...
internal class OnorbitFullTest {
    ...
    fun create() {
        ...
        assertThat(onorbitFull.classificationMarking()).isEqualTo("U")
        assertThat(onorbitFull.dataMode()).isEqualTo(OnorbitFull.DataMode.TEST)
        assertThat(onorbitFull.satNo()).isEqualTo(1)
        assertThat(onorbitFull.source()).isEqualTo("Bluestaq")
        assertThat(onorbitFull.altName()).contains("Alternate Name")
        assertThat(onorbitFull.antennas().getOrNull())
            .containsExactly(
                OnorbitAntennaFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitAntennaFull.DataMode.TEST)
        ...
        assertThat(onorbitFull.batteries().getOrNull())
            .containsExactly(
                OnorbitBatteryFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitBatteryFull.DataMode.TEST)
        ...
        assertThat(onorbitFull.category()).contains(OnorbitFull.Category.LUNAR)
        assertThat(onorbitFull.commonName()).contains("Example common name")
        assertThat(onorbitFull.constellation()).contains("Big Dipper")
        assertThat(onorbitFull.countryCode()).contains("US")
        assertThat(onorbitFull.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(onorbitFull.createdBy()).contains("some.user")
        assertThat(onorbitFull.decayDate())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(onorbitFull.entityCollection().getOrNull())
            .containsExactly(
                OnorbitFull.EntityCollection.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.EntityCollection.DataMode.TEST)
        ...
        assertThat(onorbitFull.idOnOrbit()).contains("ONORBIT-ID")
        assertThat(onorbitFull.intlDes()).contains("2021123ABC")
        assertThat(onorbitFull.launchDate()).contains(LocalDate.parse("2018-01-01"))
        assertThat(onorbitFull.launchSiteId()).contains("LAUNCHSITE-ID")
        assertThat(onorbitFull.lifetimeYears()).contains(10)
        assertThat(onorbitFull.missionNumber()).contains("Expedition 1")
        assertThat(onorbitFull.objectType()).contains(OnorbitFull.ObjectType.PAYLOAD)
        assertThat(onorbitFull.onorbitDetails().getOrNull())
            .containsExactly(
                OnorbitDetailsFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitDetailsFull.DataMode.TEST)
        ...
        assertThat(onorbitFull.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(onorbitFull.origNetwork()).contains("OPS1")
        assertThat(onorbitFull.solarArrays().getOrNull())
            .containsExactly(
                OnorbitSolarArrayFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitSolarArrayFull.DataMode.TEST)
        ...
        assertThat(onorbitFull.thrusters().getOrNull())
            .containsExactly(
                OnorbitThrusterFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitThrusterFull.DataMode.TEST)
        ...
        assertThat(onorbitFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(onorbitFull.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbitFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbitFull),
                jacksonTypeRef<OnorbitFull>(),
            )

        assertThat(roundtrippedOnorbitFull).isEqualTo(onorbitFull)
    }
}
