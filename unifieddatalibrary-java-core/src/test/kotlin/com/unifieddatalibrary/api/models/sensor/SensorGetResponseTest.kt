...
internal class SensorGetResponseTest {

    @Test
    fun create() {
        val sensorGetResponse =
            SensorGetResponse.builder()
                .classificationMarking("U")
                .dataMode(SensorGetResponse.DataMode.TEST)
                ...
                .entity(
                    SensorGetResponse.Entity.builder()
                        .classificationMarking("U")
                        .dataMode(SensorGetResponse.Entity.DataMode.TEST)
                        .name("Example name")
                        .source("Bluestaq")
                        .type(SensorGetResponse.Entity.Type.ONORBIT)
                        .countryCode("US")
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        .createdBy("some.user")
                        .idEntity("ENTITY-ID")
                        ...
                        .onOrbit(
                            SensorGetResponse.Entity.OnOrbit.builder()
                                .classificationMarking("U")
                                .dataMode(SensorGetResponse.Entity.OnOrbit.DataMode.TEST)
                                .satNo(1)
                                .source("Bluestaq")
                                ...
                                .category(SensorGetResponse.Entity.OnOrbit.Category.LUNAR)
                                ...
                                .objectType(SensorGetResponse.Entity.OnOrbit.ObjectType.PAYLOAD)
                                .addOnorbitDetail(
                        ...
                        .origin("THIRD_PARTY_DATASOURCE")
                        .origNetwork("OPS1")
                        .ownerType(SensorGetResponse.Entity.OwnerType.COMMERCIAL)
                        .addRfBand(
                            RfBandFull.builder()
                                .classificationMarking("U")
                ...
                .addSensorcharacteristic(
                    SensorGetResponse.Sensorcharacteristic.builder()
                        .classificationMarking("U")
                        .dataMode(SensorGetResponse.Sensorcharacteristic.DataMode.TEST)
                        .idSensor("SENSOR-ID")
                        .source("Bluestaq")
                ...
                .addSensorlimitsCollection(
                    SensorGetResponse.SensorlimitsCollection.builder()
                        .classificationMarking("U")
                        .dataMode(SensorGetResponse.SensorlimitsCollection.DataMode.TEST)
                        .idSensor("SENSOR-ID")
                        .source("Bluestaq")
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        .createdBy("some.user")
                ...
                .sensorObservationType(
                    SensorGetResponse.SensorObservationType.builder()
                        .dataMode(SensorGetResponse.SensorObservationType.DataMode.TEST)
                        .source("Bluestaq")
                        .id("3")
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        .createdBy("some.user")
                ...
                .addSensorStat(
                    SensorGetResponse.SensorStat.builder()
                        .classificationMarking("U")
                        .dataMode(SensorGetResponse.SensorStat.DataMode.TEST)
                        .idSensor("idSensor")
                        .source("Bluestaq")
                        .id("SENSORSTATS-ID")
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                ...
                .sensorType(
                    SensorGetResponse.SensorType.builder()
                        .dataMode(SensorGetResponse.SensorType.DataMode.TEST)
                        .source("Bluestaq")
                        .id(12344411)
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        .createdBy("some.user")
        ...
        assertThat(sensorGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(sensorGetResponse.dataMode()).isEqualTo(SensorGetResponse.DataMode.TEST)
        assertThat(sensorGetResponse.sensorName()).isEqualTo("SENSOR_NAME")
        assertThat(sensorGetResponse.source()).isEqualTo("some.user")
        assertThat(sensorGetResponse.active()).contains(true)
        assertThat(sensorGetResponse.afId()).contains("AF-ID")
        assertThat(sensorGetResponse.asrType()).contains("SENSOR_TYPE")
        assertThat(sensorGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(sensorGetResponse.createdBy()).contains("some.user")
        assertThat(sensorGetResponse.dataControl()).contains("observations")
        assertThat(sensorGetResponse.entity())
            .contains(
                SensorGetResponse.Entity.builder()
                    .classificationMarking("U")
                    .dataMode(SensorGetResponse.Entity.DataMode.TEST)
        ...
        assertThat(sensorGetResponse.idEntity()).contains("ENTITY-ID")
        assertThat(sensorGetResponse.idSensor()).contains("SENSOR-ID")
        assertThat(sensorGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(sensorGetResponse.origNetwork()).contains("OPS1")
        assertThat(sensorGetResponse.sensorcharacteristics().getOrNull())
            .containsExactly(
                SensorGetResponse.Sensorcharacteristic.builder()
                    .classificationMarking("U")
                    .dataMode(SensorGetResponse.Sensorcharacteristic.DataMode.TEST)
        ...
        assertThat(sensorGetResponse.sensorlimitsCollection().getOrNull())
            .containsExactly(
                SensorGetResponse.SensorlimitsCollection.builder()
                    .classificationMarking("U")
                    .dataMode(SensorGetResponse.SensorlimitsCollection.DataMode.TEST)
        ...
        assertThat(sensorGetResponse.sensorNumber()).contains(1234)
        assertThat(sensorGetResponse.sensorObservationType())
            .contains(
                SensorGetResponse.SensorObservationType.builder()
                    .dataMode(SensorGetResponse.SensorObservationType.DataMode.TEST)
                    .source("Bluestaq")
        ...
        assertThat(sensorGetResponse.sensorStats().getOrNull())
            .containsExactly(
                SensorGetResponse.SensorStat.builder()
                    .classificationMarking("U")
                    .dataMode(SensorGetResponse.SensorStat.DataMode.TEST)
        ...
        assertThat(sensorGetResponse.sensorType())
            .contains(
                SensorGetResponse.SensorType.builder()
                    .dataMode(SensorGetResponse.SensorType.DataMode.TEST)
                    .source("Bluestaq")
        ...
        assertThat(sensorGetResponse.shortName()).contains("SNR-1")
        assertThat(sensorGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(sensorGetResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSensorGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sensorGetResponse),
                jacksonTypeRef<SensorGetResponse>(),
            )

        assertThat(roundtrippedSensorGetResponse).isEqualTo(sensorGetResponse)
    }
}
