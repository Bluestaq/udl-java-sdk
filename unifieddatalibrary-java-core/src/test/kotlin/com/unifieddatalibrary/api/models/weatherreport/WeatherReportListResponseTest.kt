...
internal class WeatherReportListResponseTest {
    ...
    @Test
    fun create() {
      val weatherReportListResponse = WeatherReportListResponse.builder()
      ...
      assertThat(weatherReportListResponse.dataMode()).isEqualTo(WeatherReportListResponse.DataMode.TEST)
      assertThat(weatherReportListResponse.lat()).isEqualTo(56.12)
      assertThat(weatherReportListResponse.lon()).isEqualTo(-156.6)
      assertThat(weatherReportListResponse.obTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(weatherReportListResponse.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      ...
      assertThat(weatherReportListResponse.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(weatherReportListResponse.cloudCover().getOrNull()).containsExactly("OVERCAST", "BROKEN")
      ...
      assertThat(weatherReportListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(weatherReportListResponse.forecastEndTime()).contains(OffsetDateTime.parse("2024-01-01T18:00:00.123Z"))
      assertThat(weatherReportListResponse.forecastStartTime()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      ...
      assertThat(weatherReportListResponse.idAirfield()).contains("8fb38d6d-a3de-45dd-8974-4e3ed73e9449")
      assertThat(weatherReportListResponse.idGroundImagery()).contains("GROUND-IMAGERY-ID")
      assertThat(weatherReportListResponse.idSensor()).contains("0129f577-e04c-441e-65ca-0a04a750bed9")
      ...
      assertThat(weatherReportListResponse.origNetwork()).contains("ORIG")
      ...
      assertThat(weatherReportListResponse.rawMetar()).contains("KXYZ 241456Z 19012G20KT 10SM FEW120 SCT200 BKN250 26/M04 A2981 RMK AO2 PK WND 19026/1420 SLP068 T02611039 51015")
      assertThat(weatherReportListResponse.rawTaf()).contains("KXYZ 051730Z 0518/0624 31008KT 3SM -SHRA BKN020 FM052300 30006KT 5SM -SHRA OVC030 PROB30 0604/0606 VRB20G35KT 1SM TSRA BKN015CB FM060600 25010KT 4SM -SHRA OVC050 TEMPO 0608/0611 2SM -SHRA OVC030 RMK NXT FCST BY 00Z=")
      ...
      assertThat(weatherReportListResponse.srcIds().getOrNull()).containsExactly("e609a90d-4059-4043-9f1a-fd7b49a3e1d0", "c739fcdb-c0c9-43c0-97b6-bfc80d0ffd52")
      assertThat(weatherReportListResponse.srcTyps().getOrNull()).containsExactly("SENSOR", "WEATHERDATA")
    ...
    fun roundtrip() {
      ...
      val roundtrippedWeatherReportListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(weatherReportListResponse), jacksonTypeRef<WeatherReportListResponse>())
