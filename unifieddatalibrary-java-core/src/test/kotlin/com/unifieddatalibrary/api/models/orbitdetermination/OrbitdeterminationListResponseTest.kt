...
internal class OrbitdeterminationListResponseTest {
    ...
    @Test
    fun create() {
      val orbitdeterminationListResponse = OrbitdeterminationListResponse.builder()
          ...
          .aprioriElset(OrbitdeterminationListResponse.AprioriElset.builder()
              .classificationMarking("U")
          ...
          .aprioriStateVector(OrbitdeterminationListResponse.AprioriStateVector.builder()
              .classificationMarking("U")
              ...
              .covReferenceFrame(OrbitdeterminationListResponse.AprioriStateVector.CovReferenceFrame.J2000)
              .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
              .createdBy("some.user")
              ...
              .recOdSpan(3.5)
              .referenceFrame(OrbitdeterminationListResponse.AprioriStateVector.ReferenceFrame.J2000)
              .residualsAcc(99.5)
              .revNo(7205)
              .rms(0.991)
              .satNo(12)
      ...
      assertThat(orbitdeterminationListResponse.dataMode()).isEqualTo(OrbitdeterminationListResponse.DataMode.TEST)
      assertThat(orbitdeterminationListResponse.endTime()).isEqualTo(OffsetDateTime.parse("2023-08-28T15:20:21.247192Z"))
      ...
      assertThat(orbitdeterminationListResponse.startTime()).isEqualTo(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationListResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      assertThat(orbitdeterminationListResponse.acceptedObIds().getOrNull()).containsExactly("EOOBSERVATION-ID1", "RADAROBSERVATION-ID1")
      assertThat(orbitdeterminationListResponse.acceptedObTyps().getOrNull()).containsExactly("EO", "RADAR")
      ...
      assertThat(orbitdeterminationListResponse.aprioriElset()).contains(OrbitdeterminationListResponse.AprioriElset.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationListResponse.AprioriElset.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .uct(false)
          .build())
      assertThat(orbitdeterminationListResponse.aprioriIdElset()).contains("80e544b7-6a17-4554-8abf-7301e98f8e5d")
      assertThat(orbitdeterminationListResponse.aprioriIdStateVector()).contains("6e291992-8ae3-4592-bb0f-055715bf4803")
      assertThat(orbitdeterminationListResponse.aprioriStateVector()).contains(OrbitdeterminationListResponse.AprioriStateVector.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationListResponse.AprioriStateVector.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
      ...
      assertThat(orbitdeterminationListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(orbitdeterminationListResponse.effectiveFrom()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationListResponse.effectiveUntil()).contains(OffsetDateTime.parse("2023-08-30T08:15:00.123456Z"))
      ...
      assertThat(orbitdeterminationListResponse.lastObEnd()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationListResponse.lastObStart()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      ...
      assertThat(orbitdeterminationListResponse.rejectedObIds().getOrNull()).containsExactly("DIFFOFARRIVAL-ID2", "RFOBSERVATION-ID2")
      assertThat(orbitdeterminationListResponse.rejectedObTyps().getOrNull()).containsExactly("DOA", "RF")
      ...
      assertThat(orbitdeterminationListResponse.sensorIds().getOrNull()).containsExactly("SENSOR-ID1", "SENSOR-ID2")
    ...
    fun roundtrip() {
      ...
      val roundtrippedOrbitdeterminationListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(orbitdeterminationListResponse), jacksonTypeRef<OrbitdeterminationListResponse>())

      assertThat(roundtrippedOrbitdeterminationListResponse).isEqualTo(orbitdeterminationListResponse)
    }
}
