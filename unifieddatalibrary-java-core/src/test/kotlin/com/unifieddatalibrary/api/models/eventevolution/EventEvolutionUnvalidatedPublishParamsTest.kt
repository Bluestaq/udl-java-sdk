...
internal class EventEvolutionUnvalidatedPublishParamsTest {
    ...
    fun create() {
      EventEvolutionUnvalidatedPublishParams.builder()
          .addBody(EventEvolutionUnvalidatedPublishParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = EventEvolutionUnvalidatedPublishParams.builder()
          .addBody(EventEvolutionUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(EventEvolutionUnvalidatedPublishParams.Body.DataMode.TEST)
              .eventId("EVENT_ID")
      ...
      assertThat(body).containsExactly(EventEvolutionUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(EventEvolutionUnvalidatedPublishParams.Body.DataMode.TEST)
          .eventId("EVENT_ID")
          .source("Bluestaq")
