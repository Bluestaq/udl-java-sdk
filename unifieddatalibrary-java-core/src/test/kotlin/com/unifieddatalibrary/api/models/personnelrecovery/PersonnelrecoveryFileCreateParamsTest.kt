...
internal class PersonnelrecoveryFileCreateParamsTest {

    @Test
    fun create() {
      PersonnelrecoveryFileCreateParams.builder()
          .addBody(PersonnelrecoveryFileCreateParams.Body.builder()
              ...
              .createdBy("some.user")
              .executionInfo(PersonnelrecoveryFileCreateParams.Body.ExecutionInfo.builder()
                  .egress(66.53)
                  .addEgressPoint(107.23)
                  .addEgressPoint(30.455)
                  .escortVehicle(PersonnelrecoveryFileCreateParams.Body.ExecutionInfo.EscortVehicle.builder()
                      .callSign("FALCO")
                      .primaryFreq(34.55)
                      .strength(5)
                      .type("C17")
                  ...
                  .recoveryVehicle(PersonnelrecoveryFileCreateParams.Body.ExecutionInfo.RecoveryVehicle.builder()
                      .callSign("FALCO")
                      .primaryFreq(34.55)
                      .strength(5)
                      .type("C17")
              ...
              .numNonAmbulatory(0)
              .numPersons(1)
              .objectiveAreaInfo(PersonnelrecoveryFileCreateParams.Body.ObjectiveAreaInfo.builder()
                  .addEnemyData(PersonnelrecoveryFileCreateParams.Body.ObjectiveAreaInfo.EnemyData.builder()
    ...
    @Test
    fun body() {
      val params = PersonnelrecoveryFileCreateParams.builder()
          .addBody(PersonnelrecoveryFileCreateParams.Body.builder()
              .classificationMarking("U")
              .dataMode(PersonnelrecoveryFileCreateParams.Body.DataMode.TEST)
              .msgTime(OffsetDateTime.parse("2021-10-15T16:00:00.123Z"))
      ...
      assertThat(body).containsExactly(PersonnelrecoveryFileCreateParams.Body.builder()
          .classificationMarking("U")
          .dataMode(PersonnelrecoveryFileCreateParams.Body.DataMode.TEST)
          .msgTime(OffsetDateTime.parse("2021-10-15T16:00:00.123Z"))
          .pickupLat(75.1234)
