...
internal class LogisticsSupportGetResponseTest {

    @Test
    fun create() {
        val logisticsSupportGetResponse =
            LogisticsSupportGetResponse.builder()
                .classificationMarking("U")
                .dataMode(LogisticsSupportGetResponse.DataMode.TEST)
        ...
        assertThat(logisticsSupportGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(logisticsSupportGetResponse.dataMode())
            .isEqualTo(LogisticsSupportGetResponse.DataMode.TEST)
        assertThat(logisticsSupportGetResponse.rptCreatedTime())
            .isEqualTo(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(logisticsSupportGetResponse.id()).contains("LOGISTICS-SUPPORT-DETAILS UUID")
        assertThat(logisticsSupportGetResponse.aircraftMds()).contains("CO17A")
        assertThat(logisticsSupportGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(logisticsSupportGetResponse.createdBy()).contains("some.user")
        assertThat(logisticsSupportGetResponse.currIcao()).contains("KCOS")
        assertThat(logisticsSupportGetResponse.etic())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportGetResponse.etmc())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportGetResponse.extSystemId()).contains("GDSSBL012307131347070165")
        assertThat(logisticsSupportGetResponse.logisticAction()).contains("WA")
        assertThat(logisticsSupportGetResponse.logisticsDiscrepancyInfos().getOrNull())
            .containsExactly(
                LogisticsDiscrepancyInfosFull.builder()
                    .closureTime(OffsetDateTime.parse("2023-07-17T10:30:00.123Z"))
                    .discrepancyInfo(
        ...
        assertThat(logisticsSupportGetResponse.logisticsRecordId()).contains("L62017")
        assertThat(logisticsSupportGetResponse.logisticsRemarks().getOrNull())
            .containsExactly(
                LogisticsRemarksFull.builder()
                    .lastChanged(OffsetDateTime.parse("2023-07-17T10:30:00.123Z"))
                    .remark("EXAMPLE REMARK")
        ...
        assertThat(logisticsSupportGetResponse.logisticsSupportItems().getOrNull())
            .containsExactly(
                LogisticsSupportItemsFull.builder()
                    .cannibalized(true)
                    .deployPlanNumber("T89003")
        ...
        assertThat(logisticsSupportGetResponse.logisticsTransportationPlans().getOrNull())
            .containsExactly(
                LogisticsTransportationPlansFull.builder()
                    .actDepTime(OffsetDateTime.parse("2023-07-14T19:37:00.123Z"))
                    .aircraftStatus("NMCMU")
        ...
        assertThat(logisticsSupportGetResponse.maintStatusCode()).contains("NMCMU")
        assertThat(logisticsSupportGetResponse.mcTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportGetResponse.meTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(logisticsSupportGetResponse.origNetwork()).contains("OPS1")
        assertThat(logisticsSupportGetResponse.owner()).contains("EXAMPLE_OWNER")
        assertThat(logisticsSupportGetResponse.reopenFlag()).contains(true)
        assertThat(logisticsSupportGetResponse.rptClosedTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportGetResponse.suppIcao()).contains("KCOS")
        assertThat(logisticsSupportGetResponse.tailNumber()).contains("99290")
        assertThat(logisticsSupportGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
        assertThat(logisticsSupportGetResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedLogisticsSupportGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(logisticsSupportGetResponse),
                jacksonTypeRef<LogisticsSupportGetResponse>(),
            )

        assertThat(roundtrippedLogisticsSupportGetResponse).isEqualTo(logisticsSupportGetResponse)
    }
}
