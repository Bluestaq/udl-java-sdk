...
internal class EffectResponseUnvalidatedPublishParamsTest {
    ...
    fun create() {
      EffectResponseUnvalidatedPublishParams.builder()
          .addBody(EffectResponseUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(EffectResponseUnvalidatedPublishParams.Body.DataMode.TEST)
              .source("Bluestaq")
              .type("COA")
              .id("EFFECTRESPONSE-ID")
              .addActionsList(EffectResponseUnvalidatedPublishParams.Body.ActionsList.builder()
                  ...
                  .actionId("ACTION-ID")
                  .addActionMetric(EffectResponseUnvalidatedPublishParams.Body.ActionsList.ActionMetric.builder()
                      .domainValue(10.1)
              ...
              .addCoaMetric(EffectResponseUnvalidatedPublishParams.Body.CoaMetric.builder()
                  .domainValue(10.1)
                  .metricType("GoalAchievement")
                  .provenance("Example metric")
                  .relativeValue(10.1)
    ...
    @Test
    fun body() {
      val params = EffectResponseUnvalidatedPublishParams.builder()
          .addBody(EffectResponseUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(EffectResponseUnvalidatedPublishParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(EffectResponseUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(EffectResponseUnvalidatedPublishParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .type("COA")
