...
internal class SeradataRadarPayloadTupleResponseTest {
    ...
    @Test
    fun create() {
      val seradataRadarPayloadTupleResponse = SeradataRadarPayloadTupleResponse.builder()
      ...
      assertThat(seradataRadarPayloadTupleResponse.dataMode()).isEqualTo(SeradataRadarPayloadTupleResponse.DataMode.TEST)
      ...
      assertThat(seradataRadarPayloadTupleResponse.constellationInterferometricCapability()).contains("constellationInterferometricCapability")
      assertThat(seradataRadarPayloadTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(seradataRadarPayloadTupleResponse.groundStationLocations()).contains("51,42N-44,35E")
      assertThat(seradataRadarPayloadTupleResponse.groundStations()).contains("groundStations")
      assertThat(seradataRadarPayloadTupleResponse.hostedForCompanyOrgId()).contains("hostedForCompanyOrgId")
      assertThat(seradataRadarPayloadTupleResponse.idSensor()).contains("3c1ee9a0-90ad-1d75-c47b-2414e0a77e53")
      assertThat(seradataRadarPayloadTupleResponse.manufacturerOrgId()).contains("manufacturerOrgId")
      ...
      assertThat(seradataRadarPayloadTupleResponse.partnerSpacecraft()).contains("partnerSpacecraft")
      ...
      assertThat(seradataRadarPayloadTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSeradataRadarPayloadTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(seradataRadarPayloadTupleResponse), jacksonTypeRef<SeradataRadarPayloadTupleResponse>())

      assertThat(roundtrippedSeradataRadarPayloadTupleResponse).isEqualTo(seradataRadarPayloadTupleResponse)
    }
}
