...
internal class MissileTrackUnvalidatedPublishParamsTest {
    ...
    fun create() {
      MissileTrackUnvalidatedPublishParams.builder()
          .addBody(MissileTrackUnvalidatedPublishParams.Body.builder()
              ...
              .trkConf(0.95)
              .trkQual(1)
              .addVector(MissileTrackUnvalidatedPublishParams.Body.Vector.builder()
                  ...
                  .covReferenceFrame(MissileTrackUnvalidatedPublishParams.Body.Vector.CovReferenceFrame.ECEF)
                  .flightAz(45.23)
    ...
    @Test
    fun body() {
      val params = MissileTrackUnvalidatedPublishParams.builder()
          .addBody(MissileTrackUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(MissileTrackUnvalidatedPublishParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(MissileTrackUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(MissileTrackUnvalidatedPublishParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .ts(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
