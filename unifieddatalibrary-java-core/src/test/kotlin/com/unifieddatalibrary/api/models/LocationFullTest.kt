...
internal class LocationFullTest {
    ...
    @Test
    fun create() {
      val locationFull = LocationFull.builder()
      ...
      assertThat(locationFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(locationFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedLocationFull = jsonMapper.readValue(jsonMapper.writeValueAsString(locationFull), jacksonTypeRef<LocationFull>())
