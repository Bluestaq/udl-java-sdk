...
internal class SgiGetResponseTest {
    ...
    fun create() {
        ...
        assertThat(sgiGetResponse.effectiveDate())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(sgiGetResponse.sgiDate())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        ...
        assertThat(sgiGetResponse.createdAt())
        ...
        assertThat(sgiGetResponse.frequencies().getOrNull())
        ...
        assertThat(sgiGetResponse.tags().getOrNull())
        ...
        assertThat(sgiGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSgiGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sgiGetResponse),
                jacksonTypeRef<SgiGetResponse>(),
            )
