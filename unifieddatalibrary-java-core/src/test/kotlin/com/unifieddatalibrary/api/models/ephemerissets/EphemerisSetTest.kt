...
internal class EphemerisSetTest {
    ...
    @Test
    fun create() {
      val ephemerisSet = EphemerisSet.builder()
          .category("ANALYST")
          ...
          .dragModel("JAC70")
          .edr(1.1)
          .addEphemerisList(EphemerisFull.builder()
              .classificationMarking("U")
          ...
          .stateVector(StateVectorFull.builder()
              .classificationMarking("U")
      ...
      assertThat(ephemerisSet.pointEndTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(ephemerisSet.pointStartTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(ephemerisSet.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(ephemerisSet.ephemerisList().getOrNull()).containsExactly(EphemerisFull.builder()
          .classificationMarking("U")
          .dataMode(EphemerisFull.DataMode.TEST)
          .source("Bluestaq")
          .ts(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(ephemerisSet.idManeuvers().getOrNull()).containsExactly("EXAMPLE_ID1", "EXAMPLE_ID2")
      ...
      assertThat(ephemerisSet.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
      ...
      assertThat(ephemerisSet.origNetwork()).contains("ORIG")
      ...
      assertThat(ephemerisSet.stateVector()).contains(StateVectorFull.builder()
          .classificationMarking("U")
          .dataMode(StateVectorFull.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
      ...
      assertThat(ephemerisSet.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
      assertThat(ephemerisSet.transactionId()).contains("TRANSACTION-ID")
      assertThat(ephemerisSet.usableEndTime()).contains(OffsetDateTime.parse("2018-01-01T20:50:00.123456Z"))
      assertThat(ephemerisSet.usableStartTime()).contains(OffsetDateTime.parse("2018-01-01T16:10:00.123456Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedEphemerisSet = jsonMapper.readValue(jsonMapper.writeValueAsString(ephemerisSet), jacksonTypeRef<EphemerisSet>())
