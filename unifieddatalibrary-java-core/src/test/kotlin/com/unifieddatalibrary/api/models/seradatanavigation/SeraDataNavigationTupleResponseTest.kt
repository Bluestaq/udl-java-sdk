...
internal class SeraDataNavigationTupleResponseTest {
    ...
    @Test
    fun create() {
      val seraDataNavigationTupleResponse = SeraDataNavigationTupleResponse.builder()
      ...
      assertThat(seraDataNavigationTupleResponse.dataMode()).isEqualTo(SeraDataNavigationTupleResponse.DataMode.TEST)
      ...
      assertThat(seraDataNavigationTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(seraDataNavigationTupleResponse.createdBy()).contains("some.user")
      assertThat(seraDataNavigationTupleResponse.hostedForCompanyOrgId()).contains("hostedForCompanyOrgId")
      ...
      assertThat(seraDataNavigationTupleResponse.manufacturerOrgId()).contains("manufacturerOrgId")
      ...
      assertThat(seraDataNavigationTupleResponse.partnerSpacecraftId()).contains("partnerSpacecraftId")
      assertThat(seraDataNavigationTupleResponse.payloadType()).contains("WAAS")
      assertThat(seraDataNavigationTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSeraDataNavigationTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(seraDataNavigationTupleResponse), jacksonTypeRef<SeraDataNavigationTupleResponse>())

      assertThat(roundtrippedSeraDataNavigationTupleResponse).isEqualTo(seraDataNavigationTupleResponse)
    }
}
