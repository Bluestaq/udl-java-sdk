...
internal class AirTaskingOrderFullTest {
    ...
    @Test
    fun create() {
      val airTaskingOrderFull = AirTaskingOrderFull.builder()
          ...
          .addAcMsnTasking(AirTaskingOrderFull.AcMsnTasking.builder()
              .countryCode("US")
              .taskedService("A")
              .unitDesignator("AMPHIB5DIV")
              .addAcMsnLocSeg(AirTaskingOrderFull.AcMsnTasking.AcMsnLocSeg.builder()
              ...
              .addIndAcTasking(AirTaskingOrderFull.AcMsnTasking.IndAcTasking.builder()
                  .acftType("F35A")
                  .callSign("EAGLE47")
                  .iffSifMode1Code("111")
          ...
          .addGenText(AirTaskingOrderFull.GenText.builder()
              .text("FREE-TEXT")
          ...
          .msgQualifier("CHG")
          .msgSn("ATO A")
          .addNavalFltOp(AirTaskingOrderFull.NavalFltOp.builder()
              .shipName("USS WASP")
      ...
      assertThat(airTaskingOrderFull.beginTs()).isEqualTo(OffsetDateTime.parse("2023-10-25T12:00:00.123Z"))
      ...
      assertThat(airTaskingOrderFull.acMsnTasking().getOrNull()).containsExactly(AirTaskingOrderFull.AcMsnTasking.builder()
          .countryCode("US")
          .taskedService("A")
          .unitDesignator("AMPHIB5DIV")
          .addAcMsnLocSeg(AirTaskingOrderFull.AcMsnTasking.AcMsnLocSeg.builder()
          ...
          .unitLocName("ICAO:KXXQ")
          .build())
      assertThat(airTaskingOrderFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(airTaskingOrderFull.createdBy()).contains("some.user")
      assertThat(airTaskingOrderFull.endTs()).contains(OffsetDateTime.parse("2023-10-27T12:00:00.123Z"))
      assertThat(airTaskingOrderFull.genText().getOrNull()).containsExactly(AirTaskingOrderFull.GenText.builder()
          .text("FREE-TEXT")
          .textInd("OPENING REMARKS")
          .build())
      ...
      assertThat(airTaskingOrderFull.navalFltOps().getOrNull()).containsExactly(AirTaskingOrderFull.NavalFltOp.builder()
          .shipName("USS WASP")
          .fltOpStart(OffsetDateTime.parse("2021-02-25T12:00:00.123Z"))
          .fltOpStop(OffsetDateTime.parse("2021-02-25T12:00:00.123Z"))
          .addSchdLaunchRcvyTime(OffsetDateTime.parse("2021-02-25T12:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedAirTaskingOrderFull = jsonMapper.readValue(jsonMapper.writeValueAsString(airTaskingOrderFull), jacksonTypeRef<AirTaskingOrderFull>())
