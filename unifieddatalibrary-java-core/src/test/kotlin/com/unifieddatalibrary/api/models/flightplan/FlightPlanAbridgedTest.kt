...
internal class FlightPlanAbridgedTest {
    ...
    @Test
    fun create() {
      val flightPlanAbridged = FlightPlanAbridged.builder()
          .arrAirfield("KCHS")
          ...
          .addAirRefuelEvent(FlightPlanAbridged.AirRefuelEvent.builder()
              .arDegrade(3.1)
          ...
          .addFlightPlanMessage(FlightPlanAbridged.FlightPlanMessage.builder()
              .msgText("Message text")
              .routePath("PRIMARY")
              .severity("SEVERE")
              .wpNum("20")
              .build())
          .addFlightPlanPointGroup(FlightPlanAbridged.FlightPlanPointGroup.builder()
              .avgFuelFlow(19693.1)
              ...
              .etopsTempDev(9.1)
              .etopsTime("01:23")
              .addFlightPlanPoint(FlightPlanAbridged.FlightPlanPointGroup.FlightPlanPoint.builder()
              ...
              .build())
          .addFlightPlanWaypoint(FlightPlanAbridged.FlightPlanWaypoint.builder()
              .type("COMMENT")
              .waypointName("KCHS")
      ...
      assertThat(flightPlanAbridged.genTs()).isEqualTo(OffsetDateTime.parse("2023-05-01T01:01:01.123Z"))
      ...
      assertThat(flightPlanAbridged.airRefuelEvents().getOrNull()).containsExactly(FlightPlanAbridged.AirRefuelEvent.builder()
          .arDegrade(3.1)
          .arExchangedFuel(1500.1)
          .arNum(2)
          .divertFuel(143000.1)
      ...
      assertThat(flightPlanAbridged.atcAddresses().getOrNull()).containsExactly("EYCBZMFO", "EUCHZMFP", "ETARYXYX", "EDUUZVZI")
      ...
      assertThat(flightPlanAbridged.cargoRemark()).contains("Expecting 55,000 lbs. If different, call us.")
      ...
      assertThat(flightPlanAbridged.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(flightPlanAbridged.estDepTime()).contains(OffsetDateTime.parse("2023-05-01T01:01:01.123Z"))
      assertThat(flightPlanAbridged.etopsAirfields().getOrNull()).containsExactly("KHSV", "KISP", "KBG", "LTBS")
      assertThat(flightPlanAbridged.etopsAltAirfields().getOrNull()).containsExactly("KHSV", "KISP", "KBG", "LTBS")
      ...
      assertThat(flightPlanAbridged.flightPlanMessages().getOrNull()).containsExactly(FlightPlanAbridged.FlightPlanMessage.builder()
          .msgText("Message text")
          .routePath("PRIMARY")
          .severity("SEVERE")
          .wpNum("20")
          .build())
      assertThat(flightPlanAbridged.flightPlanPointGroups().getOrNull()).containsExactly(FlightPlanAbridged.FlightPlanPointGroup.builder()
          .avgFuelFlow(19693.1)
          .etopsAvgWindFactor(10.1)
          .etopsDistance(684.1)
          .etopsReqFuel(4412.1)
          ...
          .worstFuelCase("DEPRESSURIZED ENGINE OUT ETP")
          .build())
      assertThat(flightPlanAbridged.flightPlanWaypoints().getOrNull()).containsExactly(FlightPlanAbridged.FlightPlanWaypoint.builder()
          .type("COMMENT")
          .waypointName("KCHS")
          .aaTacanChannel("31/94")
          .airDistance(321.1)
      ...
      assertThat(flightPlanAbridged.idArrAirfield()).contains("363080c2-40fd-11ee-be56-0242ac120002")
      assertThat(flightPlanAbridged.idDepAirfield()).contains("2a9020f6-40fd-11ee-be56-0242ac120002")
      ...
      assertThat(flightPlanAbridged.notes()).contains("STS/STATE PBN/A1B2B5C2C4D2D4 EUR/PROTECTED")
      ...
      assertThat(flightPlanAbridged.plannerRemark()).contains("Flight plan is good for 2 days before airspace closes over the UK.")
      ...
      assertThat(flightPlanAbridged.routeString()).contains("RENV3B RENVI Y86 GOSVA/N0317F260 DCT EVLIT DCT UMUGI DCT NISIX DCT GIGOD DCT DIPEB DCT\nGORPI Z80 TILAV L87 RAKIT Z717 PODUS Z130 MAG/N0298F220 Z20 KENIG/N0319F220 Z20 ORTAG T177\nESEGU Z20 BEBLA DCT MASEK/N0300F200 DCT GISEM/N0319F200 DCT BOMBI/N0276F060 DCT RIDSU DCT")
      ...
      assertThat(flightPlanAbridged.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(flightPlanAbridged.wxValidEnd()).contains(OffsetDateTime.parse("2023-05-01T01:01:01.123Z"))
      assertThat(flightPlanAbridged.wxValidStart()).contains(OffsetDateTime.parse("2023-05-01T01:01:01.123Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedFlightPlanAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(flightPlanAbridged), jacksonTypeRef<FlightPlanAbridged>())
