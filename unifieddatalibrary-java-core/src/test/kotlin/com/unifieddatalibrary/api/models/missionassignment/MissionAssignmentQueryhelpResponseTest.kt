...
internal class MissionAssignmentQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val missionAssignmentQueryhelpResponse = MissionAssignmentQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(missionAssignmentQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(missionAssignmentQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(missionAssignmentQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedMissionAssignmentQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(missionAssignmentQueryhelpResponse), jacksonTypeRef<MissionAssignmentQueryhelpResponse>())

      assertThat(roundtrippedMissionAssignmentQueryhelpResponse).isEqualTo(missionAssignmentQueryhelpResponse)
    }
}
