...
internal class AviationRiskManagementTupleResponseTest {
    ...
    @Test
    fun create() {
        val aviationRiskManagementTupleResponse =
            AviationRiskManagementTupleResponse.builder()
                ...
                .addAviationRiskManagementWorksheetRecord(
                    AviationRiskManagementTupleResponse.AviationRiskManagementWorksheetRecord
                        .builder()
        ...
        assertThat(aviationRiskManagementTupleResponse.dataMode())
            .isEqualTo(AviationRiskManagementTupleResponse.DataMode.TEST)
        assertThat(aviationRiskManagementTupleResponse.idMission())
            .isEqualTo("fa18d96e-91ea-60da-a7a8-1af6500066c8")
        assertThat(aviationRiskManagementTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(aviationRiskManagementTupleResponse.id())
        ...
        assertThat(
            ...
            .containsExactly(
                AviationRiskManagementTupleResponse.AviationRiskManagementWorksheetRecord.builder()
                    .missionDate(LocalDate.parse("2024-11-25"))
                    .aircraftMds("E-2C HAWKEYE")
                    .approvalPending(true)
                    .approved(false)
        ...
        assertThat(aviationRiskManagementTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(aviationRiskManagementTupleResponse.createdBy()).contains("some.user")
        assertThat(aviationRiskManagementTupleResponse.extMissionId())
        ...
        assertThat(aviationRiskManagementTupleResponse.origNetwork()).contains("OPS1")
        ...
        assertThat(aviationRiskManagementTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedAviationRiskManagementTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(aviationRiskManagementTupleResponse),
                jacksonTypeRef<AviationRiskManagementTupleResponse>(),
            )

        assertThat(roundtrippedAviationRiskManagementTupleResponse)
            .isEqualTo(aviationRiskManagementTupleResponse)
    }
}
