...
internal class AnalyticImageryQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val analyticImageryQueryhelpResponse = AnalyticImageryQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(analyticImageryQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(analyticImageryQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(analyticImageryQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAnalyticImageryQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(analyticImageryQueryhelpResponse), jacksonTypeRef<AnalyticImageryQueryhelpResponse>())

      assertThat(roundtrippedAnalyticImageryQueryhelpResponse).isEqualTo(analyticImageryQueryhelpResponse)
    }
}
