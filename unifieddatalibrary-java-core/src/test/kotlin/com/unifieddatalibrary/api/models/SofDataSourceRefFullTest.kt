...
internal class SofDataSourceRefFullTest {
    ...
    @Test
    fun create() {
      val sofDataSourceRefFull = SofDataSourceRefFull.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedSofDataSourceRefFull = jsonMapper.readValue(jsonMapper.writeValueAsString(sofDataSourceRefFull), jacksonTypeRef<SofDataSourceRefFull>())
