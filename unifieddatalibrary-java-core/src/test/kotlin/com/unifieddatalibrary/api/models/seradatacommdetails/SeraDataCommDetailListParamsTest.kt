...
internal class SeraDataCommDetailListParamsTest {
    ...
    @Test
    fun create() {
        SeraDataCommDetailListParams.builder().firstResult(0L).maxResults(0L).build()
    }

    @Test
    fun queryParams() {
        val params = SeraDataCommDetailListParams.builder().firstResult(0L).maxResults(0L).build()
