    ...
    fun create() {
        val historyListResponse =
            HistoryListResponse.builder()
                ...
                .amplitude(
                    HistoryListResponse.Amplitude.builder()
                ...
                .antennaElementPosition(
                    HistoryListResponse.AntennaElementPosition.builder()
                ...
                .antennaElementPositionCoordinateSystem(
                    HistoryListResponse.AntennaElementPositionCoordinateSystem.J2000
                )
                .artistFlags(listOf(1, 2, 3))
                .azimuth(
                    HistoryListResponse.Azimuth.builder()
                        .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                        .addDimensionName("NAME1")
                        .addDimensionName("NAME2")
                        .addDimension(1)
                ...
                .b1(1.87)
                .addCharAtt(
                    HistoryListResponse.CharAtt.builder()
                        .charName("hprimeF2")
                ...
                .d1(1.94)
                .datum(
                    HistoryListResponse.Datum.builder()
                ...
                .deltafoF2(1.1)
                .densityProfile(
                    HistoryListResponse.DensityProfile.builder()
                        .iri(
                            HistoryListResponse.DensityProfile.Iri.builder()
                                .b0(245.1)
                                .b1(3.45)
                                .chi(35.1)
                                .d1(0.0)
                        ...
                        .parabolic(
                            HistoryListResponse.DensityProfile.Parabolic.builder()
                                .description("Best-fit algorithm in NHPC software.")
                                .addParabolicItem(
                                    HistoryListResponse.DensityProfile.Parabolic.ParabolicItem
                                        .builder()
                                        .f(3.621)
                                        .layer("E")
                                        .y(11.1)
                        ...
                        .shiftedChebyshev(
                            HistoryListResponse.DensityProfile.ShiftedChebyshev.builder()
                                .description(
                                    "Best-fit Huang-Reinisch formalism based on shifted Chebyshev expansion."
                                )
                                .addShiftedChebyshev(
                                    HistoryListResponse.DensityProfile.ShiftedChebyshev
                        ...
                        .topsideExtensionChapmanConst(
                            HistoryListResponse.DensityProfile.TopsideExtensionChapmanConst
                                .builder()
                                .chi(35.1)
                                .description(
                        ...
                        .topsideExtensionVaryChap(
                            HistoryListResponse.DensityProfile.TopsideExtensionVaryChap.builder()
                                .alpha(30.1)
                                .beta(30.1)
                                .chi(30.1)
                                .description(
                ...
                .doppler(
                    HistoryListResponse.Doppler.builder()
                        .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                        .addDimensionName("NAME1")
                        .addDimensionName("NAME2")
                        .addDimension(1)
                ...
                .elevation(
                    HistoryListResponse.Elevation.builder()
                        .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                        .addDimensionName("NAME1")
                        .addDimensionName("NAME2")
                        .addDimension(2)
                ...
                .foP(87.21)
                .frequency(
                    HistoryListResponse.Frequency.builder()
                        .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                        .addDimensionName("NAME1")
                        .addDimensionName("NAME2")
                        .addDimension(1)
                ...
                .polarization(
                    HistoryListResponse.Polarization.builder()
                        .addData(
                            listOf(
                                listOf(
                                    listOf(
                                        listOf(
                                            listOf(
                                                listOf(
                                                    HistoryListResponse.Polarization
                ...
                .power(
                    HistoryListResponse.Power.builder()
                        .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                        .addDimensionName("NAME1")
                        .addDimensionName("NAME2")
                        .addDimension(1)
                ...
                .qf(1.83)
                .range(
                    HistoryListResponse.Range.builder()
                        .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                        .addDimensionName("NAME1")
                        .addDimensionName("NAME2")
                        .addDimension(1)
                ...
                .scalerInfo(
                    HistoryListResponse.ScalerInfo.builder()
                        .confidenceLevel(11)
                        .confidenceScore(75)
                        .name("ARTIST-4")
                        .organization("UML")
                ...
                .stokes(
                    HistoryListResponse.Stokes.builder()
                        .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                ...
                .time(
                    HistoryListResponse.Time.builder()
                        .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                        .addDimensionName("NAME1")
                        .addDimensionName("NAME2")
                        .addDimension(1)
                ...
                .traceGeneric(
                    HistoryListResponse.TraceGeneric.builder()
        ...
        assertThat(historyListResponse.startTimeUtc())
        ...
        assertThat(historyListResponse.amplitude())
            .contains(
                HistoryListResponse.Amplitude.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.antennaElementPosition())
            .contains(
                HistoryListResponse.AntennaElementPosition.builder()
                    .addData(listOf(1.23, 0.123))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.antennaElementPositionCoordinateSystem())
            .contains(HistoryListResponse.AntennaElementPositionCoordinateSystem.J2000)
        assertThat(historyListResponse.artistFlags().getOrNull()).containsExactly(1, 2, 3)
        assertThat(historyListResponse.azimuth())
            .contains(
                HistoryListResponse.Azimuth.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.charAtts().getOrNull())
            .containsExactly(
                HistoryListResponse.CharAtt.builder()
                    .charName("hprimeF2")
                    .addClimateModelInputParam("ISSN1 88.1")
        ...
        assertThat(historyListResponse.datum())
            .contains(
                HistoryListResponse.Datum.builder()
                    .data(listOf(1.1, 2.1, 3.1))
                    .notes("NOTES")
        ...
        assertThat(historyListResponse.densityProfile())
            .contains(
                HistoryListResponse.DensityProfile.builder()
                    .iri(
                        HistoryListResponse.DensityProfile.Iri.builder()
                    ...
                    .parabolic(
                        HistoryListResponse.DensityProfile.Parabolic.builder()
                            .description("Best-fit algorithm in NHPC software.")
                            .addParabolicItem(
                                HistoryListResponse.DensityProfile.Parabolic.ParabolicItem.builder()
                                    .f(3.621)
                                    .layer("E")
                                    .y(11.1)
                                    .z(110.2)
                    ...
                    .topsideExtensionChapmanConst(
                        HistoryListResponse.DensityProfile.TopsideExtensionChapmanConst.builder()
                            .chi(35.1)
                            .description(
                                "Constant scale height Chapman topside layer determined using bottomside peak density parameters and placed chi km above the ionosonde-determined peak height."
                            )
        ...
        assertThat(historyListResponse.doppler())
            .contains(
                HistoryListResponse.Doppler.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.electronDensityUncertainty().getOrNull())
            .containsExactly(0.8, 0.2, 0.5)
        assertThat(historyListResponse.elevation())
            .contains(
                HistoryListResponse.Elevation.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.frequency())
            .contains(
                HistoryListResponse.Frequency.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.plasmaFrequencyUncertainty().getOrNull())
            .containsExactly(0.8, 0.2, 0.5)
        assertThat(historyListResponse.platformName()).contains("Millstone Hill")
        assertThat(historyListResponse.polarization())
            .contains(
                HistoryListResponse.Polarization.builder()
                    .addData(
                        listOf(
        ...
        assertThat(historyListResponse.power())
            .contains(
                HistoryListResponse.Power.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.range())
            .contains(
                HistoryListResponse.Range.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.receiveCoordinates().getOrNull())
            .containsExactly(listOf(45.5, 179.3, 35.6), listOf(-80.2, -20.5, 43.2))
        assertThat(historyListResponse.receiveSensorType())
            .contains(HistoryListResponse.ReceiveSensorType.MOBILE)
        assertThat(historyListResponse.restrictedFrequency().getOrNull())
        ...
        assertThat(historyListResponse.scalerInfo())
            .contains(
                HistoryListResponse.ScalerInfo.builder()
                    .confidenceLevel(11)
                    .confidenceScore(75)
        ...
        assertThat(historyListResponse.stokes())
            .contains(
                HistoryListResponse.Stokes.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAMES1")
        ...
        assertThat(historyListResponse.time())
            .contains(
                HistoryListResponse.Time.builder()
                    .addData(listOf(listOf(listOf(listOf(listOf(listOf(0.02, 0.034)))))))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.traceGeneric())
            .contains(
                HistoryListResponse.TraceGeneric.builder()
                    .addData(listOf(listOf(1.23, 1.0903)))
                    .addDimensionName("NAME1")
        ...
        assertThat(historyListResponse.transmitCoordinates().getOrNull())
            .containsExactly(listOf(45.5, 179.3, 35.6), listOf(-80.2, -20.5, 43.2))
        assertThat(historyListResponse.transmitSensorType())
            .contains(HistoryListResponse.TransmitSensorType.MOBILE)
