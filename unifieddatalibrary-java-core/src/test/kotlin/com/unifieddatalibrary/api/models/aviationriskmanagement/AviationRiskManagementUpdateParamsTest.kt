...
internal class AviationRiskManagementUpdateParamsTest {
    ...
    fun create() {
      AviationRiskManagementUpdateParams.builder()
          ...
          .addAviationRiskManagementWorksheetRecord(AviationRiskManagementUpdateParams.AviationRiskManagementWorksheetRecord.builder()
              .missionDate(LocalDate.parse("2024-11-25"))
              .aircraftMds("E-2C HAWKEYE")
              .approvalPending(true)
              .approved(false)
              .addAviationRiskManagementWorksheetScore(AviationRiskManagementUpdateParams.AviationRiskManagementWorksheetRecord.AviationRiskManagementWorksheetScore.builder()
                  .approvalDate(OffsetDateTime.parse("2024-11-01T16:00:00.123Z"))
                  .approvedBy("John Smith")
                  .approvedCode(0)
                  .addAviationRiskManagementSortie(AviationRiskManagementUpdateParams.AviationRiskManagementWorksheetRecord.AviationRiskManagementWorksheetScore.AviationRiskManagementSortie.builder()
    ...
    @Test
    fun pathParams() {
      val params = AviationRiskManagementUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(AviationRiskManagementUpdateParams.DataMode.TEST)
          .idMission("fa18d96e-91ea-60da-a7a8-1af6500066c8")
    ...
    fun body() {
      ...
      assertThat(body.aviationRiskManagementWorksheetRecord().getOrNull()).containsExactly(AviationRiskManagementUpdateParams.AviationRiskManagementWorksheetRecord.builder()
          .missionDate(LocalDate.parse("2024-11-25"))
          .aircraftMds("E-2C HAWKEYE")
          .approvalPending(true)
          .approved(false)
