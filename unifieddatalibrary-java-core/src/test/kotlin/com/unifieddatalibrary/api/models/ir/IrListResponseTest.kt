...
internal class IrListResponseTest {
    ...
    @Test
    fun create() {
      val irListResponse = IrListResponse.builder()
      ...
      assertThat(irListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedIrListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(irListResponse), jacksonTypeRef<IrListResponse>())
