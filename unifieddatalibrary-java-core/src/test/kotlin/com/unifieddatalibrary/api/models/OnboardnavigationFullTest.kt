...
internal class OnboardnavigationFullTest {

    @Test
    fun create() {
      val onboardnavigationFull = OnboardnavigationFull.builder()
          .classificationMarking("U")
          .dataMode(OnboardnavigationFull.DataMode.TEST)
          .source("Bluestaq")
          ...
          .referenceFrame(OnboardnavigationFull.ReferenceFrame.J2000)
          .satNo(101)
      ...
      assertThat(onboardnavigationFull.classificationMarking()).isEqualTo("U")
      assertThat(onboardnavigationFull.dataMode()).isEqualTo(OnboardnavigationFull.DataMode.TEST)
      assertThat(onboardnavigationFull.source()).isEqualTo("Bluestaq")
      assertThat(onboardnavigationFull.startTime()).isEqualTo(OffsetDateTime.parse("2021-07-20T01:02:03.123456Z"))
      assertThat(onboardnavigationFull.id()).contains("ONBOARD-NAVIGATION-ID")
      assertThat(onboardnavigationFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(onboardnavigationFull.createdBy()).contains("some.user")
      assertThat(onboardnavigationFull.deltaPos().getOrNull()).containsExactly(listOf(
        1.1,
        2.2,
        3.3,
      ))
      assertThat(onboardnavigationFull.endTime()).contains(OffsetDateTime.parse("2021-07-20T01:02:03.123456Z"))
      assertThat(onboardnavigationFull.esId()).contains("EPHEMERISSET-ID")
      assertThat(onboardnavigationFull.idOnOrbit()).contains("ONORBIT-ID")
      assertThat(onboardnavigationFull.idStateVector()).contains("STATE-VECTOR-ID")
      assertThat(onboardnavigationFull.mag().getOrNull()).containsExactly(listOf(
        1.1,
        2.2,
        3.3,
      ))
      assertThat(onboardnavigationFull.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
          ...
          .updatedBy("some.user")
          .build())
      assertThat(onboardnavigationFull.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(onboardnavigationFull.origNetwork()).contains("ORIG")
      assertThat(onboardnavigationFull.origObjectId()).contains("ORIGOBJECT-ID")
      assertThat(onboardnavigationFull.referenceFrame()).contains(OnboardnavigationFull.ReferenceFrame.J2000)
      assertThat(onboardnavigationFull.satNo()).contains(101)
      assertThat(onboardnavigationFull.starCatLoadTime()).contains(OffsetDateTime.parse("2021-07-21T01:02:03.123Z"))
      assertThat(onboardnavigationFull.starCatName()).contains("STAR-CAT-NAME")
      assertThat(onboardnavigationFull.starTracker().getOrNull()).containsExactly(listOf(
        1.1,
        2.2,
        3.3,
      ))
      assertThat(onboardnavigationFull.sunSensor().getOrNull()).containsExactly(listOf(
        1.1,
        2.2,
        3.3,
      ))
      assertThat(onboardnavigationFull.ts().getOrNull()).containsExactly(OffsetDateTime.parse("2021-07-21T01:02:03.120003Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedOnboardnavigationFull = jsonMapper.readValue(jsonMapper.writeValueAsString(onboardnavigationFull), jacksonTypeRef<OnboardnavigationFull>())

      assertThat(roundtrippedOnboardnavigationFull).isEqualTo(onboardnavigationFull)
    }
}
