...
internal class EffectResponseActionsListFullTest {
    ...
    @Test
    fun create() {
      val effectResponseActionsListFull = EffectResponseActionsListFull.builder()
      ...
      assertThat(effectResponseActionsListFull.actionEndTime()).contains(OffsetDateTime.parse("2021-01-01T00:00:00.123456Z"))
      assertThat(effectResponseActionsListFull.actionId()).contains("ACTION-ID")
      assertThat(effectResponseActionsListFull.actionMetrics().getOrNull()).containsExactly(EffectResponseMetricsFull.builder()
          .domainValue(10.1)
          .metricType("GoalAchievement")
          .provenance("Example metric")
          .relativeValue(10.1)
          .build())
      assertThat(effectResponseActionsListFull.actionStartTime()).contains(OffsetDateTime.parse("2021-01-01T00:00:00.123456Z"))
      ...
      assertThat(effectResponseActionsListFull.totEndTime()).contains(OffsetDateTime.parse("2021-01-01T00:00:00.123456Z"))
      assertThat(effectResponseActionsListFull.totStartTime()).contains(OffsetDateTime.parse("2021-01-01T00:00:00.123456Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedEffectResponseActionsListFull = jsonMapper.readValue(jsonMapper.writeValueAsString(effectResponseActionsListFull), jacksonTypeRef<EffectResponseActionsListFull>())

      assertThat(roundtrippedEffectResponseActionsListFull).isEqualTo(effectResponseActionsListFull)
    }
}
