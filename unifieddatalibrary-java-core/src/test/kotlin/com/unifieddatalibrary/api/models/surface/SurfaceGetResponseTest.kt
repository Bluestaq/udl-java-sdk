...
internal class SurfaceGetResponseTest {
    ...
    @Test
    fun create() {
      val surfaceGetResponse = SurfaceGetResponse.builder()
          ...
          .stWtKn(867.6)
          .addSurfaceObstruction(SurfaceGetResponse.SurfaceObstruction.builder()
              .classificationMarking("U")
      ...
      assertThat(surfaceGetResponse.createdAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      ...
      assertThat(surfaceGetResponse.ddtWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceGetResponse.ddWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceGetResponse.sbttWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceGetResponse.stWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      assertThat(surfaceGetResponse.stWtKn()).contains(867.6)
      assertThat(surfaceGetResponse.surfaceObstructions().getOrNull()).containsExactly(SurfaceGetResponse.SurfaceObstruction.builder()
          .classificationMarking("U")
          .dataMode(SurfaceGetResponse.SurfaceObstruction.DataMode.TEST)
          .idSurface("be831d39-1822-da9f-7ace-6cc5643397dc")
          .source("Bluestaq")
      ...
      assertThat(surfaceGetResponse.sWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceGetResponse.trtWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceGetResponse.ttWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceGetResponse.tWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      assertThat(surfaceGetResponse.tWtKn()).contains(836.45)
      assertThat(surfaceGetResponse.updatedAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSurfaceGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(surfaceGetResponse), jacksonTypeRef<SurfaceGetResponse>())
