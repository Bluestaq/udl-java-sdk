...
internal class ManeuverCreateBulkParamsTest {

    @Test
    fun create() {
      ManeuverCreateBulkParams.builder()
          .addBody(ManeuverCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(ManeuverCreateBulkParams.Body.DataMode.TEST)
              ...
              .postEventElset(ManeuverCreateBulkParams.Body.PostEventElset.builder()
                  .classificationMarking("U")
                  .dataMode(ManeuverCreateBulkParams.Body.PostEventElset.DataMode.TEST)
                  ...
                  .addSourcedDataType(ManeuverCreateBulkParams.Body.PostEventElset.SourcedDataType.RADAR)
                  .addSourcedDataType(ManeuverCreateBulkParams.Body.PostEventElset.SourcedDataType.RF)
                  .sourceDl("AXE")
              ...
              .postEventStateVector(ManeuverCreateBulkParams.Body.PostEventStateVector.builder()
                  .classificationMarking("U")
                  .dataMode(ManeuverCreateBulkParams.Body.PostEventStateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(ManeuverCreateBulkParams.Body.PostEventStateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(ManeuverCreateBulkParams.Body.PostEventStateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(ManeuverCreateBulkParams.Body.PostEventStateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
              ...
              .preEventElset(ManeuverCreateBulkParams.Body.PreEventElset.builder()
                  .classificationMarking("U")
                  .dataMode(ManeuverCreateBulkParams.Body.PreEventElset.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .agom(0.0126)
                  .algorithm("Example algorithm")
                  ...
                  .addSourcedData("OBSERVATION_UUID1")
                  .addSourcedData("OBSERVATION_UUID2")
                  .addSourcedDataType(ManeuverCreateBulkParams.Body.PreEventElset.SourcedDataType.RADAR)
                  .addSourcedDataType(ManeuverCreateBulkParams.Body.PreEventElset.SourcedDataType.RF)
                  .sourceDl("AXE")
                  .addTag("PROVIDER_TAG1")
                  .addTag("PROVIDER_TAG2")
                  .transactionId("TRANSACTION-ID")
              ...
              .preEventStateVector(ManeuverCreateBulkParams.Body.PreEventStateVector.builder()
                  .classificationMarking("U")
                  .dataMode(ManeuverCreateBulkParams.Body.PreEventStateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  .algorithm("SAMPLE_ALGORITHM")
                  ...
                  .covMethod("CALCULATED")
                  .covReferenceFrame(ManeuverCreateBulkParams.Body.PreEventStateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  .descriptor("descriptor")
                  .dragArea(4.739)
                  ...
                  .rawFileUri("rawFileURI")
                  .recOdSpan(3.5)
                  .referenceFrame(ManeuverCreateBulkParams.Body.PreEventStateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedData("DATA1")
                  .addSourcedData("DATA2")
                  .addSourcedDataType(ManeuverCreateBulkParams.Body.PreEventStateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
              ...
              .addSourcedData("SOURCEDDATA-ID")
              .addSourcedDataType(ManeuverCreateBulkParams.Body.SourcedDataType.EO)
              .addSourcedDataType(ManeuverCreateBulkParams.Body.SourcedDataType.RADAR)
    ...
    @Test
    fun body() {
      val params = ManeuverCreateBulkParams.builder()
          .addBody(ManeuverCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(ManeuverCreateBulkParams.Body.DataMode.TEST)
              .eventStartTime(OffsetDateTime.parse("2023-11-16T01:05:16.835689Z"))
      ...
      assertThat(body).containsExactly(ManeuverCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(ManeuverCreateBulkParams.Body.DataMode.TEST)
          .eventStartTime(OffsetDateTime.parse("2023-11-16T01:05:16.835689Z"))
          .source("Bluestaq")
