...
internal class ManeuverCreateBulkParamsTest {
    ...
    fun create() {
        ManeuverCreateBulkParams.builder()
            .addBody(
                ManeuverCreateBulkParams.Body.builder()
                    ...
                    .postEventElset(
                        ManeuverCreateBulkParams.Body.PostEventElset.builder()
                            .classificationMarking("U")
                            ...
                            .addSourcedDataType(
                                ManeuverCreateBulkParams.Body.PostEventElset.SourcedDataType.RADAR
                            )
                            .addSourcedDataType(
                                ManeuverCreateBulkParams.Body.PostEventElset.SourcedDataType.RF
                            )
                            .sourceDl("AXE")
                    ...
                    .postEventStateVector(
                        ManeuverCreateBulkParams.Body.PostEventStateVector.builder()
                            .classificationMarking("U")
                            .dataMode(
                                ManeuverCreateBulkParams.Body.PostEventStateVector.DataMode.TEST
                            )
                            .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .source("Bluestaq")
                            .actualOdSpan(3.5)
                            ...
                            .covReferenceFrame(
                                ManeuverCreateBulkParams.Body.PostEventStateVector.CovReferenceFrame
                                    .J2000
                            )
                            .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                            .createdBy("some.user")
                            ...
                            .recOdSpan(3.5)
                            .referenceFrame(
                                ManeuverCreateBulkParams.Body.PostEventStateVector.ReferenceFrame
                                    .J2000
                            )
                            .residualsAcc(99.5)
                            .revNo(7205)
                            ...
                            .addSourcedDataType(
                                ManeuverCreateBulkParams.Body.PostEventStateVector.SourcedDataType
                                    .RADAR
                            )
                            .sourceDl("AXE")
                            .srpArea(4.311)
                    ...
                    .preEventElset(
                        ManeuverCreateBulkParams.Body.PreEventElset.builder()
                            .classificationMarking("U")
                            ...
                            .addSourcedData("OBSERVATION_UUID2")
                            .addSourcedDataType(
                                ManeuverCreateBulkParams.Body.PreEventElset.SourcedDataType.RADAR
                            )
                            .addSourcedDataType(
                                ManeuverCreateBulkParams.Body.PreEventElset.SourcedDataType.RF
                            )
                            .sourceDl("AXE")
                            .addTag("PROVIDER_TAG1")
                            .addTag("PROVIDER_TAG2")
                    ...
                    .preEventStateVector(
                        ManeuverCreateBulkParams.Body.PreEventStateVector.builder()
                            .classificationMarking("U")
                            .dataMode(
                                ManeuverCreateBulkParams.Body.PreEventStateVector.DataMode.TEST
                            )
                            .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .source("Bluestaq")
                            .actualOdSpan(3.5)
                            ...
                            .covMethod("CALCULATED")
                            .covReferenceFrame(
                                ManeuverCreateBulkParams.Body.PreEventStateVector.CovReferenceFrame
                                    .J2000
                            )
                            .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                            .createdBy("some.user")
                            ...
                            .recOdSpan(3.5)
                            .referenceFrame(
                                ManeuverCreateBulkParams.Body.PreEventStateVector.ReferenceFrame
                                    .J2000
                            )
                            .residualsAcc(99.5)
                            .revNo(7205)
                            ...
                            .addSourcedData("DATA2")
                            .addSourcedDataType(
                                ManeuverCreateBulkParams.Body.PreEventStateVector.SourcedDataType
                                    .RADAR
                            )
                            .sourceDl("AXE")
                            .srpArea(4.311)
                    ...
                    ManeuverCreateBulkParams.Body.builder()
                        ...
                        .postEventElset(
                            ManeuverCreateBulkParams.Body.PostEventElset.builder()
                                .classificationMarking("U")
                                .dataMode(
                                    ManeuverCreateBulkParams.Body.PostEventElset.DataMode.TEST
                                )
                                .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                                .source("Bluestaq")
                                .agom(0.0126)
                                ...
                                .addSourcedData("OBSERVATION_UUID2")
                                .addSourcedDataType(
                                    ManeuverCreateBulkParams.Body.PostEventElset.SourcedDataType
                                        .RADAR
                                )
                                .addSourcedDataType(
                                    ManeuverCreateBulkParams.Body.PostEventElset.SourcedDataType.RF
                        ...
                        .postEventStateVector(
                            ManeuverCreateBulkParams.Body.PostEventStateVector.builder()
                                ...
                                .covMethod("CALCULATED")
                                .covReferenceFrame(
                                    ManeuverCreateBulkParams.Body.PostEventStateVector
                                        .CovReferenceFrame
                                        .J2000
                                )
                                .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        ...
                        .preEventElset(
                            ManeuverCreateBulkParams.Body.PreEventElset.builder()
                                ...
                                .addSourcedData("OBSERVATION_UUID2")
                                .addSourcedDataType(
                                    ManeuverCreateBulkParams.Body.PreEventElset.SourcedDataType
                                        .RADAR
                                )
                                .addSourcedDataType(
                                    ManeuverCreateBulkParams.Body.PreEventElset.SourcedDataType.RF
                        ...
                        .preEventStateVector(
                            ManeuverCreateBulkParams.Body.PreEventStateVector.builder()
                                ...
                                .covMethod("CALCULATED")
                                .covReferenceFrame(
                                    ManeuverCreateBulkParams.Body.PreEventStateVector
                                        .CovReferenceFrame
                                        .J2000
                                )
                                .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
