...
internal class SubstatusListResponseTest {
    ...
    @Test
    fun create() {
      val substatusListResponse = SubstatusListResponse.builder()
      ...
      assertThat(substatusListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubstatusListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(substatusListResponse), jacksonTypeRef<SubstatusListResponse>())
