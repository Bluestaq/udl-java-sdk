...
internal class CollectResponseFullTest {
    ...
    fun create() {
        ...
        assertThat(collectResponseFull.classificationMarking()).isEqualTo("U")
        assertThat(collectResponseFull.dataMode()).isEqualTo(CollectResponseFull.DataMode.TEST)
        assertThat(collectResponseFull.idRequest()).isEqualTo("REF-REQUEST-ID")
        assertThat(collectResponseFull.source()).isEqualTo("Bluestaq")
        assertThat(collectResponseFull.id()).contains("COLLECTRESPONSE-ID")
        assertThat(collectResponseFull.actualEndTime())
            .contains(OffsetDateTime.parse("2018-01-01T18:00:00.123456Z"))
        assertThat(collectResponseFull.actualStartTime())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
        assertThat(collectResponseFull.altEndTime())
            .contains(OffsetDateTime.parse("2018-01-01T18:00:00.123456Z"))
        assertThat(collectResponseFull.altStartTime())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
        assertThat(collectResponseFull.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(collectResponseFull.createdBy()).contains("some.user")
        assertThat(collectResponseFull.errCode()).contains("ERROR CODE")
        assertThat(collectResponseFull.externalId()).contains("EXTERNAL-ID")
        assertThat(collectResponseFull.idOnOrbit()).contains("REF-ONORBIT-ID")
        assertThat(collectResponseFull.idPlan()).contains("REF-PLAN-ID")
        assertThat(collectResponseFull.idSensor()).contains("REF-SENSOR-ID")
        assertThat(collectResponseFull.notes()).contains("Example notes")
        assertThat(collectResponseFull.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(collectResponseFull.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(collectResponseFull.origNetwork()).contains("ORIG")
        assertThat(collectResponseFull.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(collectResponseFull.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(collectResponseFull.satNo()).contains(101)
        assertThat(collectResponseFull.srcIds().getOrNull()).containsExactly("DOA_ID", "DWELL_ID")
        assertThat(collectResponseFull.srcTyps().getOrNull()).containsExactly("DOA", "DWELL")
        assertThat(collectResponseFull.status()).contains("ACCEPTED")
        assertThat(collectResponseFull.tags().getOrNull())
            .containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
        assertThat(collectResponseFull.taskId()).contains("TASK-ID")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectResponseFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectResponseFull),
                jacksonTypeRef<CollectResponseFull>(),
            )

        assertThat(roundtrippedCollectResponseFull).isEqualTo(collectResponseFull)
    }
}
