...
internal class SensorTupleResponseTest {
    ...
    fun create() {
            ...
            SensorTupleResponse.builder()
                ...
                .addSensorcharacteristic(
                    SensorTupleResponse.Sensorcharacteristic.builder()
                        ...
                        .addAcceptableSatIdFormat("5-DIGIT")
                        .addAcceptableSatIdFormat("ALPHA-5")
                        ...
                        .addRunMeanCode(0)
                        .addRunMeanCode(5)
                        .searchPatternPoints(listOf(0.0, 40.1, 60.1))
                        .settleTime(4.4)
                        ...
                        .taskableRange(20.23)
                        .taskingChannels(listOf("AD-HOC", "DAILY", "CTL"))
        ...
        assertThat(sensorTupleResponse.origNetwork()).contains("OPS1")
