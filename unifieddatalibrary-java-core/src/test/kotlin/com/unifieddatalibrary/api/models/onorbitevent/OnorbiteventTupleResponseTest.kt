...
internal class OnorbiteventTupleResponseTest {

    @Test
    fun create() {
        val onorbiteventTupleResponse =
            OnorbiteventTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(OnorbiteventTupleResponse.DataMode.TEST)
        ...
        assertThat(onorbiteventTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(onorbiteventTupleResponse.dataMode())
            .isEqualTo(OnorbiteventTupleResponse.DataMode.TEST)
        assertThat(onorbiteventTupleResponse.eventTime())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(onorbiteventTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(onorbiteventTupleResponse.id()).contains("ONORBITEVENT-ID")
        assertThat(onorbiteventTupleResponse.achievedFlightPhase()).contains("Phase 2")
        assertThat(onorbiteventTupleResponse.ageAtEvent()).contains(5.23)
        assertThat(onorbiteventTupleResponse.capabilityLoss()).contains(0.5)
        assertThat(onorbiteventTupleResponse.capabilityLossNotes()).contains("Example notes")
        assertThat(onorbiteventTupleResponse.capacityLoss()).contains(0.5)
        assertThat(onorbiteventTupleResponse.consequentialEquipmentFailure())
            .contains("Example Equipment")
        assertThat(onorbiteventTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(onorbiteventTupleResponse.createdBy()).contains("some.user")
        assertThat(onorbiteventTupleResponse.declassificationDate())
            .contains(OffsetDateTime.parse("2021-01-01T01:02:02.123Z"))
        assertThat(onorbiteventTupleResponse.declassificationString()).contains("DECLASS_STRING")
        assertThat(onorbiteventTupleResponse.derivedFrom()).contains("DERIVED_SOURCE")
        assertThat(onorbiteventTupleResponse.description()).contains("Example notes")
        assertThat(onorbiteventTupleResponse.equipmentAtFault()).contains("Example Equipment")
        assertThat(onorbiteventTupleResponse.equipmentCausingLossNotes()).contains("Example notes")
        assertThat(onorbiteventTupleResponse.equipmentPartAtFault()).contains("Example Equipment")
        assertThat(onorbiteventTupleResponse.equipmentTypeAtFault()).contains("Example Equipment")
        assertThat(onorbiteventTupleResponse.eventResult()).contains("Example results")
        assertThat(onorbiteventTupleResponse.eventTimeNotes()).contains("Notes on validity")
        assertThat(onorbiteventTupleResponse.eventType()).contains("Type1")
        assertThat(onorbiteventTupleResponse.geoPosition()).contains(45.23)
        assertThat(onorbiteventTupleResponse.idOnOrbit()).contains("ONORBIT-ID")
        assertThat(onorbiteventTupleResponse.inclined()).contains(false)
        assertThat(onorbiteventTupleResponse.injured()).contains(1)
        assertThat(onorbiteventTupleResponse.insuranceCarriedNotes()).contains("Insurance notes")
        assertThat(onorbiteventTupleResponse.insuranceLoss()).contains(0.5)
        assertThat(onorbiteventTupleResponse.insuranceLossNotes()).contains("Insurance notes")
        assertThat(onorbiteventTupleResponse.killed()).contains(23)
        assertThat(onorbiteventTupleResponse.lesseeOrgId()).contains("LESSEEORG-ID")
        assertThat(onorbiteventTupleResponse.lifeLost()).contains(0.5)
        assertThat(onorbiteventTupleResponse.netAmount()).contains(10000.23)
        assertThat(onorbiteventTupleResponse.objectStatus()).contains("Status1")
        assertThat(onorbiteventTupleResponse.occurrenceFlightPhase()).contains("Phase 2")
        assertThat(onorbiteventTupleResponse.officialLossDate())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
        assertThat(onorbiteventTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(onorbiteventTupleResponse.operatedOnBehalfOfOrgId())
            .contains("OPERATEDONBEHALFOFORG-ID")
        assertThat(onorbiteventTupleResponse.operatorOrgId()).contains("OPERATORORG-ID")
        assertThat(onorbiteventTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(onorbiteventTupleResponse.origNetwork()).contains("OPS1")
        assertThat(onorbiteventTupleResponse.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(onorbiteventTupleResponse.ownerOrgId()).contains("OWNERORG-ID")
        assertThat(onorbiteventTupleResponse.planeNumber()).contains("PL_1")
        assertThat(onorbiteventTupleResponse.planeSlot()).contains("example_slot")
        assertThat(onorbiteventTupleResponse.positionStatus()).contains("Stable")
        assertThat(onorbiteventTupleResponse.remarks()).contains("Example remarks")
        assertThat(onorbiteventTupleResponse.satellitePosition()).contains("Example description")
        assertThat(onorbiteventTupleResponse.satNo()).contains(1)
        assertThat(onorbiteventTupleResponse.stageAtFault()).contains("Phase 2")
        assertThat(onorbiteventTupleResponse.thirdPartyInsuranceLoss()).contains(10000.23)
        assertThat(onorbiteventTupleResponse.underlyingCause()).contains("CAUSE_EXAMPLE")
        assertThat(onorbiteventTupleResponse.untilTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
        assertThat(onorbiteventTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(onorbiteventTupleResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbiteventTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbiteventTupleResponse),
                jacksonTypeRef<OnorbiteventTupleResponse>(),
            )

        assertThat(roundtrippedOnorbiteventTupleResponse).isEqualTo(onorbiteventTupleResponse)
    }
}
