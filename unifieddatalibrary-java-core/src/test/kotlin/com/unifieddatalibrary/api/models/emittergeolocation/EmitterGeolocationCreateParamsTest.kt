...
internal class EmitterGeolocationCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.avgPrf()).contains(624.57)
        assertThat(body.avgPri()).contains(1601.1)
        assertThat(body.avgPw()).contains(400.2)
        ...
        assertThat(body.maxPrf()).contains(624.96)
        assertThat(body.maxPri()).contains(1602.1)
        assertThat(body.maxPw()).contains(400.3)
        assertThat(body.minFreq()).contains(1575.42)
        assertThat(body.minPrf()).contains(624.18)
        assertThat(body.minPri()).contains(1600.1)
        assertThat(body.minPw()).contains(400.1)
