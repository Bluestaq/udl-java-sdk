...
internal class OrbittrackTupleResponseTest {

    @Test
    fun create() {
        val orbittrackTupleResponse =
            OrbittrackTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(OrbittrackTupleResponse.DataMode.TEST)
                .lat(19.88550102)
                .lon(46.74596844)
                .source("Bluestaq")
                ...
                .iff("ID Mode")
                .installation(false)
                .objectType(OrbittrackTupleResponse.ObjectType.PAYLOAD)
                .objIdent(OrbittrackTupleResponse.ObjIdent.FRIEND)
                .onOrbit(
                    OnorbitFull.builder()
                        .classificationMarking("U")
                ...
                .taskForce(false)
                .addTrackSensor(
                    OrbittrackTupleResponse.TrackSensor.builder()
                        .az(90.0)
                        .range(4023.95)
                        .minRangeLimit(20.23)
                        .missionNumber("Example Mission")
                        .sensorFovType(OrbittrackTupleResponse.TrackSensor.SensorFovType.UNKNOWN)
        ...
        assertThat(orbittrackTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(orbittrackTupleResponse.dataMode())
            .isEqualTo(OrbittrackTupleResponse.DataMode.TEST)
        assertThat(orbittrackTupleResponse.lat()).isEqualTo(19.88550102)
        assertThat(orbittrackTupleResponse.lon()).isEqualTo(46.74596844)
        assertThat(orbittrackTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(orbittrackTupleResponse.ts())
            .isEqualTo(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
        assertThat(orbittrackTupleResponse.id()).contains("ORBIT_TRACK_ID")
        assertThat(orbittrackTupleResponse.alt()).contains(585.71)
        assertThat(orbittrackTupleResponse.amplification())
            .contains("A note regarding this spacecraft")
        assertThat(orbittrackTupleResponse.angElev()).contains(15.2)
        assertThat(orbittrackTupleResponse.aouData().getOrNull()).containsExactly(34.3, 26.5, 1.2)
        assertThat(orbittrackTupleResponse.aouType()).contains("ELLIPSE")
        assertThat(orbittrackTupleResponse.callSign()).contains("Charlie")
        assertThat(orbittrackTupleResponse.charlieLine())
            .contains("323751332255940400010000003635829600010200072500098205001150")
        assertThat(orbittrackTupleResponse.chXRef()).contains("FHKX")
        assertThat(orbittrackTupleResponse.cntnmnt()).contains(90.0)
        assertThat(orbittrackTupleResponse.countryCode()).contains("US")
        assertThat(orbittrackTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2021-02-25T12:00:00.123Z"))
        assertThat(orbittrackTupleResponse.createdBy()).contains("some.user")
        assertThat(orbittrackTupleResponse.decay()).contains(0.5868)
        assertThat(orbittrackTupleResponse.dummy()).contains(false)
        assertThat(orbittrackTupleResponse.feint()).contains(false)
        assertThat(orbittrackTupleResponse.hq()).contains(false)
        assertThat(orbittrackTupleResponse.idElset())
            .contains("c715a619-8695-44d2-9e7d-effd257b4843")
        assertThat(orbittrackTupleResponse.identAmp()).contains("JOKER")
        assertThat(orbittrackTupleResponse.idOnOrbit()).contains("32375")
        assertThat(orbittrackTupleResponse.iff()).contains("ID Mode")
        assertThat(orbittrackTupleResponse.installation()).contains(false)
        assertThat(orbittrackTupleResponse.objectType())
            .contains(OrbittrackTupleResponse.ObjectType.PAYLOAD)
        assertThat(orbittrackTupleResponse.objIdent())
            .contains(OrbittrackTupleResponse.ObjIdent.FRIEND)
        assertThat(orbittrackTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(orbittrackTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(orbittrackTupleResponse.origNetwork()).contains("ORIG")
        assertThat(orbittrackTupleResponse.origObjectId()).contains("L2045")
        assertThat(orbittrackTupleResponse.rdfRf()).contains(1.5273)
        assertThat(orbittrackTupleResponse.reduced()).contains(false)
        assertThat(orbittrackTupleResponse.reinforced()).contains(false)
        assertThat(orbittrackTupleResponse.rptNum()).contains("123")
        assertThat(orbittrackTupleResponse.satNo()).contains(37375)
        assertThat(orbittrackTupleResponse.satStatus()).contains("INACTIVE")
        assertThat(orbittrackTupleResponse.spd()).contains(15.03443)
        assertThat(orbittrackTupleResponse.taskForce()).contains(false)
        assertThat(orbittrackTupleResponse.trackSensors().getOrNull())
            .containsExactly(
                OrbittrackTupleResponse.TrackSensor.builder()
                    .az(90.0)
                    .range(4023.95)
        ...
        assertThat(orbittrackTupleResponse.trkId()).contains("3668f135-fcba-4630-a43d-e7782e11d988")
        assertThat(orbittrackTupleResponse.vehType()).contains("SPACE")
        assertThat(orbittrackTupleResponse.xref()).contains("XE")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedOrbittrackTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(orbittrackTupleResponse),
                jacksonTypeRef<OrbittrackTupleResponse>(),
            )

        assertThat(roundtrippedOrbittrackTupleResponse).isEqualTo(orbittrackTupleResponse)
    }
}
