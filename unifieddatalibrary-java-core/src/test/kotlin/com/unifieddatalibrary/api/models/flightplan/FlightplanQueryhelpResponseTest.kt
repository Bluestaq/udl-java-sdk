...
internal class FlightplanQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val flightplanQueryhelpResponse =
            FlightplanQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(flightplanQueryhelpResponse.classificationMarking())
        ...
        assertThat(flightplanQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(flightplanQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedFlightplanQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(flightplanQueryhelpResponse),
                jacksonTypeRef<FlightplanQueryhelpResponse>(),
            )
