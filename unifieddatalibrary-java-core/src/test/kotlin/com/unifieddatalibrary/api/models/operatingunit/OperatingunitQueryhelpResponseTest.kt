...
internal class OperatingunitQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val operatingunitQueryhelpResponse = OperatingunitQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(operatingunitQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(operatingunitQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(operatingunitQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedOperatingunitQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(operatingunitQueryhelpResponse), jacksonTypeRef<OperatingunitQueryhelpResponse>())

      assertThat(roundtrippedOperatingunitQueryhelpResponse).isEqualTo(operatingunitQueryhelpResponse)
    }
}
