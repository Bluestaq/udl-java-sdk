...
internal class DatalinkListResponseTest {
    ...
    @Test
    fun create() {
      val datalinkListResponse = DatalinkListResponse.builder()
          ...
          .minTrackQual(6)
          .month("OCT")
          .addMultiDuty(DatalinkListResponse.MultiDuty.builder()
              .duty("SICO")
              .addDutyTeleFreqNum("TEL:804-555-4142")
              .addDutyTeleFreqNum("TEL:804-867-5309")
              .addMultiDutyVoiceCoord(DatalinkListResponse.MultiDuty.MultiDutyVoiceCoord.builder()
                  .multiCommPri("P")
                  .multiFreqDes("ST300A")
          ...
          .opExInfo("CONTROL")
          .opExInfoAlt("ORANGE")
          .addOp(DatalinkListResponse.Op.builder()
          ...
          .addReference(DatalinkListResponse.Reference.builder()
              ...
              .refType("ABSTAT")
              .build())
          .addRefPoint(DatalinkListResponse.RefPoint.builder()
              ...
              .refPointType("DLRP")
              .build())
          .addRemark(DatalinkListResponse.Remark.builder()
          ...
          .serialNum("1201003")
          .sourceDl("AXE")
          .addSpecTrack(DatalinkListResponse.SpecTrack.builder()
              .specTrackNum("12345")
          ...
          .updatedBy("some.user")
          .addVoiceCoord(DatalinkListResponse.VoiceCoord.builder()
              .commPri("P")
              .freqDes("ST300A")
      ...
      assertThat(datalinkListResponse.startTime()).isEqualTo(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
      assertThat(datalinkListResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      assertThat(datalinkListResponse.ackInstUnits().getOrNull()).containsExactly("AOC EXT 2345", "317 AW")
      ...
      assertThat(datalinkListResponse.canxTs()).contains(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
      ...
      assertThat(datalinkListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(datalinkListResponse.decInstDates().getOrNull()).containsExactly("AT EXERCISE ENDEX", "DATE:25NOV1997")
      ...
      assertThat(datalinkListResponse.multiDuty().getOrNull()).containsExactly(DatalinkListResponse.MultiDuty.builder()
          .duty("SICO")
          .addDutyTeleFreqNum("TEL:804-555-4142")
          .addDutyTeleFreqNum("TEL:804-867-5309")
          .addMultiDutyVoiceCoord(DatalinkListResponse.MultiDuty.MultiDutyVoiceCoord.builder()
          ...
          .unitDes("SHIP:STENNIS")
          .build())
      assertThat(datalinkListResponse.nonLinkUnitDes().getOrNull()).containsExactly("CS:GRAY GHOST", "CS:WHITE WHALE")
      assertThat(datalinkListResponse.opExInfo()).contains("CONTROL")
      assertThat(datalinkListResponse.opExInfoAlt()).contains("ORANGE")
      assertThat(datalinkListResponse.ops().getOrNull()).containsExactly(DatalinkListResponse.Op.builder()
          .linkDetails("Link details")
          .linkName("Link-16")
          .linkStartTime(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
          .linkStopTime(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
      ...
      assertThat(datalinkListResponse.pocNums().getOrNull()).containsExactly("TEL:804-555-4142", "TEL:804-867-5309")
      ...
      assertThat(datalinkListResponse.references().getOrNull()).containsExactly(DatalinkListResponse.Reference.builder()
          .refOriginator("CENTCOM")
          .refSerialId("A")
          .refSerialNum("1402001")
          .addRefSiC("RDU")
          ...
          .refType("ABSTAT")
          .build())
      assertThat(datalinkListResponse.refPoints().getOrNull()).containsExactly(DatalinkListResponse.RefPoint.builder()
          .effEventTime(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
          .refDes("L5")
          .refLat(45.23)
          .refLocName("FORT BRAGG")
          ...
          .refPointType("DLRP")
          .build())
      assertThat(datalinkListResponse.remarks().getOrNull()).containsExactly(DatalinkListResponse.Remark.builder()
          .text("Example data link remarks")
          .type("CONTINGENCY PROCEDURES")
          .build())
      ...
      assertThat(datalinkListResponse.specTracks().getOrNull()).containsExactly(DatalinkListResponse.SpecTrack.builder()
          .specTrackNum("12345")
          .specTrackNumDesc("SAM SITE CHARLIE")
          .build())
      assertThat(datalinkListResponse.speedDiff()).contains(50)
      assertThat(datalinkListResponse.stopTime()).contains(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
      ...
      assertThat(datalinkListResponse.trackNumBlocks().getOrNull()).containsExactly("0200-0300", "0400-4412")
      assertThat(datalinkListResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(datalinkListResponse.updatedBy()).contains("some.user")
      assertThat(datalinkListResponse.voiceCoord().getOrNull()).containsExactly(DatalinkListResponse.VoiceCoord.builder()
          .commPri("P")
          .freqDes("ST300A")
          .addTeleFreqNum("TEL:804-555-4142")
          .addTeleFreqNum("TEL:804-867-5309")
    ...
    fun roundtrip() {
      ...
      val roundtrippedDatalinkListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(datalinkListResponse), jacksonTypeRef<DatalinkListResponse>())
