...
internal class IsrCollectionPocFullTest {
    ...
    @Test
    fun create() {
      val isrCollectionPocFull = IsrCollectionPocFull.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedIsrCollectionPocFull = jsonMapper.readValue(jsonMapper.writeValueAsString(isrCollectionPocFull), jacksonTypeRef<IsrCollectionPocFull>())
