...
internal class RfBandFullTest {
    ...
    @Test
    fun create() {
      val rfBandFull = RfBandFull.builder()
      ...
      assertThat(rfBandFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(rfBandFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfBandFull = jsonMapper.readValue(jsonMapper.writeValueAsString(rfBandFull), jacksonTypeRef<RfBandFull>())
