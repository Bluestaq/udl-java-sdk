...
internal class GroundImageryHistoryAodrParamsTest {
    ...
    fun queryParams() {
        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder()
                    .put("imageTime", "2019-12-27T18:11:19.117Z")
                    .put("columns", "columns")
                    .put("firstResult", "0")
                    .put("maxResults", "0")
    ...
    fun queryParamsWithoutOptionalFields() {
        ...
        assertThat(queryParams)
            .isEqualTo(QueryParams.builder().put("imageTime", "2019-12-27T18:11:19.117Z").build())
    }
}
