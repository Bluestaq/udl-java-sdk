...
internal class AirEventCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(AirEventCreateParams.DataMode.TEST)
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.type()).isEqualTo("FUEL TRANSFER")
        assertThat(body.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(body.actualArrTime()).contains(OffsetDateTime.parse("2024-01-07T14:00:03.123Z"))
        assertThat(body.actualDepTime()).contains(OffsetDateTime.parse("2024-01-07T14:17:03.123Z"))
        assertThat(body.arct()).contains(OffsetDateTime.parse("2024-01-07T15:11:27.123Z"))
        assertThat(body.arEventType()).contains("V")
        assertThat(body.arrPurpose()).contains("A")
        assertThat(body.arTrackId()).contains("CH61")
        assertThat(body.arTrackName()).contains("CH61 POST")
        assertThat(body.baseAlt()).contains(28000.1)
        assertThat(body.cancelled()).contains(false)
        assertThat(body.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(body.createdBy()).contains("some.user")
        assertThat(body.depPurpose()).contains("Q")
        assertThat(body.estArrTime()).contains(OffsetDateTime.parse("2024-01-07T13:59:48.123Z"))
        assertThat(body.estDepTime()).contains(OffsetDateTime.parse("2024-01-07T14:19:48.123Z"))
        assertThat(body.externalAirEventId()).contains("MB014313032022407540")
        assertThat(body.externalArTrackId()).contains("6418a4b68e5c3896bf024cc79aa4174c")
        assertThat(body.idMission()).contains("190dea6d-2a90-45a2-a276-be9047d9b96c")
        assertThat(body.idSortie()).contains("b9866c03-2397-4506-8153-852e72d9b54f")
        assertThat(body.legNum()).contains(825)
        assertThat(body.location()).contains("901EW")
        assertThat(body.numTankers()).contains(1)
        assertThat(body.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(body.origNetwork()).contains("OPS1")
        assertThat(body.plannedArrTime()).contains(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
        assertThat(body.plannedDepTime()).contains(OffsetDateTime.parse("2024-01-07T14:15:43.123Z"))
        assertThat(body.priority()).contains("1A2")
        assertThat(body.receivers().getOrNull())
            .containsExactly(
                AirEventCreateParams.Receiver.builder()
                    .altReceiverMissionId("1UN05201L121")
                    .amcReceiverMissionId("8PH000B1S052")
        ...
        assertThat(body.revTrack()).contains(true)
        assertThat(body.rzct()).contains(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
        assertThat(body.rzPoint()).contains("AN")
        assertThat(body.rzType()).contains("PP")
        assertThat(body.shortTrack()).contains(true)
        assertThat(body.sourceDl()).contains("AXE")
        assertThat(body.statusCode()).contains("R")
        assertThat(body.tankers().getOrNull())
            .containsExactly(
                AirEventCreateParams.Tanker.builder()
                    .altTankerMissionId("1UN05201L121")
                    .amcTankerMissionId("8PH000B1S052")
        ...
        assertThat(body.trackTime()).contains(1.5)
