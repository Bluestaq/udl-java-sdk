...
internal class LaseremitterGetResponseTest {

    @Test
    fun create() {
        val laseremitterGetResponse =
            LaseremitterGetResponse.builder()
                .classificationMarking("U")
                .dataMode(LaseremitterGetResponse.DataMode.TEST)
                .laserName("HEL")
                .laserType("PULSED")
                .source("Bluestaq")
        ...
        assertThat(laseremitterGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(laseremitterGetResponse.dataMode())
            .isEqualTo(LaseremitterGetResponse.DataMode.TEST)
        assertThat(laseremitterGetResponse.laserName()).isEqualTo("HEL")
        assertThat(laseremitterGetResponse.laserType()).isEqualTo("PULSED")
        assertThat(laseremitterGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(laseremitterGetResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(laseremitterGetResponse.atmosphericTransmission()).contains(1.0)
        assertThat(laseremitterGetResponse.beamOutputPower()).contains(100.5)
        assertThat(laseremitterGetResponse.beamWaist()).contains(14.4)
        assertThat(laseremitterGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(laseremitterGetResponse.createdBy()).contains("some.user")
        assertThat(laseremitterGetResponse.divergence()).contains(2.5)
        assertThat(laseremitterGetResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(laseremitterGetResponse.idEntity()).contains("ENTITY-ID")
        assertThat(laseremitterGetResponse.isOperational()).contains(true)
        assertThat(laseremitterGetResponse.maxDuration()).contains(1.5)
        assertThat(laseremitterGetResponse.maxFocusRange()).contains(30000.5)
        assertThat(laseremitterGetResponse.minFocusRange()).contains(2500.5)
        assertThat(laseremitterGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(laseremitterGetResponse.origNetwork()).contains("OPS1")
        assertThat(laseremitterGetResponse.pulseFluence()).contains(1000005.5)
        assertThat(laseremitterGetResponse.pulsePeakPower()).contains(640.25)
        assertThat(laseremitterGetResponse.pulseRepFreq()).contains(2225.5)
        assertThat(laseremitterGetResponse.pulseShape()).contains("RECTANGULAR")
        assertThat(laseremitterGetResponse.pulseWidth()).contains(0.25)
        assertThat(laseremitterGetResponse.sourceDl()).contains("AXE")
        assertThat(laseremitterGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(laseremitterGetResponse.updatedBy()).contains("some.user")
        assertThat(laseremitterGetResponse.wavelength()).contains(0.11)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedLaseremitterGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(laseremitterGetResponse),
                jacksonTypeRef<LaseremitterGetResponse>(),
            )

        assertThat(roundtrippedLaseremitterGetResponse).isEqualTo(laseremitterGetResponse)
    }
}
