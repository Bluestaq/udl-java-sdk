...
internal class SarObservationCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = SarObservationCreateParams.builder()
          .classificationMarking("U")
          .collectionEnd(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
          .collectionStart(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
          .dataMode(SarObservationCreateParams.DataMode.TEST)
      ...
      assertThat(body.collectionEnd()).isEqualTo(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
      assertThat(body.collectionStart()).isEqualTo(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
      ...
      assertThat(body.detectionEnd()).contains(OffsetDateTime.parse("2023-07-08T17:35:20.772190Z"))
      assertThat(body.detectionId()).contains("DETECTION-ID")
      assertThat(body.detectionStart()).contains(OffsetDateTime.parse("2023-07-08T17:35:01.615396Z"))
      ...
      assertThat(body.srcIds().getOrNull()).containsExactly("f7e01cd4-626b-441f-a423-17b160eb78ba", "223833c4-be0d-4fdb-a2e4-325a48eccced")
