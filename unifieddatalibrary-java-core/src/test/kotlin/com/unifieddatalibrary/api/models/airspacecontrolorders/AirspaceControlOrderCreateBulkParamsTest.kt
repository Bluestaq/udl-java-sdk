...
internal class AirspaceControlOrderCreateBulkParamsTest {

    @Test
    fun create() {
      AirspaceControlOrderCreateBulkParams.builder()
          .addBody(AirspaceControlOrderCreateBulkParams.Body.builder()
              ...
              .acoSerialNum("27B")
              .addAirspaceControlMeansStatus(AirspaceControlOrderCreateBulkParams.Body.AirspaceControlMeansStatus.builder()
                  .addAirspaceControlMean(AirspaceControlOrderCreateBulkParams.Body.AirspaceControlMeansStatus.AirspaceControlMean.builder()
                      .addAirspaceControlPoint(AirspaceControlOrderCreateBulkParams.Body.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceControlPoint.builder()
                          .ctrlPtAltitude("BRFL:MSL-FL230")
                          .ctrlPtLocation("203632N0594256E")
                          .ctrlPtName("APPLE")
                          .ctrlPtType("CP")
                          .build())
                      .addAirspaceTimePeriod(AirspaceControlOrderCreateBulkParams.Body.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceTimePeriod.builder()
                          .addIntDur("65WK")
                          .addIntFreq("WEEKLY")
                      ...
                      .bearing1(160.0)
                      .cmId("DESIG:C34")
                      .cmShape(AirspaceControlOrderCreateBulkParams.Body.AirspaceControlMeansStatus.AirspaceControlMean.CmShape.POLYARC)
                      .cmType("cmType")
                  ...
                  .build())
              .addAirspaceControlOrderReference(AirspaceControlOrderCreateBulkParams.Body.AirspaceControlOrderReference.builder()
                  .refOriginator("SHAPE")
                  .refSerialNum("100")
                  .addRefSiC("RCA")
                  .addRefSiC("FN:4503B")
    ...
    @Test
    fun body() {
      val params = AirspaceControlOrderCreateBulkParams.builder()
          .addBody(AirspaceControlOrderCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(AirspaceControlOrderCreateBulkParams.Body.DataMode.TEST)
              .opExName("DESERT WIND")
      ...
      assertThat(body).containsExactly(AirspaceControlOrderCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(AirspaceControlOrderCreateBulkParams.Body.DataMode.TEST)
          .opExName("DESERT WIND")
          .originator("USCENTCOM")
