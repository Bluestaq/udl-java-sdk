...
internal class NavigationalObstructionQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val navigationalObstructionQueryhelpResponse = NavigationalObstructionQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(navigationalObstructionQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(navigationalObstructionQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(navigationalObstructionQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedNavigationalObstructionQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(navigationalObstructionQueryhelpResponse), jacksonTypeRef<NavigationalObstructionQueryhelpResponse>())

      assertThat(roundtrippedNavigationalObstructionQueryhelpResponse).isEqualTo(navigationalObstructionQueryhelpResponse)
    }
}
