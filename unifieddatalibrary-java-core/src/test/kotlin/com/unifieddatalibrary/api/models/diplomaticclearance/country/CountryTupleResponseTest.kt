...
internal class CountryTupleResponseTest {
    ...
    @Test
    fun create() {
        val countryTupleResponse =
            CountryTupleResponse.builder()
                ...
                .addDiplomaticClearanceCountryContact(
                    CountryTupleResponse.DiplomaticClearanceCountryContact.builder()
                        .ahNum("256039858")
                        .ahSpdDialCode("75")
                        .commNum("904716104")
                        .commSpdDialCode("74")
                ...
                .addDiplomaticClearanceCountryEntryExitPoint(
                    CountryTupleResponse.DiplomaticClearanceCountryEntryExitPoint.builder()
                        .isEntry(true)
                        .isExit(true)
                        .pointName("BATEL")
                        .build()
                ...
                .addDiplomaticClearanceCountryProfile(
                    CountryTupleResponse.DiplomaticClearanceCountryProfile.builder()
        ...
        assertThat(countryTupleResponse.lastChangedDate())
        ...
        assertThat(countryTupleResponse.countryRemark())
            .contains("Amsterdam airport EHAM will not accept hazardous cargo.")
        assertThat(countryTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(countryTupleResponse.createdBy()).contains("some.user")
        assertThat(countryTupleResponse.diplomaticClearanceCountryContacts().getOrNull())
            .containsExactly(
                CountryTupleResponse.DiplomaticClearanceCountryContact.builder()
                    .ahNum("256039858")
                    .ahSpdDialCode("75")
        ...
        assertThat(countryTupleResponse.diplomaticClearanceCountryEntryExitPoints().getOrNull())
            .containsExactly(
                CountryTupleResponse.DiplomaticClearanceCountryEntryExitPoint.builder()
                    .isEntry(true)
                    .isExit(true)
        ...
        assertThat(countryTupleResponse.diplomaticClearanceCountryProfiles().getOrNull())
            .containsExactly(
                CountryTupleResponse.DiplomaticClearanceCountryProfile.builder()
                    .cargoPaxRemark("Cargo passenger remark")
                    .clearanceId("MDCNPER231360050AAR")
        ...
        assertThat(countryTupleResponse.officeRemark())
        ...
        assertThat(countryTupleResponse.origNetwork()).contains("OPS1")
        assertThat(countryTupleResponse.sourceDl()).contains("AXE")
        assertThat(countryTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedCountryTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(countryTupleResponse),
                jacksonTypeRef<CountryTupleResponse>(),
            )
