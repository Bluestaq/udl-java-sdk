...
internal class PersonnelrecoveryListResponseTest {
    ...
    @Test
    fun create() {
      val personnelrecoveryListResponse = PersonnelrecoveryListResponse.builder()
          ...
          .createdBy("some.user")
          .executionInfo(PersonnelrecoveryListResponse.ExecutionInfo.builder()
              .egress(66.53)
              .addEgressPoint(107.23)
              .addEgressPoint(30.455)
              .escortVehicle(PersonnelrecoveryListResponse.ExecutionInfo.EscortVehicle.builder()
                  .callSign("FALCO")
                  .primaryFreq(34.55)
                  .strength(5)
                  .type("C17")
              ...
              .recoveryVehicle(PersonnelrecoveryListResponse.ExecutionInfo.RecoveryVehicle.builder()
                  .callSign("FALCO")
                  .primaryFreq(34.55)
                  .strength(5)
                  .type("C17")
          ...
          .numNonAmbulatory(0)
          .numPersons(1)
          .objectiveAreaInfo(PersonnelrecoveryListResponse.ObjectiveAreaInfo.builder()
              .addEnemyData(PersonnelrecoveryListResponse.ObjectiveAreaInfo.EnemyData.builder()
      ...
      assertThat(personnelrecoveryListResponse.dataMode()).isEqualTo(PersonnelrecoveryListResponse.DataMode.TEST)
      assertThat(personnelrecoveryListResponse.msgTime()).isEqualTo(OffsetDateTime.parse("2021-10-15T16:00:00.123Z"))
      ...
      assertThat(personnelrecoveryListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(personnelrecoveryListResponse.createdBy()).contains("some.user")
      assertThat(personnelrecoveryListResponse.executionInfo()).contains(PersonnelrecoveryListResponse.ExecutionInfo.builder()
          .egress(66.53)
          .addEgressPoint(107.23)
          .addEgressPoint(30.455)
          .escortVehicle(PersonnelrecoveryListResponse.ExecutionInfo.EscortVehicle.builder()
      ...
      assertThat(personnelrecoveryListResponse.objectiveAreaInfo()).contains(PersonnelrecoveryListResponse.ObjectiveAreaInfo.builder()
          .addEnemyData(PersonnelrecoveryListResponse.ObjectiveAreaInfo.EnemyData.builder()
              .dirToEnemy("NORTHWEST")
              .friendliesRemarks("Comments from friendlies.")
              .hlzRemarks("Hot Landing Zone remarks.")
      ...
      assertThat(personnelrecoveryListResponse.origNetwork()).contains("ORIG")
      ...
      assertThat(personnelrecoveryListResponse.survivorMessages()).contains("UNINJURED CANT MOVE HOSTILES NEARBY")
      ...
      assertThat(personnelrecoveryListResponse.textMsg()).contains("Additional message from survivor.")
    ...
    fun roundtrip() {
      ...
      val roundtrippedPersonnelrecoveryListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(personnelrecoveryListResponse), jacksonTypeRef<PersonnelrecoveryListResponse>())

      assertThat(roundtrippedPersonnelrecoveryListResponse).isEqualTo(personnelrecoveryListResponse)
    }
}
