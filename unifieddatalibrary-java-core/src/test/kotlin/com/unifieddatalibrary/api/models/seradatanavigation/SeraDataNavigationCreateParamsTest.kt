...
internal class SeraDataNavigationCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = SeraDataNavigationCreateParams.builder()
          .classificationMarking("U")
          .dataMode(SeraDataNavigationCreateParams.DataMode.TEST)
          .source("Bluestaq")
          .spacecraftId("spacecraftId")
      ...
      assertThat(body.dataMode()).isEqualTo(SeraDataNavigationCreateParams.DataMode.TEST)
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.spacecraftId()).isEqualTo("spacecraftId")
      assertThat(body.id()).contains("SERADATANAVIGATION-ID")
