...
internal class CollectRequestCreateParamsTest {
    ...
    fun create() {
      CollectRequestCreateParams.builder()
          ...
          .eccentricity(1.1)
          .el(1.1)
          .elset(CollectRequestCreateParams.Elset.builder()
              .classificationMarking("U")
          ...
          .srchInc(1.1)
          .srchPattern("SCAN")
          .stateVector(CollectRequestCreateParams.StateVector.builder()
              .classificationMarking("U")
              ...
              .covReferenceFrame(CollectRequestCreateParams.StateVector.CovReferenceFrame.J2000)
              .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
              .createdBy("some.user")
              ...
              .addSourcedDataType(CollectRequestCreateParams.StateVector.SourcedDataType.RADAR)
              .sourceDl("AXE")
              .srpArea(4.311)
              .stepMode("AUTO")
              .stepSize(1.23)
    ...
    @Test
    fun body() {
      val params = CollectRequestCreateParams.builder()
          .classificationMarking("U")
          .dataMode(CollectRequestCreateParams.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(body.elset()).contains(CollectRequestCreateParams.Elset.builder()
          .classificationMarking("U")
          .dataMode(CollectRequestCreateParams.Elset.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
      ...
      assertThat(body.stateVector()).contains(CollectRequestCreateParams.StateVector.builder()
          .classificationMarking("U")
          .dataMode(CollectRequestCreateParams.StateVector.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
