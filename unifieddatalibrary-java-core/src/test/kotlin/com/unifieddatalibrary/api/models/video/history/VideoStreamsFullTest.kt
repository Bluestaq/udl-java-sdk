...
internal class VideoStreamsFullTest {
    ...
    fun create() {
        ...
        assertThat(videoStreamsFull.createdAt())
        ...
        assertThat(videoStreamsFull.startTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoStreamsFull.stopTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoStreamsFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(videoStreamsFull.updatedBy()).contains("some.user")
        assertThat(videoStreamsFull.videoUrls().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedVideoStreamsFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(videoStreamsFull),
                jacksonTypeRef<VideoStreamsFull>(),
            )
