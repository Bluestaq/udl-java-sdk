...
internal class ScientificTupleResponseTest {

    @Test
    fun create() {
        val scientificTupleResponse =
            ScientificTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(ScientificTupleResponse.DataMode.TEST)
                .name("SEM/MAG")
                .source("Bluestaq")
        ...
        assertThat(scientificTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(scientificTupleResponse.dataMode())
            .isEqualTo(ScientificTupleResponse.DataMode.TEST)
        assertThat(scientificTupleResponse.name()).isEqualTo("SEM/MAG")
        assertThat(scientificTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(scientificTupleResponse.spacecraftId()).isEqualTo("REF-SPACECRAFT-ID")
        assertThat(scientificTupleResponse.id()).contains("SCIENTIFIC-ID")
        assertThat(scientificTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(scientificTupleResponse.createdBy()).contains("some.user")
        assertThat(scientificTupleResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(scientificTupleResponse.frequencyBand()).contains("Gamma")
        assertThat(scientificTupleResponse.hostedForCompanyOrgId())
            .contains("REF-HOSTEDFORCOMPANYORG-ID")
        assertThat(scientificTupleResponse.idEntity())
            .contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
        assertThat(scientificTupleResponse.manufacturerOrgId()).contains("REF-MANUFACTURERORG-ID")
        assertThat(scientificTupleResponse.notes()).contains("NOTES")
        assertThat(scientificTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(scientificTupleResponse.origNetwork()).contains("ORIG")
        assertThat(scientificTupleResponse.payloadCategory()).contains("Sensor")
        assertThat(scientificTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(scientificTupleResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedScientificTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(scientificTupleResponse),
                jacksonTypeRef<ScientificTupleResponse>(),
            )

        assertThat(roundtrippedScientificTupleResponse).isEqualTo(scientificTupleResponse)
    }
}
