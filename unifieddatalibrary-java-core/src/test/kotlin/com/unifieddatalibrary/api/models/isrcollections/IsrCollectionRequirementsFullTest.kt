...
internal class IsrCollectionRequirementsFullTest {
    ...
    @Test
    fun create() {
        val isrCollectionRequirementsFull =
        ...
        assertThat(isrCollectionRequirementsFull.criticalTimes())
            .contains(
                IsrCollectionCriticalTimesFull.builder()
                    .earliestImagingTime(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                    .latestImagingTime(OffsetDateTime.parse("2021-01-19T01:11:15.001Z"))
        ...
        assertThat(isrCollectionRequirementsFull.exploitationRequirement())
            .contains(
                IsrCollectionExploitationRequirementFull.builder()
                    .id("ISRCOLLECTIONEXPLOITATIONREQUIREMENT")
                    .amplification("AMPLIFICATION")
        ...
        assertThat(isrCollectionRequirementsFull.start())
            .contains(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
        assertThat(isrCollectionRequirementsFull.stop())
            .contains(OffsetDateTime.parse("2021-01-19T01:20:01.001Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedIsrCollectionRequirementsFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(isrCollectionRequirementsFull),
                jacksonTypeRef<IsrCollectionRequirementsFull>(),
            )

        assertThat(roundtrippedIsrCollectionRequirementsFull)
            .isEqualTo(isrCollectionRequirementsFull)
    }
}
