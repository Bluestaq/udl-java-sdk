...
internal class AircraftstatusremarkAbridgedTest {
    ...
    @Test
    fun create() {
        val aircraftstatusremarkAbridged =
            AircraftstatusremarkAbridged.builder()
        ...
        assertThat(aircraftstatusremarkAbridged.dataMode())
            .isEqualTo(AircraftstatusremarkAbridged.DataMode.TEST)
        assertThat(aircraftstatusremarkAbridged.idAircraftStatus())
        ...
        assertThat(aircraftstatusremarkAbridged.id())
        ...
        assertThat(aircraftstatusremarkAbridged.createdAt())
        ...
        assertThat(aircraftstatusremarkAbridged.lastUpdatedAt())
        ...
        assertThat(aircraftstatusremarkAbridged.timestamp())
    ...
    fun roundtrip() {
        ...
        val roundtrippedAircraftstatusremarkAbridged =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(aircraftstatusremarkAbridged),
                jacksonTypeRef<AircraftstatusremarkAbridged>(),
            )
