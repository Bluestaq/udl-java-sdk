...
internal class AirTransportMissionCreateParamsTest {
    ...
    fun create() {
      AirTransportMissionCreateParams.builder()
          ...
          .addHazMat(AirTransportMissionCreateParams.HazMat.builder()
          ...
          .addRemark(AirTransportMissionCreateParams.Remark.builder()
              ...
              .user("John Doe")
              .build())
          .addRequirement(AirTransportMissionCreateParams.Requirement.builder()
              .bulkWeight(1.3)
    ...
    @Test
    fun body() {
      val params = AirTransportMissionCreateParams.builder()
          .classificationMarking("U")
          .dataMode(AirTransportMissionCreateParams.DataMode.TEST)
          .source("Bluestaq")
          .id("bdad6945-c9e4-b829-f7be-1ad075541921")
      ...
      assertThat(body.dataMode()).isEqualTo(AirTransportMissionCreateParams.DataMode.TEST)
      ...
      assertThat(body.hazMat().getOrNull()).containsExactly(AirTransportMissionCreateParams.HazMat.builder()
          .applicableNotes("11,12")
          .cgc("A")
          .cgn("4,5,7,8")
          .classDiv(1.1)
      ...
      assertThat(body.remarks().getOrNull()).containsExactly(AirTransportMissionCreateParams.Remark.builder()
          .date(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
          .gdssRemarkId("GDSSREMARK-ID")
          .itineraryNum(825)
          .text("Example mission remarks.")
          ...
          .user("John Doe")
          .build())
      assertThat(body.requirements().getOrNull()).containsExactly(AirTransportMissionCreateParams.Requirement.builder()
          .bulkWeight(1.3)
          .ead(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
          .gdssReqId("23a1fb67-cc2d-5ebe-6b99-68130cb1aa6c")
          .lad(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
