...
internal class ConjunctionQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val conjunctionQueryhelpResponse = ConjunctionQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(conjunctionQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(conjunctionQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(conjunctionQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedConjunctionQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(conjunctionQueryhelpResponse), jacksonTypeRef<ConjunctionQueryhelpResponse>())
