...
internal class DiplomaticClearanceQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val diplomaticClearanceQueryhelpResponse = DiplomaticClearanceQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(diplomaticClearanceQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(diplomaticClearanceQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(diplomaticClearanceQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedDiplomaticClearanceQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(diplomaticClearanceQueryhelpResponse), jacksonTypeRef<DiplomaticClearanceQueryhelpResponse>())

      assertThat(roundtrippedDiplomaticClearanceQueryhelpResponse).isEqualTo(diplomaticClearanceQueryhelpResponse)
    }
}
