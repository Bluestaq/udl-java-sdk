...
internal class TrackUnvalidatedPublishParamsTest {
    ...
    fun create() {
      TrackUnvalidatedPublishParams.builder()
          .addBody(TrackUnvalidatedPublishParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = TrackUnvalidatedPublishParams.builder()
          .addBody(TrackUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(TrackUnvalidatedPublishParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(TrackUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(TrackUnvalidatedPublishParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .ts(OffsetDateTime.parse("2021-06-07T14:17:39.653043Z"))
