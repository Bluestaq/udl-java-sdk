...
internal class GnssRawIfTupleResponseTest {
    ...
    @Test
    fun create() {
      val gnssRawIfTupleResponse = GnssRawIfTupleResponse.builder()
      ...
      assertThat(gnssRawIfTupleResponse.dataMode()).isEqualTo(GnssRawIfTupleResponse.DataMode.TEST)
      assertThat(gnssRawIfTupleResponse.endTime()).isEqualTo(OffsetDateTime.parse("2022-04-09T18:12:28.919768Z"))
      ...
      assertThat(gnssRawIfTupleResponse.startTime()).isEqualTo(OffsetDateTime.parse("2022-04-09T18:11:28.919768Z"))
      ...
      assertThat(gnssRawIfTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(gnssRawIfTupleResponse.createdBy()).contains("some.user")
      assertThat(gnssRawIfTupleResponse.dataRate()).contains(0.205)
      assertThat(gnssRawIfTupleResponse.diffCodeBias().getOrNull()).containsExactly(0.0271, 0.0016)
      ...
      assertThat(gnssRawIfTupleResponse.eventId()).contains("2f2205c9-7bc2-4e1a-8416-2f80cc71f64b")
      ...
      assertThat(gnssRawIfTupleResponse.quat().getOrNull()).containsExactly(0.0, -0.2734104, 0.1562345, 0.9491246)
    ...
    fun roundtrip() {
      ...
      val roundtrippedGnssRawIfTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(gnssRawIfTupleResponse), jacksonTypeRef<GnssRawIfTupleResponse>())
