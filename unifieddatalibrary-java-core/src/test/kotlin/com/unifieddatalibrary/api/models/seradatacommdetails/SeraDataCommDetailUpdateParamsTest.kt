...
internal class SeraDataCommDetailUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = SeraDataCommDetailUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(SeraDataCommDetailUpdateParams.DataMode.TEST)
          .source("Bluestaq")
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(SeraDataCommDetailUpdateParams.DataMode.TEST)
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.bodyId()).contains("SERADATACOMMDETAILS-ID")
