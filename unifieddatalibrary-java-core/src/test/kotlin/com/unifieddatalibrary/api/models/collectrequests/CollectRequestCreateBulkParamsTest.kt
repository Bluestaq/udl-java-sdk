...
internal class CollectRequestCreateBulkParamsTest {
    ...
    fun create() {
      CollectRequestCreateBulkParams.builder()
          .addBody(CollectRequestCreateBulkParams.Body.builder()
              ...
              .eccentricity(1.1)
              .el(1.1)
              .elset(CollectRequestCreateBulkParams.Body.Elset.builder()
                  .classificationMarking("U")
                  ...
                  .addSourcedDataType(CollectRequestCreateBulkParams.Body.Elset.SourcedDataType.RADAR)
                  .addSourcedDataType(CollectRequestCreateBulkParams.Body.Elset.SourcedDataType.RF)
                  .sourceDl("AXE")
              ...
              .srchInc(1.1)
              .srchPattern("SCAN")
              .stateVector(CollectRequestCreateBulkParams.Body.StateVector.builder()
                  .classificationMarking("U")
                  ...
                  .covReferenceFrame(CollectRequestCreateBulkParams.Body.StateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(CollectRequestCreateBulkParams.Body.StateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(CollectRequestCreateBulkParams.Body.StateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
    ...
    @Test
    fun body() {
      val params = CollectRequestCreateBulkParams.builder()
          .addBody(CollectRequestCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(CollectRequestCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(CollectRequestCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(CollectRequestCreateBulkParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
