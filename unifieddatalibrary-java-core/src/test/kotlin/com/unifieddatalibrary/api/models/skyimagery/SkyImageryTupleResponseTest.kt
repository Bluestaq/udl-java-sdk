...
internal class SkyImageryTupleResponseTest {

    @Test
    fun create() {
        val skyImageryTupleResponse =
            SkyImageryTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(SkyImageryTupleResponse.DataMode.TEST)
        ...
        assertThat(skyImageryTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(skyImageryTupleResponse.dataMode())
            .isEqualTo(SkyImageryTupleResponse.DataMode.TEST)
        assertThat(skyImageryTupleResponse.expStartTime())
            .isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(skyImageryTupleResponse.imageType()).isEqualTo("imageType")
        assertThat(skyImageryTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(skyImageryTupleResponse.id()).contains("SKYIMAGERY-ID")
        assertThat(skyImageryTupleResponse.annotationKey()).contains("annotationKey")
        assertThat(skyImageryTupleResponse.calibrationKey()).contains("calibrationKey")
        assertThat(skyImageryTupleResponse.checksumValue()).contains("checksumValue")
        assertThat(skyImageryTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(skyImageryTupleResponse.createdBy()).contains("some.user")
        assertThat(skyImageryTupleResponse.description()).contains("description")
        assertThat(skyImageryTupleResponse.eoObservations().getOrNull())
            .containsExactly(
                EoObservationFull.builder()
                    .classificationMarking("U")
                    .dataMode(EoObservationFull.DataMode.TEST)
        ...
        assertThat(skyImageryTupleResponse.expEndTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(skyImageryTupleResponse.filename()).contains("filename.jpg")
        assertThat(skyImageryTupleResponse.filesize()).contains(371945L)
        assertThat(skyImageryTupleResponse.frameFovHeight()).contains(21.23)
        assertThat(skyImageryTupleResponse.frameFovWidth()).contains(21.23)
        assertThat(skyImageryTupleResponse.frameHeightPixels()).contains(1)
        assertThat(skyImageryTupleResponse.frameWidthPixels()).contains(1)
        assertThat(skyImageryTupleResponse.idAttitudeSet())
            .contains("d039ba29-52f4-4839-8a8f-e85fa416aec5")
        assertThat(skyImageryTupleResponse.idOnOrbit()).contains("44920")
        assertThat(skyImageryTupleResponse.idSensor()).contains("420")
        assertThat(skyImageryTupleResponse.idSoiSet()).contains("531093d0-e9b0-475b-687aeeefefd9")
        assertThat(skyImageryTupleResponse.imageSetId()).contains("imageSetId")
        assertThat(skyImageryTupleResponse.imageSetLength()).contains(9)
        assertThat(skyImageryTupleResponse.imageSourceInfo()).contains("imageSourceInfo")
        assertThat(skyImageryTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(skyImageryTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(skyImageryTupleResponse.origNetwork()).contains("OPS1")
        assertThat(skyImageryTupleResponse.origObjectId()).contains("X15-23452")
        assertThat(skyImageryTupleResponse.origSensorId()).contains("origSensorId")
        assertThat(skyImageryTupleResponse.pixelBitDepth()).contains(1)
        assertThat(skyImageryTupleResponse.pixelFovHeight()).contains(321.123)
        assertThat(skyImageryTupleResponse.pixelFovWidth()).contains(321.123)
        assertThat(skyImageryTupleResponse.satNo()).contains(25544)
        assertThat(skyImageryTupleResponse.senalt()).contains(14.483619321)
        assertThat(skyImageryTupleResponse.senlat()).contains(-33.283048)
        assertThat(skyImageryTupleResponse.senlon()).contains(149.372549)
        assertThat(skyImageryTupleResponse.senQuat().getOrNull())
            .containsExactly(0.03, 0.02, 0.01, 0.012)
        assertThat(skyImageryTupleResponse.senQuatDot().getOrNull())
            .containsExactly(0.03, 0.02, 0.01, 0.012)
        assertThat(skyImageryTupleResponse.senx()).contains(14.52)
        assertThat(skyImageryTupleResponse.seny()).contains(32.41)
        assertThat(skyImageryTupleResponse.senz()).contains(376.12)
        assertThat(skyImageryTupleResponse.sequenceId()).contains(1)
        assertThat(skyImageryTupleResponse.sourceDl()).contains("AXE")
        assertThat(skyImageryTupleResponse.tags().getOrNull())
            .containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
        assertThat(skyImageryTupleResponse.topLeftStartAz()).contains(146.321)
        assertThat(skyImageryTupleResponse.topLeftStartEl()).contains(146.321)
        assertThat(skyImageryTupleResponse.topLeftStopAz()).contains(3.7)
        assertThat(skyImageryTupleResponse.topLeftStopEl()).contains(34.233)
        assertThat(skyImageryTupleResponse.transactionId())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSkyImageryTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(skyImageryTupleResponse),
                jacksonTypeRef<SkyImageryTupleResponse>(),
            )

        assertThat(roundtrippedSkyImageryTupleResponse).isEqualTo(skyImageryTupleResponse)
    }
}
