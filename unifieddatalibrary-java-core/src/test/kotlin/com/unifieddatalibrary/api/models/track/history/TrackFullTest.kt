    ...
    fun create() {
        val trackFull =
            TrackFull.builder()
                ...
                .covReferenceFrame(TrackFull.CovReferenceFrame.ECR_ECEF)
        ...
        assertThat(trackFull.covReferenceFrame()).contains(TrackFull.CovReferenceFrame.ECR_ECEF)
        ...
        assertThat(trackFull.grndSpd()).contains(60.23)
