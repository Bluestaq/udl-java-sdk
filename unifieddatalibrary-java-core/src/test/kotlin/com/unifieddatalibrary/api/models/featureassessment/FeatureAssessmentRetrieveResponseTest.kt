...
internal class FeatureAssessmentRetrieveResponseTest {
    ...
    @Test
    fun create() {
        val featureAssessmentRetrieveResponse =
            FeatureAssessmentRetrieveResponse.builder()
        ...
        assertThat(featureAssessmentRetrieveResponse.dataMode())
            .isEqualTo(FeatureAssessmentRetrieveResponse.DataMode.TEST)
        assertThat(featureAssessmentRetrieveResponse.featureTs())
        ...
        assertThat(featureAssessmentRetrieveResponse.annLims().getOrNull())
            .containsExactly(listOf(1, 1), listOf(1, 2), listOf(1, 3), listOf(1, 4))
        assertThat(featureAssessmentRetrieveResponse.annText().getOrNull())
            .containsExactly("rec1", "rec2")
        assertThat(featureAssessmentRetrieveResponse.area())
            .contains("POINT(52.23486096929749 16.191937138595005)")
        assertThat(featureAssessmentRetrieveResponse.asrid()).contains(4326)
        assertThat(featureAssessmentRetrieveResponse.assessment())
            .contains(
                "Vessel bigger than other small fishing boats commonly found along the coastline"
            )
        assertThat(featureAssessmentRetrieveResponse.atext())
            .contains("POINT(52.23486096929749 16.191937138595005)")
        ...
        assertThat(featureAssessmentRetrieveResponse.createdAt())
        ...
        assertThat(featureAssessmentRetrieveResponse.externalId())
            .contains("2024-06-22-17-53-05_UMBRA-05_GEC")
        assertThat(featureAssessmentRetrieveResponse.featureArray().getOrNull())
            .containsExactly(1227.6, 1575.42)
        assertThat(featureAssessmentRetrieveResponse.featureBool()).contains(true)
        assertThat(featureAssessmentRetrieveResponse.featureString())
            .contains("TRANSMITTING FREQUENCIES")
        assertThat(featureAssessmentRetrieveResponse.featureStringArray().getOrNull())
        ...
        assertThat(featureAssessmentRetrieveResponse.srcIds().getOrNull())
            .containsExactly(
                "b008c63b-ad89-4493-80e0-77bc982bef77",
                "3565a6dd-654e-4969-89e0-ee7c51ab1e1b",
            )
        assertThat(featureAssessmentRetrieveResponse.srcTs().getOrNull())
            .containsExactly(
                OffsetDateTime.parse("2025-02-24T16:27:18.471Z"),
                OffsetDateTime.parse("2025-02-24T16:29:31.000000Z"),
            )
        assertThat(featureAssessmentRetrieveResponse.srcTyps().getOrNull())
            .containsExactly("SAR", "AIS")
        assertThat(featureAssessmentRetrieveResponse.tags().getOrNull())
            .containsExactly("TAG1", "TAG2")
        assertThat(featureAssessmentRetrieveResponse.transactionId())
    ...
    fun roundtrip() {
        ...
        val roundtrippedFeatureAssessmentRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(featureAssessmentRetrieveResponse),
                jacksonTypeRef<FeatureAssessmentRetrieveResponse>(),
            )

        assertThat(roundtrippedFeatureAssessmentRetrieveResponse)
            .isEqualTo(featureAssessmentRetrieveResponse)
    }
}
