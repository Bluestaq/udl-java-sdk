...
internal class SoiObservationSetQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val soiObservationSetQueryhelpResponse =
            SoiObservationSetQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(soiObservationSetQueryhelpResponse.classificationMarking())
        ...
        assertThat(soiObservationSetQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(soiObservationSetQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSoiObservationSetQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(soiObservationSetQueryhelpResponse),
                jacksonTypeRef<SoiObservationSetQueryhelpResponse>(),
            )

        assertThat(roundtrippedSoiObservationSetQueryhelpResponse)
            .isEqualTo(soiObservationSetQueryhelpResponse)
    }
}
