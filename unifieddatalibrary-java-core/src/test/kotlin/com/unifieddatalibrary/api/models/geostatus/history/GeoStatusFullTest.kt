...
internal class GeoStatusFullTest {

    @Test
    fun create() {
        val geoStatusFull =
            GeoStatusFull.builder()
                .classificationMarking("U")
                .dataMode(GeoStatusFull.DataMode.TEST)
                .source("Bluestaq")
                .id("GEOSTATUS-ID")
                .confidenceLevel("Low")
        ...
        assertThat(geoStatusFull.classificationMarking()).isEqualTo("U")
        assertThat(geoStatusFull.dataMode()).isEqualTo(GeoStatusFull.DataMode.TEST)
        assertThat(geoStatusFull.source()).isEqualTo("Bluestaq")
        assertThat(geoStatusFull.id()).contains("GEOSTATUS-ID")
        assertThat(geoStatusFull.confidenceLevel()).contains("Low")
        assertThat(geoStatusFull.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(geoStatusFull.createdBy()).contains("some.user")
        assertThat(geoStatusFull.idOnOrbit()).contains("REF-ONORBIT-ID")
        assertThat(geoStatusFull.longitudeMax()).contains(1.01)
        assertThat(geoStatusFull.longitudeMin()).contains(180.1)
        assertThat(geoStatusFull.longitudeRate()).contains(1.1)
        assertThat(geoStatusFull.lostFlag()).contains(false)
        assertThat(geoStatusFull.objectStatus()).contains("Active")
        assertThat(geoStatusFull.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(geoStatusFull.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(geoStatusFull.origNetwork()).contains("ORIG")
        assertThat(geoStatusFull.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(geoStatusFull.planeChangeStatus()).contains("Current")
        assertThat(geoStatusFull.rawFileUri()).contains("Example URI")
        assertThat(geoStatusFull.relativeEnergy()).contains(1.1)
        assertThat(geoStatusFull.satNo()).contains(21)
        assertThat(geoStatusFull.sc()).contains(1.1)
        assertThat(geoStatusFull.semiAnnualCorrFlag()).contains(false)
        assertThat(geoStatusFull.ss()).contains(1.1)
        assertThat(geoStatusFull.troughType()).contains("West")
        assertThat(geoStatusFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(geoStatusFull.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedGeoStatusFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(geoStatusFull),
                jacksonTypeRef<GeoStatusFull>(),
            )

        assertThat(roundtrippedGeoStatusFull).isEqualTo(geoStatusFull)
    }
}
