    ...
    fun create() {
        val passiveRadarObservationListResponse =
            PassiveRadarObservationListResponse.builder()
                ...
                .rcsUnc(1.23)
                .satNo(40699)
                .senReferenceFrame(PassiveRadarObservationListResponse.SenReferenceFrame.J2000)
                .senx(-4527.793)
                .seny(3793.586)
                .senz(3553.495)
                .snr(17.292053)
        ...
        assertThat(passiveRadarObservationListResponse.origNetwork()).contains("OPS1")
        ...
        assertThat(passiveRadarObservationListResponse.senReferenceFrame())
            .contains(PassiveRadarObservationListResponse.SenReferenceFrame.J2000)
        assertThat(passiveRadarObservationListResponse.senx()).contains(-4527.793)
        assertThat(passiveRadarObservationListResponse.seny()).contains(3793.586)
        assertThat(passiveRadarObservationListResponse.senz()).contains(3553.495)
