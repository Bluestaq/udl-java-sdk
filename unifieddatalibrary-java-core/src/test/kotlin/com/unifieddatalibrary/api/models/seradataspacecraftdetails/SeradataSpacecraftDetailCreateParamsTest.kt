...
internal class SeradataSpacecraftDetailCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = SeradataSpacecraftDetailCreateParams.builder()
          .classificationMarking("U")
          .dataMode(SeradataSpacecraftDetailCreateParams.DataMode.TEST)
          .name("name")
          .source("Bluestaq")
      ...
      assertThat(body.dataMode()).isEqualTo(SeradataSpacecraftDetailCreateParams.DataMode.TEST)
      assertThat(body.name()).isEqualTo("name")
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.id()).contains("SERADATASPACECRAFTDETAILS-ID")
      ...
      assertThat(body.dateOfObservation()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
