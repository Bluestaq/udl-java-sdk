...
internal class EquipmentRemarkFullTest {
    ...
    @Test
    fun create() {
      val equipmentRemarkFull = EquipmentRemarkFull.builder()
      ...
      assertThat(equipmentRemarkFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(equipmentRemarkFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedEquipmentRemarkFull = jsonMapper.readValue(jsonMapper.writeValueAsString(equipmentRemarkFull), jacksonTypeRef<EquipmentRemarkFull>())
