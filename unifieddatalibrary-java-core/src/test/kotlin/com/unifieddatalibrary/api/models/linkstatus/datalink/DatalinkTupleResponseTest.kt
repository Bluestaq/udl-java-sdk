...
internal class DatalinkTupleResponseTest {
    ...
    @Test
    fun create() {
      val datalinkTupleResponse = DatalinkTupleResponse.builder()
          ...
          .minTrackQual(6)
          .month("OCT")
          .addMultiDuty(DatalinkTupleResponse.MultiDuty.builder()
              .duty("SICO")
              .addDutyTeleFreqNum("TEL:804-555-4142")
              .addDutyTeleFreqNum("TEL:804-867-5309")
              .addMultiDutyVoiceCoord(DatalinkTupleResponse.MultiDuty.MultiDutyVoiceCoord.builder()
                  .multiCommPri("P")
                  .multiFreqDes("ST300A")
          ...
          .opExInfo("CONTROL")
          .opExInfoAlt("ORANGE")
          .addOp(DatalinkTupleResponse.Op.builder()
          ...
          .addReference(DatalinkTupleResponse.Reference.builder()
              ...
              .refType("ABSTAT")
              .build())
          .addRefPoint(DatalinkTupleResponse.RefPoint.builder()
              ...
              .refPointType("DLRP")
              .build())
          .addRemark(DatalinkTupleResponse.Remark.builder()
          ...
          .serialNum("1201003")
          .sourceDl("AXE")
          .addSpecTrack(DatalinkTupleResponse.SpecTrack.builder()
              .specTrackNum("12345")
          ...
          .updatedBy("some.user")
          .addVoiceCoord(DatalinkTupleResponse.VoiceCoord.builder()
              .commPri("P")
              .freqDes("ST300A")
      ...
      assertThat(datalinkTupleResponse.startTime()).isEqualTo(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
      assertThat(datalinkTupleResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      assertThat(datalinkTupleResponse.ackInstUnits().getOrNull()).containsExactly("AOC EXT 2345", "317 AW")
      ...
      assertThat(datalinkTupleResponse.canxTs()).contains(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
      ...
      assertThat(datalinkTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(datalinkTupleResponse.decInstDates().getOrNull()).containsExactly("AT EXERCISE ENDEX", "DATE:25NOV1997")
      ...
      assertThat(datalinkTupleResponse.multiDuty().getOrNull()).containsExactly(DatalinkTupleResponse.MultiDuty.builder()
          .duty("SICO")
          .addDutyTeleFreqNum("TEL:804-555-4142")
          .addDutyTeleFreqNum("TEL:804-867-5309")
          .addMultiDutyVoiceCoord(DatalinkTupleResponse.MultiDuty.MultiDutyVoiceCoord.builder()
          ...
          .unitDes("SHIP:STENNIS")
          .build())
      assertThat(datalinkTupleResponse.nonLinkUnitDes().getOrNull()).containsExactly("CS:GRAY GHOST", "CS:WHITE WHALE")
      assertThat(datalinkTupleResponse.opExInfo()).contains("CONTROL")
      assertThat(datalinkTupleResponse.opExInfoAlt()).contains("ORANGE")
      assertThat(datalinkTupleResponse.ops().getOrNull()).containsExactly(DatalinkTupleResponse.Op.builder()
          .linkDetails("Link details")
          .linkName("Link-16")
          .linkStartTime(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
          .linkStopTime(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
      ...
      assertThat(datalinkTupleResponse.pocNums().getOrNull()).containsExactly("TEL:804-555-4142", "TEL:804-867-5309")
      ...
      assertThat(datalinkTupleResponse.references().getOrNull()).containsExactly(DatalinkTupleResponse.Reference.builder()
          .refOriginator("CENTCOM")
          .refSerialId("A")
          .refSerialNum("1402001")
          .addRefSiC("RDU")
          ...
          .refType("ABSTAT")
          .build())
      assertThat(datalinkTupleResponse.refPoints().getOrNull()).containsExactly(DatalinkTupleResponse.RefPoint.builder()
          .effEventTime(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
          .refDes("L5")
          .refLat(45.23)
          .refLocName("FORT BRAGG")
          ...
          .refPointType("DLRP")
          .build())
      assertThat(datalinkTupleResponse.remarks().getOrNull()).containsExactly(DatalinkTupleResponse.Remark.builder()
          .text("Example data link remarks")
          .type("CONTINGENCY PROCEDURES")
          .build())
      ...
      assertThat(datalinkTupleResponse.specTracks().getOrNull()).containsExactly(DatalinkTupleResponse.SpecTrack.builder()
          .specTrackNum("12345")
          .specTrackNumDesc("SAM SITE CHARLIE")
          .build())
      assertThat(datalinkTupleResponse.speedDiff()).contains(50)
      assertThat(datalinkTupleResponse.stopTime()).contains(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
      ...
      assertThat(datalinkTupleResponse.trackNumBlocks().getOrNull()).containsExactly("0200-0300", "0400-4412")
      assertThat(datalinkTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(datalinkTupleResponse.updatedBy()).contains("some.user")
      assertThat(datalinkTupleResponse.voiceCoord().getOrNull()).containsExactly(DatalinkTupleResponse.VoiceCoord.builder()
          .commPri("P")
          .freqDes("ST300A")
          .addTeleFreqNum("TEL:804-555-4142")
          .addTeleFreqNum("TEL:804-867-5309")
    ...
    fun roundtrip() {
      ...
      val roundtrippedDatalinkTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(datalinkTupleResponse), jacksonTypeRef<DatalinkTupleResponse>())
