...
internal class OnorbiteventUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(OnorbiteventUpdateParams.DataMode.TEST)
        assertThat(body.eventTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.bodyId()).contains("ONORBITEVENT-ID")
