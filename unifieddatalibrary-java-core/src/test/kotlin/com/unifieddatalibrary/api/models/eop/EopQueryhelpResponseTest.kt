...
internal class EopQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val eopQueryhelpResponse = EopQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(eopQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedEopQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(eopQueryhelpResponse), jacksonTypeRef<EopQueryhelpResponse>())
