...
internal class OrbitdeterminationListParamsTest {

    @Test
    fun create() {
      OrbitdeterminationListParams.builder()
          .firstResult(0L)
          .idOnOrbit("idOnOrbit")
          .maxResults(0L)
    ...
    @Test
    fun queryParams() {
      val params = OrbitdeterminationListParams.builder()
          .firstResult(0L)
          .idOnOrbit("idOnOrbit")
          .maxResults(0L)
          .startTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun queryParamsWithoutOptionalFields() {
      val params = OrbitdeterminationListParams.builder().build()
