...
internal class CountryUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      CountryUnvalidatedPublishParams.builder()
          .addBody(CountryUnvalidatedPublishParams.Body.builder()
              ...
              .createdBy("some.user")
              .addDiplomaticClearanceCountryContact(CountryUnvalidatedPublishParams.Body.DiplomaticClearanceCountryContact.builder()
                  .ahNum("256039858")
                  .ahSpdDialCode("75")
                  .commNum("904716104")
                  .commSpdDialCode("74")
                  ...
                  .siprNum("546144352")
                  .build())
              .addDiplomaticClearanceCountryEntryExitPoint(CountryUnvalidatedPublishParams.Body.DiplomaticClearanceCountryEntryExitPoint.builder()
                  .isEntry(true)
                  .isExit(true)
                  .pointName("BATEL")
                  .build())
              .addDiplomaticClearanceCountryProfile(CountryUnvalidatedPublishParams.Body.DiplomaticClearanceCountryProfile.builder()
    ...
    @Test
    fun body() {
      val params = CountryUnvalidatedPublishParams.builder()
          .addBody(CountryUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .countryCode("NL")
              .dataMode(CountryUnvalidatedPublishParams.Body.DataMode.TEST)
      ...
      assertThat(body).containsExactly(CountryUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .countryCode("NL")
          .dataMode(CountryUnvalidatedPublishParams.Body.DataMode.TEST)
          .lastChangedDate(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
