...
internal class VesselGetResponseTest {

    @Test
    fun create() {
        val vesselGetResponse =
            VesselGetResponse.builder()
                .classificationMarking("U")
                .dataMode(VesselGetResponse.DataMode.TEST)
                .source("Bluestaq")
        ...
        assertThat(vesselGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(vesselGetResponse.dataMode()).isEqualTo(VesselGetResponse.DataMode.TEST)
        assertThat(vesselGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(vesselGetResponse.id()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
        assertThat(vesselGetResponse.altVesselId()).contains("590b5194fc32e75dd00682ba")
        assertThat(vesselGetResponse.callsign()).contains("V2OZ")
        assertThat(vesselGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(vesselGetResponse.createdBy()).contains("some.user")
        assertThat(vesselGetResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(vesselGetResponse.firstSeen())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(vesselGetResponse.hullNum()).contains("A30081")
        assertThat(vesselGetResponse.idEntity()).contains("ENTITY-ID")
        assertThat(vesselGetResponse.idOrganization())
            .contains("0147f777-w09a-835f-85aa-0a07a730fgg0")
        assertThat(vesselGetResponse.imon()).contains(9566356)
        assertThat(vesselGetResponse.length()).contains(511.1)
        assertThat(vesselGetResponse.maxDraught()).contains(21.1)
        assertThat(vesselGetResponse.maxSpeed()).contains(32.5)
        assertThat(vesselGetResponse.mmsi()).contains("416450000")
        assertThat(vesselGetResponse.numBlades()).contains(4)
        assertThat(vesselGetResponse.numShafts()).contains(3)
        assertThat(vesselGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(vesselGetResponse.origNetwork()).contains("OPS1")
        assertThat(vesselGetResponse.propType()).contains("Diesel")
        assertThat(vesselGetResponse.sconum()).contains("B45524")
        assertThat(vesselGetResponse.sourceDl()).contains("AXE")
        assertThat(vesselGetResponse.status()).contains("In Service/Commission")
        assertThat(vesselGetResponse.sternType()).contains("Cruiser")
        assertThat(vesselGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(vesselGetResponse.updatedBy()).contains("some.user")
        assertThat(vesselGetResponse.vesselBuilder()).contains("Samsung Heavy Inds - Geoje")
        assertThat(vesselGetResponse.vesselClass()).contains("Nimitz")
        assertThat(vesselGetResponse.vesselDescription()).contains("Search and Rescue Vessel")
        assertThat(vesselGetResponse.vesselFlag()).contains("United States")
        assertThat(vesselGetResponse.vesselName()).contains("DORNUM")
        assertThat(vesselGetResponse.vesselType()).contains("Passenger")
        assertThat(vesselGetResponse.vslWt()).contains(3423.76)
        assertThat(vesselGetResponse.width()).contains(24.1)
        assertThat(vesselGetResponse.yearBuilt()).contains("2014")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedVesselGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(vesselGetResponse),
                jacksonTypeRef<VesselGetResponse>(),
            )

        assertThat(roundtrippedVesselGetResponse).isEqualTo(vesselGetResponse)
    }
}
