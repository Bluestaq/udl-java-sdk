...
internal class AiQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val aiQueryhelpResponse =
            AiQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(aiQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAiQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(aiQueryhelpResponse),
                jacksonTypeRef<AiQueryhelpResponse>(),
            )
