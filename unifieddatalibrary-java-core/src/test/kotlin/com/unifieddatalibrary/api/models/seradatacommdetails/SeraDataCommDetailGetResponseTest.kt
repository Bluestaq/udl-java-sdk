...
internal class SeraDataCommDetailGetResponseTest {
    ...
    @Test
    fun create() {
      val seraDataCommDetailGetResponse = SeraDataCommDetailGetResponse.builder()
      ...
      assertThat(seraDataCommDetailGetResponse.dataMode()).isEqualTo(SeraDataCommDetailGetResponse.DataMode.TEST)
      ...
      assertThat(seraDataCommDetailGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(seraDataCommDetailGetResponse.estHtsTotalUserDownlinkBandwidthPerBeam()).contains(1.23)
      assertThat(seraDataCommDetailGetResponse.estHtsTotalUserUplinkBandwidthPerBeam()).contains(1.23)
      ...
      assertThat(seraDataCommDetailGetResponse.hostedForCompanyOrgId()).contains("hostedForCompanyOrgId")
      ...
      assertThat(seraDataCommDetailGetResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSeraDataCommDetailGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(seraDataCommDetailGetResponse), jacksonTypeRef<SeraDataCommDetailGetResponse>())

      assertThat(roundtrippedSeraDataCommDetailGetResponse).isEqualTo(seraDataCommDetailGetResponse)
    }
}
