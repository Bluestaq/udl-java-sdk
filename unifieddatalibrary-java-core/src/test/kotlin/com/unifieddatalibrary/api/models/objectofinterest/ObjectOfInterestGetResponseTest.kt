...
internal class ObjectOfInterestGetResponseTest {

    @Test
    fun create() {
        val objectOfInterestGetResponse =
            ObjectOfInterestGetResponse.builder()
                .classificationMarking("U")
                .dataMode(ObjectOfInterestGetResponse.DataMode.TEST)
                ...
                .addManifold(
                    ObjectOfInterestGetResponse.Manifold.builder()
                        .classificationMarking("U")
                        .dataMode(ObjectOfInterestGetResponse.Manifold.DataMode.TEST)
        ...
        assertThat(objectOfInterestGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(objectOfInterestGetResponse.dataMode())
            .isEqualTo(ObjectOfInterestGetResponse.DataMode.TEST)
        assertThat(objectOfInterestGetResponse.idOnOrbit()).isEqualTo("REF-ONORBIT-ID")
        assertThat(objectOfInterestGetResponse.sensorTaskingStartTime())
            .isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
        assertThat(objectOfInterestGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(objectOfInterestGetResponse.statusDate())
            .isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
        assertThat(objectOfInterestGetResponse.id()).contains("OBJECTOFINTEREST-ID")
        assertThat(objectOfInterestGetResponse.affectedObjects().getOrNull())
            .containsExactly("AFFECTEDOBJECT1-ID", "AFFECTEDOBJECT2-ID")
        assertThat(objectOfInterestGetResponse.apogee()).contains(123.4)
        assertThat(objectOfInterestGetResponse.argOfPerigee()).contains(123.4)
        assertThat(objectOfInterestGetResponse.bStar()).contains(123.4)
        assertThat(objectOfInterestGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(objectOfInterestGetResponse.createdBy()).contains("some.user")
        assertThat(objectOfInterestGetResponse.deltaTs().getOrNull()).containsExactly(1.1, 2.2, 3.3)
        assertThat(objectOfInterestGetResponse.deltaVs().getOrNull()).containsExactly(1.1, 2.2, 3.3)
        assertThat(objectOfInterestGetResponse.description()).contains("Example description")
        assertThat(objectOfInterestGetResponse.eccentricity()).contains(123.4)
        assertThat(objectOfInterestGetResponse.elsetEpoch())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(objectOfInterestGetResponse.inclination()).contains(123.4)
        assertThat(objectOfInterestGetResponse.lastObTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(objectOfInterestGetResponse.manifolds().getOrNull())
            .containsExactly(
                ObjectOfInterestGetResponse.Manifold.builder()
                    .classificationMarking("U")
                    .dataMode(ObjectOfInterestGetResponse.Manifold.DataMode.TEST)
        ...
        assertThat(objectOfInterestGetResponse.meanAnomaly()).contains(123.4)
        assertThat(objectOfInterestGetResponse.meanMotion()).contains(123.4)
        assertThat(objectOfInterestGetResponse.meanMotionDDot()).contains(123.4)
        assertThat(objectOfInterestGetResponse.meanMotionDot()).contains(123.4)
        assertThat(objectOfInterestGetResponse.missedObTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(objectOfInterestGetResponse.name()).contains("Example_name")
        assertThat(objectOfInterestGetResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(objectOfInterestGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(objectOfInterestGetResponse.origNetwork()).contains("OPS1")
        assertThat(objectOfInterestGetResponse.perigee()).contains(123.4)
        assertThat(objectOfInterestGetResponse.period()).contains(123.4)
        assertThat(objectOfInterestGetResponse.priority()).contains(7)
        assertThat(objectOfInterestGetResponse.raan()).contains(123.4)
        assertThat(objectOfInterestGetResponse.revNo()).contains(123)
        assertThat(objectOfInterestGetResponse.satNo()).contains(12)
        assertThat(objectOfInterestGetResponse.semiMajorAxis()).contains(123.4)
        assertThat(objectOfInterestGetResponse.sensorTaskingStopTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
        assertThat(objectOfInterestGetResponse.status()).contains("OPEN")
        assertThat(objectOfInterestGetResponse.svEpoch())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(objectOfInterestGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(objectOfInterestGetResponse.updatedBy()).contains("some.user")
        assertThat(objectOfInterestGetResponse.x()).contains(123.4)
        assertThat(objectOfInterestGetResponse.xvel()).contains(123.4)
        assertThat(objectOfInterestGetResponse.y()).contains(123.4)
        assertThat(objectOfInterestGetResponse.yvel()).contains(123.4)
        assertThat(objectOfInterestGetResponse.z()).contains(123.4)
        assertThat(objectOfInterestGetResponse.zvel()).contains(123.4)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedObjectOfInterestGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(objectOfInterestGetResponse),
                jacksonTypeRef<ObjectOfInterestGetResponse>(),
            )

        assertThat(roundtrippedObjectOfInterestGetResponse).isEqualTo(objectOfInterestGetResponse)
    }
}
