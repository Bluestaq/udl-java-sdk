...
internal class BeamcontourFullTest {
    ...
    @Test
    fun create() {
      val beamcontourFull = BeamcontourFull.builder()
      ...
      assertThat(beamcontourFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(beamcontourFull.createdBy()).contains("some.user")
      assertThat(beamcontourFull.gain()).contains(17.1)
      assertThat(beamcontourFull.geography()).contains("POLYGON((26.156175339112 67.3291113966927,26.0910220642717 67.2580009640721,26.6637992964562 67.1795862381682,26.730115808233 67.2501237475598,26.156175339112 67.3291113966927))")
      assertThat(beamcontourFull.geographyJson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(beamcontourFull.geographyNdims()).contains(2)
      assertThat(beamcontourFull.geographySrid()).contains(4326)
      assertThat(beamcontourFull.geographyText()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(beamcontourFull.origNetwork()).contains("ORIG")
      assertThat(beamcontourFull.regionName()).contains("Example region name")
      assertThat(beamcontourFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedBeamcontourFull = jsonMapper.readValue(jsonMapper.writeValueAsString(beamcontourFull), jacksonTypeRef<BeamcontourFull>())
