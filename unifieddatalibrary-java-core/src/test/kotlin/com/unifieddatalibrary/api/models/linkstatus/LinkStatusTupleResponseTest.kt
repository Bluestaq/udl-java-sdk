...
internal class LinkStatusTupleResponseTest {
    ...
    @Test
    fun create() {
      val linkStatusTupleResponse = LinkStatusTupleResponse.builder()
      ...
      assertThat(linkStatusTupleResponse.dataMode()).isEqualTo(LinkStatusTupleResponse.DataMode.TEST)
      ...
      assertThat(linkStatusTupleResponse.linkStartTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(linkStatusTupleResponse.linkStopTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      ...
      assertThat(linkStatusTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(linkStatusTupleResponse.origNetwork()).contains("ORIG")
    ...
    fun roundtrip() {
      ...
      val roundtrippedLinkStatusTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(linkStatusTupleResponse), jacksonTypeRef<LinkStatusTupleResponse>())
