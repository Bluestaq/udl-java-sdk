...
internal class LinkstatusUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(LinkstatusUpdateParams.DataMode.TEST)
        ...
        assertThat(body.bodyId()).contains("LINKSTATUS-ID")
