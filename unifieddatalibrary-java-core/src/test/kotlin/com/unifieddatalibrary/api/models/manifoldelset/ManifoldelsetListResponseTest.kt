...
internal class ManifoldelsetListResponseTest {
    ...
    @Test
    fun create() {
        val manifoldelsetListResponse =
            ManifoldelsetListResponse.builder()
        ...
        assertThat(manifoldelsetListResponse.dataMode())
            .isEqualTo(ManifoldelsetListResponse.DataMode.TEST)
        assertThat(manifoldelsetListResponse.epoch())
        ...
        assertThat(manifoldelsetListResponse.createdAt())
        ...
        assertThat(manifoldelsetListResponse.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedManifoldelsetListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(manifoldelsetListResponse),
                jacksonTypeRef<ManifoldelsetListResponse>(),
            )
