...
internal class LinkStatusListParamsTest {

    @Test
    fun create() {
      LinkStatusListParams.builder()
    ...
    @Test
    fun queryParams() {
      val params = LinkStatusListParams.builder()
          .createdAt(LocalDate.parse("2019-12-27"))
          .firstResult(0L)
          .linkStartTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .linkStopTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun queryParamsWithoutOptionalFields() {
      val params = LinkStatusListParams.builder().build()
