...
internal class RfBandTypeQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val rfBandTypeQueryhelpResponse =
            RfBandTypeQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(rfBandTypeQueryhelpResponse.classificationMarking())
        ...
        assertThat(rfBandTypeQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(rfBandTypeQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedRfBandTypeQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(rfBandTypeQueryhelpResponse),
                jacksonTypeRef<RfBandTypeQueryhelpResponse>(),
            )
