...
internal class HistoryListResponseTest {
    ...
    fun create() {
        ...
        assertThat(historyListResponse.id()).contains("RADAROBSERVATION-ID")
        assertThat(historyListResponse.azimuth()).contains(45.23)
        assertThat(historyListResponse.azimuthBias()).contains(45.23)
        assertThat(historyListResponse.azimuthMeasured()).contains(true)
        assertThat(historyListResponse.azimuthRate()).contains(1.23)
        assertThat(historyListResponse.azimuthUnc()).contains(45.23)
        assertThat(historyListResponse.beam()).contains(1.23)
        ...
        assertThat(historyListResponse.declinationMeasured()).contains(true)
        assertThat(historyListResponse.descriptor()).contains("descriptor")
        assertThat(historyListResponse.doppler()).contains(10.23)
        assertThat(historyListResponse.dopplerUnc()).contains(1.23)
        assertThat(historyListResponse.elevation()).contains(45.23)
        assertThat(historyListResponse.elevationBias()).contains(1.23)
        assertThat(historyListResponse.elevationMeasured()).contains(true)
        assertThat(historyListResponse.elevationRate()).contains(1.23)
        assertThat(historyListResponse.elevationUnc()).contains(1.23)
        ...
        assertThat(historyListResponse.orthogonalRcs()).contains(1.23)
        assertThat(historyListResponse.orthogonalRcsUnc()).contains(10.23)
        assertThat(historyListResponse.ra()).contains(1.23)
        assertThat(historyListResponse.raMeasured()).contains(true)
        assertThat(historyListResponse.range()).contains(100.23)
        assertThat(historyListResponse.rangeAccel()).contains(10.23)
        assertThat(historyListResponse.rangeAccelUnc()).contains(1.23)
        assertThat(historyListResponse.rangeBias()).contains(1.23)
        assertThat(historyListResponse.rangeMeasured()).contains(true)
        assertThat(historyListResponse.rangeRate()).contains(1.23)
        assertThat(historyListResponse.rangeRateMeasured()).contains(true)
        assertThat(historyListResponse.rangeRateUnc()).contains(0.5)
        assertThat(historyListResponse.rangeUnc()).contains(1.23)
        ...
        assertThat(historyListResponse.satNo()).contains(1)
        assertThat(historyListResponse.senReferenceFrame())
            .contains(HistoryListResponse.SenReferenceFrame.J2000)
        assertThat(historyListResponse.senx()).contains(45.23)
        assertThat(historyListResponse.seny()).contains(40.23)
        assertThat(historyListResponse.senz()).contains(35.23)
        assertThat(historyListResponse.snr()).contains(0.5)
        ...
        assertThat(historyListResponse.trackingState()).contains("INIT ACQ")
        assertThat(historyListResponse.transactionId()).contains("TRANSACTION-ID")
        assertThat(historyListResponse.type()).contains("RADAR")
        assertThat(historyListResponse.uct()).contains(true)
        assertThat(historyListResponse.x()).contains(50.23)
        assertThat(historyListResponse.xvel()).contains(1.23)
        assertThat(historyListResponse.y()).contains(50.23)
        assertThat(historyListResponse.yvel()).contains(5.23)
        assertThat(historyListResponse.z()).contains(50.23)
        assertThat(historyListResponse.zvel()).contains(5.23)
    }
