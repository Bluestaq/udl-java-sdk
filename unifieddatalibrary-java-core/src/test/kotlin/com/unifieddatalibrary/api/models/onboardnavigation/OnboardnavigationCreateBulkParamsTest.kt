...
internal class OnboardnavigationCreateBulkParamsTest {
    ...
    fun create() {
      OnboardnavigationCreateBulkParams.builder()
          .addBody(OnboardnavigationCreateBulkParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = OnboardnavigationCreateBulkParams.builder()
          .addBody(OnboardnavigationCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(OnboardnavigationCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(OnboardnavigationCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(OnboardnavigationCreateBulkParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2021-07-20T01:02:03.123456Z"))
