...
internal class SensorPlanUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      SensorPlanUnvalidatedPublishParams.builder()
          .addBody(SensorPlanUnvalidatedPublishParams.Body.builder()
              ...
              .type("PLAN")
              .id("SENSORPLAN-ID")
              .addCollectRequest(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.builder()
                  .classificationMarking("U")
                  .dataMode(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.DataMode.TEST)
                  .source("Bluestaq")
                  .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .type("DWELL")
                  ...
                  .eccentricity(1.1)
                  .el(1.1)
                  .elset(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.Elset.builder()
                      .classificationMarking("U")
                      .dataMode(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.Elset.DataMode.TEST)
                      ...
                      .addSourcedDataType(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.Elset.SourcedDataType.RADAR)
                      .addSourcedDataType(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.Elset.SourcedDataType.RF)
                      .sourceDl("AXE")
                  ...
                  .srchInc(1.1)
                  .srchPattern("SCAN")
                  .stateVector(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.StateVector.builder()
                      .classificationMarking("U")
                      .dataMode(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.StateVector.DataMode.TEST)
                      .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                      .source("Bluestaq")
                      .actualOdSpan(3.5)
                      ...
                      .covReferenceFrame(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.StateVector.CovReferenceFrame.J2000)
                      .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                      .createdBy("some.user")
                      ...
                      .recOdSpan(3.5)
                      .referenceFrame(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.StateVector.ReferenceFrame.J2000)
                      .residualsAcc(99.5)
                      .revNo(7205)
                      .rms(0.991)
                      .satNo(12)
                      ...
                      .addSourcedDataType(SensorPlanUnvalidatedPublishParams.Body.CollectRequest.StateVector.SourcedDataType.RADAR)
                      .sourceDl("AXE")
                      .srpArea(4.311)
                      .stepMode("AUTO")
                      .stepSize(1.23)
    ...
    @Test
    fun body() {
      val params = SensorPlanUnvalidatedPublishParams.builder()
          .addBody(SensorPlanUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(SensorPlanUnvalidatedPublishParams.Body.DataMode.TEST)
              .recType("COLLECT")
      ...
      assertThat(body).containsExactly(SensorPlanUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(SensorPlanUnvalidatedPublishParams.Body.DataMode.TEST)
          .recType("COLLECT")
          .source("Bluestaq")
