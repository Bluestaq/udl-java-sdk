...
internal class ManifoldelsetGetResponseTest {
    ...
    @Test
    fun create() {
        val manifoldelsetGetResponse =
            ManifoldelsetGetResponse.builder()
        ...
        assertThat(manifoldelsetGetResponse.dataMode())
            .isEqualTo(ManifoldelsetGetResponse.DataMode.TEST)
        assertThat(manifoldelsetGetResponse.epoch())
        ...
        assertThat(manifoldelsetGetResponse.createdAt())
        ...
        assertThat(manifoldelsetGetResponse.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedManifoldelsetGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(manifoldelsetGetResponse),
                jacksonTypeRef<ManifoldelsetGetResponse>(),
            )
