...
internal class SurfaceQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val surfaceQueryhelpResponse =
            SurfaceQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(surfaceQueryhelpResponse.classificationMarking())
        ...
        assertThat(surfaceQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSurfaceQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(surfaceQueryhelpResponse),
                jacksonTypeRef<SurfaceQueryhelpResponse>(),
            )
