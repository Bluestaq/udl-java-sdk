...
internal class SensorPlanListResponseTest {
    ...
    @Test
    fun create() {
        val sensorPlanListResponse =
            SensorPlanListResponse.builder()
        ...
        assertThat(sensorPlanListResponse.dataMode())
            .isEqualTo(SensorPlanListResponse.DataMode.TEST)
        assertThat(sensorPlanListResponse.recType()).isEqualTo("COLLECT")
        assertThat(sensorPlanListResponse.source()).isEqualTo("Bluestaq")
        assertThat(sensorPlanListResponse.startTime())
        ...
        assertThat(sensorPlanListResponse.createdAt())
        ...
        assertThat(sensorPlanListResponse.endTime())
        ...
        assertThat(sensorPlanListResponse.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedSensorPlanListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sensorPlanListResponse),
                jacksonTypeRef<SensorPlanListResponse>(),
            )
