...
internal class HistoryListResponseTest {
    ...
    fun create() {
      val historyListResponse = HistoryListResponse.builder()
          ...
          .aprioriElset(HistoryListResponse.AprioriElset.builder()
              .classificationMarking("U")
          ...
          .aprioriStateVector(HistoryListResponse.AprioriStateVector.builder()
              .classificationMarking("U")
              ...
              .covReferenceFrame(HistoryListResponse.AprioriStateVector.CovReferenceFrame.J2000)
              .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
              .createdBy("some.user")
              ...
              .addSourcedDataType(HistoryListResponse.AprioriStateVector.SourcedDataType.RADAR)
              .sourceDl("AXE")
              .srpArea(4.311)
              .stepMode("AUTO")
              .stepSize(1.23)
      ...
      assertThat(historyListResponse.endTime()).isEqualTo(OffsetDateTime.parse("2023-08-28T15:20:21.247192Z"))
      ...
      assertThat(historyListResponse.startTime()).isEqualTo(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(historyListResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      assertThat(historyListResponse.acceptedObIds().getOrNull()).containsExactly("EOOBSERVATION-ID1", "RADAROBSERVATION-ID1")
      ...
      assertThat(historyListResponse.aprioriElset()).contains(HistoryListResponse.AprioriElset.builder()
          .classificationMarking("U")
          .dataMode(HistoryListResponse.AprioriElset.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .uct(false)
          .build())
      assertThat(historyListResponse.aprioriIdElset()).contains("80e544b7-6a17-4554-8abf-7301e98f8e5d")
      assertThat(historyListResponse.aprioriIdStateVector()).contains("6e291992-8ae3-4592-bb0f-055715bf4803")
      assertThat(historyListResponse.aprioriStateVector()).contains(HistoryListResponse.AprioriStateVector.builder()
          .classificationMarking("U")
          .dataMode(HistoryListResponse.AprioriStateVector.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
      ...
      assertThat(historyListResponse.effectiveFrom()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(historyListResponse.effectiveUntil()).contains(OffsetDateTime.parse("2023-08-30T08:15:00.123456Z"))
      ...
      assertThat(historyListResponse.lastObEnd()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(historyListResponse.lastObStart()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      ...
      assertThat(historyListResponse.rejectedObIds().getOrNull()).containsExactly("DIFFOFARRIVAL-ID2", "RFOBSERVATION-ID2")
      ...
      assertThat(historyListResponse.sensorIds().getOrNull()).containsExactly("SENSOR-ID1", "SENSOR-ID2")
