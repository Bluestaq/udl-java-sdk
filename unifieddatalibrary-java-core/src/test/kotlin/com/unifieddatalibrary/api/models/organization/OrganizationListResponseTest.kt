...
internal class OrganizationListResponseTest {
    ...
    @Test
    fun create() {
      val organizationListResponse = OrganizationListResponse.builder()
      ...
      assertThat(organizationListResponse.dataMode()).isEqualTo(OrganizationListResponse.DataMode.TEST)
      ...
      assertThat(organizationListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedOrganizationListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(organizationListResponse), jacksonTypeRef<OrganizationListResponse>())
