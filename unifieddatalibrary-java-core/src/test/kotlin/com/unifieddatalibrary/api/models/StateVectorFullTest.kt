...
internal class StateVectorFullTest {
    ...
    @Test
    fun create() {
      val stateVectorFull = StateVectorFull.builder()
      ...
      assertThat(stateVectorFull.epoch()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(stateVectorFull.covReferenceFrame()).contains(StateVectorFull.CovReferenceFrame.J2000)
      assertThat(stateVectorFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(stateVectorFull.effectiveFrom()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(stateVectorFull.effectiveUntil()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(stateVectorFull.idOrbitDetermination()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      ...
      assertThat(stateVectorFull.lastObEnd()).contains(OffsetDateTime.parse("2022-11-09T11:20:21.247192Z"))
      assertThat(stateVectorFull.lastObStart()).contains(OffsetDateTime.parse("2022-11-09T11:20:21.247192Z"))
      assertThat(stateVectorFull.leapSecondTime()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
      ...
      assertThat(stateVectorFull.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
      ...
      assertThat(stateVectorFull.sourcedDataTypes().getOrNull()).containsExactly(StateVectorFull.SourcedDataType.RADAR)
    ...
    fun roundtrip() {
      ...
      val roundtrippedStateVectorFull = jsonMapper.readValue(jsonMapper.writeValueAsString(stateVectorFull), jacksonTypeRef<StateVectorFull>())
