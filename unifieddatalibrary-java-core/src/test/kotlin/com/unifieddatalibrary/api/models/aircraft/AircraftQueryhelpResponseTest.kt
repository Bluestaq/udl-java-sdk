...
internal class AircraftQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val aircraftQueryhelpResponse =
            AircraftQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(aircraftQueryhelpResponse.classificationMarking())
        ...
        assertThat(aircraftQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAircraftQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(aircraftQueryhelpResponse),
                jacksonTypeRef<AircraftQueryhelpResponse>(),
            )
