...
internal class LinkStatusQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val linkStatusQueryhelpResponse = LinkStatusQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(linkStatusQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(linkStatusQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(linkStatusQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedLinkStatusQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(linkStatusQueryhelpResponse), jacksonTypeRef<LinkStatusQueryhelpResponse>())
