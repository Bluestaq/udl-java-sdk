...
internal class EquipmentRemarkQueryHelpResponseTest {
    ...
    @Test
    fun create() {
        val equipmentRemarkQueryHelpResponse =
            EquipmentRemarkQueryHelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(equipmentRemarkQueryHelpResponse.classificationMarking())
        ...
        assertThat(equipmentRemarkQueryHelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(equipmentRemarkQueryHelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedEquipmentRemarkQueryHelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(equipmentRemarkQueryHelpResponse),
                jacksonTypeRef<EquipmentRemarkQueryHelpResponse>(),
            )

        assertThat(roundtrippedEquipmentRemarkQueryHelpResponse)
            .isEqualTo(equipmentRemarkQueryHelpResponse)
    }
}
