...
internal class RadarobservationTupleResponseTest {

    @Test
    fun create() {
        val radarobservationTupleResponse =
            RadarobservationTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(RadarobservationTupleResponse.DataMode.TEST)
                ...
                .rcsUnc(1.23)
                .satNo(1)
                .senReferenceFrame(RadarobservationTupleResponse.SenReferenceFrame.J2000)
                .senx(45.23)
                .seny(40.23)
                .senz(35.23)
                .snr(0.5)
        ...
        assertThat(radarobservationTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(radarobservationTupleResponse.dataMode())
            .isEqualTo(RadarobservationTupleResponse.DataMode.TEST)
        assertThat(radarobservationTupleResponse.obTime())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
        assertThat(radarobservationTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(radarobservationTupleResponse.id()).contains("RADAROBSERVATION-ID")
        assertThat(radarobservationTupleResponse.azimuth()).contains(45.23)
        assertThat(radarobservationTupleResponse.azimuthBias()).contains(45.23)
        assertThat(radarobservationTupleResponse.azimuthMeasured()).contains(true)
        assertThat(radarobservationTupleResponse.azimuthRate()).contains(1.23)
        assertThat(radarobservationTupleResponse.azimuthUnc()).contains(45.23)
        assertThat(radarobservationTupleResponse.beam()).contains(1.23)
        assertThat(radarobservationTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(radarobservationTupleResponse.createdBy()).contains("some.user")
        assertThat(radarobservationTupleResponse.declination()).contains(10.23)
        assertThat(radarobservationTupleResponse.declinationMeasured()).contains(true)
        assertThat(radarobservationTupleResponse.descriptor()).contains("descriptor")
        assertThat(radarobservationTupleResponse.doppler()).contains(10.23)
        assertThat(radarobservationTupleResponse.dopplerUnc()).contains(1.23)
        assertThat(radarobservationTupleResponse.elevation()).contains(45.23)
        assertThat(radarobservationTupleResponse.elevationBias()).contains(1.23)
        assertThat(radarobservationTupleResponse.elevationMeasured()).contains(true)
        assertThat(radarobservationTupleResponse.elevationRate()).contains(1.23)
        assertThat(radarobservationTupleResponse.elevationUnc()).contains(1.23)
        assertThat(radarobservationTupleResponse.idOnOrbit()).contains("ONORBIT-ID")
        assertThat(radarobservationTupleResponse.idSensor()).contains("SENSOR-ID")
        assertThat(radarobservationTupleResponse.obPosition()).contains("FIRST")
        assertThat(radarobservationTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(radarobservationTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(radarobservationTupleResponse.origNetwork()).contains("ORIG")
        assertThat(radarobservationTupleResponse.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(radarobservationTupleResponse.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(radarobservationTupleResponse.orthogonalRcs()).contains(1.23)
        assertThat(radarobservationTupleResponse.orthogonalRcsUnc()).contains(10.23)
        assertThat(radarobservationTupleResponse.ra()).contains(1.23)
        assertThat(radarobservationTupleResponse.raMeasured()).contains(true)
        assertThat(radarobservationTupleResponse.range()).contains(100.23)
        assertThat(radarobservationTupleResponse.rangeAccel()).contains(10.23)
        assertThat(radarobservationTupleResponse.rangeAccelUnc()).contains(1.23)
        assertThat(radarobservationTupleResponse.rangeBias()).contains(1.23)
        assertThat(radarobservationTupleResponse.rangeMeasured()).contains(true)
        assertThat(radarobservationTupleResponse.rangeRate()).contains(1.23)
        assertThat(radarobservationTupleResponse.rangeRateMeasured()).contains(true)
        assertThat(radarobservationTupleResponse.rangeRateUnc()).contains(0.5)
        assertThat(radarobservationTupleResponse.rangeUnc()).contains(1.23)
        assertThat(radarobservationTupleResponse.rawFileUri()).contains("rawFileURI")
        assertThat(radarobservationTupleResponse.rcs()).contains(100.23)
        assertThat(radarobservationTupleResponse.rcsUnc()).contains(1.23)
        assertThat(radarobservationTupleResponse.satNo()).contains(1)
        assertThat(radarobservationTupleResponse.senReferenceFrame())
            .contains(RadarobservationTupleResponse.SenReferenceFrame.J2000)
        assertThat(radarobservationTupleResponse.senx()).contains(45.23)
        assertThat(radarobservationTupleResponse.seny()).contains(40.23)
        assertThat(radarobservationTupleResponse.senz()).contains(35.23)
        assertThat(radarobservationTupleResponse.snr()).contains(0.5)
        assertThat(radarobservationTupleResponse.sourceDl()).contains("AXE")
        assertThat(radarobservationTupleResponse.tags().getOrNull()).containsExactly("TAG1", "TAG2")
        assertThat(radarobservationTupleResponse.taskId()).contains("TASK-ID")
        assertThat(radarobservationTupleResponse.timingBias()).contains(1.23)
        assertThat(radarobservationTupleResponse.trackId()).contains("TRACK-ID")
        assertThat(radarobservationTupleResponse.trackingState()).contains("INIT ACQ")
        assertThat(radarobservationTupleResponse.transactionId()).contains("TRANSACTION-ID")
        assertThat(radarobservationTupleResponse.type()).contains("RADAR")
        assertThat(radarobservationTupleResponse.uct()).contains(true)
        assertThat(radarobservationTupleResponse.x()).contains(50.23)
        assertThat(radarobservationTupleResponse.xvel()).contains(1.23)
        assertThat(radarobservationTupleResponse.y()).contains(50.23)
        assertThat(radarobservationTupleResponse.yvel()).contains(5.23)
        assertThat(radarobservationTupleResponse.z()).contains(50.23)
        assertThat(radarobservationTupleResponse.zvel()).contains(5.23)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedRadarobservationTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(radarobservationTupleResponse),
                jacksonTypeRef<RadarobservationTupleResponse>(),
            )

        assertThat(roundtrippedRadarobservationTupleResponse)
            .isEqualTo(radarobservationTupleResponse)
    }
}
