...
internal class SarObservationTupleResponseTest {
    ...
    @Test
    fun create() {
      val sarObservationTupleResponse = SarObservationTupleResponse.builder()
      ...
      assertThat(sarObservationTupleResponse.collectionEnd()).isEqualTo(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
      assertThat(sarObservationTupleResponse.collectionStart()).isEqualTo(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
      assertThat(sarObservationTupleResponse.dataMode()).isEqualTo(SarObservationTupleResponse.DataMode.TEST)
      ...
      assertThat(sarObservationTupleResponse.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(sarObservationTupleResponse.andims()).contains(3)
      assertThat(sarObservationTupleResponse.area()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(sarObservationTupleResponse.asrid()).contains(3)
      assertThat(sarObservationTupleResponse.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(sarObservationTupleResponse.centerTime()).contains(OffsetDateTime.parse("2023-04-22T17:36:35.100885Z"))
      ...
      assertThat(sarObservationTupleResponse.createdAt()).contains(OffsetDateTime.parse("2023-04-22T17:51:40.854Z"))
      assertThat(sarObservationTupleResponse.createdBy()).contains("some.user")
      assertThat(sarObservationTupleResponse.detectionEnd()).contains(OffsetDateTime.parse("2023-07-08T17:35:20.772190Z"))
      assertThat(sarObservationTupleResponse.detectionId()).contains("DETECTION-ID")
      assertThat(sarObservationTupleResponse.detectionStart()).contains(OffsetDateTime.parse("2023-07-08T17:35:01.615396Z"))
      ...
      assertThat(sarObservationTupleResponse.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
      ...
      assertThat(sarObservationTupleResponse.srcIds().getOrNull()).containsExactly("f7e01cd4-626b-441f-a423-17b160eb78ba", "223833c4-be0d-4fdb-a2e4-325a48eccced")
      assertThat(sarObservationTupleResponse.srcTyps().getOrNull()).containsExactly("ESID", "GROUNDIMAGE")
      assertThat(sarObservationTupleResponse.swathLength()).contains(12.1)
      assertThat(sarObservationTupleResponse.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
    ...
    fun roundtrip() {
      ...
      val roundtrippedSarObservationTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sarObservationTupleResponse), jacksonTypeRef<SarObservationTupleResponse>())
