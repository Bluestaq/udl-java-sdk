...
internal class StarCatalogGetResponseTest {
    ...
    fun create() {
        ...
        assertThat(starCatalogGetResponse.allWisew1Mag()).contains(15.782)
        assertThat(starCatalogGetResponse.allWisew1MagUnc()).contains(0.042)
        assertThat(starCatalogGetResponse.allWisew2Mag()).contains(16.523)
        assertThat(starCatalogGetResponse.allWisew2MagUnc()).contains(0.021)
        assertThat(starCatalogGetResponse.allWisew3Mag()).contains(11.541)
        assertThat(starCatalogGetResponse.allWisew3MagUnc()).contains(0.159)
        assertThat(starCatalogGetResponse.allWisew4Mag()).contains(9.007)
        assertThat(starCatalogGetResponse.allWisew4MagUnc()).contains(0.468)
