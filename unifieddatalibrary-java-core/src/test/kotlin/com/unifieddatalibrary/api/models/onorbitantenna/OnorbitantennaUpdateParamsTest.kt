...
internal class OnorbitantennaUpdateParamsTest {
    ...
    fun create() {
      OnorbitantennaUpdateParams.builder()
          ...
          .antenna(OnorbitantennaUpdateParams.Antenna.builder()
    ...
    @Test
    fun pathParams() {
      val params = OnorbitantennaUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(OnorbitantennaUpdateParams.DataMode.TEST)
          .idAntenna("ANTENNA-ID")
    ...
    fun body() {
      ...
      assertThat(body.antenna()).contains(OnorbitantennaUpdateParams.Antenna.builder()
          .dataMode(OnorbitantennaUpdateParams.Antenna.DataMode.TEST)
          .name("IRIDIUM NEXT 121-ANTENNA-10075")
          .source("Bluestaq")
          .id("ANTENNA-ID")
