...
internal class IsrCollectionQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val isrCollectionQueryhelpResponse =
            IsrCollectionQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(isrCollectionQueryhelpResponse.classificationMarking())
        ...
        assertThat(isrCollectionQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(isrCollectionQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedIsrCollectionQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(isrCollectionQueryhelpResponse),
                jacksonTypeRef<IsrCollectionQueryhelpResponse>(),
            )

        assertThat(roundtrippedIsrCollectionQueryhelpResponse)
            .isEqualTo(isrCollectionQueryhelpResponse)
    }
}
