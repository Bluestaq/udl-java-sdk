...
internal class TrackRouteQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val trackRouteQueryhelpResponse = TrackRouteQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(trackRouteQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(trackRouteQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(trackRouteQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedTrackRouteQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(trackRouteQueryhelpResponse), jacksonTypeRef<TrackRouteQueryhelpResponse>())
