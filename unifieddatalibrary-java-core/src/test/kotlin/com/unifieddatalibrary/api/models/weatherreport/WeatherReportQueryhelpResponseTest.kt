...
internal class WeatherReportQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val weatherReportQueryhelpResponse =
            WeatherReportQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(weatherReportQueryhelpResponse.classificationMarking())
        ...
        assertThat(weatherReportQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(weatherReportQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedWeatherReportQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(weatherReportQueryhelpResponse),
                jacksonTypeRef<WeatherReportQueryhelpResponse>(),
            )

        assertThat(roundtrippedWeatherReportQueryhelpResponse)
            .isEqualTo(weatherReportQueryhelpResponse)
    }
}
