...
internal class OnboardnavigationUnvalidatedPublishParamsTest {
    ...
    fun create() {
      OnboardnavigationUnvalidatedPublishParams.builder()
          .addBody(OnboardnavigationUnvalidatedPublishParams.Body.builder()
              ...
              .referenceFrame(OnboardnavigationUnvalidatedPublishParams.Body.ReferenceFrame.J2000)
              .satNo(101)
    ...
    @Test
    fun body() {
      val params = OnboardnavigationUnvalidatedPublishParams.builder()
          .addBody(OnboardnavigationUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(OnboardnavigationUnvalidatedPublishParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(OnboardnavigationUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(OnboardnavigationUnvalidatedPublishParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2021-07-20T01:02:03.123456Z"))
