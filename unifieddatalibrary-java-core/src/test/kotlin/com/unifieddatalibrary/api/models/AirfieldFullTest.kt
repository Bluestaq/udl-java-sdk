...
internal class AirfieldFullTest {
    ...
    @Test
    fun create() {
      val airfieldFull = AirfieldFull.builder()
      ...
      assertThat(airfieldFull.alternativeNames().getOrNull()).containsExactly("BELLEVILLE", "JONESTOWN")
      ...
      assertThat(airfieldFull.createdAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      ...
      assertThat(airfieldFull.suitabilityCodeDescs().getOrNull()).containsExactly("Suitable C-32", "Suitable C-5", "Suitable C-130")
      assertThat(airfieldFull.suitabilityCodes()).contains("ABC")
      assertThat(airfieldFull.updatedAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedAirfieldFull = jsonMapper.readValue(jsonMapper.writeValueAsString(airfieldFull), jacksonTypeRef<AirfieldFull>())
