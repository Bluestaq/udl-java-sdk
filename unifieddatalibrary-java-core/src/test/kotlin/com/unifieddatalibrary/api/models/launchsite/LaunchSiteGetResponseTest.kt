...
internal class LaunchSiteGetResponseTest {
    ...
    @Test
    fun create() {
        val launchSiteGetResponse =
            LaunchSiteGetResponse.builder()
                ...
                .addLaunchSiteDetail(
                    LaunchSiteGetResponse.LaunchSiteDetail.builder()
                        .classificationMarking("U")
        ...
        assertThat(launchSiteGetResponse.createdAt())
        ...
        assertThat(launchSiteGetResponse.launchSiteDetails().getOrNull())
            .containsExactly(
                LaunchSiteGetResponse.LaunchSiteDetail.builder()
                    .classificationMarking("U")
                    .dataMode(LaunchSiteGetResponse.LaunchSiteDetail.DataMode.TEST)
        ...
        assertThat(launchSiteGetResponse.origNetwork()).contains("OPS1")
        assertThat(launchSiteGetResponse.shortCode()).contains("SNMLP")
        assertThat(launchSiteGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedLaunchSiteGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(launchSiteGetResponse),
                jacksonTypeRef<LaunchSiteGetResponse>(),
            )
