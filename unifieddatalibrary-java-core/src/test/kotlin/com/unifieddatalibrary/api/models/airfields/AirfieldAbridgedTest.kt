...
internal class AirfieldAbridgedTest {
    ...
    @Test
    fun create() {
        val airfieldAbridged =
            AirfieldAbridged.builder()
        ...
        assertThat(airfieldAbridged.alternativeNames().getOrNull())
        ...
        assertThat(airfieldAbridged.createdAt())
        ...
        assertThat(airfieldAbridged.suitabilityCodeDescs().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedAirfieldAbridged =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(airfieldAbridged),
                jacksonTypeRef<AirfieldAbridged>(),
            )
