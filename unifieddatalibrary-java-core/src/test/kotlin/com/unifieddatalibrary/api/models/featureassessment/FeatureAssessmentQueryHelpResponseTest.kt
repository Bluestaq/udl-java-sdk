...
internal class FeatureAssessmentQueryHelpResponseTest {
    ...
    @Test
    fun create() {
      val featureAssessmentQueryHelpResponse = FeatureAssessmentQueryHelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(featureAssessmentQueryHelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(featureAssessmentQueryHelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(featureAssessmentQueryHelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedFeatureAssessmentQueryHelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(featureAssessmentQueryHelpResponse), jacksonTypeRef<FeatureAssessmentQueryHelpResponse>())

      assertThat(roundtrippedFeatureAssessmentQueryHelpResponse).isEqualTo(featureAssessmentQueryHelpResponse)
    }
}
