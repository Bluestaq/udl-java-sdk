...
internal class EventEvolutionListResponseTest {
    ...
    @Test
    fun create() {
      val eventEvolutionListResponse = EventEvolutionListResponse.builder()
      ...
      assertThat(eventEvolutionListResponse.dataMode()).isEqualTo(EventEvolutionListResponse.DataMode.TEST)
      ...
      assertThat(eventEvolutionListResponse.startTime()).isEqualTo(OffsetDateTime.parse("2021-12-02T16:00:00.123Z"))
      ...
      assertThat(eventEvolutionListResponse.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(eventEvolutionListResponse.andims()).contains(2)
      assertThat(eventEvolutionListResponse.asrid()).contains(4326)
      assertThat(eventEvolutionListResponse.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(eventEvolutionListResponse.createdAt()).contains(OffsetDateTime.parse("2021-12-02T16:00:00.123Z"))
      assertThat(eventEvolutionListResponse.createdBy()).contains("some.user")
      assertThat(eventEvolutionListResponse.dataDescription()).contains("Description of relationship between srcTyps and srcIds")
      assertThat(eventEvolutionListResponse.endTime()).contains(OffsetDateTime.parse("2021-12-03T16:00:00.123Z"))
      ...
      assertThat(eventEvolutionListResponse.srcIds().getOrNull()).containsExactly("SRC_ID_1", "SRC_ID_2")
      assertThat(eventEvolutionListResponse.srcTyps().getOrNull()).containsExactly("AIS", "CONJUNCTION")
    ...
    fun roundtrip() {
      ...
      val roundtrippedEventEvolutionListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(eventEvolutionListResponse), jacksonTypeRef<EventEvolutionListResponse>())
