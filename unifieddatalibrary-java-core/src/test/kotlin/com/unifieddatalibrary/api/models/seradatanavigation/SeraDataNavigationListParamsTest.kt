...
internal class SeraDataNavigationListParamsTest {
    ...
    @Test
    fun create() {
        SeraDataNavigationListParams.builder().firstResult(0L).maxResults(0L).build()
    }

    @Test
    fun queryParams() {
        val params = SeraDataNavigationListParams.builder().firstResult(0L).maxResults(0L).build()
