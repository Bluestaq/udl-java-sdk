...
internal class IonoObservationTupleResponseTest {
    ...
    @Test
    fun create() {
      val ionoObservationTupleResponse = IonoObservationTupleResponse.builder()
          ...
          .amplitude(IonoObservationTupleResponse.Amplitude.builder()
              ...
              .notes("NOTES")
              .build())
          .antennaElementPosition(IonoObservationTupleResponse.AntennaElementPosition.builder()
              .addData(listOf(
                1.23, 0.123
              ))
              .addDimensionName("NAME1")
              ...
              .addDimension(4)
              .build())
          .antennaElementPositionCoordinateSystem(IonoObservationTupleResponse.AntennaElementPositionCoordinateSystem.J2000)
          .artistFlags(listOf(
            1,
            2,
            3,
          ))
          .azimuth(IonoObservationTupleResponse.Azimuth.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .b0(68.07)
          .b1(1.87)
          .addCharAtt(IonoObservationTupleResponse.CharAtt.builder()
              .charName("hprimeF2")
          ...
          .d(1.1)
          .d1(1.94)
          .datum(IonoObservationTupleResponse.Datum.builder()
              .data(listOf(
                1.1,
                2.1,
                3.1,
              ...
              .build())
          .deltafoF2(1.1)
          .densityProfile(IonoObservationTupleResponse.DensityProfile.builder()
              .iri(IonoObservationTupleResponse.DensityProfile.Iri.builder()
                  .b0(245.1)
                  .b1(3.45)
                  .chi(35.1)
                  .d1(0.0)
                  ...
                  .nValB(147025.1)
                  .build())
              .parabolic(IonoObservationTupleResponse.DensityProfile.Parabolic.builder()
                  .description("Best-fit algorithm in NHPC software.")
                  .addParabolicItem(IonoObservationTupleResponse.DensityProfile.Parabolic.ParabolicItem.builder()
                      .f(3.621)
                      .layer("E")
                      .y(11.1)
                      .z(110.2)
                      .build())
                  .build())
              .quasiParabolic(IonoObservationTupleResponse.DensityProfile.QuasiParabolic.builder()
                  .description("Array of the best-fit 3-parameter quasi-parabolas defined via A, B, C coefficients, f^2=A/r^2+B/r+C")
                  .earthRadius(6370.1)
                  .addQuasiParabolicSegment(IonoObservationTupleResponse.DensityProfile.QuasiParabolic.QuasiParabolicSegment.builder()
                      .a(-550273940000.0)
                      .b(169837632.0)
                      .c(13104.63)
                      .error(0.0016)
                      ...
                      .build())
                  .build())
              .shiftedChebyshev(IonoObservationTupleResponse.DensityProfile.ShiftedChebyshev.builder()
                  .description("Best-fit Huang-Reinisch formalism based on shifted Chebyshev expansion.")
                  .addShiftedChebyshev(IonoObservationTupleResponse.DensityProfile.ShiftedChebyshev.InnerShiftedChebyshev.builder()
                      .coeffs(listOf(
                        -11.2,
                        -10.536,
                        3.357,
                      ...
                      .build())
                  .build())
              .topsideExtensionChapmanConst(IonoObservationTupleResponse.DensityProfile.TopsideExtensionChapmanConst.builder()
                  .chi(35.1)
                  ...
                  .scaleF2(45.191)
                  .build())
              .topsideExtensionVaryChap(IonoObservationTupleResponse.DensityProfile.TopsideExtensionVaryChap.builder()
                  .alpha(30.1)
                  .beta(30.1)
                  .chi(30.1)
                  .description("Constant scale height Chapman topside layer determined using bottomside peak density parameters and placed chi km above the ionosonde-determined peak height.")
              ...
              .build())
          .doppler(IonoObservationTupleResponse.Doppler.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .elevation(IonoObservationTupleResponse.Elevation.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .foF2p(1.1)
          .foP(87.21)
          .frequency(IonoObservationTupleResponse.Frequency.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .phase(IonoObservationTupleResponse.Phase.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .polarization(IonoObservationTupleResponse.Polarization.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                IonoObservationTupleResponse.Polarization.UnnamedSchemaWithArrayParent1.X, IonoObservationTupleResponse.Polarization.UnnamedSchemaWithArrayParent1.O
              )))))))
              .addDimensionName("NAME1")
              .addDimensionName("NAME2")
              .addDimension(1)
              ...
              .notes("NOTES")
              .build())
          .power(IonoObservationTupleResponse.Power.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .qe(0.95)
          .qf(1.83)
          .range(IonoObservationTupleResponse.Range.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .scalerInfo(IonoObservationTupleResponse.ScalerInfo.builder()
              .confidenceLevel(11)
              .confidenceScore(75)
              .name("ARTIST-4")
              .organization("UML")
              ...
              .version(500200.1)
              .build())
          .stokes(IonoObservationTupleResponse.Stokes.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
          ...
          .time(IonoObservationTupleResponse.Time.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
              ...
              .notes("NOTES")
              .build())
          .traceGeneric(IonoObservationTupleResponse.TraceGeneric.builder()
      ...
      assertThat(ionoObservationTupleResponse.dataMode()).isEqualTo(IonoObservationTupleResponse.DataMode.TEST)
      assertThat(ionoObservationTupleResponse.source()).isEqualTo("Bluestaq")
      assertThat(ionoObservationTupleResponse.startTimeUtc()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      ...
      assertThat(ionoObservationTupleResponse.amplitude()).contains(IonoObservationTupleResponse.Amplitude.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationTupleResponse.antennaElementPosition()).contains(IonoObservationTupleResponse.AntennaElementPosition.builder()
          .addData(listOf(
            1.23, 0.123
          ))
          .addDimensionName("NAME1")
          ...
          .addDimension(4)
          .build())
      assertThat(ionoObservationTupleResponse.antennaElementPositionCoordinateSystem()).contains(IonoObservationTupleResponse.AntennaElementPositionCoordinateSystem.J2000)
      assertThat(ionoObservationTupleResponse.artistFlags().getOrNull()).containsExactly(1, 2, 3)
      assertThat(ionoObservationTupleResponse.azimuth()).contains(IonoObservationTupleResponse.Azimuth.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationTupleResponse.charAtts().getOrNull()).containsExactly(IonoObservationTupleResponse.CharAtt.builder()
          .charName("hprimeF2")
          .addClimateModelInputParam("ISSN1 88.1")
          .addClimateModelInputParam("Option 2")
          .climateModelName("IRI")
          ...
          .ursiId("04")
          .build())
      assertThat(ionoObservationTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(ionoObservationTupleResponse.datum()).contains(IonoObservationTupleResponse.Datum.builder()
          .data(listOf(
            1.1,
            2.1,
            3.1,
      ...
      assertThat(ionoObservationTupleResponse.densityProfile()).contains(IonoObservationTupleResponse.DensityProfile.builder()
          .iri(IonoObservationTupleResponse.DensityProfile.Iri.builder()
              .b0(245.1)
              .b1(3.45)
              .chi(35.1)
          ...
          .valleyModelDescription("2-parameter UMLCAR model with width W in km and depth D in MHz, no fitting.")
          .build())
      assertThat(ionoObservationTupleResponse.doppler()).contains(IonoObservationTupleResponse.Doppler.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationTupleResponse.electronDensity().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationTupleResponse.electronDensityUncertainty().getOrNull()).containsExactly(0.8, 0.2, 0.5)
      assertThat(ionoObservationTupleResponse.elevation()).contains(IonoObservationTupleResponse.Elevation.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationTupleResponse.frequency()).contains(IonoObservationTupleResponse.Frequency.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationTupleResponse.phase()).contains(IonoObservationTupleResponse.Phase.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationTupleResponse.plasmaFrequency().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationTupleResponse.plasmaFrequencyUncertainty().getOrNull()).containsExactly(0.8, 0.2, 0.5)
      assertThat(ionoObservationTupleResponse.platformName()).contains("Millstone Hill")
      assertThat(ionoObservationTupleResponse.polarization()).contains(IonoObservationTupleResponse.Polarization.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            IonoObservationTupleResponse.Polarization.UnnamedSchemaWithArrayParent1.X, IonoObservationTupleResponse.Polarization.UnnamedSchemaWithArrayParent1.O
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationTupleResponse.power()).contains(IonoObservationTupleResponse.Power.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationTupleResponse.range()).contains(IonoObservationTupleResponse.Range.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationTupleResponse.receiveCoordinates().getOrNull()).containsExactly(listOf(
        45.5,
        179.3,
        35.6,
      ), listOf(
      ...
      assertThat(ionoObservationTupleResponse.receiveSensorType()).contains(IonoObservationTupleResponse.ReceiveSensorType.MOBILE)
      assertThat(ionoObservationTupleResponse.restrictedFrequency().getOrNull()).containsExactly(12.5, 34.5, 45.3)
      assertThat(ionoObservationTupleResponse.restrictedFrequencyNotes()).contains("Example notes")
      assertThat(ionoObservationTupleResponse.scaleHeightF2Peak()).contains(35.613)
      assertThat(ionoObservationTupleResponse.scalerInfo()).contains(IonoObservationTupleResponse.ScalerInfo.builder()
          .confidenceLevel(11)
          .confidenceScore(75)
          .name("ARTIST-4")
          .organization("UML")
          ...
          .version(500200.1)
          .build())
      assertThat(ionoObservationTupleResponse.stokes()).contains(IonoObservationTupleResponse.Stokes.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAMES1")
      ...
      assertThat(ionoObservationTupleResponse.tidAzimuth().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationTupleResponse.tidPeriods().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationTupleResponse.tidPhaseSpeeds().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationTupleResponse.time()).contains(IonoObservationTupleResponse.Time.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationTupleResponse.traceGeneric()).contains(IonoObservationTupleResponse.TraceGeneric.builder()
          .addData(listOf(listOf(
            1.23, 1.0903
          )))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationTupleResponse.transmitCoordinates().getOrNull()).containsExactly(listOf(
        45.5,
        179.3,
        35.6,
      ), listOf(
      ...
      assertThat(ionoObservationTupleResponse.transmitSensorType()).contains(IonoObservationTupleResponse.TransmitSensorType.MOBILE)
      assertThat(ionoObservationTupleResponse.typeEs()).contains("Auroral")
      assertThat(ionoObservationTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedIonoObservationTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(ionoObservationTupleResponse), jacksonTypeRef<IonoObservationTupleResponse>())
