...
internal class LaunchVehicleDetailCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(LaunchVehicleDetailCreateParams.DataMode.TEST)
        assertThat(body.idLaunchVehicle()).isEqualTo("LAUNCHVEHICLE-ID")
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.id()).contains("LAUNCHVEHICLEDETAILS-ID")
