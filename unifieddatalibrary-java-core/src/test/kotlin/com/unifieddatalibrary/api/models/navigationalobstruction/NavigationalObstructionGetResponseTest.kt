...
internal class NavigationalObstructionGetResponseTest {
    ...
    @Test
    fun create() {
      val navigationalObstructionGetResponse = NavigationalObstructionGetResponse.builder()
      ...
      assertThat(navigationalObstructionGetResponse.cycleDate()).isEqualTo(LocalDate.parse("2024-06-13"))
      assertThat(navigationalObstructionGetResponse.dataMode()).isEqualTo(NavigationalObstructionGetResponse.DataMode.TEST)
      ...
      assertThat(navigationalObstructionGetResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      ...
      assertThat(navigationalObstructionGetResponse.baselineCutoffDate()).contains(LocalDate.parse("2024-04-23"))
      ...
      assertThat(navigationalObstructionGetResponse.createdAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      assertThat(navigationalObstructionGetResponse.createdBy()).contains("some.user")
      assertThat(navigationalObstructionGetResponse.cutoffDate()).contains(LocalDate.parse("2024-05-21"))
      ...
      assertThat(navigationalObstructionGetResponse.featureDescription()).contains("Powerline Pylon, General")
      ...
      assertThat(navigationalObstructionGetResponse.initRecordDate()).contains(LocalDate.parse("1991-03-28"))
      assertThat(navigationalObstructionGetResponse.keys().getOrNull()).containsExactly("key1", "key2")
      ...
      assertThat(navigationalObstructionGetResponse.nextCycleDate()).contains(LocalDate.parse("2024-07-11"))
      ...
      assertThat(navigationalObstructionGetResponse.obstacleRemarks()).contains("Obstacle remarks")
      ...
      assertThat(navigationalObstructionGetResponse.revDate()).contains(LocalDate.parse("2020-02-26"))
      ...
      assertThat(navigationalObstructionGetResponse.sourceDate()).contains(LocalDate.parse("2016-04-01"))
      ...
      assertThat(navigationalObstructionGetResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(navigationalObstructionGetResponse.values().getOrNull()).containsExactly("value1", "value2")
    ...
    fun roundtrip() {
      ...
      val roundtrippedNavigationalObstructionGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(navigationalObstructionGetResponse), jacksonTypeRef<NavigationalObstructionGetResponse>())

      assertThat(roundtrippedNavigationalObstructionGetResponse).isEqualTo(navigationalObstructionGetResponse)
    }
}
