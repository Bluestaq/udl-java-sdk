...
internal class CrewQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val crewQueryhelpResponse =
            CrewQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(crewQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedCrewQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(crewQueryhelpResponse),
                jacksonTypeRef<CrewQueryhelpResponse>(),
            )
