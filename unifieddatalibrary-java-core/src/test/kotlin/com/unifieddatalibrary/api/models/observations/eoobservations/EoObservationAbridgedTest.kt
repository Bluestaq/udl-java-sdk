...
internal class EoObservationAbridgedTest {
    ...
    fun create() {
        ...
        assertThat(eoObservationAbridged.declination()).contains(-17.3053)
        ...
        assertThat(eoObservationAbridged.declinationUnc()).contains(0.000015)
        ...
        assertThat(eoObservationAbridged.ra()).contains(23.4025)
        ...
        assertThat(eoObservationAbridged.raUnc()).contains(0.000015)
        ...
        assertThat(eoObservationAbridged.senalt()).contains(0.7539)
        ...
        assertThat(eoObservationAbridged.zeroPtdUnc()).contains(1.1)
    }
