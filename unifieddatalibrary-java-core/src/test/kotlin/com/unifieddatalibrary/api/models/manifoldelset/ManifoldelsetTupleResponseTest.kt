...
internal class ManifoldelsetTupleResponseTest {
    ...
    @Test
    fun create() {
        val manifoldelsetTupleResponse =
            ManifoldelsetTupleResponse.builder()
        ...
        assertThat(manifoldelsetTupleResponse.dataMode())
            .isEqualTo(ManifoldelsetTupleResponse.DataMode.TEST)
        assertThat(manifoldelsetTupleResponse.epoch())
        ...
        assertThat(manifoldelsetTupleResponse.createdAt())
        ...
        assertThat(manifoldelsetTupleResponse.origNetwork()).contains("OPS1")
        ...
        assertThat(manifoldelsetTupleResponse.updatedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedManifoldelsetTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(manifoldelsetTupleResponse),
                jacksonTypeRef<ManifoldelsetTupleResponse>(),
            )
