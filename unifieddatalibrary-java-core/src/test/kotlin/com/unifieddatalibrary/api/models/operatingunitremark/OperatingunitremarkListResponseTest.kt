...
internal class OperatingunitremarkListResponseTest {
    ...
    @Test
    fun create() {
      val operatingunitremarkListResponse = OperatingunitremarkListResponse.builder()
      ...
      assertThat(operatingunitremarkListResponse.dataMode()).isEqualTo(OperatingunitremarkListResponse.DataMode.TEST)
      ...
      assertThat(operatingunitremarkListResponse.id()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
      ...
      assertThat(operatingunitremarkListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedOperatingunitremarkListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(operatingunitremarkListResponse), jacksonTypeRef<OperatingunitremarkListResponse>())

      assertThat(roundtrippedOperatingunitremarkListResponse).isEqualTo(operatingunitremarkListResponse)
    }
}
