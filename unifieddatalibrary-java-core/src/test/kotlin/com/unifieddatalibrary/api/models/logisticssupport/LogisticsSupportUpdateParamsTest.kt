...
internal class LogisticsSupportUpdateParamsTest {

    @Test
    fun create() {
        LogisticsSupportUpdateParams.builder()
            .pathId("id")
            .classificationMarking("U")
            .dataMode(LogisticsSupportUpdateParams.DataMode.TEST)
            .rptCreatedTime(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
            .source("Bluestaq")
            .bodyId("LOGISTICS-SUPPORT-DETAILS UUID")
            .aircraftMds("CO17A")
            ...
            .addLogisticsDiscrepancyInfo(
                LogisticsSupportUpdateParams.LogisticsDiscrepancyInfo.builder()
            ...
            .addLogisticsSupportItem(
                LogisticsSupportUpdateParams.LogisticsSupportItem.builder()
                    .cannibalized(true)
                    ...
                    .addLogisticsPart(
                        LogisticsSupportUpdateParams.LogisticsSupportItem.LogisticsPart.builder()
                            .figureNumber("3")
                            .indexNumber("4")
                            .locationVerifier("JANE DOE")
                            .addLogisticsStock(
                                LogisticsSupportUpdateParams.LogisticsSupportItem.LogisticsPart
                                    .LogisticsStock
                                    .builder()
                                    .quantity(4)
                                    .sourceIcao("PHIK")
                    ...
                    .addLogisticsRemark(
                        LogisticsSupportUpdateParams.LogisticsSupportItem.LogisticsRemark.builder()
                            .lastChanged(OffsetDateTime.parse("2023-07-17T10:30:00.123Z"))
                            .remark("EXAMPLE REMARK")
                            .username("JSMITH")
                            .build()
                    ...
                    .addLogisticsSpecialty(
                        LogisticsSupportUpdateParams.LogisticsSupportItem.LogisticsSpecialty
                            .builder()
                            .firstName("JOHN")
                            .last4Ssn("9999")
                            .lastName("SMITH")
            ...
            .addLogisticsTransportationPlan(
                LogisticsSupportUpdateParams.LogisticsTransportationPlan.builder()
                    ...
                    .addLogisticsSegment(
                        LogisticsSupportUpdateParams.LogisticsTransportationPlan.LogisticsSegment
                            .builder()
                            .arrivalIcao("YBCS")
                            .departureIcao("PHIK")
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(LogisticsSupportUpdateParams.DataMode.TEST)
        assertThat(body.rptCreatedTime())
            .isEqualTo(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.bodyId()).contains("LOGISTICS-SUPPORT-DETAILS UUID")
