...
internal class OnorbitAntennaFullTest {
    ...
    fun create() {
        ...
        assertThat(onorbitAntennaFull.antenna())
            .contains(
                AntennaFull.builder()
                    .dataMode(AntennaFull.DataMode.TEST)
                    .name("IRIDIUM NEXT 121-ANTENNA-10075")
        ...
        assertThat(onorbitAntennaFull.createdAt())
        ...
        assertThat(onorbitAntennaFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbitAntennaFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbitAntennaFull),
                jacksonTypeRef<OnorbitAntennaFull>(),
            )
