...
internal class AirspaceControlOrderCreateParamsTest {
    ...
    fun create() {
      AirspaceControlOrderCreateParams.builder()
          ...
          .acoSerialNum("27B")
          .addAirspaceControlMeansStatus(AirspaceControlOrderCreateParams.AirspaceControlMeansStatus.builder()
              .addAirspaceControlMean(AirspaceControlOrderCreateParams.AirspaceControlMeansStatus.AirspaceControlMean.builder()
                  .addAirspaceControlPoint(AirspaceControlOrderCreateParams.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceControlPoint.builder()
                      .ctrlPtAltitude("BRFL:MSL-FL230")
                      .ctrlPtLocation("203632N0594256E")
                      .ctrlPtName("APPLE")
                      .ctrlPtType("CP")
                      .build())
                  .addAirspaceTimePeriod(AirspaceControlOrderCreateParams.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceTimePeriod.builder()
                      .addIntDur("65WK")
                      .addIntFreq("WEEKLY")
                  ...
                  .bearing1(160.0)
                  .cmId("DESIG:C34")
                  .cmShape(AirspaceControlOrderCreateParams.AirspaceControlMeansStatus.AirspaceControlMean.CmShape.POLYARC)
                  .cmType("cmType")
              ...
              .build())
          .addAirspaceControlOrderReference(AirspaceControlOrderCreateParams.AirspaceControlOrderReference.builder()
              .refOriginator("SHAPE")
              .refSerialNum("100")
              .addRefSiC("RCA")
              .addRefSiC("FN:4503B")
    ...
    @Test
    fun body() {
      val params = AirspaceControlOrderCreateParams.builder()
          .classificationMarking("U")
          .dataMode(AirspaceControlOrderCreateParams.DataMode.TEST)
          .opExName("DESERT WIND")
          .originator("USCENTCOM")
      ...
      assertThat(body.airspaceControlMeansStatus().getOrNull()).containsExactly(AirspaceControlOrderCreateParams.AirspaceControlMeansStatus.builder()
          .addAirspaceControlMean(AirspaceControlOrderCreateParams.AirspaceControlMeansStatus.AirspaceControlMean.builder()
              .addAirspaceControlPoint(AirspaceControlOrderCreateParams.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceControlPoint.builder()
                  .ctrlPtAltitude("BRFL:MSL-FL230")
                  .ctrlPtLocation("203632N0594256E")
          ...
          .build())
      assertThat(body.airspaceControlOrderReferences().getOrNull()).containsExactly(AirspaceControlOrderCreateParams.AirspaceControlOrderReference.builder()
          .refOriginator("SHAPE")
          .refSerialNum("100")
          .addRefSiC("RCA")
          .addRefSiC("FN:4503B")
      ...
      assertThat(body.downgradeInsDates().getOrNull()).containsExactly("NST:AT EXERCISE ENDEX", "DATE:25NOV1997")
