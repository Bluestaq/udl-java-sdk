...
internal class SgiTupleResponseTest {
    ...
    @Test
    fun create() {
      val sgiTupleResponse = SgiTupleResponse.builder()
      ...
      assertThat(sgiTupleResponse.effectiveDate()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(sgiTupleResponse.sgiDate()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(sgiTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(sgiTupleResponse.frequencies().getOrNull()).containsExactly(25.0, 25.125, 25.25, 25.375, 25.5, 25.625, 25.75, 25.875)
      ...
      assertThat(sgiTupleResponse.observedBaseline().getOrNull()).containsExactly(15, 32, 25, 134, 0, 6, 19, 8)
      assertThat(sgiTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(sgiTupleResponse.origNetwork()).contains("ORIG")
      assertThat(sgiTupleResponse.origSensorId()).contains("ORIGSENSOR-ID")
      assertThat(sgiTupleResponse.powers().getOrNull()).containsExactly(67.1, 65.2, 68.1, 74.3, 68.1, 96.4, 97.3, 68.1)
      ...
      assertThat(sgiTupleResponse.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
      assertThat(sgiTupleResponse.transactionId()).contains("TRANSACTION-ID")
      assertThat(sgiTupleResponse.type()).contains("JBH09")
      assertThat(sgiTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSgiTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sgiTupleResponse), jacksonTypeRef<SgiTupleResponse>())
