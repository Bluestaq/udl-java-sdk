...
internal class TrackRouteUnvalidatedPublishParamsTest {
    ...
    fun create() {
      TrackRouteUnvalidatedPublishParams.builder()
          ...
          .addAltitudeBlock(TrackRouteUnvalidatedPublishParams.AltitudeBlock.builder()
          ...
          .origNetwork("OPS1")
          .addPoc(TrackRouteUnvalidatedPublishParams.Poc.builder()
              .office("A34")
              .phone("8675309")
              .pocName("Fred Smith")
              .pocOrg("HQAF")
          ...
          .addRoutePoint(TrackRouteUnvalidatedPublishParams.RoutePoint.builder()
              .altCountryCode("IZ")
              .countryCode("NL")
              .dafifPt(true)
              .magDec(7.35)
    ...
    @Test
    fun body() {
      val params = TrackRouteUnvalidatedPublishParams.builder()
          .classificationMarking("U")
          .dataMode(TrackRouteUnvalidatedPublishParams.DataMode.TEST)
          .lastUpdateDate(OffsetDateTime.parse("2024-09-17T16:00:00.123Z"))
          .source("Bluestaq")
      ...
      assertThat(body.altitudeBlocks().getOrNull()).containsExactly(TrackRouteUnvalidatedPublishParams.AltitudeBlock.builder()
          .altitudeSequenceId("A1")
          .lowerAltitude(27000.1)
          .upperAltitude(27200.5)
          .build())
      ...
      assertThat(body.poc().getOrNull()).containsExactly(TrackRouteUnvalidatedPublishParams.Poc.builder()
          .office("A34")
          .phone("8675309")
          .pocName("Fred Smith")
          .pocOrg("HQAF")
      ...
      assertThat(body.routePoints().getOrNull()).containsExactly(TrackRouteUnvalidatedPublishParams.RoutePoint.builder()
          .altCountryCode("IZ")
          .countryCode("NL")
          .dafifPt(true)
          .magDec(7.35)
