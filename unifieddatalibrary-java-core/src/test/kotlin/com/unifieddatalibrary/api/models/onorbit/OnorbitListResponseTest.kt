...
internal class OnorbitListResponseTest {
    ...
    @Test
    fun create() {
      val onorbitListResponse = OnorbitListResponse.builder()
      ...
      assertThat(onorbitListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(onorbitListResponse.createdBy()).contains("some.user")
      assertThat(onorbitListResponse.decayDate()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(onorbitListResponse.objectType()).contains(OnorbitListResponse.ObjectType.PAYLOAD)
    ...
    fun roundtrip() {
      ...
      val roundtrippedOnorbitListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(onorbitListResponse), jacksonTypeRef<OnorbitListResponse>())
