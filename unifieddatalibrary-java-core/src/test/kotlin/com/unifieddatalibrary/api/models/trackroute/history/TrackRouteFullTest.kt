...
internal class TrackRouteFullTest {
    ...
    fun create() {
        val trackRouteFull =
            TrackRouteFull.builder()
                ...
                .addAltitudeBlock(
                    TrackRouteFull.AltitudeBlock.builder()
                ...
                .addRoutePoint(
                    TrackRouteFull.RoutePoint.builder()
                        .altCountryCode("IZ")
                        .countryCode("NL")
                        .dafifPt(true)
                        .magDec(7.35)
        ...
        assertThat(trackRouteFull.lastUpdateDate())
        ...
        assertThat(trackRouteFull.altitudeBlocks().getOrNull())
            .containsExactly(
                TrackRouteFull.AltitudeBlock.builder()
                    .altitudeSequenceId("A1")
                    .lowerAltitude(27000.1)
        ...
        assertThat(trackRouteFull.createdAt())
        ...
        assertThat(trackRouteFull.effectiveDate())
        ...
        assertThat(trackRouteFull.lastUsedDate())
            .contains(OffsetDateTime.parse("2024-09-17T16:00:00.123Z"))
        ...
        assertThat(trackRouteFull.poc().getOrNull())
            .containsExactly(
                TrackRouteFull.Poc.builder()
                    .office("A34")
                    .phone("8675309")
        ...
        assertThat(trackRouteFull.reviewDate())
            .contains(OffsetDateTime.parse("2024-09-16T16:00:00.123Z"))
        assertThat(trackRouteFull.routePoints().getOrNull())
            .containsExactly(
                TrackRouteFull.RoutePoint.builder()
                    .altCountryCode("IZ")
                    .countryCode("NL")
        ...
        assertThat(trackRouteFull.updatedAt())
            .contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedTrackRouteFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(trackRouteFull),
                jacksonTypeRef<TrackRouteFull>(),
            )
