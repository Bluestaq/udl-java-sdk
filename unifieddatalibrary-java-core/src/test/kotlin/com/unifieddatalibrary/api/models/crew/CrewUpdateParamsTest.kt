...
internal class CrewUpdateParamsTest {
    ...
    fun create() {
      CrewUpdateParams.builder()
          ...
          .createdBy("some.user")
          .crewHome(false)
          .addCrewMember(CrewUpdateParams.CrewMember.builder()
              .alerted(true)
              .allSortie(true)
              .approved(true)
              .attached(true)
    ...
    @Test
    fun pathParams() {
      val params = CrewUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(CrewUpdateParams.DataMode.TEST)
          .origCrewId("JHJDHjhuu929o92")
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(CrewUpdateParams.DataMode.TEST)
      ...
      assertThat(body.crewMembers().getOrNull()).containsExactly(CrewUpdateParams.CrewMember.builder()
          .alerted(true)
          .allSortie(true)
          .approved(true)
          .attached(true)
