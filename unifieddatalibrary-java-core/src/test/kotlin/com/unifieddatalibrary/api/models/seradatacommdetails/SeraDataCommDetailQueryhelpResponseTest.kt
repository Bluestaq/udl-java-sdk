...
internal class SeraDataCommDetailQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val seraDataCommDetailQueryhelpResponse = SeraDataCommDetailQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(seraDataCommDetailQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(seraDataCommDetailQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(seraDataCommDetailQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedSeraDataCommDetailQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(seraDataCommDetailQueryhelpResponse), jacksonTypeRef<SeraDataCommDetailQueryhelpResponse>())

      assertThat(roundtrippedSeraDataCommDetailQueryhelpResponse).isEqualTo(seraDataCommDetailQueryhelpResponse)
    }
}
