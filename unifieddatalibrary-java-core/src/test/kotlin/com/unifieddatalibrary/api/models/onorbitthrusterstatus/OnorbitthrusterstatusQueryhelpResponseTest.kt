...
internal class OnorbitthrusterstatusQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val onorbitthrusterstatusQueryhelpResponse = OnorbitthrusterstatusQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(onorbitthrusterstatusQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(onorbitthrusterstatusQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(onorbitthrusterstatusQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedOnorbitthrusterstatusQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(onorbitthrusterstatusQueryhelpResponse), jacksonTypeRef<OnorbitthrusterstatusQueryhelpResponse>())

      assertThat(roundtrippedOnorbitthrusterstatusQueryhelpResponse).isEqualTo(onorbitthrusterstatusQueryhelpResponse)
    }
}
