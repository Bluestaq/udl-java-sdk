...
internal class ScsEntityTest {
    ...
    @Test
    fun create() {
      val scsEntity = ScsEntity.builder()
          .id("id")
      ...
      assertThat(scsEntity.attachment()).contains(Attachment.builder()
          .author("author")
          .content("content")
          .contentLength(0)
          .contentType("content_type")
    ...
    fun roundtrip() {
      ...
      val roundtrippedScsEntity = jsonMapper.readValue(jsonMapper.writeValueAsString(scsEntity), jacksonTypeRef<ScsEntity>())
