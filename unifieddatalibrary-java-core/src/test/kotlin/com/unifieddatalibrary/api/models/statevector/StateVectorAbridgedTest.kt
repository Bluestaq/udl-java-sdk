...
internal class StateVectorAbridgedTest {
    ...
    fun create() {
        ...
        assertThat(stateVectorAbridged.missionCenter()).contains("Mission Center A")
        assertThat(stateVectorAbridged.msgTs())
        ...
        assertThat(stateVectorAbridged.origNetwork()).contains("OPS1")
