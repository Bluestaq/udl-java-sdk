...
internal class DiplomaticClearanceUpdateParamsTest {
    ...
    fun create() {
      DiplomaticClearanceUpdateParams.builder()
          ...
          .createdBy("some.user")
          .addDiplomaticClearanceDetail(DiplomaticClearanceUpdateParams.DiplomaticClearanceDetail.builder()
              .action("O")
              .altCountryCode("IZ")
              ...
              .build())
          .addDiplomaticClearanceRemark(DiplomaticClearanceUpdateParams.DiplomaticClearanceRemark.builder()
    ...
    @Test
    fun pathParams() {
      val params = DiplomaticClearanceUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(DiplomaticClearanceUpdateParams.DataMode.TEST)
          .firstDepDate(OffsetDateTime.parse("2024-01-01T01:01:01.123Z"))
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(DiplomaticClearanceUpdateParams.DataMode.TEST)
      ...
      assertThat(body.diplomaticClearanceDetails().getOrNull()).containsExactly(DiplomaticClearanceUpdateParams.DiplomaticClearanceDetail.builder()
          .action("O")
          .altCountryCode("IZ")
          .clearanceId("MFMW225662GHQ")
          .clearanceRemark("Clearance remarks")
          ...
          .windowRemark("Period remarks")
          .build())
      assertThat(body.diplomaticClearanceRemarks().getOrNull()).containsExactly(DiplomaticClearanceUpdateParams.DiplomaticClearanceRemark.builder()
          .date(OffsetDateTime.parse("2024-01-01T01:01:01.123Z"))
          .gdssRemarkId("GDSSREMARK-ID")
          .text("Example mission remarks.")
          .user("John Doe")
