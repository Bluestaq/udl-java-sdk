...
internal class SgiQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val sgiQueryhelpResponse =
            SgiQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(sgiQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSgiQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sgiQueryhelpResponse),
                jacksonTypeRef<SgiQueryhelpResponse>(),
            )
