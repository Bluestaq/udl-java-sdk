...
internal class SeradataRadarPayloadListParamsTest {
    ...
    @Test
    fun create() {
        SeradataRadarPayloadListParams.builder().firstResult(0L).maxResults(0L).build()
    }

    @Test
    fun queryParams() {
        val params = SeradataRadarPayloadListParams.builder().firstResult(0L).maxResults(0L).build()
