...
internal class ObjectOfInterestTupleResponseTest {
    ...
    @Test
    fun create() {
        val objectOfInterestTupleResponse =
            ObjectOfInterestTupleResponse.builder()
                ...
                .addManifold(
                    ObjectOfInterestTupleResponse.Manifold.builder()
                        .classificationMarking("U")
        ...
        assertThat(objectOfInterestTupleResponse.dataMode())
            .isEqualTo(ObjectOfInterestTupleResponse.DataMode.TEST)
        assertThat(objectOfInterestTupleResponse.idOnOrbit()).isEqualTo("REF-ONORBIT-ID")
        assertThat(objectOfInterestTupleResponse.sensorTaskingStartTime())
        ...
        assertThat(objectOfInterestTupleResponse.statusDate())
            .isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
        assertThat(objectOfInterestTupleResponse.id()).contains("OBJECTOFINTEREST-ID")
        assertThat(objectOfInterestTupleResponse.affectedObjects().getOrNull())
        ...
        assertThat(objectOfInterestTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(objectOfInterestTupleResponse.createdBy()).contains("some.user")
        assertThat(objectOfInterestTupleResponse.deltaTs().getOrNull())
            .containsExactly(1.1, 2.2, 3.3)
        assertThat(objectOfInterestTupleResponse.deltaVs().getOrNull())
            .containsExactly(1.1, 2.2, 3.3)
        ...
        assertThat(objectOfInterestTupleResponse.elsetEpoch())
        ...
        assertThat(objectOfInterestTupleResponse.lastObTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(objectOfInterestTupleResponse.manifolds().getOrNull())
            .containsExactly(
                ObjectOfInterestTupleResponse.Manifold.builder()
                    .classificationMarking("U")
                    .dataMode(ObjectOfInterestTupleResponse.Manifold.DataMode.TEST)
        ...
        assertThat(objectOfInterestTupleResponse.missedObTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(objectOfInterestTupleResponse.name()).contains("Example_name")
        assertThat(objectOfInterestTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(objectOfInterestTupleResponse.sensorTaskingStopTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
        assertThat(objectOfInterestTupleResponse.status()).contains("OPEN")
        assertThat(objectOfInterestTupleResponse.svEpoch())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(objectOfInterestTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedObjectOfInterestTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(objectOfInterestTupleResponse),
                jacksonTypeRef<ObjectOfInterestTupleResponse>(),
            )

        assertThat(roundtrippedObjectOfInterestTupleResponse)
            .isEqualTo(objectOfInterestTupleResponse)
    }
}
