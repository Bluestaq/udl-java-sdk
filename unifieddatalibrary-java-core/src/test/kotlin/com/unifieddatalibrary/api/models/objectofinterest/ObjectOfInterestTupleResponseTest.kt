...
internal class ObjectOfInterestTupleResponseTest {

    @Test
    fun create() {
      val objectOfInterestTupleResponse = ObjectOfInterestTupleResponse.builder()
          .classificationMarking("U")
          .dataMode(ObjectOfInterestTupleResponse.DataMode.TEST)
          ...
          .addManifold(ObjectOfInterestTupleResponse.Manifold.builder()
              .classificationMarking("U")
              .dataMode(ObjectOfInterestTupleResponse.Manifold.DataMode.TEST)
      ...
      assertThat(objectOfInterestTupleResponse.classificationMarking()).isEqualTo("U")
      assertThat(objectOfInterestTupleResponse.dataMode()).isEqualTo(ObjectOfInterestTupleResponse.DataMode.TEST)
      assertThat(objectOfInterestTupleResponse.idOnOrbit()).isEqualTo("REF-ONORBIT-ID")
      assertThat(objectOfInterestTupleResponse.sensorTaskingStartTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
      assertThat(objectOfInterestTupleResponse.source()).isEqualTo("Bluestaq")
      assertThat(objectOfInterestTupleResponse.statusDate()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
      assertThat(objectOfInterestTupleResponse.id()).contains("OBJECTOFINTEREST-ID")
      assertThat(objectOfInterestTupleResponse.affectedObjects().getOrNull()).containsExactly("AFFECTEDOBJECT1-ID", "AFFECTEDOBJECT2-ID")
      assertThat(objectOfInterestTupleResponse.apogee()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.argOfPerigee()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.bStar()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(objectOfInterestTupleResponse.createdBy()).contains("some.user")
      assertThat(objectOfInterestTupleResponse.deltaTs().getOrNull()).containsExactly(1.1, 2.2, 3.3)
      assertThat(objectOfInterestTupleResponse.deltaVs().getOrNull()).containsExactly(1.1, 2.2, 3.3)
      assertThat(objectOfInterestTupleResponse.description()).contains("Example description")
      assertThat(objectOfInterestTupleResponse.eccentricity()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.elsetEpoch()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(objectOfInterestTupleResponse.inclination()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.lastObTime()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(objectOfInterestTupleResponse.manifolds().getOrNull()).containsExactly(ObjectOfInterestTupleResponse.Manifold.builder()
          .classificationMarking("U")
          .dataMode(ObjectOfInterestTupleResponse.Manifold.DataMode.TEST)
          .idObjectOfInterest("OBJECTOFINTEREST-ID")
          .source("Bluestaq")
          ...
          .weight(0.3)
          .build())
      assertThat(objectOfInterestTupleResponse.meanAnomaly()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.meanMotion()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.meanMotionDDot()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.meanMotionDot()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.missedObTime()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(objectOfInterestTupleResponse.name()).contains("Example_name")
      assertThat(objectOfInterestTupleResponse.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
          ...
          .updatedBy("some.user")
          .build())
      assertThat(objectOfInterestTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(objectOfInterestTupleResponse.origNetwork()).contains("ORIG")
      assertThat(objectOfInterestTupleResponse.perigee()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.period()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.priority()).contains(7)
      assertThat(objectOfInterestTupleResponse.raan()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.revNo()).contains(123)
      assertThat(objectOfInterestTupleResponse.satNo()).contains(12)
      assertThat(objectOfInterestTupleResponse.semiMajorAxis()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.sensorTaskingStopTime()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
      assertThat(objectOfInterestTupleResponse.status()).contains("OPEN")
      assertThat(objectOfInterestTupleResponse.svEpoch()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(objectOfInterestTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(objectOfInterestTupleResponse.updatedBy()).contains("some.user")
      assertThat(objectOfInterestTupleResponse.x()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.xvel()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.y()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.yvel()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.z()).contains(123.4)
      assertThat(objectOfInterestTupleResponse.zvel()).contains(123.4)
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedObjectOfInterestTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(objectOfInterestTupleResponse), jacksonTypeRef<ObjectOfInterestTupleResponse>())

      assertThat(roundtrippedObjectOfInterestTupleResponse).isEqualTo(objectOfInterestTupleResponse)
    }
}
