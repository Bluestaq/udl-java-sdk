...
internal class VideoGetStreamFileResponseTest {
    ...
    @Test
    fun create() {
        val videoGetStreamFileResponse =
            VideoGetStreamFileResponse.builder()
        ...
        assertThat(videoGetStreamFileResponse.dataMode())
            .isEqualTo(VideoGetStreamFileResponse.DataMode.TEST)
        ...
        assertThat(videoGetStreamFileResponse.createdAt())
        ...
        assertThat(videoGetStreamFileResponse.startTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoGetStreamFileResponse.stopTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoGetStreamFileResponse.videoUrls().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedVideoGetStreamFileResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(videoGetStreamFileResponse),
                jacksonTypeRef<VideoGetStreamFileResponse>(),
            )
