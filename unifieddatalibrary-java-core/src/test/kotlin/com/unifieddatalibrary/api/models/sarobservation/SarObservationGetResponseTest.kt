...
internal class SarObservationGetResponseTest {

    @Test
    fun create() {
      val sarObservationGetResponse = SarObservationGetResponse.builder()
          ...
          .dataMode(SarObservationGetResponse.DataMode.TEST)
          .sarMode("SPOTLIGHT")
          .source("Bluestaq")
      ...
      assertThat(sarObservationGetResponse.classificationMarking()).isEqualTo("U")
      assertThat(sarObservationGetResponse.collectionEnd()).isEqualTo(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
      assertThat(sarObservationGetResponse.collectionStart()).isEqualTo(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
      assertThat(sarObservationGetResponse.dataMode()).isEqualTo(SarObservationGetResponse.DataMode.TEST)
      assertThat(sarObservationGetResponse.sarMode()).isEqualTo("SPOTLIGHT")
      assertThat(sarObservationGetResponse.source()).isEqualTo("Bluestaq")
      assertThat(sarObservationGetResponse.id()).contains("SAROBSERVATION-ID")
      assertThat(sarObservationGetResponse.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(sarObservationGetResponse.andims()).contains(3)
      assertThat(sarObservationGetResponse.area()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(sarObservationGetResponse.asrid()).contains(3)
      assertThat(sarObservationGetResponse.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(sarObservationGetResponse.atype()).contains("POLYGON")
      assertThat(sarObservationGetResponse.azimuthAngle()).contains(285.4481793)
      assertThat(sarObservationGetResponse.centerTime()).contains(OffsetDateTime.parse("2023-04-22T17:36:35.100885Z"))
      assertThat(sarObservationGetResponse.collectionId()).contains("COLLECTION-ID")
      assertThat(sarObservationGetResponse.continuousSpotAngle()).contains(45.1)
      assertThat(sarObservationGetResponse.coordSys()).contains("ECEF")
      assertThat(sarObservationGetResponse.createdAt()).contains(OffsetDateTime.parse("2023-04-22T17:51:40.854Z"))
      assertThat(sarObservationGetResponse.createdBy()).contains("some.user")
      assertThat(sarObservationGetResponse.detectionEnd()).contains(OffsetDateTime.parse("2023-07-08T17:35:20.772190Z"))
      assertThat(sarObservationGetResponse.detectionId()).contains("DETECTION-ID")
      assertThat(sarObservationGetResponse.detectionStart()).contains(OffsetDateTime.parse("2023-07-08T17:35:01.615396Z"))
      assertThat(sarObservationGetResponse.dwellTime()).contains(79.156794)
      assertThat(sarObservationGetResponse.externalId()).contains("EXTERNAL-ID")
      assertThat(sarObservationGetResponse.farRange()).contains(34.1)
      assertThat(sarObservationGetResponse.grazeAngle()).contains(45.1)
      assertThat(sarObservationGetResponse.groundResolutionProjection()).contains(0.5)
      assertThat(sarObservationGetResponse.idOnOrbit()).contains("36036")
      assertThat(sarObservationGetResponse.idSensor()).contains("36036-1L")
      assertThat(sarObservationGetResponse.incidenceAngle()).contains(45.1)
      assertThat(sarObservationGetResponse.looksAzimuth()).contains(2)
      assertThat(sarObservationGetResponse.looksRange()).contains(1)
      assertThat(sarObservationGetResponse.multilookNumber()).contains(5.0)
      assertThat(sarObservationGetResponse.nearRange()).contains(12.1)
      assertThat(sarObservationGetResponse.obDirection()).contains("RIGHT")
      assertThat(sarObservationGetResponse.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
          ...
          .updatedBy("some.user")
          .build())
      assertThat(sarObservationGetResponse.operatingBand()).contains("L")
      assertThat(sarObservationGetResponse.operatingFreq()).contains(2345.6)
      assertThat(sarObservationGetResponse.orbitState()).contains("ASCENDING")
      assertThat(sarObservationGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(sarObservationGetResponse.origNetwork()).contains("OPS1")
      assertThat(sarObservationGetResponse.origObjectId()).contains("36036")
      assertThat(sarObservationGetResponse.origSensorId()).contains("SMOS-1L")
      assertThat(sarObservationGetResponse.pulseBandwidth()).contains(500.1)
      assertThat(sarObservationGetResponse.pulseDuration()).contains(0.000011)
      assertThat(sarObservationGetResponse.resolutionAzimuth()).contains(0.123)
      assertThat(sarObservationGetResponse.resolutionRange()).contains(0.123)
      assertThat(sarObservationGetResponse.rxPolarization()).contains("H")
      assertThat(sarObservationGetResponse.satNo()).contains(36036)
      assertThat(sarObservationGetResponse.senalt()).contains(1.1)
      assertThat(sarObservationGetResponse.senlatEnd()).contains(45.1)
      assertThat(sarObservationGetResponse.senlatStart()).contains(45.1)
      assertThat(sarObservationGetResponse.senlonEnd()).contains(179.1)
      assertThat(sarObservationGetResponse.senlonStart()).contains(179.1)
      assertThat(sarObservationGetResponse.senvelx()).contains(1.1)
      assertThat(sarObservationGetResponse.senvely()).contains(1.1)
      assertThat(sarObservationGetResponse.senvelz()).contains(1.1)
      assertThat(sarObservationGetResponse.slantRange()).contains(60.1)
      assertThat(sarObservationGetResponse.snr()).contains(10.1)
      assertThat(sarObservationGetResponse.sourceDl()).contains("AXE")
      assertThat(sarObservationGetResponse.spacingAzimuth()).contains(0.123)
      assertThat(sarObservationGetResponse.spacingRange()).contains(0.123)
      assertThat(sarObservationGetResponse.squintAngle()).contains(1.2)
      assertThat(sarObservationGetResponse.srcIds().getOrNull()).containsExactly("f7e01cd4-626b-441f-a423-17b160eb78ba", "223833c4-be0d-4fdb-a2e4-325a48eccced")
      assertThat(sarObservationGetResponse.srcTyps().getOrNull()).containsExactly("ESID", "GROUNDIMAGE")
      assertThat(sarObservationGetResponse.swathLength()).contains(12.1)
      assertThat(sarObservationGetResponse.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
      assertThat(sarObservationGetResponse.targetposx()).contains(50.23)
      assertThat(sarObservationGetResponse.targetposy()).contains(50.23)
      assertThat(sarObservationGetResponse.targetposz()).contains(50.23)
      assertThat(sarObservationGetResponse.transactionId()).contains("TRANSACTION-ID")
      assertThat(sarObservationGetResponse.txPolarization()).contains("H")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSarObservationGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sarObservationGetResponse), jacksonTypeRef<SarObservationGetResponse>())

      assertThat(roundtrippedSarObservationGetResponse).isEqualTo(sarObservationGetResponse)
    }
}
