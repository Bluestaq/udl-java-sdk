...
internal class SarObservationGetResponseTest {
    ...
    @Test
    fun create() {
        val sarObservationGetResponse =
            SarObservationGetResponse.builder()
        ...
        assertThat(sarObservationGetResponse.collectionEnd())
            .isEqualTo(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
        assertThat(sarObservationGetResponse.collectionStart())
            .isEqualTo(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
        assertThat(sarObservationGetResponse.dataMode())
            .isEqualTo(SarObservationGetResponse.DataMode.TEST)
        ...
        assertThat(sarObservationGetResponse.agjson())
            .contains(
                "{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }"
            )
        assertThat(sarObservationGetResponse.andims()).contains(3)
        assertThat(sarObservationGetResponse.area())
            .contains(
                "POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))"
            )
        assertThat(sarObservationGetResponse.asrid()).contains(3)
        assertThat(sarObservationGetResponse.atext())
            .contains(
                "POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))"
            )
        ...
        assertThat(sarObservationGetResponse.centerTime())
        ...
        assertThat(sarObservationGetResponse.detectionStart())
        ...
        assertThat(sarObservationGetResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSarObservationGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sarObservationGetResponse),
                jacksonTypeRef<SarObservationGetResponse>(),
            )
