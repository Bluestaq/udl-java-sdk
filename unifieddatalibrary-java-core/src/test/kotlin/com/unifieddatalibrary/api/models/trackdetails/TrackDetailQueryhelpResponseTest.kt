...
internal class TrackDetailQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val trackDetailQueryhelpResponse = TrackDetailQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(trackDetailQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(trackDetailQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(trackDetailQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedTrackDetailQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(trackDetailQueryhelpResponse), jacksonTypeRef<TrackDetailQueryhelpResponse>())
