...
internal class AircraftSortieCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(AircraftSortieCreateParams.DataMode.TEST)
        ...
        assertThat(body.paperStatus()).contains(AircraftSortieCreateParams.PaperStatus.PUBLISHED)
        ...
        assertThat(body.pprStatus()).contains(AircraftSortieCreateParams.PprStatus.PENDING)
        ...
        assertThat(body.rvnReq()).contains(AircraftSortieCreateParams.RvnReq.R)
