    ...
    fun create() {
        val historyListResponse =
            HistoryListResponse.builder()
                ...
                .rcsUnc(1.23)
                .satNo(40699)
                .senReferenceFrame(HistoryListResponse.SenReferenceFrame.J2000)
                .senx(-4527.793)
                .seny(3793.586)
                .senz(3553.495)
                .snr(17.292053)
        ...
        assertThat(historyListResponse.id()).contains("bdcacfb0-3c47-4bd0-9d6c-9fa7d2c4fbb0")
        assertThat(historyListResponse.accel()).contains(1.23)
        assertThat(historyListResponse.accelUnc()).contains(0.1)
        assertThat(historyListResponse.alt()).contains(478.056378)
        assertThat(historyListResponse.azimuth()).contains(134.5)
        assertThat(historyListResponse.azimuthBias()).contains(0.123)
        assertThat(historyListResponse.azimuthRate()).contains(0.5)
        assertThat(historyListResponse.azimuthUnc()).contains(0.5)
        assertThat(historyListResponse.bistaticRange()).contains(754.8212)
        assertThat(historyListResponse.bistaticRangeAccel()).contains(1.23)
        assertThat(historyListResponse.bistaticRangeAccelUnc()).contains(0.1)
        assertThat(historyListResponse.bistaticRangeBias()).contains(2.34)
        assertThat(historyListResponse.bistaticRangeRate()).contains(-0.30222)
        assertThat(historyListResponse.bistaticRangeRateUnc()).contains(0.123)
        assertThat(historyListResponse.bistaticRangeUnc()).contains(5.1)
        assertThat(historyListResponse.coning()).contains(60.1)
        assertThat(historyListResponse.coningUnc()).contains(0.5)
        assertThat(historyListResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(historyListResponse.createdBy()).contains("some.user")
        assertThat(historyListResponse.declination()).contains(10.23)
        assertThat(historyListResponse.delay()).contains(0.00505820232809312)
        assertThat(historyListResponse.delayBias()).contains(0.00000123)
        assertThat(historyListResponse.delayUnc()).contains(0.0000031)
        assertThat(historyListResponse.descriptor()).contains("Descriptor")
        assertThat(historyListResponse.doppler()).contains(-101.781641000597)
        assertThat(historyListResponse.dopplerUnc()).contains(0.2)
        assertThat(historyListResponse.elevation()).contains(76.1)
        assertThat(historyListResponse.elevationBias()).contains(0.123)
        assertThat(historyListResponse.elevationRate()).contains(0.5)
        assertThat(historyListResponse.elevationUnc()).contains(0.5)
        assertThat(historyListResponse.extObservationId()).contains("26892")
        assertThat(historyListResponse.idOnOrbit()).contains("40699")
        assertThat(historyListResponse.idRfEmitter()).contains("RED_CLIFFS_3ABCRN")
        assertThat(historyListResponse.idSensor()).contains("OCULUSA")
        assertThat(historyListResponse.idSensorRefReceiver()).contains("OculusRef1")
        assertThat(historyListResponse.lat()).contains(-35.1181763996856)
        assertThat(historyListResponse.lon()).contains(139.613567052763)
        assertThat(historyListResponse.obPosition()).contains("FIRST")
        ...
        assertThat(historyListResponse.orthogonalRcs()).contains(10.23)
        assertThat(historyListResponse.orthogonalRcsUnc()).contains(1.23)
        assertThat(historyListResponse.ra()).contains(1.23)
        assertThat(historyListResponse.rcs()).contains(100.23)
        assertThat(historyListResponse.rcsUnc()).contains(1.23)
        assertThat(historyListResponse.satNo()).contains(40699)
        assertThat(historyListResponse.senReferenceFrame())
            .contains(HistoryListResponse.SenReferenceFrame.J2000)
        assertThat(historyListResponse.senx()).contains(-4527.793)
        assertThat(historyListResponse.seny()).contains(3793.586)
        assertThat(historyListResponse.senz()).contains(3553.495)
        assertThat(historyListResponse.snr()).contains(17.292053)
        ...
        assertThat(historyListResponse.timingBias()).contains(1.23)
        assertThat(historyListResponse.tof()).contains(0.00592856674135648)
        assertThat(historyListResponse.tofBias()).contains(0.00000123)
        assertThat(historyListResponse.tofUnc()).contains(0.0000031)
        assertThat(historyListResponse.trackId()).contains("12212")
        assertThat(historyListResponse.transactionId()).contains("TRANSACTION-ID")
        assertThat(historyListResponse.type()).contains("RADAR")
        assertThat(historyListResponse.uct()).contains(false)
        assertThat(historyListResponse.xvel()).contains(1.23)
        assertThat(historyListResponse.yvel()).contains(3.21)
        assertThat(historyListResponse.zvel()).contains(3.12)
    }
