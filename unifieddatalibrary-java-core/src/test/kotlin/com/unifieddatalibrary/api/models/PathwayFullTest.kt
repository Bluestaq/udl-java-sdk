...
internal class PathwayFullTest {
    ...
    @Test
    fun create() {
      val pathwayFull = PathwayFull.builder()
      ...
      assertThat(pathwayFull.pwDefinition()).contains("AGP: 14L, K6, K, G (ANG APRN TO TWY K), GUARD (MAIN)")
      assertThat(pathwayFull.pwLastChangedBy()).contains("John Smith")
      assertThat(pathwayFull.pwLastChangedDate()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.000Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedPathwayFull = jsonMapper.readValue(jsonMapper.writeValueAsString(pathwayFull), jacksonTypeRef<PathwayFull>())
