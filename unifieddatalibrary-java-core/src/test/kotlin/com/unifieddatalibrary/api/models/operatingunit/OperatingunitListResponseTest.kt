...
internal class OperatingunitListResponseTest {
    ...
    @Test
    fun create() {
      val operatingunitListResponse = OperatingunitListResponse.builder()
      ...
      assertThat(operatingunitListResponse.dataMode()).isEqualTo(OperatingunitListResponse.DataMode.TEST)
      ...
      assertThat(operatingunitListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(operatingunitListResponse.referenceDoc()).contains("Provider Reference Documentation")
    ...
    fun roundtrip() {
      ...
      val roundtrippedOperatingunitListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(operatingunitListResponse), jacksonTypeRef<OperatingunitListResponse>())
