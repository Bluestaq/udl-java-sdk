...
internal class EngineTest {
    ...
    fun create() {
        ...
        assertThat(engine.engineDetails().getOrNull())
            .containsExactly(
                EngineDetailsFull.builder()
                    .classificationMarking("U")
                    .dataMode(EngineDetailsFull.DataMode.TEST)
        ...
        assertThat(engine.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedEngine =
            jsonMapper.readValue(jsonMapper.writeValueAsString(engine), jacksonTypeRef<Engine>())
