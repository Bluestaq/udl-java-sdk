...
internal class SensorMaintenanceListResponseTest {
    ...
    @Test
    fun create() {
        val sensorMaintenanceListResponse =
            SensorMaintenanceListResponse.builder()
        ...
        assertThat(sensorMaintenanceListResponse.dataMode())
            .isEqualTo(SensorMaintenanceListResponse.DataMode.TEST)
        assertThat(sensorMaintenanceListResponse.endTime())
        ...
        assertThat(sensorMaintenanceListResponse.startTime())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
        ...
        assertThat(sensorMaintenanceListResponse.createdAt())
        ...
        assertThat(sensorMaintenanceListResponse.externalId()).contains("EXTERNAL-ID")
        ...
        assertThat(sensorMaintenanceListResponse.inactiveDate())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        ...
        assertThat(sensorMaintenanceListResponse.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedSensorMaintenanceListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sensorMaintenanceListResponse),
                jacksonTypeRef<SensorMaintenanceListResponse>(),
            )

        assertThat(roundtrippedSensorMaintenanceListResponse)
            .isEqualTo(sensorMaintenanceListResponse)
    }
}
