...
internal class EphemerisSetListParamsTest {

    @Test
    fun create() {
      EphemerisSetListParams.builder()
          .firstResult(0L)
          .maxResults(0L)
    ...
    @Test
    fun queryParams() {
      val params = EphemerisSetListParams.builder()
          .firstResult(0L)
          .maxResults(0L)
          .pointEndTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .pointStartTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun queryParamsWithoutOptionalFields() {
      val params = EphemerisSetListParams.builder().build()
