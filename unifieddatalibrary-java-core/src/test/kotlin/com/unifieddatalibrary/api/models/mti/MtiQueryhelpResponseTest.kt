...
internal class MtiQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val mtiQueryhelpResponse = MtiQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(mtiQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedMtiQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(mtiQueryhelpResponse), jacksonTypeRef<MtiQueryhelpResponse>())
