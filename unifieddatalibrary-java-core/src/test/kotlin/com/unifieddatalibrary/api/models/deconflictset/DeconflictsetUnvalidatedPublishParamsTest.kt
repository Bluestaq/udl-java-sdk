...
internal class DeconflictsetUnvalidatedPublishParamsTest {
        ...
        DeconflictsetUnvalidatedPublishParams.builder()
            ...
            .addDeconflictWindow(
                DeconflictsetUnvalidatedPublishParams.DeconflictWindow.builder()
                    .classificationMarking("U")
                    .dataMode(DeconflictsetUnvalidatedPublishParams.DeconflictWindow.DataMode.TEST)
                    .eventStartTime(OffsetDateTime.parse("2023-09-27T20:49:37.812Z"))
                    .source("Bluestaq")
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(DeconflictsetUnvalidatedPublishParams.DataMode.TEST)
