...
internal class RfEmitterTupleResponseTest {

    @Test
    fun create() {
        val rfEmitterTupleResponse =
            RfEmitterTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(RfEmitterTupleResponse.DataMode.TEST)
                .name("RF_NAME")
                .source("Bluestaq")
                ...
                .origNetwork("OPS1")
                .addRfEmitterDetail(
                    RfEmitterTupleResponse.RfEmitterDetail.builder()
                        .classificationMarking("U")
                        .dataMode(RfEmitterTupleResponse.RfEmitterDetail.DataMode.TEST)
                        ...
                        .amplifier(
                            RfEmitterTupleResponse.RfEmitterDetail.Amplifier.builder()
                        ...
                        .addAntenna(
                            RfEmitterTupleResponse.RfEmitterDetail.Antenna.builder()
                                .antennaDiameter(20.23)
                                .addAntennaSize(1.1)
                                .addAntennaSize(2.2)
                                .azElFixed(true)
                                .addFeed(
                                    RfEmitterTupleResponse.RfEmitterDetail.Antenna.Feed.builder()
                                        .freqMax(43500.1)
                                        .freqMin(39500.1)
                                        .name("Feed A")
                                ...
                                .name("ds1Rotor")
                                .addReceiverChannel(
                                    RfEmitterTupleResponse.RfEmitterDetail.Antenna.ReceiverChannel
                                        .builder()
                                        .bandwidth(0.51)
                                        .channelNum("315")
                                ...
                                .addTransmitChannel(
                                    RfEmitterTupleResponse.RfEmitterDetail.Antenna.TransmitChannel
                                        .builder()
                                        .power(100.23)
                                        .bandwidth(0.125)
                                        .channelNum("12")
                        ...
                        .origNetwork("OPS1")
                        .addPowerOffset(
                            RfEmitterTupleResponse.RfEmitterDetail.PowerOffset.builder()
                                .frequencyBand("KU")
                                .powerOffset(-5.1)
                                .build()
                        )
                        ...
                        .addService(
                            RfEmitterTupleResponse.RfEmitterDetail.Service.builder()
                        ...
                        .addTtp(
                            RfEmitterTupleResponse.RfEmitterDetail.Ttp.builder()
                                .outputSignalName("SIGNAL_A")
                                .addTechniqueDefinition(
                                    RfEmitterTupleResponse.RfEmitterDetail.Ttp.TechniqueDefinition
                                        .builder()
                                        .name("SIGNAL TUNE")
                                        .addParamDefinition(
                                            RfEmitterTupleResponse.RfEmitterDetail.Ttp
                                                .TechniqueDefinition
                                                .ParamDefinition
                                                .builder()
                                                .defaultValue("444.0")
        ...
        assertThat(rfEmitterTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(rfEmitterTupleResponse.dataMode())
            .isEqualTo(RfEmitterTupleResponse.DataMode.TEST)
        assertThat(rfEmitterTupleResponse.name()).isEqualTo("RF_NAME")
        assertThat(rfEmitterTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(rfEmitterTupleResponse.id()).contains("ad88770b-d824-443f-bdce-5f9e3fa500a9")
        assertThat(rfEmitterTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2025-03-05T16:00:00.123Z"))
        assertThat(rfEmitterTupleResponse.createdBy()).contains("some.user")
        assertThat(rfEmitterTupleResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(rfEmitterTupleResponse.extSysId()).contains("EXTSYS-ID")
        assertThat(rfEmitterTupleResponse.idEntity())
            .contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
        assertThat(rfEmitterTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(rfEmitterTupleResponse.origNetwork()).contains("OPS1")
        assertThat(rfEmitterTupleResponse.rfEmitterDetails().getOrNull())
            .containsExactly(
                RfEmitterTupleResponse.RfEmitterDetail.builder()
                    .classificationMarking("U")
                    .dataMode(RfEmitterTupleResponse.RfEmitterDetail.DataMode.TEST)
        ...
        assertThat(rfEmitterTupleResponse.subtype()).contains("BLOCK_1")
        assertThat(rfEmitterTupleResponse.type()).contains("TYPE_OF_EMITTER")
        assertThat(rfEmitterTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2025-03-05T16:00:00.123Z"))
        assertThat(rfEmitterTupleResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedRfEmitterTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(rfEmitterTupleResponse),
                jacksonTypeRef<RfEmitterTupleResponse>(),
            )

        assertThat(roundtrippedRfEmitterTupleResponse).isEqualTo(rfEmitterTupleResponse)
    }
}
