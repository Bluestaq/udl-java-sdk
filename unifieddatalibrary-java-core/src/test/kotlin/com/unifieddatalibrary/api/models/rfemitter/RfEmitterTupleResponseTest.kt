...
internal class RfEmitterTupleResponseTest {
    ...
    @Test
    fun create() {
      val rfEmitterTupleResponse = RfEmitterTupleResponse.builder()
          ...
          .origin("THIRD_PARTY_DATASOURCE")
          .origNetwork("ORIG")
          .addRfEmitterDetail(RfEmitterTupleResponse.RfEmitterDetail.builder()
              .classificationMarking("U")
              ...
              .origin("THIRD_PARTY_DATASOURCE")
              .origNetwork("ORIG")
              .productionFacilityLocation(LocationFull.builder()
                  .classificationMarking("U")
                  .dataMode(LocationFull.DataMode.TEST)
                  .name("Example location")
                  .source("Bluestaq")
      ...
      assertThat(rfEmitterTupleResponse.dataMode()).isEqualTo(RfEmitterTupleResponse.DataMode.TEST)
      assertThat(rfEmitterTupleResponse.name()).isEqualTo("RF_NAME")
      assertThat(rfEmitterTupleResponse.source()).isEqualTo("Bluestaq")
      assertThat(rfEmitterTupleResponse.id()).contains("RFEMITTER-ID")
      assertThat(rfEmitterTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(rfEmitterTupleResponse.createdBy()).contains("some.user")
      assertThat(rfEmitterTupleResponse.entity()).contains(EntityFull.builder()
          .classificationMarking("U")
          .dataMode(EntityFull.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
          ...
          .addUrl("URL2")
          .build())
      assertThat(rfEmitterTupleResponse.idEntity()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
      assertThat(rfEmitterTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(rfEmitterTupleResponse.origNetwork()).contains("ORIG")
      assertThat(rfEmitterTupleResponse.rfEmitterDetails().getOrNull()).containsExactly(RfEmitterTupleResponse.RfEmitterDetail.builder()
          .classificationMarking("U")
          .dataMode(RfEmitterTupleResponse.RfEmitterDetail.DataMode.TEST)
          .idRfEmitter("RFEMITTER-ID")
          .source("Bluestaq")
      ...
      assertThat(rfEmitterTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfEmitterTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rfEmitterTupleResponse), jacksonTypeRef<RfEmitterTupleResponse>())
