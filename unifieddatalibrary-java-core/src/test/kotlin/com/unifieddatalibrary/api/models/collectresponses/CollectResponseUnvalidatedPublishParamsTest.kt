...
internal class CollectResponseUnvalidatedPublishParamsTest {
    ...
    fun create() {
      CollectResponseUnvalidatedPublishParams.builder()
          .addBody(CollectResponseUnvalidatedPublishParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = CollectResponseUnvalidatedPublishParams.builder()
          .addBody(CollectResponseUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(CollectResponseUnvalidatedPublishParams.Body.DataMode.TEST)
              .idRequest("REF-REQUEST-ID")
      ...
      assertThat(body).containsExactly(CollectResponseUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(CollectResponseUnvalidatedPublishParams.Body.DataMode.TEST)
          .idRequest("REF-REQUEST-ID")
          .source("Bluestaq")
