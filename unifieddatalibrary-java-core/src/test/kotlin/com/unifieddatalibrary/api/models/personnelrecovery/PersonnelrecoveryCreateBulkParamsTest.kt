...
internal class PersonnelrecoveryCreateBulkParamsTest {
    ...
    fun create() {
      PersonnelrecoveryCreateBulkParams.builder()
          .addBody(PersonnelrecoveryCreateBulkParams.Body.builder()
              ...
              .createdBy("some.user")
              .executionInfo(PersonnelrecoveryCreateBulkParams.Body.ExecutionInfo.builder()
                  .egress(66.53)
                  .addEgressPoint(107.23)
                  .addEgressPoint(30.455)
                  .escortVehicle(PersonnelrecoveryCreateBulkParams.Body.ExecutionInfo.EscortVehicle.builder()
                      .callSign("FALCO")
                      .primaryFreq(34.55)
                      .strength(5)
                      .type("C17")
                  ...
                  .recoveryVehicle(PersonnelrecoveryCreateBulkParams.Body.ExecutionInfo.RecoveryVehicle.builder()
                      .callSign("FALCO")
                      .primaryFreq(34.55)
                      .strength(5)
                      .type("C17")
              ...
              .numNonAmbulatory(0)
              .numPersons(1)
              .objectiveAreaInfo(PersonnelrecoveryCreateBulkParams.Body.ObjectiveAreaInfo.builder()
                  .addEnemyData(PersonnelrecoveryCreateBulkParams.Body.ObjectiveAreaInfo.EnemyData.builder()
    ...
    @Test
    fun body() {
      val params = PersonnelrecoveryCreateBulkParams.builder()
          .addBody(PersonnelrecoveryCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(PersonnelrecoveryCreateBulkParams.Body.DataMode.TEST)
              .msgTime(OffsetDateTime.parse("2021-10-15T16:00:00.123Z"))
      ...
      assertThat(body).containsExactly(PersonnelrecoveryCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(PersonnelrecoveryCreateBulkParams.Body.DataMode.TEST)
          .msgTime(OffsetDateTime.parse("2021-10-15T16:00:00.123Z"))
          .pickupLat(75.1234)
