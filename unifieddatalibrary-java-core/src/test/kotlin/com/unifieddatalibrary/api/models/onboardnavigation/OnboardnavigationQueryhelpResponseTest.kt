...
internal class OnboardnavigationQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val onboardnavigationQueryhelpResponse =
            OnboardnavigationQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(onboardnavigationQueryhelpResponse.classificationMarking())
        ...
        assertThat(onboardnavigationQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(onboardnavigationQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnboardnavigationQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onboardnavigationQueryhelpResponse),
                jacksonTypeRef<OnboardnavigationQueryhelpResponse>(),
            )

        assertThat(roundtrippedOnboardnavigationQueryhelpResponse)
            .isEqualTo(onboardnavigationQueryhelpResponse)
    }
}
