...
internal class EphemerisSetQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val ephemerisSetQueryhelpResponse = EphemerisSetQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(ephemerisSetQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(ephemerisSetQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(ephemerisSetQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedEphemerisSetQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(ephemerisSetQueryhelpResponse), jacksonTypeRef<EphemerisSetQueryhelpResponse>())

      assertThat(roundtrippedEphemerisSetQueryhelpResponse).isEqualTo(ephemerisSetQueryhelpResponse)
    }
}
