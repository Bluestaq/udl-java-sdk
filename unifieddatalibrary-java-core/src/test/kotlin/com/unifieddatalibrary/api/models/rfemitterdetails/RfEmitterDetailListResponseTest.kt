    ...
    fun create() {
        val rfEmitterDetailListResponse =
            RfEmitterDetailListResponse.builder()
                ...
                .amplifier(
                    RfEmitterDetailListResponse.Amplifier.builder()
                ...
                .addAntenna(
                    RfEmitterDetailListResponse.Antenna.builder()
                        .antennaDiameter(20.23)
                        .addAntennaSize(1.1)
                        .addAntennaSize(2.2)
                        .azElFixed(true)
                        .addFeed(
                            RfEmitterDetailListResponse.Antenna.Feed.builder()
                                .freqMax(43500.1)
                                .freqMin(39500.1)
                                .name("Feed A")
                        ...
                        .name("ds1Rotor")
                        .addReceiverChannel(
                            RfEmitterDetailListResponse.Antenna.ReceiverChannel.builder()
                                .bandwidth(0.51)
                                .channelNum("315")
                        ...
                        .addTransmitChannel(
                            RfEmitterDetailListResponse.Antenna.TransmitChannel.builder()
                                .power(100.23)
                                .bandwidth(0.125)
                                .channelNum("12")
                ...
                .origNetwork("OPS1")
                .addPowerOffset(
                    RfEmitterDetailListResponse.PowerOffset.builder()
                        .frequencyBand("KU")
                        .powerOffset(-5.1)
                        .build()
                )
                ...
                .addService(
                    RfEmitterDetailListResponse.Service.builder()
                ...
                .addTtp(
                    RfEmitterDetailListResponse.Ttp.builder()
                        .outputSignalName("SIGNAL_A")
                        .addTechniqueDefinition(
                            RfEmitterDetailListResponse.Ttp.TechniqueDefinition.builder()
                                .name("SIGNAL TUNE")
                                .addParamDefinition(
                                    RfEmitterDetailListResponse.Ttp.TechniqueDefinition
                                        .ParamDefinition
                                        .builder()
                                        .defaultValue("444.0")
                                        .max(1000.1)
        ...
        assertThat(rfEmitterDetailListResponse.id())
        ...
        assertThat(rfEmitterDetailListResponse.amplifier())
            .contains(
                RfEmitterDetailListResponse.Amplifier.builder()
                    .deviceIdentifier("1200W_Amplifier_GE")
                    .manufacturer("General Electric")
        ...
        assertThat(rfEmitterDetailListResponse.antennas().getOrNull())
            .containsExactly(
                RfEmitterDetailListResponse.Antenna.builder()
                    .antennaDiameter(20.23)
                    .addAntennaSize(1.1)
        ...
        assertThat(rfEmitterDetailListResponse.bitRunTime()).contains(120.1)
        ...
        assertThat(rfEmitterDetailListResponse.fixedAttenuation()).contains(5.1)
        assertThat(rfEmitterDetailListResponse.idManufacturerOrg()).contains("MANUFACTURERORG-ID")
        assertThat(rfEmitterDetailListResponse.idProductionFacilityLocation())
            .contains("PRODUCTIONFACILITYLOCATION-ID")
        assertThat(rfEmitterDetailListResponse.loanedToCocom()).contains("SPACEFOR-STRATNORTH")
        ...
        assertThat(rfEmitterDetailListResponse.origNetwork()).contains("OPS1")
        assertThat(rfEmitterDetailListResponse.powerOffsets().getOrNull())
            .containsExactly(
                RfEmitterDetailListResponse.PowerOffset.builder()
                    .frequencyBand("KU")
                    .powerOffset(-5.1)
        ...
        assertThat(rfEmitterDetailListResponse.prepTime()).contains(60.1)
        assertThat(rfEmitterDetailListResponse.primaryCocom()).contains("SPACESOC")
        ...
        assertThat(rfEmitterDetailListResponse.services().getOrNull())
            .containsExactly(
                RfEmitterDetailListResponse.Service.builder()
                    .name("tlc-freqcontrol")
                    .version("17.2.5_build72199")
        ...
        assertThat(rfEmitterDetailListResponse.systemSensitivityStart()).contains(50.32)
        assertThat(rfEmitterDetailListResponse.ttps().getOrNull())
            .containsExactly(
                RfEmitterDetailListResponse.Ttp.builder()
                    .outputSignalName("SIGNAL_A")
                    .addTechniqueDefinition(
                        RfEmitterDetailListResponse.Ttp.TechniqueDefinition.builder()
                            .name("SIGNAL TUNE")
                            .addParamDefinition(
                                RfEmitterDetailListResponse.Ttp.TechniqueDefinition.ParamDefinition
                                    .builder()
                                    .defaultValue("444.0")
                                    .max(1000.1)
                                    .min(0.1)
        ...
        assertThat(rfEmitterDetailListResponse.updatedAt())
            .contains(OffsetDateTime.parse("2025-03-05T16:00:00.123Z"))
        assertThat(rfEmitterDetailListResponse.updatedBy()).contains("some.user")
