...
internal class OnboardnavigationListResponseTest {
    ...
    @Test
    fun create() {
      val onboardnavigationListResponse = OnboardnavigationListResponse.builder()
      ...
      assertThat(onboardnavigationListResponse.dataMode()).isEqualTo(OnboardnavigationListResponse.DataMode.TEST)
      assertThat(onboardnavigationListResponse.source()).isEqualTo("Bluestaq")
      assertThat(onboardnavigationListResponse.startTime()).isEqualTo(OffsetDateTime.parse("2021-07-20T01:02:03.123456Z"))
      assertThat(onboardnavigationListResponse.id()).contains("ONBOARD-NAVIGATION-ID")
      assertThat(onboardnavigationListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(onboardnavigationListResponse.createdBy()).contains("some.user")
      assertThat(onboardnavigationListResponse.deltaPos().getOrNull()).containsExactly(listOf(
        1.1,
        2.2,
        3.3,
      ))
      assertThat(onboardnavigationListResponse.endTime()).contains(OffsetDateTime.parse("2021-07-20T01:02:03.123456Z"))
      ...
      assertThat(onboardnavigationListResponse.mag().getOrNull()).containsExactly(listOf(
        1.1,
        2.2,
        3.3,
      ))
      ...
      assertThat(onboardnavigationListResponse.referenceFrame()).contains(OnboardnavigationListResponse.ReferenceFrame.J2000)
      assertThat(onboardnavigationListResponse.satNo()).contains(101)
      assertThat(onboardnavigationListResponse.starCatLoadTime()).contains(OffsetDateTime.parse("2021-07-21T01:02:03.123Z"))
      assertThat(onboardnavigationListResponse.starCatName()).contains("STAR-CAT-NAME")
      assertThat(onboardnavigationListResponse.starTracker().getOrNull()).containsExactly(listOf(
        1.1,
        2.2,
        3.3,
      ))
      assertThat(onboardnavigationListResponse.sunSensor().getOrNull()).containsExactly(listOf(
        1.1,
        2.2,
        3.3,
      ))
      assertThat(onboardnavigationListResponse.ts().getOrNull()).containsExactly(OffsetDateTime.parse("2021-07-21T01:02:03.120003Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedOnboardnavigationListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(onboardnavigationListResponse), jacksonTypeRef<OnboardnavigationListResponse>())

      assertThat(roundtrippedOnboardnavigationListResponse).isEqualTo(onboardnavigationListResponse)
    }
}
