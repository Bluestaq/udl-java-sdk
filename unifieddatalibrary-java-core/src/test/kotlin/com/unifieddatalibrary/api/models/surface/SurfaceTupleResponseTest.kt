...
internal class SurfaceTupleResponseTest {
    ...
    @Test
    fun create() {
      val surfaceTupleResponse = SurfaceTupleResponse.builder()
          ...
          .stWtKn(867.6)
          .addSurfaceObstruction(SurfaceTupleResponse.SurfaceObstruction.builder()
              .classificationMarking("U")
      ...
      assertThat(surfaceTupleResponse.createdAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      ...
      assertThat(surfaceTupleResponse.ddtWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceTupleResponse.ddWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceTupleResponse.sbttWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceTupleResponse.stWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      assertThat(surfaceTupleResponse.stWtKn()).contains(867.6)
      assertThat(surfaceTupleResponse.surfaceObstructions().getOrNull()).containsExactly(SurfaceTupleResponse.SurfaceObstruction.builder()
          .classificationMarking("U")
          .dataMode(SurfaceTupleResponse.SurfaceObstruction.DataMode.TEST)
          .idSurface("be831d39-1822-da9f-7ace-6cc5643397dc")
          .source("Bluestaq")
      ...
      assertThat(surfaceTupleResponse.sWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceTupleResponse.trtWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceTupleResponse.ttWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      ...
      assertThat(surfaceTupleResponse.tWtKipModNote()).contains("Observed 25% reduction in surface integrity.")
      assertThat(surfaceTupleResponse.tWtKn()).contains(836.45)
      assertThat(surfaceTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSurfaceTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(surfaceTupleResponse), jacksonTypeRef<SurfaceTupleResponse>())
