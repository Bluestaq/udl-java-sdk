...
internal class HistoryListResponseTest {
    ...
    fun create() {
        ...
        assertThat(historyListResponse.assmtTime())
        ...
        assertThat(historyListResponse.assessment()).contains("NOMINAL")
        assertThat(historyListResponse.assmtDetails())
            .contains("This spacecraft appears to be in a stable, 3-axis controlled state")
        assertThat(historyListResponse.assmtLevel()).contains("SIGNATURE")
        assertThat(historyListResponse.assmtRotPeriod()).contains(72.5)
        assertThat(historyListResponse.assmtSubType()).contains("STABLE")
        assertThat(historyListResponse.assmtUrl()).contains("https://unifieddatalibrary.com")
        assertThat(historyListResponse.autoAssmt()).contains(false)
        assertThat(historyListResponse.collectionUrl()).contains("https://unifieddatalibrary.com")
        assertThat(historyListResponse.components().getOrNull())
        ...
        assertThat(historyListResponse.idOnOrbit()).contains("25544")
        assertThat(historyListResponse.idSensor()).contains("211")
        assertThat(historyListResponse.obDuration()).contains(1.75)
        ...
        assertThat(historyListResponse.origObjectId()).contains("ISS")
        assertThat(historyListResponse.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(historyListResponse.satNo()).contains(25544)
        assertThat(historyListResponse.sigDataType()).contains("PHOTOMETRY")
        ...
        assertThat(historyListResponse.srcTyps().getOrNull()).containsExactly("EO", "SKYIMAGE")
