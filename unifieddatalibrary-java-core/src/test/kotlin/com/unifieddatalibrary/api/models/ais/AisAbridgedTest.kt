...
internal class AisAbridgedTest {
    ...
    @Test
    fun create() {
      val aisAbridged = AisAbridged.builder()
      ...
      assertThat(aisAbridged.antennaRefDimensions().getOrNull()).containsExactly(50.1, 50.1, 20.1, 20.1)
      ...
      assertThat(aisAbridged.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(aisAbridged.destinationEta()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(aisAbridged.etaCalculated()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      assertThat(aisAbridged.etaUpdated()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(aisAbridged.origNetwork()).contains("ORIG")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAisAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(aisAbridged), jacksonTypeRef<AisAbridged>())
