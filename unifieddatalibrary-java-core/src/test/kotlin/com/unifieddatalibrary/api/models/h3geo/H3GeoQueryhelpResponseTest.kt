...
internal class H3GeoQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val h3GeoQueryhelpResponse = H3GeoQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(h3GeoQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedH3GeoQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(h3GeoQueryhelpResponse), jacksonTypeRef<H3GeoQueryhelpResponse>())
