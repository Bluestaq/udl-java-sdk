...
internal class H3GeoHexCellListResponseTest {
    ...
    @Test
    fun create() {
      val h3GeoHexCellListResponse = H3GeoHexCellListResponse.builder()
      ...
      assertThat(h3GeoHexCellListResponse.dataMode()).isEqualTo(H3GeoHexCellListResponse.DataMode.TEST)
      ...
      assertThat(h3GeoHexCellListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(h3GeoHexCellListResponse.createdBy()).contains("some.user")
      assertThat(h3GeoHexCellListResponse.idH3Geo()).contains("026dd511-8ba5-47d3-9909-836149f87686")
    ...
    fun roundtrip() {
      ...
      val roundtrippedH3GeoHexCellListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(h3GeoHexCellListResponse), jacksonTypeRef<H3GeoHexCellListResponse>())
