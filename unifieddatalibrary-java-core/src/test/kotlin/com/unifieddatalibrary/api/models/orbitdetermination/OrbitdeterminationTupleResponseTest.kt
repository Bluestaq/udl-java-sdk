...
internal class OrbitdeterminationTupleResponseTest {

    @Test
    fun create() {
      val orbitdeterminationTupleResponse = OrbitdeterminationTupleResponse.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationTupleResponse.DataMode.TEST)
          ...
          .aprioriElset(OrbitdeterminationTupleResponse.AprioriElset.builder()
              .classificationMarking("U")
              .dataMode(OrbitdeterminationTupleResponse.AprioriElset.DataMode.TEST)
              ...
              .addSourcedDataType(OrbitdeterminationTupleResponse.AprioriElset.SourcedDataType.RADAR)
              .addSourcedDataType(OrbitdeterminationTupleResponse.AprioriElset.SourcedDataType.RF)
              .sourceDl("AXE")
          ...
          .aprioriStateVector(OrbitdeterminationTupleResponse.AprioriStateVector.builder()
              .classificationMarking("U")
              .dataMode(OrbitdeterminationTupleResponse.AprioriStateVector.DataMode.TEST)
              .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
              .source("Bluestaq")
              .actualOdSpan(3.5)
              ...
              .covReferenceFrame(OrbitdeterminationTupleResponse.AprioriStateVector.CovReferenceFrame.J2000)
              .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
              .createdBy("some.user")
              ...
              .recOdSpan(3.5)
              .referenceFrame(OrbitdeterminationTupleResponse.AprioriStateVector.ReferenceFrame.J2000)
              .residualsAcc(99.5)
              .revNo(7205)
              .rms(0.991)
              .satNo(12)
              ...
              .addSourcedDataType(OrbitdeterminationTupleResponse.AprioriStateVector.SourcedDataType.RADAR)
              .sourceDl("AXE")
              .srpArea(4.311)
              .stepMode("AUTO")
              .stepSize(1.23)
      ...
      assertThat(orbitdeterminationTupleResponse.classificationMarking()).isEqualTo("U")
      assertThat(orbitdeterminationTupleResponse.dataMode()).isEqualTo(OrbitdeterminationTupleResponse.DataMode.TEST)
      assertThat(orbitdeterminationTupleResponse.endTime()).isEqualTo(OffsetDateTime.parse("2023-08-28T15:20:21.247192Z"))
      assertThat(orbitdeterminationTupleResponse.initialOd()).isEqualTo(false)
      assertThat(orbitdeterminationTupleResponse.method()).isEqualTo("BLS")
      assertThat(orbitdeterminationTupleResponse.source()).isEqualTo("Bluestaq")
      assertThat(orbitdeterminationTupleResponse.startTime()).isEqualTo(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationTupleResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      assertThat(orbitdeterminationTupleResponse.acceptedObIds().getOrNull()).containsExactly("EOOBSERVATION-ID1", "RADAROBSERVATION-ID1")
      assertThat(orbitdeterminationTupleResponse.acceptedObTyps().getOrNull()).containsExactly("EO", "RADAR")
      assertThat(orbitdeterminationTupleResponse.agomEst()).contains(false)
      assertThat(orbitdeterminationTupleResponse.agomModel()).contains("RandomWalk")
      assertThat(orbitdeterminationTupleResponse.aprioriElset()).contains(OrbitdeterminationTupleResponse.AprioriElset.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationTupleResponse.AprioriElset.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .uct(false)
          .build())
      assertThat(orbitdeterminationTupleResponse.aprioriIdElset()).contains("80e544b7-6a17-4554-8abf-7301e98f8e5d")
      assertThat(orbitdeterminationTupleResponse.aprioriIdStateVector()).contains("6e291992-8ae3-4592-bb0f-055715bf4803")
      assertThat(orbitdeterminationTupleResponse.aprioriStateVector()).contains(OrbitdeterminationTupleResponse.AprioriStateVector.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationTupleResponse.AprioriStateVector.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .zvelAlt2(-3.365155181)
          .build())
      assertThat(orbitdeterminationTupleResponse.ballisticCoeffEst()).contains(false)
      assertThat(orbitdeterminationTupleResponse.ballisticCoeffModel()).contains("GaussMarkov")
      assertThat(orbitdeterminationTupleResponse.bestPassWrms()).contains(0.975)
      assertThat(orbitdeterminationTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(orbitdeterminationTupleResponse.createdBy()).contains("some.user")
      assertThat(orbitdeterminationTupleResponse.edr()).contains(1.23)
      assertThat(orbitdeterminationTupleResponse.effectiveFrom()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationTupleResponse.effectiveUntil()).contains(OffsetDateTime.parse("2023-08-30T08:15:00.123456Z"))
      assertThat(orbitdeterminationTupleResponse.errorGrowthRate()).contains(1.23)
      assertThat(orbitdeterminationTupleResponse.firstPassWrms()).contains(0.985)
      assertThat(orbitdeterminationTupleResponse.fitSpan()).contains(0.6)
      assertThat(orbitdeterminationTupleResponse.idOnOrbit()).contains("54741")
      assertThat(orbitdeterminationTupleResponse.lastObEnd()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationTupleResponse.lastObStart()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationTupleResponse.methodSource()).contains("ASW")
      assertThat(orbitdeterminationTupleResponse.numIterations()).contains(8)
      assertThat(orbitdeterminationTupleResponse.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
          ...
          .updatedBy("some.user")
          .build())
      assertThat(orbitdeterminationTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(orbitdeterminationTupleResponse.origNetwork()).contains("OPS1")
      assertThat(orbitdeterminationTupleResponse.origObjectId()).contains("ORIGOBJECT-ID")
      assertThat(orbitdeterminationTupleResponse.previousWrms()).contains(1.02)
      assertThat(orbitdeterminationTupleResponse.rejectedObIds().getOrNull()).containsExactly("DIFFOFARRIVAL-ID2", "RFOBSERVATION-ID2")
      assertThat(orbitdeterminationTupleResponse.rejectedObTyps().getOrNull()).containsExactly("DOA", "RF")
      assertThat(orbitdeterminationTupleResponse.rmsConvergenceCriteria()).contains(0.001)
      assertThat(orbitdeterminationTupleResponse.satNo()).contains(54741)
      assertThat(orbitdeterminationTupleResponse.sensorIds().getOrNull()).containsExactly("SENSOR-ID1", "SENSOR-ID2")
      assertThat(orbitdeterminationTupleResponse.sourceDl()).contains("AXE")
      assertThat(orbitdeterminationTupleResponse.timeSpan()).contains(3.5)
      assertThat(orbitdeterminationTupleResponse.wrms()).contains(0.991)
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedOrbitdeterminationTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(orbitdeterminationTupleResponse), jacksonTypeRef<OrbitdeterminationTupleResponse>())

      assertThat(roundtrippedOrbitdeterminationTupleResponse).isEqualTo(orbitdeterminationTupleResponse)
    }
}
