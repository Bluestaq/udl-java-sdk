...
internal class OrbitdeterminationTupleResponseTest {
    ...
    @Test
    fun create() {
        val orbitdeterminationTupleResponse =
            OrbitdeterminationTupleResponse.builder()
                ...
                .aprioriElset(
                    OrbitdeterminationTupleResponse.AprioriElset.builder()
                        .classificationMarking("U")
                        ...
                        .addSourcedDataType(
                            OrbitdeterminationTupleResponse.AprioriElset.SourcedDataType.RADAR
                        )
                        .addSourcedDataType(
                            OrbitdeterminationTupleResponse.AprioriElset.SourcedDataType.RF
                        )
                        .sourceDl("AXE")
                ...
                .aprioriStateVector(
                    OrbitdeterminationTupleResponse.AprioriStateVector.builder()
                        .classificationMarking("U")
                        ...
                        .covReferenceFrame(
                            OrbitdeterminationTupleResponse.AprioriStateVector.CovReferenceFrame
                                .J2000
                        )
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        .createdBy("some.user")
                        ...
                        .recOdSpan(3.5)
                        .referenceFrame(
                            OrbitdeterminationTupleResponse.AprioriStateVector.ReferenceFrame.J2000
                        )
                        .residualsAcc(99.5)
                        .revNo(7205)
                        .rms(0.991)
                        ...
                        .addSourcedDataType(
                            OrbitdeterminationTupleResponse.AprioriStateVector.SourcedDataType.RADAR
                        )
                        .sourceDl("AXE")
                        .srpArea(4.311)
                        .stepMode("AUTO")
        ...
        assertThat(orbitdeterminationTupleResponse.dataMode())
            .isEqualTo(OrbitdeterminationTupleResponse.DataMode.TEST)
        assertThat(orbitdeterminationTupleResponse.endTime())
        ...
        assertThat(orbitdeterminationTupleResponse.startTime())
            .isEqualTo(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        assertThat(orbitdeterminationTupleResponse.id())
            .contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(orbitdeterminationTupleResponse.acceptedObIds().getOrNull())
            .containsExactly("EOOBSERVATION-ID1", "RADAROBSERVATION-ID1")
        assertThat(orbitdeterminationTupleResponse.acceptedObTyps().getOrNull())
        ...
        assertThat(orbitdeterminationTupleResponse.aprioriElset())
            .contains(
                OrbitdeterminationTupleResponse.AprioriElset.builder()
                    .classificationMarking("U")
                    .dataMode(OrbitdeterminationTupleResponse.AprioriElset.DataMode.TEST)
        ...
        assertThat(orbitdeterminationTupleResponse.aprioriIdElset())
            .contains("80e544b7-6a17-4554-8abf-7301e98f8e5d")
        assertThat(orbitdeterminationTupleResponse.aprioriIdStateVector())
            .contains("6e291992-8ae3-4592-bb0f-055715bf4803")
        assertThat(orbitdeterminationTupleResponse.aprioriStateVector())
            .contains(
                OrbitdeterminationTupleResponse.AprioriStateVector.builder()
                    .classificationMarking("U")
                    .dataMode(OrbitdeterminationTupleResponse.AprioriStateVector.DataMode.TEST)
                    ...
                    .covMethod("CALCULATED")
                    .covReferenceFrame(
                        OrbitdeterminationTupleResponse.AprioriStateVector.CovReferenceFrame.J2000
                    )
                    .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                    .createdBy("some.user")
                    .descriptor("descriptor")
        ...
        assertThat(orbitdeterminationTupleResponse.createdAt())
        ...
        assertThat(orbitdeterminationTupleResponse.effectiveFrom())
            .contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        assertThat(orbitdeterminationTupleResponse.effectiveUntil())
        ...
        assertThat(orbitdeterminationTupleResponse.lastObEnd())
            .contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        assertThat(orbitdeterminationTupleResponse.lastObStart())
            .contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        ...
        assertThat(orbitdeterminationTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(orbitdeterminationTupleResponse.rejectedObIds().getOrNull())
            .containsExactly("DIFFOFARRIVAL-ID2", "RFOBSERVATION-ID2")
        assertThat(orbitdeterminationTupleResponse.rejectedObTyps().getOrNull())
        ...
        assertThat(orbitdeterminationTupleResponse.sensorIds().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedOrbitdeterminationTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(orbitdeterminationTupleResponse),
                jacksonTypeRef<OrbitdeterminationTupleResponse>(),
            )

        assertThat(roundtrippedOrbitdeterminationTupleResponse)
            .isEqualTo(orbitdeterminationTupleResponse)
    }
}
