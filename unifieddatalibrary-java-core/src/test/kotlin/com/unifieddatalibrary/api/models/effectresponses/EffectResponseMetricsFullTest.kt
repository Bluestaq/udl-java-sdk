...
internal class EffectResponseMetricsFullTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedEffectResponseMetricsFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(effectResponseMetricsFull),
                jacksonTypeRef<EffectResponseMetricsFull>(),
            )
