...
internal class CollectResponseCreateBulkParamsTest {
    ...
    fun create() {
      CollectResponseCreateBulkParams.builder()
          .addBody(CollectResponseCreateBulkParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = CollectResponseCreateBulkParams.builder()
          .addBody(CollectResponseCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(CollectResponseCreateBulkParams.Body.DataMode.TEST)
              .idRequest("REF-REQUEST-ID")
      ...
      assertThat(body).containsExactly(CollectResponseCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(CollectResponseCreateBulkParams.Body.DataMode.TEST)
          .idRequest("REF-REQUEST-ID")
          .source("Bluestaq")
