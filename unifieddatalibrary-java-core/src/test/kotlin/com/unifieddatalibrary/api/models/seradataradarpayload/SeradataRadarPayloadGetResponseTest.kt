...
internal class SeradataRadarPayloadGetResponseTest {
    ...
    @Test
    fun create() {
        val seradataRadarPayloadGetResponse =
            SeradataRadarPayloadGetResponse.builder()
        ...
        assertThat(seradataRadarPayloadGetResponse.dataMode())
            .isEqualTo(SeradataRadarPayloadGetResponse.DataMode.TEST)
        ...
        assertThat(seradataRadarPayloadGetResponse.constellationInterferometricCapability())
            .contains("constellationInterferometricCapability")
        assertThat(seradataRadarPayloadGetResponse.createdAt())
        ...
        assertThat(seradataRadarPayloadGetResponse.groundStationLocations())
            .contains("51,42N-44,35E")
        assertThat(seradataRadarPayloadGetResponse.groundStations()).contains("groundStations")
        assertThat(seradataRadarPayloadGetResponse.hostedForCompanyOrgId())
            .contains("hostedForCompanyOrgId")
        assertThat(seradataRadarPayloadGetResponse.idSensor())
            .contains("3c1ee9a0-90ad-1d75-c47b-2414e0a77e53")
        assertThat(seradataRadarPayloadGetResponse.manufacturerOrgId())
        ...
        assertThat(seradataRadarPayloadGetResponse.origNetwork()).contains("OPS1")
        assertThat(seradataRadarPayloadGetResponse.partnerSpacecraft())
        ...
        assertThat(seradataRadarPayloadGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSeradataRadarPayloadGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(seradataRadarPayloadGetResponse),
                jacksonTypeRef<SeradataRadarPayloadGetResponse>(),
            )

        assertThat(roundtrippedSeradataRadarPayloadGetResponse)
            .isEqualTo(seradataRadarPayloadGetResponse)
    }
}
