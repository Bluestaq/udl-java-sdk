...
internal class IrUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = IrUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(IrUpdateParams.DataMode.TEST)
          .name("Example name")
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(IrUpdateParams.DataMode.TEST)
      assertThat(body.name()).isEqualTo("Example name")
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.bodyId()).contains("IR-ID")
