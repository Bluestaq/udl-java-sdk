...
internal class RfEmitterQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val rfEmitterQueryhelpResponse = RfEmitterQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(rfEmitterQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(rfEmitterQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfEmitterQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rfEmitterQueryhelpResponse), jacksonTypeRef<RfEmitterQueryhelpResponse>())
