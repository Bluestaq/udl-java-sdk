...
internal class LaunchSiteTupleResponseTest {
    ...
    @Test
    fun create() {
      val launchSiteTupleResponse = LaunchSiteTupleResponse.builder()
          ...
          .addLaunchSiteDetail(LaunchSiteTupleResponse.LaunchSiteDetail.builder()
              .classificationMarking("U")
      ...
      assertThat(launchSiteTupleResponse.dataMode()).isEqualTo(LaunchSiteTupleResponse.DataMode.TEST)
      ...
      assertThat(launchSiteTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(launchSiteTupleResponse.createdBy()).contains("some.user")
      assertThat(launchSiteTupleResponse.idSite()).contains("a150b3ee-884b-b9ac-60a0-6408b4b16088")
      assertThat(launchSiteTupleResponse.launchSiteDetails().getOrNull()).containsExactly(LaunchSiteTupleResponse.LaunchSiteDetail.builder()
          .classificationMarking("U")
          .dataMode(LaunchSiteTupleResponse.LaunchSiteDetail.DataMode.TEST)
          .idLaunchSite("LAUNCHSITE-ID")
          .source("Bluestaq")
      ...
      assertThat(launchSiteTupleResponse.origNetwork()).contains("ORIG")
      assertThat(launchSiteTupleResponse.shortCode()).contains("SNMLP")
      assertThat(launchSiteTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedLaunchSiteTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(launchSiteTupleResponse), jacksonTypeRef<LaunchSiteTupleResponse>())
