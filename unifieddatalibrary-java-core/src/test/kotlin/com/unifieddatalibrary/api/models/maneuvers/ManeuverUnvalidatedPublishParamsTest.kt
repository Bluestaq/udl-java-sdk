...
internal class ManeuverUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      ManeuverUnvalidatedPublishParams.builder()
          .addBody(ManeuverUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(ManeuverUnvalidatedPublishParams.Body.DataMode.TEST)
              ...
              .postEventElset(ManeuverUnvalidatedPublishParams.Body.PostEventElset.builder()
                  .classificationMarking("U")
                  .dataMode(ManeuverUnvalidatedPublishParams.Body.PostEventElset.DataMode.TEST)
                  ...
                  .addSourcedDataType(ManeuverUnvalidatedPublishParams.Body.PostEventElset.SourcedDataType.RADAR)
                  .addSourcedDataType(ManeuverUnvalidatedPublishParams.Body.PostEventElset.SourcedDataType.RF)
                  .sourceDl("AXE")
              ...
              .postEventStateVector(ManeuverUnvalidatedPublishParams.Body.PostEventStateVector.builder()
                  .classificationMarking("U")
                  .dataMode(ManeuverUnvalidatedPublishParams.Body.PostEventStateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(ManeuverUnvalidatedPublishParams.Body.PostEventStateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(ManeuverUnvalidatedPublishParams.Body.PostEventStateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(ManeuverUnvalidatedPublishParams.Body.PostEventStateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
              ...
              .preEventElset(ManeuverUnvalidatedPublishParams.Body.PreEventElset.builder()
                  .classificationMarking("U")
                  .dataMode(ManeuverUnvalidatedPublishParams.Body.PreEventElset.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .agom(0.0126)
                  .algorithm("Example algorithm")
                  ...
                  .addSourcedData("OBSERVATION_UUID1")
                  .addSourcedData("OBSERVATION_UUID2")
                  .addSourcedDataType(ManeuverUnvalidatedPublishParams.Body.PreEventElset.SourcedDataType.RADAR)
                  .addSourcedDataType(ManeuverUnvalidatedPublishParams.Body.PreEventElset.SourcedDataType.RF)
                  .sourceDl("AXE")
                  .addTag("PROVIDER_TAG1")
                  .addTag("PROVIDER_TAG2")
                  .transactionId("TRANSACTION-ID")
              ...
              .preEventStateVector(ManeuverUnvalidatedPublishParams.Body.PreEventStateVector.builder()
                  .classificationMarking("U")
                  .dataMode(ManeuverUnvalidatedPublishParams.Body.PreEventStateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  .algorithm("SAMPLE_ALGORITHM")
                  ...
                  .covMethod("CALCULATED")
                  .covReferenceFrame(ManeuverUnvalidatedPublishParams.Body.PreEventStateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  .descriptor("descriptor")
                  .dragArea(4.739)
                  ...
                  .rawFileUri("rawFileURI")
                  .recOdSpan(3.5)
                  .referenceFrame(ManeuverUnvalidatedPublishParams.Body.PreEventStateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedData("DATA1")
                  .addSourcedData("DATA2")
                  .addSourcedDataType(ManeuverUnvalidatedPublishParams.Body.PreEventStateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
              ...
              .addSourcedData("SOURCEDDATA-ID")
              .addSourcedDataType(ManeuverUnvalidatedPublishParams.Body.SourcedDataType.EO)
              .addSourcedDataType(ManeuverUnvalidatedPublishParams.Body.SourcedDataType.RADAR)
    ...
    @Test
    fun body() {
      val params = ManeuverUnvalidatedPublishParams.builder()
          .addBody(ManeuverUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(ManeuverUnvalidatedPublishParams.Body.DataMode.TEST)
              .eventStartTime(OffsetDateTime.parse("2023-11-16T01:05:16.835689Z"))
      ...
      assertThat(body).containsExactly(ManeuverUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(ManeuverUnvalidatedPublishParams.Body.DataMode.TEST)
          .eventStartTime(OffsetDateTime.parse("2023-11-16T01:05:16.835689Z"))
          .source("Bluestaq")
