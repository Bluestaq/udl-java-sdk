...
internal class ManeuverUnvalidatedPublishParamsTest {
    ...
    fun create() {
        ManeuverUnvalidatedPublishParams.builder()
            .addBody(
                ManeuverUnvalidatedPublishParams.Body.builder()
                    ...
                    .postEventElset(
                        ManeuverUnvalidatedPublishParams.Body.PostEventElset.builder()
                            .classificationMarking("U")
                            .dataMode(
                                ManeuverUnvalidatedPublishParams.Body.PostEventElset.DataMode.TEST
                            )
                            ...
                            .addSourcedDataType(
                                ManeuverUnvalidatedPublishParams.Body.PostEventElset.SourcedDataType
                                    .RADAR
                            )
                            .addSourcedDataType(
                                ManeuverUnvalidatedPublishParams.Body.PostEventElset.SourcedDataType
                    ...
                    .postEventStateVector(
                        ManeuverUnvalidatedPublishParams.Body.PostEventStateVector.builder()
                            .classificationMarking("U")
                            .dataMode(
                                ManeuverUnvalidatedPublishParams.Body.PostEventStateVector.DataMode
                                    .TEST
                            )
                            .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .source("Bluestaq")
                            ...
                            .covReferenceFrame(
                                ManeuverUnvalidatedPublishParams.Body.PostEventStateVector
                                    .CovReferenceFrame
                                    .J2000
                            )
                            .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                    ...
                    .preEventElset(
                        ManeuverUnvalidatedPublishParams.Body.PreEventElset.builder()
                            .classificationMarking("U")
                            .dataMode(
                                ManeuverUnvalidatedPublishParams.Body.PreEventElset.DataMode.TEST
                            )
                            .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .source("Bluestaq")
                            .agom(0.0126)
                            ...
                            .addSourcedData("OBSERVATION_UUID2")
                            .addSourcedDataType(
                                ManeuverUnvalidatedPublishParams.Body.PreEventElset.SourcedDataType
                                    .RADAR
                            )
                            .addSourcedDataType(
                                ManeuverUnvalidatedPublishParams.Body.PreEventElset.SourcedDataType
                    ...
                    .preEventStateVector(
                        ManeuverUnvalidatedPublishParams.Body.PreEventStateVector.builder()
                            .classificationMarking("U")
                            .dataMode(
                                ManeuverUnvalidatedPublishParams.Body.PreEventStateVector.DataMode
                                    .TEST
                            )
                            .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .source("Bluestaq")
                            ...
                            .covMethod("CALCULATED")
                            .covReferenceFrame(
                                ManeuverUnvalidatedPublishParams.Body.PreEventStateVector
                                    .CovReferenceFrame
                                    .J2000
                            )
                            .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                    ...
                    ManeuverUnvalidatedPublishParams.Body.builder()
                        ...
                        .postEventElset(
                            ManeuverUnvalidatedPublishParams.Body.PostEventElset.builder()
                                .classificationMarking("U")
                                .dataMode(
                                    ManeuverUnvalidatedPublishParams.Body.PostEventElset.DataMode
                                        .TEST
                                )
                                .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                                .source("Bluestaq")
                                ...
                                .addSourcedData("OBSERVATION_UUID2")
                                .addSourcedDataType(
                                    ManeuverUnvalidatedPublishParams.Body.PostEventElset
                                        .SourcedDataType
                                        .RADAR
                                )
                                .addSourcedDataType(
                        ...
                        .preEventElset(
                            ManeuverUnvalidatedPublishParams.Body.PreEventElset.builder()
                                .classificationMarking("U")
                                .dataMode(
                                    ManeuverUnvalidatedPublishParams.Body.PreEventElset.DataMode
                                        .TEST
                                )
                                .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                                .source("Bluestaq")
                                ...
                                .addSourcedData("OBSERVATION_UUID2")
                                .addSourcedDataType(
                                    ManeuverUnvalidatedPublishParams.Body.PreEventElset
                                        .SourcedDataType
                                        .RADAR
                                )
                                .addSourcedDataType(
                        ...
                        .addSourcedData("SOURCEDDATA-ID")
                        .addSourcedDataType(
                            ManeuverUnvalidatedPublishParams.Body.SourcedDataType.EO
                        )
                        .addSourcedDataType(
                            ManeuverUnvalidatedPublishParams.Body.SourcedDataType.RADAR
                        )
                        .stateModel("Example name")
                        .stateModelVersion(3.0)
                        .status("POSSIBLE")
