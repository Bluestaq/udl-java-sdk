...
internal class SwirFullTest {
    ...
    fun create() {
      ...
      assertThat(swirFull.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
      ...
      assertThat(swirFull.origNetwork()).contains("ORIG")
    ...
    fun roundtrip() {
      ...
      val roundtrippedSwirFull = jsonMapper.readValue(jsonMapper.writeValueAsString(swirFull), jacksonTypeRef<SwirFull>())
