...
internal class SeraDataNavigationQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val seraDataNavigationQueryhelpResponse =
            SeraDataNavigationQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(seraDataNavigationQueryhelpResponse.classificationMarking())
        ...
        assertThat(seraDataNavigationQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(seraDataNavigationQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSeraDataNavigationQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(seraDataNavigationQueryhelpResponse),
                jacksonTypeRef<SeraDataNavigationQueryhelpResponse>(),
            )

        assertThat(roundtrippedSeraDataNavigationQueryhelpResponse)
            .isEqualTo(seraDataNavigationQueryhelpResponse)
    }
}
