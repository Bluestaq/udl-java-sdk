...
internal class H3GeoListResponseTest {
    ...
    @Test
    fun create() {
      val h3GeoListResponse = H3GeoListResponse.builder()
      ...
      assertThat(h3GeoListResponse.startTime()).isEqualTo(OffsetDateTime.parse("2024-07-02T00:00:00.123Z"))
      ...
      assertThat(h3GeoListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(h3GeoListResponse.createdBy()).contains("some.user")
      assertThat(h3GeoListResponse.endTime()).contains(OffsetDateTime.parse("2024-07-03T00:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedH3GeoListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(h3GeoListResponse), jacksonTypeRef<H3GeoListResponse>())
