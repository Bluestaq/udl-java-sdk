...
internal class CommQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val commQueryhelpResponse = CommQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(commQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedCommQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(commQueryhelpResponse), jacksonTypeRef<CommQueryhelpResponse>())
