...
internal class AirfieldSlotConsumptionQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val airfieldSlotConsumptionQueryhelpResponse = AirfieldSlotConsumptionQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(airfieldSlotConsumptionQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(airfieldSlotConsumptionQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(airfieldSlotConsumptionQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAirfieldSlotConsumptionQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(airfieldSlotConsumptionQueryhelpResponse), jacksonTypeRef<AirfieldSlotConsumptionQueryhelpResponse>())

      assertThat(roundtrippedAirfieldSlotConsumptionQueryhelpResponse).isEqualTo(airfieldSlotConsumptionQueryhelpResponse)
    }
}
