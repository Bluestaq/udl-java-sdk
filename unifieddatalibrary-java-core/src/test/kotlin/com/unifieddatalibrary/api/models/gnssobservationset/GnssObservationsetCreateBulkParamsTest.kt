...
internal class GnssObservationsetCreateBulkParamsTest {

    @Test
    fun create() {
      GnssObservationsetCreateBulkParams.builder()
          .addBody(GnssObservationsetCreateBulkParams.Body.builder()
              ...
              .gDop(0.33)
              .addGnssObservationList(GnssObservationsetCreateBulkParams.Body.GnssObservationList.builder()
                  .agcState(20)
                  .gnssSatId("GEJ")
                  .ob(listOf(
                    42.1,
    ...
    @Test
    fun body() {
      val params = GnssObservationsetCreateBulkParams.builder()
          .addBody(GnssObservationsetCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(GnssObservationsetCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(GnssObservationsetCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(GnssObservationsetCreateBulkParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .ts(OffsetDateTime.parse("2022-01-01T00:00:00.123456Z"))
