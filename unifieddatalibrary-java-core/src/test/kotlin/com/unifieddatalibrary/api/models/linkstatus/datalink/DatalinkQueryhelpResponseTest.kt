...
internal class DatalinkQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val datalinkQueryhelpResponse =
            DatalinkQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(datalinkQueryhelpResponse.classificationMarking())
        ...
        assertThat(datalinkQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedDatalinkQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(datalinkQueryhelpResponse),
                jacksonTypeRef<DatalinkQueryhelpResponse>(),
            )
