...
internal class RfBandTypeTupleResponseTest {
    ...
    @Test
    fun create() {
      val rfBandTypeTupleResponse = RfBandTypeTupleResponse.builder()
          .id("Ku")
      ...
      assertThat(rfBandTypeTupleResponse.dataMode()).isEqualTo(RfBandTypeTupleResponse.DataMode.TEST)
      ...
      assertThat(rfBandTypeTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(rfBandTypeTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfBandTypeTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rfBandTypeTupleResponse), jacksonTypeRef<RfBandTypeTupleResponse>())
