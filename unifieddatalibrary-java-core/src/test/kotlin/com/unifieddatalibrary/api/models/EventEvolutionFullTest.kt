...
internal class EventEvolutionFullTest {
    ...
    @Test
    fun create() {
      val eventEvolutionFull = EventEvolutionFull.builder()
      ...
      assertThat(eventEvolutionFull.startTime()).isEqualTo(OffsetDateTime.parse("2021-12-02T16:00:00.123Z"))
      ...
      assertThat(eventEvolutionFull.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(eventEvolutionFull.andims()).contains(2)
      assertThat(eventEvolutionFull.area()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(eventEvolutionFull.asrid()).contains(4326)
      assertThat(eventEvolutionFull.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(eventEvolutionFull.createdAt()).contains(OffsetDateTime.parse("2021-12-02T16:00:00.123Z"))
      assertThat(eventEvolutionFull.createdBy()).contains("some.user")
      assertThat(eventEvolutionFull.dataDescription()).contains("Description of relationship between srcTyps and srcIds")
      assertThat(eventEvolutionFull.endTime()).contains(OffsetDateTime.parse("2021-12-03T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedEventEvolutionFull = jsonMapper.readValue(jsonMapper.writeValueAsString(eventEvolutionFull), jacksonTypeRef<EventEvolutionFull>())
