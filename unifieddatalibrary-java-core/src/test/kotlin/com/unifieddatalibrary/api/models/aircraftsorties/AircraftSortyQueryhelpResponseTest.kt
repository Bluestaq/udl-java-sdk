...
internal class AircraftSortyQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val aircraftSortyQueryhelpResponse =
            AircraftSortyQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(aircraftSortyQueryhelpResponse.classificationMarking())
        ...
        assertThat(aircraftSortyQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(aircraftSortyQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedAircraftSortyQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(aircraftSortyQueryhelpResponse),
                jacksonTypeRef<AircraftSortyQueryhelpResponse>(),
            )

        assertThat(roundtrippedAircraftSortyQueryhelpResponse)
            .isEqualTo(aircraftSortyQueryhelpResponse)
    }
}
