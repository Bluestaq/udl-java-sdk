...
internal class LaseremitterTupleResponseTest {

    @Test
    fun create() {
        val laseremitterTupleResponse =
            LaseremitterTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(LaseremitterTupleResponse.DataMode.TEST)
                .laserName("HEL")
                .laserType("PULSED")
                .source("Bluestaq")
        ...
        assertThat(laseremitterTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(laseremitterTupleResponse.dataMode())
            .isEqualTo(LaseremitterTupleResponse.DataMode.TEST)
        assertThat(laseremitterTupleResponse.laserName()).isEqualTo("HEL")
        assertThat(laseremitterTupleResponse.laserType()).isEqualTo("PULSED")
        assertThat(laseremitterTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(laseremitterTupleResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(laseremitterTupleResponse.atmosphericTransmission()).contains(1.0)
        assertThat(laseremitterTupleResponse.beamOutputPower()).contains(100.5)
        assertThat(laseremitterTupleResponse.beamWaist()).contains(14.4)
        assertThat(laseremitterTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(laseremitterTupleResponse.createdBy()).contains("some.user")
        assertThat(laseremitterTupleResponse.divergence()).contains(2.5)
        assertThat(laseremitterTupleResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(laseremitterTupleResponse.idEntity()).contains("ENTITY-ID")
        assertThat(laseremitterTupleResponse.isOperational()).contains(true)
        assertThat(laseremitterTupleResponse.maxDuration()).contains(1.5)
        assertThat(laseremitterTupleResponse.maxFocusRange()).contains(30000.5)
        assertThat(laseremitterTupleResponse.minFocusRange()).contains(2500.5)
        assertThat(laseremitterTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(laseremitterTupleResponse.origNetwork()).contains("OPS1")
        assertThat(laseremitterTupleResponse.pulseFluence()).contains(1000005.5)
        assertThat(laseremitterTupleResponse.pulsePeakPower()).contains(640.25)
        assertThat(laseremitterTupleResponse.pulseRepFreq()).contains(2225.5)
        assertThat(laseremitterTupleResponse.pulseShape()).contains("RECTANGULAR")
        assertThat(laseremitterTupleResponse.pulseWidth()).contains(0.25)
        assertThat(laseremitterTupleResponse.sourceDl()).contains("AXE")
        assertThat(laseremitterTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(laseremitterTupleResponse.updatedBy()).contains("some.user")
        assertThat(laseremitterTupleResponse.wavelength()).contains(0.11)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedLaseremitterTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(laseremitterTupleResponse),
                jacksonTypeRef<LaseremitterTupleResponse>(),
            )

        assertThat(roundtrippedLaseremitterTupleResponse).isEqualTo(laseremitterTupleResponse)
    }
}
