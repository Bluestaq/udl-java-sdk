...
internal class NavigationalObstructionTupleResponseTest {
    ...
    @Test
    fun create() {
      val navigationalObstructionTupleResponse = NavigationalObstructionTupleResponse.builder()
      ...
      assertThat(navigationalObstructionTupleResponse.cycleDate()).isEqualTo(LocalDate.parse("2024-06-13"))
      assertThat(navigationalObstructionTupleResponse.dataMode()).isEqualTo(NavigationalObstructionTupleResponse.DataMode.TEST)
      ...
      assertThat(navigationalObstructionTupleResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      ...
      assertThat(navigationalObstructionTupleResponse.baselineCutoffDate()).contains(LocalDate.parse("2024-04-23"))
      ...
      assertThat(navigationalObstructionTupleResponse.createdAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      assertThat(navigationalObstructionTupleResponse.createdBy()).contains("some.user")
      assertThat(navigationalObstructionTupleResponse.cutoffDate()).contains(LocalDate.parse("2024-05-21"))
      assertThat(navigationalObstructionTupleResponse.dataSetRemarks()).contains("Data set remarks")
      ...
      assertThat(navigationalObstructionTupleResponse.featureDescription()).contains("Powerline Pylon, General")
      ...
      assertThat(navigationalObstructionTupleResponse.initRecordDate()).contains(LocalDate.parse("1991-03-28"))
      assertThat(navigationalObstructionTupleResponse.keys().getOrNull()).containsExactly("key1", "key2")
      ...
      assertThat(navigationalObstructionTupleResponse.nextCycleDate()).contains(LocalDate.parse("2024-07-11"))
      ...
      assertThat(navigationalObstructionTupleResponse.obstacleRemarks()).contains("Obstacle remarks")
      ...
      assertThat(navigationalObstructionTupleResponse.rawFileUri()).contains("Example URI")
      assertThat(navigationalObstructionTupleResponse.revDate()).contains(LocalDate.parse("2020-02-26"))
      ...
      assertThat(navigationalObstructionTupleResponse.sourceDate()).contains(LocalDate.parse("2016-04-01"))
      ...
      assertThat(navigationalObstructionTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(navigationalObstructionTupleResponse.values().getOrNull()).containsExactly("value1", "value2")
    ...
    fun roundtrip() {
      ...
      val roundtrippedNavigationalObstructionTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(navigationalObstructionTupleResponse), jacksonTypeRef<NavigationalObstructionTupleResponse>())

      assertThat(roundtrippedNavigationalObstructionTupleResponse).isEqualTo(navigationalObstructionTupleResponse)
    }
}
