...
internal class WaiverFullTest {
    ...
    @Test
    fun create() {
      val waiverFull = WaiverFull.builder()
      ...
      assertThat(waiverFull.expirationDate()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.000Z"))
      assertThat(waiverFull.hasExpired()).contains(false)
      assertThat(waiverFull.issueDate()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.000Z"))
      ...
      assertThat(waiverFull.waiverLastChangedDate()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.000Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedWaiverFull = jsonMapper.readValue(jsonMapper.writeValueAsString(waiverFull), jacksonTypeRef<WaiverFull>())
