...
internal class IrGetResponseTest {

    @Test
    fun create() {
      val irGetResponse = IrGetResponse.builder()
          .classificationMarking("U")
          .dataMode(IrGetResponse.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
          .id("IR-ID")
      ...
      assertThat(irGetResponse.classificationMarking()).isEqualTo("U")
      assertThat(irGetResponse.dataMode()).isEqualTo(IrGetResponse.DataMode.TEST)
      assertThat(irGetResponse.name()).isEqualTo("Example name")
      assertThat(irGetResponse.source()).isEqualTo("Bluestaq")
      assertThat(irGetResponse.id()).contains("IR-ID")
      assertThat(irGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(irGetResponse.createdBy()).contains("some.user")
      assertThat(irGetResponse.description()).contains("Example description")
      assertThat(irGetResponse.entity()).contains(EntityFull.builder()
          .classificationMarking("U")
          .dataMode(EntityFull.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
          ...
          .addUrl("URL2")
          .build())
      assertThat(irGetResponse.idEntity()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
      assertThat(irGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(irGetResponse.origNetwork()).contains("ORIG")
      assertThat(irGetResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(irGetResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedIrGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(irGetResponse), jacksonTypeRef<IrGetResponse>())

      assertThat(roundtrippedIrGetResponse).isEqualTo(irGetResponse)
    }
}
