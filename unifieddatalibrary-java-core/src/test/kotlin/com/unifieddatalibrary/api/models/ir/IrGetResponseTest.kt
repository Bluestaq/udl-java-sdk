...
internal class IrGetResponseTest {
    ...
    fun create() {
        ...
        assertThat(irGetResponse.createdAt())
        ...
        assertThat(irGetResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(irGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedIrGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(irGetResponse),
                jacksonTypeRef<IrGetResponse>(),
            )
