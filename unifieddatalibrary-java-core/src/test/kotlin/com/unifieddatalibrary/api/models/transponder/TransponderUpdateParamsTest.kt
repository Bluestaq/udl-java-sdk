...
internal class TransponderUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(TransponderUpdateParams.DataMode.TEST)
        assertThat(body.idComm()).isEqualTo("REF-COMM-ID")
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.bodyId()).contains("TRANSPONDER-ID")
