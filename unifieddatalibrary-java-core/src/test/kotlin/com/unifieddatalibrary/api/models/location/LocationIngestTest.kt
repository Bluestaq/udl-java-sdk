...
internal class LocationIngestTest {
    ...
    @Test
    fun create() {
      val locationIngest = LocationIngest.builder()
      ...
      assertThat(locationIngest.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedLocationIngest = jsonMapper.readValue(jsonMapper.writeValueAsString(locationIngest), jacksonTypeRef<LocationIngest>())
