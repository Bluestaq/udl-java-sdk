...
internal class AirfieldQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val airfieldQueryhelpResponse =
            AirfieldQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(airfieldQueryhelpResponse.classificationMarking())
        ...
        assertThat(airfieldQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAirfieldQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(airfieldQueryhelpResponse),
                jacksonTypeRef<AirfieldQueryhelpResponse>(),
            )
