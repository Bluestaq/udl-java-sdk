...
internal class TrackCreateBulkParamsTest {

    @Test
    fun create() {
      TrackCreateBulkParams.builder()
          .addBody(TrackCreateBulkParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = TrackCreateBulkParams.builder()
          .addBody(TrackCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(TrackCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(TrackCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(TrackCreateBulkParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .ts(OffsetDateTime.parse("2021-06-07T14:17:39.653043Z"))
