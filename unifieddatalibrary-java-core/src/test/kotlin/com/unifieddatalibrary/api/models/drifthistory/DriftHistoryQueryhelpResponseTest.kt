...
internal class DriftHistoryQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val driftHistoryQueryhelpResponse = DriftHistoryQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(driftHistoryQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(driftHistoryQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(driftHistoryQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedDriftHistoryQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(driftHistoryQueryhelpResponse), jacksonTypeRef<DriftHistoryQueryhelpResponse>())

      assertThat(roundtrippedDriftHistoryQueryhelpResponse).isEqualTo(driftHistoryQueryhelpResponse)
    }
}
