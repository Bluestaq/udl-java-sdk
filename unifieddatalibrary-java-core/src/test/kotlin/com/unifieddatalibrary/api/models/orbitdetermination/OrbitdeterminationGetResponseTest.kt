...
internal class OrbitdeterminationGetResponseTest {

    @Test
    fun create() {
      val orbitdeterminationGetResponse = OrbitdeterminationGetResponse.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationGetResponse.DataMode.TEST)
          ...
          .aprioriElset(OrbitdeterminationGetResponse.AprioriElset.builder()
              .classificationMarking("U")
              .dataMode(OrbitdeterminationGetResponse.AprioriElset.DataMode.TEST)
              ...
              .addSourcedDataType(OrbitdeterminationGetResponse.AprioriElset.SourcedDataType.RADAR)
              .addSourcedDataType(OrbitdeterminationGetResponse.AprioriElset.SourcedDataType.RF)
              .sourceDl("AXE")
          ...
          .aprioriStateVector(OrbitdeterminationGetResponse.AprioriStateVector.builder()
              .classificationMarking("U")
              .dataMode(OrbitdeterminationGetResponse.AprioriStateVector.DataMode.TEST)
              .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
              .source("Bluestaq")
              .actualOdSpan(3.5)
              ...
              .covReferenceFrame(OrbitdeterminationGetResponse.AprioriStateVector.CovReferenceFrame.J2000)
              .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
              .createdBy("some.user")
              ...
              .recOdSpan(3.5)
              .referenceFrame(OrbitdeterminationGetResponse.AprioriStateVector.ReferenceFrame.J2000)
              .residualsAcc(99.5)
              .revNo(7205)
              .rms(0.991)
              .satNo(12)
              ...
              .addSourcedDataType(OrbitdeterminationGetResponse.AprioriStateVector.SourcedDataType.RADAR)
              .sourceDl("AXE")
              .srpArea(4.311)
              .stepMode("AUTO")
              .stepSize(1.23)
      ...
      assertThat(orbitdeterminationGetResponse.classificationMarking()).isEqualTo("U")
      assertThat(orbitdeterminationGetResponse.dataMode()).isEqualTo(OrbitdeterminationGetResponse.DataMode.TEST)
      assertThat(orbitdeterminationGetResponse.endTime()).isEqualTo(OffsetDateTime.parse("2023-08-28T15:20:21.247192Z"))
      assertThat(orbitdeterminationGetResponse.initialOd()).isEqualTo(false)
      assertThat(orbitdeterminationGetResponse.method()).isEqualTo("BLS")
      assertThat(orbitdeterminationGetResponse.source()).isEqualTo("Bluestaq")
      assertThat(orbitdeterminationGetResponse.startTime()).isEqualTo(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationGetResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      assertThat(orbitdeterminationGetResponse.acceptedObIds().getOrNull()).containsExactly("EOOBSERVATION-ID1", "RADAROBSERVATION-ID1")
      assertThat(orbitdeterminationGetResponse.acceptedObTyps().getOrNull()).containsExactly("EO", "RADAR")
      assertThat(orbitdeterminationGetResponse.agomEst()).contains(false)
      assertThat(orbitdeterminationGetResponse.agomModel()).contains("RandomWalk")
      assertThat(orbitdeterminationGetResponse.aprioriElset()).contains(OrbitdeterminationGetResponse.AprioriElset.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationGetResponse.AprioriElset.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .uct(false)
          .build())
      assertThat(orbitdeterminationGetResponse.aprioriIdElset()).contains("80e544b7-6a17-4554-8abf-7301e98f8e5d")
      assertThat(orbitdeterminationGetResponse.aprioriIdStateVector()).contains("6e291992-8ae3-4592-bb0f-055715bf4803")
      assertThat(orbitdeterminationGetResponse.aprioriStateVector()).contains(OrbitdeterminationGetResponse.AprioriStateVector.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationGetResponse.AprioriStateVector.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .zvelAlt2(-3.365155181)
          .build())
      assertThat(orbitdeterminationGetResponse.ballisticCoeffEst()).contains(false)
      assertThat(orbitdeterminationGetResponse.ballisticCoeffModel()).contains("GaussMarkov")
      assertThat(orbitdeterminationGetResponse.bestPassWrms()).contains(0.975)
      assertThat(orbitdeterminationGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(orbitdeterminationGetResponse.createdBy()).contains("some.user")
      assertThat(orbitdeterminationGetResponse.edr()).contains(1.23)
      assertThat(orbitdeterminationGetResponse.effectiveFrom()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationGetResponse.effectiveUntil()).contains(OffsetDateTime.parse("2023-08-30T08:15:00.123456Z"))
      assertThat(orbitdeterminationGetResponse.errorGrowthRate()).contains(1.23)
      assertThat(orbitdeterminationGetResponse.firstPassWrms()).contains(0.985)
      assertThat(orbitdeterminationGetResponse.fitSpan()).contains(0.6)
      assertThat(orbitdeterminationGetResponse.idOnOrbit()).contains("54741")
      assertThat(orbitdeterminationGetResponse.lastObEnd()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationGetResponse.lastObStart()).contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
      assertThat(orbitdeterminationGetResponse.methodSource()).contains("ASW")
      assertThat(orbitdeterminationGetResponse.numIterations()).contains(8)
      assertThat(orbitdeterminationGetResponse.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
          ...
          .updatedBy("some.user")
          .build())
      assertThat(orbitdeterminationGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(orbitdeterminationGetResponse.origNetwork()).contains("OPS1")
      assertThat(orbitdeterminationGetResponse.origObjectId()).contains("ORIGOBJECT-ID")
      assertThat(orbitdeterminationGetResponse.previousWrms()).contains(1.02)
      assertThat(orbitdeterminationGetResponse.rejectedObIds().getOrNull()).containsExactly("DIFFOFARRIVAL-ID2", "RFOBSERVATION-ID2")
      assertThat(orbitdeterminationGetResponse.rejectedObTyps().getOrNull()).containsExactly("DOA", "RF")
      assertThat(orbitdeterminationGetResponse.rmsConvergenceCriteria()).contains(0.001)
      assertThat(orbitdeterminationGetResponse.satNo()).contains(54741)
      assertThat(orbitdeterminationGetResponse.sensorIds().getOrNull()).containsExactly("SENSOR-ID1", "SENSOR-ID2")
      assertThat(orbitdeterminationGetResponse.sourceDl()).contains("AXE")
      assertThat(orbitdeterminationGetResponse.timeSpan()).contains(3.5)
      assertThat(orbitdeterminationGetResponse.wrms()).contains(0.991)
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedOrbitdeterminationGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(orbitdeterminationGetResponse), jacksonTypeRef<OrbitdeterminationGetResponse>())

      assertThat(roundtrippedOrbitdeterminationGetResponse).isEqualTo(orbitdeterminationGetResponse)
    }
}
