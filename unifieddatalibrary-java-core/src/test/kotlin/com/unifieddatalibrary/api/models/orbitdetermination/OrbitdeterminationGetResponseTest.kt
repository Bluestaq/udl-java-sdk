...
internal class OrbitdeterminationGetResponseTest {
    ...
    @Test
    fun create() {
        val orbitdeterminationGetResponse =
            OrbitdeterminationGetResponse.builder()
                ...
                .aprioriElset(
                    OrbitdeterminationGetResponse.AprioriElset.builder()
                        .classificationMarking("U")
                        ...
                        .addSourcedDataType(
                            OrbitdeterminationGetResponse.AprioriElset.SourcedDataType.RADAR
                        )
                        .addSourcedDataType(
                            OrbitdeterminationGetResponse.AprioriElset.SourcedDataType.RF
                        )
                        .sourceDl("AXE")
                ...
                .aprioriStateVector(
                    OrbitdeterminationGetResponse.AprioriStateVector.builder()
                        .classificationMarking("U")
                        ...
                        .covReferenceFrame(
                            OrbitdeterminationGetResponse.AprioriStateVector.CovReferenceFrame.J2000
                        )
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        .createdBy("some.user")
                        ...
                        .recOdSpan(3.5)
                        .referenceFrame(
                            OrbitdeterminationGetResponse.AprioriStateVector.ReferenceFrame.J2000
                        )
                        .residualsAcc(99.5)
                        .revNo(7205)
                        .rms(0.991)
                        ...
                        .addSourcedDataType(
                            OrbitdeterminationGetResponse.AprioriStateVector.SourcedDataType.RADAR
                        )
                        .sourceDl("AXE")
                        .srpArea(4.311)
                        .stepMode("AUTO")
        ...
        assertThat(orbitdeterminationGetResponse.dataMode())
            .isEqualTo(OrbitdeterminationGetResponse.DataMode.TEST)
        assertThat(orbitdeterminationGetResponse.endTime())
        ...
        assertThat(orbitdeterminationGetResponse.startTime())
            .isEqualTo(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        assertThat(orbitdeterminationGetResponse.id())
            .contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(orbitdeterminationGetResponse.acceptedObIds().getOrNull())
            .containsExactly("EOOBSERVATION-ID1", "RADAROBSERVATION-ID1")
        assertThat(orbitdeterminationGetResponse.acceptedObTyps().getOrNull())
        ...
        assertThat(orbitdeterminationGetResponse.aprioriElset())
            .contains(
                OrbitdeterminationGetResponse.AprioriElset.builder()
                    .classificationMarking("U")
                    .dataMode(OrbitdeterminationGetResponse.AprioriElset.DataMode.TEST)
        ...
        assertThat(orbitdeterminationGetResponse.aprioriIdElset())
            .contains("80e544b7-6a17-4554-8abf-7301e98f8e5d")
        assertThat(orbitdeterminationGetResponse.aprioriIdStateVector())
            .contains("6e291992-8ae3-4592-bb0f-055715bf4803")
        assertThat(orbitdeterminationGetResponse.aprioriStateVector())
            .contains(
                OrbitdeterminationGetResponse.AprioriStateVector.builder()
                    .classificationMarking("U")
                    .dataMode(OrbitdeterminationGetResponse.AprioriStateVector.DataMode.TEST)
        ...
        assertThat(orbitdeterminationGetResponse.createdAt())
        ...
        assertThat(orbitdeterminationGetResponse.effectiveFrom())
            .contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        assertThat(orbitdeterminationGetResponse.effectiveUntil())
        ...
        assertThat(orbitdeterminationGetResponse.lastObEnd())
            .contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        assertThat(orbitdeterminationGetResponse.lastObStart())
            .contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        ...
        assertThat(orbitdeterminationGetResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(orbitdeterminationGetResponse.rejectedObIds().getOrNull())
            .containsExactly("DIFFOFARRIVAL-ID2", "RFOBSERVATION-ID2")
        assertThat(orbitdeterminationGetResponse.rejectedObTyps().getOrNull())
        ...
        assertThat(orbitdeterminationGetResponse.sensorIds().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedOrbitdeterminationGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(orbitdeterminationGetResponse),
                jacksonTypeRef<OrbitdeterminationGetResponse>(),
            )

        assertThat(roundtrippedOrbitdeterminationGetResponse)
            .isEqualTo(orbitdeterminationGetResponse)
    }
}
