...
internal class SwirQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val swirQueryhelpResponse = SwirQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(swirQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedSwirQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(swirQueryhelpResponse), jacksonTypeRef<SwirQueryhelpResponse>())
