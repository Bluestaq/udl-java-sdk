...
internal class CrewAbridgedTest {
    ...
    @Test
    fun create() {
      val crewAbridged = CrewAbridged.builder()
          ...
          .createdBy("some.user")
          .crewHome(false)
          .addCrewMember(CrewAbridged.CrewMember.builder()
              .alerted(true)
              .allSortie(true)
              .approved(true)
              .attached(true)
      ...
      assertThat(crewAbridged.adjReturnTime()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      assertThat(crewAbridged.adjReturnTimeApprover()).contains("Smith")
      assertThat(crewAbridged.aircraftMds()).contains("C017A")
      assertThat(crewAbridged.alertedTime()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      ...
      assertThat(crewAbridged.createdAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      assertThat(crewAbridged.createdBy()).contains("some.user")
      assertThat(crewAbridged.crewHome()).contains(false)
      assertThat(crewAbridged.crewMembers().getOrNull()).containsExactly(CrewAbridged.CrewMember.builder()
          .alerted(true)
          .allSortie(true)
          .approved(true)
          .attached(true)
      ...
      assertThat(crewAbridged.initStartTime()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      assertThat(crewAbridged.lastAlertTime()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      assertThat(crewAbridged.legalAlertTime()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      assertThat(crewAbridged.legalBravoTime()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      ...
      assertThat(crewAbridged.pickupTime()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      assertThat(crewAbridged.postRestApplied()).contains(false)
      assertThat(crewAbridged.postRestEnd()).contains(OffsetDateTime.parse("2024-01-02T16:00:00.123Z"))
      assertThat(crewAbridged.postRestOffset()).contains("+05:00")
      assertThat(crewAbridged.preRestApplied()).contains(false)
      assertThat(crewAbridged.preRestStart()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      assertThat(crewAbridged.reqQualCode().getOrNull()).containsExactly("AL", "CS")
      assertThat(crewAbridged.returnTime()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      ...
      assertThat(crewAbridged.stageTime()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      ...
      assertThat(crewAbridged.updatedAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedCrewAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(crewAbridged), jacksonTypeRef<CrewAbridged>())
