...
internal class IrQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val irQueryhelpResponse = IrQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(irQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedIrQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(irQueryhelpResponse), jacksonTypeRef<IrQueryhelpResponse>())
