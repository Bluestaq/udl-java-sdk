...
internal class NavigationUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = NavigationUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(NavigationUpdateParams.DataMode.TEST)
          .name("NAME")
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(NavigationUpdateParams.DataMode.TEST)
      assertThat(body.name()).isEqualTo("NAME")
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.bodyId()).contains("NAVIGATION-ID")
