...
internal class SeradataSpacecraftDetailQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val seradataSpacecraftDetailQueryhelpResponse =
            SeradataSpacecraftDetailQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(seradataSpacecraftDetailQueryhelpResponse.classificationMarking())
        ...
        assertThat(seradataSpacecraftDetailQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(seradataSpacecraftDetailQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSeradataSpacecraftDetailQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(seradataSpacecraftDetailQueryhelpResponse),
                jacksonTypeRef<SeradataSpacecraftDetailQueryhelpResponse>(),
            )

        assertThat(roundtrippedSeradataSpacecraftDetailQueryhelpResponse)
            .isEqualTo(seradataSpacecraftDetailQueryhelpResponse)
    }
}
