...
internal class SeraDataNavigationListResponseTest {
    ...
    @Test
    fun create() {
      val seraDataNavigationListResponse = SeraDataNavigationListResponse.builder()
      ...
      assertThat(seraDataNavigationListResponse.dataMode()).isEqualTo(SeraDataNavigationListResponse.DataMode.TEST)
      ...
      assertThat(seraDataNavigationListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(seraDataNavigationListResponse.createdBy()).contains("some.user")
      assertThat(seraDataNavigationListResponse.hostedForCompanyOrgId()).contains("hostedForCompanyOrgId")
      ...
      assertThat(seraDataNavigationListResponse.partnerSpacecraftId()).contains("partnerSpacecraftId")
    ...
    fun roundtrip() {
      ...
      val roundtrippedSeraDataNavigationListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(seraDataNavigationListResponse), jacksonTypeRef<SeraDataNavigationListResponse>())

      assertThat(roundtrippedSeraDataNavigationListResponse).isEqualTo(seraDataNavigationListResponse)
    }
}
