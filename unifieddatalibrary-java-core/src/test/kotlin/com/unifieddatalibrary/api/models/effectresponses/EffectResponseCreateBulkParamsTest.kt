...
internal class EffectResponseCreateBulkParamsTest {

    @Test
    fun create() {
      EffectResponseCreateBulkParams.builder()
          .addBody(EffectResponseCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(EffectResponseCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
              .type("COA")
              .id("EFFECTRESPONSE-ID")
              .addActionsList(EffectResponseCreateBulkParams.Body.ActionsList.builder()
                  ...
                  .actionId("ACTION-ID")
                  .addActionMetric(EffectResponseCreateBulkParams.Body.ActionsList.ActionMetric.builder()
                      .domainValue(10.1)
              ...
              .addCoaMetric(EffectResponseCreateBulkParams.Body.CoaMetric.builder()
                  .domainValue(10.1)
                  .metricType("GoalAchievement")
                  .provenance("Example metric")
                  .relativeValue(10.1)
    ...
    @Test
    fun body() {
      val params = EffectResponseCreateBulkParams.builder()
          .addBody(EffectResponseCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(EffectResponseCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(EffectResponseCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(EffectResponseCreateBulkParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .type("COA")
