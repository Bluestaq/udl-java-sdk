...
internal class OnorbitassessmentGetResponseTest {

    @Test
    fun create() {
        val onorbitassessmentGetResponse =
            OnorbitassessmentGetResponse.builder()
                .assmtTime(OffsetDateTime.parse("2025-08-10T02:44:02.000Z"))
                .classificationMarking("U")
                .dataMode(OnorbitassessmentGetResponse.DataMode.TEST)
                .source("Bluestaq")
        ...
        assertThat(onorbitassessmentGetResponse.assmtTime())
            .isEqualTo(OffsetDateTime.parse("2025-08-10T02:44:02.000Z"))
        assertThat(onorbitassessmentGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(onorbitassessmentGetResponse.dataMode())
            .isEqualTo(OnorbitassessmentGetResponse.DataMode.TEST)
        assertThat(onorbitassessmentGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(onorbitassessmentGetResponse.id())
            .contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(onorbitassessmentGetResponse.assessment()).contains("NOMINAL")
        assertThat(onorbitassessmentGetResponse.assmtDetails())
            .contains("This spacecraft appears to be in a stable, 3-axis controlled state")
        assertThat(onorbitassessmentGetResponse.assmtLevel()).contains("SIGNATURE")
        assertThat(onorbitassessmentGetResponse.assmtRotPeriod()).contains(72.5)
        assertThat(onorbitassessmentGetResponse.assmtSubType()).contains("STABLE")
        assertThat(onorbitassessmentGetResponse.assmtUrl())
            .contains("https://unifieddatalibrary.com")
        assertThat(onorbitassessmentGetResponse.autoAssmt()).contains(false)
        assertThat(onorbitassessmentGetResponse.collectionUrl())
            .contains("https://unifieddatalibrary.com")
        assertThat(onorbitassessmentGetResponse.components().getOrNull())
            .containsExactly("THRUSTER", "RWA-2")
        assertThat(onorbitassessmentGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(onorbitassessmentGetResponse.createdBy()).contains("some.user")
        assertThat(onorbitassessmentGetResponse.idOnOrbit()).contains("25544")
        assertThat(onorbitassessmentGetResponse.idSensor()).contains("211")
        assertThat(onorbitassessmentGetResponse.obDuration()).contains(1.75)
        assertThat(onorbitassessmentGetResponse.obTime())
            .contains(OffsetDateTime.parse("2025-08-09T23:27:55.862Z"))
        assertThat(onorbitassessmentGetResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(onorbitassessmentGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(onorbitassessmentGetResponse.origNetwork()).contains("OPS1")
        assertThat(onorbitassessmentGetResponse.origObjectId()).contains("ISS")
        assertThat(onorbitassessmentGetResponse.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(onorbitassessmentGetResponse.satNo()).contains(25544)
        assertThat(onorbitassessmentGetResponse.sigDataType()).contains("PHOTOMETRY")
        assertThat(onorbitassessmentGetResponse.sourceDl()).contains("AXE")
        assertThat(onorbitassessmentGetResponse.srcIds().getOrNull())
            .containsExactly(
                "49cf9dcf-e97e-43ed-8e21-22e2bb0e3da6",
                "da779fc4-3a37-4caa-a629-289671bc96e8",
            )
        assertThat(onorbitassessmentGetResponse.srcTyps().getOrNull())
            .containsExactly("EO", "SKYIMAGE")
        assertThat(onorbitassessmentGetResponse.tags().getOrNull()).containsExactly("TAG1", "TAG2")
        assertThat(onorbitassessmentGetResponse.transactionId()).contains("TRANSACTION-ID")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbitassessmentGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbitassessmentGetResponse),
                jacksonTypeRef<OnorbitassessmentGetResponse>(),
            )

        assertThat(roundtrippedOnorbitassessmentGetResponse).isEqualTo(onorbitassessmentGetResponse)
    }
}
