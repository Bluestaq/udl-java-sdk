...
internal class ScientificGetResponseTest {

    @Test
    fun create() {
        val scientificGetResponse =
            ScientificGetResponse.builder()
                .classificationMarking("U")
                .dataMode(ScientificGetResponse.DataMode.TEST)
                .name("SEM/MAG")
                .source("Bluestaq")
        ...
        assertThat(scientificGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(scientificGetResponse.dataMode()).isEqualTo(ScientificGetResponse.DataMode.TEST)
        assertThat(scientificGetResponse.name()).isEqualTo("SEM/MAG")
        assertThat(scientificGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(scientificGetResponse.spacecraftId()).isEqualTo("REF-SPACECRAFT-ID")
        assertThat(scientificGetResponse.id()).contains("SCIENTIFIC-ID")
        assertThat(scientificGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(scientificGetResponse.createdBy()).contains("some.user")
        assertThat(scientificGetResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(scientificGetResponse.frequencyBand()).contains("Gamma")
        assertThat(scientificGetResponse.hostedForCompanyOrgId())
            .contains("REF-HOSTEDFORCOMPANYORG-ID")
        assertThat(scientificGetResponse.idEntity())
            .contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
        assertThat(scientificGetResponse.manufacturerOrgId()).contains("REF-MANUFACTURERORG-ID")
        assertThat(scientificGetResponse.notes()).contains("NOTES")
        assertThat(scientificGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(scientificGetResponse.origNetwork()).contains("ORIG")
        assertThat(scientificGetResponse.payloadCategory()).contains("Sensor")
        assertThat(scientificGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(scientificGetResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedScientificGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(scientificGetResponse),
                jacksonTypeRef<ScientificGetResponse>(),
            )

        assertThat(roundtrippedScientificGetResponse).isEqualTo(scientificGetResponse)
    }
}
