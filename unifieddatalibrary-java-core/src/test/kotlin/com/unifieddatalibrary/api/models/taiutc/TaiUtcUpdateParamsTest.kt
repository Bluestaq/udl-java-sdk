...
internal class TaiUtcUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = TaiUtcUpdateParams.builder()
          .pathId("id")
          .adjustmentDate(OffsetDateTime.parse("2017-01-01T00:00:00.123Z"))
          .classificationMarking("U")
          .dataMode(TaiUtcUpdateParams.DataMode.TEST)
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(TaiUtcUpdateParams.DataMode.TEST)
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.bodyId()).contains("TAIUTC-ID")
