...
internal class SortiePprFullTest {
    ...
    fun create() {
        ...
        assertThat(sortiePprFull.startTime())
            .contains(OffsetDateTime.parse("2024-01-01T01:01:01.123Z"))
        assertThat(sortiePprFull.type()).contains(SortiePprFull.Type.M)
        assertThat(sortiePprFull.updatedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSortiePprFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sortiePprFull),
                jacksonTypeRef<SortiePprFull>(),
            )
