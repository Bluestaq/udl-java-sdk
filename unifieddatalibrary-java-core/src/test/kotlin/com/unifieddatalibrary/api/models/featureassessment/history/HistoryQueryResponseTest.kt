...
internal class HistoryQueryResponseTest {
    ...
    fun create() {
        ...
        assertThat(historyQueryResponse.area())
            .contains("POINT(52.23486096929749 16.191937138595005)")
        assertThat(historyQueryResponse.asrid()).contains(4326)
        assertThat(historyQueryResponse.assessment())
            .contains(
                "Vessel bigger than other small fishing boats commonly found along the coastline"
            )
        assertThat(historyQueryResponse.atext())
            .contains("POINT(52.23486096929749 16.191937138595005)")
        ...
        assertThat(historyQueryResponse.featureStringArray().getOrNull())
        ...
        assertThat(historyQueryResponse.srcIds().getOrNull())
            .containsExactly(
                "b008c63b-ad89-4493-80e0-77bc982bef77",
                "3565a6dd-654e-4969-89e0-ee7c51ab1e1b",
            )
        assertThat(historyQueryResponse.srcTs().getOrNull())
            .containsExactly(
