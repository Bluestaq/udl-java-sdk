...
internal class SeradataRadarPayloadQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val seradataRadarPayloadQueryhelpResponse =
            SeradataRadarPayloadQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(seradataRadarPayloadQueryhelpResponse.classificationMarking())
        ...
        assertThat(seradataRadarPayloadQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(seradataRadarPayloadQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSeradataRadarPayloadQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(seradataRadarPayloadQueryhelpResponse),
                jacksonTypeRef<SeradataRadarPayloadQueryhelpResponse>(),
            )

        assertThat(roundtrippedSeradataRadarPayloadQueryhelpResponse)
            .isEqualTo(seradataRadarPayloadQueryhelpResponse)
    }
}
