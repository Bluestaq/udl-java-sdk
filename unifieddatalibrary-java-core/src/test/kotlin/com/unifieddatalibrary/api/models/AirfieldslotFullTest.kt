...
internal class AirfieldslotFullTest {
    ...
    fun create() {
        ...
        assertThat(airfieldslotFull.createdAt())
        ...
        assertThat(airfieldslotFull.updatedAt())
            .contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedAirfieldslotFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(airfieldslotFull),
                jacksonTypeRef<AirfieldslotFull>(),
            )
