...
internal class EmireportTupleResponseTest {

    @Test
    fun create() {
        val emireportTupleResponse =
            EmireportTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(EmireportTupleResponse.DataMode.TEST)
                .isr(true)
                .reportId("REPORT-ID")
        ...
        assertThat(emireportTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(emireportTupleResponse.dataMode())
            .isEqualTo(EmireportTupleResponse.DataMode.TEST)
        assertThat(emireportTupleResponse.isr()).isEqualTo(true)
        assertThat(emireportTupleResponse.reportId()).isEqualTo("REPORT-ID")
        assertThat(emireportTupleResponse.reportTime())
            .isEqualTo(OffsetDateTime.parse("2025-01-07T21:47:40.438Z"))
        assertThat(emireportTupleResponse.reportType()).isEqualTo("SATCOM")
        assertThat(emireportTupleResponse.requestAssist()).isEqualTo(true)
        assertThat(emireportTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(emireportTupleResponse.startTime())
            .isEqualTo(OffsetDateTime.parse("2025-01-07T20:16:03.989Z"))
        assertThat(emireportTupleResponse.id()).contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(emireportTupleResponse.actionsTaken())
            .contains("verified connections, cables and antenna pointing angles")
        assertThat(emireportTupleResponse.affActivity()).contains("UPLINK")
        assertThat(emireportTupleResponse.alt()).contains(1750.0)
        assertThat(emireportTupleResponse.aor()).contains("NORTHCOM")
        assertThat(emireportTupleResponse.band()).contains("SHF")
        assertThat(emireportTupleResponse.beamPattern()).contains("MAIN LOBE")
        assertThat(emireportTupleResponse.channel()).contains("10C-10CU")
        assertThat(emireportTupleResponse.chanPirate()).contains(false)
        assertThat(emireportTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(emireportTupleResponse.createdBy()).contains("some.user")
        assertThat(emireportTupleResponse.description()).contains("Interference on channel")
        assertThat(emireportTupleResponse.dneImpact())
            .contains("Text description of the duration, nature and extent (DNE) of the impact.")
        assertThat(emireportTupleResponse.emiType()).contains("BARRAGE")
        assertThat(emireportTupleResponse.endTime())
            .contains(OffsetDateTime.parse("2025-01-07T21:30:51.672Z"))
        assertThat(emireportTupleResponse.frequency()).contains(1575.42)
        assertThat(emireportTupleResponse.geoLocErrEllp().getOrNull())
            .containsExactly(1300.0, 700.0, 35.0)
        assertThat(emireportTupleResponse.gpsEncrypted()).contains(false)
        assertThat(emireportTupleResponse.gpsFreq()).contains("L1")
        assertThat(emireportTupleResponse.highAffectedFrequency()).contains(1725.0)
        assertThat(emireportTupleResponse.idOnOrbit()).contains("25724")
        assertThat(emireportTupleResponse.intercept()).contains(false)
        assertThat(emireportTupleResponse.interceptLang()).contains("ENGLISH")
        assertThat(emireportTupleResponse.interceptType()).contains("VOICE")
        assertThat(emireportTupleResponse.intSrcAmplitude()).contains(0.275)
        assertThat(emireportTupleResponse.intSrcBandwidth()).contains(30.0)
        assertThat(emireportTupleResponse.intSrcCentFreq()).contains(485.7)
        assertThat(emireportTupleResponse.intSrcEncrypted()).contains(false)
        assertThat(emireportTupleResponse.intSrcModulation()).contains("FSK")
        assertThat(emireportTupleResponse.isrCollectionImpact()).contains(false)
        assertThat(emireportTupleResponse.killBox()).contains("7F9SW")
        assertThat(emireportTupleResponse.lat()).contains(38.7375)
        assertThat(emireportTupleResponse.link()).contains("SPOT-21")
        assertThat(emireportTupleResponse.lon()).contains(-104.7889)
        assertThat(emireportTupleResponse.milGrid()).contains("4QFJ12345678")
        assertThat(emireportTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(emireportTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(emireportTupleResponse.origNetwork()).contains("OPS1")
        assertThat(emireportTupleResponse.origObjectId()).contains("25724")
        assertThat(emireportTupleResponse.persistence()).contains("CONTINUOUS")
        assertThat(emireportTupleResponse.platform()).contains("CVN-78")
        assertThat(emireportTupleResponse.rcvrDemod()).contains("FSK")
        assertThat(emireportTupleResponse.rcvrGain()).contains(23.7)
        assertThat(emireportTupleResponse.rcvrLocation()).contains("FORT CARSON GARAGE")
        assertThat(emireportTupleResponse.rcvrType()).contains("OMNI")
        assertThat(emireportTupleResponse.respService()).contains("ARMY")
        assertThat(emireportTupleResponse.satcomPriority()).contains("HIGH")
        assertThat(emireportTupleResponse.satDownlinkFrequency()).contains(47432.5)
        assertThat(emireportTupleResponse.satDownlinkPolarization()).contains("V")
        assertThat(emireportTupleResponse.satName()).contains("MILSTAR DFS-3")
        assertThat(emireportTupleResponse.satNo()).contains(25724)
        assertThat(emireportTupleResponse.satTransponderId()).contains("36097-8433-10C")
        assertThat(emireportTupleResponse.satUplinkFrequency()).contains(44532.1)
        assertThat(emireportTupleResponse.satUplinkPolarization()).contains("H")
        assertThat(emireportTupleResponse.sourceDl()).contains("AXE")
        assertThat(emireportTupleResponse.status()).contains("INITIAL")
        assertThat(emireportTupleResponse.supportedIsrRole()).contains("IMAGERY")
        assertThat(emireportTupleResponse.system()).contains("RADIO")
        assertThat(emireportTupleResponse.tags().getOrNull()).containsExactly("TAG1", "TAG2")
        assertThat(emireportTupleResponse.transactionId()).contains("TRANSACTION-ID")
        assertThat(emireportTupleResponse.victimAltCountry()).contains("US")
        assertThat(emireportTupleResponse.victimCountryCode()).contains("US")
        assertThat(emireportTupleResponse.victimFuncImpacts()).contains("C2")
        assertThat(emireportTupleResponse.victimPocMail()).contains("bob@jammer.com")
        assertThat(emireportTupleResponse.victimPocName()).contains("Robert Smith")
        assertThat(emireportTupleResponse.victimPocPhone()).contains("7198675309")
        assertThat(emireportTupleResponse.victimPocUnit()).contains("4th Engineering Battalion")
        assertThat(emireportTupleResponse.victimReaction()).contains("TROUBLESHOOT")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedEmireportTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(emireportTupleResponse),
                jacksonTypeRef<EmireportTupleResponse>(),
            )

        assertThat(roundtrippedEmireportTupleResponse).isEqualTo(emireportTupleResponse)
    }
}
