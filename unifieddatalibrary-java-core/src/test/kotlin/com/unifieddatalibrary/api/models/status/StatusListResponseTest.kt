...
internal class StatusListResponseTest {
    ...
    @Test
    fun create() {
      val statusListResponse = StatusListResponse.builder()
          ...
          .addSubStatusCollection(StatusListResponse.SubStatusCollection.builder()
              .classificationMarking("U")
      ...
      assertThat(statusListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(statusListResponse.createdBy()).contains("some.user")
      assertThat(statusListResponse.declassificationDate()).contains(OffsetDateTime.parse("2021-01-01T01:02:02.123Z"))
      ...
      assertThat(statusListResponse.origNetwork()).contains("TST1")
      assertThat(statusListResponse.state()).contains(StatusListResponse.State.ACTIVE)
      assertThat(statusListResponse.subStatusCollection().getOrNull()).containsExactly(StatusListResponse.SubStatusCollection.builder()
          .classificationMarking("U")
          .dataMode(StatusListResponse.SubStatusCollection.DataMode.TEST)
          .notes("Sample Notes")
          .source("Bluestaq")
    ...
    fun roundtrip() {
      ...
      val roundtrippedStatusListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(statusListResponse), jacksonTypeRef<StatusListResponse>())
