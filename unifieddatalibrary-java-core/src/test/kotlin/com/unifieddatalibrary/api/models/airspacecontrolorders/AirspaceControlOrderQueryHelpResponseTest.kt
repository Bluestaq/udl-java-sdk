...
internal class AirspaceControlOrderQueryHelpResponseTest {
    ...
    @Test
    fun create() {
      val airspaceControlOrderQueryHelpResponse = AirspaceControlOrderQueryHelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(airspaceControlOrderQueryHelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(airspaceControlOrderQueryHelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(airspaceControlOrderQueryHelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAirspaceControlOrderQueryHelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(airspaceControlOrderQueryHelpResponse), jacksonTypeRef<AirspaceControlOrderQueryHelpResponse>())

      assertThat(roundtrippedAirspaceControlOrderQueryHelpResponse).isEqualTo(airspaceControlOrderQueryHelpResponse)
    }
}
