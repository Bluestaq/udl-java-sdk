...
internal class RfEmitterGetResponseTest {
    ...
    @Test
    fun create() {
      val rfEmitterGetResponse = RfEmitterGetResponse.builder()
          ...
          .origin("THIRD_PARTY_DATASOURCE")
          .origNetwork("ORIG")
          .addRfEmitterDetail(RfEmitterGetResponse.RfEmitterDetail.builder()
              .classificationMarking("U")
      ...
      assertThat(rfEmitterGetResponse.id()).contains("RFEMITTER-ID")
      assertThat(rfEmitterGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(rfEmitterGetResponse.createdBy()).contains("some.user")
      assertThat(rfEmitterGetResponse.entity()).contains(EntityFull.builder()
          .classificationMarking("U")
          .dataMode(EntityFull.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
      ...
      assertThat(rfEmitterGetResponse.origNetwork()).contains("ORIG")
      assertThat(rfEmitterGetResponse.rfEmitterDetails().getOrNull()).containsExactly(RfEmitterGetResponse.RfEmitterDetail.builder()
          .classificationMarking("U")
          .dataMode(RfEmitterGetResponse.RfEmitterDetail.DataMode.TEST)
          .idRfEmitter("RFEMITTER-ID")
          .source("Bluestaq")
      ...
      assertThat(rfEmitterGetResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfEmitterGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rfEmitterGetResponse), jacksonTypeRef<RfEmitterGetResponse>())
