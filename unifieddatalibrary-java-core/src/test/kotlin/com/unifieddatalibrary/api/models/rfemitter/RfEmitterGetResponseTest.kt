...
internal class RfEmitterGetResponseTest {

    @Test
    fun create() {
        val rfEmitterGetResponse =
            RfEmitterGetResponse.builder()
                .classificationMarking("U")
                .dataMode(RfEmitterGetResponse.DataMode.TEST)
                .name("RF_NAME")
                .source("Bluestaq")
                ...
                .origNetwork("OPS1")
                .addRfEmitterDetail(
                    RfEmitterGetResponse.RfEmitterDetail.builder()
                        .classificationMarking("U")
                        .dataMode(RfEmitterGetResponse.RfEmitterDetail.DataMode.TEST)
                        ...
                        .amplifier(
                            RfEmitterGetResponse.RfEmitterDetail.Amplifier.builder()
                        ...
                        .addAntenna(
                            RfEmitterGetResponse.RfEmitterDetail.Antenna.builder()
                                .antennaDiameter(20.23)
                                .addAntennaSize(1.1)
                                .addAntennaSize(2.2)
                                .azElFixed(true)
                                .addFeed(
                                    RfEmitterGetResponse.RfEmitterDetail.Antenna.Feed.builder()
                                        .freqMax(43500.1)
                                        .freqMin(39500.1)
                                        .name("Feed A")
                                ...
                                .name("ds1Rotor")
                                .addReceiverChannel(
                                    RfEmitterGetResponse.RfEmitterDetail.Antenna.ReceiverChannel
                                        .builder()
                                        .bandwidth(0.51)
                                        .channelNum("315")
                                ...
                                .addTransmitChannel(
                                    RfEmitterGetResponse.RfEmitterDetail.Antenna.TransmitChannel
                                        .builder()
                                        .power(100.23)
                                        .bandwidth(0.125)
                                        .channelNum("12")
                        ...
                        .origNetwork("OPS1")
                        .addPowerOffset(
                            RfEmitterGetResponse.RfEmitterDetail.PowerOffset.builder()
                                .frequencyBand("KU")
                                .powerOffset(-5.1)
                                .build()
                        )
                        ...
                        .addService(
                            RfEmitterGetResponse.RfEmitterDetail.Service.builder()
                        ...
                        .addTtp(
                            RfEmitterGetResponse.RfEmitterDetail.Ttp.builder()
                                .outputSignalName("SIGNAL_A")
                                .addTechniqueDefinition(
                                    RfEmitterGetResponse.RfEmitterDetail.Ttp.TechniqueDefinition
                                        .builder()
                                        .name("SIGNAL TUNE")
                                        .addParamDefinition(
                                            RfEmitterGetResponse.RfEmitterDetail.Ttp
                                                .TechniqueDefinition
                                                .ParamDefinition
                                                .builder()
                                                .defaultValue("444.0")
        ...
        assertThat(rfEmitterGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(rfEmitterGetResponse.dataMode()).isEqualTo(RfEmitterGetResponse.DataMode.TEST)
        assertThat(rfEmitterGetResponse.name()).isEqualTo("RF_NAME")
        assertThat(rfEmitterGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(rfEmitterGetResponse.id()).contains("ad88770b-d824-443f-bdce-5f9e3fa500a9")
        assertThat(rfEmitterGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2025-03-05T16:00:00.123Z"))
        assertThat(rfEmitterGetResponse.createdBy()).contains("some.user")
        assertThat(rfEmitterGetResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(rfEmitterGetResponse.extSysId()).contains("EXTSYS-ID")
        assertThat(rfEmitterGetResponse.idEntity()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
        assertThat(rfEmitterGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(rfEmitterGetResponse.origNetwork()).contains("OPS1")
        assertThat(rfEmitterGetResponse.rfEmitterDetails().getOrNull())
            .containsExactly(
                RfEmitterGetResponse.RfEmitterDetail.builder()
                    .classificationMarking("U")
                    .dataMode(RfEmitterGetResponse.RfEmitterDetail.DataMode.TEST)
        ...
        assertThat(rfEmitterGetResponse.subtype()).contains("BLOCK_1")
        assertThat(rfEmitterGetResponse.type()).contains("TYPE_OF_EMITTER")
        assertThat(rfEmitterGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2025-03-05T16:00:00.123Z"))
        assertThat(rfEmitterGetResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedRfEmitterGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(rfEmitterGetResponse),
                jacksonTypeRef<RfEmitterGetResponse>(),
            )

        assertThat(roundtrippedRfEmitterGetResponse).isEqualTo(rfEmitterGetResponse)
    }
}
