...
internal class TrackRouteCreateParamsTest {
    ...
    fun create() {
      TrackRouteCreateParams.builder()
          ...
          .addAltitudeBlock(TrackRouteCreateParams.AltitudeBlock.builder()
          ...
          .origNetwork("OPS1")
          .addPoc(TrackRouteCreateParams.Poc.builder()
              .office("A34")
              .phone("8675309")
              .pocName("Fred Smith")
              .pocOrg("HQAF")
          ...
          .addRoutePoint(TrackRouteCreateParams.RoutePoint.builder()
              .altCountryCode("IZ")
              .countryCode("NL")
              .dafifPt(true)
              .magDec(7.35)
    ...
    @Test
    fun body() {
      val params = TrackRouteCreateParams.builder()
          .classificationMarking("U")
          .dataMode(TrackRouteCreateParams.DataMode.TEST)
          .lastUpdateDate(OffsetDateTime.parse("2024-09-17T16:00:00.123Z"))
          .source("Bluestaq")
      ...
      assertThat(body.dataMode()).isEqualTo(TrackRouteCreateParams.DataMode.TEST)
      ...
      assertThat(body.altitudeBlocks().getOrNull()).containsExactly(TrackRouteCreateParams.AltitudeBlock.builder()
          .altitudeSequenceId("A1")
          .lowerAltitude(27000.1)
          .upperAltitude(27200.5)
          .build())
      ...
      assertThat(body.poc().getOrNull()).containsExactly(TrackRouteCreateParams.Poc.builder()
          .office("A34")
          .phone("8675309")
          .pocName("Fred Smith")
          .pocOrg("HQAF")
      ...
      assertThat(body.routePoints().getOrNull()).containsExactly(TrackRouteCreateParams.RoutePoint.builder()
          .altCountryCode("IZ")
          .countryCode("NL")
          .dafifPt(true)
          .magDec(7.35)
