...
internal class ObjectOfInterestCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(ObjectOfInterestCreateParams.DataMode.TEST)
        ...
        assertThat(body.id()).contains("OBJECTOFINTEREST-ID")
