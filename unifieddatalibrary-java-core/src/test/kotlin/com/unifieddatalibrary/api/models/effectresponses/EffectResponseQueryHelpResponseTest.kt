...
internal class EffectResponseQueryHelpResponseTest {
    ...
    @Test
    fun create() {
        val effectResponseQueryHelpResponse =
            EffectResponseQueryHelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(effectResponseQueryHelpResponse.classificationMarking())
        ...
        assertThat(effectResponseQueryHelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(effectResponseQueryHelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedEffectResponseQueryHelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(effectResponseQueryHelpResponse),
                jacksonTypeRef<EffectResponseQueryHelpResponse>(),
            )

        assertThat(roundtrippedEffectResponseQueryHelpResponse)
            .isEqualTo(effectResponseQueryHelpResponse)
    }
}
