...
internal class HistoryListResponseTest {
    ...
    fun create() {
      ...
      assertThat(historyListResponse.reportDate()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(historyListResponse.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(historyListResponse.andims()).contains(3L)
      assertThat(historyListResponse.area()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(historyListResponse.asrid()).contains(3)
      assertThat(historyListResponse.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(historyListResponse.eventEnd()).contains(OffsetDateTime.parse("2021-01-01T01:02:03.123Z"))
      assertThat(historyListResponse.eventStart()).contains(OffsetDateTime.parse("2021-01-01T01:02:03.123Z"))
      ...
      assertThat(historyListResponse.relatedDocs().getOrNull()).containsExactly(RelatedDocumentFull.builder()
          .addDataSourceRef(SofDataSourceRefFull.builder()
              .dataSourceId("dataSourceId")
              .endPosition("endPosition")
              .paragraphNumber("paragraphNumber")
