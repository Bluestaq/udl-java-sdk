...
internal class SkyImageryGetResponseTest {

    @Test
    fun create() {
        val skyImageryGetResponse =
            SkyImageryGetResponse.builder()
                .classificationMarking("U")
                .dataMode(SkyImageryGetResponse.DataMode.TEST)
        ...
        assertThat(skyImageryGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(skyImageryGetResponse.dataMode()).isEqualTo(SkyImageryGetResponse.DataMode.TEST)
        assertThat(skyImageryGetResponse.expStartTime())
            .isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(skyImageryGetResponse.imageType()).isEqualTo("imageType")
        assertThat(skyImageryGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(skyImageryGetResponse.id()).contains("SKYIMAGERY-ID")
        assertThat(skyImageryGetResponse.annotationKey()).contains("annotationKey")
        assertThat(skyImageryGetResponse.calibrationKey()).contains("calibrationKey")
        assertThat(skyImageryGetResponse.checksumValue()).contains("checksumValue")
        assertThat(skyImageryGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(skyImageryGetResponse.createdBy()).contains("some.user")
        assertThat(skyImageryGetResponse.description()).contains("description")
        assertThat(skyImageryGetResponse.eoObservations().getOrNull())
            .containsExactly(
                EoObservationFull.builder()
                    .classificationMarking("U")
                    .dataMode(EoObservationFull.DataMode.TEST)
        ...
        assertThat(skyImageryGetResponse.expEndTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(skyImageryGetResponse.filename()).contains("filename.jpg")
        assertThat(skyImageryGetResponse.filesize()).contains(371945L)
        assertThat(skyImageryGetResponse.frameFovHeight()).contains(21.23)
        assertThat(skyImageryGetResponse.frameFovWidth()).contains(21.23)
        assertThat(skyImageryGetResponse.frameHeightPixels()).contains(1)
        assertThat(skyImageryGetResponse.frameWidthPixels()).contains(1)
        assertThat(skyImageryGetResponse.idAttitudeSet())
            .contains("d039ba29-52f4-4839-8a8f-e85fa416aec5")
        assertThat(skyImageryGetResponse.idOnOrbit()).contains("44920")
        assertThat(skyImageryGetResponse.idSensor()).contains("420")
        assertThat(skyImageryGetResponse.idSoiSet()).contains("531093d0-e9b0-475b-687aeeefefd9")
        assertThat(skyImageryGetResponse.imageSetId()).contains("imageSetId")
        assertThat(skyImageryGetResponse.imageSetLength()).contains(9)
        assertThat(skyImageryGetResponse.imageSourceInfo()).contains("imageSourceInfo")
        assertThat(skyImageryGetResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(skyImageryGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(skyImageryGetResponse.origNetwork()).contains("OPS1")
        assertThat(skyImageryGetResponse.origObjectId()).contains("X15-23452")
        assertThat(skyImageryGetResponse.origSensorId()).contains("origSensorId")
        assertThat(skyImageryGetResponse.pixelBitDepth()).contains(1)
        assertThat(skyImageryGetResponse.pixelFovHeight()).contains(321.123)
        assertThat(skyImageryGetResponse.pixelFovWidth()).contains(321.123)
        assertThat(skyImageryGetResponse.satNo()).contains(25544)
        assertThat(skyImageryGetResponse.senalt()).contains(14.483619321)
        assertThat(skyImageryGetResponse.senlat()).contains(-33.283048)
        assertThat(skyImageryGetResponse.senlon()).contains(149.372549)
        assertThat(skyImageryGetResponse.senQuat().getOrNull())
            .containsExactly(0.03, 0.02, 0.01, 0.012)
        assertThat(skyImageryGetResponse.senQuatDot().getOrNull())
            .containsExactly(0.03, 0.02, 0.01, 0.012)
        assertThat(skyImageryGetResponse.senx()).contains(14.52)
        assertThat(skyImageryGetResponse.seny()).contains(32.41)
        assertThat(skyImageryGetResponse.senz()).contains(376.12)
        assertThat(skyImageryGetResponse.sequenceId()).contains(1)
        assertThat(skyImageryGetResponse.sourceDl()).contains("AXE")
        assertThat(skyImageryGetResponse.tags().getOrNull())
            .containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
        assertThat(skyImageryGetResponse.topLeftStartAz()).contains(146.321)
        assertThat(skyImageryGetResponse.topLeftStartEl()).contains(146.321)
        assertThat(skyImageryGetResponse.topLeftStopAz()).contains(3.7)
        assertThat(skyImageryGetResponse.topLeftStopEl()).contains(34.233)
        assertThat(skyImageryGetResponse.transactionId())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSkyImageryGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(skyImageryGetResponse),
                jacksonTypeRef<SkyImageryGetResponse>(),
            )

        assertThat(roundtrippedSkyImageryGetResponse).isEqualTo(skyImageryGetResponse)
    }
}
