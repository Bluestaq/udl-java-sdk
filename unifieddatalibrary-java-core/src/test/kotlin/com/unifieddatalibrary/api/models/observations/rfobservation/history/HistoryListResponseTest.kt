    ...
    fun create() {
        val historyListResponse =
            HistoryListResponse.builder()
                ...
                .addDetectionStatus("CARRIER_DETECTED")
                .eirp(10.1)
                .elevation(10.1)
                ...
                .addJamBand("L1")
                .addJamBand("L2")
                .addJamToSigRatio(54.1)
                .addJamToSigRatio(34.1)
                .maxPsd(10.1)
                .minPsd(10.1)
                .modulation("Auto")
        ...
        assertThat(historyListResponse.detectionStatuses().getOrNull())
            .containsExactly("DETECTED", "CARRIER_DETECTED")
        ...
        assertThat(historyListResponse.fftImagCoeffs().getOrNull()).containsExactly(1.1, 2.2)
        assertThat(historyListResponse.fftRealCoeffs().getOrNull()).containsExactly(1.1, 2.2)
        ...
        assertThat(historyListResponse.jamBands().getOrNull()).containsExactly("L1", "L2")
        assertThat(historyListResponse.jamToSigRatios().getOrNull()).containsExactly(54.1, 34.1)
        ...
        assertThat(historyListResponse.origCountry()).contains("AU")
        assertThat(historyListResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(historyListResponse.origMarking()).contains("U")
