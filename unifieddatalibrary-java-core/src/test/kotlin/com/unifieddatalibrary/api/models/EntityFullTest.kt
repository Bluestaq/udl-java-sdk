...
internal class EntityFullTest {
    ...
    fun create() {
        ...
        assertThat(entityFull.classificationMarking()).isEqualTo("U")
        assertThat(entityFull.dataMode()).isEqualTo(EntityFull.DataMode.TEST)
        assertThat(entityFull.name()).isEqualTo("Example name")
        assertThat(entityFull.source()).isEqualTo("Bluestaq")
        assertThat(entityFull.type()).isEqualTo(EntityFull.Type.ONORBIT)
        assertThat(entityFull.countryCode()).contains("US")
        assertThat(entityFull.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(entityFull.createdBy()).contains("some.user")
        assertThat(entityFull.idEntity()).contains("ENTITY-ID")
        assertThat(entityFull.idLocation()).contains("LOCATION-ID")
        assertThat(entityFull.idOnOrbit()).contains("ONORBIT-ID")
        assertThat(entityFull.idOperatingUnit()).contains("OPERATINGUNIT-ID")
        assertThat(entityFull.location())
            .contains(
                LocationFull.builder()
                    .classificationMarking("U")
                    .dataMode(LocationFull.DataMode.TEST)
        ...
        assertThat(entityFull.operatingUnit())
            .contains(
                OperatingunitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OperatingunitFull.DataMode.TEST)
        ...
        assertThat(entityFull.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(entityFull.origNetwork()).contains("OPS1")
        assertThat(entityFull.ownerType()).contains(EntityFull.OwnerType.COMMERCIAL)
        assertThat(entityFull.rfBands().getOrNull())
            .containsExactly(
                RfBandFull.builder()
                    .classificationMarking("U")
                    .dataMode(RfBandFull.DataMode.TEST)
        ...
        assertThat(entityFull.statusCollection().getOrNull())
            .containsExactly(
                StatusFull.builder()
                    .classificationMarking("U")
                    .dataMode(StatusFull.DataMode.TEST)
        ...
        assertThat(entityFull.taskable()).contains(false)
        assertThat(entityFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(entityFull.updatedBy()).contains("some.user")
        assertThat(entityFull.urls().getOrNull()).containsExactly("URL1", "URL2")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedEntityFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(entityFull),
                jacksonTypeRef<EntityFull>(),
            )

        assertThat(roundtrippedEntityFull).isEqualTo(entityFull)
    }
}
