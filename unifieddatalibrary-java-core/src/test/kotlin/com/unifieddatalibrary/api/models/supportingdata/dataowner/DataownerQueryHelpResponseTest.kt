...
internal class DataownerQueryHelpResponseTest {
    ...
    @Test
    fun create() {
      val dataownerQueryHelpResponse = DataownerQueryHelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(dataownerQueryHelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(dataownerQueryHelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedDataownerQueryHelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(dataownerQueryHelpResponse), jacksonTypeRef<DataownerQueryHelpResponse>())
