...
internal class CountryUpdateParamsTest {
    ...
    fun create() {
      CountryUpdateParams.builder()
          ...
          .createdBy("some.user")
          .addDiplomaticClearanceCountryContact(CountryUpdateParams.DiplomaticClearanceCountryContact.builder()
              .ahNum("256039858")
              .ahSpdDialCode("75")
              .commNum("904716104")
              .commSpdDialCode("74")
              ...
              .siprNum("546144352")
              .build())
          .addDiplomaticClearanceCountryEntryExitPoint(CountryUpdateParams.DiplomaticClearanceCountryEntryExitPoint.builder()
              .isEntry(true)
              .isExit(true)
              .pointName("BATEL")
              .build())
          .addDiplomaticClearanceCountryProfile(CountryUpdateParams.DiplomaticClearanceCountryProfile.builder()
    ...
    @Test
    fun pathParams() {
      val params = CountryUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .countryCode("NL")
          .dataMode(CountryUpdateParams.DataMode.TEST)
    ...
    fun body() {
      ...
      assertThat(body.lastChangedDate()).isEqualTo(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.bodyId()).contains("25059135-4afc-45c2-b78b-d6e843dbd96d")
      ...
      assertThat(body.countryRemark()).contains("Amsterdam airport EHAM will not accept hazardous cargo.")
      assertThat(body.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(body.createdBy()).contains("some.user")
      assertThat(body.diplomaticClearanceCountryContacts().getOrNull()).containsExactly(CountryUpdateParams.DiplomaticClearanceCountryContact.builder()
          .ahNum("256039858")
          .ahSpdDialCode("75")
          .commNum("904716104")
          .commSpdDialCode("74")
          ...
          .siprNum("546144352")
          .build())
      assertThat(body.diplomaticClearanceCountryEntryExitPoints().getOrNull()).containsExactly(CountryUpdateParams.DiplomaticClearanceCountryEntryExitPoint.builder()
          .isEntry(true)
          .isExit(true)
          .pointName("BATEL")
          .build())
      assertThat(body.diplomaticClearanceCountryProfiles().getOrNull()).containsExactly(CountryUpdateParams.DiplomaticClearanceCountryProfile.builder()
          .cargoPaxRemark("Cargo passenger remark")
          .clearanceId("MDCNPER231360050AAR")
          .crewInfoRemark("Crew info remark")
          .defClearanceStatus("R")
