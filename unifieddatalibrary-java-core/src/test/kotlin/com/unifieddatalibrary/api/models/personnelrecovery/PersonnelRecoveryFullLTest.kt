...
internal class PersonnelRecoveryFullLTest {
    ...
    fun create() {
        val personnelRecoveryFullL =
            PersonnelRecoveryFullL.builder()
                ...
                .createdBy("some.user")
                .executionInfo(
                    PersonnelRecoveryFullL.ExecutionInfo.builder()
                        .egress(66.53)
                        .addEgressPoint(107.23)
                        .addEgressPoint(30.455)
                        .escortVehicle(
                            PersonnelRecoveryFullL.ExecutionInfo.EscortVehicle.builder()
                                .callSign("FALCO")
                                .primaryFreq(34.55)
                                .strength(5)
                                .type("C17")
                        ...
                        .recoveryVehicle(
                            PersonnelRecoveryFullL.ExecutionInfo.RecoveryVehicle.builder()
                                .callSign("FALCO")
                                .primaryFreq(34.55)
                                .strength(5)
                                .type("C17")
                ...
                .numPersons(1)
                .objectiveAreaInfo(
                    PersonnelRecoveryFullL.ObjectiveAreaInfo.builder()
                        .addEnemyData(
                            PersonnelRecoveryFullL.ObjectiveAreaInfo.EnemyData.builder()
        ...
        assertThat(personnelRecoveryFullL.dataMode())
            .isEqualTo(PersonnelRecoveryFullL.DataMode.TEST)
        assertThat(personnelRecoveryFullL.msgTime())
        ...
        assertThat(personnelRecoveryFullL.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(personnelRecoveryFullL.createdBy()).contains("some.user")
        assertThat(personnelRecoveryFullL.executionInfo())
            .contains(
                PersonnelRecoveryFullL.ExecutionInfo.builder()
                    .egress(66.53)
                    .addEgressPoint(107.23)
        ...
        assertThat(personnelRecoveryFullL.objectiveAreaInfo())
            .contains(
                PersonnelRecoveryFullL.ObjectiveAreaInfo.builder()
                    .addEnemyData(
                        PersonnelRecoveryFullL.ObjectiveAreaInfo.EnemyData.builder()
        ...
        assertThat(personnelRecoveryFullL.origNetwork()).contains("OPS1")
        ...
        assertThat(personnelRecoveryFullL.survivorMessages())
    ...
    fun roundtrip() {
        ...
        val roundtrippedPersonnelRecoveryFullL =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(personnelRecoveryFullL),
                jacksonTypeRef<PersonnelRecoveryFullL>(),
            )
