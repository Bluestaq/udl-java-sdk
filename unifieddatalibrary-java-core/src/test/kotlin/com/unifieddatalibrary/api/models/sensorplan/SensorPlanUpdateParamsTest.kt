...
internal class SensorPlanUpdateParamsTest {
    ...
    fun create() {
      SensorPlanUpdateParams.builder()
          ...
          .addCollectRequest(SensorPlanUpdateParams.CollectRequest.builder()
              .classificationMarking("U")
              ...
              .eccentricity(1.1)
              .el(1.1)
              .elset(SensorPlanUpdateParams.CollectRequest.Elset.builder()
                  .classificationMarking("U")
                  ...
                  .addSourcedDataType(SensorPlanUpdateParams.CollectRequest.Elset.SourcedDataType.RADAR)
                  .addSourcedDataType(SensorPlanUpdateParams.CollectRequest.Elset.SourcedDataType.RF)
                  .sourceDl("AXE")
              ...
              .srchInc(1.1)
              .srchPattern("SCAN")
              .stateVector(SensorPlanUpdateParams.CollectRequest.StateVector.builder()
                  .classificationMarking("U")
                  .dataMode(SensorPlanUpdateParams.CollectRequest.StateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(SensorPlanUpdateParams.CollectRequest.StateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(SensorPlanUpdateParams.CollectRequest.StateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(SensorPlanUpdateParams.CollectRequest.StateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
    ...
    @Test
    fun pathParams() {
      val params = SensorPlanUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(SensorPlanUpdateParams.DataMode.TEST)
          .recType("COLLECT")
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(SensorPlanUpdateParams.DataMode.TEST)
      ...
      assertThat(body.bodyId()).contains("SENSORPLAN-ID")
      assertThat(body.collectRequests().getOrNull()).containsExactly(SensorPlanUpdateParams.CollectRequest.builder()
          .classificationMarking("U")
          .dataMode(SensorPlanUpdateParams.CollectRequest.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
