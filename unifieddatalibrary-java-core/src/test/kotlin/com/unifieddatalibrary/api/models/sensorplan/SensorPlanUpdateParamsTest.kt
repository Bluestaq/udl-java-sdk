                ...
                SensorPlanUpdateParams.CollectRequest.builder()
                    ...
                    .elset(
                        SensorPlanUpdateParams.CollectRequest.Elset.builder()
                            ...
                            .addSourcedDataType(
                                SensorPlanUpdateParams.CollectRequest.Elset.SourcedDataType.RADAR
                            )
                            .addSourcedDataType(
                    ...
                    .stateVector(
                        SensorPlanUpdateParams.CollectRequest.StateVector.builder()
                            ...
                            .covReferenceFrame(
                                SensorPlanUpdateParams.CollectRequest.StateVector.CovReferenceFrame
                                    .J2000
                            )
                            .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                            .createdBy("some.user")
                            ...
                            .addSourcedDataType(
                                SensorPlanUpdateParams.CollectRequest.StateVector.SourcedDataType
                                    .RADAR
                            )
                            .sourceDl("AXE")
                            .srpArea(4.311)
