...
internal class SeradataSpacecraftDetailListResponseTest {
    ...
    @Test
    fun create() {
      val seradataSpacecraftDetailListResponse = SeradataSpacecraftDetailListResponse.builder()
      ...
      assertThat(seradataSpacecraftDetailListResponse.dataMode()).isEqualTo(SeradataSpacecraftDetailListResponse.DataMode.TEST)
      ...
      assertThat(seradataSpacecraftDetailListResponse.id()).contains("SERADATASPACECRAFTDETAILS-ID")
      assertThat(seradataSpacecraftDetailListResponse.additionalMissionsGroups()).contains("additionalMissionsGroups")
      assertThat(seradataSpacecraftDetailListResponse.altitude()).contains(36036.6330576414)
      assertThat(seradataSpacecraftDetailListResponse.annualInsuredDepreciationFactor()).contains(1.23)
      assertThat(seradataSpacecraftDetailListResponse.annualInsuredDepreciationFactorEstimated()).contains(true)
      ...
      assertThat(seradataSpacecraftDetailListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(seradataSpacecraftDetailListResponse.createdBy()).contains("some.user")
      assertThat(seradataSpacecraftDetailListResponse.cubesatDispenserType()).contains("cubesatDispenserType")
      assertThat(seradataSpacecraftDetailListResponse.currentAge()).contains(5.898630136986301)
      assertThat(seradataSpacecraftDetailListResponse.dateOfObservation()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(seradataSpacecraftDetailListResponse.insurancePremiumAtLaunchEstimated()).contains(true)
      ...
      assertThat(seradataSpacecraftDetailListResponse.insuredValueLaunchEstimated()).contains(true)
      ...
      assertThat(seradataSpacecraftDetailListResponse.launchCharacteristic()).contains("Expendable")
      ...
      assertThat(seradataSpacecraftDetailListResponse.launchDate()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(seradataSpacecraftDetailListResponse.launchDateRemarks()).contains("launchDateRemarks")
      ...
      assertThat(seradataSpacecraftDetailListResponse.launchProviderFlightNumber()).contains("launchProviderFlightNumber")
      ...
      assertThat(seradataSpacecraftDetailListResponse.massCategory()).contains("2500 - 3500kg  - Large Satellite")
      ...
      assertThat(seradataSpacecraftDetailListResponse.orbitSubCategory()).contains("Geostationary")
      assertThat(seradataSpacecraftDetailListResponse.orderDate()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(seradataSpacecraftDetailListResponse.primaryMissionGroup()).contains("primaryMissionGroup")
      assertThat(seradataSpacecraftDetailListResponse.primeManufacturerOrgId()).contains("05c43360-382e-4aa2-b875-ed28945ff2e5")
      ...
      assertThat(seradataSpacecraftDetailListResponse.reusableFlights()).contains("reusableFlights")
      ...
      assertThat(seradataSpacecraftDetailListResponse.youtubeLaunchLink()).contains("youtubeLaunchLink")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSeradataSpacecraftDetailListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(seradataSpacecraftDetailListResponse), jacksonTypeRef<SeradataSpacecraftDetailListResponse>())

      assertThat(roundtrippedSeradataSpacecraftDetailListResponse).isEqualTo(seradataSpacecraftDetailListResponse)
    }
}
