...
internal class OrbitdeterminationCreateParamsTest {
        ...
        OrbitdeterminationCreateParams.builder()
            ...
            .aprioriStateVector(
                OrbitdeterminationCreateParams.AprioriStateVector.builder()
                    ...
                    .covReferenceFrame(
                        OrbitdeterminationCreateParams.AprioriStateVector.CovReferenceFrame.J2000
                    )
                    .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                    .createdBy("some.user")
    ...
    fun body() {
        ...
        assertThat(body.acceptedObIds().getOrNull())
        ...
        assertThat(body.aprioriStateVector())
            .contains(
                OrbitdeterminationCreateParams.AprioriStateVector.builder()
                    .classificationMarking("U")
                    .dataMode(OrbitdeterminationCreateParams.AprioriStateVector.DataMode.TEST)
        ...
        assertThat(body.effectiveFrom())
            .contains(OffsetDateTime.parse("2023-08-28T11:20:21.247192Z"))
        assertThat(body.effectiveUntil())
        ...
        assertThat(body.rejectedObIds().getOrNull())
