...
internal class OnorbitantennaListResponseTest {
    ...
    @Test
    fun create() {
      val onorbitantennaListResponse = OnorbitantennaListResponse.builder()
          ...
          .antenna(AntennaAbridged.builder()
      ...
      assertThat(onorbitantennaListResponse.dataMode()).isEqualTo(OnorbitantennaListResponse.DataMode.TEST)
      ...
      assertThat(onorbitantennaListResponse.antenna()).contains(AntennaAbridged.builder()
          .dataMode(AntennaAbridged.DataMode.TEST)
          .name("IRIDIUM NEXT 121-ANTENNA-10075")
          .source("Bluestaq")
          .id("ANTENNA-ID")
          ...
          .origNetwork("ORIG")
          .build())
      assertThat(onorbitantennaListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedOnorbitantennaListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(onorbitantennaListResponse), jacksonTypeRef<OnorbitantennaListResponse>())
