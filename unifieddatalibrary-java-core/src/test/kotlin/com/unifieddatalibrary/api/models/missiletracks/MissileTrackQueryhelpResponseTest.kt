...
internal class MissileTrackQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val missileTrackQueryhelpResponse = MissileTrackQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(missileTrackQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(missileTrackQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(missileTrackQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedMissileTrackQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(missileTrackQueryhelpResponse), jacksonTypeRef<MissileTrackQueryhelpResponse>())

      assertThat(roundtrippedMissileTrackQueryhelpResponse).isEqualTo(missileTrackQueryhelpResponse)
    }
}
