...
internal class AirspacecontrolorderAbridgedTest {
    ...
    @Test
    fun create() {
      val airspacecontrolorderAbridged = AirspacecontrolorderAbridged.builder()
          ...
          .acoSerialNum("27B")
          .addAirspaceControlMeansStatus(AirspacecontrolorderAbridged.AirspaceControlMeansStatus.builder()
              .addAirspaceControlMean(AirspacecontrolorderAbridged.AirspaceControlMeansStatus.AirspaceControlMean.builder()
                  .addAirspaceControlPoint(AirspacecontrolorderAbridged.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceControlPoint.builder()
                      .ctrlPtAltitude("BRFL:MSL-FL230")
                      .ctrlPtLocation("203632N0594256E")
                      .ctrlPtName("APPLE")
                      .ctrlPtType("CP")
                      .build())
                  .addAirspaceTimePeriod(AirspacecontrolorderAbridged.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceTimePeriod.builder()
                      .addIntDur("65WK")
                      .addIntFreq("WEEKLY")
                  ...
                  .bearing1(160.0)
                  .cmId("DESIG:C34")
                  .cmShape(AirspacecontrolorderAbridged.AirspaceControlMeansStatus.AirspaceControlMean.CmShape.POLYARC)
                  .cmType("cmType")
                  .cntrlAuth("RHEIN MAIN CP")
                  .addCntrlAuthFreq("125.25MHZ")
                  .coord0("152345N0505657E")
                  .coord1("1523N05057E")
                  .corrWayPoints(listOf(
                    "POB",
                    "RDU",
                    "IAD",
                  ))
              ...
              .build())
          .addAirspaceControlOrderReference(AirspacecontrolorderAbridged.AirspaceControlOrderReference.builder()
              .refOriginator("SHAPE")
              .refSerialNum("100")
              .addRefSiC("RCA")
              .addRefSiC("FN:4503B")
      ...
      assertThat(airspacecontrolorderAbridged.dataMode()).isEqualTo(AirspacecontrolorderAbridged.DataMode.TEST)
      ...
      assertThat(airspacecontrolorderAbridged.startTime()).isEqualTo(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
      assertThat(airspacecontrolorderAbridged.id()).contains("c44b0a80-9fef-63d9-6267-79037fb93e4c")
      ...
      assertThat(airspacecontrolorderAbridged.airspaceControlMeansStatus().getOrNull()).containsExactly(AirspacecontrolorderAbridged.AirspaceControlMeansStatus.builder()
          .addAirspaceControlMean(AirspacecontrolorderAbridged.AirspaceControlMeansStatus.AirspaceControlMean.builder()
              .addAirspaceControlPoint(AirspacecontrolorderAbridged.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceControlPoint.builder()
                  .ctrlPtAltitude("BRFL:MSL-FL230")
                  .ctrlPtLocation("203632N0594256E")
          ...
          .build())
      assertThat(airspacecontrolorderAbridged.airspaceControlOrderReferences().getOrNull()).containsExactly(AirspacecontrolorderAbridged.AirspaceControlOrderReference.builder()
          .refOriginator("SHAPE")
          .refSerialNum("100")
          .addRefSiC("RCA")
          .addRefSiC("FN:4503B")
      ...
      assertThat(airspacecontrolorderAbridged.classReasons().getOrNull()).containsExactly("15C", "10C")
      assertThat(airspacecontrolorderAbridged.classSource()).contains("ORIG:USJFCOM")
      assertThat(airspacecontrolorderAbridged.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(airspacecontrolorderAbridged.createdBy()).contains("some.user")
      assertThat(airspacecontrolorderAbridged.declassExemptionCodes().getOrNull()).containsExactly("X1", "X2")
      assertThat(airspacecontrolorderAbridged.downgradeInsDates().getOrNull()).containsExactly("NST:AT EXERCISE ENDEX", "DATE:25NOV1997")
      ...
      assertThat(airspacecontrolorderAbridged.origNetwork()).contains("ORIG")
      ...
      assertThat(airspacecontrolorderAbridged.rawFileUri()).contains("EXAMPLE URI")
      ...
      assertThat(airspacecontrolorderAbridged.stopTime()).contains(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
      assertThat(airspacecontrolorderAbridged.undLnkTrks().getOrNull()).containsExactly("A2467", "A3466", "AA232")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedAirspacecontrolorderAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(airspacecontrolorderAbridged), jacksonTypeRef<AirspacecontrolorderAbridged>())
