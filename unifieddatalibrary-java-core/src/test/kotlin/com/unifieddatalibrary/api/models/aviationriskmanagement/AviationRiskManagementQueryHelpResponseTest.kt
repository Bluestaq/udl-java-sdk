...
internal class AviationRiskManagementQueryHelpResponseTest {
    ...
    @Test
    fun create() {
      val aviationRiskManagementQueryHelpResponse = AviationRiskManagementQueryHelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(aviationRiskManagementQueryHelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(aviationRiskManagementQueryHelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(aviationRiskManagementQueryHelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAviationRiskManagementQueryHelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(aviationRiskManagementQueryHelpResponse), jacksonTypeRef<AviationRiskManagementQueryHelpResponse>())

      assertThat(roundtrippedAviationRiskManagementQueryHelpResponse).isEqualTo(aviationRiskManagementQueryHelpResponse)
    }
}
