...
internal class AircraftStatusUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(AircraftStatusUpdateParams.DataMode.TEST)
        ...
        assertThat(body.airToAirStatus())
            .contains(AircraftStatusUpdateParams.AirToAirStatus.OPERATIONAL)
        assertThat(body.airToGroundStatus())
            .contains(AircraftStatusUpdateParams.AirToGroundStatus.OPERATIONAL)
