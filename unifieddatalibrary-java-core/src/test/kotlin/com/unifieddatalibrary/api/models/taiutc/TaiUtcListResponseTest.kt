...
internal class TaiUtcListResponseTest {
    ...
    @Test
    fun create() {
      val taiUtcListResponse = TaiUtcListResponse.builder()
      ...
      assertThat(taiUtcListResponse.adjustmentDate()).isEqualTo(OffsetDateTime.parse("2017-01-01T00:00:00.123Z"))
      ...
      assertThat(taiUtcListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(taiUtcListResponse.rawFileUri()).contains("/TAI/2019/01/22/4318471007562436-tai-utc.dat")
    ...
    fun roundtrip() {
      ...
      val roundtrippedTaiUtcListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(taiUtcListResponse), jacksonTypeRef<TaiUtcListResponse>())
