...
internal class OrganizationdetailUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(OrganizationdetailUpdateParams.DataMode.TEST)
        ...
        assertThat(body.bodyId()).contains("ORGANIZATIONDETAILS-ID")
