...
internal class DriftHistoryAbridgedTest {
    ...
    @Test
    fun create() {
      val driftHistoryAbridged = DriftHistoryAbridged.builder()
      ...
      assertThat(driftHistoryAbridged.effectiveUntil()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedDriftHistoryAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(driftHistoryAbridged), jacksonTypeRef<DriftHistoryAbridged>())
