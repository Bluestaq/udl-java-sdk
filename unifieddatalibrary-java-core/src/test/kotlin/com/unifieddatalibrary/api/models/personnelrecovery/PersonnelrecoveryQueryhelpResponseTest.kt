...
internal class PersonnelrecoveryQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val personnelrecoveryQueryhelpResponse =
            PersonnelrecoveryQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(personnelrecoveryQueryhelpResponse.classificationMarking())
        ...
        assertThat(personnelrecoveryQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(personnelrecoveryQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedPersonnelrecoveryQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(personnelrecoveryQueryhelpResponse),
                jacksonTypeRef<PersonnelrecoveryQueryhelpResponse>(),
            )

        assertThat(roundtrippedPersonnelrecoveryQueryhelpResponse)
            .isEqualTo(personnelrecoveryQueryhelpResponse)
    }
}
