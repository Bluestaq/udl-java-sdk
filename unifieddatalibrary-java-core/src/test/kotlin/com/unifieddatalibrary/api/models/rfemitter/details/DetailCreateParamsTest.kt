...
internal class DetailCreateParamsTest {
                ...
                DetailCreateParams.Ttp.builder()
                    ...
                    .addTechniqueDefinition(
                        DetailCreateParams.Ttp.TechniqueDefinition.builder()
                            .name("SIGNAL TUNE")
                            .addParamDefinition(
                                DetailCreateParams.Ttp.TechniqueDefinition.ParamDefinition.builder()
                                    .defaultValue("444.0")
                                    .max(1000.1)
                                    .min(0.1)
                                    .name("CENTER_FREQ")
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(DetailCreateParams.DataMode.TEST)
