...
internal class FileDataTest {
    ...
    fun create() {
      ...
      assertThat(fileData.attributes()).contains(FileData.Attributes.builder()
          .id("id")
          .classification("classification")
          .classificationMarking("classificationMarking")
          .createdBy("createdBy")
    ...
    fun roundtrip() {
      ...
      val roundtrippedFileData = jsonMapper.readValue(jsonMapper.writeValueAsString(fileData), jacksonTypeRef<FileData>())
