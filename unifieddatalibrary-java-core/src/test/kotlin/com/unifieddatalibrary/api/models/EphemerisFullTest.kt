...
internal class EphemerisFullTest {
    ...
    fun create() {
        ...
        assertThat(ephemerisFull.createdAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedEphemerisFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(ephemerisFull),
                jacksonTypeRef<EphemerisFull>(),
            )
