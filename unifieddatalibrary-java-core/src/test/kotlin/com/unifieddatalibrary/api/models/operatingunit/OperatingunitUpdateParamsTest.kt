...
internal class OperatingunitUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = OperatingunitUpdateParams.builder()
          .id("id")
          .classificationMarking("U")
          .dataMode(OperatingunitUpdateParams.DataMode.TEST)
          .name("SOME_NAME")
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(OperatingunitUpdateParams.DataMode.TEST)
