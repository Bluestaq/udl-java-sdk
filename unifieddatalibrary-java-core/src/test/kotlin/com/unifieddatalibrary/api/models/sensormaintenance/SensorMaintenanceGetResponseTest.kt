...
internal class SensorMaintenanceGetResponseTest {
    ...
    @Test
    fun create() {
      val sensorMaintenanceGetResponse = SensorMaintenanceGetResponse.builder()
      ...
      assertThat(sensorMaintenanceGetResponse.dataMode()).isEqualTo(SensorMaintenanceGetResponse.DataMode.TEST)
      assertThat(sensorMaintenanceGetResponse.endTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(sensorMaintenanceGetResponse.startTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(sensorMaintenanceGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(sensorMaintenanceGetResponse.inactiveDate()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(sensorMaintenanceGetResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSensorMaintenanceGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sensorMaintenanceGetResponse), jacksonTypeRef<SensorMaintenanceGetResponse>())
