...
internal class ManifoldelsetQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val manifoldelsetQueryhelpResponse = ManifoldelsetQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(manifoldelsetQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(manifoldelsetQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(manifoldelsetQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedManifoldelsetQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(manifoldelsetQueryhelpResponse), jacksonTypeRef<ManifoldelsetQueryhelpResponse>())

      assertThat(roundtrippedManifoldelsetQueryhelpResponse).isEqualTo(manifoldelsetQueryhelpResponse)
    }
}
