...
internal class BatteryQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val batteryQueryhelpResponse =
            BatteryQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(batteryQueryhelpResponse.classificationMarking())
        ...
        assertThat(batteryQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatteryQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batteryQueryhelpResponse),
                jacksonTypeRef<BatteryQueryhelpResponse>(),
            )
