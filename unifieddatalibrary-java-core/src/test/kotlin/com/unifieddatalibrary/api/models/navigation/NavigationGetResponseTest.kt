...
internal class NavigationGetResponseTest {

    @Test
    fun create() {
      val navigationGetResponse = NavigationGetResponse.builder()
          .classificationMarking("U")
          .dataMode(NavigationGetResponse.DataMode.TEST)
          .name("NAME")
          .source("Bluestaq")
          .id("NAVIGATION-ID")
      ...
      assertThat(navigationGetResponse.classificationMarking()).isEqualTo("U")
      assertThat(navigationGetResponse.dataMode()).isEqualTo(NavigationGetResponse.DataMode.TEST)
      assertThat(navigationGetResponse.name()).isEqualTo("NAME")
      assertThat(navigationGetResponse.source()).isEqualTo("Bluestaq")
      assertThat(navigationGetResponse.id()).contains("NAVIGATION-ID")
      assertThat(navigationGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(navigationGetResponse.createdBy()).contains("some.user")
      assertThat(navigationGetResponse.description()).contains("DESCRIPTION")
      assertThat(navigationGetResponse.entity()).contains(EntityFull.builder()
          .classificationMarking("U")
          .dataMode(EntityFull.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
          ...
          .addUrl("URL2")
          .build())
      assertThat(navigationGetResponse.idEntity()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
      assertThat(navigationGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(navigationGetResponse.origNetwork()).contains("ORIG")
      assertThat(navigationGetResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(navigationGetResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedNavigationGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(navigationGetResponse), jacksonTypeRef<NavigationGetResponse>())

      assertThat(roundtrippedNavigationGetResponse).isEqualTo(navigationGetResponse)
    }
}
