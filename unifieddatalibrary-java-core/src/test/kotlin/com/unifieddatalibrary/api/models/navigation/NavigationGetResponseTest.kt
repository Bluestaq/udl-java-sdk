...
internal class NavigationGetResponseTest {
    ...
    @Test
    fun create() {
        val navigationGetResponse =
            NavigationGetResponse.builder()
        ...
        assertThat(navigationGetResponse.createdAt())
        ...
        assertThat(navigationGetResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(navigationGetResponse.idEntity())
            .contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
        assertThat(navigationGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(navigationGetResponse.origNetwork()).contains("OPS1")
        assertThat(navigationGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedNavigationGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(navigationGetResponse),
                jacksonTypeRef<NavigationGetResponse>(),
            )
