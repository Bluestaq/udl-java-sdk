...
internal class SarObservationListResponseTest {
    ...
    @Test
    fun create() {
        val sarObservationListResponse =
            SarObservationListResponse.builder()
        ...
        assertThat(sarObservationListResponse.collectionEnd())
            .isEqualTo(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
        assertThat(sarObservationListResponse.collectionStart())
            .isEqualTo(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
        assertThat(sarObservationListResponse.dataMode())
            .isEqualTo(SarObservationListResponse.DataMode.TEST)
        ...
        assertThat(sarObservationListResponse.centerTime())
        ...
        assertThat(sarObservationListResponse.detectionStart())
        ...
        assertThat(sarObservationListResponse.srcIds().getOrNull())
            .containsExactly(
                "f7e01cd4-626b-441f-a423-17b160eb78ba",
                "223833c4-be0d-4fdb-a2e4-325a48eccced",
            )
        assertThat(sarObservationListResponse.srcTyps().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSarObservationListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sarObservationListResponse),
                jacksonTypeRef<SarObservationListResponse>(),
            )
