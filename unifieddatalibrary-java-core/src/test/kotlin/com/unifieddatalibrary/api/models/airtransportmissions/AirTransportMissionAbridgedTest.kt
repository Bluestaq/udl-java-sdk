...
internal class AirTransportMissionAbridgedTest {
    ...
    @Test
    fun create() {
        val airTransportMissionAbridged =
            AirTransportMissionAbridged.builder()
                ...
                .addHazMat(
                    AirTransportMissionAbridged.HazMat.builder()
                ...
                .addRemark(
                    AirTransportMissionAbridged.Remark.builder()
                ...
                .addRequirement(
                    AirTransportMissionAbridged.Requirement.builder()
                        .bulkWeight(1.3)
        ...
        assertThat(airTransportMissionAbridged.dataMode())
            .isEqualTo(AirTransportMissionAbridged.DataMode.TEST)
        assertThat(airTransportMissionAbridged.source()).isEqualTo("Bluestaq")
        assertThat(airTransportMissionAbridged.id())
            .contains("bdad6945-c9e4-b829-f7be-1ad075541921")
        ...
        assertThat(airTransportMissionAbridged.createdAt())
        ...
        assertThat(airTransportMissionAbridged.gdssMissionId())
            .contains("1e6edeec-72e9-aaec-d33c-51147cb5ffdd")
        assertThat(airTransportMissionAbridged.hazMat().getOrNull())
            .containsExactly(
                AirTransportMissionAbridged.HazMat.builder()
                    .applicableNotes("11,12")
                    .cgc("A")
        ...
        assertThat(airTransportMissionAbridged.nextMissionId())
        ...
        assertThat(airTransportMissionAbridged.origMissionId())
        ...
        assertThat(airTransportMissionAbridged.prevMissionId())
            .contains("a77055df-edc3-4047-a5fa-604f80b9fe3c")
        assertThat(airTransportMissionAbridged.purpose())
            .contains(
                "People at island X need water ASAP. Two previous attempts failed due to weather."
            )
        assertThat(airTransportMissionAbridged.remarks().getOrNull())
            .containsExactly(
                AirTransportMissionAbridged.Remark.builder()
                    .date(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
                    .gdssRemarkId("GDSSREMARK-ID")
        ...
        assertThat(airTransportMissionAbridged.requirements().getOrNull())
            .containsExactly(
                AirTransportMissionAbridged.Requirement.builder()
                    .bulkWeight(1.3)
                    .ead(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
        ...
        assertThat(airTransportMissionAbridged.updatedAt())
            .contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedAirTransportMissionAbridged =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(airTransportMissionAbridged),
                jacksonTypeRef<AirTransportMissionAbridged>(),
            )
