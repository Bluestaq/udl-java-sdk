...
internal class EphemerisSetCreateParamsTest {
    ...
    fun create() {
      EphemerisSetCreateParams.builder()
          ...
          .dragModel("JAC70")
          .edr(1.1)
          .addEphemerisList(EphemerisSetCreateParams.EphemerisList.builder()
              .classificationMarking("U")
    ...
    @Test
    fun body() {
      val params = EphemerisSetCreateParams.builder()
          .category("ANALYST")
          .classificationMarking("U")
          .dataMode(EphemerisSetCreateParams.DataMode.TEST)
          .numPoints(1)
      ...
      assertThat(body.dataMode()).isEqualTo(EphemerisSetCreateParams.DataMode.TEST)
      assertThat(body.numPoints()).isEqualTo(1)
      assertThat(body.pointEndTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(body.pointStartTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(body.covReferenceFrame()).contains(EphemerisSetCreateParams.CovReferenceFrame.J2000)
      ...
      assertThat(body.ephemerisList().getOrNull()).containsExactly(EphemerisSetCreateParams.EphemerisList.builder()
          .classificationMarking("U")
          .dataMode(EphemerisSetCreateParams.EphemerisList.DataMode.TEST)
          .source("Bluestaq")
          .ts(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(body.referenceFrame()).contains(EphemerisSetCreateParams.ReferenceFrame.J2000)
      ...
      assertThat(body.usableEndTime()).contains(OffsetDateTime.parse("2018-01-01T20:50:00.123456Z"))
      assertThat(body.usableStartTime()).contains(OffsetDateTime.parse("2018-01-01T16:10:00.123456Z"))
    }
