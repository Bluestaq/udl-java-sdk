...
internal class H3GeoGetResponseTest {
    ...
    @Test
    fun create() {
      val h3GeoGetResponse = H3GeoGetResponse.builder()
          .addCell(H3GeoGetResponse.Cell.builder()
      ...
      assertThat(h3GeoGetResponse.cells()).containsExactly(H3GeoGetResponse.Cell.builder()
          .cellId("830b90fffffffff")
          .classificationMarking("U")
          .dataMode(H3GeoGetResponse.Cell.DataMode.TEST)
          .source("Bluestaq")
      ...
      assertThat(h3GeoGetResponse.startTime()).isEqualTo(OffsetDateTime.parse("2024-07-02T00:00:00.123Z"))
      ...
      assertThat(h3GeoGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(h3GeoGetResponse.createdBy()).contains("some.user")
      assertThat(h3GeoGetResponse.endTime()).contains(OffsetDateTime.parse("2024-07-03T00:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedH3GeoGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(h3GeoGetResponse), jacksonTypeRef<H3GeoGetResponse>())
