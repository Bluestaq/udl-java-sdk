...
internal class LaunchVehicleTupleResponseTest {

    @Test
    fun create() {
        val launchVehicleTupleResponse =
            LaunchVehicleTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(LaunchVehicleTupleResponse.DataMode.TEST)
                .name("Example-name")
                .source("Bluestaq")
                .id("LAUNCHVEHICLE-ID")
                ...
                .addLaunchVehicleDetail(
                    LaunchVehicleTupleResponse.LaunchVehicleDetail.builder()
                        .classificationMarking("U")
                        .dataMode(LaunchVehicleTupleResponse.LaunchVehicleDetail.DataMode.TEST)
                ...
                .origNetwork("ORIG")
                .addStage(
                    LaunchVehicleTupleResponse.Stage.builder()
                        .classificationMarking("U")
                        .dataMode(LaunchVehicleTupleResponse.Stage.DataMode.TEST)
                        .idEngine("ENGINE-ID")
                        .idLaunchVehicle("LAUNCHVEHICLE-ID")
                        .source("Bluestaq")
                        .id("STAGE-ID")
        ...
        assertThat(launchVehicleTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(launchVehicleTupleResponse.dataMode())
            .isEqualTo(LaunchVehicleTupleResponse.DataMode.TEST)
        assertThat(launchVehicleTupleResponse.name()).isEqualTo("Example-name")
        assertThat(launchVehicleTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(launchVehicleTupleResponse.id()).contains("LAUNCHVEHICLE-ID")
        assertThat(launchVehicleTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(launchVehicleTupleResponse.createdBy()).contains("some.user")
        assertThat(launchVehicleTupleResponse.launchVehicleDetails().getOrNull())
            .containsExactly(
                LaunchVehicleTupleResponse.LaunchVehicleDetail.builder()
                    .classificationMarking("U")
                    .dataMode(LaunchVehicleTupleResponse.LaunchVehicleDetail.DataMode.TEST)
        ...
        assertThat(launchVehicleTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(launchVehicleTupleResponse.origNetwork()).contains("ORIG")
        assertThat(launchVehicleTupleResponse.stages().getOrNull())
            .containsExactly(
                LaunchVehicleTupleResponse.Stage.builder()
                    .classificationMarking("U")
                    .dataMode(LaunchVehicleTupleResponse.Stage.DataMode.TEST)
        ...
        assertThat(launchVehicleTupleResponse.type()).contains("Example-vehicle-type")
        assertThat(launchVehicleTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(launchVehicleTupleResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedLaunchVehicleTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(launchVehicleTupleResponse),
                jacksonTypeRef<LaunchVehicleTupleResponse>(),
            )

        assertThat(roundtrippedLaunchVehicleTupleResponse).isEqualTo(launchVehicleTupleResponse)
    }
}
