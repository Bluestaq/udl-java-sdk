    ...
    fun create() {
        val trackListResponse =
            TrackListResponse.builder()
                ...
                .covReferenceFrame(TrackListResponse.CovReferenceFrame.ECR_ECEF)
        ...
        assertThat(trackListResponse.covReferenceFrame())
            .contains(TrackListResponse.CovReferenceFrame.ECR_ECEF)
        ...
        assertThat(trackListResponse.grndSpd()).contains(60.23)
