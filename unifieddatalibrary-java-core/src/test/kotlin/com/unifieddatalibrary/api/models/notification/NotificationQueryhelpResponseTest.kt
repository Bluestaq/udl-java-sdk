...
internal class NotificationQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val notificationQueryhelpResponse =
            NotificationQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(notificationQueryhelpResponse.classificationMarking())
        ...
        assertThat(notificationQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(notificationQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedNotificationQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(notificationQueryhelpResponse),
                jacksonTypeRef<NotificationQueryhelpResponse>(),
            )

        assertThat(roundtrippedNotificationQueryhelpResponse)
            .isEqualTo(notificationQueryhelpResponse)
    }
}
