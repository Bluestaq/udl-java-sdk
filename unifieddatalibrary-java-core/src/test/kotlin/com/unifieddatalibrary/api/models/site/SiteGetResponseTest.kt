...
internal class SiteGetResponseTest {

    @Test
    fun create() {
        val siteGetResponse =
            SiteGetResponse.builder()
                .classificationMarking("U")
                .dataMode(SiteGetResponse.DataMode.TEST)
                .name("Site Name")
                .source("Bluestaq")
                .id("SITE-ID")
                .activity("OCC")
                ...
                .runways(5L)
                .addSiteOperation(
                    SiteGetResponse.SiteOperation.builder()
                        .classificationMarking("U")
                        .dataMode(SiteGetResponse.SiteOperation.DataMode.TEST)
                ...
                .addSiteRemark(
                    SiteGetResponse.SiteRemark.builder()
                        .classificationMarking("U")
                        .dataMode(SiteGetResponse.SiteRemark.DataMode.TEST)
                        .idSite("SITE-ID")
                        .source("Bluestaq")
                        .text("This is a remark")
        ...
        assertThat(siteGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(siteGetResponse.dataMode()).isEqualTo(SiteGetResponse.DataMode.TEST)
        assertThat(siteGetResponse.name()).isEqualTo("Site Name")
        assertThat(siteGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(siteGetResponse.id()).contains("SITE-ID")
        assertThat(siteGetResponse.activity()).contains("OCC")
        assertThat(siteGetResponse.airDefArea()).contains("AL006")
        assertThat(siteGetResponse.allegiance()).contains("OTHR")
        assertThat(siteGetResponse.altAllegiance()).contains("HL")
        assertThat(siteGetResponse.beNumber()).contains("0427RT1030")
        assertThat(siteGetResponse.catCode()).contains("20345")
        assertThat(siteGetResponse.catText()).contains("Radar Facility, General")
        assertThat(siteGetResponse.classRating()).contains("1")
        assertThat(siteGetResponse.condition()).contains("RDY")
        assertThat(siteGetResponse.conditionAvail()).contains("A")
        assertThat(siteGetResponse.coord()).contains("340000000N0430000000E")
        assertThat(siteGetResponse.coordDatum()).contains("WGS")
        assertThat(siteGetResponse.coordDerivAcc()).contains(12.345)
        assertThat(siteGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(siteGetResponse.createdBy()).contains("some.user")
        assertThat(siteGetResponse.elevMsl()).contains(123.45)
        assertThat(siteGetResponse.elevMslConfLvl()).contains(50)
        assertThat(siteGetResponse.elevMslDerivAcc()).contains(12.34)
        assertThat(siteGetResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(siteGetResponse.eval()).contains(7)
        assertThat(siteGetResponse.faa()).contains("FAA1")
        assertThat(siteGetResponse.fpa()).contains("EOB")
        assertThat(siteGetResponse.functPrimary()).contains("JG")
        assertThat(siteGetResponse.geoArea()).contains("E2")
        assertThat(siteGetResponse.geoidalMslSep()).contains(12.34)
        assertThat(siteGetResponse.grade()).contains(5)
        assertThat(siteGetResponse.iata()).contains("AAA")
        assertThat(siteGetResponse.icao()).contains("ICA1")
        assertThat(siteGetResponse.ident()).contains("FRIEND")
        assertThat(siteGetResponse.idEntity()).contains("ENTITY-ID")
        assertThat(siteGetResponse.idParentSite()).contains("ID-Parent-Site")
        assertThat(siteGetResponse.lzUsage()).contains("AF")
        assertThat(siteGetResponse.maxRunwayLength()).contains(1000)
        assertThat(siteGetResponse.milGrid()).contains("4QFJ12345678")
        assertThat(siteGetResponse.milGridSys()).contains("UTM")
        assertThat(siteGetResponse.msnPrimary()).contains("AA")
        assertThat(siteGetResponse.msnPrimarySpec()).contains("AB")
        assertThat(siteGetResponse.notes()).contains("Example Notes")
        assertThat(siteGetResponse.nucCap()).contains("A")
        assertThat(siteGetResponse.operStatus()).contains("OPR")
        assertThat(siteGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(siteGetResponse.origLzId()).contains("ORIG-LZ-ID")
        assertThat(siteGetResponse.origNetwork()).contains("OPS1")
        assertThat(siteGetResponse.origSiteId()).contains("ORIG-SITE-ID")
        assertThat(siteGetResponse.osuffix()).contains("BB002")
        assertThat(siteGetResponse.pin()).contains("25200")
        assertThat(siteGetResponse.polSubdiv()).contains("IZO7")
        assertThat(siteGetResponse.popArea()).contains(true)
        assertThat(siteGetResponse.popAreaProx()).contains(12.345)
        assertThat(siteGetResponse.recStatus()).contains("A")
        assertThat(siteGetResponse.referenceDoc()).contains("Provider Reference Documentation")
        assertThat(siteGetResponse.resProd()).contains("RT")
        assertThat(siteGetResponse.reviewDate()).contains(LocalDate.parse("2008-06-10"))
        assertThat(siteGetResponse.runways()).contains(5L)
        assertThat(siteGetResponse.siteOperations().getOrNull())
            .containsExactly(
                SiteGetResponse.SiteOperation.builder()
                    .classificationMarking("U")
                    .dataMode(SiteGetResponse.SiteOperation.DataMode.TEST)
        ...
        assertThat(siteGetResponse.siteRemarks().getOrNull())
            .containsExactly(
                SiteGetResponse.SiteRemark.builder()
                    .classificationMarking("U")
                    .dataMode(SiteGetResponse.SiteRemark.DataMode.TEST)
        ...
        assertThat(siteGetResponse.symCode()).contains("SOGPU----------")
        assertThat(siteGetResponse.type()).contains("AIRBASE")
        assertThat(siteGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(siteGetResponse.updatedBy()).contains("some.user")
        assertThat(siteGetResponse.usage()).contains("MILITARY")
        assertThat(siteGetResponse.utm()).contains("19P4390691376966")
        assertThat(siteGetResponse.vegHt()).contains(3.0)
        assertThat(siteGetResponse.vegType()).contains("FR")
        assertThat(siteGetResponse.wac()).contains("0427")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSiteGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(siteGetResponse),
                jacksonTypeRef<SiteGetResponse>(),
            )

        assertThat(roundtrippedSiteGetResponse).isEqualTo(siteGetResponse)
    }
}
