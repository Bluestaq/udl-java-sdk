...
internal class CommFullTest {
    ...
    fun create() {
        val commFull =
            CommFull.builder()
                ...
                .dataMode(CommFull.DataMode.TEST)
                ...
                .origNetwork("ORIG")
                .addTransponder(
                    CommFull.Transponder.builder()
                        .classificationMarking("U")
                        .dataMode(CommFull.Transponder.DataMode.TEST)
                        .idComm("REF-COMM-ID")
                        .source("Bluestaq")
                        .id("TRANSPONDER-ID")
                        .addChannel(
        ...
        assertThat(commFull.classificationMarking()).isEqualTo("U")
        assertThat(commFull.dataMode()).isEqualTo(CommFull.DataMode.TEST)
        assertThat(commFull.name()).isEqualTo("DSCS II C-7-COMM Payload")
        assertThat(commFull.source()).isEqualTo("Bluestaq")
        assertThat(commFull.id()).contains("COMM-ID")
        assertThat(commFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(commFull.createdBy()).contains("some.user")
        assertThat(commFull.description()).contains("Description for comm A")
        assertThat(commFull.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(commFull.idEntity()).contains("ENTITY-ID")
        assertThat(commFull.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(commFull.origNetwork()).contains("ORIG")
        assertThat(commFull.transponders().getOrNull())
            .containsExactly(
                CommFull.Transponder.builder()
                    .classificationMarking("U")
                    .dataMode(CommFull.Transponder.DataMode.TEST)
        ...
        assertThat(commFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(commFull.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCommFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(commFull),
                jacksonTypeRef<CommFull>(),
            )

        assertThat(roundtrippedCommFull).isEqualTo(commFull)
    }
}
