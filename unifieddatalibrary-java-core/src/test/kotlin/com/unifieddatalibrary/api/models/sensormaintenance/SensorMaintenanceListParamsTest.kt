...
internal class SensorMaintenanceListParamsTest {

    @Test
    fun create() {
      SensorMaintenanceListParams.builder()
    ...
    @Test
    fun queryParams() {
      val params = SensorMaintenanceListParams.builder()
          .endTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .firstResult(0L)
          .maxResults(0L)
          .startTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun queryParamsWithoutOptionalFields() {
      val params = SensorMaintenanceListParams.builder().build()
