...
internal class TaiUtcQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val taiUtcQueryhelpResponse = TaiUtcQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(taiUtcQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(taiUtcQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedTaiUtcQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(taiUtcQueryhelpResponse), jacksonTypeRef<TaiUtcQueryhelpResponse>())
