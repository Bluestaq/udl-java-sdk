...
internal class SwirListResponseTest {
    ...
    @Test
    fun create() {
        val swirListResponse =
            SwirListResponse.builder()
        ...
        assertThat(swirListResponse.ts())
        ...
        assertThat(swirListResponse.createdAt())
        ...
        assertThat(swirListResponse.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedSwirListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(swirListResponse),
                jacksonTypeRef<SwirListResponse>(),
            )
