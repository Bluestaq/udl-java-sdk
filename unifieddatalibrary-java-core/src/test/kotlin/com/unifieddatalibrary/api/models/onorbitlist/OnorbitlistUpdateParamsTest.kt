...
internal class OnorbitlistUpdateParamsTest {
    ...
    fun pathParams() {
        val params =
            OnorbitlistUpdateParams.builder()
                ...
                .dataMode(OnorbitlistUpdateParams.DataMode.TEST)
                .name("HRR-SATELLITES")
                .addOnOrbitListItem(OnorbitlistUpdateParams.OnOrbitListItem.builder().build())
                .source("Bluestaq")
                .build()
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(OnorbitlistUpdateParams.DataMode.TEST)
        ...
        assertThat(body.bodyId()).contains("ONORBITLIST-ID")
    ...
    fun bodyWithoutOptionalFields() {
        ...
        assertThat(body.name()).isEqualTo("HRR-SATELLITES")
        assertThat(body.onOrbitListItems())
            .containsExactly(OnorbitlistUpdateParams.OnOrbitListItem.builder().build())
        assertThat(body.source()).isEqualTo("Bluestaq")
    }
}
