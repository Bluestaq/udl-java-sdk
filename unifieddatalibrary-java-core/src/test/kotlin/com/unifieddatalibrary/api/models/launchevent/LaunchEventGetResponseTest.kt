...
internal class LaunchEventGetResponseTest {

    @Test
    fun create() {
        val launchEventGetResponse =
            LaunchEventGetResponse.builder()
                .classificationMarking("U")
                .dataMode(LaunchEventGetResponse.DataMode.TEST)
        ...
        assertThat(launchEventGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(launchEventGetResponse.dataMode())
            .isEqualTo(LaunchEventGetResponse.DataMode.TEST)
        assertThat(launchEventGetResponse.msgCreateDate())
            .isEqualTo(OffsetDateTime.parse("2020-01-01T00:00:00.123Z"))
        assertThat(launchEventGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(launchEventGetResponse.id()).contains("LAUNCHEVENT-ID")
        assertThat(launchEventGetResponse.beNumber()).contains("ENC-123")
        assertThat(launchEventGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(launchEventGetResponse.createdBy()).contains("some.user")
        assertThat(launchEventGetResponse.declassificationDate())
            .contains(OffsetDateTime.parse("2021-01-01T01:02:02.123Z"))
        assertThat(launchEventGetResponse.declassificationString())
            .contains("Example Declassification")
        assertThat(launchEventGetResponse.derivedFrom()).contains("Example source")
        assertThat(launchEventGetResponse.idOnOrbit()).contains("REF-ONORBIT-ID")
        assertThat(launchEventGetResponse.launchDate())
            .contains(OffsetDateTime.parse("2020-01-01T00:00:00.123Z"))
        assertThat(launchEventGetResponse.launchFacilityName())
            .contains("Example launch facility name")
        assertThat(launchEventGetResponse.launchFailureCode()).contains("Example failure code")
        assertThat(launchEventGetResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(launchEventGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(launchEventGetResponse.origNetwork()).contains("OPS1")
        assertThat(launchEventGetResponse.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(launchEventGetResponse.oSuffix()).contains("oSuffix")
        assertThat(launchEventGetResponse.satNo()).contains(12)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedLaunchEventGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(launchEventGetResponse),
                jacksonTypeRef<LaunchEventGetResponse>(),
            )

        assertThat(roundtrippedLaunchEventGetResponse).isEqualTo(launchEventGetResponse)
    }
}
