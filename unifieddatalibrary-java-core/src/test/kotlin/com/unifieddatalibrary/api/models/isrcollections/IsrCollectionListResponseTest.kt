...
internal class IsrCollectionListResponseTest {
    ...
    @Test
    fun create() {
      val isrCollectionListResponse = IsrCollectionListResponse.builder()
          .classificationMarking("U")
          .dataMode(IsrCollectionListResponse.DataMode.TEST)
          .source("Bluestaq")
          .id("ISRCOLLECTION-ID")
          .addCollectionRequirement(IsrCollectionListResponse.CollectionRequirement.builder()
              .id("ISCRCOLLECTIONREQUIREMENTS")
              .country("VE")
              .cridNumbers("CRID")
              .criticalTimes(IsrCollectionListResponse.CollectionRequirement.CriticalTimes.builder()
                  ...
                  .build())
              .emphasized(false)
              .exploitationRequirement(IsrCollectionListResponse.CollectionRequirement.ExploitationRequirement.builder()
                  .id("ISRCOLLECTIONEXPLOITATIONREQUIREMENT")
                  .amplification("AMPLIFICATION")
                  .dissemination("EMAILS")
                  .eei("ESSENTIAL_ELEMENTS")
                  .poc(IsrCollectionListResponse.CollectionRequirement.ExploitationRequirement.Poc.builder()
          ...
          .origNetwork("ORIG")
          .addTasking(IsrCollectionListResponse.Tasking.builder()
              .id("ISRCOLLECTIONTASKINGS-ID")
              .collectionPeriods(IsrCollectionListResponse.Tasking.CollectionPeriods.builder()
                  .addActual(IsrCollectionListResponse.Tasking.CollectionPeriods.Actual.builder()
                      .id("ISRCOLLECTIONACTUAL-ID")
                      .start(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                      .stop(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                      .build())
                  .planned(IsrCollectionListResponse.Tasking.CollectionPeriods.Planned.builder()
                      .addAdditional(IsrCollectionListResponse.Tasking.CollectionPeriods.Planned.Additional.builder()
              ...
              .addTaskingCollectionRequirement(IsrCollectionListResponse.Tasking.TaskingCollectionRequirement.builder()
                  .id("ISCRCOLLECTIONREQUIREMENTS")
                  .country("VE")
                  .cridNumbers("CRID")
                  .criticalTimes(IsrCollectionListResponse.Tasking.TaskingCollectionRequirement.CriticalTimes.builder()
                      .earliestImagingTime(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                      .latestImagingTime(OffsetDateTime.parse("2021-01-19T01:11:15.001Z"))
                      .build())
                  .emphasized(false)
                  .exploitationRequirement(IsrCollectionListResponse.Tasking.TaskingCollectionRequirement.ExploitationRequirement.builder()
                      .id("ISRCOLLECTIONEXPLOITATIONREQUIREMENT")
                      .amplification("AMPLIFICATION")
                      .dissemination("EMAILS")
                      .eei("ESSENTIAL_ELEMENTS")
                      .poc(IsrCollectionListResponse.Tasking.TaskingCollectionRequirement.ExploitationRequirement.Poc.builder()
                          .id("ISRCOLLECTIONPOC-ID")
                          .callsign("CALLSIGN")
                          .chatName("CHAT_NAME")
                          .chatSystem("CHAT")
              ...
              .build())
          .addTransit(IsrCollectionListResponse.Transit.builder()
      ...
      assertThat(isrCollectionListResponse.dataMode()).isEqualTo(IsrCollectionListResponse.DataMode.TEST)
      ...
      assertThat(isrCollectionListResponse.collectionRequirements().getOrNull()).containsExactly(IsrCollectionListResponse.CollectionRequirement.builder()
          .id("ISCRCOLLECTIONREQUIREMENTS")
          .country("VE")
          .cridNumbers("CRID")
          .criticalTimes(IsrCollectionListResponse.CollectionRequirement.CriticalTimes.builder()
          ...
          .type("COLLECTION_TYPE")
          .build())
      assertThat(isrCollectionListResponse.createdAt()).contains(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
      ...
      assertThat(isrCollectionListResponse.missionCollectionArea()).contains("Example collection area")
      ...
      assertThat(isrCollectionListResponse.missionId()).contains("myTask-2020-04-23T00:00:00.000Z")
      ...
      assertThat(isrCollectionListResponse.missionSecondaryIntelDiscipline()).contains("Intelligence_2")
      ...
      assertThat(isrCollectionListResponse.origNetwork()).contains("ORIG")
      assertThat(isrCollectionListResponse.taskings().getOrNull()).containsExactly(IsrCollectionListResponse.Tasking.builder()
          .id("ISRCOLLECTIONTASKINGS-ID")
          .collectionPeriods(IsrCollectionListResponse.Tasking.CollectionPeriods.builder()
              .addActual(IsrCollectionListResponse.Tasking.CollectionPeriods.Actual.builder()
                  .id("ISRCOLLECTIONACTUAL-ID")
          ...
          .type(IsrCollectionListResponse.Tasking.Type.DELIBERATE)
          .build())
      assertThat(isrCollectionListResponse.transit().getOrNull()).containsExactly(IsrCollectionListResponse.Transit.builder()
          .id("ISRCOLLECTIONTRANSIT-ID")
          .base("ENVOYS")
          .duration(200.23)
          .build())
      assertThat(isrCollectionListResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedIsrCollectionListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(isrCollectionListResponse), jacksonTypeRef<IsrCollectionListResponse>())
