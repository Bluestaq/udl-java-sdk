...
internal class IrCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = IrCreateParams.builder()
          .classificationMarking("U")
          .dataMode(IrCreateParams.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
      ...
      assertThat(body.dataMode()).isEqualTo(IrCreateParams.DataMode.TEST)
      assertThat(body.name()).isEqualTo("Example name")
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.id()).contains("IR-ID")
