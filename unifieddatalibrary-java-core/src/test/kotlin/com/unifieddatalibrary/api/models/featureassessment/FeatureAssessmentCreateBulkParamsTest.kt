...
internal class FeatureAssessmentCreateBulkParamsTest {

    @Test
    fun create() {
      FeatureAssessmentCreateBulkParams.builder()
          .addBody(FeatureAssessmentCreateBulkParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = FeatureAssessmentCreateBulkParams.builder()
          .addBody(FeatureAssessmentCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(FeatureAssessmentCreateBulkParams.Body.DataMode.TEST)
              .featureTs(OffsetDateTime.parse("2024-06-22T17:53:06.123Z"))
      ...
      assertThat(body).containsExactly(FeatureAssessmentCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(FeatureAssessmentCreateBulkParams.Body.DataMode.TEST)
          .featureTs(OffsetDateTime.parse("2024-06-22T17:53:06.123Z"))
          .featureUoM("MHz")
