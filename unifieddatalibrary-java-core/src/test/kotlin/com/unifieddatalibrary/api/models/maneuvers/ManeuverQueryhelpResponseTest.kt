...
internal class ManeuverQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val maneuverQueryhelpResponse =
            ManeuverQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(maneuverQueryhelpResponse.classificationMarking())
        ...
        assertThat(maneuverQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedManeuverQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(maneuverQueryhelpResponse),
                jacksonTypeRef<ManeuverQueryhelpResponse>(),
            )
