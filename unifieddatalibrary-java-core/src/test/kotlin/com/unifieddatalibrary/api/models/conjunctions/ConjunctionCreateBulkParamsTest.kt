...
internal class ConjunctionCreateBulkParamsTest {
    ...
    fun create() {
      ConjunctionCreateBulkParams.builder()
          .addBody(ConjunctionCreateBulkParams.Body.builder()
              ...
              .stateVector1(ConjunctionCreateBulkParams.Body.StateVector1.builder()
                  .classificationMarking("U")
                  ...
                  .covReferenceFrame(ConjunctionCreateBulkParams.Body.StateVector1.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(ConjunctionCreateBulkParams.Body.StateVector1.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(ConjunctionCreateBulkParams.Body.StateVector1.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
                  ...
                  .build())
              .stateVector2(ConjunctionCreateBulkParams.Body.StateVector2.builder()
                  .classificationMarking("U")
                  ...
                  .covMethod("CALCULATED")
                  .covReferenceFrame(ConjunctionCreateBulkParams.Body.StateVector2.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  .descriptor("descriptor")
                  .dragArea(4.739)
                  ...
                  .rawFileUri("rawFileURI")
                  .recOdSpan(3.5)
                  .referenceFrame(ConjunctionCreateBulkParams.Body.StateVector2.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedData("DATA1")
                  .addSourcedData("DATA2")
                  .addSourcedDataType(ConjunctionCreateBulkParams.Body.StateVector2.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
    ...
    @Test
    fun body() {
      val params = ConjunctionCreateBulkParams.builder()
          .addBody(ConjunctionCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(ConjunctionCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(ConjunctionCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(ConjunctionCreateBulkParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .tca(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
