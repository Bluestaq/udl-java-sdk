...
internal class DataownerAbridgedTest {
    ...
    @Test
    fun create() {
        val dataownerAbridged =
            DataownerAbridged.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedDataownerAbridged =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(dataownerAbridged),
                jacksonTypeRef<DataownerAbridged>(),
            )
