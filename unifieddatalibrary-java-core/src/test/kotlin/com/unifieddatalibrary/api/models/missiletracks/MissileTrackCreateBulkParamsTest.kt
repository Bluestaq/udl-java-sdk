...
internal class MissileTrackCreateBulkParamsTest {
    ...
    fun create() {
      MissileTrackCreateBulkParams.builder()
          .addBody(MissileTrackCreateBulkParams.Body.builder()
              ...
              .trkConf(0.95)
              .trkQual(1)
              .addVector(MissileTrackCreateBulkParams.Body.Vector.builder()
                  ...
                  .covReferenceFrame(MissileTrackCreateBulkParams.Body.Vector.CovReferenceFrame.ECEF)
                  .flightAz(45.23)
    ...
    @Test
    fun body() {
      val params = MissileTrackCreateBulkParams.builder()
          .addBody(MissileTrackCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(MissileTrackCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(MissileTrackCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(MissileTrackCreateBulkParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .ts(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
