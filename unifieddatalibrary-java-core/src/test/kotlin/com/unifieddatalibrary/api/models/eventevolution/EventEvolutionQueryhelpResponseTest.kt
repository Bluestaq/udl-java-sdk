...
internal class EventEvolutionQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val eventEvolutionQueryhelpResponse = EventEvolutionQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(eventEvolutionQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(eventEvolutionQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(eventEvolutionQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedEventEvolutionQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(eventEvolutionQueryhelpResponse), jacksonTypeRef<EventEvolutionQueryhelpResponse>())

      assertThat(roundtrippedEventEvolutionQueryhelpResponse).isEqualTo(eventEvolutionQueryhelpResponse)
    }
}
