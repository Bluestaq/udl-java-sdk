...
internal class VideoQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val videoQueryhelpResponse = VideoQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(videoQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedVideoQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(videoQueryhelpResponse), jacksonTypeRef<VideoQueryhelpResponse>())
