...
internal class HistoryRetrieveResponseTest {
    ...
    @Test
    fun create() {
      val historyRetrieveResponse = HistoryRetrieveResponse.builder()
      ...
      assertThat(historyRetrieveResponse.collectionEnd()).isEqualTo(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
      assertThat(historyRetrieveResponse.collectionStart()).isEqualTo(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
      assertThat(historyRetrieveResponse.dataMode()).isEqualTo(HistoryRetrieveResponse.DataMode.TEST)
      ...
      assertThat(historyRetrieveResponse.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(historyRetrieveResponse.andims()).contains(3)
      assertThat(historyRetrieveResponse.area()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(historyRetrieveResponse.asrid()).contains(3)
      assertThat(historyRetrieveResponse.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(historyRetrieveResponse.centerTime()).contains(OffsetDateTime.parse("2023-04-22T17:36:35.100885Z"))
      ...
      assertThat(historyRetrieveResponse.createdAt()).contains(OffsetDateTime.parse("2023-04-22T17:51:40.854Z"))
      assertThat(historyRetrieveResponse.createdBy()).contains("some.user")
      assertThat(historyRetrieveResponse.detectionEnd()).contains(OffsetDateTime.parse("2023-07-08T17:35:20.772190Z"))
      assertThat(historyRetrieveResponse.detectionId()).contains("DETECTION-ID")
      assertThat(historyRetrieveResponse.detectionStart()).contains(OffsetDateTime.parse("2023-07-08T17:35:01.615396Z"))
      ...
      assertThat(historyRetrieveResponse.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
      ...
      assertThat(historyRetrieveResponse.srcIds().getOrNull()).containsExactly("f7e01cd4-626b-441f-a423-17b160eb78ba", "223833c4-be0d-4fdb-a2e4-325a48eccced")
      assertThat(historyRetrieveResponse.srcTyps().getOrNull()).containsExactly("ESID", "GROUNDIMAGE")
      assertThat(historyRetrieveResponse.swathLength()).contains(12.1)
      assertThat(historyRetrieveResponse.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
    ...
    fun roundtrip() {
      ...
      val roundtrippedHistoryRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(historyRetrieveResponse), jacksonTypeRef<HistoryRetrieveResponse>())
