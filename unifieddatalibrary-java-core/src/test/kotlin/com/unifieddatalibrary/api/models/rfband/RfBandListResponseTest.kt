...
internal class RfBandListResponseTest {
    ...
    @Test
    fun create() {
      val rfBandListResponse = RfBandListResponse.builder()
      ...
      assertThat(rfBandListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfBandListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rfBandListResponse), jacksonTypeRef<RfBandListResponse>())
