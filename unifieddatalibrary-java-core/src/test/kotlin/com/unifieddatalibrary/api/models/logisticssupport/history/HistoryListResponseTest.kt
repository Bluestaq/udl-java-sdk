...
internal class HistoryListResponseTest {
    ...
    fun create() {
        ...
        assertThat(historyListResponse.rptCreatedTime())
            .isEqualTo(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(historyListResponse.source()).isEqualTo("Bluestaq")
        assertThat(historyListResponse.id()).contains("LOGISTICS-SUPPORT-DETAILS UUID")
        assertThat(historyListResponse.aircraftMds()).contains("CO17A")
        assertThat(historyListResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(historyListResponse.createdBy()).contains("some.user")
        assertThat(historyListResponse.currIcao()).contains("KCOS")
        assertThat(historyListResponse.etic())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(historyListResponse.etmc())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(historyListResponse.extSystemId()).contains("GDSSBL012307131347070165")
        assertThat(historyListResponse.logisticAction()).contains("WA")
        assertThat(historyListResponse.logisticsDiscrepancyInfos().getOrNull())
            .containsExactly(
                LogisticsDiscrepancyInfosFull.builder()
                    .closureTime(OffsetDateTime.parse("2023-07-17T10:30:00.123Z"))
                    .discrepancyInfo(
        ...
        assertThat(historyListResponse.logisticsRecordId()).contains("L62017")
        assertThat(historyListResponse.logisticsRemarks().getOrNull())
            .containsExactly(
                LogisticsRemarksFull.builder()
                    .lastChanged(OffsetDateTime.parse("2023-07-17T10:30:00.123Z"))
                    .remark("EXAMPLE REMARK")
        ...
        assertThat(historyListResponse.logisticsSupportItems().getOrNull())
            .containsExactly(
                LogisticsSupportItemsFull.builder()
                    .cannibalized(true)
                    .deployPlanNumber("T89003")
        ...
        assertThat(historyListResponse.logisticsTransportationPlans().getOrNull())
            .containsExactly(
                LogisticsTransportationPlansFull.builder()
                    .actDepTime(OffsetDateTime.parse("2023-07-14T19:37:00.123Z"))
                    .aircraftStatus("NMCMU")
        ...
        assertThat(historyListResponse.maintStatusCode()).contains("NMCMU")
        assertThat(historyListResponse.mcTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(historyListResponse.meTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        ...
        assertThat(historyListResponse.owner()).contains("EXAMPLE_OWNER")
        assertThat(historyListResponse.reopenFlag()).contains(true)
        assertThat(historyListResponse.rptClosedTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(historyListResponse.suppIcao()).contains("KCOS")
        assertThat(historyListResponse.tailNumber()).contains("99290")
