...
internal class CountryCreateParamsTest {
    ...
    fun create() {
      CountryCreateParams.builder()
          ...
          .createdBy("some.user")
          .addDiplomaticClearanceCountryContact(CountryCreateParams.DiplomaticClearanceCountryContact.builder()
              .ahNum("256039858")
              .ahSpdDialCode("75")
              .commNum("904716104")
              .commSpdDialCode("74")
              ...
              .siprNum("546144352")
              .build())
          .addDiplomaticClearanceCountryEntryExitPoint(CountryCreateParams.DiplomaticClearanceCountryEntryExitPoint.builder()
              .isEntry(true)
              .isExit(true)
              .pointName("BATEL")
              .build())
          .addDiplomaticClearanceCountryProfile(CountryCreateParams.DiplomaticClearanceCountryProfile.builder()
    ...
    @Test
    fun body() {
      val params = CountryCreateParams.builder()
          .classificationMarking("U")
          .countryCode("NL")
          .dataMode(CountryCreateParams.DataMode.TEST)
          .lastChangedDate(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      ...
      assertThat(body.diplomaticClearanceCountryContacts().getOrNull()).containsExactly(CountryCreateParams.DiplomaticClearanceCountryContact.builder()
          .ahNum("256039858")
          .ahSpdDialCode("75")
          .commNum("904716104")
          .commSpdDialCode("74")
          ...
          .siprNum("546144352")
          .build())
      assertThat(body.diplomaticClearanceCountryEntryExitPoints().getOrNull()).containsExactly(CountryCreateParams.DiplomaticClearanceCountryEntryExitPoint.builder()
          .isEntry(true)
          .isExit(true)
          .pointName("BATEL")
          .build())
      assertThat(body.diplomaticClearanceCountryProfiles().getOrNull()).containsExactly(CountryCreateParams.DiplomaticClearanceCountryProfile.builder()
          .cargoPaxRemark("Cargo passenger remark")
          .clearanceId("MDCNPER231360050AAR")
          .crewInfoRemark("Crew info remark")
          .defClearanceStatus("R")
