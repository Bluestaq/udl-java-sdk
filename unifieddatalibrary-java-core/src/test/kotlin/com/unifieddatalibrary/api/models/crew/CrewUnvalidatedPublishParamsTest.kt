...
internal class CrewUnvalidatedPublishParamsTest {
    ...
    fun create() {
      CrewUnvalidatedPublishParams.builder()
          .addBody(CrewUnvalidatedPublishParams.Body.builder()
              ...
              .createdBy("some.user")
              .crewHome(false)
              .addCrewMember(CrewUnvalidatedPublishParams.Body.CrewMember.builder()
                  .alerted(true)
                  .allSortie(true)
                  .approved(true)
                  .attached(true)
    ...
    @Test
    fun body() {
      val params = CrewUnvalidatedPublishParams.builder()
          .addBody(CrewUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(CrewUnvalidatedPublishParams.Body.DataMode.TEST)
              .origCrewId("JHJDHjhuu929o92")
      ...
      assertThat(body).containsExactly(CrewUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(CrewUnvalidatedPublishParams.Body.DataMode.TEST)
          .origCrewId("JHJDHjhuu929o92")
          .source("Bluestaq")
