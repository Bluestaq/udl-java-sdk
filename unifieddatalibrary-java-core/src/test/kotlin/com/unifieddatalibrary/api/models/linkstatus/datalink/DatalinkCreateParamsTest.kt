...
internal class DatalinkCreateParamsTest {

    @Test
    fun create() {
      DatalinkCreateParams.builder()
          .datalinkIngest(DatalinkIngest.builder()
    ...
    @Test
    fun body() {
      val params = DatalinkCreateParams.builder()
          .datalinkIngest(DatalinkIngest.builder()
              .classificationMarking("U")
              .dataMode(DatalinkIngest.DataMode.TEST)
              .opExName("DESERT WIND")
      ...
      assertThat(body).isEqualTo(DatalinkIngest.builder()
          .classificationMarking("U")
          .dataMode(DatalinkIngest.DataMode.TEST)
          .opExName("DESERT WIND")
          .originator("USCENTCOM")
