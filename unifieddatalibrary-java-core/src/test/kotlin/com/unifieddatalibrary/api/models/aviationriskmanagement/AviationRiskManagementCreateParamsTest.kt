...
internal class AviationRiskManagementCreateParamsTest {
    ...
    fun create() {
      AviationRiskManagementCreateParams.builder()
          ...
          .addAviationRiskManagementWorksheetRecord(AviationRiskManagementCreateParams.AviationRiskManagementWorksheetRecord.builder()
              .missionDate(LocalDate.parse("2024-11-25"))
              .aircraftMds("E-2C HAWKEYE")
              .approvalPending(true)
              .approved(false)
              .addAviationRiskManagementWorksheetScore(AviationRiskManagementCreateParams.AviationRiskManagementWorksheetRecord.AviationRiskManagementWorksheetScore.builder()
                  .approvalDate(OffsetDateTime.parse("2024-11-01T16:00:00.123Z"))
                  .approvedBy("John Smith")
                  .approvedCode(0)
                  .addAviationRiskManagementSortie(AviationRiskManagementCreateParams.AviationRiskManagementWorksheetRecord.AviationRiskManagementWorksheetScore.AviationRiskManagementSortie.builder()
    ...
    @Test
    fun body() {
      val params = AviationRiskManagementCreateParams.builder()
          .classificationMarking("U")
          .dataMode(AviationRiskManagementCreateParams.DataMode.TEST)
          .idMission("fa18d96e-91ea-60da-a7a8-1af6500066c8")
          .source("Bluestaq")
      ...
      assertThat(body.aviationRiskManagementWorksheetRecord().getOrNull()).containsExactly(AviationRiskManagementCreateParams.AviationRiskManagementWorksheetRecord.builder()
          .missionDate(LocalDate.parse("2024-11-25"))
          .aircraftMds("E-2C HAWKEYE")
          .approvalPending(true)
          .approved(false)
