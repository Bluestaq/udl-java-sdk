...
internal class AviationRiskManagementCreateParamsTest {
    ...
    fun create() {
        AviationRiskManagementCreateParams.builder()
            ...
            .addAviationRiskManagementWorksheetRecord(
                AviationRiskManagementCreateParams.AviationRiskManagementWorksheetRecord.builder()
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(AviationRiskManagementCreateParams.DataMode.TEST)
