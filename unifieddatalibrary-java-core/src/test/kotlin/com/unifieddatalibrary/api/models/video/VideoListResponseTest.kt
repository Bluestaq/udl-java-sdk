...
internal class VideoListResponseTest {
    ...
    fun create() {
        ...
        assertThat(videoListResponse.createdAt())
        ...
        assertThat(videoListResponse.startTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoListResponse.stopTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoListResponse.videoUrls().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedVideoListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(videoListResponse),
                jacksonTypeRef<VideoListResponse>(),
            )
