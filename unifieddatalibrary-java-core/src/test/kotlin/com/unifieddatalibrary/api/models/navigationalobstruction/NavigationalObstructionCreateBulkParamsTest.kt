...
internal class NavigationalObstructionCreateBulkParamsTest {
    ...
    fun create() {
      NavigationalObstructionCreateBulkParams.builder()
          .addBody(NavigationalObstructionCreateBulkParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = NavigationalObstructionCreateBulkParams.builder()
          .addBody(NavigationalObstructionCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .cycleDate(LocalDate.parse("2024-06-13"))
              .dataMode(NavigationalObstructionCreateBulkParams.Body.DataMode.TEST)
      ...
      assertThat(body).containsExactly(NavigationalObstructionCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .cycleDate(LocalDate.parse("2024-06-13"))
          .dataMode(NavigationalObstructionCreateBulkParams.Body.DataMode.TEST)
          .obstacleId("359655")
