...
internal class AisFullTest {
    ...
    fun create() {
        ...
        assertThat(aisFull.antennaRefDimensions().getOrNull())
        ...
        assertThat(aisFull.destinationEta())
        ...
        assertThat(aisFull.etaCalculated())
            .contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
        assertThat(aisFull.etaUpdated())
            .contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
        ...
        assertThat(aisFull.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedAisFull =
            jsonMapper.readValue(jsonMapper.writeValueAsString(aisFull), jacksonTypeRef<AisFull>())
