...
internal class CollectRequestUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      CollectRequestUnvalidatedPublishParams.builder()
          .addBody(CollectRequestUnvalidatedPublishParams.Body.builder()
              ...
              .eccentricity(1.1)
              .el(1.1)
              .elset(CollectRequestUnvalidatedPublishParams.Body.Elset.builder()
                  .classificationMarking("U")
                  .dataMode(CollectRequestUnvalidatedPublishParams.Body.Elset.DataMode.TEST)
                  ...
                  .addSourcedDataType(CollectRequestUnvalidatedPublishParams.Body.Elset.SourcedDataType.RADAR)
                  .addSourcedDataType(CollectRequestUnvalidatedPublishParams.Body.Elset.SourcedDataType.RF)
                  .sourceDl("AXE")
              ...
              .srchInc(1.1)
              .srchPattern("SCAN")
              .stateVector(CollectRequestUnvalidatedPublishParams.Body.StateVector.builder()
                  .classificationMarking("U")
                  .dataMode(CollectRequestUnvalidatedPublishParams.Body.StateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(CollectRequestUnvalidatedPublishParams.Body.StateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(CollectRequestUnvalidatedPublishParams.Body.StateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(CollectRequestUnvalidatedPublishParams.Body.StateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
    ...
    @Test
    fun body() {
      val params = CollectRequestUnvalidatedPublishParams.builder()
          .addBody(CollectRequestUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(CollectRequestUnvalidatedPublishParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(CollectRequestUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(CollectRequestUnvalidatedPublishParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
