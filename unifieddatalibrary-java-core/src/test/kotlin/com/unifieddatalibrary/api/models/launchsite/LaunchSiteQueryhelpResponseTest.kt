...
internal class LaunchSiteQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val launchSiteQueryhelpResponse =
            LaunchSiteQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(launchSiteQueryhelpResponse.classificationMarking())
        ...
        assertThat(launchSiteQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(launchSiteQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedLaunchSiteQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(launchSiteQueryhelpResponse),
                jacksonTypeRef<LaunchSiteQueryhelpResponse>(),
            )
