...
internal class SeradataSigintPayloadUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(SeradataSigintPayloadUpdateParams.DataMode.TEST)
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.spacecraftId()).isEqualTo("spacecraftId")
        assertThat(body.bodyId()).contains("SERADATASIGINTPAYLOAD-ID")
