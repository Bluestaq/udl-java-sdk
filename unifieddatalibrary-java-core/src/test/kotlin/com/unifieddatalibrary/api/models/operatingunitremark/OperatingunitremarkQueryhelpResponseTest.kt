...
internal class OperatingunitremarkQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val operatingunitremarkQueryhelpResponse =
            OperatingunitremarkQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(operatingunitremarkQueryhelpResponse.classificationMarking())
        ...
        assertThat(operatingunitremarkQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(operatingunitremarkQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedOperatingunitremarkQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(operatingunitremarkQueryhelpResponse),
                jacksonTypeRef<OperatingunitremarkQueryhelpResponse>(),
            )

        assertThat(roundtrippedOperatingunitremarkQueryhelpResponse)
            .isEqualTo(operatingunitremarkQueryhelpResponse)
    }
}
