...
internal class NavigationalObstructionCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = NavigationalObstructionCreateParams.builder()
          .classificationMarking("U")
          .cycleDate(LocalDate.parse("2024-06-13"))
          .dataMode(NavigationalObstructionCreateParams.DataMode.TEST)
          .obstacleId("359655")
      ...
      assertThat(body.dataMode()).isEqualTo(NavigationalObstructionCreateParams.DataMode.TEST)
