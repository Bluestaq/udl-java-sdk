...
internal class NotificationListResponseTest {
    ...
    @Test
    fun create() {
      val notificationListResponse = NotificationListResponse.builder()
      ...
      assertThat(notificationListResponse.dataMode()).isEqualTo(NotificationListResponse.DataMode.TEST)
      ...
      assertThat(notificationListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedNotificationListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(notificationListResponse), jacksonTypeRef<NotificationListResponse>())
