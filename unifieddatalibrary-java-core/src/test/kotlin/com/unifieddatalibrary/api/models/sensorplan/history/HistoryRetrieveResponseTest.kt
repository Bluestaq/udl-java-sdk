...
internal class HistoryRetrieveResponseTest {
    ...
    fun create() {
      val historyRetrieveResponse = HistoryRetrieveResponse.builder()
          ...
          .type("PLAN")
          .id("SENSORPLAN-ID")
          .addCollectRequest(HistoryRetrieveResponse.CollectRequest.builder()
              .classificationMarking("U")
              ...
              .eccentricity(1.1)
              .el(1.1)
              .elset(HistoryRetrieveResponse.CollectRequest.Elset.builder()
                  .classificationMarking("U")
                  ...
                  .addSourcedDataType(HistoryRetrieveResponse.CollectRequest.Elset.SourcedDataType.RADAR)
                  .addSourcedDataType(HistoryRetrieveResponse.CollectRequest.Elset.SourcedDataType.RF)
                  .sourceDl("AXE")
                  .addTag("PROVIDER_TAG1")
                  .addTag("PROVIDER_TAG2")
              ...
              .srchInc(1.1)
              .srchPattern("SCAN")
              .stateVector(HistoryRetrieveResponse.CollectRequest.StateVector.builder()
                  .classificationMarking("U")
                  .dataMode(HistoryRetrieveResponse.CollectRequest.StateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(HistoryRetrieveResponse.CollectRequest.StateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(HistoryRetrieveResponse.CollectRequest.StateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(HistoryRetrieveResponse.CollectRequest.StateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
      ...
      assertThat(historyRetrieveResponse.startTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(historyRetrieveResponse.type()).isEqualTo("PLAN")
      assertThat(historyRetrieveResponse.id()).contains("SENSORPLAN-ID")
      assertThat(historyRetrieveResponse.collectRequests().getOrNull()).containsExactly(HistoryRetrieveResponse.CollectRequest.builder()
          .classificationMarking("U")
          .dataMode(HistoryRetrieveResponse.CollectRequest.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          ...
          .yAngle(1.1)
          .build())
      assertThat(historyRetrieveResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(historyRetrieveResponse.endTime()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(historyRetrieveResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
