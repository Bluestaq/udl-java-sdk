...
internal class PassiveRadarObservationCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.senReferenceFrame())
            .contains(PassiveRadarObservationCreateParams.SenReferenceFrame.J2000)
        assertThat(body.senx()).contains(-4527.793)
        assertThat(body.seny()).contains(3793.586)
        assertThat(body.senz()).contains(3553.495)
