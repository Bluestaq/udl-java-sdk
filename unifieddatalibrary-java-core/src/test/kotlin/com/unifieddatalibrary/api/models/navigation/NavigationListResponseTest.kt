...
internal class NavigationListResponseTest {
    ...
    @Test
    fun create() {
      val navigationListResponse = NavigationListResponse.builder()
      ...
      assertThat(navigationListResponse.dataMode()).isEqualTo(NavigationListResponse.DataMode.TEST)
      ...
      assertThat(navigationListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(navigationListResponse.idEntity()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
    ...
    fun roundtrip() {
      ...
      val roundtrippedNavigationListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(navigationListResponse), jacksonTypeRef<NavigationListResponse>())
