...
internal class EmitterGeolocationRetrieveResponseTest {

    @Test
    fun create() {
        val emitterGeolocationRetrieveResponse =
            EmitterGeolocationRetrieveResponse.builder()
                .classificationMarking("U")
                .dataMode(EmitterGeolocationRetrieveResponse.DataMode.TEST)
        ...
        assertThat(emitterGeolocationRetrieveResponse.classificationMarking()).isEqualTo("U")
        assertThat(emitterGeolocationRetrieveResponse.dataMode())
            .isEqualTo(EmitterGeolocationRetrieveResponse.DataMode.TEST)
        assertThat(emitterGeolocationRetrieveResponse.signalOfInterestType()).isEqualTo("RF")
        assertThat(emitterGeolocationRetrieveResponse.source()).isEqualTo("Bluestaq")
        assertThat(emitterGeolocationRetrieveResponse.startTime())
            .isEqualTo(OffsetDateTime.parse("2024-05-31T21:12:12.123456Z"))
        assertThat(emitterGeolocationRetrieveResponse.id())
            .contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(emitterGeolocationRetrieveResponse.agjson())
            .contains(
                "{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }"
            )
        assertThat(emitterGeolocationRetrieveResponse.algVersion()).contains("v1.0-3-gps_nb_3ball")
        assertThat(emitterGeolocationRetrieveResponse.andims()).contains(3)
        assertThat(emitterGeolocationRetrieveResponse.area())
            .contains(
                "POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))"
            )
        assertThat(emitterGeolocationRetrieveResponse.asrid()).contains(3)
        assertThat(emitterGeolocationRetrieveResponse.atext())
            .contains(
                "POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))"
            )
        assertThat(emitterGeolocationRetrieveResponse.atype()).contains("MultiPolygon")
        assertThat(emitterGeolocationRetrieveResponse.avgPrf()).contains(624.57)
        assertThat(emitterGeolocationRetrieveResponse.avgPri()).contains(1601.1)
        assertThat(emitterGeolocationRetrieveResponse.avgPw()).contains(400.2)
        assertThat(emitterGeolocationRetrieveResponse.centerFreq()).contains(1575.42)
        assertThat(emitterGeolocationRetrieveResponse.cluster()).contains("CONSTELLATION1-F")
        assertThat(emitterGeolocationRetrieveResponse.confArea()).contains(81577480.056)
        assertThat(emitterGeolocationRetrieveResponse.constellation()).contains("HawkEye360")
        assertThat(emitterGeolocationRetrieveResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(emitterGeolocationRetrieveResponse.createdBy()).contains("some.user")
        assertThat(emitterGeolocationRetrieveResponse.createdTs())
            .contains(OffsetDateTime.parse("2024-05-31T23:06:18.123456Z"))
        assertThat(emitterGeolocationRetrieveResponse.detectAlt()).contains(123.456)
        assertThat(emitterGeolocationRetrieveResponse.detectLat()).contains(41.172)
        assertThat(emitterGeolocationRetrieveResponse.detectLon()).contains(37.019)
        assertThat(emitterGeolocationRetrieveResponse.endTime())
            .contains(OffsetDateTime.parse("2024-05-31T21:16:15.123456Z"))
        assertThat(emitterGeolocationRetrieveResponse.errEllp().getOrNull())
            .containsExactly(1.23, 2.34, 3.45)
        assertThat(emitterGeolocationRetrieveResponse.externalId()).contains("780180925")
        assertThat(emitterGeolocationRetrieveResponse.idOnOrbit()).contains("HawkEye360-7")
        assertThat(emitterGeolocationRetrieveResponse.idRfEmitter())
            .contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(emitterGeolocationRetrieveResponse.idSensor()).contains("OCULUSA")
        assertThat(emitterGeolocationRetrieveResponse.maxFreq()).contains(1575.42)
        assertThat(emitterGeolocationRetrieveResponse.maxPrf()).contains(624.96)
        assertThat(emitterGeolocationRetrieveResponse.maxPri()).contains(1602.1)
        assertThat(emitterGeolocationRetrieveResponse.maxPw()).contains(400.3)
        assertThat(emitterGeolocationRetrieveResponse.minFreq()).contains(1575.42)
        assertThat(emitterGeolocationRetrieveResponse.minPrf()).contains(624.18)
        assertThat(emitterGeolocationRetrieveResponse.minPri()).contains(1600.1)
        assertThat(emitterGeolocationRetrieveResponse.minPw()).contains(400.1)
        assertThat(emitterGeolocationRetrieveResponse.numBursts()).contains(17)
        assertThat(emitterGeolocationRetrieveResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(emitterGeolocationRetrieveResponse.orderId()).contains("155240")
        assertThat(emitterGeolocationRetrieveResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(emitterGeolocationRetrieveResponse.origNetwork()).contains("OPS1")
        assertThat(emitterGeolocationRetrieveResponse.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(emitterGeolocationRetrieveResponse.origRfEmitterId()).contains("12345678")
        assertThat(emitterGeolocationRetrieveResponse.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(emitterGeolocationRetrieveResponse.passGroupId())
            .contains("80fd25a8-8b41-448d-888a-91c9dfcd940b")
        assertThat(emitterGeolocationRetrieveResponse.pulseShape()).contains("RECTANGULAR")
        assertThat(emitterGeolocationRetrieveResponse.receivedTs())
            .contains(OffsetDateTime.parse("2024-05-31T21:16:58.123456Z"))
        assertThat(emitterGeolocationRetrieveResponse.satNo()).contains(101)
        assertThat(emitterGeolocationRetrieveResponse.signalOfInterest()).contains("GPS")
        assertThat(emitterGeolocationRetrieveResponse.sourceDl()).contains("AXE")
        assertThat(emitterGeolocationRetrieveResponse.tags().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedEmitterGeolocationRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(emitterGeolocationRetrieveResponse),
                jacksonTypeRef<EmitterGeolocationRetrieveResponse>(),
            )

        assertThat(roundtrippedEmitterGeolocationRetrieveResponse)
            .isEqualTo(emitterGeolocationRetrieveResponse)
    }
}
