...
internal class SigactTupleResponseTest {
    ...
    @Test
    fun create() {
      val sigactTupleResponse = SigactTupleResponse.builder()
          ...
          .addRelatedDoc(RelatedDocumentFull.builder()
              .addDataSourceRef(SofDataSourceRefFull.builder()
      ...
      assertThat(sigactTupleResponse.reportDate()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(sigactTupleResponse.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(sigactTupleResponse.andims()).contains(3L)
      assertThat(sigactTupleResponse.area()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(sigactTupleResponse.asrid()).contains(3)
      assertThat(sigactTupleResponse.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(sigactTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(sigactTupleResponse.eventEnd()).contains(OffsetDateTime.parse("2021-01-01T01:02:03.123Z"))
      assertThat(sigactTupleResponse.eventStart()).contains(OffsetDateTime.parse("2021-01-01T01:02:03.123Z"))
      ...
      assertThat(sigactTupleResponse.relatedDocs().getOrNull()).containsExactly(RelatedDocumentFull.builder()
          .addDataSourceRef(SofDataSourceRefFull.builder()
              .dataSourceId("dataSourceId")
              .endPosition("endPosition")
              .paragraphNumber("paragraphNumber")
    ...
    fun roundtrip() {
      ...
      val roundtrippedSigactTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sigactTupleResponse), jacksonTypeRef<SigactTupleResponse>())
