...
internal class LaunchSiteListResponseTest {
    ...
    @Test
    fun create() {
        val launchSiteListResponse =
            LaunchSiteListResponse.builder()
        ...
        assertThat(launchSiteListResponse.dataMode())
            .isEqualTo(LaunchSiteListResponse.DataMode.TEST)
        ...
        assertThat(launchSiteListResponse.createdAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedLaunchSiteListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(launchSiteListResponse),
                jacksonTypeRef<LaunchSiteListResponse>(),
            )
