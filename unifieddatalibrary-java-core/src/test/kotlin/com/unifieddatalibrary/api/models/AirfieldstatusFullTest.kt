...
internal class AirfieldstatusFullTest {
    ...
    @Test
    fun create() {
      val airfieldstatusFull = AirfieldstatusFull.builder()
      ...
      assertThat(airfieldstatusFull.idAirfield()).isEqualTo("3136498f-2969-3535-1432-e984b2e2e686")
      ...
      assertThat(airfieldstatusFull.approvedDate()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      assertThat(airfieldstatusFull.arffCat()).contains("FAA-A")
      assertThat(airfieldstatusFull.cargoMog()).contains(8)
      assertThat(airfieldstatusFull.createdAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
      ...
      assertThat(airfieldstatusFull.fuelQtys().getOrNull()).containsExactly(263083.6, 286674.9, 18143.69)
      assertThat(airfieldstatusFull.fuelTypes().getOrNull()).containsExactly("JP-8", "Jet A", "AVGAS")
      ...
      assertThat(airfieldstatusFull.reviewedDate()).contains(OffsetDateTime.parse("2024-01-01T00:00:00.123Z"))
      assertThat(airfieldstatusFull.rwyCondReading()).contains(23)
      assertThat(airfieldstatusFull.rwyFrictionFactor()).contains(10)
      assertThat(airfieldstatusFull.rwyMarkings().getOrNull()).containsExactly("Aiming Point", "Threshold")
      assertThat(airfieldstatusFull.slotTypesReq().getOrNull()).containsExactly("PARKING", "WORKING", "LANDING")
      assertThat(airfieldstatusFull.sourceDl()).contains("AXE")
      assertThat(airfieldstatusFull.surveyDate()).contains(OffsetDateTime.parse("2023-01-01T12:00:00.123Z"))
      assertThat(airfieldstatusFull.updatedAt()).contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedAirfieldstatusFull = jsonMapper.readValue(jsonMapper.writeValueAsString(airfieldstatusFull), jacksonTypeRef<AirfieldstatusFull>())
