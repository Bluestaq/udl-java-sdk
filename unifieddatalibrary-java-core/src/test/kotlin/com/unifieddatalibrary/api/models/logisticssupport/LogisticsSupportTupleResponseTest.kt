...
internal class LogisticsSupportTupleResponseTest {

    @Test
    fun create() {
        val logisticsSupportTupleResponse =
            LogisticsSupportTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(LogisticsSupportTupleResponse.DataMode.TEST)
        ...
        assertThat(logisticsSupportTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(logisticsSupportTupleResponse.dataMode())
            .isEqualTo(LogisticsSupportTupleResponse.DataMode.TEST)
        assertThat(logisticsSupportTupleResponse.rptCreatedTime())
            .isEqualTo(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(logisticsSupportTupleResponse.id()).contains("LOGISTICS-SUPPORT-DETAILS UUID")
        assertThat(logisticsSupportTupleResponse.aircraftMds()).contains("CO17A")
        assertThat(logisticsSupportTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(logisticsSupportTupleResponse.createdBy()).contains("some.user")
        assertThat(logisticsSupportTupleResponse.currIcao()).contains("KCOS")
        assertThat(logisticsSupportTupleResponse.etic())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportTupleResponse.etmc())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportTupleResponse.extSystemId()).contains("GDSSBL012307131347070165")
        assertThat(logisticsSupportTupleResponse.logisticAction()).contains("WA")
        assertThat(logisticsSupportTupleResponse.logisticsDiscrepancyInfos().getOrNull())
            .containsExactly(
                LogisticsDiscrepancyInfosFull.builder()
                    .closureTime(OffsetDateTime.parse("2023-07-17T10:30:00.123Z"))
                    .discrepancyInfo(
        ...
        assertThat(logisticsSupportTupleResponse.logisticsRecordId()).contains("L62017")
        assertThat(logisticsSupportTupleResponse.logisticsRemarks().getOrNull())
            .containsExactly(
                LogisticsRemarksFull.builder()
                    .lastChanged(OffsetDateTime.parse("2023-07-17T10:30:00.123Z"))
                    .remark("EXAMPLE REMARK")
        ...
        assertThat(logisticsSupportTupleResponse.logisticsSupportItems().getOrNull())
            .containsExactly(
                LogisticsSupportItemsFull.builder()
                    .cannibalized(true)
                    .deployPlanNumber("T89003")
        ...
        assertThat(logisticsSupportTupleResponse.logisticsTransportationPlans().getOrNull())
            .containsExactly(
                LogisticsTransportationPlansFull.builder()
                    .actDepTime(OffsetDateTime.parse("2023-07-14T19:37:00.123Z"))
                    .aircraftStatus("NMCMU")
        ...
        assertThat(logisticsSupportTupleResponse.maintStatusCode()).contains("NMCMU")
        assertThat(logisticsSupportTupleResponse.mcTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportTupleResponse.meTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(logisticsSupportTupleResponse.origNetwork()).contains("OPS1")
        assertThat(logisticsSupportTupleResponse.owner()).contains("EXAMPLE_OWNER")
        assertThat(logisticsSupportTupleResponse.reopenFlag()).contains(true)
        assertThat(logisticsSupportTupleResponse.rptClosedTime())
            .contains(OffsetDateTime.parse("2023-07-13T13:47:00.123Z"))
        assertThat(logisticsSupportTupleResponse.suppIcao()).contains("KCOS")
        assertThat(logisticsSupportTupleResponse.tailNumber()).contains("99290")
        assertThat(logisticsSupportTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
        assertThat(logisticsSupportTupleResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedLogisticsSupportTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(logisticsSupportTupleResponse),
                jacksonTypeRef<LogisticsSupportTupleResponse>(),
            )

        assertThat(roundtrippedLogisticsSupportTupleResponse)
            .isEqualTo(logisticsSupportTupleResponse)
    }
}
