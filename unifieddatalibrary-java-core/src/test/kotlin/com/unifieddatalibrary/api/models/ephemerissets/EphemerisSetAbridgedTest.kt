...
internal class EphemerisSetAbridgedTest {
    ...
    @Test
    fun create() {
      val ephemerisSetAbridged = EphemerisSetAbridged.builder()
          .category("ANALYST")
      ...
      assertThat(ephemerisSetAbridged.pointEndTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(ephemerisSetAbridged.pointStartTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(ephemerisSetAbridged.covReferenceFrame()).contains(EphemerisSetAbridged.CovReferenceFrame.J2000)
      assertThat(ephemerisSetAbridged.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(ephemerisSetAbridged.idManeuvers().getOrNull()).containsExactly("EXAMPLE_ID1", "EXAMPLE_ID2")
      ...
      assertThat(ephemerisSetAbridged.origNetwork()).contains("ORIG")
      ...
      assertThat(ephemerisSetAbridged.referenceFrame()).contains(EphemerisSetAbridged.ReferenceFrame.J2000)
      ...
      assertThat(ephemerisSetAbridged.usableEndTime()).contains(OffsetDateTime.parse("2018-01-01T20:50:00.123456Z"))
      assertThat(ephemerisSetAbridged.usableStartTime()).contains(OffsetDateTime.parse("2018-01-01T16:10:00.123456Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedEphemerisSetAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(ephemerisSetAbridged), jacksonTypeRef<EphemerisSetAbridged>())
