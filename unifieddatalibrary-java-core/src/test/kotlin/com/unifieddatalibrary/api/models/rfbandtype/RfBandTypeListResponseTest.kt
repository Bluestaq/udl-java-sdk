...
internal class RfBandTypeListResponseTest {
    ...
    @Test
    fun create() {
      val rfBandTypeListResponse = RfBandTypeListResponse.builder()
          .id("Ku")
      ...
      assertThat(rfBandTypeListResponse.dataMode()).isEqualTo(RfBandTypeListResponse.DataMode.TEST)
      ...
      assertThat(rfBandTypeListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfBandTypeListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rfBandTypeListResponse), jacksonTypeRef<RfBandTypeListResponse>())
