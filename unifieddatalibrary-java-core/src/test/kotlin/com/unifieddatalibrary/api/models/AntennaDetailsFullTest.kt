...
internal class AntennaDetailsFullTest {
    ...
    @Test
    fun create() {
      val antennaDetailsFull = AntennaDetailsFull.builder()
      ...
      assertThat(antennaDetailsFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(antennaDetailsFull.manufacturerOrg()).contains(OrganizationFull.builder()
          .classificationMarking("U")
          .dataMode(OrganizationFull.DataMode.TEST)
          .name("some.user")
          .source("some.user")
      ...
      assertThat(antennaDetailsFull.origNetwork()).contains("ORIG")
      ...
      assertThat(antennaDetailsFull.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
      assertThat(antennaDetailsFull.type()).contains("Reflector")
      assertThat(antennaDetailsFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedAntennaDetailsFull = jsonMapper.readValue(jsonMapper.writeValueAsString(antennaDetailsFull), jacksonTypeRef<AntennaDetailsFull>())
