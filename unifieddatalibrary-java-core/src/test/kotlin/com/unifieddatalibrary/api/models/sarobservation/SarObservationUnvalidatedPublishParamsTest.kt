...
internal class SarObservationUnvalidatedPublishParamsTest {
    ...
    fun create() {
      SarObservationUnvalidatedPublishParams.builder()
          .addBody(SarObservationUnvalidatedPublishParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = SarObservationUnvalidatedPublishParams.builder()
          .addBody(SarObservationUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .collectionEnd(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
              .collectionStart(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
      ...
      assertThat(body).containsExactly(SarObservationUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .collectionEnd(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
          .collectionStart(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
          .dataMode(SarObservationUnvalidatedPublishParams.Body.DataMode.TEST)
