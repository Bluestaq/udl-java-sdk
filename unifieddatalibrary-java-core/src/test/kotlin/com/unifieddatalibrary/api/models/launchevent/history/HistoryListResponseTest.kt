...
internal class HistoryListResponseTest {
    ...
    fun create() {
        ...
        assertThat(historyListResponse.id()).contains("LAUNCHEVENT-ID")
        assertThat(historyListResponse.beNumber()).contains("ENC-123")
        assertThat(historyListResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(historyListResponse.createdBy()).contains("some.user")
        assertThat(historyListResponse.declassificationDate())
            .contains(OffsetDateTime.parse("2021-01-01T01:02:02.123Z"))
        assertThat(historyListResponse.declassificationString())
            .contains("Example Declassification")
        assertThat(historyListResponse.derivedFrom()).contains("Example source")
        assertThat(historyListResponse.idOnOrbit()).contains("REF-ONORBIT-ID")
        assertThat(historyListResponse.launchDate())
            .contains(OffsetDateTime.parse("2020-01-01T00:00:00.123Z"))
        assertThat(historyListResponse.launchFacilityName())
            .contains("Example launch facility name")
        assertThat(historyListResponse.launchFailureCode()).contains("Example failure code")
        ...
        assertThat(historyListResponse.oSuffix()).contains("oSuffix")
