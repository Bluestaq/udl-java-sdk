...
internal class SgiGetDataByEffectiveAsOfDateResponseTest {
    ...
    @Test
    fun create() {
        val sgiGetDataByEffectiveAsOfDateResponse =
            SgiGetDataByEffectiveAsOfDateResponse.builder()
        ...
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.dataMode())
            .isEqualTo(SgiGetDataByEffectiveAsOfDateResponse.DataMode.TEST)
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.effectiveDate())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.sgiDate())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        ...
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.coeffDegree().getOrNull())
            .containsExactly(1, 2, 3)
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.coeffOrder().getOrNull())
            .containsExactly(1, 2, 3)
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.createdBy()).contains("some.user")
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.ctce().getOrNull())
            .containsExactly(1.23, 342.3, 1.32)
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.ctci().getOrNull())
            .containsExactly(1.23, 342.3, 1.32)
        ...
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.frequencies().getOrNull())
        ...
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.idSensor())
            .contains("57c96c97-e076-48af-a068-73ee2cb37e65")
        ...
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.observedBaseline().getOrNull())
            .containsExactly(15, 32, 25, 134, 0, 6, 19, 8)
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.origin())
            .contains("THIRD_PARTY_DATASOURCE")
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.origNetwork()).contains("OPS1")
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.powers().getOrNull())
            .containsExactly(67.1, 65.2, 68.1, 74.3, 68.1, 96.4, 97.3, 68.1)
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.precedence())
            .contains(SgiGetDataByEffectiveAsOfDateResponse.Precedence.R)
        ...
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.state())
            .contains(SgiGetDataByEffectiveAsOfDateResponse.State.I)
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.stationName()).contains("Boulder")
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.stce().getOrNull())
            .containsExactly(1.23, 342.3, 1.32)
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.stci().getOrNull())
            .containsExactly(1.23, 342.3, 1.32)
        ...
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.tags().getOrNull())
        ...
        assertThat(sgiGetDataByEffectiveAsOfDateResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSgiGetDataByEffectiveAsOfDateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sgiGetDataByEffectiveAsOfDateResponse),
                jacksonTypeRef<SgiGetDataByEffectiveAsOfDateResponse>(),
            )

        assertThat(roundtrippedSgiGetDataByEffectiveAsOfDateResponse)
            .isEqualTo(sgiGetDataByEffectiveAsOfDateResponse)
    }
}
