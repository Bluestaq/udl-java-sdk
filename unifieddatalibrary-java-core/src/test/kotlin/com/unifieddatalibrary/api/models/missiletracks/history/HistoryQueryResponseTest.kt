...
internal class HistoryQueryResponseTest {
    ...
    fun create() {
      val historyQueryResponse = HistoryQueryResponse.builder()
          ...
          .trkConf(0.95)
          .trkQual(1)
          .addVector(HistoryQueryResponse.Vector.builder()
      ...
      assertThat(historyQueryResponse.ts()).isEqualTo(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(historyQueryResponse.createdAt()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123Z"))
      ...
      assertThat(historyQueryResponse.impactAouData().getOrNull()).containsExactly(34.3, 26.5, 1.2)
      ...
      assertThat(historyQueryResponse.impactTime()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      assertThat(historyQueryResponse.infoSource()).contains("S1")
      assertThat(historyQueryResponse.launchAouData().getOrNull()).containsExactly(1.23, 2.34, 3.45)
      ...
      assertThat(historyQueryResponse.launchTime()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      assertThat(historyQueryResponse.lostTrkInd()).contains(false)
      assertThat(historyQueryResponse.msgCreateDate()).contains(OffsetDateTime.parse("2024-04-25T08:17:01.346Z"))
      ...
      assertThat(historyQueryResponse.vectors().getOrNull()).containsExactly(HistoryQueryResponse.Vector.builder()
          .epoch(OffsetDateTime.parse("2024-03-30T15:02:39.346768Z"))
          .accel(listOf(
            0.59236,
            -0.03537,
