...
internal class OrbitdeterminationQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val orbitdeterminationQueryhelpResponse = OrbitdeterminationQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(orbitdeterminationQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(orbitdeterminationQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(orbitdeterminationQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedOrbitdeterminationQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(orbitdeterminationQueryhelpResponse), jacksonTypeRef<OrbitdeterminationQueryhelpResponse>())

      assertThat(roundtrippedOrbitdeterminationQueryhelpResponse).isEqualTo(orbitdeterminationQueryhelpResponse)
    }
}
