...
internal class FlightplanCreateParamsTest {
    ...
    fun create() {
      FlightplanCreateParams.builder()
          ...
          .addAirRefuelEvent(FlightplanCreateParams.AirRefuelEvent.builder()
              .arDegrade(3.1)
          ...
          .addFlightPlanMessage(FlightplanCreateParams.FlightPlanMessage.builder()
              .msgText("Message text")
              .routePath("PRIMARY")
              .severity("SEVERE")
              .wpNum("20")
              .build())
          .addFlightPlanPointGroup(FlightplanCreateParams.FlightPlanPointGroup.builder()
              .avgFuelFlow(19693.1)
              ...
              .etopsTempDev(9.1)
              .etopsTime("01:23")
              .addFlightPlanPoint(FlightplanCreateParams.FlightPlanPointGroup.FlightPlanPoint.builder()
              ...
              .build())
          .addFlightPlanWaypoint(FlightplanCreateParams.FlightPlanWaypoint.builder()
              .type("COMMENT")
              .waypointName("KCHS")
    ...
    @Test
    fun body() {
      val params = FlightplanCreateParams.builder()
          .arrAirfield("KCHS")
          .classificationMarking("U")
          .dataMode(FlightplanCreateParams.DataMode.TEST)
          .depAirfield("KSLV")
      ...
      assertThat(body.dataMode()).isEqualTo(FlightplanCreateParams.DataMode.TEST)
      ...
      assertThat(body.airRefuelEvents().getOrNull()).containsExactly(FlightplanCreateParams.AirRefuelEvent.builder()
          .arDegrade(3.1)
          .arExchangedFuel(1500.1)
          .arNum(2)
          .divertFuel(143000.1)
      ...
      assertThat(body.flightPlanMessages().getOrNull()).containsExactly(FlightplanCreateParams.FlightPlanMessage.builder()
          .msgText("Message text")
          .routePath("PRIMARY")
          .severity("SEVERE")
          .wpNum("20")
          .build())
      assertThat(body.flightPlanPointGroups().getOrNull()).containsExactly(FlightplanCreateParams.FlightPlanPointGroup.builder()
          .avgFuelFlow(19693.1)
          .etopsAvgWindFactor(10.1)
          .etopsDistance(684.1)
          .etopsReqFuel(4412.1)
          ...
          .worstFuelCase("DEPRESSURIZED ENGINE OUT ETP")
          .build())
      assertThat(body.flightPlanWaypoints().getOrNull()).containsExactly(FlightplanCreateParams.FlightPlanWaypoint.builder()
          .type("COMMENT")
          .waypointName("KCHS")
          .aaTacanChannel("31/94")
          .airDistance(321.1)
