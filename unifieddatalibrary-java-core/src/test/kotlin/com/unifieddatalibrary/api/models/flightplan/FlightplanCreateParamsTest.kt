...
internal class FlightplanCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.airRefuelEvents().getOrNull())
            .containsExactly(
                FlightplanCreateParams.AirRefuelEvent.builder()
                    .arDegrade(3.1)
                    .arExchangedFuel(1500.1)
        ...
        assertThat(body.atcAddresses().getOrNull())
        ...
        assertThat(body.etopsAltAirfields().getOrNull())
        ...
        assertThat(body.flightPlanMessages().getOrNull())
            .containsExactly(
                FlightplanCreateParams.FlightPlanMessage.builder()
                    .msgText("Message text")
                    .routePath("PRIMARY")
        ...
        assertThat(body.flightPlanPointGroups().getOrNull())
            .containsExactly(
                FlightplanCreateParams.FlightPlanPointGroup.builder()
                    .avgFuelFlow(19693.1)
                    .etopsAvgWindFactor(10.1)
        ...
        assertThat(body.flightPlanWaypoints().getOrNull())
            .containsExactly(
                FlightplanCreateParams.FlightPlanWaypoint.builder()
                    .type("COMMENT")
                    .waypointName("KCHS")
