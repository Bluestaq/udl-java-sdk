...
internal class TrackDetailListResponseTest {
    ...
    @Test
    fun create() {
      val trackDetailListResponse = TrackDetailListResponse.builder()
      ...
      assertThat(trackDetailListResponse.dataMode()).isEqualTo(TrackDetailListResponse.DataMode.TEST)
      ...
      assertThat(trackDetailListResponse.ts()).isEqualTo(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(trackDetailListResponse.antennaRefDimensions().getOrNull()).containsExactly(50.1, 50.1, 20.1, 20.1)
      assertThat(trackDetailListResponse.aouRptData().getOrNull()).containsExactly(34.3, 26.5, 1.2)
      ...
      assertThat(trackDetailListResponse.arrTime()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(trackDetailListResponse.createdAt()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123Z"))
      ...
      assertThat(trackDetailListResponse.eta()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      assertThat(trackDetailListResponse.etd()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(trackDetailListResponse.ftnMsgTs()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(trackDetailListResponse.impactAouData().getOrNull()).containsExactly(34.3, 26.5, 1.2)
      ...
      assertThat(trackDetailListResponse.impactTime()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      assertThat(trackDetailListResponse.infoSource()).contains("S1")
      assertThat(trackDetailListResponse.installation()).contains(false)
      assertThat(trackDetailListResponse.launchAouData().getOrNull()).containsExactly(34.3, 26.5, 1.2)
      ...
      assertThat(trackDetailListResponse.launchTime()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(trackDetailListResponse.objIdent()).contains(TrackDetailListResponse.ObjIdent.FRIEND)
      ...
      assertThat(trackDetailListResponse.rtnMsgTs().getOrNull()).containsExactly(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
      ...
      assertThat(trackDetailListResponse.tcpa()).contains(OffsetDateTime.parse("2021-02-25T12:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedTrackDetailListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(trackDetailListResponse), jacksonTypeRef<TrackDetailListResponse>())
