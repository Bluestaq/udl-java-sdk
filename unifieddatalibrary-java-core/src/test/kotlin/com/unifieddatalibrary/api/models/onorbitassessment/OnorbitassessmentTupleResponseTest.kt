...
internal class OnorbitassessmentTupleResponseTest {

    @Test
    fun create() {
        val onorbitassessmentTupleResponse =
            OnorbitassessmentTupleResponse.builder()
                .assmtTime(OffsetDateTime.parse("2025-08-10T02:44:02.000Z"))
                .classificationMarking("U")
                .dataMode(OnorbitassessmentTupleResponse.DataMode.TEST)
                .source("Bluestaq")
        ...
        assertThat(onorbitassessmentTupleResponse.assmtTime())
            .isEqualTo(OffsetDateTime.parse("2025-08-10T02:44:02.000Z"))
        assertThat(onorbitassessmentTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(onorbitassessmentTupleResponse.dataMode())
            .isEqualTo(OnorbitassessmentTupleResponse.DataMode.TEST)
        assertThat(onorbitassessmentTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(onorbitassessmentTupleResponse.id())
            .contains("026dd511-8ba5-47d3-9909-836149f87686")
        assertThat(onorbitassessmentTupleResponse.assessment()).contains("NOMINAL")
        assertThat(onorbitassessmentTupleResponse.assmtDetails())
            .contains("This spacecraft appears to be in a stable, 3-axis controlled state")
        assertThat(onorbitassessmentTupleResponse.assmtLevel()).contains("SIGNATURE")
        assertThat(onorbitassessmentTupleResponse.assmtRotPeriod()).contains(72.5)
        assertThat(onorbitassessmentTupleResponse.assmtSubType()).contains("STABLE")
        assertThat(onorbitassessmentTupleResponse.assmtUrl())
            .contains("https://unifieddatalibrary.com")
        assertThat(onorbitassessmentTupleResponse.autoAssmt()).contains(false)
        assertThat(onorbitassessmentTupleResponse.collectionUrl())
            .contains("https://unifieddatalibrary.com")
        assertThat(onorbitassessmentTupleResponse.components().getOrNull())
            .containsExactly("THRUSTER", "RWA-2")
        assertThat(onorbitassessmentTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(onorbitassessmentTupleResponse.createdBy()).contains("some.user")
        assertThat(onorbitassessmentTupleResponse.idOnOrbit()).contains("25544")
        assertThat(onorbitassessmentTupleResponse.idSensor()).contains("211")
        assertThat(onorbitassessmentTupleResponse.obDuration()).contains(1.75)
        assertThat(onorbitassessmentTupleResponse.obTime())
            .contains(OffsetDateTime.parse("2025-08-09T23:27:55.862Z"))
        assertThat(onorbitassessmentTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(onorbitassessmentTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(onorbitassessmentTupleResponse.origNetwork()).contains("OPS1")
        assertThat(onorbitassessmentTupleResponse.origObjectId()).contains("ISS")
        assertThat(onorbitassessmentTupleResponse.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(onorbitassessmentTupleResponse.satNo()).contains(25544)
        assertThat(onorbitassessmentTupleResponse.sigDataType()).contains("PHOTOMETRY")
        assertThat(onorbitassessmentTupleResponse.sourceDl()).contains("AXE")
        assertThat(onorbitassessmentTupleResponse.srcIds().getOrNull())
            .containsExactly(
                "49cf9dcf-e97e-43ed-8e21-22e2bb0e3da6",
                "da779fc4-3a37-4caa-a629-289671bc96e8",
            )
        assertThat(onorbitassessmentTupleResponse.srcTyps().getOrNull())
            .containsExactly("EO", "SKYIMAGE")
        assertThat(onorbitassessmentTupleResponse.tags().getOrNull())
            .containsExactly("TAG1", "TAG2")
        assertThat(onorbitassessmentTupleResponse.transactionId()).contains("TRANSACTION-ID")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbitassessmentTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbitassessmentTupleResponse),
                jacksonTypeRef<OnorbitassessmentTupleResponse>(),
            )

        assertThat(roundtrippedOnorbitassessmentTupleResponse)
            .isEqualTo(onorbitassessmentTupleResponse)
    }
}
