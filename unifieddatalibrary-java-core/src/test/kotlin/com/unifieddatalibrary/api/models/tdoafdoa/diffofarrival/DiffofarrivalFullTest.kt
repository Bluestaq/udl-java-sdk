...
internal class DiffofarrivalFullTest {
    ...
    fun create() {
        ...
        assertThat(diffofarrivalFull.bandwidth()).contains(1.1)
        ...
        assertThat(diffofarrivalFull.deltaRange()).contains(1.1)
        assertThat(diffofarrivalFull.deltaRangeRate()).contains(1.1)
        assertThat(diffofarrivalFull.deltaRangeRateUnc()).contains(1.1)
        assertThat(diffofarrivalFull.deltaRangeUnc()).contains(1.1)
        assertThat(diffofarrivalFull.descriptor()).contains("Example descriptor")
        assertThat(diffofarrivalFull.fdoa()).contains(1.1)
        assertThat(diffofarrivalFull.fdoaUnc()).contains(1.1)
        assertThat(diffofarrivalFull.frequency()).contains(1.1)
        ...
        assertThat(diffofarrivalFull.rawFileUri()).contains("rawFileURI")
        assertThat(diffofarrivalFull.satNo()).contains(25544)
        assertThat(diffofarrivalFull.sen2alt()).contains(1.1)
        assertThat(diffofarrivalFull.sen2lat()).contains(1.1)
        assertThat(diffofarrivalFull.sen2lon()).contains(1.1)
        assertThat(diffofarrivalFull.senalt()).contains(1.1)
        assertThat(diffofarrivalFull.senlat()).contains(45.1)
        assertThat(diffofarrivalFull.senlon()).contains(120.1)
        assertThat(diffofarrivalFull.sensor1Delay()).contains(1.1)
        assertThat(diffofarrivalFull.sensor2Delay()).contains(1.1)
        assertThat(diffofarrivalFull.snr()).contains(1.1)
        assertThat(diffofarrivalFull.sourceDl()).contains("AXE")
        assertThat(diffofarrivalFull.tags().getOrNull())
            .containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
        assertThat(diffofarrivalFull.taskId()).contains("TASK-ID")
        assertThat(diffofarrivalFull.tdoa()).contains(1.1)
        assertThat(diffofarrivalFull.tdoaUnc()).contains(1.1)
