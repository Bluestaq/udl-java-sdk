...
internal class DiffofarrivalFullTest {

    @Test
    fun create() {
        val diffofarrivalFull =
            DiffofarrivalFull.builder()
                .classificationMarking("U")
                .dataMode(DiffofarrivalFull.DataMode.TEST)
        ...
        assertThat(diffofarrivalFull.classificationMarking()).isEqualTo("U")
        assertThat(diffofarrivalFull.dataMode()).isEqualTo(DiffofarrivalFull.DataMode.TEST)
        assertThat(diffofarrivalFull.obTime())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
        assertThat(diffofarrivalFull.source()).isEqualTo("Bluestaq")
        assertThat(diffofarrivalFull.id()).contains("DIFFOFARRIVAL-ID")
        assertThat(diffofarrivalFull.azimuth1()).contains(40.9)
        assertThat(diffofarrivalFull.azimuth2()).contains(43.4)
        assertThat(diffofarrivalFull.bandwidth()).contains(500000.1)
        assertThat(diffofarrivalFull.collectionMode()).contains("SURVEY")
        assertThat(diffofarrivalFull.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(diffofarrivalFull.createdBy()).contains("some.user")
        assertThat(diffofarrivalFull.deltaRange()).contains(1.7)
        assertThat(diffofarrivalFull.deltaRangeRate()).contains(0.018)
        assertThat(diffofarrivalFull.deltaRangeRateUnc()).contains(0.001)
        assertThat(diffofarrivalFull.deltaRangeUnc()).contains(0.2)
        assertThat(diffofarrivalFull.descriptor()).contains("Example descriptor")
        assertThat(diffofarrivalFull.elevation1()).contains(65.4)
        assertThat(diffofarrivalFull.elevation2()).contains(65.9)
        assertThat(diffofarrivalFull.fdoa()).contains(970.8)
        assertThat(diffofarrivalFull.fdoaUnc()).contains(20.1)
        assertThat(diffofarrivalFull.frequency()).contains(2240000000.0)
        assertThat(diffofarrivalFull.idOnOrbit()).contains("ONORBIT-ID")
        assertThat(diffofarrivalFull.idSensor1()).contains("SENSOR1-ID")
        assertThat(diffofarrivalFull.idSensor2()).contains("SENSOR2-ID")
        assertThat(diffofarrivalFull.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(diffofarrivalFull.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(diffofarrivalFull.origNetwork()).contains("OPS1")
        assertThat(diffofarrivalFull.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(diffofarrivalFull.origSensorId1()).contains("ORIGSENSOR1-ID")
        assertThat(diffofarrivalFull.origSensorId2()).contains("ORIGSENSOR2-ID")
        assertThat(diffofarrivalFull.polarityType()).contains("V")
        assertThat(diffofarrivalFull.rawFileUri()).contains("/DOA/2026/01/01/filename.txt")
        assertThat(diffofarrivalFull.satNo()).contains(25544)
        assertThat(diffofarrivalFull.sen2alt()).contains(770.1)
        assertThat(diffofarrivalFull.sen2lat()).contains(32.2)
        assertThat(diffofarrivalFull.sen2lon()).contains(-110.9)
        assertThat(diffofarrivalFull.senalt()).contains(783.1)
        assertThat(diffofarrivalFull.senlat()).contains(45.1)
        assertThat(diffofarrivalFull.senlon()).contains(120.1)
        assertThat(diffofarrivalFull.sensor1Delay()).contains(0.000004)
        assertThat(diffofarrivalFull.sensor2Delay()).contains(0.000004)
        assertThat(diffofarrivalFull.snr()).contains(18.1)
        assertThat(diffofarrivalFull.sourceDl()).contains("AXE")
        assertThat(diffofarrivalFull.tags().getOrNull()).containsExactly("TAG1", "TAG2")
        assertThat(diffofarrivalFull.taskId()).contains("TASK-ID")
        assertThat(diffofarrivalFull.tdoa()).contains(0.0000136)
        assertThat(diffofarrivalFull.tdoaAmb()).contains(1)
        assertThat(diffofarrivalFull.tdoaUnc()).contains(2e-7)
        assertThat(diffofarrivalFull.transactionId()).contains("TRANSACTION-ID")
        assertThat(diffofarrivalFull.uct()).contains(false)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedDiffofarrivalFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(diffofarrivalFull),
                jacksonTypeRef<DiffofarrivalFull>(),
            )

        assertThat(roundtrippedDiffofarrivalFull).isEqualTo(diffofarrivalFull)
    }
}
