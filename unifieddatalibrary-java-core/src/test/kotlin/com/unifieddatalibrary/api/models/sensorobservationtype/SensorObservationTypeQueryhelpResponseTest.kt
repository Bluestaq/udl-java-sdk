...
internal class SensorObservationTypeQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val sensorObservationTypeQueryhelpResponse = SensorObservationTypeQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(sensorObservationTypeQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(sensorObservationTypeQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(sensorObservationTypeQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedSensorObservationTypeQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sensorObservationTypeQueryhelpResponse), jacksonTypeRef<SensorObservationTypeQueryhelpResponse>())

      assertThat(roundtrippedSensorObservationTypeQueryhelpResponse).isEqualTo(sensorObservationTypeQueryhelpResponse)
    }
}
