...
internal class LocationQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val locationQueryhelpResponse = LocationQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(locationQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(locationQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedLocationQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(locationQueryhelpResponse), jacksonTypeRef<LocationQueryhelpResponse>())
