...
internal class SensorPlanQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val sensorPlanQueryhelpResponse =
            SensorPlanQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(sensorPlanQueryhelpResponse.classificationMarking())
        ...
        assertThat(sensorPlanQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(sensorPlanQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSensorPlanQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sensorPlanQueryhelpResponse),
                jacksonTypeRef<SensorPlanQueryhelpResponse>(),
            )
