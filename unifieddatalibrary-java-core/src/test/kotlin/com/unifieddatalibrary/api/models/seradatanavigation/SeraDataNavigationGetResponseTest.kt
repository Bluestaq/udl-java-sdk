...
internal class SeraDataNavigationGetResponseTest {
    ...
    @Test
    fun create() {
        val seraDataNavigationGetResponse =
            SeraDataNavigationGetResponse.builder()
        ...
        assertThat(seraDataNavigationGetResponse.dataMode())
            .isEqualTo(SeraDataNavigationGetResponse.DataMode.TEST)
        ...
        assertThat(seraDataNavigationGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(seraDataNavigationGetResponse.createdBy()).contains("some.user")
        assertThat(seraDataNavigationGetResponse.hostedForCompanyOrgId())
        ...
        assertThat(seraDataNavigationGetResponse.origNetwork()).contains("OPS1")
        assertThat(seraDataNavigationGetResponse.partnerSpacecraftId())
            .contains("partnerSpacecraftId")
        assertThat(seraDataNavigationGetResponse.payloadType()).contains("WAAS")
        assertThat(seraDataNavigationGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSeraDataNavigationGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(seraDataNavigationGetResponse),
                jacksonTypeRef<SeraDataNavigationGetResponse>(),
            )

        assertThat(roundtrippedSeraDataNavigationGetResponse)
            .isEqualTo(seraDataNavigationGetResponse)
    }
}
