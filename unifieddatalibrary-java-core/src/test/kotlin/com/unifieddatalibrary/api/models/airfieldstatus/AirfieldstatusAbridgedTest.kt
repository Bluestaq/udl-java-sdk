...
internal class AirfieldstatusAbridgedTest {
    ...
    @Test
    fun create() {
        val airfieldstatusAbridged =
            AirfieldstatusAbridged.builder()
        ...
        assertThat(airfieldstatusAbridged.dataMode())
            .isEqualTo(AirfieldstatusAbridged.DataMode.TEST)
        assertThat(airfieldstatusAbridged.idAirfield())
        ...
        assertThat(airfieldstatusAbridged.approvedDate())
        ...
        assertThat(airfieldstatusAbridged.createdAt())
        ...
        assertThat(airfieldstatusAbridged.fuelQtys().getOrNull())
            .containsExactly(263083.6, 286674.9, 18143.69)
        assertThat(airfieldstatusAbridged.fuelTypes().getOrNull())
        ...
        assertThat(airfieldstatusAbridged.mheTypes().getOrNull())
            .containsExactly("30k", "AT", "60k")
        ...
        assertThat(airfieldstatusAbridged.reviewedDate())
        ...
        assertThat(airfieldstatusAbridged.rwyMarkings().getOrNull())
            .containsExactly("Aiming Point", "Threshold")
        assertThat(airfieldstatusAbridged.slotTypesReq().getOrNull())
            .containsExactly("PARKING", "WORKING", "LANDING")
        assertThat(airfieldstatusAbridged.sourceDl()).contains("AXE")
        assertThat(airfieldstatusAbridged.surveyDate())
    ...
    fun roundtrip() {
        ...
        val roundtrippedAirfieldstatusAbridged =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(airfieldstatusAbridged),
                jacksonTypeRef<AirfieldstatusAbridged>(),
            )
