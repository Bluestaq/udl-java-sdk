...
internal class GnssObservationsetQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val gnssObservationsetQueryhelpResponse = GnssObservationsetQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(gnssObservationsetQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(gnssObservationsetQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(gnssObservationsetQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedGnssObservationsetQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(gnssObservationsetQueryhelpResponse), jacksonTypeRef<GnssObservationsetQueryhelpResponse>())

      assertThat(roundtrippedGnssObservationsetQueryhelpResponse).isEqualTo(gnssObservationsetQueryhelpResponse)
    }
}
