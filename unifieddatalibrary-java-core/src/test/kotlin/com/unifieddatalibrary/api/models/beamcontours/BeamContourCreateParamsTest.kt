...
internal class BeamContourCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(BeamContourCreateParams.DataMode.TEST)
        assertThat(body.idBeam()).isEqualTo("REF-BEAM-ID")
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.type()).isEqualTo(BeamContourCreateParams.Type.BORESIGHT)
        assertThat(body.id()).contains("BEAMCONTOUR-ID")
