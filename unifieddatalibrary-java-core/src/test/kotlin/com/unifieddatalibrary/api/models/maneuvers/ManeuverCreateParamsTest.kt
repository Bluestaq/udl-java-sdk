...
internal class ManeuverCreateParamsTest {
    ...
    fun create() {
        ManeuverCreateParams.builder()
            ...
            .postEventElset(
                ManeuverCreateParams.PostEventElset.builder()
                    .classificationMarking("U")
            ...
            .postEventStateVector(
                ManeuverCreateParams.PostEventStateVector.builder()
                    .classificationMarking("U")
                    ...
                    .covReferenceFrame(
                        ManeuverCreateParams.PostEventStateVector.CovReferenceFrame.J2000
                    )
                    .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                    .createdBy("some.user")
                    ...
                    .addSourcedDataType(
                        ManeuverCreateParams.PostEventStateVector.SourcedDataType.RADAR
                    )
                    .sourceDl("AXE")
                    .srpArea(4.311)
                    .stepMode("AUTO")
            ...
            .preEventElset(
                ManeuverCreateParams.PreEventElset.builder()
                    .classificationMarking("U")
            ...
            .preEventStateVector(
                ManeuverCreateParams.PreEventStateVector.builder()
                    .classificationMarking("U")
                    ...
                    .covMethod("CALCULATED")
                    .covReferenceFrame(
                        ManeuverCreateParams.PreEventStateVector.CovReferenceFrame.J2000
                    )
                    .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                    .createdBy("some.user")
                    .descriptor("descriptor")
                    ...
                    .addSourcedData("DATA2")
                    .addSourcedDataType(
                        ManeuverCreateParams.PreEventStateVector.SourcedDataType.RADAR
                    )
                    .sourceDl("AXE")
                    .srpArea(4.311)
                    .stepMode("AUTO")
    ...
    fun body() {
            ...
            ManeuverCreateParams.builder()
                ...
                .postEventElset(
                    ManeuverCreateParams.PostEventElset.builder()
                        ...
                        .addSourcedData("OBSERVATION_UUID2")
                        .addSourcedDataType(
                            ManeuverCreateParams.PostEventElset.SourcedDataType.RADAR
                        )
                        .addSourcedDataType(ManeuverCreateParams.PostEventElset.SourcedDataType.RF)
                        .sourceDl("AXE")
                        .addTag("PROVIDER_TAG1")
                ...
                .postEventStateVector(
                    ManeuverCreateParams.PostEventStateVector.builder()
                        ...
                        .recOdSpan(3.5)
                        .referenceFrame(
                            ManeuverCreateParams.PostEventStateVector.ReferenceFrame.J2000
                        )
                        .residualsAcc(99.5)
                        .revNo(7205)
                        .rms(0.991)
                ...
                .preEventElset(
                    ManeuverCreateParams.PreEventElset.builder()
                        ...
                        .addSourcedData("OBSERVATION_UUID2")
                        .addSourcedDataType(
                            ManeuverCreateParams.PreEventElset.SourcedDataType.RADAR
                        )
                        .addSourcedDataType(ManeuverCreateParams.PreEventElset.SourcedDataType.RF)
                        .sourceDl("AXE")
                        .addTag("PROVIDER_TAG1")
                ...
                .preEventStateVector(
                    ManeuverCreateParams.PreEventStateVector.builder()
                        ...
                        .recOdSpan(3.5)
                        .referenceFrame(
                            ManeuverCreateParams.PreEventStateVector.ReferenceFrame.J2000
                        )
                        .residualsAcc(99.5)
                        .revNo(7205)
                        .rms(0.991)
        ...
        assertThat(body.postEventElset())
            .contains(
                ManeuverCreateParams.PostEventElset.builder()
                    .classificationMarking("U")
                    .dataMode(ManeuverCreateParams.PostEventElset.DataMode.TEST)
        ...
        assertThat(body.postEventStateVector())
            .contains(
                ManeuverCreateParams.PostEventStateVector.builder()
                    .classificationMarking("U")
                    .dataMode(ManeuverCreateParams.PostEventStateVector.DataMode.TEST)
        ...
        assertThat(body.preEventStateVector())
            .contains(
                ManeuverCreateParams.PreEventStateVector.builder()
                    .classificationMarking("U")
                    .dataMode(ManeuverCreateParams.PreEventStateVector.DataMode.TEST)
        ...
        assertThat(body.sourcedData().getOrNull())
            .containsExactly("SOURCEDDATA-ID", "SOURCEDDATA-ID")
        assertThat(body.sourcedDataTypes().getOrNull())
            .containsExactly(
                ManeuverCreateParams.SourcedDataType.EO,
                ManeuverCreateParams.SourcedDataType.RADAR,
            )
