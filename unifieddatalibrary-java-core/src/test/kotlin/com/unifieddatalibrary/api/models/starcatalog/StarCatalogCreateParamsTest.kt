...
internal class StarCatalogCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.astrometryOrigin())
            .isEqualTo(StarCatalogCreateParams.AstrometryOrigin.GAIADR3)
        ...
        assertThat(body.allWisew1Mag()).contains(15.782)
        assertThat(body.allWisew1MagUnc()).contains(0.042)
        assertThat(body.allWisew2Mag()).contains(16.523)
        assertThat(body.allWisew2MagUnc()).contains(0.021)
        assertThat(body.allWisew3Mag()).contains(11.541)
        assertThat(body.allWisew3MagUnc()).contains(0.159)
        assertThat(body.allWisew4Mag()).contains(9.007)
        assertThat(body.allWisew4MagUnc()).contains(0.468)
