...
internal class SoiObservationSetUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      SoiObservationSetUnvalidatedPublishParams.builder()
          .addBody(SoiObservationSetUnvalidatedPublishParams.Body.builder()
              ...
              .addCalibration(SoiObservationSetUnvalidatedPublishParams.Body.Calibration.builder()
                  .calBgIntensity(1.1)
              ...
              .addOpticalSoiObservationList(SoiObservationSetUnvalidatedPublishParams.Body.OpticalSoiObservationList.builder()
              ...
              .polarAngleEnd(1.1)
              .polarAngleStart(1.1)
              .addRadarSoiObservationList(SoiObservationSetUnvalidatedPublishParams.Body.RadarSoiObservationList.builder()
                  .obStartTime(OffsetDateTime.parse("2018-01-01T16:00:00.888456Z"))
                  .aspectAngles(listOf(
                    4.278,
                    4.278,
                  ...
                  .build())
              .referenceFrame(SoiObservationSetUnvalidatedPublishParams.Body.ReferenceFrame.J2000)
              .satelliteName("TITAN 3C TRANSTAGE R/B")
              .satNo(101)
              .senalt(1.1)
              .senlat(45.1)
              .senlon(179.1)
              .senReferenceFrame(SoiObservationSetUnvalidatedPublishParams.Body.SenReferenceFrame.J2000)
    ...
    @Test
    fun body() {
      val params = SoiObservationSetUnvalidatedPublishParams.builder()
          .addBody(SoiObservationSetUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(SoiObservationSetUnvalidatedPublishParams.Body.DataMode.TEST)
              .numObs(1)
      ...
      assertThat(body).containsExactly(SoiObservationSetUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(SoiObservationSetUnvalidatedPublishParams.Body.DataMode.TEST)
          .numObs(1)
          .source("Bluestaq")
