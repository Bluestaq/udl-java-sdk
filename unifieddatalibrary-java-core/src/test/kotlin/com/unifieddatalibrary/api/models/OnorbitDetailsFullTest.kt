...
internal class OnorbitDetailsFullTest {
    ...
    fun create() {
        ...
        assertThat(onorbitDetailsFull.createdAt())
        ...
        assertThat(onorbitDetailsFull.depNames().getOrNull())
        ...
        assertThat(onorbitDetailsFull.lastObTime())
        ...
        assertThat(onorbitDetailsFull.missionTypes().getOrNull())
        ...
        assertThat(onorbitDetailsFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbitDetailsFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbitDetailsFull),
                jacksonTypeRef<OnorbitDetailsFull>(),
            )
