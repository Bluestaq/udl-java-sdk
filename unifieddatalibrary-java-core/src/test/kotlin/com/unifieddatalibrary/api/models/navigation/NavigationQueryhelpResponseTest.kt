...
internal class NavigationQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val navigationQueryhelpResponse =
            NavigationQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(navigationQueryhelpResponse.classificationMarking())
        ...
        assertThat(navigationQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(navigationQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedNavigationQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(navigationQueryhelpResponse),
                jacksonTypeRef<NavigationQueryhelpResponse>(),
            )
