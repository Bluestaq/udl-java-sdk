...
internal class AircraftStatusRemarkQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val aircraftStatusRemarkQueryhelpResponse = AircraftStatusRemarkQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(aircraftStatusRemarkQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(aircraftStatusRemarkQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(aircraftStatusRemarkQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAircraftStatusRemarkQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(aircraftStatusRemarkQueryhelpResponse), jacksonTypeRef<AircraftStatusRemarkQueryhelpResponse>())

      assertThat(roundtrippedAircraftStatusRemarkQueryhelpResponse).isEqualTo(aircraftStatusRemarkQueryhelpResponse)
    }
}
