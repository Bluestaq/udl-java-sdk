...
internal class RfBandTypeGetResponseTest {
    ...
    @Test
    fun create() {
      val rfBandTypeGetResponse = RfBandTypeGetResponse.builder()
          .id("Ku")
      ...
      assertThat(rfBandTypeGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(rfBandTypeGetResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfBandTypeGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rfBandTypeGetResponse), jacksonTypeRef<RfBandTypeGetResponse>())
