...
internal class H3GeoHexCellQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val h3GeoHexCellQueryhelpResponse = H3GeoHexCellQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(h3GeoHexCellQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(h3GeoHexCellQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(h3GeoHexCellQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedH3GeoHexCellQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(h3GeoHexCellQueryhelpResponse), jacksonTypeRef<H3GeoHexCellQueryhelpResponse>())

      assertThat(roundtrippedH3GeoHexCellQueryhelpResponse).isEqualTo(h3GeoHexCellQueryhelpResponse)
    }
}
