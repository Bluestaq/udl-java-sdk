...
internal class RfEmitterDetailCreateParamsTest {
                ...
                RfEmitterDetailCreateParams.Ttp.builder()
                    ...
                    .addTechniqueDefinition(
                        RfEmitterDetailCreateParams.Ttp.TechniqueDefinition.builder()
                            .name("SIGNAL TUNE")
                            .addParamDefinition(
                                RfEmitterDetailCreateParams.Ttp.TechniqueDefinition.ParamDefinition
                                    .builder()
                                    .defaultValue("444.0")
                                    .max(1000.1)
                                    .min(0.1)
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(RfEmitterDetailCreateParams.DataMode.TEST)
