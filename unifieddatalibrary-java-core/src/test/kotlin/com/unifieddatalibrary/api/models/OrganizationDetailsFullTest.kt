...
internal class OrganizationDetailsFullTest {
    ...
    fun create() {
        ...
        assertThat(organizationDetailsFull.dataMode())
            .isEqualTo(OrganizationDetailsFull.DataMode.TEST)
        ...
        assertThat(organizationDetailsFull.createdAt())
        ...
        assertThat(organizationDetailsFull.financialYearEndDate())
        ...
        assertThat(organizationDetailsFull.tags().getOrNull())
            .containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
        assertThat(organizationDetailsFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedOrganizationDetailsFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(organizationDetailsFull),
                jacksonTypeRef<OrganizationDetailsFull>(),
            )
