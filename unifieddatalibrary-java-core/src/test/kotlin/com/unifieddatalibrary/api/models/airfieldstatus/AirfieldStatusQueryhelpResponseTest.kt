...
internal class AirfieldStatusQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val airfieldStatusQueryhelpResponse =
            AirfieldStatusQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(airfieldStatusQueryhelpResponse.classificationMarking())
        ...
        assertThat(airfieldStatusQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(airfieldStatusQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedAirfieldStatusQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(airfieldStatusQueryhelpResponse),
                jacksonTypeRef<AirfieldStatusQueryhelpResponse>(),
            )

        assertThat(roundtrippedAirfieldStatusQueryhelpResponse)
            .isEqualTo(airfieldStatusQueryhelpResponse)
    }
}
