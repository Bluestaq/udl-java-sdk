...
internal class VideoGetPlayerStreamingInfoResponseTest {
    ...
    @Test
    fun create() {
        val videoGetPlayerStreamingInfoResponse =
            VideoGetPlayerStreamingInfoResponse.builder()
        ...
        assertThat(videoGetPlayerStreamingInfoResponse.dataMode())
            .isEqualTo(VideoGetPlayerStreamingInfoResponse.DataMode.TEST)
        ...
        assertThat(videoGetPlayerStreamingInfoResponse.createdAt())
        ...
        assertThat(videoGetPlayerStreamingInfoResponse.startTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoGetPlayerStreamingInfoResponse.stopTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoGetPlayerStreamingInfoResponse.videoUrls().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedVideoGetPlayerStreamingInfoResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(videoGetPlayerStreamingInfoResponse),
                jacksonTypeRef<VideoGetPlayerStreamingInfoResponse>(),
            )

        assertThat(roundtrippedVideoGetPlayerStreamingInfoResponse)
            .isEqualTo(videoGetPlayerStreamingInfoResponse)
    }
}
