...
internal class AircraftAbridgedTest {
    ...
    @Test
    fun create() {
        val aircraftAbridged =
            AircraftAbridged.builder()
        ...
        assertThat(aircraftAbridged.createdAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedAircraftAbridged =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(aircraftAbridged),
                jacksonTypeRef<AircraftAbridged>(),
            )
