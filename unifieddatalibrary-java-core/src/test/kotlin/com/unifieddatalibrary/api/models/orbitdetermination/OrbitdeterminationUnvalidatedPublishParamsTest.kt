...
internal class OrbitdeterminationUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      OrbitdeterminationUnvalidatedPublishParams.builder()
          .addBody(OrbitdeterminationUnvalidatedPublishParams.Body.builder()
              ...
              .aprioriElset(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriElset.builder()
                  .classificationMarking("U")
                  .dataMode(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriElset.DataMode.TEST)
                  ...
                  .addSourcedDataType(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriElset.SourcedDataType.RADAR)
                  .addSourcedDataType(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriElset.SourcedDataType.RF)
                  .sourceDl("AXE")
              ...
              .aprioriStateVector(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriStateVector.builder()
                  .classificationMarking("U")
                  .dataMode(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriStateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriStateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriStateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(OrbitdeterminationUnvalidatedPublishParams.Body.AprioriStateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
    ...
    @Test
    fun body() {
      val params = OrbitdeterminationUnvalidatedPublishParams.builder()
          .addBody(OrbitdeterminationUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(OrbitdeterminationUnvalidatedPublishParams.Body.DataMode.TEST)
              .endTime(OffsetDateTime.parse("2023-08-28T15:20:21.247192Z"))
      ...
      assertThat(body).containsExactly(OrbitdeterminationUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationUnvalidatedPublishParams.Body.DataMode.TEST)
          .endTime(OffsetDateTime.parse("2023-08-28T15:20:21.247192Z"))
          .initialOd(false)
