...
internal class NavigationCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = NavigationCreateParams.builder()
          .classificationMarking("U")
          .dataMode(NavigationCreateParams.DataMode.TEST)
          .name("NAME")
          .source("Bluestaq")
      ...
      assertThat(body.dataMode()).isEqualTo(NavigationCreateParams.DataMode.TEST)
      assertThat(body.name()).isEqualTo("NAME")
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.id()).contains("NAVIGATION-ID")
