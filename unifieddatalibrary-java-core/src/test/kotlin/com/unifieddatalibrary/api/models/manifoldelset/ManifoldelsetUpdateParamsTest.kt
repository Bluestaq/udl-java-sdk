...
internal class ManifoldelsetUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = ManifoldelsetUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(ManifoldelsetUpdateParams.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(ManifoldelsetUpdateParams.DataMode.TEST)
      ...
      assertThat(body.bodyId()).contains("MANIFOLDELSET-ID")
