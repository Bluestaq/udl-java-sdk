...
internal class DiplomaticClearanceCreateBulkParamsTest {

    @Test
    fun create() {
      DiplomaticClearanceCreateBulkParams.builder()
          .addBody(DiplomaticClearanceCreateBulkParams.Body.builder()
              ...
              .createdBy("some.user")
              .addDiplomaticClearanceDetail(DiplomaticClearanceCreateBulkParams.Body.DiplomaticClearanceDetail.builder()
                  .action("O")
                  .altCountryCode("IZ")
                  ...
                  .build())
              .addDiplomaticClearanceRemark(DiplomaticClearanceCreateBulkParams.Body.DiplomaticClearanceRemark.builder()
    ...
    @Test
    fun body() {
      val params = DiplomaticClearanceCreateBulkParams.builder()
          .addBody(DiplomaticClearanceCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(DiplomaticClearanceCreateBulkParams.Body.DataMode.TEST)
              .firstDepDate(OffsetDateTime.parse("2024-01-01T01:01:01.123Z"))
      ...
      assertThat(body).containsExactly(DiplomaticClearanceCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(DiplomaticClearanceCreateBulkParams.Body.DataMode.TEST)
          .firstDepDate(OffsetDateTime.parse("2024-01-01T01:01:01.123Z"))
          .idMission("0dba1363-2d09-49fa-a784-4bb4cbb1674a")
