...
internal class RfEmitterUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = RfEmitterUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(RfEmitterUpdateParams.DataMode.TEST)
          .name("RF_NAME")
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(RfEmitterUpdateParams.DataMode.TEST)
      assertThat(body.name()).isEqualTo("RF_NAME")
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.bodyId()).contains("RFEMITTER-ID")
