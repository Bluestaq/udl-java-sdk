...
internal class TrackQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val trackQueryhelpResponse =
            TrackQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(trackQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedTrackQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(trackQueryhelpResponse),
                jacksonTypeRef<TrackQueryhelpResponse>(),
            )
