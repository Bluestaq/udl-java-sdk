...
internal class SolarArrayFullTest {
    ...
    fun create() {
        ...
        assertThat(solarArrayFull.createdAt())
        ...
        assertThat(solarArrayFull.origNetwork()).contains("OPS1")
        assertThat(solarArrayFull.solarArrayDetails().getOrNull())
            .containsExactly(
                SolarArrayDetailsFull.builder()
                    .classificationMarking("U")
                    .dataMode(SolarArrayDetailsFull.DataMode.TEST)
        ...
        assertThat(solarArrayFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSolarArrayFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(solarArrayFull),
                jacksonTypeRef<SolarArrayFull>(),
            )
