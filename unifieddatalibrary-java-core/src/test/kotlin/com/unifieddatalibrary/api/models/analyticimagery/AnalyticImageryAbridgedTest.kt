...
internal class AnalyticImageryAbridgedTest {
    ...
    @Test
    fun create() {
      val analyticImageryAbridged = AnalyticImageryAbridged.builder()
      ...
      assertThat(analyticImageryAbridged.dataMode()).isEqualTo(AnalyticImageryAbridged.DataMode.TEST)
      ...
      assertThat(analyticImageryAbridged.msgTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(analyticImageryAbridged.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(analyticImageryAbridged.andims()).contains(2)
      assertThat(analyticImageryAbridged.annLims().getOrNull()).containsExactly(listOf(
        1, 1
      ), listOf(
        1, 2
      ), listOf(
      ...
      assertThat(analyticImageryAbridged.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(analyticImageryAbridged.atype()).contains("POLYGON")
      assertThat(analyticImageryAbridged.checksumValue()).contains("123")
      assertThat(analyticImageryAbridged.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(analyticImageryAbridged.createdBy()).contains("some.user")
      assertThat(analyticImageryAbridged.dataStart()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(analyticImageryAbridged.dataStop()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(analyticImageryAbridged.origNetwork()).contains("TST1")
      ...
      assertThat(analyticImageryAbridged.srcIds().getOrNull()).containsExactly("DOA_ID", "DWELL_ID")
      ...
      assertThat(analyticImageryAbridged.transactionId()).contains("a7bdef1f-5a4f-4716-bee4-7a1e0ec7d35a")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAnalyticImageryAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(analyticImageryAbridged), jacksonTypeRef<AnalyticImageryAbridged>())
