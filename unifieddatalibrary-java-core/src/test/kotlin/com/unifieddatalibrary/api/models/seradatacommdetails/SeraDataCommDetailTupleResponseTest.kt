...
internal class SeraDataCommDetailTupleResponseTest {
    ...
    @Test
    fun create() {
        val seraDataCommDetailTupleResponse =
            SeraDataCommDetailTupleResponse.builder()
        ...
        assertThat(seraDataCommDetailTupleResponse.dataMode())
            .isEqualTo(SeraDataCommDetailTupleResponse.DataMode.TEST)
        ...
        assertThat(seraDataCommDetailTupleResponse.createdAt())
        ...
        assertThat(seraDataCommDetailTupleResponse.estHtsTotalUserDownlinkBandwidthPerBeam())
            .contains(1.23)
        assertThat(seraDataCommDetailTupleResponse.estHtsTotalUserUplinkBandwidthPerBeam())
            .contains(1.23)
        ...
        assertThat(seraDataCommDetailTupleResponse.hostedForCompanyOrgId())
        ...
        assertThat(seraDataCommDetailTupleResponse.manufacturerOrgId())
        ...
        assertThat(seraDataCommDetailTupleResponse.origNetwork()).contains("OPS1")
        ...
        assertThat(seraDataCommDetailTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSeraDataCommDetailTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(seraDataCommDetailTupleResponse),
                jacksonTypeRef<SeraDataCommDetailTupleResponse>(),
            )

        assertThat(roundtrippedSeraDataCommDetailTupleResponse)
            .isEqualTo(seraDataCommDetailTupleResponse)
    }
}
