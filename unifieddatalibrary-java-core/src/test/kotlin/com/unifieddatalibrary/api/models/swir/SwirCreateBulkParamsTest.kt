...
internal class SwirCreateBulkParamsTest {

    @Test
    fun create() {
      SwirCreateBulkParams.builder()
          .addBody(SwirCreateBulkParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = SwirCreateBulkParams.builder()
          .addBody(SwirCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(SwirCreateBulkParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(SwirCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(SwirCreateBulkParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .ts(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
