...
internal class EquipmentRemarkAbridgedTest {
    ...
    @Test
    fun create() {
      val equipmentRemarkAbridged = EquipmentRemarkAbridged.builder()
      ...
      assertThat(equipmentRemarkAbridged.dataMode()).isEqualTo(EquipmentRemarkAbridged.DataMode.TEST)
      ...
      assertThat(equipmentRemarkAbridged.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedEquipmentRemarkAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(equipmentRemarkAbridged), jacksonTypeRef<EquipmentRemarkAbridged>())
