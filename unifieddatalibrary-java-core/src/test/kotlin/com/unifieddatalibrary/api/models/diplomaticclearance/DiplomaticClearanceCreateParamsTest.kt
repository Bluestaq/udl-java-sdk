...
internal class DiplomaticClearanceCreateParamsTest {
    ...
    fun create() {
      DiplomaticClearanceCreateParams.builder()
          ...
          .createdBy("some.user")
          .addDiplomaticClearanceDetail(DiplomaticClearanceCreateParams.DiplomaticClearanceDetail.builder()
              .action("O")
              .altCountryCode("IZ")
              ...
              .build())
          .addDiplomaticClearanceRemark(DiplomaticClearanceCreateParams.DiplomaticClearanceRemark.builder()
    ...
    @Test
    fun body() {
      val params = DiplomaticClearanceCreateParams.builder()
          .classificationMarking("U")
          .dataMode(DiplomaticClearanceCreateParams.DataMode.TEST)
          .firstDepDate(OffsetDateTime.parse("2024-01-01T01:01:01.123Z"))
          .idMission("0dba1363-2d09-49fa-a784-4bb4cbb1674a")
      ...
      assertThat(body.diplomaticClearanceDetails().getOrNull()).containsExactly(DiplomaticClearanceCreateParams.DiplomaticClearanceDetail.builder()
          .action("O")
          .altCountryCode("IZ")
          .clearanceId("MFMW225662GHQ")
          .clearanceRemark("Clearance remarks")
          ...
          .windowRemark("Period remarks")
          .build())
      assertThat(body.diplomaticClearanceRemarks().getOrNull()).containsExactly(DiplomaticClearanceCreateParams.DiplomaticClearanceRemark.builder()
          .date(OffsetDateTime.parse("2024-01-01T01:01:01.123Z"))
          .gdssRemarkId("GDSSREMARK-ID")
          .text("Example mission remarks.")
          .user("John Doe")
