...
internal class RfObservationCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.detectionStatuses().getOrNull())
        ...
        assertThat(body.fftImagCoeffs().getOrNull()).containsExactly(1.1, 2.2)
        assertThat(body.fftRealCoeffs().getOrNull()).containsExactly(1.1, 2.2)
        ...
        assertThat(body.jamBands().getOrNull()).containsExactly("L1", "L2")
        assertThat(body.jamToSigRatios().getOrNull()).containsExactly(54.1, 34.1)
