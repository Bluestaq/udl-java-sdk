...
internal class SeradataOpticalPayloadUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(SeradataOpticalPayloadUpdateParams.DataMode.TEST)
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.spacecraftId()).isEqualTo("spacecraftId")
        assertThat(body.bodyId()).contains("SERADATAOPTICALPAYLOAD-ID")
