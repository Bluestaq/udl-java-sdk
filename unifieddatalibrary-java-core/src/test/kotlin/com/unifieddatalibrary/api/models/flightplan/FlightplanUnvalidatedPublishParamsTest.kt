...
internal class FlightplanUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      FlightplanUnvalidatedPublishParams.builder()
          .addBody(FlightplanUnvalidatedPublishParams.Body.builder()
              .arrAirfield("KCHS")
              .classificationMarking("U")
              .dataMode(FlightplanUnvalidatedPublishParams.Body.DataMode.TEST)
              .depAirfield("KSLV")
              .genTs(OffsetDateTime.parse("2023-05-01T01:01:01.123Z"))
              .source("Bluestaq")
              .id("c44b0a80-9fef-63d9-6267-79037fb93e4c")
              .aircraftMds("KC-130 HERCULES")
              .addAirRefuelEvent(FlightplanUnvalidatedPublishParams.Body.AirRefuelEvent.builder()
                  .arDegrade(3.1)
              ...
              .addFlightPlanMessage(FlightplanUnvalidatedPublishParams.Body.FlightPlanMessage.builder()
                  .msgText("Message text")
                  .routePath("PRIMARY")
                  .severity("SEVERE")
                  .wpNum("20")
                  .build())
              .addFlightPlanPointGroup(FlightplanUnvalidatedPublishParams.Body.FlightPlanPointGroup.builder()
                  .avgFuelFlow(19693.1)
                  ...
                  .etopsTempDev(9.1)
                  .etopsTime("01:23")
                  .addFlightPlanPoint(FlightplanUnvalidatedPublishParams.Body.FlightPlanPointGroup.FlightPlanPoint.builder()
                  ...
                  .build())
              .addFlightPlanWaypoint(FlightplanUnvalidatedPublishParams.Body.FlightPlanWaypoint.builder()
                  .type("COMMENT")
                  .waypointName("KCHS")
    ...
    @Test
    fun body() {
      val params = FlightplanUnvalidatedPublishParams.builder()
          .addBody(FlightplanUnvalidatedPublishParams.Body.builder()
              .arrAirfield("KCHS")
              .classificationMarking("U")
              .dataMode(FlightplanUnvalidatedPublishParams.Body.DataMode.TEST)
      ...
      assertThat(body).containsExactly(FlightplanUnvalidatedPublishParams.Body.builder()
          .arrAirfield("KCHS")
          .classificationMarking("U")
          .dataMode(FlightplanUnvalidatedPublishParams.Body.DataMode.TEST)
          .depAirfield("KSLV")
