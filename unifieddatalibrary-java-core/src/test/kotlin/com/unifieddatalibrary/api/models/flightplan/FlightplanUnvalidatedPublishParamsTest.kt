...
internal class FlightplanUnvalidatedPublishParamsTest {
    ...
    fun create() {
        FlightplanUnvalidatedPublishParams.builder()
            .addBody(
                FlightplanUnvalidatedPublishParams.Body.builder()
                    .arrAirfield("KCHS")
                    ...
                    .addAirRefuelEvent(
                        FlightplanUnvalidatedPublishParams.Body.AirRefuelEvent.builder()
                            .arDegrade(3.1)
                    ...
                    .addFlightPlanMessage(
                        FlightplanUnvalidatedPublishParams.Body.FlightPlanMessage.builder()
                    ...
                    .addFlightPlanPointGroup(
                        FlightplanUnvalidatedPublishParams.Body.FlightPlanPointGroup.builder()
                            .avgFuelFlow(19693.1)
                            ...
                            .etopsTime("01:23")
                            .addFlightPlanPoint(
                                FlightplanUnvalidatedPublishParams.Body.FlightPlanPointGroup
                                    .FlightPlanPoint
                                    .builder()
                    ...
                    .addFlightPlanWaypoint(
                        FlightplanUnvalidatedPublishParams.Body.FlightPlanWaypoint.builder()
                            .type("COMMENT")
                            .waypointName("KCHS")
