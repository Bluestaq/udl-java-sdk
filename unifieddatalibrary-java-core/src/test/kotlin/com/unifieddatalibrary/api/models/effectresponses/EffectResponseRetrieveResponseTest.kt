...
internal class EffectResponseRetrieveResponseTest {
    ...
    @Test
    fun create() {
        val effectResponseRetrieveResponse =
            EffectResponseRetrieveResponse.builder()
        ...
        assertThat(effectResponseRetrieveResponse.dataMode())
            .isEqualTo(EffectResponseRetrieveResponse.DataMode.TEST)
        ...
        assertThat(effectResponseRetrieveResponse.actionsList().getOrNull())
            .containsExactly(
                EffectResponseActionsListFull.builder()
                    .actionActorSrcId("ACTIONACTORSRC-ID")
                    .actionActorSrcType("AIRCRAFT")
        ...
        assertThat(effectResponseRetrieveResponse.coaMetrics().getOrNull())
            .containsExactly(
                EffectResponseMetricsFull.builder()
                    .domainValue(10.1)
                    .metricType("GoalAchievement")
        ...
        assertThat(effectResponseRetrieveResponse.createdAt())
        ...
        assertThat(effectResponseRetrieveResponse.decisionDeadline())
            .contains(OffsetDateTime.parse("2021-01-01T00:00:00.123456Z"))
        assertThat(effectResponseRetrieveResponse.externalActions().getOrNull())
            .containsExactly("ACTION1", "ACTION2")
        assertThat(effectResponseRetrieveResponse.externalRequestId())
            .contains("EXTERNALREQUEST-ID")
        ...
        assertThat(effectResponseRetrieveResponse.origNetwork()).contains("OPS1")
        ...
        assertThat(effectResponseRetrieveResponse.redTimeToOverhead())
            .contains(OffsetDateTime.parse("2021-01-01T00:00:00.123456Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedEffectResponseRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(effectResponseRetrieveResponse),
                jacksonTypeRef<EffectResponseRetrieveResponse>(),
            )

        assertThat(roundtrippedEffectResponseRetrieveResponse)
            .isEqualTo(effectResponseRetrieveResponse)
    }
}
