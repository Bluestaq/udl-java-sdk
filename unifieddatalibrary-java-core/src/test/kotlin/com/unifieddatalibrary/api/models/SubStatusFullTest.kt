...
internal class SubStatusFullTest {
    ...
    @Test
    fun create() {
      val subStatusFull = SubStatusFull.builder()
      ...
      assertThat(subStatusFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(subStatusFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSubStatusFull = jsonMapper.readValue(jsonMapper.writeValueAsString(subStatusFull), jacksonTypeRef<SubStatusFull>())
