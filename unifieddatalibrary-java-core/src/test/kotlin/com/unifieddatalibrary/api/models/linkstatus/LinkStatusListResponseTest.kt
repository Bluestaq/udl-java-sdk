...
internal class LinkStatusListResponseTest {
    ...
    @Test
    fun create() {
      val linkStatusListResponse = LinkStatusListResponse.builder()
      ...
      assertThat(linkStatusListResponse.dataMode()).isEqualTo(LinkStatusListResponse.DataMode.TEST)
      ...
      assertThat(linkStatusListResponse.linkStartTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(linkStatusListResponse.linkStopTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      ...
      assertThat(linkStatusListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(linkStatusListResponse.origNetwork()).contains("ORIG")
    ...
    fun roundtrip() {
      ...
      val roundtrippedLinkStatusListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(linkStatusListResponse), jacksonTypeRef<LinkStatusListResponse>())
