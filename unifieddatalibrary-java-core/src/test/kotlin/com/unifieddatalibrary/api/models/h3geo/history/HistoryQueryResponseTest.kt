...
internal class HistoryQueryResponseTest {
    ...
    fun create() {
      ...
      assertThat(historyQueryResponse.startTime()).isEqualTo(OffsetDateTime.parse("2024-07-02T00:00:00.123Z"))
      ...
      assertThat(historyQueryResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(historyQueryResponse.createdBy()).contains("some.user")
      assertThat(historyQueryResponse.endTime()).contains(OffsetDateTime.parse("2024-07-03T00:00:00.123Z"))
