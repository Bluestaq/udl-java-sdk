...
internal class AntennaDetailsAbridgedTest {
    ...
    @Test
    fun create() {
        val antennaDetailsAbridged =
            AntennaDetailsAbridged.builder()
        ...
        assertThat(antennaDetailsAbridged.dataMode())
            .isEqualTo(AntennaDetailsAbridged.DataMode.TEST)
        ...
        assertThat(antennaDetailsAbridged.createdAt())
        ...
        assertThat(antennaDetailsAbridged.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedAntennaDetailsAbridged =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(antennaDetailsAbridged),
                jacksonTypeRef<AntennaDetailsAbridged>(),
            )
