...
internal class HistoryRetrieveResponseTest {
    ...
    fun create() {
      ...
      assertThat(historyRetrieveResponse.endTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(historyRetrieveResponse.inactiveDate()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
