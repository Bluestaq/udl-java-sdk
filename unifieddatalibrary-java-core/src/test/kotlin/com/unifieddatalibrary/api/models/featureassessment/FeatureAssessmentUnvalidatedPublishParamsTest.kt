...
internal class FeatureAssessmentUnvalidatedPublishParamsTest {
    ...
    fun create() {
      FeatureAssessmentUnvalidatedPublishParams.builder()
          .addBody(FeatureAssessmentUnvalidatedPublishParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = FeatureAssessmentUnvalidatedPublishParams.builder()
          .addBody(FeatureAssessmentUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(FeatureAssessmentUnvalidatedPublishParams.Body.DataMode.TEST)
              .featureTs(OffsetDateTime.parse("2024-06-22T17:53:06.123Z"))
      ...
      assertThat(body).containsExactly(FeatureAssessmentUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(FeatureAssessmentUnvalidatedPublishParams.Body.DataMode.TEST)
          .featureTs(OffsetDateTime.parse("2024-06-22T17:53:06.123Z"))
          .featureUoM("MHz")
