...
internal class SensorPlanCreateParamsTest {
    ...
    fun create() {
      SensorPlanCreateParams.builder()
          ...
          .type("PLAN")
          .id("SENSORPLAN-ID")
          .addCollectRequest(SensorPlanCreateParams.CollectRequest.builder()
              .classificationMarking("U")
              ...
              .eccentricity(1.1)
              .el(1.1)
              .elset(SensorPlanCreateParams.CollectRequest.Elset.builder()
                  .classificationMarking("U")
                  ...
                  .addSourcedDataType(SensorPlanCreateParams.CollectRequest.Elset.SourcedDataType.RADAR)
                  .addSourcedDataType(SensorPlanCreateParams.CollectRequest.Elset.SourcedDataType.RF)
                  .sourceDl("AXE")
              ...
              .srchInc(1.1)
              .srchPattern("SCAN")
              .stateVector(SensorPlanCreateParams.CollectRequest.StateVector.builder()
                  .classificationMarking("U")
                  .dataMode(SensorPlanCreateParams.CollectRequest.StateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(SensorPlanCreateParams.CollectRequest.StateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(SensorPlanCreateParams.CollectRequest.StateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(SensorPlanCreateParams.CollectRequest.StateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
    ...
    @Test
    fun body() {
      val params = SensorPlanCreateParams.builder()
          .classificationMarking("U")
          .dataMode(SensorPlanCreateParams.DataMode.TEST)
          .recType("COLLECT")
          .source("Bluestaq")
      ...
      assertThat(body.dataMode()).isEqualTo(SensorPlanCreateParams.DataMode.TEST)
      assertThat(body.recType()).isEqualTo("COLLECT")
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.startTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(body.type()).isEqualTo("PLAN")
      assertThat(body.id()).contains("SENSORPLAN-ID")
      assertThat(body.collectRequests().getOrNull()).containsExactly(SensorPlanCreateParams.CollectRequest.builder()
          .classificationMarking("U")
          .dataMode(SensorPlanCreateParams.CollectRequest.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(body.customer()).contains("CUSTOMER")
      ...
      assertThat(body.purpose()).contains("Example purpose")
      assertThat(body.reqTotal()).contains(2)
      assertThat(body.senNetwork()).contains("NETWORK")
