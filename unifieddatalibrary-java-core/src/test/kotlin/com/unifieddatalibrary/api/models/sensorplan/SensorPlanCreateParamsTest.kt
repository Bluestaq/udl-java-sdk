...
internal class SensorPlanCreateParamsTest {
                ...
                SensorPlanCreateParams.CollectRequest.builder()
                    ...
                    .elset(
                        SensorPlanCreateParams.CollectRequest.Elset.builder()
                            ...
                            .addSourcedDataType(
                                SensorPlanCreateParams.CollectRequest.Elset.SourcedDataType.RADAR
                            )
                            .addSourcedDataType(
                    ...
                    .stateVector(
                        SensorPlanCreateParams.CollectRequest.StateVector.builder()
                            ...
                            .covReferenceFrame(
                                SensorPlanCreateParams.CollectRequest.StateVector.CovReferenceFrame
                                    .J2000
                            )
                            .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                            .createdBy("some.user")
                            ...
                            .addSourcedDataType(
                                SensorPlanCreateParams.CollectRequest.StateVector.SourcedDataType
                                    .RADAR
                            )
                            .sourceDl("AXE")
                            .srpArea(4.311)
    ...
    fun body() {
        ...
        assertThat(body.collectRequests().getOrNull())
            .containsExactly(
                SensorPlanCreateParams.CollectRequest.builder()
                    .classificationMarking("U")
                    .dataMode(SensorPlanCreateParams.CollectRequest.DataMode.TEST)
