...
internal class CollectResponseAbridgedTest {
    ...
    @Test
    fun create() {
      val collectResponseAbridged = CollectResponseAbridged.builder()
      ...
      assertThat(collectResponseAbridged.dataMode()).isEqualTo(CollectResponseAbridged.DataMode.TEST)
      ...
      assertThat(collectResponseAbridged.actualEndTime()).contains(OffsetDateTime.parse("2018-01-01T18:00:00.123456Z"))
      assertThat(collectResponseAbridged.actualStartTime()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(collectResponseAbridged.altEndTime()).contains(OffsetDateTime.parse("2018-01-01T18:00:00.123456Z"))
      assertThat(collectResponseAbridged.altStartTime()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(collectResponseAbridged.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(collectResponseAbridged.origNetwork()).contains("ORIG")
      ...
      assertThat(collectResponseAbridged.srcIds().getOrNull()).containsExactly("DOA_ID", "DWELL_ID")
    ...
    fun roundtrip() {
      ...
      val roundtrippedCollectResponseAbridged = jsonMapper.readValue(jsonMapper.writeValueAsString(collectResponseAbridged), jacksonTypeRef<CollectResponseAbridged>())
