...
internal class LaunchDetectionUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(LaunchDetectionUpdateParams.DataMode.TEST)
        ...
        assertThat(body.bodyId()).contains("LAUNCHDETECTION-ID")
