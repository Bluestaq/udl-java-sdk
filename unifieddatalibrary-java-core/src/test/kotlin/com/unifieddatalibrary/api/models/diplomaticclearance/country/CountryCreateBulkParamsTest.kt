...
internal class CountryCreateBulkParamsTest {
    ...
    fun create() {
      CountryCreateBulkParams.builder()
          .addBody(CountryCreateBulkParams.Body.builder()
              ...
              .createdBy("some.user")
              .addDiplomaticClearanceCountryContact(CountryCreateBulkParams.Body.DiplomaticClearanceCountryContact.builder()
                  .ahNum("256039858")
                  .ahSpdDialCode("75")
                  .commNum("904716104")
                  .commSpdDialCode("74")
                  ...
                  .siprNum("546144352")
                  .build())
              .addDiplomaticClearanceCountryEntryExitPoint(CountryCreateBulkParams.Body.DiplomaticClearanceCountryEntryExitPoint.builder()
                  .isEntry(true)
                  .isExit(true)
                  .pointName("BATEL")
                  .build())
              .addDiplomaticClearanceCountryProfile(CountryCreateBulkParams.Body.DiplomaticClearanceCountryProfile.builder()
    ...
    @Test
    fun body() {
      val params = CountryCreateBulkParams.builder()
          .addBody(CountryCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .countryCode("NL")
              .dataMode(CountryCreateBulkParams.Body.DataMode.TEST)
      ...
      assertThat(body).containsExactly(CountryCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .countryCode("NL")
          .dataMode(CountryCreateBulkParams.Body.DataMode.TEST)
          .lastChangedDate(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
