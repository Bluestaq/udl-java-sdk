...
internal class OrbitdeterminationCreateBulkParamsTest {

    @Test
    fun create() {
      OrbitdeterminationCreateBulkParams.builder()
          .addBody(OrbitdeterminationCreateBulkParams.Body.builder()
              ...
              .aprioriElset(OrbitdeterminationCreateBulkParams.Body.AprioriElset.builder()
                  .classificationMarking("U")
                  .dataMode(OrbitdeterminationCreateBulkParams.Body.AprioriElset.DataMode.TEST)
                  ...
                  .addSourcedDataType(OrbitdeterminationCreateBulkParams.Body.AprioriElset.SourcedDataType.RADAR)
                  .addSourcedDataType(OrbitdeterminationCreateBulkParams.Body.AprioriElset.SourcedDataType.RF)
                  .sourceDl("AXE")
              ...
              .aprioriStateVector(OrbitdeterminationCreateBulkParams.Body.AprioriStateVector.builder()
                  .classificationMarking("U")
                  .dataMode(OrbitdeterminationCreateBulkParams.Body.AprioriStateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(OrbitdeterminationCreateBulkParams.Body.AprioriStateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(OrbitdeterminationCreateBulkParams.Body.AprioriStateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(OrbitdeterminationCreateBulkParams.Body.AprioriStateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
    ...
    @Test
    fun body() {
      val params = OrbitdeterminationCreateBulkParams.builder()
          .addBody(OrbitdeterminationCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(OrbitdeterminationCreateBulkParams.Body.DataMode.TEST)
              .endTime(OffsetDateTime.parse("2023-08-28T15:20:21.247192Z"))
      ...
      assertThat(body).containsExactly(OrbitdeterminationCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(OrbitdeterminationCreateBulkParams.Body.DataMode.TEST)
          .endTime(OffsetDateTime.parse("2023-08-28T15:20:21.247192Z"))
          .initialOd(false)
