...
internal class SigactQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val sigactQueryhelpResponse = SigactQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(sigactQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(sigactQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedSigactQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sigactQueryhelpResponse), jacksonTypeRef<SigactQueryhelpResponse>())
