...
internal class AircraftFullTest {

    @Test
    fun create() {
      val aircraftFull = AircraftFull.builder()
          .aircraftMds("E-2C HAWKEYE")
          .classificationMarking("U")
          .dataMode(AircraftFull.DataMode.TEST)
          .source("Bluestaq")
      ...
      assertThat(aircraftFull.aircraftMds()).isEqualTo("E-2C HAWKEYE")
      assertThat(aircraftFull.classificationMarking()).isEqualTo("U")
      assertThat(aircraftFull.dataMode()).isEqualTo(AircraftFull.DataMode.TEST)
      assertThat(aircraftFull.source()).isEqualTo("Bluestaq")
      assertThat(aircraftFull.id()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
      assertThat(aircraftFull.category()).contains("M")
      assertThat(aircraftFull.command()).contains("HQACC")
      assertThat(aircraftFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(aircraftFull.createdBy()).contains("some.user")
      assertThat(aircraftFull.cruiseSpeed()).contains(915.0)
      assertThat(aircraftFull.dtd()).contains("005")
      assertThat(aircraftFull.entity()).contains(EntityFull.builder()
          .classificationMarking("U")
          .dataMode(EntityFull.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
          ...
          .addUrl("URL2")
          .build())
      assertThat(aircraftFull.idEntity()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
      assertThat(aircraftFull.maxSpeed()).contains(2655.1)
      assertThat(aircraftFull.minReqRunwayFt()).contains(3000)
      assertThat(aircraftFull.minReqRunwayM()).contains(1000)
      assertThat(aircraftFull.nominalTaTime()).contains(500)
      assertThat(aircraftFull.notes()).contains("Notes for this aircraft")
      assertThat(aircraftFull.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(aircraftFull.origNetwork()).contains("OPS1")
      assertThat(aircraftFull.owner()).contains("437AW")
      assertThat(aircraftFull.serialNumber()).contains("7007187")
      assertThat(aircraftFull.sourceDl()).contains("AXE")
      assertThat(aircraftFull.tailNumber()).contains("N702JG")
      assertThat(aircraftFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(aircraftFull.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedAircraftFull = jsonMapper.readValue(jsonMapper.writeValueAsString(aircraftFull), jacksonTypeRef<AircraftFull>())

      assertThat(roundtrippedAircraftFull).isEqualTo(aircraftFull)
    }
}
