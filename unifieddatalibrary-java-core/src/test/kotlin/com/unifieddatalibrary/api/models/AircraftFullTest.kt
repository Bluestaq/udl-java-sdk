...
internal class AircraftFullTest {
    ...
    fun create() {
        ...
        assertThat(aircraftFull.createdAt())
        ...
        assertThat(aircraftFull.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(aircraftFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedAircraftFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(aircraftFull),
                jacksonTypeRef<AircraftFull>(),
            )
