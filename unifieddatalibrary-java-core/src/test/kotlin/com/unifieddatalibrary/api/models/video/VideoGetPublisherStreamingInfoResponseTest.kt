...
internal class VideoGetPublisherStreamingInfoResponseTest {
    ...
    @Test
    fun create() {
        val videoGetPublisherStreamingInfoResponse =
            VideoGetPublisherStreamingInfoResponse.builder()
        ...
        assertThat(videoGetPublisherStreamingInfoResponse.dataMode())
            .isEqualTo(VideoGetPublisherStreamingInfoResponse.DataMode.TEST)
        ...
        assertThat(videoGetPublisherStreamingInfoResponse.createdAt())
        ...
        assertThat(videoGetPublisherStreamingInfoResponse.startTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoGetPublisherStreamingInfoResponse.stopTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(videoGetPublisherStreamingInfoResponse.videoUrls().getOrNull())
            .containsExactly("videoUrls", "videoUrls2")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedVideoGetPublisherStreamingInfoResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(videoGetPublisherStreamingInfoResponse),
                jacksonTypeRef<VideoGetPublisherStreamingInfoResponse>(),
            )

        assertThat(roundtrippedVideoGetPublisherStreamingInfoResponse)
            .isEqualTo(videoGetPublisherStreamingInfoResponse)
    }
}
