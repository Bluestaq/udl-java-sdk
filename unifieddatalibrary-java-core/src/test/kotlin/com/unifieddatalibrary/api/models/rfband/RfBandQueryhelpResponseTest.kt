...
internal class RfBandQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val rfBandQueryhelpResponse = RfBandQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(rfBandQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(rfBandQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedRfBandQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rfBandQueryhelpResponse), jacksonTypeRef<RfBandQueryhelpResponse>())
