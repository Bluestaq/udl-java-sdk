...
internal class IrTupleResponseTest {
    ...
    fun create() {
        ...
        assertThat(irTupleResponse.createdAt())
        ...
        assertThat(irTupleResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(irTupleResponse.origNetwork()).contains("OPS1")
        assertThat(irTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedIrTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(irTupleResponse),
                jacksonTypeRef<IrTupleResponse>(),
            )
