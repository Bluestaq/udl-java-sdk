...
internal class IrTupleResponseTest {

    @Test
    fun create() {
      val irTupleResponse = IrTupleResponse.builder()
          .classificationMarking("U")
          .dataMode(IrTupleResponse.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
          .id("IR-ID")
      ...
      assertThat(irTupleResponse.classificationMarking()).isEqualTo("U")
      assertThat(irTupleResponse.dataMode()).isEqualTo(IrTupleResponse.DataMode.TEST)
      assertThat(irTupleResponse.name()).isEqualTo("Example name")
      assertThat(irTupleResponse.source()).isEqualTo("Bluestaq")
      assertThat(irTupleResponse.id()).contains("IR-ID")
      assertThat(irTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(irTupleResponse.createdBy()).contains("some.user")
      assertThat(irTupleResponse.description()).contains("Example description")
      assertThat(irTupleResponse.entity()).contains(EntityFull.builder()
          .classificationMarking("U")
          .dataMode(EntityFull.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
          ...
          .addUrl("URL2")
          .build())
      assertThat(irTupleResponse.idEntity()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
      assertThat(irTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(irTupleResponse.origNetwork()).contains("ORIG")
      assertThat(irTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(irTupleResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedIrTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(irTupleResponse), jacksonTypeRef<IrTupleResponse>())

      assertThat(roundtrippedIrTupleResponse).isEqualTo(irTupleResponse)
    }
}
