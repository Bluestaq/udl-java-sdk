...
internal class CollectResponseQueryHelpResponseTest {
    ...
    @Test
    fun create() {
        val collectResponseQueryHelpResponse =
            CollectResponseQueryHelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(collectResponseQueryHelpResponse.classificationMarking())
        ...
        assertThat(collectResponseQueryHelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(collectResponseQueryHelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectResponseQueryHelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectResponseQueryHelpResponse),
                jacksonTypeRef<CollectResponseQueryHelpResponse>(),
            )

        assertThat(roundtrippedCollectResponseQueryHelpResponse)
            .isEqualTo(collectResponseQueryHelpResponse)
    }
}
