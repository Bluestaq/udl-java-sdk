...
internal class OrganizationQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val organizationQueryhelpResponse = OrganizationQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(organizationQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(organizationQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(organizationQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedOrganizationQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(organizationQueryhelpResponse), jacksonTypeRef<OrganizationQueryhelpResponse>())

      assertThat(roundtrippedOrganizationQueryhelpResponse).isEqualTo(organizationQueryhelpResponse)
    }
}
