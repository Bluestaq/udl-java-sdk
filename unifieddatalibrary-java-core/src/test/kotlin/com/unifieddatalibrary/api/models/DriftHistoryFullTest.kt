...
internal class DriftHistoryFullTest {
    ...
    @Test
    fun create() {
      val driftHistoryFull = DriftHistoryFull.builder()
      ...
      assertThat(driftHistoryFull.effectiveUntil()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedDriftHistoryFull = jsonMapper.readValue(jsonMapper.writeValueAsString(driftHistoryFull), jacksonTypeRef<DriftHistoryFull>())
