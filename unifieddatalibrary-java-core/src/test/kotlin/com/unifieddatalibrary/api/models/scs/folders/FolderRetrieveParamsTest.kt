...
internal class FolderRetrieveParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = FolderRetrieveParams.builder().id("id").firstResult(0L).maxResults(0L).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = FolderRetrieveParams.builder().id("id").build()
