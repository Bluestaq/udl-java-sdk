...
internal class SoiObservationSetListResponseTest {
    ...
    @Test
    fun create() {
        val soiObservationSetListResponse =
            SoiObservationSetListResponse.builder()
                ...
                .addCalibration(
                    SoiObservationSetListResponse.Calibration.builder()
                        .calBgIntensity(1.1)
        ...
        assertThat(soiObservationSetListResponse.dataMode())
            .isEqualTo(SoiObservationSetListResponse.DataMode.TEST)
        ...
        assertThat(soiObservationSetListResponse.startTime())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
        assertThat(soiObservationSetListResponse.type())
            .isEqualTo(SoiObservationSetListResponse.Type.OPTICAL)
        assertThat(soiObservationSetListResponse.id())
        ...
        assertThat(soiObservationSetListResponse.calibrations().getOrNull())
            .containsExactly(
                SoiObservationSetListResponse.Calibration.builder()
                    .calBgIntensity(1.1)
                    .calExtinctionCoeff(0.2)
        ...
        assertThat(soiObservationSetListResponse.collectionId())
        ...
        assertThat(soiObservationSetListResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(soiObservationSetListResponse.createdBy()).contains("some.user")
        assertThat(soiObservationSetListResponse.endTime())
        ...
        assertThat(soiObservationSetListResponse.msgCreateDate())
        ...
        assertThat(soiObservationSetListResponse.referenceFrame())
            .contains(SoiObservationSetListResponse.ReferenceFrame.J2000)
        ...
        assertThat(soiObservationSetListResponse.senReferenceFrame())
            .contains(SoiObservationSetListResponse.SenReferenceFrame.J2000)
        assertThat(soiObservationSetListResponse.sensorAsId())
            .contains("026dd511-8ba5-47d3-9909-836149f87686")
        ...
        assertThat(soiObservationSetListResponse.solarPhaseAngleBrightnessChangeDetected())
            .contains(true)
        assertThat(soiObservationSetListResponse.sourceDl()).contains("AXE")
        assertThat(soiObservationSetListResponse.spectralFilters().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSoiObservationSetListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(soiObservationSetListResponse),
                jacksonTypeRef<SoiObservationSetListResponse>(),
            )

        assertThat(roundtrippedSoiObservationSetListResponse)
            .isEqualTo(soiObservationSetListResponse)
    }
}
