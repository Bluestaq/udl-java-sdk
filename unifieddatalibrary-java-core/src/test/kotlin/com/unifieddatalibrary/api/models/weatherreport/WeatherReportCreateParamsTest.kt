...
internal class WeatherReportCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = WeatherReportCreateParams.builder()
          .classificationMarking("U")
          .dataMode(WeatherReportCreateParams.DataMode.TEST)
          .lat(56.12)
          .lon(-156.6)
      ...
      assertThat(body.agjson()).contains("{\"type\":\"Polygon\",\"coordinates\":[ [ [ 67.3291113966927, 26.156175339112 ], [ 67.2580009640721, 26.091022064271 ], [ 67.1795862381682, 26.6637992964562 ], [ 67.2501237475598, 26.730115808233 ], [ 67.3291113966927, 26.156175339112 ] ] ] }")
      assertThat(body.alt()).contains(123.12)
      assertThat(body.andims()).contains(2L)
      assertThat(body.area()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      assertThat(body.asrid()).contains(4326)
      assertThat(body.atext()).contains("POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))")
      ...
      assertThat(body.forecastEndTime()).contains(OffsetDateTime.parse("2024-01-01T18:00:00.123Z"))
      assertThat(body.forecastStartTime()).contains(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      ...
      assertThat(body.rawMetar()).contains("KXYZ 241456Z 19012G20KT 10SM FEW120 SCT200 BKN250 26/M04 A2981 RMK AO2 PK WND 19026/1420 SLP068 T02611039 51015")
      assertThat(body.rawTaf()).contains("KXYZ 051730Z 0518/0624 31008KT 3SM -SHRA BKN020 FM052300 30006KT 5SM -SHRA OVC030 PROB30 0604/0606 VRB20G35KT 1SM TSRA BKN015CB FM060600 25010KT 4SM -SHRA OVC050 TEMPO 0608/0611 2SM -SHRA OVC030 RMK NXT FCST BY 00Z=")
      ...
      assertThat(body.srcIds().getOrNull()).containsExactly("e609a90d-4059-4043-9f1a-fd7b49a3e1d0", "c739fcdb-c0c9-43c0-97b6-bfc80d0ffd52")
