...
internal class LinkStatusCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = LinkStatusCreateParams.builder()
          .classificationMarking("U")
          .dataMode(LinkStatusCreateParams.DataMode.TEST)
          .endPoint1Lat(45.23)
          .endPoint1Lon(80.23)
      ...
      assertThat(body.linkStartTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(body.linkStopTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
