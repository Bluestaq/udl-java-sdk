...
internal class AirfieldStatusUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = AirfieldStatusUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(AirfieldStatusUpdateParams.DataMode.TEST)
          .idAirfield("3136498f-2969-3535-1432-e984b2e2e686")
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(AirfieldStatusUpdateParams.DataMode.TEST)
