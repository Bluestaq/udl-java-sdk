...
internal class AirspacecontrolorderFullTest {
    ...
    @Test
    fun create() {
      val airspacecontrolorderFull = AirspacecontrolorderFull.builder()
          ...
          .acoSerialNum("27B")
          .addAirspaceControlMeansStatus(AirspacecontrolorderFull.AirspaceControlMeansStatus.builder()
              .addAirspaceControlMean(AirspacecontrolorderFull.AirspaceControlMeansStatus.AirspaceControlMean.builder()
                  .addAirspaceControlPoint(AirspacecontrolorderFull.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceControlPoint.builder()
                      .ctrlPtAltitude("BRFL:MSL-FL230")
                      .ctrlPtLocation("203632N0594256E")
                      .ctrlPtName("APPLE")
                      .ctrlPtType("CP")
                      .build())
                  .addAirspaceTimePeriod(AirspacecontrolorderFull.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceTimePeriod.builder()
                      .addIntDur("65WK")
                      .addIntFreq("WEEKLY")
                  ...
                  .bearing1(160.0)
                  .cmId("DESIG:C34")
                  .cmShape(AirspacecontrolorderFull.AirspaceControlMeansStatus.AirspaceControlMean.CmShape.POLYARC)
                  .cmType("cmType")
              ...
              .build())
          .addAirspaceControlOrderReference(AirspacecontrolorderFull.AirspaceControlOrderReference.builder()
              .refOriginator("SHAPE")
              .refSerialNum("100")
              .addRefSiC("RCA")
              .addRefSiC("FN:4503B")
      ...
      assertThat(airspacecontrolorderFull.dataMode()).isEqualTo(AirspacecontrolorderFull.DataMode.TEST)
      ...
      assertThat(airspacecontrolorderFull.startTime()).isEqualTo(OffsetDateTime.parse("2024-01-07T13:55:43.123Z"))
      ...
      assertThat(airspacecontrolorderFull.airspaceControlMeansStatus().getOrNull()).containsExactly(AirspacecontrolorderFull.AirspaceControlMeansStatus.builder()
          .addAirspaceControlMean(AirspacecontrolorderFull.AirspaceControlMeansStatus.AirspaceControlMean.builder()
              .addAirspaceControlPoint(AirspacecontrolorderFull.AirspaceControlMeansStatus.AirspaceControlMean.AirspaceControlPoint.builder()
                  .ctrlPtAltitude("BRFL:MSL-FL230")
                  .ctrlPtLocation("203632N0594256E")
          ...
          .build())
      assertThat(airspacecontrolorderFull.airspaceControlOrderReferences().getOrNull()).containsExactly(AirspacecontrolorderFull.AirspaceControlOrderReference.builder()
          .refOriginator("SHAPE")
          .refSerialNum("100")
          .addRefSiC("RCA")
          .addRefSiC("FN:4503B")
      ...
      assertThat(airspacecontrolorderFull.classReasons().getOrNull()).containsExactly("15C", "10C")
      assertThat(airspacecontrolorderFull.classSource()).contains("ORIG:USJFCOM")
      assertThat(airspacecontrolorderFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(airspacecontrolorderFull.createdBy()).contains("some.user")
      assertThat(airspacecontrolorderFull.declassExemptionCodes().getOrNull()).containsExactly("X1", "X2")
      assertThat(airspacecontrolorderFull.downgradeInsDates().getOrNull()).containsExactly("NST:AT EXERCISE ENDEX", "DATE:25NOV1997")
      ...
      assertThat(airspacecontrolorderFull.stopTime()).contains(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
      assertThat(airspacecontrolorderFull.undLnkTrks().getOrNull()).containsExactly("A2467", "A3466", "AA232")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedAirspacecontrolorderFull = jsonMapper.readValue(jsonMapper.writeValueAsString(airspacecontrolorderFull), jacksonTypeRef<AirspacecontrolorderFull>())
