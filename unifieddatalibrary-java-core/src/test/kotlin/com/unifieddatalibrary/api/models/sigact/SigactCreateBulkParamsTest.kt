...
internal class SigactCreateBulkParamsTest {

    @Test
    fun create() {
      SigactCreateBulkParams.builder()
          .addBody(SigactCreateBulkParams.Body.builder()
              ...
              .addRelatedDoc(SigactCreateBulkParams.Body.RelatedDoc.builder()
                  .addDataSourceRef(SigactCreateBulkParams.Body.RelatedDoc.DataSourceRef.builder()
    ...
    @Test
    fun body() {
      val params = SigactCreateBulkParams.builder()
          .addBody(SigactCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(SigactCreateBulkParams.Body.DataMode.TEST)
              .reportDate(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(body).containsExactly(SigactCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(SigactCreateBulkParams.Body.DataMode.TEST)
          .reportDate(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
          .source("Bluestaq")
