...
internal class H3GeoHexCellTupleResponseTest {
    ...
    @Test
    fun create() {
        val h3GeoHexCellTupleResponse =
            H3GeoHexCellTupleResponse.builder()
        ...
        assertThat(h3GeoHexCellTupleResponse.dataMode())
            .isEqualTo(H3GeoHexCellTupleResponse.DataMode.TEST)
        ...
        assertThat(h3GeoHexCellTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(h3GeoHexCellTupleResponse.createdBy()).contains("some.user")
        assertThat(h3GeoHexCellTupleResponse.idH3Geo())
    ...
    fun roundtrip() {
        ...
        val roundtrippedH3GeoHexCellTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(h3GeoHexCellTupleResponse),
                jacksonTypeRef<H3GeoHexCellTupleResponse>(),
            )
