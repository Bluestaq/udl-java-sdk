...
internal class OnorbitQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val onorbitQueryhelpResponse =
            OnorbitQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(onorbitQueryhelpResponse.classificationMarking())
        ...
        assertThat(onorbitQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbitQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbitQueryhelpResponse),
                jacksonTypeRef<OnorbitQueryhelpResponse>(),
            )
