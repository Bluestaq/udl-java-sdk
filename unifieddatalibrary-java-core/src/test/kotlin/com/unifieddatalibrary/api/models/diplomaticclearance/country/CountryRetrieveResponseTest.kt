...
internal class CountryRetrieveResponseTest {
    ...
    fun create() {
      val countryRetrieveResponse = CountryRetrieveResponse.builder()
          ...
          .createdBy("some.user")
          .addDiplomaticClearanceCountryContact(CountryRetrieveResponse.DiplomaticClearanceCountryContact.builder()
              .ahNum("256039858")
              .ahSpdDialCode("75")
              .commNum("904716104")
              .commSpdDialCode("74")
              ...
              .siprNum("546144352")
              .build())
          .addDiplomaticClearanceCountryEntryExitPoint(CountryRetrieveResponse.DiplomaticClearanceCountryEntryExitPoint.builder()
              .isEntry(true)
              .isExit(true)
              .pointName("BATEL")
              .build())
          .addDiplomaticClearanceCountryProfile(CountryRetrieveResponse.DiplomaticClearanceCountryProfile.builder()
      ...
      assertThat(countryRetrieveResponse.dataMode()).isEqualTo(CountryRetrieveResponse.DataMode.TEST)
      assertThat(countryRetrieveResponse.lastChangedDate()).isEqualTo(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
      ...
      assertThat(countryRetrieveResponse.countryRemark()).contains("Amsterdam airport EHAM will not accept hazardous cargo.")
      assertThat(countryRetrieveResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(countryRetrieveResponse.createdBy()).contains("some.user")
      assertThat(countryRetrieveResponse.diplomaticClearanceCountryContacts().getOrNull()).containsExactly(CountryRetrieveResponse.DiplomaticClearanceCountryContact.builder()
          .ahNum("256039858")
          .ahSpdDialCode("75")
          .commNum("904716104")
          .commSpdDialCode("74")
          ...
          .siprNum("546144352")
          .build())
      assertThat(countryRetrieveResponse.diplomaticClearanceCountryEntryExitPoints().getOrNull()).containsExactly(CountryRetrieveResponse.DiplomaticClearanceCountryEntryExitPoint.builder()
          .isEntry(true)
          .isExit(true)
          .pointName("BATEL")
          .build())
      assertThat(countryRetrieveResponse.diplomaticClearanceCountryProfiles().getOrNull()).containsExactly(CountryRetrieveResponse.DiplomaticClearanceCountryProfile.builder()
          .cargoPaxRemark("Cargo passenger remark")
          .clearanceId("MDCNPER231360050AAR")
          .crewInfoRemark("Crew info remark")
          .defClearanceStatus("R")
      ...
      assertThat(countryRetrieveResponse.officeRemark()).contains("Diplomatic clearance office remark")
      ...
      assertThat(countryRetrieveResponse.origNetwork()).contains("ORIG")
      assertThat(countryRetrieveResponse.sourceDl()).contains("AXE")
      assertThat(countryRetrieveResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedCountryRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(countryRetrieveResponse), jacksonTypeRef<CountryRetrieveResponse>())
