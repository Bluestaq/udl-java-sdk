...
internal class SensorPlanGetResponseTest {
    ...
    @Test
    fun create() {
        val sensorPlanGetResponse =
            SensorPlanGetResponse.builder()
                ...
                .id("SENSORPLAN-ID")
                .addCollectRequest(
                    SensorPlanGetResponse.CollectRequest.builder()
                        .classificationMarking("U")
                        ...
                        .el(1.1)
                        .elset(
                            SensorPlanGetResponse.CollectRequest.Elset.builder()
                                .classificationMarking("U")
                                ...
                                .addSourcedDataType(
                                    SensorPlanGetResponse.CollectRequest.Elset.SourcedDataType.RADAR
                                )
                                .addSourcedDataType(
                                    SensorPlanGetResponse.CollectRequest.Elset.SourcedDataType.RF
                                )
                                .sourceDl("AXE")
                                .addTag("PROVIDER_TAG1")
                                .addTag("PROVIDER_TAG2")
                        ...
                        .srchPattern("SCAN")
                        .stateVector(
                            SensorPlanGetResponse.CollectRequest.StateVector.builder()
                                .classificationMarking("U")
                                .dataMode(
                                    SensorPlanGetResponse.CollectRequest.StateVector.DataMode.TEST
                                )
                                .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                                .source("Bluestaq")
                                .actualOdSpan(3.5)
                                ...
                                .covReferenceFrame(
                                    SensorPlanGetResponse.CollectRequest.StateVector
                                        .CovReferenceFrame
                                        .J2000
                                )
                                .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                                ...
                                .recOdSpan(3.5)
                                .referenceFrame(
                                    SensorPlanGetResponse.CollectRequest.StateVector.ReferenceFrame
                                        .J2000
                                )
                                .residualsAcc(99.5)
                                .revNo(7205)
                                ...
                                .addSourcedDataType(
                                    SensorPlanGetResponse.CollectRequest.StateVector.SourcedDataType
                                        .RADAR
                                )
                                .sourceDl("AXE")
                                .srpArea(4.311)
        ...
        assertThat(sensorPlanGetResponse.startTime())
        ...
        assertThat(sensorPlanGetResponse.collectRequests().getOrNull())
            .containsExactly(
                SensorPlanGetResponse.CollectRequest.builder()
                    .classificationMarking("U")
                    .dataMode(SensorPlanGetResponse.CollectRequest.DataMode.TEST)
                    ...
                    .stateVector(
                        SensorPlanGetResponse.CollectRequest.StateVector.builder()
                            ...
                            .covMethod("CALCULATED")
                            .covReferenceFrame(
                                SensorPlanGetResponse.CollectRequest.StateVector.CovReferenceFrame
                                    .J2000
                            )
                            .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                            .createdBy("some.user")
        ...
        assertThat(sensorPlanGetResponse.createdAt())
        ...
        assertThat(sensorPlanGetResponse.endTime())
        ...
        assertThat(sensorPlanGetResponse.tags().getOrNull())
            .containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
        assertThat(sensorPlanGetResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSensorPlanGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sensorPlanGetResponse),
                jacksonTypeRef<SensorPlanGetResponse>(),
            )
