...
internal class SensorPlanGetResponseTest {

    @Test
    fun create() {
      val sensorPlanGetResponse = SensorPlanGetResponse.builder()
          .classificationMarking("U")
          .dataMode(SensorPlanGetResponse.DataMode.TEST)
          .recType("COLLECT")
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .type("PLAN")
          .id("SENSORPLAN-ID")
          .addCollectRequest(SensorPlanGetResponse.CollectRequest.builder()
              .classificationMarking("U")
              .dataMode(SensorPlanGetResponse.CollectRequest.DataMode.TEST)
              .source("Bluestaq")
              .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
              .type("DWELL")
              ...
              .eccentricity(1.1)
              .el(1.1)
              .elset(SensorPlanGetResponse.CollectRequest.Elset.builder()
                  .classificationMarking("U")
                  .dataMode(SensorPlanGetResponse.CollectRequest.Elset.DataMode.TEST)
                  ...
                  .addSourcedDataType(SensorPlanGetResponse.CollectRequest.Elset.SourcedDataType.RADAR)
                  .addSourcedDataType(SensorPlanGetResponse.CollectRequest.Elset.SourcedDataType.RF)
                  .sourceDl("AXE")
                  .addTag("PROVIDER_TAG1")
                  .addTag("PROVIDER_TAG2")
              ...
              .srchInc(1.1)
              .srchPattern("SCAN")
              .stateVector(SensorPlanGetResponse.CollectRequest.StateVector.builder()
                  .classificationMarking("U")
                  .dataMode(SensorPlanGetResponse.CollectRequest.StateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(SensorPlanGetResponse.CollectRequest.StateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(SensorPlanGetResponse.CollectRequest.StateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(SensorPlanGetResponse.CollectRequest.StateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
      ...
      assertThat(sensorPlanGetResponse.classificationMarking()).isEqualTo("U")
      assertThat(sensorPlanGetResponse.dataMode()).isEqualTo(SensorPlanGetResponse.DataMode.TEST)
      assertThat(sensorPlanGetResponse.recType()).isEqualTo("COLLECT")
      assertThat(sensorPlanGetResponse.source()).isEqualTo("Bluestaq")
      assertThat(sensorPlanGetResponse.startTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(sensorPlanGetResponse.type()).isEqualTo("PLAN")
      assertThat(sensorPlanGetResponse.id()).contains("SENSORPLAN-ID")
      assertThat(sensorPlanGetResponse.collectRequests().getOrNull()).containsExactly(SensorPlanGetResponse.CollectRequest.builder()
          .classificationMarking("U")
          .dataMode(SensorPlanGetResponse.CollectRequest.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          ...
          .yAngle(1.1)
          .build())
      assertThat(sensorPlanGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(sensorPlanGetResponse.createdBy()).contains("some.user")
      assertThat(sensorPlanGetResponse.customer()).contains("CUSTOMER")
      assertThat(sensorPlanGetResponse.endTime()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(sensorPlanGetResponse.senNetwork()).contains("NETWORK")
      assertThat(sensorPlanGetResponse.status()).contains("ACCEPTED")
      assertThat(sensorPlanGetResponse.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
      assertThat(sensorPlanGetResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(sensorPlanGetResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedSensorPlanGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sensorPlanGetResponse), jacksonTypeRef<SensorPlanGetResponse>())

      assertThat(roundtrippedSensorPlanGetResponse).isEqualTo(sensorPlanGetResponse)
    }
}
