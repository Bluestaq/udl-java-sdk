...
internal class AirTransportMissionUpdateParamsTest {
    ...
    fun create() {
      AirTransportMissionUpdateParams.builder()
          ...
          .addHazMat(AirTransportMissionUpdateParams.HazMat.builder()
          ...
          .addRemark(AirTransportMissionUpdateParams.Remark.builder()
              ...
              .user("John Doe")
              .build())
          .addRequirement(AirTransportMissionUpdateParams.Requirement.builder()
              .bulkWeight(1.3)
    ...
    @Test
    fun pathParams() {
      val params = AirTransportMissionUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(AirTransportMissionUpdateParams.DataMode.TEST)
          .source("Bluestaq")
    ...
    fun body() {
      ...
      assertThat(body.hazMat().getOrNull()).containsExactly(AirTransportMissionUpdateParams.HazMat.builder()
          .applicableNotes("11,12")
          .cgc("A")
          .cgn("4,5,7,8")
          .classDiv(1.1)
      ...
      assertThat(body.purpose()).contains("People at island X need water ASAP. Two previous attempts failed due to weather.")
      assertThat(body.remarks().getOrNull()).containsExactly(AirTransportMissionUpdateParams.Remark.builder()
          .date(OffsetDateTime.parse("2022-01-01T16:00:00.123Z"))
          .gdssRemarkId("GDSSREMARK-ID")
          .itineraryNum(825)
          .text("Example mission remarks.")
          ...
          .user("John Doe")
          .build())
      assertThat(body.requirements().getOrNull()).containsExactly(AirTransportMissionUpdateParams.Requirement.builder()
          .bulkWeight(1.3)
          .ead(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
          .gdssReqId("23a1fb67-cc2d-5ebe-6b99-68130cb1aa6c")
          .lad(OffsetDateTime.parse("2024-01-01T16:00:00.123Z"))
