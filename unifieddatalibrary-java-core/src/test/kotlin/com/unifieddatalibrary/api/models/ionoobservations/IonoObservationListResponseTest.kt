...
internal class IonoObservationListResponseTest {
    ...
    @Test
    fun create() {
      val ionoObservationListResponse = IonoObservationListResponse.builder()
          ...
          .amplitude(IonoObservationListResponse.Amplitude.builder()
              ...
              .notes("NOTES")
              .build())
          .antennaElementPosition(IonoObservationListResponse.AntennaElementPosition.builder()
              .addData(listOf(
                1.23, 0.123
              ))
              .addDimensionName("NAME1")
              ...
              .addDimension(4)
              .build())
          .antennaElementPositionCoordinateSystem(IonoObservationListResponse.AntennaElementPositionCoordinateSystem.J2000)
          .artistFlags(listOf(
            1,
            2,
            3,
          ))
          .azimuth(IonoObservationListResponse.Azimuth.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .b0(68.07)
          .b1(1.87)
          .addCharAtt(IonoObservationListResponse.CharAtt.builder()
              .charName("hprimeF2")
          ...
          .d(1.1)
          .d1(1.94)
          .datum(IonoObservationListResponse.Datum.builder()
              .data(listOf(
                1.1,
                2.1,
                3.1,
              ...
              .build())
          .deltafoF2(1.1)
          .densityProfile(IonoObservationListResponse.DensityProfile.builder()
              .iri(IonoObservationListResponse.DensityProfile.Iri.builder()
                  .b0(245.1)
                  .b1(3.45)
                  .chi(35.1)
                  .d1(0.0)
                  ...
                  .nValB(147025.1)
                  .build())
              .parabolic(IonoObservationListResponse.DensityProfile.Parabolic.builder()
                  .description("Best-fit algorithm in NHPC software.")
                  .addParabolicItem(IonoObservationListResponse.DensityProfile.Parabolic.ParabolicItem.builder()
                      .f(3.621)
                      .layer("E")
                      .y(11.1)
                      .z(110.2)
                      .build())
                  .build())
              .quasiParabolic(IonoObservationListResponse.DensityProfile.QuasiParabolic.builder()
                  .description("Array of the best-fit 3-parameter quasi-parabolas defined via A, B, C coefficients, f^2=A/r^2+B/r+C")
                  .earthRadius(6370.1)
                  .addQuasiParabolicSegment(IonoObservationListResponse.DensityProfile.QuasiParabolic.QuasiParabolicSegment.builder()
                      .a(-550273940000.0)
                      .b(169837632.0)
                      .c(13104.63)
                      .error(0.0016)
                      ...
                      .build())
                  .build())
              .shiftedChebyshev(IonoObservationListResponse.DensityProfile.ShiftedChebyshev.builder()
                  .description("Best-fit Huang-Reinisch formalism based on shifted Chebyshev expansion.")
                  .addShiftedChebyshev(IonoObservationListResponse.DensityProfile.ShiftedChebyshev.InnerShiftedChebyshev.builder()
                      .coeffs(listOf(
                        -11.2,
                        -10.536,
                        3.357,
                      ...
                      .build())
                  .build())
              .topsideExtensionChapmanConst(IonoObservationListResponse.DensityProfile.TopsideExtensionChapmanConst.builder()
                  .chi(35.1)
                  ...
                  .scaleF2(45.191)
                  .build())
              .topsideExtensionVaryChap(IonoObservationListResponse.DensityProfile.TopsideExtensionVaryChap.builder()
                  .alpha(30.1)
                  .beta(30.1)
                  .chi(30.1)
                  .description("Constant scale height Chapman topside layer determined using bottomside peak density parameters and placed chi km above the ionosonde-determined peak height.")
              ...
              .build())
          .doppler(IonoObservationListResponse.Doppler.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .elevation(IonoObservationListResponse.Elevation.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .foF2p(1.1)
          .foP(87.21)
          .frequency(IonoObservationListResponse.Frequency.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .phase(IonoObservationListResponse.Phase.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .polarization(IonoObservationListResponse.Polarization.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                IonoObservationListResponse.Polarization.UnnamedSchemaWithArrayParent0.X, IonoObservationListResponse.Polarization.UnnamedSchemaWithArrayParent0.O
              )))))))
              .addDimensionName("NAME1")
              .addDimensionName("NAME2")
              .addDimension(1)
              ...
              .notes("NOTES")
              .build())
          .power(IonoObservationListResponse.Power.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .qe(0.95)
          .qf(1.83)
          .range(IonoObservationListResponse.Range.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
          ...
          .scalerInfo(IonoObservationListResponse.ScalerInfo.builder()
              .confidenceLevel(11)
              .confidenceScore(75)
              .name("ARTIST-4")
              .organization("UML")
              ...
              .version(500200.1)
              .build())
          .stokes(IonoObservationListResponse.Stokes.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
          ...
          .time(IonoObservationListResponse.Time.builder()
              .addData(listOf(listOf(listOf(listOf(listOf(listOf(
                0.02, 0.034
              )))))))
              .addDimensionName("NAME1")
              ...
              .notes("NOTES")
              .build())
          .traceGeneric(IonoObservationListResponse.TraceGeneric.builder()
      ...
      assertThat(ionoObservationListResponse.dataMode()).isEqualTo(IonoObservationListResponse.DataMode.TEST)
      assertThat(ionoObservationListResponse.source()).isEqualTo("Bluestaq")
      assertThat(ionoObservationListResponse.startTimeUtc()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      ...
      assertThat(ionoObservationListResponse.amplitude()).contains(IonoObservationListResponse.Amplitude.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationListResponse.antennaElementPosition()).contains(IonoObservationListResponse.AntennaElementPosition.builder()
          .addData(listOf(
            1.23, 0.123
          ))
          .addDimensionName("NAME1")
          ...
          .addDimension(4)
          .build())
      assertThat(ionoObservationListResponse.antennaElementPositionCoordinateSystem()).contains(IonoObservationListResponse.AntennaElementPositionCoordinateSystem.J2000)
      assertThat(ionoObservationListResponse.artistFlags().getOrNull()).containsExactly(1, 2, 3)
      assertThat(ionoObservationListResponse.azimuth()).contains(IonoObservationListResponse.Azimuth.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationListResponse.charAtts().getOrNull()).containsExactly(IonoObservationListResponse.CharAtt.builder()
          .charName("hprimeF2")
          .addClimateModelInputParam("ISSN1 88.1")
          .addClimateModelInputParam("Option 2")
          .climateModelName("IRI")
          ...
          .ursiId("04")
          .build())
      assertThat(ionoObservationListResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(ionoObservationListResponse.datum()).contains(IonoObservationListResponse.Datum.builder()
          .data(listOf(
            1.1,
            2.1,
            3.1,
      ...
      assertThat(ionoObservationListResponse.densityProfile()).contains(IonoObservationListResponse.DensityProfile.builder()
          .iri(IonoObservationListResponse.DensityProfile.Iri.builder()
              .b0(245.1)
              .b1(3.45)
              .chi(35.1)
          ...
          .valleyModelDescription("2-parameter UMLCAR model with width W in km and depth D in MHz, no fitting.")
          .build())
      assertThat(ionoObservationListResponse.doppler()).contains(IonoObservationListResponse.Doppler.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationListResponse.electronDensity().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationListResponse.electronDensityUncertainty().getOrNull()).containsExactly(0.8, 0.2, 0.5)
      assertThat(ionoObservationListResponse.elevation()).contains(IonoObservationListResponse.Elevation.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationListResponse.frequency()).contains(IonoObservationListResponse.Frequency.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationListResponse.phase()).contains(IonoObservationListResponse.Phase.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationListResponse.plasmaFrequency().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationListResponse.plasmaFrequencyUncertainty().getOrNull()).containsExactly(0.8, 0.2, 0.5)
      assertThat(ionoObservationListResponse.platformName()).contains("Millstone Hill")
      assertThat(ionoObservationListResponse.polarization()).contains(IonoObservationListResponse.Polarization.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            IonoObservationListResponse.Polarization.UnnamedSchemaWithArrayParent0.X, IonoObservationListResponse.Polarization.UnnamedSchemaWithArrayParent0.O
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationListResponse.power()).contains(IonoObservationListResponse.Power.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
      ...
      assertThat(ionoObservationListResponse.range()).contains(IonoObservationListResponse.Range.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationListResponse.receiveCoordinates().getOrNull()).containsExactly(listOf(
        45.5,
        179.3,
        35.6,
      ), listOf(
      ...
      assertThat(ionoObservationListResponse.receiveSensorType()).contains(IonoObservationListResponse.ReceiveSensorType.MOBILE)
      assertThat(ionoObservationListResponse.restrictedFrequency().getOrNull()).containsExactly(12.5, 34.5, 45.3)
      ...
      assertThat(ionoObservationListResponse.scalerInfo()).contains(IonoObservationListResponse.ScalerInfo.builder()
          .confidenceLevel(11)
          .confidenceScore(75)
          .name("ARTIST-4")
          .organization("UML")
          ...
          .version(500200.1)
          .build())
      assertThat(ionoObservationListResponse.stokes()).contains(IonoObservationListResponse.Stokes.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAMES1")
      ...
      assertThat(ionoObservationListResponse.tidAzimuth().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationListResponse.tidPeriods().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationListResponse.tidPhaseSpeeds().getOrNull()).containsExactly(1.1, 2.1, 3.1)
      assertThat(ionoObservationListResponse.time()).contains(IonoObservationListResponse.Time.builder()
          .addData(listOf(listOf(listOf(listOf(listOf(listOf(
            0.02, 0.034
          )))))))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationListResponse.traceGeneric()).contains(IonoObservationListResponse.TraceGeneric.builder()
          .addData(listOf(listOf(
            1.23, 1.0903
          )))
          .addDimensionName("NAME1")
          ...
          .notes("NOTES")
          .build())
      assertThat(ionoObservationListResponse.transmitCoordinates().getOrNull()).containsExactly(listOf(
        45.5,
        179.3,
        35.6,
      ), listOf(
      ...
      assertThat(ionoObservationListResponse.transmitSensorType()).contains(IonoObservationListResponse.TransmitSensorType.MOBILE)
      assertThat(ionoObservationListResponse.typeEs()).contains("Auroral")
      assertThat(ionoObservationListResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedIonoObservationListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(ionoObservationListResponse), jacksonTypeRef<IonoObservationListResponse>())
