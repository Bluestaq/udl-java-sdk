...
internal class OnorbitdetailUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataMode()).isEqualTo(OnorbitdetailUpdateParams.DataMode.TEST)
        assertThat(body.idOnOrbit()).isEqualTo("REF-ONORBIT-ID")
        assertThat(body.source()).isEqualTo("Bluestaq")
        assertThat(body.bodyId()).contains("ONORBITDETAILS-ID")
