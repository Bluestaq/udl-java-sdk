...
internal class DailyOperationFullTest {
    ...
    fun create() {
        ...
        assertThat(dailyOperationFull.operatingHours().getOrNull())
            .containsExactly(
                OperatingHoursFull.builder().opStartTime("12:00").opStopTime("22:00").build()
            )
        ...
        assertThat(dailyOperationFull.ophrsLastChangedDate())
    ...
    fun roundtrip() {
        ...
        val roundtrippedDailyOperationFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(dailyOperationFull),
                jacksonTypeRef<DailyOperationFull>(),
            )
