...
internal class MissileTrackListResponseTest {
    ...
    @Test
    fun create() {
        val missileTrackListResponse =
            MissileTrackListResponse.builder()
                ...
                .trkQual(1)
                .addVector(
                    MissileTrackListResponse.Vector.builder()
                        ...
                        .covReferenceFrame(
                            MissileTrackListResponse.Vector.CovReferenceFrame.ECR_ECEF
                        )
                        .flightAz(45.23)
        ...
        assertThat(missileTrackListResponse.dataMode())
            .isEqualTo(MissileTrackListResponse.DataMode.TEST)
        assertThat(missileTrackListResponse.source()).isEqualTo("Bluestaq")
        assertThat(missileTrackListResponse.ts())
        ...
        assertThat(missileTrackListResponse.aouRptData().getOrNull())
        ...
        assertThat(missileTrackListResponse.contextKeys().getOrNull())
            .containsExactly("MsnID_DescLabel", "msnVer", "serVer", "velTs", "accelTs")
        assertThat(missileTrackListResponse.contextValues().getOrNull())
            .containsExactly(
                "MissionID Descriptive Label text",
                "1",
                "001.9b",
        ...
        assertThat(missileTrackListResponse.createdAt())
        ...
        assertThat(missileTrackListResponse.impactAlt()).contains(0.02)
        assertThat(missileTrackListResponse.impactAouData().getOrNull())
            .containsExactly(34.3, 26.5, 1.2)
        assertThat(missileTrackListResponse.impactAouType()).contains("ELLIPSE")
        assertThat(missileTrackListResponse.impactConf()).contains(99.9)
        ...
        assertThat(missileTrackListResponse.impactTime())
            .contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
        assertThat(missileTrackListResponse.infoSource()).contains("S1")
        assertThat(missileTrackListResponse.launchAlt()).contains(0.01)
        assertThat(missileTrackListResponse.launchAouData().getOrNull())
            .containsExactly(1.23, 2.34, 3.45)
        assertThat(missileTrackListResponse.launchAouType()).contains("ELLIPSE")
        assertThat(missileTrackListResponse.launchAz()).contains(99.1)
        assertThat(missileTrackListResponse.launchAzUnc()).contains(2.4)
        assertThat(missileTrackListResponse.launchConf()).contains(90.7)
        ...
        assertThat(missileTrackListResponse.launchTime())
            .contains(OffsetDateTime.parse("2021-02-25T12:00:00.123456Z"))
        assertThat(missileTrackListResponse.lostTrkInd()).contains(false)
        assertThat(missileTrackListResponse.maneuverEnd())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:15.456789Z"))
        assertThat(missileTrackListResponse.maneuverStart())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(missileTrackListResponse.msgCreateDate())
        ...
        assertThat(missileTrackListResponse.objIdent())
            .contains(MissileTrackListResponse.ObjIdent.FRIEND)
        ...
        assertThat(missileTrackListResponse.origNetwork()).contains("OPS1")
        ...
        assertThat(missileTrackListResponse.vectors().getOrNull())
            .containsExactly(
                MissileTrackListResponse.Vector.builder()
                    .epoch(OffsetDateTime.parse("2024-03-30T15:02:39.346768Z"))
                    .accel(listOf(0.59236, -0.03537, 0.35675))
                    ...
                    .course(7.3580153)
                    .cov(listOf(1.1, 2.2, 3.3))
                    .covReferenceFrame(MissileTrackListResponse.Vector.CovReferenceFrame.ECR_ECEF)
                    .flightAz(45.23)
                    .idSensor("a7e99418-b6d6-29ab-e767-440a989cce26")
                    .object_("TARGET")
                    .origSensorId("ORIGSENSOR-ID")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMissileTrackListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(missileTrackListResponse),
                jacksonTypeRef<MissileTrackListResponse>(),
            )
