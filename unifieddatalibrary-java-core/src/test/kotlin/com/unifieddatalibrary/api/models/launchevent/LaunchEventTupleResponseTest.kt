...
internal class LaunchEventTupleResponseTest {

    @Test
    fun create() {
        val launchEventTupleResponse =
            LaunchEventTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(LaunchEventTupleResponse.DataMode.TEST)
        ...
        assertThat(launchEventTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(launchEventTupleResponse.dataMode())
            .isEqualTo(LaunchEventTupleResponse.DataMode.TEST)
        assertThat(launchEventTupleResponse.msgCreateDate())
            .isEqualTo(OffsetDateTime.parse("2020-01-01T00:00:00.123Z"))
        assertThat(launchEventTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(launchEventTupleResponse.id()).contains("LAUNCHEVENT-ID")
        assertThat(launchEventTupleResponse.beNumber()).contains("ENC-123")
        assertThat(launchEventTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(launchEventTupleResponse.createdBy()).contains("some.user")
        assertThat(launchEventTupleResponse.declassificationDate())
            .contains(OffsetDateTime.parse("2021-01-01T01:02:02.123Z"))
        assertThat(launchEventTupleResponse.declassificationString())
            .contains("Example Declassification")
        assertThat(launchEventTupleResponse.derivedFrom()).contains("Example source")
        assertThat(launchEventTupleResponse.idOnOrbit()).contains("REF-ONORBIT-ID")
        assertThat(launchEventTupleResponse.launchDate())
            .contains(OffsetDateTime.parse("2020-01-01T00:00:00.123Z"))
        assertThat(launchEventTupleResponse.launchFacilityName())
            .contains("Example launch facility name")
        assertThat(launchEventTupleResponse.launchFailureCode()).contains("Example failure code")
        assertThat(launchEventTupleResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(launchEventTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(launchEventTupleResponse.origNetwork()).contains("ORIG")
        assertThat(launchEventTupleResponse.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(launchEventTupleResponse.oSuffix()).contains("oSuffix")
        assertThat(launchEventTupleResponse.satNo()).contains(12)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedLaunchEventTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(launchEventTupleResponse),
                jacksonTypeRef<LaunchEventTupleResponse>(),
            )

        assertThat(roundtrippedLaunchEventTupleResponse).isEqualTo(launchEventTupleResponse)
    }
}
