...
internal class CollectRequestQueryHelpResponseTest {
    ...
    @Test
    fun create() {
      val collectRequestQueryHelpResponse = CollectRequestQueryHelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(collectRequestQueryHelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(collectRequestQueryHelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(collectRequestQueryHelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedCollectRequestQueryHelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(collectRequestQueryHelpResponse), jacksonTypeRef<CollectRequestQueryHelpResponse>())

      assertThat(roundtrippedCollectRequestQueryHelpResponse).isEqualTo(collectRequestQueryHelpResponse)
    }
}
