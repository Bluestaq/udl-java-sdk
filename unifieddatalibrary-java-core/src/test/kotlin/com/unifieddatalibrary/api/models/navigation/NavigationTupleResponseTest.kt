...
internal class NavigationTupleResponseTest {
    ...
    @Test
    fun create() {
        val navigationTupleResponse =
            NavigationTupleResponse.builder()
        ...
        assertThat(navigationTupleResponse.dataMode())
            .isEqualTo(NavigationTupleResponse.DataMode.TEST)
        ...
        assertThat(navigationTupleResponse.createdAt())
        ...
        assertThat(navigationTupleResponse.entity())
            .contains(
                EntityFull.builder()
                    .classificationMarking("U")
                    .dataMode(EntityFull.DataMode.TEST)
        ...
        assertThat(navigationTupleResponse.idEntity())
        ...
        assertThat(navigationTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedNavigationTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(navigationTupleResponse),
                jacksonTypeRef<NavigationTupleResponse>(),
            )
