...
internal class NavigationTupleResponseTest {

    @Test
    fun create() {
      val navigationTupleResponse = NavigationTupleResponse.builder()
          .classificationMarking("U")
          .dataMode(NavigationTupleResponse.DataMode.TEST)
          .name("NAME")
          .source("Bluestaq")
          .id("NAVIGATION-ID")
      ...
      assertThat(navigationTupleResponse.classificationMarking()).isEqualTo("U")
      assertThat(navigationTupleResponse.dataMode()).isEqualTo(NavigationTupleResponse.DataMode.TEST)
      assertThat(navigationTupleResponse.name()).isEqualTo("NAME")
      assertThat(navigationTupleResponse.source()).isEqualTo("Bluestaq")
      assertThat(navigationTupleResponse.id()).contains("NAVIGATION-ID")
      assertThat(navigationTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(navigationTupleResponse.createdBy()).contains("some.user")
      assertThat(navigationTupleResponse.description()).contains("DESCRIPTION")
      assertThat(navigationTupleResponse.entity()).contains(EntityFull.builder()
          .classificationMarking("U")
          .dataMode(EntityFull.DataMode.TEST)
          .name("Example name")
          .source("Bluestaq")
          ...
          .addUrl("URL2")
          .build())
      assertThat(navigationTupleResponse.idEntity()).contains("0167f577-e06c-358e-85aa-0a07a730bdd0")
      assertThat(navigationTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
      assertThat(navigationTupleResponse.origNetwork()).contains("ORIG")
      assertThat(navigationTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(navigationTupleResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedNavigationTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(navigationTupleResponse), jacksonTypeRef<NavigationTupleResponse>())

      assertThat(roundtrippedNavigationTupleResponse).isEqualTo(navigationTupleResponse)
    }
}
