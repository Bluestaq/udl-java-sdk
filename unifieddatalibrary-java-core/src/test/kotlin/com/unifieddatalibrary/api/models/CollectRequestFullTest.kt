...
internal class CollectRequestFullTest {

    @Test
    fun create() {
      val collectRequestFull = CollectRequestFull.builder()
          .classificationMarking("U")
          .dataMode(CollectRequestFull.DataMode.TEST)
          .source("Bluestaq")
          ...
          .eccentricity(1.1)
          .el(1.1)
          .elset(CollectRequestFull.Elset.builder()
              .classificationMarking("U")
              .dataMode(CollectRequestFull.Elset.DataMode.TEST)
              ...
              .addSourcedDataType(CollectRequestFull.Elset.SourcedDataType.RADAR)
              .addSourcedDataType(CollectRequestFull.Elset.SourcedDataType.RF)
              .sourceDl("AXE")
              .addTag("PROVIDER_TAG1")
              .addTag("PROVIDER_TAG2")
          ...
          .srchInc(1.1)
          .srchPattern("SCAN")
          .stateVector(CollectRequestFull.StateVector.builder()
              .classificationMarking("U")
              .dataMode(CollectRequestFull.StateVector.DataMode.TEST)
              .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
              .source("Bluestaq")
              .actualOdSpan(3.5)
              ...
              .covReferenceFrame(CollectRequestFull.StateVector.CovReferenceFrame.J2000)
              .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
              .createdBy("some.user")
              ...
              .recOdSpan(3.5)
              .referenceFrame(CollectRequestFull.StateVector.ReferenceFrame.J2000)
              .residualsAcc(99.5)
              .revNo(7205)
              .rms(0.991)
              .satNo(12)
              ...
              .addSourcedDataType(CollectRequestFull.StateVector.SourcedDataType.RADAR)
              .sourceDl("AXE")
              .srpArea(4.311)
              .stepMode("AUTO")
              .stepSize(1.23)
      ...
      assertThat(collectRequestFull.classificationMarking()).isEqualTo("U")
      assertThat(collectRequestFull.dataMode()).isEqualTo(CollectRequestFull.DataMode.TEST)
      assertThat(collectRequestFull.source()).isEqualTo("Bluestaq")
      assertThat(collectRequestFull.startTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(collectRequestFull.type()).isEqualTo("DWELL")
      assertThat(collectRequestFull.id()).contains("COLLECTREQUEST-ID")
      assertThat(collectRequestFull.alt()).contains(1.1)
      assertThat(collectRequestFull.argOfPerigee()).contains(1.1)
      assertThat(collectRequestFull.az()).contains(1.1)
      assertThat(collectRequestFull.collectResponse().getOrNull()).containsExactly(CollectResponseFull.builder()
          .classificationMarking("U")
          .dataMode(CollectResponseFull.DataMode.TEST)
          .idRequest("REF-REQUEST-ID")
          .source("Bluestaq")
          ...
          .taskId("TASK-ID")
          .build())
      assertThat(collectRequestFull.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(collectRequestFull.createdBy()).contains("some.user")
      assertThat(collectRequestFull.customer()).contains("Bluestaq")
      assertThat(collectRequestFull.dec()).contains(1.1)
      assertThat(collectRequestFull.duration()).contains(11)
      assertThat(collectRequestFull.dwellId()).contains("DWELL-ID")
      assertThat(collectRequestFull.eccentricity()).contains(1.1)
      assertThat(collectRequestFull.el()).contains(1.1)
      assertThat(collectRequestFull.elset()).contains(CollectRequestFull.Elset.builder()
          .classificationMarking("U")
          .dataMode(CollectRequestFull.Elset.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .uct(false)
          .build())
      assertThat(collectRequestFull.endTime()).contains(OffsetDateTime.parse("2018-01-01T18:00:00.123456Z"))
      assertThat(collectRequestFull.epoch()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(collectRequestFull.esId()).contains("ES-ID")
      assertThat(collectRequestFull.extentAz()).contains(1.1)
      assertThat(collectRequestFull.extentEl()).contains(1.1)
      assertThat(collectRequestFull.extentRange()).contains(1.1)
      assertThat(collectRequestFull.externalId()).contains("EXTERNAL-ID")
      assertThat(collectRequestFull.frameRate()).contains(1.1)
      assertThat(collectRequestFull.freq()).contains(1.1)
      assertThat(collectRequestFull.freqMax()).contains(1.1)
      assertThat(collectRequestFull.freqMin()).contains(1.1)
      assertThat(collectRequestFull.idElset()).contains("REF-ELSET-ID")
      assertThat(collectRequestFull.idManifold()).contains("REF-MANIFOLD-ID")
      assertThat(collectRequestFull.idOnOrbit()).contains("REF-ONORBIT-ID")
      assertThat(collectRequestFull.idParentReq()).contains("da98671b-34db-47bf-8c8d-7c668b92c800")
      assertThat(collectRequestFull.idPlan()).contains("REF-PLAN-ID")
      assertThat(collectRequestFull.idSensor()).contains("REF-SENSOR-ID")
      assertThat(collectRequestFull.idStateVector()).contains("STATEVECTOR-ID")
      assertThat(collectRequestFull.inclination()).contains(1.1)
      assertThat(collectRequestFull.integrationTime()).contains(1.1)
      assertThat(collectRequestFull.iron()).contains(3)
      assertThat(collectRequestFull.irradiance()).contains(1.1)
      assertThat(collectRequestFull.lat()).contains(1.1)
      assertThat(collectRequestFull.lon()).contains(1.1)
      assertThat(collectRequestFull.msgCreateDate()).contains(OffsetDateTime.parse("2024-04-25T08:17:01.346Z"))
      assertThat(collectRequestFull.msgType()).contains("SU67")
      assertThat(collectRequestFull.notes()).contains("Example notes")
      assertThat(collectRequestFull.numFrames()).contains(6)
      assertThat(collectRequestFull.numObs()).contains(9)
      assertThat(collectRequestFull.numTracks()).contains(3)
      assertThat(collectRequestFull.obType()).contains("RADAR")
      assertThat(collectRequestFull.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
          ...
          .updatedBy("some.user")
          .build())
      assertThat(collectRequestFull.orbitRegime()).contains("GEO")
      assertThat(collectRequestFull.orientAngle()).contains(1.1)
      assertThat(collectRequestFull.origin()).contains("Example source")
      assertThat(collectRequestFull.origNetwork()).contains("ORIG")
      assertThat(collectRequestFull.origObjectId()).contains("ORIGOBJECT-ID")
      assertThat(collectRequestFull.origSensorId()).contains("ORIGSENSOR-ID")
      assertThat(collectRequestFull.planIndex()).contains(8)
      assertThat(collectRequestFull.polarization()).contains("H")
      assertThat(collectRequestFull.priority()).contains("EMERGENCY")
      assertThat(collectRequestFull.ra()).contains(1.1)
      assertThat(collectRequestFull.raan()).contains(1.1)
      assertThat(collectRequestFull.range()).contains(1.1)
      assertThat(collectRequestFull.rcs()).contains(1.1)
      assertThat(collectRequestFull.rcsMax()).contains(1.1)
      assertThat(collectRequestFull.rcsMin()).contains(1.1)
      assertThat(collectRequestFull.reflectance()).contains(1.1)
      assertThat(collectRequestFull.satNo()).contains(101)
      assertThat(collectRequestFull.scenario()).contains("Example direction")
      assertThat(collectRequestFull.semiMajorAxis()).contains(1.1)
      assertThat(collectRequestFull.spectralModel()).contains("Example Model")
      assertThat(collectRequestFull.srchInc()).contains(1.1)
      assertThat(collectRequestFull.srchPattern()).contains("SCAN")
      assertThat(collectRequestFull.stateVector()).contains(CollectRequestFull.StateVector.builder()
          .classificationMarking("U")
          .dataMode(CollectRequestFull.StateVector.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .zvelAlt2(-3.365155181)
          .build())
      assertThat(collectRequestFull.stopAlt()).contains(1.1)
      assertThat(collectRequestFull.stopLat()).contains(1.1)
      assertThat(collectRequestFull.stopLon()).contains(1.1)
      assertThat(collectRequestFull.suffix()).contains("T")
      assertThat(collectRequestFull.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
      assertThat(collectRequestFull.targetSize()).contains(1.1)
      assertThat(collectRequestFull.taskCategory()).contains(4)
      assertThat(collectRequestFull.taskGroup()).contains("729")
      assertThat(collectRequestFull.taskId()).contains("TASK-ID")
      assertThat(collectRequestFull.transactionId()).contains("TRANSACTION-ID")
      assertThat(collectRequestFull.trueAnomoly()).contains(1.1)
      assertThat(collectRequestFull.uctFollowUp()).contains(false)
      assertThat(collectRequestFull.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(collectRequestFull.updatedBy()).contains("some.user")
      assertThat(collectRequestFull.visMag()).contains(1.1)
      assertThat(collectRequestFull.visMagMax()).contains(1.1)
      assertThat(collectRequestFull.visMagMin()).contains(1.1)
      assertThat(collectRequestFull.xAngle()).contains(1.1)
      assertThat(collectRequestFull.yAngle()).contains(1.1)
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCollectRequestFull = jsonMapper.readValue(jsonMapper.writeValueAsString(collectRequestFull), jacksonTypeRef<CollectRequestFull>())

      assertThat(roundtrippedCollectRequestFull).isEqualTo(collectRequestFull)
    }
}
