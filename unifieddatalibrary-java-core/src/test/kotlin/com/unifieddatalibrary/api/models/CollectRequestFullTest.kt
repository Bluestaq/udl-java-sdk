...
internal class CollectRequestFullTest {
    ...
    fun create() {
        val collectRequestFull =
            CollectRequestFull.builder()
                ...
                .el(1.1)
                .elset(
                    CollectRequestFull.Elset.builder()
                        .classificationMarking("U")
                ...
                .srchPattern("SCAN")
                .stateVector(
                    CollectRequestFull.StateVector.builder()
                        .classificationMarking("U")
        ...
        assertThat(collectRequestFull.startTime())
        ...
        assertThat(collectRequestFull.collectResponse().getOrNull())
            .containsExactly(
                CollectResponseFull.builder()
                    .classificationMarking("U")
                    .dataMode(CollectResponseFull.DataMode.TEST)
        ...
        assertThat(collectRequestFull.createdAt())
        ...
        assertThat(collectRequestFull.elset())
            .contains(
                CollectRequestFull.Elset.builder()
                    .classificationMarking("U")
                    .dataMode(CollectRequestFull.Elset.DataMode.TEST)
        ...
        assertThat(collectRequestFull.endTime())
            .contains(OffsetDateTime.parse("2018-01-01T18:00:00.123456Z"))
        assertThat(collectRequestFull.epoch())
        ...
        assertThat(collectRequestFull.idParentReq())
        ...
        assertThat(collectRequestFull.msgCreateDate())
        ...
        assertThat(collectRequestFull.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(collectRequestFull.origNetwork()).contains("OPS1")
        ...
        assertThat(collectRequestFull.stateVector())
            .contains(
                CollectRequestFull.StateVector.builder()
                    .classificationMarking("U")
                    .dataMode(CollectRequestFull.StateVector.DataMode.TEST)
        ...
        assertThat(collectRequestFull.tags().getOrNull())
        ...
        assertThat(collectRequestFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectRequestFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectRequestFull),
                jacksonTypeRef<CollectRequestFull>(),
            )
