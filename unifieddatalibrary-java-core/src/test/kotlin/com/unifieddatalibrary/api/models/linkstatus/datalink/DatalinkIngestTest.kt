...
internal class DatalinkIngestTest {
    ...
    fun create() {
        ...
        assertThat(datalinkIngest.startTime())
        ...
        assertThat(datalinkIngest.ackInstUnits().getOrNull())
        ...
        assertThat(datalinkIngest.canxTs())
        ...
        assertThat(datalinkIngest.createdAt())
        ...
        assertThat(datalinkIngest.decInstDates().getOrNull())
        ...
        assertThat(datalinkIngest.multiDuty().getOrNull())
            .containsExactly(
                DatalinkIngest.MultiDuty.builder()
                    .duty("SICO")
                    .addDutyTeleFreqNum("TEL:804-555-4142")
        ...
        assertThat(datalinkIngest.nonLinkUnitDes().getOrNull())
        ...
        assertThat(datalinkIngest.ops().getOrNull())
            .containsExactly(
                DatalinkIngest.Op.builder()
                    .linkDetails("Link details")
                    .linkName("Link-16")
        ...
        assertThat(datalinkIngest.pocNums().getOrNull())
        ...
        assertThat(datalinkIngest.refPoints().getOrNull())
            .containsExactly(
                DatalinkIngest.RefPoint.builder()
                    .effEventTime(OffsetDateTime.parse("2024-01-08T13:55:43.123Z"))
                    .refDes("L5")
        ...
        assertThat(datalinkIngest.remarks().getOrNull())
            .containsExactly(
                DatalinkIngest.Remark.builder()
                    .text("Example data link remarks")
                    .type("CONTINGENCY PROCEDURES")
        ...
        assertThat(datalinkIngest.specTracks().getOrNull())
            .containsExactly(
                DatalinkIngest.SpecTrack.builder()
                    .specTrackNum("12345")
                    .specTrackNumDesc("SAM SITE CHARLIE")
        ...
        assertThat(datalinkIngest.stopTime())
        ...
        assertThat(datalinkIngest.trackNumBlocks().getOrNull())
            .containsExactly("0200-0300", "0400-4412")
        assertThat(datalinkIngest.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(datalinkIngest.updatedBy()).contains("some.user")
        assertThat(datalinkIngest.voiceCoord().getOrNull())
            .containsExactly(
                DatalinkIngest.VoiceCoord.builder()
                    .commPri("P")
                    .freqDes("ST300A")
    ...
    fun roundtrip() {
        ...
        val roundtrippedDatalinkIngest =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(datalinkIngest),
                jacksonTypeRef<DatalinkIngest>(),
            )
