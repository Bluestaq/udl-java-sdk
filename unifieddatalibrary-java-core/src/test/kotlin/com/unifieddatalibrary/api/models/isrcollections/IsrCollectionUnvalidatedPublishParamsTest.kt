...
internal class IsrCollectionUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      IsrCollectionUnvalidatedPublishParams.builder()
          .addBody(IsrCollectionUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(IsrCollectionUnvalidatedPublishParams.Body.DataMode.TEST)
              .source("Bluestaq")
              .id("ISRCOLLECTION-ID")
              .addCollectionRequirement(IsrCollectionUnvalidatedPublishParams.Body.CollectionRequirement.builder()
                  .id("ISCRCOLLECTIONREQUIREMENTS")
                  .country("VE")
                  .cridNumbers("CRID")
                  .criticalTimes(IsrCollectionUnvalidatedPublishParams.Body.CollectionRequirement.CriticalTimes.builder()
                      ...
                      .build())
                  .emphasized(false)
                  .exploitationRequirement(IsrCollectionUnvalidatedPublishParams.Body.CollectionRequirement.ExploitationRequirement.builder()
                      .id("ISRCOLLECTIONEXPLOITATIONREQUIREMENT")
                      .amplification("AMPLIFICATION")
                      .dissemination("EMAILS")
                      .eei("ESSENTIAL_ELEMENTS")
                      .poc(IsrCollectionUnvalidatedPublishParams.Body.CollectionRequirement.ExploitationRequirement.Poc.builder()
              ...
              .origNetwork("ORIG")
              .addTasking(IsrCollectionUnvalidatedPublishParams.Body.Tasking.builder()
                  .id("ISRCOLLECTIONTASKINGS-ID")
                  .collectionPeriods(IsrCollectionUnvalidatedPublishParams.Body.Tasking.CollectionPeriods.builder()
                      .addActual(IsrCollectionUnvalidatedPublishParams.Body.Tasking.CollectionPeriods.Actual.builder()
                          .id("ISRCOLLECTIONACTUAL-ID")
                          .start(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                          .stop(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                          .build())
                      .planned(IsrCollectionUnvalidatedPublishParams.Body.Tasking.CollectionPeriods.Planned.builder()
                          .addAdditional(IsrCollectionUnvalidatedPublishParams.Body.Tasking.CollectionPeriods.Planned.Additional.builder()
                          ...
                          .build())
                      .build())
                  .collectionType(IsrCollectionUnvalidatedPublishParams.Body.Tasking.CollectionType.SIMULTANEOUS)
                  .eightLine("eightLine")
                  .specialComGuidance("TEXT")
                  .sroTrack("SRO")
                  .taskingAor("Kandahar")
                  .taskingCollectionArea("AREA")
                  .addTaskingCollectionRequirement(IsrCollectionUnvalidatedPublishParams.Body.Tasking.TaskingCollectionRequirement.builder()
                      .id("ISCRCOLLECTIONREQUIREMENTS")
                      .country("VE")
                      .cridNumbers("CRID")
                      .criticalTimes(IsrCollectionUnvalidatedPublishParams.Body.Tasking.TaskingCollectionRequirement.CriticalTimes.builder()
                          .earliestImagingTime(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                          .latestImagingTime(OffsetDateTime.parse("2021-01-19T01:11:15.001Z"))
                          .build())
                      .emphasized(false)
                      .exploitationRequirement(IsrCollectionUnvalidatedPublishParams.Body.Tasking.TaskingCollectionRequirement.ExploitationRequirement.builder()
                          .id("ISRCOLLECTIONEXPLOITATIONREQUIREMENT")
                          .amplification("AMPLIFICATION")
                          .dissemination("EMAILS")
                          .eei("ESSENTIAL_ELEMENTS")
                          .poc(IsrCollectionUnvalidatedPublishParams.Body.Tasking.TaskingCollectionRequirement.ExploitationRequirement.Poc.builder()
                              .id("ISRCOLLECTIONPOC-ID")
                              .callsign("CALLSIGN")
                              .chatName("CHAT_NAME")
                              .chatSystem("CHAT")
                  ...
                  .type(IsrCollectionUnvalidatedPublishParams.Body.Tasking.Type.DELIBERATE)
                  .build())
              .addTransit(IsrCollectionUnvalidatedPublishParams.Body.Transit.builder()
    ...
    @Test
    fun body() {
      val params = IsrCollectionUnvalidatedPublishParams.builder()
          .addBody(IsrCollectionUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(IsrCollectionUnvalidatedPublishParams.Body.DataMode.TEST)
              .source("Bluestaq")
      ...
      assertThat(body).containsExactly(IsrCollectionUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(IsrCollectionUnvalidatedPublishParams.Body.DataMode.TEST)
          .source("Bluestaq")
          .id("ISRCOLLECTION-ID")
