...
internal class HistoryListResponseTest {
    ...
    fun create() {
      val historyListResponse = HistoryListResponse.builder()
          ...
          .origNetwork("ORIG")
          .addTasking(HistoryListResponse.Tasking.builder()
              .id("ISRCOLLECTIONTASKINGS-ID")
              .collectionPeriods(HistoryListResponse.Tasking.CollectionPeriods.builder()
                  .addActual(HistoryListResponse.Tasking.CollectionPeriods.Actual.builder()
                      .id("ISRCOLLECTIONACTUAL-ID")
                      .start(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                      .stop(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
                      .build())
                  .planned(HistoryListResponse.Tasking.CollectionPeriods.Planned.builder()
                      .addAdditional(HistoryListResponse.Tasking.CollectionPeriods.Planned.Additional.builder()
              ...
              .build())
          .addTransit(HistoryListResponse.Transit.builder()
      ...
      assertThat(historyListResponse.collectionRequirements().getOrNull()).containsExactly(IsrCollectionRequirementsFull.builder()
          .id("ISCRCOLLECTIONREQUIREMENTS")
          .country("VE")
          .cridNumbers("CRID")
          .criticalTimes(IsrCollectionCriticalTimesFull.builder()
          ...
          .type("COLLECTION_TYPE")
          .build())
      assertThat(historyListResponse.createdAt()).contains(OffsetDateTime.parse("2021-01-19T01:01:15.001Z"))
      ...
      assertThat(historyListResponse.taskings().getOrNull()).containsExactly(HistoryListResponse.Tasking.builder()
          .id("ISRCOLLECTIONTASKINGS-ID")
          .collectionPeriods(HistoryListResponse.Tasking.CollectionPeriods.builder()
              .addActual(HistoryListResponse.Tasking.CollectionPeriods.Actual.builder()
                  .id("ISRCOLLECTIONACTUAL-ID")
          ...
          .type(HistoryListResponse.Tasking.Type.DELIBERATE)
          .build())
      assertThat(historyListResponse.transit().getOrNull()).containsExactly(HistoryListResponse.Transit.builder()
          .id("ISRCOLLECTIONTRANSIT-ID")
          .base("ENVOYS")
          .duration(200.23)
          .build())
