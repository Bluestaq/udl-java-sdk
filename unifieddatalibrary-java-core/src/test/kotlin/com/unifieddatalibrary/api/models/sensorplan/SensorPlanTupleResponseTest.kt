...
internal class SensorPlanTupleResponseTest {

    @Test
    fun create() {
        val sensorPlanTupleResponse =
            SensorPlanTupleResponse.builder()
                .classificationMarking("U")
                .dataMode(SensorPlanTupleResponse.DataMode.TEST)
                .recType("COLLECT")
                .source("Bluestaq")
                ...
                .id("SENSORPLAN-ID")
                .addCollectRequest(
                    SensorPlanTupleResponse.CollectRequest.builder()
                        .classificationMarking("U")
                        .dataMode(SensorPlanTupleResponse.CollectRequest.DataMode.TEST)
                        .source("Bluestaq")
                        .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                        .type("DWELL")
                        ...
                        .el(1.1)
                        .elset(
                            SensorPlanTupleResponse.CollectRequest.Elset.builder()
                                .classificationMarking("U")
                                .dataMode(
                                    SensorPlanTupleResponse.CollectRequest.Elset.DataMode.TEST
                                )
                                ...
                                .addSourcedDataType(
                                    SensorPlanTupleResponse.CollectRequest.Elset.SourcedDataType
                                        .RADAR
                                )
                                .addSourcedDataType(
                                    SensorPlanTupleResponse.CollectRequest.Elset.SourcedDataType.RF
                                )
                                .sourceDl("AXE")
                                .addTag("PROVIDER_TAG1")
                                .addTag("PROVIDER_TAG2")
                        ...
                        .srchPattern("SCAN")
                        .stateVector(
                            SensorPlanTupleResponse.CollectRequest.StateVector.builder()
                                .classificationMarking("U")
                                .dataMode(
                                    SensorPlanTupleResponse.CollectRequest.StateVector.DataMode.TEST
                                )
                                .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                                .source("Bluestaq")
                                .actualOdSpan(3.5)
                                ...
                                .covReferenceFrame(
                                    SensorPlanTupleResponse.CollectRequest.StateVector
                                        .CovReferenceFrame
                                        .J2000
                                )
                                .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        ...
        assertThat(sensorPlanTupleResponse.classificationMarking()).isEqualTo("U")
        assertThat(sensorPlanTupleResponse.dataMode())
            .isEqualTo(SensorPlanTupleResponse.DataMode.TEST)
        assertThat(sensorPlanTupleResponse.recType()).isEqualTo("COLLECT")
        assertThat(sensorPlanTupleResponse.source()).isEqualTo("Bluestaq")
        assertThat(sensorPlanTupleResponse.startTime())
            .isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
        assertThat(sensorPlanTupleResponse.type()).isEqualTo("PLAN")
        assertThat(sensorPlanTupleResponse.id()).contains("SENSORPLAN-ID")
        assertThat(sensorPlanTupleResponse.collectRequests().getOrNull())
            .containsExactly(
                SensorPlanTupleResponse.CollectRequest.builder()
                    .classificationMarking("U")
                    .dataMode(SensorPlanTupleResponse.CollectRequest.DataMode.TEST)
                    ...
                    .elset(
                        SensorPlanTupleResponse.CollectRequest.Elset.builder()
                            .classificationMarking("U")
                            .dataMode(SensorPlanTupleResponse.CollectRequest.Elset.DataMode.TEST)
                            .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .source("Bluestaq")
                            .agom(0.0126)
                            .algorithm("Example algorithm")
                            ...
                            .addSourcedData("OBSERVATION_UUID2")
                            .addSourcedDataType(
                                SensorPlanTupleResponse.CollectRequest.Elset.SourcedDataType.RADAR
                            )
                            .addSourcedDataType(
                                SensorPlanTupleResponse.CollectRequest.Elset.SourcedDataType.RF
                            )
                    ...
                    .stateVector(
                        SensorPlanTupleResponse.CollectRequest.StateVector.builder()
                            ...
                            .covMethod("CALCULATED")
                            .covReferenceFrame(
                                SensorPlanTupleResponse.CollectRequest.StateVector.CovReferenceFrame
                                    .J2000
                            )
                            .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                            .createdBy("some.user")
                            ...
                            .recOdSpan(3.5)
                            .referenceFrame(
                                SensorPlanTupleResponse.CollectRequest.StateVector.ReferenceFrame
                                    .J2000
                            )
                            .residualsAcc(99.5)
                            .revNo(7205)
                            ...
                            .addSourcedData("DATA2")
                            .addSourcedDataType(
                                SensorPlanTupleResponse.CollectRequest.StateVector.SourcedDataType
                                    .RADAR
                            )
                            .sourceDl("AXE")
                            .srpArea(4.311)
        ...
        assertThat(sensorPlanTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(sensorPlanTupleResponse.createdBy()).contains("some.user")
        assertThat(sensorPlanTupleResponse.customer()).contains("CUSTOMER")
        assertThat(sensorPlanTupleResponse.endTime())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
        assertThat(sensorPlanTupleResponse.idSensor()).contains("REF-SENSOR-ID")
        assertThat(sensorPlanTupleResponse.name()).contains("EXAMPLE NAME")
        assertThat(sensorPlanTupleResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(sensorPlanTupleResponse.origNetwork()).contains("OPS1")
        assertThat(sensorPlanTupleResponse.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(sensorPlanTupleResponse.purpose()).contains("Example purpose")
        assertThat(sensorPlanTupleResponse.reqTotal()).contains(2)
        assertThat(sensorPlanTupleResponse.senNetwork()).contains("NETWORK")
        assertThat(sensorPlanTupleResponse.status()).contains("ACCEPTED")
        assertThat(sensorPlanTupleResponse.tags().getOrNull())
            .containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
        assertThat(sensorPlanTupleResponse.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(sensorPlanTupleResponse.updatedBy()).contains("some.user")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSensorPlanTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sensorPlanTupleResponse),
                jacksonTypeRef<SensorPlanTupleResponse>(),
            )

        assertThat(roundtrippedSensorPlanTupleResponse).isEqualTo(sensorPlanTupleResponse)
    }
}
