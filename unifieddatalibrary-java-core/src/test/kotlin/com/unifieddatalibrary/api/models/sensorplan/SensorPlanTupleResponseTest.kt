...
internal class SensorPlanTupleResponseTest {
    ...
    @Test
    fun create() {
      val sensorPlanTupleResponse = SensorPlanTupleResponse.builder()
          ...
          .type("PLAN")
          .id("SENSORPLAN-ID")
          .addCollectRequest(SensorPlanTupleResponse.CollectRequest.builder()
              .classificationMarking("U")
              ...
              .argOfPerigee(1.1)
              .az(1.1)
              .addCollectResponse(CollectResponseFull.builder()
                  .classificationMarking("U")
              ...
              .eccentricity(1.1)
              .el(1.1)
              .elset(SensorPlanTupleResponse.CollectRequest.Elset.builder()
                  .classificationMarking("U")
                  ...
                  .addSourcedDataType(SensorPlanTupleResponse.CollectRequest.Elset.SourcedDataType.RADAR)
                  .addSourcedDataType(SensorPlanTupleResponse.CollectRequest.Elset.SourcedDataType.RF)
                  .sourceDl("AXE")
                  .addTag("PROVIDER_TAG1")
                  .addTag("PROVIDER_TAG2")
              ...
              .srchInc(1.1)
              .srchPattern("SCAN")
              .stateVector(SensorPlanTupleResponse.CollectRequest.StateVector.builder()
                  .classificationMarking("U")
                  .dataMode(SensorPlanTupleResponse.CollectRequest.StateVector.DataMode.TEST)
                  .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                  .source("Bluestaq")
                  .actualOdSpan(3.5)
                  ...
                  .covReferenceFrame(SensorPlanTupleResponse.CollectRequest.StateVector.CovReferenceFrame.J2000)
                  .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                  .createdBy("some.user")
                  ...
                  .recOdSpan(3.5)
                  .referenceFrame(SensorPlanTupleResponse.CollectRequest.StateVector.ReferenceFrame.J2000)
                  .residualsAcc(99.5)
                  .revNo(7205)
                  .rms(0.991)
                  .satNo(12)
                  ...
                  .addSourcedDataType(SensorPlanTupleResponse.CollectRequest.StateVector.SourcedDataType.RADAR)
                  .sourceDl("AXE")
                  .srpArea(4.311)
                  .stepMode("AUTO")
                  .stepSize(1.23)
      ...
      assertThat(sensorPlanTupleResponse.dataMode()).isEqualTo(SensorPlanTupleResponse.DataMode.TEST)
      assertThat(sensorPlanTupleResponse.recType()).isEqualTo("COLLECT")
      assertThat(sensorPlanTupleResponse.source()).isEqualTo("Bluestaq")
      assertThat(sensorPlanTupleResponse.startTime()).isEqualTo(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(sensorPlanTupleResponse.type()).isEqualTo("PLAN")
      assertThat(sensorPlanTupleResponse.id()).contains("SENSORPLAN-ID")
      assertThat(sensorPlanTupleResponse.collectRequests().getOrNull()).containsExactly(SensorPlanTupleResponse.CollectRequest.builder()
          .classificationMarking("U")
          .dataMode(SensorPlanTupleResponse.CollectRequest.DataMode.TEST)
          .source("Bluestaq")
          .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          ...
          .yAngle(1.1)
          .build())
      assertThat(sensorPlanTupleResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(sensorPlanTupleResponse.endTime()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      ...
      assertThat(sensorPlanTupleResponse.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDER_TAG2")
      assertThat(sensorPlanTupleResponse.updatedAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedSensorPlanTupleResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(sensorPlanTupleResponse), jacksonTypeRef<SensorPlanTupleResponse>())
