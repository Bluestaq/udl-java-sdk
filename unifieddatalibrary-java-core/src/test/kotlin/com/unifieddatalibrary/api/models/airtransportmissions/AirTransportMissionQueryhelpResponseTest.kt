...
internal class AirTransportMissionQueryhelpResponseTest {
    ...
    @Test
    fun create() {
      val airTransportMissionQueryhelpResponse = AirTransportMissionQueryhelpResponse.builder()
          .aodrSupported(true)
      ...
      assertThat(airTransportMissionQueryhelpResponse.classificationMarking()).contains("classificationMarking")
      ...
      assertThat(airTransportMissionQueryhelpResponse.parameters().getOrNull()).containsExactly(ParamDescriptor.builder()
          .classificationMarking("classificationMarking")
          .derived(true)
          .description("description")
          .elemMatch(true)
          ...
          .utcDate(true)
          .build())
      assertThat(airTransportMissionQueryhelpResponse.requiredRoles().getOrNull()).containsExactly("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAirTransportMissionQueryhelpResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(airTransportMissionQueryhelpResponse), jacksonTypeRef<AirTransportMissionQueryhelpResponse>())

      assertThat(roundtrippedAirTransportMissionQueryhelpResponse).isEqualTo(airTransportMissionQueryhelpResponse)
    }
}
