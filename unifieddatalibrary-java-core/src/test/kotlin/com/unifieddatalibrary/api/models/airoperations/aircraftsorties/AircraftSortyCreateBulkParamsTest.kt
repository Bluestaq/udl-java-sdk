...
internal class AircraftSortyCreateBulkParamsTest {

    @Test
    fun create() {
        AircraftSortyCreateBulkParams.builder()
            .addBody(
                AircraftSortyCreateBulkParams.Body.builder()
                    .classificationMarking("U")
                    .dataMode(AircraftSortyCreateBulkParams.Body.DataMode.TEST)
                    ...
                    .oxyReqCrew(12.3)
                    .oxyReqPax(12.3)
                    .paperStatus(AircraftSortyCreateBulkParams.Body.PaperStatus.PUBLISHED)
                    .papersVersion("1.1")
                    .parkingLoc("KCOS")
                    .passengers(17)
                    .plannedArrTime(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
                    .pprStatus(AircraftSortyCreateBulkParams.Body.PprStatus.PENDING)
                    .primaryScl("ABC")
                    .rawFileUri("Example URI")
                    .reqConfig("C-1")
                    .resultRemarks("Some remark about aircraft A")
                    .rvnReq(AircraftSortyCreateBulkParams.Body.RvnReq.R)
