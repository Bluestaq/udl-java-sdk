...
internal class SarObservationQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val sarObservationQueryhelpResponse =
            SarObservationQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(sarObservationQueryhelpResponse.classificationMarking())
        ...
        assertThat(sarObservationQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
        ...
        assertThat(sarObservationQueryhelpResponse.requiredRoles().getOrNull())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSarObservationQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sarObservationQueryhelpResponse),
                jacksonTypeRef<SarObservationQueryhelpResponse>(),
            )

        assertThat(roundtrippedSarObservationQueryhelpResponse)
            .isEqualTo(sarObservationQueryhelpResponse)
    }
}
