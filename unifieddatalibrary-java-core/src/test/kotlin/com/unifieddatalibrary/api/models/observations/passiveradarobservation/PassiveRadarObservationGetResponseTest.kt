...
internal class PassiveRadarObservationGetResponseTest {

    @Test
    fun create() {
        val passiveRadarObservationGetResponse =
            PassiveRadarObservationGetResponse.builder()
                .classificationMarking("U")
                .dataMode(PassiveRadarObservationGetResponse.DataMode.TEST)
                ...
                .rcsUnc(1.23)
                .satNo(40699)
                .senReferenceFrame(PassiveRadarObservationGetResponse.SenReferenceFrame.J2000)
                .senx(-4527.793)
                .seny(3793.586)
                .senz(3553.495)
                .snr(17.292053)
        ...
        assertThat(passiveRadarObservationGetResponse.classificationMarking()).isEqualTo("U")
        assertThat(passiveRadarObservationGetResponse.dataMode())
            .isEqualTo(PassiveRadarObservationGetResponse.DataMode.TEST)
        assertThat(passiveRadarObservationGetResponse.obTime())
            .isEqualTo(OffsetDateTime.parse("2023-01-24T23:35:26.518152Z"))
        assertThat(passiveRadarObservationGetResponse.source()).isEqualTo("Bluestaq")
        assertThat(passiveRadarObservationGetResponse.id())
            .contains("bdcacfb0-3c47-4bd0-9d6c-9fa7d2c4fbb0")
        assertThat(passiveRadarObservationGetResponse.accel()).contains(1.23)
        assertThat(passiveRadarObservationGetResponse.accelUnc()).contains(0.1)
        assertThat(passiveRadarObservationGetResponse.alt()).contains(478.056378)
        assertThat(passiveRadarObservationGetResponse.azimuth()).contains(134.5)
        assertThat(passiveRadarObservationGetResponse.azimuthBias()).contains(0.123)
        assertThat(passiveRadarObservationGetResponse.azimuthRate()).contains(0.5)
        assertThat(passiveRadarObservationGetResponse.azimuthUnc()).contains(0.5)
        assertThat(passiveRadarObservationGetResponse.bistaticRange()).contains(754.8212)
        assertThat(passiveRadarObservationGetResponse.bistaticRangeAccel()).contains(1.23)
        assertThat(passiveRadarObservationGetResponse.bistaticRangeAccelUnc()).contains(0.1)
        assertThat(passiveRadarObservationGetResponse.bistaticRangeBias()).contains(2.34)
        assertThat(passiveRadarObservationGetResponse.bistaticRangeRate()).contains(-0.30222)
        assertThat(passiveRadarObservationGetResponse.bistaticRangeRateUnc()).contains(0.123)
        assertThat(passiveRadarObservationGetResponse.bistaticRangeUnc()).contains(5.1)
        assertThat(passiveRadarObservationGetResponse.coning()).contains(60.1)
        assertThat(passiveRadarObservationGetResponse.coningUnc()).contains(0.5)
        assertThat(passiveRadarObservationGetResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(passiveRadarObservationGetResponse.createdBy()).contains("some.user")
        assertThat(passiveRadarObservationGetResponse.declination()).contains(10.23)
        assertThat(passiveRadarObservationGetResponse.delay()).contains(0.00505820232809312)
        assertThat(passiveRadarObservationGetResponse.delayBias()).contains(0.00000123)
        assertThat(passiveRadarObservationGetResponse.delayUnc()).contains(0.0000031)
        assertThat(passiveRadarObservationGetResponse.descriptor()).contains("Descriptor")
        assertThat(passiveRadarObservationGetResponse.doppler()).contains(-101.781641000597)
        assertThat(passiveRadarObservationGetResponse.dopplerUnc()).contains(0.2)
        assertThat(passiveRadarObservationGetResponse.elevation()).contains(76.1)
        assertThat(passiveRadarObservationGetResponse.elevationBias()).contains(0.123)
        assertThat(passiveRadarObservationGetResponse.elevationRate()).contains(0.5)
        assertThat(passiveRadarObservationGetResponse.elevationUnc()).contains(0.5)
        assertThat(passiveRadarObservationGetResponse.extObservationId()).contains("26892")
        assertThat(passiveRadarObservationGetResponse.idOnOrbit()).contains("40699")
        assertThat(passiveRadarObservationGetResponse.idRfEmitter()).contains("RED_CLIFFS_3ABCRN")
        assertThat(passiveRadarObservationGetResponse.idSensor()).contains("OCULUSA")
        assertThat(passiveRadarObservationGetResponse.idSensorRefReceiver()).contains("OculusRef1")
        assertThat(passiveRadarObservationGetResponse.lat()).contains(-35.1181763996856)
        assertThat(passiveRadarObservationGetResponse.lon()).contains(139.613567052763)
        assertThat(passiveRadarObservationGetResponse.obPosition()).contains("FIRST")
        assertThat(passiveRadarObservationGetResponse.onOrbit())
            .contains(
                OnorbitFull.builder()
                    .classificationMarking("U")
                    .dataMode(OnorbitFull.DataMode.TEST)
        ...
        assertThat(passiveRadarObservationGetResponse.origin()).contains("THIRD_PARTY_DATASOURCE")
        assertThat(passiveRadarObservationGetResponse.origNetwork()).contains("OPS1")
        assertThat(passiveRadarObservationGetResponse.origObjectId()).contains("ORIGOBJECT-ID")
        assertThat(passiveRadarObservationGetResponse.origSensorId()).contains("ORIGSENSOR-ID")
        assertThat(passiveRadarObservationGetResponse.orthogonalRcs()).contains(10.23)
        assertThat(passiveRadarObservationGetResponse.orthogonalRcsUnc()).contains(1.23)
        assertThat(passiveRadarObservationGetResponse.ra()).contains(1.23)
        assertThat(passiveRadarObservationGetResponse.rcs()).contains(100.23)
        assertThat(passiveRadarObservationGetResponse.rcsUnc()).contains(1.23)
        assertThat(passiveRadarObservationGetResponse.satNo()).contains(40699)
        assertThat(passiveRadarObservationGetResponse.senReferenceFrame())
            .contains(PassiveRadarObservationGetResponse.SenReferenceFrame.J2000)
        assertThat(passiveRadarObservationGetResponse.senx()).contains(-4527.793)
        assertThat(passiveRadarObservationGetResponse.seny()).contains(3793.586)
        assertThat(passiveRadarObservationGetResponse.senz()).contains(3553.495)
        assertThat(passiveRadarObservationGetResponse.snr()).contains(17.292053)
        assertThat(passiveRadarObservationGetResponse.sourceDl()).contains("AXE")
        assertThat(passiveRadarObservationGetResponse.tags().getOrNull())
            .containsExactly("TAG1", "TAG2")
        assertThat(passiveRadarObservationGetResponse.taskId()).contains("TASK-ID")
        assertThat(passiveRadarObservationGetResponse.timingBias()).contains(1.23)
        assertThat(passiveRadarObservationGetResponse.tof()).contains(0.00592856674135648)
        assertThat(passiveRadarObservationGetResponse.tofBias()).contains(0.00000123)
        assertThat(passiveRadarObservationGetResponse.tofUnc()).contains(0.0000031)
        assertThat(passiveRadarObservationGetResponse.trackId()).contains("12212")
        assertThat(passiveRadarObservationGetResponse.transactionId()).contains("TRANSACTION-ID")
        assertThat(passiveRadarObservationGetResponse.type()).contains("RADAR")
        assertThat(passiveRadarObservationGetResponse.uct()).contains(false)
        assertThat(passiveRadarObservationGetResponse.xvel()).contains(1.23)
        assertThat(passiveRadarObservationGetResponse.yvel()).contains(3.21)
        assertThat(passiveRadarObservationGetResponse.zvel()).contains(3.12)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedPassiveRadarObservationGetResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(passiveRadarObservationGetResponse),
                jacksonTypeRef<PassiveRadarObservationGetResponse>(),
            )

        assertThat(roundtrippedPassiveRadarObservationGetResponse)
            .isEqualTo(passiveRadarObservationGetResponse)
    }
}
