...
internal class HistoryListResponseTest {
    ...
    fun create() {
        ...
        assertThat(historyListResponse.expStartTime())
            .isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(historyListResponse.imageType()).isEqualTo("imageType")
        assertThat(historyListResponse.source()).isEqualTo("Bluestaq")
        assertThat(historyListResponse.id()).contains("SKYIMAGERY-ID")
        assertThat(historyListResponse.annotationKey()).contains("annotationKey")
        assertThat(historyListResponse.calibrationKey()).contains("calibrationKey")
        assertThat(historyListResponse.checksumValue()).contains("checksumValue")
        assertThat(historyListResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(historyListResponse.createdBy()).contains("some.user")
        assertThat(historyListResponse.description()).contains("description")
        assertThat(historyListResponse.eoObservations().getOrNull())
            .containsExactly(
                EoObservationFull.builder()
                    .classificationMarking("U")
                    .dataMode(EoObservationFull.DataMode.TEST)
        ...
        assertThat(historyListResponse.expEndTime())
            .contains(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
        assertThat(historyListResponse.filename()).contains("filename.jpg")
        assertThat(historyListResponse.filesize()).contains(371945L)
        assertThat(historyListResponse.frameFovHeight()).contains(21.23)
        assertThat(historyListResponse.frameFovWidth()).contains(21.23)
        assertThat(historyListResponse.frameHeightPixels()).contains(1)
        assertThat(historyListResponse.frameWidthPixels()).contains(1)
        assertThat(historyListResponse.idAttitudeSet())
            .contains("d039ba29-52f4-4839-8a8f-e85fa416aec5")
        assertThat(historyListResponse.idOnOrbit()).contains("44920")
        assertThat(historyListResponse.idSensor()).contains("420")
        assertThat(historyListResponse.idSoiSet()).contains("531093d0-e9b0-475b-687aeeefefd9")
        assertThat(historyListResponse.imageSetId()).contains("imageSetId")
        assertThat(historyListResponse.imageSetLength()).contains(9)
        assertThat(historyListResponse.imageSourceInfo()).contains("imageSourceInfo")
        ...
        assertThat(historyListResponse.origObjectId()).contains("X15-23452")
        assertThat(historyListResponse.origSensorId()).contains("origSensorId")
        assertThat(historyListResponse.pixelBitDepth()).contains(1)
        assertThat(historyListResponse.pixelFovHeight()).contains(321.123)
        assertThat(historyListResponse.pixelFovWidth()).contains(321.123)
        assertThat(historyListResponse.satNo()).contains(25544)
        assertThat(historyListResponse.senalt()).contains(14.483619321)
        assertThat(historyListResponse.senlat()).contains(-33.283048)
        assertThat(historyListResponse.senlon()).contains(149.372549)
        assertThat(historyListResponse.senQuat().getOrNull())
            .containsExactly(0.03, 0.02, 0.01, 0.012)
        assertThat(historyListResponse.senQuatDot().getOrNull())
            .containsExactly(0.03, 0.02, 0.01, 0.012)
        assertThat(historyListResponse.senx()).contains(14.52)
        assertThat(historyListResponse.seny()).contains(32.41)
        assertThat(historyListResponse.senz()).contains(376.12)
        ...
        assertThat(historyListResponse.topLeftStartAz()).contains(146.321)
        assertThat(historyListResponse.topLeftStartEl()).contains(146.321)
        assertThat(historyListResponse.topLeftStopAz()).contains(3.7)
        assertThat(historyListResponse.topLeftStopEl()).contains(34.233)
