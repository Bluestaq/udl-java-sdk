...
internal class H3GeoCreateParamsTest {

    @Test
    fun create() {
      H3GeoCreateParams.builder()
          .addCell(H3GeoCreateParams.Cell.builder()
    ...
    @Test
    fun body() {
      val params = H3GeoCreateParams.builder()
          .addCell(H3GeoCreateParams.Cell.builder()
              .cellId("830b90fffffffff")
              .classificationMarking("U")
              .dataMode(H3GeoCreateParams.Cell.DataMode.TEST)
      ...
      assertThat(body.cells()).containsExactly(H3GeoCreateParams.Cell.builder()
          .cellId("830b90fffffffff")
          .classificationMarking("U")
          .dataMode(H3GeoCreateParams.Cell.DataMode.TEST)
          .source("Bluestaq")
      ...
      assertThat(body.dataMode()).isEqualTo(H3GeoCreateParams.DataMode.TEST)
