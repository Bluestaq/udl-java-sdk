...
internal class EvacUnvalidatedPublishParamsTest {
                ...
                EvacUnvalidatedPublishParams.Body.builder()
                    ...
                    .addCasualtyInfo(
                        EvacUnvalidatedPublishParams.Body.CasualtyInfo.builder()
                            ...
                            .addCondition(
                                EvacUnvalidatedPublishParams.Body.CasualtyInfo.Condition.builder()
                            ...
                            .addEtiology(
                                EvacUnvalidatedPublishParams.Body.CasualtyInfo.Etiology.builder()
                            ...
                            .gender("MALE")
                            .addHealthState(
                                EvacUnvalidatedPublishParams.Body.CasualtyInfo.HealthState.builder()
                            ...
                            .last4Ssn("1234")
                            .addMedication(
                                EvacUnvalidatedPublishParams.Body.CasualtyInfo.Medication.builder()
                                    .adminRoute("ORAL")
                            ...
                            .addTreatment(
                                EvacUnvalidatedPublishParams.Body.CasualtyInfo.Treatment.builder()
                                    .bodyPart("CHEST")
