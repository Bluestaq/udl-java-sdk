...
internal class SarObservationCreateBulkParamsTest {

    @Test
    fun create() {
      SarObservationCreateBulkParams.builder()
          .addBody(SarObservationCreateBulkParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = SarObservationCreateBulkParams.builder()
          .addBody(SarObservationCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .collectionEnd(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
              .collectionStart(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
      ...
      assertThat(body).containsExactly(SarObservationCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .collectionEnd(OffsetDateTime.parse("2023-04-22T17:38:10.201770Z"))
          .collectionStart(OffsetDateTime.parse("2023-04-22T17:35:00.123456Z"))
          .dataMode(SarObservationCreateBulkParams.Body.DataMode.TEST)
