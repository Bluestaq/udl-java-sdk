...
internal class H3GeoTupleResponseTest {
    ...
    @Test
    fun create() {
        val h3GeoTupleResponse =
            H3GeoTupleResponse.builder()
                .addCell(
                    H3GeoTupleResponse.Cell.builder()
        ...
        assertThat(h3GeoTupleResponse.cells())
            .containsExactly(
                H3GeoTupleResponse.Cell.builder()
                    .cellId("830b90fffffffff")
                    .classificationMarking("U")
        ...
        assertThat(h3GeoTupleResponse.startTime())
        ...
        assertThat(h3GeoTupleResponse.createdAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
        assertThat(h3GeoTupleResponse.createdBy()).contains("some.user")
        assertThat(h3GeoTupleResponse.endTime())
    ...
    fun roundtrip() {
        ...
        val roundtrippedH3GeoTupleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(h3GeoTupleResponse),
                jacksonTypeRef<H3GeoTupleResponse>(),
            )
