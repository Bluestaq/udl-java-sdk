...
internal class OnorbitbatteryListResponseTest {
    ...
    @Test
    fun create() {
        val onorbitbatteryListResponse =
            OnorbitbatteryListResponse.builder()
        ...
        assertThat(onorbitbatteryListResponse.dataMode())
            .isEqualTo(OnorbitbatteryListResponse.DataMode.TEST)
        ...
        assertThat(onorbitbatteryListResponse.battery())
            .contains(
                BatteryAbridged.builder()
                    .dataMode(BatteryAbridged.DataMode.TEST)
                    .name("JAK-BATTERY-1479")
        ...
        assertThat(onorbitbatteryListResponse.createdAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbitbatteryListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbitbatteryListResponse),
                jacksonTypeRef<OnorbitbatteryListResponse>(),
            )
