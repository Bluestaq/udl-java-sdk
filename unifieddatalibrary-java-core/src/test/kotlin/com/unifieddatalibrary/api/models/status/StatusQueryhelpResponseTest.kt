...
internal class StatusQueryhelpResponseTest {
    ...
    @Test
    fun create() {
        val statusQueryhelpResponse =
            StatusQueryhelpResponse.builder()
                .aodrSupported(true)
        ...
        assertThat(statusQueryhelpResponse.classificationMarking())
        ...
        assertThat(statusQueryhelpResponse.parameters().getOrNull())
            .containsExactly(
                ParamDescriptor.builder()
                    .classificationMarking("classificationMarking")
                    .derived(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedStatusQueryhelpResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(statusQueryhelpResponse),
                jacksonTypeRef<StatusQueryhelpResponse>(),
            )
