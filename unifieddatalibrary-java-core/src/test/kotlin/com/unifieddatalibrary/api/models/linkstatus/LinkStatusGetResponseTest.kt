...
internal class LinkStatusGetResponseTest {
    ...
    @Test
    fun create() {
      val linkStatusGetResponse = LinkStatusGetResponse.builder()
      ...
      assertThat(linkStatusGetResponse.linkStartTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(linkStatusGetResponse.linkStopTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      ...
      assertThat(linkStatusGetResponse.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(linkStatusGetResponse.origNetwork()).contains("ORIG")
    ...
    fun roundtrip() {
      ...
      val roundtrippedLinkStatusGetResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(linkStatusGetResponse), jacksonTypeRef<LinkStatusGetResponse>())
