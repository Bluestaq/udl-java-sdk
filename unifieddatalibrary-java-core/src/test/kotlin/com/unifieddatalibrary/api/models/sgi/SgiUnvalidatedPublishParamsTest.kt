...
internal class SgiUnvalidatedPublishParamsTest {

    @Test
    fun create() {
      SgiUnvalidatedPublishParams.builder()
          .addBody(SgiUnvalidatedPublishParams.Body.builder()
    ...
    @Test
    fun body() {
      val params = SgiUnvalidatedPublishParams.builder()
          .addBody(SgiUnvalidatedPublishParams.Body.builder()
              .classificationMarking("U")
              .dataMode(SgiUnvalidatedPublishParams.Body.DataMode.TEST)
              .effectiveDate(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      ...
      assertThat(body).containsExactly(SgiUnvalidatedPublishParams.Body.builder()
          .classificationMarking("U")
          .dataMode(SgiUnvalidatedPublishParams.Body.DataMode.TEST)
          .effectiveDate(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
          .sgiDate(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
