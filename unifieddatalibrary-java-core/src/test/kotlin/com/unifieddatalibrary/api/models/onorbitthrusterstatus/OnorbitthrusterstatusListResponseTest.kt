...
internal class OnorbitthrusterstatusListResponseTest {
    ...
    @Test
    fun create() {
        val onorbitthrusterstatusListResponse =
            OnorbitthrusterstatusListResponse.builder()
        ...
        assertThat(onorbitthrusterstatusListResponse.dataMode())
            .isEqualTo(OnorbitthrusterstatusListResponse.DataMode.TEST)
        assertThat(onorbitthrusterstatusListResponse.idOnorbitThruster())
            .isEqualTo("ff7dc909-e8b4-4a54-8529-1963d4e9b353")
        assertThat(onorbitthrusterstatusListResponse.source()).isEqualTo("Bluestaq")
        assertThat(onorbitthrusterstatusListResponse.statusTime())
        ...
        assertThat(onorbitthrusterstatusListResponse.createdAt())
        ...
        assertThat(onorbitthrusterstatusListResponse.origNetwork()).contains("OPS1")
    ...
    fun roundtrip() {
        ...
        val roundtrippedOnorbitthrusterstatusListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(onorbitthrusterstatusListResponse),
                jacksonTypeRef<OnorbitthrusterstatusListResponse>(),
            )

        assertThat(roundtrippedOnorbitthrusterstatusListResponse)
            .isEqualTo(onorbitthrusterstatusListResponse)
    }
}
