...
internal class OnorbitGetSignatureResponseTest {
    ...
    @Test
    fun create() {
      val onorbitGetSignatureResponse = OnorbitGetSignatureResponse.builder()
          .eoObservation(EoObservationAbridged.builder()
              ...
              .zeroptd(1.1)
              .build())
          .radarObservation(OnorbitGetSignatureResponse.RadarObservation.builder()
              .classificationMarking("U")
              ...
              .rcsUnc(1.23)
              .satNo(1)
              .senReferenceFrame(OnorbitGetSignatureResponse.RadarObservation.SenReferenceFrame.J2000)
              .senx(45.23)
              .seny(40.23)
              .senz(35.23)
              .snr(0.5)
              ...
              .zvel(5.23)
              .build())
          .rfObservation(OnorbitGetSignatureResponse.RfObservation.builder()
              .classificationMarking("U")
      ...
      assertThat(onorbitGetSignatureResponse.eoObservation()).contains(EoObservationAbridged.builder()
          .classificationMarking("U")
          .dataMode(EoObservationAbridged.DataMode.TEST)
          .obTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .zeroptd(1.1)
          .build())
      assertThat(onorbitGetSignatureResponse.radarObservation()).contains(OnorbitGetSignatureResponse.RadarObservation.builder()
          .classificationMarking("U")
          .dataMode(OnorbitGetSignatureResponse.RadarObservation.DataMode.TEST)
          .obTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .zvel(5.23)
          .build())
      assertThat(onorbitGetSignatureResponse.rfObservation()).contains(OnorbitGetSignatureResponse.RfObservation.builder()
          .classificationMarking("U")
          .dataMode(OnorbitGetSignatureResponse.RfObservation.DataMode.TEST)
          .obTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
    ...
    fun roundtrip() {
      ...
      val roundtrippedOnorbitGetSignatureResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(onorbitGetSignatureResponse), jacksonTypeRef<OnorbitGetSignatureResponse>())
