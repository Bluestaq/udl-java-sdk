...
internal class CollectResponseCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = CollectResponseCreateParams.builder()
          .classificationMarking("U")
          .dataMode(CollectResponseCreateParams.DataMode.TEST)
          .idRequest("REF-REQUEST-ID")
          .source("Bluestaq")
      ...
      assertThat(body.actualEndTime()).contains(OffsetDateTime.parse("2018-01-01T18:00:00.123456Z"))
      assertThat(body.actualStartTime()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
      assertThat(body.altEndTime()).contains(OffsetDateTime.parse("2018-01-01T18:00:00.123456Z"))
      assertThat(body.altStartTime()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
