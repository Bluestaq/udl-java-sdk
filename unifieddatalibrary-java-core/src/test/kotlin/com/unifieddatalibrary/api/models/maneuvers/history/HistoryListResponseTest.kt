...
internal class HistoryListResponseTest {
    ...
    fun create() {
      val historyListResponse = HistoryListResponse.builder()
          ...
          .postEventElset(HistoryListResponse.PostEventElset.builder()
              .classificationMarking("U")
              .dataMode(HistoryListResponse.PostEventElset.DataMode.TEST)
              ...
              .addSourcedDataType(HistoryListResponse.PostEventElset.SourcedDataType.RADAR)
              .addSourcedDataType(HistoryListResponse.PostEventElset.SourcedDataType.RF)
              .sourceDl("AXE")
              .addTag("PROVIDER_TAG1")
              .addTag("PROVIDER_TAG2")
          ...
          .postEventStateVector(HistoryListResponse.PostEventStateVector.builder()
              .classificationMarking("U")
              .dataMode(HistoryListResponse.PostEventStateVector.DataMode.TEST)
              .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
              .source("Bluestaq")
              .actualOdSpan(3.5)
              ...
              .covReferenceFrame(HistoryListResponse.PostEventStateVector.CovReferenceFrame.J2000)
              .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
              .createdBy("some.user")
              ...
              .recOdSpan(3.5)
              .referenceFrame(HistoryListResponse.PostEventStateVector.ReferenceFrame.J2000)
              .residualsAcc(99.5)
              .revNo(7205)
              .rms(0.991)
              .satNo(12)
              ...
              .addSourcedDataType(HistoryListResponse.PostEventStateVector.SourcedDataType.RADAR)
              .sourceDl("AXE")
              .srpArea(4.311)
              .stepMode("AUTO")
              .stepSize(1.23)
          ...
          .preEventElset(HistoryListResponse.PreEventElset.builder()
              .classificationMarking("U")
              .dataMode(HistoryListResponse.PreEventElset.DataMode.TEST)
              .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
              .source("Bluestaq")
              .agom(0.0126)
              .algorithm("Example algorithm")
              ...
              .addSourcedData("OBSERVATION_UUID1")
              .addSourcedData("OBSERVATION_UUID2")
              .addSourcedDataType(HistoryListResponse.PreEventElset.SourcedDataType.RADAR)
              .addSourcedDataType(HistoryListResponse.PreEventElset.SourcedDataType.RF)
              .sourceDl("AXE")
              .addTag("PROVIDER_TAG1")
              .addTag("PROVIDER_TAG2")
              .transactionId("TRANSACTION-ID")
          ...
          .preEventStateVector(HistoryListResponse.PreEventStateVector.builder()
              .classificationMarking("U")
              .dataMode(HistoryListResponse.PreEventStateVector.DataMode.TEST)
              .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
              .source("Bluestaq")
              .actualOdSpan(3.5)
              .algorithm("SAMPLE_ALGORITHM")
              ...
              .covMethod("CALCULATED")
              .covReferenceFrame(HistoryListResponse.PreEventStateVector.CovReferenceFrame.J2000)
              .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
              .createdBy("some.user")
              .descriptor("descriptor")
              .dragArea(4.739)
              ...
              .rawFileUri("rawFileURI")
              .recOdSpan(3.5)
              .referenceFrame(HistoryListResponse.PreEventStateVector.ReferenceFrame.J2000)
              .residualsAcc(99.5)
              .revNo(7205)
              .rms(0.991)
              .satNo(12)
              ...
              .addSourcedData("DATA1")
              .addSourcedData("DATA2")
              .addSourcedDataType(HistoryListResponse.PreEventStateVector.SourcedDataType.RADAR)
              .sourceDl("AXE")
              .srpArea(4.311)
              .stepMode("AUTO")
              .stepSize(1.23)
          ...
          .addSourcedData("SOURCEDDATA-ID")
          .addSourcedDataType(HistoryListResponse.SourcedDataType.EO)
          .addSourcedDataType(HistoryListResponse.SourcedDataType.RADAR)
      ...
      assertThat(historyListResponse.eventStartTime()).isEqualTo(OffsetDateTime.parse("2023-11-16T01:05:16.835689Z"))
      assertThat(historyListResponse.source()).isEqualTo("Bluestaq")
      assertThat(historyListResponse.id()).contains("MANEUVER-ID")
      assertThat(historyListResponse.algorithm()).contains("Example algorithm")
      assertThat(historyListResponse.characterization()).contains("North-South Station Keeping")
      assertThat(historyListResponse.characterizationUnc()).contains(0.15)
      assertThat(historyListResponse.cov().getOrNull()).containsExactly(1.1, 2.4, 3.4, 4.1, 5.6, 6.2, 7.9, 8.0, 9.2, 10.1)
      ...
      assertThat(historyListResponse.deltaMass()).contains(0.15)
      assertThat(historyListResponse.deltaPos()).contains(0.715998327)
      assertThat(historyListResponse.deltaPosU()).contains(-0.022172844)
      assertThat(historyListResponse.deltaPosV()).contains(-0.033700154)
      assertThat(historyListResponse.deltaPosW()).contains(-0.714861014)
      assertThat(historyListResponse.deltaVel()).contains(0.000631505)
      assertThat(historyListResponse.deltaVelU()).contains(0.0000350165629389647)
      assertThat(historyListResponse.deltaVelV()).contains(0.000544413)
      assertThat(historyListResponse.deltaVelW()).contains(-0.000318099)
      assertThat(historyListResponse.description()).contains("Example notes")
      assertThat(historyListResponse.descriptor()).contains("Example descriptor")
      assertThat(historyListResponse.eventEndTime()).contains(OffsetDateTime.parse("2023-11-16T01:09:01.350012Z"))
      assertThat(historyListResponse.eventId()).contains("EVENT-ID")
      assertThat(historyListResponse.idOnOrbit()).contains("12")
      assertThat(historyListResponse.idSensor()).contains("SENSOR-ID")
      assertThat(historyListResponse.maneuverUnc()).contains(0.5)
      assertThat(historyListResponse.mnvrAccels().getOrNull()).containsExactly(0.05, 0.1, 0.05)
      assertThat(historyListResponse.mnvrAccelTimes().getOrNull()).containsExactly(10.25, 50.56, 150.78)
      assertThat(historyListResponse.mnvrAccelUncs().getOrNull()).containsExactly(0.0005, 0.001, 0.0005)
      assertThat(historyListResponse.numAccelPoints()).contains(3)
      assertThat(historyListResponse.numObs()).contains(10)
      assertThat(historyListResponse.odFitEndTime()).contains(OffsetDateTime.parse("2023-11-16T03:55:51.000000Z"))
      assertThat(historyListResponse.onOrbit()).contains(OnorbitFull.builder()
          .classificationMarking("U")
          .dataMode(OnorbitFull.DataMode.TEST)
          .satNo(1)
          .source("Bluestaq")
      ...
      assertThat(historyListResponse.postApogee()).contains(35800.1)
      assertThat(historyListResponse.postArea()).contains(35.77)
      assertThat(historyListResponse.postBallisticCoeff()).contains(0.000433209)
      assertThat(historyListResponse.postDriftRate()).contains(-0.0125)
      assertThat(historyListResponse.postEccentricity()).contains(0.000164)
      assertThat(historyListResponse.postEventElset()).contains(HistoryListResponse.PostEventElset.builder()
          .classificationMarking("U")
          .dataMode(HistoryListResponse.PostEventElset.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .uct(false)
          .build())
      assertThat(historyListResponse.postEventIdElset()).contains("225adf4c-8606-40a8-929e-63e22cffe220")
      assertThat(historyListResponse.postEventIdStateVector()).contains("d83a23f8-1496-485a-bd88-ec5808c73299")
      assertThat(historyListResponse.postEventStateVector()).contains(HistoryListResponse.PostEventStateVector.builder()
          .classificationMarking("U")
          .dataMode(HistoryListResponse.PostEventStateVector.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .zvelAlt2(-3.365155181)
          .build())
      assertThat(historyListResponse.postGeoLongitude()).contains(-93.15)
      assertThat(historyListResponse.postInclination()).contains(0.0327)
      assertThat(historyListResponse.postMass()).contains(1844.5)
      assertThat(historyListResponse.postPerigee()).contains(35787.9)
      assertThat(historyListResponse.postPeriod()).contains(1436.01)
      assertThat(historyListResponse.postPosX()).contains(3589.351957)
      assertThat(historyListResponse.postPosY()).contains(42017.26823)
      assertThat(historyListResponse.postPosZ()).contains(-1.27161796)
      assertThat(historyListResponse.postRaan()).contains(98.3335)
      assertThat(historyListResponse.postRadiationPressCoeff()).contains(4.51e-7)
      assertThat(historyListResponse.postSigmaU()).contains(12.285)
      assertThat(historyListResponse.postSigmaV()).contains(71.339)
      assertThat(historyListResponse.postSigmaW()).contains(12.77)
      assertThat(historyListResponse.postSma()).contains(42164.87)
      assertThat(historyListResponse.postVelX()).contains(-3.063152826)
      assertThat(historyListResponse.postVelY()).contains(0.261586769)
      assertThat(historyListResponse.postVelZ()).contains(0.006842148)
      assertThat(historyListResponse.preApogee()).contains(35802.0)
      assertThat(historyListResponse.preBallisticCoeff()).contains(0.000437116)
      assertThat(historyListResponse.preDriftRate()).contains(-0.0125)
      assertThat(historyListResponse.preEccentricity()).contains(0.00017)
      assertThat(historyListResponse.preEventElset()).contains(HistoryListResponse.PreEventElset.builder()
          .classificationMarking("U")
          .dataMode(HistoryListResponse.PreEventElset.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .uct(false)
          .build())
      assertThat(historyListResponse.preEventIdElset()).contains("80e544b7-6a17-4554-8abf-7301e98f8e5d")
      assertThat(historyListResponse.preEventIdStateVector()).contains("6e291992-8ae3-4592-bb0f-055715bf4803")
      assertThat(historyListResponse.preEventStateVector()).contains(HistoryListResponse.PreEventStateVector.builder()
          .classificationMarking("U")
          .dataMode(HistoryListResponse.PreEventStateVector.DataMode.TEST)
          .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
          .source("Bluestaq")
          ...
          .zvelAlt2(-3.365155181)
          .build())
      assertThat(historyListResponse.preGeoLongitude()).contains(-93.12)
      assertThat(historyListResponse.preInclination()).contains(0.0336)
      assertThat(historyListResponse.prePerigee()).contains(35786.5)
      assertThat(historyListResponse.prePeriod()).contains(1436.12)
      assertThat(historyListResponse.prePosX()).contains(3584.432545)
      assertThat(historyListResponse.prePosY()).contains(42028.43245)
      assertThat(historyListResponse.prePosZ()).contains(-1.97765)
      assertThat(historyListResponse.preRaan()).contains(98.3336)
      assertThat(historyListResponse.preRadiationPressCoeff()).contains(4.51e-7)
      assertThat(historyListResponse.preSigmaU()).contains(0.215)
      assertThat(historyListResponse.preSigmaV()).contains(1.97)
      assertThat(historyListResponse.preSigmaW()).contains(0.208)
      assertThat(historyListResponse.preSma()).contains(42165.1)
      assertThat(historyListResponse.preVelX()).contains(-2.543266)
      assertThat(historyListResponse.preVelY()).contains(0.24876)
      assertThat(historyListResponse.preVelZ()).contains(0.0067352)
      assertThat(historyListResponse.reportTime()).contains(OffsetDateTime.parse("2023-11-16T04:15:00.000100Z"))
      assertThat(historyListResponse.satNo()).contains(12)
      assertThat(historyListResponse.sourcedData().getOrNull()).containsExactly("SOURCEDDATA-ID", "SOURCEDDATA-ID")
      assertThat(historyListResponse.sourcedDataTypes().getOrNull()).containsExactly(HistoryListResponse.SourcedDataType.EO, HistoryListResponse.SourcedDataType.RADAR)
      assertThat(historyListResponse.stateModel()).contains("Example name")
      assertThat(historyListResponse.stateModelVersion()).contains(3.0)
      assertThat(historyListResponse.status()).contains("POSSIBLE")
      assertThat(historyListResponse.tags().getOrNull()).containsExactly("PROVIDER_TAG1", "PROVIDERTAG2")
      assertThat(historyListResponse.totalBurnTime()).contains(600.72)
