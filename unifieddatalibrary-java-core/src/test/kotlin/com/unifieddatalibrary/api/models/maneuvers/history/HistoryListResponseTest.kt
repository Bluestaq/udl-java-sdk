    ...
    fun create() {
        val historyListResponse =
            HistoryListResponse.builder()
                ...
                .postEventElset(
                    HistoryListResponse.PostEventElset.builder()
                        .classificationMarking("U")
                        ...
                        .addSourcedDataType(
                            HistoryListResponse.PostEventElset.SourcedDataType.RADAR
                        )
                ...
                .postEventStateVector(
                    HistoryListResponse.PostEventStateVector.builder()
                        .classificationMarking("U")
                        ...
                        .covReferenceFrame(
                            HistoryListResponse.PostEventStateVector.CovReferenceFrame.J2000
                        )
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        .createdBy("some.user")
                        ...
                        .recOdSpan(3.5)
                        .referenceFrame(
                            HistoryListResponse.PostEventStateVector.ReferenceFrame.J2000
                        )
                        .residualsAcc(99.5)
                        .revNo(7205)
                        .rms(0.991)
                        ...
                        .addSourcedDataType(
                            HistoryListResponse.PostEventStateVector.SourcedDataType.RADAR
                        )
                        .sourceDl("AXE")
                        .srpArea(4.311)
                        .stepMode("AUTO")
                ...
                .preEventElset(
                    HistoryListResponse.PreEventElset.builder()
                        .classificationMarking("U")
                ...
                .preEventStateVector(
                    HistoryListResponse.PreEventStateVector.builder()
                        .classificationMarking("U")
                        ...
                        .covMethod("CALCULATED")
                        .covReferenceFrame(
                            HistoryListResponse.PreEventStateVector.CovReferenceFrame.J2000
                        )
                        .createdAt(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
                        .createdBy("some.user")
                        .descriptor("descriptor")
                        ...
                        .recOdSpan(3.5)
                        .referenceFrame(
                            HistoryListResponse.PreEventStateVector.ReferenceFrame.J2000
                        )
                        .residualsAcc(99.5)
                        .revNo(7205)
                        .rms(0.991)
                        ...
                        .addSourcedData("DATA2")
                        .addSourcedDataType(
                            HistoryListResponse.PreEventStateVector.SourcedDataType.RADAR
                        )
                        .sourceDl("AXE")
                        .srpArea(4.311)
                        .stepMode("AUTO")
        ...
        assertThat(historyListResponse.cov().getOrNull())
        ...
        assertThat(historyListResponse.mnvrAccelTimes().getOrNull())
            .containsExactly(10.25, 50.56, 150.78)
        assertThat(historyListResponse.mnvrAccelUncs().getOrNull())
        ...
        assertThat(historyListResponse.odFitEndTime())
        ...
        assertThat(historyListResponse.postEventElset())
            .contains(
                HistoryListResponse.PostEventElset.builder()
                    .classificationMarking("U")
                    .dataMode(HistoryListResponse.PostEventElset.DataMode.TEST)
        ...
        assertThat(historyListResponse.postEventIdElset())
            .contains("225adf4c-8606-40a8-929e-63e22cffe220")
        assertThat(historyListResponse.postEventIdStateVector())
            .contains("d83a23f8-1496-485a-bd88-ec5808c73299")
        assertThat(historyListResponse.postEventStateVector())
            .contains(
                HistoryListResponse.PostEventStateVector.builder()
                    .classificationMarking("U")
                    .dataMode(HistoryListResponse.PostEventStateVector.DataMode.TEST)
        ...
        assertThat(historyListResponse.preEventElset())
            .contains(
                HistoryListResponse.PreEventElset.builder()
                    .classificationMarking("U")
                    .dataMode(HistoryListResponse.PreEventElset.DataMode.TEST)
        ...
        assertThat(historyListResponse.preEventIdElset())
            .contains("80e544b7-6a17-4554-8abf-7301e98f8e5d")
        assertThat(historyListResponse.preEventIdStateVector())
            .contains("6e291992-8ae3-4592-bb0f-055715bf4803")
        assertThat(historyListResponse.preEventStateVector())
            .contains(
                HistoryListResponse.PreEventStateVector.builder()
                    .classificationMarking("U")
                    .dataMode(HistoryListResponse.PreEventStateVector.DataMode.TEST)
        ...
        assertThat(historyListResponse.sourcedData().getOrNull())
            .containsExactly("SOURCEDDATA-ID", "SOURCEDDATA-ID")
        assertThat(historyListResponse.sourcedDataTypes().getOrNull())
            .containsExactly(
                HistoryListResponse.SourcedDataType.EO,
                HistoryListResponse.SourcedDataType.RADAR,
            )
