...
internal class OnorbitIngestTest {
    ...
    @Test
    fun create() {
      val onorbitIngest = OnorbitIngest.builder()
      ...
      assertThat(onorbitIngest.createdAt()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
      assertThat(onorbitIngest.createdBy()).contains("some.user")
      assertThat(onorbitIngest.decayDate()).contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedOnorbitIngest = jsonMapper.readValue(jsonMapper.writeValueAsString(onorbitIngest), jacksonTypeRef<OnorbitIngest>())
