...
internal class HistoryListResponseTest {
    ...
    fun create() {
      ...
      assertThat(historyListResponse.linkStartTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
      assertThat(historyListResponse.linkStopTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123456Z"))
