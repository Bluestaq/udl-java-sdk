...
internal class AircraftSortyUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = AircraftSortyUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(AircraftSortyUpdateParams.DataMode.TEST)
          .plannedDepTime(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(AircraftSortyUpdateParams.DataMode.TEST)
      assertThat(body.plannedDepTime()).isEqualTo(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.bodyId()).contains("AIRCRAFTSORTIE-ID")
      assertThat(body.actualArrTime()).contains(OffsetDateTime.parse("2021-01-01T01:01:01.123Z"))
      assertThat(body.actualBlockInTime()).contains(OffsetDateTime.parse("2021-01-01T01:06:01.123Z"))
      assertThat(body.actualBlockOutTime()).contains(OffsetDateTime.parse("2021-01-01T00:55:01.123Z"))
      ...
      assertThat(body.estBlockOutTime()).contains(OffsetDateTime.parse("2021-01-01T00:55:01.123Z"))
      ...
      assertThat(body.paperStatus()).contains(AircraftSortyUpdateParams.PaperStatus.PUBLISHED)
      ...
      assertThat(body.pprStatus()).contains(AircraftSortyUpdateParams.PprStatus.PENDING)
      ...
      assertThat(body.rvnReq()).contains(AircraftSortyUpdateParams.RvnReq.R)
