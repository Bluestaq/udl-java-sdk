...
internal class TrackRouteUpdateParamsTest {
    ...
    fun create() {
      TrackRouteUpdateParams.builder()
          ...
          .addAltitudeBlock(TrackRouteUpdateParams.AltitudeBlock.builder()
          ...
          .origNetwork("OPS1")
          .addPoc(TrackRouteUpdateParams.Poc.builder()
              .office("A34")
              .phone("8675309")
              .pocName("Fred Smith")
              .pocOrg("HQAF")
          ...
          .addRoutePoint(TrackRouteUpdateParams.RoutePoint.builder()
              .altCountryCode("IZ")
              .countryCode("NL")
              .dafifPt(true)
              .magDec(7.35)
    ...
    @Test
    fun pathParams() {
      val params = TrackRouteUpdateParams.builder()
          .pathId("id")
          .classificationMarking("U")
          .dataMode(TrackRouteUpdateParams.DataMode.TEST)
          .lastUpdateDate(OffsetDateTime.parse("2024-09-17T16:00:00.123Z"))
    ...
    fun body() {
      ...
      assertThat(body.dataMode()).isEqualTo(TrackRouteUpdateParams.DataMode.TEST)
      assertThat(body.lastUpdateDate()).isEqualTo(OffsetDateTime.parse("2024-09-17T16:00:00.123Z"))
      assertThat(body.source()).isEqualTo("Bluestaq")
      assertThat(body.type()).isEqualTo("AIR REFUELING")
      assertThat(body.bodyId()).contains("026dd511-8ba5-47d3-9909-836149f87686")
      assertThat(body.altitudeBlocks().getOrNull()).containsExactly(TrackRouteUpdateParams.AltitudeBlock.builder()
          .altitudeSequenceId("A1")
          .lowerAltitude(27000.1)
          .upperAltitude(27200.5)
          .build())
      ...
      assertThat(body.poc().getOrNull()).containsExactly(TrackRouteUpdateParams.Poc.builder()
          .office("A34")
          .phone("8675309")
          .pocName("Fred Smith")
          .pocOrg("HQAF")
      ...
      assertThat(body.routePoints().getOrNull()).containsExactly(TrackRouteUpdateParams.RoutePoint.builder()
          .altCountryCode("IZ")
          .countryCode("NL")
          .dafifPt(true)
          .magDec(7.35)
