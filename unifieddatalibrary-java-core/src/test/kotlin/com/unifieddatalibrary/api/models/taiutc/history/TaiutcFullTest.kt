...
internal class TaiutcFullTest {
    ...
    fun create() {
        ...
        assertThat(taiutcFull.adjustmentDate())
        ...
        assertThat(taiutcFull.createdAt())
        ...
        assertThat(taiutcFull.origNetwork()).contains("OPS1")
        ...
        assertThat(taiutcFull.updatedAt())
            .contains(OffsetDateTime.parse("2018-01-01T16:00:00.123Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedTaiutcFull =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(taiutcFull),
                jacksonTypeRef<TaiutcFull>(),
            )
