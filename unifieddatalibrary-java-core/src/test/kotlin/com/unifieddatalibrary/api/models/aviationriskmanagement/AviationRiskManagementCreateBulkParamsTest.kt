...
internal class AviationRiskManagementCreateBulkParamsTest {
    ...
    fun create() {
      AviationRiskManagementCreateBulkParams.builder()
          .addBody(AviationRiskManagementCreateBulkParams.Body.builder()
              ...
              .addAviationRiskManagementWorksheetRecord(AviationRiskManagementCreateBulkParams.Body.AviationRiskManagementWorksheetRecord.builder()
                  .missionDate(LocalDate.parse("2024-11-25"))
                  .aircraftMds("E-2C HAWKEYE")
                  .approvalPending(true)
                  .approved(false)
                  .addAviationRiskManagementWorksheetScore(AviationRiskManagementCreateBulkParams.Body.AviationRiskManagementWorksheetRecord.AviationRiskManagementWorksheetScore.builder()
                      .approvalDate(OffsetDateTime.parse("2024-11-01T16:00:00.123Z"))
                      .approvedBy("John Smith")
                      .approvedCode(0)
                      .addAviationRiskManagementSortie(AviationRiskManagementCreateBulkParams.Body.AviationRiskManagementWorksheetRecord.AviationRiskManagementWorksheetScore.AviationRiskManagementSortie.builder()
    ...
    @Test
    fun body() {
      val params = AviationRiskManagementCreateBulkParams.builder()
          .addBody(AviationRiskManagementCreateBulkParams.Body.builder()
              .classificationMarking("U")
              .dataMode(AviationRiskManagementCreateBulkParams.Body.DataMode.TEST)
              .idMission("fa18d96e-91ea-60da-a7a8-1af6500066c8")
      ...
      assertThat(body).containsExactly(AviationRiskManagementCreateBulkParams.Body.builder()
          .classificationMarking("U")
          .dataMode(AviationRiskManagementCreateBulkParams.Body.DataMode.TEST)
          .idMission("fa18d96e-91ea-60da-a7a8-1af6500066c8")
          .source("Bluestaq")
