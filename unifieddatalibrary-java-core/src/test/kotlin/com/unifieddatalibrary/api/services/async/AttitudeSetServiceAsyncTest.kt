...
internal class AttitudeSetServiceAsyncTest {
    ...
    fun queryHelp() {
        ...
        val responseFuture = attitudeSetServiceAsync.queryHelp()
    ...
    fun tuple() {
        ...
        val attitudesetFullsFuture =
            attitudeSetServiceAsync.tuple(
        ...
        val attitudesetFulls = attitudesetFullsFuture.get()
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            attitudeSetServiceAsync.unvalidatedPublish(
                AttitudeSetUnvalidatedPublishParams.builder()
                    ...
                    .addAttitudeList(
                        AttitudeSetUnvalidatedPublishParams.AttitudeList.builder()
                            .classificationMarking("U")
                            .dataMode(
                                AttitudeSetUnvalidatedPublishParams.AttitudeList.DataMode.TEST
                            )
                            .source("Bluestaq")
                            .ts(OffsetDateTime.parse("2022-03-07T14:51:39.653043Z"))
                            .id("ATTITUDEDATA-ID")
