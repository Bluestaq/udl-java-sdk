...
internal class ItemServiceTest {
    ...
    fun count() {
        ...
        itemService.count(ItemCountParams.builder().firstResult(0L).maxResults(0L).build())
    }
    ...
    fun get() {
        ...
        val item =
            itemService.get(ItemGetParams.builder().id("id").firstResult(0L).maxResults(0L).build())
    ...
    fun queryhelp() {
        ...
        val response = itemService.queryhelp()
