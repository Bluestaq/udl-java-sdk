...
internal class CrewServiceTest {
    ...
    fun count() {
        ...
        crewService.count(CrewCountParams.builder().firstResult(0L).maxResults(0L).build())
    }
    ...
    fun queryhelp() {
        ...
        val response = crewService.queryhelp()
