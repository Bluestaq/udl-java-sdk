...
internal class GnssObservationsetServiceAsyncTest {
    ...
    fun list() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val gnssObservationsetServiceAsync = client.gnssObservationset()

        val pageFuture =
            gnssObservationsetServiceAsync.list(
    ...
    fun count() {
        ...
        val responseFuture =
            gnssObservationsetServiceAsync.count(
    ...
    fun createBulk() {
        ...
        val future =
            gnssObservationsetServiceAsync.createBulk(
                    ...
                    .addBody(
                        GnssObservationsetCreateBulkParams.Body.builder()
                            ...
                            .addGnssObservationList(
                                GnssObservationsetCreateBulkParams.Body.GnssObservationList
                                    .builder()
                                    .agcState(20)
                                    .gnssSatId("GEJ")
    ...
    fun queryhelp() {
        ...
        val responseFuture = gnssObservationsetServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val gnssObservationSetFullsFuture =
            gnssObservationsetServiceAsync.tuple(
        ...
        val gnssObservationSetFulls = gnssObservationSetFullsFuture.get()
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            gnssObservationsetServiceAsync.unvalidatedPublish(
