...
internal class DatalinkServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val datalinkServiceAsync = client.linkStatus().datalink()
    ...
    fun queryhelp() {
        ...
        val responseFuture = datalinkServiceAsync.queryhelp()
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            datalinkServiceAsync.unvalidatedPublish(
