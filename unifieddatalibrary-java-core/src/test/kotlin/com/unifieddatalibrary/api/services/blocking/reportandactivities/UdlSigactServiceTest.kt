...
internal class UdlSigactServiceTest {
    ...
    fun fileGet(wmRuntimeInfo: WireMockRuntimeInfo) {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val udlSigactService = client.reportAndActivities().udlSigact()
        stubFor(get(anyUrl()).willReturn(ok().withBody("abc")))

        val response =
            udlSigactService.fileGet(
    ...
    fun unvalidatedPublish() {
        ...
        udlSigactService.unvalidatedPublish(
