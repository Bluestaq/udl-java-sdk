...
package com.unifieddatalibrary.api.services.blocking.personnelrecovery

import com.unifieddatalibrary.api.TestServerExtension
import com.unifieddatalibrary.api.client.okhttp.UnifieddatalibraryOkHttpClient
import com.unifieddatalibrary.api.models.personnelrecovery.history.HistoryCountParams
    ...
    fun list() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val historyService = client.personnelrecovery().history()
