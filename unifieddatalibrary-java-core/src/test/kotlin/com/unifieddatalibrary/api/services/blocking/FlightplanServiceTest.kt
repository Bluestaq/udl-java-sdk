...
internal class FlightplanServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val flightplanService = client.flightplan()
            ...
            FlightplanCreateParams.builder()
                ...
                .addFlightPlanPointGroup(
                    FlightplanCreateParams.FlightPlanPointGroup.builder()
                        ...
                        .etopsTime("01:23")
                        .addFlightPlanPoint(
                            FlightplanCreateParams.FlightPlanPointGroup.FlightPlanPoint.builder()
            ...
            FlightplanUpdateParams.builder()
                ...
                .addFlightPlanPointGroup(
                    FlightplanUpdateParams.FlightPlanPointGroup.builder()
                        ...
                        .etopsTime("01:23")
                        .addFlightPlanPoint(
                            FlightplanUpdateParams.FlightPlanPointGroup.FlightPlanPoint.builder()
                                .fppEta(OffsetDateTime.parse("2023-09-09T01:00:00.123Z"))
                                .fppLat(45.23)
                                .fppLon(179.1)
                                .fppReqFuel(4250.1)
    ...
    fun list() {
        ...
        val page = flightplanService.list()
    ...
    fun queryhelp() {
        ...
        val response = flightplanService.queryhelp()
    ...
    fun unvalidatedPublish() {
        ...
        flightplanService.unvalidatedPublish(
