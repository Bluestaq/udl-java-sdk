...
internal class OrbitdeterminationServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val orbitdeterminationService = client.orbitdetermination()

        orbitdeterminationService.create(
            OrbitdeterminationCreateParams.builder()
                ...
                .aprioriStateVector(
                    OrbitdeterminationCreateParams.AprioriStateVector.builder()
                        .classificationMarking("U")
                        .dataMode(OrbitdeterminationCreateParams.AprioriStateVector.DataMode.TEST)
                        .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                        .source("Bluestaq")
                        .actualOdSpan(3.5)
                        ...
                        .recOdSpan(3.5)
                        .referenceFrame(
                            OrbitdeterminationCreateParams.AprioriStateVector.ReferenceFrame.J2000
                        )
                        .residualsAcc(99.5)
                        .revNo(7205)
                        .rms(0.991)
                        ...
                        .addSourcedDataType(
                            OrbitdeterminationCreateParams.AprioriStateVector.SourcedDataType.RADAR
                        )
                        .sourceDl("AXE")
                        .srpArea(4.311)
                        .stepMode("AUTO")
    ...
    fun list() {
        ...
        val page = orbitdeterminationService.list()
    ...
    fun count() {
        ...
        orbitdeterminationService.count(
    ...
    fun createBulk() {
        ...
        orbitdeterminationService.createBulk(
            listOf(
                OrbitdeterminationCreateBulkParams.Body.builder()
                    ...
                    .aprioriElset(
                        OrbitdeterminationCreateBulkParams.Body.AprioriElset.builder()
                            .classificationMarking("U")
                            .dataMode(
                                OrbitdeterminationCreateBulkParams.Body.AprioriElset.DataMode.TEST
                            )
                            .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .source("Bluestaq")
                            .agom(0.0126)
                            ...
                            .addSourcedData("OBSERVATION_UUID2")
                            .addSourcedDataType(
                                OrbitdeterminationCreateBulkParams.Body.AprioriElset.SourcedDataType
                                    .RADAR
                            )
                            .addSourcedDataType(
                                OrbitdeterminationCreateBulkParams.Body.AprioriElset.SourcedDataType
                    ...
                    .aprioriStateVector(
                        OrbitdeterminationCreateBulkParams.Body.AprioriStateVector.builder()
                            .classificationMarking("U")
                            .dataMode(
                                OrbitdeterminationCreateBulkParams.Body.AprioriStateVector.DataMode
                                    .TEST
                            )
                            .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .source("Bluestaq")
    ...
    fun get() {
        ...
        val orbitdetermination =
            orbitdeterminationService.get(
    ...
    fun queryhelp() {
        ...
        val response = orbitdeterminationService.queryhelp()
    ...
    fun tuple() {
        ...
        val response =
            orbitdeterminationService.tuple(
    ...
    fun unvalidatedPublish() {
        ...
        orbitdeterminationService.unvalidatedPublish(
            listOf(
                OrbitdeterminationUnvalidatedPublishParams.Body.builder()
                    ...
                    .agomModel("RandomWalk")
                    .aprioriElset(
                        OrbitdeterminationUnvalidatedPublishParams.Body.AprioriElset.builder()
                            .classificationMarking("U")
                            .dataMode(
                    ...
                    .aprioriIdStateVector("6e291992-8ae3-4592-bb0f-055715bf4803")
                    .aprioriStateVector(
                        OrbitdeterminationUnvalidatedPublishParams.Body.AprioriStateVector.builder()
                            .classificationMarking("U")
                            .dataMode(
