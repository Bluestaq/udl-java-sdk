...
internal class AircraftSortyServiceAsyncTest {
    ...
    fun list() {
        ...
        val pageFuture =
            aircraftSortyServiceAsync.list(
                AircraftSortyListParams.builder()
    ...
    fun count() {
        ...
        val responseFuture =
            aircraftSortyServiceAsync.count(
                AircraftSortyCountParams.builder()
                    .plannedDepTime(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .firstResult(0L)
                    .maxResults(0L)
                    .build()
    ...
    fun createBulk() {
        ...
        val future =
            aircraftSortyServiceAsync.createBulk(
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            aircraftSortyServiceAsync.unvalidatedPublish(
