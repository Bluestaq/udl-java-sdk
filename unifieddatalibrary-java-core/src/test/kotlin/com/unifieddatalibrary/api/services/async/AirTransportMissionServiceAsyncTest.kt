...
internal class AirTransportMissionServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val airTransportMissionServiceAsync = client.airTransportMissions()

        val future =
            airTransportMissionServiceAsync.create(
    ...
    fun retrieve() {
        ...
        val airTransportMissionFullFuture =
            airTransportMissionServiceAsync.retrieve(
        ...
        val airTransportMissionFull = airTransportMissionFullFuture.get()
    ...
    fun update() {
        ...
        val future =
            airTransportMissionServiceAsync.update(
    ...
    fun list() {
        ...
        val pageFuture =
            airTransportMissionServiceAsync.list(
    ...
    fun count() {
        ...
        val responseFuture =
            airTransportMissionServiceAsync.count(
    ...
    fun queryhelp() {
        ...
        val responseFuture = airTransportMissionServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val airTransportMissionFullsFuture =
            airTransportMissionServiceAsync.tuple(
        ...
        val airTransportMissionFulls = airTransportMissionFullsFuture.get()
