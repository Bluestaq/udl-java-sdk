...
internal class OnorbiteventServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val onorbiteventServiceAsync = client.onorbitevent()
    ...
    fun update() {
        ...
        val future =
            onorbiteventServiceAsync.update(
    ...
    fun list() {
        ...
        val pageFuture = onorbiteventServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = onorbiteventServiceAsync.delete("id")
    ...
    fun count() {
        ...
        val responseFuture =
            onorbiteventServiceAsync.count(
    ...
    fun get() {
        ...
        val onorbiteventFuture =
            onorbiteventServiceAsync.get(
                OnorbiteventGetParams.builder().id("id").firstResult(0L).maxResults(0L).build()
            )

        val onorbitevent = onorbiteventFuture.get()
    ...
    fun queryhelp() {
        ...
        val responseFuture = onorbiteventServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val responseFuture =
            onorbiteventServiceAsync.tuple(
