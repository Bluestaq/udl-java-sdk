...
internal class ManeuverServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val maneuverService = client.maneuvers()
    ...
    fun queryhelp() {
        ...
        val response = maneuverService.queryhelp()
    ...
    fun unvalidatedPublish() {
        ...
        maneuverService.unvalidatedPublish(
