...
internal class SortiePprServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val sortiePprService = client.sortiePpr()
    ...
    fun list() {
        ...
        val page = sortiePprService.list(SortiePprListParams.builder().idSortie("idSortie").build())
    ...
    fun queryhelp() {
        ...
        val response = sortiePprService.queryhelp()
    ...
    fun unvalidatedPublish() {
        ...
        sortiePprService.unvalidatedPublish(
