...
internal class EphemerisSetServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val ephemerisSetServiceAsync = client.ephemerisSets()
    ...
    fun retrieve() {
        ...
        val ephemerisSetFuture =
            ephemerisSetServiceAsync.retrieve(
                EphemerisSetRetrieveParams.builder().id("id").firstResult(0L).maxResults(0L).build()
            )

        val ephemerisSet = ephemerisSetFuture.get()
    ...
    fun list() {
        ...
        val pageFuture = ephemerisSetServiceAsync.list()
    ...
    fun count() {
        ...
        val responseFuture =
            ephemerisSetServiceAsync.count(
    ...
    fun fileRetrieve(wmRuntimeInfo: WireMockRuntimeInfo) {
        ...
        val responseFuture =
            ephemerisSetServiceAsync.fileRetrieve(
    ...
    fun queryhelp() {
        ...
        val responseFuture = ephemerisSetServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val ephemerisSetsFuture =
            ephemerisSetServiceAsync.tuple(
        ...
        val ephemerisSets = ephemerisSetsFuture.get()
