...
internal class SgiServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val sgiServiceAsync = client.sgi()
    ...
    fun list() {
        ...
        val pageFuture = sgiServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = sgiServiceAsync.delete("id")
    ...
    fun get() {
        ...
        val sgiFuture =
            sgiServiceAsync.get(
                SgiGetParams.builder().id("id").firstResult(0L).maxResults(0L).build()
            )

        val sgi = sgiFuture.get()
        sgi.validate()
    }
    ...
    fun getDataByEffectiveAsOfDate() {
        ...
        val responseFuture =
            sgiServiceAsync.getDataByEffectiveAsOfDate(
    ...
    fun queryhelp() {
        ...
        val responseFuture = sgiServiceAsync.queryhelp()
