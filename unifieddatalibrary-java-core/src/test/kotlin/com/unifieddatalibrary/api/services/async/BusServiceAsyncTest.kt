...
internal class BusServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val busServiceAsync = client.buses()
    ...
    fun list() {
        ...
        val pageFuture = busServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = busServiceAsync.delete("id")
    ...
    fun count() {
        ...
        val responseFuture =
            busServiceAsync.count(BusCountParams.builder().firstResult(0L).maxResults(0L).build())
    ...
    fun queryHelp() {
        ...
        val responseFuture = busServiceAsync.queryHelp()
    ...
    fun tuple() {
        ...
        val busFulls = busFullsFuture.get()
