...
internal class LaseremitterServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val laseremitterService = client.laseremitter()
    ...
    fun list() {
        ...
        val page = laseremitterService.list()
    ...
    fun queryhelp() {
        ...
        val response = laseremitterService.queryhelp()
