...
internal class NavigationServiceAsyncTest {
    ...
    fun list() {
        ...
        val pageFuture = navigationServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = navigationServiceAsync.delete("id")
    ...
    fun queryhelp() {
        ...
        val responseFuture = navigationServiceAsync.queryhelp()
