...
internal class OperationServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val operationServiceAsync = client.site().operations()
    ...
    fun list() {
        ...
        val pageFuture =
            operationServiceAsync.list(OperationListParams.builder().idSite("idSite").build())
    ...
    fun delete() {
        ...
        val future = operationServiceAsync.delete("id")
    ...
    fun count() {
        ...
        val responseFuture =
            operationServiceAsync.count(
                OperationCountParams.builder()
                    .idSite("idSite")
                    .firstResult(0L)
                    .maxResults(0L)
                    .build()
    ...
    fun createBulk() {
        ...
        val future =
            operationServiceAsync.createBulk(
                        ...
                        OperationCreateBulkParams.Body.builder()
                            ...
                            .addDailyOperation(
                                OperationCreateBulkParams.Body.DailyOperation.builder()
                                    .dayOfWeek(
                                        OperationCreateBulkParams.Body.DailyOperation.DayOfWeek
                                            .MONDAY
                                    )
                                    .addOperatingHour(
    ...
    fun queryHelp() {
        ...
        val responseFuture = operationServiceAsync.queryHelp()
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            operationServiceAsync.unvalidatedPublish(
                OperationUnvalidatedPublishParams.builder()
                    .addBody(
                        OperationUnvalidatedPublishParams.Body.builder()
                            ...
                            .mogsLastChangedReason("Example reason for change.")
                            .addOperationalDeviation(
                                OperationUnvalidatedPublishParams.Body.OperationalDeviation
                                    .builder()
                                    .affectedAircraftMds("C017A")
                                    .affectedMog(1)
                                    .aircraftOnGroundTime("14:00")
