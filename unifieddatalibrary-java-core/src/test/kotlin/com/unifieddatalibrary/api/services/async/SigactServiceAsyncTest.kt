...
internal class SigactServiceAsyncTest {
    ...
    fun list() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val sigactServiceAsync = client.sigact()
                        ...
                        SigactCreateBulkParams.Body.builder()
                            ...
                            .addRelatedDoc(
                                SigactCreateBulkParams.Body.RelatedDoc.builder()
                                    .addDataSourceRef(
                                        SigactCreateBulkParams.Body.RelatedDoc.DataSourceRef
                                            .builder()
    ...
    fun queryhelp() {
        ...
        val responseFuture = sigactServiceAsync.queryhelp()
