...
internal class WeatherReportServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val weatherReportService = client.weatherReport()
    ...
    fun queryhelp() {
        ...
        val response = weatherReportService.queryhelp()
    ...
    fun tuple() {
        ...
        val weatherReportFulls =
            weatherReportService.tuple(
    ...
    fun unvalidatedPublish() {
        ...
        weatherReportService.unvalidatedPublish(
