...
internal class OnboardnavigationServiceAsyncTest {
    ...
    fun list() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val onboardnavigationServiceAsync = client.onboardnavigation()

        val pageFuture =
            onboardnavigationServiceAsync.list(
    ...
    fun count() {
        ...
        val responseFuture =
            onboardnavigationServiceAsync.count(
    ...
    fun createBulk() {
        ...
        val future =
            onboardnavigationServiceAsync.createBulk(
                OnboardnavigationCreateBulkParams.builder()
                    .addBody(
                        OnboardnavigationCreateBulkParams.Body.builder()
                            ...
                            .referenceFrame(
                                OnboardnavigationCreateBulkParams.Body.ReferenceFrame.J2000
                            )
                            .satNo(101)
    ...
    fun queryhelp() {
        ...
        val responseFuture = onboardnavigationServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val onboardnavigationFullsFuture =
            onboardnavigationServiceAsync.tuple(
        ...
        val onboardnavigationFulls = onboardnavigationFullsFuture.get()
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            onboardnavigationServiceAsync.unvalidatedPublish(
