...
internal class TrackDetailServiceTest {
    ...
    fun list() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val trackDetailService = client.trackDetails()

        val page =
            trackDetailService.list(
                TrackDetailListParams.builder()
    ...
    fun count() {
        ...
        trackDetailService.count(
            TrackDetailCountParams.builder()
                .ts(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .firstResult(0L)
                .maxResults(0L)
                .build()
    ...
    fun createBulk() {
        ...
        trackDetailService.createBulk(
            TrackDetailCreateBulkParams.builder()
                .addBody(
                    TrackDetailCreateBulkParams.Body.builder()
    ...
    fun queryhelp() {
        ...
        val response = trackDetailService.queryhelp()
    ...
    fun tuple() {
        ...
        val trackDetailsFulls =
            trackDetailService.tuple(
                TrackDetailTupleParams.builder()
                    .columns("columns")
                    .ts(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .firstResult(0L)
                    .maxResults(0L)
        ...
        trackDetailsFulls.forEach { it.validate() }
    }
}
