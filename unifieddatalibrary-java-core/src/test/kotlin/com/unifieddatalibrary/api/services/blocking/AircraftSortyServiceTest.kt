...
internal class AircraftSortyServiceTest {
    ...
    fun retrieve() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val aircraftSortyService = client.aircraftSorties()

        val aircraftsortieFull =
            aircraftSortyService.retrieve(
    ...
    fun queryhelp() {
        ...
        val response = aircraftSortyService.queryhelp()
