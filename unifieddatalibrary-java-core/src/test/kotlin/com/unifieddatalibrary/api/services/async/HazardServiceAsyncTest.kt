...
internal class HazardServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val hazardServiceAsync = client.hazard()
    ...
    fun queryhelp() {
        ...
        val responseFuture = hazardServiceAsync.queryhelp()
