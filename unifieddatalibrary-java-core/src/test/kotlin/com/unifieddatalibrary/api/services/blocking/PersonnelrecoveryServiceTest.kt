                ...
                PersonnelrecoveryFileCreateParams.Body.builder()
                    ...
                    .executionInfo(
                        PersonnelrecoveryFileCreateParams.Body.ExecutionInfo.builder()
                            ...
                            .addEgressPoint(30.455)
                            .escortVehicle(
                                PersonnelrecoveryFileCreateParams.Body.ExecutionInfo.EscortVehicle
                                    .builder()
                                    .callSign("FALCO")
                                    .primaryFreq(34.55)
                                    .strength(5)
                            ...
                            .objStrategy("Description of strategy plan.")
                            .recoveryVehicle(
                                PersonnelrecoveryFileCreateParams.Body.ExecutionInfo.RecoveryVehicle
                                    .builder()
                                    .callSign("FALCO")
                                    .primaryFreq(34.55)
                                    .strength(5)
                    ...
                    .objectiveAreaInfo(
                        PersonnelrecoveryFileCreateParams.Body.ObjectiveAreaInfo.builder()
                            .addEnemyData(
                                PersonnelrecoveryFileCreateParams.Body.ObjectiveAreaInfo.EnemyData
                                    .builder()
                                    .dirToEnemy("NORTHWEST")
                                    .friendliesRemarks("Comments from friendlies.")
                                    .hlzRemarks("Hot Landing Zone remarks.")
