...
internal class EmireportServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val emireportService = client.emireport()
    ...
    fun queryhelp() {
        ...
        val response = emireportService.queryhelp()
    ...
    fun unvalidatedPublish() {
        ...
        emireportService.unvalidatedPublish(
