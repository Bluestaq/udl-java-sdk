...
internal class ObscorrelationServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val obscorrelationServiceAsync = client.observations().obscorrelation()
    ...
    fun retrieve() {
        ...
        val obscorrelationFuture =
            obscorrelationServiceAsync.retrieve(
        ...
        val obscorrelation = obscorrelationFuture.get()
    ...
    fun count() {
        ...
        val responseFuture =
            obscorrelationServiceAsync.count(
    ...
    fun createBulk() {
        ...
        val future =
            obscorrelationServiceAsync.createBulk(
    ...
    fun queryHelp() {
        ...
        val responseFuture = obscorrelationServiceAsync.queryHelp()
    ...
    fun tuple() {
        ...
        val responseFuture =
            obscorrelationServiceAsync.tuple(
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            obscorrelationServiceAsync.unvalidatedPublish(
                ObscorrelationUnvalidatedPublishParams.builder()
                    .addBody(
                        ObscorrelationUnvalidatedPublishParams.Body.builder()
                            .classificationMarking("U")
                            .corrType(
                                ObscorrelationUnvalidatedPublishParams.Body.CorrType.OBSERVATION
                            )
