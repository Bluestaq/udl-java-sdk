...
internal class RfObservationServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val rfObservationService = client.observations().rfObservation()
    ...
    fun createBulk() {
        ...
        rfObservationService.createBulk(
            listOf(
    ...
    fun queryhelp() {
        ...
        val response = rfObservationService.queryhelp()
