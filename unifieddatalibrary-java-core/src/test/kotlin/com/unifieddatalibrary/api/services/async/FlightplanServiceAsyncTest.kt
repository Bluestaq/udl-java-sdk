...
internal class FlightplanServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val flightplanServiceAsync = client.flightplan()

        val future =
            flightplanServiceAsync.create(
                FlightplanCreateParams.builder()
                    .arrAirfield("KCHS")
                    .classificationMarking("U")
                    .dataMode(FlightplanCreateParams.DataMode.TEST)
                    .depAirfield("KSLV")
                    ...
                    .addAirRefuelEvent(
                        FlightplanCreateParams.AirRefuelEvent.builder()
                            .arDegrade(3.1)
                    ...
                    .addFlightPlanMessage(
                        FlightplanCreateParams.FlightPlanMessage.builder()
                    ...
                    .addFlightPlanPointGroup(
                        FlightplanCreateParams.FlightPlanPointGroup.builder()
                            .avgFuelFlow(19693.1)
                            ...
                            .etopsTime("01:23")
                            .addFlightPlanPoint(
                                FlightplanCreateParams.FlightPlanPointGroup.FlightPlanPoint
                                    .builder()
                    ...
                    .addFlightPlanWaypoint(
                        FlightplanCreateParams.FlightPlanWaypoint.builder()
                            .type("COMMENT")
                            .waypointName("KCHS")
        ...
        val future =
            flightplanServiceAsync.update(
                FlightplanUpdateParams.builder()
                    ...
                    .aircraftMds("KC-130 HERCULES")
                    .addAirRefuelEvent(
                        FlightplanUpdateParams.AirRefuelEvent.builder()
                            .arDegrade(3.1)
                            .arExchangedFuel(1500.1)
                            .arNum(2)
                            .divertFuel(143000.1)
                    ...
                    .externalId("AFMAPP20322347140001")
                    .addFlightPlanMessage(
                        FlightplanUpdateParams.FlightPlanMessage.builder()
                            .msgText("Message text")
                            .routePath("PRIMARY")
                            .severity("SEVERE")
                            .wpNum("20")
                    ...
                    .addFlightPlanPointGroup(
                        FlightplanUpdateParams.FlightPlanPointGroup.builder()
                            .avgFuelFlow(19693.1)
                            .etopsAvgWindFactor(10.1)
                            .etopsDistance(684.1)
                            .etopsReqFuel(4412.1)
                            ...
                            .etopsTime("01:23")
                            .addFlightPlanPoint(
                                FlightplanUpdateParams.FlightPlanPointGroup.FlightPlanPoint
                                    .builder()
                                    .fppEta(OffsetDateTime.parse("2023-09-09T01:00:00.123Z"))
                                    .fppLat(45.23)
                                    .fppLon(179.1)
                    ...
                    .addFlightPlanWaypoint(
                        FlightplanUpdateParams.FlightPlanWaypoint.builder()
                            .type("COMMENT")
                            .waypointName("KCHS")
                            .aaTacanChannel("31/94")
                            .airDistance(321.1)
    ...
    fun list() {
        ...
        val pageFuture = flightplanServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = flightplanServiceAsync.delete("id")
    ...
    fun queryhelp() {
        ...
        val responseFuture = flightplanServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val flightPlanFulls = flightPlanFullsFuture.get()
        flightPlanFulls.forEach { it.validate() }
    }
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            flightplanServiceAsync.unvalidatedPublish(
                                ...
                                FlightplanUnvalidatedPublishParams.Body.FlightPlanPointGroup
                                    ...
                                    .addFlightPlanPoint(
                                        FlightplanUnvalidatedPublishParams.Body.FlightPlanPointGroup
                                            ...
                                            .builder()
                                            .fppEta(
                                                OffsetDateTime.parse("2023-09-09T01:00:00.123Z")
                                            )
                                            .fppLat(45.23)
                                            .fppLon(179.1)
                                            .fppReqFuel(4250.1)
