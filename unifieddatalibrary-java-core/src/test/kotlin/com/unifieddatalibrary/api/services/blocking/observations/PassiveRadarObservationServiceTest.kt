...
internal class PassiveRadarObservationServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val passiveRadarObservationService = client.observations().passiveRadarObservation()

        passiveRadarObservationService.create(
    ...
    fun list() {
        ...
        val page =
            passiveRadarObservationService.list(
    ...
    fun count() {
        ...
        passiveRadarObservationService.count(
    ...
    fun createBulk() {
        ...
        passiveRadarObservationService.createBulk(
    ...
    fun fileCreate() {
        ...
        passiveRadarObservationService.fileCreate(
    ...
    fun get() {
        ...
        val passiveRadarObservation =
            passiveRadarObservationService.get(
    ...
    fun queryhelp() {
        ...
        val response = passiveRadarObservationService.queryhelp()
    ...
    fun tuple() {
        ...
        val response =
            passiveRadarObservationService.tuple(
