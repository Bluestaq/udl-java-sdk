...
internal class FeatureAssessmentServiceTest {
    ...
    fun create() {
        ...
        featureAssessmentService.create(
    ...
    fun retrieve() {
        ...
        val featureAssessment =
            featureAssessmentService.retrieve(
    ...
    fun count() {
        ...
        featureAssessmentService.count(
    ...
    fun createBulk() {
        ...
        featureAssessmentService.createBulk(
    ...
    fun queryHelp() {
        ...
        val response = featureAssessmentService.queryHelp()
    ...
    fun tuple() {
        ...
        val response =
            featureAssessmentService.tuple(
    ...
    fun unvalidatedPublish() {
        ...
        featureAssessmentService.unvalidatedPublish(
