...
internal class SensorServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val sensorServiceAsync = client.sensor()
                        ...
                        SensorCreateParams.Entity.builder()
                            ...
                            .onOrbit(
                                SensorCreateParams.Entity.OnOrbit.builder()
                                    ...
                                    .objectType(
                                        SensorCreateParams.Entity.OnOrbit.ObjectType.PAYLOAD
                                    )
                                    .origin("THIRD_PARTY_DATASOURCE")
                                    .origNetwork("OPS1")
                                    .build()
                        ...
                        SensorUpdateParams.Entity.builder()
                            ...
                            .onOrbit(
                                SensorUpdateParams.Entity.OnOrbit.builder()
                                    ...
                                    .missionNumber("Expedition 1")
                                    .objectType(
                                        SensorUpdateParams.Entity.OnOrbit.ObjectType.PAYLOAD
                                    )
                                    .origin("THIRD_PARTY_DATASOURCE")
                                    .origNetwork("OPS1")
                                    .build()
    ...
    fun list() {
        ...
        val pageFuture = sensorServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = sensorServiceAsync.delete("id")
    ...
    fun queryhelp() {
        ...
        val responseFuture = sensorServiceAsync.queryhelp()
