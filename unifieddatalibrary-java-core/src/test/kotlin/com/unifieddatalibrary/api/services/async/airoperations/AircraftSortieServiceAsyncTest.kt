...
internal class AircraftSortieServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val aircraftSortieServiceAsync = client.airOperations().aircraftSortie()
    ...
    fun count() {
        ...
        val responseFuture =
            aircraftSortieServiceAsync.count(
    ...
    fun createBulk() {
        ...
        val future =
            aircraftSortieServiceAsync.createBulk(
    ...
    fun historyAodr() {
        ...
        val future =
            aircraftSortieServiceAsync.historyAodr(
    ...
    fun historyCount() {
        ...
        val responseFuture =
            aircraftSortieServiceAsync.historyCount(
    ...
    fun historyQuery() {
        ...
        val aircraftsortieFullsFuture =
            aircraftSortieServiceAsync.historyQuery(
