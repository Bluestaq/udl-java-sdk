...
internal class VesselServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val vesselServiceAsync = client.vessel()
    ...
    fun list() {
        ...
        val pageFuture = vesselServiceAsync.list()
    ...
    fun count() {
        ...
        val responseFuture =
            vesselServiceAsync.count(
                VesselCountParams.builder().firstResult(0L).maxResults(0L).build()
            )
    ...
    fun queryhelp() {
        ...
        val responseFuture = vesselServiceAsync.queryhelp()
