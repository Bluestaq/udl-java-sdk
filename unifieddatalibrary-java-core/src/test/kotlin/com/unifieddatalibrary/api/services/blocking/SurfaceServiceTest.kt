...
internal class SurfaceServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val surfaceService = client.surface()
    ...
    fun count() {
        ...
        surfaceService.count(SurfaceCountParams.builder().firstResult(0L).maxResults(0L).build())
    }
    ...
    fun queryhelp() {
        ...
        val response = surfaceService.queryhelp()
