...
internal class DetailServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val detailService = client.rfEmitter().details()
    ...
    fun count() {
        ...
        detailService.count(DetailCountParams.builder().firstResult(0L).maxResults(0L).build())
    }
    ...
    fun queryhelp() {
        ...
        val response = detailService.queryhelp()
