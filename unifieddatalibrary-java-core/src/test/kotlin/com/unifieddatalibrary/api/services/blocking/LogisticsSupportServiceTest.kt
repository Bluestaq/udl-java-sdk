...
internal class LogisticsSupportServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val logisticsSupportService = client.logisticsSupport()

        logisticsSupportService.create(
    ...
    fun update() {
        ...
        logisticsSupportService.update(
    ...
    fun list() {
        ...
        val page = logisticsSupportService.list()
    ...
    fun createBulk() {
        ...
        logisticsSupportService.createBulk(
            listOf(
                LogisticsSupportCreateBulkParams.Body.builder()
                    ...
                    .addLogisticsTransportationPlan(
                        LogisticsSupportCreateBulkParams.Body.LogisticsTransportationPlan.builder()
                            .actDepTime(OffsetDateTime.parse("2023-07-14T19:37:00.123Z"))
                            .aircraftStatus("NMCMU")
                            .approxArrTime(OffsetDateTime.parse("2023-07-14T20:37:00.123Z"))
                            .cancelledDate(OffsetDateTime.parse("2023-07-14T20:37:00.123Z"))
    ...
    fun get() {
        ...
        val logisticsSupport =
            logisticsSupportService.get(
    ...
    fun queryhelp() {
        ...
        val response = logisticsSupportService.queryhelp()
    ...
    fun unvalidatedPublish() {
        ...
        logisticsSupportService.unvalidatedPublish(
            listOf(
                LogisticsSupportUnvalidatedPublishParams.Body.builder()
                    ...
                    .addLogisticsSupportItem(
                        LogisticsSupportUnvalidatedPublishParams.Body.LogisticsSupportItem.builder()
                            .cannibalized(true)
                            .deployPlanNumber("T89003")
                            .description("HOIST ADAPTER KIT")
                            .itemLastChangedDate(OffsetDateTime.parse("2023-07-17T19:04:00.123Z"))
                    ...
                    .addLogisticsTransportationPlan(
                        LogisticsSupportUnvalidatedPublishParams.Body.LogisticsTransportationPlan
                            .builder()
                            .actDepTime(OffsetDateTime.parse("2023-07-14T19:37:00.123Z"))
                            .aircraftStatus("NMCMU")
                            .approxArrTime(OffsetDateTime.parse("2023-07-14T20:37:00.123Z"))
