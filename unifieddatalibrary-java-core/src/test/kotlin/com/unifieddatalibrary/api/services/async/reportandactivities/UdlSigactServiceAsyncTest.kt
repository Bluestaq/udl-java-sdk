...
internal class UdlSigactServiceAsyncTest {
    ...
    fun fileGet(wmRuntimeInfo: WireMockRuntimeInfo) {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val udlSigactServiceAsync = client.reportAndActivities().udlSigact()
        stubFor(get(anyUrl()).willReturn(ok().withBody("abc")))

        val responseFuture =
            udlSigactServiceAsync.fileGet(
                        ...
                        UdlSigactUnvalidatedPublishParams.Body.builder()
                            ...
                            .addRelatedDoc(
                                UdlSigactUnvalidatedPublishParams.Body.RelatedDoc.builder()
                                    .addDataSourceRef(
                                        UdlSigactUnvalidatedPublishParams.Body.RelatedDoc
                                            .DataSourceRef
                                            .builder()
