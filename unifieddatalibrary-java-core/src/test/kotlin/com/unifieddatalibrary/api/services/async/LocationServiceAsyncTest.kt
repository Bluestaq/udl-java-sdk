...
internal class LocationServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val locationServiceAsync = client.location()
    ...
    fun list() {
        ...
        val pageFuture = locationServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = locationServiceAsync.delete("id")
    ...
    fun count() {
        ...
        val responseFuture =
            locationServiceAsync.count(
                LocationCountParams.builder().firstResult(0L).maxResults(0L).build()
            )
    ...
    fun queryhelp() {
        ...
        val responseFuture = locationServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val locationFulls = locationFullsFuture.get()
