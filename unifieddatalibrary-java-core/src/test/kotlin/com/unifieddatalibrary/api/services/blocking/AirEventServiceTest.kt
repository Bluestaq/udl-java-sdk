...
internal class AirEventServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val airEventService = client.airEvents()

        airEventService.create(
    ...
    fun count() {
        ...
        airEventService.count(AirEventCountParams.builder().firstResult(0L).maxResults(0L).build())
    }
    ...
    fun queryhelp() {
        ...
        val response = airEventService.queryhelp()
    ...
    fun unvalidatedPublish() {
        ...
        airEventService.unvalidatedPublish(
