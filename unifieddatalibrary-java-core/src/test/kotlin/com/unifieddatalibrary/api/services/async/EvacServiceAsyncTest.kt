...
internal class EvacServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val evacServiceAsync = client.evac()

        val future =
            evacServiceAsync.create(
                        ...
                        EvacCreateBulkParams.Body.builder()
                            ...
                            .addCasualtyInfo(
                                EvacCreateBulkParams.Body.CasualtyInfo.builder()
                                    ...
                                    .addVitalSignData(
                                        EvacCreateBulkParams.Body.CasualtyInfo.VitalSignData
                                            .builder()
                                            .medConfFactor(1)
                                            .time(OffsetDateTime.parse("2021-10-15T16:00:00.123Z"))
                                            .vitalSign("HEART RATE")
    ...
    fun queryHelp() {
        ...
        val responseFuture = evacServiceAsync.queryHelp()
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            evacServiceAsync.unvalidatedPublish(
                        ...
                        EvacUnvalidatedPublishParams.Body.builder()
                            ...
                            .addCasualtyInfo(
                                EvacUnvalidatedPublishParams.Body.CasualtyInfo.builder()
                                    .age(35)
                                    .addAllergy(
                                        EvacUnvalidatedPublishParams.Body.CasualtyInfo.Allergy
                                            .builder()
                                            .comments("Comments on the patient's allergies.")
                                            .type("PENICILLIN")
                                            .build()
                                    ...
                                    .addInjury(
                                        EvacUnvalidatedPublishParams.Body.CasualtyInfo.Injury
                                            .builder()
                                            .bodyPart("ARM LEFT FRONT")
                                            .comments("Comments on the patient's injury.")
                                            .time(OffsetDateTime.parse("2021-10-15T16:00:00.123Z"))
