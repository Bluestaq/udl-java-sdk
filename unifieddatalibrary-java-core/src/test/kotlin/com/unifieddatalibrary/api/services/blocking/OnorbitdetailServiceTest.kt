...
internal class OnorbitdetailServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val onorbitdetailService = client.onorbitdetails()

        onorbitdetailService.create(
    ...
    fun list() {
        ...
        val page = onorbitdetailService.list()
    ...
    fun delete() {
        ...
        onorbitdetailService.delete("id")
    }
    ...
    fun get() {
        ...
        val onorbitDetailsFull =
            onorbitdetailService.get(
