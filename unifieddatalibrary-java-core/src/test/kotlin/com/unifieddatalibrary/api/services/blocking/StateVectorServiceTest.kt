...
internal class StateVectorServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val stateVectorService = client.stateVector()

        stateVectorService.create(
            StateVectorCreateParams.builder()
                .stateVectorIngest(
    ...
    fun queryhelp() {
        ...
        val response = stateVectorService.queryhelp()
