...
internal class IsrCollectionServiceAsyncTest {
    ...
    fun list() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val isrCollectionServiceAsync = client.isrCollections()
    ...
    fun count() {
        ...
        val responseFuture =
            isrCollectionServiceAsync.count(
    ...
    fun createBulk() {
        ...
        val future =
            isrCollectionServiceAsync.createBulk(
                        ...
                        IsrCollectionCreateBulkParams.Body.builder()
                                ...
                                IsrCollectionCreateBulkParams.Body.CollectionRequirement.builder()
                                    ...
                                    .exploitationRequirement(
                                        IsrCollectionCreateBulkParams.Body.CollectionRequirement
                                            ...
                                            .poc(
                                                IsrCollectionCreateBulkParams.Body
                            ...
                            .addTasking(
                                IsrCollectionCreateBulkParams.Body.Tasking.builder()
                                    ...
                                    .type(
                                        IsrCollectionCreateBulkParams.Body.Tasking.Type.DELIBERATE
                                    )
                                    .build()
                            )
                            .addTransit(
    ...
    fun queryhelp() {
        ...
        val responseFuture = isrCollectionServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val responseFuture =
            isrCollectionServiceAsync.tuple(
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            isrCollectionServiceAsync.unvalidatedPublish(
