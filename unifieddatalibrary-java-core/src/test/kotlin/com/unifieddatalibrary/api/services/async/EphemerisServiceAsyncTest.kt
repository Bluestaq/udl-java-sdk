...
internal class EphemerisServiceAsyncTest {
    ...
    fun list() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val ephemerisServiceAsync = client.ephemeris()

        val pageFuture =
            ephemerisServiceAsync.list(EphemerisListParams.builder().esId("esId").build())
    ...
    fun queryhelp() {
        ...
        val responseFuture = ephemerisServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val ephemerisFulls = ephemerisFullsFuture.get()
