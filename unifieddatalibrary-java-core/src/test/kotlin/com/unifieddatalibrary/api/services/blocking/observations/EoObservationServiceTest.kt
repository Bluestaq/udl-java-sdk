...
internal class EoObservationServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val eoObservationService = client.observations().eoObservations()
    ...
    fun createBulk() {
        ...
        eoObservationService.createBulk(
    ...
    fun queryhelp() {
        ...
        val response = eoObservationService.queryhelp()
    ...
    fun tuple() {
        ...
        val eoObservationFulls =
            eoObservationService.tuple(
        ...
        eoObservationService.unvalidatedPublish(
            listOf(
                EoObservationUnvalidatedPublishParams.Body.builder()
                    ...
                    .elevationUnc(1.1)
                    .eoobservationDetails(
                        EoObservationUnvalidatedPublishParams.Body.EoobservationDetails.builder()
                            .acalCrPixX(123.2)
                            .acalCrPixY(123.2)
                            .acalCrValX(123.2)
                            .acalCrValY(123.2)
                    ...
                    .raUnc(0.000015)
                    .rawFileUri("Example URI")
                    .referenceFrame(EoObservationUnvalidatedPublishParams.Body.ReferenceFrame.J2000)
                    .satNo(5)
                    .senalt(0.7539)
                    .senlat(45.1)
                    .senlon(179.1)
