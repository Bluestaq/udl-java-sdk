...
internal class CollectRequestServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val collectRequestService = client.collectRequests()
    ...
    fun retrieve() {
        ...
        val collectRequestFull =
            collectRequestService.retrieve(
    ...
    fun createBulk() {
        ...
        collectRequestService.createBulk(
            listOf(
    ...
    fun queryHelp() {
        ...
        val response = collectRequestService.queryHelp()
    ...
    fun tuple() {
        ...
        val collectRequestFulls =
            collectRequestService.tuple(
    ...
    fun unvalidatedPublish() {
        ...
        collectRequestService.unvalidatedPublish(
            listOf(
                CollectRequestUnvalidatedPublishParams.Body.builder()
                    ...
                    .elset(
                        CollectRequestUnvalidatedPublishParams.Body.Elset.builder()
                            ...
                            .addSourcedData("OBSERVATION_UUID2")
                            .addSourcedDataType(
                                CollectRequestUnvalidatedPublishParams.Body.Elset.SourcedDataType
                                    .RADAR
                            )
                            .addSourcedDataType(
                                CollectRequestUnvalidatedPublishParams.Body.Elset.SourcedDataType.RF
                            )
                            .sourceDl("AXE")
                            .addTag("PROVIDER_TAG1")
                            .addTag("PROVIDER_TAG2")
