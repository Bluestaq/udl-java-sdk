...
internal class SiteServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val siteServiceAsync = client.site()

        val future =
            siteServiceAsync.create(
    ...
    fun update() {
        ...
        val future =
            siteServiceAsync.update(
                SiteUpdateParams.builder()
                    .pathId("id")
                    .classificationMarking("U")
                    .dataMode(SiteUpdateParams.DataMode.TEST)
                    .name("Site Name")
                    .source("Bluestaq")
                    .bodyId("SITE-ID")
                    .activity("OCC")
    ...
    fun list() {
        ...
        val pageFuture = siteServiceAsync.list()
    ...
    fun count() {
        ...
        val responseFuture =
            siteServiceAsync.count(SiteCountParams.builder().firstResult(0L).maxResults(0L).build())
    ...
    fun get() {
        ...
        val siteFuture =
            siteServiceAsync.get(
                SiteGetParams.builder().id("id").firstResult(0L).maxResults(0L).build()
            )

        val site = siteFuture.get()
        site.validate()
    }
    ...
    fun queryhelp() {
        ...
        val responseFuture = siteServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val responseFuture =
            siteServiceAsync.tuple(
                SiteTupleParams.builder().columns("columns").firstResult(0L).maxResults(0L).build()
            )
