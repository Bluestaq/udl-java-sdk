...
internal class AirloadPlanServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val airloadPlanServiceAsync = client.airloadPlans()

        val future =
            airloadPlanServiceAsync.create(
    ...
    fun retrieve() {
        ...
        val airloadplanFullFuture =
            airloadPlanServiceAsync.retrieve(
                AirloadPlanRetrieveParams.builder().id("id").firstResult(0L).maxResults(0L).build()
            )

        val airloadplanFull = airloadplanFullFuture.get()
    ...
    fun delete() {
        ...
        val future = airloadPlanServiceAsync.delete("id")
    ...
    fun queryhelp() {
        ...
        val responseFuture = airloadPlanServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val airloadplanFullsFuture =
            airloadPlanServiceAsync.tuple(
        ...
        val airloadplanFulls = airloadplanFullsFuture.get()
