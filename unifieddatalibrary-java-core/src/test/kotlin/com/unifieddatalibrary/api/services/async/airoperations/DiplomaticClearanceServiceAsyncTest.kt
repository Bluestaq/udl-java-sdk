    ...
    fun unvalidatedPublish() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val diplomaticClearanceServiceAsync = client.airOperations().diplomaticClearance()

        val future =
            diplomaticClearanceServiceAsync.unvalidatedPublish(
                DiplomaticClearanceUnvalidatedPublishParams.builder()
                    .addBody(
                        DiplomaticClearanceUnvalidatedPublishParams.Body.builder()
                            .classificationMarking("U")
                            .dataMode(
                                DiplomaticClearanceUnvalidatedPublishParams.Body.DataMode.TEST
                            )
