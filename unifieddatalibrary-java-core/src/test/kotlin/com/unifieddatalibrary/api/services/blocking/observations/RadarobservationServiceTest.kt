...
internal class RadarobservationServiceTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClient.builder()
                ...
                .build()
        val radarobservationService = client.observations().radarobservation()

        radarobservationService.create(
    ...
    fun createBulk() {
        ...
        radarobservationService.createBulk(
    ...
    fun get() {
        ...
        val radarobservation =
            radarobservationService.get(
    ...
    fun queryhelp() {
        ...
        val response = radarobservationService.queryhelp()
