...
internal class MonoradarServiceAsyncTest {
    ...
    fun list() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val monoradarServiceAsync = client.observations().monoradar()
    ...
    fun createBulk() {
        ...
        val future =
            monoradarServiceAsync.createBulk(
    ...
    fun queryhelp() {
        ...
        val responseFuture = monoradarServiceAsync.queryhelp()
