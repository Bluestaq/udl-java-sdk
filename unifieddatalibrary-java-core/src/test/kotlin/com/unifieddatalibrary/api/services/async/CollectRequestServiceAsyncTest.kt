...
internal class CollectRequestServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val collectRequestServiceAsync = client.collectRequests()

        val future =
            collectRequestServiceAsync.create(
                CollectRequestCreateParams.builder()
                    ...
                    .elset(
                        CollectRequestCreateParams.Elset.builder()
                            ...
                            .addSourcedDataType(
                                CollectRequestCreateParams.Elset.SourcedDataType.RADAR
                            )
                    ...
                    .stateVector(
                        CollectRequestCreateParams.StateVector.builder()
                            ...
                            .recOdSpan(3.5)
                            .referenceFrame(
                                CollectRequestCreateParams.StateVector.ReferenceFrame.J2000
                            )
                            .residualsAcc(99.5)
                            .revNo(7205)
                            .rms(0.991)
    ...
    fun retrieve() {
        ...
        val collectRequestFullFuture =
            collectRequestServiceAsync.retrieve(
                CollectRequestRetrieveParams.builder()
                    .id("id")
                    .firstResult(0L)
                    .maxResults(0L)
                    .build()
        ...
        val collectRequestFull = collectRequestFullFuture.get()
        collectRequestFull.validate()
    }
    ...
    fun list() {
        ...
        val pageFuture =
            collectRequestServiceAsync.list(
                CollectRequestListParams.builder()
    ...
    fun count() {
        ...
        val responseFuture =
            collectRequestServiceAsync.count(
    ...
    fun createBulk() {
        ...
        val future =
            collectRequestServiceAsync.createBulk(
                        ...
                        CollectRequestCreateBulkParams.Body.builder()
                            ...
                            .elset(
                                CollectRequestCreateBulkParams.Body.Elset.builder()
                                    .classificationMarking("U")
                                    .dataMode(
                                        CollectRequestCreateBulkParams.Body.Elset.DataMode.TEST
                                    )
                                    .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                                    .source("Bluestaq")
                                    .agom(0.0126)
                                    ...
                                    .addSourcedData("OBSERVATION_UUID2")
                                    .addSourcedDataType(
                                        CollectRequestCreateBulkParams.Body.Elset.SourcedDataType
                                            .RADAR
                                    )
                                    .addSourcedDataType(
                            ...
                            .stateVector(
                                CollectRequestCreateBulkParams.Body.StateVector.builder()
                                    .classificationMarking("U")
                                    .dataMode(
                                        CollectRequestCreateBulkParams.Body.StateVector.DataMode
                                            .TEST
                                    )
                                    .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                                    .source("Bluestaq")
    ...
    fun queryHelp() {
        ...
        val responseFuture = collectRequestServiceAsync.queryHelp()
    ...
    fun tuple() {
        ...
        val collectRequestFullsFuture =
            collectRequestServiceAsync.tuple(
        ...
        val collectRequestFulls = collectRequestFullsFuture.get()
        collectRequestFulls.forEach { it.validate() }
    }
    ...
    fun unvalidatedPublish() {
        ...
        val future =
            collectRequestServiceAsync.unvalidatedPublish(
                CollectRequestUnvalidatedPublishParams.builder()
                    .addBody(
                        CollectRequestUnvalidatedPublishParams.Body.builder()
                            .classificationMarking("U")
                            .dataMode(CollectRequestUnvalidatedPublishParams.Body.DataMode.TEST)
                            .source("Bluestaq")
                            .startTime(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                            .type("DWELL")
                            .id("COLLECTREQUEST-ID")
                            ...
                            .el(1.1)
                            .elset(
                                CollectRequestUnvalidatedPublishParams.Body.Elset.builder()
                                    .classificationMarking("U")
                                    .dataMode(
                                        CollectRequestUnvalidatedPublishParams.Body.Elset.DataMode
                                            .TEST
                                    )
                                    .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
                                    .source("Bluestaq")
                                    ...
                                    .addSourcedData("OBSERVATION_UUID2")
                                    .addSourcedDataType(
                                        CollectRequestUnvalidatedPublishParams.Body.Elset
                                            .SourcedDataType
                                            .RADAR
                                    )
                                    .addSourcedDataType(
                            ...
                            .srchPattern("SCAN")
                            .stateVector(
                                CollectRequestUnvalidatedPublishParams.Body.StateVector.builder()
                                    .classificationMarking("U")
                                    .dataMode(
                                        CollectRequestUnvalidatedPublishParams.Body.StateVector
                                            .DataMode
                                            .TEST
                                    )
                                    .epoch(OffsetDateTime.parse("2018-01-01T16:00:00.123456Z"))
