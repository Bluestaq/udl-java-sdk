...
internal class AircraftServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val aircraftServiceAsync = client.aircraft()
    ...
    fun list() {
        ...
        val pageFuture = aircraftServiceAsync.list()
    ...
    fun queryhelp() {
        ...
        val responseFuture = aircraftServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val aircraftFulls = aircraftFullsFuture.get()
