        ...
        isrCollectionService.unvalidatedPublish(
            listOf(
                IsrCollectionUnvalidatedPublishParams.Body.builder()
                    ...
                    .id("ISRCOLLECTION-ID")
                    .addCollectionRequirement(
                        IsrCollectionUnvalidatedPublishParams.Body.CollectionRequirement.builder()
                            .id("ISCRCOLLECTIONREQUIREMENTS")
                            .country("VE")
                            .cridNumbers("CRID")
                            .criticalTimes(
                    ...
                    .addTasking(
                        IsrCollectionUnvalidatedPublishParams.Body.Tasking.builder()
                            .id("ISRCOLLECTIONTASKINGS-ID")
                            .collectionPeriods(
                                IsrCollectionUnvalidatedPublishParams.Body.Tasking.CollectionPeriods
                                    .builder()
                                    .addActual(
                            ...
                            .collectionType(
                                IsrCollectionUnvalidatedPublishParams.Body.Tasking.CollectionType
                                    .SIMULTANEOUS
                            )
                            .eightLine("eightLine")
                            .specialComGuidance("TEXT")
                            ...
                            .taskingSyncMatrixBin("MATRIX")
                            .type(
                                IsrCollectionUnvalidatedPublishParams.Body.Tasking.Type.DELIBERATE
                            )
                            .build()
                    )
                    .addTransit(
