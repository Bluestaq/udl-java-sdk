...
internal class SarObservationServiceAsyncTest {
    ...
    fun create() {
        val client =
            UnifieddatalibraryOkHttpClientAsync.builder()
                ...
                .build()
        val sarObservationServiceAsync = client.sarObservation()
    ...
    fun count() {
        ...
        val responseFuture =
            sarObservationServiceAsync.count(
    ...
    fun createBulk() {
        ...
        val future =
            sarObservationServiceAsync.createBulk(
    ...
    fun get() {
        ...
        val sarObservationFuture =
            sarObservationServiceAsync.get(
                SarObservationGetParams.builder().id("id").firstResult(0L).maxResults(0L).build()
            )

        val sarObservation = sarObservationFuture.get()
    ...
    fun queryhelp() {
        ...
        val responseFuture = sarObservationServiceAsync.queryhelp()
    ...
    fun tuple() {
        ...
        val responseFuture =
            sarObservationServiceAsync.tuple(
