...
class UnifieddatalibraryClientAsyncImpl(
    ...
    private val sync: UnifieddatalibraryClient by lazy { UnifieddatalibraryClientImpl(clientOptions) }

    private val withRawResponse: UnifieddatalibraryClientAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val airEvents: AirEventServiceAsync by lazy { AirEventServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val airOperations: AirOperationServiceAsync by lazy { AirOperationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val airTransportMissions: AirTransportMissionServiceAsync by lazy { AirTransportMissionServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val aircraft: AircraftServiceAsync by lazy { AircraftServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val aircraftSorties: AircraftSortyServiceAsync by lazy { AircraftSortyServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val aircraftStatusRemarks: AircraftStatusRemarkServiceAsync by lazy { AircraftStatusRemarkServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val aircraftStatuses: AircraftStatusServiceAsync by lazy { AircraftStatusServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val airfieldSlots: AirfieldSlotServiceAsync by lazy { AirfieldSlotServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val airfieldStatus: AirfieldStatusServiceAsync by lazy { AirfieldStatusServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val airfields: AirfieldServiceAsync by lazy { AirfieldServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val airfieldSlotConsumptions: AirfieldSlotConsumptionServiceAsync by lazy { AirfieldSlotConsumptionServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val airloadPlans: AirloadPlanServiceAsync by lazy { AirloadPlanServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val airspaceControlOrders: AirspaceControlOrderServiceAsync by lazy { AirspaceControlOrderServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val ais: AiServiceAsync by lazy { AiServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val aisObjects: AisObjectServiceAsync by lazy { AisObjectServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val analyticImagery: AnalyticImageryServiceAsync by lazy { AnalyticImageryServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val antennas: AntennaServiceAsync by lazy { AntennaServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val attitudeData: AttitudeDataServiceAsync by lazy { AttitudeDataServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val attitudeSets: AttitudeSetServiceAsync by lazy { AttitudeSetServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val batteries: BatteryServiceAsync by lazy { BatteryServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val batterydetails: BatterydetailServiceAsync by lazy { BatterydetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val beam: BeamServiceAsync by lazy { BeamServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val beamContours: BeamContourServiceAsync by lazy { BeamContourServiceAsyncImpl(clientOptionsWithUserAgent) }
    ...
    private val collectRequests: CollectRequestServiceAsync by lazy { CollectRequestServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val collectResponses: CollectResponseServiceAsync by lazy { CollectResponseServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val comm: CommServiceAsync by lazy { CommServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val conjunctions: ConjunctionServiceAsync by lazy { ConjunctionServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val cots: CotServiceAsync by lazy { CotServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val aviationRiskManagement: AviationRiskManagementServiceAsync by lazy { AviationRiskManagementServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val dropzone: DropzoneServiceAsync by lazy { DropzoneServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val emitterGeolocation: EmitterGeolocationServiceAsync by lazy { EmitterGeolocationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val featureAssessment: FeatureAssessmentServiceAsync by lazy { FeatureAssessmentServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val globalAtmosphericModel: GlobalAtmosphericModelServiceAsync by lazy { GlobalAtmosphericModelServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val routeStats: RouteStatServiceAsync by lazy { RouteStatServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val countries: CountryServiceAsync by lazy { CountryServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val crew: CrewServiceAsync by lazy { CrewServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val diffOfArrival: DiffOfArrivalServiceAsync by lazy { DiffOfArrivalServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val diplomaticClearance: DiplomaticClearanceServiceAsync by lazy { DiplomaticClearanceServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val driftHistory: DriftHistoryServiceAsync by lazy { DriftHistoryServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val ecpSdr: EcpSdrServiceAsync by lazy { EcpSdrServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val effectRequests: EffectRequestServiceAsync by lazy { EffectRequestServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val effectResponses: EffectResponseServiceAsync by lazy { EffectResponseServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val elsets: ElsetServiceAsync by lazy { ElsetServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val engineDetails: EngineDetailServiceAsync by lazy { EngineDetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val engines: EngineServiceAsync by lazy { EngineServiceAsyncImpl(clientOptionsWithUserAgent) }
    ...
    private val ephemeris: EphemerisServiceAsync by lazy { EphemerisServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val ephemerisSets: EphemerisSetServiceAsync by lazy { EphemerisSetServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val equipment: EquipmentServiceAsync by lazy { EquipmentServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val equipmentRemarks: EquipmentRemarkServiceAsync by lazy { EquipmentRemarkServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val evac: EvacServiceAsync by lazy { EvacServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val eventEvolution: EventEvolutionServiceAsync by lazy { EventEvolutionServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val flightplan: FlightplanServiceAsync by lazy { FlightplanServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val geoStatus: GeoStatusServiceAsync by lazy { GeoStatusServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val gnssObservationset: GnssObservationsetServiceAsync by lazy { GnssObservationsetServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val groundImagery: GroundImageryServiceAsync by lazy { GroundImageryServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val h3Geo: H3GeoServiceAsync by lazy { H3GeoServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val h3GeoHexCell: H3GeoHexCellServiceAsync by lazy { H3GeoHexCellServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val hazard: HazardServiceAsync by lazy { HazardServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val ir: IrServiceAsync by lazy { IrServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val isrCollections: IsrCollectionServiceAsync by lazy { IsrCollectionServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val item: ItemServiceAsync by lazy { ItemServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val itemTrackings: ItemTrackingServiceAsync by lazy { ItemTrackingServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val launchDetection: LaunchDetectionServiceAsync by lazy { LaunchDetectionServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val launchEvent: LaunchEventServiceAsync by lazy { LaunchEventServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val launchSite: LaunchSiteServiceAsync by lazy { LaunchSiteServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val launchSiteDetails: LaunchSiteDetailServiceAsync by lazy { LaunchSiteDetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val launchVehicle: LaunchVehicleServiceAsync by lazy { LaunchVehicleServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val launchVehicleDetails: LaunchVehicleDetailServiceAsync by lazy { LaunchVehicleDetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val linkStatus: LinkStatusServiceAsync by lazy { LinkStatusServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val location: LocationServiceAsync by lazy { LocationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val logisticsSupport: LogisticsSupportServiceAsync by lazy { LogisticsSupportServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val maneuvers: ManeuverServiceAsync by lazy { ManeuverServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val manifold: ManifoldServiceAsync by lazy { ManifoldServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val manifoldelset: ManifoldelsetServiceAsync by lazy { ManifoldelsetServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val missileTracks: MissileTrackServiceAsync by lazy { MissileTrackServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val missionAssignment: MissionAssignmentServiceAsync by lazy { MissionAssignmentServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val mti: MtiServiceAsync by lazy { MtiServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val navigation: NavigationServiceAsync by lazy { NavigationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val navigationalObstruction: NavigationalObstructionServiceAsync by lazy { NavigationalObstructionServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val notification: NotificationServiceAsync by lazy { NotificationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val objectOfInterest: ObjectOfInterestServiceAsync by lazy { ObjectOfInterestServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val observations: ObservationServiceAsync by lazy { ObservationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onboardnavigation: OnboardnavigationServiceAsync by lazy { OnboardnavigationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbit: OnorbitServiceAsync by lazy { OnorbitServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbitantenna: OnorbitantennaServiceAsync by lazy { OnorbitantennaServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbitbattery: OnorbitbatteryServiceAsync by lazy { OnorbitbatteryServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbitdetails: OnorbitdetailServiceAsync by lazy { OnorbitdetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbitevent: OnorbiteventServiceAsync by lazy { OnorbiteventServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbitlist: OnorbitlistServiceAsync by lazy { OnorbitlistServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbitsolararray: OnorbitsolararrayServiceAsync by lazy { OnorbitsolararrayServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbitthruster: OnorbitthrusterServiceAsync by lazy { OnorbitthrusterServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val onorbitthrusterstatus: OnorbitthrusterstatusServiceAsync by lazy { OnorbitthrusterstatusServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val operatingunit: OperatingunitServiceAsync by lazy { OperatingunitServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val operatingunitremark: OperatingunitremarkServiceAsync by lazy { OperatingunitremarkServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val orbitdetermination: OrbitdeterminationServiceAsync by lazy { OrbitdeterminationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val orbittrack: OrbittrackServiceAsync by lazy { OrbittrackServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val organization: OrganizationServiceAsync by lazy { OrganizationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val organizationdetails: OrganizationdetailServiceAsync by lazy { OrganizationdetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val personnelrecovery: PersonnelrecoveryServiceAsync by lazy { PersonnelrecoveryServiceAsyncImpl(clientOptionsWithUserAgent) }
    ...
    private val rfBand: RfBandServiceAsync by lazy { RfBandServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val rfBandType: RfBandTypeServiceAsync by lazy { RfBandTypeServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val rfEmitter: RfEmitterServiceAsync by lazy { RfEmitterServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val rfEmitterDetails: RfEmitterDetailServiceAsync by lazy { RfEmitterDetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sarObservation: SarObservationServiceAsync by lazy { SarObservationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val scientific: ScientificServiceAsync by lazy { ScientificServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sensor: SensorServiceAsync by lazy { SensorServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sensorMaintenance: SensorMaintenanceServiceAsync by lazy { SensorMaintenanceServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sensorObservationType: SensorObservationTypeServiceAsync by lazy { SensorObservationTypeServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sensorPlan: SensorPlanServiceAsync by lazy { SensorPlanServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sensorType: SensorTypeServiceAsync by lazy { SensorTypeServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val seraDataCommDetails: SeraDataCommDetailServiceAsync by lazy { SeraDataCommDetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val seraDataEarlyWarning: SeraDataEarlyWarningServiceAsync by lazy { SeraDataEarlyWarningServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val seraDataNavigation: SeraDataNavigationServiceAsync by lazy { SeraDataNavigationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val seradataOpticalPayload: SeradataOpticalPayloadServiceAsync by lazy { SeradataOpticalPayloadServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val seradataRadarPayload: SeradataRadarPayloadServiceAsync by lazy { SeradataRadarPayloadServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val seradataSigintPayload: SeradataSigintPayloadServiceAsync by lazy { SeradataSigintPayloadServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val seradataSpacecraftDetails: SeradataSpacecraftDetailServiceAsync by lazy { SeradataSpacecraftDetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sgi: SgiServiceAsync by lazy { SgiServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sigact: SigactServiceAsync by lazy { SigactServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val site: SiteServiceAsync by lazy { SiteServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val siteRemark: SiteRemarkServiceAsync by lazy { SiteRemarkServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val siteStatus: SiteStatusServiceAsync by lazy { SiteStatusServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val skyImagery: SkyImageryServiceAsync by lazy { SkyImageryServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val soiObservationSet: SoiObservationSetServiceAsync by lazy { SoiObservationSetServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val solarArray: SolarArrayServiceAsync by lazy { SolarArrayServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val solarArrayDetails: SolarArrayDetailServiceAsync by lazy { SolarArrayDetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val sortiePpr: SortiePprServiceAsync by lazy { SortiePprServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val spaceEnvObservation: SpaceEnvObservationServiceAsync by lazy { SpaceEnvObservationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val stage: StageServiceAsync by lazy { StageServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val starCatalog: StarCatalogServiceAsync by lazy { StarCatalogServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val stateVector: StateVectorServiceAsync by lazy { StateVectorServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val status: StatusServiceAsync by lazy { StatusServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val substatus: SubstatusServiceAsync by lazy { SubstatusServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val supportingData: SupportingDataServiceAsync by lazy { SupportingDataServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val surface: SurfaceServiceAsync by lazy { SurfaceServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val surfaceObstruction: SurfaceObstructionServiceAsync by lazy { SurfaceObstructionServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val swir: SwirServiceAsync by lazy { SwirServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val taiUtc: TaiUtcServiceAsync by lazy { TaiUtcServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val tdoaFdoa: TdoaFdoaServiceAsync by lazy { TdoaFdoaServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val track: TrackServiceAsync by lazy { TrackServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val trackDetails: TrackDetailServiceAsync by lazy { TrackDetailServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val trackRoute: TrackRouteServiceAsync by lazy { TrackRouteServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val transponder: TransponderServiceAsync by lazy { TransponderServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val vessel: VesselServiceAsync by lazy { VesselServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val video: VideoServiceAsync by lazy { VideoServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val weatherData: WeatherDataServiceAsync by lazy { WeatherDataServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val weatherReport: WeatherReportServiceAsync by lazy { WeatherReportServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val gnssObservations: GnssObservationServiceAsync by lazy { GnssObservationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val gnssRawIf: GnssRawIfServiceAsync by lazy { GnssRawIfServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val ionoObservations: IonoObservationServiceAsync by lazy { IonoObservationServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val reportAndActivities: ReportAndActivityServiceAsync by lazy { ReportAndActivityServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val secureMessaging: SecureMessagingServiceAsync by lazy { SecureMessagingServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val scs: ScServiceAsync by lazy { ScServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val scsViews: ScsViewServiceAsync by lazy { ScsViewServiceAsyncImpl(clientOptionsWithUserAgent) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): UnifieddatalibraryClientAsync = UnifieddatalibraryClientAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun airfieldSlotConsumptions(): AirfieldSlotConsumptionServiceAsync = airfieldSlotConsumptions
    ...
    override fun aviationRiskManagement(): AviationRiskManagementServiceAsync = aviationRiskManagement
    ...
    override fun globalAtmosphericModel(): GlobalAtmosphericModelServiceAsync = globalAtmosphericModel
    ...
    override fun navigationalObstruction(): NavigationalObstructionServiceAsync = navigationalObstruction
    ...
    override fun seradataOpticalPayload(): SeradataOpticalPayloadServiceAsync = seradataOpticalPayload
    ...
    override fun seradataSpacecraftDetails(): SeradataSpacecraftDetailServiceAsync = seradataSpacecraftDetails
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val airEvents: AirEventServiceAsync.WithRawResponse by lazy { AirEventServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val airOperations: AirOperationServiceAsync.WithRawResponse by lazy { AirOperationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val airTransportMissions: AirTransportMissionServiceAsync.WithRawResponse by lazy { AirTransportMissionServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val aircraft: AircraftServiceAsync.WithRawResponse by lazy { AircraftServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val aircraftSorties: AircraftSortyServiceAsync.WithRawResponse by lazy { AircraftSortyServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val aircraftStatusRemarks: AircraftStatusRemarkServiceAsync.WithRawResponse by lazy { AircraftStatusRemarkServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val aircraftStatuses: AircraftStatusServiceAsync.WithRawResponse by lazy { AircraftStatusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val airfieldSlots: AirfieldSlotServiceAsync.WithRawResponse by lazy { AirfieldSlotServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val airfieldStatus: AirfieldStatusServiceAsync.WithRawResponse by lazy { AirfieldStatusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val airfields: AirfieldServiceAsync.WithRawResponse by lazy { AirfieldServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val airfieldSlotConsumptions: AirfieldSlotConsumptionServiceAsync.WithRawResponse by lazy { AirfieldSlotConsumptionServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val airloadPlans: AirloadPlanServiceAsync.WithRawResponse by lazy { AirloadPlanServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val airspaceControlOrders: AirspaceControlOrderServiceAsync.WithRawResponse by lazy { AirspaceControlOrderServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val ais: AiServiceAsync.WithRawResponse by lazy { AiServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val aisObjects: AisObjectServiceAsync.WithRawResponse by lazy { AisObjectServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val analyticImagery: AnalyticImageryServiceAsync.WithRawResponse by lazy { AnalyticImageryServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val antennas: AntennaServiceAsync.WithRawResponse by lazy { AntennaServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        private val attitudeSets: AttitudeSetServiceAsync.WithRawResponse by lazy { AttitudeSetServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val batteries: BatteryServiceAsync.WithRawResponse by lazy { BatteryServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val batterydetails: BatterydetailServiceAsync.WithRawResponse by lazy { BatterydetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val beam: BeamServiceAsync.WithRawResponse by lazy { BeamServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val beamContours: BeamContourServiceAsync.WithRawResponse by lazy { BeamContourServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val buses: BusServiceAsync.WithRawResponse by lazy { BusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        private val collectRequests: CollectRequestServiceAsync.WithRawResponse by lazy { CollectRequestServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val collectResponses: CollectResponseServiceAsync.WithRawResponse by lazy { CollectResponseServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val comm: CommServiceAsync.WithRawResponse by lazy { CommServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val conjunctions: ConjunctionServiceAsync.WithRawResponse by lazy { ConjunctionServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val cots: CotServiceAsync.WithRawResponse by lazy { CotServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val aviationRiskManagement: AviationRiskManagementServiceAsync.WithRawResponse by lazy { AviationRiskManagementServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val dropzone: DropzoneServiceAsync.WithRawResponse by lazy { DropzoneServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val emitterGeolocation: EmitterGeolocationServiceAsync.WithRawResponse by lazy { EmitterGeolocationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val featureAssessment: FeatureAssessmentServiceAsync.WithRawResponse by lazy { FeatureAssessmentServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val globalAtmosphericModel: GlobalAtmosphericModelServiceAsync.WithRawResponse by lazy { GlobalAtmosphericModelServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val routeStats: RouteStatServiceAsync.WithRawResponse by lazy { RouteStatServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        private val crew: CrewServiceAsync.WithRawResponse by lazy { CrewServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        private val diplomaticClearance: DiplomaticClearanceServiceAsync.WithRawResponse by lazy { DiplomaticClearanceServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val driftHistory: DriftHistoryServiceAsync.WithRawResponse by lazy { DriftHistoryServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val ecpSdr: EcpSdrServiceAsync.WithRawResponse by lazy { EcpSdrServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val effectRequests: EffectRequestServiceAsync.WithRawResponse by lazy { EffectRequestServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val effectResponses: EffectResponseServiceAsync.WithRawResponse by lazy { EffectResponseServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val elsets: ElsetServiceAsync.WithRawResponse by lazy { ElsetServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val engineDetails: EngineDetailServiceAsync.WithRawResponse by lazy { EngineDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val engines: EngineServiceAsync.WithRawResponse by lazy { EngineServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val entities: EntityServiceAsync.WithRawResponse by lazy { EntityServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val eop: EopServiceAsync.WithRawResponse by lazy { EopServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val ephemeris: EphemerisServiceAsync.WithRawResponse by lazy { EphemerisServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val ephemerisSets: EphemerisSetServiceAsync.WithRawResponse by lazy { EphemerisSetServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val equipment: EquipmentServiceAsync.WithRawResponse by lazy { EquipmentServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val equipmentRemarks: EquipmentRemarkServiceAsync.WithRawResponse by lazy { EquipmentRemarkServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val evac: EvacServiceAsync.WithRawResponse by lazy { EvacServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val eventEvolution: EventEvolutionServiceAsync.WithRawResponse by lazy { EventEvolutionServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val flightplan: FlightplanServiceAsync.WithRawResponse by lazy { FlightplanServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val geoStatus: GeoStatusServiceAsync.WithRawResponse by lazy { GeoStatusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val gnssObservationset: GnssObservationsetServiceAsync.WithRawResponse by lazy { GnssObservationsetServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val groundImagery: GroundImageryServiceAsync.WithRawResponse by lazy { GroundImageryServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val h3Geo: H3GeoServiceAsync.WithRawResponse by lazy { H3GeoServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val h3GeoHexCell: H3GeoHexCellServiceAsync.WithRawResponse by lazy { H3GeoHexCellServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val hazard: HazardServiceAsync.WithRawResponse by lazy { HazardServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val ir: IrServiceAsync.WithRawResponse by lazy { IrServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val isrCollections: IsrCollectionServiceAsync.WithRawResponse by lazy { IsrCollectionServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val item: ItemServiceAsync.WithRawResponse by lazy { ItemServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val itemTrackings: ItemTrackingServiceAsync.WithRawResponse by lazy { ItemTrackingServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val launchDetection: LaunchDetectionServiceAsync.WithRawResponse by lazy { LaunchDetectionServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val launchEvent: LaunchEventServiceAsync.WithRawResponse by lazy { LaunchEventServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val launchSite: LaunchSiteServiceAsync.WithRawResponse by lazy { LaunchSiteServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val launchSiteDetails: LaunchSiteDetailServiceAsync.WithRawResponse by lazy { LaunchSiteDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val launchVehicle: LaunchVehicleServiceAsync.WithRawResponse by lazy { LaunchVehicleServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val launchVehicleDetails: LaunchVehicleDetailServiceAsync.WithRawResponse by lazy { LaunchVehicleDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val linkStatus: LinkStatusServiceAsync.WithRawResponse by lazy { LinkStatusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val location: LocationServiceAsync.WithRawResponse by lazy { LocationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val logisticsSupport: LogisticsSupportServiceAsync.WithRawResponse by lazy { LogisticsSupportServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val maneuvers: ManeuverServiceAsync.WithRawResponse by lazy { ManeuverServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val manifold: ManifoldServiceAsync.WithRawResponse by lazy { ManifoldServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val manifoldelset: ManifoldelsetServiceAsync.WithRawResponse by lazy { ManifoldelsetServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val missileTracks: MissileTrackServiceAsync.WithRawResponse by lazy { MissileTrackServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val missionAssignment: MissionAssignmentServiceAsync.WithRawResponse by lazy { MissionAssignmentServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val mti: MtiServiceAsync.WithRawResponse by lazy { MtiServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val navigation: NavigationServiceAsync.WithRawResponse by lazy { NavigationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val navigationalObstruction: NavigationalObstructionServiceAsync.WithRawResponse by lazy { NavigationalObstructionServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val notification: NotificationServiceAsync.WithRawResponse by lazy { NotificationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val objectOfInterest: ObjectOfInterestServiceAsync.WithRawResponse by lazy { ObjectOfInterestServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val observations: ObservationServiceAsync.WithRawResponse by lazy { ObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onboardnavigation: OnboardnavigationServiceAsync.WithRawResponse by lazy { OnboardnavigationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbit: OnorbitServiceAsync.WithRawResponse by lazy { OnorbitServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbitantenna: OnorbitantennaServiceAsync.WithRawResponse by lazy { OnorbitantennaServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbitbattery: OnorbitbatteryServiceAsync.WithRawResponse by lazy { OnorbitbatteryServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbitdetails: OnorbitdetailServiceAsync.WithRawResponse by lazy { OnorbitdetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbitevent: OnorbiteventServiceAsync.WithRawResponse by lazy { OnorbiteventServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbitlist: OnorbitlistServiceAsync.WithRawResponse by lazy { OnorbitlistServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbitsolararray: OnorbitsolararrayServiceAsync.WithRawResponse by lazy { OnorbitsolararrayServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbitthruster: OnorbitthrusterServiceAsync.WithRawResponse by lazy { OnorbitthrusterServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val onorbitthrusterstatus: OnorbitthrusterstatusServiceAsync.WithRawResponse by lazy { OnorbitthrusterstatusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val operatingunit: OperatingunitServiceAsync.WithRawResponse by lazy { OperatingunitServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val operatingunitremark: OperatingunitremarkServiceAsync.WithRawResponse by lazy { OperatingunitremarkServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val orbitdetermination: OrbitdeterminationServiceAsync.WithRawResponse by lazy { OrbitdeterminationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val orbittrack: OrbittrackServiceAsync.WithRawResponse by lazy { OrbittrackServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val organization: OrganizationServiceAsync.WithRawResponse by lazy { OrganizationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val organizationdetails: OrganizationdetailServiceAsync.WithRawResponse by lazy { OrganizationdetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val personnelrecovery: PersonnelrecoveryServiceAsync.WithRawResponse by lazy { PersonnelrecoveryServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val poi: PoiServiceAsync.WithRawResponse by lazy { PoiServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val port: PortServiceAsync.WithRawResponse by lazy { PortServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val rfBand: RfBandServiceAsync.WithRawResponse by lazy { RfBandServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val rfBandType: RfBandTypeServiceAsync.WithRawResponse by lazy { RfBandTypeServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val rfEmitter: RfEmitterServiceAsync.WithRawResponse by lazy { RfEmitterServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val rfEmitterDetails: RfEmitterDetailServiceAsync.WithRawResponse by lazy { RfEmitterDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sarObservation: SarObservationServiceAsync.WithRawResponse by lazy { SarObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val scientific: ScientificServiceAsync.WithRawResponse by lazy { ScientificServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sensor: SensorServiceAsync.WithRawResponse by lazy { SensorServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sensorMaintenance: SensorMaintenanceServiceAsync.WithRawResponse by lazy { SensorMaintenanceServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sensorObservationType: SensorObservationTypeServiceAsync.WithRawResponse by lazy { SensorObservationTypeServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sensorPlan: SensorPlanServiceAsync.WithRawResponse by lazy { SensorPlanServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sensorType: SensorTypeServiceAsync.WithRawResponse by lazy { SensorTypeServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val seraDataCommDetails: SeraDataCommDetailServiceAsync.WithRawResponse by lazy { SeraDataCommDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val seraDataEarlyWarning: SeraDataEarlyWarningServiceAsync.WithRawResponse by lazy { SeraDataEarlyWarningServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val seraDataNavigation: SeraDataNavigationServiceAsync.WithRawResponse by lazy { SeraDataNavigationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val seradataOpticalPayload: SeradataOpticalPayloadServiceAsync.WithRawResponse by lazy { SeradataOpticalPayloadServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val seradataRadarPayload: SeradataRadarPayloadServiceAsync.WithRawResponse by lazy { SeradataRadarPayloadServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val seradataSigintPayload: SeradataSigintPayloadServiceAsync.WithRawResponse by lazy { SeradataSigintPayloadServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val seradataSpacecraftDetails: SeradataSpacecraftDetailServiceAsync.WithRawResponse by lazy { SeradataSpacecraftDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sgi: SgiServiceAsync.WithRawResponse by lazy { SgiServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sigact: SigactServiceAsync.WithRawResponse by lazy { SigactServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val site: SiteServiceAsync.WithRawResponse by lazy { SiteServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val siteRemark: SiteRemarkServiceAsync.WithRawResponse by lazy { SiteRemarkServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val siteStatus: SiteStatusServiceAsync.WithRawResponse by lazy { SiteStatusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val skyImagery: SkyImageryServiceAsync.WithRawResponse by lazy { SkyImageryServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val soiObservationSet: SoiObservationSetServiceAsync.WithRawResponse by lazy { SoiObservationSetServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val solarArray: SolarArrayServiceAsync.WithRawResponse by lazy { SolarArrayServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val solarArrayDetails: SolarArrayDetailServiceAsync.WithRawResponse by lazy { SolarArrayDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val sortiePpr: SortiePprServiceAsync.WithRawResponse by lazy { SortiePprServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val spaceEnvObservation: SpaceEnvObservationServiceAsync.WithRawResponse by lazy { SpaceEnvObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val stage: StageServiceAsync.WithRawResponse by lazy { StageServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val starCatalog: StarCatalogServiceAsync.WithRawResponse by lazy { StarCatalogServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val stateVector: StateVectorServiceAsync.WithRawResponse by lazy { StateVectorServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val status: StatusServiceAsync.WithRawResponse by lazy { StatusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val substatus: SubstatusServiceAsync.WithRawResponse by lazy { SubstatusServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val supportingData: SupportingDataServiceAsync.WithRawResponse by lazy { SupportingDataServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val surface: SurfaceServiceAsync.WithRawResponse by lazy { SurfaceServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val surfaceObstruction: SurfaceObstructionServiceAsync.WithRawResponse by lazy { SurfaceObstructionServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val swir: SwirServiceAsync.WithRawResponse by lazy { SwirServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val taiUtc: TaiUtcServiceAsync.WithRawResponse by lazy { TaiUtcServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val tdoaFdoa: TdoaFdoaServiceAsync.WithRawResponse by lazy { TdoaFdoaServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val track: TrackServiceAsync.WithRawResponse by lazy { TrackServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val trackDetails: TrackDetailServiceAsync.WithRawResponse by lazy { TrackDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val trackRoute: TrackRouteServiceAsync.WithRawResponse by lazy { TrackRouteServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val transponder: TransponderServiceAsync.WithRawResponse by lazy { TransponderServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val vessel: VesselServiceAsync.WithRawResponse by lazy { VesselServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val video: VideoServiceAsync.WithRawResponse by lazy { VideoServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val weatherData: WeatherDataServiceAsync.WithRawResponse by lazy { WeatherDataServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val weatherReport: WeatherReportServiceAsync.WithRawResponse by lazy { WeatherReportServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val gnssObservations: GnssObservationServiceAsync.WithRawResponse by lazy { GnssObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val gnssRawIf: GnssRawIfServiceAsync.WithRawResponse by lazy { GnssRawIfServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val ionoObservations: IonoObservationServiceAsync.WithRawResponse by lazy { IonoObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val reportAndActivities: ReportAndActivityServiceAsync.WithRawResponse by lazy { ReportAndActivityServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val secureMessaging: SecureMessagingServiceAsync.WithRawResponse by lazy { SecureMessagingServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val scs: ScServiceAsync.WithRawResponse by lazy { ScServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val scsViews: ScsViewServiceAsync.WithRawResponse by lazy { ScsViewServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): UnifieddatalibraryClientAsync.WithRawResponse = UnifieddatalibraryClientAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun airTransportMissions(): AirTransportMissionServiceAsync.WithRawResponse = airTransportMissions
        ...
        override fun aircraftStatusRemarks(): AircraftStatusRemarkServiceAsync.WithRawResponse = aircraftStatusRemarks

        override fun aircraftStatuses(): AircraftStatusServiceAsync.WithRawResponse = aircraftStatuses
        ...
        override fun airfieldSlotConsumptions(): AirfieldSlotConsumptionServiceAsync.WithRawResponse = airfieldSlotConsumptions

        override fun airloadPlans(): AirloadPlanServiceAsync.WithRawResponse = airloadPlans

        override fun airspaceControlOrders(): AirspaceControlOrderServiceAsync.WithRawResponse = airspaceControlOrders
        ...
        override fun analyticImagery(): AnalyticImageryServiceAsync.WithRawResponse = analyticImagery
        ...
        override fun collectResponses(): CollectResponseServiceAsync.WithRawResponse = collectResponses
        ...
        override fun aviationRiskManagement(): AviationRiskManagementServiceAsync.WithRawResponse = aviationRiskManagement

        override fun dropzone(): DropzoneServiceAsync.WithRawResponse = dropzone

        override fun emitterGeolocation(): EmitterGeolocationServiceAsync.WithRawResponse = emitterGeolocation

        override fun featureAssessment(): FeatureAssessmentServiceAsync.WithRawResponse = featureAssessment

        override fun globalAtmosphericModel(): GlobalAtmosphericModelServiceAsync.WithRawResponse = globalAtmosphericModel
        ...
        override fun diplomaticClearance(): DiplomaticClearanceServiceAsync.WithRawResponse = diplomaticClearance
        ...
        override fun equipmentRemarks(): EquipmentRemarkServiceAsync.WithRawResponse = equipmentRemarks
        ...
        override fun gnssObservationset(): GnssObservationsetServiceAsync.WithRawResponse = gnssObservationset
        ...
        override fun launchDetection(): LaunchDetectionServiceAsync.WithRawResponse = launchDetection
        ...
        override fun launchSiteDetails(): LaunchSiteDetailServiceAsync.WithRawResponse = launchSiteDetails

        override fun launchVehicle(): LaunchVehicleServiceAsync.WithRawResponse = launchVehicle

        override fun launchVehicleDetails(): LaunchVehicleDetailServiceAsync.WithRawResponse = launchVehicleDetails
        ...
        override fun logisticsSupport(): LogisticsSupportServiceAsync.WithRawResponse = logisticsSupport
        ...
        override fun missionAssignment(): MissionAssignmentServiceAsync.WithRawResponse = missionAssignment
        ...
        override fun navigationalObstruction(): NavigationalObstructionServiceAsync.WithRawResponse = navigationalObstruction

        override fun notification(): NotificationServiceAsync.WithRawResponse = notification

        override fun objectOfInterest(): ObjectOfInterestServiceAsync.WithRawResponse = objectOfInterest

        override fun observations(): ObservationServiceAsync.WithRawResponse = observations

        override fun onboardnavigation(): OnboardnavigationServiceAsync.WithRawResponse = onboardnavigation
        ...
        override fun onorbitsolararray(): OnorbitsolararrayServiceAsync.WithRawResponse = onorbitsolararray

        override fun onorbitthruster(): OnorbitthrusterServiceAsync.WithRawResponse = onorbitthruster

        override fun onorbitthrusterstatus(): OnorbitthrusterstatusServiceAsync.WithRawResponse = onorbitthrusterstatus

        override fun operatingunit(): OperatingunitServiceAsync.WithRawResponse = operatingunit

        override fun operatingunitremark(): OperatingunitremarkServiceAsync.WithRawResponse = operatingunitremark

        override fun orbitdetermination(): OrbitdeterminationServiceAsync.WithRawResponse = orbitdetermination
        ...
        override fun organizationdetails(): OrganizationdetailServiceAsync.WithRawResponse = organizationdetails

        override fun personnelrecovery(): PersonnelrecoveryServiceAsync.WithRawResponse = personnelrecovery
        ...
        override fun rfEmitterDetails(): RfEmitterDetailServiceAsync.WithRawResponse = rfEmitterDetails
        ...
        override fun sensorMaintenance(): SensorMaintenanceServiceAsync.WithRawResponse = sensorMaintenance

        override fun sensorObservationType(): SensorObservationTypeServiceAsync.WithRawResponse = sensorObservationType
        ...
        override fun seraDataCommDetails(): SeraDataCommDetailServiceAsync.WithRawResponse = seraDataCommDetails

        override fun seraDataEarlyWarning(): SeraDataEarlyWarningServiceAsync.WithRawResponse = seraDataEarlyWarning

        override fun seraDataNavigation(): SeraDataNavigationServiceAsync.WithRawResponse = seraDataNavigation

        override fun seradataOpticalPayload(): SeradataOpticalPayloadServiceAsync.WithRawResponse = seradataOpticalPayload

        override fun seradataRadarPayload(): SeradataRadarPayloadServiceAsync.WithRawResponse = seradataRadarPayload

        override fun seradataSigintPayload(): SeradataSigintPayloadServiceAsync.WithRawResponse = seradataSigintPayload

        override fun seradataSpacecraftDetails(): SeradataSpacecraftDetailServiceAsync.WithRawResponse = seradataSpacecraftDetails
        ...
        override fun soiObservationSet(): SoiObservationSetServiceAsync.WithRawResponse = soiObservationSet

        override fun solarArray(): SolarArrayServiceAsync.WithRawResponse = solarArray

        override fun solarArrayDetails(): SolarArrayDetailServiceAsync.WithRawResponse = solarArrayDetails

        override fun sortiePpr(): SortiePprServiceAsync.WithRawResponse = sortiePpr

        override fun spaceEnvObservation(): SpaceEnvObservationServiceAsync.WithRawResponse = spaceEnvObservation
        ...
        override fun surfaceObstruction(): SurfaceObstructionServiceAsync.WithRawResponse = surfaceObstruction
        ...
        override fun gnssObservations(): GnssObservationServiceAsync.WithRawResponse = gnssObservations

        override fun gnssRawIf(): GnssRawIfServiceAsync.WithRawResponse = gnssRawIf

        override fun ionoObservations(): IonoObservationServiceAsync.WithRawResponse = ionoObservations

        override fun reportAndActivities(): ReportAndActivityServiceAsync.WithRawResponse = reportAndActivities

        override fun secureMessaging(): SecureMessagingServiceAsync.WithRawResponse = secureMessaging
