...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TransponderListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderListParams: TransponderListParams) = apply {
    ...
    override fun toString() =
        "TransponderListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
