    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) =
            apply {
                ...
                poiid = historyListResponse.poiid
                ...
                asset = historyListResponse.asset
                atext = historyListResponse.atext
                atype = historyListResponse.atype
                az = historyListResponse.az
                beNumber = historyListResponse.beNumber
                ce = historyListResponse.ce
                cntct = historyListResponse.cntct
                conf = historyListResponse.conf
                createdAt = historyListResponse.createdAt
                createdBy = historyListResponse.createdBy
                desc = historyListResponse.desc
                el = historyListResponse.el
                elle = historyListResponse.elle.map { it.toMutableList() }
                env = historyListResponse.env
                groups = historyListResponse.groups.map { it.toMutableList() }
                how = historyListResponse.how
                ident = historyListResponse.ident
                idWeatherReport = historyListResponse.idWeatherReport.map { it.toMutableList() }
                lat = historyListResponse.lat
                le = historyListResponse.le
                lon = historyListResponse.lon
                msnid = historyListResponse.msnid
                orientation = historyListResponse.orientation
                origin = historyListResponse.origin
                origNetwork = historyListResponse.origNetwork
                plat = historyListResponse.plat
                pps = historyListResponse.pps
                pri = historyListResponse.pri
                sourceDl = historyListResponse.sourceDl
                spec = historyListResponse.spec
                srcIds = historyListResponse.srcIds.map { it.toMutableList() }
                srcTyps = historyListResponse.srcTyps.map { it.toMutableList() }
                stale = historyListResponse.stale
                start = historyListResponse.start
                ...
                urls = historyListResponse.urls.map { it.toMutableList() }
