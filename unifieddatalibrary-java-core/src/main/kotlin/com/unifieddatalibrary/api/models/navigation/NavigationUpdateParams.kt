...
/**
 * Service operation to update a single Navigation. An Navigation is an on-orbit navigation payload.
 * A specific role is required to perform this service operation. Please contact the UDL team for
 * assistance.
 */
class NavigationUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationUpdateParams: NavigationUpdateParams) = apply {
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, bodyId=$bodyId, createdAt=$createdAt, createdBy=$createdBy, description=$description, entity=$entity, idEntity=$idEntity, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "NavigationUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
