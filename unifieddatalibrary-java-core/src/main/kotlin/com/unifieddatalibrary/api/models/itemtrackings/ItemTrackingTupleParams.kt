...
class ItemTrackingTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemTrackingTupleParams].
         *
    ...
    /** A builder for [ItemTrackingTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingTupleParams: ItemTrackingTupleParams) =
            apply {
                columns = itemTrackingTupleParams.columns
                ts = itemTrackingTupleParams.ts
                firstResult = itemTrackingTupleParams.firstResult
                maxResults = itemTrackingTupleParams.maxResults
                additionalHeaders = itemTrackingTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = itemTrackingTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ItemTrackingTupleParams].
         *
         ...
         */
        fun build(): ItemTrackingTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ItemTrackingTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ItemTrackingTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
