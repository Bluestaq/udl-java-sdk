...
class AntennaAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AntennaAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaAbridged: AntennaAbridged) =
            apply {
                dataMode = antennaAbridged.dataMode
                name = antennaAbridged.name
                source = antennaAbridged.source
                id = antennaAbridged.id
                createdAt = antennaAbridged.createdAt
                createdBy = antennaAbridged.createdBy
                origin = antennaAbridged.origin
                origNetwork = antennaAbridged.origNetwork
                additionalProperties = antennaAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AntennaAbridged].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AntennaAbridged && dataMode == other.dataMode && name == other.name && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && origin == other.origin && origNetwork == other.origNetwork && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "AntennaAbridged{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
