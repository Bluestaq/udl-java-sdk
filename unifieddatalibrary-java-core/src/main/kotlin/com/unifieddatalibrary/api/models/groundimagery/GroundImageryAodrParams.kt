...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GroundImageryAodrParams].
         *
    ...
    /** A builder for [GroundImageryAodrParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryAodrParams: GroundImageryAodrParams) = apply {
            imageTime = groundImageryAodrParams.imageTime
            columns = groundImageryAodrParams.columns
            firstResult = groundImageryAodrParams.firstResult
            maxResults = groundImageryAodrParams.maxResults
            notification = groundImageryAodrParams.notification
            outputDelimiter = groundImageryAodrParams.outputDelimiter
            outputFormat = groundImageryAodrParams.outputFormat
            additionalHeaders = groundImageryAodrParams.additionalHeaders.toBuilder()
            additionalQueryParams = groundImageryAodrParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GroundImageryAodrParams].
         *
         ...
         */
        fun build(): GroundImageryAodrParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GroundImageryAodrParams &&
    ...
    override fun toString() =
        "GroundImageryAodrParams{imageTime=$imageTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
