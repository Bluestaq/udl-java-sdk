...
class OnorbitdetailListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitdetailListPage: OnorbitdetailListPage) =
            apply {
        ...
        fun service(service: OnorbitdetailService) =
            apply {
    ...
    override fun toString() = "OnorbitdetailListPage{service=$service, params=$params, items=$items}"
}
