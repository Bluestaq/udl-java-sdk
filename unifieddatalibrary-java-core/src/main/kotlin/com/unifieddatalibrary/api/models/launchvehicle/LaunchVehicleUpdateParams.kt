...
/**
 * Service operation to update a single LaunchVehicle. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class LaunchVehicleUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleUpdateParams: LaunchVehicleUpdateParams) = apply {
    ...
    /**
     * Model representation of basic information about known launch vehicles. A launch vehicle may
     * have several details records including characteristics and information compiled by a
     * particular source.
     */
    class Body
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, bodyId=$bodyId, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "LaunchVehicleUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
