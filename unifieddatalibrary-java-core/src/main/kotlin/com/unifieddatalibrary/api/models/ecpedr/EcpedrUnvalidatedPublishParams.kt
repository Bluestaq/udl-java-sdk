...
/**
 * Service operation to take multiple ECPEDR records as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class EcpedrUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [EcpedrUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpedrUnvalidatedPublishParams: EcpedrUnvalidatedPublishParams) = apply {
            body = ecpedrUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = ecpedrUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams = ecpedrUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EcpedrUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): EcpedrUnvalidatedPublishParams =
            EcpedrUnvalidatedPublishParams(
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("chanId")
                @ExcludeMissing
                chanId: JsonField<String> = JsonMissing.of(),
                ...
                @ExcludeMissing
                msgNumber: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("obValue")
                @ExcludeMissing
                obValue: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("species")
                @ExcludeMissing
                species: JsonField<String> = JsonMissing.of(),
            ) : this(
                obType,
                obUoM,
                chanEnergyHigh,
             ...
             *
             * Unlike [chanEnergyHigh], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("chanEnergyHigh")
            @ExcludeMissing
             ...
             *
             * Unlike [chanType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [chanUnit], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [msgNumber], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 * Lower energy threshold of the channel for event detection and data collection.
                 */
                fun chanEnergyLow(chanEnergyLow: Double) =
                    chanEnergyLow(JsonField.of(chanEnergyLow))
                 ...
                 *
                 * You should usually call [Builder.chanId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.chanType] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.chanUnit] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.msgNumber] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.species] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, ecpedrMeasurements=$ecpedrMeasurements, obTime=$obTime, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, genSystem=$genSystem, genTime=$genTime, idOnOrbit=$idOnOrbit, idSensor=$idSensor, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, origSensorId=$origSensorId, satNo=$satNo, senPos=$senPos, senReferenceFrame=$senReferenceFrame, sourceDl=$sourceDl, tags=$tags, transactionId=$transactionId}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EcpedrUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EcpedrUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
