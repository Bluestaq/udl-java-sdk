...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(detailListResponse: DetailListResponse) = apply {
            classificationMarking = detailListResponse.classificationMarking
            dataMode = detailListResponse.dataMode
            idRfEmitter = detailListResponse.idRfEmitter
            source = detailListResponse.source
            id = detailListResponse.id
            alternateFacilityName = detailListResponse.alternateFacilityName
            altName = detailListResponse.altName
            amplifier = detailListResponse.amplifier
            antennas = detailListResponse.antennas.map { it.toMutableList() }
            barrageNoiseBandwidth = detailListResponse.barrageNoiseBandwidth
            bitRunTime = detailListResponse.bitRunTime
            createdAt = detailListResponse.createdAt
            createdBy = detailListResponse.createdBy
            description = detailListResponse.description
            designator = detailListResponse.designator
            dopplerNoise = detailListResponse.dopplerNoise
            drfmInstantaneousBandwidth = detailListResponse.drfmInstantaneousBandwidth
            family = detailListResponse.family
            fixedAttenuation = detailListResponse.fixedAttenuation
            idManufacturerOrg = detailListResponse.idManufacturerOrg
            idProductionFacilityLocation = detailListResponse.idProductionFacilityLocation
            loanedToCocom = detailListResponse.loanedToCocom
            notes = detailListResponse.notes
            numBits = detailListResponse.numBits
            numChannels = detailListResponse.numChannels
            origin = detailListResponse.origin
            origNetwork = detailListResponse.origNetwork
            powerOffsets = detailListResponse.powerOffsets.map { it.toMutableList() }
            prepTime = detailListResponse.prepTime
            primaryCocom = detailListResponse.primaryCocom
            productionFacilityName = detailListResponse.productionFacilityName
            receiverType = detailListResponse.receiverType
            secondaryNotes = detailListResponse.secondaryNotes
            services = detailListResponse.services.map { it.toMutableList() }
            systemSensitivityEnd = detailListResponse.systemSensitivityEnd
            systemSensitivityStart = detailListResponse.systemSensitivityStart
            ttps = detailListResponse.ttps.map { it.toMutableList() }
            updatedAt = detailListResponse.updatedAt
            updatedBy = detailListResponse.updatedBy
            urls = detailListResponse.urls.map { it.toMutableList() }
