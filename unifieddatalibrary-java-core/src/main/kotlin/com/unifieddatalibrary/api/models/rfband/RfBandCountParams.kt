...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfBandCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandCountParams: RfBandCountParams) = apply {
    ...
    override fun toString() =
        "RfBandCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
