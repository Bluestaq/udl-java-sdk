...
class SeraDataCommDetailQueryhelpResponse
private constructor(
    ...
    /** A builder for [SeraDataCommDetailQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seraDataCommDetailQueryhelpResponse: SeraDataCommDetailQueryhelpResponse
        ) = apply {
            aodrSupported = seraDataCommDetailQueryhelpResponse.aodrSupported
            classificationMarking = seraDataCommDetailQueryhelpResponse.classificationMarking
            description = seraDataCommDetailQueryhelpResponse.description
            historySupported = seraDataCommDetailQueryhelpResponse.historySupported
            name = seraDataCommDetailQueryhelpResponse.name
            parameters = seraDataCommDetailQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                seraDataCommDetailQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = seraDataCommDetailQueryhelpResponse.restSupported
            sortSupported = seraDataCommDetailQueryhelpResponse.sortSupported
            typeName = seraDataCommDetailQueryhelpResponse.typeName
            uri = seraDataCommDetailQueryhelpResponse.uri
            additionalProperties =
                seraDataCommDetailQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataCommDetailQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeraDataCommDetailQueryhelpResponse =
            SeraDataCommDetailQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): SeraDataCommDetailQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
