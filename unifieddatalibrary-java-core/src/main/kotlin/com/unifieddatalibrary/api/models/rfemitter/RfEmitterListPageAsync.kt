...
class RfEmitterListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<RfEmitterListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterListPageAsync: RfEmitterListPageAsync) =
            apply {
        ...
        fun service(service: RfEmitterServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: RfEmitterListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<RfEmitterListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "RfEmitterListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
