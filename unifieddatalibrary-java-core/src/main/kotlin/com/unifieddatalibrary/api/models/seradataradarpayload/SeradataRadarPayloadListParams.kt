 ...
 */
class SeradataRadarPayloadListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataRadarPayloadListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataRadarPayloadListParams: SeradataRadarPayloadListParams) = apply {
    ...
    override fun toString() =
        "SeradataRadarPayloadListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
