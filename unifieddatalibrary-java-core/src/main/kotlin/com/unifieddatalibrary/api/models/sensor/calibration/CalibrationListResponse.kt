...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalibrationListResponse].
         *
    ...
    /** A builder for [CalibrationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationListResponse: CalibrationListResponse) = apply {
            classificationMarking = calibrationListResponse.classificationMarking
            dataMode = calibrationListResponse.dataMode
            idSensor = calibrationListResponse.idSensor
            source = calibrationListResponse.source
            startTime = calibrationListResponse.startTime
            id = calibrationListResponse.id
            azRaAccelBias = calibrationListResponse.azRaAccelBias
            azRaAccelSigma = calibrationListResponse.azRaAccelSigma
            azRaBias = calibrationListResponse.azRaBias
            azRaRateBias = calibrationListResponse.azRaRateBias
            azRaRateSigma = calibrationListResponse.azRaRateSigma
            azRaRms = calibrationListResponse.azRaRms
            azRaSigma = calibrationListResponse.azRaSigma
            calAngleRef = calibrationListResponse.calAngleRef
            calTrackMode = calibrationListResponse.calTrackMode
            calType = calibrationListResponse.calType
            confidenceNoiseBias = calibrationListResponse.confidenceNoiseBias
            createdAt = calibrationListResponse.createdAt
            createdBy = calibrationListResponse.createdBy
            duration = calibrationListResponse.duration
            ecr = calibrationListResponse.ecr.map { it.toMutableList() }
            elDecAccelBias = calibrationListResponse.elDecAccelBias
            elDecAccelSigma = calibrationListResponse.elDecAccelSigma
            elDecBias = calibrationListResponse.elDecBias
            elDecRateBias = calibrationListResponse.elDecRateBias
            elDecRateSigma = calibrationListResponse.elDecRateSigma
            elDecRms = calibrationListResponse.elDecRms
            elDecSigma = calibrationListResponse.elDecSigma
            endTime = calibrationListResponse.endTime
            numAzRaObs = calibrationListResponse.numAzRaObs
            numElDecObs = calibrationListResponse.numElDecObs
            numObs = calibrationListResponse.numObs
            numPhotoObs = calibrationListResponse.numPhotoObs
            numRangeObs = calibrationListResponse.numRangeObs
            numRangeRateObs = calibrationListResponse.numRangeRateObs
            numRcsObs = calibrationListResponse.numRcsObs
            numTimeObs = calibrationListResponse.numTimeObs
            numTracks = calibrationListResponse.numTracks
            origin = calibrationListResponse.origin
            origNetwork = calibrationListResponse.origNetwork
            photoBias = calibrationListResponse.photoBias
            photoSigma = calibrationListResponse.photoSigma
            rangeAccelBias = calibrationListResponse.rangeAccelBias
            rangeAccelSigma = calibrationListResponse.rangeAccelSigma
            rangeBias = calibrationListResponse.rangeBias
            rangeRateBias = calibrationListResponse.rangeRateBias
            rangeRateRms = calibrationListResponse.rangeRateRms
            rangeRateSigma = calibrationListResponse.rangeRateSigma
            rangeRms = calibrationListResponse.rangeRms
            rangeSigma = calibrationListResponse.rangeSigma
            rcsBias = calibrationListResponse.rcsBias
            rcsSigma = calibrationListResponse.rcsSigma
            refTargets = calibrationListResponse.refTargets.map { it.toMutableList() }
            refType = calibrationListResponse.refType
            senType = calibrationListResponse.senType
            sourceDl = calibrationListResponse.sourceDl
            timeBias = calibrationListResponse.timeBias
            timeBiasSigma = calibrationListResponse.timeBiasSigma
            additionalProperties = calibrationListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CalibrationListResponse].
         *
         ...
         */
        fun build(): CalibrationListResponse =
    ...
    fun validate(): CalibrationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CalibrationListResponse &&
