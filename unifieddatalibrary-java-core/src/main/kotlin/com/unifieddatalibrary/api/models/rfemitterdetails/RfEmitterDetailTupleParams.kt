...
class RfEmitterDetailTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfEmitterDetailTupleParams].
         *
    ...
    /** A builder for [RfEmitterDetailTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailTupleParams: RfEmitterDetailTupleParams) =
            apply {
                columns = rfEmitterDetailTupleParams.columns
                firstResult = rfEmitterDetailTupleParams.firstResult
                maxResults = rfEmitterDetailTupleParams.maxResults
                additionalHeaders = rfEmitterDetailTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfEmitterDetailTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfEmitterDetailTupleParams].
         *
         ...
         */
        fun build(): RfEmitterDetailTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfEmitterDetailTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfEmitterDetailTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
