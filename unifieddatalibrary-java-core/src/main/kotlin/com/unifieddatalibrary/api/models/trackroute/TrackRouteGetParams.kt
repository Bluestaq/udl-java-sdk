...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TrackRouteGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TrackRouteGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TrackRouteGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackRouteGetParams: TrackRouteGetParams) = apply {
            id = trackRouteGetParams.id
            firstResult = trackRouteGetParams.firstResult
            maxResults = trackRouteGetParams.maxResults
            additionalHeaders = trackRouteGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = trackRouteGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TrackRouteGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TrackRouteGetParams =
            TrackRouteGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackRouteGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TrackRouteGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
