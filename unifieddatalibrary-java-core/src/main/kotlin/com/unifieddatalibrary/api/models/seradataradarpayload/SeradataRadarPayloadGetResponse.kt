...
class SeradataRadarPayloadGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataRadarPayloadGetResponse].
         *
    ...
    /** A builder for [SeradataRadarPayloadGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataRadarPayloadGetResponse: SeradataRadarPayloadGetResponse) =
            apply {
                classificationMarking = seradataRadarPayloadGetResponse.classificationMarking
                dataMode = seradataRadarPayloadGetResponse.dataMode
                source = seradataRadarPayloadGetResponse.source
                spacecraftId = seradataRadarPayloadGetResponse.spacecraftId
                id = seradataRadarPayloadGetResponse.id
                bandwidth = seradataRadarPayloadGetResponse.bandwidth
                bestResolution = seradataRadarPayloadGetResponse.bestResolution
                category = seradataRadarPayloadGetResponse.category
                constellationInterferometricCapability = seradataRadarPayloadGetResponse.constellationInterferometricCapability
                createdAt = seradataRadarPayloadGetResponse.createdAt
                createdBy = seradataRadarPayloadGetResponse.createdBy
                dutyCycle = seradataRadarPayloadGetResponse.dutyCycle
                fieldOfRegard = seradataRadarPayloadGetResponse.fieldOfRegard
                fieldOfView = seradataRadarPayloadGetResponse.fieldOfView
                frequency = seradataRadarPayloadGetResponse.frequency
                frequencyBand = seradataRadarPayloadGetResponse.frequencyBand
                groundStationLocations = seradataRadarPayloadGetResponse.groundStationLocations
                groundStations = seradataRadarPayloadGetResponse.groundStations
                hostedForCompanyOrgId = seradataRadarPayloadGetResponse.hostedForCompanyOrgId
                idSensor = seradataRadarPayloadGetResponse.idSensor
                manufacturerOrgId = seradataRadarPayloadGetResponse.manufacturerOrgId
                name = seradataRadarPayloadGetResponse.name
                notes = seradataRadarPayloadGetResponse.notes
                origin = seradataRadarPayloadGetResponse.origin
                origNetwork = seradataRadarPayloadGetResponse.origNetwork
                partnerSpacecraft = seradataRadarPayloadGetResponse.partnerSpacecraft
                pointingMethod = seradataRadarPayloadGetResponse.pointingMethod
                receivePolarization = seradataRadarPayloadGetResponse.receivePolarization
                recorderSize = seradataRadarPayloadGetResponse.recorderSize
                swathWidth = seradataRadarPayloadGetResponse.swathWidth
                transmitPolarization = seradataRadarPayloadGetResponse.transmitPolarization
                updatedAt = seradataRadarPayloadGetResponse.updatedAt
                updatedBy = seradataRadarPayloadGetResponse.updatedBy
                waveLength = seradataRadarPayloadGetResponse.waveLength
                additionalProperties = seradataRadarPayloadGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataRadarPayloadGetResponse].
         *
         ...
         */
        fun build(): SeradataRadarPayloadGetResponse =
    ...
    fun validate(): SeradataRadarPayloadGetResponse =
        apply {
            if (validated) {
              return@apply
            }
