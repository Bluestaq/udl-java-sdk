...
class EmireportQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmireportQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EmireportQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportQueryhelpResponse: EmireportQueryhelpResponse) = apply {
            aodrSupported = emireportQueryhelpResponse.aodrSupported
            classificationMarking = emireportQueryhelpResponse.classificationMarking
            description = emireportQueryhelpResponse.description
            historySupported = emireportQueryhelpResponse.historySupported
            name = emireportQueryhelpResponse.name
            parameters = emireportQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = emireportQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = emireportQueryhelpResponse.restSupported
            sortSupported = emireportQueryhelpResponse.sortSupported
            typeName = emireportQueryhelpResponse.typeName
            uri = emireportQueryhelpResponse.uri
            additionalProperties = emireportQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmireportQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EmireportQueryhelpResponse =
    ...
    fun validate(): EmireportQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportQueryhelpResponse &&
