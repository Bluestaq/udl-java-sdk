...
class StageListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StageListResponse].
         *
    ...
    /** A builder for [StageListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageListResponse: StageListResponse) =
            apply {
                classificationMarking = stageListResponse.classificationMarking
                dataMode = stageListResponse.dataMode
                idEngine = stageListResponse.idEngine
                idLaunchVehicle = stageListResponse.idLaunchVehicle
                source = stageListResponse.source
                id = stageListResponse.id
                avionicsNotes = stageListResponse.avionicsNotes
                burnTime = stageListResponse.burnTime
                controlThruster1 = stageListResponse.controlThruster1
                controlThruster2 = stageListResponse.controlThruster2
                createdAt = stageListResponse.createdAt
                createdBy = stageListResponse.createdBy
                diameter = stageListResponse.diameter
                length = stageListResponse.length
                mainEngineThrustSeaLevel = stageListResponse.mainEngineThrustSeaLevel
                mainEngineThrustVacuum = stageListResponse.mainEngineThrustVacuum
                manufacturerOrgId = stageListResponse.manufacturerOrgId
                mass = stageListResponse.mass
                notes = stageListResponse.notes
                numBurns = stageListResponse.numBurns
                numControlThruster1 = stageListResponse.numControlThruster1
                numControlThruster2 = stageListResponse.numControlThruster2
                numEngines = stageListResponse.numEngines
                numStageElements = stageListResponse.numStageElements
                numVernier = stageListResponse.numVernier
                origin = stageListResponse.origin
                origNetwork = stageListResponse.origNetwork
                photoUrls = stageListResponse.photoUrls.map { it.toMutableList() }
                restartable = stageListResponse.restartable
                reusable = stageListResponse.reusable
                stageNumber = stageListResponse.stageNumber
                thrustSeaLevel = stageListResponse.thrustSeaLevel
                thrustVacuum = stageListResponse.thrustVacuum
                type = stageListResponse.type
                vernier = stageListResponse.vernier
                vernierBurnTime = stageListResponse.vernierBurnTime
                vernierNumBurns = stageListResponse.vernierNumBurns
                vernierThrustSeaLevel = stageListResponse.vernierThrustSeaLevel
                vernierThrustVacuum = stageListResponse.vernierThrustVacuum
                additionalProperties = stageListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StageListResponse].
         *
    ...
    fun validate(): StageListResponse =
        apply {
            if (validated) {
              return@apply
            }
