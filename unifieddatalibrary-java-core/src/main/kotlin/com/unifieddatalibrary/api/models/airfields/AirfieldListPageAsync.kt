...
private constructor(
    ...
    override fun nextPage(): CompletableFuture<AirfieldListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldListPageAsync: AirfieldListPageAsync) = apply {
        ...
        fun service(service: AirfieldServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: AirfieldListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<AirfieldAbridged>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AirfieldListPageAsync &&
    ...
    override fun toString() =
        "AirfieldListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
