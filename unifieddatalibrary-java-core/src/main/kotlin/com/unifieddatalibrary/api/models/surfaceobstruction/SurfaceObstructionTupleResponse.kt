...
class SurfaceObstructionTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceObstructionTupleResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(surfaceObstructionTupleResponse: SurfaceObstructionTupleResponse) =
            apply {
                ...
                advisoryRequired = surfaceObstructionTupleResponse.advisoryRequired.map { it.toMutableList() }
                approvalRequired = surfaceObstructionTupleResponse.approvalRequired.map { it.toMutableList() }
                ...
                idNavigationalObstruction = surfaceObstructionTupleResponse.idNavigationalObstruction
                ...
                additionalProperties = surfaceObstructionTupleResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SurfaceObstructionTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
