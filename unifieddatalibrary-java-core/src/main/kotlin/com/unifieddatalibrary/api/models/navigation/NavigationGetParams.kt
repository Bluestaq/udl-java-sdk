...
class NavigationGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): NavigationGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationGetParams: NavigationGetParams) =
            apply {
    ...
    override fun toString() = "NavigationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
