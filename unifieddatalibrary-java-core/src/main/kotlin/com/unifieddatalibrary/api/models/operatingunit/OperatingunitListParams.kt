...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OperatingunitListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitListParams: OperatingunitListParams) = apply {
    ...
    override fun toString() =
        "OperatingunitListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
