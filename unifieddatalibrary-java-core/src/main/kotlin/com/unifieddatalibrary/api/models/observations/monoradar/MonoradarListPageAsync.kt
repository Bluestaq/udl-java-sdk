...
class MonoradarListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<MonoradarListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarListPageAsync: MonoradarListPageAsync) =
            apply {
        ...
        fun service(service: MonoradarServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: MonoradarListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<MonoradarListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "MonoradarListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
