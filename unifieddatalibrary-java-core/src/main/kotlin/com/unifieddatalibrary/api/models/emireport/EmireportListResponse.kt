...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmireportListResponse].
         *
    ...
    /** A builder for [EmireportListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportListResponse: EmireportListResponse) = apply {
            classificationMarking = emireportListResponse.classificationMarking
            dataMode = emireportListResponse.dataMode
            isr = emireportListResponse.isr
            reportId = emireportListResponse.reportId
            reportTime = emireportListResponse.reportTime
            reportType = emireportListResponse.reportType
            requestAssist = emireportListResponse.requestAssist
            source = emireportListResponse.source
            startTime = emireportListResponse.startTime
            id = emireportListResponse.id
            actionsTaken = emireportListResponse.actionsTaken
            affActivity = emireportListResponse.affActivity
            alt = emireportListResponse.alt
            aor = emireportListResponse.aor
            band = emireportListResponse.band
            beamPattern = emireportListResponse.beamPattern
            channel = emireportListResponse.channel
            chanPirate = emireportListResponse.chanPirate
            createdAt = emireportListResponse.createdAt
            createdBy = emireportListResponse.createdBy
            description = emireportListResponse.description
            dneImpact = emireportListResponse.dneImpact
            emiType = emireportListResponse.emiType
            endTime = emireportListResponse.endTime
            frequency = emireportListResponse.frequency
            geoLocErrEllp = emireportListResponse.geoLocErrEllp.map { it.toMutableList() }
            gpsEncrypted = emireportListResponse.gpsEncrypted
            gpsFreq = emireportListResponse.gpsFreq
            highAffectedFrequency = emireportListResponse.highAffectedFrequency
            idOnOrbit = emireportListResponse.idOnOrbit
            intercept = emireportListResponse.intercept
            interceptLang = emireportListResponse.interceptLang
            interceptType = emireportListResponse.interceptType
            intSrcAmplitude = emireportListResponse.intSrcAmplitude
            intSrcBandwidth = emireportListResponse.intSrcBandwidth
            intSrcCentFreq = emireportListResponse.intSrcCentFreq
            intSrcEncrypted = emireportListResponse.intSrcEncrypted
            intSrcModulation = emireportListResponse.intSrcModulation
            isrCollectionImpact = emireportListResponse.isrCollectionImpact
            killBox = emireportListResponse.killBox
            lat = emireportListResponse.lat
            link = emireportListResponse.link
            lon = emireportListResponse.lon
            milGrid = emireportListResponse.milGrid
            origin = emireportListResponse.origin
            origNetwork = emireportListResponse.origNetwork
            origObjectId = emireportListResponse.origObjectId
            persistence = emireportListResponse.persistence
            platform = emireportListResponse.platform
            rcvrDemod = emireportListResponse.rcvrDemod
            rcvrGain = emireportListResponse.rcvrGain
            rcvrLocation = emireportListResponse.rcvrLocation
            rcvrType = emireportListResponse.rcvrType
            respService = emireportListResponse.respService
            satcomPriority = emireportListResponse.satcomPriority
            satDownlinkFrequency = emireportListResponse.satDownlinkFrequency
            satDownlinkPolarization = emireportListResponse.satDownlinkPolarization
            satName = emireportListResponse.satName
            satNo = emireportListResponse.satNo
            satTransponderId = emireportListResponse.satTransponderId
            satUplinkFrequency = emireportListResponse.satUplinkFrequency
            satUplinkPolarization = emireportListResponse.satUplinkPolarization
            sourceDl = emireportListResponse.sourceDl
            status = emireportListResponse.status
            supportedIsrRole = emireportListResponse.supportedIsrRole
            system = emireportListResponse.system
            transactionId = emireportListResponse.transactionId
            victimAltCountry = emireportListResponse.victimAltCountry
            victimCountryCode = emireportListResponse.victimCountryCode
            victimFuncImpacts = emireportListResponse.victimFuncImpacts
            victimPocMail = emireportListResponse.victimPocMail
            victimPocName = emireportListResponse.victimPocName
            victimPocPhone = emireportListResponse.victimPocPhone
            victimPocUnit = emireportListResponse.victimPocUnit
            victimReaction = emireportListResponse.victimReaction
            additionalProperties = emireportListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmireportListResponse].
         *
         ...
         */
        fun build(): EmireportListResponse =
    ...
    fun validate(): EmireportListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportListResponse &&
