...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mtiListPageAsync: MtiListPageAsync) = apply {
        ...
        fun service(service: MtiServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MtiListPageAsync &&
    ...
    override fun toString() =
        "MtiListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
