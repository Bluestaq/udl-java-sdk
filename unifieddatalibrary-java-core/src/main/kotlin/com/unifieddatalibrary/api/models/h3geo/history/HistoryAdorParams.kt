...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HistoryAdorParams].
         *
    ...
    /** A builder for [HistoryAdorParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(historyAdorParams: HistoryAdorParams) = apply {
            startTime = historyAdorParams.startTime
            columns = historyAdorParams.columns
            firstResult = historyAdorParams.firstResult
            maxResults = historyAdorParams.maxResults
            notification = historyAdorParams.notification
            outputDelimiter = historyAdorParams.outputDelimiter
            outputFormat = historyAdorParams.outputFormat
            additionalHeaders = historyAdorParams.additionalHeaders.toBuilder()
            additionalQueryParams = historyAdorParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [HistoryAdorParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is HistoryAdorParams && startTime == other.startTime && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && notification == other.notification && outputDelimiter == other.outputDelimiter && outputFormat == other.outputFormat && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(startTime, columns, firstResult, maxResults, notification, outputDelimiter, outputFormat, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "HistoryAdorParams{startTime=$startTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
