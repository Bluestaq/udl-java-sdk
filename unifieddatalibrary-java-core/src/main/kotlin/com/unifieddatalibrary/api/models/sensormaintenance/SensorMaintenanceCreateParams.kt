...
/**
 * Service operation to take a single SensorMaintenance as a POST body and ingest into the database.
 * A specific role is required to perform this service operation. Please contact the UDL team for
 * assistance.
 */
class SensorMaintenanceCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun siteCode(): String = body.siteCode()
     ...
     *   if the server responded with an unexpected value).
     */
    fun approver(): Optional<String> = body.approver()
     ...
     *   if the server responded with an unexpected value).
     */
    fun changer(): Optional<String> = body.changer()
     ...
     *   if the server responded with an unexpected value).
     */
    fun eowId(): Optional<String> = body.eowId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun equipStatus(): Optional<String> = body.equipStatus()
     ...
     *   if the server responded with an unexpected value).
     */
    fun impactedFaces(): Optional<String> = body.impactedFaces()
     ...
     *   if the server responded with an unexpected value).
     */
    fun inactiveDate(): Optional<OffsetDateTime> = body.inactiveDate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun lineNumber(): Optional<String> = body.lineNumber()
     ...
     *   if the server responded with an unexpected value).
     */
    fun mdOpsCap(): Optional<String> = body.mdOpsCap()
     ...
     *   if the server responded with an unexpected value).
     */
    fun mwOpsCap(): Optional<String> = body.mwOpsCap()
     ...
     *   if the server responded with an unexpected value).
     */
    fun recall(): Optional<String> = body.recall()
     ...
     *   if the server responded with an unexpected value).
     */
    fun rel(): Optional<String> = body.rel()
     ...
     *   if the server responded with an unexpected value).
     */
    fun rev(): Optional<String> = body.rev()
     ...
     *   if the server responded with an unexpected value).
     */
    fun ssOpsCap(): Optional<String> = body.ssOpsCap()
     ...
     */
    fun _siteCode(): JsonField<String> = body._siteCode()
     ...
     */
    fun _approver(): JsonField<String> = body._approver()
     ...
     */
    fun _changer(): JsonField<String> = body._changer()
     ...
     */
    fun _eowId(): JsonField<String> = body._eowId()
     ...
     */
    fun _equipStatus(): JsonField<String> = body._equipStatus()
     ...
     */
    fun _impactedFaces(): JsonField<String> = body._impactedFaces()
     ...
     */
    fun _inactiveDate(): JsonField<OffsetDateTime> = body._inactiveDate()
     ...
     */
    fun _lineNumber(): JsonField<String> = body._lineNumber()
     ...
     */
    fun _mdOpsCap(): JsonField<String> = body._mdOpsCap()
     ...
     */
    fun _mwOpsCap(): JsonField<String> = body._mwOpsCap()
     ...
     */
    fun _recall(): JsonField<String> = body._recall()
     ...
     */
    fun _rel(): JsonField<String> = body._rel()
     ...
     */
    fun _rev(): JsonField<String> = body._rev()
     ...
     */
    fun _ssOpsCap(): JsonField<String> = body._ssOpsCap()
    ...
    /** A builder for [SensorMaintenanceCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceCreateParams: SensorMaintenanceCreateParams) = apply {
            body = sensorMaintenanceCreateParams.body.toBuilder()
            additionalHeaders = sensorMaintenanceCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = sensorMaintenanceCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * identically correspond to other UDL site IDs.
         */
        fun siteCode(siteCode: String) = apply { body.siteCode(siteCode) }
         ...
         */
        fun siteCode(siteCode: JsonField<String>) = apply { body.siteCode(siteCode) }
        ...
        /** The name of the approver. */
        fun approver(approver: String) = apply { body.approver(approver) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun approver(approver: JsonField<String>) = apply { body.approver(approver) }

        /** The name of the changer, if applicable. */
        fun changer(changer: String) = apply { body.changer(changer) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun changer(changer: JsonField<String>) = apply { body.changer(changer) }
        ...
        /** COLT EOWID. */
        fun eowId(eowId: String) = apply { body.eowId(eowId) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun eowId(eowId: JsonField<String>) = apply { body.eowId(eowId) }

        /** The mission capability status of the equipment (e.g. FMC, NMC, PMC, UNK, etc.). */
        fun equipStatus(equipStatus: String) = apply { body.equipStatus(equipStatus) }
         ...
         * value.
         */
        fun equipStatus(equipStatus: JsonField<String>) = apply { body.equipStatus(equipStatus) }
        ...
        /** The sensor face(s) to which this COLT maintenance item applies, if applicable. */
        fun impactedFaces(impactedFaces: String) = apply { body.impactedFaces(impactedFaces) }
        ...
        fun impactedFaces(impactedFaces: JsonField<String>) = apply {
            body.impactedFaces(impactedFaces)
        }

        /** The date that this item became inactive in ISO8601 UTC format. */
        fun inactiveDate(inactiveDate: OffsetDateTime) = apply { body.inactiveDate(inactiveDate) }
        ...
        fun inactiveDate(inactiveDate: JsonField<OffsetDateTime>) = apply {
            body.inactiveDate(inactiveDate)
        }

        /** The internal COLT line number assigned to this item. */
        fun lineNumber(lineNumber: String) = apply { body.lineNumber(lineNumber) }
         ...
         * value.
         */
        fun lineNumber(lineNumber: JsonField<String>) = apply { body.lineNumber(lineNumber) }

        /**
         * The Missile Defense operational capability of this maintenance item. Typical values are
         * G, Y, R, and - for non-applicable sites.
         */
        fun mdOpsCap(mdOpsCap: String) = apply { body.mdOpsCap(mdOpsCap) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun mdOpsCap(mdOpsCap: JsonField<String>) = apply { body.mdOpsCap(mdOpsCap) }

        /**
         * The Missile Warning operational capability of this maintenance item. Typical values are
         * G, Y, R, and - for non-applicable sites.
         */
        fun mwOpsCap(mwOpsCap: String) = apply { body.mwOpsCap(mwOpsCap) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun mwOpsCap(mwOpsCap: JsonField<String>) = apply { body.mwOpsCap(mwOpsCap) }
        ...
        /** The minimum time required to recall this activity, expressed as ddd:hh:mm. */
        fun recall(recall: String) = apply { body.recall(recall) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun recall(recall: JsonField<String>) = apply { body.recall(recall) }

        /** Release. */
        fun rel(rel: String) = apply { body.rel(rel) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun rel(rel: JsonField<String>) = apply { body.rel(rel) }
        ...
        /** The revision number for this maintenance item. */
        fun rev(rev: String) = apply { body.rev(rev) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun rev(rev: JsonField<String>) = apply { body.rev(rev) }
         ...
         */
        fun ssOpsCap(ssOpsCap: String) = apply { body.ssOpsCap(ssOpsCap) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun ssOpsCap(ssOpsCap: JsonField<String>) = apply { body.ssOpsCap(ssOpsCap) }
        ...
        /**
         * Returns an immutable instance of [SensorMaintenanceCreateParams].
         *
         ...
         */
        fun build(): SensorMaintenanceCreateParams =
            SensorMaintenanceCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SensorMaintenanceCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SensorMaintenanceCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
