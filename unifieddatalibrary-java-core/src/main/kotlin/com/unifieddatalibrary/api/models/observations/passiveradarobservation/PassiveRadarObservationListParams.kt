...
class PassiveRadarObservationListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PassiveRadarObservationListParams].
         *
    ...
    /** A builder for [PassiveRadarObservationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(passiveRadarObservationListParams: PassiveRadarObservationListParams) =
            apply {
                obTime = passiveRadarObservationListParams.obTime
                firstResult = passiveRadarObservationListParams.firstResult
                maxResults = passiveRadarObservationListParams.maxResults
                additionalHeaders = passiveRadarObservationListParams.additionalHeaders.toBuilder()
                additionalQueryParams = passiveRadarObservationListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PassiveRadarObservationListParams].
         *
         ...
         */
        fun build(): PassiveRadarObservationListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PassiveRadarObservationListParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "PassiveRadarObservationListParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
