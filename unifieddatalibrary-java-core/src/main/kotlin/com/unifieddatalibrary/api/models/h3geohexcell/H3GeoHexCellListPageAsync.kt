...
class H3GeoHexCellListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<H3GeoHexCellListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellListPageAsync: H3GeoHexCellListPageAsync) =
            apply {
        ...
        fun service(service: H3GeoHexCellServiceAsync) =
            apply {
    ...
    override fun toString() = "H3GeoHexCellListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
