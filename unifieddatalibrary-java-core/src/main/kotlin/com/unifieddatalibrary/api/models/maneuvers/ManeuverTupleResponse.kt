...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManeuverTupleResponse].
         *
    ...
    /** A builder for [ManeuverTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(maneuverTupleResponse: ManeuverTupleResponse) = apply {
            classificationMarking = maneuverTupleResponse.classificationMarking
            dataMode = maneuverTupleResponse.dataMode
            eventStartTime = maneuverTupleResponse.eventStartTime
            source = maneuverTupleResponse.source
            id = maneuverTupleResponse.id
            algorithm = maneuverTupleResponse.algorithm
            characterization = maneuverTupleResponse.characterization
            characterizationUnc = maneuverTupleResponse.characterizationUnc
            cov = maneuverTupleResponse.cov.map { it.toMutableList() }
            createdAt = maneuverTupleResponse.createdAt
            createdBy = maneuverTupleResponse.createdBy
            deltaMass = maneuverTupleResponse.deltaMass
            deltaPos = maneuverTupleResponse.deltaPos
            deltaPosU = maneuverTupleResponse.deltaPosU
            deltaPosV = maneuverTupleResponse.deltaPosV
            deltaPosW = maneuverTupleResponse.deltaPosW
            deltaVel = maneuverTupleResponse.deltaVel
            deltaVelU = maneuverTupleResponse.deltaVelU
            deltaVelV = maneuverTupleResponse.deltaVelV
            deltaVelW = maneuverTupleResponse.deltaVelW
            description = maneuverTupleResponse.description
            descriptor = maneuverTupleResponse.descriptor
            eventEndTime = maneuverTupleResponse.eventEndTime
            eventId = maneuverTupleResponse.eventId
            idOnOrbit = maneuverTupleResponse.idOnOrbit
            idSensor = maneuverTupleResponse.idSensor
            maneuverUnc = maneuverTupleResponse.maneuverUnc
            mnvrAccels = maneuverTupleResponse.mnvrAccels.map { it.toMutableList() }
            mnvrAccelTimes = maneuverTupleResponse.mnvrAccelTimes.map { it.toMutableList() }
            mnvrAccelUncs = maneuverTupleResponse.mnvrAccelUncs.map { it.toMutableList() }
            numAccelPoints = maneuverTupleResponse.numAccelPoints
            numObs = maneuverTupleResponse.numObs
            odFitEndTime = maneuverTupleResponse.odFitEndTime
            onOrbit = maneuverTupleResponse.onOrbit
            origin = maneuverTupleResponse.origin
            origNetwork = maneuverTupleResponse.origNetwork
            origObjectId = maneuverTupleResponse.origObjectId
            origSensorId = maneuverTupleResponse.origSensorId
            postApogee = maneuverTupleResponse.postApogee
            postArea = maneuverTupleResponse.postArea
            postBallisticCoeff = maneuverTupleResponse.postBallisticCoeff
            postDriftRate = maneuverTupleResponse.postDriftRate
            postEccentricity = maneuverTupleResponse.postEccentricity
            postEventElset = maneuverTupleResponse.postEventElset
            postEventIdElset = maneuverTupleResponse.postEventIdElset
            postEventIdStateVector = maneuverTupleResponse.postEventIdStateVector
            postEventStateVector = maneuverTupleResponse.postEventStateVector
            postGeoLongitude = maneuverTupleResponse.postGeoLongitude
            postInclination = maneuverTupleResponse.postInclination
            postMass = maneuverTupleResponse.postMass
            postPerigee = maneuverTupleResponse.postPerigee
            postPeriod = maneuverTupleResponse.postPeriod
            postPosX = maneuverTupleResponse.postPosX
            postPosY = maneuverTupleResponse.postPosY
            postPosZ = maneuverTupleResponse.postPosZ
            postRaan = maneuverTupleResponse.postRaan
            postRadiationPressCoeff = maneuverTupleResponse.postRadiationPressCoeff
            postSigmaU = maneuverTupleResponse.postSigmaU
            postSigmaV = maneuverTupleResponse.postSigmaV
            postSigmaW = maneuverTupleResponse.postSigmaW
            postSma = maneuverTupleResponse.postSma
            postVelX = maneuverTupleResponse.postVelX
            postVelY = maneuverTupleResponse.postVelY
            postVelZ = maneuverTupleResponse.postVelZ
            preApogee = maneuverTupleResponse.preApogee
            preBallisticCoeff = maneuverTupleResponse.preBallisticCoeff
            preDriftRate = maneuverTupleResponse.preDriftRate
            preEccentricity = maneuverTupleResponse.preEccentricity
            preEventElset = maneuverTupleResponse.preEventElset
            preEventIdElset = maneuverTupleResponse.preEventIdElset
            preEventIdStateVector = maneuverTupleResponse.preEventIdStateVector
            preEventStateVector = maneuverTupleResponse.preEventStateVector
            preGeoLongitude = maneuverTupleResponse.preGeoLongitude
            preInclination = maneuverTupleResponse.preInclination
            prePerigee = maneuverTupleResponse.prePerigee
            prePeriod = maneuverTupleResponse.prePeriod
            prePosX = maneuverTupleResponse.prePosX
            prePosY = maneuverTupleResponse.prePosY
            prePosZ = maneuverTupleResponse.prePosZ
            preRaan = maneuverTupleResponse.preRaan
            preRadiationPressCoeff = maneuverTupleResponse.preRadiationPressCoeff
            preSigmaU = maneuverTupleResponse.preSigmaU
            preSigmaV = maneuverTupleResponse.preSigmaV
            preSigmaW = maneuverTupleResponse.preSigmaW
            preSma = maneuverTupleResponse.preSma
            preVelX = maneuverTupleResponse.preVelX
            preVelY = maneuverTupleResponse.preVelY
            preVelZ = maneuverTupleResponse.preVelZ
            reportTime = maneuverTupleResponse.reportTime
            satNo = maneuverTupleResponse.satNo
            sourcedData = maneuverTupleResponse.sourcedData.map { it.toMutableList() }
            sourcedDataTypes = maneuverTupleResponse.sourcedDataTypes.map { it.toMutableList() }
            stateModel = maneuverTupleResponse.stateModel
            stateModelVersion = maneuverTupleResponse.stateModelVersion
            status = maneuverTupleResponse.status
            tags = maneuverTupleResponse.tags.map { it.toMutableList() }
            totalBurnTime = maneuverTupleResponse.totalBurnTime
            transactionId = maneuverTupleResponse.transactionId
            uct = maneuverTupleResponse.uct
            additionalProperties = maneuverTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ManeuverTupleResponse].
         *
         ...
         */
        fun build(): ManeuverTupleResponse =
    ...
    fun validate(): ManeuverTupleResponse = apply {
        if (validated) {
            return@apply
        }
