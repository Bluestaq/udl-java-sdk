...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationListResponse: OrganizationListResponse) = apply {
            classificationMarking = organizationListResponse.classificationMarking
            dataMode = organizationListResponse.dataMode
            name = organizationListResponse.name
            source = organizationListResponse.source
            type = organizationListResponse.type
            id = organizationListResponse.id
            active = organizationListResponse.active
            category = organizationListResponse.category
            countryCode = organizationListResponse.countryCode
            createdAt = organizationListResponse.createdAt
            createdBy = organizationListResponse.createdBy
            description = organizationListResponse.description
            externalId = organizationListResponse.externalId
            nationality = organizationListResponse.nationality
            origin = organizationListResponse.origin
            origNetwork = organizationListResponse.origNetwork
