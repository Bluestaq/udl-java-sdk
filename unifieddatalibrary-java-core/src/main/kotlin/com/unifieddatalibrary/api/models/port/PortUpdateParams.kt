...
class PortUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portUpdateParams: PortUpdateParams) =
            apply {
        ...
        /** The size of the harbor for this port measured in square kilometers. */
        fun harborSize(harborSize: Double) =
            apply {
                body.harborSize(harborSize)
            }
         ...
         * TYPHOON HARBOR (TH).
         */
        fun harborType(harborType: String) =
            apply {
                body.harborType(harborType)
            }
        ...
        /** Flag indicating whether a pilot is required at this port. */
        fun pilotReqd(pilotReqd: Boolean) =
            apply {
                body.pilotReqd(pilotReqd)
            }
        ...
        /** The tide range of this port in meters. */
        fun tideRange(tideRange: Double) =
            apply {
                body.tideRange(tideRange)
            }
    ...
    override fun toString() = "PortUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
