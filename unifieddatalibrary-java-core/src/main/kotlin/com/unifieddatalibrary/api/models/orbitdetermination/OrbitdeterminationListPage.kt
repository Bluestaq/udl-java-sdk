...
class OrbitdeterminationListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationListPage: OrbitdeterminationListPage) =
            apply {
        ...
        fun service(service: OrbitdeterminationService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbitdeterminationListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, params, items) /* spotless:on */

    override fun toString() = "OrbitdeterminationListPage{service=$service, params=$params, items=$items}"
}
