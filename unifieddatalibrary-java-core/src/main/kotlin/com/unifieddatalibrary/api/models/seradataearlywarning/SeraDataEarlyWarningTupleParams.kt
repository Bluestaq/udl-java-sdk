...
class SeraDataEarlyWarningTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeraDataEarlyWarningTupleParams].
         *
    ...
    /** A builder for [SeraDataEarlyWarningTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningTupleParams: SeraDataEarlyWarningTupleParams) =
            apply {
                columns = seraDataEarlyWarningTupleParams.columns
                firstResult = seraDataEarlyWarningTupleParams.firstResult
                maxResults = seraDataEarlyWarningTupleParams.maxResults
                additionalHeaders = seraDataEarlyWarningTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = seraDataEarlyWarningTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeraDataEarlyWarningTupleParams].
         *
         ...
         */
        fun build(): SeraDataEarlyWarningTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeraDataEarlyWarningTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SeraDataEarlyWarningTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
