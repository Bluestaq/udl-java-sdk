...
/**
 * Service operation to take a list of Personnel Recovery records as a POST body and ingest into the
 ...
 */
class PersonnelrecoveryFileCreateParams
private constructor(
    ...
    /** A builder for [PersonnelrecoveryFileCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(personnelrecoveryFileCreateParams: PersonnelrecoveryFileCreateParams) =
            apply {
                body = personnelrecoveryFileCreateParams.body.toMutableList()
                additionalHeaders = personnelrecoveryFileCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    personnelrecoveryFileCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PersonnelrecoveryFileCreateParams].
         *
         ...
         */
        fun build(): PersonnelrecoveryFileCreateParams =
            PersonnelrecoveryFileCreateParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PersonnelrecoveryFileCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "PersonnelrecoveryFileCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
