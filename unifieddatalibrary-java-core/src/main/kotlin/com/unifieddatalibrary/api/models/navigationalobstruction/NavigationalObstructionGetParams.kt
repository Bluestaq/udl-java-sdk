...
/**
 * Service operation to get a single navigational obstruction record by its unique ID passed as a
 * path parameter.
 */
class NavigationalObstructionGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NavigationalObstructionGetParams = builder().build()
    ...
    /** A builder for [NavigationalObstructionGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationalObstructionGetParams: NavigationalObstructionGetParams) =
            apply {
                id = navigationalObstructionGetParams.id
                firstResult = navigationalObstructionGetParams.firstResult
                maxResults = navigationalObstructionGetParams.maxResults
                additionalHeaders = navigationalObstructionGetParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    navigationalObstructionGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [NavigationalObstructionGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NavigationalObstructionGetParams =
            NavigationalObstructionGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NavigationalObstructionGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "NavigationalObstructionGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
