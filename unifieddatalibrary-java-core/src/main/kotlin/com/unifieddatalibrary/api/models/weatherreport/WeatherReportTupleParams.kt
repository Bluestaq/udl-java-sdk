 ...
 */
class WeatherReportTupleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WeatherReportTupleParams].
         *
    ...
    /** A builder for [WeatherReportTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherReportTupleParams: WeatherReportTupleParams) = apply {
            columns = weatherReportTupleParams.columns
            obTime = weatherReportTupleParams.obTime
            firstResult = weatherReportTupleParams.firstResult
            maxResults = weatherReportTupleParams.maxResults
            additionalHeaders = weatherReportTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = weatherReportTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WeatherReportTupleParams].
         *
         ...
         */
        fun build(): WeatherReportTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WeatherReportTupleParams && columns == other.columns && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "WeatherReportTupleParams{columns=$columns, obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
