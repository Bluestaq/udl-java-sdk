 ...
 */
class AviationRiskManagementQueryResponse
private constructor(
    ...
    /** A builder for [AviationRiskManagementQueryResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            aviationRiskManagementQueryResponse: AviationRiskManagementQueryResponse
        ) = apply {
            classificationMarking = aviationRiskManagementQueryResponse.classificationMarking
            dataMode = aviationRiskManagementQueryResponse.dataMode
            idMission = aviationRiskManagementQueryResponse.idMission
            source = aviationRiskManagementQueryResponse.source
            id = aviationRiskManagementQueryResponse.id
            aviationRiskManagementWorksheetRecord =
                aviationRiskManagementQueryResponse.aviationRiskManagementWorksheetRecord.map {
                    it.toMutableList()
                }
            createdAt = aviationRiskManagementQueryResponse.createdAt
            createdBy = aviationRiskManagementQueryResponse.createdBy
            extMissionId = aviationRiskManagementQueryResponse.extMissionId
            missionNumber = aviationRiskManagementQueryResponse.missionNumber
            orgId = aviationRiskManagementQueryResponse.orgId
            origin = aviationRiskManagementQueryResponse.origin
            origNetwork = aviationRiskManagementQueryResponse.origNetwork
            sourceDl = aviationRiskManagementQueryResponse.sourceDl
            unitId = aviationRiskManagementQueryResponse.unitId
            updatedAt = aviationRiskManagementQueryResponse.updatedAt
            updatedBy = aviationRiskManagementQueryResponse.updatedBy
            additionalProperties =
                aviationRiskManagementQueryResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AviationRiskManagementQueryResponse].
         *
         ...
         */
        fun build(): AviationRiskManagementQueryResponse =
            AviationRiskManagementQueryResponse(
    ...
    fun validate(): AviationRiskManagementQueryResponse = apply {
        if (validated) {
            return@apply
        }
