...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RouteStatListResponse].
         *
    ...
    /** A builder for [RouteStatListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatListResponse: RouteStatListResponse) = apply {
            classificationMarking = routeStatListResponse.classificationMarking
            dataMode = routeStatListResponse.dataMode
            locationEnd = routeStatListResponse.locationEnd
            locationStart = routeStatListResponse.locationStart
            source = routeStatListResponse.source
            id = routeStatListResponse.id
            avgDuration = routeStatListResponse.avgDuration
            avgSpeed = routeStatListResponse.avgSpeed
            createdAt = routeStatListResponse.createdAt
            createdBy = routeStatListResponse.createdBy
            dataPtsUsed = routeStatListResponse.dataPtsUsed
            distance = routeStatListResponse.distance
            distUnit = routeStatListResponse.distUnit
            firstPt = routeStatListResponse.firstPt
            idealDesc = routeStatListResponse.idealDesc
            idealDuration = routeStatListResponse.idealDuration
            idSiteEnd = routeStatListResponse.idSiteEnd
            idSiteStart = routeStatListResponse.idSiteStart
            lastPt = routeStatListResponse.lastPt
            locationType = routeStatListResponse.locationType
            maxDuration = routeStatListResponse.maxDuration
            maxSpeed = routeStatListResponse.maxSpeed
            minDuration = routeStatListResponse.minDuration
            minSpeed = routeStatListResponse.minSpeed
            origin = routeStatListResponse.origin
            origNetwork = routeStatListResponse.origNetwork
            partialDesc = routeStatListResponse.partialDesc
            partialDuration = routeStatListResponse.partialDuration
            sourceDl = routeStatListResponse.sourceDl
            speedUnit = routeStatListResponse.speedUnit
            timePeriod = routeStatListResponse.timePeriod
            vehicleCategory = routeStatListResponse.vehicleCategory
            vehicleType = routeStatListResponse.vehicleType
            additionalProperties = routeStatListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RouteStatListResponse].
         *
         ...
         */
        fun build(): RouteStatListResponse =
    ...
    fun validate(): RouteStatListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteStatListResponse &&
