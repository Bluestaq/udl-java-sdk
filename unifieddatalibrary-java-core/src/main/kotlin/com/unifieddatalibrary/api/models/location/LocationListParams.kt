...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LocationListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(locationListParams: LocationListParams) = apply {
            firstResult = locationListParams.firstResult
            maxResults = locationListParams.maxResults
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LocationListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LocationListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
