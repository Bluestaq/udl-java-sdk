...
class AntennaTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AntennaTupleParams].
         *
    ...
    /** A builder for [AntennaTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaTupleParams: AntennaTupleParams) =
            apply {
                columns = antennaTupleParams.columns
                firstResult = antennaTupleParams.firstResult
                maxResults = antennaTupleParams.maxResults
                additionalHeaders = antennaTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = antennaTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AntennaTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AntennaTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AntennaTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
