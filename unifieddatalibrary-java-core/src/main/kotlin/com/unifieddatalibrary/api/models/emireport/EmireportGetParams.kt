...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EmireportGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EmireportGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EmireportGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportGetParams: EmireportGetParams) = apply {
            id = emireportGetParams.id
            firstResult = emireportGetParams.firstResult
            maxResults = emireportGetParams.maxResults
            additionalHeaders = emireportGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = emireportGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EmireportGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EmireportGetParams =
            EmireportGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportGetParams &&
            id == other.id &&
    ...
    override fun toString() =
        "EmireportGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
