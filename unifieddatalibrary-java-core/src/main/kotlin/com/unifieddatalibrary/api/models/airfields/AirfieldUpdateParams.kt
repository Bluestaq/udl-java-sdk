...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldUpdateParams: AirfieldUpdateParams) = apply {
        ...
        /** Alternative names for this airfield. */
        fun alternativeNames(alternativeNames: List<String>) = apply {
         ...
         * of this airfield.
         */
        fun dstInfo(dstInfo: String) = apply { body.dstInfo(dstInfo) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dstInfo(dstInfo: JsonField<String>) = apply { body.dstInfo(dstInfo) }
         ...
         */
        fun elevFt(elevFt: Double) = apply { body.elevFt(elevFt) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun elevFt(elevFt: JsonField<Double>) = apply { body.elevFt(elevFt) }
         ...
         * provider. The provider/consumer is responsible for all unit conversions.
         */
        fun elevM(elevM: Double) = apply { body.elevM(elevM) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun elevM(elevM: JsonField<Double>) = apply { body.elevM(elevM) }
         ...
         */
        fun gmtOffset(gmtOffset: String) = apply { body.gmtOffset(gmtOffset) }
         ...
         * value.
         */
        fun gmtOffset(gmtOffset: JsonField<String>) = apply { body.gmtOffset(gmtOffset) }

        /** The host nation code of this airfield, used for non-DoD/FAA locations. */
        fun hostNatCode(hostNatCode: String) = apply { body.hostNatCode(hostNatCode) }
         ...
         * value.
         */
        fun hostNatCode(hostNatCode: JsonField<String>) = apply { body.hostNatCode(hostNatCode) }
        ...
        /** The URL link to information about airfield. */
        fun infoUrl(infoUrl: String) = apply { body.infoUrl(infoUrl) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun infoUrl(infoUrl: JsonField<String>) = apply { body.infoUrl(infoUrl) }
         ...
         */
        fun magDec(magDec: Double) = apply { body.magDec(magDec) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun magDec(magDec: JsonField<Double>) = apply { body.magDec(magDec) }
         ...
         */
        fun miscCodes(miscCodes: String) = apply { body.miscCodes(miscCodes) }
         ...
         * value.
         */
        fun miscCodes(miscCodes: JsonField<String>) = apply { body.miscCodes(miscCodes) }
        ...
        /** The regional authority of the airfield. */
        fun regionalAuthority(regionalAuthority: String) = apply {
        ...
        /** The number of runways at the site. */
        fun runways(runways: Int) = apply { body.runways(runways) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun runways(runways: JsonField<Int>) = apply { body.runways(runways) }
         ...
         * operations.
         */
        fun secondaryIcao(secondaryIcao: String) = apply { body.secondaryIcao(secondaryIcao) }
         ...
         */
        fun stateProvinceCode(stateProvinceCode: String) = apply {
         ...
         */
        fun suitabilityCodeDescs(suitabilityCodeDescs: List<String>) = apply {
         ...
         * Report (ASRR) for this airfield.
         */
        fun suitabilityCodes(suitabilityCodes: String) = apply {
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            miscCodes: JsonField<String> = JsonMissing.of(),
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun regionalAuthority(): Optional<String> =
            regionalAuthority.getOptional("regionalAuthority")
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun stateProvinceCode(): Optional<String> =
            stateProvinceCode.getOptional("stateProvinceCode")
         ...
         * Returns the raw JSON value of [secondaryIcao].
         *
         * Unlike [secondaryIcao], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("secondaryICAO")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [suitabilityCodeDescs].
         *
         * Unlike [suitabilityCodeDescs], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("suitabilityCodeDescs")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.alternativeNames] to an arbitrary JSON value.
             *
             * You should usually call [Builder.alternativeNames] with a well-typed `List<String>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun alternativeNames(alternativeNames: JsonField<List<String>>) = apply {
             ...
             * Sets [Builder.dstInfo] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dstInfo] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.elevFt] to an arbitrary JSON value.
             *
             * You should usually call [Builder.elevFt] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.elevM] to an arbitrary JSON value.
             *
             * You should usually call [Builder.elevM] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * (GMT), expressed as +/-HH:MM. Time zones east of Greenwich have positive offsets and
             * time zones west of Greenwich are negative.
             */
             ...
             * Sets [Builder.hostNatCode] to an arbitrary JSON value.
             *
             * You should usually call [Builder.hostNatCode] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun hostNatCode(hostNatCode: JsonField<String>) = apply {
             ...
             * Sets [Builder.infoUrl] to an arbitrary JSON value.
             *
             * You should usually call [Builder.infoUrl] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The secondary ICAO code for this airfield. Some airfields have two associated ICAO
             * codes, this can occur in cases when a single airfield supports both military and
             * civilian operations.
             */
             ...
             * Sets [Builder.secondaryIcao] to an arbitrary JSON value.
             *
             * You should usually call [Builder.secondaryIcao] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun secondaryIcao(secondaryIcao: JsonField<String>) = apply {
            ...
            /**
             * The code for the state or province in which this airfield is located. Intended as,
             * but not constrained to, FIPS 10-4 region code designations.
             */
             ...
             * Sets [Builder.suitabilityCodeDescs] to an arbitrary JSON value.
             *
             * You should usually call [Builder.suitabilityCodeDescs] with a well-typed
    ...
    override fun toString() =
        "AirfieldUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
