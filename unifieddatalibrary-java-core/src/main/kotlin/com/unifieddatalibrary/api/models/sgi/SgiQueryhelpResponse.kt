...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SgiQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SgiQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sgiQueryhelpResponse: SgiQueryhelpResponse) = apply {
            aodrSupported = sgiQueryhelpResponse.aodrSupported
            classificationMarking = sgiQueryhelpResponse.classificationMarking
            description = sgiQueryhelpResponse.description
            historySupported = sgiQueryhelpResponse.historySupported
            name = sgiQueryhelpResponse.name
            parameters = sgiQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = sgiQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = sgiQueryhelpResponse.restSupported
            sortSupported = sgiQueryhelpResponse.sortSupported
            typeName = sgiQueryhelpResponse.typeName
            uri = sgiQueryhelpResponse.uri
            additionalProperties = sgiQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SgiQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SgiQueryhelpResponse =
    ...
    fun validate(): SgiQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SgiQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
