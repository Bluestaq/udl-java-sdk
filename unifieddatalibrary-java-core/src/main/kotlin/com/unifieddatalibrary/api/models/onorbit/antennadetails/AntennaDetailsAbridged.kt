...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaDetailsAbridged: AntennaDetailsAbridged) = apply {
    ...
    fun validate(): AntennaDetailsAbridged = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AntennaDetailsAbridged &&
    ...
    override fun toString() =
        "AntennaDetailsAbridged{classificationMarking=$classificationMarking, dataMode=$dataMode, idAntenna=$idAntenna, source=$source, id=$id, beamForming=$beamForming, beamwidth=$beamwidth, createdAt=$createdAt, createdBy=$createdBy, description=$description, diameter=$diameter, endFrequency=$endFrequency, gain=$gain, gainTolerance=$gainTolerance, manufacturerOrgId=$manufacturerOrgId, mode=$mode, origin=$origin, origNetwork=$origNetwork, polarization=$polarization, position=$position, size=$size, startFrequency=$startFrequency, steerable=$steerable, type=$type, additionalProperties=$additionalProperties}"
}
