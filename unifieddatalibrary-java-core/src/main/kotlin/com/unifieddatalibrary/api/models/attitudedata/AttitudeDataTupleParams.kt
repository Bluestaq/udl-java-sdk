 ...
 */
class AttitudeDataTupleParams
private constructor(
    private val asId: String,
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AttitudeDataTupleParams].
         *
    ...
    /** A builder for [AttitudeDataTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeDataTupleParams: AttitudeDataTupleParams) = apply {
            asId = attitudeDataTupleParams.asId
            columns = attitudeDataTupleParams.columns
            firstResult = attitudeDataTupleParams.firstResult
            maxResults = attitudeDataTupleParams.maxResults
            additionalHeaders = attitudeDataTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = attitudeDataTupleParams.additionalQueryParams.toBuilder()
        }

        /** Unique identifier of the parent AttitudeSet associated with this record. (uuid) */
        fun asId(asId: String) = apply { this.asId = asId }
        ...
        /**
         * Returns an immutable instance of [AttitudeDataTupleParams].
         *
         ...
         */
        fun build(): AttitudeDataTupleParams =
            AttitudeDataTupleParams(
                checkRequired("asId", asId),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AttitudeDataTupleParams && asId == other.asId && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(asId, columns, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AttitudeDataTupleParams{asId=$asId, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
