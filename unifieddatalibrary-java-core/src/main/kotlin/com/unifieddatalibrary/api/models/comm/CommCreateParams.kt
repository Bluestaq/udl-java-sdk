...
/**
 * Service operation to take a single Comm as a POST body and ingest into the database. A Comm is an
 * on-orbit communications payload, including supporting data such as transponders and channels,
 * etc. A specific role is required to perform this service operation. Please contact the UDL team
 * for assistance.
 */
class CommCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommCreateParams].
         *
    ...
    /** A builder for [CommCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commCreateParams: CommCreateParams) = apply {
            body = commCreateParams.body.toBuilder()
            additionalHeaders = commCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = commCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CommCreateParams].
         *
         ...
         */
        fun build(): CommCreateParams =
            CommCreateParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    /**
     * Comm represents communications entities (e.g. on-orbit communications satellite payloads)
     * within the SSA environment.
     */
    class Body
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, description=$description, entity=$entity, idEntity=$idEntity, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CommCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CommCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
