 ...
 */
class IsrCollectionCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsrCollectionCountParams].
         *
    ...
    /** A builder for [IsrCollectionCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isrCollectionCountParams: IsrCollectionCountParams) = apply {
            createdAt = isrCollectionCountParams.createdAt
            firstResult = isrCollectionCountParams.firstResult
            maxResults = isrCollectionCountParams.maxResults
            additionalHeaders = isrCollectionCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = isrCollectionCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IsrCollectionCountParams].
         *
         ...
         */
        fun build(): IsrCollectionCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IsrCollectionCountParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "IsrCollectionCountParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
