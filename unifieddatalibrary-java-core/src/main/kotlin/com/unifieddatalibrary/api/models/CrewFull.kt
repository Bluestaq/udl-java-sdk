...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CrewFull].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crewFull: CrewFull) = apply {
            classificationMarking = crewFull.classificationMarking
            dataMode = crewFull.dataMode
            origCrewId = crewFull.origCrewId
            source = crewFull.source
            id = crewFull.id
            adjReturnTime = crewFull.adjReturnTime
            adjReturnTimeApprover = crewFull.adjReturnTimeApprover
            aircraftMds = crewFull.aircraftMds
            alertedTime = crewFull.alertedTime
            alertType = crewFull.alertType
            armsCrewUnit = crewFull.armsCrewUnit
            assignedQualCode = crewFull.assignedQualCode.map { it.toMutableList() }
            commanderId = crewFull.commanderId
            commanderLast4Ssn = crewFull.commanderLast4Ssn
            commanderName = crewFull.commanderName
            createdAt = crewFull.createdAt
            createdBy = crewFull.createdBy
            crewHome = crewFull.crewHome
            crewMembers = crewFull.crewMembers.map { it.toMutableList() }
            crewName = crewFull.crewName
            crewRms = crewFull.crewRms
            crewRole = crewFull.crewRole
            crewSource = crewFull.crewSource
            crewSquadron = crewFull.crewSquadron
            crewType = crewFull.crewType
            crewUnit = crewFull.crewUnit
            crewWing = crewFull.crewWing
            currentIcao = crewFull.currentIcao
            fdpEligType = crewFull.fdpEligType
            fdpType = crewFull.fdpType
            femaleEnlistedQty = crewFull.femaleEnlistedQty
            femaleOfficerQty = crewFull.femaleOfficerQty
            fltAuthNum = crewFull.fltAuthNum
            idSiteCurrent = crewFull.idSiteCurrent
            idSortie = crewFull.idSortie
            initStartTime = crewFull.initStartTime
            lastAlertTime = crewFull.lastAlertTime
            legalAlertTime = crewFull.legalAlertTime
            legalBravoTime = crewFull.legalBravoTime
            linkedTask = crewFull.linkedTask
            maleEnlistedQty = crewFull.maleEnlistedQty
            maleOfficerQty = crewFull.maleOfficerQty
            missionAlias = crewFull.missionAlias
            missionId = crewFull.missionId
            origin = crewFull.origin
            origNetwork = crewFull.origNetwork
            personnelType = crewFull.personnelType
            pickupTime = crewFull.pickupTime
            postRestApplied = crewFull.postRestApplied
            postRestEnd = crewFull.postRestEnd
            postRestOffset = crewFull.postRestOffset
            preRestApplied = crewFull.preRestApplied
            preRestStart = crewFull.preRestStart
            reqQualCode = crewFull.reqQualCode.map { it.toMutableList() }
            returnTime = crewFull.returnTime
            sourceDl = crewFull.sourceDl
            stage1Qual = crewFull.stage1Qual
            stage2Qual = crewFull.stage2Qual
            stage3Qual = crewFull.stage3Qual
            stageName = crewFull.stageName
            stageTime = crewFull.stageTime
            status = crewFull.status
            transportReq = crewFull.transportReq
            tripKit = crewFull.tripKit
            updatedAt = crewFull.updatedAt
            updatedBy = crewFull.updatedBy
            additionalProperties = crewFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CrewFull].
         *
