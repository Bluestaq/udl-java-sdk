 ...
 */
class OnorbitthrusterListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitthrusterListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterListParams: OnorbitthrusterListParams) = apply {
    ...
    override fun toString() =
        "OnorbitthrusterListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
