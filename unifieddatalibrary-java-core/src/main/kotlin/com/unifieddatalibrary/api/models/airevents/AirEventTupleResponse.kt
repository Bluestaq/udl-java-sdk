...
class AirEventTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventTupleResponse: AirEventTupleResponse) =
            apply {
    ...
    fun validate(): AirEventTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "AirEventTupleResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, type=$type, id=$id, actualArrTime=$actualArrTime, actualDepTime=$actualDepTime, arct=$arct, arEventType=$arEventType, arrPurpose=$arrPurpose, arTrackId=$arTrackId, arTrackName=$arTrackName, baseAlt=$baseAlt, cancelled=$cancelled, createdAt=$createdAt, createdBy=$createdBy, depPurpose=$depPurpose, estArrTime=$estArrTime, estDepTime=$estDepTime, externalAirEventId=$externalAirEventId, externalArTrackId=$externalArTrackId, idMission=$idMission, idSortie=$idSortie, legNum=$legNum, location=$location, numTankers=$numTankers, origin=$origin, origNetwork=$origNetwork, plannedArrTime=$plannedArrTime, plannedDepTime=$plannedDepTime, priority=$priority, receivers=$receivers, remarks=$remarks, revTrack=$revTrack, rzct=$rzct, rzPoint=$rzPoint, rzType=$rzType, shortTrack=$shortTrack, sourceDl=$sourceDl, statusCode=$statusCode, tankers=$tankers, trackTime=$trackTime, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
