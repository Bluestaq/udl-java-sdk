...
class GroundImageryListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<GroundImageryListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryListPageAsync: GroundImageryListPageAsync) =
            apply {
        ...
        fun service(service: GroundImageryServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: GroundImageryListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<GroundImageryListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GroundImageryListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, streamHandlerExecutor, params, items) /* spotless:on */

    override fun toString() = "GroundImageryListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
