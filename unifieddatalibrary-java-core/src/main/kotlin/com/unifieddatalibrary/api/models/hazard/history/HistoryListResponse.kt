...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            alarms = historyListResponse.alarms.map { it.toMutableList() }
            alarmValues = historyListResponse.alarmValues.map { it.toMutableList() }
            classificationMarking = historyListResponse.classificationMarking
            dataMode = historyListResponse.dataMode
            detectTime = historyListResponse.detectTime
            detectType = historyListResponse.detectType
            source = historyListResponse.source
            id = historyListResponse.id
            a = historyListResponse.a
            activity = historyListResponse.activity
            bottleId = historyListResponse.bottleId
            casRn = historyListResponse.casRn
            channel = historyListResponse.channel
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            ctrnTime = historyListResponse.ctrnTime
            density = historyListResponse.density
            dep = historyListResponse.dep
            depCtrn = historyListResponse.depCtrn
            dose = historyListResponse.dose
            doseRate = historyListResponse.doseRate
            duration = historyListResponse.duration
            gBar = historyListResponse.gBar
            harmful = historyListResponse.harmful
            hBar = historyListResponse.hBar
            idPoi = historyListResponse.idPoi
            idTrack = historyListResponse.idTrack
            massFrac = historyListResponse.massFrac
            matCat = historyListResponse.matCat
            matClass = historyListResponse.matClass
            matName = historyListResponse.matName
            matType = historyListResponse.matType
            origin = historyListResponse.origin
            origNetwork = historyListResponse.origNetwork
            ppm = historyListResponse.ppm
            radCtrn = historyListResponse.radCtrn
            readings = historyListResponse.readings.map { it.toMutableList() }
            readingUnits = historyListResponse.readingUnits.map { it.toMutableList() }
            readingValues = historyListResponse.readingValues.map { it.toMutableList() }
            z = historyListResponse.z
