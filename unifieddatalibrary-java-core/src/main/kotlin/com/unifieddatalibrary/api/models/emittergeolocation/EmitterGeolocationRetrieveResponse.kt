...
class EmitterGeolocationRetrieveResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmitterGeolocationRetrieveResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emitterGeolocationRetrieveResponse: EmitterGeolocationRetrieveResponse) =
            apply {
                ...
                additionalProperties = emitterGeolocationRetrieveResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): EmitterGeolocationRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
