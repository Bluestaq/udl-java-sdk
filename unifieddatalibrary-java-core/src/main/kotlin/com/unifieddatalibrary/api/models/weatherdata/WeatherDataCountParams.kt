...
class WeatherDataCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WeatherDataCountParams].
         *
    ...
    /** A builder for [WeatherDataCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataCountParams: WeatherDataCountParams) =
            apply {
                obTime = weatherDataCountParams.obTime
                firstResult = weatherDataCountParams.firstResult
                maxResults = weatherDataCountParams.maxResults
                additionalHeaders = weatherDataCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = weatherDataCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [WeatherDataCountParams].
         *
         ...
         */
        fun build(): WeatherDataCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is WeatherDataCountParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "WeatherDataCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
