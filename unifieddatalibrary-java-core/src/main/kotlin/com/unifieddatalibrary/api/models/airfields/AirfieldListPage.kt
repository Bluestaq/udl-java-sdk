...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldListPage: AirfieldListPage) = apply {
            service = airfieldListPage.service
            params = airfieldListPage.params
            items = airfieldListPage.items
        }

        fun service(service: AirfieldService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AirfieldListPage &&
