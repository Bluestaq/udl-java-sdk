...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfBandListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandListParams: RfBandListParams) = apply {
    ...
    override fun toString() =
        "RfBandListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
