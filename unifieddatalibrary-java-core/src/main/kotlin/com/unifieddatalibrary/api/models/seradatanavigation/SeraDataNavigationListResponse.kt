...
class SeraDataNavigationListResponse
private constructor(
    ...
    /** A builder for [SeraDataNavigationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataNavigationListResponse: SeraDataNavigationListResponse) = apply {
            classificationMarking = seraDataNavigationListResponse.classificationMarking
            dataMode = seraDataNavigationListResponse.dataMode
            source = seraDataNavigationListResponse.source
            spacecraftId = seraDataNavigationListResponse.spacecraftId
            id = seraDataNavigationListResponse.id
            areaCoverage = seraDataNavigationListResponse.areaCoverage
            clockType = seraDataNavigationListResponse.clockType
            createdAt = seraDataNavigationListResponse.createdAt
            createdBy = seraDataNavigationListResponse.createdBy
            hostedForCompanyOrgId = seraDataNavigationListResponse.hostedForCompanyOrgId
            idNavigation = seraDataNavigationListResponse.idNavigation
            locationAccuracy = seraDataNavigationListResponse.locationAccuracy
            manufacturerOrgId = seraDataNavigationListResponse.manufacturerOrgId
            modeFrequency = seraDataNavigationListResponse.modeFrequency
            modes = seraDataNavigationListResponse.modes
            name = seraDataNavigationListResponse.name
            notes = seraDataNavigationListResponse.notes
            origin = seraDataNavigationListResponse.origin
            origNetwork = seraDataNavigationListResponse.origNetwork
            partnerSpacecraftId = seraDataNavigationListResponse.partnerSpacecraftId
            payloadType = seraDataNavigationListResponse.payloadType
            additionalProperties =
                seraDataNavigationListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataNavigationListResponse].
         *
         ...
         */
        fun build(): SeraDataNavigationListResponse =
            SeraDataNavigationListResponse(
    ...
    fun validate(): SeraDataNavigationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SeraDataNavigationListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, spacecraftId=$spacecraftId, id=$id, areaCoverage=$areaCoverage, clockType=$clockType, createdAt=$createdAt, createdBy=$createdBy, hostedForCompanyOrgId=$hostedForCompanyOrgId, idNavigation=$idNavigation, locationAccuracy=$locationAccuracy, manufacturerOrgId=$manufacturerOrgId, modeFrequency=$modeFrequency, modes=$modes, name=$name, notes=$notes, origin=$origin, origNetwork=$origNetwork, partnerSpacecraftId=$partnerSpacecraftId, payloadType=$payloadType, additionalProperties=$additionalProperties}"
}
