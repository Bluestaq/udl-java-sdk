...
class TrackDetailListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailListPage: TrackDetailListPage) =
            apply {
        ...
        fun service(service: TrackDetailService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is TrackDetailListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }
