...
class DriftHistoryQueryhelpResponse
private constructor(
    ...
    /** A builder for [DriftHistoryQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(driftHistoryQueryhelpResponse: DriftHistoryQueryhelpResponse) = apply {
            aodrSupported = driftHistoryQueryhelpResponse.aodrSupported
            classificationMarking = driftHistoryQueryhelpResponse.classificationMarking
            description = driftHistoryQueryhelpResponse.description
            historySupported = driftHistoryQueryhelpResponse.historySupported
            name = driftHistoryQueryhelpResponse.name
            parameters = driftHistoryQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = driftHistoryQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = driftHistoryQueryhelpResponse.restSupported
            sortSupported = driftHistoryQueryhelpResponse.sortSupported
            typeName = driftHistoryQueryhelpResponse.typeName
            uri = driftHistoryQueryhelpResponse.uri
            additionalProperties = driftHistoryQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DriftHistoryQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DriftHistoryQueryhelpResponse =
            DriftHistoryQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): DriftHistoryQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DriftHistoryQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
