...
class SensorObservationTypeListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<SensorObservationTypeListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorObservationTypeListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        fun service(service: SensorObservationTypeServiceAsync) =
            apply {
    ...
    override fun toString() = "SensorObservationTypeListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
