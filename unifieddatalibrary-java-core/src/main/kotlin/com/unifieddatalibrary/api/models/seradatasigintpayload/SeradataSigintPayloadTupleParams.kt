...
class SeradataSigintPayloadTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataSigintPayloadTupleParams].
         *
    ...
    /** A builder for [SeradataSigintPayloadTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataSigintPayloadTupleParams: SeradataSigintPayloadTupleParams) =
            apply {
                columns = seradataSigintPayloadTupleParams.columns
                firstResult = seradataSigintPayloadTupleParams.firstResult
                maxResults = seradataSigintPayloadTupleParams.maxResults
                additionalHeaders = seradataSigintPayloadTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = seradataSigintPayloadTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataSigintPayloadTupleParams].
         *
         ...
         */
        fun build(): SeradataSigintPayloadTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataSigintPayloadTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SeradataSigintPayloadTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
