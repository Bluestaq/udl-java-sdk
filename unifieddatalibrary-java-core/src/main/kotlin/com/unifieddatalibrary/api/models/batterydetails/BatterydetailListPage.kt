...
class BatterydetailListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batterydetailListPage: BatterydetailListPage) =
            apply {
        ...
        fun service(service: BatterydetailService) =
            apply {
    ...
    override fun toString() = "BatterydetailListPage{service=$service, params=$params, items=$items}"
}
