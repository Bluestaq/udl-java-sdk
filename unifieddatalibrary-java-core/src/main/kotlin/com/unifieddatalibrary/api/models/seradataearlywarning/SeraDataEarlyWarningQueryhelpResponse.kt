...
class SeraDataEarlyWarningQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SeraDataEarlyWarningQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SeraDataEarlyWarningQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningQueryhelpResponse: SeraDataEarlyWarningQueryhelpResponse) =
            apply {
                aodrSupported = seraDataEarlyWarningQueryhelpResponse.aodrSupported
                classificationMarking = seraDataEarlyWarningQueryhelpResponse.classificationMarking
                description = seraDataEarlyWarningQueryhelpResponse.description
                historySupported = seraDataEarlyWarningQueryhelpResponse.historySupported
                name = seraDataEarlyWarningQueryhelpResponse.name
                parameters = seraDataEarlyWarningQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = seraDataEarlyWarningQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = seraDataEarlyWarningQueryhelpResponse.restSupported
                sortSupported = seraDataEarlyWarningQueryhelpResponse.sortSupported
                typeName = seraDataEarlyWarningQueryhelpResponse.typeName
                uri = seraDataEarlyWarningQueryhelpResponse.uri
                additionalProperties = seraDataEarlyWarningQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeraDataEarlyWarningQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeraDataEarlyWarningQueryhelpResponse =
    ...
    fun validate(): SeraDataEarlyWarningQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeraDataEarlyWarningQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
