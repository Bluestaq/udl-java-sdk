...
class SeraDataEarlyWarningQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seraDataEarlyWarningQueryhelpResponse: SeraDataEarlyWarningQueryhelpResponse
        ) = apply {
            ...
            requiredRoles =
                seraDataEarlyWarningQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                seraDataEarlyWarningQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): SeraDataEarlyWarningQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
