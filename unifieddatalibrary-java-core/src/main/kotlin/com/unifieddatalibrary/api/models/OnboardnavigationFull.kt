 ...
 * Navigational points are provided in kilometers and in a user specified reference frame, with ECI
 * J2K being preferred.
 */
...
private constructor(
    ...
    /**
     * Unique identifier of the parent EphemerisSet, if this data is correlated with an Ephemeris.
     * If multiple nav sensor records are required, this ID may be associated with each of those
     * records if each is synced to the ephemeris points.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Arrays of spacecraft position (X, Y, Z), in km, in the specified referenceFrame, based on the
     * onboard magnetometer, at each epoch.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The reference frame in which the sensor derived positions are provided. If the referenceFrame
     * is null it is assumed to be J2000. Note that this frame is assumed to apply to all of the
     * sensor data in this record. If onboard sensors process positional estimates in different
     * frames then separate records should be generated.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Arrays of spacecraft position (X, Y, Z), in km, in the specified referenceFrame, based on the
     * onboard star tracker, at each epoch.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Arrays of spacecraft position (X, Y, Z), in km, in the specified referenceFrame, based on the
     * onboard sun sensor, at each epoch.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnboardnavigationFull].
         *
    ...
    /** A builder for [OnboardnavigationFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationFull: OnboardnavigationFull) = apply {
            classificationMarking = onboardnavigationFull.classificationMarking
            dataMode = onboardnavigationFull.dataMode
            source = onboardnavigationFull.source
            startTime = onboardnavigationFull.startTime
            id = onboardnavigationFull.id
            createdAt = onboardnavigationFull.createdAt
            createdBy = onboardnavigationFull.createdBy
            deltaPos = onboardnavigationFull.deltaPos.map { it.toMutableList() }
            endTime = onboardnavigationFull.endTime
            esId = onboardnavigationFull.esId
            idOnOrbit = onboardnavigationFull.idOnOrbit
            idStateVector = onboardnavigationFull.idStateVector
            mag = onboardnavigationFull.mag.map { it.toMutableList() }
            onOrbit = onboardnavigationFull.onOrbit
            origin = onboardnavigationFull.origin
            origNetwork = onboardnavigationFull.origNetwork
            origObjectId = onboardnavigationFull.origObjectId
            referenceFrame = onboardnavigationFull.referenceFrame
            satNo = onboardnavigationFull.satNo
            starCatLoadTime = onboardnavigationFull.starCatLoadTime
            starCatName = onboardnavigationFull.starCatName
            starTracker = onboardnavigationFull.starTracker.map { it.toMutableList() }
            sunSensor = onboardnavigationFull.sunSensor.map { it.toMutableList() }
            ts = onboardnavigationFull.ts.map { it.toMutableList() }
            additionalProperties = onboardnavigationFull.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.deltaPos] with a well-typed `List<List<Double>>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun addMag(mag: List<Double>) = apply {
            this.mag =
                (this.mag ?: JsonField.of(mutableListOf())).also { checkKnown("mag", it).add(mag) }
        }
         ...
         *
         * You should usually call [Builder.sunSensor] with a well-typed `List<List<Double>>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Returns an immutable instance of [OnboardnavigationFull].
         *
         ...
         */
        fun build(): OnboardnavigationFull =
    ...
    fun validate(): OnboardnavigationFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OnboardnavigationFull && classificationMarking == other.classificationMarking && dataMode == other.dataMode && source == other.source && startTime == other.startTime && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && deltaPos == other.deltaPos && endTime == other.endTime && esId == other.esId && idOnOrbit == other.idOnOrbit && idStateVector == other.idStateVector && mag == other.mag && onOrbit == other.onOrbit && origin == other.origin && origNetwork == other.origNetwork && origObjectId == other.origObjectId && referenceFrame == other.referenceFrame && satNo == other.satNo && starCatLoadTime == other.starCatLoadTime && starCatName == other.starCatName && starTracker == other.starTracker && sunSensor == other.sunSensor && ts == other.ts && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, source, startTime, id, createdAt, createdBy, deltaPos, endTime, esId, idOnOrbit, idStateVector, mag, onOrbit, origin, origNetwork, origObjectId, referenceFrame, satNo, starCatLoadTime, starCatName, starTracker, sunSensor, ts, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "OnboardnavigationFull{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, startTime=$startTime, id=$id, createdAt=$createdAt, createdBy=$createdBy, deltaPos=$deltaPos, endTime=$endTime, esId=$esId, idOnOrbit=$idOnOrbit, idStateVector=$idStateVector, mag=$mag, onOrbit=$onOrbit, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, referenceFrame=$referenceFrame, satNo=$satNo, starCatLoadTime=$starCatLoadTime, starCatName=$starCatName, starTracker=$starTracker, sunSensor=$sunSensor, ts=$ts, additionalProperties=$additionalProperties}"
}
