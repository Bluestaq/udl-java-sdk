 ...
 */
class WeatherReportListResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WeatherReportListResponse].
         *
    ...
    /** A builder for [WeatherReportListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherReportListResponse: WeatherReportListResponse) = apply {
            classificationMarking = weatherReportListResponse.classificationMarking
            dataMode = weatherReportListResponse.dataMode
            lat = weatherReportListResponse.lat
            lon = weatherReportListResponse.lon
            obTime = weatherReportListResponse.obTime
            reportType = weatherReportListResponse.reportType
            source = weatherReportListResponse.source
            id = weatherReportListResponse.id
            actWeather = weatherReportListResponse.actWeather
            agjson = weatherReportListResponse.agjson
            alt = weatherReportListResponse.alt
            andims = weatherReportListResponse.andims
            asrid = weatherReportListResponse.asrid
            atext = weatherReportListResponse.atext
            atype = weatherReportListResponse.atype
            barPress = weatherReportListResponse.barPress
            ccEvent = weatherReportListResponse.ccEvent
            cloudCover = weatherReportListResponse.cloudCover.map { it.toMutableList() }
            cloudHght = weatherReportListResponse.cloudHght.map { it.toMutableList() }
            contrailHghtLower = weatherReportListResponse.contrailHghtLower
            contrailHghtUpper = weatherReportListResponse.contrailHghtUpper
            createdAt = weatherReportListResponse.createdAt
            createdBy = weatherReportListResponse.createdBy
            dataLevel = weatherReportListResponse.dataLevel
            dewPoint = weatherReportListResponse.dewPoint
            difRad = weatherReportListResponse.difRad
            dirDev = weatherReportListResponse.dirDev
            enRouteWeather = weatherReportListResponse.enRouteWeather
            externalId = weatherReportListResponse.externalId
            externalLocationId = weatherReportListResponse.externalLocationId
            forecastEndTime = weatherReportListResponse.forecastEndTime
            forecastStartTime = weatherReportListResponse.forecastStartTime
            geoPotentialAlt = weatherReportListResponse.geoPotentialAlt
            hshear = weatherReportListResponse.hshear
            icao = weatherReportListResponse.icao
            icingLowerLimit = weatherReportListResponse.icingLowerLimit
            icingUpperLimit = weatherReportListResponse.icingUpperLimit
            idAirfield = weatherReportListResponse.idAirfield
            idGroundImagery = weatherReportListResponse.idGroundImagery
            idSensor = weatherReportListResponse.idSensor
            idSite = weatherReportListResponse.idSite
            indexRefraction = weatherReportListResponse.indexRefraction
            origin = weatherReportListResponse.origin
            origNetwork = weatherReportListResponse.origNetwork
            origSensorId = weatherReportListResponse.origSensorId
            precipRate = weatherReportListResponse.precipRate
            qnh = weatherReportListResponse.qnh
            radVel = weatherReportListResponse.radVel
            radVelBeam1 = weatherReportListResponse.radVelBeam1
            radVelBeam2 = weatherReportListResponse.radVelBeam2
            radVelBeam3 = weatherReportListResponse.radVelBeam3
            radVelBeam4 = weatherReportListResponse.radVelBeam4
            radVelBeam5 = weatherReportListResponse.radVelBeam5
            rainHour = weatherReportListResponse.rainHour
            rawMetar = weatherReportListResponse.rawMetar
            rawTaf = weatherReportListResponse.rawTaf
            refRad = weatherReportListResponse.refRad
            relHumidity = weatherReportListResponse.relHumidity
            senalt = weatherReportListResponse.senalt
            senlat = weatherReportListResponse.senlat
            senlon = weatherReportListResponse.senlon
            soilMoisture = weatherReportListResponse.soilMoisture
            soilTemp = weatherReportListResponse.soilTemp
            solarRad = weatherReportListResponse.solarRad
            srcIds = weatherReportListResponse.srcIds.map { it.toMutableList() }
            srcTyps = weatherReportListResponse.srcTyps.map { it.toMutableList() }
            surroundingWeather = weatherReportListResponse.surroundingWeather
            temperature = weatherReportListResponse.temperature
            visibility = weatherReportListResponse.visibility
            vshear = weatherReportListResponse.vshear
            weatherAmp = weatherReportListResponse.weatherAmp
            weatherDesc = weatherReportListResponse.weatherDesc
            weatherId = weatherReportListResponse.weatherId
            weatherInt = weatherReportListResponse.weatherInt
            windChill = weatherReportListResponse.windChill
            windCov = weatherReportListResponse.windCov.map { it.toMutableList() }
            windDir = weatherReportListResponse.windDir
            windDirAvg = weatherReportListResponse.windDirAvg
            windDirPeak = weatherReportListResponse.windDirPeak
            windDirPeak10 = weatherReportListResponse.windDirPeak10
            windGust = weatherReportListResponse.windGust
            windGust10 = weatherReportListResponse.windGust10
            windSpd = weatherReportListResponse.windSpd
            windSpdAvg = weatherReportListResponse.windSpdAvg
            windVar = weatherReportListResponse.windVar
            additionalProperties = weatherReportListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WeatherReportListResponse].
         *
         ...
         */
        fun build(): WeatherReportListResponse =
    ...
    fun validate(): WeatherReportListResponse = apply {
        if (validated) {
            return@apply
        }
