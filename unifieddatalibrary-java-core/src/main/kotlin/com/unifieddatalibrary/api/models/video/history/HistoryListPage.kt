...
private constructor(
    ...
    private val items: List<VideoStreamsFull>,
) : Page<VideoStreamsFull> {
    ...
    fun autoPager(): AutoPager<VideoStreamsFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<VideoStreamsFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<VideoStreamsFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<VideoStreamsFull>) = apply { this.items = items }
