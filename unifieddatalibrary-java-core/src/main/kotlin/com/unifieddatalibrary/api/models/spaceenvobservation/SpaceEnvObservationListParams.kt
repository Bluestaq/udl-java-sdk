...
class SpaceEnvObservationListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SpaceEnvObservationListParams].
         *
    ...
    /** A builder for [SpaceEnvObservationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(spaceEnvObservationListParams: SpaceEnvObservationListParams) =
            apply {
                obTime = spaceEnvObservationListParams.obTime
                firstResult = spaceEnvObservationListParams.firstResult
                maxResults = spaceEnvObservationListParams.maxResults
                additionalHeaders = spaceEnvObservationListParams.additionalHeaders.toBuilder()
                additionalQueryParams = spaceEnvObservationListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SpaceEnvObservationListParams].
         *
         ...
         */
        fun build(): SpaceEnvObservationListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SpaceEnvObservationListParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SpaceEnvObservationListParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
