...
class GroundImageryGetFileParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): GroundImageryGetFileParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryGetFileParams: GroundImageryGetFileParams) =
            apply {
    ...
    override fun toString() = "GroundImageryGetFileParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
