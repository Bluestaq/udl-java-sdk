...
/**
 * Service operation to get a single GroundImagery binary image by its unique ID passed as a path
 * parameter. The image is returned as an attachment Content-Disposition.
 */
class GroundImageryGetFileParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): GroundImageryGetFileParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [GroundImageryGetFileParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GroundImageryGetFileParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryGetFileParams: GroundImageryGetFileParams) = apply {
            id = groundImageryGetFileParams.id
            firstResult = groundImageryGetFileParams.firstResult
            maxResults = groundImageryGetFileParams.maxResults
            additionalHeaders = groundImageryGetFileParams.additionalHeaders.toBuilder()
            additionalQueryParams = groundImageryGetFileParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GroundImageryGetFileParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GroundImageryGetFileParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is GroundImageryGetFileParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "GroundImageryGetFileParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
