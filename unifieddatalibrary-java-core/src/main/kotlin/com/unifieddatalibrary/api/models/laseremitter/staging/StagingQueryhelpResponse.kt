...
class StagingQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [StagingQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [StagingQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stagingQueryhelpResponse: StagingQueryhelpResponse) = apply {
            aodrSupported = stagingQueryhelpResponse.aodrSupported
            classificationMarking = stagingQueryhelpResponse.classificationMarking
            description = stagingQueryhelpResponse.description
            historySupported = stagingQueryhelpResponse.historySupported
            name = stagingQueryhelpResponse.name
            parameters = stagingQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = stagingQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = stagingQueryhelpResponse.restSupported
            sortSupported = stagingQueryhelpResponse.sortSupported
            typeName = stagingQueryhelpResponse.typeName
            uri = stagingQueryhelpResponse.uri
            additionalProperties = stagingQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StagingQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StagingQueryhelpResponse =
    ...
    fun validate(): StagingQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StagingQueryhelpResponse &&
