...
class GroundImageryGetResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryGetResponse: GroundImageryGetResponse) = apply {
    ...
    fun validate(): GroundImageryGetResponse = apply {
        if (validated) {
            return@apply
        }
