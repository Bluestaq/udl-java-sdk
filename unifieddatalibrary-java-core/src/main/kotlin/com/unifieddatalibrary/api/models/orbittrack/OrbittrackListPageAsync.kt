...
class OrbittrackListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<OrbittrackListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackListPageAsync: OrbittrackListPageAsync) =
            apply {
        ...
        fun service(service: OrbittrackServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: OrbittrackListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<OrbittrackListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "OrbittrackListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
