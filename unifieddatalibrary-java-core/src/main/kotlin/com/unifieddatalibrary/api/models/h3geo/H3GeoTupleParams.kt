...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [H3GeoTupleParams].
         *
    ...
    /** A builder for [H3GeoTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoTupleParams: H3GeoTupleParams) = apply {
            columns = h3GeoTupleParams.columns
            startTime = h3GeoTupleParams.startTime
            firstResult = h3GeoTupleParams.firstResult
            maxResults = h3GeoTupleParams.maxResults
            additionalHeaders = h3GeoTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = h3GeoTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [H3GeoTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is H3GeoTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "H3GeoTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
