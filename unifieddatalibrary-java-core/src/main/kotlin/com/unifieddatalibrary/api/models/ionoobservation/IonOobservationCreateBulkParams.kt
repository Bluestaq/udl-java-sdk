 ...
 */
class IonOobservationCreateBulkParams
private constructor(
    ...
    /** A builder for [IonOobservationCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ionOobservationCreateBulkParams: IonOobservationCreateBulkParams) =
            apply {
                body = ionOobservationCreateBulkParams.body.toMutableList()
                additionalHeaders = ionOobservationCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    ionOobservationCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [IonOobservationCreateBulkParams].
         *
         ...
         */
        fun build(): IonOobservationCreateBulkParams =
            IonOobservationCreateBulkParams(
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                data:
                    JsonField<
                        List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>
                    > =
                    JsonMissing.of(),
                @JsonProperty("dimensionName")
                @ExcludeMissing
             ...
             */
            fun data():
                Optional<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>> =
                data.getOptional("data")
            ...
            class Builder internal constructor() {
                ...
                private var data:
                    JsonField<
                        MutableList<
                            List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>
                        >
                    >? =
                    null
                private var dimensionName: JsonField<MutableList<String>>? = null
                ...
                /** Array of polarization data. */
                fun data(
                    data: List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>
                ) = data(JsonField.of(data))
                 ...
                 *
                 * You should usually call [Builder.data] with a well-typed
                 * `List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>` value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun data(
                ...
                /**
                 * Adds a single [List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>]
                 * to [Builder.data].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addData(
                    data: List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>
                ) = apply {
                    this.data =
                        (this.data ?: JsonField.of(mutableListOf())).also {
                            checkKnown("data", it).add(data)
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    @JvmStatic
                    fun of(value: String) = UnnamedSchemaWithArrayParent3(JsonField.of(value))
                }

                /** An enum containing [UnnamedSchemaWithArrayParent3]'s known values. */
                enum class Known {
                    X,
                    O,
                }
                ...
                /**
                 * An enum containing [UnnamedSchemaWithArrayParent3]'s known values, as well as an
                 * [_UNKNOWN] member.
                 *
                 * An instance of [UnnamedSchemaWithArrayParent3] can contain an unknown value in a
                 * couple of cases:
                ...
                enum class Value {
                    ...
                    O,
                    /**
                     * An enum member indicating that [UnnamedSchemaWithArrayParent3] was
                     * instantiated with an unknown value.
                     */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        O -> Known.O
                            ...
                            throw UnifieddatalibraryInvalidDataException(
                                "Unknown UnnamedSchemaWithArrayParent3: $value"
                            )
                    }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return /* spotless:off */ other is UnnamedSchemaWithArrayParent3 && value == other.value /* spotless:on */
                }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IonOobservationCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "IonOobservationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
