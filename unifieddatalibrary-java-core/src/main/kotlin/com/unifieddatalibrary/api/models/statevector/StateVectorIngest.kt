...
class StateVectorIngest private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StateVectorIngest].
         *
    ...
    /** A builder for [StateVectorIngest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorIngest: StateVectorIngest) =
            apply {
                classificationMarking = stateVectorIngest.classificationMarking
                dataMode = stateVectorIngest.dataMode
                epoch = stateVectorIngest.epoch
                source = stateVectorIngest.source
                actualOdSpan = stateVectorIngest.actualOdSpan
                algorithm = stateVectorIngest.algorithm
                alt1ReferenceFrame = stateVectorIngest.alt1ReferenceFrame
                alt2ReferenceFrame = stateVectorIngest.alt2ReferenceFrame
                area = stateVectorIngest.area
                bDot = stateVectorIngest.bDot
                cmOffset = stateVectorIngest.cmOffset
                cov = stateVectorIngest.cov.map { it.toMutableList() }
                covMethod = stateVectorIngest.covMethod
                covReferenceFrame = stateVectorIngest.covReferenceFrame
                createdAt = stateVectorIngest.createdAt
                createdBy = stateVectorIngest.createdBy
                descriptor = stateVectorIngest.descriptor
                dragArea = stateVectorIngest.dragArea
                dragCoeff = stateVectorIngest.dragCoeff
                dragModel = stateVectorIngest.dragModel
                edr = stateVectorIngest.edr
                eqCov = stateVectorIngest.eqCov.map { it.toMutableList() }
                errorControl = stateVectorIngest.errorControl
                fixedStep = stateVectorIngest.fixedStep
                geopotentialModel = stateVectorIngest.geopotentialModel
                iau1980Terms = stateVectorIngest.iau1980Terms
                idOnOrbit = stateVectorIngest.idOnOrbit
                idOrbitDetermination = stateVectorIngest.idOrbitDetermination
                idStateVector = stateVectorIngest.idStateVector
                integratorMode = stateVectorIngest.integratorMode
                inTrackThrust = stateVectorIngest.inTrackThrust
                lastObEnd = stateVectorIngest.lastObEnd
                lastObStart = stateVectorIngest.lastObStart
                leapSecondTime = stateVectorIngest.leapSecondTime
                lunarSolar = stateVectorIngest.lunarSolar
                mass = stateVectorIngest.mass
                obsAvailable = stateVectorIngest.obsAvailable
                obsUsed = stateVectorIngest.obsUsed
                origin = stateVectorIngest.origin
                origNetwork = stateVectorIngest.origNetwork
                origObjectId = stateVectorIngest.origObjectId
                partials = stateVectorIngest.partials
                pedigree = stateVectorIngest.pedigree
                polarMotionX = stateVectorIngest.polarMotionX
                polarMotionY = stateVectorIngest.polarMotionY
                posUnc = stateVectorIngest.posUnc
                rawFileUri = stateVectorIngest.rawFileUri
                recOdSpan = stateVectorIngest.recOdSpan
                referenceFrame = stateVectorIngest.referenceFrame
                residualsAcc = stateVectorIngest.residualsAcc
                revNo = stateVectorIngest.revNo
                rms = stateVectorIngest.rms
                satNo = stateVectorIngest.satNo
                sigmaPosUvw = stateVectorIngest.sigmaPosUvw.map { it.toMutableList() }
                sigmaVelUvw = stateVectorIngest.sigmaVelUvw.map { it.toMutableList() }
                solarFluxApAvg = stateVectorIngest.solarFluxApAvg
                solarFluxF10 = stateVectorIngest.solarFluxF10
                solarFluxF10Avg = stateVectorIngest.solarFluxF10Avg
                solarRadPress = stateVectorIngest.solarRadPress
                solarRadPressCoeff = stateVectorIngest.solarRadPressCoeff
                solidEarthTides = stateVectorIngest.solidEarthTides
                sourcedData = stateVectorIngest.sourcedData.map { it.toMutableList() }
                sourcedDataTypes = stateVectorIngest.sourcedDataTypes.map { it.toMutableList() }
                sourceDl = stateVectorIngest.sourceDl
                srpArea = stateVectorIngest.srpArea
                stepMode = stateVectorIngest.stepMode
                stepSize = stateVectorIngest.stepSize
                stepSizeSelection = stateVectorIngest.stepSizeSelection
                tags = stateVectorIngest.tags.map { it.toMutableList() }
                taiUtc = stateVectorIngest.taiUtc
                thrustAccel = stateVectorIngest.thrustAccel
                tracksAvail = stateVectorIngest.tracksAvail
                tracksUsed = stateVectorIngest.tracksUsed
                transactionId = stateVectorIngest.transactionId
                uct = stateVectorIngest.uct
                ut1Rate = stateVectorIngest.ut1Rate
                ut1Utc = stateVectorIngest.ut1Utc
                velUnc = stateVectorIngest.velUnc
                xaccel = stateVectorIngest.xaccel
                xpos = stateVectorIngest.xpos
                xposAlt1 = stateVectorIngest.xposAlt1
                xposAlt2 = stateVectorIngest.xposAlt2
                xvel = stateVectorIngest.xvel
                xvelAlt1 = stateVectorIngest.xvelAlt1
                xvelAlt2 = stateVectorIngest.xvelAlt2
                yaccel = stateVectorIngest.yaccel
                ypos = stateVectorIngest.ypos
                yposAlt1 = stateVectorIngest.yposAlt1
                yposAlt2 = stateVectorIngest.yposAlt2
                yvel = stateVectorIngest.yvel
                yvelAlt1 = stateVectorIngest.yvelAlt1
                yvelAlt2 = stateVectorIngest.yvelAlt2
                zaccel = stateVectorIngest.zaccel
                zpos = stateVectorIngest.zpos
                zposAlt1 = stateVectorIngest.zposAlt1
                zposAlt2 = stateVectorIngest.zposAlt2
                zvel = stateVectorIngest.zvel
                zvelAlt1 = stateVectorIngest.zvelAlt1
                zvelAlt2 = stateVectorIngest.zvelAlt2
                additionalProperties = stateVectorIngest.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StateVectorIngest].
         *
    ...
    fun validate(): StateVectorIngest =
        apply {
            if (validated) {
              return@apply
            }
