...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissileTrackTupleParams].
         *
    ...
    /** A builder for [MissileTrackTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missileTrackTupleParams: MissileTrackTupleParams) = apply {
            columns = missileTrackTupleParams.columns
            ts = missileTrackTupleParams.ts
            firstResult = missileTrackTupleParams.firstResult
            maxResults = missileTrackTupleParams.maxResults
            additionalHeaders = missileTrackTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = missileTrackTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MissileTrackTupleParams].
         *
         ...
         */
        fun build(): MissileTrackTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MissileTrackTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MissileTrackTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
