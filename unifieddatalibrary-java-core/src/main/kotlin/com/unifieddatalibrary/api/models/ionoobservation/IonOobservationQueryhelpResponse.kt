...
class IonOobservationQueryhelpResponse
private constructor(
    ...
    /** A builder for [IonOobservationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ionOobservationQueryhelpResponse: IonOobservationQueryhelpResponse) =
            apply {
                aodrSupported = ionOobservationQueryhelpResponse.aodrSupported
                classificationMarking = ionOobservationQueryhelpResponse.classificationMarking
                description = ionOobservationQueryhelpResponse.description
                historySupported = ionOobservationQueryhelpResponse.historySupported
                name = ionOobservationQueryhelpResponse.name
                parameters = ionOobservationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    ionOobservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = ionOobservationQueryhelpResponse.restSupported
                sortSupported = ionOobservationQueryhelpResponse.sortSupported
                typeName = ionOobservationQueryhelpResponse.typeName
                uri = ionOobservationQueryhelpResponse.uri
                additionalProperties =
                    ionOobservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [IonOobservationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IonOobservationQueryhelpResponse =
            IonOobservationQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): IonOobservationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IonOobservationQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
