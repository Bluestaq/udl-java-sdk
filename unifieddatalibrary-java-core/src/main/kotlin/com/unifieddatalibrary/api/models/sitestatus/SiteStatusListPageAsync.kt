...
private constructor(
    ...
    override fun nextPage(): CompletableFuture<SiteStatusListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusListPageAsync: SiteStatusListPageAsync) = apply {
        ...
        fun service(service: SiteStatusServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SiteStatusListPageAsync &&
    ...
    override fun toString() =
        "SiteStatusListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
