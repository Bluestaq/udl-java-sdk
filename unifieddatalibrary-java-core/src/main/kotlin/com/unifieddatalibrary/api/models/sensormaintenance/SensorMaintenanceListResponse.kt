...
class SensorMaintenanceListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("equipStatus") @ExcludeMissing equipStatus: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idSensor") @ExcludeMissing idSensor: JsonField<String> = JsonMissing.of(),
        @JsonProperty("impactedFaces") @ExcludeMissing impactedFaces: JsonField<String> = JsonMissing.of(),
        @JsonProperty("inactiveDate") @ExcludeMissing inactiveDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("lineNumber") @ExcludeMissing lineNumber: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _siteCode(): JsonField<String> = siteCode
    ...
    @ExcludeMissing
    fun _approver(): JsonField<String> = approver
    ...
    @ExcludeMissing
    fun _changer(): JsonField<String> = changer
    ...
    @JsonProperty("eowId")
    @ExcludeMissing
    fun _eowId(): JsonField<String> = eowId
    ...
    @ExcludeMissing
    fun _equipStatus(): JsonField<String> = equipStatus
    ...
    @ExcludeMissing
    fun _mdOpsCap(): JsonField<String> = mdOpsCap
    ...
    @ExcludeMissing
    fun _mwOpsCap(): JsonField<String> = mwOpsCap
    ...
    @JsonProperty("recall")
    @ExcludeMissing
    fun _recall(): JsonField<String> = recall
    ...
    @ExcludeMissing
    fun _requestor(): JsonField<String> = requestor
     ...
     */
    @JsonProperty("ssOpsCap")
    @ExcludeMissing
    fun _ssOpsCap(): JsonField<String> = ssOpsCap
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorMaintenanceListResponse].
         *
    ...
    /** A builder for [SensorMaintenanceListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceListResponse: SensorMaintenanceListResponse) =
            apply {
                classificationMarking = sensorMaintenanceListResponse.classificationMarking
                dataMode = sensorMaintenanceListResponse.dataMode
                endTime = sensorMaintenanceListResponse.endTime
                siteCode = sensorMaintenanceListResponse.siteCode
                source = sensorMaintenanceListResponse.source
                startTime = sensorMaintenanceListResponse.startTime
                id = sensorMaintenanceListResponse.id
                activity = sensorMaintenanceListResponse.activity
                approver = sensorMaintenanceListResponse.approver
                changer = sensorMaintenanceListResponse.changer
                createdAt = sensorMaintenanceListResponse.createdAt
                createdBy = sensorMaintenanceListResponse.createdBy
                duration = sensorMaintenanceListResponse.duration
                eowId = sensorMaintenanceListResponse.eowId
                equipStatus = sensorMaintenanceListResponse.equipStatus
                idSensor = sensorMaintenanceListResponse.idSensor
                impactedFaces = sensorMaintenanceListResponse.impactedFaces
                inactiveDate = sensorMaintenanceListResponse.inactiveDate
                lineNumber = sensorMaintenanceListResponse.lineNumber
                mdOpsCap = sensorMaintenanceListResponse.mdOpsCap
                mwOpsCap = sensorMaintenanceListResponse.mwOpsCap
                origin = sensorMaintenanceListResponse.origin
                origNetwork = sensorMaintenanceListResponse.origNetwork
                priority = sensorMaintenanceListResponse.priority
                recall = sensorMaintenanceListResponse.recall
                rel = sensorMaintenanceListResponse.rel
                remark = sensorMaintenanceListResponse.remark
                requestor = sensorMaintenanceListResponse.requestor
                resource = sensorMaintenanceListResponse.resource
                rev = sensorMaintenanceListResponse.rev
                ssOpsCap = sensorMaintenanceListResponse.ssOpsCap
                additionalProperties = sensorMaintenanceListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.siteCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun siteCode(siteCode: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.approver] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun approver(approver: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.changer] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun changer(changer: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.eowId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eowId(eowId: JsonField<String>) =
            apply {
                this.eowId = eowId
            }
         ...
         *
         * You should usually call [Builder.equipStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun equipStatus(equipStatus: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.impactedFaces] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun impactedFaces(impactedFaces: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.inactiveDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun inactiveDate(inactiveDate: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.lineNumber] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lineNumber(lineNumber: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.mdOpsCap] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mdOpsCap(mdOpsCap: JsonField<String>) =
            apply {
                this.mdOpsCap = mdOpsCap
            }
         ...
         *
         * You should usually call [Builder.mwOpsCap] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mwOpsCap(mwOpsCap: JsonField<String>) =
            apply {
                this.mwOpsCap = mwOpsCap
            }
         ...
         *
         * You should usually call [Builder.recall] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun recall(recall: JsonField<String>) =
            apply {
                this.recall = recall
            }
         ...
         *
         * You should usually call [Builder.rel] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rel(rel: JsonField<String>) =
            apply {
                this.rel = rel
            }
         ...
         *
         * You should usually call [Builder.requestor] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun requestor(requestor: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.rev] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rev(rev: JsonField<String>) =
            apply {
                this.rev = rev
            }
         ...
         *
         * You should usually call [Builder.ssOpsCap] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ssOpsCap(ssOpsCap: JsonField<String>) =
            apply {
                this.ssOpsCap = ssOpsCap
            }
        ...
        /**
         * Returns an immutable instance of [SensorMaintenanceListResponse].
         *
         ...
         */
        fun build(): SensorMaintenanceListResponse =
    ...
    fun validate(): SensorMaintenanceListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (siteCode.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (activity.asKnown().isPresent) 1 else 0) + (if (approver.asKnown().isPresent) 1 else 0) + (if (changer.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (duration.asKnown().isPresent) 1 else 0) + (if (eowId.asKnown().isPresent) 1 else 0) + (if (equipStatus.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (impactedFaces.asKnown().isPresent) 1 else 0) + (if (inactiveDate.asKnown().isPresent) 1 else 0) + (if (lineNumber.asKnown().isPresent) 1 else 0) + (if (mdOpsCap.asKnown().isPresent) 1 else 0) + (if (mwOpsCap.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (priority.asKnown().isPresent) 1 else 0) + (if (recall.asKnown().isPresent) 1 else 0) + (if (rel.asKnown().isPresent) 1 else 0) + (if (remark.asKnown().isPresent) 1 else 0) + (if (requestor.asKnown().isPresent) 1 else 0) + (if (resource.asKnown().isPresent) 1 else 0) + (if (rev.asKnown().isPresent) 1 else 0) + (if (ssOpsCap.asKnown().isPresent) 1 else 0)
