 ...
 * Requires a specific role, please contact the UDL team to gain access. This operation is intended
 * to be used for automated feeds into UDL.
 */
class EvacUnvalidatedPublishParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EvacUnvalidatedPublishParams].
         *
    ...
    /** A builder for [EvacUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evacUnvalidatedPublishParams: EvacUnvalidatedPublishParams) = apply {
            body = evacUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = evacUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams = evacUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EvacUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): EvacUnvalidatedPublishParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EvacUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "EvacUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
