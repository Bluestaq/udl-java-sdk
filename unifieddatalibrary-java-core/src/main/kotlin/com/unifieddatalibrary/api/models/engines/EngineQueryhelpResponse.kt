...
class EngineQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EngineQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EngineQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineQueryhelpResponse: EngineQueryhelpResponse) =
            apply {
                aodrSupported = engineQueryhelpResponse.aodrSupported
                classificationMarking = engineQueryhelpResponse.classificationMarking
                description = engineQueryhelpResponse.description
                historySupported = engineQueryhelpResponse.historySupported
                name = engineQueryhelpResponse.name
                parameters = engineQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = engineQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = engineQueryhelpResponse.restSupported
                sortSupported = engineQueryhelpResponse.sortSupported
                typeName = engineQueryhelpResponse.typeName
                uri = engineQueryhelpResponse.uri
                additionalProperties = engineQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EngineQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EngineQueryhelpResponse =
    ...
    fun validate(): EngineQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EngineQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
