...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(rfEmitterDetailListResponse: RfEmitterDetailListResponse) = apply {
            ...
            antennas = rfEmitterDetailListResponse.antennas.map { it.toMutableList() }
            barrageNoiseBandwidth = rfEmitterDetailListResponse.barrageNoiseBandwidth
            bitRunTime = rfEmitterDetailListResponse.bitRunTime
            ...
            fixedAttenuation = rfEmitterDetailListResponse.fixedAttenuation
            idManufacturerOrg = rfEmitterDetailListResponse.idManufacturerOrg
            idProductionFacilityLocation = rfEmitterDetailListResponse.idProductionFacilityLocation
            loanedToCocom = rfEmitterDetailListResponse.loanedToCocom
            ...
            powerOffsets = rfEmitterDetailListResponse.powerOffsets.map { it.toMutableList() }
            prepTime = rfEmitterDetailListResponse.prepTime
            primaryCocom = rfEmitterDetailListResponse.primaryCocom
            ...
            services = rfEmitterDetailListResponse.services.map { it.toMutableList() }
            ...
            ttps = rfEmitterDetailListResponse.ttps.map { it.toMutableList() }
            updatedAt = rfEmitterDetailListResponse.updatedAt
            updatedBy = rfEmitterDetailListResponse.updatedBy
