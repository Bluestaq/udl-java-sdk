...
private constructor(
     ...
     */
    @JsonProperty("location") @ExcludeMissing fun _location(): JsonField<LocationIngest> = location
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityIngest: EntityIngest) = apply {
    ...
    fun validate(): EntityIngest = apply {
        if (validated) {
            return@apply
        }
