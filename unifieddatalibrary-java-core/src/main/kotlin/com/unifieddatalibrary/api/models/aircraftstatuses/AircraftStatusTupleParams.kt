...
class AircraftStatusTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftStatusTupleParams].
         *
    ...
    /** A builder for [AircraftStatusTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusTupleParams: AircraftStatusTupleParams) =
            apply {
                columns = aircraftStatusTupleParams.columns
                firstResult = aircraftStatusTupleParams.firstResult
                maxResults = aircraftStatusTupleParams.maxResults
                additionalHeaders = aircraftStatusTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftStatusTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftStatusTupleParams].
         *
         ...
         */
        fun build(): AircraftStatusTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftStatusTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AircraftStatusTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
