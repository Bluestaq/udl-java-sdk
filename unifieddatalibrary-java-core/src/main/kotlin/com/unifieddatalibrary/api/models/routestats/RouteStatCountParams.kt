...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RouteStatCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatCountParams: RouteStatCountParams) = apply {
    ...
    override fun toString() =
        "RouteStatCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
