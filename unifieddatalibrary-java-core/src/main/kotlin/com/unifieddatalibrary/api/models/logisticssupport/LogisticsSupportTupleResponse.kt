 ...
 * personnel.
 */
class LogisticsSupportTupleResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportTupleResponse: LogisticsSupportTupleResponse) = apply {
            ...
            logisticsDiscrepancyInfos =
                logisticsSupportTupleResponse.logisticsDiscrepancyInfos.map { it.toMutableList() }
            logisticsRecordId = logisticsSupportTupleResponse.logisticsRecordId
            logisticsRemarks =
                logisticsSupportTupleResponse.logisticsRemarks.map { it.toMutableList() }
            logisticsSupportItems =
                logisticsSupportTupleResponse.logisticsSupportItems.map { it.toMutableList() }
            logisticsTransportationPlans =
                logisticsSupportTupleResponse.logisticsTransportationPlans.map {
                    it.toMutableList()
                }
    ...
    fun validate(): LogisticsSupportTupleResponse = apply {
        if (validated) {
            return@apply
        }
