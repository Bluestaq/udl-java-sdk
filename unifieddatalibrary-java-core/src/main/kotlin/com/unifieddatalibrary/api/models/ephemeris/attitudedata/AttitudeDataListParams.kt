...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AttitudeDataListParams].
         *
    ...
    /** A builder for [AttitudeDataListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeDataListParams: AttitudeDataListParams) = apply {
            asId = attitudeDataListParams.asId
            firstResult = attitudeDataListParams.firstResult
            maxResults = attitudeDataListParams.maxResults
            additionalHeaders = attitudeDataListParams.additionalHeaders.toBuilder()
            additionalQueryParams = attitudeDataListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AttitudeDataListParams].
         *
         ...
         */
        fun build(): AttitudeDataListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AttitudeDataListParams && asId == other.asId && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(asId, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AttitudeDataListParams{asId=$asId, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
