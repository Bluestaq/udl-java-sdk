...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteRemarkCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkCountParams: SiteRemarkCountParams) = apply {
    ...
    override fun toString() =
        "SiteRemarkCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
