...
class RfBandTypeListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeListResponse: RfBandTypeListResponse) =
            apply {
    ...
    fun validate(): RfBandTypeListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "RfBandTypeListResponse{id=$id, classificationMarking=$classificationMarking, dataMode=$dataMode, description=$description, source=$source, createdAt=$createdAt, createdBy=$createdBy, endFreq=$endFreq, origin=$origin, startFreq=$startFreq, additionalProperties=$additionalProperties}"
}
