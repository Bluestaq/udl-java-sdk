...
package com.unifieddatalibrary.api.models.onorbitassessment.history
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyAodrParams: HistoryAodrParams) = apply {
            assmtTime = historyAodrParams.assmtTime
    ...
    override fun toString() =
        "HistoryAodrParams{assmtTime=$assmtTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
