...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            collectionRequirements =
                historyListResponse.collectionRequirements.map { it.toMutableList() }
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            idexVersion = historyListResponse.idexVersion
            missionAor = historyListResponse.missionAor
            missionCollectionArea = historyListResponse.missionCollectionArea
            missionCountry = historyListResponse.missionCountry
            missionEmphasis = historyListResponse.missionEmphasis
            missionId = historyListResponse.missionId
            missionJoa = historyListResponse.missionJoa
            missionOperation = historyListResponse.missionOperation
            missionPrimaryIntelDiscipline = historyListResponse.missionPrimaryIntelDiscipline
            missionPrimarySubCategory = historyListResponse.missionPrimarySubCategory
            missionPriority = historyListResponse.missionPriority
            missionRegion = historyListResponse.missionRegion
            missionRole = historyListResponse.missionRole
            missionSecondaryIntelDiscipline = historyListResponse.missionSecondaryIntelDiscipline
            missionSecondarySubCategory = historyListResponse.missionSecondarySubCategory
            missionStartPointLat = historyListResponse.missionStartPointLat
            missionStartPointLong = historyListResponse.missionStartPointLong
            missionSubRegion = historyListResponse.missionSubRegion
            missionSupportedUnit = historyListResponse.missionSupportedUnit
            missionSyncMatrixBin = historyListResponse.missionSyncMatrixBin
            name = historyListResponse.name
            origin = historyListResponse.origin
            origNetwork = historyListResponse.origNetwork
            taskings = historyListResponse.taskings.map { it.toMutableList() }
            transit = historyListResponse.transit.map { it.toMutableList() }
