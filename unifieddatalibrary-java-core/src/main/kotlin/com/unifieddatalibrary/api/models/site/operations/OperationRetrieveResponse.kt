...
class OperationRetrieveResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationRetrieveResponse: OperationRetrieveResponse) =
            apply {
                ...
                operationalDeviations = operationRetrieveResponse.operationalDeviations.map { it.toMutableList() }
                operationalPlannings = operationRetrieveResponse.operationalPlannings.map { it.toMutableList() }
    ...
    fun validate(): OperationRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
