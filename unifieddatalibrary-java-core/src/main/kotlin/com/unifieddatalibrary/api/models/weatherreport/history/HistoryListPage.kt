...
private constructor(
    ...
    private val items: List<WeatherReportFull>,
) : Page<WeatherReportFull> {
    ...
    fun autoPager(): AutoPager<WeatherReportFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<WeatherReportFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<WeatherReportFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<WeatherReportFull>) = apply { this.items = items }
