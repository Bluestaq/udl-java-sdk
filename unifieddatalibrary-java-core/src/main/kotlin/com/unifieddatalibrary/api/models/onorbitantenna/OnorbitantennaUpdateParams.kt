...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun antenna(antenna: Antenna) = apply { body.antenna(antenna) }

        /**
         * Sets [Builder.antenna] to an arbitrary JSON value.
         *
         * You should usually call [Builder.antenna] with a well-typed [Antenna] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun antenna(antenna: JsonField<Antenna>) = apply { body.antenna(antenna) }
    ...
    private constructor(
         ...
         * Unlike [antenna], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("antenna") @ExcludeMissing fun _antenna(): JsonField<Antenna> = antenna
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.antenna] to an arbitrary JSON value.
             *
             * You should usually call [Builder.antenna] with a well-typed [Antenna] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun antenna(antenna: JsonField<Antenna>) = apply { this.antenna = antenna }
    ...
    private constructor(
        ...
        override fun toString() =
            "Antenna{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
