...
class OnorbitantennaUpdateParams private constructor(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun antenna(): Optional<Antenna> = body.antenna()
     ...
     */
    fun _antenna(): JsonField<Antenna> = body._antenna()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitantennaUpdateParams: OnorbitantennaUpdateParams) =
            apply {
         ...
         *
         * You should usually call [Builder.antenna] with a well-typed [Antenna] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun antenna(antenna: JsonField<Antenna>) =
            apply {
                body.antenna(antenna)
            }
    ...
    class Body private constructor(
        ...
        private val antenna: JsonField<Antenna>,
        ...
        private constructor(
            ...
            @JsonProperty("antenna") @ExcludeMissing antenna: JsonField<Antenna> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun antenna(): Optional<Antenna> = antenna.getOptional("antenna")
        ...
        @ExcludeMissing
        fun _antenna(): JsonField<Antenna> = antenna
        ...
        class Builder internal constructor() {
            ...
            private var antenna: JsonField<Antenna> = JsonMissing.of()
            ...
            /** Model representation of information on on-orbit/spacecraft communication antennas. A spacecraft may have multiple antennas and each antenna can have multiple 'details' records compiled by different sources. */
            fun antenna(antenna: Antenna) = antenna(JsonField.of(antenna))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idAntenna.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (antenna.asKnown().getOrNull()?.validity() ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idAntenna == other.idAntenna && idOnOrbit == other.idOnOrbit && source == other.source && bodyId == other.bodyId && antenna == other.antenna && createdAt == other.createdAt && createdBy == other.createdBy && origin == other.origin && origNetwork == other.origNetwork && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idAntenna, idOnOrbit, source, bodyId, antenna, createdAt, createdBy, origin, origNetwork, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idAntenna=$idAntenna, idOnOrbit=$idOnOrbit, source=$source, bodyId=$bodyId, antenna=$antenna, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    /** Model representation of information on on-orbit/spacecraft communication antennas. A spacecraft may have multiple antennas and each antenna can have multiple 'details' records compiled by different sources. */
    class Antenna private constructor(
        private val dataMode: JsonField<DataMode>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(antenna: Antenna) =
                apply {
                    dataMode = antenna.dataMode
                    name = antenna.name
                    source = antenna.source
                    id = antenna.id
                    createdAt = antenna.createdAt
                    createdBy = antenna.createdBy
                    origin = antenna.origin
                    origNetwork = antenna.origNetwork
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Antenna && dataMode == other.dataMode && name == other.name && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && origin == other.origin && origNetwork == other.origNetwork && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Antenna{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitantennaUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OnorbitantennaUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
