...
class OnorbitsolararrayGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OnorbitsolararrayGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitsolararrayGetParams: OnorbitsolararrayGetParams) =
            apply {
    ...
    override fun toString() = "OnorbitsolararrayGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
