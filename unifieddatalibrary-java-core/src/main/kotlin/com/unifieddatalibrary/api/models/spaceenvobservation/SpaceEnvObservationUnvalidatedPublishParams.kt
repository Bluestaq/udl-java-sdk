...
/**
 * Service operation to accept one or more SpaceEnvObservation(s) as a POST body and ingest into the
 ...
 */
class SpaceEnvObservationUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            spaceEnvObservationUnvalidatedPublishParams: SpaceEnvObservationUnvalidatedPublishParams
        ) = apply {
            body = spaceEnvObservationUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                spaceEnvObservationUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                spaceEnvObservationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun toString() =
        "SpaceEnvObservationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
