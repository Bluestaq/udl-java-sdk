...
class LaunchEventGetResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventGetResponse: LaunchEventGetResponse) =
            apply {
    ...
    fun validate(): LaunchEventGetResponse =
        apply {
            if (validated) {
              return@apply
            }
