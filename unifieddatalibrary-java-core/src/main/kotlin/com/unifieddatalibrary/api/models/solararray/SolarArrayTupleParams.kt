...
class SolarArrayTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SolarArrayTupleParams].
         *
    ...
    /** A builder for [SolarArrayTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayTupleParams: SolarArrayTupleParams) =
            apply {
                columns = solarArrayTupleParams.columns
                firstResult = solarArrayTupleParams.firstResult
                maxResults = solarArrayTupleParams.maxResults
                additionalHeaders = solarArrayTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = solarArrayTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SolarArrayTupleParams].
         *
         ...
         */
        fun build(): SolarArrayTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SolarArrayTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SolarArrayTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
