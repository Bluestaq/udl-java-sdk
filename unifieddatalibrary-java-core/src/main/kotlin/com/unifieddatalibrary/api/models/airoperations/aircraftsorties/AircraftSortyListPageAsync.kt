...
class AircraftSortyListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<AircraftSortyListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyListPageAsync: AircraftSortyListPageAsync) =
            apply {
        ...
        fun service(service: AircraftSortyServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftSortyListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, streamHandlerExecutor, params, items) /* spotless:on */

    override fun toString() = "AircraftSortyListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
