...
/**
 * Model representation of a nominal laser emitter. This entity contains minimal information used to
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StagingListResponse].
         *
    ...
    /** A builder for [StagingListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stagingListResponse: StagingListResponse) = apply {
            classificationMarking = stagingListResponse.classificationMarking
            laserName = stagingListResponse.laserName
            source = stagingListResponse.source
            id = stagingListResponse.id
            altitude = stagingListResponse.altitude
            createdAt = stagingListResponse.createdAt
            createdBy = stagingListResponse.createdBy
            laserType = stagingListResponse.laserType
            lat = stagingListResponse.lat
            locationCountry = stagingListResponse.locationCountry
            lon = stagingListResponse.lon
            ownerCountry = stagingListResponse.ownerCountry
            additionalProperties = stagingListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StagingListResponse].
         *
    ...
    fun validate(): StagingListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StagingListResponse &&
    ...
    override fun toString() =
        "StagingListResponse{classificationMarking=$classificationMarking, laserName=$laserName, source=$source, id=$id, altitude=$altitude, createdAt=$createdAt, createdBy=$createdBy, laserType=$laserType, lat=$lat, locationCountry=$locationCountry, lon=$lon, ownerCountry=$ownerCountry, additionalProperties=$additionalProperties}"
}
