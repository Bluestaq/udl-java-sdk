...
class SiteRemarkCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkCreateParams: SiteRemarkCreateParams) =
            apply {
        ...
        /** Unique identifier of the Site Remark record from the originating system. */
        fun origRmkId(origRmkId: String) =
            apply {
                body.origRmkId(origRmkId)
            }
    ...
    class Body private constructor(
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idSite=$idSite, source=$source, text=$text, id=$id, code=$code, createdAt=$createdAt, createdBy=$createdBy, name=$name, origin=$origin, origNetwork=$origNetwork, origRmkId=$origRmkId, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "SiteRemarkCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
