...
class EmitterGeolocationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmitterGeolocationCountParams].
         *
    ...
    /** A builder for [EmitterGeolocationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationCountParams: EmitterGeolocationCountParams) =
            apply {
                startTime = emitterGeolocationCountParams.startTime
                firstResult = emitterGeolocationCountParams.firstResult
                maxResults = emitterGeolocationCountParams.maxResults
                additionalHeaders = emitterGeolocationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = emitterGeolocationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationCountParams].
         *
         ...
         */
        fun build(): EmitterGeolocationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EmitterGeolocationCountParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EmitterGeolocationCountParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
