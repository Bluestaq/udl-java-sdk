...
class SeradataOpticalPayloadGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataOpticalPayloadGetResponse].
         *
    ...
    /** A builder for [SeradataOpticalPayloadGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataOpticalPayloadGetResponse: SeradataOpticalPayloadGetResponse) =
            apply {
                classificationMarking = seradataOpticalPayloadGetResponse.classificationMarking
                dataMode = seradataOpticalPayloadGetResponse.dataMode
                source = seradataOpticalPayloadGetResponse.source
                spacecraftId = seradataOpticalPayloadGetResponse.spacecraftId
                id = seradataOpticalPayloadGetResponse.id
                bestResolution = seradataOpticalPayloadGetResponse.bestResolution
                createdAt = seradataOpticalPayloadGetResponse.createdAt
                createdBy = seradataOpticalPayloadGetResponse.createdBy
                fieldOfRegard = seradataOpticalPayloadGetResponse.fieldOfRegard
                fieldOfView = seradataOpticalPayloadGetResponse.fieldOfView
                groundStationLocations = seradataOpticalPayloadGetResponse.groundStationLocations
                groundStations = seradataOpticalPayloadGetResponse.groundStations
                hostedForCompanyOrgId = seradataOpticalPayloadGetResponse.hostedForCompanyOrgId
                idSensor = seradataOpticalPayloadGetResponse.idSensor
                imagingPayloadCategory = seradataOpticalPayloadGetResponse.imagingPayloadCategory
                manufacturerOrgId = seradataOpticalPayloadGetResponse.manufacturerOrgId
                name = seradataOpticalPayloadGetResponse.name
                notes = seradataOpticalPayloadGetResponse.notes
                numberOfFilmReturnCanisters = seradataOpticalPayloadGetResponse.numberOfFilmReturnCanisters
                origin = seradataOpticalPayloadGetResponse.origin
                origNetwork = seradataOpticalPayloadGetResponse.origNetwork
                pointingMethod = seradataOpticalPayloadGetResponse.pointingMethod
                recorderSize = seradataOpticalPayloadGetResponse.recorderSize
                spectralBand = seradataOpticalPayloadGetResponse.spectralBand
                spectralFrequencyLimits = seradataOpticalPayloadGetResponse.spectralFrequencyLimits
                swathWidth = seradataOpticalPayloadGetResponse.swathWidth
                updatedAt = seradataOpticalPayloadGetResponse.updatedAt
                updatedBy = seradataOpticalPayloadGetResponse.updatedBy
                additionalProperties = seradataOpticalPayloadGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataOpticalPayloadGetResponse].
         *
         ...
         */
        fun build(): SeradataOpticalPayloadGetResponse =
    ...
    fun validate(): SeradataOpticalPayloadGetResponse =
        apply {
            if (validated) {
              return@apply
            }
