...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackCountParams].
         *
    ...
    /** A builder for [TrackCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackCountParams: TrackCountParams) = apply {
            ts = trackCountParams.ts
            firstResult = trackCountParams.firstResult
            maxResults = trackCountParams.maxResults
            additionalHeaders = trackCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = trackCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TrackCountParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackCountParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TrackCountParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
