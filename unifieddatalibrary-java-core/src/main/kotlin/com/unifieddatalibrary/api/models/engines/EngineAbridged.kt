...
class EngineAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EngineAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineAbridged: EngineAbridged) =
            apply {
                classificationMarking = engineAbridged.classificationMarking
                dataMode = engineAbridged.dataMode
                name = engineAbridged.name
                source = engineAbridged.source
                id = engineAbridged.id
                createdAt = engineAbridged.createdAt
                createdBy = engineAbridged.createdBy
                origin = engineAbridged.origin
                origNetwork = engineAbridged.origNetwork
                additionalProperties = engineAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EngineAbridged].
         *
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "EngineAbridged{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
