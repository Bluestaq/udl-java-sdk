...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commListParams: CommListParams) = apply {
    ...
    override fun toString() =
        "CommListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
