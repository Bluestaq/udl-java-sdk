...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DetailListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailListParams: DetailListParams) = apply {
            firstResult = detailListParams.firstResult
            maxResults = detailListParams.maxResults
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailListParams &&
    ...
    override fun toString() =
        "DetailListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
