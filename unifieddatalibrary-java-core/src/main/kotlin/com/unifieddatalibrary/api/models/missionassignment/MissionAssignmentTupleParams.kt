...
class MissionAssignmentTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissionAssignmentTupleParams].
         *
    ...
    /** A builder for [MissionAssignmentTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentTupleParams: MissionAssignmentTupleParams) =
            apply {
                columns = missionAssignmentTupleParams.columns
                ts = missionAssignmentTupleParams.ts
                firstResult = missionAssignmentTupleParams.firstResult
                maxResults = missionAssignmentTupleParams.maxResults
                additionalHeaders = missionAssignmentTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = missionAssignmentTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MissionAssignmentTupleParams].
         *
         ...
         */
        fun build(): MissionAssignmentTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MissionAssignmentTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "MissionAssignmentTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
