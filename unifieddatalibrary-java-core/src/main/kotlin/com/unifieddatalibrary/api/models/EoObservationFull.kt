...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationFull: EoObservationFull) = apply {
    ...
    fun validate(): EoObservationFull = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * Specifically, this is the average background count level in digital number per pixel
         * divided by the exposure time in seconds of the background pixels used in the photometric
         * extraction. Units are digital number per pixel per second.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
         ...
         * numSpectralFilters that corresponds to the spectral filter given in the corresponding
         * spectralFilters.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * The uncertainty in the extinction coefficient for the nth filter. Must be present for all
         * values n=1 to numSpectralFilters, in incrementing order of n, and for no other values of
         * n. -9999 for space-based sensors. Units = magnitudes per air mass.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
         ...
         * units of electrons per analog-to-digital unit. If no gain is used, the value = 1.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * Array of values for the right ascension and declination of the image center, in degrees,
         * in the specified referenceFrame. If referenceFrame is null then J2K should be assumed.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        fun imageBoreRaDec(): Optional<List<Double>> = imageBoreRaDec.getOptional("imageBoreRaDec")

        /**
         * The line of sight vector extending from the sensor toward the center of the image in the
         * specified referenceFrame. Typically aligned with the optical boresight. If referenceFrame
         ...
         * values, in degrees, in the specified referenceFrame. If referenceFrame is null then J2K
         * should be assumed. These coordinate pairs indicate the four corners of the image
         * beginning with the Upper Left (UL) and moving clockwise to Upper Right (UR), Lower Right
         * (LR), and ending with the Lower Left (LL): [ [UL RA, UL DEC], [UR RA, UR DEC],
         * [LR RA, LR DEC], [LL RA, LL DEC] ].
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        fun imageCorners(): Optional<List<List<Double>>> = imageCorners.getOptional("imageCorners")
        ...
        /**
         * Unit vector of the vertical (y) axis of the image plane, in the specified referenceFrame.
        ...
        /**
         * The uncertainty in the transmission for the nth filter. Must be present for all values
         * n=1 to numNeutralDensityFilters, in incrementing order of n, and for no other values of
         * n.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         * Then calculate the point on the RA/DEC (ECI J2000.0) sphere that a vector at this angle
         * would intersect.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         * a CCD with 16-bitpixels, would have a maximum valid pixel value of 2^16 = 65536. This can
        ...
        /**
         * Predicted elevation angle of the target object from a ground-based sensor (no atmospheric
         * refraction correction required) in degrees. AZ_EL implies apparent topocentric place in
         * true of date reference frame as seen from the observer with aberration due to the
         * observer velocity and light travel time applied.
         *
         ...
         * is in the Earth's penumbra or umbra. It is 0 when object is in umbra and 1 when object is
         * fully illuminated.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * The in-band average irradiance of a 0th mag source. Must be present for all values n=1 to
         * numSpectralFilters, in incrementing order of n, and for no other values of n. Units =
         * watts per meters squared per nanometer.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * X-velocity component of the sun state vector in ECI J2000 coordinate frame, in kilometers
         * per second.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Y-velocity component of the sun state vector in ECI J2000 coordinate frame, in kilometers
         * per second.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Z-velocity component of the sun state vector in ECI J2000 coordinate frame, in kilometers
         * per second.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * The value for the zero-point calculated for each filter denoted in spectralFilters. It is
         * the difference between the catalog mag and instrumental mag for a set of standard stars.
        ...
        /**
         * The uncertainty in the zero point for the filter denoted in spectralFilters. For use with
         * All Sky photometry. Must be present for all values n=1 to numSpectralFilters, in
         ...
         *
         * Unlike [imageBoreRaDec], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("imageBoreRaDec")
        @ExcludeMissing
         ...
         *
         * Unlike [imageBoreVector], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("imageBoreVector")
        @ExcludeMissing
         ...
         *
         * Unlike [imageFovHeight], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("imageFOVHeight")
        @ExcludeMissing
         ...
         *
         * Unlike [imageHorizVector], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("imageHorizVector")
        @ExcludeMissing
         ...
         *
         * Unlike [imageVertVector], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("imageVertVector")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(eoobservationDetails: EoobservationDetails) = apply {
                ...
                imageBoreVector = eoobservationDetails.imageBoreVector.map { it.toMutableList() }
                ...
                imageHorizVector = eoobservationDetails.imageHorizVector.map { it.toMutableList() }
                imageVertVector = eoobservationDetails.imageVertVector.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.imageBoreVector] with a well-typed `List<Double>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.imageCorners] with a well-typed `List<List<Double>>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /** Width of the image field of view, in degrees. */
            fun imageFovWidth(imageFovWidth: Double) = imageFovWidth(JsonField.of(imageFovWidth))
             ...
             *
             * You should usually call [Builder.imageHorizVector] with a well-typed `List<Double>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.imageVertVector] with a well-typed `List<Double>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EoObservationFull &&
            classificationMarking == other.classificationMarking &&
            dataMode == other.dataMode &&
            obTime == other.obTime &&
            source == other.source &&
