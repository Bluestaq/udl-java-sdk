...
class SeradataSigintPayloadListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataSigintPayloadListResponse].
         *
    ...
    /** A builder for [SeradataSigintPayloadListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataSigintPayloadListResponse: SeradataSigintPayloadListResponse) =
            apply {
                classificationMarking = seradataSigintPayloadListResponse.classificationMarking
                dataMode = seradataSigintPayloadListResponse.dataMode
                source = seradataSigintPayloadListResponse.source
                spacecraftId = seradataSigintPayloadListResponse.spacecraftId
                id = seradataSigintPayloadListResponse.id
                createdAt = seradataSigintPayloadListResponse.createdAt
                createdBy = seradataSigintPayloadListResponse.createdBy
                frequencyCoverage = seradataSigintPayloadListResponse.frequencyCoverage
                groundStationLocations = seradataSigintPayloadListResponse.groundStationLocations
                groundStations = seradataSigintPayloadListResponse.groundStations
                hostedForCompanyOrgId = seradataSigintPayloadListResponse.hostedForCompanyOrgId
                idSensor = seradataSigintPayloadListResponse.idSensor
                interceptParameters = seradataSigintPayloadListResponse.interceptParameters
                manufacturerOrgId = seradataSigintPayloadListResponse.manufacturerOrgId
                name = seradataSigintPayloadListResponse.name
                notes = seradataSigintPayloadListResponse.notes
                origin = seradataSigintPayloadListResponse.origin
                origNetwork = seradataSigintPayloadListResponse.origNetwork
                positionalAccuracy = seradataSigintPayloadListResponse.positionalAccuracy
                swathWidth = seradataSigintPayloadListResponse.swathWidth
                type = seradataSigintPayloadListResponse.type
                additionalProperties = seradataSigintPayloadListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataSigintPayloadListResponse].
         *
         ...
         */
        fun build(): SeradataSigintPayloadListResponse =
    ...
    fun validate(): SeradataSigintPayloadListResponse =
        apply {
            if (validated) {
              return@apply
            }
