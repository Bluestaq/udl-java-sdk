 ...
 */
class AirTaskingOrderListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirTaskingOrderListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderListParams: AirTaskingOrderListParams) = apply {
    ...
    override fun toString() =
        "AirTaskingOrderListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
