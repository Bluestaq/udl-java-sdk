...
class NavigationTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationTupleResponse: NavigationTupleResponse) =
            apply {
    ...
    fun validate(): NavigationTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
