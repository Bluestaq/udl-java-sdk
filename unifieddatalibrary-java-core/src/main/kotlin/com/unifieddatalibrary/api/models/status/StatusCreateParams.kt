...
/**
 * Service operation to take a single Status as a POST body and ingest into the database. A specific
 * role is required to perform this service operation. Please contact the UDL team for assistance.
 */
class StatusCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusCreateParams: StatusCreateParams) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StatusCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "StatusCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
