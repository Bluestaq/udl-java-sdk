...
class EquipmentTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EquipmentTupleParams].
         *
    ...
    /** A builder for [EquipmentTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentTupleParams: EquipmentTupleParams) =
            apply {
                columns = equipmentTupleParams.columns
                firstResult = equipmentTupleParams.firstResult
                maxResults = equipmentTupleParams.maxResults
                additionalHeaders = equipmentTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = equipmentTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EquipmentTupleParams].
         *
         ...
         */
        fun build(): EquipmentTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EquipmentTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EquipmentTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
