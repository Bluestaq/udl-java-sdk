    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyQueryResponse: HistoryQueryResponse) =
            apply {
                ...
                startTime = historyQueryResponse.startTime
                id = historyQueryResponse.id
                azRaAccelBias = historyQueryResponse.azRaAccelBias
                azRaAccelSigma = historyQueryResponse.azRaAccelSigma
                azRaBias = historyQueryResponse.azRaBias
                azRaRateBias = historyQueryResponse.azRaRateBias
                azRaRateSigma = historyQueryResponse.azRaRateSigma
                azRaRms = historyQueryResponse.azRaRms
                azRaSigma = historyQueryResponse.azRaSigma
                calAngleRef = historyQueryResponse.calAngleRef
                calTrackMode = historyQueryResponse.calTrackMode
                calType = historyQueryResponse.calType
                confidenceNoiseBias = historyQueryResponse.confidenceNoiseBias
                createdAt = historyQueryResponse.createdAt
                createdBy = historyQueryResponse.createdBy
                duration = historyQueryResponse.duration
                ecr = historyQueryResponse.ecr.map { it.toMutableList() }
                elDecAccelBias = historyQueryResponse.elDecAccelBias
                elDecAccelSigma = historyQueryResponse.elDecAccelSigma
                elDecBias = historyQueryResponse.elDecBias
                elDecRateBias = historyQueryResponse.elDecRateBias
                elDecRateSigma = historyQueryResponse.elDecRateSigma
                elDecRms = historyQueryResponse.elDecRms
                elDecSigma = historyQueryResponse.elDecSigma
                endTime = historyQueryResponse.endTime
                numAzRaObs = historyQueryResponse.numAzRaObs
                numElDecObs = historyQueryResponse.numElDecObs
                numObs = historyQueryResponse.numObs
                numPhotoObs = historyQueryResponse.numPhotoObs
                numRangeObs = historyQueryResponse.numRangeObs
                numRangeRateObs = historyQueryResponse.numRangeRateObs
                numRcsObs = historyQueryResponse.numRcsObs
                numTimeObs = historyQueryResponse.numTimeObs
                numTracks = historyQueryResponse.numTracks
                origin = historyQueryResponse.origin
                origNetwork = historyQueryResponse.origNetwork
                photoBias = historyQueryResponse.photoBias
                photoSigma = historyQueryResponse.photoSigma
                rangeAccelBias = historyQueryResponse.rangeAccelBias
                rangeAccelSigma = historyQueryResponse.rangeAccelSigma
                rangeBias = historyQueryResponse.rangeBias
                rangeRateBias = historyQueryResponse.rangeRateBias
                rangeRateRms = historyQueryResponse.rangeRateRms
                rangeRateSigma = historyQueryResponse.rangeRateSigma
                rangeRms = historyQueryResponse.rangeRms
                rangeSigma = historyQueryResponse.rangeSigma
                rcsBias = historyQueryResponse.rcsBias
                rcsSigma = historyQueryResponse.rcsSigma
                refTargets = historyQueryResponse.refTargets.map { it.toMutableList() }
                refType = historyQueryResponse.refType
                senType = historyQueryResponse.senType
                sourceDl = historyQueryResponse.sourceDl
                timeBias = historyQueryResponse.timeBias
                timeBiasSigma = historyQueryResponse.timeBiasSigma
