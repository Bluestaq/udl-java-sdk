...
class EcpsdrCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpsdrCountParams].
         *
    ...
    /** A builder for [EcpsdrCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrCountParams: EcpsdrCountParams) =
            apply {
                msgTime = ecpsdrCountParams.msgTime
                firstResult = ecpsdrCountParams.firstResult
                maxResults = ecpsdrCountParams.maxResults
                additionalHeaders = ecpsdrCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = ecpsdrCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EcpsdrCountParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EcpsdrCountParams && msgTime == other.msgTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EcpsdrCountParams{msgTime=$msgTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
