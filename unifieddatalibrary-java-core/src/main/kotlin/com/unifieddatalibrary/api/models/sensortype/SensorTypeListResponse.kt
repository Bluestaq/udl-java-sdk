...
class SensorTypeListResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SensorTypeListResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorTypeListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeListResponse: SensorTypeListResponse) =
            apply {
                id = sensorTypeListResponse.id
                createdAt = sensorTypeListResponse.createdAt
                createdBy = sensorTypeListResponse.createdBy
                origNetwork = sensorTypeListResponse.origNetwork
                type = sensorTypeListResponse.type
                additionalProperties = sensorTypeListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorTypeListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorTypeListResponse =
    ...
    fun validate(): SensorTypeListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "SensorTypeListResponse{id=$id, createdAt=$createdAt, createdBy=$createdBy, origNetwork=$origNetwork, type=$type, additionalProperties=$additionalProperties}"
}
