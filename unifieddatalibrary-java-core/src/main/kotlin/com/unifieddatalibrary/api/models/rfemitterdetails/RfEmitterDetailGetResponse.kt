 ...
 */
class RfEmitterDetailGetResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailGetResponse: RfEmitterDetailGetResponse) = apply {
            ...
            antennas = rfEmitterDetailGetResponse.antennas.map { it.toMutableList() }
            barrageNoiseBandwidth = rfEmitterDetailGetResponse.barrageNoiseBandwidth
            bitRunTime = rfEmitterDetailGetResponse.bitRunTime
            ...
            fixedAttenuation = rfEmitterDetailGetResponse.fixedAttenuation
            idManufacturerOrg = rfEmitterDetailGetResponse.idManufacturerOrg
            idProductionFacilityLocation = rfEmitterDetailGetResponse.idProductionFacilityLocation
            loanedToCocom = rfEmitterDetailGetResponse.loanedToCocom
            ...
            powerOffsets = rfEmitterDetailGetResponse.powerOffsets.map { it.toMutableList() }
            prepTime = rfEmitterDetailGetResponse.prepTime
            primaryCocom = rfEmitterDetailGetResponse.primaryCocom
            ...
            services = rfEmitterDetailGetResponse.services.map { it.toMutableList() }
            ...
            ttps = rfEmitterDetailGetResponse.ttps.map { it.toMutableList() }
    ...
    fun validate(): RfEmitterDetailGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RfEmitterDetailGetResponse &&
