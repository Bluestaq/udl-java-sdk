...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchVehicleListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleListParams: LaunchVehicleListParams) = apply {
    ...
    override fun toString() =
        "LaunchVehicleListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
