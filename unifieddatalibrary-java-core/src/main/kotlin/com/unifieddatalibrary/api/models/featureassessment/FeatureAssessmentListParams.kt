 ...
 */
class FeatureAssessmentListParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeatureAssessmentListParams].
         *
    ...
    /** A builder for [FeatureAssessmentListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentListParams: FeatureAssessmentListParams) = apply {
            idAnalyticImagery = featureAssessmentListParams.idAnalyticImagery
            firstResult = featureAssessmentListParams.firstResult
            maxResults = featureAssessmentListParams.maxResults
            additionalHeaders = featureAssessmentListParams.additionalHeaders.toBuilder()
            additionalQueryParams = featureAssessmentListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentListParams].
         *
         ...
         */
        fun build(): FeatureAssessmentListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureAssessmentListParams &&
    ...
    override fun toString() =
        "FeatureAssessmentListParams{idAnalyticImagery=$idAnalyticImagery, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
