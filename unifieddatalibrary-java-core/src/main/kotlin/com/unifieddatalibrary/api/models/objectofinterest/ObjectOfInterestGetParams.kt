...
class ObjectOfInterestGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ObjectOfInterestGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ObjectOfInterestGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ObjectOfInterestGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectOfInterestGetParams: ObjectOfInterestGetParams) =
            apply {
                id = objectOfInterestGetParams.id
                firstResult = objectOfInterestGetParams.firstResult
                maxResults = objectOfInterestGetParams.maxResults
                additionalHeaders = objectOfInterestGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = objectOfInterestGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ObjectOfInterestGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ObjectOfInterestGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ObjectOfInterestGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ObjectOfInterestGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
