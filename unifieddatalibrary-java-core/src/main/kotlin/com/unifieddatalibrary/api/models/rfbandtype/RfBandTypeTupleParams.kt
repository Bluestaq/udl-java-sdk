...
class RfBandTypeTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfBandTypeTupleParams].
         *
    ...
    /** A builder for [RfBandTypeTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeTupleParams: RfBandTypeTupleParams) =
            apply {
                columns = rfBandTypeTupleParams.columns
                firstResult = rfBandTypeTupleParams.firstResult
                maxResults = rfBandTypeTupleParams.maxResults
                additionalHeaders = rfBandTypeTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfBandTypeTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfBandTypeTupleParams].
         *
         ...
         */
        fun build(): RfBandTypeTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfBandTypeTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfBandTypeTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
