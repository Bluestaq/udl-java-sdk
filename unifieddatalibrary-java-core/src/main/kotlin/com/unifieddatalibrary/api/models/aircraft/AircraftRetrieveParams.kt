...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AircraftRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AircraftRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AircraftRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftRetrieveParams: AircraftRetrieveParams) = apply {
            id = aircraftRetrieveParams.id
            firstResult = aircraftRetrieveParams.firstResult
            maxResults = aircraftRetrieveParams.maxResults
            additionalHeaders = aircraftRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AircraftRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AircraftRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
