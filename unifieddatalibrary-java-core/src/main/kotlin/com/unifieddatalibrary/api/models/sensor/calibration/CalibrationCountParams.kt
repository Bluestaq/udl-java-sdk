...
class CalibrationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalibrationCountParams].
         *
    ...
    /** A builder for [CalibrationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationCountParams: CalibrationCountParams) =
            apply {
                startTime = calibrationCountParams.startTime
                firstResult = calibrationCountParams.firstResult
                maxResults = calibrationCountParams.maxResults
                additionalHeaders = calibrationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = calibrationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CalibrationCountParams].
         *
         ...
         */
        fun build(): CalibrationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CalibrationCountParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CalibrationCountParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
