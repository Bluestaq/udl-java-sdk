 ...
 * parameter.
 */
class SeraDataCommDetailGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeraDataCommDetailGetParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [SeraDataCommDetailGetParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SeraDataCommDetailGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataCommDetailGetParams: SeraDataCommDetailGetParams) = apply {
            id = seraDataCommDetailGetParams.id
            firstResult = seraDataCommDetailGetParams.firstResult
            maxResults = seraDataCommDetailGetParams.maxResults
            additionalHeaders = seraDataCommDetailGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = seraDataCommDetailGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataCommDetailGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeraDataCommDetailGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeraDataCommDetailGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeraDataCommDetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
