...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DetailQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DetailQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailQueryhelpResponse: DetailQueryhelpResponse) = apply {
            aodrSupported = detailQueryhelpResponse.aodrSupported
            classificationMarking = detailQueryhelpResponse.classificationMarking
            description = detailQueryhelpResponse.description
            historySupported = detailQueryhelpResponse.historySupported
            name = detailQueryhelpResponse.name
            parameters = detailQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = detailQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = detailQueryhelpResponse.restSupported
            sortSupported = detailQueryhelpResponse.sortSupported
            typeName = detailQueryhelpResponse.typeName
            uri = detailQueryhelpResponse.uri
            additionalProperties = detailQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DetailQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DetailQueryhelpResponse =
    ...
    fun validate(): DetailQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailQueryhelpResponse &&
