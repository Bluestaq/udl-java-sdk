...
class FeatureAssessmentQueryHelpResponse
private constructor(
    ...
    /** A builder for [FeatureAssessmentQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentQueryHelpResponse: FeatureAssessmentQueryHelpResponse) =
            apply {
                aodrSupported = featureAssessmentQueryHelpResponse.aodrSupported
                classificationMarking = featureAssessmentQueryHelpResponse.classificationMarking
                description = featureAssessmentQueryHelpResponse.description
                historySupported = featureAssessmentQueryHelpResponse.historySupported
                name = featureAssessmentQueryHelpResponse.name
                parameters =
                    featureAssessmentQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    featureAssessmentQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = featureAssessmentQueryHelpResponse.restSupported
                sortSupported = featureAssessmentQueryHelpResponse.sortSupported
                typeName = featureAssessmentQueryHelpResponse.typeName
                uri = featureAssessmentQueryHelpResponse.uri
                additionalProperties =
                    featureAssessmentQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FeatureAssessmentQueryHelpResponse =
            FeatureAssessmentQueryHelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): FeatureAssessmentQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
