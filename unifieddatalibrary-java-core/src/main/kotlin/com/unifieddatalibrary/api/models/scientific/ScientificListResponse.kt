...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScientificListResponse].
         *
    ...
    /** A builder for [ScientificListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificListResponse: ScientificListResponse) = apply {
            classificationMarking = scientificListResponse.classificationMarking
            dataMode = scientificListResponse.dataMode
            name = scientificListResponse.name
            source = scientificListResponse.source
            spacecraftId = scientificListResponse.spacecraftId
            id = scientificListResponse.id
            createdAt = scientificListResponse.createdAt
            createdBy = scientificListResponse.createdBy
            frequencyBand = scientificListResponse.frequencyBand
            hostedForCompanyOrgId = scientificListResponse.hostedForCompanyOrgId
            idEntity = scientificListResponse.idEntity
            manufacturerOrgId = scientificListResponse.manufacturerOrgId
            notes = scientificListResponse.notes
            origin = scientificListResponse.origin
            origNetwork = scientificListResponse.origNetwork
            payloadCategory = scientificListResponse.payloadCategory
            additionalProperties = scientificListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScientificListResponse].
         *
         ...
         */
        fun build(): ScientificListResponse =
    ...
    fun validate(): ScientificListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScientificListResponse &&
