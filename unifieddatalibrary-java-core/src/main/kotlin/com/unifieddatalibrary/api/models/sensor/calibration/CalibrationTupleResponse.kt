...
class CalibrationTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationTupleResponse: CalibrationTupleResponse) =
            apply {
    ...
    fun validate(): CalibrationTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
