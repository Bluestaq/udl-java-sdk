...
class LogisticsDiscrepancyInfosFull private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LogisticsDiscrepancyInfosFull]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsDiscrepancyInfosFull: LogisticsDiscrepancyInfosFull) =
            apply {
    ...
    fun validate(): LogisticsDiscrepancyInfosFull =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "LogisticsDiscrepancyInfosFull{closureTime=$closureTime, discrepancyInfo=$discrepancyInfo, jcn=$jcn, jobStTime=$jobStTime, additionalProperties=$additionalProperties}"
}
