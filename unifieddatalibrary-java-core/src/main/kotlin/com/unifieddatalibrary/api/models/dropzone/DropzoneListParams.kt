...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DropzoneListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DropzoneListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DropzoneListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneListParams: DropzoneListParams) = apply {
            firstResult = dropzoneListParams.firstResult
            maxResults = dropzoneListParams.maxResults
            additionalHeaders = dropzoneListParams.additionalHeaders.toBuilder()
            additionalQueryParams = dropzoneListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DropzoneListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DropzoneListParams =
            DropzoneListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DropzoneListParams &&
    ...
    override fun toString() =
        "DropzoneListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
