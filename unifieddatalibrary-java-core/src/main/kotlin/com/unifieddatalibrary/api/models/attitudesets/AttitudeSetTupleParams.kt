...
class AttitudeSetTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AttitudeSetTupleParams].
         *
    ...
    /** A builder for [AttitudeSetTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeSetTupleParams: AttitudeSetTupleParams) =
            apply {
                columns = attitudeSetTupleParams.columns
                startTime = attitudeSetTupleParams.startTime
                firstResult = attitudeSetTupleParams.firstResult
                maxResults = attitudeSetTupleParams.maxResults
                additionalHeaders = attitudeSetTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = attitudeSetTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AttitudeSetTupleParams].
         *
         ...
         */
        fun build(): AttitudeSetTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AttitudeSetTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AttitudeSetTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
