 ...
 */
class EffectRequestCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun effectList(): List<String> = body.effectList()
     ...
     *   if the server responded with an unexpected value).
     */
    fun deadlineType(): Optional<String> = body.deadlineType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun metricTypes(): Optional<List<String>> = body.metricTypes()
     ...
     *   if the server responded with an unexpected value).
     */
    fun metricWeights(): Optional<List<Double>> = body.metricWeights()
     ...
     *   if the server responded with an unexpected value).
     */
    fun modelClass(): Optional<String> = body.modelClass()
     ...
     *   if the server responded with an unexpected value).
     */
    fun targetSrcId(): Optional<String> = body.targetSrcId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun targetSrcType(): Optional<String> = body.targetSrcType()
     ...
     */
    fun _effectList(): JsonField<List<String>> = body._effectList()
     ...
     */
    fun _deadlineType(): JsonField<String> = body._deadlineType()
     ...
     */
    fun _metricTypes(): JsonField<List<String>> = body._metricTypes()
     ...
     */
    fun _metricWeights(): JsonField<List<Double>> = body._metricWeights()
     ...
     */
    fun _modelClass(): JsonField<String> = body._modelClass()
     ...
     */
    fun _targetSrcId(): JsonField<String> = body._targetSrcId()
     ...
     */
    fun _targetSrcType(): JsonField<String> = body._targetSrcType()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectRequestCreateParams].
         *
    ...
    /** A builder for [EffectRequestCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestCreateParams: EffectRequestCreateParams) = apply {
            body = effectRequestCreateParams.body.toBuilder()
            additionalHeaders = effectRequestCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = effectRequestCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * implied AND.
         */
        fun effectList(effectList: List<String>) = apply { body.effectList(effectList) }
         ...
         * supported value.
         */
        fun effectList(effectList: JsonField<List<String>>) = apply { body.effectList(effectList) }
         ...
         */
        fun addEffectList(effectList: String) = apply { body.addEffectList(effectList) }
         ...
         * earlier as long as the effect starts by the given time.
         */
        fun deadlineType(deadlineType: String) = apply { body.deadlineType(deadlineType) }
        ...
        fun deadlineType(deadlineType: JsonField<String>) = apply {
            body.deadlineType(deadlineType)
        }
         ...
         */
        fun metricTypes(metricTypes: List<String>) = apply { body.metricTypes(metricTypes) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addMetricType(metricType: String) = apply { body.addMetricType(metricType) }
         ...
         */
        fun metricWeights(metricWeights: List<Double>) = apply { body.metricWeights(metricWeights) }
        ...
        fun metricWeights(metricWeights: JsonField<List<Double>>) = apply {
            body.metricWeights(metricWeights)
        }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addMetricWeight(metricWeight: Double) = apply { body.addMetricWeight(metricWeight) }

        /** The type or class of the preference model used to evaluate this offer. */
        fun modelClass(modelClass: String) = apply { body.modelClass(modelClass) }
         ...
         * value.
         */
        fun modelClass(modelClass: JsonField<String>) = apply { body.modelClass(modelClass) }
         ...
         * respective schemas.
         */
        fun targetSrcId(targetSrcId: String) = apply { body.targetSrcId(targetSrcId) }
         ...
         * value.
         */
        fun targetSrcId(targetSrcId: JsonField<String>) = apply { body.targetSrcId(targetSrcId) }

        /** The source type of the targetId identifier (POI, TRACK). */
        fun targetSrcType(targetSrcType: String) = apply { body.targetSrcType(targetSrcType) }
        ...
        fun targetSrcType(targetSrcType: JsonField<String>) = apply {
            body.targetSrcType(targetSrcType)
        }
        ...
        /**
         * Returns an immutable instance of [EffectRequestCreateParams].
         *
         ...
         */
        fun build(): EffectRequestCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EffectRequestCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "EffectRequestCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
