...
class OnorbitlistListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<OnorbitlistListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistListPageAsync: OnorbitlistListPageAsync) = apply {
        ...
        fun service(service: OnorbitlistServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitlistListPageAsync &&
    ...
    override fun toString() =
        "OnorbitlistListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
