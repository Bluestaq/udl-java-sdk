...
class LogisticsSupportListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<LogisticsSupportListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportListPageAsync: LogisticsSupportListPageAsync) = apply {
        ...
        fun service(service: LogisticsSupportServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LogisticsSupportListPageAsync &&
    ...
    override fun toString() =
        "LogisticsSupportListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
