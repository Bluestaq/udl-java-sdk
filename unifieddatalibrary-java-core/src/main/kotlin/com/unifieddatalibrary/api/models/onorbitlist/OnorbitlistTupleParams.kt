...
class OnorbitlistTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitlistTupleParams].
         *
    ...
    /** A builder for [OnorbitlistTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistTupleParams: OnorbitlistTupleParams) =
            apply {
                columns = onorbitlistTupleParams.columns
                firstResult = onorbitlistTupleParams.firstResult
                maxResults = onorbitlistTupleParams.maxResults
                additionalHeaders = onorbitlistTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitlistTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitlistTupleParams].
         *
         ...
         */
        fun build(): OnorbitlistTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitlistTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnorbitlistTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
