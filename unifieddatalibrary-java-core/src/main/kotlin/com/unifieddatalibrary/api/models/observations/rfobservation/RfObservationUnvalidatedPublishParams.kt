...
/**
 * Service operation to take multiple RF observations as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class RfObservationUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            rfObservationUnvalidatedPublishParams: RfObservationUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                rfObservationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            pnOrders: JsonField<List<Int>> = JsonMissing.of(),
            ...
            @JsonProperty("powers")
            @ExcludeMissing
            powers: JsonField<List<Double>> = JsonMissing.of(),
         ...
         *
         * Unlike [constellationXPoints], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("constellationXPoints")
        @ExcludeMissing
         ...
         *
         * Unlike [constellationYPoints], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("constellationYPoints")
        @ExcludeMissing
         ...
         *
         * Unlike [fftImagCoeffs], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("fftImagCoeffs")
        @ExcludeMissing
         ...
         *
         * Unlike [fftRealCoeffs], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("fftRealCoeffs")
        @ExcludeMissing
        ...
        @JsonProperty("jamBands")
        @ExcludeMissing
        fun _jamBands(): JsonField<List<String>> = jamBands

        /**
         * Returns the raw JSON value of [jamToSigRatios].
         *
         * Unlike [jamToSigRatios], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("jamToSigRatios")
        @ExcludeMissing
         ...
         *
         * Unlike [telemetryIds], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("telemetryIds")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                fftImagCoeffs = body.fftImagCoeffs.map { it.toMutableList() }
                fftRealCoeffs = body.fftRealCoeffs.map { it.toMutableList() }
                ...
                jamBands = body.jamBands.map { it.toMutableList() }
                jamToSigRatios = body.jamToSigRatios.map { it.toMutableList() }
                maxPsd = body.maxPsd
                minPsd = body.minPsd
                ...
                origCountry = body.origCountry
                origin = body.origin
                origMarking = body.origMarking
            ...
            /**
             * Array of individual x-coordinates for demodulated signal constellation. This array
             * should correspond with the same-sized array of constellationYPoints.
             */
             ...
             *
             * You should usually call [Builder.constellationXPoints] with a well-typed
            ...
            /**
             * Array of individual y-coordinates for demodulated signal constellation. This array
             * should correspond with the same-sized array of constellationXPoints.
             */
             ...
             *
             * You should usually call [Builder.constellationYPoints] with a well-typed
             * `List<Double>` value instead. This method is primarily for setting the field to an
             * undocumented or not yet supported value.
             */
             ...
             * coefficients from the signal. Used together with the same-sized fftRealCoeffs array
             * to preserve both amplitude and phase information. This array should correspond with
             * the same-sized array of frequencies.
             */
            fun fftImagCoeffs(fftImagCoeffs: List<Double>) =
                fftImagCoeffs(JsonField.of(fftImagCoeffs))

            /**
             * Sets [Builder.fftImagCoeffs] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fftImagCoeffs] with a well-typed `List<Double>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /**
             * Array of real components of the complex Fast Fourier Transform (FFT) coefficients
             * from the signal. Used together with the same-sized fftImagCoeffs array to preserve
             * both amplitude and phase information. This array should correspond with the
             * same-sized array of frequencies.
             */
            fun fftRealCoeffs(fftRealCoeffs: List<Double>) =
                fftRealCoeffs(JsonField.of(fftRealCoeffs))

            /**
             * Sets [Builder.fftRealCoeffs] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fftRealCoeffs] with a well-typed `List<Double>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /**
             * Array of jamming-to-signal power ratios at the receiver for the specified jamBands,
             * in decibels. The values in this array must correspond to the position index in
             * jamBands. This array must be the same length as jamBands.
             */
             ...
             *
             * You should usually call [Builder.jamToSigRatios] with a well-typed `List<Double>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.pnOrders] with a well-typed `List<Int>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Array of individual measured PSD powers of the signal in decibel watts. This array
             ...
             *
             * You should usually call [Builder.powers] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RfObservationUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "RfObservationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
