...
class StarCatalogTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StarCatalogTupleParams].
         *
    ...
    /** A builder for [StarCatalogTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogTupleParams: StarCatalogTupleParams) =
            apply {
                columns = starCatalogTupleParams.columns
                dec = starCatalogTupleParams.dec
                firstResult = starCatalogTupleParams.firstResult
                maxResults = starCatalogTupleParams.maxResults
                ra = starCatalogTupleParams.ra
                additionalHeaders = starCatalogTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = starCatalogTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [StarCatalogTupleParams].
         *
         ...
         */
        fun build(): StarCatalogTupleParams =
    ...
    override fun toString() = "StarCatalogTupleParams{columns=$columns, dec=$dec, firstResult=$firstResult, maxResults=$maxResults, ra=$ra, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
