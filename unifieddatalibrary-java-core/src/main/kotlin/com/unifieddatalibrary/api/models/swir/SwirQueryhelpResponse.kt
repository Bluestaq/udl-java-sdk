...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SwirQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SwirQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(swirQueryhelpResponse: SwirQueryhelpResponse) = apply {
            aodrSupported = swirQueryhelpResponse.aodrSupported
            classificationMarking = swirQueryhelpResponse.classificationMarking
            description = swirQueryhelpResponse.description
            historySupported = swirQueryhelpResponse.historySupported
            name = swirQueryhelpResponse.name
            parameters = swirQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = swirQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = swirQueryhelpResponse.restSupported
            sortSupported = swirQueryhelpResponse.sortSupported
            typeName = swirQueryhelpResponse.typeName
            uri = swirQueryhelpResponse.uri
            additionalProperties = swirQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SwirQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SwirQueryhelpResponse =
    ...
    fun validate(): SwirQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SwirQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
