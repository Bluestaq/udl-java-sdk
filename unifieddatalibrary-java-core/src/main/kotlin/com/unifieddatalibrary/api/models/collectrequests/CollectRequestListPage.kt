...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestListPage: CollectRequestListPage) = apply {
            service = collectRequestListPage.service
            params = collectRequestListPage.params
            items = collectRequestListPage.items
        }

        fun service(service: CollectRequestService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectRequestListPage &&
    ...
    override fun toString() =
        "CollectRequestListPage{service=$service, params=$params, items=$items}"
}
