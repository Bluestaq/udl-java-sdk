...
class DiffofarrivalCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiffofarrivalCreateBulkParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffofarrivalCreateBulkParams: DiffofarrivalCreateBulkParams) =
            apply {
    ...
    override fun toString() = "DiffofarrivalCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
