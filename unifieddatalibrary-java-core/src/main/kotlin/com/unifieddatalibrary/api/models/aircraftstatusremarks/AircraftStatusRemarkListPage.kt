...
class AircraftStatusRemarkListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusRemarkListPage: AircraftStatusRemarkListPage) =
            apply {
        ...
        fun service(service: AircraftStatusRemarkService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftStatusRemarkListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, params, items) /* spotless:on */

    override fun toString() = "AircraftStatusRemarkListPage{service=$service, params=$params, items=$items}"
}
