    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyQueryResponse: HistoryQueryResponse) =
            apply {
                ...
                filename = historyQueryResponse.filename
                imageTime = historyQueryResponse.imageTime
                source = historyQueryResponse.source
                id = historyQueryResponse.id
                checksumValue = historyQueryResponse.checksumValue
                createdAt = historyQueryResponse.createdAt
                createdBy = historyQueryResponse.createdBy
                filesize = historyQueryResponse.filesize
                format = historyQueryResponse.format
                idSensor = historyQueryResponse.idSensor
                keywords = historyQueryResponse.keywords.map { it.toMutableList() }
                name = historyQueryResponse.name
                notes = historyQueryResponse.notes
                ...
                region = historyQueryResponse.region
                regionGeoJson = historyQueryResponse.regionGeoJson
                regionNDims = historyQueryResponse.regionNDims
                regionSRid = historyQueryResponse.regionSRid
                regionText = historyQueryResponse.regionText
                regionType = historyQueryResponse.regionType
                sourceDl = historyQueryResponse.sourceDl
                subjectId = historyQueryResponse.subjectId
