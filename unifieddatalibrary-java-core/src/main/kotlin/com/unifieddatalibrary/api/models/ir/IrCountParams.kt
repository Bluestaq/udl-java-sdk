...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IrCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IrCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IrCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(irCountParams: IrCountParams) = apply {
            firstResult = irCountParams.firstResult
            maxResults = irCountParams.maxResults
            additionalHeaders = irCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = irCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IrCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IrCountParams =
            IrCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IrCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "IrCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
