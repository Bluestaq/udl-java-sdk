...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamContourCountParams: BeamContourCountParams) = apply {
        ...
        /** ID of the beam. */
        fun idBeam(idBeam: String) = apply { this.idBeam = idBeam }
    ...
    override fun toString() =
        "BeamContourCountParams{idBeam=$idBeam, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
