...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorStatingListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SensorStatingListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SensorStatingListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorStatingListParams: SensorStatingListParams) = apply {
            firstResult = sensorStatingListParams.firstResult
            maxResults = sensorStatingListParams.maxResults
            additionalHeaders = sensorStatingListParams.additionalHeaders.toBuilder()
            additionalQueryParams = sensorStatingListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SensorStatingListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorStatingListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorStatingListParams &&
    ...
    override fun toString() =
        "SensorStatingListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
