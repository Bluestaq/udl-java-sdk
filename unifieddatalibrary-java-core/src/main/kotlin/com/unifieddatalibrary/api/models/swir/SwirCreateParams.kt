...
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun absFluxes(): Optional<List<Double>> = body.absFluxes()
     ...
     *   if the server responded with an unexpected value).
     */
    fun badWave(): Optional<String> = body.badWave()
     ...
     *   if the server responded with an unexpected value).
     */
    fun fluxRatios(): Optional<List<Double>> = body.fluxRatios()
    ...
    /**
     * Spacecraft WGS84 latitude, in degrees at obTime. -90 to 90 degrees (negative values south of
     * equator).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     *   if the server responded with an unexpected value).
     */
    fun locationName(): Optional<String> = body.locationName()

    /**
     * Spacecraft WGS84 longitude at ob time, in degrees. -180 to 180 degrees (negative values west
     * of Prime Meridian).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     *   if the server responded with an unexpected value).
     */
    fun ratioWavelengths(): Optional<List<Double>> = body.ratioWavelengths()
    ...
    /**
     * Array of wavelengths, in microns. This array should correspond with the same-sized array of
     * absFluxes.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun wavelengths(): Optional<List<Double>> = body.wavelengths()
     ...
     */
    fun _absFluxes(): JsonField<List<Double>> = body._absFluxes()
     ...
     */
    fun _badWave(): JsonField<String> = body._badWave()
     ...
     */
    fun _fluxRatios(): JsonField<List<Double>> = body._fluxRatios()
     ...
     */
    fun _locationName(): JsonField<String> = body._locationName()
     ...
     * type.
     */
    fun _ratioWavelengths(): JsonField<List<Double>> = body._ratioWavelengths()
     ...
     */
    fun _wavelengths(): JsonField<List<Double>> = body._wavelengths()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SwirCreateParams].
         *
    ...
    /** A builder for [SwirCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(swirCreateParams: SwirCreateParams) = apply {
            body = swirCreateParams.body.toBuilder()
            additionalHeaders = swirCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = swirCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * array should correspond with the same-sized array of wavelengths.
         */
        fun absFluxes(absFluxes: List<Double>) = apply { body.absFluxes(absFluxes) }
         ...
         * supported value.
         */
        fun absFluxes(absFluxes: JsonField<List<Double>>) = apply { body.absFluxes(absFluxes) }
         ...
         */
        fun addAbsFlux(absFlux: Double) = apply { body.addAbsFlux(absFlux) }

        /** User comments concerning sensor or data limitations. */
        fun badWave(badWave: String) = apply { body.badWave(badWave) }

        /**
         * Sets [Builder.badWave] to an arbitrary JSON value.
         *
         * You should usually call [Builder.badWave] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun badWave(badWave: JsonField<String>) = apply { body.badWave(badWave) }
         ...
         * ratioWavelengths.
         */
        fun fluxRatios(fluxRatios: List<Double>) = apply { body.fluxRatios(fluxRatios) }
         ...
         * supported value.
         */
        fun fluxRatios(fluxRatios: JsonField<List<Double>>) = apply { body.fluxRatios(fluxRatios) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFluxRatio(fluxRatio: Double) = apply { body.addFluxRatio(fluxRatio) }
        ...
        /** Location/name of the observing sensor. */
        fun locationName(locationName: String) = apply { body.locationName(locationName) }
         ...
         * fluxRatios.
         */
        fun ratioWavelengths(ratioWavelengths: List<Double>) = apply {
            body.ratioWavelengths(ratioWavelengths)
        }

        /**
         * Sets [Builder.ratioWavelengths] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ratioWavelengths] with a well-typed `List<Double>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun addRatioWavelength(ratioWavelength: Double) = apply {
            body.addRatioWavelength(ratioWavelength)
        }
         ...
         * of absFluxes.
         */
        fun wavelengths(wavelengths: List<Double>) = apply { body.wavelengths(wavelengths) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addWavelength(wavelength: Double) = apply { body.addWavelength(wavelength) }
        ...
        /**
         * Returns an immutable instance of [SwirCreateParams].
         *
         ...
         */
        fun build(): SwirCreateParams =
            SwirCreateParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
