...
class OrganizationdetailUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationdetailUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationdetailUpdateParams: OrganizationdetailUpdateParams) =
            apply {
        ...
        /** Former organization ID (if this organization previously existed as another organization). */
        fun formerOrgId(formerOrgId: String) =
            apply {
                body.formerOrgId(formerOrgId)
            }
        ...
        /** Mass ranking for this organization. */
        fun massRanking(massRanking: Int) =
            apply {
                body.massRanking(massRanking)
            }
        ...
        /** Parent organization ID of this organization if it is a child organization. */
        fun parentOrgId(parentOrgId: String) =
            apply {
                body.parentOrgId(parentOrgId)
            }
        ...
        /** Revenue ranking for this organization. */
        fun revenueRanking(revenueRanking: Int) =
            apply {
        ...
        /** The name of the risk manager for the organization. */
        fun riskManager(riskManager: String) =
            apply {
                body.riskManager(riskManager)
            }
        ...
        /** Notes on the services provided by the organization. */
        fun servicesNotes(servicesNotes: String) =
            apply {
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idOrganization.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (address1.asKnown().isPresent) 1 else 0) + (if (address2.asKnown().isPresent) 1 else 0) + (if (address3.asKnown().isPresent) 1 else 0) + (if (broker.asKnown().isPresent) 1 else 0) + (if (ceo.asKnown().isPresent) 1 else 0) + (if (cfo.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (cto.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (ebitda.asKnown().isPresent) 1 else 0) + (if (email.asKnown().isPresent) 1 else 0) + (if (financialNotes.asKnown().isPresent) 1 else 0) + (if (financialYearEndDate.asKnown().isPresent) 1 else 0) + (if (fleetPlanNotes.asKnown().isPresent) 1 else 0) + (if (formerOrgId.asKnown().isPresent) 1 else 0) + (if (ftes.asKnown().isPresent) 1 else 0) + (if (geoAdminLevel1.asKnown().isPresent) 1 else 0) + (if (geoAdminLevel2.asKnown().isPresent) 1 else 0) + (if (geoAdminLevel3.asKnown().isPresent) 1 else 0) + (if (massRanking.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (parentOrgId.asKnown().isPresent) 1 else 0) + (if (postalCode.asKnown().isPresent) 1 else 0) + (if (profit.asKnown().isPresent) 1 else 0) + (if (revenue.asKnown().isPresent) 1 else 0) + (if (revenueRanking.asKnown().isPresent) 1 else 0) + (if (riskManager.asKnown().isPresent) 1 else 0) + (if (servicesNotes.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrganizationdetailUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OrganizationdetailUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
