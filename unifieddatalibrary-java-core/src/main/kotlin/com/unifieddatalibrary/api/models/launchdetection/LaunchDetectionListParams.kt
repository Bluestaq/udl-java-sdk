 ...
 */
class LaunchDetectionListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchDetectionListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionListParams: LaunchDetectionListParams) = apply {
    ...
    override fun toString() =
        "LaunchDetectionListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
