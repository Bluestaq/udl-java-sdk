 ...
 */
class AircraftSortieCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftSortieCountParams].
         *
    ...
    /** A builder for [AircraftSortieCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortieCountParams: AircraftSortieCountParams) = apply {
            plannedDepTime = aircraftSortieCountParams.plannedDepTime
            firstResult = aircraftSortieCountParams.firstResult
            maxResults = aircraftSortieCountParams.maxResults
            additionalHeaders = aircraftSortieCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftSortieCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftSortieCountParams].
         *
         ...
         */
        fun build(): AircraftSortieCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftSortieCountParams && plannedDepTime == other.plannedDepTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AircraftSortieCountParams{plannedDepTime=$plannedDepTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
