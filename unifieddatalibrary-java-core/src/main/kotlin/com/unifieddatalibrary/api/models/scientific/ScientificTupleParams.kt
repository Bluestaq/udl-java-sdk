...
class ScientificTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScientificTupleParams].
         *
    ...
    /** A builder for [ScientificTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificTupleParams: ScientificTupleParams) =
            apply {
                columns = scientificTupleParams.columns
                firstResult = scientificTupleParams.firstResult
                maxResults = scientificTupleParams.maxResults
                additionalHeaders = scientificTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = scientificTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ScientificTupleParams].
         *
         ...
         */
        fun build(): ScientificTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ScientificTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ScientificTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
