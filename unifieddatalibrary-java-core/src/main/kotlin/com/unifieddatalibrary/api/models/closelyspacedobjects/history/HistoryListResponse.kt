...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("csoState") @ExcludeMissing csoState: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("compType") @ExcludeMissing compType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("deltaVTol") @ExcludeMissing deltaVTol: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("idActorSV") @ExcludeMissing idActorSv: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("maxRange") @ExcludeMissing maxRange: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("minRange") @ExcludeMissing minRange: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("rangeTol") @ExcludeMissing rangeTol: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("relPos") @ExcludeMissing relPos: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("relPosMag") @ExcludeMissing relPosMag: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("relSpeedMag")
        @ExcludeMissing
        relSpeedMag: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("relVel") @ExcludeMissing relVel: JsonField<List<Double>> = JsonMissing.of(),
     ...
     *   if the server responded with an unexpected value).
     */
    fun durationThreshold(): Optional<Double> = durationThreshold.getOptional("durationThreshold")
     ...
     *   if the server responded with an unexpected value).
     */
    fun inclinationDeltaV(): Optional<Double> = inclinationDeltaV.getOptional("inclinationDeltaV")
     ...
     */
    @JsonProperty("idTargetSV") @ExcludeMissing fun _idTargetSv(): JsonField<String> = idTargetSv
     ...
     */
    @JsonProperty("relSpeedMag") @ExcludeMissing fun _relSpeedMag(): JsonField<Double> = relSpeedMag
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            csoState = historyListResponse.csoState
            ...
            actorSvEpoch = historyListResponse.actorSvEpoch
            analysisDuration = historyListResponse.analysisDuration
            analysisEpoch = historyListResponse.analysisEpoch
            compType = historyListResponse.compType
            ...
            csoDetails = historyListResponse.csoDetails.map { it.toMutableList() }
            deltaVTol = historyListResponse.deltaVTol
            durationThreshold = historyListResponse.durationThreshold
            eventEndTime = historyListResponse.eventEndTime
            eventIntervalCoverage = historyListResponse.eventIntervalCoverage
            extId = historyListResponse.extId
            hohmannDeltaV = historyListResponse.hohmannDeltaV
            idActorSv = historyListResponse.idActorSv
            idOnOrbit1 = historyListResponse.idOnOrbit1
            idOnOrbit2 = historyListResponse.idOnOrbit2
            idTargetSv = historyListResponse.idTargetSv
            inclinationDeltaV = historyListResponse.inclinationDeltaV
            indicationSource = historyListResponse.indicationSource
            lonTol = historyListResponse.lonTol
            maxRange = historyListResponse.maxRange
            minPlaneSepAngle = historyListResponse.minPlaneSepAngle
            minPlaneSepEpoch = historyListResponse.minPlaneSepEpoch
            minRange = historyListResponse.minRange
            minRangeAnalysisDuration = historyListResponse.minRangeAnalysisDuration
            minRangeEpoch = historyListResponse.minRangeEpoch
            notes = historyListResponse.notes
            numSubIntervals = historyListResponse.numSubIntervals
            orbitAlignDel = historyListResponse.orbitAlignDel
            orbitPlaneTol = historyListResponse.orbitPlaneTol
            origin = historyListResponse.origin
            origNetwork = historyListResponse.origNetwork
            origObjectId1 = historyListResponse.origObjectId1
            origObjectId2 = historyListResponse.origObjectId2
            rangeThreshold = historyListResponse.rangeThreshold
            rangeTol = historyListResponse.rangeTol
            relPos = historyListResponse.relPos.map { it.toMutableList() }
            relPosMag = historyListResponse.relPosMag
            relSpeedMag = historyListResponse.relSpeedMag
            relVel = historyListResponse.relVel.map { it.toMutableList() }
            satNo1 = historyListResponse.satNo1
            satNo2 = historyListResponse.satNo2
            sourceDl = historyListResponse.sourceDl
            stationLimLonTol = historyListResponse.stationLimLonTol
            targetSvEpoch = historyListResponse.targetSvEpoch
            totalDeltaV = historyListResponse.totalDeltaV
         ...
         * precision.
         */
        fun actorSvEpoch(actorSvEpoch: OffsetDateTime) = actorSvEpoch(JsonField.of(actorSvEpoch))
         ...
         * tolerance.
         */
        fun numSubIntervals(numSubIntervals: Int) = numSubIntervals(JsonField.of(numSubIntervals))
        ...
        /** The threshold of the event range in kilometers. */
        fun rangeThreshold(rangeThreshold: Double) = rangeThreshold(JsonField.of(rangeThreshold))
         ...
         * value.
         */
        fun relSpeedMag(relSpeedMag: JsonField<Double>) = apply { this.relSpeedMag = relSpeedMag }
