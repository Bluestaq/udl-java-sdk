 ...
 */
class LaserdeconflictrequestListParams
private constructor(
    ...
    /** A builder for [LaserdeconflictrequestListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laserdeconflictrequestListParams: LaserdeconflictrequestListParams) =
            apply {
                startDate = laserdeconflictrequestListParams.startDate
                firstResult = laserdeconflictrequestListParams.firstResult
                maxResults = laserdeconflictrequestListParams.maxResults
                additionalHeaders = laserdeconflictrequestListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    laserdeconflictrequestListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LaserdeconflictrequestListParams].
         *
         ...
         */
        fun build(): LaserdeconflictrequestListParams =
            LaserdeconflictrequestListParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaserdeconflictrequestListParams &&
    ...
    override fun toString() =
        "LaserdeconflictrequestListParams{startDate=$startDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
