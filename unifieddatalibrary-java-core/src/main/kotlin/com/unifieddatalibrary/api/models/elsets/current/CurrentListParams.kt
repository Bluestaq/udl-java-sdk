...
class CurrentListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): CurrentListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(currentListParams: CurrentListParams) =
            apply {
    ...
    override fun toString() = "CurrentListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
