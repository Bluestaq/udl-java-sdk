...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(currentListParams: CurrentListParams) = apply {
            firstResult = currentListParams.firstResult
            maxResults = currentListParams.maxResults
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CurrentListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "CurrentListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
