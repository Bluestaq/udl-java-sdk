...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SgiCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SgiCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SgiCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sgiCountParams: SgiCountParams) = apply {
            effectiveDate = sgiCountParams.effectiveDate
            firstResult = sgiCountParams.firstResult
            maxResults = sgiCountParams.maxResults
            sgiDate = sgiCountParams.sgiDate
            additionalHeaders = sgiCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = sgiCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SgiCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SgiCountParams =
            SgiCountParams(
                effectiveDate,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SgiCountParams && effectiveDate == other.effectiveDate && firstResult == other.firstResult && maxResults == other.maxResults && sgiDate == other.sgiDate && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SgiCountParams{effectiveDate=$effectiveDate, firstResult=$firstResult, maxResults=$maxResults, sgiDate=$sgiDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
