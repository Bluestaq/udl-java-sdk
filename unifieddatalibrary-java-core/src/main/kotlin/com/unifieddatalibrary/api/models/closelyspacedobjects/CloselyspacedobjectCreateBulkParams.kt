...
/**
 * Service operation intended for initial integration only, to take a list of CloselySpacedObjects
 * (CSO) records as a POST body and ingest into the database. This operation is not intended to be
 * used for automated feeds into UDL. Data providers should contact the UDL team for specific role
 * assignments and for instructions on setting up a permanent feed through an alternate mechanism.
 */
class CloselyspacedobjectCreateBulkParams
private constructor(
    ...
    /** A builder for [CloselyspacedobjectCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            closelyspacedobjectCreateBulkParams: CloselyspacedobjectCreateBulkParams
        ) = apply {
            body = closelyspacedobjectCreateBulkParams.body.toMutableList()
            additionalHeaders = closelyspacedobjectCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                closelyspacedobjectCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CloselyspacedobjectCreateBulkParams].
         *
         ...
         */
        fun build(): CloselyspacedobjectCreateBulkParams =
            CloselyspacedobjectCreateBulkParams(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *
             * Unlike [objectEvent], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("objectEvent")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * yet supported value.
                 */
                fun objectType(objectType: JsonField<String>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloselyspacedobjectCreateBulkParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CloselyspacedobjectCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
