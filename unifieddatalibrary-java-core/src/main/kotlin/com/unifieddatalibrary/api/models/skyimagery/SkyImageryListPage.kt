...
class SkyImageryListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryListPage: SkyImageryListPage) =
            apply {
        ...
        fun service(service: SkyImageryService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SkyImageryListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }
