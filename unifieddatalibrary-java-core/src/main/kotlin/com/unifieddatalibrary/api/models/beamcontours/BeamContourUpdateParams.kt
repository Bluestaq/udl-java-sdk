...
class BeamContourUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BeamContourUpdateParams].
         *
    ...
    /** A builder for [BeamContourUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamContourUpdateParams: BeamContourUpdateParams) =
            apply {
                pathId = beamContourUpdateParams.pathId
                body = beamContourUpdateParams.body.toBuilder()
                additionalHeaders = beamContourUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = beamContourUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** The index number of this contour. The value is required if type = CONTOUR. */
        fun contourIdx(contourIdx: Long) =
            apply {
                body.contourIdx(contourIdx)
            }
        ...
        /** GeoJSON or Well Known Text expression of the boresight point, service area point or region, or the gain contour region in geographic longitude, latitude pairs. Boresight and service area point(s) are represented as a 'Point' or 'MultiPoint', service areas and closed gain contours as 'Polygon', and open contours as 'LineString'. This is an optional convenience field only used for create operations. The system will auto-detect the format (Well Known Text or GeoJSON) and populate both geographyText and geographyJson fields appropriately. A create request must contain one of the geography, geographyText, or geographyJson. */
        fun geography(geography: String) =
            apply {
        ...
        /** Geographical region or polygon (lat/lon pairs), as depicted by the GeoJSON representation of the geometry/geography, of the image as projected on the ground. GeoJSON Reference: https://geojson.org/. Ignored if included with a POST or PUT request that also specifies a valid 'area' or 'atext' field. */
        fun geographyJson(geographyJson: String) =
            apply {
        ...
        /** Number of dimensions of the geometry depicted by region. */
        fun geographyNdims(geographyNdims: Int) =
            apply {
        ...
        /** Geographical spatial_ref_sys for region. */
        fun geographySrid(geographySrid: Int) =
            apply {
        ...
        /** Geographical region or polygon (lon/lat pairs), as depicted by the Well-Known Text representation of the geometry/geography, of the image as projected on the ground. WKT reference: https://www.opengeospatial.org/standards/wkt-crs. Ignored if included with a POST or PUT request that also specifies a valid 'area' field. */
        fun geographyText(geographyText: String) =
            apply {
        ...
        /** Type of region as projected. */
        fun geographyType(geographyType: String) =
            apply {
        ...
        /**
         * Returns an immutable instance of [BeamContourUpdateParams].
         *
         ...
         */
        fun build(): BeamContourUpdateParams =
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idBeam.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (contourIdx.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (gain.asKnown().isPresent) 1 else 0) + (if (geography.asKnown().isPresent) 1 else 0) + (if (geographyJson.asKnown().isPresent) 1 else 0) + (if (geographyNdims.asKnown().isPresent) 1 else 0) + (if (geographySrid.asKnown().isPresent) 1 else 0) + (if (geographyText.asKnown().isPresent) 1 else 0) + (if (geographyType.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (regionName.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BeamContourUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "BeamContourUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
