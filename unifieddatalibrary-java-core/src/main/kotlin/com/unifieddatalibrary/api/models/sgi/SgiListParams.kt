...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SgiListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SgiListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SgiListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sgiListParams: SgiListParams) = apply {
            effectiveDate = sgiListParams.effectiveDate
            firstResult = sgiListParams.firstResult
            maxResults = sgiListParams.maxResults
            sgiDate = sgiListParams.sgiDate
            additionalHeaders = sgiListParams.additionalHeaders.toBuilder()
            additionalQueryParams = sgiListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SgiListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SgiListParams =
            SgiListParams(
                effectiveDate,
                firstResult,
                maxResults,
