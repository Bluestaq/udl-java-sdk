 ...
 */
class AirfieldStatusCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldStatusCountParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AirfieldStatusCountParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AirfieldStatusCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldStatusCountParams: AirfieldStatusCountParams) = apply {
            firstResult = airfieldStatusCountParams.firstResult
            maxResults = airfieldStatusCountParams.maxResults
            additionalHeaders = airfieldStatusCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = airfieldStatusCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AirfieldStatusCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldStatusCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirfieldStatusCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirfieldStatusCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
