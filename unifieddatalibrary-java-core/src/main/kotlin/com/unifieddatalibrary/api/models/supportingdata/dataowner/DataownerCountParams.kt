...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DataownerCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DataownerCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DataownerCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dataownerCountParams: DataownerCountParams) = apply {
            firstResult = dataownerCountParams.firstResult
            maxResults = dataownerCountParams.maxResults
            additionalHeaders = dataownerCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = dataownerCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DataownerCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DataownerCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DataownerCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "DataownerCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
