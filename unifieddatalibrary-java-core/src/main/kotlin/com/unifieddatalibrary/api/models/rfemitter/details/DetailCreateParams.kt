...
/**
 * Service operation to take a single RFEmitterDetails as a POST body and ingest into the database.
 * A specific role is required to perform this service operation. Please contact the UDL team for
 * assistance.
 */
class DetailCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DetailCreateParams].
         *
    ...
    /** A builder for [DetailCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailCreateParams: DetailCreateParams) = apply {
            body = detailCreateParams.body.toBuilder()
            additionalHeaders = detailCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = detailCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DetailCreateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "DetailCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
