...
class TrackDetailListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackDetailListParams].
         *
    ...
    /** A builder for [TrackDetailListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailListParams: TrackDetailListParams) =
            apply {
                ts = trackDetailListParams.ts
                firstResult = trackDetailListParams.firstResult
                maxResults = trackDetailListParams.maxResults
                additionalHeaders = trackDetailListParams.additionalHeaders.toBuilder()
                additionalQueryParams = trackDetailListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TrackDetailListParams].
         *
         ...
         */
        fun build(): TrackDetailListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is TrackDetailListParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "TrackDetailListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
