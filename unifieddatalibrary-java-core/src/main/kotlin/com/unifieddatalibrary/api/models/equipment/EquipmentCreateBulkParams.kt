...
class EquipmentCreateBulkParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentCreateBulkParams: EquipmentCreateBulkParams) =
            apply {
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("airDefArea") @ExcludeMissing private val airDefArea: JsonField<String>,
        @JsonProperty("allegiance") @ExcludeMissing private val allegiance: JsonField<String>,
        @JsonProperty("altAllegiance") @ExcludeMissing private val altAllegiance: JsonField<String>,
        @JsonProperty("altCountryCode") @ExcludeMissing private val altCountryCode: JsonField<String>,
        @JsonProperty("altEqpId") @ExcludeMissing private val altEqpId: JsonField<String>,
        @JsonProperty("classRating") @ExcludeMissing private val classRating: JsonField<String>,
        @JsonProperty("condition") @ExcludeMissing private val condition: JsonField<String>,
        @JsonProperty("conditionAvail") @ExcludeMissing private val conditionAvail: JsonField<String>,
        @JsonProperty("coord") @ExcludeMissing private val coord: JsonField<String>,
        @JsonProperty("coordDatum") @ExcludeMissing private val coordDatum: JsonField<String>,
        @JsonProperty("coordDerivAcc") @ExcludeMissing private val coordDerivAcc: JsonField<Double>,
        @JsonProperty("createdAt") @ExcludeMissing private val createdAt: JsonField<OffsetDateTime>,
        @JsonProperty("createdBy") @ExcludeMissing private val createdBy: JsonField<String>,
        @JsonProperty("elevMsl") @ExcludeMissing private val elevMsl: JsonField<Double>,
        @JsonProperty("elevMslConfLvl") @ExcludeMissing private val elevMslConfLvl: JsonField<Int>,
        @JsonProperty("elevMslDerivAcc") @ExcludeMissing private val elevMslDerivAcc: JsonField<Double>,
        @JsonProperty("eqpCode") @ExcludeMissing private val eqpCode: JsonField<String>,
        @JsonProperty("eqpIdNum") @ExcludeMissing private val eqpIdNum: JsonField<String>,
        @JsonProperty("eval") @ExcludeMissing private val eval: JsonField<Int>,
        @JsonProperty("fpa") @ExcludeMissing private val fpa: JsonField<String>,
        @JsonProperty("function") @ExcludeMissing private val function: JsonField<String>,
        @JsonProperty("functPrimary") @ExcludeMissing private val functPrimary: JsonField<String>,
        @JsonProperty("geoidalMslSep") @ExcludeMissing private val geoidalMslSep: JsonField<Double>,
        @JsonProperty("ident") @ExcludeMissing private val ident: JsonField<String>,
        @JsonProperty("idOperatingUnit") @ExcludeMissing private val idOperatingUnit: JsonField<String>,
        @JsonProperty("idParentEquipment") @ExcludeMissing private val idParentEquipment: JsonField<String>,
        @JsonProperty("idSite") @ExcludeMissing private val idSite: JsonField<String>,
        @JsonProperty("locReason") @ExcludeMissing private val locReason: JsonField<String>,
        @JsonProperty("milGrid") @ExcludeMissing private val milGrid: JsonField<String>,
        @JsonProperty("milGridSys") @ExcludeMissing private val milGridSys: JsonField<String>,
        @JsonProperty("nomen") @ExcludeMissing private val nomen: JsonField<String>,
        @JsonProperty("operAreaPrimary") @ExcludeMissing private val operAreaPrimary: JsonField<String>,
        @JsonProperty("operStatus") @ExcludeMissing private val operStatus: JsonField<String>,
        @JsonProperty("origin") @ExcludeMissing private val origin: JsonField<String>,
        @JsonProperty("polSubdiv") @ExcludeMissing private val polSubdiv: JsonField<String>,
        @JsonProperty("qtyOH") @ExcludeMissing private val qtyOh: JsonField<Int>,
        @JsonProperty("recStatus") @ExcludeMissing private val recStatus: JsonField<String>,
        @JsonProperty("referenceDoc") @ExcludeMissing private val referenceDoc: JsonField<String>,
        @JsonProperty("resProd") @ExcludeMissing private val resProd: JsonField<String>,
        @JsonProperty("reviewDate") @ExcludeMissing private val reviewDate: JsonField<LocalDate>,
        @JsonProperty("seqNum") @ExcludeMissing private val seqNum: JsonField<Int>,
        ...
        @JsonProperty("symCode") @ExcludeMissing private val symCode: JsonField<String>,
        @JsonProperty("utm") @ExcludeMissing private val utm: JsonField<String>,
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (airDefArea.asKnown().isPresent) 1 else 0) + (if (allegiance.asKnown().isPresent) 1 else 0) + (if (altAllegiance.asKnown().isPresent) 1 else 0) + (if (altCountryCode.asKnown().isPresent) 1 else 0) + (if (altEqpId.asKnown().isPresent) 1 else 0) + (if (classRating.asKnown().isPresent) 1 else 0) + (if (condition.asKnown().isPresent) 1 else 0) + (if (conditionAvail.asKnown().isPresent) 1 else 0) + (if (coord.asKnown().isPresent) 1 else 0) + (if (coordDatum.asKnown().isPresent) 1 else 0) + (if (coordDerivAcc.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (elevMsl.asKnown().isPresent) 1 else 0) + (if (elevMslConfLvl.asKnown().isPresent) 1 else 0) + (if (elevMslDerivAcc.asKnown().isPresent) 1 else 0) + (if (eqpCode.asKnown().isPresent) 1 else 0) + (if (eqpIdNum.asKnown().isPresent) 1 else 0) + (if (eval.asKnown().isPresent) 1 else 0) + (if (fpa.asKnown().isPresent) 1 else 0) + (if (function.asKnown().isPresent) 1 else 0) + (if (functPrimary.asKnown().isPresent) 1 else 0) + (if (geoidalMslSep.asKnown().isPresent) 1 else 0) + (if (ident.asKnown().isPresent) 1 else 0) + (if (idOperatingUnit.asKnown().isPresent) 1 else 0) + (if (idParentEquipment.asKnown().isPresent) 1 else 0) + (if (idSite.asKnown().isPresent) 1 else 0) + (if (locReason.asKnown().isPresent) 1 else 0) + (if (milGrid.asKnown().isPresent) 1 else 0) + (if (milGridSys.asKnown().isPresent) 1 else 0) + (if (nomen.asKnown().isPresent) 1 else 0) + (if (operAreaPrimary.asKnown().isPresent) 1 else 0) + (if (operStatus.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (polSubdiv.asKnown().isPresent) 1 else 0) + (if (qtyOh.asKnown().isPresent) 1 else 0) + (if (recStatus.asKnown().isPresent) 1 else 0) + (if (referenceDoc.asKnown().isPresent) 1 else 0) + (if (resProd.asKnown().isPresent) 1 else 0) + (if (reviewDate.asKnown().isPresent) 1 else 0) + (if (seqNum.asKnown().isPresent) 1 else 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (if (symCode.asKnown().isPresent) 1 else 0) + (if (utm.asKnown().isPresent) 1 else 0) + (if (wac.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EquipmentCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "EquipmentCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
