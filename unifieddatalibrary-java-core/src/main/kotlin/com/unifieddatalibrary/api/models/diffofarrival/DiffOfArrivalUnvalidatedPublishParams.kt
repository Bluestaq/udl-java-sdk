...
/**
 * Service operation to take multiple TDOA/FDOA records as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class DiffOfArrivalUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            diffOfArrivalUnvalidatedPublishParams: DiffOfArrivalUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                diffOfArrivalUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
