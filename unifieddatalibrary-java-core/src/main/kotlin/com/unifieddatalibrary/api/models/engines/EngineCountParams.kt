...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EngineCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineCountParams: EngineCountParams) = apply {
    ...
    override fun toString() =
        "EngineCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
