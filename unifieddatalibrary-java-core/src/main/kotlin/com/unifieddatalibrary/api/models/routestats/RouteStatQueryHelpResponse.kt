...
class RouteStatQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatQueryHelpResponse: RouteStatQueryHelpResponse) = apply {
    ...
    fun validate(): RouteStatQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
