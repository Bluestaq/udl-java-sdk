...
class RouteStatQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RouteStatQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RouteStatQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatQueryHelpResponse: RouteStatQueryHelpResponse) =
            apply {
                aodrSupported = routeStatQueryHelpResponse.aodrSupported
                classificationMarking = routeStatQueryHelpResponse.classificationMarking
                description = routeStatQueryHelpResponse.description
                historySupported = routeStatQueryHelpResponse.historySupported
                name = routeStatQueryHelpResponse.name
                parameters = routeStatQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = routeStatQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = routeStatQueryHelpResponse.restSupported
                sortSupported = routeStatQueryHelpResponse.sortSupported
                typeName = routeStatQueryHelpResponse.typeName
                uri = routeStatQueryHelpResponse.uri
                additionalProperties = routeStatQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RouteStatQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RouteStatQueryHelpResponse =
    ...
    fun validate(): RouteStatQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RouteStatQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
