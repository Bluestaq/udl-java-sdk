...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldListParams: AirfieldListParams) = apply {
    ...
    override fun toString() =
        "AirfieldListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
