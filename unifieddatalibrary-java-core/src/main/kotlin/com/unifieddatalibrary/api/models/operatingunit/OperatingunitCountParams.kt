 ...
 */
class OperatingunitCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OperatingunitCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitCountParams: OperatingunitCountParams) = apply {
    ...
    override fun toString() =
        "OperatingunitCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
