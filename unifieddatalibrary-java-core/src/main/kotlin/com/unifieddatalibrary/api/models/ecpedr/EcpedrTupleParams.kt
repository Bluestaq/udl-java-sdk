...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpedrTupleParams].
         *
    ...
    /** A builder for [EcpedrTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpedrTupleParams: EcpedrTupleParams) = apply {
            columns = ecpedrTupleParams.columns
            obTime = ecpedrTupleParams.obTime
            firstResult = ecpedrTupleParams.firstResult
            maxResults = ecpedrTupleParams.maxResults
            additionalHeaders = ecpedrTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = ecpedrTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EcpedrTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EcpedrTupleParams &&
    ...
    override fun toString() =
        "EcpedrTupleParams{columns=$columns, obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
