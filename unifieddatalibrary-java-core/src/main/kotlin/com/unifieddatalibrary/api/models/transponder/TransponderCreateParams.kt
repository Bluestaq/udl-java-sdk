...
class TransponderCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransponderCreateParams].
         *
    ...
    /** A builder for [TransponderCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderCreateParams: TransponderCreateParams) =
            apply {
                body = transponderCreateParams.body.toBuilder()
                additionalHeaders = transponderCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = transponderCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Transponder modulation, e.g. Auto, QPSK, 8PSK. */
        fun modulation(modulation: String) =
            apply {
                body.modulation(modulation)
            }
        ...
        /** Symbol rate is the number of symbol changes, waveform changes, or signaling events, across the transmission medium per time unit using a digitally modulated signal or a line code. Also measured in Hz. */
        fun symbolRate(symbolRate: Double) =
            apply {
                body.symbolRate(symbolRate)
            }
        ...
        /**
         * Returns an immutable instance of [TransponderCreateParams].
         *
         ...
         */
        fun build(): TransponderCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is TransponderCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "TransponderCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
