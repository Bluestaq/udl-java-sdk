...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeListPage: SensorTypeListPage) = apply {
            service = sensorTypeListPage.service
            params = sensorTypeListPage.params
            items = sensorTypeListPage.items
        }

        fun service(service: SensorTypeService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorTypeListPage &&
