...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ViewGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ViewGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ViewGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(viewGetParams: ViewGetParams) = apply {
            id = viewGetParams.id
            firstResult = viewGetParams.firstResult
            maxResults = viewGetParams.maxResults
            additionalHeaders = viewGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = viewGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ViewGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ViewGetParams =
            ViewGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun toString() =
        "ViewGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
