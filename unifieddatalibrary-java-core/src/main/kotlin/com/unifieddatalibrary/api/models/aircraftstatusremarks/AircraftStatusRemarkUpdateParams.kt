...
class AircraftStatusRemarkUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftStatusRemarkUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(aircraftStatusRemarkUpdateParams: AircraftStatusRemarkUpdateParams) =
            apply {
                ...
                additionalQueryParams = aircraftStatusRemarkUpdateParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body private constructor(
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idAircraftStatus=$idAircraftStatus, source=$source, text=$text, bodyId=$bodyId, altRmkId=$altRmkId, createdAt=$createdAt, createdBy=$createdBy, lastUpdatedAt=$lastUpdatedAt, lastUpdatedBy=$lastUpdatedBy, name=$name, origin=$origin, origNetwork=$origNetwork, sourceDl=$sourceDl, timestamp=$timestamp, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "AircraftStatusRemarkUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
