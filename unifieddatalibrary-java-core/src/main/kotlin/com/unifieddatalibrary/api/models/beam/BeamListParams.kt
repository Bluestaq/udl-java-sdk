...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BeamListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamListParams: BeamListParams) = apply {
    ...
    override fun toString() =
        "BeamListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
