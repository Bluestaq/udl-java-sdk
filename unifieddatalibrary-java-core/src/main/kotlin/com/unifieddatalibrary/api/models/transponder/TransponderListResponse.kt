...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderListResponse: TransponderListResponse) = apply {
    ...
    fun validate(): TransponderListResponse = apply {
        if (validated) {
            return@apply
        }
