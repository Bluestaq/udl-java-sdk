...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DetailGetResponse].
         *
    ...
    /** A builder for [DetailGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailGetResponse: DetailGetResponse) = apply {
            classificationMarking = detailGetResponse.classificationMarking
            dataMode = detailGetResponse.dataMode
            idRfEmitter = detailGetResponse.idRfEmitter
            source = detailGetResponse.source
            id = detailGetResponse.id
            alternateFacilityName = detailGetResponse.alternateFacilityName
            altName = detailGetResponse.altName
            amplifier = detailGetResponse.amplifier
            antennas = detailGetResponse.antennas.map { it.toMutableList() }
            barrageNoiseBandwidth = detailGetResponse.barrageNoiseBandwidth
            bitRunTime = detailGetResponse.bitRunTime
            createdAt = detailGetResponse.createdAt
            createdBy = detailGetResponse.createdBy
            description = detailGetResponse.description
            designator = detailGetResponse.designator
            dopplerNoise = detailGetResponse.dopplerNoise
            drfmInstantaneousBandwidth = detailGetResponse.drfmInstantaneousBandwidth
            family = detailGetResponse.family
            fixedAttenuation = detailGetResponse.fixedAttenuation
            idManufacturerOrg = detailGetResponse.idManufacturerOrg
            idProductionFacilityLocation = detailGetResponse.idProductionFacilityLocation
            loanedToCocom = detailGetResponse.loanedToCocom
            notes = detailGetResponse.notes
            numBits = detailGetResponse.numBits
            numChannels = detailGetResponse.numChannels
            origin = detailGetResponse.origin
            origNetwork = detailGetResponse.origNetwork
            powerOffsets = detailGetResponse.powerOffsets.map { it.toMutableList() }
            prepTime = detailGetResponse.prepTime
            primaryCocom = detailGetResponse.primaryCocom
            productionFacilityName = detailGetResponse.productionFacilityName
            receiverType = detailGetResponse.receiverType
            secondaryNotes = detailGetResponse.secondaryNotes
            services = detailGetResponse.services.map { it.toMutableList() }
            systemSensitivityEnd = detailGetResponse.systemSensitivityEnd
            systemSensitivityStart = detailGetResponse.systemSensitivityStart
            ttps = detailGetResponse.ttps.map { it.toMutableList() }
            updatedAt = detailGetResponse.updatedAt
            updatedBy = detailGetResponse.updatedBy
            urls = detailGetResponse.urls.map { it.toMutableList() }
            additionalProperties = detailGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DetailGetResponse].
         *
    ...
    fun validate(): DetailGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailGetResponse &&
