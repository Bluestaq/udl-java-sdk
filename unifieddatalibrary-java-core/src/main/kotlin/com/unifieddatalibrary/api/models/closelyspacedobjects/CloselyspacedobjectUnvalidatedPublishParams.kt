...
/**
 * Service operation to take multiple CloselySpacedObjects (CSO) records as a POST body and ingest
 ...
 */
class CloselyspacedobjectUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [CloselyspacedobjectUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            closelyspacedobjectUnvalidatedPublishParams: CloselyspacedobjectUnvalidatedPublishParams
        ) = apply {
            body = closelyspacedobjectUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                closelyspacedobjectUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                closelyspacedobjectUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CloselyspacedobjectUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): CloselyspacedobjectUnvalidatedPublishParams =
            CloselyspacedobjectUnvalidatedPublishParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloselyspacedobjectUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CloselyspacedobjectUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
