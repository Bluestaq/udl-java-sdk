 ...
 * classificationMarking, and tags. For a file, you may update description, classificationMarking,
 * and tags. A specific role is required to perform this service operation. Please contact the UDL
 * team for assistance.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v2UpdateParams: V2UpdateParams) = apply {
            path = v2UpdateParams.path
            sendNotification = v2UpdateParams.sendNotification
            body = v2UpdateParams.body.toBuilder()
