...
class AnalyticImageryCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AnalyticImageryCountParams].
         *
    ...
    /** A builder for [AnalyticImageryCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryCountParams: AnalyticImageryCountParams) =
            apply {
                msgTime = analyticImageryCountParams.msgTime
                firstResult = analyticImageryCountParams.firstResult
                maxResults = analyticImageryCountParams.maxResults
                additionalHeaders = analyticImageryCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = analyticImageryCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticImageryCountParams].
         *
         ...
         */
        fun build(): AnalyticImageryCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AnalyticImageryCountParams && msgTime == other.msgTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AnalyticImageryCountParams{msgTime=$msgTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
