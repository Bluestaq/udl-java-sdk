...
class OnboardnavigationCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnboardnavigationCreateBulkParams].
         *
    ...
    /** A builder for [OnboardnavigationCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationCreateBulkParams: OnboardnavigationCreateBulkParams) =
            apply {
                body = onboardnavigationCreateBulkParams.body.toMutableList()
                additionalHeaders = onboardnavigationCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = onboardnavigationCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnboardnavigationCreateBulkParams].
         *
         ...
         */
        fun build(): OnboardnavigationCreateBulkParams =
    ...
    override fun toString() = "OnboardnavigationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
