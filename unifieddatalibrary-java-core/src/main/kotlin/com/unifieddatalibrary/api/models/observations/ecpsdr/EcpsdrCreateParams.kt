...
/**
 * Service operation to take a single ECPSDR as a POST body and ingest into the database. A specific
 * role is required to perform this service operation. Please contact the UDL team for assistance.
 */
class EcpsdrCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrCreateParams: EcpsdrCreateParams) = apply {
         ...
         * precision.
         */
        fun msgTime(msgTime: OffsetDateTime) = apply { body.msgTime(msgTime) }
         ...
         * supported value.
         */
        fun msgTime(msgTime: JsonField<OffsetDateTime>) = apply { body.msgTime(msgTime) }
         ...
         * vRef for conversion factor to Volts.
         */
        fun asl5VCurrMon(asl5VCurrMon: Int) = apply { body.asl5VCurrMon(asl5VCurrMon) }
         ...
         * value.
         */
        fun asl5VCurrMon(asl5VCurrMon: JsonField<Int>) = apply { body.asl5VCurrMon(asl5VCurrMon) }

        /** CDS Charge Plate voltage monitor. See vRef for conversion factor to Volts. */
        fun cdsPlateVMon(cdsPlateVMon: Int) = apply { body.cdsPlateVMon(cdsPlateVMon) }
         ...
         * value.
         */
        fun cdsPlateVMon(cdsPlateVMon: JsonField<Int>) = apply { body.cdsPlateVMon(cdsPlateVMon) }

        /** CDS reference voltage monitor. See vRef for conversion factor to Volts. */
        fun cdsRefVMon(cdsRefVMon: Int) = apply { body.cdsRefVMon(cdsRefVMon) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun cdsRefVMon(cdsRefVMon: JsonField<Int>) = apply { body.cdsRefVMon(cdsRefVMon) }

        /**
         * CDS Threshold setting for ESD detection threshold. The CDS Threshold is the adjustable
         * sensitivity of recording/digitizing an ESD as a transient packet.
         */
        fun cdsThreshold(cdsThreshold: Int) = apply { body.cdsThreshold(cdsThreshold) }
         ...
         * value.
         */
        fun cdsThreshold(cdsThreshold: JsonField<Int>) = apply { body.cdsThreshold(cdsThreshold) }

        /** CDS throttle number of seconds between CDS transient capture readouts. */
        fun cdsThrottle(cdsThrottle: Int) = apply { body.cdsThrottle(cdsThrottle) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun cdsThrottle(cdsThrottle: JsonField<Int>) = apply { body.cdsThrottle(cdsThrottle) }
         ...
         * respectively.
         */
        fun dosBias(dosBias: Int) = apply { body.dosBias(dosBias) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dosBias(dosBias: JsonField<Int>) = apply { body.dosBias(dosBias) }

        /**
         * Internal 5V current monitor for digital supply line. This is sensor status telemetry. See
         * vRef for conversion factor to Volts.
         */
        fun dsl5VCurrMon(dsl5VCurrMon: Int) = apply { body.dsl5VCurrMon(dsl5VCurrMon) }
         ...
         * value.
         */
        fun dsl5VCurrMon(dsl5VCurrMon: JsonField<Int>) = apply { body.dsl5VCurrMon(dsl5VCurrMon) }

        /** Number of ESD triggers, high byte of 2-byte counter. */
        fun esdTrigCountH(esdTrigCountH: Int) = apply { body.esdTrigCountH(esdTrigCountH) }
        ...
        /** Number of ESD triggers, low byte of 2-byte counter. */
        fun esdTrigCountL(esdTrigCountL: Int) = apply { body.esdTrigCountL(esdTrigCountL) }
        ...
        /** HiLET dosimeter low range output. Low byte of scaler (HiLET) dosimeter output. */
        fun hiLetL(hiLetL: Int) = apply { body.hiLetL(hiLetL) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun hiLetL(hiLetL: JsonField<Int>) = apply { body.hiLetL(hiLetL) }

        /**
         * Unitless HiLET dosimeter medium range output. Medium byte of (HiLET) dosimeter output.
         */
        fun hiLetM(hiLetM: Int) = apply { body.hiLetM(hiLetM) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun hiLetM(hiLetM: JsonField<Int>) = apply { body.hiLetM(hiLetM) }
        ...
        /** LowLET dosimeter low range output. Low byte of (LowLET) dosimeter output. */
        fun lowLetL(lowLetL: Int) = apply { body.lowLetL(lowLetL) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun lowLetL(lowLetL: JsonField<Int>) = apply { body.lowLetL(lowLetL) }

        /** LowLET dosimeter medium range output. Medium byte of (LowLET) dosimeter output. */
        fun lowLetM(lowLetM: Int) = apply { body.lowLetM(lowLetM) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun lowLetM(lowLetM: JsonField<Int>) = apply { body.lowLetM(lowLetM) }

        /** MedLET1 dosimeter low range output. Low byte of the 1st (MedLET) dosimeter output. */
        fun medLet1L(medLet1L: Int) = apply { body.medLet1L(medLet1L) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun medLet1L(medLet1L: JsonField<Int>) = apply { body.medLet1L(medLet1L) }

        /**
         * MedLET1 dosimeter medium range output. Medium byte of the 1st (MedLET) dosimeter output.
         */
        fun medLet1M(medLet1M: Int) = apply { body.medLet1M(medLet1M) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun medLet1M(medLet1M: JsonField<Int>) = apply { body.medLet1M(medLet1M) }

        /** MedLET2 dosimeter low range output. Low byte of the 2nd (MedLET) dosimeter output. */
        fun medLet2L(medLet2L: Int) = apply { body.medLet2L(medLet2L) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun medLet2L(medLet2L: JsonField<Int>) = apply { body.medLet2L(medLet2L) }

        /**
         * MedLET2 dosimeter medium range output. Medium byte of the 2nd (MedLET) dosimeter output.
         */
        fun medLet2M(medLet2M: Int) = apply { body.medLet2M(medLet2M) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun medLet2M(medLet2M: JsonField<Int>) = apply { body.medLet2M(medLet2M) }

        /** MedLET3 dosimeter low range output. Low byte of the 3rd (MedLET) dosimeter output. */
        fun medLet3L(medLet3L: Int) = apply { body.medLet3L(medLet3L) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun medLet3L(medLet3L: JsonField<Int>) = apply { body.medLet3L(medLet3L) }

        /**
         * MedLET3 dosimeter medium range output. Medium byte of the 3rd (MedLET) dosimeter output.
         */
        fun medLet3M(medLet3M: Int) = apply { body.medLet3M(medLet3M) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun medLet3M(medLet3M: JsonField<Int>) = apply { body.medLet3M(medLet3M) }

        /** MedLET4 dosimeter low range output. Low byte of the 4th (MedLET) dosimeter output. */
        fun medLet4L(medLet4L: Int) = apply { body.medLet4L(medLet4L) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun medLet4L(medLet4L: JsonField<Int>) = apply { body.medLet4L(medLet4L) }

        /**
         * MedLET4 dosimeter medium range output. Medium byte of the 4th (MedLET) dosimeter output.
         */
        fun medLet4M(medLet4M: Int) = apply { body.medLet4M(medLet4M) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun medLet4M(medLet4M: JsonField<Int>) = apply { body.medLet4M(medLet4M) }

        /** Unitless sensor mounting plate temperature. */
        fun mpTemp(mpTemp: Int) = apply { body.mpTemp(mpTemp) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun mpTemp(mpTemp: JsonField<Int>) = apply { body.mpTemp(mpTemp) }
        ...
        /** Photodiode 1 signal level. */
        fun pd1SigLev(pd1SigLev: Int) = apply { body.pd1SigLev(pd1SigLev) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun pd1SigLev(pd1SigLev: JsonField<Int>) = apply { body.pd1SigLev(pd1SigLev) }

        /** Photodiode 2 signal level. */
        fun pd2SigLev(pd2SigLev: Int) = apply { body.pd2SigLev(pd2SigLev) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun pd2SigLev(pd2SigLev: JsonField<Int>) = apply { body.pd2SigLev(pd2SigLev) }

        /** Power supply temperature monitor. This is sensor status telemetry. */
        fun psTempMon(psTempMon: Int) = apply { body.psTempMon(psTempMon) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun psTempMon(psTempMon: JsonField<Int>) = apply { body.psTempMon(psTempMon) }

        /**
         * Flag indicating whether this record is an original or re-transmitted dataset (TRUE
         * indicates a retransmit from the host).
         */
        fun retransmit(retransmit: Boolean) = apply { body.retransmit(retransmit) }
         ...
         * value.
         */
        fun retransmit(retransmit: JsonField<Boolean>) = apply { body.retransmit(retransmit) }
        ...
        /** The sensor mode associated with this measurements (NORMAL, TEST). */
        fun senMode(senMode: String) = apply { body.senMode(senMode) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun senMode(senMode: JsonField<String>) = apply { body.senMode(senMode) }

        /**
         * Surface dosimeter charge rate high output (converts to pico-amps/bit). High byte of 2
         * bytes.
         */
        fun surfDosChargeH(surfDosChargeH: Int) = apply { body.surfDosChargeH(surfDosChargeH) }
         ...
         * bytes.
         */
        fun surfDosChargeL(surfDosChargeL: Int) = apply { body.surfDosChargeL(surfDosChargeL) }
         ...
         * bytes.
         */
        fun surfDosH(surfDosH: Int) = apply { body.surfDosH(surfDosH) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun surfDosH(surfDosH: JsonField<Int>) = apply { body.surfDosH(surfDosH) }

        /**
         * Surface dosimeter low range output (converts to pico-coulombs/bit). Low byte of 3 bytes.
         */
        fun surfDosL(surfDosL: Int) = apply { body.surfDosL(surfDosL) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun surfDosL(surfDosL: JsonField<Int>) = apply { body.surfDosL(surfDosL) }

        /**
         * Surface dosimeter medium range output (converts to pico-coulombs/bit). Middle byte of 3
         * bytes.
         */
        fun surfDosM(surfDosM: Int) = apply { body.surfDosM(surfDosM) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun surfDosM(surfDosM: JsonField<Int>) = apply { body.surfDosM(surfDosM) }

        /** Surface dosimeter status byte. */
        fun surfDosStat(surfDosStat: Int) = apply { body.surfDosStat(surfDosStat) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun surfDosStat(surfDosStat: JsonField<Int>) = apply { body.surfDosStat(surfDosStat) }

        /** Array of 144 digitized samples of ESD waveform for transient packets. */
        fun transientData(transientData: List<Int>) = apply { body.transientData(transientData) }
         ...
         */
        fun addTransientData(transientData: Int) = apply { body.addTransientData(transientData) }

        /**
         * Reference voltage (volts/bit). Conversion factor used to convert analog V monitor data
         * from bytes to volts.
         */
        fun vRef(vRef: Int) = apply { body.vRef(vRef) }
         ...
         */
        fun vRef(vRef: JsonField<Int>) = apply { body.vRef(vRef) }
    ...
    override fun toString() =
        "EcpsdrCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
