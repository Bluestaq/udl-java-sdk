 ...
 */
class AirLoadPlanRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirLoadPlanRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airLoadPlanRetrieveParams: AirLoadPlanRetrieveParams) = apply {
    ...
    override fun toString() =
        "AirLoadPlanRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
