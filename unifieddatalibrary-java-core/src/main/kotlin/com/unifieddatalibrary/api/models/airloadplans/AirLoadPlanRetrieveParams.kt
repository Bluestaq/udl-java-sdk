...
class AirloadPlanRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AirloadPlanRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AirloadPlanRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirloadPlanRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airloadPlanRetrieveParams: AirloadPlanRetrieveParams) =
            apply {
                id = airloadPlanRetrieveParams.id
                firstResult = airloadPlanRetrieveParams.firstResult
                maxResults = airloadPlanRetrieveParams.maxResults
                additionalHeaders = airloadPlanRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = airloadPlanRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirloadPlanRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirloadPlanRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirloadPlanRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirloadPlanRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
