...
class SensorObservationTypeGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorObservationTypeGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sensorObservationTypeGetResponse: SensorObservationTypeGetResponse) =
            apply {
                ...
                additionalProperties = sensorObservationTypeGetResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SensorObservationTypeGetResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "SensorObservationTypeGetResponse{dataMode=$dataMode, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origNetwork=$origNetwork, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
