...
class OrganizationQueryhelpResponse
private constructor(
    ...
    /** A builder for [OrganizationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationQueryhelpResponse: OrganizationQueryhelpResponse) = apply {
            aodrSupported = organizationQueryhelpResponse.aodrSupported
            classificationMarking = organizationQueryhelpResponse.classificationMarking
            description = organizationQueryhelpResponse.description
            historySupported = organizationQueryhelpResponse.historySupported
            name = organizationQueryhelpResponse.name
            parameters = organizationQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = organizationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = organizationQueryhelpResponse.restSupported
            sortSupported = organizationQueryhelpResponse.sortSupported
            typeName = organizationQueryhelpResponse.typeName
            uri = organizationQueryhelpResponse.uri
            additionalProperties = organizationQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OrganizationQueryhelpResponse =
            OrganizationQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): OrganizationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
