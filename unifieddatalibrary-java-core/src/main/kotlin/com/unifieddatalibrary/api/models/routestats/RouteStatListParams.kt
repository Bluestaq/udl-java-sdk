...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RouteStatListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RouteStatListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RouteStatListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatListParams: RouteStatListParams) = apply {
            firstResult = routeStatListParams.firstResult
            maxResults = routeStatListParams.maxResults
            additionalHeaders = routeStatListParams.additionalHeaders.toBuilder()
            additionalQueryParams = routeStatListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RouteStatListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RouteStatListParams =
            RouteStatListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RouteStatListParams &&
    ...
    override fun toString() =
        "RouteStatListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
