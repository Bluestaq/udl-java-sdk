...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DriftHistoryCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DriftHistoryCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DriftHistoryCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(driftHistoryCountParams: DriftHistoryCountParams) = apply {
            firstResult = driftHistoryCountParams.firstResult
            maxResults = driftHistoryCountParams.maxResults
            additionalHeaders = driftHistoryCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = driftHistoryCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DriftHistoryCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DriftHistoryCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DriftHistoryCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "DriftHistoryCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
