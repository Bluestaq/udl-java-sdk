...
class AnalyticImageryListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AnalyticImageryListParams].
         *
    ...
    /** A builder for [AnalyticImageryListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryListParams: AnalyticImageryListParams) =
            apply {
                msgTime = analyticImageryListParams.msgTime
                firstResult = analyticImageryListParams.firstResult
                maxResults = analyticImageryListParams.maxResults
                additionalHeaders = analyticImageryListParams.additionalHeaders.toBuilder()
                additionalQueryParams = analyticImageryListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticImageryListParams].
         *
         ...
         */
        fun build(): AnalyticImageryListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AnalyticImageryListParams && msgTime == other.msgTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AnalyticImageryListParams{msgTime=$msgTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
