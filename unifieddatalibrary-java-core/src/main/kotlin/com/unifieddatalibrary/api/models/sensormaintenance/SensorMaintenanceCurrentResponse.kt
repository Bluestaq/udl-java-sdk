...
class SensorMaintenanceCurrentResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorMaintenanceCurrentResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sensorMaintenanceCurrentResponse: SensorMaintenanceCurrentResponse) =
            apply {
                ...
                additionalProperties = sensorMaintenanceCurrentResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SensorMaintenanceCurrentResponse =
        apply {
            if (validated) {
              return@apply
            }
