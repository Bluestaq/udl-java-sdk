...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AntennaDetailListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaDetailListParams: AntennaDetailListParams) = apply {
    ...
    override fun toString() =
        "AntennaDetailListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
