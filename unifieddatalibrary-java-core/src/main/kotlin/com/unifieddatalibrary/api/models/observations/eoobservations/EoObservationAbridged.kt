...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("zeroPtdUnc") @ExcludeMissing zeroPtdUnc: JsonField<Double> = JsonMissing.of(),
    ) : this(
    ...
    /**
     * Background intensity for IR observations, in kilowatt per steradian per micrometer.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Line of sight declination rate of change, in degrees per second, in the specified
    ...
    /**
     * Unique identifier of the Sky Imagery record associated with this observation, if applicable.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Intensity of the target for IR observations, in kilowatt per steradian per micrometer.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Line-of-sight cartesian X position of the target, in kilometers, in the specified
     * referenceFrame. If referenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Line-of-sight cartesian X velocity of target, in kilometers per second, in the specified
     * referenceFrame. If referenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Line-of-sight cartesian Y position of the target, in kilometers, in the specified
     * referenceFrame. If referenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Line-of-sight cartesian Y velocity of target, in kilometers per second, in the specified
     * referenceFrame. If referenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Line-of-sight cartesian Z position of the target, in kilometers, in the specified
     * referenceFrame. If referenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Line-of-sight cartesian Z velocity of target, in kilometers per second, in the specified
     * referenceFrame. If referenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Line of sight range, in kilometers. Reported value should include all applicable corrections
     * as specified on the source provider data card. If uncertain, consumers should contact the
     * provider for details on the applied corrections.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
    ...
    /**
     * Range rate in kilometers per second. Reported value should include all applicable corrections
     * as specified on the source provider data card. If uncertain, consumers should contact the
     * provider for details on the applied corrections.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
    ...
    /**
     * Line of sight right ascension rate of change, in degrees per second, in the specified
     * referenceFrame. If referenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Cartesian X velocity of the observing mobile/onorbit sensor at obTime, in kilometers per
    ...
    /**
     * Cartesian Y velocity of the observing mobile/onorbit sensor at obTime, in kilometers per
     * second, in the specified senReferenceFrame. If senReferenceFrame is null then J2K should be
     * assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
    ...
    /**
     * Cartesian Z velocity of the observing mobile/onorbit sensor at obTime, in kilometers per
     * second, in the specified senReferenceFrame. If senReferenceFrame is null then J2K should be
     * assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
    ...
    /**
     * Cartesian X position of the observing mobile/onorbit sensor at obTime, in kilometers, in the
    ...
    /**
     * Cartesian Y position of the observing mobile/onorbit sensor at obTime, in kilometers, in the
     * specified senReferenceFrame. If senReferenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Cartesian Z position of the observing mobile/onorbit sensor at obTime, in kilometers, in the
     * specified senReferenceFrame. If senReferenceFrame is null then J2K should be assumed.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     */
    @JsonProperty("zeroPtdUnc") @ExcludeMissing fun _zeroPtdUnc(): JsonField<Double> = zeroPtdUnc
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eoObservationAbridged: EoObservationAbridged) = apply {
            ...
            zeroPtdUnc = eoObservationAbridged.zeroPtdUnc
        ...
        /**
         * Range rate in kilometers per second. Reported value should include all applicable
         * corrections as specified on the source provider data card. If uncertain, consumers should
         * contact the provider for details on the applied corrections.
         */
        ...
        /**
         * Cartesian X velocity of the observing mobile/onorbit sensor at obTime, in kilometers per
         * second, in the specified senReferenceFrame. If senReferenceFrame is null then J2K should
         * be assumed.
         */
        ...
        /**
         * Cartesian X position of the observing mobile/onorbit sensor at obTime, in kilometers, in
        ...
        /**
         * Cartesian Y position of the observing mobile/onorbit sensor at obTime, in kilometers, in
         * the specified senReferenceFrame. If senReferenceFrame is null then J2K should be assumed.
         */
        ...
        /**
         * Cartesian Z position of the observing mobile/onorbit sensor at obTime, in kilometers, in
         * the specified senReferenceFrame. If senReferenceFrame is null then J2K should be assumed.
         */
