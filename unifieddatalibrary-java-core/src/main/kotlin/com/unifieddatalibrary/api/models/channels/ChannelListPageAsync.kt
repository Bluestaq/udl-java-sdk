...
class ChannelListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<ChannelListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(channelListPageAsync: ChannelListPageAsync) =
            apply {
        ...
        fun service(service: ChannelServiceAsync) =
            apply {
    ...
    override fun toString() = "ChannelListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
