...
class AircraftStatusQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AircraftStatusQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AircraftStatusQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusQueryhelpResponse: AircraftStatusQueryhelpResponse) =
            apply {
                aodrSupported = aircraftStatusQueryhelpResponse.aodrSupported
                classificationMarking = aircraftStatusQueryhelpResponse.classificationMarking
                description = aircraftStatusQueryhelpResponse.description
                historySupported = aircraftStatusQueryhelpResponse.historySupported
                name = aircraftStatusQueryhelpResponse.name
                parameters = aircraftStatusQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = aircraftStatusQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = aircraftStatusQueryhelpResponse.restSupported
                sortSupported = aircraftStatusQueryhelpResponse.sortSupported
                typeName = aircraftStatusQueryhelpResponse.typeName
                uri = aircraftStatusQueryhelpResponse.uri
                additionalProperties = aircraftStatusQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftStatusQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AircraftStatusQueryhelpResponse =
    ...
    fun validate(): AircraftStatusQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftStatusQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
