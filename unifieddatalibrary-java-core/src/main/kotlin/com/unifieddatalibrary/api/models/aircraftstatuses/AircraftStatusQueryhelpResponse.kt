...
class AircraftStatusQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(aircraftStatusQueryhelpResponse: AircraftStatusQueryhelpResponse) =
            apply {
                ...
                requiredRoles =
                    aircraftStatusQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    aircraftStatusQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): AircraftStatusQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
