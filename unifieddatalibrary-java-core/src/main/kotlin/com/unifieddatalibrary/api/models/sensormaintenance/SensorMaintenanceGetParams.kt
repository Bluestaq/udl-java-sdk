 ...
 * parameter.
 */
class SensorMaintenanceGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorMaintenanceGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceGetParams: SensorMaintenanceGetParams) = apply {
    ...
    override fun toString() =
        "SensorMaintenanceGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
