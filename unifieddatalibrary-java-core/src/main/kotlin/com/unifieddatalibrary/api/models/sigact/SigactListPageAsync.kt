...
class SigactListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sigactListPageAsync: SigactListPageAsync) =
            apply {
        ...
        fun service(service: SigactServiceAsync) =
            apply {
    ...
    override fun toString() = "SigactListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
