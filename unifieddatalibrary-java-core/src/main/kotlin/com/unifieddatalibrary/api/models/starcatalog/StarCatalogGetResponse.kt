...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(starCatalogGetResponse: StarCatalogGetResponse) = apply {
            ...
            aavsoVsxId = starCatalogGetResponse.aavsoVsxId
            abgmag = starCatalogGetResponse.abgmag
            abgmagOrigin = starCatalogGetResponse.abgmagOrigin
            abgmagUnc = starCatalogGetResponse.abgmagUnc
            abimag = starCatalogGetResponse.abimag
            abimagOrigin = starCatalogGetResponse.abimagOrigin
            abimagUnc = starCatalogGetResponse.abimagUnc
            abrmag = starCatalogGetResponse.abrmag
            abrmagOrigin = starCatalogGetResponse.abrmagOrigin
            abrmagUnc = starCatalogGetResponse.abrmagUnc
            abymag = starCatalogGetResponse.abymag
            abymagOrigin = starCatalogGetResponse.abymagOrigin
            abymagUnc = starCatalogGetResponse.abymagUnc
            abzmag = starCatalogGetResponse.abzmag
            abzmagOrigin = starCatalogGetResponse.abzmagOrigin
            abzmagUnc = starCatalogGetResponse.abzmagUnc
            allWisEccInd = starCatalogGetResponse.allWisEccInd
            allWiseId = starCatalogGetResponse.allWiseId
            allWisEnaInd = starCatalogGetResponse.allWisEnaInd
            allWisEphQualInd = starCatalogGetResponse.allWisEphQualInd
            apassId = starCatalogGetResponse.apassId
            astrometricExcessNoise = starCatalogGetResponse.astrometricExcessNoise
            astrometricExcessNoiseSig = starCatalogGetResponse.astrometricExcessNoiseSig
            bmag = starCatalogGetResponse.bmag
            bmagOrigin = starCatalogGetResponse.bmagOrigin
            bmagUnc = starCatalogGetResponse.bmagUnc
            bpmag = starCatalogGetResponse.bpmag
            bpmagUnc = starCatalogGetResponse.bpmagUnc
            carrascoCatId = starCatalogGetResponse.carrascoCatId
            catVersion = starCatalogGetResponse.catVersion
            catWise2020Id = starCatalogGetResponse.catWise2020Id
            createdAt = starCatalogGetResponse.createdAt
            createdBy = starCatalogGetResponse.createdBy
            decUnc = starCatalogGetResponse.decUnc
            ducatiCatId = starCatalogGetResponse.ducatiCatId
            ...
            healpixIndex = starCatalogGetResponse.healpixIndex
            hipCatId = starCatalogGetResponse.hipCatId
            hmag = starCatalogGetResponse.hmag
            hmagOrigin = starCatalogGetResponse.hmagOrigin
            hmagUnc = starCatalogGetResponse.hmagUnc
            imag = starCatalogGetResponse.imag
            imagOrigin = starCatalogGetResponse.imagOrigin
            imagUnc = starCatalogGetResponse.imagUnc
            jmag = starCatalogGetResponse.jmag
            jmagOrigin = starCatalogGetResponse.jmagOrigin
            jmagUnc = starCatalogGetResponse.jmagUnc
            kmag = starCatalogGetResponse.kmag
            kmagOrigin = starCatalogGetResponse.kmagOrigin
            kmagUnc = starCatalogGetResponse.kmagUnc
            morphologyInd = starCatalogGetResponse.morphologyInd
            multFlag = starCatalogGetResponse.multFlag
            multiplicity = starCatalogGetResponse.multiplicity
            neighborDec = starCatalogGetResponse.neighborDec
            ...
            neighborRa = starCatalogGetResponse.neighborRa
            nonSingleStar = starCatalogGetResponse.nonSingleStar
            numNeighbors = starCatalogGetResponse.numNeighbors
            origin = starCatalogGetResponse.origin
            origNetwork = starCatalogGetResponse.origNetwork
            panStarrsId = starCatalogGetResponse.panStarrsId
            ...
            ps1astrometryCorrectionFlag = starCatalogGetResponse.ps1astrometryCorrectionFlag
            ps1ObjInfoFlag = starCatalogGetResponse.ps1ObjInfoFlag
            ps1QualityFlag = starCatalogGetResponse.ps1QualityFlag
            raUnc = starCatalogGetResponse.raUnc
            rmag = starCatalogGetResponse.rmag
            rmagOrigin = starCatalogGetResponse.rmagOrigin
            rmagUnc = starCatalogGetResponse.rmagUnc
            rpmag = starCatalogGetResponse.rpmag
            rpmagUnc = starCatalogGetResponse.rpmagUnc
            ruwe = starCatalogGetResponse.ruwe
            sdaCatId = starCatalogGetResponse.sdaCatId
            sgmag = starCatalogGetResponse.sgmag
            sgmagUnc = starCatalogGetResponse.sgmagUnc
            shift = starCatalogGetResponse.shift
            shiftFlag = starCatalogGetResponse.shiftFlag
            shiftFwhm1 = starCatalogGetResponse.shiftFwhm1
            shiftFwhm6 = starCatalogGetResponse.shiftFwhm6
            skyMapperId = starCatalogGetResponse.skyMapperId
            twoMassId = starCatalogGetResponse.twoMassId
            twoMassPhQualInd = starCatalogGetResponse.twoMassPhQualInd
            twoMassReadFlag = starCatalogGetResponse.twoMassReadFlag
            twoMassXscId = starCatalogGetResponse.twoMassXscId
            tychoDscId = starCatalogGetResponse.tychoDscId
            uhsId = starCatalogGetResponse.uhsId
            ukidssGcsId = starCatalogGetResponse.ukidssGcsId
            ukidssGpsId = starCatalogGetResponse.ukidssGpsId
            ukidssLasId = starCatalogGetResponse.ukidssLasId
            ...
            variability = starCatalogGetResponse.variability
            vhsId = starCatalogGetResponse.vhsId
            vmag = starCatalogGetResponse.vmag
            vmagOrigin = starCatalogGetResponse.vmagOrigin
            vmagUnc = starCatalogGetResponse.vmagUnc
            w1mag = starCatalogGetResponse.w1mag
            w1magOrigin = starCatalogGetResponse.w1magOrigin
            w1magUnc = starCatalogGetResponse.w1magUnc
            w1sat = starCatalogGetResponse.w1sat
            w2mag = starCatalogGetResponse.w2mag
            w2magOrigin = starCatalogGetResponse.w2magOrigin
            w2magUnc = starCatalogGetResponse.w2magUnc
            w2sat = starCatalogGetResponse.w2sat
            w3mag = starCatalogGetResponse.w3mag
            w3magOrigin = starCatalogGetResponse.w3magOrigin
            w3magUnc = starCatalogGetResponse.w3magUnc
            w3sat = starCatalogGetResponse.w3sat
            w4mag = starCatalogGetResponse.w4mag
            w4magOrigin = starCatalogGetResponse.w4magOrigin
            w4magUnc = starCatalogGetResponse.w4magUnc
            w4sat = starCatalogGetResponse.w4sat
            wdsCatId = starCatalogGetResponse.wdsCatId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StarCatalogGetResponse &&
