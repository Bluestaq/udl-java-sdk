...
/**
 * Service operation to take a single vessel record as a POST body and ingest into the database. A
 * specific role is required to perform this service operation. Please contact the UDL team for
 * assistance.
 */
class VesselCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselCreateParams: VesselCreateParams) = apply {
        ...
        /** The original source Id for this vessel. */
        fun altVesselId(altVesselId: String) = apply { body.altVesselId(altVesselId) }
         ...
         * value.
         */
        fun altVesselId(altVesselId: JsonField<String>) = apply { body.altVesselId(altVesselId) }
        ...
        /** The date this vessel was first seen. */
        fun firstSeen(firstSeen: OffsetDateTime) = apply { body.firstSeen(firstSeen) }
         ...
         * supported value.
         */
        fun firstSeen(firstSeen: JsonField<OffsetDateTime>) = apply { body.firstSeen(firstSeen) }

        /**
         * The vessel hull number designation of this maritime vessel. The hull number is a 1-6
         * character alphanumeric entry assigned to a ship and painted on the hull.
         */
        fun hullNum(hullNum: String) = apply { body.hullNum(hullNum) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun hullNum(hullNum: JsonField<String>) = apply { body.hullNum(hullNum) }
         ...
         */
        fun imon(imon: Int) = apply { body.imon(imon) }
         ...
         */
        fun imon(imon: JsonField<Int>) = apply { body.imon(imon) }
         ...
         * identifies the transmitter station of the vessel.
         */
        fun mmsi(mmsi: String) = apply { body.mmsi(mmsi) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun mmsi(mmsi: JsonField<String>) = apply { body.mmsi(mmsi) }

        /** The number of blades per shaft for this vessel. */
        fun numBlades(numBlades: Int) = apply { body.numBlades(numBlades) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun numBlades(numBlades: JsonField<Int>) = apply { body.numBlades(numBlades) }

        /** The number of shafts on this vessel. */
        fun numShafts(numShafts: Int) = apply { body.numShafts(numShafts) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun numShafts(numShafts: JsonField<Int>) = apply { body.numShafts(numShafts) }
        ...
        /** The type of propulsion employed by this vessel. */
        fun propType(propType: String) = apply { body.propType(propType) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun propType(propType: JsonField<String>) = apply { body.propType(propType) }
         ...
         * numerical.
         */
        fun sconum(sconum: String) = apply { body.sconum(sconum) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun sconum(sconum: JsonField<String>) = apply { body.sconum(sconum) }
        ...
        /** The stern type code (Counter, Cruiser) associated with this vessel. */
        fun sternType(sternType: String) = apply { body.sternType(sternType) }
         ...
         * value.
         */
        fun sternType(sternType: JsonField<String>) = apply { body.sternType(sternType) }

        /** The shipbuilder who built this vessel. */
        fun vesselBuilder(vesselBuilder: String) = apply { body.vesselBuilder(vesselBuilder) }
         ...
         * vessel of the class.
         */
        fun vesselClass(vesselClass: String) = apply { body.vesselClass(vesselClass) }
         ...
         * value.
         */
        fun vesselClass(vesselClass: JsonField<String>) = apply { body.vesselClass(vesselClass) }

        /** Further description or explanation of the vessel or type. */
        fun vesselDescription(vesselDescription: String) = apply {
        ...
        /** The flag of the subject vessel. */
        fun vesselFlag(vesselFlag: String) = apply { body.vesselFlag(vesselFlag) }
         ...
         * value.
         */
        fun vesselFlag(vesselFlag: JsonField<String>) = apply { body.vesselFlag(vesselFlag) }
         ...
         */
        fun vesselName(vesselName: String) = apply { body.vesselName(vesselName) }
         ...
         * value.
         */
        fun vesselName(vesselName: JsonField<String>) = apply { body.vesselName(vesselName) }

        /** The reported ship type (e.g. Passenger, Tanker, Cargo, Other, etc.). */
        fun vesselType(vesselType: String) = apply { body.vesselType(vesselType) }
         ...
         * value.
         */
        fun vesselType(vesselType: JsonField<String>) = apply { body.vesselType(vesselType) }

        /** The weight in tons, of this vessel. */
        fun vslWt(vslWt: Double) = apply { body.vslWt(vslWt) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun vslWt(vslWt: JsonField<Double>) = apply { body.vslWt(vslWt) }
        ...
        /** Year the vessel went into service. */
        fun yearBuilt(yearBuilt: String) = apply { body.yearBuilt(yearBuilt) }
         ...
         * value.
         */
        fun yearBuilt(yearBuilt: JsonField<String>) = apply { body.yearBuilt(yearBuilt) }
    ...
    override fun toString() =
        "VesselCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
