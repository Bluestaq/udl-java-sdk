...
class EffectRequestCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectRequestCreateBulkParams].
         *
    ...
    /** A builder for [EffectRequestCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestCreateBulkParams: EffectRequestCreateBulkParams) =
            apply {
                body = effectRequestCreateBulkParams.body.toMutableList()
                additionalHeaders = effectRequestCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectRequestCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestCreateBulkParams].
         *
         ...
         */
        fun build(): EffectRequestCreateBulkParams =
    ...
    override fun toString() = "EffectRequestCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
