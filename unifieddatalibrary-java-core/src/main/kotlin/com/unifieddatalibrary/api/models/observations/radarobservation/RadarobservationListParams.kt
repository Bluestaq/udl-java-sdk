...
class RadarobservationListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RadarobservationListParams].
         *
    ...
    /** A builder for [RadarobservationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationListParams: RadarobservationListParams) =
            apply {
                obTime = radarobservationListParams.obTime
                firstResult = radarobservationListParams.firstResult
                maxResults = radarobservationListParams.maxResults
                additionalHeaders = radarobservationListParams.additionalHeaders.toBuilder()
                additionalQueryParams = radarobservationListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RadarobservationListParams].
         *
         ...
         */
        fun build(): RadarobservationListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RadarobservationListParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RadarobservationListParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
