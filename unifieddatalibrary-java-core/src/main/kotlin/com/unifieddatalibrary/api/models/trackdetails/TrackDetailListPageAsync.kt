...
class TrackDetailListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<TrackDetailListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailListPageAsync: TrackDetailListPageAsync) =
            apply {
        ...
        fun service(service: TrackDetailServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: TrackDetailListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<TrackDetailListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "TrackDetailListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
