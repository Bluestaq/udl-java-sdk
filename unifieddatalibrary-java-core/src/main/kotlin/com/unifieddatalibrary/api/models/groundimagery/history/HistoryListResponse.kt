...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            imageTime = historyListResponse.imageTime
            ...
            format = historyListResponse.format
            idSensor = historyListResponse.idSensor
            keywords = historyListResponse.keywords.map { it.toMutableList() }
            ...
            region = historyListResponse.region
            regionGeoJson = historyListResponse.regionGeoJson
            regionNDims = historyListResponse.regionNDims
            regionSRid = historyListResponse.regionSRid
            regionText = historyListResponse.regionText
            regionType = historyListResponse.regionType
            sourceDl = historyListResponse.sourceDl
            subjectId = historyListResponse.subjectId
