 ...
 * team for assistance.
 */
class SeraDataNavigationCreateParams
private constructor(
    ...
    /** A builder for [SeraDataNavigationCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataNavigationCreateParams: SeraDataNavigationCreateParams) = apply {
            body = seraDataNavigationCreateParams.body.toBuilder()
            additionalHeaders = seraDataNavigationCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = seraDataNavigationCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataNavigationCreateParams].
         *
         ...
         */
        fun build(): SeraDataNavigationCreateParams =
            SeraDataNavigationCreateParams(
                body.build(),
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, spacecraftId=$spacecraftId, id=$id, areaCoverage=$areaCoverage, clockType=$clockType, createdAt=$createdAt, createdBy=$createdBy, hostedForCompanyOrgId=$hostedForCompanyOrgId, idNavigation=$idNavigation, locationAccuracy=$locationAccuracy, manufacturerOrgId=$manufacturerOrgId, modeFrequency=$modeFrequency, modes=$modes, name=$name, notes=$notes, origin=$origin, origNetwork=$origNetwork, partnerSpacecraftId=$partnerSpacecraftId, payloadType=$payloadType, additionalProperties=$additionalProperties}"
    }
