...
/**
 * Service operation to take a single operatingunitremark record as a POST body and ingest into the
 * database. A specific role is required to perform this service operation. Please contact the UDL
 * team for assistance.
 */
class OperatingunitremarkCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun idOperatingUnit(): String = body.idOperatingUnit()
    ...
    /** A builder for [OperatingunitremarkCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitremarkCreateParams: OperatingunitremarkCreateParams) =
            apply {
                body = operatingunitremarkCreateParams.body.toBuilder()
                additionalHeaders = operatingunitremarkCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    operatingunitremarkCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OperatingunitremarkCreateParams].
         *
         ...
         */
        fun build(): OperatingunitremarkCreateParams =
            OperatingunitremarkCreateParams(
                body.build(),
