...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            corrType = historyListResponse.corrType
            dataMode = historyListResponse.dataMode
            msgTs = historyListResponse.msgTs
            obId = historyListResponse.obId
            obType = historyListResponse.obType
            referenceOrbitId = historyListResponse.referenceOrbitId
            referenceOrbitType = historyListResponse.referenceOrbitType
            source = historyListResponse.source
            id = historyListResponse.id
            algorithmCorrType = historyListResponse.algorithmCorrType
            altCatalog = historyListResponse.altCatalog
            altNamespace = historyListResponse.altNamespace
            altObjectId = historyListResponse.altObjectId
            altUct = historyListResponse.altUct
            astat = historyListResponse.astat
            corrQuality = historyListResponse.corrQuality
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            idOnOrbit = historyListResponse.idOnOrbit
            idParentCorrelation = historyListResponse.idParentCorrelation
