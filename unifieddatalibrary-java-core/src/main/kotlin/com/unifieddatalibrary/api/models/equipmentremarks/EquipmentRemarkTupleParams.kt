 ...
 */
class EquipmentRemarkTupleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EquipmentRemarkTupleParams].
         *
    ...
    /** A builder for [EquipmentRemarkTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentRemarkTupleParams: EquipmentRemarkTupleParams) = apply {
            columns = equipmentRemarkTupleParams.columns
            firstResult = equipmentRemarkTupleParams.firstResult
            maxResults = equipmentRemarkTupleParams.maxResults
            additionalHeaders = equipmentRemarkTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = equipmentRemarkTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EquipmentRemarkTupleParams].
         *
         ...
         */
        fun build(): EquipmentRemarkTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EquipmentRemarkTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "EquipmentRemarkTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
