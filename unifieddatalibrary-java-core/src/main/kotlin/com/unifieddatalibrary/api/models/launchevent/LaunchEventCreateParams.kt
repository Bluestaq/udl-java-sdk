...
class LaunchEventCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventCreateParams: LaunchEventCreateParams) =
            apply {
        ...
        /** The launch date, in ISO8601 UTC format. */
        fun launchDate(launchDate: OffsetDateTime) =
            apply {
    ...
    override fun toString() = "LaunchEventCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
