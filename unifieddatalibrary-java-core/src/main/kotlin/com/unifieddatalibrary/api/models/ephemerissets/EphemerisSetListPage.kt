...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetListPage: EphemerisSetListPage) = apply {
            service = ephemerisSetListPage.service
            params = ephemerisSetListPage.params
            items = ephemerisSetListPage.items
        }

        fun service(service: EphemerisSetService) = apply { this.service = service }

        /** The parameters that were used to request this page. */
        fun params(params: EphemerisSetListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<EphemerisSetAbridged>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EphemerisSetListPage &&
