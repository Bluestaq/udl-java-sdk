...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissileTrackCountParams].
         *
    ...
    /** A builder for [MissileTrackCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missileTrackCountParams: MissileTrackCountParams) = apply {
            ts = missileTrackCountParams.ts
            firstResult = missileTrackCountParams.firstResult
            maxResults = missileTrackCountParams.maxResults
            additionalHeaders = missileTrackCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = missileTrackCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MissileTrackCountParams].
         *
         ...
         */
        fun build(): MissileTrackCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MissileTrackCountParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MissileTrackCountParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
