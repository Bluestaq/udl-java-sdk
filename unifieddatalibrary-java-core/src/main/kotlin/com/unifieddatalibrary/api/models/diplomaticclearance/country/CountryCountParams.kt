...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CountryCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryCountParams: CountryCountParams) = apply {
    ...
    override fun toString() =
        "CountryCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
