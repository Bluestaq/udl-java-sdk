...
/**
 * Service operation to delete a item record specified by the passed ID path parameter. A specific
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ItemDeleteParams = builder().build()
    ...
    override fun toString() =
        "ItemDeleteParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
