...
/**
 * Service operation to update an Organization. A specific role is required to perform this service
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationUpdateParams: OrganizationUpdateParams) = apply {
            pathId = organizationUpdateParams.pathId
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && name == other.name && source == other.source && type == other.type && bodyId == other.bodyId && active == other.active && category == other.category && countryCode == other.countryCode && createdAt == other.createdAt && createdBy == other.createdBy && description == other.description && externalId == other.externalId && nationality == other.nationality && origin == other.origin && origNetwork == other.origNetwork && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, name, source, type, bodyId, active, category, countryCode, createdAt, createdBy, description, externalId, nationality, origin, origNetwork, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, type=$type, bodyId=$bodyId, active=$active, category=$category, countryCode=$countryCode, createdAt=$createdAt, createdBy=$createdBy, description=$description, externalId=$externalId, nationality=$nationality, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrganizationUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "OrganizationUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
