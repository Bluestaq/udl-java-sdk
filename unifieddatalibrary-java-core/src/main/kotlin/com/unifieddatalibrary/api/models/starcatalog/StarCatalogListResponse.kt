...
class StarCatalogListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogListResponse: StarCatalogListResponse) =
            apply {
    ...
    fun validate(): StarCatalogListResponse =
        apply {
            if (validated) {
              return@apply
            }
