...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaDetailListPage: AntennaDetailListPage) = apply {
            service = antennaDetailListPage.service
            params = antennaDetailListPage.params
            items = antennaDetailListPage.items
        }

        fun service(service: AntennaDetailService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AntennaDetailListPage &&
    ...
    override fun toString() =
        "AntennaDetailListPage{service=$service, params=$params, items=$items}"
}
