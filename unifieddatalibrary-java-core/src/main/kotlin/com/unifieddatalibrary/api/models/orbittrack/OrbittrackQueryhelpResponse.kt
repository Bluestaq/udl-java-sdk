...
class OrbittrackQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OrbittrackQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OrbittrackQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackQueryhelpResponse: OrbittrackQueryhelpResponse) =
            apply {
                aodrSupported = orbittrackQueryhelpResponse.aodrSupported
                classificationMarking = orbittrackQueryhelpResponse.classificationMarking
                description = orbittrackQueryhelpResponse.description
                historySupported = orbittrackQueryhelpResponse.historySupported
                name = orbittrackQueryhelpResponse.name
                parameters = orbittrackQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = orbittrackQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = orbittrackQueryhelpResponse.restSupported
                sortSupported = orbittrackQueryhelpResponse.sortSupported
                typeName = orbittrackQueryhelpResponse.typeName
                uri = orbittrackQueryhelpResponse.uri
                additionalProperties = orbittrackQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OrbittrackQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OrbittrackQueryhelpResponse =
    ...
    fun validate(): OrbittrackQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbittrackQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
