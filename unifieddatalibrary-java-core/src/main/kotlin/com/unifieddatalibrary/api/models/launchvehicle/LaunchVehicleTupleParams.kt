...
class LaunchVehicleTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchVehicleTupleParams].
         *
    ...
    /** A builder for [LaunchVehicleTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleTupleParams: LaunchVehicleTupleParams) =
            apply {
                columns = launchVehicleTupleParams.columns
                firstResult = launchVehicleTupleParams.firstResult
                maxResults = launchVehicleTupleParams.maxResults
                additionalHeaders = launchVehicleTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = launchVehicleTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchVehicleTupleParams].
         *
         ...
         */
        fun build(): LaunchVehicleTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchVehicleTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "LaunchVehicleTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
