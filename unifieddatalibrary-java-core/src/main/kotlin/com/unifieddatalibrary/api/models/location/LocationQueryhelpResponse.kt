...
class LocationQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LocationQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LocationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(locationQueryhelpResponse: LocationQueryhelpResponse) = apply {
            aodrSupported = locationQueryhelpResponse.aodrSupported
            classificationMarking = locationQueryhelpResponse.classificationMarking
            description = locationQueryhelpResponse.description
            historySupported = locationQueryhelpResponse.historySupported
            name = locationQueryhelpResponse.name
            parameters = locationQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = locationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = locationQueryhelpResponse.restSupported
            sortSupported = locationQueryhelpResponse.sortSupported
            typeName = locationQueryhelpResponse.typeName
            uri = locationQueryhelpResponse.uri
            additionalProperties = locationQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LocationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LocationQueryhelpResponse =
    ...
    fun validate(): LocationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
