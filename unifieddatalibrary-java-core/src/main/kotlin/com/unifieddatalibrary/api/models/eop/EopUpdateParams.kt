...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopUpdateParams: EopUpdateParams) = apply {
         ...
         * or predicted.
         */
        fun eopDate(eopDate: OffsetDateTime) = apply { body.eopDate(eopDate) }
         ...
         * supported value.
         */
        fun eopDate(eopDate: JsonField<OffsetDateTime>) = apply { body.eopDate(eopDate) }
         ...
         */
        fun dEpsilon(dEpsilon: Double) = apply { body.dEpsilon(dEpsilon) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dEpsilon(dEpsilon: JsonField<Double>) = apply { body.dEpsilon(dEpsilon) }
         ...
         */
        fun dEpsilonB(dEpsilonB: Double) = apply { body.dEpsilonB(dEpsilonB) }
         ...
         * value.
         */
        fun dEpsilonB(dEpsilonB: JsonField<Double>) = apply { body.dEpsilonB(dEpsilonB) }

        /** The estimated uncertainty/error in the dEpsilon value in milliseconds of arc. */
        fun dEpsilonUnc(dEpsilonUnc: Double) = apply { body.dEpsilonUnc(dEpsilonUnc) }
         ...
         * value.
         */
        fun dEpsilonUnc(dEpsilonUnc: JsonField<Double>) = apply { body.dEpsilonUnc(dEpsilonUnc) }
         ...
         */
        fun dPsi(dPsi: Double) = apply { body.dPsi(dPsi) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dPsi(dPsi: JsonField<Double>) = apply { body.dPsi(dPsi) }
         ...
         */
        fun dPsib(dPsib: Double) = apply { body.dPsib(dPsib) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dPsib(dPsib: JsonField<Double>) = apply { body.dPsib(dPsib) }

        /** The estimated uncertainty/error in the dPSI value in milliseconds of arc. */
        fun dPsiUnc(dPsiUnc: Double) = apply { body.dPsiUnc(dPsiUnc) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dPsiUnc(dPsiUnc: JsonField<Double>) = apply { body.dPsiUnc(dPsiUnc) }
         ...
         * record represents IAU 1980 data.
         */
        fun dX(dX: Double) = apply { body.dX(dX) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dX(dX: JsonField<Double>) = apply { body.dX(dX) }
         ...
         */
        fun dXb(dXb: Double) = apply { body.dXb(dXb) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dXb(dXb: JsonField<Double>) = apply { body.dXb(dXb) }

        /** The estimated uncertainty/error in the Bulletin A dX value, in milliseconds of arc. */
        fun dXUnc(dXUnc: Double) = apply { body.dXUnc(dXUnc) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dXUnc(dXUnc: JsonField<Double>) = apply { body.dXUnc(dXUnc) }
         ...
         * record represents IAU 1980 data.
         */
        fun dY(dY: Double) = apply { body.dY(dY) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dY(dY: JsonField<Double>) = apply { body.dY(dY) }
         ...
         * when this record represents IAU 1980 data.
         */
        fun dYb(dYb: Double) = apply { body.dYb(dYb) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dYb(dYb: JsonField<Double>) = apply { body.dYb(dYb) }

        /** The estimated uncertainty/error in the Bulletin A dY value, in milliseconds of arc. */
        fun dYUnc(dYUnc: Double) = apply { body.dYUnc(dYUnc) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dYUnc(dYUnc: JsonField<Double>) = apply { body.dYUnc(dYUnc) }
         ...
         */
        fun lod(lod: Double) = apply { body.lod(lod) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun lod(lod: JsonField<Double>) = apply { body.lod(lod) }

        /** The estimated uncertainty/error in the lod value in seconds. */
        fun lodUnc(lodUnc: Double) = apply { body.lodUnc(lodUnc) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun lodUnc(lodUnc: JsonField<Double>) = apply { body.lodUnc(lodUnc) }

        /**
         * Flag indicating Issued (I), or Predicted (P) for this record's nutation values (dPSI and
         * dEpsilon).
         */
        fun nutationState(nutationState: NutationState) = apply {
        ...
        /** Flag indicating Issued (I), or Predicted (P) for this record's polar motion values. */
        fun polarMotionState(polarMotionState: PolarMotionState) = apply {
         ...
         */
        fun polarMotionX(polarMotionX: Double) = apply { body.polarMotionX(polarMotionX) }
         ...
         * Earth-centered, Earth-fixed or ECEF reference frame). Measured in arc seconds.
         */
        fun polarMotionXb(polarMotionXb: Double) = apply { body.polarMotionXb(polarMotionXb) }
        ...
        /** Estimated uncertainty/error in polarMotionX value in arc seconds. */
        fun polarMotionXUnc(polarMotionXUnc: Double) = apply {
         ...
         * Earth-centered, Earth-fixed or ECEF reference frame). Measured in arc seconds.
         */
        fun polarMotionY(polarMotionY: Double) = apply { body.polarMotionY(polarMotionY) }
         ...
         * Earth-centered, Earth-fixed or ECEF reference frame). Measured in arc seconds.
         */
        fun polarMotionYb(polarMotionYb: Double) = apply { body.polarMotionYb(polarMotionYb) }
        ...
        /** Estimated uncertainty/error in polarMotionY value in arc seconds. */
        fun polarMotionYUnc(polarMotionYUnc: Double) = apply {
         ...
         */
        fun precessionNutationStd(precessionNutationStd: String) = apply {
         ...
         * The difference between the Bulletin A UT1 and UTC time scales as of eopDate in seconds.
         */
        fun ut1Utc(ut1Utc: Double) = apply { body.ut1Utc(ut1Utc) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun ut1Utc(ut1Utc: JsonField<Double>) = apply { body.ut1Utc(ut1Utc) }

        /**
         * The Bulletin B difference between the UT1 and UTC time scales as of eopDate in seconds.
         */
        fun ut1Utcb(ut1Utcb: Double) = apply { body.ut1Utcb(ut1Utcb) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun ut1Utcb(ut1Utcb: JsonField<Double>) = apply { body.ut1Utcb(ut1Utcb) }

        /**
         * Flag indicating Issued (I), or Predicted (P) for this record''s Bulletin A UT1-UTC
         * values.
         */
        fun ut1UtcState(ut1UtcState: Ut1UtcState) = apply { body.ut1UtcState(ut1UtcState) }
        ...
        /** The estimated uncertainty/error in the ut1UTC value in seconds. */
        fun ut1UtcUnc(ut1UtcUnc: Double) = apply { body.ut1UtcUnc(ut1UtcUnc) }
         ...
         * value.
         */
        fun ut1UtcUnc(ut1UtcUnc: JsonField<Double>) = apply { body.ut1UtcUnc(ut1UtcUnc) }
     ...
     * (International Earth Rotation and Reference Systems Service). Earth Orientation Parameters
     * describe the irregularities of the earth's rotation. Technically, they are the parameters
     * which provide the rotation of the ITRS (International Terrestrial Reference System) to the
     * ICRS (International Celestial Reference System) as a function of time. Universal time --
     * Universal time (UT1) is the time of the earth clock, which performs one revolution in about
     * 24h. It is practically proportional to the sidereal time. The excess revolution time is
     * called length of day (LOD). Coordinates of the pole -- x and y are the coordinates of the
     * Celestial Ephemeris Pole (CEP) relative to the IRP, the IERS Reference Pole. The CEP differs
     * from the instantaneous rotation axis by quasi-diurnal terms with amplitudes under 0.01" (see
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            dEpsilon: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("dEpsilonB")
            @ExcludeMissing
            dEpsilonB: JsonField<Double> = JsonMissing.of(),
            ...
            @ExcludeMissing
            ut1UtcUnc: JsonField<Double> = JsonMissing.of(),
        ) : this(
            classificationMarking,
            dataMode,
            eopDate,
         ...
         * Returns the raw JSON value of [nutationState].
         *
         * Unlike [nutationState], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("nutationState")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [polarMotionXb].
         *
         * Unlike [polarMotionXb], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("polarMotionXB")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [polarMotionXUnc].
         *
         * Unlike [polarMotionXUnc], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("polarMotionXUnc")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [polarMotionYb].
         *
         * Unlike [polarMotionYb], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("polarMotionYB")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [polarMotionYUnc].
         *
         * Unlike [polarMotionYUnc], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("polarMotionYUnc")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [precessionNutationStd].
         *
         * Unlike [precessionNutationStd], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("precessionNutationStd")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            /**
             * Effective date/time for the EOP values in ISO8601 UTC format. The values could be
            ...
            /**
             * The Bulletin A offset in obliquity dDe1980 with respect to the IAU 1976 Theory of
             * Precession and the IAU 1980 Theory of Nutation, measured in milliseconds of arc.
             * Note: dEpsilon is not used when this record represents IAU 2000 data.
             */
             ...
             * Sets [Builder.dEpsilon] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dEpsilon] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * The Bulletin B offset in obliquity dDe1980 with respect to the IAU 1976 Theory of
             * Precession and the IAU 1980 Theory of Nutation, measured in milliseconds of arc.
             * Note: dEpsilonB is not used when this record represents IAU 2000 data.
             */
             ...
             * Sets [Builder.dEpsilonUnc] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dEpsilonUnc] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dEpsilonUnc(dEpsilonUnc: JsonField<Double>) = apply {
             ...
             * The Bulletin A offset in longitude dDy1980 with respect to the IAU 1976 Theory of
             * Precession and the IAU 1980 Theory of Nutation, measured in milliseconds of arc.
             * Note: dPSI is not used when this record represents IAU 2000 data.
             */
             ...
             * The Bulletin B offset in longitude dDy1980 with respect to the IAU 1976 Theory of
             * Precession and the IAU 1980 Theory of Nutation, measured in milliseconds of arc.
             * Note: dPSIB is not used when this record represents IAU 2000 data.
             */
             ...
             * Sets [Builder.dPsib] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dPsib] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.dPsiUnc] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dPsiUnc] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Theory of Precession and Nutation, measured in milliseconds of arc. Note: dX is not
             * used when this record represents IAU 1980 data.
             */
            ...
            /**
             * The Bulletin B celestial pole offset along the X-axis with respect to the IAU 2000A
             * Theory of Precession and Nutation, measured in milliseconds of arc. Note: dXB is not
             * used when this record represents IAU 1980 data.
             */
             ...
             * Sets [Builder.dXUnc] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dXUnc] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Theory of Precession and Nutation, measured in milliseconds of arc. Note: dY is not
             * used when this record represents IAU 1980 data.
             */
            ...
            /**
             * The Bulletin B celestial pole offset along the Y-axis with respect to the IAU 2000A
             * Theory of Precession and Nutation, measured in milliseconds of arc. Note: dYB is not
             * used when this record represents IAU 1980 data.
             */
             ...
             * Sets [Builder.dYUnc] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dYUnc] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Bulletin A length of day or LOD in milliseconds. Universal time (UT1) is the time of
             * the earth clock, which performs one revolution in about 24h. It is practically
             * proportional to the sidereal time. The excess revolution time is called length of day
             * (LOD).
             */
             ...
             * Sets [Builder.lodUnc] to an arbitrary JSON value.
             *
             * You should usually call [Builder.lodUnc] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Flag indicating Issued (I), or Predicted (P) for this record's nutation values (dPSI
             * and dEpsilon).
             */
            fun nutationState(nutationState: NutationState) =
                nutationState(JsonField.of(nutationState))

            /**
             * Sets [Builder.nutationState] to an arbitrary JSON value.
             *
             * You should usually call [Builder.nutationState] with a well-typed [NutationState]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun nutationState(nutationState: JsonField<NutationState>) = apply {
             ...
             * Sets [Builder.polarMotionState] to an arbitrary JSON value.
             *
             * You should usually call [Builder.polarMotionState] with a well-typed
             * [PolarMotionState] value instead. This method is primarily for setting the field to
            ...
            /**
             * The Bulletin A X coordinate value of earth polar motion at eopDate. Polar motion of
             * the Earth is the motion of the Earth's rotational axis relative to its crust. This is
             * measured with respect to a reference frame in which the solid Earth is fixed (a
             * so-called Earth-centered, Earth-fixed or ECEF reference frame). Measured in arc
             * seconds.
             */
            ...
            /**
             * Bulletin B X coordinate value of earth polar motion at eopDate. Polar motion of the
             * Earth is the motion of the Earth's rotational axis relative to its crust. This is
             * measured with respect to a reference frame in which the solid Earth is fixed (a
             * so-called Earth-centered, Earth-fixed or ECEF reference frame). Measured in arc
             * seconds.
             ...
             * Sets [Builder.polarMotionXb] to an arbitrary JSON value.
             *
             * You should usually call [Builder.polarMotionXb] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun polarMotionXb(polarMotionXb: JsonField<Double>) = apply {
            ...
            /**
             * The Bulletin A Y coordinate value of earth polar motion at eopDate. Polar motion of
             * the Earth is the motion of the Earth's rotational axis relative to its crust. This is
             * measured with respect to a reference frame in which the solid Earth is fixed (a
             * so-called Earth-centered, Earth-fixed or ECEF reference frame). Measured in arc
             * seconds.
            ...
            /**
             * Bulletin B Y coordinate value of earth polar motion at eopDate. Polar motion of the
             * Earth is the motion of the Earth's rotational axis relative to its crust. This is
             * measured with respect to a reference frame in which the solid Earth is fixed (a
             * so-called Earth-centered, Earth-fixed or ECEF reference frame). Measured in arc
             * seconds.
             ...
             * Sets [Builder.polarMotionYb] to an arbitrary JSON value.
             *
             * You should usually call [Builder.polarMotionYb] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun polarMotionYb(polarMotionYb: JsonField<Double>) = apply {
             ...
             * record. IAU1980 records employ the IAU 1976 Theory of Precession and IAU 1980 Theory
             * of Nutation, and IAU2000 records employ the IAU 2000A Theory of Precession and
             * Nutation.
             */
             ...
             * Sets [Builder.precessionNutationStd] to an arbitrary JSON value.
             *
             * You should usually call [Builder.precessionNutationStd] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun precessionNutationStd(precessionNutationStd: JsonField<String>) = apply {
             ...
             * Sets [Builder.ut1Utcb] to an arbitrary JSON value.
             *
             * You should usually call [Builder.ut1Utcb] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
