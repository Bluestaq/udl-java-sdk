 ...
 */
class CloselyspacedobjectTupleResponse
...
private constructor(
    ...
    /** A builder for [CloselyspacedobjectTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(closelyspacedobjectTupleResponse: CloselyspacedobjectTupleResponse) =
            apply {
                classificationMarking = closelyspacedobjectTupleResponse.classificationMarking
                csoState = closelyspacedobjectTupleResponse.csoState
                dataMode = closelyspacedobjectTupleResponse.dataMode
                eventStartTime = closelyspacedobjectTupleResponse.eventStartTime
                eventType = closelyspacedobjectTupleResponse.eventType
                source = closelyspacedobjectTupleResponse.source
                id = closelyspacedobjectTupleResponse.id
                actorSvEpoch = closelyspacedobjectTupleResponse.actorSvEpoch
                analysisDuration = closelyspacedobjectTupleResponse.analysisDuration
                analysisEpoch = closelyspacedobjectTupleResponse.analysisEpoch
                compType = closelyspacedobjectTupleResponse.compType
                contextKeys =
                    closelyspacedobjectTupleResponse.contextKeys.map { it.toMutableList() }
                contextValues =
                    closelyspacedobjectTupleResponse.contextValues.map { it.toMutableList() }
                createdAt = closelyspacedobjectTupleResponse.createdAt
                createdBy = closelyspacedobjectTupleResponse.createdBy
                csoDetails = closelyspacedobjectTupleResponse.csoDetails.map { it.toMutableList() }
                deltaVTol = closelyspacedobjectTupleResponse.deltaVTol
                durationThreshold = closelyspacedobjectTupleResponse.durationThreshold
                eventEndTime = closelyspacedobjectTupleResponse.eventEndTime
                eventIntervalCoverage = closelyspacedobjectTupleResponse.eventIntervalCoverage
                extId = closelyspacedobjectTupleResponse.extId
                hohmannDeltaV = closelyspacedobjectTupleResponse.hohmannDeltaV
                idActorSv = closelyspacedobjectTupleResponse.idActorSv
                idOnOrbit1 = closelyspacedobjectTupleResponse.idOnOrbit1
                idOnOrbit2 = closelyspacedobjectTupleResponse.idOnOrbit2
                idTargetSv = closelyspacedobjectTupleResponse.idTargetSv
                inclinationDeltaV = closelyspacedobjectTupleResponse.inclinationDeltaV
                indicationSource = closelyspacedobjectTupleResponse.indicationSource
                lonTol = closelyspacedobjectTupleResponse.lonTol
                maxRange = closelyspacedobjectTupleResponse.maxRange
                minPlaneSepAngle = closelyspacedobjectTupleResponse.minPlaneSepAngle
                minPlaneSepEpoch = closelyspacedobjectTupleResponse.minPlaneSepEpoch
                minRange = closelyspacedobjectTupleResponse.minRange
                minRangeAnalysisDuration = closelyspacedobjectTupleResponse.minRangeAnalysisDuration
                minRangeEpoch = closelyspacedobjectTupleResponse.minRangeEpoch
                notes = closelyspacedobjectTupleResponse.notes
                numSubIntervals = closelyspacedobjectTupleResponse.numSubIntervals
                orbitAlignDel = closelyspacedobjectTupleResponse.orbitAlignDel
                orbitPlaneTol = closelyspacedobjectTupleResponse.orbitPlaneTol
                origin = closelyspacedobjectTupleResponse.origin
                origNetwork = closelyspacedobjectTupleResponse.origNetwork
                origObjectId1 = closelyspacedobjectTupleResponse.origObjectId1
                origObjectId2 = closelyspacedobjectTupleResponse.origObjectId2
                rangeThreshold = closelyspacedobjectTupleResponse.rangeThreshold
                rangeTol = closelyspacedobjectTupleResponse.rangeTol
                relPos = closelyspacedobjectTupleResponse.relPos.map { it.toMutableList() }
                relPosMag = closelyspacedobjectTupleResponse.relPosMag
                relSpeedMag = closelyspacedobjectTupleResponse.relSpeedMag
                relVel = closelyspacedobjectTupleResponse.relVel.map { it.toMutableList() }
                satNo1 = closelyspacedobjectTupleResponse.satNo1
                satNo2 = closelyspacedobjectTupleResponse.satNo2
                sourceDl = closelyspacedobjectTupleResponse.sourceDl
                stationLimLonTol = closelyspacedobjectTupleResponse.stationLimLonTol
                targetSvEpoch = closelyspacedobjectTupleResponse.targetSvEpoch
                totalDeltaV = closelyspacedobjectTupleResponse.totalDeltaV
                additionalProperties =
                    closelyspacedobjectTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CloselyspacedobjectTupleResponse].
         *
         ...
         */
        fun build(): CloselyspacedobjectTupleResponse =
            CloselyspacedobjectTupleResponse(
    ...
    fun validate(): CloselyspacedobjectTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloselyspacedobjectTupleResponse &&
            classificationMarking == other.classificationMarking &&
