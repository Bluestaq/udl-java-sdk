...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityAbridged: EntityAbridged) = apply {
    ...
    fun validate(): EntityAbridged = apply {
        if (validated) {
            return@apply
        }
