...
class EquipmentQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentQueryHelpResponse: EquipmentQueryHelpResponse) = apply {
    ...
    fun validate(): EquipmentQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
