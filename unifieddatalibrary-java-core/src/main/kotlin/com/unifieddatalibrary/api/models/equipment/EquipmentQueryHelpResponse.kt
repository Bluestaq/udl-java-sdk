...
class EquipmentQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EquipmentQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EquipmentQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentQueryHelpResponse: EquipmentQueryHelpResponse) =
            apply {
                aodrSupported = equipmentQueryHelpResponse.aodrSupported
                classificationMarking = equipmentQueryHelpResponse.classificationMarking
                description = equipmentQueryHelpResponse.description
                historySupported = equipmentQueryHelpResponse.historySupported
                name = equipmentQueryHelpResponse.name
                parameters = equipmentQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = equipmentQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = equipmentQueryHelpResponse.restSupported
                sortSupported = equipmentQueryHelpResponse.sortSupported
                typeName = equipmentQueryHelpResponse.typeName
                uri = equipmentQueryHelpResponse.uri
                additionalProperties = equipmentQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EquipmentQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EquipmentQueryHelpResponse =
    ...
    fun validate(): EquipmentQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
