...
class ChannelQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ChannelQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ChannelQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(channelQueryhelpResponse: ChannelQueryhelpResponse) =
            apply {
                aodrSupported = channelQueryhelpResponse.aodrSupported
                classificationMarking = channelQueryhelpResponse.classificationMarking
                description = channelQueryhelpResponse.description
                historySupported = channelQueryhelpResponse.historySupported
                name = channelQueryhelpResponse.name
                parameters = channelQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = channelQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = channelQueryhelpResponse.restSupported
                sortSupported = channelQueryhelpResponse.sortSupported
                typeName = channelQueryhelpResponse.typeName
                uri = channelQueryhelpResponse.uri
                additionalProperties = channelQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ChannelQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ChannelQueryhelpResponse =
    ...
    fun validate(): ChannelQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ChannelQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
