...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfBandTypeListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeListParams: RfBandTypeListParams) = apply {
    ...
    override fun toString() =
        "RfBandTypeListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
