...
class OnorbiteventUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbiteventUpdateParams].
         *
    ...
    /** A builder for [OnorbiteventUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventUpdateParams: OnorbiteventUpdateParams) =
            apply {
                pathId = onorbiteventUpdateParams.pathId
                body = onorbiteventUpdateParams.body.toBuilder()
                additionalHeaders = onorbiteventUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbiteventUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Date/Time of the event. See eventTimeNotes for remarks on the accuracy of the date time. */
        fun eventTime(eventTime: OffsetDateTime) =
            apply {
        ...
        /** Spacecraft age at the event in years. */
        fun ageAtEvent(ageAtEvent: Double) =
            apply {
                body.ageAtEvent(ageAtEvent)
            }
        ...
        /** Spacecraft capacity loss incurred, as a fraction of 1. */
        fun capacityLoss(capacityLoss: Double) =
            apply {
        ...
        /** The result of the reported event. */
        fun eventResult(eventResult: String) =
            apply {
                body.eventResult(eventResult)
            }
        ...
        /** The type of on-orbit event being reported. */
        fun eventType(eventType: String) =
            apply {
        ...
        /** GEO position longitude at event time if applicable. Negative values are west. */
        fun geoPosition(geoPosition: Double) =
            apply {
                body.geoPosition(geoPosition)
            }
        ...
        /** Boolean indicating if the spacecraft is inclined. */
        fun inclined(inclined: Boolean) =
            apply {
                body.inclined(inclined)
            }
        ...
        /** Number of humans injured in the event. */
        fun injured(injured: Int) =
            apply {
                body.injured(injured)
            }
        ...
        /** Insurance loss incurred, as a fraction of 1. */
        fun insuranceLoss(insuranceLoss: Double) =
            apply {
        ...
        /** Unique identifier of the organization which leases this on-orbit spacecraft. */
        fun lesseeOrgId(lesseeOrgId: String) =
            apply {
                body.lesseeOrgId(lesseeOrgId)
            }
        ...
        /** Spacecraft life lost due to the event as a percent/fraction of 1. */
        fun lifeLost(lifeLost: Double) =
            apply {
                body.lifeLost(lifeLost)
            }
        ...
        /** Net amount of the insurance claim for the event, in USD. */
        fun netAmount(netAmount: Double) =
            apply {
                body.netAmount(netAmount)
            }
        ...
        /** The status of the on-orbit object. */
        fun objectStatus(objectStatus: String) =
            apply {
        ...
        /** Organization ID of the operator of the on-orbit spacecraft at the time of the event. */
        fun operatorOrgId(operatorOrgId: String) =
            apply {
        ...
        /** Organization ID of the owner of the on-orbit spacecraft at the time of the event. */
        fun ownerOrgId(ownerOrgId: String) =
            apply {
                body.ownerOrgId(ownerOrgId)
            }
        ...
        /** GEO slot plane number/designator of the spacecraft at event time. */
        fun planeNumber(planeNumber: String) =
            apply {
                body.planeNumber(planeNumber)
            }
        ...
        /** GEO plane slot of the spacecraft at event time. */
        fun planeSlot(planeSlot: String) =
            apply {
                body.planeSlot(planeSlot)
            }
        ...
        /** Faulty stage of flight for the event. */
        fun stageAtFault(stageAtFault: String) =
            apply {
        ...
        /**
         * Returns an immutable instance of [OnorbiteventUpdateParams].
         *
         ...
         */
        fun build(): OnorbiteventUpdateParams =
    ...
    override fun toString() = "OnorbiteventUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
