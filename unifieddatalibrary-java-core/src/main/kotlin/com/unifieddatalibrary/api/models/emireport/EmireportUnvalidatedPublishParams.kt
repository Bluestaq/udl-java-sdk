...
/**
 * Service operation to take multiple EMIReport records as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class EmireportUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [EmireportUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportUnvalidatedPublishParams: EmireportUnvalidatedPublishParams) =
            apply {
                body = emireportUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = emireportUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    emireportUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EmireportUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): EmireportUnvalidatedPublishParams =
            EmireportUnvalidatedPublishParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EmireportUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
