...
class CollectRequestCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectRequestCountParams].
         *
    ...
    /** A builder for [CollectRequestCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestCountParams: CollectRequestCountParams) =
            apply {
                startTime = collectRequestCountParams.startTime
                firstResult = collectRequestCountParams.firstResult
                maxResults = collectRequestCountParams.maxResults
                additionalHeaders = collectRequestCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = collectRequestCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CollectRequestCountParams].
         *
         ...
         */
        fun build(): CollectRequestCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CollectRequestCountParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CollectRequestCountParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
