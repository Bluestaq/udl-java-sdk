...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RouteStatQueryParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatQueryParams: RouteStatQueryParams) = apply {
    ...
    override fun toString() =
        "RouteStatQueryParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
