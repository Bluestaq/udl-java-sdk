...
/**
 * Service operation to take a list of CollectRequest as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class CollectRequestUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            collectRequestUnvalidatedPublishParams: CollectRequestUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                collectRequestUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun toString() =
        "CollectRequestUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
