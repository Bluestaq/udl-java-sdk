...
class OnorbitbatteryListResponse private constructor(
    ...
    private val battery: JsonField<BatteryAbridged>,
    ...
    private constructor(
        ...
        @JsonProperty("battery") @ExcludeMissing battery: JsonField<BatteryAbridged> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun battery(): Optional<BatteryAbridged> = battery.getOptional("battery")
    ...
    @ExcludeMissing
    fun _battery(): JsonField<BatteryAbridged> = battery
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitbatteryListResponse].
         *
    ...
    /** A builder for [OnorbitbatteryListResponse]. */
    class Builder internal constructor() {
        ...
        private var battery: JsonField<BatteryAbridged> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(onorbitbatteryListResponse: OnorbitbatteryListResponse) =
            apply {
                classificationMarking = onorbitbatteryListResponse.classificationMarking
                dataMode = onorbitbatteryListResponse.dataMode
                idBattery = onorbitbatteryListResponse.idBattery
                idOnOrbit = onorbitbatteryListResponse.idOnOrbit
                source = onorbitbatteryListResponse.source
                id = onorbitbatteryListResponse.id
                battery = onorbitbatteryListResponse.battery
                createdAt = onorbitbatteryListResponse.createdAt
                createdBy = onorbitbatteryListResponse.createdBy
                origin = onorbitbatteryListResponse.origin
                origNetwork = onorbitbatteryListResponse.origNetwork
                quantity = onorbitbatteryListResponse.quantity
                additionalProperties = onorbitbatteryListResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Model representation of specific spacecraft battery types. */
        fun battery(battery: BatteryAbridged) = battery(JsonField.of(battery))

        /**
         * Sets [Builder.battery] to an arbitrary JSON value.
         *
         * You should usually call [Builder.battery] with a well-typed [BatteryAbridged] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun battery(battery: JsonField<BatteryAbridged>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [OnorbitbatteryListResponse].
         *
         ...
         */
        fun build(): OnorbitbatteryListResponse =
    ...
    fun validate(): OnorbitbatteryListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "OnorbitbatteryListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idBattery=$idBattery, idOnOrbit=$idOnOrbit, source=$source, id=$id, battery=$battery, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, additionalProperties=$additionalProperties}"
}
