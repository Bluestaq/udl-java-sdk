...
class SpaceEnvObservationFull private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(spaceEnvObservationFull: SpaceEnvObservationFull) =
            apply {
    ...
    fun validate(): SpaceEnvObservationFull =
        apply {
            if (validated) {
              return@apply
            }
