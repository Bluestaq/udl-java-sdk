...
class UdlH3geoUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UdlH3geoUnvalidatedPublishParams].
         *
    ...
    /** A builder for [UdlH3geoUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(udlH3geoUnvalidatedPublishParams: UdlH3geoUnvalidatedPublishParams) =
            apply {
                body = udlH3geoUnvalidatedPublishParams.body.toBuilder()
                additionalHeaders = udlH3geoUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = udlH3geoUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
         ...
         *
         * You should usually call [Builder.cells] with a well-typed `List<Cell>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cells(cells: JsonField<List<Cell>>) =
            apply {
                body.cells(cells)
            }
        ...
        /** The number of cells associated with this H3 Geo data set. At this time, UDL supports up to 50,000 cells. */
        fun numCells(numCells: Int) =
            apply {
                body.numCells(numCells)
            }

        /**
         * Sets [Builder.numCells] to an arbitrary JSON value.
         *
         * You should usually call [Builder.numCells] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numCells(numCells: JsonField<Int>) =
            apply {
                body.numCells(numCells)
            }
         ...
         *
         * You should usually call [Builder.resolution] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resolution(resolution: JsonField<Int>) =
            apply {
                body.resolution(resolution)
            }
        ...
        /**
         * Returns an immutable instance of [UdlH3geoUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): UdlH3geoUnvalidatedPublishParams =
    ...
    class Body private constructor(
        ...
        @JsonProperty("cells")
        @ExcludeMissing
        fun _cells(): JsonField<List<Cell>> = cells
         ...
         * Unlike [numCells], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("numCells")
        @ExcludeMissing
        fun _numCells(): JsonField<Int> = numCells
        ...
        @ExcludeMissing
        fun _resolution(): JsonField<Int> = resolution
        ...
        class Builder internal constructor() {
            ...
            fun addCell(cell: Cell) =
                apply {
                    cells = (cells ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (cells.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (numCells.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (centerFreq.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (resolution.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (type.asKnown().isPresent) 1 else 0)
    ...
    class Cell private constructor(
        ...
        override fun toString() = "Cell{cellId=$cellId, classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, altMean=$altMean, altSigma=$altSigma, anomScoreInterference=$anomScoreInterference, anomScoreSpoofing=$anomScoreSpoofing, changeScore=$changeScore, coverage=$coverage, createdAt=$createdAt, createdBy=$createdBy, idH3Geo=$idH3Geo, origin=$origin, origNetwork=$origNetwork, rpmMax=$rpmMax, rpmMean=$rpmMean, rpmMedian=$rpmMedian, rpmMin=$rpmMin, rpmSigma=$rpmSigma, sourceDl=$sourceDl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is UdlH3geoUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "UdlH3geoUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
