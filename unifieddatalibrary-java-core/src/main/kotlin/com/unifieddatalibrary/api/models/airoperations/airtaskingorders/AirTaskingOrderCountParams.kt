 ...
 */
class AirTaskingOrderCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirTaskingOrderCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderCountParams: AirTaskingOrderCountParams) = apply {
    ...
    override fun toString() =
        "AirTaskingOrderCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
