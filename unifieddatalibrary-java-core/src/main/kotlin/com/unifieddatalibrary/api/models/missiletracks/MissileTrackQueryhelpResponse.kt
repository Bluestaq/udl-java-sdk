...
class MissileTrackQueryhelpResponse
private constructor(
    ...
    /** A builder for [MissileTrackQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missileTrackQueryhelpResponse: MissileTrackQueryhelpResponse) = apply {
            aodrSupported = missileTrackQueryhelpResponse.aodrSupported
            classificationMarking = missileTrackQueryhelpResponse.classificationMarking
            description = missileTrackQueryhelpResponse.description
            historySupported = missileTrackQueryhelpResponse.historySupported
            name = missileTrackQueryhelpResponse.name
            parameters = missileTrackQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = missileTrackQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = missileTrackQueryhelpResponse.restSupported
            sortSupported = missileTrackQueryhelpResponse.sortSupported
            typeName = missileTrackQueryhelpResponse.typeName
            uri = missileTrackQueryhelpResponse.uri
            additionalProperties = missileTrackQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MissileTrackQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MissileTrackQueryhelpResponse =
            MissileTrackQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): MissileTrackQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MissileTrackQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
