...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirEventCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventCountParams: AirEventCountParams) = apply {
    ...
    override fun toString() =
        "AirEventCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
