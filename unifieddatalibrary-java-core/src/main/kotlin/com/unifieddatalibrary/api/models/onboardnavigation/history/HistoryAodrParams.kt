...
package com.unifieddatalibrary.api.models.onboardnavigation.history
...
class HistoryAodrParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyAodrParams: HistoryAodrParams) =
            apply {
                startTime = historyAodrParams.startTime
    ...
    override fun toString() = "HistoryAodrParams{startTime=$startTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
