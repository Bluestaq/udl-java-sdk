...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [IrQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IrQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(irQueryhelpResponse: IrQueryhelpResponse) = apply {
            aodrSupported = irQueryhelpResponse.aodrSupported
            classificationMarking = irQueryhelpResponse.classificationMarking
            description = irQueryhelpResponse.description
            historySupported = irQueryhelpResponse.historySupported
            name = irQueryhelpResponse.name
            parameters = irQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = irQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = irQueryhelpResponse.restSupported
            sortSupported = irQueryhelpResponse.sortSupported
            typeName = irQueryhelpResponse.typeName
            uri = irQueryhelpResponse.uri
            additionalProperties = irQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IrQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IrQueryhelpResponse =
            IrQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): IrQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IrQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
