...
class ItemTrackingListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<ItemTrackingListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingListPageAsync: ItemTrackingListPageAsync) = apply {
        ...
        fun service(service: ItemTrackingServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ItemTrackingListPageAsync &&
    ...
    override fun toString() =
        "ItemTrackingListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
