 ...
 */
class IonoObservationTupleParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ionoObservationTupleParams: IonoObservationTupleParams) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IonoObservationTupleParams &&
    ...
    override fun toString() =
        "IonoObservationTupleParams{columns=$columns, startTimeUtc=$startTimeUtc, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
