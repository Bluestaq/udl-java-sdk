...
/**
 * Spacecraft characterization results from analysis of MASINT data. Supports results of both the
 * overall assessment of a particular spacecraft as well as of individual signature packages.
 */
class OnorbitassessmentGetResponse
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("assmtURL") @ExcludeMissing assmtUrl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("autoAssmt") @ExcludeMissing autoAssmt: JsonField<Boolean> = JsonMissing.of(),
     ...
     */
    @JsonProperty("assmtLevel") @ExcludeMissing fun _assmtLevel(): JsonField<String> = assmtLevel
     ...
     */
    @JsonProperty("obDuration") @ExcludeMissing fun _obDuration(): JsonField<Double> = obDuration
     ...
     */
    @JsonProperty("sigDataType") @ExcludeMissing fun _sigDataType(): JsonField<String> = sigDataType
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitassessmentGetResponse].
         *
    ...
    /** A builder for [OnorbitassessmentGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitassessmentGetResponse: OnorbitassessmentGetResponse) = apply {
            assmtTime = onorbitassessmentGetResponse.assmtTime
            classificationMarking = onorbitassessmentGetResponse.classificationMarking
            dataMode = onorbitassessmentGetResponse.dataMode
            source = onorbitassessmentGetResponse.source
            id = onorbitassessmentGetResponse.id
            assessment = onorbitassessmentGetResponse.assessment
            assmtDetails = onorbitassessmentGetResponse.assmtDetails
            assmtLevel = onorbitassessmentGetResponse.assmtLevel
            assmtRotPeriod = onorbitassessmentGetResponse.assmtRotPeriod
            assmtSubType = onorbitassessmentGetResponse.assmtSubType
            assmtUrl = onorbitassessmentGetResponse.assmtUrl
            autoAssmt = onorbitassessmentGetResponse.autoAssmt
            collectionUrl = onorbitassessmentGetResponse.collectionUrl
            components = onorbitassessmentGetResponse.components.map { it.toMutableList() }
            createdAt = onorbitassessmentGetResponse.createdAt
            createdBy = onorbitassessmentGetResponse.createdBy
            idOnOrbit = onorbitassessmentGetResponse.idOnOrbit
            idSensor = onorbitassessmentGetResponse.idSensor
            obDuration = onorbitassessmentGetResponse.obDuration
            obTime = onorbitassessmentGetResponse.obTime
            onOrbit = onorbitassessmentGetResponse.onOrbit
            origin = onorbitassessmentGetResponse.origin
            origNetwork = onorbitassessmentGetResponse.origNetwork
            origObjectId = onorbitassessmentGetResponse.origObjectId
            origSensorId = onorbitassessmentGetResponse.origSensorId
            satNo = onorbitassessmentGetResponse.satNo
            sigDataType = onorbitassessmentGetResponse.sigDataType
            sourceDl = onorbitassessmentGetResponse.sourceDl
            srcIds = onorbitassessmentGetResponse.srcIds.map { it.toMutableList() }
            srcTyps = onorbitassessmentGetResponse.srcTyps.map { it.toMutableList() }
            tags = onorbitassessmentGetResponse.tags.map { it.toMutableList() }
            transactionId = onorbitassessmentGetResponse.transactionId
            additionalProperties = onorbitassessmentGetResponse.additionalProperties.toMutableMap()
        }
         ...
         * supported value.
         */
        fun assmtTime(assmtTime: JsonField<OffsetDateTime>) = apply { this.assmtTime = assmtTime }
         ...
         * The rotational period, in seconds, determined in the assessment of the on-orbit object.
         */
        fun assmtRotPeriod(assmtRotPeriod: Double) = assmtRotPeriod(JsonField.of(assmtRotPeriod))
         ...
         * value.
         */
        fun sigDataType(sigDataType: JsonField<String>) = apply { this.sigDataType = sigDataType }
        ...
        /**
         * Returns an immutable instance of [OnorbitassessmentGetResponse].
         *
         ...
         */
        fun build(): OnorbitassessmentGetResponse =
    ...
    fun validate(): OnorbitassessmentGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitassessmentGetResponse &&
    ...
    override fun toString() =
        "OnorbitassessmentGetResponse{assmtTime=$assmtTime, classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, assessment=$assessment, assmtDetails=$assmtDetails, assmtLevel=$assmtLevel, assmtRotPeriod=$assmtRotPeriod, assmtSubType=$assmtSubType, assmtUrl=$assmtUrl, autoAssmt=$autoAssmt, collectionUrl=$collectionUrl, components=$components, createdAt=$createdAt, createdBy=$createdBy, idOnOrbit=$idOnOrbit, idSensor=$idSensor, obDuration=$obDuration, obTime=$obTime, onOrbit=$onOrbit, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, origSensorId=$origSensorId, satNo=$satNo, sigDataType=$sigDataType, sourceDl=$sourceDl, srcIds=$srcIds, srcTyps=$srcTyps, tags=$tags, transactionId=$transactionId, additionalProperties=$additionalProperties}"
}
