...
class OnorbitUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitUpdateParams: OnorbitUpdateParams) =
            apply {
    ...
    override fun toString() = "OnorbitUpdateParams{id=$id, onorbitIngest=$onorbitIngest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
