...
class SensorMaintenanceUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorMaintenanceUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceUpdateParams: SensorMaintenanceUpdateParams) =
            apply {
        ...
        /** The name of the changer, if applicable. */
        fun changer(changer: String) =
            apply {
                body.changer(changer)
            }
        ...
        /** The mission capability status of the equipment (e.g. FMC, NMC, PMC, UNK, etc.). */
        fun equipStatus(equipStatus: String) =
            apply {
                body.equipStatus(equipStatus)
            }
        ...
        /** The sensor face(s) to which this COLT maintenance item applies, if applicable. */
        fun impactedFaces(impactedFaces: String) =
            apply {
        ...
        /** The internal COLT line number assigned to this item. */
        fun lineNumber(lineNumber: String) =
            apply {
        ...
        /** The Missile Defense operational capability of this maintenance item. Typical values are G, Y, R, and - for non-applicable sites. */
        fun mdOpsCap(mdOpsCap: String) =
            apply {
                body.mdOpsCap(mdOpsCap)
            }
        ...
        /** The Missile Warning operational capability of this maintenance item. Typical values are G, Y, R, and - for non-applicable sites. */
        fun mwOpsCap(mwOpsCap: String) =
            apply {
                body.mwOpsCap(mwOpsCap)
            }
        ...
        /** The Space Surveillance operational capability of this maintenance item. Typical values are G, Y, R, and - for non-applicable sites. */
        fun ssOpsCap(ssOpsCap: String) =
            apply {
                body.ssOpsCap(ssOpsCap)
            }
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (siteCode.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (activity.asKnown().isPresent) 1 else 0) + (if (approver.asKnown().isPresent) 1 else 0) + (if (changer.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (duration.asKnown().isPresent) 1 else 0) + (if (eowId.asKnown().isPresent) 1 else 0) + (if (equipStatus.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (impactedFaces.asKnown().isPresent) 1 else 0) + (if (inactiveDate.asKnown().isPresent) 1 else 0) + (if (lineNumber.asKnown().isPresent) 1 else 0) + (if (mdOpsCap.asKnown().isPresent) 1 else 0) + (if (mwOpsCap.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (priority.asKnown().isPresent) 1 else 0) + (if (recall.asKnown().isPresent) 1 else 0) + (if (rel.asKnown().isPresent) 1 else 0) + (if (remark.asKnown().isPresent) 1 else 0) + (if (requestor.asKnown().isPresent) 1 else 0) + (if (resource.asKnown().isPresent) 1 else 0) + (if (rev.asKnown().isPresent) 1 else 0) + (if (ssOpsCap.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "SensorMaintenanceUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
