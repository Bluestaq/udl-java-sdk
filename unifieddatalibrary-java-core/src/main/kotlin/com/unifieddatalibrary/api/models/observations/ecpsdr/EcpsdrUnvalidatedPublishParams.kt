 ...
 */
class EcpsdrUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [EcpsdrUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrUnvalidatedPublishParams: EcpsdrUnvalidatedPublishParams) = apply {
            body = ecpsdrUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = ecpsdrUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams = ecpsdrUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EcpsdrUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): EcpsdrUnvalidatedPublishParams =
            EcpsdrUnvalidatedPublishParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EcpsdrUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EcpsdrUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
