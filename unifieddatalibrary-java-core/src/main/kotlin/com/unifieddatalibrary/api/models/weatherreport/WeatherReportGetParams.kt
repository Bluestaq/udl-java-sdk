...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): WeatherReportGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [WeatherReportGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WeatherReportGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherReportGetParams: WeatherReportGetParams) = apply {
            id = weatherReportGetParams.id
            firstResult = weatherReportGetParams.firstResult
            maxResults = weatherReportGetParams.maxResults
            additionalHeaders = weatherReportGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = weatherReportGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WeatherReportGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WeatherReportGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WeatherReportGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "WeatherReportGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
