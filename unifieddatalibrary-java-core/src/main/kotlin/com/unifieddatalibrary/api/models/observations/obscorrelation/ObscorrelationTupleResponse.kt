 ...
 */
class ObscorrelationTupleResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObscorrelationTupleResponse].
         *
    ...
    /** A builder for [ObscorrelationTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(obscorrelationTupleResponse: ObscorrelationTupleResponse) = apply {
            classificationMarking = obscorrelationTupleResponse.classificationMarking
            corrType = obscorrelationTupleResponse.corrType
            dataMode = obscorrelationTupleResponse.dataMode
            msgTs = obscorrelationTupleResponse.msgTs
            obId = obscorrelationTupleResponse.obId
            obType = obscorrelationTupleResponse.obType
            referenceOrbitId = obscorrelationTupleResponse.referenceOrbitId
            referenceOrbitType = obscorrelationTupleResponse.referenceOrbitType
            source = obscorrelationTupleResponse.source
            id = obscorrelationTupleResponse.id
            algorithmCorrType = obscorrelationTupleResponse.algorithmCorrType
            altCatalog = obscorrelationTupleResponse.altCatalog
            altNamespace = obscorrelationTupleResponse.altNamespace
            altObjectId = obscorrelationTupleResponse.altObjectId
            altUct = obscorrelationTupleResponse.altUct
            astat = obscorrelationTupleResponse.astat
            corrQuality = obscorrelationTupleResponse.corrQuality
            createdAt = obscorrelationTupleResponse.createdAt
            createdBy = obscorrelationTupleResponse.createdBy
            idOnOrbit = obscorrelationTupleResponse.idOnOrbit
            idParentCorrelation = obscorrelationTupleResponse.idParentCorrelation
            origin = obscorrelationTupleResponse.origin
            origNetwork = obscorrelationTupleResponse.origNetwork
            origObjectId = obscorrelationTupleResponse.origObjectId
            satNo = obscorrelationTupleResponse.satNo
            sourceDl = obscorrelationTupleResponse.sourceDl
            tags = obscorrelationTupleResponse.tags.map { it.toMutableList() }
            trackId = obscorrelationTupleResponse.trackId
            transactionId = obscorrelationTupleResponse.transactionId
            additionalProperties = obscorrelationTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationTupleResponse].
         *
         ...
         */
        fun build(): ObscorrelationTupleResponse =
    ...
    fun validate(): ObscorrelationTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationTupleResponse &&
