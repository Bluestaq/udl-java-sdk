...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            assmtTime = historyListResponse.assmtTime
            ...
            assmtDetails = historyListResponse.assmtDetails
            assmtLevel = historyListResponse.assmtLevel
            assmtRotPeriod = historyListResponse.assmtRotPeriod
            assmtSubType = historyListResponse.assmtSubType
            assmtUrl = historyListResponse.assmtUrl
            autoAssmt = historyListResponse.autoAssmt
            collectionUrl = historyListResponse.collectionUrl
            components = historyListResponse.components.map { it.toMutableList() }
            ...
            obDuration = historyListResponse.obDuration
            ...
            sigDataType = historyListResponse.sigDataType
