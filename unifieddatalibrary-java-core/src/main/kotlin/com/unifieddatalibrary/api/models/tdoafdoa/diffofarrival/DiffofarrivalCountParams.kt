...
class DiffofarrivalCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiffofarrivalCountParams].
         *
    ...
    /** A builder for [DiffofarrivalCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffofarrivalCountParams: DiffofarrivalCountParams) =
            apply {
                obTime = diffofarrivalCountParams.obTime
                firstResult = diffofarrivalCountParams.firstResult
                maxResults = diffofarrivalCountParams.maxResults
                additionalHeaders = diffofarrivalCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = diffofarrivalCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DiffofarrivalCountParams].
         *
         ...
         */
        fun build(): DiffofarrivalCountParams =
    ...
    override fun toString() = "DiffofarrivalCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
