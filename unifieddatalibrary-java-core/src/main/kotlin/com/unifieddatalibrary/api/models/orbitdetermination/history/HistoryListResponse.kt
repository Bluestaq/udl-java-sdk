    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) =
            apply {
                ...
                initialOd = historyListResponse.initialOd
                method = historyListResponse.method
                source = historyListResponse.source
                startTime = historyListResponse.startTime
                id = historyListResponse.id
                acceptedObIds = historyListResponse.acceptedObIds.map { it.toMutableList() }
                acceptedObTyps = historyListResponse.acceptedObTyps.map { it.toMutableList() }
                agomEst = historyListResponse.agomEst
                agomModel = historyListResponse.agomModel
                aprioriElset = historyListResponse.aprioriElset
                aprioriIdElset = historyListResponse.aprioriIdElset
                aprioriIdStateVector = historyListResponse.aprioriIdStateVector
                aprioriStateVector = historyListResponse.aprioriStateVector
                ballisticCoeffEst = historyListResponse.ballisticCoeffEst
                ballisticCoeffModel = historyListResponse.ballisticCoeffModel
                bestPassWrms = historyListResponse.bestPassWrms
                createdAt = historyListResponse.createdAt
                createdBy = historyListResponse.createdBy
                edr = historyListResponse.edr
                effectiveFrom = historyListResponse.effectiveFrom
                effectiveUntil = historyListResponse.effectiveUntil
                errorGrowthRate = historyListResponse.errorGrowthRate
                firstPassWrms = historyListResponse.firstPassWrms
                fitSpan = historyListResponse.fitSpan
                idOnOrbit = historyListResponse.idOnOrbit
                lastObEnd = historyListResponse.lastObEnd
                lastObStart = historyListResponse.lastObStart
                methodSource = historyListResponse.methodSource
                numIterations = historyListResponse.numIterations
                ...
                previousWrms = historyListResponse.previousWrms
                rejectedObIds = historyListResponse.rejectedObIds.map { it.toMutableList() }
                rejectedObTyps = historyListResponse.rejectedObTyps.map { it.toMutableList() }
                rmsConvergenceCriteria = historyListResponse.rmsConvergenceCriteria
                satNo = historyListResponse.satNo
                sensorIds = historyListResponse.sensorIds.map { it.toMutableList() }
                sourceDl = historyListResponse.sourceDl
                timeSpan = historyListResponse.timeSpan
                wrms = historyListResponse.wrms
