...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderListPage: TransponderListPage) = apply {
            service = transponderListPage.service
            params = transponderListPage.params
            items = transponderListPage.items
        }

        fun service(service: TransponderService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransponderListPage &&
