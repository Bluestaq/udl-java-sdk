 ...
 */
class SeraDataNavigationCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeraDataNavigationCountParams = builder().build()
    ...
    /** A builder for [SeraDataNavigationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataNavigationCountParams: SeraDataNavigationCountParams) = apply {
            firstResult = seraDataNavigationCountParams.firstResult
            maxResults = seraDataNavigationCountParams.maxResults
            additionalHeaders = seraDataNavigationCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = seraDataNavigationCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataNavigationCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeraDataNavigationCountParams =
            SeraDataNavigationCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeraDataNavigationCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeraDataNavigationCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
