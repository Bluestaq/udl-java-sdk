...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LinkStatusCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LinkStatusCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LinkStatusCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(linkStatusCountParams: LinkStatusCountParams) = apply {
            createdAt = linkStatusCountParams.createdAt
            firstResult = linkStatusCountParams.firstResult
            linkStartTime = linkStatusCountParams.linkStartTime
            linkStopTime = linkStatusCountParams.linkStopTime
            maxResults = linkStatusCountParams.maxResults
            additionalHeaders = linkStatusCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = linkStatusCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LinkStatusCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LinkStatusCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LinkStatusCountParams && createdAt == other.createdAt && firstResult == other.firstResult && linkStartTime == other.linkStartTime && linkStopTime == other.linkStopTime && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LinkStatusCountParams{createdAt=$createdAt, firstResult=$firstResult, linkStartTime=$linkStartTime, linkStopTime=$linkStopTime, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
