...
/**
 * Service operation intended for initial integration only, to take a list of AirspaceControlOrder
 ...
 */
class AirspaceControlOrderCreateBulkParams
private constructor(
    ...
    /** A builder for [AirspaceControlOrderCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            airspaceControlOrderCreateBulkParams: AirspaceControlOrderCreateBulkParams
        ) = apply {
            body = airspaceControlOrderCreateBulkParams.body.toMutableList()
            additionalHeaders = airspaceControlOrderCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                airspaceControlOrderCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AirspaceControlOrderCreateBulkParams].
         *
         ...
         */
        fun build(): AirspaceControlOrderCreateBulkParams =
            AirspaceControlOrderCreateBulkParams(
    ...
    /**
     * Beta Version Airspace Control Order: Contains airspace coordination information and
    ...
    private constructor(
        ...
        @ExcludeMissing
        fun _acoComments(): JsonField<String> = acoComments

        /**
         * Returns the raw JSON value of [acoSerialNum].
         *
         * Unlike [acoSerialNum], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [airspaceControlOrderReferences], this method doesn't throw if the JSON field has
         * an unexpected type.
         */
        @JsonProperty("airspaceControlOrderReferences")
        @ExcludeMissing
         ...
         *
         * Unlike [areaOfValidity], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("areaOfValidity")
        @ExcludeMissing
         ...
         *
         * Unlike [classReasons], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("classReasons")
        @ExcludeMissing
        ...
        @ExcludeMissing
        fun _classSource(): JsonField<String> = classSource
         ...
         *
         * Unlike [declassExemptionCodes], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("declassExemptionCodes")
        @ExcludeMissing
        ...
        @ExcludeMissing
        fun _opExInfoAlt(): JsonField<String> = opExInfoAlt
        ...
        @ExcludeMissing
        fun _planOrigNum(): JsonField<String> = planOrigNum
         ...
         *
         * Unlike [stopQualifier], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                opExName = body.opExName
                originator = body.originator
                source = body.source
                startTime = body.startTime
                id = body.id
                acoComments = body.acoComments
                acoSerialNum = body.acoSerialNum
                airspaceControlMeansStatus =
                    body.airspaceControlMeansStatus.map { it.toMutableList() }
                airspaceControlOrderReferences =
                    body.airspaceControlOrderReferences.map { it.toMutableList() }
                areaOfValidity = body.areaOfValidity
                classReasons = body.classReasons.map { it.toMutableList() }
                classSource = body.classSource
                createdAt = body.createdAt
                createdBy = body.createdBy
                declassExemptionCodes = body.declassExemptionCodes.map { it.toMutableList() }
                downgradeInsDates = body.downgradeInsDates.map { it.toMutableList() }
                geoDatum = body.geoDatum
                month = body.month
                opExInfo = body.opExInfo
                opExInfoAlt = body.opExInfoAlt
                origin = body.origin
             ...
             *
             * You should usually call [Builder.opExName] with a well-typed [String] value instead.
            ...
            /**
             * The start of the effective time period of this airspace control order, in ISO 8601
             ...
             *
             * You should usually call [Builder.acoComments] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun acoComments(acoComments: JsonField<String>) = apply {
                this.acoComments = acoComments
            }
             ...
             *
             * You should usually call [Builder.acoSerialNum] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * `List<AirspaceControlMeansStatus>` value instead. This method is primarily for
            ...
            fun airspaceControlMeansStatus(
                ...
                this.airspaceControlMeansStatus =
                    airspaceControlMeansStatus.map { it.toMutableList() }
            }
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addAirspaceControlMeansStatus(
                airspaceControlMeansStatus: AirspaceControlMeansStatus
            ) = apply {
                this.airspaceControlMeansStatus =
            ...
            /**
             * The airspaceControlReferences set provides both USMTF and non-USMTF references for
             * this airspace control order.
             */
             ...
             * `List<AirspaceControlOrderReference>` value instead. This method is primarily for
             * setting the field to an undocumented or not yet supported value.
             */
            fun airspaceControlOrderReferences(
            ...
            /** Name of the area of the command for which the ACO is valid. */
            fun areaOfValidity(areaOfValidity: String) =
                areaOfValidity(JsonField.of(areaOfValidity))
            ...
            /**
             * Markings defining the source material or the original classification authority for
             * the ACO message.
             */
             ...
             *
             * You should usually call [Builder.classSource] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun classSource(classSource: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.declassExemptionCodes] with a well-typed
             ...
             *
             * You should usually call [Builder.geoDatum] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.month] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Supplementary name that can be used to further identify exercise nicknames, or to
             * provide the primary nickname of the option or the alternative of an operational plan.
             */
             ...
             *
             * You should usually call [Builder.opExInfo] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.opExInfoAlt] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun opExInfoAlt(opExInfoAlt: JsonField<String>) = apply {
                this.opExInfoAlt = opExInfoAlt
            }
            ...
            /**
             * The official identifier of the military establishment responsible for the operation
             * plan and the identification number assigned to this plan.
             */
             ...
             *
             * You should usually call [Builder.planOrigNum] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun planOrigNum(planOrigNum: JsonField<String>) = apply {
                this.planOrigNum = planOrigNum
            }
            ...
            /**
             * A qualifier for the end of the effective time period of this airspace control order,
             * such as AFTER, ASOF, NLT, etc. Used with field stopTime to indicate a relative time.
             */
             ...
             *
             * You should usually call [Builder.stopQualifier] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        internal fun validity(): Int =
            (if (classificationMarking.asKnown().isPresent) 1 else 0) +
                ...
                (airspaceControlMeansStatus.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                    ?: 0) +
                (airspaceControlOrderReferences.asKnown().getOrNull()?.sumOf {
                    it.validity().toInt()
                } ?: 0) +
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("cmStat")
                @ExcludeMissing
                cmStat: JsonField<String> = JsonMissing.of(),
             ...
             *
             * Unlike [cmStatId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("cmStatId")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                private var airspaceControlMeans: JsonField<MutableList<AirspaceControlMean>>? =
                    null
                 ...
                 * `List<AirspaceControlMean>` value instead. This method is primarily for setting
                 * the field to an undocumented or not yet supported value.
                 */
                fun airspaceControlMeans(
                    airspaceControlMeans: JsonField<List<AirspaceControlMean>>
                ) = apply {
                 ...
                 *
                 * You should usually call [Builder.cmStat] with a well-typed [String] value
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("cmId")
                    @ExcludeMissing
                    cmId: JsonField<String> = JsonMissing.of(),
                    ...
                    @JsonProperty("usage")
                    @ExcludeMissing
                    usage: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("width")
                    @ExcludeMissing
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun corrWayPoints(): Optional<List<String>> =
                    corrWayPoints.getOptional("corrWayPoints")
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun orbitAlignment(): Optional<String> =
                    orbitAlignment.getOptional("orbitAlignment")
                ...
                @JsonProperty("bearing0")
                @ExcludeMissing
                fun _bearing0(): JsonField<Double> = bearing0
                ...
                @JsonProperty("bearing1")
                @ExcludeMissing
                fun _bearing1(): JsonField<Double> = bearing1

                /**
                 * Returns the raw JSON value of [cmId].
                 *
                 * Unlike [cmId], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [cmShape], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("cmShape")
                @ExcludeMissing
                fun _cmShape(): JsonField<CmShape> = cmShape

                /**
                 * Returns the raw JSON value of [cmType].
                 *
                 * Unlike [cmType], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [coord0], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [coord1], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [corrWayPoints], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("corrWayPoints")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [effVDim], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                ...
                @JsonProperty("freeText")
                @ExcludeMissing
                fun _freeText(): JsonField<String> = freeText

                /**
                 * Returns the raw JSON value of [genTextInd].
                 *
                 * Unlike [genTextInd], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("genTextInd")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [geoDatumAlt], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("geoDatumAlt")
                @ExcludeMissing
                ...
                @JsonProperty("link16Id")
                @ExcludeMissing
                fun _link16Id(): JsonField<String> = link16Id
                 ...
                 *
                 * Unlike [radMag0], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [radMag1], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [radMagUnit], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("radMagUnit")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [transAltitude], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("transAltitude")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [widthRight], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("widthRight")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    private var airspaceControlPoint:
                        JsonField<MutableList<AirspaceControlPoint>>? =
                        null
                    private var airspaceTimePeriod: JsonField<MutableList<AirspaceTimePeriod>>? =
                        null
                    ...
                    internal fun from(airspaceControlMean: AirspaceControlMean) = apply {
                        ...
                        cntrlAuthFreqs =
                            airspaceControlMean.cntrlAuthFreqs.map { it.toMutableList() }
                        ...
                        additionalProperties =
                            airspaceControlMean.additionalProperties.toMutableMap()
                    }

                    /**
                     * The controlPoint set describes any reference/controlling/rendezvous point for
                     * a given airspace control means.
                     */
                     ...
                     * `List<AirspaceControlPoint>` value instead. This method is primarily for
                     * setting the field to an undocumented or not yet supported value.
                     */
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addAirspaceControlPoint(airspaceControlPoint: AirspaceControlPoint) =
                        apply {
                     ...
                     * `List<AirspaceTimePeriod>` value instead. This method is primarily for
                     * setting the field to an undocumented or not yet supported value.
                     */
                    fun airspaceTimePeriod(
                        airspaceTimePeriod: JsonField<List<AirspaceTimePeriod>>
                    ) = apply {
                    ...
                    /**
                     * A bearing measured from true North, in angular degrees. If cmShape is set to
                     * "POLYARC" or "RADARC", this field is required and is mapped to the
                     * "beginning" radial bearing parameter.
                     */
                     ...
                     *
                     * You should usually call [Builder.cmId] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    ...
                    /**
                     * The commander responsible within a specified geographical area for the
                     * airspace control operation assigned to him.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun cntrlAuth(cntrlAuth: JsonField<String>) = apply {
                        this.cntrlAuth = cntrlAuth
                    }

                    /**
                     * The frequency for the airspace control authority. Can specify HZ, KHZ, MHZ,
                     * GHZ or a DESIG frequency designator code.
                     */
                     ...
                     *
                     * You should usually call [Builder.cntrlAuthFreqs] with a well-typed
                    ...
                    /**
                     * A geospatial point coordinate specified in DMS (Degrees, Minutes, Seconds)
                     * format. The fields coord0 and coord1 should be used in the specification of
                     * any airspace control shape that requires exactly one (1) or two (2) reference
                     * points for construction. For shapes requiring one reference point, for
                     * instance, when cmShape is set to "APOINT", this field is required and
                     * singularly defines the shape. Similarly, this field is required to define the
                     * center point of a "CIRCLE" shape, or the "origin of bearing" for arcs.
                     */
                    ...
                    /**
                     * An array of at least two alphanumeric symbols used to serially identify the
                     * corridor waypoints. If cmShape is set to "CORRIDOR", one of either
                     * corrWayPoints or polyCoord is required to specify the centerline of the
                     * corridor path.
                     */
                     ...
                     *
                     * You should usually call [Builder.corrWayPoints] with a well-typed
                     * `List<String>` value instead. This method is primarily for setting the field
                     * to an undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * Specifies the geodetic datum by which the spatial coordinates of the
                     * controlled airspace are calculated, if different from the top level ACO
                     * datum.
                     */
                     ...
                     *
                     * You should usually call [Builder.geoDatumAlt] with a well-typed [String]
                     ...
                     *
                     * You should usually call [Builder.orbitAlignment] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     * shape. When cmShape is set to "POLYARC" or "POLYGON", this field is required
                     * as applied in the construction of the area boundary. If cmShape is set to
                    ...
                    /**
                     * A distance that represents a radial magnitude. If cmShape is set to "CIRCLE"
                     * or "POLYARC", one of either fields radMag0 or radMag1 is required. If cmShape
                     * is set to "RADARC", this field is required and maps to the "inner" radial
                     * magnitude arc limit. If provided, the field radMagUnit is required.
                     */
                     ...
                     * A distance that represents a radial magnitude. If cmShape is set to "CIRCLE"
                     * or "POLYARC", one of either fields radMag0 or radMag1 is required. If cmShape
                     * is set to "RADARC", this field is required and maps to the "outer" radial
                     * magnitude arc limit. If provided, the field radMagUnit is required.
                     */
                    ...
                    /**
                     * Index of a segment in an airtrack, which is defined by an ordered set of
                     * points.
                     */
                     ...
                     *
                     * You should usually call [Builder.trackLeg] with a well-typed [Int] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.transAltitude] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.usage] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    ...
                    /**
                     * Used to describe the "side to side" distance of a target, object or area. If
                     * cmShape is set to "CORRIDOR" or "AORBIT", this field is required and is
                    ...
                    /**
                     * Given an ordered pair of spatial coordinates (p0, p1), defines a distance
                     * extending into the LEFT half-plane relative to the direction of the vector
                     * that maps p0 to p1. If cmShape is set to "1TRACK", this field is required to
                     * define the width of the airspace track as measured from the left of the track
                     * segment line. If provided, the field widthUnit is required.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun widthLeft(widthLeft: JsonField<Double>) = apply {
                        this.widthLeft = widthLeft
                    }

                    /**
                     * Given an ordered pair of spatial coordinates (p0, p1), defines a distance
                     * extending into the RIGHT half-plane relative to the direction of the vector
                     * that maps p0 to p1. If cmShape is set to "1TRACK", this field is required to
                     * define the width of the airspace track as measured from the right of the
                     * track segment line. If provided, the field widthUnit is required.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun widthUnit(widthUnit: JsonField<String>) = apply {
                ...
                @JvmSynthetic
                internal fun validity(): Int =
                    (airspaceControlPoint.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                        ?: 0) +
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.ctrlPtAltitude] with a well-typed
                        ...
                        /**
                         * A geospatial point coordinate specified in DMS (Degrees, Minutes,
                         * Seconds) format that represents the location of the control point.
                         */
                         ...
                         *
                         * You should usually call [Builder.ctrlPtLocation] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.ctrlPtName] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.ctrlPtType] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                ...
                private constructor(
                     ...
                     *
                     * Unlike [intDur], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("intDur")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [intFreq], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("intFreq")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [timeEnd], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("timeEnd")
                    @ExcludeMissing
                    fun _timeEnd(): JsonField<String> = timeEnd

                    /**
                     * Returns the raw JSON value of [timeMode].
                     *
                     * Unlike [timeMode], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("timeMode")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [timeStart], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("timeStart")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        /**
                         * Mandatory if timeMode is INTERVAL. Can be a numerical multiplier on an
                         * interval frequency code, a stop time qualifier code such as AFTER, NET,
                         * UFN, etc, or a datetime like string.
                         */
                         ...
                         *
                         * You should usually call [Builder.intFreq] with a well-typed
                        ...
                        /**
                         * The end time designating that the airspace control order is no longer
                         * active. Can contain datetime information or a stop time qualifier code,
                         * such as AFTER, NET, UFN, etc.
                         */
                         ...
                         *
                         * You should usually call [Builder.timeEnd] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        ...
                        /**
                         * The airspace time code associated with the ACO. Can be DISCRETE, a fixed
                         * time block, or INTERVAL, a repeating time block.
                         */
                         ...
                         *
                         * You should usually call [Builder.timeMode] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun timeMode(timeMode: JsonField<String>) = apply {
                         ...
                         *
                         * You should usually call [Builder.timeStart] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("refSId")
                @ExcludeMissing
                refSId: JsonField<String> = JsonMissing.of(),
                ...
                @ExcludeMissing
                refType: JsonField<String> = JsonMissing.of(),
            ) : this(
                refOriginator,
                refSerialNum,
                refSiCs,
            ...
            @JsonProperty("refSICs")
            @ExcludeMissing
            fun _refSiCs(): JsonField<List<String>> = refSiCs
            ...
            class Builder internal constructor() {
                ...
                /** The originator of this reference. */
                fun refOriginator(refOriginator: String) =
                    refOriginator(JsonField.of(refOriginator))
                 ...
                 *
                 * You should usually call [Builder.refSId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.refSpecialNotation] with a well-typed [String]
                 ...
                 *
                 * You should usually call [Builder.refType] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirspaceControlOrderCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AirspaceControlOrderCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
