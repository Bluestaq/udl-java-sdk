 ...
 * (CLOSED).
 */
class DeconflictsetTupleResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeconflictsetTupleResponse].
         *
    ...
    /** A builder for [DeconflictsetTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deconflictsetTupleResponse: DeconflictsetTupleResponse) = apply {
            classificationMarking = deconflictsetTupleResponse.classificationMarking
            dataMode = deconflictsetTupleResponse.dataMode
            eventStartTime = deconflictsetTupleResponse.eventStartTime
            numWindows = deconflictsetTupleResponse.numWindows
            source = deconflictsetTupleResponse.source
            id = deconflictsetTupleResponse.id
            calculationEndTime = deconflictsetTupleResponse.calculationEndTime
            calculationId = deconflictsetTupleResponse.calculationId
            calculationStartTime = deconflictsetTupleResponse.calculationStartTime
            createdAt = deconflictsetTupleResponse.createdAt
            createdBy = deconflictsetTupleResponse.createdBy
            deconflictWindows =
                deconflictsetTupleResponse.deconflictWindows.map { it.toMutableList() }
            errors = deconflictsetTupleResponse.errors.map { it.toMutableList() }
            eventEndTime = deconflictsetTupleResponse.eventEndTime
            eventType = deconflictsetTupleResponse.eventType
            idLaserDeconflictRequest = deconflictsetTupleResponse.idLaserDeconflictRequest
            origin = deconflictsetTupleResponse.origin
            origNetwork = deconflictsetTupleResponse.origNetwork
            referenceFrame = deconflictsetTupleResponse.referenceFrame
            sourceDl = deconflictsetTupleResponse.sourceDl
            tags = deconflictsetTupleResponse.tags.map { it.toMutableList() }
            transactionId = deconflictsetTupleResponse.transactionId
            warnings = deconflictsetTupleResponse.warnings.map { it.toMutableList() }
            additionalProperties = deconflictsetTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DeconflictsetTupleResponse].
         *
         ...
         */
        fun build(): DeconflictsetTupleResponse =
    ...
    fun validate(): DeconflictsetTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeconflictsetTupleResponse &&
            classificationMarking == other.classificationMarking &&
            dataMode == other.dataMode &&
            eventStartTime == other.eventStartTime &&
