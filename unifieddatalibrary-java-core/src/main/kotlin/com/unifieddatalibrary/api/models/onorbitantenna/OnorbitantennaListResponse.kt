...
class OnorbitantennaListResponse private constructor(
    ...
    private val antenna: JsonField<AntennaAbridged>,
    ...
    private constructor(
        ...
        @JsonProperty("antenna") @ExcludeMissing antenna: JsonField<AntennaAbridged> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun antenna(): Optional<AntennaAbridged> = antenna.getOptional("antenna")
    ...
    @ExcludeMissing
    fun _antenna(): JsonField<AntennaAbridged> = antenna
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitantennaListResponse].
         *
    ...
    /** A builder for [OnorbitantennaListResponse]. */
    class Builder internal constructor() {
        ...
        private var antenna: JsonField<AntennaAbridged> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(onorbitantennaListResponse: OnorbitantennaListResponse) =
            apply {
                classificationMarking = onorbitantennaListResponse.classificationMarking
                dataMode = onorbitantennaListResponse.dataMode
                idAntenna = onorbitantennaListResponse.idAntenna
                idOnOrbit = onorbitantennaListResponse.idOnOrbit
                source = onorbitantennaListResponse.source
                id = onorbitantennaListResponse.id
                antenna = onorbitantennaListResponse.antenna
                createdAt = onorbitantennaListResponse.createdAt
                createdBy = onorbitantennaListResponse.createdBy
                origin = onorbitantennaListResponse.origin
                origNetwork = onorbitantennaListResponse.origNetwork
                additionalProperties = onorbitantennaListResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Model representation of information on on-orbit/spacecraft communication antennas. A spacecraft may have multiple antennas and each antenna can have multiple 'details' records compiled by different sources. */
        fun antenna(antenna: AntennaAbridged) = antenna(JsonField.of(antenna))

        /**
         * Sets [Builder.antenna] to an arbitrary JSON value.
         *
         * You should usually call [Builder.antenna] with a well-typed [AntennaAbridged] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun antenna(antenna: JsonField<AntennaAbridged>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [OnorbitantennaListResponse].
         *
         ...
         */
        fun build(): OnorbitantennaListResponse =
    ...
    fun validate(): OnorbitantennaListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "OnorbitantennaListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idAntenna=$idAntenna, idOnOrbit=$idOnOrbit, source=$source, id=$id, antenna=$antenna, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
