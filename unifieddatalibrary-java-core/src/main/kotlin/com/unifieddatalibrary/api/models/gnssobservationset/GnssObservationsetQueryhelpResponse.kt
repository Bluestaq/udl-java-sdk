...
class GnssObservationsetQueryhelpResponse
private constructor(
    ...
    /** A builder for [GnssObservationsetQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            gnssObservationsetQueryhelpResponse: GnssObservationsetQueryhelpResponse
        ) = apply {
            aodrSupported = gnssObservationsetQueryhelpResponse.aodrSupported
            classificationMarking = gnssObservationsetQueryhelpResponse.classificationMarking
            description = gnssObservationsetQueryhelpResponse.description
            historySupported = gnssObservationsetQueryhelpResponse.historySupported
            name = gnssObservationsetQueryhelpResponse.name
            parameters = gnssObservationsetQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                gnssObservationsetQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = gnssObservationsetQueryhelpResponse.restSupported
            sortSupported = gnssObservationsetQueryhelpResponse.sortSupported
            typeName = gnssObservationsetQueryhelpResponse.typeName
            uri = gnssObservationsetQueryhelpResponse.uri
            additionalProperties =
                gnssObservationsetQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GnssObservationsetQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GnssObservationsetQueryhelpResponse =
            GnssObservationsetQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): GnssObservationsetQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
