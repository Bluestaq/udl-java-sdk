...
class SarObservationTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationTupleResponse: SarObservationTupleResponse) =
            apply {
    ...
    fun validate(): SarObservationTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
