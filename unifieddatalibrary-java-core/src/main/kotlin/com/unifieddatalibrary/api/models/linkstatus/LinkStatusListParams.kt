...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LinkStatusListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LinkStatusListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LinkStatusListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(linkStatusListParams: LinkStatusListParams) = apply {
            createdAt = linkStatusListParams.createdAt
            firstResult = linkStatusListParams.firstResult
            linkStartTime = linkStatusListParams.linkStartTime
            linkStopTime = linkStatusListParams.linkStopTime
            maxResults = linkStatusListParams.maxResults
            additionalHeaders = linkStatusListParams.additionalHeaders.toBuilder()
            additionalQueryParams = linkStatusListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LinkStatusListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LinkStatusListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LinkStatusListParams && createdAt == other.createdAt && firstResult == other.firstResult && linkStartTime == other.linkStartTime && linkStopTime == other.linkStopTime && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LinkStatusListParams{createdAt=$createdAt, firstResult=$firstResult, linkStartTime=$linkStartTime, linkStopTime=$linkStopTime, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
