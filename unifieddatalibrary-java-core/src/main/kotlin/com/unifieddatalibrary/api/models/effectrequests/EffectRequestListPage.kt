...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestListPage: EffectRequestListPage) = apply {
            service = effectRequestListPage.service
            params = effectRequestListPage.params
            items = effectRequestListPage.items
        }

        fun service(service: EffectRequestService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EffectRequestListPage &&
    ...
    override fun toString() =
        "EffectRequestListPage{service=$service, params=$params, items=$items}"
}
