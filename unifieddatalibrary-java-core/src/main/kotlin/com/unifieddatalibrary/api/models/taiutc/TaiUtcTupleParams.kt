 ...
 */
class TaiUtcTupleParams
private constructor(
    private val adjustmentDate: OffsetDateTime,
    ...
    /**
     * Effective date/time for the leap second adjustment. Must be a unique value across all TAIUTC
     * datasets. (YYYY-MM-DDTHH:MM:SS.sssZ)
     */
    fun adjustmentDate(): OffsetDateTime = adjustmentDate
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TaiUtcTupleParams].
         *
    ...
    /** A builder for [TaiUtcTupleParams]. */
    class Builder internal constructor() {

        private var adjustmentDate: OffsetDateTime? = null
        ...
        @JvmSynthetic
        internal fun from(taiUtcTupleParams: TaiUtcTupleParams) = apply {
            adjustmentDate = taiUtcTupleParams.adjustmentDate
            columns = taiUtcTupleParams.columns
            firstResult = taiUtcTupleParams.firstResult
            maxResults = taiUtcTupleParams.maxResults
            additionalHeaders = taiUtcTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = taiUtcTupleParams.additionalQueryParams.toBuilder()
        }

        /**
         * Effective date/time for the leap second adjustment. Must be a unique value across all
         * TAIUTC datasets. (YYYY-MM-DDTHH:MM:SS.sssZ)
         */
        ...
        /**
         * Returns an immutable instance of [TaiUtcTupleParams].
         *
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("adjustmentDate", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(adjustmentDate))
                put("columns", columns)
