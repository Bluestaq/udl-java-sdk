...
/**
 * Service operation intended for initial integration only, to take a list of radar observations as
 ...
 */
class RadarobservationCreateBulkParams
private constructor(
        ...
        internal fun from(radarobservationCreateBulkParams: RadarobservationCreateBulkParams) =
            apply {
                ...
                additionalQueryParams =
                    radarobservationCreateBulkParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "RadarobservationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
