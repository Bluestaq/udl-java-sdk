...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FlightplanListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightplanListParams: FlightplanListParams) = apply {
    ...
    override fun toString() =
        "FlightplanListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
