...
class LaunchVehicleQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleQueryhelpResponse: LaunchVehicleQueryhelpResponse) = apply {
            ...
            additionalProperties =
                launchVehicleQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): LaunchVehicleQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
