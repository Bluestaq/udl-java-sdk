...
class LaunchVehicleQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LaunchVehicleQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [LaunchVehicleQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleQueryhelpResponse: LaunchVehicleQueryhelpResponse) =
            apply {
                aodrSupported = launchVehicleQueryhelpResponse.aodrSupported
                classificationMarking = launchVehicleQueryhelpResponse.classificationMarking
                description = launchVehicleQueryhelpResponse.description
                historySupported = launchVehicleQueryhelpResponse.historySupported
                name = launchVehicleQueryhelpResponse.name
                parameters = launchVehicleQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = launchVehicleQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = launchVehicleQueryhelpResponse.restSupported
                sortSupported = launchVehicleQueryhelpResponse.sortSupported
                typeName = launchVehicleQueryhelpResponse.typeName
                uri = launchVehicleQueryhelpResponse.uri
                additionalProperties = launchVehicleQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchVehicleQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchVehicleQueryhelpResponse =
    ...
    fun validate(): LaunchVehicleQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchVehicleQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
