...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        logisticsStocks: JsonField<List<LogisticsStocksFull>> = JsonMissing.of(),
     ...
     *   if the server responded with an unexpected value).
     */
    fun logisticsStocks(): Optional<List<LogisticsStocksFull>> =
    ...
    /**
     * Indicates the specified Technical Order manual holding the aircraft information for use in
     * diagnosing a problem or condition.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     */
    @JsonProperty("indexNumber") @ExcludeMissing fun _indexNumber(): JsonField<String> = indexNumber

    /**
     * Returns the raw JSON value of [locationVerifier].
     *
     * Unlike [locationVerifier], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("locationVerifier")
    @ExcludeMissing
     ...
     *
     * Unlike [measurementUnitCode], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("measurementUnitCode")
    @ExcludeMissing
     ...
     *
     * Unlike [nationalStockNumber], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("nationalStockNumber")
    @ExcludeMissing
     ...
     */
    @JsonProperty("partNumber") @ExcludeMissing fun _partNumber(): JsonField<String> = partNumber
     ...
     *
     * Unlike [supplyDocumentNumber], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("supplyDocumentNumber")
    @ExcludeMissing
     ...
     *
     * Unlike [technicalOrderText], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("technicalOrderText")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsPartsFull: LogisticsPartsFull) = apply {
         ...
         *
         * You should usually call [Builder.figureNumber] with a well-typed [String] value instead.
         ...
         *
         * You should usually call [Builder.indexNumber] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun indexNumber(indexNumber: JsonField<String>) = apply { this.indexNumber = indexNumber }
         ...
         *
         * You should usually call [Builder.locationVerifier] with a well-typed [String] value
        ...
        /** The supply stocks for this support item. */
        fun logisticsStocks(logisticsStocks: List<LogisticsStocksFull>) =
         ...
         * `List<LogisticsStocksFull>` value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun logisticsStocks(logisticsStocks: JsonField<List<LogisticsStocksFull>>) = apply {
         ...
         */
        fun addLogisticsStock(logisticsStock: LogisticsStocksFull) = apply {
            logisticsStocks =
         ...
         *
         * You should usually call [Builder.measurementUnitCode] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.nationalStockNumber] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.partNumber] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun partNumber(partNumber: JsonField<String>) = apply { this.partNumber = partNumber }
         ...
         *
         * You should usually call [Builder.requestVerifier] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.supplyDocumentNumber] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Indicates the specified Technical Order manual holding the aircraft information for use
         * in diagnosing a problem or condition.
         */
         ...
         *
         * You should usually call [Builder.technicalOrderText] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.workUnitCode] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
    ...
    fun validate(): LogisticsPartsFull = apply {
        if (validated) {
            return@apply
        }
