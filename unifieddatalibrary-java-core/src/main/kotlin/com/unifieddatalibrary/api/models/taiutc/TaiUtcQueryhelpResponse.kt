...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TaiUtcQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TaiUtcQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taiUtcQueryhelpResponse: TaiUtcQueryhelpResponse) = apply {
            aodrSupported = taiUtcQueryhelpResponse.aodrSupported
            classificationMarking = taiUtcQueryhelpResponse.classificationMarking
            description = taiUtcQueryhelpResponse.description
            historySupported = taiUtcQueryhelpResponse.historySupported
            name = taiUtcQueryhelpResponse.name
            parameters = taiUtcQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = taiUtcQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = taiUtcQueryhelpResponse.restSupported
            sortSupported = taiUtcQueryhelpResponse.sortSupported
            typeName = taiUtcQueryhelpResponse.typeName
            uri = taiUtcQueryhelpResponse.uri
            additionalProperties = taiUtcQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TaiUtcQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TaiUtcQueryhelpResponse =
    ...
    fun validate(): TaiUtcQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TaiUtcQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
