...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConjunctionListParams].
         *
    ...
    /** A builder for [ConjunctionListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conjunctionListParams: ConjunctionListParams) = apply {
            tca = conjunctionListParams.tca
            firstResult = conjunctionListParams.firstResult
            maxResults = conjunctionListParams.maxResults
            additionalHeaders = conjunctionListParams.additionalHeaders.toBuilder()
            additionalQueryParams = conjunctionListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ConjunctionListParams].
         *
         ...
         */
        fun build(): ConjunctionListParams =
