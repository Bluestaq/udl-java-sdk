...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun accSysKeys(accSysKeys: List<String>) = apply { body.accSysKeys(accSysKeys) }
         ...
         * supported value.
         */
        fun accSysKeys(accSysKeys: JsonField<List<String>>) = apply { body.accSysKeys(accSysKeys) }
         ...
         */
        fun addAccSysKey(accSysKey: String) = apply { body.addAccSysKey(accSysKey) }

        /** Additional data required to find this item in the accepting system. */
        fun accSysNotes(accSysNotes: String) = apply { body.accSysNotes(accSysNotes) }
         ...
         * value.
         */
        fun accSysNotes(accSysNotes: JsonField<String>) = apply { body.accSysNotes(accSysNotes) }
         ...
         */
        fun accSystem(accSystem: String) = apply { body.accSystem(accSystem) }
         ...
         * value.
         */
        fun accSystem(accSystem: JsonField<String>) = apply { body.accSystem(accSystem) }
         ...
         */
        fun accSysValues(accSysValues: List<String>) = apply { body.accSysValues(accSysValues) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAccSysValue(accSysValue: String) = apply { body.addAccSysValue(accSysValue) }

        /**
         * Flag indicating this item is planned to be airdropped. Applicable for cargo and passenger
         * item types only.
         */
        fun airdrop(airdrop: Boolean) = apply { body.airdrop(airdrop) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun airdrop(airdrop: JsonField<Boolean>) = apply { body.airdrop(airdrop) }
         ...
         */
        fun altDataFormat(altDataFormat: String) = apply { body.altDataFormat(altDataFormat) }
         ...
         * types only.
         */
        fun cargoType(cargoType: String) = apply { body.cargoType(cargoType) }
         ...
         * value.
         */
        fun cargoType(cargoType: JsonField<String>) = apply { body.cargoType(cargoType) }

        /**
         * How far left or right of centerline is the item in meters. Applicable for cargo and
         * passenger item types only.
         */
        fun centerlineOffset(centerlineOffset: Double) = apply {
         ...
         * centimeters.
         */
        fun cg(cg: Double) = apply { body.cg(cg) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun cg(cg: JsonField<Double>) = apply { body.cg(cg) }

        /** The classification code of the commodity or group of commodities. */
        fun commodityCode(commodityCode: String) = apply { body.commodityCode(commodityCode) }
         ...
         */
        fun commoditySys(commoditySys: String) = apply { body.commoditySys(commoditySys) }
        ...
        /** Flag indicating this item acts as a container and contains additional items. */
        fun container(container: Boolean) = apply { body.container(container) }
         ...
         * value.
         */
        fun container(container: JsonField<Boolean>) = apply { body.container(container) }
        ...
        /** The departure code or location where this item has left or is leaving. */
        fun departure(departure: String) = apply { body.departure(departure) }
         ...
         * value.
         */
        fun departure(departure: JsonField<String>) = apply { body.departure(departure) }
         ...
         * Applicable for cargo and passenger item types only.
         */
        fun fs(fs: Double) = apply { body.fs(fs) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun fs(fs: JsonField<Double>) = apply { body.fs(fs) }

        /** Array of UN hazard classes or division codes that apply to this item. */
        fun hazCodes(hazCodes: List<Double>) = apply { body.hazCodes(hazCodes) }
         ...
         * supported value.
         */
        fun hazCodes(hazCodes: JsonField<List<Double>>) = apply { body.hazCodes(hazCodes) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addHazCode(hazCode: Double) = apply { body.addHazCode(hazCode) }
        ...
        /** The UDL ID of the air load plan this item is associated with. */
        fun idAirLoadPlan(idAirLoadPlan: String) = apply { body.idAirLoadPlan(idAirLoadPlan) }
        ...
        /** Array of tracking identifiers that are contained within this item. */
        fun itemContains(itemContains: List<String>) = apply { body.itemContains(itemContains) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItemContain(itemContain: String) = apply { body.addItemContain(itemContain) }
         ...
         * format (e.g. YYYY-MM-DD).
         */
        fun lastArrDate(lastArrDate: LocalDate) = apply { body.lastArrDate(lastArrDate) }
         ...
         * supported value.
         */
        fun lastArrDate(lastArrDate: JsonField<LocalDate>) = apply { body.lastArrDate(lastArrDate) }
         ...
         * Moment of the item in Newton-meters. Applicable for equipment and cargo item types only.
         */
        fun moment(moment: Double) = apply { body.moment(moment) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun moment(moment: JsonField<Double>) = apply { body.moment(moment) }
        ...
        /** Net explosive weight of the item, in kilograms. */
        fun netExpWt(netExpWt: Double) = apply { body.netExpWt(netExpWt) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun netExpWt(netExpWt: JsonField<Double>) = apply { body.netExpWt(netExpWt) }
         ...
         */
        fun numPalletPos(numPalletPos: Int) = apply { body.numPalletPos(numPalletPos) }
         ...
         * value.
         */
        fun numPalletPos(numPalletPos: JsonField<Int>) = apply { body.numPalletPos(numPalletPos) }
        ...
        /** The code denoting the type of material item. */
        fun productCode(productCode: String) = apply { body.productCode(productCode) }
         ...
         * value.
         */
        fun productCode(productCode: JsonField<String>) = apply { body.productCode(productCode) }
         ...
         */
        fun productSys(productSys: String) = apply { body.productSys(productSys) }
         ...
         * value.
         */
        fun productSys(productSys: JsonField<String>) = apply { body.productSys(productSys) }

        /** The military branch receiving this item. */
        fun receivingBranch(receivingBranch: String) = apply {
        ...
        /** The name of the unit receiving this item. */
        fun receivingUnit(receivingUnit: String) = apply { body.receivingUnit(receivingUnit) }
        ...
        /** Transportation Control Number of the cargo. Applicable for cargo item types only. */
        fun tcn(tcn: String) = apply { body.tcn(tcn) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun tcn(tcn: JsonField<String>) = apply { body.tcn(tcn) }

        /** The unit line number of this item. */
        fun uln(uln: String) = apply { body.uln(uln) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun uln(uln: JsonField<String>) = apply { body.uln(uln) }
        ...
        /** The volume of the item, in cubic meters. Applicable for cargo item types only. */
        fun volume(volume: Double) = apply { body.volume(volume) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun volume(volume: JsonField<Double>) = apply { body.volume(volume) }
         ...
         * Timestamp when the weight was taken, in ISO 8601 UTC format with millisecond precision.
         */
        fun weightTs(weightTs: OffsetDateTime) = apply { body.weightTs(weightTs) }
         ...
         * supported value.
         */
        fun weightTs(weightTs: JsonField<OffsetDateTime>) = apply { body.weightTs(weightTs) }
    ...
    override fun toString() =
        "ItemUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
