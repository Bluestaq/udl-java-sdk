...
class SeraDataNavigationQueryhelpResponse
private constructor(
    ...
    /** A builder for [SeraDataNavigationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seraDataNavigationQueryhelpResponse: SeraDataNavigationQueryhelpResponse
        ) = apply {
            aodrSupported = seraDataNavigationQueryhelpResponse.aodrSupported
            classificationMarking = seraDataNavigationQueryhelpResponse.classificationMarking
            description = seraDataNavigationQueryhelpResponse.description
            historySupported = seraDataNavigationQueryhelpResponse.historySupported
            name = seraDataNavigationQueryhelpResponse.name
            parameters = seraDataNavigationQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                seraDataNavigationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = seraDataNavigationQueryhelpResponse.restSupported
            sortSupported = seraDataNavigationQueryhelpResponse.sortSupported
            typeName = seraDataNavigationQueryhelpResponse.typeName
            uri = seraDataNavigationQueryhelpResponse.uri
            additionalProperties =
                seraDataNavigationQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataNavigationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeraDataNavigationQueryhelpResponse =
            SeraDataNavigationQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): SeraDataNavigationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
