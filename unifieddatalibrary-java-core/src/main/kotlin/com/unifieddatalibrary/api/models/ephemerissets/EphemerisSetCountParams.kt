...
class EphemerisSetCountParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EphemerisSetCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EphemerisSetCountParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EphemerisSetCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetCountParams: EphemerisSetCountParams) =
            apply {
                firstResult = ephemerisSetCountParams.firstResult
                maxResults = ephemerisSetCountParams.maxResults
                pointEndTime = ephemerisSetCountParams.pointEndTime
                pointStartTime = ephemerisSetCountParams.pointStartTime
                additionalHeaders = ephemerisSetCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = ephemerisSetCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EphemerisSetCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EphemerisSetCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EphemerisSetCountParams && firstResult == other.firstResult && maxResults == other.maxResults && pointEndTime == other.pointEndTime && pointStartTime == other.pointStartTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EphemerisSetCountParams{firstResult=$firstResult, maxResults=$maxResults, pointEndTime=$pointEndTime, pointStartTime=$pointStartTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
