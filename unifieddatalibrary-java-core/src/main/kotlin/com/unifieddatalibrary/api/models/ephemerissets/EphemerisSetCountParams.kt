...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EphemerisSetCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetCountParams: EphemerisSetCountParams) = apply {
    ...
    override fun toString() =
        "EphemerisSetCountParams{firstResult=$firstResult, maxResults=$maxResults, pointEndTime=$pointEndTime, pointStartTime=$pointStartTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
