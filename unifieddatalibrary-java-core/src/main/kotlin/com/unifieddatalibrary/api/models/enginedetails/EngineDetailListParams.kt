...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EngineDetailListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineDetailListParams: EngineDetailListParams) = apply {
    ...
    override fun toString() =
        "EngineDetailListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
