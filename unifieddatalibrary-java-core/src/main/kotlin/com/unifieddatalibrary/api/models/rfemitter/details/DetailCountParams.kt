...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DetailCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DetailCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DetailCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailCountParams: DetailCountParams) = apply {
            firstResult = detailCountParams.firstResult
            maxResults = detailCountParams.maxResults
            additionalHeaders = detailCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = detailCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DetailCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DetailCountParams =
            DetailCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailCountParams &&
    ...
    override fun toString() =
        "DetailCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
