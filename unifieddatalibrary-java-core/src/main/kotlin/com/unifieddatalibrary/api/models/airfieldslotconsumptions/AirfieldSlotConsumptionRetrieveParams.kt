 ...
 * path parameter.
 */
class AirfieldSlotConsumptionRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldSlotConsumptionRetrieveParams = builder().build()
    ...
    /** A builder for [AirfieldSlotConsumptionRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            airfieldSlotConsumptionRetrieveParams: AirfieldSlotConsumptionRetrieveParams
        ) = apply {
            id = airfieldSlotConsumptionRetrieveParams.id
            firstResult = airfieldSlotConsumptionRetrieveParams.firstResult
            maxResults = airfieldSlotConsumptionRetrieveParams.maxResults
            additionalHeaders = airfieldSlotConsumptionRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                airfieldSlotConsumptionRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AirfieldSlotConsumptionRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldSlotConsumptionRetrieveParams =
            AirfieldSlotConsumptionRetrieveParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirfieldSlotConsumptionRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirfieldSlotConsumptionRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
