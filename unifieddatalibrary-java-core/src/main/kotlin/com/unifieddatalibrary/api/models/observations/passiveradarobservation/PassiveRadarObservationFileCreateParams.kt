...
/**
 * Service operation to take multiple PassiveRadarObservation records as a POST body and ingest into
 ...
 */
class PassiveRadarObservationFileCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            passiveRadarObservationFileCreateParams: PassiveRadarObservationFileCreateParams
        ) = apply {
            body = passiveRadarObservationFileCreateParams.body.toMutableList()
            additionalHeaders =
                passiveRadarObservationFileCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                passiveRadarObservationFileCreateParams.additionalQueryParams.toBuilder()
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * The target Acceleration uncertainty measurement, in kilometers per second squared,
            ...
            /**
             * One sigma uncertainty in the bistatic range acceleration measurement, in kilometers
             * per second squared.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PassiveRadarObservationFileCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PassiveRadarObservationFileCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
