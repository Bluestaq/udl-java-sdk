...
/** Service operation intended for initial integration only, to take a list of MonoRadar records as a POST body and ingest into the database. This operation is not intended to be used for automated feeds into UDL. Data providers should contact the UDL team for specific role assignments and for instructions on setting up a permanent feed through an alternate mechanism. */
class MonoradarCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MonoradarCreateBulkParams].
         *
    ...
    /** A builder for [MonoradarCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarCreateBulkParams: MonoradarCreateBulkParams) =
            apply {
                body = monoradarCreateBulkParams.body.toMutableList()
                additionalHeaders = monoradarCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = monoradarCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MonoradarCreateBulkParams].
         *
         ...
         */
        fun build(): MonoradarCreateBulkParams =
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    aims = body.aims
                    alt3d = body.alt3d
                    artsqual = body.artsqual
                    az = body.az
                    azdelt = body.azdelt
                    bcnhits = body.bcnhits
                    cartpos = body.cartpos.map { it.toMutableList() }
                    cdm = body.cdm
                    code7500 = body.code7500
                    code7600 = body.code7600
                    code7700 = body.code7700
                    ...
                    mcg = body.mcg
                    mcv = body.mcv
                    milemrgcy = body.milemrgcy
                    mrgrpt = body.mrgrpt
                    mscommb = body.mscommb
                    mti = body.mti
                    origin = body.origin
                    ...
                    tgtconf = body.tgtconf
                    tgtcorr = body.tgtcorr
                    tgtid = body.tgtid
                    tis = body.tis
                    trkelig = body.trkelig
                    trknum = body.trknum
                    tti = body.tti
    ...
    override fun toString() = "MonoradarCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
