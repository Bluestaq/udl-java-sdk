...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackRouteListResponse].
         *
    ...
    /** A builder for [TrackRouteListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackRouteListResponse: TrackRouteListResponse) = apply {
            classificationMarking = trackRouteListResponse.classificationMarking
            dataMode = trackRouteListResponse.dataMode
            lastUpdateDate = trackRouteListResponse.lastUpdateDate
            source = trackRouteListResponse.source
            type = trackRouteListResponse.type
            id = trackRouteListResponse.id
            altitudeBlocks = trackRouteListResponse.altitudeBlocks.map { it.toMutableList() }
            apnSetting = trackRouteListResponse.apnSetting
            apxBeaconCode = trackRouteListResponse.apxBeaconCode
            artccMessage = trackRouteListResponse.artccMessage
            createdAt = trackRouteListResponse.createdAt
            createdBy = trackRouteListResponse.createdBy
            creatingOrg = trackRouteListResponse.creatingOrg
            direction = trackRouteListResponse.direction
            effectiveDate = trackRouteListResponse.effectiveDate
            externalId = trackRouteListResponse.externalId
            lastUsedDate = trackRouteListResponse.lastUsedDate
            locationTrackId = trackRouteListResponse.locationTrackId
            origin = trackRouteListResponse.origin
            origNetwork = trackRouteListResponse.origNetwork
            poc = trackRouteListResponse.poc.map { it.toMutableList() }
            priFreq = trackRouteListResponse.priFreq
            receiverTankerChCode = trackRouteListResponse.receiverTankerChCode
            regionCode = trackRouteListResponse.regionCode
            regionName = trackRouteListResponse.regionName
            reviewDate = trackRouteListResponse.reviewDate
            routePoints = trackRouteListResponse.routePoints.map { it.toMutableList() }
            schedulerOrgName = trackRouteListResponse.schedulerOrgName
            schedulerOrgUnit = trackRouteListResponse.schedulerOrgUnit
            secFreq = trackRouteListResponse.secFreq
            shortName = trackRouteListResponse.shortName
            sic = trackRouteListResponse.sic
            sourceDl = trackRouteListResponse.sourceDl
            trackId = trackRouteListResponse.trackId
            trackName = trackRouteListResponse.trackName
            typeCode = trackRouteListResponse.typeCode
            updatedAt = trackRouteListResponse.updatedAt
            updatedBy = trackRouteListResponse.updatedBy
            additionalProperties = trackRouteListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TrackRouteListResponse].
         *
         ...
         */
        fun build(): TrackRouteListResponse =
    ...
    fun validate(): TrackRouteListResponse = apply {
        if (validated) {
            return@apply
        }
