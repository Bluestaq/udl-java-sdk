 ...
 */
class AirfieldStatusListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldStatusListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AirfieldStatusListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AirfieldStatusListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldStatusListParams: AirfieldStatusListParams) = apply {
            firstResult = airfieldStatusListParams.firstResult
            maxResults = airfieldStatusListParams.maxResults
            additionalHeaders = airfieldStatusListParams.additionalHeaders.toBuilder()
            additionalQueryParams = airfieldStatusListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AirfieldStatusListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldStatusListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirfieldStatusListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirfieldStatusListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
