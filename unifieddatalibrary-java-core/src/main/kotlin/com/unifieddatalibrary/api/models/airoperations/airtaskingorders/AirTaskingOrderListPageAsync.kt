...
class AirTaskingOrderListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<AirTaskingOrderListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderListPageAsync: AirTaskingOrderListPageAsync) =
            apply {
        ...
        fun service(service: AirTaskingOrderServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: AirTaskingOrderListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<AirtaskingorderAbridged>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "AirTaskingOrderListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
