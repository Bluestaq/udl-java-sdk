 ...
 */
class OnorbitantennaListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitantennaListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitantennaListParams: OnorbitantennaListParams) = apply {
    ...
    override fun toString() =
        "OnorbitantennaListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
