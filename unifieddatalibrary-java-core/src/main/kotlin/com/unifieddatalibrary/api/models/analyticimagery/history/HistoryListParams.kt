...
package com.unifieddatalibrary.api.models.analyticimagery.history
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListParams: HistoryListParams) = apply {
            msgTime = historyListParams.msgTime
    ...
    override fun toString() =
        "HistoryListParams{msgTime=$msgTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
