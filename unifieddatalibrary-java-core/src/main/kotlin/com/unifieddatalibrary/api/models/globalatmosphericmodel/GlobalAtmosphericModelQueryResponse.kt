...
class GlobalAtmosphericModelQueryResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GlobalAtmosphericModelQueryResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelQueryResponse: GlobalAtmosphericModelQueryResponse) =
            apply {
                ...
                additionalProperties = globalAtmosphericModelQueryResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): GlobalAtmosphericModelQueryResponse =
        apply {
            if (validated) {
              return@apply
            }
