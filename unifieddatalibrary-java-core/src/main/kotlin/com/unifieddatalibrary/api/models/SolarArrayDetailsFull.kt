...
class SolarArrayDetailsFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("idSolarArray") @ExcludeMissing idSolarArray: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("junctionTechnology") @ExcludeMissing junctionTechnology: JsonField<String> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun junctionTechnology(): Optional<String> = junctionTechnology.getOptional("junctionTechnology")
     ...
     *
     * Unlike [junctionTechnology], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("span")
    @ExcludeMissing
    fun _span(): JsonField<Double> = span
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayDetailsFull: SolarArrayDetailsFull) =
            apply {
         ...
         *
         * You should usually call [Builder.idSolarArray] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idSolarArray(idSolarArray: JsonField<String>) =
            apply {
        ...
        /** Solar array junction technology (e.g. Triple). */
        fun junctionTechnology(junctionTechnology: String) = junctionTechnology(JsonField.of(junctionTechnology))

        /**
         * Sets [Builder.junctionTechnology] to an arbitrary JSON value.
         *
         * You should usually call [Builder.junctionTechnology] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun junctionTechnology(junctionTechnology: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.span] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun span(span: JsonField<Double>) =
            apply {
                this.span = span
            }
         ...
         *
         * You should usually call [Builder.technology] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun technology(technology: JsonField<String>) =
            apply {
    ...
    fun validate(): SolarArrayDetailsFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idSolarArray.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (area.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (junctionTechnology.asKnown().isPresent) 1 else 0) + (manufacturerOrg.asKnown().getOrNull()?.validity() ?: 0) + (if (manufacturerOrgId.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (span.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (technology.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SolarArrayDetailsFull && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idSolarArray == other.idSolarArray && source == other.source && id == other.id && area == other.area && createdAt == other.createdAt && createdBy == other.createdBy && description == other.description && junctionTechnology == other.junctionTechnology && manufacturerOrg == other.manufacturerOrg && manufacturerOrgId == other.manufacturerOrgId && origin == other.origin && origNetwork == other.origNetwork && span == other.span && tags == other.tags && technology == other.technology && type == other.type && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idSolarArray, source, id, area, createdAt, createdBy, description, junctionTechnology, manufacturerOrg, manufacturerOrgId, origin, origNetwork, span, tags, technology, type, updatedAt, updatedBy, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "SolarArrayDetailsFull{classificationMarking=$classificationMarking, dataMode=$dataMode, idSolarArray=$idSolarArray, source=$source, id=$id, area=$area, createdAt=$createdAt, createdBy=$createdBy, description=$description, junctionTechnology=$junctionTechnology, manufacturerOrg=$manufacturerOrg, manufacturerOrgId=$manufacturerOrgId, origin=$origin, origNetwork=$origNetwork, span=$span, tags=$tags, technology=$technology, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
