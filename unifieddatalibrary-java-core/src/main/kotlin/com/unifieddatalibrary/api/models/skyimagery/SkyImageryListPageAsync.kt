...
class SkyImageryListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<SkyImageryListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryListPageAsync: SkyImageryListPageAsync) =
            apply {
        ...
        fun service(service: SkyImageryServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: SkyImageryListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<SkyImageryListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "SkyImageryListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
