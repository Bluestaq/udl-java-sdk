...
class IonoObservationListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<IonoObservationListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ionoObservationListPageAsync: IonoObservationListPageAsync) =
            apply {
        ...
        fun service(service: IonoObservationServiceAsync) =
            apply {
    ...
    override fun toString() = "IonoObservationListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
