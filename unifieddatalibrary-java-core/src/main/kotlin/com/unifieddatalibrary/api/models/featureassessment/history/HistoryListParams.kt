...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListParams: HistoryListParams) = apply {
            idAnalyticImagery = historyListParams.idAnalyticImagery
    ...
    override fun toString() =
        "HistoryListParams{idAnalyticImagery=$idAnalyticImagery, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
