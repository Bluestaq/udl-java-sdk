...
class SarObservationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SarObservationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SarObservationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationQueryhelpResponse: SarObservationQueryhelpResponse) =
            apply {
                aodrSupported = sarObservationQueryhelpResponse.aodrSupported
                classificationMarking = sarObservationQueryhelpResponse.classificationMarking
                description = sarObservationQueryhelpResponse.description
                historySupported = sarObservationQueryhelpResponse.historySupported
                name = sarObservationQueryhelpResponse.name
                parameters = sarObservationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = sarObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = sarObservationQueryhelpResponse.restSupported
                sortSupported = sarObservationQueryhelpResponse.sortSupported
                typeName = sarObservationQueryhelpResponse.typeName
                uri = sarObservationQueryhelpResponse.uri
                additionalProperties = sarObservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SarObservationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SarObservationQueryhelpResponse =
    ...
    fun validate(): SarObservationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
