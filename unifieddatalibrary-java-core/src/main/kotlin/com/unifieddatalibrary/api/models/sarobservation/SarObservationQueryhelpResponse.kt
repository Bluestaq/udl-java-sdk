...
class SarObservationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sarObservationQueryhelpResponse: SarObservationQueryhelpResponse) =
            apply {
                ...
                requiredRoles =
                    sarObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    sarObservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SarObservationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
