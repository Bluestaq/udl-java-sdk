...
/**
 * Beta Version Air Tasking Order: The ATO is used to task air missions, assign cross force tasking
 * as well as intraservice tasking.
 */
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("ackReqInd") @ExcludeMissing ackReqInd: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("endTs") @ExcludeMissing endTs: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("genText")
        @ExcludeMissing
        genText: JsonField<List<GenText>> = JsonMissing.of(),
        @JsonProperty("msgMonth") @ExcludeMissing msgMonth: JsonField<String> = JsonMissing.of(),
    ...
    /**
     * Specifies textual data amplifying the data contained in the acknowledgement requirement
     * indicator (ackRedInd) field or the unit required to acknowledge.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun ackUnitInstructions(): Optional<String> =
        ackUnitInstructions.getOptional("ackUnitInstructions")

    /**
     * A collection that specifies the tasked country, tasked service, unit and mission level
    ...
    /**
     * A collection that details special instructions, important information, guidance, and
     ...
     */
    @JsonProperty("beginTs") @ExcludeMissing fun _beginTs(): JsonField<OffsetDateTime> = beginTs
     ...
     */
    @JsonProperty("opExerName") @ExcludeMissing fun _opExerName(): JsonField<String> = opExerName
     ...
     */
    @JsonProperty("ackReqInd") @ExcludeMissing fun _ackReqInd(): JsonField<String> = ackReqInd

    /**
     * Returns the raw JSON value of [ackUnitInstructions].
     *
     * Unlike [ackUnitInstructions], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("ackUnitInstructions")
    @ExcludeMissing
     ...
     */
    @JsonProperty("endTs") @ExcludeMissing fun _endTs(): JsonField<OffsetDateTime> = endTs
     ...
     */
    @JsonProperty("genText") @ExcludeMissing fun _genText(): JsonField<List<GenText>> = genText
     ...
     */
    @JsonProperty("msgMonth") @ExcludeMissing fun _msgMonth(): JsonField<String> = msgMonth
     ...
     */
    @JsonProperty("msgSN") @ExcludeMissing fun _msgSn(): JsonField<String> = msgSn
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirtaskingorderAbridged].
         *
    ...
    /** A builder for [AirtaskingorderAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airtaskingorderAbridged: AirtaskingorderAbridged) = apply {
            beginTs = airtaskingorderAbridged.beginTs
            classificationMarking = airtaskingorderAbridged.classificationMarking
            dataMode = airtaskingorderAbridged.dataMode
            opExerName = airtaskingorderAbridged.opExerName
            source = airtaskingorderAbridged.source
            id = airtaskingorderAbridged.id
            ackReqInd = airtaskingorderAbridged.ackReqInd
            ackUnitInstructions = airtaskingorderAbridged.ackUnitInstructions
            acMsnTasking = airtaskingorderAbridged.acMsnTasking.map { it.toMutableList() }
            createdAt = airtaskingorderAbridged.createdAt
            createdBy = airtaskingorderAbridged.createdBy
            endTs = airtaskingorderAbridged.endTs
            genText = airtaskingorderAbridged.genText.map { it.toMutableList() }
            msgMonth = airtaskingorderAbridged.msgMonth
            msgOriginator = airtaskingorderAbridged.msgOriginator
            msgQualifier = airtaskingorderAbridged.msgQualifier
            msgSn = airtaskingorderAbridged.msgSn
         ...
         *
         * You should usually call [Builder.beginTs] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun beginTs(beginTs: JsonField<OffsetDateTime>) = apply { this.beginTs = beginTs }
         ...
         *
         * You should usually call [Builder.opExerName] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun opExerName(opExerName: JsonField<String>) = apply { this.opExerName = opExerName }
         ...
         *
         * You should usually call [Builder.ackReqInd] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun ackReqInd(ackReqInd: JsonField<String>) = apply { this.ackReqInd = ackReqInd }

        /**
         * Specifies textual data amplifying the data contained in the acknowledgement requirement
         * indicator (ackRedInd) field or the unit required to acknowledge.
         */
        fun ackUnitInstructions(ackUnitInstructions: String) =
            ackUnitInstructions(JsonField.of(ackUnitInstructions))

        /**
         * Sets [Builder.ackUnitInstructions] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ackUnitInstructions] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ackUnitInstructions(ackUnitInstructions: JsonField<String>) = apply {
         ...
         * tasking for this ATO.
         */
        fun acMsnTasking(acMsnTasking: List<AcMsnTasking>) =
            acMsnTasking(JsonField.of(acMsnTasking))

        /**
         * Sets [Builder.acMsnTasking] to an arbitrary JSON value.
         *
         * You should usually call [Builder.acMsnTasking] with a well-typed `List<AcMsnTasking>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun acMsnTasking(acMsnTasking: JsonField<List<AcMsnTasking>>) = apply {
         ...
         */
        fun addAcMsnTasking(acMsnTasking: AcMsnTasking) = apply {
            this.acMsnTasking =
                (this.acMsnTasking ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.endTs] with a well-typed [OffsetDateTime] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun endTs(endTs: JsonField<OffsetDateTime>) = apply { this.endTs = endTs }
         ...
         *
         * You should usually call [Builder.genText] with a well-typed `List<GenText>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun genText(genText: JsonField<List<GenText>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addGenText(genText: GenText) = apply {
            this.genText =
                (this.genText ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.msgMonth] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun msgMonth(msgMonth: JsonField<String>) = apply { this.msgMonth = msgMonth }
         ...
         *
         * You should usually call [Builder.msgOriginator] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun msgOriginator(msgOriginator: JsonField<String>) = apply {
         ...
         *
         * You should usually call [Builder.msgQualifier] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun msgQualifier(msgQualifier: JsonField<String>) = apply {
         ...
         *
         * You should usually call [Builder.msgSn] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun msgSn(msgSn: JsonField<String>) = apply { this.msgSn = msgSn }
         ...
         *
         * You should usually call [Builder.navalFltOps] with a well-typed `List<NavalFltOp>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun navalFltOps(navalFltOps: JsonField<List<NavalFltOp>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addNavalFltOp(navalFltOp: NavalFltOp) = apply {
            navalFltOps =
                (navalFltOps ?: JsonField.of(mutableListOf())).also {
        ...
        /**
         * Returns an immutable instance of [AirtaskingorderAbridged].
         *
         ...
         */
        fun build(): AirtaskingorderAbridged =
            AirtaskingorderAbridged(
                checkRequired("beginTs", beginTs),
                checkRequired("classificationMarking", classificationMarking),
                checkRequired("dataMode", dataMode),
                checkRequired("opExerName", opExerName),
    ...
    fun validate(): AirtaskingorderAbridged = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (beginTs.asKnown().isPresent) 1 else 0) +
            (if (classificationMarking.asKnown().isPresent) 1 else 0) +
            (dataMode.asKnown().getOrNull()?.validity() ?: 0) +
            (if (opExerName.asKnown().isPresent) 1 else 0) +
            (if (source.asKnown().isPresent) 1 else 0) +
            (if (id.asKnown().isPresent) 1 else 0) +
            (if (ackReqInd.asKnown().isPresent) 1 else 0) +
            (if (ackUnitInstructions.asKnown().isPresent) 1 else 0) +
            (acMsnTasking.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (if (createdAt.asKnown().isPresent) 1 else 0) +
            (if (createdBy.asKnown().isPresent) 1 else 0) +
            (if (endTs.asKnown().isPresent) 1 else 0) +
            (genText.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (if (msgMonth.asKnown().isPresent) 1 else 0) +
            (if (msgOriginator.asKnown().isPresent) 1 else 0) +
            (if (msgQualifier.asKnown().isPresent) 1 else 0) +
            (if (msgSn.asKnown().isPresent) 1 else 0) +
    ...
    /**
     * Collection that specifies the tasked country, tasked service, unit and mission level tasking
     * for this ATO.
     */
    class AcMsnTasking
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            taskedService: JsonField<String> = JsonMissing.of(),
            @JsonProperty("unitDesignator")
            @ExcludeMissing
            unitDesignator: JsonField<String> = JsonMissing.of(),
            @JsonProperty("acMsnLocSeg")
            @ExcludeMissing
            acMsnLocSeg: JsonField<List<AcMsnLocSeg>> = JsonMissing.of(),
            ...
            @ExcludeMissing
            depLocLat: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("depLocLon")
            @ExcludeMissing
            depLocLon: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("depLocName")
            @ExcludeMissing
            depLocName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("depLocUTM")
            @ExcludeMissing
            depLocUtm: JsonField<String> = JsonMissing.of(),
            @JsonProperty("depTime")
            @ExcludeMissing
            depTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("indACTasking")
            @ExcludeMissing
            indAcTasking: JsonField<List<IndAcTasking>> = JsonMissing.of(),
            @JsonProperty("msnCommander")
            @ExcludeMissing
            msnCommander: JsonField<String> = JsonMissing.of(),
            ...
            @ExcludeMissing
            priMsnType: JsonField<String> = JsonMissing.of(),
            @JsonProperty("rcvyLocLat")
            @ExcludeMissing
            rcvyLocLat: JsonField<List<Double>> = JsonMissing.of(),
            @JsonProperty("rcvyLocLon")
            @ExcludeMissing
            rcvyLocLon: JsonField<List<Double>> = JsonMissing.of(),
            @JsonProperty("rcvyLocName")
            @ExcludeMissing
            rcvyLocName: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("rcvyLocUTM")
            @ExcludeMissing
            rcvyLocUtm: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("rcvyTime")
            @ExcludeMissing
            rcvyTime: JsonField<List<OffsetDateTime>> = JsonMissing.of(),
            @JsonProperty("resMsnInd")
            @ExcludeMissing
            resMsnInd: JsonField<String> = JsonMissing.of(),
            @JsonProperty("secMsnType")
            @ExcludeMissing
            secMsnType: JsonField<String> = JsonMissing.of(),
            @JsonProperty("unitLocName")
            @ExcludeMissing
            unitLocName: JsonField<String> = JsonMissing.of(),
        ) : this(
            countryCode,
            taskedService,
            unitDesignator,
        ...
        /**
         * The country code responsible for conducting this aircraft mission tasking for the
        ...
        /**
         * The service tasked with conducting this aircraft mission tasking for the exercise or
         * operation.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   or is unexpectedly missing or null (e.g. if the server responded with an unexpected
        ...
        /**
         * The readiness status expressed in time (minutes) for an aircraft to be airborne after the
         * launch order is received or the time required for a missile unit to assume battle
         * stations.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * WGS-84 latitude of the departure location, in degrees. -90 to 90 degrees (negative values
         * south of equator) for this tasked air mission.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * WGS-84 longitude of the departure location, in degrees. -180 to 180 degrees (negative
         * values west of Prime Meridian) for this tasked air mission.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * The departure location specified in UTM (100 meter) coordinates for the tasked air
         * mission.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * The time of departure for the tasked air mission in ISO8601 UTC format with millisecond
         * precision.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * The commander responsible for the planning and execution of the forces necessary to
        ...
        /**
         * An array of WGS-84 latitude of the recovery locations, in degrees. -90 to 90 degrees
        ...
        /**
         * An array of WGS-84 longitude of the recovery locations, in degrees. -180 to 180 degrees
        ...
        /**
         * An array of locations specified for the recovery of the tasked air mission represented by
         * varying formats.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * An array of recovery locations specified in UTM (100 meter) coordinates for the tasked
         * air mission.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         *
         * Unlike [taskedService], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("taskedService")
        @ExcludeMissing
         ...
         *
         * Unlike [unitDesignator], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("unitDesignator")
        @ExcludeMissing
         ...
         */
        @JsonProperty("depLocLat") @ExcludeMissing fun _depLocLat(): JsonField<Double> = depLocLat
         ...
         */
        @JsonProperty("depLocLon") @ExcludeMissing fun _depLocLon(): JsonField<Double> = depLocLon
         ...
         */
        @JsonProperty("depLocUTM") @ExcludeMissing fun _depLocUtm(): JsonField<String> = depLocUtm
         ...
         */
        @JsonProperty("depTime") @ExcludeMissing fun _depTime(): JsonField<OffsetDateTime> = depTime

        /**
         * Returns the raw JSON value of [indAcTasking].
         *
         * Unlike [indAcTasking], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("indACTasking")
        @ExcludeMissing
         ...
         *
         * Unlike [msnCommander], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("msnCommander")
        @ExcludeMissing
         ...
         */
        @JsonProperty("msnNum") @ExcludeMissing fun _msnNum(): JsonField<String> = msnNum
         ...
         */
        @JsonProperty("pkgId") @ExcludeMissing fun _pkgId(): JsonField<String> = pkgId
         ...
         */
        @JsonProperty("resMsnInd") @ExcludeMissing fun _resMsnInd(): JsonField<String> = resMsnInd
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(acMsnTasking: AcMsnTasking) = apply {
             ...
             *
             * You should usually call [Builder.taskedService] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun taskedService(taskedService: JsonField<String>) = apply {
             ...
             * The designator of the unit that is tasked to perform this aircraft mission tasking.
             */
            fun unitDesignator(unitDesignator: String) =
                unitDesignator(JsonField.of(unitDesignator))

            /**
             * Sets [Builder.unitDesignator] to an arbitrary JSON value.
             *
             * You should usually call [Builder.unitDesignator] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun unitDesignator(unitDesignator: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.acMsnLocSeg] with a well-typed `List<AcMsnLocSeg>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun acMsnLocSeg(acMsnLocSeg: JsonField<List<AcMsnLocSeg>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addAcMsnLocSeg(acMsnLocSeg: AcMsnLocSeg) = apply {
                this.acMsnLocSeg =
                    (this.acMsnLocSeg ?: JsonField.of(mutableListOf())).also {
                        checkKnown("acMsnLocSeg", it).add(acMsnLocSeg)
                    }
            }

            /**
             * The readiness status expressed in time (minutes) for an aircraft to be airborne after
             * the launch order is received or the time required for a missile unit to assume battle
             * stations.
             */
            ...
            /**
             * WGS-84 latitude of the departure location, in degrees. -90 to 90 degrees (negative
             ...
             *
             * You should usually call [Builder.depLocLat] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun depLocLat(depLocLat: JsonField<Double>) = apply { this.depLocLat = depLocLat }
             ...
             *
             * You should usually call [Builder.depLocLon] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun depLocLon(depLocLon: JsonField<Double>) = apply { this.depLocLon = depLocLon }
             ...
             *
             * You should usually call [Builder.depLocName] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun depLocName(depLocName: JsonField<String>) = apply { this.depLocName = depLocName }
             ...
             *
             * You should usually call [Builder.depLocUtm] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun depLocUtm(depLocUtm: JsonField<String>) = apply { this.depLocUtm = depLocUtm }
             ...
             *
             * You should usually call [Builder.depTime] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun depTime(depTime: JsonField<OffsetDateTime>) = apply { this.depTime = depTime }

            /**
             * A collection of the individual aircraft assigned to this aircraft mission tasking.
             */
            fun indAcTasking(indAcTasking: List<IndAcTasking>) =
                indAcTasking(JsonField.of(indAcTasking))

            /**
             * Sets [Builder.indAcTasking] to an arbitrary JSON value.
             *
             * You should usually call [Builder.indAcTasking] with a well-typed `List<IndAcTasking>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun indAcTasking(indAcTasking: JsonField<List<IndAcTasking>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addIndAcTasking(indAcTasking: IndAcTasking) = apply {
                this.indAcTasking =
                    (this.indAcTasking ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.msnCommander] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun msnCommander(msnCommander: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.msnNum] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun msnNum(msnNum: JsonField<String>) = apply { this.msnNum = msnNum }
             ...
             *
             * You should usually call [Builder.pkgId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pkgId(pkgId: JsonField<String>) = apply { this.pkgId = pkgId }
             ...
             *
             * You should usually call [Builder.priMsnType] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun priMsnType(priMsnType: JsonField<String>) = apply { this.priMsnType = priMsnType }
             ...
             *
             * You should usually call [Builder.rcvyLocLat] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rcvyLocLat(rcvyLocLat: JsonField<List<Double>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addRcvyLocLat(rcvyLocLat: Double) = apply {
                this.rcvyLocLat =
                    (this.rcvyLocLat ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.rcvyLocLon] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rcvyLocLon(rcvyLocLon: JsonField<List<Double>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addRcvyLocLon(rcvyLocLon: Double) = apply {
                this.rcvyLocLon =
                    (this.rcvyLocLon ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.rcvyLocName] with a well-typed `List<String>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rcvyLocName(rcvyLocName: JsonField<List<String>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addRcvyLocName(rcvyLocName: String) = apply {
                this.rcvyLocName =
                    (this.rcvyLocName ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.rcvyLocUtm] with a well-typed `List<String>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rcvyLocUtm(rcvyLocUtm: JsonField<List<String>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addRcvyLocUtm(rcvyLocUtm: String) = apply {
                this.rcvyLocUtm =
                    (this.rcvyLocUtm ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.rcvyTime] with a well-typed `List<OffsetDateTime>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun rcvyTime(rcvyTime: JsonField<List<OffsetDateTime>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addRcvyTime(rcvyTime: OffsetDateTime) = apply {
                this.rcvyTime =
                    (this.rcvyTime ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.resMsnInd] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun resMsnInd(resMsnInd: JsonField<String>) = apply { this.resMsnInd = resMsnInd }
             ...
             *
             * You should usually call [Builder.secMsnType] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun secMsnType(secMsnType: JsonField<String>) = apply { this.secMsnType = secMsnType }
             ...
             *
             * You should usually call [Builder.unitLocName] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun unitLocName(unitLocName: JsonField<String>) = apply {
            ...
            fun build(): AcMsnTasking =
                AcMsnTasking(
                    ...
                    checkRequired("taskedService", taskedService),
                    checkRequired("unitDesignator", unitDesignator),
        ...
        fun validate(): AcMsnTasking = apply {
            if (validated) {
                return@apply
            }
        ...
        internal fun validity(): Int =
            (if (countryCode.asKnown().isPresent) 1 else 0) +
                (if (taskedService.asKnown().isPresent) 1 else 0) +
                (if (unitDesignator.asKnown().isPresent) 1 else 0) +
                (acMsnLocSeg.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (alertStatus.asKnown().isPresent) 1 else 0) +
                (if (amcMsnNum.asKnown().isPresent) 1 else 0) +
                (if (depLocLat.asKnown().isPresent) 1 else 0) +
                (if (depLocLon.asKnown().isPresent) 1 else 0) +
                (if (depLocName.asKnown().isPresent) 1 else 0) +
                (if (depLocUtm.asKnown().isPresent) 1 else 0) +
                (if (depTime.asKnown().isPresent) 1 else 0) +
                (indAcTasking.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (msnCommander.asKnown().isPresent) 1 else 0) +
                (if (msnNum.asKnown().isPresent) 1 else 0) +
                (if (pkgId.asKnown().isPresent) 1 else 0) +
                (if (priMsnType.asKnown().isPresent) 1 else 0) +
                (rcvyLocLat.asKnown().getOrNull()?.size ?: 0) +
                (rcvyLocLon.asKnown().getOrNull()?.size ?: 0) +
                (rcvyLocName.asKnown().getOrNull()?.size ?: 0) +
                (rcvyLocUtm.asKnown().getOrNull()?.size ?: 0) +
                (rcvyTime.asKnown().getOrNull()?.size ?: 0) +
                (if (resMsnInd.asKnown().isPresent) 1 else 0) +
                (if (secMsnType.asKnown().isPresent) 1 else 0) +
                (if (unitLocName.asKnown().isPresent) 1 else 0)
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                airMsnPri: JsonField<String> = JsonMissing.of(),
                @JsonProperty("alt") @ExcludeMissing alt: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("areaGeoRad")
                @ExcludeMissing
                areaGeoRad: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("endTime")
                @ExcludeMissing
                endTime: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("msnLocName")
                @ExcludeMissing
                msnLocName: JsonField<String> = JsonMissing.of(),
                @JsonProperty("msnLocPtBarT")
                @ExcludeMissing
                msnLocPtBarT: JsonField<String> = JsonMissing.of(),
                @JsonProperty("msnLocPtLat")
                @ExcludeMissing
                msnLocPtLat: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("msnLocPtLon")
                @ExcludeMissing
                msnLocPtLon: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("msnLocPtName")
                @ExcludeMissing
                msnLocPtName: JsonField<String> = JsonMissing.of(),
            ) : this(
                startTime,
                airMsnPri,
                alt,
            ...
            /**
             * The name that identifies the location at which this mission is to be performed. This
             * can be the name of a general target area, orbit, cap point, station, etc.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            ...
            /**
             * The alpha-numeric specified location for this mission specified as a bearing angle in
             * degrees relative to true north and a range in nautical miles (NM).
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            ...
            /**
             * WGS-84 longitude of the mission location, in degrees. -180 to 180 degrees (negative
             * values west of Prime Meridian) for this tasked air mission.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             ...
             *
             * Unlike [airMsnPri], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("airMsnPri")
            @ExcludeMissing
             ...
             */
            @JsonProperty("alt") @ExcludeMissing fun _alt(): JsonField<Int> = alt

            /**
             * Returns the raw JSON value of [areaGeoRad].
             *
             * Unlike [areaGeoRad], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("areaGeoRad")
            @ExcludeMissing
             ...
             *
             * Unlike [msnLocName], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("msnLocName")
            @ExcludeMissing
             ...
             *
             * Unlike [msnLocPtBarT], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("msnLocPtBarT")
            @ExcludeMissing
             ...
             *
             * Unlike [msnLocPtLat], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("msnLocPtLat")
            @ExcludeMissing
             ...
             *
             * Unlike [msnLocPtLon], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("msnLocPtLon")
            @ExcludeMissing
             ...
             *
             * Unlike [msnLocPtName], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("msnLocPtName")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(acMsnLocSeg: AcMsnLocSeg) = apply {
                 ...
                 *
                 * You should usually call [Builder.airMsnPri] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun airMsnPri(airMsnPri: JsonField<String>) = apply { this.airMsnPri = airMsnPri }
                 ...
                 *
                 * You should usually call [Builder.alt] with a well-typed [Int] value instead. This
                 * method is primarily for setting the field to an undocumented or not yet supported
                 * value.
                 */
                fun alt(alt: JsonField<Int>) = apply { this.alt = alt }
                 ...
                 *
                 * You should usually call [Builder.areaGeoRad] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun areaGeoRad(areaGeoRad: JsonField<Int>) = apply { this.areaGeoRad = areaGeoRad }
                 ...
                 *
                 * You should usually call [Builder.msnLocName] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun msnLocName(msnLocName: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.msnLocPtBarT] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun msnLocPtBarT(msnLocPtBarT: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.msnLocPtLat] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun msnLocPtLat(msnLocPtLat: JsonField<Double>) = apply {
                 ...
                 *
                 * You should usually call [Builder.msnLocPtLon] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun msnLocPtLon(msnLocPtLon: JsonField<Double>) = apply {
                 ...
                 *
                 * You should usually call [Builder.msnLocPtName] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun msnLocPtName(msnLocPtName: JsonField<String>) = apply {
            ...
            fun validate(): AcMsnLocSeg = apply {
                if (validated) {
                    return@apply
                }
            ...
            internal fun validity(): Int =
                (if (startTime.asKnown().isPresent) 1 else 0) +
                    (if (airMsnPri.asKnown().isPresent) 1 else 0) +
                    (if (alt.asKnown().isPresent) 1 else 0) +
                    (if (areaGeoRad.asKnown().isPresent) 1 else 0) +
                    (if (endTime.asKnown().isPresent) 1 else 0) +
                    (if (msnLocName.asKnown().isPresent) 1 else 0) +
                    (if (msnLocPtBarT.asKnown().isPresent) 1 else 0) +
                    (if (msnLocPtLat.asKnown().isPresent) 1 else 0) +
                    (if (msnLocPtLon.asKnown().isPresent) 1 else 0) +
                    (if (msnLocPtName.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() =
                "AcMsnLocSeg{startTime=$startTime, airMsnPri=$airMsnPri, alt=$alt, areaGeoRad=$areaGeoRad, endTime=$endTime, msnLocName=$msnLocName, msnLocPtBarT=$msnLocPtBarT, msnLocPtLat=$msnLocPtLat, msnLocPtLon=$msnLocPtLon, msnLocPtName=$msnLocPtName, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                acftType: JsonField<String> = JsonMissing.of(),
                @JsonProperty("callSign")
                @ExcludeMissing
                callSign: JsonField<String> = JsonMissing.of(),
                @JsonProperty("iffSifMode1Code")
                @ExcludeMissing
                iffSifMode1Code: JsonField<String> = JsonMissing.of(),
                @JsonProperty("iffSifMode2Code")
                @ExcludeMissing
                iffSifMode2Code: JsonField<String> = JsonMissing.of(),
                @JsonProperty("iffSifMode3Code")
                @ExcludeMissing
                iffSifMode3Code: JsonField<String> = JsonMissing.of(),
                @JsonProperty("juAddress")
                @ExcludeMissing
                juAddress: JsonField<List<Int>> = JsonMissing.of(),
                @JsonProperty("link16CallSign")
                @ExcludeMissing
                link16CallSign: JsonField<String> = JsonMissing.of(),
                @JsonProperty("numAcft") @ExcludeMissing numAcft: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("priConfigCode")
                @ExcludeMissing
                priConfigCode: JsonField<String> = JsonMissing.of(),
                @JsonProperty("secConfigCode")
                @ExcludeMissing
                secConfigCode: JsonField<String> = JsonMissing.of(),
                @JsonProperty("tacanChan")
                @ExcludeMissing
                tacanChan: JsonField<Int> = JsonMissing.of(),
            ) : this(
                acftType,
                callSign,
                iffSifMode1Code,
             ...
             * (JU) address for the mission aircraft.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            ...
            /**
             * The Link 16 abbreviated call sign assigned to the ACA. This is normally the first and
             * last letter and the last two numbers of the call sign.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             *
             * Unlike [acftType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("acftType") @ExcludeMissing fun _acftType(): JsonField<String> = acftType
             ...
             *
             * Unlike [iffSifMode1Code], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("iffSifMode1Code")
            @ExcludeMissing
             ...
             *
             * Unlike [iffSifMode2Code], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("iffSifMode2Code")
            @ExcludeMissing
             ...
             *
             * Unlike [iffSifMode3Code], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("iffSifMode3Code")
            @ExcludeMissing
             ...
             *
             * Unlike [juAddress], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("juAddress")
            @ExcludeMissing
             ...
             *
             * Unlike [link16CallSign], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("link16CallSign")
            @ExcludeMissing
             ...
             */
            @JsonProperty("numAcft") @ExcludeMissing fun _numAcft(): JsonField<Int> = numAcft

            /**
             * Returns the raw JSON value of [priConfigCode].
             *
             * Unlike [priConfigCode], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("priConfigCode")
            @ExcludeMissing
             ...
             *
             * Unlike [secConfigCode], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("secConfigCode")
            @ExcludeMissing
             ...
             *
             * Unlike [tacanChan], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("tacanChan") @ExcludeMissing fun _tacanChan(): JsonField<Int> = tacanChan
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(indAcTasking: IndAcTasking) = apply {
                 ...
                 *
                 * You should usually call [Builder.acftType] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun acftType(acftType: JsonField<String>) = apply { this.acftType = acftType }
                 ...
                 * Identification Feature (SIF).
                 */
                fun iffSifMode1Code(iffSifMode1Code: String) =
                    iffSifMode1Code(JsonField.of(iffSifMode1Code))

                /**
                 * Sets [Builder.iffSifMode1Code] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.iffSifMode1Code] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun iffSifMode1Code(iffSifMode1Code: JsonField<String>) = apply {
                 ...
                 * Identification Feature (SIF).
                 */
                fun iffSifMode2Code(iffSifMode2Code: String) =
                    iffSifMode2Code(JsonField.of(iffSifMode2Code))

                /**
                 * Sets [Builder.iffSifMode2Code] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.iffSifMode2Code] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun iffSifMode2Code(iffSifMode2Code: JsonField<String>) = apply {
                 ...
                 * Identification Feature (SIF).
                 */
                fun iffSifMode3Code(iffSifMode3Code: String) =
                    iffSifMode3Code(JsonField.of(iffSifMode3Code))

                /**
                 * Sets [Builder.iffSifMode3Code] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.iffSifMode3Code] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun iffSifMode3Code(iffSifMode3Code: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.juAddress] with a well-typed `List<Int>` value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun juAddress(juAddress: JsonField<List<Int>>) = apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addJuAddress(juAddress: Int) = apply {
                    this.juAddress =
                        (this.juAddress ?: JsonField.of(mutableListOf())).also {
                            checkKnown("juAddress", it).add(juAddress)
                        }
                }

                /**
                 * The Link 16 abbreviated call sign assigned to the ACA. This is normally the first
                 * and last letter and the last two numbers of the call sign.
                 */
                fun link16CallSign(link16CallSign: String) =
                    link16CallSign(JsonField.of(link16CallSign))

                /**
                 * Sets [Builder.link16CallSign] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.link16CallSign] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun link16CallSign(link16CallSign: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.numAcft] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun numAcft(numAcft: JsonField<Int>) = apply { this.numAcft = numAcft }

                /** The code that indicates the ordinance mix carried on this mission aircraft. */
                fun priConfigCode(priConfigCode: String) =
                    priConfigCode(JsonField.of(priConfigCode))

                /**
                 * Sets [Builder.priConfigCode] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.priConfigCode] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun priConfigCode(priConfigCode: JsonField<String>) = apply {
                    this.priConfigCode = priConfigCode
                }

                /** The code for the secondary ordinance mix carried on this mission aircraft. */
                fun secConfigCode(secConfigCode: String) =
                    secConfigCode(JsonField.of(secConfigCode))

                /**
                 * Sets [Builder.secConfigCode] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.secConfigCode] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun secConfigCode(secConfigCode: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.tacanChan] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun tacanChan(tacanChan: JsonField<Int>) = apply { this.tacanChan = tacanChan }
                ...
                fun build(): IndAcTasking =
                    IndAcTasking(
                        checkRequired("acftType", acftType),
                        callSign,
                        iffSifMode1Code,
                        iffSifMode2Code,
                        iffSifMode3Code,
            ...
            fun validate(): IndAcTasking = apply {
                if (validated) {
                    return@apply
                }
            ...
            @JvmSynthetic
            internal fun validity(): Int =
                (if (acftType.asKnown().isPresent) 1 else 0) +
                    (if (callSign.asKnown().isPresent) 1 else 0) +
                    (if (iffSifMode1Code.asKnown().isPresent) 1 else 0) +
                    (if (iffSifMode2Code.asKnown().isPresent) 1 else 0) +
                    (if (iffSifMode3Code.asKnown().isPresent) 1 else 0) +
                    (juAddress.asKnown().getOrNull()?.size ?: 0) +
                    (if (link16CallSign.asKnown().isPresent) 1 else 0) +
                    (if (numAcft.asKnown().isPresent) 1 else 0) +
                    (if (priConfigCode.asKnown().isPresent) 1 else 0) +
                    (if (secConfigCode.asKnown().isPresent) 1 else 0) +
                    (if (tacanChan.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() =
                "IndAcTasking{acftType=$acftType, callSign=$callSign, iffSifMode1Code=$iffSifMode1Code, iffSifMode2Code=$iffSifMode2Code, iffSifMode3Code=$iffSifMode3Code, juAddress=$juAddress, link16CallSign=$link16CallSign, numAcft=$numAcft, priConfigCode=$priConfigCode, secConfigCode=$secConfigCode, tacanChan=$tacanChan, additionalProperties=$additionalProperties}"
        }
    ...
    private constructor(
        ...
        ) : this(text, textInd, mutableMapOf())
        ...
        /**
         * The indicator for the general text block. Examples include "OPENING REMARKS" and "GENERAL
         * SPINS INFORMATION".
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         */
        @JsonProperty("textInd") @ExcludeMissing fun _textInd(): JsonField<String> = textInd
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(genText: GenText) = apply {
                text = genText.text
             ...
             *
             * You should usually call [Builder.textInd] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun textInd(textInd: JsonField<String>) = apply { this.textInd = textInd }
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): GenText = GenText(text, textInd, additionalProperties.toMutableMap())
        }

        private var validated: Boolean = false

        fun validate(): GenText = apply {
            if (validated) {
                return@apply
            }
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (text.asKnown().isPresent) 1 else 0) + (if (textInd.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() =
            "GenText{text=$text, textInd=$textInd, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            fltOpStart: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("fltOpStop")
            @ExcludeMissing
            fltOpStop: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("schdLaunchRcvyTime")
            @ExcludeMissing
            schdLaunchRcvyTime: JsonField<List<OffsetDateTime>> = JsonMissing.of(),
        ) : this(shipName, fltOpStart, fltOpStop, schdLaunchRcvyTime, mutableMapOf())
        ...
        /**
         * An array of times at which an aircraft will be launched and/or recovered in ISO8601 UTC
         * format with millisecond precision.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        fun schdLaunchRcvyTime(): Optional<List<OffsetDateTime>> =
            schdLaunchRcvyTime.getOptional("schdLaunchRcvyTime")
         ...
         *
         * Unlike [schdLaunchRcvyTime], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("schdLaunchRcvyTime")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(navalFltOp: NavalFltOp) = apply {
             ...
             *
             * You should usually call [Builder.shipName] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.fltOpStart] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fltOpStart(fltOpStart: JsonField<OffsetDateTime>) = apply {
             ...
             *
             * You should usually call [Builder.fltOpStop] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fltOpStop(fltOpStop: JsonField<OffsetDateTime>) = apply {
                this.fltOpStop = fltOpStop
            }

            /**
             * An array of times at which an aircraft will be launched and/or recovered in ISO8601
             * UTC format with millisecond precision.
             */
            fun schdLaunchRcvyTime(schdLaunchRcvyTime: List<OffsetDateTime>) =
                schdLaunchRcvyTime(JsonField.of(schdLaunchRcvyTime))

            /**
             * Sets [Builder.schdLaunchRcvyTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.schdLaunchRcvyTime] with a well-typed
             * `List<OffsetDateTime>` value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            fun schdLaunchRcvyTime(schdLaunchRcvyTime: JsonField<List<OffsetDateTime>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addSchdLaunchRcvyTime(schdLaunchRcvyTime: OffsetDateTime) = apply {
                this.schdLaunchRcvyTime =
                    (this.schdLaunchRcvyTime ?: JsonField.of(mutableListOf())).also {
            ...
            fun build(): NavalFltOp =
                NavalFltOp(
                    checkRequired("shipName", shipName),
                    fltOpStart,
                    fltOpStop,
        ...
        internal fun validity(): Int =
            (if (shipName.asKnown().isPresent) 1 else 0) +
                (if (fltOpStart.asKnown().isPresent) 1 else 0) +
                (if (fltOpStop.asKnown().isPresent) 1 else 0) +
                (schdLaunchRcvyTime.asKnown().getOrNull()?.size ?: 0)
        ...
        override fun toString() =
            "NavalFltOp{shipName=$shipName, fltOpStart=$fltOpStart, fltOpStop=$fltOpStop, schdLaunchRcvyTime=$schdLaunchRcvyTime, additionalProperties=$additionalProperties}"
    }
