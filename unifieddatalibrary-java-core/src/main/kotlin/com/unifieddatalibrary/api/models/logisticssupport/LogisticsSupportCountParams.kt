 ...
 */
class LogisticsSupportCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LogisticsSupportCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportCountParams: LogisticsSupportCountParams) = apply {
    ...
    override fun toString() =
        "LogisticsSupportCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
