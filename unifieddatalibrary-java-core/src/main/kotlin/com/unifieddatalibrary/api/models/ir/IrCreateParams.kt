...
/**
 * Service operation to take a single IR as a POST body and ingest into the database. An IR is an
 * on-orbit infrared payload. A specific role is required to perform this service operation. Please
 * contact the UDL team for assistance.
 */
class IrCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IrCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(irCreateParams: IrCreateParams) = apply {
            body = irCreateParams.body.toBuilder()
            additionalHeaders = irCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = irCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IrCreateParams].
         *
         ...
         */
        fun build(): IrCreateParams =
            IrCreateParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IrCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "IrCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
