...
class BusListPageAsync private constructor(
    ...
    fun autoPager(): AutoPagerAsync<BusAbridged> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(busListPageAsync: BusListPageAsync) =
            apply {
        ...
        fun service(service: BusServiceAsync) =
            apply {
    ...
    override fun toString() = "BusListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
