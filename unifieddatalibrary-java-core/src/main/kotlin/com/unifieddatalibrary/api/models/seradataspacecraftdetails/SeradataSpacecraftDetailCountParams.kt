 ...
 */
class SeradataSpacecraftDetailCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataSpacecraftDetailCountParams = builder().build()
    ...
    /** A builder for [SeradataSpacecraftDetailCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataSpacecraftDetailCountParams: SeradataSpacecraftDetailCountParams
        ) = apply {
            firstResult = seradataSpacecraftDetailCountParams.firstResult
            maxResults = seradataSpacecraftDetailCountParams.maxResults
            additionalHeaders = seradataSpacecraftDetailCountParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                seradataSpacecraftDetailCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SeradataSpacecraftDetailCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataSpacecraftDetailCountParams =
            SeradataSpacecraftDetailCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeradataSpacecraftDetailCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeradataSpacecraftDetailCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
