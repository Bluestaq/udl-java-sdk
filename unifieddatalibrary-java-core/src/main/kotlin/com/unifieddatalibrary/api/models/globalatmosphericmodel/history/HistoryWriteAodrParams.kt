...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(historyWriteAodrParams: HistoryWriteAodrParams) = apply {
         ...
         * (YYYY-MM-DDTHH:MM:SS.sssZ)
         */
        fun ts(ts: OffsetDateTime) = apply { this.ts = ts }
    ...
    override fun toString() =
        "HistoryWriteAodrParams{ts=$ts, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
