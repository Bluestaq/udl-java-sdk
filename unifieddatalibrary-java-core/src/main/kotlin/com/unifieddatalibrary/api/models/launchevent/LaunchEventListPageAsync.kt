...
class LaunchEventListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<LaunchEventListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventListPageAsync: LaunchEventListPageAsync) = apply {
        ...
        fun service(service: LaunchEventServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaunchEventListPageAsync &&
    ...
    override fun toString() =
        "LaunchEventListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
