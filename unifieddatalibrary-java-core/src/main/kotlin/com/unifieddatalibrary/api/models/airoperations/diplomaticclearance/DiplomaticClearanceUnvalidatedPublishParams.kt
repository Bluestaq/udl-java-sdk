...
class DiplomaticClearanceUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiplomaticClearanceUnvalidatedPublishParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diplomaticClearanceUnvalidatedPublishParams: DiplomaticClearanceUnvalidatedPublishParams) =
            apply {
                body = diplomaticClearanceUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = diplomaticClearanceUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = diplomaticClearanceUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("firstDepDate") @ExcludeMissing private val firstDepDate: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("diplomaticClearanceDetails") @ExcludeMissing private val diplomaticClearanceDetails: JsonField<List<DiplomaticClearanceDetail>>,
        @JsonProperty("diplomaticClearanceRemarks") @ExcludeMissing private val diplomaticClearanceRemarks: JsonField<List<DiplomaticClearanceRemark>>,
        @JsonProperty("dipWorksheetName") @ExcludeMissing private val dipWorksheetName: JsonField<String>,
        @JsonProperty("docDeadline") @ExcludeMissing private val docDeadline: JsonField<OffsetDateTime>,
        @JsonProperty("externalWorksheetId") @ExcludeMissing private val externalWorksheetId: JsonField<String>,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun diplomaticClearanceDetails(): Optional<List<DiplomaticClearanceDetail>> = diplomaticClearanceDetails.getOptional("diplomaticClearanceDetails")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun diplomaticClearanceRemarks(): Optional<List<DiplomaticClearanceRemark>> = diplomaticClearanceRemarks.getOptional("diplomaticClearanceRemarks")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun externalWorksheetId(): Optional<String> = externalWorksheetId.getOptional("externalWorksheetId")
         ...
         *
         * Unlike [firstDepDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [diplomaticClearanceDetails], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("diplomaticClearanceDetails")
        @ExcludeMissing
        fun _diplomaticClearanceDetails(): JsonField<List<DiplomaticClearanceDetail>> = diplomaticClearanceDetails

        /**
         * Returns the raw JSON value of [diplomaticClearanceRemarks].
         *
         * Unlike [diplomaticClearanceRemarks], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("diplomaticClearanceRemarks")
        @ExcludeMissing
        fun _diplomaticClearanceRemarks(): JsonField<List<DiplomaticClearanceRemark>> = diplomaticClearanceRemarks
         ...
         *
         * Unlike [externalWorksheetId], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            private var diplomaticClearanceDetails: JsonField<MutableList<DiplomaticClearanceDetail>>? = null
            private var diplomaticClearanceRemarks: JsonField<MutableList<DiplomaticClearanceRemark>>? = null
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    diplomaticClearanceDetails = body.diplomaticClearanceDetails.map { it.toMutableList() }
                    diplomaticClearanceRemarks = body.diplomaticClearanceRemarks.map { it.toMutableList() }
            ...
            /** The First Departure Date (FDD) the mission is scheduled for departure, in ISO 8601 UTC format with millisecond precision. */
            fun firstDepDate(firstDepDate: OffsetDateTime) = firstDepDate(JsonField.of(firstDepDate))

            /**
             * Sets [Builder.firstDepDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.firstDepDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun firstDepDate(firstDepDate: JsonField<OffsetDateTime>) =
                apply {
            ...
            /** Collection of diplomatic clearance details. */
            fun diplomaticClearanceDetails(diplomaticClearanceDetails: List<DiplomaticClearanceDetail>) = diplomaticClearanceDetails(JsonField.of(diplomaticClearanceDetails))

            /**
             * Sets [Builder.diplomaticClearanceDetails] to an arbitrary JSON value.
             *
             * You should usually call [Builder.diplomaticClearanceDetails] with a well-typed `List<DiplomaticClearanceDetail>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun diplomaticClearanceDetails(diplomaticClearanceDetails: JsonField<List<DiplomaticClearanceDetail>>) =
                apply {
                    this.diplomaticClearanceDetails = diplomaticClearanceDetails.map { it.toMutableList() }
                }
            ...
            fun addDiplomaticClearanceDetail(diplomaticClearanceDetail: DiplomaticClearanceDetail) =
                apply {
                    diplomaticClearanceDetails = (diplomaticClearanceDetails ?: JsonField.of(mutableListOf())).also {
                        checkKnown("diplomaticClearanceDetails", it).add(diplomaticClearanceDetail)
                    }
                }

            /** Collection of diplomatic clearance remarks. */
            fun diplomaticClearanceRemarks(diplomaticClearanceRemarks: List<DiplomaticClearanceRemark>) = diplomaticClearanceRemarks(JsonField.of(diplomaticClearanceRemarks))

            /**
             * Sets [Builder.diplomaticClearanceRemarks] to an arbitrary JSON value.
             *
             * You should usually call [Builder.diplomaticClearanceRemarks] with a well-typed `List<DiplomaticClearanceRemark>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun diplomaticClearanceRemarks(diplomaticClearanceRemarks: JsonField<List<DiplomaticClearanceRemark>>) =
                apply {
                    this.diplomaticClearanceRemarks = diplomaticClearanceRemarks.map { it.toMutableList() }
                }
            ...
            fun addDiplomaticClearanceRemark(diplomaticClearanceRemark: DiplomaticClearanceRemark) =
                apply {
                    diplomaticClearanceRemarks = (diplomaticClearanceRemarks ?: JsonField.of(mutableListOf())).also {
                        checkKnown("diplomaticClearanceRemarks", it).add(diplomaticClearanceRemark)
                    }
                }
             ...
             *
             * You should usually call [Builder.docDeadline] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun docDeadline(docDeadline: JsonField<OffsetDateTime>) =
                apply {
                    this.docDeadline = docDeadline
                }

            /** Optional diplomatic clearance worksheet ID from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID. */
            fun externalWorksheetId(externalWorksheetId: String) = externalWorksheetId(JsonField.of(externalWorksheetId))

            /**
             * Sets [Builder.externalWorksheetId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.externalWorksheetId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun externalWorksheetId(externalWorksheetId: JsonField<String>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (firstDepDate.asKnown().isPresent) 1 else 0) + (if (idMission.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (apacsId.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (diplomaticClearanceDetails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (diplomaticClearanceRemarks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (dipWorksheetName.asKnown().isPresent) 1 else 0) + (if (docDeadline.asKnown().isPresent) 1 else 0) + (if (externalWorksheetId.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
        ...
        /** Collection of diplomatic clearance details. */
        class DiplomaticClearanceDetail private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("altCountryCode") @ExcludeMissing altCountryCode: JsonField<String> = JsonMissing.of(),
                @JsonProperty("clearanceId") @ExcludeMissing clearanceId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("clearanceRemark") @ExcludeMissing clearanceRemark: JsonField<String> = JsonMissing.of(),
                @JsonProperty("clearedCallSign") @ExcludeMissing clearedCallSign: JsonField<String> = JsonMissing.of(),
                ...
                @JsonProperty("entryNET") @ExcludeMissing entryNet: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("entryPoint") @ExcludeMissing entryPoint: JsonField<String> = JsonMissing.of(),
                @JsonProperty("exitNLT") @ExcludeMissing exitNlt: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("exitPoint") @ExcludeMissing exitPoint: JsonField<String> = JsonMissing.of(),
                @JsonProperty("externalClearanceId") @ExcludeMissing externalClearanceId: JsonField<String> = JsonMissing.of(),
                ...
                @JsonProperty("reqPoint") @ExcludeMissing reqPoint: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("routeString") @ExcludeMissing routeString: JsonField<String> = JsonMissing.of(),
                @JsonProperty("sequenceNum") @ExcludeMissing sequenceNum: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("status") @ExcludeMissing status: JsonField<String> = JsonMissing.of(),
                @JsonProperty("validDesc") @ExcludeMissing validDesc: JsonField<String> = JsonMissing.of(),
                @JsonProperty("validEndTime") @ExcludeMissing validEndTime: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("validStartTime") @ExcludeMissing validStartTime: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("windowRemark") @ExcludeMissing windowRemark: JsonField<String> = JsonMissing.of()
            ) : this(
              action,
              altCountryCode,
              clearanceId,
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun externalClearanceId(): Optional<String> = externalClearanceId.getOptional("externalClearanceId")
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun validStartTime(): Optional<OffsetDateTime> = validStartTime.getOptional("validStartTime")
             ...
             *
             * Unlike [clearanceRemark], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [clearedCallSign], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [entryNet], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [exitPoint], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [externalClearanceId], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [reqPoint], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("reqPoint")
            @ExcludeMissing
            fun _reqPoint(): JsonField<Boolean> = reqPoint
             ...
             *
             * Unlike [validDesc], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [validEndTime], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [validStartTime], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [windowRemark], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [DiplomaticClearanceDetail]. */
                @JvmStatic
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(diplomaticClearanceDetail: DiplomaticClearanceDetail) =
                    apply {
                        ...
                        additionalProperties = diplomaticClearanceDetail.additionalProperties.toMutableMap()
                    }
                 ...
                 *
                 * You should usually call [Builder.action] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                ...
                /** Remarks concerning this diplomatic clearance. */
                fun clearanceRemark(clearanceRemark: String) = clearanceRemark(JsonField.of(clearanceRemark))

                /**
                 * Sets [Builder.clearanceRemark] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.clearanceRemark] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun clearanceRemark(clearanceRemark: JsonField<String>) =
                    apply {
                        this.clearanceRemark = clearanceRemark
                    }

                /** The call sign of the sortie cleared with this diplomatic clearance. */
                fun clearedCallSign(clearedCallSign: String) = clearedCallSign(JsonField.of(clearedCallSign))

                /**
                 * Sets [Builder.clearedCallSign] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.clearedCallSign] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun clearedCallSign(clearedCallSign: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.entryNet] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun entryNet(entryNet: JsonField<OffsetDateTime>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.entryPoint] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun entryPoint(entryPoint: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.exitNlt] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun exitNlt(exitNlt: JsonField<OffsetDateTime>) =
                    apply {
                        this.exitNlt = exitNlt
                    }
                 ...
                 *
                 * You should usually call [Builder.exitPoint] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun exitPoint(exitPoint: JsonField<String>) =
                    apply {
                        this.exitPoint = exitPoint
                    }

                /** Optional clearance ID from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID. */
                fun externalClearanceId(externalClearanceId: String) = externalClearanceId(JsonField.of(externalClearanceId))

                /**
                 * Sets [Builder.externalClearanceId] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.externalClearanceId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun externalClearanceId(externalClearanceId: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.reqPoint] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun reqPoint(reqPoint: JsonField<Boolean>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.sequenceNum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun sequenceNum(sequenceNum: JsonField<Int>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.validDesc] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun validDesc(validDesc: JsonField<String>) =
                    apply {
                        this.validDesc = validDesc
                    }

                /** The end time of the validity of this diplomatic clearance, in ISO 8601 UTC format with millisecond precision. */
                fun validEndTime(validEndTime: OffsetDateTime) = validEndTime(JsonField.of(validEndTime))

                /**
                 * Sets [Builder.validEndTime] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.validEndTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun validEndTime(validEndTime: JsonField<OffsetDateTime>) =
                    apply {
                        this.validEndTime = validEndTime
                    }

                /** The start time of the validity of this diplomatic clearance, in ISO 8601 UTC format with millisecond precision. */
                fun validStartTime(validStartTime: OffsetDateTime) = validStartTime(JsonField.of(validStartTime))

                /**
                 * Sets [Builder.validStartTime] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.validStartTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun validStartTime(validStartTime: JsonField<OffsetDateTime>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.windowRemark] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun windowRemark(windowRemark: JsonField<String>) =
                    apply {
            ...
            fun validate(): DiplomaticClearanceDetail =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (action.asKnown().isPresent) 1 else 0) + (if (altCountryCode.asKnown().isPresent) 1 else 0) + (if (clearanceId.asKnown().isPresent) 1 else 0) + (if (clearanceRemark.asKnown().isPresent) 1 else 0) + (if (clearedCallSign.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (if (countryName.asKnown().isPresent) 1 else 0) + (if (entryNet.asKnown().isPresent) 1 else 0) + (if (entryPoint.asKnown().isPresent) 1 else 0) + (if (exitNlt.asKnown().isPresent) 1 else 0) + (if (exitPoint.asKnown().isPresent) 1 else 0) + (if (externalClearanceId.asKnown().isPresent) 1 else 0) + (if (idSortie.asKnown().isPresent) 1 else 0) + (if (legNum.asKnown().isPresent) 1 else 0) + (if (profile.asKnown().isPresent) 1 else 0) + (if (reqIcao.asKnown().isPresent) 1 else 0) + (if (reqPoint.asKnown().isPresent) 1 else 0) + (if (routeString.asKnown().isPresent) 1 else 0) + (if (sequenceNum.asKnown().isPresent) 1 else 0) + (if (status.asKnown().isPresent) 1 else 0) + (if (validDesc.asKnown().isPresent) 1 else 0) + (if (validEndTime.asKnown().isPresent) 1 else 0) + (if (validStartTime.asKnown().isPresent) 1 else 0) + (if (windowRemark.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() = "DiplomaticClearanceDetail{action=$action, altCountryCode=$altCountryCode, clearanceId=$clearanceId, clearanceRemark=$clearanceRemark, clearedCallSign=$clearedCallSign, countryCode=$countryCode, countryName=$countryName, entryNet=$entryNet, entryPoint=$entryPoint, exitNlt=$exitNlt, exitPoint=$exitPoint, externalClearanceId=$externalClearanceId, idSortie=$idSortie, legNum=$legNum, profile=$profile, reqIcao=$reqIcao, reqPoint=$reqPoint, routeString=$routeString, sequenceNum=$sequenceNum, status=$status, validDesc=$validDesc, validEndTime=$validEndTime, validStartTime=$validStartTime, windowRemark=$windowRemark, additionalProperties=$additionalProperties}"
        }

        /** Collection of diplomatic clearance remarks. */
        class DiplomaticClearanceRemark private constructor(
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [DiplomaticClearanceRemark]. */
                @JvmStatic
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(diplomaticClearanceRemark: DiplomaticClearanceRemark) =
                    apply {
                        ...
                        additionalProperties = diplomaticClearanceRemark.additionalProperties.toMutableMap()
                    }
            ...
            fun validate(): DiplomaticClearanceRemark =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (date.asKnown().isPresent) 1 else 0) + (if (gdssRemarkId.asKnown().isPresent) 1 else 0) + (if (text.asKnown().isPresent) 1 else 0) + (if (user.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() = "DiplomaticClearanceRemark{date=$date, gdssRemarkId=$gdssRemarkId, text=$text, user=$user, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && firstDepDate == other.firstDepDate && idMission == other.idMission && source == other.source && id == other.id && apacsId == other.apacsId && createdAt == other.createdAt && createdBy == other.createdBy && diplomaticClearanceDetails == other.diplomaticClearanceDetails && diplomaticClearanceRemarks == other.diplomaticClearanceRemarks && dipWorksheetName == other.dipWorksheetName && docDeadline == other.docDeadline && externalWorksheetId == other.externalWorksheetId && origin == other.origin && origNetwork == other.origNetwork && sourceDl == other.sourceDl && updatedAt == other.updatedAt && updatedBy == other.updatedBy /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, firstDepDate, idMission, source, id, apacsId, createdAt, createdBy, diplomaticClearanceDetails, diplomaticClearanceRemarks, dipWorksheetName, docDeadline, externalWorksheetId, origin, origNetwork, sourceDl, updatedAt, updatedBy) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, firstDepDate=$firstDepDate, idMission=$idMission, source=$source, id=$id, apacsId=$apacsId, createdAt=$createdAt, createdBy=$createdBy, diplomaticClearanceDetails=$diplomaticClearanceDetails, diplomaticClearanceRemarks=$diplomaticClearanceRemarks, dipWorksheetName=$dipWorksheetName, docDeadline=$docDeadline, externalWorksheetId=$externalWorksheetId, origin=$origin, origNetwork=$origNetwork, sourceDl=$sourceDl, updatedAt=$updatedAt, updatedBy=$updatedBy}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is DiplomaticClearanceUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "DiplomaticClearanceUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
