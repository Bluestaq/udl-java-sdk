...
class EntityListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityListParams: EntityListParams) =
            apply {
                firstResult = entityListParams.firstResult
                maxResults = entityListParams.maxResults
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EntityListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EntityListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
