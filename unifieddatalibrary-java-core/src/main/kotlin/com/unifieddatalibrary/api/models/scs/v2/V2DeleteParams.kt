...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V2DeleteParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v2DeleteParams: V2DeleteParams) = apply {
            path = v2DeleteParams.path
            additionalHeaders = v2DeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = v2DeleteParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = v2DeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [V2DeleteParams].
         *
