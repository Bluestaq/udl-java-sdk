...
class AirEventTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirEventTupleParams].
         *
    ...
    /** A builder for [AirEventTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventTupleParams: AirEventTupleParams) =
            apply {
                columns = airEventTupleParams.columns
                firstResult = airEventTupleParams.firstResult
                maxResults = airEventTupleParams.maxResults
                additionalHeaders = airEventTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = airEventTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirEventTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirEventTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirEventTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
