 ...
 */
class DeconflictsetCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeconflictsetCountParams].
         *
    ...
    /** A builder for [DeconflictsetCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deconflictsetCountParams: DeconflictsetCountParams) = apply {
            eventStartTime = deconflictsetCountParams.eventStartTime
            firstResult = deconflictsetCountParams.firstResult
            maxResults = deconflictsetCountParams.maxResults
            additionalHeaders = deconflictsetCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = deconflictsetCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DeconflictsetCountParams].
         *
         ...
         */
        fun build(): DeconflictsetCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeconflictsetCountParams &&
    ...
    override fun toString() =
        "DeconflictsetCountParams{eventStartTime=$eventStartTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
