...
package com.unifieddatalibrary.api.models.scsviews
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ScsViewRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ScsViewRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ScsViewRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scsViewRetrieveParams: ScsViewRetrieveParams) = apply {
            id = scsViewRetrieveParams.id
            firstResult = scsViewRetrieveParams.firstResult
            maxResults = scsViewRetrieveParams.maxResults
            additionalHeaders = scsViewRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = scsViewRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ScsViewRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScsViewRetrieveParams =
            ScsViewRetrieveParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ScsViewRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ScsViewRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
