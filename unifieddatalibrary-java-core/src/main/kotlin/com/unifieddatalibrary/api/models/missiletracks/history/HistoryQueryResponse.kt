...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyQueryResponse: HistoryQueryResponse) = apply {
            ...
            acftSubType = historyQueryResponse.acftSubType
            alert = historyQueryResponse.alert
            angElev = historyQueryResponse.angElev
            aouRptData = historyQueryResponse.aouRptData.map { it.toMutableList() }
            aouRptType = historyQueryResponse.aouRptType
            azCorr = historyQueryResponse.azCorr
            boosting = historyQueryResponse.boosting
            ...
            mslStatus = historyQueryResponse.mslStatus
            muidSrc = historyQueryResponse.muidSrc
            muidSrcTrk = historyQueryResponse.muidSrcTrk
            name = historyQueryResponse.name
            objAct = historyQueryResponse.objAct
            objIdent = historyQueryResponse.objIdent
            objPlat = historyQueryResponse.objPlat
            objType = historyQueryResponse.objType
            objTypeConf = historyQueryResponse.objTypeConf
            origin = historyQueryResponse.origin
            origNetwork = historyQueryResponse.origNetwork
            parentTrackId = historyQueryResponse.parentTrackId
            polarSingLocLat = historyQueryResponse.polarSingLocLat
            polarSingLocLon = historyQueryResponse.polarSingLocLon
            senMode = historyQueryResponse.senMode
            spaceAmp = historyQueryResponse.spaceAmp
            spaceAmpConf = historyQueryResponse.spaceAmpConf
            spaceSpecType = historyQueryResponse.spaceSpecType
            trackId = historyQueryResponse.trackId
            trkConf = historyQueryResponse.trkConf
            trkQual = historyQueryResponse.trkQual
            vectors = historyQueryResponse.vectors.map { it.toMutableList() }
