...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LinkStatusListResponse].
         *
    ...
    /** A builder for [LinkStatusListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(linkStatusListResponse: LinkStatusListResponse) = apply {
            classificationMarking = linkStatusListResponse.classificationMarking
            dataMode = linkStatusListResponse.dataMode
            endPoint1Lat = linkStatusListResponse.endPoint1Lat
            endPoint1Lon = linkStatusListResponse.endPoint1Lon
            endPoint1Name = linkStatusListResponse.endPoint1Name
            endPoint2Lat = linkStatusListResponse.endPoint2Lat
            endPoint2Lon = linkStatusListResponse.endPoint2Lon
            endPoint2Name = linkStatusListResponse.endPoint2Name
            linkName = linkStatusListResponse.linkName
            linkStartTime = linkStatusListResponse.linkStartTime
            linkStopTime = linkStatusListResponse.linkStopTime
            source = linkStatusListResponse.source
            id = linkStatusListResponse.id
            band = linkStatusListResponse.band
            constellation = linkStatusListResponse.constellation
            createdAt = linkStatusListResponse.createdAt
            createdBy = linkStatusListResponse.createdBy
            dataRate1To2 = linkStatusListResponse.dataRate1To2
            dataRate2To1 = linkStatusListResponse.dataRate2To1
            idBeam1 = linkStatusListResponse.idBeam1
            idBeam2 = linkStatusListResponse.idBeam2
            idOnOrbit1 = linkStatusListResponse.idOnOrbit1
            idOnOrbit2 = linkStatusListResponse.idOnOrbit2
            linkState = linkStatusListResponse.linkState
            linkType = linkStatusListResponse.linkType
            opsCap = linkStatusListResponse.opsCap
            origin = linkStatusListResponse.origin
            origNetwork = linkStatusListResponse.origNetwork
            satNo1 = linkStatusListResponse.satNo1
            satNo2 = linkStatusListResponse.satNo2
            sysCap = linkStatusListResponse.sysCap
            additionalProperties = linkStatusListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LinkStatusListResponse].
         *
         ...
         */
        fun build(): LinkStatusListResponse =
    ...
    fun validate(): LinkStatusListResponse = apply {
        if (validated) {
            return@apply
        }
