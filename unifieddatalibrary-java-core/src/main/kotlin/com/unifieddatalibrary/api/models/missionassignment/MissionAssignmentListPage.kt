...
class MissionAssignmentListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentListPage: MissionAssignmentListPage) =
            apply {
        ...
        fun service(service: MissionAssignmentService) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: MissionAssignmentListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<MissionAssignmentListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MissionAssignmentListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, params, items) /* spotless:on */

    override fun toString() = "MissionAssignmentListPage{service=$service, params=$params, items=$items}"
}
