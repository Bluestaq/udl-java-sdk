...
class OrbitdeterminationListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<OrbitdeterminationListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbitdeterminationListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        fun service(service: OrbitdeterminationServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: OrbitdeterminationListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<OrbitdeterminationListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "OrbitdeterminationListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
