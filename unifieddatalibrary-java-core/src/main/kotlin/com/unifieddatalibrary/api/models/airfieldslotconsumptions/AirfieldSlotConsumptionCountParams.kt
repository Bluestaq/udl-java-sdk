 ...
 */
class AirfieldSlotConsumptionCountParams
private constructor(
    ...
    /** A builder for [AirfieldSlotConsumptionCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotConsumptionCountParams: AirfieldSlotConsumptionCountParams) =
            apply {
                startTime = airfieldSlotConsumptionCountParams.startTime
                firstResult = airfieldSlotConsumptionCountParams.firstResult
                maxResults = airfieldSlotConsumptionCountParams.maxResults
                additionalHeaders = airfieldSlotConsumptionCountParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    airfieldSlotConsumptionCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldSlotConsumptionCountParams].
         *
         ...
         */
        fun build(): AirfieldSlotConsumptionCountParams =
            AirfieldSlotConsumptionCountParams(
