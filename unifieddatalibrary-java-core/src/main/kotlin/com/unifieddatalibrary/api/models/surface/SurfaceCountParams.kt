...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SurfaceCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceCountParams: SurfaceCountParams) = apply {
    ...
    override fun toString() =
        "SurfaceCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
