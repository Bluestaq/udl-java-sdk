...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitantennaListPage: OnorbitantennaListPage) = apply {
            service = onorbitantennaListPage.service
            params = onorbitantennaListPage.params
            items = onorbitantennaListPage.items
        }

        fun service(service: OnorbitantennaService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitantennaListPage &&
    ...
    override fun toString() =
        "OnorbitantennaListPage{service=$service, params=$params, items=$items}"
}
