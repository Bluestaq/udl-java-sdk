...
class BeamAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BeamAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamAbridged: BeamAbridged) =
            apply {
                beamName = beamAbridged.beamName
                classificationMarking = beamAbridged.classificationMarking
                dataMode = beamAbridged.dataMode
                source = beamAbridged.source
                id = beamAbridged.id
                createdAt = beamAbridged.createdAt
                createdBy = beamAbridged.createdBy
                notes = beamAbridged.notes
                origin = beamAbridged.origin
                origNetwork = beamAbridged.origNetwork
                additionalProperties = beamAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BeamAbridged].
         *
    ...
    override fun toString() = "BeamAbridged{beamName=$beamName, classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, notes=$notes, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
