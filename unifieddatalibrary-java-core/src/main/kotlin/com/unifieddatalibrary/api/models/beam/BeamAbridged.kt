...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamAbridged: BeamAbridged) = apply {
    ...
    fun validate(): BeamAbridged = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "BeamAbridged{beamName=$beamName, classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, notes=$notes, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
