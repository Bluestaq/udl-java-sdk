...
class LaunchVehicleListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchVehicleListResponse].
         *
    ...
    /** A builder for [LaunchVehicleListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleListResponse: LaunchVehicleListResponse) =
            apply {
                classificationMarking = launchVehicleListResponse.classificationMarking
                dataMode = launchVehicleListResponse.dataMode
                name = launchVehicleListResponse.name
                source = launchVehicleListResponse.source
                id = launchVehicleListResponse.id
                createdAt = launchVehicleListResponse.createdAt
                createdBy = launchVehicleListResponse.createdBy
                origin = launchVehicleListResponse.origin
                origNetwork = launchVehicleListResponse.origNetwork
                type = launchVehicleListResponse.type
                additionalProperties = launchVehicleListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchVehicleListResponse].
         *
         ...
         */
        fun build(): LaunchVehicleListResponse =
    ...
    fun validate(): LaunchVehicleListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "LaunchVehicleListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, type=$type, additionalProperties=$additionalProperties}"
}
