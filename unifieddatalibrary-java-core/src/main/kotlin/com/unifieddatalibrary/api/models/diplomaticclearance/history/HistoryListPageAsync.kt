...
package com.unifieddatalibrary.api.models.diplomaticclearance.history
...
private constructor(
    ...
    private val items: List<DiplomaticclearanceFull>,
) : PageAsync<DiplomaticclearanceFull> {
    ...
    fun autoPager(): AutoPagerAsync<DiplomaticclearanceFull> =
    ...
    override fun items(): List<DiplomaticclearanceFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<DiplomaticclearanceFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<DiplomaticclearanceFull>) = apply { this.items = items }
