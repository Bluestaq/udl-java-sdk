...
/**
 * Service operation to dynamically query/filter current elsets within the system by a variety of
 * query parameters not specified in this API documentation. A current elset is the currently
