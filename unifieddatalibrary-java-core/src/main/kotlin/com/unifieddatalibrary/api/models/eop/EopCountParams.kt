...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EopCountParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopCountParams: EopCountParams) = apply {
            eopDate = eopCountParams.eopDate
            firstResult = eopCountParams.firstResult
            maxResults = eopCountParams.maxResults
            additionalHeaders = eopCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = eopCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EopCountParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EopCountParams && eopDate == other.eopDate && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "EopCountParams{eopDate=$eopDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
