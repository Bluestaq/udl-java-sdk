 ...
 * team for assistance.
 */
class ObscorrelationCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun corrType(): CorrType = body.corrType()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun msgTs(): OffsetDateTime = body.msgTs()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun referenceOrbitId(): String = body.referenceOrbitId()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun referenceOrbitType(): ReferenceOrbitType = body.referenceOrbitType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun algorithmCorrType(): Optional<String> = body.algorithmCorrType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun altCatalog(): Optional<String> = body.altCatalog()
     ...
     *   if the server responded with an unexpected value).
     */
    fun altNamespace(): Optional<String> = body.altNamespace()
     ...
     *   if the server responded with an unexpected value).
     */
    fun altObjectId(): Optional<String> = body.altObjectId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun altUct(): Optional<Boolean> = body.altUct()
     ...
     *   if the server responded with an unexpected value).
     */
    fun astat(): Optional<Long> = body.astat()
     ...
     *   if the server responded with an unexpected value).
     */
    fun idParentCorrelation(): Optional<String> = body.idParentCorrelation()
     ...
     */
    fun _corrType(): JsonField<CorrType> = body._corrType()
     ...
     */
    fun _msgTs(): JsonField<OffsetDateTime> = body._msgTs()
     ...
     */
    fun _obId(): JsonField<String> = body._obId()
     ...
     */
    fun _obType(): JsonField<ObType> = body._obType()
     ...
     * type.
     */
    fun _referenceOrbitId(): JsonField<String> = body._referenceOrbitId()
     ...
     * type.
     */
    fun _referenceOrbitType(): JsonField<ReferenceOrbitType> = body._referenceOrbitType()
     ...
     * type.
     */
    fun _algorithmCorrType(): JsonField<String> = body._algorithmCorrType()
     ...
     */
    fun _altCatalog(): JsonField<String> = body._altCatalog()
     ...
     */
    fun _altNamespace(): JsonField<String> = body._altNamespace()
     ...
     */
    fun _altObjectId(): JsonField<String> = body._altObjectId()
     ...
     */
    fun _altUct(): JsonField<Boolean> = body._altUct()
     ...
     */
    fun _astat(): JsonField<Long> = body._astat()
     ...
     * type.
     */
    fun _idParentCorrelation(): JsonField<String> = body._idParentCorrelation()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObscorrelationCreateParams].
         *
    ...
    /** A builder for [ObscorrelationCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(obscorrelationCreateParams: ObscorrelationCreateParams) = apply {
            body = obscorrelationCreateParams.body.toBuilder()
            additionalHeaders = obscorrelationCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = obscorrelationCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun corrType(corrType: CorrType) = apply { body.corrType(corrType) }
         ...
         * value.
         */
        fun corrType(corrType: JsonField<CorrType>) = apply { body.corrType(corrType) }
         ...
         * Correlation message generation time, in ISO 8601 UTC format with millisecond precision.
         */
        fun msgTs(msgTs: OffsetDateTime) = apply { body.msgTs(msgTs) }
         ...
         * value.
         */
        fun msgTs(msgTs: JsonField<OffsetDateTime>) = apply { body.msgTs(msgTs) }
         ...
         */
        fun obId(obId: String) = apply { body.obId(obId) }
         ...
         */
        fun obId(obId: JsonField<String>) = apply { body.obId(obId) }
         ...
         * Set.
         */
        fun obType(obType: ObType) = apply { body.obType(obType) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun obType(obType: JsonField<ObType>) = apply { body.obType(obType) }

        /** Identifier of the orbit state used for correlation. */
        fun referenceOrbitId(referenceOrbitId: String) = apply {
            body.referenceOrbitId(referenceOrbitId)
        }
         ...
         */
        fun referenceOrbitType(referenceOrbitType: ReferenceOrbitType) = apply {
            body.referenceOrbitType(referenceOrbitType)
        }
         ...
         */
        fun algorithmCorrType(algorithmCorrType: String) = apply {
            body.algorithmCorrType(algorithmCorrType)
        }
        ...
        /** Name of the alternate catalog. */
        fun altCatalog(altCatalog: String) = apply { body.altCatalog(altCatalog) }
         ...
         * value.
         */
        fun altCatalog(altCatalog: JsonField<String>) = apply { body.altCatalog(altCatalog) }
         ...
         */
        fun altNamespace(altNamespace: String) = apply { body.altNamespace(altNamespace) }
        ...
        fun altNamespace(altNamespace: JsonField<String>) = apply {
            body.altNamespace(altNamespace)
        }

        /** Alternate unique object ID within the namespace. */
        fun altObjectId(altObjectId: String) = apply { body.altObjectId(altObjectId) }
         ...
         * value.
         */
        fun altObjectId(altObjectId: JsonField<String>) = apply { body.altObjectId(altObjectId) }
         ...
         */
        fun altUct(altUct: Boolean) = apply { body.altUct(altUct) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun astat(astat: JsonField<Long>) = apply { body.astat(astat) }
         ...
         * correlation and maintain traceability back to the original correlation.
         */
        fun idParentCorrelation(idParentCorrelation: String) = apply {
            body.idParentCorrelation(idParentCorrelation)
        }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationCreateParams].
         *
         ...
         */
        fun build(): ObscorrelationCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ObscorrelationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
