...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ManifoldCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldCountParams: ManifoldCountParams) = apply {
    ...
    override fun toString() =
        "ManifoldCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
