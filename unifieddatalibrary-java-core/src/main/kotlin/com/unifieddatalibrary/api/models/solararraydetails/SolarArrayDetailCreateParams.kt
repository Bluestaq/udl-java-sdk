...
/**
 * Service operation to take a single SolarArrayDetails as a POST body and ingest into the database.
 ...
 */
class SolarArrayDetailCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SolarArrayDetailCreateParams].
         *
    ...
    /** A builder for [SolarArrayDetailCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayDetailCreateParams: SolarArrayDetailCreateParams) = apply {
            body = solarArrayDetailCreateParams.body.toBuilder()
            additionalHeaders = solarArrayDetailCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = solarArrayDetailCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SolarArrayDetailCreateParams].
         *
         ...
         */
        fun build(): SolarArrayDetailCreateParams =
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idSolarArray == other.idSolarArray && source == other.source && id == other.id && area == other.area && createdAt == other.createdAt && createdBy == other.createdBy && description == other.description && junctionTechnology == other.junctionTechnology && manufacturerOrgId == other.manufacturerOrgId && origin == other.origin && origNetwork == other.origNetwork && span == other.span && tags == other.tags && technology == other.technology && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idSolarArray, source, id, area, createdAt, createdBy, description, junctionTechnology, manufacturerOrgId, origin, origNetwork, span, tags, technology, type, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idSolarArray=$idSolarArray, source=$source, id=$id, area=$area, createdAt=$createdAt, createdBy=$createdBy, description=$description, junctionTechnology=$junctionTechnology, manufacturerOrgId=$manufacturerOrgId, origin=$origin, origNetwork=$origNetwork, span=$span, tags=$tags, technology=$technology, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SolarArrayDetailCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SolarArrayDetailCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
