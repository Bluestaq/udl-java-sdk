...
class SiteStatusGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SiteStatusGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SiteStatusGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SiteStatusGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusGetParams: SiteStatusGetParams) =
            apply {
                id = siteStatusGetParams.id
                firstResult = siteStatusGetParams.firstResult
                maxResults = siteStatusGetParams.maxResults
                additionalHeaders = siteStatusGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = siteStatusGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SiteStatusGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SiteStatusGetParams =
            SiteStatusGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteStatusGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SiteStatusGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
