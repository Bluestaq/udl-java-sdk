...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteStatusGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusGetParams: SiteStatusGetParams) = apply {
    ...
    override fun toString() =
        "SiteStatusGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
