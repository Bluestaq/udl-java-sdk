...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConjunctionTupleParams].
         *
    ...
    /** A builder for [ConjunctionTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conjunctionTupleParams: ConjunctionTupleParams) = apply {
            columns = conjunctionTupleParams.columns
            tca = conjunctionTupleParams.tca
            firstResult = conjunctionTupleParams.firstResult
            maxResults = conjunctionTupleParams.maxResults
            additionalHeaders = conjunctionTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = conjunctionTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ConjunctionTupleParams].
         *
         ...
         */
        fun build(): ConjunctionTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConjunctionTupleParams && columns == other.columns && tca == other.tca && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, tca, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ConjunctionTupleParams{columns=$columns, tca=$tca, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
