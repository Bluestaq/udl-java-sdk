...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(historyQueryParams: HistoryQueryParams) = apply {
    ...
    override fun toString() =
        "HistoryQueryParams{ts=$ts, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
