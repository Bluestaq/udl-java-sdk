 ...
 */
class SeradataSigintPayloadCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataSigintPayloadCountParams = builder().build()
        ...
        internal fun from(seradataSigintPayloadCountParams: SeradataSigintPayloadCountParams) =
            apply {
                ...
                additionalQueryParams =
                    seradataSigintPayloadCountParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "SeradataSigintPayloadCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
