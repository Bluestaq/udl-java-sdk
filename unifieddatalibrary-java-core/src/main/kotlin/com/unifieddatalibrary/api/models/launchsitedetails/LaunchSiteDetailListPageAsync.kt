...
class LaunchSiteDetailListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<LaunchSiteDetailListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteDetailListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteDetailListPageAsync: LaunchSiteDetailListPageAsync) =
            apply {
        ...
        fun service(service: LaunchSiteDetailServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchSiteDetailListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, streamHandlerExecutor, params, items) /* spotless:on */

    override fun toString() = "LaunchSiteDetailListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
