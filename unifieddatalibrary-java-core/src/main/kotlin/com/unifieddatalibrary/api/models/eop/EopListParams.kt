...
class EopListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EopListParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopListParams: EopListParams) =
            apply {
                eopDate = eopListParams.eopDate
                firstResult = eopListParams.firstResult
                maxResults = eopListParams.maxResults
                additionalHeaders = eopListParams.additionalHeaders.toBuilder()
                additionalQueryParams = eopListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EopListParams].
         *
    ...
    override fun toString() = "EopListParams{eopDate=$eopDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
