 ...
 */
class TrackRouteTupleParams
private constructor(
    private val columns: String,
    private val lastUpdateDate: OffsetDateTime,
     ...
     */
    fun lastUpdateDate(): OffsetDateTime = lastUpdateDate
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackRouteTupleParams].
         *
    ...
    /** A builder for [TrackRouteTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackRouteTupleParams: TrackRouteTupleParams) = apply {
            columns = trackRouteTupleParams.columns
            lastUpdateDate = trackRouteTupleParams.lastUpdateDate
            firstResult = trackRouteTupleParams.firstResult
            maxResults = trackRouteTupleParams.maxResults
            additionalHeaders = trackRouteTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = trackRouteTupleParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun lastUpdateDate(lastUpdateDate: OffsetDateTime) = apply {
        ...
        /**
         * Returns an immutable instance of [TrackRouteTupleParams].
         *
         ...
         */
        fun build(): TrackRouteTupleParams =
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("columns", columns)
                put("lastUpdateDate", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(lastUpdateDate))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackRouteTupleParams && columns == other.columns && lastUpdateDate == other.lastUpdateDate && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, lastUpdateDate, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "TrackRouteTupleParams{columns=$columns, lastUpdateDate=$lastUpdateDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
