...
class AirfieldQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldQueryhelpResponse: AirfieldQueryhelpResponse) = apply {
    ...
    fun validate(): AirfieldQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
