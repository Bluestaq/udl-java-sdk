...
class AirfieldQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AirfieldQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirfieldQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldQueryhelpResponse: AirfieldQueryhelpResponse) =
            apply {
                aodrSupported = airfieldQueryhelpResponse.aodrSupported
                classificationMarking = airfieldQueryhelpResponse.classificationMarking
                description = airfieldQueryhelpResponse.description
                historySupported = airfieldQueryhelpResponse.historySupported
                name = airfieldQueryhelpResponse.name
                parameters = airfieldQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = airfieldQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = airfieldQueryhelpResponse.restSupported
                sortSupported = airfieldQueryhelpResponse.sortSupported
                typeName = airfieldQueryhelpResponse.typeName
                uri = airfieldQueryhelpResponse.uri
                additionalProperties = airfieldQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldQueryhelpResponse =
    ...
    fun validate(): AirfieldQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirfieldQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
