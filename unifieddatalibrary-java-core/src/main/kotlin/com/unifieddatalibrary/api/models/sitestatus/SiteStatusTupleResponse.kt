...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusTupleResponse: SiteStatusTupleResponse) = apply {
    ...
    fun validate(): SiteStatusTupleResponse = apply {
        if (validated) {
            return@apply
        }
