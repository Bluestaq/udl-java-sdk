...
class DropzoneQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DropzoneQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [DropzoneQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneQueryHelpResponse: DropzoneQueryHelpResponse) =
            apply {
                aodrSupported = dropzoneQueryHelpResponse.aodrSupported
                classificationMarking = dropzoneQueryHelpResponse.classificationMarking
                description = dropzoneQueryHelpResponse.description
                historySupported = dropzoneQueryHelpResponse.historySupported
                name = dropzoneQueryHelpResponse.name
                parameters = dropzoneQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = dropzoneQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = dropzoneQueryHelpResponse.restSupported
                sortSupported = dropzoneQueryHelpResponse.sortSupported
                typeName = dropzoneQueryHelpResponse.typeName
                uri = dropzoneQueryHelpResponse.uri
                additionalProperties = dropzoneQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DropzoneQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DropzoneQueryHelpResponse =
    ...
    fun validate(): DropzoneQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is DropzoneQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
