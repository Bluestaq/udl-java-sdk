...
class DropzoneQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneQueryHelpResponse: DropzoneQueryHelpResponse) = apply {
    ...
    fun validate(): DropzoneQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
