...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portQueryhelpResponse: PortQueryhelpResponse) = apply {
    ...
    fun validate(): PortQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
