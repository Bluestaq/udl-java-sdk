...
class PortQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PortQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [PortQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portQueryhelpResponse: PortQueryhelpResponse) =
            apply {
                aodrSupported = portQueryhelpResponse.aodrSupported
                classificationMarking = portQueryhelpResponse.classificationMarking
                description = portQueryhelpResponse.description
                historySupported = portQueryhelpResponse.historySupported
                name = portQueryhelpResponse.name
                parameters = portQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = portQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = portQueryhelpResponse.restSupported
                sortSupported = portQueryhelpResponse.sortSupported
                typeName = portQueryhelpResponse.typeName
                uri = portQueryhelpResponse.uri
                additionalProperties = portQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PortQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortQueryhelpResponse =
    ...
    fun validate(): PortQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PortQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
