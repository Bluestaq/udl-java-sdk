...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirspacecontrolorderFull].
         *
    ...
    /** A builder for [AirspacecontrolorderFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airspacecontrolorderFull: AirspacecontrolorderFull) = apply {
            classificationMarking = airspacecontrolorderFull.classificationMarking
            dataMode = airspacecontrolorderFull.dataMode
            opExName = airspacecontrolorderFull.opExName
            originator = airspacecontrolorderFull.originator
            source = airspacecontrolorderFull.source
            startTime = airspacecontrolorderFull.startTime
            id = airspacecontrolorderFull.id
            acoComments = airspacecontrolorderFull.acoComments
            acoSerialNum = airspacecontrolorderFull.acoSerialNum
            airspaceControlMeansStatus =
                airspacecontrolorderFull.airspaceControlMeansStatus.map { it.toMutableList() }
            airspaceControlOrderReferences =
                airspacecontrolorderFull.airspaceControlOrderReferences.map { it.toMutableList() }
            areaOfValidity = airspacecontrolorderFull.areaOfValidity
            classReasons = airspacecontrolorderFull.classReasons.map { it.toMutableList() }
            classSource = airspacecontrolorderFull.classSource
            createdAt = airspacecontrolorderFull.createdAt
            createdBy = airspacecontrolorderFull.createdBy
            declassExemptionCodes =
                airspacecontrolorderFull.declassExemptionCodes.map { it.toMutableList() }
            downgradeInsDates =
                airspacecontrolorderFull.downgradeInsDates.map { it.toMutableList() }
            geoDatum = airspacecontrolorderFull.geoDatum
            month = airspacecontrolorderFull.month
            opExInfo = airspacecontrolorderFull.opExInfo
            opExInfoAlt = airspacecontrolorderFull.opExInfoAlt
            origin = airspacecontrolorderFull.origin
            origNetwork = airspacecontrolorderFull.origNetwork
            planOrigNum = airspacecontrolorderFull.planOrigNum
            qualifier = airspacecontrolorderFull.qualifier
            qualSn = airspacecontrolorderFull.qualSn
            rawFileUri = airspacecontrolorderFull.rawFileUri
            serialNum = airspacecontrolorderFull.serialNum
            sourceDl = airspacecontrolorderFull.sourceDl
            stopQualifier = airspacecontrolorderFull.stopQualifier
            stopTime = airspacecontrolorderFull.stopTime
            undLnkTrks = airspacecontrolorderFull.undLnkTrks.map { it.toMutableList() }
            additionalProperties = airspacecontrolorderFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AirspacecontrolorderFull].
         *
         ...
         */
        fun build(): AirspacecontrolorderFull =
    ...
    fun validate(): AirspacecontrolorderFull = apply {
        if (validated) {
            return@apply
        }
