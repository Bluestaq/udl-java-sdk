...
class HistoryRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): HistoryRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyRetrieveParams: HistoryRetrieveParams) =
            apply {
                ...
                endTime = historyRetrieveParams.endTime
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is HistoryRetrieveParams && columns == other.columns && endTime == other.endTime && firstResult == other.firstResult && maxResults == other.maxResults && startTime == other.startTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "HistoryRetrieveParams{columns=$columns, endTime=$endTime, firstResult=$firstResult, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
