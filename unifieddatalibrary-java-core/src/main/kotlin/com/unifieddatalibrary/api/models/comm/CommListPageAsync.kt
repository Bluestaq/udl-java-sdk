...
private constructor(
    ...
    fun autoPager(): AutoPagerAsync<CommAbridged> = AutoPagerAsync.from(this, streamHandlerExecutor)
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commListPageAsync: CommListPageAsync) = apply {
        ...
        fun service(service: CommServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommListPageAsync &&
    ...
    override fun toString() =
        "CommListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
