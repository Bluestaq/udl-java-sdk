...
class GroundImageryTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GroundImageryTupleParams].
         *
    ...
    /** A builder for [GroundImageryTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryTupleParams: GroundImageryTupleParams) =
            apply {
                columns = groundImageryTupleParams.columns
                imageTime = groundImageryTupleParams.imageTime
                firstResult = groundImageryTupleParams.firstResult
                maxResults = groundImageryTupleParams.maxResults
                additionalHeaders = groundImageryTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = groundImageryTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GroundImageryTupleParams].
         *
         ...
         */
        fun build(): GroundImageryTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GroundImageryTupleParams && columns == other.columns && imageTime == other.imageTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, imageTime, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "GroundImageryTupleParams{columns=$columns, imageTime=$imageTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
