...
private constructor(
    ...
    private val items: List<SoiObservationSetFull>,
) : Page<SoiObservationSetFull> {
    ...
    fun autoPager(): AutoPager<SoiObservationSetFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<SoiObservationSetFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<SoiObservationSetFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<SoiObservationSetFull>) = apply { this.items = items }
