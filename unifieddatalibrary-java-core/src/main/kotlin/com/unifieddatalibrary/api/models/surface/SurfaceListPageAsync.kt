...
class SurfaceListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<SurfaceListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceListPageAsync: SurfaceListPageAsync) =
            apply {
        ...
        fun service(service: SurfaceServiceAsync) =
            apply {
    ...
    override fun toString() = "SurfaceListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
