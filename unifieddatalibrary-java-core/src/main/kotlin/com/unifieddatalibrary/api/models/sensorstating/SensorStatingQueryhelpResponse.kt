...
class SensorStatingQueryhelpResponse
...
private constructor(
    ...
    /** A builder for [SensorStatingQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorStatingQueryhelpResponse: SensorStatingQueryhelpResponse) = apply {
            aodrSupported = sensorStatingQueryhelpResponse.aodrSupported
            classificationMarking = sensorStatingQueryhelpResponse.classificationMarking
            description = sensorStatingQueryhelpResponse.description
            historySupported = sensorStatingQueryhelpResponse.historySupported
            name = sensorStatingQueryhelpResponse.name
            parameters = sensorStatingQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = sensorStatingQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = sensorStatingQueryhelpResponse.restSupported
            sortSupported = sensorStatingQueryhelpResponse.sortSupported
            typeName = sensorStatingQueryhelpResponse.typeName
            uri = sensorStatingQueryhelpResponse.uri
            additionalProperties =
                sensorStatingQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SensorStatingQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorStatingQueryhelpResponse =
            SensorStatingQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): SensorStatingQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorStatingQueryhelpResponse &&
