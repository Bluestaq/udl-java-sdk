 ...
 * parameter.
 */
class LaunchDetectionGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchDetectionGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionGetParams: LaunchDetectionGetParams) = apply {
    ...
    override fun toString() =
        "LaunchDetectionGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
