...
/**
 * Service operation to take multiple SensorMaintenance as a POST body and ingest into the database.
 * A specific role is required to perform this service operation. Please contact the UDL team for
 * assistance.
 */
class SensorMaintenanceCreateBulkParams
private constructor(
    ...
    /** A builder for [SensorMaintenanceCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceCreateBulkParams: SensorMaintenanceCreateBulkParams) =
            apply {
                origin = sensorMaintenanceCreateBulkParams.origin
                source = sensorMaintenanceCreateBulkParams.source
                body = sensorMaintenanceCreateBulkParams.body.toMutableList()
                additionalHeaders = sensorMaintenanceCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    sensorMaintenanceCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SensorMaintenanceCreateBulkParams].
         *
         ...
         */
        fun build(): SensorMaintenanceCreateBulkParams =
            SensorMaintenanceCreateBulkParams(
                origin,
                source,
    ...
    private constructor(
         ...
         *
         * Unlike [impactedFaces], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [inactiveDate], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("inactiveDate")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                impactedFaces = body.impactedFaces
                inactiveDate = body.inactiveDate
                lineNumber = body.lineNumber
                mdOpsCap = body.mdOpsCap
                mwOpsCap = body.mwOpsCap
                origin = body.origin
            ...
            /**
             * The site to which this item applies. NOTE - this site code is COLT specific and may
             * not identically correspond to other UDL site IDs.
             */
             ...
             *
             * You should usually call [Builder.approver] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.changer] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.eowId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.equipStatus] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun equipStatus(equipStatus: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.impactedFaces] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** The date that this item became inactive in ISO8601 UTC format. */
            fun inactiveDate(inactiveDate: OffsetDateTime) =
                inactiveDate(JsonField.of(inactiveDate))

            /**
             * Sets [Builder.inactiveDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.inactiveDate] with a well-typed [OffsetDateTime]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.lineNumber] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The Missile Defense operational capability of this maintenance item. Typical values
             * are G, Y, R, and - for non-applicable sites.
             */
             ...
             *
             * You should usually call [Builder.mdOpsCap] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The Missile Warning operational capability of this maintenance item. Typical values
             * are G, Y, R, and - for non-applicable sites.
             */
             ...
             *
             * You should usually call [Builder.mwOpsCap] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.recall] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.ssOpsCap] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && endTime == other.endTime && siteCode == other.siteCode && source == other.source && startTime == other.startTime && id == other.id && activity == other.activity && approver == other.approver && changer == other.changer && createdAt == other.createdAt && createdBy == other.createdBy && duration == other.duration && eowId == other.eowId && equipStatus == other.equipStatus && idSensor == other.idSensor && impactedFaces == other.impactedFaces && inactiveDate == other.inactiveDate && lineNumber == other.lineNumber && mdOpsCap == other.mdOpsCap && mwOpsCap == other.mwOpsCap && origin == other.origin && origNetwork == other.origNetwork && priority == other.priority && recall == other.recall && rel == other.rel && remark == other.remark && requestor == other.requestor && resource == other.resource && rev == other.rev && ssOpsCap == other.ssOpsCap /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, endTime, siteCode, source, startTime, id, activity, approver, changer, createdAt, createdBy, duration, eowId, equipStatus, idSensor, impactedFaces, inactiveDate, lineNumber, mdOpsCap, mwOpsCap, origin, origNetwork, priority, recall, rel, remark, requestor, resource, rev, ssOpsCap) }
        /* spotless:on */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SensorMaintenanceCreateBulkParams && origin == other.origin && source == other.source && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(origin, source, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SensorMaintenanceCreateBulkParams{origin=$origin, source=$source, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
