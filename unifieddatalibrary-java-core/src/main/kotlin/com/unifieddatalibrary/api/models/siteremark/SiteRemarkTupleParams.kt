...
class SiteRemarkTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiteRemarkTupleParams].
         *
    ...
    /** A builder for [SiteRemarkTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkTupleParams: SiteRemarkTupleParams) =
            apply {
                columns = siteRemarkTupleParams.columns
                firstResult = siteRemarkTupleParams.firstResult
                maxResults = siteRemarkTupleParams.maxResults
                additionalHeaders = siteRemarkTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = siteRemarkTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SiteRemarkTupleParams].
         *
         ...
         */
        fun build(): SiteRemarkTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteRemarkTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SiteRemarkTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
