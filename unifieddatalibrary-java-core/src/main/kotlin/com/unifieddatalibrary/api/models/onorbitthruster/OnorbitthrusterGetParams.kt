...
class OnorbitthrusterGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OnorbitthrusterGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterGetParams: OnorbitthrusterGetParams) =
            apply {
    ...
    override fun toString() = "OnorbitthrusterGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
