 ...
 * parameter. An OnorbitThruster is the association between an on-orbit spacecraft's engine and a
 * particular on-orbit spacecraft. An Engine type may be associated with many different on-orbit
 * spacecraft.
 */
class OnorbitthrusterGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitthrusterGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OnorbitthrusterGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OnorbitthrusterGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterGetParams: OnorbitthrusterGetParams) = apply {
            id = onorbitthrusterGetParams.id
            firstResult = onorbitthrusterGetParams.firstResult
            maxResults = onorbitthrusterGetParams.maxResults
            additionalHeaders = onorbitthrusterGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = onorbitthrusterGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitthrusterGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitthrusterGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OnorbitthrusterGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OnorbitthrusterGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
