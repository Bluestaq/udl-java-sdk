...
class EffectResponseCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectResponseCountParams].
         *
    ...
    /** A builder for [EffectResponseCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseCountParams: EffectResponseCountParams) =
            apply {
                createdAt = effectResponseCountParams.createdAt
                firstResult = effectResponseCountParams.firstResult
                maxResults = effectResponseCountParams.maxResults
                additionalHeaders = effectResponseCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectResponseCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectResponseCountParams].
         *
         ...
         */
        fun build(): EffectResponseCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectResponseCountParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EffectResponseCountParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
