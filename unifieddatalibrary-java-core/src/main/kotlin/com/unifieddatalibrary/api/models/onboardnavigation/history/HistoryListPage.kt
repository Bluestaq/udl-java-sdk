...
class HistoryListPage private constructor(
    ...
    private val items: List<OnboardnavigationFull>,

) : Page<OnboardnavigationFull> {
    ...
    fun autoPager(): AutoPager<OnboardnavigationFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<OnboardnavigationFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<OnboardnavigationFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<OnboardnavigationFull>) =
            apply {
                this.items = items
            }
