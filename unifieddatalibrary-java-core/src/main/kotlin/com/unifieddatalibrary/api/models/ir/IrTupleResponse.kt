...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IrTupleResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(irTupleResponse: IrTupleResponse) = apply {
            classificationMarking = irTupleResponse.classificationMarking
            dataMode = irTupleResponse.dataMode
            name = irTupleResponse.name
            source = irTupleResponse.source
            id = irTupleResponse.id
            createdAt = irTupleResponse.createdAt
            createdBy = irTupleResponse.createdBy
            description = irTupleResponse.description
            entity = irTupleResponse.entity
            idEntity = irTupleResponse.idEntity
            origin = irTupleResponse.origin
            origNetwork = irTupleResponse.origNetwork
            updatedAt = irTupleResponse.updatedAt
            updatedBy = irTupleResponse.updatedBy
            additionalProperties = irTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IrTupleResponse].
         *
    ...
    fun validate(): IrTupleResponse = apply {
        if (validated) {
            return@apply
        }
