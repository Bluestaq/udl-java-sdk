...
class StarCatalogQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogQueryhelpResponse: StarCatalogQueryhelpResponse) = apply {
    ...
    fun validate(): StarCatalogQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
