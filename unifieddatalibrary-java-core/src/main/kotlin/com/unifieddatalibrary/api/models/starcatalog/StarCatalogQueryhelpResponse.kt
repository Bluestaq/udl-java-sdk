...
class StarCatalogQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [StarCatalogQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [StarCatalogQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogQueryhelpResponse: StarCatalogQueryhelpResponse) =
            apply {
                aodrSupported = starCatalogQueryhelpResponse.aodrSupported
                classificationMarking = starCatalogQueryhelpResponse.classificationMarking
                description = starCatalogQueryhelpResponse.description
                historySupported = starCatalogQueryhelpResponse.historySupported
                name = starCatalogQueryhelpResponse.name
                parameters = starCatalogQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = starCatalogQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = starCatalogQueryhelpResponse.restSupported
                sortSupported = starCatalogQueryhelpResponse.sortSupported
                typeName = starCatalogQueryhelpResponse.typeName
                uri = starCatalogQueryhelpResponse.uri
                additionalProperties = starCatalogQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StarCatalogQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StarCatalogQueryhelpResponse =
    ...
    fun validate(): StarCatalogQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StarCatalogQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
