...
class LaunchDetectionTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchDetectionTupleResponse].
         *
    ...
    /** A builder for [LaunchDetectionTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionTupleResponse: LaunchDetectionTupleResponse) =
            apply {
                classificationMarking = launchDetectionTupleResponse.classificationMarking
                dataMode = launchDetectionTupleResponse.dataMode
                messageType = launchDetectionTupleResponse.messageType
                observationLatitude = launchDetectionTupleResponse.observationLatitude
                observationLongitude = launchDetectionTupleResponse.observationLongitude
                observationTime = launchDetectionTupleResponse.observationTime
                sequenceNumber = launchDetectionTupleResponse.sequenceNumber
                source = launchDetectionTupleResponse.source
                id = launchDetectionTupleResponse.id
                createdAt = launchDetectionTupleResponse.createdAt
                createdBy = launchDetectionTupleResponse.createdBy
                descriptor = launchDetectionTupleResponse.descriptor
                eventId = launchDetectionTupleResponse.eventId
                highZenithAzimuth = launchDetectionTupleResponse.highZenithAzimuth
                inclination = launchDetectionTupleResponse.inclination
                launchAzimuth = launchDetectionTupleResponse.launchAzimuth
                launchLatitude = launchDetectionTupleResponse.launchLatitude
                launchLongitude = launchDetectionTupleResponse.launchLongitude
                launchTime = launchDetectionTupleResponse.launchTime
                observationAltitude = launchDetectionTupleResponse.observationAltitude
                origin = launchDetectionTupleResponse.origin
                origNetwork = launchDetectionTupleResponse.origNetwork
                raan = launchDetectionTupleResponse.raan
                stereoFlag = launchDetectionTupleResponse.stereoFlag
                tags = launchDetectionTupleResponse.tags.map { it.toMutableList() }
                updatedAt = launchDetectionTupleResponse.updatedAt
                updatedBy = launchDetectionTupleResponse.updatedBy
                additionalProperties = launchDetectionTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchDetectionTupleResponse].
         *
         ...
         */
        fun build(): LaunchDetectionTupleResponse =
    ...
    fun validate(): LaunchDetectionTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
