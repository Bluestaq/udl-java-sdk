...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionTupleResponse: LaunchDetectionTupleResponse) = apply {
    ...
    fun validate(): LaunchDetectionTupleResponse = apply {
        if (validated) {
            return@apply
        }
