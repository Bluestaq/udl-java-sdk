...
class RfBandFull private constructor(
    ...
    @JsonProperty("band")
    @ExcludeMissing
    fun _band(): JsonField<String> = band
    ...
    @ExcludeMissing
    fun _edgeGain(): JsonField<Double> = edgeGain
    ...
    @ExcludeMissing
    fun _peakGain(): JsonField<Double> = peakGain
    ...
    @ExcludeMissing
    fun _purpose(): JsonField<Purpose> = purpose
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandFull: RfBandFull) =
            apply {
         ...
         *
         * You should usually call [Builder.band] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun band(band: JsonField<String>) =
            apply {
                this.band = band
            }
         ...
         *
         * You should usually call [Builder.edgeGain] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun edgeGain(edgeGain: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.erp] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun erp(erp: JsonField<Double>) =
            apply {
                this.erp = erp
            }
         ...
         *
         * You should usually call [Builder.peakGain] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun peakGain(peakGain: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.purpose] with a well-typed [Purpose] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun purpose(purpose: JsonField<Purpose>) =
            apply {
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idEntity.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (band.asKnown().isPresent) 1 else 0) + (if (bandwidth.asKnown().isPresent) 1 else 0) + (if (beamwidth.asKnown().isPresent) 1 else 0) + (if (centerFreq.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (edgeGain.asKnown().isPresent) 1 else 0) + (if (eirp.asKnown().isPresent) 1 else 0) + (if (erp.asKnown().isPresent) 1 else 0) + (if (freqMax.asKnown().isPresent) 1 else 0) + (if (freqMin.asKnown().isPresent) 1 else 0) + (mode.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (peakGain.asKnown().isPresent) 1 else 0) + (polarization.asKnown().getOrNull()?.validity() ?: 0) + (purpose.asKnown().getOrNull()?.validity() ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    /** Transponder polarization e.g. H - (Horizontally Polarized) Perpendicular to Earth's surface, V - (Vertically Polarized) Parallel to Earth's surface, L - (Left Hand Circularly Polarized) Rotating left relative to the Earth's surface, R - (Right Hand Circularly Polarized) Rotating right relative to the Earth's surface. */
    class Polarization @JsonCreator private constructor(
        private val value: JsonField<String>,
    ...
    /** Purpose or use of the RF Band -- COMM = communications, TTC = Telemetry/Tracking/Control, OPS = Operations, OTHER = Other). */
    class Purpose @JsonCreator private constructor(
        private val value: JsonField<String>,
    ...
    override fun toString() = "RfBandFull{classificationMarking=$classificationMarking, dataMode=$dataMode, idEntity=$idEntity, name=$name, source=$source, id=$id, band=$band, bandwidth=$bandwidth, beamwidth=$beamwidth, centerFreq=$centerFreq, createdAt=$createdAt, createdBy=$createdBy, edgeGain=$edgeGain, eirp=$eirp, erp=$erp, freqMax=$freqMax, freqMin=$freqMin, mode=$mode, origin=$origin, origNetwork=$origNetwork, peakGain=$peakGain, polarization=$polarization, purpose=$purpose, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
