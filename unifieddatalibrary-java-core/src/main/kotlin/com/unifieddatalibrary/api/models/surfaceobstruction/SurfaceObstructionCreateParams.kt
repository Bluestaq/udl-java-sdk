...
/**
 * Service operation to take a single surfaceobstruction record as a POST body and ingest into the
 * database. A specific role is required to perform this service operation. Please contact the UDL
 * team for assistance.
 */
class SurfaceObstructionCreateParams
private constructor(
    ...
    /** A builder for [SurfaceObstructionCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionCreateParams: SurfaceObstructionCreateParams) = apply {
            body = surfaceObstructionCreateParams.body.toBuilder()
            additionalHeaders = surfaceObstructionCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = surfaceObstructionCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SurfaceObstructionCreateParams].
         *
         ...
         */
        fun build(): SurfaceObstructionCreateParams =
            SurfaceObstructionCreateParams(
                body.build(),
