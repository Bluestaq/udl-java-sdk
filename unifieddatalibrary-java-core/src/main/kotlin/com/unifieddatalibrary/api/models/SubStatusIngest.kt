...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubStatusIngest].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subStatusIngest: SubStatusIngest) = apply {
            classificationMarking = subStatusIngest.classificationMarking
            dataMode = subStatusIngest.dataMode
            notes = subStatusIngest.notes
            source = subStatusIngest.source
            status = subStatusIngest.status
            statusId = subStatusIngest.statusId
            type = subStatusIngest.type
            id = subStatusIngest.id
            createdAt = subStatusIngest.createdAt
            createdBy = subStatusIngest.createdBy
            origin = subStatusIngest.origin
            origNetwork = subStatusIngest.origNetwork
            additionalProperties = subStatusIngest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubStatusIngest].
         *
    ...
    fun validate(): SubStatusIngest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubStatusIngest &&
    ...
    override fun toString() =
        "SubStatusIngest{classificationMarking=$classificationMarking, dataMode=$dataMode, notes=$notes, source=$source, status=$status, statusId=$statusId, type=$type, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
