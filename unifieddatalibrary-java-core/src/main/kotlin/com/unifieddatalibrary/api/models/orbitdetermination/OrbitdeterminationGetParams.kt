 ...
 * parameter.
 */
class OrbitdeterminationGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OrbitdeterminationGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationGetParams: OrbitdeterminationGetParams) = apply {
    ...
    override fun toString() =
        "OrbitdeterminationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
