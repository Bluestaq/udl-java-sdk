 ...
 */
class OnorbitthrusterstatusCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitthrusterstatusCountParams = builder().build()
    ...
    /** A builder for [OnorbitthrusterstatusCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterstatusCountParams: OnorbitthrusterstatusCountParams) =
            apply {
                firstResult = onorbitthrusterstatusCountParams.firstResult
                idOnorbitThruster = onorbitthrusterstatusCountParams.idOnorbitThruster
                maxResults = onorbitthrusterstatusCountParams.maxResults
                statusTime = onorbitthrusterstatusCountParams.statusTime
                additionalHeaders = onorbitthrusterstatusCountParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    onorbitthrusterstatusCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitthrusterstatusCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitthrusterstatusCountParams =
            OnorbitthrusterstatusCountParams(
                firstResult,
                idOnorbitThruster,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OnorbitthrusterstatusCountParams && firstResult == other.firstResult && idOnorbitThruster == other.idOnorbitThruster && maxResults == other.maxResults && statusTime == other.statusTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OnorbitthrusterstatusCountParams{firstResult=$firstResult, idOnorbitThruster=$idOnorbitThruster, maxResults=$maxResults, statusTime=$statusTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
