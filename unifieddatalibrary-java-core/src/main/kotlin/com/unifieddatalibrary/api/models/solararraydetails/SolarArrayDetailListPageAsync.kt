...
class SolarArrayDetailListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<SolarArrayDetailListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SolarArrayDetailListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayDetailListPageAsync: SolarArrayDetailListPageAsync) =
            apply {
        ...
        fun service(service: SolarArrayDetailServiceAsync) =
            apply {
    ...
    override fun toString() = "SolarArrayDetailListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
