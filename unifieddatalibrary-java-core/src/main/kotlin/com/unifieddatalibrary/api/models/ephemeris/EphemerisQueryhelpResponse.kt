...
class EphemerisQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisQueryhelpResponse: EphemerisQueryhelpResponse) = apply {
    ...
    fun validate(): EphemerisQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
