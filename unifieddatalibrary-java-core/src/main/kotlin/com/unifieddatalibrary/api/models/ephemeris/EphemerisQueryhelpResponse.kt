...
class EphemerisQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EphemerisQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EphemerisQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisQueryhelpResponse: EphemerisQueryhelpResponse) =
            apply {
                aodrSupported = ephemerisQueryhelpResponse.aodrSupported
                classificationMarking = ephemerisQueryhelpResponse.classificationMarking
                description = ephemerisQueryhelpResponse.description
                historySupported = ephemerisQueryhelpResponse.historySupported
                name = ephemerisQueryhelpResponse.name
                parameters = ephemerisQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = ephemerisQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = ephemerisQueryhelpResponse.restSupported
                sortSupported = ephemerisQueryhelpResponse.sortSupported
                typeName = ephemerisQueryhelpResponse.typeName
                uri = ephemerisQueryhelpResponse.uri
                additionalProperties = ephemerisQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EphemerisQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EphemerisQueryhelpResponse =
    ...
    fun validate(): EphemerisQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EphemerisQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
