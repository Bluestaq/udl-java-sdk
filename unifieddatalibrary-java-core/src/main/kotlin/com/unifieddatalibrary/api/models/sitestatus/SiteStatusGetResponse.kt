...
class SiteStatusGetResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusGetResponse: SiteStatusGetResponse) =
            apply {
    ...
    fun validate(): SiteStatusGetResponse =
        apply {
            if (validated) {
              return@apply
            }
