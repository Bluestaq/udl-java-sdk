...
class ScientificGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScientificGetResponse].
         *
    ...
    /** A builder for [ScientificGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificGetResponse: ScientificGetResponse) =
            apply {
                classificationMarking = scientificGetResponse.classificationMarking
                dataMode = scientificGetResponse.dataMode
                name = scientificGetResponse.name
                source = scientificGetResponse.source
                spacecraftId = scientificGetResponse.spacecraftId
                id = scientificGetResponse.id
                createdAt = scientificGetResponse.createdAt
                createdBy = scientificGetResponse.createdBy
                entity = scientificGetResponse.entity
                frequencyBand = scientificGetResponse.frequencyBand
                hostedForCompanyOrgId = scientificGetResponse.hostedForCompanyOrgId
                idEntity = scientificGetResponse.idEntity
                manufacturerOrgId = scientificGetResponse.manufacturerOrgId
                notes = scientificGetResponse.notes
                origin = scientificGetResponse.origin
                origNetwork = scientificGetResponse.origNetwork
                payloadCategory = scientificGetResponse.payloadCategory
                updatedAt = scientificGetResponse.updatedAt
                updatedBy = scientificGetResponse.updatedBy
                additionalProperties = scientificGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ScientificGetResponse].
         *
         ...
         */
        fun build(): ScientificGetResponse =
    ...
    fun validate(): ScientificGetResponse =
        apply {
            if (validated) {
              return@apply
            }
