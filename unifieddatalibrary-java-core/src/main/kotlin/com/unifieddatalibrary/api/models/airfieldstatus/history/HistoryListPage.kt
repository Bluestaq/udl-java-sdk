...
private constructor(
    ...
    private val items: List<AirfieldstatusFull>,
) : Page<AirfieldstatusFull> {
    ...
    fun autoPager(): AutoPager<AirfieldstatusFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<AirfieldstatusFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<AirfieldstatusFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<AirfieldstatusFull>) = apply { this.items = items }
