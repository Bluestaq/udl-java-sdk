 ...
 */
class AirfieldStatusTupleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirfieldStatusTupleParams].
         *
    ...
    /** A builder for [AirfieldStatusTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldStatusTupleParams: AirfieldStatusTupleParams) = apply {
            columns = airfieldStatusTupleParams.columns
            firstResult = airfieldStatusTupleParams.firstResult
            maxResults = airfieldStatusTupleParams.maxResults
            additionalHeaders = airfieldStatusTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = airfieldStatusTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AirfieldStatusTupleParams].
         *
         ...
         */
        fun build(): AirfieldStatusTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirfieldStatusTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirfieldStatusTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
