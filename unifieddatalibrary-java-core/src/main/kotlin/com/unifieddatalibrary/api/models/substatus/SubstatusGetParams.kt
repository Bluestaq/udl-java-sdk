...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SubstatusGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SubstatusGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SubstatusGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(substatusGetParams: SubstatusGetParams) = apply {
            id = substatusGetParams.id
            firstResult = substatusGetParams.firstResult
            maxResults = substatusGetParams.maxResults
            additionalHeaders = substatusGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = substatusGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SubstatusGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SubstatusGetParams =
            SubstatusGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubstatusGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SubstatusGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
