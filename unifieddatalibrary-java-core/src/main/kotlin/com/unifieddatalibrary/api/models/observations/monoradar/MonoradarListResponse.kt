...
class MonoradarListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarListResponse: MonoradarListResponse) =
            apply {
    ...
    fun validate(): MonoradarListResponse =
        apply {
            if (validated) {
              return@apply
            }
