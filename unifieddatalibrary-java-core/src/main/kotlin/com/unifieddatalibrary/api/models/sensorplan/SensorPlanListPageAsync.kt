...
private constructor(
    ...
    override fun nextPage(): CompletableFuture<SensorPlanListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanListPageAsync: SensorPlanListPageAsync) = apply {
        ...
        fun service(service: SensorPlanServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorPlanListPageAsync &&
    ...
    override fun toString() =
        "SensorPlanListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
