...
class LogisticsSegmentsFull private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSegmentsFull: LogisticsSegmentsFull) =
            apply {
    ...
    fun validate(): LogisticsSegmentsFull =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "LogisticsSegmentsFull{arrivalIcao=$arrivalIcao, departureIcao=$departureIcao, extMissionId=$extMissionId, idMission=$idMission, itin=$itin, missionNumber=$missionNumber, missionType=$missionType, modeCode=$modeCode, segActArrTime=$segActArrTime, segActDepTime=$segActDepTime, segAircraftMds=$segAircraftMds, segEstArrTime=$segEstArrTime, segEstDepTime=$segEstDepTime, segmentNumber=$segmentNumber, segTailNumber=$segTailNumber, additionalProperties=$additionalProperties}"
}
