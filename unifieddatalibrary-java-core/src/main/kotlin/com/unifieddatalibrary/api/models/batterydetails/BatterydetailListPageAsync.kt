...
class BatterydetailListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<BatterydetailListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batterydetailListPageAsync: BatterydetailListPageAsync) = apply {
        ...
        fun service(service: BatterydetailServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatterydetailListPageAsync &&
    ...
    override fun toString() =
        "BatterydetailListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
