 ...
 * team for assistance.
 */
class CollectResponseCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun idRequest(): String = body.idRequest()
     ...
     *   if the server responded with an unexpected value).
     */
    fun actualEndTime(): Optional<OffsetDateTime> = body.actualEndTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun actualStartTime(): Optional<OffsetDateTime> = body.actualStartTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun altEndTime(): Optional<OffsetDateTime> = body.altEndTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun altStartTime(): Optional<OffsetDateTime> = body.altStartTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun errCode(): Optional<String> = body.errCode()
     ...
     *   if the server responded with an unexpected value).
     */
    fun idPlan(): Optional<String> = body.idPlan()
     ...
     */
    fun _idRequest(): JsonField<String> = body._idRequest()
     ...
     */
    fun _actualEndTime(): JsonField<OffsetDateTime> = body._actualEndTime()
     ...
     */
    fun _actualStartTime(): JsonField<OffsetDateTime> = body._actualStartTime()
     ...
     */
    fun _altEndTime(): JsonField<OffsetDateTime> = body._altEndTime()
     ...
     */
    fun _altStartTime(): JsonField<OffsetDateTime> = body._altStartTime()
     ...
     */
    fun _errCode(): JsonField<String> = body._errCode()
     ...
     */
    fun _idPlan(): JsonField<String> = body._idPlan()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectResponseCreateParams].
         *
    ...
    /** A builder for [CollectResponseCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectResponseCreateParams: CollectResponseCreateParams) = apply {
            body = collectResponseCreateParams.body.toBuilder()
            additionalHeaders = collectResponseCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = collectResponseCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Unique identifier of the request associated with this response. */
        fun idRequest(idRequest: String) = apply { body.idRequest(idRequest) }
         ...
         * value.
         */
        fun idRequest(idRequest: JsonField<String>) = apply { body.idRequest(idRequest) }
        ...
        /** The actual end time of the collect or contact, in ISO 8601 UTC format. */
        fun actualEndTime(actualEndTime: OffsetDateTime) = apply {
        ...
        /** The actual start time of the collect or contact, in ISO 8601 UTC format. */
        fun actualStartTime(actualStartTime: OffsetDateTime) = apply {
        ...
        /** Proposed alternative end time, in ISO 8601 UTC format. */
        fun altEndTime(altEndTime: OffsetDateTime) = apply { body.altEndTime(altEndTime) }
        ...
        fun altEndTime(altEndTime: JsonField<OffsetDateTime>) = apply {
            body.altEndTime(altEndTime)
        }

        /** Proposed alternative start time, in ISO 8601 UTC format. */
        fun altStartTime(altStartTime: OffsetDateTime) = apply { body.altStartTime(altStartTime) }
        ...
        fun altStartTime(altStartTime: JsonField<OffsetDateTime>) = apply {
            body.altStartTime(altStartTime)
        }
        ...
        /** Error code associated with this request/response. */
        fun errCode(errCode: String) = apply { body.errCode(errCode) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun errCode(errCode: JsonField<String>) = apply { body.errCode(errCode) }
         ...
         * Unique identifier of the parent plan or schedule associated with the request/response.
         */
        fun idPlan(idPlan: String) = apply { body.idPlan(idPlan) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun idPlan(idPlan: JsonField<String>) = apply { body.idPlan(idPlan) }
        ...
        /**
         * Returns an immutable instance of [CollectResponseCreateParams].
         *
         ...
         */
        fun build(): CollectResponseCreateParams =
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idRequest == other.idRequest && source == other.source && id == other.id && actualEndTime == other.actualEndTime && actualStartTime == other.actualStartTime && altEndTime == other.altEndTime && altStartTime == other.altStartTime && createdAt == other.createdAt && createdBy == other.createdBy && errCode == other.errCode && externalId == other.externalId && idOnOrbit == other.idOnOrbit && idPlan == other.idPlan && idSensor == other.idSensor && notes == other.notes && origin == other.origin && origNetwork == other.origNetwork && origObjectId == other.origObjectId && origSensorId == other.origSensorId && satNo == other.satNo && srcIds == other.srcIds && srcTyps == other.srcTyps && status == other.status && tags == other.tags && taskId == other.taskId && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idRequest, source, id, actualEndTime, actualStartTime, altEndTime, altStartTime, createdAt, createdBy, errCode, externalId, idOnOrbit, idPlan, idSensor, notes, origin, origNetwork, origObjectId, origSensorId, satNo, srcIds, srcTyps, status, tags, taskId, additionalProperties) }
        /* spotless:on */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CollectResponseCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CollectResponseCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
