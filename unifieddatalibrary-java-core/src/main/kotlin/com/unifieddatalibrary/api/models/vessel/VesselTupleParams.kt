...
class VesselTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VesselTupleParams].
         *
    ...
    /** A builder for [VesselTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselTupleParams: VesselTupleParams) =
            apply {
                columns = vesselTupleParams.columns
                firstResult = vesselTupleParams.firstResult
                maxResults = vesselTupleParams.maxResults
                additionalHeaders = vesselTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = vesselTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [VesselTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is VesselTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "VesselTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
