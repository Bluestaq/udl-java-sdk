 ...
 */
class OnorbitassessmentCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitassessmentCountParams].
         *
    ...
    /** A builder for [OnorbitassessmentCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitassessmentCountParams: OnorbitassessmentCountParams) = apply {
            assmtTime = onorbitassessmentCountParams.assmtTime
            firstResult = onorbitassessmentCountParams.firstResult
            maxResults = onorbitassessmentCountParams.maxResults
            additionalHeaders = onorbitassessmentCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = onorbitassessmentCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitassessmentCountParams].
         *
         ...
         */
        fun build(): OnorbitassessmentCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitassessmentCountParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(assmtTime, firstResult, maxResults, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "OnorbitassessmentCountParams{assmtTime=$assmtTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
