...
class LaunchDetectionTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchDetectionTupleParams].
         *
    ...
    /** A builder for [LaunchDetectionTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionTupleParams: LaunchDetectionTupleParams) =
            apply {
                columns = launchDetectionTupleParams.columns
                firstResult = launchDetectionTupleParams.firstResult
                maxResults = launchDetectionTupleParams.maxResults
                additionalHeaders = launchDetectionTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = launchDetectionTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchDetectionTupleParams].
         *
         ...
         */
        fun build(): LaunchDetectionTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchDetectionTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "LaunchDetectionTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
