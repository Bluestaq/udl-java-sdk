...
class GlobalAtmosphericModelTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GlobalAtmosphericModelTupleParams].
         *
    ...
    /** A builder for [GlobalAtmosphericModelTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelTupleParams: GlobalAtmosphericModelTupleParams) =
            apply {
                columns = globalAtmosphericModelTupleParams.columns
                ts = globalAtmosphericModelTupleParams.ts
                firstResult = globalAtmosphericModelTupleParams.firstResult
                maxResults = globalAtmosphericModelTupleParams.maxResults
                additionalHeaders = globalAtmosphericModelTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = globalAtmosphericModelTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GlobalAtmosphericModelTupleParams].
         *
         ...
         */
        fun build(): GlobalAtmosphericModelTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GlobalAtmosphericModelTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "GlobalAtmosphericModelTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
