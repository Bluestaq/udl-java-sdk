...
/**
 * Service operation intended for initial integration only, to take a list of MissileTrack records
 ...
 */
class MissileTrackCreateBulkParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissileTrackCreateBulkParams].
         *
    ...
    /** A builder for [MissileTrackCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missileTrackCreateBulkParams: MissileTrackCreateBulkParams) = apply {
            body = missileTrackCreateBulkParams.body.toMutableList()
            additionalHeaders = missileTrackCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = missileTrackCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MissileTrackCreateBulkParams].
         *
         ...
         */
        fun build(): MissileTrackCreateBulkParams =
