...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VesselListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselListParams: VesselListParams) = apply {
    ...
    override fun toString() =
        "VesselListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
