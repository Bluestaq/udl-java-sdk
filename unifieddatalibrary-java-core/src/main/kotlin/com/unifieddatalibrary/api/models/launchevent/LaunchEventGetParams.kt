...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchEventGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventGetParams: LaunchEventGetParams) = apply {
    ...
    override fun toString() =
        "LaunchEventGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
