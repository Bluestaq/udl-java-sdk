...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EcpsdrRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrRetrieveParams: EcpsdrRetrieveParams) = apply {
    ...
    override fun toString() =
        "EcpsdrRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
