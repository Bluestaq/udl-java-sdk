...
class EcpsdrRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EcpsdrRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EcpsdrRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EcpsdrRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrRetrieveParams: EcpsdrRetrieveParams) =
            apply {
                id = ecpsdrRetrieveParams.id
                firstResult = ecpsdrRetrieveParams.firstResult
                maxResults = ecpsdrRetrieveParams.maxResults
                additionalHeaders = ecpsdrRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = ecpsdrRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EcpsdrRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EcpsdrRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EcpsdrRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EcpsdrRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
