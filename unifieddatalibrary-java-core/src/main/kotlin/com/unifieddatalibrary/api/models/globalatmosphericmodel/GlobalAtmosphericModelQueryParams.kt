...
class GlobalAtmosphericModelQueryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GlobalAtmosphericModelQueryParams].
         *
    ...
    /** A builder for [GlobalAtmosphericModelQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelQueryParams: GlobalAtmosphericModelQueryParams) =
            apply {
                ts = globalAtmosphericModelQueryParams.ts
                firstResult = globalAtmosphericModelQueryParams.firstResult
                maxResults = globalAtmosphericModelQueryParams.maxResults
                additionalHeaders = globalAtmosphericModelQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams = globalAtmosphericModelQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GlobalAtmosphericModelQueryParams].
         *
         ...
         */
        fun build(): GlobalAtmosphericModelQueryParams =
    ...
    override fun toString() = "GlobalAtmosphericModelQueryParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
