    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) =
            apply {
                ...
                actionsList = historyListResponse.actionsList.map { it.toMutableList() }
                actorSrcId = historyListResponse.actorSrcId
                actorSrcType = historyListResponse.actorSrcType
                coaMetrics = historyListResponse.coaMetrics.map { it.toMutableList() }
                collateralDamageEst = historyListResponse.collateralDamageEst
                createdAt = historyListResponse.createdAt
                createdBy = historyListResponse.createdBy
                decisionDeadline = historyListResponse.decisionDeadline
                externalActions = historyListResponse.externalActions.map { it.toMutableList() }
                externalRequestId = historyListResponse.externalRequestId
                idEffectRequest = historyListResponse.idEffectRequest
                munitionId = historyListResponse.munitionId
                munitionType = historyListResponse.munitionType
                origin = historyListResponse.origin
                origNetwork = historyListResponse.origNetwork
                probabilityOfKill = historyListResponse.probabilityOfKill
                redTargetSrcId = historyListResponse.redTargetSrcId
                redTargetSrcType = historyListResponse.redTargetSrcType
                redTimeToOverhead = historyListResponse.redTimeToOverhead
                shotsRequired = historyListResponse.shotsRequired
