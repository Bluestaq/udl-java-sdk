...
/**
 * Service operation to take a list of WeatherData as a POST body and ingest into the database. This
 * operation is intended to be used for automated feeds into UDL. A specific role is required to
 * perform this service operation. Please contact the UDL team for assistance.
 */
class WeatherDataUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            weatherDataUnvalidatedPublishParams: WeatherDataUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                weatherDataUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun toString() =
        "WeatherDataUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
