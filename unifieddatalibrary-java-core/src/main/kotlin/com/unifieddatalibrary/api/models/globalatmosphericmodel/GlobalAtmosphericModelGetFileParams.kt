...
class GlobalAtmosphericModelGetFileParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): GlobalAtmosphericModelGetFileParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GlobalAtmosphericModelGetFileParams]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelGetFileParams: GlobalAtmosphericModelGetFileParams) =
            apply {
                ...
                additionalQueryParams = globalAtmosphericModelGetFileParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "GlobalAtmosphericModelGetFileParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
