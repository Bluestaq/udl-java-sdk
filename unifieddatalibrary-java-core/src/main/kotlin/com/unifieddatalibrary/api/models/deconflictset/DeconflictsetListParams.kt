...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeconflictsetListParams].
         *
    ...
    /** A builder for [DeconflictsetListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deconflictsetListParams: DeconflictsetListParams) = apply {
            eventStartTime = deconflictsetListParams.eventStartTime
            firstResult = deconflictsetListParams.firstResult
            maxResults = deconflictsetListParams.maxResults
            additionalHeaders = deconflictsetListParams.additionalHeaders.toBuilder()
            additionalQueryParams = deconflictsetListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DeconflictsetListParams].
         *
         ...
         */
        fun build(): DeconflictsetListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeconflictsetListParams &&
    ...
    override fun toString() =
        "DeconflictsetListParams{eventStartTime=$eventStartTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
