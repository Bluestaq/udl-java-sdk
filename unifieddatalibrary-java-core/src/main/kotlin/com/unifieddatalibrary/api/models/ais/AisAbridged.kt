...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aisAbridged: AisAbridged) = apply {
    ...
    fun validate(): AisAbridged = apply {
        if (validated) {
            return@apply
        }
