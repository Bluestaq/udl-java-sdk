...
class AisAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AisAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aisAbridged: AisAbridged) =
            apply {
                classificationMarking = aisAbridged.classificationMarking
                dataMode = aisAbridged.dataMode
                source = aisAbridged.source
                ts = aisAbridged.ts
                id = aisAbridged.id
                antennaRefDimensions = aisAbridged.antennaRefDimensions.map { it.toMutableList() }
                avgSpeed = aisAbridged.avgSpeed
                callSign = aisAbridged.callSign
                cargoType = aisAbridged.cargoType
                course = aisAbridged.course
                createdAt = aisAbridged.createdAt
                createdBy = aisAbridged.createdBy
                currentPortGuid = aisAbridged.currentPortGuid
                currentPortLocode = aisAbridged.currentPortLocode
                destination = aisAbridged.destination
                destinationEta = aisAbridged.destinationEta
                distanceToGo = aisAbridged.distanceToGo
                distanceTravelled = aisAbridged.distanceTravelled
                draught = aisAbridged.draught
                engagedIn = aisAbridged.engagedIn
                etaCalculated = aisAbridged.etaCalculated
                etaUpdated = aisAbridged.etaUpdated
                idTrack = aisAbridged.idTrack
                idVessel = aisAbridged.idVessel
                imon = aisAbridged.imon
                lastPortGuid = aisAbridged.lastPortGuid
                lastPortLocode = aisAbridged.lastPortLocode
                lat = aisAbridged.lat
                length = aisAbridged.length
                lon = aisAbridged.lon
                maxSpeed = aisAbridged.maxSpeed
                mmsi = aisAbridged.mmsi
                navStatus = aisAbridged.navStatus
                nextPortGuid = aisAbridged.nextPortGuid
                nextPortLocode = aisAbridged.nextPortLocode
                origin = aisAbridged.origin
                origNetwork = aisAbridged.origNetwork
                posDeviceType = aisAbridged.posDeviceType
                posHiAccuracy = aisAbridged.posHiAccuracy
                posHiLatency = aisAbridged.posHiLatency
                rateOfTurn = aisAbridged.rateOfTurn
                shipDescription = aisAbridged.shipDescription
                shipName = aisAbridged.shipName
                shipType = aisAbridged.shipType
                sourceDl = aisAbridged.sourceDl
                specialCraft = aisAbridged.specialCraft
                specialManeuver = aisAbridged.specialManeuver
                speed = aisAbridged.speed
                trueHeading = aisAbridged.trueHeading
                vesselFlag = aisAbridged.vesselFlag
                width = aisAbridged.width
                additionalProperties = aisAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AisAbridged].
         *
