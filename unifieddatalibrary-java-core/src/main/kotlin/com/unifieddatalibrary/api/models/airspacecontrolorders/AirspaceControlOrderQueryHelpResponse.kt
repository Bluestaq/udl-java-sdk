...
class AirspaceControlOrderQueryHelpResponse
private constructor(
    ...
    /** A builder for [AirspaceControlOrderQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            airspaceControlOrderQueryHelpResponse: AirspaceControlOrderQueryHelpResponse
        ) = apply {
            aodrSupported = airspaceControlOrderQueryHelpResponse.aodrSupported
            classificationMarking = airspaceControlOrderQueryHelpResponse.classificationMarking
            description = airspaceControlOrderQueryHelpResponse.description
            historySupported = airspaceControlOrderQueryHelpResponse.historySupported
            name = airspaceControlOrderQueryHelpResponse.name
            parameters = airspaceControlOrderQueryHelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                airspaceControlOrderQueryHelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = airspaceControlOrderQueryHelpResponse.restSupported
            sortSupported = airspaceControlOrderQueryHelpResponse.sortSupported
            typeName = airspaceControlOrderQueryHelpResponse.typeName
            uri = airspaceControlOrderQueryHelpResponse.uri
            additionalProperties =
                airspaceControlOrderQueryHelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AirspaceControlOrderQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirspaceControlOrderQueryHelpResponse =
            AirspaceControlOrderQueryHelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): AirspaceControlOrderQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirspaceControlOrderQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
