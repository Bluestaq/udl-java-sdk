...
private constructor(
    ...
    private val items: List<MtiFull>,
) : PageAsync<MtiFull> {
    ...
    fun autoPager(): AutoPagerAsync<MtiFull> = AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<MtiFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<MtiFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<MtiFull>) = apply { this.items = items }
