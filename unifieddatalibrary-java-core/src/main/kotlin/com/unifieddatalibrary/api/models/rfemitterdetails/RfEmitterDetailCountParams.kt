 ...
 */
class RfEmitterDetailCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfEmitterDetailCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailCountParams: RfEmitterDetailCountParams) = apply {
    ...
    override fun toString() =
        "RfEmitterDetailCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
