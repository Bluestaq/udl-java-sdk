...
class SurfaceObstructionTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceObstructionTupleParams].
         *
    ...
    /** A builder for [SurfaceObstructionTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionTupleParams: SurfaceObstructionTupleParams) =
            apply {
                columns = surfaceObstructionTupleParams.columns
                firstResult = surfaceObstructionTupleParams.firstResult
                maxResults = surfaceObstructionTupleParams.maxResults
                additionalHeaders = surfaceObstructionTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = surfaceObstructionTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceObstructionTupleParams].
         *
         ...
         */
        fun build(): SurfaceObstructionTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SurfaceObstructionTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SurfaceObstructionTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
