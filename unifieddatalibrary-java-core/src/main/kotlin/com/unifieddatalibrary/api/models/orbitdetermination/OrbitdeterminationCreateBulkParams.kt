 ...
 * for automated feeds into the UDL. Data providers should contact the UDL team for specific role
 * assignments and for instructions on setting up a permanent feed through an alternate mechanism.
 */
class OrbitdeterminationCreateBulkParams
private constructor(
        ...
        internal fun from(orbitdeterminationCreateBulkParams: OrbitdeterminationCreateBulkParams) =
            apply {
                ...
                additionalQueryParams =
                    orbitdeterminationCreateBulkParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "OrbitdeterminationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
