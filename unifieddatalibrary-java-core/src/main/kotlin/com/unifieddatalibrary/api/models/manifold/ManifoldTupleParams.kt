...
class ManifoldTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManifoldTupleParams].
         *
    ...
    /** A builder for [ManifoldTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldTupleParams: ManifoldTupleParams) =
            apply {
                columns = manifoldTupleParams.columns
                firstResult = manifoldTupleParams.firstResult
                maxResults = manifoldTupleParams.maxResults
                additionalHeaders = manifoldTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = manifoldTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ManifoldTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ManifoldTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ManifoldTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
