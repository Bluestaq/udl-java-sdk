...
class RfBandTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfBandTupleParams].
         *
    ...
    /** A builder for [RfBandTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTupleParams: RfBandTupleParams) =
            apply {
                columns = rfBandTupleParams.columns
                firstResult = rfBandTupleParams.firstResult
                maxResults = rfBandTupleParams.maxResults
                additionalHeaders = rfBandTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfBandTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfBandTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfBandTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfBandTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
