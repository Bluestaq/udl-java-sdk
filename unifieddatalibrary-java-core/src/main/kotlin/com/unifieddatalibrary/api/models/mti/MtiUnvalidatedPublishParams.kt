...
class MtiUnvalidatedPublishParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mtiUnvalidatedPublishParams: MtiUnvalidatedPublishParams) =
            apply {
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("jobRequests") @ExcludeMissing private val jobRequests: JsonField<List<JobRequest>>,
        ...
        @JsonProperty("platformLocs") @ExcludeMissing private val platformLocs: JsonField<List<PlatformLoc>>,
        ...
        class JobDef private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.j1] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun j1(j1: JsonField<Long>) =
                    apply {
                        this.j1 = j1
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (j1.asKnown().isPresent) 1 else 0) + (if (j10.asKnown().isPresent) 1 else 0) + (if (j11.asKnown().isPresent) 1 else 0) + (if (j12.asKnown().isPresent) 1 else 0) + (if (j13.asKnown().isPresent) 1 else 0) + (if (j14.asKnown().isPresent) 1 else 0) + (if (j15.asKnown().isPresent) 1 else 0) + (if (j16.asKnown().isPresent) 1 else 0) + (if (j17.asKnown().isPresent) 1 else 0) + (if (j18.asKnown().isPresent) 1 else 0) + (if (j19.asKnown().isPresent) 1 else 0) + (if (j2.asKnown().isPresent) 1 else 0) + (if (j20.asKnown().isPresent) 1 else 0) + (if (j21.asKnown().isPresent) 1 else 0) + (if (j22.asKnown().isPresent) 1 else 0) + (if (j23.asKnown().isPresent) 1 else 0) + (if (j24.asKnown().isPresent) 1 else 0) + (if (j25.asKnown().isPresent) 1 else 0) + (if (j26.asKnown().isPresent) 1 else 0) + (if (j27.asKnown().isPresent) 1 else 0) + (if (j28.asKnown().isPresent) 1 else 0) + (if (j3.asKnown().isPresent) 1 else 0) + (if (j4.asKnown().isPresent) 1 else 0) + (if (j5.asKnown().isPresent) 1 else 0) + (if (j6.asKnown().isPresent) 1 else 0) + (if (j7.asKnown().isPresent) 1 else 0) + (if (j8.asKnown().isPresent) 1 else 0) + (if (j9.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() = "JobDef{j1=$j1, j10=$j10, j11=$j11, j12=$j12, j13=$j13, j14=$j14, j15=$j15, j16=$j16, j17=$j17, j18=$j18, j19=$j19, j2=$j2, j20=$j20, j21=$j21, j22=$j22, j23=$j23, j24=$j24, j25=$j25, j26=$j26, j27=$j27, j28=$j28, j3=$j3, j4=$j4, j5=$j5, j6=$j6, j7=$j7, j8=$j8, j9=$j9, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MtiUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "MtiUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
