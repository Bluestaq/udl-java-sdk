...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaseremitterTupleParams].
         *
    ...
    /** A builder for [LaseremitterTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laseremitterTupleParams: LaseremitterTupleParams) = apply {
            columns = laseremitterTupleParams.columns
            firstResult = laseremitterTupleParams.firstResult
            maxResults = laseremitterTupleParams.maxResults
            additionalHeaders = laseremitterTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = laseremitterTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaseremitterTupleParams].
         *
         ...
         */
        fun build(): LaseremitterTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaseremitterTupleParams &&
    ...
    override fun toString() =
        "LaseremitterTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
