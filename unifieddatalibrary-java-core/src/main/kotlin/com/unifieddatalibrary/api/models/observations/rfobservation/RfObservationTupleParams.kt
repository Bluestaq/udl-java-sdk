...
class RfObservationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfObservationTupleParams].
         *
    ...
    /** A builder for [RfObservationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationTupleParams: RfObservationTupleParams) =
            apply {
                columns = rfObservationTupleParams.columns
                obTime = rfObservationTupleParams.obTime
                firstResult = rfObservationTupleParams.firstResult
                maxResults = rfObservationTupleParams.maxResults
                additionalHeaders = rfObservationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfObservationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfObservationTupleParams].
         *
         ...
         */
        fun build(): RfObservationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfObservationTupleParams && columns == other.columns && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfObservationTupleParams{columns=$columns, obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
