 ...
 * parameter.
 */
class FeatureAssessmentRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FeatureAssessmentRetrieveParams = builder().build()
    ...
    /** A builder for [FeatureAssessmentRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentRetrieveParams: FeatureAssessmentRetrieveParams) =
            apply {
                id = featureAssessmentRetrieveParams.id
                firstResult = featureAssessmentRetrieveParams.firstResult
                maxResults = featureAssessmentRetrieveParams.maxResults
                additionalHeaders = featureAssessmentRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    featureAssessmentRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FeatureAssessmentRetrieveParams =
            FeatureAssessmentRetrieveParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FeatureAssessmentRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "FeatureAssessmentRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
