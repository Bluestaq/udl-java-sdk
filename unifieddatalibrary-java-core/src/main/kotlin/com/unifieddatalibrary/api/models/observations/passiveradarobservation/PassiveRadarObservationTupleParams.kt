...
class PassiveRadarObservationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PassiveRadarObservationTupleParams].
         *
    ...
    /** A builder for [PassiveRadarObservationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(passiveRadarObservationTupleParams: PassiveRadarObservationTupleParams) =
            apply {
                columns = passiveRadarObservationTupleParams.columns
                obTime = passiveRadarObservationTupleParams.obTime
                firstResult = passiveRadarObservationTupleParams.firstResult
                maxResults = passiveRadarObservationTupleParams.maxResults
                additionalHeaders = passiveRadarObservationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = passiveRadarObservationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PassiveRadarObservationTupleParams].
         *
         ...
         */
        fun build(): PassiveRadarObservationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PassiveRadarObservationTupleParams && columns == other.columns && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "PassiveRadarObservationTupleParams{columns=$columns, obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
