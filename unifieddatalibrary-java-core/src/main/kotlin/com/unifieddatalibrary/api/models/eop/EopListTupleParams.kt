...
class EopListTupleParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopListTupleParams: EopListTupleParams) =
            apply {
        ...
        /** Effective date/time for the EOP values in ISO8601 UTC format. The values could be current or predicted. (YYYY-MM-DDTHH:MM:SS.sssZ) */
        fun eopDate(eopDate: OffsetDateTime) =
            apply {
    ...
    override fun toString() = "EopListTupleParams{columns=$columns, eopDate=$eopDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
