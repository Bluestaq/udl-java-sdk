 ...
 */
class EopListTupleParams
private constructor(
    private val columns: String,
    private val eopDate: OffsetDateTime,
     ...
     * predicted. (YYYY-MM-DDTHH:MM:SS.sssZ)
     */
    fun eopDate(): OffsetDateTime = eopDate
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EopListTupleParams].
         *
    ...
    /** A builder for [EopListTupleParams]. */
    class Builder internal constructor() {

        private var columns: String? = null
        private var eopDate: OffsetDateTime? = null
        ...
        @JvmSynthetic
        internal fun from(eopListTupleParams: EopListTupleParams) = apply {
            columns = eopListTupleParams.columns
            eopDate = eopListTupleParams.eopDate
            firstResult = eopListTupleParams.firstResult
            maxResults = eopListTupleParams.maxResults
            additionalHeaders = eopListTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = eopListTupleParams.additionalQueryParams.toBuilder()
        }
         ...
         * or predicted. (YYYY-MM-DDTHH:MM:SS.sssZ)
         */
        fun eopDate(eopDate: OffsetDateTime) = apply { this.eopDate = eopDate }
        ...
        /**
         * Returns an immutable instance of [EopListTupleParams].
         *
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("columns", columns)
                put("eopDate", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(eopDate))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EopListTupleParams && columns == other.columns && eopDate == other.eopDate && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, eopDate, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "EopListTupleParams{columns=$columns, eopDate=$eopDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
