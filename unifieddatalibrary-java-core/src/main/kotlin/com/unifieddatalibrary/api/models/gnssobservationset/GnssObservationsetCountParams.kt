 ...
 */
class GnssObservationsetCountParams
private constructor(
    ...
    /** A builder for [GnssObservationsetCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gnssObservationsetCountParams: GnssObservationsetCountParams) = apply {
            ts = gnssObservationsetCountParams.ts
            firstResult = gnssObservationsetCountParams.firstResult
            maxResults = gnssObservationsetCountParams.maxResults
            additionalHeaders = gnssObservationsetCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = gnssObservationsetCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GnssObservationsetCountParams].
         *
         ...
         */
        fun build(): GnssObservationsetCountParams =
            GnssObservationsetCountParams(
                checkRequired("ts", ts),
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is GnssObservationsetCountParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "GnssObservationsetCountParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
