...
class SeradataOpticalPayloadListResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(seradataOpticalPayloadListResponse: SeradataOpticalPayloadListResponse) =
            apply {
                ...
                numberOfFilmReturnCanisters =
                    seradataOpticalPayloadListResponse.numberOfFilmReturnCanisters
                ...
                additionalProperties =
                    seradataOpticalPayloadListResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SeradataOpticalPayloadListResponse = apply {
        if (validated) {
            return@apply
        }
