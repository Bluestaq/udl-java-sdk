...
class SeradataOpticalPayloadListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataOpticalPayloadListResponse].
         *
    ...
    /** A builder for [SeradataOpticalPayloadListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataOpticalPayloadListResponse: SeradataOpticalPayloadListResponse) =
            apply {
                classificationMarking = seradataOpticalPayloadListResponse.classificationMarking
                dataMode = seradataOpticalPayloadListResponse.dataMode
                source = seradataOpticalPayloadListResponse.source
                spacecraftId = seradataOpticalPayloadListResponse.spacecraftId
                id = seradataOpticalPayloadListResponse.id
                bestResolution = seradataOpticalPayloadListResponse.bestResolution
                createdAt = seradataOpticalPayloadListResponse.createdAt
                createdBy = seradataOpticalPayloadListResponse.createdBy
                fieldOfRegard = seradataOpticalPayloadListResponse.fieldOfRegard
                fieldOfView = seradataOpticalPayloadListResponse.fieldOfView
                groundStationLocations = seradataOpticalPayloadListResponse.groundStationLocations
                groundStations = seradataOpticalPayloadListResponse.groundStations
                hostedForCompanyOrgId = seradataOpticalPayloadListResponse.hostedForCompanyOrgId
                idSensor = seradataOpticalPayloadListResponse.idSensor
                imagingPayloadCategory = seradataOpticalPayloadListResponse.imagingPayloadCategory
                manufacturerOrgId = seradataOpticalPayloadListResponse.manufacturerOrgId
                name = seradataOpticalPayloadListResponse.name
                notes = seradataOpticalPayloadListResponse.notes
                numberOfFilmReturnCanisters = seradataOpticalPayloadListResponse.numberOfFilmReturnCanisters
                origin = seradataOpticalPayloadListResponse.origin
                origNetwork = seradataOpticalPayloadListResponse.origNetwork
                pointingMethod = seradataOpticalPayloadListResponse.pointingMethod
                recorderSize = seradataOpticalPayloadListResponse.recorderSize
                spectralBand = seradataOpticalPayloadListResponse.spectralBand
                spectralFrequencyLimits = seradataOpticalPayloadListResponse.spectralFrequencyLimits
                swathWidth = seradataOpticalPayloadListResponse.swathWidth
                additionalProperties = seradataOpticalPayloadListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataOpticalPayloadListResponse].
         *
         ...
         */
        fun build(): SeradataOpticalPayloadListResponse =
    ...
    fun validate(): SeradataOpticalPayloadListResponse =
        apply {
            if (validated) {
              return@apply
            }
