...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            cadence = historyListResponse.cadence
            ...
            dataSourceIdentifier = historyListResponse.dataSourceIdentifier
            endAlt = historyListResponse.endAlt
            endLat = historyListResponse.endLat
            endLon = historyListResponse.endLon
            filename = historyListResponse.filename
            filesize = historyListResponse.filesize
            numAlt = historyListResponse.numAlt
            numLat = historyListResponse.numLat
            numLon = historyListResponse.numLon
            ...
            startAlt = historyListResponse.startAlt
            startLat = historyListResponse.startLat
            startLon = historyListResponse.startLon
            state = historyListResponse.state
            stepLat = historyListResponse.stepLat
            stepLon = historyListResponse.stepLon
