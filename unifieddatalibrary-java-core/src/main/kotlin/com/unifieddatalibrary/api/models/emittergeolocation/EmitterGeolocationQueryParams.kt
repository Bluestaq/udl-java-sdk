...
class EmitterGeolocationQueryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmitterGeolocationQueryParams].
         *
    ...
    /** A builder for [EmitterGeolocationQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationQueryParams: EmitterGeolocationQueryParams) =
            apply {
                startTime = emitterGeolocationQueryParams.startTime
                firstResult = emitterGeolocationQueryParams.firstResult
                maxResults = emitterGeolocationQueryParams.maxResults
                additionalHeaders = emitterGeolocationQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams = emitterGeolocationQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationQueryParams].
         *
         ...
         */
        fun build(): EmitterGeolocationQueryParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EmitterGeolocationQueryParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EmitterGeolocationQueryParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
