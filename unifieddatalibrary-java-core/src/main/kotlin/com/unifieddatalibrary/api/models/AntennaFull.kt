...
class AntennaFull private constructor(
    private val dataMode: JsonField<DataMode>,
    private val name: JsonField<String>,
    private val source: JsonField<String>,
    private val id: JsonField<String>,
    private val antennaDetails: JsonField<List<AntennaDetailsFull>>,
    ...
    private constructor(
        ...
        @JsonProperty("antennaDetails") @ExcludeMissing antennaDetails: JsonField<List<AntennaDetailsFull>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun antennaDetails(): Optional<List<AntennaDetailsFull>> = antennaDetails.getOptional("antennaDetails")
    ...
    /**
     * Returns the raw JSON value of [antennaDetails].
     *
     * Unlike [antennaDetails], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("antennaDetails")
    @ExcludeMissing
    fun _antennaDetails(): JsonField<List<AntennaDetailsFull>> = antennaDetails
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AntennaFull].
         *
    ...
    class Builder internal constructor() {
        ...
        private var antennaDetails: JsonField<MutableList<AntennaDetailsFull>>? = null
        ...
        @JvmSynthetic
        internal fun from(antennaFull: AntennaFull) =
            apply {
                dataMode = antennaFull.dataMode
                name = antennaFull.name
                source = antennaFull.source
                id = antennaFull.id
                antennaDetails = antennaFull.antennaDetails.map { it.toMutableList() }
                createdAt = antennaFull.createdAt
                createdBy = antennaFull.createdBy
                origin = antennaFull.origin
                origNetwork = antennaFull.origNetwork
                updatedAt = antennaFull.updatedAt
                updatedBy = antennaFull.updatedBy
                additionalProperties = antennaFull.additionalProperties.toMutableMap()
            }
        ...
        /** Read-only collection of additional AntennaDetails by various sources for this organization, ignored on create/update. These details must be created separately via the /udl/antennadetails operations. */
        fun antennaDetails(antennaDetails: List<AntennaDetailsFull>) = antennaDetails(JsonField.of(antennaDetails))

        /**
         * Sets [Builder.antennaDetails] to an arbitrary JSON value.
         *
         * You should usually call [Builder.antennaDetails] with a well-typed `List<AntennaDetailsFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun antennaDetails(antennaDetails: JsonField<List<AntennaDetailsFull>>) =
            apply {
                this.antennaDetails = antennaDetails.map { it.toMutableList() }
            }

        /**
         * Adds a single [AntennaDetailsFull] to [antennaDetails].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAntennaDetail(antennaDetail: AntennaDetailsFull) =
            apply {
                antennaDetails = (antennaDetails ?: JsonField.of(mutableListOf())).also {
                    checkKnown("antennaDetails", it).add(antennaDetail)
                }
            }
        ...
        /**
         * Returns an immutable instance of [AntennaFull].
         *
        ...
        fun build(): AntennaFull =
            AntennaFull(
              ...
              id,
              (antennaDetails ?: JsonMissing.of()).map { it.toImmutable() },
              createdAt,
              createdBy,
              origin,
              origNetwork,
    ...
    fun validate(): AntennaFull =
        apply {
            ...
            source()
            id()
            antennaDetails().ifPresent { it.forEach { it.validate() } }
            createdAt()
            createdBy()
            origin()
            origNetwork()
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (antennaDetails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AntennaFull && dataMode == other.dataMode && name == other.name && source == other.source && id == other.id && antennaDetails == other.antennaDetails && createdAt == other.createdAt && createdBy == other.createdBy && origin == other.origin && origNetwork == other.origNetwork && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(dataMode, name, source, id, antennaDetails, createdAt, createdBy, origin, origNetwork, updatedAt, updatedBy, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "AntennaFull{dataMode=$dataMode, name=$name, source=$source, id=$id, antennaDetails=$antennaDetails, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
