...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SolarArrayCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayCountParams: SolarArrayCountParams) = apply {
    ...
    override fun toString() =
        "SolarArrayCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
