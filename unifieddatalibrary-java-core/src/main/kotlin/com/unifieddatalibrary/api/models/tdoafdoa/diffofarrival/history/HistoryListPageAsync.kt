...
private constructor(
    ...
    private val items: List<DiffofarrivalFull>,
) : PageAsync<DiffofarrivalFull> {
    ...
    fun autoPager(): AutoPagerAsync<DiffofarrivalFull> =
    ...
    override fun items(): List<DiffofarrivalFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<DiffofarrivalFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<DiffofarrivalFull>) = apply { this.items = items }
