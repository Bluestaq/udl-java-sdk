...
class SolarArrayDetailGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SolarArrayDetailGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayDetailGetParams: SolarArrayDetailGetParams) =
            apply {
    ...
    override fun toString() = "SolarArrayDetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
