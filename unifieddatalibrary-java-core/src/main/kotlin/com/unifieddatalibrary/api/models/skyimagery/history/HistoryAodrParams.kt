...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyAodrParams: HistoryAodrParams) = apply {
            expStartTime = historyAodrParams.expStartTime
         ...
         * (YYYY-MM-DDTHH:MM:SS.ssssssZ)
         */
        fun expStartTime(expStartTime: OffsetDateTime) = apply { this.expStartTime = expStartTime }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is HistoryAodrParams && expStartTime == other.expStartTime && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && notification == other.notification && outputDelimiter == other.outputDelimiter && outputFormat == other.outputFormat && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(expStartTime, columns, firstResult, maxResults, notification, outputDelimiter, outputFormat, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "HistoryAodrParams{expStartTime=$expStartTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
