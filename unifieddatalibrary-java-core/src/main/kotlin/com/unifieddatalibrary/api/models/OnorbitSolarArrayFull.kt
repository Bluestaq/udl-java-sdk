...
class OnorbitSolarArrayFull private constructor(
    ...
    private val solarArray: JsonField<SolarArrayFull>,
    ...
    private constructor(
        ...
        @JsonProperty("solarArray") @ExcludeMissing solarArray: JsonField<SolarArrayFull> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun solarArray(): Optional<SolarArrayFull> = solarArray.getOptional("solarArray")
    ...
    @ExcludeMissing
    fun _solarArray(): JsonField<SolarArrayFull> = solarArray
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitSolarArrayFull].
         *
    ...
    /** A builder for [OnorbitSolarArrayFull]. */
    class Builder internal constructor() {
        ...
        private var solarArray: JsonField<SolarArrayFull> = JsonMissing.of()
        private var updatedAt: JsonField<OffsetDateTime> = JsonMissing.of()
        private var updatedBy: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(onorbitSolarArrayFull: OnorbitSolarArrayFull) =
            apply {
                classificationMarking = onorbitSolarArrayFull.classificationMarking
                dataMode = onorbitSolarArrayFull.dataMode
                idOnOrbit = onorbitSolarArrayFull.idOnOrbit
                idSolarArray = onorbitSolarArrayFull.idSolarArray
                source = onorbitSolarArrayFull.source
                id = onorbitSolarArrayFull.id
                createdAt = onorbitSolarArrayFull.createdAt
                createdBy = onorbitSolarArrayFull.createdBy
                origin = onorbitSolarArrayFull.origin
                origNetwork = onorbitSolarArrayFull.origNetwork
                quantity = onorbitSolarArrayFull.quantity
                solarArray = onorbitSolarArrayFull.solarArray
                updatedAt = onorbitSolarArrayFull.updatedAt
                updatedBy = onorbitSolarArrayFull.updatedBy
                additionalProperties = onorbitSolarArrayFull.additionalProperties.toMutableMap()
            }
        ...
        /** Model representation of information on on-orbit/spacecraft solar arrays. A spacecraft may have multiple solar arrays and each solar array can have multiple 'details' records compiled by different sources. */
        fun solarArray(solarArray: SolarArrayFull) = solarArray(JsonField.of(solarArray))

        /**
         * Sets [Builder.solarArray] to an arbitrary JSON value.
         *
         * You should usually call [Builder.solarArray] with a well-typed [SolarArrayFull] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun solarArray(solarArray: JsonField<SolarArrayFull>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [OnorbitSolarArrayFull].
         *
         ...
         */
        fun build(): OnorbitSolarArrayFull =
    ...
    fun validate(): OnorbitSolarArrayFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSolarArray.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (solarArray.asKnown().getOrNull()?.validity() ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "OnorbitSolarArrayFull{classificationMarking=$classificationMarking, dataMode=$dataMode, idOnOrbit=$idOnOrbit, idSolarArray=$idSolarArray, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, solarArray=$solarArray, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
