...
class SiteRemarkListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkListPage: SiteRemarkListPage) =
            apply {
        ...
        fun service(service: SiteRemarkService) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: SiteRemarkListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<SiteRemarkListResponse>) =
            apply {
                this.items = items
            }
