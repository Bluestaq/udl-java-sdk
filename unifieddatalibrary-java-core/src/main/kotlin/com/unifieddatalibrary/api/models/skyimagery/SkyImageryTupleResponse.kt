...
/** Model representation of sky imagery data. Sky imagery is ground or space based telescope imagery of RSO's and includes metadata on the image (time, source, etc) as well as binary image content (e.g. FITS, EOSSA, EOCHIP, MP4). Binary content must be downloaded individually by ID using the 'getFile' operation. */
class SkyImageryTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("expStartTime") @ExcludeMissing expStartTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("imageType") @ExcludeMissing imageType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("source") @ExcludeMissing source: JsonField<String> = JsonMissing.of(),
        @JsonProperty("id") @ExcludeMissing id: JsonField<String> = JsonMissing.of(),
        @JsonProperty("annotationKey") @ExcludeMissing annotationKey: JsonField<String> = JsonMissing.of(),
        @JsonProperty("calibrationKey") @ExcludeMissing calibrationKey: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("eoObservations") @ExcludeMissing eoObservations: JsonField<List<EoObservationFull>> = JsonMissing.of(),
        @JsonProperty("expEndTime") @ExcludeMissing expEndTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("filename") @ExcludeMissing filename: JsonField<String> = JsonMissing.of(),
        @JsonProperty("filesize") @ExcludeMissing filesize: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("frameFOVHeight") @ExcludeMissing frameFovHeight: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("frameFOVWidth") @ExcludeMissing frameFovWidth: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("frameHeightPixels") @ExcludeMissing frameHeightPixels: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("frameWidthPixels") @ExcludeMissing frameWidthPixels: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("idAttitudeSet") @ExcludeMissing idAttitudeSet: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("imageSourceInfo") @ExcludeMissing imageSourceInfo: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("pixelBitDepth") @ExcludeMissing pixelBitDepth: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("pixelFOVHeight") @ExcludeMissing pixelFovHeight: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("pixelFOVWidth") @ExcludeMissing pixelFovWidth: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("senQuatDot") @ExcludeMissing senQuatDot: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("topLeftStartAz") @ExcludeMissing topLeftStartAz: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("topLeftStartEl") @ExcludeMissing topLeftStartEl: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("topLeftStopAz") @ExcludeMissing topLeftStopAz: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("topLeftStopEl") @ExcludeMissing topLeftStopEl: JsonField<Double> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun eoObservations(): Optional<List<EoObservationFull>> = eoObservations.getOptional("eoObservations")
     ...
     *
     * Unlike [frameHeightPixels], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [frameWidthPixels], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     */
    @JsonProperty("idSOISet")
    @ExcludeMissing
    fun _idSoiSet(): JsonField<String> = idSoiSet
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SkyImageryTupleResponse].
         *
    ...
    /** A builder for [SkyImageryTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryTupleResponse: SkyImageryTupleResponse) =
            apply {
                classificationMarking = skyImageryTupleResponse.classificationMarking
                dataMode = skyImageryTupleResponse.dataMode
                expStartTime = skyImageryTupleResponse.expStartTime
                imageType = skyImageryTupleResponse.imageType
                source = skyImageryTupleResponse.source
                id = skyImageryTupleResponse.id
                annotationKey = skyImageryTupleResponse.annotationKey
                calibrationKey = skyImageryTupleResponse.calibrationKey
                checksumValue = skyImageryTupleResponse.checksumValue
                createdAt = skyImageryTupleResponse.createdAt
                createdBy = skyImageryTupleResponse.createdBy
                description = skyImageryTupleResponse.description
                eoObservations = skyImageryTupleResponse.eoObservations.map { it.toMutableList() }
                expEndTime = skyImageryTupleResponse.expEndTime
                filename = skyImageryTupleResponse.filename
                filesize = skyImageryTupleResponse.filesize
                frameFovHeight = skyImageryTupleResponse.frameFovHeight
                frameFovWidth = skyImageryTupleResponse.frameFovWidth
                frameHeightPixels = skyImageryTupleResponse.frameHeightPixels
                frameWidthPixels = skyImageryTupleResponse.frameWidthPixels
                idAttitudeSet = skyImageryTupleResponse.idAttitudeSet
                idOnOrbit = skyImageryTupleResponse.idOnOrbit
                idSensor = skyImageryTupleResponse.idSensor
                idSoiSet = skyImageryTupleResponse.idSoiSet
                imageSetId = skyImageryTupleResponse.imageSetId
                imageSetLength = skyImageryTupleResponse.imageSetLength
                imageSourceInfo = skyImageryTupleResponse.imageSourceInfo
                onOrbit = skyImageryTupleResponse.onOrbit
                origin = skyImageryTupleResponse.origin
                origNetwork = skyImageryTupleResponse.origNetwork
                origObjectId = skyImageryTupleResponse.origObjectId
                origSensorId = skyImageryTupleResponse.origSensorId
                pixelBitDepth = skyImageryTupleResponse.pixelBitDepth
                pixelFovHeight = skyImageryTupleResponse.pixelFovHeight
                pixelFovWidth = skyImageryTupleResponse.pixelFovWidth
                satNo = skyImageryTupleResponse.satNo
                senalt = skyImageryTupleResponse.senalt
                senlat = skyImageryTupleResponse.senlat
                senlon = skyImageryTupleResponse.senlon
                senQuat = skyImageryTupleResponse.senQuat.map { it.toMutableList() }
                senQuatDot = skyImageryTupleResponse.senQuatDot.map { it.toMutableList() }
                senx = skyImageryTupleResponse.senx
                seny = skyImageryTupleResponse.seny
                senz = skyImageryTupleResponse.senz
                sequenceId = skyImageryTupleResponse.sequenceId
                sourceDl = skyImageryTupleResponse.sourceDl
                tags = skyImageryTupleResponse.tags.map { it.toMutableList() }
                topLeftStartAz = skyImageryTupleResponse.topLeftStartAz
                topLeftStartEl = skyImageryTupleResponse.topLeftStartEl
                topLeftStopAz = skyImageryTupleResponse.topLeftStopAz
                topLeftStopEl = skyImageryTupleResponse.topLeftStopEl
                transactionId = skyImageryTupleResponse.transactionId
                additionalProperties = skyImageryTupleResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.expStartTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun expStartTime(expStartTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.annotationKey] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun annotationKey(annotationKey: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.calibrationKey] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun calibrationKey(calibrationKey: JsonField<String>) =
            apply {
        ...
        /** Collection of linked EOObservations. */
        fun eoObservations(eoObservations: List<EoObservationFull>) = eoObservations(JsonField.of(eoObservations))

        /**
         * Sets [Builder.eoObservations] to an arbitrary JSON value.
         *
         * You should usually call [Builder.eoObservations] with a well-typed `List<EoObservationFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eoObservations(eoObservations: JsonField<List<EoObservationFull>>) =
            apply {
         ...
         */
        fun addEoObservation(eoObservation: EoObservationFull) =
            apply {
                eoObservations = (eoObservations ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.expEndTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun expEndTime(expEndTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.frameFovHeight] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun frameFovHeight(frameFovHeight: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.frameFovWidth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun frameFovWidth(frameFovWidth: JsonField<Double>) =
            apply {
                this.frameFovWidth = frameFovWidth
            }

        /** Frame height of the image, in number of pixels. */
        fun frameHeightPixels(frameHeightPixels: Int) = frameHeightPixels(JsonField.of(frameHeightPixels))

        /**
         * Sets [Builder.frameHeightPixels] to an arbitrary JSON value.
         *
         * You should usually call [Builder.frameHeightPixels] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun frameHeightPixels(frameHeightPixels: JsonField<Int>) =
            apply {
                this.frameHeightPixels = frameHeightPixels
            }

        /** Frame width of the image, in number of pixels. */
        fun frameWidthPixels(frameWidthPixels: Int) = frameWidthPixels(JsonField.of(frameWidthPixels))

        /**
         * Sets [Builder.frameWidthPixels] to an arbitrary JSON value.
         *
         * You should usually call [Builder.frameWidthPixels] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun frameWidthPixels(frameWidthPixels: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.idAttitudeSet] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idAttitudeSet(idAttitudeSet: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.idSoiSet] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idSoiSet(idSoiSet: JsonField<String>) =
            apply {
                this.idSoiSet = idSoiSet
            }
        ...
        /** String that uniquely identifies the data source. */
        fun imageSourceInfo(imageSourceInfo: String) = imageSourceInfo(JsonField.of(imageSourceInfo))

        /**
         * Sets [Builder.imageSourceInfo] to an arbitrary JSON value.
         *
         * You should usually call [Builder.imageSourceInfo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun imageSourceInfo(imageSourceInfo: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.pixelBitDepth] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pixelBitDepth(pixelBitDepth: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.pixelFovHeight] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pixelFovHeight(pixelFovHeight: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.pixelFovWidth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pixelFovWidth(pixelFovWidth: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.senQuatDot] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun senQuatDot(senQuatDot: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSenQuatDot(senQuatDot: Double) =
            apply {
                this.senQuatDot = (this.senQuatDot ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.topLeftStartAz] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun topLeftStartAz(topLeftStartAz: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.topLeftStartEl] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun topLeftStartEl(topLeftStartEl: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.topLeftStopAz] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun topLeftStopAz(topLeftStopAz: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.topLeftStopEl] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun topLeftStopEl(topLeftStopEl: JsonField<Double>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [SkyImageryTupleResponse].
         *
         ...
         */
        fun build(): SkyImageryTupleResponse =
    ...
    fun validate(): SkyImageryTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (expStartTime.asKnown().isPresent) 1 else 0) + (if (imageType.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (annotationKey.asKnown().isPresent) 1 else 0) + (if (calibrationKey.asKnown().isPresent) 1 else 0) + (if (checksumValue.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (eoObservations.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (expEndTime.asKnown().isPresent) 1 else 0) + (if (filename.asKnown().isPresent) 1 else 0) + (if (filesize.asKnown().isPresent) 1 else 0) + (if (frameFovHeight.asKnown().isPresent) 1 else 0) + (if (frameFovWidth.asKnown().isPresent) 1 else 0) + (if (frameHeightPixels.asKnown().isPresent) 1 else 0) + (if (frameWidthPixels.asKnown().isPresent) 1 else 0) + (if (idAttitudeSet.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (idSoiSet.asKnown().isPresent) 1 else 0) + (if (imageSetId.asKnown().isPresent) 1 else 0) + (if (imageSetLength.asKnown().isPresent) 1 else 0) + (if (imageSourceInfo.asKnown().isPresent) 1 else 0) + (onOrbit.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (pixelBitDepth.asKnown().isPresent) 1 else 0) + (if (pixelFovHeight.asKnown().isPresent) 1 else 0) + (if (pixelFovWidth.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlat.asKnown().isPresent) 1 else 0) + (if (senlon.asKnown().isPresent) 1 else 0) + (senQuat.asKnown().getOrNull()?.size ?: 0) + (senQuatDot.asKnown().getOrNull()?.size ?: 0) + (if (senx.asKnown().isPresent) 1 else 0) + (if (seny.asKnown().isPresent) 1 else 0) + (if (senz.asKnown().isPresent) 1 else 0) + (if (sequenceId.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (topLeftStartAz.asKnown().isPresent) 1 else 0) + (if (topLeftStartEl.asKnown().isPresent) 1 else 0) + (if (topLeftStopAz.asKnown().isPresent) 1 else 0) + (if (topLeftStopEl.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0)
