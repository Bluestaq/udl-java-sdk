...
class OnboardnavigationListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationListPage: OnboardnavigationListPage) =
            apply {
        ...
        fun service(service: OnboardnavigationService) =
            apply {
    ...
    override fun toString() = "OnboardnavigationListPage{service=$service, params=$params, items=$items}"
}
