...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AircraftListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AircraftListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AircraftListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftListParams: AircraftListParams) = apply {
            firstResult = aircraftListParams.firstResult
            maxResults = aircraftListParams.maxResults
            additionalHeaders = aircraftListParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AircraftListParams =
            AircraftListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AircraftListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
