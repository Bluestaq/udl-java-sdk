...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitlistListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistListParams: OnorbitlistListParams) = apply {
    ...
    override fun toString() =
        "OnorbitlistListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
