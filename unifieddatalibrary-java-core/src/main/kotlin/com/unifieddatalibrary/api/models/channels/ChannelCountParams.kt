...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ChannelCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(channelCountParams: ChannelCountParams) = apply {
    ...
    override fun toString() =
        "ChannelCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
