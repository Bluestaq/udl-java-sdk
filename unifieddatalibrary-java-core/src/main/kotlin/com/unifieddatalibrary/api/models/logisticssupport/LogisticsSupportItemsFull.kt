...
import com.unifieddatalibrary.api.models.logisticssupport.LogisticsPartsFull
import com.unifieddatalibrary.api.models.logisticssupport.LogisticsRemarksFull
import com.unifieddatalibrary.api.models.logisticssupport.LogisticsSpecialtiesFull
...
class LogisticsSupportItemsFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("logisticsParts") @ExcludeMissing logisticsParts: JsonField<List<LogisticsPartsFull>> = JsonMissing.of(),
        @JsonProperty("logisticsRemarks") @ExcludeMissing logisticsRemarks: JsonField<List<LogisticsRemarksFull>> = JsonMissing.of(),
        @JsonProperty("logisticsSpecialties") @ExcludeMissing logisticsSpecialties: JsonField<List<LogisticsSpecialtiesFull>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun logisticsParts(): Optional<List<LogisticsPartsFull>> = logisticsParts.getOptional("logisticsParts")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun logisticsSpecialties(): Optional<List<LogisticsSpecialtiesFull>> = logisticsSpecialties.getOptional("logisticsSpecialties")
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportItemsFull: LogisticsSupportItemsFull) =
            apply {
                ...
                logisticsSpecialties = logisticsSupportItemsFull.logisticsSpecialties.map { it.toMutableList() }
        ...
        /** The parts associated with this support item. */
        fun logisticsParts(logisticsParts: List<LogisticsPartsFull>) = logisticsParts(JsonField.of(logisticsParts))

        /**
         * Sets [Builder.logisticsParts] to an arbitrary JSON value.
         *
         * You should usually call [Builder.logisticsParts] with a well-typed `List<LogisticsPartsFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun logisticsParts(logisticsParts: JsonField<List<LogisticsPartsFull>>) =
            apply {
         ...
         */
        fun addLogisticsPart(logisticsPart: LogisticsPartsFull) =
            apply {
        ...
        /** The specialties required to implement this support item. */
        fun logisticsSpecialties(logisticsSpecialties: List<LogisticsSpecialtiesFull>) = logisticsSpecialties(JsonField.of(logisticsSpecialties))

        /**
         * Sets [Builder.logisticsSpecialties] to an arbitrary JSON value.
         *
         * You should usually call [Builder.logisticsSpecialties] with a well-typed `List<LogisticsSpecialtiesFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLogisticsSpecialty(logisticsSpecialty: LogisticsSpecialtiesFull) =
            apply {
    ...
    fun validate(): LogisticsSupportItemsFull =
        apply {
            if (validated) {
              return@apply
            }
