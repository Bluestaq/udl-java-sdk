 ...
 */
class SeradataRadarPayloadCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataRadarPayloadCountParams = builder().build()
        ...
        internal fun from(seradataRadarPayloadCountParams: SeradataRadarPayloadCountParams) =
            apply {
                ...
                additionalQueryParams =
                    seradataRadarPayloadCountParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "SeradataRadarPayloadCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
