...
class PoiListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PoiListParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiListParams: PoiListParams) =
            apply {
                ts = poiListParams.ts
                firstResult = poiListParams.firstResult
                maxResults = poiListParams.maxResults
                additionalHeaders = poiListParams.additionalHeaders.toBuilder()
                additionalQueryParams = poiListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PoiListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PoiListParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "PoiListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
