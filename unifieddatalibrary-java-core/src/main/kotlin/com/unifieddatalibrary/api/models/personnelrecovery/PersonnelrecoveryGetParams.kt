 ...
 */
class PersonnelrecoveryGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PersonnelrecoveryGetParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [PersonnelrecoveryGetParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PersonnelrecoveryGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(personnelrecoveryGetParams: PersonnelrecoveryGetParams) = apply {
            id = personnelrecoveryGetParams.id
            firstResult = personnelrecoveryGetParams.firstResult
            maxResults = personnelrecoveryGetParams.maxResults
            additionalHeaders = personnelrecoveryGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = personnelrecoveryGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PersonnelrecoveryGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PersonnelrecoveryGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PersonnelrecoveryGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "PersonnelrecoveryGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
