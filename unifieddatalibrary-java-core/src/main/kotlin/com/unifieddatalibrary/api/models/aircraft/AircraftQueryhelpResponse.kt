...
class AircraftQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AircraftQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftQueryhelpResponse: AircraftQueryhelpResponse) = apply {
            aodrSupported = aircraftQueryhelpResponse.aodrSupported
            classificationMarking = aircraftQueryhelpResponse.classificationMarking
            description = aircraftQueryhelpResponse.description
            historySupported = aircraftQueryhelpResponse.historySupported
            name = aircraftQueryhelpResponse.name
            parameters = aircraftQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = aircraftQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = aircraftQueryhelpResponse.restSupported
            sortSupported = aircraftQueryhelpResponse.sortSupported
            typeName = aircraftQueryhelpResponse.typeName
            uri = aircraftQueryhelpResponse.uri
            additionalProperties = aircraftQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AircraftQueryhelpResponse =
    ...
    fun validate(): AircraftQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
