...
class TransponderGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransponderGetResponse].
         *
    ...
    /** A builder for [TransponderGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderGetResponse: TransponderGetResponse) =
            apply {
                classificationMarking = transponderGetResponse.classificationMarking
                dataMode = transponderGetResponse.dataMode
                idComm = transponderGetResponse.idComm
                source = transponderGetResponse.source
                id = transponderGetResponse.id
                channels = transponderGetResponse.channels.map { it.toMutableList() }
                createdAt = transponderGetResponse.createdAt
                createdBy = transponderGetResponse.createdBy
                fec = transponderGetResponse.fec
                format = transponderGetResponse.format
                modulation = transponderGetResponse.modulation
                name = transponderGetResponse.name
                nid = transponderGetResponse.nid
                origin = transponderGetResponse.origin
                origNetwork = transponderGetResponse.origNetwork
                symbolRate = transponderGetResponse.symbolRate
                system = transponderGetResponse.system
                tid = transponderGetResponse.tid
                ttf = transponderGetResponse.ttf
                updatedAt = transponderGetResponse.updatedAt
                updatedBy = transponderGetResponse.updatedBy
                additionalProperties = transponderGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TransponderGetResponse].
         *
         ...
         */
        fun build(): TransponderGetResponse =
    ...
    fun validate(): TransponderGetResponse =
        apply {
            if (validated) {
              return@apply
            }
