...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderGetResponse: TransponderGetResponse) = apply {
    ...
    fun validate(): TransponderGetResponse = apply {
        if (validated) {
            return@apply
        }
