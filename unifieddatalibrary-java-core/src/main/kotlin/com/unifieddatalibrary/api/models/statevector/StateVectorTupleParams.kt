...
private constructor(
     ...
     * precision. (YYYY-MM-DDTHH:MM:SS.ssssssZ)
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StateVectorTupleParams].
         *
    ...
    /** A builder for [StateVectorTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorTupleParams: StateVectorTupleParams) = apply {
            columns = stateVectorTupleParams.columns
            epoch = stateVectorTupleParams.epoch
            firstResult = stateVectorTupleParams.firstResult
            maxResults = stateVectorTupleParams.maxResults
            additionalHeaders = stateVectorTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = stateVectorTupleParams.additionalQueryParams.toBuilder()
        }
         ...
         * precision. (YYYY-MM-DDTHH:MM:SS.ssssssZ)
         */
        fun epoch(epoch: OffsetDateTime) = apply { this.epoch = epoch }
        ...
        /**
         * Returns an immutable instance of [StateVectorTupleParams].
         *
         ...
         */
        fun build(): StateVectorTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StateVectorTupleParams && columns == other.columns && epoch == other.epoch && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "StateVectorTupleParams{columns=$columns, epoch=$epoch, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
