...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorCountParams: SensorCountParams) = apply {
    ...
    override fun toString() =
        "SensorCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
