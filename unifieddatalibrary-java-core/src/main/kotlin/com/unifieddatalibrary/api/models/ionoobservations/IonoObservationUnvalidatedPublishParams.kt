...
class IonoObservationUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IonoObservationUnvalidatedPublishParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ionoObservationUnvalidatedPublishParams: IonoObservationUnvalidatedPublishParams) =
            apply {
                body = ionoObservationUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = ionoObservationUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = ionoObservationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("startTimeUTC") @ExcludeMissing private val startTimeUtc: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("antennaElementPosition") @ExcludeMissing private val antennaElementPosition: JsonField<AntennaElementPosition>,
        @JsonProperty("antennaElementPositionCoordinateSystem") @ExcludeMissing private val antennaElementPositionCoordinateSystem: JsonField<AntennaElementPositionCoordinateSystem>,
        ...
        @JsonProperty("densityProfile") @ExcludeMissing private val densityProfile: JsonField<DensityProfile>,
        ...
        @JsonProperty("electronDensity") @ExcludeMissing private val electronDensity: JsonField<List<Double>>,
        @JsonProperty("electronDensityUncertainty") @ExcludeMissing private val electronDensityUncertainty: JsonField<List<Double>>,
        ...
        @JsonProperty("neProfileVersion") @ExcludeMissing private val neProfileVersion: JsonField<Double>,
        ...
        @JsonProperty("plasmaFrequency") @ExcludeMissing private val plasmaFrequency: JsonField<List<Double>>,
        @JsonProperty("plasmaFrequencyUncertainty") @ExcludeMissing private val plasmaFrequencyUncertainty: JsonField<List<Double>>,
        @JsonProperty("platformName") @ExcludeMissing private val platformName: JsonField<String>,
        @JsonProperty("polarization") @ExcludeMissing private val polarization: JsonField<Polarization>,
        ...
        @JsonProperty("receiveCoordinates") @ExcludeMissing private val receiveCoordinates: JsonField<List<List<Double>>>,
        @JsonProperty("receiveSensorType") @ExcludeMissing private val receiveSensorType: JsonField<ReceiveSensorType>,
        @JsonProperty("restrictedFrequency") @ExcludeMissing private val restrictedFrequency: JsonField<List<Double>>,
        @JsonProperty("restrictedFrequencyNotes") @ExcludeMissing private val restrictedFrequencyNotes: JsonField<String>,
        @JsonProperty("scaleHeightF2Peak") @ExcludeMissing private val scaleHeightF2Peak: JsonField<Double>,
        ...
        @JsonProperty("tidPhaseSpeeds") @ExcludeMissing private val tidPhaseSpeeds: JsonField<List<Double>>,
        @JsonProperty("time") @ExcludeMissing private val time: JsonField<Time>,
        @JsonProperty("traceGeneric") @ExcludeMissing private val traceGeneric: JsonField<TraceGeneric>,
        @JsonProperty("transmitCoordinates") @ExcludeMissing private val transmitCoordinates: JsonField<List<List<Double>>>,
        @JsonProperty("transmitSensorType") @ExcludeMissing private val transmitSensorType: JsonField<TransmitSensorType>,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    electronDensityUncertainty = body.electronDensityUncertainty.map { it.toMutableList() }
                    ...
                    plasmaFrequencyUncertainty = body.plasmaFrequencyUncertainty.map { it.toMutableList() }
        ...
        class Polarization private constructor(
            private val data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>>>,
            private val dimensionName: JsonField<List<String>>,
            private val dimensions: JsonField<List<Int>>,
            private val notes: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("data") @ExcludeMissing data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>>> = JsonMissing.of(),
                @JsonProperty("dimensionName") @ExcludeMissing dimensionName: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("dimensions") @ExcludeMissing dimensions: JsonField<List<Int>> = JsonMissing.of(),
                @JsonProperty("notes") @ExcludeMissing notes: JsonField<String> = JsonMissing.of()
            ) : this(
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun data(): Optional<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>>> = data.getOptional("data")
            ...
            @JsonProperty("data")
            @ExcludeMissing
            fun _data(): JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>>> = data
            ...
            class Builder internal constructor() {
                ...
                private var data: JsonField<MutableList<List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>>>? = null
                private var dimensionName: JsonField<MutableList<String>>? = null
                private var dimensions: JsonField<MutableList<Int>>? = null
                private var notes: JsonField<String> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                ...
                /** Array of polarization data. */
                fun data(data: List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>>) = data(JsonField.of(data))

                /**
                 * Sets [Builder.data] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.data] with a well-typed `List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun data(data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>>>) =
                    apply {
                        this.data = data.map { it.toMutableList() }
                    }

                /**
                 * Adds a single [List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>] to [Builder.data].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addData(data: List<List<List<List<List<List<UnnamedSchemaWithArrayParent4>>>>>>) =
                    apply {
                        this.data = (this.data ?: JsonField.of(mutableListOf())).also {
                            checkKnown("data", it).add(data)
                        }
            ...
            class UnnamedSchemaWithArrayParent4 @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                companion object {
                    ...
                    @JvmStatic fun of(value: String) = UnnamedSchemaWithArrayParent4(JsonField.of(value))
                }
                ...
                /**
                 * An enum containing [UnnamedSchemaWithArrayParent4]'s known values, as well as an [_UNKNOWN] member.
                 *
                 * An instance of [UnnamedSchemaWithArrayParent4] can contain an unknown value in a couple of cases:
                 *
                 * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
                 *   an older version than the API, then the API may respond with new members that the SDK is unaware
                 *   of.
                ...
                enum class Value {
                    X,
                    O,
                    /** An enum member indicating that [UnnamedSchemaWithArrayParent4] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        X -> Known.X
                        O -> Known.O
                        else -> throw UnifieddatalibraryInvalidDataException("Unknown UnnamedSchemaWithArrayParent4: $value")
                    }
                ...
                fun validate(): UnnamedSchemaWithArrayParent4 =
                    apply {
                        if (validated) {
                          return@apply
                        }
    ...
    override fun toString() = "IonoObservationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
