...
class StateVectorAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StateVectorAbridged].
         *
    ...
    /** A builder for [StateVectorAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorAbridged: StateVectorAbridged) =
            apply {
                classificationMarking = stateVectorAbridged.classificationMarking
                dataMode = stateVectorAbridged.dataMode
                epoch = stateVectorAbridged.epoch
                source = stateVectorAbridged.source
                actualOdSpan = stateVectorAbridged.actualOdSpan
                algorithm = stateVectorAbridged.algorithm
                alt1ReferenceFrame = stateVectorAbridged.alt1ReferenceFrame
                alt2ReferenceFrame = stateVectorAbridged.alt2ReferenceFrame
                area = stateVectorAbridged.area
                bDot = stateVectorAbridged.bDot
                cmOffset = stateVectorAbridged.cmOffset
                cov = stateVectorAbridged.cov.map { it.toMutableList() }
                covMethod = stateVectorAbridged.covMethod
                covReferenceFrame = stateVectorAbridged.covReferenceFrame
                createdAt = stateVectorAbridged.createdAt
                createdBy = stateVectorAbridged.createdBy
                descriptor = stateVectorAbridged.descriptor
                dragArea = stateVectorAbridged.dragArea
                dragCoeff = stateVectorAbridged.dragCoeff
                dragModel = stateVectorAbridged.dragModel
                edr = stateVectorAbridged.edr
                eqCov = stateVectorAbridged.eqCov.map { it.toMutableList() }
                errorControl = stateVectorAbridged.errorControl
                fixedStep = stateVectorAbridged.fixedStep
                geopotentialModel = stateVectorAbridged.geopotentialModel
                iau1980Terms = stateVectorAbridged.iau1980Terms
                idOnOrbit = stateVectorAbridged.idOnOrbit
                idOrbitDetermination = stateVectorAbridged.idOrbitDetermination
                idStateVector = stateVectorAbridged.idStateVector
                integratorMode = stateVectorAbridged.integratorMode
                inTrackThrust = stateVectorAbridged.inTrackThrust
                lastObEnd = stateVectorAbridged.lastObEnd
                lastObStart = stateVectorAbridged.lastObStart
                leapSecondTime = stateVectorAbridged.leapSecondTime
                lunarSolar = stateVectorAbridged.lunarSolar
                mass = stateVectorAbridged.mass
                obsAvailable = stateVectorAbridged.obsAvailable
                obsUsed = stateVectorAbridged.obsUsed
                origin = stateVectorAbridged.origin
                origNetwork = stateVectorAbridged.origNetwork
                origObjectId = stateVectorAbridged.origObjectId
                partials = stateVectorAbridged.partials
                pedigree = stateVectorAbridged.pedigree
                polarMotionX = stateVectorAbridged.polarMotionX
                polarMotionY = stateVectorAbridged.polarMotionY
                posUnc = stateVectorAbridged.posUnc
                recOdSpan = stateVectorAbridged.recOdSpan
                referenceFrame = stateVectorAbridged.referenceFrame
                residualsAcc = stateVectorAbridged.residualsAcc
                revNo = stateVectorAbridged.revNo
                rms = stateVectorAbridged.rms
                satNo = stateVectorAbridged.satNo
                sigmaPosUvw = stateVectorAbridged.sigmaPosUvw.map { it.toMutableList() }
                sigmaVelUvw = stateVectorAbridged.sigmaVelUvw.map { it.toMutableList() }
                solarFluxApAvg = stateVectorAbridged.solarFluxApAvg
                solarFluxF10 = stateVectorAbridged.solarFluxF10
                solarFluxF10Avg = stateVectorAbridged.solarFluxF10Avg
                solarRadPress = stateVectorAbridged.solarRadPress
                solarRadPressCoeff = stateVectorAbridged.solarRadPressCoeff
                solidEarthTides = stateVectorAbridged.solidEarthTides
                sourceDl = stateVectorAbridged.sourceDl
                srpArea = stateVectorAbridged.srpArea
                stepMode = stateVectorAbridged.stepMode
                stepSize = stateVectorAbridged.stepSize
                stepSizeSelection = stateVectorAbridged.stepSizeSelection
                taiUtc = stateVectorAbridged.taiUtc
                thrustAccel = stateVectorAbridged.thrustAccel
                tracksAvail = stateVectorAbridged.tracksAvail
                tracksUsed = stateVectorAbridged.tracksUsed
                transactionId = stateVectorAbridged.transactionId
                uct = stateVectorAbridged.uct
                ut1Rate = stateVectorAbridged.ut1Rate
                ut1Utc = stateVectorAbridged.ut1Utc
                velUnc = stateVectorAbridged.velUnc
                xaccel = stateVectorAbridged.xaccel
                xpos = stateVectorAbridged.xpos
                xposAlt1 = stateVectorAbridged.xposAlt1
                xposAlt2 = stateVectorAbridged.xposAlt2
                xvel = stateVectorAbridged.xvel
                xvelAlt1 = stateVectorAbridged.xvelAlt1
                xvelAlt2 = stateVectorAbridged.xvelAlt2
                yaccel = stateVectorAbridged.yaccel
                ypos = stateVectorAbridged.ypos
                yposAlt1 = stateVectorAbridged.yposAlt1
                yposAlt2 = stateVectorAbridged.yposAlt2
                yvel = stateVectorAbridged.yvel
                yvelAlt1 = stateVectorAbridged.yvelAlt1
                yvelAlt2 = stateVectorAbridged.yvelAlt2
                zaccel = stateVectorAbridged.zaccel
                zpos = stateVectorAbridged.zpos
                zposAlt1 = stateVectorAbridged.zposAlt1
                zposAlt2 = stateVectorAbridged.zposAlt2
                zvel = stateVectorAbridged.zvel
                zvelAlt1 = stateVectorAbridged.zvelAlt1
                zvelAlt2 = stateVectorAbridged.zvelAlt2
                additionalProperties = stateVectorAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StateVectorAbridged].
         *
    ...
    fun validate(): StateVectorAbridged =
        apply {
            if (validated) {
              return@apply
            }
