...
class SarObservationCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SarObservationCreateBulkParams].
         *
    ...
    /** A builder for [SarObservationCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationCreateBulkParams: SarObservationCreateBulkParams) =
            apply {
                body = sarObservationCreateBulkParams.body.toMutableList()
                additionalHeaders = sarObservationCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = sarObservationCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SarObservationCreateBulkParams].
         *
         ...
         */
        fun build(): SarObservationCreateBulkParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("collectionEnd") @ExcludeMissing private val collectionEnd: JsonField<OffsetDateTime>,
        @JsonProperty("collectionStart") @ExcludeMissing private val collectionStart: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("centerTime") @ExcludeMissing private val centerTime: JsonField<OffsetDateTime>,
        @JsonProperty("collectionId") @ExcludeMissing private val collectionId: JsonField<String>,
        @JsonProperty("continuousSpotAngle") @ExcludeMissing private val continuousSpotAngle: JsonField<Double>,
        @JsonProperty("coordSys") @ExcludeMissing private val coordSys: JsonField<String>,
        @JsonProperty("createdAt") @ExcludeMissing private val createdAt: JsonField<OffsetDateTime>,
        @JsonProperty("createdBy") @ExcludeMissing private val createdBy: JsonField<String>,
        @JsonProperty("detectionEnd") @ExcludeMissing private val detectionEnd: JsonField<OffsetDateTime>,
        @JsonProperty("detectionId") @ExcludeMissing private val detectionId: JsonField<String>,
        @JsonProperty("detectionStart") @ExcludeMissing private val detectionStart: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("groundResolutionProjection") @ExcludeMissing private val groundResolutionProjection: JsonField<Double>,
        ...
        @JsonProperty("incidenceAngle") @ExcludeMissing private val incidenceAngle: JsonField<Double>,
        ...
        @JsonProperty("multilookNumber") @ExcludeMissing private val multilookNumber: JsonField<Double>,
        ...
        @JsonProperty("pulseBandwidth") @ExcludeMissing private val pulseBandwidth: JsonField<Double>,
        @JsonProperty("pulseDuration") @ExcludeMissing private val pulseDuration: JsonField<Double>,
        @JsonProperty("resolutionAzimuth") @ExcludeMissing private val resolutionAzimuth: JsonField<Double>,
        @JsonProperty("resolutionRange") @ExcludeMissing private val resolutionRange: JsonField<Double>,
        @JsonProperty("rxPolarization") @ExcludeMissing private val rxPolarization: JsonField<String>,
        ...
        @JsonProperty("spacingAzimuth") @ExcludeMissing private val spacingAzimuth: JsonField<Double>,
        ...
        @JsonProperty("txPolarization") @ExcludeMissing private val txPolarization: JsonField<String>,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun continuousSpotAngle(): Optional<Double> = continuousSpotAngle.getOptional("continuousSpotAngle")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun groundResolutionProjection(): Optional<Double> = groundResolutionProjection.getOptional("groundResolutionProjection")
         ...
         */
        @JsonProperty("sarMode")
        @ExcludeMissing
        fun _sarMode(): JsonField<String> = sarMode
         ...
         *
         * Unlike [continuousSpotAngle], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _coordSys(): JsonField<String> = coordSys
        ...
        @ExcludeMissing
        fun _dwellTime(): JsonField<Double> = dwellTime
        ...
        @ExcludeMissing
        fun _farRange(): JsonField<Double> = farRange
        ...
        @ExcludeMissing
        fun _grazeAngle(): JsonField<Double> = grazeAngle

        /**
         * Returns the raw JSON value of [groundResolutionProjection].
         *
         * Unlike [groundResolutionProjection], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _looksAzimuth(): JsonField<Int> = looksAzimuth
        ...
        @ExcludeMissing
        fun _looksRange(): JsonField<Int> = looksRange
        ...
        @ExcludeMissing
        fun _nearRange(): JsonField<Double> = nearRange
        ...
        @ExcludeMissing
        fun _obDirection(): JsonField<String> = obDirection
        ...
        @ExcludeMissing
        fun _orbitState(): JsonField<String> = orbitState
         ...
         *
         * Unlike [resolutionAzimuth], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _senlatEnd(): JsonField<Double> = senlatEnd
        ...
        @ExcludeMissing
        fun _senlatStart(): JsonField<Double> = senlatStart
        ...
        @ExcludeMissing
        fun _senlonEnd(): JsonField<Double> = senlonEnd
        ...
        @ExcludeMissing
        fun _senlonStart(): JsonField<Double> = senlonStart
         ...
         */
        @JsonProperty("senvelx")
        @ExcludeMissing
        fun _senvelx(): JsonField<Double> = senvelx
         ...
         */
        @JsonProperty("senvely")
        @ExcludeMissing
        fun _senvely(): JsonField<Double> = senvely
         ...
         */
        @JsonProperty("senvelz")
        @ExcludeMissing
        fun _senvelz(): JsonField<Double> = senvelz
        ...
        @ExcludeMissing
        fun _slantRange(): JsonField<Double> = slantRange
        ...
        @ExcludeMissing
        fun _squintAngle(): JsonField<Double> = squintAngle
        ...
        @ExcludeMissing
        fun _swathLength(): JsonField<Double> = swathLength
        ...
        @ExcludeMissing
        fun _targetposx(): JsonField<Double> = targetposx
        ...
        @ExcludeMissing
        fun _targetposy(): JsonField<Double> = targetposy
        ...
        @ExcludeMissing
        fun _targetposz(): JsonField<Double> = targetposz
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    atext = body.atext
                    atype = body.atype
                    azimuthAngle = body.azimuthAngle
                    centerTime = body.centerTime
                    collectionId = body.collectionId
                    continuousSpotAngle = body.continuousSpotAngle
                    coordSys = body.coordSys
                    createdAt = body.createdAt
                    createdBy = body.createdBy
                    detectionEnd = body.detectionEnd
                    detectionId = body.detectionId
                    detectionStart = body.detectionStart
                    dwellTime = body.dwellTime
                    externalId = body.externalId
                    farRange = body.farRange
                    grazeAngle = body.grazeAngle
                    groundResolutionProjection = body.groundResolutionProjection
                    idOnOrbit = body.idOnOrbit
                    idSensor = body.idSensor
                    incidenceAngle = body.incidenceAngle
                    looksAzimuth = body.looksAzimuth
                    looksRange = body.looksRange
                    multilookNumber = body.multilookNumber
                    nearRange = body.nearRange
                    obDirection = body.obDirection
                    operatingBand = body.operatingBand
                    operatingFreq = body.operatingFreq
                    orbitState = body.orbitState
                    origin = body.origin
                    origNetwork = body.origNetwork
                    origObjectId = body.origObjectId
                    origSensorId = body.origSensorId
                    pulseBandwidth = body.pulseBandwidth
                    pulseDuration = body.pulseDuration
                    resolutionAzimuth = body.resolutionAzimuth
                    resolutionRange = body.resolutionRange
                    rxPolarization = body.rxPolarization
                    satNo = body.satNo
                    senalt = body.senalt
                    senlatEnd = body.senlatEnd
                    senlatStart = body.senlatStart
                    senlonEnd = body.senlonEnd
                    senlonStart = body.senlonStart
                    senvelx = body.senvelx
                    senvely = body.senvely
                    senvelz = body.senvelz
                    slantRange = body.slantRange
                    snr = body.snr
                    sourceDl = body.sourceDl
                    spacingAzimuth = body.spacingAzimuth
                    spacingRange = body.spacingRange
                    squintAngle = body.squintAngle
                    srcIds = body.srcIds.map { it.toMutableList() }
                    srcTyps = body.srcTyps.map { it.toMutableList() }
                    swathLength = body.swathLength
                    tags = body.tags.map { it.toMutableList() }
                    targetposx = body.targetposx
                    targetposy = body.targetposy
            ...
            /** Collection end time in ISO 8601 UTC format with microsecond precision. */
            fun collectionEnd(collectionEnd: OffsetDateTime) = collectionEnd(JsonField.of(collectionEnd))

            /**
             * Sets [Builder.collectionEnd] to an arbitrary JSON value.
             *
             * You should usually call [Builder.collectionEnd] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun collectionEnd(collectionEnd: JsonField<OffsetDateTime>) =
                apply {
                    this.collectionEnd = collectionEnd
                }

            /** Collection start time in ISO 8601 UTC format with microsecond precision. */
            fun collectionStart(collectionStart: OffsetDateTime) = collectionStart(JsonField.of(collectionStart))

            /**
             * Sets [Builder.collectionStart] to an arbitrary JSON value.
             *
             * You should usually call [Builder.collectionStart] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun collectionStart(collectionStart: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.sarMode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun sarMode(sarMode: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.azimuthAngle] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun azimuthAngle(azimuthAngle: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.centerTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun centerTime(centerTime: JsonField<OffsetDateTime>) =
                apply {
            ...
            /** Required sweep angle for the continuous spot scene in degrees. */
            fun continuousSpotAngle(continuousSpotAngle: Double) = continuousSpotAngle(JsonField.of(continuousSpotAngle))

            /**
             * Sets [Builder.continuousSpotAngle] to an arbitrary JSON value.
             *
             * You should usually call [Builder.continuousSpotAngle] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun continuousSpotAngle(continuousSpotAngle: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.coordSys] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun coordSys(coordSys: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.detectionEnd] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun detectionEnd(detectionEnd: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.detectionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun detectionId(detectionId: JsonField<String>) =
                apply {
                    this.detectionId = detectionId
                }

            /** The detection start time in ISO 8601 UTC format, with microsecond precision. */
            fun detectionStart(detectionStart: OffsetDateTime) = detectionStart(JsonField.of(detectionStart))

            /**
             * Sets [Builder.detectionStart] to an arbitrary JSON value.
             *
             * You should usually call [Builder.detectionStart] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun detectionStart(detectionStart: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.dwellTime] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dwellTime(dwellTime: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.farRange] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun farRange(farRange: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.grazeAngle] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun grazeAngle(grazeAngle: JsonField<Double>) =
                apply {
                    this.grazeAngle = grazeAngle
                }

            /** Distance between independent measurements, representing the physical dimension that represents a pixel of the image. */
            fun groundResolutionProjection(groundResolutionProjection: Double) = groundResolutionProjection(JsonField.of(groundResolutionProjection))

            /**
             * Sets [Builder.groundResolutionProjection] to an arbitrary JSON value.
             *
             * You should usually call [Builder.groundResolutionProjection] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun groundResolutionProjection(groundResolutionProjection: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.incidenceAngle] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun incidenceAngle(incidenceAngle: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.looksAzimuth] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun looksAzimuth(looksAzimuth: JsonField<Int>) =
                apply {
                    this.looksAzimuth = looksAzimuth
                }
             ...
             *
             * You should usually call [Builder.looksRange] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun looksRange(looksRange: JsonField<Int>) =
                apply {
                    this.looksRange = looksRange
                }

            /** Averages the input synthetic aperture radar (SAR) data by looks in range and azimuth to approximate square pixels, mitigates speckle, and reduces SAR tool processing time. */
            fun multilookNumber(multilookNumber: Double) = multilookNumber(JsonField.of(multilookNumber))

            /**
             * Sets [Builder.multilookNumber] to an arbitrary JSON value.
             *
             * You should usually call [Builder.multilookNumber] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun multilookNumber(multilookNumber: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.nearRange] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun nearRange(nearRange: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.obDirection] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun obDirection(obDirection: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.operatingBand] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun operatingBand(operatingBand: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.operatingFreq] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun operatingFreq(operatingFreq: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.orbitState] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun orbitState(orbitState: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.pulseBandwidth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pulseBandwidth(pulseBandwidth: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.pulseDuration] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pulseDuration(pulseDuration: JsonField<Double>) =
                apply {
                    this.pulseDuration = pulseDuration
                }

            /** The resolution in the azimuth direction measured in meters. */
            fun resolutionAzimuth(resolutionAzimuth: Double) = resolutionAzimuth(JsonField.of(resolutionAzimuth))

            /**
             * Sets [Builder.resolutionAzimuth] to an arbitrary JSON value.
             *
             * You should usually call [Builder.resolutionAzimuth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun resolutionAzimuth(resolutionAzimuth: JsonField<Double>) =
                apply {
                    this.resolutionAzimuth = resolutionAzimuth
                }

            /** The resolution in the range direction measured in meters. */
            fun resolutionRange(resolutionRange: Double) = resolutionRange(JsonField.of(resolutionRange))

            /**
             * Sets [Builder.resolutionRange] to an arbitrary JSON value.
             *
             * You should usually call [Builder.resolutionRange] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun resolutionRange(resolutionRange: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.rxPolarization] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rxPolarization(rxPolarization: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.senlatEnd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun senlatEnd(senlatEnd: JsonField<Double>) =
                apply {
                    this.senlatEnd = senlatEnd
                }
             ...
             *
             * You should usually call [Builder.senlatStart] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun senlatStart(senlatStart: JsonField<Double>) =
                apply {
                    this.senlatStart = senlatStart
                }
             ...
             *
             * You should usually call [Builder.senlonEnd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun senlonEnd(senlonEnd: JsonField<Double>) =
                apply {
                    this.senlonEnd = senlonEnd
                }
             ...
             *
             * You should usually call [Builder.senlonStart] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun senlonStart(senlonStart: JsonField<Double>) =
                apply {
                    this.senlonStart = senlonStart
                }
             ...
             *
             * You should usually call [Builder.senvelx] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun senvelx(senvelx: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.senvely] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun senvely(senvely: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.senvelz] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun senvelz(senvelz: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.slantRange] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun slantRange(slantRange: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.spacingAzimuth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun spacingAzimuth(spacingAzimuth: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.spacingRange] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun spacingRange(spacingRange: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.squintAngle] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun squintAngle(squintAngle: JsonField<Double>) =
                apply {
                    this.squintAngle = squintAngle
                }
             ...
             *
             * You should usually call [Builder.swathLength] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun swathLength(swathLength: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.targetposx] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun targetposx(targetposx: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.targetposy] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun targetposy(targetposy: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.targetposz] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun targetposz(targetposz: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.txPolarization] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun txPolarization(txPolarization: JsonField<String>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (if (collectionEnd.asKnown().isPresent) 1 else 0) + (if (collectionStart.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (sarMode.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (agjson.asKnown().isPresent) 1 else 0) + (if (andims.asKnown().isPresent) 1 else 0) + (if (area.asKnown().isPresent) 1 else 0) + (if (asrid.asKnown().isPresent) 1 else 0) + (if (atext.asKnown().isPresent) 1 else 0) + (if (atype.asKnown().isPresent) 1 else 0) + (if (azimuthAngle.asKnown().isPresent) 1 else 0) + (if (centerTime.asKnown().isPresent) 1 else 0) + (if (collectionId.asKnown().isPresent) 1 else 0) + (if (continuousSpotAngle.asKnown().isPresent) 1 else 0) + (if (coordSys.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (detectionEnd.asKnown().isPresent) 1 else 0) + (if (detectionId.asKnown().isPresent) 1 else 0) + (if (detectionStart.asKnown().isPresent) 1 else 0) + (if (dwellTime.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (if (farRange.asKnown().isPresent) 1 else 0) + (if (grazeAngle.asKnown().isPresent) 1 else 0) + (if (groundResolutionProjection.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (incidenceAngle.asKnown().isPresent) 1 else 0) + (if (looksAzimuth.asKnown().isPresent) 1 else 0) + (if (looksRange.asKnown().isPresent) 1 else 0) + (if (multilookNumber.asKnown().isPresent) 1 else 0) + (if (nearRange.asKnown().isPresent) 1 else 0) + (if (obDirection.asKnown().isPresent) 1 else 0) + (if (operatingBand.asKnown().isPresent) 1 else 0) + (if (operatingFreq.asKnown().isPresent) 1 else 0) + (if (orbitState.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (pulseBandwidth.asKnown().isPresent) 1 else 0) + (if (pulseDuration.asKnown().isPresent) 1 else 0) + (if (resolutionAzimuth.asKnown().isPresent) 1 else 0) + (if (resolutionRange.asKnown().isPresent) 1 else 0) + (if (rxPolarization.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlatEnd.asKnown().isPresent) 1 else 0) + (if (senlatStart.asKnown().isPresent) 1 else 0) + (if (senlonEnd.asKnown().isPresent) 1 else 0) + (if (senlonStart.asKnown().isPresent) 1 else 0) + (if (senvelx.asKnown().isPresent) 1 else 0) + (if (senvely.asKnown().isPresent) 1 else 0) + (if (senvelz.asKnown().isPresent) 1 else 0) + (if (slantRange.asKnown().isPresent) 1 else 0) + (if (snr.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (spacingAzimuth.asKnown().isPresent) 1 else 0) + (if (spacingRange.asKnown().isPresent) 1 else 0) + (if (squintAngle.asKnown().isPresent) 1 else 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (if (swathLength.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (targetposx.asKnown().isPresent) 1 else 0) + (if (targetposy.asKnown().isPresent) 1 else 0) + (if (targetposz.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (txPolarization.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "SarObservationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
