...
class DropzoneRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): DropzoneRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DropzoneRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [DropzoneRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneRetrieveParams: DropzoneRetrieveParams) =
            apply {
                id = dropzoneRetrieveParams.id
                firstResult = dropzoneRetrieveParams.firstResult
                maxResults = dropzoneRetrieveParams.maxResults
                additionalHeaders = dropzoneRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = dropzoneRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DropzoneRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DropzoneRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is DropzoneRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "DropzoneRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
