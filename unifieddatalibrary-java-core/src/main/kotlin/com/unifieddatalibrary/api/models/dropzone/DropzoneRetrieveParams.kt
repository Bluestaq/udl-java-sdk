...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DropzoneRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneRetrieveParams: DropzoneRetrieveParams) = apply {
    ...
    override fun toString() =
        "DropzoneRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
