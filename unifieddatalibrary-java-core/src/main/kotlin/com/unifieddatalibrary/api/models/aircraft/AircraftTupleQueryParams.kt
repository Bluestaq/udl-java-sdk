 ...
 */
class AircraftTupleQueryParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftTupleQueryParams].
         *
    ...
    /** A builder for [AircraftTupleQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftTupleQueryParams: AircraftTupleQueryParams) = apply {
            columns = aircraftTupleQueryParams.columns
            firstResult = aircraftTupleQueryParams.firstResult
            maxResults = aircraftTupleQueryParams.maxResults
            additionalHeaders = aircraftTupleQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftTupleQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftTupleQueryParams].
         *
         ...
         */
        fun build(): AircraftTupleQueryParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftTupleQueryParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AircraftTupleQueryParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
