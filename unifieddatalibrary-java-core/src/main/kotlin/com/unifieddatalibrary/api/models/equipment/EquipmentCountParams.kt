...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EquipmentCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentCountParams: EquipmentCountParams) = apply {
    ...
    override fun toString() =
        "EquipmentCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
