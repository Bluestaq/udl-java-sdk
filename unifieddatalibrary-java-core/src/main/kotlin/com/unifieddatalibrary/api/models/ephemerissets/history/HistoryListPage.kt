...
class HistoryListPage private constructor(
    ...
    private val items: List<EphemerisSet>,
    ...
    fun autoPager(): AutoPager<EphemerisSet> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<EphemerisSet> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<EphemerisSet>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<EphemerisSet>) =
            apply {
                this.items = items
            }
