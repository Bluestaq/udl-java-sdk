 ...
 */
class AirfieldSlotConsumptionTupleParams
private constructor(
    ...
    /** A builder for [AirfieldSlotConsumptionTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotConsumptionTupleParams: AirfieldSlotConsumptionTupleParams) =
            apply {
                columns = airfieldSlotConsumptionTupleParams.columns
                startTime = airfieldSlotConsumptionTupleParams.startTime
                firstResult = airfieldSlotConsumptionTupleParams.firstResult
                maxResults = airfieldSlotConsumptionTupleParams.maxResults
                additionalHeaders = airfieldSlotConsumptionTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    airfieldSlotConsumptionTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldSlotConsumptionTupleParams].
         *
         ...
         */
        fun build(): AirfieldSlotConsumptionTupleParams =
            AirfieldSlotConsumptionTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirfieldSlotConsumptionTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirfieldSlotConsumptionTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
