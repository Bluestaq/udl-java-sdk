...
class AircraftStatusRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AircraftStatusRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusRetrieveParams: AircraftStatusRetrieveParams) =
            apply {
    ...
    override fun toString() = "AircraftStatusRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
