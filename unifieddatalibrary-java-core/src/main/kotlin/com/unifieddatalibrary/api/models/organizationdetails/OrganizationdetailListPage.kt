...
class OrganizationdetailListPage
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationdetailListPage: OrganizationdetailListPage) = apply {
            service = organizationdetailListPage.service
            params = organizationdetailListPage.params
            items = organizationdetailListPage.items
        }

        fun service(service: OrganizationdetailService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationdetailListPage &&
    ...
    override fun toString() =
        "OrganizationdetailListPage{service=$service, params=$params, items=$items}"
}
