...
/**
 * Service operation to update a single IR. An IR is an on-orbit infrared payload. A specific role
 * is required to perform this service operation. Please contact the UDL team for assistance.
 */
class IrUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IrUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(irUpdateParams: IrUpdateParams) = apply {
            pathId = irUpdateParams.pathId
            body = irUpdateParams.body.toBuilder()
            additionalHeaders = irUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = irUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IrUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IrUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "IrUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
