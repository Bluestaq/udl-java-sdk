...
/**
 * Service operation to take a single OnorbitList as a POST body and ingest into the database. An
...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, description=$description, onorbits=$onorbits, origin=$origin, additionalProperties=$additionalProperties}"
    }
