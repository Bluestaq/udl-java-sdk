 ...
 */
class MissileTrackTupleResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissileTrackTupleResponse].
         *
    ...
    /** A builder for [MissileTrackTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missileTrackTupleResponse: MissileTrackTupleResponse) = apply {
            classificationMarking = missileTrackTupleResponse.classificationMarking
            dataMode = missileTrackTupleResponse.dataMode
            source = missileTrackTupleResponse.source
            ts = missileTrackTupleResponse.ts
            id = missileTrackTupleResponse.id
            acftSubType = missileTrackTupleResponse.acftSubType
            alert = missileTrackTupleResponse.alert
            angElev = missileTrackTupleResponse.angElev
            aouRptData = missileTrackTupleResponse.aouRptData.map { it.toMutableList() }
            aouRptType = missileTrackTupleResponse.aouRptType
            azCorr = missileTrackTupleResponse.azCorr
            boosting = missileTrackTupleResponse.boosting
            burnoutAlt = missileTrackTupleResponse.burnoutAlt
            callSign = missileTrackTupleResponse.callSign
            containment = missileTrackTupleResponse.containment
            contextKeys = missileTrackTupleResponse.contextKeys.map { it.toMutableList() }
            contextValues = missileTrackTupleResponse.contextValues.map { it.toMutableList() }
            createdAt = missileTrackTupleResponse.createdAt
            createdBy = missileTrackTupleResponse.createdBy
            dropPtInd = missileTrackTupleResponse.dropPtInd
            emgInd = missileTrackTupleResponse.emgInd
            env = missileTrackTupleResponse.env
            impactAlt = missileTrackTupleResponse.impactAlt
            impactAouData = missileTrackTupleResponse.impactAouData.map { it.toMutableList() }
            impactAouType = missileTrackTupleResponse.impactAouType
            impactConf = missileTrackTupleResponse.impactConf
            impactLat = missileTrackTupleResponse.impactLat
            impactLon = missileTrackTupleResponse.impactLon
            impactTime = missileTrackTupleResponse.impactTime
            infoSource = missileTrackTupleResponse.infoSource
            launchAlt = missileTrackTupleResponse.launchAlt
            launchAouData = missileTrackTupleResponse.launchAouData.map { it.toMutableList() }
            launchAouType = missileTrackTupleResponse.launchAouType
            launchAz = missileTrackTupleResponse.launchAz
            launchAzUnc = missileTrackTupleResponse.launchAzUnc
            launchConf = missileTrackTupleResponse.launchConf
            launchLat = missileTrackTupleResponse.launchLat
            launchLon = missileTrackTupleResponse.launchLon
            launchTime = missileTrackTupleResponse.launchTime
            lostTrkInd = missileTrackTupleResponse.lostTrkInd
            maneuverEnd = missileTrackTupleResponse.maneuverEnd
            maneuverStart = missileTrackTupleResponse.maneuverStart
            msgCreateDate = missileTrackTupleResponse.msgCreateDate
            msgSubType = missileTrackTupleResponse.msgSubType
            msgType = missileTrackTupleResponse.msgType
            mslStatus = missileTrackTupleResponse.mslStatus
            muidSrc = missileTrackTupleResponse.muidSrc
            muidSrcTrk = missileTrackTupleResponse.muidSrcTrk
            name = missileTrackTupleResponse.name
            objAct = missileTrackTupleResponse.objAct
            objIdent = missileTrackTupleResponse.objIdent
            objPlat = missileTrackTupleResponse.objPlat
            objType = missileTrackTupleResponse.objType
            objTypeConf = missileTrackTupleResponse.objTypeConf
            origin = missileTrackTupleResponse.origin
            origNetwork = missileTrackTupleResponse.origNetwork
            parentTrackId = missileTrackTupleResponse.parentTrackId
            polarSingLocLat = missileTrackTupleResponse.polarSingLocLat
            polarSingLocLon = missileTrackTupleResponse.polarSingLocLon
            senMode = missileTrackTupleResponse.senMode
            spaceAmp = missileTrackTupleResponse.spaceAmp
            spaceAmpConf = missileTrackTupleResponse.spaceAmpConf
            spaceSpecType = missileTrackTupleResponse.spaceSpecType
            trackId = missileTrackTupleResponse.trackId
            trkConf = missileTrackTupleResponse.trkConf
            trkQual = missileTrackTupleResponse.trkQual
            vectors = missileTrackTupleResponse.vectors.map { it.toMutableList() }
            additionalProperties = missileTrackTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MissileTrackTupleResponse].
         *
         ...
         */
        fun build(): MissileTrackTupleResponse =
    ...
    fun validate(): MissileTrackTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MissileTrackTupleResponse &&
