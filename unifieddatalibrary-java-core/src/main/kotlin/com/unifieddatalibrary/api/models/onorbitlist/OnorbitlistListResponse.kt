...
class OnorbitlistListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistListResponse: OnorbitlistListResponse) =
            apply {
                ...
                onorbits = onorbitlistListResponse.onorbits.map { it.toMutableList() }
    ...
    fun validate(): OnorbitlistListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "OnorbitlistListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, description=$description, onorbits=$onorbits, origin=$origin, additionalProperties=$additionalProperties}"
}
