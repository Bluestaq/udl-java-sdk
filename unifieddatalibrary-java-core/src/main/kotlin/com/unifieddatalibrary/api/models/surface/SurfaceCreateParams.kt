...
class SurfaceCreateParams private constructor(
     ...
     *
     * Unlike [sbttWtKipModNote], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceCreateParams].
         *
    ...
    /** A builder for [SurfaceCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceCreateParams: SurfaceCreateParams) =
            apply {
                body = surfaceCreateParams.body.toBuilder()
                additionalHeaders = surfaceCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = surfaceCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Alternate site identifier provided by the source. */
        fun altSiteId(altSiteId: String) =
            apply {
                body.altSiteId(altSiteId)
            }

        /**
         * Sets [Builder.altSiteId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.altSiteId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun altSiteId(altSiteId: JsonField<String>) =
            apply {
                body.altSiteId(altSiteId)
            }
        ...
        /** The max weight allowable on this surface type for a DDT-type (double dual tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun ddtWtKip(ddtWtKip: Double) =
            apply {
                body.ddtWtKip(ddtWtKip)
            }

        /**
         * Sets [Builder.ddtWtKip] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ddtWtKip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ddtWtKip(ddtWtKip: JsonField<Double>) =
            apply {
                body.ddtWtKip(ddtWtKip)
            }

        /** The modified max weight allowable on this surface type for a DDT-type (double dual tandem) landing gear configuration, in kilopounds (kip). */
        fun ddtWtKipMod(ddtWtKipMod: Double) =
            apply {
                body.ddtWtKipMod(ddtWtKipMod)
            }

        /**
         * Sets [Builder.ddtWtKipMod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ddtWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ddtWtKipMod(ddtWtKipMod: JsonField<Double>) =
            apply {
                body.ddtWtKipMod(ddtWtKipMod)
            }
         ...
         *
         * You should usually call [Builder.ddtWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ddtWtKipModNote(ddtWtKipModNote: JsonField<String>) =
            apply {
                body.ddtWtKipModNote(ddtWtKipModNote)
            }

        /** The max weight allowable on this surface type for a DDT-type (double dual tandem) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun ddtWtKn(ddtWtKn: Double) =
            apply {
                body.ddtWtKn(ddtWtKn)
            }

        /**
         * Sets [Builder.ddtWtKn] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ddtWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ddtWtKn(ddtWtKn: JsonField<Double>) =
            apply {
                body.ddtWtKn(ddtWtKn)
            }

        /** The max weight allowable on this surface type for an FAA 2D-type (twin tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun ddWtKip(ddWtKip: Double) =
            apply {
                body.ddWtKip(ddWtKip)
            }

        /**
         * Sets [Builder.ddWtKip] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ddWtKip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ddWtKip(ddWtKip: JsonField<Double>) =
            apply {
                body.ddWtKip(ddWtKip)
            }

        /** The modified max weight allowable on this surface type for an FAA 2D-type (twin tandem) landing gear configuration, in kilopounds (kip). */
        fun ddWtKipMod(ddWtKipMod: Double) =
            apply {
                body.ddWtKipMod(ddWtKipMod)
            }

        /**
         * Sets [Builder.ddWtKipMod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ddWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ddWtKipMod(ddWtKipMod: JsonField<Double>) =
            apply {
                body.ddWtKipMod(ddWtKipMod)
            }
         ...
         *
         * You should usually call [Builder.ddWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ddWtKipModNote(ddWtKipModNote: JsonField<String>) =
            apply {
                body.ddWtKipModNote(ddWtKipModNote)
            }

        /** The max weight allowable on this surface type for an FAA 2D-type (twin tandem) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun ddWtKn(ddWtKn: Double) =
            apply {
                body.ddWtKn(ddWtKn)
            }
         ...
         *
         * You should usually call [Builder.ddWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ddWtKn(ddWtKn: JsonField<Double>) =
            apply {
                body.ddWtKn(ddWtKn)
            }

        /** WGS-84 latitude of the coordinate representing the end-point of a surface, in degrees. -90 to 90 degrees (negative values south of equator). */
        fun endLat(endLat: Double) =
            apply {
                body.endLat(endLat)
            }
         ...
         *
         * You should usually call [Builder.lcn] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lcn(lcn: JsonField<Int>) =
            apply {
                body.lcn(lcn)
            }

        /** The landing distance available for the runway, in feet. Applicable for runway surface types only. */
        fun ldaFt(ldaFt: Double) =
            apply {
                body.ldaFt(ldaFt)
            }
         ...
         *
         * You should usually call [Builder.ldaFt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ldaFt(ldaFt: JsonField<Double>) =
            apply {
                body.ldaFt(ldaFt)
            }

        /** The landing distance available for the runway, in meters. Applicable for runway surface types only. */
        fun ldaM(ldaM: Double) =
            apply {
                body.ldaM(ldaM)
            }
         ...
         *
         * You should usually call [Builder.ldaM] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ldaM(ldaM: JsonField<Double>) =
            apply {
                body.ldaM(ldaM)
            }

        /** The length of the surface type, in feet. Applicable for runway and parking surface types. */
        fun lengthFt(lengthFt: Double) =
            apply {
                body.lengthFt(lengthFt)
            }

        /**
         * Sets [Builder.lengthFt] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lengthFt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lengthFt(lengthFt: JsonField<Double>) =
            apply {
                body.lengthFt(lengthFt)
            }

        /** The length of the surface type, in meters. Applicable for runway and parking surface types. */
        fun lengthM(lengthM: Double) =
            apply {
                body.lengthM(lengthM)
            }

        /**
         * Sets [Builder.lengthM] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lengthM] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lengthM(lengthM: JsonField<Double>) =
            apply {
                body.lengthM(lengthM)
            }

        /** Flag indicating the surface has lighting. */
        fun lighting(lighting: Boolean) =
            apply {
         ...
         *
         * You should usually call [Builder.lighting] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lighting(lighting: JsonField<Boolean>) =
            apply {
                body.lighting(lighting)
            }

        /** Flag indicating the runway has approach lights. Applicable for runway surface types only. */
        fun lightsAprch(lightsAprch: Boolean) =
            apply {
                body.lightsAprch(lightsAprch)
            }

        /**
         * Sets [Builder.lightsAprch] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsAprch] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsAprch(lightsAprch: JsonField<Boolean>) =
            apply {
                body.lightsAprch(lightsAprch)
            }

        /** Flag indicating the runway has centerline lights. Applicable for runway surface types only. */
        fun lightsCl(lightsCl: Boolean) =
            apply {
                body.lightsCl(lightsCl)
            }

        /**
         * Sets [Builder.lightsCl] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsCl] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsCl(lightsCl: JsonField<Boolean>) =
            apply {
                body.lightsCl(lightsCl)
            }

        /** Flag indicating the runway has Optical Landing System (OLS) lights. Applicable for runway surface types only. */
        fun lightsOls(lightsOls: Boolean) =
            apply {
                body.lightsOls(lightsOls)
            }

        /**
         * Sets [Builder.lightsOls] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsOls] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsOls(lightsOls: JsonField<Boolean>) =
            apply {
                body.lightsOls(lightsOls)
            }

        /** Flag indicating the runway has Precision Approach Path Indicator (PAPI) lights. Applicable for runway surface types only. */
        fun lightsPapi(lightsPapi: Boolean) =
            apply {
                body.lightsPapi(lightsPapi)
            }

        /**
         * Sets [Builder.lightsPapi] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsPapi] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsPapi(lightsPapi: JsonField<Boolean>) =
            apply {
                body.lightsPapi(lightsPapi)
            }

        /** Flag indicating the runway has Runway End Identifier Lights (REIL). Applicable for runway surface types only. */
        fun lightsReil(lightsReil: Boolean) =
            apply {
                body.lightsReil(lightsReil)
            }

        /**
         * Sets [Builder.lightsReil] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsReil] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsReil(lightsReil: JsonField<Boolean>) =
            apply {
                body.lightsReil(lightsReil)
            }

        /** Flag indicating the runway has edge lighting. Applicable for runway surface types only. */
        fun lightsRwy(lightsRwy: Boolean) =
            apply {
                body.lightsRwy(lightsRwy)
            }

        /**
         * Sets [Builder.lightsRwy] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsRwy] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsRwy(lightsRwy: JsonField<Boolean>) =
            apply {
                body.lightsRwy(lightsRwy)
            }

        /** Flag indicating the runway has Sequential Flashing (SEQFL) lights. Applicable for runway surface types only. */
        fun lightsSeqfl(lightsSeqfl: Boolean) =
            apply {
                body.lightsSeqfl(lightsSeqfl)
            }

        /**
         * Sets [Builder.lightsSeqfl] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsSeqfl] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsSeqfl(lightsSeqfl: JsonField<Boolean>) =
            apply {
                body.lightsSeqfl(lightsSeqfl)
            }

        /** Flag indicating the runway has Touchdown Zone lights. Applicable for runway surface types only. */
        fun lightsTdzl(lightsTdzl: Boolean) =
            apply {
                body.lightsTdzl(lightsTdzl)
            }

        /**
         * Sets [Builder.lightsTdzl] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsTdzl] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsTdzl(lightsTdzl: JsonField<Boolean>) =
            apply {
                body.lightsTdzl(lightsTdzl)
            }

        /** Flag indicating the runway lighting is unknown. Applicable for runway surface types only. */
        fun lightsUnkn(lightsUnkn: Boolean) =
            apply {
                body.lightsUnkn(lightsUnkn)
            }

        /**
         * Sets [Builder.lightsUnkn] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsUnkn] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsUnkn(lightsUnkn: JsonField<Boolean>) =
            apply {
                body.lightsUnkn(lightsUnkn)
            }

        /** Flag indicating the runway has Visual Approach Slope Indicator (VASI) lights. Applicable for runway surface types only. */
        fun lightsVasi(lightsVasi: Boolean) =
            apply {
                body.lightsVasi(lightsVasi)
            }

        /**
         * Sets [Builder.lightsVasi] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightsVasi] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightsVasi(lightsVasi: JsonField<Boolean>) =
            apply {
                body.lightsVasi(lightsVasi)
            }
         ...
         *
         * You should usually call [Builder.material] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun material(material: JsonField<String>) =
            apply {
                body.material(material)
            }

        /** Flag indicating that one or more obstacles or obstructions exist in the proximity of this surface. */
        fun obstacle(obstacle: Boolean) =
            apply {
         ...
         *
         * You should usually call [Builder.obstacle] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun obstacle(obstacle: JsonField<Boolean>) =
            apply {
                body.obstacle(obstacle)
            }
         ...
         *
         * You should usually call [Builder.pcn] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pcn(pcn: JsonField<String>) =
            apply {
                body.pcn(pcn)
            }
         ...
         *
         * You should usually call [Builder.pointReference] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pointReference(pointReference: JsonField<String>) =
            apply {
                body.pointReference(pointReference)
            }

        /** Flag indicating this is the primary runway. Applicable for runway surface types only. */
        fun primary(primary: Boolean) =
            apply {
         ...
         *
         * You should usually call [Builder.rawWbc] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rawWbc(rawWbc: JsonField<String>) =
            apply {
                body.rawWbc(rawWbc)
            }

        /** The max weight allowable on this surface type for an SBTT-type (single belly twin tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun sbttWtKip(sbttWtKip: Double) =
            apply {
                body.sbttWtKip(sbttWtKip)
            }

        /**
         * Sets [Builder.sbttWtKip] to an arbitrary JSON value.
         *
         * You should usually call [Builder.sbttWtKip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sbttWtKip(sbttWtKip: JsonField<Double>) =
            apply {
                body.sbttWtKip(sbttWtKip)
            }

        /** The modified max weight allowable on this surface type for an SBTT-type (single belly twin tandem) landing gear configuration, in kilopounds (kip). */
        fun sbttWtKipMod(sbttWtKipMod: Double) =
            apply {
         ...
         *
         * You should usually call [Builder.sbttWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sbttWtKipMod(sbttWtKipMod: JsonField<Double>) =
            apply {
                body.sbttWtKipMod(sbttWtKipMod)
            }
         ...
         *
         * You should usually call [Builder.sbttWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sbttWtKipModNote(sbttWtKipModNote: JsonField<String>) =
            apply {
                body.sbttWtKipModNote(sbttWtKipModNote)
            }

        /** The max weight allowable on this surface type for an SBTT-type (single belly twin tandem) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun sbttWtKn(sbttWtKn: Double) =
            apply {
                body.sbttWtKn(sbttWtKn)
            }

        /**
         * Sets [Builder.sbttWtKn] to an arbitrary JSON value.
         *
         * You should usually call [Builder.sbttWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sbttWtKn(sbttWtKn: JsonField<Double>) =
            apply {
                body.sbttWtKn(sbttWtKn)
            }

        /** WGS-84 latitude of the coordinate representing the start-point of a surface, in degrees. -90 to 90 degrees (negative values south of equator). */
        fun startLat(startLat: Double) =
            apply {
        ...
        /** The max weight allowable on this surface type for an ST-type (single tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun stWtKip(stWtKip: Double) =
            apply {
                body.stWtKip(stWtKip)
            }

        /**
         * Sets [Builder.stWtKip] to an arbitrary JSON value.
         *
         * You should usually call [Builder.stWtKip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stWtKip(stWtKip: JsonField<Double>) =
            apply {
                body.stWtKip(stWtKip)
            }

        /** The modified max weight allowable on this surface type for an ST-type (single tandem) landing gear configuration, in kilopounds (kip). */
        fun stWtKipMod(stWtKipMod: Double) =
            apply {
                body.stWtKipMod(stWtKipMod)
            }

        /**
         * Sets [Builder.stWtKipMod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.stWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stWtKipMod(stWtKipMod: JsonField<Double>) =
            apply {
                body.stWtKipMod(stWtKipMod)
            }
         ...
         *
         * You should usually call [Builder.stWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stWtKipModNote(stWtKipModNote: JsonField<String>) =
            apply {
                body.stWtKipModNote(stWtKipModNote)
            }

        /** The max weight allowable on this surface type for an ST-type (single tandem) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun stWtKn(stWtKn: Double) =
            apply {
                body.stWtKn(stWtKn)
            }
         ...
         *
         * You should usually call [Builder.stWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stWtKn(stWtKn: JsonField<Double>) =
            apply {
                body.stWtKn(stWtKn)
            }

        /** The max weight allowable on this surface type for an S-type (single) landing gear configuration, in kilopounds (kip). Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun sWtKip(sWtKip: Double) =
            apply {
                body.sWtKip(sWtKip)
            }
         ...
         *
         * You should usually call [Builder.sWtKip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sWtKip(sWtKip: JsonField<Double>) =
            apply {
                body.sWtKip(sWtKip)
            }

        /** The modified max weight allowable on this surface type for an S-type (single) landing gear configuration, in kilopounds (kip). */
        fun sWtKipMod(sWtKipMod: Double) =
            apply {
                body.sWtKipMod(sWtKipMod)
            }

        /**
         * Sets [Builder.sWtKipMod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.sWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sWtKipMod(sWtKipMod: JsonField<Double>) =
            apply {
                body.sWtKipMod(sWtKipMod)
            }

        /** User input rationale for the manual modification of the prescribed value indicating the max weight allowable on this surface for an S-type (single) landing gear configuration. For more information, contact the provider source. */
        fun sWtKipModNote(sWtKipModNote: String) =
            apply {
         ...
         *
         * You should usually call [Builder.sWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sWtKipModNote(sWtKipModNote: JsonField<String>) =
            apply {
                body.sWtKipModNote(sWtKipModNote)
            }

        /** The max weight allowable on this surface type for an S-type (single) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun sWtKn(sWtKn: Double) =
            apply {
                body.sWtKn(sWtKn)
            }
         ...
         *
         * You should usually call [Builder.sWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sWtKn(sWtKn: JsonField<Double>) =
            apply {
                body.sWtKn(sWtKn)
            }

        /** The max weight allowable on this surface type for a TDT-type (twin delta tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun tdtWtkip(tdtWtkip: Double) =
            apply {
                body.tdtWtkip(tdtWtkip)
            }

        /**
         * Sets [Builder.tdtWtkip] to an arbitrary JSON value.
         *
         * You should usually call [Builder.tdtWtkip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tdtWtkip(tdtWtkip: JsonField<Double>) =
            apply {
                body.tdtWtkip(tdtWtkip)
            }

        /** The modified max weight allowable on this surface type for a TDT-type (twin delta tandem) landing gear configuration, in kilopounds (kip). */
        fun tdtWtKipMod(tdtWtKipMod: Double) =
            apply {
                body.tdtWtKipMod(tdtWtKipMod)
            }

        /**
         * Sets [Builder.tdtWtKipMod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.tdtWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tdtWtKipMod(tdtWtKipMod: JsonField<Double>) =
            apply {
                body.tdtWtKipMod(tdtWtKipMod)
            }
         ...
         *
         * You should usually call [Builder.tdtWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tdtWtKipModNote(tdtWtKipModNote: JsonField<String>) =
            apply {
                body.tdtWtKipModNote(tdtWtKipModNote)
            }

        /** The max weight allowable on this surface type for a TDT-type (twin delta tandem) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun tdtWtKn(tdtWtKn: Double) =
            apply {
                body.tdtWtKn(tdtWtKn)
            }

        /**
         * Sets [Builder.tdtWtKn] to an arbitrary JSON value.
         *
         * You should usually call [Builder.tdtWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tdtWtKn(tdtWtKn: JsonField<Double>) =
            apply {
                body.tdtWtKn(tdtWtKn)
            }

        /** The max weight allowable on this surface type for a TRT-type (triple tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun trtWtKip(trtWtKip: Double) =
            apply {
                body.trtWtKip(trtWtKip)
            }

        /**
         * Sets [Builder.trtWtKip] to an arbitrary JSON value.
         *
         * You should usually call [Builder.trtWtKip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trtWtKip(trtWtKip: JsonField<Double>) =
            apply {
                body.trtWtKip(trtWtKip)
            }

        /** The modified max weight allowable on this surface type for a TRT-type (triple tandem) landing gear configuration, in kilopounds (kip). */
        fun trtWtKipMod(trtWtKipMod: Double) =
            apply {
                body.trtWtKipMod(trtWtKipMod)
            }

        /**
         * Sets [Builder.trtWtKipMod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.trtWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trtWtKipMod(trtWtKipMod: JsonField<Double>) =
            apply {
                body.trtWtKipMod(trtWtKipMod)
            }
         ...
         *
         * You should usually call [Builder.trtWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trtWtKipModNote(trtWtKipModNote: JsonField<String>) =
            apply {
                body.trtWtKipModNote(trtWtKipModNote)
            }

        /** The max weight allowable on this surface type for a TRT-type (triple tandem) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun trtWtKn(trtWtKn: Double) =
            apply {
                body.trtWtKn(trtWtKn)
            }

        /**
         * Sets [Builder.trtWtKn] to an arbitrary JSON value.
         *
         * You should usually call [Builder.trtWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trtWtKn(trtWtKn: JsonField<Double>) =
            apply {
                body.trtWtKn(trtWtKn)
            }

        /** The max weight allowable on this surface type for a GDSS TT-type (twin tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun ttWtKip(ttWtKip: Double) =
            apply {
                body.ttWtKip(ttWtKip)
            }

        /**
         * Sets [Builder.ttWtKip] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ttWtKip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ttWtKip(ttWtKip: JsonField<Double>) =
            apply {
                body.ttWtKip(ttWtKip)
            }

        /** The modified max weight allowable on this surface type for a GDSS TT-type (twin tandem) landing gear configuration, in kilopounds (kip). */
        fun ttWtKipMod(ttWtKipMod: Double) =
            apply {
                body.ttWtKipMod(ttWtKipMod)
            }

        /**
         * Sets [Builder.ttWtKipMod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ttWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ttWtKipMod(ttWtKipMod: JsonField<Double>) =
            apply {
                body.ttWtKipMod(ttWtKipMod)
            }
         ...
         *
         * You should usually call [Builder.ttWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ttWtKipModNote(ttWtKipModNote: JsonField<String>) =
            apply {
                body.ttWtKipModNote(ttWtKipModNote)
            }

        /** The max weight allowable on this surface type for a GDSS TT-type (twin tandem) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun ttWtKn(ttWtKn: Double) =
            apply {
                body.ttWtKn(ttWtKn)
            }
         ...
         *
         * You should usually call [Builder.ttWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ttWtKn(ttWtKn: JsonField<Double>) =
            apply {
                body.ttWtKn(ttWtKn)
            }

        /** The max weight allowable on this surface type for a T-type (twin (dual)) landing gear configuration, in kilopounds (kip).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun tWtKip(tWtKip: Double) =
            apply {
                body.tWtKip(tWtKip)
            }
         ...
         *
         * You should usually call [Builder.tWtKip] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tWtKip(tWtKip: JsonField<Double>) =
            apply {
                body.tWtKip(tWtKip)
            }

        /** The modified max weight allowable on this surface type for a T-type (twin (dual)) landing gear configuration, in kilopounds (kip). */
        fun tWtKipMod(tWtKipMod: Double) =
            apply {
                body.tWtKipMod(tWtKipMod)
            }

        /**
         * Sets [Builder.tWtKipMod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.tWtKipMod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tWtKipMod(tWtKipMod: JsonField<Double>) =
            apply {
                body.tWtKipMod(tWtKipMod)
            }

        /** User input rationale for the manual modification of the prescribed value indicating the max weight allowable on this surface for a T-type (twin(dual)) landing gear configuration. For more information, contact the provider source. */
        fun tWtKipModNote(tWtKipModNote: String) =
            apply {
         ...
         *
         * You should usually call [Builder.tWtKipModNote] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tWtKipModNote(tWtKipModNote: JsonField<String>) =
            apply {
                body.tWtKipModNote(tWtKipModNote)
            }

        /** The max weight allowable on this surface type for a T-type (twin (dual)) landing gear configuration, in kilonewtons (kN).Note: The corresponding equivalent field is not converted by the UDL and may or may not be supplied by the provider. The provider/consumer is responsible for all unit conversions. */
        fun tWtKn(tWtKn: Double) =
            apply {
                body.tWtKn(tWtKn)
            }
         ...
         *
         * You should usually call [Builder.tWtKn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tWtKn(tWtKn: JsonField<Double>) =
            apply {
                body.tWtKn(tWtKn)
            }

        /** The width of the surface type, in feet. */
        fun widthFt(widthFt: Double) =
            apply {
                body.widthFt(widthFt)
            }

        /**
         * Sets [Builder.widthFt] to an arbitrary JSON value.
         *
         * You should usually call [Builder.widthFt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun widthFt(widthFt: JsonField<Double>) =
            apply {
                body.widthFt(widthFt)
            }

        /** The width of the surface type, in meters. */
        fun widthM(widthM: Double) =
            apply {
                body.widthM(widthM)
            }
         ...
         *
         * You should usually call [Builder.widthM] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun widthM(widthM: JsonField<Double>) =
            apply {
                body.widthM(widthM)
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceCreateParams].
         *
    ...
    class Body private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("ddtWtKipMod") @ExcludeMissing ddtWtKipMod: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("ddtWtKipModNote") @ExcludeMissing ddtWtKipModNote: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("ddWtKipMod") @ExcludeMissing ddWtKipMod: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("ddWtKipModNote") @ExcludeMissing ddWtKipModNote: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("lightsAPRCH") @ExcludeMissing lightsAprch: JsonField<Boolean> = JsonMissing.of(),
            ...
            @JsonProperty("lightsPAPI") @ExcludeMissing lightsPapi: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("lightsREIL") @ExcludeMissing lightsReil: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("lightsRWY") @ExcludeMissing lightsRwy: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("lightsSEQFL") @ExcludeMissing lightsSeqfl: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("lightsTDZL") @ExcludeMissing lightsTdzl: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("lightsUNKN") @ExcludeMissing lightsUnkn: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("lightsVASI") @ExcludeMissing lightsVasi: JsonField<Boolean> = JsonMissing.of(),
            ...
            @JsonProperty("pointReference") @ExcludeMissing pointReference: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("sbttWtKipMod") @ExcludeMissing sbttWtKipMod: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("sbttWtKipModNote") @ExcludeMissing sbttWtKipModNote: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("stWtKipMod") @ExcludeMissing stWtKipMod: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("stWtKipModNote") @ExcludeMissing stWtKipModNote: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("sWtKipModNote") @ExcludeMissing sWtKipModNote: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("tdtWtKipMod") @ExcludeMissing tdtWtKipMod: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("tdtWtKipModNote") @ExcludeMissing tdtWtKipModNote: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("trtWtKipMod") @ExcludeMissing trtWtKipMod: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("trtWtKipModNote") @ExcludeMissing trtWtKipModNote: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("ttWtKipMod") @ExcludeMissing ttWtKipMod: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("ttWtKipModNote") @ExcludeMissing ttWtKipModNote: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("tWtKipModNote") @ExcludeMissing tWtKipModNote: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _altSiteId(): JsonField<String> = altSiteId
        ...
        @ExcludeMissing
        fun _ddtWtKip(): JsonField<Double> = ddtWtKip
         ...
         * Unlike [ddtWtKn], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("ddtWtKN")
        @ExcludeMissing
        fun _ddtWtKn(): JsonField<Double> = ddtWtKn
         ...
         * Unlike [ddWtKip], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("ddWtKip")
        @ExcludeMissing
        fun _ddWtKip(): JsonField<Double> = ddWtKip
        ...
        @JsonProperty("ddWtKN")
        @ExcludeMissing
        fun _ddWtKn(): JsonField<Double> = ddWtKn
        ...
        @JsonProperty("ldaFt")
        @ExcludeMissing
        fun _ldaFt(): JsonField<Double> = ldaFt
        ...
        @JsonProperty("ldaM")
        @ExcludeMissing
        fun _ldaM(): JsonField<Double> = ldaM
        ...
        @ExcludeMissing
        fun _lengthFt(): JsonField<Double> = lengthFt
        ...
        @ExcludeMissing
        fun _lengthM(): JsonField<Double> = lengthM
        ...
        @ExcludeMissing
        fun _lighting(): JsonField<Boolean> = lighting
        ...
        @ExcludeMissing
        fun _lightsCl(): JsonField<Boolean> = lightsCl
        ...
        @ExcludeMissing
        fun _lightsOls(): JsonField<Boolean> = lightsOls
        ...
        @ExcludeMissing
        fun _lightsRwy(): JsonField<Boolean> = lightsRwy
        ...
        @ExcludeMissing
        fun _material(): JsonField<String> = material
        ...
        @ExcludeMissing
        fun _obstacle(): JsonField<Boolean> = obstacle
        ...
        @JsonProperty("rawWBC")
        @ExcludeMissing
        fun _rawWbc(): JsonField<String> = rawWbc
        ...
        @ExcludeMissing
        fun _sbttWtKip(): JsonField<Double> = sbttWtKip
        ...
        @ExcludeMissing
        fun _sbttWtKn(): JsonField<Double> = sbttWtKn
         ...
         * Unlike [stWtKip], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("stWtKip")
        @ExcludeMissing
        fun _stWtKip(): JsonField<Double> = stWtKip
        ...
        @JsonProperty("stWtKN")
        @ExcludeMissing
        fun _stWtKn(): JsonField<Double> = stWtKn
        ...
        @JsonProperty("sWtKip")
        @ExcludeMissing
        fun _sWtKip(): JsonField<Double> = sWtKip
        ...
        @ExcludeMissing
        fun _sWtKipMod(): JsonField<Double> = sWtKipMod
        ...
        @JsonProperty("sWtKN")
        @ExcludeMissing
        fun _sWtKn(): JsonField<Double> = sWtKn
        ...
        @ExcludeMissing
        fun _tdtWtkip(): JsonField<Double> = tdtWtkip
         ...
         * Unlike [tdtWtKn], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("tdtWtKN")
        @ExcludeMissing
        fun _tdtWtKn(): JsonField<Double> = tdtWtKn
        ...
        @ExcludeMissing
        fun _trtWtKip(): JsonField<Double> = trtWtKip
         ...
         * Unlike [trtWtKn], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("trtWtKN")
        @ExcludeMissing
        fun _trtWtKn(): JsonField<Double> = trtWtKn
         ...
         * Unlike [ttWtKip], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("ttWtKip")
        @ExcludeMissing
        fun _ttWtKip(): JsonField<Double> = ttWtKip
        ...
        @JsonProperty("ttWtKN")
        @ExcludeMissing
        fun _ttWtKn(): JsonField<Double> = ttWtKn
        ...
        @JsonProperty("tWtKip")
        @ExcludeMissing
        fun _tWtKip(): JsonField<Double> = tWtKip
        ...
        @ExcludeMissing
        fun _tWtKipMod(): JsonField<Double> = tWtKipMod
        ...
        @JsonProperty("tWtKN")
        @ExcludeMissing
        fun _tWtKn(): JsonField<Double> = tWtKn
         ...
         * Unlike [widthFt], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("widthFt")
        @ExcludeMissing
        fun _widthFt(): JsonField<Double> = widthFt
        ...
        @JsonProperty("widthM")
        @ExcludeMissing
        fun _widthM(): JsonField<Double> = widthM
        ...
        class Builder internal constructor() {
            ...
            /** User input rationale for the manual modification of the prescribed value indicating the max weight allowable on this surface for a DDT-type (double dual tandem) landing gear configuration. For more information, contact the provider source. */
            fun ddtWtKipModNote(ddtWtKipModNote: String) = ddtWtKipModNote(JsonField.of(ddtWtKipModNote))
            ...
            /** User input rationale for the manual modification of the prescribed value indicating the max weight allowable on this surface for an SBTT-type (single belly twin tandem) landing gear configuration. For more information, contact the provider source. */
            fun sbttWtKipModNote(sbttWtKipModNote: String) = sbttWtKipModNote(JsonField.of(sbttWtKipModNote))
            ...
            /** User input rationale for the manual modification of the prescribed value indicating the max weight allowable on this surface for a TDT-type (twin delta tandem) landing gear configuration. For more information, contact the provider source. */
            fun tdtWtKipModNote(tdtWtKipModNote: String) = tdtWtKipModNote(JsonField.of(tdtWtKipModNote))
            ...
            /** User input rationale for the manual modification of the prescribed value indicating the max weight allowable on this surface for a TRT-type (triple tandem) landing gear configuration. For more information, contact the provider source. */
            fun trtWtKipModNote(trtWtKipModNote: String) = trtWtKipModNote(JsonField.of(trtWtKipModNote))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (altSiteId.asKnown().isPresent) 1 else 0) + (if (condition.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (ddtWtKip.asKnown().isPresent) 1 else 0) + (if (ddtWtKipMod.asKnown().isPresent) 1 else 0) + (if (ddtWtKipModNote.asKnown().isPresent) 1 else 0) + (if (ddtWtKn.asKnown().isPresent) 1 else 0) + (if (ddWtKip.asKnown().isPresent) 1 else 0) + (if (ddWtKipMod.asKnown().isPresent) 1 else 0) + (if (ddWtKipModNote.asKnown().isPresent) 1 else 0) + (if (ddWtKn.asKnown().isPresent) 1 else 0) + (if (endLat.asKnown().isPresent) 1 else 0) + (if (endLon.asKnown().isPresent) 1 else 0) + (if (idSite.asKnown().isPresent) 1 else 0) + (if (lcn.asKnown().isPresent) 1 else 0) + (if (ldaFt.asKnown().isPresent) 1 else 0) + (if (ldaM.asKnown().isPresent) 1 else 0) + (if (lengthFt.asKnown().isPresent) 1 else 0) + (if (lengthM.asKnown().isPresent) 1 else 0) + (if (lighting.asKnown().isPresent) 1 else 0) + (if (lightsAprch.asKnown().isPresent) 1 else 0) + (if (lightsCl.asKnown().isPresent) 1 else 0) + (if (lightsOls.asKnown().isPresent) 1 else 0) + (if (lightsPapi.asKnown().isPresent) 1 else 0) + (if (lightsReil.asKnown().isPresent) 1 else 0) + (if (lightsRwy.asKnown().isPresent) 1 else 0) + (if (lightsSeqfl.asKnown().isPresent) 1 else 0) + (if (lightsTdzl.asKnown().isPresent) 1 else 0) + (if (lightsUnkn.asKnown().isPresent) 1 else 0) + (if (lightsVasi.asKnown().isPresent) 1 else 0) + (if (material.asKnown().isPresent) 1 else 0) + (if (obstacle.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (pcn.asKnown().isPresent) 1 else 0) + (if (pointReference.asKnown().isPresent) 1 else 0) + (if (primary.asKnown().isPresent) 1 else 0) + (if (rawWbc.asKnown().isPresent) 1 else 0) + (if (sbttWtKip.asKnown().isPresent) 1 else 0) + (if (sbttWtKipMod.asKnown().isPresent) 1 else 0) + (if (sbttWtKipModNote.asKnown().isPresent) 1 else 0) + (if (sbttWtKn.asKnown().isPresent) 1 else 0) + (if (startLat.asKnown().isPresent) 1 else 0) + (if (startLon.asKnown().isPresent) 1 else 0) + (if (stWtKip.asKnown().isPresent) 1 else 0) + (if (stWtKipMod.asKnown().isPresent) 1 else 0) + (if (stWtKipModNote.asKnown().isPresent) 1 else 0) + (if (stWtKn.asKnown().isPresent) 1 else 0) + (if (sWtKip.asKnown().isPresent) 1 else 0) + (if (sWtKipMod.asKnown().isPresent) 1 else 0) + (if (sWtKipModNote.asKnown().isPresent) 1 else 0) + (if (sWtKn.asKnown().isPresent) 1 else 0) + (if (tdtWtkip.asKnown().isPresent) 1 else 0) + (if (tdtWtKipMod.asKnown().isPresent) 1 else 0) + (if (tdtWtKipModNote.asKnown().isPresent) 1 else 0) + (if (tdtWtKn.asKnown().isPresent) 1 else 0) + (if (trtWtKip.asKnown().isPresent) 1 else 0) + (if (trtWtKipMod.asKnown().isPresent) 1 else 0) + (if (trtWtKipModNote.asKnown().isPresent) 1 else 0) + (if (trtWtKn.asKnown().isPresent) 1 else 0) + (if (ttWtKip.asKnown().isPresent) 1 else 0) + (if (ttWtKipMod.asKnown().isPresent) 1 else 0) + (if (ttWtKipModNote.asKnown().isPresent) 1 else 0) + (if (ttWtKn.asKnown().isPresent) 1 else 0) + (if (tWtKip.asKnown().isPresent) 1 else 0) + (if (tWtKipMod.asKnown().isPresent) 1 else 0) + (if (tWtKipModNote.asKnown().isPresent) 1 else 0) + (if (tWtKn.asKnown().isPresent) 1 else 0) + (if (widthFt.asKnown().isPresent) 1 else 0) + (if (widthM.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SurfaceCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "SurfaceCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
