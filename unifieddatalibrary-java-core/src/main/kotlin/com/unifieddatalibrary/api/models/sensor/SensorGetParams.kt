...
class SensorGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SensorGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SensorGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorGetParams: SensorGetParams) =
            apply {
                id = sensorGetParams.id
                firstResult = sensorGetParams.firstResult
                maxResults = sensorGetParams.maxResults
                additionalHeaders = sensorGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = sensorGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SensorGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorGetParams =
            SensorGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SensorGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
