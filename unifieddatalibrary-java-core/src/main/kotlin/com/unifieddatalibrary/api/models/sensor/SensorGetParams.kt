...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorGetParams: SensorGetParams) = apply {
    ...
    override fun toString() =
        "SensorGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
