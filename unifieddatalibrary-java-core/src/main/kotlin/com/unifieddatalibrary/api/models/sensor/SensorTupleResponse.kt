...
class SensorTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorTupleResponse].
         *
    ...
    /** A builder for [SensorTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTupleResponse: SensorTupleResponse) =
            apply {
                classificationMarking = sensorTupleResponse.classificationMarking
                dataMode = sensorTupleResponse.dataMode
                sensorName = sensorTupleResponse.sensorName
                source = sensorTupleResponse.source
                active = sensorTupleResponse.active
                afId = sensorTupleResponse.afId
                asrType = sensorTupleResponse.asrType
                createdAt = sensorTupleResponse.createdAt
                createdBy = sensorTupleResponse.createdBy
                dataControl = sensorTupleResponse.dataControl
                entity = sensorTupleResponse.entity
                idEntity = sensorTupleResponse.idEntity
                idSensor = sensorTupleResponse.idSensor
                origin = sensorTupleResponse.origin
                origNetwork = sensorTupleResponse.origNetwork
                sensorcharacteristics = sensorTupleResponse.sensorcharacteristics.map { it.toMutableList() }
                sensorlimitsCollection = sensorTupleResponse.sensorlimitsCollection.map { it.toMutableList() }
                sensorNumber = sensorTupleResponse.sensorNumber
                sensorObservationType = sensorTupleResponse.sensorObservationType
                sensorStats = sensorTupleResponse.sensorStats.map { it.toMutableList() }
                sensorType = sensorTupleResponse.sensorType
                shortName = sensorTupleResponse.shortName
                updatedAt = sensorTupleResponse.updatedAt
                updatedBy = sensorTupleResponse.updatedBy
                additionalProperties = sensorTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorTupleResponse].
         *
    ...
    fun validate(): SensorTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Entity private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(entity: Entity) =
                apply {
                    ...
                    rfBands = entity.rfBands.map { it.toMutableList() }
                    statusCollection = entity.statusCollection.map { it.toMutableList() }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (idEntity.asKnown().isPresent) 1 else 0) + (if (idLocation.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idOperatingUnit.asKnown().isPresent) 1 else 0) + (location.asKnown().getOrNull()?.validity() ?: 0) + (onOrbit.asKnown().getOrNull()?.validity() ?: 0) + (operatingUnit.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (ownerType.asKnown().getOrNull()?.validity() ?: 0) + (rfBands.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (statusCollection.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (taskable.asKnown().isPresent) 1 else 0) + (if (terrestrialId.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (urls.asKnown().getOrNull()?.size ?: 0)
        ...
        class Builder internal constructor() {
            ...
            internal fun from(sensorcharacteristic: Sensorcharacteristic) =
                apply {
                    ...
                    updatedAt = sensorcharacteristic.updatedAt
                    updatedBy = sensorcharacteristic.updatedBy
    ...
    class SensorlimitsCollection private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(sensorlimitsCollection: SensorlimitsCollection) =
                apply {
                    ...
                    updatedAt = sensorlimitsCollection.updatedAt
                    updatedBy = sensorlimitsCollection.updatedBy
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (idSensorLimits.asKnown().isPresent) 1 else 0) + (if (lowerLeftAzimuthLimit.asKnown().isPresent) 1 else 0) + (if (lowerLeftElevationLimit.asKnown().isPresent) 1 else 0) + (if (lowerRightAzimuthLimit.asKnown().isPresent) 1 else 0) + (if (lowerRightElevationLimit.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (if (upperLeftAzimuthLimit.asKnown().isPresent) 1 else 0) + (if (upperLeftElevationLimit.asKnown().isPresent) 1 else 0) + (if (upperRightAzimuthLimit.asKnown().isPresent) 1 else 0) + (if (upperRightElevationLimit.asKnown().isPresent) 1 else 0)
    ...
    class SensorObservationType private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(sensorObservationType: SensorObservationType) =
                apply {
                    dataMode = sensorObservationType.dataMode
                    source = sensorObservationType.source
                    ...
                    updatedAt = sensorObservationType.updatedAt
                    updatedBy = sensorObservationType.updatedBy
        ...
        override fun toString() = "SensorObservationType{dataMode=$dataMode, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origNetwork=$origNetwork, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
    }
    ...
    class SensorType private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(sensorType: SensorType) =
                apply {
                    ...
                    updatedBy = sensorType.updatedBy
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is SensorType && dataMode == other.dataMode && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && origNetwork == other.origNetwork && type == other.type && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "SensorType{dataMode=$dataMode, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origNetwork=$origNetwork, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
    }
