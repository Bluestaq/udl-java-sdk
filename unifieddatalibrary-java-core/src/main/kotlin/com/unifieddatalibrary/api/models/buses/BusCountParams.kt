...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BusCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(busCountParams: BusCountParams) = apply {
    ...
    override fun toString() =
        "BusCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
