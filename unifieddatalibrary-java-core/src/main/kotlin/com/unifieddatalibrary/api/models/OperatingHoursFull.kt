...
class OperatingHoursFull private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingHoursFull: OperatingHoursFull) =
            apply {
    ...
    fun validate(): OperatingHoursFull =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "OperatingHoursFull{opStartTime=$opStartTime, opStopTime=$opStopTime, additionalProperties=$additionalProperties}"
}
