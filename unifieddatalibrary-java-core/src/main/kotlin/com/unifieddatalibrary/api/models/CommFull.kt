...
class CommFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("transponders") @ExcludeMissing transponders: JsonField<List<Transponder>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commFull: CommFull) =
            apply {
         ...
         *
         * You should usually call [Builder.transponders] with a well-typed `List<Transponder>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transponders(transponders: JsonField<List<Transponder>>) =
            apply {
         ...
         */
        fun addTransponder(transponder: Transponder) =
            apply {
                transponders = (transponders ?: JsonField.of(mutableListOf())).also {
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (entity.asKnown().getOrNull()?.validity() ?: 0) + (if (idEntity.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (transponders.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    class Transponder private constructor(
        private val classificationMarking: JsonField<String>,
        private val dataMode: JsonField<DataMode>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(transponder: Transponder) =
                apply {
