 ...
 */
class ObscorrelationCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObscorrelationCountParams].
         *
    ...
    /** A builder for [ObscorrelationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(obscorrelationCountParams: ObscorrelationCountParams) = apply {
            msgTs = obscorrelationCountParams.msgTs
            firstResult = obscorrelationCountParams.firstResult
            maxResults = obscorrelationCountParams.maxResults
            additionalHeaders = obscorrelationCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = obscorrelationCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationCountParams].
         *
         ...
         */
        fun build(): ObscorrelationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationCountParams &&
            msgTs == other.msgTs &&
    ...
    override fun hashCode(): Int =
        Objects.hash(msgTs, firstResult, maxResults, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ObscorrelationCountParams{msgTs=$msgTs, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
