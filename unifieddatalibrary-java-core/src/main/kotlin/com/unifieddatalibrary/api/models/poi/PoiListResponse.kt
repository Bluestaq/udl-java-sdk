...
class PoiListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiListResponse: PoiListResponse) =
            apply {
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (poiid.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (ts.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (activity.asKnown().isPresent) 1 else 0) + (if (agjson.asKnown().isPresent) 1 else 0) + (if (alt.asKnown().isPresent) 1 else 0) + (if (andims.asKnown().isPresent) 1 else 0) + (if (asrid.asKnown().isPresent) 1 else 0) + (if (asset.asKnown().isPresent) 1 else 0) + (if (atext.asKnown().isPresent) 1 else 0) + (if (atype.asKnown().isPresent) 1 else 0) + (if (az.asKnown().isPresent) 1 else 0) + (if (beNumber.asKnown().isPresent) 1 else 0) + (if (ce.asKnown().isPresent) 1 else 0) + (if (cntct.asKnown().isPresent) 1 else 0) + (if (conf.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (desc.asKnown().isPresent) 1 else 0) + (if (el.asKnown().isPresent) 1 else 0) + (elle.asKnown().getOrNull()?.size ?: 0) + (if (env.asKnown().isPresent) 1 else 0) + (groups.asKnown().getOrNull()?.size ?: 0) + (if (how.asKnown().isPresent) 1 else 0) + (if (ident.asKnown().isPresent) 1 else 0) + (idWeatherReport.asKnown().getOrNull()?.size ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (le.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (msnid.asKnown().isPresent) 1 else 0) + (if (orientation.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (plat.asKnown().isPresent) 1 else 0) + (if (pps.asKnown().isPresent) 1 else 0) + (if (pri.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (spec.asKnown().isPresent) 1 else 0) + (if (stale.asKnown().isPresent) 1 else 0) + (if (start.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (trkid.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (urls.asKnown().getOrNull()?.size ?: 0)
