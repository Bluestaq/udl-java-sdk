 ...
 */
class SurfaceObstructionCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SurfaceObstructionCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionCountParams: SurfaceObstructionCountParams) = apply {
    ...
    override fun toString() =
        "SurfaceObstructionCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
