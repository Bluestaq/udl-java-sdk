...
class WeatherDataListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WeatherDataListParams].
         *
    ...
    /** A builder for [WeatherDataListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataListParams: WeatherDataListParams) =
            apply {
                obTime = weatherDataListParams.obTime
                firstResult = weatherDataListParams.firstResult
                maxResults = weatherDataListParams.maxResults
                additionalHeaders = weatherDataListParams.additionalHeaders.toBuilder()
                additionalQueryParams = weatherDataListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [WeatherDataListParams].
         *
         ...
         */
        fun build(): WeatherDataListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is WeatherDataListParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "WeatherDataListParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
