...
/**
 * Service operation to update a single airevent record. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class AirEventUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventUpdateParams: AirEventUpdateParams) = apply {
         ...
         * millisecond precision.
         */
        fun actualArrTime(actualArrTime: OffsetDateTime) = apply {
         ...
         * millisecond precision.
         */
        fun actualDepTime(actualDepTime: OffsetDateTime) = apply {
         ...
         */
        fun arct(arct: OffsetDateTime) = apply { body.arct(arct) }
         ...
         * value.
         */
        fun arct(arct: JsonField<OffsetDateTime>) = apply { body.arct(arct) }
         ...
         */
        fun arEventType(arEventType: String) = apply { body.arEventType(arEventType) }
         ...
         * value.
         */
        fun arEventType(arEventType: JsonField<String>) = apply { body.arEventType(arEventType) }

        /**
         * The purpose of the air event at the arrival location. Can be either descriptive text such
         * as 'fuel onload' or a purpose code specified by the provider, such as 'A'.
         */
        fun arrPurpose(arrPurpose: String) = apply { body.arrPurpose(arrPurpose) }
         ...
         * value.
         */
        fun arrPurpose(arrPurpose: JsonField<String>) = apply { body.arrPurpose(arrPurpose) }

        /** Identifier of the air refueling track, if applicable. */
        fun arTrackId(arTrackId: String) = apply { body.arTrackId(arTrackId) }
         ...
         * value.
         */
        fun arTrackId(arTrackId: JsonField<String>) = apply { body.arTrackId(arTrackId) }

        /** Name of the air refueling track, if applicable. */
        fun arTrackName(arTrackName: String) = apply { body.arTrackName(arTrackName) }
         ...
         * value.
         */
        fun arTrackName(arTrackName: JsonField<String>) = apply { body.arTrackName(arTrackName) }

        /** Altitude of this air event, in feet. */
        fun baseAlt(baseAlt: Double) = apply { body.baseAlt(baseAlt) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun baseAlt(baseAlt: JsonField<Double>) = apply { body.baseAlt(baseAlt) }

        /** Flag indicating that this air refueling event has been cancelled. */
        fun cancelled(cancelled: Boolean) = apply { body.cancelled(cancelled) }
         ...
         * value.
         */
        fun cancelled(cancelled: JsonField<Boolean>) = apply { body.cancelled(cancelled) }
         ...
         */
        fun depPurpose(depPurpose: String) = apply { body.depPurpose(depPurpose) }
         ...
         * value.
         */
        fun depPurpose(depPurpose: JsonField<String>) = apply { body.depPurpose(depPurpose) }
         ...
         * generated ID.
         */
        fun externalAirEventId(externalAirEventId: String) = apply {
         ...
         * system generated ID.
         */
        fun externalArTrackId(externalArTrackId: String) = apply {
        ...
        /** The number of tankers requested for an air refueling event. */
        fun numTankers(numTankers: Int) = apply { body.numTankers(numTankers) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun numTankers(numTankers: JsonField<Int>) = apply { body.numTankers(numTankers) }
         ...
         * millisecond precision.
         */
        fun plannedArrTime(plannedArrTime: OffsetDateTime) = apply {
        ...
        /** Priority of this air event. */
        fun priority(priority: String) = apply { body.priority(priority) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun priority(priority: JsonField<String>) = apply { body.priority(priority) }

        /** Collection of receiver aircraft associated with this Air Event. */
        fun receivers(receivers: List<Receiver>) = apply { body.receivers(receivers) }
         ...
         * supported value.
         */
        fun receivers(receivers: JsonField<List<Receiver>>) = apply { body.receivers(receivers) }
         ...
         */
        fun addReceiver(receiver: Receiver) = apply { body.addReceiver(receiver) }
         ...
         * directions.
         */
        fun revTrack(revTrack: Boolean) = apply { body.revTrack(revTrack) }
         ...
         * value.
         */
        fun revTrack(revTrack: JsonField<Boolean>) = apply { body.revTrack(revTrack) }
         ...
         * millisecond precision.
         */
        fun rzct(rzct: OffsetDateTime) = apply { body.rzct(rzct) }
         ...
         * value.
         */
        fun rzct(rzct: JsonField<OffsetDateTime>) = apply { body.rzct(rzct) }
         ...
         */
        fun rzPoint(rzPoint: String) = apply { body.rzPoint(rzPoint) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun rzPoint(rzPoint: JsonField<String>) = apply { body.rzPoint(rzPoint) }

        /**
         * Type of rendezvous used for this air refueling event. Possible values are BUD (Buddy), EN
         * (Enroute), GCI (Ground Control), PP (Point Parallel).
         */
        fun rzType(rzType: String) = apply { body.rzType(rzType) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun rzType(rzType: JsonField<String>) = apply { body.rzType(rzType) }

        /**
         * Flag indicating that the receiver unit has requested flying a short portion of an air
         * refueling track.
         */
        fun shortTrack(shortTrack: Boolean) = apply { body.shortTrack(shortTrack) }
         ...
         * value.
         */
        fun shortTrack(shortTrack: JsonField<Boolean>) = apply { body.shortTrack(shortTrack) }
         ...
         */
        fun statusCode(statusCode: String) = apply { body.statusCode(statusCode) }
         ...
         * value.
         */
        fun statusCode(statusCode: JsonField<String>) = apply { body.statusCode(statusCode) }

        /** Collection of tanker aircraft associated with this Air Event. */
        fun tankers(tankers: List<Tanker>) = apply { body.tankers(tankers) }
         ...
         * value.
         */
        fun tankers(tankers: JsonField<List<Tanker>>) = apply { body.tankers(tankers) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTanker(tanker: Tanker) = apply { body.addTanker(tanker) }

        /** Length of time the receiver unit has requested for an air event, in hours. */
        fun trackTime(trackTime: Double) = apply { body.trackTime(trackTime) }
         ...
         * value.
         */
        fun trackTime(trackTime: JsonField<Double>) = apply { body.trackTime(trackTime) }
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, type=$type, bodyId=$bodyId, actualArrTime=$actualArrTime, actualDepTime=$actualDepTime, arct=$arct, arEventType=$arEventType, arrPurpose=$arrPurpose, arTrackId=$arTrackId, arTrackName=$arTrackName, baseAlt=$baseAlt, cancelled=$cancelled, createdAt=$createdAt, createdBy=$createdBy, depPurpose=$depPurpose, estArrTime=$estArrTime, estDepTime=$estDepTime, externalAirEventId=$externalAirEventId, externalArTrackId=$externalArTrackId, idMission=$idMission, idSortie=$idSortie, legNum=$legNum, location=$location, numTankers=$numTankers, origin=$origin, origNetwork=$origNetwork, plannedArrTime=$plannedArrTime, plannedDepTime=$plannedDepTime, priority=$priority, receivers=$receivers, remarks=$remarks, revTrack=$revTrack, rzct=$rzct, rzPoint=$rzPoint, rzType=$rzType, shortTrack=$shortTrack, sourceDl=$sourceDl, statusCode=$statusCode, tankers=$tankers, trackTime=$trackTime, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "AirEventUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
