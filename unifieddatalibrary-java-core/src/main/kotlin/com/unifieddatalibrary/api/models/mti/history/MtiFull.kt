...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MtiFull].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mtiFull: MtiFull) = apply {
            classificationMarking = mtiFull.classificationMarking
            dataMode = mtiFull.dataMode
            source = mtiFull.source
            id = mtiFull.id
            createdAt = mtiFull.createdAt
            createdBy = mtiFull.createdBy
            dwells = mtiFull.dwells.map { it.toMutableList() }
            freeTexts = mtiFull.freeTexts.map { it.toMutableList() }
            hrrs = mtiFull.hrrs.map { it.toMutableList() }
            jobDefs = mtiFull.jobDefs.map { it.toMutableList() }
            jobRequests = mtiFull.jobRequests.map { it.toMutableList() }
            missions = mtiFull.missions.map { it.toMutableList() }
            origin = mtiFull.origin
            origNetwork = mtiFull.origNetwork
            p10 = mtiFull.p10
            p3 = mtiFull.p3
            p6 = mtiFull.p6
            p7 = mtiFull.p7
            p8 = mtiFull.p8
            p9 = mtiFull.p9
            platformLocs = mtiFull.platformLocs.map { it.toMutableList() }
            additionalProperties = mtiFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MtiFull].
         *
    ...
    private constructor(
        ...
        /**
         * A platform assigned number identifying the specific request or task to which the specific
         * dwell pertains.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
