 ...
 */
class FeatureAssessmentTupleResponse
...
private constructor(
     ...
     * (featureUoM). Because of the variability of the Feature Assessment data types, each record
    ...
    /**
     * A single feature/assessment string expressed in the specified unit of measure (featureUoM).
    ...
    /**
     * A single feature/assessment value expressed in the specified unit of measure (featureUoM).
     * Because of the variability of the Feature Assessment data types, each record may employ a
     * numeric observation value (featureValue), a string observation value (featureString), a
     * Boolean observation value (featureBool), an array of numeric observation values
     * (featureArray), or any combination of these.
    ...
    /** A builder for [FeatureAssessmentTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentTupleResponse: FeatureAssessmentTupleResponse) = apply {
            classificationMarking = featureAssessmentTupleResponse.classificationMarking
            dataMode = featureAssessmentTupleResponse.dataMode
            featureTs = featureAssessmentTupleResponse.featureTs
            featureUoM = featureAssessmentTupleResponse.featureUoM
            idAnalyticImagery = featureAssessmentTupleResponse.idAnalyticImagery
            source = featureAssessmentTupleResponse.source
            id = featureAssessmentTupleResponse.id
            agjson = featureAssessmentTupleResponse.agjson
            andims = featureAssessmentTupleResponse.andims
            annLims = featureAssessmentTupleResponse.annLims.map { it.toMutableList() }
            annText = featureAssessmentTupleResponse.annText.map { it.toMutableList() }
            area = featureAssessmentTupleResponse.area
            asrid = featureAssessmentTupleResponse.asrid
            assessment = featureAssessmentTupleResponse.assessment
            atext = featureAssessmentTupleResponse.atext
            atype = featureAssessmentTupleResponse.atype
            confidence = featureAssessmentTupleResponse.confidence
            createdAt = featureAssessmentTupleResponse.createdAt
            createdBy = featureAssessmentTupleResponse.createdBy
            externalId = featureAssessmentTupleResponse.externalId
            featureArray = featureAssessmentTupleResponse.featureArray.map { it.toMutableList() }
            featureBool = featureAssessmentTupleResponse.featureBool
            featureString = featureAssessmentTupleResponse.featureString
            featureStringArray =
                featureAssessmentTupleResponse.featureStringArray.map { it.toMutableList() }
            featureValue = featureAssessmentTupleResponse.featureValue
            heading = featureAssessmentTupleResponse.heading
            height = featureAssessmentTupleResponse.height
            length = featureAssessmentTupleResponse.length
            name = featureAssessmentTupleResponse.name
            origin = featureAssessmentTupleResponse.origin
            origNetwork = featureAssessmentTupleResponse.origNetwork
            sourceDl = featureAssessmentTupleResponse.sourceDl
            speed = featureAssessmentTupleResponse.speed
            srcIds = featureAssessmentTupleResponse.srcIds.map { it.toMutableList() }
            srcTs = featureAssessmentTupleResponse.srcTs.map { it.toMutableList() }
            srcTyps = featureAssessmentTupleResponse.srcTyps.map { it.toMutableList() }
            tags = featureAssessmentTupleResponse.tags.map { it.toMutableList() }
            transactionId = featureAssessmentTupleResponse.transactionId
            type = featureAssessmentTupleResponse.type
            width = featureAssessmentTupleResponse.width
            additionalProperties =
                featureAssessmentTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * An array of numeric feature/assessment values expressed in the specified unit of measure
         * (featureUoM). Because of the variability of the Feature Assessment data types, each
         * record may employ a numeric observation value (featureValue), a string observation value
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentTupleResponse].
         *
         ...
         */
        fun build(): FeatureAssessmentTupleResponse =
            FeatureAssessmentTupleResponse(
    ...
    fun validate(): FeatureAssessmentTupleResponse = apply {
        if (validated) {
            return@apply
        }
