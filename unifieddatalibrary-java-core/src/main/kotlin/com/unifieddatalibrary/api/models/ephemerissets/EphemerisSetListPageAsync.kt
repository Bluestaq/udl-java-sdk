...
class EphemerisSetListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<EphemerisSetListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetListPageAsync: EphemerisSetListPageAsync) = apply {
        ...
        fun service(service: EphemerisSetServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EphemerisSetListPageAsync &&
    ...
    override fun toString() =
        "EphemerisSetListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
