...
class RfEmitterDetailListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<RfEmitterDetailListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailListPageAsync: RfEmitterDetailListPageAsync) = apply {
        ...
        fun service(service: RfEmitterDetailServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: RfEmitterDetailListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<RfEmitterDetailListResponse>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RfEmitterDetailListPageAsync &&
    ...
    override fun toString() =
        "RfEmitterDetailListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
