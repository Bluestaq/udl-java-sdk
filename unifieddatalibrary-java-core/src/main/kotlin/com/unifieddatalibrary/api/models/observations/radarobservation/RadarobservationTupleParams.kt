...
class RadarobservationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RadarobservationTupleParams].
         *
    ...
    /** A builder for [RadarobservationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationTupleParams: RadarobservationTupleParams) =
            apply {
                columns = radarobservationTupleParams.columns
                obTime = radarobservationTupleParams.obTime
                firstResult = radarobservationTupleParams.firstResult
                maxResults = radarobservationTupleParams.maxResults
                additionalHeaders = radarobservationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = radarobservationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RadarobservationTupleParams].
         *
         ...
         */
        fun build(): RadarobservationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RadarobservationTupleParams && columns == other.columns && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RadarobservationTupleParams{columns=$columns, obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
