...
class EmitterGeolocationQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            emitterGeolocationQueryHelpResponse: EmitterGeolocationQueryHelpResponse
        ) = apply {
            ...
            requiredRoles =
                emitterGeolocationQueryHelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                emitterGeolocationQueryHelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): EmitterGeolocationQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
