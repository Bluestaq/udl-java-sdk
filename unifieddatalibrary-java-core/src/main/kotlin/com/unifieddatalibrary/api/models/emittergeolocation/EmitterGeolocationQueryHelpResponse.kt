...
class EmitterGeolocationQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EmitterGeolocationQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EmitterGeolocationQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationQueryHelpResponse: EmitterGeolocationQueryHelpResponse) =
            apply {
                aodrSupported = emitterGeolocationQueryHelpResponse.aodrSupported
                classificationMarking = emitterGeolocationQueryHelpResponse.classificationMarking
                description = emitterGeolocationQueryHelpResponse.description
                historySupported = emitterGeolocationQueryHelpResponse.historySupported
                name = emitterGeolocationQueryHelpResponse.name
                parameters = emitterGeolocationQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = emitterGeolocationQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = emitterGeolocationQueryHelpResponse.restSupported
                sortSupported = emitterGeolocationQueryHelpResponse.sortSupported
                typeName = emitterGeolocationQueryHelpResponse.typeName
                uri = emitterGeolocationQueryHelpResponse.uri
                additionalProperties = emitterGeolocationQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EmitterGeolocationQueryHelpResponse =
    ...
    fun validate(): EmitterGeolocationQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EmitterGeolocationQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
