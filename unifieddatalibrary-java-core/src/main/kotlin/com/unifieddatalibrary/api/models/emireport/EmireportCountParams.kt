...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmireportCountParams].
         *
    ...
    /** A builder for [EmireportCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportCountParams: EmireportCountParams) = apply {
            reportTime = emireportCountParams.reportTime
            firstResult = emireportCountParams.firstResult
            maxResults = emireportCountParams.maxResults
            additionalHeaders = emireportCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = emireportCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EmireportCountParams].
         *
         ...
         */
        fun build(): EmireportCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportCountParams &&
    ...
    override fun toString() =
        "EmireportCountParams{reportTime=$reportTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
