...
private constructor(
    ...
    /** A builder for [PersonnelrecoveryListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(personnelrecoveryListResponse: PersonnelrecoveryListResponse) = apply {
            classificationMarking = personnelrecoveryListResponse.classificationMarking
            dataMode = personnelrecoveryListResponse.dataMode
            msgTime = personnelrecoveryListResponse.msgTime
            pickupLat = personnelrecoveryListResponse.pickupLat
            pickupLon = personnelrecoveryListResponse.pickupLon
            source = personnelrecoveryListResponse.source
            type = personnelrecoveryListResponse.type
            id = personnelrecoveryListResponse.id
            authMethod = personnelrecoveryListResponse.authMethod
            authStatus = personnelrecoveryListResponse.authStatus
            beaconInd = personnelrecoveryListResponse.beaconInd
            callSign = personnelrecoveryListResponse.callSign
            commEq1 = personnelrecoveryListResponse.commEq1
            commEq2 = personnelrecoveryListResponse.commEq2
            commEq3 = personnelrecoveryListResponse.commEq3
            createdAt = personnelrecoveryListResponse.createdAt
            createdBy = personnelrecoveryListResponse.createdBy
            executionInfo = personnelrecoveryListResponse.executionInfo
            identity = personnelrecoveryListResponse.identity
            idWeatherReport = personnelrecoveryListResponse.idWeatherReport
            milClass = personnelrecoveryListResponse.milClass
            natAlliance = personnelrecoveryListResponse.natAlliance
            natAlliance1 = personnelrecoveryListResponse.natAlliance1
            numAmbulatory = personnelrecoveryListResponse.numAmbulatory
            numAmbulatoryInjured = personnelrecoveryListResponse.numAmbulatoryInjured
            numNonAmbulatory = personnelrecoveryListResponse.numNonAmbulatory
            numPersons = personnelrecoveryListResponse.numPersons
            objectiveAreaInfo = personnelrecoveryListResponse.objectiveAreaInfo
            origin = personnelrecoveryListResponse.origin
            origNetwork = personnelrecoveryListResponse.origNetwork
            pickupAlt = personnelrecoveryListResponse.pickupAlt
            recovId = personnelrecoveryListResponse.recovId
            rxFreq = personnelrecoveryListResponse.rxFreq
            survivorMessages = personnelrecoveryListResponse.survivorMessages
            survivorRadio = personnelrecoveryListResponse.survivorRadio
            termInd = personnelrecoveryListResponse.termInd
            textMsg = personnelrecoveryListResponse.textMsg
            txFreq = personnelrecoveryListResponse.txFreq
            additionalProperties = personnelrecoveryListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PersonnelrecoveryListResponse].
         *
         ...
         */
        fun build(): PersonnelrecoveryListResponse =
            PersonnelrecoveryListResponse(
    ...
    fun validate(): PersonnelrecoveryListResponse = apply {
        if (validated) {
            return@apply
        }
