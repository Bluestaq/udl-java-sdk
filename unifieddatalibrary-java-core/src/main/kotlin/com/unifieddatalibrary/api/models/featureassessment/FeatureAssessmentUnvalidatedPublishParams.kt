...
/**
 * Service operation to take multiple FeatureAssessment records as a POST body and ingest into the
 ...
 */
class FeatureAssessmentUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [FeatureAssessmentUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            featureAssessmentUnvalidatedPublishParams: FeatureAssessmentUnvalidatedPublishParams
        ) = apply {
            body = featureAssessmentUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                featureAssessmentUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                featureAssessmentUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): FeatureAssessmentUnvalidatedPublishParams =
            FeatureAssessmentUnvalidatedPublishParams(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                featureTs = body.featureTs
                featureUoM = body.featureUoM
                idAnalyticImagery = body.idAnalyticImagery
                source = body.source
                id = body.id
                agjson = body.agjson
                andims = body.andims
                annLims = body.annLims.map { it.toMutableList() }
                annText = body.annText.map { it.toMutableList() }
                area = body.area
                asrid = body.asrid
                ...
                featureArray = body.featureArray.map { it.toMutableList() }
                featureBool = body.featureBool
                featureString = body.featureString
                featureStringArray = body.featureStringArray.map { it.toMutableList() }
                featureValue = body.featureValue
                ...
                srcTs = body.srcTs.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FeatureAssessmentUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "FeatureAssessmentUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
