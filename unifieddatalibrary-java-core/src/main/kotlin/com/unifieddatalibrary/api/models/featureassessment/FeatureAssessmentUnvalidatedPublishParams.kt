...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * A single feature/assessment string expressed in the specified unit of measure
             * (featureUoM). Because of the variability of the Feature Assessment data types, each
             * record may employ a numeric observation value (featureValue), a string observation
             * value (featureString), a Boolean observation value (featureBool), an array of numeric
             * observation values (featureArray), or any combination of these.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureAssessmentUnvalidatedPublishParams &&
            body == other.body &&
