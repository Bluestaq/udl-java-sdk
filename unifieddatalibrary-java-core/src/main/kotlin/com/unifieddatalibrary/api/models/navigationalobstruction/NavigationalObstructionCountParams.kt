 ...
 */
class NavigationalObstructionCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NavigationalObstructionCountParams = builder().build()
    ...
    /** A builder for [NavigationalObstructionCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationalObstructionCountParams: NavigationalObstructionCountParams) =
            apply {
                cycleDate = navigationalObstructionCountParams.cycleDate
                firstResult = navigationalObstructionCountParams.firstResult
                maxResults = navigationalObstructionCountParams.maxResults
                obstacleId = navigationalObstructionCountParams.obstacleId
                additionalHeaders = navigationalObstructionCountParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    navigationalObstructionCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [NavigationalObstructionCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NavigationalObstructionCountParams =
            NavigationalObstructionCountParams(
                cycleDate,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NavigationalObstructionCountParams && cycleDate == other.cycleDate && firstResult == other.firstResult && maxResults == other.maxResults && obstacleId == other.obstacleId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "NavigationalObstructionCountParams{cycleDate=$cycleDate, firstResult=$firstResult, maxResults=$maxResults, obstacleId=$obstacleId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
