...
class GeoStatusQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [GeoStatusQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [GeoStatusQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusQueryhelpResponse: GeoStatusQueryhelpResponse) =
            apply {
                aodrSupported = geoStatusQueryhelpResponse.aodrSupported
                classificationMarking = geoStatusQueryhelpResponse.classificationMarking
                description = geoStatusQueryhelpResponse.description
                historySupported = geoStatusQueryhelpResponse.historySupported
                name = geoStatusQueryhelpResponse.name
                parameters = geoStatusQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = geoStatusQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = geoStatusQueryhelpResponse.restSupported
                sortSupported = geoStatusQueryhelpResponse.sortSupported
                typeName = geoStatusQueryhelpResponse.typeName
                uri = geoStatusQueryhelpResponse.uri
                additionalProperties = geoStatusQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [GeoStatusQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GeoStatusQueryhelpResponse =
    ...
    fun validate(): GeoStatusQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
