...
class GeoStatusQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusQueryhelpResponse: GeoStatusQueryhelpResponse) = apply {
    ...
    fun validate(): GeoStatusQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
