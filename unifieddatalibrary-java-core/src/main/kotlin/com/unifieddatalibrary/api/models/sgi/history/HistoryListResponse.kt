...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            effectiveDate = historyListResponse.effectiveDate
            sgiDate = historyListResponse.sgiDate
            source = historyListResponse.source
            id = historyListResponse.id
            analyzerAttenuation = historyListResponse.analyzerAttenuation
            ap = historyListResponse.ap
            apDuration = historyListResponse.apDuration
            coeffDegree = historyListResponse.coeffDegree.map { it.toMutableList() }
            coeffOrder = historyListResponse.coeffOrder.map { it.toMutableList() }
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            ctce = historyListResponse.ctce.map { it.toMutableList() }
            ctci = historyListResponse.ctci.map { it.toMutableList() }
            dst = historyListResponse.dst
            dtc = historyListResponse.dtc
            e10 = historyListResponse.e10
            e54 = historyListResponse.e54
            f10 = historyListResponse.f10
            f10High = historyListResponse.f10High
            f10Low = historyListResponse.f10Low
            f54 = historyListResponse.f54
            f81 = historyListResponse.f81
            frequencies = historyListResponse.frequencies.map { it.toMutableList() }
            gamma = historyListResponse.gamma
            idSensor = historyListResponse.idSensor
            kIndex = historyListResponse.kIndex
            kp = historyListResponse.kp
            kpDuration = historyListResponse.kpDuration
            m10 = historyListResponse.m10
            m54 = historyListResponse.m54
            mode = historyListResponse.mode
            normFactor = historyListResponse.normFactor
            observedBaseline = historyListResponse.observedBaseline.map { it.toMutableList() }
            ...
            precedence = historyListResponse.precedence
            rawFileUri = historyListResponse.rawFileUri
            rbDuration = historyListResponse.rbDuration
            rbIndex = historyListResponse.rbIndex
            rbRegionCode = historyListResponse.rbRegionCode
            s10 = historyListResponse.s10
            s54 = historyListResponse.s54
            state = historyListResponse.state
            stationName = historyListResponse.stationName
            stce = historyListResponse.stce.map { it.toMutableList() }
            stci = historyListResponse.stci.map { it.toMutableList() }
            sunspotNum = historyListResponse.sunspotNum
            sunspotNumHigh = historyListResponse.sunspotNumHigh
            sunspotNumLow = historyListResponse.sunspotNumLow
            ...
            y10 = historyListResponse.y10
            y54 = historyListResponse.y54
