...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiTupleResponse: PoiTupleResponse) = apply {
    ...
    fun validate(): PoiTupleResponse = apply {
        if (validated) {
            return@apply
        }
