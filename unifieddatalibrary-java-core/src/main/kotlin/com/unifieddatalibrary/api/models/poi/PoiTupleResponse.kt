...
class PoiTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("idWeatherReport") @ExcludeMissing idWeatherReport: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("orientation") @ExcludeMissing orientation: JsonField<Double> = JsonMissing.of(),
    ...
    @JsonProperty("asset")
    @ExcludeMissing
    fun _asset(): JsonField<String> = asset
    ...
    @JsonProperty("cntct")
    @ExcludeMissing
    fun _cntct(): JsonField<String> = cntct
    ...
    @JsonProperty("conf")
    @ExcludeMissing
    fun _conf(): JsonField<Double> = conf
    ...
    @JsonProperty("desc")
    @ExcludeMissing
    fun _desc(): JsonField<String> = desc
    ...
    @JsonProperty("elle")
    @ExcludeMissing
    fun _elle(): JsonField<List<Double>> = elle
    ...
    @JsonProperty("groups")
    @ExcludeMissing
    fun _groups(): JsonField<List<String>> = groups
    ...
    @JsonProperty("msnid")
    @ExcludeMissing
    fun _msnid(): JsonField<String> = msnid
    ...
    @JsonProperty("plat")
    @ExcludeMissing
    fun _plat(): JsonField<String> = plat
    ...
    @JsonProperty("spec")
    @ExcludeMissing
    fun _spec(): JsonField<String> = spec
    ...
    @JsonProperty("stale")
    @ExcludeMissing
    fun _stale(): JsonField<OffsetDateTime> = stale
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PoiTupleResponse].
         *
    ...
    /** A builder for [PoiTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiTupleResponse: PoiTupleResponse) =
            apply {
                classificationMarking = poiTupleResponse.classificationMarking
                dataMode = poiTupleResponse.dataMode
                name = poiTupleResponse.name
                poiid = poiTupleResponse.poiid
                source = poiTupleResponse.source
                ts = poiTupleResponse.ts
                id = poiTupleResponse.id
                activity = poiTupleResponse.activity
                agjson = poiTupleResponse.agjson
                alt = poiTupleResponse.alt
                andims = poiTupleResponse.andims
                area = poiTupleResponse.area
                asrid = poiTupleResponse.asrid
                asset = poiTupleResponse.asset
                atext = poiTupleResponse.atext
                atype = poiTupleResponse.atype
                az = poiTupleResponse.az
                beNumber = poiTupleResponse.beNumber
                ce = poiTupleResponse.ce
                cntct = poiTupleResponse.cntct
                conf = poiTupleResponse.conf
                createdAt = poiTupleResponse.createdAt
                createdBy = poiTupleResponse.createdBy
                desc = poiTupleResponse.desc
                el = poiTupleResponse.el
                elle = poiTupleResponse.elle.map { it.toMutableList() }
                env = poiTupleResponse.env
                groups = poiTupleResponse.groups.map { it.toMutableList() }
                how = poiTupleResponse.how
                ident = poiTupleResponse.ident
                idWeatherReport = poiTupleResponse.idWeatherReport.map { it.toMutableList() }
                lat = poiTupleResponse.lat
                le = poiTupleResponse.le
                lon = poiTupleResponse.lon
                msnid = poiTupleResponse.msnid
                orientation = poiTupleResponse.orientation
                origin = poiTupleResponse.origin
                origNetwork = poiTupleResponse.origNetwork
                plat = poiTupleResponse.plat
                pps = poiTupleResponse.pps
                pri = poiTupleResponse.pri
                sourceDl = poiTupleResponse.sourceDl
                spec = poiTupleResponse.spec
                srcIds = poiTupleResponse.srcIds.map { it.toMutableList() }
                srcTyps = poiTupleResponse.srcTyps.map { it.toMutableList() }
                stale = poiTupleResponse.stale
                start = poiTupleResponse.start
                tags = poiTupleResponse.tags.map { it.toMutableList() }
                transactionId = poiTupleResponse.transactionId
                trkid = poiTupleResponse.trkid
                type = poiTupleResponse.type
                urls = poiTupleResponse.urls.map { it.toMutableList() }
                additionalProperties = poiTupleResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.asset] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun asset(asset: JsonField<String>) =
            apply {
                this.asset = asset
            }
         ...
         *
         * You should usually call [Builder.cntct] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cntct(cntct: JsonField<String>) =
            apply {
                this.cntct = cntct
            }
         ...
         *
         * You should usually call [Builder.conf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun conf(conf: JsonField<Double>) =
            apply {
                this.conf = conf
            }
         ...
         *
         * You should usually call [Builder.desc] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun desc(desc: JsonField<String>) =
            apply {
                this.desc = desc
            }
         ...
         *
         * You should usually call [Builder.elle] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun elle(elle: JsonField<List<Double>>) =
            apply {
         ...
         */
        fun addElle(elle: Double) =
            apply {
                this.elle = (this.elle ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.groups] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun groups(groups: JsonField<List<String>>) =
            apply {
        ...
        fun addGroup(group: String) =
            apply {
                groups = (groups ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.how] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun how(how: JsonField<String>) =
            apply {
                this.how = how
            }
        ...
        /** Array of one or more unique identifiers of weather records associated with this POI. Each element in array must be 36 characters or less in length. */
        fun idWeatherReport(idWeatherReport: List<String>) = idWeatherReport(JsonField.of(idWeatherReport))

        /**
         * Sets [Builder.idWeatherReport] to an arbitrary JSON value.
         *
         * You should usually call [Builder.idWeatherReport] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idWeatherReport(idWeatherReport: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addIdWeatherReport(idWeatherReport: String) =
            apply {
                this.idWeatherReport = (this.idWeatherReport ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.msnid] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun msnid(msnid: JsonField<String>) =
            apply {
                this.msnid = msnid
            }
         ...
         *
         * You should usually call [Builder.orientation] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.plat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun plat(plat: JsonField<String>) =
            apply {
                this.plat = plat
            }
         ...
         *
         * You should usually call [Builder.pps] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pps(pps: JsonField<String>) =
            apply {
                this.pps = pps
            }
         ...
         *
         * You should usually call [Builder.pri] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pri(pri: JsonField<Int>) =
            apply {
                this.pri = pri
            }
         ...
         *
         * You should usually call [Builder.spec] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spec(spec: JsonField<String>) =
            apply {
                this.spec = spec
            }
         ...
         *
         * You should usually call [Builder.stale] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stale(stale: JsonField<OffsetDateTime>) =
            apply {
                this.stale = stale
            }
         ...
         *
         * You should usually call [Builder.start] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun start(start: JsonField<OffsetDateTime>) =
            apply {
                this.start = start
            }
        ...
        /**
         * Returns an immutable instance of [PoiTupleResponse].
         *
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (poiid.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (ts.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (activity.asKnown().isPresent) 1 else 0) + (if (agjson.asKnown().isPresent) 1 else 0) + (if (alt.asKnown().isPresent) 1 else 0) + (if (andims.asKnown().isPresent) 1 else 0) + (if (area.asKnown().isPresent) 1 else 0) + (if (asrid.asKnown().isPresent) 1 else 0) + (if (asset.asKnown().isPresent) 1 else 0) + (if (atext.asKnown().isPresent) 1 else 0) + (if (atype.asKnown().isPresent) 1 else 0) + (if (az.asKnown().isPresent) 1 else 0) + (if (beNumber.asKnown().isPresent) 1 else 0) + (if (ce.asKnown().isPresent) 1 else 0) + (if (cntct.asKnown().isPresent) 1 else 0) + (if (conf.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (desc.asKnown().isPresent) 1 else 0) + (if (el.asKnown().isPresent) 1 else 0) + (elle.asKnown().getOrNull()?.size ?: 0) + (if (env.asKnown().isPresent) 1 else 0) + (groups.asKnown().getOrNull()?.size ?: 0) + (if (how.asKnown().isPresent) 1 else 0) + (if (ident.asKnown().isPresent) 1 else 0) + (idWeatherReport.asKnown().getOrNull()?.size ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (le.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (msnid.asKnown().isPresent) 1 else 0) + (if (orientation.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (plat.asKnown().isPresent) 1 else 0) + (if (pps.asKnown().isPresent) 1 else 0) + (if (pri.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (spec.asKnown().isPresent) 1 else 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (if (stale.asKnown().isPresent) 1 else 0) + (if (start.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (trkid.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (urls.asKnown().getOrNull()?.size ?: 0)
