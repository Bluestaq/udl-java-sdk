...
/**
 * Service operation to take a single launch detection as a POST body and ingest into the database.
 * A specific role is required to perform this service operation. Please contact the UDL team for
 * assistance.
 */
class LaunchDetectionCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionCreateParams: LaunchDetectionCreateParams) = apply {
    ...
    override fun toString() =
        "LaunchDetectionCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
