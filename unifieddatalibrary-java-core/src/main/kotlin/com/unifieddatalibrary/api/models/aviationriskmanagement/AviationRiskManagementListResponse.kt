 ...
 */
class AviationRiskManagementListResponse
...
private constructor(
    ...
    /** A builder for [AviationRiskManagementListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aviationRiskManagementListResponse: AviationRiskManagementListResponse) =
            apply {
                classificationMarking = aviationRiskManagementListResponse.classificationMarking
                dataMode = aviationRiskManagementListResponse.dataMode
                idMission = aviationRiskManagementListResponse.idMission
                source = aviationRiskManagementListResponse.source
                id = aviationRiskManagementListResponse.id
                aviationRiskManagementWorksheetRecord =
                    aviationRiskManagementListResponse.aviationRiskManagementWorksheetRecord.map {
                        it.toMutableList()
                    }
                createdAt = aviationRiskManagementListResponse.createdAt
                createdBy = aviationRiskManagementListResponse.createdBy
                extMissionId = aviationRiskManagementListResponse.extMissionId
                missionNumber = aviationRiskManagementListResponse.missionNumber
                orgId = aviationRiskManagementListResponse.orgId
                origin = aviationRiskManagementListResponse.origin
                origNetwork = aviationRiskManagementListResponse.origNetwork
                sourceDl = aviationRiskManagementListResponse.sourceDl
                unitId = aviationRiskManagementListResponse.unitId
                updatedAt = aviationRiskManagementListResponse.updatedAt
                updatedBy = aviationRiskManagementListResponse.updatedBy
                additionalProperties =
                    aviationRiskManagementListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AviationRiskManagementListResponse].
         *
         ...
         */
        fun build(): AviationRiskManagementListResponse =
            AviationRiskManagementListResponse(
    ...
    fun validate(): AviationRiskManagementListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AviationRiskManagementListResponse &&
