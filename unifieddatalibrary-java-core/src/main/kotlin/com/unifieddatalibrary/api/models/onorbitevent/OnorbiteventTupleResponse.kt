...
class OnorbiteventTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventTupleResponse: OnorbiteventTupleResponse) =
            apply {
    ...
    fun validate(): OnorbiteventTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
