 ...
 */
class ItemTrackingUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            itemTrackingUnvalidatedPublishParams: ItemTrackingUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                itemTrackingUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * The United States distinguished visitor code of the person scanned, only applicable
             * to people.
             */
             ...
             *
             * You should usually call [Builder.idItem] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ItemTrackingUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ItemTrackingUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
