...
class RfObservationCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationCreateParams: RfObservationCreateParams) =
            apply {
        ...
        /** Antenna name of the RFObservation record. */
        fun antennaName(antennaName: String) =
            apply {
                body.antennaName(antennaName)
            }
        ...
        /** Array of measured signal baud rates. */
        fun baudRates(baudRates: List<Double>) =
            apply {
                body.baudRates(baudRates)
            }
        ...
        fun addBaudRate(baudRate: Double) =
            apply {
                body.addBaudRate(baudRate)
            }

        /** The ratio of bit errors per number of received bits. */
        fun bitErrorRate(bitErrorRate: Double) =
            apply {
        ...
        /** Array of chipRates. */
        fun chipRates(chipRates: List<Double>) =
            apply {
                body.chipRates(chipRates)
            }
        ...
        fun addChipRate(chipRate: Double) =
            apply {
                body.addChipRate(chipRate)
            }

        /** Array of code fills. */
        fun codeFills(codeFills: List<String>) =
            apply {
                body.codeFills(codeFills)
            }
        ...
        fun addCodeFill(codeFill: String) =
            apply {
                body.addCodeFill(codeFill)
            }

        /** Array of code lengths. */
        fun codeLengths(codeLengths: List<Double>) =
            apply {
        ...
        fun addCodeLength(codeLength: Double) =
            apply {
                body.addCodeLength(codeLength)
            }

        /** Array of code taps. */
        fun codeTaps(codeTaps: List<String>) =
            apply {
                body.codeTaps(codeTaps)
            }
        ...
        /** Confidence in the signal and its measurements and characterization. */
        fun confidence(confidence: Double) =
            apply {
        ...
        /** Array of measurement confidences. */
        fun confidences(confidences: List<Double>) =
            apply {
        ...
        /** Array of individual PSD frequencies of the signal in Hz. This array should correspond with the same-sized array of powers. */
        fun frequencies(frequencies: List<Double>) =
            apply {
        ...
        /** Expected Equivalent Isotopically Radiated Power in dBW. */
        fun nominalEirp(nominalEirp: Double) =
            apply {
                body.nominalEirp(nominalEirp)
            }
        ...
        /** Nominal or expected signal to noise ratio, in dB. */
        fun nominalSnr(nominalSnr: Double) =
            apply {
                body.nominalSnr(nominalSnr)
            }
        ...
        /** Array of pnOrder. */
        fun pnOrders(pnOrders: List<Int>) =
            apply {
                body.pnOrders(pnOrders)
            }
        ...
        fun addPnOrder(pnOrder: Int) =
            apply {
                body.addPnOrder(pnOrder)
            }

        /** The antenna pointing dependent polarizer angle, in degrees. */
        fun polarity(polarity: Double) =
            apply {
        ...
        /** Transponder polarization e.g. H - (Horizontally Polarized) Perpendicular to Earth's surface, V - (Vertically Polarized) Parallel to Earth's surface, L - (Left Hand Circularly Polarized) Rotating left relative to the earth's surface, R - (Right Hand Circularly Polarized) Rotating right relative to the earth's surface. */
        fun polarityType(polarityType: PolarityType) =
            apply {
        ...
        /** Array of optional source provided identifiers of the measurements/signals. */
        fun signalIds(signalIds: List<String>) =
            apply {
                body.signalIds(signalIds)
            }
        ...
        /** Switch Point of the RFObservation record. */
        fun switchPoint(switchPoint: Int) =
            apply {
                body.switchPoint(switchPoint)
            }
        ...
        /** Array of optional source provided telemetry identifiers of the measurements/signals. */
        fun telemetryIds(telemetryIds: List<String>) =
            apply {
        ...
        fun addTelemetryId(telemetryId: String) =
            apply {
                body.addTelemetryId(telemetryId)
            }
        ...
        /** Target track or apparent range in km. */
        fun trackRange(trackRange: Double) =
            apply {
                body.trackRange(trackRange)
            }
        ...
        /** Optional identifier provided by observation source to indicate the transponder used for this measurement. */
        fun transponder(transponder: String) =
            apply {
                body.transponder(transponder)
            }
    ...
    override fun toString() = "RfObservationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
