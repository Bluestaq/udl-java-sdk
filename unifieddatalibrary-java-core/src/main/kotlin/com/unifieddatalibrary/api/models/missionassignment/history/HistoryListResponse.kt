...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            mad = historyListResponse.mad
            source = historyListResponse.source
            ts = historyListResponse.ts
            id = historyListResponse.id
            c1associateddmpis = historyListResponse.c1associateddmpis
            c2air = historyListResponse.c2air
            c2alt = historyListResponse.c2alt
            c2crs = historyListResponse.c2crs
            c2exerciseindicator = historyListResponse.c2exerciseindicator
            c2exercisemof = historyListResponse.c2exercisemof
            c2id = historyListResponse.c2id
            c2idamplifyingdescriptor = historyListResponse.c2idamplifyingdescriptor
            c2lnd = historyListResponse.c2lnd
            c2spc = historyListResponse.c2spc
            c2spd = historyListResponse.c2spd
            c2specialinterestindicator = historyListResponse.c2specialinterestindicator
            c2sur = historyListResponse.c2sur
            c3elv = historyListResponse.c3elv
            c3lat = historyListResponse.c3lat
            c3lon = historyListResponse.c3lon
            c3ptl = historyListResponse.c3ptl
            c3ptnum = historyListResponse.c3ptnum
            c4colon = historyListResponse.c4colon
            c4def = historyListResponse.c4def
            c4egress = historyListResponse.c4egress
            c4mod = historyListResponse.c4mod
            c4numberofstores = historyListResponse.c4numberofstores
            c4runin = historyListResponse.c4runin
            c4tgt = historyListResponse.c4tgt
            c4timediscrete = historyListResponse.c4timediscrete
            c4tm = historyListResponse.c4tm
            c4typeofstores = historyListResponse.c4typeofstores
            c5colon = historyListResponse.c5colon
            c5elevationlsbs = historyListResponse.c5elevationlsbs
            c5haeadj = historyListResponse.c5haeadj
            c5latlsb = historyListResponse.c5latlsb
            c5lonlsb = historyListResponse.c5lonlsb
            c5tgtbrng = historyListResponse.c5tgtbrng
            c5tw = historyListResponse.c5tw
            c6dspc = historyListResponse.c6dspc
            c6dspct = historyListResponse.c6dspct
            c6fplpm = historyListResponse.c6fplpm
            c6intel = historyListResponse.c6intel
            c6laser = historyListResponse.c6laser
            c6longpm = historyListResponse.c6longpm
            c6tnr3 = historyListResponse.c6tnr3
            c7elang2 = historyListResponse.c7elang2
            c7in3p = historyListResponse.c7in3p
            c7tnor = historyListResponse.c7tnor
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            env = historyListResponse.env
            index = historyListResponse.index
            lat = historyListResponse.lat
            lon = historyListResponse.lon
            orginx = historyListResponse.orginx
            origin = historyListResponse.origin
            origNetwork = historyListResponse.origNetwork
            rc = historyListResponse.rc
            rr = historyListResponse.rr
            sz = historyListResponse.sz
            tno = historyListResponse.tno
            trkId = historyListResponse.trkId
            twenv = historyListResponse.twenv
