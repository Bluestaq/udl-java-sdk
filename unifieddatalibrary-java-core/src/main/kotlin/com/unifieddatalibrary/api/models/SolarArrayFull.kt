...
class SolarArrayFull private constructor(
    ...
    private val solarArrayDetails: JsonField<List<SolarArrayDetailsFull>>,
    ...
    private constructor(
        ...
        @JsonProperty("solarArrayDetails") @ExcludeMissing solarArrayDetails: JsonField<List<SolarArrayDetailsFull>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun solarArrayDetails(): Optional<List<SolarArrayDetailsFull>> = solarArrayDetails.getOptional("solarArrayDetails")
    ...
    /**
     * Returns the raw JSON value of [solarArrayDetails].
     *
     * Unlike [solarArrayDetails], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("solarArrayDetails")
    @ExcludeMissing
    fun _solarArrayDetails(): JsonField<List<SolarArrayDetailsFull>> = solarArrayDetails
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SolarArrayFull].
         *
    ...
    class Builder internal constructor() {
        ...
        private var solarArrayDetails: JsonField<MutableList<SolarArrayDetailsFull>>? = null
        private var updatedAt: JsonField<OffsetDateTime> = JsonMissing.of()
        private var updatedBy: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(solarArrayFull: SolarArrayFull) =
            apply {
                dataMode = solarArrayFull.dataMode
                name = solarArrayFull.name
                source = solarArrayFull.source
                id = solarArrayFull.id
                createdAt = solarArrayFull.createdAt
                createdBy = solarArrayFull.createdBy
                origin = solarArrayFull.origin
                origNetwork = solarArrayFull.origNetwork
                solarArrayDetails = solarArrayFull.solarArrayDetails.map { it.toMutableList() }
                updatedAt = solarArrayFull.updatedAt
                updatedBy = solarArrayFull.updatedBy
                additionalProperties = solarArrayFull.additionalProperties.toMutableMap()
            }
        ...
        /** Read-only collection of additional SolarArrayDetails by various sources for this organization, ignored on create/update. These details must be created separately via the /udl/solararraydetails operations. */
        fun solarArrayDetails(solarArrayDetails: List<SolarArrayDetailsFull>) = solarArrayDetails(JsonField.of(solarArrayDetails))

        /**
         * Sets [Builder.solarArrayDetails] to an arbitrary JSON value.
         *
         * You should usually call [Builder.solarArrayDetails] with a well-typed `List<SolarArrayDetailsFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun solarArrayDetails(solarArrayDetails: JsonField<List<SolarArrayDetailsFull>>) =
            apply {
                this.solarArrayDetails = solarArrayDetails.map { it.toMutableList() }
            }

        /**
         * Adds a single [SolarArrayDetailsFull] to [solarArrayDetails].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSolarArrayDetail(solarArrayDetail: SolarArrayDetailsFull) =
            apply {
                solarArrayDetails = (solarArrayDetails ?: JsonField.of(mutableListOf())).also {
                    checkKnown("solarArrayDetails", it).add(solarArrayDetail)
                }
            }
        ...
        /**
         * Returns an immutable instance of [SolarArrayFull].
         *
        ...
        fun build(): SolarArrayFull =
            SolarArrayFull(
              ...
              origin,
              origNetwork,
              (solarArrayDetails ?: JsonMissing.of()).map { it.toImmutable() },
              updatedAt,
              updatedBy,
    ...
    fun validate(): SolarArrayFull =
        apply {
            ...
            origin()
            origNetwork()
            solarArrayDetails().ifPresent { it.forEach { it.validate() } }
            updatedAt()
            updatedBy()
            validated = true
        }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (solarArrayDetails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "SolarArrayFull{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, solarArrayDetails=$solarArrayDetails, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
