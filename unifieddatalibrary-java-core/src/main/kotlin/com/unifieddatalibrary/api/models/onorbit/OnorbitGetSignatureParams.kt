...
class OnorbitGetSignatureParams private constructor(
    ...
    fun idOnOrbit(): String = idOnOrbit
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitGetSignatureParams].
         *
    ...
    /** A builder for [OnorbitGetSignatureParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitGetSignatureParams: OnorbitGetSignatureParams) =
            apply {
                idOnOrbit = onorbitGetSignatureParams.idOnOrbit
                firstResult = onorbitGetSignatureParams.firstResult
                maxResults = onorbitGetSignatureParams.maxResults
                additionalHeaders = onorbitGetSignatureParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitGetSignatureParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitGetSignatureParams].
         *
         ...
         */
        fun build(): OnorbitGetSignatureParams =
    ...
    override fun toString() = "OnorbitGetSignatureParams{idOnOrbit=$idOnOrbit, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
