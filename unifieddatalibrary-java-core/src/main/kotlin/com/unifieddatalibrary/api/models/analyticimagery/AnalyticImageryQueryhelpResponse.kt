...
class AnalyticImageryQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AnalyticImageryQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AnalyticImageryQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryQueryhelpResponse: AnalyticImageryQueryhelpResponse) =
            apply {
                aodrSupported = analyticImageryQueryhelpResponse.aodrSupported
                classificationMarking = analyticImageryQueryhelpResponse.classificationMarking
                description = analyticImageryQueryhelpResponse.description
                historySupported = analyticImageryQueryhelpResponse.historySupported
                name = analyticImageryQueryhelpResponse.name
                parameters = analyticImageryQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = analyticImageryQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = analyticImageryQueryhelpResponse.restSupported
                sortSupported = analyticImageryQueryhelpResponse.sortSupported
                typeName = analyticImageryQueryhelpResponse.typeName
                uri = analyticImageryQueryhelpResponse.uri
                additionalProperties = analyticImageryQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticImageryQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AnalyticImageryQueryhelpResponse =
    ...
    fun validate(): AnalyticImageryQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AnalyticImageryQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
