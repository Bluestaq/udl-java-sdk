...
class AnalyticImageryQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(analyticImageryQueryhelpResponse: AnalyticImageryQueryhelpResponse) =
            apply {
                ...
                requiredRoles =
                    analyticImageryQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    analyticImageryQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): AnalyticImageryQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
