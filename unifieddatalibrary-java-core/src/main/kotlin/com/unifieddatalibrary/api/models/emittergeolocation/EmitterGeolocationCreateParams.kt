...
/**
 * Service operation to take a single RF geolocation as a POST body and ingest into the database.
 ...
 */
class EmitterGeolocationCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun signalOfInterestType(): String = body.signalOfInterestType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun algVersion(): Optional<String> = body.algVersion()
     ...
     *   if the server responded with an unexpected value).
     */
    fun cluster(): Optional<String> = body.cluster()
     ...
     *   if the server responded with an unexpected value).
     */
    fun confArea(): Optional<Double> = body.confArea()
     ...
     *   if the server responded with an unexpected value).
     */
    fun createdTs(): Optional<OffsetDateTime> = body.createdTs()
     ...
     *   if the server responded with an unexpected value).
     */
    fun detectAlt(): Optional<Double> = body.detectAlt()
     ...
     *   if the server responded with an unexpected value).
     */
    fun detectLat(): Optional<Double> = body.detectLat()
     ...
     *   if the server responded with an unexpected value).
     */
    fun detectLon(): Optional<Double> = body.detectLon()
     ...
     *   if the server responded with an unexpected value).
     */
    fun errEllp(): Optional<List<Double>> = body.errEllp()
     ...
     *   if the server responded with an unexpected value).
     */
    fun numBursts(): Optional<Int> = body.numBursts()
     ...
     *   if the server responded with an unexpected value).
     */
    fun origRfEmitterId(): Optional<String> = body.origRfEmitterId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun receivedTs(): Optional<OffsetDateTime> = body.receivedTs()
     ...
     *   if the server responded with an unexpected value).
     */
    fun signalOfInterest(): Optional<String> = body.signalOfInterest()
     ...
     * type.
     */
    fun _signalOfInterestType(): JsonField<String> = body._signalOfInterestType()
     ...
     */
    fun _algVersion(): JsonField<String> = body._algVersion()
     ...
     */
    fun _cluster(): JsonField<String> = body._cluster()
     ...
     */
    fun _confArea(): JsonField<Double> = body._confArea()
     ...
     */
    fun _createdTs(): JsonField<OffsetDateTime> = body._createdTs()
     ...
     */
    fun _detectAlt(): JsonField<Double> = body._detectAlt()
     ...
     */
    fun _detectLat(): JsonField<Double> = body._detectLat()
     ...
     */
    fun _detectLon(): JsonField<Double> = body._detectLon()
     ...
     */
    fun _errEllp(): JsonField<List<Double>> = body._errEllp()
     ...
     */
    fun _numBursts(): JsonField<Int> = body._numBursts()
     ...
     */
    fun _origRfEmitterId(): JsonField<String> = body._origRfEmitterId()
     ...
     */
    fun _receivedTs(): JsonField<OffsetDateTime> = body._receivedTs()
     ...
     * type.
     */
    fun _signalOfInterest(): JsonField<String> = body._signalOfInterest()
    ...
    /** A builder for [EmitterGeolocationCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationCreateParams: EmitterGeolocationCreateParams) = apply {
            body = emitterGeolocationCreateParams.body.toBuilder()
            additionalHeaders = emitterGeolocationCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = emitterGeolocationCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Type of the signal of interest of this Emitter Geo Location (e.g. RF). */
        fun signalOfInterestType(signalOfInterestType: String) = apply {
            body.signalOfInterestType(signalOfInterestType)
        }
        ...
        /** The EmitterGeo algorithm type and version used in Emitter geolocation calculations. */
        fun algVersion(algVersion: String) = apply { body.algVersion(algVersion) }
         ...
         * value.
         */
        fun algVersion(algVersion: JsonField<String>) = apply { body.algVersion(algVersion) }
        ...
        /** The name(s) of the subset of constellation spacecraft that made this detection. */
        fun cluster(cluster: String) = apply { body.cluster(cluster) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun cluster(cluster: JsonField<String>) = apply { body.cluster(cluster) }

        /**
         * The area of the confidence ellipse specified in meters squared to contain the emitter
         * with a 95% probability.
         */
        fun confArea(confArea: Double) = apply { body.confArea(confArea) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun confArea(confArea: JsonField<Double>) = apply { body.confArea(confArea) }
         ...
         * precision.
         */
        fun createdTs(createdTs: OffsetDateTime) = apply { body.createdTs(createdTs) }
         ...
         * supported value.
         */
        fun createdTs(createdTs: JsonField<OffsetDateTime>) = apply { body.createdTs(createdTs) }

        /** The altitude relative to WGS-84 ellipsoid, in meters. */
        fun detectAlt(detectAlt: Double) = apply { body.detectAlt(detectAlt) }
         ...
         * value.
         */
        fun detectAlt(detectAlt: JsonField<Double>) = apply { body.detectAlt(detectAlt) }
         ...
         */
        fun detectLat(detectLat: Double) = apply { body.detectLat(detectLat) }
         ...
         * value.
         */
        fun detectLat(detectLat: JsonField<Double>) = apply { body.detectLat(detectLat) }
         ...
         */
        fun detectLon(detectLon: Double) = apply { body.detectLon(detectLon) }
         ...
         * value.
         */
        fun detectLon(detectLon: JsonField<Double>) = apply { body.detectLon(detectLon) }
         ...
         * value.
         */
        fun errEllp(errEllp: JsonField<List<Double>>) = apply { body.errEllp(errEllp) }
         ...
         */
        fun addErrEllp(errEllp: Double) = apply { body.addErrEllp(errEllp) }
        ...
        /** The maximum detected frequency in megahertz. */
        fun maxFreq(maxFreq: Double) = apply { body.maxFreq(maxFreq) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun numBursts(numBursts: JsonField<Int>) = apply { body.numBursts(numBursts) }
         ...
         */
        fun origRfEmitterId(origRfEmitterId: String) = apply {
            body.origRfEmitterId(origRfEmitterId)
        }
         ...
         * geolocation.
         */
        fun passGroupId(passGroupId: String) = apply { body.passGroupId(passGroupId) }
         ...
         */
        fun receivedTs(receivedTs: OffsetDateTime) = apply { body.receivedTs(receivedTs) }
        ...
        /** The name of the signal of interest. */
        fun signalOfInterest(signalOfInterest: String) = apply {
            body.signalOfInterest(signalOfInterest)
        }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationCreateParams].
         *
         ...
         */
        fun build(): EmitterGeolocationCreateParams =
            EmitterGeolocationCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EmitterGeolocationCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "EmitterGeolocationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
