...
class LaunchEventTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("launchDate") @ExcludeMissing launchDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("launchFacilityName") @ExcludeMissing launchFacilityName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("launchFailureCode") @ExcludeMissing launchFailureCode: JsonField<String> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun launchFacilityName(): Optional<String> = launchFacilityName.getOptional("launchFacilityName")
     ...
     *
     * Unlike [launchFacilityName], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [launchFailureCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchEventTupleResponse].
         *
    ...
    /** A builder for [LaunchEventTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventTupleResponse: LaunchEventTupleResponse) =
            apply {
                classificationMarking = launchEventTupleResponse.classificationMarking
                dataMode = launchEventTupleResponse.dataMode
                msgCreateDate = launchEventTupleResponse.msgCreateDate
                source = launchEventTupleResponse.source
                id = launchEventTupleResponse.id
                beNumber = launchEventTupleResponse.beNumber
                createdAt = launchEventTupleResponse.createdAt
                createdBy = launchEventTupleResponse.createdBy
                declassificationDate = launchEventTupleResponse.declassificationDate
                declassificationString = launchEventTupleResponse.declassificationString
                derivedFrom = launchEventTupleResponse.derivedFrom
                idOnOrbit = launchEventTupleResponse.idOnOrbit
                launchDate = launchEventTupleResponse.launchDate
                launchFacilityName = launchEventTupleResponse.launchFacilityName
                launchFailureCode = launchEventTupleResponse.launchFailureCode
                onOrbit = launchEventTupleResponse.onOrbit
                origin = launchEventTupleResponse.origin
                origNetwork = launchEventTupleResponse.origNetwork
                origObjectId = launchEventTupleResponse.origObjectId
                oSuffix = launchEventTupleResponse.oSuffix
                satNo = launchEventTupleResponse.satNo
                additionalProperties = launchEventTupleResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.launchDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchDate(launchDate: JsonField<OffsetDateTime>) =
            apply {
                this.launchDate = launchDate
            }

        /** The Launch facility name. */
        fun launchFacilityName(launchFacilityName: String) = launchFacilityName(JsonField.of(launchFacilityName))

        /**
         * Sets [Builder.launchFacilityName] to an arbitrary JSON value.
         *
         * You should usually call [Builder.launchFacilityName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchFacilityName(launchFacilityName: JsonField<String>) =
            apply {
                this.launchFacilityName = launchFacilityName
            }

        /** The DISOB launch Failure Code, if applicable. */
        fun launchFailureCode(launchFailureCode: String) = launchFailureCode(JsonField.of(launchFailureCode))

        /**
         * Sets [Builder.launchFailureCode] to an arbitrary JSON value.
         *
         * You should usually call [Builder.launchFailureCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchFailureCode(launchFailureCode: JsonField<String>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [LaunchEventTupleResponse].
         *
         ...
         */
        fun build(): LaunchEventTupleResponse =
    ...
    fun validate(): LaunchEventTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (msgCreateDate.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (beNumber.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (declassificationDate.asKnown().isPresent) 1 else 0) + (if (declassificationString.asKnown().isPresent) 1 else 0) + (if (derivedFrom.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (launchDate.asKnown().isPresent) 1 else 0) + (if (launchFacilityName.asKnown().isPresent) 1 else 0) + (if (launchFailureCode.asKnown().isPresent) 1 else 0) + (onOrbit.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (oSuffix.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchEventTupleResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && msgCreateDate == other.msgCreateDate && source == other.source && id == other.id && beNumber == other.beNumber && createdAt == other.createdAt && createdBy == other.createdBy && declassificationDate == other.declassificationDate && declassificationString == other.declassificationString && derivedFrom == other.derivedFrom && idOnOrbit == other.idOnOrbit && launchDate == other.launchDate && launchFacilityName == other.launchFacilityName && launchFailureCode == other.launchFailureCode && onOrbit == other.onOrbit && origin == other.origin && origNetwork == other.origNetwork && origObjectId == other.origObjectId && oSuffix == other.oSuffix && satNo == other.satNo && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, msgCreateDate, source, id, beNumber, createdAt, createdBy, declassificationDate, declassificationString, derivedFrom, idOnOrbit, launchDate, launchFacilityName, launchFailureCode, onOrbit, origin, origNetwork, origObjectId, oSuffix, satNo, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "LaunchEventTupleResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, msgCreateDate=$msgCreateDate, source=$source, id=$id, beNumber=$beNumber, createdAt=$createdAt, createdBy=$createdBy, declassificationDate=$declassificationDate, declassificationString=$declassificationString, derivedFrom=$derivedFrom, idOnOrbit=$idOnOrbit, launchDate=$launchDate, launchFacilityName=$launchFacilityName, launchFailureCode=$launchFailureCode, onOrbit=$onOrbit, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, oSuffix=$oSuffix, satNo=$satNo, additionalProperties=$additionalProperties}"
}
