...
class LaunchEventTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventTupleResponse: LaunchEventTupleResponse) = apply {
    ...
    fun validate(): LaunchEventTupleResponse = apply {
        if (validated) {
            return@apply
        }
