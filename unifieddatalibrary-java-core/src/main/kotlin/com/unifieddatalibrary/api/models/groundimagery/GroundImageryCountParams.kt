 ...
 */
class GroundImageryCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GroundImageryCountParams].
         *
    ...
    /** A builder for [GroundImageryCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryCountParams: GroundImageryCountParams) = apply {
            imageTime = groundImageryCountParams.imageTime
            firstResult = groundImageryCountParams.firstResult
            maxResults = groundImageryCountParams.maxResults
            additionalHeaders = groundImageryCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = groundImageryCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GroundImageryCountParams].
         *
         ...
         */
        fun build(): GroundImageryCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is GroundImageryCountParams && imageTime == other.imageTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "GroundImageryCountParams{imageTime=$imageTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
