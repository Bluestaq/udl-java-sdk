...
class LaunchVehicleListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<LaunchVehicleListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleListPageAsync: LaunchVehicleListPageAsync) = apply {
        ...
        fun service(service: LaunchVehicleServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaunchVehicleListPageAsync &&
    ...
    override fun toString() =
        "LaunchVehicleListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
