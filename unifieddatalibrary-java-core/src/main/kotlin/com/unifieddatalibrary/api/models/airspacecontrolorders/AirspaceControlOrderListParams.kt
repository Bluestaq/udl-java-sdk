 ...
 */
class AirspaceControlOrderListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirspaceControlOrderListParams = builder().build()
    ...
    /** A builder for [AirspaceControlOrderListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airspaceControlOrderListParams: AirspaceControlOrderListParams) = apply {
            firstResult = airspaceControlOrderListParams.firstResult
            maxResults = airspaceControlOrderListParams.maxResults
            additionalHeaders = airspaceControlOrderListParams.additionalHeaders.toBuilder()
            additionalQueryParams = airspaceControlOrderListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AirspaceControlOrderListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirspaceControlOrderListParams =
            AirspaceControlOrderListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirspaceControlOrderListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirspaceControlOrderListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
