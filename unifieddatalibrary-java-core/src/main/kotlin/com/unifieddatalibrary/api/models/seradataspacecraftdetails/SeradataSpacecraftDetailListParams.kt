 ...
 */
class SeradataSpacecraftDetailListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataSpacecraftDetailListParams = builder().build()
    ...
    /** A builder for [SeradataSpacecraftDetailListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataSpacecraftDetailListParams: SeradataSpacecraftDetailListParams) =
            apply {
                firstResult = seradataSpacecraftDetailListParams.firstResult
                maxResults = seradataSpacecraftDetailListParams.maxResults
                additionalHeaders = seradataSpacecraftDetailListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    seradataSpacecraftDetailListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataSpacecraftDetailListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataSpacecraftDetailListParams =
            SeradataSpacecraftDetailListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeradataSpacecraftDetailListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeradataSpacecraftDetailListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
