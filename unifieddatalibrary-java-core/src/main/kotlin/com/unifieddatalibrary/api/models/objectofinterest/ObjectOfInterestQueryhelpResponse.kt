...
class ObjectOfInterestQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(objectOfInterestQueryhelpResponse: ObjectOfInterestQueryhelpResponse) =
            apply {
                ...
                requiredRoles =
                    objectOfInterestQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    objectOfInterestQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): ObjectOfInterestQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
