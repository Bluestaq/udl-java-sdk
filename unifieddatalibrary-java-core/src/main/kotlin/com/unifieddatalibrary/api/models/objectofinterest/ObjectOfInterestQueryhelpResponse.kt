...
class ObjectOfInterestQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ObjectOfInterestQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ObjectOfInterestQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectOfInterestQueryhelpResponse: ObjectOfInterestQueryhelpResponse) =
            apply {
                aodrSupported = objectOfInterestQueryhelpResponse.aodrSupported
                classificationMarking = objectOfInterestQueryhelpResponse.classificationMarking
                description = objectOfInterestQueryhelpResponse.description
                historySupported = objectOfInterestQueryhelpResponse.historySupported
                name = objectOfInterestQueryhelpResponse.name
                parameters = objectOfInterestQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = objectOfInterestQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = objectOfInterestQueryhelpResponse.restSupported
                sortSupported = objectOfInterestQueryhelpResponse.sortSupported
                typeName = objectOfInterestQueryhelpResponse.typeName
                uri = objectOfInterestQueryhelpResponse.uri
                additionalProperties = objectOfInterestQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ObjectOfInterestQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ObjectOfInterestQueryhelpResponse =
    ...
    fun validate(): ObjectOfInterestQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ObjectOfInterestQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
