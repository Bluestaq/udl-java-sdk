...
class SensorObservationTypeListPage
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorObservationTypeListPage: SensorObservationTypeListPage) = apply {
        ...
        fun service(service: SensorObservationTypeService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorObservationTypeListPage &&
    ...
    override fun toString() =
        "SensorObservationTypeListPage{service=$service, params=$params, items=$items}"
}
