...
class EngineTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EngineTupleParams].
         *
    ...
    /** A builder for [EngineTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineTupleParams: EngineTupleParams) =
            apply {
                columns = engineTupleParams.columns
                firstResult = engineTupleParams.firstResult
                maxResults = engineTupleParams.maxResults
                additionalHeaders = engineTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = engineTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EngineTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EngineTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EngineTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
