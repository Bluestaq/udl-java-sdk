 ...
 */
class LaunchSiteDetailListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteDetailListResponse].
         *
    ...
    /** A builder for [LaunchSiteDetailListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteDetailListResponse: LaunchSiteDetailListResponse) = apply {
            classificationMarking = launchSiteDetailListResponse.classificationMarking
            dataMode = launchSiteDetailListResponse.dataMode
            idLaunchSite = launchSiteDetailListResponse.idLaunchSite
            source = launchSiteDetailListResponse.source
            id = launchSiteDetailListResponse.id
            availableInclinations =
                launchSiteDetailListResponse.availableInclinations.map { it.toMutableList() }
            createdAt = launchSiteDetailListResponse.createdAt
            createdBy = launchSiteDetailListResponse.createdBy
            description = launchSiteDetailListResponse.description
            idLocation = launchSiteDetailListResponse.idLocation
            launchGroup = launchSiteDetailListResponse.launchGroup
            location = launchSiteDetailListResponse.location
            origin = launchSiteDetailListResponse.origin
            origNetwork = launchSiteDetailListResponse.origNetwork
            additionalProperties = launchSiteDetailListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteDetailListResponse].
         *
         ...
         */
        fun build(): LaunchSiteDetailListResponse =
    ...
    fun validate(): LaunchSiteDetailListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaunchSiteDetailListResponse &&
