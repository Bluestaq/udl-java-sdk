...
class OrganizationdetailListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationdetailListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationdetailListResponse: OrganizationdetailListResponse) =
            apply {
                ...
                additionalProperties = organizationdetailListResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): OrganizationdetailListResponse =
        apply {
            if (validated) {
              return@apply
            }
