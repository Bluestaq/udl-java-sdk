...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackRouteListParams].
         *
    ...
    /** A builder for [TrackRouteListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackRouteListParams: TrackRouteListParams) = apply {
            lastUpdateDate = trackRouteListParams.lastUpdateDate
            firstResult = trackRouteListParams.firstResult
            maxResults = trackRouteListParams.maxResults
            additionalHeaders = trackRouteListParams.additionalHeaders.toBuilder()
            additionalQueryParams = trackRouteListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TrackRouteListParams].
         *
         ...
         */
        fun build(): TrackRouteListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackRouteListParams && lastUpdateDate == other.lastUpdateDate && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TrackRouteListParams{lastUpdateDate=$lastUpdateDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
