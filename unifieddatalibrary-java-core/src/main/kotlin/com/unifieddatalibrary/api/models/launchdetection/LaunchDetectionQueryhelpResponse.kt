...
class LaunchDetectionQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(launchDetectionQueryhelpResponse: LaunchDetectionQueryhelpResponse) =
            apply {
                ...
                requiredRoles =
                    launchDetectionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    launchDetectionQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): LaunchDetectionQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
