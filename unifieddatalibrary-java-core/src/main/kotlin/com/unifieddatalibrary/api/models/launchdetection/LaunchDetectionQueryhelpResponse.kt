...
class LaunchDetectionQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LaunchDetectionQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [LaunchDetectionQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionQueryhelpResponse: LaunchDetectionQueryhelpResponse) =
            apply {
                aodrSupported = launchDetectionQueryhelpResponse.aodrSupported
                classificationMarking = launchDetectionQueryhelpResponse.classificationMarking
                description = launchDetectionQueryhelpResponse.description
                historySupported = launchDetectionQueryhelpResponse.historySupported
                name = launchDetectionQueryhelpResponse.name
                parameters = launchDetectionQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = launchDetectionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = launchDetectionQueryhelpResponse.restSupported
                sortSupported = launchDetectionQueryhelpResponse.sortSupported
                typeName = launchDetectionQueryhelpResponse.typeName
                uri = launchDetectionQueryhelpResponse.uri
                additionalProperties = launchDetectionQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchDetectionQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchDetectionQueryhelpResponse =
    ...
    fun validate(): LaunchDetectionQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchDetectionQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
