...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StageCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageCountParams: StageCountParams) = apply {
    ...
    override fun toString() =
        "StageCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
