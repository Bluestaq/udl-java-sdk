...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventListResponse: LaunchEventListResponse) = apply {
    ...
    fun validate(): LaunchEventListResponse = apply {
        if (validated) {
            return@apply
        }
