...
class IsrCollectionQueryhelpResponse
private constructor(
    ...
    /** A builder for [IsrCollectionQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isrCollectionQueryhelpResponse: IsrCollectionQueryhelpResponse) = apply {
            aodrSupported = isrCollectionQueryhelpResponse.aodrSupported
            classificationMarking = isrCollectionQueryhelpResponse.classificationMarking
            description = isrCollectionQueryhelpResponse.description
            historySupported = isrCollectionQueryhelpResponse.historySupported
            name = isrCollectionQueryhelpResponse.name
            parameters = isrCollectionQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = isrCollectionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = isrCollectionQueryhelpResponse.restSupported
            sortSupported = isrCollectionQueryhelpResponse.sortSupported
            typeName = isrCollectionQueryhelpResponse.typeName
            uri = isrCollectionQueryhelpResponse.uri
            additionalProperties =
                isrCollectionQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsrCollectionQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IsrCollectionQueryhelpResponse =
            IsrCollectionQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): IsrCollectionQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
