...
class StateVectorQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorQueryhelpResponse: StateVectorQueryhelpResponse) = apply {
    ...
    fun validate(): StateVectorQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
