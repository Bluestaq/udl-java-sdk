...
class StateVectorQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [StateVectorQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [StateVectorQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorQueryhelpResponse: StateVectorQueryhelpResponse) =
            apply {
                aodrSupported = stateVectorQueryhelpResponse.aodrSupported
                classificationMarking = stateVectorQueryhelpResponse.classificationMarking
                description = stateVectorQueryhelpResponse.description
                historySupported = stateVectorQueryhelpResponse.historySupported
                name = stateVectorQueryhelpResponse.name
                parameters = stateVectorQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = stateVectorQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = stateVectorQueryhelpResponse.restSupported
                sortSupported = stateVectorQueryhelpResponse.sortSupported
                typeName = stateVectorQueryhelpResponse.typeName
                uri = stateVectorQueryhelpResponse.uri
                additionalProperties = stateVectorQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StateVectorQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StateVectorQueryhelpResponse =
    ...
    fun validate(): StateVectorQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
