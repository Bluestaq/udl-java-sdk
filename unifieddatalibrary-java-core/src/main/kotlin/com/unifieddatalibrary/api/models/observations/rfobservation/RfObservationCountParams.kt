...
class RfObservationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfObservationCountParams].
         *
    ...
    /** A builder for [RfObservationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationCountParams: RfObservationCountParams) =
            apply {
                obTime = rfObservationCountParams.obTime
                firstResult = rfObservationCountParams.firstResult
                maxResults = rfObservationCountParams.maxResults
                additionalHeaders = rfObservationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfObservationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfObservationCountParams].
         *
         ...
         */
        fun build(): RfObservationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfObservationCountParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfObservationCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
