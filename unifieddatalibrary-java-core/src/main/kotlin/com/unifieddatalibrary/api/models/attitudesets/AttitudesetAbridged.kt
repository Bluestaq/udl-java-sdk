...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudesetAbridged: AttitudesetAbridged) = apply {
    ...
    fun validate(): AttitudesetAbridged = apply {
        if (validated) {
            return@apply
        }
