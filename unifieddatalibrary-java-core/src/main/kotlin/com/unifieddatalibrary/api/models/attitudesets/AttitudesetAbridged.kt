...
class AttitudesetAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AttitudesetAbridged].
         *
    ...
    /** A builder for [AttitudesetAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudesetAbridged: AttitudesetAbridged) =
            apply {
                classificationMarking = attitudesetAbridged.classificationMarking
                dataMode = attitudesetAbridged.dataMode
                endTime = attitudesetAbridged.endTime
                frame1 = attitudesetAbridged.frame1
                frame2 = attitudesetAbridged.frame2
                numPoints = attitudesetAbridged.numPoints
                source = attitudesetAbridged.source
                startTime = attitudesetAbridged.startTime
                type = attitudesetAbridged.type
                id = attitudesetAbridged.id
                createdAt = attitudesetAbridged.createdAt
                createdBy = attitudesetAbridged.createdBy
                esId = attitudesetAbridged.esId
                eulerRotSeq = attitudesetAbridged.eulerRotSeq
                idOnOrbit = attitudesetAbridged.idOnOrbit
                idSensor = attitudesetAbridged.idSensor
                interpolator = attitudesetAbridged.interpolator
                interpolatorDegree = attitudesetAbridged.interpolatorDegree
                notes = attitudesetAbridged.notes
                origin = attitudesetAbridged.origin
                origNetwork = attitudesetAbridged.origNetwork
                origObjectId = attitudesetAbridged.origObjectId
                origSensorId = attitudesetAbridged.origSensorId
                precAngleInit = attitudesetAbridged.precAngleInit
                satNo = attitudesetAbridged.satNo
                spinAngleInit = attitudesetAbridged.spinAngleInit
                stepSize = attitudesetAbridged.stepSize
                additionalProperties = attitudesetAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AttitudesetAbridged].
         *
    ...
    fun validate(): AttitudesetAbridged =
        apply {
            if (validated) {
              return@apply
            }
