...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmireportGetResponse].
         *
    ...
    /** A builder for [EmireportGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportGetResponse: EmireportGetResponse) = apply {
            classificationMarking = emireportGetResponse.classificationMarking
            dataMode = emireportGetResponse.dataMode
            isr = emireportGetResponse.isr
            reportId = emireportGetResponse.reportId
            reportTime = emireportGetResponse.reportTime
            reportType = emireportGetResponse.reportType
            requestAssist = emireportGetResponse.requestAssist
            source = emireportGetResponse.source
            startTime = emireportGetResponse.startTime
            id = emireportGetResponse.id
            actionsTaken = emireportGetResponse.actionsTaken
            affActivity = emireportGetResponse.affActivity
            alt = emireportGetResponse.alt
            aor = emireportGetResponse.aor
            band = emireportGetResponse.band
            beamPattern = emireportGetResponse.beamPattern
            channel = emireportGetResponse.channel
            chanPirate = emireportGetResponse.chanPirate
            createdAt = emireportGetResponse.createdAt
            createdBy = emireportGetResponse.createdBy
            description = emireportGetResponse.description
            dneImpact = emireportGetResponse.dneImpact
            emiType = emireportGetResponse.emiType
            endTime = emireportGetResponse.endTime
            frequency = emireportGetResponse.frequency
            geoLocErrEllp = emireportGetResponse.geoLocErrEllp.map { it.toMutableList() }
            gpsEncrypted = emireportGetResponse.gpsEncrypted
            gpsFreq = emireportGetResponse.gpsFreq
            highAffectedFrequency = emireportGetResponse.highAffectedFrequency
            idOnOrbit = emireportGetResponse.idOnOrbit
            intercept = emireportGetResponse.intercept
            interceptLang = emireportGetResponse.interceptLang
            interceptType = emireportGetResponse.interceptType
            intSrcAmplitude = emireportGetResponse.intSrcAmplitude
            intSrcBandwidth = emireportGetResponse.intSrcBandwidth
            intSrcCentFreq = emireportGetResponse.intSrcCentFreq
            intSrcEncrypted = emireportGetResponse.intSrcEncrypted
            intSrcModulation = emireportGetResponse.intSrcModulation
            isrCollectionImpact = emireportGetResponse.isrCollectionImpact
            killBox = emireportGetResponse.killBox
            lat = emireportGetResponse.lat
            link = emireportGetResponse.link
            lon = emireportGetResponse.lon
            milGrid = emireportGetResponse.milGrid
            onOrbit = emireportGetResponse.onOrbit
            origin = emireportGetResponse.origin
            origNetwork = emireportGetResponse.origNetwork
            origObjectId = emireportGetResponse.origObjectId
            persistence = emireportGetResponse.persistence
            platform = emireportGetResponse.platform
            rcvrDemod = emireportGetResponse.rcvrDemod
            rcvrGain = emireportGetResponse.rcvrGain
            rcvrLocation = emireportGetResponse.rcvrLocation
            rcvrType = emireportGetResponse.rcvrType
            respService = emireportGetResponse.respService
            satcomPriority = emireportGetResponse.satcomPriority
            satDownlinkFrequency = emireportGetResponse.satDownlinkFrequency
            satDownlinkPolarization = emireportGetResponse.satDownlinkPolarization
            satName = emireportGetResponse.satName
            satNo = emireportGetResponse.satNo
            satTransponderId = emireportGetResponse.satTransponderId
            satUplinkFrequency = emireportGetResponse.satUplinkFrequency
            satUplinkPolarization = emireportGetResponse.satUplinkPolarization
            sourceDl = emireportGetResponse.sourceDl
            status = emireportGetResponse.status
            supportedIsrRole = emireportGetResponse.supportedIsrRole
            system = emireportGetResponse.system
            tags = emireportGetResponse.tags.map { it.toMutableList() }
            transactionId = emireportGetResponse.transactionId
            victimAltCountry = emireportGetResponse.victimAltCountry
            victimCountryCode = emireportGetResponse.victimCountryCode
            victimFuncImpacts = emireportGetResponse.victimFuncImpacts
            victimPocMail = emireportGetResponse.victimPocMail
            victimPocName = emireportGetResponse.victimPocName
            victimPocPhone = emireportGetResponse.victimPocPhone
            victimPocUnit = emireportGetResponse.victimPocUnit
            victimReaction = emireportGetResponse.victimReaction
            additionalProperties = emireportGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmireportGetResponse].
         *
         ...
         */
        fun build(): EmireportGetResponse =
    ...
    fun validate(): EmireportGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportGetResponse &&
