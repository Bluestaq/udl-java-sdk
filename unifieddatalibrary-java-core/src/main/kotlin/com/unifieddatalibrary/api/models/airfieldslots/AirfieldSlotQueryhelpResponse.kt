...
class AirfieldSlotQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AirfieldSlotQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirfieldSlotQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotQueryhelpResponse: AirfieldSlotQueryhelpResponse) =
            apply {
                aodrSupported = airfieldSlotQueryhelpResponse.aodrSupported
                classificationMarking = airfieldSlotQueryhelpResponse.classificationMarking
                description = airfieldSlotQueryhelpResponse.description
                historySupported = airfieldSlotQueryhelpResponse.historySupported
                name = airfieldSlotQueryhelpResponse.name
                parameters = airfieldSlotQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = airfieldSlotQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = airfieldSlotQueryhelpResponse.restSupported
                sortSupported = airfieldSlotQueryhelpResponse.sortSupported
                typeName = airfieldSlotQueryhelpResponse.typeName
                uri = airfieldSlotQueryhelpResponse.uri
                additionalProperties = airfieldSlotQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldSlotQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldSlotQueryhelpResponse =
    ...
    fun validate(): AirfieldSlotQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
