...
class AirfieldSlotQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotQueryhelpResponse: AirfieldSlotQueryhelpResponse) = apply {
    ...
    fun validate(): AirfieldSlotQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
