...
/**
 * Service operation intended for initial integration only, to take a list of RF geolocations as a
 ...
 */
class EmitterGeolocationCreateBulkParams
private constructor(
    ...
    /** A builder for [EmitterGeolocationCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationCreateBulkParams: EmitterGeolocationCreateBulkParams) =
            apply {
                body = emitterGeolocationCreateBulkParams.body.toMutableList()
                additionalHeaders = emitterGeolocationCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    emitterGeolocationCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationCreateBulkParams].
         *
         ...
         */
        fun build(): EmitterGeolocationCreateBulkParams =
            EmitterGeolocationCreateBulkParams(
    ...
    private constructor(
         ...
         *   value).
         */
        fun signalOfInterestType(): String =
            signalOfInterestType.getRequired("signalOfInterestType")
         ...
         *
         * Unlike [signalOfInterestType], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("signalOfInterestType")
        @ExcludeMissing
         ...
         *
         * Unlike [origRfEmitterId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("origRFEmitterId")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.signalOfInterestType] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.algVersion] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.confArea] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * supported value.
             */
            fun createdTs(createdTs: JsonField<OffsetDateTime>) = apply {
            ...
            /**
             * WGS-84 latitude of the most likely emitter location coordinate point, in degrees. -90
            ...
            /**
             * WGS-84 longitude of the most likely emitter location coordinate point, in degrees.
            ...
            /**
             * Unique identifier of the satellite used to identify and geolocate Emitter signals of
             * interest. This ID can be used to obtain additional information on an OnOrbit object
             * using the 'get by ID' operation (e.g. /udl/onorbit/{id}). For example, the onorbit
             * object with idOnOrbit = abc would be queried as /udl/onorbit/abc. Used when Emitter
             ...
             * observation. This ID can be used to obtain additional information on an RF Emitter
             * object using the 'get by ID' operation (e.g. /udl/rfemitter/{id}). For example, the
             * rfemitter object with idRFEmitter = abc would be queried as /udl/rfemitter/abc.
             */
             ...
             * Unique identifier of the reporting sensor. This ID can be used to obtain additional
             * information on a sensor using the 'get by ID' operation (e.g. /udl/sensor/{id}). For
             * example, the sensor with idSensor = abc would be queried as /udl/sensor/abc. Used
             * when Emitter geolocation is done by a single sensor.
             */
             ...
             *
             * You should usually call [Builder.minFreq] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.numBursts] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Optional identifier of the satellite used to identify and geolocate Emitter signals
             * of interest of this observation. This may be an internal identifier and not
             * necessarily a valid satellite number. Used when Emitter geolocation is done by a
             * single satellite.
             */
             ...
             * Optional identifier provided by observation source to indicate the sensor identifier
             * which produced this Emitter Geo Location. This may be an internal identifier and not
             * necessarily a valid sensor ID. Used when Emitter geolocation is done by a single
             * sensor.
             */
             ...
             *
             * You should usually call [Builder.passGroupId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * 8601 UTC with microsecond precision.
             */
            ...
            /**
             * Satellite/catalog number of the on-orbit spacecraft used to identify and geolocate
             * Emitter signals of interest of this detection. Used when Emitter geolocation is done
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EmitterGeolocationCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "EmitterGeolocationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
