...
class ScientificListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificListPage: ScientificListPage) =
            apply {
        ...
        fun service(service: ScientificService) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: ScientificListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<ScientificListResponse>) =
            apply {
                this.items = items
            }
