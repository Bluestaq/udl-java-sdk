 ...
 */
class NavigationalObstructionGetResponse
private constructor(
    ...
    /** A builder for [NavigationalObstructionGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationalObstructionGetResponse: NavigationalObstructionGetResponse) =
            apply {
                classificationMarking = navigationalObstructionGetResponse.classificationMarking
                cycleDate = navigationalObstructionGetResponse.cycleDate
                dataMode = navigationalObstructionGetResponse.dataMode
                obstacleId = navigationalObstructionGetResponse.obstacleId
                obstacleType = navigationalObstructionGetResponse.obstacleType
                source = navigationalObstructionGetResponse.source
                id = navigationalObstructionGetResponse.id
                actDelCode = navigationalObstructionGetResponse.actDelCode
                airacCycle = navigationalObstructionGetResponse.airacCycle
                baseAiracCycle = navigationalObstructionGetResponse.baseAiracCycle
                baselineCutoffDate = navigationalObstructionGetResponse.baselineCutoffDate
                boundNeLat = navigationalObstructionGetResponse.boundNeLat
                boundNeLon = navigationalObstructionGetResponse.boundNeLon
                boundSwLat = navigationalObstructionGetResponse.boundSwLat
                boundSwLon = navigationalObstructionGetResponse.boundSwLon
                countryCode = navigationalObstructionGetResponse.countryCode
                createdAt = navigationalObstructionGetResponse.createdAt
                createdBy = navigationalObstructionGetResponse.createdBy
                cutoffDate = navigationalObstructionGetResponse.cutoffDate
                dataSetRemarks = navigationalObstructionGetResponse.dataSetRemarks
                deletingOrg = navigationalObstructionGetResponse.deletingOrg
                derivingOrg = navigationalObstructionGetResponse.derivingOrg
                directivityCode = navigationalObstructionGetResponse.directivityCode
                elevation = navigationalObstructionGetResponse.elevation
                elevationAcc = navigationalObstructionGetResponse.elevationAcc
                externalId = navigationalObstructionGetResponse.externalId
                facc = navigationalObstructionGetResponse.facc
                featureCode = navigationalObstructionGetResponse.featureCode
                featureDescription = navigationalObstructionGetResponse.featureDescription
                featureName = navigationalObstructionGetResponse.featureName
                featureType = navigationalObstructionGetResponse.featureType
                heightAgl = navigationalObstructionGetResponse.heightAgl
                heightAglAcc = navigationalObstructionGetResponse.heightAglAcc
                heightMsl = navigationalObstructionGetResponse.heightMsl
                heightMslAcc = navigationalObstructionGetResponse.heightMslAcc
                horizAcc = navigationalObstructionGetResponse.horizAcc
                horizDatumCode = navigationalObstructionGetResponse.horizDatumCode
                initRecordDate = navigationalObstructionGetResponse.initRecordDate
                keys = navigationalObstructionGetResponse.keys.map { it.toMutableList() }
                lightingCode = navigationalObstructionGetResponse.lightingCode
                lineNeLat = navigationalObstructionGetResponse.lineNeLat
                lineNeLon = navigationalObstructionGetResponse.lineNeLon
                linesFilename = navigationalObstructionGetResponse.linesFilename
                lineSwLat = navigationalObstructionGetResponse.lineSwLat
                lineSwLon = navigationalObstructionGetResponse.lineSwLon
                minHeightAgl = navigationalObstructionGetResponse.minHeightAgl
                multObs = navigationalObstructionGetResponse.multObs
                nextCycleDate = navigationalObstructionGetResponse.nextCycleDate
                numLines = navigationalObstructionGetResponse.numLines
                numObs = navigationalObstructionGetResponse.numObs
                numPoints = navigationalObstructionGetResponse.numPoints
                obstacleRemarks = navigationalObstructionGetResponse.obstacleRemarks
                origId = navigationalObstructionGetResponse.origId
                origin = navigationalObstructionGetResponse.origin
                origNetwork = navigationalObstructionGetResponse.origNetwork
                ownerCountryCode = navigationalObstructionGetResponse.ownerCountryCode
                pointLat = navigationalObstructionGetResponse.pointLat
                pointLon = navigationalObstructionGetResponse.pointLon
                pointsFilename = navigationalObstructionGetResponse.pointsFilename
                processCode = navigationalObstructionGetResponse.processCode
                producer = navigationalObstructionGetResponse.producer
                provinceCode = navigationalObstructionGetResponse.provinceCode
                quality = navigationalObstructionGetResponse.quality
                rawFileUri = navigationalObstructionGetResponse.rawFileUri
                revDate = navigationalObstructionGetResponse.revDate
                segEndPoint = navigationalObstructionGetResponse.segEndPoint
                segNum = navigationalObstructionGetResponse.segNum
                segStartPoint = navigationalObstructionGetResponse.segStartPoint
                sourceDate = navigationalObstructionGetResponse.sourceDate
                sourceDl = navigationalObstructionGetResponse.sourceDl
                surfaceMatCode = navigationalObstructionGetResponse.surfaceMatCode
                transactionCode = navigationalObstructionGetResponse.transactionCode
                updatedAt = navigationalObstructionGetResponse.updatedAt
                updatedBy = navigationalObstructionGetResponse.updatedBy
                validationCode = navigationalObstructionGetResponse.validationCode
                values = navigationalObstructionGetResponse.values.map { it.toMutableList() }
                vectorsFilename = navigationalObstructionGetResponse.vectorsFilename
                wac = navigationalObstructionGetResponse.wac
                wacInnr = navigationalObstructionGetResponse.wacInnr
                additionalProperties =
                    navigationalObstructionGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [NavigationalObstructionGetResponse].
         *
         ...
         */
        fun build(): NavigationalObstructionGetResponse =
            NavigationalObstructionGetResponse(
    ...
    fun validate(): NavigationalObstructionGetResponse = apply {
        if (validated) {
            return@apply
        }
