...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitThrusterFull].
         *
    ...
    /** A builder for [OnorbitThrusterFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitThrusterFull: OnorbitThrusterFull) = apply {
            classificationMarking = onorbitThrusterFull.classificationMarking
            dataMode = onorbitThrusterFull.dataMode
            idEngine = onorbitThrusterFull.idEngine
            idOnOrbit = onorbitThrusterFull.idOnOrbit
            source = onorbitThrusterFull.source
            id = onorbitThrusterFull.id
            createdAt = onorbitThrusterFull.createdAt
            createdBy = onorbitThrusterFull.createdBy
            engine = onorbitThrusterFull.engine
            origin = onorbitThrusterFull.origin
            origNetwork = onorbitThrusterFull.origNetwork
            quantity = onorbitThrusterFull.quantity
            type = onorbitThrusterFull.type
            updatedAt = onorbitThrusterFull.updatedAt
            updatedBy = onorbitThrusterFull.updatedBy
            additionalProperties = onorbitThrusterFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitThrusterFull].
         *
    ...
    fun validate(): OnorbitThrusterFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OnorbitThrusterFull && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idEngine == other.idEngine && idOnOrbit == other.idOnOrbit && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && engine == other.engine && origin == other.origin && origNetwork == other.origNetwork && quantity == other.quantity && type == other.type && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idEngine, idOnOrbit, source, id, createdAt, createdBy, engine, origin, origNetwork, quantity, type, updatedAt, updatedBy, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "OnorbitThrusterFull{classificationMarking=$classificationMarking, dataMode=$dataMode, idEngine=$idEngine, idOnOrbit=$idOnOrbit, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, engine=$engine, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
