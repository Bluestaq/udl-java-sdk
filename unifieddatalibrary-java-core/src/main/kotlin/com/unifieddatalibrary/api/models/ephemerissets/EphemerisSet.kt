...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        ephemerisList: JsonField<List<EphemerisFull>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        stateVector: JsonField<StateVectorFull> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSet: EphemerisSet) = apply {
         ...
         * associated with a parent Ephemeris Set via the EphemerisSet ID (esId).
         */
        fun ephemerisList(ephemerisList: List<EphemerisFull>) =
            ephemerisList(JsonField.of(ephemerisList))

        /**
         * Sets [Builder.ephemerisList] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ephemerisList] with a well-typed `List<EphemerisFull>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun ephemerisList(ephemerisList: JsonField<List<EphemerisFull>>) = apply {
         ...
         */
        fun addEphemerisList(ephemerisList: EphemerisFull) = apply {
            this.ephemerisList =
         ...
         *
         * You should usually call [Builder.stateVector] with a well-typed [StateVectorFull] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stateVector(stateVector: JsonField<StateVectorFull>) = apply {
    ...
    fun validate(): EphemerisSet = apply {
        if (validated) {
            return@apply
        }
