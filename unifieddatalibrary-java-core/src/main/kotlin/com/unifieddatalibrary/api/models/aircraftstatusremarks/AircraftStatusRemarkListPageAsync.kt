...
class AircraftStatusRemarkListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<AircraftStatusRemarkListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftStatusRemarkListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        fun service(service: AircraftStatusRemarkServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: AircraftStatusRemarkListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<AircraftstatusremarkAbridged>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "AircraftStatusRemarkListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
