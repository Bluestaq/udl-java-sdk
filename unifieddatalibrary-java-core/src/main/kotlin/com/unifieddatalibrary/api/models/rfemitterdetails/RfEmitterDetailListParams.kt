 ...
 */
class RfEmitterDetailListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfEmitterDetailListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailListParams: RfEmitterDetailListParams) = apply {
    ...
    override fun toString() =
        "RfEmitterDetailListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
