...
/**
 * Information on the mission and flight plans, the type and configuration of the platform, and the
 * reference time.
 */
class MtiListResponse
private constructor(
     ...
     */
    @JsonProperty("missions") @ExcludeMissing fun _missions(): JsonField<List<Mission>> = missions
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mtiListResponse: MtiListResponse) = apply {
         ...
         *
         * You should usually call [Builder.dwells] with a well-typed `List<Dwell>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.hrrs] with a well-typed `List<Hrr>` value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun hrrs(hrrs: JsonField<List<Hrr>>) = apply { this.hrrs = hrrs.map { it.toMutableList() } }
        ...
        fun addHrr(hrr: Hrr) = apply {
            hrrs = (hrrs ?: JsonField.of(mutableListOf())).also { checkKnown("hrrs", it).add(hrr) }
        }
         ...
         *
         * You should usually call [Builder.jobDefs] with a well-typed `List<JobDef>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.jobRequests] with a well-typed `List<JobRequest>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.p10] with a well-typed [Int] value instead. This method
         ...
         *
         * You should usually call [Builder.p9] with a well-typed [Int] value instead. This method
         * is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    fun validate(): MtiListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        /**
         * Factor which modifies the value of the reported target latitude (Delta Latitude, field
         * D32.4).
         *
        ...
        /**
         * Factor which modifies the value of the reported target longitude (Delta Longitude, field
         * D32.5).
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Standard deviation in the estimated horizontal sensor location at the time of the dwell,
         * measured along the sensor track direction (field D15), in centimeters.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * Standard deviation in the estimated horizontal sensor location at the time of the dwell,
         * measured orthogonal to the sensor track direction (field D15), in centimeters.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * Ground track of the sensor at the time of the dwell, as the angle in degrees (clockwise)
         * from True North.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Standard deviation of estimate of the sensor vertical velocity, expressed in centimeters
         * per second.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Distance on the earth surface, expressed in kilometers, from the near edge to the center
         * of the dwell area.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * For dwell based radars, one-half of the 3-dB beamwidth. For non-dwell based radars, the
         * angle between the beginning of the dwell to the center of the dwell. Measured in degrees.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * Rotation of the sensor broadside face about the local vertical axis of the platform, in
         * degrees.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Temporally sequential count of a dwell within the revisit of a particular bounding area
         * for a given job ID.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Minimum velocity component, along the line of sight, which can be detected by the sensor,
        ...
        /**
         * Count of the total number of targets reported during this dwell and sent in this Dwell
         * Segment.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * The East-West position of the sensor at the temporal center of the dwell, in degrees East
         * (positive, 0 to 180) or West (negative, 0 to -180) of the Prime Meridian.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * The altitude of the sensor at temporal center of the dwell, above the WGS 84 ellipsoid,
         ...
         */
        @JsonProperty("dwellts") @ExcludeMissing fun _dwellts(): JsonField<OffsetDateTime> = dwellts
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.d10] with a well-typed [Double] value instead. This
             ...
             *
             * You should usually call [Builder.d11] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d15] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d17] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d18] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d21] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d22] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d23] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d24] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d25] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d26] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d27] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d28] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d29] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d30] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d31] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d32] with a well-typed `List<D32>` value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d32(d32: JsonField<List<D32>>) = apply { this.d32 = d32.map { it.toMutableList() } }
             ...
             *
             * You should usually call [Builder.d4] with a well-typed [Boolean] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d7] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.d8] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.dwellts] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        /**
         * A grouping of zero or more target reports for which the sensor provides a single time,
         * sensor position, reference position on the ground with simple estimates for the observed
         * area at the reported time, and other pertinent data.
         */
        class D32
        private constructor(
            ...
            /**
             * Standard deviation of the measured line-of-sight velocity component, in centimeters
             * per second.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
            ...
            /**
             * The Truth Tag - Entity is the Entity Field from the Entity State PDU used to generate
             * the MTI Target.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
            ...
            /**
             * The component of velocity for the reported detection, expressed in centimeters per
             * second, corrected for platform motion, along the line of sight between the sensor and
             * the reported detection, where the positive direction is away from the sensor.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             * line-of-sight components large enough to exceed the first velocity period. Expressed
             * in centimeters/sec.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.d32_1] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_11] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_12] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_13] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_14] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_15] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_16] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_17] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_18] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_2] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_3] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_4] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_5] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_6] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_7] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_8] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.d32_9] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.f1] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.f2] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.f3] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
    ...
    private constructor(
        ...
        /**
         * Enumeration table indicating the spectral weighting used in the cross-range or Doppler
         * compression process.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * When the RDM does not correlate to a single MTI report index or when the center range bin
         * does not correlate to the center of the dwell; provide the range sample offset in meters
         * from Dwell Center (positive is away from the sensor) of the first scatterer record.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * When the RDM does not correlate to a single MTI report index or the center doppler bin
         * does not correlate to the doppler centroid of the dwell; Doppler sample value in Hz of
        ...
        /**
         * Sequential count of a dwell within the revisit of a particular bounding area for a given
         * job ID.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Number of Range Doppler pixels that exceed target scatterer threshold and are reported in
         * this segment.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * The Peak Scatter returns the maximum power level (e.g. in milliwatts, or dBm) registered
         * by the sensor.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.h10] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h11] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h12] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h13] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h14] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h15] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h16] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h17] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h18] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h19] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h20] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h21] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h22] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h23] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h24] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h27] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h28] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h29] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h30] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h31] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.h32] with a well-typed `List<H32>` value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h32(h32: JsonField<List<H32>>) = apply { this.h32 = h32.map { it.toMutableList() } }
             ...
             *
             * You should usually call [Builder.h4] with a well-typed [Boolean] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.h32_1] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.h32_2] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.h32_3] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.h32_4] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
     ...
     * performed and details of the location parameters (terrain elevation model and geoid model)
    ...
    private constructor(
        ...
        /**
         * North-South position of the third corner (Point C) defining the area for sensor service,
        ...
        /**
         * East-West position of the third corner (Point C) defining the area for sensor service,
         * expressed as degrees East (positive, 0 to 180) or West (negative, 0 to -180) of the Prime
         * Meridian.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * North-South position of the fourth corner (Point D) defining the area for sensor service,
         * expressed as degrees North (positive) or South (negative) of the Equator.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * East-West position of the fourth corner (Point D) defining the area for sensor service,
         * expressed as degrees East (positive, 0 to 180) or West (negative, 0 to -180) of the Prime
         * Meridian.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
        ...
        /**
         * Nominal estimate of the standard deviation in the estimated horizontal sensor location,
         * measured orthogonal to the track direction, expressed in decimeters.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * Nominal estimate of the standard deviation of the measured sensor altitude, expressed in
         * decimeters.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Nominal standard deviation of the estimate of sensor speed, expressed in millimeters per
         * second.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         * sensor, expressed in decimeters per second.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * Nominal probability that an unobscured ten square-meter target will be detected within
         * the given area of surveillance.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * Flag field indicating whether filtering has been applied to the targets detected within
         * the dwell area.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Priority of this tasking request relative to all other active tasking requests scheduled
        ...
        /**
         * North-South position of the first corner (Point A) defining the area for sensor service,
         * expressed as degrees North (positive) or South (negative) of the Equator.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * East-West position of the first corner (Point A) defining the area for sensor service,
         * expressed as degrees East (positive, 0 to 180) or West (negative, 0 to -180) of the Prime
         * Meridian.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
        ...
        /**
         * North-South position of the second corner (Point B) defining the area for sensor service,
         * expressed as degrees North (positive) or South (negative) of the Equator.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * East-West position of the second corner (Point B) defining the area for sensor service,
         * expressed as degrees East (positive, 0 to 180) or West (negative, 0 to -180) of the Prime
         * Meridian.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.j10] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j11] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j12] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j13] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j14] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j19] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j2] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j22] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j24] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j25] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j26] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j27] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j28] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j3] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j6] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j7] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j8] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.j9] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
        ...
        override fun toString() =
            "JobDef{j10=$j10, j11=$j11, j12=$j12, j13=$j13, j14=$j14, j15=$j15, j16=$j16, j17=$j17, j18=$j18, j19=$j19, j2=$j2, j20=$j20, j21=$j21, j22=$j22, j23=$j23, j24=$j24, j25=$j25, j26=$j26, j27=$j27, j28=$j28, j3=$j3, j4=$j4, j5=$j5, j6=$j6, j7=$j7, j8=$j8, j9=$j9, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        /**
         * Specifies the Earliest Start Time for which the service is requested. Composite of fields
         * R15-R20.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         * service, expressed as degrees East (positive, 0 to 180) or West (negative, 0 to -180) of
         * the Prime Meridian.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Specifies the maximum time from the requested start time after which the request is to be
        ...
        /**
         * Specifies the time duration for the radar job, measured from the actual start of the job,
        ...
        /**
         * East-West position of the first corner (Point A) defining the requested area for service,
         * expressed as degrees East (positive, 0 to 180) or West (negative, 0 to -180) of the Prime
         * Meridian.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
        ...
        /**
         * East-West position of the third corner (Point C) defining the requested area for service,
         * expressed as degrees East (positive, 0 to 180) or West (negative, 0 to -180) of the Prime
         * Meridian.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.jobReqEst] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.r1] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r10] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r11] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r12] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r2] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r24] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r25] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r26] with a well-typed [Boolean] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r4] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r5] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r6] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r7] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r8] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.r9] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
    ...
    private constructor(
         ...
         */
        @JsonProperty("msnRefTs") @ExcludeMissing fun _msnRefTs(): JsonField<LocalDate> = msnRefTs
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.m3] with a well-typed [String] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
    ...
    private constructor(
        ...
        /**
         * Altitude of the platform at the time the report is prepared, referenced to its position
         * above the WGS-84 ellipsoid, in centimeters.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
        ...
        /**
         * Ground track of the platform at the time the report is prepared, expressed as the angle
        ...
        /**
         * Ground speed of the platform at the time the report is prepared, expressed as millimeters
         * per second.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.l2] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.l3] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.l5] with a well-typed [Double] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
             ...
             *
             * You should usually call [Builder.platlocts] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
