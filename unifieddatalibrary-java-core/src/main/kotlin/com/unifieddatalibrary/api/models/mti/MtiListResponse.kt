...
class MtiListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("dwells") @ExcludeMissing dwells: JsonField<List<Dwell>> = JsonMissing.of(),
        @JsonProperty("freeTexts") @ExcludeMissing freeTexts: JsonField<List<FreeText>> = JsonMissing.of(),
        @JsonProperty("hrrs") @ExcludeMissing hrrs: JsonField<List<Hrr>> = JsonMissing.of(),
        @JsonProperty("jobDefs") @ExcludeMissing jobDefs: JsonField<List<JobDef>> = JsonMissing.of(),
        @JsonProperty("jobRequests") @ExcludeMissing jobRequests: JsonField<List<JobRequest>> = JsonMissing.of(),
        @JsonProperty("missions") @ExcludeMissing missions: JsonField<List<Mission>> = JsonMissing.of(),
        ...
        @JsonProperty("platformLocs") @ExcludeMissing platformLocs: JsonField<List<PlatformLoc>> = JsonMissing.of()
    ) : this(
    ...
    @JsonProperty("dwells")
    @ExcludeMissing
    fun _dwells(): JsonField<List<Dwell>> = dwells
    ...
    @JsonProperty("hrrs")
    @ExcludeMissing
    fun _hrrs(): JsonField<List<Hrr>> = hrrs
    ...
    @ExcludeMissing
    fun _jobDefs(): JsonField<List<JobDef>> = jobDefs
    ...
    @JsonProperty("p9")
    @ExcludeMissing
    fun _p9(): JsonField<Int> = p9

    /**
     * Returns the raw JSON value of [platformLocs].
     *
     * Unlike [platformLocs], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MtiListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mtiListResponse: MtiListResponse) =
            apply {
                classificationMarking = mtiListResponse.classificationMarking
                dataMode = mtiListResponse.dataMode
                source = mtiListResponse.source
                id = mtiListResponse.id
                createdAt = mtiListResponse.createdAt
                createdBy = mtiListResponse.createdBy
                dwells = mtiListResponse.dwells.map { it.toMutableList() }
                freeTexts = mtiListResponse.freeTexts.map { it.toMutableList() }
                hrrs = mtiListResponse.hrrs.map { it.toMutableList() }
                jobDefs = mtiListResponse.jobDefs.map { it.toMutableList() }
                jobRequests = mtiListResponse.jobRequests.map { it.toMutableList() }
                missions = mtiListResponse.missions.map { it.toMutableList() }
                origin = mtiListResponse.origin
                origNetwork = mtiListResponse.origNetwork
                p10 = mtiListResponse.p10
                p3 = mtiListResponse.p3
                p6 = mtiListResponse.p6
                p7 = mtiListResponse.p7
                p8 = mtiListResponse.p8
                p9 = mtiListResponse.p9
                platformLocs = mtiListResponse.platformLocs.map { it.toMutableList() }
                additionalProperties = mtiListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.dwells] with a well-typed `List<Dwell>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dwells(dwells: JsonField<List<Dwell>>) =
            apply {
         ...
         */
        fun addDwell(dwell: Dwell) =
            apply {
                dwells = (dwells ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.freeTexts] with a well-typed `List<FreeText>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun freeTexts(freeTexts: JsonField<List<FreeText>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFreeText(freeText: FreeText) =
            apply {
                freeTexts = (freeTexts ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.hrrs] with a well-typed `List<Hrr>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hrrs(hrrs: JsonField<List<Hrr>>) =
            apply {
        ...
        fun addHrr(hrr: Hrr) =
            apply {
                hrrs = (hrrs ?: JsonField.of(mutableListOf())).also {
                    checkKnown("hrrs", it).add(hrr)
                }
            }
         ...
         *
         * You should usually call [Builder.jobDefs] with a well-typed `List<JobDef>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun jobDefs(jobDefs: JsonField<List<JobDef>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addJobDef(jobDef: JobDef) =
            apply {
                jobDefs = (jobDefs ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.jobRequests] with a well-typed `List<JobRequest>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun jobRequests(jobRequests: JsonField<List<JobRequest>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addJobRequest(jobRequest: JobRequest) =
            apply {
                jobRequests = (jobRequests ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.missions] with a well-typed `List<Mission>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun missions(missions: JsonField<List<Mission>>) =
            apply {
        ...
        fun addMission(mission: Mission) =
            apply {
                missions = (missions ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.p10] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun p10(p10: JsonField<Int>) =
            apply {
                this.p10 = p10
            }
         ...
         *
         * You should usually call [Builder.p3] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun p3(p3: JsonField<String>) =
            apply {
                this.p3 = p3
            }
         ...
         *
         * You should usually call [Builder.p6] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun p6(p6: JsonField<String>) =
            apply {
                this.p6 = p6
            }
         ...
         *
         * You should usually call [Builder.p7] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun p7(p7: JsonField<String>) =
            apply {
                this.p7 = p7
            }
         ...
         *
         * You should usually call [Builder.p8] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun p8(p8: JsonField<String>) =
            apply {
                this.p8 = p8
            }
         ...
         *
         * You should usually call [Builder.p9] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun p9(p9: JsonField<Int>) =
            apply {
                this.p9 = p9
            }

        /** A platform-assigned number identifying the specific request or task that pertains to all Dwell, HRR, and Range-Doppler segments in the packet. Job ID is unique within a mission. */
        fun platformLocs(platformLocs: List<PlatformLoc>) = platformLocs(JsonField.of(platformLocs))

        /**
         * Sets [Builder.platformLocs] to an arbitrary JSON value.
         *
         * You should usually call [Builder.platformLocs] with a well-typed `List<PlatformLoc>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun platformLocs(platformLocs: JsonField<List<PlatformLoc>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPlatformLoc(platformLoc: PlatformLoc) =
            apply {
                platformLocs = (platformLocs ?: JsonField.of(mutableListOf())).also {
        ...
        /**
         * Returns an immutable instance of [MtiListResponse].
         *
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (dwells.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (freeTexts.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (hrrs.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (jobDefs.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (jobRequests.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (missions.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (p10.asKnown().isPresent) 1 else 0) + (if (p3.asKnown().isPresent) 1 else 0) + (if (p6.asKnown().isPresent) 1 else 0) + (if (p7.asKnown().isPresent) 1 else 0) + (if (p8.asKnown().isPresent) 1 else 0) + (if (p9.asKnown().isPresent) 1 else 0) + (platformLocs.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    class Dwell private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("dwellts") @ExcludeMissing dwellts: JsonField<OffsetDateTime> = JsonMissing.of()
        ) : this(
          d10,
          d11,
          d12,
        ...
        @JsonProperty("d32")
        @ExcludeMissing
        fun _d32(): JsonField<List<D32>> = d32
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.d10] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d10(d10: JsonField<Double>) =
                apply {
                    this.d10 = d10
                }
             ...
             *
             * You should usually call [Builder.d11] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d11(d11: JsonField<Double>) =
                apply {
                    this.d11 = d11
                }
             ...
             *
             * You should usually call [Builder.d12] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d12(d12: JsonField<Int>) =
                apply {
                    this.d12 = d12
                }
             ...
             *
             * You should usually call [Builder.d13] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d13(d13: JsonField<Int>) =
                apply {
                    this.d13 = d13
                }
             ...
             *
             * You should usually call [Builder.d14] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d14(d14: JsonField<Int>) =
                apply {
                    this.d14 = d14
                }
             ...
             *
             * You should usually call [Builder.d15] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d15(d15: JsonField<Double>) =
                apply {
                    this.d15 = d15
                }
             ...
             *
             * You should usually call [Builder.d16] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d16(d16: JsonField<Int>) =
                apply {
                    this.d16 = d16
                }
             ...
             *
             * You should usually call [Builder.d17] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d17(d17: JsonField<Long>) =
                apply {
                    this.d17 = d17
                }
             ...
             *
             * You should usually call [Builder.d18] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d18(d18: JsonField<Long>) =
                apply {
                    this.d18 = d18
                }
             ...
             *
             * You should usually call [Builder.d19] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d19(d19: JsonField<Int>) =
                apply {
                    this.d19 = d19
                }
             ...
             *
             * You should usually call [Builder.d2] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d2(d2: JsonField<Int>) =
                apply {
                    this.d2 = d2
                }
             ...
             *
             * You should usually call [Builder.d20] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d20(d20: JsonField<Int>) =
                apply {
                    this.d20 = d20
                }
             ...
             *
             * You should usually call [Builder.d21] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d21(d21: JsonField<Double>) =
                apply {
                    this.d21 = d21
                }
             ...
             *
             * You should usually call [Builder.d22] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d22(d22: JsonField<Double>) =
                apply {
                    this.d22 = d22
                }
             ...
             *
             * You should usually call [Builder.d23] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d23(d23: JsonField<Double>) =
                apply {
                    this.d23 = d23
                }
             ...
             *
             * You should usually call [Builder.d24] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d24(d24: JsonField<Double>) =
                apply {
                    this.d24 = d24
                }
             ...
             *
             * You should usually call [Builder.d25] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d25(d25: JsonField<Double>) =
                apply {
                    this.d25 = d25
                }
             ...
             *
             * You should usually call [Builder.d26] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d26(d26: JsonField<Double>) =
                apply {
                    this.d26 = d26
                }
             ...
             *
             * You should usually call [Builder.d27] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d27(d27: JsonField<Double>) =
                apply {
                    this.d27 = d27
                }
             ...
             *
             * You should usually call [Builder.d28] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d28(d28: JsonField<Double>) =
                apply {
                    this.d28 = d28
                }
             ...
             *
             * You should usually call [Builder.d29] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d29(d29: JsonField<Double>) =
                apply {
                    this.d29 = d29
                }
             ...
             *
             * You should usually call [Builder.d3] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d3(d3: JsonField<Int>) =
                apply {
                    this.d3 = d3
                }
             ...
             *
             * You should usually call [Builder.d30] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d30(d30: JsonField<Double>) =
                apply {
                    this.d30 = d30
                }
             ...
             *
             * You should usually call [Builder.d31] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d31(d31: JsonField<Long>) =
                apply {
                    this.d31 = d31
                }
             ...
             *
             * You should usually call [Builder.d32] with a well-typed `List<D32>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d32(d32: JsonField<List<D32>>) =
                apply {
            ...
            fun addD32(d32: D32) =
                apply {
                    this.d32 = (this.d32 ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.d4] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d4(d4: JsonField<Boolean>) =
                apply {
                    this.d4 = d4
                }
             ...
             *
             * You should usually call [Builder.d5] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d5(d5: JsonField<Int>) =
                apply {
                    this.d5 = d5
                }
             ...
             *
             * You should usually call [Builder.d6] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d6(d6: JsonField<Long>) =
                apply {
                    this.d6 = d6
                }
             ...
             *
             * You should usually call [Builder.d7] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d7(d7: JsonField<Double>) =
                apply {
                    this.d7 = d7
                }
             ...
             *
             * You should usually call [Builder.d8] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d8(d8: JsonField<Double>) =
                apply {
                    this.d8 = d8
                }
             ...
             *
             * You should usually call [Builder.d9] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d9(d9: JsonField<Int>) =
                apply {
                    this.d9 = d9
                }
             ...
             *
             * You should usually call [Builder.dwellts] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dwellts(dwellts: JsonField<OffsetDateTime>) =
                apply {
                    this.dwellts = dwellts
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (d10.asKnown().isPresent) 1 else 0) + (if (d11.asKnown().isPresent) 1 else 0) + (if (d12.asKnown().isPresent) 1 else 0) + (if (d13.asKnown().isPresent) 1 else 0) + (if (d14.asKnown().isPresent) 1 else 0) + (if (d15.asKnown().isPresent) 1 else 0) + (if (d16.asKnown().isPresent) 1 else 0) + (if (d17.asKnown().isPresent) 1 else 0) + (if (d18.asKnown().isPresent) 1 else 0) + (if (d19.asKnown().isPresent) 1 else 0) + (if (d2.asKnown().isPresent) 1 else 0) + (if (d20.asKnown().isPresent) 1 else 0) + (if (d21.asKnown().isPresent) 1 else 0) + (if (d22.asKnown().isPresent) 1 else 0) + (if (d23.asKnown().isPresent) 1 else 0) + (if (d24.asKnown().isPresent) 1 else 0) + (if (d25.asKnown().isPresent) 1 else 0) + (if (d26.asKnown().isPresent) 1 else 0) + (if (d27.asKnown().isPresent) 1 else 0) + (if (d28.asKnown().isPresent) 1 else 0) + (if (d29.asKnown().isPresent) 1 else 0) + (if (d3.asKnown().isPresent) 1 else 0) + (if (d30.asKnown().isPresent) 1 else 0) + (if (d31.asKnown().isPresent) 1 else 0) + (d32.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (d4.asKnown().isPresent) 1 else 0) + (if (d5.asKnown().isPresent) 1 else 0) + (if (d6.asKnown().isPresent) 1 else 0) + (if (d7.asKnown().isPresent) 1 else 0) + (if (d8.asKnown().isPresent) 1 else 0) + (if (d9.asKnown().isPresent) 1 else 0) + (if (dwellts.asKnown().isPresent) 1 else 0)
        ...
        class D32 private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("d32_10") @ExcludeMissing d32_10: JsonField<String> = JsonMissing.of(),
                @JsonProperty("d32_11") @ExcludeMissing d32_11: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_12") @ExcludeMissing d32_12: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("d32_13") @ExcludeMissing d32_13: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("d32_14") @ExcludeMissing d32_14: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_15") @ExcludeMissing d32_15: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_16") @ExcludeMissing d32_16: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_17") @ExcludeMissing d32_17: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_18") @ExcludeMissing d32_18: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_2") @ExcludeMissing d32_2: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("d32_3") @ExcludeMissing d32_3: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("d32_4") @ExcludeMissing d32_4: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_5") @ExcludeMissing d32_5: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_6") @ExcludeMissing d32_6: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("d32_7") @ExcludeMissing d32_7: JsonField<Long> = JsonMissing.of(),
             ...
             *
             * Unlike [d32_1], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_1")
            @ExcludeMissing
            fun _d32_1(): JsonField<Int> = d32_1

            /**
             * Returns the raw JSON value of [d32_10].
             *
             * Unlike [d32_10], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_10")
            @ExcludeMissing
            fun _d32_10(): JsonField<String> = d32_10

            /**
             * Returns the raw JSON value of [d32_11].
             *
             * Unlike [d32_11], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_11")
            @ExcludeMissing
            fun _d32_11(): JsonField<Long> = d32_11

            /**
             * Returns the raw JSON value of [d32_12].
             *
             * Unlike [d32_12], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_12")
            @ExcludeMissing
            fun _d32_12(): JsonField<Int> = d32_12

            /**
             * Returns the raw JSON value of [d32_13].
             *
             * Unlike [d32_13], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_13")
            @ExcludeMissing
            fun _d32_13(): JsonField<Int> = d32_13

            /**
             * Returns the raw JSON value of [d32_14].
             *
             * Unlike [d32_14], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_14")
            @ExcludeMissing
            fun _d32_14(): JsonField<Long> = d32_14

            /**
             * Returns the raw JSON value of [d32_15].
             *
             * Unlike [d32_15], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_15")
            @ExcludeMissing
            fun _d32_15(): JsonField<Long> = d32_15

            /**
             * Returns the raw JSON value of [d32_16].
             *
             * Unlike [d32_16], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_16")
            @ExcludeMissing
            fun _d32_16(): JsonField<Long> = d32_16

            /**
             * Returns the raw JSON value of [d32_17].
             *
             * Unlike [d32_17], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_17")
            @ExcludeMissing
            fun _d32_17(): JsonField<Long> = d32_17

            /**
             * Returns the raw JSON value of [d32_18].
             *
             * Unlike [d32_18], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_18")
            @ExcludeMissing
            fun _d32_18(): JsonField<Long> = d32_18

            /**
             * Returns the raw JSON value of [d32_2].
             *
             * Unlike [d32_2], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_2")
            @ExcludeMissing
            fun _d32_2(): JsonField<Double> = d32_2

            /**
             * Returns the raw JSON value of [d32_3].
             *
             * Unlike [d32_3], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_3")
            @ExcludeMissing
            fun _d32_3(): JsonField<Double> = d32_3

            /**
             * Returns the raw JSON value of [d32_4].
             *
             * Unlike [d32_4], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_4")
            @ExcludeMissing
            fun _d32_4(): JsonField<Long> = d32_4

            /**
             * Returns the raw JSON value of [d32_5].
             *
             * Unlike [d32_5], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_5")
            @ExcludeMissing
            fun _d32_5(): JsonField<Long> = d32_5

            /**
             * Returns the raw JSON value of [d32_6].
             *
             * Unlike [d32_6], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_6")
            @ExcludeMissing
            fun _d32_6(): JsonField<Long> = d32_6

            /**
             * Returns the raw JSON value of [d32_7].
             *
             * Unlike [d32_7], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_7")
            @ExcludeMissing
            fun _d32_7(): JsonField<Long> = d32_7

            /**
             * Returns the raw JSON value of [d32_8].
             *
             * Unlike [d32_8], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_8")
            @ExcludeMissing
            fun _d32_8(): JsonField<Int> = d32_8

            /**
             * Returns the raw JSON value of [d32_9].
             *
             * Unlike [d32_9], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("d32_9")
            @ExcludeMissing
            fun _d32_9(): JsonField<Long> = d32_9
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.d32_1] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_1(d32_1: JsonField<Int>) =
                    apply {
                        this.d32_1 = d32_1
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_10] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_10(d32_10: JsonField<String>) =
                    apply {
                        this.d32_10 = d32_10
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_11] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_11(d32_11: JsonField<Long>) =
                    apply {
                        this.d32_11 = d32_11
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_12] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_12(d32_12: JsonField<Int>) =
                    apply {
                        this.d32_12 = d32_12
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_13] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_13(d32_13: JsonField<Int>) =
                    apply {
                        this.d32_13 = d32_13
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_14] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_14(d32_14: JsonField<Long>) =
                    apply {
                        this.d32_14 = d32_14
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_15] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_15(d32_15: JsonField<Long>) =
                    apply {
                        this.d32_15 = d32_15
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_16] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_16(d32_16: JsonField<Long>) =
                    apply {
                        this.d32_16 = d32_16
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_17] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_17(d32_17: JsonField<Long>) =
                    apply {
                        this.d32_17 = d32_17
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_18] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_18(d32_18: JsonField<Long>) =
                    apply {
                        this.d32_18 = d32_18
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_2(d32_2: JsonField<Double>) =
                    apply {
                        this.d32_2 = d32_2
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_3] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_3(d32_3: JsonField<Double>) =
                    apply {
                        this.d32_3 = d32_3
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_4] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_4(d32_4: JsonField<Long>) =
                    apply {
                        this.d32_4 = d32_4
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_5] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_5(d32_5: JsonField<Long>) =
                    apply {
                        this.d32_5 = d32_5
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_6] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_6(d32_6: JsonField<Long>) =
                    apply {
                        this.d32_6 = d32_6
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_7] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_7(d32_7: JsonField<Long>) =
                    apply {
                        this.d32_7 = d32_7
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_8] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_8(d32_8: JsonField<Int>) =
                    apply {
                        this.d32_8 = d32_8
                    }
                 ...
                 *
                 * You should usually call [Builder.d32_9] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun d32_9(d32_9: JsonField<Long>) =
                    apply {
                        this.d32_9 = d32_9
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (d32_1.asKnown().isPresent) 1 else 0) + (if (d32_10.asKnown().isPresent) 1 else 0) + (if (d32_11.asKnown().isPresent) 1 else 0) + (if (d32_12.asKnown().isPresent) 1 else 0) + (if (d32_13.asKnown().isPresent) 1 else 0) + (if (d32_14.asKnown().isPresent) 1 else 0) + (if (d32_15.asKnown().isPresent) 1 else 0) + (if (d32_16.asKnown().isPresent) 1 else 0) + (if (d32_17.asKnown().isPresent) 1 else 0) + (if (d32_18.asKnown().isPresent) 1 else 0) + (if (d32_2.asKnown().isPresent) 1 else 0) + (if (d32_3.asKnown().isPresent) 1 else 0) + (if (d32_4.asKnown().isPresent) 1 else 0) + (if (d32_5.asKnown().isPresent) 1 else 0) + (if (d32_6.asKnown().isPresent) 1 else 0) + (if (d32_7.asKnown().isPresent) 1 else 0) + (if (d32_8.asKnown().isPresent) 1 else 0) + (if (d32_9.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() = "D32{d32_1=$d32_1, d32_10=$d32_10, d32_11=$d32_11, d32_12=$d32_12, d32_13=$d32_13, d32_14=$d32_14, d32_15=$d32_15, d32_16=$d32_16, d32_17=$d32_17, d32_18=$d32_18, d32_2=$d32_2, d32_3=$d32_3, d32_4=$d32_4, d32_5=$d32_5, d32_6=$d32_6, d32_7=$d32_7, d32_8=$d32_8, d32_9=$d32_9, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() = "Dwell{d10=$d10, d11=$d11, d12=$d12, d13=$d13, d14=$d14, d15=$d15, d16=$d16, d17=$d17, d18=$d18, d19=$d19, d2=$d2, d20=$d20, d21=$d21, d22=$d22, d23=$d23, d24=$d24, d25=$d25, d26=$d26, d27=$d27, d28=$d28, d29=$d29, d3=$d3, d30=$d30, d31=$d31, d32=$d32, d4=$d4, d5=$d5, d6=$d6, d7=$d7, d8=$d8, d9=$d9, dwellts=$dwellts, additionalProperties=$additionalProperties}"
    }

    class FreeText private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(freeText: FreeText) =
                apply {
                    f1 = freeText.f1
                    f2 = freeText.f2
                    f3 = freeText.f3
             ...
             *
             * You should usually call [Builder.f1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun f1(f1: JsonField<String>) =
                apply {
                    this.f1 = f1
                }
             ...
             *
             * You should usually call [Builder.f2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun f2(f2: JsonField<String>) =
                apply {
                    this.f2 = f2
                }
             ...
             *
             * You should usually call [Builder.f3] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun f3(f3: JsonField<String>) =
                apply {
                    this.f3 = f3
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (f1.asKnown().isPresent) 1 else 0) + (if (f2.asKnown().isPresent) 1 else 0) + (if (f3.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "FreeText{f1=$f1, f2=$f2, f3=$f3, additionalProperties=$additionalProperties}"
    }

    class Hrr private constructor(
        ...
        @JsonProperty("h32")
        @ExcludeMissing
        fun _h32(): JsonField<List<H32>> = h32
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.h10] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h10(h10: JsonField<Long>) =
                apply {
                    this.h10 = h10
                }
             ...
             *
             * You should usually call [Builder.h11] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h11(h11: JsonField<Double>) =
                apply {
                    this.h11 = h11
                }
             ...
             *
             * You should usually call [Builder.h12] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h12(h12: JsonField<Double>) =
                apply {
                    this.h12 = h12
                }
             ...
             *
             * You should usually call [Builder.h13] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h13(h13: JsonField<Double>) =
                apply {
                    this.h13 = h13
                }
             ...
             *
             * You should usually call [Builder.h14] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h14(h14: JsonField<Double>) =
                apply {
                    this.h14 = h14
                }
             ...
             *
             * You should usually call [Builder.h15] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h15(h15: JsonField<Double>) =
                apply {
                    this.h15 = h15
                }
             ...
             *
             * You should usually call [Builder.h16] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h16(h16: JsonField<String>) =
                apply {
                    this.h16 = h16
                }
             ...
             *
             * You should usually call [Builder.h17] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h17(h17: JsonField<String>) =
                apply {
                    this.h17 = h17
                }
             ...
             *
             * You should usually call [Builder.h18] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h18(h18: JsonField<String>) =
                apply {
                    this.h18 = h18
                }
             ...
             *
             * You should usually call [Builder.h19] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h19(h19: JsonField<Double>) =
                apply {
                    this.h19 = h19
                }
             ...
             *
             * You should usually call [Builder.h2] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h2(h2: JsonField<Int>) =
                apply {
                    this.h2 = h2
                }
             ...
             *
             * You should usually call [Builder.h20] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h20(h20: JsonField<Long>) =
                apply {
                    this.h20 = h20
                }
             ...
             *
             * You should usually call [Builder.h21] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h21(h21: JsonField<Long>) =
                apply {
                    this.h21 = h21
                }
             ...
             *
             * You should usually call [Builder.h22] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h22(h22: JsonField<Long>) =
                apply {
                    this.h22 = h22
                }
             ...
             *
             * You should usually call [Builder.h23] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h23(h23: JsonField<String>) =
                apply {
                    this.h23 = h23
                }
             ...
             *
             * You should usually call [Builder.h24] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h24(h24: JsonField<String>) =
                apply {
                    this.h24 = h24
                }
             ...
             *
             * You should usually call [Builder.h27] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h27(h27: JsonField<Long>) =
                apply {
                    this.h27 = h27
                }
             ...
             *
             * You should usually call [Builder.h28] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h28(h28: JsonField<Long>) =
                apply {
                    this.h28 = h28
                }
             ...
             *
             * You should usually call [Builder.h29] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h29(h29: JsonField<Long>) =
                apply {
                    this.h29 = h29
                }
             ...
             *
             * You should usually call [Builder.h3] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h3(h3: JsonField<Int>) =
                apply {
                    this.h3 = h3
                }
             ...
             *
             * You should usually call [Builder.h30] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h30(h30: JsonField<Long>) =
                apply {
                    this.h30 = h30
                }
             ...
             *
             * You should usually call [Builder.h31] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h31(h31: JsonField<Long>) =
                apply {
                    this.h31 = h31
                }
             ...
             *
             * You should usually call [Builder.h32] with a well-typed `List<H32>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h32(h32: JsonField<List<H32>>) =
                apply {
            ...
            fun addH32(h32: H32) =
                apply {
                    this.h32 = (this.h32 ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.h4] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h4(h4: JsonField<Boolean>) =
                apply {
                    this.h4 = h4
                }
             ...
             *
             * You should usually call [Builder.h5] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h5(h5: JsonField<Int>) =
                apply {
                    this.h5 = h5
                }
             ...
             *
             * You should usually call [Builder.h6] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h6(h6: JsonField<Int>) =
                apply {
                    this.h6 = h6
                }
             ...
             *
             * You should usually call [Builder.h7] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h7(h7: JsonField<Int>) =
                apply {
                    this.h7 = h7
                }
             ...
             *
             * You should usually call [Builder.h8] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h8(h8: JsonField<Int>) =
                apply {
                    this.h8 = h8
                }
             ...
             *
             * You should usually call [Builder.h9] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun h9(h9: JsonField<Long>) =
                apply {
                    this.h9 = h9
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (h10.asKnown().isPresent) 1 else 0) + (if (h11.asKnown().isPresent) 1 else 0) + (if (h12.asKnown().isPresent) 1 else 0) + (if (h13.asKnown().isPresent) 1 else 0) + (if (h14.asKnown().isPresent) 1 else 0) + (if (h15.asKnown().isPresent) 1 else 0) + (if (h16.asKnown().isPresent) 1 else 0) + (if (h17.asKnown().isPresent) 1 else 0) + (if (h18.asKnown().isPresent) 1 else 0) + (if (h19.asKnown().isPresent) 1 else 0) + (if (h2.asKnown().isPresent) 1 else 0) + (if (h20.asKnown().isPresent) 1 else 0) + (if (h21.asKnown().isPresent) 1 else 0) + (if (h22.asKnown().isPresent) 1 else 0) + (if (h23.asKnown().isPresent) 1 else 0) + (if (h24.asKnown().isPresent) 1 else 0) + (if (h27.asKnown().isPresent) 1 else 0) + (if (h28.asKnown().isPresent) 1 else 0) + (if (h29.asKnown().isPresent) 1 else 0) + (if (h3.asKnown().isPresent) 1 else 0) + (if (h30.asKnown().isPresent) 1 else 0) + (if (h31.asKnown().isPresent) 1 else 0) + (h32.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (h4.asKnown().isPresent) 1 else 0) + (if (h5.asKnown().isPresent) 1 else 0) + (if (h6.asKnown().isPresent) 1 else 0) + (if (h7.asKnown().isPresent) 1 else 0) + (if (h8.asKnown().isPresent) 1 else 0) + (if (h9.asKnown().isPresent) 1 else 0)

        /** HRR Scatterer record for a target pixel that exceeds the target detection threshold. */
        class H32 private constructor(
             ...
             *
             * Unlike [h32_1], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("h32_1")
            @ExcludeMissing
            fun _h32_1(): JsonField<Int> = h32_1

            /**
             * Returns the raw JSON value of [h32_2].
             *
             * Unlike [h32_2], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("h32_2")
            @ExcludeMissing
            fun _h32_2(): JsonField<Int> = h32_2

            /**
             * Returns the raw JSON value of [h32_3].
             *
             * Unlike [h32_3], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("h32_3")
            @ExcludeMissing
            fun _h32_3(): JsonField<Int> = h32_3

            /**
             * Returns the raw JSON value of [h32_4].
             *
             * Unlike [h32_4], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("h32_4")
            @ExcludeMissing
            fun _h32_4(): JsonField<Int> = h32_4
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.h32_1] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun h32_1(h32_1: JsonField<Int>) =
                    apply {
                        this.h32_1 = h32_1
                    }
                 ...
                 *
                 * You should usually call [Builder.h32_2] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun h32_2(h32_2: JsonField<Int>) =
                    apply {
                        this.h32_2 = h32_2
                    }
                 ...
                 *
                 * You should usually call [Builder.h32_3] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun h32_3(h32_3: JsonField<Int>) =
                    apply {
                        this.h32_3 = h32_3
                    }
                 ...
                 *
                 * You should usually call [Builder.h32_4] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun h32_4(h32_4: JsonField<Int>) =
                    apply {
                        this.h32_4 = h32_4
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (h32_1.asKnown().isPresent) 1 else 0) + (if (h32_2.asKnown().isPresent) 1 else 0) + (if (h32_3.asKnown().isPresent) 1 else 0) + (if (h32_4.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() = "H32{h32_1=$h32_1, h32_2=$h32_2, h32_3=$h32_3, h32_4=$h32_4, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() = "Hrr{h10=$h10, h11=$h11, h12=$h12, h13=$h13, h14=$h14, h15=$h15, h16=$h16, h17=$h17, h18=$h18, h19=$h19, h2=$h2, h20=$h20, h21=$h21, h22=$h22, h23=$h23, h24=$h24, h27=$h27, h28=$h28, h29=$h29, h3=$h3, h30=$h30, h31=$h31, h32=$h32, h4=$h4, h5=$h5, h6=$h6, h7=$h7, h8=$h8, h9=$h9, additionalProperties=$additionalProperties}"
    }
    ...
    class JobDef private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(jobDef: JobDef) =
                apply {
                    j10 = jobDef.j10
                    j11 = jobDef.j11
                    j12 = jobDef.j12
             ...
             *
             * You should usually call [Builder.j10] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j10(j10: JsonField<Double>) =
                apply {
                    this.j10 = j10
                }
             ...
             *
             * You should usually call [Builder.j11] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j11(j11: JsonField<Double>) =
                apply {
                    this.j11 = j11
                }
             ...
             *
             * You should usually call [Builder.j12] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j12(j12: JsonField<Double>) =
                apply {
                    this.j12 = j12
                }
             ...
             *
             * You should usually call [Builder.j13] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j13(j13: JsonField<Double>) =
                apply {
                    this.j13 = j13
                }
             ...
             *
             * You should usually call [Builder.j14] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j14(j14: JsonField<String>) =
                apply {
                    this.j14 = j14
                }
             ...
             *
             * You should usually call [Builder.j15] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j15(j15: JsonField<Int>) =
                apply {
                    this.j15 = j15
                }
             ...
             *
             * You should usually call [Builder.j16] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j16(j16: JsonField<Int>) =
                apply {
                    this.j16 = j16
                }
             ...
             *
             * You should usually call [Builder.j17] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j17(j17: JsonField<Int>) =
                apply {
                    this.j17 = j17
                }
             ...
             *
             * You should usually call [Builder.j18] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j18(j18: JsonField<Int>) =
                apply {
                    this.j18 = j18
                }
             ...
             *
             * You should usually call [Builder.j19] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j19(j19: JsonField<Long>) =
                apply {
                    this.j19 = j19
                }
             ...
             *
             * You should usually call [Builder.j2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j2(j2: JsonField<String>) =
                apply {
                    this.j2 = j2
                }
             ...
             *
             * You should usually call [Builder.j20] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j20(j20: JsonField<Int>) =
                apply {
                    this.j20 = j20
                }
             ...
             *
             * You should usually call [Builder.j21] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j21(j21: JsonField<Int>) =
                apply {
                    this.j21 = j21
                }
             ...
             *
             * You should usually call [Builder.j22] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j22(j22: JsonField<Double>) =
                apply {
                    this.j22 = j22
                }
             ...
             *
             * You should usually call [Builder.j23] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j23(j23: JsonField<Int>) =
                apply {
                    this.j23 = j23
                }
             ...
             *
             * You should usually call [Builder.j24] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j24(j24: JsonField<Long>) =
                apply {
                    this.j24 = j24
                }
             ...
             *
             * You should usually call [Builder.j25] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j25(j25: JsonField<Long>) =
                apply {
                    this.j25 = j25
                }
             ...
             *
             * You should usually call [Builder.j26] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j26(j26: JsonField<Long>) =
                apply {
                    this.j26 = j26
                }
             ...
             *
             * You should usually call [Builder.j27] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j27(j27: JsonField<String>) =
                apply {
                    this.j27 = j27
                }
             ...
             *
             * You should usually call [Builder.j28] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j28(j28: JsonField<String>) =
                apply {
                    this.j28 = j28
                }
             ...
             *
             * You should usually call [Builder.j3] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j3(j3: JsonField<String>) =
                apply {
                    this.j3 = j3
                }
             ...
             *
             * You should usually call [Builder.j4] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j4(j4: JsonField<Long>) =
                apply {
                    this.j4 = j4
                }
             ...
             *
             * You should usually call [Builder.j5] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j5(j5: JsonField<Long>) =
                apply {
                    this.j5 = j5
                }
             ...
             *
             * You should usually call [Builder.j6] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j6(j6: JsonField<Double>) =
                apply {
                    this.j6 = j6
                }
             ...
             *
             * You should usually call [Builder.j7] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j7(j7: JsonField<Double>) =
                apply {
                    this.j7 = j7
                }
             ...
             *
             * You should usually call [Builder.j8] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j8(j8: JsonField<Double>) =
                apply {
                    this.j8 = j8
                }
             ...
             *
             * You should usually call [Builder.j9] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun j9(j9: JsonField<Double>) =
                apply {
                    this.j9 = j9
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (j10.asKnown().isPresent) 1 else 0) + (if (j11.asKnown().isPresent) 1 else 0) + (if (j12.asKnown().isPresent) 1 else 0) + (if (j13.asKnown().isPresent) 1 else 0) + (if (j14.asKnown().isPresent) 1 else 0) + (if (j15.asKnown().isPresent) 1 else 0) + (if (j16.asKnown().isPresent) 1 else 0) + (if (j17.asKnown().isPresent) 1 else 0) + (if (j18.asKnown().isPresent) 1 else 0) + (if (j19.asKnown().isPresent) 1 else 0) + (if (j2.asKnown().isPresent) 1 else 0) + (if (j20.asKnown().isPresent) 1 else 0) + (if (j21.asKnown().isPresent) 1 else 0) + (if (j22.asKnown().isPresent) 1 else 0) + (if (j23.asKnown().isPresent) 1 else 0) + (if (j24.asKnown().isPresent) 1 else 0) + (if (j25.asKnown().isPresent) 1 else 0) + (if (j26.asKnown().isPresent) 1 else 0) + (if (j27.asKnown().isPresent) 1 else 0) + (if (j28.asKnown().isPresent) 1 else 0) + (if (j3.asKnown().isPresent) 1 else 0) + (if (j4.asKnown().isPresent) 1 else 0) + (if (j5.asKnown().isPresent) 1 else 0) + (if (j6.asKnown().isPresent) 1 else 0) + (if (j7.asKnown().isPresent) 1 else 0) + (if (j8.asKnown().isPresent) 1 else 0) + (if (j9.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is JobDef && j10 == other.j10 && j11 == other.j11 && j12 == other.j12 && j13 == other.j13 && j14 == other.j14 && j15 == other.j15 && j16 == other.j16 && j17 == other.j17 && j18 == other.j18 && j19 == other.j19 && j2 == other.j2 && j20 == other.j20 && j21 == other.j21 && j22 == other.j22 && j23 == other.j23 && j24 == other.j24 && j25 == other.j25 && j26 == other.j26 && j27 == other.j27 && j28 == other.j28 && j3 == other.j3 && j4 == other.j4 && j5 == other.j5 && j6 == other.j6 && j7 == other.j7 && j8 == other.j8 && j9 == other.j9 && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(j10, j11, j12, j13, j14, j15, j16, j17, j18, j19, j2, j20, j21, j22, j23, j24, j25, j26, j27, j28, j3, j4, j5, j6, j7, j8, j9, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "JobDef{j10=$j10, j11=$j11, j12=$j12, j13=$j13, j14=$j14, j15=$j15, j16=$j16, j17=$j17, j18=$j18, j19=$j19, j2=$j2, j20=$j20, j21=$j21, j22=$j22, j23=$j23, j24=$j24, j25=$j25, j26=$j26, j27=$j27, j28=$j28, j3=$j3, j4=$j4, j5=$j5, j6=$j6, j7=$j7, j8=$j8, j9=$j9, additionalProperties=$additionalProperties}"
    }

    class JobRequest private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("jobReqEst") @ExcludeMissing jobReqEst: JsonField<OffsetDateTime> = JsonMissing.of(),
         ...
         *
         * Unlike [jobReqEst], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("r26")
        @ExcludeMissing
        fun _r26(): JsonField<Boolean> = r26
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(jobRequest: JobRequest) =
                apply {
             ...
             *
             * You should usually call [Builder.jobReqEst] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun jobReqEst(jobReqEst: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.r1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r1(r1: JsonField<String>) =
                apply {
                    this.r1 = r1
                }
             ...
             *
             * You should usually call [Builder.r10] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r10(r10: JsonField<Double>) =
                apply {
                    this.r10 = r10
                }
             ...
             *
             * You should usually call [Builder.r11] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r11(r11: JsonField<Double>) =
                apply {
                    this.r11 = r11
                }
             ...
             *
             * You should usually call [Builder.r12] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r12(r12: JsonField<String>) =
                apply {
                    this.r12 = r12
                }
             ...
             *
             * You should usually call [Builder.r13] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r13(r13: JsonField<Int>) =
                apply {
                    this.r13 = r13
                }
             ...
             *
             * You should usually call [Builder.r14] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r14(r14: JsonField<Int>) =
                apply {
                    this.r14 = r14
                }
             ...
             *
             * You should usually call [Builder.r2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r2(r2: JsonField<String>) =
                apply {
                    this.r2 = r2
                }
             ...
             *
             * You should usually call [Builder.r21] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r21(r21: JsonField<Int>) =
                apply {
                    this.r21 = r21
                }
             ...
             *
             * You should usually call [Builder.r22] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r22(r22: JsonField<Int>) =
                apply {
                    this.r22 = r22
                }
             ...
             *
             * You should usually call [Builder.r23] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r23(r23: JsonField<Int>) =
                apply {
                    this.r23 = r23
                }
             ...
             *
             * You should usually call [Builder.r24] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r24(r24: JsonField<String>) =
                apply {
                    this.r24 = r24
                }
             ...
             *
             * You should usually call [Builder.r25] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r25(r25: JsonField<String>) =
                apply {
                    this.r25 = r25
                }
             ...
             *
             * You should usually call [Builder.r26] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r26(r26: JsonField<Boolean>) =
                apply {
                    this.r26 = r26
                }
             ...
             *
             * You should usually call [Builder.r3] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r3(r3: JsonField<Long>) =
                apply {
                    this.r3 = r3
                }
             ...
             *
             * You should usually call [Builder.r4] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r4(r4: JsonField<Double>) =
                apply {
                    this.r4 = r4
                }
             ...
             *
             * You should usually call [Builder.r5] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r5(r5: JsonField<Double>) =
                apply {
                    this.r5 = r5
                }
             ...
             *
             * You should usually call [Builder.r6] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r6(r6: JsonField<Double>) =
                apply {
                    this.r6 = r6
                }
             ...
             *
             * You should usually call [Builder.r7] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r7(r7: JsonField<Double>) =
                apply {
                    this.r7 = r7
                }
             ...
             *
             * You should usually call [Builder.r8] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r8(r8: JsonField<Double>) =
                apply {
                    this.r8 = r8
                }
             ...
             *
             * You should usually call [Builder.r9] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun r9(r9: JsonField<Double>) =
                apply {
                    this.r9 = r9
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (jobReqEst.asKnown().isPresent) 1 else 0) + (if (r1.asKnown().isPresent) 1 else 0) + (if (r10.asKnown().isPresent) 1 else 0) + (if (r11.asKnown().isPresent) 1 else 0) + (if (r12.asKnown().isPresent) 1 else 0) + (if (r13.asKnown().isPresent) 1 else 0) + (if (r14.asKnown().isPresent) 1 else 0) + (if (r2.asKnown().isPresent) 1 else 0) + (if (r21.asKnown().isPresent) 1 else 0) + (if (r22.asKnown().isPresent) 1 else 0) + (if (r23.asKnown().isPresent) 1 else 0) + (if (r24.asKnown().isPresent) 1 else 0) + (if (r25.asKnown().isPresent) 1 else 0) + (if (r26.asKnown().isPresent) 1 else 0) + (if (r3.asKnown().isPresent) 1 else 0) + (if (r4.asKnown().isPresent) 1 else 0) + (if (r5.asKnown().isPresent) 1 else 0) + (if (r6.asKnown().isPresent) 1 else 0) + (if (r7.asKnown().isPresent) 1 else 0) + (if (r8.asKnown().isPresent) 1 else 0) + (if (r9.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "JobRequest{jobReqEst=$jobReqEst, r1=$r1, r10=$r10, r11=$r11, r12=$r12, r13=$r13, r14=$r14, r2=$r2, r21=$r21, r22=$r22, r23=$r23, r24=$r24, r25=$r25, r26=$r26, r3=$r3, r4=$r4, r5=$r5, r6=$r6, r7=$r7, r8=$r8, r9=$r9, additionalProperties=$additionalProperties}"
    }
    ...
    class Mission private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("msnRefTs") @ExcludeMissing msnRefTs: JsonField<LocalDate> = JsonMissing.of()
        ) : this(
          m1,
          m2,
          m3,
        ...
        @JsonProperty("m4")
        @ExcludeMissing
        fun _m4(): JsonField<String> = m4

        /**
         * Returns the raw JSON value of [msnRefTs].
         *
         * Unlike [msnRefTs], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(mission: Mission) =
                apply {
                    m1 = mission.m1
                    m2 = mission.m2
                    m3 = mission.m3
             ...
             *
             * You should usually call [Builder.m3] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun m3(m3: JsonField<String>) =
                apply {
                    this.m3 = m3
                }
             ...
             *
             * You should usually call [Builder.m4] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun m4(m4: JsonField<String>) =
                apply {
                    this.m4 = m4
                }
             ...
             *
             * You should usually call [Builder.msnRefTs] with a well-typed [LocalDate] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun msnRefTs(msnRefTs: JsonField<LocalDate>) =
                apply {
                    this.msnRefTs = msnRefTs
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (m1.asKnown().isPresent) 1 else 0) + (if (m2.asKnown().isPresent) 1 else 0) + (if (m3.asKnown().isPresent) 1 else 0) + (if (m4.asKnown().isPresent) 1 else 0) + (if (msnRefTs.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "Mission{m1=$m1, m2=$m2, m3=$m3, m4=$m4, msnRefTs=$msnRefTs, additionalProperties=$additionalProperties}"
    }

    class PlatformLoc private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("platlocts") @ExcludeMissing platlocts: JsonField<OffsetDateTime> = JsonMissing.of()
        ) : this(
          l1,
          l2,
          l3,
        ...
        @JsonProperty("l7")
        @ExcludeMissing
        fun _l7(): JsonField<Long> = l7

        /**
         * Returns the raw JSON value of [platlocts].
         *
         * Unlike [platlocts], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(platformLoc: PlatformLoc) =
                apply {
                    l1 = platformLoc.l1
                    l2 = platformLoc.l2
                    l3 = platformLoc.l3
             ...
             *
             * You should usually call [Builder.l1] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun l1(l1: JsonField<Long>) =
                apply {
                    this.l1 = l1
                }
             ...
             *
             * You should usually call [Builder.l2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun l2(l2: JsonField<Double>) =
                apply {
                    this.l2 = l2
                }
             ...
             *
             * You should usually call [Builder.l3] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun l3(l3: JsonField<Double>) =
                apply {
                    this.l3 = l3
                }
             ...
             *
             * You should usually call [Builder.l4] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun l4(l4: JsonField<Int>) =
                apply {
                    this.l4 = l4
                }
             ...
             *
             * You should usually call [Builder.l5] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun l5(l5: JsonField<Double>) =
                apply {
                    this.l5 = l5
                }
             ...
             *
             * You should usually call [Builder.l6] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun l6(l6: JsonField<Int>) =
                apply {
                    this.l6 = l6
                }
             ...
             *
             * You should usually call [Builder.l7] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun l7(l7: JsonField<Long>) =
                apply {
                    this.l7 = l7
                }
             ...
             *
             * You should usually call [Builder.platlocts] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun platlocts(platlocts: JsonField<OffsetDateTime>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (l1.asKnown().isPresent) 1 else 0) + (if (l2.asKnown().isPresent) 1 else 0) + (if (l3.asKnown().isPresent) 1 else 0) + (if (l4.asKnown().isPresent) 1 else 0) + (if (l5.asKnown().isPresent) 1 else 0) + (if (l6.asKnown().isPresent) 1 else 0) + (if (l7.asKnown().isPresent) 1 else 0) + (if (platlocts.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "PlatformLoc{l1=$l1, l2=$l2, l3=$l3, l4=$l4, l5=$l5, l6=$l6, l7=$l7, platlocts=$platlocts, additionalProperties=$additionalProperties}"
    }
