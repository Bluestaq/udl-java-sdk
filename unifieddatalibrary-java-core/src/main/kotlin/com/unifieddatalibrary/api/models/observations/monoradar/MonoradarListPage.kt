...
class MonoradarListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarListPage: MonoradarListPage) =
            apply {
        ...
        fun service(service: MonoradarService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MonoradarListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }
