...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = searchCriterion.accept(new SearchCriterion.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitScsSearchField(ScsSearchFieldCriterion scsSearchField) {
     *         return Optional.of(scsSearchField.toString());
     *     }
     *
     *     // ...
     *
     ...
     * ```
     *
     * @throws UnifieddatalibraryInvalidDataException if [Visitor.unknown] is not overridden in
