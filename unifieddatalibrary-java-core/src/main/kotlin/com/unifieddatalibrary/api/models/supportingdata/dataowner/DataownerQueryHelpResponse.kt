...
class DataownerQueryHelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DataownerQueryHelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DataownerQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dataownerQueryHelpResponse: DataownerQueryHelpResponse) = apply {
            aodrSupported = dataownerQueryHelpResponse.aodrSupported
            classificationMarking = dataownerQueryHelpResponse.classificationMarking
            description = dataownerQueryHelpResponse.description
            historySupported = dataownerQueryHelpResponse.historySupported
            name = dataownerQueryHelpResponse.name
            parameters = dataownerQueryHelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = dataownerQueryHelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = dataownerQueryHelpResponse.restSupported
            sortSupported = dataownerQueryHelpResponse.sortSupported
            typeName = dataownerQueryHelpResponse.typeName
            uri = dataownerQueryHelpResponse.uri
            additionalProperties = dataownerQueryHelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DataownerQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DataownerQueryHelpResponse =
    ...
    fun validate(): DataownerQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DataownerQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
