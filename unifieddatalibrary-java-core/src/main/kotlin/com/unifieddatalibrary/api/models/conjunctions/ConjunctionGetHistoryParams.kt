 ...
 */
class ConjunctionGetHistoryParams
private constructor(
    private val tca: OffsetDateTime,
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConjunctionGetHistoryParams].
         *
    ...
    /** A builder for [ConjunctionGetHistoryParams]. */
    class Builder internal constructor() {

        private var tca: OffsetDateTime? = null
        ...
        @JvmSynthetic
        internal fun from(conjunctionGetHistoryParams: ConjunctionGetHistoryParams) = apply {
            tca = conjunctionGetHistoryParams.tca
            columns = conjunctionGetHistoryParams.columns
            firstResult = conjunctionGetHistoryParams.firstResult
            maxResults = conjunctionGetHistoryParams.maxResults
            additionalHeaders = conjunctionGetHistoryParams.additionalHeaders.toBuilder()
            additionalQueryParams = conjunctionGetHistoryParams.additionalQueryParams.toBuilder()
        }

        /** Time of closest approach (TCA) in UTC. (YYYY-MM-DDTHH:MM:SS.ssssssZ) */
        fun tca(tca: OffsetDateTime) = apply { this.tca = tca }
        ...
        /**
         * Returns an immutable instance of [ConjunctionGetHistoryParams].
         *
         ...
         */
        fun build(): ConjunctionGetHistoryParams =
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("tca", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(tca))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConjunctionGetHistoryParams && tca == other.tca && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(tca, columns, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ConjunctionGetHistoryParams{tca=$tca, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
