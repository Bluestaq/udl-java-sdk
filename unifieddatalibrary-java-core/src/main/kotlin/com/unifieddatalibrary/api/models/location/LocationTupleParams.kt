...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LocationTupleParams].
         *
    ...
    /** A builder for [LocationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(locationTupleParams: LocationTupleParams) = apply {
            columns = locationTupleParams.columns
            firstResult = locationTupleParams.firstResult
            maxResults = locationTupleParams.maxResults
            additionalHeaders = locationTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = locationTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LocationTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LocationTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LocationTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
