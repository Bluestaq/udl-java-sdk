 ...
 * object of interest's manifold describing a possible/theoretical orbit for an object of interest
 * for tasking purposes.
 */
class ManifoldelsetGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ManifoldelsetGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetGetParams: ManifoldelsetGetParams) = apply {
    ...
    override fun toString() =
        "ManifoldelsetGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
