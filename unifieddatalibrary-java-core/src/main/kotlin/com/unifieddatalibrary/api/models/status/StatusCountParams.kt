...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StatusCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusCountParams: StatusCountParams) = apply {
    ...
    override fun toString() =
        "StatusCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
