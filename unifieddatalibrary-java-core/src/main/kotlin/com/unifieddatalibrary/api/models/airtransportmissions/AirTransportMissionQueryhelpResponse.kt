...
class AirTransportMissionQueryhelpResponse
private constructor(
    ...
    /** A builder for [AirTransportMissionQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            airTransportMissionQueryhelpResponse: AirTransportMissionQueryhelpResponse
        ) = apply {
            aodrSupported = airTransportMissionQueryhelpResponse.aodrSupported
            classificationMarking = airTransportMissionQueryhelpResponse.classificationMarking
            description = airTransportMissionQueryhelpResponse.description
            historySupported = airTransportMissionQueryhelpResponse.historySupported
            name = airTransportMissionQueryhelpResponse.name
            parameters = airTransportMissionQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                airTransportMissionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = airTransportMissionQueryhelpResponse.restSupported
            sortSupported = airTransportMissionQueryhelpResponse.sortSupported
            typeName = airTransportMissionQueryhelpResponse.typeName
            uri = airTransportMissionQueryhelpResponse.uri
            additionalProperties =
                airTransportMissionQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AirTransportMissionQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirTransportMissionQueryhelpResponse =
            AirTransportMissionQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): AirTransportMissionQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirTransportMissionQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
