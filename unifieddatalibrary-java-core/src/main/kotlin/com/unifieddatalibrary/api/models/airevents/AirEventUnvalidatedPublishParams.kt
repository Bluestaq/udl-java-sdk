...
/**
 * Service operation to take multiple airevent records as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class AirEventUnvalidatedPublishParams
private constructor(
        ...
        internal fun from(airEventUnvalidatedPublishParams: AirEventUnvalidatedPublishParams) =
            apply {
                ...
                additionalQueryParams =
                    airEventUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "AirEventUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
