...
class CommQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CommQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [CommQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commQueryhelpResponse: CommQueryhelpResponse) =
            apply {
                aodrSupported = commQueryhelpResponse.aodrSupported
                classificationMarking = commQueryhelpResponse.classificationMarking
                description = commQueryhelpResponse.description
                historySupported = commQueryhelpResponse.historySupported
                name = commQueryhelpResponse.name
                parameters = commQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = commQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = commQueryhelpResponse.restSupported
                sortSupported = commQueryhelpResponse.sortSupported
                typeName = commQueryhelpResponse.typeName
                uri = commQueryhelpResponse.uri
                additionalProperties = commQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CommQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommQueryhelpResponse =
    ...
    fun validate(): CommQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CommQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
