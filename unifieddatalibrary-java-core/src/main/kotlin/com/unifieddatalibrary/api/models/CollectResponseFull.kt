...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectResponseFull: CollectResponseFull) = apply {
    ...
    fun validate(): CollectResponseFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectResponseFull &&
