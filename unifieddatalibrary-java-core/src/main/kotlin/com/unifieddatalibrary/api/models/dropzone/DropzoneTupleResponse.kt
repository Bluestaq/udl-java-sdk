...
class DropzoneTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DropzoneTupleResponse].
         *
    ...
    /** A builder for [DropzoneTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneTupleResponse: DropzoneTupleResponse) =
            apply {
                classificationMarking = dropzoneTupleResponse.classificationMarking
                dataMode = dropzoneTupleResponse.dataMode
                lat = dropzoneTupleResponse.lat
                lon = dropzoneTupleResponse.lon
                name = dropzoneTupleResponse.name
                source = dropzoneTupleResponse.source
                id = dropzoneTupleResponse.id
                altCountryCode = dropzoneTupleResponse.altCountryCode
                altCountryName = dropzoneTupleResponse.altCountryName
                approvalDate = dropzoneTupleResponse.approvalDate
                code = dropzoneTupleResponse.code
                countryCode = dropzoneTupleResponse.countryCode
                countryName = dropzoneTupleResponse.countryName
                createdAt = dropzoneTupleResponse.createdAt
                createdBy = dropzoneTupleResponse.createdBy
                expirationDate = dropzoneTupleResponse.expirationDate
                extIdentifier = dropzoneTupleResponse.extIdentifier
                idSite = dropzoneTupleResponse.idSite
                lastUpdate = dropzoneTupleResponse.lastUpdate
                length = dropzoneTupleResponse.length
                majcom = dropzoneTupleResponse.majcom
                nearestLoc = dropzoneTupleResponse.nearestLoc
                operationalApprovalDate = dropzoneTupleResponse.operationalApprovalDate
                origin = dropzoneTupleResponse.origin
                origNetwork = dropzoneTupleResponse.origNetwork
                pointName = dropzoneTupleResponse.pointName
                radius = dropzoneTupleResponse.radius
                recertDate = dropzoneTupleResponse.recertDate
                remark = dropzoneTupleResponse.remark
                sourceDl = dropzoneTupleResponse.sourceDl
                stateAbbr = dropzoneTupleResponse.stateAbbr
                stateName = dropzoneTupleResponse.stateName
                surveyDate = dropzoneTupleResponse.surveyDate
                updatedAt = dropzoneTupleResponse.updatedAt
                updatedBy = dropzoneTupleResponse.updatedBy
                width = dropzoneTupleResponse.width
                zarId = dropzoneTupleResponse.zarId
                additionalProperties = dropzoneTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DropzoneTupleResponse].
         *
         ...
         */
        fun build(): DropzoneTupleResponse =
    ...
    fun validate(): DropzoneTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
