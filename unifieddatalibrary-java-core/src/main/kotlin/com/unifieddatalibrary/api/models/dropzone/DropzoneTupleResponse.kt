...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneTupleResponse: DropzoneTupleResponse) = apply {
    ...
    fun validate(): DropzoneTupleResponse = apply {
        if (validated) {
            return@apply
        }
