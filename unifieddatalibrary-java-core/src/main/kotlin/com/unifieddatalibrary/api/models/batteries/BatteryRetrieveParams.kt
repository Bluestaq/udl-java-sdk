...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BatteryRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BatteryRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BatteryRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batteryRetrieveParams: BatteryRetrieveParams) = apply {
            id = batteryRetrieveParams.id
            firstResult = batteryRetrieveParams.firstResult
            maxResults = batteryRetrieveParams.maxResults
            additionalHeaders = batteryRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = batteryRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatteryRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatteryRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatteryRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BatteryRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
