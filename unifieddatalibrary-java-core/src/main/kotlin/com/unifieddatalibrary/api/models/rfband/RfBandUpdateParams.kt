...
class RfBandUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfBandUpdateParams].
         *
    ...
    /** A builder for [RfBandUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandUpdateParams: RfBandUpdateParams) =
            apply {
                pathId = rfBandUpdateParams.pathId
                body = rfBandUpdateParams.body.toBuilder()
                additionalHeaders = rfBandUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfBandUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Center frequency of RF frequency range, if applicable, in Mhz. */
        fun centerFreq(centerFreq: Double) =
            apply {
                body.centerFreq(centerFreq)
            }
        ...
        /** RF Range edge gain, in dBi. */
        fun edgeGain(edgeGain: Double) =
            apply {
                body.edgeGain(edgeGain)
            }
        ...
        /** End/maximum of transmit RF frequency range, if applicable, in Mhz. */
        fun freqMax(freqMax: Double) =
            apply {
                body.freqMax(freqMax)
            }
        ...
        /** Start/minimum of transmit RF frequency range, if applicable, in Mhz. */
        fun freqMin(freqMin: Double) =
            apply {
                body.freqMin(freqMin)
            }
        ...
        /** RF Range maximum gain, in dBi. */
        fun peakGain(peakGain: Double) =
            apply {
                body.peakGain(peakGain)
            }
        ...
        /** Transponder polarization e.g. H - (Horizontally Polarized) Perpendicular to Earth's surface, V - (Vertically Polarized) Parallel to Earth's surface, L - (Left Hand Circularly Polarized) Rotating left relative to the Earth's surface, R - (Right Hand Circularly Polarized) Rotating right relative to the Earth's surface. */
        fun polarization(polarization: Polarization) =
            apply {
        ...
        /**
         * Returns an immutable instance of [RfBandUpdateParams].
         *
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idEntity.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (band.asKnown().isPresent) 1 else 0) + (if (bandwidth.asKnown().isPresent) 1 else 0) + (if (beamwidth.asKnown().isPresent) 1 else 0) + (if (centerFreq.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (edgeGain.asKnown().isPresent) 1 else 0) + (if (eirp.asKnown().isPresent) 1 else 0) + (if (erp.asKnown().isPresent) 1 else 0) + (if (freqMax.asKnown().isPresent) 1 else 0) + (if (freqMin.asKnown().isPresent) 1 else 0) + (mode.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (peakGain.asKnown().isPresent) 1 else 0) + (polarization.asKnown().getOrNull()?.validity() ?: 0) + (purpose.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idEntity=$idEntity, name=$name, source=$source, bodyId=$bodyId, band=$band, bandwidth=$bandwidth, beamwidth=$beamwidth, centerFreq=$centerFreq, createdAt=$createdAt, createdBy=$createdBy, edgeGain=$edgeGain, eirp=$eirp, erp=$erp, freqMax=$freqMax, freqMin=$freqMin, mode=$mode, origin=$origin, origNetwork=$origNetwork, peakGain=$peakGain, polarization=$polarization, purpose=$purpose, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "RfBandUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
