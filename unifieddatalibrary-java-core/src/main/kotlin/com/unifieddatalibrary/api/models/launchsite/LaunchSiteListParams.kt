...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchSiteListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LaunchSiteListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LaunchSiteListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteListParams: LaunchSiteListParams) = apply {
            firstResult = launchSiteListParams.firstResult
            maxResults = launchSiteListParams.maxResults
            additionalHeaders = launchSiteListParams.additionalHeaders.toBuilder()
            additionalQueryParams = launchSiteListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchSiteListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LaunchSiteListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LaunchSiteListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
