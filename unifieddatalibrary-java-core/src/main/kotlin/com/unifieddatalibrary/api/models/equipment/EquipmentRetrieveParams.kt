...
class EquipmentRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EquipmentRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EquipmentRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EquipmentRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentRetrieveParams: EquipmentRetrieveParams) =
            apply {
                id = equipmentRetrieveParams.id
                firstResult = equipmentRetrieveParams.firstResult
                maxResults = equipmentRetrieveParams.maxResults
                additionalHeaders = equipmentRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = equipmentRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EquipmentRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EquipmentRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EquipmentRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EquipmentRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
