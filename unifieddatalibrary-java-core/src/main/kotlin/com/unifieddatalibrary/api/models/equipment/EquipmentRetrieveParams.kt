...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EquipmentRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentRetrieveParams: EquipmentRetrieveParams) = apply {
    ...
    override fun toString() =
        "EquipmentRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
