...
class AirspaceControlOrderUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirspaceControlOrderUnvalidatedPublishParams].
         *
    ...
    /** A builder for [AirspaceControlOrderUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airspaceControlOrderUnvalidatedPublishParams: AirspaceControlOrderUnvalidatedPublishParams) =
            apply {
                body = airspaceControlOrderUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = airspaceControlOrderUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = airspaceControlOrderUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirspaceControlOrderUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): AirspaceControlOrderUnvalidatedPublishParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("airspaceControlMeansStatus") @ExcludeMissing private val airspaceControlMeansStatus: JsonField<List<AirspaceControlMeansStatus>>,
        @JsonProperty("airspaceControlOrderReferences") @ExcludeMissing private val airspaceControlOrderReferences: JsonField<List<AirspaceControlOrderReference>>,
        @JsonProperty("areaOfValidity") @ExcludeMissing private val areaOfValidity: JsonField<String>,
        @JsonProperty("classReasons") @ExcludeMissing private val classReasons: JsonField<List<String>>,
        @JsonProperty("classSource") @ExcludeMissing private val classSource: JsonField<String>,
        @JsonProperty("createdAt") @ExcludeMissing private val createdAt: JsonField<OffsetDateTime>,
        @JsonProperty("createdBy") @ExcludeMissing private val createdBy: JsonField<String>,
        @JsonProperty("declassExemptionCodes") @ExcludeMissing private val declassExemptionCodes: JsonField<List<String>>,
        @JsonProperty("downgradeInsDates") @ExcludeMissing private val downgradeInsDates: JsonField<List<String>>,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun airspaceControlMeansStatus(): Optional<List<AirspaceControlMeansStatus>> = airspaceControlMeansStatus.getOptional("airspaceControlMeansStatus")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun airspaceControlOrderReferences(): Optional<List<AirspaceControlOrderReference>> = airspaceControlOrderReferences.getOptional("airspaceControlOrderReferences")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun declassExemptionCodes(): Optional<List<String>> = declassExemptionCodes.getOptional("declassExemptionCodes")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun downgradeInsDates(): Optional<List<String>> = downgradeInsDates.getOptional("downgradeInsDates")
        ...
        @ExcludeMissing
        fun _opExName(): JsonField<String> = opExName
         ...
         *
         * Unlike [airspaceControlMeansStatus], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("airspaceControlMeansStatus")
        @ExcludeMissing
        fun _airspaceControlMeansStatus(): JsonField<List<AirspaceControlMeansStatus>> = airspaceControlMeansStatus

        /**
         * Returns the raw JSON value of [airspaceControlOrderReferences].
         *
         * Unlike [airspaceControlOrderReferences], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("airspaceControlOrderReferences")
        @ExcludeMissing
        fun _airspaceControlOrderReferences(): JsonField<List<AirspaceControlOrderReference>> = airspaceControlOrderReferences
         ...
         *
         * Unlike [declassExemptionCodes], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [downgradeInsDates], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _geoDatum(): JsonField<String> = geoDatum
        ...
        @JsonProperty("month")
        @ExcludeMissing
        fun _month(): JsonField<String> = month
        ...
        @ExcludeMissing
        fun _opExInfo(): JsonField<String> = opExInfo
        ...
        @ExcludeMissing
        fun _qualifier(): JsonField<String> = qualifier
        ...
        @JsonProperty("qualSN")
        @ExcludeMissing
        fun _qualSn(): JsonField<Int> = qualSn
        ...
        @ExcludeMissing
        fun _serialNum(): JsonField<String> = serialNum
        ...
        class Builder internal constructor() {
            ...
            private var airspaceControlMeansStatus: JsonField<MutableList<AirspaceControlMeansStatus>>? = null
            private var airspaceControlOrderReferences: JsonField<MutableList<AirspaceControlOrderReference>>? = null
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    airspaceControlMeansStatus = body.airspaceControlMeansStatus.map { it.toMutableList() }
                    airspaceControlOrderReferences = body.airspaceControlOrderReferences.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.opExName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun opExName(opExName: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.acoComments] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun acoComments(acoComments: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.acoSerialNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun acoSerialNum(acoSerialNum: JsonField<String>) =
                apply {
                    this.acoSerialNum = acoSerialNum
                }

            /** Mandatory nested segment to report multiple airspace control means statuses within an ACOID. */
            fun airspaceControlMeansStatus(airspaceControlMeansStatus: List<AirspaceControlMeansStatus>) = airspaceControlMeansStatus(JsonField.of(airspaceControlMeansStatus))

            /**
             * Sets [Builder.airspaceControlMeansStatus] to an arbitrary JSON value.
             *
             * You should usually call [Builder.airspaceControlMeansStatus] with a well-typed `List<AirspaceControlMeansStatus>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun airspaceControlMeansStatus(airspaceControlMeansStatus: JsonField<List<AirspaceControlMeansStatus>>) =
                apply {
            ...
            fun addAirspaceControlMeansStatus(airspaceControlMeansStatus: AirspaceControlMeansStatus) =
                apply {
                    this.airspaceControlMeansStatus = (this.airspaceControlMeansStatus ?: JsonField.of(mutableListOf())).also {
                        checkKnown("airspaceControlMeansStatus", it).add(airspaceControlMeansStatus)
                    }
                }

            /** The airspaceControlReferences set provides both USMTF and non-USMTF references for this airspace control order. */
            fun airspaceControlOrderReferences(airspaceControlOrderReferences: List<AirspaceControlOrderReference>) = airspaceControlOrderReferences(JsonField.of(airspaceControlOrderReferences))

            /**
             * Sets [Builder.airspaceControlOrderReferences] to an arbitrary JSON value.
             *
             * You should usually call [Builder.airspaceControlOrderReferences] with a well-typed `List<AirspaceControlOrderReference>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun airspaceControlOrderReferences(airspaceControlOrderReferences: JsonField<List<AirspaceControlOrderReference>>) =
                apply {
                    this.airspaceControlOrderReferences = airspaceControlOrderReferences.map { it.toMutableList() }
                }
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addAirspaceControlOrderReference(airspaceControlOrderReference: AirspaceControlOrderReference) =
                apply {
                    airspaceControlOrderReferences = (airspaceControlOrderReferences ?: JsonField.of(mutableListOf())).also {
                        checkKnown("airspaceControlOrderReferences", it).add(airspaceControlOrderReference)
                    }
                }
             ...
             *
             * You should usually call [Builder.areaOfValidity] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun areaOfValidity(areaOfValidity: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.classReasons] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun classReasons(classReasons: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addClassReason(classReason: String) =
                apply {
                    classReasons = (classReasons ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.classSource] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun classSource(classSource: JsonField<String>) =
                apply {
            ...
            /** Coded entries that provide justification for exemption from automatic downgrading or declassification of the airspace control order. */
            fun declassExemptionCodes(declassExemptionCodes: List<String>) = declassExemptionCodes(JsonField.of(declassExemptionCodes))

            /**
             * Sets [Builder.declassExemptionCodes] to an arbitrary JSON value.
             *
             * You should usually call [Builder.declassExemptionCodes] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun declassExemptionCodes(declassExemptionCodes: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addDeclassExemptionCode(declassExemptionCode: String) =
                apply {
                    declassExemptionCodes = (declassExemptionCodes ?: JsonField.of(mutableListOf())).also {
                        checkKnown("declassExemptionCodes", it).add(declassExemptionCode)
                    }
                }

            /** Markings providing the literal guidance or date for downgrading or declassifying the airspace control order. */
            fun downgradeInsDates(downgradeInsDates: List<String>) = downgradeInsDates(JsonField.of(downgradeInsDates))

            /**
             * Sets [Builder.downgradeInsDates] to an arbitrary JSON value.
             *
             * You should usually call [Builder.downgradeInsDates] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun downgradeInsDates(downgradeInsDates: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addDowngradeInsDate(downgradeInsDate: String) =
                apply {
                    downgradeInsDates = (downgradeInsDates ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.geoDatum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun geoDatum(geoDatum: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.month] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun month(month: JsonField<String>) =
                apply {
                    this.month = month
                }
             ...
             *
             * You should usually call [Builder.opExInfo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun opExInfo(opExInfo: JsonField<String>) =
                apply {
                    this.opExInfo = opExInfo
                }
             ...
             *
             * You should usually call [Builder.opExInfoAlt] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun opExInfoAlt(opExInfoAlt: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.planOrigNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun planOrigNum(planOrigNum: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.qualifier] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun qualifier(qualifier: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.qualSn] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun qualSn(qualSn: JsonField<Int>) =
                apply {
                    this.qualSn = qualSn
                }
             ...
             *
             * You should usually call [Builder.serialNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun serialNum(serialNum: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.stopQualifier] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun stopQualifier(stopQualifier: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.stopTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun stopTime(stopTime: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.undLnkTrks] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun undLnkTrks(undLnkTrks: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addUndLnkTrk(undLnkTrk: String) =
                apply {
                    undLnkTrks = (undLnkTrks ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (opExName.asKnown().isPresent) 1 else 0) + (if (originator.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (acoComments.asKnown().isPresent) 1 else 0) + (if (acoSerialNum.asKnown().isPresent) 1 else 0) + (airspaceControlMeansStatus.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (airspaceControlOrderReferences.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (areaOfValidity.asKnown().isPresent) 1 else 0) + (classReasons.asKnown().getOrNull()?.size ?: 0) + (if (classSource.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (declassExemptionCodes.asKnown().getOrNull()?.size ?: 0) + (downgradeInsDates.asKnown().getOrNull()?.size ?: 0) + (if (geoDatum.asKnown().isPresent) 1 else 0) + (if (month.asKnown().isPresent) 1 else 0) + (if (opExInfo.asKnown().isPresent) 1 else 0) + (if (opExInfoAlt.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (planOrigNum.asKnown().isPresent) 1 else 0) + (if (qualifier.asKnown().isPresent) 1 else 0) + (if (qualSn.asKnown().isPresent) 1 else 0) + (if (rawFileUri.asKnown().isPresent) 1 else 0) + (if (serialNum.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (stopQualifier.asKnown().isPresent) 1 else 0) + (if (stopTime.asKnown().isPresent) 1 else 0) + (undLnkTrks.asKnown().getOrNull()?.size ?: 0)
        ...
        /** Mandatory nested segment to report multiple airspace control means statuses within an ACOID. */
        class AirspaceControlMeansStatus private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("airspaceControlMeans") @ExcludeMissing airspaceControlMeans: JsonField<List<AirspaceControlMean>> = JsonMissing.of(),
                @JsonProperty("cmStat") @ExcludeMissing cmStat: JsonField<String> = JsonMissing.of(),
                @JsonProperty("cmStatId") @ExcludeMissing cmStatId: JsonField<List<String>> = JsonMissing.of()
            ) : this(
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun airspaceControlMeans(): Optional<List<AirspaceControlMean>> = airspaceControlMeans.getOptional("airspaceControlMeans")
             ...
             *
             * Unlike [airspaceControlMeans], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            @JsonProperty("cmStat")
            @ExcludeMissing
            fun _cmStat(): JsonField<String> = cmStat
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [AirspaceControlMeansStatus]. */
                @JvmStatic
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(airspaceControlMeansStatus: AirspaceControlMeansStatus) =
                    apply {
                        airspaceControlMeans = airspaceControlMeansStatus.airspaceControlMeans.map { it.toMutableList() }
                        cmStat = airspaceControlMeansStatus.cmStat
                        cmStatId = airspaceControlMeansStatus.cmStatId.map { it.toMutableList() }
                        additionalProperties = airspaceControlMeansStatus.additionalProperties.toMutableMap()
                    }

                /** A conditional nested segment to report multiple airspace control means within a particular airspace control means status. */
                fun airspaceControlMeans(airspaceControlMeans: List<AirspaceControlMean>) = airspaceControlMeans(JsonField.of(airspaceControlMeans))

                /**
                 * Sets [Builder.airspaceControlMeans] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.airspaceControlMeans] with a well-typed `List<AirspaceControlMean>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addAirspaceControlMean(airspaceControlMean: AirspaceControlMean) =
                    apply {
                        airspaceControlMeans = (airspaceControlMeans ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.cmStat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun cmStat(cmStat: JsonField<String>) =
                    apply {
                        this.cmStat = cmStat
                    }
                 ...
                 *
                 * You should usually call [Builder.cmStatId] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun cmStatId(cmStatId: JsonField<List<String>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addCmStatId(cmStatId: String) =
                    apply {
                        this.cmStatId = (this.cmStatId ?: JsonField.of(mutableListOf())).also {
            ...
            fun validate(): AirspaceControlMeansStatus =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (airspaceControlMeans.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (cmStat.asKnown().isPresent) 1 else 0) + (cmStatId.asKnown().getOrNull()?.size ?: 0)

            /** A conditional nested segment to report multiple airspace control means within a particular airspace control means status. */
            class AirspaceControlMean private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("airspaceControlPoint") @ExcludeMissing airspaceControlPoint: JsonField<List<AirspaceControlPoint>> = JsonMissing.of(),
                    @JsonProperty("airspaceTimePeriod") @ExcludeMissing airspaceTimePeriod: JsonField<List<AirspaceTimePeriod>> = JsonMissing.of(),
                    @JsonProperty("bearing0") @ExcludeMissing bearing0: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("bearing1") @ExcludeMissing bearing1: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("cmId") @ExcludeMissing cmId: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("cmShape") @ExcludeMissing cmShape: JsonField<CmShape> = JsonMissing.of(),
                    @JsonProperty("cmType") @ExcludeMissing cmType: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("cntrlAuth") @ExcludeMissing cntrlAuth: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("cntrlAuthFreqs") @ExcludeMissing cntrlAuthFreqs: JsonField<List<String>> = JsonMissing.of(),
                    @JsonProperty("coord0") @ExcludeMissing coord0: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("coord1") @ExcludeMissing coord1: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("corrWayPoints") @ExcludeMissing corrWayPoints: JsonField<List<String>> = JsonMissing.of(),
                    @JsonProperty("effVDim") @ExcludeMissing effVDim: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("freeText") @ExcludeMissing freeText: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("genTextInd") @ExcludeMissing genTextInd: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("geoDatumAlt") @ExcludeMissing geoDatumAlt: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("link16Id") @ExcludeMissing link16Id: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("orbitAlignment") @ExcludeMissing orbitAlignment: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("polyCoord") @ExcludeMissing polyCoord: JsonField<List<String>> = JsonMissing.of(),
                    @JsonProperty("radMag0") @ExcludeMissing radMag0: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("radMag1") @ExcludeMissing radMag1: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("radMagUnit") @ExcludeMissing radMagUnit: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("trackLeg") @ExcludeMissing trackLeg: JsonField<Int> = JsonMissing.of(),
                    @JsonProperty("transAltitude") @ExcludeMissing transAltitude: JsonField<String> = JsonMissing.of(),
                    ...
                    @JsonProperty("widthLeft") @ExcludeMissing widthLeft: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("widthRight") @ExcludeMissing widthRight: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("widthUnit") @ExcludeMissing widthUnit: JsonField<String> = JsonMissing.of()
                ) : this(
                 ...
                 * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun airspaceControlPoint(): Optional<List<AirspaceControlPoint>> = airspaceControlPoint.getOptional("airspaceControlPoint")
                 ...
                 * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun airspaceTimePeriod(): Optional<List<AirspaceTimePeriod>> = airspaceTimePeriod.getOptional("airspaceTimePeriod")
                 ...
                 * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun cntrlAuthFreqs(): Optional<List<String>> = cntrlAuthFreqs.getOptional("cntrlAuthFreqs")
                 ...
                 *
                 * Unlike [airspaceControlPoint], this method doesn't throw if the JSON field has an unexpected type.
                 */
                @JsonProperty("airspaceControlPoint")
                @ExcludeMissing
                fun _airspaceControlPoint(): JsonField<List<AirspaceControlPoint>> = airspaceControlPoint

                /**
                 * Returns the raw JSON value of [airspaceTimePeriod].
                 *
                 * Unlike [airspaceTimePeriod], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [bearing0], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [bearing1], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                @JsonProperty("cmId")
                @ExcludeMissing
                fun _cmId(): JsonField<String> = cmId
                ...
                @JsonProperty("cmType")
                @ExcludeMissing
                fun _cmType(): JsonField<String> = cmType

                /**
                 * Returns the raw JSON value of [cntrlAuth].
                 *
                 * Unlike [cntrlAuth], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [cntrlAuthFreqs], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                @JsonProperty("coord0")
                @ExcludeMissing
                fun _coord0(): JsonField<String> = coord0
                ...
                @JsonProperty("coord1")
                @ExcludeMissing
                fun _coord1(): JsonField<String> = coord1

                /**
                 * Returns the raw JSON value of [corrWayPoints].
                 *
                 * Unlike [corrWayPoints], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                @ExcludeMissing
                fun _effVDim(): JsonField<String> = effVDim

                /**
                 * Returns the raw JSON value of [freeText].
                 *
                 * Unlike [freeText], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [genTextInd], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [geoDatumAlt], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [link16Id], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [orbitAlignment], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [polyCoord], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                @ExcludeMissing
                fun _radMag0(): JsonField<Double> = radMag0
                ...
                @ExcludeMissing
                fun _radMag1(): JsonField<Double> = radMag1

                /**
                 * Returns the raw JSON value of [radMagUnit].
                 *
                 * Unlike [radMagUnit], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [trackLeg], this method doesn't throw if the JSON field has an unexpected type.
                 */
                @JsonProperty("trackLeg")
                @ExcludeMissing
                fun _trackLeg(): JsonField<Int> = trackLeg

                /**
                 * Returns the raw JSON value of [transAltitude].
                 *
                 * Unlike [transAltitude], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [widthLeft], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [widthRight], this method doesn't throw if the JSON field has an unexpected type.
                 */
                 ...
                 *
                 * Unlike [widthUnit], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                class Builder internal constructor() {
                    ...
                    private var airspaceControlPoint: JsonField<MutableList<AirspaceControlPoint>>? = null
                    ...
                    @JvmSynthetic
                    internal fun from(airspaceControlMean: AirspaceControlMean) =
                        apply {
                            airspaceControlPoint = airspaceControlMean.airspaceControlPoint.map { it.toMutableList() }
                            airspaceTimePeriod = airspaceControlMean.airspaceTimePeriod.map { it.toMutableList() }
                    ...
                    /** The controlPoint set describes any reference/controlling/rendezvous point for a given airspace control means. */
                    fun airspaceControlPoint(airspaceControlPoint: List<AirspaceControlPoint>) = airspaceControlPoint(JsonField.of(airspaceControlPoint))

                    /**
                     * Sets [Builder.airspaceControlPoint] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.airspaceControlPoint] with a well-typed `List<AirspaceControlPoint>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun airspaceControlPoint(airspaceControlPoint: JsonField<List<AirspaceControlPoint>>) =
                        apply {
                    ...
                    fun addAirspaceControlPoint(airspaceControlPoint: AirspaceControlPoint) =
                        apply {
                            this.airspaceControlPoint = (this.airspaceControlPoint ?: JsonField.of(mutableListOf())).also {
                                checkKnown("airspaceControlPoint", it).add(airspaceControlPoint)
                            }
                        }

                    /** The timePeriods set describes the effective datetime for a given airspace control means. */
                    fun airspaceTimePeriod(airspaceTimePeriod: List<AirspaceTimePeriod>) = airspaceTimePeriod(JsonField.of(airspaceTimePeriod))

                    /**
                     * Sets [Builder.airspaceTimePeriod] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.airspaceTimePeriod] with a well-typed `List<AirspaceTimePeriod>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addAirspaceTimePeriod(airspaceTimePeriod: AirspaceTimePeriod) =
                        apply {
                            this.airspaceTimePeriod = (this.airspaceTimePeriod ?: JsonField.of(mutableListOf())).also {
                     ...
                     *
                     * You should usually call [Builder.bearing0] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun bearing0(bearing0: JsonField<Double>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.bearing1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun bearing1(bearing1: JsonField<Double>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.cmId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun cmId(cmId: JsonField<String>) =
                        apply {
                            this.cmId = cmId
                        }
                     ...
                     *
                     * You should usually call [Builder.cmShape] with a well-typed [CmShape] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun cmShape(cmShape: JsonField<CmShape>) =
                        apply {
                            this.cmShape = cmShape
                        }
                     ...
                     *
                     * You should usually call [Builder.cmType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun cmType(cmType: JsonField<String>) =
                        apply {
                            this.cmType = cmType
                        }
                     ...
                     *
                     * You should usually call [Builder.cntrlAuth] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun cntrlAuth(cntrlAuth: JsonField<String>) =
                        apply {
                            this.cntrlAuth = cntrlAuth
                        }

                    /** The frequency for the airspace control authority. Can specify HZ, KHZ, MHZ, GHZ or a DESIG frequency designator code. */
                    fun cntrlAuthFreqs(cntrlAuthFreqs: List<String>) = cntrlAuthFreqs(JsonField.of(cntrlAuthFreqs))

                    /**
                     * Sets [Builder.cntrlAuthFreqs] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.cntrlAuthFreqs] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun cntrlAuthFreqs(cntrlAuthFreqs: JsonField<List<String>>) =
                        apply {
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addCntrlAuthFreq(cntrlAuthFreq: String) =
                        apply {
                            cntrlAuthFreqs = (cntrlAuthFreqs ?: JsonField.of(mutableListOf())).also {
                     ...
                     *
                     * You should usually call [Builder.coord0] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun coord0(coord0: JsonField<String>) =
                        apply {
                            this.coord0 = coord0
                        }
                     ...
                     *
                     * You should usually call [Builder.coord1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun coord1(coord1: JsonField<String>) =
                        apply {
                            this.coord1 = coord1
                        }

                    /** An array of at least two alphanumeric symbols used to serially identify the corridor waypoints. If cmShape is set to "CORRIDOR", one of either corrWayPoints or polyCoord is required to specify the centerline of the corridor path. */
                    fun corrWayPoints(corrWayPoints: List<String>) = corrWayPoints(JsonField.of(corrWayPoints))

                    /**
                     * Sets [Builder.corrWayPoints] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.corrWayPoints] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun corrWayPoints(corrWayPoints: JsonField<List<String>>) =
                        apply {
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addCorrWayPoint(corrWayPoint: String) =
                        apply {
                            corrWayPoints = (corrWayPoints ?: JsonField.of(mutableListOf())).also {
                     ...
                     *
                     * You should usually call [Builder.effVDim] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun effVDim(effVDim: JsonField<String>) =
                        apply {
                            this.effVDim = effVDim
                        }
                     ...
                     *
                     * You should usually call [Builder.freeText] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun freeText(freeText: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.genTextInd] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun genTextInd(genTextInd: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.geoDatumAlt] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun geoDatumAlt(geoDatumAlt: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.link16Id] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun link16Id(link16Id: JsonField<String>) =
                        apply {
                            this.link16Id = link16Id
                        }

                    /** Orbit alignment look-up code. Can be C=Center, L=Left, R=Right. */
                    fun orbitAlignment(orbitAlignment: String) = orbitAlignment(JsonField.of(orbitAlignment))

                    /**
                     * Sets [Builder.orbitAlignment] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.orbitAlignment] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun orbitAlignment(orbitAlignment: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.polyCoord] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun polyCoord(polyCoord: JsonField<List<String>>) =
                        apply {
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addPolyCoord(polyCoord: String) =
                        apply {
                            this.polyCoord = (this.polyCoord ?: JsonField.of(mutableListOf())).also {
                     ...
                     *
                     * You should usually call [Builder.radMag0] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun radMag0(radMag0: JsonField<Double>) =
                        apply {
                            this.radMag0 = radMag0
                        }
                     ...
                     *
                     * You should usually call [Builder.radMag1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun radMag1(radMag1: JsonField<Double>) =
                        apply {
                            this.radMag1 = radMag1
                        }
                     ...
                     *
                     * You should usually call [Builder.radMagUnit] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun radMagUnit(radMagUnit: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.trackLeg] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun trackLeg(trackLeg: JsonField<Int>) =
                        apply {
                            this.trackLeg = trackLeg
                        }

                    /** The altitude at or below which the vertical position of an aircraft is controlled by reference to true altitude. */
                    fun transAltitude(transAltitude: String) = transAltitude(JsonField.of(transAltitude))

                    /**
                     * Sets [Builder.transAltitude] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.transAltitude] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun transAltitude(transAltitude: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.widthLeft] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun widthLeft(widthLeft: JsonField<Double>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.widthRight] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun widthRight(widthRight: JsonField<Double>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.widthUnit] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun widthUnit(widthUnit: JsonField<String>) =
                        apply {
                ...
                fun validate(): AirspaceControlMean =
                    apply {
                        if (validated) {
                          return@apply
                        }
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (airspaceControlPoint.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (airspaceTimePeriod.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (bearing0.asKnown().isPresent) 1 else 0) + (if (bearing1.asKnown().isPresent) 1 else 0) + (if (cmId.asKnown().isPresent) 1 else 0) + (cmShape.asKnown().getOrNull()?.validity() ?: 0) + (if (cmType.asKnown().isPresent) 1 else 0) + (if (cntrlAuth.asKnown().isPresent) 1 else 0) + (cntrlAuthFreqs.asKnown().getOrNull()?.size ?: 0) + (if (coord0.asKnown().isPresent) 1 else 0) + (if (coord1.asKnown().isPresent) 1 else 0) + (corrWayPoints.asKnown().getOrNull()?.size ?: 0) + (if (effVDim.asKnown().isPresent) 1 else 0) + (if (freeText.asKnown().isPresent) 1 else 0) + (if (genTextInd.asKnown().isPresent) 1 else 0) + (if (geoDatumAlt.asKnown().isPresent) 1 else 0) + (if (link16Id.asKnown().isPresent) 1 else 0) + (if (orbitAlignment.asKnown().isPresent) 1 else 0) + (polyCoord.asKnown().getOrNull()?.size ?: 0) + (if (radMag0.asKnown().isPresent) 1 else 0) + (if (radMag1.asKnown().isPresent) 1 else 0) + (if (radMagUnit.asKnown().isPresent) 1 else 0) + (if (trackLeg.asKnown().isPresent) 1 else 0) + (if (transAltitude.asKnown().isPresent) 1 else 0) + (if (usage.asKnown().isPresent) 1 else 0) + (if (width.asKnown().isPresent) 1 else 0) + (if (widthLeft.asKnown().isPresent) 1 else 0) + (if (widthRight.asKnown().isPresent) 1 else 0) + (if (widthUnit.asKnown().isPresent) 1 else 0)

                /** The controlPoint set describes any reference/controlling/rendezvous point for a given airspace control means. */
                class AirspaceControlPoint private constructor(
                    ...
                    @JsonCreator
                    private constructor(
                        @JsonProperty("ctrlPtAltitude") @ExcludeMissing ctrlPtAltitude: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("ctrlPtLocation") @ExcludeMissing ctrlPtLocation: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("ctrlPtName") @ExcludeMissing ctrlPtName: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("ctrlPtType") @ExcludeMissing ctrlPtType: JsonField<String> = JsonMissing.of()
                    ) : this(
                      ctrlPtAltitude,
                      ctrlPtLocation,
                      ctrlPtName,
                     ...
                     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                     */
                    fun ctrlPtAltitude(): Optional<String> = ctrlPtAltitude.getOptional("ctrlPtAltitude")
                     ...
                     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                     */
                    fun ctrlPtLocation(): Optional<String> = ctrlPtLocation.getOptional("ctrlPtLocation")
                     ...
                     *
                     * Unlike [ctrlPtAltitude], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [ctrlPtLocation], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [ctrlPtName], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [ctrlPtType], this method doesn't throw if the JSON field has an unexpected type.
                     */
                    ...
                    companion object {
                        ...
                        /** Returns a mutable builder for constructing an instance of [AirspaceControlPoint]. */
                        @JvmStatic
                        fun builder() = Builder()
                    }
                    ...
                    class Builder internal constructor() {
                        ...
                        @JvmSynthetic
                        internal fun from(airspaceControlPoint: AirspaceControlPoint) =
                            apply {
                                ...
                                additionalProperties = airspaceControlPoint.additionalProperties.toMutableMap()
                            }

                        /** The altitude of the control point. */
                        fun ctrlPtAltitude(ctrlPtAltitude: String) = ctrlPtAltitude(JsonField.of(ctrlPtAltitude))

                        /**
                         * Sets [Builder.ctrlPtAltitude] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.ctrlPtAltitude] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun ctrlPtAltitude(ctrlPtAltitude: JsonField<String>) =
                            apply {
                                this.ctrlPtAltitude = ctrlPtAltitude
                            }

                        /** A geospatial point coordinate specified in DMS (Degrees, Minutes, Seconds) format that represents the location of the control point. */
                        fun ctrlPtLocation(ctrlPtLocation: String) = ctrlPtLocation(JsonField.of(ctrlPtLocation))

                        /**
                         * Sets [Builder.ctrlPtLocation] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.ctrlPtLocation] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun ctrlPtLocation(ctrlPtLocation: JsonField<String>) =
                            apply {
                         ...
                         *
                         * You should usually call [Builder.ctrlPtName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun ctrlPtName(ctrlPtName: JsonField<String>) =
                            apply {
                         ...
                         *
                         * You should usually call [Builder.ctrlPtType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun ctrlPtType(ctrlPtType: JsonField<String>) =
                            apply {
                    ...
                    fun validate(): AirspaceControlPoint =
                        apply {
                            if (validated) {
                              return@apply
                            }
                     ...
                     */
                    @JvmSynthetic
                    internal fun validity(): Int = (if (ctrlPtAltitude.asKnown().isPresent) 1 else 0) + (if (ctrlPtLocation.asKnown().isPresent) 1 else 0) + (if (ctrlPtName.asKnown().isPresent) 1 else 0) + (if (ctrlPtType.asKnown().isPresent) 1 else 0)
                    ...
                    override fun toString() = "AirspaceControlPoint{ctrlPtAltitude=$ctrlPtAltitude, ctrlPtLocation=$ctrlPtLocation, ctrlPtName=$ctrlPtName, ctrlPtType=$ctrlPtType, additionalProperties=$additionalProperties}"
                }

                /** The timePeriods set describes the effective datetime for a given airspace control means. */
                class AirspaceTimePeriod private constructor(
                    ...
                    @JsonCreator
                    private constructor(
                        @JsonProperty("intDur") @ExcludeMissing intDur: JsonField<List<String>> = JsonMissing.of(),
                        @JsonProperty("intFreq") @ExcludeMissing intFreq: JsonField<List<String>> = JsonMissing.of(),
                        @JsonProperty("timeEnd") @ExcludeMissing timeEnd: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("timeMode") @ExcludeMissing timeMode: JsonField<String> = JsonMissing.of(),
                        @JsonProperty("timeStart") @ExcludeMissing timeStart: JsonField<String> = JsonMissing.of()
                    ) : this(
                      intDur,
                      intFreq,
                      timeEnd,
                     ...
                     *
                     * Unlike [intDur], this method doesn't throw if the JSON field has an unexpected type.
                     */
                    @JsonProperty("intDur")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [intFreq], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [timeEnd], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [timeMode], this method doesn't throw if the JSON field has an unexpected type.
                     */
                     ...
                     *
                     * Unlike [timeStart], this method doesn't throw if the JSON field has an unexpected type.
                     */
                    ...
                    companion object {
                        ...
                        /** Returns a mutable builder for constructing an instance of [AirspaceTimePeriod]. */
                        @JvmStatic
                        fun builder() = Builder()
                    }
                    ...
                    class Builder internal constructor() {
                        ...
                        @JvmSynthetic
                        internal fun from(airspaceTimePeriod: AirspaceTimePeriod) =
                            apply {
                                ...
                                additionalProperties = airspaceTimePeriod.additionalProperties.toMutableMap()
                            }
                         ...
                         *
                         * You should usually call [Builder.intDur] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun intDur(intDur: JsonField<List<String>>) =
                            apply {
                         ...
                         * @throws IllegalStateException if the field was previously set to a non-list.
                         */
                        fun addIntDur(intDur: String) =
                            apply {
                                this.intDur = (this.intDur ?: JsonField.of(mutableListOf())).also {
                         ...
                         *
                         * You should usually call [Builder.intFreq] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun intFreq(intFreq: JsonField<List<String>>) =
                            apply {
                         ...
                         * @throws IllegalStateException if the field was previously set to a non-list.
                         */
                        fun addIntFreq(intFreq: String) =
                            apply {
                                this.intFreq = (this.intFreq ?: JsonField.of(mutableListOf())).also {
                         ...
                         *
                         * You should usually call [Builder.timeEnd] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun timeEnd(timeEnd: JsonField<String>) =
                            apply {
                         ...
                         *
                         * You should usually call [Builder.timeMode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun timeMode(timeMode: JsonField<String>) =
                            apply {
                         ...
                         *
                         * You should usually call [Builder.timeStart] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                         * supported value.
                         */
                        fun timeStart(timeStart: JsonField<String>) =
                            apply {
                    ...
                    fun validate(): AirspaceTimePeriod =
                        apply {
                            if (validated) {
                              return@apply
                            }
                     ...
                     */
                    @JvmSynthetic
                    internal fun validity(): Int = (intDur.asKnown().getOrNull()?.size ?: 0) + (intFreq.asKnown().getOrNull()?.size ?: 0) + (if (timeEnd.asKnown().isPresent) 1 else 0) + (if (timeMode.asKnown().isPresent) 1 else 0) + (if (timeStart.asKnown().isPresent) 1 else 0)
                    ...
                    override fun toString() = "AirspaceTimePeriod{intDur=$intDur, intFreq=$intFreq, timeEnd=$timeEnd, timeMode=$timeMode, timeStart=$timeStart, additionalProperties=$additionalProperties}"
                }

                /** Designates the geometric type that defines the airspace shape. One of CIRCLE, CORRIDOR, LINE, ORBIT, etc. */
                class CmShape @JsonCreator private constructor(
                    private val value: JsonField<String>,
                    ...
                    enum class Value {
                        ...
                        AORBIT,
                        GEOLINE,
                        /** An enum member indicating that [CmShape] was instantiated with an unknown value. */
                        _UNKNOWN,
                    }
                    ...
                    fun known(): Known =
                        when (this) {
                            ...
                            else -> throw UnifieddatalibraryInvalidDataException("Unknown CmShape: $value")
                        }
            ...
            override fun toString() = "AirspaceControlMeansStatus{airspaceControlMeans=$airspaceControlMeans, cmStat=$cmStat, cmStatId=$cmStatId, additionalProperties=$additionalProperties}"
        }

        /** The airspaceControlReferences set provides both USMTF and non-USMTF references for this airspace control order. */
        class AirspaceControlOrderReference private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("refOriginator") @ExcludeMissing refOriginator: JsonField<String> = JsonMissing.of(),
                @JsonProperty("refSerialNum") @ExcludeMissing refSerialNum: JsonField<String> = JsonMissing.of(),
                @JsonProperty("refSICs") @ExcludeMissing refSiCs: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("refSId") @ExcludeMissing refSId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("refSpecialNotation") @ExcludeMissing refSpecialNotation: JsonField<String> = JsonMissing.of(),
                @JsonProperty("refTs") @ExcludeMissing refTs: JsonField<OffsetDateTime> = JsonMissing.of(),
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun refSpecialNotation(): Optional<String> = refSpecialNotation.getOptional("refSpecialNotation")
             ...
             *
             * Unlike [refOriginator], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [refSerialNum], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            @JsonProperty("refSId")
            @ExcludeMissing
            fun _refSId(): JsonField<String> = refSId

            /**
             * Returns the raw JSON value of [refSpecialNotation].
             *
             * Unlike [refSpecialNotation], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            @JsonProperty("refTs")
            @ExcludeMissing
            fun _refTs(): JsonField<OffsetDateTime> = refTs
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [AirspaceControlOrderReference]. */
                @JvmStatic
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(airspaceControlOrderReference: AirspaceControlOrderReference) =
                    apply {
                        ...
                        additionalProperties = airspaceControlOrderReference.additionalProperties.toMutableMap()
                    }
                 ...
                 *
                 * You should usually call [Builder.refOriginator] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun refOriginator(refOriginator: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.refSerialNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun refSerialNum(refSerialNum: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.refSiCs] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun refSiCs(refSiCs: JsonField<List<String>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addRefSiC(refSiC: String) =
                    apply {
                        refSiCs = (refSiCs ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.refSId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun refSId(refSId: JsonField<String>) =
                    apply {
                        this.refSId = refSId
                    }

                /** Indicates any special actions, restrictions, guidance, or information relating to this reference. */
                fun refSpecialNotation(refSpecialNotation: String) = refSpecialNotation(JsonField.of(refSpecialNotation))

                /**
                 * Sets [Builder.refSpecialNotation] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.refSpecialNotation] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun refSpecialNotation(refSpecialNotation: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.refTs] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun refTs(refTs: JsonField<OffsetDateTime>) =
                    apply {
                        this.refTs = refTs
                    }
            ...
            fun validate(): AirspaceControlOrderReference =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (refOriginator.asKnown().isPresent) 1 else 0) + (if (refSerialNum.asKnown().isPresent) 1 else 0) + (refSiCs.asKnown().getOrNull()?.size ?: 0) + (if (refSId.asKnown().isPresent) 1 else 0) + (if (refSpecialNotation.asKnown().isPresent) 1 else 0) + (if (refTs.asKnown().isPresent) 1 else 0) + (if (refType.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() = "AirspaceControlOrderReference{refOriginator=$refOriginator, refSerialNum=$refSerialNum, refSiCs=$refSiCs, refSId=$refSId, refSpecialNotation=$refSpecialNotation, refTs=$refTs, refType=$refType, additionalProperties=$additionalProperties}"
        }
    ...
    override fun toString() = "AirspaceControlOrderUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
