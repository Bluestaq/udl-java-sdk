...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteListParams: SiteListParams) = apply {
    ...
    override fun toString() =
        "SiteListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
