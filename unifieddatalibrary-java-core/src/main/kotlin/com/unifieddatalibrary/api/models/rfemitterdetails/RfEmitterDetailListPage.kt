...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailListPage: RfEmitterDetailListPage) = apply {
            service = rfEmitterDetailListPage.service
            params = rfEmitterDetailListPage.params
            items = rfEmitterDetailListPage.items
        }

        fun service(service: RfEmitterDetailService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RfEmitterDetailListPage &&
    ...
    override fun toString() =
        "RfEmitterDetailListPage{service=$service, params=$params, items=$items}"
}
