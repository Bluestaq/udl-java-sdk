...
class ObscorrelationQueryHelpResponse
...
private constructor(
    ...
    /** A builder for [ObscorrelationQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(obscorrelationQueryHelpResponse: ObscorrelationQueryHelpResponse) =
            apply {
                aodrSupported = obscorrelationQueryHelpResponse.aodrSupported
                classificationMarking = obscorrelationQueryHelpResponse.classificationMarking
                description = obscorrelationQueryHelpResponse.description
                historySupported = obscorrelationQueryHelpResponse.historySupported
                name = obscorrelationQueryHelpResponse.name
                parameters = obscorrelationQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    obscorrelationQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = obscorrelationQueryHelpResponse.restSupported
                sortSupported = obscorrelationQueryHelpResponse.sortSupported
                typeName = obscorrelationQueryHelpResponse.typeName
                uri = obscorrelationQueryHelpResponse.uri
                additionalProperties =
                    obscorrelationQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ObscorrelationQueryHelpResponse =
            ObscorrelationQueryHelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): ObscorrelationQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationQueryHelpResponse &&
