...
class OnorbitlistQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistQueryhelpResponse: OnorbitlistQueryhelpResponse) = apply {
    ...
    fun validate(): OnorbitlistQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
