...
class OnorbitlistQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OnorbitlistQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OnorbitlistQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistQueryhelpResponse: OnorbitlistQueryhelpResponse) =
            apply {
                aodrSupported = onorbitlistQueryhelpResponse.aodrSupported
                classificationMarking = onorbitlistQueryhelpResponse.classificationMarking
                description = onorbitlistQueryhelpResponse.description
                historySupported = onorbitlistQueryhelpResponse.historySupported
                name = onorbitlistQueryhelpResponse.name
                parameters = onorbitlistQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = onorbitlistQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = onorbitlistQueryhelpResponse.restSupported
                sortSupported = onorbitlistQueryhelpResponse.sortSupported
                typeName = onorbitlistQueryhelpResponse.typeName
                uri = onorbitlistQueryhelpResponse.uri
                additionalProperties = onorbitlistQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitlistQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitlistQueryhelpResponse =
    ...
    fun validate(): OnorbitlistQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitlistQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
