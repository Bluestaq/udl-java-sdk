...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpedrCountParams].
         *
    ...
    /** A builder for [EcpedrCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpedrCountParams: EcpedrCountParams) = apply {
            obTime = ecpedrCountParams.obTime
            firstResult = ecpedrCountParams.firstResult
            maxResults = ecpedrCountParams.maxResults
            additionalHeaders = ecpedrCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = ecpedrCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EcpedrCountParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EcpedrCountParams &&
            obTime == other.obTime &&
    ...
    override fun toString() =
        "EcpedrCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
