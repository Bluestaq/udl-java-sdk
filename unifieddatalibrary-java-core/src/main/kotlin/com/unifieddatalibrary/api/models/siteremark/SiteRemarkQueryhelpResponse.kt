...
class SiteRemarkQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SiteRemarkQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SiteRemarkQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkQueryhelpResponse: SiteRemarkQueryhelpResponse) =
            apply {
                aodrSupported = siteRemarkQueryhelpResponse.aodrSupported
                classificationMarking = siteRemarkQueryhelpResponse.classificationMarking
                description = siteRemarkQueryhelpResponse.description
                historySupported = siteRemarkQueryhelpResponse.historySupported
                name = siteRemarkQueryhelpResponse.name
                parameters = siteRemarkQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = siteRemarkQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = siteRemarkQueryhelpResponse.restSupported
                sortSupported = siteRemarkQueryhelpResponse.sortSupported
                typeName = siteRemarkQueryhelpResponse.typeName
                uri = siteRemarkQueryhelpResponse.uri
                additionalProperties = siteRemarkQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SiteRemarkQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SiteRemarkQueryhelpResponse =
    ...
    fun validate(): SiteRemarkQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteRemarkQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
