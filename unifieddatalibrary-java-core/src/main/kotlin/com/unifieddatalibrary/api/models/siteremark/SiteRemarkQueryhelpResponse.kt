...
class SiteRemarkQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkQueryhelpResponse: SiteRemarkQueryhelpResponse) = apply {
    ...
    fun validate(): SiteRemarkQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
