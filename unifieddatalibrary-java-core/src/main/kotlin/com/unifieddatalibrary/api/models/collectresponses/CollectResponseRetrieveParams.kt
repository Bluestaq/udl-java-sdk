 ...
 * parameter.
 */
class CollectResponseRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CollectResponseRetrieveParams = builder().build()
    ...
    /** A builder for [CollectResponseRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectResponseRetrieveParams: CollectResponseRetrieveParams) = apply {
            id = collectResponseRetrieveParams.id
            firstResult = collectResponseRetrieveParams.firstResult
            maxResults = collectResponseRetrieveParams.maxResults
            additionalHeaders = collectResponseRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = collectResponseRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CollectResponseRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CollectResponseRetrieveParams =
            CollectResponseRetrieveParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CollectResponseRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "CollectResponseRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
