...
class AirfieldslotAbridged private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("airfieldName") @ExcludeMissing airfieldName: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("acSlotCat") @ExcludeMissing acSlotCat: JsonField<AcSlotCat> = JsonMissing.of(),
        ...
        @JsonProperty("minSeparation") @ExcludeMissing minSeparation: JsonField<Int> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _capacity(): JsonField<Int> = capacity
    ...
    @ExcludeMissing
    fun _endTime(): JsonField<String> = endTime
    ...
    @ExcludeMissing
    fun _startTime(): JsonField<String> = startTime
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldslotAbridged: AirfieldslotAbridged) =
            apply {
         ...
         *
         * You should usually call [Builder.airfieldName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun airfieldName(airfieldName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.acSlotCat] with a well-typed [AcSlotCat] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun acSlotCat(acSlotCat: JsonField<AcSlotCat>) =
            apply {
                this.acSlotCat = acSlotCat
            }
         ...
         *
         * You should usually call [Builder.capacity] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun capacity(capacity: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.endTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun endTime(endTime: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.minSeparation] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun minSeparation(minSeparation: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.startTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun startTime(startTime: JsonField<String>) =
            apply {
    ...
    fun validate(): AirfieldslotAbridged =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (airfieldName.asKnown().isPresent) 1 else 0) + (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (acSlotCat.asKnown().getOrNull()?.validity() ?: 0) + (if (altAirfieldId.asKnown().isPresent) 1 else 0) + (if (capacity.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (icao.asKnown().isPresent) 1 else 0) + (if (idAirfield.asKnown().isPresent) 1 else 0) + (if (minSeparation.asKnown().isPresent) 1 else 0) + (if (notes.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0)
    ...
    /** Largest category of aircraft supported in this slot (WIDE, NARROW, HELO, ALL, OTHER). */
    class AcSlotCat @JsonCreator private constructor(
        private val value: JsonField<String>,
