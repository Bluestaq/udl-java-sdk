...
class OnboardnavigationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OnboardnavigationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OnboardnavigationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationQueryhelpResponse: OnboardnavigationQueryhelpResponse) =
            apply {
                aodrSupported = onboardnavigationQueryhelpResponse.aodrSupported
                classificationMarking = onboardnavigationQueryhelpResponse.classificationMarking
                description = onboardnavigationQueryhelpResponse.description
                historySupported = onboardnavigationQueryhelpResponse.historySupported
                name = onboardnavigationQueryhelpResponse.name
                parameters = onboardnavigationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = onboardnavigationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = onboardnavigationQueryhelpResponse.restSupported
                sortSupported = onboardnavigationQueryhelpResponse.sortSupported
                typeName = onboardnavigationQueryhelpResponse.typeName
                uri = onboardnavigationQueryhelpResponse.uri
                additionalProperties = onboardnavigationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OnboardnavigationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnboardnavigationQueryhelpResponse =
    ...
    fun validate(): OnboardnavigationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
