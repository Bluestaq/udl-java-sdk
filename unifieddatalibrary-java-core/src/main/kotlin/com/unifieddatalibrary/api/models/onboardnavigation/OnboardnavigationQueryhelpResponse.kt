...
class OnboardnavigationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(onboardnavigationQueryhelpResponse: OnboardnavigationQueryhelpResponse) =
            apply {
                ...
                parameters =
                    onboardnavigationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    onboardnavigationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    onboardnavigationQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): OnboardnavigationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
