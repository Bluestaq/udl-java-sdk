 ...
 */
class FeatureAssessmentTupleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeatureAssessmentTupleParams].
         *
    ...
    /** A builder for [FeatureAssessmentTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentTupleParams: FeatureAssessmentTupleParams) = apply {
            columns = featureAssessmentTupleParams.columns
            idAnalyticImagery = featureAssessmentTupleParams.idAnalyticImagery
            firstResult = featureAssessmentTupleParams.firstResult
            maxResults = featureAssessmentTupleParams.maxResults
            additionalHeaders = featureAssessmentTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = featureAssessmentTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentTupleParams].
         *
         ...
         */
        fun build(): FeatureAssessmentTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FeatureAssessmentTupleParams && columns == other.columns && idAnalyticImagery == other.idAnalyticImagery && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, idAnalyticImagery, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "FeatureAssessmentTupleParams{columns=$columns, idAnalyticImagery=$idAnalyticImagery, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
