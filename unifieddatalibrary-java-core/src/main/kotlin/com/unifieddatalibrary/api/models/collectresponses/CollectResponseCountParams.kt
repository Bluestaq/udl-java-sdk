 ...
 */
class CollectResponseCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectResponseCountParams].
         *
    ...
    /** A builder for [CollectResponseCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectResponseCountParams: CollectResponseCountParams) = apply {
            createdAt = collectResponseCountParams.createdAt
            firstResult = collectResponseCountParams.firstResult
            maxResults = collectResponseCountParams.maxResults
            additionalHeaders = collectResponseCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = collectResponseCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CollectResponseCountParams].
         *
         ...
         */
        fun build(): CollectResponseCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CollectResponseCountParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "CollectResponseCountParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
