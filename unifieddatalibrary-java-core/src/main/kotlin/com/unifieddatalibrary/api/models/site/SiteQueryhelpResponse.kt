...
class SiteQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SiteQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SiteQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteQueryhelpResponse: SiteQueryhelpResponse) =
            apply {
                aodrSupported = siteQueryhelpResponse.aodrSupported
                classificationMarking = siteQueryhelpResponse.classificationMarking
                description = siteQueryhelpResponse.description
                historySupported = siteQueryhelpResponse.historySupported
                name = siteQueryhelpResponse.name
                parameters = siteQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = siteQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = siteQueryhelpResponse.restSupported
                sortSupported = siteQueryhelpResponse.sortSupported
                typeName = siteQueryhelpResponse.typeName
                uri = siteQueryhelpResponse.uri
                additionalProperties = siteQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SiteQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SiteQueryhelpResponse =
    ...
    fun validate(): SiteQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
