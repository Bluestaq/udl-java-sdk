...
/**
 * Service operation intended for initial integration only, to take a list of ECPEDR records as a
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpedrCreateBulkParams].
         *
    ...
    /** A builder for [EcpedrCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpedrCreateBulkParams: EcpedrCreateBulkParams) = apply {
            body = ecpedrCreateBulkParams.body.toMutableList()
            additionalHeaders = ecpedrCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = ecpedrCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EcpedrCreateBulkParams].
         *
         ...
         */
        fun build(): EcpedrCreateBulkParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EcpedrCreateBulkParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EcpedrCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
