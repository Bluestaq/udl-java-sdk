...
class DiffOfArrivalQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffOfArrivalQueryhelpResponse: DiffOfArrivalQueryhelpResponse) = apply {
            ...
            additionalProperties =
                diffOfArrivalQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): DiffOfArrivalQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
