...
class DiffOfArrivalQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DiffOfArrivalQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [DiffOfArrivalQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffOfArrivalQueryhelpResponse: DiffOfArrivalQueryhelpResponse) =
            apply {
                aodrSupported = diffOfArrivalQueryhelpResponse.aodrSupported
                classificationMarking = diffOfArrivalQueryhelpResponse.classificationMarking
                description = diffOfArrivalQueryhelpResponse.description
                historySupported = diffOfArrivalQueryhelpResponse.historySupported
                name = diffOfArrivalQueryhelpResponse.name
                parameters = diffOfArrivalQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = diffOfArrivalQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = diffOfArrivalQueryhelpResponse.restSupported
                sortSupported = diffOfArrivalQueryhelpResponse.sortSupported
                typeName = diffOfArrivalQueryhelpResponse.typeName
                uri = diffOfArrivalQueryhelpResponse.uri
                additionalProperties = diffOfArrivalQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DiffOfArrivalQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DiffOfArrivalQueryhelpResponse =
    ...
    fun validate(): DiffOfArrivalQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
