...
/**
 * Service operation to take a single AntennaDetails as a POST body and ingest into the database. An
 ...
 */
class AntennaDetailCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaDetailCreateParams: AntennaDetailCreateParams) = apply {
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idAntenna=$idAntenna, source=$source, id=$id, beamForming=$beamForming, beamwidth=$beamwidth, createdAt=$createdAt, createdBy=$createdBy, description=$description, diameter=$diameter, endFrequency=$endFrequency, gain=$gain, gainTolerance=$gainTolerance, manufacturerOrgId=$manufacturerOrgId, mode=$mode, origin=$origin, origNetwork=$origNetwork, polarization=$polarization, position=$position, size=$size, startFrequency=$startFrequency, steerable=$steerable, tags=$tags, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "AntennaDetailCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
