    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) =
            apply {
                ...
                idSite = historyListResponse.idSite
                source = historyListResponse.source
                id = historyListResponse.id
                cat = historyListResponse.cat
                coldInventory = historyListResponse.coldInventory
                commImpairment = historyListResponse.commImpairment
                cpcon = historyListResponse.cpcon
                createdAt = historyListResponse.createdAt
                createdBy = historyListResponse.createdBy
                eoc = historyListResponse.eoc
                fpcon = historyListResponse.fpcon
                hotInventory = historyListResponse.hotInventory
                hpcon = historyListResponse.hpcon
                instStatus = historyListResponse.instStatus
                link = historyListResponse.link.map { it.toMutableList() }
                linkStatus = historyListResponse.linkStatus.map { it.toMutableList() }
                missile = historyListResponse.missile.map { it.toMutableList() }
                missileInventory = historyListResponse.missileInventory.map { it.toMutableList() }
                mobileAltId = historyListResponse.mobileAltId
                opsCapability = historyListResponse.opsCapability
                opsImpairment = historyListResponse.opsImpairment
                origin = historyListResponse.origin
                origNetwork = historyListResponse.origNetwork
                pes = historyListResponse.pes
                poiid = historyListResponse.poiid
                radarStatus = historyListResponse.radarStatus.map { it.toMutableList() }
                radarSystem = historyListResponse.radarSystem.map { it.toMutableList() }
                radiateMode = historyListResponse.radiateMode
                reportTime = historyListResponse.reportTime
                samMode = historyListResponse.samMode
                siteType = historyListResponse.siteType
                timeFunction = historyListResponse.timeFunction
                trackId = historyListResponse.trackId
                trackRefL16 = historyListResponse.trackRefL16
                updatedAt = historyListResponse.updatedAt
                updatedBy = historyListResponse.updatedBy
                weatherMessage = historyListResponse.weatherMessage
