...
class AircraftstatusAbridged private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftstatusAbridged: AircraftstatusAbridged) =
            apply {
    ...
    fun validate(): AircraftstatusAbridged =
        apply {
            if (validated) {
              return@apply
            }
