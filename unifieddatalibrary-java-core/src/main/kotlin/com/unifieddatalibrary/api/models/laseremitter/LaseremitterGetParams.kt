...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaseremitterGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LaseremitterGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LaseremitterGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laseremitterGetParams: LaseremitterGetParams) = apply {
            id = laseremitterGetParams.id
            firstResult = laseremitterGetParams.firstResult
            maxResults = laseremitterGetParams.maxResults
            additionalHeaders = laseremitterGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = laseremitterGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaseremitterGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaseremitterGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaseremitterGetParams &&
            id == other.id &&
    ...
    override fun toString() =
        "LaseremitterGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
