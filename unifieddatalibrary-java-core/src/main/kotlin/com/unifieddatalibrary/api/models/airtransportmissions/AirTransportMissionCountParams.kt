 ...
 */
class AirTransportMissionCountParams
private constructor(
    ...
    /** A builder for [AirTransportMissionCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTransportMissionCountParams: AirTransportMissionCountParams) = apply {
            createdAt = airTransportMissionCountParams.createdAt
            firstResult = airTransportMissionCountParams.firstResult
            maxResults = airTransportMissionCountParams.maxResults
            additionalHeaders = airTransportMissionCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = airTransportMissionCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AirTransportMissionCountParams].
         *
         ...
         */
        fun build(): AirTransportMissionCountParams =
            AirTransportMissionCountParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirTransportMissionCountParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirTransportMissionCountParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
