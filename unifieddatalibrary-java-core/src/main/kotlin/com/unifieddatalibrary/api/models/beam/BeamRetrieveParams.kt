...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BeamRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamRetrieveParams: BeamRetrieveParams) = apply {
    ...
    override fun toString() =
        "BeamRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
