...
class BeamRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): BeamRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BeamRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [BeamRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamRetrieveParams: BeamRetrieveParams) =
            apply {
                id = beamRetrieveParams.id
                firstResult = beamRetrieveParams.firstResult
                maxResults = beamRetrieveParams.maxResults
                additionalHeaders = beamRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = beamRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BeamRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BeamRetrieveParams =
            BeamRetrieveParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BeamRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "BeamRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
