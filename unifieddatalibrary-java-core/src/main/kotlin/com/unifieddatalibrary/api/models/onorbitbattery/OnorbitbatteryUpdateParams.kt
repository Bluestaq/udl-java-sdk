...
/**
 * Service operation to update a single OnorbitBattery. OnorbitBattery is the association between
 * on-orbit spacecraft batteries and a particular on-orbit spacecraft. A Battery may be associated
 * with many different on-orbit spacecraft. A specific role is required to perform this service
 * operation. Please contact the UDL team for assistance.
 */
class OnorbitbatteryUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitbatteryUpdateParams: OnorbitbatteryUpdateParams) = apply {
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idBattery=$idBattery, idOnOrbit=$idOnOrbit, source=$source, bodyId=$bodyId, battery=$battery, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "OnorbitbatteryUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
