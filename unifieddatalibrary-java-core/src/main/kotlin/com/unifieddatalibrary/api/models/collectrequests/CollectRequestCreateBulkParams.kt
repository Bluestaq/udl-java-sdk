...
class CollectRequestCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectRequestCreateBulkParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestCreateBulkParams: CollectRequestCreateBulkParams) =
            apply {
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("integrationTime") @ExcludeMissing private val integrationTime: JsonField<Double>,
        ...
        @JsonProperty("msgCreateDate") @ExcludeMissing private val msgCreateDate: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("stateVector") @ExcludeMissing private val stateVector: JsonField<StateVector>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CollectRequestCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "CollectRequestCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
