...
class EffectRequestQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EffectRequestQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EffectRequestQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestQueryHelpResponse: EffectRequestQueryHelpResponse) =
            apply {
                aodrSupported = effectRequestQueryHelpResponse.aodrSupported
                classificationMarking = effectRequestQueryHelpResponse.classificationMarking
                description = effectRequestQueryHelpResponse.description
                historySupported = effectRequestQueryHelpResponse.historySupported
                name = effectRequestQueryHelpResponse.name
                parameters = effectRequestQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = effectRequestQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = effectRequestQueryHelpResponse.restSupported
                sortSupported = effectRequestQueryHelpResponse.sortSupported
                typeName = effectRequestQueryHelpResponse.typeName
                uri = effectRequestQueryHelpResponse.uri
                additionalProperties = effectRequestQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EffectRequestQueryHelpResponse =
    ...
    fun validate(): EffectRequestQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectRequestQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
