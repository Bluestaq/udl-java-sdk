...
class EffectRequestQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestQueryHelpResponse: EffectRequestQueryHelpResponse) = apply {
            ...
            additionalProperties =
                effectRequestQueryHelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): EffectRequestQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
