...
class SurfaceTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceTupleParams].
         *
    ...
    /** A builder for [SurfaceTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceTupleParams: SurfaceTupleParams) =
            apply {
                columns = surfaceTupleParams.columns
                firstResult = surfaceTupleParams.firstResult
                maxResults = surfaceTupleParams.maxResults
                additionalHeaders = surfaceTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = surfaceTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SurfaceTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SurfaceTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
