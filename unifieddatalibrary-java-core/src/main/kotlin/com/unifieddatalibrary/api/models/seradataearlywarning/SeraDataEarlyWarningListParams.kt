 ...
 */
class SeraDataEarlyWarningListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeraDataEarlyWarningListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningListParams: SeraDataEarlyWarningListParams) = apply {
    ...
    override fun toString() =
        "SeraDataEarlyWarningListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
