...
class OnorbitListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<OnorbitListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitListPageAsync: OnorbitListPageAsync) =
            apply {
        ...
        fun service(service: OnorbitServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: OnorbitListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<OnorbitListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "OnorbitListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
