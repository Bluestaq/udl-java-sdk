...
class EntityRetrieveParams private constructor(
    ...
    /** A builder for [EntityRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityRetrieveParams: EntityRetrieveParams) =
            apply {
                id = entityRetrieveParams.id
                firstResult = entityRetrieveParams.firstResult
                maxResults = entityRetrieveParams.maxResults
                additionalHeaders = entityRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = entityRetrieveParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EntityRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EntityRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
