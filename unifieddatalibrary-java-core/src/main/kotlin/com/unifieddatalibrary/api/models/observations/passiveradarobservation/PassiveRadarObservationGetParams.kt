...
class PassiveRadarObservationGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): PassiveRadarObservationGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PassiveRadarObservationGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [PassiveRadarObservationGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(passiveRadarObservationGetParams: PassiveRadarObservationGetParams) =
            apply {
                id = passiveRadarObservationGetParams.id
                firstResult = passiveRadarObservationGetParams.firstResult
                maxResults = passiveRadarObservationGetParams.maxResults
                additionalHeaders = passiveRadarObservationGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = passiveRadarObservationGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PassiveRadarObservationGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PassiveRadarObservationGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PassiveRadarObservationGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "PassiveRadarObservationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
