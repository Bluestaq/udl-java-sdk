 ...
 * path parameter.
 */
class PassiveRadarObservationGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PassiveRadarObservationGetParams = builder().build()
        ...
        internal fun from(passiveRadarObservationGetParams: PassiveRadarObservationGetParams) =
            apply {
                ...
                additionalQueryParams =
                    passiveRadarObservationGetParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "PassiveRadarObservationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
