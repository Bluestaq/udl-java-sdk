...
class OperatingUnitRemarkFull private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperatingUnitRemarkFull].
         *
    ...
    /** A builder for [OperatingUnitRemarkFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingUnitRemarkFull: OperatingUnitRemarkFull) =
            apply {
                classificationMarking = operatingUnitRemarkFull.classificationMarking
                dataMode = operatingUnitRemarkFull.dataMode
                idOperatingUnit = operatingUnitRemarkFull.idOperatingUnit
                source = operatingUnitRemarkFull.source
                text = operatingUnitRemarkFull.text
                id = operatingUnitRemarkFull.id
                altRmkId = operatingUnitRemarkFull.altRmkId
                code = operatingUnitRemarkFull.code
                createdAt = operatingUnitRemarkFull.createdAt
                createdBy = operatingUnitRemarkFull.createdBy
                name = operatingUnitRemarkFull.name
                origin = operatingUnitRemarkFull.origin
                type = operatingUnitRemarkFull.type
                updatedAt = operatingUnitRemarkFull.updatedAt
                updatedBy = operatingUnitRemarkFull.updatedBy
                additionalProperties = operatingUnitRemarkFull.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OperatingUnitRemarkFull].
         *
         ...
         */
        fun build(): OperatingUnitRemarkFull =
    ...
    fun validate(): OperatingUnitRemarkFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idOperatingUnit.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (text.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (altRmkId.asKnown().isPresent) 1 else 0) + (if (code.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "OperatingUnitRemarkFull{classificationMarking=$classificationMarking, dataMode=$dataMode, idOperatingUnit=$idOperatingUnit, source=$source, text=$text, id=$id, altRmkId=$altRmkId, code=$code, createdAt=$createdAt, createdBy=$createdBy, name=$name, origin=$origin, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
