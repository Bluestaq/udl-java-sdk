...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingUnitRemarkFull: OperatingUnitRemarkFull) = apply {
    ...
    fun validate(): OperatingUnitRemarkFull = apply {
        if (validated) {
            return@apply
        }
