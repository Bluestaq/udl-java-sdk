...
class OnorbitTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitTupleParams].
         *
    ...
    /** A builder for [OnorbitTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitTupleParams: OnorbitTupleParams) =
            apply {
                columns = onorbitTupleParams.columns
                firstResult = onorbitTupleParams.firstResult
                maxResults = onorbitTupleParams.maxResults
                additionalHeaders = onorbitTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnorbitTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
