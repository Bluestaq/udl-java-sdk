 ...
 */
class DiffOfArrivalRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DiffOfArrivalRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffOfArrivalRetrieveParams: DiffOfArrivalRetrieveParams) = apply {
    ...
    override fun toString() =
        "DiffOfArrivalRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
