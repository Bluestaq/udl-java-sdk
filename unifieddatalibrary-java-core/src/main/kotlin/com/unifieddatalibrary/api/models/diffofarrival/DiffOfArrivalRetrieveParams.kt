...
class DiffOfArrivalRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): DiffOfArrivalRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DiffOfArrivalRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [DiffOfArrivalRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffOfArrivalRetrieveParams: DiffOfArrivalRetrieveParams) =
            apply {
                id = diffOfArrivalRetrieveParams.id
                firstResult = diffOfArrivalRetrieveParams.firstResult
                maxResults = diffOfArrivalRetrieveParams.maxResults
                additionalHeaders = diffOfArrivalRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = diffOfArrivalRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DiffOfArrivalRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DiffOfArrivalRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is DiffOfArrivalRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "DiffOfArrivalRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
