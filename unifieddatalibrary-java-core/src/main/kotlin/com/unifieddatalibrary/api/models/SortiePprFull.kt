...
class SortiePprFull private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SortiePprFull].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprFull: SortiePprFull) =
            apply {
                classificationMarking = sortiePprFull.classificationMarking
                dataMode = sortiePprFull.dataMode
                idSortie = sortiePprFull.idSortie
                source = sortiePprFull.source
                id = sortiePprFull.id
                createdAt = sortiePprFull.createdAt
                createdBy = sortiePprFull.createdBy
                endTime = sortiePprFull.endTime
                externalId = sortiePprFull.externalId
                grantor = sortiePprFull.grantor
                number = sortiePprFull.number
                origin = sortiePprFull.origin
                origNetwork = sortiePprFull.origNetwork
                remarks = sortiePprFull.remarks
                requestor = sortiePprFull.requestor
                sourceDl = sortiePprFull.sourceDl
                startTime = sortiePprFull.startTime
                type = sortiePprFull.type
                updatedAt = sortiePprFull.updatedAt
                updatedBy = sortiePprFull.updatedBy
                additionalProperties = sortiePprFull.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SortiePprFull].
         *
    ...
    override fun toString() = "SortiePprFull{classificationMarking=$classificationMarking, dataMode=$dataMode, idSortie=$idSortie, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, endTime=$endTime, externalId=$externalId, grantor=$grantor, number=$number, origin=$origin, origNetwork=$origNetwork, remarks=$remarks, requestor=$requestor, sourceDl=$sourceDl, startTime=$startTime, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
