...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprFull: SortiePprFull) = apply {
    ...
    fun validate(): SortiePprFull = apply {
        if (validated) {
            return@apply
        }
