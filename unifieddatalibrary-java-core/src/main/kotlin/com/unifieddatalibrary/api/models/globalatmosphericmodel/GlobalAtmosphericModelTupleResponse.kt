...
class GlobalAtmosphericModelTupleResponse private constructor(
    ...
    /**
     * MD5 value of the data file. If not provided, the ingest/create operation will automatically generate the value.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    ...
    @ExcludeMissing
    fun _cadence(): JsonField<Int> = cadence
    ...
    @JsonProperty("endAlt")
    @ExcludeMissing
    fun _endAlt(): JsonField<Double> = endAlt
    ...
    @JsonProperty("endLat")
    @ExcludeMissing
    fun _endLat(): JsonField<Double> = endLat
    ...
    @JsonProperty("endLon")
    @ExcludeMissing
    fun _endLon(): JsonField<Double> = endLon
    ...
    @JsonProperty("numAlt")
    @ExcludeMissing
    fun _numAlt(): JsonField<Int> = numAlt
    ...
    @JsonProperty("numLat")
    @ExcludeMissing
    fun _numLat(): JsonField<Int> = numLat
    ...
    @JsonProperty("numLon")
    @ExcludeMissing
    fun _numLon(): JsonField<Int> = numLon
    ...
    @ExcludeMissing
    fun _startAlt(): JsonField<Double> = startAlt
    ...
    @ExcludeMissing
    fun _startLat(): JsonField<Double> = startLat
    ...
    @ExcludeMissing
    fun _startLon(): JsonField<Double> = startLon
     ...
     */
    @JsonProperty("stepLat")
    @ExcludeMissing
    fun _stepLat(): JsonField<Double> = stepLat
     ...
     */
    @JsonProperty("stepLon")
    @ExcludeMissing
    fun _stepLon(): JsonField<Double> = stepLon
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GlobalAtmosphericModelTupleResponse].
         *
    ...
    /** A builder for [GlobalAtmosphericModelTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelTupleResponse: GlobalAtmosphericModelTupleResponse) =
            apply {
                classificationMarking = globalAtmosphericModelTupleResponse.classificationMarking
                dataMode = globalAtmosphericModelTupleResponse.dataMode
                source = globalAtmosphericModelTupleResponse.source
                ts = globalAtmosphericModelTupleResponse.ts
                type = globalAtmosphericModelTupleResponse.type
                id = globalAtmosphericModelTupleResponse.id
                cadence = globalAtmosphericModelTupleResponse.cadence
                ...
                filename = globalAtmosphericModelTupleResponse.filename
                filesize = globalAtmosphericModelTupleResponse.filesize
                numAlt = globalAtmosphericModelTupleResponse.numAlt
                numLat = globalAtmosphericModelTupleResponse.numLat
                numLon = globalAtmosphericModelTupleResponse.numLon
                origin = globalAtmosphericModelTupleResponse.origin
                origNetwork = globalAtmosphericModelTupleResponse.origNetwork
                reportTime = globalAtmosphericModelTupleResponse.reportTime
                sourceDl = globalAtmosphericModelTupleResponse.sourceDl
                startAlt = globalAtmosphericModelTupleResponse.startAlt
                startLat = globalAtmosphericModelTupleResponse.startLat
                startLon = globalAtmosphericModelTupleResponse.startLon
                state = globalAtmosphericModelTupleResponse.state
                stepLat = globalAtmosphericModelTupleResponse.stepLat
                stepLon = globalAtmosphericModelTupleResponse.stepLon
                additionalProperties = globalAtmosphericModelTupleResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.cadence] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cadence(cadence: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.endAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun endAlt(endAlt: JsonField<Double>) =
            apply {
                this.endAlt = endAlt
            }
         ...
         *
         * You should usually call [Builder.endLat] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun endLat(endLat: JsonField<Double>) =
            apply {
                this.endLat = endLat
            }
         ...
         *
         * You should usually call [Builder.endLon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun endLon(endLon: JsonField<Double>) =
            apply {
                this.endLon = endLon
            }
         ...
         *
         * You should usually call [Builder.numAlt] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numAlt(numAlt: JsonField<Int>) =
            apply {
                this.numAlt = numAlt
            }
         ...
         *
         * You should usually call [Builder.numLat] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numLat(numLat: JsonField<Int>) =
            apply {
                this.numLat = numLat
            }
         ...
         *
         * You should usually call [Builder.numLon] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numLon(numLon: JsonField<Int>) =
            apply {
                this.numLon = numLon
            }
         ...
         *
         * You should usually call [Builder.startAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun startAlt(startAlt: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.startLat] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun startLat(startLat: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.startLon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun startLon(startLon: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.stepLat] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stepLat(stepLat: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.stepLon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stepLon(stepLon: JsonField<Double>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [GlobalAtmosphericModelTupleResponse].
         *
         ...
         */
        fun build(): GlobalAtmosphericModelTupleResponse =
    ...
    fun validate(): GlobalAtmosphericModelTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (ts.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (cadence.asKnown().isPresent) 1 else 0) + (if (checksumValue.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (endAlt.asKnown().isPresent) 1 else 0) + (if (endLat.asKnown().isPresent) 1 else 0) + (if (endLon.asKnown().isPresent) 1 else 0) + (if (filename.asKnown().isPresent) 1 else 0) + (if (filesize.asKnown().isPresent) 1 else 0) + (if (numAlt.asKnown().isPresent) 1 else 0) + (if (numLat.asKnown().isPresent) 1 else 0) + (if (numLon.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (reportTime.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (startAlt.asKnown().isPresent) 1 else 0) + (if (startLat.asKnown().isPresent) 1 else 0) + (if (startLon.asKnown().isPresent) 1 else 0) + (if (state.asKnown().isPresent) 1 else 0) + (if (stepLat.asKnown().isPresent) 1 else 0) + (if (stepLon.asKnown().isPresent) 1 else 0)
