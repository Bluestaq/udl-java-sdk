 ...
 * Density (3D) data, etc.
 */
class GlobalAtmosphericModelTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            globalAtmosphericModelTupleResponse: GlobalAtmosphericModelTupleResponse
        ) = apply {
            ...
            additionalProperties =
                globalAtmosphericModelTupleResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): GlobalAtmosphericModelTupleResponse = apply {
        if (validated) {
            return@apply
        }
