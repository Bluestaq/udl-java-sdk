 ...
 */
class EopAbridged private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("eopDate") @ExcludeMissing eopDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("dEpsilonUnc") @ExcludeMissing dEpsilonUnc: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("nutationState") @ExcludeMissing nutationState: JsonField<NutationState> = JsonMissing.of(),
        @JsonProperty("origin") @ExcludeMissing origin: JsonField<String> = JsonMissing.of(),
        @JsonProperty("origNetwork") @ExcludeMissing origNetwork: JsonField<String> = JsonMissing.of(),
        @JsonProperty("polarMotionState") @ExcludeMissing polarMotionState: JsonField<PolarMotionState> = JsonMissing.of(),
        @JsonProperty("polarMotionX") @ExcludeMissing polarMotionX: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("polarMotionXB") @ExcludeMissing polarMotionXb: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("polarMotionXUnc") @ExcludeMissing polarMotionXUnc: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("polarMotionY") @ExcludeMissing polarMotionY: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("polarMotionYB") @ExcludeMissing polarMotionYb: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("polarMotionYUnc") @ExcludeMissing polarMotionYUnc: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("precessionNutationStd") @ExcludeMissing precessionNutationStd: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("ut1UTCState") @ExcludeMissing ut1UtcState: JsonField<Ut1UtcState> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun polarMotionState(): Optional<PolarMotionState> = polarMotionState.getOptional("polarMotionState")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun precessionNutationStd(): Optional<String> = precessionNutationStd.getOptional("precessionNutationStd")
    ...
    @ExcludeMissing
    fun _eopDate(): JsonField<OffsetDateTime> = eopDate
     ...
     */
    @JsonProperty("dEpsilon")
    @ExcludeMissing
    fun _dEpsilon(): JsonField<Double> = dEpsilon
     ...
     */
    @JsonProperty("dEpsilonB")
    @ExcludeMissing
    fun _dEpsilonB(): JsonField<Double> = dEpsilonB
    ...
    @ExcludeMissing
    fun _dEpsilonUnc(): JsonField<Double> = dEpsilonUnc
    ...
    @JsonProperty("dPSI")
    @ExcludeMissing
    fun _dPsi(): JsonField<Double> = dPsi
    ...
    @JsonProperty("dPSIB")
    @ExcludeMissing
    fun _dPsib(): JsonField<Double> = dPsib
     ...
     */
    @JsonProperty("dPSIUnc")
    @ExcludeMissing
    fun _dPsiUnc(): JsonField<Double> = dPsiUnc
    ...
    @JsonProperty("dXUnc")
    @ExcludeMissing
    fun _dXUnc(): JsonField<Double> = dXUnc
    ...
    @JsonProperty("dYUnc")
    @ExcludeMissing
    fun _dYUnc(): JsonField<Double> = dYUnc
    ...
    @JsonProperty("lodUnc")
    @ExcludeMissing
    fun _lodUnc(): JsonField<Double> = lodUnc
     ...
     *
     * Unlike [polarMotionState], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [precessionNutationStd], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     */
    @JsonProperty("ut1UTCB")
    @ExcludeMissing
    fun _ut1Utcb(): JsonField<Double> = ut1Utcb
     ...
     */
    @JsonProperty("ut1UTCUnc")
    @ExcludeMissing
    fun _ut1UtcUnc(): JsonField<Double> = ut1UtcUnc
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EopAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopAbridged: EopAbridged) =
            apply {
                classificationMarking = eopAbridged.classificationMarking
                dataMode = eopAbridged.dataMode
                eopDate = eopAbridged.eopDate
                source = eopAbridged.source
                id = eopAbridged.id
                createdAt = eopAbridged.createdAt
                createdBy = eopAbridged.createdBy
                dEpsilon = eopAbridged.dEpsilon
                dEpsilonB = eopAbridged.dEpsilonB
                dEpsilonUnc = eopAbridged.dEpsilonUnc
                dPsi = eopAbridged.dPsi
                dPsib = eopAbridged.dPsib
                dPsiUnc = eopAbridged.dPsiUnc
                dX = eopAbridged.dX
                dXb = eopAbridged.dXb
                dXUnc = eopAbridged.dXUnc
                dY = eopAbridged.dY
                dYb = eopAbridged.dYb
                dYUnc = eopAbridged.dYUnc
                lod = eopAbridged.lod
                lodUnc = eopAbridged.lodUnc
                nutationState = eopAbridged.nutationState
                origin = eopAbridged.origin
                origNetwork = eopAbridged.origNetwork
                polarMotionState = eopAbridged.polarMotionState
                polarMotionX = eopAbridged.polarMotionX
                polarMotionXb = eopAbridged.polarMotionXb
                polarMotionXUnc = eopAbridged.polarMotionXUnc
                polarMotionY = eopAbridged.polarMotionY
                polarMotionYb = eopAbridged.polarMotionYb
                polarMotionYUnc = eopAbridged.polarMotionYUnc
                precessionNutationStd = eopAbridged.precessionNutationStd
                rawFileUri = eopAbridged.rawFileUri
                ut1Utc = eopAbridged.ut1Utc
                ut1Utcb = eopAbridged.ut1Utcb
                ut1UtcState = eopAbridged.ut1UtcState
                ut1UtcUnc = eopAbridged.ut1UtcUnc
                additionalProperties = eopAbridged.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.eopDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eopDate(eopDate: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.dEpsilon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dEpsilon(dEpsilon: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.dEpsilonB] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dEpsilonB(dEpsilonB: JsonField<Double>) =
            apply {
                this.dEpsilonB = dEpsilonB
            }
         ...
         *
         * You should usually call [Builder.dEpsilonUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dEpsilonUnc(dEpsilonUnc: JsonField<Double>) =
            apply {
                this.dEpsilonUnc = dEpsilonUnc
            }
         ...
         *
         * You should usually call [Builder.dPsi] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dPsi(dPsi: JsonField<Double>) =
            apply {
                this.dPsi = dPsi
            }
         ...
         *
         * You should usually call [Builder.dPsib] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dPsib(dPsib: JsonField<Double>) =
            apply {
                this.dPsib = dPsib
            }
         ...
         *
         * You should usually call [Builder.dPsiUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dPsiUnc(dPsiUnc: JsonField<Double>) =
            apply {
                this.dPsiUnc = dPsiUnc
            }
         ...
         *
         * You should usually call [Builder.dX] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dX(dX: JsonField<Double>) =
            apply {
                this.dX = dX
            }
         ...
         *
         * You should usually call [Builder.dXb] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dXb(dXb: JsonField<Double>) =
            apply {
                this.dXb = dXb
            }
         ...
         *
         * You should usually call [Builder.dXUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dXUnc(dXUnc: JsonField<Double>) =
            apply {
                this.dXUnc = dXUnc
            }
         ...
         *
         * You should usually call [Builder.dY] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dY(dY: JsonField<Double>) =
            apply {
                this.dY = dY
            }
         ...
         *
         * You should usually call [Builder.dYb] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dYb(dYb: JsonField<Double>) =
            apply {
                this.dYb = dYb
            }
         ...
         *
         * You should usually call [Builder.dYUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dYUnc(dYUnc: JsonField<Double>) =
            apply {
                this.dYUnc = dYUnc
            }
         ...
         *
         * You should usually call [Builder.lod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lod(lod: JsonField<Double>) =
            apply {
                this.lod = lod
            }
         ...
         *
         * You should usually call [Builder.lodUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lodUnc(lodUnc: JsonField<Double>) =
            apply {
                this.lodUnc = lodUnc
            }
         ...
         *
         * You should usually call [Builder.nutationState] with a well-typed [NutationState] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nutationState(nutationState: JsonField<NutationState>) =
            apply {
        ...
        /** Flag indicating Issued (I), or Predicted (P) for this record's polar motion values. */
        fun polarMotionState(polarMotionState: PolarMotionState) = polarMotionState(JsonField.of(polarMotionState))

        /**
         * Sets [Builder.polarMotionState] to an arbitrary JSON value.
         *
         * You should usually call [Builder.polarMotionState] with a well-typed [PolarMotionState] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarMotionState(polarMotionState: JsonField<PolarMotionState>) =
            apply {
         ...
         *
         * You should usually call [Builder.polarMotionXb] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarMotionXb(polarMotionXb: JsonField<Double>) =
            apply {
                this.polarMotionXb = polarMotionXb
            }

        /** Estimated uncertainty/error in polarMotionX value in arc seconds. */
        fun polarMotionXUnc(polarMotionXUnc: Double) = polarMotionXUnc(JsonField.of(polarMotionXUnc))

        /**
         * Sets [Builder.polarMotionXUnc] to an arbitrary JSON value.
         *
         * You should usually call [Builder.polarMotionXUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarMotionXUnc(polarMotionXUnc: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.polarMotionYb] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarMotionYb(polarMotionYb: JsonField<Double>) =
            apply {
                this.polarMotionYb = polarMotionYb
            }

        /** Estimated uncertainty/error in polarMotionY value in arc seconds. */
        fun polarMotionYUnc(polarMotionYUnc: Double) = polarMotionYUnc(JsonField.of(polarMotionYUnc))

        /**
         * Sets [Builder.polarMotionYUnc] to an arbitrary JSON value.
         *
         * You should usually call [Builder.polarMotionYUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarMotionYUnc(polarMotionYUnc: JsonField<Double>) =
            apply {
                this.polarMotionYUnc = polarMotionYUnc
            }

        /** The IAU Theory of Precession and Theory of Nutation applied to the data in this record. IAU1980 records employ the IAU 1976 Theory of Precession and IAU 1980 Theory of Nutation, and IAU2000 records employ the IAU 2000A Theory of Precession and Nutation. */
        fun precessionNutationStd(precessionNutationStd: String) = precessionNutationStd(JsonField.of(precessionNutationStd))

        /**
         * Sets [Builder.precessionNutationStd] to an arbitrary JSON value.
         *
         * You should usually call [Builder.precessionNutationStd] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun precessionNutationStd(precessionNutationStd: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.ut1Utcb] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ut1Utcb(ut1Utcb: JsonField<Double>) =
            apply {
                this.ut1Utcb = ut1Utcb
            }
         ...
         *
         * You should usually call [Builder.ut1UtcState] with a well-typed [Ut1UtcState] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ut1UtcState(ut1UtcState: JsonField<Ut1UtcState>) =
            apply {
         ...
         *
         * You should usually call [Builder.ut1UtcUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ut1UtcUnc(ut1UtcUnc: JsonField<Double>) =
            apply {
                this.ut1UtcUnc = ut1UtcUnc
            }
        ...
        /**
         * Returns an immutable instance of [EopAbridged].
         *
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (eopDate.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (dEpsilon.asKnown().isPresent) 1 else 0) + (if (dEpsilonB.asKnown().isPresent) 1 else 0) + (if (dEpsilonUnc.asKnown().isPresent) 1 else 0) + (if (dPsi.asKnown().isPresent) 1 else 0) + (if (dPsib.asKnown().isPresent) 1 else 0) + (if (dPsiUnc.asKnown().isPresent) 1 else 0) + (if (dX.asKnown().isPresent) 1 else 0) + (if (dXb.asKnown().isPresent) 1 else 0) + (if (dXUnc.asKnown().isPresent) 1 else 0) + (if (dY.asKnown().isPresent) 1 else 0) + (if (dYb.asKnown().isPresent) 1 else 0) + (if (dYUnc.asKnown().isPresent) 1 else 0) + (if (lod.asKnown().isPresent) 1 else 0) + (if (lodUnc.asKnown().isPresent) 1 else 0) + (nutationState.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (polarMotionState.asKnown().getOrNull()?.validity() ?: 0) + (if (polarMotionX.asKnown().isPresent) 1 else 0) + (if (polarMotionXb.asKnown().isPresent) 1 else 0) + (if (polarMotionXUnc.asKnown().isPresent) 1 else 0) + (if (polarMotionY.asKnown().isPresent) 1 else 0) + (if (polarMotionYb.asKnown().isPresent) 1 else 0) + (if (polarMotionYUnc.asKnown().isPresent) 1 else 0) + (if (precessionNutationStd.asKnown().isPresent) 1 else 0) + (if (rawFileUri.asKnown().isPresent) 1 else 0) + (if (ut1Utc.asKnown().isPresent) 1 else 0) + (if (ut1Utcb.asKnown().isPresent) 1 else 0) + (ut1UtcState.asKnown().getOrNull()?.validity() ?: 0) + (if (ut1UtcUnc.asKnown().isPresent) 1 else 0)
    ...
    /** Flag indicating Issued (I), or Predicted (P) for this record's nutation values (dPSI and dEpsilon). */
    class NutationState @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        enum class Value {
            I,
            P,
            /** An enum member indicating that [NutationState] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                I -> Known.I
                P -> Known.P
                else -> throw UnifieddatalibraryInvalidDataException("Unknown NutationState: $value")
            }
    ...
    /** Flag indicating Issued (I), or Predicted (P) for this record's polar motion values. */
    class PolarMotionState @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        enum class Value {
            I,
            P,
            /** An enum member indicating that [PolarMotionState] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                I -> Known.I
                P -> Known.P
                else -> throw UnifieddatalibraryInvalidDataException("Unknown PolarMotionState: $value")
            }
    ...
    /** Flag indicating Issued (I), or Predicted (P) for this record''s Bulletin A UT1-UTC values. */
    class Ut1UtcState @JsonCreator private constructor(
        private val value: JsonField<String>,
