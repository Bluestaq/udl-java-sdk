...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopAbridged: EopAbridged) = apply {
    ...
    fun validate(): EopAbridged = apply {
        if (validated) {
            return@apply
        }
