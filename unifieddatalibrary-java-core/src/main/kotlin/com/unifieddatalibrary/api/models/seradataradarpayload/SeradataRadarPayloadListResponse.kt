...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataRadarPayloadListResponse: SeradataRadarPayloadListResponse) =
            apply {
                classificationMarking = seradataRadarPayloadListResponse.classificationMarking
                dataMode = seradataRadarPayloadListResponse.dataMode
                source = seradataRadarPayloadListResponse.source
                spacecraftId = seradataRadarPayloadListResponse.spacecraftId
                id = seradataRadarPayloadListResponse.id
                ...
                fieldOfRegard = seradataRadarPayloadListResponse.fieldOfRegard
                fieldOfView = seradataRadarPayloadListResponse.fieldOfView
                frequency = seradataRadarPayloadListResponse.frequency
                frequencyBand = seradataRadarPayloadListResponse.frequencyBand
                groundStationLocations = seradataRadarPayloadListResponse.groundStationLocations
                groundStations = seradataRadarPayloadListResponse.groundStations
                hostedForCompanyOrgId = seradataRadarPayloadListResponse.hostedForCompanyOrgId
                idSensor = seradataRadarPayloadListResponse.idSensor
                manufacturerOrgId = seradataRadarPayloadListResponse.manufacturerOrgId
                name = seradataRadarPayloadListResponse.name
                notes = seradataRadarPayloadListResponse.notes
                origin = seradataRadarPayloadListResponse.origin
                origNetwork = seradataRadarPayloadListResponse.origNetwork
                partnerSpacecraft = seradataRadarPayloadListResponse.partnerSpacecraft
                pointingMethod = seradataRadarPayloadListResponse.pointingMethod
                receivePolarization = seradataRadarPayloadListResponse.receivePolarization
                recorderSize = seradataRadarPayloadListResponse.recorderSize
