...
class EoObservationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EoObservationCountParams].
         *
    ...
    /** A builder for [EoObservationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationCountParams: EoObservationCountParams) =
            apply {
                obTime = eoObservationCountParams.obTime
                firstResult = eoObservationCountParams.firstResult
                maxResults = eoObservationCountParams.maxResults
                additionalHeaders = eoObservationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = eoObservationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EoObservationCountParams].
         *
         ...
         */
        fun build(): EoObservationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EoObservationCountParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EoObservationCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
