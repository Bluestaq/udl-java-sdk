...
/**
 * Service operation to get a single IR record by its unique ID passed as a path parameter. An IR is
 * an on-orbit infrared payload.
 */
class IrGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IrGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IrGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IrGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(irGetParams: IrGetParams) = apply {
            id = irGetParams.id
            firstResult = irGetParams.firstResult
            maxResults = irGetParams.maxResults
            additionalHeaders = irGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = irGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IrGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IrGetParams =
            IrGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IrGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "IrGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
