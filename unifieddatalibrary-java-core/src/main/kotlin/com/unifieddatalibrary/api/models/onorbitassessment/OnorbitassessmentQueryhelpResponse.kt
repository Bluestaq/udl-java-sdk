...
class OnorbitassessmentQueryhelpResponse
...
private constructor(
    ...
    /** A builder for [OnorbitassessmentQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitassessmentQueryhelpResponse: OnorbitassessmentQueryhelpResponse) =
            apply {
                aodrSupported = onorbitassessmentQueryhelpResponse.aodrSupported
                classificationMarking = onorbitassessmentQueryhelpResponse.classificationMarking
                description = onorbitassessmentQueryhelpResponse.description
                historySupported = onorbitassessmentQueryhelpResponse.historySupported
                name = onorbitassessmentQueryhelpResponse.name
                parameters =
                    onorbitassessmentQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    onorbitassessmentQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = onorbitassessmentQueryhelpResponse.restSupported
                sortSupported = onorbitassessmentQueryhelpResponse.sortSupported
                typeName = onorbitassessmentQueryhelpResponse.typeName
                uri = onorbitassessmentQueryhelpResponse.uri
                additionalProperties =
                    onorbitassessmentQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitassessmentQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitassessmentQueryhelpResponse =
            OnorbitassessmentQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): OnorbitassessmentQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitassessmentQueryhelpResponse &&
