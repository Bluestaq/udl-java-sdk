...
class SurfaceGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SurfaceGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SurfaceGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SurfaceGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceGetParams: SurfaceGetParams) =
            apply {
                id = surfaceGetParams.id
                firstResult = surfaceGetParams.firstResult
                maxResults = surfaceGetParams.maxResults
                additionalHeaders = surfaceGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = surfaceGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SurfaceGetParams =
            SurfaceGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SurfaceGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SurfaceGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
