...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SurfaceGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceGetParams: SurfaceGetParams) = apply {
    ...
    override fun toString() =
        "SurfaceGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
