...
class SkyImageryListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SkyImageryListResponse].
         *
    ...
    /** A builder for [SkyImageryListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryListResponse: SkyImageryListResponse) =
            apply {
                classificationMarking = skyImageryListResponse.classificationMarking
                dataMode = skyImageryListResponse.dataMode
                expStartTime = skyImageryListResponse.expStartTime
                imageType = skyImageryListResponse.imageType
                source = skyImageryListResponse.source
                id = skyImageryListResponse.id
                annotationKey = skyImageryListResponse.annotationKey
                calibrationKey = skyImageryListResponse.calibrationKey
                checksumValue = skyImageryListResponse.checksumValue
                createdAt = skyImageryListResponse.createdAt
                createdBy = skyImageryListResponse.createdBy
                description = skyImageryListResponse.description
                expEndTime = skyImageryListResponse.expEndTime
                filename = skyImageryListResponse.filename
                filesize = skyImageryListResponse.filesize
                frameFovHeight = skyImageryListResponse.frameFovHeight
                frameFovWidth = skyImageryListResponse.frameFovWidth
                frameHeightPixels = skyImageryListResponse.frameHeightPixels
                frameWidthPixels = skyImageryListResponse.frameWidthPixels
                idAttitudeSet = skyImageryListResponse.idAttitudeSet
                idOnOrbit = skyImageryListResponse.idOnOrbit
                idSensor = skyImageryListResponse.idSensor
                idSoiSet = skyImageryListResponse.idSoiSet
                imageSetId = skyImageryListResponse.imageSetId
                imageSetLength = skyImageryListResponse.imageSetLength
                imageSourceInfo = skyImageryListResponse.imageSourceInfo
                origin = skyImageryListResponse.origin
                origNetwork = skyImageryListResponse.origNetwork
                origObjectId = skyImageryListResponse.origObjectId
                origSensorId = skyImageryListResponse.origSensorId
                pixelBitDepth = skyImageryListResponse.pixelBitDepth
                pixelFovHeight = skyImageryListResponse.pixelFovHeight
                pixelFovWidth = skyImageryListResponse.pixelFovWidth
                satNo = skyImageryListResponse.satNo
                senalt = skyImageryListResponse.senalt
                senlat = skyImageryListResponse.senlat
                senlon = skyImageryListResponse.senlon
                senQuat = skyImageryListResponse.senQuat.map { it.toMutableList() }
                senQuatDot = skyImageryListResponse.senQuatDot.map { it.toMutableList() }
                senx = skyImageryListResponse.senx
                seny = skyImageryListResponse.seny
                senz = skyImageryListResponse.senz
                sequenceId = skyImageryListResponse.sequenceId
                sourceDl = skyImageryListResponse.sourceDl
                tags = skyImageryListResponse.tags.map { it.toMutableList() }
                topLeftStartAz = skyImageryListResponse.topLeftStartAz
                topLeftStartEl = skyImageryListResponse.topLeftStartEl
                topLeftStopAz = skyImageryListResponse.topLeftStopAz
                topLeftStopEl = skyImageryListResponse.topLeftStopEl
                transactionId = skyImageryListResponse.transactionId
                additionalProperties = skyImageryListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SkyImageryListResponse].
         *
         ...
         */
        fun build(): SkyImageryListResponse =
    ...
    fun validate(): SkyImageryListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (expStartTime.asKnown().isPresent) 1 else 0) + (if (imageType.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (annotationKey.asKnown().isPresent) 1 else 0) + (if (calibrationKey.asKnown().isPresent) 1 else 0) + (if (checksumValue.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (expEndTime.asKnown().isPresent) 1 else 0) + (if (filename.asKnown().isPresent) 1 else 0) + (if (filesize.asKnown().isPresent) 1 else 0) + (if (frameFovHeight.asKnown().isPresent) 1 else 0) + (if (frameFovWidth.asKnown().isPresent) 1 else 0) + (if (frameHeightPixels.asKnown().isPresent) 1 else 0) + (if (frameWidthPixels.asKnown().isPresent) 1 else 0) + (if (idAttitudeSet.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (idSoiSet.asKnown().isPresent) 1 else 0) + (if (imageSetId.asKnown().isPresent) 1 else 0) + (if (imageSetLength.asKnown().isPresent) 1 else 0) + (if (imageSourceInfo.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (pixelBitDepth.asKnown().isPresent) 1 else 0) + (if (pixelFovHeight.asKnown().isPresent) 1 else 0) + (if (pixelFovWidth.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlat.asKnown().isPresent) 1 else 0) + (if (senlon.asKnown().isPresent) 1 else 0) + (senQuat.asKnown().getOrNull()?.size ?: 0) + (senQuatDot.asKnown().getOrNull()?.size ?: 0) + (if (senx.asKnown().isPresent) 1 else 0) + (if (seny.asKnown().isPresent) 1 else 0) + (if (senz.asKnown().isPresent) 1 else 0) + (if (sequenceId.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (topLeftStartAz.asKnown().isPresent) 1 else 0) + (if (topLeftStartEl.asKnown().isPresent) 1 else 0) + (if (topLeftStopAz.asKnown().isPresent) 1 else 0) + (if (topLeftStopEl.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0)
