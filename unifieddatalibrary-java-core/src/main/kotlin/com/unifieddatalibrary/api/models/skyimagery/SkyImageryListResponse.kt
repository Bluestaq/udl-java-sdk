...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryListResponse: SkyImageryListResponse) = apply {
    ...
    fun validate(): SkyImageryListResponse = apply {
        if (validated) {
            return@apply
        }
