 ...
 */
class OnorbitassessmentTupleResponse
...
private constructor(
    ...
    /** A builder for [OnorbitassessmentTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitassessmentTupleResponse: OnorbitassessmentTupleResponse) = apply {
            assmtTime = onorbitassessmentTupleResponse.assmtTime
            classificationMarking = onorbitassessmentTupleResponse.classificationMarking
            dataMode = onorbitassessmentTupleResponse.dataMode
            source = onorbitassessmentTupleResponse.source
            id = onorbitassessmentTupleResponse.id
            assessment = onorbitassessmentTupleResponse.assessment
            assmtDetails = onorbitassessmentTupleResponse.assmtDetails
            assmtLevel = onorbitassessmentTupleResponse.assmtLevel
            assmtRotPeriod = onorbitassessmentTupleResponse.assmtRotPeriod
            assmtSubType = onorbitassessmentTupleResponse.assmtSubType
            assmtUrl = onorbitassessmentTupleResponse.assmtUrl
            autoAssmt = onorbitassessmentTupleResponse.autoAssmt
            collectionUrl = onorbitassessmentTupleResponse.collectionUrl
            components = onorbitassessmentTupleResponse.components.map { it.toMutableList() }
            createdAt = onorbitassessmentTupleResponse.createdAt
            createdBy = onorbitassessmentTupleResponse.createdBy
            idOnOrbit = onorbitassessmentTupleResponse.idOnOrbit
            idSensor = onorbitassessmentTupleResponse.idSensor
            obDuration = onorbitassessmentTupleResponse.obDuration
            obTime = onorbitassessmentTupleResponse.obTime
            onOrbit = onorbitassessmentTupleResponse.onOrbit
            origin = onorbitassessmentTupleResponse.origin
            origNetwork = onorbitassessmentTupleResponse.origNetwork
            origObjectId = onorbitassessmentTupleResponse.origObjectId
            origSensorId = onorbitassessmentTupleResponse.origSensorId
            satNo = onorbitassessmentTupleResponse.satNo
            sigDataType = onorbitassessmentTupleResponse.sigDataType
            sourceDl = onorbitassessmentTupleResponse.sourceDl
            srcIds = onorbitassessmentTupleResponse.srcIds.map { it.toMutableList() }
            srcTyps = onorbitassessmentTupleResponse.srcTyps.map { it.toMutableList() }
            tags = onorbitassessmentTupleResponse.tags.map { it.toMutableList() }
            transactionId = onorbitassessmentTupleResponse.transactionId
            additionalProperties =
                onorbitassessmentTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitassessmentTupleResponse].
         *
         ...
         */
        fun build(): OnorbitassessmentTupleResponse =
            OnorbitassessmentTupleResponse(
    ...
    fun validate(): OnorbitassessmentTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitassessmentTupleResponse &&
