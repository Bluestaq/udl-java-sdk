...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TransponderCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderCountParams: TransponderCountParams) = apply {
    ...
    override fun toString() =
        "TransponderCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
