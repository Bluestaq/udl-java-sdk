...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteTupleResponse].
         *
    ...
    /** A builder for [LaunchSiteTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteTupleResponse: LaunchSiteTupleResponse) = apply {
            classificationMarking = launchSiteTupleResponse.classificationMarking
            code = launchSiteTupleResponse.code
            dataMode = launchSiteTupleResponse.dataMode
            name = launchSiteTupleResponse.name
            source = launchSiteTupleResponse.source
            id = launchSiteTupleResponse.id
            altCode = launchSiteTupleResponse.altCode
            createdAt = launchSiteTupleResponse.createdAt
            createdBy = launchSiteTupleResponse.createdBy
            idSite = launchSiteTupleResponse.idSite
            launchSiteDetails = launchSiteTupleResponse.launchSiteDetails.map { it.toMutableList() }
            origin = launchSiteTupleResponse.origin
            origNetwork = launchSiteTupleResponse.origNetwork
            shortCode = launchSiteTupleResponse.shortCode
            updatedAt = launchSiteTupleResponse.updatedAt
            updatedBy = launchSiteTupleResponse.updatedBy
            additionalProperties = launchSiteTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteTupleResponse].
         *
         ...
         */
        fun build(): LaunchSiteTupleResponse =
    ...
    fun validate(): LaunchSiteTupleResponse = apply {
        if (validated) {
            return@apply
        }
