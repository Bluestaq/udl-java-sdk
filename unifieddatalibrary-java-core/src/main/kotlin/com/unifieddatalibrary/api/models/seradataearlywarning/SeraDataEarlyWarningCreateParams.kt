 ...
 * team for assistance.
 */
class SeraDataEarlyWarningCreateParams
private constructor(
    ...
    fun missileLaunchPhaseDetectionAbility(): Optional<String> =
        body.missileLaunchPhaseDetectionAbility()
    ...
    fun _missileLaunchPhaseDetectionAbility(): JsonField<String> =
        body._missileLaunchPhaseDetectionAbility()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(seraDataEarlyWarningCreateParams: SeraDataEarlyWarningCreateParams) =
            apply {
                ...
                additionalQueryParams =
                    seraDataEarlyWarningCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Is the sensor Earth Pointing. */
        fun earthPointing(earthPointing: Boolean) = apply { body.earthPointing(earthPointing) }
        ...
        /** Frequency Limits for this IR. */
        fun frequencyLimits(frequencyLimits: String) = apply {
        ...
        /** UUID of the parent IR record. */
        fun idIr(idIr: String) = apply { body.idIr(idIr) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun idIr(idIr: JsonField<String>) = apply { body.idIr(idIr) }
        ...
        /** Missile Launch Phase Detection Ability. */
        fun missileLaunchPhaseDetectionAbility(missileLaunchPhaseDetectionAbility: String) = apply {
        ...
        ) = apply { body.missileLaunchPhaseDetectionAbility(missileLaunchPhaseDetectionAbility) }
        ...
        /** Spectral Bands, e.g. Infra-Red. */
        fun spectralBands(spectralBands: String) = apply { body.spectralBands(spectralBands) }
    ...
    override fun toString() =
        "SeraDataEarlyWarningCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
