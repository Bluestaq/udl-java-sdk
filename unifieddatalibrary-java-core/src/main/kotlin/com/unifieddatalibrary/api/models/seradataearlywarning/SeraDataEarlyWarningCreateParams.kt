...
class SeraDataEarlyWarningCreateParams private constructor(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun earthPointing(): Optional<Boolean> = body.earthPointing()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun frequencyLimits(): Optional<String> = body.frequencyLimits()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun idIr(): Optional<String> = body.idIr()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun missileLaunchPhaseDetectionAbility(): Optional<String> = body.missileLaunchPhaseDetectionAbility()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun spectralBands(): Optional<String> = body.spectralBands()
     ...
     */
    fun _earthPointing(): JsonField<Boolean> = body._earthPointing()
     ...
     */
    fun _frequencyLimits(): JsonField<String> = body._frequencyLimits()
     ...
     */
    fun _idIr(): JsonField<String> = body._idIr()
     ...
     */
    fun _missileLaunchPhaseDetectionAbility(): JsonField<String> = body._missileLaunchPhaseDetectionAbility()
     ...
     */
    fun _spectralBands(): JsonField<String> = body._spectralBands()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeraDataEarlyWarningCreateParams].
         *
    ...
    /** A builder for [SeraDataEarlyWarningCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningCreateParams: SeraDataEarlyWarningCreateParams) =
            apply {
                body = seraDataEarlyWarningCreateParams.body.toBuilder()
                additionalHeaders = seraDataEarlyWarningCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = seraDataEarlyWarningCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Is the sensor Earth Pointing. */
        fun earthPointing(earthPointing: Boolean) =
            apply {
                body.earthPointing(earthPointing)
            }
        ...
        fun frequencyLimits(frequencyLimits: String) =
            apply {
                body.frequencyLimits(frequencyLimits)
            }
        ...
        fun missileLaunchPhaseDetectionAbility(missileLaunchPhaseDetectionAbility: String) =
            apply {
                body.missileLaunchPhaseDetectionAbility(missileLaunchPhaseDetectionAbility)
            }
        ...
        /** Payload notes. */
        fun payloadNotes(payloadNotes: String) =
            apply {
        ...
        /** Spectral Bands, e.g. Infra-Red. */
        fun spectralBands(spectralBands: String) =
            apply {
                body.spectralBands(spectralBands)
            }
        ...
        /**
         * Returns an immutable instance of [SeraDataEarlyWarningCreateParams].
         *
         ...
         */
        fun build(): SeraDataEarlyWarningCreateParams =
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    earthPointing = body.earthPointing
                    frequencyLimits = body.frequencyLimits
                    ...
                    missileLaunchPhaseDetectionAbility = body.missileLaunchPhaseDetectionAbility
                    name = body.name
                    origin = body.origin
                    origNetwork = body.origNetwork
                    partnerSpacecraftId = body.partnerSpacecraftId
                    payloadNotes = body.payloadNotes
                    spectralBands = body.spectralBands
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeraDataEarlyWarningCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "SeraDataEarlyWarningCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
