...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BeamCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamCountParams: BeamCountParams) = apply {
    ...
    override fun toString() =
        "BeamCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
