...
/**
 * Service operation intended for initial integration only, to take a list of dropzone records as a
 ...
 */
class DropzoneCreateBulkParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DropzoneCreateBulkParams].
         *
    ...
    /** A builder for [DropzoneCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneCreateBulkParams: DropzoneCreateBulkParams) = apply {
            body = dropzoneCreateBulkParams.body.toMutableList()
            additionalHeaders = dropzoneCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = dropzoneCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DropzoneCreateBulkParams].
         *
         ...
         */
        fun build(): DropzoneCreateBulkParams =
    ...
    /**
     * Properties and characteristics of a Drop Zone, including name, location, shape, type code,
    ...
    private constructor(
         ...
         *
         * Unlike [altCountryName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("altCountryName")
        @ExcludeMissing
         ...
         *
         * Unlike [extIdentifier], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        ...
        class Builder internal constructor() {
            ...
            /**
             * WGS84 latitude of the drop zone, in degrees. -90 to 90 degrees (negative values south
             * of equator).
             */
            ...
            /**
             * WGS84 longitude of the drop zone, in degrees. -180 to 180 degrees (negative values
            ...
            /**
             * Specifies an alternate country code for the drop zone if the data provider code is
             * not part of an official Country Code standard such as ISO-3166 or FIPS. This field
             * will be set to the value provided by the source and should be used for all Queries
             ...
             * code.
             */
            fun altCountryName(altCountryName: String) =
                altCountryName(JsonField.of(altCountryName))
             ...
             * country in the UDL’s country API. Call udl/country/{code} to get any associated FIPS
             * code, ISO Alpha-3 code, or alternate code values that exist for the specified country
             * code.
             */
             ...
             *
             * You should usually call [Builder.expirationDate] with a well-typed [OffsetDateTime]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.extIdentifier] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.nearestLoc] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.zarId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DropzoneCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "DropzoneCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
