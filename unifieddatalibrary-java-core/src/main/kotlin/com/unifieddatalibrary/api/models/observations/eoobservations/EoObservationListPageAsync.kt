...
class EoObservationListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<EoObservationListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationListPageAsync: EoObservationListPageAsync) =
            apply {
        ...
        fun service(service: EoObservationServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: EoObservationListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<EoObservationAbridged>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EoObservationListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, streamHandlerExecutor, params, items) /* spotless:on */

    override fun toString() = "EoObservationListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
