...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConjunctionCountParams].
         *
    ...
    /** A builder for [ConjunctionCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conjunctionCountParams: ConjunctionCountParams) = apply {
            tca = conjunctionCountParams.tca
            firstResult = conjunctionCountParams.firstResult
            maxResults = conjunctionCountParams.maxResults
            additionalHeaders = conjunctionCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = conjunctionCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ConjunctionCountParams].
         *
         ...
         */
        fun build(): ConjunctionCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConjunctionCountParams && tca == other.tca && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ConjunctionCountParams{tca=$tca, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
