...
/**
 * Model representation of observation data for passive radar based sensor phenomenologies. Passive
 * radar is a form of radar that instead of using a dedicated transmitter, as is the case for
 * traditional radar, utilizes radio frequency (RF) energy already in the environment. With an
 * abundance of existing energy available from geographically diverse sources, passive radar offers
 * wide field of view coverage and long observation times. A passive radar system is comprised of
 * separately located transmitter (for example, FM radio stations), a reference receiver, and a
 * surveillance sensor. The transmitted signal illuminates multiple targets over a broad angular
 * extent as well as providing a signal at the reference site. The reflected energy is received at
 * the surveillance site for processing with the reference signal. The long observation durations
 * that are possible with this technology enables an accurate orbit to be determined within a single
 * pass.
 */
class PassiveRadarObservationTupleResponse
...
private constructor(
    ...
    /**
     * The target Acceleration measurement, in kilometers per second squared, for this observation.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The target Acceleration uncertainty measurement, in kilometers per second squared, for this
     * observation.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * One sigma uncertainty in the bistatic range acceleration measurement, in kilometers per
     * second squared.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * One sigma uncertainty in rate of change of the bistatic path, in kilometers per second.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * One sigma uncertainty in orthogonal polarization Radar Cross Section, in meters squared.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * One sigma uncertainty in principal polarization Radar Cross Section, in meters squared.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            passiveRadarObservationTupleResponse: PassiveRadarObservationTupleResponse
        ) = apply {
            ...
            senReferenceFrame = passiveRadarObservationTupleResponse.senReferenceFrame
            senx = passiveRadarObservationTupleResponse.senx
            seny = passiveRadarObservationTupleResponse.seny
            senz = passiveRadarObservationTupleResponse.senz
            ...
            additionalProperties =
                passiveRadarObservationTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * The target Acceleration uncertainty measurement, in kilometers per second squared, for
         * this observation.
         */
        ...
        /**
         * The reference frame of the observing sensor state. If the senReferenceFrame is null, it
     ...
     *   its expected type.
     */
    fun validate(): PassiveRadarObservationTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PassiveRadarObservationTupleResponse &&
