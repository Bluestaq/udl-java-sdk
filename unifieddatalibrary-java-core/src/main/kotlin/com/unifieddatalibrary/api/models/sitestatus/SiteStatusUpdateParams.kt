...
class SiteStatusUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiteStatusUpdateParams].
         *
    ...
    /** A builder for [SiteStatusUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusUpdateParams: SiteStatusUpdateParams) =
            apply {
                pathId = siteStatusUpdateParams.pathId
                body = siteStatusUpdateParams.body.toBuilder()
                additionalHeaders = siteStatusUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = siteStatusUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SiteStatusUpdateParams].
         *
         ...
         */
        fun build(): SiteStatusUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteStatusUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "SiteStatusUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
