...
/**
 * Service operation to update a single SiteStatus object. A specific role is required to perform
 * this service operation. Please contact the UDL team for assistance.
 */
class SiteStatusUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusUpdateParams: SiteStatusUpdateParams) = apply {
    ...
    override fun toString() =
        "SiteStatusUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
