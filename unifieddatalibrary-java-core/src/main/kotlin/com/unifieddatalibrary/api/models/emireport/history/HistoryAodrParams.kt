...
private constructor(
    private val reportTime: OffsetDateTime,
     ...
     */
    fun reportTime(): OffsetDateTime = reportTime
    ...
    class Builder internal constructor() {
        ...
        private var reportTime: OffsetDateTime? = null
        ...
        internal fun from(historyAodrParams: HistoryAodrParams) = apply {
            reportTime = historyAodrParams.reportTime
         ...
         * precision. (YYYY-MM-DDTHH:MM:SS.sssZ)
         */
        fun reportTime(reportTime: OffsetDateTime) = apply { this.reportTime = reportTime }
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("reportTime", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(reportTime))
    ...
    override fun toString() =
        "HistoryAodrParams{reportTime=$reportTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
