...
class PortListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortListResponse].
         *
    ...
    /** A builder for [PortListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portListResponse: PortListResponse) =
            apply {
                classificationMarking = portListResponse.classificationMarking
                dataMode = portListResponse.dataMode
                source = portListResponse.source
                id = portListResponse.id
                avgDuration = portListResponse.avgDuration
                countryCode = portListResponse.countryCode
                createdAt = portListResponse.createdAt
                createdBy = portListResponse.createdBy
                externalId = portListResponse.externalId
                harborSize = portListResponse.harborSize
                harborType = portListResponse.harborType
                idSite = portListResponse.idSite
                lat = portListResponse.lat
                locode = portListResponse.locode
                lon = portListResponse.lon
                maxDraught = portListResponse.maxDraught
                origin = portListResponse.origin
                origNetwork = portListResponse.origNetwork
                pilotReqd = portListResponse.pilotReqd
                portName = portListResponse.portName
                shelter = portListResponse.shelter
                tideRange = portListResponse.tideRange
                additionalProperties = portListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PortListResponse].
         *
    ...
    override fun toString() = "PortListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, avgDuration=$avgDuration, countryCode=$countryCode, createdAt=$createdAt, createdBy=$createdBy, externalId=$externalId, harborSize=$harborSize, harborType=$harborType, idSite=$idSite, lat=$lat, locode=$locode, lon=$lon, maxDraught=$maxDraught, origin=$origin, origNetwork=$origNetwork, pilotReqd=$pilotReqd, portName=$portName, shelter=$shelter, tideRange=$tideRange, additionalProperties=$additionalProperties}"
}
