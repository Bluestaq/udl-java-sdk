...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SubstatusCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SubstatusCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SubstatusCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(substatusCountParams: SubstatusCountParams) = apply {
            firstResult = substatusCountParams.firstResult
            maxResults = substatusCountParams.maxResults
            additionalHeaders = substatusCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = substatusCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SubstatusCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SubstatusCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubstatusCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SubstatusCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
