...
class SarObservationGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SarObservationGetResponse].
         *
    ...
    /** A builder for [SarObservationGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationGetResponse: SarObservationGetResponse) =
            apply {
                classificationMarking = sarObservationGetResponse.classificationMarking
                collectionEnd = sarObservationGetResponse.collectionEnd
                collectionStart = sarObservationGetResponse.collectionStart
                dataMode = sarObservationGetResponse.dataMode
                sarMode = sarObservationGetResponse.sarMode
                source = sarObservationGetResponse.source
                id = sarObservationGetResponse.id
                agjson = sarObservationGetResponse.agjson
                andims = sarObservationGetResponse.andims
                area = sarObservationGetResponse.area
                asrid = sarObservationGetResponse.asrid
                atext = sarObservationGetResponse.atext
                atype = sarObservationGetResponse.atype
                azimuthAngle = sarObservationGetResponse.azimuthAngle
                centerTime = sarObservationGetResponse.centerTime
                collectionId = sarObservationGetResponse.collectionId
                continuousSpotAngle = sarObservationGetResponse.continuousSpotAngle
                coordSys = sarObservationGetResponse.coordSys
                createdAt = sarObservationGetResponse.createdAt
                createdBy = sarObservationGetResponse.createdBy
                detectionEnd = sarObservationGetResponse.detectionEnd
                detectionId = sarObservationGetResponse.detectionId
                detectionStart = sarObservationGetResponse.detectionStart
                dwellTime = sarObservationGetResponse.dwellTime
                externalId = sarObservationGetResponse.externalId
                farRange = sarObservationGetResponse.farRange
                grazeAngle = sarObservationGetResponse.grazeAngle
                groundResolutionProjection = sarObservationGetResponse.groundResolutionProjection
                idOnOrbit = sarObservationGetResponse.idOnOrbit
                idSensor = sarObservationGetResponse.idSensor
                incidenceAngle = sarObservationGetResponse.incidenceAngle
                looksAzimuth = sarObservationGetResponse.looksAzimuth
                looksRange = sarObservationGetResponse.looksRange
                multilookNumber = sarObservationGetResponse.multilookNumber
                nearRange = sarObservationGetResponse.nearRange
                obDirection = sarObservationGetResponse.obDirection
                onOrbit = sarObservationGetResponse.onOrbit
                operatingBand = sarObservationGetResponse.operatingBand
                operatingFreq = sarObservationGetResponse.operatingFreq
                orbitState = sarObservationGetResponse.orbitState
                origin = sarObservationGetResponse.origin
                origNetwork = sarObservationGetResponse.origNetwork
                origObjectId = sarObservationGetResponse.origObjectId
                origSensorId = sarObservationGetResponse.origSensorId
                pulseBandwidth = sarObservationGetResponse.pulseBandwidth
                pulseDuration = sarObservationGetResponse.pulseDuration
                resolutionAzimuth = sarObservationGetResponse.resolutionAzimuth
                resolutionRange = sarObservationGetResponse.resolutionRange
                rxPolarization = sarObservationGetResponse.rxPolarization
                satNo = sarObservationGetResponse.satNo
                senalt = sarObservationGetResponse.senalt
                senlatEnd = sarObservationGetResponse.senlatEnd
                senlatStart = sarObservationGetResponse.senlatStart
                senlonEnd = sarObservationGetResponse.senlonEnd
                senlonStart = sarObservationGetResponse.senlonStart
                senvelx = sarObservationGetResponse.senvelx
                senvely = sarObservationGetResponse.senvely
                senvelz = sarObservationGetResponse.senvelz
                slantRange = sarObservationGetResponse.slantRange
                snr = sarObservationGetResponse.snr
                sourceDl = sarObservationGetResponse.sourceDl
                spacingAzimuth = sarObservationGetResponse.spacingAzimuth
                spacingRange = sarObservationGetResponse.spacingRange
                squintAngle = sarObservationGetResponse.squintAngle
                srcIds = sarObservationGetResponse.srcIds.map { it.toMutableList() }
                srcTyps = sarObservationGetResponse.srcTyps.map { it.toMutableList() }
                swathLength = sarObservationGetResponse.swathLength
                tags = sarObservationGetResponse.tags.map { it.toMutableList() }
                targetposx = sarObservationGetResponse.targetposx
                targetposy = sarObservationGetResponse.targetposy
                targetposz = sarObservationGetResponse.targetposz
                transactionId = sarObservationGetResponse.transactionId
                txPolarization = sarObservationGetResponse.txPolarization
                additionalProperties = sarObservationGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SarObservationGetResponse].
         *
         ...
         */
        fun build(): SarObservationGetResponse =
    ...
    fun validate(): SarObservationGetResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (if (collectionEnd.asKnown().isPresent) 1 else 0) + (if (collectionStart.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (sarMode.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (agjson.asKnown().isPresent) 1 else 0) + (if (andims.asKnown().isPresent) 1 else 0) + (if (area.asKnown().isPresent) 1 else 0) + (if (asrid.asKnown().isPresent) 1 else 0) + (if (atext.asKnown().isPresent) 1 else 0) + (if (atype.asKnown().isPresent) 1 else 0) + (if (azimuthAngle.asKnown().isPresent) 1 else 0) + (if (centerTime.asKnown().isPresent) 1 else 0) + (if (collectionId.asKnown().isPresent) 1 else 0) + (if (continuousSpotAngle.asKnown().isPresent) 1 else 0) + (if (coordSys.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (detectionEnd.asKnown().isPresent) 1 else 0) + (if (detectionId.asKnown().isPresent) 1 else 0) + (if (detectionStart.asKnown().isPresent) 1 else 0) + (if (dwellTime.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (if (farRange.asKnown().isPresent) 1 else 0) + (if (grazeAngle.asKnown().isPresent) 1 else 0) + (if (groundResolutionProjection.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (incidenceAngle.asKnown().isPresent) 1 else 0) + (if (looksAzimuth.asKnown().isPresent) 1 else 0) + (if (looksRange.asKnown().isPresent) 1 else 0) + (if (multilookNumber.asKnown().isPresent) 1 else 0) + (if (nearRange.asKnown().isPresent) 1 else 0) + (if (obDirection.asKnown().isPresent) 1 else 0) + (onOrbit.asKnown().getOrNull()?.validity() ?: 0) + (if (operatingBand.asKnown().isPresent) 1 else 0) + (if (operatingFreq.asKnown().isPresent) 1 else 0) + (if (orbitState.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (pulseBandwidth.asKnown().isPresent) 1 else 0) + (if (pulseDuration.asKnown().isPresent) 1 else 0) + (if (resolutionAzimuth.asKnown().isPresent) 1 else 0) + (if (resolutionRange.asKnown().isPresent) 1 else 0) + (if (rxPolarization.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlatEnd.asKnown().isPresent) 1 else 0) + (if (senlatStart.asKnown().isPresent) 1 else 0) + (if (senlonEnd.asKnown().isPresent) 1 else 0) + (if (senlonStart.asKnown().isPresent) 1 else 0) + (if (senvelx.asKnown().isPresent) 1 else 0) + (if (senvely.asKnown().isPresent) 1 else 0) + (if (senvelz.asKnown().isPresent) 1 else 0) + (if (slantRange.asKnown().isPresent) 1 else 0) + (if (snr.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (spacingAzimuth.asKnown().isPresent) 1 else 0) + (if (spacingRange.asKnown().isPresent) 1 else 0) + (if (squintAngle.asKnown().isPresent) 1 else 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (if (swathLength.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (targetposx.asKnown().isPresent) 1 else 0) + (if (targetposy.asKnown().isPresent) 1 else 0) + (if (targetposz.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (txPolarization.asKnown().isPresent) 1 else 0)
