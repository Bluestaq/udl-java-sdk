 ...
 */
class SarObservationGetResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationGetResponse: SarObservationGetResponse) = apply {
    ...
    fun validate(): SarObservationGetResponse = apply {
        if (validated) {
            return@apply
        }
