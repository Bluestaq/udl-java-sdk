...
class RfEmitterGetResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("rfEmitterDetails") @ExcludeMissing rfEmitterDetails: JsonField<List<RfEmitterDetail>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun rfEmitterDetails(): Optional<List<RfEmitterDetail>> = rfEmitterDetails.getOptional("rfEmitterDetails")
     ...
     *
     * Unlike [rfEmitterDetails], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterGetResponse: RfEmitterGetResponse) =
            apply {
        ...
        /** Read-only details for this RFEmitter. */
        fun rfEmitterDetails(rfEmitterDetails: List<RfEmitterDetail>) = rfEmitterDetails(JsonField.of(rfEmitterDetails))

        /**
         * Sets [Builder.rfEmitterDetails] to an arbitrary JSON value.
         *
         * You should usually call [Builder.rfEmitterDetails] with a well-typed `List<RfEmitterDetail>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rfEmitterDetails(rfEmitterDetails: JsonField<List<RfEmitterDetail>>) =
            apply {
         ...
         */
        fun addRfEmitterDetail(rfEmitterDetail: RfEmitterDetail) =
            apply {
                rfEmitterDetails = (rfEmitterDetails ?: JsonField.of(mutableListOf())).also {
    ...
    fun validate(): RfEmitterGetResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (entity.asKnown().getOrNull()?.validity() ?: 0) + (if (idEntity.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (rfEmitterDetails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    class RfEmitterDetail private constructor(
        private val classificationMarking: JsonField<String>,
        private val dataMode: JsonField<DataMode>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(rfEmitterDetail: RfEmitterDetail) =
                apply {
                    ...
                    antennaDiameter = rfEmitterDetail.antennaDiameter
                    antennaSize = rfEmitterDetail.antennaSize.map { it.toMutableList() }
                    ...
                    manufacturerOrgId = rfEmitterDetail.manufacturerOrgId
                    ...
                    productionFacilityLocationId = rfEmitterDetail.productionFacilityLocationId
                    productionFacilityName = rfEmitterDetail.productionFacilityName
                    receiverBandwidth = rfEmitterDetail.receiverBandwidth
                    receiverSensitivity = rfEmitterDetail.receiverSensitivity
                    ...
                    transmitPower = rfEmitterDetail.transmitPower
                    transmitterBandwidth = rfEmitterDetail.transmitterBandwidth
                    transmitterFrequency = rfEmitterDetail.transmitterFrequency
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfEmitterGetResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && name == other.name && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && entity == other.entity && idEntity == other.idEntity && origin == other.origin && origNetwork == other.origNetwork && rfEmitterDetails == other.rfEmitterDetails && type == other.type && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, name, source, id, createdAt, createdBy, entity, idEntity, origin, origNetwork, rfEmitterDetails, type, updatedAt, updatedBy, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "RfEmitterGetResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, entity=$entity, idEntity=$idEntity, origin=$origin, origNetwork=$origNetwork, rfEmitterDetails=$rfEmitterDetails, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
