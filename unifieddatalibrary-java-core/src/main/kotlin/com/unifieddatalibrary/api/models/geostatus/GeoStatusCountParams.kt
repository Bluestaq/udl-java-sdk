...
class GeoStatusCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GeoStatusCountParams].
         *
    ...
    /** A builder for [GeoStatusCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusCountParams: GeoStatusCountParams) =
            apply {
                createdAt = geoStatusCountParams.createdAt
                firstResult = geoStatusCountParams.firstResult
                maxResults = geoStatusCountParams.maxResults
                additionalHeaders = geoStatusCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = geoStatusCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GeoStatusCountParams].
         *
         ...
         */
        fun build(): GeoStatusCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GeoStatusCountParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "GeoStatusCountParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
