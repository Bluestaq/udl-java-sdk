...
/**
 * Service operation to update a single AntennaDetails. An antenna may have multiple details records
 * compiled by various sources. A specific role is required to perform this service operation.
 * Please contact the UDL team for assistance.
 */
class AntennaDetailUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AntennaDetailUpdateParams].
         *
    ...
    /** A builder for [AntennaDetailUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaDetailUpdateParams: AntennaDetailUpdateParams) = apply {
            pathId = antennaDetailUpdateParams.pathId
            body = antennaDetailUpdateParams.body.toBuilder()
            additionalHeaders = antennaDetailUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = antennaDetailUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Boolean indicating if this is a beam forming antenna. */
        fun beamForming(beamForming: Boolean) = apply { body.beamForming(beamForming) }
         ...
         * value.
         */
        fun beamForming(beamForming: JsonField<Boolean>) = apply { body.beamForming(beamForming) }
        ...
        /** Antenna end of frequency range in Mhz. */
        fun endFrequency(endFrequency: Double) = apply { body.endFrequency(endFrequency) }
        ...
        /** Antenna gain tolerance in dB. */
        fun gainTolerance(gainTolerance: Double) = apply { body.gainTolerance(gainTolerance) }
        ...
        /** Antenna polarization in degrees. */
        fun polarization(polarization: Double) = apply { body.polarization(polarization) }
        ...
        /** Antenna position (e.g. Top, Nadir, Side). */
        fun position(position: String) = apply { body.position(position) }
         ...
         * value.
         */
        fun size(size: JsonField<List<Double>>) = apply { body.size(size) }
         ...
         */
        fun addSize(size: Double) = apply { body.addSize(size) }

        /** Antenna start of frequency range in Mhz. */
        fun startFrequency(startFrequency: Double) = apply { body.startFrequency(startFrequency) }
        ...
        /** Boolean indicating if this antenna is steerable. */
        fun steerable(steerable: Boolean) = apply { body.steerable(steerable) }
         ...
         * value.
         */
        fun steerable(steerable: JsonField<Boolean>) = apply { body.steerable(steerable) }
        ...
        /**
         * Returns an immutable instance of [AntennaDetailUpdateParams].
         *
         ...
         */
        fun build(): AntennaDetailUpdateParams =
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            steerable: JsonField<Boolean> = JsonMissing.of(),
         ...
         * Returns the raw JSON value of [gainTolerance].
         *
         * Unlike [gainTolerance], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("gainTolerance")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.beamForming] to an arbitrary JSON value.
             *
             * You should usually call [Builder.beamForming] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun beamForming(beamForming: JsonField<Boolean>) = apply {
             ...
             * Sets [Builder.gainTolerance] to an arbitrary JSON value.
             *
             * You should usually call [Builder.gainTolerance] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun gainTolerance(gainTolerance: JsonField<Double>) = apply {
             ...
             * Sets [Builder.polarization] to an arbitrary JSON value.
             *
             * You should usually call [Builder.polarization] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun polarization(polarization: JsonField<Double>) = apply {
             ...
             * Sets [Builder.size] to an arbitrary JSON value.
             *
             * You should usually call [Builder.size] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.steerable] to an arbitrary JSON value.
             *
             * You should usually call [Builder.steerable] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idAntenna == other.idAntenna && source == other.source && bodyId == other.bodyId && beamForming == other.beamForming && beamwidth == other.beamwidth && createdAt == other.createdAt && createdBy == other.createdBy && description == other.description && diameter == other.diameter && endFrequency == other.endFrequency && gain == other.gain && gainTolerance == other.gainTolerance && manufacturerOrgId == other.manufacturerOrgId && mode == other.mode && origin == other.origin && origNetwork == other.origNetwork && polarization == other.polarization && position == other.position && size == other.size && startFrequency == other.startFrequency && steerable == other.steerable && tags == other.tags && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idAntenna, source, bodyId, beamForming, beamwidth, createdAt, createdBy, description, diameter, endFrequency, gain, gainTolerance, manufacturerOrgId, mode, origin, origNetwork, polarization, position, size, startFrequency, steerable, tags, type, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idAntenna=$idAntenna, source=$source, bodyId=$bodyId, beamForming=$beamForming, beamwidth=$beamwidth, createdAt=$createdAt, createdBy=$createdBy, description=$description, diameter=$diameter, endFrequency=$endFrequency, gain=$gain, gainTolerance=$gainTolerance, manufacturerOrgId=$manufacturerOrgId, mode=$mode, origin=$origin, origNetwork=$origNetwork, polarization=$polarization, position=$position, size=$size, startFrequency=$startFrequency, steerable=$steerable, tags=$tags, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AntennaDetailUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AntennaDetailUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
