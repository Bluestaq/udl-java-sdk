...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AntennaCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaCountParams: AntennaCountParams) = apply {
    ...
    override fun toString() =
        "AntennaCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
