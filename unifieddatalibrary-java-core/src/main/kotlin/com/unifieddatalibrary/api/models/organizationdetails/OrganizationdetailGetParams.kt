...
class OrganizationdetailGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OrganizationdetailGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OrganizationdetailGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OrganizationdetailGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationdetailGetParams: OrganizationdetailGetParams) =
            apply {
                id = organizationdetailGetParams.id
                firstResult = organizationdetailGetParams.firstResult
                maxResults = organizationdetailGetParams.maxResults
                additionalHeaders = organizationdetailGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = organizationdetailGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OrganizationdetailGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OrganizationdetailGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrganizationdetailGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OrganizationdetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
