 ...
 * sources.
 */
class OrganizationdetailGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OrganizationdetailGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationdetailGetParams: OrganizationdetailGetParams) = apply {
    ...
    override fun toString() =
        "OrganizationdetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
