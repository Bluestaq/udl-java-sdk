...
class ItemTrackingListResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingListResponse: ItemTrackingListResponse) = apply {
    ...
    fun validate(): ItemTrackingListResponse = apply {
        if (validated) {
            return@apply
        }
