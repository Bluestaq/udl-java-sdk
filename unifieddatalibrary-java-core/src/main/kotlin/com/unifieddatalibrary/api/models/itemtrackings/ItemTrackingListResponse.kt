...
class ItemTrackingListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemTrackingListResponse].
         *
    ...
    /** A builder for [ItemTrackingListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingListResponse: ItemTrackingListResponse) =
            apply {
                classificationMarking = itemTrackingListResponse.classificationMarking
                dataMode = itemTrackingListResponse.dataMode
                scanCode = itemTrackingListResponse.scanCode
                scannerId = itemTrackingListResponse.scannerId
                source = itemTrackingListResponse.source
                ts = itemTrackingListResponse.ts
                id = itemTrackingListResponse.id
                createdAt = itemTrackingListResponse.createdAt
                createdBy = itemTrackingListResponse.createdBy
                dvCode = itemTrackingListResponse.dvCode
                idItem = itemTrackingListResponse.idItem
                keys = itemTrackingListResponse.keys.map { it.toMutableList() }
                lat = itemTrackingListResponse.lat
                lon = itemTrackingListResponse.lon
                notes = itemTrackingListResponse.notes
                origin = itemTrackingListResponse.origin
                origNetwork = itemTrackingListResponse.origNetwork
                scanType = itemTrackingListResponse.scanType
                scGenTool = itemTrackingListResponse.scGenTool
                sourceDl = itemTrackingListResponse.sourceDl
                type = itemTrackingListResponse.type
                values = itemTrackingListResponse.values.map { it.toMutableList() }
                additionalProperties = itemTrackingListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ItemTrackingListResponse].
         *
         ...
         */
        fun build(): ItemTrackingListResponse =
    ...
    fun validate(): ItemTrackingListResponse =
        apply {
            if (validated) {
              return@apply
            }
