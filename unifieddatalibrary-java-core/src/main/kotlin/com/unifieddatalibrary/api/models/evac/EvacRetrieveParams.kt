...
class EvacRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EvacRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EvacRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EvacRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evacRetrieveParams: EvacRetrieveParams) =
            apply {
                id = evacRetrieveParams.id
                firstResult = evacRetrieveParams.firstResult
                maxResults = evacRetrieveParams.maxResults
                additionalHeaders = evacRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = evacRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EvacRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EvacRetrieveParams =
            EvacRetrieveParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EvacRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EvacRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
