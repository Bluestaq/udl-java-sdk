...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EvacRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evacRetrieveParams: EvacRetrieveParams) = apply {
    ...
    override fun toString() =
        "EvacRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
