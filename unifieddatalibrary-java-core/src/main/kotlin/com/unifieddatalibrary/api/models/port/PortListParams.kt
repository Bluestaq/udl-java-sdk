...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PortListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portListParams: PortListParams) = apply {
    ...
    override fun toString() =
        "PortListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
