...
class CalibrationQueryResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalibrationQueryResponse].
         *
    ...
    /** A builder for [CalibrationQueryResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationQueryResponse: CalibrationQueryResponse) =
            apply {
                classificationMarking = calibrationQueryResponse.classificationMarking
                dataMode = calibrationQueryResponse.dataMode
                idSensor = calibrationQueryResponse.idSensor
                source = calibrationQueryResponse.source
                startTime = calibrationQueryResponse.startTime
                id = calibrationQueryResponse.id
                azRaAccelBias = calibrationQueryResponse.azRaAccelBias
                azRaAccelSigma = calibrationQueryResponse.azRaAccelSigma
                azRaBias = calibrationQueryResponse.azRaBias
                azRaRateBias = calibrationQueryResponse.azRaRateBias
                azRaRateSigma = calibrationQueryResponse.azRaRateSigma
                azRaRms = calibrationQueryResponse.azRaRms
                azRaSigma = calibrationQueryResponse.azRaSigma
                calAngleRef = calibrationQueryResponse.calAngleRef
                calTrackMode = calibrationQueryResponse.calTrackMode
                calType = calibrationQueryResponse.calType
                confidenceNoiseBias = calibrationQueryResponse.confidenceNoiseBias
                createdAt = calibrationQueryResponse.createdAt
                createdBy = calibrationQueryResponse.createdBy
                duration = calibrationQueryResponse.duration
                ecr = calibrationQueryResponse.ecr.map { it.toMutableList() }
                elDecAccelBias = calibrationQueryResponse.elDecAccelBias
                elDecAccelSigma = calibrationQueryResponse.elDecAccelSigma
                elDecBias = calibrationQueryResponse.elDecBias
                elDecRateBias = calibrationQueryResponse.elDecRateBias
                elDecRateSigma = calibrationQueryResponse.elDecRateSigma
                elDecRms = calibrationQueryResponse.elDecRms
                elDecSigma = calibrationQueryResponse.elDecSigma
                endTime = calibrationQueryResponse.endTime
                numAzRaObs = calibrationQueryResponse.numAzRaObs
                numElDecObs = calibrationQueryResponse.numElDecObs
                numObs = calibrationQueryResponse.numObs
                numPhotoObs = calibrationQueryResponse.numPhotoObs
                numRangeObs = calibrationQueryResponse.numRangeObs
                numRangeRateObs = calibrationQueryResponse.numRangeRateObs
                numRcsObs = calibrationQueryResponse.numRcsObs
                numTimeObs = calibrationQueryResponse.numTimeObs
                numTracks = calibrationQueryResponse.numTracks
                origin = calibrationQueryResponse.origin
                origNetwork = calibrationQueryResponse.origNetwork
                photoBias = calibrationQueryResponse.photoBias
                photoSigma = calibrationQueryResponse.photoSigma
                rangeAccelBias = calibrationQueryResponse.rangeAccelBias
                rangeAccelSigma = calibrationQueryResponse.rangeAccelSigma
                rangeBias = calibrationQueryResponse.rangeBias
                rangeRateBias = calibrationQueryResponse.rangeRateBias
                rangeRateRms = calibrationQueryResponse.rangeRateRms
                rangeRateSigma = calibrationQueryResponse.rangeRateSigma
                rangeRms = calibrationQueryResponse.rangeRms
                rangeSigma = calibrationQueryResponse.rangeSigma
                rcsBias = calibrationQueryResponse.rcsBias
                rcsSigma = calibrationQueryResponse.rcsSigma
                refTargets = calibrationQueryResponse.refTargets.map { it.toMutableList() }
                refType = calibrationQueryResponse.refType
                senType = calibrationQueryResponse.senType
                sourceDl = calibrationQueryResponse.sourceDl
                timeBias = calibrationQueryResponse.timeBias
                timeBiasSigma = calibrationQueryResponse.timeBiasSigma
                additionalProperties = calibrationQueryResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CalibrationQueryResponse].
         *
         ...
         */
        fun build(): CalibrationQueryResponse =
    ...
    fun validate(): CalibrationQueryResponse =
        apply {
            if (validated) {
              return@apply
            }
