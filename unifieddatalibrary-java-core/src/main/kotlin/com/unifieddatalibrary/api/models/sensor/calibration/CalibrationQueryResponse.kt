 ...
 */
class CalibrationQueryResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationQueryResponse: CalibrationQueryResponse) = apply {
    ...
    fun validate(): CalibrationQueryResponse = apply {
        if (validated) {
            return@apply
        }
