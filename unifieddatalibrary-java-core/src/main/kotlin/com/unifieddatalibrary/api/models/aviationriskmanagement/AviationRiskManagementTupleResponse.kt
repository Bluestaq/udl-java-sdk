...
private constructor(
    ...
    /** A builder for [AviationRiskManagementTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            aviationRiskManagementTupleResponse: AviationRiskManagementTupleResponse
        ) = apply {
            classificationMarking = aviationRiskManagementTupleResponse.classificationMarking
            dataMode = aviationRiskManagementTupleResponse.dataMode
            idMission = aviationRiskManagementTupleResponse.idMission
            source = aviationRiskManagementTupleResponse.source
            id = aviationRiskManagementTupleResponse.id
            aviationRiskManagementWorksheetRecord =
                aviationRiskManagementTupleResponse.aviationRiskManagementWorksheetRecord.map {
                    it.toMutableList()
                }
            createdAt = aviationRiskManagementTupleResponse.createdAt
            createdBy = aviationRiskManagementTupleResponse.createdBy
            extMissionId = aviationRiskManagementTupleResponse.extMissionId
            missionNumber = aviationRiskManagementTupleResponse.missionNumber
            orgId = aviationRiskManagementTupleResponse.orgId
            origin = aviationRiskManagementTupleResponse.origin
            origNetwork = aviationRiskManagementTupleResponse.origNetwork
            sourceDl = aviationRiskManagementTupleResponse.sourceDl
            unitId = aviationRiskManagementTupleResponse.unitId
            updatedAt = aviationRiskManagementTupleResponse.updatedAt
            updatedBy = aviationRiskManagementTupleResponse.updatedBy
            additionalProperties =
                aviationRiskManagementTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AviationRiskManagementTupleResponse].
         *
         ...
         */
        fun build(): AviationRiskManagementTupleResponse =
            AviationRiskManagementTupleResponse(
    ...
    fun validate(): AviationRiskManagementTupleResponse = apply {
        if (validated) {
            return@apply
        }
