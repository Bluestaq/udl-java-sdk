...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTupleResponse: ItemTupleResponse) = apply {
    ...
    fun validate(): ItemTupleResponse = apply {
        if (validated) {
            return@apply
        }
