...
class VesselListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselListPageAsync: VesselListPageAsync) =
            apply {
        ...
        fun service(service: VesselServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: VesselListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<VesselListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "VesselListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
