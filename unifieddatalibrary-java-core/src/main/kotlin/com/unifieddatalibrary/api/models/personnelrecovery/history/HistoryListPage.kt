...
private constructor(
    ...
    private val items: List<PersonnelRecoveryFullL>,
) : Page<PersonnelRecoveryFullL> {
    ...
    fun autoPager(): AutoPager<PersonnelRecoveryFullL> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<PersonnelRecoveryFullL> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<PersonnelRecoveryFullL>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<PersonnelRecoveryFullL>) = apply { this.items = items }
