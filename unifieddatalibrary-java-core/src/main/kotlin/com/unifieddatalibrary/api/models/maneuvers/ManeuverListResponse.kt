...
private constructor(
    ...
    private constructor(
        ...
        private val missionCenter: JsonField<String>,
        ...
        private constructor(
            ...
            @JsonProperty("missionCenter")
            @ExcludeMissing
            missionCenter: JsonField<String> = JsonMissing.of(),
            @JsonProperty("msgTs")
            @ExcludeMissing
         ...
         * in terms of equinoctial elements. The size of the covariance matrix is dynamic. The
         ...
         * field should contain only the lower left triangle values from top left down to bottom
         * right, in order.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun missionCenter(): Optional<String> = missionCenter.getOptional("missionCenter")
        ...
        /**
         * Returns the raw JSON value of [missionCenter].
         *
         * Unlike [missionCenter], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("missionCenter")
        @ExcludeMissing
        fun _missionCenter(): JsonField<String> = missionCenter
        ...
        class Builder internal constructor() {
            ...
            private var missionCenter: JsonField<String> = JsonMissing.of()
            ...
            internal fun from(postEventStateVector: PostEventStateVector) = apply {
                ...
                missionCenter = postEventStateVector.missionCenter
            ...
            /** Mission center or organization performing this vector creation. */
            fun missionCenter(missionCenter: String) = missionCenter(JsonField.of(missionCenter))

            /**
             * Sets [Builder.missionCenter] to an arbitrary JSON value.
             *
             * You should usually call [Builder.missionCenter] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun missionCenter(missionCenter: JsonField<String>) = apply {
        ...
        internal fun validity(): Int =
            (if (classificationMarking.asKnown().isPresent) 1 else 0) +
                ...
                (if (missionCenter.asKnown().isPresent) 1 else 0) +
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PostEventStateVector &&
                ...
                mass == other.mass &&
                missionCenter == other.missionCenter &&
                msgTs == other.msgTs &&
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(preEventStateVector: PreEventStateVector) = apply {
                ...
                missionCenter = preEventStateVector.missionCenter
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ManeuverListResponse &&
            classificationMarking == other.classificationMarking &&
            dataMode == other.dataMode &&
