...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeconflictsetGetResponse].
         *
    ...
    /** A builder for [DeconflictsetGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deconflictsetGetResponse: DeconflictsetGetResponse) = apply {
            classificationMarking = deconflictsetGetResponse.classificationMarking
            dataMode = deconflictsetGetResponse.dataMode
            eventStartTime = deconflictsetGetResponse.eventStartTime
            numWindows = deconflictsetGetResponse.numWindows
            source = deconflictsetGetResponse.source
            id = deconflictsetGetResponse.id
            calculationEndTime = deconflictsetGetResponse.calculationEndTime
            calculationId = deconflictsetGetResponse.calculationId
            calculationStartTime = deconflictsetGetResponse.calculationStartTime
            createdAt = deconflictsetGetResponse.createdAt
            createdBy = deconflictsetGetResponse.createdBy
            deconflictWindows =
                deconflictsetGetResponse.deconflictWindows.map { it.toMutableList() }
            errors = deconflictsetGetResponse.errors.map { it.toMutableList() }
            eventEndTime = deconflictsetGetResponse.eventEndTime
            eventType = deconflictsetGetResponse.eventType
            idLaserDeconflictRequest = deconflictsetGetResponse.idLaserDeconflictRequest
            origin = deconflictsetGetResponse.origin
            origNetwork = deconflictsetGetResponse.origNetwork
            referenceFrame = deconflictsetGetResponse.referenceFrame
            sourceDl = deconflictsetGetResponse.sourceDl
            tags = deconflictsetGetResponse.tags.map { it.toMutableList() }
            transactionId = deconflictsetGetResponse.transactionId
            warnings = deconflictsetGetResponse.warnings.map { it.toMutableList() }
            additionalProperties = deconflictsetGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DeconflictsetGetResponse].
         *
         ...
         */
        fun build(): DeconflictsetGetResponse =
    ...
    fun validate(): DeconflictsetGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeconflictsetGetResponse &&
            classificationMarking == other.classificationMarking &&
            dataMode == other.dataMode &&
            eventStartTime == other.eventStartTime &&
