...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackRouteCountParams].
         *
    ...
    /** A builder for [TrackRouteCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackRouteCountParams: TrackRouteCountParams) = apply {
            lastUpdateDate = trackRouteCountParams.lastUpdateDate
            firstResult = trackRouteCountParams.firstResult
            maxResults = trackRouteCountParams.maxResults
            additionalHeaders = trackRouteCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = trackRouteCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TrackRouteCountParams].
         *
         ...
         */
        fun build(): TrackRouteCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackRouteCountParams && lastUpdateDate == other.lastUpdateDate && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(lastUpdateDate, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "TrackRouteCountParams{lastUpdateDate=$lastUpdateDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
