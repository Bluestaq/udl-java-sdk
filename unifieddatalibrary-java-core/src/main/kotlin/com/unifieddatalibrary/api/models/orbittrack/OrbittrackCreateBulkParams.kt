...
/**
 * Service operation intended for initial integration only, to take a list of orbit track records as
 ...
 */
class OrbittrackCreateBulkParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackCreateBulkParams: OrbittrackCreateBulkParams) = apply {
    ...
    /**
     * Keplerian orbital elements describing an orbit for a particular on-orbit satellite and
    ...
    private constructor(
         ...
         *
         * Unlike [amplification], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [trackSensors], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("trackSensors")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.amplification] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The angle formed between the line of sight of the observer and the horizon at track
             * timestamp, in degrees. The angular range is -90 to 90, with negative values
             * representing angle of depression.
             */
             ...
             *
             * You should usually call [Builder.aouData] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The Area of Uncertainty (AoU) type (BEARING, ELLIPSE, OTHER) definition. This type
             * defines the elements of the aouData array and is required if aouData is not null. See
             * the aouData field definition for specific information.
             */
             ...
             *
             * You should usually call [Builder.aouType] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.charlieLine] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun charlieLine(charlieLine: JsonField<String>) = apply {
                this.charlieLine = charlieLine
            }

            /**
             * The cross-reference code of the channel on which this track report was received, if
             * the report came over a comms channel.
             */
             ...
             *
             * You should usually call [Builder.chXRef] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.cntnmnt] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Predicted change in Mean Motion (velocity) in radians/herg^2. herg is a unit of time
             * measure equal to 806.8120769 seconds, and is the orbital period of an imaginary
             * satellite rotating about the Earth at zero altitude.
             */
             ...
             *
             * You should usually call [Builder.decay] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Optional identifier provided by observation source to indicate the target on-orbit
             * object of this track. This may be an internal identifier and not necessarily a valid
             * satellite number.
             */
             ...
             *
             * You should usually call [Builder.rdfRf] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.rptNum] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** TrackSensor Collection. */
            fun trackSensors(trackSensors: List<TrackSensor>) =
                trackSensors(JsonField.of(trackSensors))
             ...
             *
             * You should usually call [Builder.vehType] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun sensorFovType(): Optional<SensorFovType> =
                sensorFovType.getOptional("sensorFOVType")
             ...
             *
             * Unlike [sensorName], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("sensorName")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.az] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                ...
                /** Minimum range measurement capability of the sensor, in kilometers. */
                fun minRangeLimit(minRangeLimit: Double) =
                    minRangeLimit(JsonField.of(minRangeLimit))
                 ...
                 * yet supported value.
                 */
                fun sensorName(sensorName: JsonField<String>) = apply {
                    this.sensorName = sensorName
                }

                /**
                 * Number assigned to this sensor. Since there is no authoritative numbering scheme,
                 * these numbers sometimes collide across sensors (especially commercial sensors).
                 * It is therefore not a unique identifier.
                 */
                 ...
                 *
                 * You should usually call [Builder.sensorNumber] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [SensorFovType]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                ...
                enum class Value {
                    ...
                    UNKNOWN,
                    /**
                     * An enum member indicating that [SensorFovType] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
    ...
    override fun toString() =
        "OrbittrackCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
