...
class OrbittrackCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbittrackCreateBulkParams].
         *
    ...
    /** A builder for [OrbittrackCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackCreateBulkParams: OrbittrackCreateBulkParams) =
            apply {
                body = orbittrackCreateBulkParams.body.toMutableList()
                additionalHeaders = orbittrackCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = orbittrackCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OrbittrackCreateBulkParams].
         *
         ...
         */
        fun build(): OrbittrackCreateBulkParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("trackSensors") @ExcludeMissing private val trackSensors: JsonField<List<TrackSensor>>,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    aouData = body.aouData.map { it.toMutableList() }
                    aouType = body.aouType
                    callSign = body.callSign
                    charlieLine = body.charlieLine
                    chXRef = body.chXRef
                    cntnmnt = body.cntnmnt
                    ...
                    rptNum = body.rptNum
                    satNo = body.satNo
                    satStatus = body.satStatus
                    spd = body.spd
                    taskForce = body.taskForce
                    trackSensors = body.trackSensors.map { it.toMutableList() }
                    trkId = body.trkId
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, lat=$lat, lon=$lon, source=$source, ts=$ts, id=$id, alt=$alt, amplification=$amplification, angElev=$angElev, aouData=$aouData, aouType=$aouType, callSign=$callSign, charlieLine=$charlieLine, chXRef=$chXRef, cntnmnt=$cntnmnt, countryCode=$countryCode, createdAt=$createdAt, createdBy=$createdBy, decay=$decay, dummy=$dummy, feint=$feint, hq=$hq, idElset=$idElset, identAmp=$identAmp, idOnOrbit=$idOnOrbit, iff=$iff, installation=$installation, objectType=$objectType, objIdent=$objIdent, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, rdfRf=$rdfRf, reduced=$reduced, reinforced=$reinforced, rptNum=$rptNum, satNo=$satNo, satStatus=$satStatus, spd=$spd, taskForce=$taskForce, trackSensors=$trackSensors, trkId=$trkId, vehType=$vehType, xref=$xref}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbittrackCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OrbittrackCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
