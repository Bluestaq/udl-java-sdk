...
class RadarobservationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RadarobservationCountParams].
         *
    ...
    /** A builder for [RadarobservationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationCountParams: RadarobservationCountParams) =
            apply {
                obTime = radarobservationCountParams.obTime
                firstResult = radarobservationCountParams.firstResult
                maxResults = radarobservationCountParams.maxResults
                additionalHeaders = radarobservationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = radarobservationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RadarobservationCountParams].
         *
         ...
         */
        fun build(): RadarobservationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RadarobservationCountParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RadarobservationCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
