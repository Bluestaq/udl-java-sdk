...
private constructor(
    ...
    /**
     * Read-only end time at which this elset was no longer the 'current' elset for its satellite.
     * This field and is set by the system automatically and ignored on create/edit operations.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
