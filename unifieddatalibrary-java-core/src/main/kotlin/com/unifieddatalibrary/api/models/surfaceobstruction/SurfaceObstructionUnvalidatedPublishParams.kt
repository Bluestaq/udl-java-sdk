...
/**
 * Service operation to take multiple surfaceobstruction records as a POST body and ingest into the
 ...
 */
class SurfaceObstructionUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            surfaceObstructionUnvalidatedPublishParams: SurfaceObstructionUnvalidatedPublishParams
        ) = apply {
            body = surfaceObstructionUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                surfaceObstructionUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                surfaceObstructionUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun toString() =
        "SurfaceObstructionUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
