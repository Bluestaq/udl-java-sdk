...
class SurfaceObstructionUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceObstructionUnvalidatedPublishParams].
         *
    ...
    /** A builder for [SurfaceObstructionUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionUnvalidatedPublishParams: SurfaceObstructionUnvalidatedPublishParams) =
            apply {
                body = surfaceObstructionUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = surfaceObstructionUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = surfaceObstructionUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceObstructionUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): SurfaceObstructionUnvalidatedPublishParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("advisoryRequired") @ExcludeMissing private val advisoryRequired: JsonField<List<String>>,
        @JsonProperty("approvalRequired") @ExcludeMissing private val approvalRequired: JsonField<List<String>>,
        @JsonProperty("createdAt") @ExcludeMissing private val createdAt: JsonField<OffsetDateTime>,
        @JsonProperty("createdBy") @ExcludeMissing private val createdBy: JsonField<String>,
        @JsonProperty("distanceFromCenterLine") @ExcludeMissing private val distanceFromCenterLine: JsonField<Double>,
        @JsonProperty("distanceFromEdge") @ExcludeMissing private val distanceFromEdge: JsonField<Double>,
        @JsonProperty("distanceFromThreshold") @ExcludeMissing private val distanceFromThreshold: JsonField<Double>,
        @JsonProperty("idNavigationalObstruction") @ExcludeMissing private val idNavigationalObstruction: JsonField<String>,
        @JsonProperty("obstructionDesc") @ExcludeMissing private val obstructionDesc: JsonField<String>,
        @JsonProperty("obstructionHeight") @ExcludeMissing private val obstructionHeight: JsonField<Double>,
        @JsonProperty("obstructionSideCode") @ExcludeMissing private val obstructionSideCode: JsonField<String>,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    idSurface = body.idSurface
                    source = body.source
                    id = body.id
                    advisoryRequired = body.advisoryRequired.map { it.toMutableList() }
                    approvalRequired = body.approvalRequired.map { it.toMutableList() }
                    createdAt = body.createdAt
                    createdBy = body.createdBy
                    distanceFromCenterLine = body.distanceFromCenterLine
                    distanceFromEdge = body.distanceFromEdge
                    distanceFromThreshold = body.distanceFromThreshold
                    idNavigationalObstruction = body.idNavigationalObstruction
                    obstructionDesc = body.obstructionDesc
                    obstructionHeight = body.obstructionHeight
                    obstructionSideCode = body.obstructionSideCode
                    origin = body.origin
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SurfaceObstructionUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "SurfaceObstructionUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
