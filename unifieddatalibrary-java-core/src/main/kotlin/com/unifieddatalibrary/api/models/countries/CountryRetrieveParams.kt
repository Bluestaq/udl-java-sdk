...
class CountryRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): CountryRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryRetrieveParams: CountryRetrieveParams) =
            apply {
                code = countryRetrieveParams.code
                firstResult = countryRetrieveParams.firstResult
                maxResults = countryRetrieveParams.maxResults
                additionalHeaders = countryRetrieveParams.additionalHeaders.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CountryRetrieveParams && code == other.code && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(code, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "CountryRetrieveParams{code=$code, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
