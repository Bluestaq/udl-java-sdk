...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftTupleParams].
         *
    ...
    /** A builder for [AircraftTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftTupleParams: AircraftTupleParams) = apply {
            columns = aircraftTupleParams.columns
            firstResult = aircraftTupleParams.firstResult
            maxResults = aircraftTupleParams.maxResults
            additionalHeaders = aircraftTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AircraftTupleParams &&
    ...
    override fun toString() =
        "AircraftTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
