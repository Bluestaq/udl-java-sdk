...
class EntityTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntityTupleParams].
         *
    ...
    /** A builder for [EntityTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityTupleParams: EntityTupleParams) =
            apply {
                columns = entityTupleParams.columns
                firstResult = entityTupleParams.firstResult
                maxResults = entityTupleParams.maxResults
                additionalHeaders = entityTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = entityTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EntityTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EntityTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EntityTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
