 ...
 * parameter.
 */
class LogisticsSupportGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LogisticsSupportGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportGetParams: LogisticsSupportGetParams) = apply {
    ...
    override fun toString() =
        "LogisticsSupportGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
