...
class LogisticsSupportGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): LogisticsSupportGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LogisticsSupportGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [LogisticsSupportGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportGetParams: LogisticsSupportGetParams) =
            apply {
                id = logisticsSupportGetParams.id
                firstResult = logisticsSupportGetParams.firstResult
                maxResults = logisticsSupportGetParams.maxResults
                additionalHeaders = logisticsSupportGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = logisticsSupportGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LogisticsSupportGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LogisticsSupportGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LogisticsSupportGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "LogisticsSupportGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
