...
class AircraftsortieAbridged private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftsortieAbridged: AircraftsortieAbridged) =
            apply {
    ...
    fun validate(): AircraftsortieAbridged =
        apply {
            if (validated) {
              return@apply
            }
