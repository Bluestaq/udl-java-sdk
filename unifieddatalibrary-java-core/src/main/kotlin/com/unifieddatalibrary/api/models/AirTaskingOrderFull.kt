...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirTaskingOrderFull].
         *
    ...
    /** A builder for [AirTaskingOrderFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderFull: AirTaskingOrderFull) = apply {
            beginTs = airTaskingOrderFull.beginTs
            classificationMarking = airTaskingOrderFull.classificationMarking
            dataMode = airTaskingOrderFull.dataMode
            opExerName = airTaskingOrderFull.opExerName
            source = airTaskingOrderFull.source
            id = airTaskingOrderFull.id
            ackReqInd = airTaskingOrderFull.ackReqInd
            ackUnitInstructions = airTaskingOrderFull.ackUnitInstructions
            acMsnTasking = airTaskingOrderFull.acMsnTasking.map { it.toMutableList() }
            createdAt = airTaskingOrderFull.createdAt
            createdBy = airTaskingOrderFull.createdBy
            endTs = airTaskingOrderFull.endTs
            genText = airTaskingOrderFull.genText.map { it.toMutableList() }
            msgMonth = airTaskingOrderFull.msgMonth
            msgOriginator = airTaskingOrderFull.msgOriginator
            msgQualifier = airTaskingOrderFull.msgQualifier
            msgSn = airTaskingOrderFull.msgSn
            navalFltOps = airTaskingOrderFull.navalFltOps.map { it.toMutableList() }
            origin = airTaskingOrderFull.origin
            origNetwork = airTaskingOrderFull.origNetwork
            rawFileUri = airTaskingOrderFull.rawFileUri
            sourceDl = airTaskingOrderFull.sourceDl
            additionalProperties = airTaskingOrderFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AirTaskingOrderFull].
         *
    ...
    fun validate(): AirTaskingOrderFull = apply {
        if (validated) {
            return@apply
        }
