 ...
 */
class PersonnelrecoveryTupleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PersonnelrecoveryTupleParams].
         *
    ...
    /** A builder for [PersonnelrecoveryTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(personnelrecoveryTupleParams: PersonnelrecoveryTupleParams) = apply {
            columns = personnelrecoveryTupleParams.columns
            msgTime = personnelrecoveryTupleParams.msgTime
            firstResult = personnelrecoveryTupleParams.firstResult
            maxResults = personnelrecoveryTupleParams.maxResults
            additionalHeaders = personnelrecoveryTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = personnelrecoveryTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PersonnelrecoveryTupleParams].
         *
         ...
         */
        fun build(): PersonnelrecoveryTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PersonnelrecoveryTupleParams && columns == other.columns && msgTime == other.msgTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "PersonnelrecoveryTupleParams{columns=$columns, msgTime=$msgTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
