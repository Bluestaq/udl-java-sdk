...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FolderRetrieveParams].
         *
    ...
    /** A builder for [FolderRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(folderRetrieveParams: FolderRetrieveParams) = apply {
            id = folderRetrieveParams.id
            firstResult = folderRetrieveParams.firstResult
            maxResults = folderRetrieveParams.maxResults
            additionalHeaders = folderRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = folderRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FolderRetrieveParams].
         *
         ...
         */
        fun build(): FolderRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FolderRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "FolderRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
