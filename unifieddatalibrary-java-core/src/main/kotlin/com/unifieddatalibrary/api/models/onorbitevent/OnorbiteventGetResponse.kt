...
class OnorbiteventGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbiteventGetResponse].
         *
    ...
    /** A builder for [OnorbiteventGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventGetResponse: OnorbiteventGetResponse) =
            apply {
                classificationMarking = onorbiteventGetResponse.classificationMarking
                dataMode = onorbiteventGetResponse.dataMode
                eventTime = onorbiteventGetResponse.eventTime
                source = onorbiteventGetResponse.source
                id = onorbiteventGetResponse.id
                achievedFlightPhase = onorbiteventGetResponse.achievedFlightPhase
                ageAtEvent = onorbiteventGetResponse.ageAtEvent
                capabilityLoss = onorbiteventGetResponse.capabilityLoss
                capabilityLossNotes = onorbiteventGetResponse.capabilityLossNotes
                capacityLoss = onorbiteventGetResponse.capacityLoss
                consequentialEquipmentFailure = onorbiteventGetResponse.consequentialEquipmentFailure
                createdAt = onorbiteventGetResponse.createdAt
                createdBy = onorbiteventGetResponse.createdBy
                declassificationDate = onorbiteventGetResponse.declassificationDate
                declassificationString = onorbiteventGetResponse.declassificationString
                derivedFrom = onorbiteventGetResponse.derivedFrom
                description = onorbiteventGetResponse.description
                equipmentAtFault = onorbiteventGetResponse.equipmentAtFault
                equipmentCausingLossNotes = onorbiteventGetResponse.equipmentCausingLossNotes
                equipmentPartAtFault = onorbiteventGetResponse.equipmentPartAtFault
                equipmentTypeAtFault = onorbiteventGetResponse.equipmentTypeAtFault
                eventResult = onorbiteventGetResponse.eventResult
                eventTimeNotes = onorbiteventGetResponse.eventTimeNotes
                eventType = onorbiteventGetResponse.eventType
                geoPosition = onorbiteventGetResponse.geoPosition
                idOnOrbit = onorbiteventGetResponse.idOnOrbit
                inclined = onorbiteventGetResponse.inclined
                injured = onorbiteventGetResponse.injured
                insuranceCarriedNotes = onorbiteventGetResponse.insuranceCarriedNotes
                insuranceLoss = onorbiteventGetResponse.insuranceLoss
                insuranceLossNotes = onorbiteventGetResponse.insuranceLossNotes
                killed = onorbiteventGetResponse.killed
                lesseeOrgId = onorbiteventGetResponse.lesseeOrgId
                lifeLost = onorbiteventGetResponse.lifeLost
                netAmount = onorbiteventGetResponse.netAmount
                objectStatus = onorbiteventGetResponse.objectStatus
                occurrenceFlightPhase = onorbiteventGetResponse.occurrenceFlightPhase
                officialLossDate = onorbiteventGetResponse.officialLossDate
                onOrbit = onorbiteventGetResponse.onOrbit
                operatedOnBehalfOfOrgId = onorbiteventGetResponse.operatedOnBehalfOfOrgId
                operatorOrgId = onorbiteventGetResponse.operatorOrgId
                origin = onorbiteventGetResponse.origin
                origNetwork = onorbiteventGetResponse.origNetwork
                origObjectId = onorbiteventGetResponse.origObjectId
                ownerOrgId = onorbiteventGetResponse.ownerOrgId
                planeNumber = onorbiteventGetResponse.planeNumber
                planeSlot = onorbiteventGetResponse.planeSlot
                positionStatus = onorbiteventGetResponse.positionStatus
                remarks = onorbiteventGetResponse.remarks
                satellitePosition = onorbiteventGetResponse.satellitePosition
                satNo = onorbiteventGetResponse.satNo
                stageAtFault = onorbiteventGetResponse.stageAtFault
                thirdPartyInsuranceLoss = onorbiteventGetResponse.thirdPartyInsuranceLoss
                underlyingCause = onorbiteventGetResponse.underlyingCause
                untilTime = onorbiteventGetResponse.untilTime
                updatedAt = onorbiteventGetResponse.updatedAt
                updatedBy = onorbiteventGetResponse.updatedBy
                additionalProperties = onorbiteventGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbiteventGetResponse].
         *
         ...
         */
        fun build(): OnorbiteventGetResponse =
    ...
    fun validate(): OnorbiteventGetResponse =
        apply {
            if (validated) {
              return@apply
            }
