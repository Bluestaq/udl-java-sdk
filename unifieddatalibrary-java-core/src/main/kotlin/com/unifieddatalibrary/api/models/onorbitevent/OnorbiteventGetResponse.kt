...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventGetResponse: OnorbiteventGetResponse) = apply {
    ...
    fun validate(): OnorbiteventGetResponse = apply {
        if (validated) {
            return@apply
        }
