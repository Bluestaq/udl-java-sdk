...
/**
 * Beta Version Navigational Obstruction: Information describing navigational obstructions, such as
 * applicable boundaries, locations, heights, data ownership, and currency.
 */
class NavigationalObstructionTupleResponse
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("airacCycle") @ExcludeMissing airacCycle: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("heightAGL") @ExcludeMissing heightAgl: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("heightAGLAcc")
        @ExcludeMissing
        heightAglAcc: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("heightMSL") @ExcludeMissing heightMsl: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("heightMSLAcc")
        @ExcludeMissing
        heightMslAcc: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("horizAcc") @ExcludeMissing horizAcc: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("lineNELat") @ExcludeMissing lineNeLat: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("lineNELon") @ExcludeMissing lineNeLon: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("linesFilename")
        @ExcludeMissing
        linesFilename: JsonField<String> = JsonMissing.of(),
        @JsonProperty("lineSWLat") @ExcludeMissing lineSwLat: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("lineSWLon") @ExcludeMissing lineSwLon: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("pointLat") @ExcludeMissing pointLat: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("pointLon") @ExcludeMissing pointLon: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("producer") @ExcludeMissing producer: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("revDate") @ExcludeMissing revDate: JsonField<LocalDate> = JsonMissing.of(),
        @JsonProperty("segEndPoint") @ExcludeMissing segEndPoint: JsonField<Int> = JsonMissing.of(),
    ...
    /**
     * The Aeronautical Information Regulation and Control (AIRAC) cycle of this obstruction data
     * set. The format is YYNN where YY is the last two digits of the year and NN is the cycle
     * number.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * The baseline Aeronautical Information Regulation and Control (AIRAC) cycle for change sets
     * only. The format is YYNN where YY is the last two digits of the year and NN is the cycle
     * number.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Earliest record date possible in this obstruction data set (not the earliest data item), in
     * ISO 8601 date-only format (e.g. YYYY-MM-DD). If null, this data set is assumed to be a full
     * data pull of holdings until the cutoffDate. If this field is populated, this data set only
    ...
    /**
     * WGS-84 latitude of the northeastern boundary for obstructions contained in this data set, in
    ...
    /**
     * WGS-84 longitude of the northeastern boundary for obstructions contained in this data set, in
    ...
    /**
     * WGS-84 latitude of the southwestern boundary for obstructions contained in this data set, in
     * degrees. -90 to 90 degrees (negative values south of equator).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * WGS-84 longitude of the southwestern boundary for obstructions contained in this data set, in
     * degrees. -180 to 180 degrees (negative values west of Prime Meridian).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * The DoD Standard Country Code designator for the country issuing the diplomatic clearance.
     * This field will be set to "OTHR" if the source value does not match a UDL Country code value
     * (ISO-3166-ALPHA-2).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Latest record date possible in this obstruction data set (not the most recent data item), in
     * ISO 8601 date-only format (e.g. YYYY-MM-DD).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * FACC (Feature and Attribute Coding Catalog) is a five-character code for encoding real-world
     * entities and objects. The first letter of the code is an alphabetic value from "A" to "Z"
     * which will map to a feature category. The second character will map to a subcategory.
     * Characters three to five are numeric and range from 000 to 999. This value will provide a
     * unit feature type identification within the categories.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * This field provides an array of keys that can be added to any obstruction feature to provide
     * information that is not already supported. The entries in this array must correspond to the
     * position index in the values array. This array must be the same length as values.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The date after which this obstruction data set’s currency is stale and should be refreshed,
    ...
    /**
     * The DoD Standard Country Code designator for the country or political entity that owns the
     * data set associated with this obstruction. This field will be set to "OTHR" if the source
    ...
    /**
     * WGS-84 latitude of this point obstacle, in degrees. -90 to 90 degrees (negative values south
     * of equator).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     * provide information that is not already supported. The entries in this array must correspond
     * to the position index in the keys array. This array must be the same length as keys.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     */
    @JsonProperty("cycleDate") @ExcludeMissing fun _cycleDate(): JsonField<LocalDate> = cycleDate
     ...
     */
    @JsonProperty("obstacleId") @ExcludeMissing fun _obstacleId(): JsonField<String> = obstacleId

    /**
     * Returns the raw JSON value of [obstacleType].
     *
     * Unlike [obstacleType], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("obstacleType")
    @ExcludeMissing
     ...
     */
    @JsonProperty("actDelCode") @ExcludeMissing fun _actDelCode(): JsonField<String> = actDelCode
     ...
     *
     * Unlike [baseAiracCycle], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("baseAiracCycle")
    @ExcludeMissing
     ...
     *
     * Unlike [baselineCutoffDate], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("baselineCutoffDate")
    @ExcludeMissing
     ...
     */
    @JsonProperty("boundNELat") @ExcludeMissing fun _boundNeLat(): JsonField<Double> = boundNeLat
     ...
     */
    @JsonProperty("boundNELon") @ExcludeMissing fun _boundNeLon(): JsonField<Double> = boundNeLon
     ...
     */
    @JsonProperty("boundSWLat") @ExcludeMissing fun _boundSwLat(): JsonField<Double> = boundSwLat
     ...
     */
    @JsonProperty("boundSWLon") @ExcludeMissing fun _boundSwLon(): JsonField<Double> = boundSwLon
     ...
     */
    @JsonProperty("cutoffDate") @ExcludeMissing fun _cutoffDate(): JsonField<LocalDate> = cutoffDate

    /**
     * Returns the raw JSON value of [dataSetRemarks].
     *
     * Unlike [dataSetRemarks], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("dataSetRemarks")
    @ExcludeMissing
     ...
     */
    @JsonProperty("deletingOrg") @ExcludeMissing fun _deletingOrg(): JsonField<String> = deletingOrg
     ...
     */
    @JsonProperty("derivingOrg") @ExcludeMissing fun _derivingOrg(): JsonField<String> = derivingOrg

    /**
     * Returns the raw JSON value of [directivityCode].
     *
     * Unlike [directivityCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("directivityCode")
    @ExcludeMissing
     ...
     *
     * Unlike [elevationAcc], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("elevationAcc")
    @ExcludeMissing
     ...
     */
    @JsonProperty("featureCode") @ExcludeMissing fun _featureCode(): JsonField<String> = featureCode

    /**
     * Returns the raw JSON value of [featureDescription].
     *
     * Unlike [featureDescription], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("featureDescription")
    @ExcludeMissing
     ...
     */
    @JsonProperty("featureName") @ExcludeMissing fun _featureName(): JsonField<String> = featureName
     ...
     */
    @JsonProperty("featureType") @ExcludeMissing fun _featureType(): JsonField<String> = featureType
     ...
     *
     * Unlike [heightAglAcc], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("heightAGLAcc")
    @ExcludeMissing
     ...
     *
     * Unlike [heightMslAcc], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("heightMSLAcc")
    @ExcludeMissing
     ...
     *
     * Unlike [horizDatumCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("horizDatumCode")
    @ExcludeMissing
     ...
     *
     * Unlike [initRecordDate], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("initRecordDate")
    @ExcludeMissing
     ...
     *
     * Unlike [lightingCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("lightingCode")
    @ExcludeMissing
     ...
     *
     * Unlike [linesFilename], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("linesFilename")
    @ExcludeMissing
     ...
     *
     * Unlike [minHeightAgl], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("minHeightAGL")
    @ExcludeMissing
     ...
     *
     * Unlike [nextCycleDate], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("nextCycleDate")
    @ExcludeMissing
     ...
     *
     * Unlike [obstacleRemarks], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("obstacleRemarks")
    @ExcludeMissing
     ...
     *
     * Unlike [pointsFilename], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("pointsFilename")
    @ExcludeMissing
     ...
     */
    @JsonProperty("processCode") @ExcludeMissing fun _processCode(): JsonField<String> = processCode
     ...
     *
     * Unlike [provinceCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("provinceCode")
    @ExcludeMissing
     ...
     */
    @JsonProperty("segEndPoint") @ExcludeMissing fun _segEndPoint(): JsonField<Int> = segEndPoint
     ...
     *
     * Unlike [segStartPoint], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("segStartPoint")
    @ExcludeMissing
     ...
     */
    @JsonProperty("sourceDate") @ExcludeMissing fun _sourceDate(): JsonField<LocalDate> = sourceDate
     ...
     *
     * Unlike [surfaceMatCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("surfaceMatCode")
    @ExcludeMissing
     ...
     *
     * Unlike [validationCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("validationCode")
    @ExcludeMissing
     ...
     *
     * Unlike [vectorsFilename], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("vectorsFilename")
    @ExcludeMissing
    ...
    /** A builder for [NavigationalObstructionTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            navigationalObstructionTupleResponse: NavigationalObstructionTupleResponse
        ) = apply {
            classificationMarking = navigationalObstructionTupleResponse.classificationMarking
            cycleDate = navigationalObstructionTupleResponse.cycleDate
            dataMode = navigationalObstructionTupleResponse.dataMode
            obstacleId = navigationalObstructionTupleResponse.obstacleId
            obstacleType = navigationalObstructionTupleResponse.obstacleType
            source = navigationalObstructionTupleResponse.source
            id = navigationalObstructionTupleResponse.id
            actDelCode = navigationalObstructionTupleResponse.actDelCode
            airacCycle = navigationalObstructionTupleResponse.airacCycle
            baseAiracCycle = navigationalObstructionTupleResponse.baseAiracCycle
            baselineCutoffDate = navigationalObstructionTupleResponse.baselineCutoffDate
            boundNeLat = navigationalObstructionTupleResponse.boundNeLat
            boundNeLon = navigationalObstructionTupleResponse.boundNeLon
            boundSwLat = navigationalObstructionTupleResponse.boundSwLat
            boundSwLon = navigationalObstructionTupleResponse.boundSwLon
            countryCode = navigationalObstructionTupleResponse.countryCode
            createdAt = navigationalObstructionTupleResponse.createdAt
            createdBy = navigationalObstructionTupleResponse.createdBy
            cutoffDate = navigationalObstructionTupleResponse.cutoffDate
            dataSetRemarks = navigationalObstructionTupleResponse.dataSetRemarks
            deletingOrg = navigationalObstructionTupleResponse.deletingOrg
            derivingOrg = navigationalObstructionTupleResponse.derivingOrg
            directivityCode = navigationalObstructionTupleResponse.directivityCode
            elevation = navigationalObstructionTupleResponse.elevation
            elevationAcc = navigationalObstructionTupleResponse.elevationAcc
            externalId = navigationalObstructionTupleResponse.externalId
            facc = navigationalObstructionTupleResponse.facc
            featureCode = navigationalObstructionTupleResponse.featureCode
            featureDescription = navigationalObstructionTupleResponse.featureDescription
            featureName = navigationalObstructionTupleResponse.featureName
            featureType = navigationalObstructionTupleResponse.featureType
            heightAgl = navigationalObstructionTupleResponse.heightAgl
            heightAglAcc = navigationalObstructionTupleResponse.heightAglAcc
            heightMsl = navigationalObstructionTupleResponse.heightMsl
            heightMslAcc = navigationalObstructionTupleResponse.heightMslAcc
            horizAcc = navigationalObstructionTupleResponse.horizAcc
            horizDatumCode = navigationalObstructionTupleResponse.horizDatumCode
            initRecordDate = navigationalObstructionTupleResponse.initRecordDate
            keys = navigationalObstructionTupleResponse.keys.map { it.toMutableList() }
            lightingCode = navigationalObstructionTupleResponse.lightingCode
            lineNeLat = navigationalObstructionTupleResponse.lineNeLat
            lineNeLon = navigationalObstructionTupleResponse.lineNeLon
            linesFilename = navigationalObstructionTupleResponse.linesFilename
            lineSwLat = navigationalObstructionTupleResponse.lineSwLat
            lineSwLon = navigationalObstructionTupleResponse.lineSwLon
            minHeightAgl = navigationalObstructionTupleResponse.minHeightAgl
            multObs = navigationalObstructionTupleResponse.multObs
            nextCycleDate = navigationalObstructionTupleResponse.nextCycleDate
            numLines = navigationalObstructionTupleResponse.numLines
            numObs = navigationalObstructionTupleResponse.numObs
            numPoints = navigationalObstructionTupleResponse.numPoints
            obstacleRemarks = navigationalObstructionTupleResponse.obstacleRemarks
            origId = navigationalObstructionTupleResponse.origId
            origin = navigationalObstructionTupleResponse.origin
            origNetwork = navigationalObstructionTupleResponse.origNetwork
            ownerCountryCode = navigationalObstructionTupleResponse.ownerCountryCode
            pointLat = navigationalObstructionTupleResponse.pointLat
            pointLon = navigationalObstructionTupleResponse.pointLon
            pointsFilename = navigationalObstructionTupleResponse.pointsFilename
            processCode = navigationalObstructionTupleResponse.processCode
            producer = navigationalObstructionTupleResponse.producer
            provinceCode = navigationalObstructionTupleResponse.provinceCode
            quality = navigationalObstructionTupleResponse.quality
            rawFileUri = navigationalObstructionTupleResponse.rawFileUri
            revDate = navigationalObstructionTupleResponse.revDate
            segEndPoint = navigationalObstructionTupleResponse.segEndPoint
            segNum = navigationalObstructionTupleResponse.segNum
            segStartPoint = navigationalObstructionTupleResponse.segStartPoint
            sourceDate = navigationalObstructionTupleResponse.sourceDate
            sourceDl = navigationalObstructionTupleResponse.sourceDl
            surfaceMatCode = navigationalObstructionTupleResponse.surfaceMatCode
            transactionCode = navigationalObstructionTupleResponse.transactionCode
            updatedAt = navigationalObstructionTupleResponse.updatedAt
            updatedBy = navigationalObstructionTupleResponse.updatedBy
            validationCode = navigationalObstructionTupleResponse.validationCode
            values = navigationalObstructionTupleResponse.values.map { it.toMutableList() }
            vectorsFilename = navigationalObstructionTupleResponse.vectorsFilename
            wac = navigationalObstructionTupleResponse.wac
            wacInnr = navigationalObstructionTupleResponse.wacInnr
            additionalProperties =
                navigationalObstructionTupleResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.cycleDate] with a well-typed [LocalDate] value instead.
         ...
         *
         * You should usually call [Builder.obstacleId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.obstacleType] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.actDelCode] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.airacCycle] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.baseAiracCycle] with a well-typed [Int] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.baselineCutoffDate] with a well-typed [LocalDate] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.boundNeLat] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.boundNeLon] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.boundSwLat] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.boundSwLon] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.cutoffDate] with a well-typed [LocalDate] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun cutoffDate(cutoffDate: JsonField<LocalDate>) = apply { this.cutoffDate = cutoffDate }

        /** Remarks concerning this obstruction's data set. */
        fun dataSetRemarks(dataSetRemarks: String) = dataSetRemarks(JsonField.of(dataSetRemarks))
         ...
         *
         * You should usually call [Builder.deletingOrg] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun deletingOrg(deletingOrg: JsonField<String>) = apply { this.deletingOrg = deletingOrg }
         ...
         *
         * You should usually call [Builder.derivingOrg] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun derivingOrg(derivingOrg: JsonField<String>) = apply { this.derivingOrg = derivingOrg }

        /**
         * The side or sides of this obstruction feature which produces the greatest reflectivity
         * potential.
         */
        fun directivityCode(directivityCode: Int) = directivityCode(JsonField.of(directivityCode))

        /**
         * Sets [Builder.directivityCode] to an arbitrary JSON value.
         *
         * You should usually call [Builder.directivityCode] with a well-typed [Int] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.elevationAcc] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.featureCode] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun featureCode(featureCode: JsonField<String>) = apply { this.featureCode = featureCode }
         ...
         *
         * You should usually call [Builder.featureName] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun featureName(featureName: JsonField<String>) = apply { this.featureName = featureName }
         ...
         *
         * You should usually call [Builder.featureType] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun featureType(featureType: JsonField<String>) = apply { this.featureType = featureType }
         ...
         *
         * You should usually call [Builder.heightAglAcc] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.heightMslAcc] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.horizAcc] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         * 1984 (WGS-84), but also use maps by allied countries with local datums.
         */
        fun horizDatumCode(horizDatumCode: String) = horizDatumCode(JsonField.of(horizDatumCode))
         ...
         * YYYY-MM-DD).
         */
        fun initRecordDate(initRecordDate: LocalDate) = initRecordDate(JsonField.of(initRecordDate))
         ...
         *
         * You should usually call [Builder.lightingCode] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.linesFilename] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.minHeightAgl] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.multObs] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.numLines] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.origId] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.pointLat] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.pointLon] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun pointLon(pointLon: JsonField<Double>) = apply { this.pointLon = pointLon }

        /** The name of the point file associated with this obstruction data set. */
        fun pointsFilename(pointsFilename: String) = pointsFilename(JsonField.of(pointsFilename))
         ...
         *
         * You should usually call [Builder.processCode] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun processCode(processCode: JsonField<String>) = apply { this.processCode = processCode }
         ...
         *
         * You should usually call [Builder.producer] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.provinceCode] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.revDate] with a well-typed [LocalDate] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.segEndPoint] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.segStartPoint] with a well-typed [Int] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.sourceDate] with a well-typed [LocalDate] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun sourceDate(sourceDate: JsonField<LocalDate>) = apply { this.sourceDate = sourceDate }
        ...
        /** The surface material composition code of this point obstacle. */
        fun surfaceMatCode(surfaceMatCode: String) = surfaceMatCode(JsonField.of(surfaceMatCode))
         ...
         *
         * You should usually call [Builder.validationCode] with a well-typed [Int] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [NavigationalObstructionTupleResponse].
         *
         ...
         */
        fun build(): NavigationalObstructionTupleResponse =
            NavigationalObstructionTupleResponse(
    ...
    fun validate(): NavigationalObstructionTupleResponse = apply {
        if (validated) {
            return@apply
        }
