...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationListParams: OrganizationListParams) = apply {
            firstResult = organizationListParams.firstResult
            maxResults = organizationListParams.maxResults
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrganizationListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OrganizationListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
