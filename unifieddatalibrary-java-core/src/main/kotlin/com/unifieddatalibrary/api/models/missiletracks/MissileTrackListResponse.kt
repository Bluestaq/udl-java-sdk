...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissileTrackListResponse].
         *
    ...
    /** A builder for [MissileTrackListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missileTrackListResponse: MissileTrackListResponse) = apply {
            classificationMarking = missileTrackListResponse.classificationMarking
            dataMode = missileTrackListResponse.dataMode
            source = missileTrackListResponse.source
            ts = missileTrackListResponse.ts
            id = missileTrackListResponse.id
            acftSubType = missileTrackListResponse.acftSubType
            alert = missileTrackListResponse.alert
            angElev = missileTrackListResponse.angElev
            aouRptData = missileTrackListResponse.aouRptData.map { it.toMutableList() }
            aouRptType = missileTrackListResponse.aouRptType
            azCorr = missileTrackListResponse.azCorr
            boosting = missileTrackListResponse.boosting
            burnoutAlt = missileTrackListResponse.burnoutAlt
            callSign = missileTrackListResponse.callSign
            containment = missileTrackListResponse.containment
            contextKeys = missileTrackListResponse.contextKeys.map { it.toMutableList() }
            contextValues = missileTrackListResponse.contextValues.map { it.toMutableList() }
            createdAt = missileTrackListResponse.createdAt
            createdBy = missileTrackListResponse.createdBy
            dropPtInd = missileTrackListResponse.dropPtInd
            emgInd = missileTrackListResponse.emgInd
            env = missileTrackListResponse.env
            impactAlt = missileTrackListResponse.impactAlt
            impactAouData = missileTrackListResponse.impactAouData.map { it.toMutableList() }
            impactAouType = missileTrackListResponse.impactAouType
            impactConf = missileTrackListResponse.impactConf
            impactLat = missileTrackListResponse.impactLat
            impactLon = missileTrackListResponse.impactLon
            impactTime = missileTrackListResponse.impactTime
            infoSource = missileTrackListResponse.infoSource
            launchAlt = missileTrackListResponse.launchAlt
            launchAouData = missileTrackListResponse.launchAouData.map { it.toMutableList() }
            launchAouType = missileTrackListResponse.launchAouType
            launchAz = missileTrackListResponse.launchAz
            launchAzUnc = missileTrackListResponse.launchAzUnc
            launchConf = missileTrackListResponse.launchConf
            launchLat = missileTrackListResponse.launchLat
            launchLon = missileTrackListResponse.launchLon
            launchTime = missileTrackListResponse.launchTime
            lostTrkInd = missileTrackListResponse.lostTrkInd
            maneuverEnd = missileTrackListResponse.maneuverEnd
            maneuverStart = missileTrackListResponse.maneuverStart
            msgCreateDate = missileTrackListResponse.msgCreateDate
            msgSubType = missileTrackListResponse.msgSubType
            msgType = missileTrackListResponse.msgType
            mslStatus = missileTrackListResponse.mslStatus
            muidSrc = missileTrackListResponse.muidSrc
            muidSrcTrk = missileTrackListResponse.muidSrcTrk
            name = missileTrackListResponse.name
            objAct = missileTrackListResponse.objAct
            objIdent = missileTrackListResponse.objIdent
            objPlat = missileTrackListResponse.objPlat
            objType = missileTrackListResponse.objType
            objTypeConf = missileTrackListResponse.objTypeConf
            origin = missileTrackListResponse.origin
            origNetwork = missileTrackListResponse.origNetwork
            parentTrackId = missileTrackListResponse.parentTrackId
            polarSingLocLat = missileTrackListResponse.polarSingLocLat
            polarSingLocLon = missileTrackListResponse.polarSingLocLon
            senMode = missileTrackListResponse.senMode
            spaceAmp = missileTrackListResponse.spaceAmp
            spaceAmpConf = missileTrackListResponse.spaceAmpConf
            spaceSpecType = missileTrackListResponse.spaceSpecType
            trackId = missileTrackListResponse.trackId
            trkConf = missileTrackListResponse.trkConf
            trkQual = missileTrackListResponse.trkQual
            vectors = missileTrackListResponse.vectors.map { it.toMutableList() }
            additionalProperties = missileTrackListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MissileTrackListResponse].
         *
         ...
         */
        fun build(): MissileTrackListResponse =
    ...
    fun validate(): MissileTrackListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MissileTrackListResponse &&
