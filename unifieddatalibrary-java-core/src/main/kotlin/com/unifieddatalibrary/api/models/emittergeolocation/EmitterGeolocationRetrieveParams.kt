...
class EmitterGeolocationRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EmitterGeolocationRetrieveParams = builder().build()
        ...
        internal fun from(emitterGeolocationRetrieveParams: EmitterGeolocationRetrieveParams) =
            apply {
                ...
                additionalQueryParams =
                    emitterGeolocationRetrieveParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "EmitterGeolocationRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
