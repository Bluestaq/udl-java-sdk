...
/**
 * Service operation to update a single SensorStaging record. A specific role is required to perform
 * this service operation. Please contact the UDL team for assistance.
 */
class SensorStatingUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorStatingUpdateParams].
         *
    ...
    /** A builder for [SensorStatingUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorStatingUpdateParams: SensorStatingUpdateParams) = apply {
            pathId = sensorStatingUpdateParams.pathId
            body = sensorStatingUpdateParams.body.toBuilder()
            additionalHeaders = sensorStatingUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = sensorStatingUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SensorStatingUpdateParams].
         *
         ...
         */
        fun build(): SensorStatingUpdateParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, sensorName=$sensorName, source=$source, bodyId=$bodyId, altitude=$altitude, createdAt=$createdAt, createdBy=$createdBy, lat=$lat, locationCountry=$locationCountry, lon=$lon, ownerCountry=$ownerCountry, sensorNumber=$sensorNumber, sensorObservationType=$sensorObservationType, sensorType=$sensorType, shortName=$shortName, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorStatingUpdateParams &&
            pathId == other.pathId &&
            body == other.body &&
    ...
    override fun toString() =
        "SensorStatingUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
