...
class StatusGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): StatusGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StatusGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [StatusGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusGetParams: StatusGetParams) =
            apply {
                id = statusGetParams.id
                firstResult = statusGetParams.firstResult
                maxResults = statusGetParams.maxResults
                additionalHeaders = statusGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = statusGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [StatusGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StatusGetParams =
            StatusGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StatusGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "StatusGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
