...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StatusGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusGetParams: StatusGetParams) = apply {
    ...
    override fun toString() =
        "StatusGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
