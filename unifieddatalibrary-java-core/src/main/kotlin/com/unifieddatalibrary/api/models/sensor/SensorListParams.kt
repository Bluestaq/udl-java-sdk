...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorListParams: SensorListParams) = apply {
    ...
    override fun toString() =
        "SensorListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
