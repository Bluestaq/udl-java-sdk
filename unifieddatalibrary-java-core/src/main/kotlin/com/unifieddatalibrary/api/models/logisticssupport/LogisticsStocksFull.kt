...
private constructor(
     ...
     */
    @JsonProperty("stockPOC") @ExcludeMissing fun _stockPoc(): JsonField<String> = stockPoc
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsStocksFull: LogisticsStocksFull) = apply {
         ...
         *
         * You should usually call [Builder.stockCheckTime] with a well-typed [OffsetDateTime] value
         ...
         *
         * You should usually call [Builder.stockPoc] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    fun validate(): LogisticsStocksFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "LogisticsStocksFull{quantity=$quantity, sourceIcao=$sourceIcao, stockCheckTime=$stockCheckTime, stockPoc=$stockPoc, additionalProperties=$additionalProperties}"
}
