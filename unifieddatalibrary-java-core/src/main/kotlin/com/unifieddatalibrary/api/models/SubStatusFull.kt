...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subStatusFull: SubStatusFull) = apply {
    ...
    fun validate(): SubStatusFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SubStatusFull{classificationMarking=$classificationMarking, dataMode=$dataMode, notes=$notes, source=$source, status=$status, statusId=$statusId, type=$type, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
