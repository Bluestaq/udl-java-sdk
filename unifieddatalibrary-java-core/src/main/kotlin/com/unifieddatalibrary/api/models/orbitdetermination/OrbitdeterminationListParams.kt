...
class OrbitdeterminationListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OrbitdeterminationListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OrbitdeterminationListParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OrbitdeterminationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationListParams: OrbitdeterminationListParams) =
            apply {
                firstResult = orbitdeterminationListParams.firstResult
                idOnOrbit = orbitdeterminationListParams.idOnOrbit
                maxResults = orbitdeterminationListParams.maxResults
                startTime = orbitdeterminationListParams.startTime
                additionalHeaders = orbitdeterminationListParams.additionalHeaders.toBuilder()
                additionalQueryParams = orbitdeterminationListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OrbitdeterminationListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OrbitdeterminationListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbitdeterminationListParams && firstResult == other.firstResult && idOnOrbit == other.idOnOrbit && maxResults == other.maxResults && startTime == other.startTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OrbitdeterminationListParams{firstResult=$firstResult, idOnOrbit=$idOnOrbit, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
