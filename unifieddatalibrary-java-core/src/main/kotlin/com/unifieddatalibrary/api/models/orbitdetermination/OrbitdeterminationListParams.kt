 ...
 */
class OrbitdeterminationListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OrbitdeterminationListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationListParams: OrbitdeterminationListParams) = apply {
    ...
    override fun toString() =
        "OrbitdeterminationListParams{firstResult=$firstResult, idOnOrbit=$idOnOrbit, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
