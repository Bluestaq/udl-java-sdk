...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PortCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portCountParams: PortCountParams) = apply {
    ...
    override fun toString() =
        "PortCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
