...
class H3GeoHexCellTupleParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellTupleParams: H3GeoHexCellTupleParams) =
            apply {
    ...
    override fun toString() = "H3GeoHexCellTupleParams{columns=$columns, idH3Geo=$idH3Geo, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
