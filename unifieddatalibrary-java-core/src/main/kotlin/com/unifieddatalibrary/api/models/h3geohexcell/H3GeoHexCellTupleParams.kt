 ...
 */
class H3GeoHexCellTupleParams
private constructor(
    private val columns: String,
    private val idH3Geo: String,
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [H3GeoHexCellTupleParams].
         *
    ...
    /** A builder for [H3GeoHexCellTupleParams]. */
    class Builder internal constructor() {

        private var columns: String? = null
        private var idH3Geo: String? = null
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellTupleParams: H3GeoHexCellTupleParams) = apply {
            columns = h3GeoHexCellTupleParams.columns
            idH3Geo = h3GeoHexCellTupleParams.idH3Geo
            firstResult = h3GeoHexCellTupleParams.firstResult
            maxResults = h3GeoHexCellTupleParams.maxResults
            additionalHeaders = h3GeoHexCellTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = h3GeoHexCellTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Unique identifier of the parent H3 Geo record containing this hex cell. (uuid) */
        fun idH3Geo(idH3Geo: String) = apply { this.idH3Geo = idH3Geo }
        ...
        /**
         * Returns an immutable instance of [H3GeoHexCellTupleParams].
         *
         ...
         */
        fun build(): H3GeoHexCellTupleParams =
            H3GeoHexCellTupleParams(
                checkRequired("columns", columns),
                checkRequired("idH3Geo", idH3Geo),
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is H3GeoHexCellTupleParams && columns == other.columns && idH3Geo == other.idH3Geo && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, idH3Geo, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "H3GeoHexCellTupleParams{columns=$columns, idH3Geo=$idH3Geo, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
