...
class MissionAssignmentCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissionAssignmentCreateParams].
         *
    ...
    /** A builder for [MissionAssignmentCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentCreateParams: MissionAssignmentCreateParams) =
            apply {
                body = missionAssignmentCreateParams.body.toBuilder()
                additionalHeaders = missionAssignmentCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = missionAssignmentCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** TARGET DATA CONTINUATION WORD - method of fire. */
        fun c2exercisemof(c2exercisemof: String) =
            apply {
        ...
        /** TARGET DATA CONTINUATION WORD - point number. */
        fun c3ptnum(c3ptnum: String) =
            apply {
                body.c3ptnum(c3ptnum)
            }
        ...
        /** SURFACE ATTACK CONTINUATION WORD - minute. */
        fun c4colon(c4colon: Int) =
            apply {
                body.c4colon(c4colon)
            }
        ...
        /** SURFACE ATTACK CONTINUATION WORD - run in heading, NS=511. */
        fun c4egress(c4egress: Int) =
            apply {
                body.c4egress(c4egress)
            }
        ...
        /** SURFACE ATTACK CONTINUATION WORD - run in heading, NS=511. */
        fun c4runin(c4runin: Int) =
            apply {
                body.c4runin(c4runin)
            }
        ...
        /** SURFACE ATTACK CONTINUATION WORD - type of stores. */
        fun c4typeofstores(c4typeofstores: Int) =
            apply {
        ...
        /** SURFACE ATTACK CONTINUATION WORD - seconds in increments of 1 sec. */
        fun c5colon(c5colon: Int) =
            apply {
                body.c5colon(c5colon)
            }
        ...
        /** CONTINUATION WORD - hae adjustment, measured in 3.125 FT. */
        fun c5haeadj(c5haeadj: Int) =
            apply {
                body.c5haeadj(c5haeadj)
            }
        ...
        /** CONTINUATION WORD - used with c3_lat to double precision to approx 4 ft. */
        fun c5latlsb(c5latlsb: Int) =
            apply {
                body.c5latlsb(c5latlsb)
            }
        ...
        /** CONTINUATION WORD - used with c3_lon to double precision to approx 4 ft. */
        fun c5lonlsb(c5lonlsb: Int) =
            apply {
                body.c5lonlsb(c5lonlsb)
            }
        ...
        /** CONTINUATION WORD - target bearing. */
        fun c5tgtbrng(c5tgtbrng: Int) =
            apply {
                body.c5tgtbrng(c5tgtbrng)
            }
        ...
        /** TARGETING CONTINUATION WORD - designator/seeker pulse code type. */
        fun c6dspct(c6dspct: String) =
            apply {
                body.c6dspct(c6dspct)
            }
        ...
        /** TARGETING CONTINUATION WORD - first pulse/last pulse mode. */
        fun c6fplpm(c6fplpm: String) =
            apply {
                body.c6fplpm(c6fplpm)
            }
        ...
        /** TARGETING CONTINUATION WORD - index number, related, 0=NS. */
        fun c6intel(c6intel: Int) =
            apply {
                body.c6intel(c6intel)
            }
        ...
        /** TARGETING CONTINUATION WORD - laser illuminator code. */
        fun c6laser(c6laser: Int) =
            apply {
                body.c6laser(c6laser)
            }
        ...
        /** TARGETING CONTINUATION WORD - long pulse mode. */
        fun c6longpm(c6longpm: String) =
            apply {
                body.c6longpm(c6longpm)
            }
        ...
        /** THIRD PARTY CONTINUATION WORD - elevation angle, 2. */
        fun c7elang2(c7elang2: Double) =
            apply {
                body.c7elang2(c7elang2)
            }
        ...
        /**
         * Returns an immutable instance of [MissionAssignmentCreateParams].
         *
         ...
         */
        fun build(): MissionAssignmentCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MissionAssignmentCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "MissionAssignmentCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
