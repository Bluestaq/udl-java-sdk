...
class OnboardnavigationCountParams private constructor(
    ...
    /** Start time of the sensor data, in ISO 8601 UTC format. (YYYY-MM-DDTHH:MM:SS.ssssssZ) */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnboardnavigationCountParams].
         *
    ...
    /** A builder for [OnboardnavigationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationCountParams: OnboardnavigationCountParams) =
            apply {
                startTime = onboardnavigationCountParams.startTime
                firstResult = onboardnavigationCountParams.firstResult
                maxResults = onboardnavigationCountParams.maxResults
                additionalHeaders = onboardnavigationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = onboardnavigationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnboardnavigationCountParams].
         *
         ...
         */
        fun build(): OnboardnavigationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnboardnavigationCountParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnboardnavigationCountParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
