...
private constructor(
    ...
    private val items: List<GnssObservationSetFull>,
) : Page<GnssObservationSetFull> {
    ...
    fun autoPager(): AutoPager<GnssObservationSetFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<GnssObservationSetFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<GnssObservationSetFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<GnssObservationSetFull>) = apply { this.items = items }
