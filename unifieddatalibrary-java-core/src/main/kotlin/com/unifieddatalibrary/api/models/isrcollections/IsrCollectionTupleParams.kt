 ...
 */
class IsrCollectionTupleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsrCollectionTupleParams].
         *
    ...
    /** A builder for [IsrCollectionTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isrCollectionTupleParams: IsrCollectionTupleParams) = apply {
            columns = isrCollectionTupleParams.columns
            createdAt = isrCollectionTupleParams.createdAt
            firstResult = isrCollectionTupleParams.firstResult
            maxResults = isrCollectionTupleParams.maxResults
            additionalHeaders = isrCollectionTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = isrCollectionTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IsrCollectionTupleParams].
         *
         ...
         */
        fun build(): IsrCollectionTupleParams =
