...
/**
 * Service operation to push a generic Notification/Alert JSON message into the UDL. This operation
 * accepts a UDL-formatted Notification JSON notification/alert message. See the Notification schema
 * for required fields such as classificationMarking, msgType, etc. Messages pushed through this
 * service may be pulled via Secure Messaging and historical REST services. A specific role is
...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun msgBody(): String = body.msgBody()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun msgType(): String = body.msgType()
     ...
     */
    fun _msgBody(): JsonField<String> = body._msgBody()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(notificationCreateParams: NotificationCreateParams) = apply {
            body = notificationCreateParams.body.toBuilder()
         ...
         */
        fun msgBody(msgBody: String) = apply { body.msgBody(msgBody) }
         ...
         */
        fun msgBody(msgBody: JsonField<String>) = apply { body.msgBody(msgBody) }
    ...
    /**
     * Model representation of client generated notification data. Contains a message type and
     * message body field to store notification information.
     */
    class Body
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.msgBody] to an arbitrary JSON value.
             *
             * You should usually call [Builder.msgBody] with a well-typed [String] value instead.
            ...
            /**
             * Optional array of provider/source specific tags for this data, used for implementing
             * data owner conditional access controls to restrict access to the data.
             */
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, msgBody=$msgBody, msgType=$msgType, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, sourceDl=$sourceDl, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NotificationCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "NotificationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
