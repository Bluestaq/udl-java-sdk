...
class SeraDataCommDetailListResponse
private constructor(
    ...
    /** A builder for [SeraDataCommDetailListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataCommDetailListResponse: SeraDataCommDetailListResponse) = apply {
            classificationMarking = seraDataCommDetailListResponse.classificationMarking
            dataMode = seraDataCommDetailListResponse.dataMode
            source = seraDataCommDetailListResponse.source
            id = seraDataCommDetailListResponse.id
            band = seraDataCommDetailListResponse.band
            bandwidth = seraDataCommDetailListResponse.bandwidth
            createdAt = seraDataCommDetailListResponse.createdAt
            createdBy = seraDataCommDetailListResponse.createdBy
            eirp = seraDataCommDetailListResponse.eirp
            estHtsTotalCapacity = seraDataCommDetailListResponse.estHtsTotalCapacity
            estHtsTotalUserDownlinkBandwidthPerBeam =
                seraDataCommDetailListResponse.estHtsTotalUserDownlinkBandwidthPerBeam
            estHtsTotalUserUplinkBandwidthPerBeam =
                seraDataCommDetailListResponse.estHtsTotalUserUplinkBandwidthPerBeam
            gatewayDownlinkFrom = seraDataCommDetailListResponse.gatewayDownlinkFrom
            gatewayDownlinkTo = seraDataCommDetailListResponse.gatewayDownlinkTo
            gatewayUplinkFrom = seraDataCommDetailListResponse.gatewayUplinkFrom
            gatewayUplinkTo = seraDataCommDetailListResponse.gatewayUplinkTo
            hostedForCompanyOrgId = seraDataCommDetailListResponse.hostedForCompanyOrgId
            htsNumUserSpotBeams = seraDataCommDetailListResponse.htsNumUserSpotBeams
            htsUserDownlinkBandwidthPerBeam =
                seraDataCommDetailListResponse.htsUserDownlinkBandwidthPerBeam
            htsUserUplinkBandwidthPerBeam =
                seraDataCommDetailListResponse.htsUserUplinkBandwidthPerBeam
            idComm = seraDataCommDetailListResponse.idComm
            manufacturerOrgId = seraDataCommDetailListResponse.manufacturerOrgId
            num36MhzEquivalentTransponders =
                seraDataCommDetailListResponse.num36MhzEquivalentTransponders
            numOperationalTransponders = seraDataCommDetailListResponse.numOperationalTransponders
            numSpareTransponders = seraDataCommDetailListResponse.numSpareTransponders
            origin = seraDataCommDetailListResponse.origin
            origNetwork = seraDataCommDetailListResponse.origNetwork
            payloadNotes = seraDataCommDetailListResponse.payloadNotes
            polarization = seraDataCommDetailListResponse.polarization
            solidStatePowerAmp = seraDataCommDetailListResponse.solidStatePowerAmp
            spacecraftId = seraDataCommDetailListResponse.spacecraftId
            tradeLeaseOrgId = seraDataCommDetailListResponse.tradeLeaseOrgId
            travelingWaveTubeAmplifier = seraDataCommDetailListResponse.travelingWaveTubeAmplifier
            userDownlinkFrom = seraDataCommDetailListResponse.userDownlinkFrom
            userDownlinkTo = seraDataCommDetailListResponse.userDownlinkTo
            userUplinkFrom = seraDataCommDetailListResponse.userUplinkFrom
            userUplinkTo = seraDataCommDetailListResponse.userUplinkTo
            additionalProperties =
                seraDataCommDetailListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataCommDetailListResponse].
         *
         ...
         */
        fun build(): SeraDataCommDetailListResponse =
            SeraDataCommDetailListResponse(
    ...
    fun validate(): SeraDataCommDetailListResponse = apply {
        if (validated) {
            return@apply
        }
