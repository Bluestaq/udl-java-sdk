...
private constructor(
    ...
    /** A builder for [FeatureAssessmentRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentRetrieveResponse: FeatureAssessmentRetrieveResponse) =
            apply {
                classificationMarking = featureAssessmentRetrieveResponse.classificationMarking
                dataMode = featureAssessmentRetrieveResponse.dataMode
                featureTs = featureAssessmentRetrieveResponse.featureTs
                featureUoM = featureAssessmentRetrieveResponse.featureUoM
                idAnalyticImagery = featureAssessmentRetrieveResponse.idAnalyticImagery
                source = featureAssessmentRetrieveResponse.source
                id = featureAssessmentRetrieveResponse.id
                agjson = featureAssessmentRetrieveResponse.agjson
                andims = featureAssessmentRetrieveResponse.andims
                annLims = featureAssessmentRetrieveResponse.annLims.map { it.toMutableList() }
                annText = featureAssessmentRetrieveResponse.annText.map { it.toMutableList() }
                area = featureAssessmentRetrieveResponse.area
                asrid = featureAssessmentRetrieveResponse.asrid
                assessment = featureAssessmentRetrieveResponse.assessment
                atext = featureAssessmentRetrieveResponse.atext
                atype = featureAssessmentRetrieveResponse.atype
                confidence = featureAssessmentRetrieveResponse.confidence
                createdAt = featureAssessmentRetrieveResponse.createdAt
                createdBy = featureAssessmentRetrieveResponse.createdBy
                externalId = featureAssessmentRetrieveResponse.externalId
                featureArray =
                    featureAssessmentRetrieveResponse.featureArray.map { it.toMutableList() }
                featureBool = featureAssessmentRetrieveResponse.featureBool
                featureString = featureAssessmentRetrieveResponse.featureString
                featureStringArray =
                    featureAssessmentRetrieveResponse.featureStringArray.map { it.toMutableList() }
                featureValue = featureAssessmentRetrieveResponse.featureValue
                heading = featureAssessmentRetrieveResponse.heading
                height = featureAssessmentRetrieveResponse.height
                length = featureAssessmentRetrieveResponse.length
                name = featureAssessmentRetrieveResponse.name
                origin = featureAssessmentRetrieveResponse.origin
                origNetwork = featureAssessmentRetrieveResponse.origNetwork
                sourceDl = featureAssessmentRetrieveResponse.sourceDl
                speed = featureAssessmentRetrieveResponse.speed
                srcIds = featureAssessmentRetrieveResponse.srcIds.map { it.toMutableList() }
                srcTs = featureAssessmentRetrieveResponse.srcTs.map { it.toMutableList() }
                srcTyps = featureAssessmentRetrieveResponse.srcTyps.map { it.toMutableList() }
                tags = featureAssessmentRetrieveResponse.tags.map { it.toMutableList() }
                transactionId = featureAssessmentRetrieveResponse.transactionId
                type = featureAssessmentRetrieveResponse.type
                width = featureAssessmentRetrieveResponse.width
                additionalProperties =
                    featureAssessmentRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentRetrieveResponse].
         *
         ...
         */
        fun build(): FeatureAssessmentRetrieveResponse =
            FeatureAssessmentRetrieveResponse(
    ...
    fun validate(): FeatureAssessmentRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
