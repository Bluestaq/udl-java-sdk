...
class EphemerisSetAbridged private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetAbridged: EphemerisSetAbridged) =
            apply {
    ...
    fun validate(): EphemerisSetAbridged =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (category.asKnown().isPresent) 1 else 0) + (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (numPoints.asKnown().isPresent) 1 else 0) + (if (pointEndTime.asKnown().isPresent) 1 else 0) + (if (pointStartTime.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (bDot.asKnown().isPresent) 1 else 0) + (if (centBody.asKnown().isPresent) 1 else 0) + (if (comments.asKnown().isPresent) 1 else 0) + (covReferenceFrame.asKnown().getOrNull()?.validity() ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (dragModel.asKnown().isPresent) 1 else 0) + (if (edr.asKnown().isPresent) 1 else 0) + (if (filename.asKnown().isPresent) 1 else 0) + (if (geopotentialModel.asKnown().isPresent) 1 else 0) + (if (hasAccel.asKnown().isPresent) 1 else 0) + (if (hasCov.asKnown().isPresent) 1 else 0) + (if (hasMnvr.asKnown().isPresent) 1 else 0) + (idManeuvers.asKnown().getOrNull()?.size ?: 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idStateVector.asKnown().isPresent) 1 else 0) + (if (integrator.asKnown().isPresent) 1 else 0) + (if (interpolation.asKnown().isPresent) 1 else 0) + (if (interpolationDegree.asKnown().isPresent) 1 else 0) + (if (lunarSolar.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (pedigree.asKnown().isPresent) 1 else 0) + (referenceFrame.asKnown().getOrNull()?.validity() ?: 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (solidEarthTides.asKnown().isPresent) 1 else 0) + (if (stepSize.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (usableEndTime.asKnown().isPresent) 1 else 0) + (if (usableStartTime.asKnown().isPresent) 1 else 0)
