...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemQueryhelpResponse: ItemQueryhelpResponse) = apply {
    ...
    fun validate(): ItemQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
