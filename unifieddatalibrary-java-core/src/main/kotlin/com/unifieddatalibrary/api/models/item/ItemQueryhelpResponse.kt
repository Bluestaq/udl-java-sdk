...
class ItemQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ItemQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ItemQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemQueryhelpResponse: ItemQueryhelpResponse) =
            apply {
                aodrSupported = itemQueryhelpResponse.aodrSupported
                classificationMarking = itemQueryhelpResponse.classificationMarking
                description = itemQueryhelpResponse.description
                historySupported = itemQueryhelpResponse.historySupported
                name = itemQueryhelpResponse.name
                parameters = itemQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = itemQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = itemQueryhelpResponse.restSupported
                sortSupported = itemQueryhelpResponse.sortSupported
                typeName = itemQueryhelpResponse.typeName
                uri = itemQueryhelpResponse.uri
                additionalProperties = itemQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ItemQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ItemQueryhelpResponse =
    ...
    fun validate(): ItemQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ItemQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
