...
class SensorPlanGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorPlanGetResponse].
         *
    ...
    /** A builder for [SensorPlanGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanGetResponse: SensorPlanGetResponse) =
            apply {
                classificationMarking = sensorPlanGetResponse.classificationMarking
                dataMode = sensorPlanGetResponse.dataMode
                recType = sensorPlanGetResponse.recType
                source = sensorPlanGetResponse.source
                startTime = sensorPlanGetResponse.startTime
                type = sensorPlanGetResponse.type
                id = sensorPlanGetResponse.id
                collectRequests = sensorPlanGetResponse.collectRequests.map { it.toMutableList() }
                createdAt = sensorPlanGetResponse.createdAt
                createdBy = sensorPlanGetResponse.createdBy
                customer = sensorPlanGetResponse.customer
                endTime = sensorPlanGetResponse.endTime
                idSensor = sensorPlanGetResponse.idSensor
                name = sensorPlanGetResponse.name
                origin = sensorPlanGetResponse.origin
                origNetwork = sensorPlanGetResponse.origNetwork
                origSensorId = sensorPlanGetResponse.origSensorId
                purpose = sensorPlanGetResponse.purpose
                reqTotal = sensorPlanGetResponse.reqTotal
                senNetwork = sensorPlanGetResponse.senNetwork
                status = sensorPlanGetResponse.status
                tags = sensorPlanGetResponse.tags.map { it.toMutableList() }
                updatedAt = sensorPlanGetResponse.updatedAt
                updatedBy = sensorPlanGetResponse.updatedBy
                additionalProperties = sensorPlanGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorPlanGetResponse].
         *
         ...
         */
        fun build(): SensorPlanGetResponse =
    ...
    fun validate(): SensorPlanGetResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "SensorPlanGetResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, recType=$recType, source=$source, startTime=$startTime, type=$type, id=$id, collectRequests=$collectRequests, createdAt=$createdAt, createdBy=$createdBy, customer=$customer, endTime=$endTime, idSensor=$idSensor, name=$name, origin=$origin, origNetwork=$origNetwork, origSensorId=$origSensorId, purpose=$purpose, reqTotal=$reqTotal, senNetwork=$senNetwork, status=$status, tags=$tags, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
