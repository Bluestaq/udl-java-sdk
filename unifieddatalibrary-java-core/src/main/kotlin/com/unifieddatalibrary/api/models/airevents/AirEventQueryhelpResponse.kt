...
class AirEventQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventQueryhelpResponse: AirEventQueryhelpResponse) = apply {
    ...
    fun validate(): AirEventQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
