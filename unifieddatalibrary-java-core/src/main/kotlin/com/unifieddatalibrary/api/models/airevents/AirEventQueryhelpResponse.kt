...
class AirEventQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AirEventQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirEventQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventQueryhelpResponse: AirEventQueryhelpResponse) =
            apply {
                aodrSupported = airEventQueryhelpResponse.aodrSupported
                classificationMarking = airEventQueryhelpResponse.classificationMarking
                description = airEventQueryhelpResponse.description
                historySupported = airEventQueryhelpResponse.historySupported
                name = airEventQueryhelpResponse.name
                parameters = airEventQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = airEventQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = airEventQueryhelpResponse.restSupported
                sortSupported = airEventQueryhelpResponse.sortSupported
                typeName = airEventQueryhelpResponse.typeName
                uri = airEventQueryhelpResponse.uri
                additionalProperties = airEventQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirEventQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirEventQueryhelpResponse =
    ...
    fun validate(): AirEventQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirEventQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
