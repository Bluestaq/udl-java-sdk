...
/**
 * Service operation to take a list of WeatherReports as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class WeatherReportUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [WeatherReportUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            weatherReportUnvalidatedPublishParams: WeatherReportUnvalidatedPublishParams
        ) = apply {
            body = weatherReportUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = weatherReportUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                weatherReportUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WeatherReportUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): WeatherReportUnvalidatedPublishParams =
            WeatherReportUnvalidatedPublishParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WeatherReportUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "WeatherReportUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
