...
class OnboardnavigationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnboardnavigationTupleParams].
         *
    ...
    /** A builder for [OnboardnavigationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationTupleParams: OnboardnavigationTupleParams) =
            apply {
                columns = onboardnavigationTupleParams.columns
                startTime = onboardnavigationTupleParams.startTime
                firstResult = onboardnavigationTupleParams.firstResult
                maxResults = onboardnavigationTupleParams.maxResults
                additionalHeaders = onboardnavigationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = onboardnavigationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnboardnavigationTupleParams].
         *
         ...
         */
        fun build(): OnboardnavigationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnboardnavigationTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnboardnavigationTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
