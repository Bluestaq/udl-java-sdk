...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldCountParams: AirfieldCountParams) = apply {
    ...
    override fun toString() =
        "AirfieldCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
