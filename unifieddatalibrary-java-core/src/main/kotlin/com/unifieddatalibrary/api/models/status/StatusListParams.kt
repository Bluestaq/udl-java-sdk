...
class StatusListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): StatusListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusListParams: StatusListParams) =
            apply {
                firstResult = statusListParams.firstResult
                maxResults = statusListParams.maxResults
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StatusListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "StatusListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
