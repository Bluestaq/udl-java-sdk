 ...
 */
class LogisticsSupportUpdateParams
private constructor(
    ...
    fun logisticsDiscrepancyInfos(): Optional<List<LogisticsDiscrepancyInfo>> =
        body.logisticsDiscrepancyInfos()
    ...
    fun logisticsTransportationPlans(): Optional<List<LogisticsTransportationPlan>> =
        body.logisticsTransportationPlans()
    ...
    fun _logisticsDiscrepancyInfos(): JsonField<List<LogisticsDiscrepancyInfo>> =
        body._logisticsDiscrepancyInfos()
     ...
     * type.
     */
    fun _logisticsSupportItems(): JsonField<List<LogisticsSupportItem>> =
        body._logisticsSupportItems()
    ...
    fun _logisticsTransportationPlans(): JsonField<List<LogisticsTransportationPlan>> =
        body._logisticsTransportationPlans()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportUpdateParams: LogisticsSupportUpdateParams) = apply {
        ...
        /** The time this report was created, in ISO 8601 UTC format with millisecond precision. */
        fun rptCreatedTime(rptCreatedTime: OffsetDateTime) = apply {
         ...
         * record.
         */
        fun currIcao(currIcao: String) = apply { body.currIcao(currIcao) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun currIcao(currIcao: JsonField<String>) = apply { body.currIcao(currIcao) }
        ...
        /** Logistics estimated time mission capable. */
        fun etmc(etmc: OffsetDateTime) = apply { body.etmc(etmc) }
         ...
         * value.
         */
        fun etmc(etmc: JsonField<OffsetDateTime>) = apply { body.etmc(etmc) }
         ...
         * generated ID.
         */
        fun extSystemId(extSystemId: String) = apply { body.extSystemId(extSystemId) }
         ...
         * value.
         */
        fun extSystemId(extSystemId: JsonField<String>) = apply { body.extSystemId(extSystemId) }
         ...
         */
        fun logisticAction(logisticAction: String) = apply { body.logisticAction(logisticAction) }
        ...
        ) = apply { body.logisticsDiscrepancyInfos(logisticsDiscrepancyInfos) }
        ...
        /** The identifier that represents a Logistics Master Record. */
        fun logisticsRecordId(logisticsRecordId: String) = apply {
        ...
        /** Remarks associated with this LogisticsSupport record. */
        fun logisticsRemarks(logisticsRemarks: List<LogisticsRemark>) = apply {
         ...
         * `List<LogisticsRemark>` value instead. This method is primarily for setting the field to
        ...
        /** Support items associated with this LogisticsSupport record. */
        fun logisticsSupportItems(logisticsSupportItems: List<LogisticsSupportItem>) = apply {
        ...
        ) = apply { body.logisticsTransportationPlans(logisticsTransportationPlans) }
        ...
        ) = apply { body.addLogisticsTransportationPlan(logisticsTransportationPlan) }

        /**
         * The maintenance status code of the aircraft which may be based on pilot descriptions or
         * evaluation codes. Contact the source provider for details.
         */
        fun maintStatusCode(maintStatusCode: String) = apply {
         ...
         */
        fun mcTime(mcTime: OffsetDateTime) = apply { body.mcTime(mcTime) }
         ...
         * supported value.
         */
        fun mcTime(mcTime: JsonField<OffsetDateTime>) = apply { body.mcTime(mcTime) }

        /**
         * The time indicating when a given aircraft breaks for a mission essential reason. This
         * datetime should be in ISO 8601 UTC format with millisecond precision.
         */
        fun meTime(meTime: OffsetDateTime) = apply { body.meTime(meTime) }
         ...
         * supported value.
         */
        fun meTime(meTime: JsonField<OffsetDateTime>) = apply { body.meTime(meTime) }
        ...
        /** This is used to indicate whether a closed master record has been reopened. */
        fun reopenFlag(reopenFlag: Boolean) = apply { body.reopenFlag(reopenFlag) }
         ...
         * value.
         */
        fun reopenFlag(reopenFlag: JsonField<Boolean>) = apply { body.reopenFlag(reopenFlag) }

        /** The time this report was closed, in ISO 8601 UTC format with millisecond precision. */
        fun rptClosedTime(rptClosedTime: OffsetDateTime) = apply {
         ...
         * record.
         */
        fun suppIcao(suppIcao: String) = apply { body.suppIcao(suppIcao) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun suppIcao(suppIcao: JsonField<String>) = apply { body.suppIcao(suppIcao) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): LogisticsRemark =
                LogisticsRemark(lastChanged, remark, username, additionalProperties.toMutableMap())
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * well-typed `List<LogisticsTransportationPlansRemark>` value instead. This method is
    ...
    override fun toString() =
        "LogisticsSupportUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
