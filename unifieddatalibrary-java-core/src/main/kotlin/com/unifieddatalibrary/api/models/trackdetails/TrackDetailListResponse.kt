...
class TrackDetailListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("acftSubType") @ExcludeMissing acftSubType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("antennaRefDimensions") @ExcludeMissing antennaRefDimensions: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("aouRptData") @ExcludeMissing aouRptData: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("aouRptType") @ExcludeMissing aouRptType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("arrTime") @ExcludeMissing arrTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("azCorrArcWidth") @ExcludeMissing azCorrArcWidth: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("azCorrCenterLine") @ExcludeMissing azCorrCenterLine: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("burnoutAlt") @ExcludeMissing burnoutAlt: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("containment") @ExcludeMissing containment: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("coopLocInd") @ExcludeMissing coopLocInd: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("ecefPos") @ExcludeMissing ecefPos: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("ecefVel") @ExcludeMissing ecefVel: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("emitterName") @ExcludeMissing emitterName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("env") @ExcludeMissing env: JsonField<Env> = JsonMissing.of(),
        @JsonProperty("errAreaOrient") @ExcludeMissing errAreaOrient: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("errGeoAreaSwitch") @ExcludeMissing errGeoAreaSwitch: JsonField<String> = JsonMissing.of(),
        @JsonProperty("errSemiIntAxis") @ExcludeMissing errSemiIntAxis: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("errSemiMajElev") @ExcludeMissing errSemiMajElev: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("evalRating") @ExcludeMissing evalRating: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("ftnMsgTs") @ExcludeMissing ftnMsgTs: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("impactAouData") @ExcludeMissing impactAouData: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("impactAouType") @ExcludeMissing impactAouType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("impactTime") @ExcludeMissing impactTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("infoSource") @ExcludeMissing infoSource: JsonField<String> = JsonMissing.of(),
        @JsonProperty("installation") @ExcludeMissing installation: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("launchAouData") @ExcludeMissing launchAouData: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("launchAouType") @ExcludeMissing launchAouType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("launchTime") @ExcludeMissing launchTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("length") @ExcludeMissing length: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("lostTrkInd") @ExcludeMissing lostTrkInd: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("maneuverInd") @ExcludeMissing maneuverInd: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("mil2525Bstr") @ExcludeMissing mil2525Bstr: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("muidSrcTrk") @ExcludeMissing muidSrcTrk: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("polarSingLocLat") @ExcludeMissing polarSingLocLat: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("polarSingLocLon") @ExcludeMissing polarSingLocLon: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("posDeviceType") @ExcludeMissing posDeviceType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("reinforced") @ExcludeMissing reinforced: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("rptArchived") @ExcludeMissing rptArchived: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("rtnMsgTs") @ExcludeMissing rtnMsgTs: JsonField<List<OffsetDateTime>> = JsonMissing.of(),
        @JsonProperty("rtnTrkState") @ExcludeMissing rtnTrkState: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("selfReport") @ExcludeMissing selfReport: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("spaceAmpConf") @ExcludeMissing spaceAmpConf: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("spaceSpecType") @ExcludeMissing spaceSpecType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("tesEventId") @ExcludeMissing tesEventId: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("trnspdrType") @ExcludeMissing trnspdrType: JsonField<String> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun antennaRefDimensions(): Optional<List<Double>> = antennaRefDimensions.getOptional("antennaRefDimensions")
    ...
    @ExcludeMissing
    fun _addInfo(): JsonField<String> = addInfo
    ...
    @JsonProperty("alert")
    @ExcludeMissing
    fun _alert(): JsonField<String> = alert
     ...
     */
    @JsonProperty("angElev")
    @ExcludeMissing
    fun _angElev(): JsonField<Double> = angElev

    /**
     * Returns the raw JSON value of [antennaRefDimensions].
     *
     * Unlike [antennaRefDimensions], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("appGrp")
    @ExcludeMissing
    fun _appGrp(): JsonField<String> = appGrp
     ...
     */
    @JsonProperty("arrCargo")
    @ExcludeMissing
    fun _arrCargo(): JsonField<String> = arrCargo
     ...
     */
    @JsonProperty("arrFlag")
    @ExcludeMissing
    fun _arrFlag(): JsonField<String> = arrFlag
    ...
    @ExcludeMissing
    fun _arrPort(): JsonField<String> = arrPort
    ...
    @ExcludeMissing
    fun _arrTime(): JsonField<OffsetDateTime> = arrTime
    ...
    @JsonProperty("aton")
    @ExcludeMissing
    fun _aton(): JsonField<String> = aton
    ...
    @JsonProperty("avgSpd")
    @ExcludeMissing
    fun _avgSpd(): JsonField<Double> = avgSpd
     ...
     *
     * Unlike [azCorrCenterLine], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _boosting(): JsonField<Boolean> = boosting
    ...
    @JsonProperty("course")
    @ExcludeMissing
    fun _course(): JsonField<Double> = course
     ...
     */
    @JsonProperty("depCargo")
    @ExcludeMissing
    fun _depCargo(): JsonField<String> = depCargo
    ...
    @ExcludeMissing
    fun _depFlag(): JsonField<String> = depFlag
    ...
    @ExcludeMissing
    fun _depPort(): JsonField<String> = depPort
    ...
    @ExcludeMissing
    fun _desCargo(): JsonField<String> = desCargo
     ...
     */
    @JsonProperty("desFlag")
    @ExcludeMissing
    fun _desFlag(): JsonField<String> = desFlag
    ...
    @JsonProperty("disId")
    @ExcludeMissing
    fun _disId(): JsonField<String> = disId
    ...
    @ExcludeMissing
    fun _draught(): JsonField<Double> = draught
    ...
    @ExcludeMissing
    fun _dropPtInd(): JsonField<Boolean> = dropPtInd
    ...
    @JsonProperty("dummy")
    @ExcludeMissing
    fun _dummy(): JsonField<Boolean> = dummy
    ...
    @ExcludeMissing
    fun _ecefPos(): JsonField<List<Double>> = ecefPos
    ...
    @ExcludeMissing
    fun _ecefVel(): JsonField<List<Double>> = ecefVel
    ...
    @JsonProperty("elnot1")
    @ExcludeMissing
    fun _elnot1(): JsonField<String> = elnot1
    ...
    @JsonProperty("elnot2")
    @ExcludeMissing
    fun _elnot2(): JsonField<String> = elnot2
    ...
    @JsonProperty("emgInd")
    @ExcludeMissing
    fun _emgInd(): JsonField<Boolean> = emgInd
     ...
     *
     * Unlike [errGeoAreaSwitch], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("etd")
    @ExcludeMissing
    fun _etd(): JsonField<OffsetDateTime> = etd
    ...
    @JsonProperty("feint")
    @ExcludeMissing
    fun _feint(): JsonField<Boolean> = feint
    ...
    @JsonProperty("ftnCmd")
    @ExcludeMissing
    fun _ftnCmd(): JsonField<String> = ftnCmd
    ...
    @ExcludeMissing
    fun _harmonics(): JsonField<String> = harmonics
    ...
    @JsonProperty("hdng")
    @ExcludeMissing
    fun _hdng(): JsonField<Double> = hdng
     ...
     */
    @JsonProperty("hullNum")
    @ExcludeMissing
    fun _hullNum(): JsonField<String> = hullNum
     ...
     */
    @JsonProperty("hullProf")
    @ExcludeMissing
    fun _hullProf(): JsonField<String> = hullProf
    ...
    @ExcludeMissing
    fun _identAmp(): JsonField<String> = identAmp
    ...
    @ExcludeMissing
    fun _impactLat(): JsonField<Double> = impactLat
    ...
    @ExcludeMissing
    fun _impactLon(): JsonField<Double> = impactLon
    ...
    @ExcludeMissing
    fun _launchLat(): JsonField<Double> = launchLat
    ...
    @ExcludeMissing
    fun _launchLon(): JsonField<Double> = launchLon
     ...
     */
    @JsonProperty("midbCat")
    @ExcludeMissing
    fun _midbCat(): JsonField<String> = midbCat
    ...
    @ExcludeMissing
    fun _mslStatus(): JsonField<String> = mslStatus
     ...
     */
    @JsonProperty("muidSrc")
    @ExcludeMissing
    fun _muidSrc(): JsonField<String> = muidSrc
    ...
    @ExcludeMissing
    fun _navStatus(): JsonField<String> = navStatus
    ...
    @JsonProperty("ntds")
    @ExcludeMissing
    fun _ntds(): JsonField<String> = ntds
     ...
     */
    @JsonProperty("numBlades")
    @ExcludeMissing
    fun _numBlades(): JsonField<Int> = numBlades
     ...
     */
    @JsonProperty("numShafts")
    @ExcludeMissing
    fun _numShafts(): JsonField<Int> = numShafts
    ...
    @JsonProperty("objAct")
    @ExcludeMissing
    fun _objAct(): JsonField<String> = objAct
    ...
    @ExcludeMissing
    fun _objIdent(): JsonField<ObjIdent> = objIdent
    ...
    @JsonProperty("objNat")
    @ExcludeMissing
    fun _objNat(): JsonField<String> = objNat
     ...
     */
    @JsonProperty("objPlat")
    @ExcludeMissing
    fun _objPlat(): JsonField<String> = objPlat
    ...
    @ExcludeMissing
    fun _objType(): JsonField<String> = objType
     ...
     */
    @JsonProperty("offPosInd")
    @ExcludeMissing
    fun _offPosInd(): JsonField<String> = offPosInd
     ...
     */
    @JsonProperty("origXref")
    @ExcludeMissing
    fun _origXref(): JsonField<String> = origXref
     ...
     */
    @JsonProperty("propRPM")
    @ExcludeMissing
    fun _propRpm(): JsonField<Double> = propRpm
    ...
    @ExcludeMissing
    fun _propType(): JsonField<String> = propType
    ...
    @ExcludeMissing
    fun _reduced(): JsonField<Boolean> = reduced
     ...
     */
    @JsonProperty("rptChxref")
    @ExcludeMissing
    fun _rptChxref(): JsonField<String> = rptChxref
    ...
    @JsonProperty("rtn")
    @ExcludeMissing
    fun _rtn(): JsonField<List<String>> = rtn
    ...
    @JsonProperty("rtnCmd")
    @ExcludeMissing
    fun _rtnCmd(): JsonField<String> = rtnCmd
    ...
    @ExcludeMissing
    fun _scanRate(): JsonField<Double> = scanRate
    ...
    @JsonProperty("sconum")
    @ExcludeMissing
    fun _sconum(): JsonField<String> = sconum
    ...
    @ExcludeMissing
    fun _shipClass(): JsonField<String> = shipClass
    ...
    @ExcludeMissing
    fun _sourceUid(): JsonField<String> = sourceUid
    ...
    @ExcludeMissing
    fun _spaceAmp(): JsonField<String> = spaceAmp
     ...
     */
    @JsonProperty("staffCmts")
    @ExcludeMissing
    fun _staffCmts(): JsonField<String> = staffCmts
    ...
    @ExcludeMissing
    fun _sternType(): JsonField<String> = sternType
    ...
    @ExcludeMissing
    fun _taskForce(): JsonField<Boolean> = taskForce
    ...
    @JsonProperty("tcpa")
    @ExcludeMissing
    fun _tcpa(): JsonField<OffsetDateTime> = tcpa
     ...
     */
    @JsonProperty("trkConf")
    @ExcludeMissing
    fun _trkConf(): JsonField<Double> = trkConf
    ...
    @JsonProperty("trkNum")
    @ExcludeMissing
    fun _trkNum(): JsonField<String> = trkNum
    ...
    @ExcludeMissing
    fun _trkQual(): JsonField<Int> = trkQual
     ...
     */
    @JsonProperty("trkScope")
    @ExcludeMissing
    fun _trkScope(): JsonField<String> = trkScope
     ...
     */
    @JsonProperty("trnspdrId")
    @ExcludeMissing
    fun _trnspdrId(): JsonField<String> = trnspdrId
    ...
    @JsonProperty("vslWt")
    @ExcludeMissing
    fun _vslWt(): JsonField<Double> = vslWt
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackDetailListResponse].
         *
    ...
    /** A builder for [TrackDetailListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailListResponse: TrackDetailListResponse) =
            apply {
                classificationMarking = trackDetailListResponse.classificationMarking
                dataMode = trackDetailListResponse.dataMode
                lat = trackDetailListResponse.lat
                lon = trackDetailListResponse.lon
                source = trackDetailListResponse.source
                ts = trackDetailListResponse.ts
                id = trackDetailListResponse.id
                acftSubType = trackDetailListResponse.acftSubType
                addInfo = trackDetailListResponse.addInfo
                alert = trackDetailListResponse.alert
                alt = trackDetailListResponse.alt
                angElev = trackDetailListResponse.angElev
                antennaRefDimensions = trackDetailListResponse.antennaRefDimensions.map { it.toMutableList() }
                aouRptData = trackDetailListResponse.aouRptData.map { it.toMutableList() }
                aouRptType = trackDetailListResponse.aouRptType
                appGrp = trackDetailListResponse.appGrp
                arrCargo = trackDetailListResponse.arrCargo
                arrFlag = trackDetailListResponse.arrFlag
                arrPort = trackDetailListResponse.arrPort
                arrTime = trackDetailListResponse.arrTime
                aton = trackDetailListResponse.aton
                avgSpd = trackDetailListResponse.avgSpd
                azCorrArcWidth = trackDetailListResponse.azCorrArcWidth
                azCorrCenterLine = trackDetailListResponse.azCorrCenterLine
                beNumber = trackDetailListResponse.beNumber
                boosting = trackDetailListResponse.boosting
                burnoutAlt = trackDetailListResponse.burnoutAlt
                callSign = trackDetailListResponse.callSign
                cargoType = trackDetailListResponse.cargoType
                cI = trackDetailListResponse.cI
                containment = trackDetailListResponse.containment
                coopLocInd = trackDetailListResponse.coopLocInd
                course = trackDetailListResponse.course
                cpa = trackDetailListResponse.cpa
                createdAt = trackDetailListResponse.createdAt
                createdBy = trackDetailListResponse.createdBy
                depCargo = trackDetailListResponse.depCargo
                depFlag = trackDetailListResponse.depFlag
                depPort = trackDetailListResponse.depPort
                desCargo = trackDetailListResponse.desCargo
                desFlag = trackDetailListResponse.desFlag
                destination = trackDetailListResponse.destination
                disId = trackDetailListResponse.disId
                draught = trackDetailListResponse.draught
                dropPtInd = trackDetailListResponse.dropPtInd
                dummy = trackDetailListResponse.dummy
                ecefPos = trackDetailListResponse.ecefPos.map { it.toMutableList() }
                ecefVel = trackDetailListResponse.ecefVel.map { it.toMutableList() }
                elnot1 = trackDetailListResponse.elnot1
                elnot2 = trackDetailListResponse.elnot2
                emgInd = trackDetailListResponse.emgInd
                emitterName = trackDetailListResponse.emitterName
                env = trackDetailListResponse.env
                errAreaOrient = trackDetailListResponse.errAreaOrient
                errGeoAreaSwitch = trackDetailListResponse.errGeoAreaSwitch
                errSemiIntAxis = trackDetailListResponse.errSemiIntAxis
                errSemiMajElev = trackDetailListResponse.errSemiMajElev
                eta = trackDetailListResponse.eta
                etd = trackDetailListResponse.etd
                evalRating = trackDetailListResponse.evalRating
                feint = trackDetailListResponse.feint
                freq = trackDetailListResponse.freq
                ftn = trackDetailListResponse.ftn
                ftnCmd = trackDetailListResponse.ftnCmd
                ftnMsgTs = trackDetailListResponse.ftnMsgTs
                harmonics = trackDetailListResponse.harmonics
                hdng = trackDetailListResponse.hdng
                hq = trackDetailListResponse.hq
                hullNum = trackDetailListResponse.hullNum
                hullProf = trackDetailListResponse.hullProf
                identAmp = trackDetailListResponse.identAmp
                iff = trackDetailListResponse.iff
                imon = trackDetailListResponse.imon
                impactAouData = trackDetailListResponse.impactAouData.map { it.toMutableList() }
                impactAouType = trackDetailListResponse.impactAouType
                impactLat = trackDetailListResponse.impactLat
                impactLon = trackDetailListResponse.impactLon
                impactTime = trackDetailListResponse.impactTime
                infoSource = trackDetailListResponse.infoSource
                installation = trackDetailListResponse.installation
                launchAouData = trackDetailListResponse.launchAouData.map { it.toMutableList() }
                launchAouType = trackDetailListResponse.launchAouType
                launchLat = trackDetailListResponse.launchLat
                launchLon = trackDetailListResponse.launchLon
                launchTime = trackDetailListResponse.launchTime
                length = trackDetailListResponse.length
                lostTrkInd = trackDetailListResponse.lostTrkInd
                maneuverInd = trackDetailListResponse.maneuverInd
                maxFreq = trackDetailListResponse.maxFreq
                midbCat = trackDetailListResponse.midbCat
                mil2525Bstr = trackDetailListResponse.mil2525Bstr
                mmsi = trackDetailListResponse.mmsi
                msgType = trackDetailListResponse.msgType
                mslStatus = trackDetailListResponse.mslStatus
                muidSrc = trackDetailListResponse.muidSrc
                muidSrcTrk = trackDetailListResponse.muidSrcTrk
                name = trackDetailListResponse.name
                navStatus = trackDetailListResponse.navStatus
                ntds = trackDetailListResponse.ntds
                numBlades = trackDetailListResponse.numBlades
                numShafts = trackDetailListResponse.numShafts
                objAct = trackDetailListResponse.objAct
                objIdent = trackDetailListResponse.objIdent
                objNat = trackDetailListResponse.objNat
                objPlat = trackDetailListResponse.objPlat
                objType = trackDetailListResponse.objType
                offPosInd = trackDetailListResponse.offPosInd
                origin = trackDetailListResponse.origin
                origNetwork = trackDetailListResponse.origNetwork
                origXref = trackDetailListResponse.origXref
                oSuffix = trackDetailListResponse.oSuffix
                pif = trackDetailListResponse.pif
                pin = trackDetailListResponse.pin
                polarSingLocLat = trackDetailListResponse.polarSingLocLat
                polarSingLocLon = trackDetailListResponse.polarSingLocLon
                posDeviceType = trackDetailListResponse.posDeviceType
                prf = trackDetailListResponse.prf
                pri = trackDetailListResponse.pri
                propRpm = trackDetailListResponse.propRpm
                propType = trackDetailListResponse.propType
                pw = trackDetailListResponse.pw
                reduced = trackDetailListResponse.reduced
                reinforced = trackDetailListResponse.reinforced
                rptArchived = trackDetailListResponse.rptArchived
                rptChxref = trackDetailListResponse.rptChxref
                rtn = trackDetailListResponse.rtn.map { it.toMutableList() }
                rtnCmd = trackDetailListResponse.rtnCmd
                rtnMsgTs = trackDetailListResponse.rtnMsgTs.map { it.toMutableList() }
                rtnTrkState = trackDetailListResponse.rtnTrkState
                scanRate = trackDetailListResponse.scanRate
                scanType = trackDetailListResponse.scanType
                scn = trackDetailListResponse.scn
                sconum = trackDetailListResponse.sconum
                selfReport = trackDetailListResponse.selfReport
                sen = trackDetailListResponse.sen
                shipClass = trackDetailListResponse.shipClass
                shortName = trackDetailListResponse.shortName
                sourceUid = trackDetailListResponse.sourceUid
                spaceAmp = trackDetailListResponse.spaceAmp
                spaceAmpConf = trackDetailListResponse.spaceAmpConf
                spaceSpecType = trackDetailListResponse.spaceSpecType
                spd = trackDetailListResponse.spd
                staffCmts = trackDetailListResponse.staffCmts
                sternType = trackDetailListResponse.sternType
                taskForce = trackDetailListResponse.taskForce
                tcpa = trackDetailListResponse.tcpa
                tesEventId = trackDetailListResponse.tesEventId
                tol = trackDetailListResponse.tol
                tpk = trackDetailListResponse.tpk
                trkConf = trackDetailListResponse.trkConf
                trkId = trackDetailListResponse.trkId
                trkNum = trackDetailListResponse.trkNum
                trkQual = trackDetailListResponse.trkQual
                trkScope = trackDetailListResponse.trkScope
                trnspdrId = trackDetailListResponse.trnspdrId
                trnspdrType = trackDetailListResponse.trnspdrType
                vslWt = trackDetailListResponse.vslWt
                width = trackDetailListResponse.width
                additionalProperties = trackDetailListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.acftSubType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun acftSubType(acftSubType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.addInfo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun addInfo(addInfo: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.alert] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alert(alert: JsonField<String>) =
            apply {
                this.alert = alert
            }
         ...
         *
         * You should usually call [Builder.angElev] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun angElev(angElev: JsonField<Double>) =
            apply {
                this.angElev = angElev
            }

        /** The reference dimensions of the vessel, reported as [A, B, C, D], in meters. Where the array values represent the distance fore (A), aft (B), to port (C), and to starboard (D) of the navigation antenna. Array with values A = C = 0 and B, D > 0 indicate the length (B) and width (D) of the vessel without antenna position reference. */
        fun antennaRefDimensions(antennaRefDimensions: List<Double>) = antennaRefDimensions(JsonField.of(antennaRefDimensions))

        /**
         * Sets [Builder.antennaRefDimensions] to an arbitrary JSON value.
         *
         * You should usually call [Builder.antennaRefDimensions] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun antennaRefDimensions(antennaRefDimensions: JsonField<List<Double>>) =
            apply {
         ...
         */
        fun addAntennaRefDimension(antennaRefDimension: Double) =
            apply {
                antennaRefDimensions = (antennaRefDimensions ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.aouRptData] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun aouRptData(aouRptData: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAouRptData(aouRptData: Double) =
            apply {
                this.aouRptData = (this.aouRptData ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.aouRptType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun aouRptType(aouRptType: JsonField<String>) =
            apply {
                this.aouRptType = aouRptType
            }
         ...
         *
         * You should usually call [Builder.appGrp] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun appGrp(appGrp: JsonField<String>) =
            apply {
                this.appGrp = appGrp
            }
         ...
         *
         * You should usually call [Builder.arrCargo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrCargo(arrCargo: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.arrFlag] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrFlag(arrFlag: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.arrPort] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrPort(arrPort: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.arrTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrTime(arrTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.aton] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun aton(aton: JsonField<String>) =
            apply {
                this.aton = aton
            }
         ...
         *
         * You should usually call [Builder.avgSpd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun avgSpd(avgSpd: JsonField<Double>) =
            apply {
                this.avgSpd = avgSpd
            }
         ...
         *
         * You should usually call [Builder.azCorrArcWidth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun azCorrArcWidth(azCorrArcWidth: JsonField<Double>) =
            apply {
                this.azCorrArcWidth = azCorrArcWidth
            }

        /** The azimuth corridor centerline angle measured in degrees clockwise from true north, of the center line of an azimuth corridor. The center line extends from the referenced corridor origin location. */
        fun azCorrCenterLine(azCorrCenterLine: Double) = azCorrCenterLine(JsonField.of(azCorrCenterLine))

        /**
         * Sets [Builder.azCorrCenterLine] to an arbitrary JSON value.
         *
         * You should usually call [Builder.azCorrCenterLine] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun azCorrCenterLine(azCorrCenterLine: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.boosting] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun boosting(boosting: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.burnoutAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun burnoutAlt(burnoutAlt: JsonField<Double>) =
            apply {
                this.burnoutAlt = burnoutAlt
            }
         ...
         *
         * You should usually call [Builder.cI] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cI(cI: JsonField<String>) =
            apply {
                this.cI = cI
            }
         ...
         *
         * You should usually call [Builder.containment] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun containment(containment: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.coopLocInd] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun coopLocInd(coopLocInd: JsonField<String>) =
            apply {
                this.coopLocInd = coopLocInd
            }
         ...
         *
         * You should usually call [Builder.course] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun course(course: JsonField<Double>) =
            apply {
                this.course = course
            }
         ...
         *
         * You should usually call [Builder.cpa] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cpa(cpa: JsonField<Double>) =
            apply {
                this.cpa = cpa
            }
         ...
         *
         * You should usually call [Builder.depCargo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depCargo(depCargo: JsonField<String>) =
            apply {
                this.depCargo = depCargo
            }
         ...
         *
         * You should usually call [Builder.depFlag] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depFlag(depFlag: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.depPort] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depPort(depPort: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.desCargo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun desCargo(desCargo: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.desFlag] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun desFlag(desFlag: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.disId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun disId(disId: JsonField<String>) =
            apply {
                this.disId = disId
            }
         ...
         *
         * You should usually call [Builder.draught] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun draught(draught: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.dropPtInd] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dropPtInd(dropPtInd: JsonField<Boolean>) =
            apply {
                this.dropPtInd = dropPtInd
            }
         ...
         *
         * You should usually call [Builder.dummy] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dummy(dummy: JsonField<Boolean>) =
            apply {
                this.dummy = dummy
            }
         ...
         *
         * You should usually call [Builder.ecefPos] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ecefPos(ecefPos: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addEcefPo(ecefPo: Double) =
            apply {
                ecefPos = (ecefPos ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.ecefVel] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ecefVel(ecefVel: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addEcefVel(ecefVel: Double) =
            apply {
                this.ecefVel = (this.ecefVel ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.elnot1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun elnot1(elnot1: JsonField<String>) =
            apply {
                this.elnot1 = elnot1
            }
         ...
         *
         * You should usually call [Builder.elnot2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun elnot2(elnot2: JsonField<String>) =
            apply {
                this.elnot2 = elnot2
            }
         ...
         *
         * You should usually call [Builder.emgInd] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun emgInd(emgInd: JsonField<Boolean>) =
            apply {
                this.emgInd = emgInd
            }
         ...
         *
         * You should usually call [Builder.emitterName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun emitterName(emitterName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.env] with a well-typed [Env] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun env(env: JsonField<Env>) =
            apply {
                this.env = env
            }
         ...
         *
         * You should usually call [Builder.errAreaOrient] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun errAreaOrient(errAreaOrient: JsonField<Double>) =
            apply {
         ...
         * 2 - CIRCLE_ELLIPSE.
         */
        fun errGeoAreaSwitch(errGeoAreaSwitch: String) = errGeoAreaSwitch(JsonField.of(errGeoAreaSwitch))

        /**
         * Sets [Builder.errGeoAreaSwitch] to an arbitrary JSON value.
         *
         * You should usually call [Builder.errGeoAreaSwitch] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun errGeoAreaSwitch(errGeoAreaSwitch: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.errSemiIntAxis] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun errSemiIntAxis(errSemiIntAxis: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.errSemiMajElev] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun errSemiMajElev(errSemiMajElev: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.etd] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun etd(etd: JsonField<OffsetDateTime>) =
            apply {
                this.etd = etd
            }
         ...
         *
         * You should usually call [Builder.evalRating] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun evalRating(evalRating: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.feint] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun feint(feint: JsonField<Boolean>) =
            apply {
                this.feint = feint
            }
         ...
         *
         * You should usually call [Builder.ftn] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ftn(ftn: JsonField<String>) =
            apply {
                this.ftn = ftn
            }
         ...
         *
         * You should usually call [Builder.ftnCmd] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ftnCmd(ftnCmd: JsonField<String>) =
            apply {
                this.ftnCmd = ftnCmd
            }
         ...
         *
         * You should usually call [Builder.ftnMsgTs] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ftnMsgTs(ftnMsgTs: JsonField<OffsetDateTime>) =
            apply {
                this.ftnMsgTs = ftnMsgTs
            }
         ...
         *
         * You should usually call [Builder.harmonics] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun harmonics(harmonics: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.hdng] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hdng(hdng: JsonField<Double>) =
            apply {
                this.hdng = hdng
            }
         ...
         *
         * You should usually call [Builder.hq] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hq(hq: JsonField<Boolean>) =
            apply {
                this.hq = hq
            }
         ...
         *
         * You should usually call [Builder.hullNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hullNum(hullNum: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.hullProf] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hullProf(hullProf: JsonField<String>) =
            apply {
                this.hullProf = hullProf
            }
         ...
         *
         * You should usually call [Builder.identAmp] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun identAmp(identAmp: JsonField<String>) =
            apply {
                this.identAmp = identAmp
            }
         ...
         *
         * You should usually call [Builder.iff] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun iff(iff: JsonField<String>) =
            apply {
                this.iff = iff
            }
         ...
         *
         * You should usually call [Builder.imon] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun imon(imon: JsonField<Int>) =
            apply {
                this.imon = imon
            }
         ...
         *
         * You should usually call [Builder.impactAouData] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun impactAouData(impactAouData: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addImpactAouData(impactAouData: Double) =
            apply {
                this.impactAouData = (this.impactAouData ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.impactAouType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun impactAouType(impactAouType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.impactLat] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun impactLat(impactLat: JsonField<Double>) =
            apply {
                this.impactLat = impactLat
            }
         ...
         *
         * You should usually call [Builder.impactLon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun impactLon(impactLon: JsonField<Double>) =
            apply {
                this.impactLon = impactLon
            }
         ...
         *
         * You should usually call [Builder.impactTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun impactTime(impactTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.infoSource] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun infoSource(infoSource: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.installation] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun installation(installation: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.launchAouData] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchAouData(launchAouData: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLaunchAouData(launchAouData: Double) =
            apply {
                this.launchAouData = (this.launchAouData ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.launchAouType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchAouType(launchAouType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.launchLat] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchLat(launchLat: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.launchLon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchLon(launchLon: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.launchTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchTime(launchTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.lostTrkInd] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lostTrkInd(lostTrkInd: JsonField<Boolean>) =
            apply {
                this.lostTrkInd = lostTrkInd
            }
         ...
         *
         * You should usually call [Builder.maneuverInd] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maneuverInd(maneuverInd: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.midbCat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun midbCat(midbCat: JsonField<String>) =
            apply {
                this.midbCat = midbCat
            }
         ...
         *
         * You should usually call [Builder.mil2525Bstr] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mil2525Bstr(mil2525Bstr: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.mmsi] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mmsi(mmsi: JsonField<Int>) =
            apply {
                this.mmsi = mmsi
            }
         ...
         *
         * You should usually call [Builder.mslStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mslStatus(mslStatus: JsonField<String>) =
            apply {
                this.mslStatus = mslStatus
            }
         ...
         *
         * You should usually call [Builder.muidSrc] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun muidSrc(muidSrc: JsonField<String>) =
            apply {
                this.muidSrc = muidSrc
            }
         ...
         *
         * You should usually call [Builder.muidSrcTrk] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun muidSrcTrk(muidSrcTrk: JsonField<String>) =
            apply {
                this.muidSrcTrk = muidSrcTrk
            }
         ...
         *
         * You should usually call [Builder.navStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun navStatus(navStatus: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.ntds] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ntds(ntds: JsonField<String>) =
            apply {
                this.ntds = ntds
            }
         ...
         *
         * You should usually call [Builder.numBlades] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numBlades(numBlades: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.numShafts] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numShafts(numShafts: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.objAct] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun objAct(objAct: JsonField<String>) =
            apply {
                this.objAct = objAct
            }
         ...
         *
         * You should usually call [Builder.objIdent] with a well-typed [ObjIdent] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun objIdent(objIdent: JsonField<ObjIdent>) =
            apply {
         ...
         *
         * You should usually call [Builder.objNat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun objNat(objNat: JsonField<String>) =
            apply {
                this.objNat = objNat
            }
         ...
         *
         * You should usually call [Builder.objPlat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun objPlat(objPlat: JsonField<String>) =
            apply {
                this.objPlat = objPlat
            }
         ...
         *
         * You should usually call [Builder.objType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun objType(objType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.offPosInd] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun offPosInd(offPosInd: JsonField<String>) =
            apply {
                this.offPosInd = offPosInd
            }
         ...
         *
         * You should usually call [Builder.origXref] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun origXref(origXref: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.pif] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pif(pif: JsonField<String>) =
            apply {
                this.pif = pif
            }
        ...
        /** WGS-84 azimuth corridor reference point latitude, in degrees. -90 to 90 degrees (negative values south of equator). */
        fun polarSingLocLat(polarSingLocLat: Double) = polarSingLocLat(JsonField.of(polarSingLocLat))

        /**
         * Sets [Builder.polarSingLocLat] to an arbitrary JSON value.
         *
         * You should usually call [Builder.polarSingLocLat] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarSingLocLat(polarSingLocLat: JsonField<Double>) =
            apply {
                this.polarSingLocLat = polarSingLocLat
            }

        /** WGS-84 azimuth corridor reference point longitude, in degrees. -180 to 180 degrees (negative values west of Prime Meridian). */
        fun polarSingLocLon(polarSingLocLon: Double) = polarSingLocLon(JsonField.of(polarSingLocLon))

        /**
         * Sets [Builder.polarSingLocLon] to an arbitrary JSON value.
         *
         * You should usually call [Builder.polarSingLocLon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarSingLocLon(polarSingLocLon: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.posDeviceType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun posDeviceType(posDeviceType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.prf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun prf(prf: JsonField<Double>) =
            apply {
                this.prf = prf
            }
         ...
         *
         * You should usually call [Builder.pri] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pri(pri: JsonField<Double>) =
            apply {
                this.pri = pri
            }
         ...
         *
         * You should usually call [Builder.propRpm] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun propRpm(propRpm: JsonField<Double>) =
            apply {
                this.propRpm = propRpm
            }
         ...
         *
         * You should usually call [Builder.propType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun propType(propType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.pw] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pw(pw: JsonField<Double>) =
            apply {
                this.pw = pw
            }
         ...
         *
         * You should usually call [Builder.reduced] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reduced(reduced: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.reinforced] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reinforced(reinforced: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.rptArchived] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rptArchived(rptArchived: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.rptChxref] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rptChxref(rptChxref: JsonField<String>) =
            apply {
                this.rptChxref = rptChxref
            }
         ...
         *
         * You should usually call [Builder.rtn] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rtn(rtn: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRtn(rtn: String) =
            apply {
                this.rtn = (this.rtn ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.rtnCmd] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rtnCmd(rtnCmd: JsonField<String>) =
            apply {
                this.rtnCmd = rtnCmd
            }
         ...
         *
         * You should usually call [Builder.rtnMsgTs] with a well-typed `List<OffsetDateTime>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rtnMsgTs(rtnMsgTs: JsonField<List<OffsetDateTime>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRtnMsgT(rtnMsgT: OffsetDateTime) =
            apply {
                rtnMsgTs = (rtnMsgTs ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.rtnTrkState] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rtnTrkState(rtnTrkState: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.scanRate] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun scanRate(scanRate: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.scn] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun scn(scn: JsonField<Int>) =
            apply {
                this.scn = scn
            }
         ...
         *
         * You should usually call [Builder.sconum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sconum(sconum: JsonField<String>) =
            apply {
                this.sconum = sconum
            }
         ...
         *
         * You should usually call [Builder.selfReport] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun selfReport(selfReport: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.sen] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sen(sen: JsonField<String>) =
            apply {
                this.sen = sen
            }
         ...
         *
         * You should usually call [Builder.shipClass] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun shipClass(shipClass: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.shortName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun shortName(shortName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.sourceUid] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sourceUid(sourceUid: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.spaceAmp] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spaceAmp(spaceAmp: JsonField<String>) =
            apply {
                this.spaceAmp = spaceAmp
            }
         ...
         *
         * You should usually call [Builder.spaceAmpConf] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spaceAmpConf(spaceAmpConf: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.spaceSpecType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spaceSpecType(spaceSpecType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.spd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spd(spd: JsonField<Double>) =
            apply {
                this.spd = spd
            }
         ...
         *
         * You should usually call [Builder.staffCmts] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun staffCmts(staffCmts: JsonField<String>) =
            apply {
                this.staffCmts = staffCmts
            }
         ...
         *
         * You should usually call [Builder.sternType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sternType(sternType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.taskForce] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun taskForce(taskForce: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.tcpa] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tcpa(tcpa: JsonField<OffsetDateTime>) =
            apply {
                this.tcpa = tcpa
            }
         ...
         *
         * You should usually call [Builder.tesEventId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tesEventId(tesEventId: JsonField<String>) =
            apply {
                this.tesEventId = tesEventId
            }
         ...
         *
         * You should usually call [Builder.tol] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tol(tol: JsonField<Double>) =
            apply {
                this.tol = tol
            }
         ...
         *
         * You should usually call [Builder.tpk] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tpk(tpk: JsonField<Double>) =
            apply {
                this.tpk = tpk
            }
         ...
         *
         * You should usually call [Builder.trkConf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trkConf(trkConf: JsonField<Double>) =
            apply {
                this.trkConf = trkConf
            }
         ...
         *
         * You should usually call [Builder.trkNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trkNum(trkNum: JsonField<String>) =
            apply {
                this.trkNum = trkNum
            }
         ...
         *
         * You should usually call [Builder.trkQual] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trkQual(trkQual: JsonField<Int>) =
            apply {
                this.trkQual = trkQual
            }
         ...
         *
         * You should usually call [Builder.trkScope] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trkScope(trkScope: JsonField<String>) =
            apply {
                this.trkScope = trkScope
            }
         ...
         *
         * You should usually call [Builder.trnspdrId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trnspdrId(trnspdrId: JsonField<String>) =
            apply {
                this.trnspdrId = trnspdrId
            }
         ...
         *
         * You should usually call [Builder.trnspdrType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trnspdrType(trnspdrType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.vslWt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vslWt(vslWt: JsonField<Double>) =
            apply {
                this.vslWt = vslWt
            }
        ...
        /**
         * Returns an immutable instance of [TrackDetailListResponse].
         *
         ...
         */
        fun build(): TrackDetailListResponse =
    ...
    fun validate(): TrackDetailListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (ts.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (acftSubType.asKnown().isPresent) 1 else 0) + (if (addInfo.asKnown().isPresent) 1 else 0) + (if (alert.asKnown().isPresent) 1 else 0) + (if (alt.asKnown().isPresent) 1 else 0) + (if (angElev.asKnown().isPresent) 1 else 0) + (antennaRefDimensions.asKnown().getOrNull()?.size ?: 0) + (aouRptData.asKnown().getOrNull()?.size ?: 0) + (if (aouRptType.asKnown().isPresent) 1 else 0) + (if (appGrp.asKnown().isPresent) 1 else 0) + (if (arrCargo.asKnown().isPresent) 1 else 0) + (if (arrFlag.asKnown().isPresent) 1 else 0) + (if (arrPort.asKnown().isPresent) 1 else 0) + (if (arrTime.asKnown().isPresent) 1 else 0) + (if (aton.asKnown().isPresent) 1 else 0) + (if (avgSpd.asKnown().isPresent) 1 else 0) + (if (azCorrArcWidth.asKnown().isPresent) 1 else 0) + (if (azCorrCenterLine.asKnown().isPresent) 1 else 0) + (if (beNumber.asKnown().isPresent) 1 else 0) + (if (boosting.asKnown().isPresent) 1 else 0) + (if (burnoutAlt.asKnown().isPresent) 1 else 0) + (if (callSign.asKnown().isPresent) 1 else 0) + (if (cargoType.asKnown().isPresent) 1 else 0) + (if (cI.asKnown().isPresent) 1 else 0) + (if (containment.asKnown().isPresent) 1 else 0) + (if (coopLocInd.asKnown().isPresent) 1 else 0) + (if (course.asKnown().isPresent) 1 else 0) + (if (cpa.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (depCargo.asKnown().isPresent) 1 else 0) + (if (depFlag.asKnown().isPresent) 1 else 0) + (if (depPort.asKnown().isPresent) 1 else 0) + (if (desCargo.asKnown().isPresent) 1 else 0) + (if (desFlag.asKnown().isPresent) 1 else 0) + (if (destination.asKnown().isPresent) 1 else 0) + (if (disId.asKnown().isPresent) 1 else 0) + (if (draught.asKnown().isPresent) 1 else 0) + (if (dropPtInd.asKnown().isPresent) 1 else 0) + (if (dummy.asKnown().isPresent) 1 else 0) + (ecefPos.asKnown().getOrNull()?.size ?: 0) + (ecefVel.asKnown().getOrNull()?.size ?: 0) + (if (elnot1.asKnown().isPresent) 1 else 0) + (if (elnot2.asKnown().isPresent) 1 else 0) + (if (emgInd.asKnown().isPresent) 1 else 0) + (if (emitterName.asKnown().isPresent) 1 else 0) + (env.asKnown().getOrNull()?.validity() ?: 0) + (if (errAreaOrient.asKnown().isPresent) 1 else 0) + (if (errGeoAreaSwitch.asKnown().isPresent) 1 else 0) + (if (errSemiIntAxis.asKnown().isPresent) 1 else 0) + (if (errSemiMajElev.asKnown().isPresent) 1 else 0) + (if (eta.asKnown().isPresent) 1 else 0) + (if (etd.asKnown().isPresent) 1 else 0) + (if (evalRating.asKnown().isPresent) 1 else 0) + (if (feint.asKnown().isPresent) 1 else 0) + (if (freq.asKnown().isPresent) 1 else 0) + (if (ftn.asKnown().isPresent) 1 else 0) + (if (ftnCmd.asKnown().isPresent) 1 else 0) + (if (ftnMsgTs.asKnown().isPresent) 1 else 0) + (if (harmonics.asKnown().isPresent) 1 else 0) + (if (hdng.asKnown().isPresent) 1 else 0) + (if (hq.asKnown().isPresent) 1 else 0) + (if (hullNum.asKnown().isPresent) 1 else 0) + (if (hullProf.asKnown().isPresent) 1 else 0) + (if (identAmp.asKnown().isPresent) 1 else 0) + (if (iff.asKnown().isPresent) 1 else 0) + (if (imon.asKnown().isPresent) 1 else 0) + (impactAouData.asKnown().getOrNull()?.size ?: 0) + (if (impactAouType.asKnown().isPresent) 1 else 0) + (if (impactLat.asKnown().isPresent) 1 else 0) + (if (impactLon.asKnown().isPresent) 1 else 0) + (if (impactTime.asKnown().isPresent) 1 else 0) + (if (infoSource.asKnown().isPresent) 1 else 0) + (if (installation.asKnown().isPresent) 1 else 0) + (launchAouData.asKnown().getOrNull()?.size ?: 0) + (if (launchAouType.asKnown().isPresent) 1 else 0) + (if (launchLat.asKnown().isPresent) 1 else 0) + (if (launchLon.asKnown().isPresent) 1 else 0) + (if (launchTime.asKnown().isPresent) 1 else 0) + (if (length.asKnown().isPresent) 1 else 0) + (if (lostTrkInd.asKnown().isPresent) 1 else 0) + (if (maneuverInd.asKnown().isPresent) 1 else 0) + (if (maxFreq.asKnown().isPresent) 1 else 0) + (if (midbCat.asKnown().isPresent) 1 else 0) + (if (mil2525Bstr.asKnown().isPresent) 1 else 0) + (if (mmsi.asKnown().isPresent) 1 else 0) + (if (msgType.asKnown().isPresent) 1 else 0) + (if (mslStatus.asKnown().isPresent) 1 else 0) + (if (muidSrc.asKnown().isPresent) 1 else 0) + (if (muidSrcTrk.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (navStatus.asKnown().isPresent) 1 else 0) + (if (ntds.asKnown().isPresent) 1 else 0) + (if (numBlades.asKnown().isPresent) 1 else 0) + (if (numShafts.asKnown().isPresent) 1 else 0) + (if (objAct.asKnown().isPresent) 1 else 0) + (objIdent.asKnown().getOrNull()?.validity() ?: 0) + (if (objNat.asKnown().isPresent) 1 else 0) + (if (objPlat.asKnown().isPresent) 1 else 0) + (if (objType.asKnown().isPresent) 1 else 0) + (if (offPosInd.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origXref.asKnown().isPresent) 1 else 0) + (if (oSuffix.asKnown().isPresent) 1 else 0) + (if (pif.asKnown().isPresent) 1 else 0) + (if (pin.asKnown().isPresent) 1 else 0) + (if (polarSingLocLat.asKnown().isPresent) 1 else 0) + (if (polarSingLocLon.asKnown().isPresent) 1 else 0) + (if (posDeviceType.asKnown().isPresent) 1 else 0) + (if (prf.asKnown().isPresent) 1 else 0) + (if (pri.asKnown().isPresent) 1 else 0) + (if (propRpm.asKnown().isPresent) 1 else 0) + (if (propType.asKnown().isPresent) 1 else 0) + (if (pw.asKnown().isPresent) 1 else 0) + (if (reduced.asKnown().isPresent) 1 else 0) + (if (reinforced.asKnown().isPresent) 1 else 0) + (if (rptArchived.asKnown().isPresent) 1 else 0) + (if (rptChxref.asKnown().isPresent) 1 else 0) + (rtn.asKnown().getOrNull()?.size ?: 0) + (if (rtnCmd.asKnown().isPresent) 1 else 0) + (rtnMsgTs.asKnown().getOrNull()?.size ?: 0) + (if (rtnTrkState.asKnown().isPresent) 1 else 0) + (if (scanRate.asKnown().isPresent) 1 else 0) + (if (scanType.asKnown().isPresent) 1 else 0) + (if (scn.asKnown().isPresent) 1 else 0) + (if (sconum.asKnown().isPresent) 1 else 0) + (if (selfReport.asKnown().isPresent) 1 else 0) + (if (sen.asKnown().isPresent) 1 else 0) + (if (shipClass.asKnown().isPresent) 1 else 0) + (if (shortName.asKnown().isPresent) 1 else 0) + (if (sourceUid.asKnown().isPresent) 1 else 0) + (if (spaceAmp.asKnown().isPresent) 1 else 0) + (if (spaceAmpConf.asKnown().isPresent) 1 else 0) + (if (spaceSpecType.asKnown().isPresent) 1 else 0) + (if (spd.asKnown().isPresent) 1 else 0) + (if (staffCmts.asKnown().isPresent) 1 else 0) + (if (sternType.asKnown().isPresent) 1 else 0) + (if (taskForce.asKnown().isPresent) 1 else 0) + (if (tcpa.asKnown().isPresent) 1 else 0) + (if (tesEventId.asKnown().isPresent) 1 else 0) + (if (tol.asKnown().isPresent) 1 else 0) + (if (tpk.asKnown().isPresent) 1 else 0) + (if (trkConf.asKnown().isPresent) 1 else 0) + (if (trkId.asKnown().isPresent) 1 else 0) + (if (trkNum.asKnown().isPresent) 1 else 0) + (if (trkQual.asKnown().isPresent) 1 else 0) + (if (trkScope.asKnown().isPresent) 1 else 0) + (if (trnspdrId.asKnown().isPresent) 1 else 0) + (if (trnspdrType.asKnown().isPresent) 1 else 0) + (if (vslWt.asKnown().isPresent) 1 else 0) + (if (width.asKnown().isPresent) 1 else 0)
     ...
     * UNKNOWN: Environment is not known.
     */
    class Env @JsonCreator private constructor(
        private val value: JsonField<String>,
     ...
     * UNKNOWN: Track object which has been evaluated and does not meet criteria for any standard identity.
     */
    class ObjIdent @JsonCreator private constructor(
        private val value: JsonField<String>,
