...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailListResponse: TrackDetailListResponse) = apply {
            ...
            antennaRefDimensions =
                trackDetailListResponse.antennaRefDimensions.map { it.toMutableList() }
    ...
    fun validate(): TrackDetailListResponse = apply {
        if (validated) {
            return@apply
        }
