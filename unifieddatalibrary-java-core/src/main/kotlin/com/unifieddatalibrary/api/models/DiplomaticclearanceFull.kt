...
/**
 * A diplomatic clearance is an authorization for an aircraft to traverse or land within a specified
 * country.
 */
...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        diplomaticClearanceDetails: JsonField<List<DiplomaticClearanceDetail>> = JsonMissing.of(),
        @JsonProperty("diplomaticClearanceRemarks")
        @ExcludeMissing
        diplomaticClearanceRemarks: JsonField<List<DiplomaticClearanceRemark>> = JsonMissing.of(),
    ...
    /**
     * The First Departure Date (FDD) the mission is scheduled for departure, in ISO 8601 UTC format
    ...
    /**
     * Optional diplomatic clearance worksheet ID from external systems. This field has no meaning
     * within UDL and is provided as a convenience for systems that require tracking of an internal
     * system generated ID.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     *
     * Unlike [externalWorksheetId], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("externalWorksheetId")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiplomaticclearanceFull].
         *
    ...
    /** A builder for [DiplomaticclearanceFull]. */
    class Builder internal constructor() {
        ...
        private var diplomaticClearanceDetails: JsonField<MutableList<DiplomaticClearanceDetail>>? =
            null
        private var diplomaticClearanceRemarks: JsonField<MutableList<DiplomaticClearanceRemark>>? =
            null
        ...
        @JvmSynthetic
        internal fun from(diplomaticclearanceFull: DiplomaticclearanceFull) = apply {
            classificationMarking = diplomaticclearanceFull.classificationMarking
            dataMode = diplomaticclearanceFull.dataMode
            firstDepDate = diplomaticclearanceFull.firstDepDate
            idMission = diplomaticclearanceFull.idMission
            source = diplomaticclearanceFull.source
            id = diplomaticclearanceFull.id
            apacsId = diplomaticclearanceFull.apacsId
            createdAt = diplomaticclearanceFull.createdAt
            createdBy = diplomaticclearanceFull.createdBy
            diplomaticClearanceDetails =
                diplomaticclearanceFull.diplomaticClearanceDetails.map { it.toMutableList() }
            diplomaticClearanceRemarks =
                diplomaticclearanceFull.diplomaticClearanceRemarks.map { it.toMutableList() }
            dipWorksheetName = diplomaticclearanceFull.dipWorksheetName
            docDeadline = diplomaticclearanceFull.docDeadline
            externalWorksheetId = diplomaticclearanceFull.externalWorksheetId
            origin = diplomaticclearanceFull.origin
            origNetwork = diplomaticclearanceFull.origNetwork
            sourceDl = diplomaticclearanceFull.sourceDl
            updatedAt = diplomaticclearanceFull.updatedAt
            updatedBy = diplomaticclearanceFull.updatedBy
            additionalProperties = diplomaticclearanceFull.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.firstDepDate] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * `List<DiplomaticClearanceDetail>` value instead. This method is primarily for setting the
         ...
         * `List<DiplomaticClearanceRemark>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun diplomaticClearanceRemarks(
         ...
         *
         * You should usually call [Builder.docDeadline] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.externalWorksheetId] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Returns an immutable instance of [DiplomaticclearanceFull].
         *
         ...
         */
        fun build(): DiplomaticclearanceFull =
    ...
    fun validate(): DiplomaticclearanceFull = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        /**
         * Earliest time the aircraft may enter the country, in ISO 8601 UTC format with millisecond
         * precision.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Latest time the aircraft may exit the country, in ISO 8601 UTC format with millisecond
         * precision.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
        ...
        /**
         * Optional clearance ID from external systems. This field has no meaning within UDL and is
        ...
        /**
         * The 1801 fileable route of flight string associated with this diplomatic clearance. The
         * route of flight string contains route designators, significant points, change of
        ...
        /**
         * The end time of the validity of this diplomatic clearance, in ISO 8601 UTC format with
        ...
        /**
         * The start time of the validity of this diplomatic clearance, in ISO 8601 UTC format with
         * millisecond precision.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         *
         * Unlike [clearanceRemark], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("clearanceRemark")
        @ExcludeMissing
         ...
         *
         * Unlike [clearedCallSign], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("clearedCallSign")
        @ExcludeMissing
         ...
         */
        @JsonProperty("exitNLT") @ExcludeMissing fun _exitNlt(): JsonField<OffsetDateTime> = exitNlt
         ...
         */
        @JsonProperty("exitPoint") @ExcludeMissing fun _exitPoint(): JsonField<String> = exitPoint
         ...
         */
        @JsonProperty("validDesc") @ExcludeMissing fun _validDesc(): JsonField<String> = validDesc
         ...
         *
         * Unlike [validStartTime], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("validStartTime")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.clearanceRemark] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.clearedCallSign] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.entryNet] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun entryNet(entryNet: JsonField<OffsetDateTime>) = apply { this.entryNet = entryNet }
             ...
             *
             * You should usually call [Builder.exitNlt] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.exitPoint] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.reqPoint] with a well-typed [Boolean] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.sequenceNum] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun sequenceNum(sequenceNum: JsonField<Int>) = apply { this.sequenceNum = sequenceNum }
             ...
             *
             * You should usually call [Builder.validDesc] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.validStartTime] with a well-typed [OffsetDateTime]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
