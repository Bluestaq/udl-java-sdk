...
class MonoradarTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MonoradarTupleParams].
         *
    ...
    /** A builder for [MonoradarTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarTupleParams: MonoradarTupleParams) =
            apply {
                columns = monoradarTupleParams.columns
                ts = monoradarTupleParams.ts
                firstResult = monoradarTupleParams.firstResult
                maxResults = monoradarTupleParams.maxResults
                additionalHeaders = monoradarTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = monoradarTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MonoradarTupleParams].
         *
         ...
         */
        fun build(): MonoradarTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MonoradarTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "MonoradarTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
