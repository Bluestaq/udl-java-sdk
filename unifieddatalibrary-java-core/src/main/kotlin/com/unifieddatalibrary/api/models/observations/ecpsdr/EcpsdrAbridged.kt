...
class EcpsdrAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpsdrAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrAbridged: EcpsdrAbridged) =
            apply {
                classificationMarking = ecpsdrAbridged.classificationMarking
                dataMode = ecpsdrAbridged.dataMode
                msgTime = ecpsdrAbridged.msgTime
                source = ecpsdrAbridged.source
                type = ecpsdrAbridged.type
                id = ecpsdrAbridged.id
                asl5VCurrMon = ecpsdrAbridged.asl5VCurrMon
                cdsPlateVMon = ecpsdrAbridged.cdsPlateVMon
                cdsRefVMon = ecpsdrAbridged.cdsRefVMon
                cdsThreshold = ecpsdrAbridged.cdsThreshold
                cdsThrottle = ecpsdrAbridged.cdsThrottle
                checksum = ecpsdrAbridged.checksum
                createdAt = ecpsdrAbridged.createdAt
                createdBy = ecpsdrAbridged.createdBy
                dosBias = ecpsdrAbridged.dosBias
                dsl5VCurrMon = ecpsdrAbridged.dsl5VCurrMon
                esdTrigCountH = ecpsdrAbridged.esdTrigCountH
                esdTrigCountL = ecpsdrAbridged.esdTrigCountL
                hiLetL = ecpsdrAbridged.hiLetL
                hiLetM = ecpsdrAbridged.hiLetM
                idOnOrbit = ecpsdrAbridged.idOnOrbit
                idSensor = ecpsdrAbridged.idSensor
                lowLetL = ecpsdrAbridged.lowLetL
                lowLetM = ecpsdrAbridged.lowLetM
                medLet1L = ecpsdrAbridged.medLet1L
                medLet1M = ecpsdrAbridged.medLet1M
                medLet2L = ecpsdrAbridged.medLet2L
                medLet2M = ecpsdrAbridged.medLet2M
                medLet3L = ecpsdrAbridged.medLet3L
                medLet3M = ecpsdrAbridged.medLet3M
                medLet4L = ecpsdrAbridged.medLet4L
                medLet4M = ecpsdrAbridged.medLet4M
                mpTemp = ecpsdrAbridged.mpTemp
                obTime = ecpsdrAbridged.obTime
                origin = ecpsdrAbridged.origin
                origNetwork = ecpsdrAbridged.origNetwork
                origObjectId = ecpsdrAbridged.origObjectId
                origSensorId = ecpsdrAbridged.origSensorId
                pd1SigLev = ecpsdrAbridged.pd1SigLev
                pd2SigLev = ecpsdrAbridged.pd2SigLev
                psTempMon = ecpsdrAbridged.psTempMon
                retransmit = ecpsdrAbridged.retransmit
                satNo = ecpsdrAbridged.satNo
                senMode = ecpsdrAbridged.senMode
                surfDosChargeH = ecpsdrAbridged.surfDosChargeH
                surfDosChargeL = ecpsdrAbridged.surfDosChargeL
                surfDosH = ecpsdrAbridged.surfDosH
                surfDosL = ecpsdrAbridged.surfDosL
                surfDosM = ecpsdrAbridged.surfDosM
                surfDosStat = ecpsdrAbridged.surfDosStat
                transientData = ecpsdrAbridged.transientData.map { it.toMutableList() }
                vRef = ecpsdrAbridged.vRef
                additionalProperties = ecpsdrAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EcpsdrAbridged].
         *
