...
class OnorbitlistGetResponse private constructor(
    ...
    private val onorbits: JsonField<List<String>>,
    ...
    private constructor(
        ...
        @JsonProperty("onorbits") @ExcludeMissing onorbits: JsonField<List<String>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun onorbits(): Optional<List<String>> = onorbits.getOptional("onorbits")
    ...
    /**
     * Returns the raw JSON value of [onorbits].
     *
     * Unlike [onorbits], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("onorbits")
    @ExcludeMissing
    fun _onorbits(): JsonField<List<String>> = onorbits
    ...
    class Builder internal constructor() {
        ...
        private var onorbits: JsonField<MutableList<String>>? = null
        ...
        @JvmSynthetic
        internal fun from(onorbitlistGetResponse: OnorbitlistGetResponse) =
            apply {
                ...
                onorbits = onorbitlistGetResponse.onorbits.map { it.toMutableList() }
        ...
        /** Ordered array of Onorbit IDs belonging to this list. */
        fun onorbits(onorbits: List<String>) = onorbits(JsonField.of(onorbits))

        /**
         * Sets [Builder.onorbits] to an arbitrary JSON value.
         *
         * You should usually call [Builder.onorbits] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun onorbits(onorbits: JsonField<List<String>>) =
            apply {
                this.onorbits = onorbits.map { it.toMutableList() }
            }

        /**
         * Adds a single [String] to [onorbits].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addOnorbit(onorbit: String) =
            apply {
                onorbits = (onorbits ?: JsonField.of(mutableListOf())).also {
                    checkKnown("onorbits", it).add(onorbit)
                }
            }
        ...
        fun build(): OnorbitlistGetResponse =
            OnorbitlistGetResponse(
              ...
              createdBy,
              description,
              (onorbits ?: JsonMissing.of()).map { it.toImmutable() },
              origin,
              updatedAt,
              updatedBy,
    ...
    fun validate(): OnorbitlistGetResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (onorbits.asKnown().getOrNull()?.size ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitlistGetResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && name == other.name && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && description == other.description && onorbits == other.onorbits && origin == other.origin && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, name, source, id, createdAt, createdBy, description, onorbits, origin, updatedAt, updatedBy, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "OnorbitlistGetResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, description=$description, onorbits=$onorbits, origin=$origin, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
