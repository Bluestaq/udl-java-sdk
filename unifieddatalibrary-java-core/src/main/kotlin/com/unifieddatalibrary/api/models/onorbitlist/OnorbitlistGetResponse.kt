...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitlistGetResponse].
         *
    ...
    /** A builder for [OnorbitlistGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistGetResponse: OnorbitlistGetResponse) = apply {
            classificationMarking = onorbitlistGetResponse.classificationMarking
            dataMode = onorbitlistGetResponse.dataMode
            name = onorbitlistGetResponse.name
            onOrbitListItems = onorbitlistGetResponse.onOrbitListItems.map { it.toMutableList() }
            source = onorbitlistGetResponse.source
            id = onorbitlistGetResponse.id
            createdAt = onorbitlistGetResponse.createdAt
            createdBy = onorbitlistGetResponse.createdBy
            defaultRevisitRateMins = onorbitlistGetResponse.defaultRevisitRateMins
            description = onorbitlistGetResponse.description
            listPriority = onorbitlistGetResponse.listPriority
            namespace = onorbitlistGetResponse.namespace
            origin = onorbitlistGetResponse.origin
            sourceDl = onorbitlistGetResponse.sourceDl
            tags = onorbitlistGetResponse.tags.map { it.toMutableList() }
            transactionId = onorbitlistGetResponse.transactionId
            updatedAt = onorbitlistGetResponse.updatedAt
            updatedBy = onorbitlistGetResponse.updatedBy
            additionalProperties = onorbitlistGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitlistGetResponse].
         *
         ...
         */
        fun build(): OnorbitlistGetResponse =
    ...
    fun validate(): OnorbitlistGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitlistGetResponse &&
