...
class EffectResponseListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectResponseListParams].
         *
    ...
    /** A builder for [EffectResponseListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseListParams: EffectResponseListParams) =
            apply {
                createdAt = effectResponseListParams.createdAt
                firstResult = effectResponseListParams.firstResult
                maxResults = effectResponseListParams.maxResults
                additionalHeaders = effectResponseListParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectResponseListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectResponseListParams].
         *
         ...
         */
        fun build(): EffectResponseListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectResponseListParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EffectResponseListParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
