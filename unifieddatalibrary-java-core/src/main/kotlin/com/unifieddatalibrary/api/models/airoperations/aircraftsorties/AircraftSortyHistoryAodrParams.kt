...
class AircraftSortyHistoryAodrParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftSortyHistoryAodrParams].
         *
    ...
    /** A builder for [AircraftSortyHistoryAodrParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyHistoryAodrParams: AircraftSortyHistoryAodrParams) =
            apply {
                plannedDepTime = aircraftSortyHistoryAodrParams.plannedDepTime
                columns = aircraftSortyHistoryAodrParams.columns
                firstResult = aircraftSortyHistoryAodrParams.firstResult
                maxResults = aircraftSortyHistoryAodrParams.maxResults
                notification = aircraftSortyHistoryAodrParams.notification
                outputDelimiter = aircraftSortyHistoryAodrParams.outputDelimiter
                outputFormat = aircraftSortyHistoryAodrParams.outputFormat
                additionalHeaders = aircraftSortyHistoryAodrParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftSortyHistoryAodrParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortyHistoryAodrParams].
         *
         ...
         */
        fun build(): AircraftSortyHistoryAodrParams =
    ...
    override fun toString() = "AircraftSortyHistoryAodrParams{plannedDepTime=$plannedDepTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
