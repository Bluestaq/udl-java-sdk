...
class SeraDataEarlyWarningListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<SeraDataEarlyWarningListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        fun service(service: SeraDataEarlyWarningServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SeraDataEarlyWarningListPageAsync &&
    ...
    override fun toString() =
        "SeraDataEarlyWarningListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
