...
class EffectRequestTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestTupleResponse: EffectRequestTupleResponse) = apply {
    ...
    fun validate(): EffectRequestTupleResponse = apply {
        if (validated) {
            return@apply
        }
