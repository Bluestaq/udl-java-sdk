...
class EffectRequestTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectRequestTupleResponse].
         *
    ...
    /** A builder for [EffectRequestTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestTupleResponse: EffectRequestTupleResponse) =
            apply {
                classificationMarking = effectRequestTupleResponse.classificationMarking
                dataMode = effectRequestTupleResponse.dataMode
                effectList = effectRequestTupleResponse.effectList.map { it.toMutableList() }
                source = effectRequestTupleResponse.source
                id = effectRequestTupleResponse.id
                context = effectRequestTupleResponse.context
                createdAt = effectRequestTupleResponse.createdAt
                createdBy = effectRequestTupleResponse.createdBy
                deadlineType = effectRequestTupleResponse.deadlineType
                endTime = effectRequestTupleResponse.endTime
                externalRequestId = effectRequestTupleResponse.externalRequestId
                metricTypes = effectRequestTupleResponse.metricTypes.map { it.toMutableList() }
                metricWeights = effectRequestTupleResponse.metricWeights.map { it.toMutableList() }
                modelClass = effectRequestTupleResponse.modelClass
                origin = effectRequestTupleResponse.origin
                origNetwork = effectRequestTupleResponse.origNetwork
                priority = effectRequestTupleResponse.priority
                startTime = effectRequestTupleResponse.startTime
                state = effectRequestTupleResponse.state
                targetSrcId = effectRequestTupleResponse.targetSrcId
                targetSrcType = effectRequestTupleResponse.targetSrcType
                additionalProperties = effectRequestTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestTupleResponse].
         *
         ...
         */
        fun build(): EffectRequestTupleResponse =
    ...
    fun validate(): EffectRequestTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
