...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitListParams: OnorbitListParams) = apply {
    ...
    override fun toString() =
        "OnorbitListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
