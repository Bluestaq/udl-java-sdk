 ...
 * date, and remarks.
 */
class DropzoneRetrieveResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneRetrieveResponse: DropzoneRetrieveResponse) = apply {
    ...
    fun validate(): DropzoneRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
