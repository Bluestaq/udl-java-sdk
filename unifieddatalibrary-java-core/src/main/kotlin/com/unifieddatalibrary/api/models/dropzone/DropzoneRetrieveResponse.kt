...
class DropzoneRetrieveResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("altCountryName") @ExcludeMissing altCountryName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("approvalDate") @ExcludeMissing approvalDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("extIdentifier") @ExcludeMissing extIdentifier: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idSite") @ExcludeMissing idSite: JsonField<String> = JsonMissing.of(),
        @JsonProperty("lastUpdate") @ExcludeMissing lastUpdate: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("nearestLoc") @ExcludeMissing nearestLoc: JsonField<String> = JsonMissing.of(),
        @JsonProperty("operationalApprovalDate") @ExcludeMissing operationalApprovalDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("recertDate") @ExcludeMissing recertDate: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DropzoneRetrieveResponse].
         *
    ...
    /** A builder for [DropzoneRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneRetrieveResponse: DropzoneRetrieveResponse) =
            apply {
                classificationMarking = dropzoneRetrieveResponse.classificationMarking
                dataMode = dropzoneRetrieveResponse.dataMode
                lat = dropzoneRetrieveResponse.lat
                lon = dropzoneRetrieveResponse.lon
                name = dropzoneRetrieveResponse.name
                source = dropzoneRetrieveResponse.source
                id = dropzoneRetrieveResponse.id
                altCountryCode = dropzoneRetrieveResponse.altCountryCode
                altCountryName = dropzoneRetrieveResponse.altCountryName
                approvalDate = dropzoneRetrieveResponse.approvalDate
                code = dropzoneRetrieveResponse.code
                countryCode = dropzoneRetrieveResponse.countryCode
                countryName = dropzoneRetrieveResponse.countryName
                createdAt = dropzoneRetrieveResponse.createdAt
                createdBy = dropzoneRetrieveResponse.createdBy
                expirationDate = dropzoneRetrieveResponse.expirationDate
                extIdentifier = dropzoneRetrieveResponse.extIdentifier
                idSite = dropzoneRetrieveResponse.idSite
                lastUpdate = dropzoneRetrieveResponse.lastUpdate
                length = dropzoneRetrieveResponse.length
                majcom = dropzoneRetrieveResponse.majcom
                nearestLoc = dropzoneRetrieveResponse.nearestLoc
                operationalApprovalDate = dropzoneRetrieveResponse.operationalApprovalDate
                origin = dropzoneRetrieveResponse.origin
                origNetwork = dropzoneRetrieveResponse.origNetwork
                pointName = dropzoneRetrieveResponse.pointName
                radius = dropzoneRetrieveResponse.radius
                recertDate = dropzoneRetrieveResponse.recertDate
                remark = dropzoneRetrieveResponse.remark
                sourceDl = dropzoneRetrieveResponse.sourceDl
                stateAbbr = dropzoneRetrieveResponse.stateAbbr
                stateName = dropzoneRetrieveResponse.stateName
                surveyDate = dropzoneRetrieveResponse.surveyDate
                updatedAt = dropzoneRetrieveResponse.updatedAt
                updatedBy = dropzoneRetrieveResponse.updatedBy
                width = dropzoneRetrieveResponse.width
                zarId = dropzoneRetrieveResponse.zarId
                additionalProperties = dropzoneRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DropzoneRetrieveResponse].
         *
         ...
         */
        fun build(): DropzoneRetrieveResponse =
    ...
    fun validate(): DropzoneRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
