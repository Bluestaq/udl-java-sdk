...
class SensorObservationTypeGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorObservationTypeGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorObservationTypeGetParams: SensorObservationTypeGetParams) = apply {
    ...
    override fun toString() =
        "SensorObservationTypeGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
