...
class RfEmitterDetailUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailUpdateParams: RfEmitterDetailUpdateParams) =
            apply {
        ...
        /** Unique identifier of the parent RF Emitter. */
        fun idRfEmitter(idRfEmitter: String) =
            apply {
                body.idRfEmitter(idRfEmitter)
            }
        ...
        /** Optional alternate name or alias for this RF Emitter. */
        fun altName(altName: String) =
            apply {
                body.altName(altName)
            }
        ...
        /** Array with 1-2 values specifying the length and width (for rectangular) and just length for dipole antennas in meters. */
        fun antennaSize(antennaSize: List<Double>) =
            apply {
        ...
        fun addAntennaSize(antennaSize: Double) =
            apply {
                body.addAntennaSize(antennaSize)
            }
        ...
        /** Designator of this RF Emitter. */
        fun designator(designator: String) =
            apply {
                body.designator(designator)
            }
        ...
        /** Doppler noise value in Mhz. */
        fun dopplerNoise(dopplerNoise: Double) =
            apply {
        ...
        /** Number of bits. */
        fun numBits(numBits: Int) =
            apply {
                body.numBits(numBits)
            }
        ...
        /** Number of channels. */
        fun numChannels(numChannels: Int) =
            apply {
                body.numChannels(numChannels)
            }
        ...
        /** Type or name of receiver. */
        fun receiverType(receiverType: String) =
            apply {
        ...
        /** Transmit power in Watts. */
        fun transmitPower(transmitPower: Double) =
            apply {
    ...
    override fun toString() = "RfEmitterDetailUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
