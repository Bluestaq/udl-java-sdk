...
/**
 * Service operation to update a single OnorbitSolarArray. An OnorbitSolarArray is the association
 * between on-orbit spacecraft SolarArrays and a particular on-orbit spacecraft. A SolarArray type
 * may be associated with many different on-orbit spacecraft. A specific role is required to perform
 * this service operation. Please contact the UDL team for assistance.
 */
class OnorbitsolararrayUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitsolararrayUpdateParams: OnorbitsolararrayUpdateParams) = apply {
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idOnOrbit=$idOnOrbit, idSolarArray=$idSolarArray, source=$source, bodyId=$bodyId, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, solarArray=$solarArray, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "OnorbitsolararrayUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
