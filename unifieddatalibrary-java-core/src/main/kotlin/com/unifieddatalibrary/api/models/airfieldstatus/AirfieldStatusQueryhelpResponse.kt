...
class AirfieldStatusQueryhelpResponse
private constructor(
    ...
    /** A builder for [AirfieldStatusQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldStatusQueryhelpResponse: AirfieldStatusQueryhelpResponse) =
            apply {
                aodrSupported = airfieldStatusQueryhelpResponse.aodrSupported
                classificationMarking = airfieldStatusQueryhelpResponse.classificationMarking
                description = airfieldStatusQueryhelpResponse.description
                historySupported = airfieldStatusQueryhelpResponse.historySupported
                name = airfieldStatusQueryhelpResponse.name
                parameters = airfieldStatusQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    airfieldStatusQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = airfieldStatusQueryhelpResponse.restSupported
                sortSupported = airfieldStatusQueryhelpResponse.sortSupported
                typeName = airfieldStatusQueryhelpResponse.typeName
                uri = airfieldStatusQueryhelpResponse.uri
                additionalProperties =
                    airfieldStatusQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldStatusQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldStatusQueryhelpResponse =
            AirfieldStatusQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): AirfieldStatusQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirfieldStatusQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
