...
class SurfaceObstructionGetResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionGetResponse: SurfaceObstructionGetResponse) = apply {
            ...
            advisoryRequired =
                surfaceObstructionGetResponse.advisoryRequired.map { it.toMutableList() }
            approvalRequired =
                surfaceObstructionGetResponse.approvalRequired.map { it.toMutableList() }
    ...
    fun validate(): SurfaceObstructionGetResponse = apply {
        if (validated) {
            return@apply
        }
