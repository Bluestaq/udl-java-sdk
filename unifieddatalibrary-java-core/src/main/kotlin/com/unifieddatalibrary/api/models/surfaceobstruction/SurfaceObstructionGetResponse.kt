...
class SurfaceObstructionGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceObstructionGetResponse].
         *
    ...
    /** A builder for [SurfaceObstructionGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionGetResponse: SurfaceObstructionGetResponse) =
            apply {
                classificationMarking = surfaceObstructionGetResponse.classificationMarking
                dataMode = surfaceObstructionGetResponse.dataMode
                idSurface = surfaceObstructionGetResponse.idSurface
                source = surfaceObstructionGetResponse.source
                id = surfaceObstructionGetResponse.id
                advisoryRequired = surfaceObstructionGetResponse.advisoryRequired.map { it.toMutableList() }
                approvalRequired = surfaceObstructionGetResponse.approvalRequired.map { it.toMutableList() }
                createdAt = surfaceObstructionGetResponse.createdAt
                createdBy = surfaceObstructionGetResponse.createdBy
                distanceFromCenterLine = surfaceObstructionGetResponse.distanceFromCenterLine
                distanceFromEdge = surfaceObstructionGetResponse.distanceFromEdge
                distanceFromThreshold = surfaceObstructionGetResponse.distanceFromThreshold
                idNavigationalObstruction = surfaceObstructionGetResponse.idNavigationalObstruction
                obstructionDesc = surfaceObstructionGetResponse.obstructionDesc
                obstructionHeight = surfaceObstructionGetResponse.obstructionHeight
                obstructionSideCode = surfaceObstructionGetResponse.obstructionSideCode
                origin = surfaceObstructionGetResponse.origin
                origNetwork = surfaceObstructionGetResponse.origNetwork
                sourceDl = surfaceObstructionGetResponse.sourceDl
                updatedAt = surfaceObstructionGetResponse.updatedAt
                updatedBy = surfaceObstructionGetResponse.updatedBy
                additionalProperties = surfaceObstructionGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceObstructionGetResponse].
         *
         ...
         */
        fun build(): SurfaceObstructionGetResponse =
    ...
    fun validate(): SurfaceObstructionGetResponse =
        apply {
            if (validated) {
              return@apply
            }
