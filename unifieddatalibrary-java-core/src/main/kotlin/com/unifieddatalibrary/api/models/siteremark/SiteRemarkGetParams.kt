...
class SiteRemarkGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SiteRemarkGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SiteRemarkGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SiteRemarkGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkGetParams: SiteRemarkGetParams) =
            apply {
                id = siteRemarkGetParams.id
                firstResult = siteRemarkGetParams.firstResult
                maxResults = siteRemarkGetParams.maxResults
                additionalHeaders = siteRemarkGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = siteRemarkGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SiteRemarkGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SiteRemarkGetParams =
            SiteRemarkGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteRemarkGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SiteRemarkGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
