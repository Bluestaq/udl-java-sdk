...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteRemarkGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkGetParams: SiteRemarkGetParams) = apply {
    ...
    override fun toString() =
        "SiteRemarkGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
