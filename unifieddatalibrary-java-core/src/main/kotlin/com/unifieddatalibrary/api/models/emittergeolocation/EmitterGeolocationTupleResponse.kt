...
class EmitterGeolocationTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("signalOfInterestType") @ExcludeMissing signalOfInterestType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("algVersion") @ExcludeMissing algVersion: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("centerFreq") @ExcludeMissing centerFreq: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("createdTs") @ExcludeMissing createdTs: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("errEllp") @ExcludeMissing errEllp: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("origRFEmitterId") @ExcludeMissing origRfEmitterId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("origSensorId") @ExcludeMissing origSensorId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("passGroupId") @ExcludeMissing passGroupId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("receivedTs") @ExcludeMissing receivedTs: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("satNo") @ExcludeMissing satNo: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("signalOfInterest") @ExcludeMissing signalOfInterest: JsonField<String> = JsonMissing.of(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmitterGeolocationTupleResponse].
         *
    ...
    /** A builder for [EmitterGeolocationTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationTupleResponse: EmitterGeolocationTupleResponse) =
            apply {
                classificationMarking = emitterGeolocationTupleResponse.classificationMarking
                dataMode = emitterGeolocationTupleResponse.dataMode
                signalOfInterestType = emitterGeolocationTupleResponse.signalOfInterestType
                source = emitterGeolocationTupleResponse.source
                startTime = emitterGeolocationTupleResponse.startTime
                id = emitterGeolocationTupleResponse.id
                agjson = emitterGeolocationTupleResponse.agjson
                algVersion = emitterGeolocationTupleResponse.algVersion
                andims = emitterGeolocationTupleResponse.andims
                area = emitterGeolocationTupleResponse.area
                asrid = emitterGeolocationTupleResponse.asrid
                atext = emitterGeolocationTupleResponse.atext
                atype = emitterGeolocationTupleResponse.atype
                centerFreq = emitterGeolocationTupleResponse.centerFreq
                cluster = emitterGeolocationTupleResponse.cluster
                confArea = emitterGeolocationTupleResponse.confArea
                constellation = emitterGeolocationTupleResponse.constellation
                createdAt = emitterGeolocationTupleResponse.createdAt
                createdBy = emitterGeolocationTupleResponse.createdBy
                createdTs = emitterGeolocationTupleResponse.createdTs
                detectAlt = emitterGeolocationTupleResponse.detectAlt
                detectLat = emitterGeolocationTupleResponse.detectLat
                detectLon = emitterGeolocationTupleResponse.detectLon
                endTime = emitterGeolocationTupleResponse.endTime
                errEllp = emitterGeolocationTupleResponse.errEllp.map { it.toMutableList() }
                externalId = emitterGeolocationTupleResponse.externalId
                idOnOrbit = emitterGeolocationTupleResponse.idOnOrbit
                idRfEmitter = emitterGeolocationTupleResponse.idRfEmitter
                idSensor = emitterGeolocationTupleResponse.idSensor
                maxFreq = emitterGeolocationTupleResponse.maxFreq
                minFreq = emitterGeolocationTupleResponse.minFreq
                numBursts = emitterGeolocationTupleResponse.numBursts
                onOrbit = emitterGeolocationTupleResponse.onOrbit
                orderId = emitterGeolocationTupleResponse.orderId
                origin = emitterGeolocationTupleResponse.origin
                origNetwork = emitterGeolocationTupleResponse.origNetwork
                origObjectId = emitterGeolocationTupleResponse.origObjectId
                origRfEmitterId = emitterGeolocationTupleResponse.origRfEmitterId
                origSensorId = emitterGeolocationTupleResponse.origSensorId
                passGroupId = emitterGeolocationTupleResponse.passGroupId
                receivedTs = emitterGeolocationTupleResponse.receivedTs
                satNo = emitterGeolocationTupleResponse.satNo
                signalOfInterest = emitterGeolocationTupleResponse.signalOfInterest
                sourceDl = emitterGeolocationTupleResponse.sourceDl
                tags = emitterGeolocationTupleResponse.tags.map { it.toMutableList() }
                additionalProperties = emitterGeolocationTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationTupleResponse].
         *
         ...
         */
        fun build(): EmitterGeolocationTupleResponse =
    ...
    fun validate(): EmitterGeolocationTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
