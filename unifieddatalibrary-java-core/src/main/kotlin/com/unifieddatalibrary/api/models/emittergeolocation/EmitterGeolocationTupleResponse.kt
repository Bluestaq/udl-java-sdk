...
class EmitterGeolocationTupleResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emitterGeolocationTupleResponse: EmitterGeolocationTupleResponse) =
            apply {
                ...
                avgPrf = emitterGeolocationTupleResponse.avgPrf
                avgPri = emitterGeolocationTupleResponse.avgPri
                avgPw = emitterGeolocationTupleResponse.avgPw
                ...
                maxPrf = emitterGeolocationTupleResponse.maxPrf
                maxPri = emitterGeolocationTupleResponse.maxPri
                maxPw = emitterGeolocationTupleResponse.maxPw
                minFreq = emitterGeolocationTupleResponse.minFreq
                minPrf = emitterGeolocationTupleResponse.minPrf
                minPri = emitterGeolocationTupleResponse.minPri
                minPw = emitterGeolocationTupleResponse.minPw
                ...
                pulseShape = emitterGeolocationTupleResponse.pulseShape
                ...
                additionalProperties =
                    emitterGeolocationTupleResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): EmitterGeolocationTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmitterGeolocationTupleResponse &&
