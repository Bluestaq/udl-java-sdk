...
class OnorbitsolararrayListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitsolararrayListPage: OnorbitsolararrayListPage) =
            apply {
        ...
        fun service(service: OnorbitsolararrayService) =
            apply {
    ...
    override fun toString() = "OnorbitsolararrayListPage{service=$service, params=$params, items=$items}"
}
