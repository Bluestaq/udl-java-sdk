...
/**
 * Service operation to take multiple EffectResponses as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class EffectResponseUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            effectResponseUnvalidatedPublishParams: EffectResponseUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                effectResponseUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun toString() =
        "EffectResponseUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
