...
class EffectResponseUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectResponseUnvalidatedPublishParams].
         *
    ...
    /** A builder for [EffectResponseUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseUnvalidatedPublishParams: EffectResponseUnvalidatedPublishParams) =
            apply {
                body = effectResponseUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = effectResponseUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectResponseUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectResponseUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): EffectResponseUnvalidatedPublishParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("actionsList") @ExcludeMissing private val actionsList: JsonField<List<ActionsList>>,
        ...
        @JsonProperty("coaMetrics") @ExcludeMissing private val coaMetrics: JsonField<List<CoaMetric>>,
        @JsonProperty("collateralDamageEst") @ExcludeMissing private val collateralDamageEst: JsonField<Double>,
        @JsonProperty("createdAt") @ExcludeMissing private val createdAt: JsonField<OffsetDateTime>,
        @JsonProperty("createdBy") @ExcludeMissing private val createdBy: JsonField<String>,
        @JsonProperty("decisionDeadline") @ExcludeMissing private val decisionDeadline: JsonField<OffsetDateTime>,
        @JsonProperty("externalActions") @ExcludeMissing private val externalActions: JsonField<List<String>>,
        @JsonProperty("externalRequestId") @ExcludeMissing private val externalRequestId: JsonField<String>,
        @JsonProperty("idEffectRequest") @ExcludeMissing private val idEffectRequest: JsonField<String>,
        ...
        @JsonProperty("probabilityOfKill") @ExcludeMissing private val probabilityOfKill: JsonField<Double>,
        @JsonProperty("redTargetSrcId") @ExcludeMissing private val redTargetSrcId: JsonField<String>,
        @JsonProperty("redTargetSrcType") @ExcludeMissing private val redTargetSrcType: JsonField<String>,
        @JsonProperty("redTimeToOverhead") @ExcludeMissing private val redTimeToOverhead: JsonField<OffsetDateTime>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectResponseUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "EffectResponseUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
