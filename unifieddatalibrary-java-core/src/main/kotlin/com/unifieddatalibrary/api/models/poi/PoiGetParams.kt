...
class PoiGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): PoiGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PoiGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [PoiGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiGetParams: PoiGetParams) =
            apply {
                id = poiGetParams.id
                firstResult = poiGetParams.firstResult
                maxResults = poiGetParams.maxResults
                additionalHeaders = poiGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = poiGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PoiGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PoiGetParams =
            PoiGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PoiGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "PoiGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
