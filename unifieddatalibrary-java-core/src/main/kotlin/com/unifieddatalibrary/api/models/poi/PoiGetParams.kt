...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PoiGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiGetParams: PoiGetParams) = apply {
            id = poiGetParams.id
    ...
    override fun toString() =
        "PoiGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
