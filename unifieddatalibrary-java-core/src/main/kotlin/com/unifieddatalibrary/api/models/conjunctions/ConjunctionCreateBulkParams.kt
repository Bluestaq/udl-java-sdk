...
/**
 * Service operation intended for initial integration only, to take a list of Conjunctions as a POST
 * body and ingest into the database. A Conjunction is analysis of probability of collision; the
 * data can include state vectors for primary and secondary satellites. This operation is not
 * intended to be used for automated feeds into UDL. Data providers should contact the UDL team for
 * specific role assignments and for instructions on setting up a permanent feed through an
 * alternate mechanism.
 */
class ConjunctionCreateBulkParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConjunctionCreateBulkParams].
         *
    ...
    /** A builder for [ConjunctionCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conjunctionCreateBulkParams: ConjunctionCreateBulkParams) = apply {
            body = conjunctionCreateBulkParams.body.toMutableList()
            additionalHeaders = conjunctionCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = conjunctionCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ConjunctionCreateBulkParams].
         *
         ...
         */
        fun build(): ConjunctionCreateBulkParams =
