...
class OnorbitDetailsFull private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitDetailsFull: OnorbitDetailsFull) =
            apply {
    ...
    fun validate(): OnorbitDetailsFull =
        apply {
            if (validated) {
              return@apply
            }
