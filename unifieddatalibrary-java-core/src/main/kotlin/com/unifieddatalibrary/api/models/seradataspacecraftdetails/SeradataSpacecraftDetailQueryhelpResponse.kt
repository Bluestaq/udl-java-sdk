...
class SeradataSpacecraftDetailQueryhelpResponse
private constructor(
    ...
    /** A builder for [SeradataSpacecraftDetailQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataSpacecraftDetailQueryhelpResponse: SeradataSpacecraftDetailQueryhelpResponse
        ) = apply {
            aodrSupported = seradataSpacecraftDetailQueryhelpResponse.aodrSupported
            classificationMarking = seradataSpacecraftDetailQueryhelpResponse.classificationMarking
            description = seradataSpacecraftDetailQueryhelpResponse.description
            historySupported = seradataSpacecraftDetailQueryhelpResponse.historySupported
            name = seradataSpacecraftDetailQueryhelpResponse.name
            parameters =
                seradataSpacecraftDetailQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                seradataSpacecraftDetailQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = seradataSpacecraftDetailQueryhelpResponse.restSupported
            sortSupported = seradataSpacecraftDetailQueryhelpResponse.sortSupported
            typeName = seradataSpacecraftDetailQueryhelpResponse.typeName
            uri = seradataSpacecraftDetailQueryhelpResponse.uri
            additionalProperties =
                seradataSpacecraftDetailQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SeradataSpacecraftDetailQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataSpacecraftDetailQueryhelpResponse =
            SeradataSpacecraftDetailQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): SeradataSpacecraftDetailQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
