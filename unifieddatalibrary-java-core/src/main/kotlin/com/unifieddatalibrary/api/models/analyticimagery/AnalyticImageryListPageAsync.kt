...
class AnalyticImageryListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<AnalyticImageryListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryListPageAsync: AnalyticImageryListPageAsync) = apply {
        ...
        fun service(service: AnalyticImageryServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AnalyticImageryListPageAsync &&
    ...
    override fun toString() =
        "AnalyticImageryListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
