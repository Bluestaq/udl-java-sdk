...
/**
 * Service operation to get a single LaserEmitterStaging record by its unique ID passed as a path
 * parameter.
 */
class StagingRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StagingRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StagingRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [StagingRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stagingRetrieveParams: StagingRetrieveParams) = apply {
            id = stagingRetrieveParams.id
            firstResult = stagingRetrieveParams.firstResult
            maxResults = stagingRetrieveParams.maxResults
            additionalHeaders = stagingRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = stagingRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [StagingRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StagingRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StagingRetrieveParams &&
            id == other.id &&
    ...
    override fun toString() =
        "StagingRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
