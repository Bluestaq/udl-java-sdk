...
/**
 * Service operation to take a single EffectResponse as a POST body and ingest into the database.
 ...
 */
class EffectResponseCreateParams
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun actionsList(): Optional<List<ActionsList>> = body.actionsList()
     ...
     *   if the server responded with an unexpected value).
     */
    fun actorSrcId(): Optional<String> = body.actorSrcId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun actorSrcType(): Optional<String> = body.actorSrcType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun coaMetrics(): Optional<List<CoaMetric>> = body.coaMetrics()
     ...
     *   if the server responded with an unexpected value).
     */
    fun collateralDamageEst(): Optional<Double> = body.collateralDamageEst()
     ...
     *   if the server responded with an unexpected value).
     */
    fun decisionDeadline(): Optional<OffsetDateTime> = body.decisionDeadline()
     ...
     *   if the server responded with an unexpected value).
     */
    fun externalActions(): Optional<List<String>> = body.externalActions()
     ...
     *   if the server responded with an unexpected value).
     */
    fun externalRequestId(): Optional<String> = body.externalRequestId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun idEffectRequest(): Optional<String> = body.idEffectRequest()
     ...
     *   if the server responded with an unexpected value).
     */
    fun munitionId(): Optional<String> = body.munitionId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun munitionType(): Optional<String> = body.munitionType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun probabilityOfKill(): Optional<Double> = body.probabilityOfKill()
     ...
     *   if the server responded with an unexpected value).
     */
    fun redTargetSrcId(): Optional<String> = body.redTargetSrcId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun redTargetSrcType(): Optional<String> = body.redTargetSrcType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun redTimeToOverhead(): Optional<OffsetDateTime> = body.redTimeToOverhead()
     ...
     *   if the server responded with an unexpected value).
     */
    fun shotsRequired(): Optional<Int> = body.shotsRequired()
     ...
     */
    fun _actionsList(): JsonField<List<ActionsList>> = body._actionsList()
     ...
     */
    fun _actorSrcId(): JsonField<String> = body._actorSrcId()
     ...
     */
    fun _actorSrcType(): JsonField<String> = body._actorSrcType()
     ...
     */
    fun _coaMetrics(): JsonField<List<CoaMetric>> = body._coaMetrics()
     ...
     * type.
     */
    fun _collateralDamageEst(): JsonField<Double> = body._collateralDamageEst()
     ...
     * type.
     */
    fun _decisionDeadline(): JsonField<OffsetDateTime> = body._decisionDeadline()
     ...
     */
    fun _externalActions(): JsonField<List<String>> = body._externalActions()
     ...
     * type.
     */
    fun _externalRequestId(): JsonField<String> = body._externalRequestId()
     ...
     */
    fun _idEffectRequest(): JsonField<String> = body._idEffectRequest()
     ...
     */
    fun _munitionId(): JsonField<String> = body._munitionId()
     ...
     */
    fun _munitionType(): JsonField<String> = body._munitionType()
     ...
     * type.
     */
    fun _probabilityOfKill(): JsonField<Double> = body._probabilityOfKill()
     ...
     */
    fun _redTargetSrcId(): JsonField<String> = body._redTargetSrcId()
     ...
     * type.
     */
    fun _redTargetSrcType(): JsonField<String> = body._redTargetSrcType()
     ...
     * type.
     */
    fun _redTimeToOverhead(): JsonField<OffsetDateTime> = body._redTimeToOverhead()
     ...
     */
    fun _shotsRequired(): JsonField<Int> = body._shotsRequired()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectResponseCreateParams].
         *
    ...
    /** A builder for [EffectResponseCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseCreateParams: EffectResponseCreateParams) = apply {
            body = effectResponseCreateParams.body.toBuilder()
            additionalHeaders = effectResponseCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = effectResponseCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** List of actions associated with this effect response. */
        fun actionsList(actionsList: List<ActionsList>) = apply { body.actionsList(actionsList) }
         ...
         */
        fun addActionsList(actionsList: ActionsList) = apply { body.addActionsList(actionsList) }

        /**
         * The record ID, depending on the type identified in actorSrcType, of the requested asset.
         */
        fun actorSrcId(actorSrcId: String) = apply { body.actorSrcId(actorSrcId) }
         ...
         * value.
         */
        fun actorSrcId(actorSrcId: JsonField<String>) = apply { body.actorSrcId(actorSrcId) }

        /** The source type of the asset/actor identifier (AIRCRAFT, LANDCRAFT, SEACRAFT, TRACK). */
        fun actorSrcType(actorSrcType: String) = apply { body.actorSrcType(actorSrcType) }
        ...
        fun actorSrcType(actorSrcType: JsonField<String>) = apply {
            body.actorSrcType(actorSrcType)
        }

        /** List of COA metrics associated with this effect response. */
        fun coaMetrics(coaMetrics: List<CoaMetric>) = apply { body.coaMetrics(coaMetrics) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCoaMetric(coaMetric: CoaMetric) = apply { body.addCoaMetric(coaMetric) }

        /** The collateral damage estimate (CDE) of the munition being fired. */
        fun collateralDamageEst(collateralDamageEst: Double) = apply {
            body.collateralDamageEst(collateralDamageEst)
        }
         ...
         * The deadline time to accept this COA before it's no longer valid, in ISO8601 UTC format.
         */
        fun decisionDeadline(decisionDeadline: OffsetDateTime) = apply {
            body.decisionDeadline(decisionDeadline)
        }
        ...
        /** List of external actions to be executed as part of this task. */
        fun externalActions(externalActions: List<String>) = apply {
            body.externalActions(externalActions)
        }
        ...
        fun addExternalAction(externalAction: String) = apply {
            body.addExternalAction(externalAction)
        }
         ...
         * id.
         */
        fun externalRequestId(externalRequestId: String) = apply {
            body.externalRequestId(externalRequestId)
        }
        ...
        /** Unique identifier of the EffectRequest associated with this response. */
        fun idEffectRequest(idEffectRequest: String) = apply {
            body.idEffectRequest(idEffectRequest)
        }
        ...
        /** Unique identifier of the munition. */
        fun munitionId(munitionId: String) = apply { body.munitionId(munitionId) }
         ...
         * value.
         */
        fun munitionId(munitionId: JsonField<String>) = apply { body.munitionId(munitionId) }

        /** The type of munition being fired. */
        fun munitionType(munitionType: String) = apply { body.munitionType(munitionType) }
        ...
        fun munitionType(munitionType: JsonField<String>) = apply {
            body.munitionType(munitionType)
        }
        ...
        /** The probability of kill (0-1) of the target being destroyed. */
        fun probabilityOfKill(probabilityOfKill: Double) = apply {
            body.probabilityOfKill(probabilityOfKill)
        }
         ...
         */
        fun redTargetSrcId(redTargetSrcId: String) = apply { body.redTargetSrcId(redTargetSrcId) }
        ...
        fun redTargetSrcId(redTargetSrcId: JsonField<String>) = apply {
            body.redTargetSrcId(redTargetSrcId)
        }

        /** The source type of the targetId identifier (POI, SITE, TRACK). */
        fun redTargetSrcType(redTargetSrcType: String) = apply {
            body.redTargetSrcType(redTargetSrcType)
        }
         ...
         * The time to overhead for the red force to be over their target, in ISO8601 UTC format.
         */
        fun redTimeToOverhead(redTimeToOverhead: OffsetDateTime) = apply {
            body.redTimeToOverhead(redTimeToOverhead)
        }
        ...
        /** The number of shots required to destroy target. */
        fun shotsRequired(shotsRequired: Int) = apply { body.shotsRequired(shotsRequired) }
        ...
        fun shotsRequired(shotsRequired: JsonField<Int>) = apply {
            body.shotsRequired(shotsRequired)
        }
        ...
        /**
         * Returns an immutable instance of [EffectResponseCreateParams].
         *
         ...
         */
        fun build(): EffectResponseCreateParams =
