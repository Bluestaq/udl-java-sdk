...
class EffectResponseCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseCreateParams: EffectResponseCreateParams) =
            apply {
        ...
        /** List of actions associated with this effect response. */
        fun actionsList(actionsList: List<ActionsList>) =
            apply {
        ...
        fun addActionsList(actionsList: ActionsList) =
            apply {
                body.addActionsList(actionsList)
            }

        /** The record ID, depending on the type identified in actorSrcType, of the requested asset. */
        fun actorSrcId(actorSrcId: String) =
            apply {
                body.actorSrcId(actorSrcId)
            }
        ...
        /** The source type of the asset/actor identifier (AIRCRAFT, LANDCRAFT, SEACRAFT, TRACK). */
        fun actorSrcType(actorSrcType: String) =
            apply {
        ...
        /** List of COA metrics associated with this effect response. */
        fun coaMetrics(coaMetrics: List<CoaMetric>) =
            apply {
        ...
        /** Unique identifier of the munition. */
        fun munitionId(munitionId: String) =
            apply {
                body.munitionId(munitionId)
            }
        ...
        /** The type of munition being fired. */
        fun munitionType(munitionType: String) =
            apply {
        ...
        /** The number of shots required to destroy target. */
        fun shotsRequired(shotsRequired: Int) =
            apply {
    ...
    override fun toString() = "EffectResponseCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
