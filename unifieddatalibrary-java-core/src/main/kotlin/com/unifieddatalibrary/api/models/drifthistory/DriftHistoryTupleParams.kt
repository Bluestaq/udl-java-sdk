...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DriftHistoryTupleParams].
         *
    ...
    /** A builder for [DriftHistoryTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(driftHistoryTupleParams: DriftHistoryTupleParams) = apply {
            columns = driftHistoryTupleParams.columns
            firstResult = driftHistoryTupleParams.firstResult
            maxResults = driftHistoryTupleParams.maxResults
            additionalHeaders = driftHistoryTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = driftHistoryTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DriftHistoryTupleParams].
         *
         ...
         */
        fun build(): DriftHistoryTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DriftHistoryTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "DriftHistoryTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
