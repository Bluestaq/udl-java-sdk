 ...
 * pass.
 */
class PassiveRadarObservationGetResponse
...
private constructor(
    ...
    /** A builder for [PassiveRadarObservationGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(passiveRadarObservationGetResponse: PassiveRadarObservationGetResponse) =
            apply {
                classificationMarking = passiveRadarObservationGetResponse.classificationMarking
                dataMode = passiveRadarObservationGetResponse.dataMode
                obTime = passiveRadarObservationGetResponse.obTime
                source = passiveRadarObservationGetResponse.source
                id = passiveRadarObservationGetResponse.id
                accel = passiveRadarObservationGetResponse.accel
                accelUnc = passiveRadarObservationGetResponse.accelUnc
                alt = passiveRadarObservationGetResponse.alt
                azimuth = passiveRadarObservationGetResponse.azimuth
                azimuthBias = passiveRadarObservationGetResponse.azimuthBias
                azimuthRate = passiveRadarObservationGetResponse.azimuthRate
                azimuthUnc = passiveRadarObservationGetResponse.azimuthUnc
                bistaticRange = passiveRadarObservationGetResponse.bistaticRange
                bistaticRangeAccel = passiveRadarObservationGetResponse.bistaticRangeAccel
                bistaticRangeAccelUnc = passiveRadarObservationGetResponse.bistaticRangeAccelUnc
                bistaticRangeBias = passiveRadarObservationGetResponse.bistaticRangeBias
                bistaticRangeRate = passiveRadarObservationGetResponse.bistaticRangeRate
                bistaticRangeRateUnc = passiveRadarObservationGetResponse.bistaticRangeRateUnc
                bistaticRangeUnc = passiveRadarObservationGetResponse.bistaticRangeUnc
                coning = passiveRadarObservationGetResponse.coning
                coningUnc = passiveRadarObservationGetResponse.coningUnc
                createdAt = passiveRadarObservationGetResponse.createdAt
                createdBy = passiveRadarObservationGetResponse.createdBy
                declination = passiveRadarObservationGetResponse.declination
                delay = passiveRadarObservationGetResponse.delay
                delayBias = passiveRadarObservationGetResponse.delayBias
                delayUnc = passiveRadarObservationGetResponse.delayUnc
                descriptor = passiveRadarObservationGetResponse.descriptor
                doppler = passiveRadarObservationGetResponse.doppler
                dopplerUnc = passiveRadarObservationGetResponse.dopplerUnc
                elevation = passiveRadarObservationGetResponse.elevation
                elevationBias = passiveRadarObservationGetResponse.elevationBias
                elevationRate = passiveRadarObservationGetResponse.elevationRate
                elevationUnc = passiveRadarObservationGetResponse.elevationUnc
                extObservationId = passiveRadarObservationGetResponse.extObservationId
                idOnOrbit = passiveRadarObservationGetResponse.idOnOrbit
                idRfEmitter = passiveRadarObservationGetResponse.idRfEmitter
                idSensor = passiveRadarObservationGetResponse.idSensor
                idSensorRefReceiver = passiveRadarObservationGetResponse.idSensorRefReceiver
                lat = passiveRadarObservationGetResponse.lat
                lon = passiveRadarObservationGetResponse.lon
                obPosition = passiveRadarObservationGetResponse.obPosition
                onOrbit = passiveRadarObservationGetResponse.onOrbit
                origin = passiveRadarObservationGetResponse.origin
                origNetwork = passiveRadarObservationGetResponse.origNetwork
                origObjectId = passiveRadarObservationGetResponse.origObjectId
                origSensorId = passiveRadarObservationGetResponse.origSensorId
                orthogonalRcs = passiveRadarObservationGetResponse.orthogonalRcs
                orthogonalRcsUnc = passiveRadarObservationGetResponse.orthogonalRcsUnc
                ra = passiveRadarObservationGetResponse.ra
                rcs = passiveRadarObservationGetResponse.rcs
                rcsUnc = passiveRadarObservationGetResponse.rcsUnc
                satNo = passiveRadarObservationGetResponse.satNo
                senReferenceFrame = passiveRadarObservationGetResponse.senReferenceFrame
                senx = passiveRadarObservationGetResponse.senx
                seny = passiveRadarObservationGetResponse.seny
                senz = passiveRadarObservationGetResponse.senz
                snr = passiveRadarObservationGetResponse.snr
                sourceDl = passiveRadarObservationGetResponse.sourceDl
                tags = passiveRadarObservationGetResponse.tags.map { it.toMutableList() }
                taskId = passiveRadarObservationGetResponse.taskId
                timingBias = passiveRadarObservationGetResponse.timingBias
                tof = passiveRadarObservationGetResponse.tof
                tofBias = passiveRadarObservationGetResponse.tofBias
                tofUnc = passiveRadarObservationGetResponse.tofUnc
                trackId = passiveRadarObservationGetResponse.trackId
                transactionId = passiveRadarObservationGetResponse.transactionId
                type = passiveRadarObservationGetResponse.type
                uct = passiveRadarObservationGetResponse.uct
                xvel = passiveRadarObservationGetResponse.xvel
                yvel = passiveRadarObservationGetResponse.yvel
                zvel = passiveRadarObservationGetResponse.zvel
                additionalProperties =
                    passiveRadarObservationGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PassiveRadarObservationGetResponse].
         *
         ...
         */
        fun build(): PassiveRadarObservationGetResponse =
            PassiveRadarObservationGetResponse(
    ...
    fun validate(): PassiveRadarObservationGetResponse = apply {
        if (validated) {
            return@apply
        }
