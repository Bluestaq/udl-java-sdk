...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaseremitterGetResponse].
         *
    ...
    /** A builder for [LaseremitterGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laseremitterGetResponse: LaseremitterGetResponse) = apply {
            classificationMarking = laseremitterGetResponse.classificationMarking
            dataMode = laseremitterGetResponse.dataMode
            laserName = laseremitterGetResponse.laserName
            laserType = laseremitterGetResponse.laserType
            source = laseremitterGetResponse.source
            id = laseremitterGetResponse.id
            atmosphericTransmission = laseremitterGetResponse.atmosphericTransmission
            beamOutputPower = laseremitterGetResponse.beamOutputPower
            beamWaist = laseremitterGetResponse.beamWaist
            createdAt = laseremitterGetResponse.createdAt
            createdBy = laseremitterGetResponse.createdBy
            divergence = laseremitterGetResponse.divergence
            entity = laseremitterGetResponse.entity
            idEntity = laseremitterGetResponse.idEntity
            isOperational = laseremitterGetResponse.isOperational
            maxDuration = laseremitterGetResponse.maxDuration
            maxFocusRange = laseremitterGetResponse.maxFocusRange
            minFocusRange = laseremitterGetResponse.minFocusRange
            origin = laseremitterGetResponse.origin
            origNetwork = laseremitterGetResponse.origNetwork
            pulseFluence = laseremitterGetResponse.pulseFluence
            pulsePeakPower = laseremitterGetResponse.pulsePeakPower
            pulseRepFreq = laseremitterGetResponse.pulseRepFreq
            pulseShape = laseremitterGetResponse.pulseShape
            pulseWidth = laseremitterGetResponse.pulseWidth
            sourceDl = laseremitterGetResponse.sourceDl
            updatedAt = laseremitterGetResponse.updatedAt
            updatedBy = laseremitterGetResponse.updatedBy
            wavelength = laseremitterGetResponse.wavelength
            additionalProperties = laseremitterGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LaseremitterGetResponse].
         *
         ...
         */
        fun build(): LaseremitterGetResponse =
    ...
    fun validate(): LaseremitterGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaseremitterGetResponse &&
