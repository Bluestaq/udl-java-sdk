...
private constructor(
    ...
    override fun nextPage(): CompletableFuture<SensorTypeListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeListPageAsync: SensorTypeListPageAsync) = apply {
        ...
        fun service(service: SensorTypeServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: SensorTypeListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<SensorTypeListResponse>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorTypeListPageAsync &&
    ...
    override fun toString() =
        "SensorTypeListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
