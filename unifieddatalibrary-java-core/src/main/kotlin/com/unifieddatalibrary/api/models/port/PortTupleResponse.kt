...
class PortTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("harborSize") @ExcludeMissing harborSize: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("harborType") @ExcludeMissing harborType: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("locode")
    @ExcludeMissing
    fun _locode(): JsonField<String> = locode
    ...
    @ExcludeMissing
    fun _pilotReqd(): JsonField<Boolean> = pilotReqd
    ...
    @ExcludeMissing
    fun _portName(): JsonField<String> = portName
    ...
    @ExcludeMissing
    fun _shelter(): JsonField<String> = shelter
    ...
    @ExcludeMissing
    fun _tideRange(): JsonField<Double> = tideRange
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortTupleResponse].
         *
    ...
    /** A builder for [PortTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portTupleResponse: PortTupleResponse) =
            apply {
                classificationMarking = portTupleResponse.classificationMarking
                dataMode = portTupleResponse.dataMode
                source = portTupleResponse.source
                id = portTupleResponse.id
                avgDuration = portTupleResponse.avgDuration
                countryCode = portTupleResponse.countryCode
                createdAt = portTupleResponse.createdAt
                createdBy = portTupleResponse.createdBy
                externalId = portTupleResponse.externalId
                harborSize = portTupleResponse.harborSize
                harborType = portTupleResponse.harborType
                idSite = portTupleResponse.idSite
                lat = portTupleResponse.lat
                locode = portTupleResponse.locode
                lon = portTupleResponse.lon
                maxDraught = portTupleResponse.maxDraught
                origin = portTupleResponse.origin
                origNetwork = portTupleResponse.origNetwork
                pilotReqd = portTupleResponse.pilotReqd
                portName = portTupleResponse.portName
                shelter = portTupleResponse.shelter
                sourceDl = portTupleResponse.sourceDl
                tideRange = portTupleResponse.tideRange
                updatedAt = portTupleResponse.updatedAt
                updatedBy = portTupleResponse.updatedBy
                additionalProperties = portTupleResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.harborSize] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun harborSize(harborSize: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.harborType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun harborType(harborType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.locode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun locode(locode: JsonField<String>) =
            apply {
                this.locode = locode
            }
         ...
         *
         * You should usually call [Builder.pilotReqd] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pilotReqd(pilotReqd: JsonField<Boolean>) =
            apply {
                this.pilotReqd = pilotReqd
            }
         ...
         *
         * You should usually call [Builder.portName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun portName(portName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.shelter] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun shelter(shelter: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.tideRange] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tideRange(tideRange: JsonField<Double>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [PortTupleResponse].
         *
    ...
    fun validate(): PortTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (avgDuration.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (if (harborSize.asKnown().isPresent) 1 else 0) + (if (harborType.asKnown().isPresent) 1 else 0) + (if (idSite.asKnown().isPresent) 1 else 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (locode.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (maxDraught.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (pilotReqd.asKnown().isPresent) 1 else 0) + (if (portName.asKnown().isPresent) 1 else 0) + (if (shelter.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (tideRange.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "PortTupleResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, avgDuration=$avgDuration, countryCode=$countryCode, createdAt=$createdAt, createdBy=$createdBy, externalId=$externalId, harborSize=$harborSize, harborType=$harborType, idSite=$idSite, lat=$lat, locode=$locode, lon=$lon, maxDraught=$maxDraught, origin=$origin, origNetwork=$origNetwork, pilotReqd=$pilotReqd, portName=$portName, shelter=$shelter, sourceDl=$sourceDl, tideRange=$tideRange, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
