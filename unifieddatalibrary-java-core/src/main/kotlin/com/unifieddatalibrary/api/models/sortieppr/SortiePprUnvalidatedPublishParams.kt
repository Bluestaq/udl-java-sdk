...
/**
 * Service operation to take SortiePPR as a POST body and ingest into the database. This operation
 * is intended to be used for automated feeds into UDL. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class SortiePprUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [SortiePprUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprUnvalidatedPublishParams: SortiePprUnvalidatedPublishParams) =
            apply {
                body = sortiePprUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = sortiePprUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    sortiePprUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SortiePprUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): SortiePprUnvalidatedPublishParams =
            SortiePprUnvalidatedPublishParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SortiePprUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SortiePprUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
