...
class EffectResponseRetrieveResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("actionsList") @ExcludeMissing actionsList: JsonField<List<EffectResponseActionsListFull>> = JsonMissing.of(),
        ...
        @JsonProperty("coaMetrics") @ExcludeMissing coaMetrics: JsonField<List<EffectResponseMetricsFull>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun actionsList(): Optional<List<EffectResponseActionsListFull>> = actionsList.getOptional("actionsList")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun coaMetrics(): Optional<List<EffectResponseMetricsFull>> = coaMetrics.getOptional("coaMetrics")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectResponseRetrieveResponse].
         *
    ...
    /** A builder for [EffectResponseRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseRetrieveResponse: EffectResponseRetrieveResponse) =
            apply {
                classificationMarking = effectResponseRetrieveResponse.classificationMarking
                dataMode = effectResponseRetrieveResponse.dataMode
                source = effectResponseRetrieveResponse.source
                type = effectResponseRetrieveResponse.type
                id = effectResponseRetrieveResponse.id
                actionsList = effectResponseRetrieveResponse.actionsList.map { it.toMutableList() }
                actorSrcId = effectResponseRetrieveResponse.actorSrcId
                actorSrcType = effectResponseRetrieveResponse.actorSrcType
                coaMetrics = effectResponseRetrieveResponse.coaMetrics.map { it.toMutableList() }
                collateralDamageEst = effectResponseRetrieveResponse.collateralDamageEst
                createdAt = effectResponseRetrieveResponse.createdAt
                createdBy = effectResponseRetrieveResponse.createdBy
                decisionDeadline = effectResponseRetrieveResponse.decisionDeadline
                externalActions = effectResponseRetrieveResponse.externalActions.map { it.toMutableList() }
                externalRequestId = effectResponseRetrieveResponse.externalRequestId
                idEffectRequest = effectResponseRetrieveResponse.idEffectRequest
                munitionId = effectResponseRetrieveResponse.munitionId
                munitionType = effectResponseRetrieveResponse.munitionType
                origin = effectResponseRetrieveResponse.origin
                origNetwork = effectResponseRetrieveResponse.origNetwork
                probabilityOfKill = effectResponseRetrieveResponse.probabilityOfKill
                redTargetSrcId = effectResponseRetrieveResponse.redTargetSrcId
                redTargetSrcType = effectResponseRetrieveResponse.redTargetSrcType
                redTimeToOverhead = effectResponseRetrieveResponse.redTimeToOverhead
                shotsRequired = effectResponseRetrieveResponse.shotsRequired
                additionalProperties = effectResponseRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /** List of actions associated with this effect response. */
        fun actionsList(actionsList: List<EffectResponseActionsListFull>) = actionsList(JsonField.of(actionsList))

        /**
         * Sets [Builder.actionsList] to an arbitrary JSON value.
         *
         * You should usually call [Builder.actionsList] with a well-typed `List<EffectResponseActionsListFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun actionsList(actionsList: JsonField<List<EffectResponseActionsListFull>>) =
            apply {
         ...
         */
        fun addActionsList(actionsList: EffectResponseActionsListFull) =
            apply {
        ...
        /** List of COA metrics associated with this effect response. */
        fun coaMetrics(coaMetrics: List<EffectResponseMetricsFull>) = coaMetrics(JsonField.of(coaMetrics))

        /**
         * Sets [Builder.coaMetrics] to an arbitrary JSON value.
         *
         * You should usually call [Builder.coaMetrics] with a well-typed `List<EffectResponseMetricsFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun coaMetrics(coaMetrics: JsonField<List<EffectResponseMetricsFull>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCoaMetric(coaMetric: EffectResponseMetricsFull) =
            apply {
        ...
        /**
         * Returns an immutable instance of [EffectResponseRetrieveResponse].
         *
         ...
         */
        fun build(): EffectResponseRetrieveResponse =
    ...
    fun validate(): EffectResponseRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
