...
class EffectResponseRetrieveResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseRetrieveResponse: EffectResponseRetrieveResponse) = apply {
            ...
            externalActions =
                effectResponseRetrieveResponse.externalActions.map { it.toMutableList() }
            ...
            additionalProperties =
                effectResponseRetrieveResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): EffectResponseRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
