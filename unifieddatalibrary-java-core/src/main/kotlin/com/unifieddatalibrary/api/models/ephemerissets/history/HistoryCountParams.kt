...
class HistoryCountParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): HistoryCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(historyCountParams: HistoryCountParams) =
            apply {
                firstResult = historyCountParams.firstResult
                maxResults = historyCountParams.maxResults
                pointEndTime = historyCountParams.pointEndTime
                pointStartTime = historyCountParams.pointStartTime
        ...
        fun pointEndTime(pointEndTime: Optional<OffsetDateTime>) = pointEndTime(pointEndTime.getOrNull())
        ...
        fun pointStartTime(pointStartTime: Optional<OffsetDateTime>) = pointStartTime(pointStartTime.getOrNull())
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                pointEndTime?.let { put("pointEndTime", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                pointStartTime?.let { put("pointStartTime", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is HistoryCountParams && firstResult == other.firstResult && maxResults == other.maxResults && pointEndTime == other.pointEndTime && pointStartTime == other.pointStartTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(firstResult, maxResults, pointEndTime, pointStartTime, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "HistoryCountParams{firstResult=$firstResult, maxResults=$maxResults, pointEndTime=$pointEndTime, pointStartTime=$pointStartTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
