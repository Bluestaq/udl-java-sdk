...
class ManifoldGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ManifoldGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldGetParams: ManifoldGetParams) =
            apply {
    ...
    override fun toString() = "ManifoldGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
