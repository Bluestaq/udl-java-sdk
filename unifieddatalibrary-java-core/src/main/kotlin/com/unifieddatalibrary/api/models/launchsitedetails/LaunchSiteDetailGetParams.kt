...
/**
 * Service operation to get a single LaunchSiteDetails by its unique ID passed as a path parameter.
 ...
 */
class LaunchSiteDetailGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchSiteDetailGetParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteDetailGetParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LaunchSiteDetailGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteDetailGetParams: LaunchSiteDetailGetParams) = apply {
            id = launchSiteDetailGetParams.id
            firstResult = launchSiteDetailGetParams.firstResult
            maxResults = launchSiteDetailGetParams.maxResults
            additionalHeaders = launchSiteDetailGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = launchSiteDetailGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteDetailGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchSiteDetailGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LaunchSiteDetailGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LaunchSiteDetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
