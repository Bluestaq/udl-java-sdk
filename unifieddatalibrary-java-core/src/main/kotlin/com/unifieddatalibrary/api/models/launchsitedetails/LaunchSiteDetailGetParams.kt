...
class LaunchSiteDetailGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): LaunchSiteDetailGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteDetailGetParams: LaunchSiteDetailGetParams) =
            apply {
    ...
    override fun toString() = "LaunchSiteDetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
