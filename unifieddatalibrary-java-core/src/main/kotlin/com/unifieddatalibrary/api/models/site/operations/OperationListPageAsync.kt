...
private constructor(
    ...
    override fun nextPage(): CompletableFuture<OperationListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationListPageAsync: OperationListPageAsync) = apply {
        ...
        fun service(service: OperationServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OperationListPageAsync &&
    ...
    override fun toString() =
        "OperationListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
