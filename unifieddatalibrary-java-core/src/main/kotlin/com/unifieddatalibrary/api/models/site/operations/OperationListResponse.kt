...
private constructor(
     ...
     */
    @JsonProperty("pathways") @ExcludeMissing fun _pathways(): JsonField<List<Pathway>> = pathways
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperationListResponse].
         *
    ...
    /** A builder for [OperationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationListResponse: OperationListResponse) = apply {
            classificationMarking = operationListResponse.classificationMarking
            dataMode = operationListResponse.dataMode
            idSite = operationListResponse.idSite
            source = operationListResponse.source
            id = operationListResponse.id
            createdAt = operationListResponse.createdAt
            createdBy = operationListResponse.createdBy
            dailyOperations = operationListResponse.dailyOperations.map { it.toMutableList() }
            dopsLastChangedBy = operationListResponse.dopsLastChangedBy
            dopsLastChangedDate = operationListResponse.dopsLastChangedDate
            dopsLastChangedReason = operationListResponse.dopsLastChangedReason
            idLaunchSite = operationListResponse.idLaunchSite
            maximumOnGrounds = operationListResponse.maximumOnGrounds.map { it.toMutableList() }
            mogsLastChangedBy = operationListResponse.mogsLastChangedBy
            mogsLastChangedDate = operationListResponse.mogsLastChangedDate
            mogsLastChangedReason = operationListResponse.mogsLastChangedReason
            operationalDeviations =
                operationListResponse.operationalDeviations.map { it.toMutableList() }
            operationalPlannings =
                operationListResponse.operationalPlannings.map { it.toMutableList() }
            origin = operationListResponse.origin
            origNetwork = operationListResponse.origNetwork
            pathways = operationListResponse.pathways.map { it.toMutableList() }
            sourceDl = operationListResponse.sourceDl
            updatedAt = operationListResponse.updatedAt
            updatedBy = operationListResponse.updatedBy
            waivers = operationListResponse.waivers.map { it.toMutableList() }
            additionalProperties = operationListResponse.additionalProperties.toMutableMap()
        }
         ...
         * `List<DailyOperation>` value instead. This method is primarily for setting the field to
         ...
         * `List<MaximumOnGround>` value instead. This method is primarily for setting the field to
         * an undocumented or not yet supported value.
         */
         ...
         * `List<OperationalPlanning>` value instead. This method is primarily for setting the field
         ...
         *
         * You should usually call [Builder.waivers] with a well-typed `List<Waiver>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [OperationListResponse].
         *
         ...
         */
        fun build(): OperationListResponse =
    ...
    fun validate(): OperationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [operatingHours], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("operatingHours")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * `List<OperatingHour>` value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            ...
            fun known(): Known =
                when (this) {
                    ...
                    SUNDAY -> Known.SUNDAY
                        ...
                        throw UnifieddatalibraryInvalidDataException("Unknown DayOfWeek: $value")
                }
        ...
        private constructor(
             ...
             *
             * Unlike [opStartTime], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("opStartTime")
            @ExcludeMissing
             ...
             *
             * Unlike [opStopTime], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("opStopTime")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.opStartTime] with a well-typed [String] value
    ...
    private constructor(
         ...
         *
         * Unlike [contingencyMog], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("contingencyMOG")
        @ExcludeMissing
    ...
    private constructor(
         ...
         *
         * Unlike [odLastChangedBy], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("odLastChangedBy")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.affectedMog] with a well-typed [Int] value instead.
             ...
             *
             * You should usually call [Builder.odRemark] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    private constructor(
         ...
         *
         * Unlike [opLastChangedBy], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("opLastChangedBy")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.opRemark] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.opSource] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.opStatus] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    private constructor(
        ...
        ) : this(pwDefinition, pwLastChangedBy, pwLastChangedDate, pwType, pwUsage, mutableMapOf())
        ...
        /**
         * The datetime of the most recent change made to this Pathway data, in ISO 8601 UTC format
         ...
         *
         * Unlike [pwLastChangedBy], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("pwLastChangedBy")
        @ExcludeMissing
         ...
         *
         * Unlike [pwLastChangedDate], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("pwLastChangedDate")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.pwLastChangedBy] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.pwType] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.pwUsage] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    private constructor(
         ...
         *
         * Unlike [requestingUnit], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("requestingUnit")
        @ExcludeMissing
         ...
         *
         * Unlike [waiverAppliesTo], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("waiverAppliesTo")
        @ExcludeMissing
