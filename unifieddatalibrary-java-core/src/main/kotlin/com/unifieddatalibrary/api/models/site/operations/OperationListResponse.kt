...
class OperationListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationListResponse: OperationListResponse) =
            apply {
                ...
                operationalDeviations = operationListResponse.operationalDeviations.map { it.toMutableList() }
                operationalPlannings = operationListResponse.operationalPlannings.map { it.toMutableList() }
    ...
    fun validate(): OperationListResponse =
        apply {
            if (validated) {
              return@apply
            }
