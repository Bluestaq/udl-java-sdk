...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldSlotListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotListParams: AirfieldSlotListParams) = apply {
    ...
    override fun toString() =
        "AirfieldSlotListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
