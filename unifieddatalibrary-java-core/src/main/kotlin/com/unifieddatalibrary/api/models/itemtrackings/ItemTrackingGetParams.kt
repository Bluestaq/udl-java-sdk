...
class ItemTrackingGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ItemTrackingGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ItemTrackingGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ItemTrackingGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingGetParams: ItemTrackingGetParams) =
            apply {
                id = itemTrackingGetParams.id
                firstResult = itemTrackingGetParams.firstResult
                maxResults = itemTrackingGetParams.maxResults
                additionalHeaders = itemTrackingGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = itemTrackingGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ItemTrackingGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ItemTrackingGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ItemTrackingGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ItemTrackingGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
