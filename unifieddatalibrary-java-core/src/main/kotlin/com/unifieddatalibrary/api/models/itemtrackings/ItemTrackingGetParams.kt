...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ItemTrackingGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingGetParams: ItemTrackingGetParams) = apply {
    ...
    override fun toString() =
        "ItemTrackingGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
