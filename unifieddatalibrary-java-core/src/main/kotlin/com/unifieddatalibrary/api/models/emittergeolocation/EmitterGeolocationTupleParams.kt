...
class EmitterGeolocationTupleParams private constructor(
    ...
    /** The start time for this Emitter Geo Location data set in ISO 8601 UTC with microsecond precision. (YYYY-MM-DDTHH:MM:SS.ssssssZ) */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmitterGeolocationTupleParams].
         *
    ...
    /** A builder for [EmitterGeolocationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationTupleParams: EmitterGeolocationTupleParams) =
            apply {
                columns = emitterGeolocationTupleParams.columns
                startTime = emitterGeolocationTupleParams.startTime
                firstResult = emitterGeolocationTupleParams.firstResult
                maxResults = emitterGeolocationTupleParams.maxResults
                additionalHeaders = emitterGeolocationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = emitterGeolocationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationTupleParams].
         *
         ...
         */
        fun build(): EmitterGeolocationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EmitterGeolocationTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EmitterGeolocationTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
