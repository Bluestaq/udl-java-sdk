...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubstatusTupleParams].
         *
    ...
    /** A builder for [SubstatusTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(substatusTupleParams: SubstatusTupleParams) = apply {
            columns = substatusTupleParams.columns
            firstResult = substatusTupleParams.firstResult
            maxResults = substatusTupleParams.maxResults
            additionalHeaders = substatusTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = substatusTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SubstatusTupleParams].
         *
         ...
         */
        fun build(): SubstatusTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubstatusTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SubstatusTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
