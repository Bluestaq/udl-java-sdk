...
class OrbittrackTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbittrackTupleParams].
         *
    ...
    /** A builder for [OrbittrackTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackTupleParams: OrbittrackTupleParams) =
            apply {
                columns = orbittrackTupleParams.columns
                ts = orbittrackTupleParams.ts
                firstResult = orbittrackTupleParams.firstResult
                maxResults = orbittrackTupleParams.maxResults
                additionalHeaders = orbittrackTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = orbittrackTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OrbittrackTupleParams].
         *
         ...
         */
        fun build(): OrbittrackTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbittrackTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OrbittrackTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
