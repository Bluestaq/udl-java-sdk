...
class HistoryQueryResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("cartpos") @ExcludeMissing cartpos: JsonField<List<Double>> = JsonMissing.of(),
    ...
    @JsonProperty("msgfmt")
    @ExcludeMissing
    fun _msgfmt(): JsonField<String> = msgfmt
    ...
    @JsonProperty("msgts")
    @ExcludeMissing
    fun _msgts(): JsonField<OffsetDateTime> = msgts
    ...
    @JsonProperty("msgtyp")
    @ExcludeMissing
    fun _msgtyp(): JsonField<String> = msgtyp
    ...
    @JsonProperty("addr")
    @ExcludeMissing
    fun _addr(): JsonField<String> = addr
    ...
    @JsonProperty("aims")
    @ExcludeMissing
    fun _aims(): JsonField<Boolean> = aims
    ...
    @JsonProperty("alt3d")
    @ExcludeMissing
    fun _alt3d(): JsonField<Double> = alt3d
    ...
    @ExcludeMissing
    fun _artsqual(): JsonField<String> = artsqual
    ...
    @JsonProperty("azdelt")
    @ExcludeMissing
    fun _azdelt(): JsonField<Double> = azdelt
     ...
     */
    @JsonProperty("bcnhits")
    @ExcludeMissing
    fun _bcnhits(): JsonField<Int> = bcnhits
    ...
    @ExcludeMissing
    fun _cartpos(): JsonField<List<Double>> = cartpos
    ...
    @ExcludeMissing
    fun _code7500(): JsonField<Boolean> = code7500
    ...
    @ExcludeMissing
    fun _code7600(): JsonField<Boolean> = code7600
    ...
    @ExcludeMissing
    fun _code7700(): JsonField<Boolean> = code7700
    ...
    @JsonProperty("faa")
    @ExcludeMissing
    fun _faa(): JsonField<Boolean> = faa
     ...
     */
    @JsonProperty("grndspd")
    @ExcludeMissing
    fun _grndspd(): JsonField<Double> = grndspd
    ...
    @JsonProperty("m1g")
    @ExcludeMissing
    fun _m1g(): JsonField<Boolean> = m1g
    ...
    @JsonProperty("m2g")
    @ExcludeMissing
    fun _m2g(): JsonField<Boolean> = m2g
    ...
    @JsonProperty("m2xv")
    @ExcludeMissing
    fun _m2xv(): JsonField<String> = m2xv
    ...
    @JsonProperty("m3ag")
    @ExcludeMissing
    fun _m3ag(): JsonField<Boolean> = m3ag
    ...
    @JsonProperty("m3av")
    @ExcludeMissing
    fun _m3av(): JsonField<String> = m3av
    ...
    @JsonProperty("m3axv")
    @ExcludeMissing
    fun _m3axv(): JsonField<String> = m3axv
    ...
    @JsonProperty("m4d1d2")
    @ExcludeMissing
    fun _m4d1d2(): JsonField<String> = m4d1d2
    ...
    @JsonProperty("mcg")
    @ExcludeMissing
    fun _mcg(): JsonField<Boolean> = mcg
    ...
    @ExcludeMissing
    fun _milemrgcy(): JsonField<Boolean> = milemrgcy
    ...
    @JsonProperty("mrgrpt")
    @ExcludeMissing
    fun _mrgrpt(): JsonField<Boolean> = mrgrpt
     ...
     */
    @JsonProperty("mscommb")
    @ExcludeMissing
    fun _mscommb(): JsonField<String> = mscommb
    ...
    @JsonProperty("mti")
    @ExcludeMissing
    fun _mti(): JsonField<Boolean> = mti
    ...
    @JsonProperty("psrrl")
    @ExcludeMissing
    fun _psrrl(): JsonField<Double> = psrrl
     ...
     */
    @JsonProperty("rngdelt")
    @ExcludeMissing
    fun _rngdelt(): JsonField<Double> = rngdelt
    ...
    @JsonProperty("spi")
    @ExcludeMissing
    fun _spi(): JsonField<Boolean> = spi
    ...
    @JsonProperty("ssrl")
    @ExcludeMissing
    fun _ssrl(): JsonField<Double> = ssrl
     ...
     */
    @JsonProperty("tgtconf")
    @ExcludeMissing
    fun _tgtconf(): JsonField<String> = tgtconf
     ...
     */
    @JsonProperty("tgtcorr")
    @ExcludeMissing
    fun _tgtcorr(): JsonField<String> = tgtcorr
    ...
    @JsonProperty("tgtid")
    @ExcludeMissing
    fun _tgtid(): JsonField<String> = tgtid
     ...
     */
    @JsonProperty("trkelig")
    @ExcludeMissing
    fun _trkelig(): JsonField<String> = trkelig
    ...
    @JsonProperty("trknum")
    @ExcludeMissing
    fun _trknum(): JsonField<Int> = trknum
    ...
    @JsonProperty("wectc")
    @ExcludeMissing
    fun _wectc(): JsonField<List<String>> = wectc
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(historyQueryResponse: HistoryQueryResponse) =
            apply {
                classificationMarking = historyQueryResponse.classificationMarking
                dataMode = historyQueryResponse.dataMode
                msgfmt = historyQueryResponse.msgfmt
                msgts = historyQueryResponse.msgts
                msgtyp = historyQueryResponse.msgtyp
                source = historyQueryResponse.source
                ts = historyQueryResponse.ts
                id = historyQueryResponse.id
                acp = historyQueryResponse.acp
                addr = historyQueryResponse.addr
                af = historyQueryResponse.af
                aims = historyQueryResponse.aims
                alt3d = historyQueryResponse.alt3d
                artsqual = historyQueryResponse.artsqual
                az = historyQueryResponse.az
                azdelt = historyQueryResponse.azdelt
                bcnhits = historyQueryResponse.bcnhits
                cartpos = historyQueryResponse.cartpos.map { it.toMutableList() }
                cdm = historyQueryResponse.cdm
                code7500 = historyQueryResponse.code7500
                code7600 = historyQueryResponse.code7600
                code7700 = historyQueryResponse.code7700
                createdAt = historyQueryResponse.createdAt
                createdBy = historyQueryResponse.createdBy
                faa = historyQueryResponse.faa
                grndspd = historyQueryResponse.grndspd
                hdng = historyQueryResponse.hdng
                idSensor = historyQueryResponse.idSensor
                m1 = historyQueryResponse.m1
                m1g = historyQueryResponse.m1g
                m1v = historyQueryResponse.m1v
                m2 = historyQueryResponse.m2
                m2g = historyQueryResponse.m2g
                m2v = historyQueryResponse.m2v
                m2xv = historyQueryResponse.m2xv
                m3a = historyQueryResponse.m3a
                m3ag = historyQueryResponse.m3ag
                m3av = historyQueryResponse.m3av
                m3axv = historyQueryResponse.m3axv
                m4 = historyQueryResponse.m4
                m4d1d2 = historyQueryResponse.m4d1d2
                m4v = historyQueryResponse.m4v
                mah = historyQueryResponse.mah
                mc = historyQueryResponse.mc
                mcg = historyQueryResponse.mcg
                mcv = historyQueryResponse.mcv
                milemrgcy = historyQueryResponse.milemrgcy
                mrgrpt = historyQueryResponse.mrgrpt
                mscommb = historyQueryResponse.mscommb
                mti = historyQueryResponse.mti
                origin = historyQueryResponse.origin
                origNetwork = historyQueryResponse.origNetwork
                origSensorId = historyQueryResponse.origSensorId
                psrrl = historyQueryResponse.psrrl
                rad = historyQueryResponse.rad
                rng = historyQueryResponse.rng
                rngdelt = historyQueryResponse.rngdelt
                sac = historyQueryResponse.sac
                senalt = historyQueryResponse.senalt
                senlat = historyQueryResponse.senlat
                senlon = historyQueryResponse.senlon
                sic = historyQueryResponse.sic
                spi = historyQueryResponse.spi
                ssrl = historyQueryResponse.ssrl
                tags = historyQueryResponse.tags.map { it.toMutableList() }
                tgtconf = historyQueryResponse.tgtconf
                tgtcorr = historyQueryResponse.tgtcorr
                tgtid = historyQueryResponse.tgtid
                tis = historyQueryResponse.tis
                trkelig = historyQueryResponse.trkelig
                trknum = historyQueryResponse.trknum
                tti = historyQueryResponse.tti
                wectc = historyQueryResponse.wectc.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.msgfmt] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun msgfmt(msgfmt: JsonField<String>) =
            apply {
                this.msgfmt = msgfmt
            }
         ...
         *
         * You should usually call [Builder.msgts] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun msgts(msgts: JsonField<OffsetDateTime>) =
            apply {
                this.msgts = msgts
            }
         ...
         *
         * You should usually call [Builder.msgtyp] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun msgtyp(msgtyp: JsonField<String>) =
            apply {
                this.msgtyp = msgtyp
            }
         ...
         *
         * You should usually call [Builder.acp] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun acp(acp: JsonField<Int>) =
            apply {
                this.acp = acp
            }
         ...
         *
         * You should usually call [Builder.addr] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun addr(addr: JsonField<String>) =
            apply {
                this.addr = addr
            }
         ...
         *
         * You should usually call [Builder.af] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun af(af: JsonField<Boolean>) =
            apply {
                this.af = af
            }
         ...
         *
         * You should usually call [Builder.aims] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun aims(aims: JsonField<Boolean>) =
            apply {
                this.aims = aims
            }
         ...
         *
         * You should usually call [Builder.alt3d] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alt3d(alt3d: JsonField<Double>) =
            apply {
                this.alt3d = alt3d
            }
         ...
         *
         * You should usually call [Builder.artsqual] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun artsqual(artsqual: JsonField<String>) =
            apply {
                this.artsqual = artsqual
            }
         ...
         *
         * You should usually call [Builder.azdelt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun azdelt(azdelt: JsonField<Double>) =
            apply {
                this.azdelt = azdelt
            }
         ...
         *
         * You should usually call [Builder.bcnhits] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun bcnhits(bcnhits: JsonField<Int>) =
            apply {
                this.bcnhits = bcnhits
            }
         ...
         *
         * You should usually call [Builder.cartpos] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cartpos(cartpos: JsonField<List<Double>>) =
            apply {
         ...
         */
        fun addCartpo(cartpo: Double) =
            apply {
                cartpos = (cartpos ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.cdm] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cdm(cdm: JsonField<String>) =
            apply {
                this.cdm = cdm
            }
         ...
         *
         * You should usually call [Builder.code7500] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun code7500(code7500: JsonField<Boolean>) =
            apply {
                this.code7500 = code7500
            }
         ...
         *
         * You should usually call [Builder.code7600] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun code7600(code7600: JsonField<Boolean>) =
            apply {
                this.code7600 = code7600
            }
         ...
         *
         * You should usually call [Builder.code7700] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun code7700(code7700: JsonField<Boolean>) =
            apply {
                this.code7700 = code7700
            }
         ...
         *
         * You should usually call [Builder.faa] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun faa(faa: JsonField<Boolean>) =
            apply {
                this.faa = faa
            }
         ...
         *
         * You should usually call [Builder.grndspd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun grndspd(grndspd: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.m1g] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m1g(m1g: JsonField<Boolean>) =
            apply {
                this.m1g = m1g
            }
         ...
         *
         * You should usually call [Builder.m1v] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m1v(m1v: JsonField<String>) =
            apply {
                this.m1v = m1v
            }
         ...
         *
         * You should usually call [Builder.m2g] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m2g(m2g: JsonField<Boolean>) =
            apply {
                this.m2g = m2g
            }
         ...
         *
         * You should usually call [Builder.m2v] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m2v(m2v: JsonField<String>) =
            apply {
                this.m2v = m2v
            }
         ...
         *
         * You should usually call [Builder.m2xv] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m2xv(m2xv: JsonField<String>) =
            apply {
                this.m2xv = m2xv
            }
         ...
         *
         * You should usually call [Builder.m3ag] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m3ag(m3ag: JsonField<Boolean>) =
            apply {
                this.m3ag = m3ag
            }
         ...
         *
         * You should usually call [Builder.m3av] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m3av(m3av: JsonField<String>) =
            apply {
                this.m3av = m3av
            }
         ...
         *
         * You should usually call [Builder.m3axv] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m3axv(m3axv: JsonField<String>) =
            apply {
                this.m3axv = m3axv
            }
         ...
         *
         * You should usually call [Builder.m4d1d2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m4d1d2(m4d1d2: JsonField<String>) =
            apply {
                this.m4d1d2 = m4d1d2
            }
         ...
         *
         * You should usually call [Builder.m4v] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun m4v(m4v: JsonField<String>) =
            apply {
                this.m4v = m4v
            }
         ...
         *
         * You should usually call [Builder.mah] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mah(mah: JsonField<String>) =
            apply {
                this.mah = mah
            }
         ...
         *
         * You should usually call [Builder.mc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mc(mc: JsonField<Double>) =
            apply {
                this.mc = mc
            }
         ...
         *
         * You should usually call [Builder.mcg] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mcg(mcg: JsonField<Boolean>) =
            apply {
                this.mcg = mcg
            }
         ...
         *
         * You should usually call [Builder.mcv] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mcv(mcv: JsonField<String>) =
            apply {
                this.mcv = mcv
            }
         ...
         *
         * You should usually call [Builder.milemrgcy] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun milemrgcy(milemrgcy: JsonField<Boolean>) =
            apply {
                this.milemrgcy = milemrgcy
            }
         ...
         *
         * You should usually call [Builder.mrgrpt] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mrgrpt(mrgrpt: JsonField<Boolean>) =
            apply {
                this.mrgrpt = mrgrpt
            }
         ...
         *
         * You should usually call [Builder.mscommb] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mscommb(mscommb: JsonField<String>) =
            apply {
                this.mscommb = mscommb
            }
         ...
         *
         * You should usually call [Builder.mti] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mti(mti: JsonField<Boolean>) =
            apply {
                this.mti = mti
            }
         ...
         *
         * You should usually call [Builder.psrrl] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun psrrl(psrrl: JsonField<Double>) =
            apply {
                this.psrrl = psrrl
            }
         ...
         *
         * You should usually call [Builder.rad] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rad(rad: JsonField<String>) =
            apply {
                this.rad = rad
            }
         ...
         *
         * You should usually call [Builder.rng] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rng(rng: JsonField<Double>) =
            apply {
                this.rng = rng
            }
         ...
         *
         * You should usually call [Builder.rngdelt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rngdelt(rngdelt: JsonField<Double>) =
            apply {
                this.rngdelt = rngdelt
            }
         ...
         *
         * You should usually call [Builder.sac] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sac(sac: JsonField<Int>) =
            apply {
                this.sac = sac
            }
         ...
         *
         * You should usually call [Builder.sic] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sic(sic: JsonField<Int>) =
            apply {
                this.sic = sic
            }
         ...
         *
         * You should usually call [Builder.spi] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spi(spi: JsonField<Boolean>) =
            apply {
                this.spi = spi
            }
         ...
         *
         * You should usually call [Builder.ssrl] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ssrl(ssrl: JsonField<Double>) =
            apply {
                this.ssrl = ssrl
            }
         ...
         *
         * You should usually call [Builder.tgtconf] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tgtconf(tgtconf: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.tgtcorr] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tgtcorr(tgtcorr: JsonField<String>) =
            apply {
                this.tgtcorr = tgtcorr
            }
         ...
         *
         * You should usually call [Builder.tgtid] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tgtid(tgtid: JsonField<String>) =
            apply {
                this.tgtid = tgtid
            }
         ...
         *
         * You should usually call [Builder.tis] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tis(tis: JsonField<Double>) =
            apply {
                this.tis = tis
            }
         ...
         *
         * You should usually call [Builder.trkelig] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trkelig(trkelig: JsonField<String>) =
            apply {
                this.trkelig = trkelig
            }
         ...
         *
         * You should usually call [Builder.trknum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trknum(trknum: JsonField<Int>) =
            apply {
                this.trknum = trknum
            }
         ...
         *
         * You should usually call [Builder.tti] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tti(tti: JsonField<String>) =
            apply {
                this.tti = tti
            }
         ...
         *
         * You should usually call [Builder.wectc] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun wectc(wectc: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addWectc(wectc: String) =
            apply {
                this.wectc = (this.wectc ?: JsonField.of(mutableListOf())).also {
    ...
    fun validate(): HistoryQueryResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (msgfmt.asKnown().isPresent) 1 else 0) + (if (msgts.asKnown().isPresent) 1 else 0) + (if (msgtyp.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (ts.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (acp.asKnown().isPresent) 1 else 0) + (if (addr.asKnown().isPresent) 1 else 0) + (if (af.asKnown().isPresent) 1 else 0) + (if (aims.asKnown().isPresent) 1 else 0) + (if (alt3d.asKnown().isPresent) 1 else 0) + (if (artsqual.asKnown().isPresent) 1 else 0) + (if (az.asKnown().isPresent) 1 else 0) + (if (azdelt.asKnown().isPresent) 1 else 0) + (if (bcnhits.asKnown().isPresent) 1 else 0) + (cartpos.asKnown().getOrNull()?.size ?: 0) + (if (cdm.asKnown().isPresent) 1 else 0) + (if (code7500.asKnown().isPresent) 1 else 0) + (if (code7600.asKnown().isPresent) 1 else 0) + (if (code7700.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (faa.asKnown().isPresent) 1 else 0) + (if (grndspd.asKnown().isPresent) 1 else 0) + (if (hdng.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (m1.asKnown().isPresent) 1 else 0) + (if (m1g.asKnown().isPresent) 1 else 0) + (if (m1v.asKnown().isPresent) 1 else 0) + (if (m2.asKnown().isPresent) 1 else 0) + (if (m2g.asKnown().isPresent) 1 else 0) + (if (m2v.asKnown().isPresent) 1 else 0) + (if (m2xv.asKnown().isPresent) 1 else 0) + (if (m3a.asKnown().isPresent) 1 else 0) + (if (m3ag.asKnown().isPresent) 1 else 0) + (if (m3av.asKnown().isPresent) 1 else 0) + (if (m3axv.asKnown().isPresent) 1 else 0) + (if (m4.asKnown().isPresent) 1 else 0) + (if (m4d1d2.asKnown().isPresent) 1 else 0) + (if (m4v.asKnown().isPresent) 1 else 0) + (if (mah.asKnown().isPresent) 1 else 0) + (if (mc.asKnown().isPresent) 1 else 0) + (if (mcg.asKnown().isPresent) 1 else 0) + (if (mcv.asKnown().isPresent) 1 else 0) + (if (milemrgcy.asKnown().isPresent) 1 else 0) + (if (mrgrpt.asKnown().isPresent) 1 else 0) + (if (mscommb.asKnown().isPresent) 1 else 0) + (if (mti.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (psrrl.asKnown().isPresent) 1 else 0) + (if (rad.asKnown().isPresent) 1 else 0) + (if (rng.asKnown().isPresent) 1 else 0) + (if (rngdelt.asKnown().isPresent) 1 else 0) + (if (sac.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlat.asKnown().isPresent) 1 else 0) + (if (senlon.asKnown().isPresent) 1 else 0) + (if (sic.asKnown().isPresent) 1 else 0) + (if (spi.asKnown().isPresent) 1 else 0) + (if (ssrl.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (tgtconf.asKnown().isPresent) 1 else 0) + (if (tgtcorr.asKnown().isPresent) 1 else 0) + (if (tgtid.asKnown().isPresent) 1 else 0) + (if (tis.asKnown().isPresent) 1 else 0) + (if (trkelig.asKnown().isPresent) 1 else 0) + (if (trknum.asKnown().isPresent) 1 else 0) + (if (tti.asKnown().isPresent) 1 else 0) + (wectc.asKnown().getOrNull()?.size ?: 0)
