...
class SeradataRadarPayloadTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataRadarPayloadTupleResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(seradataRadarPayloadTupleResponse: SeradataRadarPayloadTupleResponse) =
            apply {
                ...
                constellationInterferometricCapability = seradataRadarPayloadTupleResponse.constellationInterferometricCapability
                ...
                additionalProperties = seradataRadarPayloadTupleResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SeradataRadarPayloadTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
