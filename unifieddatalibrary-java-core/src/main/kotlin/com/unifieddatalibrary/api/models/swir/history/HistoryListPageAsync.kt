...
private constructor(
    ...
    private val items: List<SwirFull>,
) : PageAsync<SwirFull> {
    ...
    fun autoPager(): AutoPagerAsync<SwirFull> = AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<SwirFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<SwirFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<SwirFull>) = apply { this.items = items }
