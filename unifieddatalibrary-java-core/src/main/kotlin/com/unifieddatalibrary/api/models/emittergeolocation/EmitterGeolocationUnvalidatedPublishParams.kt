...
/**
 * Service operation to take multiple emittergeolocation records as a POST body and ingest into the
 ...
 */
class EmitterGeolocationUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            emitterGeolocationUnvalidatedPublishParams: EmitterGeolocationUnvalidatedPublishParams
        ) = apply {
            body = emitterGeolocationUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                emitterGeolocationUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                emitterGeolocationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmitterGeolocationUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EmitterGeolocationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
