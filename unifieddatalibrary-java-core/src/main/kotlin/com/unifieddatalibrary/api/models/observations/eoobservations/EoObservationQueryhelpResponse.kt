...
class EoObservationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationQueryhelpResponse: EoObservationQueryhelpResponse) = apply {
            ...
            additionalProperties =
                eoObservationQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): EoObservationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
