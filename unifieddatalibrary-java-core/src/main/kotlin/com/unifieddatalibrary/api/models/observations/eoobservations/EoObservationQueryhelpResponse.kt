...
class EoObservationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EoObservationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EoObservationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationQueryhelpResponse: EoObservationQueryhelpResponse) =
            apply {
                aodrSupported = eoObservationQueryhelpResponse.aodrSupported
                classificationMarking = eoObservationQueryhelpResponse.classificationMarking
                description = eoObservationQueryhelpResponse.description
                historySupported = eoObservationQueryhelpResponse.historySupported
                name = eoObservationQueryhelpResponse.name
                parameters = eoObservationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = eoObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = eoObservationQueryhelpResponse.restSupported
                sortSupported = eoObservationQueryhelpResponse.sortSupported
                typeName = eoObservationQueryhelpResponse.typeName
                uri = eoObservationQueryhelpResponse.uri
                additionalProperties = eoObservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EoObservationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EoObservationQueryhelpResponse =
    ...
    fun validate(): EoObservationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
