...
class HistoryQueryParams private constructor(
    ...
    /** Target detection time, in ISO 8601 UTC format with microsecond precision. (YYYY-MM-DDTHH:MM:SS.ssssssZ) */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HistoryQueryParams].
         *
    ...
    /** A builder for [HistoryQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(historyQueryParams: HistoryQueryParams) =
            apply {
                ts = historyQueryParams.ts
                columns = historyQueryParams.columns
                firstResult = historyQueryParams.firstResult
                maxResults = historyQueryParams.maxResults
                additionalHeaders = historyQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams = historyQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [HistoryQueryParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is HistoryQueryParams && ts == other.ts && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "HistoryQueryParams{ts=$ts, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
