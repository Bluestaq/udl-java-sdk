 ...
 * possible/theoretical orbits for an object of interest based on a delta V and delta T. A specific
 * role is required to perform this service operation. Please contact the UDL team for assistance.
 */
class ManifoldUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldUpdateParams: ManifoldUpdateParams) = apply {
    ...
    override fun toString() =
        "ManifoldUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
