...
class SeraDataEarlyWarningListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeraDataEarlyWarningListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(seraDataEarlyWarningListResponse: SeraDataEarlyWarningListResponse) =
            apply {
                ...
                missileLaunchPhaseDetectionAbility = seraDataEarlyWarningListResponse.missileLaunchPhaseDetectionAbility
                ...
                additionalProperties = seraDataEarlyWarningListResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SeraDataEarlyWarningListResponse =
        apply {
            if (validated) {
              return@apply
            }
