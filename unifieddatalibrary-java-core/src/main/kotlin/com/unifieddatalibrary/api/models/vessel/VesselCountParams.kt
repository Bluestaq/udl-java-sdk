...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VesselCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselCountParams: VesselCountParams) = apply {
    ...
    override fun toString() =
        "VesselCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
