...
class ManifoldelsetListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<ManifoldelsetListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetListPageAsync: ManifoldelsetListPageAsync) =
            apply {
        ...
        fun service(service: ManifoldelsetServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: ManifoldelsetListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<ManifoldelsetListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "ManifoldelsetListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
