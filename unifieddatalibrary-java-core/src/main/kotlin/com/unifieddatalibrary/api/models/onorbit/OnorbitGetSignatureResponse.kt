...
class OnorbitGetSignatureResponse private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("eoObservation") @ExcludeMissing eoObservation: JsonField<EoObservationAbridged> = JsonMissing.of(),
        @JsonProperty("radarObservation") @ExcludeMissing radarObservation: JsonField<RadarObservation> = JsonMissing.of(),
        @JsonProperty("rfObservation") @ExcludeMissing rfObservation: JsonField<RfObservation> = JsonMissing.of()
    ) : this(
      eoObservation,
      radarObservation,
      rfObservation,
     ...
     */
    fun eoObservation(): Optional<EoObservationAbridged> = eoObservation.getOptional("eoObservation")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun radarObservation(): Optional<RadarObservation> = radarObservation.getOptional("radarObservation")
     ...
     *
     * Unlike [radarObservation], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitGetSignatureResponse: OnorbitGetSignatureResponse) =
            apply {
        ...
        /** Model representation of observation data for electro-optical based sensor phenomenologies. ECI J2K is the preferred reference frame for EOObservations, however, several user-specified reference frames are accommodated. Users should check the EOObservation record as well as the 'Discover' tab in the storefront to confirm the coordinate frames used by the data provider. */
        fun eoObservation(eoObservation: EoObservationAbridged) = eoObservation(JsonField.of(eoObservation))

        /**
         * Sets [Builder.eoObservation] to an arbitrary JSON value.
         *
         * You should usually call [Builder.eoObservation] with a well-typed [EoObservationAbridged] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eoObservation(eoObservation: JsonField<EoObservationAbridged>) =
            apply {
                this.eoObservation = eoObservation
            }

        /** Model representation of observation data for radar based sensor phenomenologies. J2000 is the preferred coordinate frame for all observations, but in some cases observations may be in another frame depending on the provider. Please see the 'Discover' tab in the storefront to confirm coordinate frames by data provider. */
        fun radarObservation(radarObservation: RadarObservation) = radarObservation(JsonField.of(radarObservation))

        /**
         * Sets [Builder.radarObservation] to an arbitrary JSON value.
         *
         * You should usually call [Builder.radarObservation] with a well-typed [RadarObservation] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun radarObservation(radarObservation: JsonField<RadarObservation>) =
            apply {
         ...
         *
         * You should usually call [Builder.rfObservation] with a well-typed [RfObservation] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rfObservation(rfObservation: JsonField<RfObservation>) =
            apply {
    ...
    fun validate(): OnorbitGetSignatureResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (eoObservation.asKnown().getOrNull()?.validity() ?: 0) + (radarObservation.asKnown().getOrNull()?.validity() ?: 0) + (rfObservation.asKnown().getOrNull()?.validity() ?: 0)

    /** Model representation of observation data for radar based sensor phenomenologies. J2000 is the preferred coordinate frame for all observations, but in some cases observations may be in another frame depending on the provider. Please see the 'Discover' tab in the storefront to confirm coordinate frames by data provider. */
    class RadarObservation private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(radarObservation: RadarObservation) =
                apply {
    ...
    class RfObservation private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(rfObservation: RfObservation) =
                apply {
    ...
    override fun toString() = "OnorbitGetSignatureResponse{eoObservation=$eoObservation, radarObservation=$radarObservation, rfObservation=$rfObservation, additionalProperties=$additionalProperties}"
}
