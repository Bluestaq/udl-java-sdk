...
class EngineDetailsAbridged private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineDetailsAbridged: EngineDetailsAbridged) =
            apply {
    ...
    fun validate(): EngineDetailsAbridged =
        apply {
            if (validated) {
              return@apply
            }
