...
/**
 * Service operation to take multiple dropzone records as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class DropzoneUnvalidatedPublishParams
private constructor(
        ...
        internal fun from(dropzoneUnvalidatedPublishParams: DropzoneUnvalidatedPublishParams) =
            apply {
                ...
                additionalQueryParams =
                    dropzoneUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DropzoneUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "DropzoneUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
