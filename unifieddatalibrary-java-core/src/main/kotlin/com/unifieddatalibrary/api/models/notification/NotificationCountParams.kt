...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NotificationCountParams].
         *
    ...
    /** A builder for [NotificationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(notificationCountParams: NotificationCountParams) = apply {
            createdAt = notificationCountParams.createdAt
            firstResult = notificationCountParams.firstResult
            maxResults = notificationCountParams.maxResults
            additionalHeaders = notificationCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = notificationCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NotificationCountParams].
         *
         ...
         */
        fun build(): NotificationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NotificationCountParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "NotificationCountParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
