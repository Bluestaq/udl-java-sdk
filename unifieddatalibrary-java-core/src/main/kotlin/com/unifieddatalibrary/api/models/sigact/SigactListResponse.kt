...
class SigactListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("relatedDocs") @ExcludeMissing relatedDocs: JsonField<List<RelatedDoc>> = JsonMissing.of(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SigactListResponse].
         *
    ...
    /** A builder for [SigactListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sigactListResponse: SigactListResponse) =
            apply {
                classificationMarking = sigactListResponse.classificationMarking
                dataMode = sigactListResponse.dataMode
                reportDate = sigactListResponse.reportDate
                source = sigactListResponse.source
                id = sigactListResponse.id
                accuracy = sigactListResponse.accuracy
                actors = sigactListResponse.actors.map { it.toMutableList() }
                agjson = sigactListResponse.agjson
                andims = sigactListResponse.andims
                asrid = sigactListResponse.asrid
                atext = sigactListResponse.atext
                atype = sigactListResponse.atype
                avgTone = sigactListResponse.avgTone
                cameoBaseCode = sigactListResponse.cameoBaseCode
                cameoCode = sigactListResponse.cameoCode
                cameoRootCode = sigactListResponse.cameoRootCode
                checksumValue = sigactListResponse.checksumValue
                city = sigactListResponse.city
                civAbd = sigactListResponse.civAbd
                civDet = sigactListResponse.civDet
                civKia = sigactListResponse.civKia
                civWound = sigactListResponse.civWound
                clarity = sigactListResponse.clarity
                coalAbd = sigactListResponse.coalAbd
                coalDet = sigactListResponse.coalDet
                coalKia = sigactListResponse.coalKia
                coalWound = sigactListResponse.coalWound
                complexAttack = sigactListResponse.complexAttack
                confidence = sigactListResponse.confidence
                countryCode = sigactListResponse.countryCode
                createdAt = sigactListResponse.createdAt
                createdBy = sigactListResponse.createdBy
                district = sigactListResponse.district
                documentFilename = sigactListResponse.documentFilename
                documentSource = sigactListResponse.documentSource
                enemyAbd = sigactListResponse.enemyAbd
                enemyDet = sigactListResponse.enemyDet
                enemyKia = sigactListResponse.enemyKia
                eventDescription = sigactListResponse.eventDescription
                eventEnd = sigactListResponse.eventEnd
                eventStart = sigactListResponse.eventStart
                eventType = sigactListResponse.eventType
                filesize = sigactListResponse.filesize
                friendlyAbd = sigactListResponse.friendlyAbd
                friendlyDet = sigactListResponse.friendlyDet
                friendlyKia = sigactListResponse.friendlyKia
                friendlyWound = sigactListResponse.friendlyWound
                goldstein = sigactListResponse.goldstein
                hasAttachment = sigactListResponse.hasAttachment
                hostNatAbd = sigactListResponse.hostNatAbd
                hostNatDet = sigactListResponse.hostNatDet
                hostNatKia = sigactListResponse.hostNatKia
                hostNatWound = sigactListResponse.hostNatWound
                idNumber = sigactListResponse.idNumber
                lat = sigactListResponse.lat
                lon = sigactListResponse.lon
                milgrid = sigactListResponse.milgrid
                notes = sigactListResponse.notes
                numArticles = sigactListResponse.numArticles
                numMentions = sigactListResponse.numMentions
                numSources = sigactListResponse.numSources
                origin = sigactListResponse.origin
                origNetwork = sigactListResponse.origNetwork
                province = sigactListResponse.province
                relatedDocs = sigactListResponse.relatedDocs.map { it.toMutableList() }
                repUnit = sigactListResponse.repUnit
                repUnitActivity = sigactListResponse.repUnitActivity
                repUnitType = sigactListResponse.repUnitType
                sideAAbd = sigactListResponse.sideAAbd
                sideADet = sigactListResponse.sideADet
                sideAkia = sigactListResponse.sideAkia
                sideAWound = sigactListResponse.sideAWound
                sideBAbd = sigactListResponse.sideBAbd
                sideBDet = sigactListResponse.sideBDet
                sideBkia = sigactListResponse.sideBkia
                sideBWound = sigactListResponse.sideBWound
                sourceLanguage = sigactListResponse.sourceLanguage
                sourceUrl = sigactListResponse.sourceUrl
                summary = sigactListResponse.summary
                target = sigactListResponse.target
                theater = sigactListResponse.theater
                typeOfAttack = sigactListResponse.typeOfAttack
                additionalProperties = sigactListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SigactListResponse].
         *
    ...
    fun validate(): SigactListResponse =
        apply {
            if (validated) {
              return@apply
            }
