...
private constructor(
     ...
     * labeling convention. The MGRS is used as geocode for the entire Earth.
     *
     * Example of an milgrid coordinate, or grid reference, would be 4QFJ12345678, which consists of
     * three parts:
     *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SigactListResponse &&
