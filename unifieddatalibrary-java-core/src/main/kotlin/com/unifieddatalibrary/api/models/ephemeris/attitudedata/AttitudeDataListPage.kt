...
class AttitudeDataListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeDataListPage: AttitudeDataListPage) =
            apply {
        ...
        fun service(service: AttitudeDataService) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: AttitudeDataListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<AttitudeDataAbridged>) =
            apply {
                this.items = items
            }
