...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatTupleResponse: RouteStatTupleResponse) = apply {
    ...
    fun validate(): RouteStatTupleResponse = apply {
        if (validated) {
            return@apply
        }
