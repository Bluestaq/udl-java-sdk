...
class ScientificQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ScientificQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ScientificQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificQueryhelpResponse: ScientificQueryhelpResponse) =
            apply {
                aodrSupported = scientificQueryhelpResponse.aodrSupported
                classificationMarking = scientificQueryhelpResponse.classificationMarking
                description = scientificQueryhelpResponse.description
                historySupported = scientificQueryhelpResponse.historySupported
                name = scientificQueryhelpResponse.name
                parameters = scientificQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = scientificQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = scientificQueryhelpResponse.restSupported
                sortSupported = scientificQueryhelpResponse.sortSupported
                typeName = scientificQueryhelpResponse.typeName
                uri = scientificQueryhelpResponse.uri
                additionalProperties = scientificQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ScientificQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScientificQueryhelpResponse =
    ...
    fun validate(): ScientificQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ScientificQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
