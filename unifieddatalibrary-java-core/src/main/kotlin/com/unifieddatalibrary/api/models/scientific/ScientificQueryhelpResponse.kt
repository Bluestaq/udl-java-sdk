...
class ScientificQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificQueryhelpResponse: ScientificQueryhelpResponse) = apply {
    ...
    fun validate(): ScientificQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
