...
class EoObservationRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EoObservationRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationRetrieveParams: EoObservationRetrieveParams) = apply {
    ...
    override fun toString() =
        "EoObservationRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
