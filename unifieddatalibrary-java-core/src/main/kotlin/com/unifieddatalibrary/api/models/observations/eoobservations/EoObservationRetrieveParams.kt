...
class EoObservationRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EoObservationRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EoObservationRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EoObservationRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationRetrieveParams: EoObservationRetrieveParams) =
            apply {
                id = eoObservationRetrieveParams.id
                firstResult = eoObservationRetrieveParams.firstResult
                maxResults = eoObservationRetrieveParams.maxResults
                additionalHeaders = eoObservationRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = eoObservationRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EoObservationRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EoObservationRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EoObservationRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EoObservationRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
