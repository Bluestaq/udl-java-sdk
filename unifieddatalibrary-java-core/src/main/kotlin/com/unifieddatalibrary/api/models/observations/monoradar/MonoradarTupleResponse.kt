...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarTupleResponse: MonoradarTupleResponse) = apply {
    ...
    fun validate(): MonoradarTupleResponse = apply {
        if (validated) {
            return@apply
        }
