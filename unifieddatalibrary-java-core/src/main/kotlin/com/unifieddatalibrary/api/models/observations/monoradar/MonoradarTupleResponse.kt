...
class MonoradarTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MonoradarTupleResponse].
         *
    ...
    /** A builder for [MonoradarTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarTupleResponse: MonoradarTupleResponse) =
            apply {
                classificationMarking = monoradarTupleResponse.classificationMarking
                dataMode = monoradarTupleResponse.dataMode
                msgfmt = monoradarTupleResponse.msgfmt
                msgts = monoradarTupleResponse.msgts
                msgtyp = monoradarTupleResponse.msgtyp
                source = monoradarTupleResponse.source
                ts = monoradarTupleResponse.ts
                id = monoradarTupleResponse.id
                acp = monoradarTupleResponse.acp
                addr = monoradarTupleResponse.addr
                af = monoradarTupleResponse.af
                aims = monoradarTupleResponse.aims
                alt3d = monoradarTupleResponse.alt3d
                artsqual = monoradarTupleResponse.artsqual
                az = monoradarTupleResponse.az
                azdelt = monoradarTupleResponse.azdelt
                bcnhits = monoradarTupleResponse.bcnhits
                cartpos = monoradarTupleResponse.cartpos.map { it.toMutableList() }
                cdm = monoradarTupleResponse.cdm
                code7500 = monoradarTupleResponse.code7500
                code7600 = monoradarTupleResponse.code7600
                code7700 = monoradarTupleResponse.code7700
                createdAt = monoradarTupleResponse.createdAt
                createdBy = monoradarTupleResponse.createdBy
                faa = monoradarTupleResponse.faa
                grndspd = monoradarTupleResponse.grndspd
                hdng = monoradarTupleResponse.hdng
                idSensor = monoradarTupleResponse.idSensor
                m1 = monoradarTupleResponse.m1
                m1g = monoradarTupleResponse.m1g
                m1v = monoradarTupleResponse.m1v
                m2 = monoradarTupleResponse.m2
                m2g = monoradarTupleResponse.m2g
                m2v = monoradarTupleResponse.m2v
                m2xv = monoradarTupleResponse.m2xv
                m3a = monoradarTupleResponse.m3a
                m3ag = monoradarTupleResponse.m3ag
                m3av = monoradarTupleResponse.m3av
                m3axv = monoradarTupleResponse.m3axv
                m4 = monoradarTupleResponse.m4
                m4d1d2 = monoradarTupleResponse.m4d1d2
                m4v = monoradarTupleResponse.m4v
                mah = monoradarTupleResponse.mah
                mc = monoradarTupleResponse.mc
                mcg = monoradarTupleResponse.mcg
                mcv = monoradarTupleResponse.mcv
                milemrgcy = monoradarTupleResponse.milemrgcy
                mrgrpt = monoradarTupleResponse.mrgrpt
                mscommb = monoradarTupleResponse.mscommb
                mti = monoradarTupleResponse.mti
                origin = monoradarTupleResponse.origin
                origNetwork = monoradarTupleResponse.origNetwork
                origSensorId = monoradarTupleResponse.origSensorId
                psrrl = monoradarTupleResponse.psrrl
                rad = monoradarTupleResponse.rad
                rng = monoradarTupleResponse.rng
                rngdelt = monoradarTupleResponse.rngdelt
                sac = monoradarTupleResponse.sac
                senalt = monoradarTupleResponse.senalt
                senlat = monoradarTupleResponse.senlat
                senlon = monoradarTupleResponse.senlon
                sic = monoradarTupleResponse.sic
                spi = monoradarTupleResponse.spi
                ssrl = monoradarTupleResponse.ssrl
                tags = monoradarTupleResponse.tags.map { it.toMutableList() }
                tgtconf = monoradarTupleResponse.tgtconf
                tgtcorr = monoradarTupleResponse.tgtcorr
                tgtid = monoradarTupleResponse.tgtid
                tis = monoradarTupleResponse.tis
                trkelig = monoradarTupleResponse.trkelig
                trknum = monoradarTupleResponse.trknum
                tti = monoradarTupleResponse.tti
                wectc = monoradarTupleResponse.wectc.map { it.toMutableList() }
                additionalProperties = monoradarTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MonoradarTupleResponse].
         *
         ...
         */
        fun build(): MonoradarTupleResponse =
    ...
    fun validate(): MonoradarTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
