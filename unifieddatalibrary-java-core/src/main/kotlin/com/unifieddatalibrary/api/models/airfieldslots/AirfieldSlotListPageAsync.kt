...
class AirfieldSlotListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<AirfieldSlotListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotListPageAsync: AirfieldSlotListPageAsync) =
            apply {
        ...
        fun service(service: AirfieldSlotServiceAsync) =
            apply {
    ...
    override fun toString() = "AirfieldSlotListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
