...
class OperatingunitQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OperatingunitQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OperatingunitQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitQueryhelpResponse: OperatingunitQueryhelpResponse) =
            apply {
                aodrSupported = operatingunitQueryhelpResponse.aodrSupported
                classificationMarking = operatingunitQueryhelpResponse.classificationMarking
                description = operatingunitQueryhelpResponse.description
                historySupported = operatingunitQueryhelpResponse.historySupported
                name = operatingunitQueryhelpResponse.name
                parameters = operatingunitQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = operatingunitQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = operatingunitQueryhelpResponse.restSupported
                sortSupported = operatingunitQueryhelpResponse.sortSupported
                typeName = operatingunitQueryhelpResponse.typeName
                uri = operatingunitQueryhelpResponse.uri
                additionalProperties = operatingunitQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OperatingunitQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OperatingunitQueryhelpResponse =
    ...
    fun validate(): OperatingunitQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
