...
class OperatingunitQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitQueryhelpResponse: OperatingunitQueryhelpResponse) = apply {
            ...
            additionalProperties =
                operatingunitQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): OperatingunitQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
