 ...
 */
class CloselyspacedobjectTupleParams
private constructor(
    ...
    /** A builder for [CloselyspacedobjectTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(closelyspacedobjectTupleParams: CloselyspacedobjectTupleParams) = apply {
            columns = closelyspacedobjectTupleParams.columns
            eventStartTime = closelyspacedobjectTupleParams.eventStartTime
            firstResult = closelyspacedobjectTupleParams.firstResult
            maxResults = closelyspacedobjectTupleParams.maxResults
            additionalHeaders = closelyspacedobjectTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = closelyspacedobjectTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CloselyspacedobjectTupleParams].
         *
         ...
         */
        fun build(): CloselyspacedobjectTupleParams =
            CloselyspacedobjectTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloselyspacedobjectTupleParams &&
    ...
    override fun toString() =
        "CloselyspacedobjectTupleParams{columns=$columns, eventStartTime=$eventStartTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
