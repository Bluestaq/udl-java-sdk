...
class OperationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperationCountParams].
         *
    ...
    /** A builder for [OperationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationCountParams: OperationCountParams) =
            apply {
                idSite = operationCountParams.idSite
                firstResult = operationCountParams.firstResult
                maxResults = operationCountParams.maxResults
                additionalHeaders = operationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = operationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OperationCountParams].
         *
         ...
         */
        fun build(): OperationCountParams =
    ...
    override fun toString() = "OperationCountParams{idSite=$idSite, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
