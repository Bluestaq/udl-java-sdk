...
class VesselGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): VesselGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [VesselGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [VesselGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselGetParams: VesselGetParams) =
            apply {
                id = vesselGetParams.id
                firstResult = vesselGetParams.firstResult
                maxResults = vesselGetParams.maxResults
                additionalHeaders = vesselGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = vesselGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [VesselGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VesselGetParams =
            VesselGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is VesselGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "VesselGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
