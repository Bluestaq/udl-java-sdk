...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VesselGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselGetParams: VesselGetParams) = apply {
    ...
    override fun toString() =
        "VesselGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
