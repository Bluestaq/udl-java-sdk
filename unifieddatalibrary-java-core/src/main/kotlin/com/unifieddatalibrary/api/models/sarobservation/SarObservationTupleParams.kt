...
class SarObservationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SarObservationTupleParams].
         *
    ...
    /** A builder for [SarObservationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationTupleParams: SarObservationTupleParams) =
            apply {
                collectionStart = sarObservationTupleParams.collectionStart
                columns = sarObservationTupleParams.columns
                firstResult = sarObservationTupleParams.firstResult
                maxResults = sarObservationTupleParams.maxResults
                additionalHeaders = sarObservationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = sarObservationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SarObservationTupleParams].
         *
         ...
         */
        fun build(): SarObservationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SarObservationTupleParams && collectionStart == other.collectionStart && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SarObservationTupleParams{collectionStart=$collectionStart, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
