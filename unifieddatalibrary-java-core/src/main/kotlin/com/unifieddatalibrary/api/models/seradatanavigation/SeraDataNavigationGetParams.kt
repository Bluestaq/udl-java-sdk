 ...
 */
class SeraDataNavigationGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeraDataNavigationGetParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [SeraDataNavigationGetParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SeraDataNavigationGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataNavigationGetParams: SeraDataNavigationGetParams) = apply {
            id = seraDataNavigationGetParams.id
            firstResult = seraDataNavigationGetParams.firstResult
            maxResults = seraDataNavigationGetParams.maxResults
            additionalHeaders = seraDataNavigationGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = seraDataNavigationGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataNavigationGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeraDataNavigationGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeraDataNavigationGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeraDataNavigationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
