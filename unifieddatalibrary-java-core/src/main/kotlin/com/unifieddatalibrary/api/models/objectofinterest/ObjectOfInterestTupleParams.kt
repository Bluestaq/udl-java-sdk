...
class ObjectOfInterestTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObjectOfInterestTupleParams].
         *
    ...
    /** A builder for [ObjectOfInterestTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectOfInterestTupleParams: ObjectOfInterestTupleParams) =
            apply {
                columns = objectOfInterestTupleParams.columns
                firstResult = objectOfInterestTupleParams.firstResult
                maxResults = objectOfInterestTupleParams.maxResults
                additionalHeaders = objectOfInterestTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = objectOfInterestTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ObjectOfInterestTupleParams].
         *
         ...
         */
        fun build(): ObjectOfInterestTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ObjectOfInterestTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ObjectOfInterestTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
