...
class QueryHelpRetrieveResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [QueryHelpRetrieveResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [QueryHelpRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(queryHelpRetrieveResponse: QueryHelpRetrieveResponse) = apply {
            aodrSupported = queryHelpRetrieveResponse.aodrSupported
            classificationMarking = queryHelpRetrieveResponse.classificationMarking
            description = queryHelpRetrieveResponse.description
            historySupported = queryHelpRetrieveResponse.historySupported
            name = queryHelpRetrieveResponse.name
            parameters = queryHelpRetrieveResponse.parameters.map { it.toMutableList() }
            requiredRoles = queryHelpRetrieveResponse.requiredRoles.map { it.toMutableList() }
            restSupported = queryHelpRetrieveResponse.restSupported
            sortSupported = queryHelpRetrieveResponse.sortSupported
            typeName = queryHelpRetrieveResponse.typeName
            uri = queryHelpRetrieveResponse.uri
            additionalProperties = queryHelpRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [QueryHelpRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): QueryHelpRetrieveResponse =
    ...
    fun validate(): QueryHelpRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is QueryHelpRetrieveResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
