...
class SoiObservationSetQueryhelpResponse
private constructor(
    ...
    /** A builder for [SoiObservationSetQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(soiObservationSetQueryhelpResponse: SoiObservationSetQueryhelpResponse) =
            apply {
                aodrSupported = soiObservationSetQueryhelpResponse.aodrSupported
                classificationMarking = soiObservationSetQueryhelpResponse.classificationMarking
                description = soiObservationSetQueryhelpResponse.description
                historySupported = soiObservationSetQueryhelpResponse.historySupported
                name = soiObservationSetQueryhelpResponse.name
                parameters =
                    soiObservationSetQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    soiObservationSetQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = soiObservationSetQueryhelpResponse.restSupported
                sortSupported = soiObservationSetQueryhelpResponse.sortSupported
                typeName = soiObservationSetQueryhelpResponse.typeName
                uri = soiObservationSetQueryhelpResponse.uri
                additionalProperties =
                    soiObservationSetQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SoiObservationSetQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SoiObservationSetQueryhelpResponse =
            SoiObservationSetQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): SoiObservationSetQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SoiObservationSetQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
