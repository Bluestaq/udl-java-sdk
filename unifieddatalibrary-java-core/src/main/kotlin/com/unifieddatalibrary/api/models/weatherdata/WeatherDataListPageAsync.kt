...
class WeatherDataListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<WeatherDataListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataListPageAsync: WeatherDataListPageAsync) = apply {
        ...
        fun service(service: WeatherDataServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: WeatherDataListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<WeatherDataListResponse>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WeatherDataListPageAsync &&
    ...
    override fun toString() =
        "WeatherDataListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
