...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaseremitterListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LaseremitterListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LaseremitterListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laseremitterListParams: LaseremitterListParams) = apply {
            firstResult = laseremitterListParams.firstResult
            maxResults = laseremitterListParams.maxResults
            additionalHeaders = laseremitterListParams.additionalHeaders.toBuilder()
            additionalQueryParams = laseremitterListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaseremitterListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaseremitterListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaseremitterListParams &&
    ...
    override fun toString() =
        "LaseremitterListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
