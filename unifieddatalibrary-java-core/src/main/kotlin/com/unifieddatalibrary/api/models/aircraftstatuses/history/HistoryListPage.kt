...
class HistoryListPage private constructor(
    ...
    private val items: List<AircraftstatusFull>,

) : Page<AircraftstatusFull> {
    ...
    fun autoPager(): AutoPager<AircraftstatusFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<AircraftstatusFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<AircraftstatusFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<AircraftstatusFull>) =
            apply {
                this.items = items
            }
