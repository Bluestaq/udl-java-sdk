...
class LogisticsSupportCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LogisticsSupportCreateBulkParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(logisticsSupportCreateBulkParams: LogisticsSupportCreateBulkParams) =
            apply {
                ...
                additionalQueryParams = logisticsSupportCreateBulkParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LogisticsSupportCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "LogisticsSupportCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
