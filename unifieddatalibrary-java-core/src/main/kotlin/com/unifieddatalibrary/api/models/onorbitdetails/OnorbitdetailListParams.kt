...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitdetailListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitdetailListParams: OnorbitdetailListParams) = apply {
    ...
    override fun toString() =
        "OnorbitdetailListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
