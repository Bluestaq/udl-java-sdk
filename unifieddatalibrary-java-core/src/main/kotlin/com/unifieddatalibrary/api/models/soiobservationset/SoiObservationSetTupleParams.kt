 ...
 */
class SoiObservationSetTupleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SoiObservationSetTupleParams].
         *
    ...
    /** A builder for [SoiObservationSetTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(soiObservationSetTupleParams: SoiObservationSetTupleParams) = apply {
            columns = soiObservationSetTupleParams.columns
            startTime = soiObservationSetTupleParams.startTime
            firstResult = soiObservationSetTupleParams.firstResult
            maxResults = soiObservationSetTupleParams.maxResults
            additionalHeaders = soiObservationSetTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = soiObservationSetTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SoiObservationSetTupleParams].
         *
         ...
         */
        fun build(): SoiObservationSetTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SoiObservationSetTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SoiObservationSetTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
