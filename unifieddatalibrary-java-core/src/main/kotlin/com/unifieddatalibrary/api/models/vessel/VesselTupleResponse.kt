...
class VesselTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("altVesselId") @ExcludeMissing altVesselId: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("firstSeen") @ExcludeMissing firstSeen: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("maxDraught") @ExcludeMissing maxDraught: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("vesselBuilder") @ExcludeMissing vesselBuilder: JsonField<String> = JsonMissing.of(),
        @JsonProperty("vesselClass") @ExcludeMissing vesselClass: JsonField<String> = JsonMissing.of(),
        @JsonProperty("vesselDescription") @ExcludeMissing vesselDescription: JsonField<String> = JsonMissing.of(),
        @JsonProperty("vesselFlag") @ExcludeMissing vesselFlag: JsonField<String> = JsonMissing.of(),
        @JsonProperty("vesselName") @ExcludeMissing vesselName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("vesselType") @ExcludeMissing vesselType: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("mmsi")
    @ExcludeMissing
    fun _mmsi(): JsonField<String> = mmsi
     ...
     *
     * Unlike [vesselDescription], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _yearBuilt(): JsonField<String> = yearBuilt
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselTupleResponse: VesselTupleResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.altVesselId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun altVesselId(altVesselId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.firstSeen] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun firstSeen(firstSeen: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.maxDraught] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maxDraught(maxDraught: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.mmsi] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mmsi(mmsi: JsonField<String>) =
            apply {
                this.mmsi = mmsi
            }
         ...
         *
         * You should usually call [Builder.vesselBuilder] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vesselBuilder(vesselBuilder: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.vesselClass] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vesselClass(vesselClass: JsonField<String>) =
            apply {
                this.vesselClass = vesselClass
            }

        /** Further description or explanation of the vessel or type. */
        fun vesselDescription(vesselDescription: String) = vesselDescription(JsonField.of(vesselDescription))

        /**
         * Sets [Builder.vesselDescription] to an arbitrary JSON value.
         *
         * You should usually call [Builder.vesselDescription] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vesselDescription(vesselDescription: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.vesselName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vesselName(vesselName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.vesselType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vesselType(vesselType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.yearBuilt] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun yearBuilt(yearBuilt: JsonField<String>) =
            apply {
    ...
    fun validate(): VesselTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (altVesselId.asKnown().isPresent) 1 else 0) + (if (callsign.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (entity.asKnown().getOrNull()?.validity() ?: 0) + (if (firstSeen.asKnown().isPresent) 1 else 0) + (if (hullNum.asKnown().isPresent) 1 else 0) + (if (idEntity.asKnown().isPresent) 1 else 0) + (if (idOrganization.asKnown().isPresent) 1 else 0) + (if (imon.asKnown().isPresent) 1 else 0) + (if (length.asKnown().isPresent) 1 else 0) + (if (maxDraught.asKnown().isPresent) 1 else 0) + (if (maxSpeed.asKnown().isPresent) 1 else 0) + (if (mmsi.asKnown().isPresent) 1 else 0) + (if (numBlades.asKnown().isPresent) 1 else 0) + (if (numShafts.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (propType.asKnown().isPresent) 1 else 0) + (if (sconum.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (status.asKnown().isPresent) 1 else 0) + (if (sternType.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (if (vesselBuilder.asKnown().isPresent) 1 else 0) + (if (vesselClass.asKnown().isPresent) 1 else 0) + (if (vesselDescription.asKnown().isPresent) 1 else 0) + (if (vesselFlag.asKnown().isPresent) 1 else 0) + (if (vesselName.asKnown().isPresent) 1 else 0) + (if (vesselType.asKnown().isPresent) 1 else 0) + (if (vslWt.asKnown().isPresent) 1 else 0) + (if (width.asKnown().isPresent) 1 else 0) + (if (yearBuilt.asKnown().isPresent) 1 else 0)
