...
class GeoStatusListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GeoStatusListParams].
         *
    ...
    /** A builder for [GeoStatusListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusListParams: GeoStatusListParams) =
            apply {
                createdAt = geoStatusListParams.createdAt
                firstResult = geoStatusListParams.firstResult
                maxResults = geoStatusListParams.maxResults
                additionalHeaders = geoStatusListParams.additionalHeaders.toBuilder()
                additionalQueryParams = geoStatusListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GeoStatusListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GeoStatusListParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "GeoStatusListParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
