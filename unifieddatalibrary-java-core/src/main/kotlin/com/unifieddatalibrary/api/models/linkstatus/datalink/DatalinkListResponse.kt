...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatalinkListResponse].
         *
    ...
    /** A builder for [DatalinkListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datalinkListResponse: DatalinkListResponse) = apply {
            classificationMarking = datalinkListResponse.classificationMarking
            dataMode = datalinkListResponse.dataMode
            opExName = datalinkListResponse.opExName
            originator = datalinkListResponse.originator
            source = datalinkListResponse.source
            startTime = datalinkListResponse.startTime
            id = datalinkListResponse.id
            ackInstUnits = datalinkListResponse.ackInstUnits.map { it.toMutableList() }
            ackReq = datalinkListResponse.ackReq
            altDiff = datalinkListResponse.altDiff
            canxId = datalinkListResponse.canxId
            canxOriginator = datalinkListResponse.canxOriginator
            canxSerialNum = datalinkListResponse.canxSerialNum
            canxSiCs = datalinkListResponse.canxSiCs.map { it.toMutableList() }
            canxSpecialNotation = datalinkListResponse.canxSpecialNotation
            canxTs = datalinkListResponse.canxTs
            classReasons = datalinkListResponse.classReasons.map { it.toMutableList() }
            classSource = datalinkListResponse.classSource
            consecDecorr = datalinkListResponse.consecDecorr
            courseDiff = datalinkListResponse.courseDiff
            createdAt = datalinkListResponse.createdAt
            createdBy = datalinkListResponse.createdBy
            decExemptCodes = datalinkListResponse.decExemptCodes.map { it.toMutableList() }
            decInstDates = datalinkListResponse.decInstDates.map { it.toMutableList() }
            decorrWinMult = datalinkListResponse.decorrWinMult
            geoDatum = datalinkListResponse.geoDatum
            jreCallSign = datalinkListResponse.jreCallSign
            jreDetails = datalinkListResponse.jreDetails
            jrePriAdd = datalinkListResponse.jrePriAdd
            jreSecAdd = datalinkListResponse.jreSecAdd
            jreUnitDes = datalinkListResponse.jreUnitDes
            maxGeoPosQual = datalinkListResponse.maxGeoPosQual
            maxTrackQual = datalinkListResponse.maxTrackQual
            mgmtCode = datalinkListResponse.mgmtCode
            mgmtCodeMeaning = datalinkListResponse.mgmtCodeMeaning
            minGeoPosQual = datalinkListResponse.minGeoPosQual
            minTrackQual = datalinkListResponse.minTrackQual
            month = datalinkListResponse.month
            multiDuty = datalinkListResponse.multiDuty.map { it.toMutableList() }
            nonLinkUnitDes = datalinkListResponse.nonLinkUnitDes.map { it.toMutableList() }
            opExInfo = datalinkListResponse.opExInfo
            opExInfoAlt = datalinkListResponse.opExInfoAlt
            ops = datalinkListResponse.ops.map { it.toMutableList() }
            origin = datalinkListResponse.origin
            origNetwork = datalinkListResponse.origNetwork
            planOrigNum = datalinkListResponse.planOrigNum
            pocCallSign = datalinkListResponse.pocCallSign
            pocLat = datalinkListResponse.pocLat
            pocLocName = datalinkListResponse.pocLocName
            pocLon = datalinkListResponse.pocLon
            pocName = datalinkListResponse.pocName
            pocNums = datalinkListResponse.pocNums.map { it.toMutableList() }
            ...
            resTrackQual = datalinkListResponse.resTrackQual
            serialNum = datalinkListResponse.serialNum
            sourceDl = datalinkListResponse.sourceDl
            specTracks = datalinkListResponse.specTracks.map { it.toMutableList() }
            speedDiff = datalinkListResponse.speedDiff
            stopTime = datalinkListResponse.stopTime
            stopTimeMod = datalinkListResponse.stopTimeMod
            sysDefaultCode = datalinkListResponse.sysDefaultCode
            trackNumBlockLLs = datalinkListResponse.trackNumBlockLLs.map { it.toMutableList() }
            trackNumBlocks = datalinkListResponse.trackNumBlocks.map { it.toMutableList() }
            updatedAt = datalinkListResponse.updatedAt
            updatedBy = datalinkListResponse.updatedBy
            voiceCoord = datalinkListResponse.voiceCoord.map { it.toMutableList() }
            winSizeMin = datalinkListResponse.winSizeMin
            winSizeMult = datalinkListResponse.winSizeMult
            additionalProperties = datalinkListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DatalinkListResponse].
         *
         ...
         */
        fun build(): DatalinkListResponse =
    ...
    fun validate(): DatalinkListResponse = apply {
        if (validated) {
            return@apply
        }
