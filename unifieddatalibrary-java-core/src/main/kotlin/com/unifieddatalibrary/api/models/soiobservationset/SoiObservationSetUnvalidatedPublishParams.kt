...
/**
 * Service operation to take multiple SOIObservationSet records as a POST body and ingest into the
 ...
 */
class SoiObservationSetUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [SoiObservationSetUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            soiObservationSetUnvalidatedPublishParams: SoiObservationSetUnvalidatedPublishParams
        ) = apply {
            body = soiObservationSetUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                soiObservationSetUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                soiObservationSetUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SoiObservationSetUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): SoiObservationSetUnvalidatedPublishParams =
            SoiObservationSetUnvalidatedPublishParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SoiObservationSetUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SoiObservationSetUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
