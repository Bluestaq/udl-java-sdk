...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SwirTupleParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(swirTupleParams: SwirTupleParams) = apply {
            columns = swirTupleParams.columns
            ts = swirTupleParams.ts
            firstResult = swirTupleParams.firstResult
            maxResults = swirTupleParams.maxResults
            additionalHeaders = swirTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = swirTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SwirTupleParams].
         *
