...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): HazardGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardGetParams: HazardGetParams) = apply {
    ...
    override fun toString() =
        "HazardGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
