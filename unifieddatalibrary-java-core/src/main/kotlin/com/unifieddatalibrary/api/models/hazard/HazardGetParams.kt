...
class HazardGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): HazardGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [HazardGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [HazardGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardGetParams: HazardGetParams) =
            apply {
                id = hazardGetParams.id
                firstResult = hazardGetParams.firstResult
                maxResults = hazardGetParams.maxResults
                additionalHeaders = hazardGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = hazardGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [HazardGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HazardGetParams =
            HazardGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is HazardGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "HazardGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
