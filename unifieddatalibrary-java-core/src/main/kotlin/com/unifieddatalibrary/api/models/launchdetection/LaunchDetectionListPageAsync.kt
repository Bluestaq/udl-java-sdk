...
class LaunchDetectionListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<LaunchDetectionListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionListPageAsync: LaunchDetectionListPageAsync) =
            apply {
        ...
        fun service(service: LaunchDetectionServiceAsync) =
            apply {
    ...
    override fun toString() = "LaunchDetectionListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
