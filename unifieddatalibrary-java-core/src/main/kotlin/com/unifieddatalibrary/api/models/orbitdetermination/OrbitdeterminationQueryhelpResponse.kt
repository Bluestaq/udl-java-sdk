...
class OrbitdeterminationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OrbitdeterminationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OrbitdeterminationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationQueryhelpResponse: OrbitdeterminationQueryhelpResponse) =
            apply {
                aodrSupported = orbitdeterminationQueryhelpResponse.aodrSupported
                classificationMarking = orbitdeterminationQueryhelpResponse.classificationMarking
                description = orbitdeterminationQueryhelpResponse.description
                historySupported = orbitdeterminationQueryhelpResponse.historySupported
                name = orbitdeterminationQueryhelpResponse.name
                parameters = orbitdeterminationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = orbitdeterminationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = orbitdeterminationQueryhelpResponse.restSupported
                sortSupported = orbitdeterminationQueryhelpResponse.sortSupported
                typeName = orbitdeterminationQueryhelpResponse.typeName
                uri = orbitdeterminationQueryhelpResponse.uri
                additionalProperties = orbitdeterminationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OrbitdeterminationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OrbitdeterminationQueryhelpResponse =
    ...
    fun validate(): OrbitdeterminationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbitdeterminationQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
