...
class OrbitdeterminationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            orbitdeterminationQueryhelpResponse: OrbitdeterminationQueryhelpResponse
        ) = apply {
            ...
            requiredRoles =
                orbitdeterminationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                orbitdeterminationQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): OrbitdeterminationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
