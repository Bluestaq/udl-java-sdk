...
private constructor(
     ...
     * type.
     */
    fun _operationalDeviations(): JsonField<List<OperationalDeviation>> =
        body._operationalDeviations()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperationCreateParams].
         *
    ...
    /** A builder for [OperationCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationCreateParams: OperationCreateParams) = apply {
            body = operationCreateParams.body.toBuilder()
            additionalHeaders = operationCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = operationCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * week.
         */
        fun dailyOperations(dailyOperations: List<DailyOperation>) = apply {
         ...
         * collection.
         */
        fun dopsLastChangedBy(dopsLastChangedBy: String) = apply {
         ...
         * ISO 8601 UTC format with millisecond precision.
         */
        fun dopsLastChangedDate(dopsLastChangedDate: OffsetDateTime) = apply {
        ...
        /** The reason for the most recent change to data in the dailyOperations collection. */
        fun dopsLastChangedReason(dopsLastChangedReason: String) = apply {
         ...
         */
        fun maximumOnGrounds(maximumOnGrounds: List<MaximumOnGround>) = apply {
         ...
         * collection.
         */
        fun mogsLastChangedBy(mogsLastChangedBy: String) = apply {
         ...
         */
        fun mogsLastChangedDate(mogsLastChangedDate: OffsetDateTime) = apply {
        ...
        /** The reason for the most recent change to data in the MaximumOnGrounds collection. */
        fun mogsLastChangedReason(mogsLastChangedReason: String) = apply {
         ...
         * operations.
         */
        fun operationalDeviations(operationalDeviations: List<OperationalDeviation>) = apply {
        ...
        /** Collection of planning information associated with this SiteOperations record. */
        fun operationalPlannings(operationalPlannings: List<OperationalPlanning>) = apply {
         ...
         * record.
         */
        fun pathways(pathways: List<Pathway>) = apply { body.pathways(pathways) }
         ...
         * supported value.
         */
        fun pathways(pathways: JsonField<List<Pathway>>) = apply { body.pathways(pathways) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPathway(pathway: Pathway) = apply { body.addPathway(pathway) }
         ...
         * with this record.
         */
        fun waivers(waivers: List<Waiver>) = apply { body.waivers(waivers) }
         ...
         * value.
         */
        fun waivers(waivers: JsonField<List<Waiver>>) = apply { body.waivers(waivers) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addWaiver(waiver: Waiver) = apply { body.addWaiver(waiver) }
        ...
        /**
         * Returns an immutable instance of [OperationCreateParams].
         *
         ...
         */
        fun build(): OperationCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OperationCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "OperationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
