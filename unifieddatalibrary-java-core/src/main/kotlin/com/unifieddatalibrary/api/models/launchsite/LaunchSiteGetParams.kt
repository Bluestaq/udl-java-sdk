...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchSiteGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LaunchSiteGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LaunchSiteGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteGetParams: LaunchSiteGetParams) = apply {
            id = launchSiteGetParams.id
            firstResult = launchSiteGetParams.firstResult
            maxResults = launchSiteGetParams.maxResults
            additionalHeaders = launchSiteGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = launchSiteGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchSiteGetParams =
            LaunchSiteGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LaunchSiteGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LaunchSiteGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
