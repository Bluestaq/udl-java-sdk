...
class AirfieldRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AirfieldRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AirfieldRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirfieldRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldRetrieveParams: AirfieldRetrieveParams) =
            apply {
                id = airfieldRetrieveParams.id
                firstResult = airfieldRetrieveParams.firstResult
                maxResults = airfieldRetrieveParams.maxResults
                additionalHeaders = airfieldRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = airfieldRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirfieldRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirfieldRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
