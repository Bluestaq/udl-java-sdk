...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldRetrieveParams: AirfieldRetrieveParams) = apply {
    ...
    override fun toString() =
        "AirfieldRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
