...
class HazardCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HazardCreateBulkParams].
         *
    ...
    /** A builder for [HazardCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardCreateBulkParams: HazardCreateBulkParams) =
            apply {
                body = hazardCreateBulkParams.body.toMutableList()
                additionalHeaders = hazardCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = hazardCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [HazardCreateBulkParams].
         *
         ...
         */
        fun build(): HazardCreateBulkParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("alarmValues") @ExcludeMissing private val alarmValues: JsonField<List<Double>>,
        @JsonProperty("classificationMarking") @ExcludeMissing private val classificationMarking: JsonField<String>,
        @JsonProperty("dataMode") @ExcludeMissing private val dataMode: JsonField<DataMode>,
        @JsonProperty("detectTime") @ExcludeMissing private val detectTime: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("readingUnits") @ExcludeMissing private val readingUnits: JsonField<List<String>>,
        @JsonProperty("readingValues") @ExcludeMissing private val readingValues: JsonField<List<Double>>,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    alarms = body.alarms.map { it.toMutableList() }
                    alarmValues = body.alarmValues.map { it.toMutableList() }
                    classificationMarking = body.classificationMarking
                    dataMode = body.dataMode
                    detectTime = body.detectTime
                    detectType = body.detectType
                    source = body.source
                    id = body.id
                    a = body.a
                    ...
                    ctrnTime = body.ctrnTime
                    density = body.density
                    dep = body.dep
                    depCtrn = body.depCtrn
                    dose = body.dose
                    doseRate = body.doseRate
                    ...
                    massFrac = body.massFrac
                    matCat = body.matCat
                    matClass = body.matClass
                    matName = body.matName
                    matType = body.matType
                    origin = body.origin
                    origNetwork = body.origNetwork
                    ppm = body.ppm
                    radCtrn = body.radCtrn
                    readings = body.readings.map { it.toMutableList() }
    ...
    override fun toString() = "HazardCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
