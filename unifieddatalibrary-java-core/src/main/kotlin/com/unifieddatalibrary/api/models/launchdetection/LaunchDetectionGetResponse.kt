...
class LaunchDetectionGetResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionGetResponse: LaunchDetectionGetResponse) = apply {
    ...
    fun validate(): LaunchDetectionGetResponse = apply {
        if (validated) {
            return@apply
        }
