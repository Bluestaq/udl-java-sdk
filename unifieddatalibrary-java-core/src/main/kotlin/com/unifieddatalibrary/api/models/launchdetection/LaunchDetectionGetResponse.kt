...
class LaunchDetectionGetResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("messageType") @ExcludeMissing messageType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("observationLatitude") @ExcludeMissing observationLatitude: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("observationLongitude") @ExcludeMissing observationLongitude: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("observationTime") @ExcludeMissing observationTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("sequenceNumber") @ExcludeMissing sequenceNumber: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("highZenithAzimuth") @ExcludeMissing highZenithAzimuth: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("inclination") @ExcludeMissing inclination: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("launchAzimuth") @ExcludeMissing launchAzimuth: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("launchLatitude") @ExcludeMissing launchLatitude: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("launchLongitude") @ExcludeMissing launchLongitude: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("launchTime") @ExcludeMissing launchTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("observationAltitude") @ExcludeMissing observationAltitude: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("stereoFlag") @ExcludeMissing stereoFlag: JsonField<Boolean> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun observationAltitude(): Optional<Double> = observationAltitude.getOptional("observationAltitude")
     ...
     *
     * Unlike [observationLatitude], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [observationLongitude], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [highZenithAzimuth], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [observationAltitude], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchDetectionGetResponse].
         *
    ...
    /** A builder for [LaunchDetectionGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionGetResponse: LaunchDetectionGetResponse) =
            apply {
                classificationMarking = launchDetectionGetResponse.classificationMarking
                dataMode = launchDetectionGetResponse.dataMode
                messageType = launchDetectionGetResponse.messageType
                observationLatitude = launchDetectionGetResponse.observationLatitude
                observationLongitude = launchDetectionGetResponse.observationLongitude
                observationTime = launchDetectionGetResponse.observationTime
                sequenceNumber = launchDetectionGetResponse.sequenceNumber
                source = launchDetectionGetResponse.source
                id = launchDetectionGetResponse.id
                createdAt = launchDetectionGetResponse.createdAt
                createdBy = launchDetectionGetResponse.createdBy
                descriptor = launchDetectionGetResponse.descriptor
                eventId = launchDetectionGetResponse.eventId
                highZenithAzimuth = launchDetectionGetResponse.highZenithAzimuth
                inclination = launchDetectionGetResponse.inclination
                launchAzimuth = launchDetectionGetResponse.launchAzimuth
                launchLatitude = launchDetectionGetResponse.launchLatitude
                launchLongitude = launchDetectionGetResponse.launchLongitude
                launchTime = launchDetectionGetResponse.launchTime
                observationAltitude = launchDetectionGetResponse.observationAltitude
                origin = launchDetectionGetResponse.origin
                origNetwork = launchDetectionGetResponse.origNetwork
                raan = launchDetectionGetResponse.raan
                stereoFlag = launchDetectionGetResponse.stereoFlag
                tags = launchDetectionGetResponse.tags.map { it.toMutableList() }
                updatedAt = launchDetectionGetResponse.updatedAt
                updatedBy = launchDetectionGetResponse.updatedBy
                additionalProperties = launchDetectionGetResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.messageType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun messageType(messageType: JsonField<String>) =
            apply {
                this.messageType = messageType
            }

        /** Latitude of launch vehicle at observation time (in Degrees). -90 to 90 degrees (negative values south of equator). */
        fun observationLatitude(observationLatitude: Double) = observationLatitude(JsonField.of(observationLatitude))

        /**
         * Sets [Builder.observationLatitude] to an arbitrary JSON value.
         *
         * You should usually call [Builder.observationLatitude] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun observationLatitude(observationLatitude: JsonField<Double>) =
            apply {
                this.observationLatitude = observationLatitude
            }

        /** Longitude of launch vehicle at observation time (in Degrees). */
        fun observationLongitude(observationLongitude: Double) = observationLongitude(JsonField.of(observationLongitude))

        /**
         * Sets [Builder.observationLongitude] to an arbitrary JSON value.
         *
         * You should usually call [Builder.observationLongitude] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun observationLongitude(observationLongitude: JsonField<Double>) =
            apply {
                this.observationLongitude = observationLongitude
            }

        /** Time of observation. */
        fun observationTime(observationTime: OffsetDateTime) = observationTime(JsonField.of(observationTime))

        /**
         * Sets [Builder.observationTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.observationTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun observationTime(observationTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.sequenceNumber] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sequenceNumber(sequenceNumber: JsonField<Int>) =
            apply {
        ...
        /** Flag indicating that the Launch azimuth is uncertain due to near vertical flight path. */
        fun highZenithAzimuth(highZenithAzimuth: Boolean) = highZenithAzimuth(JsonField.of(highZenithAzimuth))

        /**
         * Sets [Builder.highZenithAzimuth] to an arbitrary JSON value.
         *
         * You should usually call [Builder.highZenithAzimuth] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun highZenithAzimuth(highZenithAzimuth: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.launchAzimuth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchAzimuth(launchAzimuth: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.launchLatitude] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchLatitude(launchLatitude: JsonField<Double>) =
            apply {
                this.launchLatitude = launchLatitude
            }

        /** Geodetic Longitude of launch origin (in Degrees). -180 to 180 degrees (negative values west of Prime Meridian). */
        fun launchLongitude(launchLongitude: Double) = launchLongitude(JsonField.of(launchLongitude))

        /**
         * Sets [Builder.launchLongitude] to an arbitrary JSON value.
         *
         * You should usually call [Builder.launchLongitude] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchLongitude(launchLongitude: JsonField<Double>) =
            apply {
        ...
        /** Altitude of launch vehicle at observation time (in KM). */
        fun observationAltitude(observationAltitude: Double) = observationAltitude(JsonField.of(observationAltitude))

        /**
         * Sets [Builder.observationAltitude] to an arbitrary JSON value.
         *
         * You should usually call [Builder.observationAltitude] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun observationAltitude(observationAltitude: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.stereoFlag] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stereoFlag(stereoFlag: JsonField<Boolean>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [LaunchDetectionGetResponse].
         *
         ...
         */
        fun build(): LaunchDetectionGetResponse =
            LaunchDetectionGetResponse(
              ...
              checkRequired(
                "observationLatitude", observationLatitude
              ),
              checkRequired(
                "observationLongitude", observationLongitude
              ),
              checkRequired(
    ...
    fun validate(): LaunchDetectionGetResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (messageType.asKnown().isPresent) 1 else 0) + (if (observationLatitude.asKnown().isPresent) 1 else 0) + (if (observationLongitude.asKnown().isPresent) 1 else 0) + (if (observationTime.asKnown().isPresent) 1 else 0) + (if (sequenceNumber.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (eventId.asKnown().isPresent) 1 else 0) + (if (highZenithAzimuth.asKnown().isPresent) 1 else 0) + (if (inclination.asKnown().isPresent) 1 else 0) + (if (launchAzimuth.asKnown().isPresent) 1 else 0) + (if (launchLatitude.asKnown().isPresent) 1 else 0) + (if (launchLongitude.asKnown().isPresent) 1 else 0) + (if (launchTime.asKnown().isPresent) 1 else 0) + (if (observationAltitude.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (raan.asKnown().isPresent) 1 else 0) + (if (stereoFlag.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
