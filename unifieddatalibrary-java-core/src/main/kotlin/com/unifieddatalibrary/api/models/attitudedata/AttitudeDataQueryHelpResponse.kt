...
class AttitudeDataQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeDataQueryHelpResponse: AttitudeDataQueryHelpResponse) = apply {
    ...
    fun validate(): AttitudeDataQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
