...
class AttitudeDataQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AttitudeDataQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AttitudeDataQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeDataQueryHelpResponse: AttitudeDataQueryHelpResponse) =
            apply {
                aodrSupported = attitudeDataQueryHelpResponse.aodrSupported
                classificationMarking = attitudeDataQueryHelpResponse.classificationMarking
                description = attitudeDataQueryHelpResponse.description
                historySupported = attitudeDataQueryHelpResponse.historySupported
                name = attitudeDataQueryHelpResponse.name
                parameters = attitudeDataQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = attitudeDataQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = attitudeDataQueryHelpResponse.restSupported
                sortSupported = attitudeDataQueryHelpResponse.sortSupported
                typeName = attitudeDataQueryHelpResponse.typeName
                uri = attitudeDataQueryHelpResponse.uri
                additionalProperties = attitudeDataQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AttitudeDataQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AttitudeDataQueryHelpResponse =
    ...
    fun validate(): AttitudeDataQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AttitudeDataQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
