...
class RfEmitterQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RfEmitterQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfEmitterQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterQueryhelpResponse: RfEmitterQueryhelpResponse) =
            apply {
                aodrSupported = rfEmitterQueryhelpResponse.aodrSupported
                classificationMarking = rfEmitterQueryhelpResponse.classificationMarking
                description = rfEmitterQueryhelpResponse.description
                historySupported = rfEmitterQueryhelpResponse.historySupported
                name = rfEmitterQueryhelpResponse.name
                parameters = rfEmitterQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = rfEmitterQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = rfEmitterQueryhelpResponse.restSupported
                sortSupported = rfEmitterQueryhelpResponse.sortSupported
                typeName = rfEmitterQueryhelpResponse.typeName
                uri = rfEmitterQueryhelpResponse.uri
                additionalProperties = rfEmitterQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RfEmitterQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfEmitterQueryhelpResponse =
    ...
    fun validate(): RfEmitterQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
