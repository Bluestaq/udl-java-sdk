...
class RfEmitterQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterQueryhelpResponse: RfEmitterQueryhelpResponse) = apply {
    ...
    fun validate(): RfEmitterQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
