 ...
 */
class OrbitdeterminationTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orbitdeterminationTupleResponse: OrbitdeterminationTupleResponse) =
            apply {
                ...
                acceptedObIds =
                    orbitdeterminationTupleResponse.acceptedObIds.map { it.toMutableList() }
                acceptedObTyps =
                    orbitdeterminationTupleResponse.acceptedObTyps.map { it.toMutableList() }
                ...
                rejectedObIds =
                    orbitdeterminationTupleResponse.rejectedObIds.map { it.toMutableList() }
                rejectedObTyps =
                    orbitdeterminationTupleResponse.rejectedObTyps.map { it.toMutableList() }
                ...
                additionalProperties =
                    orbitdeterminationTupleResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): OrbitdeterminationTupleResponse = apply {
        if (validated) {
            return@apply
        }
