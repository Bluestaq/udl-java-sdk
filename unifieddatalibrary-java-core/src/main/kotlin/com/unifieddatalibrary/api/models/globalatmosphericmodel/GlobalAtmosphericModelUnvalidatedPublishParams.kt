 ...
 */
class GlobalAtmosphericModelUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GlobalAtmosphericModelUnvalidatedPublishParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelUnvalidatedPublishParams: GlobalAtmosphericModelUnvalidatedPublishParams) =
            apply {
                body = globalAtmosphericModelUnvalidatedPublishParams.body.toBuilder()
                additionalHeaders = globalAtmosphericModelUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = globalAtmosphericModelUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Starting altitude of model outputs, in kilometers. */
        fun startAlt(startAlt: Double) =
            apply {
                body.startAlt(startAlt)
            }
        ...
        /** Separation in latitude between subsequent model outputs, in degrees. */
        fun stepLat(stepLat: Double) =
            apply {
                body.stepLat(stepLat)
            }
        ...
        /** Separation in longitude between subsequent model outputs, in degrees. */
        fun stepLon(stepLon: Double) =
            apply {
                body.stepLon(stepLon)
            }
    ...
    override fun toString() = "GlobalAtmosphericModelUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
