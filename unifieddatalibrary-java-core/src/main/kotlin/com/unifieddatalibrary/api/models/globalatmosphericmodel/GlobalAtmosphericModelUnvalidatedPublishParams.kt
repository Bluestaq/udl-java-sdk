 ...
 * file extension whose content conforms to the `GlobalAtmosphericModel_Ingest` schema.\ 2\) A file
 * with the `.geojson` file extension.
 *
 * The JSON and GEOJSON files will be associated with each other other via the `id` field. Query the
 * metadata via `GET /udl/globalatmosphericmodel` and use `GET
 ...
 */
class GlobalAtmosphericModelUnvalidatedPublishParams
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun cadence(): Optional<Int> = body.cadence()
     ...
     *   if the server responded with an unexpected value).
     */
    fun dataSourceIdentifier(): Optional<String> = body.dataSourceIdentifier()
     ...
     *   if the server responded with an unexpected value).
     */
    fun endAlt(): Optional<Double> = body.endAlt()
     ...
     *   if the server responded with an unexpected value).
     */
    fun numAlt(): Optional<Int> = body.numAlt()
     ...
     *   if the server responded with an unexpected value).
     */
    fun numLat(): Optional<Int> = body.numLat()
     ...
     *   if the server responded with an unexpected value).
     */
    fun numLon(): Optional<Int> = body.numLon()
     ...
     *   if the server responded with an unexpected value).
     */
    fun startAlt(): Optional<Double> = body.startAlt()
     ...
     *   if the server responded with an unexpected value).
     */
    fun stepLat(): Optional<Double> = body.stepLat()
     ...
     *   if the server responded with an unexpected value).
     */
    fun stepLon(): Optional<Double> = body.stepLon()
     ...
     */
    fun _cadence(): JsonField<Int> = body._cadence()
     ...
     * type.
     */
    fun _dataSourceIdentifier(): JsonField<String> = body._dataSourceIdentifier()
     ...
     */
    fun _endAlt(): JsonField<Double> = body._endAlt()
     ...
     */
    fun _numAlt(): JsonField<Int> = body._numAlt()
     ...
     */
    fun _numLat(): JsonField<Int> = body._numLat()
     ...
     */
    fun _numLon(): JsonField<Int> = body._numLon()
     ...
     */
    fun _startAlt(): JsonField<Double> = body._startAlt()
     ...
     */
    fun _stepLat(): JsonField<Double> = body._stepLat()
     ...
     */
    fun _stepLon(): JsonField<Double> = body._stepLon()
    ...
    /** A builder for [GlobalAtmosphericModelUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body = globalAtmosphericModelUnvalidatedPublishParams.body.toBuilder()
            additionalHeaders =
                globalAtmosphericModelUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                globalAtmosphericModelUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Model execution cadence, in minutes. */
        fun cadence(cadence: Int) = apply { body.cadence(cadence) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun cadence(cadence: JsonField<Int>) = apply { body.cadence(cadence) }
         ...
         */
        fun dataSourceIdentifier(dataSourceIdentifier: String) = apply {
            body.dataSourceIdentifier(dataSourceIdentifier)
        }
        ...
        /** Ending altitude of model outputs, in kilometers. */
        fun endAlt(endAlt: Double) = apply { body.endAlt(endAlt) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun endAlt(endAlt: JsonField<Double>) = apply { body.endAlt(endAlt) }
        ...
        /** Number of altitude points. */
        fun numAlt(numAlt: Int) = apply { body.numAlt(numAlt) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun numAlt(numAlt: JsonField<Int>) = apply { body.numAlt(numAlt) }

        /** Number of latitude points. */
        fun numLat(numLat: Int) = apply { body.numLat(numLat) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun numLat(numLat: JsonField<Int>) = apply { body.numLat(numLat) }

        /** Number of longitude points. */
        fun numLon(numLon: Int) = apply { body.numLon(numLon) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun numLon(numLon: JsonField<Int>) = apply { body.numLon(numLon) }
        ...
        /** Starting altitude of model outputs, in kilometers. */
        fun startAlt(startAlt: Double) = apply { body.startAlt(startAlt) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun startAlt(startAlt: JsonField<Double>) = apply { body.startAlt(startAlt) }
        ...
        /** Separation in latitude between subsequent model outputs, in degrees. */
        fun stepLat(stepLat: Double) = apply { body.stepLat(stepLat) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun stepLat(stepLat: JsonField<Double>) = apply { body.stepLat(stepLat) }

        /** Separation in longitude between subsequent model outputs, in degrees. */
        fun stepLon(stepLon: Double) = apply { body.stepLon(stepLon) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun stepLon(stepLon: JsonField<Double>) = apply { body.stepLon(stepLon) }
        ...
        /**
         * Returns an immutable instance of [GlobalAtmosphericModelUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): GlobalAtmosphericModelUnvalidatedPublishParams =
            GlobalAtmosphericModelUnvalidatedPublishParams(
                body.build(),
     ...
     * situational awareness such as the Global Total Electron Content (2D) data, Global Total
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            startAlt: JsonField<Double> = JsonMissing.of(),
         ...
         * Returns the raw JSON value of [dataSourceIdentifier].
         *
         * Unlike [dataSourceIdentifier], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("dataSourceIdentifier")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                dataSourceIdentifier = body.dataSourceIdentifier
                endAlt = body.endAlt
                endLat = body.endLat
                endLon = body.endLon
                ...
                startAlt = body.startAlt
                startLat = body.startLat
                startLon = body.startLon
                state = body.state
                stepLat = body.stepLat
                stepLon = body.stepLon
             ...
             * Sets [Builder.dataSourceIdentifier] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dataSourceIdentifier] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun dataSourceIdentifier(dataSourceIdentifier: JsonField<String>) = apply {
             ...
             * Sets [Builder.endAlt] to an arbitrary JSON value.
             *
             * You should usually call [Builder.endAlt] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * WGS-84 ending longitude of model output, in degrees. -180 to 180 degrees (negative
             * values west of Prime Meridian).
             */
             ...
             * Sets [Builder.startAlt] to an arbitrary JSON value.
             *
             * You should usually call [Builder.startAlt] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * WGS-84 starting latitude of model output, in degrees. -90 to 90 degrees (negative
             * values south of equator).
             */
             ...
             * Sets [Builder.stepLat] to an arbitrary JSON value.
             *
             * You should usually call [Builder.stepLat] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.stepLon] to an arbitrary JSON value.
             *
             * You should usually call [Builder.stepLon] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GlobalAtmosphericModelUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "GlobalAtmosphericModelUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
