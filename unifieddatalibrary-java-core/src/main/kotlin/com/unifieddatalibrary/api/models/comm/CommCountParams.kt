...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commCountParams: CommCountParams) = apply {
    ...
    override fun toString() =
        "CommCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
