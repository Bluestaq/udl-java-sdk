...
class NotificationQueryhelpResponse
private constructor(
    ...
    /** A builder for [NotificationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(notificationQueryhelpResponse: NotificationQueryhelpResponse) = apply {
            aodrSupported = notificationQueryhelpResponse.aodrSupported
            classificationMarking = notificationQueryhelpResponse.classificationMarking
            description = notificationQueryhelpResponse.description
            historySupported = notificationQueryhelpResponse.historySupported
            name = notificationQueryhelpResponse.name
            parameters = notificationQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = notificationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = notificationQueryhelpResponse.restSupported
            sortSupported = notificationQueryhelpResponse.sortSupported
            typeName = notificationQueryhelpResponse.typeName
            uri = notificationQueryhelpResponse.uri
            additionalProperties = notificationQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NotificationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NotificationQueryhelpResponse =
            NotificationQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): NotificationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NotificationQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
