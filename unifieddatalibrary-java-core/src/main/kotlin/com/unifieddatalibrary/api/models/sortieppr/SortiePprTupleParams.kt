 ...
 */
class SortiePprTupleParams
private constructor(
    private val columns: String,
    private val idSortie: String,
    ...
    /**
     * Unique identifier of the Aircraft Sortie associated with this prior permission required (PPR)
     * record.
     */
    fun idSortie(): String = idSortie
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SortiePprTupleParams].
         *
    ...
    /** A builder for [SortiePprTupleParams]. */
    class Builder internal constructor() {

        private var columns: String? = null
        private var idSortie: String? = null
        ...
        @JvmSynthetic
        internal fun from(sortiePprTupleParams: SortiePprTupleParams) = apply {
            columns = sortiePprTupleParams.columns
            idSortie = sortiePprTupleParams.idSortie
            firstResult = sortiePprTupleParams.firstResult
            maxResults = sortiePprTupleParams.maxResults
            additionalHeaders = sortiePprTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = sortiePprTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Unique identifier of the Aircraft Sortie associated with this prior permission required
         * (PPR) record.
         */
        fun idSortie(idSortie: String) = apply { this.idSortie = idSortie }
        ...
        /**
         * Returns an immutable instance of [SortiePprTupleParams].
         *
         ...
         */
        fun build(): SortiePprTupleParams =
            SortiePprTupleParams(
                checkRequired("columns", columns),
                checkRequired("idSortie", idSortie),
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SortiePprTupleParams && columns == other.columns && idSortie == other.idSortie && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, idSortie, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SortiePprTupleParams{columns=$columns, idSortie=$idSortie, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
