...
class EoObservationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EoObservationTupleParams].
         *
    ...
    /** A builder for [EoObservationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationTupleParams: EoObservationTupleParams) =
            apply {
                columns = eoObservationTupleParams.columns
                obTime = eoObservationTupleParams.obTime
                firstResult = eoObservationTupleParams.firstResult
                maxResults = eoObservationTupleParams.maxResults
                additionalHeaders = eoObservationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = eoObservationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EoObservationTupleParams].
         *
         ...
         */
        fun build(): EoObservationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EoObservationTupleParams && columns == other.columns && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EoObservationTupleParams{columns=$columns, obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
