...
class GlobalAtmosphericModelQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [GlobalAtmosphericModelQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [GlobalAtmosphericModelQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelQueryHelpResponse: GlobalAtmosphericModelQueryHelpResponse) =
            apply {
                aodrSupported = globalAtmosphericModelQueryHelpResponse.aodrSupported
                classificationMarking = globalAtmosphericModelQueryHelpResponse.classificationMarking
                description = globalAtmosphericModelQueryHelpResponse.description
                historySupported = globalAtmosphericModelQueryHelpResponse.historySupported
                name = globalAtmosphericModelQueryHelpResponse.name
                parameters = globalAtmosphericModelQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = globalAtmosphericModelQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = globalAtmosphericModelQueryHelpResponse.restSupported
                sortSupported = globalAtmosphericModelQueryHelpResponse.sortSupported
                typeName = globalAtmosphericModelQueryHelpResponse.typeName
                uri = globalAtmosphericModelQueryHelpResponse.uri
                additionalProperties = globalAtmosphericModelQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [GlobalAtmosphericModelQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GlobalAtmosphericModelQueryHelpResponse =
    ...
    fun validate(): GlobalAtmosphericModelQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GlobalAtmosphericModelQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
