...
class GlobalAtmosphericModelQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            globalAtmosphericModelQueryHelpResponse: GlobalAtmosphericModelQueryHelpResponse
        ) = apply {
            ...
            parameters =
                globalAtmosphericModelQueryHelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                globalAtmosphericModelQueryHelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                globalAtmosphericModelQueryHelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): GlobalAtmosphericModelQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
