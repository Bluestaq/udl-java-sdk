...
class SeradataSigintPayloadGetResponse
private constructor(
        ...
        internal fun from(seradataSigintPayloadGetResponse: SeradataSigintPayloadGetResponse) =
            apply {
                ...
                additionalProperties =
                    seradataSigintPayloadGetResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SeradataSigintPayloadGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SeradataSigintPayloadGetResponse &&
