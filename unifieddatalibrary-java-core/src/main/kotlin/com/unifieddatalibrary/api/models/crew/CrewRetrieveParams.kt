...
class CrewRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): CrewRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CrewRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [CrewRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crewRetrieveParams: CrewRetrieveParams) =
            apply {
                id = crewRetrieveParams.id
                firstResult = crewRetrieveParams.firstResult
                maxResults = crewRetrieveParams.maxResults
                additionalHeaders = crewRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = crewRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CrewRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CrewRetrieveParams =
            CrewRetrieveParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CrewRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CrewRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
