...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiteRemarkGetResponse].
         *
    ...
    /** A builder for [SiteRemarkGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkGetResponse: SiteRemarkGetResponse) = apply {
            classificationMarking = siteRemarkGetResponse.classificationMarking
            dataMode = siteRemarkGetResponse.dataMode
            idSite = siteRemarkGetResponse.idSite
            source = siteRemarkGetResponse.source
            text = siteRemarkGetResponse.text
            id = siteRemarkGetResponse.id
            code = siteRemarkGetResponse.code
            createdAt = siteRemarkGetResponse.createdAt
            createdBy = siteRemarkGetResponse.createdBy
            name = siteRemarkGetResponse.name
            origin = siteRemarkGetResponse.origin
            origNetwork = siteRemarkGetResponse.origNetwork
            origRmkId = siteRemarkGetResponse.origRmkId
            type = siteRemarkGetResponse.type
            additionalProperties = siteRemarkGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SiteRemarkGetResponse].
         *
         ...
         */
        fun build(): SiteRemarkGetResponse =
    ...
    fun validate(): SiteRemarkGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SiteRemarkGetResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idSite=$idSite, source=$source, text=$text, id=$id, code=$code, createdAt=$createdAt, createdBy=$createdBy, name=$name, origin=$origin, origNetwork=$origNetwork, origRmkId=$origRmkId, type=$type, additionalProperties=$additionalProperties}"
}
