...
class SiteRemarkGetResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkGetResponse: SiteRemarkGetResponse) =
            apply {
    ...
    fun validate(): SiteRemarkGetResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "SiteRemarkGetResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idSite=$idSite, source=$source, text=$text, id=$id, code=$code, createdAt=$createdAt, createdBy=$createdBy, name=$name, origin=$origin, origNetwork=$origNetwork, origRmkId=$origRmkId, type=$type, additionalProperties=$additionalProperties}"
}
