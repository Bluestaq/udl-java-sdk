...
class LinkStatusQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LinkStatusQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LinkStatusQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(linkStatusQueryhelpResponse: LinkStatusQueryhelpResponse) = apply {
            aodrSupported = linkStatusQueryhelpResponse.aodrSupported
            classificationMarking = linkStatusQueryhelpResponse.classificationMarking
            description = linkStatusQueryhelpResponse.description
            historySupported = linkStatusQueryhelpResponse.historySupported
            name = linkStatusQueryhelpResponse.name
            parameters = linkStatusQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = linkStatusQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = linkStatusQueryhelpResponse.restSupported
            sortSupported = linkStatusQueryhelpResponse.sortSupported
            typeName = linkStatusQueryhelpResponse.typeName
            uri = linkStatusQueryhelpResponse.uri
            additionalProperties = linkStatusQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LinkStatusQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LinkStatusQueryhelpResponse =
    ...
    fun validate(): LinkStatusQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LinkStatusQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
