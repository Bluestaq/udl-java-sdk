...
class EffectResponseQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(effectResponseQueryHelpResponse: EffectResponseQueryHelpResponse) =
            apply {
                ...
                requiredRoles =
                    effectResponseQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    effectResponseQueryHelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): EffectResponseQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
