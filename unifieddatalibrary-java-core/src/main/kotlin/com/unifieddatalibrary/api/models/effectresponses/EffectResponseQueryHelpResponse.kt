...
class EffectResponseQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EffectResponseQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EffectResponseQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseQueryHelpResponse: EffectResponseQueryHelpResponse) =
            apply {
                aodrSupported = effectResponseQueryHelpResponse.aodrSupported
                classificationMarking = effectResponseQueryHelpResponse.classificationMarking
                description = effectResponseQueryHelpResponse.description
                historySupported = effectResponseQueryHelpResponse.historySupported
                name = effectResponseQueryHelpResponse.name
                parameters = effectResponseQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = effectResponseQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = effectResponseQueryHelpResponse.restSupported
                sortSupported = effectResponseQueryHelpResponse.sortSupported
                typeName = effectResponseQueryHelpResponse.typeName
                uri = effectResponseQueryHelpResponse.uri
                additionalProperties = effectResponseQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EffectResponseQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EffectResponseQueryHelpResponse =
    ...
    fun validate(): EffectResponseQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectResponseQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
