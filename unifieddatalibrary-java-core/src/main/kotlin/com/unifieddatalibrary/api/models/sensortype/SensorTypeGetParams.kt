...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorTypeGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeGetParams: SensorTypeGetParams) = apply {
    ...
    override fun toString() =
        "SensorTypeGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
