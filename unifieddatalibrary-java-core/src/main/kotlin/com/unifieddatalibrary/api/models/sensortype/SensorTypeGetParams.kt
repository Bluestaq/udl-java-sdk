...
class SensorTypeGetParams private constructor(
    private val id: Int?,
    ...
    fun id(): Optional<Int> = Optional.ofNullable(id)
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SensorTypeGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SensorTypeGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorTypeGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeGetParams: SensorTypeGetParams) =
            apply {
                id = sensorTypeGetParams.id
                firstResult = sensorTypeGetParams.firstResult
                maxResults = sensorTypeGetParams.maxResults
                additionalHeaders = sensorTypeGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = sensorTypeGetParams.additionalQueryParams.toBuilder()
            }
         ...
         */
        fun id(id: Int) = id(id as Int?)

        /** Alias for calling [Builder.id] with `id.orElse(null)`. */
        fun id(id: Optional<Int>) = id(id.getOrNull())
        ...
        /**
         * Returns an immutable instance of [SensorTypeGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorTypeGetParams =
            SensorTypeGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorTypeGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SensorTypeGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
