...
class OnorbitlistTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistTupleResponse: OnorbitlistTupleResponse) =
            apply {
                ...
                onorbits = onorbitlistTupleResponse.onorbits.map { it.toMutableList() }
    ...
    fun validate(): OnorbitlistTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
