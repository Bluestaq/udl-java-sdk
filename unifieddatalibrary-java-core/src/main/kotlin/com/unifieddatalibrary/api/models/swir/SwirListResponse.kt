...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SwirListResponse].
         *
    ...
    /** A builder for [SwirListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(swirListResponse: SwirListResponse) = apply {
            classificationMarking = swirListResponse.classificationMarking
            dataMode = swirListResponse.dataMode
            source = swirListResponse.source
            ts = swirListResponse.ts
            id = swirListResponse.id
            badWave = swirListResponse.badWave
            createdAt = swirListResponse.createdAt
            createdBy = swirListResponse.createdBy
            idOnOrbit = swirListResponse.idOnOrbit
            lat = swirListResponse.lat
            locationName = swirListResponse.locationName
            lon = swirListResponse.lon
            origin = swirListResponse.origin
            origNetwork = swirListResponse.origNetwork
            origObjectId = swirListResponse.origObjectId
            satNo = swirListResponse.satNo
            solarPhaseAngle = swirListResponse.solarPhaseAngle
            additionalProperties = swirListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SwirListResponse].
         *
    ...
    fun validate(): SwirListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SwirListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, ts=$ts, id=$id, badWave=$badWave, createdAt=$createdAt, createdBy=$createdBy, idOnOrbit=$idOnOrbit, lat=$lat, locationName=$locationName, lon=$lon, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, satNo=$satNo, solarPhaseAngle=$solarPhaseAngle, additionalProperties=$additionalProperties}"
}
