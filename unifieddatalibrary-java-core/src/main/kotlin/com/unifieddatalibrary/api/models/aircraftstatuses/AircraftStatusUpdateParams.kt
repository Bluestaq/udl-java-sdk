...
class AircraftStatusUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftStatusUpdateParams].
         *
    ...
    /** A builder for [AircraftStatusUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusUpdateParams: AircraftStatusUpdateParams) =
            apply {
                pathId = aircraftStatusUpdateParams.pathId
                body = aircraftStatusUpdateParams.body.toBuilder()
                additionalHeaders = aircraftStatusUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftStatusUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftStatusUpdateParams].
         *
         ...
         */
        fun build(): AircraftStatusUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftStatusUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AircraftStatusUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
