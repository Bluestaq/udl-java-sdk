...
/**
 * Service operation to update a single AircraftStatus. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class AircraftStatusUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusUpdateParams: AircraftStatusUpdateParams) = apply {
    ...
    override fun toString() =
        "AircraftStatusUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
