...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DeconflictsetGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DeconflictsetGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DeconflictsetGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deconflictsetGetParams: DeconflictsetGetParams) = apply {
            id = deconflictsetGetParams.id
            firstResult = deconflictsetGetParams.firstResult
            maxResults = deconflictsetGetParams.maxResults
            additionalHeaders = deconflictsetGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = deconflictsetGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DeconflictsetGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DeconflictsetGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeconflictsetGetParams &&
            id == other.id &&
    ...
    override fun toString() =
        "DeconflictsetGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
