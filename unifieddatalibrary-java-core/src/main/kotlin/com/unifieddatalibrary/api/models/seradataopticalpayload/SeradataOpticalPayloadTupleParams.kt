...
class SeradataOpticalPayloadTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataOpticalPayloadTupleParams].
         *
    ...
    /** A builder for [SeradataOpticalPayloadTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataOpticalPayloadTupleParams: SeradataOpticalPayloadTupleParams) =
            apply {
                columns = seradataOpticalPayloadTupleParams.columns
                firstResult = seradataOpticalPayloadTupleParams.firstResult
                maxResults = seradataOpticalPayloadTupleParams.maxResults
                additionalHeaders = seradataOpticalPayloadTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = seradataOpticalPayloadTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataOpticalPayloadTupleParams].
         *
         ...
         */
        fun build(): SeradataOpticalPayloadTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataOpticalPayloadTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SeradataOpticalPayloadTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
