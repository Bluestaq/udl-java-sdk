...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OrganizationCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OrganizationCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OrganizationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationCountParams: OrganizationCountParams) = apply {
            firstResult = organizationCountParams.firstResult
            maxResults = organizationCountParams.maxResults
            additionalHeaders = organizationCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = organizationCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OrganizationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrganizationCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OrganizationCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
