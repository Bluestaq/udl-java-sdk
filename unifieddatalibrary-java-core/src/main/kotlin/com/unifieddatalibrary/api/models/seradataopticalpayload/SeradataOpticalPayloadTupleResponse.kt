...
class SeradataOpticalPayloadTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataOpticalPayloadTupleResponse].
         *
    ...
    /** A builder for [SeradataOpticalPayloadTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataOpticalPayloadTupleResponse: SeradataOpticalPayloadTupleResponse) =
            apply {
                classificationMarking = seradataOpticalPayloadTupleResponse.classificationMarking
                dataMode = seradataOpticalPayloadTupleResponse.dataMode
                source = seradataOpticalPayloadTupleResponse.source
                spacecraftId = seradataOpticalPayloadTupleResponse.spacecraftId
                id = seradataOpticalPayloadTupleResponse.id
                bestResolution = seradataOpticalPayloadTupleResponse.bestResolution
                createdAt = seradataOpticalPayloadTupleResponse.createdAt
                createdBy = seradataOpticalPayloadTupleResponse.createdBy
                fieldOfRegard = seradataOpticalPayloadTupleResponse.fieldOfRegard
                fieldOfView = seradataOpticalPayloadTupleResponse.fieldOfView
                groundStationLocations = seradataOpticalPayloadTupleResponse.groundStationLocations
                groundStations = seradataOpticalPayloadTupleResponse.groundStations
                hostedForCompanyOrgId = seradataOpticalPayloadTupleResponse.hostedForCompanyOrgId
                idSensor = seradataOpticalPayloadTupleResponse.idSensor
                imagingPayloadCategory = seradataOpticalPayloadTupleResponse.imagingPayloadCategory
                manufacturerOrgId = seradataOpticalPayloadTupleResponse.manufacturerOrgId
                name = seradataOpticalPayloadTupleResponse.name
                notes = seradataOpticalPayloadTupleResponse.notes
                numberOfFilmReturnCanisters = seradataOpticalPayloadTupleResponse.numberOfFilmReturnCanisters
                origin = seradataOpticalPayloadTupleResponse.origin
                origNetwork = seradataOpticalPayloadTupleResponse.origNetwork
                pointingMethod = seradataOpticalPayloadTupleResponse.pointingMethod
                recorderSize = seradataOpticalPayloadTupleResponse.recorderSize
                spectralBand = seradataOpticalPayloadTupleResponse.spectralBand
                spectralFrequencyLimits = seradataOpticalPayloadTupleResponse.spectralFrequencyLimits
                swathWidth = seradataOpticalPayloadTupleResponse.swathWidth
                updatedAt = seradataOpticalPayloadTupleResponse.updatedAt
                updatedBy = seradataOpticalPayloadTupleResponse.updatedBy
                additionalProperties = seradataOpticalPayloadTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataOpticalPayloadTupleResponse].
         *
         ...
         */
        fun build(): SeradataOpticalPayloadTupleResponse =
    ...
    fun validate(): SeradataOpticalPayloadTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
