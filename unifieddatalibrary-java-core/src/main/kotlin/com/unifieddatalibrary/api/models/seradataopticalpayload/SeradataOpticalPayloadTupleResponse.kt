...
class SeradataOpticalPayloadTupleResponse
private constructor(
    ...
    /**
     * Sensor name from Seradata, e.g. TOURNESOL, MESSR (Multispectral Self-Scanning Radiometer),
     * AWFI, etc.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataOpticalPayloadTupleResponse: SeradataOpticalPayloadTupleResponse
        ) = apply {
            ...
            numberOfFilmReturnCanisters =
                seradataOpticalPayloadTupleResponse.numberOfFilmReturnCanisters
            ...
            additionalProperties =
                seradataOpticalPayloadTupleResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.imagingPayloadCategory] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.numberOfFilmReturnCanisters] with a well-typed [Long]
         ...
         *
         * You should usually call [Builder.spectralBand] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
    ...
    fun validate(): SeradataOpticalPayloadTupleResponse = apply {
        if (validated) {
            return@apply
        }
