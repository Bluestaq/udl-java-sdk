...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackTupleParams].
         *
    ...
    /** A builder for [TrackTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackTupleParams: TrackTupleParams) = apply {
            columns = trackTupleParams.columns
            ts = trackTupleParams.ts
            firstResult = trackTupleParams.firstResult
            maxResults = trackTupleParams.maxResults
            additionalHeaders = trackTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = trackTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TrackTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TrackTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
