...
class CountryTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CountryTupleParams].
         *
    ...
    /** A builder for [CountryTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryTupleParams: CountryTupleParams) =
            apply {
                columns = countryTupleParams.columns
                firstResult = countryTupleParams.firstResult
                maxResults = countryTupleParams.maxResults
                additionalHeaders = countryTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = countryTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CountryTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CountryTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CountryTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
