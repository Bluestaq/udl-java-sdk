...
/**
 * Service operation to take a single equipmentremark record as a POST body and ingest into the
 * database. A specific role is required to perform this service operation. Please contact the UDL
 * team for assistance.
 */
class EquipmentRemarkCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun idEquipment(): String = body.idEquipment()
     ...
     */
    fun _idEquipment(): JsonField<String> = body._idEquipment()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EquipmentRemarkCreateParams].
         *
    ...
    /** A builder for [EquipmentRemarkCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentRemarkCreateParams: EquipmentRemarkCreateParams) = apply {
            body = equipmentRemarkCreateParams.body.toBuilder()
            additionalHeaders = equipmentRemarkCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = equipmentRemarkCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** The ID of the Equipment to which this remark applies. */
        fun idEquipment(idEquipment: String) = apply { body.idEquipment(idEquipment) }

        /**
         * Sets [Builder.idEquipment] to an arbitrary JSON value.
         *
         * You should usually call [Builder.idEquipment] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun idEquipment(idEquipment: JsonField<String>) = apply { body.idEquipment(idEquipment) }
        ...
        /**
         * Returns an immutable instance of [EquipmentRemarkCreateParams].
         *
         ...
         */
        fun build(): EquipmentRemarkCreateParams =
    ...
    private constructor(
        ...
        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idEquipment, source, text, id, altRmkId, code, createdAt, createdBy, name, origin, type, additionalProperties) }
        /* spotless:on */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EquipmentRemarkCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "EquipmentRemarkCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
