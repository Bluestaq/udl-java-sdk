...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("beaconInd") @ExcludeMissing beaconInd: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("milClass") @ExcludeMissing milClass: JsonField<String> = JsonMissing.of(),
        @JsonProperty("natAlliance") @ExcludeMissing natAlliance: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("numPersons") @ExcludeMissing numPersons: JsonField<Int> = JsonMissing.of(),
    ...
    /**
     * Specifies the type of incident resulting in a recovery or evacuation mission. Intended as,
     * but not constrained to, MIL-STD-6016 J6.1 Emergency Type (e.g. NO STATEMENT, DOWN AIRCRAFT,
     * MAN IN WATER, DITCHING, BAILOUT, DISTRESSED VEHICLE, GROUND INCIDENT, MEDICAL, ISOLATED
     * PERSONS, etc.).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /**
     * The confirmation status of the isolated personnel identity. Intended as, but not constrained
     * to, MIL-STD-6016 J6.1 Authentication Status, Isolated Personnel (NO STATEMENT, AUTHENTICATED,
     * NOT AUTHENTICATED, AUTHENTICATED UNDER DURESS, NOT APPLICABLE):
     *
    ...
    /**
     * The survivor service identity (UNKNOWN MILITARY, UNKNOWN CIVILIAN, FRIEND MILITARY, FRIEND
     * CIVIILIAN, NEUTRAL MILITARY, NEUTRAL CIVILIAN, HOSTILE MILITARY, HOSTILE CIVILIAN).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     * constrained to, MIL-STD-6016 J6.1 Isolated Personnel Classification (NO STATEMENT, MILITARY,
     * GOVERNMENT CIVILIAN, GOVERNMENT CONTRACTOR, CIVILIAN, MULTIPLE CLASSIFICATIONS).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     * evacuation. If natAlliance is set to 126, then natAlliance1 must be non 0. If natAlliance is
     * any number other than 126, then natAlliance1 will be set to 0 regardless. Defined in
     ...
     * evacuation. Specify an entry here only if natAlliance is 126. Defined in MIL-STD-6016 J6.1
     * Nationality/Alliance isolated person(s), 1.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * UUID identifying the Personnel Recovery mission, which should remain the same on subsequent
     * posts related to the same recovery mission.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Preloaded message conveying the situation confronting the isolated person(s). Intended as,
     * but not constrained to, MIL-STD-6016 J6.1 Survivor Radio Messages (e.g. INJURED CANT MOVE NO
     * KNOWN HOSTILES, INJURED CANT MOVE HOSTILES NEARBY, UNINJURED CANT MOVE HOSTILES NEARBY,
     * UNINJURED NO KNOWN HOSTILES, INJURED LIMITED MOBILITY).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     * Radio Type (NO STATEMENT, PRQ7SEL, PRC90, PRC112, PRC112B B1, PRC112C, PRC112D, PRC148 MBITR,
     ...
     */
    @JsonProperty("authMethod") @ExcludeMissing fun _authMethod(): JsonField<String> = authMethod
     ...
     */
    @JsonProperty("authStatus") @ExcludeMissing fun _authStatus(): JsonField<String> = authStatus
     ...
     *
     * Unlike [executionInfo], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("executionInfo")
    @ExcludeMissing
     ...
     */
    @JsonProperty("natAlliance") @ExcludeMissing fun _natAlliance(): JsonField<Int> = natAlliance

    /**
     * Returns the raw JSON value of [natAlliance1].
     *
     * Unlike [natAlliance1], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("natAlliance1") @ExcludeMissing fun _natAlliance1(): JsonField<Int> = natAlliance1
     ...
     *
     * Unlike [numAmbulatoryInjured], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("numAmbulatoryInjured")
    @ExcludeMissing
     ...
     *
     * Unlike [survivorRadio], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("survivorRadio")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PersonnelRecoveryFullL].
         *
    ...
    /** A builder for [PersonnelRecoveryFullL]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(personnelRecoveryFullL: PersonnelRecoveryFullL) = apply {
            classificationMarking = personnelRecoveryFullL.classificationMarking
            dataMode = personnelRecoveryFullL.dataMode
            msgTime = personnelRecoveryFullL.msgTime
            pickupLat = personnelRecoveryFullL.pickupLat
            pickupLon = personnelRecoveryFullL.pickupLon
            source = personnelRecoveryFullL.source
            type = personnelRecoveryFullL.type
            id = personnelRecoveryFullL.id
            authMethod = personnelRecoveryFullL.authMethod
            authStatus = personnelRecoveryFullL.authStatus
            beaconInd = personnelRecoveryFullL.beaconInd
            callSign = personnelRecoveryFullL.callSign
            commEq1 = personnelRecoveryFullL.commEq1
            commEq2 = personnelRecoveryFullL.commEq2
            commEq3 = personnelRecoveryFullL.commEq3
            createdAt = personnelRecoveryFullL.createdAt
            createdBy = personnelRecoveryFullL.createdBy
            executionInfo = personnelRecoveryFullL.executionInfo
            identity = personnelRecoveryFullL.identity
            idWeatherReport = personnelRecoveryFullL.idWeatherReport
            milClass = personnelRecoveryFullL.milClass
            natAlliance = personnelRecoveryFullL.natAlliance
            natAlliance1 = personnelRecoveryFullL.natAlliance1
            numAmbulatory = personnelRecoveryFullL.numAmbulatory
            numAmbulatoryInjured = personnelRecoveryFullL.numAmbulatoryInjured
            numNonAmbulatory = personnelRecoveryFullL.numNonAmbulatory
            numPersons = personnelRecoveryFullL.numPersons
            objectiveAreaInfo = personnelRecoveryFullL.objectiveAreaInfo
            origin = personnelRecoveryFullL.origin
            origNetwork = personnelRecoveryFullL.origNetwork
            pickupAlt = personnelRecoveryFullL.pickupAlt
            recovId = personnelRecoveryFullL.recovId
            rxFreq = personnelRecoveryFullL.rxFreq
            survivorMessages = personnelRecoveryFullL.survivorMessages
            survivorRadio = personnelRecoveryFullL.survivorRadio
            termInd = personnelRecoveryFullL.termInd
            textMsg = personnelRecoveryFullL.textMsg
            txFreq = personnelRecoveryFullL.txFreq
            additionalProperties = personnelRecoveryFullL.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.authMethod] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.authStatus] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.beaconInd] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.commEq1] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.commEq2] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.commEq3] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        ...
        fun executionInfo(executionInfo: ExecutionInfo) = executionInfo(JsonField.of(executionInfo))

        /**
         * Sets [Builder.executionInfo] to an arbitrary JSON value.
         *
         * You should usually call [Builder.executionInfo] with a well-typed [ExecutionInfo] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.milClass] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.natAlliance] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         * value.
         */
        fun natAlliance1(natAlliance1: JsonField<Int>) = apply { this.natAlliance1 = natAlliance1 }
         ...
         *
         * You should usually call [Builder.numNonAmbulatory] with a well-typed [Int] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.numPersons] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.objectiveAreaInfo] with a well-typed [ObjectiveAreaInfo]
         ...
         *
         * You should usually call [Builder.recovId] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.rxFreq] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.survivorRadio] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.termInd] with a well-typed [Boolean] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.textMsg] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.txFreq] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        ...
        /**
         * Returns an immutable instance of [PersonnelRecoveryFullL].
         *
         ...
         */
        fun build(): PersonnelRecoveryFullL =
    ...
    fun validate(): PersonnelRecoveryFullL = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("egress") @ExcludeMissing egress: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("ingress") @ExcludeMissing ingress: JsonField<Double> = JsonMissing.of(),
         ...
         * altitude, in meters, of the egress location. This array must contain a minimum of 2
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun escortVehicle(): Optional<EscortVehicle> = escortVehicle.getOptional("escortVehicle")
         ...
         * Array of the WGS-84 latitude (-90 to 90, negative values south of the equator) in
         * degrees, longitude (-180 to 180, negative values west of Prime Meridian) in degrees, and
         * altitude, in meters, of the initial location. This array must contain a minimum of 2
         * elements (latitude and longitude), and may contain an optional 3rd element (altitude).
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         ...
         *
         * Unlike [egressPoint], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("egressPoint")
        @ExcludeMissing
         ...
         *
         * Unlike [objStrategy], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("objStrategy")
        @ExcludeMissing
         ...
         *
         * Unlike [recoveryVehicle], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("recoveryVehicle")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.egress] with a well-typed [Double] value instead.
             ...
             *
             * You should usually call [Builder.egressPoint] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.ingress] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * (altitude).
             */
            fun initialPoint(initialPoint: List<Double>) = initialPoint(JsonField.of(initialPoint))

            /**
             * Sets [Builder.initialPoint] to an arbitrary JSON value.
             *
             * You should usually call [Builder.initialPoint] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.recoveryVehicle] with a well-typed [RecoveryVehicle]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
        ...
        private constructor(
             ...
             * in this recovery vehicle message. If null, the strength is assumed to represent a
             * single object. Note that if this recovery derives from a J-series message then
             * special definitions apply for the following values: 13 indicates an estimated 2-7
             * units, 14 indicates an estimated more than 7 units, and 15 indicates an estimated
             * more than 12 units.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             ...
             *
             * Unlike [primaryFreq], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("primaryFreq")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.primaryFreq] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("oscFreq") @ExcludeMissing oscFreq: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("pzDesc") @ExcludeMissing pzDesc: JsonField<String> = JsonMissing.of(),
         ...
         * Array of the WGS-84 latitude (-90 to 90, negative values south of the equator) in
         * degrees, longitude (-180 to 180, negative values west of Prime Meridian) in degrees, and
         * altitude, in meters, of the pz location. This array must contain a minimum of 2 elements
         * (latitude and longitude), and may contain an optional 3rd element (altitude).
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
         ...
         *
         * Unlike [oscCallSign], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("oscCallSign")
        @ExcludeMissing
         ...
         *
         * Unlike [pzLocation], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("pzLocation")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.oscFreq] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.pzDesc] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.pzLocation] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
