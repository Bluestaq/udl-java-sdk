...
/**
 * Service operation to take a single sortieppr record as a POST body and ingest into the database.
 * A specific role is required to perform this service operation. Please contact the UDL team for
 * assistance.
 */
class SortiePprCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun idSortie(): String = body.idSortie()
    ...
    /**
     * Time the prior permission required (PPR) valid window ends, in ISO 8601 UTC format with
     ...
     *   if the server responded with an unexpected value).
     */
    fun grantor(): Optional<String> = body.grantor()
     ...
     *   if the server responded with an unexpected value).
     */
    fun requestor(): Optional<String> = body.requestor()
    ...
    /**
     * Time the prior permission required (PPR) valid window begins, in ISO 8601 UTC format with
     * millisecond precision.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Type of prior permission required (PPR) for a sortie (M - Military or C - Civilian). Enum:
     * [M, C].
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     */
    fun _grantor(): JsonField<String> = body._grantor()
     ...
     */
    fun _requestor(): JsonField<String> = body._requestor()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SortiePprCreateParams].
         *
    ...
    /** A builder for [SortiePprCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprCreateParams: SortiePprCreateParams) = apply {
            body = sortiePprCreateParams.body.toBuilder()
            additionalHeaders = sortiePprCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = sortiePprCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Identifier of the prior permission required (PPR) grantor. */
        fun grantor(grantor: String) = apply { body.grantor(grantor) }

        /**
         * Sets [Builder.grantor] to an arbitrary JSON value.
         *
         * You should usually call [Builder.grantor] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun grantor(grantor: JsonField<String>) = apply { body.grantor(grantor) }
        ...
        /** The username of the prior permission required (PPR) requestor. */
        fun requestor(requestor: String) = apply { body.requestor(requestor) }
         ...
         * value.
         */
        fun requestor(requestor: JsonField<String>) = apply { body.requestor(requestor) }
        ...
        /**
         * Type of prior permission required (PPR) for a sortie (M - Military or C - Civilian).
         * Enum: [M, C].
         */
        ...
        /**
         * Returns an immutable instance of [SortiePprCreateParams].
         *
         ...
         */
        fun build(): SortiePprCreateParams =
    ...
    /**
     * SortiePPR is a regulatory requirement where operators must obtain permissions to full
    ...
    private constructor(
         ...
         *   value).
         */
        fun idSortie(): String = idSortie.getRequired("idSortie")
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun grantor(): Optional<String> = grantor.getOptional("grantor")
         ...
         * Unlike [grantor], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("grantor") @ExcludeMissing fun _grantor(): JsonField<String> = grantor
        ...
        class Builder internal constructor() {
            ...
            private var idSortie: JsonField<String>? = null
            ...
            private var grantor: JsonField<String> = JsonMissing.of()
            ...
            /**
             * Time the prior permission required (PPR) valid window ends, in ISO 8601 UTC format
            ...
            /** Identifier of the prior permission required (PPR) grantor. */
            fun grantor(grantor: String) = grantor(JsonField.of(grantor))

            /**
             * Sets [Builder.grantor] to an arbitrary JSON value.
             *
             * You should usually call [Builder.grantor] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun grantor(grantor: JsonField<String>) = apply { this.grantor = grantor }
            ...
            /**
             * Time the prior permission required (PPR) valid window begins, in ISO 8601 UTC format
             * with millisecond precision.
             */
        ...
        internal fun validity(): Int =
            (if (classificationMarking.asKnown().isPresent) 1 else 0) +
                ...
                (if (grantor.asKnown().isPresent) 1 else 0) +
        ...
        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idSortie, source, id, createdAt, createdBy, endTime, externalId, grantor, number, origin, origNetwork, remarks, requestor, sourceDl, startTime, type, additionalProperties) }
        /* spotless:on */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SortiePprCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SortiePprCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
