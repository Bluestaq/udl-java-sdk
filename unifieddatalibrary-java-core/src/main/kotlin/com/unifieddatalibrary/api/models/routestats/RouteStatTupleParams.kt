...
class RouteStatTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RouteStatTupleParams].
         *
    ...
    /** A builder for [RouteStatTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatTupleParams: RouteStatTupleParams) =
            apply {
                columns = routeStatTupleParams.columns
                firstResult = routeStatTupleParams.firstResult
                maxResults = routeStatTupleParams.maxResults
                additionalHeaders = routeStatTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = routeStatTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RouteStatTupleParams].
         *
         ...
         */
        fun build(): RouteStatTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RouteStatTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RouteStatTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
