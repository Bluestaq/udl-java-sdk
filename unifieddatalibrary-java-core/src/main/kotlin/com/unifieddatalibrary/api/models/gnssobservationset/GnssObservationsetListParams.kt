 ...
 */
class GnssObservationsetListParams
private constructor(
     ...
     * all observations within the set. (YYYY-MM-DDTHH:MM:SS.ssssssZ)
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GnssObservationsetListParams].
         *
    ...
    /** A builder for [GnssObservationsetListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gnssObservationsetListParams: GnssObservationsetListParams) = apply {
            ts = gnssObservationsetListParams.ts
            firstResult = gnssObservationsetListParams.firstResult
            maxResults = gnssObservationsetListParams.maxResults
            additionalHeaders = gnssObservationsetListParams.additionalHeaders.toBuilder()
            additionalQueryParams = gnssObservationsetListParams.additionalQueryParams.toBuilder()
        }

        /**
         * Observation Time, in ISO8601 UTC format with microsecond precision. This timestamp
         * applies to all observations within the set. (YYYY-MM-DDTHH:MM:SS.ssssssZ)
         */
        ...
        /**
         * Returns an immutable instance of [GnssObservationsetListParams].
         *
         ...
         */
        fun build(): GnssObservationsetListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is GnssObservationsetListParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "GnssObservationsetListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
