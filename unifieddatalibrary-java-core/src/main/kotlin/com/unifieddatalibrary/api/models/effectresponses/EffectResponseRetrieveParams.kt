...
class EffectResponseRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EffectResponseRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EffectResponseRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EffectResponseRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseRetrieveParams: EffectResponseRetrieveParams) =
            apply {
                id = effectResponseRetrieveParams.id
                firstResult = effectResponseRetrieveParams.firstResult
                maxResults = effectResponseRetrieveParams.maxResults
                additionalHeaders = effectResponseRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectResponseRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectResponseRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EffectResponseRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectResponseRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EffectResponseRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
