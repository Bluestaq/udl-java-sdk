...
class EffectResponseRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EffectResponseRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseRetrieveParams: EffectResponseRetrieveParams) = apply {
    ...
    override fun toString() =
        "EffectResponseRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
