...
class ObjectOfInterestUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectOfInterestUpdateParams: ObjectOfInterestUpdateParams) =
            apply {
        ...
        /** Time of last status change of the object of interest event. */
        fun statusDate(statusDate: OffsetDateTime) =
            apply {
        ...
        /** Possible delta time applications for the object of interest, in seconds. */
        fun deltaTs(deltaTs: List<Double>) =
            apply {
                body.deltaTs(deltaTs)
            }
        ...
        fun addDeltaT(deltaT: Double) =
            apply {
                body.addDeltaT(deltaT)
            }

        /** Possible delta V applications for the object of interest, in km/sec. */
        fun deltaVs(deltaVs: List<Double>) =
            apply {
                body.deltaVs(deltaVs)
            }
        ...
        /** Last reported elset epoch time in ISO 8601 UTC time, with microsecond precision. */
        fun elsetEpoch(elsetEpoch: OffsetDateTime) =
            apply {
        ...
        /** Last reported state vector epoch time in ISO 8601 UTC time, with microsecond precision. */
        fun svEpoch(svEpoch: OffsetDateTime) =
            apply {
                body.svEpoch(svEpoch)
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ObjectOfInterestUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "ObjectOfInterestUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
