...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aiQueryhelpResponse: AiQueryhelpResponse) = apply {
    ...
    fun validate(): AiQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
