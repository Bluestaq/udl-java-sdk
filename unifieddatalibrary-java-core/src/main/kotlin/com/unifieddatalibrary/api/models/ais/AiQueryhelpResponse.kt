...
class AiQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AiQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AiQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aiQueryhelpResponse: AiQueryhelpResponse) =
            apply {
                aodrSupported = aiQueryhelpResponse.aodrSupported
                classificationMarking = aiQueryhelpResponse.classificationMarking
                description = aiQueryhelpResponse.description
                historySupported = aiQueryhelpResponse.historySupported
                name = aiQueryhelpResponse.name
                parameters = aiQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = aiQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = aiQueryhelpResponse.restSupported
                sortSupported = aiQueryhelpResponse.sortSupported
                typeName = aiQueryhelpResponse.typeName
                uri = aiQueryhelpResponse.uri
                additionalProperties = aiQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AiQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AiQueryhelpResponse =
            AiQueryhelpResponse(
              aodrSupported,
              classificationMarking,
              description,
    ...
    fun validate(): AiQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AiQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
