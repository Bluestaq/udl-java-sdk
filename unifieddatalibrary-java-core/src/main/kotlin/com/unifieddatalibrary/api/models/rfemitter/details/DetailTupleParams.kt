...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DetailTupleParams].
         *
    ...
    /** A builder for [DetailTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailTupleParams: DetailTupleParams) = apply {
            columns = detailTupleParams.columns
            firstResult = detailTupleParams.firstResult
            maxResults = detailTupleParams.maxResults
            additionalHeaders = detailTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = detailTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DetailTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailTupleParams &&
    ...
    override fun toString() =
        "DetailTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
