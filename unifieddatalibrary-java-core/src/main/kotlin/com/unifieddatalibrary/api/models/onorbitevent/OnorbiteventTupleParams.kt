...
class OnorbiteventTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbiteventTupleParams].
         *
    ...
    /** A builder for [OnorbiteventTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventTupleParams: OnorbiteventTupleParams) =
            apply {
                columns = onorbiteventTupleParams.columns
                firstResult = onorbiteventTupleParams.firstResult
                maxResults = onorbiteventTupleParams.maxResults
                additionalHeaders = onorbiteventTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbiteventTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbiteventTupleParams].
         *
         ...
         */
        fun build(): OnorbiteventTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbiteventTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnorbiteventTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
