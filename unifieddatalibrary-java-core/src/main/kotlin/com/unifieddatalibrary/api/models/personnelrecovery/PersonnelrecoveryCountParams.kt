 ...
 */
class PersonnelrecoveryCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PersonnelrecoveryCountParams].
         *
    ...
    /** A builder for [PersonnelrecoveryCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(personnelrecoveryCountParams: PersonnelrecoveryCountParams) = apply {
            msgTime = personnelrecoveryCountParams.msgTime
            firstResult = personnelrecoveryCountParams.firstResult
            maxResults = personnelrecoveryCountParams.maxResults
            additionalHeaders = personnelrecoveryCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = personnelrecoveryCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PersonnelrecoveryCountParams].
         *
         ...
         */
        fun build(): PersonnelrecoveryCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PersonnelrecoveryCountParams && msgTime == other.msgTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "PersonnelrecoveryCountParams{msgTime=$msgTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
