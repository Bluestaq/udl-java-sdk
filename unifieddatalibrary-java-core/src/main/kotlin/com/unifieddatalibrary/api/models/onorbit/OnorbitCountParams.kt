...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitCountParams: OnorbitCountParams) = apply {
    ...
    override fun toString() =
        "OnorbitCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
