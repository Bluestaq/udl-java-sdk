...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardQueryhelpResponse: HazardQueryhelpResponse) = apply {
    ...
    fun validate(): HazardQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
