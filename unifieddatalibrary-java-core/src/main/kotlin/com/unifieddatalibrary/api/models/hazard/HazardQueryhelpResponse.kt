...
class HazardQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [HazardQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [HazardQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardQueryhelpResponse: HazardQueryhelpResponse) =
            apply {
                aodrSupported = hazardQueryhelpResponse.aodrSupported
                classificationMarking = hazardQueryhelpResponse.classificationMarking
                description = hazardQueryhelpResponse.description
                historySupported = hazardQueryhelpResponse.historySupported
                name = hazardQueryhelpResponse.name
                parameters = hazardQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = hazardQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = hazardQueryhelpResponse.restSupported
                sortSupported = hazardQueryhelpResponse.sortSupported
                typeName = hazardQueryhelpResponse.typeName
                uri = hazardQueryhelpResponse.uri
                additionalProperties = hazardQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [HazardQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HazardQueryhelpResponse =
    ...
    fun validate(): HazardQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
