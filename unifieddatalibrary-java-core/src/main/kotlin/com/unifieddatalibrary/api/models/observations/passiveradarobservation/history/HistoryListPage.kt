...
class HistoryListPage private constructor(
    private val service: HistoryService,
    private val params: HistoryListParams,
    private val items: List<HistoryListResponse>,
    ...
    fun autoPager(): AutoPager<HistoryListResponse> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<HistoryListResponse> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<HistoryListResponse>? = null

        @JvmSynthetic
        internal fun from(historyListPage: HistoryListPage) =
            apply {
        ...
        fun service(service: HistoryService) =
            apply {
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<HistoryListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is HistoryListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }
