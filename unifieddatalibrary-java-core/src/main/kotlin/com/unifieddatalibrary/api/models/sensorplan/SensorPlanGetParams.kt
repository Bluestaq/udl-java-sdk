...
class SensorPlanGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SensorPlanGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SensorPlanGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorPlanGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanGetParams: SensorPlanGetParams) =
            apply {
                id = sensorPlanGetParams.id
                firstResult = sensorPlanGetParams.firstResult
                maxResults = sensorPlanGetParams.maxResults
                additionalHeaders = sensorPlanGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = sensorPlanGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SensorPlanGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorPlanGetParams =
            SensorPlanGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorPlanGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SensorPlanGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
