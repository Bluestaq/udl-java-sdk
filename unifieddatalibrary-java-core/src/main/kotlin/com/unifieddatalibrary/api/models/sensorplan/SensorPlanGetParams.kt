...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorPlanGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanGetParams: SensorPlanGetParams) = apply {
    ...
    override fun toString() =
        "SensorPlanGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
