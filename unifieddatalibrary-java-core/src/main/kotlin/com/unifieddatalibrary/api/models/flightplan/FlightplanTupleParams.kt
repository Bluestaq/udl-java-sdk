...
class FlightplanTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FlightplanTupleParams].
         *
    ...
    /** A builder for [FlightplanTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightplanTupleParams: FlightplanTupleParams) =
            apply {
                columns = flightplanTupleParams.columns
                firstResult = flightplanTupleParams.firstResult
                maxResults = flightplanTupleParams.maxResults
                additionalHeaders = flightplanTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = flightplanTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [FlightplanTupleParams].
         *
         ...
         */
        fun build(): FlightplanTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is FlightplanTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "FlightplanTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
