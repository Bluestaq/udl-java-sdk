...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ScientificCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificCountParams: ScientificCountParams) = apply {
    ...
    override fun toString() =
        "ScientificCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
