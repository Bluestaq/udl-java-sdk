...
class CountryQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryQueryhelpResponse: CountryQueryhelpResponse) = apply {
    ...
    fun validate(): CountryQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
