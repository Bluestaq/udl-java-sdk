...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mtiQueryhelpResponse: MtiQueryhelpResponse) = apply {
    ...
    fun validate(): MtiQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
