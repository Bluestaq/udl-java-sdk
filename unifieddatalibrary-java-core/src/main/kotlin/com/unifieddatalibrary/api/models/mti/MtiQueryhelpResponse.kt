...
class MtiQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MtiQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [MtiQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mtiQueryhelpResponse: MtiQueryhelpResponse) =
            apply {
                aodrSupported = mtiQueryhelpResponse.aodrSupported
                classificationMarking = mtiQueryhelpResponse.classificationMarking
                description = mtiQueryhelpResponse.description
                historySupported = mtiQueryhelpResponse.historySupported
                name = mtiQueryhelpResponse.name
                parameters = mtiQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = mtiQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = mtiQueryhelpResponse.restSupported
                sortSupported = mtiQueryhelpResponse.sortSupported
                typeName = mtiQueryhelpResponse.typeName
                uri = mtiQueryhelpResponse.uri
                additionalProperties = mtiQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MtiQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MtiQueryhelpResponse =
    ...
    fun validate(): MtiQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
