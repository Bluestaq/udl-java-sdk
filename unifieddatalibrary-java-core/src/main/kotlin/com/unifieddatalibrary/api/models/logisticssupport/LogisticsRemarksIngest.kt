...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LogisticsRemarksIngest]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LogisticsRemarksIngest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsRemarksIngest: LogisticsRemarksIngest) = apply {
            lastChanged = logisticsRemarksIngest.lastChanged
            remark = logisticsRemarksIngest.remark
            username = logisticsRemarksIngest.username
            additionalProperties = logisticsRemarksIngest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LogisticsRemarksIngest].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LogisticsRemarksIngest =
    ...
    fun validate(): LogisticsRemarksIngest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LogisticsRemarksIngest &&
    ...
    override fun toString() =
        "LogisticsRemarksIngest{lastChanged=$lastChanged, remark=$remark, username=$username, additionalProperties=$additionalProperties}"
}
