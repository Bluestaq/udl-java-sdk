...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotListPage: AirfieldSlotListPage) = apply {
            service = airfieldSlotListPage.service
            params = airfieldSlotListPage.params
            items = airfieldSlotListPage.items
        }

        fun service(service: AirfieldSlotService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AirfieldSlotListPage &&
