...
class PersonnelrecoveryQueryhelpResponse
private constructor(
    ...
    /** A builder for [PersonnelrecoveryQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(personnelrecoveryQueryhelpResponse: PersonnelrecoveryQueryhelpResponse) =
            apply {
                aodrSupported = personnelrecoveryQueryhelpResponse.aodrSupported
                classificationMarking = personnelrecoveryQueryhelpResponse.classificationMarking
                description = personnelrecoveryQueryhelpResponse.description
                historySupported = personnelrecoveryQueryhelpResponse.historySupported
                name = personnelrecoveryQueryhelpResponse.name
                parameters =
                    personnelrecoveryQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    personnelrecoveryQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = personnelrecoveryQueryhelpResponse.restSupported
                sortSupported = personnelrecoveryQueryhelpResponse.sortSupported
                typeName = personnelrecoveryQueryhelpResponse.typeName
                uri = personnelrecoveryQueryhelpResponse.uri
                additionalProperties =
                    personnelrecoveryQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PersonnelrecoveryQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PersonnelrecoveryQueryhelpResponse =
            PersonnelrecoveryQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): PersonnelrecoveryQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PersonnelrecoveryQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
