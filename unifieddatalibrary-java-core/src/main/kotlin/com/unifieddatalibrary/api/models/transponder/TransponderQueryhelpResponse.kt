...
class TransponderQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TransponderQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [TransponderQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderQueryhelpResponse: TransponderQueryhelpResponse) =
            apply {
                aodrSupported = transponderQueryhelpResponse.aodrSupported
                classificationMarking = transponderQueryhelpResponse.classificationMarking
                description = transponderQueryhelpResponse.description
                historySupported = transponderQueryhelpResponse.historySupported
                name = transponderQueryhelpResponse.name
                parameters = transponderQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = transponderQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = transponderQueryhelpResponse.restSupported
                sortSupported = transponderQueryhelpResponse.sortSupported
                typeName = transponderQueryhelpResponse.typeName
                uri = transponderQueryhelpResponse.uri
                additionalProperties = transponderQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TransponderQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TransponderQueryhelpResponse =
    ...
    fun validate(): TransponderQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is TransponderQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
