...
class TransponderQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderQueryhelpResponse: TransponderQueryhelpResponse) = apply {
    ...
    fun validate(): TransponderQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
