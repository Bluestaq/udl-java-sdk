...
class StatusGetByEntityTypeParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StatusGetByEntityTypeParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusGetByEntityTypeParams: StatusGetByEntityTypeParams) = apply {
    ...
    override fun toString() =
        "StatusGetByEntityTypeParams{entityType=$entityType, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
