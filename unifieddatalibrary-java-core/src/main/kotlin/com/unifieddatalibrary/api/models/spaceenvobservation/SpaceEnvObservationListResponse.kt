...
class SpaceEnvObservationListResponse
private constructor(
        ...
        internal fun from(spaceEnvObservationListResponse: SpaceEnvObservationListResponse) =
            apply {
                ...
                additionalProperties =
                    spaceEnvObservationListResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SpaceEnvObservationListResponse = apply {
        if (validated) {
            return@apply
        }
