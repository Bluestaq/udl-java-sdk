 ...
 */
class PersonnelrecoveryListParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PersonnelrecoveryListParams].
         *
    ...
    /** A builder for [PersonnelrecoveryListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(personnelrecoveryListParams: PersonnelrecoveryListParams) = apply {
            msgTime = personnelrecoveryListParams.msgTime
            firstResult = personnelrecoveryListParams.firstResult
            maxResults = personnelrecoveryListParams.maxResults
            additionalHeaders = personnelrecoveryListParams.additionalHeaders.toBuilder()
            additionalQueryParams = personnelrecoveryListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PersonnelrecoveryListParams].
         *
         ...
         */
        fun build(): PersonnelrecoveryListParams =
