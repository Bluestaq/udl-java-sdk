...
/**
 * Service operation to take a single OnorbitThrusterStatus record as a POST body and ingest into
 * the database. A specific role is required to perform this service operation. Please contact the
 * UDL team for assistance.
 */
class OnorbitthrusterstatusCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun idOnorbitThruster(): String = body.idOnorbitThruster()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun statusTime(): OffsetDateTime = body.statusTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun estDeltaV(): Optional<Double> = body.estDeltaV()
     ...
     *   if the server responded with an unexpected value).
     */
    fun fuelMass(): Optional<Double> = body.fuelMass()
     ...
     *   if the server responded with an unexpected value).
     */
    fun fuelMassUnc(): Optional<Double> = body.fuelMassUnc()
     ...
     *   if the server responded with an unexpected value).
     */
    fun isp(): Optional<Double> = body.isp()
     ...
     *   if the server responded with an unexpected value).
     */
    fun minDeltaV(): Optional<Double> = body.minDeltaV()
     ...
     *   if the server responded with an unexpected value).
     */
    fun operational(): Optional<Boolean> = body.operational()
     ...
     *   if the server responded with an unexpected value).
     */
    fun propMassAvg(): Optional<Double> = body.propMassAvg()
     ...
     *   if the server responded with an unexpected value).
     */
    fun propMassMax(): Optional<Double> = body.propMassMax()
     ...
     *   if the server responded with an unexpected value).
     */
    fun propMassMedian(): Optional<Double> = body.propMassMedian()
     ...
     *   if the server responded with an unexpected value).
     */
    fun propMassMin(): Optional<Double> = body.propMassMin()
     ...
     *   if the server responded with an unexpected value).
     */
    fun thrustMax(): Optional<Double> = body.thrustMax()
     ...
     * type.
     */
    fun _idOnorbitThruster(): JsonField<String> = body._idOnorbitThruster()
     ...
     */
    fun _statusTime(): JsonField<OffsetDateTime> = body._statusTime()
     ...
     */
    fun _estDeltaV(): JsonField<Double> = body._estDeltaV()
     ...
     */
    fun _fuelMass(): JsonField<Double> = body._fuelMass()
     ...
     */
    fun _fuelMassUnc(): JsonField<Double> = body._fuelMassUnc()
     ...
     */
    fun _isp(): JsonField<Double> = body._isp()
     ...
     */
    fun _minDeltaV(): JsonField<Double> = body._minDeltaV()
     ...
     */
    fun _operational(): JsonField<Boolean> = body._operational()
     ...
     */
    fun _propMassAvg(): JsonField<Double> = body._propMassAvg()
     ...
     */
    fun _propMassMax(): JsonField<Double> = body._propMassMax()
     ...
     */
    fun _propMassMedian(): JsonField<Double> = body._propMassMedian()
     ...
     */
    fun _propMassMin(): JsonField<Double> = body._propMassMin()
     ...
     */
    fun _thrustMax(): JsonField<Double> = body._thrustMax()
    ...
    /** A builder for [OnorbitthrusterstatusCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterstatusCreateParams: OnorbitthrusterstatusCreateParams) =
            apply {
                body = onorbitthrusterstatusCreateParams.body.toBuilder()
                additionalHeaders = onorbitthrusterstatusCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    onorbitthrusterstatusCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        fun idOnorbitThruster(idOnorbitThruster: String) = apply {
            body.idOnorbitThruster(idOnorbitThruster)
        }
         ...
         */
        fun statusTime(statusTime: OffsetDateTime) = apply { body.statusTime(statusTime) }
        ...
        /** Estimated available delta-velocity for this thruster, in meters per second. */
        fun estDeltaV(estDeltaV: Double) = apply { body.estDeltaV(estDeltaV) }
         ...
         * value.
         */
        fun estDeltaV(estDeltaV: JsonField<Double>) = apply { body.estDeltaV(estDeltaV) }

        /** Total fuel mass available for this thruster's type, in kilograms. */
        fun fuelMass(fuelMass: Double) = apply { body.fuelMass(fuelMass) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun fuelMass(fuelMass: JsonField<Double>) = apply { body.fuelMass(fuelMass) }

        /**
         * 1-sigma uncertainty of the total fuel mass available for this thruster type, in
         * kilograms.
         */
        fun fuelMassUnc(fuelMassUnc: Double) = apply { body.fuelMassUnc(fuelMassUnc) }
         ...
         * value.
         */
        fun fuelMassUnc(fuelMassUnc: JsonField<Double>) = apply { body.fuelMassUnc(fuelMassUnc) }

        /** Specific impulse for this thruster, in seconds. */
        fun isp(isp: Double) = apply { body.isp(isp) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun isp(isp: JsonField<Double>) = apply { body.isp(isp) }
        ...
        /** Minimum available delta-velocity for this thruster, in meters per second. */
        fun minDeltaV(minDeltaV: Double) = apply { body.minDeltaV(minDeltaV) }
         ...
         * value.
         */
        fun minDeltaV(minDeltaV: JsonField<Double>) = apply { body.minDeltaV(minDeltaV) }
        ...
        /** Flag indicating if this thruster is operational. */
        fun operational(operational: Boolean) = apply { body.operational(operational) }
         ...
         * value.
         */
        fun operational(operational: JsonField<Boolean>) = apply { body.operational(operational) }
        ...
        /** Average available propellant mass for this thruster's type, in kilograms. */
        fun propMassAvg(propMassAvg: Double) = apply { body.propMassAvg(propMassAvg) }
         ...
         * value.
         */
        fun propMassAvg(propMassAvg: JsonField<Double>) = apply { body.propMassAvg(propMassAvg) }

        /** Maximum available propellant mass for this thruster's type, in kilograms. */
        fun propMassMax(propMassMax: Double) = apply { body.propMassMax(propMassMax) }
         ...
         * value.
         */
        fun propMassMax(propMassMax: JsonField<Double>) = apply { body.propMassMax(propMassMax) }

        /** Median available propellant mass for this thruster's type, in kilograms. */
        fun propMassMedian(propMassMedian: Double) = apply { body.propMassMedian(propMassMedian) }
        ...
        fun propMassMedian(propMassMedian: JsonField<Double>) = apply {
            body.propMassMedian(propMassMedian)
        }

        /** Minimum available propellant mass for this thruster's type, in kilograms. */
        fun propMassMin(propMassMin: Double) = apply { body.propMassMin(propMassMin) }
         ...
         * value.
         */
        fun propMassMin(propMassMin: JsonField<Double>) = apply { body.propMassMin(propMassMin) }

        /** Maximum available thrust for this thruster, in newtons. */
        fun thrustMax(thrustMax: Double) = apply { body.thrustMax(thrustMax) }
         ...
         * value.
         */
        fun thrustMax(thrustMax: JsonField<Double>) = apply { body.thrustMax(thrustMax) }
        ...
        /**
         * Returns an immutable instance of [OnorbitthrusterstatusCreateParams].
         *
         ...
         */
        fun build(): OnorbitthrusterstatusCreateParams =
            OnorbitthrusterstatusCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OnorbitthrusterstatusCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "OnorbitthrusterstatusCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
