...
class ManifoldListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManifoldListResponse].
         *
    ...
    /** A builder for [ManifoldListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldListResponse: ManifoldListResponse) =
            apply {
                classificationMarking = manifoldListResponse.classificationMarking
                dataMode = manifoldListResponse.dataMode
                idObjectOfInterest = manifoldListResponse.idObjectOfInterest
                source = manifoldListResponse.source
                id = manifoldListResponse.id
                createdAt = manifoldListResponse.createdAt
                createdBy = manifoldListResponse.createdBy
                deltaT = manifoldListResponse.deltaT
                deltaV = manifoldListResponse.deltaV
                origin = manifoldListResponse.origin
                origNetwork = manifoldListResponse.origNetwork
                status = manifoldListResponse.status
                weight = manifoldListResponse.weight
                additionalProperties = manifoldListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ManifoldListResponse].
         *
         ...
         */
        fun build(): ManifoldListResponse =
    ...
    fun validate(): ManifoldListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "ManifoldListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idObjectOfInterest=$idObjectOfInterest, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, deltaT=$deltaT, deltaV=$deltaV, origin=$origin, origNetwork=$origNetwork, status=$status, weight=$weight, additionalProperties=$additionalProperties}"
}
