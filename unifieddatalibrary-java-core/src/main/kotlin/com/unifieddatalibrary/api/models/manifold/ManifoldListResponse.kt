...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldListResponse: ManifoldListResponse) = apply {
    ...
    fun validate(): ManifoldListResponse = apply {
        if (validated) {
            return@apply
        }
