...
class AiHistoryCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AiHistoryCountParams].
         *
    ...
    /** A builder for [AiHistoryCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aiHistoryCountParams: AiHistoryCountParams) =
            apply {
                ts = aiHistoryCountParams.ts
                firstResult = aiHistoryCountParams.firstResult
                maxResults = aiHistoryCountParams.maxResults
                additionalHeaders = aiHistoryCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = aiHistoryCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AiHistoryCountParams].
         *
         ...
         */
        fun build(): AiHistoryCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AiHistoryCountParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AiHistoryCountParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
