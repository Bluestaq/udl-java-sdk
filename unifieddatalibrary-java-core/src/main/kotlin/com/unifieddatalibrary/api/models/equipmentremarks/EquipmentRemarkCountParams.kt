 ...
 */
class EquipmentRemarkCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EquipmentRemarkCountParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [EquipmentRemarkCountParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EquipmentRemarkCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentRemarkCountParams: EquipmentRemarkCountParams) = apply {
            firstResult = equipmentRemarkCountParams.firstResult
            maxResults = equipmentRemarkCountParams.maxResults
            additionalHeaders = equipmentRemarkCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = equipmentRemarkCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EquipmentRemarkCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EquipmentRemarkCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EquipmentRemarkCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "EquipmentRemarkCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
