...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VideoListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [VideoListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VideoListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(videoListParams: VideoListParams) = apply {
            firstResult = videoListParams.firstResult
            maxResults = videoListParams.maxResults
            additionalHeaders = videoListParams.additionalHeaders.toBuilder()
            additionalQueryParams = videoListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VideoListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VideoListParams =
            VideoListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VideoListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "VideoListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
