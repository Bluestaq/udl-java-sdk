...
class SensorGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorGetResponse].
         *
    ...
    /** A builder for [SensorGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorGetResponse: SensorGetResponse) =
            apply {
                classificationMarking = sensorGetResponse.classificationMarking
                dataMode = sensorGetResponse.dataMode
                sensorName = sensorGetResponse.sensorName
                source = sensorGetResponse.source
                active = sensorGetResponse.active
                afId = sensorGetResponse.afId
                asrType = sensorGetResponse.asrType
                createdAt = sensorGetResponse.createdAt
                createdBy = sensorGetResponse.createdBy
                dataControl = sensorGetResponse.dataControl
                entity = sensorGetResponse.entity
                idEntity = sensorGetResponse.idEntity
                idSensor = sensorGetResponse.idSensor
                origin = sensorGetResponse.origin
                origNetwork = sensorGetResponse.origNetwork
                sensorcharacteristics = sensorGetResponse.sensorcharacteristics.map { it.toMutableList() }
                sensorlimitsCollection = sensorGetResponse.sensorlimitsCollection.map { it.toMutableList() }
                sensorNumber = sensorGetResponse.sensorNumber
                sensorObservationType = sensorGetResponse.sensorObservationType
                sensorStats = sensorGetResponse.sensorStats.map { it.toMutableList() }
                sensorType = sensorGetResponse.sensorType
                shortName = sensorGetResponse.shortName
                updatedAt = sensorGetResponse.updatedAt
                updatedBy = sensorGetResponse.updatedBy
                additionalProperties = sensorGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorGetResponse].
         *
    ...
    fun validate(): SensorGetResponse =
        apply {
            if (validated) {
              return@apply
            }
