...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorGetResponse: SensorGetResponse) = apply {
            ...
            sensorcharacteristics =
                sensorGetResponse.sensorcharacteristics.map { it.toMutableList() }
            sensorlimitsCollection =
                sensorGetResponse.sensorlimitsCollection.map { it.toMutableList() }
    ...
    fun validate(): SensorGetResponse = apply {
        if (validated) {
            return@apply
        }
