...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NavigationListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationListParams: NavigationListParams) = apply {
    ...
    override fun toString() =
        "NavigationListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
