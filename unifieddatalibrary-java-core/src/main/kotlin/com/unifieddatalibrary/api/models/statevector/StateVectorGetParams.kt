...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StateVectorGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorGetParams: StateVectorGetParams) = apply {
    ...
    override fun toString() =
        "StateVectorGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
