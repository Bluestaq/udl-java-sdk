...
class StateVectorGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): StateVectorGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StateVectorGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [StateVectorGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorGetParams: StateVectorGetParams) =
            apply {
                id = stateVectorGetParams.id
                firstResult = stateVectorGetParams.firstResult
                maxResults = stateVectorGetParams.maxResults
                additionalHeaders = stateVectorGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = stateVectorGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [StateVectorGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StateVectorGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StateVectorGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "StateVectorGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
