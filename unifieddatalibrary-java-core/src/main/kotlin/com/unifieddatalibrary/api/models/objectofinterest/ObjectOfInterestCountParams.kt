 ...
 */
class ObjectOfInterestCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ObjectOfInterestCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectOfInterestCountParams: ObjectOfInterestCountParams) = apply {
    ...
    override fun toString() =
        "ObjectOfInterestCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
