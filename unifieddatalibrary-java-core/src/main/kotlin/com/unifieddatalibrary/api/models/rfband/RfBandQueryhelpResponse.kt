...
class RfBandQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RfBandQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfBandQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandQueryhelpResponse: RfBandQueryhelpResponse) =
            apply {
                aodrSupported = rfBandQueryhelpResponse.aodrSupported
                classificationMarking = rfBandQueryhelpResponse.classificationMarking
                description = rfBandQueryhelpResponse.description
                historySupported = rfBandQueryhelpResponse.historySupported
                name = rfBandQueryhelpResponse.name
                parameters = rfBandQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = rfBandQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = rfBandQueryhelpResponse.restSupported
                sortSupported = rfBandQueryhelpResponse.sortSupported
                typeName = rfBandQueryhelpResponse.typeName
                uri = rfBandQueryhelpResponse.uri
                additionalProperties = rfBandQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RfBandQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfBandQueryhelpResponse =
    ...
    fun validate(): RfBandQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfBandQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
