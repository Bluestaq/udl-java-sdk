...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandQueryhelpResponse: RfBandQueryhelpResponse) = apply {
    ...
    fun validate(): RfBandQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
