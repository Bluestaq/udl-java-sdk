...
class SiteStatusQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusQueryhelpResponse: SiteStatusQueryhelpResponse) = apply {
    ...
    fun validate(): SiteStatusQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
