...
class SiteStatusQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SiteStatusQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SiteStatusQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusQueryhelpResponse: SiteStatusQueryhelpResponse) =
            apply {
                aodrSupported = siteStatusQueryhelpResponse.aodrSupported
                classificationMarking = siteStatusQueryhelpResponse.classificationMarking
                description = siteStatusQueryhelpResponse.description
                historySupported = siteStatusQueryhelpResponse.historySupported
                name = siteStatusQueryhelpResponse.name
                parameters = siteStatusQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = siteStatusQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = siteStatusQueryhelpResponse.restSupported
                sortSupported = siteStatusQueryhelpResponse.sortSupported
                typeName = siteStatusQueryhelpResponse.typeName
                uri = siteStatusQueryhelpResponse.uri
                additionalProperties = siteStatusQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SiteStatusQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SiteStatusQueryhelpResponse =
    ...
    fun validate(): SiteStatusQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteStatusQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
