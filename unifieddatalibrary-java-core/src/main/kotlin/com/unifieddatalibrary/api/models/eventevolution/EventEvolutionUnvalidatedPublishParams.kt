 ...
 * database. Requires a specific role, please contact the UDL team to gain access. This operation is
 * intended to be used for automated feeds into UDL.
 */
class EventEvolutionUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [EventEvolutionUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            eventEvolutionUnvalidatedPublishParams: EventEvolutionUnvalidatedPublishParams
        ) = apply {
            body = eventEvolutionUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = eventEvolutionUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                eventEvolutionUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EventEvolutionUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): EventEvolutionUnvalidatedPublishParams =
            EventEvolutionUnvalidatedPublishParams(
