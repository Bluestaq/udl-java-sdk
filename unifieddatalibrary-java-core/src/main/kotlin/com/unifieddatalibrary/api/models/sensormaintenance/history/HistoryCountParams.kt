...
class HistoryCountParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyCountParams: HistoryCountParams) =
            apply {
                endTime = historyCountParams.endTime
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is HistoryCountParams && endTime == other.endTime && firstResult == other.firstResult && maxResults == other.maxResults && startTime == other.startTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "HistoryCountParams{endTime=$endTime, firstResult=$firstResult, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
