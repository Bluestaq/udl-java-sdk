...
/**
 * Service operation to get a single Transponder record by its unique ID passed as a path parameter.
 * A Comm payload may have multiple transponders and a transponder may have many channels.
 */
class TransponderGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TransponderGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TransponderGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TransponderGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderGetParams: TransponderGetParams) = apply {
            id = transponderGetParams.id
            firstResult = transponderGetParams.firstResult
            maxResults = transponderGetParams.maxResults
            additionalHeaders = transponderGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = transponderGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransponderGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TransponderGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TransponderGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TransponderGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
