...
class TransponderGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): TransponderGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderGetParams: TransponderGetParams) =
            apply {
    ...
    override fun toString() = "TransponderGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
