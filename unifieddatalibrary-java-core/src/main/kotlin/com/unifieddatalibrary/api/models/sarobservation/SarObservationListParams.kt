...
class SarObservationListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SarObservationListParams].
         *
    ...
    /** A builder for [SarObservationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationListParams: SarObservationListParams) =
            apply {
                collectionStart = sarObservationListParams.collectionStart
                firstResult = sarObservationListParams.firstResult
                maxResults = sarObservationListParams.maxResults
                additionalHeaders = sarObservationListParams.additionalHeaders.toBuilder()
                additionalQueryParams = sarObservationListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SarObservationListParams].
         *
         ...
         */
        fun build(): SarObservationListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SarObservationListParams && collectionStart == other.collectionStart && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SarObservationListParams{collectionStart=$collectionStart, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
