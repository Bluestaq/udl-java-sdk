...
/**
 * SortiePPR is a regulatory requirement where operators must obtain permissions to full operational
 * access to a runway, taxiway, or airport service.
 */
class SortiePprListResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SortiePprListResponse].
         *
    ...
    /** A builder for [SortiePprListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprListResponse: SortiePprListResponse) = apply {
            classificationMarking = sortiePprListResponse.classificationMarking
            dataMode = sortiePprListResponse.dataMode
            idSortie = sortiePprListResponse.idSortie
            source = sortiePprListResponse.source
            id = sortiePprListResponse.id
            createdAt = sortiePprListResponse.createdAt
            createdBy = sortiePprListResponse.createdBy
            endTime = sortiePprListResponse.endTime
            externalId = sortiePprListResponse.externalId
            grantor = sortiePprListResponse.grantor
            number = sortiePprListResponse.number
            origin = sortiePprListResponse.origin
            origNetwork = sortiePprListResponse.origNetwork
            remarks = sortiePprListResponse.remarks
            requestor = sortiePprListResponse.requestor
            sourceDl = sortiePprListResponse.sourceDl
            startTime = sortiePprListResponse.startTime
            type = sortiePprListResponse.type
            additionalProperties = sortiePprListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SortiePprListResponse].
         *
         ...
         */
        fun build(): SortiePprListResponse =
    ...
    fun validate(): SortiePprListResponse = apply {
        if (validated) {
            return@apply
        }
