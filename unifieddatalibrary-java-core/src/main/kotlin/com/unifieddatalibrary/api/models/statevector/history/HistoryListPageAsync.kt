...
import com.unifieddatalibrary.api.models.statevector.history.HistoryListParams
...
class HistoryListPageAsync private constructor(
    ...
    private val items: List<StateVectorFull>,

) : PageAsync<StateVectorFull> {
    ...
    fun autoPager(): AutoPagerAsync<StateVectorFull> =
        AutoPagerAsync.from(
    ...
    override fun items(): List<StateVectorFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<StateVectorFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<StateVectorFull>) =
            apply {
                this.items = items
            }
