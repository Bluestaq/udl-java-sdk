...
/**
 * Service operation intended for initial integration only, to take a list of operatingunitremark
 ...
 */
class OperatingunitremarkCreateBulkParams
private constructor(
    ...
    /** A builder for [OperatingunitremarkCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            operatingunitremarkCreateBulkParams: OperatingunitremarkCreateBulkParams
        ) = apply {
            body = operatingunitremarkCreateBulkParams.body.toMutableList()
            additionalHeaders = operatingunitremarkCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                operatingunitremarkCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OperatingunitremarkCreateBulkParams].
         *
         ...
         */
        fun build(): OperatingunitremarkCreateBulkParams =
            OperatingunitremarkCreateBulkParams(
    ...
    private constructor(
        ...
        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idOperatingUnit, source, text, id, altRmkId, code, createdAt, createdBy, name, origin, type) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idOperatingUnit=$idOperatingUnit, source=$source, text=$text, id=$id, altRmkId=$altRmkId, code=$code, createdAt=$createdAt, createdBy=$createdBy, name=$name, origin=$origin, type=$type}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OperatingunitremarkCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "OperatingunitremarkCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
