...
private constructor(
    ...
    private val items: List<AisFull>,
) : PageAsync<AisFull> {
    ...
    fun autoPager(): AutoPagerAsync<AisFull> = AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<AisFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<AisFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<AisFull>) = apply { this.items = items }
