...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EngineListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineListParams: EngineListParams) = apply {
    ...
    override fun toString() =
        "EngineListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
