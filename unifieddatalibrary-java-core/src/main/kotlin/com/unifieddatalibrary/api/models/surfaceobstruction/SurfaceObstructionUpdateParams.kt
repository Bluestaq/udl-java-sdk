...
class SurfaceObstructionUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceObstructionUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionUpdateParams: SurfaceObstructionUpdateParams) =
            apply {
        ...
        /** The unique identifier of the associated surface record. This field is required when posting, updating, or deleting a SurfaceObstruction record. */
        fun idSurface(idSurface: String) =
            apply {
                body.idSurface(idSurface)
            }
    ...
    override fun toString() = "SurfaceObstructionUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
