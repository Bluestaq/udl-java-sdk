...
/**
 * Service operation to update a single surfaceobstruction record. A specific role is required to
 * perform this service operation. Please contact the UDL team for assistance.
 */
class SurfaceObstructionUpdateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun idSurface(): String = body.idSurface()
     ...
     *   if the server responded with an unexpected value).
     */
    fun advisoryRequired(): Optional<List<String>> = body.advisoryRequired()
     ...
     *   if the server responded with an unexpected value).
     */
    fun approvalRequired(): Optional<List<String>> = body.approvalRequired()
     ...
     *   if the server responded with an unexpected value).
     */
    fun distanceFromCenterLine(): Optional<Double> = body.distanceFromCenterLine()
     ...
     *   if the server responded with an unexpected value).
     */
    fun distanceFromEdge(): Optional<Double> = body.distanceFromEdge()
     ...
     *   if the server responded with an unexpected value).
     */
    fun distanceFromThreshold(): Optional<Double> = body.distanceFromThreshold()
     ...
     *   if the server responded with an unexpected value).
     */
    fun idNavigationalObstruction(): Optional<String> = body.idNavigationalObstruction()
     ...
     *   if the server responded with an unexpected value).
     */
    fun obstructionDesc(): Optional<String> = body.obstructionDesc()
     ...
     *   if the server responded with an unexpected value).
     */
    fun obstructionHeight(): Optional<Double> = body.obstructionHeight()
     ...
     *   if the server responded with an unexpected value).
     */
    fun obstructionSideCode(): Optional<String> = body.obstructionSideCode()
     ...
     */
    fun _idSurface(): JsonField<String> = body._idSurface()
     ...
     * type.
     */
    fun _advisoryRequired(): JsonField<List<String>> = body._advisoryRequired()
     ...
     * type.
     */
    fun _approvalRequired(): JsonField<List<String>> = body._approvalRequired()
     ...
     * unexpected type.
     */
    fun _distanceFromCenterLine(): JsonField<Double> = body._distanceFromCenterLine()
     ...
     * type.
     */
    fun _distanceFromEdge(): JsonField<Double> = body._distanceFromEdge()
     ...
     * type.
     */
    fun _distanceFromThreshold(): JsonField<Double> = body._distanceFromThreshold()
     ...
     * unexpected type.
     */
    fun _idNavigationalObstruction(): JsonField<String> = body._idNavigationalObstruction()
     ...
     */
    fun _obstructionDesc(): JsonField<String> = body._obstructionDesc()
     ...
     * type.
     */
    fun _obstructionHeight(): JsonField<Double> = body._obstructionHeight()
     ...
     * type.
     */
    fun _obstructionSideCode(): JsonField<String> = body._obstructionSideCode()
    ...
    /** A builder for [SurfaceObstructionUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionUpdateParams: SurfaceObstructionUpdateParams) = apply {
            pathId = surfaceObstructionUpdateParams.pathId
            body = surfaceObstructionUpdateParams.body.toBuilder()
            additionalHeaders = surfaceObstructionUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = surfaceObstructionUpdateParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun idSurface(idSurface: String) = apply { body.idSurface(idSurface) }
         ...
         * value.
         */
        fun idSurface(idSurface: JsonField<String>) = apply { body.idSurface(idSurface) }
         ...
         * require an advisory for usage.
         */
        fun advisoryRequired(advisoryRequired: List<String>) = apply {
            body.advisoryRequired(advisoryRequired)
        }
        ...
        fun addAdvisoryRequired(advisoryRequired: String) = apply {
            body.addAdvisoryRequired(advisoryRequired)
        }
         ...
         * require an approval for usage.
         */
        fun approvalRequired(approvalRequired: List<String>) = apply {
            body.approvalRequired(approvalRequired)
        }
        ...
        fun addApprovalRequired(approvalRequired: String) = apply {
            body.addApprovalRequired(approvalRequired)
        }
        ...
        /** The distance from the surface center line to this obstruction, in feet. */
        fun distanceFromCenterLine(distanceFromCenterLine: Double) = apply {
            body.distanceFromCenterLine(distanceFromCenterLine)
        }
        ...
        /** The distance from the surface edge to this obstruction, in feet. */
        fun distanceFromEdge(distanceFromEdge: Double) = apply {
            body.distanceFromEdge(distanceFromEdge)
        }
        ...
        /** The distance from the surface threshold to this obstruction, in feet. */
        fun distanceFromThreshold(distanceFromThreshold: Double) = apply {
            body.distanceFromThreshold(distanceFromThreshold)
        }
        ...
        /** The unique identifier of the associated NavigationalObstruction record. */
        fun idNavigationalObstruction(idNavigationalObstruction: String) = apply {
            body.idNavigationalObstruction(idNavigationalObstruction)
        }
        ...
        /** Description of this surface obstruction. */
        fun obstructionDesc(obstructionDesc: String) = apply {
            body.obstructionDesc(obstructionDesc)
        }
        ...
        /** The height above ground level of the surface obstruction, in feet. */
        fun obstructionHeight(obstructionHeight: Double) = apply {
            body.obstructionHeight(obstructionHeight)
        }
        ...
        /** A code that indicates which side of the surface end is affected by this obstruction. */
        fun obstructionSideCode(obstructionSideCode: String) = apply {
            body.obstructionSideCode(obstructionSideCode)
        }
        ...
        /**
         * Returns an immutable instance of [SurfaceObstructionUpdateParams].
         *
         ...
         */
        fun build(): SurfaceObstructionUpdateParams =
            SurfaceObstructionUpdateParams(
                pathId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SurfaceObstructionUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SurfaceObstructionUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
