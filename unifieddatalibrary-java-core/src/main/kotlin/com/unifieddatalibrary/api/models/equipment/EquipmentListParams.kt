...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EquipmentListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentListParams: EquipmentListParams) = apply {
    ...
    override fun toString() =
        "EquipmentListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
