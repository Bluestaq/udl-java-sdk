...
class OperationListParams private constructor(
    private val idSite: String,
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperationListParams].
         *
    ...
    /** A builder for [OperationListParams]. */
    class Builder internal constructor() {

        private var idSite: String? = null
        ...
        @JvmSynthetic
        internal fun from(operationListParams: OperationListParams) =
            apply {
                idSite = operationListParams.idSite
                firstResult = operationListParams.firstResult
                maxResults = operationListParams.maxResults
                additionalHeaders = operationListParams.additionalHeaders.toBuilder()
                additionalQueryParams = operationListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OperationListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OperationListParams && idSite == other.idSite && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OperationListParams{idSite=$idSite, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
