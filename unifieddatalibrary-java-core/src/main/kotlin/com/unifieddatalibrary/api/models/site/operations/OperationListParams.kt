...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationListParams: OperationListParams) = apply {
        ...
        /** The ID of the parent site. */
        fun idSite(idSite: String) = apply { this.idSite = idSite }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OperationListParams &&
            idSite == other.idSite &&
    ...
    override fun toString() =
        "OperationListParams{idSite=$idSite, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
