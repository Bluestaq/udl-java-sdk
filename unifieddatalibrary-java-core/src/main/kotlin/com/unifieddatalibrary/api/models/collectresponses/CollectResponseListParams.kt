 ...
 */
class CollectResponseListParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectResponseListParams].
         *
    ...
    /** A builder for [CollectResponseListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectResponseListParams: CollectResponseListParams) = apply {
            createdAt = collectResponseListParams.createdAt
            firstResult = collectResponseListParams.firstResult
            maxResults = collectResponseListParams.maxResults
            additionalHeaders = collectResponseListParams.additionalHeaders.toBuilder()
            additionalQueryParams = collectResponseListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CollectResponseListParams].
         *
         ...
         */
        fun build(): CollectResponseListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CollectResponseListParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "CollectResponseListParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
