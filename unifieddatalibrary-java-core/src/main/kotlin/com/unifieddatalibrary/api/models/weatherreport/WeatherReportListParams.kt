...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WeatherReportListParams].
         *
    ...
    /** A builder for [WeatherReportListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherReportListParams: WeatherReportListParams) = apply {
            obTime = weatherReportListParams.obTime
            firstResult = weatherReportListParams.firstResult
            maxResults = weatherReportListParams.maxResults
            additionalHeaders = weatherReportListParams.additionalHeaders.toBuilder()
            additionalQueryParams = weatherReportListParams.additionalQueryParams.toBuilder()
        }

        /**
         * Datetime when a weather observation was made or forecast was issued in ISO 8601 UTC
         * datetime format with microsecond precision. (YYYY-MM-DDTHH:MM:SS.ssssssZ)
         */
        ...
        /**
         * Returns an immutable instance of [WeatherReportListParams].
         *
         ...
         */
        fun build(): WeatherReportListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WeatherReportListParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "WeatherReportListParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
