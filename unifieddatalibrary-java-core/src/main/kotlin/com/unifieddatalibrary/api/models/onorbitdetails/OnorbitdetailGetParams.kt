...
class OnorbitdetailGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OnorbitdetailGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitdetailGetParams: OnorbitdetailGetParams) =
            apply {
    ...
    override fun toString() = "OnorbitdetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
