...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellCountParams: H3GeoHexCellCountParams) = apply {
    ...
    override fun toString() =
        "H3GeoHexCellCountParams{idH3Geo=$idH3Geo, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
