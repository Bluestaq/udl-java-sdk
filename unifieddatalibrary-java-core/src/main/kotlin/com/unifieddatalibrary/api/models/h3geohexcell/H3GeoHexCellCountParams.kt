...
class H3GeoHexCellCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [H3GeoHexCellCountParams].
         *
    ...
    /** A builder for [H3GeoHexCellCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellCountParams: H3GeoHexCellCountParams) =
            apply {
                idH3Geo = h3GeoHexCellCountParams.idH3Geo
                firstResult = h3GeoHexCellCountParams.firstResult
                maxResults = h3GeoHexCellCountParams.maxResults
                additionalHeaders = h3GeoHexCellCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = h3GeoHexCellCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [H3GeoHexCellCountParams].
         *
         ...
         */
        fun build(): H3GeoHexCellCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is H3GeoHexCellCountParams && idH3Geo == other.idH3Geo && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "H3GeoHexCellCountParams{idH3Geo=$idH3Geo, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
