...
class LaunchSiteQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LaunchSiteQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteQueryhelpResponse: LaunchSiteQueryhelpResponse) = apply {
            aodrSupported = launchSiteQueryhelpResponse.aodrSupported
            classificationMarking = launchSiteQueryhelpResponse.classificationMarking
            description = launchSiteQueryhelpResponse.description
            historySupported = launchSiteQueryhelpResponse.historySupported
            name = launchSiteQueryhelpResponse.name
            parameters = launchSiteQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = launchSiteQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = launchSiteQueryhelpResponse.restSupported
            sortSupported = launchSiteQueryhelpResponse.sortSupported
            typeName = launchSiteQueryhelpResponse.typeName
            uri = launchSiteQueryhelpResponse.uri
            additionalProperties = launchSiteQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchSiteQueryhelpResponse =
    ...
    fun validate(): LaunchSiteQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
