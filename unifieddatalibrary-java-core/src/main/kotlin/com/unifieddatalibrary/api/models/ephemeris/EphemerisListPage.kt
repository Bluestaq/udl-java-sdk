...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisListPage: EphemerisListPage) = apply {
            service = ephemerisListPage.service
            params = ephemerisListPage.params
            items = ephemerisListPage.items
        }

        fun service(service: EphemerisService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EphemerisListPage &&
