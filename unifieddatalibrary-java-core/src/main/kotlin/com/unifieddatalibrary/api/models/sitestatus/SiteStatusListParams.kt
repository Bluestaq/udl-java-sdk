...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteStatusListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusListParams: SiteStatusListParams) = apply {
    ...
    override fun toString() =
        "SiteStatusListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
