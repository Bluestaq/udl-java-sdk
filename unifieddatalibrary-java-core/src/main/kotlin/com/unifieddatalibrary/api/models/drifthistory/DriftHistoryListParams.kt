...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DriftHistoryListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DriftHistoryListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DriftHistoryListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(driftHistoryListParams: DriftHistoryListParams) = apply {
            firstResult = driftHistoryListParams.firstResult
            maxResults = driftHistoryListParams.maxResults
            additionalHeaders = driftHistoryListParams.additionalHeaders.toBuilder()
            additionalQueryParams = driftHistoryListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DriftHistoryListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DriftHistoryListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DriftHistoryListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "DriftHistoryListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
