...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            resolution = historyListResponse.resolution
    ...
    override fun toString() =
        "HistoryListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, numCells=$numCells, source=$source, startTime=$startTime, id=$id, centerFreq=$centerFreq, createdAt=$createdAt, createdBy=$createdBy, endTime=$endTime, origin=$origin, origNetwork=$origNetwork, resolution=$resolution, sourceDl=$sourceDl, type=$type, additionalProperties=$additionalProperties}"
}
