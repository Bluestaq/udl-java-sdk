...
class TrackRouteQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackRouteQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TrackRouteQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackRouteQueryhelpResponse: TrackRouteQueryhelpResponse) = apply {
            aodrSupported = trackRouteQueryhelpResponse.aodrSupported
            classificationMarking = trackRouteQueryhelpResponse.classificationMarking
            description = trackRouteQueryhelpResponse.description
            historySupported = trackRouteQueryhelpResponse.historySupported
            name = trackRouteQueryhelpResponse.name
            parameters = trackRouteQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = trackRouteQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = trackRouteQueryhelpResponse.restSupported
            sortSupported = trackRouteQueryhelpResponse.sortSupported
            typeName = trackRouteQueryhelpResponse.typeName
            uri = trackRouteQueryhelpResponse.uri
            additionalProperties = trackRouteQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TrackRouteQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TrackRouteQueryhelpResponse =
    ...
    fun validate(): TrackRouteQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackRouteQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
