...
class FlightplanQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FlightplanQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [FlightplanQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightplanQueryhelpResponse: FlightplanQueryhelpResponse) =
            apply {
                aodrSupported = flightplanQueryhelpResponse.aodrSupported
                classificationMarking = flightplanQueryhelpResponse.classificationMarking
                description = flightplanQueryhelpResponse.description
                historySupported = flightplanQueryhelpResponse.historySupported
                name = flightplanQueryhelpResponse.name
                parameters = flightplanQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = flightplanQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = flightplanQueryhelpResponse.restSupported
                sortSupported = flightplanQueryhelpResponse.sortSupported
                typeName = flightplanQueryhelpResponse.typeName
                uri = flightplanQueryhelpResponse.uri
                additionalProperties = flightplanQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FlightplanQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FlightplanQueryhelpResponse =
    ...
    fun validate(): FlightplanQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
