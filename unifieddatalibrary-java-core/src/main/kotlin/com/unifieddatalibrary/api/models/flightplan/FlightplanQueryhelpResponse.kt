...
class FlightplanQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightplanQueryhelpResponse: FlightplanQueryhelpResponse) = apply {
    ...
    fun validate(): FlightplanQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
