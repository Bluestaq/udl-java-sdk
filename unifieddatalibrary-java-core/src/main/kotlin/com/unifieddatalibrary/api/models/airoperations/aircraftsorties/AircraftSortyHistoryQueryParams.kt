...
class AircraftSortyHistoryQueryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftSortyHistoryQueryParams].
         *
    ...
    /** A builder for [AircraftSortyHistoryQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyHistoryQueryParams: AircraftSortyHistoryQueryParams) =
            apply {
                plannedDepTime = aircraftSortyHistoryQueryParams.plannedDepTime
                columns = aircraftSortyHistoryQueryParams.columns
                firstResult = aircraftSortyHistoryQueryParams.firstResult
                maxResults = aircraftSortyHistoryQueryParams.maxResults
                additionalHeaders = aircraftSortyHistoryQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftSortyHistoryQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortyHistoryQueryParams].
         *
         ...
         */
        fun build(): AircraftSortyHistoryQueryParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftSortyHistoryQueryParams && plannedDepTime == other.plannedDepTime && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(plannedDepTime, columns, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AircraftSortyHistoryQueryParams{plannedDepTime=$plannedDepTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
