...
class AircraftStatusRemarkCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftStatusRemarkCreateParams].
         *
    ...
    /** A builder for [AircraftStatusRemarkCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusRemarkCreateParams: AircraftStatusRemarkCreateParams) =
            apply {
                body = aircraftStatusRemarkCreateParams.body.toBuilder()
                additionalHeaders = aircraftStatusRemarkCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftStatusRemarkCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Unique identifier of the Aircraft Status Remark record from the originating system. */
        fun altRmkId(altRmkId: String) =
            apply {
                body.altRmkId(altRmkId)
            }
        ...
        /**
         * Returns an immutable instance of [AircraftStatusRemarkCreateParams].
         *
         ...
         */
        fun build(): AircraftStatusRemarkCreateParams =
    ...
    class Body private constructor(
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idAircraftStatus=$idAircraftStatus, source=$source, text=$text, id=$id, altRmkId=$altRmkId, createdAt=$createdAt, createdBy=$createdBy, lastUpdatedAt=$lastUpdatedAt, lastUpdatedBy=$lastUpdatedBy, name=$name, origin=$origin, origNetwork=$origNetwork, sourceDl=$sourceDl, timestamp=$timestamp, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "AircraftStatusRemarkCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
