...
/**
 * Service operation to take a single Aircraft Status Remark record as a POST body and ingest into
 * the database. A specific role is required to perform this service operation. Please contact the
 * UDL team for assistance.
 */
class AircraftStatusRemarkCreateParams
private constructor(
        ...
        internal fun from(aircraftStatusRemarkCreateParams: AircraftStatusRemarkCreateParams) =
            apply {
                ...
                additionalQueryParams =
                    aircraftStatusRemarkCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idAircraftStatus=$idAircraftStatus, source=$source, text=$text, id=$id, altRmkId=$altRmkId, createdAt=$createdAt, createdBy=$createdBy, lastUpdatedAt=$lastUpdatedAt, lastUpdatedBy=$lastUpdatedBy, name=$name, origin=$origin, origNetwork=$origNetwork, sourceDl=$sourceDl, timestamp=$timestamp, additionalProperties=$additionalProperties}"
    }
