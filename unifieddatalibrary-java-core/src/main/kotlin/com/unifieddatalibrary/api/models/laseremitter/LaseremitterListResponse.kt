 ...
 * energy.
 */
class LaseremitterListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaseremitterListResponse].
         *
    ...
    /** A builder for [LaseremitterListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laseremitterListResponse: LaseremitterListResponse) = apply {
            classificationMarking = laseremitterListResponse.classificationMarking
            dataMode = laseremitterListResponse.dataMode
            laserName = laseremitterListResponse.laserName
            laserType = laseremitterListResponse.laserType
            source = laseremitterListResponse.source
            id = laseremitterListResponse.id
            atmosphericTransmission = laseremitterListResponse.atmosphericTransmission
            beamOutputPower = laseremitterListResponse.beamOutputPower
            beamWaist = laseremitterListResponse.beamWaist
            createdAt = laseremitterListResponse.createdAt
            createdBy = laseremitterListResponse.createdBy
            divergence = laseremitterListResponse.divergence
            idEntity = laseremitterListResponse.idEntity
            isOperational = laseremitterListResponse.isOperational
            maxDuration = laseremitterListResponse.maxDuration
            maxFocusRange = laseremitterListResponse.maxFocusRange
            minFocusRange = laseremitterListResponse.minFocusRange
            origin = laseremitterListResponse.origin
            origNetwork = laseremitterListResponse.origNetwork
            pulseFluence = laseremitterListResponse.pulseFluence
            pulsePeakPower = laseremitterListResponse.pulsePeakPower
            pulseRepFreq = laseremitterListResponse.pulseRepFreq
            pulseShape = laseremitterListResponse.pulseShape
            pulseWidth = laseremitterListResponse.pulseWidth
            sourceDl = laseremitterListResponse.sourceDl
            wavelength = laseremitterListResponse.wavelength
            additionalProperties = laseremitterListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LaseremitterListResponse].
         *
         ...
         */
        fun build(): LaseremitterListResponse =
    ...
    fun validate(): LaseremitterListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaseremitterListResponse &&
    ...
    override fun toString() =
        "LaseremitterListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, laserName=$laserName, laserType=$laserType, source=$source, id=$id, atmosphericTransmission=$atmosphericTransmission, beamOutputPower=$beamOutputPower, beamWaist=$beamWaist, createdAt=$createdAt, createdBy=$createdBy, divergence=$divergence, idEntity=$idEntity, isOperational=$isOperational, maxDuration=$maxDuration, maxFocusRange=$maxFocusRange, minFocusRange=$minFocusRange, origin=$origin, origNetwork=$origNetwork, pulseFluence=$pulseFluence, pulsePeakPower=$pulsePeakPower, pulseRepFreq=$pulseRepFreq, pulseShape=$pulseShape, pulseWidth=$pulseWidth, sourceDl=$sourceDl, wavelength=$wavelength, additionalProperties=$additionalProperties}"
}
