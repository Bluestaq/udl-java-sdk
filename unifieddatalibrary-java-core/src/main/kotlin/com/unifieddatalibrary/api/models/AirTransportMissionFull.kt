...
private constructor(
    ...
    private val aircraftSorties: JsonField<List<AircraftsortieFull>>,
     ...
     *
     * Unlike [aircraftSorties], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("aircraftSorties")
    @ExcludeMissing
    fun _aircraftSorties(): JsonField<List<AircraftsortieFull>> = aircraftSorties
    ...
    class Builder internal constructor() {
        ...
        private var aircraftSorties: JsonField<MutableList<AircraftsortieFull>>? = null
