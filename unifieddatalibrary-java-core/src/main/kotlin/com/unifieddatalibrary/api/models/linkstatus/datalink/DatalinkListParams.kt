...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatalinkListParams].
         *
    ...
    /** A builder for [DatalinkListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datalinkListParams: DatalinkListParams) = apply {
            startTime = datalinkListParams.startTime
            firstResult = datalinkListParams.firstResult
            maxResults = datalinkListParams.maxResults
            additionalHeaders = datalinkListParams.additionalHeaders.toBuilder()
            additionalQueryParams = datalinkListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DatalinkListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DatalinkListParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "DatalinkListParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
