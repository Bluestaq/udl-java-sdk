...
class PoiGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PoiGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiGetResponse: PoiGetResponse) =
            apply {
                classificationMarking = poiGetResponse.classificationMarking
                dataMode = poiGetResponse.dataMode
                name = poiGetResponse.name
                poiid = poiGetResponse.poiid
                source = poiGetResponse.source
                ts = poiGetResponse.ts
                id = poiGetResponse.id
                activity = poiGetResponse.activity
                agjson = poiGetResponse.agjson
                alt = poiGetResponse.alt
                andims = poiGetResponse.andims
                area = poiGetResponse.area
                asrid = poiGetResponse.asrid
                asset = poiGetResponse.asset
                atext = poiGetResponse.atext
                atype = poiGetResponse.atype
                az = poiGetResponse.az
                beNumber = poiGetResponse.beNumber
                ce = poiGetResponse.ce
                cntct = poiGetResponse.cntct
                conf = poiGetResponse.conf
                createdAt = poiGetResponse.createdAt
                createdBy = poiGetResponse.createdBy
                desc = poiGetResponse.desc
                el = poiGetResponse.el
                elle = poiGetResponse.elle.map { it.toMutableList() }
                env = poiGetResponse.env
                groups = poiGetResponse.groups.map { it.toMutableList() }
                how = poiGetResponse.how
                ident = poiGetResponse.ident
                idWeatherReport = poiGetResponse.idWeatherReport.map { it.toMutableList() }
                lat = poiGetResponse.lat
                le = poiGetResponse.le
                lon = poiGetResponse.lon
                msnid = poiGetResponse.msnid
                orientation = poiGetResponse.orientation
                origin = poiGetResponse.origin
                origNetwork = poiGetResponse.origNetwork
                plat = poiGetResponse.plat
                pps = poiGetResponse.pps
                pri = poiGetResponse.pri
                sourceDl = poiGetResponse.sourceDl
                spec = poiGetResponse.spec
                srcIds = poiGetResponse.srcIds.map { it.toMutableList() }
                srcTyps = poiGetResponse.srcTyps.map { it.toMutableList() }
                stale = poiGetResponse.stale
                start = poiGetResponse.start
                tags = poiGetResponse.tags.map { it.toMutableList() }
                transactionId = poiGetResponse.transactionId
                trkid = poiGetResponse.trkid
                type = poiGetResponse.type
                urls = poiGetResponse.urls.map { it.toMutableList() }
                additionalProperties = poiGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PoiGetResponse].
         *
