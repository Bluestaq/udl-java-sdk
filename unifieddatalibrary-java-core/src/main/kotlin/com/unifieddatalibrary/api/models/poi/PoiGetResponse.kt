...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiGetResponse: PoiGetResponse) = apply {
    ...
    fun validate(): PoiGetResponse = apply {
        if (validated) {
            return@apply
        }
