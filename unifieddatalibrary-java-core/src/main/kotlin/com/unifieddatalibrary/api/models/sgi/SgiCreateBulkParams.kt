...
/**
 * Service operation intended for initial integration only, to take a list of SGI as a POST body and
 * ingest into the database. This operation is not intended to be used for automated feeds into UDL.
 * Data providers should contact the UDL team for specific role assignments and for instructions on
 * setting up a permanent feed through an alternate mechanism.
 */
class SgiCreateBulkParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SgiCreateBulkParams].
         *
    ...
    /** A builder for [SgiCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sgiCreateBulkParams: SgiCreateBulkParams) = apply {
            body = sgiCreateBulkParams.body.toMutableList()
            additionalHeaders = sgiCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = sgiCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SgiCreateBulkParams].
         *
    ...
    private constructor(
        ...
        @JsonProperty("sgiDate") @ExcludeMissing private val sgiDate: JsonField<OffsetDateTime>,
        @JsonProperty("source") @ExcludeMissing private val source: JsonField<String>,
        @JsonProperty("id") @ExcludeMissing private val id: JsonField<String>,
        @JsonProperty("analyzerAttenuation")
        @ExcludeMissing
        private val analyzerAttenuation: JsonField<Double>,
        @JsonProperty("ap") @ExcludeMissing private val ap: JsonField<Double>,
        @JsonProperty("apDuration") @ExcludeMissing private val apDuration: JsonField<Int>,
        @JsonProperty("coeffDegree") @ExcludeMissing private val coeffDegree: JsonField<List<Int>>,
        @JsonProperty("coeffOrder") @ExcludeMissing private val coeffOrder: JsonField<List<Int>>,
        @JsonProperty("createdAt") @ExcludeMissing private val createdAt: JsonField<OffsetDateTime>,
        @JsonProperty("createdBy") @ExcludeMissing private val createdBy: JsonField<String>,
        @JsonProperty("ctce") @ExcludeMissing private val ctce: JsonField<List<Double>>,
        @JsonProperty("ctci") @ExcludeMissing private val ctci: JsonField<List<Double>>,
        @JsonProperty("dst") @ExcludeMissing private val dst: JsonField<Double>,
        @JsonProperty("dtc") @ExcludeMissing private val dtc: JsonField<Double>,
        @JsonProperty("e10") @ExcludeMissing private val e10: JsonField<Double>,
        @JsonProperty("e54") @ExcludeMissing private val e54: JsonField<Double>,
        @JsonProperty("f10") @ExcludeMissing private val f10: JsonField<Double>,
        @JsonProperty("f10High") @ExcludeMissing private val f10High: JsonField<Double>,
        @JsonProperty("f10Low") @ExcludeMissing private val f10Low: JsonField<Double>,
        @JsonProperty("f54") @ExcludeMissing private val f54: JsonField<Double>,
        @JsonProperty("f81") @ExcludeMissing private val f81: JsonField<Double>,
        @JsonProperty("frequencies")
        @ExcludeMissing
        private val frequencies: JsonField<List<Double>>,
        @JsonProperty("gamma") @ExcludeMissing private val gamma: JsonField<Int>,
        @JsonProperty("idSensor") @ExcludeMissing private val idSensor: JsonField<String>,
        @JsonProperty("kIndex") @ExcludeMissing private val kIndex: JsonField<Int>,
        @JsonProperty("kp") @ExcludeMissing private val kp: JsonField<Double>,
        @JsonProperty("kpDuration") @ExcludeMissing private val kpDuration: JsonField<Int>,
        @JsonProperty("m10") @ExcludeMissing private val m10: JsonField<Double>,
        @JsonProperty("m54") @ExcludeMissing private val m54: JsonField<Double>,
        @JsonProperty("mode") @ExcludeMissing private val mode: JsonField<Int>,
        @JsonProperty("normFactor") @ExcludeMissing private val normFactor: JsonField<Double>,
        ...
        @JsonProperty("precedence") @ExcludeMissing private val precedence: JsonField<Precedence>,
        @JsonProperty("rawFileURI") @ExcludeMissing private val rawFileUri: JsonField<String>,
        @JsonProperty("rbDuration") @ExcludeMissing private val rbDuration: JsonField<Int>,
        @JsonProperty("rbIndex") @ExcludeMissing private val rbIndex: JsonField<Double>,
        @JsonProperty("rbRegionCode") @ExcludeMissing private val rbRegionCode: JsonField<Int>,
        @JsonProperty("s10") @ExcludeMissing private val s10: JsonField<Double>,
        @JsonProperty("s54") @ExcludeMissing private val s54: JsonField<Double>,
        @JsonProperty("state") @ExcludeMissing private val state: JsonField<State>,
        @JsonProperty("stationName") @ExcludeMissing private val stationName: JsonField<String>,
        @JsonProperty("stce") @ExcludeMissing private val stce: JsonField<List<Double>>,
        @JsonProperty("stci") @ExcludeMissing private val stci: JsonField<List<Double>>,
        @JsonProperty("sunspotNum") @ExcludeMissing private val sunspotNum: JsonField<Double>,
        @JsonProperty("sunspotNumHigh")
        @ExcludeMissing
        private val sunspotNumHigh: JsonField<Double>,
        @JsonProperty("sunspotNumLow") @ExcludeMissing private val sunspotNumLow: JsonField<Double>,
        ...
        @JsonProperty("y10") @ExcludeMissing private val y10: JsonField<Double>,
        @JsonProperty("y54") @ExcludeMissing private val y54: JsonField<Double>,
    ) {
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun observedBaseline(): Optional<List<Int>> =
            observedBaseline.getOptional("observedBaseline")
         ...
         *
         * Unlike [analyzerAttenuation], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("analyzerAttenuation")
        @ExcludeMissing
        ...
        @ExcludeMissing
        fun _coeffOrder(): JsonField<List<Int>> = coeffOrder
        ...
        @ExcludeMissing
        fun _normFactor(): JsonField<Double> = normFactor
         ...
         *
         * Unlike [rbRegionCode], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("rbRegionCode")
        @ExcludeMissing
        fun _rbRegionCode(): JsonField<Int> = rbRegionCode
        ...
        @ExcludeMissing
        fun _stationName(): JsonField<String> = stationName
        ...
        @ExcludeMissing
        fun _sunspotNum(): JsonField<Double> = sunspotNum

        /**
         * Returns the raw JSON value of [sunspotNumHigh].
         *
         * Unlike [sunspotNumHigh], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("sunspotNumHigh")
        @ExcludeMissing
         ...
         *
         * Unlike [sunspotNumLow], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                sgiDate = body.sgiDate
                source = body.source
                id = body.id
                analyzerAttenuation = body.analyzerAttenuation
                ap = body.ap
                apDuration = body.apDuration
                coeffDegree = body.coeffDegree.map { it.toMutableList() }
                coeffOrder = body.coeffOrder.map { it.toMutableList() }
                createdAt = body.createdAt
                createdBy = body.createdBy
                ctce = body.ctce.map { it.toMutableList() }
                ctci = body.ctci.map { it.toMutableList() }
                dst = body.dst
                dtc = body.dtc
                e10 = body.e10
                e54 = body.e54
                f10 = body.f10
                f10High = body.f10High
                f10Low = body.f10Low
                f54 = body.f54
                f81 = body.f81
                ...
                kIndex = body.kIndex
                kp = body.kp
                kpDuration = body.kpDuration
                m10 = body.m10
                m54 = body.m54
                mode = body.mode
                normFactor = body.normFactor
                observedBaseline = body.observedBaseline.map { it.toMutableList() }
                origin = body.origin
                ...
                rbDuration = body.rbDuration
                rbIndex = body.rbIndex
                rbRegionCode = body.rbRegionCode
                s10 = body.s10
                s54 = body.s54
                state = body.state
                stationName = body.stationName
                stce = body.stce.map { it.toMutableList() }
                stci = body.stci.map { it.toMutableList() }
                sunspotNum = body.sunspotNum
                sunspotNumHigh = body.sunspotNumHigh
                sunspotNumLow = body.sunspotNumLow
            ...
            /**
             * ISO8601 UTC Time the data was received and processed from the source. Typically a
             * source provides data for a date window with each transmission including past,
             ...
             * predicted value. Note: sgiDate defines the start time of the time window for this
             * data record.
             */
            ...
            /**
             * Signal analyzer's input attenuation level, in decibels. Attenuation is a setting on
             * the hardware that measures the power of a signal.
             */
             ...
             *
             * You should usually call [Builder.analyzerAttenuation] with a well-typed [Double]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /**
             * The time, in hours, for which the Ap index value is valid. If null, a span of 3 hours
             * is assumed.
             */
             ...
             *
             * You should usually call [Builder.apDuration] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.coeffOrder] with a well-typed `List<Int>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * temperature (DTC) difference. Each array element corresponds to the positional index
             * of the coeffDegree and coeffOrder arrays.
             */
             ...
             *
             * You should usually call [Builder.ctce] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * temperature (DTX) difference. Each array element corresponds to the positional index
             * of the coeffDegree and coeffOrder arrays.
             */
             ...
             *
             * You should usually call [Builder.ctci] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Extreme Ultraviolet (EUV) proxy, E10.7, in x10-22 Watts per meter squared per Hertz,
             * is the integrated solar EUV energy flux at the top of atmosphere and normalized to
             * solar flux units.
             */
            ...
            /**
             * Daily F10.7 index - high range, in x10-22 Watts per meter squared per Hertz. This
             * field usually applies to forecast values, based on the consensus of the Solar Cycle
             * 24 Prediction Panel.
             */
             ...
             *
             * You should usually call [Builder.f10High] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.f10Low] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The maximum measured gamma deflection during the kpDuration timespan. If kpDuration
             * is null, a 3 hour duration should be assumed.
             */
             ...
             * timespan. The K-Index is a unitless measure (0 - 9) of the deviation in the Earth's
             * magnetic field from normal at the station geographic location, with 0 indicating the
             * absence of geomagnetic disturbance, and 9 indicating the most significant
            ...
            /**
             * The Planetary K-index (Kp) over the kpDuration timespan. The Kp-Index is the average
             * K-Index for the entire Earth, utilizing a unitless scale (0-9, in incremenets of
             * 1/3), with 0 indicating the absence of geomagnetic disturbance, and 9 indicating the
             ...
             *
             * You should usually call [Builder.kpDuration] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.mode] with a well-typed [Int] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
            ...
            /**
             * The normalization factor that has already been applied to the index value prior to
             * record ingest. Typically used to normalize the index value to a particular interval.
             * Units of the normalization factor may vary depending on the provider of this data
             * (REACH, POES, CEASE3, etc.).
             */
             ...
             *
             * You should usually call [Builder.normFactor] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Observed baseline values of the frequencies specified in the frequencies field, in
             * solar flux units. The baseline values will be used to help detect abnormal readings
             * from the sun that might indicate a flare or other solar activity.
             */
             ...
             *
             * You should usually call [Builder.observedBaseline] with a well-typed `List<Int>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             * supported value.
             */
            fun precedence(precedence: JsonField<Precedence>) = apply {
             ...
             * rbDuration is null, a 24 hour duration should be assumed. Note: rbDuration defines
             * the length of the time window for this data record. The time window start time is
             * defined by sgiDate, and the time window end time is defined by sgiDate plus
             * rbDuration.
             */
             ...
             *
             * You should usually call [Builder.rbDuration] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The value of the radiation belt index. This is the ratio of current intensity of a
             * radiation belt to long-term average value. It's long-term average should be close
             * to 1. Depending on the type of belt sensor, this ratio may measure Flux (number of
             * particles / (cm^2 sec energy solid-angle)), dose rate (rad per second), or relative
             * counts of particles per time (counts per second). The index value may also be
             * normalized, the normalization value typically represents an average of the sensor
             * measurements taken within a region over a given time interval. See the normFactor
             * field for the specific normalization factor, if provided.
             */
             ...
             *
             * You should usually call [Builder.rbIndex] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Region code for the associated radiation belt index. This is the code associated with
             * the corresponding radiation belt location. See the provider card for reference to
             * specific region code definitions.
             */
             ...
             * supported value.
             */
            fun rbRegionCode(rbRegionCode: JsonField<Int>) = apply {
                this.rbRegionCode = rbRegionCode
            }
             ...
             *
             * You should usually call [Builder.stationName] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun stationName(stationName: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.stce] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.stci] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.sunspotNum] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Daily sunspot number - high range. This field usually applies to forecast values,
             * based on the consensus of the Solar Cycle 24 Prediction Panel.
             */
            fun sunspotNumHigh(sunspotNumHigh: Double) =
                sunspotNumHigh(JsonField.of(sunspotNumHigh))
             ...
             *
             * You should usually call [Builder.sunspotNumLow] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Daily Y10.7 index for 85-90 km heating of N2, O2, H2O, NO by solar coronal. 0.1-0.8
             * nm and Lya 121 nm emissions in x10-22 Watts per meter squared per Hertz.
             */
            ...
            /**
             * 54 day Y10.7 index for 85-90 km heating of N2, O2, H2O, NO by solar coronal. 0.1-0.8
             * nm and Lya 121 nm emissions in x10-22 Watts per meter squared per Hertz.
             */
         ...
         * Emergency, Z = Flash).
         */
        class Precedence @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
            ...
            enum class Value {
                ...
                Z,
                /**
                 * An enum member indicating that [Precedence] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    Z -> Known.Z
                        ...
                        throw UnifieddatalibraryInvalidDataException("Unknown Precedence: $value")
                }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && effectiveDate == other.effectiveDate && sgiDate == other.sgiDate && source == other.source && id == other.id && analyzerAttenuation == other.analyzerAttenuation && ap == other.ap && apDuration == other.apDuration && coeffDegree == other.coeffDegree && coeffOrder == other.coeffOrder && createdAt == other.createdAt && createdBy == other.createdBy && ctce == other.ctce && ctci == other.ctci && dst == other.dst && dtc == other.dtc && e10 == other.e10 && e54 == other.e54 && f10 == other.f10 && f10High == other.f10High && f10Low == other.f10Low && f54 == other.f54 && f81 == other.f81 && frequencies == other.frequencies && gamma == other.gamma && idSensor == other.idSensor && kIndex == other.kIndex && kp == other.kp && kpDuration == other.kpDuration && m10 == other.m10 && m54 == other.m54 && mode == other.mode && normFactor == other.normFactor && observedBaseline == other.observedBaseline && origin == other.origin && origNetwork == other.origNetwork && origSensorId == other.origSensorId && powers == other.powers && precedence == other.precedence && rawFileUri == other.rawFileUri && rbDuration == other.rbDuration && rbIndex == other.rbIndex && rbRegionCode == other.rbRegionCode && s10 == other.s10 && s54 == other.s54 && state == other.state && stationName == other.stationName && stce == other.stce && stci == other.stci && sunspotNum == other.sunspotNum && sunspotNumHigh == other.sunspotNumHigh && sunspotNumLow == other.sunspotNumLow && tags == other.tags && transactionId == other.transactionId && type == other.type && y10 == other.y10 && y54 == other.y54 /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, effectiveDate, sgiDate, source, id, analyzerAttenuation, ap, apDuration, coeffDegree, coeffOrder, createdAt, createdBy, ctce, ctci, dst, dtc, e10, e54, f10, f10High, f10Low, f54, f81, frequencies, gamma, idSensor, kIndex, kp, kpDuration, m10, m54, mode, normFactor, observedBaseline, origin, origNetwork, origSensorId, powers, precedence, rawFileUri, rbDuration, rbIndex, rbRegionCode, s10, s54, state, stationName, stce, stci, sunspotNum, sunspotNumHigh, sunspotNumLow, tags, transactionId, type, y10, y54) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, effectiveDate=$effectiveDate, sgiDate=$sgiDate, source=$source, id=$id, analyzerAttenuation=$analyzerAttenuation, ap=$ap, apDuration=$apDuration, coeffDegree=$coeffDegree, coeffOrder=$coeffOrder, createdAt=$createdAt, createdBy=$createdBy, ctce=$ctce, ctci=$ctci, dst=$dst, dtc=$dtc, e10=$e10, e54=$e54, f10=$f10, f10High=$f10High, f10Low=$f10Low, f54=$f54, f81=$f81, frequencies=$frequencies, gamma=$gamma, idSensor=$idSensor, kIndex=$kIndex, kp=$kp, kpDuration=$kpDuration, m10=$m10, m54=$m54, mode=$mode, normFactor=$normFactor, observedBaseline=$observedBaseline, origin=$origin, origNetwork=$origNetwork, origSensorId=$origSensorId, powers=$powers, precedence=$precedence, rawFileUri=$rawFileUri, rbDuration=$rbDuration, rbIndex=$rbIndex, rbRegionCode=$rbRegionCode, s10=$s10, s54=$s54, state=$state, stationName=$stationName, stce=$stce, stci=$stci, sunspotNum=$sunspotNum, sunspotNumHigh=$sunspotNumHigh, sunspotNumLow=$sunspotNumLow, tags=$tags, transactionId=$transactionId, type=$type, y10=$y10, y54=$y54}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SgiCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SgiCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
