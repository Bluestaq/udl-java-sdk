...
/**
 * Service operation to update an SeradataSpacecraftDetails. A specific role is required to perform
 * this service operation. Please contact the UDL team for assistance.
 */
class SeradataSpacecraftDetailUpdateParams
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun additionalMissionsGroups(): Optional<String> = body.additionalMissionsGroups()
     ...
     *   if the server responded with an unexpected value).
     */
    fun annualInsuredDepreciationFactor(): Optional<Double> = body.annualInsuredDepreciationFactor()
    ...
    fun annualInsuredDepreciationFactorEstimated(): Optional<Boolean> =
        body.annualInsuredDepreciationFactorEstimated()
     ...
     *   if the server responded with an unexpected value).
     */
    fun busId(): Optional<String> = body.busId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun capabilityLost(): Optional<Double> = body.capabilityLost()
     ...
     *   if the server responded with an unexpected value).
     */
    fun capacityLost(): Optional<Double> = body.capacityLost()
     ...
     *   if the server responded with an unexpected value).
     */
    fun catalogNumber(): Optional<Int> = body.catalogNumber()
     ...
     *   if the server responded with an unexpected value).
     */
    fun collisionRiskCm(): Optional<Double> = body.collisionRiskCm()
     ...
     *   if the server responded with an unexpected value).
     */
    fun collisionRiskMm(): Optional<Double> = body.collisionRiskMm()
     ...
     *   if the server responded with an unexpected value).
     */
    fun combinedCostEstimated(): Optional<Boolean> = body.combinedCostEstimated()
     ...
     *   if the server responded with an unexpected value).
     */
    fun combinedNewCost(): Optional<Double> = body.combinedNewCost()
     ...
     *   if the server responded with an unexpected value).
     */
    fun commercialLaunch(): Optional<Boolean> = body.commercialLaunch()
     ...
     *   if the server responded with an unexpected value).
     */
    fun costEstimated(): Optional<Boolean> = body.costEstimated()
     ...
     *   if the server responded with an unexpected value).
     */
    fun cubesatDispenserType(): Optional<String> = body.cubesatDispenserType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun currentAge(): Optional<Double> = body.currentAge()
     ...
     *   if the server responded with an unexpected value).
     */
    fun dateOfObservation(): Optional<OffsetDateTime> = body.dateOfObservation()
     ...
     *   if the server responded with an unexpected value).
     */
    fun designLife(): Optional<Int> = body.designLife()
     ...
     *   if the server responded with an unexpected value).
     */
    fun expectedLife(): Optional<Int> = body.expectedLife()
     ...
     *   if the server responded with an unexpected value).
     */
    fun insuranceLossesTotal(): Optional<Double> = body.insuranceLossesTotal()
     ...
     *   if the server responded with an unexpected value).
     */
    fun insuranceNotes(): Optional<String> = body.insuranceNotes()
     ...
     *   if the server responded with an unexpected value).
     */
    fun insurancePremiumAtLaunch(): Optional<Double> = body.insurancePremiumAtLaunch()
    ...
    fun insurancePremiumAtLaunchEstimated(): Optional<Boolean> =
        body.insurancePremiumAtLaunchEstimated()
     ...
     *   if the server responded with an unexpected value).
     */
    fun insuredAtLaunch(): Optional<Boolean> = body.insuredAtLaunch()
     ...
     *   if the server responded with an unexpected value).
     */
    fun insuredValueAtLaunch(): Optional<Double> = body.insuredValueAtLaunch()
     ...
     *   if the server responded with an unexpected value).
     */
    fun insuredValueLaunchEstimated(): Optional<Boolean> = body.insuredValueLaunchEstimated()
     ...
     *   if the server responded with an unexpected value).
     */
    fun intlNumber(): Optional<String> = body.intlNumber()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchArranger(): Optional<String> = body.launchArranger()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchArrangerCountry(): Optional<String> = body.launchArrangerCountry()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchCharacteristic(): Optional<String> = body.launchCharacteristic()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchCost(): Optional<Double> = body.launchCost()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchCostEstimated(): Optional<Boolean> = body.launchCostEstimated()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchCountry(): Optional<String> = body.launchCountry()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchDate(): Optional<OffsetDateTime> = body.launchDate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchDateRemarks(): Optional<String> = body.launchDateRemarks()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchId(): Optional<String> = body.launchId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchNotes(): Optional<String> = body.launchNotes()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchNumber(): Optional<String> = body.launchNumber()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchProvider(): Optional<String> = body.launchProvider()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchProviderCountry(): Optional<String> = body.launchProviderCountry()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchProviderFlightNumber(): Optional<String> = body.launchProviderFlightNumber()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchSiteId(): Optional<String> = body.launchSiteId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchSiteName(): Optional<String> = body.launchSiteName()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchType(): Optional<String> = body.launchType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun launchVehicleId(): Optional<String> = body.launchVehicleId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun leased(): Optional<Boolean> = body.leased()
     ...
     *   if the server responded with an unexpected value).
     */
    fun nameAtLaunch(): Optional<String> = body.nameAtLaunch()
     ...
     *   if the server responded with an unexpected value).
     */
    fun newCost(): Optional<Double> = body.newCost()
     ...
     *   if the server responded with an unexpected value).
     */
    fun numHumans(): Optional<Int> = body.numHumans()
     ...
     *   if the server responded with an unexpected value).
     */
    fun operator(): Optional<String> = body.operator()
     ...
     *   if the server responded with an unexpected value).
     */
    fun operatorCountry(): Optional<String> = body.operatorCountry()
     ...
     *   if the server responded with an unexpected value).
     */
    fun orbitCategory(): Optional<String> = body.orbitCategory()
     ...
     *   if the server responded with an unexpected value).
     */
    fun orbitSubCategory(): Optional<String> = body.orbitSubCategory()
     ...
     *   if the server responded with an unexpected value).
     */
    fun orderDate(): Optional<OffsetDateTime> = body.orderDate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun primaryMissionGroup(): Optional<String> = body.primaryMissionGroup()
     ...
     *   if the server responded with an unexpected value).
     */
    fun primeManufacturerOrgId(): Optional<String> = body.primeManufacturerOrgId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun programName(): Optional<String> = body.programName()
     ...
     *   if the server responded with an unexpected value).
     */
    fun reusableFlights(): Optional<String> = body.reusableFlights()
     ...
     *   if the server responded with an unexpected value).
     */
    fun reusedHullName(): Optional<String> = body.reusedHullName()
     ...
     *   if the server responded with an unexpected value).
     */
    fun sector(): Optional<String> = body.sector()
     ...
     *   if the server responded with an unexpected value).
     */
    fun stabilizer(): Optional<String> = body.stabilizer()
     ...
     *   if the server responded with an unexpected value).
     */
    fun totalClaims(): Optional<Int> = body.totalClaims()
     ...
     *   if the server responded with an unexpected value).
     */
    fun totalFatalities(): Optional<Int> = body.totalFatalities()
     ...
     *   if the server responded with an unexpected value).
     */
    fun totalInjuries(): Optional<Int> = body.totalInjuries()
     ...
     *   if the server responded with an unexpected value).
     */
    fun totalPayloadPower(): Optional<Double> = body.totalPayloadPower()
     ...
     *   if the server responded with an unexpected value).
     */
    fun youtubeLaunchLink(): Optional<String> = body.youtubeLaunchLink()
     ...
     * unexpected type.
     */
    fun _additionalMissionsGroups(): JsonField<String> = body._additionalMissionsGroups()
     ...
     * unexpected type.
     */
    fun _annualInsuredDepreciationFactor(): JsonField<Double> =
        body._annualInsuredDepreciationFactor()
    ...
    fun _annualInsuredDepreciationFactorEstimated(): JsonField<Boolean> =
        body._annualInsuredDepreciationFactorEstimated()
     ...
     */
    fun _busId(): JsonField<String> = body._busId()
     ...
     */
    fun _capabilityLost(): JsonField<Double> = body._capabilityLost()
     ...
     */
    fun _capacityLost(): JsonField<Double> = body._capacityLost()
     ...
     */
    fun _catalogNumber(): JsonField<Int> = body._catalogNumber()
     ...
     */
    fun _collisionRiskCm(): JsonField<Double> = body._collisionRiskCm()
     ...
     */
    fun _collisionRiskMm(): JsonField<Double> = body._collisionRiskMm()
     ...
     * type.
     */
    fun _combinedCostEstimated(): JsonField<Boolean> = body._combinedCostEstimated()
     ...
     */
    fun _combinedNewCost(): JsonField<Double> = body._combinedNewCost()
     ...
     * type.
     */
    fun _commercialLaunch(): JsonField<Boolean> = body._commercialLaunch()
     ...
     */
    fun _costEstimated(): JsonField<Boolean> = body._costEstimated()
     ...
     * type.
     */
    fun _cubesatDispenserType(): JsonField<String> = body._cubesatDispenserType()
     ...
     */
    fun _currentAge(): JsonField<Double> = body._currentAge()
     ...
     * type.
     */
    fun _dateOfObservation(): JsonField<OffsetDateTime> = body._dateOfObservation()
     ...
     */
    fun _designLife(): JsonField<Int> = body._designLife()
     ...
     */
    fun _expectedLife(): JsonField<Int> = body._expectedLife()
     ...
     * type.
     */
    fun _insuranceLossesTotal(): JsonField<Double> = body._insuranceLossesTotal()
     ...
     */
    fun _insuranceNotes(): JsonField<String> = body._insuranceNotes()
     ...
     * unexpected type.
     */
    fun _insurancePremiumAtLaunch(): JsonField<Double> = body._insurancePremiumAtLaunch()
     ...
     * an unexpected type.
     */
    fun _insurancePremiumAtLaunchEstimated(): JsonField<Boolean> =
        body._insurancePremiumAtLaunchEstimated()
     ...
     */
    fun _insuredAtLaunch(): JsonField<Boolean> = body._insuredAtLaunch()
     ...
     * type.
     */
    fun _insuredValueAtLaunch(): JsonField<Double> = body._insuredValueAtLaunch()
     ...
     * unexpected type.
     */
    fun _insuredValueLaunchEstimated(): JsonField<Boolean> = body._insuredValueLaunchEstimated()
     ...
     */
    fun _intlNumber(): JsonField<String> = body._intlNumber()
     ...
     */
    fun _launchArranger(): JsonField<String> = body._launchArranger()
     ...
     * type.
     */
    fun _launchArrangerCountry(): JsonField<String> = body._launchArrangerCountry()
     ...
     * type.
     */
    fun _launchCharacteristic(): JsonField<String> = body._launchCharacteristic()
     ...
     */
    fun _launchCost(): JsonField<Double> = body._launchCost()
     ...
     * type.
     */
    fun _launchCostEstimated(): JsonField<Boolean> = body._launchCostEstimated()
     ...
     */
    fun _launchCountry(): JsonField<String> = body._launchCountry()
     ...
     */
    fun _launchDate(): JsonField<OffsetDateTime> = body._launchDate()
     ...
     * type.
     */
    fun _launchDateRemarks(): JsonField<String> = body._launchDateRemarks()
     ...
     */
    fun _launchId(): JsonField<String> = body._launchId()
     ...
     */
    fun _launchNotes(): JsonField<String> = body._launchNotes()
     ...
     */
    fun _launchNumber(): JsonField<String> = body._launchNumber()
     ...
     */
    fun _launchProvider(): JsonField<String> = body._launchProvider()
     ...
     * type.
     */
    fun _launchProviderCountry(): JsonField<String> = body._launchProviderCountry()
     ...
     * unexpected type.
     */
    fun _launchProviderFlightNumber(): JsonField<String> = body._launchProviderFlightNumber()
     ...
     */
    fun _launchSiteId(): JsonField<String> = body._launchSiteId()
     ...
     */
    fun _launchSiteName(): JsonField<String> = body._launchSiteName()
     ...
     */
    fun _launchType(): JsonField<String> = body._launchType()
     ...
     */
    fun _launchVehicleId(): JsonField<String> = body._launchVehicleId()
     ...
     */
    fun _leased(): JsonField<Boolean> = body._leased()
     ...
     */
    fun _nameAtLaunch(): JsonField<String> = body._nameAtLaunch()
     ...
     */
    fun _newCost(): JsonField<Double> = body._newCost()
     ...
     */
    fun _numHumans(): JsonField<Int> = body._numHumans()
     ...
     */
    fun _operator(): JsonField<String> = body._operator()
     ...
     */
    fun _operatorCountry(): JsonField<String> = body._operatorCountry()
     ...
     */
    fun _orbitCategory(): JsonField<String> = body._orbitCategory()
     ...
     * type.
     */
    fun _orbitSubCategory(): JsonField<String> = body._orbitSubCategory()
     ...
     */
    fun _orderDate(): JsonField<OffsetDateTime> = body._orderDate()
     ...
     * type.
     */
    fun _primaryMissionGroup(): JsonField<String> = body._primaryMissionGroup()
     ...
     * unexpected type.
     */
    fun _primeManufacturerOrgId(): JsonField<String> = body._primeManufacturerOrgId()
     ...
     */
    fun _programName(): JsonField<String> = body._programName()
     ...
     */
    fun _reusableFlights(): JsonField<String> = body._reusableFlights()
     ...
     */
    fun _reusedHullName(): JsonField<String> = body._reusedHullName()
     ...
     */
    fun _sector(): JsonField<String> = body._sector()
     ...
     */
    fun _stabilizer(): JsonField<String> = body._stabilizer()
     ...
     */
    fun _totalClaims(): JsonField<Int> = body._totalClaims()
     ...
     */
    fun _totalFatalities(): JsonField<Int> = body._totalFatalities()
     ...
     */
    fun _totalInjuries(): JsonField<Int> = body._totalInjuries()
     ...
     * type.
     */
    fun _totalPayloadPower(): JsonField<Double> = body._totalPayloadPower()
     ...
     * type.
     */
    fun _youtubeLaunchLink(): JsonField<String> = body._youtubeLaunchLink()
    ...
    /** A builder for [SeradataSpacecraftDetailUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataSpacecraftDetailUpdateParams: SeradataSpacecraftDetailUpdateParams
        ) = apply {
            pathId = seradataSpacecraftDetailUpdateParams.pathId
            body = seradataSpacecraftDetailUpdateParams.body.toBuilder()
            additionalHeaders = seradataSpacecraftDetailUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                seradataSpacecraftDetailUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Spacecraft additional missions and groups. */
        fun additionalMissionsGroups(additionalMissionsGroups: String) = apply {
            body.additionalMissionsGroups(additionalMissionsGroups)
        }
        ...
        /** Annual insured depreciaion factor as a percent fraction. */
        fun annualInsuredDepreciationFactor(annualInsuredDepreciationFactor: Double) = apply {
            body.annualInsuredDepreciationFactor(annualInsuredDepreciationFactor)
        }
        ...
        fun annualInsuredDepreciationFactorEstimated(
            ...
            body.annualInsuredDepreciationFactorEstimated(annualInsuredDepreciationFactorEstimated)
        }
        ...
        /** Spacecraft Bus ID. */
        fun busId(busId: String) = apply { body.busId(busId) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun busId(busId: JsonField<String>) = apply { body.busId(busId) }

        /** Total capability lost as a percent fraction. */
        fun capabilityLost(capabilityLost: Double) = apply { body.capabilityLost(capabilityLost) }
        ...
        fun capabilityLost(capabilityLost: JsonField<Double>) = apply {
            body.capabilityLost(capabilityLost)
        }

        /** Total capacity lost as a percent fraction. */
        fun capacityLost(capacityLost: Double) = apply { body.capacityLost(capacityLost) }
        ...
        fun capacityLost(capacityLost: JsonField<Double>) = apply {
            body.capacityLost(capacityLost)
        }

        /** NORAD satellite number if available. */
        fun catalogNumber(catalogNumber: Int) = apply { body.catalogNumber(catalogNumber) }
        ...
        fun catalogNumber(catalogNumber: JsonField<Int>) = apply {
            body.catalogNumber(catalogNumber)
        }

        /** Spacecraft collision risk 1cm sqm latest. */
        fun collisionRiskCm(collisionRiskCm: Double) = apply {
            body.collisionRiskCm(collisionRiskCm)
        }
        ...
        /** Spacecraft collision risk 1mm sqm latest. */
        fun collisionRiskMm(collisionRiskMm: Double) = apply {
            body.collisionRiskMm(collisionRiskMm)
        }
        ...
        /** Boolean indicating if the spacecraft combined new cost is estimated. */
        fun combinedCostEstimated(combinedCostEstimated: Boolean) = apply {
            body.combinedCostEstimated(combinedCostEstimated)
        }
        ...
        /** Combined cost of spacecraft at new in M USD. */
        fun combinedNewCost(combinedNewCost: Double) = apply {
            body.combinedNewCost(combinedNewCost)
        }
        ...
        /** Boolean indicating if the launch was commercial. */
        fun commercialLaunch(commercialLaunch: Boolean) = apply {
            body.commercialLaunch(commercialLaunch)
        }
        ...
        /** Boolean indicating if the spacecraft cost is estimated. */
        fun costEstimated(costEstimated: Boolean) = apply { body.costEstimated(costEstimated) }
        ...
        fun costEstimated(costEstimated: JsonField<Boolean>) = apply {
            body.costEstimated(costEstimated)
        }
        ...
        /** Cubesat dispenser type. */
        fun cubesatDispenserType(cubesatDispenserType: String) = apply {
            body.cubesatDispenserType(cubesatDispenserType)
        }
        ...
        /** Current age in years. */
        fun currentAge(currentAge: Double) = apply { body.currentAge(currentAge) }
         ...
         * value.
         */
        fun currentAge(currentAge: JsonField<Double>) = apply { body.currentAge(currentAge) }

        /** Spacecraft date of observation. */
        fun dateOfObservation(dateOfObservation: OffsetDateTime) = apply {
            body.dateOfObservation(dateOfObservation)
        }
        ...
        /** Spacecraft design life in days. */
        fun designLife(designLife: Int) = apply { body.designLife(designLife) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun designLife(designLife: JsonField<Int>) = apply { body.designLife(designLife) }
        ...
        /** Spacecraft expected life in days. */
        fun expectedLife(expectedLife: Int) = apply { body.expectedLife(expectedLife) }
         ...
         * value.
         */
        fun expectedLife(expectedLife: JsonField<Int>) = apply { body.expectedLife(expectedLife) }
        ...
        /** Spacecraft total insurance losses as a fraction. */
        fun insuranceLossesTotal(insuranceLossesTotal: Double) = apply {
            body.insuranceLossesTotal(insuranceLossesTotal)
        }
        ...
        /** Insurance notes for the spacecraft. */
        fun insuranceNotes(insuranceNotes: String) = apply { body.insuranceNotes(insuranceNotes) }
        ...
        fun insuranceNotes(insuranceNotes: JsonField<String>) = apply {
            body.insuranceNotes(insuranceNotes)
        }

        /** Insurance premium at launch in M USD. */
        fun insurancePremiumAtLaunch(insurancePremiumAtLaunch: Double) = apply {
            body.insurancePremiumAtLaunch(insurancePremiumAtLaunch)
        }
        ...
        /** Boolean indicating if the spacecraft insurancePremiumAtLaunch is estimated. */
        fun insurancePremiumAtLaunchEstimated(insurancePremiumAtLaunchEstimated: Boolean) = apply {
            body.insurancePremiumAtLaunchEstimated(insurancePremiumAtLaunchEstimated)
        }
        ...
        ) = apply { body.insurancePremiumAtLaunchEstimated(insurancePremiumAtLaunchEstimated) }

        /** Boolean indicating if the spacecraft was insured at launch. */
        fun insuredAtLaunch(insuredAtLaunch: Boolean) = apply {
            body.insuredAtLaunch(insuredAtLaunch)
        }
        ...
        /** Insured value of spacecraft at launch in M USD. */
        fun insuredValueAtLaunch(insuredValueAtLaunch: Double) = apply {
            body.insuredValueAtLaunch(insuredValueAtLaunch)
        }
        ...
        /** Boolean indicating if the spacecraft insured value at launch is estimated. */
        fun insuredValueLaunchEstimated(insuredValueLaunchEstimated: Boolean) = apply {
            body.insuredValueLaunchEstimated(insuredValueLaunchEstimated)
        }
        ...
        /** Seradata international number. */
        fun intlNumber(intlNumber: String) = apply { body.intlNumber(intlNumber) }
         ...
         * value.
         */
        fun intlNumber(intlNumber: JsonField<String>) = apply { body.intlNumber(intlNumber) }
        ...
        /** Spacecraft launch arranger. */
        fun launchArranger(launchArranger: String) = apply { body.launchArranger(launchArranger) }
        ...
        fun launchArranger(launchArranger: JsonField<String>) = apply {
            body.launchArranger(launchArranger)
        }

        /** Spacecraft launch arranger country. */
        fun launchArrangerCountry(launchArrangerCountry: String) = apply {
            body.launchArrangerCountry(launchArrangerCountry)
        }
        ...
        /** Seradata launch characteristic (e.g. Expendable, Reusable (New), etc). */
        fun launchCharacteristic(launchCharacteristic: String) = apply {
            body.launchCharacteristic(launchCharacteristic)
        }
        ...
        /** Cost of launch in M USD. */
        fun launchCost(launchCost: Double) = apply { body.launchCost(launchCost) }
         ...
         * value.
         */
        fun launchCost(launchCost: JsonField<Double>) = apply { body.launchCost(launchCost) }

        /** Boolean indicating if the spacecraft launch cost is estimated. */
        fun launchCostEstimated(launchCostEstimated: Boolean) = apply {
            body.launchCostEstimated(launchCostEstimated)
        }
        ...
        /** Seradata launch country. */
        fun launchCountry(launchCountry: String) = apply { body.launchCountry(launchCountry) }
        ...
        fun launchCountry(launchCountry: JsonField<String>) = apply {
            body.launchCountry(launchCountry)
        }

        /** Launch date. */
        fun launchDate(launchDate: OffsetDateTime) = apply { body.launchDate(launchDate) }
        ...
        fun launchDate(launchDate: JsonField<OffsetDateTime>) = apply {
            body.launchDate(launchDate)
        }

        /** Seradata remarks on launch date. */
        fun launchDateRemarks(launchDateRemarks: String) = apply {
            body.launchDateRemarks(launchDateRemarks)
        }
        ...
        /** Seradata launch ID. */
        fun launchId(launchId: String) = apply { body.launchId(launchId) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun launchId(launchId: JsonField<String>) = apply { body.launchId(launchId) }
        ...
        /** Insurance notes for the spacecraft. */
        fun launchNotes(launchNotes: String) = apply { body.launchNotes(launchNotes) }
         ...
         * value.
         */
        fun launchNotes(launchNotes: JsonField<String>) = apply { body.launchNotes(launchNotes) }

        /** Seradata launch number. */
        fun launchNumber(launchNumber: String) = apply { body.launchNumber(launchNumber) }
        ...
        fun launchNumber(launchNumber: JsonField<String>) = apply {
            body.launchNumber(launchNumber)
        }

        /** Seradata launch provider. */
        fun launchProvider(launchProvider: String) = apply { body.launchProvider(launchProvider) }
        ...
        fun launchProvider(launchProvider: JsonField<String>) = apply {
            body.launchProvider(launchProvider)
        }

        /** Seradata launch provider country. */
        fun launchProviderCountry(launchProviderCountry: String) = apply {
            body.launchProviderCountry(launchProviderCountry)
        }
        ...
        /** Seradata launch vehicle family. */
        fun launchProviderFlightNumber(launchProviderFlightNumber: String) = apply {
            body.launchProviderFlightNumber(launchProviderFlightNumber)
        }
        ...
        /** Seradata Launch Site ID. */
        fun launchSiteId(launchSiteId: String) = apply { body.launchSiteId(launchSiteId) }
        ...
        fun launchSiteId(launchSiteId: JsonField<String>) = apply {
            body.launchSiteId(launchSiteId)
        }

        /** Launch Site Name. */
        fun launchSiteName(launchSiteName: String) = apply { body.launchSiteName(launchSiteName) }
        ...
        fun launchSiteName(launchSiteName: JsonField<String>) = apply {
            body.launchSiteName(launchSiteName)
        }

        /** Seradata launch type (e.g. Launched, Future, etc). */
        fun launchType(launchType: String) = apply { body.launchType(launchType) }
         ...
         * value.
         */
        fun launchType(launchType: JsonField<String>) = apply { body.launchType(launchType) }

        /** Seradata launch ID. */
        fun launchVehicleId(launchVehicleId: String) = apply {
            body.launchVehicleId(launchVehicleId)
        }
        ...
        /** Boolean indicating if the spacecraft was leased. */
        fun leased(leased: Boolean) = apply { body.leased(leased) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun leased(leased: JsonField<Boolean>) = apply { body.leased(leased) }
        ...
        /** Spacecraft name at launch. */
        fun nameAtLaunch(nameAtLaunch: String) = apply { body.nameAtLaunch(nameAtLaunch) }
        ...
        fun nameAtLaunch(nameAtLaunch: JsonField<String>) = apply {
            body.nameAtLaunch(nameAtLaunch)
        }

        /** Cost of spacecraft at new in M USD. */
        fun newCost(newCost: Double) = apply { body.newCost(newCost) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun newCost(newCost: JsonField<Double>) = apply { body.newCost(newCost) }
        ...
        /** Number of humans carried on spacecraft. */
        fun numHumans(numHumans: Int) = apply { body.numHumans(numHumans) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun numHumans(numHumans: JsonField<Int>) = apply { body.numHumans(numHumans) }

        /** Spacecraft operator name. */
        fun operator(operator: String) = apply { body.operator(operator) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun operator(operator: JsonField<String>) = apply { body.operator(operator) }

        /** Spacecraft operator country. */
        fun operatorCountry(operatorCountry: String) = apply {
            body.operatorCountry(operatorCountry)
        }
        ...
        /** Spacecraft orbit category (e.g GEO, LEO, etc). */
        fun orbitCategory(orbitCategory: String) = apply { body.orbitCategory(orbitCategory) }
        ...
        fun orbitCategory(orbitCategory: JsonField<String>) = apply {
            body.orbitCategory(orbitCategory)
        }

        /** Spacecraft sub orbit category (e.g LEO - Sun-synchronous, Geostationary, etc). */
        fun orbitSubCategory(orbitSubCategory: String) = apply {
            body.orbitSubCategory(orbitSubCategory)
        }
        ...
        /** Spacecraft order date. */
        fun orderDate(orderDate: OffsetDateTime) = apply { body.orderDate(orderDate) }
         ...
         * supported value.
         */
        fun orderDate(orderDate: JsonField<OffsetDateTime>) = apply { body.orderDate(orderDate) }
        ...
        /** Spacecraft primary mission and group. */
        fun primaryMissionGroup(primaryMissionGroup: String) = apply {
            body.primaryMissionGroup(primaryMissionGroup)
        }
        ...
        /** UUID of the prime manufacturer organization, if available. */
        fun primeManufacturerOrgId(primeManufacturerOrgId: String) = apply {
            body.primeManufacturerOrgId(primeManufacturerOrgId)
        }
        ...
        /** Spacecraft program name. */
        fun programName(programName: String) = apply { body.programName(programName) }
         ...
         * value.
         */
        fun programName(programName: JsonField<String>) = apply { body.programName(programName) }
        ...
        /** Spacecraft reusable flights. */
        fun reusableFlights(reusableFlights: String) = apply {
            body.reusableFlights(reusableFlights)
        }
        ...
        /** Spacecraft reused hull name. */
        fun reusedHullName(reusedHullName: String) = apply { body.reusedHullName(reusedHullName) }
        ...
        fun reusedHullName(reusedHullName: JsonField<String>) = apply {
            body.reusedHullName(reusedHullName)
        }

        /** Seradata sector (e.g. Commercial, Military, Civil/Other). */
        fun sector(sector: String) = apply { body.sector(sector) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun sector(sector: JsonField<String>) = apply { body.sector(sector) }
        ...
        /** Spacecraft stabilizer (e.g. 3-Axis, Gravity Gradiant, etc). */
        fun stabilizer(stabilizer: String) = apply { body.stabilizer(stabilizer) }
         ...
         * value.
         */
        fun stabilizer(stabilizer: JsonField<String>) = apply { body.stabilizer(stabilizer) }
        ...
        /** Number of insurance claims for this spacecraft. */
        fun totalClaims(totalClaims: Int) = apply { body.totalClaims(totalClaims) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun totalClaims(totalClaims: JsonField<Int>) = apply { body.totalClaims(totalClaims) }

        /** Number of fatalities related to this spacecraft. */
        fun totalFatalities(totalFatalities: Int) = apply { body.totalFatalities(totalFatalities) }
        ...
        fun totalFatalities(totalFatalities: JsonField<Int>) = apply {
            body.totalFatalities(totalFatalities)
        }

        /** Number of injuries related to this spacecraft. */
        fun totalInjuries(totalInjuries: Int) = apply { body.totalInjuries(totalInjuries) }
        ...
        fun totalInjuries(totalInjuries: JsonField<Int>) = apply {
            body.totalInjuries(totalInjuries)
        }

        /** Mass dry in kg. */
        fun totalPayloadPower(totalPayloadPower: Double) = apply {
            body.totalPayloadPower(totalPayloadPower)
        }
        ...
        /** Youtube link of launch. */
        fun youtubeLaunchLink(youtubeLaunchLink: String) = apply {
            body.youtubeLaunchLink(youtubeLaunchLink)
        }
        ...
        /**
         * Returns an immutable instance of [SeradataSpacecraftDetailUpdateParams].
         *
         ...
         */
        fun build(): SeradataSpacecraftDetailUpdateParams =
            SeradataSpacecraftDetailUpdateParams(
                pathId,
                body.build(),
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("designLife")
            @ExcludeMissing
            designLife: JsonField<Int> = JsonMissing.of(),
            ...
            @ExcludeMissing
            launchId: JsonField<String> = JsonMissing.of(),
            ...
            @ExcludeMissing
            totalClaims: JsonField<Int> = JsonMissing.of(),
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun launchDateRemarks(): Optional<String> =
            launchDateRemarks.getOptional("launchDateRemarks")
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun totalPayloadPower(): Optional<Double> =
            totalPayloadPower.getOptional("totalPayloadPower")
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun youtubeLaunchLink(): Optional<String> =
            youtubeLaunchLink.getOptional("youtubeLaunchLink")
         ...
         * Returns the raw JSON value of [annualInsuredDepreciationFactor].
         *
         * Unlike [annualInsuredDepreciationFactor], this method doesn't throw if the JSON field has
         * an unexpected type.
         */
        @JsonProperty("annualInsuredDepreciationFactor")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [capabilityLost].
         *
         * Unlike [capabilityLost], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("capabilityLost")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [capacityLost].
         *
         * Unlike [capacityLost], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("capacityLost")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [catalogNumber].
         *
         * Unlike [catalogNumber], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("catalogNumber")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [collisionRiskCm].
         *
         * Unlike [collisionRiskCm], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("collisionRiskCM")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [collisionRiskMm].
         *
         * Unlike [collisionRiskMm], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("collisionRiskMM")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [combinedCostEstimated].
         *
         * Unlike [combinedCostEstimated], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("combinedCostEstimated")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [combinedNewCost].
         *
         * Unlike [combinedNewCost], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("combinedNewCost")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [costEstimated].
         *
         * Unlike [costEstimated], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("costEstimated")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [cubesatDispenserType].
         *
         * Unlike [cubesatDispenserType], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("cubesatDispenserType")
        @ExcludeMissing
        ...
        @JsonProperty("currentAge")
        @ExcludeMissing
        fun _currentAge(): JsonField<Double> = currentAge
         ...
         * Returns the raw JSON value of [expectedLife].
         *
         * Unlike [expectedLife], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("expectedLife")
        @ExcludeMissing
        fun _expectedLife(): JsonField<Int> = expectedLife
         ...
         * Returns the raw JSON value of [insuranceLossesTotal].
         *
         * Unlike [insuranceLossesTotal], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("insuranceLossesTotal")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [insuranceNotes].
         *
         * Unlike [insuranceNotes], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("insuranceNotes")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [insurancePremiumAtLaunchEstimated].
         *
         * Unlike [insurancePremiumAtLaunchEstimated], this method doesn't throw if the JSON field
         ...
         * Returns the raw JSON value of [insuredAtLaunch].
         *
         * Unlike [insuredAtLaunch], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("insuredAtLaunch")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [insuredValueAtLaunch].
         *
         * Unlike [insuredValueAtLaunch], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("insuredValueAtLaunch")
        @ExcludeMissing
        ...
        @JsonProperty("intlNumber")
        @ExcludeMissing
        fun _intlNumber(): JsonField<String> = intlNumber
         ...
         * Returns the raw JSON value of [launchArranger].
         *
         * Unlike [launchArranger], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("launchArranger")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [launchArrangerCountry].
         *
         * Unlike [launchArrangerCountry], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("launchArrangerCountry")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [launchCharacteristic].
         *
         * Unlike [launchCharacteristic], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("launchCharacteristic")
        @ExcludeMissing
        ...
        @JsonProperty("launchCost")
        @ExcludeMissing
        fun _launchCost(): JsonField<Double> = launchCost

        /**
         * Returns the raw JSON value of [launchCostEstimated].
         *
         * Unlike [launchCostEstimated], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("launchCostEstimated")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [launchCountry].
         *
         * Unlike [launchCountry], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("launchCountry")
        @ExcludeMissing
        ...
        @JsonProperty("launchNotes")
        @ExcludeMissing
        fun _launchNotes(): JsonField<String> = launchNotes

        /**
         * Returns the raw JSON value of [launchNumber].
         *
         * Unlike [launchNumber], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("launchNumber")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [launchProvider].
         *
         * Unlike [launchProvider], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("launchProvider")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [launchProviderCountry].
         *
         * Unlike [launchProviderCountry], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("launchProviderCountry")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [launchSiteName].
         *
         * Unlike [launchSiteName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("launchSiteName")
        @ExcludeMissing
        ...
        @JsonProperty("launchType")
        @ExcludeMissing
        fun _launchType(): JsonField<String> = launchType

        /**
         * Returns the raw JSON value of [launchVehicleId].
         *
         * Unlike [launchVehicleId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("launchVehicleId")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [nameAtLaunch].
         *
         * Unlike [nameAtLaunch], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("nameAtLaunch")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [operatorCountry].
         *
         * Unlike [operatorCountry], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("operatorCountry")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [orbitCategory].
         *
         * Unlike [orbitCategory], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("orbitCategory")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [primaryMissionGroup].
         *
         * Unlike [primaryMissionGroup], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("primaryMissionGroup")
        @ExcludeMissing
        ...
        @JsonProperty("programName")
        @ExcludeMissing
        fun _programName(): JsonField<String> = programName
         ...
         * Returns the raw JSON value of [reusableFlights].
         *
         * Unlike [reusableFlights], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("reusableFlights")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [reusedHullName].
         *
         * Unlike [reusedHullName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("reusedHullName")
        @ExcludeMissing
        ...
        @JsonProperty("stabilizer")
        @ExcludeMissing
        fun _stabilizer(): JsonField<String> = stabilizer
        ...
        @JsonProperty("totalClaims")
        @ExcludeMissing
        fun _totalClaims(): JsonField<Int> = totalClaims

        /**
         * Returns the raw JSON value of [totalFatalities].
         *
         * Unlike [totalFatalities], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("totalFatalities")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [totalInjuries].
         *
         * Unlike [totalInjuries], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("totalInjuries")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            private var annualInsuredDepreciationFactorEstimated: JsonField<Boolean> =
                JsonMissing.of()
            ...
            internal fun from(body: Body) = apply {
                ...
                source = body.source
                bodyId = body.bodyId
                additionalMissionsGroups = body.additionalMissionsGroups
                altitude = body.altitude
                annualInsuredDepreciationFactor = body.annualInsuredDepreciationFactor
                annualInsuredDepreciationFactorEstimated =
                    body.annualInsuredDepreciationFactorEstimated
                apogee = body.apogee
                busId = body.busId
                capabilityLost = body.capabilityLost
                capacityLost = body.capacityLost
                catalogNumber = body.catalogNumber
                collisionRiskCm = body.collisionRiskCm
                collisionRiskMm = body.collisionRiskMm
                combinedCostEstimated = body.combinedCostEstimated
                combinedNewCost = body.combinedNewCost
                commercialLaunch = body.commercialLaunch
                constellation = body.constellation
                costEstimated = body.costEstimated
                createdAt = body.createdAt
                createdBy = body.createdBy
                cubesatDispenserType = body.cubesatDispenserType
                currentAge = body.currentAge
                dateOfObservation = body.dateOfObservation
                description = body.description
                designLife = body.designLife
                dryMass = body.dryMass
                expectedLife = body.expectedLife
                geoPosition = body.geoPosition
                idOnOrbit = body.idOnOrbit
                inclination = body.inclination
                insuranceLossesTotal = body.insuranceLossesTotal
                insuranceNotes = body.insuranceNotes
                insurancePremiumAtLaunch = body.insurancePremiumAtLaunch
                insurancePremiumAtLaunchEstimated = body.insurancePremiumAtLaunchEstimated
                insuredAtLaunch = body.insuredAtLaunch
                insuredValueAtLaunch = body.insuredValueAtLaunch
                insuredValueLaunchEstimated = body.insuredValueLaunchEstimated
                intlNumber = body.intlNumber
                lat = body.lat
                launchArranger = body.launchArranger
                launchArrangerCountry = body.launchArrangerCountry
                launchCharacteristic = body.launchCharacteristic
                launchCost = body.launchCost
                launchCostEstimated = body.launchCostEstimated
                launchCountry = body.launchCountry
                launchDate = body.launchDate
                launchDateRemarks = body.launchDateRemarks
                launchId = body.launchId
                launchMass = body.launchMass
                launchNotes = body.launchNotes
                launchNumber = body.launchNumber
                launchProvider = body.launchProvider
                launchProviderCountry = body.launchProviderCountry
                launchProviderFlightNumber = body.launchProviderFlightNumber
                launchSiteId = body.launchSiteId
                launchSiteName = body.launchSiteName
                launchType = body.launchType
                launchVehicleId = body.launchVehicleId
                leased = body.leased
                lifeLost = body.lifeLost
                lon = body.lon
                massCategory = body.massCategory
                nameAtLaunch = body.nameAtLaunch
                newCost = body.newCost
                notes = body.notes
                numHumans = body.numHumans
                operator = body.operator
                operatorCountry = body.operatorCountry
                orbitCategory = body.orbitCategory
                orbitSubCategory = body.orbitSubCategory
                ...
                period = body.period
                primaryMissionGroup = body.primaryMissionGroup
                primeManufacturerOrgId = body.primeManufacturerOrgId
                programName = body.programName
                quantity = body.quantity
                reusableFlights = body.reusableFlights
                reusedHullName = body.reusedHullName
                sector = body.sector
                serialNumber = body.serialNumber
                stabilizer = body.stabilizer
                status = body.status
                totalClaims = body.totalClaims
                totalFatalities = body.totalFatalities
                totalInjuries = body.totalInjuries
                totalPayloadPower = body.totalPayloadPower
                youtubeLaunchLink = body.youtubeLaunchLink
             ...
             * undocumented or not yet supported value.
             */
            fun annualInsuredDepreciationFactor(
                annualInsuredDepreciationFactor: JsonField<Double>
            ) = apply { this.annualInsuredDepreciationFactor = annualInsuredDepreciationFactor }
             ...
             * Sets [Builder.busId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.busId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** Total capability lost as a percent fraction. */
            fun capabilityLost(capabilityLost: Double) =
                capabilityLost(JsonField.of(capabilityLost))
             ...
             * Sets [Builder.capacityLost] to an arbitrary JSON value.
             *
             * You should usually call [Builder.capacityLost] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun capacityLost(capacityLost: JsonField<Double>) = apply {
             ...
             * Sets [Builder.catalogNumber] to an arbitrary JSON value.
             *
             * You should usually call [Builder.catalogNumber] with a well-typed [Int] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun catalogNumber(catalogNumber: JsonField<Int>) = apply {
             ...
             * Sets [Builder.combinedCostEstimated] to an arbitrary JSON value.
             *
             * You should usually call [Builder.combinedCostEstimated] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun combinedCostEstimated(combinedCostEstimated: JsonField<Boolean>) = apply {
             ...
             * Sets [Builder.cubesatDispenserType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.cubesatDispenserType] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun cubesatDispenserType(cubesatDispenserType: JsonField<String>) = apply {
             ...
             * Sets [Builder.currentAge] to an arbitrary JSON value.
             *
             * You should usually call [Builder.currentAge] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.dateOfObservation] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dateOfObservation] with a well-typed
             ...
             * Sets [Builder.designLife] to an arbitrary JSON value.
             *
             * You should usually call [Builder.designLife] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * supported value.
             */
            fun expectedLife(expectedLife: JsonField<Int>) = apply {
             ...
             * Sets [Builder.insuranceLossesTotal] to an arbitrary JSON value.
             *
             * You should usually call [Builder.insuranceLossesTotal] with a well-typed [Double]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun insuranceLossesTotal(insuranceLossesTotal: JsonField<Double>) = apply {
            ...
            /** Insurance notes for the spacecraft. */
            fun insuranceNotes(insuranceNotes: String) =
                insuranceNotes(JsonField.of(insuranceNotes))
             ...
             * Sets [Builder.insuredValueAtLaunch] to an arbitrary JSON value.
             *
             * You should usually call [Builder.insuredValueAtLaunch] with a well-typed [Double]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun insuredValueAtLaunch(insuredValueAtLaunch: JsonField<Double>) = apply {
             ...
             * Sets [Builder.insuredValueLaunchEstimated] to an arbitrary JSON value.
             *
             * You should usually call [Builder.insuredValueLaunchEstimated] with a well-typed
             * [Boolean] value instead. This method is primarily for setting the field to an
             * undocumented or not yet supported value.
             */
            fun insuredValueLaunchEstimated(insuredValueLaunchEstimated: JsonField<Boolean>) =
                apply {
             ...
             * Sets [Builder.intlNumber] to an arbitrary JSON value.
             *
             * You should usually call [Builder.intlNumber] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** Spacecraft launch arranger. */
            fun launchArranger(launchArranger: String) =
                launchArranger(JsonField.of(launchArranger))
             ...
             * Sets [Builder.launchArrangerCountry] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchArrangerCountry] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun launchArrangerCountry(launchArrangerCountry: JsonField<String>) = apply {
             ...
             * Sets [Builder.launchCharacteristic] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchCharacteristic] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun launchCharacteristic(launchCharacteristic: JsonField<String>) = apply {
             ...
             * Sets [Builder.launchCost] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchCost] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.launchCostEstimated] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchCostEstimated] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun launchCostEstimated(launchCostEstimated: JsonField<Boolean>) = apply {
             ...
             * Sets [Builder.launchCountry] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchCountry] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun launchCountry(launchCountry: JsonField<String>) = apply {
             ...
             * Sets [Builder.launchId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.launchNotes] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchNotes] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun launchNotes(launchNotes: JsonField<String>) = apply {
                this.launchNotes = launchNotes
            }
             ...
             * Sets [Builder.launchNumber] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchNumber] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun launchNumber(launchNumber: JsonField<String>) = apply {
            ...
            /** Seradata launch provider. */
            fun launchProvider(launchProvider: String) =
                launchProvider(JsonField.of(launchProvider))
             ...
             * Sets [Builder.launchProviderCountry] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchProviderCountry] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun launchProviderCountry(launchProviderCountry: JsonField<String>) = apply {
             ...
             * Sets [Builder.launchProviderFlightNumber] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchProviderFlightNumber] with a well-typed
            ...
            /** Launch Site Name. */
            fun launchSiteName(launchSiteName: String) =
                launchSiteName(JsonField.of(launchSiteName))
             ...
             * Sets [Builder.launchType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.launchType] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.leased] to an arbitrary JSON value.
             *
             * You should usually call [Builder.leased] with a well-typed [Boolean] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Mass category (e.g. 2500 - 3500kg - Large Satellite, 10 - 100 kg - Microsatellite,
             * etc).
             */
             ...
             * Sets [Builder.nameAtLaunch] to an arbitrary JSON value.
             *
             * You should usually call [Builder.nameAtLaunch] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun nameAtLaunch(nameAtLaunch: JsonField<String>) = apply {
             ...
             * Sets [Builder.newCost] to an arbitrary JSON value.
             *
             * You should usually call [Builder.newCost] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.numHumans] to an arbitrary JSON value.
             *
             * You should usually call [Builder.numHumans] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.orbitCategory] to an arbitrary JSON value.
             *
             * You should usually call [Builder.orbitCategory] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun orbitCategory(orbitCategory: JsonField<String>) = apply {
             ...
             * supported value.
             */
            fun orderDate(orderDate: JsonField<OffsetDateTime>) = apply {
             ...
             * Sets [Builder.primaryMissionGroup] to an arbitrary JSON value.
             *
             * You should usually call [Builder.primaryMissionGroup] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun primaryMissionGroup(primaryMissionGroup: JsonField<String>) = apply {
             ...
             * Sets [Builder.primeManufacturerOrgId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.primeManufacturerOrgId] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun primeManufacturerOrgId(primeManufacturerOrgId: JsonField<String>) = apply {
             ...
             * Sets [Builder.programName] to an arbitrary JSON value.
             *
             * You should usually call [Builder.programName] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun programName(programName: JsonField<String>) = apply {
            ...
            /** Spacecraft reused hull name. */
            fun reusedHullName(reusedHullName: String) =
                reusedHullName(JsonField.of(reusedHullName))
             ...
             * Sets [Builder.sector] to an arbitrary JSON value.
             *
             * You should usually call [Builder.sector] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.stabilizer] to an arbitrary JSON value.
             *
             * You should usually call [Builder.stabilizer] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.totalClaims] to an arbitrary JSON value.
             *
             * You should usually call [Builder.totalClaims] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** Number of fatalities related to this spacecraft. */
            fun totalFatalities(totalFatalities: Int) =
                totalFatalities(JsonField.of(totalFatalities))

            /**
             * Sets [Builder.totalFatalities] to an arbitrary JSON value.
             *
             * You should usually call [Builder.totalFatalities] with a well-typed [Int] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalFatalities(totalFatalities: JsonField<Int>) = apply {
             ...
             * Sets [Builder.totalInjuries] to an arbitrary JSON value.
             *
             * You should usually call [Builder.totalInjuries] with a well-typed [Int] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalInjuries(totalInjuries: JsonField<Int>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeradataSpacecraftDetailUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SeradataSpacecraftDetailUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
