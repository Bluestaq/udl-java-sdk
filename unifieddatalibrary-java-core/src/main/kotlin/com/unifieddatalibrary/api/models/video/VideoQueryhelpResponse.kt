...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [VideoQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VideoQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(videoQueryhelpResponse: VideoQueryhelpResponse) = apply {
            aodrSupported = videoQueryhelpResponse.aodrSupported
            classificationMarking = videoQueryhelpResponse.classificationMarking
            description = videoQueryhelpResponse.description
            historySupported = videoQueryhelpResponse.historySupported
            name = videoQueryhelpResponse.name
            parameters = videoQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = videoQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = videoQueryhelpResponse.restSupported
            sortSupported = videoQueryhelpResponse.sortSupported
            typeName = videoQueryhelpResponse.typeName
            uri = videoQueryhelpResponse.uri
            additionalProperties = videoQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VideoQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VideoQueryhelpResponse =
    ...
    fun validate(): VideoQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VideoQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
