...
class OnorbitantennaGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OnorbitantennaGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitantennaGetParams: OnorbitantennaGetParams) =
            apply {
    ...
    override fun toString() = "OnorbitantennaGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
