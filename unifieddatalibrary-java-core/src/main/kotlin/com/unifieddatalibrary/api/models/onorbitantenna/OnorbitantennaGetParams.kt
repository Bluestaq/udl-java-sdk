 ...
 * particular on-orbit spacecraft. An antenna type may be associated with many different on-orbit
 * spacecraft.
 */
class OnorbitantennaGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitantennaGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OnorbitantennaGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OnorbitantennaGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitantennaGetParams: OnorbitantennaGetParams) = apply {
            id = onorbitantennaGetParams.id
            firstResult = onorbitantennaGetParams.firstResult
            maxResults = onorbitantennaGetParams.maxResults
            additionalHeaders = onorbitantennaGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = onorbitantennaGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitantennaGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitantennaGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OnorbitantennaGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OnorbitantennaGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
