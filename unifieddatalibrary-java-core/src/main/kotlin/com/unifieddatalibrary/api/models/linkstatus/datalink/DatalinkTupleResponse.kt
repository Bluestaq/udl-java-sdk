...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatalinkTupleResponse].
         *
    ...
    /** A builder for [DatalinkTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datalinkTupleResponse: DatalinkTupleResponse) = apply {
            classificationMarking = datalinkTupleResponse.classificationMarking
            dataMode = datalinkTupleResponse.dataMode
            opExName = datalinkTupleResponse.opExName
            originator = datalinkTupleResponse.originator
            source = datalinkTupleResponse.source
            startTime = datalinkTupleResponse.startTime
            id = datalinkTupleResponse.id
            ackInstUnits = datalinkTupleResponse.ackInstUnits.map { it.toMutableList() }
            ackReq = datalinkTupleResponse.ackReq
            altDiff = datalinkTupleResponse.altDiff
            canxId = datalinkTupleResponse.canxId
            canxOriginator = datalinkTupleResponse.canxOriginator
            canxSerialNum = datalinkTupleResponse.canxSerialNum
            canxSiCs = datalinkTupleResponse.canxSiCs.map { it.toMutableList() }
            canxSpecialNotation = datalinkTupleResponse.canxSpecialNotation
            canxTs = datalinkTupleResponse.canxTs
            classReasons = datalinkTupleResponse.classReasons.map { it.toMutableList() }
            classSource = datalinkTupleResponse.classSource
            consecDecorr = datalinkTupleResponse.consecDecorr
            courseDiff = datalinkTupleResponse.courseDiff
            createdAt = datalinkTupleResponse.createdAt
            createdBy = datalinkTupleResponse.createdBy
            decExemptCodes = datalinkTupleResponse.decExemptCodes.map { it.toMutableList() }
            decInstDates = datalinkTupleResponse.decInstDates.map { it.toMutableList() }
            decorrWinMult = datalinkTupleResponse.decorrWinMult
            geoDatum = datalinkTupleResponse.geoDatum
            jreCallSign = datalinkTupleResponse.jreCallSign
            jreDetails = datalinkTupleResponse.jreDetails
            jrePriAdd = datalinkTupleResponse.jrePriAdd
            jreSecAdd = datalinkTupleResponse.jreSecAdd
            jreUnitDes = datalinkTupleResponse.jreUnitDes
            maxGeoPosQual = datalinkTupleResponse.maxGeoPosQual
            maxTrackQual = datalinkTupleResponse.maxTrackQual
            mgmtCode = datalinkTupleResponse.mgmtCode
            mgmtCodeMeaning = datalinkTupleResponse.mgmtCodeMeaning
            minGeoPosQual = datalinkTupleResponse.minGeoPosQual
            minTrackQual = datalinkTupleResponse.minTrackQual
            month = datalinkTupleResponse.month
            multiDuty = datalinkTupleResponse.multiDuty.map { it.toMutableList() }
            nonLinkUnitDes = datalinkTupleResponse.nonLinkUnitDes.map { it.toMutableList() }
            opExInfo = datalinkTupleResponse.opExInfo
            opExInfoAlt = datalinkTupleResponse.opExInfoAlt
            ops = datalinkTupleResponse.ops.map { it.toMutableList() }
            origin = datalinkTupleResponse.origin
            origNetwork = datalinkTupleResponse.origNetwork
            planOrigNum = datalinkTupleResponse.planOrigNum
            pocCallSign = datalinkTupleResponse.pocCallSign
            pocLat = datalinkTupleResponse.pocLat
            pocLocName = datalinkTupleResponse.pocLocName
            pocLon = datalinkTupleResponse.pocLon
            pocName = datalinkTupleResponse.pocName
            pocNums = datalinkTupleResponse.pocNums.map { it.toMutableList() }
            pocRank = datalinkTupleResponse.pocRank
            qualifier = datalinkTupleResponse.qualifier
            qualSn = datalinkTupleResponse.qualSn
            rawFileUri = datalinkTupleResponse.rawFileUri
            references = datalinkTupleResponse.references.map { it.toMutableList() }
            refPoints = datalinkTupleResponse.refPoints.map { it.toMutableList() }
            remarks = datalinkTupleResponse.remarks.map { it.toMutableList() }
            resTrackQual = datalinkTupleResponse.resTrackQual
            serialNum = datalinkTupleResponse.serialNum
            sourceDl = datalinkTupleResponse.sourceDl
            specTracks = datalinkTupleResponse.specTracks.map { it.toMutableList() }
            speedDiff = datalinkTupleResponse.speedDiff
            stopTime = datalinkTupleResponse.stopTime
            stopTimeMod = datalinkTupleResponse.stopTimeMod
            sysDefaultCode = datalinkTupleResponse.sysDefaultCode
            trackNumBlockLLs = datalinkTupleResponse.trackNumBlockLLs.map { it.toMutableList() }
            trackNumBlocks = datalinkTupleResponse.trackNumBlocks.map { it.toMutableList() }
            updatedAt = datalinkTupleResponse.updatedAt
            updatedBy = datalinkTupleResponse.updatedBy
            voiceCoord = datalinkTupleResponse.voiceCoord.map { it.toMutableList() }
            winSizeMin = datalinkTupleResponse.winSizeMin
            winSizeMult = datalinkTupleResponse.winSizeMult
            additionalProperties = datalinkTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DatalinkTupleResponse].
         *
         ...
         */
        fun build(): DatalinkTupleResponse =
    ...
    fun validate(): DatalinkTupleResponse = apply {
        if (validated) {
            return@apply
        }
