...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StagingListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StagingListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [StagingListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stagingListParams: StagingListParams) = apply {
            firstResult = stagingListParams.firstResult
            maxResults = stagingListParams.maxResults
            additionalHeaders = stagingListParams.additionalHeaders.toBuilder()
            additionalQueryParams = stagingListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [StagingListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StagingListParams =
            StagingListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StagingListParams &&
    ...
    override fun toString() =
        "StagingListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
