...
class SensorMaintenanceQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SensorMaintenanceQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorMaintenanceQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceQueryhelpResponse: SensorMaintenanceQueryhelpResponse) =
            apply {
                aodrSupported = sensorMaintenanceQueryhelpResponse.aodrSupported
                classificationMarking = sensorMaintenanceQueryhelpResponse.classificationMarking
                description = sensorMaintenanceQueryhelpResponse.description
                historySupported = sensorMaintenanceQueryhelpResponse.historySupported
                name = sensorMaintenanceQueryhelpResponse.name
                parameters = sensorMaintenanceQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = sensorMaintenanceQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = sensorMaintenanceQueryhelpResponse.restSupported
                sortSupported = sensorMaintenanceQueryhelpResponse.sortSupported
                typeName = sensorMaintenanceQueryhelpResponse.typeName
                uri = sensorMaintenanceQueryhelpResponse.uri
                additionalProperties = sensorMaintenanceQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorMaintenanceQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorMaintenanceQueryhelpResponse =
    ...
    fun validate(): SensorMaintenanceQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
