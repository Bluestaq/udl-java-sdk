...
class SensorMaintenanceQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sensorMaintenanceQueryhelpResponse: SensorMaintenanceQueryhelpResponse) =
            apply {
                ...
                parameters =
                    sensorMaintenanceQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    sensorMaintenanceQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    sensorMaintenanceQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SensorMaintenanceQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
