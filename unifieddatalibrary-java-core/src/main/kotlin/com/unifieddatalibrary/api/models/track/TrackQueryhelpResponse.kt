...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TrackQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TrackQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackQueryhelpResponse: TrackQueryhelpResponse) = apply {
            aodrSupported = trackQueryhelpResponse.aodrSupported
            classificationMarking = trackQueryhelpResponse.classificationMarking
            description = trackQueryhelpResponse.description
            historySupported = trackQueryhelpResponse.historySupported
            name = trackQueryhelpResponse.name
            parameters = trackQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = trackQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = trackQueryhelpResponse.restSupported
            sortSupported = trackQueryhelpResponse.sortSupported
            typeName = trackQueryhelpResponse.typeName
            uri = trackQueryhelpResponse.uri
            additionalProperties = trackQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TrackQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TrackQueryhelpResponse =
    ...
    fun validate(): TrackQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
