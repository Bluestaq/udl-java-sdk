...
/**
 * Service operation intended for initial integration only, to take a list of SensorCalibrations as
 ...
 */
class CalibrationCreateBulkParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalibrationCreateBulkParams].
         *
    ...
    /** A builder for [CalibrationCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationCreateBulkParams: CalibrationCreateBulkParams) = apply {
            body = calibrationCreateBulkParams.body.toMutableList()
            additionalHeaders = calibrationCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = calibrationCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CalibrationCreateBulkParams].
         *
         ...
         */
        fun build(): CalibrationCreateBulkParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CalibrationCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CalibrationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
