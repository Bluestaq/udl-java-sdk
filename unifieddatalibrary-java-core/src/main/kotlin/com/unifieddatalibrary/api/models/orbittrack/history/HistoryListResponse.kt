...
class HistoryListResponse private constructor(
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (ts.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (alt.asKnown().isPresent) 1 else 0) + (if (amplification.asKnown().isPresent) 1 else 0) + (if (angElev.asKnown().isPresent) 1 else 0) + (aouData.asKnown().getOrNull()?.size ?: 0) + (if (aouType.asKnown().isPresent) 1 else 0) + (if (callSign.asKnown().isPresent) 1 else 0) + (if (charlieLine.asKnown().isPresent) 1 else 0) + (if (chXRef.asKnown().isPresent) 1 else 0) + (if (cntnmnt.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (decay.asKnown().isPresent) 1 else 0) + (if (dummy.asKnown().isPresent) 1 else 0) + (if (feint.asKnown().isPresent) 1 else 0) + (if (hq.asKnown().isPresent) 1 else 0) + (if (idElset.asKnown().isPresent) 1 else 0) + (if (identAmp.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (iff.asKnown().isPresent) 1 else 0) + (if (installation.asKnown().isPresent) 1 else 0) + (objectType.asKnown().getOrNull()?.validity() ?: 0) + (objIdent.asKnown().getOrNull()?.validity() ?: 0) + (onOrbit.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (rdfRf.asKnown().isPresent) 1 else 0) + (if (reduced.asKnown().isPresent) 1 else 0) + (if (reinforced.asKnown().isPresent) 1 else 0) + (if (rptNum.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (satStatus.asKnown().isPresent) 1 else 0) + (if (spd.asKnown().isPresent) 1 else 0) + (if (taskForce.asKnown().isPresent) 1 else 0) + (trackSensors.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (trkId.asKnown().isPresent) 1 else 0) + (if (vehType.asKnown().isPresent) 1 else 0) + (if (xref.asKnown().isPresent) 1 else 0)
