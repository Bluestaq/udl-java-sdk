 ...
 */
class FeatureAssessmentQueryParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeatureAssessmentQueryParams].
         *
    ...
    /** A builder for [FeatureAssessmentQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentQueryParams: FeatureAssessmentQueryParams) = apply {
            idAnalyticImagery = featureAssessmentQueryParams.idAnalyticImagery
            firstResult = featureAssessmentQueryParams.firstResult
            maxResults = featureAssessmentQueryParams.maxResults
            additionalHeaders = featureAssessmentQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = featureAssessmentQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentQueryParams].
         *
         ...
         */
        fun build(): FeatureAssessmentQueryParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FeatureAssessmentQueryParams && idAnalyticImagery == other.idAnalyticImagery && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "FeatureAssessmentQueryParams{idAnalyticImagery=$idAnalyticImagery, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
