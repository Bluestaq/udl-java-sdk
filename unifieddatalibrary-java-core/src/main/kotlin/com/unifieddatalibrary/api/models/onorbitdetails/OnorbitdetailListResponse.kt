...
class OnorbitdetailListResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitdetailListResponse: OnorbitdetailListResponse) = apply {
    ...
    fun validate(): OnorbitdetailListResponse = apply {
        if (validated) {
            return@apply
        }
