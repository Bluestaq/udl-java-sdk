...
class OnorbitdetailListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("additionalMass") @ExcludeMissing additionalMass: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("adeptRadius") @ExcludeMissing adeptRadius: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("bolDeltaV") @ExcludeMissing bolDeltaV: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("bolFuelMass") @ExcludeMissing bolFuelMass: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("busCrossSection") @ExcludeMissing busCrossSection: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("busType") @ExcludeMissing busType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("colaRadius") @ExcludeMissing colaRadius: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("createdAt") @ExcludeMissing createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("createdBy") @ExcludeMissing createdBy: JsonField<String> = JsonMissing.of(),
        @JsonProperty("crossSection") @ExcludeMissing crossSection: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("currentMass") @ExcludeMissing currentMass: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("deltaVUnc") @ExcludeMissing deltaVUnc: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("depEstMasses") @ExcludeMissing depEstMasses: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("depMassUncs") @ExcludeMissing depMassUncs: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("depNames") @ExcludeMissing depNames: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("estDeltaVDuration") @ExcludeMissing estDeltaVDuration: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("fuelRemaining") @ExcludeMissing fuelRemaining: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("geoSlot") @ExcludeMissing geoSlot: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("lastObSource") @ExcludeMissing lastObSource: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("launchMassMax") @ExcludeMissing launchMassMax: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("launchMassMin") @ExcludeMissing launchMassMin: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("maneuverable") @ExcludeMissing maneuverable: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("missionTypes") @ExcludeMissing missionTypes: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("numDeployable") @ExcludeMissing numDeployable: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("solarArrayArea") @ExcludeMissing solarArrayArea: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("totalMassUnc") @ExcludeMissing totalMassUnc: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("vismagMean") @ExcludeMissing vismagMean: JsonField<Double> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _bolDeltaV(): JsonField<Double> = bolDeltaV
    ...
    @ExcludeMissing
    fun _busType(): JsonField<String> = busType
    ...
    @ExcludeMissing
    fun _deltaVUnc(): JsonField<Double> = deltaVUnc
    ...
    @ExcludeMissing
    fun _dryMass(): JsonField<Double> = dryMass

    /**
     * Returns the raw JSON value of [estDeltaVDuration].
     *
     * Unlike [estDeltaVDuration], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     */
    @JsonProperty("geoSlot")
    @ExcludeMissing
    fun _geoSlot(): JsonField<Double> = geoSlot
    ...
    @ExcludeMissing
    fun _maxDeltaV(): JsonField<Double> = maxDeltaV
    ...
    @ExcludeMissing
    fun _maxRadius(): JsonField<Double> = maxRadius
    ...
    @ExcludeMissing
    fun _numMission(): JsonField<Int> = numMission
     ...
     */
    @JsonProperty("rcsMean")
    @ExcludeMissing
    fun _rcsMean(): JsonField<Double> = rcsMean
    ...
    @ExcludeMissing
    fun _refSource(): JsonField<String> = refSource
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitdetailListResponse].
         *
    ...
    /** A builder for [OnorbitdetailListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitdetailListResponse: OnorbitdetailListResponse) =
            apply {
                classificationMarking = onorbitdetailListResponse.classificationMarking
                dataMode = onorbitdetailListResponse.dataMode
                idOnOrbit = onorbitdetailListResponse.idOnOrbit
                source = onorbitdetailListResponse.source
                id = onorbitdetailListResponse.id
                additionalMass = onorbitdetailListResponse.additionalMass
                adeptRadius = onorbitdetailListResponse.adeptRadius
                bolDeltaV = onorbitdetailListResponse.bolDeltaV
                bolFuelMass = onorbitdetailListResponse.bolFuelMass
                busCrossSection = onorbitdetailListResponse.busCrossSection
                busType = onorbitdetailListResponse.busType
                colaRadius = onorbitdetailListResponse.colaRadius
                createdAt = onorbitdetailListResponse.createdAt
                createdBy = onorbitdetailListResponse.createdBy
                crossSection = onorbitdetailListResponse.crossSection
                currentMass = onorbitdetailListResponse.currentMass
                deltaVUnc = onorbitdetailListResponse.deltaVUnc
                depEstMasses = onorbitdetailListResponse.depEstMasses.map { it.toMutableList() }
                depMassUncs = onorbitdetailListResponse.depMassUncs.map { it.toMutableList() }
                depNames = onorbitdetailListResponse.depNames.map { it.toMutableList() }
                driftRate = onorbitdetailListResponse.driftRate
                dryMass = onorbitdetailListResponse.dryMass
                estDeltaVDuration = onorbitdetailListResponse.estDeltaVDuration
                fuelRemaining = onorbitdetailListResponse.fuelRemaining
                geoSlot = onorbitdetailListResponse.geoSlot
                lastObSource = onorbitdetailListResponse.lastObSource
                lastObTime = onorbitdetailListResponse.lastObTime
                launchMass = onorbitdetailListResponse.launchMass
                launchMassMax = onorbitdetailListResponse.launchMassMax
                launchMassMin = onorbitdetailListResponse.launchMassMin
                maneuverable = onorbitdetailListResponse.maneuverable
                maxDeltaV = onorbitdetailListResponse.maxDeltaV
                maxRadius = onorbitdetailListResponse.maxRadius
                missionTypes = onorbitdetailListResponse.missionTypes.map { it.toMutableList() }
                numDeployable = onorbitdetailListResponse.numDeployable
                numMission = onorbitdetailListResponse.numMission
                origin = onorbitdetailListResponse.origin
                origNetwork = onorbitdetailListResponse.origNetwork
                rcs = onorbitdetailListResponse.rcs
                rcsMax = onorbitdetailListResponse.rcsMax
                rcsMean = onorbitdetailListResponse.rcsMean
                rcsMin = onorbitdetailListResponse.rcsMin
                refSource = onorbitdetailListResponse.refSource
                solarArrayArea = onorbitdetailListResponse.solarArrayArea
                totalMassUnc = onorbitdetailListResponse.totalMassUnc
                vismag = onorbitdetailListResponse.vismag
                vismagMax = onorbitdetailListResponse.vismagMax
                vismagMean = onorbitdetailListResponse.vismagMean
                vismagMin = onorbitdetailListResponse.vismagMin
                additionalProperties = onorbitdetailListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.additionalMass] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun additionalMass(additionalMass: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.adeptRadius] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun adeptRadius(adeptRadius: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.bolDeltaV] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun bolDeltaV(bolDeltaV: JsonField<Double>) =
            apply {
                this.bolDeltaV = bolDeltaV
            }
         ...
         *
         * You should usually call [Builder.bolFuelMass] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun bolFuelMass(bolFuelMass: JsonField<Double>) =
            apply {
                this.bolFuelMass = bolFuelMass
            }

        /** Average cross sectional area of the bus in meters squared. */
        fun busCrossSection(busCrossSection: Double) = busCrossSection(JsonField.of(busCrossSection))

        /**
         * Sets [Builder.busCrossSection] to an arbitrary JSON value.
         *
         * You should usually call [Builder.busCrossSection] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun busCrossSection(busCrossSection: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.busType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun busType(busType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.colaRadius] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun colaRadius(colaRadius: JsonField<Double>) =
            apply {
                this.colaRadius = colaRadius
            }
         ...
         *
         * You should usually call [Builder.crossSection] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crossSection(crossSection: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.currentMass] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun currentMass(currentMass: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.deltaVUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun deltaVUnc(deltaVUnc: JsonField<Double>) =
            apply {
                this.deltaVUnc = deltaVUnc
            }
         ...
         *
         * You should usually call [Builder.depEstMasses] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depEstMasses(depEstMasses: JsonField<List<Double>>) =
            apply {
         ...
         */
        fun addDepEstMass(depEstMass: Double) =
            apply {
                depEstMasses = (depEstMasses ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.depMassUncs] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depMassUncs(depMassUncs: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addDepMassUnc(depMassUnc: Double) =
            apply {
                depMassUncs = (depMassUncs ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.depNames] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depNames(depNames: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addDepName(depName: String) =
            apply {
                depNames = (depNames ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.dryMass] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dryMass(dryMass: JsonField<Double>) =
            apply {
                this.dryMass = dryMass
            }

        /** Estimated maximum burn duration for the object, in seconds. */
        fun estDeltaVDuration(estDeltaVDuration: Double) = estDeltaVDuration(JsonField.of(estDeltaVDuration))

        /**
         * Sets [Builder.estDeltaVDuration] to an arbitrary JSON value.
         *
         * You should usually call [Builder.estDeltaVDuration] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun estDeltaVDuration(estDeltaVDuration: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.fuelRemaining] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fuelRemaining(fuelRemaining: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.geoSlot] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun geoSlot(geoSlot: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.lastObSource] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lastObSource(lastObSource: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.launchMassMax] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchMassMax(launchMassMax: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.launchMassMin] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun launchMassMin(launchMassMin: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.maneuverable] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maneuverable(maneuverable: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.maxDeltaV] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maxDeltaV(maxDeltaV: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.maxRadius] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maxRadius(maxRadius: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.missionTypes] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun missionTypes(missionTypes: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addMissionType(missionType: String) =
            apply {
                missionTypes = (missionTypes ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.numDeployable] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numDeployable(numDeployable: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.numMission] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numMission(numMission: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.rcsMean] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rcsMean(rcsMean: JsonField<Double>) =
            apply {
                this.rcsMean = rcsMean
            }
         ...
         *
         * You should usually call [Builder.refSource] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun refSource(refSource: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.solarArrayArea] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun solarArrayArea(solarArrayArea: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.totalMassUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun totalMassUnc(totalMassUnc: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.vismagMean] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vismagMean(vismagMean: JsonField<Double>) =
            apply {
                this.vismagMean = vismagMean
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitdetailListResponse].
         *
         ...
         */
        fun build(): OnorbitdetailListResponse =
    ...
    fun validate(): OnorbitdetailListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (additionalMass.asKnown().isPresent) 1 else 0) + (if (adeptRadius.asKnown().isPresent) 1 else 0) + (if (bolDeltaV.asKnown().isPresent) 1 else 0) + (if (bolFuelMass.asKnown().isPresent) 1 else 0) + (if (busCrossSection.asKnown().isPresent) 1 else 0) + (if (busType.asKnown().isPresent) 1 else 0) + (if (colaRadius.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (crossSection.asKnown().isPresent) 1 else 0) + (if (currentMass.asKnown().isPresent) 1 else 0) + (if (deltaVUnc.asKnown().isPresent) 1 else 0) + (depEstMasses.asKnown().getOrNull()?.size ?: 0) + (depMassUncs.asKnown().getOrNull()?.size ?: 0) + (depNames.asKnown().getOrNull()?.size ?: 0) + (if (driftRate.asKnown().isPresent) 1 else 0) + (if (dryMass.asKnown().isPresent) 1 else 0) + (if (estDeltaVDuration.asKnown().isPresent) 1 else 0) + (if (fuelRemaining.asKnown().isPresent) 1 else 0) + (if (geoSlot.asKnown().isPresent) 1 else 0) + (if (lastObSource.asKnown().isPresent) 1 else 0) + (if (lastObTime.asKnown().isPresent) 1 else 0) + (if (launchMass.asKnown().isPresent) 1 else 0) + (if (launchMassMax.asKnown().isPresent) 1 else 0) + (if (launchMassMin.asKnown().isPresent) 1 else 0) + (if (maneuverable.asKnown().isPresent) 1 else 0) + (if (maxDeltaV.asKnown().isPresent) 1 else 0) + (if (maxRadius.asKnown().isPresent) 1 else 0) + (missionTypes.asKnown().getOrNull()?.size ?: 0) + (if (numDeployable.asKnown().isPresent) 1 else 0) + (if (numMission.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (rcs.asKnown().isPresent) 1 else 0) + (if (rcsMax.asKnown().isPresent) 1 else 0) + (if (rcsMean.asKnown().isPresent) 1 else 0) + (if (rcsMin.asKnown().isPresent) 1 else 0) + (if (refSource.asKnown().isPresent) 1 else 0) + (if (solarArrayArea.asKnown().isPresent) 1 else 0) + (if (totalMassUnc.asKnown().isPresent) 1 else 0) + (if (vismag.asKnown().isPresent) 1 else 0) + (if (vismagMax.asKnown().isPresent) 1 else 0) + (if (vismagMean.asKnown().isPresent) 1 else 0) + (if (vismagMin.asKnown().isPresent) 1 else 0)
