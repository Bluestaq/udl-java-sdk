...
class OnorbitantennaListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<OnorbitantennaListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitantennaListPageAsync: OnorbitantennaListPageAsync) =
            apply {
        ...
        fun service(service: OnorbitantennaServiceAsync) =
            apply {
    ...
    override fun toString() = "OnorbitantennaListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
