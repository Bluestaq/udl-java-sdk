...
class CalibrationRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): CalibrationRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CalibrationRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [CalibrationRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationRetrieveParams: CalibrationRetrieveParams) =
            apply {
                id = calibrationRetrieveParams.id
                firstResult = calibrationRetrieveParams.firstResult
                maxResults = calibrationRetrieveParams.maxResults
                additionalHeaders = calibrationRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = calibrationRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CalibrationRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CalibrationRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CalibrationRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CalibrationRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
