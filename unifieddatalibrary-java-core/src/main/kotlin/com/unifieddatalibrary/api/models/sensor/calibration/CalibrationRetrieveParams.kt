 ...
 */
class CalibrationRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CalibrationRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationRetrieveParams: CalibrationRetrieveParams) = apply {
    ...
    override fun toString() =
        "CalibrationRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
