...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardGetResponse: HazardGetResponse) = apply {
    ...
    fun validate(): HazardGetResponse = apply {
        if (validated) {
            return@apply
        }
