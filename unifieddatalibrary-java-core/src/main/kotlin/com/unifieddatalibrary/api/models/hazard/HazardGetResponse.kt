...
class HazardGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HazardGetResponse].
         *
    ...
    /** A builder for [HazardGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardGetResponse: HazardGetResponse) =
            apply {
                alarms = hazardGetResponse.alarms.map { it.toMutableList() }
                alarmValues = hazardGetResponse.alarmValues.map { it.toMutableList() }
                classificationMarking = hazardGetResponse.classificationMarking
                dataMode = hazardGetResponse.dataMode
                detectTime = hazardGetResponse.detectTime
                detectType = hazardGetResponse.detectType
                source = hazardGetResponse.source
                id = hazardGetResponse.id
                a = hazardGetResponse.a
                activity = hazardGetResponse.activity
                bottleId = hazardGetResponse.bottleId
                casRn = hazardGetResponse.casRn
                channel = hazardGetResponse.channel
                createdAt = hazardGetResponse.createdAt
                createdBy = hazardGetResponse.createdBy
                ctrnTime = hazardGetResponse.ctrnTime
                density = hazardGetResponse.density
                dep = hazardGetResponse.dep
                depCtrn = hazardGetResponse.depCtrn
                dose = hazardGetResponse.dose
                doseRate = hazardGetResponse.doseRate
                duration = hazardGetResponse.duration
                gBar = hazardGetResponse.gBar
                harmful = hazardGetResponse.harmful
                hBar = hazardGetResponse.hBar
                idPoi = hazardGetResponse.idPoi
                idTrack = hazardGetResponse.idTrack
                massFrac = hazardGetResponse.massFrac
                matCat = hazardGetResponse.matCat
                matClass = hazardGetResponse.matClass
                matName = hazardGetResponse.matName
                matType = hazardGetResponse.matType
                origin = hazardGetResponse.origin
                origNetwork = hazardGetResponse.origNetwork
                ppm = hazardGetResponse.ppm
                radCtrn = hazardGetResponse.radCtrn
                readings = hazardGetResponse.readings.map { it.toMutableList() }
                readingUnits = hazardGetResponse.readingUnits.map { it.toMutableList() }
                readingValues = hazardGetResponse.readingValues.map { it.toMutableList() }
                z = hazardGetResponse.z
                additionalProperties = hazardGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [HazardGetResponse].
         *
    ...
    fun validate(): HazardGetResponse =
        apply {
            if (validated) {
              return@apply
            }
