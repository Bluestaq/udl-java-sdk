...
package com.unifieddatalibrary.api.models.maneuvers.history
...
private constructor(
    ...
    /**
     * Optional array of UDL data (elsets, state vectors, etc) UUIDs used to build this maneuver.
     * See the associated sourcedDataTypes array for the specific types of data for the positionally
    ...
    /**
     * Optional array of UDL data types used to build this maneuver (e.g. EO, RADAR, RF, DOA, ELSET,
     * SV). See the associated sourcedData array for the specific UUIDs of data for the positionally
     * corresponding data types in this array (the two arrays must match in size).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            algorithm = historyListResponse.algorithm
            characterization = historyListResponse.characterization
            characterizationUnc = historyListResponse.characterizationUnc
            cov = historyListResponse.cov.map { it.toMutableList() }
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            deltaMass = historyListResponse.deltaMass
            deltaPos = historyListResponse.deltaPos
            deltaPosU = historyListResponse.deltaPosU
            deltaPosV = historyListResponse.deltaPosV
            deltaPosW = historyListResponse.deltaPosW
            deltaVel = historyListResponse.deltaVel
            deltaVelU = historyListResponse.deltaVelU
            deltaVelV = historyListResponse.deltaVelV
            deltaVelW = historyListResponse.deltaVelW
            ...
            eventId = historyListResponse.eventId
            idOnOrbit = historyListResponse.idOnOrbit
            idSensor = historyListResponse.idSensor
            maneuverUnc = historyListResponse.maneuverUnc
            mnvrAccels = historyListResponse.mnvrAccels.map { it.toMutableList() }
            mnvrAccelTimes = historyListResponse.mnvrAccelTimes.map { it.toMutableList() }
            mnvrAccelUncs = historyListResponse.mnvrAccelUncs.map { it.toMutableList() }
            numAccelPoints = historyListResponse.numAccelPoints
            numObs = historyListResponse.numObs
            odFitEndTime = historyListResponse.odFitEndTime
            ...
            postApogee = historyListResponse.postApogee
            postArea = historyListResponse.postArea
            postBallisticCoeff = historyListResponse.postBallisticCoeff
            postDriftRate = historyListResponse.postDriftRate
            postEccentricity = historyListResponse.postEccentricity
            postEventElset = historyListResponse.postEventElset
            postEventIdElset = historyListResponse.postEventIdElset
            postEventIdStateVector = historyListResponse.postEventIdStateVector
            postEventStateVector = historyListResponse.postEventStateVector
            postGeoLongitude = historyListResponse.postGeoLongitude
            postInclination = historyListResponse.postInclination
            postMass = historyListResponse.postMass
            postPerigee = historyListResponse.postPerigee
            postPeriod = historyListResponse.postPeriod
            postPosX = historyListResponse.postPosX
            postPosY = historyListResponse.postPosY
            postPosZ = historyListResponse.postPosZ
            postRaan = historyListResponse.postRaan
            postRadiationPressCoeff = historyListResponse.postRadiationPressCoeff
            postSigmaU = historyListResponse.postSigmaU
            postSigmaV = historyListResponse.postSigmaV
            postSigmaW = historyListResponse.postSigmaW
            postSma = historyListResponse.postSma
            postVelX = historyListResponse.postVelX
            postVelY = historyListResponse.postVelY
            postVelZ = historyListResponse.postVelZ
            preApogee = historyListResponse.preApogee
            preBallisticCoeff = historyListResponse.preBallisticCoeff
            preDriftRate = historyListResponse.preDriftRate
            preEccentricity = historyListResponse.preEccentricity
            preEventElset = historyListResponse.preEventElset
            preEventIdElset = historyListResponse.preEventIdElset
            preEventIdStateVector = historyListResponse.preEventIdStateVector
            preEventStateVector = historyListResponse.preEventStateVector
            preGeoLongitude = historyListResponse.preGeoLongitude
            preInclination = historyListResponse.preInclination
            prePerigee = historyListResponse.prePerigee
            prePeriod = historyListResponse.prePeriod
            prePosX = historyListResponse.prePosX
            prePosY = historyListResponse.prePosY
            prePosZ = historyListResponse.prePosZ
            preRaan = historyListResponse.preRaan
            preRadiationPressCoeff = historyListResponse.preRadiationPressCoeff
            preSigmaU = historyListResponse.preSigmaU
            preSigmaV = historyListResponse.preSigmaV
            preSigmaW = historyListResponse.preSigmaW
            preSma = historyListResponse.preSma
            preVelX = historyListResponse.preVelX
            preVelY = historyListResponse.preVelY
            preVelZ = historyListResponse.preVelZ
            reportTime = historyListResponse.reportTime
            satNo = historyListResponse.satNo
            sourcedData = historyListResponse.sourcedData.map { it.toMutableList() }
            sourcedDataTypes = historyListResponse.sourcedDataTypes.map { it.toMutableList() }
            stateModel = historyListResponse.stateModel
            stateModelVersion = historyListResponse.stateModelVersion
            status = historyListResponse.status
            tags = historyListResponse.tags.map { it.toMutableList() }
            totalBurnTime = historyListResponse.totalBurnTime
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(postEventElset: PostEventElset) = apply {
                ...
                effectiveFrom = postEventElset.effectiveFrom
                effectiveUntil = postEventElset.effectiveUntil
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(postEventStateVector: PostEventStateVector) = apply {
                ...
                effectiveFrom = postEventStateVector.effectiveFrom
                effectiveUntil = postEventStateVector.effectiveUntil
                ...
                sourcedDataTypes = postEventStateVector.sourcedDataTypes.map { it.toMutableList() }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(preEventElset: PreEventElset) = apply {
                ...
                effectiveFrom = preEventElset.effectiveFrom
                effectiveUntil = preEventElset.effectiveUntil
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(preEventStateVector: PreEventStateVector) = apply {
                ...
                effectiveFrom = preEventStateVector.effectiveFrom
                effectiveUntil = preEventStateVector.effectiveUntil
                ...
                sourcedDataTypes = preEventStateVector.sourcedDataTypes.map { it.toMutableList() }
