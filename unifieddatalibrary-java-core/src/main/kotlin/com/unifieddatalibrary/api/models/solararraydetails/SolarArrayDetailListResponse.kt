...
class SolarArrayDetailListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayDetailListResponse: SolarArrayDetailListResponse) =
            apply {
    ...
    fun validate(): SolarArrayDetailListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idSolarArray.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (area.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (junctionTechnology.asKnown().isPresent) 1 else 0) + (if (manufacturerOrgId.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (span.asKnown().isPresent) 1 else 0) + (if (technology.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SolarArrayDetailListResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idSolarArray == other.idSolarArray && source == other.source && id == other.id && area == other.area && createdAt == other.createdAt && createdBy == other.createdBy && description == other.description && junctionTechnology == other.junctionTechnology && manufacturerOrgId == other.manufacturerOrgId && origin == other.origin && origNetwork == other.origNetwork && span == other.span && technology == other.technology && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idSolarArray, source, id, area, createdAt, createdBy, description, junctionTechnology, manufacturerOrgId, origin, origNetwork, span, technology, type, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "SolarArrayDetailListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idSolarArray=$idSolarArray, source=$source, id=$id, area=$area, createdAt=$createdAt, createdBy=$createdBy, description=$description, junctionTechnology=$junctionTechnology, manufacturerOrgId=$manufacturerOrgId, origin=$origin, origNetwork=$origNetwork, span=$span, technology=$technology, type=$type, additionalProperties=$additionalProperties}"
}
