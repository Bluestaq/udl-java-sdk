...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchVehicleGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleGetParams: LaunchVehicleGetParams) = apply {
    ...
    override fun toString() =
        "LaunchVehicleGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
