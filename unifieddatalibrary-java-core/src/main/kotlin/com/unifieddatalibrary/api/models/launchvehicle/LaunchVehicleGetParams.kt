...
class LaunchVehicleGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): LaunchVehicleGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LaunchVehicleGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [LaunchVehicleGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleGetParams: LaunchVehicleGetParams) =
            apply {
                id = launchVehicleGetParams.id
                firstResult = launchVehicleGetParams.firstResult
                maxResults = launchVehicleGetParams.maxResults
                additionalHeaders = launchVehicleGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = launchVehicleGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchVehicleGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchVehicleGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchVehicleGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "LaunchVehicleGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
