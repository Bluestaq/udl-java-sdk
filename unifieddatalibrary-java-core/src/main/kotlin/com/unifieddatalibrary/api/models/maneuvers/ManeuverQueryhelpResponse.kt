...
class ManeuverQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManeuverQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ManeuverQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(maneuverQueryhelpResponse: ManeuverQueryhelpResponse) = apply {
            aodrSupported = maneuverQueryhelpResponse.aodrSupported
            classificationMarking = maneuverQueryhelpResponse.classificationMarking
            description = maneuverQueryhelpResponse.description
            historySupported = maneuverQueryhelpResponse.historySupported
            name = maneuverQueryhelpResponse.name
            parameters = maneuverQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = maneuverQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = maneuverQueryhelpResponse.restSupported
            sortSupported = maneuverQueryhelpResponse.sortSupported
            typeName = maneuverQueryhelpResponse.typeName
            uri = maneuverQueryhelpResponse.uri
            additionalProperties = maneuverQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ManeuverQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ManeuverQueryhelpResponse =
    ...
    fun validate(): ManeuverQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
