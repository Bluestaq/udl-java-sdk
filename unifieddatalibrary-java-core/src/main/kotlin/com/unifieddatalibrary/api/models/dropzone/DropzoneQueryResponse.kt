...
class DropzoneQueryResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneQueryResponse: DropzoneQueryResponse) =
            apply {
    ...
    fun validate(): DropzoneQueryResponse =
        apply {
            if (validated) {
              return@apply
            }
