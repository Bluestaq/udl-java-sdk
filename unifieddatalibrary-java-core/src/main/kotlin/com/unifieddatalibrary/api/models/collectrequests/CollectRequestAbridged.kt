...
class CollectRequestAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectRequestAbridged].
         *
    ...
    /** A builder for [CollectRequestAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestAbridged: CollectRequestAbridged) =
            apply {
                classificationMarking = collectRequestAbridged.classificationMarking
                dataMode = collectRequestAbridged.dataMode
                source = collectRequestAbridged.source
                startTime = collectRequestAbridged.startTime
                type = collectRequestAbridged.type
                id = collectRequestAbridged.id
                alt = collectRequestAbridged.alt
                argOfPerigee = collectRequestAbridged.argOfPerigee
                az = collectRequestAbridged.az
                createdAt = collectRequestAbridged.createdAt
                createdBy = collectRequestAbridged.createdBy
                customer = collectRequestAbridged.customer
                dec = collectRequestAbridged.dec
                duration = collectRequestAbridged.duration
                dwellId = collectRequestAbridged.dwellId
                eccentricity = collectRequestAbridged.eccentricity
                el = collectRequestAbridged.el
                elset = collectRequestAbridged.elset
                endTime = collectRequestAbridged.endTime
                epoch = collectRequestAbridged.epoch
                esId = collectRequestAbridged.esId
                extentAz = collectRequestAbridged.extentAz
                extentEl = collectRequestAbridged.extentEl
                extentRange = collectRequestAbridged.extentRange
                externalId = collectRequestAbridged.externalId
                frameRate = collectRequestAbridged.frameRate
                freq = collectRequestAbridged.freq
                freqMax = collectRequestAbridged.freqMax
                freqMin = collectRequestAbridged.freqMin
                idElset = collectRequestAbridged.idElset
                idManifold = collectRequestAbridged.idManifold
                idOnOrbit = collectRequestAbridged.idOnOrbit
                idParentReq = collectRequestAbridged.idParentReq
                idPlan = collectRequestAbridged.idPlan
                idSensor = collectRequestAbridged.idSensor
                idStateVector = collectRequestAbridged.idStateVector
                inclination = collectRequestAbridged.inclination
                integrationTime = collectRequestAbridged.integrationTime
                iron = collectRequestAbridged.iron
                irradiance = collectRequestAbridged.irradiance
                lat = collectRequestAbridged.lat
                lon = collectRequestAbridged.lon
                msgCreateDate = collectRequestAbridged.msgCreateDate
                msgType = collectRequestAbridged.msgType
                notes = collectRequestAbridged.notes
                numFrames = collectRequestAbridged.numFrames
                numObs = collectRequestAbridged.numObs
                numTracks = collectRequestAbridged.numTracks
                obType = collectRequestAbridged.obType
                orbitRegime = collectRequestAbridged.orbitRegime
                orientAngle = collectRequestAbridged.orientAngle
                origin = collectRequestAbridged.origin
                origNetwork = collectRequestAbridged.origNetwork
                origObjectId = collectRequestAbridged.origObjectId
                origSensorId = collectRequestAbridged.origSensorId
                planIndex = collectRequestAbridged.planIndex
                polarization = collectRequestAbridged.polarization
                priority = collectRequestAbridged.priority
                ra = collectRequestAbridged.ra
                raan = collectRequestAbridged.raan
                range = collectRequestAbridged.range
                rcs = collectRequestAbridged.rcs
                rcsMax = collectRequestAbridged.rcsMax
                rcsMin = collectRequestAbridged.rcsMin
                reflectance = collectRequestAbridged.reflectance
                satNo = collectRequestAbridged.satNo
                scenario = collectRequestAbridged.scenario
                semiMajorAxis = collectRequestAbridged.semiMajorAxis
                spectralModel = collectRequestAbridged.spectralModel
                srchInc = collectRequestAbridged.srchInc
                srchPattern = collectRequestAbridged.srchPattern
                stateVector = collectRequestAbridged.stateVector
                stopAlt = collectRequestAbridged.stopAlt
                stopLat = collectRequestAbridged.stopLat
                stopLon = collectRequestAbridged.stopLon
                suffix = collectRequestAbridged.suffix
                targetSize = collectRequestAbridged.targetSize
                taskCategory = collectRequestAbridged.taskCategory
                taskGroup = collectRequestAbridged.taskGroup
                taskId = collectRequestAbridged.taskId
                transactionId = collectRequestAbridged.transactionId
                trueAnomoly = collectRequestAbridged.trueAnomoly
                uctFollowUp = collectRequestAbridged.uctFollowUp
                visMag = collectRequestAbridged.visMag
                visMagMax = collectRequestAbridged.visMagMax
                visMagMin = collectRequestAbridged.visMagMin
                xAngle = collectRequestAbridged.xAngle
                yAngle = collectRequestAbridged.yAngle
                additionalProperties = collectRequestAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CollectRequestAbridged].
         *
         ...
         */
        fun build(): CollectRequestAbridged =
    ...
    fun validate(): CollectRequestAbridged =
        apply {
            if (validated) {
              return@apply
            }
