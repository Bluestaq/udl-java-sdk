...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestAbridged: CollectRequestAbridged) = apply {
    ...
    fun validate(): CollectRequestAbridged = apply {
        if (validated) {
            return@apply
        }
