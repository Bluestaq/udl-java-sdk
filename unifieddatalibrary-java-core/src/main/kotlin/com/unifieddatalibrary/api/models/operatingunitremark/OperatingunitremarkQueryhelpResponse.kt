...
class OperatingunitremarkQueryhelpResponse
private constructor(
    ...
    /** A builder for [OperatingunitremarkQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            operatingunitremarkQueryhelpResponse: OperatingunitremarkQueryhelpResponse
        ) = apply {
            aodrSupported = operatingunitremarkQueryhelpResponse.aodrSupported
            classificationMarking = operatingunitremarkQueryhelpResponse.classificationMarking
            description = operatingunitremarkQueryhelpResponse.description
            historySupported = operatingunitremarkQueryhelpResponse.historySupported
            name = operatingunitremarkQueryhelpResponse.name
            parameters = operatingunitremarkQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                operatingunitremarkQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = operatingunitremarkQueryhelpResponse.restSupported
            sortSupported = operatingunitremarkQueryhelpResponse.sortSupported
            typeName = operatingunitremarkQueryhelpResponse.typeName
            uri = operatingunitremarkQueryhelpResponse.uri
            additionalProperties =
                operatingunitremarkQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OperatingunitremarkQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OperatingunitremarkQueryhelpResponse =
            OperatingunitremarkQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): OperatingunitremarkQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OperatingunitremarkQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
