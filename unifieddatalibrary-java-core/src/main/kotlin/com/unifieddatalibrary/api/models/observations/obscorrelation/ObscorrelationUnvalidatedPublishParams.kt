 ...
 */
class ObscorrelationUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [ObscorrelationUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            obscorrelationUnvalidatedPublishParams: ObscorrelationUnvalidatedPublishParams
        ) = apply {
            body = obscorrelationUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = obscorrelationUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                obscorrelationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): ObscorrelationUnvalidatedPublishParams =
            ObscorrelationUnvalidatedPublishParams(
    ...
    /**
     * Model representation supporting post-pass correlation of UCTs and re-correlation of
    ...
    private constructor(
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun algorithmCorrType(): Optional<String> =
            algorithmCorrType.getOptional("algorithmCorrType")
         ...
         *
         * Unlike [referenceOrbitType], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("referenceOrbitType")
        @ExcludeMissing
        ...
        @ExcludeMissing
        fun _altCatalog(): JsonField<String> = altCatalog

        /**
         * Returns the raw JSON value of [altNamespace].
         *
         * Unlike [altNamespace], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        ...
        @ExcludeMissing
        fun _altObjectId(): JsonField<String> = altObjectId
         ...
         *
         * Unlike [idParentCorrelation], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("idParentCorrelation")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                corrType = body.corrType
                dataMode = body.dataMode
                msgTs = body.msgTs
                obId = body.obId
                obType = body.obType
                referenceOrbitId = body.referenceOrbitId
                referenceOrbitType = body.referenceOrbitType
                source = body.source
                id = body.id
                algorithmCorrType = body.algorithmCorrType
                altCatalog = body.altCatalog
                altNamespace = body.altNamespace
                altObjectId = body.altObjectId
                altUct = body.altUct
                astat = body.astat
                ...
                idParentCorrelation = body.idParentCorrelation
                origin = body.origin
             ...
             *
             * You should usually call [Builder.corrType] with a well-typed [CorrType] value
            ...
            /**
             * Identifier of the Observation associated with this Correlation. If corrType=TRACK
             * then this field should reference the first Observation in the track. Note: To
             * retrieve all remaining Observations in the track, the GET query should include this
             * Observation's source and origin field values, along with the trackId.
             */
            ...
            /**
             * Indicator of whether the type of Observation(s) being correlated is DOA, EO,
             * PASSIVE_RADAR, RADAR, RF, SAR, or SOISET: DOA: The observation type being correlated
             * is Difference of Arrival. EO: The observation type being correlated is
             * Electro-Optical. PASSIVE_RADAR: The observation type being correlated is Passive
             * Radar. RADAR: The observation type being correlated is Radar. RF: The observation
             * type being correlated is Radio Frequency. SAR: The observation type being correlated
             * is Synthetic Aperture Radar. SOISET: The observation type being correlated is Space
             * Object Identification Observation Set.
             */
             ...
             *
             * You should usually call [Builder.obType] with a well-typed [ObType] value instead.
            ...
            /**
             * Indicator of whether the reference orbit type used for correlation is an ELSET, ESID,
             * or SV: ELSET: The reference orbit type is an Element Set. ESID: The reference orbit
             * type is an Ephemeris Set. SV: The reference orbit type is a State Vector.
             */
             ...
             * [ReferenceOrbitType] value instead. This method is primarily for setting the field to
             ...
             *
             * You should usually call [Builder.altCatalog] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Namespaces may be defined by their respective data providers or systems (e.g. JCO,
             * 18SDS, EOSSS, EXO, KBR, KRTL, LeoLabs, NorthStar, SAFRAN, Slingshot).
             */
             ...
             *
             * You should usually call [Builder.altNamespace] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.altObjectId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun altObjectId(altObjectId: JsonField<String>) = apply {
                this.altObjectId = altObjectId
            }

            /**
             * Boolean indicating whether the observation or track can be correlated to the
             * alternate object specified under altObjectId. This flag should only be set to true by
             * data providers after an attempt to correlate to an on-orbit object was made and
             * failed. If unable to correlate, the 'origObjectId' field may be populated with an
             ...
             *
             * You should usually call [Builder.altUct] with a well-typed [Boolean] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * correlation to the orbit of the corresponding satellite, such as when all observation
             * residuals equal 0.
             */
             ...
             *
             * You should usually call [Builder.idParentCorrelation] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /**
             * Optional identifier indicates the target on-orbit object being correlated. This may
             * be an internal identifier and not necessarily a valid satellite number.
             */
            ...
            /**
             * Current 18th SDS satellite/catalog number of the target on-orbit object. Useful to
             * know in the case where an observation is correlated to another satellite/catalog
             * number.
             */
         ...
         * observations is being correlated.
         */
        class CorrType @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            /**
             * An enum containing [ReferenceOrbitType]'s known values, as well as an [_UNKNOWN]
             * member.
             *
             * An instance of [ReferenceOrbitType] can contain an unknown value in a couple of
             * cases:
             * - It was deserialized from data that doesn't match any known member. For example, if
             *   the SDK is on an older version than the API, then the API may respond with new
             *   members that the SDK is unaware of.
            ...
            enum class Value {
                ...
                SV,
                /**
                 * An enum member indicating that [ReferenceOrbitType] was instantiated with an
                 * unknown value.
                 */
                _UNKNOWN,
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ObscorrelationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
