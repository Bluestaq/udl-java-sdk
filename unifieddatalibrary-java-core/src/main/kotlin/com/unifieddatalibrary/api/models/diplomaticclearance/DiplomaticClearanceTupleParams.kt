 ...
 */
class DiplomaticClearanceTupleParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diplomaticClearanceTupleParams: DiplomaticClearanceTupleParams) = apply {
         ...
         * format with millisecond precision. (YYYY-MM-DDTHH:MM:SS.sssZ)
         */
        fun firstDepDate(firstDepDate: OffsetDateTime) = apply { this.firstDepDate = firstDepDate }
