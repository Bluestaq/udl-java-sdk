...
class DiplomaticClearanceTupleParams private constructor(
    private val columns: String,
    private val firstDepDate: OffsetDateTime,
    ...
    fun firstDepDate(): OffsetDateTime = firstDepDate
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiplomaticClearanceTupleParams].
         *
    ...
    /** A builder for [DiplomaticClearanceTupleParams]. */
    class Builder internal constructor() {

        private var columns: String? = null
        private var firstDepDate: OffsetDateTime? = null
        ...
        @JvmSynthetic
        internal fun from(diplomaticClearanceTupleParams: DiplomaticClearanceTupleParams) =
            apply {
                columns = diplomaticClearanceTupleParams.columns
                firstDepDate = diplomaticClearanceTupleParams.firstDepDate
                firstResult = diplomaticClearanceTupleParams.firstResult
                maxResults = diplomaticClearanceTupleParams.maxResults
                additionalHeaders = diplomaticClearanceTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = diplomaticClearanceTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DiplomaticClearanceTupleParams].
         *
         ...
         */
        fun build(): DiplomaticClearanceTupleParams =
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("columns", columns)
                put("firstDepDate", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(firstDepDate))
    ...
    override fun toString() = "DiplomaticClearanceTupleParams{columns=$columns, firstDepDate=$firstDepDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
