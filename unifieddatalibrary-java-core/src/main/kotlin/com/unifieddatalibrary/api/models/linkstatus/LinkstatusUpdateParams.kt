...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LinkstatusUpdateParams].
         *
    ...
    /** A builder for [LinkstatusUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(linkstatusUpdateParams: LinkstatusUpdateParams) = apply {
            pathId = linkstatusUpdateParams.pathId
            body = linkstatusUpdateParams.body.toBuilder()
            additionalHeaders = linkstatusUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = linkstatusUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LinkstatusUpdateParams].
         *
         ...
         */
        fun build(): LinkstatusUpdateParams =
            LinkstatusUpdateParams(
                pathId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LinkstatusUpdateParams &&
            pathId == other.pathId &&
            body == other.body &&
    ...
    override fun toString() =
        "LinkstatusUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
