...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteRemarkListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkListParams: SiteRemarkListParams) = apply {
    ...
    override fun toString() =
        "SiteRemarkListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
