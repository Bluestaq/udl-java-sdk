...
class AirEventCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirEventCreateBulkParams].
         *
    ...
    /** A builder for [AirEventCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventCreateBulkParams: AirEventCreateBulkParams) =
            apply {
                body = airEventCreateBulkParams.body.toMutableList()
                additionalHeaders = airEventCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = airEventCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirEventCreateBulkParams].
         *
         ...
         */
        fun build(): AirEventCreateBulkParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("actualArrTime") @ExcludeMissing private val actualArrTime: JsonField<OffsetDateTime>,
        @JsonProperty("actualDepTime") @ExcludeMissing private val actualDepTime: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("estArrTime") @ExcludeMissing private val estArrTime: JsonField<OffsetDateTime>,
        @JsonProperty("estDepTime") @ExcludeMissing private val estDepTime: JsonField<OffsetDateTime>,
        @JsonProperty("externalAirEventId") @ExcludeMissing private val externalAirEventId: JsonField<String>,
        @JsonProperty("externalARTrackId") @ExcludeMissing private val externalArTrackId: JsonField<String>,
        ...
        @JsonProperty("plannedArrTime") @ExcludeMissing private val plannedArrTime: JsonField<OffsetDateTime>,
        @JsonProperty("plannedDepTime") @ExcludeMissing private val plannedDepTime: JsonField<OffsetDateTime>,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    arct = body.arct
                    arEventType = body.arEventType
                    arrPurpose = body.arrPurpose
                    arTrackId = body.arTrackId
                    arTrackName = body.arTrackName
                    baseAlt = body.baseAlt
                    cancelled = body.cancelled
                    createdAt = body.createdAt
                    createdBy = body.createdBy
                    depPurpose = body.depPurpose
                    estArrTime = body.estArrTime
                    estDepTime = body.estDepTime
                    externalAirEventId = body.externalAirEventId
                    externalArTrackId = body.externalArTrackId
                    idMission = body.idMission
                    idSortie = body.idSortie
                    legNum = body.legNum
                    location = body.location
                    numTankers = body.numTankers
                    origin = body.origin
                    origNetwork = body.origNetwork
                    plannedArrTime = body.plannedArrTime
                    plannedDepTime = body.plannedDepTime
                    priority = body.priority
                    receivers = body.receivers.map { it.toMutableList() }
                    remarks = body.remarks.map { it.toMutableList() }
                    revTrack = body.revTrack
                    rzct = body.rzct
                    rzPoint = body.rzPoint
                    rzType = body.rzType
                    shortTrack = body.shortTrack
                    sourceDl = body.sourceDl
                    statusCode = body.statusCode
                    tankers = body.tankers.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirEventCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AirEventCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
