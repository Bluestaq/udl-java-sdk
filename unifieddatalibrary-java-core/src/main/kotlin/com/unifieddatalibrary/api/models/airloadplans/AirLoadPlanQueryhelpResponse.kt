...
class AirloadPlanQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airloadPlanQueryhelpResponse: AirloadPlanQueryhelpResponse) = apply {
    ...
    fun validate(): AirloadPlanQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
