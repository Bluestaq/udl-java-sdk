...
class AirloadPlanQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AirloadPlanQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirloadPlanQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airloadPlanQueryhelpResponse: AirloadPlanQueryhelpResponse) =
            apply {
                aodrSupported = airloadPlanQueryhelpResponse.aodrSupported
                classificationMarking = airloadPlanQueryhelpResponse.classificationMarking
                description = airloadPlanQueryhelpResponse.description
                historySupported = airloadPlanQueryhelpResponse.historySupported
                name = airloadPlanQueryhelpResponse.name
                parameters = airloadPlanQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = airloadPlanQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = airloadPlanQueryhelpResponse.restSupported
                sortSupported = airloadPlanQueryhelpResponse.sortSupported
                typeName = airloadPlanQueryhelpResponse.typeName
                uri = airloadPlanQueryhelpResponse.uri
                additionalProperties = airloadPlanQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirloadPlanQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirloadPlanQueryhelpResponse =
    ...
    fun validate(): AirloadPlanQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirloadPlanQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
