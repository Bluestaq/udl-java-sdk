...
class CollectRequestRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CollectRequestRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestRetrieveParams: CollectRequestRetrieveParams) = apply {
    ...
    override fun toString() =
        "CollectRequestRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
