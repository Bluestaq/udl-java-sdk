...
class CollectRequestRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): CollectRequestRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CollectRequestRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [CollectRequestRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestRetrieveParams: CollectRequestRetrieveParams) =
            apply {
                id = collectRequestRetrieveParams.id
                firstResult = collectRequestRetrieveParams.firstResult
                maxResults = collectRequestRetrieveParams.maxResults
                additionalHeaders = collectRequestRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = collectRequestRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CollectRequestRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CollectRequestRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CollectRequestRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CollectRequestRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
