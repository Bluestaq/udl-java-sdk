...
class CollectRequestListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectRequestListParams].
         *
    ...
    /** A builder for [CollectRequestListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestListParams: CollectRequestListParams) =
            apply {
                startTime = collectRequestListParams.startTime
                firstResult = collectRequestListParams.firstResult
                maxResults = collectRequestListParams.maxResults
                additionalHeaders = collectRequestListParams.additionalHeaders.toBuilder()
                additionalQueryParams = collectRequestListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CollectRequestListParams].
         *
         ...
         */
        fun build(): CollectRequestListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CollectRequestListParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CollectRequestListParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
