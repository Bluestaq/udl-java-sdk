...
class PortListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portListPageAsync: PortListPageAsync) =
            apply {
        ...
        fun service(service: PortServiceAsync) =
            apply {
    ...
    override fun toString() = "PortListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
