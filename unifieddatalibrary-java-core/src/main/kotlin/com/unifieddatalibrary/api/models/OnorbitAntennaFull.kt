...
class OnorbitAntennaFull private constructor(
    ...
    @ExcludeMissing
    fun _antenna(): JsonField<AntennaFull> = antenna
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitAntennaFull: OnorbitAntennaFull) =
            apply {
         ...
         *
         * You should usually call [Builder.antenna] with a well-typed [AntennaFull] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun antenna(antenna: JsonField<AntennaFull>) =
            apply {
    ...
    fun validate(): OnorbitAntennaFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idAntenna.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (antenna.asKnown().getOrNull()?.validity() ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
