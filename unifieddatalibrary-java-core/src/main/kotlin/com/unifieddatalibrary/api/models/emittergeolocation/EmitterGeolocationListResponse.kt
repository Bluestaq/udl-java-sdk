...
class EmitterGeolocationListResponse
...
private constructor(
    ...
    /** A builder for [EmitterGeolocationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationListResponse: EmitterGeolocationListResponse) = apply {
            classificationMarking = emitterGeolocationListResponse.classificationMarking
            dataMode = emitterGeolocationListResponse.dataMode
            signalOfInterestType = emitterGeolocationListResponse.signalOfInterestType
            source = emitterGeolocationListResponse.source
            startTime = emitterGeolocationListResponse.startTime
            id = emitterGeolocationListResponse.id
            agjson = emitterGeolocationListResponse.agjson
            algVersion = emitterGeolocationListResponse.algVersion
            andims = emitterGeolocationListResponse.andims
            asrid = emitterGeolocationListResponse.asrid
            atext = emitterGeolocationListResponse.atext
            atype = emitterGeolocationListResponse.atype
            avgPrf = emitterGeolocationListResponse.avgPrf
            avgPri = emitterGeolocationListResponse.avgPri
            avgPw = emitterGeolocationListResponse.avgPw
            centerFreq = emitterGeolocationListResponse.centerFreq
            cluster = emitterGeolocationListResponse.cluster
            confArea = emitterGeolocationListResponse.confArea
            constellation = emitterGeolocationListResponse.constellation
            createdAt = emitterGeolocationListResponse.createdAt
            createdBy = emitterGeolocationListResponse.createdBy
            createdTs = emitterGeolocationListResponse.createdTs
            detectAlt = emitterGeolocationListResponse.detectAlt
            detectLat = emitterGeolocationListResponse.detectLat
            detectLon = emitterGeolocationListResponse.detectLon
            endTime = emitterGeolocationListResponse.endTime
            errEllp = emitterGeolocationListResponse.errEllp.map { it.toMutableList() }
            externalId = emitterGeolocationListResponse.externalId
            idOnOrbit = emitterGeolocationListResponse.idOnOrbit
            idRfEmitter = emitterGeolocationListResponse.idRfEmitter
            idSensor = emitterGeolocationListResponse.idSensor
            maxFreq = emitterGeolocationListResponse.maxFreq
            maxPrf = emitterGeolocationListResponse.maxPrf
            maxPri = emitterGeolocationListResponse.maxPri
            maxPw = emitterGeolocationListResponse.maxPw
            minFreq = emitterGeolocationListResponse.minFreq
            minPrf = emitterGeolocationListResponse.minPrf
            minPri = emitterGeolocationListResponse.minPri
            minPw = emitterGeolocationListResponse.minPw
            numBursts = emitterGeolocationListResponse.numBursts
            orderId = emitterGeolocationListResponse.orderId
            origin = emitterGeolocationListResponse.origin
            origNetwork = emitterGeolocationListResponse.origNetwork
            origObjectId = emitterGeolocationListResponse.origObjectId
            origRfEmitterId = emitterGeolocationListResponse.origRfEmitterId
            origSensorId = emitterGeolocationListResponse.origSensorId
            passGroupId = emitterGeolocationListResponse.passGroupId
            pulseShape = emitterGeolocationListResponse.pulseShape
            receivedTs = emitterGeolocationListResponse.receivedTs
            satNo = emitterGeolocationListResponse.satNo
            signalOfInterest = emitterGeolocationListResponse.signalOfInterest
            sourceDl = emitterGeolocationListResponse.sourceDl
            tags = emitterGeolocationListResponse.tags.map { it.toMutableList() }
            additionalProperties =
                emitterGeolocationListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationListResponse].
         *
         ...
         */
        fun build(): EmitterGeolocationListResponse =
            EmitterGeolocationListResponse(
    ...
    fun validate(): EmitterGeolocationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmitterGeolocationListResponse &&
