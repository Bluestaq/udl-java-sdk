...
class AirloadPlanListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirloadPlanListParams].
         *
    ...
    /** A builder for [AirloadPlanListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airloadPlanListParams: AirloadPlanListParams) =
            apply {
                estDepTime = airloadPlanListParams.estDepTime
                firstResult = airloadPlanListParams.firstResult
                maxResults = airloadPlanListParams.maxResults
                additionalHeaders = airloadPlanListParams.additionalHeaders.toBuilder()
                additionalQueryParams = airloadPlanListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirloadPlanListParams].
         *
         ...
         */
        fun build(): AirloadPlanListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirloadPlanListParams && estDepTime == other.estDepTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirloadPlanListParams{estDepTime=$estDepTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
