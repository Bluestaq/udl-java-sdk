...
class OperationQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationQueryHelpResponse: OperationQueryHelpResponse) = apply {
    ...
    fun validate(): OperationQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
