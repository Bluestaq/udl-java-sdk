...
class OperationQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OperationQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OperationQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationQueryHelpResponse: OperationQueryHelpResponse) =
            apply {
                aodrSupported = operationQueryHelpResponse.aodrSupported
                classificationMarking = operationQueryHelpResponse.classificationMarking
                description = operationQueryHelpResponse.description
                historySupported = operationQueryHelpResponse.historySupported
                name = operationQueryHelpResponse.name
                parameters = operationQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = operationQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = operationQueryHelpResponse.restSupported
                sortSupported = operationQueryHelpResponse.sortSupported
                typeName = operationQueryHelpResponse.typeName
                uri = operationQueryHelpResponse.uri
                additionalProperties = operationQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OperationQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OperationQueryHelpResponse =
    ...
    fun validate(): OperationQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OperationQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
