...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiteRemarkTupleResponse].
         *
    ...
    /** A builder for [SiteRemarkTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkTupleResponse: SiteRemarkTupleResponse) = apply {
            classificationMarking = siteRemarkTupleResponse.classificationMarking
            dataMode = siteRemarkTupleResponse.dataMode
            idSite = siteRemarkTupleResponse.idSite
            source = siteRemarkTupleResponse.source
            text = siteRemarkTupleResponse.text
            id = siteRemarkTupleResponse.id
            code = siteRemarkTupleResponse.code
            createdAt = siteRemarkTupleResponse.createdAt
            createdBy = siteRemarkTupleResponse.createdBy
            name = siteRemarkTupleResponse.name
            origin = siteRemarkTupleResponse.origin
            origNetwork = siteRemarkTupleResponse.origNetwork
            origRmkId = siteRemarkTupleResponse.origRmkId
            type = siteRemarkTupleResponse.type
            additionalProperties = siteRemarkTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SiteRemarkTupleResponse].
         *
         ...
         */
        fun build(): SiteRemarkTupleResponse =
    ...
    fun validate(): SiteRemarkTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SiteRemarkTupleResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idSite=$idSite, source=$source, text=$text, id=$id, code=$code, createdAt=$createdAt, createdBy=$createdBy, name=$name, origin=$origin, origNetwork=$origNetwork, origRmkId=$origRmkId, type=$type, additionalProperties=$additionalProperties}"
}
