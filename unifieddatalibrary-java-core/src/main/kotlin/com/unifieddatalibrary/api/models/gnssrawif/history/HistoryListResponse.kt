...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            centerFreq = historyListResponse.centerFreq.map { it.toMutableList() }
            ...
            postFourier = historyListResponse.postFourier.map { it.toMutableList() }
            quat = historyListResponse.quat.map { it.toMutableList() }
            receiver = historyListResponse.receiver
            sampleRate = historyListResponse.sampleRate.map { it.toMutableList() }
            sampleType = historyListResponse.sampleType
            satNo = historyListResponse.satNo
            sequenceId = historyListResponse.sequenceId
            setId = historyListResponse.setId
            setLength = historyListResponse.setLength
            ...
            startIndex = historyListResponse.startIndex
