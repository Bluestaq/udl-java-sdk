...
class RfObservationTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfObservationTupleResponse].
         *
    ...
    /** A builder for [RfObservationTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationTupleResponse: RfObservationTupleResponse) =
            apply {
                classificationMarking = rfObservationTupleResponse.classificationMarking
                dataMode = rfObservationTupleResponse.dataMode
                obTime = rfObservationTupleResponse.obTime
                source = rfObservationTupleResponse.source
                type = rfObservationTupleResponse.type
                id = rfObservationTupleResponse.id
                antennaName = rfObservationTupleResponse.antennaName
                azimuth = rfObservationTupleResponse.azimuth
                azimuthMeasured = rfObservationTupleResponse.azimuthMeasured
                azimuthRate = rfObservationTupleResponse.azimuthRate
                azimuthUnc = rfObservationTupleResponse.azimuthUnc
                bandwidth = rfObservationTupleResponse.bandwidth
                baudRate = rfObservationTupleResponse.baudRate
                bitErrorRate = rfObservationTupleResponse.bitErrorRate
                carrierStandard = rfObservationTupleResponse.carrierStandard
                channel = rfObservationTupleResponse.channel
                collectionMode = rfObservationTupleResponse.collectionMode
                confidence = rfObservationTupleResponse.confidence
                createdAt = rfObservationTupleResponse.createdAt
                createdBy = rfObservationTupleResponse.createdBy
                descriptor = rfObservationTupleResponse.descriptor
                detectionStatus = rfObservationTupleResponse.detectionStatus
                eirp = rfObservationTupleResponse.eirp
                elevation = rfObservationTupleResponse.elevation
                elevationMeasured = rfObservationTupleResponse.elevationMeasured
                elevationRate = rfObservationTupleResponse.elevationRate
                elevationUnc = rfObservationTupleResponse.elevationUnc
                elnot = rfObservationTupleResponse.elnot
                endFrequency = rfObservationTupleResponse.endFrequency
                frequency = rfObservationTupleResponse.frequency
                frequencyShift = rfObservationTupleResponse.frequencyShift
                idOnOrbit = rfObservationTupleResponse.idOnOrbit
                idSensor = rfObservationTupleResponse.idSensor
                incoming = rfObservationTupleResponse.incoming
                innerCodingRate = rfObservationTupleResponse.innerCodingRate
                maxPsd = rfObservationTupleResponse.maxPsd
                minPsd = rfObservationTupleResponse.minPsd
                modulation = rfObservationTupleResponse.modulation
                noisePwrDensity = rfObservationTupleResponse.noisePwrDensity
                nominalBandwidth = rfObservationTupleResponse.nominalBandwidth
                nominalEirp = rfObservationTupleResponse.nominalEirp
                nominalFrequency = rfObservationTupleResponse.nominalFrequency
                ...
                outerCodingRate = rfObservationTupleResponse.outerCodingRate
                peak = rfObservationTupleResponse.peak
                pgri = rfObservationTupleResponse.pgri
                polarity = rfObservationTupleResponse.polarity
                polarityType = rfObservationTupleResponse.polarityType
                powerOverNoise = rfObservationTupleResponse.powerOverNoise
                range = rfObservationTupleResponse.range
                rangeMeasured = rfObservationTupleResponse.rangeMeasured
                rangeRate = rfObservationTupleResponse.rangeRate
                rangeRateMeasured = rfObservationTupleResponse.rangeRateMeasured
                rangeRateUnc = rfObservationTupleResponse.rangeRateUnc
                rangeUnc = rfObservationTupleResponse.rangeUnc
                rawFileUri = rfObservationTupleResponse.rawFileUri
                referenceLevel = rfObservationTupleResponse.referenceLevel
                relativeCarrierPower = rfObservationTupleResponse.relativeCarrierPower
                relativeNoiseFloor = rfObservationTupleResponse.relativeNoiseFloor
                resolutionBandwidth = rfObservationTupleResponse.resolutionBandwidth
                satNo = rfObservationTupleResponse.satNo
                senalt = rfObservationTupleResponse.senalt
                senlat = rfObservationTupleResponse.senlat
                senlon = rfObservationTupleResponse.senlon
                snr = rfObservationTupleResponse.snr
                sourceDl = rfObservationTupleResponse.sourceDl
                spectrumAnalyzerPower = rfObservationTupleResponse.spectrumAnalyzerPower
                startFrequency = rfObservationTupleResponse.startFrequency
                switchPoint = rfObservationTupleResponse.switchPoint
                symbolToNoiseRatio = rfObservationTupleResponse.symbolToNoiseRatio
                tags = rfObservationTupleResponse.tags.map { it.toMutableList() }
                taskId = rfObservationTupleResponse.taskId
                trackId = rfObservationTupleResponse.trackId
                trackRange = rfObservationTupleResponse.trackRange
                transactionId = rfObservationTupleResponse.transactionId
                transmitFilterRollOff = rfObservationTupleResponse.transmitFilterRollOff
                transmitFilterType = rfObservationTupleResponse.transmitFilterType
                transponder = rfObservationTupleResponse.transponder
                uct = rfObservationTupleResponse.uct
                url = rfObservationTupleResponse.url
                videoBandwidth = rfObservationTupleResponse.videoBandwidth
                additionalProperties = rfObservationTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RfObservationTupleResponse].
         *
         ...
         */
        fun build(): RfObservationTupleResponse =
    ...
    fun validate(): RfObservationTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (obTime.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (antennaName.asKnown().isPresent) 1 else 0) + (if (azimuth.asKnown().isPresent) 1 else 0) + (if (azimuthMeasured.asKnown().isPresent) 1 else 0) + (if (azimuthRate.asKnown().isPresent) 1 else 0) + (if (azimuthUnc.asKnown().isPresent) 1 else 0) + (if (bandwidth.asKnown().isPresent) 1 else 0) + (if (baudRate.asKnown().isPresent) 1 else 0) + (if (bitErrorRate.asKnown().isPresent) 1 else 0) + (if (carrierStandard.asKnown().isPresent) 1 else 0) + (if (channel.asKnown().isPresent) 1 else 0) + (if (collectionMode.asKnown().isPresent) 1 else 0) + (if (confidence.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (detectionStatus.asKnown().isPresent) 1 else 0) + (if (eirp.asKnown().isPresent) 1 else 0) + (if (elevation.asKnown().isPresent) 1 else 0) + (if (elevationMeasured.asKnown().isPresent) 1 else 0) + (if (elevationRate.asKnown().isPresent) 1 else 0) + (if (elevationUnc.asKnown().isPresent) 1 else 0) + (if (elnot.asKnown().isPresent) 1 else 0) + (if (endFrequency.asKnown().isPresent) 1 else 0) + (if (frequency.asKnown().isPresent) 1 else 0) + (if (frequencyShift.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (incoming.asKnown().isPresent) 1 else 0) + (if (innerCodingRate.asKnown().isPresent) 1 else 0) + (if (maxPsd.asKnown().isPresent) 1 else 0) + (if (minPsd.asKnown().isPresent) 1 else 0) + (if (modulation.asKnown().isPresent) 1 else 0) + (if (noisePwrDensity.asKnown().isPresent) 1 else 0) + (if (nominalBandwidth.asKnown().isPresent) 1 else 0) + (if (nominalEirp.asKnown().isPresent) 1 else 0) + (if (nominalFrequency.asKnown().isPresent) 1 else 0) + (if (nominalPowerOverNoise.asKnown().isPresent) 1 else 0) + (if (nominalSnr.asKnown().isPresent) 1 else 0) + (onOrbit.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (outerCodingRate.asKnown().isPresent) 1 else 0) + (if (peak.asKnown().isPresent) 1 else 0) + (if (pgri.asKnown().isPresent) 1 else 0) + (if (polarity.asKnown().isPresent) 1 else 0) + (polarityType.asKnown().getOrNull()?.validity() ?: 0) + (if (powerOverNoise.asKnown().isPresent) 1 else 0) + (if (range.asKnown().isPresent) 1 else 0) + (if (rangeMeasured.asKnown().isPresent) 1 else 0) + (if (rangeRate.asKnown().isPresent) 1 else 0) + (if (rangeRateMeasured.asKnown().isPresent) 1 else 0) + (if (rangeRateUnc.asKnown().isPresent) 1 else 0) + (if (rangeUnc.asKnown().isPresent) 1 else 0) + (if (rawFileUri.asKnown().isPresent) 1 else 0) + (if (referenceLevel.asKnown().isPresent) 1 else 0) + (if (relativeCarrierPower.asKnown().isPresent) 1 else 0) + (if (relativeNoiseFloor.asKnown().isPresent) 1 else 0) + (if (resolutionBandwidth.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlat.asKnown().isPresent) 1 else 0) + (if (senlon.asKnown().isPresent) 1 else 0) + (if (snr.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (spectrumAnalyzerPower.asKnown().isPresent) 1 else 0) + (if (startFrequency.asKnown().isPresent) 1 else 0) + (if (switchPoint.asKnown().isPresent) 1 else 0) + (if (symbolToNoiseRatio.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (taskId.asKnown().isPresent) 1 else 0) + (if (trackId.asKnown().isPresent) 1 else 0) + (if (trackRange.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (transmitFilterRollOff.asKnown().isPresent) 1 else 0) + (if (transmitFilterType.asKnown().isPresent) 1 else 0) + (if (transponder.asKnown().isPresent) 1 else 0) + (if (uct.asKnown().isPresent) 1 else 0) + (if (url.asKnown().isPresent) 1 else 0) + (if (videoBandwidth.asKnown().isPresent) 1 else 0)
