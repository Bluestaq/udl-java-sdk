 ...
 */
class RfObservationTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationTupleResponse: RfObservationTupleResponse) = apply {
    ...
    fun validate(): RfObservationTupleResponse = apply {
        if (validated) {
            return@apply
        }
