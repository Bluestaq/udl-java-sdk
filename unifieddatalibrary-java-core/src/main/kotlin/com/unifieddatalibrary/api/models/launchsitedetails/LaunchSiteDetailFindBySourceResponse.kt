 ...
 */
class LaunchSiteDetailFindBySourceResponse
...
private constructor(
    ...
    /** A builder for [LaunchSiteDetailFindBySourceResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            launchSiteDetailFindBySourceResponse: LaunchSiteDetailFindBySourceResponse
        ) = apply {
            classificationMarking = launchSiteDetailFindBySourceResponse.classificationMarking
            dataMode = launchSiteDetailFindBySourceResponse.dataMode
            idLaunchSite = launchSiteDetailFindBySourceResponse.idLaunchSite
            source = launchSiteDetailFindBySourceResponse.source
            id = launchSiteDetailFindBySourceResponse.id
            availableInclinations =
                launchSiteDetailFindBySourceResponse.availableInclinations.map {
                    it.toMutableList()
                }
            createdAt = launchSiteDetailFindBySourceResponse.createdAt
            createdBy = launchSiteDetailFindBySourceResponse.createdBy
            description = launchSiteDetailFindBySourceResponse.description
            idLocation = launchSiteDetailFindBySourceResponse.idLocation
            launchGroup = launchSiteDetailFindBySourceResponse.launchGroup
            location = launchSiteDetailFindBySourceResponse.location
            origin = launchSiteDetailFindBySourceResponse.origin
            origNetwork = launchSiteDetailFindBySourceResponse.origNetwork
            additionalProperties =
                launchSiteDetailFindBySourceResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteDetailFindBySourceResponse].
         *
         ...
         */
        fun build(): LaunchSiteDetailFindBySourceResponse =
            LaunchSiteDetailFindBySourceResponse(
    ...
    fun validate(): LaunchSiteDetailFindBySourceResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaunchSiteDetailFindBySourceResponse &&
