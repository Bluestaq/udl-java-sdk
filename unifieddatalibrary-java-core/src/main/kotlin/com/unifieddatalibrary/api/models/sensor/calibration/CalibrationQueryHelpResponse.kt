...
class CalibrationQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationQueryHelpResponse: CalibrationQueryHelpResponse) = apply {
    ...
    fun validate(): CalibrationQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
