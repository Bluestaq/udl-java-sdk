...
class CalibrationQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CalibrationQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [CalibrationQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationQueryHelpResponse: CalibrationQueryHelpResponse) =
            apply {
                aodrSupported = calibrationQueryHelpResponse.aodrSupported
                classificationMarking = calibrationQueryHelpResponse.classificationMarking
                description = calibrationQueryHelpResponse.description
                historySupported = calibrationQueryHelpResponse.historySupported
                name = calibrationQueryHelpResponse.name
                parameters = calibrationQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = calibrationQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = calibrationQueryHelpResponse.restSupported
                sortSupported = calibrationQueryHelpResponse.sortSupported
                typeName = calibrationQueryHelpResponse.typeName
                uri = calibrationQueryHelpResponse.uri
                additionalProperties = calibrationQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CalibrationQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CalibrationQueryHelpResponse =
    ...
    fun validate(): CalibrationQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
