...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DropzoneQueryParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneQueryParams: DropzoneQueryParams) = apply {
    ...
    override fun toString() =
        "DropzoneQueryParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
