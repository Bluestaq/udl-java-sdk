...
class GnssRawIfListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GnssRawIfListParams].
         *
    ...
    /** A builder for [GnssRawIfListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gnssRawIfListParams: GnssRawIfListParams) =
            apply {
                startTime = gnssRawIfListParams.startTime
                firstResult = gnssRawIfListParams.firstResult
                maxResults = gnssRawIfListParams.maxResults
                additionalHeaders = gnssRawIfListParams.additionalHeaders.toBuilder()
                additionalQueryParams = gnssRawIfListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GnssRawIfListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GnssRawIfListParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "GnssRawIfListParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
