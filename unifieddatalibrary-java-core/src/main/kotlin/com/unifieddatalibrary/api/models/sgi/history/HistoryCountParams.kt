...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is HistoryCountParams && effectiveDate == other.effectiveDate && firstResult == other.firstResult && maxResults == other.maxResults && sgiDate == other.sgiDate && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "HistoryCountParams{effectiveDate=$effectiveDate, firstResult=$firstResult, maxResults=$maxResults, sgiDate=$sgiDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
