...
class StarCatalogCreateBulkParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogCreateBulkParams: StarCatalogCreateBulkParams) =
            apply {
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("astrometryOrigin") @ExcludeMissing private val astrometryOrigin: JsonField<AstrometryOrigin>,
        ...
        @JsonProperty("neighborDistance") @ExcludeMissing private val neighborDistance: JsonField<Double>,
    ...
    override fun toString() = "StarCatalogCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
