...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ItemCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemCountParams: ItemCountParams) = apply {
    ...
    override fun toString() =
        "ItemCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
