...
class SeradataSigintPayloadListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<SeradataSigintPayloadListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataSigintPayloadListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        fun service(service: SeradataSigintPayloadServiceAsync) =
            apply {
    ...
    override fun toString() = "SeradataSigintPayloadListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
