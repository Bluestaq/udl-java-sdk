...
class GroundImageryTupleResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GroundImageryTupleResponse].
         *
    ...
    /** A builder for [GroundImageryTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryTupleResponse: GroundImageryTupleResponse) = apply {
            classificationMarking = groundImageryTupleResponse.classificationMarking
            dataMode = groundImageryTupleResponse.dataMode
            filename = groundImageryTupleResponse.filename
            imageTime = groundImageryTupleResponse.imageTime
            source = groundImageryTupleResponse.source
            id = groundImageryTupleResponse.id
            checksumValue = groundImageryTupleResponse.checksumValue
            createdAt = groundImageryTupleResponse.createdAt
            createdBy = groundImageryTupleResponse.createdBy
            filesize = groundImageryTupleResponse.filesize
            format = groundImageryTupleResponse.format
            idSensor = groundImageryTupleResponse.idSensor
            keywords = groundImageryTupleResponse.keywords.map { it.toMutableList() }
            name = groundImageryTupleResponse.name
            notes = groundImageryTupleResponse.notes
            origin = groundImageryTupleResponse.origin
            origNetwork = groundImageryTupleResponse.origNetwork
            origSensorId = groundImageryTupleResponse.origSensorId
            region = groundImageryTupleResponse.region
            regionGeoJson = groundImageryTupleResponse.regionGeoJson
            regionNDims = groundImageryTupleResponse.regionNDims
            regionSRid = groundImageryTupleResponse.regionSRid
            regionText = groundImageryTupleResponse.regionText
            regionType = groundImageryTupleResponse.regionType
            sourceDl = groundImageryTupleResponse.sourceDl
            subjectId = groundImageryTupleResponse.subjectId
            tags = groundImageryTupleResponse.tags.map { it.toMutableList() }
            transactionId = groundImageryTupleResponse.transactionId
            updatedAt = groundImageryTupleResponse.updatedAt
            updatedBy = groundImageryTupleResponse.updatedBy
            additionalProperties = groundImageryTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GroundImageryTupleResponse].
         *
         ...
         */
        fun build(): GroundImageryTupleResponse =
    ...
    fun validate(): GroundImageryTupleResponse = apply {
        if (validated) {
            return@apply
        }
