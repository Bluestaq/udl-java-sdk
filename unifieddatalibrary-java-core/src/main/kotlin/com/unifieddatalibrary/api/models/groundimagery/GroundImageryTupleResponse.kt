...
class GroundImageryTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryTupleResponse: GroundImageryTupleResponse) =
            apply {
    ...
    fun validate(): GroundImageryTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
