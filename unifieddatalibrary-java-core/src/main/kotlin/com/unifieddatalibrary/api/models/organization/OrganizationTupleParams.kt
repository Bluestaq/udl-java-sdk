...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationTupleParams].
         *
    ...
    /** A builder for [OrganizationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationTupleParams: OrganizationTupleParams) = apply {
            columns = organizationTupleParams.columns
            firstResult = organizationTupleParams.firstResult
            maxResults = organizationTupleParams.maxResults
            additionalHeaders = organizationTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = organizationTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationTupleParams].
         *
         ...
         */
        fun build(): OrganizationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrganizationTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OrganizationTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
