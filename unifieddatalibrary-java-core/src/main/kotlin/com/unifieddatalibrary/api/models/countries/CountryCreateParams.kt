...
class CountryCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryCreateParams: CountryCreateParams) =
            apply {
        ...
        /** 3 Digit or other alternate country code. */
        fun codeAlt(codeAlt: String) =
            apply {
                body.codeAlt(codeAlt)
            }

        /**
         * Sets [Builder.codeAlt] to an arbitrary JSON value.
         *
         * You should usually call [Builder.codeAlt] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun codeAlt(codeAlt: JsonField<String>) =
            apply {
                body.codeAlt(codeAlt)
            }
         ...
         *
         * You should usually call [Builder.fipsCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fipsCode(fipsCode: JsonField<String>) =
            apply {
                body.fipsCode(fipsCode)
            }

        /** ISO 3166 Alpha-3 country code. This is a three-character code that represents a country name, which may be more closely related to the country name than its corresponding Alpha-2 code. */
        fun iso3Code(iso3Code: String) =
            apply {
                body.iso3Code(iso3Code)
            }

        /**
         * Sets [Builder.iso3Code] to an arbitrary JSON value.
         *
         * You should usually call [Builder.iso3Code] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun iso3Code(iso3Code: JsonField<String>) =
            apply {
                body.iso3Code(iso3Code)
            }
    ...
    class Body private constructor(
         ...
         * Unlike [codeAlt], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("codeAlt")
        @ExcludeMissing
        fun _codeAlt(): JsonField<String> = codeAlt
        ...
        @ExcludeMissing
        fun _fipsCode(): JsonField<String> = fipsCode
        ...
        @ExcludeMissing
        fun _iso3Code(): JsonField<String> = iso3Code
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (code.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (codeAlt.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (fipsCode.asKnown().isPresent) 1 else 0) + (if (iso3Code.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "Body{code=$code, dataMode=$dataMode, source=$source, codeAlt=$codeAlt, createdAt=$createdAt, createdBy=$createdBy, fipsCode=$fipsCode, iso3Code=$iso3Code, name=$name, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CountryCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "CountryCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
