...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LogisticsRemarksFull]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LogisticsRemarksFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsRemarksFull: LogisticsRemarksFull) = apply {
            lastChanged = logisticsRemarksFull.lastChanged
            remark = logisticsRemarksFull.remark
            username = logisticsRemarksFull.username
            additionalProperties = logisticsRemarksFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LogisticsRemarksFull].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LogisticsRemarksFull =
            LogisticsRemarksFull(lastChanged, remark, username, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): LogisticsRemarksFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "LogisticsRemarksFull{lastChanged=$lastChanged, remark=$remark, username=$username, additionalProperties=$additionalProperties}"
}
