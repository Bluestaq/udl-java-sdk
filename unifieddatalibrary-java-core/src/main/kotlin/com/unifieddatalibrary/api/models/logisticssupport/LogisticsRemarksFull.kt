...
class LogisticsRemarksFull private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsRemarksFull: LogisticsRemarksFull) =
            apply {
    ...
    fun validate(): LogisticsRemarksFull =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "LogisticsRemarksFull{lastChanged=$lastChanged, remark=$remark, username=$username, additionalProperties=$additionalProperties}"
}
