...
class StageQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [StageQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [StageQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageQueryhelpResponse: StageQueryhelpResponse) =
            apply {
                aodrSupported = stageQueryhelpResponse.aodrSupported
                classificationMarking = stageQueryhelpResponse.classificationMarking
                description = stageQueryhelpResponse.description
                historySupported = stageQueryhelpResponse.historySupported
                name = stageQueryhelpResponse.name
                parameters = stageQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = stageQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = stageQueryhelpResponse.restSupported
                sortSupported = stageQueryhelpResponse.sortSupported
                typeName = stageQueryhelpResponse.typeName
                uri = stageQueryhelpResponse.uri
                additionalProperties = stageQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StageQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StageQueryhelpResponse =
    ...
    fun validate(): StageQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StageQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
