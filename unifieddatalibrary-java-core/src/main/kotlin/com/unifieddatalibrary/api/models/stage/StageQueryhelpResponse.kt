...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageQueryhelpResponse: StageQueryhelpResponse) = apply {
    ...
    fun validate(): StageQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
