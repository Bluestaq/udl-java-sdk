...
class HistoryListPage private constructor(
    ...
    private val items: List<SpaceEnvObservationFull>,

) : Page<SpaceEnvObservationFull> {
    ...
    fun autoPager(): AutoPager<SpaceEnvObservationFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<SpaceEnvObservationFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<SpaceEnvObservationFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<SpaceEnvObservationFull>) =
            apply {
                this.items = items
            }
