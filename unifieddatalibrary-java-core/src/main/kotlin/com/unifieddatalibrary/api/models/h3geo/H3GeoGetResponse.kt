...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [H3GeoGetResponse].
         *
    ...
    /** A builder for [H3GeoGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoGetResponse: H3GeoGetResponse) = apply {
            cells = h3GeoGetResponse.cells.map { it.toMutableList() }
            classificationMarking = h3GeoGetResponse.classificationMarking
            dataMode = h3GeoGetResponse.dataMode
            numCells = h3GeoGetResponse.numCells
            source = h3GeoGetResponse.source
            startTime = h3GeoGetResponse.startTime
            id = h3GeoGetResponse.id
            centerFreq = h3GeoGetResponse.centerFreq
            createdAt = h3GeoGetResponse.createdAt
            createdBy = h3GeoGetResponse.createdBy
            endTime = h3GeoGetResponse.endTime
            origin = h3GeoGetResponse.origin
            origNetwork = h3GeoGetResponse.origNetwork
            resolution = h3GeoGetResponse.resolution
            sourceDl = h3GeoGetResponse.sourceDl
            tags = h3GeoGetResponse.tags.map { it.toMutableList() }
            type = h3GeoGetResponse.type
            additionalProperties = h3GeoGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [H3GeoGetResponse].
         *
    ...
    fun validate(): H3GeoGetResponse = apply {
        if (validated) {
            return@apply
        }
