...
class SecureMessagingDescribeTopicParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SecureMessagingDescribeTopicParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SecureMessagingDescribeTopicParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SecureMessagingDescribeTopicParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(secureMessagingDescribeTopicParams: SecureMessagingDescribeTopicParams) =
            apply {
                topic = secureMessagingDescribeTopicParams.topic
                firstResult = secureMessagingDescribeTopicParams.firstResult
                maxResults = secureMessagingDescribeTopicParams.maxResults
                additionalHeaders = secureMessagingDescribeTopicParams.additionalHeaders.toBuilder()
                additionalQueryParams = secureMessagingDescribeTopicParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SecureMessagingDescribeTopicParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SecureMessagingDescribeTopicParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SecureMessagingDescribeTopicParams && topic == other.topic && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SecureMessagingDescribeTopicParams{topic=$topic, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
