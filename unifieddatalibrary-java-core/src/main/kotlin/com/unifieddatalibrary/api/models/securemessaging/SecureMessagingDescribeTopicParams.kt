...
class SecureMessagingDescribeTopicParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SecureMessagingDescribeTopicParams = builder().build()
        ...
        internal fun from(secureMessagingDescribeTopicParams: SecureMessagingDescribeTopicParams) =
            apply {
                ...
                additionalQueryParams =
                    secureMessagingDescribeTopicParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "SecureMessagingDescribeTopicParams{topic=$topic, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
