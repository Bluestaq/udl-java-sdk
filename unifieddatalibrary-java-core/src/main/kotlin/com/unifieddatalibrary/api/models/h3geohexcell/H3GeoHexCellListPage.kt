...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellListPage: H3GeoHexCellListPage) = apply {
            service = h3GeoHexCellListPage.service
            params = h3GeoHexCellListPage.params
            items = h3GeoHexCellListPage.items
        }

        fun service(service: H3GeoHexCellService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is H3GeoHexCellListPage &&
