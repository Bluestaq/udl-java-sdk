...
class AirfieldSlotUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotUpdateParams: AirfieldSlotUpdateParams) =
            apply {
        ...
        /** The name of the airfield where this slot is located. */
        fun airfieldName(airfieldName: String) =
            apply {
        ...
        /** Largest category of aircraft supported in this slot (WIDE, NARROW, HELO, ALL, OTHER). */
        fun acSlotCat(acSlotCat: AcSlotCat) =
            apply {
                body.acSlotCat(acSlotCat)
            }
        ...
        /** Minimum time that must elapse between different aircraft leaving and entering this slot, in minutes. */
        fun minSeparation(minSeparation: Int) =
            apply {
        ...
        /** Zulu time this slot is first available based on daily standard hours. Not applicable to slots with type PARKING. Abnormal hours, such as holidays, should be marked via the AirfieldSlotConsumption schema. */
        fun startTime(startTime: String) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirfieldSlotUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AirfieldSlotUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
