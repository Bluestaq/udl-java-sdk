...
class SeraDataEarlyWarningGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SeraDataEarlyWarningGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SeraDataEarlyWarningGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SeraDataEarlyWarningGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningGetParams: SeraDataEarlyWarningGetParams) =
            apply {
                id = seraDataEarlyWarningGetParams.id
                firstResult = seraDataEarlyWarningGetParams.firstResult
                maxResults = seraDataEarlyWarningGetParams.maxResults
                additionalHeaders = seraDataEarlyWarningGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = seraDataEarlyWarningGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeraDataEarlyWarningGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeraDataEarlyWarningGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeraDataEarlyWarningGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SeraDataEarlyWarningGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
