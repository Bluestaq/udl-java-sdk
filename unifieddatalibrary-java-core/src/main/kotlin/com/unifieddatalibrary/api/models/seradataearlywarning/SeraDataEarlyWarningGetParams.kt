 ...
 * parameter.
 */
class SeraDataEarlyWarningGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeraDataEarlyWarningGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningGetParams: SeraDataEarlyWarningGetParams) = apply {
    ...
    override fun toString() =
        "SeraDataEarlyWarningGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
