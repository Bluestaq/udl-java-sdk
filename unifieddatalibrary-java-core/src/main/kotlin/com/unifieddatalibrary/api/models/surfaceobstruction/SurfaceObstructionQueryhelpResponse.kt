...
class SurfaceObstructionQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SurfaceObstructionQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SurfaceObstructionQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionQueryhelpResponse: SurfaceObstructionQueryhelpResponse) =
            apply {
                aodrSupported = surfaceObstructionQueryhelpResponse.aodrSupported
                classificationMarking = surfaceObstructionQueryhelpResponse.classificationMarking
                description = surfaceObstructionQueryhelpResponse.description
                historySupported = surfaceObstructionQueryhelpResponse.historySupported
                name = surfaceObstructionQueryhelpResponse.name
                parameters = surfaceObstructionQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = surfaceObstructionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = surfaceObstructionQueryhelpResponse.restSupported
                sortSupported = surfaceObstructionQueryhelpResponse.sortSupported
                typeName = surfaceObstructionQueryhelpResponse.typeName
                uri = surfaceObstructionQueryhelpResponse.uri
                additionalProperties = surfaceObstructionQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceObstructionQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SurfaceObstructionQueryhelpResponse =
    ...
    fun validate(): SurfaceObstructionQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SurfaceObstructionQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
