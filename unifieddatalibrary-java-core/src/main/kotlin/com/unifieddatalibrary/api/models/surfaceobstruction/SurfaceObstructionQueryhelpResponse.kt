...
class SurfaceObstructionQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            surfaceObstructionQueryhelpResponse: SurfaceObstructionQueryhelpResponse
        ) = apply {
            ...
            requiredRoles =
                surfaceObstructionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                surfaceObstructionQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): SurfaceObstructionQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
