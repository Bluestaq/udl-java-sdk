 ...
 */
class AircraftStatusRemarkListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AircraftStatusRemarkListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusRemarkListParams: AircraftStatusRemarkListParams) = apply {
    ...
    override fun toString() =
        "AircraftStatusRemarkListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
