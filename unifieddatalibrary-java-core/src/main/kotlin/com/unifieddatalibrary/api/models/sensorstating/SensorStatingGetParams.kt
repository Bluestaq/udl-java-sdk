...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorStatingGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SensorStatingGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SensorStatingGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorStatingGetParams: SensorStatingGetParams) = apply {
            id = sensorStatingGetParams.id
            firstResult = sensorStatingGetParams.firstResult
            maxResults = sensorStatingGetParams.maxResults
            additionalHeaders = sensorStatingGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = sensorStatingGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SensorStatingGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorStatingGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorStatingGetParams &&
            id == other.id &&
    ...
    override fun toString() =
        "SensorStatingGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
