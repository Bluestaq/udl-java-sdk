...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TupleListParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tupleListParams: TupleListParams) = apply {
            columns = tupleListParams.columns
            createdAt = tupleListParams.createdAt
            firstResult = tupleListParams.firstResult
            maxResults = tupleListParams.maxResults
            additionalHeaders = tupleListParams.additionalHeaders.toBuilder()
            additionalQueryParams = tupleListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TupleListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TupleListParams && columns == other.columns && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TupleListParams{columns=$columns, createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
