...
class ChannelTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChannelTupleParams].
         *
    ...
    /** A builder for [ChannelTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(channelTupleParams: ChannelTupleParams) =
            apply {
                columns = channelTupleParams.columns
                firstResult = channelTupleParams.firstResult
                maxResults = channelTupleParams.maxResults
                additionalHeaders = channelTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = channelTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ChannelTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ChannelTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ChannelTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
