...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceTupleResponse: SurfaceTupleResponse) = apply {
            ...
            surfaceObstructions =
                surfaceTupleResponse.surfaceObstructions.map { it.toMutableList() }
    ...
    fun validate(): SurfaceTupleResponse = apply {
        if (validated) {
            return@apply
        }
