...
class SurfaceTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("surfaceObstructions") @ExcludeMissing surfaceObstructions: JsonField<List<SurfaceObstruction>> = JsonMissing.of(),
    ...
    /**
     * An array of SurfaceNavigation objects representing information about obstructions proximal to this surface. This is a read-only field that will be populated with any associated SurfaceObstruction objects for queries that return the full schema.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun surfaceObstructions(): Optional<List<SurfaceObstruction>> = surfaceObstructions.getOptional("surfaceObstructions")
     ...
     *
     * Unlike [surfaceObstructions], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceTupleResponse].
         *
    ...
    /** A builder for [SurfaceTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceTupleResponse: SurfaceTupleResponse) =
            apply {
                classificationMarking = surfaceTupleResponse.classificationMarking
                dataMode = surfaceTupleResponse.dataMode
                name = surfaceTupleResponse.name
                source = surfaceTupleResponse.source
                type = surfaceTupleResponse.type
                id = surfaceTupleResponse.id
                altSiteId = surfaceTupleResponse.altSiteId
                condition = surfaceTupleResponse.condition
                createdAt = surfaceTupleResponse.createdAt
                createdBy = surfaceTupleResponse.createdBy
                ddtWtKip = surfaceTupleResponse.ddtWtKip
                ddtWtKipMod = surfaceTupleResponse.ddtWtKipMod
                ddtWtKipModNote = surfaceTupleResponse.ddtWtKipModNote
                ddtWtKn = surfaceTupleResponse.ddtWtKn
                ddWtKip = surfaceTupleResponse.ddWtKip
                ddWtKipMod = surfaceTupleResponse.ddWtKipMod
                ddWtKipModNote = surfaceTupleResponse.ddWtKipModNote
                ddWtKn = surfaceTupleResponse.ddWtKn
                endLat = surfaceTupleResponse.endLat
                endLon = surfaceTupleResponse.endLon
                idSite = surfaceTupleResponse.idSite
                lcn = surfaceTupleResponse.lcn
                ldaFt = surfaceTupleResponse.ldaFt
                ldaM = surfaceTupleResponse.ldaM
                lengthFt = surfaceTupleResponse.lengthFt
                lengthM = surfaceTupleResponse.lengthM
                lighting = surfaceTupleResponse.lighting
                lightsAprch = surfaceTupleResponse.lightsAprch
                lightsCl = surfaceTupleResponse.lightsCl
                lightsOls = surfaceTupleResponse.lightsOls
                lightsPapi = surfaceTupleResponse.lightsPapi
                lightsReil = surfaceTupleResponse.lightsReil
                lightsRwy = surfaceTupleResponse.lightsRwy
                lightsSeqfl = surfaceTupleResponse.lightsSeqfl
                lightsTdzl = surfaceTupleResponse.lightsTdzl
                lightsUnkn = surfaceTupleResponse.lightsUnkn
                lightsVasi = surfaceTupleResponse.lightsVasi
                material = surfaceTupleResponse.material
                obstacle = surfaceTupleResponse.obstacle
                origin = surfaceTupleResponse.origin
                origNetwork = surfaceTupleResponse.origNetwork
                pcn = surfaceTupleResponse.pcn
                pointReference = surfaceTupleResponse.pointReference
                primary = surfaceTupleResponse.primary
                rawWbc = surfaceTupleResponse.rawWbc
                sbttWtKip = surfaceTupleResponse.sbttWtKip
                sbttWtKipMod = surfaceTupleResponse.sbttWtKipMod
                sbttWtKipModNote = surfaceTupleResponse.sbttWtKipModNote
                sbttWtKn = surfaceTupleResponse.sbttWtKn
                startLat = surfaceTupleResponse.startLat
                startLon = surfaceTupleResponse.startLon
                stWtKip = surfaceTupleResponse.stWtKip
                stWtKipMod = surfaceTupleResponse.stWtKipMod
                stWtKipModNote = surfaceTupleResponse.stWtKipModNote
                stWtKn = surfaceTupleResponse.stWtKn
                surfaceObstructions = surfaceTupleResponse.surfaceObstructions.map { it.toMutableList() }
                sWtKip = surfaceTupleResponse.sWtKip
                sWtKipMod = surfaceTupleResponse.sWtKipMod
                sWtKipModNote = surfaceTupleResponse.sWtKipModNote
                sWtKn = surfaceTupleResponse.sWtKn
                tdtWtkip = surfaceTupleResponse.tdtWtkip
                tdtWtKipMod = surfaceTupleResponse.tdtWtKipMod
                tdtWtKipModNote = surfaceTupleResponse.tdtWtKipModNote
                tdtWtKn = surfaceTupleResponse.tdtWtKn
                trtWtKip = surfaceTupleResponse.trtWtKip
                trtWtKipMod = surfaceTupleResponse.trtWtKipMod
                trtWtKipModNote = surfaceTupleResponse.trtWtKipModNote
                trtWtKn = surfaceTupleResponse.trtWtKn
                ttWtKip = surfaceTupleResponse.ttWtKip
                ttWtKipMod = surfaceTupleResponse.ttWtKipMod
                ttWtKipModNote = surfaceTupleResponse.ttWtKipModNote
                ttWtKn = surfaceTupleResponse.ttWtKn
                tWtKip = surfaceTupleResponse.tWtKip
                tWtKipMod = surfaceTupleResponse.tWtKipMod
                tWtKipModNote = surfaceTupleResponse.tWtKipModNote
                tWtKn = surfaceTupleResponse.tWtKn
                updatedAt = surfaceTupleResponse.updatedAt
                updatedBy = surfaceTupleResponse.updatedBy
                widthFt = surfaceTupleResponse.widthFt
                widthM = surfaceTupleResponse.widthM
                additionalProperties = surfaceTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /** An array of SurfaceNavigation objects representing information about obstructions proximal to this surface. This is a read-only field that will be populated with any associated SurfaceObstruction objects for queries that return the full schema. */
        fun surfaceObstructions(surfaceObstructions: List<SurfaceObstruction>) = surfaceObstructions(JsonField.of(surfaceObstructions))

        /**
         * Sets [Builder.surfaceObstructions] to an arbitrary JSON value.
         *
         * You should usually call [Builder.surfaceObstructions] with a well-typed `List<SurfaceObstruction>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun surfaceObstructions(surfaceObstructions: JsonField<List<SurfaceObstruction>>) =
            apply {
         ...
         */
        fun addSurfaceObstruction(surfaceObstruction: SurfaceObstruction) =
            apply {
                surfaceObstructions = (surfaceObstructions ?: JsonField.of(mutableListOf())).also {
        ...
        /**
         * Returns an immutable instance of [SurfaceTupleResponse].
         *
         ...
         */
        fun build(): SurfaceTupleResponse =
    ...
    fun validate(): SurfaceTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class SurfaceObstruction private constructor(
        private val classificationMarking: JsonField<String>,
        private val dataMode: JsonField<DataMode>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(surfaceObstruction: SurfaceObstruction) =
                apply {
        ...
        fun validate(): SurfaceObstruction =
            apply {
                if (validated) {
                  return@apply
                }
