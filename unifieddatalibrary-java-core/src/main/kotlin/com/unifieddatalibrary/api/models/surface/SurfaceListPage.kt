...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceListPage: SurfaceListPage) = apply {
            service = surfaceListPage.service
            params = surfaceListPage.params
            items = surfaceListPage.items
        }

        fun service(service: SurfaceService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SurfaceListPage &&
