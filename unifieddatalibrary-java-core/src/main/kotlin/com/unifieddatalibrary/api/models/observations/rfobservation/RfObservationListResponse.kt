...
class RfObservationListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationListResponse: RfObservationListResponse) =
            apply {
    ...
    fun validate(): RfObservationListResponse =
        apply {
            if (validated) {
              return@apply
            }
