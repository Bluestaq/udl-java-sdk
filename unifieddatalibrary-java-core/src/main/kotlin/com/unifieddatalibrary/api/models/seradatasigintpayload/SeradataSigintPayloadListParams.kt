 ...
 */
class SeradataSigintPayloadListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataSigintPayloadListParams = builder().build()
        ...
        internal fun from(seradataSigintPayloadListParams: SeradataSigintPayloadListParams) =
            apply {
                ...
                additionalQueryParams =
                    seradataSigintPayloadListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "SeradataSigintPayloadListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
