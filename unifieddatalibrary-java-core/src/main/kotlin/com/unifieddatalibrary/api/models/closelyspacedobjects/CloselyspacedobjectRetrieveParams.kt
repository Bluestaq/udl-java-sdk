...
/**
 * Service operation to get a single CloselySpacedObjects (CSO) record by its unique ID passed as a
 * path parameter.
 */
class CloselyspacedobjectRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CloselyspacedobjectRetrieveParams = builder().build()
    ...
    /** A builder for [CloselyspacedobjectRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(closelyspacedobjectRetrieveParams: CloselyspacedobjectRetrieveParams) =
            apply {
                id = closelyspacedobjectRetrieveParams.id
                firstResult = closelyspacedobjectRetrieveParams.firstResult
                maxResults = closelyspacedobjectRetrieveParams.maxResults
                additionalHeaders = closelyspacedobjectRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    closelyspacedobjectRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CloselyspacedobjectRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CloselyspacedobjectRetrieveParams =
            CloselyspacedobjectRetrieveParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloselyspacedobjectRetrieveParams &&
            id == other.id &&
    ...
    override fun toString() =
        "CloselyspacedobjectRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
