...
class ChannelRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ChannelRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(channelRetrieveParams: ChannelRetrieveParams) =
            apply {
    ...
    override fun toString() = "ChannelRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
