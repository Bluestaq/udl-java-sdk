...
class AirTaskingOrderQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(airTaskingOrderQueryHelpResponse: AirTaskingOrderQueryHelpResponse) =
            apply {
                ...
                requiredRoles =
                    airTaskingOrderQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    airTaskingOrderQueryHelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): AirTaskingOrderQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
