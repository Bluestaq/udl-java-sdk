...
class AirTaskingOrderQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AirTaskingOrderQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirTaskingOrderQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderQueryHelpResponse: AirTaskingOrderQueryHelpResponse) =
            apply {
                aodrSupported = airTaskingOrderQueryHelpResponse.aodrSupported
                classificationMarking = airTaskingOrderQueryHelpResponse.classificationMarking
                description = airTaskingOrderQueryHelpResponse.description
                historySupported = airTaskingOrderQueryHelpResponse.historySupported
                name = airTaskingOrderQueryHelpResponse.name
                parameters = airTaskingOrderQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = airTaskingOrderQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = airTaskingOrderQueryHelpResponse.restSupported
                sortSupported = airTaskingOrderQueryHelpResponse.sortSupported
                typeName = airTaskingOrderQueryHelpResponse.typeName
                uri = airTaskingOrderQueryHelpResponse.uri
                additionalProperties = airTaskingOrderQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirTaskingOrderQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirTaskingOrderQueryHelpResponse =
    ...
    fun validate(): AirTaskingOrderQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirTaskingOrderQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
