...
class AnalyticImageryHistoryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AnalyticImageryHistoryParams].
         *
    ...
    /** A builder for [AnalyticImageryHistoryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryHistoryParams: AnalyticImageryHistoryParams) =
            apply {
                msgTime = analyticImageryHistoryParams.msgTime
                columns = analyticImageryHistoryParams.columns
                firstResult = analyticImageryHistoryParams.firstResult
                maxResults = analyticImageryHistoryParams.maxResults
                additionalHeaders = analyticImageryHistoryParams.additionalHeaders.toBuilder()
                additionalQueryParams = analyticImageryHistoryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticImageryHistoryParams].
         *
         ...
         */
        fun build(): AnalyticImageryHistoryParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AnalyticImageryHistoryParams && msgTime == other.msgTime && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(msgTime, columns, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AnalyticImageryHistoryParams{msgTime=$msgTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
