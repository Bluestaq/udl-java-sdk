 ...
 * Density (3D) data, etc.
 */
class GlobalAtmosphericModelListResponse
private constructor(
    ...
    /** A builder for [GlobalAtmosphericModelListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelListResponse: GlobalAtmosphericModelListResponse) =
            apply {
                classificationMarking = globalAtmosphericModelListResponse.classificationMarking
                dataMode = globalAtmosphericModelListResponse.dataMode
                source = globalAtmosphericModelListResponse.source
                ts = globalAtmosphericModelListResponse.ts
                type = globalAtmosphericModelListResponse.type
                id = globalAtmosphericModelListResponse.id
                cadence = globalAtmosphericModelListResponse.cadence
                checksumValue = globalAtmosphericModelListResponse.checksumValue
                createdAt = globalAtmosphericModelListResponse.createdAt
                createdBy = globalAtmosphericModelListResponse.createdBy
                dataSourceIdentifier = globalAtmosphericModelListResponse.dataSourceIdentifier
                endAlt = globalAtmosphericModelListResponse.endAlt
                endLat = globalAtmosphericModelListResponse.endLat
                endLon = globalAtmosphericModelListResponse.endLon
                filename = globalAtmosphericModelListResponse.filename
                filesize = globalAtmosphericModelListResponse.filesize
                numAlt = globalAtmosphericModelListResponse.numAlt
                numLat = globalAtmosphericModelListResponse.numLat
                numLon = globalAtmosphericModelListResponse.numLon
                origin = globalAtmosphericModelListResponse.origin
                origNetwork = globalAtmosphericModelListResponse.origNetwork
                reportTime = globalAtmosphericModelListResponse.reportTime
                sourceDl = globalAtmosphericModelListResponse.sourceDl
                startAlt = globalAtmosphericModelListResponse.startAlt
                startLat = globalAtmosphericModelListResponse.startLat
                startLon = globalAtmosphericModelListResponse.startLon
                state = globalAtmosphericModelListResponse.state
                stepLat = globalAtmosphericModelListResponse.stepLat
                stepLon = globalAtmosphericModelListResponse.stepLon
                additionalProperties =
                    globalAtmosphericModelListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [GlobalAtmosphericModelListResponse].
         *
         ...
         */
        fun build(): GlobalAtmosphericModelListResponse =
            GlobalAtmosphericModelListResponse(
    ...
    fun validate(): GlobalAtmosphericModelListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GlobalAtmosphericModelListResponse &&
