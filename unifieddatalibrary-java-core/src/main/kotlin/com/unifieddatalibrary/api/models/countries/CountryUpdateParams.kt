...
class CountryUpdateParams private constructor(
    ...
    fun pathCode(): Optional<String> = Optional.ofNullable(pathCode)
    ...
    class Builder internal constructor() {
        ...
        internal fun from(countryUpdateParams: CountryUpdateParams) =
            apply {
                pathCode = countryUpdateParams.pathCode
        ...
        fun pathCode(pathCode: String?) =
            apply {
                this.pathCode = pathCode
            }

        /** Alias for calling [Builder.pathCode] with `pathCode.orElse(null)`. */
        fun pathCode(pathCode: Optional<String>) = pathCode(pathCode.getOrNull())
        ...
        /** The country code. Optimally, this value is the ISO 3166 Alpha-2-two-character country code, however it can represent various consortiums that do not appear in the ISO document. */
        fun bodyCode(bodyCode: String) =
            apply {
                body.bodyCode(bodyCode)
            }

        /**
         * Sets [Builder.bodyCode] to an arbitrary JSON value.
         *
         * You should usually call [Builder.bodyCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun bodyCode(bodyCode: JsonField<String>) =
            apply {
                body.bodyCode(bodyCode)
            }
    ...
    class Body private constructor(
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun bodyCode(): String = bodyCode.getRequired("code")
        ...
        @JsonProperty("code")
        @ExcludeMissing
        fun _bodyCode(): JsonField<String> = bodyCode
        ...
        class Builder internal constructor() {
            ...
            private var bodyCode: JsonField<String>? = null
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Body && bodyCode == other.bodyCode && dataMode == other.dataMode && source == other.source && codeAlt == other.codeAlt && createdAt == other.createdAt && createdBy == other.createdBy && fipsCode == other.fipsCode && iso3Code == other.iso3Code && name == other.name && origNetwork == other.origNetwork && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(bodyCode, dataMode, source, codeAlt, createdAt, createdBy, fipsCode, iso3Code, name, origNetwork, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{bodyCode=$bodyCode, dataMode=$dataMode, source=$source, codeAlt=$codeAlt, createdAt=$createdAt, createdBy=$createdBy, fipsCode=$fipsCode, iso3Code=$iso3Code, name=$name, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CountryUpdateParams && pathCode == other.pathCode && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathCode, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "CountryUpdateParams{pathCode=$pathCode, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
