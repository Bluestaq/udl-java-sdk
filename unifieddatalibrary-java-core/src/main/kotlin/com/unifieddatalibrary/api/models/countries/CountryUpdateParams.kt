...
/**
 * Service operation to update a single Country. A specific role is required to perform this service
...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                    checkRequired("bodyCode", bodyCode),
        ...
        internal fun validity(): Int =
            (if (bodyCode.asKnown().isPresent) 1 else 0) +
        ...
        override fun toString() =
            "Body{bodyCode=$bodyCode, dataMode=$dataMode, source=$source, codeAlt=$codeAlt, createdAt=$createdAt, createdBy=$createdBy, fipsCode=$fipsCode, iso3Code=$iso3Code, name=$name, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "CountryUpdateParams{pathCode=$pathCode, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
