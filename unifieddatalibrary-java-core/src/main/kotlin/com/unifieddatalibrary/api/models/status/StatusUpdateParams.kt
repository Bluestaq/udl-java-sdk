...
/**
 * Service operation to update a single Status. A specific role is required to perform this service
...
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun subStatusCollection(): Optional<List<SubStatusIngest>> = body.subStatusCollection()
     ...
     * type.
     */
    fun _subStatusCollection(): JsonField<List<SubStatusIngest>> = body._subStatusCollection()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(statusUpdateParams: StatusUpdateParams) = apply {
            pathId = statusUpdateParams.pathId
            body = statusUpdateParams.body.toBuilder()
        ...
        /** Operation capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK). */
        fun opsCap(opsCap: OpsCap) = apply { body.opsCap(opsCap) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun opsCap(opsCap: JsonField<OpsCap>) = apply { body.opsCap(opsCap) }
        ...
        fun subStatusCollection(subStatusCollection: List<SubStatusIngest>) = apply {
         ...
         * `List<SubStatusIngest>` value instead. This method is primarily for setting the field to
         * an undocumented or not yet supported value.
         */
        fun subStatusCollection(subStatusCollection: JsonField<List<SubStatusIngest>>) = apply {
            body.subStatusCollection(subStatusCollection)
        }

        /**
         * Adds a single [SubStatusIngest] to [Builder.subStatusCollection].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSubStatusCollection(subStatusCollection: SubStatusIngest) = apply {
            body.addSubStatusCollection(subStatusCollection)
        }

        /** System capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK). */
        fun sysCap(sysCap: SysCap) = apply { body.sysCap(sysCap) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun sysCap(sysCap: JsonField<SysCap>) = apply { body.sysCap(sysCap) }
    ...
    /**
     * Status for a particular Entity. An entity may have multiple status records collected by
     * various sources.
     */
    class Body
    ...
    private constructor(
        ...
        private val subStatusCollection: JsonField<List<SubStatusIngest>>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            subStatusCollection: JsonField<List<SubStatusIngest>> = JsonMissing.of(),
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun subStatusCollection(): Optional<List<SubStatusIngest>> =
         ...
         * Returns the raw JSON value of [subStatusCollection].
         *
         * Unlike [subStatusCollection], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("subStatusCollection")
        @ExcludeMissing
        fun _subStatusCollection(): JsonField<List<SubStatusIngest>> = subStatusCollection
        ...
        class Builder internal constructor() {
            ...
            private var subStatusCollection: JsonField<MutableList<SubStatusIngest>>? = null
             ...
             * Sets [Builder.opsCap] to an arbitrary JSON value.
             *
             * You should usually call [Builder.opsCap] with a well-typed [OpsCap] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            fun subStatusCollection(subStatusCollection: List<SubStatusIngest>) =
             ...
             *
             * You should usually call [Builder.subStatusCollection] with a well-typed
             * `List<SubStatusIngest>` value instead. This method is primarily for setting the field
             ...
             * Sets [Builder.sysCap] to an arbitrary JSON value.
             *
             * You should usually call [Builder.sysCap] with a well-typed [SysCap] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idEntity=$idEntity, source=$source, bodyId=$bodyId, createdAt=$createdAt, createdBy=$createdBy, declassificationDate=$declassificationDate, declassificationString=$declassificationString, derivedFrom=$derivedFrom, notes=$notes, opsCap=$opsCap, origin=$origin, origNetwork=$origNetwork, state=$state, subStatusCollection=$subStatusCollection, sysCap=$sysCap, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "StatusUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
