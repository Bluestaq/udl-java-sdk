...
class RfEmitterTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterTupleResponse: RfEmitterTupleResponse) =
            apply {
    ...
    fun validate(): RfEmitterTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
