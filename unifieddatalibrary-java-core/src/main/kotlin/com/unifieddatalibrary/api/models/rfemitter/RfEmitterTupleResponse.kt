...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfEmitterTupleResponse].
         *
    ...
    /** A builder for [RfEmitterTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterTupleResponse: RfEmitterTupleResponse) = apply {
            classificationMarking = rfEmitterTupleResponse.classificationMarking
            dataMode = rfEmitterTupleResponse.dataMode
            name = rfEmitterTupleResponse.name
            source = rfEmitterTupleResponse.source
            id = rfEmitterTupleResponse.id
            createdAt = rfEmitterTupleResponse.createdAt
            createdBy = rfEmitterTupleResponse.createdBy
            entity = rfEmitterTupleResponse.entity
            extSysId = rfEmitterTupleResponse.extSysId
            idEntity = rfEmitterTupleResponse.idEntity
            origin = rfEmitterTupleResponse.origin
            origNetwork = rfEmitterTupleResponse.origNetwork
            rfEmitterDetails = rfEmitterTupleResponse.rfEmitterDetails.map { it.toMutableList() }
            subtype = rfEmitterTupleResponse.subtype
            type = rfEmitterTupleResponse.type
            updatedAt = rfEmitterTupleResponse.updatedAt
            updatedBy = rfEmitterTupleResponse.updatedBy
            additionalProperties = rfEmitterTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RfEmitterTupleResponse].
         *
         ...
         */
        fun build(): RfEmitterTupleResponse =
    ...
    fun validate(): RfEmitterTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RfEmitterTupleResponse &&
            classificationMarking == other.classificationMarking &&
            dataMode == other.dataMode &&
            name == other.name &&
            source == other.source &&
