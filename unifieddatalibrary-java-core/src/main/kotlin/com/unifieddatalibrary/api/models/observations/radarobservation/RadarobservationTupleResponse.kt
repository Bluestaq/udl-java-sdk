...
class RadarobservationTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RadarobservationTupleResponse].
         *
    ...
    /** A builder for [RadarobservationTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationTupleResponse: RadarobservationTupleResponse) =
            apply {
                classificationMarking = radarobservationTupleResponse.classificationMarking
                dataMode = radarobservationTupleResponse.dataMode
                obTime = radarobservationTupleResponse.obTime
                source = radarobservationTupleResponse.source
                id = radarobservationTupleResponse.id
                azimuth = radarobservationTupleResponse.azimuth
                azimuthBias = radarobservationTupleResponse.azimuthBias
                azimuthMeasured = radarobservationTupleResponse.azimuthMeasured
                azimuthRate = radarobservationTupleResponse.azimuthRate
                azimuthUnc = radarobservationTupleResponse.azimuthUnc
                beam = radarobservationTupleResponse.beam
                createdAt = radarobservationTupleResponse.createdAt
                createdBy = radarobservationTupleResponse.createdBy
                declination = radarobservationTupleResponse.declination
                declinationMeasured = radarobservationTupleResponse.declinationMeasured
                descriptor = radarobservationTupleResponse.descriptor
                doppler = radarobservationTupleResponse.doppler
                dopplerUnc = radarobservationTupleResponse.dopplerUnc
                elevation = radarobservationTupleResponse.elevation
                elevationBias = radarobservationTupleResponse.elevationBias
                elevationMeasured = radarobservationTupleResponse.elevationMeasured
                elevationRate = radarobservationTupleResponse.elevationRate
                elevationUnc = radarobservationTupleResponse.elevationUnc
                idOnOrbit = radarobservationTupleResponse.idOnOrbit
                idSensor = radarobservationTupleResponse.idSensor
                obPosition = radarobservationTupleResponse.obPosition
                onOrbit = radarobservationTupleResponse.onOrbit
                origin = radarobservationTupleResponse.origin
                origNetwork = radarobservationTupleResponse.origNetwork
                origObjectId = radarobservationTupleResponse.origObjectId
                origSensorId = radarobservationTupleResponse.origSensorId
                orthogonalRcs = radarobservationTupleResponse.orthogonalRcs
                orthogonalRcsUnc = radarobservationTupleResponse.orthogonalRcsUnc
                ra = radarobservationTupleResponse.ra
                raMeasured = radarobservationTupleResponse.raMeasured
                range = radarobservationTupleResponse.range
                rangeAccel = radarobservationTupleResponse.rangeAccel
                rangeAccelUnc = radarobservationTupleResponse.rangeAccelUnc
                rangeBias = radarobservationTupleResponse.rangeBias
                rangeMeasured = radarobservationTupleResponse.rangeMeasured
                rangeRate = radarobservationTupleResponse.rangeRate
                rangeRateMeasured = radarobservationTupleResponse.rangeRateMeasured
                rangeRateUnc = radarobservationTupleResponse.rangeRateUnc
                rangeUnc = radarobservationTupleResponse.rangeUnc
                rawFileUri = radarobservationTupleResponse.rawFileUri
                rcs = radarobservationTupleResponse.rcs
                rcsUnc = radarobservationTupleResponse.rcsUnc
                satNo = radarobservationTupleResponse.satNo
                senReferenceFrame = radarobservationTupleResponse.senReferenceFrame
                senx = radarobservationTupleResponse.senx
                seny = radarobservationTupleResponse.seny
                senz = radarobservationTupleResponse.senz
                snr = radarobservationTupleResponse.snr
                sourceDl = radarobservationTupleResponse.sourceDl
                tags = radarobservationTupleResponse.tags.map { it.toMutableList() }
                taskId = radarobservationTupleResponse.taskId
                timingBias = radarobservationTupleResponse.timingBias
                trackId = radarobservationTupleResponse.trackId
                trackingState = radarobservationTupleResponse.trackingState
                transactionId = radarobservationTupleResponse.transactionId
                type = radarobservationTupleResponse.type
                uct = radarobservationTupleResponse.uct
                x = radarobservationTupleResponse.x
                xvel = radarobservationTupleResponse.xvel
                y = radarobservationTupleResponse.y
                yvel = radarobservationTupleResponse.yvel
                z = radarobservationTupleResponse.z
                zvel = radarobservationTupleResponse.zvel
                additionalProperties = radarobservationTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RadarobservationTupleResponse].
         *
         ...
         */
        fun build(): RadarobservationTupleResponse =
    ...
    fun validate(): RadarobservationTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
