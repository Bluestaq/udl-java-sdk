 ...
 */
class RadarobservationTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationTupleResponse: RadarobservationTupleResponse) = apply {
    ...
    fun validate(): RadarobservationTupleResponse = apply {
        if (validated) {
            return@apply
        }
