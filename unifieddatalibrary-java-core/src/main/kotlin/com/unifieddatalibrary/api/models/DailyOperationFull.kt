...
class DailyOperationFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("operatingHours") @ExcludeMissing operatingHours: JsonField<List<OperatingHoursFull>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun operatingHours(): Optional<List<OperatingHoursFull>> = operatingHours.getOptional("operatingHours")
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dailyOperationFull: DailyOperationFull) =
            apply {
        ...
        /** A collection containing the operational start and stop times scheduled for the day of the week specified. */
        fun operatingHours(operatingHours: List<OperatingHoursFull>) = operatingHours(JsonField.of(operatingHours))

        /**
         * Sets [Builder.operatingHours] to an arbitrary JSON value.
         *
         * You should usually call [Builder.operatingHours] with a well-typed `List<OperatingHoursFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun operatingHours(operatingHours: JsonField<List<OperatingHoursFull>>) =
            apply {
         ...
         */
        fun addOperatingHour(operatingHour: OperatingHoursFull) =
            apply {
    ...
    fun validate(): DailyOperationFull =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "DailyOperationFull{dayOfWeek=$dayOfWeek, operatingHours=$operatingHours, operationName=$operationName, ophrsLastChangedBy=$ophrsLastChangedBy, ophrsLastChangedDate=$ophrsLastChangedDate, additionalProperties=$additionalProperties}"
}
