 ...
 */
class ObscorrelationListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObscorrelationListResponse].
         *
    ...
    /** A builder for [ObscorrelationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(obscorrelationListResponse: ObscorrelationListResponse) = apply {
            classificationMarking = obscorrelationListResponse.classificationMarking
            corrType = obscorrelationListResponse.corrType
            dataMode = obscorrelationListResponse.dataMode
            msgTs = obscorrelationListResponse.msgTs
            obId = obscorrelationListResponse.obId
            obType = obscorrelationListResponse.obType
            referenceOrbitId = obscorrelationListResponse.referenceOrbitId
            referenceOrbitType = obscorrelationListResponse.referenceOrbitType
            source = obscorrelationListResponse.source
            id = obscorrelationListResponse.id
            algorithmCorrType = obscorrelationListResponse.algorithmCorrType
            altCatalog = obscorrelationListResponse.altCatalog
            altNamespace = obscorrelationListResponse.altNamespace
            altObjectId = obscorrelationListResponse.altObjectId
            altUct = obscorrelationListResponse.altUct
            astat = obscorrelationListResponse.astat
            corrQuality = obscorrelationListResponse.corrQuality
            createdAt = obscorrelationListResponse.createdAt
            createdBy = obscorrelationListResponse.createdBy
            idOnOrbit = obscorrelationListResponse.idOnOrbit
            idParentCorrelation = obscorrelationListResponse.idParentCorrelation
            origin = obscorrelationListResponse.origin
            origNetwork = obscorrelationListResponse.origNetwork
            origObjectId = obscorrelationListResponse.origObjectId
            satNo = obscorrelationListResponse.satNo
            sourceDl = obscorrelationListResponse.sourceDl
            trackId = obscorrelationListResponse.trackId
            transactionId = obscorrelationListResponse.transactionId
            additionalProperties = obscorrelationListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationListResponse].
         *
         ...
         */
        fun build(): ObscorrelationListResponse =
    ...
    fun validate(): ObscorrelationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationListResponse &&
    ...
    override fun toString() =
        "ObscorrelationListResponse{classificationMarking=$classificationMarking, corrType=$corrType, dataMode=$dataMode, msgTs=$msgTs, obId=$obId, obType=$obType, referenceOrbitId=$referenceOrbitId, referenceOrbitType=$referenceOrbitType, source=$source, id=$id, algorithmCorrType=$algorithmCorrType, altCatalog=$altCatalog, altNamespace=$altNamespace, altObjectId=$altObjectId, altUct=$altUct, astat=$astat, corrQuality=$corrQuality, createdAt=$createdAt, createdBy=$createdBy, idOnOrbit=$idOnOrbit, idParentCorrelation=$idParentCorrelation, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, satNo=$satNo, sourceDl=$sourceDl, trackId=$trackId, transactionId=$transactionId, additionalProperties=$additionalProperties}"
}
