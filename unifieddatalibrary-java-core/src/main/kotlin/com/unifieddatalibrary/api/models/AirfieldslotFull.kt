...
class AirfieldslotFull private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirfieldslotFull].
         *
    ...
    /** A builder for [AirfieldslotFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldslotFull: AirfieldslotFull) =
            apply {
                airfieldName = airfieldslotFull.airfieldName
                classificationMarking = airfieldslotFull.classificationMarking
                dataMode = airfieldslotFull.dataMode
                name = airfieldslotFull.name
                source = airfieldslotFull.source
                id = airfieldslotFull.id
                acSlotCat = airfieldslotFull.acSlotCat
                altAirfieldId = airfieldslotFull.altAirfieldId
                capacity = airfieldslotFull.capacity
                createdAt = airfieldslotFull.createdAt
                createdBy = airfieldslotFull.createdBy
                endTime = airfieldslotFull.endTime
                icao = airfieldslotFull.icao
                idAirfield = airfieldslotFull.idAirfield
                minSeparation = airfieldslotFull.minSeparation
                notes = airfieldslotFull.notes
                origin = airfieldslotFull.origin
                origNetwork = airfieldslotFull.origNetwork
                sourceDl = airfieldslotFull.sourceDl
                startTime = airfieldslotFull.startTime
                type = airfieldslotFull.type
                updatedAt = airfieldslotFull.updatedAt
                updatedBy = airfieldslotFull.updatedBy
                additionalProperties = airfieldslotFull.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldslotFull].
         *
    ...
    override fun toString() = "AirfieldslotFull{airfieldName=$airfieldName, classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, acSlotCat=$acSlotCat, altAirfieldId=$altAirfieldId, capacity=$capacity, createdAt=$createdAt, createdBy=$createdBy, endTime=$endTime, icao=$icao, idAirfield=$idAirfield, minSeparation=$minSeparation, notes=$notes, origin=$origin, origNetwork=$origNetwork, sourceDl=$sourceDl, startTime=$startTime, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
