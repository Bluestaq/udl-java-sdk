...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldslotFull: AirfieldslotFull) = apply {
    ...
    fun validate(): AirfieldslotFull = apply {
        if (validated) {
            return@apply
        }
