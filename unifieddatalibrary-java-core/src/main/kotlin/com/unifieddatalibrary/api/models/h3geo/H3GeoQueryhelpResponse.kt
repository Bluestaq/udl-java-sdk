...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [H3GeoQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [H3GeoQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoQueryhelpResponse: H3GeoQueryhelpResponse) = apply {
            aodrSupported = h3GeoQueryhelpResponse.aodrSupported
            classificationMarking = h3GeoQueryhelpResponse.classificationMarking
            description = h3GeoQueryhelpResponse.description
            historySupported = h3GeoQueryhelpResponse.historySupported
            name = h3GeoQueryhelpResponse.name
            parameters = h3GeoQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = h3GeoQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = h3GeoQueryhelpResponse.restSupported
            sortSupported = h3GeoQueryhelpResponse.sortSupported
            typeName = h3GeoQueryhelpResponse.typeName
            uri = h3GeoQueryhelpResponse.uri
            additionalProperties = h3GeoQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [H3GeoQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): H3GeoQueryhelpResponse =
    ...
    fun validate(): H3GeoQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is H3GeoQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
