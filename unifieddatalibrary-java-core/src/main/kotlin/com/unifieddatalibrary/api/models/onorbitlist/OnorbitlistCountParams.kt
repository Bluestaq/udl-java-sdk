...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitlistCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistCountParams: OnorbitlistCountParams) = apply {
    ...
    override fun toString() =
        "OnorbitlistCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
