...
class SkyImageryGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SkyImageryGetResponse].
         *
    ...
    /** A builder for [SkyImageryGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryGetResponse: SkyImageryGetResponse) =
            apply {
                classificationMarking = skyImageryGetResponse.classificationMarking
                dataMode = skyImageryGetResponse.dataMode
                expStartTime = skyImageryGetResponse.expStartTime
                imageType = skyImageryGetResponse.imageType
                source = skyImageryGetResponse.source
                id = skyImageryGetResponse.id
                annotationKey = skyImageryGetResponse.annotationKey
                calibrationKey = skyImageryGetResponse.calibrationKey
                checksumValue = skyImageryGetResponse.checksumValue
                createdAt = skyImageryGetResponse.createdAt
                createdBy = skyImageryGetResponse.createdBy
                description = skyImageryGetResponse.description
                eoObservations = skyImageryGetResponse.eoObservations.map { it.toMutableList() }
                expEndTime = skyImageryGetResponse.expEndTime
                filename = skyImageryGetResponse.filename
                filesize = skyImageryGetResponse.filesize
                frameFovHeight = skyImageryGetResponse.frameFovHeight
                frameFovWidth = skyImageryGetResponse.frameFovWidth
                frameHeightPixels = skyImageryGetResponse.frameHeightPixels
                frameWidthPixels = skyImageryGetResponse.frameWidthPixels
                idAttitudeSet = skyImageryGetResponse.idAttitudeSet
                idOnOrbit = skyImageryGetResponse.idOnOrbit
                idSensor = skyImageryGetResponse.idSensor
                idSoiSet = skyImageryGetResponse.idSoiSet
                imageSetId = skyImageryGetResponse.imageSetId
                imageSetLength = skyImageryGetResponse.imageSetLength
                imageSourceInfo = skyImageryGetResponse.imageSourceInfo
                onOrbit = skyImageryGetResponse.onOrbit
                origin = skyImageryGetResponse.origin
                origNetwork = skyImageryGetResponse.origNetwork
                origObjectId = skyImageryGetResponse.origObjectId
                origSensorId = skyImageryGetResponse.origSensorId
                pixelBitDepth = skyImageryGetResponse.pixelBitDepth
                pixelFovHeight = skyImageryGetResponse.pixelFovHeight
                pixelFovWidth = skyImageryGetResponse.pixelFovWidth
                satNo = skyImageryGetResponse.satNo
                senalt = skyImageryGetResponse.senalt
                senlat = skyImageryGetResponse.senlat
                senlon = skyImageryGetResponse.senlon
                senQuat = skyImageryGetResponse.senQuat.map { it.toMutableList() }
                senQuatDot = skyImageryGetResponse.senQuatDot.map { it.toMutableList() }
                senx = skyImageryGetResponse.senx
                seny = skyImageryGetResponse.seny
                senz = skyImageryGetResponse.senz
                sequenceId = skyImageryGetResponse.sequenceId
                sourceDl = skyImageryGetResponse.sourceDl
                tags = skyImageryGetResponse.tags.map { it.toMutableList() }
                topLeftStartAz = skyImageryGetResponse.topLeftStartAz
                topLeftStartEl = skyImageryGetResponse.topLeftStartEl
                topLeftStopAz = skyImageryGetResponse.topLeftStopAz
                topLeftStopEl = skyImageryGetResponse.topLeftStopEl
                transactionId = skyImageryGetResponse.transactionId
                additionalProperties = skyImageryGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SkyImageryGetResponse].
         *
         ...
         */
        fun build(): SkyImageryGetResponse =
    ...
    fun validate(): SkyImageryGetResponse =
        apply {
            if (validated) {
              return@apply
            }
