...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryGetResponse: SkyImageryGetResponse) = apply {
    ...
    fun validate(): SkyImageryGetResponse = apply {
        if (validated) {
            return@apply
        }
