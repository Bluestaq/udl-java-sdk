...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbiteventListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventListParams: OnorbiteventListParams) = apply {
    ...
    override fun toString() =
        "OnorbiteventListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
