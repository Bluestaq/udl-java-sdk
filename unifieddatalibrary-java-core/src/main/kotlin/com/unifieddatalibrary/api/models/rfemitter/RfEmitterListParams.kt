...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfEmitterListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterListParams: RfEmitterListParams) = apply {
    ...
    override fun toString() =
        "RfEmitterListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
