 ...
 */
class ObscorrelationListParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObscorrelationListParams].
         *
    ...
    /** A builder for [ObscorrelationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(obscorrelationListParams: ObscorrelationListParams) = apply {
            msgTs = obscorrelationListParams.msgTs
            firstResult = obscorrelationListParams.firstResult
            maxResults = obscorrelationListParams.maxResults
            additionalHeaders = obscorrelationListParams.additionalHeaders.toBuilder()
            additionalQueryParams = obscorrelationListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationListParams].
         *
         ...
         */
        fun build(): ObscorrelationListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationListParams &&
            msgTs == other.msgTs &&
    ...
    override fun toString() =
        "ObscorrelationListParams{msgTs=$msgTs, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
