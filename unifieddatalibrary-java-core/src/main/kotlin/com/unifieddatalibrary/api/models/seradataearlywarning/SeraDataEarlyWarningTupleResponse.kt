...
class SeraDataEarlyWarningTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(seraDataEarlyWarningTupleResponse: SeraDataEarlyWarningTupleResponse) =
            apply {
                ...
                missileLaunchPhaseDetectionAbility =
                    seraDataEarlyWarningTupleResponse.missileLaunchPhaseDetectionAbility
                ...
                additionalProperties =
                    seraDataEarlyWarningTupleResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SeraDataEarlyWarningTupleResponse = apply {
        if (validated) {
            return@apply
        }
