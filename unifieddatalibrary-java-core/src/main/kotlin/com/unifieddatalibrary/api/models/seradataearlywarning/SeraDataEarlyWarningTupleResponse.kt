...
class SeraDataEarlyWarningTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeraDataEarlyWarningTupleResponse].
         *
    ...
    /** A builder for [SeraDataEarlyWarningTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningTupleResponse: SeraDataEarlyWarningTupleResponse) =
            apply {
                classificationMarking = seraDataEarlyWarningTupleResponse.classificationMarking
                dataMode = seraDataEarlyWarningTupleResponse.dataMode
                source = seraDataEarlyWarningTupleResponse.source
                spacecraftId = seraDataEarlyWarningTupleResponse.spacecraftId
                id = seraDataEarlyWarningTupleResponse.id
                bestResolution = seraDataEarlyWarningTupleResponse.bestResolution
                createdAt = seraDataEarlyWarningTupleResponse.createdAt
                createdBy = seraDataEarlyWarningTupleResponse.createdBy
                earthPointing = seraDataEarlyWarningTupleResponse.earthPointing
                frequencyLimits = seraDataEarlyWarningTupleResponse.frequencyLimits
                groundStationLocations = seraDataEarlyWarningTupleResponse.groundStationLocations
                groundStations = seraDataEarlyWarningTupleResponse.groundStations
                hostedForCompanyOrgId = seraDataEarlyWarningTupleResponse.hostedForCompanyOrgId
                idIr = seraDataEarlyWarningTupleResponse.idIr
                manufacturerOrgId = seraDataEarlyWarningTupleResponse.manufacturerOrgId
                missileLaunchPhaseDetectionAbility = seraDataEarlyWarningTupleResponse.missileLaunchPhaseDetectionAbility
                name = seraDataEarlyWarningTupleResponse.name
                origin = seraDataEarlyWarningTupleResponse.origin
                origNetwork = seraDataEarlyWarningTupleResponse.origNetwork
                partnerSpacecraftId = seraDataEarlyWarningTupleResponse.partnerSpacecraftId
                payloadNotes = seraDataEarlyWarningTupleResponse.payloadNotes
                spectralBands = seraDataEarlyWarningTupleResponse.spectralBands
                updatedAt = seraDataEarlyWarningTupleResponse.updatedAt
                updatedBy = seraDataEarlyWarningTupleResponse.updatedBy
                additionalProperties = seraDataEarlyWarningTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeraDataEarlyWarningTupleResponse].
         *
         ...
         */
        fun build(): SeraDataEarlyWarningTupleResponse =
    ...
    fun validate(): SeraDataEarlyWarningTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
