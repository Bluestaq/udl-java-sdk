...
/**
 * Model representation of a nominal RF emitter. This entity contains minimal information used to
 * stage RF emitter entities.
 */
class StagingRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StagingRetrieveResponse].
         *
    ...
    /** A builder for [StagingRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stagingRetrieveResponse: StagingRetrieveResponse) = apply {
            classificationMarking = stagingRetrieveResponse.classificationMarking
            name = stagingRetrieveResponse.name
            source = stagingRetrieveResponse.source
            id = stagingRetrieveResponse.id
            altitude = stagingRetrieveResponse.altitude
            createdAt = stagingRetrieveResponse.createdAt
            createdBy = stagingRetrieveResponse.createdBy
            extSysId = stagingRetrieveResponse.extSysId
            lat = stagingRetrieveResponse.lat
            locationCountry = stagingRetrieveResponse.locationCountry
            lon = stagingRetrieveResponse.lon
            ownerCountry = stagingRetrieveResponse.ownerCountry
            subtype = stagingRetrieveResponse.subtype
            type = stagingRetrieveResponse.type
            additionalProperties = stagingRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StagingRetrieveResponse].
         *
         ...
         */
        fun build(): StagingRetrieveResponse =
    ...
    fun validate(): StagingRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StagingRetrieveResponse &&
    ...
    override fun toString() =
        "StagingRetrieveResponse{classificationMarking=$classificationMarking, name=$name, source=$source, id=$id, altitude=$altitude, createdAt=$createdAt, createdBy=$createdBy, extSysId=$extSysId, lat=$lat, locationCountry=$locationCountry, lon=$lon, ownerCountry=$ownerCountry, subtype=$subtype, type=$type, additionalProperties=$additionalProperties}"
}
