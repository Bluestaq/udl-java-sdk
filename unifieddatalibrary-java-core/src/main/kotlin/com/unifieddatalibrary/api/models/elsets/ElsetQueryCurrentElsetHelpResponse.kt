...
class ElsetQueryCurrentElsetHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(elsetQueryCurrentElsetHelpResponse: ElsetQueryCurrentElsetHelpResponse) =
            apply {
                ...
                parameters =
                    elsetQueryCurrentElsetHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    elsetQueryCurrentElsetHelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    elsetQueryCurrentElsetHelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): ElsetQueryCurrentElsetHelpResponse = apply {
        if (validated) {
            return@apply
        }
