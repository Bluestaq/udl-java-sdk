...
class ElsetQueryCurrentElsetHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ElsetQueryCurrentElsetHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ElsetQueryCurrentElsetHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elsetQueryCurrentElsetHelpResponse: ElsetQueryCurrentElsetHelpResponse) =
            apply {
                aodrSupported = elsetQueryCurrentElsetHelpResponse.aodrSupported
                classificationMarking = elsetQueryCurrentElsetHelpResponse.classificationMarking
                description = elsetQueryCurrentElsetHelpResponse.description
                historySupported = elsetQueryCurrentElsetHelpResponse.historySupported
                name = elsetQueryCurrentElsetHelpResponse.name
                parameters = elsetQueryCurrentElsetHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = elsetQueryCurrentElsetHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = elsetQueryCurrentElsetHelpResponse.restSupported
                sortSupported = elsetQueryCurrentElsetHelpResponse.sortSupported
                typeName = elsetQueryCurrentElsetHelpResponse.typeName
                uri = elsetQueryCurrentElsetHelpResponse.uri
                additionalProperties = elsetQueryCurrentElsetHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ElsetQueryCurrentElsetHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ElsetQueryCurrentElsetHelpResponse =
    ...
    fun validate(): ElsetQueryCurrentElsetHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
