...
class SensorObservationTypeListResponse
private constructor(
        ...
        internal fun from(sensorObservationTypeListResponse: SensorObservationTypeListResponse) =
            apply {
                ...
                additionalProperties =
                    sensorObservationTypeListResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SensorObservationTypeListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorObservationTypeListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SensorObservationTypeListResponse{id=$id, createdAt=$createdAt, createdBy=$createdBy, origNetwork=$origNetwork, type=$type, additionalProperties=$additionalProperties}"
}
