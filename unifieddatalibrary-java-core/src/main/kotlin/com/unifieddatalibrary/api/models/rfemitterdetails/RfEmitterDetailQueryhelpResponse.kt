...
class RfEmitterDetailQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(rfEmitterDetailQueryhelpResponse: RfEmitterDetailQueryhelpResponse) =
            apply {
                ...
                requiredRoles =
                    rfEmitterDetailQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    rfEmitterDetailQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): RfEmitterDetailQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
