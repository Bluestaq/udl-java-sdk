...
class RfEmitterDetailQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RfEmitterDetailQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfEmitterDetailQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailQueryhelpResponse: RfEmitterDetailQueryhelpResponse) =
            apply {
                aodrSupported = rfEmitterDetailQueryhelpResponse.aodrSupported
                classificationMarking = rfEmitterDetailQueryhelpResponse.classificationMarking
                description = rfEmitterDetailQueryhelpResponse.description
                historySupported = rfEmitterDetailQueryhelpResponse.historySupported
                name = rfEmitterDetailQueryhelpResponse.name
                parameters = rfEmitterDetailQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = rfEmitterDetailQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = rfEmitterDetailQueryhelpResponse.restSupported
                sortSupported = rfEmitterDetailQueryhelpResponse.sortSupported
                typeName = rfEmitterDetailQueryhelpResponse.typeName
                uri = rfEmitterDetailQueryhelpResponse.uri
                additionalProperties = rfEmitterDetailQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RfEmitterDetailQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfEmitterDetailQueryhelpResponse =
    ...
    fun validate(): RfEmitterDetailQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfEmitterDetailQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
