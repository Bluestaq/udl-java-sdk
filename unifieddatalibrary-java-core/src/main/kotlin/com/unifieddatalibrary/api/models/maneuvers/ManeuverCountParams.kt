...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManeuverCountParams].
         *
    ...
    /** A builder for [ManeuverCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(maneuverCountParams: ManeuverCountParams) = apply {
            eventStartTime = maneuverCountParams.eventStartTime
            firstResult = maneuverCountParams.firstResult
            maxResults = maneuverCountParams.maxResults
            additionalHeaders = maneuverCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = maneuverCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ManeuverCountParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ManeuverCountParams && eventStartTime == other.eventStartTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ManeuverCountParams{eventStartTime=$eventStartTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
