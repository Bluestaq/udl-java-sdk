...
class AttitudeSetListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<AttitudeSetListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeSetListPageAsync: AttitudeSetListPageAsync) = apply {
        ...
        fun service(service: AttitudeSetServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AttitudeSetListPageAsync &&
    ...
    override fun toString() =
        "AttitudeSetListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
