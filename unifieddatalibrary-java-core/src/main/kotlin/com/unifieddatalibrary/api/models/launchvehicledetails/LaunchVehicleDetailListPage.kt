...
class LaunchVehicleDetailListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleDetailListPage: LaunchVehicleDetailListPage) =
            apply {
        ...
        fun service(service: LaunchVehicleDetailService) =
            apply {
    ...
    override fun toString() = "LaunchVehicleDetailListPage{service=$service, params=$params, items=$items}"
}
