...
private constructor(
    ...
    private constructor(
         ...
         * different labeling convention. The MGRS is used as geocode for the entire Earth.
         *
         * Example of an milgrid coordinate, or grid reference, would be 4QFJ12345678, which
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UdlSigactUnvalidatedPublishParams &&
            body == other.body &&
