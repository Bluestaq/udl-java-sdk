...
class SkyImageryGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SkyImageryGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryGetParams: SkyImageryGetParams) =
            apply {
    ...
    override fun toString() = "SkyImageryGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
