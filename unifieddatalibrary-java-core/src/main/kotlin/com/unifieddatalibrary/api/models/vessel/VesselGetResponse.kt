...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselGetResponse: VesselGetResponse) = apply {
    ...
    fun validate(): VesselGetResponse = apply {
        if (validated) {
            return@apply
        }
