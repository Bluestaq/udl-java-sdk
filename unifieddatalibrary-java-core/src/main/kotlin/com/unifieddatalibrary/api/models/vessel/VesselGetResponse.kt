...
class VesselGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VesselGetResponse].
         *
    ...
    /** A builder for [VesselGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselGetResponse: VesselGetResponse) =
            apply {
                classificationMarking = vesselGetResponse.classificationMarking
                dataMode = vesselGetResponse.dataMode
                source = vesselGetResponse.source
                id = vesselGetResponse.id
                altVesselId = vesselGetResponse.altVesselId
                callsign = vesselGetResponse.callsign
                createdAt = vesselGetResponse.createdAt
                createdBy = vesselGetResponse.createdBy
                entity = vesselGetResponse.entity
                firstSeen = vesselGetResponse.firstSeen
                hullNum = vesselGetResponse.hullNum
                idEntity = vesselGetResponse.idEntity
                idOrganization = vesselGetResponse.idOrganization
                imon = vesselGetResponse.imon
                length = vesselGetResponse.length
                maxDraught = vesselGetResponse.maxDraught
                maxSpeed = vesselGetResponse.maxSpeed
                mmsi = vesselGetResponse.mmsi
                numBlades = vesselGetResponse.numBlades
                numShafts = vesselGetResponse.numShafts
                origin = vesselGetResponse.origin
                origNetwork = vesselGetResponse.origNetwork
                propType = vesselGetResponse.propType
                sconum = vesselGetResponse.sconum
                sourceDl = vesselGetResponse.sourceDl
                status = vesselGetResponse.status
                sternType = vesselGetResponse.sternType
                updatedAt = vesselGetResponse.updatedAt
                updatedBy = vesselGetResponse.updatedBy
                vesselBuilder = vesselGetResponse.vesselBuilder
                vesselClass = vesselGetResponse.vesselClass
                vesselDescription = vesselGetResponse.vesselDescription
                vesselFlag = vesselGetResponse.vesselFlag
                vesselName = vesselGetResponse.vesselName
                vesselType = vesselGetResponse.vesselType
                vslWt = vesselGetResponse.vslWt
                width = vesselGetResponse.width
                yearBuilt = vesselGetResponse.yearBuilt
                additionalProperties = vesselGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [VesselGetResponse].
         *
    ...
    fun validate(): VesselGetResponse =
        apply {
            if (validated) {
              return@apply
            }
