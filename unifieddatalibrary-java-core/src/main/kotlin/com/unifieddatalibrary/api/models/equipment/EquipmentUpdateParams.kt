...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentUpdateParams: EquipmentUpdateParams) = apply {
        ...
        /** Unique identifier of the Equipment record from the originating system. */
        fun altEqpId(altEqpId: String) = apply { body.altEqpId(altEqpId) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun altEqpId(altEqpId: JsonField<String>) = apply { body.altEqpId(altEqpId) }
         ...
         */
        fun eqpCode(eqpCode: String) = apply { body.eqpCode(eqpCode) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun eqpCode(eqpCode: JsonField<String>) = apply { body.eqpCode(eqpCode) }

        /**
         * Uniquely identifies each item or group of equipment associated with a unit, facility or
         * site.
         */
        fun eqpIdNum(eqpIdNum: String) = apply { body.eqpIdNum(eqpIdNum) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun eqpIdNum(eqpIdNum: JsonField<String>) = apply { body.eqpIdNum(eqpIdNum) }
         ...
         * provided, users may consult the data provider.
         */
        fun function(function: String) = apply { body.function(function) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun function(function: JsonField<String>) = apply { body.function(function) }
         ...
         * Unique identifier of the Parent equipment record associated with this equipment record.
         */
        fun idParentEquipment(idParentEquipment: String) = apply {
         ...
         */
        fun nomen(nomen: String) = apply { body.nomen(nomen) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun nomen(nomen: JsonField<String>) = apply { body.nomen(nomen) }
         ...
         */
        fun operAreaPrimary(operAreaPrimary: String) = apply {
         ...
         */
        fun qtyOh(qtyOh: Int) = apply { body.qtyOh(qtyOh) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun qtyOh(qtyOh: JsonField<Int>) = apply { body.qtyOh(qtyOh) }
        ...
        /** Provider specific sequential number assigned to the equipment. */
        fun seqNum(seqNum: Int) = apply { body.seqNum(seqNum) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun seqNum(seqNum: JsonField<Int>) = apply { body.seqNum(seqNum) }
