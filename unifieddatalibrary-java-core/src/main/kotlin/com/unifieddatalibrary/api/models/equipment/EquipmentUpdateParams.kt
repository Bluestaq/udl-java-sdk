...
class EquipmentUpdateParams private constructor(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun altEqpId(): Optional<String> = body.altEqpId()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun eqpCode(): Optional<String> = body.eqpCode()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun eqpIdNum(): Optional<String> = body.eqpIdNum()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun function(): Optional<String> = body.function()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun idParentEquipment(): Optional<String> = body.idParentEquipment()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun nomen(): Optional<String> = body.nomen()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun operAreaPrimary(): Optional<String> = body.operAreaPrimary()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun qtyOh(): Optional<Int> = body.qtyOh()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun seqNum(): Optional<Int> = body.seqNum()
     ...
     */
    fun _altEqpId(): JsonField<String> = body._altEqpId()
     ...
     */
    fun _eqpCode(): JsonField<String> = body._eqpCode()
     ...
     */
    fun _eqpIdNum(): JsonField<String> = body._eqpIdNum()
     ...
     */
    fun _function(): JsonField<String> = body._function()
     ...
     */
    fun _idParentEquipment(): JsonField<String> = body._idParentEquipment()
     ...
     */
    fun _nomen(): JsonField<String> = body._nomen()
     ...
     */
    fun _operAreaPrimary(): JsonField<String> = body._operAreaPrimary()
     ...
     */
    fun _qtyOh(): JsonField<Int> = body._qtyOh()
     ...
     */
    fun _seqNum(): JsonField<Int> = body._seqNum()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EquipmentUpdateParams].
         *
    ...
    /** A builder for [EquipmentUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentUpdateParams: EquipmentUpdateParams) =
            apply {
                pathId = equipmentUpdateParams.pathId
                body = equipmentUpdateParams.body.toBuilder()
                additionalHeaders = equipmentUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = equipmentUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Air Defense District (ADD) or Air Defense Area (ADA) in which the geographic coordinates reside. */
        fun airDefArea(airDefArea: String) =
            apply {
                body.airDefArea(airDefArea)
            }
        ...
        /** The DoD Standard Country Code designator for the country or political entity to which the equipment owes its allegiance. This field will be set to "OTHR" if the source value does not match a UDL Country code value (ISO-3166-ALPHA-2). */
        fun allegiance(allegiance: String) =
            apply {
        ...
        /** Specifies an alternate allegiance code if the data provider code is not part of an official Country Code standard such as ISO-3166 or FIPS. This field will be set to the value provided by the source and should be used for all Queries specifying allegiance. */
        fun altAllegiance(altAllegiance: String) =
            apply {
        ...
        /** Unique identifier of the Equipment record from the originating system. */
        fun altEqpId(altEqpId: String) =
            apply {
                body.altEqpId(altEqpId)
            }
         ...
         * O - Other. Explain in Remarks.
         */
        fun classRating(classRating: String) =
            apply {
                body.classRating(classRating)
            }
        ...
        /** A mathematical model of the earth used to calculate coordinates on a map. US Forces use the World Geodetic System 1984 (WGS 84), but also use maps by allied countries with local datums. The datum must be specified to ensure accuracy of coordinates. The specific usage and enumerations contained in this field may be found in the documentation provided in the referenceDoc field. If referenceDoc not provided, users may consult the data provider. */
        fun coordDatum(coordDatum: String) =
            apply {
                body.coordDatum(coordDatum)
            }
        ...
        /** Indicates the plus or minus error assessed against the method used to derive the coordinate. */
        fun coordDerivAcc(coordDerivAcc: Double) =
            apply {
        ...
        /** Ground elevation, in meters, of the geographic coordinates referenced to (above or below) Mean Sea Level (MSL) vertical datum. */
        fun elevMsl(elevMsl: Double) =
            apply {
                body.elevMsl(elevMsl)
            }
        ...
        /** Indicates the confidence level expressed as a percent that a specific geometric spatial element, ELEVATION_MSL linear accuracy, has been vertically positioned to within a specified vertical accuracy. Confidence level has a range of values from 0 to 100, with 100 being highest level of confidence. */
        fun elevMslConfLvl(elevMslConfLvl: Int) =
            apply {
        ...
        /** Designated equipment code assigned to the item of equipment or an abbreviation record type unique identifier. Users should consult the data provider for information on the equipment code structure. */
        fun eqpCode(eqpCode: String) =
            apply {
                body.eqpCode(eqpCode)
            }
        ...
        /** Uniquely identifies each item or group of equipment associated with a unit, facility or site. */
        fun eqpIdNum(eqpIdNum: String) =
            apply {
                body.eqpIdNum(eqpIdNum)
            }
        ...
        /** Principal operational function being performed. The specific usage and enumerations contained in this field may be found in the documentation provided in the referenceDoc field. If referenceDoc not provided, users may consult the data provider. */
        fun functPrimary(functPrimary: String) =
            apply {
        ...
        /** The distance between Mean Sea Level and a referenced ellipsoid, measured in meters. */
        fun geoidalMslSep(geoidalMslSep: Double) =
            apply {
        ...
        fun idParentEquipment(idParentEquipment: String) =
            apply {
                body.idParentEquipment(idParentEquipment)
            }
        ...
        /** Indicates the reason that the equipment is at that location. The specific usage and enumerations contained in this field may be found in the documentation provided in the referenceDoc field. If referenceDoc not provided, users may consult the data provider. */
        fun locReason(locReason: String) =
            apply {
                body.locReason(locReason)
            }
         ...
         * 12345678 (numerical location; easting is 1234 and northing is 5678, in this case specifying a location with 10 m resolution).
         */
        fun milGrid(milGrid: String) =
            apply {
                body.milGrid(milGrid)
            }
         ...
         * UTM - Universal Transverse Mercator.
         */
        fun milGridSys(milGridSys: String) =
            apply {
                body.milGridSys(milGridSys)
            }
        ...
        fun operAreaPrimary(operAreaPrimary: String) =
            apply {
                body.operAreaPrimary(operAreaPrimary)
            }
        ...
        /** The Degree to which an entity is ready to perform the overall operational mission(s) for which it was organized and equipped. The specific usage and enumerations contained in this field may be found in the documentation provided in the referenceDoc field. If referenceDoc not provided, users may consult the data provider. */
        fun operStatus(operStatus: String) =
            apply {
                body.operStatus(operStatus)
            }
        ...
        /** Political subdivision in which the geographic coordinates reside. The specific usage and enumerations contained in this field may be found in the documentation provided in the referenceDoc field. If referenceDoc not provided, users may consult the data provider. */
        fun polSubdiv(polSubdiv: String) =
            apply {
                body.polSubdiv(polSubdiv)
            }
         ...
         * W - Working Record.
         */
        fun recStatus(recStatus: String) =
            apply {
                body.recStatus(recStatus)
            }
        ...
        /** The reference documentiation that specifies the usage and enumerations contained in this record. If referenceDoc not provided, users may consult the data provider. */
        fun referenceDoc(referenceDoc: String) =
            apply {
        ...
        /** Responsible Producer - Organization that is responsible for the maintenance of the record. */
        fun resProd(resProd: String) =
            apply {
                body.resProd(resProd)
            }
        ...
        /** A standard scheme for symbol coding enabling the transfer, display and use of symbols and graphics among information systems, as per MIL-STD 2525B, and supported by the element AFFILIATION. */
        fun symCode(symCode: String) =
            apply {
                body.symCode(symCode)
            }
        ...
        /**
         * Returns an immutable instance of [EquipmentUpdateParams].
         *
         ...
         */
        fun build(): EquipmentUpdateParams =
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (airDefArea.asKnown().isPresent) 1 else 0) + (if (allegiance.asKnown().isPresent) 1 else 0) + (if (altAllegiance.asKnown().isPresent) 1 else 0) + (if (altCountryCode.asKnown().isPresent) 1 else 0) + (if (altEqpId.asKnown().isPresent) 1 else 0) + (if (classRating.asKnown().isPresent) 1 else 0) + (if (condition.asKnown().isPresent) 1 else 0) + (if (conditionAvail.asKnown().isPresent) 1 else 0) + (if (coord.asKnown().isPresent) 1 else 0) + (if (coordDatum.asKnown().isPresent) 1 else 0) + (if (coordDerivAcc.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (elevMsl.asKnown().isPresent) 1 else 0) + (if (elevMslConfLvl.asKnown().isPresent) 1 else 0) + (if (elevMslDerivAcc.asKnown().isPresent) 1 else 0) + (if (eqpCode.asKnown().isPresent) 1 else 0) + (if (eqpIdNum.asKnown().isPresent) 1 else 0) + (if (eval.asKnown().isPresent) 1 else 0) + (if (fpa.asKnown().isPresent) 1 else 0) + (if (function.asKnown().isPresent) 1 else 0) + (if (functPrimary.asKnown().isPresent) 1 else 0) + (if (geoidalMslSep.asKnown().isPresent) 1 else 0) + (if (ident.asKnown().isPresent) 1 else 0) + (if (idOperatingUnit.asKnown().isPresent) 1 else 0) + (if (idParentEquipment.asKnown().isPresent) 1 else 0) + (if (idSite.asKnown().isPresent) 1 else 0) + (if (locReason.asKnown().isPresent) 1 else 0) + (if (milGrid.asKnown().isPresent) 1 else 0) + (if (milGridSys.asKnown().isPresent) 1 else 0) + (if (nomen.asKnown().isPresent) 1 else 0) + (if (operAreaPrimary.asKnown().isPresent) 1 else 0) + (if (operStatus.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (polSubdiv.asKnown().isPresent) 1 else 0) + (if (qtyOh.asKnown().isPresent) 1 else 0) + (if (recStatus.asKnown().isPresent) 1 else 0) + (if (referenceDoc.asKnown().isPresent) 1 else 0) + (if (resProd.asKnown().isPresent) 1 else 0) + (if (reviewDate.asKnown().isPresent) 1 else 0) + (if (seqNum.asKnown().isPresent) 1 else 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (if (symCode.asKnown().isPresent) 1 else 0) + (if (utm.asKnown().isPresent) 1 else 0) + (if (wac.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "EquipmentUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
