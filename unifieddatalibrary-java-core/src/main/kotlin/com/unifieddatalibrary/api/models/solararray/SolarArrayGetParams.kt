...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SolarArrayGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayGetParams: SolarArrayGetParams) = apply {
    ...
    override fun toString() =
        "SolarArrayGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
