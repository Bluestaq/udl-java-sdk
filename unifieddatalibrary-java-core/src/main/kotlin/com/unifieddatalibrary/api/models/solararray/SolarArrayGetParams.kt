...
class SolarArrayGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SolarArrayGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SolarArrayGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SolarArrayGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayGetParams: SolarArrayGetParams) =
            apply {
                id = solarArrayGetParams.id
                firstResult = solarArrayGetParams.firstResult
                maxResults = solarArrayGetParams.maxResults
                additionalHeaders = solarArrayGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = solarArrayGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SolarArrayGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SolarArrayGetParams =
            SolarArrayGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SolarArrayGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SolarArrayGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
