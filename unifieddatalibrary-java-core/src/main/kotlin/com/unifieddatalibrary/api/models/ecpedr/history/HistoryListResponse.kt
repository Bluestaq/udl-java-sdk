...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            ecpedrMeasurements = historyListResponse.ecpedrMeasurements.map { it.toMutableList() }
            ...
            genSystem = historyListResponse.genSystem
            genTime = historyListResponse.genTime
            ...
            senPos = historyListResponse.senPos.map { it.toMutableList() }
