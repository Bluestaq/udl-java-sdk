...
class BeamContourQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamContourQueryHelpResponse: BeamContourQueryHelpResponse) = apply {
    ...
    fun validate(): BeamContourQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
