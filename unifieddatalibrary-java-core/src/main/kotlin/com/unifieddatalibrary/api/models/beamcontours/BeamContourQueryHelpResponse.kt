...
class BeamContourQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BeamContourQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [BeamContourQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamContourQueryHelpResponse: BeamContourQueryHelpResponse) =
            apply {
                aodrSupported = beamContourQueryHelpResponse.aodrSupported
                classificationMarking = beamContourQueryHelpResponse.classificationMarking
                description = beamContourQueryHelpResponse.description
                historySupported = beamContourQueryHelpResponse.historySupported
                name = beamContourQueryHelpResponse.name
                parameters = beamContourQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = beamContourQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = beamContourQueryHelpResponse.restSupported
                sortSupported = beamContourQueryHelpResponse.sortSupported
                typeName = beamContourQueryHelpResponse.typeName
                uri = beamContourQueryHelpResponse.uri
                additionalProperties = beamContourQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BeamContourQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BeamContourQueryHelpResponse =
    ...
    fun validate(): BeamContourQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BeamContourQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
