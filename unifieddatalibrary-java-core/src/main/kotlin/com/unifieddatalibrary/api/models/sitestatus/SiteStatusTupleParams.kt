...
class SiteStatusTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiteStatusTupleParams].
         *
    ...
    /** A builder for [SiteStatusTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusTupleParams: SiteStatusTupleParams) =
            apply {
                columns = siteStatusTupleParams.columns
                firstResult = siteStatusTupleParams.firstResult
                maxResults = siteStatusTupleParams.maxResults
                additionalHeaders = siteStatusTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = siteStatusTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SiteStatusTupleParams].
         *
         ...
         */
        fun build(): SiteStatusTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteStatusTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SiteStatusTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
