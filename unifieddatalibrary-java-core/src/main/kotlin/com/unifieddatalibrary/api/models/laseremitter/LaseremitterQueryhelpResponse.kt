...
class LaseremitterQueryhelpResponse
private constructor(
    ...
    /** A builder for [LaseremitterQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laseremitterQueryhelpResponse: LaseremitterQueryhelpResponse) = apply {
            aodrSupported = laseremitterQueryhelpResponse.aodrSupported
            classificationMarking = laseremitterQueryhelpResponse.classificationMarking
            description = laseremitterQueryhelpResponse.description
            historySupported = laseremitterQueryhelpResponse.historySupported
            name = laseremitterQueryhelpResponse.name
            parameters = laseremitterQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = laseremitterQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = laseremitterQueryhelpResponse.restSupported
            sortSupported = laseremitterQueryhelpResponse.sortSupported
            typeName = laseremitterQueryhelpResponse.typeName
            uri = laseremitterQueryhelpResponse.uri
            additionalProperties = laseremitterQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LaseremitterQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaseremitterQueryhelpResponse =
            LaseremitterQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): LaseremitterQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaseremitterQueryhelpResponse &&
