...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NotificationGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [NotificationGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NotificationGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(notificationGetParams: NotificationGetParams) = apply {
            id = notificationGetParams.id
            firstResult = notificationGetParams.firstResult
            maxResults = notificationGetParams.maxResults
            additionalHeaders = notificationGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = notificationGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NotificationGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NotificationGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NotificationGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "NotificationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
