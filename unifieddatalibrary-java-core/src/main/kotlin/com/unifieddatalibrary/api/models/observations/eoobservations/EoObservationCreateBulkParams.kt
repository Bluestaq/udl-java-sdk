    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * specified in spectralFilters that corresponds to the spectral filter given in the
                 * corresponding spectralFilterNames.
                 */
                ...
                /**
                 * This is the uncertainty in the extinction coefficient for the nth filter. Must be
                 * present for all values n=1 to numSpectralFilters, in incrementing order of n, and
                 * for no other values of n. -9999 for space-based sensors. Units = mag/airmass.
                 */
                 ...
                 * The phase angle bisector is the angle that is << of the value in #48. Then
                 * calculate the point on the RA/DEC (ECI J2000.0) sphere that a vector at this
                 ...
                 * with units DN/sec), not to be confused with the SNR of the signal in the peak
                 * pixel (i.e., DN/pixel/sec).
                 */
                ...
                /**
                 * Fraction of the sun that is illuminating the target object. This indicates if the
                 * target is in the Earth’s penumbra or umbra. (It is 0 when object is in umbra and
                 * 1 when object is fully illuminated.).
                 */
                 ...
                 * n=1 to numSpectralFilters, in incrementing order of n, and for no other values of
                 * n.
                 */
