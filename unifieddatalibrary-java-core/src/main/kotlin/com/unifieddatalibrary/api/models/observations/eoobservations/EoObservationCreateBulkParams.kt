...
/**
 * Service operation intended for initial integration only, to take a list of EO observations as a
 ...
 */
class EoObservationCreateBulkParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationCreateBulkParams: EoObservationCreateBulkParams) = apply {
        ...
        /** Flag to convert observation reference frame into J2000. */
        fun convertToJ2K(convertToJ2K: Boolean?) = apply { this.convertToJ2K = convertToJ2K }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * Line of sight range, in kilometers. Reported value should include all applicable
             * corrections as specified on the source provider data card. If uncertain, consumers
            ...
            /**
             * Cartesian X velocity of the observing mobile/onorbit sensor at obTime, in kilometers
            ...
            /**
             * Cartesian Y velocity of the observing mobile/onorbit sensor at obTime, in kilometers
             * per second, in the specified senReferenceFrame. If senReferenceFrame is null then J2K
             * should be assumed.
             */
            ...
            /**
             * Cartesian Z velocity of the observing mobile/onorbit sensor at obTime, in kilometers
             * per second, in the specified senReferenceFrame. If senReferenceFrame is null then J2K
             * should be assumed.
             */
            ...
            /**
             * Cartesian X position of the observing mobile/onorbit sensor at obTime, in kilometers,
            ...
            /**
             * Cartesian Y position of the observing mobile/onorbit sensor at obTime, in kilometers,
             * in the specified senReferenceFrame. If senReferenceFrame is null then J2K should be
             * assumed.
             */
            ...
            /**
             * Cartesian Z position of the observing mobile/onorbit sensor at obTime, in kilometers,
             * in the specified senReferenceFrame. If senReferenceFrame is null then J2K should be
             * assumed.
             */
        ...
        private constructor(
            ...
            private val imageBoreRaDec: JsonField<List<Double>>,
            private val imageBoreVector: JsonField<List<Double>>,
            private val imageCorners: JsonField<List<List<Double>>>,
            private val imageFovHeight: JsonField<Double>,
            private val imageFovWidth: JsonField<Double>,
            private val imageHorizVector: JsonField<List<Double>>,
            private val imageVertVector: JsonField<List<Double>>,
            ...
            private constructor(
                ...
                @ExcludeMissing
                ccdTemp: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("imageBoreRaDec")
                @ExcludeMissing
                imageBoreRaDec: JsonField<List<Double>> = JsonMissing.of(),
                @JsonProperty("imageBoreVector")
                @ExcludeMissing
                imageBoreVector: JsonField<List<Double>> = JsonMissing.of(),
                @JsonProperty("imageCorners")
                @ExcludeMissing
                imageCorners: JsonField<List<List<Double>>> = JsonMissing.of(),
                @JsonProperty("imageFOVHeight")
                @ExcludeMissing
                imageFovHeight: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("imageFOVWidth")
                @ExcludeMissing
                imageFovWidth: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("imageHorizVector")
                @ExcludeMissing
                imageHorizVector: JsonField<List<Double>> = JsonMissing.of(),
                @JsonProperty("imageVertVector")
                @ExcludeMissing
                imageVertVector: JsonField<List<Double>> = JsonMissing.of(),
                ...
                @ExcludeMissing
                pixelMax: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("pixelMin")
                @ExcludeMissing
                pixelMin: JsonField<Long> = JsonMissing.of(),
                ...
                @JsonProperty("snrEst")
                @ExcludeMissing
                snrEst: JsonField<Double> = JsonMissing.of(),
             ...
             * position. Specifically, this is the average background count level in digital number
             * per pixel divided by the exposure time in seconds of the background pixels used in
             * the photometric extraction. Units are digital number per pixel per second.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun backgroundSignal(): Optional<Double> =
                backgroundSignal.getOptional("backgroundSignal")

            /**
             * Estimated 1-sigma uncertainty in the background signal at or in the vicinity of the
             * radiometric source position. Units are digital number per pixel per second.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            ...
            /**
             * Operating temperature, in kelvin, of CCD recorded during exposure or measured during
             * calibrations.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             ...
             * in numSpectralFilters that corresponds to the spectral filter given in the
             * corresponding spectralFilters.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             * of n. Units = magnitudes per air mass.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            ...
            /**
             * The uncertainty in the extinction coefficient for the nth filter. Must be present for
             * all values n=1 to numSpectralFilters, in incrementing order of n, and for no other
             * values of n. -9999 for space-based sensors. Units = magnitudes per air mass.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             * in units of electrons per analog-to-digital unit. If no gain is used, the value = 1.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun imageBoreRaDec(): Optional<List<Double>> =
                imageBoreRaDec.getOptional("imageBoreRaDec")

            /**
             * The line of sight vector extending from the sensor toward the center of the image in
             * the specified referenceFrame. Typically aligned with the optical boresight. If
             * referenceFrame is null then J2K should be assumed.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun imageBoreVector(): Optional<List<Double>> =
                imageBoreVector.getOptional("imageBoreVector")

            /**
             * Array of four two-element arrays consisting of right ascension (RA) and declination
             * (DEC) values, in degrees, in the specified referenceFrame. If referenceFrame is null
             * then J2K should be assumed. These coordinate pairs indicate the four corners of the
             * image beginning with the Upper Left (UL) and moving clockwise to Upper Right (UR),
             * Lower Right (LR), and ending with the Lower Left (LL): [ [UL RA, UL DEC], [UR RA, UR
             * DEC], [LR RA, LR DEC], [LL RA, LL DEC] ].
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun imageCorners(): Optional<List<List<Double>>> =
                imageCorners.getOptional("imageCorners")
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun imageFovHeight(): Optional<Double> = imageFovHeight.getOptional("imageFOVHeight")
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun imageFovWidth(): Optional<Double> = imageFovWidth.getOptional("imageFOVWidth")
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun imageHorizVector(): Optional<List<Double>> =
                imageHorizVector.getOptional("imageHorizVector")
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun imageVertVector(): Optional<List<Double>> =
                imageVertVector.getOptional("imageVertVector")
            ...
            fun neutralDensityFilterTransmissionsUnc(): Optional<List<Double>> =
                neutralDensityFilterTransmissionsUnc.getOptional(
                    "neutralDensityFilterTransmissionsUnc"
                )
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun numDetectedStars(): Optional<Long> =
             ...
             * phase angle bisector is the angle that is half of the value of the Solar Phase Angle.
             * Then calculate the point on the RA/DEC (ECI J2000.0) sphere that a vector at this
             * angle would intersect.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun pixelArrayHeight(): Optional<Long> =
                pixelArrayHeight.getOptional("pixelArrayHeight")
             ...
             * = 65536. This can represent the saturation value of the detector, but some sensors
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun predictedAzimuth(): Optional<Double> =
                predictedAzimuth.getOptional("predictedAzimuth")

            /**
             * Predicted Declination of the Target object from the frame of reference of the sensor
             * (J2000, geocentric velocity aberration), in degrees. SGP4 and VCMs produce geocentric
             ...
             * sensor (J2000, geocentric velocity aberration), in degrees. SGP4 and VCMs produce
             * geocentric origin and velocity aberration and subtracting the sensor geocentric
             * position of the sensor places in its reference frame.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun raDeclinationCov(): Optional<Double> =
                raDeclinationCov.getOptional("raDeclinationCov")
             ...
             * digital number per second), not to be confused with the SNR of the signal in the peak
             * pixel (i.e., digital number per pixel per second).
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
            ...
            /**
             * The in-band average irradiance of a 0th mag source. Must be present for all values
             * n=1 to numSpectralFilters, in incrementing order of n, and for no other values of n.
             * Units = watts per meters squared per nanometer.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun surfBrightness(): Optional<List<Double>> =
                surfBrightness.getOptional("surfBrightness")
            ...
            /**
             * The value for the zero-point calculated for each filter denoted in spectralFilters.
             * It is the difference between the catalog mag and instrumental mag for a set of
             * standard stars. For use with All Sky photometry. Must be present for all values n=1
            ...
            /**
             * The uncertainty in the zero point for the filter denoted in spectralFilters. For use
             * with All Sky photometry. Must be present for all values n=1 to numSpectralFilters, in
             ...
             *
             * Unlike [acalCrPixX], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("acalCrPixX")
            @ExcludeMissing
             ...
             *
             * Unlike [acalCrPixY], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("acalCrPixY")
            @ExcludeMissing
             ...
             *
             * Unlike [acalCrValX], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("acalCrValX")
            @ExcludeMissing
             ...
             *
             * Unlike [acalCrValY], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("acalCrValY")
            @ExcludeMissing
             ...
             *
             * Unlike [backgroundSignal], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("backgroundSignal")
            @ExcludeMissing
             ...
             *
             * Unlike [binningVert], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("binningVert")
            @ExcludeMissing
             ...
             *
             * Unlike [ccdObjPosX], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("ccdObjPosX")
            @ExcludeMissing
             ...
             *
             * Unlike [ccdObjPosY], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("ccdObjPosY")
            @ExcludeMissing
             ...
             *
             * Unlike [ccdObjWidth], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("ccdObjWidth")
            @ExcludeMissing
             ...
             *
             * Unlike [centroidColumn], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("centroidColumn")
            @ExcludeMissing
             ...
             *
             * Unlike [centroidRow], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("centroidRow")
            @ExcludeMissing
             ...
             *
             * Unlike [colorCoeffs], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("colorCoeffs")
            @ExcludeMissing
             ...
             *
             * Unlike [columnVariance], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("columnVariance")
            @ExcludeMissing
             ...
             *
             * Unlike [currentNeutralDensityFilterNum], this method doesn't throw if the JSON field
             ...
             *
             * Unlike [declinationCov], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("declinationCov")
            @ExcludeMissing
             ...
             *
             * Unlike [idEoObservation], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("idEOObservation")
            @ExcludeMissing
            ...
            /**
             * Returns the raw JSON value of [imageBoreRaDec].
             *
             * Unlike [imageBoreRaDec], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("imageBoreRaDec")
            @ExcludeMissing
            fun _imageBoreRaDec(): JsonField<List<Double>> = imageBoreRaDec

            /**
             * Returns the raw JSON value of [imageBoreVector].
             *
             * Unlike [imageBoreVector], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("imageBoreVector")
            @ExcludeMissing
            fun _imageBoreVector(): JsonField<List<Double>> = imageBoreVector

            /**
             * Returns the raw JSON value of [imageCorners].
             *
             * Unlike [imageCorners], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("imageCorners")
            @ExcludeMissing
            fun _imageCorners(): JsonField<List<List<Double>>> = imageCorners

            /**
             * Returns the raw JSON value of [imageFovHeight].
             *
             * Unlike [imageFovHeight], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("imageFOVHeight")
            @ExcludeMissing
            fun _imageFovHeight(): JsonField<Double> = imageFovHeight

            /**
             * Returns the raw JSON value of [imageFovWidth].
             *
             * Unlike [imageFovWidth], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("imageFOVWidth")
            @ExcludeMissing
            fun _imageFovWidth(): JsonField<Double> = imageFovWidth

            /**
             * Returns the raw JSON value of [imageHorizVector].
             *
             * Unlike [imageHorizVector], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("imageHorizVector")
            @ExcludeMissing
            fun _imageHorizVector(): JsonField<List<Double>> = imageHorizVector

            /**
             * Returns the raw JSON value of [imageVertVector].
             *
             * Unlike [imageVertVector], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("imageVertVector")
            @ExcludeMissing
            fun _imageVertVector(): JsonField<List<Double>> = imageVertVector

            /**
             * Returns the raw JSON value of [magInstrumental].
             *
             * Unlike [magInstrumental], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("magInstrumental")
            @ExcludeMissing
             ...
             *
             * Unlike [neutralDensityFilterNames], this method doesn't throw if the JSON field has
             * an unexpected type.
             */
            @JsonProperty("neutralDensityFilterNames")
            @ExcludeMissing
             ...
             *
             * Unlike [neutralDensityFilterTransmissions], this method doesn't throw if the JSON
             ...
             *
             * Unlike [numCatalogStars], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("numCatalogStars")
            @ExcludeMissing
             ...
             *
             * Unlike [objSunRange], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("objSunRange")
            @ExcludeMissing
             ...
             *
             * Unlike [peakApertureCount], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("peakApertureCount")
            @ExcludeMissing
             ...
             *
             * Unlike [phaseAngBisect], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("phaseAngBisect")
            @ExcludeMissing
             ...
             *
             * Unlike [pixelArrayHeight], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("pixelArrayHeight")
            @ExcludeMissing
             ...
             *
             * Unlike [pixelArrayWidth], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("pixelArrayWidth")
            @ExcludeMissing
             ...
             *
             * Unlike [pixelMax], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [pixelMin], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [predictedAzimuth], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("predictedAzimuth")
            @ExcludeMissing
             ...
             *
             * Unlike [predictedRa], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("predictedRa")
            @ExcludeMissing
             ...
             *
             * Unlike [predictedRaUnc], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("predictedRaUnc")
            @ExcludeMissing
             ...
             *
             * Unlike [raDeclinationCov], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("raDeclinationCov")
            @ExcludeMissing
             ...
             *
             * Unlike [rowColCov], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("rowColCov")
            @ExcludeMissing
             ...
             *
             * Unlike [rowVariance], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("rowVariance")
            @ExcludeMissing
             ...
             *
             * Unlike [spectralFilters], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("spectralFilters")
            @ExcludeMissing
             ...
             *
             * Unlike [sunAzimuth], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("sunAzimuth")
            @ExcludeMissing
             ...
             *
             * Unlike [surfBrightness], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("surfBrightness")
            @ExcludeMissing
             ...
             *
             * Unlike [surfBrightnessUnc], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("surfBrightnessUnc")
            @ExcludeMissing
             ...
             *
             * Unlike [timesUnc], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            ...
            class Builder internal constructor() {
                ...
                private var imageBoreRaDec: JsonField<MutableList<Double>>? = null
                private var imageBoreVector: JsonField<MutableList<Double>>? = null
                private var imageCorners: JsonField<MutableList<List<Double>>>? = null
                private var imageFovHeight: JsonField<Double> = JsonMissing.of()
                private var imageFovWidth: JsonField<Double> = JsonMissing.of()
                private var imageHorizVector: JsonField<MutableList<Double>>? = null
                private var imageVertVector: JsonField<MutableList<Double>>? = null
                ...
                private var neutralDensityFilterTransmissions: JsonField<MutableList<Double>>? =
                    null
                private var neutralDensityFilterTransmissionsUnc: JsonField<MutableList<Double>>? =
                    null
                ...
                internal fun from(eoobservationDetails: EoobservationDetails) = apply {
                    ...
                    currentNeutralDensityFilterNum =
                        eoobservationDetails.currentNeutralDensityFilterNum
                    ...
                    extinctionCoeffs =
                        eoobservationDetails.extinctionCoeffs.map { it.toMutableList() }
                    extinctionCoeffsUnc =
                    ...
                    imageBoreRaDec = eoobservationDetails.imageBoreRaDec.map { it.toMutableList() }
                    imageBoreVector =
                        eoobservationDetails.imageBoreVector.map { it.toMutableList() }
                    imageCorners = eoobservationDetails.imageCorners.map { it.toMutableList() }
                    imageFovHeight = eoobservationDetails.imageFovHeight
                    imageFovWidth = eoobservationDetails.imageFovWidth
                    imageHorizVector =
                        eoobservationDetails.imageHorizVector.map { it.toMutableList() }
                    imageVertVector =
                        eoobservationDetails.imageVertVector.map { it.toMutableList() }
                    ...
                    spectralFilters =
                        eoobservationDetails.spectralFilters.map { it.toMutableList() }
                    spectralFilterSolarMag =
                 ...
                 * yet supported value.
                 */
                fun acalCrPixX(acalCrPixX: JsonField<Double>) = apply {
                 ...
                 * yet supported value.
                 */
                fun acalCrPixY(acalCrPixY: JsonField<Double>) = apply {
                 ...
                 * yet supported value.
                 */
                fun acalCrValX(acalCrValX: JsonField<Double>) = apply {
                 ...
                 * yet supported value.
                 */
                fun acalCrValY(acalCrValY: JsonField<Double>) = apply {
                 ...
                 * number per pixel divided by the exposure time in seconds of the background pixels
                 * used in the photometric extraction. Units are digital number per pixel per
                 * second.
                 */
                 ...
                 *
                 * You should usually call [Builder.backgroundSignal] with a well-typed [Double]
                 ...
                 *
                 * You should usually call [Builder.binningVert] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun binningVert(binningVert: JsonField<Long>) = apply {
                 ...
                 * yet supported value.
                 */
                fun ccdObjPosX(ccdObjPosX: JsonField<Double>) = apply {
                 ...
                 * yet supported value.
                 */
                fun ccdObjPosY(ccdObjPosY: JsonField<Double>) = apply {
                    this.ccdObjPosY = ccdObjPosY
                }

                /**
                 * This is the pixel width of the target. This is either a frame-by-frame
                 * measurement or a constant point spread function or synthetic aperture used in the
                 * extraction.
                 */
                 ...
                 *
                 * You should usually call [Builder.ccdTemp] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                ...
                /**
                 * Observed centroid column number on the focal plane in pixels (0 is left edge, 0.5
                 * is center of pixels along left of image).
                 */
                ...
                /**
                 * Classification marking of the data in IC/CAPCO Portion-marked format, will be set
                 * to EOObservation classificationMarking if blank.
                 */
                fun classificationMarking(classificationMarking: String) =
                    classificationMarking(JsonField.of(classificationMarking))
                 ...
                 * atmospheric extinction. Must be present for all values n=1 to numSpectralFilters,
                 * in incrementing order of n, and for no other values of n.
                 */
                 ...
                 *
                 * You should usually call [Builder.colorCoeffs] with a well-typed `List<Double>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.currentNeutralDensityFilterNum] with a
                 * well-typed [Long] value instead. This method is primarily for setting the field
                 * to an undocumented or not yet supported value.
                 */
                fun currentNeutralDensityFilterNum(
                    currentNeutralDensityFilterNum: JsonField<Long>
                ) = apply { this.currentNeutralDensityFilterNum = currentNeutralDensityFilterNum }
                 ...
                 *
                 * You should usually call [Builder.does] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                ...
                /**
                 * The uncertainty in the extinction coefficient for the nth filter. Must be present
                 * for all values n=1 to numSpectralFilters, in incrementing order of n, and for no
                 * other values of n. -9999 for space-based sensors. Units = magnitudes per air
                 * mass.
                 */
                 ...
                 * observation in units of electrons per analog-to-digital unit. If no gain is used,
                 * the value = 1.
                 */
                 ...
                 *
                 * You should usually call [Builder.gain] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.idEoObservation] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.ifov] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 * should be assumed.
                 */
                fun imageBoreRaDec(imageBoreRaDec: List<Double>) =
                    imageBoreRaDec(JsonField.of(imageBoreRaDec))

                /**
                 * Sets [Builder.imageBoreRaDec] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.imageBoreRaDec] with a well-typed `List<Double>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun imageBoreRaDec(imageBoreRaDec: JsonField<List<Double>>) = apply {
                    this.imageBoreRaDec = imageBoreRaDec.map { it.toMutableList() }
                }

                /**
                 * Adds a single [Double] to [Builder.imageBoreRaDec].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addImageBoreRaDec(imageBoreRaDec: Double) = apply {
                    this.imageBoreRaDec =
                        (this.imageBoreRaDec ?: JsonField.of(mutableListOf())).also {
                            checkKnown("imageBoreRaDec", it).add(imageBoreRaDec)
                        }
                }

                /**
                 * The line of sight vector extending from the sensor toward the center of the image
                 * in the specified referenceFrame. Typically aligned with the optical boresight. If
                 * referenceFrame is null then J2K should be assumed.
                 */
                fun imageBoreVector(imageBoreVector: List<Double>) =
                    imageBoreVector(JsonField.of(imageBoreVector))

                /**
                 * Sets [Builder.imageBoreVector] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.imageBoreVector] with a well-typed
                 * `List<Double>` value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                fun imageBoreVector(imageBoreVector: JsonField<List<Double>>) = apply {
                    this.imageBoreVector = imageBoreVector.map { it.toMutableList() }
                }

                /**
                 * Adds a single [Double] to [Builder.imageBoreVector].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addImageBoreVector(imageBoreVector: Double) = apply {
                    this.imageBoreVector =
                        (this.imageBoreVector ?: JsonField.of(mutableListOf())).also {
                            checkKnown("imageBoreVector", it).add(imageBoreVector)
                        }
                }
                 ...
                 * moving clockwise to Upper Right (UR), Lower Right (LR), and ending with the Lower
                 * Left (LL): [ [UL RA, UL DEC], [UR RA, UR DEC], [LR RA, LR DEC], [LL RA, LL DEC]
                 * ].
                 */
                fun imageCorners(imageCorners: List<List<Double>>) =
                    imageCorners(JsonField.of(imageCorners))

                /**
                 * Sets [Builder.imageCorners] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.imageCorners] with a well-typed
                 * `List<List<Double>>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                fun imageCorners(imageCorners: JsonField<List<List<Double>>>) = apply {
                    this.imageCorners = imageCorners.map { it.toMutableList() }
                }

                /**
                 * Adds a single [List<Double>] to [imageCorners].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addImageCorner(imageCorner: List<Double>) = apply {
                    imageCorners =
                        (imageCorners ?: JsonField.of(mutableListOf())).also {
                            checkKnown("imageCorners", it).add(imageCorner)
                        }
                }

                /** Height of the image field of view, in degrees. */
                fun imageFovHeight(imageFovHeight: Double) =
                    imageFovHeight(JsonField.of(imageFovHeight))

                /**
                 * Sets [Builder.imageFovHeight] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.imageFovHeight] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun imageFovHeight(imageFovHeight: JsonField<Double>) = apply {
                    this.imageFovHeight = imageFovHeight
                }

                /** Width of the image field of view, in degrees. */
                fun imageFovWidth(imageFovWidth: Double) =
                    imageFovWidth(JsonField.of(imageFovWidth))

                /**
                 * Sets [Builder.imageFovWidth] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.imageFovWidth] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun imageFovWidth(imageFovWidth: JsonField<Double>) = apply {
                    this.imageFovWidth = imageFovWidth
                }
                 ...
                 * referenceFrame. If referenceFrame is null then J2K should be assumed.
                 */
                fun imageHorizVector(imageHorizVector: List<Double>) =
                    imageHorizVector(JsonField.of(imageHorizVector))

                /**
                 * Sets [Builder.imageHorizVector] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.imageHorizVector] with a well-typed
                 * `List<Double>` value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                fun imageHorizVector(imageHorizVector: JsonField<List<Double>>) = apply {
                    this.imageHorizVector = imageHorizVector.map { it.toMutableList() }
                }

                /**
                 * Adds a single [Double] to [Builder.imageHorizVector].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addImageHorizVector(imageHorizVector: Double) = apply {
                    this.imageHorizVector =
                        (this.imageHorizVector ?: JsonField.of(mutableListOf())).also {
                            checkKnown("imageHorizVector", it).add(imageHorizVector)
                        }
                }
                 ...
                 * referenceFrame. If referenceFrame is null then J2K should be assumed.
                 */
                fun imageVertVector(imageVertVector: List<Double>) =
                    imageVertVector(JsonField.of(imageVertVector))

                /**
                 * Sets [Builder.imageVertVector] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.imageVertVector] with a well-typed
                 * `List<Double>` value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                fun imageVertVector(imageVertVector: JsonField<List<Double>>) = apply {
                    this.imageVertVector = imageVertVector.map { it.toMutableList() }
                }

                /**
                 * Adds a single [Double] to [Builder.imageVertVector].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addImageVertVector(imageVertVector: Double) = apply {
                    this.imageVertVector =
                        (this.imageVertVector ?: JsonField.of(mutableListOf())).also {
                            checkKnown("imageVertVector", it).add(imageVertVector)
                        }
                }
                 ...
                 *
                 * You should usually call [Builder.magInstrumental] with a well-typed [Double]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.magInstrumentalUnc] with a well-typed [Double]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                ...
                fun addNeutralDensityFilterName(neutralDensityFilterName: String) = apply {
                    neutralDensityFilterNames =
                        (neutralDensityFilterNames ?: JsonField.of(mutableListOf())).also {
                            checkKnown("neutralDensityFilterNames", it)
                                .add(neutralDensityFilterName)
                        }
                }
                ...
                fun neutralDensityFilterTransmissions(
                    neutralDensityFilterTransmissions: List<Double>
                ) =
                    neutralDensityFilterTransmissions(
                        JsonField.of(neutralDensityFilterTransmissions)
                    )

                /**
                 * Sets [Builder.neutralDensityFilterTransmissions] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.neutralDensityFilterTransmissions] with a
                ...
                fun addNeutralDensityFilterTransmission(neutralDensityFilterTransmission: Double) =
                    apply {
                        neutralDensityFilterTransmissions =
                            (neutralDensityFilterTransmissions ?: JsonField.of(mutableListOf()))
                                .also {
                ...
                /**
                 * Number of correlated stars in the FOV with the target object. Can be 0 for narrow
                 * FOV sensors.
                 */
                 ...
                 *
                 * You should usually call [Builder.numCorrelatedStars] with a well-typed [Long]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.numNeutralDensityFilters] with a well-typed
                 * [Long] value instead. This method is primarily for setting the field to an
                 * undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.numSpectralFilters] with a well-typed [Long]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.opticalCrossSectionUnc] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.pcalNumStars] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.peakApertureCount] with a well-typed [Double]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.peakBackgroundCount] with a well-typed [Int]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                ...
                /**
                 * Solar phase angle bisector vector. The vector that bisects the solar phase angle.
                 * The phase angle bisector is the angle that is half of the value of the Solar
                 * Phase Angle. Then calculate the point on the RA/DEC (ECI J2000.0) sphere that a
                 * vector at this angle would intersect.
                 */
                 ...
                 *
                 * You should usually call [Builder.pixelMin] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.predictedAzimuth] with a well-typed [Double]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.predictedDeclinationUnc] with a well-typed
                 * [Double] value instead. This method is primarily for setting the field to an
                 * undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.predictedElevation] with a well-typed [Double]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.raDeclinationCov] with a well-typed [Double]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.rowColCov] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * this SNR applies to the total signal of the radiometric source (i.e., Net_Obj_Sig
                 * with units digital number per second), not to be confused with the SNR of the
                 * signal in the peak pixel (i.e., digital number per pixel per second).
                 */
                 ...
                 *
                 * You should usually call [Builder.snrEst] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * when object is fully illuminated.
                 */
                fun solarDiskFrac(solarDiskFrac: Double) =
                    solarDiskFrac(JsonField.of(solarDiskFrac))
                 ...
                 *
                 * You should usually call [Builder.spectralFilters] with a well-typed
                 * `List<String>` value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                ...
                fun spectralFilterSolarMag(spectralFilterSolarMag: JsonField<List<Double>>) =
                    apply {
                        this.spectralFilterSolarMag =
                            spectralFilterSolarMag.map { it.toMutableList() }
                    }
                 ...
                 */
                fun spectralZmfl(spectralZmfl: List<Double>) =
                    spectralZmfl(JsonField.of(spectralZmfl))

                /**
                 * Sets [Builder.spectralZmfl] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.spectralZmfl] with a well-typed `List<Double>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                ...
                /**
                 * Azimuth angle of the sun from a ground-based telescope (no atmospheric refraction
                 * correction required) the observer with aberration due to the observer velocity
                 * and light travel time applied in degrees.
                 */
                 ...
                 * yet supported value.
                 */
                fun sunAzimuth(sunAzimuth: JsonField<Double>) = apply {
                 ...
                 *
                 * You should usually call [Builder.surfBrightnessUnc] with a well-typed
                 * `List<Double>` value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.timesUnc] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.toes] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 * mag for a set of standard stars. For use with All Sky photometry. Must be present
                 * for all values n=1 to numSpectralFilters, in incrementing order of n, and for no
                 * other values of n.
                 */
                ...
                fun build(): EoobservationDetails =
                    EoobservationDetails(
                        ...
                        idEoObservation,
                        ifov,
                        (imageBoreRaDec ?: JsonMissing.of()).map { it.toImmutable() },
                        (imageBoreVector ?: JsonMissing.of()).map { it.toImmutable() },
                        (imageCorners ?: JsonMissing.of()).map { it.toImmutable() },
                        imageFovHeight,
                        imageFovWidth,
                        (imageHorizVector ?: JsonMissing.of()).map { it.toImmutable() },
                        (imageVertVector ?: JsonMissing.of()).map { it.toImmutable() },
                        magInstrumental,
                        magInstrumentalUnc,
            ...
            internal fun validity(): Int =
                (if (acalCrPixX.asKnown().isPresent) 1 else 0) +
                    ...
                    (imageBoreRaDec.asKnown().getOrNull()?.size ?: 0) +
                    (imageBoreVector.asKnown().getOrNull()?.size ?: 0) +
                    (imageCorners.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) +
                    (if (imageFovHeight.asKnown().isPresent) 1 else 0) +
                    (if (imageFovWidth.asKnown().isPresent) 1 else 0) +
                    (imageHorizVector.asKnown().getOrNull()?.size ?: 0) +
                    (imageVertVector.asKnown().getOrNull()?.size ?: 0) +
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is EoobservationDetails &&
                    ...
                    ifov == other.ifov &&
                    imageBoreRaDec == other.imageBoreRaDec &&
                    imageBoreVector == other.imageBoreVector &&
                    imageCorners == other.imageCorners &&
                    imageFovHeight == other.imageFovHeight &&
                    imageFovWidth == other.imageFovWidth &&
                    imageHorizVector == other.imageHorizVector &&
                    imageVertVector == other.imageVertVector &&
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EoObservationCreateBulkParams &&
            convertToJ2K == other.convertToJ2K &&
            body == other.body &&
    ...
    override fun hashCode(): Int =
        Objects.hash(convertToJ2K, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "EoObservationCreateBulkParams{convertToJ2K=$convertToJ2K, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
