 ...
 * parameter.
 */
class SeradataSpacecraftDetailGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataSpacecraftDetailGetParams = builder().build()
    ...
    /** A builder for [SeradataSpacecraftDetailGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataSpacecraftDetailGetParams: SeradataSpacecraftDetailGetParams) =
            apply {
                id = seradataSpacecraftDetailGetParams.id
                firstResult = seradataSpacecraftDetailGetParams.firstResult
                maxResults = seradataSpacecraftDetailGetParams.maxResults
                additionalHeaders = seradataSpacecraftDetailGetParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    seradataSpacecraftDetailGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataSpacecraftDetailGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataSpacecraftDetailGetParams =
            SeradataSpacecraftDetailGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeradataSpacecraftDetailGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeradataSpacecraftDetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
