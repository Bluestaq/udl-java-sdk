 ...
 */
class AirspaceControlOrderCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirspaceControlOrderCountParams = builder().build()
    ...
    /** A builder for [AirspaceControlOrderCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airspaceControlOrderCountParams: AirspaceControlOrderCountParams) =
            apply {
                firstResult = airspaceControlOrderCountParams.firstResult
                maxResults = airspaceControlOrderCountParams.maxResults
                additionalHeaders = airspaceControlOrderCountParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    airspaceControlOrderCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirspaceControlOrderCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirspaceControlOrderCountParams =
            AirspaceControlOrderCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirspaceControlOrderCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirspaceControlOrderCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
