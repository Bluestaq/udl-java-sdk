...
class GeoStatusListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusListResponse: GeoStatusListResponse) =
            apply {
    ...
    fun validate(): GeoStatusListResponse =
        apply {
            if (validated) {
              return@apply
            }
