...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sensorMaintenanceTupleResponse: SensorMaintenanceTupleResponse) = apply {
            ...
            externalId = sensorMaintenanceTupleResponse.externalId
    ...
    override fun toString() =
        "SensorMaintenanceTupleResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, endTime=$endTime, siteCode=$siteCode, source=$source, startTime=$startTime, id=$id, activity=$activity, approver=$approver, changer=$changer, createdAt=$createdAt, createdBy=$createdBy, duration=$duration, eowId=$eowId, equipStatus=$equipStatus, externalId=$externalId, idSensor=$idSensor, impactedFaces=$impactedFaces, inactiveDate=$inactiveDate, lineNumber=$lineNumber, mdOpsCap=$mdOpsCap, mwOpsCap=$mwOpsCap, origin=$origin, origNetwork=$origNetwork, priority=$priority, recall=$recall, rel=$rel, remark=$remark, requestor=$requestor, resource=$resource, rev=$rev, ssOpsCap=$ssOpsCap, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
