...
class SensorMaintenanceTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorMaintenanceTupleResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceTupleResponse: SensorMaintenanceTupleResponse) =
            apply {
                ...
                additionalProperties = sensorMaintenanceTupleResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SensorMaintenanceTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
