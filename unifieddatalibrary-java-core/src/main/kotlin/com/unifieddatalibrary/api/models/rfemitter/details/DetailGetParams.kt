...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DetailGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DetailGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DetailGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailGetParams: DetailGetParams) = apply {
            id = detailGetParams.id
            firstResult = detailGetParams.firstResult
            maxResults = detailGetParams.maxResults
            additionalHeaders = detailGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = detailGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DetailGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DetailGetParams =
            DetailGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailGetParams &&
            id == other.id &&
    ...
    override fun toString() =
        "DetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
