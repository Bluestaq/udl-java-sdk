...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirTransportMissionAbridged].
         *
    ...
    /** A builder for [AirTransportMissionAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTransportMissionAbridged: AirTransportMissionAbridged) = apply {
            classificationMarking = airTransportMissionAbridged.classificationMarking
            dataMode = airTransportMissionAbridged.dataMode
            source = airTransportMissionAbridged.source
            id = airTransportMissionAbridged.id
            abp = airTransportMissionAbridged.abp
            alias = airTransportMissionAbridged.alias
            allocatedUnit = airTransportMissionAbridged.allocatedUnit
            amcMissionId = airTransportMissionAbridged.amcMissionId
            apacsId = airTransportMissionAbridged.apacsId
            atoCallSign = airTransportMissionAbridged.atoCallSign
            atoMissionId = airTransportMissionAbridged.atoMissionId
            callSign = airTransportMissionAbridged.callSign
            createdAt = airTransportMissionAbridged.createdAt
            createdBy = airTransportMissionAbridged.createdBy
            cw = airTransportMissionAbridged.cw
            dipWorksheetName = airTransportMissionAbridged.dipWorksheetName
            firstPickUp = airTransportMissionAbridged.firstPickUp
            gdssMissionId = airTransportMissionAbridged.gdssMissionId
            hazMat = airTransportMissionAbridged.hazMat.map { it.toMutableList() }
            jcsPriority = airTransportMissionAbridged.jcsPriority
            lastDropOff = airTransportMissionAbridged.lastDropOff
            loadCategoryType = airTransportMissionAbridged.loadCategoryType
            m1 = airTransportMissionAbridged.m1
            m2 = airTransportMissionAbridged.m2
            m3a = airTransportMissionAbridged.m3a
            naf = airTransportMissionAbridged.naf
            nextAmcMissionId = airTransportMissionAbridged.nextAmcMissionId
            nextMissionId = airTransportMissionAbridged.nextMissionId
            node = airTransportMissionAbridged.node
            objective = airTransportMissionAbridged.objective
            operation = airTransportMissionAbridged.operation
            origin = airTransportMissionAbridged.origin
            origMissionId = airTransportMissionAbridged.origMissionId
            origNetwork = airTransportMissionAbridged.origNetwork
            prevAmcMissionId = airTransportMissionAbridged.prevAmcMissionId
            prevMissionId = airTransportMissionAbridged.prevMissionId
            purpose = airTransportMissionAbridged.purpose
            remarks = airTransportMissionAbridged.remarks.map { it.toMutableList() }
            requirements = airTransportMissionAbridged.requirements.map { it.toMutableList() }
            sourceDl = airTransportMissionAbridged.sourceDl
            sourceSysDeviation = airTransportMissionAbridged.sourceSysDeviation
            state = airTransportMissionAbridged.state
            type = airTransportMissionAbridged.type
            updatedAt = airTransportMissionAbridged.updatedAt
            updatedBy = airTransportMissionAbridged.updatedBy
            additionalProperties = airTransportMissionAbridged.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AirTransportMissionAbridged].
         *
         ...
         */
        fun build(): AirTransportMissionAbridged =
    ...
    fun validate(): AirTransportMissionAbridged = apply {
        if (validated) {
            return@apply
        }
