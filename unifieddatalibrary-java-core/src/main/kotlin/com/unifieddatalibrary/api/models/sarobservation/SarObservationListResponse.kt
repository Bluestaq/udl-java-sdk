...
class SarObservationListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SarObservationListResponse].
         *
    ...
    /** A builder for [SarObservationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationListResponse: SarObservationListResponse) =
            apply {
                classificationMarking = sarObservationListResponse.classificationMarking
                collectionEnd = sarObservationListResponse.collectionEnd
                collectionStart = sarObservationListResponse.collectionStart
                dataMode = sarObservationListResponse.dataMode
                sarMode = sarObservationListResponse.sarMode
                source = sarObservationListResponse.source
                id = sarObservationListResponse.id
                agjson = sarObservationListResponse.agjson
                andims = sarObservationListResponse.andims
                asrid = sarObservationListResponse.asrid
                atext = sarObservationListResponse.atext
                atype = sarObservationListResponse.atype
                azimuthAngle = sarObservationListResponse.azimuthAngle
                centerTime = sarObservationListResponse.centerTime
                collectionId = sarObservationListResponse.collectionId
                continuousSpotAngle = sarObservationListResponse.continuousSpotAngle
                coordSys = sarObservationListResponse.coordSys
                createdAt = sarObservationListResponse.createdAt
                createdBy = sarObservationListResponse.createdBy
                detectionEnd = sarObservationListResponse.detectionEnd
                detectionId = sarObservationListResponse.detectionId
                detectionStart = sarObservationListResponse.detectionStart
                dwellTime = sarObservationListResponse.dwellTime
                externalId = sarObservationListResponse.externalId
                farRange = sarObservationListResponse.farRange
                grazeAngle = sarObservationListResponse.grazeAngle
                groundResolutionProjection = sarObservationListResponse.groundResolutionProjection
                idOnOrbit = sarObservationListResponse.idOnOrbit
                idSensor = sarObservationListResponse.idSensor
                incidenceAngle = sarObservationListResponse.incidenceAngle
                looksAzimuth = sarObservationListResponse.looksAzimuth
                looksRange = sarObservationListResponse.looksRange
                multilookNumber = sarObservationListResponse.multilookNumber
                nearRange = sarObservationListResponse.nearRange
                obDirection = sarObservationListResponse.obDirection
                operatingBand = sarObservationListResponse.operatingBand
                operatingFreq = sarObservationListResponse.operatingFreq
                orbitState = sarObservationListResponse.orbitState
                origin = sarObservationListResponse.origin
                origNetwork = sarObservationListResponse.origNetwork
                origObjectId = sarObservationListResponse.origObjectId
                origSensorId = sarObservationListResponse.origSensorId
                pulseBandwidth = sarObservationListResponse.pulseBandwidth
                pulseDuration = sarObservationListResponse.pulseDuration
                resolutionAzimuth = sarObservationListResponse.resolutionAzimuth
                resolutionRange = sarObservationListResponse.resolutionRange
                rxPolarization = sarObservationListResponse.rxPolarization
                satNo = sarObservationListResponse.satNo
                senalt = sarObservationListResponse.senalt
                senlatEnd = sarObservationListResponse.senlatEnd
                senlatStart = sarObservationListResponse.senlatStart
                senlonEnd = sarObservationListResponse.senlonEnd
                senlonStart = sarObservationListResponse.senlonStart
                senvelx = sarObservationListResponse.senvelx
                senvely = sarObservationListResponse.senvely
                senvelz = sarObservationListResponse.senvelz
                slantRange = sarObservationListResponse.slantRange
                snr = sarObservationListResponse.snr
                sourceDl = sarObservationListResponse.sourceDl
                spacingAzimuth = sarObservationListResponse.spacingAzimuth
                spacingRange = sarObservationListResponse.spacingRange
                squintAngle = sarObservationListResponse.squintAngle
                srcIds = sarObservationListResponse.srcIds.map { it.toMutableList() }
                srcTyps = sarObservationListResponse.srcTyps.map { it.toMutableList() }
                swathLength = sarObservationListResponse.swathLength
                targetposx = sarObservationListResponse.targetposx
                targetposy = sarObservationListResponse.targetposy
                targetposz = sarObservationListResponse.targetposz
                transactionId = sarObservationListResponse.transactionId
                txPolarization = sarObservationListResponse.txPolarization
                additionalProperties = sarObservationListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SarObservationListResponse].
         *
         ...
         */
        fun build(): SarObservationListResponse =
    ...
    fun validate(): SarObservationListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (if (collectionEnd.asKnown().isPresent) 1 else 0) + (if (collectionStart.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (sarMode.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (agjson.asKnown().isPresent) 1 else 0) + (if (andims.asKnown().isPresent) 1 else 0) + (if (asrid.asKnown().isPresent) 1 else 0) + (if (atext.asKnown().isPresent) 1 else 0) + (if (atype.asKnown().isPresent) 1 else 0) + (if (azimuthAngle.asKnown().isPresent) 1 else 0) + (if (centerTime.asKnown().isPresent) 1 else 0) + (if (collectionId.asKnown().isPresent) 1 else 0) + (if (continuousSpotAngle.asKnown().isPresent) 1 else 0) + (if (coordSys.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (detectionEnd.asKnown().isPresent) 1 else 0) + (if (detectionId.asKnown().isPresent) 1 else 0) + (if (detectionStart.asKnown().isPresent) 1 else 0) + (if (dwellTime.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (if (farRange.asKnown().isPresent) 1 else 0) + (if (grazeAngle.asKnown().isPresent) 1 else 0) + (if (groundResolutionProjection.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (incidenceAngle.asKnown().isPresent) 1 else 0) + (if (looksAzimuth.asKnown().isPresent) 1 else 0) + (if (looksRange.asKnown().isPresent) 1 else 0) + (if (multilookNumber.asKnown().isPresent) 1 else 0) + (if (nearRange.asKnown().isPresent) 1 else 0) + (if (obDirection.asKnown().isPresent) 1 else 0) + (if (operatingBand.asKnown().isPresent) 1 else 0) + (if (operatingFreq.asKnown().isPresent) 1 else 0) + (if (orbitState.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (pulseBandwidth.asKnown().isPresent) 1 else 0) + (if (pulseDuration.asKnown().isPresent) 1 else 0) + (if (resolutionAzimuth.asKnown().isPresent) 1 else 0) + (if (resolutionRange.asKnown().isPresent) 1 else 0) + (if (rxPolarization.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlatEnd.asKnown().isPresent) 1 else 0) + (if (senlatStart.asKnown().isPresent) 1 else 0) + (if (senlonEnd.asKnown().isPresent) 1 else 0) + (if (senlonStart.asKnown().isPresent) 1 else 0) + (if (senvelx.asKnown().isPresent) 1 else 0) + (if (senvely.asKnown().isPresent) 1 else 0) + (if (senvelz.asKnown().isPresent) 1 else 0) + (if (slantRange.asKnown().isPresent) 1 else 0) + (if (snr.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (spacingAzimuth.asKnown().isPresent) 1 else 0) + (if (spacingRange.asKnown().isPresent) 1 else 0) + (if (squintAngle.asKnown().isPresent) 1 else 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (if (swathLength.asKnown().isPresent) 1 else 0) + (if (targetposx.asKnown().isPresent) 1 else 0) + (if (targetposy.asKnown().isPresent) 1 else 0) + (if (targetposz.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (txPolarization.asKnown().isPresent) 1 else 0)
