...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationListResponse: SarObservationListResponse) = apply {
    ...
    fun validate(): SarObservationListResponse = apply {
        if (validated) {
            return@apply
        }
