 ...
 * parameter.
 */
class OnorbitassessmentGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitassessmentGetParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [OnorbitassessmentGetParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OnorbitassessmentGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitassessmentGetParams: OnorbitassessmentGetParams) = apply {
            id = onorbitassessmentGetParams.id
            firstResult = onorbitassessmentGetParams.firstResult
            maxResults = onorbitassessmentGetParams.maxResults
            additionalHeaders = onorbitassessmentGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = onorbitassessmentGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitassessmentGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitassessmentGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitassessmentGetParams &&
            id == other.id &&
    ...
    override fun toString() =
        "OnorbitassessmentGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
