...
class LogisticsSupportQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(logisticsSupportQueryhelpResponse: LogisticsSupportQueryhelpResponse) =
            apply {
                ...
                requiredRoles =
                    logisticsSupportQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    logisticsSupportQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): LogisticsSupportQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
