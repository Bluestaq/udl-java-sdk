...
class LogisticsSupportQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LogisticsSupportQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [LogisticsSupportQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportQueryhelpResponse: LogisticsSupportQueryhelpResponse) =
            apply {
                aodrSupported = logisticsSupportQueryhelpResponse.aodrSupported
                classificationMarking = logisticsSupportQueryhelpResponse.classificationMarking
                description = logisticsSupportQueryhelpResponse.description
                historySupported = logisticsSupportQueryhelpResponse.historySupported
                name = logisticsSupportQueryhelpResponse.name
                parameters = logisticsSupportQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = logisticsSupportQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = logisticsSupportQueryhelpResponse.restSupported
                sortSupported = logisticsSupportQueryhelpResponse.sortSupported
                typeName = logisticsSupportQueryhelpResponse.typeName
                uri = logisticsSupportQueryhelpResponse.uri
                additionalProperties = logisticsSupportQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LogisticsSupportQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LogisticsSupportQueryhelpResponse =
    ...
    fun validate(): LogisticsSupportQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LogisticsSupportQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
