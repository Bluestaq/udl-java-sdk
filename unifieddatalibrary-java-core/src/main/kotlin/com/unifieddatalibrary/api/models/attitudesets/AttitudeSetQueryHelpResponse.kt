...
class AttitudeSetQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AttitudeSetQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AttitudeSetQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeSetQueryHelpResponse: AttitudeSetQueryHelpResponse) =
            apply {
                aodrSupported = attitudeSetQueryHelpResponse.aodrSupported
                classificationMarking = attitudeSetQueryHelpResponse.classificationMarking
                description = attitudeSetQueryHelpResponse.description
                historySupported = attitudeSetQueryHelpResponse.historySupported
                name = attitudeSetQueryHelpResponse.name
                parameters = attitudeSetQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = attitudeSetQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = attitudeSetQueryHelpResponse.restSupported
                sortSupported = attitudeSetQueryHelpResponse.sortSupported
                typeName = attitudeSetQueryHelpResponse.typeName
                uri = attitudeSetQueryHelpResponse.uri
                additionalProperties = attitudeSetQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AttitudeSetQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AttitudeSetQueryHelpResponse =
    ...
    fun validate(): AttitudeSetQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
