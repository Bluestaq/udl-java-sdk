...
class AttitudeSetQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeSetQueryHelpResponse: AttitudeSetQueryHelpResponse) = apply {
    ...
    fun validate(): AttitudeSetQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
