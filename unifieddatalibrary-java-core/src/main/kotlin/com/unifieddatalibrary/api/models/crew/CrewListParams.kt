...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CrewListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crewListParams: CrewListParams) = apply {
    ...
    override fun toString() =
        "CrewListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
