...
class IonoObservationCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IonoObservationCreateBulkParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ionoObservationCreateBulkParams: IonoObservationCreateBulkParams) =
            apply {
                ...
                additionalQueryParams = ionoObservationCreateBulkParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body @JsonCreator private constructor(
        ...
        class Polarization private constructor(
            private val data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>>,
            private val dimensionName: JsonField<List<String>>,
            private val dimensions: JsonField<List<Int>>,
            private val notes: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("data") @ExcludeMissing data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>> = JsonMissing.of(),
                @JsonProperty("dimensionName") @ExcludeMissing dimensionName: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("dimensions") @ExcludeMissing dimensions: JsonField<List<Int>> = JsonMissing.of(),
                @JsonProperty("notes") @ExcludeMissing notes: JsonField<String> = JsonMissing.of()
            ) : this(
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun data(): Optional<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>> = data.getOptional("data")
            ...
            @JsonProperty("data")
            @ExcludeMissing
            fun _data(): JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>> = data
            ...
            class Builder internal constructor() {
                ...
                private var data: JsonField<MutableList<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>>? = null
                private var dimensionName: JsonField<MutableList<String>>? = null
                private var dimensions: JsonField<MutableList<Int>>? = null
                private var notes: JsonField<String> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                ...
                /** Array of polarization data. */
                fun data(data: List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>) = data(JsonField.of(data))

                /**
                 * Sets [Builder.data] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.data] with a well-typed `List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun data(data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>>>) =
                    apply {
                        this.data = data.map { it.toMutableList() }
                    }

                /**
                 * Adds a single [List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>] to [Builder.data].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addData(data: List<List<List<List<List<List<UnnamedSchemaWithArrayParent3>>>>>>) =
                    apply {
                        this.data = (this.data ?: JsonField.of(mutableListOf())).also {
                            checkKnown("data", it).add(data)
                        }
            ...
            class UnnamedSchemaWithArrayParent3 @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                companion object {
                    ...
                    @JvmStatic fun of(value: String) = UnnamedSchemaWithArrayParent3(JsonField.of(value))
                }
                ...
                /**
                 * An enum containing [UnnamedSchemaWithArrayParent3]'s known values, as well as an [_UNKNOWN] member.
                 *
                 * An instance of [UnnamedSchemaWithArrayParent3] can contain an unknown value in a couple of cases:
                 *
                 * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
                 *   an older version than the API, then the API may respond with new members that the SDK is unaware
                 *   of.
                ...
                enum class Value {
                    X,
                    O,
                    /** An enum member indicating that [UnnamedSchemaWithArrayParent3] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        X -> Known.X
                        O -> Known.O
                        else -> throw UnifieddatalibraryInvalidDataException("Unknown UnnamedSchemaWithArrayParent3: $value")
                    }
                ...
                fun validate(): UnnamedSchemaWithArrayParent3 =
                    apply {
                        if (validated) {
                          return@apply
                        }
    ...
    override fun toString() = "IonoObservationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
