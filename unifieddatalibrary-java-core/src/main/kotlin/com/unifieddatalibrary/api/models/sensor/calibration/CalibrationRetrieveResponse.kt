 ...
 */
class CalibrationRetrieveResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationRetrieveResponse: CalibrationRetrieveResponse) = apply {
    ...
    fun validate(): CalibrationRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
