...
class CalibrationRetrieveResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("azRaAccelBias") @ExcludeMissing azRaAccelBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("azRaAccelSigma") @ExcludeMissing azRaAccelSigma: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("azRaBias") @ExcludeMissing azRaBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("azRaRateBias") @ExcludeMissing azRaRateBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("azRaRateSigma") @ExcludeMissing azRaRateSigma: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("calAngleRef") @ExcludeMissing calAngleRef: JsonField<String> = JsonMissing.of(),
        @JsonProperty("calTrackMode") @ExcludeMissing calTrackMode: JsonField<String> = JsonMissing.of(),
        @JsonProperty("calType") @ExcludeMissing calType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("confidenceNoiseBias") @ExcludeMissing confidenceNoiseBias: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("elDecAccelBias") @ExcludeMissing elDecAccelBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("elDecAccelSigma") @ExcludeMissing elDecAccelSigma: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("elDecBias") @ExcludeMissing elDecBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("elDecRateBias") @ExcludeMissing elDecRateBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("elDecRateSigma") @ExcludeMissing elDecRateSigma: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("elDecRms") @ExcludeMissing elDecRms: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("elDecSigma") @ExcludeMissing elDecSigma: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("numRangeRateObs") @ExcludeMissing numRangeRateObs: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("photoSigma") @ExcludeMissing photoSigma: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("rangeAccelBias") @ExcludeMissing rangeAccelBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("rangeAccelSigma") @ExcludeMissing rangeAccelSigma: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("rangeBias") @ExcludeMissing rangeBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("rangeRateBias") @ExcludeMissing rangeRateBias: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("rangeRateRms") @ExcludeMissing rangeRateRms: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("rangeRateSigma") @ExcludeMissing rangeRateSigma: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("rangeRms") @ExcludeMissing rangeRms: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("rangeSigma") @ExcludeMissing rangeSigma: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("refTargets") @ExcludeMissing refTargets: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("timeBiasSigma") @ExcludeMissing timeBiasSigma: JsonField<Double> = JsonMissing.of()
    ) : this(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalibrationRetrieveResponse].
         *
    ...
    /** A builder for [CalibrationRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationRetrieveResponse: CalibrationRetrieveResponse) =
            apply {
                classificationMarking = calibrationRetrieveResponse.classificationMarking
                dataMode = calibrationRetrieveResponse.dataMode
                idSensor = calibrationRetrieveResponse.idSensor
                source = calibrationRetrieveResponse.source
                startTime = calibrationRetrieveResponse.startTime
                id = calibrationRetrieveResponse.id
                azRaAccelBias = calibrationRetrieveResponse.azRaAccelBias
                azRaAccelSigma = calibrationRetrieveResponse.azRaAccelSigma
                azRaBias = calibrationRetrieveResponse.azRaBias
                azRaRateBias = calibrationRetrieveResponse.azRaRateBias
                azRaRateSigma = calibrationRetrieveResponse.azRaRateSigma
                azRaRms = calibrationRetrieveResponse.azRaRms
                azRaSigma = calibrationRetrieveResponse.azRaSigma
                calAngleRef = calibrationRetrieveResponse.calAngleRef
                calTrackMode = calibrationRetrieveResponse.calTrackMode
                calType = calibrationRetrieveResponse.calType
                confidenceNoiseBias = calibrationRetrieveResponse.confidenceNoiseBias
                createdAt = calibrationRetrieveResponse.createdAt
                createdBy = calibrationRetrieveResponse.createdBy
                duration = calibrationRetrieveResponse.duration
                ecr = calibrationRetrieveResponse.ecr.map { it.toMutableList() }
                elDecAccelBias = calibrationRetrieveResponse.elDecAccelBias
                elDecAccelSigma = calibrationRetrieveResponse.elDecAccelSigma
                elDecBias = calibrationRetrieveResponse.elDecBias
                elDecRateBias = calibrationRetrieveResponse.elDecRateBias
                elDecRateSigma = calibrationRetrieveResponse.elDecRateSigma
                elDecRms = calibrationRetrieveResponse.elDecRms
                elDecSigma = calibrationRetrieveResponse.elDecSigma
                endTime = calibrationRetrieveResponse.endTime
                numAzRaObs = calibrationRetrieveResponse.numAzRaObs
                numElDecObs = calibrationRetrieveResponse.numElDecObs
                numObs = calibrationRetrieveResponse.numObs
                numPhotoObs = calibrationRetrieveResponse.numPhotoObs
                numRangeObs = calibrationRetrieveResponse.numRangeObs
                numRangeRateObs = calibrationRetrieveResponse.numRangeRateObs
                numRcsObs = calibrationRetrieveResponse.numRcsObs
                numTimeObs = calibrationRetrieveResponse.numTimeObs
                numTracks = calibrationRetrieveResponse.numTracks
                origin = calibrationRetrieveResponse.origin
                origNetwork = calibrationRetrieveResponse.origNetwork
                photoBias = calibrationRetrieveResponse.photoBias
                photoSigma = calibrationRetrieveResponse.photoSigma
                rangeAccelBias = calibrationRetrieveResponse.rangeAccelBias
                rangeAccelSigma = calibrationRetrieveResponse.rangeAccelSigma
                rangeBias = calibrationRetrieveResponse.rangeBias
                rangeRateBias = calibrationRetrieveResponse.rangeRateBias
                rangeRateRms = calibrationRetrieveResponse.rangeRateRms
                rangeRateSigma = calibrationRetrieveResponse.rangeRateSigma
                rangeRms = calibrationRetrieveResponse.rangeRms
                rangeSigma = calibrationRetrieveResponse.rangeSigma
                rcsBias = calibrationRetrieveResponse.rcsBias
                rcsSigma = calibrationRetrieveResponse.rcsSigma
                refTargets = calibrationRetrieveResponse.refTargets.map { it.toMutableList() }
                refType = calibrationRetrieveResponse.refType
                senType = calibrationRetrieveResponse.senType
                sourceDl = calibrationRetrieveResponse.sourceDl
                timeBias = calibrationRetrieveResponse.timeBias
                timeBiasSigma = calibrationRetrieveResponse.timeBiasSigma
                additionalProperties = calibrationRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CalibrationRetrieveResponse].
         *
         ...
         */
        fun build(): CalibrationRetrieveResponse =
    ...
    fun validate(): CalibrationRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
