...
class ItemTrackingTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingTupleResponse: ItemTrackingTupleResponse) = apply {
    ...
    fun validate(): ItemTrackingTupleResponse = apply {
        if (validated) {
            return@apply
        }
