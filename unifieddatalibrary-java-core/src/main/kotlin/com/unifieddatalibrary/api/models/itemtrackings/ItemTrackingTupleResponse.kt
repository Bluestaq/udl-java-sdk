...
class ItemTrackingTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemTrackingTupleResponse].
         *
    ...
    /** A builder for [ItemTrackingTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingTupleResponse: ItemTrackingTupleResponse) =
            apply {
                classificationMarking = itemTrackingTupleResponse.classificationMarking
                dataMode = itemTrackingTupleResponse.dataMode
                scanCode = itemTrackingTupleResponse.scanCode
                scannerId = itemTrackingTupleResponse.scannerId
                source = itemTrackingTupleResponse.source
                ts = itemTrackingTupleResponse.ts
                id = itemTrackingTupleResponse.id
                createdAt = itemTrackingTupleResponse.createdAt
                createdBy = itemTrackingTupleResponse.createdBy
                dvCode = itemTrackingTupleResponse.dvCode
                idItem = itemTrackingTupleResponse.idItem
                keys = itemTrackingTupleResponse.keys.map { it.toMutableList() }
                lat = itemTrackingTupleResponse.lat
                lon = itemTrackingTupleResponse.lon
                notes = itemTrackingTupleResponse.notes
                origin = itemTrackingTupleResponse.origin
                origNetwork = itemTrackingTupleResponse.origNetwork
                scanType = itemTrackingTupleResponse.scanType
                scGenTool = itemTrackingTupleResponse.scGenTool
                sourceDl = itemTrackingTupleResponse.sourceDl
                type = itemTrackingTupleResponse.type
                values = itemTrackingTupleResponse.values.map { it.toMutableList() }
                additionalProperties = itemTrackingTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ItemTrackingTupleResponse].
         *
         ...
         */
        fun build(): ItemTrackingTupleResponse =
    ...
    fun validate(): ItemTrackingTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
