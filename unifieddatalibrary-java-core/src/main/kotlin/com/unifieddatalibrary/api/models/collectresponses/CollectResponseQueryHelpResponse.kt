...
class CollectResponseQueryHelpResponse
private constructor(
    ...
    /** A builder for [CollectResponseQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectResponseQueryHelpResponse: CollectResponseQueryHelpResponse) =
            apply {
                aodrSupported = collectResponseQueryHelpResponse.aodrSupported
                classificationMarking = collectResponseQueryHelpResponse.classificationMarking
                description = collectResponseQueryHelpResponse.description
                historySupported = collectResponseQueryHelpResponse.historySupported
                name = collectResponseQueryHelpResponse.name
                parameters = collectResponseQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    collectResponseQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = collectResponseQueryHelpResponse.restSupported
                sortSupported = collectResponseQueryHelpResponse.sortSupported
                typeName = collectResponseQueryHelpResponse.typeName
                uri = collectResponseQueryHelpResponse.uri
                additionalProperties =
                    collectResponseQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CollectResponseQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CollectResponseQueryHelpResponse =
            CollectResponseQueryHelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): CollectResponseQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
