 ...
 */
class AviationRiskManagementTupleParams
private constructor(
    private val columns: String,
    private val idMission: String,
    ...
    fun idMission(): String = idMission
    ...
    /** A builder for [AviationRiskManagementTupleParams]. */
    class Builder internal constructor() {

        private var columns: String? = null
        private var idMission: String? = null
        ...
        @JvmSynthetic
        internal fun from(aviationRiskManagementTupleParams: AviationRiskManagementTupleParams) =
            apply {
                columns = aviationRiskManagementTupleParams.columns
                idMission = aviationRiskManagementTupleParams.idMission
                firstResult = aviationRiskManagementTupleParams.firstResult
                maxResults = aviationRiskManagementTupleParams.maxResults
                additionalHeaders = aviationRiskManagementTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    aviationRiskManagementTupleParams.additionalQueryParams.toBuilder()
            }
         ...
         * The unique identifier of the mission to which this risk management record is assigned.
         */
        fun idMission(idMission: String) = apply { this.idMission = idMission }
        ...
        /**
         * Returns an immutable instance of [AviationRiskManagementTupleParams].
         *
         ...
         */
        fun build(): AviationRiskManagementTupleParams =
            AviationRiskManagementTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AviationRiskManagementTupleParams && columns == other.columns && idMission == other.idMission && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, idMission, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AviationRiskManagementTupleParams{columns=$columns, idMission=$idMission, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
