...
class ChannelAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChannelAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(channelAbridged: ChannelAbridged) =
            apply {
                classificationMarking = channelAbridged.classificationMarking
                dataMode = channelAbridged.dataMode
                idTransponder = channelAbridged.idTransponder
                name = channelAbridged.name
                source = channelAbridged.source
                id = channelAbridged.id
                apid = channelAbridged.apid
                beamName = channelAbridged.beamName
                compression = channelAbridged.compression
                createdAt = channelAbridged.createdAt
                createdBy = channelAbridged.createdBy
                encryption = channelAbridged.encryption
                idBeam = channelAbridged.idBeam
                idRfBand = channelAbridged.idRfBand
                origin = channelAbridged.origin
                origNetwork = channelAbridged.origNetwork
                owner = channelAbridged.owner
                pkg = channelAbridged.pkg
                res = channelAbridged.res
                sid = channelAbridged.sid
                type = channelAbridged.type
                vpid = channelAbridged.vpid
                additionalProperties = channelAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ChannelAbridged].
         *
    ...
    override fun toString() = "ChannelAbridged{classificationMarking=$classificationMarking, dataMode=$dataMode, idTransponder=$idTransponder, name=$name, source=$source, id=$id, apid=$apid, beamName=$beamName, compression=$compression, createdAt=$createdAt, createdBy=$createdBy, encryption=$encryption, idBeam=$idBeam, idRfBand=$idRfBand, origin=$origin, origNetwork=$origNetwork, owner=$owner, pkg=$pkg, res=$res, sid=$sid, type=$type, vpid=$vpid, additionalProperties=$additionalProperties}"
}
