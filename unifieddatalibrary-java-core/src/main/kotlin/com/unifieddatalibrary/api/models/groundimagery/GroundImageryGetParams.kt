...
class GroundImageryGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): GroundImageryGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryGetParams: GroundImageryGetParams) =
            apply {
    ...
    override fun toString() = "GroundImageryGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
