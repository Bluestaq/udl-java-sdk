 ...
 * parameter. GroundImagery represents metadata about a ground image, as well as the actual binary
 * image data.
 */
class GroundImageryGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): GroundImageryGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GroundImageryGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GroundImageryGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryGetParams: GroundImageryGetParams) = apply {
            id = groundImageryGetParams.id
            firstResult = groundImageryGetParams.firstResult
            maxResults = groundImageryGetParams.maxResults
            additionalHeaders = groundImageryGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = groundImageryGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GroundImageryGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GroundImageryGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is GroundImageryGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "GroundImageryGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
