 ...
 */
class OperatingunitremarkCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OperatingunitremarkCountParams = builder().build()
    ...
    /** A builder for [OperatingunitremarkCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitremarkCountParams: OperatingunitremarkCountParams) = apply {
            firstResult = operatingunitremarkCountParams.firstResult
            maxResults = operatingunitremarkCountParams.maxResults
            additionalHeaders = operatingunitremarkCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = operatingunitremarkCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OperatingunitremarkCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OperatingunitremarkCountParams =
            OperatingunitremarkCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OperatingunitremarkCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OperatingunitremarkCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
