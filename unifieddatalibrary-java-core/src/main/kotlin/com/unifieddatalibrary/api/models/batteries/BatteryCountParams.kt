...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BatteryCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BatteryCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BatteryCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batteryCountParams: BatteryCountParams) = apply {
            firstResult = batteryCountParams.firstResult
            maxResults = batteryCountParams.maxResults
            additionalHeaders = batteryCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = batteryCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatteryCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatteryCountParams =
            BatteryCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatteryCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BatteryCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
