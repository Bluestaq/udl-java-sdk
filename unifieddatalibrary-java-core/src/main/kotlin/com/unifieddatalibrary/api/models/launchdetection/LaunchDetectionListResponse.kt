...
class LaunchDetectionListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionListResponse: LaunchDetectionListResponse) =
            apply {
    ...
    fun validate(): LaunchDetectionListResponse =
        apply {
            if (validated) {
              return@apply
            }
