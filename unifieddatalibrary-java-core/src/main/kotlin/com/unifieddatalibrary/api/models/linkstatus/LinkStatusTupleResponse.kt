...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LinkStatusTupleResponse].
         *
    ...
    /** A builder for [LinkStatusTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(linkStatusTupleResponse: LinkStatusTupleResponse) = apply {
            classificationMarking = linkStatusTupleResponse.classificationMarking
            dataMode = linkStatusTupleResponse.dataMode
            endPoint1Lat = linkStatusTupleResponse.endPoint1Lat
            endPoint1Lon = linkStatusTupleResponse.endPoint1Lon
            endPoint1Name = linkStatusTupleResponse.endPoint1Name
            endPoint2Lat = linkStatusTupleResponse.endPoint2Lat
            endPoint2Lon = linkStatusTupleResponse.endPoint2Lon
            endPoint2Name = linkStatusTupleResponse.endPoint2Name
            linkName = linkStatusTupleResponse.linkName
            linkStartTime = linkStatusTupleResponse.linkStartTime
            linkStopTime = linkStatusTupleResponse.linkStopTime
            source = linkStatusTupleResponse.source
            id = linkStatusTupleResponse.id
            band = linkStatusTupleResponse.band
            constellation = linkStatusTupleResponse.constellation
            createdAt = linkStatusTupleResponse.createdAt
            createdBy = linkStatusTupleResponse.createdBy
            dataRate1To2 = linkStatusTupleResponse.dataRate1To2
            dataRate2To1 = linkStatusTupleResponse.dataRate2To1
            idBeam1 = linkStatusTupleResponse.idBeam1
            idBeam2 = linkStatusTupleResponse.idBeam2
            idOnOrbit1 = linkStatusTupleResponse.idOnOrbit1
            idOnOrbit2 = linkStatusTupleResponse.idOnOrbit2
            linkState = linkStatusTupleResponse.linkState
            linkType = linkStatusTupleResponse.linkType
            opsCap = linkStatusTupleResponse.opsCap
            origin = linkStatusTupleResponse.origin
            origNetwork = linkStatusTupleResponse.origNetwork
            satNo1 = linkStatusTupleResponse.satNo1
            satNo2 = linkStatusTupleResponse.satNo2
            sysCap = linkStatusTupleResponse.sysCap
            additionalProperties = linkStatusTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LinkStatusTupleResponse].
         *
         ...
         */
        fun build(): LinkStatusTupleResponse =
    ...
    fun validate(): LinkStatusTupleResponse = apply {
        if (validated) {
            return@apply
        }
