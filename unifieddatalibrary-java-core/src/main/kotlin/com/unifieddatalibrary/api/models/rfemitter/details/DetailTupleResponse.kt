...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("prepTime") @ExcludeMissing prepTime: JsonField<Double> = JsonMissing.of(),
     ...
     *   if the server responded with an unexpected value).
     */
    fun idManufacturerOrg(): Optional<String> = idManufacturerOrg.getOptional("idManufacturerOrg")
    ...
    /**
     * COCOM that has temporary responsibility for scheduling and management of the RF Emitter (e.g.
     * SPACEFOR-CENT, SPACEFOR-EURAF, SPACEFOR-INDOPAC, SPACEFOR-KOR, SPACEFOR-STRATNORTH, SPACESOC,
     * NONE).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     * transmitter. End sensitivity range, in decibel-milliwatts.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     * Receiver sensitivity is the lowest power level at which the receiver can detect an RF signal
     * and demodulate data. Sensitivity is purely a receiver specification and is independent of the
     * transmitter. Start sensitivity range, in decibel-milliwatts.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     */
    @JsonProperty("amplifier") @ExcludeMissing fun _amplifier(): JsonField<Amplifier> = amplifier
     ...
     */
    @JsonProperty("antennas") @ExcludeMissing fun _antennas(): JsonField<List<Antenna>> = antennas
     ...
     */
    @JsonProperty("bitRunTime") @ExcludeMissing fun _bitRunTime(): JsonField<Double> = bitRunTime
     ...
     *
     * Unlike [loanedToCocom], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("loanedToCocom")
    @ExcludeMissing
     ...
     *
     * Unlike [powerOffsets], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("powerOffsets")
    @ExcludeMissing
     ...
     *
     * Unlike [primaryCocom], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("primaryCocom")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DetailTupleResponse].
         *
    ...
    /** A builder for [DetailTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailTupleResponse: DetailTupleResponse) = apply {
            classificationMarking = detailTupleResponse.classificationMarking
            dataMode = detailTupleResponse.dataMode
            idRfEmitter = detailTupleResponse.idRfEmitter
            source = detailTupleResponse.source
            id = detailTupleResponse.id
            alternateFacilityName = detailTupleResponse.alternateFacilityName
            altName = detailTupleResponse.altName
            amplifier = detailTupleResponse.amplifier
            antennas = detailTupleResponse.antennas.map { it.toMutableList() }
            barrageNoiseBandwidth = detailTupleResponse.barrageNoiseBandwidth
            bitRunTime = detailTupleResponse.bitRunTime
            createdAt = detailTupleResponse.createdAt
            createdBy = detailTupleResponse.createdBy
            description = detailTupleResponse.description
            designator = detailTupleResponse.designator
            dopplerNoise = detailTupleResponse.dopplerNoise
            drfmInstantaneousBandwidth = detailTupleResponse.drfmInstantaneousBandwidth
            family = detailTupleResponse.family
            fixedAttenuation = detailTupleResponse.fixedAttenuation
            idManufacturerOrg = detailTupleResponse.idManufacturerOrg
            idProductionFacilityLocation = detailTupleResponse.idProductionFacilityLocation
            loanedToCocom = detailTupleResponse.loanedToCocom
            notes = detailTupleResponse.notes
            numBits = detailTupleResponse.numBits
            numChannels = detailTupleResponse.numChannels
            origin = detailTupleResponse.origin
            origNetwork = detailTupleResponse.origNetwork
            powerOffsets = detailTupleResponse.powerOffsets.map { it.toMutableList() }
            prepTime = detailTupleResponse.prepTime
            primaryCocom = detailTupleResponse.primaryCocom
            productionFacilityName = detailTupleResponse.productionFacilityName
            receiverType = detailTupleResponse.receiverType
            secondaryNotes = detailTupleResponse.secondaryNotes
            services = detailTupleResponse.services.map { it.toMutableList() }
            systemSensitivityEnd = detailTupleResponse.systemSensitivityEnd
            systemSensitivityStart = detailTupleResponse.systemSensitivityStart
            ttps = detailTupleResponse.ttps.map { it.toMutableList() }
            updatedAt = detailTupleResponse.updatedAt
            updatedBy = detailTupleResponse.updatedBy
            urls = detailTupleResponse.urls.map { it.toMutableList() }
            additionalProperties = detailTupleResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.amplifier] with a well-typed [Amplifier] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.bitRunTime] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.idProductionFacilityLocation] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun idProductionFacilityLocation(idProductionFacilityLocation: JsonField<String>) = apply {
         ...
         *
         * You should usually call [Builder.loanedToCocom] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         * task.
         */
        fun powerOffsets(powerOffsets: List<PowerOffset>) = powerOffsets(JsonField.of(powerOffsets))
         ...
         *
         * You should usually call [Builder.prepTime] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.primaryCocom] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.ttps] with a well-typed `List<Ttp>` value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun ttps(ttps: JsonField<List<Ttp>>) = apply { this.ttps = ttps.map { it.toMutableList() } }
        ...
        fun addTtp(ttp: Ttp) = apply {
            ttps = (ttps ?: JsonField.of(mutableListOf())).also { checkKnown("ttps", it).add(ttp) }
        }
        ...
        /**
         * Returns an immutable instance of [DetailTupleResponse].
         *
    ...
    fun validate(): DetailTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         */
        fun deviceIdentifier(): Optional<String> = deviceIdentifier.getOptional("deviceIdentifier")
         ...
         *
         * Unlike [deviceIdentifier], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("deviceIdentifier")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.deviceIdentifier] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("feeds") @ExcludeMissing feeds: JsonField<List<Feed>> = JsonMissing.of(),
         ...
         *
         * Unlike [antennaDiameter], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("antennaDiameter")
        @ExcludeMissing
         ...
         *
         * Unlike [azElFixed], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("azElFixed") @ExcludeMissing fun _azElFixed(): JsonField<Boolean> = azElFixed
         ...
         *
         * Unlike [fixedElevation], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("fixedElevation")
        @ExcludeMissing
         ...
         *
         * Unlike [maxAzimuths], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("maxAzimuths")
        @ExcludeMissing
         ...
         *
         * Unlike [minAzimuths], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("minAzimuths")
        @ExcludeMissing
         ...
         *
         * Unlike [receiverChannels], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("receiverChannels")
        @ExcludeMissing
         ...
         *
         * Unlike [transmitChannels], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("transmitChannels")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.feeds] with a well-typed `List<Feed>` value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.maxAzimuths] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.minAzimuths] with a well-typed `List<Double>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * `List<ReceiverChannel>` value instead. This method is primarily for setting the field
             ...
             * `List<TransmitChannel>` value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 */
                fun build(): Feed =
                    Feed(freqMax, freqMin, name, polarization, additionalProperties.toMutableMap())
            }
        ...
        private constructor(
             ...
             *
             * Unlike [channelNum], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("channelNum")
            @ExcludeMissing
             ...
             *
             * Unlike [maxBandwidth], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("maxBandwidth")
            @ExcludeMissing
             ...
             *
             * Unlike [minBandwidth], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("minBandwidth")
            @ExcludeMissing
             ...
             *
             * Unlike [sensitivity], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("sensitivity")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * minBandwidth ≤ bandwidth ≤ maxBandwidth.
                 */
                fun maxBandwidth(maxBandwidth: Double) = maxBandwidth(JsonField.of(maxBandwidth))

                /**
                 * Sets [Builder.maxBandwidth] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.maxBandwidth] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * bandwidth ≤ maxBandwidth.
                 */
                fun minBandwidth(minBandwidth: Double) = minBandwidth(JsonField.of(minBandwidth))

                /**
                 * Sets [Builder.minBandwidth] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.minBandwidth] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.sensitivity] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
        ...
        private constructor(
            ...
            /**
             * The transmitter bandwidth, in megahertz, must satisfy the constraint: minBandwidth ≤
             * bandwidth ≤ maxBandwidth.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
            ...
            /**
             * The transmitter frequency, in megahertz, must satisfy the constraint: freqMin <= freq
             * <= freqMax.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
            ...
            /**
             * The maximum transmitter frequency, in megahertz, must satisfy the constraint: freqMin
             * ≤ freq ≤ freqMax.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
            ...
            /**
             * The minimum transmitter frequency, in megahertz, must satisfy the constraint: freqMin
             * ≤ freq ≤ freqMax.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             ...
             *
             * Unlike [maxGain], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [minGain], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [sampleRates], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("sampleRates")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.freq] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 * The set of sample rates supported by this transmit channel, in bits per second.
                 */
                fun sampleRates(sampleRates: List<Double>) = sampleRates(JsonField.of(sampleRates))

                /**
                 * Sets [Builder.sampleRates] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.sampleRates] with a well-typed `List<Double>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
    ...
    private constructor(
         ...
         *
         * Unlike [powerOffset], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("powerOffset")
        @ExcludeMissing
    ...
    private constructor(
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun outputSignalName(): Optional<String> = outputSignalName.getOptional("outputSignalName")
         ...
         *
         * Unlike [outputSignalName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("outputSignalName")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            private var techniqueDefinitions: JsonField<MutableList<TechniqueDefinition>>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
             ...
             *
             * You should usually call [Builder.outputSignalName] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * `List<TechniqueDefinition>` value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            fun techniqueDefinitions(techniqueDefinitions: JsonField<List<TechniqueDefinition>>) =
                apply {
        ...
        internal fun validity(): Int =
            (if (outputSignalName.asKnown().isPresent) 1 else 0) +
                (techniqueDefinitions.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        private constructor(
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [TechniqueDefinition].
                 */
                @JvmStatic fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(techniqueDefinition: TechniqueDefinition) = apply {
                    ...
                    additionalProperties = techniqueDefinition.additionalProperties.toMutableMap()
                }
                 ...
                 * `List<ParamDefinition>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                fun paramDefinitions(paramDefinitions: JsonField<List<ParamDefinition>>) = apply {
            ...
            internal fun validity(): Int =
                (if (name.asKnown().isPresent) 1 else 0) +
                    (paramDefinitions.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)

            /**
             * An RF Emitter Technique Parameter Definition associated with an RF Emitter Technique
             * Definition.
             */
            ...
            private constructor(
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun validValues(): Optional<List<String>> = validValues.getOptional("validValues")
                 ...
                 *
                 * Unlike [optional], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("optional")
                @ExcludeMissing
                ...
                companion object {
                    ...
                    /**
                     * Returns a mutable builder for constructing an instance of [ParamDefinition].
                     */
                    @JvmStatic fun builder() = Builder()
                }
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(paramDefinition: ParamDefinition) = apply {
                        ...
                        additionalProperties = paramDefinition.additionalProperties.toMutableMap()
                    }
                     ...
                     *
                     * You should usually call [Builder.optional] with a well-typed [Boolean] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailTupleResponse &&
