...
class HistoryListPage private constructor(
    ...
    private val items: List<AttitudesetFull>,

) : Page<AttitudesetFull> {
    ...
    fun autoPager(): AutoPager<AttitudesetFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<AttitudesetFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<AttitudesetFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<AttitudesetFull>) =
            apply {
                this.items = items
            }
