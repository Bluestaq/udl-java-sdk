...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SortiePprGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprGetParams: SortiePprGetParams) = apply {
    ...
    override fun toString() =
        "SortiePprGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
