...
class SortiePprGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SortiePprGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SortiePprGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SortiePprGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprGetParams: SortiePprGetParams) =
            apply {
                id = sortiePprGetParams.id
                firstResult = sortiePprGetParams.firstResult
                maxResults = sortiePprGetParams.maxResults
                additionalHeaders = sortiePprGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = sortiePprGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SortiePprGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SortiePprGetParams =
            SortiePprGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SortiePprGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SortiePprGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
