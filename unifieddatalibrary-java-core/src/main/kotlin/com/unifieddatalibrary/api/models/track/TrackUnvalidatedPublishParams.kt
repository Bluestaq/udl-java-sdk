 ...
 */
class TrackUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [TrackUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackUnvalidatedPublishParams: TrackUnvalidatedPublishParams) = apply {
            body = trackUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = trackUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams = trackUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TrackUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): TrackUnvalidatedPublishParams =
            TrackUnvalidatedPublishParams(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * the array must always contain 3 values. These values represent the vehicle's rotation
             * about the vertical, lateral, and longitudinal axes, respectively, in a locally level,
             * East, North, Up "right handed" coordinate system centered on the vehicle. Yaw is
             * measured in degrees and ranges from -180 to 180. Pitch is measured in degrees and
             * ranges from -90 to 90. Roll is measured in degrees and ranges from -180 to 180.
             */
             ...
             * the track object. When provided, the array must always contain 3 values. These values
             * represent the rate of change of the vehicle's rotation about the vertical, lateral,
             * and longitudinal axes, respectively, in a locally level, East, North, Up "right
             * handed" coordinate system centered on the vehicle.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "TrackUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
