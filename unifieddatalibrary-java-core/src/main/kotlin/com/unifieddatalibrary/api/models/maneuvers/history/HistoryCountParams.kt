...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyCountParams: HistoryCountParams) = apply {
            eventStartTime = historyCountParams.eventStartTime
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is HistoryCountParams && eventStartTime == other.eventStartTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "HistoryCountParams{eventStartTime=$eventStartTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
