...
class BatteryQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BatteryQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BatteryQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batteryQueryhelpResponse: BatteryQueryhelpResponse) = apply {
            aodrSupported = batteryQueryhelpResponse.aodrSupported
            classificationMarking = batteryQueryhelpResponse.classificationMarking
            description = batteryQueryhelpResponse.description
            historySupported = batteryQueryhelpResponse.historySupported
            name = batteryQueryhelpResponse.name
            parameters = batteryQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = batteryQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = batteryQueryhelpResponse.restSupported
            sortSupported = batteryQueryhelpResponse.sortSupported
            typeName = batteryQueryhelpResponse.typeName
            uri = batteryQueryhelpResponse.uri
            additionalProperties = batteryQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatteryQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatteryQueryhelpResponse =
    ...
    fun validate(): BatteryQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatteryQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
