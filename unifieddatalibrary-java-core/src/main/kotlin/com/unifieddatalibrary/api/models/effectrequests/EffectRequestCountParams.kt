...
class EffectRequestCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectRequestCountParams].
         *
    ...
    /** A builder for [EffectRequestCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestCountParams: EffectRequestCountParams) =
            apply {
                createdAt = effectRequestCountParams.createdAt
                firstResult = effectRequestCountParams.firstResult
                maxResults = effectRequestCountParams.maxResults
                additionalHeaders = effectRequestCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectRequestCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestCountParams].
         *
         ...
         */
        fun build(): EffectRequestCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectRequestCountParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EffectRequestCountParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
