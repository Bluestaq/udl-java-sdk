...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorTypeListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeListParams: SensorTypeListParams) = apply {
    ...
    override fun toString() =
        "SensorTypeListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
