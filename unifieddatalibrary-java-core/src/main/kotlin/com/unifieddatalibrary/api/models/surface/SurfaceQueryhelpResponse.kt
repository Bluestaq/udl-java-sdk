...
class SurfaceQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SurfaceQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SurfaceQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceQueryhelpResponse: SurfaceQueryhelpResponse) =
            apply {
                aodrSupported = surfaceQueryhelpResponse.aodrSupported
                classificationMarking = surfaceQueryhelpResponse.classificationMarking
                description = surfaceQueryhelpResponse.description
                historySupported = surfaceQueryhelpResponse.historySupported
                name = surfaceQueryhelpResponse.name
                parameters = surfaceQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = surfaceQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = surfaceQueryhelpResponse.restSupported
                sortSupported = surfaceQueryhelpResponse.sortSupported
                typeName = surfaceQueryhelpResponse.typeName
                uri = surfaceQueryhelpResponse.uri
                additionalProperties = surfaceQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SurfaceQueryhelpResponse =
    ...
    fun validate(): SurfaceQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SurfaceQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
