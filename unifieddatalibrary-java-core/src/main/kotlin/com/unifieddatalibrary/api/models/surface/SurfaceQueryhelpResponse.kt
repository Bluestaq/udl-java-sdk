...
class SurfaceQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceQueryhelpResponse: SurfaceQueryhelpResponse) = apply {
    ...
    fun validate(): SurfaceQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
