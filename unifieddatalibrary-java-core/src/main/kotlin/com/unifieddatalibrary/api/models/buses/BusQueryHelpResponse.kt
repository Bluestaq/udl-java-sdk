...
class BusQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BusQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [BusQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(busQueryHelpResponse: BusQueryHelpResponse) =
            apply {
                aodrSupported = busQueryHelpResponse.aodrSupported
                classificationMarking = busQueryHelpResponse.classificationMarking
                description = busQueryHelpResponse.description
                historySupported = busQueryHelpResponse.historySupported
                name = busQueryHelpResponse.name
                parameters = busQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = busQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = busQueryHelpResponse.restSupported
                sortSupported = busQueryHelpResponse.sortSupported
                typeName = busQueryHelpResponse.typeName
                uri = busQueryHelpResponse.uri
                additionalProperties = busQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BusQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BusQueryHelpResponse =
    ...
    fun validate(): BusQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BusQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
