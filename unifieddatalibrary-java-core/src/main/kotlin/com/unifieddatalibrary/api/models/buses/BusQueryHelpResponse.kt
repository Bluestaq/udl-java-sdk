...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(busQueryHelpResponse: BusQueryHelpResponse) = apply {
    ...
    fun validate(): BusQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
