...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftsortieAbridged].
         *
    ...
    /** A builder for [AircraftsortieAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftsortieAbridged: AircraftsortieAbridged) = apply {
            classificationMarking = aircraftsortieAbridged.classificationMarking
            dataMode = aircraftsortieAbridged.dataMode
            plannedDepTime = aircraftsortieAbridged.plannedDepTime
            source = aircraftsortieAbridged.source
            id = aircraftsortieAbridged.id
            actualArrTime = aircraftsortieAbridged.actualArrTime
            actualBlockInTime = aircraftsortieAbridged.actualBlockInTime
            actualBlockOutTime = aircraftsortieAbridged.actualBlockOutTime
            actualDepTime = aircraftsortieAbridged.actualDepTime
            aircraftAdsb = aircraftsortieAbridged.aircraftAdsb
            aircraftAltId = aircraftsortieAbridged.aircraftAltId
            aircraftEvent = aircraftsortieAbridged.aircraftEvent
            aircraftMds = aircraftsortieAbridged.aircraftMds
            aircraftRemarks = aircraftsortieAbridged.aircraftRemarks
            alertStatus = aircraftsortieAbridged.alertStatus
            alertStatusCode = aircraftsortieAbridged.alertStatusCode
            amcMsnNum = aircraftsortieAbridged.amcMsnNum
            amcMsnType = aircraftsortieAbridged.amcMsnType
            arrFaa = aircraftsortieAbridged.arrFaa
            arrIata = aircraftsortieAbridged.arrIata
            arrIcao = aircraftsortieAbridged.arrIcao
            arrItinerary = aircraftsortieAbridged.arrItinerary
            arrPurposeCode = aircraftsortieAbridged.arrPurposeCode
            callSign = aircraftsortieAbridged.callSign
            cargoConfig = aircraftsortieAbridged.cargoConfig
            commanderName = aircraftsortieAbridged.commanderName
            createdAt = aircraftsortieAbridged.createdAt
            createdBy = aircraftsortieAbridged.createdBy
            currentState = aircraftsortieAbridged.currentState
            delayCode = aircraftsortieAbridged.delayCode
            depFaa = aircraftsortieAbridged.depFaa
            depIata = aircraftsortieAbridged.depIata
            depIcao = aircraftsortieAbridged.depIcao
            depItinerary = aircraftsortieAbridged.depItinerary
            depPurposeCode = aircraftsortieAbridged.depPurposeCode
            dhd = aircraftsortieAbridged.dhd
            dhdReason = aircraftsortieAbridged.dhdReason
            estArrTime = aircraftsortieAbridged.estArrTime
            estBlockInTime = aircraftsortieAbridged.estBlockInTime
            estBlockOutTime = aircraftsortieAbridged.estBlockOutTime
            estDepTime = aircraftsortieAbridged.estDepTime
            filename = aircraftsortieAbridged.filename
            filesize = aircraftsortieAbridged.filesize
            flightTime = aircraftsortieAbridged.flightTime
            fmDeskNum = aircraftsortieAbridged.fmDeskNum
            fmName = aircraftsortieAbridged.fmName
            fuelReq = aircraftsortieAbridged.fuelReq
            gndTime = aircraftsortieAbridged.gndTime
            idAircraft = aircraftsortieAbridged.idAircraft
            idMission = aircraftsortieAbridged.idMission
            jcsPriority = aircraftsortieAbridged.jcsPriority
            legNum = aircraftsortieAbridged.legNum
            lineNumber = aircraftsortieAbridged.lineNumber
            missionId = aircraftsortieAbridged.missionId
            missionUpdate = aircraftsortieAbridged.missionUpdate
            objectiveRemarks = aircraftsortieAbridged.objectiveRemarks
            origin = aircraftsortieAbridged.origin
            origNetwork = aircraftsortieAbridged.origNetwork
            origSortieId = aircraftsortieAbridged.origSortieId
            oxyOnCrew = aircraftsortieAbridged.oxyOnCrew
            oxyOnPax = aircraftsortieAbridged.oxyOnPax
            oxyReqCrew = aircraftsortieAbridged.oxyReqCrew
            oxyReqPax = aircraftsortieAbridged.oxyReqPax
            paperStatus = aircraftsortieAbridged.paperStatus
            papersVersion = aircraftsortieAbridged.papersVersion
            parkingLoc = aircraftsortieAbridged.parkingLoc
            passengers = aircraftsortieAbridged.passengers
            plannedArrTime = aircraftsortieAbridged.plannedArrTime
            pprStatus = aircraftsortieAbridged.pprStatus
            primaryScl = aircraftsortieAbridged.primaryScl
            rawFileUri = aircraftsortieAbridged.rawFileUri
            reqConfig = aircraftsortieAbridged.reqConfig
            resultRemarks = aircraftsortieAbridged.resultRemarks
            rvnReq = aircraftsortieAbridged.rvnReq
            scheduleRemarks = aircraftsortieAbridged.scheduleRemarks
            secondaryScl = aircraftsortieAbridged.secondaryScl
            soe = aircraftsortieAbridged.soe
            sortieDate = aircraftsortieAbridged.sortieDate
            sourceDl = aircraftsortieAbridged.sourceDl
            tailNumber = aircraftsortieAbridged.tailNumber
            additionalProperties = aircraftsortieAbridged.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftsortieAbridged].
         *
         ...
         */
        fun build(): AircraftsortieAbridged =
    ...
    fun validate(): AircraftsortieAbridged = apply {
        if (validated) {
            return@apply
        }
