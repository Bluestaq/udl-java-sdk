...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TaiUtcGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TaiUtcGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TaiUtcGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taiUtcGetParams: TaiUtcGetParams) = apply {
            id = taiUtcGetParams.id
            firstResult = taiUtcGetParams.firstResult
            maxResults = taiUtcGetParams.maxResults
            additionalHeaders = taiUtcGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = taiUtcGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TaiUtcGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TaiUtcGetParams =
            TaiUtcGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TaiUtcGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TaiUtcGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
