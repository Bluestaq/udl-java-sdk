...
class CollectRequestFull private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectRequestFull].
         *
    ...
    /** A builder for [CollectRequestFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestFull: CollectRequestFull) =
            apply {
                classificationMarking = collectRequestFull.classificationMarking
                dataMode = collectRequestFull.dataMode
                source = collectRequestFull.source
                startTime = collectRequestFull.startTime
                type = collectRequestFull.type
                id = collectRequestFull.id
                alt = collectRequestFull.alt
                argOfPerigee = collectRequestFull.argOfPerigee
                az = collectRequestFull.az
                collectResponse = collectRequestFull.collectResponse.map { it.toMutableList() }
                createdAt = collectRequestFull.createdAt
                createdBy = collectRequestFull.createdBy
                customer = collectRequestFull.customer
                dec = collectRequestFull.dec
                duration = collectRequestFull.duration
                dwellId = collectRequestFull.dwellId
                eccentricity = collectRequestFull.eccentricity
                el = collectRequestFull.el
                elset = collectRequestFull.elset
                endTime = collectRequestFull.endTime
                epoch = collectRequestFull.epoch
                esId = collectRequestFull.esId
                extentAz = collectRequestFull.extentAz
                extentEl = collectRequestFull.extentEl
                extentRange = collectRequestFull.extentRange
                externalId = collectRequestFull.externalId
                frameRate = collectRequestFull.frameRate
                freq = collectRequestFull.freq
                freqMax = collectRequestFull.freqMax
                freqMin = collectRequestFull.freqMin
                idElset = collectRequestFull.idElset
                idManifold = collectRequestFull.idManifold
                idOnOrbit = collectRequestFull.idOnOrbit
                idParentReq = collectRequestFull.idParentReq
                idPlan = collectRequestFull.idPlan
                idSensor = collectRequestFull.idSensor
                idStateVector = collectRequestFull.idStateVector
                inclination = collectRequestFull.inclination
                integrationTime = collectRequestFull.integrationTime
                iron = collectRequestFull.iron
                irradiance = collectRequestFull.irradiance
                lat = collectRequestFull.lat
                lon = collectRequestFull.lon
                msgCreateDate = collectRequestFull.msgCreateDate
                msgType = collectRequestFull.msgType
                notes = collectRequestFull.notes
                numFrames = collectRequestFull.numFrames
                numObs = collectRequestFull.numObs
                numTracks = collectRequestFull.numTracks
                obType = collectRequestFull.obType
                onOrbit = collectRequestFull.onOrbit
                orbitRegime = collectRequestFull.orbitRegime
                orientAngle = collectRequestFull.orientAngle
                origin = collectRequestFull.origin
                origNetwork = collectRequestFull.origNetwork
                origObjectId = collectRequestFull.origObjectId
                origSensorId = collectRequestFull.origSensorId
                planIndex = collectRequestFull.planIndex
                polarization = collectRequestFull.polarization
                priority = collectRequestFull.priority
                ra = collectRequestFull.ra
                raan = collectRequestFull.raan
                range = collectRequestFull.range
                rcs = collectRequestFull.rcs
                rcsMax = collectRequestFull.rcsMax
                rcsMin = collectRequestFull.rcsMin
                reflectance = collectRequestFull.reflectance
                satNo = collectRequestFull.satNo
                scenario = collectRequestFull.scenario
                semiMajorAxis = collectRequestFull.semiMajorAxis
                spectralModel = collectRequestFull.spectralModel
                srchInc = collectRequestFull.srchInc
                srchPattern = collectRequestFull.srchPattern
                stateVector = collectRequestFull.stateVector
                stopAlt = collectRequestFull.stopAlt
                stopLat = collectRequestFull.stopLat
                stopLon = collectRequestFull.stopLon
                suffix = collectRequestFull.suffix
                tags = collectRequestFull.tags.map { it.toMutableList() }
                targetSize = collectRequestFull.targetSize
                taskCategory = collectRequestFull.taskCategory
                taskGroup = collectRequestFull.taskGroup
                taskId = collectRequestFull.taskId
                transactionId = collectRequestFull.transactionId
                trueAnomoly = collectRequestFull.trueAnomoly
                uctFollowUp = collectRequestFull.uctFollowUp
                updatedAt = collectRequestFull.updatedAt
                updatedBy = collectRequestFull.updatedBy
                visMag = collectRequestFull.visMag
                visMagMax = collectRequestFull.visMagMax
                visMagMin = collectRequestFull.visMagMin
                xAngle = collectRequestFull.xAngle
                yAngle = collectRequestFull.yAngle
                additionalProperties = collectRequestFull.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CollectRequestFull].
         *
    ...
    fun validate(): CollectRequestFull =
        apply {
            if (validated) {
              return@apply
            }
