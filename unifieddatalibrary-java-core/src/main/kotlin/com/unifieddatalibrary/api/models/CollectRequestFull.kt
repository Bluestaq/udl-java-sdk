 ...
 * sensors and/or orbital objects. Options are provided to accomodate most common sensor contact and
 * collection applications, including single sensor-object tasking, search operations, and TT&C
 * support. Multiple requests originating from a plan or schedule may be associated to a sensor plan
 * if desired.
 */
...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        collectResponse: JsonField<List<CollectResponseFull>> = JsonMissing.of(),
    ...
    /**
     * The type of this collect or contact request (DIRECTED SEARCH, DWELL, OBJECT, POL, RATE TRACK,
     * SEARCH, SOI, STARE, TTC, VOLUME SEARCH, etc.).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    /**
     * Height above WGS-84 ellipsoid (HAE), in kilometers. If an accompanying stopAlt is provided,
     * then alt value can be assumed to be the starting altitude of a volume definition.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * CollectResponses associated to request id. Read-only details (only used on detail queries,
     * not to be provided on create/update operations).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun collectResponse(): Optional<List<CollectResponseFull>> =
        collectResponse.getOptional("collectResponse")
    ...
    /**
     * The duration of the collect request, in seconds. If both duration and endTime are provided,
     ...
     * by which its orbit around another body deviates from a perfect circle.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The end time of the collect or contact request window, in ISO 8601 UTC format. If no endTime
     * or duration is provided it is assumed the request is either ongoing or that the request is
     * for a specified number of tracks (numTracks). If both duration and endTime are provided, the
     * endTime is assumed to take precedence.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     * provides theoretical Keplerian orbital elements belonging to an object of interest's manifold
    ...
    /**
     * The unique ID of the collect request record from which this request originated. This may be
     * used for cases of sensor-to-sensor tasking, such as tip/cue operations.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Unique identifier of the parent plan or schedule associated with this request. If null, this
     * request is assumed not associated with a plan or schedule.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Unique identifier of the requested/scheduled/planned sensor associated with this request. If
     * both idSensor and origSensorId are null then the request is assumed to be a general request
     * for observations or contact on an object, if specified, or an area/volume. In this case, the
    ...
    /**
     * The angle, in degrees, between the equator and the orbit plane when looking from the center
     * of the Earth. Inclination ranges from 0-180 degrees, with 0-90 representing posigrade orbits
     * and 90-180 representing retrograde orbits.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * WGS-84 longitude, in degrees. -180 to 180 degrees (negative values west of Prime Meridian).
     * If an accompanying stopLon is provided, then lon value can be assumed to be the starting
     * longitude of a volume definition.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The number of requested tracks on the target. If numTracks is not provided it is assumed to
     * indicate all possible observations every pass over the request duration or within the request
     * start/end window.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Optional type of observation (EO, IR, RADAR, RF-ACTIVE, RF-PASSIVE, OTHER) requested. This
     * field may correspond to a request of a specific sensor, or to a general non sensor specific
     * request.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     * equinoctial plane. A positive value indicates clockwise rotation about the sensor boresight
     * vector.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     * necessarily a valid sensor ID. If both idSensor and origSensorId are null then the request is
     * assumed to be a general request for observations or contact on an object, if specified, or an
    ...
    /**
     * The minimum Radar Cross-Section of the target, in m^2. If only minimum RCS is provided it is
     * assumed to be minimum reportable RCS.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Pre-coordinated code, direction, or configuration to be executed by the sensor or site for
     * this collect or contact.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The average of the periapsis and apoapsis distances, in kilometers. For circular orbits, the
     * semimajor axis is the distance between the centers of the bodies.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The stopping HAE WGS-84 height above ellipsoid (HAE), of a volume definition, in kilometers.
     * The stopAlt value is only meaningful if a (starting) alt value is provided.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The stopping WGS-84 latitude of a volume definition, in degrees. -90 to 90 degrees (negative
     * values south of equator). The stopLat value is only meaningful if a (starting) lat value is
     * provided.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * The (SSN) tasking suffix (A-Z) associated with this request. The suffix defines the amount of
     * observational data and the frequency of collection. Note that suffix definitions are sensor
     * type specific.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * The (SSN) tasking category (1-5) associated with this request. The tasking category defines
     * the priority of gathering and transmitting the requested observational data. Note that
     * category definitions are sensor type specific.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The true anomaly defines the angular position, in degrees, of the object on it's orbital path
     * as measured from the orbit focal point at epoch. The true anomaly is referenced from perigee.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The minimum estimated or expected visual magnitude of the target, in Magnitudes (M). If only
     * minimum vismag is provided it is assumed to be minimum reportable vismag.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The angular distance, in degrees, in the sensor-x direction from scan center defined by the
     * central vector. The specification of xAngle and yAngle defines a rectangle of width 2*xAngle
     * and height 2*yAngle centered about the central vector.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The angular distance, in degrees, in the sensor-y direction from scan center defined by the
     * central vector. The specification of xAngle and yAngle defines a rectangle of width 2*xAngle
     * and height 2*yAngle centered about the central vector.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     ...
     */
    @JsonProperty("extentRange") @ExcludeMissing fun _extentRange(): JsonField<Double> = extentRange
     ...
     */
    @JsonProperty("idManifold") @ExcludeMissing fun _idManifold(): JsonField<String> = idManifold
     ...
     */
    @JsonProperty("idParentReq") @ExcludeMissing fun _idParentReq(): JsonField<String> = idParentReq
     ...
     */
    @JsonProperty("irradiance") @ExcludeMissing fun _irradiance(): JsonField<Double> = irradiance
     ...
     */
    @JsonProperty("orbitRegime") @ExcludeMissing fun _orbitRegime(): JsonField<String> = orbitRegime
     ...
     */
    @JsonProperty("orientAngle") @ExcludeMissing fun _orientAngle(): JsonField<Double> = orientAngle
     ...
     */
    @JsonProperty("reflectance") @ExcludeMissing fun _reflectance(): JsonField<Double> = reflectance
     ...
     */
    @JsonProperty("srchPattern") @ExcludeMissing fun _srchPattern(): JsonField<String> = srchPattern
     ...
     */
    @JsonProperty("targetSize") @ExcludeMissing fun _targetSize(): JsonField<Double> = targetSize
     ...
     */
    @JsonProperty("taskCategory") @ExcludeMissing fun _taskCategory(): JsonField<Int> = taskCategory
     ...
     */
    @JsonProperty("trueAnomoly") @ExcludeMissing fun _trueAnomoly(): JsonField<Double> = trueAnomoly
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestFull: CollectRequestFull) = apply {
        ...
        /**
         * CollectResponses associated to request id. Read-only details (only used on detail
         * queries, not to be provided on create/update operations).
         */
        fun collectResponse(collectResponse: List<CollectResponseFull>) =
            collectResponse(JsonField.of(collectResponse))

        /**
         * Sets [Builder.collectResponse] to an arbitrary JSON value.
         *
         * You should usually call [Builder.collectResponse] with a well-typed
         * `List<CollectResponseFull>` value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun collectResponse(collectResponse: JsonField<List<CollectResponseFull>>) = apply {
         ...
         */
        fun addCollectResponse(collectResponse: CollectResponseFull) = apply {
            this.collectResponse =
                (this.collectResponse ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.dwellId] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.extentAz] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.extentEl] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.extentRange] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun extentRange(extentRange: JsonField<Double>) = apply { this.extentRange = extentRange }
         ...
         *
         * You should usually call [Builder.idParentReq] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun idParentReq(idParentReq: JsonField<String>) = apply { this.idParentReq = idParentReq }
         ...
         *
         * You should usually call [Builder.idPlan] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.iron] with a well-typed [Int] value instead. This method
         ...
         *
         * You should usually call [Builder.irradiance] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.numFrames] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.obType] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.orbitRegime] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun orbitRegime(orbitRegime: JsonField<String>) = apply { this.orbitRegime = orbitRegime }
         ...
         *
         * You should usually call [Builder.orientAngle] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun orientAngle(orientAngle: JsonField<Double>) = apply { this.orientAngle = orientAngle }
         ...
         *
         * You should usually call [Builder.planIndex] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.reflectance] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun reflectance(reflectance: JsonField<Double>) = apply { this.reflectance = reflectance }
         ...
         *
         * You should usually call [Builder.spectralModel] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.srchInc] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.srchPattern] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun srchPattern(srchPattern: JsonField<String>) = apply { this.srchPattern = srchPattern }
         ...
         *
         * You should usually call [Builder.stopAlt] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.stopLat] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.stopLon] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.targetSize] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         * value.
         */
        fun taskCategory(taskCategory: JsonField<Int>) = apply { this.taskCategory = taskCategory }
         ...
         *
         * You should usually call [Builder.trueAnomoly] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun trueAnomoly(trueAnomoly: JsonField<Double>) = apply { this.trueAnomoly = trueAnomoly }
         ...
         *
         * You should usually call [Builder.uctFollowUp] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun uctFollowUp(uctFollowUp: JsonField<Boolean>) = apply { this.uctFollowUp = uctFollowUp }
         ...
         *
         * You should usually call [Builder.xAngle] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.yAngle] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    fun validate(): CollectRequestFull = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (classificationMarking.asKnown().isPresent) 1 else 0) +
            ...
            (collectResponse.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
