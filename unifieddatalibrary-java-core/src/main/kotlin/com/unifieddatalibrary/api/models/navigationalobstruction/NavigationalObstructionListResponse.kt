...
private constructor(
    ...
    /** A builder for [NavigationalObstructionListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            navigationalObstructionListResponse: NavigationalObstructionListResponse
        ) = apply {
            classificationMarking = navigationalObstructionListResponse.classificationMarking
            cycleDate = navigationalObstructionListResponse.cycleDate
            dataMode = navigationalObstructionListResponse.dataMode
            obstacleId = navigationalObstructionListResponse.obstacleId
            obstacleType = navigationalObstructionListResponse.obstacleType
            source = navigationalObstructionListResponse.source
            id = navigationalObstructionListResponse.id
            actDelCode = navigationalObstructionListResponse.actDelCode
            airacCycle = navigationalObstructionListResponse.airacCycle
            baseAiracCycle = navigationalObstructionListResponse.baseAiracCycle
            baselineCutoffDate = navigationalObstructionListResponse.baselineCutoffDate
            boundNeLat = navigationalObstructionListResponse.boundNeLat
            boundNeLon = navigationalObstructionListResponse.boundNeLon
            boundSwLat = navigationalObstructionListResponse.boundSwLat
            boundSwLon = navigationalObstructionListResponse.boundSwLon
            countryCode = navigationalObstructionListResponse.countryCode
            createdAt = navigationalObstructionListResponse.createdAt
            createdBy = navigationalObstructionListResponse.createdBy
            cutoffDate = navigationalObstructionListResponse.cutoffDate
            dataSetRemarks = navigationalObstructionListResponse.dataSetRemarks
            deletingOrg = navigationalObstructionListResponse.deletingOrg
            derivingOrg = navigationalObstructionListResponse.derivingOrg
            directivityCode = navigationalObstructionListResponse.directivityCode
            elevation = navigationalObstructionListResponse.elevation
            elevationAcc = navigationalObstructionListResponse.elevationAcc
            externalId = navigationalObstructionListResponse.externalId
            facc = navigationalObstructionListResponse.facc
            featureCode = navigationalObstructionListResponse.featureCode
            featureDescription = navigationalObstructionListResponse.featureDescription
            featureName = navigationalObstructionListResponse.featureName
            featureType = navigationalObstructionListResponse.featureType
            heightAgl = navigationalObstructionListResponse.heightAgl
            heightAglAcc = navigationalObstructionListResponse.heightAglAcc
            heightMsl = navigationalObstructionListResponse.heightMsl
            heightMslAcc = navigationalObstructionListResponse.heightMslAcc
            horizAcc = navigationalObstructionListResponse.horizAcc
            horizDatumCode = navigationalObstructionListResponse.horizDatumCode
            initRecordDate = navigationalObstructionListResponse.initRecordDate
            keys = navigationalObstructionListResponse.keys.map { it.toMutableList() }
            lightingCode = navigationalObstructionListResponse.lightingCode
            lineNeLat = navigationalObstructionListResponse.lineNeLat
            lineNeLon = navigationalObstructionListResponse.lineNeLon
            linesFilename = navigationalObstructionListResponse.linesFilename
            lineSwLat = navigationalObstructionListResponse.lineSwLat
            lineSwLon = navigationalObstructionListResponse.lineSwLon
            minHeightAgl = navigationalObstructionListResponse.minHeightAgl
            multObs = navigationalObstructionListResponse.multObs
            nextCycleDate = navigationalObstructionListResponse.nextCycleDate
            numLines = navigationalObstructionListResponse.numLines
            numObs = navigationalObstructionListResponse.numObs
            numPoints = navigationalObstructionListResponse.numPoints
            obstacleRemarks = navigationalObstructionListResponse.obstacleRemarks
            origId = navigationalObstructionListResponse.origId
            origin = navigationalObstructionListResponse.origin
            origNetwork = navigationalObstructionListResponse.origNetwork
            ownerCountryCode = navigationalObstructionListResponse.ownerCountryCode
            pointLat = navigationalObstructionListResponse.pointLat
            pointLon = navigationalObstructionListResponse.pointLon
            pointsFilename = navigationalObstructionListResponse.pointsFilename
            processCode = navigationalObstructionListResponse.processCode
            producer = navigationalObstructionListResponse.producer
            provinceCode = navigationalObstructionListResponse.provinceCode
            quality = navigationalObstructionListResponse.quality
            rawFileUri = navigationalObstructionListResponse.rawFileUri
            revDate = navigationalObstructionListResponse.revDate
            segEndPoint = navigationalObstructionListResponse.segEndPoint
            segNum = navigationalObstructionListResponse.segNum
            segStartPoint = navigationalObstructionListResponse.segStartPoint
            sourceDate = navigationalObstructionListResponse.sourceDate
            sourceDl = navigationalObstructionListResponse.sourceDl
            surfaceMatCode = navigationalObstructionListResponse.surfaceMatCode
            transactionCode = navigationalObstructionListResponse.transactionCode
            validationCode = navigationalObstructionListResponse.validationCode
            values = navigationalObstructionListResponse.values.map { it.toMutableList() }
            vectorsFilename = navigationalObstructionListResponse.vectorsFilename
            wac = navigationalObstructionListResponse.wac
            wacInnr = navigationalObstructionListResponse.wacInnr
            additionalProperties =
                navigationalObstructionListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NavigationalObstructionListResponse].
         *
         ...
         */
        fun build(): NavigationalObstructionListResponse =
            NavigationalObstructionListResponse(
    ...
    fun validate(): NavigationalObstructionListResponse = apply {
        if (validated) {
            return@apply
        }
