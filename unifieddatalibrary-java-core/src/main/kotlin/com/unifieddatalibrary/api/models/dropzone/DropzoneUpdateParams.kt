...
/**
 * Service operation to update a single dropzone record. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class DropzoneUpdateParams
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun altCountryName(): Optional<String> = body.altCountryName()
     ...
     *   if the server responded with an unexpected value).
     */
    fun approvalDate(): Optional<OffsetDateTime> = body.approvalDate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun expirationDate(): Optional<OffsetDateTime> = body.expirationDate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun extIdentifier(): Optional<String> = body.extIdentifier()
     ...
     *   if the server responded with an unexpected value).
     */
    fun lastUpdate(): Optional<OffsetDateTime> = body.lastUpdate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun majcom(): Optional<String> = body.majcom()
     ...
     *   if the server responded with an unexpected value).
     */
    fun nearestLoc(): Optional<String> = body.nearestLoc()
     ...
     *   if the server responded with an unexpected value).
     */
    fun operationalApprovalDate(): Optional<OffsetDateTime> = body.operationalApprovalDate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun pointName(): Optional<String> = body.pointName()
     ...
     *   if the server responded with an unexpected value).
     */
    fun radius(): Optional<Double> = body.radius()
     ...
     *   if the server responded with an unexpected value).
     */
    fun recertDate(): Optional<OffsetDateTime> = body.recertDate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun remark(): Optional<String> = body.remark()
     ...
     *   if the server responded with an unexpected value).
     */
    fun stateAbbr(): Optional<String> = body.stateAbbr()
     ...
     *   if the server responded with an unexpected value).
     */
    fun stateName(): Optional<String> = body.stateName()
     ...
     */
    fun _altCountryName(): JsonField<String> = body._altCountryName()
     ...
     */
    fun _approvalDate(): JsonField<OffsetDateTime> = body._approvalDate()
     ...
     */
    fun _expirationDate(): JsonField<OffsetDateTime> = body._expirationDate()
     ...
     */
    fun _extIdentifier(): JsonField<String> = body._extIdentifier()
     ...
     */
    fun _lastUpdate(): JsonField<OffsetDateTime> = body._lastUpdate()
     ...
     */
    fun _majcom(): JsonField<String> = body._majcom()
     ...
     */
    fun _nearestLoc(): JsonField<String> = body._nearestLoc()
     ...
     * unexpected type.
     */
    fun _operationalApprovalDate(): JsonField<OffsetDateTime> = body._operationalApprovalDate()
     ...
     */
    fun _pointName(): JsonField<String> = body._pointName()
     ...
     */
    fun _radius(): JsonField<Double> = body._radius()
     ...
     */
    fun _recertDate(): JsonField<OffsetDateTime> = body._recertDate()
     ...
     */
    fun _remark(): JsonField<String> = body._remark()
     ...
     */
    fun _stateAbbr(): JsonField<String> = body._stateAbbr()
     ...
     */
    fun _stateName(): JsonField<String> = body._stateName()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DropzoneUpdateParams].
         *
    ...
    /** A builder for [DropzoneUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneUpdateParams: DropzoneUpdateParams) = apply {
            pathId = dropzoneUpdateParams.pathId
            body = dropzoneUpdateParams.body.toBuilder()
            additionalHeaders = dropzoneUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = dropzoneUpdateParams.additionalQueryParams.toBuilder()
        }
         ...
         * Specifies the country name associated with the source provided alternate country code.
         */
        fun altCountryName(altCountryName: String) = apply { body.altCountryName(altCountryName) }
        ...
        fun altCountryName(altCountryName: JsonField<String>) = apply {
            body.altCountryName(altCountryName)
        }
         ...
         * precision.
         */
        fun approvalDate(approvalDate: OffsetDateTime) = apply { body.approvalDate(approvalDate) }
        ...
        /** The country name of the location for the drop zone. */
        fun countryName(countryName: String) = apply { body.countryName(countryName) }
         ...
         * value.
         */
        fun countryName(countryName: JsonField<String>) = apply { body.countryName(countryName) }
         ...
         * precision.
         */
        fun expirationDate(expirationDate: OffsetDateTime) = apply {
        ...
        /** The external identifier assigned to the drop zone. */
        fun extIdentifier(extIdentifier: String) = apply { body.extIdentifier(extIdentifier) }
        ...
        fun extIdentifier(extIdentifier: JsonField<String>) = apply {
            body.extIdentifier(extIdentifier)
        }
         ...
         * precision.
         */
        fun lastUpdate(lastUpdate: OffsetDateTime) = apply { body.lastUpdate(lastUpdate) }
        ...
        /** The Major Command (MAJCOM) responsible for management of the drop zone. */
        fun majcom(majcom: String) = apply { body.majcom(majcom) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun majcom(majcom: JsonField<String>) = apply { body.majcom(majcom) }

        /** The nearest reference location to the drop zone. */
        fun nearestLoc(nearestLoc: String) = apply { body.nearestLoc(nearestLoc) }
         ...
         * value.
         */
        fun nearestLoc(nearestLoc: JsonField<String>) = apply { body.nearestLoc(nearestLoc) }
         ...
         */
        fun operationalApprovalDate(operationalApprovalDate: OffsetDateTime) = apply {
            body.operationalApprovalDate(operationalApprovalDate)
        }
        ...
        /** The name assigned to the drop zone point. */
        fun pointName(pointName: String) = apply { body.pointName(pointName) }
         ...
         * value.
         */
        fun pointName(pointName: JsonField<String>) = apply { body.pointName(pointName) }

        /** The radius dimension of the drop zone in meters for circular drop zones. */
        fun radius(radius: Double) = apply { body.radius(radius) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun radius(radius: JsonField<Double>) = apply { body.radius(radius) }

        /**
         * The date the drop zone was recertified, in ISO 8601 UTC format with millisecond
         * precision.
         */
        fun recertDate(recertDate: OffsetDateTime) = apply { body.recertDate(recertDate) }
        ...
        fun recertDate(recertDate: JsonField<OffsetDateTime>) = apply {
            body.recertDate(recertDate)
        }

        /** Remarks concerning the drop zone. */
        fun remark(remark: String) = apply { body.remark(remark) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun remark(remark: JsonField<String>) = apply { body.remark(remark) }
        ...
        /** The US alphabetical code for the state where the drop zone is located. */
        fun stateAbbr(stateAbbr: String) = apply { body.stateAbbr(stateAbbr) }
         ...
         * value.
         */
        fun stateAbbr(stateAbbr: JsonField<String>) = apply { body.stateAbbr(stateAbbr) }

        /** The name of the state where the drop zone is located. */
        fun stateName(stateName: String) = apply { body.stateName(stateName) }
         ...
         * value.
         */
        fun stateName(stateName: JsonField<String>) = apply { body.stateName(stateName) }
        ...
        /** The width dimension of the drop zone in meters for non-circular drop zones. */
        fun width(width: Double) = apply { body.width(width) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun width(width: JsonField<Double>) = apply { body.width(width) }

        /** The identifier of the Zone Availability Report (ZAR) for the drop zone. */
        fun zarId(zarId: String) = apply { body.zarId(zarId) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun zarId(zarId: JsonField<String>) = apply { body.zarId(zarId) }
        ...
        /**
         * Returns an immutable instance of [DropzoneUpdateParams].
         *
         ...
         */
        fun build(): DropzoneUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DropzoneUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "DropzoneUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
