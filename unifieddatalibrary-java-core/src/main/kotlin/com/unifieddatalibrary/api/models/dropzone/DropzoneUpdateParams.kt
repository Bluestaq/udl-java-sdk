...
class DropzoneUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneUpdateParams: DropzoneUpdateParams) =
            apply {
        ...
        /** The external identifier assigned to the drop zone. */
        fun extIdentifier(extIdentifier: String) =
            apply {
        ...
        /** Last time the drop zone information was updated, in ISO 8601 UTC format with millisecond precision. */
        fun lastUpdate(lastUpdate: OffsetDateTime) =
            apply {
        ...
        /** The nearest reference location to the drop zone. */
        fun nearestLoc(nearestLoc: String) =
            apply {
                body.nearestLoc(nearestLoc)
            }
        ...
        /** The name assigned to the drop zone point. */
        fun pointName(pointName: String) =
            apply {
        ...
        /** The date the drop zone was recertified, in ISO 8601 UTC format with millisecond precision. */
        fun recertDate(recertDate: OffsetDateTime) =
            apply {
        ...
        /** The US alphabetical code for the state where the drop zone is located. */
        fun stateAbbr(stateAbbr: String) =
            apply {
        ...
        /** The name of the state where the drop zone is located. */
        fun stateName(stateName: String) =
            apply {
        ...
        /** The date the drop zone survey was performed, in ISO 8601 UTC format with millisecond precision. */
        fun surveyDate(surveyDate: OffsetDateTime) =
            apply {
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (altCountryCode.asKnown().isPresent) 1 else 0) + (if (altCountryName.asKnown().isPresent) 1 else 0) + (if (approvalDate.asKnown().isPresent) 1 else 0) + (if (code.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (if (countryName.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (expirationDate.asKnown().isPresent) 1 else 0) + (if (extIdentifier.asKnown().isPresent) 1 else 0) + (if (idSite.asKnown().isPresent) 1 else 0) + (if (lastUpdate.asKnown().isPresent) 1 else 0) + (if (length.asKnown().isPresent) 1 else 0) + (if (majcom.asKnown().isPresent) 1 else 0) + (if (nearestLoc.asKnown().isPresent) 1 else 0) + (if (operationalApprovalDate.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (pointName.asKnown().isPresent) 1 else 0) + (if (radius.asKnown().isPresent) 1 else 0) + (if (recertDate.asKnown().isPresent) 1 else 0) + (if (remark.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (stateAbbr.asKnown().isPresent) 1 else 0) + (if (stateName.asKnown().isPresent) 1 else 0) + (if (surveyDate.asKnown().isPresent) 1 else 0) + (if (width.asKnown().isPresent) 1 else 0) + (if (zarId.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "DropzoneUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
