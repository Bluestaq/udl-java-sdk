...
class CommRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): CommRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commRetrieveParams: CommRetrieveParams) =
            apply {
    ...
    override fun toString() = "CommRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
