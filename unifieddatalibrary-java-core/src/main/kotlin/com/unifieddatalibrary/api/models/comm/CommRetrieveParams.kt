...
/**
 * Service operation to get a single Comm record by its unique ID passed as a path parameter. A Comm
 * is an on-orbit communications payload, including supporting data such as transponders and
 * channels, etc.
 */
class CommRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CommRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CommRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commRetrieveParams: CommRetrieveParams) = apply {
            id = commRetrieveParams.id
            firstResult = commRetrieveParams.firstResult
            maxResults = commRetrieveParams.maxResults
            additionalHeaders = commRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = commRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CommRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommRetrieveParams =
            CommRetrieveParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CommRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "CommRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
