 ...
 */
class SoiObservationSetGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SoiObservationSetGetParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [SoiObservationSetGetParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SoiObservationSetGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(soiObservationSetGetParams: SoiObservationSetGetParams) = apply {
            id = soiObservationSetGetParams.id
            firstResult = soiObservationSetGetParams.firstResult
            maxResults = soiObservationSetGetParams.maxResults
            additionalHeaders = soiObservationSetGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = soiObservationSetGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SoiObservationSetGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SoiObservationSetGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SoiObservationSetGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SoiObservationSetGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
