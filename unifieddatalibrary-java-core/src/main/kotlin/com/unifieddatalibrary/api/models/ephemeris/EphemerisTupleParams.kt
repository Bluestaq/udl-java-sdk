...
class EphemerisTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EphemerisTupleParams].
         *
    ...
    /** A builder for [EphemerisTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisTupleParams: EphemerisTupleParams) =
            apply {
                columns = ephemerisTupleParams.columns
                esId = ephemerisTupleParams.esId
                firstResult = ephemerisTupleParams.firstResult
                maxResults = ephemerisTupleParams.maxResults
                additionalHeaders = ephemerisTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = ephemerisTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EphemerisTupleParams].
         *
         ...
         */
        fun build(): EphemerisTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EphemerisTupleParams && columns == other.columns && esId == other.esId && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, esId, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "EphemerisTupleParams{columns=$columns, esId=$esId, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
