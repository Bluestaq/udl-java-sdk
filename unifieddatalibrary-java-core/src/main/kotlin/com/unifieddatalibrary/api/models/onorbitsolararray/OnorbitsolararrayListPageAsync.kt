...
class OnorbitsolararrayListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<OnorbitsolararrayListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitsolararrayListPageAsync: OnorbitsolararrayListPageAsync) = apply {
        ...
        fun service(service: OnorbitsolararrayServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitsolararrayListPageAsync &&
    ...
    override fun toString() =
        "OnorbitsolararrayListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
