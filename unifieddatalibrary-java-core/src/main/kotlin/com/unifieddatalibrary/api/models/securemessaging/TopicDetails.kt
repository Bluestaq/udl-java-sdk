...
class TopicDetails private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("udlOpenAPISchema") @ExcludeMissing udlOpenAPISchema: JsonField<String> = JsonMissing.of()
    ) : this(
      description,
      maxPos,
      minPos,
    ...
    @JsonProperty("maxPos")
    @ExcludeMissing
    fun _maxPos(): JsonField<Long> = maxPos
    ...
    @JsonProperty("minPos")
    @ExcludeMissing
    fun _minPos(): JsonField<Long> = minPos
     ...
     *
     * Unlike [udlOpenAPISchema], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(topicDetails: TopicDetails) =
            apply {
         ...
         *
         * You should usually call [Builder.maxPos] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maxPos(maxPos: JsonField<Long>) =
            apply {
                this.maxPos = maxPos
            }
         ...
         *
         * You should usually call [Builder.minPos] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun minPos(minPos: JsonField<Long>) =
            apply {
                this.minPos = minPos
            }
        ...
        /** The UDL schema that the objects in this topic apply to. */
        fun udlOpenAPISchema(udlOpenAPISchema: String) = udlOpenAPISchema(JsonField.of(udlOpenAPISchema))

        /**
         * Sets [Builder.udlOpenAPISchema] to an arbitrary JSON value.
         *
         * You should usually call [Builder.udlOpenAPISchema] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun udlOpenAPISchema(udlOpenAPISchema: JsonField<String>) =
            apply {
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (description.asKnown().isPresent) 1 else 0) + (if (maxPos.asKnown().isPresent) 1 else 0) + (if (minPos.asKnown().isPresent) 1 else 0) + (if (topic.asKnown().isPresent) 1 else 0) + (if (udlOpenAPISchema.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "TopicDetails{description=$description, maxPos=$maxPos, minPos=$minPos, topic=$topic, udlOpenAPISchema=$udlOpenAPISchema, additionalProperties=$additionalProperties}"
}
