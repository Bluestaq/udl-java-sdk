...
class AiListPageAsync private constructor(
    ...
    fun autoPager(): AutoPagerAsync<AisAbridged> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aiListPageAsync: AiListPageAsync) =
            apply {
        ...
        fun service(service: AiServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: AiListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<AisAbridged>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "AiListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
