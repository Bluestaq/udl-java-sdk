...
class EcpsdrCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpsdrCreateBulkParams].
         *
    ...
    /** A builder for [EcpsdrCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrCreateBulkParams: EcpsdrCreateBulkParams) =
            apply {
                body = ecpsdrCreateBulkParams.body.toMutableList()
                additionalHeaders = ecpsdrCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = ecpsdrCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EcpsdrCreateBulkParams].
         *
         ...
         */
        fun build(): EcpsdrCreateBulkParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("transientData") @ExcludeMissing private val transientData: JsonField<List<Int>>,
        ...
        @ExcludeMissing
        fun _asl5VCurrMon(): JsonField<Int> = asl5VCurrMon
        ...
        @ExcludeMissing
        fun _cdsPlateVMon(): JsonField<Int> = cdsPlateVMon
        ...
        @ExcludeMissing
        fun _cdsRefVMon(): JsonField<Int> = cdsRefVMon
        ...
        @ExcludeMissing
        fun _cdsThreshold(): JsonField<Int> = cdsThreshold
        ...
        @ExcludeMissing
        fun _cdsThrottle(): JsonField<Int> = cdsThrottle
        ...
        @ExcludeMissing
        fun _checksum(): JsonField<Int> = checksum
         ...
         */
        @JsonProperty("dosBias")
        @ExcludeMissing
        fun _dosBias(): JsonField<Int> = dosBias
        ...
        @ExcludeMissing
        fun _dsl5VCurrMon(): JsonField<Int> = dsl5VCurrMon
        ...
        @JsonProperty("hiLetL")
        @ExcludeMissing
        fun _hiLetL(): JsonField<Int> = hiLetL
        ...
        @JsonProperty("hiLetM")
        @ExcludeMissing
        fun _hiLetM(): JsonField<Int> = hiLetM
         ...
         */
        @JsonProperty("lowLetL")
        @ExcludeMissing
        fun _lowLetL(): JsonField<Int> = lowLetL
         ...
         */
        @JsonProperty("lowLetM")
        @ExcludeMissing
        fun _lowLetM(): JsonField<Int> = lowLetM
         ...
         */
        @JsonProperty("medLet1L")
        @ExcludeMissing
        fun _medLet1L(): JsonField<Int> = medLet1L
         ...
         */
        @JsonProperty("medLet1M")
        @ExcludeMissing
        fun _medLet1M(): JsonField<Int> = medLet1M
         ...
         */
        @JsonProperty("medLet2L")
        @ExcludeMissing
        fun _medLet2L(): JsonField<Int> = medLet2L
         ...
         */
        @JsonProperty("medLet2M")
        @ExcludeMissing
        fun _medLet2M(): JsonField<Int> = medLet2M
         ...
         */
        @JsonProperty("medLet3L")
        @ExcludeMissing
        fun _medLet3L(): JsonField<Int> = medLet3L
         ...
         */
        @JsonProperty("medLet3M")
        @ExcludeMissing
        fun _medLet3M(): JsonField<Int> = medLet3M
         ...
         */
        @JsonProperty("medLet4L")
        @ExcludeMissing
        fun _medLet4L(): JsonField<Int> = medLet4L
         ...
         */
        @JsonProperty("medLet4M")
        @ExcludeMissing
        fun _medLet4M(): JsonField<Int> = medLet4M
        ...
        @JsonProperty("mpTemp")
        @ExcludeMissing
        fun _mpTemp(): JsonField<Int> = mpTemp
         ...
         */
        @JsonProperty("pd1SigLev")
        @ExcludeMissing
        fun _pd1SigLev(): JsonField<Int> = pd1SigLev
         ...
         */
        @JsonProperty("pd2SigLev")
        @ExcludeMissing
        fun _pd2SigLev(): JsonField<Int> = pd2SigLev
         ...
         */
        @JsonProperty("psTempMon")
        @ExcludeMissing
        fun _psTempMon(): JsonField<Int> = psTempMon
        ...
        @ExcludeMissing
        fun _retransmit(): JsonField<Boolean> = retransmit
         ...
         */
        @JsonProperty("senMode")
        @ExcludeMissing
        fun _senMode(): JsonField<String> = senMode
         ...
         */
        @JsonProperty("surfDosH")
        @ExcludeMissing
        fun _surfDosH(): JsonField<Int> = surfDosH
         ...
         */
        @JsonProperty("surfDosL")
        @ExcludeMissing
        fun _surfDosL(): JsonField<Int> = surfDosL
         ...
         */
        @JsonProperty("surfDosM")
        @ExcludeMissing
        fun _surfDosM(): JsonField<Int> = surfDosM
        ...
        @ExcludeMissing
        fun _surfDosStat(): JsonField<Int> = surfDosStat
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    type = body.type
                    id = body.id
                    asl5VCurrMon = body.asl5VCurrMon
                    cdsPlateVMon = body.cdsPlateVMon
                    cdsRefVMon = body.cdsRefVMon
                    cdsThreshold = body.cdsThreshold
                    cdsThrottle = body.cdsThrottle
                    checksum = body.checksum
                    createdAt = body.createdAt
                    createdBy = body.createdBy
                    dosBias = body.dosBias
                    dsl5VCurrMon = body.dsl5VCurrMon
                    esdTrigCountH = body.esdTrigCountH
                    esdTrigCountL = body.esdTrigCountL
                    hiLetL = body.hiLetL
                    hiLetM = body.hiLetM
                    idOnOrbit = body.idOnOrbit
                    idSensor = body.idSensor
                    lowLetL = body.lowLetL
                    lowLetM = body.lowLetM
                    medLet1L = body.medLet1L
                    medLet1M = body.medLet1M
                    medLet2L = body.medLet2L
                    medLet2M = body.medLet2M
                    medLet3L = body.medLet3L
                    medLet3M = body.medLet3M
                    medLet4L = body.medLet4L
                    medLet4M = body.medLet4M
                    mpTemp = body.mpTemp
                    obTime = body.obTime
                    origin = body.origin
                    ...
                    pd1SigLev = body.pd1SigLev
                    pd2SigLev = body.pd2SigLev
                    psTempMon = body.psTempMon
                    retransmit = body.retransmit
                    satNo = body.satNo
                    senMode = body.senMode
                    surfDosChargeH = body.surfDosChargeH
                    surfDosChargeL = body.surfDosChargeL
                    surfDosH = body.surfDosH
                    surfDosL = body.surfDosL
                    surfDosM = body.surfDosM
             ...
             *
             * You should usually call [Builder.asl5VCurrMon] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun asl5VCurrMon(asl5VCurrMon: JsonField<Int>) =
                apply {
                    this.asl5VCurrMon = asl5VCurrMon
                }
             ...
             *
             * You should usually call [Builder.cdsPlateVMon] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun cdsPlateVMon(cdsPlateVMon: JsonField<Int>) =
                apply {
                    this.cdsPlateVMon = cdsPlateVMon
                }
             ...
             *
             * You should usually call [Builder.cdsRefVMon] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun cdsRefVMon(cdsRefVMon: JsonField<Int>) =
                apply {
                    this.cdsRefVMon = cdsRefVMon
                }
             ...
             *
             * You should usually call [Builder.cdsThreshold] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun cdsThreshold(cdsThreshold: JsonField<Int>) =
                apply {
                    this.cdsThreshold = cdsThreshold
                }
             ...
             *
             * You should usually call [Builder.cdsThrottle] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun cdsThrottle(cdsThrottle: JsonField<Int>) =
                apply {
                    this.cdsThrottle = cdsThrottle
                }
             ...
             *
             * You should usually call [Builder.checksum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun checksum(checksum: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.dosBias] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dosBias(dosBias: JsonField<Int>) =
                apply {
                    this.dosBias = dosBias
                }
             ...
             *
             * You should usually call [Builder.dsl5VCurrMon] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dsl5VCurrMon(dsl5VCurrMon: JsonField<Int>) =
                apply {
                    this.dsl5VCurrMon = dsl5VCurrMon
                }
             ...
             *
             * You should usually call [Builder.esdTrigCountH] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun esdTrigCountH(esdTrigCountH: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.esdTrigCountL] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun esdTrigCountL(esdTrigCountL: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.hiLetL] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun hiLetL(hiLetL: JsonField<Int>) =
                apply {
                    this.hiLetL = hiLetL
                }
             ...
             *
             * You should usually call [Builder.hiLetM] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun hiLetM(hiLetM: JsonField<Int>) =
                apply {
                    this.hiLetM = hiLetM
                }
             ...
             *
             * You should usually call [Builder.lowLetL] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lowLetL(lowLetL: JsonField<Int>) =
                apply {
                    this.lowLetL = lowLetL
                }
             ...
             *
             * You should usually call [Builder.lowLetM] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lowLetM(lowLetM: JsonField<Int>) =
                apply {
                    this.lowLetM = lowLetM
                }
             ...
             *
             * You should usually call [Builder.medLet1L] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun medLet1L(medLet1L: JsonField<Int>) =
                apply {
                    this.medLet1L = medLet1L
                }
             ...
             *
             * You should usually call [Builder.medLet1M] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun medLet1M(medLet1M: JsonField<Int>) =
                apply {
                    this.medLet1M = medLet1M
                }
             ...
             *
             * You should usually call [Builder.medLet2L] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun medLet2L(medLet2L: JsonField<Int>) =
                apply {
                    this.medLet2L = medLet2L
                }
             ...
             *
             * You should usually call [Builder.medLet2M] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun medLet2M(medLet2M: JsonField<Int>) =
                apply {
                    this.medLet2M = medLet2M
                }
             ...
             *
             * You should usually call [Builder.medLet3L] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun medLet3L(medLet3L: JsonField<Int>) =
                apply {
                    this.medLet3L = medLet3L
                }
             ...
             *
             * You should usually call [Builder.medLet3M] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun medLet3M(medLet3M: JsonField<Int>) =
                apply {
                    this.medLet3M = medLet3M
                }
             ...
             *
             * You should usually call [Builder.medLet4L] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun medLet4L(medLet4L: JsonField<Int>) =
                apply {
                    this.medLet4L = medLet4L
                }
             ...
             *
             * You should usually call [Builder.medLet4M] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun medLet4M(medLet4M: JsonField<Int>) =
                apply {
                    this.medLet4M = medLet4M
                }
             ...
             *
             * You should usually call [Builder.mpTemp] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun mpTemp(mpTemp: JsonField<Int>) =
                apply {
                    this.mpTemp = mpTemp
                }
             ...
             *
             * You should usually call [Builder.pd1SigLev] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pd1SigLev(pd1SigLev: JsonField<Int>) =
                apply {
                    this.pd1SigLev = pd1SigLev
                }
             ...
             *
             * You should usually call [Builder.pd2SigLev] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pd2SigLev(pd2SigLev: JsonField<Int>) =
                apply {
                    this.pd2SigLev = pd2SigLev
                }
             ...
             *
             * You should usually call [Builder.psTempMon] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun psTempMon(psTempMon: JsonField<Int>) =
                apply {
                    this.psTempMon = psTempMon
                }
             ...
             *
             * You should usually call [Builder.retransmit] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun retransmit(retransmit: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.senMode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun senMode(senMode: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.surfDosChargeH] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun surfDosChargeH(surfDosChargeH: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.surfDosChargeL] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun surfDosChargeL(surfDosChargeL: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.surfDosH] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun surfDosH(surfDosH: JsonField<Int>) =
                apply {
                    this.surfDosH = surfDosH
                }
             ...
             *
             * You should usually call [Builder.surfDosL] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun surfDosL(surfDosL: JsonField<Int>) =
                apply {
                    this.surfDosL = surfDosL
                }
             ...
             *
             * You should usually call [Builder.surfDosM] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun surfDosM(surfDosM: JsonField<Int>) =
                apply {
                    this.surfDosM = surfDosM
                }
             ...
             *
             * You should usually call [Builder.surfDosStat] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun surfDosStat(surfDosStat: JsonField<Int>) =
                apply {
                    this.surfDosStat = surfDosStat
                }
             ...
             *
             * You should usually call [Builder.transientData] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun transientData(transientData: JsonField<List<Int>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addTransientData(transientData: Int) =
                apply {
                    this.transientData = (this.transientData ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.vRef] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun vRef(vRef: JsonField<Int>) =
                apply {
                    this.vRef = vRef
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (msgTime.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (asl5VCurrMon.asKnown().isPresent) 1 else 0) + (if (cdsPlateVMon.asKnown().isPresent) 1 else 0) + (if (cdsRefVMon.asKnown().isPresent) 1 else 0) + (if (cdsThreshold.asKnown().isPresent) 1 else 0) + (if (cdsThrottle.asKnown().isPresent) 1 else 0) + (if (checksum.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (dosBias.asKnown().isPresent) 1 else 0) + (if (dsl5VCurrMon.asKnown().isPresent) 1 else 0) + (if (esdTrigCountH.asKnown().isPresent) 1 else 0) + (if (esdTrigCountL.asKnown().isPresent) 1 else 0) + (if (hiLetL.asKnown().isPresent) 1 else 0) + (if (hiLetM.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (lowLetL.asKnown().isPresent) 1 else 0) + (if (lowLetM.asKnown().isPresent) 1 else 0) + (if (medLet1L.asKnown().isPresent) 1 else 0) + (if (medLet1M.asKnown().isPresent) 1 else 0) + (if (medLet2L.asKnown().isPresent) 1 else 0) + (if (medLet2M.asKnown().isPresent) 1 else 0) + (if (medLet3L.asKnown().isPresent) 1 else 0) + (if (medLet3M.asKnown().isPresent) 1 else 0) + (if (medLet4L.asKnown().isPresent) 1 else 0) + (if (medLet4M.asKnown().isPresent) 1 else 0) + (if (mpTemp.asKnown().isPresent) 1 else 0) + (if (obTime.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (pd1SigLev.asKnown().isPresent) 1 else 0) + (if (pd2SigLev.asKnown().isPresent) 1 else 0) + (if (psTempMon.asKnown().isPresent) 1 else 0) + (if (retransmit.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (senMode.asKnown().isPresent) 1 else 0) + (if (surfDosChargeH.asKnown().isPresent) 1 else 0) + (if (surfDosChargeL.asKnown().isPresent) 1 else 0) + (if (surfDosH.asKnown().isPresent) 1 else 0) + (if (surfDosL.asKnown().isPresent) 1 else 0) + (if (surfDosM.asKnown().isPresent) 1 else 0) + (if (surfDosStat.asKnown().isPresent) 1 else 0) + (transientData.asKnown().getOrNull()?.size ?: 0) + (if (vRef.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EcpsdrCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "EcpsdrCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
