...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiteListResponse].
         *
    ...
    /** A builder for [SiteListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteListResponse: SiteListResponse) = apply {
            classificationMarking = siteListResponse.classificationMarking
            dataMode = siteListResponse.dataMode
            name = siteListResponse.name
            source = siteListResponse.source
            id = siteListResponse.id
            activity = siteListResponse.activity
            airDefArea = siteListResponse.airDefArea
            allegiance = siteListResponse.allegiance
            altAllegiance = siteListResponse.altAllegiance
            beNumber = siteListResponse.beNumber
            catCode = siteListResponse.catCode
            catText = siteListResponse.catText
            classRating = siteListResponse.classRating
            condition = siteListResponse.condition
            conditionAvail = siteListResponse.conditionAvail
            coord = siteListResponse.coord
            coordDatum = siteListResponse.coordDatum
            coordDerivAcc = siteListResponse.coordDerivAcc
            createdAt = siteListResponse.createdAt
            createdBy = siteListResponse.createdBy
            elevMsl = siteListResponse.elevMsl
            elevMslConfLvl = siteListResponse.elevMslConfLvl
            elevMslDerivAcc = siteListResponse.elevMslDerivAcc
            eval = siteListResponse.eval
            faa = siteListResponse.faa
            fpa = siteListResponse.fpa
            functPrimary = siteListResponse.functPrimary
            geoArea = siteListResponse.geoArea
            geoidalMslSep = siteListResponse.geoidalMslSep
            grade = siteListResponse.grade
            iata = siteListResponse.iata
            icao = siteListResponse.icao
            ident = siteListResponse.ident
            idEntity = siteListResponse.idEntity
            idParentSite = siteListResponse.idParentSite
            lzUsage = siteListResponse.lzUsage
            maxRunwayLength = siteListResponse.maxRunwayLength
            milGrid = siteListResponse.milGrid
            milGridSys = siteListResponse.milGridSys
            msnPrimary = siteListResponse.msnPrimary
            msnPrimarySpec = siteListResponse.msnPrimarySpec
            notes = siteListResponse.notes
            nucCap = siteListResponse.nucCap
            operStatus = siteListResponse.operStatus
            origin = siteListResponse.origin
            origLzId = siteListResponse.origLzId
            origNetwork = siteListResponse.origNetwork
            origSiteId = siteListResponse.origSiteId
            osuffix = siteListResponse.osuffix
            pin = siteListResponse.pin
            polSubdiv = siteListResponse.polSubdiv
            popArea = siteListResponse.popArea
            popAreaProx = siteListResponse.popAreaProx
            recStatus = siteListResponse.recStatus
            referenceDoc = siteListResponse.referenceDoc
            resProd = siteListResponse.resProd
            reviewDate = siteListResponse.reviewDate
            runways = siteListResponse.runways
            symCode = siteListResponse.symCode
            type = siteListResponse.type
            usage = siteListResponse.usage
            utm = siteListResponse.utm
            vegHt = siteListResponse.vegHt
            vegType = siteListResponse.vegType
            wac = siteListResponse.wac
            additionalProperties = siteListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SiteListResponse].
         *
    ...
    fun validate(): SiteListResponse = apply {
        if (validated) {
            return@apply
        }
