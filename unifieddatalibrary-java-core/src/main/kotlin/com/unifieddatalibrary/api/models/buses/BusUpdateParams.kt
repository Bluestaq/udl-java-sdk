...
class BusUpdateParams private constructor(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun telemetryTrackingManufacturerOrgId(): Optional<String> = body.telemetryTrackingManufacturerOrgId()
     ...
     */
    fun _telemetryTrackingManufacturerOrgId(): JsonField<String> = body._telemetryTrackingManufacturerOrgId()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BusUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(busUpdateParams: BusUpdateParams) =
            apply {
                pathId = busUpdateParams.pathId
                body = busUpdateParams.body.toBuilder()
                additionalHeaders = busUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = busUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Attitude and Orbital Control Notes/description for the bus. */
        fun aocsNotes(aocsNotes: String) =
            apply {
                body.aocsNotes(aocsNotes)
            }
        ...
        /** Average mass of this bus without payloads or fuel, in kilograms. */
        fun avgDryMass(avgDryMass: Double) =
            apply {
                body.avgDryMass(avgDryMass)
            }
        ...
        /** Average mass of this bus with fuel, but without payloads, in kilograms. */
        fun avgWetMass(avgWetMass: Double) =
            apply {
                body.avgWetMass(avgWetMass)
            }
        ...
        /** Mass category of this bus (e.g. 1 - 10 kg: Nanosatellite, 10 - 100 kg: Microsatellite, 100 - 500 kg: Minisatellite, 1000 - 2500kg: Medium satellite, etc.). */
        fun massCategory(massCategory: String) =
            apply {
        ...
        /** Maximum mass of this bus without payloads or fuel, in kilograms. */
        fun maxDryMass(maxDryMass: Double) =
            apply {
                body.maxDryMass(maxDryMass)
            }
        ...
        /** Maximum mass of this bus with fuel, but without payloads, in kilograms. */
        fun maxWetMass(maxWetMass: Double) =
            apply {
                body.maxWetMass(maxWetMass)
            }
        ...
        /** Median mass of this bus without payloads or fuel, in kilograms. */
        fun medianDryMass(medianDryMass: Double) =
            apply {
        ...
        /** Median mass of this bus with fuel, but without payloads, in kilograms. */
        fun medianWetMass(medianWetMass: Double) =
            apply {
        ...
        /** Minimum mass of this bus without payloads or fuel, in kilograms. */
        fun minDryMass(minDryMass: Double) =
            apply {
                body.minDryMass(minDryMass)
            }
        ...
        /** Minimum mass of this bus with fuel, but without payloads, in kilograms. */
        fun minWetMass(minWetMass: Double) =
            apply {
                body.minWetMass(minWetMass)
            }
        ...
        /** The number of orbit types this bus can support. */
        fun numOrbitType(numOrbitType: Int) =
            apply {
                body.numOrbitType(numOrbitType)
            }
        ...
        /** Array of orbit types this bus can support (e.g. GEO, LEO, etc.). Must contain the same number of elements as the value of numOrbitType. */
        fun orbitTypes(orbitTypes: List<String>) =
            apply {
                body.orbitTypes(orbitTypes)
            }
        ...
        /** The volume available on this bus for payloads, in cubic meters. */
        fun payloadVolume(payloadVolume: Double) =
            apply {
        ...
        /** Power category of this bus (e.g. 0-1kW low power, etc). */
        fun powerCategory(powerCategory: String) =
            apply {
        ...
        /**
         * Returns an immutable instance of [BusUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BusUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "BusUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
