...
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun altCode(): Optional<String> = body.altCode()
     ...
     *   if the server responded with an unexpected value).
     */
    fun shortCode(): Optional<String> = body.shortCode()
     ...
     */
    fun _altCode(): JsonField<String> = body._altCode()
     ...
     */
    fun _shortCode(): JsonField<String> = body._shortCode()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteUpdateParams].
         *
    ...
    /** A builder for [LaunchSiteUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteUpdateParams: LaunchSiteUpdateParams) = apply {
            pathId = launchSiteUpdateParams.pathId
            body = launchSiteUpdateParams.body.toBuilder()
            additionalHeaders = launchSiteUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = launchSiteUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Alternate launch site code. */
        fun altCode(altCode: String) = apply { body.altCode(altCode) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun altCode(altCode: JsonField<String>) = apply { body.altCode(altCode) }
        ...
        /** Abbreviated short name for the launch site. */
        fun shortCode(shortCode: String) = apply { body.shortCode(shortCode) }
         ...
         * value.
         */
        fun shortCode(shortCode: JsonField<String>) = apply { body.shortCode(shortCode) }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteUpdateParams].
         *
         ...
         */
        fun build(): LaunchSiteUpdateParams =
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            shortCode: JsonField<String> = JsonMissing.of(),
        ) : this(
            classificationMarking,
            code,
            dataMode,
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.altCode] to an arbitrary JSON value.
             *
             * You should usually call [Builder.altCode] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && code == other.code && dataMode == other.dataMode && name == other.name && source == other.source && bodyId == other.bodyId && altCode == other.altCode && createdAt == other.createdAt && createdBy == other.createdBy && idSite == other.idSite && origin == other.origin && origNetwork == other.origNetwork && shortCode == other.shortCode && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, code, dataMode, name, source, bodyId, altCode, createdAt, createdBy, idSite, origin, origNetwork, shortCode, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{classificationMarking=$classificationMarking, code=$code, dataMode=$dataMode, name=$name, source=$source, bodyId=$bodyId, altCode=$altCode, createdAt=$createdAt, createdBy=$createdBy, idSite=$idSite, origin=$origin, origNetwork=$origNetwork, shortCode=$shortCode, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LaunchSiteUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "LaunchSiteUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
