...
package com.unifieddatalibrary.api.models.airoperations.aircraftsorties.history
...
private constructor(
    ...
    private val items: List<AircraftsortieFull>,
) : Page<AircraftsortieFull> {
    ...
    fun autoPager(): AutoPager<AircraftsortieFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<AircraftsortieFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<AircraftsortieFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<AircraftsortieFull>) = apply { this.items = items }
