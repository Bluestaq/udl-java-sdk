...
class DiffOfArrivalTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiffOfArrivalTupleParams].
         *
    ...
    /** A builder for [DiffOfArrivalTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffOfArrivalTupleParams: DiffOfArrivalTupleParams) =
            apply {
                columns = diffOfArrivalTupleParams.columns
                obTime = diffOfArrivalTupleParams.obTime
                firstResult = diffOfArrivalTupleParams.firstResult
                maxResults = diffOfArrivalTupleParams.maxResults
                additionalHeaders = diffOfArrivalTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = diffOfArrivalTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DiffOfArrivalTupleParams].
         *
         ...
         */
        fun build(): DiffOfArrivalTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is DiffOfArrivalTupleParams && columns == other.columns && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "DiffOfArrivalTupleParams{columns=$columns, obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
