...
class H3GeoHexCellListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellListResponse: H3GeoHexCellListResponse) =
            apply {
    ...
    fun validate(): H3GeoHexCellListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "H3GeoHexCellListResponse{cellId=$cellId, classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, altMean=$altMean, altSigma=$altSigma, anomScoreInterference=$anomScoreInterference, anomScoreSpoofing=$anomScoreSpoofing, changeScore=$changeScore, coverage=$coverage, createdAt=$createdAt, createdBy=$createdBy, idH3Geo=$idH3Geo, origin=$origin, origNetwork=$origNetwork, rpmMax=$rpmMax, rpmMean=$rpmMean, rpmMedian=$rpmMedian, rpmMin=$rpmMin, rpmSigma=$rpmSigma, sourceDl=$sourceDl, additionalProperties=$additionalProperties}"
}
