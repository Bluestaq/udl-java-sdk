...
class ItemTrackingQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingQueryhelpResponse: ItemTrackingQueryhelpResponse) = apply {
    ...
    fun validate(): ItemTrackingQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
