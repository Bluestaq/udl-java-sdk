...
class ItemTrackingQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ItemTrackingQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ItemTrackingQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingQueryhelpResponse: ItemTrackingQueryhelpResponse) =
            apply {
                aodrSupported = itemTrackingQueryhelpResponse.aodrSupported
                classificationMarking = itemTrackingQueryhelpResponse.classificationMarking
                description = itemTrackingQueryhelpResponse.description
                historySupported = itemTrackingQueryhelpResponse.historySupported
                name = itemTrackingQueryhelpResponse.name
                parameters = itemTrackingQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = itemTrackingQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = itemTrackingQueryhelpResponse.restSupported
                sortSupported = itemTrackingQueryhelpResponse.sortSupported
                typeName = itemTrackingQueryhelpResponse.typeName
                uri = itemTrackingQueryhelpResponse.uri
                additionalProperties = itemTrackingQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ItemTrackingQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ItemTrackingQueryhelpResponse =
    ...
    fun validate(): ItemTrackingQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ItemTrackingQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
