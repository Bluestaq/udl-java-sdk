...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteGetParams: SiteGetParams) = apply {
            id = siteGetParams.id
    ...
    override fun toString() =
        "SiteGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
