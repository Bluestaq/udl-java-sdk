...
class SiteGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SiteGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SiteGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SiteGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteGetParams: SiteGetParams) =
            apply {
                id = siteGetParams.id
                firstResult = siteGetParams.firstResult
                maxResults = siteGetParams.maxResults
                additionalHeaders = siteGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = siteGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SiteGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SiteGetParams =
            SiteGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SiteGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SiteGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
