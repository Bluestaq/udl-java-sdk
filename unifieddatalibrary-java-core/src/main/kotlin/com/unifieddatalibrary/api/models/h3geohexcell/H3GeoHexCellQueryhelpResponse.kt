...
class H3GeoHexCellQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellQueryhelpResponse: H3GeoHexCellQueryhelpResponse) = apply {
    ...
    fun validate(): H3GeoHexCellQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
