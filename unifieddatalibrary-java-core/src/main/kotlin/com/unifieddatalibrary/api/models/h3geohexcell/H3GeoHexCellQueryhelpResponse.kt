...
class H3GeoHexCellQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [H3GeoHexCellQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [H3GeoHexCellQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellQueryhelpResponse: H3GeoHexCellQueryhelpResponse) =
            apply {
                aodrSupported = h3GeoHexCellQueryhelpResponse.aodrSupported
                classificationMarking = h3GeoHexCellQueryhelpResponse.classificationMarking
                description = h3GeoHexCellQueryhelpResponse.description
                historySupported = h3GeoHexCellQueryhelpResponse.historySupported
                name = h3GeoHexCellQueryhelpResponse.name
                parameters = h3GeoHexCellQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = h3GeoHexCellQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = h3GeoHexCellQueryhelpResponse.restSupported
                sortSupported = h3GeoHexCellQueryhelpResponse.sortSupported
                typeName = h3GeoHexCellQueryhelpResponse.typeName
                uri = h3GeoHexCellQueryhelpResponse.uri
                additionalProperties = h3GeoHexCellQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [H3GeoHexCellQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): H3GeoHexCellQueryhelpResponse =
    ...
    fun validate(): H3GeoHexCellQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is H3GeoHexCellQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
