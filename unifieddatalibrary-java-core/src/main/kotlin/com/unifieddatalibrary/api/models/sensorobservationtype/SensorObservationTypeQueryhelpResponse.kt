...
class SensorObservationTypeQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SensorObservationTypeQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorObservationTypeQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorObservationTypeQueryhelpResponse: SensorObservationTypeQueryhelpResponse) =
            apply {
                aodrSupported = sensorObservationTypeQueryhelpResponse.aodrSupported
                classificationMarking = sensorObservationTypeQueryhelpResponse.classificationMarking
                description = sensorObservationTypeQueryhelpResponse.description
                historySupported = sensorObservationTypeQueryhelpResponse.historySupported
                name = sensorObservationTypeQueryhelpResponse.name
                parameters = sensorObservationTypeQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = sensorObservationTypeQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = sensorObservationTypeQueryhelpResponse.restSupported
                sortSupported = sensorObservationTypeQueryhelpResponse.sortSupported
                typeName = sensorObservationTypeQueryhelpResponse.typeName
                uri = sensorObservationTypeQueryhelpResponse.uri
                additionalProperties = sensorObservationTypeQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorObservationTypeQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorObservationTypeQueryhelpResponse =
    ...
    fun validate(): SensorObservationTypeQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
