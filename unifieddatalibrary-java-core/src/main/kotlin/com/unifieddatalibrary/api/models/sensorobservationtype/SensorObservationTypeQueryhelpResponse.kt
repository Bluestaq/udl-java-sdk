...
class SensorObservationTypeQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            sensorObservationTypeQueryhelpResponse: SensorObservationTypeQueryhelpResponse
        ) = apply {
            ...
            parameters =
                sensorObservationTypeQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                sensorObservationTypeQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                sensorObservationTypeQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): SensorObservationTypeQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
