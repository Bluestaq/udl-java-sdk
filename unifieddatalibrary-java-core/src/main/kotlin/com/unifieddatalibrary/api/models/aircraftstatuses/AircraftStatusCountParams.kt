 ...
 */
class AircraftStatusCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AircraftStatusCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusCountParams: AircraftStatusCountParams) = apply {
    ...
    override fun toString() =
        "AircraftStatusCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
