...
class AirfieldstatusFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("approvedBy") @ExcludeMissing approvedBy: JsonField<String> = JsonMissing.of(),
        @JsonProperty("approvedDate") @ExcludeMissing approvedDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("fleetServiceMOG") @ExcludeMissing fleetServiceMog: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("fuelMOG") @ExcludeMissing fuelMog: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("fuelQtys") @ExcludeMissing fuelQtys: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("fuelTypes") @ExcludeMissing fuelTypes: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("mheTypes") @ExcludeMissing mheTypes: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("mxMOG") @ExcludeMissing mxMog: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("narrowParkingMOG") @ExcludeMissing narrowParkingMog: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("narrowWorkingMOG") @ExcludeMissing narrowWorkingMog: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("numCOG") @ExcludeMissing numCog: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("operatingMOG") @ExcludeMissing operatingMog: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("origin") @ExcludeMissing origin: JsonField<String> = JsonMissing.of(),
        @JsonProperty("origNetwork") @ExcludeMissing origNetwork: JsonField<String> = JsonMissing.of(),
        @JsonProperty("passengerServiceMOG") @ExcludeMissing passengerServiceMog: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("reviewedBy") @ExcludeMissing reviewedBy: JsonField<String> = JsonMissing.of(),
        @JsonProperty("reviewedDate") @ExcludeMissing reviewedDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("rwyCondReading") @ExcludeMissing rwyCondReading: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("rwyFrictionFactor") @ExcludeMissing rwyFrictionFactor: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("rwyMarkings") @ExcludeMissing rwyMarkings: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("slotTypesReq") @ExcludeMissing slotTypesReq: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("sourceDL") @ExcludeMissing sourceDl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("surveyDate") @ExcludeMissing surveyDate: JsonField<OffsetDateTime> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun passengerServiceMog(): Optional<Int> = passengerServiceMog.getOptional("passengerServiceMOG")
     ...
     */
    @JsonProperty("arffCat")
    @ExcludeMissing
    fun _arffCat(): JsonField<String> = arffCat
     ...
     */
    @JsonProperty("cargoMOG")
    @ExcludeMissing
    fun _cargoMog(): JsonField<Int> = cargoMog
     ...
     */
    @JsonProperty("fuelMOG")
    @ExcludeMissing
    fun _fuelMog(): JsonField<Int> = fuelMog
     ...
     */
    @JsonProperty("gseTime")
    @ExcludeMissing
    fun _gseTime(): JsonField<Int> = gseTime
    ...
    @JsonProperty("medCap")
    @ExcludeMissing
    fun _medCap(): JsonField<String> = medCap
    ...
    @ExcludeMissing
    fun _mheQtys(): JsonField<List<Int>> = mheQtys
    ...
    @JsonProperty("mxMOG")
    @ExcludeMissing
    fun _mxMog(): JsonField<Int> = mxMog

    /**
     * Returns the raw JSON value of [narrowParkingMog].
     *
     * Unlike [narrowParkingMog], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [narrowWorkingMog], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("numCOG")
    @ExcludeMissing
    fun _numCog(): JsonField<Int> = numCog
     ...
     *
     * Unlike [passengerServiceMog], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _priRwyNum(): JsonField<String> = priRwyNum
     ...
     *
     * Unlike [rwyFrictionFactor], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldstatusFull: AirfieldstatusFull) =
            apply {
         ...
         *
         * You should usually call [Builder.approvedBy] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun approvedBy(approvedBy: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.approvedDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun approvedDate(approvedDate: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.arffCat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arffCat(arffCat: JsonField<String>) =
            apply {
                this.arffCat = arffCat
            }
         ...
         *
         * You should usually call [Builder.cargoMog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cargoMog(cargoMog: JsonField<Int>) =
            apply {
                this.cargoMog = cargoMog
            }
         ...
         *
         * You should usually call [Builder.fleetServiceMog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fleetServiceMog(fleetServiceMog: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.fuelMog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fuelMog(fuelMog: JsonField<Int>) =
            apply {
                this.fuelMog = fuelMog
            }
         ...
         *
         * You should usually call [Builder.fuelQtys] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fuelQtys(fuelQtys: JsonField<List<Double>>) =
            apply {
         ...
         */
        fun addFuelQty(fuelQty: Double) =
            apply {
                fuelQtys = (fuelQtys ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.fuelTypes] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fuelTypes(fuelTypes: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFuelType(fuelType: String) =
            apply {
                fuelTypes = (fuelTypes ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.gseTime] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun gseTime(gseTime: JsonField<Int>) =
            apply {
                this.gseTime = gseTime
            }
         ...
         *
         * You should usually call [Builder.medCap] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun medCap(medCap: JsonField<String>) =
            apply {
                this.medCap = medCap
            }
         ...
         *
         * You should usually call [Builder.mheQtys] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mheQtys(mheQtys: JsonField<List<Int>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addMheQty(mheQty: Int) =
            apply {
                mheQtys = (mheQtys ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.mheTypes] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mheTypes(mheTypes: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addMheType(mheType: String) =
            apply {
                mheTypes = (mheTypes ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.mxMog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mxMog(mxMog: JsonField<Int>) =
            apply {
                this.mxMog = mxMog
            }

        /** Maximum on ground (MOG) number of parking narrow-body aircraft based on spacing and manpower at the time of status. */
        fun narrowParkingMog(narrowParkingMog: Int) = narrowParkingMog(JsonField.of(narrowParkingMog))

        /**
         * Sets [Builder.narrowParkingMog] to an arbitrary JSON value.
         *
         * You should usually call [Builder.narrowParkingMog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun narrowParkingMog(narrowParkingMog: JsonField<Int>) =
            apply {
                this.narrowParkingMog = narrowParkingMog
            }

        /** Maximum on ground (MOG) number of working narrow-body aircraft based on spacing and manpower at the time of status. */
        fun narrowWorkingMog(narrowWorkingMog: Int) = narrowWorkingMog(JsonField.of(narrowWorkingMog))

        /**
         * Sets [Builder.narrowWorkingMog] to an arbitrary JSON value.
         *
         * You should usually call [Builder.narrowWorkingMog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun narrowWorkingMog(narrowWorkingMog: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.numCog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numCog(numCog: JsonField<Int>) =
            apply {
                this.numCog = numCog
            }
         ...
         *
         * You should usually call [Builder.operatingMog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun operatingMog(operatingMog: JsonField<Int>) =
            apply {
        ...
        /** Maximum on ground (MOG) number of high-reach/wide-body passenger aircraft that can be serviced simultaneously based on spacing and manpower at the time of status. */
        fun passengerServiceMog(passengerServiceMog: Int) = passengerServiceMog(JsonField.of(passengerServiceMog))

        /**
         * Sets [Builder.passengerServiceMog] to an arbitrary JSON value.
         *
         * You should usually call [Builder.passengerServiceMog] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun passengerServiceMog(passengerServiceMog: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.priRwyNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun priRwyNum(priRwyNum: JsonField<String>) =
            apply {
                this.priRwyNum = priRwyNum
            }
         ...
         *
         * You should usually call [Builder.reviewedBy] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reviewedBy(reviewedBy: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.reviewedDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reviewedDate(reviewedDate: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.rwyCondReading] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rwyCondReading(rwyCondReading: JsonField<Int>) =
            apply {
                this.rwyCondReading = rwyCondReading
            }

        /** The primary runway friction factor which is dependent on the surface friction between the tires of the aircraft and the runway surface, from 0 to 100. A lower number indicates less friction and less braking response. */
        fun rwyFrictionFactor(rwyFrictionFactor: Int) = rwyFrictionFactor(JsonField.of(rwyFrictionFactor))

        /**
         * Sets [Builder.rwyFrictionFactor] to an arbitrary JSON value.
         *
         * You should usually call [Builder.rwyFrictionFactor] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rwyFrictionFactor(rwyFrictionFactor: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.rwyMarkings] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rwyMarkings(rwyMarkings: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRwyMarking(rwyMarking: String) =
            apply {
                rwyMarkings = (rwyMarkings ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.slotTypesReq] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun slotTypesReq(slotTypesReq: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSlotTypesReq(slotTypesReq: String) =
            apply {
                this.slotTypesReq = (this.slotTypesReq ?: JsonField.of(mutableListOf())).also {
    ...
    fun validate(): AirfieldstatusFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idAirfield.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (altAirfieldId.asKnown().isPresent) 1 else 0) + (if (approvedBy.asKnown().isPresent) 1 else 0) + (if (approvedDate.asKnown().isPresent) 1 else 0) + (if (arffCat.asKnown().isPresent) 1 else 0) + (if (cargoMog.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (fleetServiceMog.asKnown().isPresent) 1 else 0) + (if (fuelMog.asKnown().isPresent) 1 else 0) + (fuelQtys.asKnown().getOrNull()?.size ?: 0) + (fuelTypes.asKnown().getOrNull()?.size ?: 0) + (if (gseTime.asKnown().isPresent) 1 else 0) + (if (medCap.asKnown().isPresent) 1 else 0) + (if (message.asKnown().isPresent) 1 else 0) + (mheQtys.asKnown().getOrNull()?.size ?: 0) + (mheTypes.asKnown().getOrNull()?.size ?: 0) + (if (mxMog.asKnown().isPresent) 1 else 0) + (if (narrowParkingMog.asKnown().isPresent) 1 else 0) + (if (narrowWorkingMog.asKnown().isPresent) 1 else 0) + (if (numCog.asKnown().isPresent) 1 else 0) + (if (operatingMog.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (passengerServiceMog.asKnown().isPresent) 1 else 0) + (if (priFreq.asKnown().isPresent) 1 else 0) + (if (priRwyNum.asKnown().isPresent) 1 else 0) + (if (reviewedBy.asKnown().isPresent) 1 else 0) + (if (reviewedDate.asKnown().isPresent) 1 else 0) + (if (rwyCondReading.asKnown().isPresent) 1 else 0) + (if (rwyFrictionFactor.asKnown().isPresent) 1 else 0) + (rwyMarkings.asKnown().getOrNull()?.size ?: 0) + (slotTypesReq.asKnown().getOrNull()?.size ?: 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (surveyDate.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (if (wideParkingMog.asKnown().isPresent) 1 else 0) + (if (wideWorkingMog.asKnown().isPresent) 1 else 0)
