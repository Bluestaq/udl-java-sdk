...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyListPage: AircraftSortyListPage) = apply {
            service = aircraftSortyListPage.service
            params = aircraftSortyListPage.params
            items = aircraftSortyListPage.items
        }

        fun service(service: AircraftSortyService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AircraftSortyListPage &&
    ...
    override fun toString() =
        "AircraftSortyListPage{service=$service, params=$params, items=$items}"
}
