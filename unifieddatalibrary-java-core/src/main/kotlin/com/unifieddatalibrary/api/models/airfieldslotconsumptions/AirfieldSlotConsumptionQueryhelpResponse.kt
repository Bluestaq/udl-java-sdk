...
class AirfieldSlotConsumptionQueryhelpResponse
private constructor(
    ...
    /** A builder for [AirfieldSlotConsumptionQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            airfieldSlotConsumptionQueryhelpResponse: AirfieldSlotConsumptionQueryhelpResponse
        ) = apply {
            aodrSupported = airfieldSlotConsumptionQueryhelpResponse.aodrSupported
            classificationMarking = airfieldSlotConsumptionQueryhelpResponse.classificationMarking
            description = airfieldSlotConsumptionQueryhelpResponse.description
            historySupported = airfieldSlotConsumptionQueryhelpResponse.historySupported
            name = airfieldSlotConsumptionQueryhelpResponse.name
            parameters =
                airfieldSlotConsumptionQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                airfieldSlotConsumptionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = airfieldSlotConsumptionQueryhelpResponse.restSupported
            sortSupported = airfieldSlotConsumptionQueryhelpResponse.sortSupported
            typeName = airfieldSlotConsumptionQueryhelpResponse.typeName
            uri = airfieldSlotConsumptionQueryhelpResponse.uri
            additionalProperties =
                airfieldSlotConsumptionQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AirfieldSlotConsumptionQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldSlotConsumptionQueryhelpResponse =
            AirfieldSlotConsumptionQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): AirfieldSlotConsumptionQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
