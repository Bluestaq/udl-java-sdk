...
class MtiTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MtiTupleParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mtiTupleParams: MtiTupleParams) =
            apply {
                columns = mtiTupleParams.columns
                createdAt = mtiTupleParams.createdAt
                firstResult = mtiTupleParams.firstResult
                maxResults = mtiTupleParams.maxResults
                additionalHeaders = mtiTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = mtiTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MtiTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MtiTupleParams && columns == other.columns && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "MtiTupleParams{columns=$columns, createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
