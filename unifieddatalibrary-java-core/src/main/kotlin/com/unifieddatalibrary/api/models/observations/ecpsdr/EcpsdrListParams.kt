...
class EcpsdrListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpsdrListParams].
         *
    ...
    /** A builder for [EcpsdrListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrListParams: EcpsdrListParams) =
            apply {
                msgTime = ecpsdrListParams.msgTime
                firstResult = ecpsdrListParams.firstResult
                maxResults = ecpsdrListParams.maxResults
                additionalHeaders = ecpsdrListParams.additionalHeaders.toBuilder()
                additionalQueryParams = ecpsdrListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EcpsdrListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EcpsdrListParams && msgTime == other.msgTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EcpsdrListParams{msgTime=$msgTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
