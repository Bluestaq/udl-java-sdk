 ...
 * specification.
 */
class IonOobservationListResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ionOobservationListResponse: IonOobservationListResponse) = apply {
            ...
            antennaElementPositionCoordinateSystem =
                ionOobservationListResponse.antennaElementPositionCoordinateSystem
            ...
            electronDensityUncertainty =
                ionOobservationListResponse.electronDensityUncertainty.map { it.toMutableList() }
            ...
            plasmaFrequencyUncertainty =
                ionOobservationListResponse.plasmaFrequencyUncertainty.map { it.toMutableList() }
            ...
            receiveCoordinates =
                ionOobservationListResponse.receiveCoordinates.map { it.toMutableList() }
            receiveSensorType = ionOobservationListResponse.receiveSensorType
            restrictedFrequency =
                ionOobservationListResponse.restrictedFrequency.map { it.toMutableList() }
            ...
            transmitCoordinates =
                ionOobservationListResponse.transmitCoordinates.map { it.toMutableList() }
    ...
    fun validate(): IonOobservationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        private val data:
            JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>>,
        private val dimensionName: JsonField<List<String>>,
        private val dimensions: JsonField<List<Int>>,
        private val notes: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
         ...
         */
        fun data():
            Optional<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>> =
            data.getOptional("data")
        ...
        class Builder internal constructor() {
            ...
            private var data:
                JsonField<
                    MutableList<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>
                >? =
                null
            private var dimensionName: JsonField<MutableList<String>>? = null
            private var dimensions: JsonField<MutableList<Int>>? = null
            ...
            /** Array of polarization data. */
            fun data(
                data: List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>
            ) = data(JsonField.of(data))
             ...
             *
             * You should usually call [Builder.data] with a well-typed
             * `List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun data(
                data:
                    JsonField<
                        List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>
                    >
            ) = apply { this.data = data.map { it.toMutableList() } }

            /**
             * Adds a single [List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>] to
             * [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
