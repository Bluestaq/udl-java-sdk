...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteStatusCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteStatusCountParams: SiteStatusCountParams) = apply {
    ...
    override fun toString() =
        "SiteStatusCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
