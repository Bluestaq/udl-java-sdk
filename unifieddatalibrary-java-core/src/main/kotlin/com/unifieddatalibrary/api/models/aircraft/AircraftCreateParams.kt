...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftCreateParams].
         *
    ...
    /** A builder for [AircraftCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftCreateParams: AircraftCreateParams) = apply {
            body = aircraftCreateParams.body.toBuilder()
            additionalHeaders = aircraftCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftCreateParams].
         *
         ...
         */
        fun build(): AircraftCreateParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{aircraftMds=$aircraftMds, classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, category=$category, command=$command, createdAt=$createdAt, createdBy=$createdBy, cruiseSpeed=$cruiseSpeed, dtd=$dtd, entity=$entity, idEntity=$idEntity, maxSpeed=$maxSpeed, minReqRunwayFt=$minReqRunwayFt, minReqRunwayM=$minReqRunwayM, nominalTaTime=$nominalTaTime, notes=$notes, origin=$origin, origNetwork=$origNetwork, owner=$owner, serialNumber=$serialNumber, sourceDl=$sourceDl, tailNumber=$tailNumber, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AircraftCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
