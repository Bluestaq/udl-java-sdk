...
class SensorQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SensorQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorQueryhelpResponse: SensorQueryhelpResponse) =
            apply {
                aodrSupported = sensorQueryhelpResponse.aodrSupported
                classificationMarking = sensorQueryhelpResponse.classificationMarking
                description = sensorQueryhelpResponse.description
                historySupported = sensorQueryhelpResponse.historySupported
                name = sensorQueryhelpResponse.name
                parameters = sensorQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = sensorQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = sensorQueryhelpResponse.restSupported
                sortSupported = sensorQueryhelpResponse.sortSupported
                typeName = sensorQueryhelpResponse.typeName
                uri = sensorQueryhelpResponse.uri
                additionalProperties = sensorQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorQueryhelpResponse =
    ...
    fun validate(): SensorQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
