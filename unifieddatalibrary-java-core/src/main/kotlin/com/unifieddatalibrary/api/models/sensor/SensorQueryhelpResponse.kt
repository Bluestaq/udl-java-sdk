...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorQueryhelpResponse: SensorQueryhelpResponse) = apply {
    ...
    fun validate(): SensorQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
