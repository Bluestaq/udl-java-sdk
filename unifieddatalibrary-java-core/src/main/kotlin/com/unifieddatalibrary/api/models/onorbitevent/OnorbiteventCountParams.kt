...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbiteventCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventCountParams: OnorbiteventCountParams) = apply {
    ...
    override fun toString() =
        "OnorbiteventCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
