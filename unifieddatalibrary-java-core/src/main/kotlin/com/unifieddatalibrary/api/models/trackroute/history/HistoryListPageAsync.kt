...
private constructor(
    ...
    private val items: List<TrackRouteFull>,
) : PageAsync<TrackRouteFull> {
    ...
    fun autoPager(): AutoPagerAsync<TrackRouteFull> =
    ...
    override fun items(): List<TrackRouteFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<TrackRouteFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<TrackRouteFull>) = apply { this.items = items }
