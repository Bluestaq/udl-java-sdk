...
class OnorbitthrusterListResponse
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("engine")
        @ExcludeMissing
        engine: JsonField<EngineAbridged> = JsonMissing.of(),
     ...
     */
    @JsonProperty("engine") @ExcludeMissing fun _engine(): JsonField<EngineAbridged> = engine
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterListResponse: OnorbitthrusterListResponse) = apply {
         ...
         *
         * You should usually call [Builder.engine] with a well-typed [EngineAbridged] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun engine(engine: JsonField<EngineAbridged>) = apply { this.engine = engine }
    ...
    fun validate(): OnorbitthrusterListResponse = apply {
        if (validated) {
            return@apply
        }
