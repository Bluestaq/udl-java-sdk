...
class OnorbitthrusterListResponse private constructor(
    ...
    private val engine: JsonField<EngineAbridged>,
    ...
    private constructor(
        ...
        @JsonProperty("engine") @ExcludeMissing engine: JsonField<EngineAbridged> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun engine(): Optional<EngineAbridged> = engine.getOptional("engine")
    ...
    @JsonProperty("engine")
    @ExcludeMissing
    fun _engine(): JsonField<EngineAbridged> = engine
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitthrusterListResponse].
         *
    ...
    /** A builder for [OnorbitthrusterListResponse]. */
    class Builder internal constructor() {
        ...
        private var engine: JsonField<EngineAbridged> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterListResponse: OnorbitthrusterListResponse) =
            apply {
                classificationMarking = onorbitthrusterListResponse.classificationMarking
                dataMode = onorbitthrusterListResponse.dataMode
                idEngine = onorbitthrusterListResponse.idEngine
                idOnOrbit = onorbitthrusterListResponse.idOnOrbit
                source = onorbitthrusterListResponse.source
                id = onorbitthrusterListResponse.id
                createdAt = onorbitthrusterListResponse.createdAt
                createdBy = onorbitthrusterListResponse.createdBy
                engine = onorbitthrusterListResponse.engine
                origin = onorbitthrusterListResponse.origin
                origNetwork = onorbitthrusterListResponse.origNetwork
                quantity = onorbitthrusterListResponse.quantity
                type = onorbitthrusterListResponse.type
                additionalProperties = onorbitthrusterListResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Known launch vehicle engines and their performance characteristics and limits. A launch vehicle has 1 to many engines per stage. */
        fun engine(engine: EngineAbridged) = engine(JsonField.of(engine))

        /**
         * Sets [Builder.engine] to an arbitrary JSON value.
         *
         * You should usually call [Builder.engine] with a well-typed [EngineAbridged] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun engine(engine: JsonField<EngineAbridged>) =
            apply {
                this.engine = engine
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitthrusterListResponse].
         *
         ...
         */
        fun build(): OnorbitthrusterListResponse =
    ...
    fun validate(): OnorbitthrusterListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idEngine.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (engine.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "OnorbitthrusterListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idEngine=$idEngine, idOnOrbit=$idOnOrbit, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, engine=$engine, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, type=$type, additionalProperties=$additionalProperties}"
}
