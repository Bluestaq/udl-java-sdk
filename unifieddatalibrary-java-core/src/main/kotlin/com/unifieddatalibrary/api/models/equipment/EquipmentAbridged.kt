...
class EquipmentAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EquipmentAbridged].
         *
    ...
    /** A builder for [EquipmentAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentAbridged: EquipmentAbridged) =
            apply {
                classificationMarking = equipmentAbridged.classificationMarking
                countryCode = equipmentAbridged.countryCode
                dataMode = equipmentAbridged.dataMode
                lat = equipmentAbridged.lat
                lon = equipmentAbridged.lon
                source = equipmentAbridged.source
                id = equipmentAbridged.id
                airDefArea = equipmentAbridged.airDefArea
                allegiance = equipmentAbridged.allegiance
                altAllegiance = equipmentAbridged.altAllegiance
                altCountryCode = equipmentAbridged.altCountryCode
                altEqpId = equipmentAbridged.altEqpId
                classRating = equipmentAbridged.classRating
                condition = equipmentAbridged.condition
                conditionAvail = equipmentAbridged.conditionAvail
                coord = equipmentAbridged.coord
                coordDatum = equipmentAbridged.coordDatum
                coordDerivAcc = equipmentAbridged.coordDerivAcc
                createdAt = equipmentAbridged.createdAt
                createdBy = equipmentAbridged.createdBy
                elevMsl = equipmentAbridged.elevMsl
                elevMslConfLvl = equipmentAbridged.elevMslConfLvl
                elevMslDerivAcc = equipmentAbridged.elevMslDerivAcc
                eqpCode = equipmentAbridged.eqpCode
                eqpIdNum = equipmentAbridged.eqpIdNum
                eval = equipmentAbridged.eval
                fpa = equipmentAbridged.fpa
                function = equipmentAbridged.function
                functPrimary = equipmentAbridged.functPrimary
                geoidalMslSep = equipmentAbridged.geoidalMslSep
                ident = equipmentAbridged.ident
                idOperatingUnit = equipmentAbridged.idOperatingUnit
                idParentEquipment = equipmentAbridged.idParentEquipment
                idSite = equipmentAbridged.idSite
                locReason = equipmentAbridged.locReason
                milGrid = equipmentAbridged.milGrid
                milGridSys = equipmentAbridged.milGridSys
                nomen = equipmentAbridged.nomen
                operAreaPrimary = equipmentAbridged.operAreaPrimary
                operStatus = equipmentAbridged.operStatus
                origin = equipmentAbridged.origin
                polSubdiv = equipmentAbridged.polSubdiv
                qtyOh = equipmentAbridged.qtyOh
                recStatus = equipmentAbridged.recStatus
                referenceDoc = equipmentAbridged.referenceDoc
                resProd = equipmentAbridged.resProd
                reviewDate = equipmentAbridged.reviewDate
                seqNum = equipmentAbridged.seqNum
                srcIds = equipmentAbridged.srcIds.map { it.toMutableList() }
                srcTyps = equipmentAbridged.srcTyps.map { it.toMutableList() }
                symCode = equipmentAbridged.symCode
                utm = equipmentAbridged.utm
                wac = equipmentAbridged.wac
                additionalProperties = equipmentAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EquipmentAbridged].
         *
    ...
    fun validate(): EquipmentAbridged =
        apply {
            if (validated) {
              return@apply
            }
