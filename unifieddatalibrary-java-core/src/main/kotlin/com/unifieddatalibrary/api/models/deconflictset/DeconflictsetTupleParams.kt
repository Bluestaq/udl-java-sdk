 ...
 */
class DeconflictsetTupleParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeconflictsetTupleParams].
         *
    ...
    /** A builder for [DeconflictsetTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deconflictsetTupleParams: DeconflictsetTupleParams) = apply {
            columns = deconflictsetTupleParams.columns
            eventStartTime = deconflictsetTupleParams.eventStartTime
            firstResult = deconflictsetTupleParams.firstResult
            maxResults = deconflictsetTupleParams.maxResults
            additionalHeaders = deconflictsetTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = deconflictsetTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DeconflictsetTupleParams].
         *
         ...
         */
        fun build(): DeconflictsetTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeconflictsetTupleParams &&
    ...
    override fun toString() =
        "DeconflictsetTupleParams{columns=$columns, eventStartTime=$eventStartTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
