...
/**
 * Service operation to take multiple logisticssupport records as a POST body and ingest into the
 ...
 */
class LogisticsSupportUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            logisticsSupportUnvalidatedPublishParams: LogisticsSupportUnvalidatedPublishParams
        ) = apply {
            body = logisticsSupportUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                logisticsSupportUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                logisticsSupportUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
