...
class LogisticsSupportUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LogisticsSupportUnvalidatedPublishParams].
         *
    ...
    /** A builder for [LogisticsSupportUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportUnvalidatedPublishParams: LogisticsSupportUnvalidatedPublishParams) =
            apply {
                body = logisticsSupportUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = logisticsSupportUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = logisticsSupportUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LogisticsSupportUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): LogisticsSupportUnvalidatedPublishParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("rptCreatedTime") @ExcludeMissing private val rptCreatedTime: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("logisticAction") @ExcludeMissing private val logisticAction: JsonField<String>,
        @JsonProperty("logisticsDiscrepancyInfos") @ExcludeMissing private val logisticsDiscrepancyInfos: JsonField<List<LogisticsDiscrepancyInfo>>,
        @JsonProperty("logisticsRecordId") @ExcludeMissing private val logisticsRecordId: JsonField<String>,
        @JsonProperty("logisticsRemarks") @ExcludeMissing private val logisticsRemarks: JsonField<List<LogisticsRemark>>,
        @JsonProperty("logisticsSupportItems") @ExcludeMissing private val logisticsSupportItems: JsonField<List<LogisticsSupportItem>>,
        @JsonProperty("logisticsTransportationPlans") @ExcludeMissing private val logisticsTransportationPlans: JsonField<List<LogisticsTransportationPlan>>,
        @JsonProperty("maintStatusCode") @ExcludeMissing private val maintStatusCode: JsonField<String>,
        ...
        @JsonProperty("rptClosedTime") @ExcludeMissing private val rptClosedTime: JsonField<OffsetDateTime>,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun logisticsRemarks(): Optional<List<LogisticsRemark>> = logisticsRemarks.getOptional("logisticsRemarks")
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    logisticsDiscrepancyInfos = body.logisticsDiscrepancyInfos.map { it.toMutableList() }
                    ...
                    logisticsTransportationPlans = body.logisticsTransportationPlans.map { it.toMutableList() }
            ...
            /** Remarks associated with this LogisticsSupport record. */
            fun logisticsRemarks(logisticsRemarks: List<LogisticsRemark>) = logisticsRemarks(JsonField.of(logisticsRemarks))

            /**
             * Sets [Builder.logisticsRemarks] to an arbitrary JSON value.
             *
             * You should usually call [Builder.logisticsRemarks] with a well-typed `List<LogisticsRemark>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun logisticsRemarks(logisticsRemarks: JsonField<List<LogisticsRemark>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addLogisticsRemark(logisticsRemark: LogisticsRemark) =
                apply {
        ...
        /** Remarks associated with this LogisticsSupport record. */
        class LogisticsRemark private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(logisticsRemark: LogisticsRemark) =
                    apply {
            ...
            override fun toString() = "LogisticsRemark{lastChanged=$lastChanged, remark=$remark, username=$username, additionalProperties=$additionalProperties}"
        }
        ...
        class LogisticsSupportItem private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("logisticsRemarks") @ExcludeMissing logisticsRemarks: JsonField<List<LogisticsRemark>> = JsonMissing.of(),
        ...
        class LogisticsTransportationPlan private constructor(
            ...
            private val logisticsTransportationPlansRemarks: JsonField<List<LogisticsTransportationPlansRemark>>,
            ...
            private constructor(
                ...
                @JsonProperty("logisticsTransportationPlansRemarks") @ExcludeMissing logisticsTransportationPlansRemarks: JsonField<List<LogisticsTransportationPlansRemark>> = JsonMissing.of(),
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun logisticsTransportationPlansRemarks(): Optional<List<LogisticsTransportationPlansRemark>> = logisticsTransportationPlansRemarks.getOptional("logisticsTransportationPlansRemarks")
            ...
            @ExcludeMissing
            fun _logisticsTransportationPlansRemarks(): JsonField<List<LogisticsTransportationPlansRemark>> = logisticsTransportationPlansRemarks
            ...
            class Builder internal constructor() {
                ...
                private var logisticsTransportationPlansRemarks: JsonField<MutableList<LogisticsTransportationPlansRemark>>? = null
                ...
                /** Remarks associated with this transportation plan. */
                fun logisticsTransportationPlansRemarks(logisticsTransportationPlansRemarks: List<LogisticsTransportationPlansRemark>) = logisticsTransportationPlansRemarks(JsonField.of(logisticsTransportationPlansRemarks))

                /**
                 * Sets [Builder.logisticsTransportationPlansRemarks] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.logisticsTransportationPlansRemarks] with a well-typed `List<LogisticsTransportationPlansRemark>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun logisticsTransportationPlansRemarks(logisticsTransportationPlansRemarks: JsonField<List<LogisticsTransportationPlansRemark>>) =
                    apply {
                        this.logisticsTransportationPlansRemarks = logisticsTransportationPlansRemarks.map { it.toMutableList() }
                    }

                /**
                 * Adds a single [LogisticsTransportationPlansRemark] to [logisticsTransportationPlansRemarks].
                 *
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addLogisticsTransportationPlansRemark(logisticsTransportationPlansRemark: LogisticsTransportationPlansRemark) =
                    apply {
            ...
            /** Remarks associated with this LogisticsSupport record. */
            class LogisticsTransportationPlansRemark private constructor(
                private val lastChanged: JsonField<OffsetDateTime>,
                private val remark: JsonField<String>,
                private val username: JsonField<String>,
                private val additionalProperties: MutableMap<String, JsonValue>,
                ...
                companion object {
                    ...
                    /** Returns a mutable builder for constructing an instance of [LogisticsTransportationPlansRemark]. */
                    @JvmStatic
                    fun builder() = Builder()
                }
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(logisticsTransportationPlansRemark: LogisticsTransportationPlansRemark) =
                        apply {
                            ...
                            additionalProperties = logisticsTransportationPlansRemark.additionalProperties.toMutableMap()
                        }
                ...
                fun validate(): LogisticsTransportationPlansRemark =
                    apply {
                        if (validated) {
                          return@apply
                        }
                ...
                override fun toString() = "LogisticsTransportationPlansRemark{lastChanged=$lastChanged, remark=$remark, username=$username, additionalProperties=$additionalProperties}"
            }
    ...
    override fun toString() = "LogisticsSupportUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
