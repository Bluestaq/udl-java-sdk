...
/**
 * Service operation to take a single OnorbitThruster as a POST body and ingest into the database.
 ...
 * assistance.
 */
class OnorbitthrusterCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterCreateParams: OnorbitthrusterCreateParams) = apply {
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idEngine=$idEngine, idOnOrbit=$idOnOrbit, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, engine=$engine, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, type=$type, additionalProperties=$additionalProperties}"
    }
