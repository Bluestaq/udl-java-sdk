...
class OnorbitthrusterCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitthrusterCreateParams].
         *
    ...
    /** A builder for [OnorbitthrusterCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterCreateParams: OnorbitthrusterCreateParams) =
            apply {
                body = onorbitthrusterCreateParams.body.toBuilder()
                additionalHeaders = onorbitthrusterCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitthrusterCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitthrusterCreateParams].
         *
         ...
         */
        fun build(): OnorbitthrusterCreateParams =
    ...
    class Body private constructor(
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idEngine=$idEngine, idOnOrbit=$idOnOrbit, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, engine=$engine, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "OnorbitthrusterCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
