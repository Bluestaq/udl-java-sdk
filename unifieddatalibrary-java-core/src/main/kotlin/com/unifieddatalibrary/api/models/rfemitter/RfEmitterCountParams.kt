...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfEmitterCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterCountParams: RfEmitterCountParams) = apply {
    ...
    override fun toString() =
        "RfEmitterCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
