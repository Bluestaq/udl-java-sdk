...
class SeraDataCommDetailTupleResponse
private constructor(
    ...
    /** A builder for [SeraDataCommDetailTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataCommDetailTupleResponse: SeraDataCommDetailTupleResponse) =
            apply {
                classificationMarking = seraDataCommDetailTupleResponse.classificationMarking
                dataMode = seraDataCommDetailTupleResponse.dataMode
                source = seraDataCommDetailTupleResponse.source
                id = seraDataCommDetailTupleResponse.id
                band = seraDataCommDetailTupleResponse.band
                bandwidth = seraDataCommDetailTupleResponse.bandwidth
                createdAt = seraDataCommDetailTupleResponse.createdAt
                createdBy = seraDataCommDetailTupleResponse.createdBy
                eirp = seraDataCommDetailTupleResponse.eirp
                estHtsTotalCapacity = seraDataCommDetailTupleResponse.estHtsTotalCapacity
                estHtsTotalUserDownlinkBandwidthPerBeam =
                    seraDataCommDetailTupleResponse.estHtsTotalUserDownlinkBandwidthPerBeam
                estHtsTotalUserUplinkBandwidthPerBeam =
                    seraDataCommDetailTupleResponse.estHtsTotalUserUplinkBandwidthPerBeam
                gatewayDownlinkFrom = seraDataCommDetailTupleResponse.gatewayDownlinkFrom
                gatewayDownlinkTo = seraDataCommDetailTupleResponse.gatewayDownlinkTo
                gatewayUplinkFrom = seraDataCommDetailTupleResponse.gatewayUplinkFrom
                gatewayUplinkTo = seraDataCommDetailTupleResponse.gatewayUplinkTo
                hostedForCompanyOrgId = seraDataCommDetailTupleResponse.hostedForCompanyOrgId
                htsNumUserSpotBeams = seraDataCommDetailTupleResponse.htsNumUserSpotBeams
                htsUserDownlinkBandwidthPerBeam =
                    seraDataCommDetailTupleResponse.htsUserDownlinkBandwidthPerBeam
                htsUserUplinkBandwidthPerBeam =
                    seraDataCommDetailTupleResponse.htsUserUplinkBandwidthPerBeam
                idComm = seraDataCommDetailTupleResponse.idComm
                manufacturerOrgId = seraDataCommDetailTupleResponse.manufacturerOrgId
                num36MhzEquivalentTransponders =
                    seraDataCommDetailTupleResponse.num36MhzEquivalentTransponders
                numOperationalTransponders =
                    seraDataCommDetailTupleResponse.numOperationalTransponders
                numSpareTransponders = seraDataCommDetailTupleResponse.numSpareTransponders
                origin = seraDataCommDetailTupleResponse.origin
                origNetwork = seraDataCommDetailTupleResponse.origNetwork
                payloadNotes = seraDataCommDetailTupleResponse.payloadNotes
                polarization = seraDataCommDetailTupleResponse.polarization
                solidStatePowerAmp = seraDataCommDetailTupleResponse.solidStatePowerAmp
                spacecraftId = seraDataCommDetailTupleResponse.spacecraftId
                tradeLeaseOrgId = seraDataCommDetailTupleResponse.tradeLeaseOrgId
                travelingWaveTubeAmplifier =
                    seraDataCommDetailTupleResponse.travelingWaveTubeAmplifier
                updatedAt = seraDataCommDetailTupleResponse.updatedAt
                updatedBy = seraDataCommDetailTupleResponse.updatedBy
                userDownlinkFrom = seraDataCommDetailTupleResponse.userDownlinkFrom
                userDownlinkTo = seraDataCommDetailTupleResponse.userDownlinkTo
                userUplinkFrom = seraDataCommDetailTupleResponse.userUplinkFrom
                userUplinkTo = seraDataCommDetailTupleResponse.userUplinkTo
                additionalProperties =
                    seraDataCommDetailTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeraDataCommDetailTupleResponse].
         *
         ...
         */
        fun build(): SeraDataCommDetailTupleResponse =
            SeraDataCommDetailTupleResponse(
    ...
    fun validate(): SeraDataCommDetailTupleResponse = apply {
        if (validated) {
            return@apply
        }
