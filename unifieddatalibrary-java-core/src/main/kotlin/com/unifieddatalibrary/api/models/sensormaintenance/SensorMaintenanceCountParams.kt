...
class SensorMaintenanceCountParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SensorMaintenanceCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SensorMaintenanceCountParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorMaintenanceCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceCountParams: SensorMaintenanceCountParams) =
            apply {
                endTime = sensorMaintenanceCountParams.endTime
                firstResult = sensorMaintenanceCountParams.firstResult
                maxResults = sensorMaintenanceCountParams.maxResults
                startTime = sensorMaintenanceCountParams.startTime
                additionalHeaders = sensorMaintenanceCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = sensorMaintenanceCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SensorMaintenanceCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorMaintenanceCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorMaintenanceCountParams && endTime == other.endTime && firstResult == other.firstResult && maxResults == other.maxResults && startTime == other.startTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(endTime, firstResult, maxResults, startTime, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "SensorMaintenanceCountParams{endTime=$endTime, firstResult=$firstResult, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
