 ...
 */
class SensorMaintenanceCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SensorMaintenanceCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceCountParams: SensorMaintenanceCountParams) = apply {
    ...
    override fun toString() =
        "SensorMaintenanceCountParams{endTime=$endTime, firstResult=$firstResult, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
