 ...
 * database. This operation does not persist any DeconflictWindow datatypes that may be present in
 * the body of the request. This operation is not intended to be used for automated feeds into UDL.
 * A specific role is required to perform this service operation. Please contact the UDL team for
 * assistance.
 */
class DeconflictsetCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun numWindows(): Int = body.numWindows()
     ...
     *   if the server responded with an unexpected value).
     */
    fun calculationEndTime(): Optional<OffsetDateTime> = body.calculationEndTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun calculationId(): Optional<String> = body.calculationId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun calculationStartTime(): Optional<OffsetDateTime> = body.calculationStartTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun deconflictWindows(): Optional<List<DeconflictWindow>> = body.deconflictWindows()
     ...
     *   if the server responded with an unexpected value).
     */
    fun errors(): Optional<List<String>> = body.errors()
     ...
     *   if the server responded with an unexpected value).
     */
    fun idLaserDeconflictRequest(): Optional<String> = body.idLaserDeconflictRequest()
     ...
     *   if the server responded with an unexpected value).
     */
    fun referenceFrame(): Optional<String> = body.referenceFrame()
     ...
     *   if the server responded with an unexpected value).
     */
    fun warnings(): Optional<List<String>> = body.warnings()
     ...
     */
    fun _numWindows(): JsonField<Int> = body._numWindows()
     ...
     * type.
     */
    fun _calculationEndTime(): JsonField<OffsetDateTime> = body._calculationEndTime()
     ...
     */
    fun _calculationId(): JsonField<String> = body._calculationId()
     ...
     * type.
     */
    fun _calculationStartTime(): JsonField<OffsetDateTime> = body._calculationStartTime()
     ...
     * type.
     */
    fun _deconflictWindows(): JsonField<List<DeconflictWindow>> = body._deconflictWindows()
     ...
     */
    fun _errors(): JsonField<List<String>> = body._errors()
     ...
     * unexpected type.
     */
    fun _idLaserDeconflictRequest(): JsonField<String> = body._idLaserDeconflictRequest()
     ...
     */
    fun _referenceFrame(): JsonField<String> = body._referenceFrame()
     ...
     */
    fun _warnings(): JsonField<List<String>> = body._warnings()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeconflictsetCreateParams].
         *
    ...
    /** A builder for [DeconflictsetCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deconflictsetCreateParams: DeconflictsetCreateParams) = apply {
            body = deconflictsetCreateParams.body.toBuilder()
            additionalHeaders = deconflictsetCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = deconflictsetCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** The number of windows provided by this DeconflictSet record. */
        fun numWindows(numWindows: Int) = apply { body.numWindows(numWindows) }
         ...
         */
        fun numWindows(numWindows: JsonField<Int>) = apply { body.numWindows(numWindows) }
         ...
         */
        fun calculationEndTime(calculationEndTime: OffsetDateTime) = apply {
            body.calculationEndTime(calculationEndTime)
        }
        ...
        /** The algorithm execution id associated with the generation of this DeconflictSet. */
        fun calculationId(calculationId: String) = apply { body.calculationId(calculationId) }
         ...
         * millisecond precision.
         */
        fun calculationStartTime(calculationStartTime: OffsetDateTime) = apply {
            body.calculationStartTime(calculationStartTime)
        }
        ...
        /** Array of DeconflictWindow records associated with this DeconflictSet. */
        fun deconflictWindows(deconflictWindows: List<DeconflictWindow>) = apply {
            body.deconflictWindows(deconflictWindows)
        }
        ...
        fun addDeconflictWindow(deconflictWindow: DeconflictWindow) = apply {
            body.addDeconflictWindow(deconflictWindow)
        }
         ...
         * deconflict response calculation may be inaccurate, or why it failed.
         */
        fun errors(errors: List<String>) = apply { body.errors(errors) }
         ...
         * value.
         */
        fun errors(errors: JsonField<List<String>>) = apply { body.errors(errors) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addError(error: String) = apply { body.addError(error) }
         ...
         * DeconflictSet, if applicable.
         */
        fun idLaserDeconflictRequest(idLaserDeconflictRequest: String) = apply {
            body.idLaserDeconflictRequest(idLaserDeconflictRequest)
        }
         ...
         * assumed to be J2000.
         */
        fun referenceFrame(referenceFrame: String) = apply { body.referenceFrame(referenceFrame) }
         ...
         * deconflict response calculation may be inaccurate, or why it failed.
         */
        fun warnings(warnings: List<String>) = apply { body.warnings(warnings) }
         ...
         * supported value.
         */
        fun warnings(warnings: JsonField<List<String>>) = apply { body.warnings(warnings) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addWarning(warning: String) = apply { body.addWarning(warning) }
        ...
        /**
         * Returns an immutable instance of [DeconflictsetCreateParams].
         *
         ...
         */
        fun build(): DeconflictsetCreateParams =
    ...
    /**
     * The DeconflictSet service provides access to a set of DeconflictWindows and metadata about
     * those data. A DeconflictWindow describes a time window during which an action, such as target
     * engagement, may either occur or is prohibited from occurring. The DeconflictWindow model
     * includes information about the spatial details for specific target types. A flag is provided
     * to specify whether the window should be associated with taking action (OPEN), or if no action
     * should occur (CLOSED).
     */
    class Body
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            numWindows: JsonField<Int> = JsonMissing.of(),
         ...
         * Returns the raw JSON value of [calculationEndTime].
         *
         * Unlike [calculationEndTime], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("calculationEndTime")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [calculationId].
         *
         * Unlike [calculationId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("calculationId")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [calculationStartTime].
         *
         * Unlike [calculationStartTime], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("calculationStartTime")
        @ExcludeMissing
        ...
        @JsonProperty("warnings")
        @ExcludeMissing
        fun _warnings(): JsonField<List<String>> = warnings
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                numWindows = body.numWindows
                source = body.source
                id = body.id
                calculationEndTime = body.calculationEndTime
                calculationId = body.calculationId
                calculationStartTime = body.calculationStartTime
                createdAt = body.createdAt
                createdBy = body.createdBy
                deconflictWindows = body.deconflictWindows.map { it.toMutableList() }
                errors = body.errors.map { it.toMutableList() }
                eventEndTime = body.eventEndTime
                eventType = body.eventType
                idLaserDeconflictRequest = body.idLaserDeconflictRequest
                origin = body.origin
                ...
                warnings = body.warnings.map { it.toMutableList() }
             ...
             * Sets [Builder.numWindows] to an arbitrary JSON value.
             *
             * You should usually call [Builder.numWindows] with a well-typed [Int] value instead.
             ...
             * Sets [Builder.calculationEndTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.calculationEndTime] with a well-typed
             ...
             * Sets [Builder.calculationId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.calculationId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun calculationId(calculationId: JsonField<String>) = apply {
             ...
             * Sets [Builder.calculationStartTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.calculationStartTime] with a well-typed
             * [OffsetDateTime] value instead. This method is primarily for setting the field to an
             * undocumented or not yet supported value.
             */
            fun calculationStartTime(calculationStartTime: JsonField<OffsetDateTime>) = apply {
             ...
             *
             * You should usually call [Builder.deconflictWindows] with a well-typed
             * `List<DeconflictWindow>` value instead. This method is primarily for setting the
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeconflictsetCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "DeconflictsetCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
