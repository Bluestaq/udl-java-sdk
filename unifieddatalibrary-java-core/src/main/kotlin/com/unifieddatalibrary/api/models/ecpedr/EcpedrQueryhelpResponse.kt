...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EcpedrQueryhelpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EcpedrQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpedrQueryhelpResponse: EcpedrQueryhelpResponse) = apply {
            aodrSupported = ecpedrQueryhelpResponse.aodrSupported
            classificationMarking = ecpedrQueryhelpResponse.classificationMarking
            description = ecpedrQueryhelpResponse.description
            historySupported = ecpedrQueryhelpResponse.historySupported
            name = ecpedrQueryhelpResponse.name
            parameters = ecpedrQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = ecpedrQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = ecpedrQueryhelpResponse.restSupported
            sortSupported = ecpedrQueryhelpResponse.sortSupported
            typeName = ecpedrQueryhelpResponse.typeName
            uri = ecpedrQueryhelpResponse.uri
            additionalProperties = ecpedrQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EcpedrQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EcpedrQueryhelpResponse =
    ...
    fun validate(): EcpedrQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EcpedrQueryhelpResponse &&
