...
class SeradataOpticalPayloadQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataOpticalPayloadQueryhelpResponse: SeradataOpticalPayloadQueryhelpResponse
        ) = apply {
            ...
            parameters =
                seradataOpticalPayloadQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                seradataOpticalPayloadQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                seradataOpticalPayloadQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): SeradataOpticalPayloadQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
