...
class SeradataOpticalPayloadQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SeradataOpticalPayloadQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SeradataOpticalPayloadQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataOpticalPayloadQueryhelpResponse: SeradataOpticalPayloadQueryhelpResponse) =
            apply {
                aodrSupported = seradataOpticalPayloadQueryhelpResponse.aodrSupported
                classificationMarking = seradataOpticalPayloadQueryhelpResponse.classificationMarking
                description = seradataOpticalPayloadQueryhelpResponse.description
                historySupported = seradataOpticalPayloadQueryhelpResponse.historySupported
                name = seradataOpticalPayloadQueryhelpResponse.name
                parameters = seradataOpticalPayloadQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = seradataOpticalPayloadQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = seradataOpticalPayloadQueryhelpResponse.restSupported
                sortSupported = seradataOpticalPayloadQueryhelpResponse.sortSupported
                typeName = seradataOpticalPayloadQueryhelpResponse.typeName
                uri = seradataOpticalPayloadQueryhelpResponse.uri
                additionalProperties = seradataOpticalPayloadQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataOpticalPayloadQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataOpticalPayloadQueryhelpResponse =
    ...
    fun validate(): SeradataOpticalPayloadQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataOpticalPayloadQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
