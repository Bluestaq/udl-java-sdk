...
class AirloadPlanCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirloadPlanCountParams].
         *
    ...
    /** A builder for [AirloadPlanCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airloadPlanCountParams: AirloadPlanCountParams) =
            apply {
                estDepTime = airloadPlanCountParams.estDepTime
                firstResult = airloadPlanCountParams.firstResult
                maxResults = airloadPlanCountParams.maxResults
                additionalHeaders = airloadPlanCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = airloadPlanCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirloadPlanCountParams].
         *
         ...
         */
        fun build(): AirloadPlanCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirloadPlanCountParams && estDepTime == other.estDepTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(estDepTime, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AirloadPlanCountParams{estDepTime=$estDepTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
