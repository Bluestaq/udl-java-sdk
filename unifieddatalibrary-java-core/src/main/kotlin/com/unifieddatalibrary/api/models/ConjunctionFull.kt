...
class ConjunctionFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("collisionProb") @ExcludeMissing collisionProb: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("collisionProbMethod") @ExcludeMissing collisionProbMethod: JsonField<String> = JsonMissing.of(),
        @JsonProperty("comments") @ExcludeMissing comments: JsonField<String> = JsonMissing.of(),
        @JsonProperty("concernNotes") @ExcludeMissing concernNotes: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("ephemName1") @ExcludeMissing ephemName1: JsonField<String> = JsonMissing.of(),
        @JsonProperty("ephemName2") @ExcludeMissing ephemName2: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("idOnOrbit1") @ExcludeMissing idOnOrbit1: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idOnOrbit2") @ExcludeMissing idOnOrbit2: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idStateVector1") @ExcludeMissing idStateVector1: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idStateVector2") @ExcludeMissing idStateVector2: JsonField<String> = JsonMissing.of(),
        @JsonProperty("largeCovWarning") @ExcludeMissing largeCovWarning: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("largeRelPosWarning") @ExcludeMissing largeRelPosWarning: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("lastObTime1") @ExcludeMissing lastObTime1: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("lastObTime2") @ExcludeMissing lastObTime2: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("messageFor") @ExcludeMissing messageFor: JsonField<String> = JsonMissing.of(),
        @JsonProperty("messageId") @ExcludeMissing messageId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("missDistance") @ExcludeMissing missDistance: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("onOrbit1") @ExcludeMissing onOrbit1: JsonField<OnorbitFull> = JsonMissing.of(),
        @JsonProperty("onOrbit2") @ExcludeMissing onOrbit2: JsonField<OnorbitFull> = JsonMissing.of(),
        @JsonProperty("origIdOnOrbit1") @ExcludeMissing origIdOnOrbit1: JsonField<String> = JsonMissing.of(),
        @JsonProperty("origIdOnOrbit2") @ExcludeMissing origIdOnOrbit2: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("ownerContacted") @ExcludeMissing ownerContacted: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("penetrationLevelSigma") @ExcludeMissing penetrationLevelSigma: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("screenEntryTime") @ExcludeMissing screenEntryTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("screenExitTime") @ExcludeMissing screenExitTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("screenVolumeX") @ExcludeMissing screenVolumeX: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("screenVolumeY") @ExcludeMissing screenVolumeY: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("screenVolumeZ") @ExcludeMissing screenVolumeZ: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("smallCovWarning") @ExcludeMissing smallCovWarning: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("smallRelVelWarning") @ExcludeMissing smallRelVelWarning: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("stateDeptNotified") @ExcludeMissing stateDeptNotified: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("stateVector1") @ExcludeMissing stateVector1: JsonField<StateVector1> = JsonMissing.of(),
        @JsonProperty("stateVector2") @ExcludeMissing stateVector2: JsonField<StateVector2> = JsonMissing.of(),
        @JsonProperty("tags") @ExcludeMissing tags: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("thrustAccel1") @ExcludeMissing thrustAccel1: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("thrustAccel2") @ExcludeMissing thrustAccel2: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("volEntryTime") @ExcludeMissing volEntryTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("volExitTime") @ExcludeMissing volExitTime: JsonField<OffsetDateTime> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun collisionProbMethod(): Optional<String> = collisionProbMethod.getOptional("collisionProbMethod")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun largeRelPosWarning(): Optional<Boolean> = largeRelPosWarning.getOptional("largeRelPosWarning")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun penetrationLevelSigma(): Optional<Double> = penetrationLevelSigma.getOptional("penetrationLevelSigma")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun smallRelVelWarning(): Optional<Boolean> = smallRelVelWarning.getOptional("smallRelVelWarning")
    ...
    @JsonProperty("tca")
    @ExcludeMissing
    fun _tca(): JsonField<OffsetDateTime> = tca
    ...
    @JsonProperty("ccir")
    @ExcludeMissing
    fun _ccir(): JsonField<String> = ccir
    ...
    @JsonProperty("cdAoM1")
    @ExcludeMissing
    fun _cdAoM1(): JsonField<Double> = cdAoM1
    ...
    @JsonProperty("cdAoM2")
    @ExcludeMissing
    fun _cdAoM2(): JsonField<Double> = cdAoM2
     ...
     *
     * Unlike [collisionProbMethod], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("crAoM1")
    @ExcludeMissing
    fun _crAoM1(): JsonField<Double> = crAoM1
    ...
    @JsonProperty("crAoM2")
    @ExcludeMissing
    fun _crAoM2(): JsonField<Double> = crAoM2
    ...
    @ExcludeMissing
    fun _ephemName1(): JsonField<String> = ephemName1
    ...
    @ExcludeMissing
    fun _ephemName2(): JsonField<String> = ephemName2
    ...
    @JsonProperty("esId1")
    @ExcludeMissing
    fun _esId1(): JsonField<String> = esId1
    ...
    @JsonProperty("esId2")
    @ExcludeMissing
    fun _esId2(): JsonField<String> = esId2
     ...
     *
     * Unlike [largeRelPosWarning], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _messageFor(): JsonField<String> = messageFor
    ...
    @ExcludeMissing
    fun _onOrbit1(): JsonField<OnorbitFull> = onOrbit1
    ...
    @ExcludeMissing
    fun _onOrbit2(): JsonField<OnorbitFull> = onOrbit2
     ...
     *
     * Unlike [penetrationLevelSigma], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     */
    @JsonProperty("relPosN")
    @ExcludeMissing
    fun _relPosN(): JsonField<Double> = relPosN
     ...
     */
    @JsonProperty("relPosR")
    @ExcludeMissing
    fun _relPosR(): JsonField<Double> = relPosR
     ...
     */
    @JsonProperty("relPosT")
    @ExcludeMissing
    fun _relPosT(): JsonField<Double> = relPosT
    ...
    @ExcludeMissing
    fun _relVelMag(): JsonField<Double> = relVelMag
     ...
     */
    @JsonProperty("relVelN")
    @ExcludeMissing
    fun _relVelN(): JsonField<Double> = relVelN
     ...
     */
    @JsonProperty("relVelR")
    @ExcludeMissing
    fun _relVelR(): JsonField<Double> = relVelR
     ...
     */
    @JsonProperty("relVelT")
    @ExcludeMissing
    fun _relVelT(): JsonField<Double> = relVelT
    ...
    @JsonProperty("satNo1")
    @ExcludeMissing
    fun _satNo1(): JsonField<Int> = satNo1
    ...
    @JsonProperty("satNo2")
    @ExcludeMissing
    fun _satNo2(): JsonField<Int> = satNo2
     ...
     *
     * Unlike [smallRelVelWarning], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [stateDeptNotified], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     */
    @JsonProperty("uvwWarn")
    @ExcludeMissing
    fun _uvwWarn(): JsonField<Boolean> = uvwWarn
     ...
     */
    @JsonProperty("volShape")
    @ExcludeMissing
    fun _volShape(): JsonField<String> = volShape
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conjunctionFull: ConjunctionFull) =
            apply {
         ...
         *
         * You should usually call [Builder.tca] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tca(tca: JsonField<OffsetDateTime>) =
            apply {
                this.tca = tca
            }
         ...
         *
         * You should usually call [Builder.ccir] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ccir(ccir: JsonField<String>) =
            apply {
                this.ccir = ccir
            }
         ...
         *
         * You should usually call [Builder.cdAoM1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cdAoM1(cdAoM1: JsonField<Double>) =
            apply {
                this.cdAoM1 = cdAoM1
            }
         ...
         *
         * You should usually call [Builder.cdAoM2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cdAoM2(cdAoM2: JsonField<Double>) =
            apply {
                this.cdAoM2 = cdAoM2
            }
         ...
         *
         * You should usually call [Builder.collisionProb] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun collisionProb(collisionProb: JsonField<Double>) =
            apply {
                this.collisionProb = collisionProb
            }

        /** The method that was used to calculate the collision probability, ex. FOSTER-1992. */
        fun collisionProbMethod(collisionProbMethod: String) = collisionProbMethod(JsonField.of(collisionProbMethod))

        /**
         * Sets [Builder.collisionProbMethod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.collisionProbMethod] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun collisionProbMethod(collisionProbMethod: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.concernNotes] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun concernNotes(concernNotes: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.crAoM1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crAoM1(crAoM1: JsonField<Double>) =
            apply {
                this.crAoM1 = crAoM1
            }
         ...
         *
         * You should usually call [Builder.crAoM2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crAoM2(crAoM2: JsonField<Double>) =
            apply {
                this.crAoM2 = crAoM2
            }
         ...
         *
         * You should usually call [Builder.ephemName1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ephemName1(ephemName1: JsonField<String>) =
            apply {
                this.ephemName1 = ephemName1
            }
         ...
         *
         * You should usually call [Builder.ephemName2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ephemName2(ephemName2: JsonField<String>) =
            apply {
                this.ephemName2 = ephemName2
            }
         ...
         *
         * You should usually call [Builder.esId1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun esId1(esId1: JsonField<String>) =
            apply {
                this.esId1 = esId1
            }
         ...
         *
         * You should usually call [Builder.esId2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun esId2(esId2: JsonField<String>) =
            apply {
                this.esId2 = esId2
            }
         ...
         *
         * You should usually call [Builder.idOnOrbit1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idOnOrbit1(idOnOrbit1: JsonField<String>) =
            apply {
                this.idOnOrbit1 = idOnOrbit1
            }
         ...
         *
         * You should usually call [Builder.idOnOrbit2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idOnOrbit2(idOnOrbit2: JsonField<String>) =
            apply {
                this.idOnOrbit2 = idOnOrbit2
            }
         ...
         *
         * You should usually call [Builder.idStateVector1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idStateVector1(idStateVector1: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.idStateVector2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idStateVector2(idStateVector2: JsonField<String>) =
            apply {
                this.idStateVector2 = idStateVector2
            }

        /** Used for probability of collision calculation, not Warning/Alert Threshold notifications. */
        fun largeCovWarning(largeCovWarning: Boolean) = largeCovWarning(JsonField.of(largeCovWarning))

        /**
         * Sets [Builder.largeCovWarning] to an arbitrary JSON value.
         *
         * You should usually call [Builder.largeCovWarning] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun largeCovWarning(largeCovWarning: JsonField<Boolean>) =
            apply {
                this.largeCovWarning = largeCovWarning
            }

        /** Used for probability of collision calculation, not Warning/Alert Threshold notifications. */
        fun largeRelPosWarning(largeRelPosWarning: Boolean) = largeRelPosWarning(JsonField.of(largeRelPosWarning))

        /**
         * Sets [Builder.largeRelPosWarning] to an arbitrary JSON value.
         *
         * You should usually call [Builder.largeRelPosWarning] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun largeRelPosWarning(largeRelPosWarning: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.lastObTime1] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lastObTime1(lastObTime1: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.lastObTime2] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lastObTime2(lastObTime2: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.messageFor] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun messageFor(messageFor: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.messageId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.missDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun missDistance(missDistance: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.onOrbit1] with a well-typed [OnorbitFull] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun onOrbit1(onOrbit1: JsonField<OnorbitFull>) =
            apply {
                this.onOrbit1 = onOrbit1
            }
         ...
         *
         * You should usually call [Builder.onOrbit2] with a well-typed [OnorbitFull] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun onOrbit2(onOrbit2: JsonField<OnorbitFull>) =
            apply {
                this.onOrbit2 = onOrbit2
            }
         ...
         *
         * You should usually call [Builder.origIdOnOrbit1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun origIdOnOrbit1(origIdOnOrbit1: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.origIdOnOrbit2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun origIdOnOrbit2(origIdOnOrbit2: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.ownerContacted] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ownerContacted(ownerContacted: JsonField<Boolean>) =
            apply {
                this.ownerContacted = ownerContacted
            }

        /** Penetration Level Sigma. */
        fun penetrationLevelSigma(penetrationLevelSigma: Double) = penetrationLevelSigma(JsonField.of(penetrationLevelSigma))

        /**
         * Sets [Builder.penetrationLevelSigma] to an arbitrary JSON value.
         *
         * You should usually call [Builder.penetrationLevelSigma] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun penetrationLevelSigma(penetrationLevelSigma: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.relPosN] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relPosN(relPosN: JsonField<Double>) =
            apply {
                this.relPosN = relPosN
            }
         ...
         *
         * You should usually call [Builder.relPosR] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relPosR(relPosR: JsonField<Double>) =
            apply {
                this.relPosR = relPosR
            }
         ...
         *
         * You should usually call [Builder.relPosT] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relPosT(relPosT: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.relVelMag] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relVelMag(relVelMag: JsonField<Double>) =
            apply {
                this.relVelMag = relVelMag
            }
         ...
         *
         * You should usually call [Builder.relVelN] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relVelN(relVelN: JsonField<Double>) =
            apply {
                this.relVelN = relVelN
            }
         ...
         *
         * You should usually call [Builder.relVelR] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relVelR(relVelR: JsonField<Double>) =
            apply {
                this.relVelR = relVelR
            }
         ...
         *
         * You should usually call [Builder.relVelT] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relVelT(relVelT: JsonField<Double>) =
            apply {
                this.relVelT = relVelT
            }
         ...
         *
         * You should usually call [Builder.satNo1] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun satNo1(satNo1: JsonField<Int>) =
            apply {
                this.satNo1 = satNo1
            }
         ...
         *
         * You should usually call [Builder.satNo2] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun satNo2(satNo2: JsonField<Int>) =
            apply {
                this.satNo2 = satNo2
            }

        /** The start time in UTC of the screening period for the conjunction assessment. */
        fun screenEntryTime(screenEntryTime: OffsetDateTime) = screenEntryTime(JsonField.of(screenEntryTime))

        /**
         * Sets [Builder.screenEntryTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.screenEntryTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun screenEntryTime(screenEntryTime: JsonField<OffsetDateTime>) =
            apply {
                this.screenEntryTime = screenEntryTime
            }

        /** The stop time in UTC of the screening period for the conjunction assessment. */
        fun screenExitTime(screenExitTime: OffsetDateTime) = screenExitTime(JsonField.of(screenExitTime))

        /**
         * Sets [Builder.screenExitTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.screenExitTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun screenExitTime(screenExitTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.screenVolumeX] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun screenVolumeX(screenVolumeX: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.screenVolumeY] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun screenVolumeY(screenVolumeY: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.screenVolumeZ] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun screenVolumeZ(screenVolumeZ: JsonField<Double>) =
            apply {
                this.screenVolumeZ = screenVolumeZ
            }

        /** Used for probability of collision calculation, not Warning/Alert Threshold notifications. */
        fun smallCovWarning(smallCovWarning: Boolean) = smallCovWarning(JsonField.of(smallCovWarning))

        /**
         * Sets [Builder.smallCovWarning] to an arbitrary JSON value.
         *
         * You should usually call [Builder.smallCovWarning] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun smallCovWarning(smallCovWarning: JsonField<Boolean>) =
            apply {
                this.smallCovWarning = smallCovWarning
            }

        /** Used for probability of collision calculation, not Warning/Alert Threshold notifications. */
        fun smallRelVelWarning(smallRelVelWarning: Boolean) = smallRelVelWarning(JsonField.of(smallRelVelWarning))

        /**
         * Sets [Builder.smallRelVelWarning] to an arbitrary JSON value.
         *
         * You should usually call [Builder.smallRelVelWarning] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun smallRelVelWarning(smallRelVelWarning: JsonField<Boolean>) =
            apply {
                this.smallRelVelWarning = smallRelVelWarning
            }

        /** Flag indicating if State department was notified. */
        fun stateDeptNotified(stateDeptNotified: Boolean) = stateDeptNotified(JsonField.of(stateDeptNotified))

        /**
         * Sets [Builder.stateDeptNotified] to an arbitrary JSON value.
         *
         * You should usually call [Builder.stateDeptNotified] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stateDeptNotified(stateDeptNotified: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.stateVector1] with a well-typed [StateVector1] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stateVector1(stateVector1: JsonField<StateVector1>) =
            apply {
         ...
         *
         * You should usually call [Builder.stateVector2] with a well-typed [StateVector2] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stateVector2(stateVector2: JsonField<StateVector2>) =
            apply {
         ...
         *
         * You should usually call [Builder.thrustAccel1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun thrustAccel1(thrustAccel1: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.thrustAccel2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun thrustAccel2(thrustAccel2: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.uvwWarn] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun uvwWarn(uvwWarn: JsonField<Boolean>) =
            apply {
                this.uvwWarn = uvwWarn
            }
         ...
         *
         * You should usually call [Builder.volEntryTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun volEntryTime(volEntryTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.volExitTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun volExitTime(volExitTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.volShape] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun volShape(volShape: JsonField<String>) =
            apply {
                this.volShape = volShape
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (tca.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (ccir.asKnown().isPresent) 1 else 0) + (if (cdAoM1.asKnown().isPresent) 1 else 0) + (if (cdAoM2.asKnown().isPresent) 1 else 0) + (if (collisionProb.asKnown().isPresent) 1 else 0) + (if (collisionProbMethod.asKnown().isPresent) 1 else 0) + (if (comments.asKnown().isPresent) 1 else 0) + (if (concernNotes.asKnown().isPresent) 1 else 0) + (if (crAoM1.asKnown().isPresent) 1 else 0) + (if (crAoM2.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (ephemName1.asKnown().isPresent) 1 else 0) + (if (ephemName2.asKnown().isPresent) 1 else 0) + (if (esId1.asKnown().isPresent) 1 else 0) + (if (esId2.asKnown().isPresent) 1 else 0) + (if (eventId.asKnown().isPresent) 1 else 0) + (if (idOnOrbit1.asKnown().isPresent) 1 else 0) + (if (idOnOrbit2.asKnown().isPresent) 1 else 0) + (if (idStateVector1.asKnown().isPresent) 1 else 0) + (if (idStateVector2.asKnown().isPresent) 1 else 0) + (if (largeCovWarning.asKnown().isPresent) 1 else 0) + (if (largeRelPosWarning.asKnown().isPresent) 1 else 0) + (if (lastObTime1.asKnown().isPresent) 1 else 0) + (if (lastObTime2.asKnown().isPresent) 1 else 0) + (if (messageFor.asKnown().isPresent) 1 else 0) + (if (messageId.asKnown().isPresent) 1 else 0) + (if (missDistance.asKnown().isPresent) 1 else 0) + (onOrbit1.asKnown().getOrNull()?.validity() ?: 0) + (onOrbit2.asKnown().getOrNull()?.validity() ?: 0) + (if (origIdOnOrbit1.asKnown().isPresent) 1 else 0) + (if (origIdOnOrbit2.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (originator.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (ownerContacted.asKnown().isPresent) 1 else 0) + (if (penetrationLevelSigma.asKnown().isPresent) 1 else 0) + (if (rawFileUri.asKnown().isPresent) 1 else 0) + (if (relPosN.asKnown().isPresent) 1 else 0) + (if (relPosR.asKnown().isPresent) 1 else 0) + (if (relPosT.asKnown().isPresent) 1 else 0) + (if (relVelMag.asKnown().isPresent) 1 else 0) + (if (relVelN.asKnown().isPresent) 1 else 0) + (if (relVelR.asKnown().isPresent) 1 else 0) + (if (relVelT.asKnown().isPresent) 1 else 0) + (if (satNo1.asKnown().isPresent) 1 else 0) + (if (satNo2.asKnown().isPresent) 1 else 0) + (if (screenEntryTime.asKnown().isPresent) 1 else 0) + (if (screenExitTime.asKnown().isPresent) 1 else 0) + (if (screenVolumeX.asKnown().isPresent) 1 else 0) + (if (screenVolumeY.asKnown().isPresent) 1 else 0) + (if (screenVolumeZ.asKnown().isPresent) 1 else 0) + (if (smallCovWarning.asKnown().isPresent) 1 else 0) + (if (smallRelVelWarning.asKnown().isPresent) 1 else 0) + (if (stateDeptNotified.asKnown().isPresent) 1 else 0) + (stateVector1.asKnown().getOrNull()?.validity() ?: 0) + (stateVector2.asKnown().getOrNull()?.validity() ?: 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (thrustAccel1.asKnown().isPresent) 1 else 0) + (if (thrustAccel2.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (uvwWarn.asKnown().isPresent) 1 else 0) + (if (volEntryTime.asKnown().isPresent) 1 else 0) + (if (volExitTime.asKnown().isPresent) 1 else 0) + (if (volShape.asKnown().isPresent) 1 else 0)
    ...
    /** This service provides operations for querying and manipulation of state vectors for OnOrbit objects. State vectors are cartesian vectors of position (r) and velocity (v) that, together with their time (epoch) (t), uniquely determine the trajectory of the orbiting body in space. J2000 is the preferred coordinate frame for all state vector positions/velocities in UDL, but in some cases data may be in another frame depending on the provider and/or datatype. Please see the 'Discover' tab in the storefront to confirm coordinate frames by data provider. */
    class StateVector1 private constructor(
        private val classificationMarking: JsonField<String>,
        private val dataMode: JsonField<DataMode>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(stateVector1: StateVector1) =
                apply {
    ...
    class StateVector2 private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(stateVector2: StateVector2) =
                apply {
