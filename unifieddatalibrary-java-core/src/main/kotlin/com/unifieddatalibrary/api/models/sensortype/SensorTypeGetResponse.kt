...
class SensorTypeGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorTypeGetResponse].
         *
    ...
    /** A builder for [SensorTypeGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeGetResponse: SensorTypeGetResponse) =
            apply {
                dataMode = sensorTypeGetResponse.dataMode
                source = sensorTypeGetResponse.source
                id = sensorTypeGetResponse.id
                createdAt = sensorTypeGetResponse.createdAt
                createdBy = sensorTypeGetResponse.createdBy
                origNetwork = sensorTypeGetResponse.origNetwork
                type = sensorTypeGetResponse.type
                updatedAt = sensorTypeGetResponse.updatedAt
                updatedBy = sensorTypeGetResponse.updatedBy
                additionalProperties = sensorTypeGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorTypeGetResponse].
         *
         ...
         */
        fun build(): SensorTypeGetResponse =
    ...
    fun validate(): SensorTypeGetResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "SensorTypeGetResponse{dataMode=$dataMode, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origNetwork=$origNetwork, type=$type, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
