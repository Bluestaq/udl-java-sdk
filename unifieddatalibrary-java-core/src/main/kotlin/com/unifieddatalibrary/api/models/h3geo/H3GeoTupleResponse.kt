...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [H3GeoTupleResponse].
         *
    ...
    /** A builder for [H3GeoTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoTupleResponse: H3GeoTupleResponse) = apply {
            cells = h3GeoTupleResponse.cells.map { it.toMutableList() }
            classificationMarking = h3GeoTupleResponse.classificationMarking
            dataMode = h3GeoTupleResponse.dataMode
            numCells = h3GeoTupleResponse.numCells
            source = h3GeoTupleResponse.source
            startTime = h3GeoTupleResponse.startTime
            id = h3GeoTupleResponse.id
            centerFreq = h3GeoTupleResponse.centerFreq
            createdAt = h3GeoTupleResponse.createdAt
            createdBy = h3GeoTupleResponse.createdBy
            endTime = h3GeoTupleResponse.endTime
            origin = h3GeoTupleResponse.origin
            origNetwork = h3GeoTupleResponse.origNetwork
            resolution = h3GeoTupleResponse.resolution
            sourceDl = h3GeoTupleResponse.sourceDl
            tags = h3GeoTupleResponse.tags.map { it.toMutableList() }
            type = h3GeoTupleResponse.type
            additionalProperties = h3GeoTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [H3GeoTupleResponse].
         *
    ...
    fun validate(): H3GeoTupleResponse = apply {
        if (validated) {
            return@apply
        }
