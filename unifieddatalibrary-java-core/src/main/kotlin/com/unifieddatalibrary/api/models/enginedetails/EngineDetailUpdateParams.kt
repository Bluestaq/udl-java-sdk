...
class EngineDetailUpdateParams private constructor(
     ...
     *
     * Unlike [characteristicType], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [nozzleExpansionRatio], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EngineDetailUpdateParams].
         *
    ...
    /** A builder for [EngineDetailUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineDetailUpdateParams: EngineDetailUpdateParams) =
            apply {
                pathId = engineDetailUpdateParams.pathId
                body = engineDetailUpdateParams.body.toBuilder()
                additionalHeaders = engineDetailUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = engineDetailUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Identifier of the parent engine record. */
        fun idEngine(idEngine: String) =
            apply {
                body.idEngine(idEngine)
            }
        ...
        /** Launch engine maximum burn time in seconds. */
        fun burnTime(burnTime: Double) =
            apply {
                body.burnTime(burnTime)
            }
         ...
         *
         * You should usually call [Builder.chamberPressure] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun chamberPressure(chamberPressure: JsonField<Double>) =
            apply {
                body.chamberPressure(chamberPressure)
            }
         ...
         *
         * You should usually call [Builder.characteristicType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun characteristicType(characteristicType: JsonField<String>) =
            apply {
                body.characteristicType(characteristicType)
            }
        ...
        /** Engine cycle type (e.g. Electrostatic Ion, Pressure Fed, Hall, Catalytic Decomposition, etc.). */
        fun cycleType(cycleType: String) =
            apply {
                body.cycleType(cycleType)
            }

        /**
         * Sets [Builder.cycleType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.cycleType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cycleType(cycleType: JsonField<String>) =
            apply {
                body.cycleType(cycleType)
            }

        /** Engine type or family. */
        fun family(family: String) =
            apply {
                body.family(family)
            }
        ...
        /** Engine maximum number of firings. */
        fun maxFirings(maxFirings: Int) =
            apply {
                body.maxFirings(maxFirings)
            }

        /**
         * Sets [Builder.maxFirings] to an arbitrary JSON value.
         *
         * You should usually call [Builder.maxFirings] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maxFirings(maxFirings: JsonField<Int>) =
            apply {
                body.maxFirings(maxFirings)
            }
         ...
         *
         * You should usually call [Builder.nozzleExpansionRatio] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nozzleExpansionRatio(nozzleExpansionRatio: JsonField<Double>) =
            apply {
                body.nozzleExpansionRatio(nozzleExpansionRatio)
            }
        ...
        /** Oxidizer type (e.g. Nitrogen Tetroxide, Liquid Oxygen, etc). */
        fun oxidizer(oxidizer: String) =
            apply {
                body.oxidizer(oxidizer)
            }
        ...
        /** Propellant/fuel type of the engine (e.g. Liquid Hydrogen, Kerosene, Aerozine, etc). */
        fun propellant(propellant: String) =
            apply {
                body.propellant(propellant)
            }
         ...
         *
         * You should usually call [Builder.seaLevelThrust] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun seaLevelThrust(seaLevelThrust: JsonField<Double>) =
            apply {
                body.seaLevelThrust(seaLevelThrust)
            }
         ...
         *
         * You should usually call [Builder.specificImpulse] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun specificImpulse(specificImpulse: JsonField<Double>) =
            apply {
                body.specificImpulse(specificImpulse)
            }
        ...
        /** Engine maximum thrust in a vacuum in Kilo-Newtons. */
        fun vacuumThrust(vacuumThrust: Double) =
            apply {
         ...
         *
         * You should usually call [Builder.vacuumThrust] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vacuumThrust(vacuumThrust: JsonField<Double>) =
            apply {
                body.vacuumThrust(vacuumThrust)
            }
        ...
        /**
         * Returns an immutable instance of [EngineDetailUpdateParams].
         *
         ...
         */
        fun build(): EngineDetailUpdateParams =
    ...
    class Body private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("chamberPressure") @ExcludeMissing chamberPressure: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("characteristicType") @ExcludeMissing characteristicType: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("nozzleExpansionRatio") @ExcludeMissing nozzleExpansionRatio: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("seaLevelThrust") @ExcludeMissing seaLevelThrust: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("specificImpulse") @ExcludeMissing specificImpulse: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("tags") @ExcludeMissing tags: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("vacuumThrust") @ExcludeMissing vacuumThrust: JsonField<Double> = JsonMissing.of()
        ) : this(
          classificationMarking,
          dataMode,
          idEngine,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun characteristicType(): Optional<String> = characteristicType.getOptional("characteristicType")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun nozzleExpansionRatio(): Optional<Double> = nozzleExpansionRatio.getOptional("nozzleExpansionRatio")
        ...
        @ExcludeMissing
        fun _cycleType(): JsonField<String> = cycleType
        ...
        @ExcludeMissing
        fun _maxFirings(): JsonField<Int> = maxFirings
        ...
        class Builder internal constructor() {
            ...
            /** Engine chamber pressure in bars. */
            fun chamberPressure(chamberPressure: Double) = chamberPressure(JsonField.of(chamberPressure))
            ...
            /** Engine characteristic type (e.g. Electric, Mono-propellant, Bi-propellant, etc.). */
            fun characteristicType(characteristicType: String) = characteristicType(JsonField.of(characteristicType))
            ...
            /** Engine nozzle expansion ratio. */
            fun nozzleExpansionRatio(nozzleExpansionRatio: Double) = nozzleExpansionRatio(JsonField.of(nozzleExpansionRatio))
            ...
            /** Launch engine specific impulse in seconds. */
            fun specificImpulse(specificImpulse: Double) = specificImpulse(JsonField.of(specificImpulse))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idEngine.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (burnTime.asKnown().isPresent) 1 else 0) + (if (chamberPressure.asKnown().isPresent) 1 else 0) + (if (characteristicType.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (cycleType.asKnown().isPresent) 1 else 0) + (if (family.asKnown().isPresent) 1 else 0) + (if (manufacturerOrgId.asKnown().isPresent) 1 else 0) + (if (maxFirings.asKnown().isPresent) 1 else 0) + (if (notes.asKnown().isPresent) 1 else 0) + (if (nozzleExpansionRatio.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (oxidizer.asKnown().isPresent) 1 else 0) + (if (propellant.asKnown().isPresent) 1 else 0) + (if (seaLevelThrust.asKnown().isPresent) 1 else 0) + (if (specificImpulse.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (vacuumThrust.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EngineDetailUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "EngineDetailUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
