...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SgiGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SgiGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SgiGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sgiGetParams: SgiGetParams) = apply {
            id = sgiGetParams.id
            firstResult = sgiGetParams.firstResult
            maxResults = sgiGetParams.maxResults
            additionalHeaders = sgiGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = sgiGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SgiGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SgiGetParams =
            SgiGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SgiGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SgiGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
