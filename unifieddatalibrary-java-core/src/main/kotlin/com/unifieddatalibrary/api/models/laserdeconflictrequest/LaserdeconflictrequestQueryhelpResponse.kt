...
class LaserdeconflictrequestQueryhelpResponse
...
private constructor(
    ...
    /** A builder for [LaserdeconflictrequestQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            laserdeconflictrequestQueryhelpResponse: LaserdeconflictrequestQueryhelpResponse
        ) = apply {
            aodrSupported = laserdeconflictrequestQueryhelpResponse.aodrSupported
            classificationMarking = laserdeconflictrequestQueryhelpResponse.classificationMarking
            description = laserdeconflictrequestQueryhelpResponse.description
            historySupported = laserdeconflictrequestQueryhelpResponse.historySupported
            name = laserdeconflictrequestQueryhelpResponse.name
            parameters =
                laserdeconflictrequestQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                laserdeconflictrequestQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = laserdeconflictrequestQueryhelpResponse.restSupported
            sortSupported = laserdeconflictrequestQueryhelpResponse.sortSupported
            typeName = laserdeconflictrequestQueryhelpResponse.typeName
            uri = laserdeconflictrequestQueryhelpResponse.uri
            additionalProperties =
                laserdeconflictrequestQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LaserdeconflictrequestQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaserdeconflictrequestQueryhelpResponse =
            LaserdeconflictrequestQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): LaserdeconflictrequestQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaserdeconflictrequestQueryhelpResponse &&
