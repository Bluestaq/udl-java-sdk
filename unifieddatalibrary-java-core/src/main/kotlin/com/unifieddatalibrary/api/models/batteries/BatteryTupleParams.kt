...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatteryTupleParams].
         *
    ...
    /** A builder for [BatteryTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batteryTupleParams: BatteryTupleParams) = apply {
            columns = batteryTupleParams.columns
            firstResult = batteryTupleParams.firstResult
            maxResults = batteryTupleParams.maxResults
            additionalHeaders = batteryTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = batteryTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatteryTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatteryTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BatteryTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
