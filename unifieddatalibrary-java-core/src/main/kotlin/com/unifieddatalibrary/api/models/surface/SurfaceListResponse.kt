...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceListResponse: SurfaceListResponse) = apply {
    ...
    fun validate(): SurfaceListResponse = apply {
        if (validated) {
            return@apply
        }
