...
class SurfaceListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SurfaceListResponse].
         *
    ...
    /** A builder for [SurfaceListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceListResponse: SurfaceListResponse) =
            apply {
                classificationMarking = surfaceListResponse.classificationMarking
                dataMode = surfaceListResponse.dataMode
                name = surfaceListResponse.name
                source = surfaceListResponse.source
                type = surfaceListResponse.type
                id = surfaceListResponse.id
                altSiteId = surfaceListResponse.altSiteId
                condition = surfaceListResponse.condition
                createdAt = surfaceListResponse.createdAt
                createdBy = surfaceListResponse.createdBy
                ddtWtKip = surfaceListResponse.ddtWtKip
                ddtWtKipMod = surfaceListResponse.ddtWtKipMod
                ddtWtKipModNote = surfaceListResponse.ddtWtKipModNote
                ddtWtKn = surfaceListResponse.ddtWtKn
                ddWtKip = surfaceListResponse.ddWtKip
                ddWtKipMod = surfaceListResponse.ddWtKipMod
                ddWtKipModNote = surfaceListResponse.ddWtKipModNote
                ddWtKn = surfaceListResponse.ddWtKn
                endLat = surfaceListResponse.endLat
                endLon = surfaceListResponse.endLon
                idSite = surfaceListResponse.idSite
                lcn = surfaceListResponse.lcn
                ldaFt = surfaceListResponse.ldaFt
                ldaM = surfaceListResponse.ldaM
                lengthFt = surfaceListResponse.lengthFt
                lengthM = surfaceListResponse.lengthM
                lighting = surfaceListResponse.lighting
                lightsAprch = surfaceListResponse.lightsAprch
                lightsCl = surfaceListResponse.lightsCl
                lightsOls = surfaceListResponse.lightsOls
                lightsPapi = surfaceListResponse.lightsPapi
                lightsReil = surfaceListResponse.lightsReil
                lightsRwy = surfaceListResponse.lightsRwy
                lightsSeqfl = surfaceListResponse.lightsSeqfl
                lightsTdzl = surfaceListResponse.lightsTdzl
                lightsUnkn = surfaceListResponse.lightsUnkn
                lightsVasi = surfaceListResponse.lightsVasi
                material = surfaceListResponse.material
                obstacle = surfaceListResponse.obstacle
                origin = surfaceListResponse.origin
                origNetwork = surfaceListResponse.origNetwork
                pcn = surfaceListResponse.pcn
                pointReference = surfaceListResponse.pointReference
                primary = surfaceListResponse.primary
                rawWbc = surfaceListResponse.rawWbc
                sbttWtKip = surfaceListResponse.sbttWtKip
                sbttWtKipMod = surfaceListResponse.sbttWtKipMod
                sbttWtKipModNote = surfaceListResponse.sbttWtKipModNote
                sbttWtKn = surfaceListResponse.sbttWtKn
                startLat = surfaceListResponse.startLat
                startLon = surfaceListResponse.startLon
                stWtKip = surfaceListResponse.stWtKip
                stWtKipMod = surfaceListResponse.stWtKipMod
                stWtKipModNote = surfaceListResponse.stWtKipModNote
                stWtKn = surfaceListResponse.stWtKn
                sWtKip = surfaceListResponse.sWtKip
                sWtKipMod = surfaceListResponse.sWtKipMod
                sWtKipModNote = surfaceListResponse.sWtKipModNote
                sWtKn = surfaceListResponse.sWtKn
                tdtWtkip = surfaceListResponse.tdtWtkip
                tdtWtKipMod = surfaceListResponse.tdtWtKipMod
                tdtWtKipModNote = surfaceListResponse.tdtWtKipModNote
                tdtWtKn = surfaceListResponse.tdtWtKn
                trtWtKip = surfaceListResponse.trtWtKip
                trtWtKipMod = surfaceListResponse.trtWtKipMod
                trtWtKipModNote = surfaceListResponse.trtWtKipModNote
                trtWtKn = surfaceListResponse.trtWtKn
                ttWtKip = surfaceListResponse.ttWtKip
                ttWtKipMod = surfaceListResponse.ttWtKipMod
                ttWtKipModNote = surfaceListResponse.ttWtKipModNote
                ttWtKn = surfaceListResponse.ttWtKn
                tWtKip = surfaceListResponse.tWtKip
                tWtKipMod = surfaceListResponse.tWtKipMod
                tWtKipModNote = surfaceListResponse.tWtKipModNote
                tWtKn = surfaceListResponse.tWtKn
                widthFt = surfaceListResponse.widthFt
                widthM = surfaceListResponse.widthM
                additionalProperties = surfaceListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceListResponse].
         *
    ...
    fun validate(): SurfaceListResponse =
        apply {
            if (validated) {
              return@apply
            }
