 ...
 */
class AirspaceControlOrderTupleParams
private constructor(
    ...
    /** A builder for [AirspaceControlOrderTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airspaceControlOrderTupleParams: AirspaceControlOrderTupleParams) =
            apply {
                columns = airspaceControlOrderTupleParams.columns
                firstResult = airspaceControlOrderTupleParams.firstResult
                maxResults = airspaceControlOrderTupleParams.maxResults
                additionalHeaders = airspaceControlOrderTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    airspaceControlOrderTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirspaceControlOrderTupleParams].
         *
         ...
         */
        fun build(): AirspaceControlOrderTupleParams =
            AirspaceControlOrderTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirspaceControlOrderTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirspaceControlOrderTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
