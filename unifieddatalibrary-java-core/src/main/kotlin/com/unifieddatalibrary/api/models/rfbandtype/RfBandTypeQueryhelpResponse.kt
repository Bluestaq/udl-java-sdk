...
class RfBandTypeQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeQueryhelpResponse: RfBandTypeQueryhelpResponse) = apply {
    ...
    fun validate(): RfBandTypeQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
