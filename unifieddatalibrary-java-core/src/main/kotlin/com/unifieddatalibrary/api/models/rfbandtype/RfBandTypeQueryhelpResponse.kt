...
class RfBandTypeQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RfBandTypeQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfBandTypeQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeQueryhelpResponse: RfBandTypeQueryhelpResponse) =
            apply {
                aodrSupported = rfBandTypeQueryhelpResponse.aodrSupported
                classificationMarking = rfBandTypeQueryhelpResponse.classificationMarking
                description = rfBandTypeQueryhelpResponse.description
                historySupported = rfBandTypeQueryhelpResponse.historySupported
                name = rfBandTypeQueryhelpResponse.name
                parameters = rfBandTypeQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = rfBandTypeQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = rfBandTypeQueryhelpResponse.restSupported
                sortSupported = rfBandTypeQueryhelpResponse.sortSupported
                typeName = rfBandTypeQueryhelpResponse.typeName
                uri = rfBandTypeQueryhelpResponse.uri
                additionalProperties = rfBandTypeQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RfBandTypeQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfBandTypeQueryhelpResponse =
    ...
    fun validate(): RfBandTypeQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfBandTypeQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
