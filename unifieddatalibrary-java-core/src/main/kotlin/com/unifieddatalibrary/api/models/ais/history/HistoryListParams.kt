...
package com.unifieddatalibrary.api.models.ais.history
...
class HistoryListParams private constructor(
    ...
    override fun toString() = "HistoryListParams{ts=$ts, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
