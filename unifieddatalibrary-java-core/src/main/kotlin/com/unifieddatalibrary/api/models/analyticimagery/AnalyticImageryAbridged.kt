...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryAbridged: AnalyticImageryAbridged) = apply {
    ...
    fun validate(): AnalyticImageryAbridged = apply {
        if (validated) {
            return@apply
        }
