...
private constructor(
    ...
    fun diplomaticClearanceCountryContacts(): Optional<List<DiplomaticClearanceCountryContact>> =
        body.diplomaticClearanceCountryContacts()
    ...
    fun diplomaticClearanceCountryEntryExitPoints():
        ...
        body.diplomaticClearanceCountryEntryExitPoints()
    ...
    fun diplomaticClearanceCountryProfiles(): Optional<List<DiplomaticClearanceCountryProfile>> =
        body.diplomaticClearanceCountryProfiles()
    ...
    fun _diplomaticClearanceCountryContacts(): JsonField<List<DiplomaticClearanceCountryContact>> =
        body._diplomaticClearanceCountryContacts()
    ...
    fun _diplomaticClearanceCountryEntryExitPoints():
        ...
        body._diplomaticClearanceCountryEntryExitPoints()
    ...
    fun _diplomaticClearanceCountryProfiles(): JsonField<List<DiplomaticClearanceCountryProfile>> =
        body._diplomaticClearanceCountryProfiles()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryUpdateParams: CountryUpdateParams) = apply {
         ...
         */
        fun lastChangedDate(lastChangedDate: OffsetDateTime) = apply {
         ...
         */
        fun acceptsDms(acceptsDms: Boolean) = apply { body.acceptsDms(acceptsDms) }
         ...
         * value.
         */
        fun acceptsDms(acceptsDms: JsonField<Boolean>) = apply { body.acceptsDms(acceptsDms) }

        /**
         * Flag indicating whether this country's diplomatic clearance office can receive messages
         * via email.
         */
        fun acceptsEmail(acceptsEmail: Boolean) = apply { body.acceptsEmail(acceptsEmail) }
         ...
         * via fax.
         */
        fun acceptsFax(acceptsFax: Boolean) = apply { body.acceptsFax(acceptsFax) }
         ...
         * value.
         */
        fun acceptsFax(acceptsFax: JsonField<Boolean>) = apply { body.acceptsFax(acceptsFax) }

        /**
         * Flag indicating whether this country's diplomatic clearance office can receive messages
         * via SIPRNet.
         */
        fun acceptsSiprNet(acceptsSiprNet: Boolean) = apply { body.acceptsSiprNet(acceptsSiprNet) }
        ...
        /** The source agency of the diplomatic clearance country data. */
        fun agency(agency: String) = apply { body.agency(agency) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun agency(agency: JsonField<String>) = apply { body.agency(agency) }
         ...
         * format.
         */
        fun closeTime(closeTime: String) = apply { body.closeTime(closeTime) }
         ...
         * value.
         */
        fun closeTime(closeTime: JsonField<String>) = apply { body.closeTime(closeTime) }

        /** System generated code used to identify a country. */
        fun countryId(countryId: String) = apply { body.countryId(countryId) }
         ...
         * value.
         */
        fun countryId(countryId: JsonField<String>) = apply { body.countryId(countryId) }
        ...
        /** Remarks concerning the country for which the diplomatic clearance will be issued. */
        fun countryRemark(countryRemark: String) = apply { body.countryRemark(countryRemark) }
        ...
        ) = apply { body.diplomaticClearanceCountryContacts(diplomaticClearanceCountryContacts) }
        ...
        ) = apply { body.addDiplomaticClearanceCountryContact(diplomaticClearanceCountryContact) }
        ...
        fun addDiplomaticClearanceCountryEntryExitPoint(
            ...
            body.addDiplomaticClearanceCountryEntryExitPoint(
        ...
        ) = apply { body.diplomaticClearanceCountryProfiles(diplomaticClearanceCountryProfiles) }
        ...
        ) = apply { body.addDiplomaticClearanceCountryProfile(diplomaticClearanceCountryProfile) }

        /** Flag indicating whether a diplomatic clearance profile exists for this country. */
        fun existingProfile(existingProfile: Boolean) = apply {
        ...
        /** Name of this country's diplomatic clearance office. */
        fun officeName(officeName: String) = apply { body.officeName(officeName) }
         ...
         * value.
         */
        fun officeName(officeName: JsonField<String>) = apply { body.officeName(officeName) }

        /** Name of the point of contact for this country's diplomatic clearance office. */
        fun officePoc(officePoc: String) = apply { body.officePoc(officePoc) }
         ...
         * value.
         */
        fun officePoc(officePoc: JsonField<String>) = apply { body.officePoc(officePoc) }

        /** Remarks concerning this country's diplomatic clearance office. */
        fun officeRemark(officeRemark: String) = apply { body.officeRemark(officeRemark) }
        ...
        /** Flag indicating whether this country's diplomatic clearance office is open on Friday. */
        fun openFri(openFri: Boolean) = apply { body.openFri(openFri) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun openFri(openFri: JsonField<Boolean>) = apply { body.openFri(openFri) }

        /** Flag indicating whether this country's diplomatic clearance office is open on Monday. */
        fun openMon(openMon: Boolean) = apply { body.openMon(openMon) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun openMon(openMon: JsonField<Boolean>) = apply { body.openMon(openMon) }

        /**
         * Flag indicating whether this country's diplomatic clearance office is open on Saturday.
         */
        fun openSat(openSat: Boolean) = apply { body.openSat(openSat) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun openSat(openSat: JsonField<Boolean>) = apply { body.openSat(openSat) }

        /** Flag indicating whether this country's diplomatic clearance office is open on Sunday. */
        fun openSun(openSun: Boolean) = apply { body.openSun(openSun) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun openSun(openSun: JsonField<Boolean>) = apply { body.openSun(openSun) }

        /**
         * Flag indicating whether this country's diplomatic clearance office is open on Thursday.
         */
        fun openThu(openThu: Boolean) = apply { body.openThu(openThu) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun openThu(openThu: JsonField<Boolean>) = apply { body.openThu(openThu) }

        /**
         * Zulu opening time of this country's diplomatic clearance office expressed in HH:MM
         * format.
         */
        fun openTime(openTime: String) = apply { body.openTime(openTime) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun openTime(openTime: JsonField<String>) = apply { body.openTime(openTime) }

        /**
         * Flag indicating whether this country's diplomatic clearance office is open on Tuesday.
         */
        fun openTue(openTue: Boolean) = apply { body.openTue(openTue) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun openTue(openTue: JsonField<Boolean>) = apply { body.openTue(openTue) }

        /**
         * Flag indicating whether this country's diplomatic clearance office is open on Wednesday.
         */
        fun openWed(openWed: Boolean) = apply { body.openWed(openWed) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun openWed(openWed: JsonField<Boolean>) = apply { body.openWed(openWed) }
    ...
    override fun toString() =
        "CountryUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
