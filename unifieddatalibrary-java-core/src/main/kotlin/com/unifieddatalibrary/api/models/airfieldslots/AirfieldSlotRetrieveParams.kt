 ...
 * parameter.
 */
class AirfieldSlotRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldSlotRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotRetrieveParams: AirfieldSlotRetrieveParams) = apply {
    ...
    override fun toString() =
        "AirfieldSlotRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
