...
class AirfieldSlotRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AirfieldSlotRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AirfieldSlotRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirfieldSlotRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotRetrieveParams: AirfieldSlotRetrieveParams) =
            apply {
                id = airfieldSlotRetrieveParams.id
                firstResult = airfieldSlotRetrieveParams.firstResult
                maxResults = airfieldSlotRetrieveParams.maxResults
                additionalHeaders = airfieldSlotRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = airfieldSlotRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldSlotRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirfieldSlotRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirfieldSlotRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirfieldSlotRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
