...
private constructor(
    ...
    private val items: List<NotificationFull>,
) : Page<NotificationFull> {
    ...
    fun autoPager(): AutoPager<NotificationFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<NotificationFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<NotificationFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<NotificationFull>) = apply { this.items = items }
