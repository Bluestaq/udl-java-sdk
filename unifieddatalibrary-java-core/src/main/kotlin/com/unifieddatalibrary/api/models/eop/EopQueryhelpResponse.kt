...
class EopQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EopQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EopQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopQueryhelpResponse: EopQueryhelpResponse) =
            apply {
                aodrSupported = eopQueryhelpResponse.aodrSupported
                classificationMarking = eopQueryhelpResponse.classificationMarking
                description = eopQueryhelpResponse.description
                historySupported = eopQueryhelpResponse.historySupported
                name = eopQueryhelpResponse.name
                parameters = eopQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = eopQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = eopQueryhelpResponse.restSupported
                sortSupported = eopQueryhelpResponse.sortSupported
                typeName = eopQueryhelpResponse.typeName
                uri = eopQueryhelpResponse.uri
                additionalProperties = eopQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EopQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EopQueryhelpResponse =
    ...
    fun validate(): EopQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EopQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
