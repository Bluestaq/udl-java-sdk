...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopQueryhelpResponse: EopQueryhelpResponse) = apply {
    ...
    fun validate(): EopQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
