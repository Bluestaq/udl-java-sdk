...
class CountryAbridged private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryAbridged: CountryAbridged) =
            apply {
    ...
    override fun toString() = "CountryAbridged{code=$code, dataMode=$dataMode, source=$source, codeAlt=$codeAlt, createdAt=$createdAt, createdBy=$createdBy, fipsCode=$fipsCode, iso3Code=$iso3Code, name=$name, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
