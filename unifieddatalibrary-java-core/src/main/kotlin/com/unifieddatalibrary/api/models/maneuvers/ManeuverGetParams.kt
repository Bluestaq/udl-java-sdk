...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ManeuverGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ManeuverGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ManeuverGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(maneuverGetParams: ManeuverGetParams) = apply {
            id = maneuverGetParams.id
            firstResult = maneuverGetParams.firstResult
            maxResults = maneuverGetParams.maxResults
            additionalHeaders = maneuverGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = maneuverGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ManeuverGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ManeuverGetParams =
            ManeuverGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ManeuverGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ManeuverGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
