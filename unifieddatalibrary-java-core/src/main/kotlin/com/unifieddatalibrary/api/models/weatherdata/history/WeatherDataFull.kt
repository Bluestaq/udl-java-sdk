...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataFull: WeatherDataFull) = apply {
    ...
    fun validate(): WeatherDataFull = apply {
        if (validated) {
            return@apply
        }
