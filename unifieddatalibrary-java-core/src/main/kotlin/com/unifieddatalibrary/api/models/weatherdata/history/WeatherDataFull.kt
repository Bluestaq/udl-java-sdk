...
class WeatherDataFull private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WeatherDataFull].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataFull: WeatherDataFull) =
            apply {
                classificationMarking = weatherDataFull.classificationMarking
                dataMode = weatherDataFull.dataMode
                obTime = weatherDataFull.obTime
                source = weatherDataFull.source
                id = weatherDataFull.id
                angleOrientation = weatherDataFull.angleOrientation
                avgRefPwr = weatherDataFull.avgRefPwr
                avgTxPwr = weatherDataFull.avgTxPwr
                checksum = weatherDataFull.checksum
                coIntegs = weatherDataFull.coIntegs.map { it.toMutableList() }
                consRecs = weatherDataFull.consRecs.map { it.toMutableList() }
                createdAt = weatherDataFull.createdAt
                createdBy = weatherDataFull.createdBy
                doppVels = weatherDataFull.doppVels.map { it.toMutableList() }
                fileCreation = weatherDataFull.fileCreation
                firstGuessAvgs = weatherDataFull.firstGuessAvgs.map { it.toMutableList() }
                idSensor = weatherDataFull.idSensor
                interpulsePeriods = weatherDataFull.interpulsePeriods.map { it.toMutableList() }
                lightDetSensors = weatherDataFull.lightDetSensors.map { it.toMutableList() }
                lightEventNum = weatherDataFull.lightEventNum
                noiseLvls = weatherDataFull.noiseLvls.map { it.toMutableList() }
                numElements = weatherDataFull.numElements
                origin = weatherDataFull.origin
                origNetwork = weatherDataFull.origNetwork
                origSensorId = weatherDataFull.origSensorId
                posConfidence = weatherDataFull.posConfidence
                qcValue = weatherDataFull.qcValue
                sectorNum = weatherDataFull.sectorNum
                semiMajorAxis = weatherDataFull.semiMajorAxis
                semiMinorAxis = weatherDataFull.semiMinorAxis
                sigPwrs = weatherDataFull.sigPwrs.map { it.toMutableList() }
                sigStrength = weatherDataFull.sigStrength
                snrs = weatherDataFull.snrs.map { it.toMutableList() }
                specAvgs = weatherDataFull.specAvgs.map { it.toMutableList() }
                specWidths = weatherDataFull.specWidths.map { it.toMutableList() }
                srcIds = weatherDataFull.srcIds.map { it.toMutableList() }
                srcTyps = weatherDataFull.srcTyps.map { it.toMutableList() }
                tdAvgSampleNums = weatherDataFull.tdAvgSampleNums.map { it.toMutableList() }
                termAlt = weatherDataFull.termAlt
                additionalProperties = weatherDataFull.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [WeatherDataFull].
         *
