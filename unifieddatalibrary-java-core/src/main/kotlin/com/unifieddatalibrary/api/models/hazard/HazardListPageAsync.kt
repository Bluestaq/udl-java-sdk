...
class HazardListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardListPageAsync: HazardListPageAsync) =
            apply {
        ...
        fun service(service: HazardServiceAsync) =
            apply {
    ...
    override fun toString() = "HazardListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
