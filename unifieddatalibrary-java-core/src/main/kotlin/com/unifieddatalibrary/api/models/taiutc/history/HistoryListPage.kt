...
private constructor(
    ...
    private val items: List<TaiutcFull>,
) : Page<TaiutcFull> {
    ...
    fun autoPager(): AutoPager<TaiutcFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<TaiutcFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<TaiutcFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<TaiutcFull>) = apply { this.items = items }
