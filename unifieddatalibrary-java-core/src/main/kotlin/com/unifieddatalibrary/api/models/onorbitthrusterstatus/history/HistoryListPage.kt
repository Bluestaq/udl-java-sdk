...
private constructor(
    ...
    private val items: List<OnorbitthrusterstatusFull>,
) : Page<OnorbitthrusterstatusFull> {
    ...
    fun autoPager(): AutoPager<OnorbitthrusterstatusFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<OnorbitthrusterstatusFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<OnorbitthrusterstatusFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<OnorbitthrusterstatusFull>) = apply { this.items = items }
