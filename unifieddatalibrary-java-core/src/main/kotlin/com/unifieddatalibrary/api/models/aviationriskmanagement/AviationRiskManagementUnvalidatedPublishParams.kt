 ...
 */
class AviationRiskManagementUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [AviationRiskManagementUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body = aviationRiskManagementUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                aviationRiskManagementUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                aviationRiskManagementUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AviationRiskManagementUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): AviationRiskManagementUnvalidatedPublishParams =
            AviationRiskManagementUnvalidatedPublishParams(
    ...
    /**
     * Aviation Risk Management is used to identify, evaluate, and track risks when mission planning
    ...
    private constructor(
        ...
        fun aviationRiskManagementWorksheetRecord():
            ...
            aviationRiskManagementWorksheetRecord.getOptional(
         ...
         *
         * Unlike [aviationRiskManagementWorksheetRecord], this method doesn't throw if the JSON
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                id = body.id
                aviationRiskManagementWorksheetRecord =
                    body.aviationRiskManagementWorksheetRecord.map { it.toMutableList() }
                createdAt = body.createdAt
                createdBy = body.createdBy
                extMissionId = body.extMissionId
             ...
             *
             * You should usually call [Builder.aviationRiskManagementWorksheetRecord] with a
             * well-typed `List<AviationRiskManagementWorksheetRecord>` value instead. This method
            ...
            fun addAviationRiskManagementWorksheetRecord(
                ...
                this.aviationRiskManagementWorksheetRecord =
                    (this.aviationRiskManagementWorksheetRecord ?: JsonField.of(mutableListOf()))
                        .also {
            ...
            /**
             * Optional mission ID from external systems. This field has no meaning within UDL and
             ...
             *
             * You should usually call [Builder.unitId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun approvalPending(): Optional<Boolean> =
                approvalPending.getOptional("approvalPending")
            ...
            fun aviationRiskManagementWorksheetScore():
                ...
                aviationRiskManagementWorksheetScore.getOptional(
                    "aviationRiskManagementWorksheetScore"
                )
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun lastUpdatedAt(): Optional<OffsetDateTime> =
                lastUpdatedAt.getOptional("lastUpdatedAt")
             ...
             *
             * Unlike [missionDate], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("missionDate")
            @ExcludeMissing
             ...
             *
             * Unlike [approvalPending], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("approvalPending")
            @ExcludeMissing
             ...
             *
             * Unlike [extRecordId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("extRecordId")
            @ExcludeMissing
             ...
             *
             * Unlike [itinerary], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("itinerary")
            @ExcludeMissing
            fun _itinerary(): JsonField<String> = itinerary
             ...
             *
             * Unlike [submissionDate], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("submissionDate")
            @ExcludeMissing
             ...
             *
             * Unlike [tierNumber], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("tierNumber")
            @ExcludeMissing
            fun _tierNumber(): JsonField<Int> = tierNumber

            /**
             * Returns the raw JSON value of [totalScore].
             *
             * Unlike [totalScore], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("totalScore")
            @ExcludeMissing
            fun _totalScore(): JsonField<Int> = totalScore
            ...
            class Builder internal constructor() {
                ...
                internal fun from(
                    ...
                    aviationRiskManagementWorksheetScore =
                        aviationRiskManagementWorksheetRecord.aviationRiskManagementWorksheetScore
                 ...
                 *
                 * You should usually call [Builder.approvalPending] with a well-typed [Boolean]
                 ...
                 * well-typed `List<AviationRiskManagementWorksheetScore>` value instead. This
                 * method is primarily for setting the field to an undocumented or not yet supported
                 * value.
                 */
                fun aviationRiskManagementWorksheetScore(
                 ...
                 *
                 * You should usually call [Builder.itinerary] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.lastUpdatedAt] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.submissionDate] with a well-typed
                 * [OffsetDateTime] value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                 ...
                 * For example, Tier 1 may indicate mission planners, Tier 2 may indicate operations
                 * personnel, Tier 3 may indicate squadron leadership, and Tier 4 may indicate the
                 * aircrew.
                 */
                 ...
                 *
                 * You should usually call [Builder.tierNumber] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.totalScore] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(
                ...
                private val aviationRiskManagementSortie:
                    JsonField<List<AviationRiskManagementSortie>>,
                 ...
                 */
                fun approvalDate(): Optional<OffsetDateTime> =
                    approvalDate.getOptional("approvalDate")
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun riskDescription(): Optional<String> =
                    riskDescription.getOptional("riskDescription")
                 ...
                 *
                 * Unlike [approvalDate], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("approvalDate")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [approvedBy], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("approvedBy")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [approvedCode], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("approvedCode")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [aviationRiskManagementSortie], this method doesn't throw if the JSON
                 * field has an unexpected type.
                 */
                @JsonProperty("aviationRiskManagementSortie")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [extScoreId], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("extScoreId")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [riskCategory], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("riskCategory")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [riskKey], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                ...
                @JsonProperty("riskName")
                @ExcludeMissing
                fun _riskName(): JsonField<String> = riskName
                 ...
                 *
                 * Unlike [scoreRemark], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("scoreRemark")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.approvalDate] with a well-typed
                    ...
                    /**
                     * Numeric assignment used to determine score approval. 0 - APPROVAL PENDING
                     * (used when score value is 2 or 3); 1 - APPROVED (used when score value is 2
                     * or 3); 2 - DISAPPROVED.
                     */
                    ...
                    /**
                     * Collection of aviation risk management worksheet record score aircraft
                     * sorties.
                     */
                     ...
                     *
                     * You should usually call [Builder.aviationRiskManagementSortie] with a
                     * well-typed `List<AviationRiskManagementSortie>` value instead. This method is
                    ...
                    fun addAviationRiskManagementSortie(
                        ...
                        this.aviationRiskManagementSortie =
                            (this.aviationRiskManagementSortie ?: JsonField.of(mutableListOf()))
                                .also {
                    ...
                    /**
                     * Optional identifier of the worksheet record score provided by the data
                     * source. This field has no meaning within UDL and is provided as a convenience
                     * for systems that require tracking of an internal system generated ID.
                     */
                    ...
                    /** The category of the risk factor. */
                    fun riskCategory(riskCategory: String) =
                        riskCategory(JsonField.of(riskCategory))

                    /**
                     * Sets [Builder.riskCategory] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.riskCategory] with a well-typed [String]
                     ...
                     *
                     * You should usually call [Builder.score] with a well-typed [Int] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.scoreRemark] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    fun build(): AviationRiskManagementWorksheetScore =
                        AviationRiskManagementWorksheetScore(
                            ...
                            approvedBy,
                            approvedCode,
                            (aviationRiskManagementSortie ?: JsonMissing.of()).map {
                                it.toImmutable()
                            },
                            extScoreId,
                            riskCategory,
                ...
                private constructor(
                     ...
                     *
                     * Unlike [idSortie], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("idSortie")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [legNum], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    ...
                    class Builder internal constructor() {
                        ...
                        /**
                         * Optional aircraft sortie ID from external systems. This field has no
                         * meaning within UDL and is provided as a convenience for systems that
                         * require tracking of an internal system generated ID.
                         */
                        fun extSortieId(extSortieId: String) =
                            extSortieId(JsonField.of(extSortieId))
                        ...
                        /**
                         * Unique identifier of an associated Aircraft Sortie that is assigned to
                         * this risk management record.
                         */
                         ...
                         *
                         * You should usually call [Builder.idSortie] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun idSortie(idSortie: JsonField<String>) = apply {
                        ...
                        /**
                         * The score of the associated aircraft sortie as defined by the data
                         * source. Value ranges from 0 to 3, where a value of 0 indicates a low and
                         * a value of 3 indicates severe. A value of -1 indicates no score.
                         */
                         ...
                         *
                         * You should usually call [Builder.sortieScore] with a well-typed [Int]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AviationRiskManagementUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AviationRiskManagementUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
