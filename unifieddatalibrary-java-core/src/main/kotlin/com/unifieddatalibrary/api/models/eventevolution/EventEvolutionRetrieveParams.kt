...
class EventEvolutionRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EventEvolutionRetrieveParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [EventEvolutionRetrieveParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EventEvolutionRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventEvolutionRetrieveParams: EventEvolutionRetrieveParams) = apply {
            id = eventEvolutionRetrieveParams.id
            firstResult = eventEvolutionRetrieveParams.firstResult
            maxResults = eventEvolutionRetrieveParams.maxResults
            additionalHeaders = eventEvolutionRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = eventEvolutionRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EventEvolutionRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EventEvolutionRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EventEvolutionRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "EventEvolutionRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
