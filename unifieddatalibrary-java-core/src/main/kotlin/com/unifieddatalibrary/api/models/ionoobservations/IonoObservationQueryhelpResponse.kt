...
class IonoObservationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [IonoObservationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ionoObservationQueryhelpResponse: IonoObservationQueryhelpResponse) =
            apply {
                ...
                requiredRoles = ionoObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties = ionoObservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): IonoObservationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
