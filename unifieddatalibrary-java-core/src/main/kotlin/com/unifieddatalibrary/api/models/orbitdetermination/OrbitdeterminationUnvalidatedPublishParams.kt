...
/**
 * Service operation to take multiple OrbitDetermination records as a POST body and ingest into the
 ...
 */
class OrbitdeterminationUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            orbitdeterminationUnvalidatedPublishParams: OrbitdeterminationUnvalidatedPublishParams
        ) = apply {
            body = orbitdeterminationUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                orbitdeterminationUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                orbitdeterminationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    private constructor(
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun ballisticCoeffEst(): Optional<Boolean> =
            ballisticCoeffEst.getOptional("ballisticCoeffEst")
         ...
         *
         * Unlike [acceptedObIds], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("acceptedObIds")
        @ExcludeMissing
         ...
         *
         * Unlike [acceptedObTyps], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("acceptedObTyps")
        @ExcludeMissing
         ...
         *
         * Unlike [aprioriElset], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("aprioriElset")
        @ExcludeMissing
         ...
         *
         * Unlike [aprioriIdElset], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("aprioriIdElset")
        @ExcludeMissing
         ...
         *
         * Unlike [aprioriIdStateVector], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("aprioriIdStateVector")
        @ExcludeMissing
         ...
         *
         * Unlike [aprioriStateVector], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("aprioriStateVector")
        @ExcludeMissing
         ...
         *
         * Unlike [ballisticCoeffModel], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("ballisticCoeffModel")
        @ExcludeMissing
         ...
         *
         * Unlike [bestPassWrms], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [errorGrowthRate], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("errorGrowthRate")
        @ExcludeMissing
         ...
         *
         * Unlike [firstPassWrms], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [methodSource], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [numIterations], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [previousWrms], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [rejectedObIds], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("rejectedObIds")
        @ExcludeMissing
         ...
         *
         * Unlike [rejectedObTyps], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("rejectedObTyps")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.initialOd] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * positionally corresponding UUIDs in this array (the two arrays must match in size).
             */
            fun acceptedObIds(acceptedObIds: List<String>) =
                acceptedObIds(JsonField.of(acceptedObIds))

            /**
             * Sets [Builder.acceptedObIds] to an arbitrary JSON value.
             *
             * You should usually call [Builder.acceptedObIds] with a well-typed `List<String>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /**
             * Array of UDL observation types (e.g. DOA, EO, RADAR, RF) of the observations that
             * were accepted in this OD solution. See the associated acceptedObIds array for the
             * records UUID(s), positionally corresponding to the record types in this array. The
             * acceptedObTyps and acceptedObIds arrays must match in size.
             */
             ...
             *
             * You should usually call [Builder.acceptedObTyps] with a well-typed `List<String>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.agomEst] with a well-typed [Boolean] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Identifier of the element set used to seed this OD solution. This ID can be used to
             * obtain additional information on an Elset object using the 'get by ID' operation
             * (e.g. /udl/elset/{id}). For example, the Elset with idElset = abc would be queried as
             * /udl/elset/abc.
             */
            fun aprioriIdElset(aprioriIdElset: String) =
                aprioriIdElset(JsonField.of(aprioriIdElset))
             ...
             * Identifier of the state vector used to seed this OD solution. This ID can be used to
             * obtain additional information on a StateVector object using the 'get by ID' operation
             * (e.g. /udl/statevector/{id}). For example, the StateVector with idStateVector = abc
             * would be queried as /udl/statevector/abc.
             */
             ...
             *
             * You should usually call [Builder.aprioriIdStateVector] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             * [AprioriStateVector] value instead. This method is primarily for setting the field to
             ...
             *
             * You should usually call [Builder.ballisticCoeffModel] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /**
             * Lowest Weighted Root Mean Squared (RMS) value achieved for any single satellite pass
             * during the observation span, indicating the pass with the highest quality OD
             * solution.
             */
             ...
             *
             * You should usually call [Builder.bestPassWrms] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Optional end time at which this OD solution may no longer be accurate, in ISO 8601
             ...
             *
             * You should usually call [Builder.firstPassWrms] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.fitSpan] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * ISO 8601 UTC datetime format with microsecond precision. For an exact observation
             * time, the lastObStart and lastObEnd are the same.
             */
             ...
             * in ISO 8601 UTC datetime format with microsecond precision. For an exact observation
             * time, the lastObStart and lastObEnd are the same.
             */
             ...
             *
             * You should usually call [Builder.methodSource] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.numIterations] with a well-typed [Int] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Optional identifier provided by the OD source to indicate the target on-orbit object
             * of this OD solution. This may be an internal identifier and not necessarily map to a
            ...
            /**
             * The Weighted Root Mean Squared (RMS) of the differential correction from the previous
             * overhead pass of the satellite. Provides a point of comparison for assessing changes
             * in the quality of the OD solution between consecutive passes.
             */
             ...
             *
             * You should usually call [Builder.previousWrms] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * positionally corresponding UUIDs in this array (the two arrays must match in size).
             */
            fun rejectedObIds(rejectedObIds: List<String>) =
                rejectedObIds(JsonField.of(rejectedObIds))

            /**
             * Sets [Builder.rejectedObIds] to an arbitrary JSON value.
             *
             * You should usually call [Builder.rejectedObIds] with a well-typed `List<String>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            ...
            /**
             * Array of UDL observation types (e.g. DOA, EO, RADAR, RF) of the observations that
             * were rejected in this OD solution. See the associated rejectedObIds array for the
             * records UUID(s), positionally corresponding to the record types in this array. The
             * rejectedObTyps and rejectedObIds arrays must match in size.
             */
             ...
             *
             * You should usually call [Builder.rejectedObTyps] with a well-typed `List<String>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.rmsConvergenceCriteria] with a well-typed [Double]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.timeSpan] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The Weighted Root Mean Squared (RMS) of the differential correction of the target
             * object that produced this OD state. WRMS is a quality indicator of the OD update,
             * with a value of 1.00 being optimal. WRMS applies to batch least squares (BLS)
             * processes.
             */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(aprioriStateVector: AprioriStateVector) = apply {
                    ...
                    sourcedDataTypes =
                        aprioriStateVector.sourcedDataTypes.map { it.toMutableList() }
    ...
    override fun toString() =
        "OrbitdeterminationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
