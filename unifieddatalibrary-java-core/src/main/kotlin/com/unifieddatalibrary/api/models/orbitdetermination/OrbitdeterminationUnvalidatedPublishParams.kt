...
/** Service operation to take multiple OrbitDetermination records as a POST body and ingest into the database. This operation is intended to be used for automated feeds into UDL. A specific role is required to perform this service operation. Please contact the UDL team for assistance. */
class OrbitdeterminationUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbitdeterminationUnvalidatedPublishParams].
         *
    ...
    /** A builder for [OrbitdeterminationUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationUnvalidatedPublishParams: OrbitdeterminationUnvalidatedPublishParams) =
            apply {
                body = orbitdeterminationUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = orbitdeterminationUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = orbitdeterminationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OrbitdeterminationUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): OrbitdeterminationUnvalidatedPublishParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("acceptedObIds") @ExcludeMissing private val acceptedObIds: JsonField<List<String>>,
        @JsonProperty("acceptedObTyps") @ExcludeMissing private val acceptedObTyps: JsonField<List<String>>,
        ...
        @JsonProperty("aprioriElset") @ExcludeMissing private val aprioriElset: JsonField<AprioriElset>,
        @JsonProperty("aprioriIdElset") @ExcludeMissing private val aprioriIdElset: JsonField<String>,
        @JsonProperty("aprioriIdStateVector") @ExcludeMissing private val aprioriIdStateVector: JsonField<String>,
        @JsonProperty("aprioriStateVector") @ExcludeMissing private val aprioriStateVector: JsonField<AprioriStateVector>,
        @JsonProperty("ballisticCoeffEst") @ExcludeMissing private val ballisticCoeffEst: JsonField<Boolean>,
        @JsonProperty("ballisticCoeffModel") @ExcludeMissing private val ballisticCoeffModel: JsonField<String>,
        ...
        @JsonProperty("effectiveFrom") @ExcludeMissing private val effectiveFrom: JsonField<OffsetDateTime>,
        @JsonProperty("effectiveUntil") @ExcludeMissing private val effectiveUntil: JsonField<OffsetDateTime>,
        @JsonProperty("errorGrowthRate") @ExcludeMissing private val errorGrowthRate: JsonField<Double>,
        ...
        @JsonProperty("lastObStart") @ExcludeMissing private val lastObStart: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("rejectedObIds") @ExcludeMissing private val rejectedObIds: JsonField<List<String>>,
        @JsonProperty("rejectedObTyps") @ExcludeMissing private val rejectedObTyps: JsonField<List<String>>,
        @JsonProperty("rmsConvergenceCriteria") @ExcludeMissing private val rmsConvergenceCriteria: JsonField<Double>,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    initialOd = body.initialOd
                    method = body.method
                    source = body.source
                    startTime = body.startTime
                    id = body.id
                    acceptedObIds = body.acceptedObIds.map { it.toMutableList() }
                    acceptedObTyps = body.acceptedObTyps.map { it.toMutableList() }
                    agomEst = body.agomEst
                    agomModel = body.agomModel
                    aprioriElset = body.aprioriElset
                    aprioriIdElset = body.aprioriIdElset
                    aprioriIdStateVector = body.aprioriIdStateVector
                    aprioriStateVector = body.aprioriStateVector
                    ballisticCoeffEst = body.ballisticCoeffEst
                    ballisticCoeffModel = body.ballisticCoeffModel
                    bestPassWrms = body.bestPassWrms
                    createdAt = body.createdAt
                    createdBy = body.createdBy
                    edr = body.edr
                    effectiveFrom = body.effectiveFrom
                    effectiveUntil = body.effectiveUntil
                    errorGrowthRate = body.errorGrowthRate
                    firstPassWrms = body.firstPassWrms
                    fitSpan = body.fitSpan
                    idOnOrbit = body.idOnOrbit
                    lastObEnd = body.lastObEnd
                    lastObStart = body.lastObStart
                    methodSource = body.methodSource
                    numIterations = body.numIterations
                    origin = body.origin
                    origNetwork = body.origNetwork
                    origObjectId = body.origObjectId
                    previousWrms = body.previousWrms
                    rejectedObIds = body.rejectedObIds.map { it.toMutableList() }
                    rejectedObTyps = body.rejectedObTyps.map { it.toMutableList() }
                    rmsConvergenceCriteria = body.rmsConvergenceCriteria
                    satNo = body.satNo
                    sensorIds = body.sensorIds.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbitdeterminationUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OrbitdeterminationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
