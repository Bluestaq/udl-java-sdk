...
class AttitudeSetRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AttitudeSetRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AttitudeSetRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AttitudeSetRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeSetRetrieveParams: AttitudeSetRetrieveParams) =
            apply {
                id = attitudeSetRetrieveParams.id
                firstResult = attitudeSetRetrieveParams.firstResult
                maxResults = attitudeSetRetrieveParams.maxResults
                additionalHeaders = attitudeSetRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = attitudeSetRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AttitudeSetRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AttitudeSetRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AttitudeSetRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AttitudeSetRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
