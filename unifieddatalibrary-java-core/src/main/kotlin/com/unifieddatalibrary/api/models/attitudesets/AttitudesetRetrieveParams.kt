 ...
 */
class AttitudeSetRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AttitudeSetRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeSetRetrieveParams: AttitudeSetRetrieveParams) = apply {
    ...
    override fun toString() =
        "AttitudeSetRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
