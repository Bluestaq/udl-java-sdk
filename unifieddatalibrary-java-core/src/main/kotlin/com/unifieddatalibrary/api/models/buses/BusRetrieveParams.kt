...
class BusRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): BusRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BusRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [BusRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(busRetrieveParams: BusRetrieveParams) =
            apply {
                id = busRetrieveParams.id
                firstResult = busRetrieveParams.firstResult
                maxResults = busRetrieveParams.maxResults
                additionalHeaders = busRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = busRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BusRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BusRetrieveParams =
            BusRetrieveParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BusRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "BusRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
