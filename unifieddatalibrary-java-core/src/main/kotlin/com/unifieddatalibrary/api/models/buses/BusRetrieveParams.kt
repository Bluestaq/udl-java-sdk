...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BusRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(busRetrieveParams: BusRetrieveParams) = apply {
    ...
    override fun toString() =
        "BusRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
