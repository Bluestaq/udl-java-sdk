...
class PoiCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PoiCreateBulkParams].
         *
    ...
    /** A builder for [PoiCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiCreateBulkParams: PoiCreateBulkParams) =
            apply {
                body = poiCreateBulkParams.body.toMutableList()
                additionalHeaders = poiCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = poiCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PoiCreateBulkParams].
         *
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("poiid") @ExcludeMissing private val poiid: JsonField<String>,
        ...
        @JsonProperty("conf") @ExcludeMissing private val conf: JsonField<Double>,
        @JsonProperty("createdAt") @ExcludeMissing private val createdAt: JsonField<OffsetDateTime>,
        @JsonProperty("createdBy") @ExcludeMissing private val createdBy: JsonField<String>,
        @JsonProperty("desc") @ExcludeMissing private val desc: JsonField<String>,
        @JsonProperty("el") @ExcludeMissing private val el: JsonField<Double>,
        @JsonProperty("elle") @ExcludeMissing private val elle: JsonField<List<Double>>,
        @JsonProperty("env") @ExcludeMissing private val env: JsonField<String>,
        @JsonProperty("groups") @ExcludeMissing private val groups: JsonField<List<String>>,
        @JsonProperty("how") @ExcludeMissing private val how: JsonField<String>,
        @JsonProperty("ident") @ExcludeMissing private val ident: JsonField<String>,
        @JsonProperty("idWeatherReport") @ExcludeMissing private val idWeatherReport: JsonField<List<String>>,
        ...
        @JsonProperty("orientation") @ExcludeMissing private val orientation: JsonField<Double>,
        @JsonProperty("origin") @ExcludeMissing private val origin: JsonField<String>,
        @JsonProperty("origNetwork") @ExcludeMissing private val origNetwork: JsonField<String>,
        @JsonProperty("plat") @ExcludeMissing private val plat: JsonField<String>,
        @JsonProperty("pps") @ExcludeMissing private val pps: JsonField<String>,
        @JsonProperty("pri") @ExcludeMissing private val pri: JsonField<Int>,
        @JsonProperty("sourceDL") @ExcludeMissing private val sourceDl: JsonField<String>,
        @JsonProperty("spec") @ExcludeMissing private val spec: JsonField<String>,
        ...
        @JsonProperty("stale") @ExcludeMissing private val stale: JsonField<OffsetDateTime>,
        @JsonProperty("start") @ExcludeMissing private val start: JsonField<OffsetDateTime>,
        ...
        @JsonProperty("urls") @ExcludeMissing private val urls: JsonField<List<String>>,
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, poiid=$poiid, source=$source, ts=$ts, id=$id, activity=$activity, agjson=$agjson, alt=$alt, andims=$andims, area=$area, asrid=$asrid, asset=$asset, atext=$atext, atype=$atype, az=$az, beNumber=$beNumber, ce=$ce, cntct=$cntct, conf=$conf, createdAt=$createdAt, createdBy=$createdBy, desc=$desc, el=$el, elle=$elle, env=$env, groups=$groups, how=$how, ident=$ident, idWeatherReport=$idWeatherReport, lat=$lat, le=$le, lon=$lon, msnid=$msnid, orientation=$orientation, origin=$origin, origNetwork=$origNetwork, plat=$plat, pps=$pps, pri=$pri, sourceDl=$sourceDl, spec=$spec, srcIds=$srcIds, srcTyps=$srcTyps, stale=$stale, start=$start, tags=$tags, transactionId=$transactionId, trkid=$trkid, type=$type, urls=$urls}"
    }
    ...
    override fun toString() = "PoiCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
