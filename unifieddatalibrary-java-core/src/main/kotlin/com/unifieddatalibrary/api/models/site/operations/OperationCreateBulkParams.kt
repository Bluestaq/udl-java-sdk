...
class OperationCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperationCreateBulkParams].
         *
    ...
    /** A builder for [OperationCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationCreateBulkParams: OperationCreateBulkParams) =
            apply {
                body = operationCreateBulkParams.body.toMutableList()
                additionalHeaders = operationCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = operationCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OperationCreateBulkParams].
         *
         ...
         */
        fun build(): OperationCreateBulkParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("dailyOperations") @ExcludeMissing private val dailyOperations: JsonField<List<DailyOperation>>,
        @JsonProperty("dopsLastChangedBy") @ExcludeMissing private val dopsLastChangedBy: JsonField<String>,
        @JsonProperty("dopsLastChangedDate") @ExcludeMissing private val dopsLastChangedDate: JsonField<OffsetDateTime>,
        @JsonProperty("dopsLastChangedReason") @ExcludeMissing private val dopsLastChangedReason: JsonField<String>,
        @JsonProperty("idLaunchSite") @ExcludeMissing private val idLaunchSite: JsonField<String>,
        @JsonProperty("maximumOnGrounds") @ExcludeMissing private val maximumOnGrounds: JsonField<List<MaximumOnGround>>,
        @JsonProperty("mogsLastChangedBy") @ExcludeMissing private val mogsLastChangedBy: JsonField<String>,
        @JsonProperty("mogsLastChangedDate") @ExcludeMissing private val mogsLastChangedDate: JsonField<OffsetDateTime>,
        @JsonProperty("mogsLastChangedReason") @ExcludeMissing private val mogsLastChangedReason: JsonField<String>,
        @JsonProperty("operationalDeviations") @ExcludeMissing private val operationalDeviations: JsonField<List<OperationalDeviation>>,
        @JsonProperty("operationalPlannings") @ExcludeMissing private val operationalPlannings: JsonField<List<OperationalPlanning>>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OperationCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OperationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
