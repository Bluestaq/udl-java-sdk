...
private constructor(
    ...
    private val items: List<WeatherDataFull>,
) : PageAsync<WeatherDataFull> {
    ...
    fun autoPager(): AutoPagerAsync<WeatherDataFull> =
    ...
    override fun items(): List<WeatherDataFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<WeatherDataFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<WeatherDataFull>) = apply { this.items = items }
