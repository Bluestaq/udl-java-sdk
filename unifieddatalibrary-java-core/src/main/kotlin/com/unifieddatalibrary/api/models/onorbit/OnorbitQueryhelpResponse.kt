...
class OnorbitQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OnorbitQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OnorbitQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitQueryhelpResponse: OnorbitQueryhelpResponse) =
            apply {
                aodrSupported = onorbitQueryhelpResponse.aodrSupported
                classificationMarking = onorbitQueryhelpResponse.classificationMarking
                description = onorbitQueryhelpResponse.description
                historySupported = onorbitQueryhelpResponse.historySupported
                name = onorbitQueryhelpResponse.name
                parameters = onorbitQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = onorbitQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = onorbitQueryhelpResponse.restSupported
                sortSupported = onorbitQueryhelpResponse.sortSupported
                typeName = onorbitQueryhelpResponse.typeName
                uri = onorbitQueryhelpResponse.uri
                additionalProperties = onorbitQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitQueryhelpResponse =
    ...
    fun validate(): OnorbitQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
