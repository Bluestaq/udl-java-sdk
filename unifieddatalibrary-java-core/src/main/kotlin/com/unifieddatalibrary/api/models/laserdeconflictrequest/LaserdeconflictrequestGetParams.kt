...
/**
 * Service operation to get a single LaserDeconflictRequest record by its unique ID passed as a path
 * parameter.
 */
class LaserdeconflictrequestGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaserdeconflictrequestGetParams = builder().build()
    ...
    /** A builder for [LaserdeconflictrequestGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laserdeconflictrequestGetParams: LaserdeconflictrequestGetParams) =
            apply {
                id = laserdeconflictrequestGetParams.id
                firstResult = laserdeconflictrequestGetParams.firstResult
                maxResults = laserdeconflictrequestGetParams.maxResults
                additionalHeaders = laserdeconflictrequestGetParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    laserdeconflictrequestGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LaserdeconflictrequestGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaserdeconflictrequestGetParams =
            LaserdeconflictrequestGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaserdeconflictrequestGetParams &&
            id == other.id &&
    ...
    override fun toString() =
        "LaserdeconflictrequestGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
