...
class RfBandCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandCreateParams: RfBandCreateParams) =
            apply {
    ...
    class Body private constructor(
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idEntity=$idEntity, name=$name, source=$source, id=$id, band=$band, bandwidth=$bandwidth, beamwidth=$beamwidth, centerFreq=$centerFreq, createdAt=$createdAt, createdBy=$createdBy, edgeGain=$edgeGain, eirp=$eirp, erp=$erp, freqMax=$freqMax, freqMin=$freqMin, mode=$mode, origin=$origin, origNetwork=$origNetwork, peakGain=$peakGain, polarization=$polarization, purpose=$purpose, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "RfBandCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
