...
class LaunchVehicleDetailUpdateParams private constructor(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun gtoInj3SigAccuracyInclinationMargin(): Optional<Double> = body.gtoInj3SigAccuracyInclinationMargin()
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun gtoInj3SigAccuracyInclinationTarget(): Optional<Double> = body.gtoInj3SigAccuracyInclinationTarget()
     ...
     */
    fun _gtoInj3SigAccuracyApogeeMargin(): JsonField<Double> = body._gtoInj3SigAccuracyApogeeMargin()
     ...
     */
    fun _gtoInj3SigAccuracyApogeeTarget(): JsonField<Double> = body._gtoInj3SigAccuracyApogeeTarget()
     ...
     */
    fun _gtoInj3SigAccuracyInclinationMargin(): JsonField<Double> = body._gtoInj3SigAccuracyInclinationMargin()
     ...
     */
    fun _gtoInj3SigAccuracyInclinationTarget(): JsonField<Double> = body._gtoInj3SigAccuracyInclinationTarget()
     ...
     */
    fun _gtoInj3SigAccuracyPerigeeMargin(): JsonField<Double> = body._gtoInj3SigAccuracyPerigeeMargin()
     ...
     */
    fun _gtoInj3SigAccuracyPerigeeTarget(): JsonField<Double> = body._gtoInj3SigAccuracyPerigeeTarget()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchVehicleDetailUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(launchVehicleDetailUpdateParams: LaunchVehicleDetailUpdateParams) =
            apply {
                ...
                additionalQueryParams = launchVehicleDetailUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Vehicle fairing length in meters. */
        fun fairingLength(fairingLength: Double) =
            apply {
        ...
        /** Vehicle fairing mass in kg. */
        fun fairingMass(fairingMass: Double) =
            apply {
                body.fairingMass(fairingMass)
            }
        ...
        /** Name of the fairing. */
        fun fairingName(fairingName: String) =
            apply {
                body.fairingName(fairingName)
            }
        ...
        /** Notes/Description of the launch vehicle fairing. */
        fun fairingNotes(fairingNotes: String) =
            apply {
        ...
        /** Vehicle launch prefix. */
        fun launchPrefix(launchPrefix: String) =
            apply {
        ...
        /** Vehicle maximum acceleration load in g. */
        fun maxAccelLoad(maxAccelLoad: Double) =
            apply {
        ...
        /** Vehicle minor variant. */
        fun minorVariant(minorVariant: String) =
            apply {
        ...
        /** Optional URL for additional information on the vehicle. */
        fun sourceUrl(sourceUrl: String) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchVehicleDetailUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "LaunchVehicleDetailUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
