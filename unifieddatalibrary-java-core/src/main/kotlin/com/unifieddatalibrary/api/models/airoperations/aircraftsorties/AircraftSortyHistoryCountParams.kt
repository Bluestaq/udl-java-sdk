...
class AircraftSortyHistoryCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftSortyHistoryCountParams].
         *
    ...
    /** A builder for [AircraftSortyHistoryCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyHistoryCountParams: AircraftSortyHistoryCountParams) =
            apply {
                plannedDepTime = aircraftSortyHistoryCountParams.plannedDepTime
                firstResult = aircraftSortyHistoryCountParams.firstResult
                maxResults = aircraftSortyHistoryCountParams.maxResults
                additionalHeaders = aircraftSortyHistoryCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftSortyHistoryCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortyHistoryCountParams].
         *
         ...
         */
        fun build(): AircraftSortyHistoryCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftSortyHistoryCountParams && plannedDepTime == other.plannedDepTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(plannedDepTime, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AircraftSortyHistoryCountParams{plannedDepTime=$plannedDepTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
