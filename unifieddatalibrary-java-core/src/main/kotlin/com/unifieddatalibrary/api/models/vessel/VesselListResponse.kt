...
class VesselListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VesselListResponse].
         *
    ...
    /** A builder for [VesselListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselListResponse: VesselListResponse) =
            apply {
                classificationMarking = vesselListResponse.classificationMarking
                dataMode = vesselListResponse.dataMode
                source = vesselListResponse.source
                id = vesselListResponse.id
                altVesselId = vesselListResponse.altVesselId
                callsign = vesselListResponse.callsign
                createdAt = vesselListResponse.createdAt
                createdBy = vesselListResponse.createdBy
                firstSeen = vesselListResponse.firstSeen
                hullNum = vesselListResponse.hullNum
                idEntity = vesselListResponse.idEntity
                idOrganization = vesselListResponse.idOrganization
                imon = vesselListResponse.imon
                length = vesselListResponse.length
                maxDraught = vesselListResponse.maxDraught
                maxSpeed = vesselListResponse.maxSpeed
                mmsi = vesselListResponse.mmsi
                numBlades = vesselListResponse.numBlades
                numShafts = vesselListResponse.numShafts
                origin = vesselListResponse.origin
                origNetwork = vesselListResponse.origNetwork
                propType = vesselListResponse.propType
                sconum = vesselListResponse.sconum
                status = vesselListResponse.status
                sternType = vesselListResponse.sternType
                vesselBuilder = vesselListResponse.vesselBuilder
                vesselClass = vesselListResponse.vesselClass
                vesselDescription = vesselListResponse.vesselDescription
                vesselFlag = vesselListResponse.vesselFlag
                vesselName = vesselListResponse.vesselName
                vesselType = vesselListResponse.vesselType
                vslWt = vesselListResponse.vslWt
                width = vesselListResponse.width
                yearBuilt = vesselListResponse.yearBuilt
                additionalProperties = vesselListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [VesselListResponse].
         *
    ...
    fun validate(): VesselListResponse =
        apply {
            if (validated) {
              return@apply
            }
