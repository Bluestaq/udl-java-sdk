...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselListResponse: VesselListResponse) = apply {
    ...
    fun validate(): VesselListResponse = apply {
        if (validated) {
            return@apply
        }
