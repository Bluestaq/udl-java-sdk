...
class StatusQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [StatusQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [StatusQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusQueryhelpResponse: StatusQueryhelpResponse) =
            apply {
                aodrSupported = statusQueryhelpResponse.aodrSupported
                classificationMarking = statusQueryhelpResponse.classificationMarking
                description = statusQueryhelpResponse.description
                historySupported = statusQueryhelpResponse.historySupported
                name = statusQueryhelpResponse.name
                parameters = statusQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = statusQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = statusQueryhelpResponse.restSupported
                sortSupported = statusQueryhelpResponse.sortSupported
                typeName = statusQueryhelpResponse.typeName
                uri = statusQueryhelpResponse.uri
                additionalProperties = statusQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StatusQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StatusQueryhelpResponse =
    ...
    fun validate(): StatusQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StatusQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
