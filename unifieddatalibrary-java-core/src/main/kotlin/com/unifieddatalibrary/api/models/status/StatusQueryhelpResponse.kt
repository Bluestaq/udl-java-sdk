...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusQueryhelpResponse: StatusQueryhelpResponse) = apply {
    ...
    fun validate(): StatusQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
