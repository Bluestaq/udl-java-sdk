...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaseremitterCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LaseremitterCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LaseremitterCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laseremitterCountParams: LaseremitterCountParams) = apply {
            firstResult = laseremitterCountParams.firstResult
            maxResults = laseremitterCountParams.maxResults
            additionalHeaders = laseremitterCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = laseremitterCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaseremitterCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaseremitterCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaseremitterCountParams &&
    ...
    override fun toString() =
        "LaseremitterCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
