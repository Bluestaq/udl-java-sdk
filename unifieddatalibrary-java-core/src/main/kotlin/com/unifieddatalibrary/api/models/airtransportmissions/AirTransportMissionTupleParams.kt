 ...
 */
class AirTransportMissionTupleParams
private constructor(
    ...
    /** A builder for [AirTransportMissionTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTransportMissionTupleParams: AirTransportMissionTupleParams) = apply {
            columns = airTransportMissionTupleParams.columns
            createdAt = airTransportMissionTupleParams.createdAt
            firstResult = airTransportMissionTupleParams.firstResult
            maxResults = airTransportMissionTupleParams.maxResults
            additionalHeaders = airTransportMissionTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = airTransportMissionTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AirTransportMissionTupleParams].
         *
         ...
         */
        fun build(): AirTransportMissionTupleParams =
            AirTransportMissionTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirTransportMissionTupleParams && columns == other.columns && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AirTransportMissionTupleParams{columns=$columns, createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
