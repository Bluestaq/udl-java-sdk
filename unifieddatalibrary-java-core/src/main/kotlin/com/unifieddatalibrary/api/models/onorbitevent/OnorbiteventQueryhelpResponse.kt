...
class OnorbiteventQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OnorbiteventQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OnorbiteventQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventQueryhelpResponse: OnorbiteventQueryhelpResponse) =
            apply {
                aodrSupported = onorbiteventQueryhelpResponse.aodrSupported
                classificationMarking = onorbiteventQueryhelpResponse.classificationMarking
                description = onorbiteventQueryhelpResponse.description
                historySupported = onorbiteventQueryhelpResponse.historySupported
                name = onorbiteventQueryhelpResponse.name
                parameters = onorbiteventQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = onorbiteventQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = onorbiteventQueryhelpResponse.restSupported
                sortSupported = onorbiteventQueryhelpResponse.sortSupported
                typeName = onorbiteventQueryhelpResponse.typeName
                uri = onorbiteventQueryhelpResponse.uri
                additionalProperties = onorbiteventQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbiteventQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbiteventQueryhelpResponse =
    ...
    fun validate(): OnorbiteventQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbiteventQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
