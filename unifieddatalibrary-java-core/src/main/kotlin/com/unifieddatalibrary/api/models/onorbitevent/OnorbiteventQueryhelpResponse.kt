...
class OnorbiteventQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventQueryhelpResponse: OnorbiteventQueryhelpResponse) = apply {
    ...
    fun validate(): OnorbiteventQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
