...
import com.unifieddatalibrary.api.models.logisticssupport.LogisticsRemarksAbridged
...
class LogisticsSupportListResponse private constructor(
    ...
    private val logisticsRemarks: JsonField<List<LogisticsRemarksAbridged>>,
    ...
    private constructor(
        ...
        @JsonProperty("logisticsDiscrepancyInfos") @ExcludeMissing logisticsDiscrepancyInfos: JsonField<List<LogisticsDiscrepancyInfo>> = JsonMissing.of(),
        @JsonProperty("logisticsRecordId") @ExcludeMissing logisticsRecordId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("logisticsRemarks") @ExcludeMissing logisticsRemarks: JsonField<List<LogisticsRemarksAbridged>> = JsonMissing.of(),
        @JsonProperty("logisticsSupportItems") @ExcludeMissing logisticsSupportItems: JsonField<List<LogisticsSupportItem>> = JsonMissing.of(),
        @JsonProperty("logisticsTransportationPlans") @ExcludeMissing logisticsTransportationPlans: JsonField<List<LogisticsTransportationPlan>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun logisticsDiscrepancyInfos(): Optional<List<LogisticsDiscrepancyInfo>> = logisticsDiscrepancyInfos.getOptional("logisticsDiscrepancyInfos")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun logisticsRemarks(): Optional<List<LogisticsRemarksAbridged>> = logisticsRemarks.getOptional("logisticsRemarks")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun logisticsSupportItems(): Optional<List<LogisticsSupportItem>> = logisticsSupportItems.getOptional("logisticsSupportItems")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun logisticsTransportationPlans(): Optional<List<LogisticsTransportationPlan>> = logisticsTransportationPlans.getOptional("logisticsTransportationPlans")
    ...
    @ExcludeMissing
    fun _logisticsDiscrepancyInfos(): JsonField<List<LogisticsDiscrepancyInfo>> = logisticsDiscrepancyInfos
    ...
    @ExcludeMissing
    fun _logisticsRemarks(): JsonField<List<LogisticsRemarksAbridged>> = logisticsRemarks
    ...
    @ExcludeMissing
    fun _logisticsTransportationPlans(): JsonField<List<LogisticsTransportationPlan>> = logisticsTransportationPlans
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LogisticsSupportListResponse].
         *
    ...
    /** A builder for [LogisticsSupportListResponse]. */
    class Builder internal constructor() {
        ...
        private var logisticsDiscrepancyInfos: JsonField<MutableList<LogisticsDiscrepancyInfo>>? = null
        private var logisticsRecordId: JsonField<String> = JsonMissing.of()
        private var logisticsRemarks: JsonField<MutableList<LogisticsRemarksAbridged>>? = null
        private var logisticsSupportItems: JsonField<MutableList<LogisticsSupportItem>>? = null
        private var logisticsTransportationPlans: JsonField<MutableList<LogisticsTransportationPlan>>? = null
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportListResponse: LogisticsSupportListResponse) =
            apply {
                classificationMarking = logisticsSupportListResponse.classificationMarking
                dataMode = logisticsSupportListResponse.dataMode
                rptCreatedTime = logisticsSupportListResponse.rptCreatedTime
                source = logisticsSupportListResponse.source
                id = logisticsSupportListResponse.id
                aircraftMds = logisticsSupportListResponse.aircraftMds
                createdAt = logisticsSupportListResponse.createdAt
                createdBy = logisticsSupportListResponse.createdBy
                currIcao = logisticsSupportListResponse.currIcao
                etic = logisticsSupportListResponse.etic
                etmc = logisticsSupportListResponse.etmc
                extSystemId = logisticsSupportListResponse.extSystemId
                logisticAction = logisticsSupportListResponse.logisticAction
                logisticsDiscrepancyInfos = logisticsSupportListResponse.logisticsDiscrepancyInfos.map { it.toMutableList() }
                logisticsRecordId = logisticsSupportListResponse.logisticsRecordId
                logisticsRemarks = logisticsSupportListResponse.logisticsRemarks.map { it.toMutableList() }
                logisticsSupportItems = logisticsSupportListResponse.logisticsSupportItems.map { it.toMutableList() }
                logisticsTransportationPlans = logisticsSupportListResponse.logisticsTransportationPlans.map { it.toMutableList() }
                maintStatusCode = logisticsSupportListResponse.maintStatusCode
                mcTime = logisticsSupportListResponse.mcTime
                meTime = logisticsSupportListResponse.meTime
                origin = logisticsSupportListResponse.origin
                origNetwork = logisticsSupportListResponse.origNetwork
                owner = logisticsSupportListResponse.owner
                reopenFlag = logisticsSupportListResponse.reopenFlag
                rptClosedTime = logisticsSupportListResponse.rptClosedTime
                suppIcao = logisticsSupportListResponse.suppIcao
                tailNumber = logisticsSupportListResponse.tailNumber
                updatedAt = logisticsSupportListResponse.updatedAt
                updatedBy = logisticsSupportListResponse.updatedBy
                additionalProperties = logisticsSupportListResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Discrepancy information associated with this LogisticsSupport record. */
        fun logisticsDiscrepancyInfos(logisticsDiscrepancyInfos: List<LogisticsDiscrepancyInfo>) = logisticsDiscrepancyInfos(JsonField.of(logisticsDiscrepancyInfos))

        /**
         * Sets [Builder.logisticsDiscrepancyInfos] to an arbitrary JSON value.
         *
         * You should usually call [Builder.logisticsDiscrepancyInfos] with a well-typed `List<LogisticsDiscrepancyInfo>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun logisticsDiscrepancyInfos(logisticsDiscrepancyInfos: JsonField<List<LogisticsDiscrepancyInfo>>) =
            apply {
        ...
        /** Remarks associated with this LogisticsSupport record. */
        fun logisticsRemarks(logisticsRemarks: List<LogisticsRemarksAbridged>) = logisticsRemarks(JsonField.of(logisticsRemarks))

        /**
         * Sets [Builder.logisticsRemarks] to an arbitrary JSON value.
         *
         * You should usually call [Builder.logisticsRemarks] with a well-typed `List<LogisticsRemarksAbridged>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun logisticsRemarks(logisticsRemarks: JsonField<List<LogisticsRemarksAbridged>>) =
            apply {
                this.logisticsRemarks = logisticsRemarks.map { it.toMutableList() }
            }

        /**
         * Adds a single [LogisticsRemarksAbridged] to [logisticsRemarks].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLogisticsRemark(logisticsRemark: LogisticsRemarksAbridged) =
            apply {
        ...
        /** Support items associated with this LogisticsSupport record. */
        fun logisticsSupportItems(logisticsSupportItems: List<LogisticsSupportItem>) = logisticsSupportItems(JsonField.of(logisticsSupportItems))

        /**
         * Sets [Builder.logisticsSupportItems] to an arbitrary JSON value.
         *
         * You should usually call [Builder.logisticsSupportItems] with a well-typed `List<LogisticsSupportItem>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun logisticsSupportItems(logisticsSupportItems: JsonField<List<LogisticsSupportItem>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLogisticsSupportItem(logisticsSupportItem: LogisticsSupportItem) =
            apply {
        ...
        /** Transportation plans associated with this LogisticsSupport record, used to coordinate maintenance efforts. */
        fun logisticsTransportationPlans(logisticsTransportationPlans: List<LogisticsTransportationPlan>) = logisticsTransportationPlans(JsonField.of(logisticsTransportationPlans))

        /**
         * Sets [Builder.logisticsTransportationPlans] to an arbitrary JSON value.
         *
         * You should usually call [Builder.logisticsTransportationPlans] with a well-typed `List<LogisticsTransportationPlan>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun logisticsTransportationPlans(logisticsTransportationPlans: JsonField<List<LogisticsTransportationPlan>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLogisticsTransportationPlan(logisticsTransportationPlan: LogisticsTransportationPlan) =
            apply {
        ...
        /**
         * Returns an immutable instance of [LogisticsSupportListResponse].
         *
         ...
         */
        fun build(): LogisticsSupportListResponse =
    ...
    fun validate(): LogisticsSupportListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    /** Discrepancy information associated with this LogisticsSupport record. */
    class LogisticsDiscrepancyInfo private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("closureTime") @ExcludeMissing closureTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("discrepancyInfo") @ExcludeMissing discrepancyInfo: JsonField<String> = JsonMissing.of(),
            @JsonProperty("jcn") @ExcludeMissing jcn: JsonField<String> = JsonMissing.of(),
            @JsonProperty("jobStTime") @ExcludeMissing jobStTime: JsonField<OffsetDateTime> = JsonMissing.of()
        ) : this(
          closureTime,
          discrepancyInfo,
          jcn,
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [LogisticsDiscrepancyInfo]. */
            @JvmStatic
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(logisticsDiscrepancyInfo: LogisticsDiscrepancyInfo) =
                apply {
                    ...
                    additionalProperties = logisticsDiscrepancyInfo.additionalProperties.toMutableMap()
                }
             ...
             *
             * You should usually call [Builder.closureTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun closureTime(closureTime: JsonField<OffsetDateTime>) =
                apply {
                    this.closureTime = closureTime
                }

            /** The aircraft discrepancy description. */
            fun discrepancyInfo(discrepancyInfo: String) = discrepancyInfo(JsonField.of(discrepancyInfo))

            /**
             * Sets [Builder.discrepancyInfo] to an arbitrary JSON value.
             *
             * You should usually call [Builder.discrepancyInfo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun discrepancyInfo(discrepancyInfo: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.jcn] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun jcn(jcn: JsonField<String>) =
                apply {
                    this.jcn = jcn
                }
             ...
             *
             * You should usually call [Builder.jobStTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun jobStTime(jobStTime: JsonField<OffsetDateTime>) =
                apply {
        ...
        fun validate(): LogisticsDiscrepancyInfo =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (closureTime.asKnown().isPresent) 1 else 0) + (if (discrepancyInfo.asKnown().isPresent) 1 else 0) + (if (jcn.asKnown().isPresent) 1 else 0) + (if (jobStTime.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "LogisticsDiscrepancyInfo{closureTime=$closureTime, discrepancyInfo=$discrepancyInfo, jcn=$jcn, jobStTime=$jobStTime, additionalProperties=$additionalProperties}"
    }

    /** Support items associated with this LogisticsSupport record. */
    class LogisticsSupportItem private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("cannibalized") @ExcludeMissing cannibalized: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("deployPlanNumber") @ExcludeMissing deployPlanNumber: JsonField<String> = JsonMissing.of(),
            @JsonProperty("description") @ExcludeMissing description: JsonField<String> = JsonMissing.of(),
            @JsonProperty("itemLastChangedDate") @ExcludeMissing itemLastChangedDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("jobControlNumber") @ExcludeMissing jobControlNumber: JsonField<String> = JsonMissing.of(),
            @JsonProperty("logisticsParts") @ExcludeMissing logisticsParts: JsonField<List<LogisticsPart>> = JsonMissing.of(),
            @JsonProperty("logisticsRemarks") @ExcludeMissing logisticsRemarks: JsonField<List<LogisticsRemarksAbridged>> = JsonMissing.of(),
            @JsonProperty("logisticsSpecialties") @ExcludeMissing logisticsSpecialties: JsonField<List<LogisticsSpecialty>> = JsonMissing.of(),
            @JsonProperty("quantity") @ExcludeMissing quantity: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("readyTime") @ExcludeMissing readyTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("receivedTime") @ExcludeMissing receivedTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("recoveryRequestTypeCode") @ExcludeMissing recoveryRequestTypeCode: JsonField<String> = JsonMissing.of(),
            @JsonProperty("redeployPlanNumber") @ExcludeMissing redeployPlanNumber: JsonField<String> = JsonMissing.of(),
            @JsonProperty("redeployShipmentUnitId") @ExcludeMissing redeployShipmentUnitId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("requestNumber") @ExcludeMissing requestNumber: JsonField<String> = JsonMissing.of(),
            @JsonProperty("resupportFlag") @ExcludeMissing resupportFlag: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("shipmentUnitId") @ExcludeMissing shipmentUnitId: JsonField<String> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun itemLastChangedDate(): Optional<OffsetDateTime> = itemLastChangedDate.getOptional("itemLastChangedDate")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun logisticsParts(): Optional<List<LogisticsPart>> = logisticsParts.getOptional("logisticsParts")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun logisticsSpecialties(): Optional<List<LogisticsSpecialty>> = logisticsSpecialties.getOptional("logisticsSpecialties")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun recoveryRequestTypeCode(): Optional<String> = recoveryRequestTypeCode.getOptional("recoveryRequestTypeCode")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun redeployPlanNumber(): Optional<String> = redeployPlanNumber.getOptional("redeployPlanNumber")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun redeployShipmentUnitId(): Optional<String> = redeployShipmentUnitId.getOptional("redeployShipmentUnitId")
         ...
         *
         * Unlike [deployPlanNumber], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [itemLastChangedDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [jobControlNumber], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [logisticsSpecialties], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [recoveryRequestTypeCode], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [redeployPlanNumber], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [redeployShipmentUnitId], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("siPOC")
        @ExcludeMissing
        fun _siPoc(): JsonField<String> = siPoc
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(logisticsSupportItem: LogisticsSupportItem) =
                apply {
                    ...
                    logisticsRemarks = logisticsSupportItem.logisticsRemarks.map { it.toMutableList() }
                    logisticsSpecialties = logisticsSupportItem.logisticsSpecialties.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.cannibalized] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun cannibalized(cannibalized: JsonField<Boolean>) =
                apply {
                    this.cannibalized = cannibalized
                }

            /** System generated reference id for the transportation plan. Format: TXXXXXNNNN T - Transportation, Sequence Number, Node Id. */
            fun deployPlanNumber(deployPlanNumber: String) = deployPlanNumber(JsonField.of(deployPlanNumber))

            /**
             * Sets [Builder.deployPlanNumber] to an arbitrary JSON value.
             *
             * You should usually call [Builder.deployPlanNumber] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun deployPlanNumber(deployPlanNumber: JsonField<String>) =
                apply {
            ...
            /** The last time this supported item was updated, in ISO 8601 UTC format with millisecond precision. */
            fun itemLastChangedDate(itemLastChangedDate: OffsetDateTime) = itemLastChangedDate(JsonField.of(itemLastChangedDate))

            /**
             * Sets [Builder.itemLastChangedDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.itemLastChangedDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun itemLastChangedDate(itemLastChangedDate: JsonField<OffsetDateTime>) =
                apply {
                    this.itemLastChangedDate = itemLastChangedDate
                }

            /** A number assigned by Job Control to monitor and record maintenance actions required to correct the associated aircraft maintenance discrepancy. It is seven, nine or twelve characters, depending on the base-specific numbering scheme. If seven characters: characters 1-3 are Julian date, 4-7 are sequence numbers. If nine characters: characters 1-2 are last two digits of the year, characters 3-5 are Julian date, 6-9 are sequence numbers. If twelve characters: characters 1-2 are last two digits of the year, 3-5 are Julian date, 6-9 are sequence numbers, and 10-12 are a three-digit supplemental number. */
            fun jobControlNumber(jobControlNumber: String) = jobControlNumber(JsonField.of(jobControlNumber))

            /**
             * Sets [Builder.jobControlNumber] to an arbitrary JSON value.
             *
             * You should usually call [Builder.jobControlNumber] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun jobControlNumber(jobControlNumber: JsonField<String>) =
                apply {
                    this.jobControlNumber = jobControlNumber
                }

            /** The parts associated with this support item. */
            fun logisticsParts(logisticsParts: List<LogisticsPart>) = logisticsParts(JsonField.of(logisticsParts))

            /**
             * Sets [Builder.logisticsParts] to an arbitrary JSON value.
             *
             * You should usually call [Builder.logisticsParts] with a well-typed `List<LogisticsPart>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun logisticsParts(logisticsParts: JsonField<List<LogisticsPart>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addLogisticsPart(logisticsPart: LogisticsPart) =
                apply {
                    logisticsParts = (logisticsParts ?: JsonField.of(mutableListOf())).also {
            ...
            /** The specialties required to implement this support item. */
            fun logisticsSpecialties(logisticsSpecialties: List<LogisticsSpecialty>) = logisticsSpecialties(JsonField.of(logisticsSpecialties))

            /**
             * Sets [Builder.logisticsSpecialties] to an arbitrary JSON value.
             *
             * You should usually call [Builder.logisticsSpecialties] with a well-typed `List<LogisticsSpecialty>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun logisticsSpecialties(logisticsSpecialties: JsonField<List<LogisticsSpecialty>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addLogisticsSpecialty(logisticsSpecialty: LogisticsSpecialty) =
                apply {
                    logisticsSpecialties = (logisticsSpecialties ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.readyTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun readyTime(readyTime: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.receivedTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receivedTime(receivedTime: JsonField<OffsetDateTime>) =
                apply {
                    this.receivedTime = receivedTime
                }

            /** The type of recovery request needed. Contact the source provider for details. */
            fun recoveryRequestTypeCode(recoveryRequestTypeCode: String) = recoveryRequestTypeCode(JsonField.of(recoveryRequestTypeCode))

            /**
             * Sets [Builder.recoveryRequestTypeCode] to an arbitrary JSON value.
             *
             * You should usually call [Builder.recoveryRequestTypeCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun recoveryRequestTypeCode(recoveryRequestTypeCode: JsonField<String>) =
                apply {
                    this.recoveryRequestTypeCode = recoveryRequestTypeCode
                }

            /** System generated reference id for the transportation plan. Format: TXXXXXNNNN T - Transportation, Sequence Number, Node Id. */
            fun redeployPlanNumber(redeployPlanNumber: String) = redeployPlanNumber(JsonField.of(redeployPlanNumber))

            /**
             * Sets [Builder.redeployPlanNumber] to an arbitrary JSON value.
             *
             * You should usually call [Builder.redeployPlanNumber] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun redeployPlanNumber(redeployPlanNumber: JsonField<String>) =
                apply {
                    this.redeployPlanNumber = redeployPlanNumber
                }

            /** This is the Redeploy (return) Transportation Control Number/Tracking Reference Number for the selected item. */
            fun redeployShipmentUnitId(redeployShipmentUnitId: String) = redeployShipmentUnitId(JsonField.of(redeployShipmentUnitId))

            /**
             * Sets [Builder.redeployShipmentUnitId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.redeployShipmentUnitId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun redeployShipmentUnitId(redeployShipmentUnitId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.requestNumber] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun requestNumber(requestNumber: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.resupportFlag] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun resupportFlag(resupportFlag: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.shipmentUnitId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun shipmentUnitId(shipmentUnitId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.siPoc] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun siPoc(siPoc: JsonField<String>) =
                apply {
                    this.siPoc = siPoc
                }
        ...
        fun validate(): LogisticsSupportItem =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (cannibalized.asKnown().isPresent) 1 else 0) + (if (deployPlanNumber.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (itemLastChangedDate.asKnown().isPresent) 1 else 0) + (if (jobControlNumber.asKnown().isPresent) 1 else 0) + (logisticsParts.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (logisticsRemarks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (logisticsSpecialties.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (if (readyTime.asKnown().isPresent) 1 else 0) + (if (receivedTime.asKnown().isPresent) 1 else 0) + (if (recoveryRequestTypeCode.asKnown().isPresent) 1 else 0) + (if (redeployPlanNumber.asKnown().isPresent) 1 else 0) + (if (redeployShipmentUnitId.asKnown().isPresent) 1 else 0) + (if (requestNumber.asKnown().isPresent) 1 else 0) + (if (resupportFlag.asKnown().isPresent) 1 else 0) + (if (shipmentUnitId.asKnown().isPresent) 1 else 0) + (if (siPoc.asKnown().isPresent) 1 else 0) + (if (sourceIcao.asKnown().isPresent) 1 else 0)

        /** The parts associated with this support item. */
        class LogisticsPart private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("logisticsStocks") @ExcludeMissing logisticsStocks: JsonField<List<LogisticsStock>> = JsonMissing.of(),
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun logisticsStocks(): Optional<List<LogisticsStock>> = logisticsStocks.getOptional("logisticsStocks")
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(logisticsPart: LogisticsPart) =
                    apply {
                ...
                /** The supply stocks for this support item. */
                fun logisticsStocks(logisticsStocks: List<LogisticsStock>) = logisticsStocks(JsonField.of(logisticsStocks))

                /**
                 * Sets [Builder.logisticsStocks] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.logisticsStocks] with a well-typed `List<LogisticsStock>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun logisticsStocks(logisticsStocks: JsonField<List<LogisticsStock>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addLogisticsStock(logisticsStock: LogisticsStock) =
                    apply {
            ...
            /** The supply stocks for this support item. */
            class LogisticsStock private constructor(
                private val quantity: JsonField<Int>,
                private val sourceIcao: JsonField<String>,
                ...
                companion object {
                    ...
                    /** Returns a mutable builder for constructing an instance of [LogisticsStock]. */
                    @JvmStatic
                    fun builder() = Builder()
                }
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(logisticsStock: LogisticsStock) =
                        apply {
                            ...
                            additionalProperties = logisticsStock.additionalProperties.toMutableMap()
                        }
                ...
                override fun toString() = "LogisticsStock{quantity=$quantity, sourceIcao=$sourceIcao, stockCheckTime=$stockCheckTime, stockPoc=$stockPoc, additionalProperties=$additionalProperties}"
            }
        ...
        class LogisticsSpecialty private constructor(
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [LogisticsSpecialty]. */
                @JvmStatic
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(logisticsSpecialty: LogisticsSpecialty) =
                    apply {
                        ...
                        additionalProperties = logisticsSpecialty.additionalProperties.toMutableMap()
                    }
            ...
            fun validate(): LogisticsSpecialty =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun toString() = "LogisticsSpecialty{firstName=$firstName, last4Ssn=$last4Ssn, lastName=$lastName, rankCode=$rankCode, roleTypeCode=$roleTypeCode, skillLevel=$skillLevel, specialty=$specialty, additionalProperties=$additionalProperties}"
        }
    ...
    class LogisticsTransportationPlan private constructor(
        ...
        private val logisticsTransportationPlansRemarks: JsonField<List<LogisticsRemarksAbridged>>,
        ...
        private constructor(
            ...
            @JsonProperty("logisticsSegments") @ExcludeMissing logisticsSegments: JsonField<List<LogisticsSegment>> = JsonMissing.of(),
            @JsonProperty("logisticsTransportationPlansRemarks") @ExcludeMissing logisticsTransportationPlansRemarks: JsonField<List<LogisticsRemarksAbridged>> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun logisticsSegments(): Optional<List<LogisticsSegment>> = logisticsSegments.getOptional("logisticsSegments")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun logisticsTransportationPlansRemarks(): Optional<List<LogisticsRemarksAbridged>> = logisticsTransportationPlansRemarks.getOptional("logisticsTransportationPlansRemarks")
        ...
        @ExcludeMissing
        fun _logisticsTransportationPlansRemarks(): JsonField<List<LogisticsRemarksAbridged>> = logisticsTransportationPlansRemarks
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [LogisticsTransportationPlan]. */
            @JvmStatic
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            private var logisticsTransportationPlansRemarks: JsonField<MutableList<LogisticsRemarksAbridged>>? = null
            ...
            internal fun from(logisticsTransportationPlan: LogisticsTransportationPlan) =
                apply {
                    ...
                    logisticsSegments = logisticsTransportationPlan.logisticsSegments.map { it.toMutableList() }
                    logisticsTransportationPlansRemarks = logisticsTransportationPlan.logisticsTransportationPlansRemarks.map { it.toMutableList() }
                    ...
                    additionalProperties = logisticsTransportationPlan.additionalProperties.toMutableMap()
                }
            ...
            /** The transportation segments associated with this transportation plan. */
            fun logisticsSegments(logisticsSegments: List<LogisticsSegment>) = logisticsSegments(JsonField.of(logisticsSegments))

            /**
             * Sets [Builder.logisticsSegments] to an arbitrary JSON value.
             *
             * You should usually call [Builder.logisticsSegments] with a well-typed `List<LogisticsSegment>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addLogisticsSegment(logisticsSegment: LogisticsSegment) =
                apply {
            ...
            /** Remarks associated with this transportation plan. */
            fun logisticsTransportationPlansRemarks(logisticsTransportationPlansRemarks: List<LogisticsRemarksAbridged>) = logisticsTransportationPlansRemarks(JsonField.of(logisticsTransportationPlansRemarks))

            /**
             * Sets [Builder.logisticsTransportationPlansRemarks] to an arbitrary JSON value.
             *
             * You should usually call [Builder.logisticsTransportationPlansRemarks] with a well-typed `List<LogisticsRemarksAbridged>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun logisticsTransportationPlansRemarks(logisticsTransportationPlansRemarks: JsonField<List<LogisticsRemarksAbridged>>) =
                apply {
                    this.logisticsTransportationPlansRemarks = logisticsTransportationPlansRemarks.map { it.toMutableList() }
                }

            /**
             * Adds a single [LogisticsRemarksAbridged] to [logisticsTransportationPlansRemarks].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addLogisticsTransportationPlansRemark(logisticsTransportationPlansRemark: LogisticsRemarksAbridged) =
                apply {
        ...
        fun validate(): LogisticsTransportationPlan =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        /** Remarks associated with this LogisticsSupport record. */
        class LogisticsSegment private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("arrivalICAO") @ExcludeMissing arrivalIcao: JsonField<String> = JsonMissing.of(),
                @JsonProperty("departureICAO") @ExcludeMissing departureIcao: JsonField<String> = JsonMissing.of(),
                @JsonProperty("extMissionId") @ExcludeMissing extMissionId: JsonField<String> = JsonMissing.of(),
                ...
                @JsonProperty("segActArrTime") @ExcludeMissing segActArrTime: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("segActDepTime") @ExcludeMissing segActDepTime: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("segAircraftMDS") @ExcludeMissing segAircraftMds: JsonField<String> = JsonMissing.of(),
                @JsonProperty("segEstArrTime") @ExcludeMissing segEstArrTime: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("segEstDepTime") @ExcludeMissing segEstDepTime: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("segmentNumber") @ExcludeMissing segmentNumber: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("segTailNumber") @ExcludeMissing segTailNumber: JsonField<String> = JsonMissing.of()
            ) : this(
              arrivalIcao,
              departureIcao,
              extMissionId,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(logisticsSegment: LogisticsSegment) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.arrivalIcao] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun arrivalIcao(arrivalIcao: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.departureIcao] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun departureIcao(departureIcao: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.extMissionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun extMissionId(extMissionId: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.itin] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun itin(itin: JsonField<Int>) =
                    apply {
                        this.itin = itin
                    }
                 ...
                 *
                 * You should usually call [Builder.modeCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun modeCode(modeCode: JsonField<String>) =
                    apply {
                        this.modeCode = modeCode
                    }

                /** Actual arrival time to segment destination, in ISO 8601 UTC format with millisecond precision. */
                fun segActArrTime(segActArrTime: OffsetDateTime) = segActArrTime(JsonField.of(segActArrTime))

                /**
                 * Sets [Builder.segActArrTime] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.segActArrTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun segActArrTime(segActArrTime: JsonField<OffsetDateTime>) =
                    apply {
                        this.segActArrTime = segActArrTime
                    }

                /** Actual departure time to the segment destination, in ISO 8601 UTC format with millisecond precision. */
                fun segActDepTime(segActDepTime: OffsetDateTime) = segActDepTime(JsonField.of(segActDepTime))

                /**
                 * Sets [Builder.segActDepTime] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.segActDepTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun segActDepTime(segActDepTime: JsonField<OffsetDateTime>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.segAircraftMds] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun segAircraftMds(segAircraftMds: JsonField<String>) =
                    apply {
                        this.segAircraftMds = segAircraftMds
                    }

                /** GC. LGTPS_C_DT_EST_ARR. GD2: Estimated arrival time to the segment destination. Only supplied when the segment is not attached to a Mission, otherwise the ETA is derived from the Mission segment destination point. This datetime should be in ISO 8601 UTC format with millisecond precision. */
                fun segEstArrTime(segEstArrTime: OffsetDateTime) = segEstArrTime(JsonField.of(segEstArrTime))

                /**
                 * Sets [Builder.segEstArrTime] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.segEstArrTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun segEstArrTime(segEstArrTime: JsonField<OffsetDateTime>) =
                    apply {
                        this.segEstArrTime = segEstArrTime
                    }

                /** GC. LGTPS_C_DT_EST_DEP. GD2: Estimated departure time from the segment origin. Only supplied when the segment is not attached to a Mission, otherwise the ETD is derived from the Mission segment origin point. This datetime should be in ISO 8601 UTC format with millisecond precision. */
                fun segEstDepTime(segEstDepTime: OffsetDateTime) = segEstDepTime(JsonField.of(segEstDepTime))

                /**
                 * Sets [Builder.segEstDepTime] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.segEstDepTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun segEstDepTime(segEstDepTime: JsonField<OffsetDateTime>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.segmentNumber] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun segmentNumber(segmentNumber: JsonField<Int>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.segTailNumber] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun segTailNumber(segTailNumber: JsonField<String>) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (arrivalIcao.asKnown().isPresent) 1 else 0) + (if (departureIcao.asKnown().isPresent) 1 else 0) + (if (extMissionId.asKnown().isPresent) 1 else 0) + (if (idMission.asKnown().isPresent) 1 else 0) + (if (itin.asKnown().isPresent) 1 else 0) + (if (missionNumber.asKnown().isPresent) 1 else 0) + (if (missionType.asKnown().isPresent) 1 else 0) + (if (modeCode.asKnown().isPresent) 1 else 0) + (if (segActArrTime.asKnown().isPresent) 1 else 0) + (if (segActDepTime.asKnown().isPresent) 1 else 0) + (if (segAircraftMds.asKnown().isPresent) 1 else 0) + (if (segEstArrTime.asKnown().isPresent) 1 else 0) + (if (segEstDepTime.asKnown().isPresent) 1 else 0) + (if (segmentNumber.asKnown().isPresent) 1 else 0) + (if (segTailNumber.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() = "LogisticsSegment{arrivalIcao=$arrivalIcao, departureIcao=$departureIcao, extMissionId=$extMissionId, idMission=$idMission, itin=$itin, missionNumber=$missionNumber, missionType=$missionType, modeCode=$modeCode, segActArrTime=$segActArrTime, segActDepTime=$segActDepTime, segAircraftMds=$segAircraftMds, segEstArrTime=$segEstArrTime, segEstDepTime=$segEstDepTime, segmentNumber=$segmentNumber, segTailNumber=$segTailNumber, additionalProperties=$additionalProperties}"
        }
