 ...
 * required by an aircraft, including transportation information, supplies coordination, and service
 * personnel.
 */
class LogisticsSupportListResponse
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        logisticsRemarks: JsonField<List<LogisticsRemarksAbridged>> = JsonMissing.of(),
    ...
    /**
     * The estimated time mission capable for the aircraft, in ISO 8601 UCT format with millisecond
     * precision. This is the estimated time when the aircraft is mission ready.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Optional system identifier from external systs. This field has no meaning within UDL and is
    ...
    /**
     * This field identifies the pacing event for bringing the aircraft to Mission Capable status.
     * It is used in calculating the Estimated Time Mission Capable (ETMC) value. Acceptable values
     * are WA (Will Advise), INW (In Work), P+hhh.h (where P=parts and hhh.h is the number of hours
     * up to 999 plus tenths of hours), EQ+hhh.h (EQ=equipment), MRT+hhh.h (MRT=maintenance recovery
     * team).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     *   if the server responded with an unexpected value).
     */
    fun logisticsRemarks(): Optional<List<LogisticsRemarksAbridged>> =
    ...
    /**
     * The time indicating when all mission essential problems with a given aircraft have been fixed
     * and is mission capable. This datetime should be in ISO 8601 UTC format with millisecond
     * precision.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     */
    @JsonProperty("extSystemId") @ExcludeMissing fun _extSystemId(): JsonField<String> = extSystemId
     ...
     *
     * Unlike [logisticsSupportItems], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("logisticsSupportItems")
    @ExcludeMissing
     ...
     */
    @JsonProperty("reopenFlag") @ExcludeMissing fun _reopenFlag(): JsonField<Boolean> = reopenFlag
    ...
    class Builder internal constructor() {
        ...
        private var logisticsDiscrepancyInfos: JsonField<MutableList<LogisticsDiscrepancyInfo>>? =
            null
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportListResponse: LogisticsSupportListResponse) = apply {
            ...
            logisticsDiscrepancyInfos =
                logisticsSupportListResponse.logisticsDiscrepancyInfos.map { it.toMutableList() }
            logisticsRecordId = logisticsSupportListResponse.logisticsRecordId
            logisticsRemarks =
                logisticsSupportListResponse.logisticsRemarks.map { it.toMutableList() }
            logisticsSupportItems =
                logisticsSupportListResponse.logisticsSupportItems.map { it.toMutableList() }
            logisticsTransportationPlans =
                logisticsSupportListResponse.logisticsTransportationPlans.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.rptCreatedTime] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.currIcao] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.etmc] with a well-typed [OffsetDateTime] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.extSystemId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun extSystemId(extSystemId: JsonField<String>) = apply { this.extSystemId = extSystemId }
        ...
        /** Discrepancy information associated with this LogisticsSupport record. */
        fun logisticsDiscrepancyInfos(logisticsDiscrepancyInfos: List<LogisticsDiscrepancyInfo>) =
         ...
         * `List<LogisticsDiscrepancyInfo>` value instead. This method is primarily for setting the
        ...
        /** Remarks associated with this LogisticsSupport record. */
        fun logisticsRemarks(logisticsRemarks: List<LogisticsRemarksAbridged>) =
         ...
         * `List<LogisticsRemarksAbridged>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun logisticsRemarks(logisticsRemarks: JsonField<List<LogisticsRemarksAbridged>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLogisticsRemark(logisticsRemark: LogisticsRemarksAbridged) = apply {
            logisticsRemarks =
         ...
         * `List<LogisticsTransportationPlan>` value instead. This method is primarily for setting
         ...
         *
         * You should usually call [Builder.reopenFlag] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.rptClosedTime] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.suppIcao] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    fun validate(): LogisticsSupportListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (classificationMarking.asKnown().isPresent) 1 else 0) +
            ...
            (logisticsSupportItems.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
         ...
         *
         * Unlike [discrepancyInfo], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("discrepancyInfo")
        @ExcludeMissing
    ...
    private constructor(
         ...
         *
         * Unlike [logisticsParts], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("logisticsParts")
        @ExcludeMissing
         ...
         *
         * Unlike [shipmentUnitId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("shipmentUnitId")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * `List<LogisticsPart>` value instead. This method is primarily for setting the field
             ...
             *
             * You should usually call [Builder.logisticsRemarks] with a well-typed
             * `List<LogisticsRemarksAbridged>` value instead. This method is primarily for setting
             * the field to an undocumented or not yet supported value.
             */
             ...
             * `List<LogisticsSpecialty>` value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.redeployShipmentUnitId] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
        ...
        private constructor(
            ...
            /**
             * The person who validated that the sourced location has, and can supply, the requested
             * parts.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
            ...
            /**
             * Indicates the specified Technical Order manual holding the aircraft information for
             * use in diagnosing a problem or condition.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             *
             * Unlike [figureNumber], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("figureNumber")
            @ExcludeMissing
             ...
             *
             * Unlike [indexNumber], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("indexNumber")
            @ExcludeMissing
             ...
             *
             * Unlike [partNumber], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("partNumber")
            @ExcludeMissing
             ...
             *
             * Unlike [workUnitCode], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("workUnitCode")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.figureNumber] with a well-typed [String] value
                 ...
                 *
                 * You should usually call [Builder.indexNumber] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * `List<LogisticsStock>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.measurementUnitCode] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.nationalStockNumber] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.supplyDocumentNumber] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.technicalOrderText] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.workUnitCode] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            internal fun validity(): Int =
                (if (figureNumber.asKnown().isPresent) 1 else 0) +
                    ...
                    (logisticsStocks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            ...
            private constructor(
                ...
                /**
                 * The datetime when the parts were sourced, in ISO 8601 UTC format with millisecond
                 * precision.
                 *
                 * @throws UnifieddatalibraryInvalidDataException if the JSON field has an
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 ...
                 *
                 * Unlike [stockPoc], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("stockPOC")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.stockPoc] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    fun stockPoc(stockPoc: JsonField<String>) = apply { this.stockPoc = stockPoc }
        ...
        private constructor(
            ...
            /**
             * Type code that determines role of the mission response team member. TC - Team Chief,
             * TM - Team Member.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             ...
             * assigned responsibility for correcting the discrepancy. Shop specialties are normally
             * listed in abbreviated format.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             */
             ...
             *
             * Unlike [roleTypeCode], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("roleTypeCode")
            @ExcludeMissing
             ...
             *
             * Unlike [skillLevel], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("skillLevel")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.roleTypeCode] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            logisticsTransportationPlansRemarks: JsonField<List<LogisticsRemarksAbridged>> =
                JsonMissing.of(),
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun logisticsTransportationPlansRemarks(): Optional<List<LogisticsRemarksAbridged>> =
         ...
         *
         * Unlike [aircraftStatus], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("aircraftStatus")
        @ExcludeMissing
         ...
         *
         * Unlike [coordinatorUnit], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("coordinatorUnit")
        @ExcludeMissing
         ...
         *
         * Unlike [destinationIcao], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("destinationICAO")
        @ExcludeMissing
         ...
         *
         * Unlike [logisticsTransportationPlansRemarks], this method doesn't throw if the JSON field
         * has an unexpected type.
         */
        @JsonProperty("logisticsTransportationPlansRemarks")
        @ExcludeMissing
        fun _logisticsTransportationPlansRemarks(): JsonField<List<LogisticsRemarksAbridged>> =
            logisticsTransportationPlansRemarks
         ...
         *
         * Unlike [numEnrouteStops], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("numEnrouteStops")
        @ExcludeMissing
         ...
         *
         * Unlike [planDefinition], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("planDefinition")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            private var logisticsTransportationPlansRemarks:
                JsonField<MutableList<LogisticsRemarksAbridged>>? =
                null
            ...
            @JvmSynthetic
            internal fun from(logisticsTransportationPlan: LogisticsTransportationPlan) = apply {
             ...
             *
             * You should usually call [Builder.approxArrTime] with a well-typed [OffsetDateTime]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.cancelledDate] with a well-typed [OffsetDateTime]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.logisticMasterRecordId] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             * field to an undocumented or not yet supported value.
             */
            fun logisticsSegments(logisticsSegments: JsonField<List<LogisticsSegment>>) = apply {
            ...
            fun logisticsTransportationPlansRemarks(
                logisticsTransportationPlansRemarks: List<LogisticsRemarksAbridged>
            ) =
                logisticsTransportationPlansRemarks(
             ...
             * well-typed `List<LogisticsRemarksAbridged>` value instead. This method is primarily
            ...
            fun addLogisticsTransportationPlansRemark(
                logisticsTransportationPlansRemark: LogisticsRemarksAbridged
            ) = apply {
                logisticsTransportationPlansRemarks =
             ...
             *
             * You should usually call [Builder.majcom] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
             ...
             * supplied when the segment is not attached to a Mission, otherwise the ETA is derived
             * from the Mission segment destination point. This datetime should be in ISO 8601 UTC
             * format with millisecond precision.
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected
             *   type (e.g. if the server responded with an unexpected value).
             ...
             * supplied when the segment is not attached to a Mission, otherwise the ETD is derived
             * from the Mission segment origin point. This datetime should be in ISO 8601 UTC format
             ...
             *
             * Unlike [arrivalIcao], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("arrivalICAO")
            @ExcludeMissing
             ...
             *
             * Unlike [departureIcao], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("departureICAO")
            @ExcludeMissing
             ...
             *
             * Unlike [extMissionId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("extMissionId")
            @ExcludeMissing
             ...
             *
             * Unlike [missionType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("missionType")
            @ExcludeMissing
             ...
             *
             * Unlike [segActArrTime], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("segActArrTime")
            @ExcludeMissing
             ...
             *
             * Unlike [segActDepTime], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("segActDepTime")
            @ExcludeMissing
             ...
             *
             * Unlike [segEstArrTime], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("segEstArrTime")
            @ExcludeMissing
             ...
             *
             * Unlike [segEstDepTime], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("segEstDepTime")
            @ExcludeMissing
             ...
             *
             * Unlike [segmentNumber], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("segmentNumber")
            @ExcludeMissing
             ...
             *
             * Unlike [segTailNumber], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("segTailNumber")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.arrivalIcao] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.departureIcao] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.extMissionId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.missionType] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.segTailNumber] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
