...
class ManifoldelsetTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManifoldelsetTupleResponse].
         *
    ...
    /** A builder for [ManifoldelsetTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetTupleResponse: ManifoldelsetTupleResponse) =
            apply {
                classificationMarking = manifoldelsetTupleResponse.classificationMarking
                dataMode = manifoldelsetTupleResponse.dataMode
                epoch = manifoldelsetTupleResponse.epoch
                idManifold = manifoldelsetTupleResponse.idManifold
                source = manifoldelsetTupleResponse.source
                tmpSatNo = manifoldelsetTupleResponse.tmpSatNo
                id = manifoldelsetTupleResponse.id
                apogee = manifoldelsetTupleResponse.apogee
                argOfPerigee = manifoldelsetTupleResponse.argOfPerigee
                bStar = manifoldelsetTupleResponse.bStar
                createdAt = manifoldelsetTupleResponse.createdAt
                createdBy = manifoldelsetTupleResponse.createdBy
                eccentricity = manifoldelsetTupleResponse.eccentricity
                inclination = manifoldelsetTupleResponse.inclination
                line1 = manifoldelsetTupleResponse.line1
                line2 = manifoldelsetTupleResponse.line2
                meanAnomaly = manifoldelsetTupleResponse.meanAnomaly
                meanMotion = manifoldelsetTupleResponse.meanMotion
                meanMotionDDot = manifoldelsetTupleResponse.meanMotionDDot
                meanMotionDot = manifoldelsetTupleResponse.meanMotionDot
                origin = manifoldelsetTupleResponse.origin
                origNetwork = manifoldelsetTupleResponse.origNetwork
                perigee = manifoldelsetTupleResponse.perigee
                period = manifoldelsetTupleResponse.period
                raan = manifoldelsetTupleResponse.raan
                revNo = manifoldelsetTupleResponse.revNo
                semiMajorAxis = manifoldelsetTupleResponse.semiMajorAxis
                updatedAt = manifoldelsetTupleResponse.updatedAt
                updatedBy = manifoldelsetTupleResponse.updatedBy
                additionalProperties = manifoldelsetTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ManifoldelsetTupleResponse].
         *
         ...
         */
        fun build(): ManifoldelsetTupleResponse =
    ...
    fun validate(): ManifoldelsetTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
