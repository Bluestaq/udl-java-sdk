 ...
 */
class ManifoldelsetTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetTupleResponse: ManifoldelsetTupleResponse) = apply {
    ...
    fun validate(): ManifoldelsetTupleResponse = apply {
        if (validated) {
            return@apply
        }
