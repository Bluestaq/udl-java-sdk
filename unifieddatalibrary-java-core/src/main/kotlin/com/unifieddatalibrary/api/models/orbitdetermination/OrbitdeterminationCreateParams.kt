...
/**
 * Service operation to take a single OrbitDetermination record as a POST body and ingest into the
 * database. A specific role is required to perform this service operation. Please contact the UDL
 * team for assistance.
 */
class OrbitdeterminationCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationCreateParams: OrbitdeterminationCreateParams) = apply {
        ...
        /** Flag indicating whether this is an initial orbit determination. */
        fun initialOd(initialOd: Boolean) = apply { body.initialOd(initialOd) }
         ...
         * value.
         */
        fun initialOd(initialOd: JsonField<Boolean>) = apply { body.initialOd(initialOd) }
         ...
         */
        fun acceptedObIds(acceptedObIds: List<String>) = apply { body.acceptedObIds(acceptedObIds) }
         ...
         */
        fun addAcceptedObId(acceptedObId: String) = apply { body.addAcceptedObId(acceptedObId) }
         ...
         */
        fun acceptedObTyps(acceptedObTyps: List<String>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAcceptedObTyp(acceptedObTyp: String) = apply { body.addAcceptedObTyp(acceptedObTyp) }

        /** Flag indicating whether the AGOM was estimated during this OD solution. */
        fun agomEst(agomEst: Boolean) = apply { body.agomEst(agomEst) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun agomEst(agomEst: JsonField<Boolean>) = apply { body.agomEst(agomEst) }

        /** Model used to estimate the AGOM. */
        fun agomModel(agomModel: String) = apply { body.agomModel(agomModel) }
         ...
         * value.
         */
        fun agomModel(agomModel: JsonField<String>) = apply { body.agomModel(agomModel) }
         ...
         */
        fun aprioriElset(aprioriElset: AprioriElset) = apply { body.aprioriElset(aprioriElset) }
         ...
         * /udl/elset/abc.
         */
        fun aprioriIdElset(aprioriIdElset: String) = apply { body.aprioriIdElset(aprioriIdElset) }
         ...
         */
        fun aprioriIdStateVector(aprioriIdStateVector: String) = apply {
         ...
         */
        fun aprioriStateVector(aprioriStateVector: AprioriStateVector) = apply {
         ...
         * Flag indicating whether the ballistic coefficient was estimated during this OD solution.
         */
        fun ballisticCoeffEst(ballisticCoeffEst: Boolean) = apply {
        ...
        /** Model used to estimate the ballistic coefficient. */
        fun ballisticCoeffModel(ballisticCoeffModel: String) = apply {
         ...
         */
        fun bestPassWrms(bestPassWrms: Double) = apply { body.bestPassWrms(bestPassWrms) }
         ...
         */
        fun effectiveFrom(effectiveFrom: OffsetDateTime) = apply {
         ...
         * datetime format with microsecond precision.
         */
        fun effectiveUntil(effectiveUntil: OffsetDateTime) = apply {
        ...
        /** Error growth rate of the OD solution in kilometers per day. */
        fun errorGrowthRate(errorGrowthRate: Double) = apply {
         ...
         * observation period.
         */
        fun firstPassWrms(firstPassWrms: Double) = apply { body.firstPassWrms(firstPassWrms) }
        ...
        /** The fit span, in days, used in a Batch Least Squares (BLS) OD. */
        fun fitSpan(fitSpan: Double) = apply { body.fitSpan(fitSpan) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun fitSpan(fitSpan: JsonField<Double>) = apply { body.fitSpan(fitSpan) }
         ...
         * lastObStart and lastObEnd are the same.
         */
        fun lastObEnd(lastObEnd: OffsetDateTime) = apply { body.lastObEnd(lastObEnd) }
         ...
         * supported value.
         */
        fun lastObEnd(lastObEnd: JsonField<OffsetDateTime>) = apply { body.lastObEnd(lastObEnd) }
         ...
         */
        fun lastObStart(lastObStart: OffsetDateTime) = apply { body.lastObStart(lastObStart) }
         ...
         * FreeFlyer, GEODYNE, GDTS, etc.).
         */
        fun methodSource(methodSource: String) = apply { body.methodSource(methodSource) }
        ...
        /** The number of iterations taken for the algorithm to converge on an OD solution. */
        fun numIterations(numIterations: Int) = apply { body.numIterations(numIterations) }
         ...
         */
        fun previousWrms(previousWrms: Double) = apply { body.previousWrms(previousWrms) }
         ...
         * positionally corresponding UUIDs in this array (the two arrays must match in size).
         */
        fun rejectedObIds(rejectedObIds: List<String>) = apply { body.rejectedObIds(rejectedObIds) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRejectedObId(rejectedObId: String) = apply { body.addRejectedObId(rejectedObId) }
         ...
         */
        fun rejectedObTyps(rejectedObTyps: List<String>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRejectedObTyp(rejectedObTyp: String) = apply { body.addRejectedObTyp(rejectedObTyp) }

        /**
         * OD parameter value for the Root Mean Square (RMS) convergence criteria to successfully
         * close the OD solution.
         */
        fun rmsConvergenceCriteria(rmsConvergenceCriteria: Double) = apply {
         ...
         * solution.
         */
        fun sensorIds(sensorIds: List<String>) = apply { body.sensorIds(sensorIds) }
         ...
         * supported value.
         */
        fun sensorIds(sensorIds: JsonField<List<String>>) = apply { body.sensorIds(sensorIds) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSensorId(sensorId: String) = apply { body.addSensorId(sensorId) }
        ...
        /** The time span used for the OD of the object, in days. */
        fun timeSpan(timeSpan: Double) = apply { body.timeSpan(timeSpan) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun timeSpan(timeSpan: JsonField<Double>) = apply { body.timeSpan(timeSpan) }
         ...
         */
        fun wrms(wrms: Double) = apply { body.wrms(wrms) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun wrms(wrms: JsonField<Double>) = apply { body.wrms(wrms) }
    ...
    override fun toString() =
        "OrbitdeterminationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
