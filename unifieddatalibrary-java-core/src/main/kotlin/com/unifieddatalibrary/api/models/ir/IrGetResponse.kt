...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IrGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(irGetResponse: IrGetResponse) = apply {
            classificationMarking = irGetResponse.classificationMarking
            dataMode = irGetResponse.dataMode
            name = irGetResponse.name
            source = irGetResponse.source
            id = irGetResponse.id
            createdAt = irGetResponse.createdAt
            createdBy = irGetResponse.createdBy
            description = irGetResponse.description
            entity = irGetResponse.entity
            idEntity = irGetResponse.idEntity
            origin = irGetResponse.origin
            origNetwork = irGetResponse.origNetwork
            updatedAt = irGetResponse.updatedAt
            updatedBy = irGetResponse.updatedBy
            additionalProperties = irGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IrGetResponse].
         *
    ...
    fun validate(): IrGetResponse = apply {
        if (validated) {
            return@apply
        }
