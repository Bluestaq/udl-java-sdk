...
class AttitudeDataAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AttitudeDataAbridged].
         *
    ...
    /** A builder for [AttitudeDataAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeDataAbridged: AttitudeDataAbridged) =
            apply {
                classificationMarking = attitudeDataAbridged.classificationMarking
                dataMode = attitudeDataAbridged.dataMode
                source = attitudeDataAbridged.source
                ts = attitudeDataAbridged.ts
                id = attitudeDataAbridged.id
                asId = attitudeDataAbridged.asId
                coningAngle = attitudeDataAbridged.coningAngle
                createdAt = attitudeDataAbridged.createdAt
                createdBy = attitudeDataAbridged.createdBy
                declination = attitudeDataAbridged.declination
                idOnOrbit = attitudeDataAbridged.idOnOrbit
                motionType = attitudeDataAbridged.motionType
                origin = attitudeDataAbridged.origin
                origNetwork = attitudeDataAbridged.origNetwork
                origObjectId = attitudeDataAbridged.origObjectId
                precPeriod = attitudeDataAbridged.precPeriod
                q1 = attitudeDataAbridged.q1
                q1Dot = attitudeDataAbridged.q1Dot
                q2 = attitudeDataAbridged.q2
                q2Dot = attitudeDataAbridged.q2Dot
                q3 = attitudeDataAbridged.q3
                q3Dot = attitudeDataAbridged.q3Dot
                qc = attitudeDataAbridged.qc
                qcDot = attitudeDataAbridged.qcDot
                ra = attitudeDataAbridged.ra
                satNo = attitudeDataAbridged.satNo
                spinPeriod = attitudeDataAbridged.spinPeriod
                xAngle = attitudeDataAbridged.xAngle.map { it.toMutableList() }
                xRate = attitudeDataAbridged.xRate.map { it.toMutableList() }
                yAngle = attitudeDataAbridged.yAngle.map { it.toMutableList() }
                yRate = attitudeDataAbridged.yRate.map { it.toMutableList() }
                zAngle = attitudeDataAbridged.zAngle.map { it.toMutableList() }
                zRate = attitudeDataAbridged.zRate.map { it.toMutableList() }
                additionalProperties = attitudeDataAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AttitudeDataAbridged].
         *
         ...
         */
        fun build(): AttitudeDataAbridged =
    ...
    fun validate(): AttitudeDataAbridged =
        apply {
            if (validated) {
              return@apply
            }
