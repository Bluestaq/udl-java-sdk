...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudeDataAbridged: AttitudeDataAbridged) = apply {
    ...
    fun validate(): AttitudeDataAbridged = apply {
        if (validated) {
            return@apply
        }
