...
class TupleListPageAsync private constructor(
    ...
    fun autoPager(): AutoPagerAsync<EvacFull> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tupleListPageAsync: TupleListPageAsync) =
            apply {
        ...
        fun service(service: TupleServiceAsync) =
            apply {
    ...
    override fun toString() = "TupleListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
