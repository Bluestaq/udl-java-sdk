...
class OnorbitbatteryCreateParams private constructor(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun battery(): Optional<Battery> = body.battery()
     ...
     */
    fun _battery(): JsonField<Battery> = body._battery()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitbatteryCreateParams].
         *
    ...
    /** A builder for [OnorbitbatteryCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitbatteryCreateParams: OnorbitbatteryCreateParams) =
            apply {
                body = onorbitbatteryCreateParams.body.toBuilder()
                additionalHeaders = onorbitbatteryCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitbatteryCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** ID of the battery. */
        fun idBattery(idBattery: String) =
            apply {
                body.idBattery(idBattery)
            }

        /**
         * Sets [Builder.idBattery] to an arbitrary JSON value.
         *
         * You should usually call [Builder.idBattery] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idBattery(idBattery: JsonField<String>) =
            apply {
                body.idBattery(idBattery)
            }
         ...
         *
         * You should usually call [Builder.battery] with a well-typed [Battery] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun battery(battery: JsonField<Battery>) =
            apply {
                body.battery(battery)
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitbatteryCreateParams].
         *
         ...
         */
        fun build(): OnorbitbatteryCreateParams =
    ...
    class Body private constructor(
        ...
        private val battery: JsonField<Battery>,
        ...
        private constructor(
            ...
            @JsonProperty("battery") @ExcludeMissing battery: JsonField<Battery> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun battery(): Optional<Battery> = battery.getOptional("battery")
        ...
        @ExcludeMissing
        fun _idBattery(): JsonField<String> = idBattery
        ...
        @ExcludeMissing
        fun _battery(): JsonField<Battery> = battery
        ...
        class Builder internal constructor() {
            ...
            private var battery: JsonField<Battery> = JsonMissing.of()
            ...
            /** Model representation of specific spacecraft battery types. */
            fun battery(battery: Battery) = battery(JsonField.of(battery))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idBattery.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (battery.asKnown().getOrNull()?.validity() ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idBattery=$idBattery, idOnOrbit=$idOnOrbit, source=$source, id=$id, battery=$battery, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, additionalProperties=$additionalProperties}"
    }
    ...
    /** Model representation of specific spacecraft battery types. */
    class Battery private constructor(
        private val dataMode: JsonField<DataMode>,
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [Battery].
             *
             * The following fields are required:
             *
             * ```java
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(battery: Battery) =
                apply {
                    dataMode = battery.dataMode
                    name = battery.name
                    source = battery.source
                    id = battery.id
                    createdAt = battery.createdAt
                    createdBy = battery.createdBy
                    origin = battery.origin
                    origNetwork = battery.origNetwork
                    additionalProperties = battery.additionalProperties.toMutableMap()
                }
            ...
            /**
             * Returns an immutable instance of [Battery].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Battery && dataMode == other.dataMode && name == other.name && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && origin == other.origin && origNetwork == other.origNetwork && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Battery{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitbatteryCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OnorbitbatteryCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
