...
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun battery(): Optional<BatteryIngest> = body.battery()
     ...
     */
    fun _battery(): JsonField<BatteryIngest> = body._battery()
    ...
    class Builder internal constructor() {
        ...
        /** Model representation of specific spacecraft battery types. */
        fun battery(battery: BatteryIngest) = apply { body.battery(battery) }

        /**
         * Sets [Builder.battery] to an arbitrary JSON value.
         *
         * You should usually call [Builder.battery] with a well-typed [BatteryIngest] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun battery(battery: JsonField<BatteryIngest>) = apply { body.battery(battery) }
    ...
    private constructor(
        ...
        private val battery: JsonField<BatteryIngest>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            battery: JsonField<BatteryIngest> = JsonMissing.of(),
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun battery(): Optional<BatteryIngest> = battery.getOptional("battery")
         ...
         * Unlike [battery], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("battery") @ExcludeMissing fun _battery(): JsonField<BatteryIngest> = battery
        ...
        class Builder internal constructor() {
            ...
            private var battery: JsonField<BatteryIngest> = JsonMissing.of()
            ...
            /** Model representation of specific spacecraft battery types. */
            fun battery(battery: BatteryIngest) = battery(JsonField.of(battery))
             ...
             * supported value.
             */
            fun battery(battery: JsonField<BatteryIngest>) = apply { this.battery = battery }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitbatteryCreateParams &&
            body == other.body &&
