...
/**
 * Service operation to take a single OnorbitBattery as a POST body and ingest into the database.
 * OnorbitBattery is the association between on-orbit spacecraft batteries and a particular on-orbit
 * spacecraft. A Battery may be associated with many different on-orbit spacecraft. A specific role
 * is required to perform this service operation. Please contact the UDL team for assistance.
 */
class OnorbitbatteryCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitbatteryCreateParams: OnorbitbatteryCreateParams) = apply {
        ...
        /** Model representation of specific spacecraft battery types. */
        fun battery(battery: Battery) = apply { body.battery(battery) }

        /**
         * Sets [Builder.battery] to an arbitrary JSON value.
         *
         * You should usually call [Builder.battery] with a well-typed [Battery] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun battery(battery: JsonField<Battery>) = apply { body.battery(battery) }
    ...
    private constructor(
         ...
         * Unlike [battery], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("battery") @ExcludeMissing fun _battery(): JsonField<Battery> = battery
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.battery] to an arbitrary JSON value.
             *
             * You should usually call [Builder.battery] with a well-typed [Battery] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun battery(battery: JsonField<Battery>) = apply { this.battery = battery }
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idBattery=$idBattery, idOnOrbit=$idOnOrbit, source=$source, id=$id, battery=$battery, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(battery: Battery) = apply {
        ...
        override fun toString() =
            "Battery{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "OnorbitbatteryCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
