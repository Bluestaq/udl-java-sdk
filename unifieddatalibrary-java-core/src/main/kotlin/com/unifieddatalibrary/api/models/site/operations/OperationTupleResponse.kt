...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationTupleResponse: OperationTupleResponse) = apply {
            ...
            operationalDeviations =
                operationTupleResponse.operationalDeviations.map { it.toMutableList() }
            operationalPlannings =
                operationTupleResponse.operationalPlannings.map { it.toMutableList() }
    ...
    fun validate(): OperationTupleResponse = apply {
        if (validated) {
            return@apply
        }
