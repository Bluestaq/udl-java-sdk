...
class OperationTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperationTupleResponse].
         *
    ...
    /** A builder for [OperationTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationTupleResponse: OperationTupleResponse) =
            apply {
                classificationMarking = operationTupleResponse.classificationMarking
                dataMode = operationTupleResponse.dataMode
                idSite = operationTupleResponse.idSite
                source = operationTupleResponse.source
                id = operationTupleResponse.id
                createdAt = operationTupleResponse.createdAt
                createdBy = operationTupleResponse.createdBy
                dailyOperations = operationTupleResponse.dailyOperations.map { it.toMutableList() }
                dopsLastChangedBy = operationTupleResponse.dopsLastChangedBy
                dopsLastChangedDate = operationTupleResponse.dopsLastChangedDate
                dopsLastChangedReason = operationTupleResponse.dopsLastChangedReason
                idLaunchSite = operationTupleResponse.idLaunchSite
                maximumOnGrounds = operationTupleResponse.maximumOnGrounds.map { it.toMutableList() }
                mogsLastChangedBy = operationTupleResponse.mogsLastChangedBy
                mogsLastChangedDate = operationTupleResponse.mogsLastChangedDate
                mogsLastChangedReason = operationTupleResponse.mogsLastChangedReason
                operationalDeviations = operationTupleResponse.operationalDeviations.map { it.toMutableList() }
                operationalPlannings = operationTupleResponse.operationalPlannings.map { it.toMutableList() }
                origin = operationTupleResponse.origin
                origNetwork = operationTupleResponse.origNetwork
                pathways = operationTupleResponse.pathways.map { it.toMutableList() }
                sourceDl = operationTupleResponse.sourceDl
                updatedAt = operationTupleResponse.updatedAt
                updatedBy = operationTupleResponse.updatedBy
                waivers = operationTupleResponse.waivers.map { it.toMutableList() }
                additionalProperties = operationTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OperationTupleResponse].
         *
         ...
         */
        fun build(): OperationTupleResponse =
    ...
    fun validate(): OperationTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
