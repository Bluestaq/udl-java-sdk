...
class BatterydetailRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): BatterydetailRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BatterydetailRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [BatterydetailRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batterydetailRetrieveParams: BatterydetailRetrieveParams) =
            apply {
                id = batterydetailRetrieveParams.id
                firstResult = batterydetailRetrieveParams.firstResult
                maxResults = batterydetailRetrieveParams.maxResults
                additionalHeaders = batterydetailRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = batterydetailRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BatterydetailRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatterydetailRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BatterydetailRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "BatterydetailRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
