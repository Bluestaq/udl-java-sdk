 ...
 */
class BatterydetailRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BatterydetailRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batterydetailRetrieveParams: BatterydetailRetrieveParams) = apply {
    ...
    override fun toString() =
        "BatterydetailRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
