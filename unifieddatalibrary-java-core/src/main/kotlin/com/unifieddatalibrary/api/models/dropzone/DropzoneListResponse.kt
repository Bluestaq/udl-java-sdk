...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DropzoneListResponse].
         *
    ...
    /** A builder for [DropzoneListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneListResponse: DropzoneListResponse) = apply {
            classificationMarking = dropzoneListResponse.classificationMarking
            dataMode = dropzoneListResponse.dataMode
            lat = dropzoneListResponse.lat
            lon = dropzoneListResponse.lon
            name = dropzoneListResponse.name
            source = dropzoneListResponse.source
            id = dropzoneListResponse.id
            altCountryCode = dropzoneListResponse.altCountryCode
            altCountryName = dropzoneListResponse.altCountryName
            approvalDate = dropzoneListResponse.approvalDate
            code = dropzoneListResponse.code
            countryCode = dropzoneListResponse.countryCode
            countryName = dropzoneListResponse.countryName
            createdAt = dropzoneListResponse.createdAt
            createdBy = dropzoneListResponse.createdBy
            expirationDate = dropzoneListResponse.expirationDate
            extIdentifier = dropzoneListResponse.extIdentifier
            idSite = dropzoneListResponse.idSite
            lastUpdate = dropzoneListResponse.lastUpdate
            length = dropzoneListResponse.length
            majcom = dropzoneListResponse.majcom
            nearestLoc = dropzoneListResponse.nearestLoc
            operationalApprovalDate = dropzoneListResponse.operationalApprovalDate
            origin = dropzoneListResponse.origin
            origNetwork = dropzoneListResponse.origNetwork
            pointName = dropzoneListResponse.pointName
            radius = dropzoneListResponse.radius
            recertDate = dropzoneListResponse.recertDate
            remark = dropzoneListResponse.remark
            sourceDl = dropzoneListResponse.sourceDl
            stateAbbr = dropzoneListResponse.stateAbbr
            stateName = dropzoneListResponse.stateName
            surveyDate = dropzoneListResponse.surveyDate
            width = dropzoneListResponse.width
            zarId = dropzoneListResponse.zarId
            additionalProperties = dropzoneListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DropzoneListResponse].
         *
         ...
         */
        fun build(): DropzoneListResponse =
    ...
    fun validate(): DropzoneListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DropzoneListResponse &&
