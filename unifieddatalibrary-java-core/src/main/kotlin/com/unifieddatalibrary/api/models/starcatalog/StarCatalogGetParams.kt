...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StarCatalogGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogGetParams: StarCatalogGetParams) = apply {
    ...
    override fun toString() =
        "StarCatalogGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
