...
class StarCatalogGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): StarCatalogGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StarCatalogGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [StarCatalogGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogGetParams: StarCatalogGetParams) =
            apply {
                id = starCatalogGetParams.id
                firstResult = starCatalogGetParams.firstResult
                maxResults = starCatalogGetParams.maxResults
                additionalHeaders = starCatalogGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = starCatalogGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [StarCatalogGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StarCatalogGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StarCatalogGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "StarCatalogGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
