...
/** Crew Services. */
class CrewAbridged private constructor(
    private val classificationMarking: JsonField<String>,
    private val dataMode: JsonField<DataMode>,
    private val origCrewId: JsonField<String>,
    ...
    private val alertType: JsonField<String>,
    private val armsCrewUnit: JsonField<String>,
    private val assignedQualCode: JsonField<List<String>>,
    private val commanderId: JsonField<String>,
    private val commanderLast4Ssn: JsonField<String>,
    private val commanderName: JsonField<String>,
    private val createdAt: JsonField<OffsetDateTime>,
    private val createdBy: JsonField<String>,
    private val crewHome: JsonField<Boolean>,
    private val crewMembers: JsonField<List<CrewMember>>,
    private val crewName: JsonField<String>,
    private val crewRms: JsonField<String>,
    private val crewRole: JsonField<String>,
    private val crewSource: JsonField<String>,
    private val crewSquadron: JsonField<String>,
    private val crewType: JsonField<String>,
    private val crewUnit: JsonField<String>,
    private val crewWing: JsonField<String>,
    private val currentIcao: JsonField<String>,
    private val fdpEligType: JsonField<String>,
    private val fdpType: JsonField<String>,
    private val femaleEnlistedQty: JsonField<Int>,
    private val femaleOfficerQty: JsonField<Int>,
    private val fltAuthNum: JsonField<String>,
    private val idSiteCurrent: JsonField<String>,
    ...
    private val linkedTask: JsonField<Boolean>,
    private val maleEnlistedQty: JsonField<Int>,
    private val maleOfficerQty: JsonField<Int>,
    private val missionAlias: JsonField<String>,
    private val missionId: JsonField<String>,
    private val origin: JsonField<String>,
    private val origNetwork: JsonField<String>,
    private val personnelType: JsonField<String>,
    ...
    private val stage1Qual: JsonField<String>,
    private val stage2Qual: JsonField<String>,
    private val stage3Qual: JsonField<String>,
    private val stageName: JsonField<String>,
    private val stageTime: JsonField<OffsetDateTime>,
    private val status: JsonField<String>,
    private val transportReq: JsonField<Boolean>,
    private val tripKit: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("origCrewId") @ExcludeMissing origCrewId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("source") @ExcludeMissing source: JsonField<String> = JsonMissing.of(),
        @JsonProperty("id") @ExcludeMissing id: JsonField<String> = JsonMissing.of(),
        @JsonProperty("adjReturnTime") @ExcludeMissing adjReturnTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("adjReturnTimeApprover") @ExcludeMissing adjReturnTimeApprover: JsonField<String> = JsonMissing.of(),
        @JsonProperty("aircraftMDS") @ExcludeMissing aircraftMds: JsonField<String> = JsonMissing.of(),
        @JsonProperty("alertedTime") @ExcludeMissing alertedTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("alertType") @ExcludeMissing alertType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("armsCrewUnit") @ExcludeMissing armsCrewUnit: JsonField<String> = JsonMissing.of(),
        @JsonProperty("assignedQualCode") @ExcludeMissing assignedQualCode: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("commanderId") @ExcludeMissing commanderId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("commanderLast4SSN") @ExcludeMissing commanderLast4Ssn: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("crewHome") @ExcludeMissing crewHome: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("crewMembers") @ExcludeMissing crewMembers: JsonField<List<CrewMember>> = JsonMissing.of(),
        @JsonProperty("crewName") @ExcludeMissing crewName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("crewRMS") @ExcludeMissing crewRms: JsonField<String> = JsonMissing.of(),
        @JsonProperty("crewRole") @ExcludeMissing crewRole: JsonField<String> = JsonMissing.of(),
        @JsonProperty("crewSource") @ExcludeMissing crewSource: JsonField<String> = JsonMissing.of(),
        @JsonProperty("crewSquadron") @ExcludeMissing crewSquadron: JsonField<String> = JsonMissing.of(),
        @JsonProperty("crewType") @ExcludeMissing crewType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("crewUnit") @ExcludeMissing crewUnit: JsonField<String> = JsonMissing.of(),
        @JsonProperty("crewWing") @ExcludeMissing crewWing: JsonField<String> = JsonMissing.of(),
        @JsonProperty("currentICAO") @ExcludeMissing currentIcao: JsonField<String> = JsonMissing.of(),
        @JsonProperty("fdpEligType") @ExcludeMissing fdpEligType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("fdpType") @ExcludeMissing fdpType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("femaleEnlistedQty") @ExcludeMissing femaleEnlistedQty: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("femaleOfficerQty") @ExcludeMissing femaleOfficerQty: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("fltAuthNum") @ExcludeMissing fltAuthNum: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idSiteCurrent") @ExcludeMissing idSiteCurrent: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idSortie") @ExcludeMissing idSortie: JsonField<String> = JsonMissing.of(),
        @JsonProperty("initStartTime") @ExcludeMissing initStartTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("lastAlertTime") @ExcludeMissing lastAlertTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("legalAlertTime") @ExcludeMissing legalAlertTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("legalBravoTime") @ExcludeMissing legalBravoTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("linkedTask") @ExcludeMissing linkedTask: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("maleEnlistedQty") @ExcludeMissing maleEnlistedQty: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("maleOfficerQty") @ExcludeMissing maleOfficerQty: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("missionAlias") @ExcludeMissing missionAlias: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("personnelType") @ExcludeMissing personnelType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("pickupTime") @ExcludeMissing pickupTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("postRestApplied") @ExcludeMissing postRestApplied: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("postRestEnd") @ExcludeMissing postRestEnd: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("postRestOffset") @ExcludeMissing postRestOffset: JsonField<String> = JsonMissing.of(),
        @JsonProperty("preRestApplied") @ExcludeMissing preRestApplied: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("preRestStart") @ExcludeMissing preRestStart: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("reqQualCode") @ExcludeMissing reqQualCode: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("returnTime") @ExcludeMissing returnTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("sourceDL") @ExcludeMissing sourceDl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("stage1Qual") @ExcludeMissing stage1Qual: JsonField<String> = JsonMissing.of(),
        @JsonProperty("stage2Qual") @ExcludeMissing stage2Qual: JsonField<String> = JsonMissing.of(),
        @JsonProperty("stage3Qual") @ExcludeMissing stage3Qual: JsonField<String> = JsonMissing.of(),
        @JsonProperty("stageName") @ExcludeMissing stageName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("stageTime") @ExcludeMissing stageTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("status") @ExcludeMissing status: JsonField<String> = JsonMissing.of(),
        @JsonProperty("transportReq") @ExcludeMissing transportReq: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("tripKit") @ExcludeMissing tripKit: JsonField<String> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun adjReturnTimeApprover(): Optional<String> = adjReturnTimeApprover.getOptional("adjReturnTimeApprover")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun assignedQualCode(): Optional<List<String>> = assignedQualCode.getOptional("assignedQualCode")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun commanderLast4Ssn(): Optional<String> = commanderLast4Ssn.getOptional("commanderLast4SSN")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun legalAlertTime(): Optional<OffsetDateTime> = legalAlertTime.getOptional("legalAlertTime")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun legalBravoTime(): Optional<OffsetDateTime> = legalBravoTime.getOptional("legalBravoTime")
     ...
     *
     * Unlike [adjReturnTime], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [adjReturnTimeApprover], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _alertType(): JsonField<String> = alertType

    /**
     * Returns the raw JSON value of [armsCrewUnit].
     *
     * Unlike [armsCrewUnit], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [assignedQualCode], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [commanderLast4Ssn], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     */
    @JsonProperty("crewHome")
    @ExcludeMissing
    fun _crewHome(): JsonField<Boolean> = crewHome
    ...
    @ExcludeMissing
    fun _crewName(): JsonField<String> = crewName
     ...
     */
    @JsonProperty("crewRMS")
    @ExcludeMissing
    fun _crewRms(): JsonField<String> = crewRms
    ...
    @ExcludeMissing
    fun _crewRole(): JsonField<String> = crewRole
     ...
     *
     * Unlike [crewSquadron], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _crewType(): JsonField<String> = crewType
     ...
     */
    @JsonProperty("crewUnit")
    @ExcludeMissing
    fun _crewUnit(): JsonField<String> = crewUnit
     ...
     */
    @JsonProperty("crewWing")
    @ExcludeMissing
    fun _crewWing(): JsonField<String> = crewWing
     ...
     */
    @JsonProperty("fdpType")
    @ExcludeMissing
    fun _fdpType(): JsonField<String> = fdpType

    /**
     * Returns the raw JSON value of [femaleEnlistedQty].
     *
     * Unlike [femaleEnlistedQty], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [femaleOfficerQty], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [idSiteCurrent], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [initStartTime], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [lastAlertTime], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [legalAlertTime], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [legalBravoTime], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [maleEnlistedQty], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [maleOfficerQty], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [missionAlias], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [personnelType], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [postRestApplied], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [postRestOffset], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [preRestApplied], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [preRestStart], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _stageName(): JsonField<String> = stageName
     ...
     *
     * Unlike [transportReq], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     */
    @JsonProperty("tripKit")
    @ExcludeMissing
    fun _tripKit(): JsonField<String> = tripKit
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CrewAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crewAbridged: CrewAbridged) =
            apply {
                classificationMarking = crewAbridged.classificationMarking
                dataMode = crewAbridged.dataMode
                origCrewId = crewAbridged.origCrewId
                source = crewAbridged.source
                id = crewAbridged.id
                adjReturnTime = crewAbridged.adjReturnTime
                adjReturnTimeApprover = crewAbridged.adjReturnTimeApprover
                aircraftMds = crewAbridged.aircraftMds
                alertedTime = crewAbridged.alertedTime
                alertType = crewAbridged.alertType
                armsCrewUnit = crewAbridged.armsCrewUnit
                assignedQualCode = crewAbridged.assignedQualCode.map { it.toMutableList() }
                commanderId = crewAbridged.commanderId
                commanderLast4Ssn = crewAbridged.commanderLast4Ssn
                commanderName = crewAbridged.commanderName
                createdAt = crewAbridged.createdAt
                createdBy = crewAbridged.createdBy
                crewHome = crewAbridged.crewHome
                crewMembers = crewAbridged.crewMembers.map { it.toMutableList() }
                crewName = crewAbridged.crewName
                crewRms = crewAbridged.crewRms
                crewRole = crewAbridged.crewRole
                crewSource = crewAbridged.crewSource
                crewSquadron = crewAbridged.crewSquadron
                crewType = crewAbridged.crewType
                crewUnit = crewAbridged.crewUnit
                crewWing = crewAbridged.crewWing
                currentIcao = crewAbridged.currentIcao
                fdpEligType = crewAbridged.fdpEligType
                fdpType = crewAbridged.fdpType
                femaleEnlistedQty = crewAbridged.femaleEnlistedQty
                femaleOfficerQty = crewAbridged.femaleOfficerQty
                fltAuthNum = crewAbridged.fltAuthNum
                idSiteCurrent = crewAbridged.idSiteCurrent
                idSortie = crewAbridged.idSortie
                initStartTime = crewAbridged.initStartTime
                lastAlertTime = crewAbridged.lastAlertTime
                legalAlertTime = crewAbridged.legalAlertTime
                legalBravoTime = crewAbridged.legalBravoTime
                linkedTask = crewAbridged.linkedTask
                maleEnlistedQty = crewAbridged.maleEnlistedQty
                maleOfficerQty = crewAbridged.maleOfficerQty
                missionAlias = crewAbridged.missionAlias
                missionId = crewAbridged.missionId
                origin = crewAbridged.origin
                origNetwork = crewAbridged.origNetwork
                personnelType = crewAbridged.personnelType
                pickupTime = crewAbridged.pickupTime
                postRestApplied = crewAbridged.postRestApplied
                postRestEnd = crewAbridged.postRestEnd
                postRestOffset = crewAbridged.postRestOffset
                preRestApplied = crewAbridged.preRestApplied
                preRestStart = crewAbridged.preRestStart
                reqQualCode = crewAbridged.reqQualCode.map { it.toMutableList() }
                returnTime = crewAbridged.returnTime
                sourceDl = crewAbridged.sourceDl
                stage1Qual = crewAbridged.stage1Qual
                stage2Qual = crewAbridged.stage2Qual
                stage3Qual = crewAbridged.stage3Qual
                stageName = crewAbridged.stageName
                stageTime = crewAbridged.stageTime
                status = crewAbridged.status
                transportReq = crewAbridged.transportReq
                tripKit = crewAbridged.tripKit
                updatedAt = crewAbridged.updatedAt
                updatedBy = crewAbridged.updatedBy
                additionalProperties = crewAbridged.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.origCrewId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun origCrewId(origCrewId: JsonField<String>) =
            apply {
                this.origCrewId = origCrewId
            }
        ...
        /** Adjusted return time, in ISO 8601 UTC format with millisecond precision. */
        fun adjReturnTime(adjReturnTime: OffsetDateTime) = adjReturnTime(JsonField.of(adjReturnTime))

        /**
         * Sets [Builder.adjReturnTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.adjReturnTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun adjReturnTime(adjReturnTime: JsonField<OffsetDateTime>) =
            apply {
                this.adjReturnTime = adjReturnTime
            }

        /** Last name of the adjusted return time approver. */
        fun adjReturnTimeApprover(adjReturnTimeApprover: String) = adjReturnTimeApprover(JsonField.of(adjReturnTimeApprover))

        /**
         * Sets [Builder.adjReturnTimeApprover] to an arbitrary JSON value.
         *
         * You should usually call [Builder.adjReturnTimeApprover] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun adjReturnTimeApprover(adjReturnTimeApprover: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.alertedTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alertedTime(alertedTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.alertType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alertType(alertType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.armsCrewUnit] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun armsCrewUnit(armsCrewUnit: JsonField<String>) =
            apply {
                this.armsCrewUnit = armsCrewUnit
            }

        /** Array of qualification codes assigned to this crew (e.g., AL for Aircraft Leader, CS for Combat Systems Operator, etc.). */
        fun assignedQualCode(assignedQualCode: List<String>) = assignedQualCode(JsonField.of(assignedQualCode))

        /**
         * Sets [Builder.assignedQualCode] to an arbitrary JSON value.
         *
         * You should usually call [Builder.assignedQualCode] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun assignedQualCode(assignedQualCode: JsonField<List<String>>) =
            apply {
         ...
         */
        fun addAssignedQualCode(assignedQualCode: String) =
            apply {
                this.assignedQualCode = (this.assignedQualCode ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.commanderId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun commanderId(commanderId: JsonField<String>) =
            apply {
                this.commanderId = commanderId
            }

        /** Last four digits of the crew commander's social security number. */
        fun commanderLast4Ssn(commanderLast4Ssn: String) = commanderLast4Ssn(JsonField.of(commanderLast4Ssn))

        /**
         * Sets [Builder.commanderLast4Ssn] to an arbitrary JSON value.
         *
         * You should usually call [Builder.commanderLast4Ssn] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun commanderLast4Ssn(commanderLast4Ssn: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.crewHome] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewHome(crewHome: JsonField<Boolean>) =
            apply {
                this.crewHome = crewHome
            }
         ...
         *
         * You should usually call [Builder.crewMembers] with a well-typed `List<CrewMember>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewMembers(crewMembers: JsonField<List<CrewMember>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCrewMember(crewMember: CrewMember) =
            apply {
                crewMembers = (crewMembers ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.crewName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewName(crewName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.crewRms] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewRms(crewRms: JsonField<String>) =
            apply {
                this.crewRms = crewRms
            }
         ...
         *
         * You should usually call [Builder.crewRole] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewRole(crewRole: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.crewSource] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewSource(crewSource: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.crewSquadron] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewSquadron(crewSquadron: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.crewType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewType(crewType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.crewUnit] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewUnit(crewUnit: JsonField<String>) =
            apply {
                this.crewUnit = crewUnit
            }
         ...
         *
         * You should usually call [Builder.crewWing] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun crewWing(crewWing: JsonField<String>) =
            apply {
                this.crewWing = crewWing
            }
         ...
         *
         * You should usually call [Builder.currentIcao] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun currentIcao(currentIcao: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.fdpEligType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fdpEligType(fdpEligType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.fdpType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fdpType(fdpType: JsonField<String>) =
            apply {
                this.fdpType = fdpType
            }

        /** The number of female enlisted crew members. */
        fun femaleEnlistedQty(femaleEnlistedQty: Int) = femaleEnlistedQty(JsonField.of(femaleEnlistedQty))

        /**
         * Sets [Builder.femaleEnlistedQty] to an arbitrary JSON value.
         *
         * You should usually call [Builder.femaleEnlistedQty] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun femaleEnlistedQty(femaleEnlistedQty: JsonField<Int>) =
            apply {
                this.femaleEnlistedQty = femaleEnlistedQty
            }

        /** The number of female officer crew members. */
        fun femaleOfficerQty(femaleOfficerQty: Int) = femaleOfficerQty(JsonField.of(femaleOfficerQty))

        /**
         * Sets [Builder.femaleOfficerQty] to an arbitrary JSON value.
         *
         * You should usually call [Builder.femaleOfficerQty] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun femaleOfficerQty(femaleOfficerQty: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.fltAuthNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fltAuthNum(fltAuthNum: JsonField<String>) =
            apply {
                this.fltAuthNum = fltAuthNum
            }
         ...
         *
         * You should usually call [Builder.idSiteCurrent] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idSiteCurrent(idSiteCurrent: JsonField<String>) =
            apply {
        ...
        /** Initial start time of the crew's linked task that was delinked due to mission closure, in ISO 8601 UTC format with millisecond precision. */
        fun initStartTime(initStartTime: OffsetDateTime) = initStartTime(JsonField.of(initStartTime))

        /**
         * Sets [Builder.initStartTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.initStartTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun initStartTime(initStartTime: JsonField<OffsetDateTime>) =
            apply {
                this.initStartTime = initStartTime
            }

        /** The last time the crew can be alerted, in ISO 8601 UTC format with millisecond precision. */
        fun lastAlertTime(lastAlertTime: OffsetDateTime) = lastAlertTime(JsonField.of(lastAlertTime))

        /**
         * Sets [Builder.lastAlertTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lastAlertTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lastAlertTime(lastAlertTime: JsonField<OffsetDateTime>) =
            apply {
                this.lastAlertTime = lastAlertTime
            }

        /** Time the crew is legal for alert, in ISO 8601 UTC format with millisecond precision. */
        fun legalAlertTime(legalAlertTime: OffsetDateTime) = legalAlertTime(JsonField.of(legalAlertTime))

        /**
         * Sets [Builder.legalAlertTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.legalAlertTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun legalAlertTime(legalAlertTime: JsonField<OffsetDateTime>) =
            apply {
                this.legalAlertTime = legalAlertTime
            }

        /** Time the crew is legally authorized or scheduled to remain on standby for duty, in ISO 8601 UTC format with millisecond precision. */
        fun legalBravoTime(legalBravoTime: OffsetDateTime) = legalBravoTime(JsonField.of(legalBravoTime))

        /**
         * Sets [Builder.legalBravoTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.legalBravoTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun legalBravoTime(legalBravoTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.linkedTask] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun linkedTask(linkedTask: JsonField<Boolean>) =
            apply {
                this.linkedTask = linkedTask
            }

        /** The number of male enlisted crew members. */
        fun maleEnlistedQty(maleEnlistedQty: Int) = maleEnlistedQty(JsonField.of(maleEnlistedQty))

        /**
         * Sets [Builder.maleEnlistedQty] to an arbitrary JSON value.
         *
         * You should usually call [Builder.maleEnlistedQty] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maleEnlistedQty(maleEnlistedQty: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.maleOfficerQty] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maleOfficerQty(maleOfficerQty: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.missionAlias] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun missionAlias(missionAlias: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.personnelType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun personnelType(personnelType: JsonField<String>) =
            apply {
        ...
        /** Flag indicating whether post-mission crew rest is applied to the last sortie of a crew's task. */
        fun postRestApplied(postRestApplied: Boolean) = postRestApplied(JsonField.of(postRestApplied))

        /**
         * Sets [Builder.postRestApplied] to an arbitrary JSON value.
         *
         * You should usually call [Builder.postRestApplied] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun postRestApplied(postRestApplied: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.postRestEnd] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun postRestEnd(postRestEnd: JsonField<OffsetDateTime>) =
            apply {
                this.postRestEnd = postRestEnd
            }

        /** The scheduled delay or adjustment in the start time of a crew's rest period after a mission, expressed as +/-HH:MM. */
        fun postRestOffset(postRestOffset: String) = postRestOffset(JsonField.of(postRestOffset))

        /**
         * Sets [Builder.postRestOffset] to an arbitrary JSON value.
         *
         * You should usually call [Builder.postRestOffset] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun postRestOffset(postRestOffset: JsonField<String>) =
            apply {
                this.postRestOffset = postRestOffset
            }

        /** Flag indicating whether pre-mission crew rest is applied to the first sortie of a crew's task. */
        fun preRestApplied(preRestApplied: Boolean) = preRestApplied(JsonField.of(preRestApplied))

        /**
         * Sets [Builder.preRestApplied] to an arbitrary JSON value.
         *
         * You should usually call [Builder.preRestApplied] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun preRestApplied(preRestApplied: JsonField<Boolean>) =
            apply {
                this.preRestApplied = preRestApplied
            }

        /** Start time of the crew rest period before the mission, in ISO 8601 UTC format with millisecond precision. */
        fun preRestStart(preRestStart: OffsetDateTime) = preRestStart(JsonField.of(preRestStart))

        /**
         * Sets [Builder.preRestStart] to an arbitrary JSON value.
         *
         * You should usually call [Builder.preRestStart] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun preRestStart(preRestStart: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.reqQualCode] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reqQualCode(reqQualCode: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addReqQualCode(reqQualCode: String) =
            apply {
                this.reqQualCode = (this.reqQualCode ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.returnTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun returnTime(returnTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.stage1Qual] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stage1Qual(stage1Qual: JsonField<String>) =
            apply {
                this.stage1Qual = stage1Qual
            }
         ...
         *
         * You should usually call [Builder.stage2Qual] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stage2Qual(stage2Qual: JsonField<String>) =
            apply {
                this.stage2Qual = stage2Qual
            }
         ...
         *
         * You should usually call [Builder.stage3Qual] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stage3Qual(stage3Qual: JsonField<String>) =
            apply {
                this.stage3Qual = stage3Qual
            }
         ...
         *
         * You should usually call [Builder.stageName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stageName(stageName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.stageTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stageTime(stageTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.transportReq] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transportReq(transportReq: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.tripKit] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tripKit(tripKit: JsonField<String>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [CrewAbridged].
         *
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (origCrewId.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (adjReturnTime.asKnown().isPresent) 1 else 0) + (if (adjReturnTimeApprover.asKnown().isPresent) 1 else 0) + (if (aircraftMds.asKnown().isPresent) 1 else 0) + (if (alertedTime.asKnown().isPresent) 1 else 0) + (if (alertType.asKnown().isPresent) 1 else 0) + (if (armsCrewUnit.asKnown().isPresent) 1 else 0) + (assignedQualCode.asKnown().getOrNull()?.size ?: 0) + (if (commanderId.asKnown().isPresent) 1 else 0) + (if (commanderLast4Ssn.asKnown().isPresent) 1 else 0) + (if (commanderName.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (crewHome.asKnown().isPresent) 1 else 0) + (crewMembers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (crewName.asKnown().isPresent) 1 else 0) + (if (crewRms.asKnown().isPresent) 1 else 0) + (if (crewRole.asKnown().isPresent) 1 else 0) + (if (crewSource.asKnown().isPresent) 1 else 0) + (if (crewSquadron.asKnown().isPresent) 1 else 0) + (if (crewType.asKnown().isPresent) 1 else 0) + (if (crewUnit.asKnown().isPresent) 1 else 0) + (if (crewWing.asKnown().isPresent) 1 else 0) + (if (currentIcao.asKnown().isPresent) 1 else 0) + (if (fdpEligType.asKnown().isPresent) 1 else 0) + (if (fdpType.asKnown().isPresent) 1 else 0) + (if (femaleEnlistedQty.asKnown().isPresent) 1 else 0) + (if (femaleOfficerQty.asKnown().isPresent) 1 else 0) + (if (fltAuthNum.asKnown().isPresent) 1 else 0) + (if (idSiteCurrent.asKnown().isPresent) 1 else 0) + (if (idSortie.asKnown().isPresent) 1 else 0) + (if (initStartTime.asKnown().isPresent) 1 else 0) + (if (lastAlertTime.asKnown().isPresent) 1 else 0) + (if (legalAlertTime.asKnown().isPresent) 1 else 0) + (if (legalBravoTime.asKnown().isPresent) 1 else 0) + (if (linkedTask.asKnown().isPresent) 1 else 0) + (if (maleEnlistedQty.asKnown().isPresent) 1 else 0) + (if (maleOfficerQty.asKnown().isPresent) 1 else 0) + (if (missionAlias.asKnown().isPresent) 1 else 0) + (if (missionId.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (personnelType.asKnown().isPresent) 1 else 0) + (if (pickupTime.asKnown().isPresent) 1 else 0) + (if (postRestApplied.asKnown().isPresent) 1 else 0) + (if (postRestEnd.asKnown().isPresent) 1 else 0) + (if (postRestOffset.asKnown().isPresent) 1 else 0) + (if (preRestApplied.asKnown().isPresent) 1 else 0) + (if (preRestStart.asKnown().isPresent) 1 else 0) + (reqQualCode.asKnown().getOrNull()?.size ?: 0) + (if (returnTime.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (stage1Qual.asKnown().isPresent) 1 else 0) + (if (stage2Qual.asKnown().isPresent) 1 else 0) + (if (stage3Qual.asKnown().isPresent) 1 else 0) + (if (stageName.asKnown().isPresent) 1 else 0) + (if (stageTime.asKnown().isPresent) 1 else 0) + (if (status.asKnown().isPresent) 1 else 0) + (if (transportReq.asKnown().isPresent) 1 else 0) + (if (tripKit.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    class CrewMember private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("alerted") @ExcludeMissing alerted: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("allSortie") @ExcludeMissing allSortie: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("approved") @ExcludeMissing approved: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("attached") @ExcludeMissing attached: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("branch") @ExcludeMissing branch: JsonField<String> = JsonMissing.of(),
            @JsonProperty("civilian") @ExcludeMissing civilian: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("commander") @ExcludeMissing commander: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("crewPosition") @ExcludeMissing crewPosition: JsonField<String> = JsonMissing.of(),
            @JsonProperty("dodID") @ExcludeMissing dodId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("dutyPosition") @ExcludeMissing dutyPosition: JsonField<String> = JsonMissing.of(),
            @JsonProperty("dutyStatus") @ExcludeMissing dutyStatus: JsonField<String> = JsonMissing.of(),
            @JsonProperty("emailed") @ExcludeMissing emailed: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("extraTime") @ExcludeMissing extraTime: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("firstName") @ExcludeMissing firstName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("fltCurrencyExp") @ExcludeMissing fltCurrencyExp: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("fltCurrencyExpId") @ExcludeMissing fltCurrencyExpId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("fltRecDate") @ExcludeMissing fltRecDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("fltRecDue") @ExcludeMissing fltRecDue: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("flySquadron") @ExcludeMissing flySquadron: JsonField<String> = JsonMissing.of(),
            @JsonProperty("funded") @ExcludeMissing funded: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("gender") @ExcludeMissing gender: JsonField<String> = JsonMissing.of(),
            @JsonProperty("gndCurrencyExp") @ExcludeMissing gndCurrencyExp: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("gndCurrencyExpId") @ExcludeMissing gndCurrencyExpId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("grounded") @ExcludeMissing grounded: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("guestStart") @ExcludeMissing guestStart: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("guestStop") @ExcludeMissing guestStop: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("last4SSN") @ExcludeMissing last4Ssn: JsonField<String> = JsonMissing.of(),
            @JsonProperty("lastFltDate") @ExcludeMissing lastFltDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("lastName") @ExcludeMissing lastName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("loanedTo") @ExcludeMissing loanedTo: JsonField<String> = JsonMissing.of(),
            @JsonProperty("lodging") @ExcludeMissing lodging: JsonField<String> = JsonMissing.of(),
            @JsonProperty("memberActualAlertTime") @ExcludeMissing memberActualAlertTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberAdjReturnTime") @ExcludeMissing memberAdjReturnTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberAdjReturnTimeApprover") @ExcludeMissing memberAdjReturnTimeApprover: JsonField<String> = JsonMissing.of(),
            @JsonProperty("memberId") @ExcludeMissing memberId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("memberInitStartTime") @ExcludeMissing memberInitStartTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberLastAlertTime") @ExcludeMissing memberLastAlertTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberLegalAlertTime") @ExcludeMissing memberLegalAlertTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberPickupTime") @ExcludeMissing memberPickupTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberPostRestOffset") @ExcludeMissing memberPostRestOffset: JsonField<String> = JsonMissing.of(),
            @JsonProperty("memberPostRestTime") @ExcludeMissing memberPostRestTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberPreRestTime") @ExcludeMissing memberPreRestTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberRemarks") @ExcludeMissing memberRemarks: JsonField<String> = JsonMissing.of(),
            @JsonProperty("memberReturnTime") @ExcludeMissing memberReturnTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberSchedAlertTime") @ExcludeMissing memberSchedAlertTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("memberSource") @ExcludeMissing memberSource: JsonField<String> = JsonMissing.of(),
            @JsonProperty("memberStageName") @ExcludeMissing memberStageName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("memberTransportReq") @ExcludeMissing memberTransportReq: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("memberType") @ExcludeMissing memberType: JsonField<String> = JsonMissing.of(),
            @JsonProperty("middleInitial") @ExcludeMissing middleInitial: JsonField<String> = JsonMissing.of(),
            @JsonProperty("notified") @ExcludeMissing notified: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("phoneNumber") @ExcludeMissing phoneNumber: JsonField<String> = JsonMissing.of(),
            @JsonProperty("physAvCode") @ExcludeMissing physAvCode: JsonField<String> = JsonMissing.of(),
            @JsonProperty("physAvStatus") @ExcludeMissing physAvStatus: JsonField<String> = JsonMissing.of(),
            @JsonProperty("physDue") @ExcludeMissing physDue: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("rank") @ExcludeMissing rank: JsonField<String> = JsonMissing.of(),
            @JsonProperty("remarkCode") @ExcludeMissing remarkCode: JsonField<String> = JsonMissing.of(),
            @JsonProperty("rmsMDS") @ExcludeMissing rmsMds: JsonField<String> = JsonMissing.of(),
            @JsonProperty("showTime") @ExcludeMissing showTime: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("squadron") @ExcludeMissing squadron: JsonField<String> = JsonMissing.of(),
            @JsonProperty("trainingDate") @ExcludeMissing trainingDate: JsonField<OffsetDateTime> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun fltCurrencyExp(): Optional<OffsetDateTime> = fltCurrencyExp.getOptional("fltCurrencyExp")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun fltCurrencyExpId(): Optional<String> = fltCurrencyExpId.getOptional("fltCurrencyExpId")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun gndCurrencyExp(): Optional<OffsetDateTime> = gndCurrencyExp.getOptional("gndCurrencyExp")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun gndCurrencyExpId(): Optional<String> = gndCurrencyExpId.getOptional("gndCurrencyExpId")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberActualAlertTime(): Optional<OffsetDateTime> = memberActualAlertTime.getOptional("memberActualAlertTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberAdjReturnTime(): Optional<OffsetDateTime> = memberAdjReturnTime.getOptional("memberAdjReturnTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberAdjReturnTimeApprover(): Optional<String> = memberAdjReturnTimeApprover.getOptional("memberAdjReturnTimeApprover")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberInitStartTime(): Optional<OffsetDateTime> = memberInitStartTime.getOptional("memberInitStartTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberLastAlertTime(): Optional<OffsetDateTime> = memberLastAlertTime.getOptional("memberLastAlertTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberLegalAlertTime(): Optional<OffsetDateTime> = memberLegalAlertTime.getOptional("memberLegalAlertTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberPickupTime(): Optional<OffsetDateTime> = memberPickupTime.getOptional("memberPickupTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberPostRestOffset(): Optional<String> = memberPostRestOffset.getOptional("memberPostRestOffset")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberPostRestTime(): Optional<OffsetDateTime> = memberPostRestTime.getOptional("memberPostRestTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberPreRestTime(): Optional<OffsetDateTime> = memberPreRestTime.getOptional("memberPreRestTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberReturnTime(): Optional<OffsetDateTime> = memberReturnTime.getOptional("memberReturnTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberSchedAlertTime(): Optional<OffsetDateTime> = memberSchedAlertTime.getOptional("memberSchedAlertTime")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun memberTransportReq(): Optional<Boolean> = memberTransportReq.getOptional("memberTransportReq")
        ...
        @ExcludeMissing
        fun _alerted(): JsonField<Boolean> = alerted

        /**
         * Returns the raw JSON value of [allSortie].
         *
         * Unlike [allSortie], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [attached], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("attached")
        @ExcludeMissing
        fun _attached(): JsonField<Boolean> = attached
         ...
         *
         * Unlike [civilian], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("civilian")
        @ExcludeMissing
        fun _civilian(): JsonField<Boolean> = civilian

        /**
         * Returns the raw JSON value of [commander].
         *
         * Unlike [commander], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [crewPosition], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("dodID")
        @ExcludeMissing
        fun _dodId(): JsonField<String> = dodId

        /**
         * Returns the raw JSON value of [dutyPosition].
         *
         * Unlike [dutyPosition], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [dutyStatus], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _emailed(): JsonField<Boolean> = emailed

        /**
         * Returns the raw JSON value of [extraTime].
         *
         * Unlike [extraTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [fltCurrencyExp], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [fltCurrencyExpId], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [fltRecDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [fltRecDue], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [flySquadron], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("funded")
        @ExcludeMissing
        fun _funded(): JsonField<Boolean> = funded
         ...
         *
         * Unlike [gndCurrencyExp], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [gndCurrencyExpId], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [grounded], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("grounded")
        @ExcludeMissing
        fun _grounded(): JsonField<Boolean> = grounded

        /**
         * Returns the raw JSON value of [guestStart].
         *
         * Unlike [guestStart], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [guestStop], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [lastFltDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [loanedTo], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("loanedTo")
        @ExcludeMissing
        fun _loanedTo(): JsonField<String> = loanedTo
        ...
        @ExcludeMissing
        fun _lodging(): JsonField<String> = lodging

        /**
         * Returns the raw JSON value of [memberActualAlertTime].
         *
         * Unlike [memberActualAlertTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberAdjReturnTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberAdjReturnTimeApprover], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _memberId(): JsonField<String> = memberId

        /**
         * Returns the raw JSON value of [memberInitStartTime].
         *
         * Unlike [memberInitStartTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberLastAlertTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberLegalAlertTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberPickupTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberPostRestOffset], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberPostRestTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberPreRestTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberRemarks], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberReturnTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberSchedAlertTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberSource], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberStageName], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [memberTransportReq], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [middleInitial], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [notified], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("notified")
        @ExcludeMissing
        fun _notified(): JsonField<Boolean> = notified
         ...
         *
         * Unlike [physAvCode], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [physAvStatus], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [remarkCode], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("rmsMDS")
        @ExcludeMissing
        fun _rmsMds(): JsonField<String> = rmsMds

        /**
         * Returns the raw JSON value of [showTime].
         *
         * Unlike [showTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [squadron], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("squadron")
        @ExcludeMissing
        fun _squadron(): JsonField<String> = squadron

        /**
         * Returns the raw JSON value of [trainingDate].
         *
         * Unlike [trainingDate], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("wing")
        @ExcludeMissing
        fun _wing(): JsonField<String> = wing
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(crewMember: CrewMember) =
                apply {
             ...
             *
             * You should usually call [Builder.alerted] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun alerted(alerted: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.allSortie] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun allSortie(allSortie: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.approved] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun approved(approved: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.attached] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun attached(attached: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.branch] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.civilian] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun civilian(civilian: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.commander] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun commander(commander: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.crewPosition] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun crewPosition(crewPosition: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.dodId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dodId(dodId: JsonField<String>) =
                apply {
                    this.dodId = dodId
                }
             ...
             *
             * You should usually call [Builder.dutyPosition] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dutyPosition(dutyPosition: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.dutyStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dutyStatus(dutyStatus: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.emailed] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun emailed(emailed: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.extraTime] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun extraTime(extraTime: JsonField<Boolean>) =
                apply {
            ...
            /** The earliest flying currency expiration date for this crew member, in ISO 8601 UTC format with millisecond precision. */
            fun fltCurrencyExp(fltCurrencyExp: OffsetDateTime) = fltCurrencyExp(JsonField.of(fltCurrencyExp))

            /**
             * Sets [Builder.fltCurrencyExp] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fltCurrencyExp] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fltCurrencyExp(fltCurrencyExp: JsonField<OffsetDateTime>) =
                apply {
                    this.fltCurrencyExp = fltCurrencyExp
                }

            /** The training task identifier associated with the flying currency expiration date for this crew member. */
            fun fltCurrencyExpId(fltCurrencyExpId: String) = fltCurrencyExpId(JsonField.of(fltCurrencyExpId))

            /**
             * Sets [Builder.fltCurrencyExpId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fltCurrencyExpId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fltCurrencyExpId(fltCurrencyExpId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.fltRecDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fltRecDate(fltRecDate: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.fltRecDue] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fltRecDue(fltRecDue: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.flySquadron] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun flySquadron(flySquadron: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.funded] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun funded(funded: JsonField<Boolean>) =
                apply {
                    this.funded = funded
                }
            ...
            /** The earliest ground currency expiration date for this crew member, in ISO 8601 UTC format with millisecond precision. */
            fun gndCurrencyExp(gndCurrencyExp: OffsetDateTime) = gndCurrencyExp(JsonField.of(gndCurrencyExp))

            /**
             * Sets [Builder.gndCurrencyExp] to an arbitrary JSON value.
             *
             * You should usually call [Builder.gndCurrencyExp] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun gndCurrencyExp(gndCurrencyExp: JsonField<OffsetDateTime>) =
                apply {
                    this.gndCurrencyExp = gndCurrencyExp
                }

            /** The training task identifier associated with the ground currency expiration date for this crew member. */
            fun gndCurrencyExpId(gndCurrencyExpId: String) = gndCurrencyExpId(JsonField.of(gndCurrencyExpId))

            /**
             * Sets [Builder.gndCurrencyExpId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.gndCurrencyExpId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun gndCurrencyExpId(gndCurrencyExpId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.grounded] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun grounded(grounded: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.guestStart] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun guestStart(guestStart: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.guestStop] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun guestStop(guestStop: JsonField<OffsetDateTime>) =
                apply {
            ...
            /** Date of the last flight for this crew member, in ISO 8601 UTC format with millisecond precision. */
            fun lastFltDate(lastFltDate: OffsetDateTime) = lastFltDate(JsonField.of(lastFltDate))

            /**
             * Sets [Builder.lastFltDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.lastFltDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lastFltDate(lastFltDate: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.loanedTo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun loanedTo(loanedTo: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.lodging] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lodging(lodging: JsonField<String>) =
                apply {
                    this.lodging = lodging
                }

            /** Time this crew member was actually alerted for the mission, in ISO 8601 UTC format with millisecond precision. */
            fun memberActualAlertTime(memberActualAlertTime: OffsetDateTime) = memberActualAlertTime(JsonField.of(memberActualAlertTime))

            /**
             * Sets [Builder.memberActualAlertTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberActualAlertTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** Adjusted return time for the crew member, in ISO 8601 UTC format with millisecond precision. */
            fun memberAdjReturnTime(memberAdjReturnTime: OffsetDateTime) = memberAdjReturnTime(JsonField.of(memberAdjReturnTime))

            /**
             * Sets [Builder.memberAdjReturnTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberAdjReturnTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberAdjReturnTime(memberAdjReturnTime: JsonField<OffsetDateTime>) =
                apply {
                    this.memberAdjReturnTime = memberAdjReturnTime
                }

            /** Last name of the crew member's adjusted return time approver. */
            fun memberAdjReturnTimeApprover(memberAdjReturnTimeApprover: String) = memberAdjReturnTimeApprover(JsonField.of(memberAdjReturnTimeApprover))

            /**
             * Sets [Builder.memberAdjReturnTimeApprover] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberAdjReturnTimeApprover] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.memberId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberId(memberId: JsonField<String>) =
                apply {
                    this.memberId = memberId
                }

            /** Initial start time of the crew member's linked task that was delinked due to mission closure, in ISO 8601 UTC format with millisecond precision. */
            fun memberInitStartTime(memberInitStartTime: OffsetDateTime) = memberInitStartTime(JsonField.of(memberInitStartTime))

            /**
             * Sets [Builder.memberInitStartTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberInitStartTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberInitStartTime(memberInitStartTime: JsonField<OffsetDateTime>) =
                apply {
                    this.memberInitStartTime = memberInitStartTime
                }

            /** The latest possible time the crew member can legally be alerted for a task, in ISO 8601 UTC format with millisecond precision. */
            fun memberLastAlertTime(memberLastAlertTime: OffsetDateTime) = memberLastAlertTime(JsonField.of(memberLastAlertTime))

            /**
             * Sets [Builder.memberLastAlertTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberLastAlertTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberLastAlertTime(memberLastAlertTime: JsonField<OffsetDateTime>) =
                apply {
                    this.memberLastAlertTime = memberLastAlertTime
                }

            /** Time this crew member becomes eligible to be alerted for the mission, in ISO 8601 UTC format with millisecond precision. */
            fun memberLegalAlertTime(memberLegalAlertTime: OffsetDateTime) = memberLegalAlertTime(JsonField.of(memberLegalAlertTime))

            /**
             * Sets [Builder.memberLegalAlertTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberLegalAlertTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberLegalAlertTime(memberLegalAlertTime: JsonField<OffsetDateTime>) =
                apply {
                    this.memberLegalAlertTime = memberLegalAlertTime
                }

            /** Time this crew member will be picked up from lodging, in ISO 8601 UTC format with millisecond precision. */
            fun memberPickupTime(memberPickupTime: OffsetDateTime) = memberPickupTime(JsonField.of(memberPickupTime))

            /**
             * Sets [Builder.memberPickupTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberPickupTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberPickupTime(memberPickupTime: JsonField<OffsetDateTime>) =
                apply {
                    this.memberPickupTime = memberPickupTime
                }

            /** The scheduled delay or adjustment in the start time of a crew member's rest period after a mission, expressed as +/-HH:MM. */
            fun memberPostRestOffset(memberPostRestOffset: String) = memberPostRestOffset(JsonField.of(memberPostRestOffset))

            /**
             * Sets [Builder.memberPostRestOffset] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberPostRestOffset] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberPostRestOffset(memberPostRestOffset: JsonField<String>) =
                apply {
                    this.memberPostRestOffset = memberPostRestOffset
                }

            /** End time of this crew member's rest period after the mission, in ISO 8601 UTC format with millisecond precision. */
            fun memberPostRestTime(memberPostRestTime: OffsetDateTime) = memberPostRestTime(JsonField.of(memberPostRestTime))

            /**
             * Sets [Builder.memberPostRestTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberPostRestTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberPostRestTime(memberPostRestTime: JsonField<OffsetDateTime>) =
                apply {
                    this.memberPostRestTime = memberPostRestTime
                }

            /** Start time of this crew member's rest period before the mission, in ISO 8601 UTC format with millisecond precision. */
            fun memberPreRestTime(memberPreRestTime: OffsetDateTime) = memberPreRestTime(JsonField.of(memberPreRestTime))

            /**
             * Sets [Builder.memberPreRestTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberPreRestTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberPreRestTime(memberPreRestTime: JsonField<OffsetDateTime>) =
                apply {
                    this.memberPreRestTime = memberPreRestTime
                }

            /** Remarks concerning the crew member. */
            fun memberRemarks(memberRemarks: String) = memberRemarks(JsonField.of(memberRemarks))

            /**
             * Sets [Builder.memberRemarks] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberRemarks] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberRemarks(memberRemarks: JsonField<String>) =
                apply {
                    this.memberRemarks = memberRemarks
                }

            /** Scheduled return time for this crew member, in ISO 8601 UTC format with millisecond precision. */
            fun memberReturnTime(memberReturnTime: OffsetDateTime) = memberReturnTime(JsonField.of(memberReturnTime))

            /**
             * Sets [Builder.memberReturnTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberReturnTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberReturnTime(memberReturnTime: JsonField<OffsetDateTime>) =
                apply {
                    this.memberReturnTime = memberReturnTime
                }

            /** Time this crew member is scheduled to be alerted for the mission, in ISO 8601 UTC format with millisecond precision. */
            fun memberSchedAlertTime(memberSchedAlertTime: OffsetDateTime) = memberSchedAlertTime(JsonField.of(memberSchedAlertTime))

            /**
             * Sets [Builder.memberSchedAlertTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberSchedAlertTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberSchedAlertTime(memberSchedAlertTime: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.memberSource] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberSource(memberSource: JsonField<String>) =
                apply {
                    this.memberSource = memberSource
                }

            /** Stage name for the crew member. A stage is a pool of crews supporting a given operation plan. */
            fun memberStageName(memberStageName: String) = memberStageName(JsonField.of(memberStageName))

            /**
             * Sets [Builder.memberStageName] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberStageName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberStageName(memberStageName: JsonField<String>) =
                apply {
                    this.memberStageName = memberStageName
                }

            /** Flag indicating whether this crew member needs transportation to the departure location. */
            fun memberTransportReq(memberTransportReq: Boolean) = memberTransportReq(JsonField.of(memberTransportReq))

            /**
             * Sets [Builder.memberTransportReq] to an arbitrary JSON value.
             *
             * You should usually call [Builder.memberTransportReq] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberTransportReq(memberTransportReq: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.memberType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun memberType(memberType: JsonField<String>) =
                apply {
                    this.memberType = memberType
                }

            /** The middle initial of the crew member. */
            fun middleInitial(middleInitial: String) = middleInitial(JsonField.of(middleInitial))

            /**
             * Sets [Builder.middleInitial] to an arbitrary JSON value.
             *
             * You should usually call [Builder.middleInitial] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun middleInitial(middleInitial: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.notified] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun notified(notified: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.physAvCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun physAvCode(physAvCode: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.physAvStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun physAvStatus(physAvStatus: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.physDue] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun physDue(physDue: JsonField<OffsetDateTime>) =
                apply {
                    this.physDue = physDue
                }
             ...
             *
             * You should usually call [Builder.remarkCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun remarkCode(remarkCode: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.rmsMds] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rmsMds(rmsMds: JsonField<String>) =
                apply {
                    this.rmsMds = rmsMds
                }
             ...
             *
             * You should usually call [Builder.showTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun showTime(showTime: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.squadron] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun squadron(squadron: JsonField<String>) =
                apply {
                    this.squadron = squadron
                }

            /** The date this crew member accomplished physiological or altitude chamber training, in ISO 8601 UTC format with millisecond precision. */
            fun trainingDate(trainingDate: OffsetDateTime) = trainingDate(JsonField.of(trainingDate))

            /**
             * Sets [Builder.trainingDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.trainingDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun trainingDate(trainingDate: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.wing] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun wing(wing: JsonField<String>) =
                apply {
                    this.wing = wing
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (alerted.asKnown().isPresent) 1 else 0) + (if (allSortie.asKnown().isPresent) 1 else 0) + (if (approved.asKnown().isPresent) 1 else 0) + (if (attached.asKnown().isPresent) 1 else 0) + (if (branch.asKnown().isPresent) 1 else 0) + (if (civilian.asKnown().isPresent) 1 else 0) + (if (commander.asKnown().isPresent) 1 else 0) + (if (crewPosition.asKnown().isPresent) 1 else 0) + (if (dodId.asKnown().isPresent) 1 else 0) + (if (dutyPosition.asKnown().isPresent) 1 else 0) + (if (dutyStatus.asKnown().isPresent) 1 else 0) + (if (emailed.asKnown().isPresent) 1 else 0) + (if (extraTime.asKnown().isPresent) 1 else 0) + (if (firstName.asKnown().isPresent) 1 else 0) + (if (fltCurrencyExp.asKnown().isPresent) 1 else 0) + (if (fltCurrencyExpId.asKnown().isPresent) 1 else 0) + (if (fltRecDate.asKnown().isPresent) 1 else 0) + (if (fltRecDue.asKnown().isPresent) 1 else 0) + (if (flySquadron.asKnown().isPresent) 1 else 0) + (if (funded.asKnown().isPresent) 1 else 0) + (if (gender.asKnown().isPresent) 1 else 0) + (if (gndCurrencyExp.asKnown().isPresent) 1 else 0) + (if (gndCurrencyExpId.asKnown().isPresent) 1 else 0) + (if (grounded.asKnown().isPresent) 1 else 0) + (if (guestStart.asKnown().isPresent) 1 else 0) + (if (guestStop.asKnown().isPresent) 1 else 0) + (if (last4Ssn.asKnown().isPresent) 1 else 0) + (if (lastFltDate.asKnown().isPresent) 1 else 0) + (if (lastName.asKnown().isPresent) 1 else 0) + (if (loanedTo.asKnown().isPresent) 1 else 0) + (if (lodging.asKnown().isPresent) 1 else 0) + (if (memberActualAlertTime.asKnown().isPresent) 1 else 0) + (if (memberAdjReturnTime.asKnown().isPresent) 1 else 0) + (if (memberAdjReturnTimeApprover.asKnown().isPresent) 1 else 0) + (if (memberId.asKnown().isPresent) 1 else 0) + (if (memberInitStartTime.asKnown().isPresent) 1 else 0) + (if (memberLastAlertTime.asKnown().isPresent) 1 else 0) + (if (memberLegalAlertTime.asKnown().isPresent) 1 else 0) + (if (memberPickupTime.asKnown().isPresent) 1 else 0) + (if (memberPostRestOffset.asKnown().isPresent) 1 else 0) + (if (memberPostRestTime.asKnown().isPresent) 1 else 0) + (if (memberPreRestTime.asKnown().isPresent) 1 else 0) + (if (memberRemarks.asKnown().isPresent) 1 else 0) + (if (memberReturnTime.asKnown().isPresent) 1 else 0) + (if (memberSchedAlertTime.asKnown().isPresent) 1 else 0) + (if (memberSource.asKnown().isPresent) 1 else 0) + (if (memberStageName.asKnown().isPresent) 1 else 0) + (if (memberTransportReq.asKnown().isPresent) 1 else 0) + (if (memberType.asKnown().isPresent) 1 else 0) + (if (middleInitial.asKnown().isPresent) 1 else 0) + (if (notified.asKnown().isPresent) 1 else 0) + (if (phoneNumber.asKnown().isPresent) 1 else 0) + (if (physAvCode.asKnown().isPresent) 1 else 0) + (if (physAvStatus.asKnown().isPresent) 1 else 0) + (if (physDue.asKnown().isPresent) 1 else 0) + (if (rank.asKnown().isPresent) 1 else 0) + (if (remarkCode.asKnown().isPresent) 1 else 0) + (if (rmsMds.asKnown().isPresent) 1 else 0) + (if (showTime.asKnown().isPresent) 1 else 0) + (if (squadron.asKnown().isPresent) 1 else 0) + (if (trainingDate.asKnown().isPresent) 1 else 0) + (if (username.asKnown().isPresent) 1 else 0) + (if (wing.asKnown().isPresent) 1 else 0)
