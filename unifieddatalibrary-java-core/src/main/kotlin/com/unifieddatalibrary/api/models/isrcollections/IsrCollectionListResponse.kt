...
private constructor(
    ...
    @JsonProperty("collectionRequirements")
    @ExcludeMissing
    fun _collectionRequirements(): JsonField<List<CollectionRequirement>> = collectionRequirements
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsrCollectionListResponse].
         *
    ...
    /** A builder for [IsrCollectionListResponse]. */
    class Builder internal constructor() {
        ...
        private var collectionRequirements: JsonField<MutableList<CollectionRequirement>>? = null
        ...
        @JvmSynthetic
        internal fun from(isrCollectionListResponse: IsrCollectionListResponse) = apply {
            classificationMarking = isrCollectionListResponse.classificationMarking
            dataMode = isrCollectionListResponse.dataMode
            source = isrCollectionListResponse.source
            id = isrCollectionListResponse.id
            collectionRequirements =
                isrCollectionListResponse.collectionRequirements.map { it.toMutableList() }
            createdAt = isrCollectionListResponse.createdAt
            createdBy = isrCollectionListResponse.createdBy
            idexVersion = isrCollectionListResponse.idexVersion
            missionAor = isrCollectionListResponse.missionAor
            missionCollectionArea = isrCollectionListResponse.missionCollectionArea
            missionCountry = isrCollectionListResponse.missionCountry
            missionEmphasis = isrCollectionListResponse.missionEmphasis
            missionId = isrCollectionListResponse.missionId
            missionJoa = isrCollectionListResponse.missionJoa
            missionOperation = isrCollectionListResponse.missionOperation
            missionPrimaryIntelDiscipline = isrCollectionListResponse.missionPrimaryIntelDiscipline
            missionPrimarySubCategory = isrCollectionListResponse.missionPrimarySubCategory
            missionPriority = isrCollectionListResponse.missionPriority
            missionRegion = isrCollectionListResponse.missionRegion
            missionRole = isrCollectionListResponse.missionRole
            missionSecondaryIntelDiscipline =
                isrCollectionListResponse.missionSecondaryIntelDiscipline
            missionSecondarySubCategory = isrCollectionListResponse.missionSecondarySubCategory
            missionStartPointLat = isrCollectionListResponse.missionStartPointLat
            missionStartPointLong = isrCollectionListResponse.missionStartPointLong
            missionSubRegion = isrCollectionListResponse.missionSubRegion
            missionSupportedUnit = isrCollectionListResponse.missionSupportedUnit
            missionSyncMatrixBin = isrCollectionListResponse.missionSyncMatrixBin
            name = isrCollectionListResponse.name
            origin = isrCollectionListResponse.origin
            origNetwork = isrCollectionListResponse.origNetwork
            taskings = isrCollectionListResponse.taskings.map { it.toMutableList() }
            transit = isrCollectionListResponse.transit.map { it.toMutableList() }
            updatedAt = isrCollectionListResponse.updatedAt
            updatedBy = isrCollectionListResponse.updatedBy
            additionalProperties = isrCollectionListResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun collectionRequirements(collectionRequirements: JsonField<List<CollectionRequirement>>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [IsrCollectionListResponse].
         *
         ...
         */
        fun build(): IsrCollectionListResponse =
    ...
    fun validate(): IsrCollectionListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun criticalTimes(): Optional<CriticalTimes> = criticalTimes.getOptional("criticalTimes")
        ...
        @JsonProperty("exploitationRequirement")
        @ExcludeMissing
        fun _exploitationRequirement(): JsonField<ExploitationRequirement> = exploitationRequirement
         ...
         *
         * Unlike [intelDiscipline], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("intelDiscipline")
        @ExcludeMissing
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [CollectionRequirement].
             */
            @JvmStatic fun builder() = Builder()
        }
        ...
        private constructor(
             ...
             *
             * Unlike [dissemination], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("dissemination")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.dissemination] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.eei] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.poc] with a well-typed [Poc] value instead. This
                 * method is primarily for setting the field to an undocumented or not yet supported
                 * value.
                 */
                 ...
                 *
                 * You should usually call [Builder.reportingCriteria] with a well-typed [String]
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.chatSystem] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.radioFrequency] with a well-typed [Double]
    ...
    private constructor(
        ...
        private val taskingCollectionRequirements: JsonField<List<TaskingCollectionRequirement>>,
