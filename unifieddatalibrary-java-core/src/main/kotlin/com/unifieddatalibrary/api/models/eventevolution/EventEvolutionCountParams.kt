 ...
 */
class EventEvolutionCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EventEvolutionCountParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [EventEvolutionCountParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EventEvolutionCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventEvolutionCountParams: EventEvolutionCountParams) = apply {
            eventId = eventEvolutionCountParams.eventId
            firstResult = eventEvolutionCountParams.firstResult
            maxResults = eventEvolutionCountParams.maxResults
            startTime = eventEvolutionCountParams.startTime
            additionalHeaders = eventEvolutionCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = eventEvolutionCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EventEvolutionCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EventEvolutionCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EventEvolutionCountParams && eventId == other.eventId && firstResult == other.firstResult && maxResults == other.maxResults && startTime == other.startTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "EventEvolutionCountParams{eventId=$eventId, firstResult=$firstResult, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
