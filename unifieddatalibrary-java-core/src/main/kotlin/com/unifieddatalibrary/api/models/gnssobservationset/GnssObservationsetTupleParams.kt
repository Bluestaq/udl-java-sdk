 ...
 */
class GnssObservationsetTupleParams
private constructor(
    ...
    /** A builder for [GnssObservationsetTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gnssObservationsetTupleParams: GnssObservationsetTupleParams) = apply {
            columns = gnssObservationsetTupleParams.columns
            ts = gnssObservationsetTupleParams.ts
            firstResult = gnssObservationsetTupleParams.firstResult
            maxResults = gnssObservationsetTupleParams.maxResults
            additionalHeaders = gnssObservationsetTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = gnssObservationsetTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GnssObservationsetTupleParams].
         *
         ...
         */
        fun build(): GnssObservationsetTupleParams =
            GnssObservationsetTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is GnssObservationsetTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "GnssObservationsetTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
