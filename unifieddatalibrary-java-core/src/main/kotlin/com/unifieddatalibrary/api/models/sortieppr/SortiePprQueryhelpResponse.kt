...
class SortiePprQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SortiePprQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SortiePprQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprQueryhelpResponse: SortiePprQueryhelpResponse) =
            apply {
                aodrSupported = sortiePprQueryhelpResponse.aodrSupported
                classificationMarking = sortiePprQueryhelpResponse.classificationMarking
                description = sortiePprQueryhelpResponse.description
                historySupported = sortiePprQueryhelpResponse.historySupported
                name = sortiePprQueryhelpResponse.name
                parameters = sortiePprQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = sortiePprQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = sortiePprQueryhelpResponse.restSupported
                sortSupported = sortiePprQueryhelpResponse.sortSupported
                typeName = sortiePprQueryhelpResponse.typeName
                uri = sortiePprQueryhelpResponse.uri
                additionalProperties = sortiePprQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SortiePprQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SortiePprQueryhelpResponse =
    ...
    fun validate(): SortiePprQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SortiePprQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
