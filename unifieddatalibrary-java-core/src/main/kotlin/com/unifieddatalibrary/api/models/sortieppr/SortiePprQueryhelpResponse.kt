...
class SortiePprQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprQueryhelpResponse: SortiePprQueryhelpResponse) = apply {
    ...
    fun validate(): SortiePprQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
