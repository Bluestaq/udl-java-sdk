...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfEmitterDetailGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailGetParams: RfEmitterDetailGetParams) = apply {
    ...
    override fun toString() =
        "RfEmitterDetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
