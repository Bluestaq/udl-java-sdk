...
class RfEmitterDetailGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): RfEmitterDetailGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RfEmitterDetailGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfEmitterDetailGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailGetParams: RfEmitterDetailGetParams) =
            apply {
                id = rfEmitterDetailGetParams.id
                firstResult = rfEmitterDetailGetParams.firstResult
                maxResults = rfEmitterDetailGetParams.maxResults
                additionalHeaders = rfEmitterDetailGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfEmitterDetailGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfEmitterDetailGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfEmitterDetailGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfEmitterDetailGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfEmitterDetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
