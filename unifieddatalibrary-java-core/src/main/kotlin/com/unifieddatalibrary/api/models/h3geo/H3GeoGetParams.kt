...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): H3GeoGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [H3GeoGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [H3GeoGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoGetParams: H3GeoGetParams) = apply {
            id = h3GeoGetParams.id
            firstResult = h3GeoGetParams.firstResult
            maxResults = h3GeoGetParams.maxResults
            additionalHeaders = h3GeoGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = h3GeoGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [H3GeoGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): H3GeoGetParams =
            H3GeoGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is H3GeoGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "H3GeoGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
