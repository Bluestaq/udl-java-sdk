...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageTupleResponse: StageTupleResponse) = apply {
    ...
    fun validate(): StageTupleResponse = apply {
        if (validated) {
            return@apply
        }
