...
class StageTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StageTupleResponse].
         *
    ...
    /** A builder for [StageTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageTupleResponse: StageTupleResponse) =
            apply {
                classificationMarking = stageTupleResponse.classificationMarking
                dataMode = stageTupleResponse.dataMode
                idEngine = stageTupleResponse.idEngine
                idLaunchVehicle = stageTupleResponse.idLaunchVehicle
                source = stageTupleResponse.source
                id = stageTupleResponse.id
                avionicsNotes = stageTupleResponse.avionicsNotes
                burnTime = stageTupleResponse.burnTime
                controlThruster1 = stageTupleResponse.controlThruster1
                controlThruster2 = stageTupleResponse.controlThruster2
                createdAt = stageTupleResponse.createdAt
                createdBy = stageTupleResponse.createdBy
                diameter = stageTupleResponse.diameter
                engine = stageTupleResponse.engine
                length = stageTupleResponse.length
                mainEngineThrustSeaLevel = stageTupleResponse.mainEngineThrustSeaLevel
                mainEngineThrustVacuum = stageTupleResponse.mainEngineThrustVacuum
                manufacturerOrgId = stageTupleResponse.manufacturerOrgId
                mass = stageTupleResponse.mass
                notes = stageTupleResponse.notes
                numBurns = stageTupleResponse.numBurns
                numControlThruster1 = stageTupleResponse.numControlThruster1
                numControlThruster2 = stageTupleResponse.numControlThruster2
                numEngines = stageTupleResponse.numEngines
                numStageElements = stageTupleResponse.numStageElements
                numVernier = stageTupleResponse.numVernier
                origin = stageTupleResponse.origin
                origNetwork = stageTupleResponse.origNetwork
                photoUrls = stageTupleResponse.photoUrls.map { it.toMutableList() }
                restartable = stageTupleResponse.restartable
                reusable = stageTupleResponse.reusable
                stageNumber = stageTupleResponse.stageNumber
                tags = stageTupleResponse.tags.map { it.toMutableList() }
                thrustSeaLevel = stageTupleResponse.thrustSeaLevel
                thrustVacuum = stageTupleResponse.thrustVacuum
                type = stageTupleResponse.type
                updatedAt = stageTupleResponse.updatedAt
                updatedBy = stageTupleResponse.updatedBy
                vernier = stageTupleResponse.vernier
                vernierBurnTime = stageTupleResponse.vernierBurnTime
                vernierNumBurns = stageTupleResponse.vernierNumBurns
                vernierThrustSeaLevel = stageTupleResponse.vernierThrustSeaLevel
                vernierThrustVacuum = stageTupleResponse.vernierThrustVacuum
                additionalProperties = stageTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StageTupleResponse].
         *
    ...
    fun validate(): StageTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
