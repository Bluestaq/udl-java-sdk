...
class LogisticsSupportTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LogisticsSupportTupleParams].
         *
    ...
    /** A builder for [LogisticsSupportTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportTupleParams: LogisticsSupportTupleParams) =
            apply {
                columns = logisticsSupportTupleParams.columns
                firstResult = logisticsSupportTupleParams.firstResult
                maxResults = logisticsSupportTupleParams.maxResults
                additionalHeaders = logisticsSupportTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = logisticsSupportTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LogisticsSupportTupleParams].
         *
         ...
         */
        fun build(): LogisticsSupportTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LogisticsSupportTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "LogisticsSupportTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
