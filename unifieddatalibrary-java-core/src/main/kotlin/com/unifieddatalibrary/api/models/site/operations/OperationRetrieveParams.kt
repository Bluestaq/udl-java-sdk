...
class OperationRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OperationRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationRetrieveParams: OperationRetrieveParams) =
            apply {
    ...
    override fun toString() = "OperationRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
