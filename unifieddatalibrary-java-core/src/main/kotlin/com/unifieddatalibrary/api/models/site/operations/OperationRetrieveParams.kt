...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OperationRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OperationRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OperationRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationRetrieveParams: OperationRetrieveParams) = apply {
            id = operationRetrieveParams.id
            firstResult = operationRetrieveParams.firstResult
            maxResults = operationRetrieveParams.maxResults
            additionalHeaders = operationRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = operationRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OperationRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OperationRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OperationRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OperationRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
