...
class DatalinkQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatalinkQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DatalinkQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datalinkQueryhelpResponse: DatalinkQueryhelpResponse) = apply {
            aodrSupported = datalinkQueryhelpResponse.aodrSupported
            classificationMarking = datalinkQueryhelpResponse.classificationMarking
            description = datalinkQueryhelpResponse.description
            historySupported = datalinkQueryhelpResponse.historySupported
            name = datalinkQueryhelpResponse.name
            parameters = datalinkQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = datalinkQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = datalinkQueryhelpResponse.restSupported
            sortSupported = datalinkQueryhelpResponse.sortSupported
            typeName = datalinkQueryhelpResponse.typeName
            uri = datalinkQueryhelpResponse.uri
            additionalProperties = datalinkQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DatalinkQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DatalinkQueryhelpResponse =
    ...
    fun validate(): DatalinkQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DatalinkQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
