...
class RadarobservationUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RadarobservationUnvalidatedPublishParams].
         *
    ...
    /** A builder for [RadarobservationUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationUnvalidatedPublishParams: RadarobservationUnvalidatedPublishParams) =
            apply {
                body = radarobservationUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = radarobservationUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = radarobservationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RadarobservationUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): RadarobservationUnvalidatedPublishParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RadarobservationUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "RadarobservationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
