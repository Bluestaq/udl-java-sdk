...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ScientificListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificListParams: ScientificListParams) = apply {
    ...
    override fun toString() =
        "ScientificListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
