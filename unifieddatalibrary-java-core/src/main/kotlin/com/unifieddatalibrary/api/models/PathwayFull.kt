...
private constructor(
    ...
    /**
     * The datetime of the most recent change made to this Pathway data, in ISO 8601 UTC format with
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pathwayFull: PathwayFull) = apply {
         ...
         *
         * You should usually call [Builder.pwDefinition] with a well-typed [String] value instead.
         ...
         *
         * You should usually call [Builder.pwLastChangedDate] with a well-typed [OffsetDateTime]
         ...
         *
         * You should usually call [Builder.pwType] with a well-typed [String] value instead. This
         ...
         *
         * You should usually call [Builder.pwUsage] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    fun validate(): PathwayFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PathwayFull{pwDefinition=$pwDefinition, pwLastChangedBy=$pwLastChangedBy, pwLastChangedDate=$pwLastChangedDate, pwType=$pwType, pwUsage=$pwUsage, additionalProperties=$additionalProperties}"
}
