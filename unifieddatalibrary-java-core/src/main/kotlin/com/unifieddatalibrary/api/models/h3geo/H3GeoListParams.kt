...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [H3GeoListParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoListParams: H3GeoListParams) = apply {
            startTime = h3GeoListParams.startTime
            firstResult = h3GeoListParams.firstResult
            maxResults = h3GeoListParams.maxResults
            additionalHeaders = h3GeoListParams.additionalHeaders.toBuilder()
            additionalQueryParams = h3GeoListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [H3GeoListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is H3GeoListParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "H3GeoListParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
