...
private constructor(
     ...
     */
    fun alarms(): List<String> = body.alarms()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun alarmValues(): List<Double> = body.alarmValues()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun detectTime(): OffsetDateTime = body.detectTime()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun detectType(): String = body.detectType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun activity(): Optional<Double> = body.activity()
     ...
     *   if the server responded with an unexpected value).
     */
    fun bottleId(): Optional<String> = body.bottleId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun casRn(): Optional<String> = body.casRn()
     ...
     *   if the server responded with an unexpected value).
     */
    fun ctrnTime(): Optional<Double> = body.ctrnTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun density(): Optional<Double> = body.density()
     ...
     *   if the server responded with an unexpected value).
     */
    fun dep(): Optional<Double> = body.dep()
     ...
     *   if the server responded with an unexpected value).
     */
    fun depCtrn(): Optional<Double> = body.depCtrn()
     ...
     *   if the server responded with an unexpected value).
     */
    fun dose(): Optional<Double> = body.dose()
     ...
     *   if the server responded with an unexpected value).
     */
    fun doseRate(): Optional<Double> = body.doseRate()
     ...
     *   if the server responded with an unexpected value).
     */
    fun gBar(): Optional<Double> = body.gBar()
     ...
     *   if the server responded with an unexpected value).
     */
    fun harmful(): Optional<Boolean> = body.harmful()
     ...
     *   if the server responded with an unexpected value).
     */
    fun hBar(): Optional<Double> = body.hBar()
     ...
     *   if the server responded with an unexpected value).
     */
    fun idTrack(): Optional<String> = body.idTrack()
     ...
     *   if the server responded with an unexpected value).
     */
    fun massFrac(): Optional<Double> = body.massFrac()
     ...
     *   if the server responded with an unexpected value).
     */
    fun matCat(): Optional<Int> = body.matCat()
     ...
     *   if the server responded with an unexpected value).
     */
    fun matClass(): Optional<String> = body.matClass()
     ...
     *   if the server responded with an unexpected value).
     */
    fun matName(): Optional<String> = body.matName()
     ...
     *   if the server responded with an unexpected value).
     */
    fun matType(): Optional<String> = body.matType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun radCtrn(): Optional<Double> = body.radCtrn()
     ...
     *   if the server responded with an unexpected value).
     */
    fun readings(): Optional<List<String>> = body.readings()
     ...
     *   if the server responded with an unexpected value).
     */
    fun readingUnits(): Optional<List<String>> = body.readingUnits()
     ...
     *   if the server responded with an unexpected value).
     */
    fun readingValues(): Optional<List<Double>> = body.readingValues()
     ...
     */
    fun _alarms(): JsonField<List<String>> = body._alarms()
     ...
     */
    fun _alarmValues(): JsonField<List<Double>> = body._alarmValues()
     ...
     */
    fun _detectTime(): JsonField<OffsetDateTime> = body._detectTime()
     ...
     */
    fun _detectType(): JsonField<String> = body._detectType()
     ...
     */
    fun _activity(): JsonField<Double> = body._activity()
     ...
     */
    fun _bottleId(): JsonField<String> = body._bottleId()
     ...
     */
    fun _casRn(): JsonField<String> = body._casRn()
     ...
     */
    fun _ctrnTime(): JsonField<Double> = body._ctrnTime()
     ...
     */
    fun _density(): JsonField<Double> = body._density()
     ...
     */
    fun _dep(): JsonField<Double> = body._dep()
     ...
     */
    fun _depCtrn(): JsonField<Double> = body._depCtrn()
     ...
     */
    fun _dose(): JsonField<Double> = body._dose()
     ...
     */
    fun _doseRate(): JsonField<Double> = body._doseRate()
     ...
     */
    fun _gBar(): JsonField<Double> = body._gBar()
     ...
     */
    fun _harmful(): JsonField<Boolean> = body._harmful()
     ...
     */
    fun _hBar(): JsonField<Double> = body._hBar()
     ...
     */
    fun _idTrack(): JsonField<String> = body._idTrack()
     ...
     */
    fun _massFrac(): JsonField<Double> = body._massFrac()
     ...
     */
    fun _matCat(): JsonField<Int> = body._matCat()
     ...
     */
    fun _matClass(): JsonField<String> = body._matClass()
     ...
     */
    fun _matName(): JsonField<String> = body._matName()
     ...
     */
    fun _matType(): JsonField<String> = body._matType()
     ...
     */
    fun _ppm(): JsonField<Int> = body._ppm()
     ...
     */
    fun _radCtrn(): JsonField<Double> = body._radCtrn()
     ...
     */
    fun _readings(): JsonField<List<String>> = body._readings()
     ...
     */
    fun _readingUnits(): JsonField<List<String>> = body._readingUnits()
     ...
     */
    fun _readingValues(): JsonField<List<Double>> = body._readingValues()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HazardCreateParams].
         *
    ...
    /** A builder for [HazardCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardCreateParams: HazardCreateParams) = apply {
            body = hazardCreateParams.body.toBuilder()
            additionalHeaders = hazardCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = hazardCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * arrays must contain the same number of elements.
         */
        fun alarms(alarms: List<String>) = apply { body.alarms(alarms) }
         ...
         * value.
         */
        fun alarms(alarms: JsonField<List<String>>) = apply { body.alarms(alarms) }
         ...
         */
        fun addAlarm(alarm: String) = apply { body.addAlarm(alarm) }
         ...
         */
        fun alarmValues(alarmValues: List<Double>) = apply { body.alarmValues(alarmValues) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAlarmValue(alarmValue: Double) = apply { body.addAlarmValue(alarmValue) }
        ...
        /** The detect time, in ISO 8601 UTC format, with millisecond precision. */
        fun detectTime(detectTime: OffsetDateTime) = apply { body.detectTime(detectTime) }
         ...
         * this record.
         */
        fun detectType(detectType: String) = apply { body.detectType(detectType) }
         ...
         * value.
         */
        fun detectType(detectType: JsonField<String>) = apply { body.detectType(detectType) }
         ...
         */
        fun a(a: JsonField<Int>) = apply { body.a(a) }
         ...
         */
        fun activity(activity: Double) = apply { body.activity(activity) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun activity(activity: JsonField<Double>) = apply { body.activity(activity) }

        /** The specific bottle ID associated with this detection. */
        fun bottleId(bottleId: String) = apply { body.bottleId(bottleId) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun bottleId(bottleId: JsonField<String>) = apply { body.bottleId(bottleId) }
         ...
         */
        fun casRn(casRn: String) = apply { body.casRn(casRn) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun casRn(casRn: JsonField<String>) = apply { body.casRn(casRn) }
        ...
        /** The concentration time, in (kg/sec)/m^3, associated with this material detection. */
        fun ctrnTime(ctrnTime: Double) = apply { body.ctrnTime(ctrnTime) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun ctrnTime(ctrnTime: JsonField<Double>) = apply { body.ctrnTime(ctrnTime) }

        /** Measure of density of the material associated with this detection, in kg/m^3. */
        fun density(density: Double) = apply { body.density(density) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun density(density: JsonField<Double>) = apply { body.density(density) }

        /** The deposition measurement of the contaminant to surface area, in kg/m^2. */
        fun dep(dep: Double) = apply { body.dep(dep) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dep(dep: JsonField<Double>) = apply { body.dep(dep) }

        /** The deposition concentration of the contaminant to surface area, in becquerels/m^2. */
        fun depCtrn(depCtrn: Double) = apply { body.depCtrn(depCtrn) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun depCtrn(depCtrn: JsonField<Double>) = apply { body.depCtrn(depCtrn) }
         ...
         * of energy absorbed per kilogram of matter.
         */
        fun dose(dose: Double) = apply { body.dose(dose) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dose(dose: JsonField<Double>) = apply { body.dose(dose) }
         ...
         */
        fun doseRate(doseRate: Double) = apply { body.doseRate(doseRate) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun doseRate(doseRate: JsonField<Double>) = apply { body.doseRate(doseRate) }
         ...
         */
        fun gBar(gBar: Double) = apply { body.gBar(gBar) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun gBar(gBar: JsonField<Double>) = apply { body.gBar(gBar) }

        /** Flag indicating whether this detection is harmful to humans. */
        fun harmful(harmful: Boolean) = apply { body.harmful(harmful) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun hBar(hBar: JsonField<Double>) = apply { body.hBar(hBar) }
        ...
        /** ID of the Track record related to this hazard record. */
        fun idTrack(idTrack: String) = apply { body.idTrack(idTrack) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun idTrack(idTrack: JsonField<String>) = apply { body.idTrack(idTrack) }

        /** Ratio of the chemical substance mass to the total mass of the mixture. */
        fun massFrac(massFrac: Double) = apply { body.massFrac(massFrac) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun massFrac(massFrac: JsonField<Double>) = apply { body.massFrac(massFrac) }
         ...
         * devices and electron capture devices.
         */
        fun matCat(matCat: Int) = apply { body.matCat(matCat) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun matCat(matCat: JsonField<Int>) = apply { body.matCat(matCat) }
         ...
         */
        fun matClass(matClass: String) = apply { body.matClass(matClass) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun matClass(matClass: JsonField<String>) = apply { body.matClass(matClass) }

        /** The material common name associated with this detection. */
        fun matName(matName: String) = apply { body.matName(matName) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun matName(matName: JsonField<String>) = apply { body.matName(matName) }
         ...
         */
        fun matType(matType: String) = apply { body.matType(matType) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun matType(matType: JsonField<String>) = apply { body.matType(matType) }
         ...
         * million (units of contaminant mass per million parts of total mass).
         */
        fun ppm(ppm: Int) = apply { body.ppm(ppm) }
         ...
         */
        fun ppm(ppm: JsonField<Int>) = apply { body.ppm(ppm) }

        /**
         * Measure of radioactive concentration of the material associated with this detection, in
         * becquerels/m^3. One becquerel (Bq) is equal to one nuclear decay per second.
         */
        fun radCtrn(radCtrn: Double) = apply { body.radCtrn(radCtrn) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun radCtrn(radCtrn: JsonField<Double>) = apply { body.radCtrn(radCtrn) }
         ...
         */
        fun readings(readings: List<String>) = apply { body.readings(readings) }
         ...
         * supported value.
         */
        fun readings(readings: JsonField<List<String>>) = apply { body.readings(readings) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addReading(reading: String) = apply { body.addReading(reading) }

        /**
         * Array of the units that correspond to each of the readingValues. The readings,
         * readingUnits, and readingValues arrays must contain the same number of elements.
         */
        fun readingUnits(readingUnits: List<String>) = apply { body.readingUnits(readingUnits) }
        ...
        fun readingUnits(readingUnits: JsonField<List<String>>) = apply {
            body.readingUnits(readingUnits)
        }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addReadingUnit(readingUnit: String) = apply { body.addReadingUnit(readingUnit) }
         ...
         * elements.
         */
        fun readingValues(readingValues: List<Double>) = apply { body.readingValues(readingValues) }
        ...
        fun readingValues(readingValues: JsonField<List<Double>>) = apply {
            body.readingValues(readingValues)
        }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addReadingValue(readingValue: Double) = apply { body.addReadingValue(readingValue) }

        /** The Atomic Number of the material associated with this detection. */
        fun z(z: Int) = apply { body.z(z) }
         ...
         * primarily for setting the field to an undocumented or not yet supported value.
         */
        fun z(z: JsonField<Int>) = apply { body.z(z) }
        ...
        /**
         * Returns an immutable instance of [HazardCreateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is HazardCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "HazardCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
