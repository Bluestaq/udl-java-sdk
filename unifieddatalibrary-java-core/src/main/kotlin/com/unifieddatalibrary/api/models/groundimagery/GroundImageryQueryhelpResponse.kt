...
class GroundImageryQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [GroundImageryQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [GroundImageryQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryQueryhelpResponse: GroundImageryQueryhelpResponse) =
            apply {
                aodrSupported = groundImageryQueryhelpResponse.aodrSupported
                classificationMarking = groundImageryQueryhelpResponse.classificationMarking
                description = groundImageryQueryhelpResponse.description
                historySupported = groundImageryQueryhelpResponse.historySupported
                name = groundImageryQueryhelpResponse.name
                parameters = groundImageryQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = groundImageryQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = groundImageryQueryhelpResponse.restSupported
                sortSupported = groundImageryQueryhelpResponse.sortSupported
                typeName = groundImageryQueryhelpResponse.typeName
                uri = groundImageryQueryhelpResponse.uri
                additionalProperties = groundImageryQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [GroundImageryQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GroundImageryQueryhelpResponse =
    ...
    fun validate(): GroundImageryQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
