...
class GroundImageryQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryQueryhelpResponse: GroundImageryQueryhelpResponse) = apply {
            ...
            additionalProperties =
                groundImageryQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): GroundImageryQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
