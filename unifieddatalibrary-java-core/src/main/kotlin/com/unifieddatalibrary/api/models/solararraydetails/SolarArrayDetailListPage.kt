...
class SolarArrayDetailListPage
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayDetailListPage: SolarArrayDetailListPage) = apply {
            service = solarArrayDetailListPage.service
            params = solarArrayDetailListPage.params
            items = solarArrayDetailListPage.items
        }

        fun service(service: SolarArrayDetailService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SolarArrayDetailListPage &&
    ...
    override fun toString() =
        "SolarArrayDetailListPage{service=$service, params=$params, items=$items}"
}
