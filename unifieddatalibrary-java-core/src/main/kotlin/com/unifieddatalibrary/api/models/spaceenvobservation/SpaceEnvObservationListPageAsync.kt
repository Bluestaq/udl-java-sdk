...
class SpaceEnvObservationListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<SpaceEnvObservationListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        fun service(service: SpaceEnvObservationServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: SpaceEnvObservationListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<SpaceEnvObservationListResponse>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SpaceEnvObservationListPageAsync &&
    ...
    override fun toString() =
        "SpaceEnvObservationListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
