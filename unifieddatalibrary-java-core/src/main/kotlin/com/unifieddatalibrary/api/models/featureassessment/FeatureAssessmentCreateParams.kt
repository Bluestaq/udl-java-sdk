...
/**
 * Service operation to take a single FeatureAssessment record as a POST body and ingest into the
 * database. A specific role is required to perform this service operation. Please contact the UDL
 * team for assistance.
 */
class FeatureAssessmentCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun featureTs(): OffsetDateTime = body.featureTs()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun featureUoM(): String = body.featureUoM()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun idAnalyticImagery(): String = body.idAnalyticImagery()
     ...
     *   if the server responded with an unexpected value).
     */
    fun annLims(): Optional<List<List<Int>>> = body.annLims()
     ...
     *   if the server responded with an unexpected value).
     */
    fun annText(): Optional<List<String>> = body.annText()
     ...
     *   if the server responded with an unexpected value).
     */
    fun featureArray(): Optional<List<Double>> = body.featureArray()
     ...
     *   if the server responded with an unexpected value).
     */
    fun featureBool(): Optional<Boolean> = body.featureBool()
     ...
     *   if the server responded with an unexpected value).
     */
    fun featureString(): Optional<String> = body.featureString()
     ...
     *   if the server responded with an unexpected value).
     */
    fun featureStringArray(): Optional<List<String>> = body.featureStringArray()
     ...
     *   if the server responded with an unexpected value).
     */
    fun featureValue(): Optional<Double> = body.featureValue()
     ...
     *   if the server responded with an unexpected value).
     */
    fun heading(): Optional<Double> = body.heading()
     ...
     *   if the server responded with an unexpected value).
     */
    fun srcTs(): Optional<List<OffsetDateTime>> = body.srcTs()
     ...
     */
    fun _featureTs(): JsonField<OffsetDateTime> = body._featureTs()
     ...
     */
    fun _featureUoM(): JsonField<String> = body._featureUoM()
     ...
     * type.
     */
    fun _idAnalyticImagery(): JsonField<String> = body._idAnalyticImagery()
     ...
     */
    fun _annLims(): JsonField<List<List<Int>>> = body._annLims()
     ...
     */
    fun _annText(): JsonField<List<String>> = body._annText()
     ...
     */
    fun _featureArray(): JsonField<List<Double>> = body._featureArray()
     ...
     */
    fun _featureBool(): JsonField<Boolean> = body._featureBool()
     ...
     */
    fun _featureString(): JsonField<String> = body._featureString()
     ...
     * type.
     */
    fun _featureStringArray(): JsonField<List<String>> = body._featureStringArray()
     ...
     */
    fun _featureValue(): JsonField<Double> = body._featureValue()
     ...
     */
    fun _heading(): JsonField<Double> = body._heading()
     ...
     */
    fun _srcTs(): JsonField<List<OffsetDateTime>> = body._srcTs()
    ...
    /** A builder for [FeatureAssessmentCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentCreateParams: FeatureAssessmentCreateParams) = apply {
            body = featureAssessmentCreateParams.body.toBuilder()
            additionalHeaders = featureAssessmentCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = featureAssessmentCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * precision.
         */
        fun featureTs(featureTs: OffsetDateTime) = apply { body.featureTs(featureTs) }
         ...
         * supported value.
         */
        fun featureTs(featureTs: JsonField<OffsetDateTime>) = apply { body.featureTs(featureTs) }
         ...
         */
        fun featureUoM(featureUoM: String) = apply { body.featureUoM(featureUoM) }
         ...
         * value.
         */
        fun featureUoM(featureUoM: JsonField<String>) = apply { body.featureUoM(featureUoM) }

        /**
         * Unique identifier of the Analytic Imagery associated with this Feature Assessment record.
         */
        fun idAnalyticImagery(idAnalyticImagery: String) = apply {
            body.idAnalyticImagery(idAnalyticImagery)
        }
         ...
         */
        fun annLims(annLims: List<List<Int>>) = apply { body.annLims(annLims) }
         ...
         * supported value.
         */
        fun annLims(annLims: JsonField<List<List<Int>>>) = apply { body.annLims(annLims) }
         ...
         */
        fun addAnnLim(annLim: List<Int>) = apply { body.addAnnLim(annLim) }
         ...
         */
        fun annText(annText: List<String>) = apply { body.annText(annText) }
         ...
         * value.
         */
        fun annText(annText: JsonField<List<String>>) = apply { body.annText(annText) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAnnText(annText: String) = apply { body.addAnnText(annText) }
         ...
         */
        fun featureArray(featureArray: List<Double>) = apply { body.featureArray(featureArray) }
        ...
        fun featureArray(featureArray: JsonField<List<Double>>) = apply {
            body.featureArray(featureArray)
        }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFeatureArray(featureArray: Double) = apply { body.addFeatureArray(featureArray) }
         ...
         * numeric observation values (featureArray), or any combination of these.
         */
        fun featureBool(featureBool: Boolean) = apply { body.featureBool(featureBool) }
         ...
         * value.
         */
        fun featureBool(featureBool: JsonField<Boolean>) = apply { body.featureBool(featureBool) }
         ...
         * (featureArray), or any combination of these.
         */
        fun featureString(featureString: String) = apply { body.featureString(featureString) }
        ...
        fun featureString(featureString: JsonField<String>) = apply {
            body.featureString(featureString)
        }
         ...
         * of these.
         */
        fun featureStringArray(featureStringArray: List<String>) = apply {
            body.featureStringArray(featureStringArray)
        }
        ...
        fun addFeatureStringArray(featureStringArray: String) = apply {
            body.addFeatureStringArray(featureStringArray)
        }
         ...
         * (featureArray), or any combination of these.
         */
        fun featureValue(featureValue: Double) = apply { body.featureValue(featureValue) }
        ...
        fun featureValue(featureValue: JsonField<Double>) = apply {
            body.featureValue(featureValue)
        }

        /**
         * The feature object heading, in degrees clockwise from true North at the object location.
         */
        fun heading(heading: Double) = apply { body.heading(heading) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun heading(heading: JsonField<Double>) = apply { body.heading(heading) }

        /** Estimated physical height of the feature, in meters. */
        fun height(height: Double) = apply { body.height(height) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun height(height: JsonField<Double>) = apply { body.height(height) }
         ...
         */
        fun srcTs(srcTs: List<OffsetDateTime>) = apply { body.srcTs(srcTs) }
         ...
         * supported value.
         */
        fun srcTs(srcTs: JsonField<List<OffsetDateTime>>) = apply { body.srcTs(srcTs) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSrcT(srcT: OffsetDateTime) = apply { body.addSrcT(srcT) }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentCreateParams].
         *
         ...
         */
        fun build(): FeatureAssessmentCreateParams =
            FeatureAssessmentCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FeatureAssessmentCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "FeatureAssessmentCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
