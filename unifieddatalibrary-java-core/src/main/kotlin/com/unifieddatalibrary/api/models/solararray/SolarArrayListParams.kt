...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SolarArrayListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayListParams: SolarArrayListParams) = apply {
    ...
    override fun toString() =
        "SolarArrayListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
