...
class EquipmentRemarkQueryHelpResponse
private constructor(
    ...
    /** A builder for [EquipmentRemarkQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentRemarkQueryHelpResponse: EquipmentRemarkQueryHelpResponse) =
            apply {
                aodrSupported = equipmentRemarkQueryHelpResponse.aodrSupported
                classificationMarking = equipmentRemarkQueryHelpResponse.classificationMarking
                description = equipmentRemarkQueryHelpResponse.description
                historySupported = equipmentRemarkQueryHelpResponse.historySupported
                name = equipmentRemarkQueryHelpResponse.name
                parameters = equipmentRemarkQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    equipmentRemarkQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = equipmentRemarkQueryHelpResponse.restSupported
                sortSupported = equipmentRemarkQueryHelpResponse.sortSupported
                typeName = equipmentRemarkQueryHelpResponse.typeName
                uri = equipmentRemarkQueryHelpResponse.uri
                additionalProperties =
                    equipmentRemarkQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EquipmentRemarkQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EquipmentRemarkQueryHelpResponse =
            EquipmentRemarkQueryHelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): EquipmentRemarkQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
