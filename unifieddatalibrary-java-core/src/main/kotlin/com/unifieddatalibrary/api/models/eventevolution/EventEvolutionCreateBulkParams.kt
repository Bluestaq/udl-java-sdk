...
/**
 * Service operation intended for initial integration only, to take a list of EventEvolution records
 * as a POST body and ingest into the database. Requires specific roles, please contact the UDL team
 * to gain access. This operation is not intended to be used for automated feeds into UDL...data
 * providers should contact the UDL team for instructions on setting up a permanent feed through an
 * alternate mechanism.
 */
class EventEvolutionCreateBulkParams
private constructor(
    ...
    /** A builder for [EventEvolutionCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventEvolutionCreateBulkParams: EventEvolutionCreateBulkParams) = apply {
            body = eventEvolutionCreateBulkParams.body.toMutableList()
            additionalHeaders = eventEvolutionCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = eventEvolutionCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EventEvolutionCreateBulkParams].
         *
         ...
         */
        fun build(): EventEvolutionCreateBulkParams =
            EventEvolutionCreateBulkParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EventEvolutionCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "EventEvolutionCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
