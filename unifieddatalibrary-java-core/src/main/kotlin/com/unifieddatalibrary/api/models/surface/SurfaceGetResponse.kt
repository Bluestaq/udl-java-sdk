...
class SurfaceGetResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceGetResponse: SurfaceGetResponse) =
            apply {
    ...
    fun validate(): SurfaceGetResponse =
        apply {
            if (validated) {
              return@apply
            }
