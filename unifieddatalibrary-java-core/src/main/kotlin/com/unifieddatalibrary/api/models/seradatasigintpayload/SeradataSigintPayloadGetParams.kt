 ...
 * parameter.
 */
class SeradataSigintPayloadGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataSigintPayloadGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataSigintPayloadGetParams: SeradataSigintPayloadGetParams) = apply {
    ...
    override fun toString() =
        "SeradataSigintPayloadGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
