...
class SeradataSigintPayloadGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SeradataSigintPayloadGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SeradataSigintPayloadGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SeradataSigintPayloadGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataSigintPayloadGetParams: SeradataSigintPayloadGetParams) =
            apply {
                id = seradataSigintPayloadGetParams.id
                firstResult = seradataSigintPayloadGetParams.firstResult
                maxResults = seradataSigintPayloadGetParams.maxResults
                additionalHeaders = seradataSigintPayloadGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = seradataSigintPayloadGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataSigintPayloadGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataSigintPayloadGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataSigintPayloadGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SeradataSigintPayloadGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
