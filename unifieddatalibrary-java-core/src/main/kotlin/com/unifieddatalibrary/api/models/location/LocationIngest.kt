...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LocationIngest].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(locationIngest: LocationIngest) = apply {
            classificationMarking = locationIngest.classificationMarking
            dataMode = locationIngest.dataMode
            name = locationIngest.name
            source = locationIngest.source
            altitude = locationIngest.altitude
            countryCode = locationIngest.countryCode
            createdAt = locationIngest.createdAt
            createdBy = locationIngest.createdBy
            idLocation = locationIngest.idLocation
            lat = locationIngest.lat
            lon = locationIngest.lon
            origin = locationIngest.origin
            origNetwork = locationIngest.origNetwork
            additionalProperties = locationIngest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LocationIngest].
         *
    ...
    fun validate(): LocationIngest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "LocationIngest{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, altitude=$altitude, countryCode=$countryCode, createdAt=$createdAt, createdBy=$createdBy, idLocation=$idLocation, lat=$lat, lon=$lon, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
