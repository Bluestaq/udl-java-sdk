...
private constructor(
    ...
    private val items: List<TrackFull>,
) : PageAsync<TrackFull> {
    ...
    fun autoPager(): AutoPagerAsync<TrackFull> = AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<TrackFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<TrackFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<TrackFull>) = apply { this.items = items }
