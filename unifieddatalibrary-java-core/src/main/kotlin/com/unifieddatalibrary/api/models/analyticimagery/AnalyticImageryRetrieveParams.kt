...
class AnalyticImageryRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AnalyticImageryRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AnalyticImageryRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AnalyticImageryRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryRetrieveParams: AnalyticImageryRetrieveParams) =
            apply {
                id = analyticImageryRetrieveParams.id
                firstResult = analyticImageryRetrieveParams.firstResult
                maxResults = analyticImageryRetrieveParams.maxResults
                additionalHeaders = analyticImageryRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = analyticImageryRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticImageryRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AnalyticImageryRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AnalyticImageryRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AnalyticImageryRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
