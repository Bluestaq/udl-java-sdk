 ...
 * parameter. AnalyticImagery represents metadata about an image, as well as the actual binary image
 * data.
 */
class AnalyticImageryRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AnalyticImageryRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryRetrieveParams: AnalyticImageryRetrieveParams) = apply {
    ...
    override fun toString() =
        "AnalyticImageryRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
