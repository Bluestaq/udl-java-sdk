...
class SeradataSigintPayloadQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataSigintPayloadQueryhelpResponse: SeradataSigintPayloadQueryhelpResponse
        ) = apply {
            ...
            parameters =
                seradataSigintPayloadQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                seradataSigintPayloadQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                seradataSigintPayloadQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): SeradataSigintPayloadQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
