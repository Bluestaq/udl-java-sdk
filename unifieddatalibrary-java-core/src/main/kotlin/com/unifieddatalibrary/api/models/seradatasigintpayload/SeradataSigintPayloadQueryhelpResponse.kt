...
class SeradataSigintPayloadQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SeradataSigintPayloadQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SeradataSigintPayloadQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataSigintPayloadQueryhelpResponse: SeradataSigintPayloadQueryhelpResponse) =
            apply {
                aodrSupported = seradataSigintPayloadQueryhelpResponse.aodrSupported
                classificationMarking = seradataSigintPayloadQueryhelpResponse.classificationMarking
                description = seradataSigintPayloadQueryhelpResponse.description
                historySupported = seradataSigintPayloadQueryhelpResponse.historySupported
                name = seradataSigintPayloadQueryhelpResponse.name
                parameters = seradataSigintPayloadQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = seradataSigintPayloadQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = seradataSigintPayloadQueryhelpResponse.restSupported
                sortSupported = seradataSigintPayloadQueryhelpResponse.sortSupported
                typeName = seradataSigintPayloadQueryhelpResponse.typeName
                uri = seradataSigintPayloadQueryhelpResponse.uri
                additionalProperties = seradataSigintPayloadQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataSigintPayloadQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataSigintPayloadQueryhelpResponse =
    ...
    fun validate(): SeradataSigintPayloadQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataSigintPayloadQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
