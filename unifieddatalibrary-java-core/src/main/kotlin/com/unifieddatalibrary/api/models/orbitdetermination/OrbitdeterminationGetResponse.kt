...
class OrbitdeterminationGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbitdeterminationGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationGetResponse: OrbitdeterminationGetResponse) =
            apply {
    ...
    fun validate(): OrbitdeterminationGetResponse =
        apply {
            if (validated) {
              return@apply
            }
