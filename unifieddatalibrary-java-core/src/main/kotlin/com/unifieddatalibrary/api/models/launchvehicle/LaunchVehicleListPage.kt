...
class LaunchVehicleListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleListPage: LaunchVehicleListPage) =
            apply {
        ...
        fun service(service: LaunchVehicleService) =
            apply {
    ...
    override fun toString() = "LaunchVehicleListPage{service=$service, params=$params, items=$items}"
}
