...
class HistoryListPage private constructor(
    ...
    private val items: List<GeoStatusFull>,
    ...
    fun autoPager(): AutoPager<GeoStatusFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<GeoStatusFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<GeoStatusFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<GeoStatusFull>) =
            apply {
                this.items = items
            }
