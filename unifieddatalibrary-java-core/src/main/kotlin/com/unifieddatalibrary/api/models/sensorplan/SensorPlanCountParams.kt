...
class SensorPlanCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorPlanCountParams].
         *
    ...
    /** A builder for [SensorPlanCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanCountParams: SensorPlanCountParams) =
            apply {
                startTime = sensorPlanCountParams.startTime
                firstResult = sensorPlanCountParams.firstResult
                maxResults = sensorPlanCountParams.maxResults
                additionalHeaders = sensorPlanCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = sensorPlanCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SensorPlanCountParams].
         *
         ...
         */
        fun build(): SensorPlanCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorPlanCountParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SensorPlanCountParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
