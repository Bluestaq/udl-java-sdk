...
class OrbittrackListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbittrackListParams].
         *
    ...
    /** A builder for [OrbittrackListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackListParams: OrbittrackListParams) =
            apply {
                ts = orbittrackListParams.ts
                firstResult = orbittrackListParams.firstResult
                maxResults = orbittrackListParams.maxResults
                additionalHeaders = orbittrackListParams.additionalHeaders.toBuilder()
                additionalQueryParams = orbittrackListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OrbittrackListParams].
         *
         ...
         */
        fun build(): OrbittrackListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbittrackListParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OrbittrackListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
