...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SiteCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteCountParams: SiteCountParams) = apply {
    ...
    override fun toString() =
        "SiteCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
