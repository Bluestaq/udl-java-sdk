 ...
 */
class LaunchDetectionCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchDetectionCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchDetectionCountParams: LaunchDetectionCountParams) = apply {
    ...
    override fun toString() =
        "LaunchDetectionCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
