...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elsetAbridged: ElsetAbridged) = apply {
    ...
    fun validate(): ElsetAbridged = apply {
        if (validated) {
            return@apply
        }
