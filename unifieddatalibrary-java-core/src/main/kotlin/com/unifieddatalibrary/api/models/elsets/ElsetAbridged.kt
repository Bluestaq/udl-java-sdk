...
class ElsetAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ElsetAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elsetAbridged: ElsetAbridged) =
            apply {
                classificationMarking = elsetAbridged.classificationMarking
                dataMode = elsetAbridged.dataMode
                epoch = elsetAbridged.epoch
                source = elsetAbridged.source
                agom = elsetAbridged.agom
                algorithm = elsetAbridged.algorithm
                apogee = elsetAbridged.apogee
                argOfPerigee = elsetAbridged.argOfPerigee
                ballisticCoeff = elsetAbridged.ballisticCoeff
                bStar = elsetAbridged.bStar
                createdAt = elsetAbridged.createdAt
                createdBy = elsetAbridged.createdBy
                descriptor = elsetAbridged.descriptor
                eccentricity = elsetAbridged.eccentricity
                ephemType = elsetAbridged.ephemType
                idElset = elsetAbridged.idElset
                idOnOrbit = elsetAbridged.idOnOrbit
                idOrbitDetermination = elsetAbridged.idOrbitDetermination
                inclination = elsetAbridged.inclination
                line1 = elsetAbridged.line1
                line2 = elsetAbridged.line2
                meanAnomaly = elsetAbridged.meanAnomaly
                meanMotion = elsetAbridged.meanMotion
                meanMotionDDot = elsetAbridged.meanMotionDDot
                meanMotionDot = elsetAbridged.meanMotionDot
                origin = elsetAbridged.origin
                origNetwork = elsetAbridged.origNetwork
                origObjectId = elsetAbridged.origObjectId
                perigee = elsetAbridged.perigee
                period = elsetAbridged.period
                raan = elsetAbridged.raan
                revNo = elsetAbridged.revNo
                satNo = elsetAbridged.satNo
                semiMajorAxis = elsetAbridged.semiMajorAxis
                sourceDl = elsetAbridged.sourceDl
                transactionId = elsetAbridged.transactionId
                uct = elsetAbridged.uct
                additionalProperties = elsetAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ElsetAbridged].
         *
