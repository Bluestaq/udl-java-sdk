 ...
 */
class AircraftStatusListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AircraftStatusListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusListParams: AircraftStatusListParams) = apply {
    ...
    override fun toString() =
        "AircraftStatusListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
