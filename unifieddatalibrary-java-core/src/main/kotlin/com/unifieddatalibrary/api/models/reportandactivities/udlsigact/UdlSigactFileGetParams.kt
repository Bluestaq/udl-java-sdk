...
/**
 * Service operation to get a single SigAct text file by its unique ID passed as a path parameter.
 * The text file is returned as an attachment Content-Disposition.
 */
class UdlSigactFileGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UdlSigactFileGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(udlSigactFileGetParams: UdlSigactFileGetParams) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UdlSigactFileGetParams &&
            id == other.id &&
    ...
    override fun toString() =
        "UdlSigactFileGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
