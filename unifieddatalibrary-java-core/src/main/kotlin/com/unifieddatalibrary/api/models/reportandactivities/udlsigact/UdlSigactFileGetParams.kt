...
class UdlSigactFileGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): UdlSigactFileGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UdlSigactFileGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [UdlSigactFileGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(udlSigactFileGetParams: UdlSigactFileGetParams) =
            apply {
                id = udlSigactFileGetParams.id
                firstResult = udlSigactFileGetParams.firstResult
                maxResults = udlSigactFileGetParams.maxResults
                additionalHeaders = udlSigactFileGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = udlSigactFileGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [UdlSigactFileGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UdlSigactFileGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is UdlSigactFileGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "UdlSigactFileGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
