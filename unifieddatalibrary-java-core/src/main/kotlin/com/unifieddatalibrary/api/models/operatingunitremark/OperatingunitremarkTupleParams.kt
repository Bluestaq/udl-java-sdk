 ...
 */
class OperatingunitremarkTupleParams
private constructor(
    ...
    /** A builder for [OperatingunitremarkTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitremarkTupleParams: OperatingunitremarkTupleParams) = apply {
            columns = operatingunitremarkTupleParams.columns
            firstResult = operatingunitremarkTupleParams.firstResult
            maxResults = operatingunitremarkTupleParams.maxResults
            additionalHeaders = operatingunitremarkTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = operatingunitremarkTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OperatingunitremarkTupleParams].
         *
         ...
         */
        fun build(): OperatingunitremarkTupleParams =
            OperatingunitremarkTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OperatingunitremarkTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OperatingunitremarkTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
