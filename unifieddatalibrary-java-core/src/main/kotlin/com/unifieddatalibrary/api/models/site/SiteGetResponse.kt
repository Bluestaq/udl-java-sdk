...
/**
 * Properties and characteristics of a site entity, such as an airbase, airfield, naval station,
 * etc.
 */
...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        idParentSite: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        msnPrimarySpec: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        origSiteId: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        popAreaProx: JsonField<Double> = JsonMissing.of(),
        ...
        @ExcludeMissing
        siteOperations: JsonField<List<SiteOperation>> = JsonMissing.of(),
        @JsonProperty("siteRemarks")
        @ExcludeMissing
        siteRemarks: JsonField<List<SiteRemark>> = JsonMissing.of(),
     ...
     * in at any particular time. Typically refers to a unit, organization, or installation/site
     * performing a specific function or mission such as a redistribution center or naval shipyard.
     * The specific usage and enumerations contained in this field may be found in the documentation
     * provided in the referenceDoc field. If referenceDoc not provided, users may consult the data
     * provider.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     * site owes its allegiance. This field will be set to "OTHR" if the source value does not match
     * a UDL Country code value (ISO-3166-ALPHA-2).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The Basic Encyclopedia Number associated with the Site. Uniquely identifies the installation
     * of a site. The beNumber is generated based on the value input for the COORD to determine the
     * appropriate World Aeronautical Chart (WAC) location identifier, the system assigned record
     * originator and a one-up-number.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Indicates the importance of the entity to the OES or MIR system. This data element is
     * restricted to update by DIA (DB-4). Valid values are:
     *
    ...
    /**
     * The physical manner of being or state of existence of the entity. A physical condition that
     * must be considered in the determining of a course of action. The specific usage and
    ...
    /**
     * Availability of the entity relative to its condition. Indicates the reason the entity is not
     * fully operational. The specific usage and enumerations contained in this field may be found
     ...
     * that the analyst has assigned to the data within this record. The numerical range is from 1
     * to 9 with 1 representing the highest confidence level.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Principal operational function being performed. The specific usage and enumerations contained
    ...
    /**
     * Geographical region code used by the Requirements Management System (RMS) as specified by
     * National Geospatial Agency (NGA) in Flight Information Publications (FIPS) 10-4, Appendix 3 -
     * Country Code and Geographic Region Codes. The specific usage and enumerations contained in
    ...
    /**
     * Indicates the amount or degree of deviation from the horizontal represented as a percent.
     * Grade is determined by the formula: vertical distance (VD) divided by horizontal distance
     * (HD) times 100. VD is the difference between the highest and lowest elevation within the
     * entity. HD is the linear distance between the highest and lowest elevation.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Indicates the normal usage of the Landing Zone (LZ). Intended as, but not constrained to MIDB
     * Helocopter Landing Area usage value definitions:
     *
     * AF - Airfield
     *
     * FD - Field
     ...
     *
     * 12345678 (numerical location; easting is 1234 and northing is 5678, in this case specifying a
    ...
    /**
     * Indicates the principal type of mission that an entity is organized and equipped to perform.
     * The specific usage and enumerations contained in this field may be found in the documentation
     * provided in the referenceDoc field. If referenceDoc not provided, users may consult the data
     * provider.
     *
    ...
    /**
     * Indicates the principal specialty type of mission that an entity is organized and equipped to
     ...
     * which it was organized and equipped. The specific usage and enumerations contained in this
     * field may be found in the documentation provided in the referenceDoc field. If referenceDoc
    ...
    /**
     * The O-suffix associated with this site. The O-suffix is a five-character alpha/numeric system
     * used to identify a site, or demographic area, within an installation. The Installation Basic
     * Encyclopedia (beNumber), in conjunction with the O-suffix, uniquely identifies the Site. The
     * Installation beNumber and oSuffix are also used in conjunction with the catCode to classify
    ...
    /**
     * Indicates whether the facility is in or outside of a populated area. True, the facility is in
     * or within 5 NM of a populated area. False, the facility is outside a populated area.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     * elements in the record as defined by SOPs.
     *
     * A - Active
     *
     * I - Inactive
    ...
    /**
     * The reference documentation that specifies the usage and enumerations contained in this
     ...
     * accuracy and currency, in ISO8601 UTC format. This date cannot be greater than the current
     * date.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     *   if the server responded with an unexpected value).
     */
    fun siteOperations(): Optional<List<SiteOperation>> =
        siteOperations.getOptional("siteOperations")
     ...
     * graphics among information systems, as per MIL-STD 2525B, and supported by the element ident.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The predominant vegetation found in the Landing Zone (LZ). The specific usage and
     * enumerations contained in this field may be found in the documentation provided in the
     * referenceDoc field. If referenceDoc not provided, users may consult the data provider.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     ...
     */
    @JsonProperty("catCode") @ExcludeMissing fun _catCode(): JsonField<String> = catCode
     ...
     */
    @JsonProperty("catText") @ExcludeMissing fun _catText(): JsonField<String> = catText
     ...
     */
    @JsonProperty("geoArea") @ExcludeMissing fun _geoArea(): JsonField<String> = geoArea
     ...
     */
    @JsonProperty("grade") @ExcludeMissing fun _grade(): JsonField<Int> = grade
     ...
     */
    @JsonProperty("lzUsage") @ExcludeMissing fun _lzUsage(): JsonField<String> = lzUsage
     ...
     */
    @JsonProperty("nucCap") @ExcludeMissing fun _nucCap(): JsonField<String> = nucCap
     ...
     */
    @JsonProperty("origLzId") @ExcludeMissing fun _origLzId(): JsonField<String> = origLzId
     ...
     */
    @JsonProperty("origSiteID") @ExcludeMissing fun _origSiteId(): JsonField<String> = origSiteId
     ...
     */
    @JsonProperty("popArea") @ExcludeMissing fun _popArea(): JsonField<Boolean> = popArea
     ...
     */
    @JsonProperty("popAreaProx") @ExcludeMissing fun _popAreaProx(): JsonField<Double> = popAreaProx
     ...
     */
    @JsonProperty("runways") @ExcludeMissing fun _runways(): JsonField<Long> = runways
     ...
     */
    @JsonProperty("vegHt") @ExcludeMissing fun _vegHt(): JsonField<Double> = vegHt
     ...
     */
    @JsonProperty("vegType") @ExcludeMissing fun _vegType(): JsonField<String> = vegType
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiteGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteGetResponse: SiteGetResponse) = apply {
            classificationMarking = siteGetResponse.classificationMarking
            dataMode = siteGetResponse.dataMode
            name = siteGetResponse.name
            source = siteGetResponse.source
            id = siteGetResponse.id
            activity = siteGetResponse.activity
            airDefArea = siteGetResponse.airDefArea
            allegiance = siteGetResponse.allegiance
            altAllegiance = siteGetResponse.altAllegiance
            beNumber = siteGetResponse.beNumber
            catCode = siteGetResponse.catCode
            catText = siteGetResponse.catText
            classRating = siteGetResponse.classRating
            condition = siteGetResponse.condition
            conditionAvail = siteGetResponse.conditionAvail
            coord = siteGetResponse.coord
            coordDatum = siteGetResponse.coordDatum
            coordDerivAcc = siteGetResponse.coordDerivAcc
            createdAt = siteGetResponse.createdAt
            createdBy = siteGetResponse.createdBy
            elevMsl = siteGetResponse.elevMsl
            elevMslConfLvl = siteGetResponse.elevMslConfLvl
            elevMslDerivAcc = siteGetResponse.elevMslDerivAcc
            entity = siteGetResponse.entity
            eval = siteGetResponse.eval
            faa = siteGetResponse.faa
            fpa = siteGetResponse.fpa
            functPrimary = siteGetResponse.functPrimary
            geoArea = siteGetResponse.geoArea
            geoidalMslSep = siteGetResponse.geoidalMslSep
            grade = siteGetResponse.grade
            iata = siteGetResponse.iata
            icao = siteGetResponse.icao
            ident = siteGetResponse.ident
            idEntity = siteGetResponse.idEntity
            idParentSite = siteGetResponse.idParentSite
            lzUsage = siteGetResponse.lzUsage
            maxRunwayLength = siteGetResponse.maxRunwayLength
            milGrid = siteGetResponse.milGrid
            milGridSys = siteGetResponse.milGridSys
            msnPrimary = siteGetResponse.msnPrimary
            msnPrimarySpec = siteGetResponse.msnPrimarySpec
            notes = siteGetResponse.notes
            nucCap = siteGetResponse.nucCap
            operStatus = siteGetResponse.operStatus
            origin = siteGetResponse.origin
            origLzId = siteGetResponse.origLzId
            origNetwork = siteGetResponse.origNetwork
            origSiteId = siteGetResponse.origSiteId
            osuffix = siteGetResponse.osuffix
            pin = siteGetResponse.pin
            polSubdiv = siteGetResponse.polSubdiv
            popArea = siteGetResponse.popArea
            popAreaProx = siteGetResponse.popAreaProx
            recStatus = siteGetResponse.recStatus
            referenceDoc = siteGetResponse.referenceDoc
            resProd = siteGetResponse.resProd
            reviewDate = siteGetResponse.reviewDate
            runways = siteGetResponse.runways
            siteOperations = siteGetResponse.siteOperations.map { it.toMutableList() }
            siteRemarks = siteGetResponse.siteRemarks.map { it.toMutableList() }
            symCode = siteGetResponse.symCode
            type = siteGetResponse.type
            updatedAt = siteGetResponse.updatedAt
            updatedBy = siteGetResponse.updatedBy
            usage = siteGetResponse.usage
            utm = siteGetResponse.utm
            vegHt = siteGetResponse.vegHt
            vegType = siteGetResponse.vegType
            wac = siteGetResponse.wac
            additionalProperties = siteGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Indicates the function or mission of an entity, which that entity may or may not be
         * engaged in at any particular time. Typically refers to a unit, organization, or
         * installation/site performing a specific function or mission such as a redistribution
        ...
        /**
         * The DoD Standard Country Code designator for the country or political entity to which the
         * site owes its allegiance. This field will be set to "OTHR" if the source value does not
         ...
         * installation of a site. The beNumber is generated based on the value input for the COORD
         * to determine the appropriate World Aeronautical Chart (WAC) location identifier, the
         * system assigned record originator and a one-up-number.
         */
         ...
         *
         * You should usually call [Builder.catCode] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun catCode(catCode: JsonField<String>) = apply { this.catCode = catCode }
         ...
         *
         * You should usually call [Builder.catText] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun catText(catText: JsonField<String>) = apply { this.catText = catText }
         ...
         * Level (MSL) vertical datum, in meters.
         */
         ...
         *
         * You should usually call [Builder.functPrimary] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Geographical region code used by the Requirements Management System (RMS) as specified by
         * National Geospatial Agency (NGA) in Flight Information Publications (FIPS) 10-4, Appendix
         * 3 - Country Code and Geographic Region Codes. The specific usage and enumerations
         * contained in this field may be found in the documentation provided in the referenceDoc
         * field. If referenceDoc not provided, users may consult the data provider.
         */
         ...
         *
         * You should usually call [Builder.geoArea] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun geoArea(geoArea: JsonField<String>) = apply { this.geoArea = geoArea }
         ...
         *
         * You should usually call [Builder.grade] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun grade(grade: JsonField<Int>) = apply { this.grade = grade }
         ...
         *
         * You should usually call [Builder.idParentSite] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun idParentSite(idParentSite: JsonField<String>) = apply {
            this.idParentSite = idParentSite
        }

        /**
         * Indicates the normal usage of the Landing Zone (LZ). Intended as, but not constrained to
         * MIDB Helocopter Landing Area usage value definitions:
         *
         * AF - Airfield
         *
         * FD - Field
         ...
         *
         * You should usually call [Builder.lzUsage] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun lzUsage(lzUsage: JsonField<String>) = apply { this.lzUsage = lzUsage }
        ...
        /**
         * Indicates the principal type of mission that an entity is organized and equipped to
         * perform. The specific usage and enumerations contained in this field may be found in the
         * documentation provided in the referenceDoc field. If referenceDoc not provided, users may
         * consult the data provider.
         */
        ...
        /**
         * Indicates the principal specialty type of mission that an entity is organized and
         ...
         *
         * You should usually call [Builder.msnPrimarySpec] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun msnPrimarySpec(msnPrimarySpec: JsonField<String>) = apply {
         ...
         *
         * You should usually call [Builder.nucCap] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun nucCap(nucCap: JsonField<String>) = apply { this.nucCap = nucCap }
         ...
         *
         * You should usually call [Builder.origLzId] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun origLzId(origLzId: JsonField<String>) = apply { this.origLzId = origLzId }
         ...
         *
         * You should usually call [Builder.origSiteId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun origSiteId(origSiteId: JsonField<String>) = apply { this.origSiteId = origSiteId }

        /**
         * The O-suffix associated with this site. The O-suffix is a five-character alpha/numeric
         * system used to identify a site, or demographic area, within an installation. The
         * Installation Basic Encyclopedia (beNumber), in conjunction with the O-suffix, uniquely
         * identifies the Site. The Installation beNumber and oSuffix are also used in conjunction
         * with the catCode to classify the function or purpose of the facility.
         */
        ...
        /**
         * Indicates whether the facility is in or outside of a populated area. True, the facility
         * is in or within 5 NM of a populated area. False, the facility is outside a populated
         * area.
         */
         ...
         *
         * You should usually call [Builder.popArea] with a well-typed [Boolean] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun popArea(popArea: JsonField<Boolean>) = apply { this.popArea = popArea }
         ...
         *
         * You should usually call [Builder.popAreaProx] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun popAreaProx(popAreaProx: JsonField<Double>) = apply { this.popAreaProx = popAreaProx }
        ...
        /**
         * Date on which the data in the record was last reviewed by the responsible analyst for
         * accuracy and currency, in ISO8601 UTC format. This date cannot be greater than the
         * current date.
         */
         ...
         *
         * You should usually call [Builder.runways] with a well-typed [Long] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun runways(runways: JsonField<Long>) = apply { this.runways = runways }

        fun siteOperations(siteOperations: List<SiteOperation>) =
            siteOperations(JsonField.of(siteOperations))

        /**
         * Sets [Builder.siteOperations] to an arbitrary JSON value.
         *
         * You should usually call [Builder.siteOperations] with a well-typed `List<SiteOperation>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun siteOperations(siteOperations: JsonField<List<SiteOperation>>) = apply {
         ...
         */
        fun addSiteOperation(siteOperation: SiteOperation) = apply {
            siteOperations =
                (siteOperations ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.siteRemarks] with a well-typed `List<SiteRemark>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun siteRemarks(siteRemarks: JsonField<List<SiteRemark>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSiteRemark(siteRemark: SiteRemark) = apply {
            siteRemarks =
                (siteRemarks ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.usage] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.vegHt] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun vegHt(vegHt: JsonField<Double>) = apply { this.vegHt = vegHt }
         ...
         *
         * You should usually call [Builder.vegType] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun vegType(vegType: JsonField<String>) = apply { this.vegType = vegType }
        ...
        /**
         * Returns an immutable instance of [SiteGetResponse].
         *
    ...
    fun validate(): SiteGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (classificationMarking.asKnown().isPresent) 1 else 0) +
            ...
            (if (catCode.asKnown().isPresent) 1 else 0) +
            (if (catText.asKnown().isPresent) 1 else 0) +
            ...
            (if (geoArea.asKnown().isPresent) 1 else 0) +
            (if (geoidalMslSep.asKnown().isPresent) 1 else 0) +
            (if (grade.asKnown().isPresent) 1 else 0) +
            ...
            (if (idParentSite.asKnown().isPresent) 1 else 0) +
            (if (lzUsage.asKnown().isPresent) 1 else 0) +
            ...
            (if (msnPrimarySpec.asKnown().isPresent) 1 else 0) +
            (if (notes.asKnown().isPresent) 1 else 0) +
            (if (nucCap.asKnown().isPresent) 1 else 0) +
            (if (operStatus.asKnown().isPresent) 1 else 0) +
            (if (origin.asKnown().isPresent) 1 else 0) +
            (if (origLzId.asKnown().isPresent) 1 else 0) +
            (if (origNetwork.asKnown().isPresent) 1 else 0) +
            (if (origSiteId.asKnown().isPresent) 1 else 0) +
            (if (osuffix.asKnown().isPresent) 1 else 0) +
            (if (pin.asKnown().isPresent) 1 else 0) +
            (if (polSubdiv.asKnown().isPresent) 1 else 0) +
            (if (popArea.asKnown().isPresent) 1 else 0) +
            (if (popAreaProx.asKnown().isPresent) 1 else 0) +
            ...
            (siteOperations.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (siteRemarks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            ...
            (if (vegHt.asKnown().isPresent) 1 else 0) +
            (if (vegType.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
        ...
        @JsonProperty("operationalDeviations")
        @ExcludeMissing
        fun _operationalDeviations(): JsonField<List<OperationalDeviationFull>> =
            operationalDeviations
        ...
        class Builder internal constructor() {
            ...
            private var operationalDeviations: JsonField<MutableList<OperationalDeviationFull>>? =
                null
            private var operationalPlannings: JsonField<MutableList<OperationalPlanningFull>>? =
                null
            private var origin: JsonField<String> = JsonMissing.of()
            private var origNetwork: JsonField<String> = JsonMissing.of()
            ...
            @JvmSynthetic
            internal fun from(siteOperation: SiteOperation) = apply {
                ...
                operationalDeviations =
                    siteOperation.operationalDeviations.map { it.toMutableList() }
             ...
             * `List<DailyOperationFull>` value instead. This method is primarily for setting the
             ...
             * `List<MaximumOnGroundFull>` value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
             ...
             * `List<OperationalDeviationFull>` value instead. This method is primarily for setting
             ...
             * `List<OperationalPlanningFull>` value instead. This method is primarily for setting
             * the field to an undocumented or not yet supported value.
             */
            fun operationalPlannings(
                operationalPlannings: JsonField<List<OperationalPlanningFull>>
            ) = apply {
             ...
             *
             * You should usually call [Builder.pathways] with a well-typed `List<PathwayFull>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
        ...
        fun validate(): SiteOperation = apply {
            if (validated) {
                return@apply
            }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(siteRemark: SiteRemark) = apply {
        ...
        override fun toString() =
            "SiteRemark{classificationMarking=$classificationMarking, dataMode=$dataMode, idSite=$idSite, source=$source, text=$text, id=$id, code=$code, createdAt=$createdAt, createdBy=$createdBy, name=$name, origin=$origin, origNetwork=$origNetwork, origRmkId=$origRmkId, type=$type, additionalProperties=$additionalProperties}"
    }
