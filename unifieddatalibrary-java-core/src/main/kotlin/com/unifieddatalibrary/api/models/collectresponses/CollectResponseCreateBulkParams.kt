 ...
 * objects as a POST body and ingest into the database. This operation is not intended to be used
 ...
 */
class CollectResponseCreateBulkParams
private constructor(
    ...
    /** A builder for [CollectResponseCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectResponseCreateBulkParams: CollectResponseCreateBulkParams) =
            apply {
                body = collectResponseCreateBulkParams.body.toMutableList()
                additionalHeaders = collectResponseCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    collectResponseCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CollectResponseCreateBulkParams].
         *
         ...
         */
        fun build(): CollectResponseCreateBulkParams =
            CollectResponseCreateBulkParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CollectResponseCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CollectResponseCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
