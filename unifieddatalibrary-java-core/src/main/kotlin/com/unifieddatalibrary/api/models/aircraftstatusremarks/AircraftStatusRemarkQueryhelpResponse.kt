...
class AircraftStatusRemarkQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            aircraftStatusRemarkQueryhelpResponse: AircraftStatusRemarkQueryhelpResponse
        ) = apply {
            ...
            requiredRoles =
                aircraftStatusRemarkQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                aircraftStatusRemarkQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): AircraftStatusRemarkQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
