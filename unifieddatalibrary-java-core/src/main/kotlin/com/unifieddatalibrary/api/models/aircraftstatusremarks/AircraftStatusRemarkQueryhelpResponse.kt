...
class AircraftStatusRemarkQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AircraftStatusRemarkQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AircraftStatusRemarkQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusRemarkQueryhelpResponse: AircraftStatusRemarkQueryhelpResponse) =
            apply {
                aodrSupported = aircraftStatusRemarkQueryhelpResponse.aodrSupported
                classificationMarking = aircraftStatusRemarkQueryhelpResponse.classificationMarking
                description = aircraftStatusRemarkQueryhelpResponse.description
                historySupported = aircraftStatusRemarkQueryhelpResponse.historySupported
                name = aircraftStatusRemarkQueryhelpResponse.name
                parameters = aircraftStatusRemarkQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = aircraftStatusRemarkQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = aircraftStatusRemarkQueryhelpResponse.restSupported
                sortSupported = aircraftStatusRemarkQueryhelpResponse.sortSupported
                typeName = aircraftStatusRemarkQueryhelpResponse.typeName
                uri = aircraftStatusRemarkQueryhelpResponse.uri
                additionalProperties = aircraftStatusRemarkQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftStatusRemarkQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AircraftStatusRemarkQueryhelpResponse =
    ...
    fun validate(): AircraftStatusRemarkQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftStatusRemarkQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
