...
class MissionAssignmentQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MissionAssignmentQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [MissionAssignmentQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentQueryhelpResponse: MissionAssignmentQueryhelpResponse) =
            apply {
                aodrSupported = missionAssignmentQueryhelpResponse.aodrSupported
                classificationMarking = missionAssignmentQueryhelpResponse.classificationMarking
                description = missionAssignmentQueryhelpResponse.description
                historySupported = missionAssignmentQueryhelpResponse.historySupported
                name = missionAssignmentQueryhelpResponse.name
                parameters = missionAssignmentQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = missionAssignmentQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = missionAssignmentQueryhelpResponse.restSupported
                sortSupported = missionAssignmentQueryhelpResponse.sortSupported
                typeName = missionAssignmentQueryhelpResponse.typeName
                uri = missionAssignmentQueryhelpResponse.uri
                additionalProperties = missionAssignmentQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MissionAssignmentQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MissionAssignmentQueryhelpResponse =
    ...
    fun validate(): MissionAssignmentQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MissionAssignmentQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
