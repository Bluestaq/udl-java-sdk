...
class MissionAssignmentQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(missionAssignmentQueryhelpResponse: MissionAssignmentQueryhelpResponse) =
            apply {
                ...
                parameters =
                    missionAssignmentQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    missionAssignmentQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    missionAssignmentQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): MissionAssignmentQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
