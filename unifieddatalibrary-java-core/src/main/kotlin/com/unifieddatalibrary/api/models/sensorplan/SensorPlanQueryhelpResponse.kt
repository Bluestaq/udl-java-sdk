...
class SensorPlanQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanQueryhelpResponse: SensorPlanQueryhelpResponse) = apply {
    ...
    fun validate(): SensorPlanQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
