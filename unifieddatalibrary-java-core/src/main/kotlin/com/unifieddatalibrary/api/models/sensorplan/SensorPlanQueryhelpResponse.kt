...
class SensorPlanQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SensorPlanQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorPlanQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanQueryhelpResponse: SensorPlanQueryhelpResponse) =
            apply {
                aodrSupported = sensorPlanQueryhelpResponse.aodrSupported
                classificationMarking = sensorPlanQueryhelpResponse.classificationMarking
                description = sensorPlanQueryhelpResponse.description
                historySupported = sensorPlanQueryhelpResponse.historySupported
                name = sensorPlanQueryhelpResponse.name
                parameters = sensorPlanQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = sensorPlanQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = sensorPlanQueryhelpResponse.restSupported
                sortSupported = sensorPlanQueryhelpResponse.sortSupported
                typeName = sensorPlanQueryhelpResponse.typeName
                uri = sensorPlanQueryhelpResponse.uri
                additionalProperties = sensorPlanQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorPlanQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorPlanQueryhelpResponse =
    ...
    fun validate(): SensorPlanQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorPlanQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
