...
class ItemGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemGetResponse: ItemGetResponse) =
            apply {
                classificationMarking = itemGetResponse.classificationMarking
                dataMode = itemGetResponse.dataMode
                scanCode = itemGetResponse.scanCode
                source = itemGetResponse.source
                type = itemGetResponse.type
                id = itemGetResponse.id
                accSysKeys = itemGetResponse.accSysKeys.map { it.toMutableList() }
                accSysNotes = itemGetResponse.accSysNotes
                accSystem = itemGetResponse.accSystem
                accSysValues = itemGetResponse.accSysValues.map { it.toMutableList() }
                airdrop = itemGetResponse.airdrop
                altDataFormat = itemGetResponse.altDataFormat
                cargoType = itemGetResponse.cargoType
                centerlineOffset = itemGetResponse.centerlineOffset
                cg = itemGetResponse.cg
                commodityCode = itemGetResponse.commodityCode
                commoditySys = itemGetResponse.commoditySys
                container = itemGetResponse.container
                createdAt = itemGetResponse.createdAt
                createdBy = itemGetResponse.createdBy
                departure = itemGetResponse.departure
                destination = itemGetResponse.destination
                dvCode = itemGetResponse.dvCode
                fs = itemGetResponse.fs
                hazCodes = itemGetResponse.hazCodes.map { it.toMutableList() }
                height = itemGetResponse.height
                idAirLoadPlan = itemGetResponse.idAirLoadPlan
                itemContains = itemGetResponse.itemContains.map { it.toMutableList() }
                keys = itemGetResponse.keys.map { it.toMutableList() }
                lastArrDate = itemGetResponse.lastArrDate
                length = itemGetResponse.length
                moment = itemGetResponse.moment
                name = itemGetResponse.name
                netExpWt = itemGetResponse.netExpWt
                notes = itemGetResponse.notes
                numPalletPos = itemGetResponse.numPalletPos
                origin = itemGetResponse.origin
                origNetwork = itemGetResponse.origNetwork
                productCode = itemGetResponse.productCode
                productSys = itemGetResponse.productSys
                receivingBranch = itemGetResponse.receivingBranch
                receivingUnit = itemGetResponse.receivingUnit
                scGenTool = itemGetResponse.scGenTool
                sourceDl = itemGetResponse.sourceDl
                tcn = itemGetResponse.tcn
                uln = itemGetResponse.uln
                updatedAt = itemGetResponse.updatedAt
                updatedBy = itemGetResponse.updatedBy
                values = itemGetResponse.values.map { it.toMutableList() }
                volume = itemGetResponse.volume
                weight = itemGetResponse.weight
                weightTs = itemGetResponse.weightTs
                width = itemGetResponse.width
                additionalProperties = itemGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ItemGetResponse].
         *
