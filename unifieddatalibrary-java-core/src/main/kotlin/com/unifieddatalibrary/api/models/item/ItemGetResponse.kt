...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemGetResponse: ItemGetResponse) = apply {
    ...
    fun validate(): ItemGetResponse = apply {
        if (validated) {
            return@apply
        }
