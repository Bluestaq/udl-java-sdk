...
private constructor(
    ...
    fun autoPager(): AutoPagerAsync<CrewAbridged> = AutoPagerAsync.from(this, streamHandlerExecutor)
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crewListPageAsync: CrewListPageAsync) = apply {
        ...
        fun service(service: CrewServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: CrewListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<CrewAbridged>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CrewListPageAsync &&
    ...
    override fun toString() =
        "CrewListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
