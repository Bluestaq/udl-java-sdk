 ...
 * parameter.
 */
class SeradataOpticalPayloadGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataOpticalPayloadGetParams = builder().build()
        ...
        internal fun from(seradataOpticalPayloadGetParams: SeradataOpticalPayloadGetParams) =
            apply {
                ...
                additionalQueryParams =
                    seradataOpticalPayloadGetParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "SeradataOpticalPayloadGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
