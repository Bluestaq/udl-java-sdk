...
class NavigationalObstructionQueryhelpResponse
private constructor(
    ...
    /** A builder for [NavigationalObstructionQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            navigationalObstructionQueryhelpResponse: NavigationalObstructionQueryhelpResponse
        ) = apply {
            aodrSupported = navigationalObstructionQueryhelpResponse.aodrSupported
            classificationMarking = navigationalObstructionQueryhelpResponse.classificationMarking
            description = navigationalObstructionQueryhelpResponse.description
            historySupported = navigationalObstructionQueryhelpResponse.historySupported
            name = navigationalObstructionQueryhelpResponse.name
            parameters =
                navigationalObstructionQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                navigationalObstructionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = navigationalObstructionQueryhelpResponse.restSupported
            sortSupported = navigationalObstructionQueryhelpResponse.sortSupported
            typeName = navigationalObstructionQueryhelpResponse.typeName
            uri = navigationalObstructionQueryhelpResponse.uri
            additionalProperties =
                navigationalObstructionQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NavigationalObstructionQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NavigationalObstructionQueryhelpResponse =
            NavigationalObstructionQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): NavigationalObstructionQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
