...
class EngineRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EngineRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineRetrieveParams: EngineRetrieveParams) =
            apply {
    ...
    override fun toString() = "EngineRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
