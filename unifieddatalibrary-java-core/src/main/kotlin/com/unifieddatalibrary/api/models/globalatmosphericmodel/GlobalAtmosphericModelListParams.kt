 ...
 */
class GlobalAtmosphericModelListParams
private constructor(
    ...
    /** A builder for [GlobalAtmosphericModelListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalAtmosphericModelListParams: GlobalAtmosphericModelListParams) =
            apply {
                ts = globalAtmosphericModelListParams.ts
                firstResult = globalAtmosphericModelListParams.firstResult
                maxResults = globalAtmosphericModelListParams.maxResults
                additionalHeaders = globalAtmosphericModelListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    globalAtmosphericModelListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GlobalAtmosphericModelListParams].
         *
         ...
         */
        fun build(): GlobalAtmosphericModelListParams =
            GlobalAtmosphericModelListParams(
                checkRequired("ts", ts),
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GlobalAtmosphericModelListParams &&
            ts == other.ts &&
    ...
    override fun toString() =
        "GlobalAtmosphericModelListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
