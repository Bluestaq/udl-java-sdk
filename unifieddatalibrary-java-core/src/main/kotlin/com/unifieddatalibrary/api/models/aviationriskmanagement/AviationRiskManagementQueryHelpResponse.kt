...
class AviationRiskManagementQueryHelpResponse
private constructor(
    ...
    /** A builder for [AviationRiskManagementQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            aviationRiskManagementQueryHelpResponse: AviationRiskManagementQueryHelpResponse
        ) = apply {
            aodrSupported = aviationRiskManagementQueryHelpResponse.aodrSupported
            classificationMarking = aviationRiskManagementQueryHelpResponse.classificationMarking
            description = aviationRiskManagementQueryHelpResponse.description
            historySupported = aviationRiskManagementQueryHelpResponse.historySupported
            name = aviationRiskManagementQueryHelpResponse.name
            parameters =
                aviationRiskManagementQueryHelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                aviationRiskManagementQueryHelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = aviationRiskManagementQueryHelpResponse.restSupported
            sortSupported = aviationRiskManagementQueryHelpResponse.sortSupported
            typeName = aviationRiskManagementQueryHelpResponse.typeName
            uri = aviationRiskManagementQueryHelpResponse.uri
            additionalProperties =
                aviationRiskManagementQueryHelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AviationRiskManagementQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AviationRiskManagementQueryHelpResponse =
            AviationRiskManagementQueryHelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): AviationRiskManagementQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AviationRiskManagementQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
