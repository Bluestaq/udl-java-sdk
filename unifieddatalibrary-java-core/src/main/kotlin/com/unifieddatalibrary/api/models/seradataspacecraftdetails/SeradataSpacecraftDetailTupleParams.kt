 ...
 */
class SeradataSpacecraftDetailTupleParams
private constructor(
    ...
    /** A builder for [SeradataSpacecraftDetailTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataSpacecraftDetailTupleParams: SeradataSpacecraftDetailTupleParams
        ) = apply {
            columns = seradataSpacecraftDetailTupleParams.columns
            firstResult = seradataSpacecraftDetailTupleParams.firstResult
            maxResults = seradataSpacecraftDetailTupleParams.maxResults
            additionalHeaders = seradataSpacecraftDetailTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                seradataSpacecraftDetailTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SeradataSpacecraftDetailTupleParams].
         *
         ...
         */
        fun build(): SeradataSpacecraftDetailTupleParams =
            SeradataSpacecraftDetailTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeradataSpacecraftDetailTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeradataSpacecraftDetailTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
