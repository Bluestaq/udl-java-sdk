...
class OnorbitlistGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OnorbitlistGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OnorbitlistGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OnorbitlistGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistGetParams: OnorbitlistGetParams) =
            apply {
                id = onorbitlistGetParams.id
                firstResult = onorbitlistGetParams.firstResult
                maxResults = onorbitlistGetParams.maxResults
                additionalHeaders = onorbitlistGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitlistGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitlistGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitlistGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitlistGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnorbitlistGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
