...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitlistGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistGetParams: OnorbitlistGetParams) = apply {
    ...
    override fun toString() =
        "OnorbitlistGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
