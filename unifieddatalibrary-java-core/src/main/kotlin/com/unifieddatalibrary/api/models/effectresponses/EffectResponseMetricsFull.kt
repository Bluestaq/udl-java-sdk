...
private constructor(
    ...
    /**
     * The type of the metric (e.g. CollateralDamage, GoalAchievement, OpportunityCost, Timeliness,
     * Unavailable, etc.).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     */
    @JsonProperty("domainValue") @ExcludeMissing fun _domainValue(): JsonField<Double> = domainValue
     ...
     */
    @JsonProperty("metricType") @ExcludeMissing fun _metricType(): JsonField<String> = metricType
     ...
     */
    @JsonProperty("provenance") @ExcludeMissing fun _provenance(): JsonField<String> = provenance
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseMetricsFull: EffectResponseMetricsFull) = apply {
         ...
         *
         * You should usually call [Builder.domainValue] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun domainValue(domainValue: JsonField<Double>) = apply { this.domainValue = domainValue }
         ...
         *
         * You should usually call [Builder.metricType] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.provenance] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.relativeValue] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
    ...
    fun validate(): EffectResponseMetricsFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "EffectResponseMetricsFull{domainValue=$domainValue, metricType=$metricType, provenance=$provenance, relativeValue=$relativeValue, additionalProperties=$additionalProperties}"
}
