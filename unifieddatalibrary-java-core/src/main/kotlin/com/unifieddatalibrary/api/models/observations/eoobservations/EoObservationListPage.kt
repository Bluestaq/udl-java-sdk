...
class EoObservationListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationListPage: EoObservationListPage) =
            apply {
        ...
        fun service(service: EoObservationService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EoObservationListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, params, items) /* spotless:on */

    override fun toString() = "EoObservationListPage{service=$service, params=$params, items=$items}"
}
