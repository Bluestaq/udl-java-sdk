...
class OnboardnavigationListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnboardnavigationListParams].
         *
    ...
    /** A builder for [OnboardnavigationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationListParams: OnboardnavigationListParams) =
            apply {
                startTime = onboardnavigationListParams.startTime
                firstResult = onboardnavigationListParams.firstResult
                maxResults = onboardnavigationListParams.maxResults
                additionalHeaders = onboardnavigationListParams.additionalHeaders.toBuilder()
                additionalQueryParams = onboardnavigationListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnboardnavigationListParams].
         *
         ...
         */
        fun build(): OnboardnavigationListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnboardnavigationListParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnboardnavigationListParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
