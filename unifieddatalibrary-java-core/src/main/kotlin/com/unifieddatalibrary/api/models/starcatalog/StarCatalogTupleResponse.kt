...
class StarCatalogTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogTupleResponse: StarCatalogTupleResponse) =
            apply {
    ...
    fun validate(): StarCatalogTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
