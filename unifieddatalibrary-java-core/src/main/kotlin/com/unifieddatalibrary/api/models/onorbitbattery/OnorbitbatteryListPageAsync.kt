...
class OnorbitbatteryListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<OnorbitbatteryListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitbatteryListPageAsync: OnorbitbatteryListPageAsync) =
            apply {
        ...
        fun service(service: OnorbitbatteryServiceAsync) =
            apply {
    ...
    override fun toString() = "OnorbitbatteryListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
