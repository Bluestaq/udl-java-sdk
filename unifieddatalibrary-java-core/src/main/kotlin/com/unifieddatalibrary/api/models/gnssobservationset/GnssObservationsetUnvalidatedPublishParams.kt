...
/**
 * Service operation to accept one or more GNSSObservationSet(s) and associated GNSS Observation(s)
 * as a POST body and ingest into the database. This operation is intended to be used for automated
 * feeds into UDL. A specific role is required to perform this service operation. Please contact the
 * UDL team for assistance.
 */
class GnssObservationsetUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [GnssObservationsetUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            gnssObservationsetUnvalidatedPublishParams: GnssObservationsetUnvalidatedPublishParams
        ) = apply {
            body = gnssObservationsetUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                gnssObservationsetUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                gnssObservationsetUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GnssObservationsetUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): GnssObservationsetUnvalidatedPublishParams =
            GnssObservationsetUnvalidatedPublishParams(
    ...
    private constructor(
        ...
        @ExcludeMissing
        fun _boresight(): JsonField<List<Double>> = boresight
         ...
         *
         * Unlike [gnssObservationList], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("gnssObservationList")
        @ExcludeMissing
        ...
        @ExcludeMissing
        fun _markerType(): JsonField<String> = markerType
        ...
        @ExcludeMissing
        fun _obsCodes(): JsonField<List<String>> = obsCodes
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                ts = body.ts
                id = body.id
                agcState = body.agcState
                alt = body.alt
                boresight = body.boresight.map { it.toMutableList() }
                createdAt = body.createdAt
                createdBy = body.createdBy
                esId = body.esId
                eventId = body.eventId
                gDop = body.gDop
                gnssObservationList = body.gnssObservationList.map { it.toMutableList() }
                hDop = body.hDop
                idOnOrbit = body.idOnOrbit
                lat = body.lat
                lon = body.lon
                markerType = body.markerType
                navigationStatus = body.navigationStatus
                obsCodes = body.obsCodes.map { it.toMutableList() }
                origin = body.origin
                origNetwork = body.origNetwork
                origObjectId = body.origObjectId
                outage = body.outage
                pDop = body.pDop
                quat = body.quat.map { it.toMutableList() }
                receiver = body.receiver
                satNo = body.satNo
                satPosition = body.satPosition.map { it.toMutableList() }
                satVelocity = body.satVelocity.map { it.toMutableList() }
            ...
            /**
             * Unique identifier of the parent Ephemeris Set, if this data is correlated with an
             * Ephemeris. If reporting for a spacecraft with multiple onboard GNSS receivers, this
             * ID may be associated with multiple GNSS Observation records if each receiver is
             * synced to the ephemeris points.
             */
            ...
            /**
             * Optional source-provided identifier for this collection event. This field can be used
             * to associate records related to the same event.
             */
             ...
             * `List<GnssObservationList>` value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            fun gnssObservationList(gnssObservationList: JsonField<List<GnssObservationList>>) =
                apply {
            ...
            /**
             * WGS-84 spacecraft latitude sub-point at observation time (ts), represented as -90 to
            ...
            /**
             * WGS-84 spacecraft longitude sub-point at observation time (ts), represented as -180
             ...
             * The marker type of the observing receiver (AIRBORNE, ANIMAL, BALLISTIC, FIXED BUOY,
             * FLOATING BUOY, FLOATING ICE, GEODETIC, GLACIER, GROUNDCRAFT, HUMAN, NON GEODETIC, NON
             * PHYSICAL, SPACEBORNE, WATERCRAFT). Reference RINEX 3+ for further information
             * concerning marker types.
             */
             ...
             *
             * You should usually call [Builder.markerType] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * navigation status specifies whether the signal is normal, degraded, or unavailable.
             * For status value definitions please reach out to data source provider.
             */
             ...
             * representation of the measurement type, the channel, and the coding, in compliance
             * with the RINEX 3+ standard (Pseudorange (C), Carrier Phase (L), Doppler (D), Signal
             * Strength C/No (S), or Channel Number (X)). See the GNSS Observation ob field for the
             * units of measure associated with each observation type.
             */
            ...
            /**
             * The quaternion describing the rotation of the body-fixed frame used for this system
             ...
             * receivers a separate set should be generated for each. A null value is assumed to
             * indicate that only one receiver is present, or reported.
             */
             ...
             *
             * You should usually call [Builder.receiver] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * km/second, at observation time (ts). The array element order is [xvel, yvel, zvel].
             */
            ...
            /**
             * Array of UUIDs of the UDL data records that are related to this GNSS Observation Set.
             ...
             * to this GNSS Observation Set. See the associated 'srcIds' array for the record UUIDs,
        ...
        /**
         * Information for Global Navigation Satellite Systems (GNSS) Observations collected from
         * GNSS receivers, including the specific GNSS sat from which each signal was received, and
         * the observation codes of each observation in the record. Each GNSS Observation is
         * associated with a GNSS Observation Set record containing data which applies to all
         * observations in the set, including observation time, receiver location, and Dilution of
         * Precision (DOP) values. Users can Reference RINEX 3+ documentation for further
        ...
        private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("agcState")
                @ExcludeMissing
                agcState: JsonField<Int> = JsonMissing.of(),
             ...
             * Returns the raw JSON value of [agcState].
             *
             * Unlike [agcState], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("agcState") @ExcludeMissing fun _agcState(): JsonField<Int> = agcState
             ...
             *
             * Unlike [gnssSatId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("gnssSatId")
            @ExcludeMissing
            fun _gnssSatId(): JsonField<String> = gnssSatId
             ...
             *
             * Unlike [obsCodeSet], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("obsCodeSet")
            @ExcludeMissing
             ...
             * Returns the raw JSON value of [trackingStatus].
             *
             * Unlike [trackingStatus], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("trackingStatus")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.gnssSatId] with a well-typed [String] value
                 ...
                 *
                 * You should usually call [Builder.ob] with a well-typed `List<Double>` value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun ob(ob: JsonField<List<Double>>) = apply {
                    this.ob = ob.map { it.toMutableList() }
                }
                ...
                fun addOb(ob: Double) = apply {
                    this.ob =
                        (this.ob ?: JsonField.of(mutableListOf())).also {
                            checkKnown("ob", it).add(ob)
                        }
                }

                /**
                 * The observation code set that applies to this observation record. Reference RINEX
                 * 3+ for further information concerning observation code set conventions.
                 */
                 ...
                 *
                 * You should usually call [Builder.obsCodeSet] with a well-typed `List<String>`
                 ...
                 * best).
                 */
                fun trackingStatus(trackingStatus: Int) =
                    trackingStatus(JsonField.of(trackingStatus))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is GnssObservationsetUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "GnssObservationsetUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
