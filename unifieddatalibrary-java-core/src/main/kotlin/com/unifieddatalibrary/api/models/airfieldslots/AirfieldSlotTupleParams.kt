...
class AirfieldSlotTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirfieldSlotTupleParams].
         *
    ...
    /** A builder for [AirfieldSlotTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotTupleParams: AirfieldSlotTupleParams) =
            apply {
                columns = airfieldSlotTupleParams.columns
                firstResult = airfieldSlotTupleParams.firstResult
                maxResults = airfieldSlotTupleParams.maxResults
                additionalHeaders = airfieldSlotTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = airfieldSlotTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldSlotTupleParams].
         *
         ...
         */
        fun build(): AirfieldSlotTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirfieldSlotTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirfieldSlotTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
