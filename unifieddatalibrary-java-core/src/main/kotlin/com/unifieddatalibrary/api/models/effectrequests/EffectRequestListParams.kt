...
class EffectRequestListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectRequestListParams].
         *
    ...
    /** A builder for [EffectRequestListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestListParams: EffectRequestListParams) =
            apply {
                createdAt = effectRequestListParams.createdAt
                firstResult = effectRequestListParams.firstResult
                maxResults = effectRequestListParams.maxResults
                additionalHeaders = effectRequestListParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectRequestListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestListParams].
         *
         ...
         */
        fun build(): EffectRequestListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectRequestListParams && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EffectRequestListParams{createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
