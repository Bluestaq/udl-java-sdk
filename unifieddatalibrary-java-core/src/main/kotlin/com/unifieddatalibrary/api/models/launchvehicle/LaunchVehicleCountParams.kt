 ...
 */
class LaunchVehicleCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchVehicleCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleCountParams: LaunchVehicleCountParams) = apply {
    ...
    override fun toString() =
        "LaunchVehicleCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
