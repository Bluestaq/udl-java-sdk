...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackListResponse: OrbittrackListResponse) = apply {
    ...
    fun validate(): OrbittrackListResponse = apply {
        if (validated) {
            return@apply
        }
