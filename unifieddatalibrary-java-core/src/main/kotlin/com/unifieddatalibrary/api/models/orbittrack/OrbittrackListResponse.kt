...
class OrbittrackListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("amplification") @ExcludeMissing amplification: JsonField<String> = JsonMissing.of(),
        @JsonProperty("angElev") @ExcludeMissing angElev: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("aouData") @ExcludeMissing aouData: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("charlieLine") @ExcludeMissing charlieLine: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("trackSensors") @ExcludeMissing trackSensors: JsonField<List<TrackSensor>> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _aouData(): JsonField<List<Double>> = aouData
     ...
     */
    @JsonProperty("aouType")
    @ExcludeMissing
    fun _aouType(): JsonField<String> = aouType
    ...
    @ExcludeMissing
    fun _charlieLine(): JsonField<String> = charlieLine
    ...
    @JsonProperty("chXRef")
    @ExcludeMissing
    fun _chXRef(): JsonField<String> = chXRef
     ...
     */
    @JsonProperty("cntnmnt")
    @ExcludeMissing
    fun _cntnmnt(): JsonField<Double> = cntnmnt
    ...
    @JsonProperty("decay")
    @ExcludeMissing
    fun _decay(): JsonField<Double> = decay
    ...
    @JsonProperty("rdfRF")
    @ExcludeMissing
    fun _rdfRf(): JsonField<Double> = rdfRf
    ...
    @JsonProperty("rptNum")
    @ExcludeMissing
    fun _rptNum(): JsonField<String> = rptNum
    ...
    @ExcludeMissing
    fun _satStatus(): JsonField<String> = satStatus
    ...
    @ExcludeMissing
    fun _vehType(): JsonField<String> = vehType
    ...
    @JsonProperty("xref")
    @ExcludeMissing
    fun _xref(): JsonField<String> = xref
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbittrackListResponse].
         *
    ...
    /** A builder for [OrbittrackListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackListResponse: OrbittrackListResponse) =
            apply {
                classificationMarking = orbittrackListResponse.classificationMarking
                dataMode = orbittrackListResponse.dataMode
                lat = orbittrackListResponse.lat
                lon = orbittrackListResponse.lon
                source = orbittrackListResponse.source
                ts = orbittrackListResponse.ts
                id = orbittrackListResponse.id
                alt = orbittrackListResponse.alt
                amplification = orbittrackListResponse.amplification
                angElev = orbittrackListResponse.angElev
                aouData = orbittrackListResponse.aouData.map { it.toMutableList() }
                aouType = orbittrackListResponse.aouType
                callSign = orbittrackListResponse.callSign
                charlieLine = orbittrackListResponse.charlieLine
                chXRef = orbittrackListResponse.chXRef
                cntnmnt = orbittrackListResponse.cntnmnt
                countryCode = orbittrackListResponse.countryCode
                createdAt = orbittrackListResponse.createdAt
                createdBy = orbittrackListResponse.createdBy
                decay = orbittrackListResponse.decay
                dummy = orbittrackListResponse.dummy
                feint = orbittrackListResponse.feint
                hq = orbittrackListResponse.hq
                idElset = orbittrackListResponse.idElset
                identAmp = orbittrackListResponse.identAmp
                idOnOrbit = orbittrackListResponse.idOnOrbit
                iff = orbittrackListResponse.iff
                installation = orbittrackListResponse.installation
                objectType = orbittrackListResponse.objectType
                objIdent = orbittrackListResponse.objIdent
                origin = orbittrackListResponse.origin
                origNetwork = orbittrackListResponse.origNetwork
                origObjectId = orbittrackListResponse.origObjectId
                rdfRf = orbittrackListResponse.rdfRf
                reduced = orbittrackListResponse.reduced
                reinforced = orbittrackListResponse.reinforced
                rptNum = orbittrackListResponse.rptNum
                satNo = orbittrackListResponse.satNo
                satStatus = orbittrackListResponse.satStatus
                spd = orbittrackListResponse.spd
                taskForce = orbittrackListResponse.taskForce
                trackSensors = orbittrackListResponse.trackSensors.map { it.toMutableList() }
                trkId = orbittrackListResponse.trkId
                vehType = orbittrackListResponse.vehType
                xref = orbittrackListResponse.xref
                additionalProperties = orbittrackListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.amplification] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun amplification(amplification: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.aouData] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun aouData(aouData: JsonField<List<Double>>) =
            apply {
         ...
         */
        fun addAouData(aouData: Double) =
            apply {
                this.aouData = (this.aouData ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.aouType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun aouType(aouType: JsonField<String>) =
            apply {
                this.aouType = aouType
            }
         ...
         *
         * You should usually call [Builder.charlieLine] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun charlieLine(charlieLine: JsonField<String>) =
            apply {
                this.charlieLine = charlieLine
            }
         ...
         *
         * You should usually call [Builder.chXRef] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun chXRef(chXRef: JsonField<String>) =
            apply {
                this.chXRef = chXRef
            }
         ...
         *
         * You should usually call [Builder.cntnmnt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cntnmnt(cntnmnt: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.decay] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun decay(decay: JsonField<Double>) =
            apply {
                this.decay = decay
            }
         ...
         *
         * You should usually call [Builder.rdfRf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rdfRf(rdfRf: JsonField<Double>) =
            apply {
                this.rdfRf = rdfRf
            }
         ...
         *
         * You should usually call [Builder.rptNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rptNum(rptNum: JsonField<String>) =
            apply {
                this.rptNum = rptNum
            }
         ...
         *
         * You should usually call [Builder.satStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun satStatus(satStatus: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.trackSensors] with a well-typed `List<TrackSensor>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trackSensors(trackSensors: JsonField<List<TrackSensor>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTrackSensor(trackSensor: TrackSensor) =
            apply {
                trackSensors = (trackSensors ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.vehType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vehType(vehType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.xref] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun xref(xref: JsonField<String>) =
            apply {
                this.xref = xref
            }
        ...
        /**
         * Returns an immutable instance of [OrbittrackListResponse].
         *
         ...
         */
        fun build(): OrbittrackListResponse =
    ...
    fun validate(): OrbittrackListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (ts.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (alt.asKnown().isPresent) 1 else 0) + (if (amplification.asKnown().isPresent) 1 else 0) + (if (angElev.asKnown().isPresent) 1 else 0) + (aouData.asKnown().getOrNull()?.size ?: 0) + (if (aouType.asKnown().isPresent) 1 else 0) + (if (callSign.asKnown().isPresent) 1 else 0) + (if (charlieLine.asKnown().isPresent) 1 else 0) + (if (chXRef.asKnown().isPresent) 1 else 0) + (if (cntnmnt.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (decay.asKnown().isPresent) 1 else 0) + (if (dummy.asKnown().isPresent) 1 else 0) + (if (feint.asKnown().isPresent) 1 else 0) + (if (hq.asKnown().isPresent) 1 else 0) + (if (idElset.asKnown().isPresent) 1 else 0) + (if (identAmp.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (iff.asKnown().isPresent) 1 else 0) + (if (installation.asKnown().isPresent) 1 else 0) + (objectType.asKnown().getOrNull()?.validity() ?: 0) + (objIdent.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (rdfRf.asKnown().isPresent) 1 else 0) + (if (reduced.asKnown().isPresent) 1 else 0) + (if (reinforced.asKnown().isPresent) 1 else 0) + (if (rptNum.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (satStatus.asKnown().isPresent) 1 else 0) + (if (spd.asKnown().isPresent) 1 else 0) + (if (taskForce.asKnown().isPresent) 1 else 0) + (trackSensors.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (trkId.asKnown().isPresent) 1 else 0) + (if (vehType.asKnown().isPresent) 1 else 0) + (if (xref.asKnown().isPresent) 1 else 0)
    ...
    class TrackSensor private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("minRangeLimit") @ExcludeMissing minRangeLimit: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("missionNumber") @ExcludeMissing missionNumber: JsonField<String> = JsonMissing.of(),
            @JsonProperty("sensorFOVType") @ExcludeMissing sensorFovType: JsonField<SensorFovType> = JsonMissing.of(),
            @JsonProperty("sensorName") @ExcludeMissing sensorName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("sensorNumber") @ExcludeMissing sensorNumber: JsonField<Int> = JsonMissing.of()
        ) : this(
          az,
          range,
          minRangeLimit,
         ...
         *
         * Unlike [minRangeLimit], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [sensorFovType], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(trackSensor: TrackSensor) =
                apply {
                    az = trackSensor.az
             ...
             *
             * You should usually call [Builder.minRangeLimit] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun minRangeLimit(minRangeLimit: JsonField<Double>) =
                apply {
            ...
            /** The field of view (FOV) type (Butterfly, Cone Angular, Cone Distance, Horizon to Horizon, Unknown) employed by the sensor observing this object. */
            fun sensorFovType(sensorFovType: SensorFovType) = sensorFovType(JsonField.of(sensorFovType))

            /**
             * Sets [Builder.sensorFovType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.sensorFovType] with a well-typed [SensorFovType] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun sensorFovType(sensorFovType: JsonField<SensorFovType>) =
                apply {
             ...
             *
             * You should usually call [Builder.sensorName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun sensorName(sensorName: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.sensorNumber] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun sensorNumber(sensorNumber: JsonField<Int>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (az.asKnown().isPresent) 1 else 0) + (if (range.asKnown().isPresent) 1 else 0) + (if (minRangeLimit.asKnown().isPresent) 1 else 0) + (if (missionNumber.asKnown().isPresent) 1 else 0) + (sensorFovType.asKnown().getOrNull()?.validity() ?: 0) + (if (sensorName.asKnown().isPresent) 1 else 0) + (if (sensorNumber.asKnown().isPresent) 1 else 0)

        /** The field of view (FOV) type (Butterfly, Cone Angular, Cone Distance, Horizon to Horizon, Unknown) employed by the sensor observing this object. */
        class SensorFovType @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            enum class Value {
                ...
                HORIZON_TO_HORIZON,
                UNKNOWN,
                /** An enum member indicating that [SensorFovType] was instantiated with an unknown value. */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    UNKNOWN -> Known.UNKNOWN
                    else -> throw UnifieddatalibraryInvalidDataException("Unknown SensorFovType: $value")
                }
        ...
        override fun toString() = "TrackSensor{az=$az, range=$range, minRangeLimit=$minRangeLimit, missionNumber=$missionNumber, sensorFovType=$sensorFovType, sensorName=$sensorName, sensorNumber=$sensorNumber, additionalProperties=$additionalProperties}"
    }
