...
/**
 * Service operation intended for initial integration only, to take a list of EMIReport records as a
 ...
 */
class EmireportCreateBulkParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmireportCreateBulkParams].
         *
    ...
    /** A builder for [EmireportCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportCreateBulkParams: EmireportCreateBulkParams) = apply {
            body = emireportCreateBulkParams.body.toMutableList()
            additionalHeaders = emireportCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = emireportCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EmireportCreateBulkParams].
         *
         ...
         */
        fun build(): EmireportCreateBulkParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportCreateBulkParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EmireportCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
