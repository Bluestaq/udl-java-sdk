...
class ConjunctionRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ConjunctionRetrieveParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ConjunctionRetrieveParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConjunctionRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conjunctionRetrieveParams: ConjunctionRetrieveParams) = apply {
            id = conjunctionRetrieveParams.id
            firstResult = conjunctionRetrieveParams.firstResult
            maxResults = conjunctionRetrieveParams.maxResults
            additionalHeaders = conjunctionRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = conjunctionRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ConjunctionRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConjunctionRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConjunctionRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ConjunctionRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
