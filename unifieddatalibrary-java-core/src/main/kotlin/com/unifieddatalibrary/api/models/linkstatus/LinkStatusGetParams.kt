...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LinkStatusGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LinkStatusGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LinkStatusGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(linkStatusGetParams: LinkStatusGetParams) = apply {
            id = linkStatusGetParams.id
            firstResult = linkStatusGetParams.firstResult
            maxResults = linkStatusGetParams.maxResults
            additionalHeaders = linkStatusGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = linkStatusGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LinkStatusGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LinkStatusGetParams =
            LinkStatusGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LinkStatusGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LinkStatusGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
