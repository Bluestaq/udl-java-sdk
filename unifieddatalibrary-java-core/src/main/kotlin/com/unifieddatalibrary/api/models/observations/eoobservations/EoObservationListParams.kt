...
private constructor(
     ...
     * provider for details on their obTime specifications. (YYYY-MM-DDTHH:MM:SS.ssssssZ)
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EoObservationListParams].
         *
    ...
    /** A builder for [EoObservationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eoObservationListParams: EoObservationListParams) = apply {
            obTime = eoObservationListParams.obTime
            firstResult = eoObservationListParams.firstResult
            maxResults = eoObservationListParams.maxResults
            additionalHeaders = eoObservationListParams.additionalHeaders.toBuilder()
            additionalQueryParams = eoObservationListParams.additionalQueryParams.toBuilder()
        }

        /**
         * Ob detection time in ISO 8601 UTC, up to microsecond precision. Consumers should contact
         * the provider for details on their obTime specifications. (YYYY-MM-DDTHH:MM:SS.ssssssZ)
         */
        ...
        /**
         * Returns an immutable instance of [EoObservationListParams].
         *
         ...
         */
        fun build(): EoObservationListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EoObservationListParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "EoObservationListParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
