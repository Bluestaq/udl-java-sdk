...
class AircraftSortyUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftSortyUnvalidatedPublishParams].
         *
    ...
    /** A builder for [AircraftSortyUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyUnvalidatedPublishParams: AircraftSortyUnvalidatedPublishParams) =
            apply {
                body = aircraftSortyUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = aircraftSortyUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftSortyUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortyUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): AircraftSortyUnvalidatedPublishParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftSortyUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AircraftSortyUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
