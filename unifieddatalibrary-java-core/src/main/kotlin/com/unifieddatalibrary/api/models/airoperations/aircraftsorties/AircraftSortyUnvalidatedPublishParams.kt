...
/**
 * Service operation to take one or many aircraft sortie records as a POST body and ingest into the
 ...
 */
class AircraftSortyUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            aircraftSortyUnvalidatedPublishParams: AircraftSortyUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                aircraftSortyUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun toString() =
        "AircraftSortyUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
