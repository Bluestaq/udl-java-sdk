...
class SeraDataNavigationGetResponse
private constructor(
    ...
    /** A builder for [SeraDataNavigationGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataNavigationGetResponse: SeraDataNavigationGetResponse) = apply {
            classificationMarking = seraDataNavigationGetResponse.classificationMarking
            dataMode = seraDataNavigationGetResponse.dataMode
            source = seraDataNavigationGetResponse.source
            spacecraftId = seraDataNavigationGetResponse.spacecraftId
            id = seraDataNavigationGetResponse.id
            areaCoverage = seraDataNavigationGetResponse.areaCoverage
            clockType = seraDataNavigationGetResponse.clockType
            createdAt = seraDataNavigationGetResponse.createdAt
            createdBy = seraDataNavigationGetResponse.createdBy
            hostedForCompanyOrgId = seraDataNavigationGetResponse.hostedForCompanyOrgId
            idNavigation = seraDataNavigationGetResponse.idNavigation
            locationAccuracy = seraDataNavigationGetResponse.locationAccuracy
            manufacturerOrgId = seraDataNavigationGetResponse.manufacturerOrgId
            modeFrequency = seraDataNavigationGetResponse.modeFrequency
            modes = seraDataNavigationGetResponse.modes
            name = seraDataNavigationGetResponse.name
            notes = seraDataNavigationGetResponse.notes
            origin = seraDataNavigationGetResponse.origin
            origNetwork = seraDataNavigationGetResponse.origNetwork
            partnerSpacecraftId = seraDataNavigationGetResponse.partnerSpacecraftId
            payloadType = seraDataNavigationGetResponse.payloadType
            updatedAt = seraDataNavigationGetResponse.updatedAt
            updatedBy = seraDataNavigationGetResponse.updatedBy
            additionalProperties = seraDataNavigationGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataNavigationGetResponse].
         *
         ...
         */
        fun build(): SeraDataNavigationGetResponse =
            SeraDataNavigationGetResponse(
    ...
    fun validate(): SeraDataNavigationGetResponse = apply {
        if (validated) {
            return@apply
        }
