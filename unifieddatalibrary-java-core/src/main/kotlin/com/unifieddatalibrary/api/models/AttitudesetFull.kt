...
class AttitudesetFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("attitudeList") @ExcludeMissing attitudeList: JsonField<List<AttitudedataFull>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attitudesetFull: AttitudesetFull) =
            apply {
        ...
        /** Collection of attitude data associated with this Attitude Set. */
        fun attitudeList(attitudeList: List<AttitudedataFull>) = attitudeList(JsonField.of(attitudeList))

        /**
         * Sets [Builder.attitudeList] to an arbitrary JSON value.
         *
         * You should usually call [Builder.attitudeList] with a well-typed `List<AttitudedataFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun attitudeList(attitudeList: JsonField<List<AttitudedataFull>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAttitudeList(attitudeList: AttitudedataFull) =
            apply {
