...
class OnorbitthrusterstatusFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("idOnorbitThruster") @ExcludeMissing idOnorbitThruster: JsonField<String> = JsonMissing.of(),
        @JsonProperty("source") @ExcludeMissing source: JsonField<String> = JsonMissing.of(),
        @JsonProperty("statusTime") @ExcludeMissing statusTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("fuelMassUnc") @ExcludeMissing fuelMassUnc: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("operational") @ExcludeMissing operational: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("origin") @ExcludeMissing origin: JsonField<String> = JsonMissing.of(),
        @JsonProperty("origNetwork") @ExcludeMissing origNetwork: JsonField<String> = JsonMissing.of(),
        @JsonProperty("propMassAvg") @ExcludeMissing propMassAvg: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("propMassMax") @ExcludeMissing propMassMax: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("propMassMedian") @ExcludeMissing propMassMedian: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("propMassMin") @ExcludeMissing propMassMin: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("thrustMax") @ExcludeMissing thrustMax: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("totalDeltaV") @ExcludeMissing totalDeltaV: JsonField<Double> = JsonMissing.of()
    ) : this(
     ...
     *
     * Unlike [idOnorbitThruster], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _estDeltaV(): JsonField<Double> = estDeltaV
    ...
    @ExcludeMissing
    fun _fuelMass(): JsonField<Double> = fuelMass
    ...
    @ExcludeMissing
    fun _minDeltaV(): JsonField<Double> = minDeltaV
    ...
    @ExcludeMissing
    fun _thrustMax(): JsonField<Double> = thrustMax
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitthrusterstatusFull].
         *
    ...
    /** A builder for [OnorbitthrusterstatusFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterstatusFull: OnorbitthrusterstatusFull) =
            apply {
                classificationMarking = onorbitthrusterstatusFull.classificationMarking
                dataMode = onorbitthrusterstatusFull.dataMode
                idOnorbitThruster = onorbitthrusterstatusFull.idOnorbitThruster
                source = onorbitthrusterstatusFull.source
                statusTime = onorbitthrusterstatusFull.statusTime
                id = onorbitthrusterstatusFull.id
                createdAt = onorbitthrusterstatusFull.createdAt
                createdBy = onorbitthrusterstatusFull.createdBy
                estDeltaV = onorbitthrusterstatusFull.estDeltaV
                fuelMass = onorbitthrusterstatusFull.fuelMass
                fuelMassUnc = onorbitthrusterstatusFull.fuelMassUnc
                isp = onorbitthrusterstatusFull.isp
                maxDeltaV = onorbitthrusterstatusFull.maxDeltaV
                minDeltaV = onorbitthrusterstatusFull.minDeltaV
                name = onorbitthrusterstatusFull.name
                operational = onorbitthrusterstatusFull.operational
                origin = onorbitthrusterstatusFull.origin
                origNetwork = onorbitthrusterstatusFull.origNetwork
                propMassAvg = onorbitthrusterstatusFull.propMassAvg
                propMassMax = onorbitthrusterstatusFull.propMassMax
                propMassMedian = onorbitthrusterstatusFull.propMassMedian
                propMassMin = onorbitthrusterstatusFull.propMassMin
                thrustMax = onorbitthrusterstatusFull.thrustMax
                totalDeltaV = onorbitthrusterstatusFull.totalDeltaV
                additionalProperties = onorbitthrusterstatusFull.additionalProperties.toMutableMap()
            }
        ...
        /** ID of the associated OnorbitThruster record. This ID can be used to obtain additional information on an onorbit thruster object using the 'get by ID' operation (e.g. /udl/onorbitthruster/{id}). For example, the OnorbitThruster object with idOnorbitThruster = abc would be queried as /udl/onorbitthruster/abc. */
        fun idOnorbitThruster(idOnorbitThruster: String) = idOnorbitThruster(JsonField.of(idOnorbitThruster))

        /**
         * Sets [Builder.idOnorbitThruster] to an arbitrary JSON value.
         *
         * You should usually call [Builder.idOnorbitThruster] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idOnorbitThruster(idOnorbitThruster: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.statusTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun statusTime(statusTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.estDeltaV] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun estDeltaV(estDeltaV: JsonField<Double>) =
            apply {
                this.estDeltaV = estDeltaV
            }
         ...
         *
         * You should usually call [Builder.fuelMass] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fuelMass(fuelMass: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.fuelMassUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fuelMassUnc(fuelMassUnc: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.isp] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun isp(isp: JsonField<Double>) =
            apply {
                this.isp = isp
            }
         ...
         *
         * You should usually call [Builder.minDeltaV] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun minDeltaV(minDeltaV: JsonField<Double>) =
            apply {
                this.minDeltaV = minDeltaV
            }
         ...
         *
         * You should usually call [Builder.operational] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun operational(operational: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.propMassAvg] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun propMassAvg(propMassAvg: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.propMassMax] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun propMassMax(propMassMax: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.propMassMedian] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun propMassMedian(propMassMedian: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.propMassMin] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun propMassMin(propMassMin: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.thrustMax] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun thrustMax(thrustMax: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.totalDeltaV] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun totalDeltaV(totalDeltaV: JsonField<Double>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [OnorbitthrusterstatusFull].
         *
         ...
         */
        fun build(): OnorbitthrusterstatusFull =
    ...
    fun validate(): OnorbitthrusterstatusFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idOnorbitThruster.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (statusTime.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (estDeltaV.asKnown().isPresent) 1 else 0) + (if (fuelMass.asKnown().isPresent) 1 else 0) + (if (fuelMassUnc.asKnown().isPresent) 1 else 0) + (if (isp.asKnown().isPresent) 1 else 0) + (if (maxDeltaV.asKnown().isPresent) 1 else 0) + (if (minDeltaV.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (operational.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (propMassAvg.asKnown().isPresent) 1 else 0) + (if (propMassMax.asKnown().isPresent) 1 else 0) + (if (propMassMedian.asKnown().isPresent) 1 else 0) + (if (propMassMin.asKnown().isPresent) 1 else 0) + (if (thrustMax.asKnown().isPresent) 1 else 0) + (if (totalDeltaV.asKnown().isPresent) 1 else 0)
