...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterstatusFull: OnorbitthrusterstatusFull) = apply {
    ...
    fun validate(): OnorbitthrusterstatusFull = apply {
        if (validated) {
            return@apply
        }
