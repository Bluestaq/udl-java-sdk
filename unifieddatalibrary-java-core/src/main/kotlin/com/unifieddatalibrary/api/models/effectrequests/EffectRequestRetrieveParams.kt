...
class EffectRequestRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EffectRequestRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EffectRequestRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EffectRequestRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestRetrieveParams: EffectRequestRetrieveParams) =
            apply {
                id = effectRequestRetrieveParams.id
                firstResult = effectRequestRetrieveParams.firstResult
                maxResults = effectRequestRetrieveParams.maxResults
                additionalHeaders = effectRequestRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectRequestRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EffectRequestRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectRequestRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EffectRequestRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
