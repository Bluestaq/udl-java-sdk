...
class EffectRequestRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EffectRequestRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestRetrieveParams: EffectRequestRetrieveParams) = apply {
    ...
    override fun toString() =
        "EffectRequestRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
