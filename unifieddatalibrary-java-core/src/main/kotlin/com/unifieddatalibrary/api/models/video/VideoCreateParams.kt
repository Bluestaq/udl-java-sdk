...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun tokenValue(): String = body.tokenValue()
     ...
     *   if the server responded with an unexpected value).
     */
    fun videoUrls(): Optional<List<String>> = body.videoUrls()
     ...
     */
    fun _tokenValue(): JsonField<String> = body._tokenValue()
     ...
     */
    fun _videoUrls(): JsonField<List<String>> = body._videoUrls()
    ...
    class Builder internal constructor() {
        ...
        /** Video Publisher Token. */
        fun tokenValue(tokenValue: String) = apply { body.tokenValue(tokenValue) }
         ...
         * value.
         */
        fun tokenValue(tokenValue: JsonField<String>) = apply { body.tokenValue(tokenValue) }
        ...
        /** Video Streaming Support URLs. */
        fun videoUrls(videoUrls: List<String>) = apply { body.videoUrls(videoUrls) }
         ...
         * supported value.
         */
        fun videoUrls(videoUrls: JsonField<List<String>>) = apply { body.videoUrls(videoUrls) }
         ...
         */
        fun addVideoUrl(videoUrl: String) = apply { body.addVideoUrl(videoUrl) }
    ...
    private constructor(
        ...
        @JsonProperty("tokenValue")
        @ExcludeMissing
        fun _tokenValue(): JsonField<String> = tokenValue
        ...
        @JsonProperty("videoUrls")
        @ExcludeMissing
        fun _videoUrls(): JsonField<List<String>> = videoUrls
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                videoUrls = body.videoUrls.map { it.toMutableList() }
             ...
             * Sets [Builder.tokenValue] to an arbitrary JSON value.
             *
             * You should usually call [Builder.tokenValue] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VideoCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
