...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IrListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IrListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IrListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(irListParams: IrListParams) = apply {
            firstResult = irListParams.firstResult
            maxResults = irListParams.maxResults
            additionalHeaders = irListParams.additionalHeaders.toBuilder()
            additionalQueryParams = irListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IrListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IrListParams =
            IrListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IrListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "IrListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
