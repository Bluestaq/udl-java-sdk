...
class EffectResponseActionsListFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("actionMetrics") @ExcludeMissing actionMetrics: JsonField<List<EffectResponseMetricsFull>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun actionMetrics(): Optional<List<EffectResponseMetricsFull>> = actionMetrics.getOptional("actionMetrics")
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EffectResponseActionsListFull]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseActionsListFull: EffectResponseActionsListFull) =
            apply {
        ...
        /** List of metrics associated with this action. */
        fun actionMetrics(actionMetrics: List<EffectResponseMetricsFull>) = actionMetrics(JsonField.of(actionMetrics))

        /**
         * Sets [Builder.actionMetrics] to an arbitrary JSON value.
         *
         * You should usually call [Builder.actionMetrics] with a well-typed `List<EffectResponseMetricsFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun actionMetrics(actionMetrics: JsonField<List<EffectResponseMetricsFull>>) =
            apply {
         ...
         */
        fun addActionMetric(actionMetric: EffectResponseMetricsFull) =
            apply {
    ...
    fun validate(): EffectResponseActionsListFull =
        apply {
            if (validated) {
              return@apply
            }
