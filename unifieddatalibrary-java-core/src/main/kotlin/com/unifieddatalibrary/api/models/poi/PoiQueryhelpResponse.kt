...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiQueryhelpResponse: PoiQueryhelpResponse) = apply {
    ...
    fun validate(): PoiQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
