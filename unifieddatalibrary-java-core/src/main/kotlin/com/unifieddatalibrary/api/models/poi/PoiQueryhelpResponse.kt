...
class PoiQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PoiQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [PoiQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiQueryhelpResponse: PoiQueryhelpResponse) =
            apply {
                aodrSupported = poiQueryhelpResponse.aodrSupported
                classificationMarking = poiQueryhelpResponse.classificationMarking
                description = poiQueryhelpResponse.description
                historySupported = poiQueryhelpResponse.historySupported
                name = poiQueryhelpResponse.name
                parameters = poiQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = poiQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = poiQueryhelpResponse.restSupported
                sortSupported = poiQueryhelpResponse.sortSupported
                typeName = poiQueryhelpResponse.typeName
                uri = poiQueryhelpResponse.uri
                additionalProperties = poiQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PoiQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PoiQueryhelpResponse =
    ...
    fun validate(): PoiQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PoiQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
