...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityQueryHelpResponse: EntityQueryHelpResponse) = apply {
    ...
    fun validate(): EntityQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
