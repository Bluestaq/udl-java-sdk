...
class EntityQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EntityQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EntityQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityQueryHelpResponse: EntityQueryHelpResponse) =
            apply {
                aodrSupported = entityQueryHelpResponse.aodrSupported
                classificationMarking = entityQueryHelpResponse.classificationMarking
                description = entityQueryHelpResponse.description
                historySupported = entityQueryHelpResponse.historySupported
                name = entityQueryHelpResponse.name
                parameters = entityQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = entityQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = entityQueryHelpResponse.restSupported
                sortSupported = entityQueryHelpResponse.sortSupported
                typeName = entityQueryHelpResponse.typeName
                uri = entityQueryHelpResponse.uri
                additionalProperties = entityQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EntityQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EntityQueryHelpResponse =
    ...
    fun validate(): EntityQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EntityQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
