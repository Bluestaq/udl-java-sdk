...
class WeatherDataQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataQueryhelpResponse: WeatherDataQueryhelpResponse) = apply {
    ...
    fun validate(): WeatherDataQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
