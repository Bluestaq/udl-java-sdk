...
class WeatherDataQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WeatherDataQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [WeatherDataQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataQueryhelpResponse: WeatherDataQueryhelpResponse) =
            apply {
                aodrSupported = weatherDataQueryhelpResponse.aodrSupported
                classificationMarking = weatherDataQueryhelpResponse.classificationMarking
                description = weatherDataQueryhelpResponse.description
                historySupported = weatherDataQueryhelpResponse.historySupported
                name = weatherDataQueryhelpResponse.name
                parameters = weatherDataQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = weatherDataQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = weatherDataQueryhelpResponse.restSupported
                sortSupported = weatherDataQueryhelpResponse.sortSupported
                typeName = weatherDataQueryhelpResponse.typeName
                uri = weatherDataQueryhelpResponse.uri
                additionalProperties = weatherDataQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [WeatherDataQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WeatherDataQueryhelpResponse =
    ...
    fun validate(): WeatherDataQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is WeatherDataQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
