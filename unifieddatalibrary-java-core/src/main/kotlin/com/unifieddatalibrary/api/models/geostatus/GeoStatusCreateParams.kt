...
class GeoStatusCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusCreateParams: GeoStatusCreateParams) =
            apply {
        ...
        /** Maximum longitude for this object. WGS-84 longitude of the spacecraft position, in degrees. 0 to 360 degrees. */
        fun longitudeMax(longitudeMax: Double) =
            apply {
        ...
        /** Minimum longitude for this object. WGS-84 longitude of the spacecraft position, in degrees. 0 to 360 degrees. */
        fun longitudeMin(longitudeMin: Double) =
            apply {
        ...
        /** Corrective or overriding long term trend for longitudinal change in degrees/day. */
        fun longitudeRate(longitudeRate: Double) =
            apply {
        ...
        /** Lost space object indicator. (True or False). */
        fun lostFlag(lostFlag: Boolean) =
            apply {
                body.lostFlag(lostFlag)
            }
         ...
         * West - Drifting westward; large relative energy and a period greater than 1436.2 minutes.
         */
        fun troughType(troughType: String) =
            apply {
                body.troughType(troughType)
            }
    ...
    override fun toString() = "GeoStatusCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
