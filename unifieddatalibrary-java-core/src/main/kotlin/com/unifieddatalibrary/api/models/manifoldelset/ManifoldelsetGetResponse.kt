...
/**
 * Theoretical Keplarian orbital elements belonging to an object of interest's manifold describing a
 * possible/theoretical orbit for an object of interest for tasking purposes.
 */
class ManifoldelsetGetResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetGetResponse: ManifoldelsetGetResponse) = apply {
    ...
    fun validate(): ManifoldelsetGetResponse = apply {
        if (validated) {
            return@apply
        }
