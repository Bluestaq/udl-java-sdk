...
class ManifoldelsetGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManifoldelsetGetResponse].
         *
    ...
    /** A builder for [ManifoldelsetGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetGetResponse: ManifoldelsetGetResponse) =
            apply {
                classificationMarking = manifoldelsetGetResponse.classificationMarking
                dataMode = manifoldelsetGetResponse.dataMode
                epoch = manifoldelsetGetResponse.epoch
                idManifold = manifoldelsetGetResponse.idManifold
                source = manifoldelsetGetResponse.source
                tmpSatNo = manifoldelsetGetResponse.tmpSatNo
                id = manifoldelsetGetResponse.id
                apogee = manifoldelsetGetResponse.apogee
                argOfPerigee = manifoldelsetGetResponse.argOfPerigee
                bStar = manifoldelsetGetResponse.bStar
                createdAt = manifoldelsetGetResponse.createdAt
                createdBy = manifoldelsetGetResponse.createdBy
                eccentricity = manifoldelsetGetResponse.eccentricity
                inclination = manifoldelsetGetResponse.inclination
                line1 = manifoldelsetGetResponse.line1
                line2 = manifoldelsetGetResponse.line2
                meanAnomaly = manifoldelsetGetResponse.meanAnomaly
                meanMotion = manifoldelsetGetResponse.meanMotion
                meanMotionDDot = manifoldelsetGetResponse.meanMotionDDot
                meanMotionDot = manifoldelsetGetResponse.meanMotionDot
                origin = manifoldelsetGetResponse.origin
                origNetwork = manifoldelsetGetResponse.origNetwork
                perigee = manifoldelsetGetResponse.perigee
                period = manifoldelsetGetResponse.period
                raan = manifoldelsetGetResponse.raan
                revNo = manifoldelsetGetResponse.revNo
                semiMajorAxis = manifoldelsetGetResponse.semiMajorAxis
                updatedAt = manifoldelsetGetResponse.updatedAt
                updatedBy = manifoldelsetGetResponse.updatedBy
                additionalProperties = manifoldelsetGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ManifoldelsetGetResponse].
         *
         ...
         */
        fun build(): ManifoldelsetGetResponse =
    ...
    fun validate(): ManifoldelsetGetResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ManifoldelsetGetResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && epoch == other.epoch && idManifold == other.idManifold && source == other.source && tmpSatNo == other.tmpSatNo && id == other.id && apogee == other.apogee && argOfPerigee == other.argOfPerigee && bStar == other.bStar && createdAt == other.createdAt && createdBy == other.createdBy && eccentricity == other.eccentricity && inclination == other.inclination && line1 == other.line1 && line2 == other.line2 && meanAnomaly == other.meanAnomaly && meanMotion == other.meanMotion && meanMotionDDot == other.meanMotionDDot && meanMotionDot == other.meanMotionDot && origin == other.origin && origNetwork == other.origNetwork && perigee == other.perigee && period == other.period && raan == other.raan && revNo == other.revNo && semiMajorAxis == other.semiMajorAxis && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, epoch, idManifold, source, tmpSatNo, id, apogee, argOfPerigee, bStar, createdAt, createdBy, eccentricity, inclination, line1, line2, meanAnomaly, meanMotion, meanMotionDDot, meanMotionDot, origin, origNetwork, perigee, period, raan, revNo, semiMajorAxis, updatedAt, updatedBy, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "ManifoldelsetGetResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, epoch=$epoch, idManifold=$idManifold, source=$source, tmpSatNo=$tmpSatNo, id=$id, apogee=$apogee, argOfPerigee=$argOfPerigee, bStar=$bStar, createdAt=$createdAt, createdBy=$createdBy, eccentricity=$eccentricity, inclination=$inclination, line1=$line1, line2=$line2, meanAnomaly=$meanAnomaly, meanMotion=$meanMotion, meanMotionDDot=$meanMotionDDot, meanMotionDot=$meanMotionDot, origin=$origin, origNetwork=$origNetwork, perigee=$perigee, period=$period, raan=$raan, revNo=$revNo, semiMajorAxis=$semiMajorAxis, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
