...
class StageCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StageCreateParams].
         *
    ...
    /** A builder for [StageCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageCreateParams: StageCreateParams) =
            apply {
                body = stageCreateParams.body.toBuilder()
                additionalHeaders = stageCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = stageCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Description/notes of the stage avionics. */
        fun avionicsNotes(avionicsNotes: String) =
            apply {
        ...
        /** Number of burns for the stage engines. */
        fun numBurns(numBurns: Int) =
            apply {
                body.numBurns(numBurns)
            }
        ...
        /** The number of the specified engines on this launch stage. */
        fun numEngines(numEngines: Int) =
            apply {
                body.numEngines(numEngines)
            }
        ...
        /** Number of vernier or additional engines. */
        fun numVernier(numVernier: Int) =
            apply {
                body.numVernier(numVernier)
            }
        ...
        /** Array of URLs of photos of the stage. */
        fun photoUrls(photoUrls: List<String>) =
            apply {
        ...
        fun addPhotoUrl(photoUrl: String) =
            apply {
                body.addPhotoUrl(photoUrl)
            }

        /** Boolean indicating if this launch stage can be restarted. */
        fun restartable(restartable: Boolean) =
            apply {
                body.restartable(restartable)
            }
        ...
        /** The stage number of this launch stage. */
        fun stageNumber(stageNumber: Int) =
            apply {
        ...
        /** Total thrust of the stage in a vacuum in kN. */
        fun thrustVacuum(thrustVacuum: Double) =
            apply {
        ...
        /** Engine vernier or additional engine type. */
        fun vernier(vernier: String) =
            apply {
                body.vernier(vernier)
            }
        ...
        /**
         * Returns an immutable instance of [StageCreateParams].
         *
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idEngine.asKnown().isPresent) 1 else 0) + (if (idLaunchVehicle.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (avionicsNotes.asKnown().isPresent) 1 else 0) + (if (burnTime.asKnown().isPresent) 1 else 0) + (if (controlThruster1.asKnown().isPresent) 1 else 0) + (if (controlThruster2.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (diameter.asKnown().isPresent) 1 else 0) + (if (length.asKnown().isPresent) 1 else 0) + (if (mainEngineThrustSeaLevel.asKnown().isPresent) 1 else 0) + (if (mainEngineThrustVacuum.asKnown().isPresent) 1 else 0) + (if (manufacturerOrgId.asKnown().isPresent) 1 else 0) + (if (mass.asKnown().isPresent) 1 else 0) + (if (notes.asKnown().isPresent) 1 else 0) + (if (numBurns.asKnown().isPresent) 1 else 0) + (if (numControlThruster1.asKnown().isPresent) 1 else 0) + (if (numControlThruster2.asKnown().isPresent) 1 else 0) + (if (numEngines.asKnown().isPresent) 1 else 0) + (if (numStageElements.asKnown().isPresent) 1 else 0) + (if (numVernier.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (photoUrls.asKnown().getOrNull()?.size ?: 0) + (if (restartable.asKnown().isPresent) 1 else 0) + (if (reusable.asKnown().isPresent) 1 else 0) + (if (stageNumber.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (thrustSeaLevel.asKnown().isPresent) 1 else 0) + (if (thrustVacuum.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (vernier.asKnown().isPresent) 1 else 0) + (if (vernierBurnTime.asKnown().isPresent) 1 else 0) + (if (vernierNumBurns.asKnown().isPresent) 1 else 0) + (if (vernierThrustSeaLevel.asKnown().isPresent) 1 else 0) + (if (vernierThrustVacuum.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StageCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "StageCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
