 ...
 */
class OperatingunitremarkListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OperatingunitremarkListParams = builder().build()
    ...
    /** A builder for [OperatingunitremarkListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitremarkListParams: OperatingunitremarkListParams) = apply {
            firstResult = operatingunitremarkListParams.firstResult
            maxResults = operatingunitremarkListParams.maxResults
            additionalHeaders = operatingunitremarkListParams.additionalHeaders.toBuilder()
            additionalQueryParams = operatingunitremarkListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OperatingunitremarkListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OperatingunitremarkListParams =
            OperatingunitremarkListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OperatingunitremarkListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OperatingunitremarkListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
