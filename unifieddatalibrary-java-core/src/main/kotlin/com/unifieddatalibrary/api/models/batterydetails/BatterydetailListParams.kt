...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BatterydetailListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batterydetailListParams: BatterydetailListParams) = apply {
    ...
    override fun toString() =
        "BatterydetailListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
