...
class RfObservationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationQueryhelpResponse: RfObservationQueryhelpResponse) = apply {
            ...
            additionalProperties =
                rfObservationQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): RfObservationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
