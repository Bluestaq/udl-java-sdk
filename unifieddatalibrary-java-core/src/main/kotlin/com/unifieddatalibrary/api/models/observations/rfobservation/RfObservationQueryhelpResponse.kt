...
class RfObservationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RfObservationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfObservationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationQueryhelpResponse: RfObservationQueryhelpResponse) =
            apply {
                aodrSupported = rfObservationQueryhelpResponse.aodrSupported
                classificationMarking = rfObservationQueryhelpResponse.classificationMarking
                description = rfObservationQueryhelpResponse.description
                historySupported = rfObservationQueryhelpResponse.historySupported
                name = rfObservationQueryhelpResponse.name
                parameters = rfObservationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = rfObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = rfObservationQueryhelpResponse.restSupported
                sortSupported = rfObservationQueryhelpResponse.sortSupported
                typeName = rfObservationQueryhelpResponse.typeName
                uri = rfObservationQueryhelpResponse.uri
                additionalProperties = rfObservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RfObservationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfObservationQueryhelpResponse =
    ...
    fun validate(): RfObservationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfObservationQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
