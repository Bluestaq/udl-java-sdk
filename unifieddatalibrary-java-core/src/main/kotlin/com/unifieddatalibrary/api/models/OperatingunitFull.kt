...
class OperatingunitFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("operatingUnitRemarks") @ExcludeMissing operatingUnitRemarks: JsonField<List<OperatingUnitRemarkFull>> = JsonMissing.of(),
        @JsonProperty("operStatus") @ExcludeMissing operStatus: JsonField<String> = JsonMissing.of(),
        @JsonProperty("organization") @ExcludeMissing organization: JsonField<OrganizationFull> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun operatingUnitRemarks(): Optional<List<OperatingUnitRemarkFull>> = operatingUnitRemarks.getOptional("operatingUnitRemarks")
     ...
     *
     * Unlike [operatingUnitRemarks], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitFull: OperatingunitFull) =
            apply {
        ...
        /** Remarks contain amplifying information for a specific service. The information may contain context and interpretations for consumer use. */
        fun operatingUnitRemarks(operatingUnitRemarks: List<OperatingUnitRemarkFull>) = operatingUnitRemarks(JsonField.of(operatingUnitRemarks))

        /**
         * Sets [Builder.operatingUnitRemarks] to an arbitrary JSON value.
         *
         * You should usually call [Builder.operatingUnitRemarks] with a well-typed `List<OperatingUnitRemarkFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         */
        fun addOperatingUnitRemark(operatingUnitRemark: OperatingUnitRemarkFull) =
            apply {
                operatingUnitRemarks = (operatingUnitRemarks ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.organization] with a well-typed [OrganizationFull] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun organization(organization: JsonField<OrganizationFull>) =
            apply {
    ...
    fun validate(): OperatingunitFull =
        apply {
            if (validated) {
              return@apply
            }
