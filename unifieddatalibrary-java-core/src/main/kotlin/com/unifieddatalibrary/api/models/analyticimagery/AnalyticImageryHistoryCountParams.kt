...
class AnalyticImageryHistoryCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AnalyticImageryHistoryCountParams].
         *
    ...
    /** A builder for [AnalyticImageryHistoryCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryHistoryCountParams: AnalyticImageryHistoryCountParams) =
            apply {
                msgTime = analyticImageryHistoryCountParams.msgTime
                firstResult = analyticImageryHistoryCountParams.firstResult
                maxResults = analyticImageryHistoryCountParams.maxResults
                additionalHeaders = analyticImageryHistoryCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = analyticImageryHistoryCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticImageryHistoryCountParams].
         *
         ...
         */
        fun build(): AnalyticImageryHistoryCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AnalyticImageryHistoryCountParams && msgTime == other.msgTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AnalyticImageryHistoryCountParams{msgTime=$msgTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
