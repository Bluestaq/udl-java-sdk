...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfObservationGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationGetParams: RfObservationGetParams) = apply {
    ...
    override fun toString() =
        "RfObservationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
