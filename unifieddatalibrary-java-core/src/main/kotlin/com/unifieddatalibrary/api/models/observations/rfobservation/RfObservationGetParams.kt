...
class RfObservationGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): RfObservationGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RfObservationGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfObservationGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationGetParams: RfObservationGetParams) =
            apply {
                id = rfObservationGetParams.id
                firstResult = rfObservationGetParams.firstResult
                maxResults = rfObservationGetParams.maxResults
                additionalHeaders = rfObservationGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfObservationGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfObservationGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfObservationGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfObservationGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfObservationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
