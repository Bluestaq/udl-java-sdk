...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationListPage: SarObservationListPage) = apply {
            service = sarObservationListPage.service
            params = sarObservationListPage.params
            items = sarObservationListPage.items
        }

        fun service(service: SarObservationService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SarObservationListPage &&
    ...
    override fun toString() =
        "SarObservationListPage{service=$service, params=$params, items=$items}"
}
