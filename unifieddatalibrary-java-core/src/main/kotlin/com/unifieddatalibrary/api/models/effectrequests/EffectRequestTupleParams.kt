...
class EffectRequestTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectRequestTupleParams].
         *
    ...
    /** A builder for [EffectRequestTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestTupleParams: EffectRequestTupleParams) =
            apply {
                columns = effectRequestTupleParams.columns
                createdAt = effectRequestTupleParams.createdAt
                firstResult = effectRequestTupleParams.firstResult
                maxResults = effectRequestTupleParams.maxResults
                additionalHeaders = effectRequestTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectRequestTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestTupleParams].
         *
         ...
         */
        fun build(): EffectRequestTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectRequestTupleParams && columns == other.columns && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EffectRequestTupleParams{columns=$columns, createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
