...
class SeraDataEarlyWarningGetResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("earthPointing") @ExcludeMissing earthPointing: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("frequencyLimits") @ExcludeMissing frequencyLimits: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("missileLaunchPhaseDetectionAbility") @ExcludeMissing missileLaunchPhaseDetectionAbility: JsonField<String> = JsonMissing.of(),
        @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
        @JsonProperty("origin") @ExcludeMissing origin: JsonField<String> = JsonMissing.of(),
        @JsonProperty("origNetwork") @ExcludeMissing origNetwork: JsonField<String> = JsonMissing.of(),
        @JsonProperty("partnerSpacecraftId") @ExcludeMissing partnerSpacecraftId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("payloadNotes") @ExcludeMissing payloadNotes: JsonField<String> = JsonMissing.of(),
        @JsonProperty("spectralBands") @ExcludeMissing spectralBands: JsonField<String> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun missileLaunchPhaseDetectionAbility(): Optional<String> = missileLaunchPhaseDetectionAbility.getOptional("missileLaunchPhaseDetectionAbility")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun partnerSpacecraftId(): Optional<String> = partnerSpacecraftId.getOptional("partnerSpacecraftId")
    ...
    @JsonProperty("idIR")
    @ExcludeMissing
    fun _idIr(): JsonField<String> = idIr
     ...
     *
     * Unlike [missileLaunchPhaseDetectionAbility], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("missileLaunchPhaseDetectionAbility")
    @ExcludeMissing
    fun _missileLaunchPhaseDetectionAbility(): JsonField<String> = missileLaunchPhaseDetectionAbility
     ...
     *
     * Unlike [partnerSpacecraftId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeraDataEarlyWarningGetResponse].
         *
    ...
    /** A builder for [SeraDataEarlyWarningGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningGetResponse: SeraDataEarlyWarningGetResponse) =
            apply {
                classificationMarking = seraDataEarlyWarningGetResponse.classificationMarking
                dataMode = seraDataEarlyWarningGetResponse.dataMode
                source = seraDataEarlyWarningGetResponse.source
                spacecraftId = seraDataEarlyWarningGetResponse.spacecraftId
                id = seraDataEarlyWarningGetResponse.id
                bestResolution = seraDataEarlyWarningGetResponse.bestResolution
                createdAt = seraDataEarlyWarningGetResponse.createdAt
                createdBy = seraDataEarlyWarningGetResponse.createdBy
                earthPointing = seraDataEarlyWarningGetResponse.earthPointing
                frequencyLimits = seraDataEarlyWarningGetResponse.frequencyLimits
                groundStationLocations = seraDataEarlyWarningGetResponse.groundStationLocations
                groundStations = seraDataEarlyWarningGetResponse.groundStations
                hostedForCompanyOrgId = seraDataEarlyWarningGetResponse.hostedForCompanyOrgId
                idIr = seraDataEarlyWarningGetResponse.idIr
                manufacturerOrgId = seraDataEarlyWarningGetResponse.manufacturerOrgId
                missileLaunchPhaseDetectionAbility = seraDataEarlyWarningGetResponse.missileLaunchPhaseDetectionAbility
                name = seraDataEarlyWarningGetResponse.name
                origin = seraDataEarlyWarningGetResponse.origin
                origNetwork = seraDataEarlyWarningGetResponse.origNetwork
                partnerSpacecraftId = seraDataEarlyWarningGetResponse.partnerSpacecraftId
                payloadNotes = seraDataEarlyWarningGetResponse.payloadNotes
                spectralBands = seraDataEarlyWarningGetResponse.spectralBands
                updatedAt = seraDataEarlyWarningGetResponse.updatedAt
                updatedBy = seraDataEarlyWarningGetResponse.updatedBy
                additionalProperties = seraDataEarlyWarningGetResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.earthPointing] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun earthPointing(earthPointing: JsonField<Boolean>) =
            apply {
                this.earthPointing = earthPointing
            }

        /** Frequency Limits for this IR. */
        fun frequencyLimits(frequencyLimits: String) = frequencyLimits(JsonField.of(frequencyLimits))

        /**
         * Sets [Builder.frequencyLimits] to an arbitrary JSON value.
         *
         * You should usually call [Builder.frequencyLimits] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun frequencyLimits(frequencyLimits: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.idIr] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idIr(idIr: JsonField<String>) =
            apply {
                this.idIr = idIr
            }
        ...
        /** Missile Launch Phase Detection Ability. */
        fun missileLaunchPhaseDetectionAbility(missileLaunchPhaseDetectionAbility: String) = missileLaunchPhaseDetectionAbility(JsonField.of(missileLaunchPhaseDetectionAbility))

        /**
         * Sets [Builder.missileLaunchPhaseDetectionAbility] to an arbitrary JSON value.
         *
         * You should usually call [Builder.missileLaunchPhaseDetectionAbility] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun missileLaunchPhaseDetectionAbility(missileLaunchPhaseDetectionAbility: JsonField<String>) =
            apply {
        ...
        /** Seradata ID of the spacecraft (SeradataSpacecraftDetails ID). */
        fun partnerSpacecraftId(partnerSpacecraftId: String) = partnerSpacecraftId(JsonField.of(partnerSpacecraftId))

        /**
         * Sets [Builder.partnerSpacecraftId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.partnerSpacecraftId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun partnerSpacecraftId(partnerSpacecraftId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.spectralBands] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spectralBands(spectralBands: JsonField<String>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [SeraDataEarlyWarningGetResponse].
         *
         ...
         */
        fun build(): SeraDataEarlyWarningGetResponse =
    ...
    fun validate(): SeraDataEarlyWarningGetResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (spacecraftId.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (bestResolution.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (earthPointing.asKnown().isPresent) 1 else 0) + (if (frequencyLimits.asKnown().isPresent) 1 else 0) + (if (groundStationLocations.asKnown().isPresent) 1 else 0) + (if (groundStations.asKnown().isPresent) 1 else 0) + (if (hostedForCompanyOrgId.asKnown().isPresent) 1 else 0) + (if (idIr.asKnown().isPresent) 1 else 0) + (if (manufacturerOrgId.asKnown().isPresent) 1 else 0) + (if (missileLaunchPhaseDetectionAbility.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (partnerSpacecraftId.asKnown().isPresent) 1 else 0) + (if (payloadNotes.asKnown().isPresent) 1 else 0) + (if (spectralBands.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
