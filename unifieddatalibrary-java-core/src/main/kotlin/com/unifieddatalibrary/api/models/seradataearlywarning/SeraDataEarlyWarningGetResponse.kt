...
class SeraDataEarlyWarningGetResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(seraDataEarlyWarningGetResponse: SeraDataEarlyWarningGetResponse) =
            apply {
                ...
                missileLaunchPhaseDetectionAbility =
                    seraDataEarlyWarningGetResponse.missileLaunchPhaseDetectionAbility
                ...
                additionalProperties =
                    seraDataEarlyWarningGetResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SeraDataEarlyWarningGetResponse = apply {
        if (validated) {
            return@apply
        }
