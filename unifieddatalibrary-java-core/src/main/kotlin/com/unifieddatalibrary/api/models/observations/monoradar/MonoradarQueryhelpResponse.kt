...
class MonoradarQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarQueryhelpResponse: MonoradarQueryhelpResponse) = apply {
    ...
    fun validate(): MonoradarQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
