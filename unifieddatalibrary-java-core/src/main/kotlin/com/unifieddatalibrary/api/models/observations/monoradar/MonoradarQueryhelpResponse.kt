...
class MonoradarQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MonoradarQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [MonoradarQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monoradarQueryhelpResponse: MonoradarQueryhelpResponse) =
            apply {
                aodrSupported = monoradarQueryhelpResponse.aodrSupported
                classificationMarking = monoradarQueryhelpResponse.classificationMarking
                description = monoradarQueryhelpResponse.description
                historySupported = monoradarQueryhelpResponse.historySupported
                name = monoradarQueryhelpResponse.name
                parameters = monoradarQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = monoradarQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = monoradarQueryhelpResponse.restSupported
                sortSupported = monoradarQueryhelpResponse.sortSupported
                typeName = monoradarQueryhelpResponse.typeName
                uri = monoradarQueryhelpResponse.uri
                additionalProperties = monoradarQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MonoradarQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MonoradarQueryhelpResponse =
    ...
    fun validate(): MonoradarQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MonoradarQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
