...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VideoGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [VideoGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VideoGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(videoGetParams: VideoGetParams) = apply {
            id = videoGetParams.id
            firstResult = videoGetParams.firstResult
            maxResults = videoGetParams.maxResults
            additionalHeaders = videoGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = videoGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VideoGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VideoGetParams =
            VideoGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VideoGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "VideoGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
