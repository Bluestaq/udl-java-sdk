...
class RfObservationGetResponse private constructor(
    ...
    private val baudRates: JsonField<List<Double>>,
    private val bitErrorRate: JsonField<Double>,
    private val carrierStandard: JsonField<String>,
    private val channel: JsonField<Int>,
    private val chipRates: JsonField<List<Double>>,
    private val codeFills: JsonField<List<String>>,
    private val codeLengths: JsonField<List<Double>>,
    private val codeTaps: JsonField<List<String>>,
    private val collectionMode: JsonField<String>,
    private val confidence: JsonField<Double>,
    private val confidences: JsonField<List<Double>>,
    private val constellationXPoints: JsonField<List<Double>>,
    private val constellationYPoints: JsonField<List<Double>>,
    private val createdAt: JsonField<OffsetDateTime>,
    private val createdBy: JsonField<String>,
    private val descriptor: JsonField<String>,
    private val detectionStatus: JsonField<String>,
    private val detectionStatuses: JsonField<List<String>>,
    ...
    private val pnOrders: JsonField<List<Int>>,
    ...
    private val signalIds: JsonField<List<String>>,
    ...
    private val telemetryIds: JsonField<List<String>>,
    ...
    private constructor(
        ...
        @JsonProperty("antennaName") @ExcludeMissing antennaName: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("baudRates") @ExcludeMissing baudRates: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("bitErrorRate") @ExcludeMissing bitErrorRate: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("carrierStandard") @ExcludeMissing carrierStandard: JsonField<String> = JsonMissing.of(),
        @JsonProperty("channel") @ExcludeMissing channel: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("chipRates") @ExcludeMissing chipRates: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("codeFills") @ExcludeMissing codeFills: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("codeLengths") @ExcludeMissing codeLengths: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("codeTaps") @ExcludeMissing codeTaps: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("collectionMode") @ExcludeMissing collectionMode: JsonField<String> = JsonMissing.of(),
        @JsonProperty("confidence") @ExcludeMissing confidence: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("confidences") @ExcludeMissing confidences: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("constellationXPoints") @ExcludeMissing constellationXPoints: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("constellationYPoints") @ExcludeMissing constellationYPoints: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("detectionStatus") @ExcludeMissing detectionStatus: JsonField<String> = JsonMissing.of(),
        @JsonProperty("detectionStatuses") @ExcludeMissing detectionStatuses: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("frequencies") @ExcludeMissing frequencies: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("frequency") @ExcludeMissing frequency: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("frequencyShift") @ExcludeMissing frequencyShift: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("innerCodingRate") @ExcludeMissing innerCodingRate: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("modulation") @ExcludeMissing modulation: JsonField<String> = JsonMissing.of(),
        @JsonProperty("noisePwrDensity") @ExcludeMissing noisePwrDensity: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("nominalBandwidth") @ExcludeMissing nominalBandwidth: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("nominalEirp") @ExcludeMissing nominalEirp: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("nominalFrequency") @ExcludeMissing nominalFrequency: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("nominalPowerOverNoise") @ExcludeMissing nominalPowerOverNoise: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("nominalSnr") @ExcludeMissing nominalSnr: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("outerCodingRate") @ExcludeMissing outerCodingRate: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("pnOrders") @ExcludeMissing pnOrders: JsonField<List<Int>> = JsonMissing.of(),
        @JsonProperty("polarity") @ExcludeMissing polarity: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("polarityType") @ExcludeMissing polarityType: JsonField<PolarityType> = JsonMissing.of(),
        @JsonProperty("powerOverNoise") @ExcludeMissing powerOverNoise: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("referenceLevel") @ExcludeMissing referenceLevel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("relativeCarrierPower") @ExcludeMissing relativeCarrierPower: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("relativeNoiseFloor") @ExcludeMissing relativeNoiseFloor: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("resolutionBandwidth") @ExcludeMissing resolutionBandwidth: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("signalIds") @ExcludeMissing signalIds: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("spectrumAnalyzerPower") @ExcludeMissing spectrumAnalyzerPower: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("symbolToNoiseRatio") @ExcludeMissing symbolToNoiseRatio: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("tags") @ExcludeMissing tags: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("taskId") @ExcludeMissing taskId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("telemetryIds") @ExcludeMissing telemetryIds: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("trackId") @ExcludeMissing trackId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("trackRange") @ExcludeMissing trackRange: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("transactionId") @ExcludeMissing transactionId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("transmitFilterRollOff") @ExcludeMissing transmitFilterRollOff: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("transmitFilterType") @ExcludeMissing transmitFilterType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("transponder") @ExcludeMissing transponder: JsonField<String> = JsonMissing.of(),
        @JsonProperty("uct") @ExcludeMissing uct: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("url") @ExcludeMissing url: JsonField<String> = JsonMissing.of(),
        @JsonProperty("videoBandwidth") @ExcludeMissing videoBandwidth: JsonField<Double> = JsonMissing.of()
    ) : this(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun baudRates(): Optional<List<Double>> = baudRates.getOptional("baudRates")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun chipRates(): Optional<List<Double>> = chipRates.getOptional("chipRates")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun codeFills(): Optional<List<String>> = codeFills.getOptional("codeFills")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun codeLengths(): Optional<List<Double>> = codeLengths.getOptional("codeLengths")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun codeTaps(): Optional<List<String>> = codeTaps.getOptional("codeTaps")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun confidences(): Optional<List<Double>> = confidences.getOptional("confidences")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun constellationXPoints(): Optional<List<Double>> = constellationXPoints.getOptional("constellationXPoints")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun constellationYPoints(): Optional<List<Double>> = constellationYPoints.getOptional("constellationYPoints")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun detectionStatuses(): Optional<List<String>> = detectionStatuses.getOptional("detectionStatuses")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun nominalPowerOverNoise(): Optional<Double> = nominalPowerOverNoise.getOptional("nominalPowerOverNoise")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun pnOrders(): Optional<List<Int>> = pnOrders.getOptional("pnOrders")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun relativeCarrierPower(): Optional<Double> = relativeCarrierPower.getOptional("relativeCarrierPower")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun relativeNoiseFloor(): Optional<Double> = relativeNoiseFloor.getOptional("relativeNoiseFloor")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun resolutionBandwidth(): Optional<Double> = resolutionBandwidth.getOptional("resolutionBandwidth")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun signalIds(): Optional<List<String>> = signalIds.getOptional("signalIds")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun spectrumAnalyzerPower(): Optional<Double> = spectrumAnalyzerPower.getOptional("spectrumAnalyzerPower")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun symbolToNoiseRatio(): Optional<Double> = symbolToNoiseRatio.getOptional("symbolToNoiseRatio")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun telemetryIds(): Optional<List<String>> = telemetryIds.getOptional("telemetryIds")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun transmitFilterRollOff(): Optional<Double> = transmitFilterRollOff.getOptional("transmitFilterRollOff")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun transmitFilterType(): Optional<String> = transmitFilterType.getOptional("transmitFilterType")
    ...
    @ExcludeMissing
    fun _baudRate(): JsonField<Double> = baudRate

    /**
     * Returns the raw JSON value of [baudRates].
     *
     * Unlike [baudRates], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("baudRates")
    @ExcludeMissing
    fun _baudRates(): JsonField<List<Double>> = baudRates
    ...
    @ExcludeMissing
    fun _channel(): JsonField<Int> = channel

    /**
     * Returns the raw JSON value of [chipRates].
     *
     * Unlike [chipRates], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("chipRates")
    @ExcludeMissing
    fun _chipRates(): JsonField<List<Double>> = chipRates

    /**
     * Returns the raw JSON value of [codeFills].
     *
     * Unlike [codeFills], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("codeFills")
    @ExcludeMissing
    fun _codeFills(): JsonField<List<String>> = codeFills

    /**
     * Returns the raw JSON value of [codeLengths].
     *
     * Unlike [codeLengths], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("codeLengths")
    @ExcludeMissing
    fun _codeLengths(): JsonField<List<Double>> = codeLengths

    /**
     * Returns the raw JSON value of [codeTaps].
     *
     * Unlike [codeTaps], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("codeTaps")
    @ExcludeMissing
    fun _codeTaps(): JsonField<List<String>> = codeTaps
    ...
    /**
     * Returns the raw JSON value of [confidences].
     *
     * Unlike [confidences], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("confidences")
    @ExcludeMissing
    fun _confidences(): JsonField<List<Double>> = confidences

    /**
     * Returns the raw JSON value of [constellationXPoints].
     *
     * Unlike [constellationXPoints], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("constellationXPoints")
    @ExcludeMissing
    fun _constellationXPoints(): JsonField<List<Double>> = constellationXPoints

    /**
     * Returns the raw JSON value of [constellationYPoints].
     *
     * Unlike [constellationYPoints], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("constellationYPoints")
    @ExcludeMissing
    fun _constellationYPoints(): JsonField<List<Double>> = constellationYPoints
    ...
    /**
     * Returns the raw JSON value of [detectionStatuses].
     *
     * Unlike [detectionStatuses], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("detectionStatuses")
    @ExcludeMissing
    fun _detectionStatuses(): JsonField<List<String>> = detectionStatuses
    ...
    @JsonProperty("eirp")
    @ExcludeMissing
    fun _eirp(): JsonField<Double> = eirp
    ...
    @JsonProperty("elnot")
    @ExcludeMissing
    fun _elnot(): JsonField<String> = elnot
    ...
    @ExcludeMissing
    fun _incoming(): JsonField<Boolean> = incoming
    ...
    @JsonProperty("maxPSD")
    @ExcludeMissing
    fun _maxPsd(): JsonField<Double> = maxPsd
    ...
    @JsonProperty("minPSD")
    @ExcludeMissing
    fun _minPsd(): JsonField<Double> = minPsd
     ...
     *
     * Unlike [nominalBandwidth], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [nominalFrequency], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [nominalPowerOverNoise], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("peak")
    @ExcludeMissing
    fun _peak(): JsonField<Boolean> = peak
    ...
    @JsonProperty("pgri")
    @ExcludeMissing
    fun _pgri(): JsonField<Double> = pgri

    /**
     * Returns the raw JSON value of [pnOrders].
     *
     * Unlike [pnOrders], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("pnOrders")
    @ExcludeMissing
    fun _pnOrders(): JsonField<List<Int>> = pnOrders
    ...
    @ExcludeMissing
    fun _polarity(): JsonField<Double> = polarity
    ...
    @JsonProperty("powers")
    @ExcludeMissing
    fun _powers(): JsonField<List<Double>> = powers
     ...
     *
     * Unlike [relativeCarrierPower], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [relativeNoiseFloor], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [resolutionBandwidth], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    /**
     * Returns the raw JSON value of [signalIds].
     *
     * Unlike [signalIds], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("signalIds")
    @ExcludeMissing
    fun _signalIds(): JsonField<List<String>> = signalIds
    ...
    @JsonProperty("snrs")
    @ExcludeMissing
    fun _snrs(): JsonField<List<Double>> = snrs
     ...
     *
     * Unlike [spectrumAnalyzerPower], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [symbolToNoiseRatio], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    /**
     * Returns the raw JSON value of [telemetryIds].
     *
     * Unlike [telemetryIds], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("telemetryIds")
    @ExcludeMissing
    fun _telemetryIds(): JsonField<List<String>> = telemetryIds
     ...
     *
     * Unlike [transmitFilterRollOff], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [transmitFilterType], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfObservationGetResponse].
         *
    ...
    /** A builder for [RfObservationGetResponse]. */
    class Builder internal constructor() {
        ...
        private var baudRates: JsonField<MutableList<Double>>? = null
        ...
        private var chipRates: JsonField<MutableList<Double>>? = null
        private var codeFills: JsonField<MutableList<String>>? = null
        private var codeLengths: JsonField<MutableList<Double>>? = null
        private var codeTaps: JsonField<MutableList<String>>? = null
        private var collectionMode: JsonField<String> = JsonMissing.of()
        private var confidence: JsonField<Double> = JsonMissing.of()
        private var confidences: JsonField<MutableList<Double>>? = null
        private var constellationXPoints: JsonField<MutableList<Double>>? = null
        private var constellationYPoints: JsonField<MutableList<Double>>? = null
        private var createdAt: JsonField<OffsetDateTime> = JsonMissing.of()
        private var createdBy: JsonField<String> = JsonMissing.of()
        private var descriptor: JsonField<String> = JsonMissing.of()
        private var detectionStatus: JsonField<String> = JsonMissing.of()
        private var detectionStatuses: JsonField<MutableList<String>>? = null
        ...
        private var pnOrders: JsonField<MutableList<Int>>? = null
        ...
        private var signalIds: JsonField<MutableList<String>>? = null
        ...
        private var telemetryIds: JsonField<MutableList<String>>? = null
        ...
        @JvmSynthetic
        internal fun from(rfObservationGetResponse: RfObservationGetResponse) =
            apply {
                classificationMarking = rfObservationGetResponse.classificationMarking
                dataMode = rfObservationGetResponse.dataMode
                obTime = rfObservationGetResponse.obTime
                source = rfObservationGetResponse.source
                type = rfObservationGetResponse.type
                id = rfObservationGetResponse.id
                antennaName = rfObservationGetResponse.antennaName
                azimuth = rfObservationGetResponse.azimuth
                azimuthMeasured = rfObservationGetResponse.azimuthMeasured
                azimuthRate = rfObservationGetResponse.azimuthRate
                azimuthUnc = rfObservationGetResponse.azimuthUnc
                bandwidth = rfObservationGetResponse.bandwidth
                baudRate = rfObservationGetResponse.baudRate
                baudRates = rfObservationGetResponse.baudRates.map { it.toMutableList() }
                bitErrorRate = rfObservationGetResponse.bitErrorRate
                carrierStandard = rfObservationGetResponse.carrierStandard
                channel = rfObservationGetResponse.channel
                chipRates = rfObservationGetResponse.chipRates.map { it.toMutableList() }
                codeFills = rfObservationGetResponse.codeFills.map { it.toMutableList() }
                codeLengths = rfObservationGetResponse.codeLengths.map { it.toMutableList() }
                codeTaps = rfObservationGetResponse.codeTaps.map { it.toMutableList() }
                collectionMode = rfObservationGetResponse.collectionMode
                confidence = rfObservationGetResponse.confidence
                confidences = rfObservationGetResponse.confidences.map { it.toMutableList() }
                constellationXPoints = rfObservationGetResponse.constellationXPoints.map { it.toMutableList() }
                constellationYPoints = rfObservationGetResponse.constellationYPoints.map { it.toMutableList() }
                createdAt = rfObservationGetResponse.createdAt
                createdBy = rfObservationGetResponse.createdBy
                descriptor = rfObservationGetResponse.descriptor
                detectionStatus = rfObservationGetResponse.detectionStatus
                detectionStatuses = rfObservationGetResponse.detectionStatuses.map { it.toMutableList() }
                eirp = rfObservationGetResponse.eirp
                elevation = rfObservationGetResponse.elevation
                elevationMeasured = rfObservationGetResponse.elevationMeasured
                elevationRate = rfObservationGetResponse.elevationRate
                elevationUnc = rfObservationGetResponse.elevationUnc
                elnot = rfObservationGetResponse.elnot
                endFrequency = rfObservationGetResponse.endFrequency
                frequencies = rfObservationGetResponse.frequencies.map { it.toMutableList() }
                frequency = rfObservationGetResponse.frequency
                frequencyShift = rfObservationGetResponse.frequencyShift
                idOnOrbit = rfObservationGetResponse.idOnOrbit
                idSensor = rfObservationGetResponse.idSensor
                incoming = rfObservationGetResponse.incoming
                innerCodingRate = rfObservationGetResponse.innerCodingRate
                maxPsd = rfObservationGetResponse.maxPsd
                minPsd = rfObservationGetResponse.minPsd
                modulation = rfObservationGetResponse.modulation
                noisePwrDensity = rfObservationGetResponse.noisePwrDensity
                nominalBandwidth = rfObservationGetResponse.nominalBandwidth
                nominalEirp = rfObservationGetResponse.nominalEirp
                nominalFrequency = rfObservationGetResponse.nominalFrequency
                nominalPowerOverNoise = rfObservationGetResponse.nominalPowerOverNoise
                nominalSnr = rfObservationGetResponse.nominalSnr
                onOrbit = rfObservationGetResponse.onOrbit
                origin = rfObservationGetResponse.origin
                origNetwork = rfObservationGetResponse.origNetwork
                origObjectId = rfObservationGetResponse.origObjectId
                origSensorId = rfObservationGetResponse.origSensorId
                outerCodingRate = rfObservationGetResponse.outerCodingRate
                peak = rfObservationGetResponse.peak
                pgri = rfObservationGetResponse.pgri
                pnOrders = rfObservationGetResponse.pnOrders.map { it.toMutableList() }
                polarity = rfObservationGetResponse.polarity
                polarityType = rfObservationGetResponse.polarityType
                powerOverNoise = rfObservationGetResponse.powerOverNoise
                powers = rfObservationGetResponse.powers.map { it.toMutableList() }
                range = rfObservationGetResponse.range
                rangeMeasured = rfObservationGetResponse.rangeMeasured
                rangeRate = rfObservationGetResponse.rangeRate
                rangeRateMeasured = rfObservationGetResponse.rangeRateMeasured
                rangeRateUnc = rfObservationGetResponse.rangeRateUnc
                rangeUnc = rfObservationGetResponse.rangeUnc
                rawFileUri = rfObservationGetResponse.rawFileUri
                referenceLevel = rfObservationGetResponse.referenceLevel
                relativeCarrierPower = rfObservationGetResponse.relativeCarrierPower
                relativeNoiseFloor = rfObservationGetResponse.relativeNoiseFloor
                resolutionBandwidth = rfObservationGetResponse.resolutionBandwidth
                satNo = rfObservationGetResponse.satNo
                senalt = rfObservationGetResponse.senalt
                senlat = rfObservationGetResponse.senlat
                senlon = rfObservationGetResponse.senlon
                signalIds = rfObservationGetResponse.signalIds.map { it.toMutableList() }
                snr = rfObservationGetResponse.snr
                snrs = rfObservationGetResponse.snrs.map { it.toMutableList() }
                sourceDl = rfObservationGetResponse.sourceDl
                spectrumAnalyzerPower = rfObservationGetResponse.spectrumAnalyzerPower
                startFrequency = rfObservationGetResponse.startFrequency
                switchPoint = rfObservationGetResponse.switchPoint
                symbolToNoiseRatio = rfObservationGetResponse.symbolToNoiseRatio
                tags = rfObservationGetResponse.tags.map { it.toMutableList() }
                taskId = rfObservationGetResponse.taskId
                telemetryIds = rfObservationGetResponse.telemetryIds.map { it.toMutableList() }
                trackId = rfObservationGetResponse.trackId
                trackRange = rfObservationGetResponse.trackRange
                transactionId = rfObservationGetResponse.transactionId
                transmitFilterRollOff = rfObservationGetResponse.transmitFilterRollOff
                transmitFilterType = rfObservationGetResponse.transmitFilterType
                transponder = rfObservationGetResponse.transponder
                uct = rfObservationGetResponse.uct
                url = rfObservationGetResponse.url
                videoBandwidth = rfObservationGetResponse.videoBandwidth
                additionalProperties = rfObservationGetResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.antennaName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun antennaName(antennaName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.baudRate] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun baudRate(baudRate: JsonField<Double>) =
            apply {
                this.baudRate = baudRate
            }

        /** Array of measured signal baud rates. */
        fun baudRates(baudRates: List<Double>) = baudRates(JsonField.of(baudRates))

        /**
         * Sets [Builder.baudRates] to an arbitrary JSON value.
         *
         * You should usually call [Builder.baudRates] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun baudRates(baudRates: JsonField<List<Double>>) =
            apply {
                this.baudRates = baudRates.map { it.toMutableList() }
            }

        /**
         * Adds a single [Double] to [baudRates].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addBaudRate(baudRate: Double) =
            apply {
                baudRates = (baudRates ?: JsonField.of(mutableListOf())).also {
                    checkKnown("baudRates", it).add(baudRate)
                }
            }
         ...
         *
         * You should usually call [Builder.bitErrorRate] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun bitErrorRate(bitErrorRate: JsonField<Double>) =
            apply {
                this.bitErrorRate = bitErrorRate
            }

        /** Carrier standard (e.g. DVB-S2, 802.11g, etc.). */
        fun carrierStandard(carrierStandard: String) = carrierStandard(JsonField.of(carrierStandard))

        /**
         * Sets [Builder.carrierStandard] to an arbitrary JSON value.
         *
         * You should usually call [Builder.carrierStandard] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun carrierStandard(carrierStandard: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.channel] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun channel(channel: JsonField<Int>) =
            apply {
                this.channel = channel
            }

        /** Array of chipRates. */
        fun chipRates(chipRates: List<Double>) = chipRates(JsonField.of(chipRates))

        /**
         * Sets [Builder.chipRates] to an arbitrary JSON value.
         *
         * You should usually call [Builder.chipRates] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun chipRates(chipRates: JsonField<List<Double>>) =
            apply {
                this.chipRates = chipRates.map { it.toMutableList() }
            }

        /**
         * Adds a single [Double] to [chipRates].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addChipRate(chipRate: Double) =
            apply {
                chipRates = (chipRates ?: JsonField.of(mutableListOf())).also {
                    checkKnown("chipRates", it).add(chipRate)
                }
            }

        /** Array of code fills. */
        fun codeFills(codeFills: List<String>) = codeFills(JsonField.of(codeFills))

        /**
         * Sets [Builder.codeFills] to an arbitrary JSON value.
         *
         * You should usually call [Builder.codeFills] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun codeFills(codeFills: JsonField<List<String>>) =
            apply {
                this.codeFills = codeFills.map { it.toMutableList() }
            }

        /**
         * Adds a single [String] to [codeFills].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCodeFill(codeFill: String) =
            apply {
                codeFills = (codeFills ?: JsonField.of(mutableListOf())).also {
                    checkKnown("codeFills", it).add(codeFill)
                }
            }

        /** Array of code lengths. */
        fun codeLengths(codeLengths: List<Double>) = codeLengths(JsonField.of(codeLengths))

        /**
         * Sets [Builder.codeLengths] to an arbitrary JSON value.
         *
         * You should usually call [Builder.codeLengths] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun codeLengths(codeLengths: JsonField<List<Double>>) =
            apply {
                this.codeLengths = codeLengths.map { it.toMutableList() }
            }

        /**
         * Adds a single [Double] to [codeLengths].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCodeLength(codeLength: Double) =
            apply {
                codeLengths = (codeLengths ?: JsonField.of(mutableListOf())).also {
                    checkKnown("codeLengths", it).add(codeLength)
                }
            }

        /** Array of code taps. */
        fun codeTaps(codeTaps: List<String>) = codeTaps(JsonField.of(codeTaps))

        /**
         * Sets [Builder.codeTaps] to an arbitrary JSON value.
         *
         * You should usually call [Builder.codeTaps] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun codeTaps(codeTaps: JsonField<List<String>>) =
            apply {
                this.codeTaps = codeTaps.map { it.toMutableList() }
            }

        /**
         * Adds a single [String] to [codeTaps].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCodeTap(codeTap: String) =
            apply {
                codeTaps = (codeTaps ?: JsonField.of(mutableListOf())).also {
                    checkKnown("codeTaps", it).add(codeTap)
                }
            }
         ...
         *
         * You should usually call [Builder.confidence] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun confidence(confidence: JsonField<Double>) =
            apply {
                this.confidence = confidence
            }

        /** Array of measurement confidences. */
        fun confidences(confidences: List<Double>) = confidences(JsonField.of(confidences))

        /**
         * Sets [Builder.confidences] to an arbitrary JSON value.
         *
         * You should usually call [Builder.confidences] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun confidences(confidences: JsonField<List<Double>>) =
            apply {
                this.confidences = confidences.map { it.toMutableList() }
            }

        /**
         * Adds a single [Double] to [confidences].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConfidence(confidence: Double) =
            apply {
                confidences = (confidences ?: JsonField.of(mutableListOf())).also {
                    checkKnown("confidences", it).add(confidence)
                }
            }

        /** Array of individual x-coordinates for demodulated signal constellation. This array should correspond with the same-sized array of constellationYPoints. */
        fun constellationXPoints(constellationXPoints: List<Double>) = constellationXPoints(JsonField.of(constellationXPoints))

        /**
         * Sets [Builder.constellationXPoints] to an arbitrary JSON value.
         *
         * You should usually call [Builder.constellationXPoints] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun constellationXPoints(constellationXPoints: JsonField<List<Double>>) =
            apply {
                this.constellationXPoints = constellationXPoints.map { it.toMutableList() }
            }

        /**
         * Adds a single [Double] to [constellationXPoints].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConstellationXPoint(constellationXPoint: Double) =
            apply {
                constellationXPoints = (constellationXPoints ?: JsonField.of(mutableListOf())).also {
                    checkKnown("constellationXPoints", it).add(constellationXPoint)
                }
            }

        /** Array of individual y-coordinates for demodulated signal constellation. This array should correspond with the same-sized array of constellationXPoints. */
        fun constellationYPoints(constellationYPoints: List<Double>) = constellationYPoints(JsonField.of(constellationYPoints))

        /**
         * Sets [Builder.constellationYPoints] to an arbitrary JSON value.
         *
         * You should usually call [Builder.constellationYPoints] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun constellationYPoints(constellationYPoints: JsonField<List<Double>>) =
            apply {
                this.constellationYPoints = constellationYPoints.map { it.toMutableList() }
            }

        /**
         * Adds a single [Double] to [constellationYPoints].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConstellationYPoint(constellationYPoint: Double) =
            apply {
                constellationYPoints = (constellationYPoints ?: JsonField.of(mutableListOf())).also {
                    checkKnown("constellationYPoints", it).add(constellationYPoint)
                }
            }
        ...
        /** Detection status (e.g. DETECTED, CARRIER_ACQUIRING, CARRIER_DETECTED, NOT_DETECTED, etc). */
        fun detectionStatus(detectionStatus: String) = detectionStatus(JsonField.of(detectionStatus))

        /**
         * Sets [Builder.detectionStatus] to an arbitrary JSON value.
         *
         * You should usually call [Builder.detectionStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun detectionStatus(detectionStatus: JsonField<String>) =
            apply {
                this.detectionStatus = detectionStatus
            }

        /** Array of detection statuses (e.g. DETECTED, CARRIER_DETECTED, NOT_DETECTED) for each measured signal. */
        fun detectionStatuses(detectionStatuses: List<String>) = detectionStatuses(JsonField.of(detectionStatuses))

        /**
         * Sets [Builder.detectionStatuses] to an arbitrary JSON value.
         *
         * You should usually call [Builder.detectionStatuses] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun detectionStatuses(detectionStatuses: JsonField<List<String>>) =
            apply {
                this.detectionStatuses = detectionStatuses.map { it.toMutableList() }
            }

        /**
         * Adds a single [String] to [detectionStatuses].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addDetectionStatus(detectionStatus: String) =
            apply {
                detectionStatuses = (detectionStatuses ?: JsonField.of(mutableListOf())).also {
                    checkKnown("detectionStatuses", it).add(detectionStatus)
                }
            }
         ...
         *
         * You should usually call [Builder.eirp] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eirp(eirp: JsonField<Double>) =
            apply {
                this.eirp = eirp
            }
         ...
         *
         * You should usually call [Builder.elnot] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun elnot(elnot: JsonField<String>) =
            apply {
                this.elnot = elnot
            }
         ...
         *
         * You should usually call [Builder.frequencies] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun frequencies(frequencies: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFrequency(frequency: Double) =
            apply {
                frequencies = (frequencies ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.frequencyShift] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun frequencyShift(frequencyShift: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.incoming] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun incoming(incoming: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.innerCodingRate] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun innerCodingRate(innerCodingRate: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.maxPsd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun maxPsd(maxPsd: JsonField<Double>) =
            apply {
                this.maxPsd = maxPsd
            }
         ...
         *
         * You should usually call [Builder.minPsd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun minPsd(minPsd: JsonField<Double>) =
            apply {
                this.minPsd = minPsd
            }
         ...
         *
         * You should usually call [Builder.modulation] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun modulation(modulation: JsonField<String>) =
            apply {
                this.modulation = modulation
            }

        /** Noise power density, in dBW-Hz. */
        fun noisePwrDensity(noisePwrDensity: Double) = noisePwrDensity(JsonField.of(noisePwrDensity))

        /**
         * Sets [Builder.noisePwrDensity] to an arbitrary JSON value.
         *
         * You should usually call [Builder.noisePwrDensity] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun noisePwrDensity(noisePwrDensity: JsonField<Double>) =
            apply {
                this.noisePwrDensity = noisePwrDensity
            }

        /** Expected bandwidth in Hz. */
        fun nominalBandwidth(nominalBandwidth: Double) = nominalBandwidth(JsonField.of(nominalBandwidth))

        /**
         * Sets [Builder.nominalBandwidth] to an arbitrary JSON value.
         *
         * You should usually call [Builder.nominalBandwidth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nominalBandwidth(nominalBandwidth: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.nominalEirp] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nominalEirp(nominalEirp: JsonField<Double>) =
            apply {
                this.nominalEirp = nominalEirp
            }

        /** Nominal or expected center carrier frequency in Hz. */
        fun nominalFrequency(nominalFrequency: Double) = nominalFrequency(JsonField.of(nominalFrequency))

        /**
         * Sets [Builder.nominalFrequency] to an arbitrary JSON value.
         *
         * You should usually call [Builder.nominalFrequency] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nominalFrequency(nominalFrequency: JsonField<Double>) =
            apply {
                this.nominalFrequency = nominalFrequency
            }

        /** Expected carrier power over noise (dBW/Hz). */
        fun nominalPowerOverNoise(nominalPowerOverNoise: Double) = nominalPowerOverNoise(JsonField.of(nominalPowerOverNoise))

        /**
         * Sets [Builder.nominalPowerOverNoise] to an arbitrary JSON value.
         *
         * You should usually call [Builder.nominalPowerOverNoise] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nominalPowerOverNoise(nominalPowerOverNoise: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.nominalSnr] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nominalSnr(nominalSnr: JsonField<Double>) =
            apply {
                this.nominalSnr = nominalSnr
            }
         ...
         *
         * You should usually call [Builder.outerCodingRate] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun outerCodingRate(outerCodingRate: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.peak] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun peak(peak: JsonField<Boolean>) =
            apply {
                this.peak = peak
            }
         ...
         *
         * You should usually call [Builder.pgri] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pgri(pgri: JsonField<Double>) =
            apply {
                this.pgri = pgri
            }

        /** Array of pnOrder. */
        fun pnOrders(pnOrders: List<Int>) = pnOrders(JsonField.of(pnOrders))

        /**
         * Sets [Builder.pnOrders] to an arbitrary JSON value.
         *
         * You should usually call [Builder.pnOrders] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pnOrders(pnOrders: JsonField<List<Int>>) =
            apply {
                this.pnOrders = pnOrders.map { it.toMutableList() }
            }

        /**
         * Adds a single [Int] to [pnOrders].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPnOrder(pnOrder: Int) =
            apply {
                pnOrders = (pnOrders ?: JsonField.of(mutableListOf())).also {
                    checkKnown("pnOrders", it).add(pnOrder)
                }
            }
         ...
         *
         * You should usually call [Builder.polarity] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarity(polarity: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.polarityType] with a well-typed [PolarityType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarityType(polarityType: JsonField<PolarityType>) =
            apply {
         ...
         *
         * You should usually call [Builder.powerOverNoise] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun powerOverNoise(powerOverNoise: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.powers] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun powers(powers: JsonField<List<Double>>) =
            apply {
        ...
        fun addPower(power: Double) =
            apply {
                powers = (powers ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.referenceLevel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun referenceLevel(referenceLevel: JsonField<Double>) =
            apply {
                this.referenceLevel = referenceLevel
            }

        /** Measured power of the center carrier frequency in dBW. */
        fun relativeCarrierPower(relativeCarrierPower: Double) = relativeCarrierPower(JsonField.of(relativeCarrierPower))

        /**
         * Sets [Builder.relativeCarrierPower] to an arbitrary JSON value.
         *
         * You should usually call [Builder.relativeCarrierPower] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relativeCarrierPower(relativeCarrierPower: JsonField<Double>) =
            apply {
                this.relativeCarrierPower = relativeCarrierPower
            }

        /** The measure of the signal created from the sum of all the noise sources and unwanted signals within the measurement system, in dBW. */
        fun relativeNoiseFloor(relativeNoiseFloor: Double) = relativeNoiseFloor(JsonField.of(relativeNoiseFloor))

        /**
         * Sets [Builder.relativeNoiseFloor] to an arbitrary JSON value.
         *
         * You should usually call [Builder.relativeNoiseFloor] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun relativeNoiseFloor(relativeNoiseFloor: JsonField<Double>) =
            apply {
                this.relativeNoiseFloor = relativeNoiseFloor
            }

        /** Resolution bandwidth in Hz. */
        fun resolutionBandwidth(resolutionBandwidth: Double) = resolutionBandwidth(JsonField.of(resolutionBandwidth))

        /**
         * Sets [Builder.resolutionBandwidth] to an arbitrary JSON value.
         *
         * You should usually call [Builder.resolutionBandwidth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resolutionBandwidth(resolutionBandwidth: JsonField<Double>) =
            apply {
        ...
        /** Array of optional source provided identifiers of the measurements/signals. */
        fun signalIds(signalIds: List<String>) = signalIds(JsonField.of(signalIds))

        /**
         * Sets [Builder.signalIds] to an arbitrary JSON value.
         *
         * You should usually call [Builder.signalIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun signalIds(signalIds: JsonField<List<String>>) =
            apply {
                this.signalIds = signalIds.map { it.toMutableList() }
            }

        /**
         * Adds a single [String] to [signalIds].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSignalId(signalId: String) =
            apply {
                signalIds = (signalIds ?: JsonField.of(mutableListOf())).also {
                    checkKnown("signalIds", it).add(signalId)
                }
            }
         ...
         *
         * You should usually call [Builder.snrs] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun snrs(snrs: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSnr(snr: Double) =
            apply {
                snrs = (snrs ?: JsonField.of(mutableListOf())).also {
                    checkKnown("snrs", it).add(snr)
                }
            }
        ...
        /** Measured spectrum analyzer power of the center carrier frequency in dBW. */
        fun spectrumAnalyzerPower(spectrumAnalyzerPower: Double) = spectrumAnalyzerPower(JsonField.of(spectrumAnalyzerPower))

        /**
         * Sets [Builder.spectrumAnalyzerPower] to an arbitrary JSON value.
         *
         * You should usually call [Builder.spectrumAnalyzerPower] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spectrumAnalyzerPower(spectrumAnalyzerPower: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.switchPoint] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun switchPoint(switchPoint: JsonField<Int>) =
            apply {
                this.switchPoint = switchPoint
            }

        /** Symbol to noise ratio, in dB. */
        fun symbolToNoiseRatio(symbolToNoiseRatio: Double) = symbolToNoiseRatio(JsonField.of(symbolToNoiseRatio))

        /**
         * Sets [Builder.symbolToNoiseRatio] to an arbitrary JSON value.
         *
         * You should usually call [Builder.symbolToNoiseRatio] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun symbolToNoiseRatio(symbolToNoiseRatio: JsonField<Double>) =
            apply {
        ...
        /** Array of optional source provided telemetry identifiers of the measurements/signals. */
        fun telemetryIds(telemetryIds: List<String>) = telemetryIds(JsonField.of(telemetryIds))

        /**
         * Sets [Builder.telemetryIds] to an arbitrary JSON value.
         *
         * You should usually call [Builder.telemetryIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun telemetryIds(telemetryIds: JsonField<List<String>>) =
            apply {
                this.telemetryIds = telemetryIds.map { it.toMutableList() }
            }

        /**
         * Adds a single [String] to [telemetryIds].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTelemetryId(telemetryId: String) =
            apply {
                telemetryIds = (telemetryIds ?: JsonField.of(mutableListOf())).also {
                    checkKnown("telemetryIds", it).add(telemetryId)
                }
            }
         ...
         *
         * You should usually call [Builder.trackRange] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trackRange(trackRange: JsonField<Double>) =
            apply {
        ...
        /** Transmit pulse shaping filter roll-off value. */
        fun transmitFilterRollOff(transmitFilterRollOff: Double) = transmitFilterRollOff(JsonField.of(transmitFilterRollOff))

        /**
         * Sets [Builder.transmitFilterRollOff] to an arbitrary JSON value.
         *
         * You should usually call [Builder.transmitFilterRollOff] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transmitFilterRollOff(transmitFilterRollOff: JsonField<Double>) =
            apply {
                this.transmitFilterRollOff = transmitFilterRollOff
            }

        /** Transmit pulse shaping filter typ (e.g. RRC). */
        fun transmitFilterType(transmitFilterType: String) = transmitFilterType(JsonField.of(transmitFilterType))

        /**
         * Sets [Builder.transmitFilterType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.transmitFilterType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transmitFilterType(transmitFilterType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.transponder] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transponder(transponder: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.videoBandwidth] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun videoBandwidth(videoBandwidth: JsonField<Double>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [RfObservationGetResponse].
         *
         ...
         */
        fun build(): RfObservationGetResponse =
            RfObservationGetResponse(
              ...
              bandwidth,
              baudRate,
              (baudRates ?: JsonMissing.of()).map { it.toImmutable() },
              bitErrorRate,
              carrierStandard,
              channel,
              (chipRates ?: JsonMissing.of()).map { it.toImmutable() },
              (codeFills ?: JsonMissing.of()).map { it.toImmutable() },
              (codeLengths ?: JsonMissing.of()).map { it.toImmutable() },
              (codeTaps ?: JsonMissing.of()).map { it.toImmutable() },
              collectionMode,
              confidence,
              (confidences ?: JsonMissing.of()).map { it.toImmutable() },
              (constellationXPoints ?: JsonMissing.of()).map { it.toImmutable() },
              (constellationYPoints ?: JsonMissing.of()).map { it.toImmutable() },
              createdAt,
              createdBy,
              descriptor,
              detectionStatus,
              (detectionStatuses ?: JsonMissing.of()).map { it.toImmutable() },
              eirp,
              elevation,
              elevationMeasured,
              elevationRate,
              ...
              peak,
              pgri,
              (pnOrders ?: JsonMissing.of()).map { it.toImmutable() },
              polarity,
              polarityType,
              powerOverNoise,
              ...
              senlat,
              senlon,
              (signalIds ?: JsonMissing.of()).map { it.toImmutable() },
              snr,
              ...
              taskId,
              (telemetryIds ?: JsonMissing.of()).map { it.toImmutable() },
              trackId,
              trackRange,
              transactionId,
              transmitFilterRollOff,
    ...
    fun validate(): RfObservationGetResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (obTime.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (antennaName.asKnown().isPresent) 1 else 0) + (if (azimuth.asKnown().isPresent) 1 else 0) + (if (azimuthMeasured.asKnown().isPresent) 1 else 0) + (if (azimuthRate.asKnown().isPresent) 1 else 0) + (if (azimuthUnc.asKnown().isPresent) 1 else 0) + (if (bandwidth.asKnown().isPresent) 1 else 0) + (if (baudRate.asKnown().isPresent) 1 else 0) + (baudRates.asKnown().getOrNull()?.size ?: 0) + (if (bitErrorRate.asKnown().isPresent) 1 else 0) + (if (carrierStandard.asKnown().isPresent) 1 else 0) + (if (channel.asKnown().isPresent) 1 else 0) + (chipRates.asKnown().getOrNull()?.size ?: 0) + (codeFills.asKnown().getOrNull()?.size ?: 0) + (codeLengths.asKnown().getOrNull()?.size ?: 0) + (codeTaps.asKnown().getOrNull()?.size ?: 0) + (if (collectionMode.asKnown().isPresent) 1 else 0) + (if (confidence.asKnown().isPresent) 1 else 0) + (confidences.asKnown().getOrNull()?.size ?: 0) + (constellationXPoints.asKnown().getOrNull()?.size ?: 0) + (constellationYPoints.asKnown().getOrNull()?.size ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (detectionStatus.asKnown().isPresent) 1 else 0) + (detectionStatuses.asKnown().getOrNull()?.size ?: 0) + (if (eirp.asKnown().isPresent) 1 else 0) + (if (elevation.asKnown().isPresent) 1 else 0) + (if (elevationMeasured.asKnown().isPresent) 1 else 0) + (if (elevationRate.asKnown().isPresent) 1 else 0) + (if (elevationUnc.asKnown().isPresent) 1 else 0) + (if (elnot.asKnown().isPresent) 1 else 0) + (if (endFrequency.asKnown().isPresent) 1 else 0) + (frequencies.asKnown().getOrNull()?.size ?: 0) + (if (frequency.asKnown().isPresent) 1 else 0) + (if (frequencyShift.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (incoming.asKnown().isPresent) 1 else 0) + (if (innerCodingRate.asKnown().isPresent) 1 else 0) + (if (maxPsd.asKnown().isPresent) 1 else 0) + (if (minPsd.asKnown().isPresent) 1 else 0) + (if (modulation.asKnown().isPresent) 1 else 0) + (if (noisePwrDensity.asKnown().isPresent) 1 else 0) + (if (nominalBandwidth.asKnown().isPresent) 1 else 0) + (if (nominalEirp.asKnown().isPresent) 1 else 0) + (if (nominalFrequency.asKnown().isPresent) 1 else 0) + (if (nominalPowerOverNoise.asKnown().isPresent) 1 else 0) + (if (nominalSnr.asKnown().isPresent) 1 else 0) + (onOrbit.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (outerCodingRate.asKnown().isPresent) 1 else 0) + (if (peak.asKnown().isPresent) 1 else 0) + (if (pgri.asKnown().isPresent) 1 else 0) + (pnOrders.asKnown().getOrNull()?.size ?: 0) + (if (polarity.asKnown().isPresent) 1 else 0) + (polarityType.asKnown().getOrNull()?.validity() ?: 0) + (if (powerOverNoise.asKnown().isPresent) 1 else 0) + (powers.asKnown().getOrNull()?.size ?: 0) + (if (range.asKnown().isPresent) 1 else 0) + (if (rangeMeasured.asKnown().isPresent) 1 else 0) + (if (rangeRate.asKnown().isPresent) 1 else 0) + (if (rangeRateMeasured.asKnown().isPresent) 1 else 0) + (if (rangeRateUnc.asKnown().isPresent) 1 else 0) + (if (rangeUnc.asKnown().isPresent) 1 else 0) + (if (rawFileUri.asKnown().isPresent) 1 else 0) + (if (referenceLevel.asKnown().isPresent) 1 else 0) + (if (relativeCarrierPower.asKnown().isPresent) 1 else 0) + (if (relativeNoiseFloor.asKnown().isPresent) 1 else 0) + (if (resolutionBandwidth.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlat.asKnown().isPresent) 1 else 0) + (if (senlon.asKnown().isPresent) 1 else 0) + (signalIds.asKnown().getOrNull()?.size ?: 0) + (if (snr.asKnown().isPresent) 1 else 0) + (snrs.asKnown().getOrNull()?.size ?: 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (spectrumAnalyzerPower.asKnown().isPresent) 1 else 0) + (if (startFrequency.asKnown().isPresent) 1 else 0) + (if (switchPoint.asKnown().isPresent) 1 else 0) + (if (symbolToNoiseRatio.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (taskId.asKnown().isPresent) 1 else 0) + (telemetryIds.asKnown().getOrNull()?.size ?: 0) + (if (trackId.asKnown().isPresent) 1 else 0) + (if (trackRange.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (transmitFilterRollOff.asKnown().isPresent) 1 else 0) + (if (transmitFilterType.asKnown().isPresent) 1 else 0) + (if (transponder.asKnown().isPresent) 1 else 0) + (if (uct.asKnown().isPresent) 1 else 0) + (if (url.asKnown().isPresent) 1 else 0) + (if (videoBandwidth.asKnown().isPresent) 1 else 0)
    ...
    /** Transponder polarization e.g. H - (Horizontally Polarized) Perpendicular to Earth's surface, V - (Vertically Polarized) Parallel to Earth's surface, L - (Left Hand Circularly Polarized) Rotating left relative to the earth's surface, R - (Right Hand Circularly Polarized) Rotating right relative to the earth's surface. */
    class PolarityType @JsonCreator private constructor(
        private val value: JsonField<String>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfObservationGetResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && obTime == other.obTime && source == other.source && type == other.type && id == other.id && antennaName == other.antennaName && azimuth == other.azimuth && azimuthMeasured == other.azimuthMeasured && azimuthRate == other.azimuthRate && azimuthUnc == other.azimuthUnc && bandwidth == other.bandwidth && baudRate == other.baudRate && baudRates == other.baudRates && bitErrorRate == other.bitErrorRate && carrierStandard == other.carrierStandard && channel == other.channel && chipRates == other.chipRates && codeFills == other.codeFills && codeLengths == other.codeLengths && codeTaps == other.codeTaps && collectionMode == other.collectionMode && confidence == other.confidence && confidences == other.confidences && constellationXPoints == other.constellationXPoints && constellationYPoints == other.constellationYPoints && createdAt == other.createdAt && createdBy == other.createdBy && descriptor == other.descriptor && detectionStatus == other.detectionStatus && detectionStatuses == other.detectionStatuses && eirp == other.eirp && elevation == other.elevation && elevationMeasured == other.elevationMeasured && elevationRate == other.elevationRate && elevationUnc == other.elevationUnc && elnot == other.elnot && endFrequency == other.endFrequency && frequencies == other.frequencies && frequency == other.frequency && frequencyShift == other.frequencyShift && idOnOrbit == other.idOnOrbit && idSensor == other.idSensor && incoming == other.incoming && innerCodingRate == other.innerCodingRate && maxPsd == other.maxPsd && minPsd == other.minPsd && modulation == other.modulation && noisePwrDensity == other.noisePwrDensity && nominalBandwidth == other.nominalBandwidth && nominalEirp == other.nominalEirp && nominalFrequency == other.nominalFrequency && nominalPowerOverNoise == other.nominalPowerOverNoise && nominalSnr == other.nominalSnr && onOrbit == other.onOrbit && origin == other.origin && origNetwork == other.origNetwork && origObjectId == other.origObjectId && origSensorId == other.origSensorId && outerCodingRate == other.outerCodingRate && peak == other.peak && pgri == other.pgri && pnOrders == other.pnOrders && polarity == other.polarity && polarityType == other.polarityType && powerOverNoise == other.powerOverNoise && powers == other.powers && range == other.range && rangeMeasured == other.rangeMeasured && rangeRate == other.rangeRate && rangeRateMeasured == other.rangeRateMeasured && rangeRateUnc == other.rangeRateUnc && rangeUnc == other.rangeUnc && rawFileUri == other.rawFileUri && referenceLevel == other.referenceLevel && relativeCarrierPower == other.relativeCarrierPower && relativeNoiseFloor == other.relativeNoiseFloor && resolutionBandwidth == other.resolutionBandwidth && satNo == other.satNo && senalt == other.senalt && senlat == other.senlat && senlon == other.senlon && signalIds == other.signalIds && snr == other.snr && snrs == other.snrs && sourceDl == other.sourceDl && spectrumAnalyzerPower == other.spectrumAnalyzerPower && startFrequency == other.startFrequency && switchPoint == other.switchPoint && symbolToNoiseRatio == other.symbolToNoiseRatio && tags == other.tags && taskId == other.taskId && telemetryIds == other.telemetryIds && trackId == other.trackId && trackRange == other.trackRange && transactionId == other.transactionId && transmitFilterRollOff == other.transmitFilterRollOff && transmitFilterType == other.transmitFilterType && transponder == other.transponder && uct == other.uct && url == other.url && videoBandwidth == other.videoBandwidth && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, obTime, source, type, id, antennaName, azimuth, azimuthMeasured, azimuthRate, azimuthUnc, bandwidth, baudRate, baudRates, bitErrorRate, carrierStandard, channel, chipRates, codeFills, codeLengths, codeTaps, collectionMode, confidence, confidences, constellationXPoints, constellationYPoints, createdAt, createdBy, descriptor, detectionStatus, detectionStatuses, eirp, elevation, elevationMeasured, elevationRate, elevationUnc, elnot, endFrequency, frequencies, frequency, frequencyShift, idOnOrbit, idSensor, incoming, innerCodingRate, maxPsd, minPsd, modulation, noisePwrDensity, nominalBandwidth, nominalEirp, nominalFrequency, nominalPowerOverNoise, nominalSnr, onOrbit, origin, origNetwork, origObjectId, origSensorId, outerCodingRate, peak, pgri, pnOrders, polarity, polarityType, powerOverNoise, powers, range, rangeMeasured, rangeRate, rangeRateMeasured, rangeRateUnc, rangeUnc, rawFileUri, referenceLevel, relativeCarrierPower, relativeNoiseFloor, resolutionBandwidth, satNo, senalt, senlat, senlon, signalIds, snr, snrs, sourceDl, spectrumAnalyzerPower, startFrequency, switchPoint, symbolToNoiseRatio, tags, taskId, telemetryIds, trackId, trackRange, transactionId, transmitFilterRollOff, transmitFilterType, transponder, uct, url, videoBandwidth, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "RfObservationGetResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, obTime=$obTime, source=$source, type=$type, id=$id, antennaName=$antennaName, azimuth=$azimuth, azimuthMeasured=$azimuthMeasured, azimuthRate=$azimuthRate, azimuthUnc=$azimuthUnc, bandwidth=$bandwidth, baudRate=$baudRate, baudRates=$baudRates, bitErrorRate=$bitErrorRate, carrierStandard=$carrierStandard, channel=$channel, chipRates=$chipRates, codeFills=$codeFills, codeLengths=$codeLengths, codeTaps=$codeTaps, collectionMode=$collectionMode, confidence=$confidence, confidences=$confidences, constellationXPoints=$constellationXPoints, constellationYPoints=$constellationYPoints, createdAt=$createdAt, createdBy=$createdBy, descriptor=$descriptor, detectionStatus=$detectionStatus, detectionStatuses=$detectionStatuses, eirp=$eirp, elevation=$elevation, elevationMeasured=$elevationMeasured, elevationRate=$elevationRate, elevationUnc=$elevationUnc, elnot=$elnot, endFrequency=$endFrequency, frequencies=$frequencies, frequency=$frequency, frequencyShift=$frequencyShift, idOnOrbit=$idOnOrbit, idSensor=$idSensor, incoming=$incoming, innerCodingRate=$innerCodingRate, maxPsd=$maxPsd, minPsd=$minPsd, modulation=$modulation, noisePwrDensity=$noisePwrDensity, nominalBandwidth=$nominalBandwidth, nominalEirp=$nominalEirp, nominalFrequency=$nominalFrequency, nominalPowerOverNoise=$nominalPowerOverNoise, nominalSnr=$nominalSnr, onOrbit=$onOrbit, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, origSensorId=$origSensorId, outerCodingRate=$outerCodingRate, peak=$peak, pgri=$pgri, pnOrders=$pnOrders, polarity=$polarity, polarityType=$polarityType, powerOverNoise=$powerOverNoise, powers=$powers, range=$range, rangeMeasured=$rangeMeasured, rangeRate=$rangeRate, rangeRateMeasured=$rangeRateMeasured, rangeRateUnc=$rangeRateUnc, rangeUnc=$rangeUnc, rawFileUri=$rawFileUri, referenceLevel=$referenceLevel, relativeCarrierPower=$relativeCarrierPower, relativeNoiseFloor=$relativeNoiseFloor, resolutionBandwidth=$resolutionBandwidth, satNo=$satNo, senalt=$senalt, senlat=$senlat, senlon=$senlon, signalIds=$signalIds, snr=$snr, snrs=$snrs, sourceDl=$sourceDl, spectrumAnalyzerPower=$spectrumAnalyzerPower, startFrequency=$startFrequency, switchPoint=$switchPoint, symbolToNoiseRatio=$symbolToNoiseRatio, tags=$tags, taskId=$taskId, telemetryIds=$telemetryIds, trackId=$trackId, trackRange=$trackRange, transactionId=$transactionId, transmitFilterRollOff=$transmitFilterRollOff, transmitFilterType=$transmitFilterType, transponder=$transponder, uct=$uct, url=$url, videoBandwidth=$videoBandwidth, additionalProperties=$additionalProperties}"
}
