 ...
 */
class RfObservationGetResponse
...
private constructor(
    ...
    private val fftImagCoeffs: JsonField<List<Double>>,
    private val fftRealCoeffs: JsonField<List<Double>>,
    ...
    private val jamBands: JsonField<List<String>>,
    private val jamToSigRatios: JsonField<List<Double>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        baudRates: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        chipRates: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("codeFills")
        @ExcludeMissing
        codeFills: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("codeLengths")
        @ExcludeMissing
        codeLengths: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("codeTaps")
        @ExcludeMissing
        codeTaps: JsonField<List<String>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        confidences: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("constellationXPoints")
        @ExcludeMissing
        constellationXPoints: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("constellationYPoints")
        @ExcludeMissing
        constellationYPoints: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        detectionStatuses: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("fftImagCoeffs")
        @ExcludeMissing
        fftImagCoeffs: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("fftRealCoeffs")
        @ExcludeMissing
        fftRealCoeffs: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("jamBands")
        @ExcludeMissing
        jamBands: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("jamToSigRatios")
        @ExcludeMissing
        jamToSigRatios: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        signalIds: JsonField<List<String>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        telemetryIds: JsonField<List<String>> = JsonMissing.of(),
    ...
    /**
     * Collection mode (e.g. CONTINUOUS, MANUAL, NEIGHBORHOOD_WATCH, DIRECTED_SEARCH, SPOT_SEARCH,
     * SURVEY, etc).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Array of individual x-coordinates for demodulated signal constellation. This array should
     * correspond with the same-sized array of constellationYPoints.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun constellationXPoints(): Optional<List<Double>> =
        constellationXPoints.getOptional("constellationXPoints")

    /**
     * Array of individual y-coordinates for demodulated signal constellation. This array should
     * correspond with the same-sized array of constellationXPoints.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun constellationYPoints(): Optional<List<Double>> =
        constellationYPoints.getOptional("constellationYPoints")
    ...
    /**
     * Array of detection statuses (e.g. CARRIER_DETECTED, DETECTED, NOT_DETECTED) for each measured
     * signal.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun detectionStatuses(): Optional<List<String>> =
        detectionStatuses.getOptional("detectionStatuses")
    ...
    /**
     * Array of imaginary components of the complex Fast Fourier Transform (FFT) coefficients from
     * the signal. Used together with the same-sized fftRealCoeffs array to preserve both amplitude
     * and phase information. This array should correspond with the same-sized array of frequencies.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun fftImagCoeffs(): Optional<List<Double>> = fftImagCoeffs.getOptional("fftImagCoeffs")

    /**
     * Array of real components of the complex Fast Fourier Transform (FFT) coefficients from the
     * signal. Used together with the same-sized fftImagCoeffs array to preserve both amplitude and
     * phase information. This array should correspond with the same-sized array of frequencies.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun fftRealCoeffs(): Optional<List<Double>> = fftRealCoeffs.getOptional("fftRealCoeffs")

    /**
     * Array of individual PSD frequencies of the signal in hertz. This array should correspond with
     * the same-sized array of powers.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Array of frequency bands experiencing jamming or intentional interference. This array must be
     * the same length as jamToSigRatios.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun jamBands(): Optional<List<String>> = jamBands.getOptional("jamBands")

    /**
     * Array of jamming-to-signal power ratios at the receiver for the specified jamBands, in
     * decibels. The values in this array must correspond to the position index in jamBands. This
     * array must be the same length as jamBands.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun jamToSigRatios(): Optional<List<Double>> = jamToSigRatios.getOptional("jamToSigRatios")
     ...
     * closely spaced pulses separated by much longer times between these pulse groups. The PGRI is
     * measured in seconds.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Array of individual measured PSD powers of the signal in decibel watts. This array should
     ...
     * within the measurement system, in decibel watts.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     */
    @JsonProperty("baudRates") @ExcludeMissing fun _baudRates(): JsonField<List<Double>> = baudRates
     ...
     */
    @JsonProperty("chipRates") @ExcludeMissing fun _chipRates(): JsonField<List<Double>> = chipRates
     ...
     */
    @JsonProperty("codeFills") @ExcludeMissing fun _codeFills(): JsonField<List<String>> = codeFills
     ...
     */
    @JsonProperty("codeTaps") @ExcludeMissing fun _codeTaps(): JsonField<List<String>> = codeTaps
     ...
     *
     * Unlike [constellationXPoints], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("constellationXPoints")
    @ExcludeMissing
     ...
     *
     * Unlike [constellationYPoints], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("constellationYPoints")
    @ExcludeMissing
     ...
     *
     * Unlike [detectionStatuses], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("detectionStatuses")
    @ExcludeMissing
    ...
    /**
     * Returns the raw JSON value of [fftImagCoeffs].
     *
     * Unlike [fftImagCoeffs], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("fftImagCoeffs")
    @ExcludeMissing
    fun _fftImagCoeffs(): JsonField<List<Double>> = fftImagCoeffs

    /**
     * Returns the raw JSON value of [fftRealCoeffs].
     *
     * Unlike [fftRealCoeffs], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("fftRealCoeffs")
    @ExcludeMissing
    fun _fftRealCoeffs(): JsonField<List<Double>> = fftRealCoeffs
    ...
    /**
     * Returns the raw JSON value of [jamBands].
     *
     * Unlike [jamBands], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("jamBands") @ExcludeMissing fun _jamBands(): JsonField<List<String>> = jamBands

    /**
     * Returns the raw JSON value of [jamToSigRatios].
     *
     * Unlike [jamToSigRatios], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("jamToSigRatios")
    @ExcludeMissing
    fun _jamToSigRatios(): JsonField<List<Double>> = jamToSigRatios
     ...
     */
    @JsonProperty("pnOrders") @ExcludeMissing fun _pnOrders(): JsonField<List<Int>> = pnOrders
     ...
     */
    @JsonProperty("signalIds") @ExcludeMissing fun _signalIds(): JsonField<List<String>> = signalIds
    ...
    class Builder internal constructor() {
        ...
        private var fftImagCoeffs: JsonField<MutableList<Double>>? = null
        private var fftRealCoeffs: JsonField<MutableList<Double>>? = null
        ...
        private var jamBands: JsonField<MutableList<String>>? = null
        private var jamToSigRatios: JsonField<MutableList<Double>>? = null
        ...
        @JvmSynthetic
        internal fun from(rfObservationGetResponse: RfObservationGetResponse) = apply {
            ...
            constellationXPoints =
                rfObservationGetResponse.constellationXPoints.map { it.toMutableList() }
            constellationYPoints =
                rfObservationGetResponse.constellationYPoints.map { it.toMutableList() }
            ...
            detectionStatuses =
                rfObservationGetResponse.detectionStatuses.map { it.toMutableList() }
            ...
            fftImagCoeffs = rfObservationGetResponse.fftImagCoeffs.map { it.toMutableList() }
            fftRealCoeffs = rfObservationGetResponse.fftRealCoeffs.map { it.toMutableList() }
            ...
            jamBands = rfObservationGetResponse.jamBands.map { it.toMutableList() }
            jamToSigRatios = rfObservationGetResponse.jamToSigRatios.map { it.toMutableList() }
            ...
            origCountry = rfObservationGetResponse.origCountry
            origin = rfObservationGetResponse.origin
            origMarking = rfObservationGetResponse.origMarking
         ...
         *
         * You should usually call [Builder.baudRates] with a well-typed `List<Double>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun baudRates(baudRates: JsonField<List<Double>>) = apply {
         ...
         */
        fun addBaudRate(baudRate: Double) = apply {
            baudRates =
                (baudRates ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.chipRates] with a well-typed `List<Double>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun chipRates(chipRates: JsonField<List<Double>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addChipRate(chipRate: Double) = apply {
            chipRates =
                (chipRates ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.codeFills] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun codeFills(codeFills: JsonField<List<String>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCodeFill(codeFill: String) = apply {
            codeFills =
                (codeFills ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.codeLengths] with a well-typed `List<Double>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun codeLengths(codeLengths: JsonField<List<Double>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCodeLength(codeLength: Double) = apply {
            codeLengths =
                (codeLengths ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.codeTaps] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun codeTaps(codeTaps: JsonField<List<String>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCodeTap(codeTap: String) = apply {
            codeTaps =
                (codeTaps ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.confidences] with a well-typed `List<Double>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun confidences(confidences: JsonField<List<Double>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConfidence(confidence: Double) = apply {
            confidences =
                (confidences ?: JsonField.of(mutableListOf())).also {
         ...
         * correspond with the same-sized array of constellationYPoints.
         */
        fun constellationXPoints(constellationXPoints: List<Double>) =
            constellationXPoints(JsonField.of(constellationXPoints))

        /**
         * Sets [Builder.constellationXPoints] to an arbitrary JSON value.
         *
         * You should usually call [Builder.constellationXPoints] with a well-typed `List<Double>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun constellationXPoints(constellationXPoints: JsonField<List<Double>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConstellationXPoint(constellationXPoint: Double) = apply {
            constellationXPoints =
                (constellationXPoints ?: JsonField.of(mutableListOf())).also {
         ...
         * correspond with the same-sized array of constellationXPoints.
         */
        fun constellationYPoints(constellationYPoints: List<Double>) =
            constellationYPoints(JsonField.of(constellationYPoints))

        /**
         * Sets [Builder.constellationYPoints] to an arbitrary JSON value.
         *
         * You should usually call [Builder.constellationYPoints] with a well-typed `List<Double>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun constellationYPoints(constellationYPoints: JsonField<List<Double>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConstellationYPoint(constellationYPoint: Double) = apply {
            constellationYPoints =
                (constellationYPoints ?: JsonField.of(mutableListOf())).also {
        ...
        /**
         * Array of detection statuses (e.g. CARRIER_DETECTED, DETECTED, NOT_DETECTED) for each
         * measured signal.
         */
        fun detectionStatuses(detectionStatuses: List<String>) =
            detectionStatuses(JsonField.of(detectionStatuses))

        /**
         * Sets [Builder.detectionStatuses] to an arbitrary JSON value.
         *
         * You should usually call [Builder.detectionStatuses] with a well-typed `List<String>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun detectionStatuses(detectionStatuses: JsonField<List<String>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addDetectionStatus(detectionStatus: String) = apply {
            detectionStatuses =
                (detectionStatuses ?: JsonField.of(mutableListOf())).also {
        ...
        /**
         * Array of imaginary components of the complex Fast Fourier Transform (FFT) coefficients
         * from the signal. Used together with the same-sized fftRealCoeffs array to preserve both
         * amplitude and phase information. This array should correspond with the same-sized array
         * of frequencies.
         */
        fun fftImagCoeffs(fftImagCoeffs: List<Double>) = fftImagCoeffs(JsonField.of(fftImagCoeffs))

        /**
         * Sets [Builder.fftImagCoeffs] to an arbitrary JSON value.
         *
         * You should usually call [Builder.fftImagCoeffs] with a well-typed `List<Double>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fftImagCoeffs(fftImagCoeffs: JsonField<List<Double>>) = apply {
            this.fftImagCoeffs = fftImagCoeffs.map { it.toMutableList() }
        }

        /**
         * Adds a single [Double] to [fftImagCoeffs].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFftImagCoeff(fftImagCoeff: Double) = apply {
            fftImagCoeffs =
                (fftImagCoeffs ?: JsonField.of(mutableListOf())).also {
                    checkKnown("fftImagCoeffs", it).add(fftImagCoeff)
                }
        }

        /**
         * Array of real components of the complex Fast Fourier Transform (FFT) coefficients from
         * the signal. Used together with the same-sized fftImagCoeffs array to preserve both
         * amplitude and phase information. This array should correspond with the same-sized array
         * of frequencies.
         */
        fun fftRealCoeffs(fftRealCoeffs: List<Double>) = fftRealCoeffs(JsonField.of(fftRealCoeffs))

        /**
         * Sets [Builder.fftRealCoeffs] to an arbitrary JSON value.
         *
         * You should usually call [Builder.fftRealCoeffs] with a well-typed `List<Double>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fftRealCoeffs(fftRealCoeffs: JsonField<List<Double>>) = apply {
            this.fftRealCoeffs = fftRealCoeffs.map { it.toMutableList() }
        }

        /**
         * Adds a single [Double] to [fftRealCoeffs].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFftRealCoeff(fftRealCoeff: Double) = apply {
            fftRealCoeffs =
                (fftRealCoeffs ?: JsonField.of(mutableListOf())).also {
                    checkKnown("fftRealCoeffs", it).add(fftRealCoeff)
                }
        }

        /**
         * Array of individual PSD frequencies of the signal in hertz. This array should correspond
         * with the same-sized array of powers.
         */
        ...
        /**
         * Array of frequency bands experiencing jamming or intentional interference. This array
         * must be the same length as jamToSigRatios.
         */
        fun jamBands(jamBands: List<String>) = jamBands(JsonField.of(jamBands))

        /**
         * Sets [Builder.jamBands] to an arbitrary JSON value.
         *
         * You should usually call [Builder.jamBands] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun jamBands(jamBands: JsonField<List<String>>) = apply {
            this.jamBands = jamBands.map { it.toMutableList() }
        }

        /**
         * Adds a single [String] to [jamBands].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addJamBand(jamBand: String) = apply {
            jamBands =
                (jamBands ?: JsonField.of(mutableListOf())).also {
                    checkKnown("jamBands", it).add(jamBand)
                }
        }

        /**
         * Array of jamming-to-signal power ratios at the receiver for the specified jamBands, in
         * decibels. The values in this array must correspond to the position index in jamBands.
         * This array must be the same length as jamBands.
         */
        fun jamToSigRatios(jamToSigRatios: List<Double>) =
            jamToSigRatios(JsonField.of(jamToSigRatios))

        /**
         * Sets [Builder.jamToSigRatios] to an arbitrary JSON value.
         *
         * You should usually call [Builder.jamToSigRatios] with a well-typed `List<Double>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun jamToSigRatios(jamToSigRatios: JsonField<List<Double>>) = apply {
            this.jamToSigRatios = jamToSigRatios.map { it.toMutableList() }
        }

        /**
         * Adds a single [Double] to [jamToSigRatios].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addJamToSigRatio(jamToSigRatio: Double) = apply {
            jamToSigRatios =
                (jamToSigRatios ?: JsonField.of(mutableListOf())).also {
                    checkKnown("jamToSigRatios", it).add(jamToSigRatio)
                }
        }
         ...
         *
         * You should usually call [Builder.pnOrders] with a well-typed `List<Int>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun pnOrders(pnOrders: JsonField<List<Int>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPnOrder(pnOrder: Int) = apply {
            pnOrders =
                (pnOrders ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.signalIds] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun signalIds(signalIds: JsonField<List<String>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSignalId(signalId: String) = apply {
            signalIds =
                (signalIds ?: JsonField.of(mutableListOf())).also {
        ...
        fun addSnr(snr: Double) = apply {
            snrs = (snrs ?: JsonField.of(mutableListOf())).also { checkKnown("snrs", it).add(snr) }
        }
         ...
         *
         * You should usually call [Builder.telemetryIds] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun telemetryIds(telemetryIds: JsonField<List<String>>) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTelemetryId(telemetryId: String) = apply {
            telemetryIds =
                (telemetryIds ?: JsonField.of(mutableListOf())).also {
        ...
        fun build(): RfObservationGetResponse =
            RfObservationGetResponse(
                ...
                elnot,
                endFrequency,
                (fftImagCoeffs ?: JsonMissing.of()).map { it.toImmutable() },
                (fftRealCoeffs ?: JsonMissing.of()).map { it.toImmutable() },
                ...
                incoming,
                innerCodingRate,
                (jamBands ?: JsonMissing.of()).map { it.toImmutable() },
                (jamToSigRatios ?: JsonMissing.of()).map { it.toImmutable() },
                maxPsd,
                minPsd,
                modulation,
                noisePwrDensity,
     ...
     *   its expected type.
     */
    fun validate(): RfObservationGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (classificationMarking.asKnown().isPresent) 1 else 0) +
            ...
            (baudRates.asKnown().getOrNull()?.size ?: 0) +
            ...
            (chipRates.asKnown().getOrNull()?.size ?: 0) +
            (codeFills.asKnown().getOrNull()?.size ?: 0) +
            (codeLengths.asKnown().getOrNull()?.size ?: 0) +
            (codeTaps.asKnown().getOrNull()?.size ?: 0) +
            (if (collectionMode.asKnown().isPresent) 1 else 0) +
            (if (confidence.asKnown().isPresent) 1 else 0) +
            (confidences.asKnown().getOrNull()?.size ?: 0) +
            (constellationXPoints.asKnown().getOrNull()?.size ?: 0) +
            (constellationYPoints.asKnown().getOrNull()?.size ?: 0) +
            (if (createdAt.asKnown().isPresent) 1 else 0) +
            (if (createdBy.asKnown().isPresent) 1 else 0) +
            (if (descriptor.asKnown().isPresent) 1 else 0) +
            (if (detectionStatus.asKnown().isPresent) 1 else 0) +
            (detectionStatuses.asKnown().getOrNull()?.size ?: 0) +
            ...
            (fftImagCoeffs.asKnown().getOrNull()?.size ?: 0) +
            (fftRealCoeffs.asKnown().getOrNull()?.size ?: 0) +
            ...
            (jamBands.asKnown().getOrNull()?.size ?: 0) +
            (jamToSigRatios.asKnown().getOrNull()?.size ?: 0) +
            ...
            (pnOrders.asKnown().getOrNull()?.size ?: 0) +
            ...
            (signalIds.asKnown().getOrNull()?.size ?: 0) +
            ...
            (telemetryIds.asKnown().getOrNull()?.size ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RfObservationGetResponse &&
            ...
            baudRates == other.baudRates &&
            bitErrorRate == other.bitErrorRate &&
            carrierStandard == other.carrierStandard &&
            channel == other.channel &&
            chipRates == other.chipRates &&
            codeFills == other.codeFills &&
            codeLengths == other.codeLengths &&
            codeTaps == other.codeTaps &&
            collectionMode == other.collectionMode &&
            confidence == other.confidence &&
            confidences == other.confidences &&
            constellationXPoints == other.constellationXPoints &&
            constellationYPoints == other.constellationYPoints &&
            createdAt == other.createdAt &&
            createdBy == other.createdBy &&
            descriptor == other.descriptor &&
            detectionStatus == other.detectionStatus &&
            detectionStatuses == other.detectionStatuses &&
            eirp == other.eirp &&
            ...
            fftImagCoeffs == other.fftImagCoeffs &&
            fftRealCoeffs == other.fftRealCoeffs &&
            ...
            jamBands == other.jamBands &&
            jamToSigRatios == other.jamToSigRatios &&
            maxPsd == other.maxPsd &&
            minPsd == other.minPsd &&
            ...
            tags == other.tags &&
            taskId == other.taskId &&
            telemetryIds == other.telemetryIds &&
