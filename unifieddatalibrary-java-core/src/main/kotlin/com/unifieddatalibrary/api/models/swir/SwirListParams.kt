...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SwirListParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(swirListParams: SwirListParams) = apply {
            ts = swirListParams.ts
            firstResult = swirListParams.firstResult
            maxResults = swirListParams.maxResults
            additionalHeaders = swirListParams.additionalHeaders.toBuilder()
            additionalQueryParams = swirListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SwirListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SwirListParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SwirListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
