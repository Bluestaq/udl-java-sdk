...
class SpaceEnvObservationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SpaceEnvObservationTupleParams].
         *
    ...
    /** A builder for [SpaceEnvObservationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(spaceEnvObservationTupleParams: SpaceEnvObservationTupleParams) =
            apply {
                columns = spaceEnvObservationTupleParams.columns
                obTime = spaceEnvObservationTupleParams.obTime
                firstResult = spaceEnvObservationTupleParams.firstResult
                maxResults = spaceEnvObservationTupleParams.maxResults
                additionalHeaders = spaceEnvObservationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = spaceEnvObservationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Time of the observation, in ISO 8601 UTC format with millisecond precision. (YYYY-MM-DDTHH:MM:SS.sssZ) */
        fun obTime(obTime: OffsetDateTime) =
            apply {
                this.obTime = obTime
            }
        ...
        /**
         * Returns an immutable instance of [SpaceEnvObservationTupleParams].
         *
         ...
         */
        fun build(): SpaceEnvObservationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SpaceEnvObservationTupleParams && columns == other.columns && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, obTime, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "SpaceEnvObservationTupleParams{columns=$columns, obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
