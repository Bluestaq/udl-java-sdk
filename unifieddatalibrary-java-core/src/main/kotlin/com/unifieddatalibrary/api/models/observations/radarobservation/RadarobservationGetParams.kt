 ...
 */
class RadarobservationGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RadarobservationGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationGetParams: RadarobservationGetParams) = apply {
    ...
    override fun toString() =
        "RadarobservationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
