...
class RadarobservationGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): RadarobservationGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RadarobservationGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RadarobservationGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationGetParams: RadarobservationGetParams) =
            apply {
                id = radarobservationGetParams.id
                firstResult = radarobservationGetParams.firstResult
                maxResults = radarobservationGetParams.maxResults
                additionalHeaders = radarobservationGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = radarobservationGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RadarobservationGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RadarobservationGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RadarobservationGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RadarobservationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
