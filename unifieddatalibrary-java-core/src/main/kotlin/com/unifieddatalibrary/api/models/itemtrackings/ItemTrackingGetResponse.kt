...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingGetResponse: ItemTrackingGetResponse) = apply {
    ...
    fun validate(): ItemTrackingGetResponse = apply {
        if (validated) {
            return@apply
        }
