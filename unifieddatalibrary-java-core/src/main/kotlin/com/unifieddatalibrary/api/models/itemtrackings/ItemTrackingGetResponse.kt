...
class ItemTrackingGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemTrackingGetResponse].
         *
    ...
    /** A builder for [ItemTrackingGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingGetResponse: ItemTrackingGetResponse) =
            apply {
                classificationMarking = itemTrackingGetResponse.classificationMarking
                dataMode = itemTrackingGetResponse.dataMode
                scanCode = itemTrackingGetResponse.scanCode
                scannerId = itemTrackingGetResponse.scannerId
                source = itemTrackingGetResponse.source
                ts = itemTrackingGetResponse.ts
                id = itemTrackingGetResponse.id
                createdAt = itemTrackingGetResponse.createdAt
                createdBy = itemTrackingGetResponse.createdBy
                dvCode = itemTrackingGetResponse.dvCode
                idItem = itemTrackingGetResponse.idItem
                keys = itemTrackingGetResponse.keys.map { it.toMutableList() }
                lat = itemTrackingGetResponse.lat
                lon = itemTrackingGetResponse.lon
                notes = itemTrackingGetResponse.notes
                origin = itemTrackingGetResponse.origin
                origNetwork = itemTrackingGetResponse.origNetwork
                scanType = itemTrackingGetResponse.scanType
                scGenTool = itemTrackingGetResponse.scGenTool
                sourceDl = itemTrackingGetResponse.sourceDl
                type = itemTrackingGetResponse.type
                values = itemTrackingGetResponse.values.map { it.toMutableList() }
                additionalProperties = itemTrackingGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ItemTrackingGetResponse].
         *
         ...
         */
        fun build(): ItemTrackingGetResponse =
    ...
    fun validate(): ItemTrackingGetResponse =
        apply {
            if (validated) {
              return@apply
            }
