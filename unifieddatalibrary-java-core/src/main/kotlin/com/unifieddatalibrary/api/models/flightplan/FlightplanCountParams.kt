...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FlightplanCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightplanCountParams: FlightplanCountParams) = apply {
    ...
    override fun toString() =
        "FlightplanCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
