...
class PassiveRadarObservationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            passiveRadarObservationQueryhelpResponse: PassiveRadarObservationQueryhelpResponse
        ) = apply {
            ...
            parameters =
                passiveRadarObservationQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                passiveRadarObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                passiveRadarObservationQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): PassiveRadarObservationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
