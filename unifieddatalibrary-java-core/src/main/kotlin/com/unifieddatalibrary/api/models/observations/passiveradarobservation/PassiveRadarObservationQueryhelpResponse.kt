...
class PassiveRadarObservationQueryhelpResponse private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("aodrSupported") @ExcludeMissing aodrSupported: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("historySupported") @ExcludeMissing historySupported: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
        @JsonProperty("parameters") @ExcludeMissing parameters: JsonField<List<ParamDescriptor>> = JsonMissing.of(),
        @JsonProperty("requiredRoles") @ExcludeMissing requiredRoles: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("restSupported") @ExcludeMissing restSupported: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("sortSupported") @ExcludeMissing sortSupported: JsonField<Boolean> = JsonMissing.of(),
     ...
     *
     * Unlike [historySupported], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _typeName(): JsonField<String> = typeName
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PassiveRadarObservationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [PassiveRadarObservationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(passiveRadarObservationQueryhelpResponse: PassiveRadarObservationQueryhelpResponse) =
            apply {
                aodrSupported = passiveRadarObservationQueryhelpResponse.aodrSupported
                classificationMarking = passiveRadarObservationQueryhelpResponse.classificationMarking
                description = passiveRadarObservationQueryhelpResponse.description
                historySupported = passiveRadarObservationQueryhelpResponse.historySupported
                name = passiveRadarObservationQueryhelpResponse.name
                parameters = passiveRadarObservationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = passiveRadarObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = passiveRadarObservationQueryhelpResponse.restSupported
                sortSupported = passiveRadarObservationQueryhelpResponse.sortSupported
                typeName = passiveRadarObservationQueryhelpResponse.typeName
                uri = passiveRadarObservationQueryhelpResponse.uri
                additionalProperties = passiveRadarObservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.aodrSupported] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun aodrSupported(aodrSupported: JsonField<Boolean>) =
            apply {
        ...
        fun historySupported(historySupported: Boolean) = historySupported(JsonField.of(historySupported))

        /**
         * Sets [Builder.historySupported] to an arbitrary JSON value.
         *
         * You should usually call [Builder.historySupported] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun historySupported(historySupported: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.parameters] with a well-typed `List<ParamDescriptor>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun parameters(parameters: JsonField<List<ParamDescriptor>>) =
            apply {
         ...
         */
        fun addParameter(parameter: ParamDescriptor) =
            apply {
                parameters = (parameters ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.requiredRoles] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun requiredRoles(requiredRoles: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRequiredRole(requiredRole: String) =
            apply {
                requiredRoles = (requiredRoles ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.restSupported] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun restSupported(restSupported: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.sortSupported] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sortSupported(sortSupported: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.typeName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun typeName(typeName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.uri] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun uri(uri: JsonField<String>) =
            apply {
                this.uri = uri
            }
        ...
        /**
         * Returns an immutable instance of [PassiveRadarObservationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PassiveRadarObservationQueryhelpResponse =
    ...
    fun validate(): PassiveRadarObservationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (aodrSupported.asKnown().isPresent) 1 else 0) + (if (classificationMarking.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (historySupported.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (parameters.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (requiredRoles.asKnown().getOrNull()?.size ?: 0) + (if (restSupported.asKnown().isPresent) 1 else 0) + (if (sortSupported.asKnown().isPresent) 1 else 0) + (if (typeName.asKnown().isPresent) 1 else 0) + (if (uri.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PassiveRadarObservationQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
