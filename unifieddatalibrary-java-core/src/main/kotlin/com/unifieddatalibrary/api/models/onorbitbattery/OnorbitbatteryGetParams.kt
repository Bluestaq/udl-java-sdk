...
class OnorbitbatteryGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OnorbitbatteryGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OnorbitbatteryGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OnorbitbatteryGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitbatteryGetParams: OnorbitbatteryGetParams) =
            apply {
                id = onorbitbatteryGetParams.id
                firstResult = onorbitbatteryGetParams.firstResult
                maxResults = onorbitbatteryGetParams.maxResults
                additionalHeaders = onorbitbatteryGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitbatteryGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitbatteryGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitbatteryGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitbatteryGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnorbitbatteryGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
