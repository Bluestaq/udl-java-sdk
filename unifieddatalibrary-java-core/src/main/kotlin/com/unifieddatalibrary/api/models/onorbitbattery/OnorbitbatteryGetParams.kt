...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitbatteryGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitbatteryGetParams: OnorbitbatteryGetParams) = apply {
    ...
    override fun toString() =
        "OnorbitbatteryGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
