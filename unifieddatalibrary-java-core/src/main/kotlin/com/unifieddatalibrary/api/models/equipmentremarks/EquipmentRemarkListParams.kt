 ...
 */
class EquipmentRemarkListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EquipmentRemarkListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [EquipmentRemarkListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EquipmentRemarkListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentRemarkListParams: EquipmentRemarkListParams) = apply {
            firstResult = equipmentRemarkListParams.firstResult
            maxResults = equipmentRemarkListParams.maxResults
            additionalHeaders = equipmentRemarkListParams.additionalHeaders.toBuilder()
            additionalQueryParams = equipmentRemarkListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EquipmentRemarkListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EquipmentRemarkListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EquipmentRemarkListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "EquipmentRemarkListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
