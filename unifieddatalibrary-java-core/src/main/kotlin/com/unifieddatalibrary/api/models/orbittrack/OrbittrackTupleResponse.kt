...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackTupleResponse: OrbittrackTupleResponse) = apply {
    ...
    fun validate(): OrbittrackTupleResponse = apply {
        if (validated) {
            return@apply
        }
