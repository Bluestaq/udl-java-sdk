...
class OrbittrackTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbittrackTupleResponse].
         *
    ...
    /** A builder for [OrbittrackTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackTupleResponse: OrbittrackTupleResponse) =
            apply {
                classificationMarking = orbittrackTupleResponse.classificationMarking
                dataMode = orbittrackTupleResponse.dataMode
                lat = orbittrackTupleResponse.lat
                lon = orbittrackTupleResponse.lon
                source = orbittrackTupleResponse.source
                ts = orbittrackTupleResponse.ts
                id = orbittrackTupleResponse.id
                alt = orbittrackTupleResponse.alt
                amplification = orbittrackTupleResponse.amplification
                angElev = orbittrackTupleResponse.angElev
                aouData = orbittrackTupleResponse.aouData.map { it.toMutableList() }
                aouType = orbittrackTupleResponse.aouType
                callSign = orbittrackTupleResponse.callSign
                charlieLine = orbittrackTupleResponse.charlieLine
                chXRef = orbittrackTupleResponse.chXRef
                cntnmnt = orbittrackTupleResponse.cntnmnt
                countryCode = orbittrackTupleResponse.countryCode
                createdAt = orbittrackTupleResponse.createdAt
                createdBy = orbittrackTupleResponse.createdBy
                decay = orbittrackTupleResponse.decay
                dummy = orbittrackTupleResponse.dummy
                feint = orbittrackTupleResponse.feint
                hq = orbittrackTupleResponse.hq
                idElset = orbittrackTupleResponse.idElset
                identAmp = orbittrackTupleResponse.identAmp
                idOnOrbit = orbittrackTupleResponse.idOnOrbit
                iff = orbittrackTupleResponse.iff
                installation = orbittrackTupleResponse.installation
                objectType = orbittrackTupleResponse.objectType
                objIdent = orbittrackTupleResponse.objIdent
                onOrbit = orbittrackTupleResponse.onOrbit
                origin = orbittrackTupleResponse.origin
                origNetwork = orbittrackTupleResponse.origNetwork
                origObjectId = orbittrackTupleResponse.origObjectId
                rdfRf = orbittrackTupleResponse.rdfRf
                reduced = orbittrackTupleResponse.reduced
                reinforced = orbittrackTupleResponse.reinforced
                rptNum = orbittrackTupleResponse.rptNum
                satNo = orbittrackTupleResponse.satNo
                satStatus = orbittrackTupleResponse.satStatus
                spd = orbittrackTupleResponse.spd
                taskForce = orbittrackTupleResponse.taskForce
                trackSensors = orbittrackTupleResponse.trackSensors.map { it.toMutableList() }
                trkId = orbittrackTupleResponse.trkId
                vehType = orbittrackTupleResponse.vehType
                xref = orbittrackTupleResponse.xref
                additionalProperties = orbittrackTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OrbittrackTupleResponse].
         *
         ...
         */
        fun build(): OrbittrackTupleResponse =
    ...
    fun validate(): OrbittrackTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
