...
class SolarArrayListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SolarArrayListResponse].
         *
    ...
    /** A builder for [SolarArrayListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayListResponse: SolarArrayListResponse) =
            apply {
                dataMode = solarArrayListResponse.dataMode
                name = solarArrayListResponse.name
                source = solarArrayListResponse.source
                id = solarArrayListResponse.id
                createdAt = solarArrayListResponse.createdAt
                createdBy = solarArrayListResponse.createdBy
                origin = solarArrayListResponse.origin
                origNetwork = solarArrayListResponse.origNetwork
                additionalProperties = solarArrayListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SolarArrayListResponse].
         *
         ...
         */
        fun build(): SolarArrayListResponse =
    ...
    fun validate(): SolarArrayListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "SolarArrayListResponse{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
