...
class AircraftSortyCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftSortyCountParams].
         *
    ...
    /** A builder for [AircraftSortyCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyCountParams: AircraftSortyCountParams) =
            apply {
                plannedDepTime = aircraftSortyCountParams.plannedDepTime
                firstResult = aircraftSortyCountParams.firstResult
                maxResults = aircraftSortyCountParams.maxResults
                additionalHeaders = aircraftSortyCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftSortyCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortyCountParams].
         *
         ...
         */
        fun build(): AircraftSortyCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftSortyCountParams && plannedDepTime == other.plannedDepTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AircraftSortyCountParams{plannedDepTime=$plannedDepTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
