...
class SpaceEnvObservationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SpaceEnvObservationCountParams].
         *
    ...
    /** A builder for [SpaceEnvObservationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(spaceEnvObservationCountParams: SpaceEnvObservationCountParams) =
            apply {
                obTime = spaceEnvObservationCountParams.obTime
                firstResult = spaceEnvObservationCountParams.firstResult
                maxResults = spaceEnvObservationCountParams.maxResults
                additionalHeaders = spaceEnvObservationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = spaceEnvObservationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SpaceEnvObservationCountParams].
         *
         ...
         */
        fun build(): SpaceEnvObservationCountParams =
    ...
    override fun toString() = "SpaceEnvObservationCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
