...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LinkStatusGetResponse].
         *
    ...
    /** A builder for [LinkStatusGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(linkStatusGetResponse: LinkStatusGetResponse) = apply {
            classificationMarking = linkStatusGetResponse.classificationMarking
            dataMode = linkStatusGetResponse.dataMode
            endPoint1Lat = linkStatusGetResponse.endPoint1Lat
            endPoint1Lon = linkStatusGetResponse.endPoint1Lon
            endPoint1Name = linkStatusGetResponse.endPoint1Name
            endPoint2Lat = linkStatusGetResponse.endPoint2Lat
            endPoint2Lon = linkStatusGetResponse.endPoint2Lon
            endPoint2Name = linkStatusGetResponse.endPoint2Name
            linkName = linkStatusGetResponse.linkName
            linkStartTime = linkStatusGetResponse.linkStartTime
            linkStopTime = linkStatusGetResponse.linkStopTime
            source = linkStatusGetResponse.source
            id = linkStatusGetResponse.id
            band = linkStatusGetResponse.band
            constellation = linkStatusGetResponse.constellation
            createdAt = linkStatusGetResponse.createdAt
            createdBy = linkStatusGetResponse.createdBy
            dataRate1To2 = linkStatusGetResponse.dataRate1To2
            dataRate2To1 = linkStatusGetResponse.dataRate2To1
            idBeam1 = linkStatusGetResponse.idBeam1
            idBeam2 = linkStatusGetResponse.idBeam2
            idOnOrbit1 = linkStatusGetResponse.idOnOrbit1
            idOnOrbit2 = linkStatusGetResponse.idOnOrbit2
            linkState = linkStatusGetResponse.linkState
            linkType = linkStatusGetResponse.linkType
            opsCap = linkStatusGetResponse.opsCap
            origin = linkStatusGetResponse.origin
            origNetwork = linkStatusGetResponse.origNetwork
            satNo1 = linkStatusGetResponse.satNo1
            satNo2 = linkStatusGetResponse.satNo2
            sysCap = linkStatusGetResponse.sysCap
            additionalProperties = linkStatusGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LinkStatusGetResponse].
         *
         ...
         */
        fun build(): LinkStatusGetResponse =
    ...
    fun validate(): LinkStatusGetResponse = apply {
        if (validated) {
            return@apply
        }
