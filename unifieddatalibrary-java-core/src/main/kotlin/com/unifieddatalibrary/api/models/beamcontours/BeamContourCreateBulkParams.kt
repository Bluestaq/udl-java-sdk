...
class BeamContourCreateBulkParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamContourCreateBulkParams: BeamContourCreateBulkParams) =
            apply {
    ...
    class Body @JsonCreator private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idBeam.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (contourIdx.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (gain.asKnown().isPresent) 1 else 0) + (if (geography.asKnown().isPresent) 1 else 0) + (if (geographyJson.asKnown().isPresent) 1 else 0) + (if (geographyNdims.asKnown().isPresent) 1 else 0) + (if (geographySrid.asKnown().isPresent) 1 else 0) + (if (geographyText.asKnown().isPresent) 1 else 0) + (if (geographyType.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (regionName.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "BeamContourCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
