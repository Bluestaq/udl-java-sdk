 ...
 */
class LaserdeconflictrequestTupleParams
private constructor(
    ...
    /** A builder for [LaserdeconflictrequestTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laserdeconflictrequestTupleParams: LaserdeconflictrequestTupleParams) =
            apply {
                columns = laserdeconflictrequestTupleParams.columns
                startDate = laserdeconflictrequestTupleParams.startDate
                firstResult = laserdeconflictrequestTupleParams.firstResult
                maxResults = laserdeconflictrequestTupleParams.maxResults
                additionalHeaders = laserdeconflictrequestTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    laserdeconflictrequestTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [LaserdeconflictrequestTupleParams].
         *
         ...
         */
        fun build(): LaserdeconflictrequestTupleParams =
            LaserdeconflictrequestTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaserdeconflictrequestTupleParams &&
    ...
    override fun toString() =
        "LaserdeconflictrequestTupleParams{columns=$columns, startDate=$startDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
