...
class SolarArrayListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<SolarArrayListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayListPageAsync: SolarArrayListPageAsync) =
            apply {
        ...
        fun service(service: SolarArrayServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SolarArrayListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, streamHandlerExecutor, params, items) /* spotless:on */

    override fun toString() = "SolarArrayListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
