...
class EngineDetailsFull private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineDetailsFull: EngineDetailsFull) =
            apply {
    ...
    fun validate(): EngineDetailsFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idEngine.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (burnTime.asKnown().isPresent) 1 else 0) + (if (chamberPressure.asKnown().isPresent) 1 else 0) + (if (characteristicType.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (cycleType.asKnown().isPresent) 1 else 0) + (if (family.asKnown().isPresent) 1 else 0) + (if (manufacturerOrgId.asKnown().isPresent) 1 else 0) + (if (maxFirings.asKnown().isPresent) 1 else 0) + (if (notes.asKnown().isPresent) 1 else 0) + (if (nozzleExpansionRatio.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (oxidizer.asKnown().isPresent) 1 else 0) + (if (propellant.asKnown().isPresent) 1 else 0) + (if (seaLevelThrust.asKnown().isPresent) 1 else 0) + (if (specificImpulse.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (if (vacuumThrust.asKnown().isPresent) 1 else 0)
