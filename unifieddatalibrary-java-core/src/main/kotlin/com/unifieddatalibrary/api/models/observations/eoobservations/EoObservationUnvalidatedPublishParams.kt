...
/**
 * Service operation to take multiple EO observations as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class EoObservationUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            eoObservationUnvalidatedPublishParams: EoObservationUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                eoObservationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EoObservationUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EoObservationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
