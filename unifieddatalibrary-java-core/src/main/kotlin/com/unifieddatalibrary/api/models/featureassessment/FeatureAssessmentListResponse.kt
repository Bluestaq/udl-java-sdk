 ...
 */
class FeatureAssessmentListResponse
private constructor(
    ...
    /** A builder for [FeatureAssessmentListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureAssessmentListResponse: FeatureAssessmentListResponse) = apply {
            classificationMarking = featureAssessmentListResponse.classificationMarking
            dataMode = featureAssessmentListResponse.dataMode
            featureTs = featureAssessmentListResponse.featureTs
            featureUoM = featureAssessmentListResponse.featureUoM
            idAnalyticImagery = featureAssessmentListResponse.idAnalyticImagery
            source = featureAssessmentListResponse.source
            id = featureAssessmentListResponse.id
            agjson = featureAssessmentListResponse.agjson
            andims = featureAssessmentListResponse.andims
            annLims = featureAssessmentListResponse.annLims.map { it.toMutableList() }
            annText = featureAssessmentListResponse.annText.map { it.toMutableList() }
            asrid = featureAssessmentListResponse.asrid
            assessment = featureAssessmentListResponse.assessment
            atext = featureAssessmentListResponse.atext
            atype = featureAssessmentListResponse.atype
            confidence = featureAssessmentListResponse.confidence
            createdAt = featureAssessmentListResponse.createdAt
            createdBy = featureAssessmentListResponse.createdBy
            externalId = featureAssessmentListResponse.externalId
            featureArray = featureAssessmentListResponse.featureArray.map { it.toMutableList() }
            featureBool = featureAssessmentListResponse.featureBool
            featureString = featureAssessmentListResponse.featureString
            featureStringArray =
                featureAssessmentListResponse.featureStringArray.map { it.toMutableList() }
            featureValue = featureAssessmentListResponse.featureValue
            heading = featureAssessmentListResponse.heading
            height = featureAssessmentListResponse.height
            length = featureAssessmentListResponse.length
            name = featureAssessmentListResponse.name
            origin = featureAssessmentListResponse.origin
            origNetwork = featureAssessmentListResponse.origNetwork
            sourceDl = featureAssessmentListResponse.sourceDl
            speed = featureAssessmentListResponse.speed
            srcIds = featureAssessmentListResponse.srcIds.map { it.toMutableList() }
            srcTs = featureAssessmentListResponse.srcTs.map { it.toMutableList() }
            srcTyps = featureAssessmentListResponse.srcTyps.map { it.toMutableList() }
            transactionId = featureAssessmentListResponse.transactionId
            type = featureAssessmentListResponse.type
            width = featureAssessmentListResponse.width
            additionalProperties = featureAssessmentListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureAssessmentListResponse].
         *
         ...
         */
        fun build(): FeatureAssessmentListResponse =
            FeatureAssessmentListResponse(
    ...
    fun validate(): FeatureAssessmentListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureAssessmentListResponse &&
