...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardTupleResponse: HazardTupleResponse) = apply {
    ...
    fun validate(): HazardTupleResponse = apply {
        if (validated) {
            return@apply
        }
