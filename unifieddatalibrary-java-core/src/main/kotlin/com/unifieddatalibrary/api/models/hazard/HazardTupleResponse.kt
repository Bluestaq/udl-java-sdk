...
class HazardTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HazardTupleResponse].
         *
    ...
    /** A builder for [HazardTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardTupleResponse: HazardTupleResponse) =
            apply {
                alarms = hazardTupleResponse.alarms.map { it.toMutableList() }
                alarmValues = hazardTupleResponse.alarmValues.map { it.toMutableList() }
                classificationMarking = hazardTupleResponse.classificationMarking
                dataMode = hazardTupleResponse.dataMode
                detectTime = hazardTupleResponse.detectTime
                detectType = hazardTupleResponse.detectType
                source = hazardTupleResponse.source
                id = hazardTupleResponse.id
                a = hazardTupleResponse.a
                activity = hazardTupleResponse.activity
                bottleId = hazardTupleResponse.bottleId
                casRn = hazardTupleResponse.casRn
                channel = hazardTupleResponse.channel
                createdAt = hazardTupleResponse.createdAt
                createdBy = hazardTupleResponse.createdBy
                ctrnTime = hazardTupleResponse.ctrnTime
                density = hazardTupleResponse.density
                dep = hazardTupleResponse.dep
                depCtrn = hazardTupleResponse.depCtrn
                dose = hazardTupleResponse.dose
                doseRate = hazardTupleResponse.doseRate
                duration = hazardTupleResponse.duration
                gBar = hazardTupleResponse.gBar
                harmful = hazardTupleResponse.harmful
                hBar = hazardTupleResponse.hBar
                idPoi = hazardTupleResponse.idPoi
                idTrack = hazardTupleResponse.idTrack
                massFrac = hazardTupleResponse.massFrac
                matCat = hazardTupleResponse.matCat
                matClass = hazardTupleResponse.matClass
                matName = hazardTupleResponse.matName
                matType = hazardTupleResponse.matType
                origin = hazardTupleResponse.origin
                origNetwork = hazardTupleResponse.origNetwork
                ppm = hazardTupleResponse.ppm
                radCtrn = hazardTupleResponse.radCtrn
                readings = hazardTupleResponse.readings.map { it.toMutableList() }
                readingUnits = hazardTupleResponse.readingUnits.map { it.toMutableList() }
                readingValues = hazardTupleResponse.readingValues.map { it.toMutableList() }
                z = hazardTupleResponse.z
                additionalProperties = hazardTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [HazardTupleResponse].
         *
    ...
    fun validate(): HazardTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
