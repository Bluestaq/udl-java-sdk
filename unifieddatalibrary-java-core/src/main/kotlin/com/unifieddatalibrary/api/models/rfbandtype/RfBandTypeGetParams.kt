...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfBandTypeGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeGetParams: RfBandTypeGetParams) = apply {
    ...
    override fun toString() =
        "RfBandTypeGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
