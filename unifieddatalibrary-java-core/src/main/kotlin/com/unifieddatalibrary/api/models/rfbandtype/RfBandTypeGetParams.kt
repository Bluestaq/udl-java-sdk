...
class RfBandTypeGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): RfBandTypeGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RfBandTypeGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfBandTypeGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeGetParams: RfBandTypeGetParams) =
            apply {
                id = rfBandTypeGetParams.id
                firstResult = rfBandTypeGetParams.firstResult
                maxResults = rfBandTypeGetParams.maxResults
                additionalHeaders = rfBandTypeGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfBandTypeGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfBandTypeGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfBandTypeGetParams =
            RfBandTypeGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfBandTypeGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfBandTypeGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
