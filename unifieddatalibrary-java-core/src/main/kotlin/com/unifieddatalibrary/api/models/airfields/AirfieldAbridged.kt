...
class AirfieldAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirfieldAbridged].
         *
    ...
    /** A builder for [AirfieldAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldAbridged: AirfieldAbridged) =
            apply {
                classificationMarking = airfieldAbridged.classificationMarking
                dataMode = airfieldAbridged.dataMode
                name = airfieldAbridged.name
                source = airfieldAbridged.source
                type = airfieldAbridged.type
                id = airfieldAbridged.id
                altAirfieldId = airfieldAbridged.altAirfieldId
                alternativeNames = airfieldAbridged.alternativeNames.map { it.toMutableList() }
                city = airfieldAbridged.city
                countryCode = airfieldAbridged.countryCode
                countryName = airfieldAbridged.countryName
                createdAt = airfieldAbridged.createdAt
                createdBy = airfieldAbridged.createdBy
                dstInfo = airfieldAbridged.dstInfo
                elevFt = airfieldAbridged.elevFt
                elevM = airfieldAbridged.elevM
                faa = airfieldAbridged.faa
                geoloc = airfieldAbridged.geoloc
                gmtOffset = airfieldAbridged.gmtOffset
                hostNatCode = airfieldAbridged.hostNatCode
                iata = airfieldAbridged.iata
                icao = airfieldAbridged.icao
                idSite = airfieldAbridged.idSite
                infoUrl = airfieldAbridged.infoUrl
                lat = airfieldAbridged.lat
                lon = airfieldAbridged.lon
                magDec = airfieldAbridged.magDec
                maxRunwayLength = airfieldAbridged.maxRunwayLength
                miscCodes = airfieldAbridged.miscCodes
                origin = airfieldAbridged.origin
                origNetwork = airfieldAbridged.origNetwork
                regionalAuthority = airfieldAbridged.regionalAuthority
                regionName = airfieldAbridged.regionName
                runways = airfieldAbridged.runways
                secondaryIcao = airfieldAbridged.secondaryIcao
                sourceDl = airfieldAbridged.sourceDl
                state = airfieldAbridged.state
                stateProvinceCode = airfieldAbridged.stateProvinceCode
                suitabilityCodeDescs = airfieldAbridged.suitabilityCodeDescs.map { it.toMutableList() }
                suitabilityCodes = airfieldAbridged.suitabilityCodes
                wacInnr = airfieldAbridged.wacInnr
                zarId = airfieldAbridged.zarId
                additionalProperties = airfieldAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldAbridged].
         *
