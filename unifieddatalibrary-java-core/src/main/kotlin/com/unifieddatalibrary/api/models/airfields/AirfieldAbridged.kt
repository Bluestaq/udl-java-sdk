...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldAbridged: AirfieldAbridged) = apply {
    ...
    fun validate(): AirfieldAbridged = apply {
        if (validated) {
            return@apply
        }
