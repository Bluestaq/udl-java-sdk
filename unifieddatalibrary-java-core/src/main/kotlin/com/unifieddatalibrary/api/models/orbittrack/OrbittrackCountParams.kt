...
class OrbittrackCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbittrackCountParams].
         *
    ...
    /** A builder for [OrbittrackCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbittrackCountParams: OrbittrackCountParams) =
            apply {
                ts = orbittrackCountParams.ts
                firstResult = orbittrackCountParams.firstResult
                maxResults = orbittrackCountParams.maxResults
                additionalHeaders = orbittrackCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = orbittrackCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OrbittrackCountParams].
         *
         ...
         */
        fun build(): OrbittrackCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbittrackCountParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OrbittrackCountParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
