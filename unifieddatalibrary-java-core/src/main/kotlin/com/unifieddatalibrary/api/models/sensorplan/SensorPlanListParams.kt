...
class SensorPlanListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorPlanListParams].
         *
    ...
    /** A builder for [SensorPlanListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanListParams: SensorPlanListParams) =
            apply {
                startTime = sensorPlanListParams.startTime
                firstResult = sensorPlanListParams.firstResult
                maxResults = sensorPlanListParams.maxResults
                additionalHeaders = sensorPlanListParams.additionalHeaders.toBuilder()
                additionalQueryParams = sensorPlanListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SensorPlanListParams].
         *
         ...
         */
        fun build(): SensorPlanListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorPlanListParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SensorPlanListParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
