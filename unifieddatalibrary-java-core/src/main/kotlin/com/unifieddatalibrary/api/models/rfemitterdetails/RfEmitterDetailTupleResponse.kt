...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(rfEmitterDetailTupleResponse: RfEmitterDetailTupleResponse) = apply {
            ...
            amplifier = rfEmitterDetailTupleResponse.amplifier
            antennas = rfEmitterDetailTupleResponse.antennas.map { it.toMutableList() }
            barrageNoiseBandwidth = rfEmitterDetailTupleResponse.barrageNoiseBandwidth
            bitRunTime = rfEmitterDetailTupleResponse.bitRunTime
            ...
            fixedAttenuation = rfEmitterDetailTupleResponse.fixedAttenuation
            idManufacturerOrg = rfEmitterDetailTupleResponse.idManufacturerOrg
            idProductionFacilityLocation = rfEmitterDetailTupleResponse.idProductionFacilityLocation
            loanedToCocom = rfEmitterDetailTupleResponse.loanedToCocom
            ...
            powerOffsets = rfEmitterDetailTupleResponse.powerOffsets.map { it.toMutableList() }
            prepTime = rfEmitterDetailTupleResponse.prepTime
            primaryCocom = rfEmitterDetailTupleResponse.primaryCocom
            ...
            services = rfEmitterDetailTupleResponse.services.map { it.toMutableList() }
            ...
            ttps = rfEmitterDetailTupleResponse.ttps.map { it.toMutableList() }
