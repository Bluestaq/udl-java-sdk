 ...
 */
class RfEmitterDetailTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterDetailTupleResponse: RfEmitterDetailTupleResponse) = apply {
    ...
    fun validate(): RfEmitterDetailTupleResponse = apply {
        if (validated) {
            return@apply
        }
