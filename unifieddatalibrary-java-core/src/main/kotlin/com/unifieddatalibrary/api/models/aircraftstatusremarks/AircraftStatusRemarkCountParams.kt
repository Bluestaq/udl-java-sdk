 ...
 */
class AircraftStatusRemarkCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AircraftStatusRemarkCountParams = builder().build()
        ...
        internal fun from(aircraftStatusRemarkCountParams: AircraftStatusRemarkCountParams) =
            apply {
                ...
                additionalQueryParams =
                    aircraftStatusRemarkCountParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "AircraftStatusRemarkCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
