...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ScientificGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificGetParams: ScientificGetParams) = apply {
    ...
    override fun toString() =
        "ScientificGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
