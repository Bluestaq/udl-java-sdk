...
class ScientificGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ScientificGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ScientificGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ScientificGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scientificGetParams: ScientificGetParams) =
            apply {
                id = scientificGetParams.id
                firstResult = scientificGetParams.firstResult
                maxResults = scientificGetParams.maxResults
                additionalHeaders = scientificGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = scientificGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ScientificGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScientificGetParams =
            ScientificGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ScientificGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ScientificGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
