...
class RouteStatQueryResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RouteStatQueryResponse].
         *
    ...
    /** A builder for [RouteStatQueryResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatQueryResponse: RouteStatQueryResponse) =
            apply {
                classificationMarking = routeStatQueryResponse.classificationMarking
                dataMode = routeStatQueryResponse.dataMode
                locationEnd = routeStatQueryResponse.locationEnd
                locationStart = routeStatQueryResponse.locationStart
                source = routeStatQueryResponse.source
                id = routeStatQueryResponse.id
                avgDuration = routeStatQueryResponse.avgDuration
                avgSpeed = routeStatQueryResponse.avgSpeed
                createdAt = routeStatQueryResponse.createdAt
                createdBy = routeStatQueryResponse.createdBy
                dataPtsUsed = routeStatQueryResponse.dataPtsUsed
                distance = routeStatQueryResponse.distance
                distUnit = routeStatQueryResponse.distUnit
                firstPt = routeStatQueryResponse.firstPt
                idealDesc = routeStatQueryResponse.idealDesc
                idealDuration = routeStatQueryResponse.idealDuration
                idSiteEnd = routeStatQueryResponse.idSiteEnd
                idSiteStart = routeStatQueryResponse.idSiteStart
                lastPt = routeStatQueryResponse.lastPt
                locationType = routeStatQueryResponse.locationType
                maxDuration = routeStatQueryResponse.maxDuration
                maxSpeed = routeStatQueryResponse.maxSpeed
                minDuration = routeStatQueryResponse.minDuration
                minSpeed = routeStatQueryResponse.minSpeed
                origin = routeStatQueryResponse.origin
                origNetwork = routeStatQueryResponse.origNetwork
                partialDesc = routeStatQueryResponse.partialDesc
                partialDuration = routeStatQueryResponse.partialDuration
                sourceDl = routeStatQueryResponse.sourceDl
                speedUnit = routeStatQueryResponse.speedUnit
                timePeriod = routeStatQueryResponse.timePeriod
                vehicleCategory = routeStatQueryResponse.vehicleCategory
                vehicleType = routeStatQueryResponse.vehicleType
                additionalProperties = routeStatQueryResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RouteStatQueryResponse].
         *
         ...
         */
        fun build(): RouteStatQueryResponse =
    ...
    fun validate(): RouteStatQueryResponse =
        apply {
            if (validated) {
              return@apply
            }
