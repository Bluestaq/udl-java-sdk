...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatQueryResponse: RouteStatQueryResponse) = apply {
    ...
    fun validate(): RouteStatQueryResponse = apply {
        if (validated) {
            return@apply
        }
