...
class SolarArrayQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SolarArrayQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SolarArrayQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayQueryhelpResponse: SolarArrayQueryhelpResponse) =
            apply {
                aodrSupported = solarArrayQueryhelpResponse.aodrSupported
                classificationMarking = solarArrayQueryhelpResponse.classificationMarking
                description = solarArrayQueryhelpResponse.description
                historySupported = solarArrayQueryhelpResponse.historySupported
                name = solarArrayQueryhelpResponse.name
                parameters = solarArrayQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = solarArrayQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = solarArrayQueryhelpResponse.restSupported
                sortSupported = solarArrayQueryhelpResponse.sortSupported
                typeName = solarArrayQueryhelpResponse.typeName
                uri = solarArrayQueryhelpResponse.uri
                additionalProperties = solarArrayQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SolarArrayQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SolarArrayQueryhelpResponse =
    ...
    fun validate(): SolarArrayQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
