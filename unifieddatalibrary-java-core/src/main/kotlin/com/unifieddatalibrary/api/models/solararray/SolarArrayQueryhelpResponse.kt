...
class SolarArrayQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(solarArrayQueryhelpResponse: SolarArrayQueryhelpResponse) = apply {
    ...
    fun validate(): SolarArrayQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
