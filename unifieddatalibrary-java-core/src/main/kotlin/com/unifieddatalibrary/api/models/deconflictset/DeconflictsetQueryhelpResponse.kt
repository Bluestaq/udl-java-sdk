...
class DeconflictsetQueryhelpResponse
...
private constructor(
    ...
    /** A builder for [DeconflictsetQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deconflictsetQueryhelpResponse: DeconflictsetQueryhelpResponse) = apply {
            aodrSupported = deconflictsetQueryhelpResponse.aodrSupported
            classificationMarking = deconflictsetQueryhelpResponse.classificationMarking
            description = deconflictsetQueryhelpResponse.description
            historySupported = deconflictsetQueryhelpResponse.historySupported
            name = deconflictsetQueryhelpResponse.name
            parameters = deconflictsetQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = deconflictsetQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = deconflictsetQueryhelpResponse.restSupported
            sortSupported = deconflictsetQueryhelpResponse.sortSupported
            typeName = deconflictsetQueryhelpResponse.typeName
            uri = deconflictsetQueryhelpResponse.uri
            additionalProperties =
                deconflictsetQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DeconflictsetQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DeconflictsetQueryhelpResponse =
            DeconflictsetQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): DeconflictsetQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeconflictsetQueryhelpResponse &&
