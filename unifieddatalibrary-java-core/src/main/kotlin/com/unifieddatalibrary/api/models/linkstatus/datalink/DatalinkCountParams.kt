...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatalinkCountParams].
         *
    ...
    /** A builder for [DatalinkCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datalinkCountParams: DatalinkCountParams) = apply {
            startTime = datalinkCountParams.startTime
            firstResult = datalinkCountParams.firstResult
            maxResults = datalinkCountParams.maxResults
            additionalHeaders = datalinkCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = datalinkCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DatalinkCountParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DatalinkCountParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "DatalinkCountParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
