...
class HistoryListPage private constructor(
    ...
    private val items: List<EphemerisFull>,
    ...
    fun autoPager(): AutoPager<EphemerisFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<EphemerisFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<EphemerisFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<EphemerisFull>) =
            apply {
                this.items = items
            }
