...
class DropzoneTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DropzoneTupleParams].
         *
    ...
    /** A builder for [DropzoneTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneTupleParams: DropzoneTupleParams) =
            apply {
                columns = dropzoneTupleParams.columns
                firstResult = dropzoneTupleParams.firstResult
                maxResults = dropzoneTupleParams.maxResults
                additionalHeaders = dropzoneTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = dropzoneTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DropzoneTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is DropzoneTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "DropzoneTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
