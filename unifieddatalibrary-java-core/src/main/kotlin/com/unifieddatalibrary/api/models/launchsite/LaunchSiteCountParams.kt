...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LaunchSiteCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LaunchSiteCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LaunchSiteCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteCountParams: LaunchSiteCountParams) = apply {
            firstResult = launchSiteCountParams.firstResult
            maxResults = launchSiteCountParams.maxResults
            additionalHeaders = launchSiteCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = launchSiteCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchSiteCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LaunchSiteCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LaunchSiteCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
