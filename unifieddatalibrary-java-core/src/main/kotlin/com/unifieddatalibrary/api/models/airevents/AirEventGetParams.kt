...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirEventGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventGetParams: AirEventGetParams) = apply {
    ...
    override fun toString() =
        "AirEventGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
