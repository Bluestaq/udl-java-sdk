...
class AirEventGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AirEventGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AirEventGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirEventGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventGetParams: AirEventGetParams) =
            apply {
                id = airEventGetParams.id
                firstResult = airEventGetParams.firstResult
                maxResults = airEventGetParams.maxResults
                additionalHeaders = airEventGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = airEventGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirEventGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirEventGetParams =
            AirEventGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirEventGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirEventGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
