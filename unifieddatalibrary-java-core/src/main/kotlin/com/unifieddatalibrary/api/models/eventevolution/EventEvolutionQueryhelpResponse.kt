...
class EventEvolutionQueryhelpResponse
private constructor(
    ...
    /** A builder for [EventEvolutionQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventEvolutionQueryhelpResponse: EventEvolutionQueryhelpResponse) =
            apply {
                aodrSupported = eventEvolutionQueryhelpResponse.aodrSupported
                classificationMarking = eventEvolutionQueryhelpResponse.classificationMarking
                description = eventEvolutionQueryhelpResponse.description
                historySupported = eventEvolutionQueryhelpResponse.historySupported
                name = eventEvolutionQueryhelpResponse.name
                parameters = eventEvolutionQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles =
                    eventEvolutionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = eventEvolutionQueryhelpResponse.restSupported
                sortSupported = eventEvolutionQueryhelpResponse.sortSupported
                typeName = eventEvolutionQueryhelpResponse.typeName
                uri = eventEvolutionQueryhelpResponse.uri
                additionalProperties =
                    eventEvolutionQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EventEvolutionQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EventEvolutionQueryhelpResponse =
            EventEvolutionQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): EventEvolutionQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
