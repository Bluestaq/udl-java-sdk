...
class EphemerisSetFileRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EphemerisSetFileRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EphemerisSetFileRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetFileRetrieveParams: EphemerisSetFileRetrieveParams) =
            apply {
    ...
    override fun toString() = "EphemerisSetFileRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
