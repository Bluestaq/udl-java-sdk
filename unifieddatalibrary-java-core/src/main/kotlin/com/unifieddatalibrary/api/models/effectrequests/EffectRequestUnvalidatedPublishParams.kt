...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * The indicator of deadline of the bid request (e.g. BETWEEN, IMMEDIATE, NOEARLIERTHAN,
             * NOLATERTHAN, etc.): BETWEEN:&nbsp;Produce effect any time between the given start and
             * end times, equal penalty for being early or late IMMEDIATE:&nbsp;Start as soon as
             * possible, earlier is always better NOEARLIERTHAN:&nbsp;Produce effect at this time or
             * later. Large penalty for being earlier, no reward for being later
