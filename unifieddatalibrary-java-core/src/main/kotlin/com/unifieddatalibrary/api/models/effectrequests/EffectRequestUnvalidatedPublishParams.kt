...
class EffectRequestUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectRequestUnvalidatedPublishParams].
         *
    ...
    /** A builder for [EffectRequestUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestUnvalidatedPublishParams: EffectRequestUnvalidatedPublishParams) =
            apply {
                body = effectRequestUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = effectRequestUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectRequestUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): EffectRequestUnvalidatedPublishParams =
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("externalRequestId") @ExcludeMissing private val externalRequestId: JsonField<String>,
        @JsonProperty("metricTypes") @ExcludeMissing private val metricTypes: JsonField<List<String>>,
        @JsonProperty("metricWeights") @ExcludeMissing private val metricWeights: JsonField<List<Double>>,
        ...
        @ExcludeMissing
        fun _modelClass(): JsonField<String> = modelClass
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    effectList = body.effectList.map { it.toMutableList() }
                    source = body.source
                    id = body.id
                    ...
                    metricTypes = body.metricTypes.map { it.toMutableList() }
                    metricWeights = body.metricWeights.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.effectList] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun effectList(effectList: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addEffectList(effectList: String) =
                apply {
                    this.effectList = (this.effectList ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.deadlineType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun deadlineType(deadlineType: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.metricTypes] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun metricTypes(metricTypes: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addMetricType(metricType: String) =
                apply {
                    metricTypes = (metricTypes ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.metricWeights] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun metricWeights(metricWeights: JsonField<List<Double>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addMetricWeight(metricWeight: Double) =
                apply {
                    metricWeights = (metricWeights ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.modelClass] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun modelClass(modelClass: JsonField<String>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (effectList.asKnown().getOrNull()?.size ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (context.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (deadlineType.asKnown().isPresent) 1 else 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (externalRequestId.asKnown().isPresent) 1 else 0) + (metricTypes.asKnown().getOrNull()?.size ?: 0) + (metricWeights.asKnown().getOrNull()?.size ?: 0) + (if (modelClass.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (priority.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (state.asKnown().isPresent) 1 else 0) + (if (targetSrcId.asKnown().isPresent) 1 else 0) + (if (targetSrcType.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectRequestUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "EffectRequestUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
