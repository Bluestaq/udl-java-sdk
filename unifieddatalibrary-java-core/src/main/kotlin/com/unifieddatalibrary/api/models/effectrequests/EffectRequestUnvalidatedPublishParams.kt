...
/**
 * Service operation to take multiple EffectRequests as a POST body and ingest into the database.
 * This operation is intended to be used for automated feeds into UDL. A specific role is required
 * to perform this service operation. Please contact the UDL team for assistance.
 */
class EffectRequestUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            effectRequestUnvalidatedPublishParams: EffectRequestUnvalidatedPublishParams
        ) = apply {
            ...
            additionalQueryParams =
                effectRequestUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    private constructor(
         ...
         * NOLATERTHAN, etc.):
         *
         * BETWEEN: Produce effect any time between the given start and end times, equal penalty for
         * being early or late.
         *
         * IMMEDIATE: Start as soon as possible, earlier is always better.
         *
         * NOEARLIERTHAN: Produce effect at this time or later. Large penalty for being earlier, no
         * reward for being later.
         *
         * NOLATERTHAN: Produce effect no later than the given startTime. Large penalty for being
         * later, no reward for being even earlier as long as the effect starts by the given time.
         *
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type
         *   (e.g. if the server responded with an unexpected value).
         */
         ...
         *
         * Unlike [deadlineType], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("deadlineType")
        @ExcludeMissing
         ...
         *
         * Unlike [metricWeights], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("metricWeights")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * List of effects to be achieved on the target (e.g. COVER, DECEIVE, DEGRADE, DENY,
             * DESTROY, DISRUPT, DIVERSION, DIVERT, FIX, INSPECT, INTERCEPT, ISOLATE, MANIPULATE,
             * NEUTRALIZE, SHADOW, SUPPRESS, etc.). The effects included in this list are connected
             * by implied AND.
             */
             ...
             * NOLATERTHAN, etc.):
             *
             * BETWEEN: Produce effect any time between the given start and end times, equal penalty
             * for being early or late.
             *
             * IMMEDIATE: Start as soon as possible, earlier is always better.
             *
             * NOEARLIERTHAN: Produce effect at this time or later. Large penalty for being earlier,
             * no reward for being later.
             *
             * NOLATERTHAN: Produce effect no later than the given startTime. Large penalty for
             * being later, no reward for being even earlier as long as the effect starts by the
             * given time.
             */
             ...
             *
             * You should usually call [Builder.deadlineType] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * 'metricWeights' array for the weighting values, positionally corresponding to these
             * types. The 'metricTypes' and 'metricWeights' arrays must match in size.
             */
            ...
            /**
             * Array of the weights for the metric in the final evaluation score. Normalized (0 to
             * 1). See the associated 'metricTypes' array for the metric classes, positionally
             * corresponding to these values. The 'metricTypes' and 'metricWeights' arrays must
             * match in size.
             */
            fun metricWeights(metricWeights: List<Double>) =
                metricWeights(JsonField.of(metricWeights))

            /**
             * Sets [Builder.metricWeights] to an arbitrary JSON value.
             *
             * You should usually call [Builder.metricWeights] with a well-typed `List<Double>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.modelClass] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EffectRequestUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EffectRequestUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
