 ...
 */
class WeatherReportCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WeatherReportCountParams].
         *
    ...
    /** A builder for [WeatherReportCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherReportCountParams: WeatherReportCountParams) = apply {
            obTime = weatherReportCountParams.obTime
            firstResult = weatherReportCountParams.firstResult
            maxResults = weatherReportCountParams.maxResults
            additionalHeaders = weatherReportCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = weatherReportCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WeatherReportCountParams].
         *
         ...
         */
        fun build(): WeatherReportCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WeatherReportCountParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "WeatherReportCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
