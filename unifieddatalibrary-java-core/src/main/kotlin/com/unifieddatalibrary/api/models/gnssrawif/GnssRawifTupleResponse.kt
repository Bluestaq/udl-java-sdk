...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gnssRawIfTupleResponse: GnssRawIfTupleResponse) = apply {
    ...
    fun validate(): GnssRawIfTupleResponse = apply {
        if (validated) {
            return@apply
        }
