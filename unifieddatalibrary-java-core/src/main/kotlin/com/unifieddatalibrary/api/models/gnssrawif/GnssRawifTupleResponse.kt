...
class GnssRawIfTupleResponse private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("centerFreq") @ExcludeMissing centerFreq: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("boresight") @ExcludeMissing boresight: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("diffCodeBias") @ExcludeMissing diffCodeBias: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("postFourier") @ExcludeMissing postFourier: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("sampleRate") @ExcludeMissing sampleRate: JsonField<List<Int>> = JsonMissing.of(),
        @JsonProperty("sampleType") @ExcludeMissing sampleType: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _bitDepth(): JsonField<Int> = bitDepth
    ...
    @ExcludeMissing
    fun _dataRate(): JsonField<Double> = dataRate
    ...
    @JsonProperty("ifFreq")
    @ExcludeMissing
    fun _ifFreq(): JsonField<List<Double>> = ifFreq
    ...
    @JsonProperty("quat")
    @ExcludeMissing
    fun _quat(): JsonField<List<Double>> = quat
    ...
    @ExcludeMissing
    fun _receiver(): JsonField<String> = receiver
    ...
    @ExcludeMissing
    fun _sampleRate(): JsonField<List<Int>> = sampleRate
    ...
    @ExcludeMissing
    fun _sampleType(): JsonField<String> = sampleType
    ...
    @JsonProperty("setId")
    @ExcludeMissing
    fun _setId(): JsonField<String> = setId
     ...
     */
    @JsonProperty("setLength")
    @ExcludeMissing
    fun _setLength(): JsonField<Int> = setLength
    ...
    @ExcludeMissing
    fun _startIndex(): JsonField<Int> = startIndex
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GnssRawIfTupleResponse].
         *
    ...
    /** A builder for [GnssRawIfTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gnssRawIfTupleResponse: GnssRawIfTupleResponse) =
            apply {
                centerFreq = gnssRawIfTupleResponse.centerFreq.map { it.toMutableList() }
                classificationMarking = gnssRawIfTupleResponse.classificationMarking
                dataMode = gnssRawIfTupleResponse.dataMode
                endTime = gnssRawIfTupleResponse.endTime
                fileName = gnssRawIfTupleResponse.fileName
                source = gnssRawIfTupleResponse.source
                startTime = gnssRawIfTupleResponse.startTime
                id = gnssRawIfTupleResponse.id
                bitDepth = gnssRawIfTupleResponse.bitDepth
                boresight = gnssRawIfTupleResponse.boresight.map { it.toMutableList() }
                createdAt = gnssRawIfTupleResponse.createdAt
                createdBy = gnssRawIfTupleResponse.createdBy
                dataRate = gnssRawIfTupleResponse.dataRate
                diffCodeBias = gnssRawIfTupleResponse.diffCodeBias.map { it.toMutableList() }
                endAlt = gnssRawIfTupleResponse.endAlt
                endLat = gnssRawIfTupleResponse.endLat
                endLon = gnssRawIfTupleResponse.endLon
                esId = gnssRawIfTupleResponse.esId
                eventId = gnssRawIfTupleResponse.eventId
                fileSize = gnssRawIfTupleResponse.fileSize
                idOnOrbit = gnssRawIfTupleResponse.idOnOrbit
                ifFreq = gnssRawIfTupleResponse.ifFreq.map { it.toMutableList() }
                origin = gnssRawIfTupleResponse.origin
                origNetwork = gnssRawIfTupleResponse.origNetwork
                origObjectId = gnssRawIfTupleResponse.origObjectId
                postFourier = gnssRawIfTupleResponse.postFourier.map { it.toMutableList() }
                quat = gnssRawIfTupleResponse.quat.map { it.toMutableList() }
                receiver = gnssRawIfTupleResponse.receiver
                sampleRate = gnssRawIfTupleResponse.sampleRate.map { it.toMutableList() }
                sampleType = gnssRawIfTupleResponse.sampleType
                satNo = gnssRawIfTupleResponse.satNo
                sequenceId = gnssRawIfTupleResponse.sequenceId
                setId = gnssRawIfTupleResponse.setId
                setLength = gnssRawIfTupleResponse.setLength
                srcIds = gnssRawIfTupleResponse.srcIds.map { it.toMutableList() }
                srcTyps = gnssRawIfTupleResponse.srcTyps.map { it.toMutableList() }
                startAlt = gnssRawIfTupleResponse.startAlt
                startIndex = gnssRawIfTupleResponse.startIndex
                startLat = gnssRawIfTupleResponse.startLat
                startLon = gnssRawIfTupleResponse.startLon
                tags = gnssRawIfTupleResponse.tags.map { it.toMutableList() }
                additionalProperties = gnssRawIfTupleResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.centerFreq] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun centerFreq(centerFreq: JsonField<List<Double>>) =
            apply {
         ...
         */
        fun addCenterFreq(centerFreq: Double) =
            apply {
                this.centerFreq = (this.centerFreq ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.bitDepth] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun bitDepth(bitDepth: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.boresight] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun boresight(boresight: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addBoresight(boresight: Double) =
            apply {
                this.boresight = (this.boresight ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.dataRate] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dataRate(dataRate: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.diffCodeBias] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun diffCodeBias(diffCodeBias: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addDiffCodeBia(diffCodeBia: Double) =
            apply {
                diffCodeBias = (diffCodeBias ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.ifFreq] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ifFreq(ifFreq: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addIfFreq(ifFreq: Double) =
            apply {
                this.ifFreq = (this.ifFreq ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.postFourier] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun postFourier(postFourier: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPostFourier(postFourier: String) =
            apply {
                this.postFourier = (this.postFourier ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.quat] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun quat(quat: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addQuat(quat: Double) =
            apply {
                this.quat = (this.quat ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.receiver] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun receiver(receiver: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.sampleRate] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sampleRate(sampleRate: JsonField<List<Int>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSampleRate(sampleRate: Int) =
            apply {
                this.sampleRate = (this.sampleRate ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.sampleType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sampleType(sampleType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.setId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun setId(setId: JsonField<String>) =
            apply {
                this.setId = setId
            }
         ...
         *
         * You should usually call [Builder.setLength] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun setLength(setLength: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.startIndex] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun startIndex(startIndex: JsonField<Int>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [GnssRawIfTupleResponse].
         *
         ...
         */
        fun build(): GnssRawIfTupleResponse =
    ...
    fun validate(): GnssRawIfTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (centerFreq.asKnown().getOrNull()?.size ?: 0) + (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (fileName.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (bitDepth.asKnown().isPresent) 1 else 0) + (boresight.asKnown().getOrNull()?.size ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (dataRate.asKnown().isPresent) 1 else 0) + (diffCodeBias.asKnown().getOrNull()?.size ?: 0) + (if (endAlt.asKnown().isPresent) 1 else 0) + (if (endLat.asKnown().isPresent) 1 else 0) + (if (endLon.asKnown().isPresent) 1 else 0) + (if (esId.asKnown().isPresent) 1 else 0) + (if (eventId.asKnown().isPresent) 1 else 0) + (if (fileSize.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (ifFreq.asKnown().getOrNull()?.size ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (postFourier.asKnown().getOrNull()?.size ?: 0) + (quat.asKnown().getOrNull()?.size ?: 0) + (if (receiver.asKnown().isPresent) 1 else 0) + (sampleRate.asKnown().getOrNull()?.size ?: 0) + (if (sampleType.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (sequenceId.asKnown().isPresent) 1 else 0) + (if (setId.asKnown().isPresent) 1 else 0) + (if (setLength.asKnown().isPresent) 1 else 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (if (startAlt.asKnown().isPresent) 1 else 0) + (if (startIndex.asKnown().isPresent) 1 else 0) + (if (startLat.asKnown().isPresent) 1 else 0) + (if (startLon.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0)
