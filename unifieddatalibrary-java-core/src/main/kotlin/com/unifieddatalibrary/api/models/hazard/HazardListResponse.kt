...
class HazardListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("alarmValues") @ExcludeMissing alarmValues: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("classificationMarking") @ExcludeMissing classificationMarking: JsonField<String> = JsonMissing.of(),
        @JsonProperty("dataMode") @ExcludeMissing dataMode: JsonField<DataMode> = JsonMissing.of(),
        @JsonProperty("detectTime") @ExcludeMissing detectTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("detectType") @ExcludeMissing detectType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("readings") @ExcludeMissing readings: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("readingUnits") @ExcludeMissing readingUnits: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("readingValues") @ExcludeMissing readingValues: JsonField<List<Double>> = JsonMissing.of(),
    ...
    @JsonProperty("alarms")
    @ExcludeMissing
    fun _alarms(): JsonField<List<String>> = alarms
    ...
    @ExcludeMissing
    fun _detectType(): JsonField<String> = detectType
    ...
    @ExcludeMissing
    fun _activity(): JsonField<Double> = activity
    ...
    @ExcludeMissing
    fun _bottleId(): JsonField<String> = bottleId
    ...
    @JsonProperty("casRN")
    @ExcludeMissing
    fun _casRn(): JsonField<String> = casRn
    ...
    @ExcludeMissing
    fun _ctrnTime(): JsonField<Double> = ctrnTime
    ...
    @ExcludeMissing
    fun _density(): JsonField<Double> = density
     ...
     */
    @JsonProperty("depCtrn")
    @ExcludeMissing
    fun _depCtrn(): JsonField<Double> = depCtrn
    ...
    @JsonProperty("dose")
    @ExcludeMissing
    fun _dose(): JsonField<Double> = dose
    ...
    @ExcludeMissing
    fun _doseRate(): JsonField<Double> = doseRate
    ...
    @JsonProperty("gBar")
    @ExcludeMissing
    fun _gBar(): JsonField<Double> = gBar
     ...
     */
    @JsonProperty("harmful")
    @ExcludeMissing
    fun _harmful(): JsonField<Boolean> = harmful
    ...
    @JsonProperty("hBar")
    @ExcludeMissing
    fun _hBar(): JsonField<Double> = hBar
    ...
    @ExcludeMissing
    fun _massFrac(): JsonField<Double> = massFrac
    ...
    @JsonProperty("matCat")
    @ExcludeMissing
    fun _matCat(): JsonField<Int> = matCat
    ...
    @ExcludeMissing
    fun _matClass(): JsonField<String> = matClass
    ...
    @ExcludeMissing
    fun _matName(): JsonField<String> = matName
    ...
    @ExcludeMissing
    fun _matType(): JsonField<String> = matType
     ...
     */
    @JsonProperty("radCtrn")
    @ExcludeMissing
    fun _radCtrn(): JsonField<Double> = radCtrn
    ...
    @ExcludeMissing
    fun _readings(): JsonField<List<String>> = readings
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HazardListResponse].
         *
    ...
    /** A builder for [HazardListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardListResponse: HazardListResponse) =
            apply {
                alarms = hazardListResponse.alarms.map { it.toMutableList() }
                alarmValues = hazardListResponse.alarmValues.map { it.toMutableList() }
                classificationMarking = hazardListResponse.classificationMarking
                dataMode = hazardListResponse.dataMode
                detectTime = hazardListResponse.detectTime
                detectType = hazardListResponse.detectType
                source = hazardListResponse.source
                id = hazardListResponse.id
                a = hazardListResponse.a
                activity = hazardListResponse.activity
                bottleId = hazardListResponse.bottleId
                casRn = hazardListResponse.casRn
                channel = hazardListResponse.channel
                createdAt = hazardListResponse.createdAt
                createdBy = hazardListResponse.createdBy
                ctrnTime = hazardListResponse.ctrnTime
                density = hazardListResponse.density
                dep = hazardListResponse.dep
                depCtrn = hazardListResponse.depCtrn
                dose = hazardListResponse.dose
                doseRate = hazardListResponse.doseRate
                duration = hazardListResponse.duration
                gBar = hazardListResponse.gBar
                harmful = hazardListResponse.harmful
                hBar = hazardListResponse.hBar
                idPoi = hazardListResponse.idPoi
                idTrack = hazardListResponse.idTrack
                massFrac = hazardListResponse.massFrac
                matCat = hazardListResponse.matCat
                matClass = hazardListResponse.matClass
                matName = hazardListResponse.matName
                matType = hazardListResponse.matType
                origin = hazardListResponse.origin
                origNetwork = hazardListResponse.origNetwork
                ppm = hazardListResponse.ppm
                radCtrn = hazardListResponse.radCtrn
                readings = hazardListResponse.readings.map { it.toMutableList() }
                readingUnits = hazardListResponse.readingUnits.map { it.toMutableList() }
                readingValues = hazardListResponse.readingValues.map { it.toMutableList() }
                z = hazardListResponse.z
                additionalProperties = hazardListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.alarms] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alarms(alarms: JsonField<List<String>>) =
            apply {
        ...
        fun addAlarm(alarm: String) =
            apply {
                alarms = (alarms ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.alarmValues] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alarmValues(alarmValues: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAlarmValue(alarmValue: Double) =
            apply {
                alarmValues = (alarmValues ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.detectTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun detectTime(detectTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.detectType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun detectType(detectType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.a] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun a(a: JsonField<Int>) =
            apply {
                this.a = a
            }
         ...
         *
         * You should usually call [Builder.activity] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun activity(activity: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.bottleId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun bottleId(bottleId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.casRn] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun casRn(casRn: JsonField<String>) =
            apply {
                this.casRn = casRn
            }
         ...
         *
         * You should usually call [Builder.channel] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun channel(channel: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.ctrnTime] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ctrnTime(ctrnTime: JsonField<Double>) =
            apply {
                this.ctrnTime = ctrnTime
            }
         ...
         *
         * You should usually call [Builder.density] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun density(density: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.dep] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dep(dep: JsonField<Double>) =
            apply {
                this.dep = dep
            }
         ...
         *
         * You should usually call [Builder.depCtrn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depCtrn(depCtrn: JsonField<Double>) =
            apply {
                this.depCtrn = depCtrn
            }
         ...
         *
         * You should usually call [Builder.dose] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dose(dose: JsonField<Double>) =
            apply {
                this.dose = dose
            }
         ...
         *
         * You should usually call [Builder.doseRate] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun doseRate(doseRate: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.gBar] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun gBar(gBar: JsonField<Double>) =
            apply {
                this.gBar = gBar
            }
         ...
         *
         * You should usually call [Builder.harmful] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun harmful(harmful: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.hBar] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hBar(hBar: JsonField<Double>) =
            apply {
                this.hBar = hBar
            }
         ...
         *
         * You should usually call [Builder.massFrac] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun massFrac(massFrac: JsonField<Double>) =
            apply {
                this.massFrac = massFrac
            }
         ...
         *
         * You should usually call [Builder.matCat] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun matCat(matCat: JsonField<Int>) =
            apply {
                this.matCat = matCat
            }
         ...
         *
         * You should usually call [Builder.matClass] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun matClass(matClass: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.matName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun matName(matName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.matType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun matType(matType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.ppm] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ppm(ppm: JsonField<Int>) =
            apply {
                this.ppm = ppm
            }
         ...
         *
         * You should usually call [Builder.radCtrn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun radCtrn(radCtrn: JsonField<Double>) =
            apply {
                this.radCtrn = radCtrn
            }
         ...
         *
         * You should usually call [Builder.readings] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun readings(readings: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addReading(reading: String) =
            apply {
                readings = (readings ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.readingUnits] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun readingUnits(readingUnits: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addReadingUnit(readingUnit: String) =
            apply {
                readingUnits = (readingUnits ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.readingValues] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun readingValues(readingValues: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addReadingValue(readingValue: Double) =
            apply {
                readingValues = (readingValues ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.z] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun z(z: JsonField<Int>) =
            apply {
                this.z = z
            }
        ...
        /**
         * Returns an immutable instance of [HazardListResponse].
         *
    ...
    fun validate(): HazardListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (alarms.asKnown().getOrNull()?.size ?: 0) + (alarmValues.asKnown().getOrNull()?.size ?: 0) + (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (detectTime.asKnown().isPresent) 1 else 0) + (if (detectType.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (a.asKnown().isPresent) 1 else 0) + (if (activity.asKnown().isPresent) 1 else 0) + (if (bottleId.asKnown().isPresent) 1 else 0) + (if (casRn.asKnown().isPresent) 1 else 0) + (if (channel.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (ctrnTime.asKnown().isPresent) 1 else 0) + (if (density.asKnown().isPresent) 1 else 0) + (if (dep.asKnown().isPresent) 1 else 0) + (if (depCtrn.asKnown().isPresent) 1 else 0) + (if (dose.asKnown().isPresent) 1 else 0) + (if (doseRate.asKnown().isPresent) 1 else 0) + (if (duration.asKnown().isPresent) 1 else 0) + (if (gBar.asKnown().isPresent) 1 else 0) + (if (harmful.asKnown().isPresent) 1 else 0) + (if (hBar.asKnown().isPresent) 1 else 0) + (if (idPoi.asKnown().isPresent) 1 else 0) + (if (idTrack.asKnown().isPresent) 1 else 0) + (if (massFrac.asKnown().isPresent) 1 else 0) + (if (matCat.asKnown().isPresent) 1 else 0) + (if (matClass.asKnown().isPresent) 1 else 0) + (if (matName.asKnown().isPresent) 1 else 0) + (if (matType.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (ppm.asKnown().isPresent) 1 else 0) + (if (radCtrn.asKnown().isPresent) 1 else 0) + (readings.asKnown().getOrNull()?.size ?: 0) + (readingUnits.asKnown().getOrNull()?.size ?: 0) + (readingValues.asKnown().getOrNull()?.size ?: 0) + (if (z.asKnown().isPresent) 1 else 0)
