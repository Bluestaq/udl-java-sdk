...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hazardListResponse: HazardListResponse) = apply {
    ...
    fun validate(): HazardListResponse = apply {
        if (validated) {
            return@apply
        }
