...
class EngineDetailRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EngineDetailRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(engineDetailRetrieveParams: EngineDetailRetrieveParams) =
            apply {
    ...
    override fun toString() = "EngineDetailRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
