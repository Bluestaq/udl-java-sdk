...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatalinkTupleParams].
         *
    ...
    /** A builder for [DatalinkTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datalinkTupleParams: DatalinkTupleParams) = apply {
            columns = datalinkTupleParams.columns
            startTime = datalinkTupleParams.startTime
            firstResult = datalinkTupleParams.firstResult
            maxResults = datalinkTupleParams.maxResults
            additionalHeaders = datalinkTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = datalinkTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DatalinkTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DatalinkTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "DatalinkTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
