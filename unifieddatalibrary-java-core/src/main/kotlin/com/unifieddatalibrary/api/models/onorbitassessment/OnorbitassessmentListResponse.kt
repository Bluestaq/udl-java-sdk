 ...
 */
class OnorbitassessmentListResponse
...
private constructor(
    ...
    /** A builder for [OnorbitassessmentListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitassessmentListResponse: OnorbitassessmentListResponse) = apply {
            assmtTime = onorbitassessmentListResponse.assmtTime
            classificationMarking = onorbitassessmentListResponse.classificationMarking
            dataMode = onorbitassessmentListResponse.dataMode
            source = onorbitassessmentListResponse.source
            id = onorbitassessmentListResponse.id
            assessment = onorbitassessmentListResponse.assessment
            assmtDetails = onorbitassessmentListResponse.assmtDetails
            assmtLevel = onorbitassessmentListResponse.assmtLevel
            assmtRotPeriod = onorbitassessmentListResponse.assmtRotPeriod
            assmtSubType = onorbitassessmentListResponse.assmtSubType
            assmtUrl = onorbitassessmentListResponse.assmtUrl
            autoAssmt = onorbitassessmentListResponse.autoAssmt
            collectionUrl = onorbitassessmentListResponse.collectionUrl
            components = onorbitassessmentListResponse.components.map { it.toMutableList() }
            createdAt = onorbitassessmentListResponse.createdAt
            createdBy = onorbitassessmentListResponse.createdBy
            idOnOrbit = onorbitassessmentListResponse.idOnOrbit
            idSensor = onorbitassessmentListResponse.idSensor
            obDuration = onorbitassessmentListResponse.obDuration
            obTime = onorbitassessmentListResponse.obTime
            origin = onorbitassessmentListResponse.origin
            origNetwork = onorbitassessmentListResponse.origNetwork
            origObjectId = onorbitassessmentListResponse.origObjectId
            origSensorId = onorbitassessmentListResponse.origSensorId
            satNo = onorbitassessmentListResponse.satNo
            sigDataType = onorbitassessmentListResponse.sigDataType
            sourceDl = onorbitassessmentListResponse.sourceDl
            srcIds = onorbitassessmentListResponse.srcIds.map { it.toMutableList() }
            srcTyps = onorbitassessmentListResponse.srcTyps.map { it.toMutableList() }
            transactionId = onorbitassessmentListResponse.transactionId
            additionalProperties = onorbitassessmentListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitassessmentListResponse].
         *
         ...
         */
        fun build(): OnorbitassessmentListResponse =
            OnorbitassessmentListResponse(
    ...
    fun validate(): OnorbitassessmentListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitassessmentListResponse &&
