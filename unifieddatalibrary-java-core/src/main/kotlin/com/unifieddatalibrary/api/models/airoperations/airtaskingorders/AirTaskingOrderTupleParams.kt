...
class AirTaskingOrderTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirTaskingOrderTupleParams].
         *
    ...
    /** A builder for [AirTaskingOrderTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderTupleParams: AirTaskingOrderTupleParams) =
            apply {
                columns = airTaskingOrderTupleParams.columns
                firstResult = airTaskingOrderTupleParams.firstResult
                maxResults = airTaskingOrderTupleParams.maxResults
                additionalHeaders = airTaskingOrderTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = airTaskingOrderTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirTaskingOrderTupleParams].
         *
         ...
         */
        fun build(): AirTaskingOrderTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirTaskingOrderTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirTaskingOrderTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
