 ...
 */
class LaserdeconflictrequestGetResponse
...
private constructor(
    ...
    /** A builder for [LaserdeconflictrequestGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(laserdeconflictrequestGetResponse: LaserdeconflictrequestGetResponse) =
            apply {
                classificationMarking = laserdeconflictrequestGetResponse.classificationMarking
                dataMode = laserdeconflictrequestGetResponse.dataMode
                endDate = laserdeconflictrequestGetResponse.endDate
                idLaserEmitters =
                    laserdeconflictrequestGetResponse.idLaserEmitters.map { it.toMutableList() }
                numTargets = laserdeconflictrequestGetResponse.numTargets
                requestId = laserdeconflictrequestGetResponse.requestId
                requestTs = laserdeconflictrequestGetResponse.requestTs
                source = laserdeconflictrequestGetResponse.source
                startDate = laserdeconflictrequestGetResponse.startDate
                id = laserdeconflictrequestGetResponse.id
                centerlineAzimuth = laserdeconflictrequestGetResponse.centerlineAzimuth
                centerlineElevation = laserdeconflictrequestGetResponse.centerlineElevation
                createdAt = laserdeconflictrequestGetResponse.createdAt
                createdBy = laserdeconflictrequestGetResponse.createdBy
                defaultCha = laserdeconflictrequestGetResponse.defaultCha
                enableDss = laserdeconflictrequestGetResponse.enableDss
                fixedPoints =
                    laserdeconflictrequestGetResponse.fixedPoints.map { it.toMutableList() }
                geopotentialModel = laserdeconflictrequestGetResponse.geopotentialModel
                idOnOrbit = laserdeconflictrequestGetResponse.idOnOrbit
                laserDeconflictTargets =
                    laserdeconflictrequestGetResponse.laserDeconflictTargets.map {
                        it.toMutableList()
                    }
                laserSystemName = laserdeconflictrequestGetResponse.laserSystemName
                lengthCenterline = laserdeconflictrequestGetResponse.lengthCenterline
                lengthLeftRight = laserdeconflictrequestGetResponse.lengthLeftRight
                lengthUpDown = laserdeconflictrequestGetResponse.lengthUpDown
                maximumHeight = laserdeconflictrequestGetResponse.maximumHeight
                minimumHeight = laserdeconflictrequestGetResponse.minimumHeight
                missionName = laserdeconflictrequestGetResponse.missionName
                origin = laserdeconflictrequestGetResponse.origin
                origNetwork = laserdeconflictrequestGetResponse.origNetwork
                origObjectId = laserdeconflictrequestGetResponse.origObjectId
                platformLocationName = laserdeconflictrequestGetResponse.platformLocationName
                platformLocationType = laserdeconflictrequestGetResponse.platformLocationType
                programId = laserdeconflictrequestGetResponse.programId
                propagator = laserdeconflictrequestGetResponse.propagator
                protectList =
                    laserdeconflictrequestGetResponse.protectList.map { it.toMutableList() }
                satNo = laserdeconflictrequestGetResponse.satNo
                sourceDl = laserdeconflictrequestGetResponse.sourceDl
                sourceEnabled = laserdeconflictrequestGetResponse.sourceEnabled
                status = laserdeconflictrequestGetResponse.status
                tags = laserdeconflictrequestGetResponse.tags.map { it.toMutableList() }
                targetEnabled = laserdeconflictrequestGetResponse.targetEnabled
                targetType = laserdeconflictrequestGetResponse.targetType
                transactionId = laserdeconflictrequestGetResponse.transactionId
                treatEarthAs = laserdeconflictrequestGetResponse.treatEarthAs
                useFieldOfRegard = laserdeconflictrequestGetResponse.useFieldOfRegard
                victimEnabled = laserdeconflictrequestGetResponse.victimEnabled
                additionalProperties =
                    laserdeconflictrequestGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LaserdeconflictrequestGetResponse].
         *
         ...
         */
        fun build(): LaserdeconflictrequestGetResponse =
            LaserdeconflictrequestGetResponse(
    ...
    fun validate(): LaserdeconflictrequestGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LaserdeconflictrequestGetResponse &&
            classificationMarking == other.classificationMarking &&
            dataMode == other.dataMode &&
