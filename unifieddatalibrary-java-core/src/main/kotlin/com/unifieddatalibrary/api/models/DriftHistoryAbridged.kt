...
class DriftHistoryAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DriftHistoryAbridged].
         *
    ...
    /** A builder for [DriftHistoryAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(driftHistoryAbridged: DriftHistoryAbridged) =
            apply {
                classificationMarking = driftHistoryAbridged.classificationMarking
                dataMode = driftHistoryAbridged.dataMode
                source = driftHistoryAbridged.source
                id = driftHistoryAbridged.id
                createdBy = driftHistoryAbridged.createdBy
                driftRate = driftHistoryAbridged.driftRate
                effectiveUntil = driftHistoryAbridged.effectiveUntil
                idOnOrbit = driftHistoryAbridged.idOnOrbit
                origin = driftHistoryAbridged.origin
                additionalProperties = driftHistoryAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DriftHistoryAbridged].
         *
         ...
         */
        fun build(): DriftHistoryAbridged =
    ...
    fun validate(): DriftHistoryAbridged =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "DriftHistoryAbridged{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, createdBy=$createdBy, driftRate=$driftRate, effectiveUntil=$effectiveUntil, idOnOrbit=$idOnOrbit, origin=$origin, additionalProperties=$additionalProperties}"
}
