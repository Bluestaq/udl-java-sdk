...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(driftHistoryAbridged: DriftHistoryAbridged) = apply {
    ...
    fun validate(): DriftHistoryAbridged = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "DriftHistoryAbridged{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, createdBy=$createdBy, driftRate=$driftRate, effectiveUntil=$effectiveUntil, idOnOrbit=$idOnOrbit, origin=$origin, additionalProperties=$additionalProperties}"
}
