...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftFull].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftFull: AircraftFull) = apply {
            aircraftMds = aircraftFull.aircraftMds
            classificationMarking = aircraftFull.classificationMarking
            dataMode = aircraftFull.dataMode
            source = aircraftFull.source
            id = aircraftFull.id
            category = aircraftFull.category
            command = aircraftFull.command
            createdAt = aircraftFull.createdAt
            createdBy = aircraftFull.createdBy
            cruiseSpeed = aircraftFull.cruiseSpeed
            dtd = aircraftFull.dtd
            entity = aircraftFull.entity
            idEntity = aircraftFull.idEntity
            maxSpeed = aircraftFull.maxSpeed
            minReqRunwayFt = aircraftFull.minReqRunwayFt
            minReqRunwayM = aircraftFull.minReqRunwayM
            nominalTaTime = aircraftFull.nominalTaTime
            notes = aircraftFull.notes
            origin = aircraftFull.origin
            origNetwork = aircraftFull.origNetwork
            owner = aircraftFull.owner
            serialNumber = aircraftFull.serialNumber
            sourceDl = aircraftFull.sourceDl
            tailNumber = aircraftFull.tailNumber
            updatedAt = aircraftFull.updatedAt
            updatedBy = aircraftFull.updatedBy
            additionalProperties = aircraftFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftFull].
         *
    ...
    fun validate(): AircraftFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftFull && aircraftMds == other.aircraftMds && classificationMarking == other.classificationMarking && dataMode == other.dataMode && source == other.source && id == other.id && category == other.category && command == other.command && createdAt == other.createdAt && createdBy == other.createdBy && cruiseSpeed == other.cruiseSpeed && dtd == other.dtd && entity == other.entity && idEntity == other.idEntity && maxSpeed == other.maxSpeed && minReqRunwayFt == other.minReqRunwayFt && minReqRunwayM == other.minReqRunwayM && nominalTaTime == other.nominalTaTime && notes == other.notes && origin == other.origin && origNetwork == other.origNetwork && owner == other.owner && serialNumber == other.serialNumber && sourceDl == other.sourceDl && tailNumber == other.tailNumber && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(aircraftMds, classificationMarking, dataMode, source, id, category, command, createdAt, createdBy, cruiseSpeed, dtd, entity, idEntity, maxSpeed, minReqRunwayFt, minReqRunwayM, nominalTaTime, notes, origin, origNetwork, owner, serialNumber, sourceDl, tailNumber, updatedAt, updatedBy, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AircraftFull{aircraftMds=$aircraftMds, classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, category=$category, command=$command, createdAt=$createdAt, createdBy=$createdBy, cruiseSpeed=$cruiseSpeed, dtd=$dtd, entity=$entity, idEntity=$idEntity, maxSpeed=$maxSpeed, minReqRunwayFt=$minReqRunwayFt, minReqRunwayM=$minReqRunwayM, nominalTaTime=$nominalTaTime, notes=$notes, origin=$origin, origNetwork=$origNetwork, owner=$owner, serialNumber=$serialNumber, sourceDl=$sourceDl, tailNumber=$tailNumber, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
