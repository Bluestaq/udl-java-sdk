...
class LaunchVehicleDetailGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchVehicleDetailGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleDetailGetResponse: LaunchVehicleDetailGetResponse) =
            apply {
                ...
                gtoInj3SigAccuracyApogeeMargin = launchVehicleDetailGetResponse.gtoInj3SigAccuracyApogeeMargin
                gtoInj3SigAccuracyApogeeTarget = launchVehicleDetailGetResponse.gtoInj3SigAccuracyApogeeTarget
                gtoInj3SigAccuracyInclinationMargin = launchVehicleDetailGetResponse.gtoInj3SigAccuracyInclinationMargin
                gtoInj3SigAccuracyInclinationTarget = launchVehicleDetailGetResponse.gtoInj3SigAccuracyInclinationTarget
                gtoInj3SigAccuracyPerigeeMargin = launchVehicleDetailGetResponse.gtoInj3SigAccuracyPerigeeMargin
                gtoInj3SigAccuracyPerigeeTarget = launchVehicleDetailGetResponse.gtoInj3SigAccuracyPerigeeTarget
                ...
                additionalProperties = launchVehicleDetailGetResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): LaunchVehicleDetailGetResponse =
        apply {
            if (validated) {
              return@apply
            }
