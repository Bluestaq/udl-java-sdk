...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmireportTupleResponse].
         *
    ...
    /** A builder for [EmireportTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportTupleResponse: EmireportTupleResponse) = apply {
            classificationMarking = emireportTupleResponse.classificationMarking
            dataMode = emireportTupleResponse.dataMode
            isr = emireportTupleResponse.isr
            reportId = emireportTupleResponse.reportId
            reportTime = emireportTupleResponse.reportTime
            reportType = emireportTupleResponse.reportType
            requestAssist = emireportTupleResponse.requestAssist
            source = emireportTupleResponse.source
            startTime = emireportTupleResponse.startTime
            id = emireportTupleResponse.id
            actionsTaken = emireportTupleResponse.actionsTaken
            affActivity = emireportTupleResponse.affActivity
            alt = emireportTupleResponse.alt
            aor = emireportTupleResponse.aor
            band = emireportTupleResponse.band
            beamPattern = emireportTupleResponse.beamPattern
            channel = emireportTupleResponse.channel
            chanPirate = emireportTupleResponse.chanPirate
            createdAt = emireportTupleResponse.createdAt
            createdBy = emireportTupleResponse.createdBy
            description = emireportTupleResponse.description
            dneImpact = emireportTupleResponse.dneImpact
            emiType = emireportTupleResponse.emiType
            endTime = emireportTupleResponse.endTime
            frequency = emireportTupleResponse.frequency
            geoLocErrEllp = emireportTupleResponse.geoLocErrEllp.map { it.toMutableList() }
            gpsEncrypted = emireportTupleResponse.gpsEncrypted
            gpsFreq = emireportTupleResponse.gpsFreq
            highAffectedFrequency = emireportTupleResponse.highAffectedFrequency
            idOnOrbit = emireportTupleResponse.idOnOrbit
            intercept = emireportTupleResponse.intercept
            interceptLang = emireportTupleResponse.interceptLang
            interceptType = emireportTupleResponse.interceptType
            intSrcAmplitude = emireportTupleResponse.intSrcAmplitude
            intSrcBandwidth = emireportTupleResponse.intSrcBandwidth
            intSrcCentFreq = emireportTupleResponse.intSrcCentFreq
            intSrcEncrypted = emireportTupleResponse.intSrcEncrypted
            intSrcModulation = emireportTupleResponse.intSrcModulation
            isrCollectionImpact = emireportTupleResponse.isrCollectionImpact
            killBox = emireportTupleResponse.killBox
            lat = emireportTupleResponse.lat
            link = emireportTupleResponse.link
            lon = emireportTupleResponse.lon
            milGrid = emireportTupleResponse.milGrid
            onOrbit = emireportTupleResponse.onOrbit
            origin = emireportTupleResponse.origin
            origNetwork = emireportTupleResponse.origNetwork
            origObjectId = emireportTupleResponse.origObjectId
            persistence = emireportTupleResponse.persistence
            platform = emireportTupleResponse.platform
            rcvrDemod = emireportTupleResponse.rcvrDemod
            rcvrGain = emireportTupleResponse.rcvrGain
            rcvrLocation = emireportTupleResponse.rcvrLocation
            rcvrType = emireportTupleResponse.rcvrType
            respService = emireportTupleResponse.respService
            satcomPriority = emireportTupleResponse.satcomPriority
            satDownlinkFrequency = emireportTupleResponse.satDownlinkFrequency
            satDownlinkPolarization = emireportTupleResponse.satDownlinkPolarization
            satName = emireportTupleResponse.satName
            satNo = emireportTupleResponse.satNo
            satTransponderId = emireportTupleResponse.satTransponderId
            satUplinkFrequency = emireportTupleResponse.satUplinkFrequency
            satUplinkPolarization = emireportTupleResponse.satUplinkPolarization
            sourceDl = emireportTupleResponse.sourceDl
            status = emireportTupleResponse.status
            supportedIsrRole = emireportTupleResponse.supportedIsrRole
            system = emireportTupleResponse.system
            tags = emireportTupleResponse.tags.map { it.toMutableList() }
            transactionId = emireportTupleResponse.transactionId
            victimAltCountry = emireportTupleResponse.victimAltCountry
            victimCountryCode = emireportTupleResponse.victimCountryCode
            victimFuncImpacts = emireportTupleResponse.victimFuncImpacts
            victimPocMail = emireportTupleResponse.victimPocMail
            victimPocName = emireportTupleResponse.victimPocName
            victimPocPhone = emireportTupleResponse.victimPocPhone
            victimPocUnit = emireportTupleResponse.victimPocUnit
            victimReaction = emireportTupleResponse.victimReaction
            additionalProperties = emireportTupleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmireportTupleResponse].
         *
         ...
         */
        fun build(): EmireportTupleResponse =
    ...
    fun validate(): EmireportTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportTupleResponse &&
