...
class TransponderTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("channels") @ExcludeMissing channels: JsonField<List<ChannelFull>> = JsonMissing.of(),
        ...
        @JsonProperty("symbolRate") @ExcludeMissing symbolRate: JsonField<Double> = JsonMissing.of(),
    ...
    @JsonProperty("idComm")
    @ExcludeMissing
    fun _idComm(): JsonField<String> = idComm
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransponderTupleResponse].
         *
    ...
    /** A builder for [TransponderTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderTupleResponse: TransponderTupleResponse) =
            apply {
                classificationMarking = transponderTupleResponse.classificationMarking
                dataMode = transponderTupleResponse.dataMode
                idComm = transponderTupleResponse.idComm
                source = transponderTupleResponse.source
                id = transponderTupleResponse.id
                channels = transponderTupleResponse.channels.map { it.toMutableList() }
                createdAt = transponderTupleResponse.createdAt
                createdBy = transponderTupleResponse.createdBy
                fec = transponderTupleResponse.fec
                format = transponderTupleResponse.format
                modulation = transponderTupleResponse.modulation
                name = transponderTupleResponse.name
                nid = transponderTupleResponse.nid
                origin = transponderTupleResponse.origin
                origNetwork = transponderTupleResponse.origNetwork
                symbolRate = transponderTupleResponse.symbolRate
                system = transponderTupleResponse.system
                tid = transponderTupleResponse.tid
                ttf = transponderTupleResponse.ttf
                updatedAt = transponderTupleResponse.updatedAt
                updatedBy = transponderTupleResponse.updatedBy
                additionalProperties = transponderTupleResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.idComm] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idComm(idComm: JsonField<String>) =
            apply {
                this.idComm = idComm
            }
         ...
         *
         * You should usually call [Builder.channels] with a well-typed `List<ChannelFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun channels(channels: JsonField<List<ChannelFull>>) =
            apply {
         ...
         */
        fun addChannel(channel: ChannelFull) =
            apply {
                channels = (channels ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.fec] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fec(fec: JsonField<Int>) =
            apply {
                this.fec = fec
            }
         ...
         *
         * You should usually call [Builder.nid] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nid(nid: JsonField<String>) =
            apply {
                this.nid = nid
            }
         ...
         *
         * You should usually call [Builder.symbolRate] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun symbolRate(symbolRate: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.tid] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tid(tid: JsonField<String>) =
            apply {
                this.tid = tid
            }
         ...
         *
         * You should usually call [Builder.ttf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ttf(ttf: JsonField<Double>) =
            apply {
                this.ttf = ttf
            }
        ...
        /**
         * Returns an immutable instance of [TransponderTupleResponse].
         *
         ...
         */
        fun build(): TransponderTupleResponse =
    ...
    fun validate(): TransponderTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idComm.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (channels.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (fec.asKnown().isPresent) 1 else 0) + (if (format.asKnown().isPresent) 1 else 0) + (if (modulation.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (nid.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (symbolRate.asKnown().isPresent) 1 else 0) + (if (system.asKnown().isPresent) 1 else 0) + (if (tid.asKnown().isPresent) 1 else 0) + (if (ttf.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
