 ...
 * communications channel between the receiving and the transmitting antennas. It is mainly used in
 * satellite communication to transfer the received signals.
 */
class TransponderTupleResponse
private constructor(
     ...
     */
    @JsonProperty("symbolRate") @ExcludeMissing fun _symbolRate(): JsonField<Double> = symbolRate
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderTupleResponse: TransponderTupleResponse) = apply {
         ...
         *
         * You should usually call [Builder.channels] with a well-typed `List<ChannelFull>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
    ...
    fun validate(): TransponderTupleResponse = apply {
        if (validated) {
            return@apply
        }
