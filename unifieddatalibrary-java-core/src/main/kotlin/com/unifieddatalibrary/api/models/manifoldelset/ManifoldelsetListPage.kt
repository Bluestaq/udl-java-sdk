...
class ManifoldelsetListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetListPage: ManifoldelsetListPage) =
            apply {
        ...
        fun service(service: ManifoldelsetService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ManifoldelsetListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, params, items) /* spotless:on */

    override fun toString() = "ManifoldelsetListPage{service=$service, params=$params, items=$items}"
}
