...
class ElsetRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ElsetRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ElsetRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ElsetRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elsetRetrieveParams: ElsetRetrieveParams) =
            apply {
                id = elsetRetrieveParams.id
                firstResult = elsetRetrieveParams.firstResult
                maxResults = elsetRetrieveParams.maxResults
                additionalHeaders = elsetRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = elsetRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ElsetRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ElsetRetrieveParams =
            ElsetRetrieveParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ElsetRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ElsetRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
