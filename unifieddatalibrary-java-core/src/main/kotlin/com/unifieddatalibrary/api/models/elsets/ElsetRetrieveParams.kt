...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ElsetRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elsetRetrieveParams: ElsetRetrieveParams) = apply {
    ...
    override fun toString() =
        "ElsetRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
