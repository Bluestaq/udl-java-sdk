...
class StateVectorCreateParams private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> = stateVectorIngest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorCreateParams: StateVectorCreateParams) =
            apply {
    ...
    override fun toString() = "StateVectorCreateParams{stateVectorIngest=$stateVectorIngest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
