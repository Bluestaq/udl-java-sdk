...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(rfBandListResponse: RfBandListResponse) = apply {
            ...
            bandwidthSettings = rfBandListResponse.bandwidthSettings.map { it.toMutableList() }
            beamwidth = rfBandListResponse.beamwidth
            beamwidthSettings = rfBandListResponse.beamwidthSettings.map { it.toMutableList() }
            centerFreq = rfBandListResponse.centerFreq
            createdAt = rfBandListResponse.createdAt
            createdBy = rfBandListResponse.createdBy
            delaySettings = rfBandListResponse.delaySettings.map { it.toMutableList() }
            ...
            frequencySettings = rfBandListResponse.frequencySettings.map { it.toMutableList() }
            gainSettings = rfBandListResponse.gainSettings.map { it.toMutableList() }
            mode = rfBandListResponse.mode
            noiseSettings = rfBandListResponse.noiseSettings.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RfBandListResponse &&
