...
class RfBandListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfBandListResponse].
         *
    ...
    /** A builder for [RfBandListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandListResponse: RfBandListResponse) =
            apply {
                classificationMarking = rfBandListResponse.classificationMarking
                dataMode = rfBandListResponse.dataMode
                idEntity = rfBandListResponse.idEntity
                name = rfBandListResponse.name
                source = rfBandListResponse.source
                id = rfBandListResponse.id
                band = rfBandListResponse.band
                bandwidth = rfBandListResponse.bandwidth
                beamwidth = rfBandListResponse.beamwidth
                centerFreq = rfBandListResponse.centerFreq
                createdAt = rfBandListResponse.createdAt
                createdBy = rfBandListResponse.createdBy
                edgeGain = rfBandListResponse.edgeGain
                eirp = rfBandListResponse.eirp
                erp = rfBandListResponse.erp
                freqMax = rfBandListResponse.freqMax
                freqMin = rfBandListResponse.freqMin
                mode = rfBandListResponse.mode
                origin = rfBandListResponse.origin
                origNetwork = rfBandListResponse.origNetwork
                peakGain = rfBandListResponse.peakGain
                polarization = rfBandListResponse.polarization
                purpose = rfBandListResponse.purpose
                additionalProperties = rfBandListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RfBandListResponse].
         *
    ...
    fun validate(): RfBandListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfBandListResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idEntity == other.idEntity && name == other.name && source == other.source && id == other.id && band == other.band && bandwidth == other.bandwidth && beamwidth == other.beamwidth && centerFreq == other.centerFreq && createdAt == other.createdAt && createdBy == other.createdBy && edgeGain == other.edgeGain && eirp == other.eirp && erp == other.erp && freqMax == other.freqMax && freqMin == other.freqMin && mode == other.mode && origin == other.origin && origNetwork == other.origNetwork && peakGain == other.peakGain && polarization == other.polarization && purpose == other.purpose && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idEntity, name, source, id, band, bandwidth, beamwidth, centerFreq, createdAt, createdBy, edgeGain, eirp, erp, freqMax, freqMin, mode, origin, origNetwork, peakGain, polarization, purpose, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "RfBandListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idEntity=$idEntity, name=$name, source=$source, id=$id, band=$band, bandwidth=$bandwidth, beamwidth=$beamwidth, centerFreq=$centerFreq, createdAt=$createdAt, createdBy=$createdBy, edgeGain=$edgeGain, eirp=$eirp, erp=$erp, freqMax=$freqMax, freqMin=$freqMin, mode=$mode, origin=$origin, origNetwork=$origNetwork, peakGain=$peakGain, polarization=$polarization, purpose=$purpose, additionalProperties=$additionalProperties}"
}
