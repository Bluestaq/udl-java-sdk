...
class AircraftSortyRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AircraftSortyRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AircraftSortyRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AircraftSortyRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyRetrieveParams: AircraftSortyRetrieveParams) =
            apply {
                id = aircraftSortyRetrieveParams.id
                firstResult = aircraftSortyRetrieveParams.firstResult
                maxResults = aircraftSortyRetrieveParams.maxResults
                additionalHeaders = aircraftSortyRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftSortyRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortyRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AircraftSortyRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftSortyRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AircraftSortyRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
