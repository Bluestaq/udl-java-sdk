 ...
 * parameter.
 */
class AircraftSortyRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AircraftSortyRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyRetrieveParams: AircraftSortyRetrieveParams) = apply {
    ...
    override fun toString() =
        "AircraftSortyRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
