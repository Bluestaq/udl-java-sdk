...
class PassiveRadarObservationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PassiveRadarObservationCountParams].
         *
    ...
    /** A builder for [PassiveRadarObservationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(passiveRadarObservationCountParams: PassiveRadarObservationCountParams) =
            apply {
                obTime = passiveRadarObservationCountParams.obTime
                firstResult = passiveRadarObservationCountParams.firstResult
                maxResults = passiveRadarObservationCountParams.maxResults
                additionalHeaders = passiveRadarObservationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = passiveRadarObservationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PassiveRadarObservationCountParams].
         *
         ...
         */
        fun build(): PassiveRadarObservationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PassiveRadarObservationCountParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "PassiveRadarObservationCountParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
