...
/**
 * Service operation to update a single TAIUTC object. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class TaiUtcUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TaiUtcUpdateParams].
         *
    ...
    /** A builder for [TaiUtcUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taiUtcUpdateParams: TaiUtcUpdateParams) = apply {
            pathId = taiUtcUpdateParams.pathId
            body = taiUtcUpdateParams.body.toBuilder()
            additionalHeaders = taiUtcUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = taiUtcUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TaiUtcUpdateParams].
         *
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && adjustmentDate == other.adjustmentDate && classificationMarking == other.classificationMarking && dataMode == other.dataMode && source == other.source && bodyId == other.bodyId && createdAt == other.createdAt && createdBy == other.createdBy && multiplicationFactor == other.multiplicationFactor && origin == other.origin && origNetwork == other.origNetwork && rawFileUri == other.rawFileUri && taiUtc == other.taiUtc && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(adjustmentDate, classificationMarking, dataMode, source, bodyId, createdAt, createdBy, multiplicationFactor, origin, origNetwork, rawFileUri, taiUtc, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{adjustmentDate=$adjustmentDate, classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, bodyId=$bodyId, createdAt=$createdAt, createdBy=$createdBy, multiplicationFactor=$multiplicationFactor, origin=$origin, origNetwork=$origNetwork, rawFileUri=$rawFileUri, taiUtc=$taiUtc, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TaiUtcUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "TaiUtcUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
