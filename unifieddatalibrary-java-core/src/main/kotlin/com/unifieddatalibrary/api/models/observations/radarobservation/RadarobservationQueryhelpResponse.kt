...
class RadarobservationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RadarobservationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RadarobservationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationQueryhelpResponse: RadarobservationQueryhelpResponse) =
            apply {
                aodrSupported = radarobservationQueryhelpResponse.aodrSupported
                classificationMarking = radarobservationQueryhelpResponse.classificationMarking
                description = radarobservationQueryhelpResponse.description
                historySupported = radarobservationQueryhelpResponse.historySupported
                name = radarobservationQueryhelpResponse.name
                parameters = radarobservationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = radarobservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = radarobservationQueryhelpResponse.restSupported
                sortSupported = radarobservationQueryhelpResponse.sortSupported
                typeName = radarobservationQueryhelpResponse.typeName
                uri = radarobservationQueryhelpResponse.uri
                additionalProperties = radarobservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RadarobservationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RadarobservationQueryhelpResponse =
    ...
    fun validate(): RadarobservationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RadarobservationQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
