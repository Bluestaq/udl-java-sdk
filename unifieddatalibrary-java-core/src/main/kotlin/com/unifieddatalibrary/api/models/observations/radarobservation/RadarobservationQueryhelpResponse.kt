...
class RadarobservationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(radarobservationQueryhelpResponse: RadarobservationQueryhelpResponse) =
            apply {
                ...
                requiredRoles =
                    radarobservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    radarobservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): RadarobservationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
