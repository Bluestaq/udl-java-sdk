...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NavigationCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationCountParams: NavigationCountParams) = apply {
    ...
    override fun toString() =
        "NavigationCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
