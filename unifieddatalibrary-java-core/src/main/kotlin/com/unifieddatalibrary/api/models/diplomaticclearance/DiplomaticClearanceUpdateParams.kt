...
class DiplomaticClearanceUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiplomaticClearanceUpdateParams].
         *
    ...
    /** A builder for [DiplomaticClearanceUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diplomaticClearanceUpdateParams: DiplomaticClearanceUpdateParams) =
            apply {
                pathId = diplomaticClearanceUpdateParams.pathId
                body = diplomaticClearanceUpdateParams.body.toBuilder()
                additionalHeaders = diplomaticClearanceUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = diplomaticClearanceUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DiplomaticClearanceUpdateParams].
         *
         ...
         */
        fun build(): DiplomaticClearanceUpdateParams =
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (firstDepDate.asKnown().isPresent) 1 else 0) + (if (idMission.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (apacsId.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (diplomaticClearanceDetails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (diplomaticClearanceRemarks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (dipWorksheetName.asKnown().isPresent) 1 else 0) + (if (docDeadline.asKnown().isPresent) 1 else 0) + (if (externalWorksheetId.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "DiplomaticClearanceUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
