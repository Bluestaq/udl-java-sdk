...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SubstatusListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SubstatusListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SubstatusListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(substatusListParams: SubstatusListParams) = apply {
            firstResult = substatusListParams.firstResult
            maxResults = substatusListParams.maxResults
            additionalHeaders = substatusListParams.additionalHeaders.toBuilder()
            additionalQueryParams = substatusListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SubstatusListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SubstatusListParams =
            SubstatusListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubstatusListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SubstatusListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
