...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightPlanAbridged: FlightPlanAbridged) = apply {
            ...
            flightPlanPointGroups =
                flightPlanAbridged.flightPlanPointGroups.map { it.toMutableList() }
    ...
    fun validate(): FlightPlanAbridged = apply {
        if (validated) {
            return@apply
        }
