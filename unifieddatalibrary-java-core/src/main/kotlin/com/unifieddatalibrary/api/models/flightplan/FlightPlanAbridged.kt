...
class FlightPlanAbridged private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("airRefuelEvents") @ExcludeMissing airRefuelEvents: JsonField<List<AirRefuelEvent>> = JsonMissing.of(),
        @JsonProperty("amcMissionId") @ExcludeMissing amcMissionId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("appLandingFuel") @ExcludeMissing appLandingFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("arrAlternate1") @ExcludeMissing arrAlternate1: JsonField<String> = JsonMissing.of(),
        @JsonProperty("arrAlternate1Fuel") @ExcludeMissing arrAlternate1Fuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("arrAlternate2") @ExcludeMissing arrAlternate2: JsonField<String> = JsonMissing.of(),
        @JsonProperty("arrAlternate2Fuel") @ExcludeMissing arrAlternate2Fuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("arrIceFuel") @ExcludeMissing arrIceFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("arrRunway") @ExcludeMissing arrRunway: JsonField<String> = JsonMissing.of(),
        @JsonProperty("atcAddresses") @ExcludeMissing atcAddresses: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("avgTempDev") @ExcludeMissing avgTempDev: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("burnedFuel") @ExcludeMissing burnedFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("callSign") @ExcludeMissing callSign: JsonField<String> = JsonMissing.of(),
        @JsonProperty("cargoRemark") @ExcludeMissing cargoRemark: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("contingencyFuel") @ExcludeMissing contingencyFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("countryCodes") @ExcludeMissing countryCodes: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("createdAt") @ExcludeMissing createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("createdBy") @ExcludeMissing createdBy: JsonField<String> = JsonMissing.of(),
        @JsonProperty("depAlternate") @ExcludeMissing depAlternate: JsonField<String> = JsonMissing.of(),
        @JsonProperty("depressFuel") @ExcludeMissing depressFuel: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("earlyDescentFuel") @ExcludeMissing earlyDescentFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("enduranceTime") @ExcludeMissing enduranceTime: JsonField<String> = JsonMissing.of(),
        @JsonProperty("enrouteFuel") @ExcludeMissing enrouteFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("enrouteTime") @ExcludeMissing enrouteTime: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("etopsAirfields") @ExcludeMissing etopsAirfields: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("etopsAltAirfields") @ExcludeMissing etopsAltAirfields: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("etopsRating") @ExcludeMissing etopsRating: JsonField<String> = JsonMissing.of(),
        @JsonProperty("etopsValWindow") @ExcludeMissing etopsValWindow: JsonField<String> = JsonMissing.of(),
        @JsonProperty("externalId") @ExcludeMissing externalId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("flightPlanMessages") @ExcludeMissing flightPlanMessages: JsonField<List<FlightPlanMessage>> = JsonMissing.of(),
        @JsonProperty("flightPlanPointGroups") @ExcludeMissing flightPlanPointGroups: JsonField<List<FlightPlanPointGroup>> = JsonMissing.of(),
        @JsonProperty("flightPlanWaypoints") @ExcludeMissing flightPlanWaypoints: JsonField<List<FlightPlanWaypoint>> = JsonMissing.of(),
        @JsonProperty("flightRules") @ExcludeMissing flightRules: JsonField<String> = JsonMissing.of(),
        @JsonProperty("flightType") @ExcludeMissing flightType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("fuelDegrade") @ExcludeMissing fuelDegrade: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("gpsRAIM") @ExcludeMissing gpsRaim: JsonField<String> = JsonMissing.of(),
        @JsonProperty("holdDownFuel") @ExcludeMissing holdDownFuel: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("idArrAirfield") @ExcludeMissing idArrAirfield: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idDepAirfield") @ExcludeMissing idDepAirfield: JsonField<String> = JsonMissing.of(),
        @JsonProperty("identExtraFuel") @ExcludeMissing identExtraFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("idSortie") @ExcludeMissing idSortie: JsonField<String> = JsonMissing.of(),
        @JsonProperty("initialCruiseSpeed") @ExcludeMissing initialCruiseSpeed: JsonField<String> = JsonMissing.of(),
        @JsonProperty("initialFlightLevel") @ExcludeMissing initialFlightLevel: JsonField<String> = JsonMissing.of(),
        @JsonProperty("landingFuel") @ExcludeMissing landingFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("legNum") @ExcludeMissing legNum: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("minDivertFuel") @ExcludeMissing minDivertFuel: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("opConditionFuel") @ExcludeMissing opConditionFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("opWeight") @ExcludeMissing opWeight: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("origin") @ExcludeMissing origin: JsonField<String> = JsonMissing.of(),
        @JsonProperty("originator") @ExcludeMissing originator: JsonField<String> = JsonMissing.of(),
        @JsonProperty("origNetwork") @ExcludeMissing origNetwork: JsonField<String> = JsonMissing.of(),
        @JsonProperty("plannerRemark") @ExcludeMissing plannerRemark: JsonField<String> = JsonMissing.of(),
        @JsonProperty("rampFuel") @ExcludeMissing rampFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("remAlternate1Fuel") @ExcludeMissing remAlternate1Fuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("remAlternate2Fuel") @ExcludeMissing remAlternate2Fuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("reserveFuel") @ExcludeMissing reserveFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("routeString") @ExcludeMissing routeString: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("takeoffFuel") @ExcludeMissing takeoffFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("taxiFuel") @ExcludeMissing taxiFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("thunderAvoidFuel") @ExcludeMissing thunderAvoidFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("tocFuel") @ExcludeMissing tocFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("tocIceFuel") @ExcludeMissing tocIceFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("todFuel") @ExcludeMissing todFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("todIceFuel") @ExcludeMissing todIceFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("unidentExtraFuel") @ExcludeMissing unidentExtraFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("unusableFuel") @ExcludeMissing unusableFuel: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("updatedAt") @ExcludeMissing updatedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("updatedBy") @ExcludeMissing updatedBy: JsonField<String> = JsonMissing.of(),
        @JsonProperty("wakeTurbCat") @ExcludeMissing wakeTurbCat: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("windFacAvg") @ExcludeMissing windFacAvg: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("wxValidEnd") @ExcludeMissing wxValidEnd: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("wxValidStart") @ExcludeMissing wxValidStart: JsonField<OffsetDateTime> = JsonMissing.of()
    ) : this(
      arrAirfield,
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun airRefuelEvents(): Optional<List<AirRefuelEvent>> = airRefuelEvents.getOptional("airRefuelEvents")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun etopsAltAirfields(): Optional<List<String>> = etopsAltAirfields.getOptional("etopsAltAirfields")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun flightPlanMessages(): Optional<List<FlightPlanMessage>> = flightPlanMessages.getOptional("flightPlanMessages")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun flightPlanPointGroups(): Optional<List<FlightPlanPointGroup>> = flightPlanPointGroups.getOptional("flightPlanPointGroups")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun flightPlanWaypoints(): Optional<List<FlightPlanWaypoint>> = flightPlanWaypoints.getOptional("flightPlanWaypoints")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun initialCruiseSpeed(): Optional<String> = initialCruiseSpeed.getOptional("initialCruiseSpeed")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun initialFlightLevel(): Optional<String> = initialFlightLevel.getOptional("initialFlightLevel")
    ...
    @JsonProperty("genTS")
    @ExcludeMissing
    fun _genTs(): JsonField<OffsetDateTime> = genTs
     ...
     *
     * Unlike [arrAlternate1Fuel], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [arrAlternate2Fuel], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _arrIceFuel(): JsonField<Double> = arrIceFuel
    ...
    @ExcludeMissing
    fun _arrRunway(): JsonField<String> = arrRunway
    ...
    @ExcludeMissing
    fun _avgTempDev(): JsonField<Double> = avgTempDev
    ...
    @ExcludeMissing
    fun _burnedFuel(): JsonField<Double> = burnedFuel
    ...
    @ExcludeMissing
    fun _cargoRemark(): JsonField<String> = cargoRemark
    ...
    @ExcludeMissing
    fun _climbFuel(): JsonField<Double> = climbFuel
    ...
    @ExcludeMissing
    fun _climbTime(): JsonField<String> = climbTime
    ...
    @ExcludeMissing
    fun _depressFuel(): JsonField<Double> = depressFuel
    ...
    @ExcludeMissing
    fun _depRunway(): JsonField<String> = depRunway
    ...
    @ExcludeMissing
    fun _dragIndex(): JsonField<Double> = dragIndex

    /**
     * Returns the raw JSON value of [earlyDescentFuel].
     *
     * Unlike [earlyDescentFuel], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _enrouteFuel(): JsonField<Double> = enrouteFuel
    ...
    @ExcludeMissing
    fun _enrouteTime(): JsonField<String> = enrouteTime
    ...
    @ExcludeMissing
    fun _equipment(): JsonField<String> = equipment
     ...
     *
     * Unlike [etopsAltAirfields], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _etopsRating(): JsonField<String> = etopsRating
     ...
     *
     * Unlike [flightPlanMessages], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [flightPlanPointGroups], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [flightPlanWaypoints], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _flightRules(): JsonField<String> = flightRules
    ...
    @ExcludeMissing
    fun _flightType(): JsonField<String> = flightType
    ...
    @ExcludeMissing
    fun _fuelDegrade(): JsonField<Double> = fuelDegrade
     ...
     */
    @JsonProperty("gpsRAIM")
    @ExcludeMissing
    fun _gpsRaim(): JsonField<String> = gpsRaim
    ...
    @ExcludeMissing
    fun _holdFuel(): JsonField<Double> = holdFuel
    ...
    @ExcludeMissing
    fun _holdTime(): JsonField<String> = holdTime
     ...
     *
     * Unlike [initialCruiseSpeed], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [initialFlightLevel], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _landingFuel(): JsonField<Double> = landingFuel
    ...
    @ExcludeMissing
    fun _msnIndex(): JsonField<Double> = msnIndex
    ...
    @ExcludeMissing
    fun _opWeight(): JsonField<Double> = opWeight
    ...
    @ExcludeMissing
    fun _rampFuel(): JsonField<Double> = rampFuel

    /**
     * Returns the raw JSON value of [remAlternate1Fuel].
     *
     * Unlike [remAlternate1Fuel], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [remAlternate2Fuel], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _reserveFuel(): JsonField<Double> = reserveFuel
    ...
    @JsonProperty("star")
    @ExcludeMissing
    fun _star(): JsonField<String> = star
    ...
    @ExcludeMissing
    fun _takeoffFuel(): JsonField<Double> = takeoffFuel
    ...
    @ExcludeMissing
    fun _taxiFuel(): JsonField<Double> = taxiFuel

    /**
     * Returns the raw JSON value of [thunderAvoidFuel].
     *
     * Unlike [thunderAvoidFuel], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     */
    @JsonProperty("tocFuel")
    @ExcludeMissing
    fun _tocFuel(): JsonField<Double> = tocFuel
    ...
    @ExcludeMissing
    fun _tocIceFuel(): JsonField<Double> = tocIceFuel
     ...
     */
    @JsonProperty("todFuel")
    @ExcludeMissing
    fun _todFuel(): JsonField<Double> = todFuel
    ...
    @ExcludeMissing
    fun _todIceFuel(): JsonField<Double> = todIceFuel

    /**
     * Returns the raw JSON value of [unidentExtraFuel].
     *
     * Unlike [unidentExtraFuel], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _wakeTurbCat(): JsonField<String> = wakeTurbCat
    ...
    @ExcludeMissing
    fun _windFac1(): JsonField<Double> = windFac1
    ...
    @ExcludeMissing
    fun _windFac2(): JsonField<Double> = windFac2
    ...
    @ExcludeMissing
    fun _windFacAvg(): JsonField<Double> = windFacAvg
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FlightPlanAbridged].
         *
    ...
    /** A builder for [FlightPlanAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightPlanAbridged: FlightPlanAbridged) =
            apply {
                arrAirfield = flightPlanAbridged.arrAirfield
                classificationMarking = flightPlanAbridged.classificationMarking
                dataMode = flightPlanAbridged.dataMode
                depAirfield = flightPlanAbridged.depAirfield
                genTs = flightPlanAbridged.genTs
                source = flightPlanAbridged.source
                id = flightPlanAbridged.id
                aircraftMds = flightPlanAbridged.aircraftMds
                airRefuelEvents = flightPlanAbridged.airRefuelEvents.map { it.toMutableList() }
                amcMissionId = flightPlanAbridged.amcMissionId
                appLandingFuel = flightPlanAbridged.appLandingFuel
                arrAlternate1 = flightPlanAbridged.arrAlternate1
                arrAlternate1Fuel = flightPlanAbridged.arrAlternate1Fuel
                arrAlternate2 = flightPlanAbridged.arrAlternate2
                arrAlternate2Fuel = flightPlanAbridged.arrAlternate2Fuel
                arrIceFuel = flightPlanAbridged.arrIceFuel
                arrRunway = flightPlanAbridged.arrRunway
                atcAddresses = flightPlanAbridged.atcAddresses.map { it.toMutableList() }
                avgTempDev = flightPlanAbridged.avgTempDev
                burnedFuel = flightPlanAbridged.burnedFuel
                callSign = flightPlanAbridged.callSign
                cargoRemark = flightPlanAbridged.cargoRemark
                climbFuel = flightPlanAbridged.climbFuel
                climbTime = flightPlanAbridged.climbTime
                contingencyFuel = flightPlanAbridged.contingencyFuel
                countryCodes = flightPlanAbridged.countryCodes.map { it.toMutableList() }
                createdAt = flightPlanAbridged.createdAt
                createdBy = flightPlanAbridged.createdBy
                depAlternate = flightPlanAbridged.depAlternate
                depressFuel = flightPlanAbridged.depressFuel
                depRunway = flightPlanAbridged.depRunway
                dragIndex = flightPlanAbridged.dragIndex
                earlyDescentFuel = flightPlanAbridged.earlyDescentFuel
                enduranceTime = flightPlanAbridged.enduranceTime
                enrouteFuel = flightPlanAbridged.enrouteFuel
                enrouteTime = flightPlanAbridged.enrouteTime
                equipment = flightPlanAbridged.equipment
                estDepTime = flightPlanAbridged.estDepTime
                etopsAirfields = flightPlanAbridged.etopsAirfields.map { it.toMutableList() }
                etopsAltAirfields = flightPlanAbridged.etopsAltAirfields.map { it.toMutableList() }
                etopsRating = flightPlanAbridged.etopsRating
                etopsValWindow = flightPlanAbridged.etopsValWindow
                externalId = flightPlanAbridged.externalId
                flightPlanMessages = flightPlanAbridged.flightPlanMessages.map { it.toMutableList() }
                flightPlanPointGroups = flightPlanAbridged.flightPlanPointGroups.map { it.toMutableList() }
                flightPlanWaypoints = flightPlanAbridged.flightPlanWaypoints.map { it.toMutableList() }
                flightRules = flightPlanAbridged.flightRules
                flightType = flightPlanAbridged.flightType
                fuelDegrade = flightPlanAbridged.fuelDegrade
                gpsRaim = flightPlanAbridged.gpsRaim
                holdDownFuel = flightPlanAbridged.holdDownFuel
                holdFuel = flightPlanAbridged.holdFuel
                holdTime = flightPlanAbridged.holdTime
                idAircraft = flightPlanAbridged.idAircraft
                idArrAirfield = flightPlanAbridged.idArrAirfield
                idDepAirfield = flightPlanAbridged.idDepAirfield
                identExtraFuel = flightPlanAbridged.identExtraFuel
                idSortie = flightPlanAbridged.idSortie
                initialCruiseSpeed = flightPlanAbridged.initialCruiseSpeed
                initialFlightLevel = flightPlanAbridged.initialFlightLevel
                landingFuel = flightPlanAbridged.landingFuel
                legNum = flightPlanAbridged.legNum
                minDivertFuel = flightPlanAbridged.minDivertFuel
                msnIndex = flightPlanAbridged.msnIndex
                notes = flightPlanAbridged.notes
                numAircraft = flightPlanAbridged.numAircraft
                opConditionFuel = flightPlanAbridged.opConditionFuel
                opWeight = flightPlanAbridged.opWeight
                origin = flightPlanAbridged.origin
                originator = flightPlanAbridged.originator
                origNetwork = flightPlanAbridged.origNetwork
                plannerRemark = flightPlanAbridged.plannerRemark
                rampFuel = flightPlanAbridged.rampFuel
                remAlternate1Fuel = flightPlanAbridged.remAlternate1Fuel
                remAlternate2Fuel = flightPlanAbridged.remAlternate2Fuel
                reserveFuel = flightPlanAbridged.reserveFuel
                routeString = flightPlanAbridged.routeString
                sid = flightPlanAbridged.sid
                sourceDl = flightPlanAbridged.sourceDl
                star = flightPlanAbridged.star
                status = flightPlanAbridged.status
                tailNumber = flightPlanAbridged.tailNumber
                takeoffFuel = flightPlanAbridged.takeoffFuel
                taxiFuel = flightPlanAbridged.taxiFuel
                thunderAvoidFuel = flightPlanAbridged.thunderAvoidFuel
                tocFuel = flightPlanAbridged.tocFuel
                tocIceFuel = flightPlanAbridged.tocIceFuel
                todFuel = flightPlanAbridged.todFuel
                todIceFuel = flightPlanAbridged.todIceFuel
                unidentExtraFuel = flightPlanAbridged.unidentExtraFuel
                unusableFuel = flightPlanAbridged.unusableFuel
                updatedAt = flightPlanAbridged.updatedAt
                updatedBy = flightPlanAbridged.updatedBy
                wakeTurbCat = flightPlanAbridged.wakeTurbCat
                windFac1 = flightPlanAbridged.windFac1
                windFac2 = flightPlanAbridged.windFac2
                windFacAvg = flightPlanAbridged.windFacAvg
                wxValidEnd = flightPlanAbridged.wxValidEnd
                wxValidStart = flightPlanAbridged.wxValidStart
                additionalProperties = flightPlanAbridged.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.genTs] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun genTs(genTs: JsonField<OffsetDateTime>) =
            apply {
                this.genTs = genTs
            }
        ...
        /** Collection of air refueling events occurring on this flight. */
        fun airRefuelEvents(airRefuelEvents: List<AirRefuelEvent>) = airRefuelEvents(JsonField.of(airRefuelEvents))

        /**
         * Sets [Builder.airRefuelEvents] to an arbitrary JSON value.
         *
         * You should usually call [Builder.airRefuelEvents] with a well-typed `List<AirRefuelEvent>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun airRefuelEvents(airRefuelEvents: JsonField<List<AirRefuelEvent>>) =
            apply {
         ...
         */
        fun addAirRefuelEvent(airRefuelEvent: AirRefuelEvent) =
            apply {
                airRefuelEvents = (airRefuelEvents ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.appLandingFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun appLandingFuel(appLandingFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.arrAlternate1] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrAlternate1(arrAlternate1: JsonField<String>) =
            apply {
                this.arrAlternate1 = arrAlternate1
            }

        /** Fuel required to fly to alternate landing site 1 and land in pounds. */
        fun arrAlternate1Fuel(arrAlternate1Fuel: Double) = arrAlternate1Fuel(JsonField.of(arrAlternate1Fuel))

        /**
         * Sets [Builder.arrAlternate1Fuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.arrAlternate1Fuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrAlternate1Fuel(arrAlternate1Fuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.arrAlternate2] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrAlternate2(arrAlternate2: JsonField<String>) =
            apply {
                this.arrAlternate2 = arrAlternate2
            }

        /** Fuel required to fly to alternate landing site 2 and land in pounds. */
        fun arrAlternate2Fuel(arrAlternate2Fuel: Double) = arrAlternate2Fuel(JsonField.of(arrAlternate2Fuel))

        /**
         * Sets [Builder.arrAlternate2Fuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.arrAlternate2Fuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrAlternate2Fuel(arrAlternate2Fuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.arrIceFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrIceFuel(arrIceFuel: JsonField<Double>) =
            apply {
                this.arrIceFuel = arrIceFuel
            }
         ...
         *
         * You should usually call [Builder.arrRunway] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrRunway(arrRunway: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.atcAddresses] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun atcAddresses(atcAddresses: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAtcAddress(atcAddress: String) =
            apply {
                atcAddresses = (atcAddresses ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.avgTempDev] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun avgTempDev(avgTempDev: JsonField<Double>) =
            apply {
                this.avgTempDev = avgTempDev
            }
         ...
         *
         * You should usually call [Builder.burnedFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun burnedFuel(burnedFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.cargoRemark] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cargoRemark(cargoRemark: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.climbFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun climbFuel(climbFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.climbTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun climbTime(climbTime: JsonField<String>) =
            apply {
                this.climbTime = climbTime
            }

        /** The amount of contingency fuel in pounds. */
        fun contingencyFuel(contingencyFuel: Double) = contingencyFuel(JsonField.of(contingencyFuel))

        /**
         * Sets [Builder.contingencyFuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.contingencyFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun contingencyFuel(contingencyFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.countryCodes] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.depAlternate] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depAlternate(depAlternate: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.depressFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depressFuel(depressFuel: JsonField<Double>) =
            apply {
                this.depressFuel = depressFuel
            }
         ...
         *
         * You should usually call [Builder.depRunway] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depRunway(depRunway: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.dragIndex] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dragIndex(dragIndex: JsonField<Double>) =
            apply {
                this.dragIndex = dragIndex
            }

        /** Additional fuel burned at landing/missed approach for an early descent in pounds. */
        fun earlyDescentFuel(earlyDescentFuel: Double) = earlyDescentFuel(JsonField.of(earlyDescentFuel))

        /**
         * Sets [Builder.earlyDescentFuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.earlyDescentFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun earlyDescentFuel(earlyDescentFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.enduranceTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun enduranceTime(enduranceTime: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.enrouteFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun enrouteFuel(enrouteFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.enrouteTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun enrouteTime(enrouteTime: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.equipment] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun equipment(equipment: JsonField<String>) =
            apply {
        ...
        /** Array of Extended Operations (ETOPS) adequate landing airfields that are within the mission region. */
        fun etopsAirfields(etopsAirfields: List<String>) = etopsAirfields(JsonField.of(etopsAirfields))

        /**
         * Sets [Builder.etopsAirfields] to an arbitrary JSON value.
         *
         * You should usually call [Builder.etopsAirfields] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun etopsAirfields(etopsAirfields: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addEtopsAirfield(etopsAirfield: String) =
            apply {
                etopsAirfields = (etopsAirfields ?: JsonField.of(mutableListOf())).also {
                    checkKnown("etopsAirfields", it).add(etopsAirfield)
                }
            }

        /** Array of Extended Operations (ETOPS) alternate suitable landing airfields that are within the mission region. */
        fun etopsAltAirfields(etopsAltAirfields: List<String>) = etopsAltAirfields(JsonField.of(etopsAltAirfields))

        /**
         * Sets [Builder.etopsAltAirfields] to an arbitrary JSON value.
         *
         * You should usually call [Builder.etopsAltAirfields] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun etopsAltAirfields(etopsAltAirfields: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addEtopsAltAirfield(etopsAltAirfield: String) =
            apply {
                etopsAltAirfields = (etopsAltAirfields ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.etopsRating] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun etopsRating(etopsRating: JsonField<String>) =
            apply {
                this.etopsRating = etopsRating
            }
         ...
         *
         * You should usually call [Builder.etopsValWindow] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun etopsValWindow(etopsValWindow: JsonField<String>) =
            apply {
        ...
        /** Collection of messages associated with this flight plan indicating the severity, the point where the message was generated, the path (Primary, Alternate, etc.), and the text of the message. */
        fun flightPlanMessages(flightPlanMessages: List<FlightPlanMessage>) = flightPlanMessages(JsonField.of(flightPlanMessages))

        /**
         * Sets [Builder.flightPlanMessages] to an arbitrary JSON value.
         *
         * You should usually call [Builder.flightPlanMessages] with a well-typed `List<FlightPlanMessage>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun flightPlanMessages(flightPlanMessages: JsonField<List<FlightPlanMessage>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFlightPlanMessage(flightPlanMessage: FlightPlanMessage) =
            apply {
                flightPlanMessages = (flightPlanMessages ?: JsonField.of(mutableListOf())).also {
                    checkKnown("flightPlanMessages", it).add(flightPlanMessage)
                }
            }

        /** Collection of point groups generated for this flight plan. Groups include point sets for Extended Operations (ETOPS), Critical Fuel Point, and Equal Time Point (ETP). */
        fun flightPlanPointGroups(flightPlanPointGroups: List<FlightPlanPointGroup>) = flightPlanPointGroups(JsonField.of(flightPlanPointGroups))

        /**
         * Sets [Builder.flightPlanPointGroups] to an arbitrary JSON value.
         *
         * You should usually call [Builder.flightPlanPointGroups] with a well-typed `List<FlightPlanPointGroup>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFlightPlanPointGroup(flightPlanPointGroup: FlightPlanPointGroup) =
            apply {
                flightPlanPointGroups = (flightPlanPointGroups ?: JsonField.of(mutableListOf())).also {
                    checkKnown("flightPlanPointGroups", it).add(flightPlanPointGroup)
                }
            }

        /** Collection of waypoints associated with this flight plan. */
        fun flightPlanWaypoints(flightPlanWaypoints: List<FlightPlanWaypoint>) = flightPlanWaypoints(JsonField.of(flightPlanWaypoints))

        /**
         * Sets [Builder.flightPlanWaypoints] to an arbitrary JSON value.
         *
         * You should usually call [Builder.flightPlanWaypoints] with a well-typed `List<FlightPlanWaypoint>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun flightPlanWaypoints(flightPlanWaypoints: JsonField<List<FlightPlanWaypoint>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFlightPlanWaypoint(flightPlanWaypoint: FlightPlanWaypoint) =
            apply {
                flightPlanWaypoints = (flightPlanWaypoints ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.flightRules] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun flightRules(flightRules: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.flightType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun flightType(flightType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.fuelDegrade] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fuelDegrade(fuelDegrade: JsonField<Double>) =
            apply {
                this.fuelDegrade = fuelDegrade
            }
         ...
         *
         * You should usually call [Builder.gpsRaim] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun gpsRaim(gpsRaim: JsonField<String>) =
            apply {
                this.gpsRaim = gpsRaim
            }
         ...
         *
         * You should usually call [Builder.holdDownFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun holdDownFuel(holdDownFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.holdFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun holdFuel(holdFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.holdTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun holdTime(holdTime: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.idArrAirfield] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idArrAirfield(idArrAirfield: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.idDepAirfield] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idDepAirfield(idDepAirfield: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.identExtraFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun identExtraFuel(identExtraFuel: JsonField<Double>) =
            apply {
        ...
        /** A character string representation of the initial filed cruise speed for this flight (prepended values of K, N, and M represent kilometers per hour, knots, and Mach, respectively). */
        fun initialCruiseSpeed(initialCruiseSpeed: String) = initialCruiseSpeed(JsonField.of(initialCruiseSpeed))

        /**
         * Sets [Builder.initialCruiseSpeed] to an arbitrary JSON value.
         *
         * You should usually call [Builder.initialCruiseSpeed] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun initialCruiseSpeed(initialCruiseSpeed: JsonField<String>) =
            apply {
                this.initialCruiseSpeed = initialCruiseSpeed
            }

        /** A character string representation of the initial filed altitude level for this flight (prepended values of F, S, A, and M represent flight level in hundreds of feet, standard metric level in tens of meters, altitude in hundreds of feet, and altitude in tens of meters, respectively). */
        fun initialFlightLevel(initialFlightLevel: String) = initialFlightLevel(JsonField.of(initialFlightLevel))

        /**
         * Sets [Builder.initialFlightLevel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.initialFlightLevel] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun initialFlightLevel(initialFlightLevel: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.landingFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun landingFuel(landingFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.minDivertFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun minDivertFuel(minDivertFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.msnIndex] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun msnIndex(msnIndex: JsonField<Double>) =
            apply {
                this.msnIndex = msnIndex
            }
         ...
         *
         * You should usually call [Builder.numAircraft] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numAircraft(numAircraft: JsonField<Int>) =
            apply {
                this.numAircraft = numAircraft
            }

        /** Additional fuel burned at Top of Descent for the operational condition in pounds. */
        fun opConditionFuel(opConditionFuel: Double) = opConditionFuel(JsonField.of(opConditionFuel))

        /**
         * Sets [Builder.opConditionFuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.opConditionFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun opConditionFuel(opConditionFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.opWeight] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun opWeight(opWeight: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.originator] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun originator(originator: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.plannerRemark] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun plannerRemark(plannerRemark: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.rampFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rampFuel(rampFuel: JsonField<Double>) =
            apply {
                this.rampFuel = rampFuel
            }

        /** Total fuel remaining at alternate landing site 1 in pounds. */
        fun remAlternate1Fuel(remAlternate1Fuel: Double) = remAlternate1Fuel(JsonField.of(remAlternate1Fuel))

        /**
         * Sets [Builder.remAlternate1Fuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.remAlternate1Fuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun remAlternate1Fuel(remAlternate1Fuel: JsonField<Double>) =
            apply {
                this.remAlternate1Fuel = remAlternate1Fuel
            }

        /** Total fuel remaining at alternate landing site 2 in pounds. */
        fun remAlternate2Fuel(remAlternate2Fuel: Double) = remAlternate2Fuel(JsonField.of(remAlternate2Fuel))

        /**
         * Sets [Builder.remAlternate2Fuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.remAlternate2Fuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun remAlternate2Fuel(remAlternate2Fuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.reserveFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reserveFuel(reserveFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.routeString] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun routeString(routeString: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.sid] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.star] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun star(star: JsonField<String>) =
            apply {
                this.star = star
            }
         ...
         *
         * You should usually call [Builder.takeoffFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun takeoffFuel(takeoffFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.taxiFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun taxiFuel(taxiFuel: JsonField<Double>) =
            apply {
                this.taxiFuel = taxiFuel
            }

        /** Additional fuel burned at Top of Descent for thunderstorm avoidance in pounds. */
        fun thunderAvoidFuel(thunderAvoidFuel: Double) = thunderAvoidFuel(JsonField.of(thunderAvoidFuel))

        /**
         * Sets [Builder.thunderAvoidFuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.thunderAvoidFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun thunderAvoidFuel(thunderAvoidFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.tocFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tocFuel(tocFuel: JsonField<Double>) =
            apply {
                this.tocFuel = tocFuel
            }
         ...
         *
         * You should usually call [Builder.tocIceFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tocIceFuel(tocIceFuel: JsonField<Double>) =
            apply {
                this.tocIceFuel = tocIceFuel
            }
         ...
         *
         * You should usually call [Builder.todFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun todFuel(todFuel: JsonField<Double>) =
            apply {
                this.todFuel = todFuel
            }
         ...
         *
         * You should usually call [Builder.todIceFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun todIceFuel(todIceFuel: JsonField<Double>) =
            apply {
                this.todIceFuel = todIceFuel
            }

        /** The amount of unidentified extra fuel required to get to min landing in pounds. */
        fun unidentExtraFuel(unidentExtraFuel: Double) = unidentExtraFuel(JsonField.of(unidentExtraFuel))

        /**
         * Sets [Builder.unidentExtraFuel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.unidentExtraFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun unidentExtraFuel(unidentExtraFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.unusableFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun unusableFuel(unusableFuel: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.wakeTurbCat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun wakeTurbCat(wakeTurbCat: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.windFac1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun windFac1(windFac1: JsonField<Double>) =
            apply {
                this.windFac1 = windFac1
            }
         ...
         *
         * You should usually call [Builder.windFac2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun windFac2(windFac2: JsonField<Double>) =
            apply {
                this.windFac2 = windFac2
            }
         ...
         *
         * You should usually call [Builder.windFacAvg] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun windFacAvg(windFacAvg: JsonField<Double>) =
            apply {
                this.windFacAvg = windFacAvg
            }
         ...
         *
         * You should usually call [Builder.wxValidEnd] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun wxValidEnd(wxValidEnd: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.wxValidStart] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun wxValidStart(wxValidStart: JsonField<OffsetDateTime>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [FlightPlanAbridged].
         *
    ...
    fun validate(): FlightPlanAbridged =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (arrAirfield.asKnown().isPresent) 1 else 0) + (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (depAirfield.asKnown().isPresent) 1 else 0) + (if (genTs.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (aircraftMds.asKnown().isPresent) 1 else 0) + (airRefuelEvents.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (amcMissionId.asKnown().isPresent) 1 else 0) + (if (appLandingFuel.asKnown().isPresent) 1 else 0) + (if (arrAlternate1.asKnown().isPresent) 1 else 0) + (if (arrAlternate1Fuel.asKnown().isPresent) 1 else 0) + (if (arrAlternate2.asKnown().isPresent) 1 else 0) + (if (arrAlternate2Fuel.asKnown().isPresent) 1 else 0) + (if (arrIceFuel.asKnown().isPresent) 1 else 0) + (if (arrRunway.asKnown().isPresent) 1 else 0) + (atcAddresses.asKnown().getOrNull()?.size ?: 0) + (if (avgTempDev.asKnown().isPresent) 1 else 0) + (if (burnedFuel.asKnown().isPresent) 1 else 0) + (if (callSign.asKnown().isPresent) 1 else 0) + (if (cargoRemark.asKnown().isPresent) 1 else 0) + (if (climbFuel.asKnown().isPresent) 1 else 0) + (if (climbTime.asKnown().isPresent) 1 else 0) + (if (contingencyFuel.asKnown().isPresent) 1 else 0) + (countryCodes.asKnown().getOrNull()?.size ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (depAlternate.asKnown().isPresent) 1 else 0) + (if (depressFuel.asKnown().isPresent) 1 else 0) + (if (depRunway.asKnown().isPresent) 1 else 0) + (if (dragIndex.asKnown().isPresent) 1 else 0) + (if (earlyDescentFuel.asKnown().isPresent) 1 else 0) + (if (enduranceTime.asKnown().isPresent) 1 else 0) + (if (enrouteFuel.asKnown().isPresent) 1 else 0) + (if (enrouteTime.asKnown().isPresent) 1 else 0) + (if (equipment.asKnown().isPresent) 1 else 0) + (if (estDepTime.asKnown().isPresent) 1 else 0) + (etopsAirfields.asKnown().getOrNull()?.size ?: 0) + (etopsAltAirfields.asKnown().getOrNull()?.size ?: 0) + (if (etopsRating.asKnown().isPresent) 1 else 0) + (if (etopsValWindow.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (flightPlanMessages.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (flightPlanPointGroups.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (flightPlanWaypoints.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (flightRules.asKnown().isPresent) 1 else 0) + (if (flightType.asKnown().isPresent) 1 else 0) + (if (fuelDegrade.asKnown().isPresent) 1 else 0) + (if (gpsRaim.asKnown().isPresent) 1 else 0) + (if (holdDownFuel.asKnown().isPresent) 1 else 0) + (if (holdFuel.asKnown().isPresent) 1 else 0) + (if (holdTime.asKnown().isPresent) 1 else 0) + (if (idAircraft.asKnown().isPresent) 1 else 0) + (if (idArrAirfield.asKnown().isPresent) 1 else 0) + (if (idDepAirfield.asKnown().isPresent) 1 else 0) + (if (identExtraFuel.asKnown().isPresent) 1 else 0) + (if (idSortie.asKnown().isPresent) 1 else 0) + (if (initialCruiseSpeed.asKnown().isPresent) 1 else 0) + (if (initialFlightLevel.asKnown().isPresent) 1 else 0) + (if (landingFuel.asKnown().isPresent) 1 else 0) + (if (legNum.asKnown().isPresent) 1 else 0) + (if (minDivertFuel.asKnown().isPresent) 1 else 0) + (if (msnIndex.asKnown().isPresent) 1 else 0) + (if (notes.asKnown().isPresent) 1 else 0) + (if (numAircraft.asKnown().isPresent) 1 else 0) + (if (opConditionFuel.asKnown().isPresent) 1 else 0) + (if (opWeight.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (originator.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (plannerRemark.asKnown().isPresent) 1 else 0) + (if (rampFuel.asKnown().isPresent) 1 else 0) + (if (remAlternate1Fuel.asKnown().isPresent) 1 else 0) + (if (remAlternate2Fuel.asKnown().isPresent) 1 else 0) + (if (reserveFuel.asKnown().isPresent) 1 else 0) + (if (routeString.asKnown().isPresent) 1 else 0) + (if (sid.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (star.asKnown().isPresent) 1 else 0) + (if (status.asKnown().isPresent) 1 else 0) + (if (tailNumber.asKnown().isPresent) 1 else 0) + (if (takeoffFuel.asKnown().isPresent) 1 else 0) + (if (taxiFuel.asKnown().isPresent) 1 else 0) + (if (thunderAvoidFuel.asKnown().isPresent) 1 else 0) + (if (tocFuel.asKnown().isPresent) 1 else 0) + (if (tocIceFuel.asKnown().isPresent) 1 else 0) + (if (todFuel.asKnown().isPresent) 1 else 0) + (if (todIceFuel.asKnown().isPresent) 1 else 0) + (if (unidentExtraFuel.asKnown().isPresent) 1 else 0) + (if (unusableFuel.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (if (wakeTurbCat.asKnown().isPresent) 1 else 0) + (if (windFac1.asKnown().isPresent) 1 else 0) + (if (windFac2.asKnown().isPresent) 1 else 0) + (if (windFacAvg.asKnown().isPresent) 1 else 0) + (if (wxValidEnd.asKnown().isPresent) 1 else 0) + (if (wxValidStart.asKnown().isPresent) 1 else 0)
    ...
    /** Collection of air refueling events occurring on this flight. */
    class AirRefuelEvent private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("arDegrade") @ExcludeMissing arDegrade: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("arExchangedFuel") @ExcludeMissing arExchangedFuel: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("arNum") @ExcludeMissing arNum: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("divertFuel") @ExcludeMissing divertFuel: JsonField<Double> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _arDegrade(): JsonField<Double> = arDegrade

        /**
         * Returns the raw JSON value of [arExchangedFuel].
         *
         * Unlike [arExchangedFuel], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("arNum")
        @ExcludeMissing
        fun _arNum(): JsonField<Int> = arNum
         ...
         */
        @JsonProperty("exitFuel")
        @ExcludeMissing
        fun _exitFuel(): JsonField<Double> = exitFuel
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(airRefuelEvent: AirRefuelEvent) =
                apply {
             ...
             *
             * You should usually call [Builder.arDegrade] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun arDegrade(arDegrade: JsonField<Double>) =
                apply {
                    this.arDegrade = arDegrade
                }

            /** Fuel onloaded (use positive numbers) or fuel offloaded (use negative numbers) in pounds. */
            fun arExchangedFuel(arExchangedFuel: Double) = arExchangedFuel(JsonField.of(arExchangedFuel))

            /**
             * Sets [Builder.arExchangedFuel] to an arbitrary JSON value.
             *
             * You should usually call [Builder.arExchangedFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun arExchangedFuel(arExchangedFuel: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.arNum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun arNum(arNum: JsonField<Int>) =
                apply {
                    this.arNum = arNum
                }
             ...
             *
             * You should usually call [Builder.divertFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun divertFuel(divertFuel: JsonField<Double>) =
                apply {
                    this.divertFuel = divertFuel
                }
             ...
             *
             * You should usually call [Builder.exitFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun exitFuel(exitFuel: JsonField<Double>) =
                apply {
                    this.exitFuel = exitFuel
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (arDegrade.asKnown().isPresent) 1 else 0) + (if (arExchangedFuel.asKnown().isPresent) 1 else 0) + (if (arNum.asKnown().isPresent) 1 else 0) + (if (divertFuel.asKnown().isPresent) 1 else 0) + (if (exitFuel.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "AirRefuelEvent{arDegrade=$arDegrade, arExchangedFuel=$arExchangedFuel, arNum=$arNum, divertFuel=$divertFuel, exitFuel=$exitFuel, additionalProperties=$additionalProperties}"
    }

    /** Collection of messages associated with this flight plan indicating the severity, the point where the message was generated, the path (Primary, Alternate, etc.), and the text of the message. */
    class FlightPlanMessage private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("routePath") @ExcludeMissing routePath: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _msgText(): JsonField<String> = msgText
        ...
        @ExcludeMissing
        fun _routePath(): JsonField<String> = routePath
        ...
        @JsonProperty("wpNum")
        @ExcludeMissing
        fun _wpNum(): JsonField<String> = wpNum
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(flightPlanMessage: FlightPlanMessage) =
                apply {
             ...
             *
             * You should usually call [Builder.msgText] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun msgText(msgText: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.routePath] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun routePath(routePath: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.severity] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun severity(severity: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.wpNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun wpNum(wpNum: JsonField<String>) =
                apply {
                    this.wpNum = wpNum
                }
        ...
        fun validate(): FlightPlanMessage =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (msgText.asKnown().isPresent) 1 else 0) + (if (routePath.asKnown().isPresent) 1 else 0) + (if (severity.asKnown().isPresent) 1 else 0) + (if (wpNum.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "FlightPlanMessage{msgText=$msgText, routePath=$routePath, severity=$severity, wpNum=$wpNum, additionalProperties=$additionalProperties}"
    }

    /** Collection of point groups generated for this flight plan. Groups include point sets for Extended Operations (ETOPS), Critical Fuel Point, and Equal Time Point (ETP). */
    class FlightPlanPointGroup private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("avgFuelFlow") @ExcludeMissing avgFuelFlow: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("etopsAvgWindFactor") @ExcludeMissing etopsAvgWindFactor: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("etopsDistance") @ExcludeMissing etopsDistance: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("etopsReqFuel") @ExcludeMissing etopsReqFuel: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("etopsTempDev") @ExcludeMissing etopsTempDev: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("etopsTime") @ExcludeMissing etopsTime: JsonField<String> = JsonMissing.of(),
            @JsonProperty("flightPlanPoints") @ExcludeMissing flightPlanPoints: JsonField<List<FlightPlanPoint>> = JsonMissing.of(),
            @JsonProperty("fromTakeoffTime") @ExcludeMissing fromTakeoffTime: JsonField<String> = JsonMissing.of(),
            @JsonProperty("fsafAvgWindFactor") @ExcludeMissing fsafAvgWindFactor: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("fsafDistance") @ExcludeMissing fsafDistance: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("fsafReqFuel") @ExcludeMissing fsafReqFuel: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("fsafTempDev") @ExcludeMissing fsafTempDev: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("fsafTime") @ExcludeMissing fsafTime: JsonField<String> = JsonMissing.of(),
            @JsonProperty("fuelCalcAlt") @ExcludeMissing fuelCalcAlt: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("fuelCalcSpd") @ExcludeMissing fuelCalcSpd: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lsafAvgWindFactor") @ExcludeMissing lsafAvgWindFactor: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lsafDistance") @ExcludeMissing lsafDistance: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lsafName") @ExcludeMissing lsafName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("lsafReqFuel") @ExcludeMissing lsafReqFuel: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lsafTempDev") @ExcludeMissing lsafTempDev: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lsafTime") @ExcludeMissing lsafTime: JsonField<String> = JsonMissing.of(),
            @JsonProperty("plannedFuel") @ExcludeMissing plannedFuel: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("pointGroupName") @ExcludeMissing pointGroupName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("worstFuelCase") @ExcludeMissing worstFuelCase: JsonField<String> = JsonMissing.of()
        ) : this(
          avgFuelFlow,
          etopsAvgWindFactor,
          etopsDistance,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun etopsAvgWindFactor(): Optional<Double> = etopsAvgWindFactor.getOptional("etopsAvgWindFactor")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun flightPlanPoints(): Optional<List<FlightPlanPoint>> = flightPlanPoints.getOptional("flightPlanPoints")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun fsafAvgWindFactor(): Optional<Double> = fsafAvgWindFactor.getOptional("fsafAvgWindFactor")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun lsafAvgWindFactor(): Optional<Double> = lsafAvgWindFactor.getOptional("lsafAvgWindFactor")
         ...
         *
         * Unlike [etopsAvgWindFactor], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [etopsDistance], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [etopsReqFuel], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [etopsTempDev], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _etopsTime(): JsonField<String> = etopsTime

        /**
         * Returns the raw JSON value of [flightPlanPoints].
         *
         * Unlike [flightPlanPoints], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [fromTakeoffTime], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [fsafAvgWindFactor], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [fsafDistance], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _fsafTime(): JsonField<String> = fsafTime
         ...
         *
         * Unlike [lsafAvgWindFactor], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [lsafDistance], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _lsafName(): JsonField<String> = lsafName
        ...
        @ExcludeMissing
        fun _lsafTime(): JsonField<String> = lsafTime
         ...
         *
         * Unlike [pointGroupName], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [worstFuelCase], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(flightPlanPointGroup: FlightPlanPointGroup) =
                apply {
             ...
             *
             * You should usually call [Builder.avgFuelFlow] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun avgFuelFlow(avgFuelFlow: JsonField<Double>) =
                apply {
                    this.avgFuelFlow = avgFuelFlow
                }

            /** Average wind factor from the Extended Operations (ETOPS) point to the recovery airfield in knots. */
            fun etopsAvgWindFactor(etopsAvgWindFactor: Double) = etopsAvgWindFactor(JsonField.of(etopsAvgWindFactor))

            /**
             * Sets [Builder.etopsAvgWindFactor] to an arbitrary JSON value.
             *
             * You should usually call [Builder.etopsAvgWindFactor] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun etopsAvgWindFactor(etopsAvgWindFactor: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.etopsDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun etopsDistance(etopsDistance: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.etopsReqFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun etopsReqFuel(etopsReqFuel: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.etopsTempDev] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun etopsTempDev(etopsTempDev: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.etopsTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun etopsTime(etopsTime: JsonField<String>) =
                apply {
                    this.etopsTime = etopsTime
                }

            /** Array of point data for this Point Group. */
            fun flightPlanPoints(flightPlanPoints: List<FlightPlanPoint>) = flightPlanPoints(JsonField.of(flightPlanPoints))

            /**
             * Sets [Builder.flightPlanPoints] to an arbitrary JSON value.
             *
             * You should usually call [Builder.flightPlanPoints] with a well-typed `List<FlightPlanPoint>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun flightPlanPoints(flightPlanPoints: JsonField<List<FlightPlanPoint>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addFlightPlanPoint(flightPlanPoint: FlightPlanPoint) =
                apply {
                    flightPlanPoints = (flightPlanPoints ?: JsonField.of(mutableListOf())).also {
                        checkKnown("flightPlanPoints", it).add(flightPlanPoint)
                    }
                }

            /** Total time from takeoff when the point is reached expressed in HH:MM format. */
            fun fromTakeoffTime(fromTakeoffTime: String) = fromTakeoffTime(JsonField.of(fromTakeoffTime))

            /**
             * Sets [Builder.fromTakeoffTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fromTakeoffTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fromTakeoffTime(fromTakeoffTime: JsonField<String>) =
                apply {
                    this.fromTakeoffTime = fromTakeoffTime
                }

            /** Average wind factor from the Equal Time Point (ETP) to the first suitable airfield in knots. */
            fun fsafAvgWindFactor(fsafAvgWindFactor: Double) = fsafAvgWindFactor(JsonField.of(fsafAvgWindFactor))

            /**
             * Sets [Builder.fsafAvgWindFactor] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fsafAvgWindFactor] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fsafAvgWindFactor(fsafAvgWindFactor: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.fsafDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fsafDistance(fsafDistance: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.fsafReqFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fsafReqFuel(fsafReqFuel: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.fsafTempDev] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fsafTempDev(fsafTempDev: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.fsafTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fsafTime(fsafTime: JsonField<String>) =
                apply {
                    this.fsafTime = fsafTime
                }
             ...
             *
             * You should usually call [Builder.fuelCalcAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fuelCalcAlt(fuelCalcAlt: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.fuelCalcSpd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fuelCalcSpd(fuelCalcSpd: JsonField<Double>) =
                apply {
                    this.fuelCalcSpd = fuelCalcSpd
                }

            /** Average wind factor from the Equal Time Point (ETP) to the last suitable airfield in knots. */
            fun lsafAvgWindFactor(lsafAvgWindFactor: Double) = lsafAvgWindFactor(JsonField.of(lsafAvgWindFactor))

            /**
             * Sets [Builder.lsafAvgWindFactor] to an arbitrary JSON value.
             *
             * You should usually call [Builder.lsafAvgWindFactor] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lsafAvgWindFactor(lsafAvgWindFactor: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.lsafDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lsafDistance(lsafDistance: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.lsafName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lsafName(lsafName: JsonField<String>) =
                apply {
                    this.lsafName = lsafName
                }
             ...
             *
             * You should usually call [Builder.lsafReqFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lsafReqFuel(lsafReqFuel: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.lsafTempDev] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lsafTempDev(lsafTempDev: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.lsafTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lsafTime(lsafTime: JsonField<String>) =
                apply {
                    this.lsafTime = lsafTime
                }
             ...
             *
             * You should usually call [Builder.plannedFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun plannedFuel(plannedFuel: JsonField<Double>) =
                apply {
                    this.plannedFuel = plannedFuel
                }

            /** Name of the point group, usually Extended Operations (ETOPS), Critical Fuel Point, and Equal Time Point (ETP) sections. */
            fun pointGroupName(pointGroupName: String) = pointGroupName(JsonField.of(pointGroupName))

            /**
             * Sets [Builder.pointGroupName] to an arbitrary JSON value.
             *
             * You should usually call [Builder.pointGroupName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pointGroupName(pointGroupName: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.worstFuelCase] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun worstFuelCase(worstFuelCase: JsonField<String>) =
                apply {
        ...
        fun validate(): FlightPlanPointGroup =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (avgFuelFlow.asKnown().isPresent) 1 else 0) + (if (etopsAvgWindFactor.asKnown().isPresent) 1 else 0) + (if (etopsDistance.asKnown().isPresent) 1 else 0) + (if (etopsReqFuel.asKnown().isPresent) 1 else 0) + (if (etopsTempDev.asKnown().isPresent) 1 else 0) + (if (etopsTime.asKnown().isPresent) 1 else 0) + (flightPlanPoints.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (fromTakeoffTime.asKnown().isPresent) 1 else 0) + (if (fsafAvgWindFactor.asKnown().isPresent) 1 else 0) + (if (fsafDistance.asKnown().isPresent) 1 else 0) + (if (fsafReqFuel.asKnown().isPresent) 1 else 0) + (if (fsafTempDev.asKnown().isPresent) 1 else 0) + (if (fsafTime.asKnown().isPresent) 1 else 0) + (if (fuelCalcAlt.asKnown().isPresent) 1 else 0) + (if (fuelCalcSpd.asKnown().isPresent) 1 else 0) + (if (lsafAvgWindFactor.asKnown().isPresent) 1 else 0) + (if (lsafDistance.asKnown().isPresent) 1 else 0) + (if (lsafName.asKnown().isPresent) 1 else 0) + (if (lsafReqFuel.asKnown().isPresent) 1 else 0) + (if (lsafTempDev.asKnown().isPresent) 1 else 0) + (if (lsafTime.asKnown().isPresent) 1 else 0) + (if (plannedFuel.asKnown().isPresent) 1 else 0) + (if (pointGroupName.asKnown().isPresent) 1 else 0) + (if (worstFuelCase.asKnown().isPresent) 1 else 0)

        /** Array of point data for this Point Group. */
        class FlightPlanPoint private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("fppEta") @ExcludeMissing fppEta: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("fppLat") @ExcludeMissing fppLat: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("fppLon") @ExcludeMissing fppLon: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("fppReqFuel") @ExcludeMissing fppReqFuel: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("fppLat")
            @ExcludeMissing
            fun _fppLat(): JsonField<Double> = fppLat
            ...
            @JsonProperty("fppLon")
            @ExcludeMissing
            fun _fppLon(): JsonField<Double> = fppLon

            /**
             * Returns the raw JSON value of [fppReqFuel].
             *
             * Unlike [fppReqFuel], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(flightPlanPoint: FlightPlanPoint) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.fppEta] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fppEta(fppEta: JsonField<OffsetDateTime>) =
                    apply {
                        this.fppEta = fppEta
                    }
                 ...
                 *
                 * You should usually call [Builder.fppLat] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fppLat(fppLat: JsonField<Double>) =
                    apply {
                        this.fppLat = fppLat
                    }
                 ...
                 *
                 * You should usually call [Builder.fppLon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fppLon(fppLon: JsonField<Double>) =
                    apply {
                        this.fppLon = fppLon
                    }
                 ...
                 *
                 * You should usually call [Builder.fppReqFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fppReqFuel(fppReqFuel: JsonField<Double>) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (fppEta.asKnown().isPresent) 1 else 0) + (if (fppLat.asKnown().isPresent) 1 else 0) + (if (fppLon.asKnown().isPresent) 1 else 0) + (if (fppReqFuel.asKnown().isPresent) 1 else 0) + (if (pointName.asKnown().isPresent) 1 else 0)
            ...
            override fun toString() = "FlightPlanPoint{fppEta=$fppEta, fppLat=$fppLat, fppLon=$fppLon, fppReqFuel=$fppReqFuel, pointName=$pointName, additionalProperties=$additionalProperties}"
        }
    ...
    class FlightPlanWaypoint private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("waypointName") @ExcludeMissing waypointName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("aaTacanChannel") @ExcludeMissing aaTacanChannel: JsonField<String> = JsonMissing.of(),
            @JsonProperty("airDistance") @ExcludeMissing airDistance: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("avgCalAirspeed") @ExcludeMissing avgCalAirspeed: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("avgDriftAng") @ExcludeMissing avgDriftAng: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("avgGroundSpeed") @ExcludeMissing avgGroundSpeed: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("avgTrueAirspeed") @ExcludeMissing avgTrueAirspeed: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("avgWindDir") @ExcludeMissing avgWindDir: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("avgWindSpeed") @ExcludeMissing avgWindSpeed: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("dayLowAlt") @ExcludeMissing dayLowAlt: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("eta") @ExcludeMissing eta: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("exchangedFuel") @ExcludeMissing exchangedFuel: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("fuelFlow") @ExcludeMissing fuelFlow: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("iceCat") @ExcludeMissing iceCat: JsonField<String> = JsonMissing.of(),
            @JsonProperty("lat") @ExcludeMissing lat: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("legAlternate") @ExcludeMissing legAlternate: JsonField<String> = JsonMissing.of(),
            @JsonProperty("legDragIndex") @ExcludeMissing legDragIndex: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("legFuelDegrade") @ExcludeMissing legFuelDegrade: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("legMach") @ExcludeMissing legMach: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("legMsnIndex") @ExcludeMissing legMsnIndex: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("legWindFac") @ExcludeMissing legWindFac: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lon") @ExcludeMissing lon: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("magCourse") @ExcludeMissing magCourse: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("magHeading") @ExcludeMissing magHeading: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("nightLowAlt") @ExcludeMissing nightLowAlt: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("nvgLowAlt") @ExcludeMissing nvgLowAlt: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("pointWindDir") @ExcludeMissing pointWindDir: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("pointWindSpeed") @ExcludeMissing pointWindSpeed: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("tacanChannel") @ExcludeMissing tacanChannel: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tempDev") @ExcludeMissing tempDev: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("thunderCat") @ExcludeMissing thunderCat: JsonField<String> = JsonMissing.of(),
            @JsonProperty("totalAirDistance") @ExcludeMissing totalAirDistance: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("totalFlownDistance") @ExcludeMissing totalFlownDistance: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("totalRemDistance") @ExcludeMissing totalRemDistance: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("totalRemFuel") @ExcludeMissing totalRemFuel: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("totalTime") @ExcludeMissing totalTime: JsonField<String> = JsonMissing.of(),
            @JsonProperty("totalTimeRem") @ExcludeMissing totalTimeRem: JsonField<String> = JsonMissing.of(),
            @JsonProperty("totalUsedFuel") @ExcludeMissing totalUsedFuel: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("totalWeight") @ExcludeMissing totalWeight: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("trueCourse") @ExcludeMissing trueCourse: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("waypointNum") @ExcludeMissing waypointNum: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("zoneDistance") @ExcludeMissing zoneDistance: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("zoneFuel") @ExcludeMissing zoneFuel: JsonField<Double> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun totalFlownDistance(): Optional<Double> = totalFlownDistance.getOptional("totalFlownDistance")
         ...
         *
         * Unlike [aaTacanChannel], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("airway")
        @ExcludeMissing
        fun _airway(): JsonField<String> = airway
        ...
        @JsonProperty("arId")
        @ExcludeMissing
        fun _arId(): JsonField<String> = arId
        ...
        @JsonProperty("arpt")
        @ExcludeMissing
        fun _arpt(): JsonField<String> = arpt
        ...
        @JsonProperty("ata")
        @ExcludeMissing
        fun _ata(): JsonField<OffsetDateTime> = ata

        /**
         * Returns the raw JSON value of [avgCalAirspeed].
         *
         * Unlike [avgCalAirspeed], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [avgGroundSpeed], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [avgTrueAirspeed], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [avgWindSpeed], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _dayLowAlt(): JsonField<Double> = dayLowAlt
        ...
        @JsonProperty("eta")
        @ExcludeMissing
        fun _eta(): JsonField<OffsetDateTime> = eta

        /**
         * Returns the raw JSON value of [exchangedFuel].
         *
         * Unlike [exchangedFuel], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _fuelFlow(): JsonField<Double> = fuelFlow
        ...
        @JsonProperty("iceCat")
        @ExcludeMissing
        fun _iceCat(): JsonField<String> = iceCat
         ...
         *
         * Unlike [legAlternate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [legDragIndex], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [legFuelDegrade], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         */
        @JsonProperty("legMach")
        @ExcludeMissing
        fun _legMach(): JsonField<Double> = legMach
        ...
        @ExcludeMissing
        fun _magCourse(): JsonField<Double> = magCourse
        ...
        @JsonProperty("magVar")
        @ExcludeMissing
        fun _magVar(): JsonField<Double> = magVar
        ...
        @JsonProperty("navaid")
        @ExcludeMissing
        fun _navaid(): JsonField<String> = navaid
        ...
        @ExcludeMissing
        fun _nvgLowAlt(): JsonField<Double> = nvgLowAlt

        /**
         * Returns the raw JSON value of [pointWindDir].
         *
         * Unlike [pointWindDir], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [pointWindSpeed], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         */
        @JsonProperty("priFreq")
        @ExcludeMissing
        fun _priFreq(): JsonField<Double> = priFreq
         ...
         */
        @JsonProperty("secFreq")
        @ExcludeMissing
        fun _secFreq(): JsonField<Double> = secFreq

        /**
         * Returns the raw JSON value of [tacanChannel].
         *
         * Unlike [tacanChannel], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         */
        @JsonProperty("tempDev")
        @ExcludeMissing
        fun _tempDev(): JsonField<Double> = tempDev
         ...
         *
         * Unlike [totalAirDistance], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [totalFlownDistance], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [totalRemDistance], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [totalRemFuel], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _totalTime(): JsonField<String> = totalTime

        /**
         * Returns the raw JSON value of [totalTimeRem].
         *
         * Unlike [totalTimeRem], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [totalUsedFuel], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         */
        @JsonProperty("turbCat")
        @ExcludeMissing
        fun _turbCat(): JsonField<String> = turbCat
         ...
         */
        @JsonProperty("vorFreq")
        @ExcludeMissing
        fun _vorFreq(): JsonField<Double> = vorFreq
         ...
         *
         * Unlike [zoneDistance], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _zoneFuel(): JsonField<Double> = zoneFuel
         ...
         */
        @JsonProperty("zoneTime")
        @ExcludeMissing
        fun _zoneTime(): JsonField<Double> = zoneTime
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(flightPlanWaypoint: FlightPlanWaypoint) =
                apply {
             ...
             *
             * You should usually call [Builder.waypointName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun waypointName(waypointName: JsonField<String>) =
                apply {
                    this.waypointName = waypointName
                }

            /** The air-to-air Tactical Air Navigation (TACAN) channels used by the receiver/tanker during air refueling. */
            fun aaTacanChannel(aaTacanChannel: String) = aaTacanChannel(JsonField.of(aaTacanChannel))

            /**
             * Sets [Builder.aaTacanChannel] to an arbitrary JSON value.
             *
             * You should usually call [Builder.aaTacanChannel] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun aaTacanChannel(aaTacanChannel: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.airDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun airDistance(airDistance: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.airway] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun airway(airway: JsonField<String>) =
                apply {
                    this.airway = airway
                }
             ...
             *
             * You should usually call [Builder.alt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun alt(alt: JsonField<Double>) =
                apply {
                    this.alt = alt
                }
             ...
             *
             * You should usually call [Builder.arId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun arId(arId: JsonField<String>) =
                apply {
                    this.arId = arId
                }
             ...
             *
             * You should usually call [Builder.arpt] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun arpt(arpt: JsonField<String>) =
                apply {
                    this.arpt = arpt
                }
             ...
             *
             * You should usually call [Builder.ata] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun ata(ata: JsonField<OffsetDateTime>) =
                apply {
                    this.ata = ata
                }

            /** The average calibrated airspeed (CAS) for this leg in knots. */
            fun avgCalAirspeed(avgCalAirspeed: Double) = avgCalAirspeed(JsonField.of(avgCalAirspeed))

            /**
             * Sets [Builder.avgCalAirspeed] to an arbitrary JSON value.
             *
             * You should usually call [Builder.avgCalAirspeed] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun avgCalAirspeed(avgCalAirspeed: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.avgDriftAng] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun avgDriftAng(avgDriftAng: JsonField<Double>) =
                apply {
                    this.avgDriftAng = avgDriftAng
                }

            /** The average ground speed for this leg in knots. */
            fun avgGroundSpeed(avgGroundSpeed: Double) = avgGroundSpeed(JsonField.of(avgGroundSpeed))

            /**
             * Sets [Builder.avgGroundSpeed] to an arbitrary JSON value.
             *
             * You should usually call [Builder.avgGroundSpeed] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun avgGroundSpeed(avgGroundSpeed: JsonField<Double>) =
                apply {
                    this.avgGroundSpeed = avgGroundSpeed
                }

            /** The average true airspeed (TAS) for this leg in knots. */
            fun avgTrueAirspeed(avgTrueAirspeed: Double) = avgTrueAirspeed(JsonField.of(avgTrueAirspeed))

            /**
             * Sets [Builder.avgTrueAirspeed] to an arbitrary JSON value.
             *
             * You should usually call [Builder.avgTrueAirspeed] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun avgTrueAirspeed(avgTrueAirspeed: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.avgWindDir] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun avgWindDir(avgWindDir: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.avgWindSpeed] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun avgWindSpeed(avgWindSpeed: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.dayLowAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dayLowAlt(dayLowAlt: JsonField<Double>) =
                apply {
                    this.dayLowAlt = dayLowAlt
                }
             ...
             *
             * You should usually call [Builder.eta] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun eta(eta: JsonField<OffsetDateTime>) =
                apply {
                    this.eta = eta
                }
             ...
             *
             * You should usually call [Builder.exchangedFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun exchangedFuel(exchangedFuel: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.fuelFlow] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fuelFlow(fuelFlow: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.iceCat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun iceCat(iceCat: JsonField<String>) =
                apply {
                    this.iceCat = iceCat
                }
             ...
             *
             * You should usually call [Builder.legAlternate] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun legAlternate(legAlternate: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.legDragIndex] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun legDragIndex(legDragIndex: JsonField<Double>) =
                apply {
                    this.legDragIndex = legDragIndex
                }

            /** The fuel degrade percentage used for this leg. */
            fun legFuelDegrade(legFuelDegrade: Double) = legFuelDegrade(JsonField.of(legFuelDegrade))

            /**
             * Sets [Builder.legFuelDegrade] to an arbitrary JSON value.
             *
             * You should usually call [Builder.legFuelDegrade] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun legFuelDegrade(legFuelDegrade: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.legMach] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun legMach(legMach: JsonField<Double>) =
                apply {
                    this.legMach = legMach
                }
             ...
             *
             * You should usually call [Builder.legMsnIndex] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun legMsnIndex(legMsnIndex: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.legWindFac] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun legWindFac(legWindFac: JsonField<Double>) =
                apply {
                    this.legWindFac = legWindFac
                }
             ...
             *
             * You should usually call [Builder.magCourse] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun magCourse(magCourse: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.magHeading] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun magHeading(magHeading: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.magVar] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun magVar(magVar: JsonField<Double>) =
                apply {
                    this.magVar = magVar
                }
             ...
             *
             * You should usually call [Builder.navaid] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun navaid(navaid: JsonField<String>) =
                apply {
                    this.navaid = navaid
                }
             ...
             *
             * You should usually call [Builder.nightLowAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun nightLowAlt(nightLowAlt: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.nvgLowAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun nvgLowAlt(nvgLowAlt: JsonField<Double>) =
                apply {
                    this.nvgLowAlt = nvgLowAlt
                }
             ...
             *
             * You should usually call [Builder.pointWindDir] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pointWindDir(pointWindDir: JsonField<Double>) =
                apply {
                    this.pointWindDir = pointWindDir
                }

            /** The wind velocity at this specific point in knots. */
            fun pointWindSpeed(pointWindSpeed: Double) = pointWindSpeed(JsonField.of(pointWindSpeed))

            /**
             * Sets [Builder.pointWindSpeed] to an arbitrary JSON value.
             *
             * You should usually call [Builder.pointWindSpeed] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pointWindSpeed(pointWindSpeed: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.priFreq] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun priFreq(priFreq: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.secFreq] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun secFreq(secFreq: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.tacanChannel] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tacanChannel(tacanChannel: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.tempDev] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tempDev(tempDev: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.thunderCat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun thunderCat(thunderCat: JsonField<String>) =
                apply {
                    this.thunderCat = thunderCat
                }

            /** The total air distance to this waypoint in nautical miles. */
            fun totalAirDistance(totalAirDistance: Double) = totalAirDistance(JsonField.of(totalAirDistance))

            /**
             * Sets [Builder.totalAirDistance] to an arbitrary JSON value.
             *
             * You should usually call [Builder.totalAirDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalAirDistance(totalAirDistance: JsonField<Double>) =
                apply {
                    this.totalAirDistance = totalAirDistance
                }

            /** The total distance flown to this waypoint calculated from point of departure in nautical miles. */
            fun totalFlownDistance(totalFlownDistance: Double) = totalFlownDistance(JsonField.of(totalFlownDistance))

            /**
             * Sets [Builder.totalFlownDistance] to an arbitrary JSON value.
             *
             * You should usually call [Builder.totalFlownDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalFlownDistance(totalFlownDistance: JsonField<Double>) =
                apply {
                    this.totalFlownDistance = totalFlownDistance
                }

            /** The total distance remaining from this waypoint to the point of arrival in nautical miles. */
            fun totalRemDistance(totalRemDistance: Double) = totalRemDistance(JsonField.of(totalRemDistance))

            /**
             * Sets [Builder.totalRemDistance] to an arbitrary JSON value.
             *
             * You should usually call [Builder.totalRemDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalRemDistance(totalRemDistance: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.totalRemFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalRemFuel(totalRemFuel: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.totalTime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalTime(totalTime: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.totalTimeRem] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalTimeRem(totalTimeRem: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.totalUsedFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalUsedFuel(totalUsedFuel: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.totalWeight] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalWeight(totalWeight: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.trueCourse] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun trueCourse(trueCourse: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.turbCat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun turbCat(turbCat: JsonField<String>) =
                apply {
                    this.turbCat = turbCat
                }
             ...
             *
             * You should usually call [Builder.vorFreq] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun vorFreq(vorFreq: JsonField<Double>) =
                apply {
                    this.vorFreq = vorFreq
                }
             ...
             *
             * You should usually call [Builder.waypointNum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun waypointNum(waypointNum: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.zoneDistance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun zoneDistance(zoneDistance: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.zoneFuel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun zoneFuel(zoneFuel: JsonField<Double>) =
                apply {
                    this.zoneFuel = zoneFuel
                }
             ...
             *
             * You should usually call [Builder.zoneTime] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun zoneTime(zoneTime: JsonField<Double>) =
                apply {
        ...
        fun validate(): FlightPlanWaypoint =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (type.asKnown().isPresent) 1 else 0) + (if (waypointName.asKnown().isPresent) 1 else 0) + (if (aaTacanChannel.asKnown().isPresent) 1 else 0) + (if (airDistance.asKnown().isPresent) 1 else 0) + (if (airway.asKnown().isPresent) 1 else 0) + (if (alt.asKnown().isPresent) 1 else 0) + (if (arId.asKnown().isPresent) 1 else 0) + (if (arpt.asKnown().isPresent) 1 else 0) + (if (ata.asKnown().isPresent) 1 else 0) + (if (avgCalAirspeed.asKnown().isPresent) 1 else 0) + (if (avgDriftAng.asKnown().isPresent) 1 else 0) + (if (avgGroundSpeed.asKnown().isPresent) 1 else 0) + (if (avgTrueAirspeed.asKnown().isPresent) 1 else 0) + (if (avgWindDir.asKnown().isPresent) 1 else 0) + (if (avgWindSpeed.asKnown().isPresent) 1 else 0) + (if (dayLowAlt.asKnown().isPresent) 1 else 0) + (if (eta.asKnown().isPresent) 1 else 0) + (if (exchangedFuel.asKnown().isPresent) 1 else 0) + (if (fuelFlow.asKnown().isPresent) 1 else 0) + (if (iceCat.asKnown().isPresent) 1 else 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (legAlternate.asKnown().isPresent) 1 else 0) + (if (legDragIndex.asKnown().isPresent) 1 else 0) + (if (legFuelDegrade.asKnown().isPresent) 1 else 0) + (if (legMach.asKnown().isPresent) 1 else 0) + (if (legMsnIndex.asKnown().isPresent) 1 else 0) + (if (legWindFac.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (magCourse.asKnown().isPresent) 1 else 0) + (if (magHeading.asKnown().isPresent) 1 else 0) + (if (magVar.asKnown().isPresent) 1 else 0) + (if (navaid.asKnown().isPresent) 1 else 0) + (if (nightLowAlt.asKnown().isPresent) 1 else 0) + (if (nvgLowAlt.asKnown().isPresent) 1 else 0) + (if (pointWindDir.asKnown().isPresent) 1 else 0) + (if (pointWindSpeed.asKnown().isPresent) 1 else 0) + (if (priFreq.asKnown().isPresent) 1 else 0) + (if (secFreq.asKnown().isPresent) 1 else 0) + (if (tacanChannel.asKnown().isPresent) 1 else 0) + (if (tempDev.asKnown().isPresent) 1 else 0) + (if (thunderCat.asKnown().isPresent) 1 else 0) + (if (totalAirDistance.asKnown().isPresent) 1 else 0) + (if (totalFlownDistance.asKnown().isPresent) 1 else 0) + (if (totalRemDistance.asKnown().isPresent) 1 else 0) + (if (totalRemFuel.asKnown().isPresent) 1 else 0) + (if (totalTime.asKnown().isPresent) 1 else 0) + (if (totalTimeRem.asKnown().isPresent) 1 else 0) + (if (totalUsedFuel.asKnown().isPresent) 1 else 0) + (if (totalWeight.asKnown().isPresent) 1 else 0) + (if (trueCourse.asKnown().isPresent) 1 else 0) + (if (turbCat.asKnown().isPresent) 1 else 0) + (if (vorFreq.asKnown().isPresent) 1 else 0) + (if (waypointNum.asKnown().isPresent) 1 else 0) + (if (zoneDistance.asKnown().isPresent) 1 else 0) + (if (zoneFuel.asKnown().isPresent) 1 else 0) + (if (zoneTime.asKnown().isPresent) 1 else 0)
