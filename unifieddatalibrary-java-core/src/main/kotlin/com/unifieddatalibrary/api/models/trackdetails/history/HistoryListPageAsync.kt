...
private constructor(
    ...
    private val items: List<TrackDetailsFull>,
) : PageAsync<TrackDetailsFull> {
    ...
    fun autoPager(): AutoPagerAsync<TrackDetailsFull> =
    ...
    override fun items(): List<TrackDetailsFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<TrackDetailsFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<TrackDetailsFull>) = apply { this.items = items }
