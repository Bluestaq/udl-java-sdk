...
class HistoryCountParams private constructor(
    private val expStartTime: OffsetDateTime,
    ...
    fun expStartTime(): OffsetDateTime = expStartTime
    ...
    class Builder internal constructor() {
        ...
        private var expStartTime: OffsetDateTime? = null
        ...
        internal fun from(historyCountParams: HistoryCountParams) =
            apply {
                expStartTime = historyCountParams.expStartTime
        ...
        /** Start time of the exposure, in ISO 8601 UTC format with microsecond precision. (YYYY-MM-DDTHH:MM:SS.ssssssZ) */
        fun expStartTime(expStartTime: OffsetDateTime) =
            apply {
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("expStartTime", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(expStartTime))
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is HistoryCountParams && expStartTime == other.expStartTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(expStartTime, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "HistoryCountParams{expStartTime=$expStartTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
