 ...
 * file extension whose content conforms to the `AnalyticImagery_Ingest` schema.\ 2\) A binary image
 * file of the allowed types for this service.
 *
 ...
 */
class AnalyticImageryUnvalidatedPublishParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            analyticImageryUnvalidatedPublishParams: AnalyticImageryUnvalidatedPublishParams
        ) = apply {
            body = analyticImageryUnvalidatedPublishParams.body.toBuilder()
            additionalHeaders =
                analyticImageryUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                analyticImageryUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AnalyticImageryUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "AnalyticImageryUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
