...
class SensorPlanUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorPlanUnvalidatedPublishParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sensorPlanUnvalidatedPublishParams: SensorPlanUnvalidatedPublishParams) =
            apply {
                ...
                additionalQueryParams = sensorPlanUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("collectRequests") @ExcludeMissing private val collectRequests: JsonField<List<CollectRequest>>,
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, recType=$recType, source=$source, startTime=$startTime, type=$type, id=$id, collectRequests=$collectRequests, createdAt=$createdAt, createdBy=$createdBy, customer=$customer, endTime=$endTime, idSensor=$idSensor, name=$name, origin=$origin, origNetwork=$origNetwork, origSensorId=$origSensorId, purpose=$purpose, reqTotal=$reqTotal, senNetwork=$senNetwork, status=$status, tags=$tags}"
    }
    ...
    override fun toString() = "SensorPlanUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
