...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 *
                 * Unlike [msgTs], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("msgTs")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.msgTs] with a well-typed [OffsetDateTime]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorPlanUnvalidatedPublishParams &&
            body == other.body &&
