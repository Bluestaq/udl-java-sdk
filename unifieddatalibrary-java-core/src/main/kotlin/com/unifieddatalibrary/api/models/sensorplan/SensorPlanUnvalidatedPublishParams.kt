 ...
 */
class SensorPlanUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [SensorPlanUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanUnvalidatedPublishParams: SensorPlanUnvalidatedPublishParams) =
            apply {
                body = sensorPlanUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = sensorPlanUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    sensorPlanUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SensorPlanUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): SensorPlanUnvalidatedPublishParams =
            SensorPlanUnvalidatedPublishParams(
    ...
    /**
     * A Plan is used to aggregate two or more of the same type of record to a parent entity, with
     * the planId (UUID) being included in all of the subordinate records, enabling resolution back
     * to the parent.
     */
    class Body
    @JsonCreator
    private constructor(
         ...
         *
         * Unlike [collectRequests], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("collectRequests")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                type = body.type
                id = body.id
                collectRequests = body.collectRequests.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.recType] with a well-typed [String] value instead.
            ...
            /**
             * The list of collect requests belonging to the SensorPlan. Each collect request is
             * associated with a parent SensorPlan via the IdPlan. If provided, the list must have
             * the same size as reqTotal.
             */
             ...
             * `List<CollectRequest>` value instead. This method is primarily for setting the field
            ...
            /**
             * The total number of requests contained in this plan or schedule. Value of this field
             * must match the size of collectRequest list if the list is provided and can be null or
             * any value otherwise.
             */
             ...
             *
             * You should usually call [Builder.reqTotal] with a well-typed [Int] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.senNetwork] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        /**
         * Collect Requests support several types of individual requests, or planned/scheduled tasks
         * on sensors and/or orbital objects. Options are provided to accomodate most common sensor
         * contact and collection applications, including single sensor-object tasking, search
         * operations, and TT&C support. Multiple requests originating from a plan or schedule may
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                duration: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("dwellId")
                @ExcludeMissing
                dwellId: JsonField<String> = JsonMissing.of(),
                ...
                @JsonProperty("idPlan")
                @ExcludeMissing
                idPlan: JsonField<String> = JsonMissing.of(),
                ...
                @ExcludeMissing
                planIndex: JsonField<Int> = JsonMissing.of(),
                ...
                @JsonProperty("rcsMax")
                @ExcludeMissing
                rcsMax: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("rcsMin")
                @ExcludeMissing
                rcsMin: JsonField<Double> = JsonMissing.of(),
                ...
                @ExcludeMissing
                srchInc: JsonField<Double> = JsonMissing.of(),
                ...
                @ExcludeMissing
                stopAlt: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("stopLat")
                @ExcludeMissing
                stopLat: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("stopLon")
                @ExcludeMissing
                stopLon: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("suffix")
                @ExcludeMissing
                ...
                @JsonProperty("visMag")
                @ExcludeMissing
                visMag: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("xAngle")
                @ExcludeMissing
                xAngle: JsonField<Double> = JsonMissing.of(),
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun msgCreateDate(): Optional<OffsetDateTime> =
                msgCreateDate.getOptional("msgCreateDate")
             ...
             *
             * Unlike [extentAz], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [extentEl], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [extentRange], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("extentRange")
            @ExcludeMissing
             ...
             *
             * Unlike [frameRate], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("frameRate")
            @ExcludeMissing
             ...
             *
             * Unlike [idManifold], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("idManifold")
            @ExcludeMissing
             ...
             *
             * Unlike [idParentReq], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("idParentReq")
            @ExcludeMissing
             ...
             *
             * Unlike [integrationTime], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("integrationTime")
            @ExcludeMissing
             ...
             *
             * Unlike [irradiance], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("irradiance")
            @ExcludeMissing
             ...
             *
             * Unlike [numFrames], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [numTracks], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [orbitRegime], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("orbitRegime")
            @ExcludeMissing
             ...
             *
             * Unlike [orientAngle], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("orientAngle")
            @ExcludeMissing
             ...
             *
             * Unlike [planIndex], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [reflectance], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("reflectance")
            @ExcludeMissing
             ...
             *
             * Unlike [scenario], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [srchPattern], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("srchPattern")
            @ExcludeMissing
             ...
             *
             * Unlike [stateVector], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("stateVector")
            @ExcludeMissing
             ...
             *
             * Unlike [targetSize], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("targetSize")
            @ExcludeMissing
             ...
             *
             * Unlike [taskGroup], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("taskGroup")
            @ExcludeMissing
             ...
             *
             * Unlike [trueAnomoly], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("trueAnomoly")
            @ExcludeMissing
             ...
             *
             * Unlike [uctFollowUp], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("uctFollowUp")
            @ExcludeMissing
             ...
             *
             * Unlike [visMagMax], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("visMagMax")
            @ExcludeMissing
             ...
             *
             * Unlike [visMagMin], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("visMagMin")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.alt] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 * Sets [Builder.customer] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.customer] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun customer(customer: JsonField<String>) = apply { this.customer = customer }
                 ...
                 *
                 * You should usually call [Builder.dec] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                ...
                /**
                 * The dwell ID associated with this request. A dwell ID is dwell point specific and
                 * a DWELL request consist of many dwell point requests.
                 */
                 ...
                 *
                 * You should usually call [Builder.dwellId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.el] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.elset] with a well-typed [Elset] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                ...
                /**
                 * The end time of the collect or contact request window, in ISO 8601 UTC format. If
                 * no endTime or duration is provided it is assumed the request is either ongoing or
                 * that the request is for a specified number of tracks (numTracks). If both
                 ...
                 *
                 * You should usually call [Builder.esId] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.extentAz] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.extentEl] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.frameRate] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * yet supported value.
                 */
                fun idManifold(idManifold: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.idPlan] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.integrationTime] with a well-typed [Double]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.iron] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 * yet supported value.
                 */
                fun irradiance(irradiance: JsonField<Double>) = apply {
                 ...
                 *
                 * You should usually call [Builder.msgCreateDate] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.msgType] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.numFrames] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.numObs] with a well-typed [Int] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.numTracks] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * and not necessarily a valid sensor ID. If both idSensor and origSensorId are null
                 * then the request is assumed to be a general request for observations or contact
                 * on an object, if specified, or an area/volume. In this case, the requester may
                 * specify a desired obType.
                 */
                fun origSensorId(origSensorId: String) = origSensorId(JsonField.of(origSensorId))
                 ...
                 *
                 * You should usually call [Builder.planIndex] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.ra] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.rcs] with a well-typed [Double] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.rcsMax] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.rcsMin] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.scenario] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                ...
                /** The spectral model used for the irradiance calculation. */
                fun spectralModel(spectralModel: String) =
                    spectralModel(JsonField.of(spectralModel))
                 ...
                 *
                 * You should usually call [Builder.srchInc] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * trajectory of the orbiting body in space. J2000 is the preferred coordinate frame
                 * for all state vector positions/velocities in UDL, but in some cases data may be
                 * in another frame depending on the provider and/or datatype. Please see the
                 ...
                 *
                 * You should usually call [Builder.stateVector] with a well-typed [StateVector]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.stopAlt] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.stopLat] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.stopLon] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * yet supported value.
                 */
                fun targetSize(targetSize: JsonField<Double>) = apply {
                 ...
                 *
                 * You should usually call [Builder.taskCategory] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.taskGroup] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.visMag] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.visMagMax] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.visMagMin] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.xAngle] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.yAngle] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("agom")
                    @ExcludeMissing
                    agom: JsonField<Double> = JsonMissing.of(),
                    ...
                    @JsonProperty("bStar")
                    @ExcludeMissing
                    bStar: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("createdAt")
                    @ExcludeMissing
                    createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
                    @JsonProperty("createdBy")
                    ...
                    @JsonProperty("raan")
                    @ExcludeMissing
                    raan: JsonField<Double> = JsonMissing.of(),
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun ballisticCoeff(): Optional<Double> =
                    ballisticCoeff.getOptional("ballisticCoeff")
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun meanMotionDDot(): Optional<Double> =
                    meanMotionDDot.getOptional("meanMotionDDot")
                 ...
                 * Returns the raw JSON value of [classificationMarking].
                 *
                 * Unlike [classificationMarking], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("classificationMarking")
                @ExcludeMissing
                 ...
                 * Returns the raw JSON value of [epoch].
                 *
                 * Unlike [epoch], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("epoch")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [agom], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [apogee], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 * Returns the raw JSON value of [argOfPerigee].
                 *
                 * Unlike [argOfPerigee], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("argOfPerigee")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [bStar], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 * Returns the raw JSON value of [eccentricity].
                 *
                 * Unlike [eccentricity], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("eccentricity")
                @ExcludeMissing
                 ...
                 * Returns the raw JSON value of [idElset].
                 *
                 * Unlike [idElset], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("idElset") @ExcludeMissing fun _idElset(): JsonField<String> = idElset
                 ...
                 * Returns the raw JSON value of [inclination].
                 *
                 * Unlike [inclination], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("inclination")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [meanAnomaly], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("meanAnomaly")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [meanMotion], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("meanMotion")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [meanMotionDot], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("meanMotionDot")
                @ExcludeMissing
                 ...
                 * Returns the raw JSON value of [origin].
                 *
                 * Unlike [origin], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("origin") @ExcludeMissing fun _origin(): JsonField<String> = origin
                 ...
                 * Returns the raw JSON value of [origNetwork].
                 *
                 * Unlike [origNetwork], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("origNetwork")
                @ExcludeMissing
                 ...
                 * Returns the raw JSON value of [origObjectId].
                 *
                 * Unlike [origObjectId], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("origObjectId")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [perigee], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 * Returns the raw JSON value of [raan].
                 *
                 * Unlike [raan], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("raan") @ExcludeMissing fun _raan(): JsonField<Double> = raan
                 ...
                 *
                 * Unlike [rawFileUri], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("rawFileURI")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [revNo], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 * Returns the raw JSON value of [satNo].
                 *
                 * Unlike [satNo], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("satNo") @ExcludeMissing fun _satNo(): JsonField<Int> = satNo
                 ...
                 * Returns the raw JSON value of [semiMajorAxis].
                 *
                 * Unlike [semiMajorAxis], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("semiMajorAxis")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [sourcedData], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("sourcedData")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     * datasets.
                     *
                     * TEST:&nbsp;Specific datasets used to evaluate compliance with specifications
                     * and requirements, and for validating technical, functional, and performance
                     * characteristics.
                     */
                    fun dataMode(dataMode: DataMode) = dataMode(JsonField.of(dataMode))
                     ...
                     * Sets [Builder.epoch] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.epoch] with a well-typed [OffsetDateTime]
                    ...
                    /**
                     * AGOM, expressed in m^2/kg, is the value of the (averaged) object Area times
                     * the solar radiation pressure coefficient(Gamma) over the object Mass.
                     * Applicable only with ephemType4.
                     */
                     ...
                     *
                     * You should usually call [Builder.agom] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun algorithm(algorithm: JsonField<String>) = apply {
                        this.algorithm = algorithm
                    }

                    /**
                     * The orbit point furthest from the center of the earth in kilometers. If not
                     * provided, apogee will be computed from the TLE according to the following.
                     * Using mu, the standard gravitational parameter for the earth (398600.4418),
                     * semi-major axis A = (mu/(n _ 2 _ pi/(24*3600))^2)(1/3). Using semi-major axis
                     * A, eccentricity E, apogee = (A * (1 + E)) in km. Note that the calculations
                     * are for computing the apogee radius from the center of the earth, to compute
                     * apogee altitude the radius of the earth should be subtracted (6378.135 km).
                     */
                    ...
                    /**
                     * The argument of perigee is the angle in degrees formed between the perigee
                     * and the ascending node. If the perigee would occur at the ascending node, the
                     * argument of perigee would be 0.
                     */
                    fun argOfPerigee(argOfPerigee: Double) =
                        argOfPerigee(JsonField.of(argOfPerigee))

                    /**
                     * Sets [Builder.argOfPerigee] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.argOfPerigee] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun argOfPerigee(argOfPerigee: JsonField<Double>) = apply {
                     ...
                     *
                     * You should usually call [Builder.ballisticCoeff] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * The drag term for SGP4 orbital model, used for calculating decay constants
                     ...
                     *
                     * You should usually call [Builder.bStar] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     * perfect circle. A value of 0 is a circular orbit, values between 0 and 1 form
                    ...
                    fun eccentricity(eccentricity: Double) =
                        eccentricity(JsonField.of(eccentricity))

                    /**
                     * Sets [Builder.eccentricity] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.eccentricity] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun eccentricity(eccentricity: JsonField<Double>) = apply {
                     ...
                     * public catalog, the idOnOrbit is typically the satellite number as a string,
                     ...
                     * not yet supported value.
                     */
                    fun idOnOrbit(idOnOrbit: JsonField<String>) = apply {
                     ...
                     * example, the OrbitDetermination with idOrbitDetermination = abc would be
                     * queried as /udl/orbitdetermination/abc.
                     */
                     ...
                     *
                     * You should usually call [Builder.idOrbitDetermination] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * The angle between the equator and the orbit when looking from the center of
                     * the Earth. If the orbit went exactly around the equator from left to right,
                     * then the inclination would be 0. The inclination ranges from 0 to 180
                     * degrees.
                     */
                    fun inclination(inclination: Double) = inclination(JsonField.of(inclination))
                     ...
                     * Sets [Builder.inclination] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.inclination] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun inclination(inclination: JsonField<Double>) = apply {
                    ...
                    /**
                     * Read only derived/generated line1 of a legacy TLE (two line element set)
                     * format, ignored on create/edit operations.
                     */
                    ...
                    /**
                     * Read only derived/generated line2 of a legacy TLE (two line element set)
                     * format, ignored on create/edit operations.
                     */
                     ...
                     *
                     * You should usually call [Builder.meanAnomaly] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * Mean motion is the angular speed required for a body to complete one orbit,
                     * assuming constant speed in a circular orbit which completes in the same time
                     * as the variable speed, elliptical orbit of the actual body. Measured in
                     * revolutions per day.
                     */
                     ...
                     *
                     * You should usually call [Builder.meanMotionDDot] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.meanMotionDot] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * The originating source network on which this record was created,
                     ...
                     * Sets [Builder.origNetwork] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.origNetwork] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun origNetwork(origNetwork: JsonField<String>) = apply {
                    ...
                    /**
                     * Optional identifier provided by elset source to indicate the target onorbit
                     * object of this elset. This may be an internal identifier and not necessarily
                     * map to a valid satellite number.
                     */
                    fun origObjectId(origObjectId: String) =
                        origObjectId(JsonField.of(origObjectId))

                    /**
                     * Sets [Builder.origObjectId] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.origObjectId] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun origObjectId(origObjectId: JsonField<String>) = apply {
                     ...
                     * Using mu, the standard gravitational parameter for the earth (398600.4418),
                     * semi-major axis A = (mu/(n _ 2 _ pi/(24*3600))^2)(1/3). Using semi-major axis
                     * A, eccentricity E, perigee = (A * (1 - E)) in km. Note that the calculations
                     * are for computing the perigee radius from the center of the earth, to compute
                    ...
                    /**
                     * Right ascension of the ascending node, or RAAN is the angle as measured in
                     * degrees eastwards (or, as seen from the north, counterclockwise) from the
                     * First Point of Aries to the ascending node, which is where the orbit crosses
                     * the equator when traveling north.
                     */
                    fun raan(raan: Double) = raan(JsonField.of(raan))
                     ...
                     * Sets [Builder.raan] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.raan] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    fun raan(raan: JsonField<Double>) = apply { this.raan = raan }
                    ...
                    /**
                     * Optional URI location in the document repository of the raw file parsed by
                     * the system to produce this record. To download the raw file, prepend
                     * https://udl-hostname/scs/download?id= to this value.
                     */
                    ...
                    /**
                     * The current revolution number. The value is incremented when a satellite
                     ...
                     *
                     * You should usually call [Builder.revNo] with a well-typed [Int] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     * Sets [Builder.satNo] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.satNo] with a well-typed [Int] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    fun satNo(satNo: JsonField<Int>) = apply { this.satNo = satNo }
                     ...
                     * Sets [Builder.semiMajorAxis] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.semiMajorAxis] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun semiMajorAxis(semiMajorAxis: JsonField<Double>) = apply {
                    ...
                    /**
                     * Optional array of UDL data (observation) UUIDs used to build this element
                     * set. See the associated sourcedDataTypes array for the specific types of
                     * observations for the positionally corresponding UUIDs in this array (the two
                     * arrays must match in size).
                     */
                    fun sourcedData(sourcedData: List<String>) =
                        sourcedData(JsonField.of(sourcedData))

                    /**
                     * Sets [Builder.sourcedData] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.sourcedData] with a well-typed
                     ...
                     * (e.g. EO, RADAR, RF, DOA). See the associated sourcedData array for the
                     * specific UUIDs of observations for the positionally corresponding data types
                     * in this array (the two arrays must match in size).
                     */
                     ...
                     * `List<SourcedDataType>` value instead. This method is primarily for setting
                     ...
                     * conditional access controls to restrict access to the data. Should be left
                     * null by data providers unless conditional access controls are coordinated
                     * with the UDL team.
                     */
                    fun tags(tags: List<String>) = tags(JsonField.of(tags))
                    ...
                    /**
                     * Optional identifier to track a commercial or marketplace transaction executed
                     ...
                     * correlate to an on-orbit object was made and failed. If unable to correlate,
                     ...
                     *
                     * You should usually call [Builder.uct] with a well-typed [Boolean] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                ...
                internal fun validity(): Int =
                    (if (classificationMarking.asKnown().isPresent) 1 else 0) +
                        ...
                        (sourcedDataTypes.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                            ?: 0) +
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    /**
                     * An enum containing [DataMode]'s known values, as well as an [_UNKNOWN]
                     * member.
                     *
                     * An instance of [DataMode] can contain an unknown value in a couple of cases:
                    ...
                    enum class Value {
                        ...
                        EXERCISE,
                        /**
                         * An enum member indicating that [DataMode] was instantiated with an
                         * unknown value.
                         */
                        _UNKNOWN,
                    }
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("area")
                    @ExcludeMissing
                    area: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("bDot")
                    @ExcludeMissing
                    bDot: JsonField<Double> = JsonMissing.of(),
                    ...
                    @JsonProperty("xpos")
                    @ExcludeMissing
                    xpos: JsonField<Double> = JsonMissing.of(),
                    ...
                    @JsonProperty("xvel")
                    @ExcludeMissing
                    xvel: JsonField<Double> = JsonMissing.of(),
                    ...
                    @JsonProperty("ypos")
                    @ExcludeMissing
                    ypos: JsonField<Double> = JsonMissing.of(),
                    ...
                    @JsonProperty("yvel")
                    @ExcludeMissing
                    yvel: JsonField<Double> = JsonMissing.of(),
                    ...
                    @JsonProperty("zpos")
                    @ExcludeMissing
                    zpos: JsonField<Double> = JsonMissing.of(),
                    ...
                    @JsonProperty("zvel")
                    @ExcludeMissing
                    zvel: JsonField<Double> = JsonMissing.of(),
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun integratorMode(): Optional<String> =
                    integratorMode.getOptional("integratorMode")
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun solarFluxApAvg(): Optional<Double> =
                    solarFluxApAvg.getOptional("solarFluxAPAvg")
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun solarFluxF10Avg(): Optional<Double> =
                    solarFluxF10Avg.getOptional("solarFluxF10Avg")
                 ...
                 *
                 * Unlike [actualOdSpan], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("actualODSpan")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [area], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [bDot], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [eqCov], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [errorControl], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("errorControl")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [iau1980Terms], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("iau1980Terms")
                @ExcludeMissing
                 ...
                 * Returns the raw JSON value of [idStateVector].
                 *
                 * Unlike [idStateVector], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("idStateVector")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [inTrackThrust], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("inTrackThrust")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [lastObStart], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("lastObStart")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [lunarSolar], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("lunarSolar")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [mass], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [obsAvailable], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("obsAvailable")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [obsUsed], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [polarMotionX], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("polarMotionX")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [polarMotionY], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("polarMotionY")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [posUnc], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [residualsAcc], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("residualsAcc")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [sigmaPosUvw], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("sigmaPosUVW")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [sigmaVelUvw], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("sigmaVelUVW")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [solarFluxF10], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("solarFluxF10")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [solarRadPress], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("solarRadPress")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [srpArea], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [taiUtc], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [thrustAccel], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("thrustAccel")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [tracksAvail], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("tracksAvail")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [tracksUsed], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("tracksUsed")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [ut1Rate], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [ut1Utc], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [velUnc], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [xaccel], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [xpos], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [xvel], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [yaccel], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [ypos], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [yvel], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [zaccel], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [zpos], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [zvel], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                ...
                class Builder internal constructor() {
                    ...
                    /** The actual time span used for the OD of the object, expressed in days. */
                    fun actualOdSpan(actualOdSpan: Double) =
                        actualOdSpan(JsonField.of(actualOdSpan))

                    /**
                     * Sets [Builder.actualOdSpan] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.actualOdSpan] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.alt1ReferenceFrame] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.alt2ReferenceFrame] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.area] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.bDot] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    ...
                    /**
                     * Covariance matrix, in kilometer and second based units, in the specified
                     * covReferenceFrame. If the covReferenceFrame is null it is assumed to be
                     * J2000. The array values (1-21) represent the lower triangular half of the
                     * position-velocity covariance matrix. The size of the covariance matrix is
                     * dynamic, depending on whether the covariance for position only or position &
                     * velocity. The covariance elements are position dependent within the array
                     ...
                     * z'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;16&nbsp;&nbsp;17&nbsp;&nbsp;18&nbsp;&nbsp;19&nbsp;&nbsp;20&nbsp;&nbsp;&nbsp;21&nbsp;
                     *
                     * The cov array should contain only the lower left triangle values from top
                    ...
                    /**
                     * The method used to generate the covariance during the orbit determination
                     * (OD) that produced the state vector, or whether an arbitrary, non-calculated
                     * default value was used (CALCULATED, DEFAULT).
                     */
                     ...
                     * not yet supported value.
                     */
                    fun covMethod(covMethod: JsonField<String>) = apply {
                        this.covMethod = covMethod
                    }

                    /**
                     * The reference frame of the covariance matrix elements. If the
                     * covReferenceFrame is null it is assumed to be J2000.
                     */
                     ...
                     * [CovReferenceFrame] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun dragCoeff(dragCoeff: JsonField<Double>) = apply {
                        this.dragCoeff = dragCoeff
                    }

                    /**
                     * The Drag Model used for this vector (e.g. HARRIS-PRIESTER, JAC70, JBH09,
                     * MSIS90, NONE, etc.).
                     */
                     ...
                     * not yet supported value.
                     */
                    fun dragModel(dragModel: JsonField<String>) = apply {
                     ...
                     *
                     * You should usually call [Builder.edr] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     * where C1, C2, etc, are the "consider parameters" that may be added to the
                     * covariance matrix.&nbsp; The covariance matrix will be as large as the last
                     * element/model parameter needed.&nbsp; In other words, if the DC solved for
                     * all 6 elements plus AGOM, the covariance matrix will be 9x9 (and the rows for
                     * B and BDOT will be all zeros).&nbsp; If the covariance matrix is unavailable,
                     * the size will be set to 0x0, and no data will follow.&nbsp; The cov field
                     * should contain only the lower left triangle values from top left down to
                     ...
                     *
                     * You should usually call [Builder.eqCov] with a well-typed `List<Double>`
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /** Integrator error control. */
                    fun errorControl(errorControl: Double) =
                        errorControl(JsonField.of(errorControl))

                    /**
                     * Sets [Builder.errorControl] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.errorControl] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun fixedStep(fixedStep: JsonField<Boolean>) = apply {
                        this.fixedStep = fixedStep
                    }

                    /**
                     * Geopotential model used for this vector (e.g. EGM-96, WGS-84, WGS-72, JGM-2,
                     * or GEM-T3), including mm degree zonals, nn degree/order tesserals. E.g.
                     * EGM-96 24Z,24T.
                     */
                     ...
                     *
                     * You should usually call [Builder.geopotentialModel] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     * object using the 'get by ID' operation (e.g. /udl/orbitdetermination/{id}).
                     * For example, the OrbitDetermination with idOrbitDetermination = abc would be
                     * queries as /udl/orbitdetermination/abc.
                     */
                    fun idOrbitDetermination(idOrbitDetermination: String) =
                        idOrbitDetermination(JsonField.of(idOrbitDetermination))
                     ...
                     * Sets [Builder.idStateVector] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.idStateVector] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun idStateVector(idStateVector: JsonField<String>) = apply {
                     ...
                     *
                     * You should usually call [Builder.integratorMode] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.inTrackThrust] with a well-typed [Boolean]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.lastObEnd] with a well-typed
                     * [OffsetDateTime] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.lastObStart] with a well-typed
                     * [OffsetDateTime] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * Time of the next leap second after epoch in ISO 8601 UTC time. If the next
                     * leap second is not known, the time of the previous leap second is used.
                     */
                     ...
                     *
                     * You should usually call [Builder.lunarSolar] with a well-typed [Boolean]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.mass] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.obsUsed] with a well-typed [Int] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    ...
                    /**
                     * Optional identifier provided by state vector source to indicate the target
                     * onorbit object of this state vector. This may be an internal identifier and
                    ...
                    fun polarMotionX(polarMotionX: Double) =
                        polarMotionX(JsonField.of(polarMotionX))

                    /**
                     * Sets [Builder.polarMotionX] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.polarMotionX] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    fun polarMotionY(polarMotionY: Double) =
                        polarMotionY(JsonField.of(polarMotionY))

                    /**
                     * Sets [Builder.polarMotionY] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.polarMotionY] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun recOdSpan(recOdSpan: JsonField<Double>) = apply {
                     ...
                     * [ReferenceFrame] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
                    ...
                    /** The percentage of residuals accepted in the OD of the object. */
                    fun residualsAcc(residualsAcc: Double) =
                        residualsAcc(JsonField.of(residualsAcc))

                    /**
                     * Sets [Builder.residualsAcc] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.residualsAcc] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     * state vector update, with a value of 1.00 being optimal. WRMS applies to
                     * Batch Least Squares (BLS) processes.
                     */
                     ...
                     *
                     * You should usually call [Builder.rms] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    ...
                    /**
                     * Array containing the standard deviation of error in target object position,
                     * U, V and W direction respectively (km).
                     */
                    fun sigmaPosUvw(sigmaPosUvw: List<Double>) =
                        sigmaPosUvw(JsonField.of(sigmaPosUvw))

                    /**
                     * Sets [Builder.sigmaPosUvw] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.sigmaPosUvw] with a well-typed
                    ...
                    /**
                     * Array containing the standard deviation of error in target object velocity,
                     * U, V and W direction respectively (km/sec).
                     */
                    fun sigmaVelUvw(sigmaVelUvw: List<Double>) =
                        sigmaVelUvw(JsonField.of(sigmaVelUvw))

                    /**
                     * Sets [Builder.sigmaVelUvw] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.sigmaVelUvw] with a well-typed
                     * `List<Double>` value instead. This method is primarily for setting the field
                     * to an undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.solarFluxApAvg] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /** F10 (10.7 cm) solar flux value. */
                    fun solarFluxF10(solarFluxF10: Double) =
                        solarFluxF10(JsonField.of(solarFluxF10))

                    /**
                     * Sets [Builder.solarFluxF10] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.solarFluxF10] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.solarRadPress] with a well-typed [Boolean]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.solarRadPressCoeff] with a well-typed
                    ...
                    /**
                     * Optional array of UDL data (observation) UUIDs used to build this state
                     * vector. See the associated sourcedDataTypes array for the specific types of
                     * observations for the positionally corresponding UUIDs in this array (the two
                     * arrays must match in size).
                     */
                    fun sourcedData(sourcedData: List<String>) =
                     ...
                     *
                     * You should usually call [Builder.stepSizeSelection] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * TAI (Temps Atomique International) minus UTC (Universal Time Coordinates)
                     * offset in seconds.
                     */
                     ...
                     *
                     * You should usually call [Builder.thrustAccel] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun tracksUsed(tracksUsed: JsonField<Int>) = apply {
                    ...
                    /**
                     * Boolean indicating this state vector was unable to be correlated to a known
                     * object. This flag should only be set to true by data providers after an
                     ...
                     *
                     * You should usually call [Builder.xpos] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    ...
                    /**
                     * Cartesian X position of the target, in kilometers, in the specified
                     * alt1ReferenceFrame. Alternate reference frames are optional and are intended
                     * to allow a data source to provide an equivalent vector in a different
                     * cartesian frame than the primary vector.
                     */
                    ...
                    /**
                     * Cartesian X position of the target, in kilometers, in the specified
                     * alt2ReferenceFrame. Alternate reference frames are optional and are intended
                     * to allow a data source to provide an equivalent vector in a different
                     * cartesian frame than the primary vector.
                     */
                     ...
                     *
                     * You should usually call [Builder.xvel] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.ypos] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.yvel] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.zpos] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.zvel] with a well-typed [Double] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    /**
                     * An enum containing [CovReferenceFrame]'s known values, as well as an
                     * [_UNKNOWN] member.
                     *
                     * An instance of [CovReferenceFrame] can contain an unknown value in a couple
                     * of cases:
                     * - It was deserialized from data that doesn't match any known member. For
                     *   example, if the SDK is on an older version than the API, then the API may
                     *   respond with new members that the SDK is unaware of.
                    ...
                    enum class Value {
                        ...
                        GCRF,
                        /**
                         * An enum member indicating that [CovReferenceFrame] was instantiated with
                         * an unknown value.
                         */
                        _UNKNOWN,
                    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SensorPlanUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SensorPlanUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
