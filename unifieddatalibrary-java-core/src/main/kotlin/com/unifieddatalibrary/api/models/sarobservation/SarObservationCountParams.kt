...
class SarObservationCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SarObservationCountParams].
         *
    ...
    /** A builder for [SarObservationCountParams]. */
    class Builder internal constructor() {

        private var collectionStart: OffsetDateTime? = null
        ...
        @JvmSynthetic
        internal fun from(sarObservationCountParams: SarObservationCountParams) =
            apply {
                collectionStart = sarObservationCountParams.collectionStart
                firstResult = sarObservationCountParams.firstResult
                maxResults = sarObservationCountParams.maxResults
                additionalHeaders = sarObservationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = sarObservationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SarObservationCountParams].
         *
         ...
         */
        fun build(): SarObservationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SarObservationCountParams && collectionStart == other.collectionStart && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(collectionStart, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "SarObservationCountParams{collectionStart=$collectionStart, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
