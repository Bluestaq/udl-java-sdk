...
class SeradataRadarPayloadGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SeradataRadarPayloadGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SeradataRadarPayloadGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SeradataRadarPayloadGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataRadarPayloadGetParams: SeradataRadarPayloadGetParams) =
            apply {
                id = seradataRadarPayloadGetParams.id
                firstResult = seradataRadarPayloadGetParams.firstResult
                maxResults = seradataRadarPayloadGetParams.maxResults
                additionalHeaders = seradataRadarPayloadGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = seradataRadarPayloadGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataRadarPayloadGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataRadarPayloadGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataRadarPayloadGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SeradataRadarPayloadGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
