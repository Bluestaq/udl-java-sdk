 ...
 * parameter.
 */
class SeradataRadarPayloadGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataRadarPayloadGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataRadarPayloadGetParams: SeradataRadarPayloadGetParams) = apply {
    ...
    override fun toString() =
        "SeradataRadarPayloadGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
