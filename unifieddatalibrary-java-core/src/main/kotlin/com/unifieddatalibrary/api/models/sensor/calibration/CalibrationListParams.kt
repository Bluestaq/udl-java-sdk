...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalibrationListParams].
         *
    ...
    /** A builder for [CalibrationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationListParams: CalibrationListParams) = apply {
            startTime = calibrationListParams.startTime
            firstResult = calibrationListParams.firstResult
            maxResults = calibrationListParams.maxResults
            additionalHeaders = calibrationListParams.additionalHeaders.toBuilder()
            additionalQueryParams = calibrationListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CalibrationListParams].
         *
         ...
         */
        fun build(): CalibrationListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CalibrationListParams &&
    ...
    override fun toString() =
        "CalibrationListParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
