...
class PassiveRadarObservationListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<PassiveRadarObservationListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PassiveRadarObservationListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(passiveRadarObservationListPageAsync: PassiveRadarObservationListPageAsync) =
            apply {
        ...
        fun service(service: PassiveRadarObservationServiceAsync) =
            apply {
    ...
    override fun toString() = "PassiveRadarObservationListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
