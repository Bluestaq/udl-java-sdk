...
class PassiveRadarObservationCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PassiveRadarObservationCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(passiveRadarObservationCreateParams: PassiveRadarObservationCreateParams) =
            apply {
                ...
                additionalQueryParams = passiveRadarObservationCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** The target Acceleration uncertainty measurement in kilometers/sec^2 for this observation. */
        fun accelUnc(accelUnc: Double) =
            apply {
                body.accelUnc(accelUnc)
            }
        ...
        /** Target bistatic path distance in kilometers. This is the transmitter-to-target-to-surveillance site distance. */
        fun bistaticRange(bistaticRange: Double) =
            apply {
        ...
        /** One sigma uncertainty in the coning angle measurement, in degrees. */
        fun coningUnc(coningUnc: Double) =
            apply {
                body.coningUnc(coningUnc)
            }
        ...
        /** Delay bias in seconds. */
        fun delayBias(delayBias: Double) =
            apply {
                body.delayBias(delayBias)
            }
        ...
        /** One sigma uncertainty in the delay measurement, in seconds. */
        fun delayUnc(delayUnc: Double) =
            apply {
                body.delayUnc(delayUnc)
            }
        ...
        /** The Time of Flight (TOF) bias in seconds. */
        fun tofBias(tofBias: Double) =
            apply {
                body.tofBias(tofBias)
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PassiveRadarObservationCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "PassiveRadarObservationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
