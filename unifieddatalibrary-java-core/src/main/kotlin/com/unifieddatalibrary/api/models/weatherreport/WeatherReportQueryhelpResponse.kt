...
class WeatherReportQueryhelpResponse
private constructor(
    ...
    /** A builder for [WeatherReportQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherReportQueryhelpResponse: WeatherReportQueryhelpResponse) = apply {
            aodrSupported = weatherReportQueryhelpResponse.aodrSupported
            classificationMarking = weatherReportQueryhelpResponse.classificationMarking
            description = weatherReportQueryhelpResponse.description
            historySupported = weatherReportQueryhelpResponse.historySupported
            name = weatherReportQueryhelpResponse.name
            parameters = weatherReportQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = weatherReportQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = weatherReportQueryhelpResponse.restSupported
            sortSupported = weatherReportQueryhelpResponse.sortSupported
            typeName = weatherReportQueryhelpResponse.typeName
            uri = weatherReportQueryhelpResponse.uri
            additionalProperties =
                weatherReportQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WeatherReportQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WeatherReportQueryhelpResponse =
            WeatherReportQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): WeatherReportQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WeatherReportQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
