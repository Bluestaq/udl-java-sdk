...
class EphemerisSetRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EphemerisSetRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetRetrieveParams: EphemerisSetRetrieveParams) = apply {
    ...
    override fun toString() =
        "EphemerisSetRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
