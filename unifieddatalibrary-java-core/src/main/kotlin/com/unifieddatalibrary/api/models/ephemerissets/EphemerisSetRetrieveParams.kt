...
class EphemerisSetRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EphemerisSetRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EphemerisSetRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EphemerisSetRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetRetrieveParams: EphemerisSetRetrieveParams) =
            apply {
                id = ephemerisSetRetrieveParams.id
                firstResult = ephemerisSetRetrieveParams.firstResult
                maxResults = ephemerisSetRetrieveParams.maxResults
                additionalHeaders = ephemerisSetRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = ephemerisSetRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EphemerisSetRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EphemerisSetRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EphemerisSetRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EphemerisSetRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
