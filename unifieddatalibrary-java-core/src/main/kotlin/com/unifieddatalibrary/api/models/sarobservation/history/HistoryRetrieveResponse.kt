...
class HistoryRetrieveResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(historyRetrieveResponse: HistoryRetrieveResponse) =
            apply {
                classificationMarking = historyRetrieveResponse.classificationMarking
                collectionEnd = historyRetrieveResponse.collectionEnd
                collectionStart = historyRetrieveResponse.collectionStart
                dataMode = historyRetrieveResponse.dataMode
                sarMode = historyRetrieveResponse.sarMode
                source = historyRetrieveResponse.source
                id = historyRetrieveResponse.id
                agjson = historyRetrieveResponse.agjson
                andims = historyRetrieveResponse.andims
                area = historyRetrieveResponse.area
                asrid = historyRetrieveResponse.asrid
                atext = historyRetrieveResponse.atext
                atype = historyRetrieveResponse.atype
                azimuthAngle = historyRetrieveResponse.azimuthAngle
                centerTime = historyRetrieveResponse.centerTime
                collectionId = historyRetrieveResponse.collectionId
                continuousSpotAngle = historyRetrieveResponse.continuousSpotAngle
                coordSys = historyRetrieveResponse.coordSys
                createdAt = historyRetrieveResponse.createdAt
                createdBy = historyRetrieveResponse.createdBy
                detectionEnd = historyRetrieveResponse.detectionEnd
                detectionId = historyRetrieveResponse.detectionId
                detectionStart = historyRetrieveResponse.detectionStart
                dwellTime = historyRetrieveResponse.dwellTime
                externalId = historyRetrieveResponse.externalId
                farRange = historyRetrieveResponse.farRange
                grazeAngle = historyRetrieveResponse.grazeAngle
                groundResolutionProjection = historyRetrieveResponse.groundResolutionProjection
                idOnOrbit = historyRetrieveResponse.idOnOrbit
                idSensor = historyRetrieveResponse.idSensor
                incidenceAngle = historyRetrieveResponse.incidenceAngle
                looksAzimuth = historyRetrieveResponse.looksAzimuth
                looksRange = historyRetrieveResponse.looksRange
                multilookNumber = historyRetrieveResponse.multilookNumber
                nearRange = historyRetrieveResponse.nearRange
                obDirection = historyRetrieveResponse.obDirection
                onOrbit = historyRetrieveResponse.onOrbit
                operatingBand = historyRetrieveResponse.operatingBand
                operatingFreq = historyRetrieveResponse.operatingFreq
                orbitState = historyRetrieveResponse.orbitState
                origin = historyRetrieveResponse.origin
                origNetwork = historyRetrieveResponse.origNetwork
                origObjectId = historyRetrieveResponse.origObjectId
                origSensorId = historyRetrieveResponse.origSensorId
                pulseBandwidth = historyRetrieveResponse.pulseBandwidth
                pulseDuration = historyRetrieveResponse.pulseDuration
                resolutionAzimuth = historyRetrieveResponse.resolutionAzimuth
                resolutionRange = historyRetrieveResponse.resolutionRange
                rxPolarization = historyRetrieveResponse.rxPolarization
                satNo = historyRetrieveResponse.satNo
                senalt = historyRetrieveResponse.senalt
                senlatEnd = historyRetrieveResponse.senlatEnd
                senlatStart = historyRetrieveResponse.senlatStart
                senlonEnd = historyRetrieveResponse.senlonEnd
                senlonStart = historyRetrieveResponse.senlonStart
                senvelx = historyRetrieveResponse.senvelx
                senvely = historyRetrieveResponse.senvely
                senvelz = historyRetrieveResponse.senvelz
                slantRange = historyRetrieveResponse.slantRange
                snr = historyRetrieveResponse.snr
                sourceDl = historyRetrieveResponse.sourceDl
                spacingAzimuth = historyRetrieveResponse.spacingAzimuth
                spacingRange = historyRetrieveResponse.spacingRange
                squintAngle = historyRetrieveResponse.squintAngle
                srcIds = historyRetrieveResponse.srcIds.map { it.toMutableList() }
                srcTyps = historyRetrieveResponse.srcTyps.map { it.toMutableList() }
                swathLength = historyRetrieveResponse.swathLength
                tags = historyRetrieveResponse.tags.map { it.toMutableList() }
                targetposx = historyRetrieveResponse.targetposx
                targetposy = historyRetrieveResponse.targetposy
                targetposz = historyRetrieveResponse.targetposz
                transactionId = historyRetrieveResponse.transactionId
                txPolarization = historyRetrieveResponse.txPolarization
    ...
    fun validate(): HistoryRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
