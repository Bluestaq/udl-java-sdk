...
/**
 * Service operation to update a single Antenna. A specific role is required to perform this service
 * operation. Please contact the UDL team for assistance.
 */
class AntennaUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AntennaUpdateParams].
         *
    ...
    /** A builder for [AntennaUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaUpdateParams: AntennaUpdateParams) = apply {
            pathId = antennaUpdateParams.pathId
            antennaIngest = antennaUpdateParams.antennaIngest
            additionalHeaders = antennaUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = antennaUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AntennaUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AntennaUpdateParams &&
            pathId == other.pathId &&
    ...
    override fun hashCode(): Int =
        Objects.hash(pathId, antennaIngest, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "AntennaUpdateParams{pathId=$pathId, antennaIngest=$antennaIngest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
