...
class CrewQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CrewQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [CrewQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crewQueryhelpResponse: CrewQueryhelpResponse) =
            apply {
                aodrSupported = crewQueryhelpResponse.aodrSupported
                classificationMarking = crewQueryhelpResponse.classificationMarking
                description = crewQueryhelpResponse.description
                historySupported = crewQueryhelpResponse.historySupported
                name = crewQueryhelpResponse.name
                parameters = crewQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = crewQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = crewQueryhelpResponse.restSupported
                sortSupported = crewQueryhelpResponse.sortSupported
                typeName = crewQueryhelpResponse.typeName
                uri = crewQueryhelpResponse.uri
                additionalProperties = crewQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CrewQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CrewQueryhelpResponse =
    ...
    fun validate(): CrewQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CrewQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
