...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crewQueryhelpResponse: CrewQueryhelpResponse) = apply {
    ...
    fun validate(): CrewQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
