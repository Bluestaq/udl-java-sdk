...
class AirTaskingOrderRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AirTaskingOrderRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AirTaskingOrderRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AirTaskingOrderRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderRetrieveParams: AirTaskingOrderRetrieveParams) =
            apply {
                id = airTaskingOrderRetrieveParams.id
                firstResult = airTaskingOrderRetrieveParams.firstResult
                maxResults = airTaskingOrderRetrieveParams.maxResults
                additionalHeaders = airTaskingOrderRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = airTaskingOrderRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirTaskingOrderRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AirTaskingOrderRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirTaskingOrderRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirTaskingOrderRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
