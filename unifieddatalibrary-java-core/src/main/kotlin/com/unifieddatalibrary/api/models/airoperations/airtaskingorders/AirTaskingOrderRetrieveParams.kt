 ...
 * parameter.
 */
class AirTaskingOrderRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirTaskingOrderRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderRetrieveParams: AirTaskingOrderRetrieveParams) = apply {
    ...
    override fun toString() =
        "AirTaskingOrderRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
