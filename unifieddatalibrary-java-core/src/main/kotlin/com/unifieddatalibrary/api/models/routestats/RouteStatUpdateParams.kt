...
class RouteStatUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RouteStatUpdateParams].
         *
    ...
    /** A builder for [RouteStatUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatUpdateParams: RouteStatUpdateParams) =
            apply {
                pathId = routeStatUpdateParams.pathId
                body = routeStatUpdateParams.body.toBuilder()
                additionalHeaders = routeStatUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = routeStatUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RouteStatUpdateParams].
         *
         ...
         */
        fun build(): RouteStatUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RouteStatUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "RouteStatUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
