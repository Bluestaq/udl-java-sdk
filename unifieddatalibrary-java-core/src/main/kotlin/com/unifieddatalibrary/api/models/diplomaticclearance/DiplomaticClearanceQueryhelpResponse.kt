...
class DiplomaticClearanceQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DiplomaticClearanceQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [DiplomaticClearanceQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diplomaticClearanceQueryhelpResponse: DiplomaticClearanceQueryhelpResponse) =
            apply {
                aodrSupported = diplomaticClearanceQueryhelpResponse.aodrSupported
                classificationMarking = diplomaticClearanceQueryhelpResponse.classificationMarking
                description = diplomaticClearanceQueryhelpResponse.description
                historySupported = diplomaticClearanceQueryhelpResponse.historySupported
                name = diplomaticClearanceQueryhelpResponse.name
                parameters = diplomaticClearanceQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = diplomaticClearanceQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = diplomaticClearanceQueryhelpResponse.restSupported
                sortSupported = diplomaticClearanceQueryhelpResponse.sortSupported
                typeName = diplomaticClearanceQueryhelpResponse.typeName
                uri = diplomaticClearanceQueryhelpResponse.uri
                additionalProperties = diplomaticClearanceQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DiplomaticClearanceQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DiplomaticClearanceQueryhelpResponse =
    ...
    fun validate(): DiplomaticClearanceQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is DiplomaticClearanceQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
