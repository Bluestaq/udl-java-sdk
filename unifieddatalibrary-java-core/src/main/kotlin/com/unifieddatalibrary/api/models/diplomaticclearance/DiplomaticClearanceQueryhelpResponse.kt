...
class DiplomaticClearanceQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            diplomaticClearanceQueryhelpResponse: DiplomaticClearanceQueryhelpResponse
        ) = apply {
            ...
            requiredRoles =
                diplomaticClearanceQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                diplomaticClearanceQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): DiplomaticClearanceQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
