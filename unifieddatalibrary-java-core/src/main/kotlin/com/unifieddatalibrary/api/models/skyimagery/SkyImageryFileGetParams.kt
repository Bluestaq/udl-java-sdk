...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SkyImageryFileGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryFileGetParams: SkyImageryFileGetParams) = apply {
    ...
    override fun toString() =
        "SkyImageryFileGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
