...
class SkyImageryFileGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SkyImageryFileGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SkyImageryFileGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SkyImageryFileGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryFileGetParams: SkyImageryFileGetParams) =
            apply {
                id = skyImageryFileGetParams.id
                firstResult = skyImageryFileGetParams.firstResult
                maxResults = skyImageryFileGetParams.maxResults
                additionalHeaders = skyImageryFileGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = skyImageryFileGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SkyImageryFileGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SkyImageryFileGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SkyImageryFileGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SkyImageryFileGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
