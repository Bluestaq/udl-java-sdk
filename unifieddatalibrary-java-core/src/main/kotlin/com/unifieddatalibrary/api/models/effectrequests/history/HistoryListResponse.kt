...
private constructor(
     ...
     *
     * NOLATERTHAN: Produce effect no later than the given startTime. Large penalty for being later,
     * no reward for being even earlier as long as the effect starts by the given time.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
