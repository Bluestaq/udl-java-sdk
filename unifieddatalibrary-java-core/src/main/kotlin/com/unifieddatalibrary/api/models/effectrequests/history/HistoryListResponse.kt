...
import com.unifieddatalibrary.api.models.effectrequests.history.HistoryListResponse
...
class HistoryListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("effectList") @ExcludeMissing effectList: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("deadlineType") @ExcludeMissing deadlineType: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("metricTypes") @ExcludeMissing metricTypes: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("metricWeights") @ExcludeMissing metricWeights: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("modelClass") @ExcludeMissing modelClass: JsonField<String> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) =
            apply {
                ...
                effectList = historyListResponse.effectList.map { it.toMutableList() }
                source = historyListResponse.source
                id = historyListResponse.id
                context = historyListResponse.context
                createdAt = historyListResponse.createdAt
                createdBy = historyListResponse.createdBy
                deadlineType = historyListResponse.deadlineType
                endTime = historyListResponse.endTime
                externalRequestId = historyListResponse.externalRequestId
                metricTypes = historyListResponse.metricTypes.map { it.toMutableList() }
                metricWeights = historyListResponse.metricWeights.map { it.toMutableList() }
                modelClass = historyListResponse.modelClass
                ...
                state = historyListResponse.state
                targetSrcId = historyListResponse.targetSrcId
                targetSrcType = historyListResponse.targetSrcType
