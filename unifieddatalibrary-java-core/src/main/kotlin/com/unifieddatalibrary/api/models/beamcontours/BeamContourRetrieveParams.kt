...
class BeamContourRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BeamContourRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamContourRetrieveParams: BeamContourRetrieveParams) = apply {
    ...
    override fun toString() =
        "BeamContourRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
