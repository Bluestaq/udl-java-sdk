...
class BeamContourRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): BeamContourRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BeamContourRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [BeamContourRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamContourRetrieveParams: BeamContourRetrieveParams) =
            apply {
                id = beamContourRetrieveParams.id
                firstResult = beamContourRetrieveParams.firstResult
                maxResults = beamContourRetrieveParams.maxResults
                additionalHeaders = beamContourRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = beamContourRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BeamContourRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BeamContourRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BeamContourRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "BeamContourRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
