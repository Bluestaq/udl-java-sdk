...
class DiffofarrivalListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiffofarrivalListParams].
         *
    ...
    /** A builder for [DiffofarrivalListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffofarrivalListParams: DiffofarrivalListParams) =
            apply {
                obTime = diffofarrivalListParams.obTime
                firstResult = diffofarrivalListParams.firstResult
                maxResults = diffofarrivalListParams.maxResults
                additionalHeaders = diffofarrivalListParams.additionalHeaders.toBuilder()
                additionalQueryParams = diffofarrivalListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DiffofarrivalListParams].
         *
         ...
         */
        fun build(): DiffofarrivalListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is DiffofarrivalListParams && obTime == other.obTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "DiffofarrivalListParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
