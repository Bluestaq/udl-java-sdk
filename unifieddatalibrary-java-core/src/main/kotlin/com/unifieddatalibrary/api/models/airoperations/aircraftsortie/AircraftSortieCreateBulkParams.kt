 ...
 */
class AircraftSortieCreateBulkParams
private constructor(
    ...
    /** A builder for [AircraftSortieCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortieCreateBulkParams: AircraftSortieCreateBulkParams) = apply {
            body = aircraftSortieCreateBulkParams.body.toMutableList()
            additionalHeaders = aircraftSortieCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftSortieCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftSortieCreateBulkParams].
         *
         ...
         */
        fun build(): AircraftSortieCreateBulkParams =
            AircraftSortieCreateBulkParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftSortieCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AircraftSortieCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
