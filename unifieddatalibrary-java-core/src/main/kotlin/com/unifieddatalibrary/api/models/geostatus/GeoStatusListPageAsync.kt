...
class GeoStatusListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<GeoStatusListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusListPageAsync: GeoStatusListPageAsync) =
            apply {
        ...
        fun service(service: GeoStatusServiceAsync) =
            apply {
    ...
    override fun toString() = "GeoStatusListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
