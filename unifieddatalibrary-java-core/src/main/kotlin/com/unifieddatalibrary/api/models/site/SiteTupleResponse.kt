...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteTupleResponse: SiteTupleResponse) = apply {
    ...
    fun validate(): SiteTupleResponse = apply {
        if (validated) {
            return@apply
        }
