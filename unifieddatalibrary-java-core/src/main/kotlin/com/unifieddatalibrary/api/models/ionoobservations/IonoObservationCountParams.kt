 ...
 */
class IonoObservationCountParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ionoObservationCountParams: IonoObservationCountParams) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IonoObservationCountParams &&
    ...
    override fun toString() =
        "IonoObservationCountParams{startTimeUtc=$startTimeUtc, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
