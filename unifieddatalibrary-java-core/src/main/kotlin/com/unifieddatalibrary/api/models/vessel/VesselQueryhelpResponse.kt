...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselQueryhelpResponse: VesselQueryhelpResponse) = apply {
    ...
    fun validate(): VesselQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
