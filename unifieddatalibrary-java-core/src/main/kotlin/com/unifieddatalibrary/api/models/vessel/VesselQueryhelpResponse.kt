...
class VesselQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [VesselQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [VesselQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(vesselQueryhelpResponse: VesselQueryhelpResponse) =
            apply {
                aodrSupported = vesselQueryhelpResponse.aodrSupported
                classificationMarking = vesselQueryhelpResponse.classificationMarking
                description = vesselQueryhelpResponse.description
                historySupported = vesselQueryhelpResponse.historySupported
                name = vesselQueryhelpResponse.name
                parameters = vesselQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = vesselQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = vesselQueryhelpResponse.restSupported
                sortSupported = vesselQueryhelpResponse.sortSupported
                typeName = vesselQueryhelpResponse.typeName
                uri = vesselQueryhelpResponse.uri
                additionalProperties = vesselQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [VesselQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VesselQueryhelpResponse =
    ...
    fun validate(): VesselQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is VesselQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
