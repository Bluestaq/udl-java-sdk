...
/**
 * Service operation intended for initial integration only, to take a list of ObsCorrelation records
 ...
 */
class ObscorrelationCreateBulkParams
private constructor(
    ...
    /** A builder for [ObscorrelationCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(obscorrelationCreateBulkParams: ObscorrelationCreateBulkParams) = apply {
            body = obscorrelationCreateBulkParams.body.toMutableList()
            additionalHeaders = obscorrelationCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = obscorrelationCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationCreateBulkParams].
         *
         ...
         */
        fun build(): ObscorrelationCreateBulkParams =
            ObscorrelationCreateBulkParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationCreateBulkParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ObscorrelationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
