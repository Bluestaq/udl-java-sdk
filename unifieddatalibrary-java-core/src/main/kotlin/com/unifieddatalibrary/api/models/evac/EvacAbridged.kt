...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evacAbridged: EvacAbridged) = apply {
    ...
    fun validate(): EvacAbridged = apply {
        if (validated) {
            return@apply
        }
