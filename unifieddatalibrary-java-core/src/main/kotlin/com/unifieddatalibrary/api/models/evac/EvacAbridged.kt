...
class EvacAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EvacAbridged].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evacAbridged: EvacAbridged) =
            apply {
                classificationMarking = evacAbridged.classificationMarking
                dataMode = evacAbridged.dataMode
                pickupLat = evacAbridged.pickupLat
                pickupLon = evacAbridged.pickupLon
                reqTime = evacAbridged.reqTime
                source = evacAbridged.source
                type = evacAbridged.type
                id = evacAbridged.id
                casualtyInfo = evacAbridged.casualtyInfo.map { it.toMutableList() }
                ce = evacAbridged.ce
                cntctFreq = evacAbridged.cntctFreq
                comments = evacAbridged.comments
                createdAt = evacAbridged.createdAt
                createdBy = evacAbridged.createdBy
                enemyData = evacAbridged.enemyData.map { it.toMutableList() }
                idWeatherReport = evacAbridged.idWeatherReport
                le = evacAbridged.le
                medevacId = evacAbridged.medevacId
                medicReq = evacAbridged.medicReq
                missionType = evacAbridged.missionType
                numAmbulatory = evacAbridged.numAmbulatory
                numCasualties = evacAbridged.numCasualties
                numKia = evacAbridged.numKia
                numLitter = evacAbridged.numLitter
                numWia = evacAbridged.numWia
                obstaclesRemarks = evacAbridged.obstaclesRemarks
                origin = evacAbridged.origin
                origNetwork = evacAbridged.origNetwork
                pickupAlt = evacAbridged.pickupAlt
                pickupTime = evacAbridged.pickupTime
                reqCallSign = evacAbridged.reqCallSign
                reqNum = evacAbridged.reqNum
                terrain = evacAbridged.terrain
                terrainRemarks = evacAbridged.terrainRemarks
                zoneContrCallSign = evacAbridged.zoneContrCallSign
                zoneHot = evacAbridged.zoneHot
                zoneMarking = evacAbridged.zoneMarking
                zoneMarkingColor = evacAbridged.zoneMarkingColor
                zoneName = evacAbridged.zoneName
                zoneSecurity = evacAbridged.zoneSecurity
                additionalProperties = evacAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EvacAbridged].
         *
