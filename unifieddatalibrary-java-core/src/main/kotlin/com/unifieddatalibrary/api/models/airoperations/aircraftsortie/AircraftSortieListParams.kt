 ...
 */
class AircraftSortieListParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftSortieListParams].
         *
    ...
    /** A builder for [AircraftSortieListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortieListParams: AircraftSortieListParams) = apply {
            plannedDepTime = aircraftSortieListParams.plannedDepTime
            firstResult = aircraftSortieListParams.firstResult
            maxResults = aircraftSortieListParams.maxResults
            additionalHeaders = aircraftSortieListParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftSortieListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftSortieListParams].
         *
         ...
         */
        fun build(): AircraftSortieListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftSortieListParams && plannedDepTime == other.plannedDepTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AircraftSortieListParams{plannedDepTime=$plannedDepTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
