 ...
 */
class AviationRiskManagementCountParams
private constructor(
    ...
    /** A builder for [AviationRiskManagementCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aviationRiskManagementCountParams: AviationRiskManagementCountParams) =
            apply {
                idMission = aviationRiskManagementCountParams.idMission
                firstResult = aviationRiskManagementCountParams.firstResult
                maxResults = aviationRiskManagementCountParams.maxResults
                additionalHeaders = aviationRiskManagementCountParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    aviationRiskManagementCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AviationRiskManagementCountParams].
         *
         ...
         */
        fun build(): AviationRiskManagementCountParams =
            AviationRiskManagementCountParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AviationRiskManagementCountParams && idMission == other.idMission && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(idMission, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AviationRiskManagementCountParams{idMission=$idMission, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
