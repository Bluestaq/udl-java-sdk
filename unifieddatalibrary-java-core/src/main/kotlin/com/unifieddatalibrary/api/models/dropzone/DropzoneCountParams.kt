...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DropzoneCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropzoneCountParams: DropzoneCountParams) = apply {
    ...
    override fun toString() =
        "DropzoneCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
