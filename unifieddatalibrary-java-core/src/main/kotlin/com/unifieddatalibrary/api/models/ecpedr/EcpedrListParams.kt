...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpedrListParams].
         *
    ...
    /** A builder for [EcpedrListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpedrListParams: EcpedrListParams) = apply {
            obTime = ecpedrListParams.obTime
            firstResult = ecpedrListParams.firstResult
            maxResults = ecpedrListParams.maxResults
            additionalHeaders = ecpedrListParams.additionalHeaders.toBuilder()
            additionalQueryParams = ecpedrListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EcpedrListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EcpedrListParams &&
            obTime == other.obTime &&
    ...
    override fun toString() =
        "EcpedrListParams{obTime=$obTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
