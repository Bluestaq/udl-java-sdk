...
class OrbitdeterminationCountParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OrbitdeterminationCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OrbitdeterminationCountParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OrbitdeterminationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationCountParams: OrbitdeterminationCountParams) =
            apply {
                firstResult = orbitdeterminationCountParams.firstResult
                idOnOrbit = orbitdeterminationCountParams.idOnOrbit
                maxResults = orbitdeterminationCountParams.maxResults
                startTime = orbitdeterminationCountParams.startTime
                additionalHeaders = orbitdeterminationCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = orbitdeterminationCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OrbitdeterminationCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OrbitdeterminationCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OrbitdeterminationCountParams && firstResult == other.firstResult && idOnOrbit == other.idOnOrbit && maxResults == other.maxResults && startTime == other.startTime && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OrbitdeterminationCountParams{firstResult=$firstResult, idOnOrbit=$idOnOrbit, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
