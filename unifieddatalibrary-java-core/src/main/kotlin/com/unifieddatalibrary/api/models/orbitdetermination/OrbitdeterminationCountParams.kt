 ...
 */
class OrbitdeterminationCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OrbitdeterminationCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationCountParams: OrbitdeterminationCountParams) = apply {
    ...
    override fun toString() =
        "OrbitdeterminationCountParams{firstResult=$firstResult, idOnOrbit=$idOnOrbit, maxResults=$maxResults, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
