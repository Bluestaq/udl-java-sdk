...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun recType(): String = body.recType()
     ...
     *   if the server responded with an unexpected value).
     */
    fun collectRequests(): Optional<List<CollectRequest>> = body.collectRequests()
     ...
     *   if the server responded with an unexpected value).
     */
    fun reqTotal(): Optional<Int> = body.reqTotal()
     ...
     *   if the server responded with an unexpected value).
     */
    fun senNetwork(): Optional<String> = body.senNetwork()
     ...
     */
    fun _recType(): JsonField<String> = body._recType()
     ...
     */
    fun _collectRequests(): JsonField<List<CollectRequest>> = body._collectRequests()
     ...
     */
    fun _reqTotal(): JsonField<Int> = body._reqTotal()
     ...
     */
    fun _senNetwork(): JsonField<String> = body._senNetwork()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorPlanUpdateParams].
         *
    ...
    /** A builder for [SensorPlanUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanUpdateParams: SensorPlanUpdateParams) = apply {
            pathId = sensorPlanUpdateParams.pathId
            body = sensorPlanUpdateParams.body.toBuilder()
            additionalHeaders = sensorPlanUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = sensorPlanUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** The type of records that comprise this parent set (COLLECT, CONTACT). */
        fun recType(recType: String) = apply { body.recType(recType) }
         ...
         */
        fun recType(recType: JsonField<String>) = apply { body.recType(recType) }
         ...
         */
        fun collectRequests(collectRequests: List<CollectRequest>) = apply {
            body.collectRequests(collectRequests)
        }
        ...
        fun addCollectRequest(collectRequest: CollectRequest) = apply {
            body.addCollectRequest(collectRequest)
        }
         ...
         * value otherwise.
         */
        fun reqTotal(reqTotal: Int) = apply { body.reqTotal(reqTotal) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun reqTotal(reqTotal: JsonField<Int>) = apply { body.reqTotal(reqTotal) }

        /** The sensor or ground network associated with this plan or schedule. */
        fun senNetwork(senNetwork: String) = apply { body.senNetwork(senNetwork) }
         ...
         * value.
         */
        fun senNetwork(senNetwork: JsonField<String>) = apply { body.senNetwork(senNetwork) }
        ...
        /**
         * Returns an immutable instance of [SensorPlanUpdateParams].
         *
         ...
         */
        fun build(): SensorPlanUpdateParams =
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && recType == other.recType && source == other.source && startTime == other.startTime && type == other.type && bodyId == other.bodyId && collectRequests == other.collectRequests && createdAt == other.createdAt && createdBy == other.createdBy && customer == other.customer && endTime == other.endTime && idSensor == other.idSensor && name == other.name && origin == other.origin && origNetwork == other.origNetwork && origSensorId == other.origSensorId && purpose == other.purpose && reqTotal == other.reqTotal && senNetwork == other.senNetwork && status == other.status && tags == other.tags && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, recType, source, startTime, type, bodyId, collectRequests, createdAt, createdBy, customer, endTime, idSensor, name, origin, origNetwork, origSensorId, purpose, reqTotal, senNetwork, status, tags, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, recType=$recType, source=$source, startTime=$startTime, type=$type, bodyId=$bodyId, collectRequests=$collectRequests, createdAt=$createdAt, createdBy=$createdBy, customer=$customer, endTime=$endTime, idSensor=$idSensor, name=$name, origin=$origin, origNetwork=$origNetwork, origSensorId=$origSensorId, purpose=$purpose, reqTotal=$reqTotal, senNetwork=$senNetwork, status=$status, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SensorPlanUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SensorPlanUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
