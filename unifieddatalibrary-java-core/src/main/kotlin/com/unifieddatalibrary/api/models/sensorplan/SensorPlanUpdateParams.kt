...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorPlanUpdateParams &&
            pathId == other.pathId &&
            body == other.body &&
