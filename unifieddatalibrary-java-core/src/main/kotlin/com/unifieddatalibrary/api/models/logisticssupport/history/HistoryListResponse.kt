...
import com.unifieddatalibrary.api.models.logisticssupport.history.HistoryListResponse
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) =
            apply {
                ...
                logisticsDiscrepancyInfos = historyListResponse.logisticsDiscrepancyInfos.map { it.toMutableList() }
                ...
                logisticsSupportItems = historyListResponse.logisticsSupportItems.map { it.toMutableList() }
                logisticsTransportationPlans = historyListResponse.logisticsTransportationPlans.map { it.toMutableList() }
