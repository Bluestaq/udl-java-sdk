...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            rptCreatedTime = historyListResponse.rptCreatedTime
            source = historyListResponse.source
            id = historyListResponse.id
            aircraftMds = historyListResponse.aircraftMds
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            currIcao = historyListResponse.currIcao
            etic = historyListResponse.etic
            etmc = historyListResponse.etmc
            extSystemId = historyListResponse.extSystemId
            logisticAction = historyListResponse.logisticAction
            logisticsDiscrepancyInfos =
                historyListResponse.logisticsDiscrepancyInfos.map { it.toMutableList() }
            logisticsRecordId = historyListResponse.logisticsRecordId
            logisticsRemarks = historyListResponse.logisticsRemarks.map { it.toMutableList() }
            logisticsSupportItems =
                historyListResponse.logisticsSupportItems.map { it.toMutableList() }
            logisticsTransportationPlans =
                historyListResponse.logisticsTransportationPlans.map { it.toMutableList() }
            maintStatusCode = historyListResponse.maintStatusCode
            mcTime = historyListResponse.mcTime
            meTime = historyListResponse.meTime
            origin = historyListResponse.origin
            origNetwork = historyListResponse.origNetwork
            owner = historyListResponse.owner
            reopenFlag = historyListResponse.reopenFlag
            rptClosedTime = historyListResponse.rptClosedTime
            suppIcao = historyListResponse.suppIcao
            tailNumber = historyListResponse.tailNumber
