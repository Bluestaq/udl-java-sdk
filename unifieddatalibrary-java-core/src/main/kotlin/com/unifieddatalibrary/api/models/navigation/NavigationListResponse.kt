...
class NavigationListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NavigationListResponse].
         *
    ...
    /** A builder for [NavigationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationListResponse: NavigationListResponse) =
            apply {
                classificationMarking = navigationListResponse.classificationMarking
                dataMode = navigationListResponse.dataMode
                name = navigationListResponse.name
                source = navigationListResponse.source
                id = navigationListResponse.id
                createdAt = navigationListResponse.createdAt
                createdBy = navigationListResponse.createdBy
                description = navigationListResponse.description
                idEntity = navigationListResponse.idEntity
                origin = navigationListResponse.origin
                origNetwork = navigationListResponse.origNetwork
                additionalProperties = navigationListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [NavigationListResponse].
         *
         ...
         */
        fun build(): NavigationListResponse =
    ...
    fun validate(): NavigationListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "NavigationListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, description=$description, idEntity=$idEntity, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
}
