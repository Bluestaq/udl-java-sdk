...
import com.unifieddatalibrary.api.models.missionassignment.history.HistoryQueryResponse
...
class HistoryQueryResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("c6longpm") @ExcludeMissing c6longpm: JsonField<String> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyQueryResponse: HistoryQueryResponse) =
            apply {
                ...
                mad = historyQueryResponse.mad
                source = historyQueryResponse.source
                ts = historyQueryResponse.ts
                id = historyQueryResponse.id
                c1associateddmpis = historyQueryResponse.c1associateddmpis
                c2air = historyQueryResponse.c2air
                c2alt = historyQueryResponse.c2alt
                c2crs = historyQueryResponse.c2crs
                c2exerciseindicator = historyQueryResponse.c2exerciseindicator
                c2exercisemof = historyQueryResponse.c2exercisemof
                c2id = historyQueryResponse.c2id
                c2idamplifyingdescriptor = historyQueryResponse.c2idamplifyingdescriptor
                c2lnd = historyQueryResponse.c2lnd
                c2spc = historyQueryResponse.c2spc
                c2spd = historyQueryResponse.c2spd
                c2specialinterestindicator = historyQueryResponse.c2specialinterestindicator
                c2sur = historyQueryResponse.c2sur
                c3elv = historyQueryResponse.c3elv
                c3lat = historyQueryResponse.c3lat
                c3lon = historyQueryResponse.c3lon
                c3ptl = historyQueryResponse.c3ptl
                c3ptnum = historyQueryResponse.c3ptnum
                c4colon = historyQueryResponse.c4colon
                c4def = historyQueryResponse.c4def
                c4egress = historyQueryResponse.c4egress
                c4mod = historyQueryResponse.c4mod
                c4numberofstores = historyQueryResponse.c4numberofstores
                c4runin = historyQueryResponse.c4runin
                c4tgt = historyQueryResponse.c4tgt
                c4timediscrete = historyQueryResponse.c4timediscrete
                c4tm = historyQueryResponse.c4tm
                c4typeofstores = historyQueryResponse.c4typeofstores
                c5colon = historyQueryResponse.c5colon
                c5elevationlsbs = historyQueryResponse.c5elevationlsbs
                c5haeadj = historyQueryResponse.c5haeadj
                c5latlsb = historyQueryResponse.c5latlsb
                c5lonlsb = historyQueryResponse.c5lonlsb
                c5tgtbrng = historyQueryResponse.c5tgtbrng
                c5tw = historyQueryResponse.c5tw
                c6dspc = historyQueryResponse.c6dspc
                c6dspct = historyQueryResponse.c6dspct
                c6fplpm = historyQueryResponse.c6fplpm
                c6intel = historyQueryResponse.c6intel
                c6laser = historyQueryResponse.c6laser
                c6longpm = historyQueryResponse.c6longpm
                c6tnr3 = historyQueryResponse.c6tnr3
                c7elang2 = historyQueryResponse.c7elang2
                c7in3p = historyQueryResponse.c7in3p
                c7tnor = historyQueryResponse.c7tnor
                createdAt = historyQueryResponse.createdAt
                createdBy = historyQueryResponse.createdBy
                env = historyQueryResponse.env
                index = historyQueryResponse.index
                lat = historyQueryResponse.lat
                lon = historyQueryResponse.lon
                orginx = historyQueryResponse.orginx
                origin = historyQueryResponse.origin
                origNetwork = historyQueryResponse.origNetwork
                rc = historyQueryResponse.rc
                rr = historyQueryResponse.rr
                sz = historyQueryResponse.sz
                tno = historyQueryResponse.tno
                trkId = historyQueryResponse.trkId
                twenv = historyQueryResponse.twenv
                updatedAt = historyQueryResponse.updatedAt
                updatedBy = historyQueryResponse.updatedBy
