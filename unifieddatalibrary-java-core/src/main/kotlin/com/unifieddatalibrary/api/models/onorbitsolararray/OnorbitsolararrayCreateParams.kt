...
/**
 * Service operation to take a single OnorbitSolarArray as a POST body and ingest into the database.
 ...
 * assistance.
 */
class OnorbitsolararrayCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitsolararrayCreateParams: OnorbitsolararrayCreateParams) = apply {
         ...
         */
        fun solarArray(solarArray: SolarArray) = apply { body.solarArray(solarArray) }

        /**
         * Sets [Builder.solarArray] to an arbitrary JSON value.
         *
         * You should usually call [Builder.solarArray] with a well-typed [SolarArray] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun solarArray(solarArray: JsonField<SolarArray>) = apply { body.solarArray(solarArray) }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            solarArray: JsonField<SolarArray> = JsonMissing.of(),
        ) : this(
            classificationMarking,
            dataMode,
            idOnOrbit,
        ...
        class Builder internal constructor() {
            ...
            /**
             * Model representation of information on on-orbit/spacecraft solar arrays. A spacecraft
             * may have multiple solar arrays and each solar array can have multiple 'details'
             ...
             * supported value.
             */
            fun solarArray(solarArray: JsonField<SolarArray>) = apply {
        ...
        internal fun validity(): Int =
            (if (classificationMarking.asKnown().isPresent) 1 else 0) +
                ...
                (solarArray.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idOnOrbit=$idOnOrbit, idSolarArray=$idSolarArray, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, solarArray=$solarArray, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(solarArray: SolarArray) = apply {
        ...
        override fun toString() =
            "SolarArray{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "OnorbitsolararrayCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
