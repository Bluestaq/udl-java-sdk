...
private constructor(
     ...
     *   if the server responded with an unexpected value).
     */
    fun solarArray(): Optional<SolarArrayIngest> = body.solarArray()
     ...
     */
    fun _solarArray(): JsonField<SolarArrayIngest> = body._solarArray()
    ...
    class Builder internal constructor() {
         ...
         */
        fun solarArray(solarArray: SolarArrayIngest) = apply { body.solarArray(solarArray) }

        /**
         * Sets [Builder.solarArray] to an arbitrary JSON value.
         *
         * You should usually call [Builder.solarArray] with a well-typed [SolarArrayIngest] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun solarArray(solarArray: JsonField<SolarArrayIngest>) = apply {
    ...
    private constructor(
        ...
        private val solarArray: JsonField<SolarArrayIngest>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            solarArray: JsonField<SolarArrayIngest> = JsonMissing.of(),
        ) : this(
            classificationMarking,
            dataMode,
            idOnOrbit,
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun solarArray(): Optional<SolarArrayIngest> = solarArray.getOptional("solarArray")
        ...
        @JsonProperty("solarArray")
        @ExcludeMissing
        fun _solarArray(): JsonField<SolarArrayIngest> = solarArray
        ...
        class Builder internal constructor() {
            ...
            private var solarArray: JsonField<SolarArrayIngest> = JsonMissing.of()
             ...
             */
            fun solarArray(solarArray: SolarArrayIngest) = solarArray(JsonField.of(solarArray))

            /**
             * Sets [Builder.solarArray] to an arbitrary JSON value.
             *
             * You should usually call [Builder.solarArray] with a well-typed [SolarArrayIngest]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun solarArray(solarArray: JsonField<SolarArrayIngest>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitsolararrayCreateParams &&
            body == other.body &&
