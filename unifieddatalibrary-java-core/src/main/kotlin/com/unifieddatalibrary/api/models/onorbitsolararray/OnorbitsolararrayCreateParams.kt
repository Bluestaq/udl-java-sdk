...
class OnorbitsolararrayCreateParams private constructor(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun solarArray(): Optional<SolarArray> = body.solarArray()
    ...
    /**
     * Returns the raw JSON value of [solarArray].
     *
     * Unlike [solarArray], this method doesn't throw if the JSON field has an unexpected type.
     */
    fun _solarArray(): JsonField<SolarArray> = body._solarArray()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitsolararrayCreateParams].
         *
    ...
    /** A builder for [OnorbitsolararrayCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitsolararrayCreateParams: OnorbitsolararrayCreateParams) =
            apply {
                body = onorbitsolararrayCreateParams.body.toBuilder()
                additionalHeaders = onorbitsolararrayCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitsolararrayCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** ID of the SolarArray. */
        fun idSolarArray(idSolarArray: String) =
            apply {
        ...
        /** Model representation of information on on-orbit/spacecraft solar arrays. A spacecraft may have multiple solar arrays and each solar array can have multiple 'details' records compiled by different sources. */
        fun solarArray(solarArray: SolarArray) =
            apply {
                body.solarArray(solarArray)
            }

        /**
         * Sets [Builder.solarArray] to an arbitrary JSON value.
         *
         * You should usually call [Builder.solarArray] with a well-typed [SolarArray] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun solarArray(solarArray: JsonField<SolarArray>) =
            apply {
                body.solarArray(solarArray)
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitsolararrayCreateParams].
         *
         ...
         */
        fun build(): OnorbitsolararrayCreateParams =
    ...
    class Body private constructor(
        ...
        private val solarArray: JsonField<SolarArray>,
        ...
        private constructor(
            ...
            @JsonProperty("solarArray") @ExcludeMissing solarArray: JsonField<SolarArray> = JsonMissing.of()
        ) : this(
          classificationMarking,
          dataMode,
          idOnOrbit,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun solarArray(): Optional<SolarArray> = solarArray.getOptional("solarArray")
         ...
         * Unlike [solarArray], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("solarArray")
        @ExcludeMissing
        fun _solarArray(): JsonField<SolarArray> = solarArray
        ...
        class Builder internal constructor() {
            ...
            private var solarArray: JsonField<SolarArray> = JsonMissing.of()
            ...
            /** Model representation of information on on-orbit/spacecraft solar arrays. A spacecraft may have multiple solar arrays and each solar array can have multiple 'details' records compiled by different sources. */
            fun solarArray(solarArray: SolarArray) = solarArray(JsonField.of(solarArray))
        ...
        fun validate(): Body =
            apply {
                ...
                origNetwork()
                quantity()
                solarArray().ifPresent { it.validate() }
                validated = true
            }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSolarArray.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (solarArray.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && idOnOrbit == other.idOnOrbit && idSolarArray == other.idSolarArray && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && origin == other.origin && origNetwork == other.origNetwork && quantity == other.quantity && solarArray == other.solarArray && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idOnOrbit, idSolarArray, source, id, createdAt, createdBy, origin, origNetwork, quantity, solarArray, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idOnOrbit=$idOnOrbit, idSolarArray=$idSolarArray, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, quantity=$quantity, solarArray=$solarArray, additionalProperties=$additionalProperties}"
    }
    ...
    /** Model representation of information on on-orbit/spacecraft solar arrays. A spacecraft may have multiple solar arrays and each solar array can have multiple 'details' records compiled by different sources. */
    class SolarArray private constructor(
        private val dataMode: JsonField<DataMode>,
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [SolarArray].
             *
             * The following fields are required:
             *
             * ```java
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(solarArray: SolarArray) =
                apply {
                    dataMode = solarArray.dataMode
                    name = solarArray.name
                    source = solarArray.source
                    id = solarArray.id
                    createdAt = solarArray.createdAt
                    createdBy = solarArray.createdBy
                    origin = solarArray.origin
                    origNetwork = solarArray.origNetwork
                    additionalProperties = solarArray.additionalProperties.toMutableMap()
                }
            ...
            /**
             * Returns an immutable instance of [SolarArray].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is SolarArray && dataMode == other.dataMode && name == other.name && source == other.source && id == other.id && createdAt == other.createdAt && createdBy == other.createdBy && origin == other.origin && origNetwork == other.origNetwork && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "SolarArray{dataMode=$dataMode, name=$name, source=$source, id=$id, createdAt=$createdAt, createdBy=$createdBy, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitsolararrayCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OnorbitsolararrayCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
