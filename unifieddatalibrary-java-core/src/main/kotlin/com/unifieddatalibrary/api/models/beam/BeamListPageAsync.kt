...
class BeamListPageAsync private constructor(
    ...
    fun autoPager(): AutoPagerAsync<BeamAbridged> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamListPageAsync: BeamListPageAsync) =
            apply {
        ...
        fun service(service: BeamServiceAsync) =
            apply {
    ...
    override fun toString() = "BeamListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
