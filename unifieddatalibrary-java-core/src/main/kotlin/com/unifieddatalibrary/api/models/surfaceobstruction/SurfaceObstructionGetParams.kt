 ...
 * parameter.
 */
class SurfaceObstructionGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SurfaceObstructionGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionGetParams: SurfaceObstructionGetParams) = apply {
    ...
    override fun toString() =
        "SurfaceObstructionGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
