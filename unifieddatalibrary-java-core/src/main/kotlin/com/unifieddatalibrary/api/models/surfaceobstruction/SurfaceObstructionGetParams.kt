...
class SurfaceObstructionGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SurfaceObstructionGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SurfaceObstructionGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SurfaceObstructionGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceObstructionGetParams: SurfaceObstructionGetParams) =
            apply {
                id = surfaceObstructionGetParams.id
                firstResult = surfaceObstructionGetParams.firstResult
                maxResults = surfaceObstructionGetParams.maxResults
                additionalHeaders = surfaceObstructionGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = surfaceObstructionGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SurfaceObstructionGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SurfaceObstructionGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SurfaceObstructionGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SurfaceObstructionGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
