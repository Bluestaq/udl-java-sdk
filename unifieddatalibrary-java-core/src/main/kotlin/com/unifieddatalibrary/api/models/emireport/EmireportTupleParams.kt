...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmireportTupleParams].
         *
    ...
    /** A builder for [EmireportTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emireportTupleParams: EmireportTupleParams) = apply {
            columns = emireportTupleParams.columns
            reportTime = emireportTupleParams.reportTime
            firstResult = emireportTupleParams.firstResult
            maxResults = emireportTupleParams.maxResults
            additionalHeaders = emireportTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = emireportTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EmireportTupleParams].
         *
         ...
         */
        fun build(): EmireportTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmireportTupleParams &&
    ...
    override fun toString() =
        "EmireportTupleParams{columns=$columns, reportTime=$reportTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
