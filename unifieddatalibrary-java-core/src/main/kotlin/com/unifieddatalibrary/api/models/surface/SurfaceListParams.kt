...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SurfaceListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(surfaceListParams: SurfaceListParams) = apply {
    ...
    override fun toString() =
        "SurfaceListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
