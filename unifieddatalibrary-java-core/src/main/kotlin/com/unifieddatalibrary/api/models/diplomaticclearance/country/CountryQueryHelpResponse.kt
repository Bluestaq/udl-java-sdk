...
class CountryQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CountryQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [CountryQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryQueryHelpResponse: CountryQueryHelpResponse) =
            apply {
                aodrSupported = countryQueryHelpResponse.aodrSupported
                classificationMarking = countryQueryHelpResponse.classificationMarking
                description = countryQueryHelpResponse.description
                historySupported = countryQueryHelpResponse.historySupported
                name = countryQueryHelpResponse.name
                parameters = countryQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = countryQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = countryQueryHelpResponse.restSupported
                sortSupported = countryQueryHelpResponse.sortSupported
                typeName = countryQueryHelpResponse.typeName
                uri = countryQueryHelpResponse.uri
                additionalProperties = countryQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CountryQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CountryQueryHelpResponse =
    ...
    fun validate(): CountryQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CountryQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
