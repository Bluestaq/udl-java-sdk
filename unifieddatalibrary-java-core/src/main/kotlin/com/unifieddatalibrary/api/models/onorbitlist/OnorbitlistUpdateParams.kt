...
/**
 * Service operation to update a single OnorbitList. An OnorbitList is just a generic named list of
 * on-orbit IDs. A specific role is required to perform this service operation. Please contact the
 * UDL team for assistance.
 */
class OnorbitlistUpdateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistUpdateParams: OnorbitlistUpdateParams) = apply {
        ...
        /** Ordered array of Onorbit IDs belonging to this list. */
        fun onorbits(onorbits: List<String>) = apply { body.onorbits(onorbits) }

        /**
         * Sets [Builder.onorbits] to an arbitrary JSON value.
         *
         * You should usually call [Builder.onorbits] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun onorbits(onorbits: JsonField<List<String>>) = apply { body.onorbits(onorbits) }
         ...
         */
        fun addOnorbit(onorbit: String) = apply { body.addOnorbit(onorbit) }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            onorbits: JsonField<List<String>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             * supported value.
             */
            fun onorbits(onorbits: JsonField<List<String>>) = apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addOnorbit(onorbit: String) = apply {
                onorbits =
                    (onorbits ?: JsonField.of(mutableListOf())).also {
        ...
        internal fun validity(): Int =
            (if (classificationMarking.asKnown().isPresent) 1 else 0) +
                ...
                (onorbits.asKnown().getOrNull()?.size ?: 0) +
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, bodyId=$bodyId, createdAt=$createdAt, createdBy=$createdBy, description=$description, onorbits=$onorbits, origin=$origin, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "OnorbitlistUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
