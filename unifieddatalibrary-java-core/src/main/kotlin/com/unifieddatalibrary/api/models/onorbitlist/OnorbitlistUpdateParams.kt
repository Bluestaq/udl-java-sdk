...
class OnorbitlistUpdateParams private constructor(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun onorbits(): Optional<List<String>> = body.onorbits()
     ...
     */
    fun _onorbits(): JsonField<List<String>> = body._onorbits()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitlistUpdateParams].
         *
    ...
    /** A builder for [OnorbitlistUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitlistUpdateParams: OnorbitlistUpdateParams) =
            apply {
                pathId = onorbitlistUpdateParams.pathId
                body = onorbitlistUpdateParams.body.toBuilder()
                additionalHeaders = onorbitlistUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitlistUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Ordered array of Onorbit IDs belonging to this list. */
        fun onorbits(onorbits: List<String>) =
            apply {
                body.onorbits(onorbits)
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitlistUpdateParams].
         *
         ...
         */
        fun build(): OnorbitlistUpdateParams =
    ...
    class Body private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) =
                apply {
                    ...
                    onorbits = body.onorbits.map { it.toMutableList() }
                    origin = body.origin
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (bodyId.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (onorbits.asKnown().getOrNull()?.size ?: 0) + (if (origin.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && name == other.name && source == other.source && bodyId == other.bodyId && createdAt == other.createdAt && createdBy == other.createdBy && description == other.description && onorbits == other.onorbits && origin == other.origin && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, name, source, bodyId, createdAt, createdBy, description, onorbits, origin, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, name=$name, source=$source, bodyId=$bodyId, createdAt=$createdAt, createdBy=$createdBy, description=$description, onorbits=$onorbits, origin=$origin, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitlistUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OnorbitlistUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
