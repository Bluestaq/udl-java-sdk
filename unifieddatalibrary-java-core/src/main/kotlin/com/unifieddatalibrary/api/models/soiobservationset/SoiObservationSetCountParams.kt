 ...
 */
class SoiObservationSetCountParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SoiObservationSetCountParams].
         *
    ...
    /** A builder for [SoiObservationSetCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(soiObservationSetCountParams: SoiObservationSetCountParams) = apply {
            startTime = soiObservationSetCountParams.startTime
            firstResult = soiObservationSetCountParams.firstResult
            maxResults = soiObservationSetCountParams.maxResults
            additionalHeaders = soiObservationSetCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = soiObservationSetCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SoiObservationSetCountParams].
         *
         ...
         */
        fun build(): SoiObservationSetCountParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SoiObservationSetCountParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SoiObservationSetCountParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
