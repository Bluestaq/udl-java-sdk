 ...
 * J2K being preferred.
 */
class OnboardnavigationListResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationListResponse: OnboardnavigationListResponse) = apply {
    ...
    fun validate(): OnboardnavigationListResponse = apply {
        if (validated) {
            return@apply
        }
