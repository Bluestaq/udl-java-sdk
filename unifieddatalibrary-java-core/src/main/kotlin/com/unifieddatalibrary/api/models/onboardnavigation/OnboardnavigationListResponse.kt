...
class OnboardnavigationListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("deltaPos") @ExcludeMissing deltaPos: JsonField<List<List<Double>>> = JsonMissing.of(),
        ...
        @JsonProperty("mag") @ExcludeMissing mag: JsonField<List<List<Double>>> = JsonMissing.of(),
        ...
        @JsonProperty("starCatLoadTime") @ExcludeMissing starCatLoadTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("starCatName") @ExcludeMissing starCatName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("starTracker") @ExcludeMissing starTracker: JsonField<List<List<Double>>> = JsonMissing.of(),
        @JsonProperty("sunSensor") @ExcludeMissing sunSensor: JsonField<List<List<Double>>> = JsonMissing.of(),
        @JsonProperty("ts") @ExcludeMissing ts: JsonField<List<OffsetDateTime>> = JsonMissing.of()
    ) : this(
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun starCatLoadTime(): Optional<OffsetDateTime> = starCatLoadTime.getOptional("starCatLoadTime")
    ...
    @JsonProperty("mag")
    @ExcludeMissing
    fun _mag(): JsonField<List<List<Double>>> = mag
     ...
     *
     * Unlike [starCatLoadTime], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("ts")
    @ExcludeMissing
    fun _ts(): JsonField<List<OffsetDateTime>> = ts
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnboardnavigationListResponse].
         *
    ...
    /** A builder for [OnboardnavigationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationListResponse: OnboardnavigationListResponse) =
            apply {
                classificationMarking = onboardnavigationListResponse.classificationMarking
                dataMode = onboardnavigationListResponse.dataMode
                source = onboardnavigationListResponse.source
                startTime = onboardnavigationListResponse.startTime
                id = onboardnavigationListResponse.id
                createdAt = onboardnavigationListResponse.createdAt
                createdBy = onboardnavigationListResponse.createdBy
                deltaPos = onboardnavigationListResponse.deltaPos.map { it.toMutableList() }
                endTime = onboardnavigationListResponse.endTime
                esId = onboardnavigationListResponse.esId
                idOnOrbit = onboardnavigationListResponse.idOnOrbit
                idStateVector = onboardnavigationListResponse.idStateVector
                mag = onboardnavigationListResponse.mag.map { it.toMutableList() }
                origin = onboardnavigationListResponse.origin
                origNetwork = onboardnavigationListResponse.origNetwork
                origObjectId = onboardnavigationListResponse.origObjectId
                referenceFrame = onboardnavigationListResponse.referenceFrame
                satNo = onboardnavigationListResponse.satNo
                starCatLoadTime = onboardnavigationListResponse.starCatLoadTime
                starCatName = onboardnavigationListResponse.starCatName
                starTracker = onboardnavigationListResponse.starTracker.map { it.toMutableList() }
                sunSensor = onboardnavigationListResponse.sunSensor.map { it.toMutableList() }
                ts = onboardnavigationListResponse.ts.map { it.toMutableList() }
                additionalProperties = onboardnavigationListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.deltaPos] with a well-typed `List<List<Double>>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun deltaPos(deltaPos: JsonField<List<List<Double>>>) =
            apply {
         ...
         */
        fun addDeltaPo(deltaPo: List<Double>) =
            apply {
                deltaPos = (deltaPos ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.mag] with a well-typed `List<List<Double>>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mag(mag: JsonField<List<List<Double>>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addMag(mag: List<Double>) =
            apply {
                this.mag = (this.mag ?: JsonField.of(mutableListOf())).also {
        ...
        /** The last load time of the current star catalog onboard this spacecraft. */
        fun starCatLoadTime(starCatLoadTime: OffsetDateTime) = starCatLoadTime(JsonField.of(starCatLoadTime))

        /**
         * Sets [Builder.starCatLoadTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.starCatLoadTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun starCatLoadTime(starCatLoadTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.starCatName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun starCatName(starCatName: JsonField<String>) =
            apply {
                this.starCatName = starCatName
            }

        /** Arrays of spacecraft position (X, Y, Z), in km, in the specified referenceFrame, based on the onboard star tracker, at each epoch. */
        fun starTracker(starTracker: List<List<Double>>) = starTracker(JsonField.of(starTracker))

        /**
         * Sets [Builder.starTracker] to an arbitrary JSON value.
         *
         * You should usually call [Builder.starTracker] with a well-typed `List<List<Double>>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun starTracker(starTracker: JsonField<List<List<Double>>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addStarTracker(starTracker: List<Double>) =
            apply {
                this.starTracker = (this.starTracker ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.sunSensor] with a well-typed `List<List<Double>>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sunSensor(sunSensor: JsonField<List<List<Double>>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSunSensor(sunSensor: List<Double>) =
            apply {
                this.sunSensor = (this.sunSensor ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.ts] with a well-typed `List<OffsetDateTime>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ts(ts: JsonField<List<OffsetDateTime>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addT(t: OffsetDateTime) =
            apply {
                ts = (ts ?: JsonField.of(mutableListOf())).also {
                    checkKnown("ts", it).add(t)
                }
            }
        ...
        /**
         * Returns an immutable instance of [OnboardnavigationListResponse].
         *
         ...
         */
        fun build(): OnboardnavigationListResponse =
    ...
    fun validate(): OnboardnavigationListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (deltaPos.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (esId.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idStateVector.asKnown().isPresent) 1 else 0) + (mag.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (referenceFrame.asKnown().getOrNull()?.validity() ?: 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (starCatLoadTime.asKnown().isPresent) 1 else 0) + (if (starCatName.asKnown().isPresent) 1 else 0) + (starTracker.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) + (sunSensor.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) + (ts.asKnown().getOrNull()?.size ?: 0)
