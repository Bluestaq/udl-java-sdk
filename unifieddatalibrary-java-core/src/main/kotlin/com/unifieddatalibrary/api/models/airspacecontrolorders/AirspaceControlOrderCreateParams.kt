...
/**
 * Service operation to take a single AirspaceControlOrder record as a POST body and ingest into the
 * database. A specific role is required to perform this service operation. Please contact the UDL
 * team for assistance.
 */
class AirspaceControlOrderCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun opExName(): String = body.opExName()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun originator(): String = body.originator()
     ...
     *   if the server responded with an unexpected value).
     */
    fun acoComments(): Optional<String> = body.acoComments()
     ...
     *   if the server responded with an unexpected value).
     */
    fun acoSerialNum(): Optional<String> = body.acoSerialNum()
    ...
    fun airspaceControlMeansStatus(): Optional<List<AirspaceControlMeansStatus>> =
        body.airspaceControlMeansStatus()
    ...
    fun airspaceControlOrderReferences(): Optional<List<AirspaceControlOrderReference>> =
        body.airspaceControlOrderReferences()
     ...
     *   if the server responded with an unexpected value).
     */
    fun areaOfValidity(): Optional<String> = body.areaOfValidity()
     ...
     *   if the server responded with an unexpected value).
     */
    fun classReasons(): Optional<List<String>> = body.classReasons()
     ...
     *   if the server responded with an unexpected value).
     */
    fun classSource(): Optional<String> = body.classSource()
     ...
     *   if the server responded with an unexpected value).
     */
    fun declassExemptionCodes(): Optional<List<String>> = body.declassExemptionCodes()
     ...
     *   if the server responded with an unexpected value).
     */
    fun downgradeInsDates(): Optional<List<String>> = body.downgradeInsDates()
     ...
     *   if the server responded with an unexpected value).
     */
    fun geoDatum(): Optional<String> = body.geoDatum()
     ...
     *   if the server responded with an unexpected value).
     */
    fun month(): Optional<String> = body.month()
     ...
     *   if the server responded with an unexpected value).
     */
    fun opExInfo(): Optional<String> = body.opExInfo()
     ...
     *   if the server responded with an unexpected value).
     */
    fun opExInfoAlt(): Optional<String> = body.opExInfoAlt()
     ...
     *   if the server responded with an unexpected value).
     */
    fun planOrigNum(): Optional<String> = body.planOrigNum()
     ...
     *   if the server responded with an unexpected value).
     */
    fun qualifier(): Optional<String> = body.qualifier()
     ...
     *   if the server responded with an unexpected value).
     */
    fun qualSn(): Optional<Int> = body.qualSn()
     ...
     *   if the server responded with an unexpected value).
     */
    fun serialNum(): Optional<String> = body.serialNum()
     ...
     *   if the server responded with an unexpected value).
     */
    fun stopQualifier(): Optional<String> = body.stopQualifier()
     ...
     *   if the server responded with an unexpected value).
     */
    fun stopTime(): Optional<OffsetDateTime> = body.stopTime()
     ...
     *   if the server responded with an unexpected value).
     */
    fun undLnkTrks(): Optional<List<String>> = body.undLnkTrks()
     ...
     */
    fun _opExName(): JsonField<String> = body._opExName()
     ...
     */
    fun _acoComments(): JsonField<String> = body._acoComments()
     ...
     */
    fun _acoSerialNum(): JsonField<String> = body._acoSerialNum()
    ...
    fun _airspaceControlMeansStatus(): JsonField<List<AirspaceControlMeansStatus>> =
        body._airspaceControlMeansStatus()
    ...
    fun _airspaceControlOrderReferences(): JsonField<List<AirspaceControlOrderReference>> =
        body._airspaceControlOrderReferences()
     ...
     */
    fun _areaOfValidity(): JsonField<String> = body._areaOfValidity()
     ...
     */
    fun _classReasons(): JsonField<List<String>> = body._classReasons()
     ...
     */
    fun _classSource(): JsonField<String> = body._classSource()
     ...
     * type.
     */
    fun _declassExemptionCodes(): JsonField<List<String>> = body._declassExemptionCodes()
     ...
     * type.
     */
    fun _downgradeInsDates(): JsonField<List<String>> = body._downgradeInsDates()
     ...
     */
    fun _geoDatum(): JsonField<String> = body._geoDatum()
     ...
     */
    fun _month(): JsonField<String> = body._month()
     ...
     */
    fun _opExInfo(): JsonField<String> = body._opExInfo()
     ...
     */
    fun _opExInfoAlt(): JsonField<String> = body._opExInfoAlt()
     ...
     */
    fun _planOrigNum(): JsonField<String> = body._planOrigNum()
     ...
     */
    fun _qualifier(): JsonField<String> = body._qualifier()
     ...
     */
    fun _qualSn(): JsonField<Int> = body._qualSn()
     ...
     */
    fun _serialNum(): JsonField<String> = body._serialNum()
     ...
     */
    fun _stopQualifier(): JsonField<String> = body._stopQualifier()
     ...
     */
    fun _stopTime(): JsonField<OffsetDateTime> = body._stopTime()
     ...
     */
    fun _undLnkTrks(): JsonField<List<String>> = body._undLnkTrks()
    ...
    /** A builder for [AirspaceControlOrderCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airspaceControlOrderCreateParams: AirspaceControlOrderCreateParams) =
            apply {
                body = airspaceControlOrderCreateParams.body.toBuilder()
                additionalHeaders = airspaceControlOrderCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    airspaceControlOrderCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         */
        fun opExName(opExName: String) = apply { body.opExName(opExName) }
         ...
         */
        fun opExName(opExName: JsonField<String>) = apply { body.opExName(opExName) }
        ...
        /** Free text information expressed in natural language. */
        fun acoComments(acoComments: String) = apply { body.acoComments(acoComments) }
         ...
         * value.
         */
        fun acoComments(acoComments: JsonField<String>) = apply { body.acoComments(acoComments) }

        /** The serial number of this airspace control order. */
        fun acoSerialNum(acoSerialNum: String) = apply { body.acoSerialNum(acoSerialNum) }
        ...
        fun acoSerialNum(acoSerialNum: JsonField<String>) = apply {
            body.acoSerialNum(acoSerialNum)
        }
        ...
        ) = apply { body.airspaceControlMeansStatus(airspaceControlMeansStatus) }
        ...
        fun addAirspaceControlMeansStatus(airspaceControlMeansStatus: AirspaceControlMeansStatus) =
            apply {
                body.addAirspaceControlMeansStatus(airspaceControlMeansStatus)
            }
        ...
        ) = apply { body.airspaceControlOrderReferences(airspaceControlOrderReferences) }
        ...
        ) = apply { body.addAirspaceControlOrderReference(airspaceControlOrderReference) }

        /** Name of the area of the command for which the ACO is valid. */
        fun areaOfValidity(areaOfValidity: String) = apply { body.areaOfValidity(areaOfValidity) }
        ...
        fun areaOfValidity(areaOfValidity: JsonField<String>) = apply {
            body.areaOfValidity(areaOfValidity)
        }
         ...
         * code.
         */
        fun classReasons(classReasons: List<String>) = apply { body.classReasons(classReasons) }
        ...
        fun classReasons(classReasons: JsonField<List<String>>) = apply {
            body.classReasons(classReasons)
        }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addClassReason(classReason: String) = apply { body.addClassReason(classReason) }

        /**
         * Markings defining the source material or the original classification authority for the
         * ACO message.
         */
        fun classSource(classSource: String) = apply { body.classSource(classSource) }
         ...
         * value.
         */
        fun classSource(classSource: JsonField<String>) = apply { body.classSource(classSource) }
         ...
         * declassification of the airspace control order.
         */
        fun declassExemptionCodes(declassExemptionCodes: List<String>) = apply {
            body.declassExemptionCodes(declassExemptionCodes)
        }
        ...
        fun addDeclassExemptionCode(declassExemptionCode: String) = apply {
            body.addDeclassExemptionCode(declassExemptionCode)
        }
         ...
         * airspace control order.
         */
        fun downgradeInsDates(downgradeInsDates: List<String>) = apply {
            body.downgradeInsDates(downgradeInsDates)
        }
        ...
        fun addDowngradeInsDate(downgradeInsDate: String) = apply {
            body.addDowngradeInsDate(downgradeInsDate)
        }
         ...
         * are calculated.
         */
        fun geoDatum(geoDatum: String) = apply { body.geoDatum(geoDatum) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun geoDatum(geoDatum: JsonField<String>) = apply { body.geoDatum(geoDatum) }

        /** The month in which the message originated. */
        fun month(month: String) = apply { body.month(month) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun month(month: JsonField<String>) = apply { body.month(month) }
         ...
         */
        fun opExInfo(opExInfo: String) = apply { body.opExInfo(opExInfo) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun opExInfo(opExInfo: JsonField<String>) = apply { body.opExInfo(opExInfo) }

        /**
         * The secondary supplementary nickname of the option or the alternative of the operational
         * plan or order.
         */
        fun opExInfoAlt(opExInfoAlt: String) = apply { body.opExInfoAlt(opExInfoAlt) }
         ...
         * value.
         */
        fun opExInfoAlt(opExInfoAlt: JsonField<String>) = apply { body.opExInfoAlt(opExInfoAlt) }
         ...
         */
        fun planOrigNum(planOrigNum: String) = apply { body.planOrigNum(planOrigNum) }
         ...
         * value.
         */
        fun planOrigNum(planOrigNum: JsonField<String>) = apply { body.planOrigNum(planOrigNum) }

        /** The qualifier which caveats the message status. */
        fun qualifier(qualifier: String) = apply { body.qualifier(qualifier) }
         ...
         * value.
         */
        fun qualifier(qualifier: JsonField<String>) = apply { body.qualifier(qualifier) }

        /** The serial number associated with the message qualifier. */
        fun qualSn(qualSn: Int) = apply { body.qualSn(qualSn) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun qualSn(qualSn: JsonField<Int>) = apply { body.qualSn(qualSn) }
        ...
        /** The unique message identifier sequentially assigned by the originator. */
        fun serialNum(serialNum: String) = apply { body.serialNum(serialNum) }
         ...
         * value.
         */
        fun serialNum(serialNum: JsonField<String>) = apply { body.serialNum(serialNum) }
         ...
         */
        fun stopQualifier(stopQualifier: String) = apply { body.stopQualifier(stopQualifier) }
        ...
        fun stopQualifier(stopQualifier: JsonField<String>) = apply {
            body.stopQualifier(stopQualifier)
        }
         ...
         * format with millisecond precision.
         */
        fun stopTime(stopTime: OffsetDateTime) = apply { body.stopTime(stopTime) }
         ...
         * supported value.
         */
        fun stopTime(stopTime: JsonField<OffsetDateTime>) = apply { body.stopTime(stopTime) }

        /**
         * Array of unique link 16 identifiers that will be assigned to a future airspace control
         * means.
         */
        fun undLnkTrks(undLnkTrks: List<String>) = apply { body.undLnkTrks(undLnkTrks) }
         ...
         * supported value.
         */
        fun undLnkTrks(undLnkTrks: JsonField<List<String>>) = apply { body.undLnkTrks(undLnkTrks) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addUndLnkTrk(undLnkTrk: String) = apply { body.addUndLnkTrk(undLnkTrk) }
        ...
        /**
         * Returns an immutable instance of [AirspaceControlOrderCreateParams].
         *
         ...
         */
        fun build(): AirspaceControlOrderCreateParams =
            AirspaceControlOrderCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AirspaceControlOrderCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AirspaceControlOrderCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
