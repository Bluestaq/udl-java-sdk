...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileRetrieveParams: FileRetrieveParams) = apply {
            id = fileRetrieveParams.id
            firstResult = fileRetrieveParams.firstResult
            maxResults = fileRetrieveParams.maxResults
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FileRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "FileRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
