...
class ElsetTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ElsetTupleParams].
         *
    ...
    /** A builder for [ElsetTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elsetTupleParams: ElsetTupleParams) =
            apply {
                columns = elsetTupleParams.columns
                epoch = elsetTupleParams.epoch
                firstResult = elsetTupleParams.firstResult
                maxResults = elsetTupleParams.maxResults
                additionalHeaders = elsetTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = elsetTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ElsetTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ElsetTupleParams && columns == other.columns && epoch == other.epoch && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ElsetTupleParams{columns=$columns, epoch=$epoch, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
