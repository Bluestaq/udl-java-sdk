...
class RfEmitterTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfEmitterTupleParams].
         *
    ...
    /** A builder for [RfEmitterTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterTupleParams: RfEmitterTupleParams) =
            apply {
                columns = rfEmitterTupleParams.columns
                firstResult = rfEmitterTupleParams.firstResult
                maxResults = rfEmitterTupleParams.maxResults
                additionalHeaders = rfEmitterTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfEmitterTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfEmitterTupleParams].
         *
         ...
         */
        fun build(): RfEmitterTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfEmitterTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfEmitterTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
