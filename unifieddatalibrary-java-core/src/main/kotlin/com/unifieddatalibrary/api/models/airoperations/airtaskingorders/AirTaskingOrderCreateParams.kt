...
class AirTaskingOrderCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderCreateParams: AirTaskingOrderCreateParams) =
            apply {
        ...
        /** The effective begin time for this ATO in ISO 8601 UTC format with millisecond precision. */
        fun beginTs(beginTs: OffsetDateTime) =
            apply {
                body.beginTs(beginTs)
            }
        ...
        /** Specifies the unique operation or exercise name, nickname, or codeword assigned to a joint exercise or operation plan. */
        fun opExerName(opExerName: String) =
            apply {
                body.opExerName(opExerName)
            }
        ...
        /** The indicator specifying an affirmative or a negatice condition for this message. */
        fun ackReqInd(ackReqInd: String) =
            apply {
                body.ackReqInd(ackReqInd)
            }
        ...
        /** The effective end time for this ATO in ISO 8601 UTC format with millisecond precision. */
        fun endTs(endTs: OffsetDateTime) =
            apply {
                body.endTs(endTs)
            }
        ...
        /** A collection that details special instructions, important information, guidance, and amplifying information regarding this ATO. */
        fun genText(genText: List<GenText>) =
            apply {
                body.genText(genText)
            }
        ...
        fun addGenText(genText: GenText) =
            apply {
                body.addGenText(genText)
            }

        /** The month in which the message originated. */
        fun msgMonth(msgMonth: String) =
            apply {
                body.msgMonth(msgMonth)
            }
        ...
        /** The identifier of the originator of the message. */
        fun msgOriginator(msgOriginator: String) =
            apply {
        ...
        /** The qualifier which caveats the message status. */
        fun msgQualifier(msgQualifier: String) =
            apply {
        ...
        /** A collection that specifies the naval flight operations for this ATO. */
        fun navalFltOps(navalFltOps: List<NavalFltOp>) =
            apply {
    ...
    override fun toString() = "AirTaskingOrderCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
