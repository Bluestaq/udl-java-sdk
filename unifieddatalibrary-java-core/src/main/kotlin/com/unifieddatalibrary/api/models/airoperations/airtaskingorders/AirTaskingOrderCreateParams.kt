 ...
 * team for assistance.
 */
class AirTaskingOrderCreateParams
private constructor(
     ...
     */
    fun beginTs(): OffsetDateTime = body.beginTs()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun opExerName(): String = body.opExerName()
     ...
     *   if the server responded with an unexpected value).
     */
    fun ackReqInd(): Optional<String> = body.ackReqInd()
     ...
     *   if the server responded with an unexpected value).
     */
    fun ackUnitInstructions(): Optional<String> = body.ackUnitInstructions()
     ...
     *   if the server responded with an unexpected value).
     */
    fun acMsnTasking(): Optional<List<AcMsnTasking>> = body.acMsnTasking()
     ...
     *   if the server responded with an unexpected value).
     */
    fun endTs(): Optional<OffsetDateTime> = body.endTs()
     ...
     *   if the server responded with an unexpected value).
     */
    fun genText(): Optional<List<GenText>> = body.genText()
     ...
     *   if the server responded with an unexpected value).
     */
    fun msgMonth(): Optional<String> = body.msgMonth()
     ...
     *   if the server responded with an unexpected value).
     */
    fun msgOriginator(): Optional<String> = body.msgOriginator()
     ...
     *   if the server responded with an unexpected value).
     */
    fun msgQualifier(): Optional<String> = body.msgQualifier()
     ...
     *   if the server responded with an unexpected value).
     */
    fun msgSn(): Optional<String> = body.msgSn()
     ...
     *   if the server responded with an unexpected value).
     */
    fun navalFltOps(): Optional<List<NavalFltOp>> = body.navalFltOps()
     ...
     */
    fun _beginTs(): JsonField<OffsetDateTime> = body._beginTs()
     ...
     */
    fun _opExerName(): JsonField<String> = body._opExerName()
     ...
     */
    fun _ackReqInd(): JsonField<String> = body._ackReqInd()
     ...
     * type.
     */
    fun _ackUnitInstructions(): JsonField<String> = body._ackUnitInstructions()
     ...
     */
    fun _acMsnTasking(): JsonField<List<AcMsnTasking>> = body._acMsnTasking()
     ...
     */
    fun _endTs(): JsonField<OffsetDateTime> = body._endTs()
     ...
     */
    fun _genText(): JsonField<List<GenText>> = body._genText()
     ...
     */
    fun _msgMonth(): JsonField<String> = body._msgMonth()
     ...
     */
    fun _msgOriginator(): JsonField<String> = body._msgOriginator()
     ...
     */
    fun _msgQualifier(): JsonField<String> = body._msgQualifier()
     ...
     */
    fun _msgSn(): JsonField<String> = body._msgSn()
     ...
     */
    fun _navalFltOps(): JsonField<List<NavalFltOp>> = body._navalFltOps()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirTaskingOrderCreateParams].
         *
    ...
    /** A builder for [AirTaskingOrderCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airTaskingOrderCreateParams: AirTaskingOrderCreateParams) = apply {
            body = airTaskingOrderCreateParams.body.toBuilder()
            additionalHeaders = airTaskingOrderCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = airTaskingOrderCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * The effective begin time for this ATO in ISO 8601 UTC format with millisecond precision.
         */
        fun beginTs(beginTs: OffsetDateTime) = apply { body.beginTs(beginTs) }
         ...
         * supported value.
         */
        fun beginTs(beginTs: JsonField<OffsetDateTime>) = apply { body.beginTs(beginTs) }
         ...
         */
        fun opExerName(opExerName: String) = apply { body.opExerName(opExerName) }
         ...
         * value.
         */
        fun opExerName(opExerName: JsonField<String>) = apply { body.opExerName(opExerName) }
        ...
        /** The indicator specifying an affirmative or a negatice condition for this message. */
        fun ackReqInd(ackReqInd: String) = apply { body.ackReqInd(ackReqInd) }
         ...
         * value.
         */
        fun ackReqInd(ackReqInd: JsonField<String>) = apply { body.ackReqInd(ackReqInd) }

        /**
         * Specifies textual data amplifying the data contained in the acknowledgement requirement
         * indicator (ackRedInd) field or the unit required to acknowledge.
         */
        fun ackUnitInstructions(ackUnitInstructions: String) = apply {
            body.ackUnitInstructions(ackUnitInstructions)
        }
         ...
         * tasking for this ATO.
         */
        fun acMsnTasking(acMsnTasking: List<AcMsnTasking>) = apply {
            body.acMsnTasking(acMsnTasking)
        }
        ...
        fun addAcMsnTasking(acMsnTasking: AcMsnTasking) = apply {
            body.addAcMsnTasking(acMsnTasking)
        }
         ...
         * The effective end time for this ATO in ISO 8601 UTC format with millisecond precision.
         */
        fun endTs(endTs: OffsetDateTime) = apply { body.endTs(endTs) }
         ...
         * value.
         */
        fun endTs(endTs: JsonField<OffsetDateTime>) = apply { body.endTs(endTs) }

        /**
         * A collection that details special instructions, important information, guidance, and
         * amplifying information regarding this ATO.
         */
        fun genText(genText: List<GenText>) = apply { body.genText(genText) }
         ...
         * supported value.
         */
        fun genText(genText: JsonField<List<GenText>>) = apply { body.genText(genText) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addGenText(genText: GenText) = apply { body.addGenText(genText) }

        /** The month in which the message originated. */
        fun msgMonth(msgMonth: String) = apply { body.msgMonth(msgMonth) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun msgMonth(msgMonth: JsonField<String>) = apply { body.msgMonth(msgMonth) }

        /** The identifier of the originator of the message. */
        fun msgOriginator(msgOriginator: String) = apply { body.msgOriginator(msgOriginator) }
        ...
        fun msgOriginator(msgOriginator: JsonField<String>) = apply {
            body.msgOriginator(msgOriginator)
        }

        /** The qualifier which caveats the message status. */
        fun msgQualifier(msgQualifier: String) = apply { body.msgQualifier(msgQualifier) }
        ...
        fun msgQualifier(msgQualifier: JsonField<String>) = apply {
            body.msgQualifier(msgQualifier)
        }

        /** The unique message identifier sequentially assigned by the originator. */
        fun msgSn(msgSn: String) = apply { body.msgSn(msgSn) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun msgSn(msgSn: JsonField<String>) = apply { body.msgSn(msgSn) }

        /** A collection that specifies the naval flight operations for this ATO. */
        fun navalFltOps(navalFltOps: List<NavalFltOp>) = apply { body.navalFltOps(navalFltOps) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addNavalFltOp(navalFltOp: NavalFltOp) = apply { body.addNavalFltOp(navalFltOp) }
        ...
        /**
         * Returns an immutable instance of [AirTaskingOrderCreateParams].
         *
         ...
         */
        fun build(): AirTaskingOrderCreateParams =
