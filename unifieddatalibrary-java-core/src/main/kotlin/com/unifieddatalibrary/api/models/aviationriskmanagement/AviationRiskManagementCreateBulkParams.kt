 ...
 * Management records as a POST body and ingest into the database. This operation is not intended to
 * be used for automated feeds into UDL. Data providers should contact the UDL team for specific
 * role assignments and for instructions on setting up a permanent feed through an alternate
 * mechanism.
 */
class AviationRiskManagementCreateBulkParams
private constructor(
    ...
    /** A builder for [AviationRiskManagementCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            aviationRiskManagementCreateBulkParams: AviationRiskManagementCreateBulkParams
        ) = apply {
            body = aviationRiskManagementCreateBulkParams.body.toMutableList()
            additionalHeaders = aviationRiskManagementCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                aviationRiskManagementCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AviationRiskManagementCreateBulkParams].
         *
         ...
         */
        fun build(): AviationRiskManagementCreateBulkParams =
            AviationRiskManagementCreateBulkParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AviationRiskManagementCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AviationRiskManagementCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
