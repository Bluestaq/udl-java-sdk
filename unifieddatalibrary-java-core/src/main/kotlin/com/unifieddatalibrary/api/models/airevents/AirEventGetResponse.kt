...
class AirEventGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirEventGetResponse].
         *
    ...
    /** A builder for [AirEventGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventGetResponse: AirEventGetResponse) =
            apply {
                classificationMarking = airEventGetResponse.classificationMarking
                dataMode = airEventGetResponse.dataMode
                source = airEventGetResponse.source
                type = airEventGetResponse.type
                id = airEventGetResponse.id
                actualArrTime = airEventGetResponse.actualArrTime
                actualDepTime = airEventGetResponse.actualDepTime
                arct = airEventGetResponse.arct
                arEventType = airEventGetResponse.arEventType
                arrPurpose = airEventGetResponse.arrPurpose
                arTrackId = airEventGetResponse.arTrackId
                arTrackName = airEventGetResponse.arTrackName
                baseAlt = airEventGetResponse.baseAlt
                cancelled = airEventGetResponse.cancelled
                createdAt = airEventGetResponse.createdAt
                createdBy = airEventGetResponse.createdBy
                depPurpose = airEventGetResponse.depPurpose
                estArrTime = airEventGetResponse.estArrTime
                estDepTime = airEventGetResponse.estDepTime
                externalAirEventId = airEventGetResponse.externalAirEventId
                externalArTrackId = airEventGetResponse.externalArTrackId
                idMission = airEventGetResponse.idMission
                idSortie = airEventGetResponse.idSortie
                legNum = airEventGetResponse.legNum
                location = airEventGetResponse.location
                numTankers = airEventGetResponse.numTankers
                origin = airEventGetResponse.origin
                origNetwork = airEventGetResponse.origNetwork
                plannedArrTime = airEventGetResponse.plannedArrTime
                plannedDepTime = airEventGetResponse.plannedDepTime
                priority = airEventGetResponse.priority
                receivers = airEventGetResponse.receivers.map { it.toMutableList() }
                remarks = airEventGetResponse.remarks.map { it.toMutableList() }
                revTrack = airEventGetResponse.revTrack
                rzct = airEventGetResponse.rzct
                rzPoint = airEventGetResponse.rzPoint
                rzType = airEventGetResponse.rzType
                shortTrack = airEventGetResponse.shortTrack
                sourceDl = airEventGetResponse.sourceDl
                statusCode = airEventGetResponse.statusCode
                tankers = airEventGetResponse.tankers.map { it.toMutableList() }
                trackTime = airEventGetResponse.trackTime
                updatedAt = airEventGetResponse.updatedAt
                updatedBy = airEventGetResponse.updatedBy
                additionalProperties = airEventGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirEventGetResponse].
         *
    ...
    fun validate(): AirEventGetResponse =
        apply {
            if (validated) {
              return@apply
            }
