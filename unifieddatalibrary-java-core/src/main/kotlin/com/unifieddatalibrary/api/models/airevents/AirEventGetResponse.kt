...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventGetResponse: AirEventGetResponse) = apply {
    ...
    fun validate(): AirEventGetResponse = apply {
        if (validated) {
            return@apply
        }
