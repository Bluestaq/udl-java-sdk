...
/**
 * Information related to the planning, load, status, and deployment or dispatch of one aircraft to
 * carry out a mission.
 */
...
private constructor(
    ...
    private val crew: JsonField<CrewFull>,
    ...
    private val sortiePpr: JsonField<List<SortiePprFull>>,
    ...
    private constructor(
        ...
        @JsonProperty("crew") @ExcludeMissing crew: JsonField<CrewFull> = JsonMissing.of(),
        ...
        @JsonProperty("sortiePPR")
        @ExcludeMissing
        sortiePpr: JsonField<List<SortiePprFull>> = JsonMissing.of(),
    ...
    /**
     * The actual time the Aircraft comes to a complete stop in its parking position, in ISO 8601
    ...
    /**
     * The actual time the Aircraft begins to taxi from its parking position, in ISO 8601 UTC format
    ...
    /**
     * Description of the cargo configuration (e.g. C-1, C-2, C-3, DV-1, DV-2, AE-1, etc.) currently
     * on board the aircraft. Configuration meanings are determined by the data source.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
     ...
     *   if the server responded with an unexpected value).
     */
    fun crew(): Optional<CrewFull> = crew.getOptional("crew")
    ...
    /**
     * Due home date by which the aircraft must return to its home station, in ISO 8601 UTC format
     * with millisecond precision.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * The estimated time the Aircraft will come to a complete stop in its parking position, in ISO
    ...
    /**
     * The estimated time the Aircraft will begin to taxi from its parking position, in ISO 8601 UTC
    ...
    /**
     * Desk phone number of the flight manager assigned to the sortie. Null when no flight manager
     * is assigned.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Time the associated mission data was last updated in relation to the aircraft assignment, in
     * ISO 8601 UTC format with millisecond precision. If this time is coming from an external
     * system, it may not sync with the latest mission time associated to this record.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The scheduled time that the Aircraft sortie is planned to arrive, in ISO 8601 UTC format with
     * millisecond precision.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * When crew papers are associated to this sortie, the system updates this value. This field is
     * the URI location in the document repository of that raw file. To download the raw file,
     * prepend https://udl-hostname/scs/download?id= to this field's value.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Type of Ravens required for this sortie (N - None, R - Raven (Security Team) required, C6 -
     * Consider ravens (Ground time over 6 hours), R6 - Ravens required (Ground time over 6 hours)).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Indicates the group responsible for recording the completion time of the next event in the
     * sequence of events assigned to this sortie (e.g. OPS - Operations, MX - Maintenance, TR -
     * Transportation, etc.).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     *   if the server responded with an unexpected value).
     */
    fun sortiePpr(): Optional<List<SortiePprFull>> = sortiePpr.getOptional("sortiePPR")
     ...
     *
     * Unlike [actualBlockOutTime], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("actualBlockOutTime")
    @ExcludeMissing
     ...
     */
    @JsonProperty("alertStatus") @ExcludeMissing fun _alertStatus(): JsonField<Int> = alertStatus
     ...
     */
    @JsonProperty("amcMsnType") @ExcludeMissing fun _amcMsnType(): JsonField<String> = amcMsnType
     ...
     */
    @JsonProperty("arrItinerary") @ExcludeMissing fun _arrItinerary(): JsonField<Int> = arrItinerary
    ...
    /**
     * Returns the raw JSON value of [crew].
     *
     * Unlike [crew], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("crew") @ExcludeMissing fun _crew(): JsonField<CrewFull> = crew
     ...
     */
    @JsonProperty("depItinerary") @ExcludeMissing fun _depItinerary(): JsonField<Int> = depItinerary
     ...
     */
    @JsonProperty("flightTime") @ExcludeMissing fun _flightTime(): JsonField<Double> = flightTime
     ...
     */
    @JsonProperty("oxyReqCrew") @ExcludeMissing fun _oxyReqCrew(): JsonField<Double> = oxyReqCrew
     ...
     */
    @JsonProperty("parkingLoc") @ExcludeMissing fun _parkingLoc(): JsonField<String> = parkingLoc
     ...
     */
    @JsonProperty("pprStatus") @ExcludeMissing fun _pprStatus(): JsonField<PprStatus> = pprStatus
     ...
     */
    @JsonProperty("primarySCL") @ExcludeMissing fun _primaryScl(): JsonField<String> = primaryScl
     ...
     */
    @JsonProperty("sortieDate") @ExcludeMissing fun _sortieDate(): JsonField<LocalDate> = sortieDate

    /**
     * Returns the raw JSON value of [sortiePpr].
     *
     * Unlike [sortiePpr], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("sortiePPR")
    @ExcludeMissing
    fun _sortiePpr(): JsonField<List<SortiePprFull>> = sortiePpr
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftsortieFull].
         *
    ...
    /** A builder for [AircraftsortieFull]. */
    class Builder internal constructor() {
        ...
        private var crew: JsonField<CrewFull> = JsonMissing.of()
        ...
        private var sortiePpr: JsonField<MutableList<SortiePprFull>>? = null
        ...
        @JvmSynthetic
        internal fun from(aircraftsortieFull: AircraftsortieFull) = apply {
            classificationMarking = aircraftsortieFull.classificationMarking
            dataMode = aircraftsortieFull.dataMode
            plannedDepTime = aircraftsortieFull.plannedDepTime
            source = aircraftsortieFull.source
            id = aircraftsortieFull.id
            actualArrTime = aircraftsortieFull.actualArrTime
            actualBlockInTime = aircraftsortieFull.actualBlockInTime
            actualBlockOutTime = aircraftsortieFull.actualBlockOutTime
            actualDepTime = aircraftsortieFull.actualDepTime
            aircraftAdsb = aircraftsortieFull.aircraftAdsb
            aircraftAltId = aircraftsortieFull.aircraftAltId
            aircraftEvent = aircraftsortieFull.aircraftEvent
            aircraftMds = aircraftsortieFull.aircraftMds
            aircraftRemarks = aircraftsortieFull.aircraftRemarks
            alertStatus = aircraftsortieFull.alertStatus
            alertStatusCode = aircraftsortieFull.alertStatusCode
            amcMsnNum = aircraftsortieFull.amcMsnNum
            amcMsnType = aircraftsortieFull.amcMsnType
            arrFaa = aircraftsortieFull.arrFaa
            arrIata = aircraftsortieFull.arrIata
            arrIcao = aircraftsortieFull.arrIcao
            arrItinerary = aircraftsortieFull.arrItinerary
            arrPurposeCode = aircraftsortieFull.arrPurposeCode
            callSign = aircraftsortieFull.callSign
            cargoConfig = aircraftsortieFull.cargoConfig
            commanderName = aircraftsortieFull.commanderName
            createdAt = aircraftsortieFull.createdAt
            createdBy = aircraftsortieFull.createdBy
            crew = aircraftsortieFull.crew
            currentState = aircraftsortieFull.currentState
            delayCode = aircraftsortieFull.delayCode
            depFaa = aircraftsortieFull.depFaa
            depIata = aircraftsortieFull.depIata
            depIcao = aircraftsortieFull.depIcao
            depItinerary = aircraftsortieFull.depItinerary
            depPurposeCode = aircraftsortieFull.depPurposeCode
            dhd = aircraftsortieFull.dhd
            dhdReason = aircraftsortieFull.dhdReason
            estArrTime = aircraftsortieFull.estArrTime
            estBlockInTime = aircraftsortieFull.estBlockInTime
            estBlockOutTime = aircraftsortieFull.estBlockOutTime
            estDepTime = aircraftsortieFull.estDepTime
            filename = aircraftsortieFull.filename
            filesize = aircraftsortieFull.filesize
            flightTime = aircraftsortieFull.flightTime
            fmDeskNum = aircraftsortieFull.fmDeskNum
            fmName = aircraftsortieFull.fmName
            fuelReq = aircraftsortieFull.fuelReq
            gndTime = aircraftsortieFull.gndTime
            idAircraft = aircraftsortieFull.idAircraft
            idMission = aircraftsortieFull.idMission
            jcsPriority = aircraftsortieFull.jcsPriority
            legNum = aircraftsortieFull.legNum
            lineNumber = aircraftsortieFull.lineNumber
            missionId = aircraftsortieFull.missionId
            missionUpdate = aircraftsortieFull.missionUpdate
            objectiveRemarks = aircraftsortieFull.objectiveRemarks
            origin = aircraftsortieFull.origin
            origNetwork = aircraftsortieFull.origNetwork
            origSortieId = aircraftsortieFull.origSortieId
            oxyOnCrew = aircraftsortieFull.oxyOnCrew
            oxyOnPax = aircraftsortieFull.oxyOnPax
            oxyReqCrew = aircraftsortieFull.oxyReqCrew
            oxyReqPax = aircraftsortieFull.oxyReqPax
            paperStatus = aircraftsortieFull.paperStatus
            papersVersion = aircraftsortieFull.papersVersion
            parkingLoc = aircraftsortieFull.parkingLoc
            passengers = aircraftsortieFull.passengers
            plannedArrTime = aircraftsortieFull.plannedArrTime
            pprStatus = aircraftsortieFull.pprStatus
            primaryScl = aircraftsortieFull.primaryScl
            rawFileUri = aircraftsortieFull.rawFileUri
            reqConfig = aircraftsortieFull.reqConfig
            resultRemarks = aircraftsortieFull.resultRemarks
            rvnReq = aircraftsortieFull.rvnReq
            scheduleRemarks = aircraftsortieFull.scheduleRemarks
            secondaryScl = aircraftsortieFull.secondaryScl
            soe = aircraftsortieFull.soe
            sortieDate = aircraftsortieFull.sortieDate
            sortiePpr = aircraftsortieFull.sortiePpr.map { it.toMutableList() }
            sourceDl = aircraftsortieFull.sourceDl
            tailNumber = aircraftsortieFull.tailNumber
            updatedAt = aircraftsortieFull.updatedAt
            updatedBy = aircraftsortieFull.updatedBy
            additionalProperties = aircraftsortieFull.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.actualBlockInTime] with a well-typed [OffsetDateTime]
         ...
         *
         * You should usually call [Builder.actualBlockOutTime] with a well-typed [OffsetDateTime]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
         ...
         *
         * You should usually call [Builder.aircraftAdsb] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.aircraftAltId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.aircraftEvent] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.alertStatus] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.amcMsnType] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.arrFaa] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.arrIata] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         * value.
         */
        fun arrItinerary(arrItinerary: JsonField<Int>) = apply { this.arrItinerary = arrItinerary }
        ...
        /** Crew Services. */
        fun crew(crew: CrewFull) = crew(JsonField.of(crew))

        /**
         * Sets [Builder.crew] to an arbitrary JSON value.
         *
         * You should usually call [Builder.crew] with a well-typed [CrewFull] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun crew(crew: JsonField<CrewFull>) = apply { this.crew = crew }
         ...
         *
         * You should usually call [Builder.depFaa] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.depIata] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         * value.
         */
        fun depItinerary(depItinerary: JsonField<Int>) = apply { this.depItinerary = depItinerary }
         ...
         *
         * You should usually call [Builder.dhd] with a well-typed [OffsetDateTime] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.estBlockInTime] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.filesize] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.flightTime] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.fmName] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.fuelReq] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.gndTime] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.missionUpdate] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.origSortieId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.oxyOnPax] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.oxyReqCrew] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.papersVersion] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.parkingLoc] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.passengers] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.pprStatus] with a well-typed [PprStatus] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.primaryScl] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.resultRemarks] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.rvnReq] with a well-typed [RvnReq] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.secondaryScl] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.sortieDate] with a well-typed [LocalDate] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun sortieDate(sortieDate: JsonField<LocalDate>) = apply { this.sortieDate = sortieDate }

        fun sortiePpr(sortiePpr: List<SortiePprFull>) = sortiePpr(JsonField.of(sortiePpr))

        /**
         * Sets [Builder.sortiePpr] to an arbitrary JSON value.
         *
         * You should usually call [Builder.sortiePpr] with a well-typed `List<SortiePprFull>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sortiePpr(sortiePpr: JsonField<List<SortiePprFull>>) = apply {
            this.sortiePpr = sortiePpr.map { it.toMutableList() }
        }

        /**
         * Adds a single [SortiePprFull] to [Builder.sortiePpr].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSortiePpr(sortiePpr: SortiePprFull) = apply {
            this.sortiePpr =
                (this.sortiePpr ?: JsonField.of(mutableListOf())).also {
                    checkKnown("sortiePpr", it).add(sortiePpr)
                }
        }
        ...
        /**
         * Returns an immutable instance of [AircraftsortieFull].
         *
        ...
        fun build(): AircraftsortieFull =
            AircraftsortieFull(
                ...
                soe,
                sortieDate,
                (sortiePpr ?: JsonMissing.of()).map { it.toImmutable() },
                sourceDl,
                tailNumber,
                updatedAt,
                updatedBy,
    ...
    fun validate(): AircraftsortieFull = apply {
        if (validated) {
            return@apply
        }
        ...
        soe()
        sortieDate()
        sortiePpr().ifPresent { it.forEach { it.validate() } }
        sourceDl()
        tailNumber()
        updatedAt()
        updatedBy()
    ...
    internal fun validity(): Int =
        (if (classificationMarking.asKnown().isPresent) 1 else 0) +
            ...
            (crew.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (sortiePpr.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    /** The prior permission required (PPR) status. */
    class PprStatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
