...
class SigactListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SigactListParams].
         *
    ...
    /** A builder for [SigactListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sigactListParams: SigactListParams) =
            apply {
                reportDate = sigactListParams.reportDate
                firstResult = sigactListParams.firstResult
                maxResults = sigactListParams.maxResults
                additionalHeaders = sigactListParams.additionalHeaders.toBuilder()
                additionalQueryParams = sigactListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SigactListParams].
         *
    ...
    override fun toString() = "SigactListParams{reportDate=$reportDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
