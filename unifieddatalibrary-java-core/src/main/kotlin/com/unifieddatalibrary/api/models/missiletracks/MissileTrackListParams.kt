...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissileTrackListParams].
         *
    ...
    /** A builder for [MissileTrackListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missileTrackListParams: MissileTrackListParams) = apply {
            ts = missileTrackListParams.ts
            firstResult = missileTrackListParams.firstResult
            maxResults = missileTrackListParams.maxResults
            additionalHeaders = missileTrackListParams.additionalHeaders.toBuilder()
            additionalQueryParams = missileTrackListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MissileTrackListParams].
         *
         ...
         */
        fun build(): MissileTrackListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MissileTrackListParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MissileTrackListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
