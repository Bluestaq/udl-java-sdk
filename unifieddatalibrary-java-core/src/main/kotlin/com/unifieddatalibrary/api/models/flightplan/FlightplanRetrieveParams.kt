...
class FlightplanRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): FlightplanRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FlightplanRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [FlightplanRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightplanRetrieveParams: FlightplanRetrieveParams) =
            apply {
                id = flightplanRetrieveParams.id
                firstResult = flightplanRetrieveParams.firstResult
                maxResults = flightplanRetrieveParams.maxResults
                additionalHeaders = flightplanRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = flightplanRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [FlightplanRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FlightplanRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is FlightplanRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "FlightplanRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
