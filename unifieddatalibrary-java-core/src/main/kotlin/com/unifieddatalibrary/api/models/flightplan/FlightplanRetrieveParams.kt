 ...
 */
class FlightplanRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FlightplanRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightplanRetrieveParams: FlightplanRetrieveParams) = apply {
    ...
    override fun toString() =
        "FlightplanRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
