...
class SeradataRadarPayloadTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataRadarPayloadTupleParams].
         *
    ...
    /** A builder for [SeradataRadarPayloadTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataRadarPayloadTupleParams: SeradataRadarPayloadTupleParams) =
            apply {
                columns = seradataRadarPayloadTupleParams.columns
                firstResult = seradataRadarPayloadTupleParams.firstResult
                maxResults = seradataRadarPayloadTupleParams.maxResults
                additionalHeaders = seradataRadarPayloadTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = seradataRadarPayloadTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataRadarPayloadTupleParams].
         *
         ...
         */
        fun build(): SeradataRadarPayloadTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataRadarPayloadTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SeradataRadarPayloadTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
