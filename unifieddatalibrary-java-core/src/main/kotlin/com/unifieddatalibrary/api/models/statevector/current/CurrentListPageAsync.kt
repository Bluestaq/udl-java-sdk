...
class CurrentListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<CurrentListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(currentListPageAsync: CurrentListPageAsync) =
            apply {
        ...
        fun service(service: CurrentServiceAsync) =
            apply {
    ...
    override fun toString() = "CurrentListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
