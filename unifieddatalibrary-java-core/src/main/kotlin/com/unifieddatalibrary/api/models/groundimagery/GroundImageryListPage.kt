...
class GroundImageryListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryListPage: GroundImageryListPage) =
            apply {
        ...
        fun service(service: GroundImageryService) =
            apply {
    ...
    override fun toString() = "GroundImageryListPage{service=$service, params=$params, items=$items}"
}
