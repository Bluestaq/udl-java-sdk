...
class H3GeoHexCellListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [H3GeoHexCellListParams].
         *
    ...
    /** A builder for [H3GeoHexCellListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoHexCellListParams: H3GeoHexCellListParams) =
            apply {
                idH3Geo = h3GeoHexCellListParams.idH3Geo
                firstResult = h3GeoHexCellListParams.firstResult
                maxResults = h3GeoHexCellListParams.maxResults
                additionalHeaders = h3GeoHexCellListParams.additionalHeaders.toBuilder()
                additionalQueryParams = h3GeoHexCellListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [H3GeoHexCellListParams].
         *
         ...
         */
        fun build(): H3GeoHexCellListParams =
    ...
    override fun toString() = "H3GeoHexCellListParams{idH3Geo=$idH3Geo, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
