...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sigactCountParams: SigactCountParams) = apply {
        ...
        /** Date of the report or filing. (YYYY-MM-DDTHH:MM:SS.sssZ) */
        fun reportDate(reportDate: OffsetDateTime) = apply { this.reportDate = reportDate }
    ...
    override fun toString() =
        "SigactCountParams{reportDate=$reportDate, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
