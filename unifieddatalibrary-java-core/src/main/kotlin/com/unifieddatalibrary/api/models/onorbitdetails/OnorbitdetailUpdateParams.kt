...
class OnorbitdetailUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnorbitdetailUpdateParams].
         *
    ...
    /** A builder for [OnorbitdetailUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitdetailUpdateParams: OnorbitdetailUpdateParams) =
            apply {
                pathId = onorbitdetailUpdateParams.pathId
                body = onorbitdetailUpdateParams.body.toBuilder()
                additionalHeaders = onorbitdetailUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitdetailUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** The radius used for long-term debris environment projection analyses that is not as conservative as COLA Radius, in meters. */
        fun adeptRadius(adeptRadius: Double) =
            apply {
                body.adeptRadius(adeptRadius)
            }
        ...
        /** The total beginning of life delta V of the spacecraft, in meters per second. */
        fun bolDeltaV(bolDeltaV: Double) =
            apply {
                body.bolDeltaV(bolDeltaV)
            }
        ...
        /** Spacecraft beginning of life fuel mass, in orbit, in kilograms. */
        fun bolFuelMass(bolFuelMass: Double) =
            apply {
                body.bolFuelMass(bolFuelMass)
            }
        ...
        /** Type of the bus on the spacecraft. */
        fun busType(busType: String) =
            apply {
                body.busType(busType)
            }
        ...
        /** Maximum dimension of the box circumscribing the spacecraft (d = sqrt(a*a + b*b + c\*c) where a is the tip-to-tip dimension, b and c are perpendicular to that.) in meters. */
        fun colaRadius(colaRadius: Double) =
            apply {
                body.colaRadius(colaRadius)
            }
        ...
        /** Average cross sectional area in meters squared. */
        fun crossSection(crossSection: Double) =
            apply {
        ...
        /** The estimated total current mass of the spacecraft, in kilograms. */
        fun currentMass(currentMass: Double) =
            apply {
                body.currentMass(currentMass)
            }
        ...
        /** The 1-sigma uncertainty of the total spacecraft delta V, in meters per second. */
        fun deltaVUnc(deltaVUnc: Double) =
            apply {
                body.deltaVUnc(deltaVUnc)
            }
        ...
        /** Array of the estimated mass of each deployable object, in kilograms. Must contain the same number of elements as the value of numDeployable. */
        fun depEstMasses(depEstMasses: List<Double>) =
            apply {
        ...
        fun addDepEstMass(depEstMass: Double) =
            apply {
                body.addDepEstMass(depEstMass)
            }

        /** Array of the 1-sigma uncertainty of the mass for each deployable object, in kilograms. Must contain the same number of elements as the value of numDeployable. */
        fun depMassUncs(depMassUncs: List<Double>) =
            apply {
        ...
        fun addDepMassUnc(depMassUnc: Double) =
            apply {
                body.addDepMassUnc(depMassUnc)
            }

        /** Array of satellite deployable objects. Must contain the same number of elements as the value of numDeployable. */
        fun depNames(depNames: List<String>) =
            apply {
                body.depNames(depNames)
            }
        ...
        fun addDepName(depName: String) =
            apply {
                body.addDepName(depName)
            }

        /** GEO drift rate, if applicable in degrees per day. */
        fun driftRate(driftRate: Double) =
            apply {
                body.driftRate(driftRate)
            }
        ...
        /** Spacecraft dry mass (without fuel or disposables) in kilograms. */
        fun dryMass(dryMass: Double) =
            apply {
                body.dryMass(dryMass)
            }
        ...
        /** Estimated remaining fuel for the object in kilograms. */
        fun fuelRemaining(fuelRemaining: Double) =
            apply {
        ...
        /** GEO slot if applicable, in degrees. -180 (West of Prime Meridian) to 180 degrees (East of Prime Meridian). Prime Meridian is 0. */
        fun geoSlot(geoSlot: Double) =
            apply {
                body.geoSlot(geoSlot)
            }
        ...
        /** The name of the source who last provided an observation for this idOnOrbit. */
        fun lastObSource(lastObSource: String) =
            apply {
        ...
        /** Time of last reported observation for this object in ISO 8601 UTC with microsecond precision. */
        fun lastObTime(lastObTime: OffsetDateTime) =
            apply {
        ...
        /** Nominal mass of spacecraft and fuel at launch time, in kilograms. */
        fun launchMass(launchMass: Double) =
            apply {
                body.launchMass(launchMass)
            }
        ...
        /** Maximum (estimated) mass of spacecraft and fuel at launch time, in kilograms. */
        fun launchMassMax(launchMassMax: Double) =
            apply {
        ...
        /** Minimum (estimated) mass of spacecraft and fuel at launch time, in kilograms. */
        fun launchMassMin(launchMassMin: Double) =
            apply {
        ...
        /** Boolean indicating whether a spacecraft is maneuverable. Note that a spacecraft may have propulsion capability but may not be maneuverable due to lack of fuel, anomalous condition, or other operational constraints. */
        fun maneuverable(maneuverable: Boolean) =
            apply {
        ...
        /** Maximum delta V available for this on-orbit spacecraft, in meters per second. */
        fun maxDeltaV(maxDeltaV: Double) =
            apply {
                body.maxDeltaV(maxDeltaV)
            }
        ...
        /** Maximum dimension across the spacecraft (e.g., tip-to-tip across the solar panel arrays) in meters. */
        fun maxRadius(maxRadius: Double) =
            apply {
                body.maxRadius(maxRadius)
            }
        ...
        /** Array of the type of missions the spacecraft performs. Must contain the same number of elements as the value of numMission. */
        fun missionTypes(missionTypes: List<String>) =
            apply {
        ...
        fun addMissionType(missionType: String) =
            apply {
                body.addMissionType(missionType)
            }

        /** The number of sub-satellites or deployable objects on the spacecraft. */
        fun numDeployable(numDeployable: Int) =
            apply {
        ...
        /** The number of distinct missions the spacecraft performs. */
        fun numMission(numMission: Int) =
            apply {
                body.numMission(numMission)
            }
        ...
        /** Mean radar cross section in meters squared. */
        fun rcsMean(rcsMean: Double) =
            apply {
                body.rcsMean(rcsMean)
            }
        ...
        /** The reference source, sources, or URL from which the data in this record was obtained. */
        fun refSource(refSource: String) =
            apply {
                body.refSource(refSource)
            }
        ...
        /** The 1-sigma uncertainty of the total spacecraft mass, in kilograms. */
        fun totalMassUnc(totalMassUnc: Double) =
            apply {
        ...
        /** Maximum visual magnitude in M. */
        fun vismagMax(vismagMax: Double) =
            apply {
                body.vismagMax(vismagMax)
            }
        ...
        /** Mean visual magnitude in M. */
        fun vismagMean(vismagMean: Double) =
            apply {
                body.vismagMean(vismagMean)
            }
        ...
        /** Minimum visual magnitude in M. */
        fun vismagMin(vismagMin: Double) =
            apply {
                body.vismagMin(vismagMin)
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitdetailUpdateParams].
         *
         ...
         */
        fun build(): OnorbitdetailUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitdetailUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OnorbitdetailUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
