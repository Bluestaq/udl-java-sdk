...
/**
 * Service operation to take multiple item records as a POST body and ingest into the database. This
 * operation is intended to be used for automated feeds into UDL. A specific role is required to
 * perform this service operation. Please contact the UDL team for assistance.
 */
class ItemUnvalidatedPublishParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemUnvalidatedPublishParams].
         *
    ...
    /** A builder for [ItemUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemUnvalidatedPublishParams: ItemUnvalidatedPublishParams) = apply {
            body = itemUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = itemUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams = itemUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ItemUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): ItemUnvalidatedPublishParams =
    ...
    private constructor(
         ...
         *
         * Unlike [accSysValues], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("accSysValues")
        @ExcludeMissing
         ...
         *
         * Unlike [altDataFormat], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [commodityCode], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [commoditySys], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [idAirLoadPlan], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [itemContains], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("itemContains")
        @ExcludeMissing
         ...
         *
         * Unlike [numPalletPos], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [receivingBranch], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("receivingBranch")
        @ExcludeMissing
         ...
         *
         * Unlike [receivingUnit], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        ...
        class Builder internal constructor() {
            ...
            /**
             * The tracking identifier of an item or person. May be similar in representation of a
             * barcode or UPC. If no scanCode or tracking number equivalent is available, 'NONE'
             * should be used.
             */
             ...
             *
             * You should usually call [Builder.scanCode] with a well-typed [String] value instead.
            ...
            /**
             * Array of keys that may be associated to the accepting system data. The entries in
             * this array must correspond to the position index in accSysValues array. This array
             * must be the same length as accSysValues.
             */
             ...
             *
             * You should usually call [Builder.accSysNotes] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun accSysNotes(accSysNotes: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.airdrop] with a well-typed [Boolean] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Name of the additional data format so downstream consuming applications can know how
             * to parse it. Typically includes the source system name and the format name.
             */
             ...
             *
             * You should usually call [Builder.altDataFormat] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The type of cargo (e.g. PALLET, ROLLING STOCK, LOOSE, OTHER). Applicable for cargo
             * item types only.
             */
             ...
             *
             * You should usually call [Builder.commodityCode] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.commoditySys] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.container] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.dvCode] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.idAirLoadPlan] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Moment of the item in Newton-meters. Applicable for equipment and cargo item types
             * only.
             */
             ...
             *
             * You should usually call [Builder.moment] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * supported value.
             */
            fun numPalletPos(numPalletPos: JsonField<Int>) = apply {
             ...
             *
             * You should usually call [Builder.productSys] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.receivingUnit] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Array of values for the keys that may be associated to this tracked item. The entries
             * in this array must correspond to the position index in the keys array. This array
             ...
             *
             * You should usually call [Builder.volume] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
