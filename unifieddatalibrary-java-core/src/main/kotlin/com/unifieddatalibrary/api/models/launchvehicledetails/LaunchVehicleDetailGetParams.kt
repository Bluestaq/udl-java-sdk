...
class LaunchVehicleDetailGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): LaunchVehicleDetailGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleDetailGetParams: LaunchVehicleDetailGetParams) =
            apply {
    ...
    override fun toString() = "LaunchVehicleDetailGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
