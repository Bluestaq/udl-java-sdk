...
class WeatherDataGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): WeatherDataGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [WeatherDataGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [WeatherDataGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataGetParams: WeatherDataGetParams) =
            apply {
                id = weatherDataGetParams.id
                firstResult = weatherDataGetParams.firstResult
                maxResults = weatherDataGetParams.maxResults
                additionalHeaders = weatherDataGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = weatherDataGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [WeatherDataGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WeatherDataGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is WeatherDataGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "WeatherDataGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
