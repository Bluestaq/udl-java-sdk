...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): WeatherDataGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataGetParams: WeatherDataGetParams) = apply {
    ...
    override fun toString() =
        "WeatherDataGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
