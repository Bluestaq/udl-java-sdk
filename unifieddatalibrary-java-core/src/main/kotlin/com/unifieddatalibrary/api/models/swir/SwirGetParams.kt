...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SwirGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SwirGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SwirGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(swirGetParams: SwirGetParams) = apply {
            id = swirGetParams.id
            firstResult = swirGetParams.firstResult
            maxResults = swirGetParams.maxResults
            additionalHeaders = swirGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = swirGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SwirGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SwirGetParams =
            SwirGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SwirGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SwirGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
