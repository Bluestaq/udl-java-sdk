...
class SkyImageryQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SkyImageryQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SkyImageryQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryQueryhelpResponse: SkyImageryQueryhelpResponse) =
            apply {
                aodrSupported = skyImageryQueryhelpResponse.aodrSupported
                classificationMarking = skyImageryQueryhelpResponse.classificationMarking
                description = skyImageryQueryhelpResponse.description
                historySupported = skyImageryQueryhelpResponse.historySupported
                name = skyImageryQueryhelpResponse.name
                parameters = skyImageryQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = skyImageryQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = skyImageryQueryhelpResponse.restSupported
                sortSupported = skyImageryQueryhelpResponse.sortSupported
                typeName = skyImageryQueryhelpResponse.typeName
                uri = skyImageryQueryhelpResponse.uri
                additionalProperties = skyImageryQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SkyImageryQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SkyImageryQueryhelpResponse =
    ...
    fun validate(): SkyImageryQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
