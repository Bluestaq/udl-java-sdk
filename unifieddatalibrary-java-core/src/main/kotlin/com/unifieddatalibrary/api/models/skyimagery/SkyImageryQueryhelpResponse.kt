...
class SkyImageryQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skyImageryQueryhelpResponse: SkyImageryQueryhelpResponse) = apply {
    ...
    fun validate(): SkyImageryQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
