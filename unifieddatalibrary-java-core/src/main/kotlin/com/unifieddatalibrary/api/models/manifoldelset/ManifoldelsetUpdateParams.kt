...
class ManifoldelsetUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManifoldelsetUpdateParams].
         *
    ...
    /** A builder for [ManifoldelsetUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetUpdateParams: ManifoldelsetUpdateParams) =
            apply {
                pathId = manifoldelsetUpdateParams.pathId
                body = manifoldelsetUpdateParams.body.toBuilder()
                additionalHeaders = manifoldelsetUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = manifoldelsetUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Identifier of the parent Manifold record. */
        fun idManifold(idManifold: String) =
            apply {
                body.idManifold(idManifold)
            }
        ...
        /** A placeholder satellite number and not a true NORAD catalog number. */
        fun tmpSatNo(tmpSatNo: Int) =
            apply {
                body.tmpSatNo(tmpSatNo)
            }
        ...
        /** The argument of perigee is the angle in degrees formed between the perigee and the ascending node. If the perigee would occur at the ascending node, the argument of perigee would be 0. */
        fun argOfPerigee(argOfPerigee: Double) =
            apply {
        ...
        /** The orbital eccentricity of an astronomical object is a parameter that determines the amount by which its orbit around another body deviates from a perfect circle. A value of 0 is a circular orbit, values between 0 and 1 form an elliptic orbit, 1 is a parabolic escape orbit, and greater than 1 is a hyperbolic escape orbit. */
        fun eccentricity(eccentricity: Double) =
            apply {
        ...
        /** Where the satellite is in its orbital path. The mean anomaly ranges from 0 to 360 degrees. The mean anomaly is referenced to the perigee. If the satellite were at the perigee, the mean anomaly would be 0. */
        fun meanAnomaly(meanAnomaly: Double) =
            apply {
        ...
        /** The constant angular speed required for the body to complete one circular orbit in the same amount of time as the actual elliptical orbit with variable speed. Measured in revolutions per day. */
        fun meanMotion(meanMotion: Double) =
            apply {
                body.meanMotion(meanMotion)
            }
        ...
        /** The orbit point nearest to the center of the earth in kilometers. */
        fun perigee(perigee: Double) =
            apply {
                body.perigee(perigee)
            }
        ...
        /**
         * Returns an immutable instance of [ManifoldelsetUpdateParams].
         *
         ...
         */
        fun build(): ManifoldelsetUpdateParams =
    ...
    override fun toString() = "ManifoldelsetUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
