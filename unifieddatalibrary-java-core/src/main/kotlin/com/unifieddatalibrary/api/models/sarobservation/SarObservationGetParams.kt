...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SarObservationGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationGetParams: SarObservationGetParams) = apply {
    ...
    override fun toString() =
        "SarObservationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
