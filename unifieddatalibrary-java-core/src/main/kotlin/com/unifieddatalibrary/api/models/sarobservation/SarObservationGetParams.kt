...
class SarObservationGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SarObservationGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SarObservationGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SarObservationGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationGetParams: SarObservationGetParams) =
            apply {
                id = sarObservationGetParams.id
                firstResult = sarObservationGetParams.firstResult
                maxResults = sarObservationGetParams.maxResults
                additionalHeaders = sarObservationGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = sarObservationGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SarObservationGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SarObservationGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SarObservationGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SarObservationGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
