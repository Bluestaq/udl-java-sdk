...
/**
 * Service operation to update an SeradataRadarPayload. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class SeradataRadarPayloadUpdateParams
private constructor(
    ...
    fun constellationInterferometricCapability(): Optional<String> =
        body.constellationInterferometricCapability()
    ...
    fun _constellationInterferometricCapability(): JsonField<String> =
        body._constellationInterferometricCapability()
    ...
    /** A builder for [SeradataRadarPayloadUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataRadarPayloadUpdateParams: SeradataRadarPayloadUpdateParams) =
            apply {
                pathId = seradataRadarPayloadUpdateParams.pathId
                body = seradataRadarPayloadUpdateParams.body.toBuilder()
                additionalHeaders = seradataRadarPayloadUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    seradataRadarPayloadUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Best resolution in meters. */
        fun bestResolution(bestResolution: Double) = apply { body.bestResolution(bestResolution) }
        ...
        /** Duty cycle. */
        fun dutyCycle(dutyCycle: String) = apply { body.dutyCycle(dutyCycle) }
         ...
         * value.
         */
        fun dutyCycle(dutyCycle: JsonField<String>) = apply { body.dutyCycle(dutyCycle) }

        /** Field of regard of this radar in degrees. */
        fun fieldOfRegard(fieldOfRegard: Double) = apply { body.fieldOfRegard(fieldOfRegard) }
        ...
        /** Field of view of this radar in kilometers. */
        fun fieldOfView(fieldOfView: Double) = apply { body.fieldOfView(fieldOfView) }
         ...
         * value.
         */
        fun fieldOfView(fieldOfView: JsonField<Double>) = apply { body.fieldOfView(fieldOfView) }
         ...
         */
        fun frequencyBand(frequencyBand: String) = apply { body.frequencyBand(frequencyBand) }
        ...
        /** Partner seradata-spacecraft. */
        fun partnerSpacecraft(partnerSpacecraft: String) = apply {
        ...
        /** Point method for this radar, e.g. Spacecraft. */
        fun pointingMethod(pointingMethod: String) = apply { body.pointingMethod(pointingMethod) }
        ...
        /** Receive polarization, e.g. Lin Dual, Lin vert, etc. */
        fun receivePolarization(receivePolarization: String) = apply {
        ...
        /** Recorder size, e.g. 256. */
        fun recorderSize(recorderSize: String) = apply { body.recorderSize(recorderSize) }
        ...
        /** Transmit polarization, e.g. Lin Dual, Lin vert, etc. */
        fun transmitPolarization(transmitPolarization: String) = apply {
        ...
        /**
         * Returns an immutable instance of [SeradataRadarPayloadUpdateParams].
         *
         ...
         */
        fun build(): SeradataRadarPayloadUpdateParams =
            SeradataRadarPayloadUpdateParams(
                pathId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeradataRadarPayloadUpdateParams && pathId == other.pathId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(pathId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "SeradataRadarPayloadUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
