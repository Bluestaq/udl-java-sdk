...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airloadplanFull: AirloadplanFull) = apply {
            ...
            airLoadPlanHazmatActuals =
                airloadplanFull.airLoadPlanHazmatActuals.map { it.toMutableList() }
            airLoadPlanHr = airloadplanFull.airLoadPlanHr.map { it.toMutableList() }
            airLoadPlanPalletDetails =
                airloadplanFull.airLoadPlanPalletDetails.map { it.toMutableList() }
    ...
    fun validate(): AirloadplanFull = apply {
        if (validated) {
            return@apply
        }
