...
class AirloadplanFull private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirloadplanFull].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airloadplanFull: AirloadplanFull) =
            apply {
                classificationMarking = airloadplanFull.classificationMarking
                dataMode = airloadplanFull.dataMode
                estDepTime = airloadplanFull.estDepTime
                source = airloadplanFull.source
                id = airloadplanFull.id
                aclOnboard = airloadplanFull.aclOnboard
                aclReleased = airloadplanFull.aclReleased
                aircraftMds = airloadplanFull.aircraftMds
                airLoadPlanHazmatActuals = airloadplanFull.airLoadPlanHazmatActuals.map { it.toMutableList() }
                airLoadPlanHr = airloadplanFull.airLoadPlanHr.map { it.toMutableList() }
                airLoadPlanPalletDetails = airloadplanFull.airLoadPlanPalletDetails.map { it.toMutableList() }
                airLoadPlanPaxCargo = airloadplanFull.airLoadPlanPaxCargo.map { it.toMutableList() }
                airLoadPlanUlnActuals = airloadplanFull.airLoadPlanUlnActuals.map { it.toMutableList() }
                arrAirfield = airloadplanFull.arrAirfield
                arrIcao = airloadplanFull.arrIcao
                availableTime = airloadplanFull.availableTime
                basicMoment = airloadplanFull.basicMoment
                basicWeight = airloadplanFull.basicWeight
                briefTime = airloadplanFull.briefTime
                callSign = airloadplanFull.callSign
                cargoBayFsMax = airloadplanFull.cargoBayFsMax
                cargoBayFsMin = airloadplanFull.cargoBayFsMin
                cargoBayWidth = airloadplanFull.cargoBayWidth
                cargoConfig = airloadplanFull.cargoConfig
                cargoMoment = airloadplanFull.cargoMoment
                cargoVolume = airloadplanFull.cargoVolume
                cargoWeight = airloadplanFull.cargoWeight
                createdAt = airloadplanFull.createdAt
                createdBy = airloadplanFull.createdBy
                crewSize = airloadplanFull.crewSize
                depAirfield = airloadplanFull.depAirfield
                depIcao = airloadplanFull.depIcao
                equipConfig = airloadplanFull.equipConfig
                estArrTime = airloadplanFull.estArrTime
                estLandingFuelMoment = airloadplanFull.estLandingFuelMoment
                estLandingFuelWeight = airloadplanFull.estLandingFuelWeight
                externalId = airloadplanFull.externalId
                fuelMoment = airloadplanFull.fuelMoment
                fuelWeight = airloadplanFull.fuelWeight
                grossCg = airloadplanFull.grossCg
                grossMoment = airloadplanFull.grossMoment
                grossWeight = airloadplanFull.grossWeight
                idMission = airloadplanFull.idMission
                idSortie = airloadplanFull.idSortie
                landingCg = airloadplanFull.landingCg
                landingMoment = airloadplanFull.landingMoment
                landingWeight = airloadplanFull.landingWeight
                legNum = airloadplanFull.legNum
                loadmasterName = airloadplanFull.loadmasterName
                loadmasterRank = airloadplanFull.loadmasterRank
                loadRemarks = airloadplanFull.loadRemarks
                missionNumber = airloadplanFull.missionNumber
                operatingMoment = airloadplanFull.operatingMoment
                operatingWeight = airloadplanFull.operatingWeight
                origin = airloadplanFull.origin
                origNetwork = airloadplanFull.origNetwork
                ppOnboard = airloadplanFull.ppOnboard
                ppReleased = airloadplanFull.ppReleased
                schedTime = airloadplanFull.schedTime
                seatsOnboard = airloadplanFull.seatsOnboard
                seatsReleased = airloadplanFull.seatsReleased
                sourceDl = airloadplanFull.sourceDl
                tailNumber = airloadplanFull.tailNumber
                tankConfig = airloadplanFull.tankConfig
                updatedAt = airloadplanFull.updatedAt
                updatedBy = airloadplanFull.updatedBy
                utilCode = airloadplanFull.utilCode
                zeroFuelCg = airloadplanFull.zeroFuelCg
                zeroFuelMoment = airloadplanFull.zeroFuelMoment
                zeroFuelWeight = airloadplanFull.zeroFuelWeight
                additionalProperties = airloadplanFull.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AirloadplanFull].
         *
