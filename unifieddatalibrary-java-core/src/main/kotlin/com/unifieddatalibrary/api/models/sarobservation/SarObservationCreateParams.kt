...
/**
 * Service operation to take a single SAR observation as a POST body and ingest into the database.
 ...
 */
class SarObservationCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sarObservationCreateParams: SarObservationCreateParams) = apply {
        ...
        /** Collection end time in ISO 8601 UTC format with microsecond precision. */
        fun collectionEnd(collectionEnd: OffsetDateTime) = apply {
        ...
        /** Collection mode setting for this collection (e.g. AREA, SPOTLIGHT, STRIP, etc.). */
        fun sarMode(sarMode: String) = apply { body.sarMode(sarMode) }
         ...
         */
        fun sarMode(sarMode: JsonField<String>) = apply { body.sarMode(sarMode) }
         ...
         */
        fun azimuthAngle(azimuthAngle: Double) = apply { body.azimuthAngle(azimuthAngle) }
         ...
         */
        fun centerTime(centerTime: OffsetDateTime) = apply { body.centerTime(centerTime) }
        ...
        /** Required sweep angle for the continuous spot scene in degrees. */
        fun continuousSpotAngle(continuousSpotAngle: Double) = apply {
         ...
         * collection.
         */
        fun coordSys(coordSys: String) = apply { body.coordSys(coordSys) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun coordSys(coordSys: JsonField<String>) = apply { body.coordSys(coordSys) }
        ...
        /** The detection end time in ISO 8601 UTC format, with microsecond precision. */
        fun detectionEnd(detectionEnd: OffsetDateTime) = apply { body.detectionEnd(detectionEnd) }
         ...
         * Identifier of the specific detection within a collection which produced this observation.
         */
        fun detectionId(detectionId: String) = apply { body.detectionId(detectionId) }
         ...
         * value.
         */
        fun detectionId(detectionId: JsonField<String>) = apply { body.detectionId(detectionId) }

        /** The detection start time in ISO 8601 UTC format, with microsecond precision. */
        fun detectionStart(detectionStart: OffsetDateTime) = apply {
        ...
        /** The duration, in seconds, of this detection. */
        fun dwellTime(dwellTime: Double) = apply { body.dwellTime(dwellTime) }
         ...
         * value.
         */
        fun dwellTime(dwellTime: JsonField<Double>) = apply { body.dwellTime(dwellTime) }
         ...
         * collection.
         */
        fun farRange(farRange: Double) = apply { body.farRange(farRange) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun farRange(farRange: JsonField<Double>) = apply { body.farRange(farRange) }

        /** The graze angle (also referred to as look angle) for the collection in degrees. */
        fun grazeAngle(grazeAngle: Double) = apply { body.grazeAngle(grazeAngle) }
         ...
         * value.
         */
        fun grazeAngle(grazeAngle: JsonField<Double>) = apply { body.grazeAngle(grazeAngle) }

        /**
         * Distance between independent measurements, representing the physical dimension that
         * represents a pixel of the image.
         */
        fun groundResolutionProjection(groundResolutionProjection: Double) = apply {
        ...
        /** The center incidence angle in degrees. */
        fun incidenceAngle(incidenceAngle: Double) = apply { body.incidenceAngle(incidenceAngle) }
        ...
        /** The number of looks in the azimuth direction. */
        fun looksAzimuth(looksAzimuth: Int) = apply { body.looksAzimuth(looksAzimuth) }
         ...
         * value.
         */
        fun looksAzimuth(looksAzimuth: JsonField<Int>) = apply { body.looksAzimuth(looksAzimuth) }

        /** The number of looks in the range direction. */
        fun looksRange(looksRange: Int) = apply { body.looksRange(looksRange) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun looksRange(looksRange: JsonField<Int>) = apply { body.looksRange(looksRange) }

        /**
         * Averages the input synthetic aperture radar (SAR) data by looks in range and azimuth to
         * approximate square pixels, mitigates speckle, and reduces SAR tool processing time.
         */
        fun multilookNumber(multilookNumber: Double) = apply {
         ...
         * collection.
         */
        fun nearRange(nearRange: Double) = apply { body.nearRange(nearRange) }
         ...
         * value.
         */
        fun nearRange(nearRange: JsonField<Double>) = apply { body.nearRange(nearRange) }

        /** The antenna pointing direction (LEFT, RIGHT). */
        fun obDirection(obDirection: String) = apply { body.obDirection(obDirection) }
         ...
         * value.
         */
        fun obDirection(obDirection: JsonField<String>) = apply { body.obDirection(obDirection) }
         ...
         */
        fun operatingBand(operatingBand: String) = apply { body.operatingBand(operatingBand) }
        ...
        /** The operating frequency, in Mhz, for the collection. */
        fun operatingFreq(operatingFreq: Double) = apply { body.operatingFreq(operatingFreq) }
        ...
        /** The orbital direction (ASCENDING, DESCENDING) of the platform during the collection. */
        fun orbitState(orbitState: String) = apply { body.orbitState(orbitState) }
         ...
         * value.
         */
        fun orbitState(orbitState: JsonField<String>) = apply { body.orbitState(orbitState) }
        ...
        /** The bandwidth frequency of the pulse in Mhz. */
        fun pulseBandwidth(pulseBandwidth: Double) = apply { body.pulseBandwidth(pulseBandwidth) }
        ...
        /** The duration of a pulse in seconds. */
        fun pulseDuration(pulseDuration: Double) = apply { body.pulseDuration(pulseDuration) }
        ...
        /** The resolution in the azimuth direction measured in meters. */
        fun resolutionAzimuth(resolutionAzimuth: Double) = apply {
        ...
        /** The resolution in the range direction measured in meters. */
        fun resolutionRange(resolutionRange: Double) = apply {
         ...
         */
        fun rxPolarization(rxPolarization: String) = apply { body.rxPolarization(rxPolarization) }
         ...
         * to 90 degrees (negative values south of equator).
         */
        fun senlatEnd(senlatEnd: Double) = apply { body.senlatEnd(senlatEnd) }
         ...
         * value.
         */
        fun senlatEnd(senlatEnd: JsonField<Double>) = apply { body.senlatEnd(senlatEnd) }

        /**
         * WGS-84 sensor latitude sub-point at collect start time (collectionStart), represented as
         * -90 to 90 degrees (negative values south of equator).
         */
        fun senlatStart(senlatStart: Double) = apply { body.senlatStart(senlatStart) }
         ...
         * value.
         */
        fun senlatStart(senlatStart: JsonField<Double>) = apply { body.senlatStart(senlatStart) }

        /**
         * WGS-84 sensor longitude sub-point at collect end time (collectionEnd), represented as
         * -180 to 180 degrees (negative values west of Prime Meridian).
         */
        fun senlonEnd(senlonEnd: Double) = apply { body.senlonEnd(senlonEnd) }
         ...
         * value.
         */
        fun senlonEnd(senlonEnd: JsonField<Double>) = apply { body.senlonEnd(senlonEnd) }

        /**
         * WGS-84 sensor longitude sub-point at collect start time (collectionStart), represented as
         * -180 to 180 degrees (negative values west of Prime Meridian).
         */
        fun senlonStart(senlonStart: Double) = apply { body.senlonStart(senlonStart) }
         ...
         * value.
         */
        fun senlonStart(senlonStart: JsonField<Double>) = apply { body.senlonStart(senlonStart) }
        ...
        /** Slant distance from sensor to center point of imaging event in kilometers. */
        fun slantRange(slantRange: Double) = apply { body.slantRange(slantRange) }
         ...
         * value.
         */
        fun slantRange(slantRange: JsonField<Double>) = apply { body.slantRange(slantRange) }
        ...
        /** The pixel spacing in the azimuth direction measured in meters. */
        fun spacingAzimuth(spacingAzimuth: Double) = apply { body.spacingAzimuth(spacingAzimuth) }
        ...
        /** The pixel spacing in the range direction measured in meters. */
        fun spacingRange(spacingRange: Double) = apply { body.spacingRange(spacingRange) }
        ...
        /** The squint angle for the collection in degrees. */
        fun squintAngle(squintAngle: Double) = apply { body.squintAngle(squintAngle) }
         ...
         * value.
         */
        fun squintAngle(squintAngle: JsonField<Double>) = apply { body.squintAngle(squintAngle) }
        ...
        /** The length of the collection as projected on the ground in kilometers. */
        fun swathLength(swathLength: Double) = apply { body.swathLength(swathLength) }
         ...
         * value.
         */
        fun swathLength(swathLength: JsonField<Double>) = apply { body.swathLength(swathLength) }
        ...
        /** The collection target X position in kilometers. */
        fun targetposx(targetposx: Double) = apply { body.targetposx(targetposx) }
         ...
         * value.
         */
        fun targetposx(targetposx: JsonField<Double>) = apply { body.targetposx(targetposx) }

        /** The collection target Y position in kilometers. */
        fun targetposy(targetposy: Double) = apply { body.targetposy(targetposy) }
         ...
         * value.
         */
        fun targetposy(targetposy: JsonField<Double>) = apply { body.targetposy(targetposy) }

        /** The collection target Z position in kilometers. */
        fun targetposz(targetposz: Double) = apply { body.targetposz(targetposz) }
         ...
         * value.
         */
        fun targetposz(targetposz: JsonField<Double>) = apply { body.targetposz(targetposz) }
         ...
         * Polarized) Rotating right relative to the earth's surface.
         */
        fun txPolarization(txPolarization: String) = apply { body.txPolarization(txPolarization) }
    ...
    override fun toString() =
        "SarObservationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
