...
class SensorPlanTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorPlanTupleParams].
         *
    ...
    /** A builder for [SensorPlanTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanTupleParams: SensorPlanTupleParams) =
            apply {
                columns = sensorPlanTupleParams.columns
                startTime = sensorPlanTupleParams.startTime
                firstResult = sensorPlanTupleParams.firstResult
                maxResults = sensorPlanTupleParams.maxResults
                additionalHeaders = sensorPlanTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = sensorPlanTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SensorPlanTupleParams].
         *
         ...
         */
        fun build(): SensorPlanTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorPlanTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SensorPlanTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
