...
class PortGetResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portGetResponse: PortGetResponse) =
            apply {
    ...
    override fun toString() = "PortGetResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, avgDuration=$avgDuration, countryCode=$countryCode, createdAt=$createdAt, createdBy=$createdBy, externalId=$externalId, harborSize=$harborSize, harborType=$harborType, idSite=$idSite, lat=$lat, locode=$locode, lon=$lon, maxDraught=$maxDraught, origin=$origin, origNetwork=$origNetwork, pilotReqd=$pilotReqd, portName=$portName, shelter=$shelter, sourceDl=$sourceDl, tideRange=$tideRange, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
