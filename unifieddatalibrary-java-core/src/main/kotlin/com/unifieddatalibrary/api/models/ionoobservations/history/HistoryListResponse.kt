...
class HistoryListResponse private constructor(
    ...
    private val antennaElementPositionCoordinateSystem: JsonField<AntennaElementPositionCoordinateSystem>,
    ...
    private constructor(
        ...
        @JsonProperty("startTimeUTC") @ExcludeMissing startTimeUtc: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("systemInfo") @ExcludeMissing systemInfo: JsonField<String> = JsonMissing.of(),
        @JsonProperty("id") @ExcludeMissing id: JsonField<String> = JsonMissing.of(),
        @JsonProperty("amplitude") @ExcludeMissing amplitude: JsonField<Amplitude> = JsonMissing.of(),
        @JsonProperty("antennaElementPosition") @ExcludeMissing antennaElementPosition: JsonField<AntennaElementPosition> = JsonMissing.of(),
        @JsonProperty("antennaElementPositionCoordinateSystem") @ExcludeMissing antennaElementPositionCoordinateSystem: JsonField<AntennaElementPositionCoordinateSystem> = JsonMissing.of(),
        @JsonProperty("artistFlags") @ExcludeMissing artistFlags: JsonField<List<Int>> = JsonMissing.of(),
        ...
        @JsonProperty("charAtts") @ExcludeMissing charAtts: JsonField<List<CharAtt>> = JsonMissing.of(),
        ...
        @JsonProperty("densityProfile") @ExcludeMissing densityProfile: JsonField<DensityProfile> = JsonMissing.of(),
        ...
        @JsonProperty("electronDensity") @ExcludeMissing electronDensity: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("electronDensityUncertainty") @ExcludeMissing electronDensityUncertainty: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("elevation") @ExcludeMissing elevation: JsonField<Elevation> = JsonMissing.of(),
        ...
        @JsonProperty("frequency") @ExcludeMissing frequency: JsonField<Frequency> = JsonMissing.of(),
        ...
        @JsonProperty("hprimefMUF") @ExcludeMissing hprimefMuf: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("neProfileName") @ExcludeMissing neProfileName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("neProfileVersion") @ExcludeMissing neProfileVersion: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("plasmaFrequency") @ExcludeMissing plasmaFrequency: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("plasmaFrequencyUncertainty") @ExcludeMissing plasmaFrequencyUncertainty: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("platformName") @ExcludeMissing platformName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("polarization") @ExcludeMissing polarization: JsonField<Polarization> = JsonMissing.of(),
        ...
        @JsonProperty("receiveCoordinates") @ExcludeMissing receiveCoordinates: JsonField<List<List<Double>>> = JsonMissing.of(),
        @JsonProperty("receiveSensorType") @ExcludeMissing receiveSensorType: JsonField<ReceiveSensorType> = JsonMissing.of(),
        @JsonProperty("restrictedFrequency") @ExcludeMissing restrictedFrequency: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("restrictedFrequencyNotes") @ExcludeMissing restrictedFrequencyNotes: JsonField<String> = JsonMissing.of(),
        @JsonProperty("scaleHeightF2Peak") @ExcludeMissing scaleHeightF2Peak: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("scalerInfo") @ExcludeMissing scalerInfo: JsonField<ScalerInfo> = JsonMissing.of(),
        @JsonProperty("stokes") @ExcludeMissing stokes: JsonField<Stokes> = JsonMissing.of(),
        @JsonProperty("systemNotes") @ExcludeMissing systemNotes: JsonField<String> = JsonMissing.of(),
        @JsonProperty("tec") @ExcludeMissing tec: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("tidAzimuth") @ExcludeMissing tidAzimuth: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("tidPeriods") @ExcludeMissing tidPeriods: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("tidPhaseSpeeds") @ExcludeMissing tidPhaseSpeeds: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("time") @ExcludeMissing time: JsonField<Time> = JsonMissing.of(),
        @JsonProperty("traceGeneric") @ExcludeMissing traceGeneric: JsonField<TraceGeneric> = JsonMissing.of(),
        @JsonProperty("transmitCoordinates") @ExcludeMissing transmitCoordinates: JsonField<List<List<Double>>> = JsonMissing.of(),
        @JsonProperty("transmitSensorType") @ExcludeMissing transmitSensorType: JsonField<TransmitSensorType> = JsonMissing.of(),
    ...
    /** @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun antennaElementPosition(): Optional<AntennaElementPosition> = antennaElementPosition.getOptional("antennaElementPosition")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun antennaElementPositionCoordinateSystem(): Optional<AntennaElementPositionCoordinateSystem> = antennaElementPositionCoordinateSystem.getOptional("antennaElementPositionCoordinateSystem")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun electronDensityUncertainty(): Optional<List<Double>> = electronDensityUncertainty.getOptional("electronDensityUncertainty")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun plasmaFrequencyUncertainty(): Optional<List<Double>> = plasmaFrequencyUncertainty.getOptional("plasmaFrequencyUncertainty")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun receiveCoordinates(): Optional<List<List<Double>>> = receiveCoordinates.getOptional("receiveCoordinates")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun receiveSensorType(): Optional<ReceiveSensorType> = receiveSensorType.getOptional("receiveSensorType")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun restrictedFrequency(): Optional<List<Double>> = restrictedFrequency.getOptional("restrictedFrequency")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun restrictedFrequencyNotes(): Optional<String> = restrictedFrequencyNotes.getOptional("restrictedFrequencyNotes")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun transmitCoordinates(): Optional<List<List<Double>>> = transmitCoordinates.getOptional("transmitCoordinates")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun transmitSensorType(): Optional<TransmitSensorType> = transmitSensorType.getOptional("transmitSensorType")
    ...
    @ExcludeMissing
    fun _stationId(): JsonField<String> = stationId
    ...
    @JsonProperty("system")
    @ExcludeMissing
    fun _system(): JsonField<String> = system
    ...
    @ExcludeMissing
    fun _systemInfo(): JsonField<String> = systemInfo
    ...
    @ExcludeMissing
    fun _amplitude(): JsonField<Amplitude> = amplitude

    /**
     * Returns the raw JSON value of [antennaElementPosition].
     *
     * Unlike [antennaElementPosition], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [antennaElementPositionCoordinateSystem], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("antennaElementPositionCoordinateSystem")
    @ExcludeMissing
    fun _antennaElementPositionCoordinateSystem(): JsonField<AntennaElementPositionCoordinateSystem> = antennaElementPositionCoordinateSystem
    ...
    @ExcludeMissing
    fun _azimuth(): JsonField<Azimuth> = azimuth
    ...
    @ExcludeMissing
    fun _charAtts(): JsonField<List<CharAtt>> = charAtts
    ...
    @JsonProperty("datum")
    @ExcludeMissing
    fun _datum(): JsonField<Datum> = datum
    ...
    @ExcludeMissing
    fun _deltafoF2(): JsonField<Double> = deltafoF2
    ...
    @ExcludeMissing
    fun _doppler(): JsonField<Doppler> = doppler
    ...
    @JsonProperty("downE")
    @ExcludeMissing
    fun _downE(): JsonField<Double> = downE
    ...
    @JsonProperty("downEs")
    @ExcludeMissing
    fun _downEs(): JsonField<Double> = downEs
    ...
    @JsonProperty("downF")
    @ExcludeMissing
    fun _downF(): JsonField<Double> = downF
     ...
     *
     * Unlike [electronDensityUncertainty], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _elevation(): JsonField<Elevation> = elevation
    ...
    @JsonProperty("fbEs")
    @ExcludeMissing
    fun _fbEs(): JsonField<Double> = fbEs
    ...
    @ExcludeMissing
    fun _fhprimeF(): JsonField<Double> = fhprimeF
    ...
    @ExcludeMissing
    fun _fhprimeF2(): JsonField<Double> = fhprimeF2
    ...
    @JsonProperty("fmin")
    @ExcludeMissing
    fun _fmin(): JsonField<Double> = fmin
    ...
    @JsonProperty("fminE")
    @ExcludeMissing
    fun _fminE(): JsonField<Double> = fminE
    ...
    @JsonProperty("fminEs")
    @ExcludeMissing
    fun _fminEs(): JsonField<Double> = fminEs
    ...
    @JsonProperty("fminF")
    @ExcludeMissing
    fun _fminF(): JsonField<Double> = fminF
    ...
    @JsonProperty("fmuf")
    @ExcludeMissing
    fun _fmuf(): JsonField<Double> = fmuf
    ...
    @JsonProperty("foEa")
    @ExcludeMissing
    fun _foEa(): JsonField<Double> = foEa
    ...
    @JsonProperty("foEp")
    @ExcludeMissing
    fun _foEp(): JsonField<Double> = foEp
    ...
    @JsonProperty("foEs")
    @ExcludeMissing
    fun _foEs(): JsonField<Double> = foEs
    ...
    @JsonProperty("foF1")
    @ExcludeMissing
    fun _foF1(): JsonField<Double> = foF1
    ...
    @JsonProperty("foF1p")
    @ExcludeMissing
    fun _foF1p(): JsonField<Double> = foF1p
    ...
    @JsonProperty("foF2")
    @ExcludeMissing
    fun _foF2(): JsonField<Double> = foF2
    ...
    @JsonProperty("foF2p")
    @ExcludeMissing
    fun _foF2p(): JsonField<Double> = foF2p
    ...
    @JsonProperty("fxF1")
    @ExcludeMissing
    fun _fxF1(): JsonField<Double> = fxF1
    ...
    @JsonProperty("fxF2")
    @ExcludeMissing
    fun _fxF2(): JsonField<Double> = fxF2
    ...
    @JsonProperty("height")
    @ExcludeMissing
    fun _height(): JsonField<List<Double>> = height
    ...
    @JsonProperty("hmF1")
    @ExcludeMissing
    fun _hmF1(): JsonField<Double> = hmF1
    ...
    @JsonProperty("hmF2")
    @ExcludeMissing
    fun _hmF2(): JsonField<Double> = hmF2
     ...
     */
    @JsonProperty("hprimeE")
    @ExcludeMissing
    fun _hprimeE(): JsonField<Double> = hprimeE
    ...
    @ExcludeMissing
    fun _hprimeEa(): JsonField<Double> = hprimeEa
    ...
    @ExcludeMissing
    fun _hprimeEs(): JsonField<Double> = hprimeEs
     ...
     */
    @JsonProperty("hprimeF")
    @ExcludeMissing
    fun _hprimeF(): JsonField<Double> = hprimeF
    ...
    @ExcludeMissing
    fun _hprimeF1(): JsonField<Double> = hprimeF1
    ...
    @ExcludeMissing
    fun _hprimeF2(): JsonField<Double> = hprimeF2
    ...
    @ExcludeMissing
    fun _hprimefMuf(): JsonField<Double> = hprimefMuf
     ...
     */
    @JsonProperty("hprimeP")
    @ExcludeMissing
    fun _hprimeP(): JsonField<Double> = hprimeP
    ...
    @JsonProperty("mufd")
    @ExcludeMissing
    fun _mufd(): JsonField<Double> = mufd
     ...
     *
     * Unlike [neProfileVersion], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("phase")
    @ExcludeMissing
    fun _phase(): JsonField<Phase> = phase
     ...
     *
     * Unlike [plasmaFrequencyUncertainty], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("power")
    @ExcludeMissing
    fun _power(): JsonField<Power> = power
    ...
    @JsonProperty("range")
    @ExcludeMissing
    fun _range(): JsonField<Range> = range

    /**
     * Returns the raw JSON value of [receiveCoordinates].
     *
     * Unlike [receiveCoordinates], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [receiveSensorType], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [restrictedFrequency], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [restrictedFrequencyNotes], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [scaleHeightF2Peak], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("stokes")
    @ExcludeMissing
    fun _stokes(): JsonField<Stokes> = stokes
    ...
    @ExcludeMissing
    fun _systemNotes(): JsonField<String> = systemNotes
     ...
     *
     * Unlike [transmitCoordinates], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [transmitSensorType], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("typeEs")
    @ExcludeMissing
    fun _typeEs(): JsonField<String> = typeEs
    ...
    @ExcludeMissing
    fun _zhalfNm(): JsonField<Double> = zhalfNm
    ...
    class Builder internal constructor() {
        ...
        private var antennaElementPositionCoordinateSystem: JsonField<AntennaElementPositionCoordinateSystem> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(historyListResponse: HistoryListResponse) =
            apply {
                ...
                startTimeUtc = historyListResponse.startTimeUtc
                stationId = historyListResponse.stationId
                system = historyListResponse.system
                systemInfo = historyListResponse.systemInfo
                id = historyListResponse.id
                amplitude = historyListResponse.amplitude
                antennaElementPosition = historyListResponse.antennaElementPosition
                antennaElementPositionCoordinateSystem = historyListResponse.antennaElementPositionCoordinateSystem
                artistFlags = historyListResponse.artistFlags.map { it.toMutableList() }
                azimuth = historyListResponse.azimuth
                b0 = historyListResponse.b0
                b1 = historyListResponse.b1
                charAtts = historyListResponse.charAtts.map { it.toMutableList() }
                createdAt = historyListResponse.createdAt
                createdBy = historyListResponse.createdBy
                d = historyListResponse.d
                d1 = historyListResponse.d1
                datum = historyListResponse.datum
                deltafoF2 = historyListResponse.deltafoF2
                densityProfile = historyListResponse.densityProfile
                doppler = historyListResponse.doppler
                downE = historyListResponse.downE
                downEs = historyListResponse.downEs
                downF = historyListResponse.downF
                electronDensity = historyListResponse.electronDensity.map { it.toMutableList() }
                electronDensityUncertainty = historyListResponse.electronDensityUncertainty.map { it.toMutableList() }
                elevation = historyListResponse.elevation
                fbEs = historyListResponse.fbEs
                fe = historyListResponse.fe
                ff = historyListResponse.ff
                fhprimeF = historyListResponse.fhprimeF
                fhprimeF2 = historyListResponse.fhprimeF2
                fmin = historyListResponse.fmin
                fminE = historyListResponse.fminE
                fminEs = historyListResponse.fminEs
                fminF = historyListResponse.fminF
                fmuf = historyListResponse.fmuf
                foE = historyListResponse.foE
                foEa = historyListResponse.foEa
                foEp = historyListResponse.foEp
                foEs = historyListResponse.foEs
                foF1 = historyListResponse.foF1
                foF1p = historyListResponse.foF1p
                foF2 = historyListResponse.foF2
                foF2p = historyListResponse.foF2p
                foP = historyListResponse.foP
                frequency = historyListResponse.frequency
                fxE = historyListResponse.fxE
                fxF1 = historyListResponse.fxF1
                fxF2 = historyListResponse.fxF2
                fxI = historyListResponse.fxI
                height = historyListResponse.height.map { it.toMutableList() }
                hmE = historyListResponse.hmE
                hmF1 = historyListResponse.hmF1
                hmF2 = historyListResponse.hmF2
                hprimeE = historyListResponse.hprimeE
                hprimeEa = historyListResponse.hprimeEa
                hprimeEs = historyListResponse.hprimeEs
                hprimeF = historyListResponse.hprimeF
                hprimeF1 = historyListResponse.hprimeF1
                hprimeF2 = historyListResponse.hprimeF2
                hprimefMuf = historyListResponse.hprimefMuf
                hprimeP = historyListResponse.hprimeP
                idSensor = historyListResponse.idSensor
                luf = historyListResponse.luf
                md = historyListResponse.md
                mufd = historyListResponse.mufd
                neProfileName = historyListResponse.neProfileName
                neProfileVersion = historyListResponse.neProfileVersion
                ...
                phase = historyListResponse.phase
                plasmaFrequency = historyListResponse.plasmaFrequency.map { it.toMutableList() }
                plasmaFrequencyUncertainty = historyListResponse.plasmaFrequencyUncertainty.map { it.toMutableList() }
                platformName = historyListResponse.platformName
                polarization = historyListResponse.polarization
                power = historyListResponse.power
                qe = historyListResponse.qe
                qf = historyListResponse.qf
                range = historyListResponse.range
                receiveCoordinates = historyListResponse.receiveCoordinates.map { it.toMutableList() }
                receiveSensorType = historyListResponse.receiveSensorType
                restrictedFrequency = historyListResponse.restrictedFrequency.map { it.toMutableList() }
                restrictedFrequencyNotes = historyListResponse.restrictedFrequencyNotes
                scaleHeightF2Peak = historyListResponse.scaleHeightF2Peak
                scalerInfo = historyListResponse.scalerInfo
                stokes = historyListResponse.stokes
                systemNotes = historyListResponse.systemNotes
                tec = historyListResponse.tec
                tidAzimuth = historyListResponse.tidAzimuth.map { it.toMutableList() }
                tidPeriods = historyListResponse.tidPeriods.map { it.toMutableList() }
                tidPhaseSpeeds = historyListResponse.tidPhaseSpeeds.map { it.toMutableList() }
                time = historyListResponse.time
                traceGeneric = historyListResponse.traceGeneric
                transmitCoordinates = historyListResponse.transmitCoordinates.map { it.toMutableList() }
                transmitSensorType = historyListResponse.transmitSensorType
                typeEs = historyListResponse.typeEs
                updatedAt = historyListResponse.updatedAt
                updatedBy = historyListResponse.updatedBy
                yE = historyListResponse.yE
                yF1 = historyListResponse.yF1
                yF2 = historyListResponse.yF2
                zhalfNm = historyListResponse.zhalfNm
                zmE = historyListResponse.zmE
         ...
         *
         * You should usually call [Builder.startTimeUtc] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun startTimeUtc(startTimeUtc: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.stationId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stationId(stationId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.system] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun system(system: JsonField<String>) =
            apply {
                this.system = system
            }
         ...
         *
         * You should usually call [Builder.systemInfo] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun systemInfo(systemInfo: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.amplitude] with a well-typed [Amplitude] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun amplitude(amplitude: JsonField<Amplitude>) =
            apply {
                this.amplitude = amplitude
            }

        fun antennaElementPosition(antennaElementPosition: AntennaElementPosition) = antennaElementPosition(JsonField.of(antennaElementPosition))

        /**
         * Sets [Builder.antennaElementPosition] to an arbitrary JSON value.
         *
         * You should usually call [Builder.antennaElementPosition] with a well-typed [AntennaElementPosition] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Enums: J2000, ECR/ECEF, TEME, GCRF, WGS84 (GEODetic lat, long, alt), GEOCentric (lat, long, radii). */
        fun antennaElementPositionCoordinateSystem(antennaElementPositionCoordinateSystem: AntennaElementPositionCoordinateSystem) = antennaElementPositionCoordinateSystem(JsonField.of(antennaElementPositionCoordinateSystem))

        /**
         * Sets [Builder.antennaElementPositionCoordinateSystem] to an arbitrary JSON value.
         *
         * You should usually call [Builder.antennaElementPositionCoordinateSystem] with a well-typed [AntennaElementPositionCoordinateSystem] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun antennaElementPositionCoordinateSystem(antennaElementPositionCoordinateSystem: JsonField<AntennaElementPositionCoordinateSystem>) =
            apply {
         ...
         *
         * You should usually call [Builder.artistFlags] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun artistFlags(artistFlags: JsonField<List<Int>>) =
            apply {
         ...
         */
        fun addArtistFlag(artistFlag: Int) =
            apply {
                artistFlags = (artistFlags ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.azimuth] with a well-typed [Azimuth] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun azimuth(azimuth: JsonField<Azimuth>) =
            apply {
         ...
         *
         * You should usually call [Builder.b0] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun b0(b0: JsonField<Double>) =
            apply {
                this.b0 = b0
            }
         ...
         *
         * You should usually call [Builder.b1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun b1(b1: JsonField<Double>) =
            apply {
                this.b1 = b1
            }
         ...
         *
         * You should usually call [Builder.charAtts] with a well-typed `List<CharAtt>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun charAtts(charAtts: JsonField<List<CharAtt>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCharAtt(charAtt: CharAtt) =
            apply {
                charAtts = (charAtts ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.d] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun d(d: JsonField<Double>) =
            apply {
                this.d = d
            }
         ...
         *
         * You should usually call [Builder.d1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun d1(d1: JsonField<Double>) =
            apply {
                this.d1 = d1
            }
         ...
         *
         * You should usually call [Builder.datum] with a well-typed [Datum] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun datum(datum: JsonField<Datum>) =
            apply {
                this.datum = datum
            }
         ...
         *
         * You should usually call [Builder.deltafoF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun deltafoF2(deltafoF2: JsonField<Double>) =
            apply {
                this.deltafoF2 = deltafoF2
            }

        /** Profile of electron densities in the ionosphere associated with an IonoObservation. */
        fun densityProfile(densityProfile: DensityProfile) = densityProfile(JsonField.of(densityProfile))

        /**
         * Sets [Builder.densityProfile] to an arbitrary JSON value.
         *
         * You should usually call [Builder.densityProfile] with a well-typed [DensityProfile] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun densityProfile(densityProfile: JsonField<DensityProfile>) =
            apply {
         ...
         *
         * You should usually call [Builder.doppler] with a well-typed [Doppler] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun doppler(doppler: JsonField<Doppler>) =
            apply {
         ...
         *
         * You should usually call [Builder.downE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun downE(downE: JsonField<Double>) =
            apply {
                this.downE = downE
            }
         ...
         *
         * You should usually call [Builder.downEs] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun downEs(downEs: JsonField<Double>) =
            apply {
                this.downEs = downEs
            }
         ...
         *
         * You should usually call [Builder.downF] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun downF(downF: JsonField<Double>) =
            apply {
                this.downF = downF
            }

        /** Array of electron densities in cm^-3 (must match the size of the height and plasmaFrequency arrays). */
        fun electronDensity(electronDensity: List<Double>) = electronDensity(JsonField.of(electronDensity))

        /**
         * Sets [Builder.electronDensity] to an arbitrary JSON value.
         *
         * You should usually call [Builder.electronDensity] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun electronDensity(electronDensity: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addElectronDensity(electronDensity: Double) =
            apply {
                this.electronDensity = (this.electronDensity ?: JsonField.of(mutableListOf())).also {
                    checkKnown("electronDensity", it).add(electronDensity)
                }
            }

        /** Uncertainty in specifying the electron density at each height point of the profile (must match the size of the electronDensity array). */
        fun electronDensityUncertainty(electronDensityUncertainty: List<Double>) = electronDensityUncertainty(JsonField.of(electronDensityUncertainty))

        /**
         * Sets [Builder.electronDensityUncertainty] to an arbitrary JSON value.
         *
         * You should usually call [Builder.electronDensityUncertainty] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun electronDensityUncertainty(electronDensityUncertainty: JsonField<List<Double>>) =
            apply {
                this.electronDensityUncertainty = electronDensityUncertainty.map { it.toMutableList() }
            }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addElectronDensityUncertainty(electronDensityUncertainty: Double) =
            apply {
                this.electronDensityUncertainty = (this.electronDensityUncertainty ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.elevation] with a well-typed [Elevation] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun elevation(elevation: JsonField<Elevation>) =
            apply {
         ...
         *
         * You should usually call [Builder.fbEs] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fbEs(fbEs: JsonField<Double>) =
            apply {
                this.fbEs = fbEs
            }
         ...
         *
         * You should usually call [Builder.fe] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fe(fe: JsonField<Double>) =
            apply {
                this.fe = fe
            }
         ...
         *
         * You should usually call [Builder.ff] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ff(ff: JsonField<Double>) =
            apply {
                this.ff = ff
            }
         ...
         *
         * You should usually call [Builder.fhprimeF] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fhprimeF(fhprimeF: JsonField<Double>) =
            apply {
                this.fhprimeF = fhprimeF
            }
         ...
         *
         * You should usually call [Builder.fhprimeF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fhprimeF2(fhprimeF2: JsonField<Double>) =
            apply {
                this.fhprimeF2 = fhprimeF2
            }
         ...
         *
         * You should usually call [Builder.fmin] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fmin(fmin: JsonField<Double>) =
            apply {
                this.fmin = fmin
            }
         ...
         *
         * You should usually call [Builder.fminE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fminE(fminE: JsonField<Double>) =
            apply {
                this.fminE = fminE
            }
         ...
         *
         * You should usually call [Builder.fminEs] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fminEs(fminEs: JsonField<Double>) =
            apply {
                this.fminEs = fminEs
            }
         ...
         *
         * You should usually call [Builder.fminF] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fminF(fminF: JsonField<Double>) =
            apply {
                this.fminF = fminF
            }
         ...
         *
         * You should usually call [Builder.fmuf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fmuf(fmuf: JsonField<Double>) =
            apply {
                this.fmuf = fmuf
            }
         ...
         *
         * You should usually call [Builder.foE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foE(foE: JsonField<Double>) =
            apply {
                this.foE = foE
            }
         ...
         *
         * You should usually call [Builder.foEa] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foEa(foEa: JsonField<Double>) =
            apply {
                this.foEa = foEa
            }
         ...
         *
         * You should usually call [Builder.foEp] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foEp(foEp: JsonField<Double>) =
            apply {
                this.foEp = foEp
            }
         ...
         *
         * You should usually call [Builder.foEs] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foEs(foEs: JsonField<Double>) =
            apply {
                this.foEs = foEs
            }
         ...
         *
         * You should usually call [Builder.foF1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foF1(foF1: JsonField<Double>) =
            apply {
                this.foF1 = foF1
            }
         ...
         *
         * You should usually call [Builder.foF1p] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foF1p(foF1p: JsonField<Double>) =
            apply {
                this.foF1p = foF1p
            }
         ...
         *
         * You should usually call [Builder.foF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foF2(foF2: JsonField<Double>) =
            apply {
                this.foF2 = foF2
            }
         ...
         *
         * You should usually call [Builder.foF2p] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foF2p(foF2p: JsonField<Double>) =
            apply {
                this.foF2p = foF2p
            }
         ...
         *
         * You should usually call [Builder.foP] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun foP(foP: JsonField<Double>) =
            apply {
                this.foP = foP
            }
         ...
         *
         * You should usually call [Builder.frequency] with a well-typed [Frequency] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.fxE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fxE(fxE: JsonField<Double>) =
            apply {
                this.fxE = fxE
            }
         ...
         *
         * You should usually call [Builder.fxF1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fxF1(fxF1: JsonField<Double>) =
            apply {
                this.fxF1 = fxF1
            }
         ...
         *
         * You should usually call [Builder.fxF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fxF2(fxF2: JsonField<Double>) =
            apply {
                this.fxF2 = fxF2
            }
         ...
         *
         * You should usually call [Builder.fxI] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fxI(fxI: JsonField<Double>) =
            apply {
                this.fxI = fxI
            }
         ...
         *
         * You should usually call [Builder.height] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun height(height: JsonField<List<Double>>) =
            apply {
        ...
        fun addHeight(height: Double) =
            apply {
                this.height = (this.height ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.hmE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hmE(hmE: JsonField<Double>) =
            apply {
                this.hmE = hmE
            }
         ...
         *
         * You should usually call [Builder.hmF1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hmF1(hmF1: JsonField<Double>) =
            apply {
                this.hmF1 = hmF1
            }
         ...
         *
         * You should usually call [Builder.hmF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hmF2(hmF2: JsonField<Double>) =
            apply {
                this.hmF2 = hmF2
            }
         ...
         *
         * You should usually call [Builder.hprimeE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hprimeE(hprimeE: JsonField<Double>) =
            apply {
                this.hprimeE = hprimeE
            }
         ...
         *
         * You should usually call [Builder.hprimeEa] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hprimeEa(hprimeEa: JsonField<Double>) =
            apply {
                this.hprimeEa = hprimeEa
            }
         ...
         *
         * You should usually call [Builder.hprimeEs] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hprimeEs(hprimeEs: JsonField<Double>) =
            apply {
                this.hprimeEs = hprimeEs
            }
         ...
         *
         * You should usually call [Builder.hprimeF] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hprimeF(hprimeF: JsonField<Double>) =
            apply {
                this.hprimeF = hprimeF
            }
         ...
         *
         * You should usually call [Builder.hprimeF1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hprimeF1(hprimeF1: JsonField<Double>) =
            apply {
                this.hprimeF1 = hprimeF1
            }
         ...
         *
         * You should usually call [Builder.hprimeF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hprimeF2(hprimeF2: JsonField<Double>) =
            apply {
                this.hprimeF2 = hprimeF2
            }
         ...
         *
         * You should usually call [Builder.hprimefMuf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hprimefMuf(hprimefMuf: JsonField<Double>) =
            apply {
                this.hprimefMuf = hprimefMuf
            }
         ...
         *
         * You should usually call [Builder.hprimeP] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hprimeP(hprimeP: JsonField<Double>) =
            apply {
                this.hprimeP = hprimeP
            }
         ...
         *
         * You should usually call [Builder.luf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun luf(luf: JsonField<Double>) =
            apply {
                this.luf = luf
            }
         ...
         *
         * You should usually call [Builder.md] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun md(md: JsonField<Double>) =
            apply {
                this.md = md
            }
         ...
         *
         * You should usually call [Builder.mufd] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun mufd(mufd: JsonField<Double>) =
            apply {
                this.mufd = mufd
            }
         ...
         *
         * You should usually call [Builder.neProfileName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun neProfileName(neProfileName: JsonField<String>) =
            apply {
                this.neProfileName = neProfileName
            }

        /** Version of the algorithm used for the electron density profile. */
        fun neProfileVersion(neProfileVersion: Double) = neProfileVersion(JsonField.of(neProfileVersion))

        /**
         * Sets [Builder.neProfileVersion] to an arbitrary JSON value.
         *
         * You should usually call [Builder.neProfileVersion] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun neProfileVersion(neProfileVersion: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.phase] with a well-typed [Phase] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun phase(phase: JsonField<Phase>) =
            apply {
                this.phase = phase
            }

        /** Array of plasma frequencies in MHz (must match the size of the height and electronDensity arrays). */
        fun plasmaFrequency(plasmaFrequency: List<Double>) = plasmaFrequency(JsonField.of(plasmaFrequency))

        /**
         * Sets [Builder.plasmaFrequency] to an arbitrary JSON value.
         *
         * You should usually call [Builder.plasmaFrequency] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun plasmaFrequency(plasmaFrequency: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPlasmaFrequency(plasmaFrequency: Double) =
            apply {
                this.plasmaFrequency = (this.plasmaFrequency ?: JsonField.of(mutableListOf())).also {
                    checkKnown("plasmaFrequency", it).add(plasmaFrequency)
                }
            }

        /** Uncertainty in specifying the electron plasma frequency at each height point of the profile (must match the size of the plasmaFrequency array). */
        fun plasmaFrequencyUncertainty(plasmaFrequencyUncertainty: List<Double>) = plasmaFrequencyUncertainty(JsonField.of(plasmaFrequencyUncertainty))

        /**
         * Sets [Builder.plasmaFrequencyUncertainty] to an arbitrary JSON value.
         *
         * You should usually call [Builder.plasmaFrequencyUncertainty] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun plasmaFrequencyUncertainty(plasmaFrequencyUncertainty: JsonField<List<Double>>) =
            apply {
                this.plasmaFrequencyUncertainty = plasmaFrequencyUncertainty.map { it.toMutableList() }
            }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPlasmaFrequencyUncertainty(plasmaFrequencyUncertainty: Double) =
            apply {
                this.plasmaFrequencyUncertainty = (this.plasmaFrequencyUncertainty ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.platformName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun platformName(platformName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.polarization] with a well-typed [Polarization] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun polarization(polarization: JsonField<Polarization>) =
            apply {
         ...
         *
         * You should usually call [Builder.power] with a well-typed [Power] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun power(power: JsonField<Power>) =
            apply {
                this.power = power
            }
         ...
         *
         * You should usually call [Builder.qe] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun qe(qe: JsonField<Double>) =
            apply {
                this.qe = qe
            }
         ...
         *
         * You should usually call [Builder.qf] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun qf(qf: JsonField<Double>) =
            apply {
                this.qf = qf
            }
         ...
         *
         * You should usually call [Builder.range] with a well-typed [Range] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun range(range: JsonField<Range>) =
            apply {
                this.range = range
            }

        /** List of Geodetic Latitude, Longitude, and Altitude coordinates in km of the receiver. Coordinates List must always have 3 elements. Valid ranges are -90.0 to 90.0 for Latitude and -180.0 to 180.0 for Longitude. Altitude is in km and its value must be 0 or greater. */
        fun receiveCoordinates(receiveCoordinates: List<List<Double>>) = receiveCoordinates(JsonField.of(receiveCoordinates))

        /**
         * Sets [Builder.receiveCoordinates] to an arbitrary JSON value.
         *
         * You should usually call [Builder.receiveCoordinates] with a well-typed `List<List<Double>>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun receiveCoordinates(receiveCoordinates: JsonField<List<List<Double>>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addReceiveCoordinate(receiveCoordinate: List<Double>) =
            apply {
                receiveCoordinates = (receiveCoordinates ?: JsonField.of(mutableListOf())).also {
                    checkKnown("receiveCoordinates", it).add(receiveCoordinate)
                }
            }

        /** Enums: Mobile, Static. */
        fun receiveSensorType(receiveSensorType: ReceiveSensorType) = receiveSensorType(JsonField.of(receiveSensorType))

        /**
         * Sets [Builder.receiveSensorType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.receiveSensorType] with a well-typed [ReceiveSensorType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun receiveSensorType(receiveSensorType: JsonField<ReceiveSensorType>) =
            apply {
                this.receiveSensorType = receiveSensorType
            }

        /** Array of restricted frequencies. */
        fun restrictedFrequency(restrictedFrequency: List<Double>) = restrictedFrequency(JsonField.of(restrictedFrequency))

        /**
         * Sets [Builder.restrictedFrequency] to an arbitrary JSON value.
         *
         * You should usually call [Builder.restrictedFrequency] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun restrictedFrequency(restrictedFrequency: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRestrictedFrequency(restrictedFrequency: Double) =
            apply {
                this.restrictedFrequency = (this.restrictedFrequency ?: JsonField.of(mutableListOf())).also {
                    checkKnown("restrictedFrequency", it).add(restrictedFrequency)
                }
            }

        /** Notes for the restrictedFrequency data. */
        fun restrictedFrequencyNotes(restrictedFrequencyNotes: String) = restrictedFrequencyNotes(JsonField.of(restrictedFrequencyNotes))

        /**
         * Sets [Builder.restrictedFrequencyNotes] to an arbitrary JSON value.
         *
         * You should usually call [Builder.restrictedFrequencyNotes] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun restrictedFrequencyNotes(restrictedFrequencyNotes: JsonField<String>) =
            apply {
                this.restrictedFrequencyNotes = restrictedFrequencyNotes
            }

        /** Effective scale height at hmF2 Titheridge method in km. URSI ID: 69. */
        fun scaleHeightF2Peak(scaleHeightF2Peak: Double) = scaleHeightF2Peak(JsonField.of(scaleHeightF2Peak))

        /**
         * Sets [Builder.scaleHeightF2Peak] to an arbitrary JSON value.
         *
         * You should usually call [Builder.scaleHeightF2Peak] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun scaleHeightF2Peak(scaleHeightF2Peak: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.scalerInfo] with a well-typed [ScalerInfo] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun scalerInfo(scalerInfo: JsonField<ScalerInfo>) =
            apply {
                this.scalerInfo = scalerInfo
            }
         ...
         *
         * You should usually call [Builder.stokes] with a well-typed [Stokes] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stokes(stokes: JsonField<Stokes>) =
            apply {
                this.stokes = stokes
            }
         ...
         *
         * You should usually call [Builder.systemNotes] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun systemNotes(systemNotes: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.tec] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tec(tec: JsonField<Double>) =
            apply {
                this.tec = tec
            }
         ...
         *
         * You should usually call [Builder.tidAzimuth] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tidAzimuth(tidAzimuth: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTidAzimuth(tidAzimuth: Double) =
            apply {
                this.tidAzimuth = (this.tidAzimuth ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.tidPeriods] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tidPeriods(tidPeriods: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTidPeriod(tidPeriod: Double) =
            apply {
                tidPeriods = (tidPeriods ?: JsonField.of(mutableListOf())).also {
                    checkKnown("tidPeriods", it).add(tidPeriod)
                }
            }

        /** Array of speed in m/s at which the disturbance travels through the ionosphere. */
        fun tidPhaseSpeeds(tidPhaseSpeeds: List<Double>) = tidPhaseSpeeds(JsonField.of(tidPhaseSpeeds))

        /**
         * Sets [Builder.tidPhaseSpeeds] to an arbitrary JSON value.
         *
         * You should usually call [Builder.tidPhaseSpeeds] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tidPhaseSpeeds(tidPhaseSpeeds: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTidPhaseSpeed(tidPhaseSpeed: Double) =
            apply {
                tidPhaseSpeeds = (tidPhaseSpeeds ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.time] with a well-typed [Time] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun time(time: JsonField<Time>) =
            apply {
                this.time = time
            }
         ...
         *
         * You should usually call [Builder.traceGeneric] with a well-typed [TraceGeneric] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun traceGeneric(traceGeneric: JsonField<TraceGeneric>) =
            apply {
                this.traceGeneric = traceGeneric
            }

        /** List of Geodetic Latitude, Longitude, and Altitude coordinates in km of the receiver. Coordinates List must always have 3 elements. Valid ranges are -90.0 to 90.0 for Latitude and -180.0 to 180.0 for Longitude. Altitude is in km and its value must be 0 or greater. */
        fun transmitCoordinates(transmitCoordinates: List<List<Double>>) = transmitCoordinates(JsonField.of(transmitCoordinates))

        /**
         * Sets [Builder.transmitCoordinates] to an arbitrary JSON value.
         *
         * You should usually call [Builder.transmitCoordinates] with a well-typed `List<List<Double>>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transmitCoordinates(transmitCoordinates: JsonField<List<List<Double>>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTransmitCoordinate(transmitCoordinate: List<Double>) =
            apply {
                transmitCoordinates = (transmitCoordinates ?: JsonField.of(mutableListOf())).also {
                    checkKnown("transmitCoordinates", it).add(transmitCoordinate)
                }
            }

        /** Enums: Mobile, Static. */
        fun transmitSensorType(transmitSensorType: TransmitSensorType) = transmitSensorType(JsonField.of(transmitSensorType))

        /**
         * Sets [Builder.transmitSensorType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.transmitSensorType] with a well-typed [TransmitSensorType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transmitSensorType(transmitSensorType: JsonField<TransmitSensorType>) =
            apply {
         ...
         *
         * You should usually call [Builder.typeEs] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun typeEs(typeEs: JsonField<String>) =
            apply {
                this.typeEs = typeEs
            }
         ...
         *
         * You should usually call [Builder.yE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun yE(yE: JsonField<Double>) =
            apply {
                this.yE = yE
            }
         ...
         *
         * You should usually call [Builder.yF1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun yF1(yF1: JsonField<Double>) =
            apply {
                this.yF1 = yF1
            }
         ...
         *
         * You should usually call [Builder.yF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun yF2(yF2: JsonField<Double>) =
            apply {
                this.yF2 = yF2
            }
         ...
         *
         * You should usually call [Builder.zhalfNm] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun zhalfNm(zhalfNm: JsonField<Double>) =
            apply {
                this.zhalfNm = zhalfNm
            }
         ...
         *
         * You should usually call [Builder.zmE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun zmE(zmE: JsonField<Double>) =
            apply {
                this.zmE = zmE
            }
    ...
    fun validate(): HistoryListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTimeUtc.asKnown().isPresent) 1 else 0) + (if (stationId.asKnown().isPresent) 1 else 0) + (if (system.asKnown().isPresent) 1 else 0) + (if (systemInfo.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (amplitude.asKnown().getOrNull()?.validity() ?: 0) + (antennaElementPosition.asKnown().getOrNull()?.validity() ?: 0) + (antennaElementPositionCoordinateSystem.asKnown().getOrNull()?.validity() ?: 0) + (artistFlags.asKnown().getOrNull()?.size ?: 0) + (azimuth.asKnown().getOrNull()?.validity() ?: 0) + (if (b0.asKnown().isPresent) 1 else 0) + (if (b1.asKnown().isPresent) 1 else 0) + (charAtts.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (d.asKnown().isPresent) 1 else 0) + (if (d1.asKnown().isPresent) 1 else 0) + (datum.asKnown().getOrNull()?.validity() ?: 0) + (if (deltafoF2.asKnown().isPresent) 1 else 0) + (densityProfile.asKnown().getOrNull()?.validity() ?: 0) + (doppler.asKnown().getOrNull()?.validity() ?: 0) + (if (downE.asKnown().isPresent) 1 else 0) + (if (downEs.asKnown().isPresent) 1 else 0) + (if (downF.asKnown().isPresent) 1 else 0) + (electronDensity.asKnown().getOrNull()?.size ?: 0) + (electronDensityUncertainty.asKnown().getOrNull()?.size ?: 0) + (elevation.asKnown().getOrNull()?.validity() ?: 0) + (if (fbEs.asKnown().isPresent) 1 else 0) + (if (fe.asKnown().isPresent) 1 else 0) + (if (ff.asKnown().isPresent) 1 else 0) + (if (fhprimeF.asKnown().isPresent) 1 else 0) + (if (fhprimeF2.asKnown().isPresent) 1 else 0) + (if (fmin.asKnown().isPresent) 1 else 0) + (if (fminE.asKnown().isPresent) 1 else 0) + (if (fminEs.asKnown().isPresent) 1 else 0) + (if (fminF.asKnown().isPresent) 1 else 0) + (if (fmuf.asKnown().isPresent) 1 else 0) + (if (foE.asKnown().isPresent) 1 else 0) + (if (foEa.asKnown().isPresent) 1 else 0) + (if (foEp.asKnown().isPresent) 1 else 0) + (if (foEs.asKnown().isPresent) 1 else 0) + (if (foF1.asKnown().isPresent) 1 else 0) + (if (foF1p.asKnown().isPresent) 1 else 0) + (if (foF2.asKnown().isPresent) 1 else 0) + (if (foF2p.asKnown().isPresent) 1 else 0) + (if (foP.asKnown().isPresent) 1 else 0) + (frequency.asKnown().getOrNull()?.validity() ?: 0) + (if (fxE.asKnown().isPresent) 1 else 0) + (if (fxF1.asKnown().isPresent) 1 else 0) + (if (fxF2.asKnown().isPresent) 1 else 0) + (if (fxI.asKnown().isPresent) 1 else 0) + (height.asKnown().getOrNull()?.size ?: 0) + (if (hmE.asKnown().isPresent) 1 else 0) + (if (hmF1.asKnown().isPresent) 1 else 0) + (if (hmF2.asKnown().isPresent) 1 else 0) + (if (hprimeE.asKnown().isPresent) 1 else 0) + (if (hprimeEa.asKnown().isPresent) 1 else 0) + (if (hprimeEs.asKnown().isPresent) 1 else 0) + (if (hprimeF.asKnown().isPresent) 1 else 0) + (if (hprimeF1.asKnown().isPresent) 1 else 0) + (if (hprimeF2.asKnown().isPresent) 1 else 0) + (if (hprimefMuf.asKnown().isPresent) 1 else 0) + (if (hprimeP.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (luf.asKnown().isPresent) 1 else 0) + (if (md.asKnown().isPresent) 1 else 0) + (if (mufd.asKnown().isPresent) 1 else 0) + (if (neProfileName.asKnown().isPresent) 1 else 0) + (if (neProfileVersion.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (phase.asKnown().getOrNull()?.validity() ?: 0) + (plasmaFrequency.asKnown().getOrNull()?.size ?: 0) + (plasmaFrequencyUncertainty.asKnown().getOrNull()?.size ?: 0) + (if (platformName.asKnown().isPresent) 1 else 0) + (polarization.asKnown().getOrNull()?.validity() ?: 0) + (power.asKnown().getOrNull()?.validity() ?: 0) + (if (qe.asKnown().isPresent) 1 else 0) + (if (qf.asKnown().isPresent) 1 else 0) + (range.asKnown().getOrNull()?.validity() ?: 0) + (receiveCoordinates.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) + (receiveSensorType.asKnown().getOrNull()?.validity() ?: 0) + (restrictedFrequency.asKnown().getOrNull()?.size ?: 0) + (if (restrictedFrequencyNotes.asKnown().isPresent) 1 else 0) + (if (scaleHeightF2Peak.asKnown().isPresent) 1 else 0) + (scalerInfo.asKnown().getOrNull()?.validity() ?: 0) + (stokes.asKnown().getOrNull()?.validity() ?: 0) + (if (systemNotes.asKnown().isPresent) 1 else 0) + (if (tec.asKnown().isPresent) 1 else 0) + (tidAzimuth.asKnown().getOrNull()?.size ?: 0) + (tidPeriods.asKnown().getOrNull()?.size ?: 0) + (tidPhaseSpeeds.asKnown().getOrNull()?.size ?: 0) + (time.asKnown().getOrNull()?.validity() ?: 0) + (traceGeneric.asKnown().getOrNull()?.validity() ?: 0) + (transmitCoordinates.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) + (transmitSensorType.asKnown().getOrNull()?.validity() ?: 0) + (if (typeEs.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (if (yE.asKnown().isPresent) 1 else 0) + (if (yF1.asKnown().isPresent) 1 else 0) + (if (yF2.asKnown().isPresent) 1 else 0) + (if (zhalfNm.asKnown().isPresent) 1 else 0) + (if (zmE.asKnown().isPresent) 1 else 0)
    ...
    class Amplitude private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") @ExcludeMissing data: JsonField<List<List<List<List<List<List<List<Double>>>>>>>> = JsonMissing.of(),
            @JsonProperty("dimensionName") @ExcludeMissing dimensionName: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("dimensions") @ExcludeMissing dimensions: JsonField<List<Int>> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun data(): Optional<List<List<List<List<List<List<List<Double>>>>>>>> = data.getOptional("data")
         ...
         *
         * Unlike [dimensionName], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            private var data: JsonField<MutableList<List<List<List<List<List<List<Double>>>>>>>>? = null
            ...
            @JvmSynthetic
            internal fun from(amplitude: Amplitude) =
                apply {
            ...
            /** Array of amplitude data. */
            fun data(data: List<List<List<List<List<List<List<Double>>>>>>>) = data(JsonField.of(data))

            /**
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<List<List<List<List<List<List<Double>>>>>>>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun data(data: JsonField<List<List<List<List<List<List<List<Double>>>>>>>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: List<List<List<List<List<List<Double>>>>>>) =
                apply {
            ...
            /** Array of names for dimensions. */
            fun dimensionName(dimensionName: List<String>) = dimensionName(JsonField.of(dimensionName))

            /**
             * Sets [Builder.dimensionName] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dimensionName] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dimensionName(dimensionName: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addDimensionName(dimensionName: String) =
                apply {
                    this.dimensionName = (this.dimensionName ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.dimensions] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dimensions(dimensions: JsonField<List<Int>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addDimension(dimension: Int) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (data.asKnown().getOrNull()?.sumOf { it.sumOf { it.sumOf { it.sumOf { it.sumOf { it.sumOf { it.size.toInt() }.toInt() }.toInt() }.toInt() }.toInt() }.toInt() } ?: 0) + (dimensionName.asKnown().getOrNull()?.size ?: 0) + (dimensions.asKnown().getOrNull()?.size ?: 0) + (if (notes.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Amplitude && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(data, dimensionName, dimensions, notes, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "Amplitude{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }

    class AntennaElementPosition private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") @ExcludeMissing data: JsonField<List<List<Double>>> = JsonMissing.of(),
            @JsonProperty("dimensionName") @ExcludeMissing dimensionName: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("dimensions") @ExcludeMissing dimensions: JsonField<List<Int>> = JsonMissing.of()
        ) : this(
          data,
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<List<Double>>> = data
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(antennaElementPosition: AntennaElementPosition) =
                apply {
             ...
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<List<Double>>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun data(data: JsonField<List<List<Double>>>) =
                apply {
                    this.data = data.map { it.toMutableList() }
                }
        ...
        fun validate(): AntennaElementPosition =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (data.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) + (dimensionName.asKnown().getOrNull()?.size ?: 0) + (dimensions.asKnown().getOrNull()?.size ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is AntennaElementPosition && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(data, dimensionName, dimensions, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "AntennaElementPosition{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, additionalProperties=$additionalProperties}"
    }

    /** Enums: J2000, ECR/ECEF, TEME, GCRF, WGS84 (GEODetic lat, long, alt), GEOCentric (lat, long, radii). */
    class AntennaElementPositionCoordinateSystem @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        companion object {
            ...
            @JvmStatic fun of(value: String) = AntennaElementPositionCoordinateSystem(JsonField.of(value))
        }
        ...
        /**
         * An enum containing [AntennaElementPositionCoordinateSystem]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [AntennaElementPositionCoordinateSystem] can contain an unknown value in a couple of cases:
         *
         * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
         *   an older version than the API, then the API may respond with new members that the SDK is unaware
         *   of.
        ...
        enum class Value {
            ...
            WGS84_GEO_DETIC_LAT_LONG_ALT,
            GEO_CENTRIC_LAT_LONG_RADII,
            /** An enum member indicating that [AntennaElementPositionCoordinateSystem] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw UnifieddatalibraryInvalidDataException("Unknown AntennaElementPositionCoordinateSystem: $value")
            }
        ...
        fun validate(): AntennaElementPositionCoordinateSystem =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is AntennaElementPositionCoordinateSystem && value == other.value /* spotless:on */
        }
    ...
    class Azimuth private constructor(
        private val data: JsonField<List<List<List<List<List<List<List<Double>>>>>>>>,
        private val dimensionName: JsonField<List<String>>,
        private val dimensions: JsonField<List<Int>>,
        private val notes: JsonField<String>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(azimuth: Azimuth) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Azimuth && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Azimuth{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }

    /** Characteristic attributes of a IonoObservation. */
    class CharAtt private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("charName") @ExcludeMissing charName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("climateModelInputParams") @ExcludeMissing climateModelInputParams: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("climateModelName") @ExcludeMissing climateModelName: JsonField<String> = JsonMissing.of(),
            @JsonProperty("climateModelOptions") @ExcludeMissing climateModelOptions: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("d") @ExcludeMissing d: JsonField<String> = JsonMissing.of(),
            @JsonProperty("lowerBound") @ExcludeMissing lowerBound: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("q") @ExcludeMissing q: JsonField<String> = JsonMissing.of(),
            @JsonProperty("uncertaintyBoundType") @ExcludeMissing uncertaintyBoundType: JsonField<String> = JsonMissing.of(),
            @JsonProperty("upperBound") @ExcludeMissing upperBound: JsonField<Double> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun climateModelInputParams(): Optional<List<String>> = climateModelInputParams.getOptional("climateModelInputParams")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun climateModelOptions(): Optional<List<String>> = climateModelOptions.getOptional("climateModelOptions")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun uncertaintyBoundType(): Optional<String> = uncertaintyBoundType.getOptional("uncertaintyBoundType")
        ...
        @ExcludeMissing
        fun _charName(): JsonField<String> = charName

        /**
         * Returns the raw JSON value of [climateModelInputParams].
         *
         * Unlike [climateModelInputParams], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [climateModelName], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [climateModelOptions], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("q")
        @ExcludeMissing
        fun _q(): JsonField<String> = q

        /**
         * Returns the raw JSON value of [uncertaintyBoundType].
         *
         * Unlike [uncertaintyBoundType], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("ursiID")
        @ExcludeMissing
        fun _ursiId(): JsonField<String> = ursiId
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(charAtt: CharAtt) =
                apply {
             ...
             *
             * You should usually call [Builder.charName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun charName(charName: JsonField<String>) =
                apply {
                    this.charName = charName
                }

            /** Input parameters for the climate model. */
            fun climateModelInputParams(climateModelInputParams: List<String>) = climateModelInputParams(JsonField.of(climateModelInputParams))

            /**
             * Sets [Builder.climateModelInputParams] to an arbitrary JSON value.
             *
             * You should usually call [Builder.climateModelInputParams] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun climateModelInputParams(climateModelInputParams: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addClimateModelInputParam(climateModelInputParam: String) =
                apply {
                    climateModelInputParams = (climateModelInputParams ?: JsonField.of(mutableListOf())).also {
                        checkKnown("climateModelInputParams", it).add(climateModelInputParam)
                    }
                }

            /** Name of the climate model. */
            fun climateModelName(climateModelName: String) = climateModelName(JsonField.of(climateModelName))

            /**
             * Sets [Builder.climateModelName] to an arbitrary JSON value.
             *
             * You should usually call [Builder.climateModelName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun climateModelName(climateModelName: JsonField<String>) =
                apply {
                    this.climateModelName = climateModelName
                }

            /** List of options for the climate model. */
            fun climateModelOptions(climateModelOptions: List<String>) = climateModelOptions(JsonField.of(climateModelOptions))

            /**
             * Sets [Builder.climateModelOptions] to an arbitrary JSON value.
             *
             * You should usually call [Builder.climateModelOptions] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun climateModelOptions(climateModelOptions: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addClimateModelOption(climateModelOption: String) =
                apply {
                    climateModelOptions = (climateModelOptions ?: JsonField.of(mutableListOf())).also {
             ...
             * Sets [Builder.d] to an arbitrary JSON value.
             *
             * You should usually call [Builder.d] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun d(d: JsonField<String>) =
                apply {
                    this.d = d
                }
             ...
             *
             * You should usually call [Builder.lowerBound] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lowerBound(lowerBound: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.q] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun q(q: JsonField<String>) =
                apply {
                    this.q = q
                }

            /** Uncertainty Bounds (lower and upper) define an interval around reported value that contains true value at the specified probability level. Probability levels are specified in terms of percentile (from 1 to 100) or the standard deviation, sigma (e.g. 1sigma, 2sigma, 3sigma, 5percentile, 10percentile, 25percentile). */
            fun uncertaintyBoundType(uncertaintyBoundType: String) = uncertaintyBoundType(JsonField.of(uncertaintyBoundType))

            /**
             * Sets [Builder.uncertaintyBoundType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.uncertaintyBoundType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun uncertaintyBoundType(uncertaintyBoundType: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.upperBound] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun upperBound(upperBound: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.ursiId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun ursiId(ursiId: JsonField<String>) =
                apply {
                    this.ursiId = ursiId
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (charName.asKnown().isPresent) 1 else 0) + (climateModelInputParams.asKnown().getOrNull()?.size ?: 0) + (if (climateModelName.asKnown().isPresent) 1 else 0) + (climateModelOptions.asKnown().getOrNull()?.size ?: 0) + (if (d.asKnown().isPresent) 1 else 0) + (if (lowerBound.asKnown().isPresent) 1 else 0) + (if (q.asKnown().isPresent) 1 else 0) + (if (uncertaintyBoundType.asKnown().isPresent) 1 else 0) + (if (upperBound.asKnown().isPresent) 1 else 0) + (if (ursiId.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is CharAtt && charName == other.charName && climateModelInputParams == other.climateModelInputParams && climateModelName == other.climateModelName && climateModelOptions == other.climateModelOptions && d == other.d && lowerBound == other.lowerBound && q == other.q && uncertaintyBoundType == other.uncertaintyBoundType && upperBound == other.upperBound && ursiId == other.ursiId && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(charName, climateModelInputParams, climateModelName, climateModelOptions, d, lowerBound, q, uncertaintyBoundType, upperBound, ursiId, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "CharAtt{charName=$charName, climateModelInputParams=$climateModelInputParams, climateModelName=$climateModelName, climateModelOptions=$climateModelOptions, d=$d, lowerBound=$lowerBound, q=$q, uncertaintyBoundType=$uncertaintyBoundType, upperBound=$upperBound, ursiId=$ursiId, additionalProperties=$additionalProperties}"
    }

    class Datum private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<Double>> = data
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun data(data: JsonField<List<Double>>) =
                apply {
                    this.data = data.map { it.toMutableList() }
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (data.asKnown().getOrNull()?.size ?: 0) + (if (notes.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Datum && data == other.data && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Datum{data=$data, notes=$notes, additionalProperties=$additionalProperties}"
    }

    /** Profile of electron densities in the ionosphere associated with an IonoObservation. */
    class DensityProfile private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("parabolic") @ExcludeMissing parabolic: JsonField<Parabolic> = JsonMissing.of(),
            @JsonProperty("quasiParabolic") @ExcludeMissing quasiParabolic: JsonField<QuasiParabolic> = JsonMissing.of(),
            @JsonProperty("shiftedChebyshev") @ExcludeMissing shiftedChebyshev: JsonField<ShiftedChebyshev> = JsonMissing.of(),
            @JsonProperty("topsideExtensionChapmanConst") @ExcludeMissing topsideExtensionChapmanConst: JsonField<TopsideExtensionChapmanConst> = JsonMissing.of(),
            @JsonProperty("topsideExtensionVaryChap") @ExcludeMissing topsideExtensionVaryChap: JsonField<TopsideExtensionVaryChap> = JsonMissing.of(),
            @JsonProperty("valleyModelCoeffs") @ExcludeMissing valleyModelCoeffs: JsonField<List<Double>> = JsonMissing.of(),
            @JsonProperty("valleyModelDescription") @ExcludeMissing valleyModelDescription: JsonField<String> = JsonMissing.of()
        ) : this(
          iri,
          parabolic,
          quasiParabolic,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun quasiParabolic(): Optional<QuasiParabolic> = quasiParabolic.getOptional("quasiParabolic")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun shiftedChebyshev(): Optional<ShiftedChebyshev> = shiftedChebyshev.getOptional("shiftedChebyshev")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun topsideExtensionChapmanConst(): Optional<TopsideExtensionChapmanConst> = topsideExtensionChapmanConst.getOptional("topsideExtensionChapmanConst")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun topsideExtensionVaryChap(): Optional<TopsideExtensionVaryChap> = topsideExtensionVaryChap.getOptional("topsideExtensionVaryChap")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun valleyModelCoeffs(): Optional<List<Double>> = valleyModelCoeffs.getOptional("valleyModelCoeffs")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun valleyModelDescription(): Optional<String> = valleyModelDescription.getOptional("valleyModelDescription")
         ...
         *
         * Unlike [quasiParabolic], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [shiftedChebyshev], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [topsideExtensionChapmanConst], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("topsideExtensionChapmanConst")
        @ExcludeMissing
        fun _topsideExtensionChapmanConst(): JsonField<TopsideExtensionChapmanConst> = topsideExtensionChapmanConst

        /**
         * Returns the raw JSON value of [topsideExtensionVaryChap].
         *
         * Unlike [topsideExtensionVaryChap], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("topsideExtensionVaryChap")
        @ExcludeMissing
        fun _topsideExtensionVaryChap(): JsonField<TopsideExtensionVaryChap> = topsideExtensionVaryChap

        /**
         * Returns the raw JSON value of [valleyModelCoeffs].
         *
         * Unlike [valleyModelCoeffs], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [valleyModelDescription], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            private var topsideExtensionChapmanConst: JsonField<TopsideExtensionChapmanConst> = JsonMissing.of()
            private var topsideExtensionVaryChap: JsonField<TopsideExtensionVaryChap> = JsonMissing.of()
            ...
            @JvmSynthetic
            internal fun from(densityProfile: DensityProfile) =
                apply {
             ...
             *
             * You should usually call [Builder.iri] with a well-typed [Iri] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun iri(iri: JsonField<Iri>) =
                apply {
                    this.iri = iri
                }
             ...
             *
             * You should usually call [Builder.parabolic] with a well-typed [Parabolic] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun parabolic(parabolic: JsonField<Parabolic>) =
                apply {
                    this.parabolic = parabolic
                }

            /** Coefficients to describe profile shape as quasi-parabolic segments. */
            fun quasiParabolic(quasiParabolic: QuasiParabolic) = quasiParabolic(JsonField.of(quasiParabolic))

            /**
             * Sets [Builder.quasiParabolic] to an arbitrary JSON value.
             *
             * You should usually call [Builder.quasiParabolic] with a well-typed [QuasiParabolic] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun quasiParabolic(quasiParabolic: JsonField<QuasiParabolic>) =
                apply {
                    this.quasiParabolic = quasiParabolic
                }

            /** Coefficients to describe either the E, F1, and bottomside F2 profile shapes or the height uncertainty boundaries. */
            fun shiftedChebyshev(shiftedChebyshev: ShiftedChebyshev) = shiftedChebyshev(JsonField.of(shiftedChebyshev))

            /**
             * Sets [Builder.shiftedChebyshev] to an arbitrary JSON value.
             *
             * You should usually call [Builder.shiftedChebyshev] with a well-typed [ShiftedChebyshev] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun shiftedChebyshev(shiftedChebyshev: JsonField<ShiftedChebyshev>) =
                apply {
                    this.shiftedChebyshev = shiftedChebyshev
                }

            /** Parameters of the constant-scale-height Chapman layer. */
            fun topsideExtensionChapmanConst(topsideExtensionChapmanConst: TopsideExtensionChapmanConst) = topsideExtensionChapmanConst(JsonField.of(topsideExtensionChapmanConst))

            /**
             * Sets [Builder.topsideExtensionChapmanConst] to an arbitrary JSON value.
             *
             * You should usually call [Builder.topsideExtensionChapmanConst] with a well-typed [TopsideExtensionChapmanConst] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun topsideExtensionChapmanConst(topsideExtensionChapmanConst: JsonField<TopsideExtensionChapmanConst>) =
                apply {
                    this.topsideExtensionChapmanConst = topsideExtensionChapmanConst
                }

            /** Varying scale height Chapman topside layer. */
            fun topsideExtensionVaryChap(topsideExtensionVaryChap: TopsideExtensionVaryChap) = topsideExtensionVaryChap(JsonField.of(topsideExtensionVaryChap))

            /**
             * Sets [Builder.topsideExtensionVaryChap] to an arbitrary JSON value.
             *
             * You should usually call [Builder.topsideExtensionVaryChap] with a well-typed [TopsideExtensionVaryChap] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun topsideExtensionVaryChap(topsideExtensionVaryChap: JsonField<TopsideExtensionVaryChap>) =
                apply {
                    this.topsideExtensionVaryChap = topsideExtensionVaryChap
                }

            /** Array of valley model coefficients. */
            fun valleyModelCoeffs(valleyModelCoeffs: List<Double>) = valleyModelCoeffs(JsonField.of(valleyModelCoeffs))

            /**
             * Sets [Builder.valleyModelCoeffs] to an arbitrary JSON value.
             *
             * You should usually call [Builder.valleyModelCoeffs] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun valleyModelCoeffs(valleyModelCoeffs: JsonField<List<Double>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addValleyModelCoeff(valleyModelCoeff: Double) =
                apply {
                    valleyModelCoeffs = (valleyModelCoeffs ?: JsonField.of(mutableListOf())).also {
                        checkKnown("valleyModelCoeffs", it).add(valleyModelCoeff)
                    }
                }

            /** Description of the valley model and parameters. */
            fun valleyModelDescription(valleyModelDescription: String) = valleyModelDescription(JsonField.of(valleyModelDescription))

            /**
             * Sets [Builder.valleyModelDescription] to an arbitrary JSON value.
             *
             * You should usually call [Builder.valleyModelDescription] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun valleyModelDescription(valleyModelDescription: JsonField<String>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (iri.asKnown().getOrNull()?.validity() ?: 0) + (parabolic.asKnown().getOrNull()?.validity() ?: 0) + (quasiParabolic.asKnown().getOrNull()?.validity() ?: 0) + (shiftedChebyshev.asKnown().getOrNull()?.validity() ?: 0) + (topsideExtensionChapmanConst.asKnown().getOrNull()?.validity() ?: 0) + (topsideExtensionVaryChap.asKnown().getOrNull()?.validity() ?: 0) + (valleyModelCoeffs.asKnown().getOrNull()?.size ?: 0) + (if (valleyModelDescription.asKnown().isPresent) 1 else 0)

        /** Full set of the IRI formalism coefficients. */
        class Iri private constructor(
            private val b0: JsonField<Double>,
            private val b1: JsonField<Double>,
            ...
            private constructor(
                ...
                @JsonProperty("hmF1") @ExcludeMissing hmF1: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("hmF2") @ExcludeMissing hmF2: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("hValTop") @ExcludeMissing hValTop: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("fp30")
            @ExcludeMissing
            fun _fp30(): JsonField<Double> = fp30
            ...
            @JsonProperty("fp3U")
            @ExcludeMissing
            fun _fp3U(): JsonField<Double> = fp3U
            ...
            @ExcludeMissing
            fun _hValTop(): JsonField<Double> = hValTop
            ...
            @JsonProperty("nmF1")
            @ExcludeMissing
            fun _nmF1(): JsonField<Double> = nmF1
            ...
            @JsonProperty("nmF2")
            @ExcludeMissing
            fun _nmF2(): JsonField<Double> = nmF2
            ...
            @JsonProperty("nValB")
            @ExcludeMissing
            fun _nValB(): JsonField<Double> = nValB
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.chi] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun chi(chi: JsonField<Double>) =
                    apply {
                        this.chi = chi
                    }
                 ...
                 *
                 * You should usually call [Builder.fp1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fp1(fp1: JsonField<Double>) =
                    apply {
                        this.fp1 = fp1
                    }
                 ...
                 *
                 * You should usually call [Builder.fp2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fp2(fp2: JsonField<Double>) =
                    apply {
                        this.fp2 = fp2
                    }
                 ...
                 *
                 * You should usually call [Builder.fp30] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fp30(fp30: JsonField<Double>) =
                    apply {
                        this.fp30 = fp30
                    }
                 ...
                 *
                 * You should usually call [Builder.fp3U] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fp3U(fp3U: JsonField<Double>) =
                    apply {
                        this.fp3U = fp3U
                    }
                 ...
                 *
                 * You should usually call [Builder.ha] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun ha(ha: JsonField<Double>) =
                    apply {
                        this.ha = ha
                    }
                 ...
                 *
                 * You should usually call [Builder.hdx] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun hdx(hdx: JsonField<Double>) =
                    apply {
                        this.hdx = hdx
                    }
                 ...
                 *
                 * You should usually call [Builder.hmD] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun hmD(hmD: JsonField<Double>) =
                    apply {
                        this.hmD = hmD
                    }
                 ...
                 *
                 * You should usually call [Builder.hValTop] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun hValTop(hValTop: JsonField<Double>) =
                    apply {
                        this.hValTop = hValTop
                    }
                 ...
                 *
                 * You should usually call [Builder.hz] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun hz(hz: JsonField<Double>) =
                    apply {
                        this.hz = hz
                    }
                 ...
                 *
                 * You should usually call [Builder.nmD] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun nmD(nmD: JsonField<Double>) =
                    apply {
                        this.nmD = nmD
                    }
                 ...
                 *
                 * You should usually call [Builder.nmE] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun nmE(nmE: JsonField<Double>) =
                    apply {
                        this.nmE = nmE
                    }
                 ...
                 *
                 * You should usually call [Builder.nmF1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun nmF1(nmF1: JsonField<Double>) =
                    apply {
                        this.nmF1 = nmF1
                    }
                 ...
                 *
                 * You should usually call [Builder.nmF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun nmF2(nmF2: JsonField<Double>) =
                    apply {
                        this.nmF2 = nmF2
                    }
                 ...
                 *
                 * You should usually call [Builder.nValB] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun nValB(nValB: JsonField<Double>) =
                    apply {
                        this.nValB = nValB
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (b0.asKnown().isPresent) 1 else 0) + (if (b1.asKnown().isPresent) 1 else 0) + (if (chi.asKnown().isPresent) 1 else 0) + (if (d1.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (fp1.asKnown().isPresent) 1 else 0) + (if (fp2.asKnown().isPresent) 1 else 0) + (if (fp30.asKnown().isPresent) 1 else 0) + (if (fp3U.asKnown().isPresent) 1 else 0) + (if (ha.asKnown().isPresent) 1 else 0) + (if (hdx.asKnown().isPresent) 1 else 0) + (if (hmD.asKnown().isPresent) 1 else 0) + (if (hmE.asKnown().isPresent) 1 else 0) + (if (hmF1.asKnown().isPresent) 1 else 0) + (if (hmF2.asKnown().isPresent) 1 else 0) + (if (hValTop.asKnown().isPresent) 1 else 0) + (if (hz.asKnown().isPresent) 1 else 0) + (if (nmD.asKnown().isPresent) 1 else 0) + (if (nmE.asKnown().isPresent) 1 else 0) + (if (nmF1.asKnown().isPresent) 1 else 0) + (if (nmF2.asKnown().isPresent) 1 else 0) + (if (nValB.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return /* spotless:off */ other is Iri && b0 == other.b0 && b1 == other.b1 && chi == other.chi && d1 == other.d1 && description == other.description && fp1 == other.fp1 && fp2 == other.fp2 && fp30 == other.fp30 && fp3U == other.fp3U && ha == other.ha && hdx == other.hdx && hmD == other.hmD && hmE == other.hmE && hmF1 == other.hmF1 && hmF2 == other.hmF2 && hValTop == other.hValTop && hz == other.hz && nmD == other.nmD && nmE == other.nmE && nmF1 == other.nmF1 && nmF2 == other.nmF2 && nValB == other.nValB && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(b0, b1, chi, d1, description, fp1, fp2, fp30, fp3U, ha, hdx, hmD, hmE, hmF1, hmF2, hValTop, hz, nmD, nmE, nmF1, nmF2, nValB, additionalProperties) }
            /* spotless:on */

            override fun hashCode(): Int = hashCode

            override fun toString() = "Iri{b0=$b0, b1=$b1, chi=$chi, d1=$d1, description=$description, fp1=$fp1, fp2=$fp2, fp30=$fp30, fp3U=$fp3U, ha=$ha, hdx=$hdx, hmD=$hmD, hmE=$hmE, hmF1=$hmF1, hmF2=$hmF2, hValTop=$hValTop, hz=$hz, nmD=$nmD, nmE=$nmE, nmF1=$nmF1, nmF2=$nmF2, nValB=$nValB, additionalProperties=$additionalProperties}"
        }

        /** Coefficients to describe the E, F1, and F2 layers as parabolic-shape segments. */
        class Parabolic private constructor(
            private val description: JsonField<String>,
            ...
            private constructor(
                @JsonProperty("description") @ExcludeMissing description: JsonField<String> = JsonMissing.of(),
                @JsonProperty("parabolicItems") @ExcludeMissing parabolicItems: JsonField<List<ParabolicItem>> = JsonMissing.of()
            ) : this(
              description,
              parabolicItems,
              mutableMapOf(),
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun parabolicItems(): Optional<List<ParabolicItem>> = parabolicItems.getOptional("parabolicItems")
             ...
             *
             * Unlike [parabolicItems], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(parabolic: Parabolic) =
                    apply {
                ...
                /** Describes the E, F1, and F2 layers as parabolic-shape segments. */
                fun parabolicItems(parabolicItems: List<ParabolicItem>) = parabolicItems(JsonField.of(parabolicItems))

                /**
                 * Sets [Builder.parabolicItems] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.parabolicItems] with a well-typed `List<ParabolicItem>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun parabolicItems(parabolicItems: JsonField<List<ParabolicItem>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addParabolicItem(parabolicItem: ParabolicItem) =
                    apply {
                        parabolicItems = (parabolicItems ?: JsonField.of(mutableListOf())).also {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (description.asKnown().isPresent) 1 else 0) + (parabolicItems.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)

            /** Describes the E, F1, and F2 layers as parabolic-shape segments. */
            class ParabolicItem private constructor(
                ...
                @JsonProperty("layer")
                @ExcludeMissing
                fun _layer(): JsonField<String> = layer
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(parabolicItem: ParabolicItem) =
                        apply {
                            f = parabolicItem.f
                     ...
                     *
                     * You should usually call [Builder.f] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun f(f: JsonField<Double>) =
                        apply {
                            this.f = f
                        }
                     ...
                     *
                     * You should usually call [Builder.layer] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun layer(layer: JsonField<String>) =
                        apply {
                            this.layer = layer
                        }
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (f.asKnown().isPresent) 1 else 0) + (if (layer.asKnown().isPresent) 1 else 0) + (if (y.asKnown().isPresent) 1 else 0) + (if (z.asKnown().isPresent) 1 else 0)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return /* spotless:off */ other is ParabolicItem && f == other.f && layer == other.layer && y == other.y && z == other.z && additionalProperties == other.additionalProperties /* spotless:on */
                }

                /* spotless:off */
                private val hashCode: Int by lazy { Objects.hash(f, layer, y, z, additionalProperties) }
                /* spotless:on */

                override fun hashCode(): Int = hashCode

                override fun toString() = "ParabolicItem{f=$f, layer=$layer, y=$y, z=$z, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return /* spotless:off */ other is Parabolic && description == other.description && parabolicItems == other.parabolicItems && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(description, parabolicItems, additionalProperties) }
            /* spotless:on */

            override fun hashCode(): Int = hashCode

            override fun toString() = "Parabolic{description=$description, parabolicItems=$parabolicItems, additionalProperties=$additionalProperties}"
        }

        /** Coefficients to describe profile shape as quasi-parabolic segments. */
        class QuasiParabolic private constructor(
            private val description: JsonField<String>,
            ...
            private constructor(
                @JsonProperty("description") @ExcludeMissing description: JsonField<String> = JsonMissing.of(),
                @JsonProperty("earthRadius") @ExcludeMissing earthRadius: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("quasiParabolicSegments") @ExcludeMissing quasiParabolicSegments: JsonField<List<QuasiParabolicSegment>> = JsonMissing.of()
            ) : this(
              description,
              earthRadius,
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun quasiParabolicSegments(): Optional<List<QuasiParabolicSegment>> = quasiParabolicSegments.getOptional("quasiParabolicSegments")
             ...
             *
             * Unlike [earthRadius], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [quasiParabolicSegments], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("quasiParabolicSegments")
            @ExcludeMissing
            fun _quasiParabolicSegments(): JsonField<List<QuasiParabolicSegment>> = quasiParabolicSegments
            ...
            class Builder internal constructor() {
                ...
                private var quasiParabolicSegments: JsonField<MutableList<QuasiParabolicSegment>>? = null
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                @JvmSynthetic
                internal fun from(quasiParabolic: QuasiParabolic) =
                    apply {
                        description = quasiParabolic.description
                        earthRadius = quasiParabolic.earthRadius
                        quasiParabolicSegments = quasiParabolic.quasiParabolicSegments.map { it.toMutableList() }
                 ...
                 *
                 * You should usually call [Builder.earthRadius] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun earthRadius(earthRadius: JsonField<Double>) =
                    apply {
                        this.earthRadius = earthRadius
                    }

                /** Array of quasi-parabolic segments. Each segment is the best-fit 3-parameter quasi-parabolas defined via A, B, C coefficients, f^2=A/r^2+B/r+C”. Usually 3 groups for E, F1, and F2 layers, but additional segments may be used to improve accuracy. */
                fun quasiParabolicSegments(quasiParabolicSegments: List<QuasiParabolicSegment>) = quasiParabolicSegments(JsonField.of(quasiParabolicSegments))

                /**
                 * Sets [Builder.quasiParabolicSegments] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.quasiParabolicSegments] with a well-typed `List<QuasiParabolicSegment>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun quasiParabolicSegments(quasiParabolicSegments: JsonField<List<QuasiParabolicSegment>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addQuasiParabolicSegment(quasiParabolicSegment: QuasiParabolicSegment) =
                    apply {
                        quasiParabolicSegments = (quasiParabolicSegments ?: JsonField.of(mutableListOf())).also {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (description.asKnown().isPresent) 1 else 0) + (if (earthRadius.asKnown().isPresent) 1 else 0) + (quasiParabolicSegments.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
            ...
            class QuasiParabolicSegment private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("error") @ExcludeMissing error: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("error")
                @ExcludeMissing
                fun _error(): JsonField<Double> = error
                ...
                companion object {
                    ...
                    /** Returns a mutable builder for constructing an instance of [QuasiParabolicSegment]. */
                    @JvmStatic
                    fun builder() = Builder()
                }
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(quasiParabolicSegment: QuasiParabolicSegment) =
                        apply {
                            ...
                            additionalProperties = quasiParabolicSegment.additionalProperties.toMutableMap()
                        }
                     ...
                     *
                     * You should usually call [Builder.a] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun a(a: JsonField<Double>) =
                        apply {
                            this.a = a
                        }
                     ...
                     *
                     * You should usually call [Builder.b] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun b(b: JsonField<Double>) =
                        apply {
                            this.b = b
                        }
                     ...
                     *
                     * You should usually call [Builder.c] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun c(c: JsonField<Double>) =
                        apply {
                            this.c = c
                        }
                     ...
                     *
                     * You should usually call [Builder.error] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun error(error: JsonField<Double>) =
                        apply {
                            this.error = error
                        }
                     ...
                     *
                     * You should usually call [Builder.rb] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun rb(rb: JsonField<Double>) =
                        apply {
                            this.rb = rb
                        }
                     ...
                     *
                     * You should usually call [Builder.re] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun re(re: JsonField<Double>) =
                        apply {
                            this.re = re
                        }
                ...
                fun validate(): QuasiParabolicSegment =
                    apply {
                        if (validated) {
                          return@apply
                        }
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (a.asKnown().isPresent) 1 else 0) + (if (b.asKnown().isPresent) 1 else 0) + (if (c.asKnown().isPresent) 1 else 0) + (if (error.asKnown().isPresent) 1 else 0) + (if (index.asKnown().isPresent) 1 else 0) + (if (rb.asKnown().isPresent) 1 else 0) + (if (re.asKnown().isPresent) 1 else 0)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return /* spotless:off */ other is QuasiParabolicSegment && a == other.a && b == other.b && c == other.c && error == other.error && index == other.index && rb == other.rb && re == other.re && additionalProperties == other.additionalProperties /* spotless:on */
                }

                /* spotless:off */
                private val hashCode: Int by lazy { Objects.hash(a, b, c, error, index, rb, re, additionalProperties) }
                /* spotless:on */

                override fun hashCode(): Int = hashCode

                override fun toString() = "QuasiParabolicSegment{a=$a, b=$b, c=$c, error=$error, index=$index, rb=$rb, re=$re, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return /* spotless:off */ other is QuasiParabolic && description == other.description && earthRadius == other.earthRadius && quasiParabolicSegments == other.quasiParabolicSegments && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(description, earthRadius, quasiParabolicSegments, additionalProperties) }
            /* spotless:on */

            override fun hashCode(): Int = hashCode

            override fun toString() = "QuasiParabolic{description=$description, earthRadius=$earthRadius, quasiParabolicSegments=$quasiParabolicSegments, additionalProperties=$additionalProperties}"
        }

        /** Coefficients to describe either the E, F1, and bottomside F2 profile shapes or the height uncertainty boundaries. */
        class ShiftedChebyshev private constructor(
            private val description: JsonField<String>,
            ...
            private constructor(
                @JsonProperty("description") @ExcludeMissing description: JsonField<String> = JsonMissing.of(),
                @JsonProperty("shiftedChebyshevs") @ExcludeMissing shiftedChebyshevs: JsonField<List<InnerShiftedChebyshev>> = JsonMissing.of()
            ) : this(
              description,
              shiftedChebyshevs,
              mutableMapOf(),
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun shiftedChebyshevs(): Optional<List<InnerShiftedChebyshev>> = shiftedChebyshevs.getOptional("shiftedChebyshevs")
             ...
             *
             * Unlike [shiftedChebyshevs], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(shiftedChebyshev: ShiftedChebyshev) =
                    apply {
                        description = shiftedChebyshev.description
                        shiftedChebyshevs = shiftedChebyshev.shiftedChebyshevs.map { it.toMutableList() }
                ...
                /** Up to 3 groups of coefficients, using “shiftedChebyshev” sub-field, to describe E, F1, and bottomside F2 profile shapes, or up to 6 groups of coefficients to describe height uncertainty boundaries (upper and lower). */
                fun shiftedChebyshevs(shiftedChebyshevs: List<InnerShiftedChebyshev>) = shiftedChebyshevs(JsonField.of(shiftedChebyshevs))

                /**
                 * Sets [Builder.shiftedChebyshevs] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.shiftedChebyshevs] with a well-typed `List<InnerShiftedChebyshev>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addShiftedChebyshev(shiftedChebyshev: InnerShiftedChebyshev) =
                    apply {
                        shiftedChebyshevs = (shiftedChebyshevs ?: JsonField.of(mutableListOf())).also {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (description.asKnown().isPresent) 1 else 0) + (shiftedChebyshevs.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
            ...
            class InnerShiftedChebyshev private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("coeffs") @ExcludeMissing coeffs: JsonField<List<Double>> = JsonMissing.of(),
                    @JsonProperty("error") @ExcludeMissing error: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("fstart") @ExcludeMissing fstart: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("fstop") @ExcludeMissing fstop: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("layer") @ExcludeMissing layer: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("n") @ExcludeMissing n: JsonField<Int> = JsonMissing.of(),
                    @JsonProperty("peakheight") @ExcludeMissing peakheight: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("zhalfNm") @ExcludeMissing zhalfNm: JsonField<Double> = JsonMissing.of()
                ) : this(
                  coeffs,
                  error,
                 ...
                 *
                 * Unlike [coeffs], this method doesn't throw if the JSON field has an unexpected type.
                 */
                @JsonProperty("coeffs")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [fstart], this method doesn't throw if the JSON field has an unexpected type.
                 */
                @JsonProperty("fstart")
                @ExcludeMissing
                fun _fstart(): JsonField<Double> = fstart

                /**
                 * Returns the raw JSON value of [fstop].
                 *
                 * Unlike [fstop], this method doesn't throw if the JSON field has an unexpected type.
                 */
                @JsonProperty("fstop")
                @ExcludeMissing
                fun _fstop(): JsonField<Double> = fstop
                ...
                @JsonProperty("n")
                @ExcludeMissing
                fun _n(): JsonField<Int> = n

                /**
                 * Returns the raw JSON value of [peakheight].
                 *
                 * Unlike [peakheight], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                companion object {
                    ...
                    /** Returns a mutable builder for constructing an instance of [InnerShiftedChebyshev]. */
                    @JvmStatic
                    fun builder() = Builder()
                }
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(innerShiftedChebyshev: InnerShiftedChebyshev) =
                        apply {
                            ...
                            additionalProperties = innerShiftedChebyshev.additionalProperties.toMutableMap()
                        }
                     ...
                     *
                     * You should usually call [Builder.coeffs] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun coeffs(coeffs: JsonField<List<Double>>) =
                        apply {
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addCoeff(coeff: Double) =
                        apply {
                            coeffs = (coeffs ?: JsonField.of(mutableListOf())).also {
                     ...
                     *
                     * You should usually call [Builder.fstart] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun fstart(fstart: JsonField<Double>) =
                        apply {
                            this.fstart = fstart
                        }
                     ...
                     *
                     * You should usually call [Builder.fstop] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun fstop(fstop: JsonField<Double>) =
                        apply {
                            this.fstop = fstop
                        }
                     ...
                     *
                     * You should usually call [Builder.n] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun n(n: JsonField<Int>) =
                        apply {
                            this.n = n
                        }
                     ...
                     *
                     * You should usually call [Builder.peakheight] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun peakheight(peakheight: JsonField<Double>) =
                        apply {
                ...
                fun validate(): InnerShiftedChebyshev =
                    apply {
                        if (validated) {
                          return@apply
                        }
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (coeffs.asKnown().getOrNull()?.size ?: 0) + (if (error.asKnown().isPresent) 1 else 0) + (if (fstart.asKnown().isPresent) 1 else 0) + (if (fstop.asKnown().isPresent) 1 else 0) + (if (layer.asKnown().isPresent) 1 else 0) + (if (n.asKnown().isPresent) 1 else 0) + (if (peakheight.asKnown().isPresent) 1 else 0) + (if (zhalfNm.asKnown().isPresent) 1 else 0)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return /* spotless:off */ other is InnerShiftedChebyshev && coeffs == other.coeffs && error == other.error && fstart == other.fstart && fstop == other.fstop && layer == other.layer && n == other.n && peakheight == other.peakheight && zhalfNm == other.zhalfNm && additionalProperties == other.additionalProperties /* spotless:on */
                }

                /* spotless:off */
                private val hashCode: Int by lazy { Objects.hash(coeffs, error, fstart, fstop, layer, n, peakheight, zhalfNm, additionalProperties) }
                /* spotless:on */

                override fun hashCode(): Int = hashCode

                override fun toString() = "InnerShiftedChebyshev{coeffs=$coeffs, error=$error, fstart=$fstart, fstop=$fstop, layer=$layer, n=$n, peakheight=$peakheight, zhalfNm=$zhalfNm, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return /* spotless:off */ other is ShiftedChebyshev && description == other.description && shiftedChebyshevs == other.shiftedChebyshevs && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(description, shiftedChebyshevs, additionalProperties) }
            /* spotless:on */

            override fun hashCode(): Int = hashCode

            override fun toString() = "ShiftedChebyshev{description=$description, shiftedChebyshevs=$shiftedChebyshevs, additionalProperties=$additionalProperties}"
        }

        /** Parameters of the constant-scale-height Chapman layer. */
        class TopsideExtensionChapmanConst private constructor(
            private val chi: JsonField<Double>,
            private val description: JsonField<String>,
            private val hmF2: JsonField<Double>,
            private val nmF2: JsonField<Double>,
            ...
            private constructor(
                ...
                @JsonProperty("hmF2") @ExcludeMissing hmF2: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("nmF2") @ExcludeMissing nmF2: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("scaleF2") @ExcludeMissing scaleF2: JsonField<Double> = JsonMissing.of()
            ) : this(
              chi,
              description,
              hmF2,
            ...
            @ExcludeMissing
            fun _scaleF2(): JsonField<Double> = scaleF2
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [TopsideExtensionChapmanConst]. */
                @JvmStatic
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(topsideExtensionChapmanConst: TopsideExtensionChapmanConst) =
                    apply {
                        ...
                        additionalProperties = topsideExtensionChapmanConst.additionalProperties.toMutableMap()
                    }
                 ...
                 *
                 * You should usually call [Builder.scaleF2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun scaleF2(scaleF2: JsonField<Double>) =
                    apply {
                        this.scaleF2 = scaleF2
                    }
            ...
            fun validate(): TopsideExtensionChapmanConst =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (chi.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (hmF2.asKnown().isPresent) 1 else 0) + (if (nmF2.asKnown().isPresent) 1 else 0) + (if (scaleF2.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return /* spotless:off */ other is TopsideExtensionChapmanConst && chi == other.chi && description == other.description && hmF2 == other.hmF2 && nmF2 == other.nmF2 && scaleF2 == other.scaleF2 && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(chi, description, hmF2, nmF2, scaleF2, additionalProperties) }
            /* spotless:on */

            override fun hashCode(): Int = hashCode

            override fun toString() = "TopsideExtensionChapmanConst{chi=$chi, description=$description, hmF2=$hmF2, nmF2=$nmF2, scaleF2=$scaleF2, additionalProperties=$additionalProperties}"
        }

        /** Varying scale height Chapman topside layer. */
        class TopsideExtensionVaryChap private constructor(
            ...
            @JsonProperty("alpha")
            @ExcludeMissing
            fun _alpha(): JsonField<Double> = alpha
            ...
            @JsonProperty("beta")
            @ExcludeMissing
            fun _beta(): JsonField<Double> = beta
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [TopsideExtensionVaryChap]. */
                @JvmStatic
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(topsideExtensionVaryChap: TopsideExtensionVaryChap) =
                    apply {
                        ...
                        additionalProperties = topsideExtensionVaryChap.additionalProperties.toMutableMap()
                    }
                 ...
                 *
                 * You should usually call [Builder.alpha] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun alpha(alpha: JsonField<Double>) =
                    apply {
                        this.alpha = alpha
                    }
                 ...
                 *
                 * You should usually call [Builder.beta] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun beta(beta: JsonField<Double>) =
                    apply {
                        this.beta = beta
                    }
                 ...
                 *
                 * You should usually call [Builder.ht] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun ht(ht: JsonField<Double>) =
                    apply {
                        this.ht = ht
                    }
            ...
            fun validate(): TopsideExtensionVaryChap =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (alpha.asKnown().isPresent) 1 else 0) + (if (beta.asKnown().isPresent) 1 else 0) + (if (chi.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (hmF2.asKnown().isPresent) 1 else 0) + (if (ht.asKnown().isPresent) 1 else 0) + (if (nmF2.asKnown().isPresent) 1 else 0) + (if (scaleF2.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return /* spotless:off */ other is TopsideExtensionVaryChap && alpha == other.alpha && beta == other.beta && chi == other.chi && description == other.description && hmF2 == other.hmF2 && ht == other.ht && nmF2 == other.nmF2 && scaleF2 == other.scaleF2 && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(alpha, beta, chi, description, hmF2, ht, nmF2, scaleF2, additionalProperties) }
            /* spotless:on */

            override fun hashCode(): Int = hashCode

            override fun toString() = "TopsideExtensionVaryChap{alpha=$alpha, beta=$beta, chi=$chi, description=$description, hmF2=$hmF2, ht=$ht, nmF2=$nmF2, scaleF2=$scaleF2, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is DensityProfile && iri == other.iri && parabolic == other.parabolic && quasiParabolic == other.quasiParabolic && shiftedChebyshev == other.shiftedChebyshev && topsideExtensionChapmanConst == other.topsideExtensionChapmanConst && topsideExtensionVaryChap == other.topsideExtensionVaryChap && valleyModelCoeffs == other.valleyModelCoeffs && valleyModelDescription == other.valleyModelDescription && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(iri, parabolic, quasiParabolic, shiftedChebyshev, topsideExtensionChapmanConst, topsideExtensionVaryChap, valleyModelCoeffs, valleyModelDescription, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "DensityProfile{iri=$iri, parabolic=$parabolic, quasiParabolic=$quasiParabolic, shiftedChebyshev=$shiftedChebyshev, topsideExtensionChapmanConst=$topsideExtensionChapmanConst, topsideExtensionVaryChap=$topsideExtensionVaryChap, valleyModelCoeffs=$valleyModelCoeffs, valleyModelDescription=$valleyModelDescription, additionalProperties=$additionalProperties}"
    }

    class Doppler private constructor(
        private val data: JsonField<List<List<List<List<List<List<List<Double>>>>>>>>,
        private val dimensionName: JsonField<List<String>>,
        private val dimensions: JsonField<List<Int>>,
        private val notes: JsonField<String>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(doppler: Doppler) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Doppler && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Doppler{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }
    ...
    class Elevation private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(elevation: Elevation) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Elevation && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Elevation{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }
    ...
    class Frequency private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(frequency: Frequency) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Frequency && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Frequency{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }
    ...
    class Phase private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Phase && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Phase{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }

    class Polarization private constructor(
        private val data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>>,
        private val dimensionName: JsonField<List<String>>,
        private val dimensions: JsonField<List<Int>>,
        private val notes: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") @ExcludeMissing data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>> = JsonMissing.of(),
            @JsonProperty("dimensionName") @ExcludeMissing dimensionName: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("dimensions") @ExcludeMissing dimensions: JsonField<List<Int>> = JsonMissing.of(),
            @JsonProperty("notes") @ExcludeMissing notes: JsonField<String> = JsonMissing.of()
        ) : this(
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun data(): Optional<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>> = data.getOptional("data")
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>> = data
        ...
        class Builder internal constructor() {
            ...
            private var data: JsonField<MutableList<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>>? = null
            private var dimensionName: JsonField<MutableList<String>>? = null
            private var dimensions: JsonField<MutableList<Int>>? = null
            private var notes: JsonField<String> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            @JvmSynthetic
            internal fun from(polarization: Polarization) =
                apply {
            ...
            /** Array of polarization data. */
            fun data(data: List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>) = data(JsonField.of(data))

            /**
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun data(data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>>) =
                apply {
                    this.data = data.map { it.toMutableList() }
                }

            /**
             * Adds a single [List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>] to [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>) =
                apply {
                    this.data = (this.data ?: JsonField.of(mutableListOf())).also {
                        checkKnown("data", it).add(data)
                    }
        ...
        fun validate(): Polarization =
            apply {
                if (validated) {
                  return@apply
                }

                data().ifPresent { it.forEach { it.forEach { it.forEach { it.forEach { it.forEach { it.forEach { it.forEach { it.validate() } } } } } } } }
                dimensionName()
                dimensions()
                notes()
                validated = true
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (data.asKnown().getOrNull()?.sumOf { it.sumOf { it.sumOf { it.sumOf { it.sumOf { it.sumOf { it.sumOf { it.validity().toInt() }.toInt() }.toInt() }.toInt() }.toInt() }.toInt() }.toInt() } ?: 0) + (dimensionName.asKnown().getOrNull()?.size ?: 0) + (dimensions.asKnown().getOrNull()?.size ?: 0) + (if (notes.asKnown().isPresent) 1 else 0)

        class UnnamedSchemaWithArrayParent2 @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            companion object {
                ...
                @JvmStatic fun of(value: String) = UnnamedSchemaWithArrayParent2(JsonField.of(value))
            }
            ...
            /**
             * An enum containing [UnnamedSchemaWithArrayParent2]'s known values, as well as an [_UNKNOWN] member.
             *
             * An instance of [UnnamedSchemaWithArrayParent2] can contain an unknown value in a couple of cases:
             *
             * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
             *   an older version than the API, then the API may respond with new members that the SDK is unaware
             *   of.
            ...
            enum class Value {
                X,
                O,
                /** An enum member indicating that [UnnamedSchemaWithArrayParent2] was instantiated with an unknown value. */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    X -> Known.X
                    O -> Known.O
                    else -> throw UnifieddatalibraryInvalidDataException("Unknown UnnamedSchemaWithArrayParent2: $value")
                }
            ...
            fun validate(): UnnamedSchemaWithArrayParent2 =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return /* spotless:off */ other is UnnamedSchemaWithArrayParent2 && value == other.value /* spotless:on */
            }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Polarization && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Polarization{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }
    ...
    class Power private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Power && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Power{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }
    ...
    class Range private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Range && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Range{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }

    /** Enums: Mobile, Static. */
    class ReceiveSensorType @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        enum class Value {
            MOBILE,
            STATIC,
            /** An enum member indicating that [ReceiveSensorType] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                MOBILE -> Known.MOBILE
                STATIC -> Known.STATIC
                else -> throw UnifieddatalibraryInvalidDataException("Unknown ReceiveSensorType: $value")
            }
        ...
        fun validate(): ReceiveSensorType =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is ReceiveSensorType && value == other.value /* spotless:on */
        }
    ...
    /** The ScalerInfo record describes the person or system who interpreted the ionogram in IonoObservation. */
    class ScalerInfo private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("confidenceLevel") @ExcludeMissing confidenceLevel: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("confidenceScore") @ExcludeMissing confidenceScore: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
            @JsonProperty("organization") @ExcludeMissing organization: JsonField<String> = JsonMissing.of(),
         ...
         *
         * Unlike [confidenceScore], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _version(): JsonField<Double> = version
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(scalerInfo: ScalerInfo) =
                apply {
            ...
            /** Scaler confidence level. */
            fun confidenceLevel(confidenceLevel: Int) = confidenceLevel(JsonField.of(confidenceLevel))

            /**
             * Sets [Builder.confidenceLevel] to an arbitrary JSON value.
             *
             * You should usually call [Builder.confidenceLevel] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun confidenceLevel(confidenceLevel: JsonField<Int>) =
                apply {
                    this.confidenceLevel = confidenceLevel
                }

            /** Scaler confidence score. */
            fun confidenceScore(confidenceScore: Int) = confidenceScore(JsonField.of(confidenceScore))

            /**
             * Sets [Builder.confidenceScore] to an arbitrary JSON value.
             *
             * You should usually call [Builder.confidenceScore] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun confidenceScore(confidenceScore: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.organization] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun organization(organization: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.version] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun version(version: JsonField<Double>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (confidenceLevel.asKnown().isPresent) 1 else 0) + (if (confidenceScore.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (organization.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (version.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is ScalerInfo && confidenceLevel == other.confidenceLevel && confidenceScore == other.confidenceScore && name == other.name && organization == other.organization && type == other.type && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(confidenceLevel, confidenceScore, name, organization, type, version, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "ScalerInfo{confidenceLevel=$confidenceLevel, confidenceScore=$confidenceScore, name=$name, organization=$organization, type=$type, version=$version, additionalProperties=$additionalProperties}"
    }

    class Stokes private constructor(
        private val data: JsonField<List<List<List<List<List<List<List<Double>>>>>>>>,
        private val dimensionName: JsonField<List<String>>,
        private val dimensions: JsonField<List<Int>>,
        private val notes: JsonField<String>,
        ...
        @JsonProperty("s")
        @ExcludeMissing
        fun _s(): JsonField<List<Double>> = s
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(stokes: Stokes) =
                apply {
             ...
             *
             * You should usually call [Builder.s] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun s(s: JsonField<List<Double>>) =
                apply {
                    this.s = s.map { it.toMutableList() }
                }
            ...
            fun addS(s: Double) =
                apply {
                    this.s = (this.s ?: JsonField.of(mutableListOf())).also {
                        checkKnown("s", it).add(s)
                    }
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (data.asKnown().getOrNull()?.sumOf { it.sumOf { it.sumOf { it.sumOf { it.sumOf { it.sumOf { it.size.toInt() }.toInt() }.toInt() }.toInt() }.toInt() }.toInt() } ?: 0) + (dimensionName.asKnown().getOrNull()?.size ?: 0) + (dimensions.asKnown().getOrNull()?.size ?: 0) + (if (notes.asKnown().isPresent) 1 else 0) + (s.asKnown().getOrNull()?.size ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Stokes && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && s == other.s && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(data, dimensionName, dimensions, notes, s, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "Stokes{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, s=$s, additionalProperties=$additionalProperties}"
    }
    ...
    class Time private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is Time && data == other.data && dimensionName == other.dimensionName && dimensions == other.dimensions && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() = "Time{data=$data, dimensionName=$dimensionName, dimensions=$dimensions, notes=$notes, additionalProperties=$additionalProperties}"
    }

    class TraceGeneric private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") @ExcludeMissing data: JsonField<List<List<List<Double>>>> = JsonMissing.of(),
            @JsonProperty("dimensionName") @ExcludeMissing dimensionName: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("notes") @ExcludeMissing notes: JsonField<String> = JsonMissing.of()
        ) : this(
          data,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(traceGeneric: TraceGeneric) =
                apply {
             ...
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<List<List<Double>>>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun data(data: JsonField<List<List<List<Double>>>>) =
                apply {
                    this.data = data.map { it.toMutableList() }
                }
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: List<List<Double>>) =
                apply {
                    this.data = (this.data ?: JsonField.of(mutableListOf())).also {
                        checkKnown("data", it).add(data)
                    }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (data.asKnown().getOrNull()?.sumOf { it.sumOf { it.size.toInt() }.toInt() } ?: 0) + (dimensionName.asKnown().getOrNull()?.size ?: 0) + (if (notes.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is TraceGeneric && data == other.data && dimensionName == other.dimensionName && notes == other.notes && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(data, dimensionName, notes, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "TraceGeneric{data=$data, dimensionName=$dimensionName, notes=$notes, additionalProperties=$additionalProperties}"
    }

    /** Enums: Mobile, Static. */
    class TransmitSensorType @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        enum class Value {
            MOBILE,
            STATIC,
            /** An enum member indicating that [TransmitSensorType] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                MOBILE -> Known.MOBILE
                STATIC -> Known.STATIC
                else -> throw UnifieddatalibraryInvalidDataException("Unknown TransmitSensorType: $value")
            }
        ...
        fun validate(): TransmitSensorType =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is TransmitSensorType && value == other.value /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is HistoryListResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && source == other.source && startTimeUtc == other.startTimeUtc && stationId == other.stationId && system == other.system && systemInfo == other.systemInfo && id == other.id && amplitude == other.amplitude && antennaElementPosition == other.antennaElementPosition && antennaElementPositionCoordinateSystem == other.antennaElementPositionCoordinateSystem && artistFlags == other.artistFlags && azimuth == other.azimuth && b0 == other.b0 && b1 == other.b1 && charAtts == other.charAtts && createdAt == other.createdAt && createdBy == other.createdBy && d == other.d && d1 == other.d1 && datum == other.datum && deltafoF2 == other.deltafoF2 && densityProfile == other.densityProfile && doppler == other.doppler && downE == other.downE && downEs == other.downEs && downF == other.downF && electronDensity == other.electronDensity && electronDensityUncertainty == other.electronDensityUncertainty && elevation == other.elevation && fbEs == other.fbEs && fe == other.fe && ff == other.ff && fhprimeF == other.fhprimeF && fhprimeF2 == other.fhprimeF2 && fmin == other.fmin && fminE == other.fminE && fminEs == other.fminEs && fminF == other.fminF && fmuf == other.fmuf && foE == other.foE && foEa == other.foEa && foEp == other.foEp && foEs == other.foEs && foF1 == other.foF1 && foF1p == other.foF1p && foF2 == other.foF2 && foF2p == other.foF2p && foP == other.foP && frequency == other.frequency && fxE == other.fxE && fxF1 == other.fxF1 && fxF2 == other.fxF2 && fxI == other.fxI && height == other.height && hmE == other.hmE && hmF1 == other.hmF1 && hmF2 == other.hmF2 && hprimeE == other.hprimeE && hprimeEa == other.hprimeEa && hprimeEs == other.hprimeEs && hprimeF == other.hprimeF && hprimeF1 == other.hprimeF1 && hprimeF2 == other.hprimeF2 && hprimefMuf == other.hprimefMuf && hprimeP == other.hprimeP && idSensor == other.idSensor && luf == other.luf && md == other.md && mufd == other.mufd && neProfileName == other.neProfileName && neProfileVersion == other.neProfileVersion && origin == other.origin && origNetwork == other.origNetwork && origSensorId == other.origSensorId && phase == other.phase && plasmaFrequency == other.plasmaFrequency && plasmaFrequencyUncertainty == other.plasmaFrequencyUncertainty && platformName == other.platformName && polarization == other.polarization && power == other.power && qe == other.qe && qf == other.qf && range == other.range && receiveCoordinates == other.receiveCoordinates && receiveSensorType == other.receiveSensorType && restrictedFrequency == other.restrictedFrequency && restrictedFrequencyNotes == other.restrictedFrequencyNotes && scaleHeightF2Peak == other.scaleHeightF2Peak && scalerInfo == other.scalerInfo && stokes == other.stokes && systemNotes == other.systemNotes && tec == other.tec && tidAzimuth == other.tidAzimuth && tidPeriods == other.tidPeriods && tidPhaseSpeeds == other.tidPhaseSpeeds && time == other.time && traceGeneric == other.traceGeneric && transmitCoordinates == other.transmitCoordinates && transmitSensorType == other.transmitSensorType && typeEs == other.typeEs && updatedAt == other.updatedAt && updatedBy == other.updatedBy && yE == other.yE && yF1 == other.yF1 && yF2 == other.yF2 && zhalfNm == other.zhalfNm && zmE == other.zmE && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, source, startTimeUtc, stationId, system, systemInfo, id, amplitude, antennaElementPosition, antennaElementPositionCoordinateSystem, artistFlags, azimuth, b0, b1, charAtts, createdAt, createdBy, d, d1, datum, deltafoF2, densityProfile, doppler, downE, downEs, downF, electronDensity, electronDensityUncertainty, elevation, fbEs, fe, ff, fhprimeF, fhprimeF2, fmin, fminE, fminEs, fminF, fmuf, foE, foEa, foEp, foEs, foF1, foF1p, foF2, foF2p, foP, frequency, fxE, fxF1, fxF2, fxI, height, hmE, hmF1, hmF2, hprimeE, hprimeEa, hprimeEs, hprimeF, hprimeF1, hprimeF2, hprimefMuf, hprimeP, idSensor, luf, md, mufd, neProfileName, neProfileVersion, origin, origNetwork, origSensorId, phase, plasmaFrequency, plasmaFrequencyUncertainty, platformName, polarization, power, qe, qf, range, receiveCoordinates, receiveSensorType, restrictedFrequency, restrictedFrequencyNotes, scaleHeightF2Peak, scalerInfo, stokes, systemNotes, tec, tidAzimuth, tidPeriods, tidPhaseSpeeds, time, traceGeneric, transmitCoordinates, transmitSensorType, typeEs, updatedAt, updatedBy, yE, yF1, yF2, zhalfNm, zmE, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "HistoryListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, startTimeUtc=$startTimeUtc, stationId=$stationId, system=$system, systemInfo=$systemInfo, id=$id, amplitude=$amplitude, antennaElementPosition=$antennaElementPosition, antennaElementPositionCoordinateSystem=$antennaElementPositionCoordinateSystem, artistFlags=$artistFlags, azimuth=$azimuth, b0=$b0, b1=$b1, charAtts=$charAtts, createdAt=$createdAt, createdBy=$createdBy, d=$d, d1=$d1, datum=$datum, deltafoF2=$deltafoF2, densityProfile=$densityProfile, doppler=$doppler, downE=$downE, downEs=$downEs, downF=$downF, electronDensity=$electronDensity, electronDensityUncertainty=$electronDensityUncertainty, elevation=$elevation, fbEs=$fbEs, fe=$fe, ff=$ff, fhprimeF=$fhprimeF, fhprimeF2=$fhprimeF2, fmin=$fmin, fminE=$fminE, fminEs=$fminEs, fminF=$fminF, fmuf=$fmuf, foE=$foE, foEa=$foEa, foEp=$foEp, foEs=$foEs, foF1=$foF1, foF1p=$foF1p, foF2=$foF2, foF2p=$foF2p, foP=$foP, frequency=$frequency, fxE=$fxE, fxF1=$fxF1, fxF2=$fxF2, fxI=$fxI, height=$height, hmE=$hmE, hmF1=$hmF1, hmF2=$hmF2, hprimeE=$hprimeE, hprimeEa=$hprimeEa, hprimeEs=$hprimeEs, hprimeF=$hprimeF, hprimeF1=$hprimeF1, hprimeF2=$hprimeF2, hprimefMuf=$hprimefMuf, hprimeP=$hprimeP, idSensor=$idSensor, luf=$luf, md=$md, mufd=$mufd, neProfileName=$neProfileName, neProfileVersion=$neProfileVersion, origin=$origin, origNetwork=$origNetwork, origSensorId=$origSensorId, phase=$phase, plasmaFrequency=$plasmaFrequency, plasmaFrequencyUncertainty=$plasmaFrequencyUncertainty, platformName=$platformName, polarization=$polarization, power=$power, qe=$qe, qf=$qf, range=$range, receiveCoordinates=$receiveCoordinates, receiveSensorType=$receiveSensorType, restrictedFrequency=$restrictedFrequency, restrictedFrequencyNotes=$restrictedFrequencyNotes, scaleHeightF2Peak=$scaleHeightF2Peak, scalerInfo=$scalerInfo, stokes=$stokes, systemNotes=$systemNotes, tec=$tec, tidAzimuth=$tidAzimuth, tidPeriods=$tidPeriods, tidPhaseSpeeds=$tidPhaseSpeeds, time=$time, traceGeneric=$traceGeneric, transmitCoordinates=$transmitCoordinates, transmitSensorType=$transmitSensorType, typeEs=$typeEs, updatedAt=$updatedAt, updatedBy=$updatedBy, yE=$yE, yF1=$yF1, yF2=$yF2, zhalfNm=$zhalfNm, zmE=$zmE, additionalProperties=$additionalProperties}"
}
