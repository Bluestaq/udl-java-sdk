...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            antennaElementPositionCoordinateSystem =
                historyListResponse.antennaElementPositionCoordinateSystem
            ...
            electronDensityUncertainty =
                historyListResponse.electronDensityUncertainty.map { it.toMutableList() }
            ...
            plasmaFrequencyUncertainty =
                historyListResponse.plasmaFrequencyUncertainty.map { it.toMutableList() }
    ...
    private constructor(
        private val data:
            JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>>,
        private val dimensionName: JsonField<List<String>>,
        private val dimensions: JsonField<List<Int>>,
        private val notes: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
         ...
         */
        fun data():
            Optional<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>> =
            data.getOptional("data")
        ...
        class Builder internal constructor() {
            ...
            private var data:
                JsonField<
                    MutableList<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>
                >? =
                null
            private var dimensionName: JsonField<MutableList<String>>? = null
            private var dimensions: JsonField<MutableList<Int>>? = null
            ...
            /** Array of polarization data. */
            fun data(
                data: List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>
            ) = data(JsonField.of(data))
             ...
             *
             * You should usually call [Builder.data] with a well-typed
             * `List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun data(
                data:
                    JsonField<
                        List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>>
                    >
            ) = apply { this.data = data.map { it.toMutableList() } }

            /**
             * Adds a single [List<List<List<List<List<List<UnnamedSchemaWithArrayParent2>>>>>>] to
             * [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            enum class Value {
                ...
                O,
                /**
                 * An enum member indicating that [UnnamedSchemaWithArrayParent2] was instantiated
