...
class ManifoldListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<ManifoldListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldListPageAsync: ManifoldListPageAsync) =
            apply {
        ...
        fun service(service: ManifoldServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: ManifoldListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<ManifoldListResponse>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "ManifoldListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
