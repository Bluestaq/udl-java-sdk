...
/**
 * Service operation intended for initial integration only, to take a list of Evac records as a POST
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EvacCreateBulkParams].
         *
    ...
    /** A builder for [EvacCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evacCreateBulkParams: EvacCreateBulkParams) = apply {
            body = evacCreateBulkParams.body.toMutableList()
            additionalHeaders = evacCreateBulkParams.additionalHeaders.toBuilder()
            additionalQueryParams = evacCreateBulkParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EvacCreateBulkParams].
         *
         ...
         */
        fun build(): EvacCreateBulkParams =
    ...
    /**
     * Casualty report and evacuation request. Used to report and request support to evacuate
    ...
    private constructor(
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun zoneContrCallSign(): Optional<String> =
            zoneContrCallSign.getOptional("zoneContrCallSign")
         ...
         *
         * Unlike [casualtyInfo], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("casualtyInfo")
        @ExcludeMissing
         ...
         *
         * Unlike [numCasualties], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
         ...
         *
         * Unlike [terrainRemarks], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("terrainRemarks")
        @ExcludeMissing
         ...
         *
         * Unlike [zoneSecurity], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                type = body.type
                id = body.id
                casualtyInfo = body.casualtyInfo.map { it.toMutableList() }
                ce = body.ce
                cntctFreq = body.cntctFreq
                comments = body.comments
                createdAt = body.createdAt
                createdBy = body.createdBy
                enemyData = body.enemyData.map { it.toMutableList() }
                idWeatherReport = body.idWeatherReport
                le = body.le
                medevacId = body.medevacId
                medicReq = body.medicReq
                missionType = body.missionType
                numAmbulatory = body.numAmbulatory
                numCasualties = body.numCasualties
                numKia = body.numKia
                numLitter = body.numLitter
                numWia = body.numWia
                obstaclesRemarks = body.obstaclesRemarks
                origin = body.origin
                origNetwork = body.origNetwork
                pickupAlt = body.pickupAlt
                pickupTime = body.pickupTime
                reqCallSign = body.reqCallSign
                reqNum = body.reqNum
                terrain = body.terrain
                terrainRemarks = body.terrainRemarks
                zoneContrCallSign = body.zoneContrCallSign
                zoneHot = body.zoneHot
                zoneMarking = body.zoneMarking
             ...
             *
             * You should usually call [Builder.numCasualties] with a well-typed [Int] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * height above ellipsoid, and negative values indicate a point height below ellipsoid.
             */
             ...
             *
             * You should usually call [Builder.reqCallSign] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun reqCallSign(reqCallSign: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.reqNum] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * PLOWED FIELDS, FLAT, STANDING WATER, MARSH, URBAN BUILT-UP AREA, MOUNTAIN, HILL, SAND
             * TD, ROCKY, VALLEY, METAMORPHIC ICE, UNKNOWN TD, SEA, NO STATEMENT).
             */
             ...
             *
             * You should usually call [Builder.terrain] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Amplifying data for the terrain describing any notable additional terrain features.
             */
            fun terrainRemarks(terrainRemarks: String) =
                terrainRemarks(JsonField.of(terrainRemarks))
             ...
             *
             * You should usually call [Builder.zoneHot] with a well-typed [Boolean] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The expected marker identifying the pickup site (SMOKE ZONE MARKING, FLARES, MIRROR,
             * GLIDE ANGLE INDICATOR LIGHT, LIGHT ZONE MARKING, PANELS, FIRE, LASER DESIGNATOR,
             * STROBE LIGHTS, VEHICLE LIGHTS, COLORED SMOKE, WHITE PHOSPHERUS, INFRARED,
             * ILLUMINATION, FRATRICIDE FENCE).
             */
             ...
             *
             * You should usually call [Builder.zoneMarking] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun zoneMarking(zoneMarking: JsonField<String>) = apply {
            ...
            /**
             * The pickup site security (UNKNOWN ZONESECURITY, NO ENEMY, POSSIBLE ENEMY, ENEMY IN
             * AREA USE CAUTION, ENEMY IN AREA ARMED ESCORT REQUIRED).
             */
             ...
             *
             * You should usually call [Builder.zoneSecurity] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun burialLocation(): Optional<List<Double>> =
                burialLocation.getOptional("burialLocation")
             ...
             *
             * Unlike [bloodType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("bloodType")
            @ExcludeMissing
             ...
             *
             * Unlike [burialLocation], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("burialLocation")
            @ExcludeMissing
             ...
             *
             * Unlike [careProviderUrn], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("careProviderUrn")
            @ExcludeMissing
             ...
             *
             * Unlike [casualtyKey], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("casualtyKey")
            @ExcludeMissing
             ...
             *
             * Unlike [collectionPoint], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("collectionPoint")
            @ExcludeMissing
             ...
             *
             * Unlike [contamType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("contamType")
            @ExcludeMissing
             ...
             *
             * Unlike [disposition], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("disposition")
            @ExcludeMissing
             ...
             *
             * Unlike [dispositionType], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("dispositionType")
            @ExcludeMissing
             ...
             *
             * Unlike [etiology], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("etiology")
            @ExcludeMissing
             ...
             *
             * Unlike [evacType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [healthState], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("healthState")
            @ExcludeMissing
             ...
             *
             * Unlike [medication], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("medication")
            @ExcludeMissing
             ...
             *
             * Unlike [patientIdentity], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("patientIdentity")
            @ExcludeMissing
             ...
             *
             * Unlike [payGrade], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [reportGen], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("reportGen")
            @ExcludeMissing
             ...
             *
             * Unlike [reportTime], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("reportTime")
            @ExcludeMissing
             ...
             *
             * Unlike [treatment], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("treatment")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.bloodType] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * degrees, and altitude, in meters, of the burial location. This array must contain
                 ...
                 *
                 * You should usually call [Builder.careProviderUrn] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.collectionPoint] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.condition] with a well-typed `List<Condition>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 * yet supported value.
                 */
                fun contamType(contamType: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.dispositionType] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.etiology] with a well-typed `List<Etiology>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.evacType] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                ...
                /** Health state information. */
                fun healthState(healthState: List<HealthState>) =
                    healthState(JsonField.of(healthState))

                /**
                 * Sets [Builder.healthState] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.healthState] with a well-typed
                 * `List<HealthState>` value instead. This method is primarily for setting the field
                ...
                /** The career field of this patient. */
                fun occSpeciality(occSpeciality: String) =
                    occSpeciality(JsonField.of(occSpeciality))
                 ...
                 *
                 * You should usually call [Builder.patientIdentity] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 * CIVILIAN, ENEMY POW).
                 */
                fun patientStatus(patientStatus: String) =
                    patientStatus(JsonField.of(patientStatus))
                 ...
                 *
                 * You should usually call [Builder.payGrade] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.reportGen] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.reportTime] with a well-typed [OffsetDateTime]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 * this patient (EXTRACTION EQUIPMENT, SEMI RIGID LITTER, BACKBOARD, CERVICAL COLLAR
                 * ,JUNGLE PENETRATOR, OXYGEN, WHOLE BLOOD, VENTILATOR, HOIST, NONE).
                 */
                fun specMedEquip(specMedEquip: List<String>) =
                    specMedEquip(JsonField.of(specMedEquip))

                /**
                 * Sets [Builder.specMedEquip] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.specMedEquip] with a well-typed `List<String>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.treatment] with a well-typed `List<Treatment>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 * `List<VitalSignData>` value instead. This method is primarily for setting the
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     */
                    fun build(): Allergy =
                        Allergy(comments, type, additionalProperties.toMutableMap())
                }
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     * LEFT FRONT, ANKLE RIGHT BACK, ANKLE RIGHT FRONT, ARM LEFT BACK, ARM LEFT
                     * ELBOW BACK, ARM LEFT ELBOW FRONT, ARM LEFT FRONT, ARM LEFT LOWER BACK, etc.).
                     */
                    fun bodyPart(bodyPart: String) = bodyPart(JsonField.of(bodyPart))
                     ...
                     *
                     * You should usually call [Builder.time] with a well-typed [OffsetDateTime]
                     ...
                     * Condition Type Enumeration (e.g. ACTIVITY HIGH, ACTIVITY LOW, ACTIVITY
                     * MEDIUM, ACTIVITY NONE, AVPU ALERT, AVPU ALTERED MENTAL STATE, AVPU PAIN, AVPU
                     * UNRESPONSIVE, etc.).
                     */
                    fun type(type: String) = type(JsonField.of(type))
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    /**
                     * The cause or manner of causation of the medical condition. Intended as, but
                     * not constrained to, K07.1 EtiologyType Enumeration (e.g. ASSAULT, BUILDING
                     * COLLAPSE, BURN CHEMICAL, BURN ELECTRICAL, BURN, BURN HOT LIQUID, BURN
                     * RADIATION, BURN THERMAL, etc.).
                     */
                    fun type(type: String) = type(JsonField.of(type))
            ...
            private constructor(
                 ...
                 *   unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun healthStateCode(): Optional<String> =
                    healthStateCode.getOptional("healthStateCode")
                 ...
                 *
                 * Unlike [medConfFactor], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("medConfFactor")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    /** Medical confidence factor. */
                    fun medConfFactor(medConfFactor: Int) =
                        medConfFactor(JsonField.of(medConfFactor))
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     * Body Location Enumeration (e.g. ANKLE LEFT BACK, ANKLE LEFT FRONT, ANKLE
                     * RIGHT BACK, ANKLE RIGHT FRONT, ARM LEFT BACK, ARM LEFT ELBOW BACK, ARM LEFT
                     * ELBOW FRONT, ARM LEFT FRONT, ARM LEFT LOWER BACK, etc.).
                     */
                    fun bodyPart(bodyPart: String) = bodyPart(JsonField.of(bodyPart))
                     ...
                     * BALLISTIC, BLAST WAVE, BURN 1ST DEGREE, BURN 2ND DEGREE, BURN 3RD DEGREE,
                     * BURN INHALATION, BURN LOWER AIRWAY, CHEST FLAIL, CHEST OPEN, DEGLOVING,
                     * ECCHYMOSIS, FRACTURE CLOSED, FRACTURE CREPITUS, FRACTURE IT, FRACTURE OPEN,
                     * HEMATOMA, IRREGULAR CONSISTENCY, IRREGULAR CONSISTENCY RIDGED, IRREGULAR
                     * CONSISTENCY SWOLLEN, IRREGULAR CONSISTENCY SWOLLEN DISTENDED, IRREGULAR
                     * CONSISTENCY TENDER, IRREGULAR POSITION, IRREGULAR SHAPE, IRREGULAR SHAPE
                     * MISSHAPED, IRREGULAR SHAPE NON SYMMETRICAL, LACERATION, NEUROVASCULAR
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("dose")
                    @ExcludeMissing
                    dose: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("time")
                    @ExcludeMissing
                    time: JsonField<OffsetDateTime> = JsonMissing.of(),
                    @JsonProperty("type") @ExcludeMissing type: JsonField<String> = JsonMissing.of(),
                 ...
                 *
                 * Unlike [adminRoute], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("adminRoute")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [dose], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                ...
                class Builder internal constructor() {
                    ...
                    /**
                     * Body part location or body part referenced for medication. Intended as, but
                     * not constrained to, K07.1 Body Location Enumeration (e.g. ANKLE LEFT BACK,
                     * ANKLE LEFT FRONT, ANKLE RIGHT BACK, ANKLE RIGHT FRONT, ARM LEFT BACK, ARM
                     * LEFT ELBOW BACK, ARM LEFT ELBOW FRONT, ARM LEFT FRONT, ARM LEFT LOWER BACK,
                     * etc.).
                     */
                    fun bodyPart(bodyPart: String) = bodyPart(JsonField.of(bodyPart))
                     ...
                     *
                     * You should usually call [Builder.dose] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    ...
                    /**
                     * The type of medication administered. Intended as, but not constrained to,
                     * K07.1 Medication Enumeration (CEFOTETAN, ABRASION, ABX, AMOXILOXACIN,
                     * ANALGESIC, COLLOID, CRYOPECIPITATES, CRYSTALLOID, EPINEPHRINE, ERTAPENEM,
                     * FENTANYL, HEXTEND, LACTATED RINGERS, MOBIC, MORPHINE, NARCOTIC, NS,
                     * PENICILLIN, PLASMA, PLATELETS, PRBC, TYLENOL, WHOLE BLOOD MT).
                     */
                    fun type(type: String) = type(JsonField.of(type))
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    /**
                     * Body part location or body part treated or to be treated. Intended as, but
                     * not constrained to, K07.1 Body Location Enumeration (e.g. ANKLE LEFT BACK,
                     * ANKLE LEFT FRONT, ANKLE RIGHT BACK, ANKLE RIGHT FRONT, ARM LEFT BACK, ARM
                     * LEFT ELBOW BACK, ARM LEFT ELBOW FRONT, ARM LEFT FRONT, ARM LEFT LOWER BACK,
                     * etc.).
                     ...
                     * constrained to, K07.1 Treatment Type Enumeration (e.g. AIRWAY ADJUNCT, AIRWAY
                     * ASSISTED VENTILATION, AIRWAY COMBI TUBE USED, AIRWAY ET NT, AIRWAY INTUBATED,
                     * AIRWAY NPA OPA APPLIED, AIRWAY PATIENT, AIRWAY POSITIONAL, AIRWAY SURGICAL
                     * CRIC, BREATHING CHEST SEAL, BREATHING CHEST TUBE, etc.).
                     */
                    fun type(type: String) = type(JsonField.of(type))
            ...
            private constructor(
                 ...
                 *
                 * Unlike [vitalSign1], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("vitalSign1")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [vitalSign2], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("vitalSign2")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     * not yet supported value.
                     */
                    fun vitalSign(vitalSign: JsonField<String>) = apply {
                        this.vitalSign = vitalSign
                    }

                    /**
                     * Vital sign value 1. The content of this field is dependent on the type of
                     * vital sign being measured (see the vitalSign field).
                     */
                    ...
                    /**
                     * Vital sign value 2. The content of this field is dependent on the type of
                     * vital sign being measured (see the vitalSign field).
                     */
        ...
        private constructor(
             ...
             *
             * Unlike [dirToEnemy], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("dirToEnemy")
            @ExcludeMissing
             ...
             *
             * Unlike [hlzRemarks], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("hlzRemarks")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.friendliesRemarks] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && classificationMarking == other.classificationMarking && dataMode == other.dataMode && pickupLat == other.pickupLat && pickupLon == other.pickupLon && reqTime == other.reqTime && source == other.source && type == other.type && id == other.id && casualtyInfo == other.casualtyInfo && ce == other.ce && cntctFreq == other.cntctFreq && comments == other.comments && createdAt == other.createdAt && createdBy == other.createdBy && enemyData == other.enemyData && idWeatherReport == other.idWeatherReport && le == other.le && medevacId == other.medevacId && medicReq == other.medicReq && missionType == other.missionType && numAmbulatory == other.numAmbulatory && numCasualties == other.numCasualties && numKia == other.numKia && numLitter == other.numLitter && numWia == other.numWia && obstaclesRemarks == other.obstaclesRemarks && origin == other.origin && origNetwork == other.origNetwork && pickupAlt == other.pickupAlt && pickupTime == other.pickupTime && reqCallSign == other.reqCallSign && reqNum == other.reqNum && terrain == other.terrain && terrainRemarks == other.terrainRemarks && zoneContrCallSign == other.zoneContrCallSign && zoneHot == other.zoneHot && zoneMarking == other.zoneMarking && zoneMarkingColor == other.zoneMarkingColor && zoneName == other.zoneName && zoneSecurity == other.zoneSecurity /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, pickupLat, pickupLon, reqTime, source, type, id, casualtyInfo, ce, cntctFreq, comments, createdAt, createdBy, enemyData, idWeatherReport, le, medevacId, medicReq, missionType, numAmbulatory, numCasualties, numKia, numLitter, numWia, obstaclesRemarks, origin, origNetwork, pickupAlt, pickupTime, reqCallSign, reqNum, terrain, terrainRemarks, zoneContrCallSign, zoneHot, zoneMarking, zoneMarkingColor, zoneName, zoneSecurity) }
        /* spotless:on */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EvacCreateBulkParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "EvacCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
