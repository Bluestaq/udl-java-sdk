...
class SensorTypeQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeQueryhelpResponse: SensorTypeQueryhelpResponse) = apply {
    ...
    fun validate(): SensorTypeQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
