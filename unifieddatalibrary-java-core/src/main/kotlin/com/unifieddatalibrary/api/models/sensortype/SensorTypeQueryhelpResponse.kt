...
class SensorTypeQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SensorTypeQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SensorTypeQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorTypeQueryhelpResponse: SensorTypeQueryhelpResponse) =
            apply {
                aodrSupported = sensorTypeQueryhelpResponse.aodrSupported
                classificationMarking = sensorTypeQueryhelpResponse.classificationMarking
                description = sensorTypeQueryhelpResponse.description
                historySupported = sensorTypeQueryhelpResponse.historySupported
                name = sensorTypeQueryhelpResponse.name
                parameters = sensorTypeQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = sensorTypeQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = sensorTypeQueryhelpResponse.restSupported
                sortSupported = sensorTypeQueryhelpResponse.sortSupported
                typeName = sensorTypeQueryhelpResponse.typeName
                uri = sensorTypeQueryhelpResponse.uri
                additionalProperties = sensorTypeQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SensorTypeQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SensorTypeQueryhelpResponse =
    ...
    fun validate(): SensorTypeQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorTypeQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
