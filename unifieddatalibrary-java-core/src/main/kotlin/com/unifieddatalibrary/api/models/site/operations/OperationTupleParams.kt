...
class OperationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperationTupleParams].
         *
    ...
    /** A builder for [OperationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operationTupleParams: OperationTupleParams) =
            apply {
                columns = operationTupleParams.columns
                idSite = operationTupleParams.idSite
                firstResult = operationTupleParams.firstResult
                maxResults = operationTupleParams.maxResults
                additionalHeaders = operationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = operationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OperationTupleParams].
         *
         ...
         */
        fun build(): OperationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OperationTupleParams && columns == other.columns && idSite == other.idSite && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, idSite, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OperationTupleParams{columns=$columns, idSite=$idSite, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
