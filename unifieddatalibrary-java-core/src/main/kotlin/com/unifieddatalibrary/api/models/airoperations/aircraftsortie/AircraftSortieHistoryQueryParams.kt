 ...
 */
class AircraftSortieHistoryQueryParams
private constructor(
    ...
    /** A builder for [AircraftSortieHistoryQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortieHistoryQueryParams: AircraftSortieHistoryQueryParams) =
            apply {
                plannedDepTime = aircraftSortieHistoryQueryParams.plannedDepTime
                columns = aircraftSortieHistoryQueryParams.columns
                firstResult = aircraftSortieHistoryQueryParams.firstResult
                maxResults = aircraftSortieHistoryQueryParams.maxResults
                additionalHeaders = aircraftSortieHistoryQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    aircraftSortieHistoryQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortieHistoryQueryParams].
         *
         ...
         */
        fun build(): AircraftSortieHistoryQueryParams =
            AircraftSortieHistoryQueryParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftSortieHistoryQueryParams && plannedDepTime == other.plannedDepTime && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AircraftSortieHistoryQueryParams{plannedDepTime=$plannedDepTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
