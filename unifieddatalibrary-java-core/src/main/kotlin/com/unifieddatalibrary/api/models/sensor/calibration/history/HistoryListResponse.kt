...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            azRaAccelBias = historyListResponse.azRaAccelBias
            azRaAccelSigma = historyListResponse.azRaAccelSigma
            azRaBias = historyListResponse.azRaBias
            azRaRateBias = historyListResponse.azRaRateBias
            azRaRateSigma = historyListResponse.azRaRateSigma
            azRaRms = historyListResponse.azRaRms
            azRaSigma = historyListResponse.azRaSigma
            calAngleRef = historyListResponse.calAngleRef
            calTrackMode = historyListResponse.calTrackMode
            calType = historyListResponse.calType
            confidenceNoiseBias = historyListResponse.confidenceNoiseBias
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            duration = historyListResponse.duration
            ecr = historyListResponse.ecr.map { it.toMutableList() }
            elDecAccelBias = historyListResponse.elDecAccelBias
            elDecAccelSigma = historyListResponse.elDecAccelSigma
            elDecBias = historyListResponse.elDecBias
            elDecRateBias = historyListResponse.elDecRateBias
            elDecRateSigma = historyListResponse.elDecRateSigma
            elDecRms = historyListResponse.elDecRms
            elDecSigma = historyListResponse.elDecSigma
            endTime = historyListResponse.endTime
            numAzRaObs = historyListResponse.numAzRaObs
            numElDecObs = historyListResponse.numElDecObs
            numObs = historyListResponse.numObs
            numPhotoObs = historyListResponse.numPhotoObs
            numRangeObs = historyListResponse.numRangeObs
            numRangeRateObs = historyListResponse.numRangeRateObs
            numRcsObs = historyListResponse.numRcsObs
            numTimeObs = historyListResponse.numTimeObs
            numTracks = historyListResponse.numTracks
            origin = historyListResponse.origin
            origNetwork = historyListResponse.origNetwork
            photoBias = historyListResponse.photoBias
            photoSigma = historyListResponse.photoSigma
            rangeAccelBias = historyListResponse.rangeAccelBias
            rangeAccelSigma = historyListResponse.rangeAccelSigma
            rangeBias = historyListResponse.rangeBias
            rangeRateBias = historyListResponse.rangeRateBias
            rangeRateRms = historyListResponse.rangeRateRms
            rangeRateSigma = historyListResponse.rangeRateSigma
            rangeRms = historyListResponse.rangeRms
            rangeSigma = historyListResponse.rangeSigma
            rcsBias = historyListResponse.rcsBias
            rcsSigma = historyListResponse.rcsSigma
            refTargets = historyListResponse.refTargets.map { it.toMutableList() }
            refType = historyListResponse.refType
            senType = historyListResponse.senType
            sourceDl = historyListResponse.sourceDl
            timeBias = historyListResponse.timeBias
            timeBiasSigma = historyListResponse.timeBiasSigma
