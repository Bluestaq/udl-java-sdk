...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldslotconsumptionFull: AirfieldslotconsumptionFull) = apply {
    ...
    fun validate(): AirfieldslotconsumptionFull = apply {
        if (validated) {
            return@apply
        }
