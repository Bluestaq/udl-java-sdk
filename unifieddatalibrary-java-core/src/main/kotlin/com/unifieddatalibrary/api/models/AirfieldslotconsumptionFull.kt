...
class AirfieldslotconsumptionFull private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("idAirfieldSlot") @ExcludeMissing idAirfieldSlot: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("altArrSortieId") @ExcludeMissing altArrSortieId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("altDepSortieId") @ExcludeMissing altDepSortieId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("appComment") @ExcludeMissing appComment: JsonField<String> = JsonMissing.of(),
        @JsonProperty("appInitials") @ExcludeMissing appInitials: JsonField<String> = JsonMissing.of(),
        @JsonProperty("appOrg") @ExcludeMissing appOrg: JsonField<String> = JsonMissing.of(),
        @JsonProperty("callSigns") @ExcludeMissing callSigns: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("idArrSortie") @ExcludeMissing idArrSortie: JsonField<String> = JsonMissing.of(),
        @JsonProperty("idDepSortie") @ExcludeMissing idDepSortie: JsonField<String> = JsonMissing.of(),
        @JsonProperty("missionId") @ExcludeMissing missionId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("occAircraftMDS") @ExcludeMissing occAircraftMds: JsonField<String> = JsonMissing.of(),
        @JsonProperty("occStartTime") @ExcludeMissing occStartTime: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("occTailNumber") @ExcludeMissing occTailNumber: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("reqComment") @ExcludeMissing reqComment: JsonField<String> = JsonMissing.of(),
        @JsonProperty("reqInitials") @ExcludeMissing reqInitials: JsonField<String> = JsonMissing.of(),
        @JsonProperty("reqOrg") @ExcludeMissing reqOrg: JsonField<String> = JsonMissing.of(),
        @JsonProperty("resAircraftMDS") @ExcludeMissing resAircraftMds: JsonField<String> = JsonMissing.of(),
        @JsonProperty("resMissionId") @ExcludeMissing resMissionId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("resReason") @ExcludeMissing resReason: JsonField<String> = JsonMissing.of(),
        @JsonProperty("resTailNumber") @ExcludeMissing resTailNumber: JsonField<String> = JsonMissing.of(),
        @JsonProperty("resType") @ExcludeMissing resType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("sourceDL") @ExcludeMissing sourceDl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("status") @ExcludeMissing status: JsonField<Status> = JsonMissing.of(),
        @JsonProperty("targetTime") @ExcludeMissing targetTime: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    @JsonProperty("appOrg")
    @ExcludeMissing
    fun _appOrg(): JsonField<String> = appOrg
    ...
    @ExcludeMissing
    fun _consumer(): JsonField<String> = consumer
    ...
    @ExcludeMissing
    fun _occupied(): JsonField<Boolean> = occupied
    ...
    @JsonProperty("reqOrg")
    @ExcludeMissing
    fun _reqOrg(): JsonField<String> = reqOrg
    ...
    @ExcludeMissing
    fun _resReason(): JsonField<String> = resReason
    ...
    @ExcludeMissing
    fun _resType(): JsonField<String> = resType
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirfieldslotconsumptionFull].
         *
    ...
    /** A builder for [AirfieldslotconsumptionFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldslotconsumptionFull: AirfieldslotconsumptionFull) =
            apply {
                classificationMarking = airfieldslotconsumptionFull.classificationMarking
                dataMode = airfieldslotconsumptionFull.dataMode
                idAirfieldSlot = airfieldslotconsumptionFull.idAirfieldSlot
                numAircraft = airfieldslotconsumptionFull.numAircraft
                source = airfieldslotconsumptionFull.source
                startTime = airfieldslotconsumptionFull.startTime
                id = airfieldslotconsumptionFull.id
                altArrSortieId = airfieldslotconsumptionFull.altArrSortieId
                altDepSortieId = airfieldslotconsumptionFull.altDepSortieId
                appComment = airfieldslotconsumptionFull.appComment
                appInitials = airfieldslotconsumptionFull.appInitials
                appOrg = airfieldslotconsumptionFull.appOrg
                callSigns = airfieldslotconsumptionFull.callSigns.map { it.toMutableList() }
                consumer = airfieldslotconsumptionFull.consumer
                createdAt = airfieldslotconsumptionFull.createdAt
                createdBy = airfieldslotconsumptionFull.createdBy
                endTime = airfieldslotconsumptionFull.endTime
                idArrSortie = airfieldslotconsumptionFull.idArrSortie
                idDepSortie = airfieldslotconsumptionFull.idDepSortie
                missionId = airfieldslotconsumptionFull.missionId
                occAircraftMds = airfieldslotconsumptionFull.occAircraftMds
                occStartTime = airfieldslotconsumptionFull.occStartTime
                occTailNumber = airfieldslotconsumptionFull.occTailNumber
                occupied = airfieldslotconsumptionFull.occupied
                origin = airfieldslotconsumptionFull.origin
                origNetwork = airfieldslotconsumptionFull.origNetwork
                reqComment = airfieldslotconsumptionFull.reqComment
                reqInitials = airfieldslotconsumptionFull.reqInitials
                reqOrg = airfieldslotconsumptionFull.reqOrg
                resAircraftMds = airfieldslotconsumptionFull.resAircraftMds
                resMissionId = airfieldslotconsumptionFull.resMissionId
                resReason = airfieldslotconsumptionFull.resReason
                resTailNumber = airfieldslotconsumptionFull.resTailNumber
                resType = airfieldslotconsumptionFull.resType
                sourceDl = airfieldslotconsumptionFull.sourceDl
                status = airfieldslotconsumptionFull.status
                targetTime = airfieldslotconsumptionFull.targetTime
                updatedAt = airfieldslotconsumptionFull.updatedAt
                updatedBy = airfieldslotconsumptionFull.updatedBy
                additionalProperties = airfieldslotconsumptionFull.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.idAirfieldSlot] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idAirfieldSlot(idAirfieldSlot: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.altArrSortieId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun altArrSortieId(altArrSortieId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.altDepSortieId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun altDepSortieId(altDepSortieId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.appComment] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun appComment(appComment: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.appInitials] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun appInitials(appInitials: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.appOrg] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun appOrg(appOrg: JsonField<String>) =
            apply {
                this.appOrg = appOrg
            }
         ...
         *
         * You should usually call [Builder.callSigns] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun callSigns(callSigns: JsonField<List<String>>) =
            apply {
        ...
        fun addCallSign(callSign: String) =
            apply {
                callSigns = (callSigns ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.consumer] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun consumer(consumer: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.idArrSortie] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idArrSortie(idArrSortie: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.idDepSortie] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idDepSortie(idDepSortie: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.occAircraftMds] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun occAircraftMds(occAircraftMds: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.occStartTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun occStartTime(occStartTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.occTailNumber] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun occTailNumber(occTailNumber: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.occupied] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun occupied(occupied: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.reqComment] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reqComment(reqComment: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.reqInitials] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reqInitials(reqInitials: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.reqOrg] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reqOrg(reqOrg: JsonField<String>) =
            apply {
                this.reqOrg = reqOrg
            }
         ...
         *
         * You should usually call [Builder.resAircraftMds] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resAircraftMds(resAircraftMds: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.resMissionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resMissionId(resMissionId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.resReason] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resReason(resReason: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.resTailNumber] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resTailNumber(resTailNumber: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.resType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resType(resType: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.targetTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun targetTime(targetTime: JsonField<OffsetDateTime>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [AirfieldslotconsumptionFull].
         *
         ...
         */
        fun build(): AirfieldslotconsumptionFull =
    ...
    fun validate(): AirfieldslotconsumptionFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idAirfieldSlot.asKnown().isPresent) 1 else 0) + (if (numAircraft.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (altArrSortieId.asKnown().isPresent) 1 else 0) + (if (altDepSortieId.asKnown().isPresent) 1 else 0) + (if (appComment.asKnown().isPresent) 1 else 0) + (if (appInitials.asKnown().isPresent) 1 else 0) + (if (appOrg.asKnown().isPresent) 1 else 0) + (callSigns.asKnown().getOrNull()?.size ?: 0) + (if (consumer.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (idArrSortie.asKnown().isPresent) 1 else 0) + (if (idDepSortie.asKnown().isPresent) 1 else 0) + (if (missionId.asKnown().isPresent) 1 else 0) + (if (occAircraftMds.asKnown().isPresent) 1 else 0) + (if (occStartTime.asKnown().isPresent) 1 else 0) + (if (occTailNumber.asKnown().isPresent) 1 else 0) + (if (occupied.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (reqComment.asKnown().isPresent) 1 else 0) + (if (reqInitials.asKnown().isPresent) 1 else 0) + (if (reqOrg.asKnown().isPresent) 1 else 0) + (if (resAircraftMds.asKnown().isPresent) 1 else 0) + (if (resMissionId.asKnown().isPresent) 1 else 0) + (if (resReason.asKnown().isPresent) 1 else 0) + (if (resTailNumber.asKnown().isPresent) 1 else 0) + (if (resType.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (status.asKnown().getOrNull()?.validity() ?: 0) + (if (targetTime.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
