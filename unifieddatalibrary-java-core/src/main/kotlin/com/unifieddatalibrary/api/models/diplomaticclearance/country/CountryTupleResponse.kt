...
class CountryTupleResponse private constructor(
    ...
    private val diplomaticClearanceCountryContacts: JsonField<List<DiplomaticClearanceCountryContact>>,
    private val diplomaticClearanceCountryEntryExitPoints: JsonField<List<DiplomaticClearanceCountryEntryExitPoint>>,
    private val diplomaticClearanceCountryProfiles: JsonField<List<DiplomaticClearanceCountryProfile>>,
    ...
    private constructor(
        ...
        @JsonProperty("acceptsDMS") @ExcludeMissing acceptsDms: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("acceptsEmail") @ExcludeMissing acceptsEmail: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("acceptsFax") @ExcludeMissing acceptsFax: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("acceptsSIPRNet") @ExcludeMissing acceptsSiprNet: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("countryRemark") @ExcludeMissing countryRemark: JsonField<String> = JsonMissing.of(),
        @JsonProperty("createdAt") @ExcludeMissing createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("createdBy") @ExcludeMissing createdBy: JsonField<String> = JsonMissing.of(),
        @JsonProperty("diplomaticClearanceCountryContacts") @ExcludeMissing diplomaticClearanceCountryContacts: JsonField<List<DiplomaticClearanceCountryContact>> = JsonMissing.of(),
        @JsonProperty("diplomaticClearanceCountryEntryExitPoints") @ExcludeMissing diplomaticClearanceCountryEntryExitPoints: JsonField<List<DiplomaticClearanceCountryEntryExitPoint>> = JsonMissing.of(),
        @JsonProperty("diplomaticClearanceCountryProfiles") @ExcludeMissing diplomaticClearanceCountryProfiles: JsonField<List<DiplomaticClearanceCountryProfile>> = JsonMissing.of(),
        @JsonProperty("existingProfile") @ExcludeMissing existingProfile: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("gmtOffset") @ExcludeMissing gmtOffset: JsonField<String> = JsonMissing.of(),
        @JsonProperty("officeName") @ExcludeMissing officeName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("officePOC") @ExcludeMissing officePoc: JsonField<String> = JsonMissing.of(),
        @JsonProperty("officeRemark") @ExcludeMissing officeRemark: JsonField<String> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryTupleResponse: CountryTupleResponse) =
            apply {
                ...
                diplomaticClearanceCountryContacts = countryTupleResponse.diplomaticClearanceCountryContacts.map { it.toMutableList() }
                diplomaticClearanceCountryEntryExitPoints = countryTupleResponse.diplomaticClearanceCountryEntryExitPoints.map { it.toMutableList() }
                diplomaticClearanceCountryProfiles = countryTupleResponse.diplomaticClearanceCountryProfiles.map { it.toMutableList() }
    ...
    fun validate(): CountryTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
