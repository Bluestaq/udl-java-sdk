 ...
 * parameter.
 */
class MissionAssignmentGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MissionAssignmentGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentGetParams: MissionAssignmentGetParams) = apply {
    ...
    override fun toString() =
        "MissionAssignmentGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
