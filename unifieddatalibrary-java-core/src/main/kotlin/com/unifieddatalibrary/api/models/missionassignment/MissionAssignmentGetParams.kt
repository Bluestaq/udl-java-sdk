...
class MissionAssignmentGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): MissionAssignmentGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MissionAssignmentGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [MissionAssignmentGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentGetParams: MissionAssignmentGetParams) =
            apply {
                id = missionAssignmentGetParams.id
                firstResult = missionAssignmentGetParams.firstResult
                maxResults = missionAssignmentGetParams.maxResults
                additionalHeaders = missionAssignmentGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = missionAssignmentGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MissionAssignmentGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MissionAssignmentGetParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is MissionAssignmentGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "MissionAssignmentGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
