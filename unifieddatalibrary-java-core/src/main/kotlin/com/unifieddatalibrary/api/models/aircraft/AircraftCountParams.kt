...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AircraftCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AircraftCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AircraftCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftCountParams: AircraftCountParams) = apply {
            firstResult = aircraftCountParams.firstResult
            maxResults = aircraftCountParams.maxResults
            additionalHeaders = aircraftCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AircraftCountParams =
            AircraftCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AircraftCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
