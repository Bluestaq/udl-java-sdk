...
class SensorPlanTupleResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("collectRequests") @ExcludeMissing collectRequests: JsonField<List<CollectRequest>> = JsonMissing.of(),
        ...
        @JsonProperty("senNetwork") @ExcludeMissing senNetwork: JsonField<String> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun collectRequests(): Optional<List<CollectRequest>> = collectRequests.getOptional("collectRequests")
    ...
    @ExcludeMissing
    fun _recType(): JsonField<String> = recType
    ...
    /**
     * Returns the raw JSON value of [collectRequests].
     *
     * Unlike [collectRequests], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("collectRequests")
    @ExcludeMissing
    fun _collectRequests(): JsonField<List<CollectRequest>> = collectRequests
    ...
    @ExcludeMissing
    fun _customer(): JsonField<String> = customer
     ...
     */
    @JsonProperty("reqTotal")
    @ExcludeMissing
    fun _reqTotal(): JsonField<Int> = reqTotal
    ...
    @ExcludeMissing
    fun _senNetwork(): JsonField<String> = senNetwork
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorPlanTupleResponse].
         *
    ...
    /** A builder for [SensorPlanTupleResponse]. */
    class Builder internal constructor() {
        ...
        private var collectRequests: JsonField<MutableList<CollectRequest>>? = null
        ...
        @JvmSynthetic
        internal fun from(sensorPlanTupleResponse: SensorPlanTupleResponse) =
            apply {
                classificationMarking = sensorPlanTupleResponse.classificationMarking
                dataMode = sensorPlanTupleResponse.dataMode
                recType = sensorPlanTupleResponse.recType
                source = sensorPlanTupleResponse.source
                startTime = sensorPlanTupleResponse.startTime
                type = sensorPlanTupleResponse.type
                id = sensorPlanTupleResponse.id
                collectRequests = sensorPlanTupleResponse.collectRequests.map { it.toMutableList() }
                createdAt = sensorPlanTupleResponse.createdAt
                createdBy = sensorPlanTupleResponse.createdBy
                customer = sensorPlanTupleResponse.customer
                endTime = sensorPlanTupleResponse.endTime
                idSensor = sensorPlanTupleResponse.idSensor
                name = sensorPlanTupleResponse.name
                origin = sensorPlanTupleResponse.origin
                origNetwork = sensorPlanTupleResponse.origNetwork
                origSensorId = sensorPlanTupleResponse.origSensorId
                purpose = sensorPlanTupleResponse.purpose
                reqTotal = sensorPlanTupleResponse.reqTotal
                senNetwork = sensorPlanTupleResponse.senNetwork
                status = sensorPlanTupleResponse.status
                tags = sensorPlanTupleResponse.tags.map { it.toMutableList() }
                updatedAt = sensorPlanTupleResponse.updatedAt
                updatedBy = sensorPlanTupleResponse.updatedBy
                additionalProperties = sensorPlanTupleResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.recType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun recType(recType: JsonField<String>) =
            apply {
        ...
        /** The list of collect requests belonging to the SensorPlan. Each collect request is associated with a parent SensorPlan via the IdPlan. If provided, the list must have the same size as reqTotal. */
        fun collectRequests(collectRequests: List<CollectRequest>) = collectRequests(JsonField.of(collectRequests))

        /**
         * Sets [Builder.collectRequests] to an arbitrary JSON value.
         *
         * You should usually call [Builder.collectRequests] with a well-typed `List<CollectRequest>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun collectRequests(collectRequests: JsonField<List<CollectRequest>>) =
            apply {
                this.collectRequests = collectRequests.map { it.toMutableList() }
            }

        /**
         * Adds a single [CollectRequest] to [collectRequests].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCollectRequest(collectRequest: CollectRequest) =
            apply {
                collectRequests = (collectRequests ?: JsonField.of(mutableListOf())).also {
                    checkKnown("collectRequests", it).add(collectRequest)
                }
            }
         ...
         *
         * You should usually call [Builder.customer] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun customer(customer: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.reqTotal] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reqTotal(reqTotal: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.senNetwork] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun senNetwork(senNetwork: JsonField<String>) =
            apply {
                this.senNetwork = senNetwork
            }
        ...
        /**
         * Returns an immutable instance of [SensorPlanTupleResponse].
         *
         ...
         */
        fun build(): SensorPlanTupleResponse =
            SensorPlanTupleResponse(
              ...
              id,
              (collectRequests ?: JsonMissing.of()).map { it.toImmutable() },
              createdAt,
              createdBy,
              customer,
              endTime,
    ...
    fun validate(): SensorPlanTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
            ...
            type()
            id()
            collectRequests().ifPresent { it.forEach { it.validate() } }
            createdAt()
            createdBy()
            customer()
            endTime()
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (recType.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (collectRequests.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (customer.asKnown().isPresent) 1 else 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (purpose.asKnown().isPresent) 1 else 0) + (if (reqTotal.asKnown().isPresent) 1 else 0) + (if (senNetwork.asKnown().isPresent) 1 else 0) + (if (status.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    class CollectRequest private constructor(
        private val classificationMarking: JsonField<String>,
        private val dataMode: JsonField<DataMode>,
        private val source: JsonField<String>,
        private val startTime: JsonField<OffsetDateTime>,
        ...
        private val collectResponse: JsonField<List<CollectResponseFull>>,
        private val createdAt: JsonField<OffsetDateTime>,
        private val createdBy: JsonField<String>,
        private val customer: JsonField<String>,
        ...
        private constructor(
            ...
            @JsonProperty("collectResponse") @ExcludeMissing collectResponse: JsonField<List<CollectResponseFull>> = JsonMissing.of(),
            @JsonProperty("createdAt") @ExcludeMissing createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("createdBy") @ExcludeMissing createdBy: JsonField<String> = JsonMissing.of(),
            @JsonProperty("customer") @ExcludeMissing customer: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("extentAz") @ExcludeMissing extentAz: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("extentEl") @ExcludeMissing extentEl: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("extentRange") @ExcludeMissing extentRange: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("externalId") @ExcludeMissing externalId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("frameRate") @ExcludeMissing frameRate: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("idManifold") @ExcludeMissing idManifold: JsonField<String> = JsonMissing.of(),
            @JsonProperty("idOnOrbit") @ExcludeMissing idOnOrbit: JsonField<String> = JsonMissing.of(),
            @JsonProperty("idParentReq") @ExcludeMissing idParentReq: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("integrationTime") @ExcludeMissing integrationTime: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("iron") @ExcludeMissing iron: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("irradiance") @ExcludeMissing irradiance: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lat") @ExcludeMissing lat: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("lon") @ExcludeMissing lon: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("msgCreateDate") @ExcludeMissing msgCreateDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            ...
            @JsonProperty("orbitRegime") @ExcludeMissing orbitRegime: JsonField<String> = JsonMissing.of(),
            @JsonProperty("orientAngle") @ExcludeMissing orientAngle: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("origin") @ExcludeMissing origin: JsonField<String> = JsonMissing.of(),
            @JsonProperty("origNetwork") @ExcludeMissing origNetwork: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("polarization") @ExcludeMissing polarization: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("reflectance") @ExcludeMissing reflectance: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("spectralModel") @ExcludeMissing spectralModel: JsonField<String> = JsonMissing.of(),
            @JsonProperty("srchInc") @ExcludeMissing srchInc: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("srchPattern") @ExcludeMissing srchPattern: JsonField<String> = JsonMissing.of(),
            @JsonProperty("stateVector") @ExcludeMissing stateVector: JsonField<StateVector> = JsonMissing.of(),
            ...
            @JsonProperty("tags") @ExcludeMissing tags: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("targetSize") @ExcludeMissing targetSize: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("taskCategory") @ExcludeMissing taskCategory: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("taskGroup") @ExcludeMissing taskGroup: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("trueAnomoly") @ExcludeMissing trueAnomoly: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("uctFollowUp") @ExcludeMissing uctFollowUp: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("updatedAt") @ExcludeMissing updatedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("updatedBy") @ExcludeMissing updatedBy: JsonField<String> = JsonMissing.of(),
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun collectResponse(): Optional<List<CollectResponseFull>> = collectResponse.getOptional("collectResponse")
        ...
        @JsonProperty("az")
        @ExcludeMissing
        fun _az(): JsonField<Double> = az

        /**
         * Returns the raw JSON value of [collectResponse].
         *
         * Unlike [collectResponse], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("collectResponse")
        @ExcludeMissing
        fun _collectResponse(): JsonField<List<CollectResponseFull>> = collectResponse
        ...
        @ExcludeMissing
        fun _duration(): JsonField<Int> = duration
         ...
         */
        @JsonProperty("dwellId")
        @ExcludeMissing
        fun _dwellId(): JsonField<String> = dwellId
        ...
        @JsonProperty("elset")
        @ExcludeMissing
        fun _elset(): JsonField<Elset> = elset
        ...
        @ExcludeMissing
        fun _extentAz(): JsonField<Double> = extentAz
        ...
        @ExcludeMissing
        fun _extentEl(): JsonField<Double> = extentEl
        ...
        @ExcludeMissing
        fun _frameRate(): JsonField<Double> = frameRate
        ...
        @JsonProperty("freq")
        @ExcludeMissing
        fun _freq(): JsonField<Double> = freq
        ...
        @ExcludeMissing
        fun _freqMax(): JsonField<Double> = freqMax
        ...
        @ExcludeMissing
        fun _freqMin(): JsonField<Double> = freqMin
        ...
        @ExcludeMissing
        fun _idElset(): JsonField<String> = idElset
         ...
         *
         * Unlike [integrationTime], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _msgType(): JsonField<String> = msgType
        ...
        @ExcludeMissing
        fun _numFrames(): JsonField<Int> = numFrames
        ...
        @JsonProperty("obType")
        @ExcludeMissing
        fun _obType(): JsonField<String> = obType
         ...
         */
        @JsonProperty("planIndex")
        @ExcludeMissing
        fun _planIndex(): JsonField<Int> = planIndex
        ...
        @JsonProperty("rcsMax")
        @ExcludeMissing
        fun _rcsMax(): JsonField<Double> = rcsMax
        ...
        @JsonProperty("rcsMin")
        @ExcludeMissing
        fun _rcsMin(): JsonField<Double> = rcsMin
        ...
        @ExcludeMissing
        fun _scenario(): JsonField<String> = scenario
         ...
         *
         * Unlike [spectralModel], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         */
        @JsonProperty("srchInc")
        @ExcludeMissing
        fun _srchInc(): JsonField<Double> = srchInc
         ...
         */
        @JsonProperty("stopAlt")
        @ExcludeMissing
        fun _stopAlt(): JsonField<Double> = stopAlt
        ...
        @ExcludeMissing
        fun _stopLat(): JsonField<Double> = stopLat
        ...
        @ExcludeMissing
        fun _stopLon(): JsonField<Double> = stopLon
         ...
         *
         * Unlike [taskCategory], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _taskGroup(): JsonField<String> = taskGroup
        ...
        @JsonProperty("visMag")
        @ExcludeMissing
        fun _visMag(): JsonField<Double> = visMag
        ...
        @ExcludeMissing
        fun _visMagMax(): JsonField<Double> = visMagMax
        ...
        @ExcludeMissing
        fun _visMagMin(): JsonField<Double> = visMagMin
        ...
        @JsonProperty("xAngle")
        @ExcludeMissing
        fun _xAngle(): JsonField<Double> = xAngle
        ...
        @JsonProperty("yAngle")
        @ExcludeMissing
        fun _yAngle(): JsonField<Double> = yAngle
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [CollectRequest].
             *
             * The following fields are required:
             *
             * ```java
        ...
        class Builder internal constructor() {
            ...
            private var collectResponse: JsonField<MutableList<CollectResponseFull>>? = null
            private var createdAt: JsonField<OffsetDateTime> = JsonMissing.of()
            private var createdBy: JsonField<String> = JsonMissing.of()
            private var customer: JsonField<String> = JsonMissing.of()
            ...
            @JvmSynthetic
            internal fun from(collectRequest: CollectRequest) =
                apply {
                    classificationMarking = collectRequest.classificationMarking
                    dataMode = collectRequest.dataMode
                    source = collectRequest.source
                    startTime = collectRequest.startTime
                    type = collectRequest.type
                    id = collectRequest.id
                    alt = collectRequest.alt
                    argOfPerigee = collectRequest.argOfPerigee
                    az = collectRequest.az
                    collectResponse = collectRequest.collectResponse.map { it.toMutableList() }
                    createdAt = collectRequest.createdAt
                    createdBy = collectRequest.createdBy
                    customer = collectRequest.customer
                    dec = collectRequest.dec
                    duration = collectRequest.duration
                    dwellId = collectRequest.dwellId
                    eccentricity = collectRequest.eccentricity
                    el = collectRequest.el
                    elset = collectRequest.elset
                    endTime = collectRequest.endTime
                    epoch = collectRequest.epoch
                    esId = collectRequest.esId
                    extentAz = collectRequest.extentAz
                    extentEl = collectRequest.extentEl
                    extentRange = collectRequest.extentRange
                    externalId = collectRequest.externalId
                    frameRate = collectRequest.frameRate
                    freq = collectRequest.freq
                    freqMax = collectRequest.freqMax
                    freqMin = collectRequest.freqMin
                    idElset = collectRequest.idElset
                    idManifold = collectRequest.idManifold
                    idOnOrbit = collectRequest.idOnOrbit
                    idParentReq = collectRequest.idParentReq
                    idPlan = collectRequest.idPlan
                    idSensor = collectRequest.idSensor
                    idStateVector = collectRequest.idStateVector
                    inclination = collectRequest.inclination
                    integrationTime = collectRequest.integrationTime
                    iron = collectRequest.iron
                    irradiance = collectRequest.irradiance
                    lat = collectRequest.lat
                    lon = collectRequest.lon
                    msgCreateDate = collectRequest.msgCreateDate
                    msgType = collectRequest.msgType
                    notes = collectRequest.notes
                    numFrames = collectRequest.numFrames
                    numObs = collectRequest.numObs
                    numTracks = collectRequest.numTracks
                    obType = collectRequest.obType
                    orbitRegime = collectRequest.orbitRegime
                    orientAngle = collectRequest.orientAngle
                    origin = collectRequest.origin
                    origNetwork = collectRequest.origNetwork
                    origObjectId = collectRequest.origObjectId
                    origSensorId = collectRequest.origSensorId
                    planIndex = collectRequest.planIndex
                    polarization = collectRequest.polarization
                    priority = collectRequest.priority
                    ra = collectRequest.ra
                    raan = collectRequest.raan
                    range = collectRequest.range
                    rcs = collectRequest.rcs
                    rcsMax = collectRequest.rcsMax
                    rcsMin = collectRequest.rcsMin
                    reflectance = collectRequest.reflectance
                    satNo = collectRequest.satNo
                    scenario = collectRequest.scenario
                    semiMajorAxis = collectRequest.semiMajorAxis
                    spectralModel = collectRequest.spectralModel
                    srchInc = collectRequest.srchInc
                    srchPattern = collectRequest.srchPattern
                    stateVector = collectRequest.stateVector
                    stopAlt = collectRequest.stopAlt
                    stopLat = collectRequest.stopLat
                    stopLon = collectRequest.stopLon
                    suffix = collectRequest.suffix
                    tags = collectRequest.tags.map { it.toMutableList() }
                    targetSize = collectRequest.targetSize
                    taskCategory = collectRequest.taskCategory
                    taskGroup = collectRequest.taskGroup
                    taskId = collectRequest.taskId
                    transactionId = collectRequest.transactionId
                    trueAnomoly = collectRequest.trueAnomoly
                    uctFollowUp = collectRequest.uctFollowUp
                    updatedAt = collectRequest.updatedAt
                    updatedBy = collectRequest.updatedBy
                    visMag = collectRequest.visMag
                    visMagMax = collectRequest.visMagMax
                    visMagMin = collectRequest.visMagMin
                    xAngle = collectRequest.xAngle
                    yAngle = collectRequest.yAngle
                    additionalProperties = collectRequest.additionalProperties.toMutableMap()
                }
             ...
             *
             * You should usually call [Builder.az] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun az(az: JsonField<Double>) =
                apply {
                    this.az = az
                }

            /** CollectResponses associated to request id. Read-only details (only used on detail queries, not to be provided on create/update operations). */
            fun collectResponse(collectResponse: List<CollectResponseFull>) = collectResponse(JsonField.of(collectResponse))

            /**
             * Sets [Builder.collectResponse] to an arbitrary JSON value.
             *
             * You should usually call [Builder.collectResponse] with a well-typed `List<CollectResponseFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun collectResponse(collectResponse: JsonField<List<CollectResponseFull>>) =
                apply {
                    this.collectResponse = collectResponse.map { it.toMutableList() }
                }

            /**
             * Adds a single [CollectResponseFull] to [Builder.collectResponse].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addCollectResponse(collectResponse: CollectResponseFull) =
                apply {
                    this.collectResponse = (this.collectResponse ?: JsonField.of(mutableListOf())).also {
                        checkKnown("collectResponse", it).add(collectResponse)
                    }
                }
             ...
             *
             * You should usually call [Builder.duration] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun duration(duration: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.dwellId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dwellId(dwellId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.el] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun el(el: JsonField<Double>) =
                apply {
                    this.el = el
                }
             ...
             *
             * You should usually call [Builder.elset] with a well-typed [Elset] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun elset(elset: JsonField<Elset>) =
                apply {
                    this.elset = elset
                }
             ...
             *
             * You should usually call [Builder.extentAz] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun extentAz(extentAz: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.extentEl] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun extentEl(extentEl: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.extentRange] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun extentRange(extentRange: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.frameRate] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun frameRate(frameRate: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.freq] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun freq(freq: JsonField<Double>) =
                apply {
                    this.freq = freq
                }
             ...
             *
             * You should usually call [Builder.freqMax] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun freqMax(freqMax: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.freqMin] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun freqMin(freqMin: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.idElset] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun idElset(idElset: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.idParentReq] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun idParentReq(idParentReq: JsonField<String>) =
                apply {
            ...
            /** For optical sensors, the integration time per camera frame, in milliseconds. */
            fun integrationTime(integrationTime: Double) = integrationTime(JsonField.of(integrationTime))

            /**
             * Sets [Builder.integrationTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.integrationTime] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun integrationTime(integrationTime: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.iron] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun iron(iron: JsonField<Int>) =
                apply {
                    this.iron = iron
                }
             ...
             *
             * You should usually call [Builder.irradiance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun irradiance(irradiance: JsonField<Double>) =
                apply {
            ...
            /** The timestamp of the external message from which this request originated, if applicable, in ISO8601 UTC format with millisecond precision. */
            fun msgCreateDate(msgCreateDate: OffsetDateTime) = msgCreateDate(JsonField.of(msgCreateDate))

            /**
             * Sets [Builder.msgCreateDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.msgCreateDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun msgCreateDate(msgCreateDate: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.msgType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun msgType(msgType: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.numFrames] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun numFrames(numFrames: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.obType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun obType(obType: JsonField<String>) =
                apply {
                    this.obType = obType
                }
             ...
             *
             * You should usually call [Builder.orbitRegime] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun orbitRegime(orbitRegime: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.orientAngle] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun orientAngle(orientAngle: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.planIndex] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun planIndex(planIndex: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.polarization] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun polarization(polarization: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.rcsMax] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rcsMax(rcsMax: JsonField<Double>) =
                apply {
                    this.rcsMax = rcsMax
                }
             ...
             *
             * You should usually call [Builder.rcsMin] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rcsMin(rcsMin: JsonField<Double>) =
                apply {
                    this.rcsMin = rcsMin
                }
             ...
             *
             * You should usually call [Builder.reflectance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun reflectance(reflectance: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.scenario] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun scenario(scenario: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.spectralModel] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun spectralModel(spectralModel: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.srchInc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun srchInc(srchInc: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.srchPattern] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun srchPattern(srchPattern: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.stateVector] with a well-typed [StateVector] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun stateVector(stateVector: JsonField<StateVector>) =
                apply {
             ...
             *
             * You should usually call [Builder.stopAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun stopAlt(stopAlt: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.stopLat] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun stopLat(stopLat: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.stopLon] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun stopLon(stopLon: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.targetSize] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun targetSize(targetSize: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.taskCategory] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun taskCategory(taskCategory: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.taskGroup] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun taskGroup(taskGroup: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.trueAnomoly] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun trueAnomoly(trueAnomoly: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.uctFollowUp] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun uctFollowUp(uctFollowUp: JsonField<Boolean>) =
                apply {
             ...
             *
             * You should usually call [Builder.visMag] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun visMag(visMag: JsonField<Double>) =
                apply {
                    this.visMag = visMag
                }
             ...
             *
             * You should usually call [Builder.visMagMax] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun visMagMax(visMagMax: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.visMagMin] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun visMagMin(visMagMin: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.xAngle] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun xAngle(xAngle: JsonField<Double>) =
                apply {
                    this.xAngle = xAngle
                }
             ...
             *
             * You should usually call [Builder.yAngle] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun yAngle(yAngle: JsonField<Double>) =
                apply {
                    this.yAngle = yAngle
                }
            ...
            /**
             * Returns an immutable instance of [CollectRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
            ...
            fun build(): CollectRequest =
                CollectRequest(
                  ...
                  argOfPerigee,
                  az,
                  (collectResponse ?: JsonMissing.of()).map { it.toImmutable() },
                  createdAt,
                  createdBy,
                  customer,
                  dec,
        ...
        fun validate(): CollectRequest =
            apply {
                ...
                argOfPerigee()
                az()
                collectResponse().ifPresent { it.forEach { it.validate() } }
                createdAt()
                createdBy()
                customer()
                dec()
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (startTime.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (alt.asKnown().isPresent) 1 else 0) + (if (argOfPerigee.asKnown().isPresent) 1 else 0) + (if (az.asKnown().isPresent) 1 else 0) + (collectResponse.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (customer.asKnown().isPresent) 1 else 0) + (if (dec.asKnown().isPresent) 1 else 0) + (if (duration.asKnown().isPresent) 1 else 0) + (if (dwellId.asKnown().isPresent) 1 else 0) + (if (eccentricity.asKnown().isPresent) 1 else 0) + (if (el.asKnown().isPresent) 1 else 0) + (elset.asKnown().getOrNull()?.validity() ?: 0) + (if (endTime.asKnown().isPresent) 1 else 0) + (if (epoch.asKnown().isPresent) 1 else 0) + (if (esId.asKnown().isPresent) 1 else 0) + (if (extentAz.asKnown().isPresent) 1 else 0) + (if (extentEl.asKnown().isPresent) 1 else 0) + (if (extentRange.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (if (frameRate.asKnown().isPresent) 1 else 0) + (if (freq.asKnown().isPresent) 1 else 0) + (if (freqMax.asKnown().isPresent) 1 else 0) + (if (freqMin.asKnown().isPresent) 1 else 0) + (if (idElset.asKnown().isPresent) 1 else 0) + (if (idManifold.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idParentReq.asKnown().isPresent) 1 else 0) + (if (idPlan.asKnown().isPresent) 1 else 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (if (idStateVector.asKnown().isPresent) 1 else 0) + (if (inclination.asKnown().isPresent) 1 else 0) + (if (integrationTime.asKnown().isPresent) 1 else 0) + (if (iron.asKnown().isPresent) 1 else 0) + (if (irradiance.asKnown().isPresent) 1 else 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (msgCreateDate.asKnown().isPresent) 1 else 0) + (if (msgType.asKnown().isPresent) 1 else 0) + (if (notes.asKnown().isPresent) 1 else 0) + (if (numFrames.asKnown().isPresent) 1 else 0) + (if (numObs.asKnown().isPresent) 1 else 0) + (if (numTracks.asKnown().isPresent) 1 else 0) + (if (obType.asKnown().isPresent) 1 else 0) + (if (orbitRegime.asKnown().isPresent) 1 else 0) + (if (orientAngle.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (planIndex.asKnown().isPresent) 1 else 0) + (if (polarization.asKnown().isPresent) 1 else 0) + (if (priority.asKnown().isPresent) 1 else 0) + (if (ra.asKnown().isPresent) 1 else 0) + (if (raan.asKnown().isPresent) 1 else 0) + (if (range.asKnown().isPresent) 1 else 0) + (if (rcs.asKnown().isPresent) 1 else 0) + (if (rcsMax.asKnown().isPresent) 1 else 0) + (if (rcsMin.asKnown().isPresent) 1 else 0) + (if (reflectance.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (scenario.asKnown().isPresent) 1 else 0) + (if (semiMajorAxis.asKnown().isPresent) 1 else 0) + (if (spectralModel.asKnown().isPresent) 1 else 0) + (if (srchInc.asKnown().isPresent) 1 else 0) + (if (srchPattern.asKnown().isPresent) 1 else 0) + (stateVector.asKnown().getOrNull()?.validity() ?: 0) + (if (stopAlt.asKnown().isPresent) 1 else 0) + (if (stopLat.asKnown().isPresent) 1 else 0) + (if (stopLon.asKnown().isPresent) 1 else 0) + (if (suffix.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (targetSize.asKnown().isPresent) 1 else 0) + (if (taskCategory.asKnown().isPresent) 1 else 0) + (if (taskGroup.asKnown().isPresent) 1 else 0) + (if (taskId.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (trueAnomoly.asKnown().isPresent) 1 else 0) + (if (uctFollowUp.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (if (visMag.asKnown().isPresent) 1 else 0) + (if (visMagMax.asKnown().isPresent) 1 else 0) + (if (visMagMin.asKnown().isPresent) 1 else 0) + (if (xAngle.asKnown().isPresent) 1 else 0) + (if (yAngle.asKnown().isPresent) 1 else 0)
        ...
        /** An element set is a collection of Keplerian orbital elements describing an orbit of a particular satellite. The data is used along with an orbit propagator in order to predict the motion of a satellite. The element set, or elset for short, consists of identification data, the classical elements and drag parameters. */
        class Elset private constructor(
            private val classificationMarking: JsonField<String>,
            private val dataMode: JsonField<DataMode>,
            private val epoch: JsonField<OffsetDateTime>,
            private val source: JsonField<String>,
            ...
            private constructor(
                ...
                @JsonProperty("argOfPerigee") @ExcludeMissing argOfPerigee: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("ballisticCoeff") @ExcludeMissing ballisticCoeff: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("eccentricity") @ExcludeMissing eccentricity: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("effectiveFrom") @ExcludeMissing effectiveFrom: JsonField<OffsetDateTime> = JsonMissing.of(),
                ...
                @JsonProperty("idElset") @ExcludeMissing idElset: JsonField<String> = JsonMissing.of(),
                @JsonProperty("idOnOrbit") @ExcludeMissing idOnOrbit: JsonField<String> = JsonMissing.of(),
                @JsonProperty("idOrbitDetermination") @ExcludeMissing idOrbitDetermination: JsonField<String> = JsonMissing.of(),
                @JsonProperty("inclination") @ExcludeMissing inclination: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("satNo") @ExcludeMissing satNo: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("semiMajorAxis") @ExcludeMissing semiMajorAxis: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("sourcedData") @ExcludeMissing sourcedData: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("sourcedDataTypes") @ExcludeMissing sourcedDataTypes: JsonField<List<SourcedDataType>> = JsonMissing.of(),
            ...
            /**
             * The orbit point furthest from the center of the earth in kilometers. If not provided, apogee will be computed from the TLE according to the following. Using mu, the standard gravitational parameter for the earth (398600.4418), semi-major axis A = (mu/(n _ 2 _ pi/(24*3600))^2)(1/3). Using semi-major axis A, eccentricity E, apogee = (A * (1 + E)) in km. Note that the calculations are for computing the apogee radius from the center of the earth, to compute apogee altitude the radius of the earth should be subtracted (6378.135 km).
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun idOrbitDetermination(): Optional<String> = idOrbitDetermination.getOptional("idOrbitDetermination")
            ...
            /**
             * The orbit point nearest to the center of the earth in kilometers. If not provided, perigee will be computed from the TLE according to the following. Using mu, the standard gravitational parameter for the earth (398600.4418), semi-major axis A = (mu/(n _ 2 _ pi/(24*3600))^2)(1/3). Using semi-major axis A, eccentricity E, perigee = (A * (1 - E)) in km. Note that the calculations are for computing the perigee radius from the center of the earth, to compute perigee altitude the radius of the earth should be subtracted (6378.135 km).
             *
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun sourcedDataTypes(): Optional<List<SourcedDataType>> = sourcedDataTypes.getOptional("sourcedDataTypes")
            ...
            @JsonProperty("agom")
            @ExcludeMissing
            fun _agom(): JsonField<Double> = agom
            ...
            @ExcludeMissing
            fun _ephemType(): JsonField<Long> = ephemType
             ...
             *
             * Unlike [idOrbitDetermination], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [sourcedDataTypes], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                internal fun from(elset: Elset) =
                    apply {
                        ...
                        effectiveFrom = elset.effectiveFrom
                        effectiveUntil = elset.effectiveUntil
                 ...
                 *
                 * You should usually call [Builder.agom] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun agom(agom: JsonField<Double>) =
                    apply {
                        this.agom = agom
                    }
                 ...
                 *
                 * You should usually call [Builder.algorithm] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun algorithm(algorithm: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.ballisticCoeff] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun ballisticCoeff(ballisticCoeff: JsonField<Double>) =
                    apply {
                ...
                /** Read-only start time at which this elset was the 'current' elset for its satellite. This field and is set by the system automatically and ignored on create/edit operations. */
                fun effectiveFrom(effectiveFrom: OffsetDateTime) = effectiveFrom(JsonField.of(effectiveFrom))

                /**
                 * Sets [Builder.effectiveFrom] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.effectiveFrom] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun effectiveFrom(effectiveFrom: JsonField<OffsetDateTime>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.ephemType] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun ephemType(ephemType: JsonField<Long>) =
                    apply {
                ...
                /** Unique identifier of the OD solution record that produced this elset. This ID can be used to obtain additional information on an OrbitDetermination object using the 'get by ID' operation (e.g. /udl/orbitdetermination/{id}). For example, the OrbitDetermination with idOrbitDetermination = abc would be queried as /udl/orbitdetermination/abc. */
                fun idOrbitDetermination(idOrbitDetermination: String) = idOrbitDetermination(JsonField.of(idOrbitDetermination))

                /**
                 * Sets [Builder.idOrbitDetermination] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.idOrbitDetermination] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun idOrbitDetermination(idOrbitDetermination: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.sourcedData] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun sourcedData(sourcedData: JsonField<List<String>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addSourcedData(sourcedData: String) =
                    apply {
                        this.sourcedData = (this.sourcedData ?: JsonField.of(mutableListOf())).also {
                            checkKnown("sourcedData", it).add(sourcedData)
                        }
                    }

                /** Optional array of UDL observation data types used to build this element set (e.g. EO, RADAR, RF, DOA). See the associated sourcedData array for the specific UUIDs of observations for the positionally corresponding data types in this array (the two arrays must match in size). */
                fun sourcedDataTypes(sourcedDataTypes: List<SourcedDataType>) = sourcedDataTypes(JsonField.of(sourcedDataTypes))

                /**
                 * Sets [Builder.sourcedDataTypes] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.sourcedDataTypes] with a well-typed `List<SourcedDataType>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun sourcedDataTypes(sourcedDataTypes: JsonField<List<SourcedDataType>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addSourcedDataType(sourcedDataType: SourcedDataType) =
                    apply {
                        sourcedDataTypes = (sourcedDataTypes ?: JsonField.of(mutableListOf())).also {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (epoch.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (agom.asKnown().isPresent) 1 else 0) + (if (algorithm.asKnown().isPresent) 1 else 0) + (if (apogee.asKnown().isPresent) 1 else 0) + (if (argOfPerigee.asKnown().isPresent) 1 else 0) + (if (ballisticCoeff.asKnown().isPresent) 1 else 0) + (if (bStar.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (eccentricity.asKnown().isPresent) 1 else 0) + (if (effectiveFrom.asKnown().isPresent) 1 else 0) + (if (effectiveUntil.asKnown().isPresent) 1 else 0) + (if (ephemType.asKnown().isPresent) 1 else 0) + (if (idElset.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idOrbitDetermination.asKnown().isPresent) 1 else 0) + (if (inclination.asKnown().isPresent) 1 else 0) + (if (line1.asKnown().isPresent) 1 else 0) + (if (line2.asKnown().isPresent) 1 else 0) + (if (meanAnomaly.asKnown().isPresent) 1 else 0) + (if (meanMotion.asKnown().isPresent) 1 else 0) + (if (meanMotionDDot.asKnown().isPresent) 1 else 0) + (if (meanMotionDot.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (perigee.asKnown().isPresent) 1 else 0) + (if (period.asKnown().isPresent) 1 else 0) + (if (raan.asKnown().isPresent) 1 else 0) + (if (rawFileUri.asKnown().isPresent) 1 else 0) + (if (revNo.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (semiMajorAxis.asKnown().isPresent) 1 else 0) + (sourcedData.asKnown().getOrNull()?.size ?: 0) + (sourcedDataTypes.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (uct.asKnown().isPresent) 1 else 0)
            ...
            class SourcedDataType @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                enum class Value {
                    ...
                    ELSET,
                    SV,
                    /** An enum member indicating that [SourcedDataType] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        ELSET -> Known.ELSET
                        SV -> Known.SV
                        else -> throw UnifieddatalibraryInvalidDataException("Unknown SourcedDataType: $value")
                    }
        ...
        class StateVector private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("epoch") @ExcludeMissing epoch: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("source") @ExcludeMissing source: JsonField<String> = JsonMissing.of(),
                @JsonProperty("actualODSpan") @ExcludeMissing actualOdSpan: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("algorithm") @ExcludeMissing algorithm: JsonField<String> = JsonMissing.of(),
                @JsonProperty("alt1ReferenceFrame") @ExcludeMissing alt1ReferenceFrame: JsonField<String> = JsonMissing.of(),
                @JsonProperty("alt2ReferenceFrame") @ExcludeMissing alt2ReferenceFrame: JsonField<String> = JsonMissing.of(),
                ...
                @JsonProperty("errorControl") @ExcludeMissing errorControl: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("iau1980Terms") @ExcludeMissing iau1980Terms: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("idOnOrbit") @ExcludeMissing idOnOrbit: JsonField<String> = JsonMissing.of(),
                @JsonProperty("idOrbitDetermination") @ExcludeMissing idOrbitDetermination: JsonField<String> = JsonMissing.of(),
                @JsonProperty("idStateVector") @ExcludeMissing idStateVector: JsonField<String> = JsonMissing.of(),
                @JsonProperty("integratorMode") @ExcludeMissing integratorMode: JsonField<String> = JsonMissing.of(),
                @JsonProperty("inTrackThrust") @ExcludeMissing inTrackThrust: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("lastObEnd") @ExcludeMissing lastObEnd: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("lastObStart") @ExcludeMissing lastObStart: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("leapSecondTime") @ExcludeMissing leapSecondTime: JsonField<OffsetDateTime> = JsonMissing.of(),
                ...
                @JsonProperty("obsAvailable") @ExcludeMissing obsAvailable: JsonField<Int> = JsonMissing.of(),
                ...
                @JsonProperty("polarMotionX") @ExcludeMissing polarMotionX: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("polarMotionY") @ExcludeMissing polarMotionY: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("residualsAcc") @ExcludeMissing residualsAcc: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("revNo") @ExcludeMissing revNo: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("rms") @ExcludeMissing rms: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("satNo") @ExcludeMissing satNo: JsonField<Int> = JsonMissing.of(),
                @JsonProperty("sigmaPosUVW") @ExcludeMissing sigmaPosUvw: JsonField<List<Double>> = JsonMissing.of(),
                @JsonProperty("sigmaVelUVW") @ExcludeMissing sigmaVelUvw: JsonField<List<Double>> = JsonMissing.of(),
                @JsonProperty("solarFluxAPAvg") @ExcludeMissing solarFluxApAvg: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("solarFluxF10") @ExcludeMissing solarFluxF10: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("solarFluxF10Avg") @ExcludeMissing solarFluxF10Avg: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("solarRadPress") @ExcludeMissing solarRadPress: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("solarRadPressCoeff") @ExcludeMissing solarRadPressCoeff: JsonField<Double> = JsonMissing.of(),
                ...
                @JsonProperty("stepSizeSelection") @ExcludeMissing stepSizeSelection: JsonField<String> = JsonMissing.of(),
                @JsonProperty("tags") @ExcludeMissing tags: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("taiUtc") @ExcludeMissing taiUtc: JsonField<Double> = JsonMissing.of(),
                @JsonProperty("thrustAccel") @ExcludeMissing thrustAccel: JsonField<Double> = JsonMissing.of(),
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun alt1ReferenceFrame(): Optional<String> = alt1ReferenceFrame.getOptional("alt1ReferenceFrame")
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun alt2ReferenceFrame(): Optional<String> = alt2ReferenceFrame.getOptional("alt2ReferenceFrame")
             ...
             * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun solarRadPressCoeff(): Optional<Double> = solarRadPressCoeff.getOptional("solarRadPressCoeff")
             ...
             *
             * Unlike [alt1ReferenceFrame], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [alt2ReferenceFrame], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            @JsonProperty("area")
            @ExcludeMissing
            fun _area(): JsonField<Double> = area
            ...
            @ExcludeMissing
            fun _cmOffset(): JsonField<Double> = cmOffset
            ...
            @ExcludeMissing
            fun _dragArea(): JsonField<Double> = dragArea
            ...
            @JsonProperty("eqCov")
            @ExcludeMissing
            fun _eqCov(): JsonField<List<Double>> = eqCov
             ...
             */
            @JsonProperty("obsUsed")
            @ExcludeMissing
            fun _obsUsed(): JsonField<Int> = obsUsed
            ...
            @ExcludeMissing
            fun _partials(): JsonField<String> = partials
            ...
            @JsonProperty("posUnc")
            @ExcludeMissing
            fun _posUnc(): JsonField<Double> = posUnc
             ...
             *
             * Unlike [solarRadPressCoeff], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            @ExcludeMissing
            fun _srpArea(): JsonField<Double> = srpArea
            ...
            @ExcludeMissing
            fun _stepMode(): JsonField<String> = stepMode
            ...
            @ExcludeMissing
            fun _stepSize(): JsonField<Double> = stepSize

            /**
             * Returns the raw JSON value of [stepSizeSelection].
             *
             * Unlike [stepSizeSelection], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            @JsonProperty("taiUtc")
            @ExcludeMissing
            fun _taiUtc(): JsonField<Double> = taiUtc
            ...
            @ExcludeMissing
            fun _ut1Rate(): JsonField<Double> = ut1Rate
            ...
            @JsonProperty("ut1Utc")
            @ExcludeMissing
            fun _ut1Utc(): JsonField<Double> = ut1Utc
            ...
            @JsonProperty("velUnc")
            @ExcludeMissing
            fun _velUnc(): JsonField<Double> = velUnc
            ...
            @ExcludeMissing
            fun _xposAlt1(): JsonField<Double> = xposAlt1
            ...
            @ExcludeMissing
            fun _xposAlt2(): JsonField<Double> = xposAlt2
            ...
            @ExcludeMissing
            fun _xvelAlt1(): JsonField<Double> = xvelAlt1
            ...
            @ExcludeMissing
            fun _xvelAlt2(): JsonField<Double> = xvelAlt2
            ...
            @ExcludeMissing
            fun _yposAlt1(): JsonField<Double> = yposAlt1
            ...
            @ExcludeMissing
            fun _yposAlt2(): JsonField<Double> = yposAlt2
            ...
            @ExcludeMissing
            fun _yvelAlt1(): JsonField<Double> = yvelAlt1
            ...
            @ExcludeMissing
            fun _yvelAlt2(): JsonField<Double> = yvelAlt2
            ...
            @ExcludeMissing
            fun _zposAlt1(): JsonField<Double> = zposAlt1
            ...
            @ExcludeMissing
            fun _zposAlt2(): JsonField<Double> = zposAlt2
            ...
            @ExcludeMissing
            fun _zvelAlt1(): JsonField<Double> = zvelAlt1
            ...
            @ExcludeMissing
            fun _zvelAlt2(): JsonField<Double> = zvelAlt2
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(stateVector: StateVector) =
                    apply {
                        ...
                        edr = stateVector.edr
                        effectiveFrom = stateVector.effectiveFrom
                        effectiveUntil = stateVector.effectiveUntil
                 ...
                 *
                 * You should usually call [Builder.actualOdSpan] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun actualOdSpan(actualOdSpan: JsonField<Double>) =
                    apply {
                ...
                /** The reference frame of the alternate1 (Alt1) cartesian orbital state. */
                fun alt1ReferenceFrame(alt1ReferenceFrame: String) = alt1ReferenceFrame(JsonField.of(alt1ReferenceFrame))

                /**
                 * Sets [Builder.alt1ReferenceFrame] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.alt1ReferenceFrame] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun alt1ReferenceFrame(alt1ReferenceFrame: JsonField<String>) =
                    apply {
                        this.alt1ReferenceFrame = alt1ReferenceFrame
                    }

                /** The reference frame of the alternate2 (Alt2) cartesian orbital state. */
                fun alt2ReferenceFrame(alt2ReferenceFrame: String) = alt2ReferenceFrame(JsonField.of(alt2ReferenceFrame))

                /**
                 * Sets [Builder.alt2ReferenceFrame] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.alt2ReferenceFrame] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun alt2ReferenceFrame(alt2ReferenceFrame: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.area] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun area(area: JsonField<Double>) =
                    apply {
                        this.area = area
                    }
                 ...
                 *
                 * You should usually call [Builder.cmOffset] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun cmOffset(cmOffset: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.covMethod] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun covMethod(covMethod: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.dragArea] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun dragArea(dragArea: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.dragCoeff] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun dragCoeff(dragCoeff: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.eqCov] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun eqCov(eqCov: JsonField<List<Double>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addEqCov(eqCov: Double) =
                    apply {
                        this.eqCov = (this.eqCov ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.errorControl] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun errorControl(errorControl: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.fixedStep] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun fixedStep(fixedStep: JsonField<Boolean>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.iau1980Terms] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun iau1980Terms(iau1980Terms: JsonField<Int>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.integratorMode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun integratorMode(integratorMode: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.inTrackThrust] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun inTrackThrust(inTrackThrust: JsonField<Boolean>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.lastObEnd] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun lastObEnd(lastObEnd: JsonField<OffsetDateTime>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.lastObStart] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun lastObStart(lastObStart: JsonField<OffsetDateTime>) =
                    apply {
                        this.lastObStart = lastObStart
                    }

                /** Time of the next leap second after epoch in ISO 8601 UTC time. If the next leap second is not known, the time of the previous leap second is used. */
                fun leapSecondTime(leapSecondTime: OffsetDateTime) = leapSecondTime(JsonField.of(leapSecondTime))

                /**
                 * Sets [Builder.leapSecondTime] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.leapSecondTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun leapSecondTime(leapSecondTime: JsonField<OffsetDateTime>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.obsAvailable] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun obsAvailable(obsAvailable: JsonField<Int>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.obsUsed] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun obsUsed(obsUsed: JsonField<Int>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.partials] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun partials(partials: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.polarMotionX] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun polarMotionX(polarMotionX: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.polarMotionY] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun polarMotionY(polarMotionY: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.posUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun posUnc(posUnc: JsonField<Double>) =
                    apply {
                        this.posUnc = posUnc
                    }
                 ...
                 *
                 * You should usually call [Builder.recOdSpan] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun recOdSpan(recOdSpan: JsonField<Double>) =
                    apply {
                        this.recOdSpan = recOdSpan
                    }
                 ...
                 *
                 * You should usually call [Builder.residualsAcc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun residualsAcc(residualsAcc: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.rms] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun rms(rms: JsonField<Double>) =
                    apply {
                        this.rms = rms
                    }
                 ...
                 *
                 * You should usually call [Builder.sigmaPosUvw] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun sigmaPosUvw(sigmaPosUvw: JsonField<List<Double>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addSigmaPosUvw(sigmaPosUvw: Double) =
                    apply {
                        this.sigmaPosUvw = (this.sigmaPosUvw ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.sigmaVelUvw] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun sigmaVelUvw(sigmaVelUvw: JsonField<List<Double>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addSigmaVelUvw(sigmaVelUvw: Double) =
                    apply {
                        this.sigmaVelUvw = (this.sigmaVelUvw ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.solarFluxApAvg] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun solarFluxApAvg(solarFluxApAvg: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.solarFluxF10] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun solarFluxF10(solarFluxF10: JsonField<Double>) =
                    apply {
                        this.solarFluxF10 = solarFluxF10
                    }

                /** F10 (10.7 cm) solar flux 81-day average value. */
                fun solarFluxF10Avg(solarFluxF10Avg: Double) = solarFluxF10Avg(JsonField.of(solarFluxF10Avg))

                /**
                 * Sets [Builder.solarFluxF10Avg] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.solarFluxF10Avg] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun solarFluxF10Avg(solarFluxF10Avg: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.solarRadPress] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun solarRadPress(solarRadPress: JsonField<Boolean>) =
                    apply {
                        this.solarRadPress = solarRadPress
                    }

                /** Area-to-mass ratio coefficient for solar radiation pressure. */
                fun solarRadPressCoeff(solarRadPressCoeff: Double) = solarRadPressCoeff(JsonField.of(solarRadPressCoeff))

                /**
                 * Sets [Builder.solarRadPressCoeff] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.solarRadPressCoeff] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun solarRadPressCoeff(solarRadPressCoeff: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.srpArea] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun srpArea(srpArea: JsonField<Double>) =
                    apply {
                        this.srpArea = srpArea
                    }
                 ...
                 *
                 * You should usually call [Builder.stepMode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun stepMode(stepMode: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.stepSize] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun stepSize(stepSize: JsonField<Double>) =
                    apply {
                        this.stepSize = stepSize
                    }

                /** Initial step size selection (AUTO or MANUAL). */
                fun stepSizeSelection(stepSizeSelection: String) = stepSizeSelection(JsonField.of(stepSizeSelection))

                /**
                 * Sets [Builder.stepSizeSelection] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.stepSizeSelection] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun stepSizeSelection(stepSizeSelection: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.taiUtc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun taiUtc(taiUtc: JsonField<Double>) =
                    apply {
                        this.taiUtc = taiUtc
                    }
                 ...
                 *
                 * You should usually call [Builder.thrustAccel] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun thrustAccel(thrustAccel: JsonField<Double>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.tracksAvail] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun tracksAvail(tracksAvail: JsonField<Int>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.tracksUsed] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun tracksUsed(tracksUsed: JsonField<Int>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.ut1Rate] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun ut1Rate(ut1Rate: JsonField<Double>) =
                    apply {
                        this.ut1Rate = ut1Rate
                    }
                 ...
                 *
                 * You should usually call [Builder.ut1Utc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun ut1Utc(ut1Utc: JsonField<Double>) =
                    apply {
                        this.ut1Utc = ut1Utc
                    }
                 ...
                 *
                 * You should usually call [Builder.velUnc] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun velUnc(velUnc: JsonField<Double>) =
                    apply {
                        this.velUnc = velUnc
                    }
                 ...
                 *
                 * You should usually call [Builder.xposAlt1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun xposAlt1(xposAlt1: JsonField<Double>) =
                    apply {
                        this.xposAlt1 = xposAlt1
                    }
                 ...
                 *
                 * You should usually call [Builder.xposAlt2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun xposAlt2(xposAlt2: JsonField<Double>) =
                    apply {
                        this.xposAlt2 = xposAlt2
                    }
                 ...
                 *
                 * You should usually call [Builder.xvelAlt1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun xvelAlt1(xvelAlt1: JsonField<Double>) =
                    apply {
                        this.xvelAlt1 = xvelAlt1
                    }
                 ...
                 *
                 * You should usually call [Builder.xvelAlt2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun xvelAlt2(xvelAlt2: JsonField<Double>) =
                    apply {
                        this.xvelAlt2 = xvelAlt2
                    }
                 ...
                 *
                 * You should usually call [Builder.yposAlt1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun yposAlt1(yposAlt1: JsonField<Double>) =
                    apply {
                        this.yposAlt1 = yposAlt1
                    }
                 ...
                 *
                 * You should usually call [Builder.yposAlt2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun yposAlt2(yposAlt2: JsonField<Double>) =
                    apply {
                        this.yposAlt2 = yposAlt2
                    }
                 ...
                 *
                 * You should usually call [Builder.yvelAlt1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun yvelAlt1(yvelAlt1: JsonField<Double>) =
                    apply {
                        this.yvelAlt1 = yvelAlt1
                    }
                 ...
                 *
                 * You should usually call [Builder.yvelAlt2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun yvelAlt2(yvelAlt2: JsonField<Double>) =
                    apply {
                        this.yvelAlt2 = yvelAlt2
                    }
                 ...
                 *
                 * You should usually call [Builder.zposAlt1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun zposAlt1(zposAlt1: JsonField<Double>) =
                    apply {
                        this.zposAlt1 = zposAlt1
                    }
                 ...
                 *
                 * You should usually call [Builder.zposAlt2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun zposAlt2(zposAlt2: JsonField<Double>) =
                    apply {
                        this.zposAlt2 = zposAlt2
                    }
                 ...
                 *
                 * You should usually call [Builder.zvelAlt1] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun zvelAlt1(zvelAlt1: JsonField<Double>) =
                    apply {
                        this.zvelAlt1 = zvelAlt1
                    }
                 ...
                 *
                 * You should usually call [Builder.zvelAlt2] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun zvelAlt2(zvelAlt2: JsonField<Double>) =
                    apply {
                        this.zvelAlt2 = zvelAlt2
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (epoch.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (actualOdSpan.asKnown().isPresent) 1 else 0) + (if (algorithm.asKnown().isPresent) 1 else 0) + (if (alt1ReferenceFrame.asKnown().isPresent) 1 else 0) + (if (alt2ReferenceFrame.asKnown().isPresent) 1 else 0) + (if (area.asKnown().isPresent) 1 else 0) + (if (bDot.asKnown().isPresent) 1 else 0) + (if (cmOffset.asKnown().isPresent) 1 else 0) + (cov.asKnown().getOrNull()?.size ?: 0) + (if (covMethod.asKnown().isPresent) 1 else 0) + (covReferenceFrame.asKnown().getOrNull()?.validity() ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (dragArea.asKnown().isPresent) 1 else 0) + (if (dragCoeff.asKnown().isPresent) 1 else 0) + (if (dragModel.asKnown().isPresent) 1 else 0) + (if (edr.asKnown().isPresent) 1 else 0) + (if (effectiveFrom.asKnown().isPresent) 1 else 0) + (if (effectiveUntil.asKnown().isPresent) 1 else 0) + (eqCov.asKnown().getOrNull()?.size ?: 0) + (if (errorControl.asKnown().isPresent) 1 else 0) + (if (fixedStep.asKnown().isPresent) 1 else 0) + (if (geopotentialModel.asKnown().isPresent) 1 else 0) + (if (iau1980Terms.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idOrbitDetermination.asKnown().isPresent) 1 else 0) + (if (idStateVector.asKnown().isPresent) 1 else 0) + (if (integratorMode.asKnown().isPresent) 1 else 0) + (if (inTrackThrust.asKnown().isPresent) 1 else 0) + (if (lastObEnd.asKnown().isPresent) 1 else 0) + (if (lastObStart.asKnown().isPresent) 1 else 0) + (if (leapSecondTime.asKnown().isPresent) 1 else 0) + (if (lunarSolar.asKnown().isPresent) 1 else 0) + (if (mass.asKnown().isPresent) 1 else 0) + (if (obsAvailable.asKnown().isPresent) 1 else 0) + (if (obsUsed.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (partials.asKnown().isPresent) 1 else 0) + (if (pedigree.asKnown().isPresent) 1 else 0) + (if (polarMotionX.asKnown().isPresent) 1 else 0) + (if (polarMotionY.asKnown().isPresent) 1 else 0) + (if (posUnc.asKnown().isPresent) 1 else 0) + (if (rawFileUri.asKnown().isPresent) 1 else 0) + (if (recOdSpan.asKnown().isPresent) 1 else 0) + (referenceFrame.asKnown().getOrNull()?.validity() ?: 0) + (if (residualsAcc.asKnown().isPresent) 1 else 0) + (if (revNo.asKnown().isPresent) 1 else 0) + (if (rms.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (sigmaPosUvw.asKnown().getOrNull()?.size ?: 0) + (sigmaVelUvw.asKnown().getOrNull()?.size ?: 0) + (if (solarFluxApAvg.asKnown().isPresent) 1 else 0) + (if (solarFluxF10.asKnown().isPresent) 1 else 0) + (if (solarFluxF10Avg.asKnown().isPresent) 1 else 0) + (if (solarRadPress.asKnown().isPresent) 1 else 0) + (if (solarRadPressCoeff.asKnown().isPresent) 1 else 0) + (if (solidEarthTides.asKnown().isPresent) 1 else 0) + (sourcedData.asKnown().getOrNull()?.size ?: 0) + (sourcedDataTypes.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (srpArea.asKnown().isPresent) 1 else 0) + (if (stepMode.asKnown().isPresent) 1 else 0) + (if (stepSize.asKnown().isPresent) 1 else 0) + (if (stepSizeSelection.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (taiUtc.asKnown().isPresent) 1 else 0) + (if (thrustAccel.asKnown().isPresent) 1 else 0) + (if (tracksAvail.asKnown().isPresent) 1 else 0) + (if (tracksUsed.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (uct.asKnown().isPresent) 1 else 0) + (if (ut1Rate.asKnown().isPresent) 1 else 0) + (if (ut1Utc.asKnown().isPresent) 1 else 0) + (if (velUnc.asKnown().isPresent) 1 else 0) + (if (xaccel.asKnown().isPresent) 1 else 0) + (if (xpos.asKnown().isPresent) 1 else 0) + (if (xposAlt1.asKnown().isPresent) 1 else 0) + (if (xposAlt2.asKnown().isPresent) 1 else 0) + (if (xvel.asKnown().isPresent) 1 else 0) + (if (xvelAlt1.asKnown().isPresent) 1 else 0) + (if (xvelAlt2.asKnown().isPresent) 1 else 0) + (if (yaccel.asKnown().isPresent) 1 else 0) + (if (ypos.asKnown().isPresent) 1 else 0) + (if (yposAlt1.asKnown().isPresent) 1 else 0) + (if (yposAlt2.asKnown().isPresent) 1 else 0) + (if (yvel.asKnown().isPresent) 1 else 0) + (if (yvelAlt1.asKnown().isPresent) 1 else 0) + (if (yvelAlt2.asKnown().isPresent) 1 else 0) + (if (zaccel.asKnown().isPresent) 1 else 0) + (if (zpos.asKnown().isPresent) 1 else 0) + (if (zposAlt1.asKnown().isPresent) 1 else 0) + (if (zposAlt2.asKnown().isPresent) 1 else 0) + (if (zvel.asKnown().isPresent) 1 else 0) + (if (zvelAlt1.asKnown().isPresent) 1 else 0) + (if (zvelAlt2.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return /* spotless:off */ other is CollectRequest && classificationMarking == other.classificationMarking && dataMode == other.dataMode && source == other.source && startTime == other.startTime && type == other.type && id == other.id && alt == other.alt && argOfPerigee == other.argOfPerigee && az == other.az && collectResponse == other.collectResponse && createdAt == other.createdAt && createdBy == other.createdBy && customer == other.customer && dec == other.dec && duration == other.duration && dwellId == other.dwellId && eccentricity == other.eccentricity && el == other.el && elset == other.elset && endTime == other.endTime && epoch == other.epoch && esId == other.esId && extentAz == other.extentAz && extentEl == other.extentEl && extentRange == other.extentRange && externalId == other.externalId && frameRate == other.frameRate && freq == other.freq && freqMax == other.freqMax && freqMin == other.freqMin && idElset == other.idElset && idManifold == other.idManifold && idOnOrbit == other.idOnOrbit && idParentReq == other.idParentReq && idPlan == other.idPlan && idSensor == other.idSensor && idStateVector == other.idStateVector && inclination == other.inclination && integrationTime == other.integrationTime && iron == other.iron && irradiance == other.irradiance && lat == other.lat && lon == other.lon && msgCreateDate == other.msgCreateDate && msgType == other.msgType && notes == other.notes && numFrames == other.numFrames && numObs == other.numObs && numTracks == other.numTracks && obType == other.obType && orbitRegime == other.orbitRegime && orientAngle == other.orientAngle && origin == other.origin && origNetwork == other.origNetwork && origObjectId == other.origObjectId && origSensorId == other.origSensorId && planIndex == other.planIndex && polarization == other.polarization && priority == other.priority && ra == other.ra && raan == other.raan && range == other.range && rcs == other.rcs && rcsMax == other.rcsMax && rcsMin == other.rcsMin && reflectance == other.reflectance && satNo == other.satNo && scenario == other.scenario && semiMajorAxis == other.semiMajorAxis && spectralModel == other.spectralModel && srchInc == other.srchInc && srchPattern == other.srchPattern && stateVector == other.stateVector && stopAlt == other.stopAlt && stopLat == other.stopLat && stopLon == other.stopLon && suffix == other.suffix && tags == other.tags && targetSize == other.targetSize && taskCategory == other.taskCategory && taskGroup == other.taskGroup && taskId == other.taskId && transactionId == other.transactionId && trueAnomoly == other.trueAnomoly && uctFollowUp == other.uctFollowUp && updatedAt == other.updatedAt && updatedBy == other.updatedBy && visMag == other.visMag && visMagMax == other.visMagMax && visMagMin == other.visMagMin && xAngle == other.xAngle && yAngle == other.yAngle && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, source, startTime, type, id, alt, argOfPerigee, az, collectResponse, createdAt, createdBy, customer, dec, duration, dwellId, eccentricity, el, elset, endTime, epoch, esId, extentAz, extentEl, extentRange, externalId, frameRate, freq, freqMax, freqMin, idElset, idManifold, idOnOrbit, idParentReq, idPlan, idSensor, idStateVector, inclination, integrationTime, iron, irradiance, lat, lon, msgCreateDate, msgType, notes, numFrames, numObs, numTracks, obType, orbitRegime, orientAngle, origin, origNetwork, origObjectId, origSensorId, planIndex, polarization, priority, ra, raan, range, rcs, rcsMax, rcsMin, reflectance, satNo, scenario, semiMajorAxis, spectralModel, srchInc, srchPattern, stateVector, stopAlt, stopLat, stopLon, suffix, tags, targetSize, taskCategory, taskGroup, taskId, transactionId, trueAnomoly, uctFollowUp, updatedAt, updatedBy, visMag, visMagMax, visMagMin, xAngle, yAngle, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "CollectRequest{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, startTime=$startTime, type=$type, id=$id, alt=$alt, argOfPerigee=$argOfPerigee, az=$az, collectResponse=$collectResponse, createdAt=$createdAt, createdBy=$createdBy, customer=$customer, dec=$dec, duration=$duration, dwellId=$dwellId, eccentricity=$eccentricity, el=$el, elset=$elset, endTime=$endTime, epoch=$epoch, esId=$esId, extentAz=$extentAz, extentEl=$extentEl, extentRange=$extentRange, externalId=$externalId, frameRate=$frameRate, freq=$freq, freqMax=$freqMax, freqMin=$freqMin, idElset=$idElset, idManifold=$idManifold, idOnOrbit=$idOnOrbit, idParentReq=$idParentReq, idPlan=$idPlan, idSensor=$idSensor, idStateVector=$idStateVector, inclination=$inclination, integrationTime=$integrationTime, iron=$iron, irradiance=$irradiance, lat=$lat, lon=$lon, msgCreateDate=$msgCreateDate, msgType=$msgType, notes=$notes, numFrames=$numFrames, numObs=$numObs, numTracks=$numTracks, obType=$obType, orbitRegime=$orbitRegime, orientAngle=$orientAngle, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, origSensorId=$origSensorId, planIndex=$planIndex, polarization=$polarization, priority=$priority, ra=$ra, raan=$raan, range=$range, rcs=$rcs, rcsMax=$rcsMax, rcsMin=$rcsMin, reflectance=$reflectance, satNo=$satNo, scenario=$scenario, semiMajorAxis=$semiMajorAxis, spectralModel=$spectralModel, srchInc=$srchInc, srchPattern=$srchPattern, stateVector=$stateVector, stopAlt=$stopAlt, stopLat=$stopLat, stopLon=$stopLon, suffix=$suffix, tags=$tags, targetSize=$targetSize, taskCategory=$taskCategory, taskGroup=$taskGroup, taskId=$taskId, transactionId=$transactionId, trueAnomoly=$trueAnomoly, uctFollowUp=$uctFollowUp, updatedAt=$updatedAt, updatedBy=$updatedBy, visMag=$visMag, visMagMax=$visMagMax, visMagMin=$visMagMin, xAngle=$xAngle, yAngle=$yAngle, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorPlanTupleResponse && classificationMarking == other.classificationMarking && dataMode == other.dataMode && recType == other.recType && source == other.source && startTime == other.startTime && type == other.type && id == other.id && collectRequests == other.collectRequests && createdAt == other.createdAt && createdBy == other.createdBy && customer == other.customer && endTime == other.endTime && idSensor == other.idSensor && name == other.name && origin == other.origin && origNetwork == other.origNetwork && origSensorId == other.origSensorId && purpose == other.purpose && reqTotal == other.reqTotal && senNetwork == other.senNetwork && status == other.status && tags == other.tags && updatedAt == other.updatedAt && updatedBy == other.updatedBy && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, recType, source, startTime, type, id, collectRequests, createdAt, createdBy, customer, endTime, idSensor, name, origin, origNetwork, origSensorId, purpose, reqTotal, senNetwork, status, tags, updatedAt, updatedBy, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() = "SensorPlanTupleResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, recType=$recType, source=$source, startTime=$startTime, type=$type, id=$id, collectRequests=$collectRequests, createdAt=$createdAt, createdBy=$createdBy, customer=$customer, endTime=$endTime, idSensor=$idSensor, name=$name, origin=$origin, origNetwork=$origNetwork, origSensorId=$origSensorId, purpose=$purpose, reqTotal=$reqTotal, senNetwork=$senNetwork, status=$status, tags=$tags, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
