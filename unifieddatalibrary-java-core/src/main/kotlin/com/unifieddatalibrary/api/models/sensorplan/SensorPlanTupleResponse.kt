...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                /** Mission center or organization performing this vector creation. */
                fun missionCenter(missionCenter: String) =
                    missionCenter(JsonField.of(missionCenter))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorPlanTupleResponse &&
            classificationMarking == other.classificationMarking &&
            dataMode == other.dataMode &&
            ...
            type == other.type &&
            id == other.id &&
            collectRequests == other.collectRequests &&
            createdAt == other.createdAt &&
            createdBy == other.createdBy &&
            customer == other.customer &&
            endTime == other.endTime &&
