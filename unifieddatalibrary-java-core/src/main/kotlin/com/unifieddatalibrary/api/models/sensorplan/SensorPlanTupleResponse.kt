...
private constructor(
    ...
    /**
     * The list of collect requests belonging to the SensorPlan. Each collect request is associated
     * with a parent SensorPlan via the IdPlan. If provided, the list must have the same size as
     * reqTotal.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    fun collectRequests(): Optional<List<CollectRequest>> =
        collectRequests.getOptional("collectRequests")
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorPlanTupleResponse: SensorPlanTupleResponse) = apply {
        ...
        /**
         * The list of collect requests belonging to the SensorPlan. Each collect request is
         * associated with a parent SensorPlan via the IdPlan. If provided, the list must have the
         * same size as reqTotal.
         */
        fun collectRequests(collectRequests: List<CollectRequest>) =
            collectRequests(JsonField.of(collectRequests))

        /**
         * Sets [Builder.collectRequests] to an arbitrary JSON value.
         *
         * You should usually call [Builder.collectRequests] with a well-typed
         * `List<CollectRequest>` value instead. This method is primarily for setting the field to
         * an undocumented or not yet supported value.
         */
        fun collectRequests(collectRequests: JsonField<List<CollectRequest>>) = apply {
         ...
         */
        fun addCollectRequest(collectRequest: CollectRequest) = apply {
            collectRequests =
                (collectRequests ?: JsonField.of(mutableListOf())).also {
    ...
    fun validate(): SensorPlanTupleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (classificationMarking.asKnown().isPresent) 1 else 0) +
            ...
            (collectRequests.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
         ...
         *
         * Unlike [collectResponse], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("collectResponse")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(collectRequest: CollectRequest) = apply {
             ...
             * `List<CollectResponseFull>` value instead. This method is primarily for setting the
        ...
        fun validate(): CollectRequest = apply {
            if (validated) {
                return@apply
            }
        ...
        private constructor(
             ...
             *   type (e.g. if the server responded with an unexpected value).
             */
            fun effectiveFrom(): Optional<OffsetDateTime> =
                effectiveFrom.getOptional("effectiveFrom")
             ...
             *
             * Unlike [effectiveUntil], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("effectiveUntil")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.effectiveFrom] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.effectiveUntil] with a well-typed
                 * [OffsetDateTime] value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
    ...
    override fun toString() =
        "SensorPlanTupleResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, recType=$recType, source=$source, startTime=$startTime, type=$type, id=$id, collectRequests=$collectRequests, createdAt=$createdAt, createdBy=$createdBy, customer=$customer, endTime=$endTime, idSensor=$idSensor, name=$name, origin=$origin, origNetwork=$origNetwork, origSensorId=$origSensorId, purpose=$purpose, reqTotal=$reqTotal, senNetwork=$senNetwork, status=$status, tags=$tags, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
