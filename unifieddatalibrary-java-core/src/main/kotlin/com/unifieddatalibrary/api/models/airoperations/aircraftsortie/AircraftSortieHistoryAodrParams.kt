 ...
 */
class AircraftSortieHistoryAodrParams
private constructor(
    ...
    /** A builder for [AircraftSortieHistoryAodrParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortieHistoryAodrParams: AircraftSortieHistoryAodrParams) =
            apply {
                plannedDepTime = aircraftSortieHistoryAodrParams.plannedDepTime
                columns = aircraftSortieHistoryAodrParams.columns
                firstResult = aircraftSortieHistoryAodrParams.firstResult
                maxResults = aircraftSortieHistoryAodrParams.maxResults
                notification = aircraftSortieHistoryAodrParams.notification
                outputDelimiter = aircraftSortieHistoryAodrParams.outputDelimiter
                outputFormat = aircraftSortieHistoryAodrParams.outputFormat
                additionalHeaders = aircraftSortieHistoryAodrParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    aircraftSortieHistoryAodrParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortieHistoryAodrParams].
         *
         ...
         */
        fun build(): AircraftSortieHistoryAodrParams =
            AircraftSortieHistoryAodrParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AircraftSortieHistoryAodrParams && plannedDepTime == other.plannedDepTime && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && notification == other.notification && outputDelimiter == other.outputDelimiter && outputFormat == other.outputFormat && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(plannedDepTime, columns, firstResult, maxResults, notification, outputDelimiter, outputFormat, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AircraftSortieHistoryAodrParams{plannedDepTime=$plannedDepTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
