...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BatteryListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BatteryListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BatteryListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batteryListParams: BatteryListParams) = apply {
            firstResult = batteryListParams.firstResult
            maxResults = batteryListParams.maxResults
            additionalHeaders = batteryListParams.additionalHeaders.toBuilder()
            additionalQueryParams = batteryListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatteryListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatteryListParams =
            BatteryListParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatteryListParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BatteryListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
