...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfBandGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandGetParams: RfBandGetParams) = apply {
    ...
    override fun toString() =
        "RfBandGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
