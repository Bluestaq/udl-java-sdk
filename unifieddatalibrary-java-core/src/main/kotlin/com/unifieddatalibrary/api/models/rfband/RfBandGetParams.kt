...
class RfBandGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): RfBandGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RfBandGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfBandGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandGetParams: RfBandGetParams) =
            apply {
                id = rfBandGetParams.id
                firstResult = rfBandGetParams.firstResult
                maxResults = rfBandGetParams.maxResults
                additionalHeaders = rfBandGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfBandGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfBandGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfBandGetParams =
            RfBandGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfBandGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfBandGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
