...
class RfEmitterGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): RfEmitterGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RfEmitterGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RfEmitterGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterGetParams: RfEmitterGetParams) =
            apply {
                id = rfEmitterGetParams.id
                firstResult = rfEmitterGetParams.firstResult
                maxResults = rfEmitterGetParams.maxResults
                additionalHeaders = rfEmitterGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = rfEmitterGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RfEmitterGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RfEmitterGetParams =
            RfEmitterGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RfEmitterGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RfEmitterGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
