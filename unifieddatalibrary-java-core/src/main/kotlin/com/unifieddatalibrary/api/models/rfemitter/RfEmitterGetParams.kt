...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfEmitterGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfEmitterGetParams: RfEmitterGetParams) = apply {
    ...
    override fun toString() =
        "RfEmitterGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
