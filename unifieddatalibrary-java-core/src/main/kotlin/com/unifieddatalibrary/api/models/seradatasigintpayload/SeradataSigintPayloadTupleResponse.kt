...
class SeradataSigintPayloadTupleResponse
private constructor(
        ...
        internal fun from(seradataSigintPayloadTupleResponse: SeradataSigintPayloadTupleResponse) =
            apply {
                ...
                additionalProperties =
                    seradataSigintPayloadTupleResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): SeradataSigintPayloadTupleResponse = apply {
        if (validated) {
            return@apply
        }
