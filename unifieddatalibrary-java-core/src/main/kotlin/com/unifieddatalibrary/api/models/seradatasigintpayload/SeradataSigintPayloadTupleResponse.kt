...
class SeradataSigintPayloadTupleResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataSigintPayloadTupleResponse].
         *
    ...
    /** A builder for [SeradataSigintPayloadTupleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataSigintPayloadTupleResponse: SeradataSigintPayloadTupleResponse) =
            apply {
                classificationMarking = seradataSigintPayloadTupleResponse.classificationMarking
                dataMode = seradataSigintPayloadTupleResponse.dataMode
                source = seradataSigintPayloadTupleResponse.source
                spacecraftId = seradataSigintPayloadTupleResponse.spacecraftId
                id = seradataSigintPayloadTupleResponse.id
                createdAt = seradataSigintPayloadTupleResponse.createdAt
                createdBy = seradataSigintPayloadTupleResponse.createdBy
                frequencyCoverage = seradataSigintPayloadTupleResponse.frequencyCoverage
                groundStationLocations = seradataSigintPayloadTupleResponse.groundStationLocations
                groundStations = seradataSigintPayloadTupleResponse.groundStations
                hostedForCompanyOrgId = seradataSigintPayloadTupleResponse.hostedForCompanyOrgId
                idSensor = seradataSigintPayloadTupleResponse.idSensor
                interceptParameters = seradataSigintPayloadTupleResponse.interceptParameters
                manufacturerOrgId = seradataSigintPayloadTupleResponse.manufacturerOrgId
                name = seradataSigintPayloadTupleResponse.name
                notes = seradataSigintPayloadTupleResponse.notes
                origin = seradataSigintPayloadTupleResponse.origin
                origNetwork = seradataSigintPayloadTupleResponse.origNetwork
                positionalAccuracy = seradataSigintPayloadTupleResponse.positionalAccuracy
                swathWidth = seradataSigintPayloadTupleResponse.swathWidth
                type = seradataSigintPayloadTupleResponse.type
                updatedAt = seradataSigintPayloadTupleResponse.updatedAt
                updatedBy = seradataSigintPayloadTupleResponse.updatedBy
                additionalProperties = seradataSigintPayloadTupleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataSigintPayloadTupleResponse].
         *
         ...
         */
        fun build(): SeradataSigintPayloadTupleResponse =
    ...
    fun validate(): SeradataSigintPayloadTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
