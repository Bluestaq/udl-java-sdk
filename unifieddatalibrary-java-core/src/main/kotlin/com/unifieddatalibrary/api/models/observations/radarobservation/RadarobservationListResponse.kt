 ...
 */
class RadarobservationListResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationListResponse: RadarobservationListResponse) = apply {
    ...
    fun validate(): RadarobservationListResponse = apply {
        if (validated) {
            return@apply
        }
