...
class RadarobservationListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RadarobservationListResponse].
         *
    ...
    /** A builder for [RadarobservationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radarobservationListResponse: RadarobservationListResponse) =
            apply {
                classificationMarking = radarobservationListResponse.classificationMarking
                dataMode = radarobservationListResponse.dataMode
                obTime = radarobservationListResponse.obTime
                source = radarobservationListResponse.source
                id = radarobservationListResponse.id
                azimuth = radarobservationListResponse.azimuth
                azimuthBias = radarobservationListResponse.azimuthBias
                azimuthMeasured = radarobservationListResponse.azimuthMeasured
                azimuthRate = radarobservationListResponse.azimuthRate
                azimuthUnc = radarobservationListResponse.azimuthUnc
                beam = radarobservationListResponse.beam
                createdAt = radarobservationListResponse.createdAt
                createdBy = radarobservationListResponse.createdBy
                declination = radarobservationListResponse.declination
                declinationMeasured = radarobservationListResponse.declinationMeasured
                descriptor = radarobservationListResponse.descriptor
                doppler = radarobservationListResponse.doppler
                dopplerUnc = radarobservationListResponse.dopplerUnc
                elevation = radarobservationListResponse.elevation
                elevationBias = radarobservationListResponse.elevationBias
                elevationMeasured = radarobservationListResponse.elevationMeasured
                elevationRate = radarobservationListResponse.elevationRate
                elevationUnc = radarobservationListResponse.elevationUnc
                idOnOrbit = radarobservationListResponse.idOnOrbit
                idSensor = radarobservationListResponse.idSensor
                obPosition = radarobservationListResponse.obPosition
                origin = radarobservationListResponse.origin
                origNetwork = radarobservationListResponse.origNetwork
                origObjectId = radarobservationListResponse.origObjectId
                origSensorId = radarobservationListResponse.origSensorId
                orthogonalRcs = radarobservationListResponse.orthogonalRcs
                orthogonalRcsUnc = radarobservationListResponse.orthogonalRcsUnc
                ra = radarobservationListResponse.ra
                raMeasured = radarobservationListResponse.raMeasured
                range = radarobservationListResponse.range
                rangeAccel = radarobservationListResponse.rangeAccel
                rangeAccelUnc = radarobservationListResponse.rangeAccelUnc
                rangeBias = radarobservationListResponse.rangeBias
                rangeMeasured = radarobservationListResponse.rangeMeasured
                rangeRate = radarobservationListResponse.rangeRate
                rangeRateMeasured = radarobservationListResponse.rangeRateMeasured
                rangeRateUnc = radarobservationListResponse.rangeRateUnc
                rangeUnc = radarobservationListResponse.rangeUnc
                rawFileUri = radarobservationListResponse.rawFileUri
                rcs = radarobservationListResponse.rcs
                rcsUnc = radarobservationListResponse.rcsUnc
                satNo = radarobservationListResponse.satNo
                senReferenceFrame = radarobservationListResponse.senReferenceFrame
                senx = radarobservationListResponse.senx
                seny = radarobservationListResponse.seny
                senz = radarobservationListResponse.senz
                snr = radarobservationListResponse.snr
                sourceDl = radarobservationListResponse.sourceDl
                taskId = radarobservationListResponse.taskId
                timingBias = radarobservationListResponse.timingBias
                trackId = radarobservationListResponse.trackId
                trackingState = radarobservationListResponse.trackingState
                transactionId = radarobservationListResponse.transactionId
                type = radarobservationListResponse.type
                uct = radarobservationListResponse.uct
                x = radarobservationListResponse.x
                xvel = radarobservationListResponse.xvel
                y = radarobservationListResponse.y
                yvel = radarobservationListResponse.yvel
                z = radarobservationListResponse.z
                zvel = radarobservationListResponse.zvel
                additionalProperties = radarobservationListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RadarobservationListResponse].
         *
         ...
         */
        fun build(): RadarobservationListResponse =
    ...
    fun validate(): RadarobservationListResponse =
        apply {
            if (validated) {
              return@apply
            }
