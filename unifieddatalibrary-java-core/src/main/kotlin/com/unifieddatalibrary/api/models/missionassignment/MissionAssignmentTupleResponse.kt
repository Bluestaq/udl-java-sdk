...
class MissionAssignmentTupleResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentTupleResponse: MissionAssignmentTupleResponse) = apply {
            ...
            additionalProperties =
                missionAssignmentTupleResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): MissionAssignmentTupleResponse = apply {
        if (validated) {
            return@apply
        }
