 ...
 */
class ObscorrelationRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ObscorrelationRetrieveParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ObscorrelationRetrieveParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ObscorrelationRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(obscorrelationRetrieveParams: ObscorrelationRetrieveParams) = apply {
            id = obscorrelationRetrieveParams.id
            firstResult = obscorrelationRetrieveParams.firstResult
            maxResults = obscorrelationRetrieveParams.maxResults
            additionalHeaders = obscorrelationRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = obscorrelationRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ObscorrelationRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ObscorrelationRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObscorrelationRetrieveParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ObscorrelationRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
