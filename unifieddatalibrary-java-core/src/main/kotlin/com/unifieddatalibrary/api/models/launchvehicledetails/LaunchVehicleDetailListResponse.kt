 ...
 */
class LaunchVehicleDetailListResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(launchVehicleDetailListResponse: LaunchVehicleDetailListResponse) =
            apply {
                ...
                gtoInj3SigAccuracyApogeeMargin =
                    launchVehicleDetailListResponse.gtoInj3SigAccuracyApogeeMargin
                gtoInj3SigAccuracyApogeeTarget =
                    launchVehicleDetailListResponse.gtoInj3SigAccuracyApogeeTarget
                gtoInj3SigAccuracyInclinationMargin =
                    launchVehicleDetailListResponse.gtoInj3SigAccuracyInclinationMargin
                gtoInj3SigAccuracyInclinationTarget =
                    launchVehicleDetailListResponse.gtoInj3SigAccuracyInclinationTarget
                gtoInj3SigAccuracyPerigeeMargin =
                    launchVehicleDetailListResponse.gtoInj3SigAccuracyPerigeeMargin
                gtoInj3SigAccuracyPerigeeTarget =
                    launchVehicleDetailListResponse.gtoInj3SigAccuracyPerigeeTarget
                ...
                additionalProperties =
                    launchVehicleDetailListResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): LaunchVehicleDetailListResponse = apply {
        if (validated) {
            return@apply
        }
