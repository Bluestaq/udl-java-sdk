...
class LaunchVehicleDetailListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchVehicleDetailListResponse].
         *
    ...
    /** A builder for [LaunchVehicleDetailListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchVehicleDetailListResponse: LaunchVehicleDetailListResponse) =
            apply {
                classificationMarking = launchVehicleDetailListResponse.classificationMarking
                dataMode = launchVehicleDetailListResponse.dataMode
                idLaunchVehicle = launchVehicleDetailListResponse.idLaunchVehicle
                source = launchVehicleDetailListResponse.source
                id = launchVehicleDetailListResponse.id
                attitudeAccuracy = launchVehicleDetailListResponse.attitudeAccuracy
                category = launchVehicleDetailListResponse.category
                createdAt = launchVehicleDetailListResponse.createdAt
                createdBy = launchVehicleDetailListResponse.createdBy
                deploymentRotationRate = launchVehicleDetailListResponse.deploymentRotationRate
                diameter = launchVehicleDetailListResponse.diameter
                estLaunchPrice = launchVehicleDetailListResponse.estLaunchPrice
                estLaunchPriceTypical = launchVehicleDetailListResponse.estLaunchPriceTypical
                fairingExternalDiameter = launchVehicleDetailListResponse.fairingExternalDiameter
                fairingInternalDiameter = launchVehicleDetailListResponse.fairingInternalDiameter
                fairingLength = launchVehicleDetailListResponse.fairingLength
                fairingMass = launchVehicleDetailListResponse.fairingMass
                fairingMaterial = launchVehicleDetailListResponse.fairingMaterial
                fairingName = launchVehicleDetailListResponse.fairingName
                fairingNotes = launchVehicleDetailListResponse.fairingNotes
                family = launchVehicleDetailListResponse.family
                geoPayloadMass = launchVehicleDetailListResponse.geoPayloadMass
                gtoInj3SigAccuracyApogeeMargin = launchVehicleDetailListResponse.gtoInj3SigAccuracyApogeeMargin
                gtoInj3SigAccuracyApogeeTarget = launchVehicleDetailListResponse.gtoInj3SigAccuracyApogeeTarget
                gtoInj3SigAccuracyInclinationMargin = launchVehicleDetailListResponse.gtoInj3SigAccuracyInclinationMargin
                gtoInj3SigAccuracyInclinationTarget = launchVehicleDetailListResponse.gtoInj3SigAccuracyInclinationTarget
                gtoInj3SigAccuracyPerigeeMargin = launchVehicleDetailListResponse.gtoInj3SigAccuracyPerigeeMargin
                gtoInj3SigAccuracyPerigeeTarget = launchVehicleDetailListResponse.gtoInj3SigAccuracyPerigeeTarget
                gtoPayloadMass = launchVehicleDetailListResponse.gtoPayloadMass
                launchMass = launchVehicleDetailListResponse.launchMass
                launchPrefix = launchVehicleDetailListResponse.launchPrefix
                length = launchVehicleDetailListResponse.length
                leoPayloadMass = launchVehicleDetailListResponse.leoPayloadMass
                manufacturerOrgId = launchVehicleDetailListResponse.manufacturerOrgId
                maxAccelLoad = launchVehicleDetailListResponse.maxAccelLoad
                maxAcousticLevel = launchVehicleDetailListResponse.maxAcousticLevel
                maxAcousticLevelRange = launchVehicleDetailListResponse.maxAcousticLevelRange
                maxFairingPressureChange = launchVehicleDetailListResponse.maxFairingPressureChange
                maxFlightShockForce = launchVehicleDetailListResponse.maxFlightShockForce
                maxFlightShockFreq = launchVehicleDetailListResponse.maxFlightShockFreq
                maxPayloadFreqLat = launchVehicleDetailListResponse.maxPayloadFreqLat
                maxPayloadFreqLon = launchVehicleDetailListResponse.maxPayloadFreqLon
                minorVariant = launchVehicleDetailListResponse.minorVariant
                notes = launchVehicleDetailListResponse.notes
                origin = launchVehicleDetailListResponse.origin
                origNetwork = launchVehicleDetailListResponse.origNetwork
                oxidizer = launchVehicleDetailListResponse.oxidizer
                payloadNotes = launchVehicleDetailListResponse.payloadNotes
                payloadSeparationRate = launchVehicleDetailListResponse.payloadSeparationRate
                propellant = launchVehicleDetailListResponse.propellant
                soundPressureLevel = launchVehicleDetailListResponse.soundPressureLevel
                sourceUrl = launchVehicleDetailListResponse.sourceUrl
                ssoPayloadMass = launchVehicleDetailListResponse.ssoPayloadMass
                variant = launchVehicleDetailListResponse.variant
                additionalProperties = launchVehicleDetailListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchVehicleDetailListResponse].
         *
         ...
         */
        fun build(): LaunchVehicleDetailListResponse =
    ...
    fun validate(): LaunchVehicleDetailListResponse =
        apply {
            if (validated) {
              return@apply
            }
