...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteCreateParams].
         *
    ...
    /** A builder for [LaunchSiteCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteCreateParams: LaunchSiteCreateParams) = apply {
            body = launchSiteCreateParams.body.toBuilder()
            additionalHeaders = launchSiteCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = launchSiteCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteCreateParams].
         *
         ...
         */
        fun build(): LaunchSiteCreateParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, code=$code, dataMode=$dataMode, name=$name, source=$source, id=$id, altCode=$altCode, createdAt=$createdAt, createdBy=$createdBy, idSite=$idSite, origin=$origin, origNetwork=$origNetwork, shortCode=$shortCode, additionalProperties=$additionalProperties}"
    }
