...
class EopListPageAsync private constructor(
    ...
    fun autoPager(): AutoPagerAsync<EopAbridged> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopListPageAsync: EopListPageAsync) =
            apply {
        ...
        fun service(service: EopServiceAsync) =
            apply {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: EopListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<EopAbridged>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "EopListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
