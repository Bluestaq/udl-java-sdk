...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrQueryHelpResponse: EcpsdrQueryHelpResponse) = apply {
    ...
    fun validate(): EcpsdrQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
