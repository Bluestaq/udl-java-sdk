...
class EcpsdrQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EcpsdrQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EcpsdrQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpsdrQueryHelpResponse: EcpsdrQueryHelpResponse) =
            apply {
                aodrSupported = ecpsdrQueryHelpResponse.aodrSupported
                classificationMarking = ecpsdrQueryHelpResponse.classificationMarking
                description = ecpsdrQueryHelpResponse.description
                historySupported = ecpsdrQueryHelpResponse.historySupported
                name = ecpsdrQueryHelpResponse.name
                parameters = ecpsdrQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = ecpsdrQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = ecpsdrQueryHelpResponse.restSupported
                sortSupported = ecpsdrQueryHelpResponse.sortSupported
                typeName = ecpsdrQueryHelpResponse.typeName
                uri = ecpsdrQueryHelpResponse.uri
                additionalProperties = ecpsdrQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EcpsdrQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EcpsdrQueryHelpResponse =
    ...
    fun validate(): EcpsdrQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
