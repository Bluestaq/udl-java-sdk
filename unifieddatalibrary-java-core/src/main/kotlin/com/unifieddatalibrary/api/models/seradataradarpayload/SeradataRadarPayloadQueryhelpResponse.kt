...
class SeradataRadarPayloadQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataRadarPayloadQueryhelpResponse: SeradataRadarPayloadQueryhelpResponse
        ) = apply {
            ...
            requiredRoles =
                seradataRadarPayloadQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                seradataRadarPayloadQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): SeradataRadarPayloadQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
