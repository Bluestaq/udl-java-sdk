...
class SeradataRadarPayloadQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SeradataRadarPayloadQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SeradataRadarPayloadQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataRadarPayloadQueryhelpResponse: SeradataRadarPayloadQueryhelpResponse) =
            apply {
                aodrSupported = seradataRadarPayloadQueryhelpResponse.aodrSupported
                classificationMarking = seradataRadarPayloadQueryhelpResponse.classificationMarking
                description = seradataRadarPayloadQueryhelpResponse.description
                historySupported = seradataRadarPayloadQueryhelpResponse.historySupported
                name = seradataRadarPayloadQueryhelpResponse.name
                parameters = seradataRadarPayloadQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = seradataRadarPayloadQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = seradataRadarPayloadQueryhelpResponse.restSupported
                sortSupported = seradataRadarPayloadQueryhelpResponse.sortSupported
                typeName = seradataRadarPayloadQueryhelpResponse.typeName
                uri = seradataRadarPayloadQueryhelpResponse.uri
                additionalProperties = seradataRadarPayloadQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SeradataRadarPayloadQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeradataRadarPayloadQueryhelpResponse =
    ...
    fun validate(): SeradataRadarPayloadQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataRadarPayloadQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
