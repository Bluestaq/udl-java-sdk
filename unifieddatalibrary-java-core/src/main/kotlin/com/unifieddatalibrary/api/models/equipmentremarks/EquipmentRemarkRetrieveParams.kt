...
/**
 * Service operation to get a single equipmentremark record by its unique ID passed as a path
 * parameter.
 */
class EquipmentRemarkRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EquipmentRemarkRetrieveParams = builder().build()
    ...
    /** A builder for [EquipmentRemarkRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentRemarkRetrieveParams: EquipmentRemarkRetrieveParams) = apply {
            id = equipmentRemarkRetrieveParams.id
            firstResult = equipmentRemarkRetrieveParams.firstResult
            maxResults = equipmentRemarkRetrieveParams.maxResults
            additionalHeaders = equipmentRemarkRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = equipmentRemarkRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EquipmentRemarkRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EquipmentRemarkRetrieveParams =
            EquipmentRemarkRetrieveParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EquipmentRemarkRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "EquipmentRemarkRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
