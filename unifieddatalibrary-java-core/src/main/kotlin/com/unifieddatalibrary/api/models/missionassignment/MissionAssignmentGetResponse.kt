...
class MissionAssignmentGetResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentGetResponse: MissionAssignmentGetResponse) = apply {
    ...
    fun validate(): MissionAssignmentGetResponse = apply {
        if (validated) {
            return@apply
        }
