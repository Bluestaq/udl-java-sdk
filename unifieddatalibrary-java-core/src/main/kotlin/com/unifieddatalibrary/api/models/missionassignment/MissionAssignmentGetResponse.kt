...
class MissionAssignmentGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissionAssignmentGetResponse].
         *
    ...
    /** A builder for [MissionAssignmentGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionAssignmentGetResponse: MissionAssignmentGetResponse) =
            apply {
                classificationMarking = missionAssignmentGetResponse.classificationMarking
                dataMode = missionAssignmentGetResponse.dataMode
                mad = missionAssignmentGetResponse.mad
                source = missionAssignmentGetResponse.source
                ts = missionAssignmentGetResponse.ts
                id = missionAssignmentGetResponse.id
                c1associateddmpis = missionAssignmentGetResponse.c1associateddmpis
                c2air = missionAssignmentGetResponse.c2air
                c2alt = missionAssignmentGetResponse.c2alt
                c2crs = missionAssignmentGetResponse.c2crs
                c2exerciseindicator = missionAssignmentGetResponse.c2exerciseindicator
                c2exercisemof = missionAssignmentGetResponse.c2exercisemof
                c2id = missionAssignmentGetResponse.c2id
                c2idamplifyingdescriptor = missionAssignmentGetResponse.c2idamplifyingdescriptor
                c2lnd = missionAssignmentGetResponse.c2lnd
                c2spc = missionAssignmentGetResponse.c2spc
                c2spd = missionAssignmentGetResponse.c2spd
                c2specialinterestindicator = missionAssignmentGetResponse.c2specialinterestindicator
                c2sur = missionAssignmentGetResponse.c2sur
                c3elv = missionAssignmentGetResponse.c3elv
                c3lat = missionAssignmentGetResponse.c3lat
                c3lon = missionAssignmentGetResponse.c3lon
                c3ptl = missionAssignmentGetResponse.c3ptl
                c3ptnum = missionAssignmentGetResponse.c3ptnum
                c4colon = missionAssignmentGetResponse.c4colon
                c4def = missionAssignmentGetResponse.c4def
                c4egress = missionAssignmentGetResponse.c4egress
                c4mod = missionAssignmentGetResponse.c4mod
                c4numberofstores = missionAssignmentGetResponse.c4numberofstores
                c4runin = missionAssignmentGetResponse.c4runin
                c4tgt = missionAssignmentGetResponse.c4tgt
                c4timediscrete = missionAssignmentGetResponse.c4timediscrete
                c4tm = missionAssignmentGetResponse.c4tm
                c4typeofstores = missionAssignmentGetResponse.c4typeofstores
                c5colon = missionAssignmentGetResponse.c5colon
                c5elevationlsbs = missionAssignmentGetResponse.c5elevationlsbs
                c5haeadj = missionAssignmentGetResponse.c5haeadj
                c5latlsb = missionAssignmentGetResponse.c5latlsb
                c5lonlsb = missionAssignmentGetResponse.c5lonlsb
                c5tgtbrng = missionAssignmentGetResponse.c5tgtbrng
                c5tw = missionAssignmentGetResponse.c5tw
                c6dspc = missionAssignmentGetResponse.c6dspc
                c6dspct = missionAssignmentGetResponse.c6dspct
                c6fplpm = missionAssignmentGetResponse.c6fplpm
                c6intel = missionAssignmentGetResponse.c6intel
                c6laser = missionAssignmentGetResponse.c6laser
                c6longpm = missionAssignmentGetResponse.c6longpm
                c6tnr3 = missionAssignmentGetResponse.c6tnr3
                c7elang2 = missionAssignmentGetResponse.c7elang2
                c7in3p = missionAssignmentGetResponse.c7in3p
                c7tnor = missionAssignmentGetResponse.c7tnor
                createdAt = missionAssignmentGetResponse.createdAt
                createdBy = missionAssignmentGetResponse.createdBy
                env = missionAssignmentGetResponse.env
                index = missionAssignmentGetResponse.index
                lat = missionAssignmentGetResponse.lat
                lon = missionAssignmentGetResponse.lon
                orginx = missionAssignmentGetResponse.orginx
                origin = missionAssignmentGetResponse.origin
                origNetwork = missionAssignmentGetResponse.origNetwork
                rc = missionAssignmentGetResponse.rc
                rr = missionAssignmentGetResponse.rr
                sz = missionAssignmentGetResponse.sz
                tno = missionAssignmentGetResponse.tno
                trkId = missionAssignmentGetResponse.trkId
                twenv = missionAssignmentGetResponse.twenv
                updatedAt = missionAssignmentGetResponse.updatedAt
                updatedBy = missionAssignmentGetResponse.updatedBy
                additionalProperties = missionAssignmentGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MissionAssignmentGetResponse].
         *
         ...
         */
        fun build(): MissionAssignmentGetResponse =
    ...
    fun validate(): MissionAssignmentGetResponse =
        apply {
            if (validated) {
              return@apply
            }
