...
class EffectRequestRetrieveResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectRequestRetrieveResponse].
         *
    ...
    /** A builder for [EffectRequestRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestRetrieveResponse: EffectRequestRetrieveResponse) =
            apply {
                classificationMarking = effectRequestRetrieveResponse.classificationMarking
                dataMode = effectRequestRetrieveResponse.dataMode
                effectList = effectRequestRetrieveResponse.effectList.map { it.toMutableList() }
                source = effectRequestRetrieveResponse.source
                id = effectRequestRetrieveResponse.id
                context = effectRequestRetrieveResponse.context
                createdAt = effectRequestRetrieveResponse.createdAt
                createdBy = effectRequestRetrieveResponse.createdBy
                deadlineType = effectRequestRetrieveResponse.deadlineType
                endTime = effectRequestRetrieveResponse.endTime
                externalRequestId = effectRequestRetrieveResponse.externalRequestId
                metricTypes = effectRequestRetrieveResponse.metricTypes.map { it.toMutableList() }
                metricWeights = effectRequestRetrieveResponse.metricWeights.map { it.toMutableList() }
                modelClass = effectRequestRetrieveResponse.modelClass
                origin = effectRequestRetrieveResponse.origin
                origNetwork = effectRequestRetrieveResponse.origNetwork
                priority = effectRequestRetrieveResponse.priority
                startTime = effectRequestRetrieveResponse.startTime
                state = effectRequestRetrieveResponse.state
                targetSrcId = effectRequestRetrieveResponse.targetSrcId
                targetSrcType = effectRequestRetrieveResponse.targetSrcType
                additionalProperties = effectRequestRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EffectRequestRetrieveResponse].
         *
         ...
         */
        fun build(): EffectRequestRetrieveResponse =
    ...
    fun validate(): EffectRequestRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
