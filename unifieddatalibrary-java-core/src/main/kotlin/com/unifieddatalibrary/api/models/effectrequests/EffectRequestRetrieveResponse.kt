...
class EffectRequestRetrieveResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectRequestRetrieveResponse: EffectRequestRetrieveResponse) = apply {
    ...
    fun validate(): EffectRequestRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
