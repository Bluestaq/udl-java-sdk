...
class EmitterGeolocationQueryResponse
private constructor(
        ...
        internal fun from(emitterGeolocationQueryResponse: EmitterGeolocationQueryResponse) =
            apply {
                ...
                additionalProperties =
                    emitterGeolocationQueryResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): EmitterGeolocationQueryResponse = apply {
        if (validated) {
            return@apply
        }
