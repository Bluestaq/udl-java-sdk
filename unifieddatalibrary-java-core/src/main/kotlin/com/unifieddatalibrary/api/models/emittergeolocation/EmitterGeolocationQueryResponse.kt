...
class EmitterGeolocationQueryResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmitterGeolocationQueryResponse].
         *
    ...
    /** A builder for [EmitterGeolocationQueryResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emitterGeolocationQueryResponse: EmitterGeolocationQueryResponse) =
            apply {
                classificationMarking = emitterGeolocationQueryResponse.classificationMarking
                dataMode = emitterGeolocationQueryResponse.dataMode
                signalOfInterestType = emitterGeolocationQueryResponse.signalOfInterestType
                source = emitterGeolocationQueryResponse.source
                startTime = emitterGeolocationQueryResponse.startTime
                id = emitterGeolocationQueryResponse.id
                agjson = emitterGeolocationQueryResponse.agjson
                algVersion = emitterGeolocationQueryResponse.algVersion
                andims = emitterGeolocationQueryResponse.andims
                asrid = emitterGeolocationQueryResponse.asrid
                atext = emitterGeolocationQueryResponse.atext
                atype = emitterGeolocationQueryResponse.atype
                centerFreq = emitterGeolocationQueryResponse.centerFreq
                cluster = emitterGeolocationQueryResponse.cluster
                confArea = emitterGeolocationQueryResponse.confArea
                constellation = emitterGeolocationQueryResponse.constellation
                createdAt = emitterGeolocationQueryResponse.createdAt
                createdBy = emitterGeolocationQueryResponse.createdBy
                createdTs = emitterGeolocationQueryResponse.createdTs
                detectAlt = emitterGeolocationQueryResponse.detectAlt
                detectLat = emitterGeolocationQueryResponse.detectLat
                detectLon = emitterGeolocationQueryResponse.detectLon
                endTime = emitterGeolocationQueryResponse.endTime
                errEllp = emitterGeolocationQueryResponse.errEllp.map { it.toMutableList() }
                externalId = emitterGeolocationQueryResponse.externalId
                idOnOrbit = emitterGeolocationQueryResponse.idOnOrbit
                idRfEmitter = emitterGeolocationQueryResponse.idRfEmitter
                idSensor = emitterGeolocationQueryResponse.idSensor
                maxFreq = emitterGeolocationQueryResponse.maxFreq
                minFreq = emitterGeolocationQueryResponse.minFreq
                numBursts = emitterGeolocationQueryResponse.numBursts
                orderId = emitterGeolocationQueryResponse.orderId
                origin = emitterGeolocationQueryResponse.origin
                origNetwork = emitterGeolocationQueryResponse.origNetwork
                origObjectId = emitterGeolocationQueryResponse.origObjectId
                origRfEmitterId = emitterGeolocationQueryResponse.origRfEmitterId
                origSensorId = emitterGeolocationQueryResponse.origSensorId
                passGroupId = emitterGeolocationQueryResponse.passGroupId
                receivedTs = emitterGeolocationQueryResponse.receivedTs
                satNo = emitterGeolocationQueryResponse.satNo
                signalOfInterest = emitterGeolocationQueryResponse.signalOfInterest
                sourceDl = emitterGeolocationQueryResponse.sourceDl
                tags = emitterGeolocationQueryResponse.tags.map { it.toMutableList() }
                additionalProperties = emitterGeolocationQueryResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EmitterGeolocationQueryResponse].
         *
         ...
         */
        fun build(): EmitterGeolocationQueryResponse =
    ...
    fun validate(): EmitterGeolocationQueryResponse =
        apply {
            if (validated) {
              return@apply
            }
