...
class OnorbitthrusterListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<OnorbitthrusterListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitthrusterListPageAsync: OnorbitthrusterListPageAsync) = apply {
        ...
        fun service(service: OnorbitthrusterServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitthrusterListPageAsync &&
    ...
    override fun toString() =
        "OnorbitthrusterListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
