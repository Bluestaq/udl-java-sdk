...
class SortiePprCreateBulkParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SortiePprCreateBulkParams].
         *
    ...
    /** A builder for [SortiePprCreateBulkParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sortiePprCreateBulkParams: SortiePprCreateBulkParams) =
            apply {
                body = sortiePprCreateBulkParams.body.toMutableList()
                additionalHeaders = sortiePprCreateBulkParams.additionalHeaders.toBuilder()
                additionalQueryParams = sortiePprCreateBulkParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SortiePprCreateBulkParams].
         *
         ...
         */
        fun build(): SortiePprCreateBulkParams =
    ...
    override fun toString() = "SortiePprCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
