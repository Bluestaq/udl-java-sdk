...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiListPageAsync: PoiListPageAsync) = apply {
        ...
        fun service(service: PoiServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: PoiListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<PoiListResponse>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PoiListPageAsync &&
    ...
    override fun toString() =
        "PoiListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
