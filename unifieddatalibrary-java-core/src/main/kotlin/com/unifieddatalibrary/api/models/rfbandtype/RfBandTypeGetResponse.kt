...
class RfBandTypeGetResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RfBandTypeGetResponse].
         *
    ...
    /** A builder for [RfBandTypeGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeGetResponse: RfBandTypeGetResponse) =
            apply {
                id = rfBandTypeGetResponse.id
                classificationMarking = rfBandTypeGetResponse.classificationMarking
                dataMode = rfBandTypeGetResponse.dataMode
                description = rfBandTypeGetResponse.description
                source = rfBandTypeGetResponse.source
                createdAt = rfBandTypeGetResponse.createdAt
                createdBy = rfBandTypeGetResponse.createdBy
                endFreq = rfBandTypeGetResponse.endFreq
                origin = rfBandTypeGetResponse.origin
                startFreq = rfBandTypeGetResponse.startFreq
                updatedAt = rfBandTypeGetResponse.updatedAt
                updatedBy = rfBandTypeGetResponse.updatedBy
                additionalProperties = rfBandTypeGetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RfBandTypeGetResponse].
         *
         ...
         */
        fun build(): RfBandTypeGetResponse =
    ...
    fun validate(): RfBandTypeGetResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (endFreq.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (startFreq.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "RfBandTypeGetResponse{id=$id, classificationMarking=$classificationMarking, dataMode=$dataMode, description=$description, source=$source, createdAt=$createdAt, createdBy=$createdBy, endFreq=$endFreq, origin=$origin, startFreq=$startFreq, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
