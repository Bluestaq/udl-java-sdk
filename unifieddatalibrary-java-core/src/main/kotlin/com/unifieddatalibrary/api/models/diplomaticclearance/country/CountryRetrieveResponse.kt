...
class CountryRetrieveResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(countryRetrieveResponse: CountryRetrieveResponse) =
            apply {
                classificationMarking = countryRetrieveResponse.classificationMarking
                countryCode = countryRetrieveResponse.countryCode
                dataMode = countryRetrieveResponse.dataMode
                lastChangedDate = countryRetrieveResponse.lastChangedDate
                source = countryRetrieveResponse.source
                id = countryRetrieveResponse.id
                acceptsDms = countryRetrieveResponse.acceptsDms
                acceptsEmail = countryRetrieveResponse.acceptsEmail
                acceptsFax = countryRetrieveResponse.acceptsFax
                acceptsSiprNet = countryRetrieveResponse.acceptsSiprNet
                agency = countryRetrieveResponse.agency
                altCountryCode = countryRetrieveResponse.altCountryCode
                closeTime = countryRetrieveResponse.closeTime
                countryId = countryRetrieveResponse.countryId
                countryName = countryRetrieveResponse.countryName
                countryRemark = countryRetrieveResponse.countryRemark
                createdAt = countryRetrieveResponse.createdAt
                createdBy = countryRetrieveResponse.createdBy
                diplomaticClearanceCountryContacts = countryRetrieveResponse.diplomaticClearanceCountryContacts.map { it.toMutableList() }
                diplomaticClearanceCountryEntryExitPoints = countryRetrieveResponse.diplomaticClearanceCountryEntryExitPoints.map { it.toMutableList() }
                diplomaticClearanceCountryProfiles = countryRetrieveResponse.diplomaticClearanceCountryProfiles.map { it.toMutableList() }
                existingProfile = countryRetrieveResponse.existingProfile
                gmtOffset = countryRetrieveResponse.gmtOffset
                officeName = countryRetrieveResponse.officeName
                officePoc = countryRetrieveResponse.officePoc
                officeRemark = countryRetrieveResponse.officeRemark
                openFri = countryRetrieveResponse.openFri
                openMon = countryRetrieveResponse.openMon
                openSat = countryRetrieveResponse.openSat
                openSun = countryRetrieveResponse.openSun
                openThu = countryRetrieveResponse.openThu
                openTime = countryRetrieveResponse.openTime
                openTue = countryRetrieveResponse.openTue
                openWed = countryRetrieveResponse.openWed
                origin = countryRetrieveResponse.origin
                origNetwork = countryRetrieveResponse.origNetwork
                sourceDl = countryRetrieveResponse.sourceDl
                updatedAt = countryRetrieveResponse.updatedAt
                updatedBy = countryRetrieveResponse.updatedBy
