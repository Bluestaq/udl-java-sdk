...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(countryRetrieveResponse: CountryRetrieveResponse) = apply {
            ...
            diplomaticClearanceCountryContacts =
                countryRetrieveResponse.diplomaticClearanceCountryContacts.map {
                    it.toMutableList()
                }
            diplomaticClearanceCountryEntryExitPoints =
                countryRetrieveResponse.diplomaticClearanceCountryEntryExitPoints.map {
                    it.toMutableList()
                }
            diplomaticClearanceCountryProfiles =
                countryRetrieveResponse.diplomaticClearanceCountryProfiles.map {
                    it.toMutableList()
                }
