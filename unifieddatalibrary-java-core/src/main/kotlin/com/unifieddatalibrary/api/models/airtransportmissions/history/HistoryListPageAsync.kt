...
private constructor(
    ...
    private val items: List<AirTransportMissionFull>,
) : PageAsync<AirTransportMissionFull> {
    ...
    fun autoPager(): AutoPagerAsync<AirTransportMissionFull> =
    ...
    override fun items(): List<AirTransportMissionFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<AirTransportMissionFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<AirTransportMissionFull>) = apply { this.items = items }
