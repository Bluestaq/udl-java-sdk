...
class SpaceEnvObservationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SpaceEnvObservationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SpaceEnvObservationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(spaceEnvObservationQueryhelpResponse: SpaceEnvObservationQueryhelpResponse) =
            apply {
                aodrSupported = spaceEnvObservationQueryhelpResponse.aodrSupported
                classificationMarking = spaceEnvObservationQueryhelpResponse.classificationMarking
                description = spaceEnvObservationQueryhelpResponse.description
                historySupported = spaceEnvObservationQueryhelpResponse.historySupported
                name = spaceEnvObservationQueryhelpResponse.name
                parameters = spaceEnvObservationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = spaceEnvObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = spaceEnvObservationQueryhelpResponse.restSupported
                sortSupported = spaceEnvObservationQueryhelpResponse.sortSupported
                typeName = spaceEnvObservationQueryhelpResponse.typeName
                uri = spaceEnvObservationQueryhelpResponse.uri
                additionalProperties = spaceEnvObservationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SpaceEnvObservationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SpaceEnvObservationQueryhelpResponse =
    ...
    fun validate(): SpaceEnvObservationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SpaceEnvObservationQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
