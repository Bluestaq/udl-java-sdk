...
class SpaceEnvObservationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            spaceEnvObservationQueryhelpResponse: SpaceEnvObservationQueryhelpResponse
        ) = apply {
            ...
            requiredRoles =
                spaceEnvObservationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            ...
            additionalProperties =
                spaceEnvObservationQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): SpaceEnvObservationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
