...
class StarCatalogListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): StarCatalogListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StarCatalogListParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [StarCatalogListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogListParams: StarCatalogListParams) =
            apply {
                dec = starCatalogListParams.dec
                firstResult = starCatalogListParams.firstResult
                maxResults = starCatalogListParams.maxResults
                ra = starCatalogListParams.ra
                additionalHeaders = starCatalogListParams.additionalHeaders.toBuilder()
                additionalQueryParams = starCatalogListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [StarCatalogListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StarCatalogListParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is StarCatalogListParams && dec == other.dec && firstResult == other.firstResult && maxResults == other.maxResults && ra == other.ra && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "StarCatalogListParams{dec=$dec, firstResult=$firstResult, maxResults=$maxResults, ra=$ra, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
