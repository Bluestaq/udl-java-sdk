...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StarCatalogListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogListParams: StarCatalogListParams) = apply {
    ...
    override fun toString() =
        "StarCatalogListParams{dec=$dec, firstResult=$firstResult, maxResults=$maxResults, ra=$ra, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
