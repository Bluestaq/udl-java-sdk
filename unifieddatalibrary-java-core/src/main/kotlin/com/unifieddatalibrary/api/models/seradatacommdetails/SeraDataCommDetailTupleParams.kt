 ...
 */
class SeraDataCommDetailTupleParams
private constructor(
    ...
    /** A builder for [SeraDataCommDetailTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataCommDetailTupleParams: SeraDataCommDetailTupleParams) = apply {
            columns = seraDataCommDetailTupleParams.columns
            firstResult = seraDataCommDetailTupleParams.firstResult
            maxResults = seraDataCommDetailTupleParams.maxResults
            additionalHeaders = seraDataCommDetailTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = seraDataCommDetailTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataCommDetailTupleParams].
         *
         ...
         */
        fun build(): SeraDataCommDetailTupleParams =
            SeraDataCommDetailTupleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeraDataCommDetailTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeraDataCommDetailTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
