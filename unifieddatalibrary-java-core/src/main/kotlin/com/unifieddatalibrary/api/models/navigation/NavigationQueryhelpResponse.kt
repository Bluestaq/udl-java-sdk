...
class NavigationQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [NavigationQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [NavigationQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationQueryhelpResponse: NavigationQueryhelpResponse) =
            apply {
                aodrSupported = navigationQueryhelpResponse.aodrSupported
                classificationMarking = navigationQueryhelpResponse.classificationMarking
                description = navigationQueryhelpResponse.description
                historySupported = navigationQueryhelpResponse.historySupported
                name = navigationQueryhelpResponse.name
                parameters = navigationQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = navigationQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = navigationQueryhelpResponse.restSupported
                sortSupported = navigationQueryhelpResponse.sortSupported
                typeName = navigationQueryhelpResponse.typeName
                uri = navigationQueryhelpResponse.uri
                additionalProperties = navigationQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [NavigationQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NavigationQueryhelpResponse =
    ...
    fun validate(): NavigationQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is NavigationQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
