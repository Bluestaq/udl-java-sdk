...
class NavigationQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationQueryhelpResponse: NavigationQueryhelpResponse) = apply {
    ...
    fun validate(): NavigationQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
