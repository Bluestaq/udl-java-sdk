 ...
 */
class SeraDataCommDetailCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeraDataCommDetailCountParams = builder().build()
    ...
    /** A builder for [SeraDataCommDetailCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataCommDetailCountParams: SeraDataCommDetailCountParams) = apply {
            firstResult = seraDataCommDetailCountParams.firstResult
            maxResults = seraDataCommDetailCountParams.maxResults
            additionalHeaders = seraDataCommDetailCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = seraDataCommDetailCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SeraDataCommDetailCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SeraDataCommDetailCountParams =
            SeraDataCommDetailCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SeraDataCommDetailCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SeraDataCommDetailCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
