...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AntennaListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaListParams: AntennaListParams) = apply {
    ...
    override fun toString() =
        "AntennaListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
