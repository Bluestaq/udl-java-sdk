...
class DiplomaticClearanceListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diplomaticClearanceListPage: DiplomaticClearanceListPage) =
            apply {
        ...
        fun service(service: DiplomaticClearanceService) =
            apply {
    ...
    override fun toString() = "DiplomaticClearanceListPage{service=$service, params=$params, items=$items}"
}
