...
class ManifoldQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldQueryhelpResponse: ManifoldQueryhelpResponse) = apply {
    ...
    fun validate(): ManifoldQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
