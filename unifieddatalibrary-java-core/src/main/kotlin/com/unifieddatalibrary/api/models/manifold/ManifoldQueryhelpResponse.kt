...
class ManifoldQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ManifoldQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ManifoldQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldQueryhelpResponse: ManifoldQueryhelpResponse) =
            apply {
                aodrSupported = manifoldQueryhelpResponse.aodrSupported
                classificationMarking = manifoldQueryhelpResponse.classificationMarking
                description = manifoldQueryhelpResponse.description
                historySupported = manifoldQueryhelpResponse.historySupported
                name = manifoldQueryhelpResponse.name
                parameters = manifoldQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = manifoldQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = manifoldQueryhelpResponse.restSupported
                sortSupported = manifoldQueryhelpResponse.sortSupported
                typeName = manifoldQueryhelpResponse.typeName
                uri = manifoldQueryhelpResponse.uri
                additionalProperties = manifoldQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ManifoldQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ManifoldQueryhelpResponse =
    ...
    fun validate(): ManifoldQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
