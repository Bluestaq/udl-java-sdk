...
/**
 * Service operation to update a single AircraftSortie. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class AircraftSortyUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftSortyUpdateParams].
         *
    ...
    /** A builder for [AircraftSortyUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyUpdateParams: AircraftSortyUpdateParams) = apply {
            pathId = aircraftSortyUpdateParams.pathId
            body = aircraftSortyUpdateParams.body.toBuilder()
            additionalHeaders = aircraftSortyUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = aircraftSortyUpdateParams.additionalQueryParams.toBuilder()
        }
         ...
         * 8601 UTC format with millisecond precision.
         */
        fun actualBlockInTime(actualBlockInTime: OffsetDateTime) = apply {
         ...
         * format with millisecond precision.
         */
        fun actualBlockOutTime(actualBlockOutTime: OffsetDateTime) = apply {
        ...
        /** The Automatic Dependent Surveillance-Broadcast (ADS-B) device identifier. */
        fun aircraftAdsb(aircraftAdsb: String) = apply { body.aircraftAdsb(aircraftAdsb) }
        ...
        /** Alternate Aircraft Identifier provided by source. */
        fun aircraftAltId(aircraftAltId: String) = apply { body.aircraftAltId(aircraftAltId) }
        ...
        /** Aircraft event text. */
        fun aircraftEvent(aircraftEvent: String) = apply { body.aircraftEvent(aircraftEvent) }
        ...
        /** Remarks concerning the aircraft. */
        fun aircraftRemarks(aircraftRemarks: String) = apply {
        ...
        /** The amount of time allowed between launch order and takeoff, in seconds. */
        fun alertStatus(alertStatus: Int) = apply { body.alertStatus(alertStatus) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun alertStatus(alertStatus: JsonField<Int>) = apply { body.alertStatus(alertStatus) }

        /** The Alert Status code. */
        fun alertStatusCode(alertStatusCode: String) = apply {
        ...
        /** The Air Mobility Command (AMC) mission number of the sortie. */
        fun amcMsnNum(amcMsnNum: String) = apply { body.amcMsnNum(amcMsnNum) }
         ...
         * value.
         */
        fun amcMsnNum(amcMsnNum: JsonField<String>) = apply { body.amcMsnNum(amcMsnNum) }

        /** The type of mission (e.g. SAAM, CHNL, etc.). */
        fun amcMsnType(amcMsnType: String) = apply { body.amcMsnType(amcMsnType) }
         ...
         * value.
         */
        fun amcMsnType(amcMsnType: JsonField<String>) = apply { body.amcMsnType(amcMsnType) }

        /** The arrival Federal Aviation Administration (FAA) code of this sortie. */
        fun arrFaa(arrFaa: String) = apply { body.arrFaa(arrFaa) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun arrFaa(arrFaa: JsonField<String>) = apply { body.arrFaa(arrFaa) }

        /** The arrival International Aviation Transport Association (IATA) code of this sortie. */
        fun arrIata(arrIata: String) = apply { body.arrIata(arrIata) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun arrIata(arrIata: JsonField<String>) = apply { body.arrIata(arrIata) }
        ...
        /** The itinerary identifier of the arrival location. */
        fun arrItinerary(arrItinerary: Int) = apply { body.arrItinerary(arrItinerary) }
         ...
         * value.
         */
        fun arrItinerary(arrItinerary: JsonField<Int>) = apply { body.arrItinerary(arrItinerary) }

        /** Purpose code at the arrival location of this sortie. */
        fun arrPurposeCode(arrPurposeCode: String) = apply { body.arrPurposeCode(arrPurposeCode) }
        ...
        /** The primary delay code. */
        fun delayCode(delayCode: String) = apply { body.delayCode(delayCode) }
         ...
         * value.
         */
        fun delayCode(delayCode: JsonField<String>) = apply { body.delayCode(delayCode) }

        /** The departure Federal Aviation Administration (FAA) code of this sortie. */
        fun depFaa(depFaa: String) = apply { body.depFaa(depFaa) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun depFaa(depFaa: JsonField<String>) = apply { body.depFaa(depFaa) }

        /**
         * The departure International Aviation Transport Association (IATA) code of this sortie.
         */
        fun depIata(depIata: String) = apply { body.depIata(depIata) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun depIata(depIata: JsonField<String>) = apply { body.depIata(depIata) }
        ...
        /** The itinerary identifier of the departure location. */
        fun depItinerary(depItinerary: Int) = apply { body.depItinerary(depItinerary) }
         ...
         * value.
         */
        fun depItinerary(depItinerary: JsonField<Int>) = apply { body.depItinerary(depItinerary) }

        /** Purpose code at the departure location of this sortie. */
        fun depPurposeCode(depPurposeCode: String) = apply { body.depPurposeCode(depPurposeCode) }
         ...
         * format with millisecond precision.
         */
        fun dhd(dhd: OffsetDateTime) = apply { body.dhd(dhd) }
         ...
         * value.
         */
        fun dhd(dhd: JsonField<OffsetDateTime>) = apply { body.dhd(dhd) }

        /** Reason the aircraft must return to home station by its due home date. */
        fun dhdReason(dhdReason: String) = apply { body.dhdReason(dhdReason) }
         ...
         * value.
         */
        fun dhdReason(dhdReason: JsonField<String>) = apply { body.dhdReason(dhdReason) }
         ...
         */
        fun estBlockInTime(estBlockInTime: OffsetDateTime) = apply {
         ...
         * UTC format with millisecond precision.
         */
        fun estBlockOutTime(estBlockOutTime: OffsetDateTime) = apply {
        ...
        /** Size of the supporting PDF, in bytes. */
        fun filesize(filesize: Int) = apply { body.filesize(filesize) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun filesize(filesize: JsonField<Int>) = apply { body.filesize(filesize) }

        /** The planned flight time for this sortie, in minutes. */
        fun flightTime(flightTime: Double) = apply { body.flightTime(flightTime) }
         ...
         * value.
         */
        fun flightTime(flightTime: JsonField<Double>) = apply { body.flightTime(flightTime) }

        /**
         * Desk phone number of the flight manager assigned to the sortie. Null when no flight
         * manager is assigned.
         */
        fun fmDeskNum(fmDeskNum: String) = apply { body.fmDeskNum(fmDeskNum) }
         ...
         * value.
         */
        fun fmDeskNum(fmDeskNum: JsonField<String>) = apply { body.fmDeskNum(fmDeskNum) }

        /**
         * Last name of the flight manager assigned to the sortie. Null when no flight manager is
         * assigned.
         */
        fun fmName(fmName: String) = apply { body.fmName(fmName) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun fmName(fmName: JsonField<String>) = apply { body.fmName(fmName) }

        /** Mass of fuel required for this leg of the sortie, in kilograms. */
        fun fuelReq(fuelReq: Double) = apply { body.fuelReq(fuelReq) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun fuelReq(fuelReq: JsonField<Double>) = apply { body.fuelReq(fuelReq) }

        /** Scheduled ground time, in minutes. */
        fun gndTime(gndTime: Double) = apply { body.gndTime(gndTime) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun gndTime(gndTime: JsonField<Double>) = apply { body.gndTime(gndTime) }
        ...
        /** The external system line number of this sortie. */
        fun lineNumber(lineNumber: Int) = apply { body.lineNumber(lineNumber) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun lineNumber(lineNumber: JsonField<Int>) = apply { body.lineNumber(lineNumber) }
         ...
         */
        fun missionUpdate(missionUpdate: OffsetDateTime) = apply {
        ...
        /** Remarks concerning the sortie objective. */
        fun objectiveRemarks(objectiveRemarks: String) = apply {
        ...
        /** The sortie identifier provided by the originating source. */
        fun origSortieId(origSortieId: String) = apply { body.origSortieId(origSortieId) }
        ...
        /** Liquid oxygen onboard the aircraft for the crew compartment, in liters. */
        fun oxyOnCrew(oxyOnCrew: Double) = apply { body.oxyOnCrew(oxyOnCrew) }
         ...
         * value.
         */
        fun oxyOnCrew(oxyOnCrew: JsonField<Double>) = apply { body.oxyOnCrew(oxyOnCrew) }

        /** Liquid oxygen onboard the aircraft for the troop compartment, in liters. */
        fun oxyOnPax(oxyOnPax: Double) = apply { body.oxyOnPax(oxyOnPax) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun oxyOnPax(oxyOnPax: JsonField<Double>) = apply { body.oxyOnPax(oxyOnPax) }

        /** Liquid oxygen required on the aircraft for the crew compartment, in liters. */
        fun oxyReqCrew(oxyReqCrew: Double) = apply { body.oxyReqCrew(oxyReqCrew) }
         ...
         * value.
         */
        fun oxyReqCrew(oxyReqCrew: JsonField<Double>) = apply { body.oxyReqCrew(oxyReqCrew) }

        /** Liquid oxygen required on the aircraft for the troop compartment, in liters. */
        fun oxyReqPax(oxyReqPax: Double) = apply { body.oxyReqPax(oxyReqPax) }
         ...
         * value.
         */
        fun oxyReqPax(oxyReqPax: JsonField<Double>) = apply { body.oxyReqPax(oxyReqPax) }

        /** The status of the supporting document. */
        fun paperStatus(paperStatus: PaperStatus) = apply { body.paperStatus(paperStatus) }
        ...
        /** The version number of the crew paper. */
        fun papersVersion(papersVersion: String) = apply { body.papersVersion(papersVersion) }
        ...
        /** The POI parking location. */
        fun parkingLoc(parkingLoc: String) = apply { body.parkingLoc(parkingLoc) }
         ...
         * value.
         */
        fun parkingLoc(parkingLoc: JsonField<String>) = apply { body.parkingLoc(parkingLoc) }

        /** The number of passengers tasked for this sortie. */
        fun passengers(passengers: Int) = apply { body.passengers(passengers) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun passengers(passengers: JsonField<Int>) = apply { body.passengers(passengers) }
        ...
        /** The prior permission required (PPR) status. */
        fun pprStatus(pprStatus: PprStatus) = apply { body.pprStatus(pprStatus) }
         ...
         * value.
         */
        fun pprStatus(pprStatus: JsonField<PprStatus>) = apply { body.pprStatus(pprStatus) }

        /** The planned primary Standard Conventional Load of the aircraft for this sortie. */
        fun primaryScl(primaryScl: String) = apply { body.primaryScl(primaryScl) }
         ...
         * value.
         */
        fun primaryScl(primaryScl: JsonField<String>) = apply { body.primaryScl(primaryScl) }
        ...
        /** Aircraft configuration required for the mission. */
        fun reqConfig(reqConfig: String) = apply { body.reqConfig(reqConfig) }
         ...
         * value.
         */
        fun reqConfig(reqConfig: JsonField<String>) = apply { body.reqConfig(reqConfig) }

        /** Remarks concerning the results of this sortie. */
        fun resultRemarks(resultRemarks: String) = apply { body.resultRemarks(resultRemarks) }
         ...
         * hours)).
         */
        fun rvnReq(rvnReq: RvnReq) = apply { body.rvnReq(rvnReq) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun rvnReq(rvnReq: JsonField<RvnReq>) = apply { body.rvnReq(rvnReq) }

        /** Remarks concerning the schedule. */
        fun scheduleRemarks(scheduleRemarks: String) = apply {
        ...
        /** The planned secondary Standard Conventional Load of the aircraft for this sortie. */
        fun secondaryScl(secondaryScl: String) = apply { body.secondaryScl(secondaryScl) }
         ...
         */
        fun soe(soe: String) = apply { body.soe(soe) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun soe(soe: JsonField<String>) = apply { body.soe(soe) }

        /**
         * The scheduled UTC date for this sortie, in ISO 8601 date-only format (ex. YYYY-MM-DD).
         */
        fun sortieDate(sortieDate: LocalDate) = apply { body.sortieDate(sortieDate) }
         ...
         * value.
         */
        fun sortieDate(sortieDate: JsonField<LocalDate>) = apply { body.sortieDate(sortieDate) }
        ...
        /**
         * Returns an immutable instance of [AircraftSortyUpdateParams].
         *
         ...
         */
        fun build(): AircraftSortyUpdateParams =
