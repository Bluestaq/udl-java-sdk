...
import com.unifieddatalibrary.api.models.observations.rfobservation.history.HistoryListResponse
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) =
            apply {
                ...
                obTime = historyListResponse.obTime
                source = historyListResponse.source
                type = historyListResponse.type
                id = historyListResponse.id
                antennaName = historyListResponse.antennaName
                azimuth = historyListResponse.azimuth
                azimuthMeasured = historyListResponse.azimuthMeasured
                azimuthRate = historyListResponse.azimuthRate
                azimuthUnc = historyListResponse.azimuthUnc
                bandwidth = historyListResponse.bandwidth
                baudRate = historyListResponse.baudRate
                baudRates = historyListResponse.baudRates.map { it.toMutableList() }
                bitErrorRate = historyListResponse.bitErrorRate
                carrierStandard = historyListResponse.carrierStandard
                channel = historyListResponse.channel
                chipRates = historyListResponse.chipRates.map { it.toMutableList() }
                codeFills = historyListResponse.codeFills.map { it.toMutableList() }
                codeLengths = historyListResponse.codeLengths.map { it.toMutableList() }
                codeTaps = historyListResponse.codeTaps.map { it.toMutableList() }
                collectionMode = historyListResponse.collectionMode
                confidence = historyListResponse.confidence
                confidences = historyListResponse.confidences.map { it.toMutableList() }
                constellationXPoints = historyListResponse.constellationXPoints.map { it.toMutableList() }
                constellationYPoints = historyListResponse.constellationYPoints.map { it.toMutableList() }
                createdAt = historyListResponse.createdAt
                createdBy = historyListResponse.createdBy
                descriptor = historyListResponse.descriptor
                detectionStatus = historyListResponse.detectionStatus
                detectionStatuses = historyListResponse.detectionStatuses.map { it.toMutableList() }
                eirp = historyListResponse.eirp
                elevation = historyListResponse.elevation
                elevationMeasured = historyListResponse.elevationMeasured
                elevationRate = historyListResponse.elevationRate
                elevationUnc = historyListResponse.elevationUnc
                elnot = historyListResponse.elnot
                endFrequency = historyListResponse.endFrequency
                frequencies = historyListResponse.frequencies.map { it.toMutableList() }
                frequency = historyListResponse.frequency
                frequencyShift = historyListResponse.frequencyShift
                idOnOrbit = historyListResponse.idOnOrbit
                idSensor = historyListResponse.idSensor
                incoming = historyListResponse.incoming
                innerCodingRate = historyListResponse.innerCodingRate
                maxPsd = historyListResponse.maxPsd
                minPsd = historyListResponse.minPsd
                modulation = historyListResponse.modulation
                noisePwrDensity = historyListResponse.noisePwrDensity
                nominalBandwidth = historyListResponse.nominalBandwidth
                nominalEirp = historyListResponse.nominalEirp
                nominalFrequency = historyListResponse.nominalFrequency
                nominalPowerOverNoise = historyListResponse.nominalPowerOverNoise
                nominalSnr = historyListResponse.nominalSnr
                ...
                outerCodingRate = historyListResponse.outerCodingRate
                peak = historyListResponse.peak
                pgri = historyListResponse.pgri
                pnOrders = historyListResponse.pnOrders.map { it.toMutableList() }
                polarity = historyListResponse.polarity
                polarityType = historyListResponse.polarityType
                powerOverNoise = historyListResponse.powerOverNoise
                powers = historyListResponse.powers.map { it.toMutableList() }
                range = historyListResponse.range
                rangeMeasured = historyListResponse.rangeMeasured
                rangeRate = historyListResponse.rangeRate
                rangeRateMeasured = historyListResponse.rangeRateMeasured
                rangeRateUnc = historyListResponse.rangeRateUnc
                rangeUnc = historyListResponse.rangeUnc
                rawFileUri = historyListResponse.rawFileUri
                referenceLevel = historyListResponse.referenceLevel
                relativeCarrierPower = historyListResponse.relativeCarrierPower
                relativeNoiseFloor = historyListResponse.relativeNoiseFloor
                resolutionBandwidth = historyListResponse.resolutionBandwidth
                ...
                signalIds = historyListResponse.signalIds.map { it.toMutableList() }
                snr = historyListResponse.snr
                snrs = historyListResponse.snrs.map { it.toMutableList() }
                sourceDl = historyListResponse.sourceDl
                spectrumAnalyzerPower = historyListResponse.spectrumAnalyzerPower
                startFrequency = historyListResponse.startFrequency
                switchPoint = historyListResponse.switchPoint
                symbolToNoiseRatio = historyListResponse.symbolToNoiseRatio
                tags = historyListResponse.tags.map { it.toMutableList() }
                taskId = historyListResponse.taskId
                telemetryIds = historyListResponse.telemetryIds.map { it.toMutableList() }
                trackId = historyListResponse.trackId
                trackRange = historyListResponse.trackRange
                transactionId = historyListResponse.transactionId
                transmitFilterRollOff = historyListResponse.transmitFilterRollOff
                transmitFilterType = historyListResponse.transmitFilterType
                transponder = historyListResponse.transponder
                uct = historyListResponse.uct
                url = historyListResponse.url
                videoBandwidth = historyListResponse.videoBandwidth
