...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            constellationXPoints =
                historyListResponse.constellationXPoints.map { it.toMutableList() }
            constellationYPoints =
                historyListResponse.constellationYPoints.map { it.toMutableList() }
            ...
            fftImagCoeffs = historyListResponse.fftImagCoeffs.map { it.toMutableList() }
            fftRealCoeffs = historyListResponse.fftRealCoeffs.map { it.toMutableList() }
            ...
            jamBands = historyListResponse.jamBands.map { it.toMutableList() }
            jamToSigRatios = historyListResponse.jamToSigRatios.map { it.toMutableList() }
            ...
            origCountry = historyListResponse.origCountry
            origin = historyListResponse.origin
            origMarking = historyListResponse.origMarking
