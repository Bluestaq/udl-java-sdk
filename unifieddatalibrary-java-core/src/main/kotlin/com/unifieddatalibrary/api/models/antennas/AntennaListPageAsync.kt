...
private constructor(
    ...
    override fun nextPage(): CompletableFuture<AntennaListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaListPageAsync: AntennaListPageAsync) = apply {
        ...
        fun service(service: AntennaServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AntennaListPageAsync &&
    ...
    override fun toString() =
        "AntennaListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
