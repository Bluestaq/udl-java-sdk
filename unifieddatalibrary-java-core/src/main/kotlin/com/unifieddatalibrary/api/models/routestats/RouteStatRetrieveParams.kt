...
class RouteStatRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): RouteStatRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RouteStatRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [RouteStatRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatRetrieveParams: RouteStatRetrieveParams) =
            apply {
                id = routeStatRetrieveParams.id
                firstResult = routeStatRetrieveParams.firstResult
                maxResults = routeStatRetrieveParams.maxResults
                additionalHeaders = routeStatRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = routeStatRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RouteStatRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RouteStatRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is RouteStatRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "RouteStatRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
