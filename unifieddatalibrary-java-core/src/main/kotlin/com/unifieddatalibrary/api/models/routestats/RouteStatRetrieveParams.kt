...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RouteStatRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routeStatRetrieveParams: RouteStatRetrieveParams) = apply {
    ...
    override fun toString() =
        "RouteStatRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
