 ...
 */
class CloselyspacedobjectRetrieveResponse
...
private constructor(
    ...
    /** A builder for [CloselyspacedobjectRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            closelyspacedobjectRetrieveResponse: CloselyspacedobjectRetrieveResponse
        ) = apply {
            classificationMarking = closelyspacedobjectRetrieveResponse.classificationMarking
            csoState = closelyspacedobjectRetrieveResponse.csoState
            dataMode = closelyspacedobjectRetrieveResponse.dataMode
            eventStartTime = closelyspacedobjectRetrieveResponse.eventStartTime
            eventType = closelyspacedobjectRetrieveResponse.eventType
            source = closelyspacedobjectRetrieveResponse.source
            id = closelyspacedobjectRetrieveResponse.id
            actorSvEpoch = closelyspacedobjectRetrieveResponse.actorSvEpoch
            analysisDuration = closelyspacedobjectRetrieveResponse.analysisDuration
            analysisEpoch = closelyspacedobjectRetrieveResponse.analysisEpoch
            compType = closelyspacedobjectRetrieveResponse.compType
            contextKeys = closelyspacedobjectRetrieveResponse.contextKeys.map { it.toMutableList() }
            contextValues =
                closelyspacedobjectRetrieveResponse.contextValues.map { it.toMutableList() }
            createdAt = closelyspacedobjectRetrieveResponse.createdAt
            createdBy = closelyspacedobjectRetrieveResponse.createdBy
            csoDetails = closelyspacedobjectRetrieveResponse.csoDetails.map { it.toMutableList() }
            deltaVTol = closelyspacedobjectRetrieveResponse.deltaVTol
            durationThreshold = closelyspacedobjectRetrieveResponse.durationThreshold
            eventEndTime = closelyspacedobjectRetrieveResponse.eventEndTime
            eventIntervalCoverage = closelyspacedobjectRetrieveResponse.eventIntervalCoverage
            extId = closelyspacedobjectRetrieveResponse.extId
            hohmannDeltaV = closelyspacedobjectRetrieveResponse.hohmannDeltaV
            idActorSv = closelyspacedobjectRetrieveResponse.idActorSv
            idOnOrbit1 = closelyspacedobjectRetrieveResponse.idOnOrbit1
            idOnOrbit2 = closelyspacedobjectRetrieveResponse.idOnOrbit2
            idTargetSv = closelyspacedobjectRetrieveResponse.idTargetSv
            inclinationDeltaV = closelyspacedobjectRetrieveResponse.inclinationDeltaV
            indicationSource = closelyspacedobjectRetrieveResponse.indicationSource
            lonTol = closelyspacedobjectRetrieveResponse.lonTol
            maxRange = closelyspacedobjectRetrieveResponse.maxRange
            minPlaneSepAngle = closelyspacedobjectRetrieveResponse.minPlaneSepAngle
            minPlaneSepEpoch = closelyspacedobjectRetrieveResponse.minPlaneSepEpoch
            minRange = closelyspacedobjectRetrieveResponse.minRange
            minRangeAnalysisDuration = closelyspacedobjectRetrieveResponse.minRangeAnalysisDuration
            minRangeEpoch = closelyspacedobjectRetrieveResponse.minRangeEpoch
            notes = closelyspacedobjectRetrieveResponse.notes
            numSubIntervals = closelyspacedobjectRetrieveResponse.numSubIntervals
            orbitAlignDel = closelyspacedobjectRetrieveResponse.orbitAlignDel
            orbitPlaneTol = closelyspacedobjectRetrieveResponse.orbitPlaneTol
            origin = closelyspacedobjectRetrieveResponse.origin
            origNetwork = closelyspacedobjectRetrieveResponse.origNetwork
            origObjectId1 = closelyspacedobjectRetrieveResponse.origObjectId1
            origObjectId2 = closelyspacedobjectRetrieveResponse.origObjectId2
            rangeThreshold = closelyspacedobjectRetrieveResponse.rangeThreshold
            rangeTol = closelyspacedobjectRetrieveResponse.rangeTol
            relPos = closelyspacedobjectRetrieveResponse.relPos.map { it.toMutableList() }
            relPosMag = closelyspacedobjectRetrieveResponse.relPosMag
            relSpeedMag = closelyspacedobjectRetrieveResponse.relSpeedMag
            relVel = closelyspacedobjectRetrieveResponse.relVel.map { it.toMutableList() }
            satNo1 = closelyspacedobjectRetrieveResponse.satNo1
            satNo2 = closelyspacedobjectRetrieveResponse.satNo2
            sourceDl = closelyspacedobjectRetrieveResponse.sourceDl
            stationLimLonTol = closelyspacedobjectRetrieveResponse.stationLimLonTol
            targetSvEpoch = closelyspacedobjectRetrieveResponse.targetSvEpoch
            totalDeltaV = closelyspacedobjectRetrieveResponse.totalDeltaV
            additionalProperties =
                closelyspacedobjectRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CloselyspacedobjectRetrieveResponse].
         *
         ...
         */
        fun build(): CloselyspacedobjectRetrieveResponse =
            CloselyspacedobjectRetrieveResponse(
    ...
    fun validate(): CloselyspacedobjectRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloselyspacedobjectRetrieveResponse &&
            classificationMarking == other.classificationMarking &&
