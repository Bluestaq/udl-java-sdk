...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EventEvolutionFull].
         *
    ...
    /** A builder for [EventEvolutionFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventEvolutionFull: EventEvolutionFull) = apply {
            classificationMarking = eventEvolutionFull.classificationMarking
            dataMode = eventEvolutionFull.dataMode
            eventId = eventEvolutionFull.eventId
            source = eventEvolutionFull.source
            startTime = eventEvolutionFull.startTime
            summary = eventEvolutionFull.summary
            id = eventEvolutionFull.id
            agjson = eventEvolutionFull.agjson
            andims = eventEvolutionFull.andims
            area = eventEvolutionFull.area
            asrid = eventEvolutionFull.asrid
            atext = eventEvolutionFull.atext
            atype = eventEvolutionFull.atype
            category = eventEvolutionFull.category
            countryCode = eventEvolutionFull.countryCode
            createdAt = eventEvolutionFull.createdAt
            createdBy = eventEvolutionFull.createdBy
            dataDescription = eventEvolutionFull.dataDescription
            endTime = eventEvolutionFull.endTime
            geoAdminLevel1 = eventEvolutionFull.geoAdminLevel1
            geoAdminLevel2 = eventEvolutionFull.geoAdminLevel2
            geoAdminLevel3 = eventEvolutionFull.geoAdminLevel3
            origin = eventEvolutionFull.origin
            origNetwork = eventEvolutionFull.origNetwork
            redact = eventEvolutionFull.redact
            srcIds = eventEvolutionFull.srcIds.map { it.toMutableList() }
            srcTyps = eventEvolutionFull.srcTyps.map { it.toMutableList() }
            status = eventEvolutionFull.status
            tags = eventEvolutionFull.tags.map { it.toMutableList() }
            url = eventEvolutionFull.url.map { it.toMutableList() }
            additionalProperties = eventEvolutionFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EventEvolutionFull].
         *
    ...
    fun validate(): EventEvolutionFull = apply {
        if (validated) {
            return@apply
        }
