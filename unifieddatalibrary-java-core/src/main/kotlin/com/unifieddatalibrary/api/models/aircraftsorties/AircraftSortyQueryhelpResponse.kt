...
class AircraftSortyQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AircraftSortyQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AircraftSortyQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyQueryhelpResponse: AircraftSortyQueryhelpResponse) =
            apply {
                aodrSupported = aircraftSortyQueryhelpResponse.aodrSupported
                classificationMarking = aircraftSortyQueryhelpResponse.classificationMarking
                description = aircraftSortyQueryhelpResponse.description
                historySupported = aircraftSortyQueryhelpResponse.historySupported
                name = aircraftSortyQueryhelpResponse.name
                parameters = aircraftSortyQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = aircraftSortyQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = aircraftSortyQueryhelpResponse.restSupported
                sortSupported = aircraftSortyQueryhelpResponse.sortSupported
                typeName = aircraftSortyQueryhelpResponse.typeName
                uri = aircraftSortyQueryhelpResponse.uri
                additionalProperties = aircraftSortyQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftSortyQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AircraftSortyQueryhelpResponse =
    ...
    fun validate(): AircraftSortyQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftSortyQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
