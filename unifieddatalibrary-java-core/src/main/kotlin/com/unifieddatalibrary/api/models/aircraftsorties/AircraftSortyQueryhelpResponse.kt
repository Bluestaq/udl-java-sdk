...
class AircraftSortyQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftSortyQueryhelpResponse: AircraftSortyQueryhelpResponse) = apply {
            ...
            additionalProperties =
                aircraftSortyQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): AircraftSortyQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
