...
/**
 * Service operation to take LaunchEvent entries as a POST body and ingest into the database. This
 * operation is intended to be used for automated feeds into UDL. A specific role is required to
 * perform this service operation. Please contact the UDL team for assistance.
 */
class LaunchEventUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [LaunchEventUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            launchEventUnvalidatedPublishParams: LaunchEventUnvalidatedPublishParams
        ) = apply {
            body = launchEventUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders = launchEventUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                launchEventUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchEventUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): LaunchEventUnvalidatedPublishParams =
            LaunchEventUnvalidatedPublishParams(
