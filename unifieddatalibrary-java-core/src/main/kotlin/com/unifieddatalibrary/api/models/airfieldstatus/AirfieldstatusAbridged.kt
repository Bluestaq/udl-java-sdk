...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirfieldstatusAbridged].
         *
    ...
    /** A builder for [AirfieldstatusAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldstatusAbridged: AirfieldstatusAbridged) = apply {
            classificationMarking = airfieldstatusAbridged.classificationMarking
            dataMode = airfieldstatusAbridged.dataMode
            idAirfield = airfieldstatusAbridged.idAirfield
            source = airfieldstatusAbridged.source
            id = airfieldstatusAbridged.id
            altAirfieldId = airfieldstatusAbridged.altAirfieldId
            approvedBy = airfieldstatusAbridged.approvedBy
            approvedDate = airfieldstatusAbridged.approvedDate
            arffCat = airfieldstatusAbridged.arffCat
            cargoMog = airfieldstatusAbridged.cargoMog
            createdAt = airfieldstatusAbridged.createdAt
            createdBy = airfieldstatusAbridged.createdBy
            fleetServiceMog = airfieldstatusAbridged.fleetServiceMog
            fuelMog = airfieldstatusAbridged.fuelMog
            fuelQtys = airfieldstatusAbridged.fuelQtys.map { it.toMutableList() }
            fuelTypes = airfieldstatusAbridged.fuelTypes.map { it.toMutableList() }
            gseTime = airfieldstatusAbridged.gseTime
            medCap = airfieldstatusAbridged.medCap
            message = airfieldstatusAbridged.message
            mheQtys = airfieldstatusAbridged.mheQtys.map { it.toMutableList() }
            mheTypes = airfieldstatusAbridged.mheTypes.map { it.toMutableList() }
            mxMog = airfieldstatusAbridged.mxMog
            narrowParkingMog = airfieldstatusAbridged.narrowParkingMog
            narrowWorkingMog = airfieldstatusAbridged.narrowWorkingMog
            numCog = airfieldstatusAbridged.numCog
            operatingMog = airfieldstatusAbridged.operatingMog
            origin = airfieldstatusAbridged.origin
            origNetwork = airfieldstatusAbridged.origNetwork
            passengerServiceMog = airfieldstatusAbridged.passengerServiceMog
            priFreq = airfieldstatusAbridged.priFreq
            priRwyNum = airfieldstatusAbridged.priRwyNum
            reviewedBy = airfieldstatusAbridged.reviewedBy
            reviewedDate = airfieldstatusAbridged.reviewedDate
            rwyCondReading = airfieldstatusAbridged.rwyCondReading
            rwyFrictionFactor = airfieldstatusAbridged.rwyFrictionFactor
            rwyMarkings = airfieldstatusAbridged.rwyMarkings.map { it.toMutableList() }
            slotTypesReq = airfieldstatusAbridged.slotTypesReq.map { it.toMutableList() }
            sourceDl = airfieldstatusAbridged.sourceDl
            surveyDate = airfieldstatusAbridged.surveyDate
            wideParkingMog = airfieldstatusAbridged.wideParkingMog
            wideWorkingMog = airfieldstatusAbridged.wideWorkingMog
            additionalProperties = airfieldstatusAbridged.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AirfieldstatusAbridged].
         *
         ...
         */
        fun build(): AirfieldstatusAbridged =
    ...
    fun validate(): AirfieldstatusAbridged = apply {
        if (validated) {
            return@apply
        }
