...
class TrackDetailCountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackDetailCountParams].
         *
    ...
    /** A builder for [TrackDetailCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailCountParams: TrackDetailCountParams) =
            apply {
                ts = trackDetailCountParams.ts
                firstResult = trackDetailCountParams.firstResult
                maxResults = trackDetailCountParams.maxResults
                additionalHeaders = trackDetailCountParams.additionalHeaders.toBuilder()
                additionalQueryParams = trackDetailCountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TrackDetailCountParams].
         *
         ...
         */
        fun build(): TrackDetailCountParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is TrackDetailCountParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "TrackDetailCountParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
