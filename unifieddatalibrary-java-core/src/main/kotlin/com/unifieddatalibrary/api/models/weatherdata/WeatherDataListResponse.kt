...
private constructor(
     ...
     */
    @JsonProperty("doppVels") @ExcludeMissing fun _doppVels(): JsonField<List<Double>> = doppVels
     ...
     */
    @JsonProperty("noiseLvls") @ExcludeMissing fun _noiseLvls(): JsonField<List<Double>> = noiseLvls
     ...
     */
    @JsonProperty("numElements") @ExcludeMissing fun _numElements(): JsonField<Int> = numElements
     ...
     */
    @JsonProperty("sigStrength") @ExcludeMissing fun _sigStrength(): JsonField<Double> = sigStrength
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataListResponse: WeatherDataListResponse) = apply {
         ...
         * value.
         */
        fun sigStrength(sigStrength: JsonField<Double>) = apply { this.sigStrength = sigStrength }
    ...
    fun validate(): WeatherDataListResponse = apply {
        if (validated) {
            return@apply
        }
