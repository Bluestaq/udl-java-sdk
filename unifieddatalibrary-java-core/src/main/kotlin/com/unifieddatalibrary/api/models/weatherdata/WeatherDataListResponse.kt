...
class WeatherDataListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("angleOrientation") @ExcludeMissing angleOrientation: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("avgRefPwr") @ExcludeMissing avgRefPwr: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("avgTxPwr") @ExcludeMissing avgTxPwr: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("checksum") @ExcludeMissing checksum: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("coIntegs") @ExcludeMissing coIntegs: JsonField<List<Int>> = JsonMissing.of(),
        @JsonProperty("consRecs") @ExcludeMissing consRecs: JsonField<List<Int>> = JsonMissing.of(),
        @JsonProperty("createdAt") @ExcludeMissing createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("createdBy") @ExcludeMissing createdBy: JsonField<String> = JsonMissing.of(),
        @JsonProperty("doppVels") @ExcludeMissing doppVels: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("fileCreation") @ExcludeMissing fileCreation: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("firstGuessAvgs") @ExcludeMissing firstGuessAvgs: JsonField<List<Int>> = JsonMissing.of(),
        @JsonProperty("idSensor") @ExcludeMissing idSensor: JsonField<String> = JsonMissing.of(),
        @JsonProperty("interpulsePeriods") @ExcludeMissing interpulsePeriods: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("lightDetSensors") @ExcludeMissing lightDetSensors: JsonField<List<Int>> = JsonMissing.of(),
        @JsonProperty("lightEventNum") @ExcludeMissing lightEventNum: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("noiseLvls") @ExcludeMissing noiseLvls: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("numElements") @ExcludeMissing numElements: JsonField<Int> = JsonMissing.of(),
        ...
        @JsonProperty("posConfidence") @ExcludeMissing posConfidence: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("semiMinorAxis") @ExcludeMissing semiMinorAxis: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("sigPwrs") @ExcludeMissing sigPwrs: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("sigStrength") @ExcludeMissing sigStrength: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("snrs") @ExcludeMissing snrs: JsonField<List<Double>> = JsonMissing.of(),
        @JsonProperty("specAvgs") @ExcludeMissing specAvgs: JsonField<List<Int>> = JsonMissing.of(),
        @JsonProperty("specWidths") @ExcludeMissing specWidths: JsonField<List<Double>> = JsonMissing.of(),
        ...
        @JsonProperty("tdAvgSampleNums") @ExcludeMissing tdAvgSampleNums: JsonField<List<Int>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun interpulsePeriods(): Optional<List<Double>> = interpulsePeriods.getOptional("interpulsePeriods")
     ...
     *
     * Unlike [angleOrientation], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _avgRefPwr(): JsonField<Double> = avgRefPwr
    ...
    @ExcludeMissing
    fun _avgTxPwr(): JsonField<Double> = avgTxPwr
    ...
    @ExcludeMissing
    fun _coIntegs(): JsonField<List<Int>> = coIntegs
    ...
    @ExcludeMissing
    fun _consRecs(): JsonField<List<Int>> = consRecs
     ...
     *
     * Unlike [interpulsePeriods], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _qcValue(): JsonField<Int> = qcValue
    ...
    @ExcludeMissing
    fun _sectorNum(): JsonField<Int> = sectorNum
    ...
    @ExcludeMissing
    fun _sigPwrs(): JsonField<List<Double>> = sigPwrs
    ...
    @ExcludeMissing
    fun _specAvgs(): JsonField<List<Int>> = specAvgs
     ...
     */
    @JsonProperty("termAlt")
    @ExcludeMissing
    fun _termAlt(): JsonField<Double> = termAlt
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WeatherDataListResponse].
         *
    ...
    /** A builder for [WeatherDataListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataListResponse: WeatherDataListResponse) =
            apply {
                classificationMarking = weatherDataListResponse.classificationMarking
                dataMode = weatherDataListResponse.dataMode
                obTime = weatherDataListResponse.obTime
                source = weatherDataListResponse.source
                id = weatherDataListResponse.id
                angleOrientation = weatherDataListResponse.angleOrientation
                avgRefPwr = weatherDataListResponse.avgRefPwr
                avgTxPwr = weatherDataListResponse.avgTxPwr
                checksum = weatherDataListResponse.checksum
                coIntegs = weatherDataListResponse.coIntegs.map { it.toMutableList() }
                consRecs = weatherDataListResponse.consRecs.map { it.toMutableList() }
                createdAt = weatherDataListResponse.createdAt
                createdBy = weatherDataListResponse.createdBy
                doppVels = weatherDataListResponse.doppVels.map { it.toMutableList() }
                fileCreation = weatherDataListResponse.fileCreation
                firstGuessAvgs = weatherDataListResponse.firstGuessAvgs.map { it.toMutableList() }
                idSensor = weatherDataListResponse.idSensor
                interpulsePeriods = weatherDataListResponse.interpulsePeriods.map { it.toMutableList() }
                lightDetSensors = weatherDataListResponse.lightDetSensors.map { it.toMutableList() }
                lightEventNum = weatherDataListResponse.lightEventNum
                noiseLvls = weatherDataListResponse.noiseLvls.map { it.toMutableList() }
                numElements = weatherDataListResponse.numElements
                origin = weatherDataListResponse.origin
                origNetwork = weatherDataListResponse.origNetwork
                origSensorId = weatherDataListResponse.origSensorId
                posConfidence = weatherDataListResponse.posConfidence
                qcValue = weatherDataListResponse.qcValue
                sectorNum = weatherDataListResponse.sectorNum
                semiMajorAxis = weatherDataListResponse.semiMajorAxis
                semiMinorAxis = weatherDataListResponse.semiMinorAxis
                sigPwrs = weatherDataListResponse.sigPwrs.map { it.toMutableList() }
                sigStrength = weatherDataListResponse.sigStrength
                snrs = weatherDataListResponse.snrs.map { it.toMutableList() }
                specAvgs = weatherDataListResponse.specAvgs.map { it.toMutableList() }
                specWidths = weatherDataListResponse.specWidths.map { it.toMutableList() }
                srcIds = weatherDataListResponse.srcIds.map { it.toMutableList() }
                srcTyps = weatherDataListResponse.srcTyps.map { it.toMutableList() }
                tdAvgSampleNums = weatherDataListResponse.tdAvgSampleNums.map { it.toMutableList() }
                termAlt = weatherDataListResponse.termAlt
                additionalProperties = weatherDataListResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Angle of orientation of the 50% positional confidence ellipse, in degrees clockwise from true north. */
        fun angleOrientation(angleOrientation: Double) = angleOrientation(JsonField.of(angleOrientation))

        /**
         * Sets [Builder.angleOrientation] to an arbitrary JSON value.
         *
         * You should usually call [Builder.angleOrientation] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun angleOrientation(angleOrientation: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.avgRefPwr] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun avgRefPwr(avgRefPwr: JsonField<Double>) =
            apply {
                this.avgRefPwr = avgRefPwr
            }
         ...
         *
         * You should usually call [Builder.avgTxPwr] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun avgTxPwr(avgTxPwr: JsonField<Double>) =
            apply {
                this.avgTxPwr = avgTxPwr
            }
         ...
         *
         * You should usually call [Builder.coIntegs] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun coIntegs(coIntegs: JsonField<List<Int>>) =
            apply {
         ...
         */
        fun addCoInteg(coInteg: Int) =
            apply {
                coIntegs = (coIntegs ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.consRecs] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun consRecs(consRecs: JsonField<List<Int>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConsRec(consRec: Int) =
            apply {
                consRecs = (consRecs ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.doppVels] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun doppVels(doppVels: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addDoppVel(doppVel: Double) =
            apply {
                doppVels = (doppVels ?: JsonField.of(mutableListOf())).also {
                    checkKnown("doppVels", it).add(doppVel)
                }
            }

        /** Datetime the system files were created. */
        fun fileCreation(fileCreation: OffsetDateTime) = fileCreation(JsonField.of(fileCreation))

        /**
         * Sets [Builder.fileCreation] to an arbitrary JSON value.
         *
         * You should usually call [Builder.fileCreation] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fileCreation(fileCreation: JsonField<OffsetDateTime>) =
            apply {
                this.fileCreation = fileCreation
            }

        /** Array of average maximum number(s) of consecutive instances in which the same first guess velocity is used in radar data processing to estimate wind speed. Users should consult the data provider for information on the first guess averages array structure. */
        fun firstGuessAvgs(firstGuessAvgs: List<Int>) = firstGuessAvgs(JsonField.of(firstGuessAvgs))

        /**
         * Sets [Builder.firstGuessAvgs] to an arbitrary JSON value.
         *
         * You should usually call [Builder.firstGuessAvgs] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun firstGuessAvgs(firstGuessAvgs: JsonField<List<Int>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFirstGuessAvg(firstGuessAvg: Int) =
            apply {
                firstGuessAvgs = (firstGuessAvgs ?: JsonField.of(mutableListOf())).also {
        ...
        /** Array of the elapsed time(s) from the beginning of one pulse to the beginning of the next pulse for a radar beam, in microseconds. Users should consult the data provider for information on the interpulse periods array structure. */
        fun interpulsePeriods(interpulsePeriods: List<Double>) = interpulsePeriods(JsonField.of(interpulsePeriods))

        /**
         * Sets [Builder.interpulsePeriods] to an arbitrary JSON value.
         *
         * You should usually call [Builder.interpulsePeriods] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun interpulsePeriods(interpulsePeriods: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addInterpulsePeriod(interpulsePeriod: Double) =
            apply {
                interpulsePeriods = (interpulsePeriods ?: JsonField.of(mutableListOf())).also {
                    checkKnown("interpulsePeriods", it).add(interpulsePeriod)
                }
            }

        /** Array of sensor(s) that participated in the lightning event location determination. */
        fun lightDetSensors(lightDetSensors: List<Int>) = lightDetSensors(JsonField.of(lightDetSensors))

        /**
         * Sets [Builder.lightDetSensors] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lightDetSensors] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightDetSensors(lightDetSensors: JsonField<List<Int>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLightDetSensor(lightDetSensor: Int) =
            apply {
                lightDetSensors = (lightDetSensors ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.lightEventNum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lightEventNum(lightEventNum: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.noiseLvls] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun noiseLvls(noiseLvls: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addNoiseLvl(noiseLvl: Double) =
            apply {
                noiseLvls = (noiseLvls ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.numElements] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numElements(numElements: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.posConfidence] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun posConfidence(posConfidence: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.qcValue] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun qcValue(qcValue: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.sectorNum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sectorNum(sectorNum: JsonField<Int>) =
            apply {
         ...
         *
         * You should usually call [Builder.semiMinorAxis] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun semiMinorAxis(semiMinorAxis: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.sigPwrs] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sigPwrs(sigPwrs: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSigPwr(sigPwr: Double) =
            apply {
                sigPwrs = (sigPwrs ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.sigStrength] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sigStrength(sigStrength: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.specAvgs] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun specAvgs(specAvgs: JsonField<List<Int>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSpecAvg(specAvg: Int) =
            apply {
                specAvgs = (specAvgs ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.specWidths] with a well-typed `List<Double>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun specWidths(specWidths: JsonField<List<Double>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSpecWidth(specWidth: Double) =
            apply {
                specWidths = (specWidths ?: JsonField.of(mutableListOf())).also {
        ...
        /** Array of the number(s) of radar samples used in time domain averaging for radar data processing. Time domain averaging improves the quality of the measured signal by reducing random noise and enhancing the signal-to-noise ratio. Users should consult the data provider for information on the time domain sample numbers array structure. */
        fun tdAvgSampleNums(tdAvgSampleNums: List<Int>) = tdAvgSampleNums(JsonField.of(tdAvgSampleNums))

        /**
         * Sets [Builder.tdAvgSampleNums] to an arbitrary JSON value.
         *
         * You should usually call [Builder.tdAvgSampleNums] with a well-typed `List<Int>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tdAvgSampleNums(tdAvgSampleNums: JsonField<List<Int>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTdAvgSampleNum(tdAvgSampleNum: Int) =
            apply {
                tdAvgSampleNums = (tdAvgSampleNums ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.termAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun termAlt(termAlt: JsonField<Double>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [WeatherDataListResponse].
         *
         ...
         */
        fun build(): WeatherDataListResponse =
    ...
    fun validate(): WeatherDataListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (obTime.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (angleOrientation.asKnown().isPresent) 1 else 0) + (if (avgRefPwr.asKnown().isPresent) 1 else 0) + (if (avgTxPwr.asKnown().isPresent) 1 else 0) + (if (checksum.asKnown().isPresent) 1 else 0) + (coIntegs.asKnown().getOrNull()?.size ?: 0) + (consRecs.asKnown().getOrNull()?.size ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (doppVels.asKnown().getOrNull()?.size ?: 0) + (if (fileCreation.asKnown().isPresent) 1 else 0) + (firstGuessAvgs.asKnown().getOrNull()?.size ?: 0) + (if (idSensor.asKnown().isPresent) 1 else 0) + (interpulsePeriods.asKnown().getOrNull()?.size ?: 0) + (lightDetSensors.asKnown().getOrNull()?.size ?: 0) + (if (lightEventNum.asKnown().isPresent) 1 else 0) + (noiseLvls.asKnown().getOrNull()?.size ?: 0) + (if (numElements.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origSensorId.asKnown().isPresent) 1 else 0) + (if (posConfidence.asKnown().isPresent) 1 else 0) + (if (qcValue.asKnown().isPresent) 1 else 0) + (if (sectorNum.asKnown().isPresent) 1 else 0) + (if (semiMajorAxis.asKnown().isPresent) 1 else 0) + (if (semiMinorAxis.asKnown().isPresent) 1 else 0) + (sigPwrs.asKnown().getOrNull()?.size ?: 0) + (if (sigStrength.asKnown().isPresent) 1 else 0) + (snrs.asKnown().getOrNull()?.size ?: 0) + (specAvgs.asKnown().getOrNull()?.size ?: 0) + (specWidths.asKnown().getOrNull()?.size ?: 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (tdAvgSampleNums.asKnown().getOrNull()?.size ?: 0) + (if (termAlt.asKnown().isPresent) 1 else 0)
