 ...
 */
class SeradataOpticalPayloadListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataOpticalPayloadListParams = builder().build()
        ...
        internal fun from(seradataOpticalPayloadListParams: SeradataOpticalPayloadListParams) =
            apply {
                ...
                additionalQueryParams =
                    seradataOpticalPayloadListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "SeradataOpticalPayloadListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
