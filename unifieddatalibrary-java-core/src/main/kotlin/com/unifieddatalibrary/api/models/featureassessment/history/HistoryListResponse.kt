...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            featureTs = historyListResponse.featureTs
            featureUoM = historyListResponse.featureUoM
            idAnalyticImagery = historyListResponse.idAnalyticImagery
            ...
            annLims = historyListResponse.annLims.map { it.toMutableList() }
            annText = historyListResponse.annText.map { it.toMutableList() }
            area = historyListResponse.area
            asrid = historyListResponse.asrid
            assessment = historyListResponse.assessment
            ...
            featureArray = historyListResponse.featureArray.map { it.toMutableList() }
            featureBool = historyListResponse.featureBool
            featureString = historyListResponse.featureString
            featureStringArray = historyListResponse.featureStringArray.map { it.toMutableList() }
            featureValue = historyListResponse.featureValue
            heading = historyListResponse.heading
            height = historyListResponse.height
            length = historyListResponse.length
            ...
            speed = historyListResponse.speed
            srcIds = historyListResponse.srcIds.map { it.toMutableList() }
            srcTs = historyListResponse.srcTs.map { it.toMutableList() }
            ...
            width = historyListResponse.width
