...
class HistoryListPage private constructor(
    ...
    private val items: List<EopFull>,
    ...
    fun autoPager(): AutoPager<EopFull> = AutoPager.from(this)

    /** The parameters that were used to request this page. */
    fun params(): HistoryListParams = params

    /** The response that this page was parsed from. */
    override fun items(): List<EopFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<EopFull>? = null
