...
class AiListParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AiListParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aiListParams: AiListParams) =
            apply {
                ts = aiListParams.ts
                firstResult = aiListParams.firstResult
                maxResults = aiListParams.maxResults
                additionalHeaders = aiListParams.additionalHeaders.toBuilder()
                additionalQueryParams = aiListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AiListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AiListParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AiListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
