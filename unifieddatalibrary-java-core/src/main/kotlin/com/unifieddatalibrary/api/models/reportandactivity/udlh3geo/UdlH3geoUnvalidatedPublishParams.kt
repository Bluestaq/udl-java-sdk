...
package com.unifieddatalibrary.api.models.reportandactivity.udlh3geo
...
/**
 * Service operation to take a single H3Geo record and many associated H3Geo hex cell records as a
 * POST body and ingest into the database. This operation is intended to be used for automated feeds
 * into UDL. A specific role is required to perform this service operation. Please contact the UDL
 * team for assistance.
 */
class UdlH3geoUnvalidatedPublishParams
private constructor(
        ...
        internal fun from(udlH3geoUnvalidatedPublishParams: UdlH3geoUnvalidatedPublishParams) =
            apply {
                ...
                additionalQueryParams =
                    udlH3geoUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "UdlH3geoUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
