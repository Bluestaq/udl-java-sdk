...
private constructor(
    private val detectTime: OffsetDateTime,
     ...
     */
    fun detectTime(): OffsetDateTime = detectTime
    ...
    class Builder internal constructor() {
        ...
        private var detectTime: OffsetDateTime? = null
        ...
        internal fun from(historyListParams: HistoryListParams) = apply {
            detectTime = historyListParams.detectTime
         ...
         * (YYYY-MM-DDTHH:MM:SS.sssZ)
         */
        fun detectTime(detectTime: OffsetDateTime) = apply { this.detectTime = detectTime }
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("detectTime", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(detectTime))
    ...
    override fun toString() =
        "HistoryListParams{detectTime=$detectTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
