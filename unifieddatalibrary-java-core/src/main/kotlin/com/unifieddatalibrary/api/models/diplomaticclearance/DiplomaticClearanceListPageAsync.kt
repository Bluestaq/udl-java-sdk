...
class DiplomaticClearanceListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<DiplomaticClearanceListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        fun service(service: DiplomaticClearanceServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DiplomaticClearanceListPageAsync &&
    ...
    override fun toString() =
        "DiplomaticClearanceListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
