...
class EopRetrieveParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): EopRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EopRetrieveParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EopRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopRetrieveParams: EopRetrieveParams) =
            apply {
                id = eopRetrieveParams.id
                firstResult = eopRetrieveParams.firstResult
                maxResults = eopRetrieveParams.maxResults
                additionalHeaders = eopRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams = eopRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EopRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EopRetrieveParams =
            EopRetrieveParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EopRetrieveParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EopRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
