...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EopRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eopRetrieveParams: EopRetrieveParams) = apply {
    ...
    override fun toString() =
        "EopRetrieveParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
