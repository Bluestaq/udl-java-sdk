...
class LaunchEventQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventQueryhelpResponse: LaunchEventQueryhelpResponse) = apply {
    ...
    fun validate(): LaunchEventQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
