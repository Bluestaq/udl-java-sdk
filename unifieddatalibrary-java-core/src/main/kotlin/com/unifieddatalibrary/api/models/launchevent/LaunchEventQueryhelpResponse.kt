...
class LaunchEventQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LaunchEventQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [LaunchEventQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchEventQueryhelpResponse: LaunchEventQueryhelpResponse) =
            apply {
                aodrSupported = launchEventQueryhelpResponse.aodrSupported
                classificationMarking = launchEventQueryhelpResponse.classificationMarking
                description = launchEventQueryhelpResponse.description
                historySupported = launchEventQueryhelpResponse.historySupported
                name = launchEventQueryhelpResponse.name
                parameters = launchEventQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = launchEventQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = launchEventQueryhelpResponse.restSupported
                sortSupported = launchEventQueryhelpResponse.sortSupported
                typeName = launchEventQueryhelpResponse.typeName
                uri = launchEventQueryhelpResponse.uri
                additionalProperties = launchEventQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LaunchEventQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LaunchEventQueryhelpResponse =
    ...
    fun validate(): LaunchEventQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchEventQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
