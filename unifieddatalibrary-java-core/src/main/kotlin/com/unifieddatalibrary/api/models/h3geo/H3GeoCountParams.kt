...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [H3GeoCountParams].
         *
    ...
    /** A builder for [H3GeoCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(h3GeoCountParams: H3GeoCountParams) = apply {
            startTime = h3GeoCountParams.startTime
            firstResult = h3GeoCountParams.firstResult
            maxResults = h3GeoCountParams.maxResults
            additionalHeaders = h3GeoCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = h3GeoCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [H3GeoCountParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is H3GeoCountParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "H3GeoCountParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
