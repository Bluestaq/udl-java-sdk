...
class CalibrationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalibrationTupleParams].
         *
    ...
    /** A builder for [CalibrationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationTupleParams: CalibrationTupleParams) =
            apply {
                columns = calibrationTupleParams.columns
                startTime = calibrationTupleParams.startTime
                firstResult = calibrationTupleParams.firstResult
                maxResults = calibrationTupleParams.maxResults
                additionalHeaders = calibrationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = calibrationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CalibrationTupleParams].
         *
         ...
         */
        fun build(): CalibrationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CalibrationTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CalibrationTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
