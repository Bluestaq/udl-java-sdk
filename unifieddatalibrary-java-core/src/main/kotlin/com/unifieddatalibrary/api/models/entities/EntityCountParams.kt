...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EntityCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityCountParams: EntityCountParams) = apply {
    ...
    override fun toString() =
        "EntityCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
