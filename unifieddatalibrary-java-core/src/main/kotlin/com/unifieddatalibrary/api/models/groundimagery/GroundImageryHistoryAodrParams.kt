 ...
 */
class GroundImageryHistoryAodrParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryHistoryAodrParams: GroundImageryHistoryAodrParams) = apply {
        ...
        /** Timestamp the image was captured/produced. (YYYY-MM-DDTHH:MM:SS.ssssssZ) */
        fun imageTime(imageTime: OffsetDateTime) = apply { this.imageTime = imageTime }
    ...
    override fun toString() =
        "GroundImageryHistoryAodrParams{imageTime=$imageTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
