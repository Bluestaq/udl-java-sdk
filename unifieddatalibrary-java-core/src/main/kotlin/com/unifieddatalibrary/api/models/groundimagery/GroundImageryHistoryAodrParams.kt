...
class GroundImageryHistoryAodrParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GroundImageryHistoryAodrParams].
         *
    ...
    /** A builder for [GroundImageryHistoryAodrParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groundImageryHistoryAodrParams: GroundImageryHistoryAodrParams) =
            apply {
                imageTime = groundImageryHistoryAodrParams.imageTime
                columns = groundImageryHistoryAodrParams.columns
                firstResult = groundImageryHistoryAodrParams.firstResult
                maxResults = groundImageryHistoryAodrParams.maxResults
                notification = groundImageryHistoryAodrParams.notification
                outputDelimiter = groundImageryHistoryAodrParams.outputDelimiter
                outputFormat = groundImageryHistoryAodrParams.outputFormat
                additionalHeaders = groundImageryHistoryAodrParams.additionalHeaders.toBuilder()
                additionalQueryParams = groundImageryHistoryAodrParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GroundImageryHistoryAodrParams].
         *
         ...
         */
        fun build(): GroundImageryHistoryAodrParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GroundImageryHistoryAodrParams && imageTime == other.imageTime && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && notification == other.notification && outputDelimiter == other.outputDelimiter && outputFormat == other.outputFormat && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(imageTime, columns, firstResult, maxResults, notification, outputDelimiter, outputFormat, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "GroundImageryHistoryAodrParams{imageTime=$imageTime, columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
