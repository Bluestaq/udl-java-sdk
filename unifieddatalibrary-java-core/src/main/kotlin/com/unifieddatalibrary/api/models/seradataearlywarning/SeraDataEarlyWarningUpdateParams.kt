...
/**
 * Service operation to update an SeradataEarlyWarning. A specific role is required to perform this
 * service operation. Please contact the UDL team for assistance.
 */
class SeraDataEarlyWarningUpdateParams
private constructor(
        ...
        internal fun from(seraDataEarlyWarningUpdateParams: SeraDataEarlyWarningUpdateParams) =
            apply {
                ...
                additionalQueryParams =
                    seraDataEarlyWarningUpdateParams.additionalQueryParams.toBuilder()
            }
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, spacecraftId=$spacecraftId, bodyId=$bodyId, bestResolution=$bestResolution, createdAt=$createdAt, createdBy=$createdBy, earthPointing=$earthPointing, frequencyLimits=$frequencyLimits, groundStationLocations=$groundStationLocations, groundStations=$groundStations, hostedForCompanyOrgId=$hostedForCompanyOrgId, idIr=$idIr, manufacturerOrgId=$manufacturerOrgId, missileLaunchPhaseDetectionAbility=$missileLaunchPhaseDetectionAbility, name=$name, origin=$origin, origNetwork=$origNetwork, partnerSpacecraftId=$partnerSpacecraftId, payloadNotes=$payloadNotes, spectralBands=$spectralBands, additionalProperties=$additionalProperties}"
    }
