...
class SeraDataEarlyWarningUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeraDataEarlyWarningUpdateParams].
         *
    ...
    /** A builder for [SeraDataEarlyWarningUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seraDataEarlyWarningUpdateParams: SeraDataEarlyWarningUpdateParams) =
            apply {
                pathId = seraDataEarlyWarningUpdateParams.pathId
                body = seraDataEarlyWarningUpdateParams.body.toBuilder()
                additionalHeaders = seraDataEarlyWarningUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = seraDataEarlyWarningUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SeraDataEarlyWarningUpdateParams].
         *
         ...
         */
        fun build(): SeraDataEarlyWarningUpdateParams =
    ...
    class Body private constructor(
        ...
        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, spacecraftId=$spacecraftId, bodyId=$bodyId, bestResolution=$bestResolution, createdAt=$createdAt, createdBy=$createdBy, earthPointing=$earthPointing, frequencyLimits=$frequencyLimits, groundStationLocations=$groundStationLocations, groundStations=$groundStations, hostedForCompanyOrgId=$hostedForCompanyOrgId, idIr=$idIr, manufacturerOrgId=$manufacturerOrgId, missileLaunchPhaseDetectionAbility=$missileLaunchPhaseDetectionAbility, name=$name, origin=$origin, origNetwork=$origNetwork, partnerSpacecraftId=$partnerSpacecraftId, payloadNotes=$payloadNotes, spectralBands=$spectralBands, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "SeraDataEarlyWarningUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
