...
private constructor(
    ...
    /** A builder for [SeradataSpacecraftDetailGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            seradataSpacecraftDetailGetResponse: SeradataSpacecraftDetailGetResponse
        ) = apply {
            classificationMarking = seradataSpacecraftDetailGetResponse.classificationMarking
            dataMode = seradataSpacecraftDetailGetResponse.dataMode
            name = seradataSpacecraftDetailGetResponse.name
            source = seradataSpacecraftDetailGetResponse.source
            id = seradataSpacecraftDetailGetResponse.id
            additionalMissionsGroups = seradataSpacecraftDetailGetResponse.additionalMissionsGroups
            altitude = seradataSpacecraftDetailGetResponse.altitude
            annualInsuredDepreciationFactor =
                seradataSpacecraftDetailGetResponse.annualInsuredDepreciationFactor
            annualInsuredDepreciationFactorEstimated =
                seradataSpacecraftDetailGetResponse.annualInsuredDepreciationFactorEstimated
            apogee = seradataSpacecraftDetailGetResponse.apogee
            busId = seradataSpacecraftDetailGetResponse.busId
            capabilityLost = seradataSpacecraftDetailGetResponse.capabilityLost
            capacityLost = seradataSpacecraftDetailGetResponse.capacityLost
            catalogNumber = seradataSpacecraftDetailGetResponse.catalogNumber
            collisionRiskCm = seradataSpacecraftDetailGetResponse.collisionRiskCm
            collisionRiskMm = seradataSpacecraftDetailGetResponse.collisionRiskMm
            combinedCostEstimated = seradataSpacecraftDetailGetResponse.combinedCostEstimated
            combinedNewCost = seradataSpacecraftDetailGetResponse.combinedNewCost
            commercialLaunch = seradataSpacecraftDetailGetResponse.commercialLaunch
            constellation = seradataSpacecraftDetailGetResponse.constellation
            costEstimated = seradataSpacecraftDetailGetResponse.costEstimated
            createdAt = seradataSpacecraftDetailGetResponse.createdAt
            createdBy = seradataSpacecraftDetailGetResponse.createdBy
            cubesatDispenserType = seradataSpacecraftDetailGetResponse.cubesatDispenserType
            currentAge = seradataSpacecraftDetailGetResponse.currentAge
            dateOfObservation = seradataSpacecraftDetailGetResponse.dateOfObservation
            description = seradataSpacecraftDetailGetResponse.description
            designLife = seradataSpacecraftDetailGetResponse.designLife
            dryMass = seradataSpacecraftDetailGetResponse.dryMass
            expectedLife = seradataSpacecraftDetailGetResponse.expectedLife
            geoPosition = seradataSpacecraftDetailGetResponse.geoPosition
            idOnOrbit = seradataSpacecraftDetailGetResponse.idOnOrbit
            inclination = seradataSpacecraftDetailGetResponse.inclination
            insuranceLossesTotal = seradataSpacecraftDetailGetResponse.insuranceLossesTotal
            insuranceNotes = seradataSpacecraftDetailGetResponse.insuranceNotes
            insurancePremiumAtLaunch = seradataSpacecraftDetailGetResponse.insurancePremiumAtLaunch
            insurancePremiumAtLaunchEstimated =
                seradataSpacecraftDetailGetResponse.insurancePremiumAtLaunchEstimated
            insuredAtLaunch = seradataSpacecraftDetailGetResponse.insuredAtLaunch
            insuredValueAtLaunch = seradataSpacecraftDetailGetResponse.insuredValueAtLaunch
            insuredValueLaunchEstimated =
                seradataSpacecraftDetailGetResponse.insuredValueLaunchEstimated
            intlNumber = seradataSpacecraftDetailGetResponse.intlNumber
            lat = seradataSpacecraftDetailGetResponse.lat
            launchArranger = seradataSpacecraftDetailGetResponse.launchArranger
            launchArrangerCountry = seradataSpacecraftDetailGetResponse.launchArrangerCountry
            launchCharacteristic = seradataSpacecraftDetailGetResponse.launchCharacteristic
            launchCost = seradataSpacecraftDetailGetResponse.launchCost
            launchCostEstimated = seradataSpacecraftDetailGetResponse.launchCostEstimated
            launchCountry = seradataSpacecraftDetailGetResponse.launchCountry
            launchDate = seradataSpacecraftDetailGetResponse.launchDate
            launchDateRemarks = seradataSpacecraftDetailGetResponse.launchDateRemarks
            launchId = seradataSpacecraftDetailGetResponse.launchId
            launchMass = seradataSpacecraftDetailGetResponse.launchMass
            launchNotes = seradataSpacecraftDetailGetResponse.launchNotes
            launchNumber = seradataSpacecraftDetailGetResponse.launchNumber
            launchProvider = seradataSpacecraftDetailGetResponse.launchProvider
            launchProviderCountry = seradataSpacecraftDetailGetResponse.launchProviderCountry
            launchProviderFlightNumber =
                seradataSpacecraftDetailGetResponse.launchProviderFlightNumber
            launchSiteId = seradataSpacecraftDetailGetResponse.launchSiteId
            launchSiteName = seradataSpacecraftDetailGetResponse.launchSiteName
            launchType = seradataSpacecraftDetailGetResponse.launchType
            launchVehicleId = seradataSpacecraftDetailGetResponse.launchVehicleId
            leased = seradataSpacecraftDetailGetResponse.leased
            lifeLost = seradataSpacecraftDetailGetResponse.lifeLost
            lon = seradataSpacecraftDetailGetResponse.lon
            massCategory = seradataSpacecraftDetailGetResponse.massCategory
            nameAtLaunch = seradataSpacecraftDetailGetResponse.nameAtLaunch
            newCost = seradataSpacecraftDetailGetResponse.newCost
            notes = seradataSpacecraftDetailGetResponse.notes
            numHumans = seradataSpacecraftDetailGetResponse.numHumans
            onOrbit = seradataSpacecraftDetailGetResponse.onOrbit
            operator = seradataSpacecraftDetailGetResponse.operator
            operatorCountry = seradataSpacecraftDetailGetResponse.operatorCountry
            orbitCategory = seradataSpacecraftDetailGetResponse.orbitCategory
            orbitSubCategory = seradataSpacecraftDetailGetResponse.orbitSubCategory
            orderDate = seradataSpacecraftDetailGetResponse.orderDate
            origin = seradataSpacecraftDetailGetResponse.origin
            origNetwork = seradataSpacecraftDetailGetResponse.origNetwork
            owner = seradataSpacecraftDetailGetResponse.owner
            ownerCountry = seradataSpacecraftDetailGetResponse.ownerCountry
            perigee = seradataSpacecraftDetailGetResponse.perigee
            period = seradataSpacecraftDetailGetResponse.period
            primaryMissionGroup = seradataSpacecraftDetailGetResponse.primaryMissionGroup
            primeManufacturerOrgId = seradataSpacecraftDetailGetResponse.primeManufacturerOrgId
            programName = seradataSpacecraftDetailGetResponse.programName
            quantity = seradataSpacecraftDetailGetResponse.quantity
            reusableFlights = seradataSpacecraftDetailGetResponse.reusableFlights
            reusedHullName = seradataSpacecraftDetailGetResponse.reusedHullName
            scientific = seradataSpacecraftDetailGetResponse.scientific.map { it.toMutableList() }
            sector = seradataSpacecraftDetailGetResponse.sector
            seradataCommDetails =
                seradataSpacecraftDetailGetResponse.seradataCommDetails.map { it.toMutableList() }
            seradataEarlyWarning =
                seradataSpacecraftDetailGetResponse.seradataEarlyWarning.map { it.toMutableList() }
            seradataNavigation =
                seradataSpacecraftDetailGetResponse.seradataNavigation.map { it.toMutableList() }
            seradataOpticalPayload =
                seradataSpacecraftDetailGetResponse.seradataOpticalPayload.map {
                    it.toMutableList()
                }
            seradataRadarPayload =
                seradataSpacecraftDetailGetResponse.seradataRadarPayload.map { it.toMutableList() }
            seradataSigIntPayload =
                seradataSpacecraftDetailGetResponse.seradataSigIntPayload.map { it.toMutableList() }
            serialNumber = seradataSpacecraftDetailGetResponse.serialNumber
            stabilizer = seradataSpacecraftDetailGetResponse.stabilizer
            status = seradataSpacecraftDetailGetResponse.status
            totalClaims = seradataSpacecraftDetailGetResponse.totalClaims
            totalFatalities = seradataSpacecraftDetailGetResponse.totalFatalities
            totalInjuries = seradataSpacecraftDetailGetResponse.totalInjuries
            totalPayloadPower = seradataSpacecraftDetailGetResponse.totalPayloadPower
            updatedAt = seradataSpacecraftDetailGetResponse.updatedAt
            updatedBy = seradataSpacecraftDetailGetResponse.updatedBy
            youtubeLaunchLink = seradataSpacecraftDetailGetResponse.youtubeLaunchLink
            additionalProperties =
                seradataSpacecraftDetailGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SeradataSpacecraftDetailGetResponse].
         *
         ...
         */
        fun build(): SeradataSpacecraftDetailGetResponse =
            SeradataSpacecraftDetailGetResponse(
    ...
    fun validate(): SeradataSpacecraftDetailGetResponse = apply {
        if (validated) {
            return@apply
        }
