...
class StarCatalogCountParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): StarCatalogCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(starCatalogCountParams: StarCatalogCountParams) =
            apply {
    ...
    override fun toString() = "StarCatalogCountParams{dec=$dec, firstResult=$firstResult, maxResults=$maxResults, ra=$ra, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
