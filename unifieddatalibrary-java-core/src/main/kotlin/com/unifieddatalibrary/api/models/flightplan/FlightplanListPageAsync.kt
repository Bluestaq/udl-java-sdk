...
private constructor(
    ...
    override fun nextPage(): CompletableFuture<FlightplanListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(flightplanListPageAsync: FlightplanListPageAsync) = apply {
        ...
        fun service(service: FlightplanServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FlightplanListPageAsync &&
    ...
    override fun toString() =
        "FlightplanListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
