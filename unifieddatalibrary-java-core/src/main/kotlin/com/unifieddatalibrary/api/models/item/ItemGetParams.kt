...
class ItemGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): ItemGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ItemGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ItemGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemGetParams: ItemGetParams) =
            apply {
                id = itemGetParams.id
                firstResult = itemGetParams.firstResult
                maxResults = itemGetParams.maxResults
                additionalHeaders = itemGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = itemGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ItemGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ItemGetParams =
            ItemGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ItemGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "ItemGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
