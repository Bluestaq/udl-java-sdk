...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ItemGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemGetParams: ItemGetParams) = apply {
            id = itemGetParams.id
    ...
    override fun toString() =
        "ItemGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
