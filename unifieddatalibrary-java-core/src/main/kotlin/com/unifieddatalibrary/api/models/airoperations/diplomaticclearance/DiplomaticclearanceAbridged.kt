...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diplomaticclearanceAbridged: DiplomaticclearanceAbridged) = apply {
            ...
            diplomaticClearanceDetails =
                diplomaticclearanceAbridged.diplomaticClearanceDetails.map { it.toMutableList() }
            diplomaticClearanceRemarks =
                diplomaticclearanceAbridged.diplomaticClearanceRemarks.map { it.toMutableList() }
    ...
    fun validate(): DiplomaticclearanceAbridged = apply {
        if (validated) {
            return@apply
        }
