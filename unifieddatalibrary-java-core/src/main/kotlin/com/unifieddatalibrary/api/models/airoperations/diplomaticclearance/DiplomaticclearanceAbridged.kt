...
class DiplomaticclearanceAbridged private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiplomaticclearanceAbridged].
         *
    ...
    /** A builder for [DiplomaticclearanceAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diplomaticclearanceAbridged: DiplomaticclearanceAbridged) =
            apply {
                classificationMarking = diplomaticclearanceAbridged.classificationMarking
                dataMode = diplomaticclearanceAbridged.dataMode
                firstDepDate = diplomaticclearanceAbridged.firstDepDate
                idMission = diplomaticclearanceAbridged.idMission
                source = diplomaticclearanceAbridged.source
                id = diplomaticclearanceAbridged.id
                apacsId = diplomaticclearanceAbridged.apacsId
                createdAt = diplomaticclearanceAbridged.createdAt
                createdBy = diplomaticclearanceAbridged.createdBy
                diplomaticClearanceDetails = diplomaticclearanceAbridged.diplomaticClearanceDetails.map { it.toMutableList() }
                diplomaticClearanceRemarks = diplomaticclearanceAbridged.diplomaticClearanceRemarks.map { it.toMutableList() }
                dipWorksheetName = diplomaticclearanceAbridged.dipWorksheetName
                docDeadline = diplomaticclearanceAbridged.docDeadline
                externalWorksheetId = diplomaticclearanceAbridged.externalWorksheetId
                origin = diplomaticclearanceAbridged.origin
                origNetwork = diplomaticclearanceAbridged.origNetwork
                sourceDl = diplomaticclearanceAbridged.sourceDl
                updatedAt = diplomaticclearanceAbridged.updatedAt
                updatedBy = diplomaticclearanceAbridged.updatedBy
                additionalProperties = diplomaticclearanceAbridged.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DiplomaticclearanceAbridged].
         *
         ...
         */
        fun build(): DiplomaticclearanceAbridged =
    ...
    fun validate(): DiplomaticclearanceAbridged =
        apply {
            if (validated) {
              return@apply
            }
