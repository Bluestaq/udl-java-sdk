...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elsetQueryhelpResponse: ElsetQueryhelpResponse) = apply {
    ...
    fun validate(): ElsetQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
