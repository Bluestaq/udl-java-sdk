...
class ElsetQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ElsetQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ElsetQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elsetQueryhelpResponse: ElsetQueryhelpResponse) =
            apply {
                aodrSupported = elsetQueryhelpResponse.aodrSupported
                classificationMarking = elsetQueryhelpResponse.classificationMarking
                description = elsetQueryhelpResponse.description
                historySupported = elsetQueryhelpResponse.historySupported
                name = elsetQueryhelpResponse.name
                parameters = elsetQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = elsetQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = elsetQueryhelpResponse.restSupported
                sortSupported = elsetQueryhelpResponse.sortSupported
                typeName = elsetQueryhelpResponse.typeName
                uri = elsetQueryhelpResponse.uri
                additionalProperties = elsetQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ElsetQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ElsetQueryhelpResponse =
    ...
    fun validate(): ElsetQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ElsetQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
