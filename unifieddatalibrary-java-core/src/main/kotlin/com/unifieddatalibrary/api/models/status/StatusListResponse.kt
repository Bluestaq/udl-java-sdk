...
class StatusListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusListResponse: StatusListResponse) =
            apply {
    ...
    fun validate(): StatusListResponse =
        apply {
            if (validated) {
              return@apply
            }
