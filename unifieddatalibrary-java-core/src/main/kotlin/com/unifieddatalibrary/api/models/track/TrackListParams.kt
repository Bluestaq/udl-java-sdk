...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(trackListParams: TrackListParams) = apply {
            ts = trackListParams.ts
            firstResult = trackListParams.firstResult
            maxResults = trackListParams.maxResults
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TrackListParams && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TrackListParams{ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
