...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftstatusFull: AircraftstatusFull) = apply {
    ...
    fun validate(): AircraftstatusFull = apply {
        if (validated) {
            return@apply
        }
