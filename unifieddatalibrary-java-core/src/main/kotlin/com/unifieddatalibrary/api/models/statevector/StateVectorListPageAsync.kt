...
class StateVectorListPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<StateVectorListPageAsync> =
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stateVectorListPageAsync: StateVectorListPageAsync) = apply {
        ...
        fun service(service: StateVectorServiceAsync) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StateVectorListPageAsync &&
    ...
    override fun toString() =
        "StateVectorListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
