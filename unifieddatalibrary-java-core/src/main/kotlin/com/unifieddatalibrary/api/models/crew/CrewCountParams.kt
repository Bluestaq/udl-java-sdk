...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CrewCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crewCountParams: CrewCountParams) = apply {
    ...
    override fun toString() =
        "CrewCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
