...
class AiTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AiTupleParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aiTupleParams: AiTupleParams) =
            apply {
                columns = aiTupleParams.columns
                ts = aiTupleParams.ts
                firstResult = aiTupleParams.firstResult
                maxResults = aiTupleParams.maxResults
                additionalHeaders = aiTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = aiTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AiTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AiTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AiTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
