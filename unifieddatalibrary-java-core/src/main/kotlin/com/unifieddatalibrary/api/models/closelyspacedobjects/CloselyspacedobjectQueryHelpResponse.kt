...
class CloselyspacedobjectQueryHelpResponse
...
private constructor(
    ...
    /** A builder for [CloselyspacedobjectQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            closelyspacedobjectQueryHelpResponse: CloselyspacedobjectQueryHelpResponse
        ) = apply {
            aodrSupported = closelyspacedobjectQueryHelpResponse.aodrSupported
            classificationMarking = closelyspacedobjectQueryHelpResponse.classificationMarking
            description = closelyspacedobjectQueryHelpResponse.description
            historySupported = closelyspacedobjectQueryHelpResponse.historySupported
            name = closelyspacedobjectQueryHelpResponse.name
            parameters = closelyspacedobjectQueryHelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                closelyspacedobjectQueryHelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = closelyspacedobjectQueryHelpResponse.restSupported
            sortSupported = closelyspacedobjectQueryHelpResponse.sortSupported
            typeName = closelyspacedobjectQueryHelpResponse.typeName
            uri = closelyspacedobjectQueryHelpResponse.uri
            additionalProperties =
                closelyspacedobjectQueryHelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CloselyspacedobjectQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CloselyspacedobjectQueryHelpResponse =
            CloselyspacedobjectQueryHelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): CloselyspacedobjectQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloselyspacedobjectQueryHelpResponse &&
