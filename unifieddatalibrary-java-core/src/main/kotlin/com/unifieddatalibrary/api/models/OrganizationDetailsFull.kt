...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationDetailsFull].
         *
    ...
    /** A builder for [OrganizationDetailsFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationDetailsFull: OrganizationDetailsFull) = apply {
            classificationMarking = organizationDetailsFull.classificationMarking
            dataMode = organizationDetailsFull.dataMode
            idOrganization = organizationDetailsFull.idOrganization
            name = organizationDetailsFull.name
            source = organizationDetailsFull.source
            id = organizationDetailsFull.id
            address1 = organizationDetailsFull.address1
            address2 = organizationDetailsFull.address2
            address3 = organizationDetailsFull.address3
            broker = organizationDetailsFull.broker
            ceo = organizationDetailsFull.ceo
            cfo = organizationDetailsFull.cfo
            createdAt = organizationDetailsFull.createdAt
            createdBy = organizationDetailsFull.createdBy
            cto = organizationDetailsFull.cto
            description = organizationDetailsFull.description
            ebitda = organizationDetailsFull.ebitda
            email = organizationDetailsFull.email
            financialNotes = organizationDetailsFull.financialNotes
            financialYearEndDate = organizationDetailsFull.financialYearEndDate
            fleetPlanNotes = organizationDetailsFull.fleetPlanNotes
            formerOrgId = organizationDetailsFull.formerOrgId
            ftes = organizationDetailsFull.ftes
            geoAdminLevel1 = organizationDetailsFull.geoAdminLevel1
            geoAdminLevel2 = organizationDetailsFull.geoAdminLevel2
            geoAdminLevel3 = organizationDetailsFull.geoAdminLevel3
            massRanking = organizationDetailsFull.massRanking
            origin = organizationDetailsFull.origin
            origNetwork = organizationDetailsFull.origNetwork
            parentOrgId = organizationDetailsFull.parentOrgId
            postalCode = organizationDetailsFull.postalCode
            profit = organizationDetailsFull.profit
            revenue = organizationDetailsFull.revenue
            revenueRanking = organizationDetailsFull.revenueRanking
            riskManager = organizationDetailsFull.riskManager
            servicesNotes = organizationDetailsFull.servicesNotes
            tags = organizationDetailsFull.tags.map { it.toMutableList() }
            updatedAt = organizationDetailsFull.updatedAt
            updatedBy = organizationDetailsFull.updatedBy
            additionalProperties = organizationDetailsFull.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationDetailsFull].
         *
         ...
         */
        fun build(): OrganizationDetailsFull =
    ...
    fun validate(): OrganizationDetailsFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "OrganizationDetailsFull{classificationMarking=$classificationMarking, dataMode=$dataMode, idOrganization=$idOrganization, name=$name, source=$source, id=$id, address1=$address1, address2=$address2, address3=$address3, broker=$broker, ceo=$ceo, cfo=$cfo, createdAt=$createdAt, createdBy=$createdBy, cto=$cto, description=$description, ebitda=$ebitda, email=$email, financialNotes=$financialNotes, financialYearEndDate=$financialYearEndDate, fleetPlanNotes=$fleetPlanNotes, formerOrgId=$formerOrgId, ftes=$ftes, geoAdminLevel1=$geoAdminLevel1, geoAdminLevel2=$geoAdminLevel2, geoAdminLevel3=$geoAdminLevel3, massRanking=$massRanking, origin=$origin, origNetwork=$origNetwork, parentOrgId=$parentOrgId, postalCode=$postalCode, profit=$profit, revenue=$revenue, revenueRanking=$revenueRanking, riskManager=$riskManager, servicesNotes=$servicesNotes, tags=$tags, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
