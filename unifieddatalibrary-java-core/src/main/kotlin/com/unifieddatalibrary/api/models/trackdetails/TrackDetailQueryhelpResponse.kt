...
class TrackDetailQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailQueryhelpResponse: TrackDetailQueryhelpResponse) = apply {
    ...
    fun validate(): TrackDetailQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
