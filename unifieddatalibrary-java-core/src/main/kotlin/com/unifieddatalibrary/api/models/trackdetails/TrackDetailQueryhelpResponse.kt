...
class TrackDetailQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TrackDetailQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [TrackDetailQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailQueryhelpResponse: TrackDetailQueryhelpResponse) =
            apply {
                aodrSupported = trackDetailQueryhelpResponse.aodrSupported
                classificationMarking = trackDetailQueryhelpResponse.classificationMarking
                description = trackDetailQueryhelpResponse.description
                historySupported = trackDetailQueryhelpResponse.historySupported
                name = trackDetailQueryhelpResponse.name
                parameters = trackDetailQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = trackDetailQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = trackDetailQueryhelpResponse.restSupported
                sortSupported = trackDetailQueryhelpResponse.sortSupported
                typeName = trackDetailQueryhelpResponse.typeName
                uri = trackDetailQueryhelpResponse.uri
                additionalProperties = trackDetailQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TrackDetailQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TrackDetailQueryhelpResponse =
    ...
    fun validate(): TrackDetailQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
