...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LocationCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LocationCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LocationCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(locationCountParams: LocationCountParams) = apply {
            firstResult = locationCountParams.firstResult
            maxResults = locationCountParams.maxResults
            additionalHeaders = locationCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = locationCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LocationCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LocationCountParams =
            LocationCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LocationCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LocationCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
