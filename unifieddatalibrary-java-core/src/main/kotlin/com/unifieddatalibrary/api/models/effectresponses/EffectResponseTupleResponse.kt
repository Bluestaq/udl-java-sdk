...
class EffectResponseTupleResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseTupleResponse: EffectResponseTupleResponse) =
            apply {
    ...
    fun validate(): EffectResponseTupleResponse =
        apply {
            if (validated) {
              return@apply
            }
