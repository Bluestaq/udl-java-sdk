...
/**
 * Service operation to take multiple OnorbitAssessment records as a POST body and ingest into the
 ...
 */
class OnorbitassessmentUnvalidatedPublishParams
private constructor(
    ...
    /** A builder for [OnorbitassessmentUnvalidatedPublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            onorbitassessmentUnvalidatedPublishParams: OnorbitassessmentUnvalidatedPublishParams
        ) = apply {
            body = onorbitassessmentUnvalidatedPublishParams.body.toMutableList()
            additionalHeaders =
                onorbitassessmentUnvalidatedPublishParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                onorbitassessmentUnvalidatedPublishParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitassessmentUnvalidatedPublishParams].
         *
         ...
         */
        fun build(): OnorbitassessmentUnvalidatedPublishParams =
            OnorbitassessmentUnvalidatedPublishParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OnorbitassessmentUnvalidatedPublishParams &&
            body == other.body &&
    ...
    override fun toString() =
        "OnorbitassessmentUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
