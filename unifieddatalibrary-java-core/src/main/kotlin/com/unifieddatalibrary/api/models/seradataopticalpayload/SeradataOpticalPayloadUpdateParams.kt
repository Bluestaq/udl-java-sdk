 ...
 */
class SeradataOpticalPayloadUpdateParams
private constructor(
        ...
        internal fun from(seradataOpticalPayloadUpdateParams: SeradataOpticalPayloadUpdateParams) =
            apply {
                ...
                additionalQueryParams =
                    seradataOpticalPayloadUpdateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SeradataOpticalPayloadUpdateParams &&
            pathId == other.pathId &&
            body == other.body &&
    ...
    override fun toString() =
        "SeradataOpticalPayloadUpdateParams{pathId=$pathId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
