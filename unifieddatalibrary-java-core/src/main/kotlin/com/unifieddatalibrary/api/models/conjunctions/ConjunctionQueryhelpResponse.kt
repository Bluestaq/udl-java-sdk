...
class ConjunctionQueryhelpResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConjunctionQueryhelpResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConjunctionQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conjunctionQueryhelpResponse: ConjunctionQueryhelpResponse) = apply {
            aodrSupported = conjunctionQueryhelpResponse.aodrSupported
            classificationMarking = conjunctionQueryhelpResponse.classificationMarking
            description = conjunctionQueryhelpResponse.description
            historySupported = conjunctionQueryhelpResponse.historySupported
            name = conjunctionQueryhelpResponse.name
            parameters = conjunctionQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles = conjunctionQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = conjunctionQueryhelpResponse.restSupported
            sortSupported = conjunctionQueryhelpResponse.sortSupported
            typeName = conjunctionQueryhelpResponse.typeName
            uri = conjunctionQueryhelpResponse.uri
            additionalProperties = conjunctionQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConjunctionQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConjunctionQueryhelpResponse =
    ...
    fun validate(): ConjunctionQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConjunctionQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
