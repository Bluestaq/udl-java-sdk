...
class AntennaQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaQueryhelpResponse: AntennaQueryhelpResponse) = apply {
    ...
    fun validate(): AntennaQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
