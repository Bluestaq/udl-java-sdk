...
class AntennaQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AntennaQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [AntennaQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(antennaQueryhelpResponse: AntennaQueryhelpResponse) =
            apply {
                aodrSupported = antennaQueryhelpResponse.aodrSupported
                classificationMarking = antennaQueryhelpResponse.classificationMarking
                description = antennaQueryhelpResponse.description
                historySupported = antennaQueryhelpResponse.historySupported
                name = antennaQueryhelpResponse.name
                parameters = antennaQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = antennaQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = antennaQueryhelpResponse.restSupported
                sortSupported = antennaQueryhelpResponse.sortSupported
                typeName = antennaQueryhelpResponse.typeName
                uri = antennaQueryhelpResponse.uri
                additionalProperties = antennaQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AntennaQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AntennaQueryhelpResponse =
    ...
    fun validate(): AntennaQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AntennaQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
