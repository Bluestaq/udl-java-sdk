...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffofarrivalFull: DiffofarrivalFull) = apply {
    ...
    fun validate(): DiffofarrivalFull = apply {
        if (validated) {
            return@apply
        }
