...
class DiffofarrivalFull private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DiffofarrivalFull].
         *
    ...
    /** A builder for [DiffofarrivalFull]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(diffofarrivalFull: DiffofarrivalFull) =
            apply {
                classificationMarking = diffofarrivalFull.classificationMarking
                dataMode = diffofarrivalFull.dataMode
                obTime = diffofarrivalFull.obTime
                source = diffofarrivalFull.source
                id = diffofarrivalFull.id
                bandwidth = diffofarrivalFull.bandwidth
                collectionMode = diffofarrivalFull.collectionMode
                createdAt = diffofarrivalFull.createdAt
                createdBy = diffofarrivalFull.createdBy
                deltaRange = diffofarrivalFull.deltaRange
                deltaRangeRate = diffofarrivalFull.deltaRangeRate
                deltaRangeRateUnc = diffofarrivalFull.deltaRangeRateUnc
                deltaRangeUnc = diffofarrivalFull.deltaRangeUnc
                descriptor = diffofarrivalFull.descriptor
                fdoa = diffofarrivalFull.fdoa
                fdoaUnc = diffofarrivalFull.fdoaUnc
                frequency = diffofarrivalFull.frequency
                idOnOrbit = diffofarrivalFull.idOnOrbit
                idSensor1 = diffofarrivalFull.idSensor1
                idSensor2 = diffofarrivalFull.idSensor2
                onOrbit = diffofarrivalFull.onOrbit
                origin = diffofarrivalFull.origin
                origNetwork = diffofarrivalFull.origNetwork
                origObjectId = diffofarrivalFull.origObjectId
                origSensorId1 = diffofarrivalFull.origSensorId1
                origSensorId2 = diffofarrivalFull.origSensorId2
                rawFileUri = diffofarrivalFull.rawFileUri
                satNo = diffofarrivalFull.satNo
                sen2alt = diffofarrivalFull.sen2alt
                sen2lat = diffofarrivalFull.sen2lat
                sen2lon = diffofarrivalFull.sen2lon
                senalt = diffofarrivalFull.senalt
                senlat = diffofarrivalFull.senlat
                senlon = diffofarrivalFull.senlon
                sensor1Delay = diffofarrivalFull.sensor1Delay
                sensor2Delay = diffofarrivalFull.sensor2Delay
                snr = diffofarrivalFull.snr
                sourceDl = diffofarrivalFull.sourceDl
                tags = diffofarrivalFull.tags.map { it.toMutableList() }
                taskId = diffofarrivalFull.taskId
                tdoa = diffofarrivalFull.tdoa
                tdoaUnc = diffofarrivalFull.tdoaUnc
                transactionId = diffofarrivalFull.transactionId
                uct = diffofarrivalFull.uct
                additionalProperties = diffofarrivalFull.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DiffofarrivalFull].
         *
    ...
    fun validate(): DiffofarrivalFull =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (obTime.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (bandwidth.asKnown().isPresent) 1 else 0) + (if (collectionMode.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (deltaRange.asKnown().isPresent) 1 else 0) + (if (deltaRangeRate.asKnown().isPresent) 1 else 0) + (if (deltaRangeRateUnc.asKnown().isPresent) 1 else 0) + (if (deltaRangeUnc.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (fdoa.asKnown().isPresent) 1 else 0) + (if (fdoaUnc.asKnown().isPresent) 1 else 0) + (if (frequency.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idSensor1.asKnown().isPresent) 1 else 0) + (if (idSensor2.asKnown().isPresent) 1 else 0) + (onOrbit.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (origSensorId1.asKnown().isPresent) 1 else 0) + (if (origSensorId2.asKnown().isPresent) 1 else 0) + (if (rawFileUri.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (if (sen2alt.asKnown().isPresent) 1 else 0) + (if (sen2lat.asKnown().isPresent) 1 else 0) + (if (sen2lon.asKnown().isPresent) 1 else 0) + (if (senalt.asKnown().isPresent) 1 else 0) + (if (senlat.asKnown().isPresent) 1 else 0) + (if (senlon.asKnown().isPresent) 1 else 0) + (if (sensor1Delay.asKnown().isPresent) 1 else 0) + (if (sensor2Delay.asKnown().isPresent) 1 else 0) + (if (snr.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0) + (if (taskId.asKnown().isPresent) 1 else 0) + (if (tdoa.asKnown().isPresent) 1 else 0) + (if (tdoaUnc.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (uct.asKnown().isPresent) 1 else 0)
