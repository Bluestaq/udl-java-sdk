...
class SigactQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SigactQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SigactQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sigactQueryhelpResponse: SigactQueryhelpResponse) =
            apply {
                aodrSupported = sigactQueryhelpResponse.aodrSupported
                classificationMarking = sigactQueryhelpResponse.classificationMarking
                description = sigactQueryhelpResponse.description
                historySupported = sigactQueryhelpResponse.historySupported
                name = sigactQueryhelpResponse.name
                parameters = sigactQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = sigactQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = sigactQueryhelpResponse.restSupported
                sortSupported = sigactQueryhelpResponse.sortSupported
                typeName = sigactQueryhelpResponse.typeName
                uri = sigactQueryhelpResponse.uri
                additionalProperties = sigactQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SigactQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SigactQueryhelpResponse =
    ...
    fun validate(): SigactQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
