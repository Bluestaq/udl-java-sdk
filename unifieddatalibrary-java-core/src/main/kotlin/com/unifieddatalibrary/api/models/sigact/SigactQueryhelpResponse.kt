...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sigactQueryhelpResponse: SigactQueryhelpResponse) = apply {
    ...
    fun validate(): SigactQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
