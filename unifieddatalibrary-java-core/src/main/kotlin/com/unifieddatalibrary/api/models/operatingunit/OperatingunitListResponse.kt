 ...
 */
class OperatingunitListResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitListResponse: OperatingunitListResponse) = apply {
    ...
    fun validate(): OperatingunitListResponse = apply {
        if (validated) {
            return@apply
        }
