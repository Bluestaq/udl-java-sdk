...
class OperatingunitListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("altOperatingUnitId") @ExcludeMissing altOperatingUnitId: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("deployStatus") @ExcludeMissing deployStatus: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("echelonTier") @ExcludeMissing echelonTier: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("masterUnit") @ExcludeMissing masterUnit: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("msnPrimarySpecialty") @ExcludeMissing msnPrimarySpecialty: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("stylizedUnit") @ExcludeMissing stylizedUnit: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("symCode") @ExcludeMissing symCode: JsonField<String> = JsonMissing.of(),
        @JsonProperty("unitIdentifier") @ExcludeMissing unitIdentifier: JsonField<String> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun altOperatingUnitId(): Optional<String> = altOperatingUnitId.getOptional("altOperatingUnitId")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun msnPrimarySpecialty(): Optional<String> = msnPrimarySpecialty.getOptional("msnPrimarySpecialty")
     ...
     *
     * Unlike [altOperatingUnitId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("divCat")
    @ExcludeMissing
    fun _divCat(): JsonField<String> = divCat
    ...
    @ExcludeMissing
    fun _echelon(): JsonField<String> = echelon
    ...
    @ExcludeMissing
    fun _flagFlown(): JsonField<String> = flagFlown
    ...
    @ExcludeMissing
    fun _fleetId(): JsonField<String> = fleetId
    ...
    @JsonProperty("force")
    @ExcludeMissing
    fun _force(): JsonField<String> = force
    ...
    @ExcludeMissing
    fun _forceName(): JsonField<String> = forceName
    ...
    @ExcludeMissing
    fun _functRole(): JsonField<String> = functRole
    ...
    @ExcludeMissing
    fun _idContact(): JsonField<String> = idContact
    ...
    @ExcludeMissing
    fun _locName(): JsonField<String> = locName
    ...
    @ExcludeMissing
    fun _locReason(): JsonField<String> = locReason
     ...
     *
     * Unlike [msnPrimarySpecialty], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperatingunitListResponse].
         *
    ...
    /** A builder for [OperatingunitListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitListResponse: OperatingunitListResponse) =
            apply {
                classificationMarking = operatingunitListResponse.classificationMarking
                dataMode = operatingunitListResponse.dataMode
                name = operatingunitListResponse.name
                source = operatingunitListResponse.source
                airDefArea = operatingunitListResponse.airDefArea
                allegiance = operatingunitListResponse.allegiance
                altAllegiance = operatingunitListResponse.altAllegiance
                altCountryCode = operatingunitListResponse.altCountryCode
                altOperatingUnitId = operatingunitListResponse.altOperatingUnitId
                classRating = operatingunitListResponse.classRating
                condition = operatingunitListResponse.condition
                conditionAvail = operatingunitListResponse.conditionAvail
                coord = operatingunitListResponse.coord
                coordDatum = operatingunitListResponse.coordDatum
                coordDerivAcc = operatingunitListResponse.coordDerivAcc
                countryCode = operatingunitListResponse.countryCode
                createdAt = operatingunitListResponse.createdAt
                createdBy = operatingunitListResponse.createdBy
                deployStatus = operatingunitListResponse.deployStatus
                description = operatingunitListResponse.description
                divCat = operatingunitListResponse.divCat
                echelon = operatingunitListResponse.echelon
                echelonTier = operatingunitListResponse.echelonTier
                elevMsl = operatingunitListResponse.elevMsl
                elevMslConfLvl = operatingunitListResponse.elevMslConfLvl
                elevMslDerivAcc = operatingunitListResponse.elevMslDerivAcc
                eval = operatingunitListResponse.eval
                flagFlown = operatingunitListResponse.flagFlown
                fleetId = operatingunitListResponse.fleetId
                force = operatingunitListResponse.force
                forceName = operatingunitListResponse.forceName
                fpa = operatingunitListResponse.fpa
                functRole = operatingunitListResponse.functRole
                geoidalMslSep = operatingunitListResponse.geoidalMslSep
                idContact = operatingunitListResponse.idContact
                ident = operatingunitListResponse.ident
                idLocation = operatingunitListResponse.idLocation
                idOperatingUnit = operatingunitListResponse.idOperatingUnit
                idOrganization = operatingunitListResponse.idOrganization
                lat = operatingunitListResponse.lat
                locName = operatingunitListResponse.locName
                locReason = operatingunitListResponse.locReason
                lon = operatingunitListResponse.lon
                masterUnit = operatingunitListResponse.masterUnit
                milGrid = operatingunitListResponse.milGrid
                milGridSys = operatingunitListResponse.milGridSys
                msnPrimary = operatingunitListResponse.msnPrimary
                msnPrimarySpecialty = operatingunitListResponse.msnPrimarySpecialty
                operStatus = operatingunitListResponse.operStatus
                origin = operatingunitListResponse.origin
                polSubdiv = operatingunitListResponse.polSubdiv
                recStatus = operatingunitListResponse.recStatus
                referenceDoc = operatingunitListResponse.referenceDoc
                resProd = operatingunitListResponse.resProd
                reviewDate = operatingunitListResponse.reviewDate
                stylizedUnit = operatingunitListResponse.stylizedUnit
                symCode = operatingunitListResponse.symCode
                unitIdentifier = operatingunitListResponse.unitIdentifier
                utm = operatingunitListResponse.utm
                wac = operatingunitListResponse.wac
                additionalProperties = operatingunitListResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Unique identifier of the operating unit record from the originating system. */
        fun altOperatingUnitId(altOperatingUnitId: String) = altOperatingUnitId(JsonField.of(altOperatingUnitId))

        /**
         * Sets [Builder.altOperatingUnitId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.altOperatingUnitId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun altOperatingUnitId(altOperatingUnitId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.deployStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun deployStatus(deployStatus: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.divCat] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun divCat(divCat: JsonField<String>) =
            apply {
                this.divCat = divCat
            }
         ...
         *
         * You should usually call [Builder.echelon] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun echelon(echelon: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.echelonTier] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun echelonTier(echelonTier: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.flagFlown] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun flagFlown(flagFlown: JsonField<String>) =
            apply {
                this.flagFlown = flagFlown
            }
         ...
         *
         * You should usually call [Builder.fleetId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fleetId(fleetId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.force] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun force(force: JsonField<String>) =
            apply {
                this.force = force
            }
         ...
         *
         * You should usually call [Builder.forceName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun forceName(forceName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.functRole] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun functRole(functRole: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.idContact] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idContact(idContact: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.locName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun locName(locName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.locReason] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun locReason(locReason: JsonField<String>) =
            apply {
                this.locReason = locReason
            }
         ...
         *
         * You should usually call [Builder.masterUnit] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun masterUnit(masterUnit: JsonField<Boolean>) =
            apply {
        ...
        /** Indicates the principal specialty type of mission that an operating unit is organized and equipped to perform. The specific usage and enumerations contained in this field may be found in the documentation provided in the referenceDoc field. If referenceDoc not provided, users may consult the data provider. */
        fun msnPrimarySpecialty(msnPrimarySpecialty: String) = msnPrimarySpecialty(JsonField.of(msnPrimarySpecialty))

        /**
         * Sets [Builder.msnPrimarySpecialty] to an arbitrary JSON value.
         *
         * You should usually call [Builder.msnPrimarySpecialty] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun msnPrimarySpecialty(msnPrimarySpecialty: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.stylizedUnit] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stylizedUnit(stylizedUnit: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.unitIdentifier] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun unitIdentifier(unitIdentifier: JsonField<String>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [OperatingunitListResponse].
         *
         ...
         */
        fun build(): OperatingunitListResponse =
    ...
    fun validate(): OperatingunitListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (airDefArea.asKnown().isPresent) 1 else 0) + (if (allegiance.asKnown().isPresent) 1 else 0) + (if (altAllegiance.asKnown().isPresent) 1 else 0) + (if (altCountryCode.asKnown().isPresent) 1 else 0) + (if (altOperatingUnitId.asKnown().isPresent) 1 else 0) + (if (classRating.asKnown().isPresent) 1 else 0) + (if (condition.asKnown().isPresent) 1 else 0) + (if (conditionAvail.asKnown().isPresent) 1 else 0) + (if (coord.asKnown().isPresent) 1 else 0) + (if (coordDatum.asKnown().isPresent) 1 else 0) + (if (coordDerivAcc.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (deployStatus.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (divCat.asKnown().isPresent) 1 else 0) + (if (echelon.asKnown().isPresent) 1 else 0) + (if (echelonTier.asKnown().isPresent) 1 else 0) + (if (elevMsl.asKnown().isPresent) 1 else 0) + (if (elevMslConfLvl.asKnown().isPresent) 1 else 0) + (if (elevMslDerivAcc.asKnown().isPresent) 1 else 0) + (if (eval.asKnown().isPresent) 1 else 0) + (if (flagFlown.asKnown().isPresent) 1 else 0) + (if (fleetId.asKnown().isPresent) 1 else 0) + (if (force.asKnown().isPresent) 1 else 0) + (if (forceName.asKnown().isPresent) 1 else 0) + (if (fpa.asKnown().isPresent) 1 else 0) + (if (functRole.asKnown().isPresent) 1 else 0) + (if (geoidalMslSep.asKnown().isPresent) 1 else 0) + (if (idContact.asKnown().isPresent) 1 else 0) + (if (ident.asKnown().isPresent) 1 else 0) + (if (idLocation.asKnown().isPresent) 1 else 0) + (if (idOperatingUnit.asKnown().isPresent) 1 else 0) + (if (idOrganization.asKnown().isPresent) 1 else 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (locName.asKnown().isPresent) 1 else 0) + (if (locReason.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (masterUnit.asKnown().isPresent) 1 else 0) + (if (milGrid.asKnown().isPresent) 1 else 0) + (if (milGridSys.asKnown().isPresent) 1 else 0) + (if (msnPrimary.asKnown().isPresent) 1 else 0) + (if (msnPrimarySpecialty.asKnown().isPresent) 1 else 0) + (if (operStatus.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (polSubdiv.asKnown().isPresent) 1 else 0) + (if (recStatus.asKnown().isPresent) 1 else 0) + (if (referenceDoc.asKnown().isPresent) 1 else 0) + (if (resProd.asKnown().isPresent) 1 else 0) + (if (reviewDate.asKnown().isPresent) 1 else 0) + (if (stylizedUnit.asKnown().isPresent) 1 else 0) + (if (symCode.asKnown().isPresent) 1 else 0) + (if (unitIdentifier.asKnown().isPresent) 1 else 0) + (if (utm.asKnown().isPresent) 1 else 0) + (if (wac.asKnown().isPresent) 1 else 0)
