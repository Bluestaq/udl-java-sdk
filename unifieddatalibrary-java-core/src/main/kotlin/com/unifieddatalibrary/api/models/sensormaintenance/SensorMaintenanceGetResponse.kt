...
class SensorMaintenanceGetResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SensorMaintenanceGetResponse].
         *
    ...
    /** A builder for [SensorMaintenanceGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceGetResponse: SensorMaintenanceGetResponse) = apply {
            classificationMarking = sensorMaintenanceGetResponse.classificationMarking
            dataMode = sensorMaintenanceGetResponse.dataMode
            endTime = sensorMaintenanceGetResponse.endTime
            siteCode = sensorMaintenanceGetResponse.siteCode
            source = sensorMaintenanceGetResponse.source
            startTime = sensorMaintenanceGetResponse.startTime
            id = sensorMaintenanceGetResponse.id
            activity = sensorMaintenanceGetResponse.activity
            approver = sensorMaintenanceGetResponse.approver
            changer = sensorMaintenanceGetResponse.changer
            createdAt = sensorMaintenanceGetResponse.createdAt
            createdBy = sensorMaintenanceGetResponse.createdBy
            duration = sensorMaintenanceGetResponse.duration
            eowId = sensorMaintenanceGetResponse.eowId
            equipStatus = sensorMaintenanceGetResponse.equipStatus
            externalId = sensorMaintenanceGetResponse.externalId
            idSensor = sensorMaintenanceGetResponse.idSensor
            impactedFaces = sensorMaintenanceGetResponse.impactedFaces
            inactiveDate = sensorMaintenanceGetResponse.inactiveDate
            lineNumber = sensorMaintenanceGetResponse.lineNumber
            mdOpsCap = sensorMaintenanceGetResponse.mdOpsCap
            mwOpsCap = sensorMaintenanceGetResponse.mwOpsCap
            origin = sensorMaintenanceGetResponse.origin
            origNetwork = sensorMaintenanceGetResponse.origNetwork
            priority = sensorMaintenanceGetResponse.priority
            recall = sensorMaintenanceGetResponse.recall
            rel = sensorMaintenanceGetResponse.rel
            remark = sensorMaintenanceGetResponse.remark
            requestor = sensorMaintenanceGetResponse.requestor
            resource = sensorMaintenanceGetResponse.resource
            rev = sensorMaintenanceGetResponse.rev
            ssOpsCap = sensorMaintenanceGetResponse.ssOpsCap
            updatedAt = sensorMaintenanceGetResponse.updatedAt
            updatedBy = sensorMaintenanceGetResponse.updatedBy
            additionalProperties = sensorMaintenanceGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SensorMaintenanceGetResponse].
         *
         ...
         */
        fun build(): SensorMaintenanceGetResponse =
    ...
    fun validate(): SensorMaintenanceGetResponse = apply {
        if (validated) {
            return@apply
        }
