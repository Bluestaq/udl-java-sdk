...
class SensorMaintenanceGetResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceGetResponse: SensorMaintenanceGetResponse) =
            apply {
    ...
    fun validate(): SensorMaintenanceGetResponse =
        apply {
            if (validated) {
              return@apply
            }
