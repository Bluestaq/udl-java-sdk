...
/** Service operation to take a list of onboard navigation records as a POST body and ingest into the database. This operation is intended to be used for automated feeds into UDL. A specific role is required to perform this service operation. Please contact the UDL team for assistance. */
class OnboardnavigationUnvalidatedPublishParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OnboardnavigationUnvalidatedPublishParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onboardnavigationUnvalidatedPublishParams: OnboardnavigationUnvalidatedPublishParams) =
            apply {
                body = onboardnavigationUnvalidatedPublishParams.body.toMutableList()
                additionalHeaders = onboardnavigationUnvalidatedPublishParams.additionalHeaders.toBuilder()
                additionalQueryParams = onboardnavigationUnvalidatedPublishParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("deltaPos") @ExcludeMissing private val deltaPos: JsonField<List<List<Double>>>,
        ...
        @JsonProperty("referenceFrame") @ExcludeMissing private val referenceFrame: JsonField<ReferenceFrame>,
        @JsonProperty("satNo") @ExcludeMissing private val satNo: JsonField<Int>,
        @JsonProperty("starCatLoadTime") @ExcludeMissing private val starCatLoadTime: JsonField<OffsetDateTime>,
        @JsonProperty("starCatName") @ExcludeMissing private val starCatName: JsonField<String>,
        @JsonProperty("starTracker") @ExcludeMissing private val starTracker: JsonField<List<List<Double>>>,
        @JsonProperty("sunSensor") @ExcludeMissing private val sunSensor: JsonField<List<List<Double>>>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnboardnavigationUnvalidatedPublishParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "OnboardnavigationUnvalidatedPublishParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
