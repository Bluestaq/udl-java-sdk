...
private constructor(
    ...
    private val items: List<SortiePprFull>,
) : PageAsync<SortiePprFull> {
    ...
    fun autoPager(): AutoPagerAsync<SortiePprFull> =
    ...
    override fun items(): List<SortiePprFull> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<SortiePprFull>? = null
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<SortiePprFull>) = apply { this.items = items }
