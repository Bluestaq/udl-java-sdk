...
class BeamContourListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamContourListPage: BeamContourListPage) =
            apply {
        ...
        fun service(service: BeamContourService) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: BeamContourListParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun items(items: List<BeamcontourAbridged>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BeamContourListPage && service == other.service && params == other.params && items == other.items /* spotless:on */
    }
