...
class CollectRequestQueryHelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(collectRequestQueryHelpResponse: CollectRequestQueryHelpResponse) =
            apply {
                ...
                requiredRoles =
                    collectRequestQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                ...
                additionalProperties =
                    collectRequestQueryHelpResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): CollectRequestQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
