...
class CollectRequestQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CollectRequestQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [CollectRequestQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestQueryHelpResponse: CollectRequestQueryHelpResponse) =
            apply {
                aodrSupported = collectRequestQueryHelpResponse.aodrSupported
                classificationMarking = collectRequestQueryHelpResponse.classificationMarking
                description = collectRequestQueryHelpResponse.description
                historySupported = collectRequestQueryHelpResponse.historySupported
                name = collectRequestQueryHelpResponse.name
                parameters = collectRequestQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = collectRequestQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = collectRequestQueryHelpResponse.restSupported
                sortSupported = collectRequestQueryHelpResponse.sortSupported
                typeName = collectRequestQueryHelpResponse.typeName
                uri = collectRequestQueryHelpResponse.uri
                additionalProperties = collectRequestQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CollectRequestQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CollectRequestQueryHelpResponse =
    ...
    fun validate(): CollectRequestQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CollectRequestQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
