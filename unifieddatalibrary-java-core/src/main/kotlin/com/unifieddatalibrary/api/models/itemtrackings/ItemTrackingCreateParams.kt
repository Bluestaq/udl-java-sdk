...
class ItemTrackingCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingCreateParams: ItemTrackingCreateParams) =
            apply {
        ...
        /** The ID of the scanner or input device. */
        fun scannerId(scannerId: String) =
            apply {
                body.scannerId(scannerId)
            }
    ...
    override fun toString() = "ItemTrackingCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
