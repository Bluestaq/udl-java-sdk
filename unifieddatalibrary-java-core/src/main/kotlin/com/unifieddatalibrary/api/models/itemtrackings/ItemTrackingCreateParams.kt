 ...
 * team for assistance.
 */
class ItemTrackingCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun scannerId(): String = body.scannerId()
     ...
     *   if the server responded with an unexpected value).
     */
    fun idItem(): Optional<String> = body.idItem()
     ...
     *   if the server responded with an unexpected value).
     */
    fun scanType(): Optional<String> = body.scanType()
     ...
     */
    fun _scannerId(): JsonField<String> = body._scannerId()
     ...
     */
    fun _idItem(): JsonField<String> = body._idItem()
     ...
     */
    fun _scanType(): JsonField<String> = body._scanType()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemTrackingCreateParams].
         *
    ...
    /** A builder for [ItemTrackingCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(itemTrackingCreateParams: ItemTrackingCreateParams) = apply {
            body = itemTrackingCreateParams.body.toBuilder()
            additionalHeaders = itemTrackingCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = itemTrackingCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * barcode or UPC.
         */
        fun scanCode(scanCode: String) = apply { body.scanCode(scanCode) }
         ...
         */
        fun scanCode(scanCode: JsonField<String>) = apply { body.scanCode(scanCode) }

        /** The ID of the scanner or input device. */
        fun scannerId(scannerId: String) = apply { body.scannerId(scannerId) }
         ...
         * value.
         */
        fun scannerId(scannerId: JsonField<String>) = apply { body.scannerId(scannerId) }
         ...
         * people.
         */
        fun dvCode(dvCode: String) = apply { body.dvCode(dvCode) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dvCode(dvCode: JsonField<String>) = apply { body.dvCode(dvCode) }

        /** The UDL ID of the item this record is associated with. */
        fun idItem(idItem: String) = apply { body.idItem(idItem) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun idItem(idItem: JsonField<String>) = apply { body.idItem(idItem) }
         ...
         */
        fun scanType(scanType: String) = apply { body.scanType(scanType) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun scanType(scanType: JsonField<String>) = apply { body.scanType(scanType) }

        /**
         * The algorithm name or standard that generated the scanCode (e.g. UPC-A, EAN-13, GTIN,
         * SSCC, bID, JAN, etc.).
         */
        fun scGenTool(scGenTool: String) = apply { body.scGenTool(scGenTool) }
         ...
         * value.
         */
        fun scGenTool(scGenTool: JsonField<String>) = apply { body.scGenTool(scGenTool) }
        ...
        /**
         * Returns an immutable instance of [ItemTrackingCreateParams].
         *
         ...
         */
        fun build(): ItemTrackingCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ItemTrackingCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ItemTrackingCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
