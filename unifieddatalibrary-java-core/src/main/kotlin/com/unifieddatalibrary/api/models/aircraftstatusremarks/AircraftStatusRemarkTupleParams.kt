...
class AircraftStatusRemarkTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftStatusRemarkTupleParams].
         *
    ...
    /** A builder for [AircraftStatusRemarkTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftStatusRemarkTupleParams: AircraftStatusRemarkTupleParams) =
            apply {
                columns = aircraftStatusRemarkTupleParams.columns
                firstResult = aircraftStatusRemarkTupleParams.firstResult
                maxResults = aircraftStatusRemarkTupleParams.maxResults
                additionalHeaders = aircraftStatusRemarkTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = aircraftStatusRemarkTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AircraftStatusRemarkTupleParams].
         *
         ...
         */
        fun build(): AircraftStatusRemarkTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AircraftStatusRemarkTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AircraftStatusRemarkTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
