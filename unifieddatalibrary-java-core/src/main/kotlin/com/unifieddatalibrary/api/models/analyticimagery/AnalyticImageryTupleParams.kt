...
class AnalyticImageryTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AnalyticImageryTupleParams].
         *
    ...
    /** A builder for [AnalyticImageryTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryTupleParams: AnalyticImageryTupleParams) =
            apply {
                columns = analyticImageryTupleParams.columns
                msgTime = analyticImageryTupleParams.msgTime
                firstResult = analyticImageryTupleParams.firstResult
                maxResults = analyticImageryTupleParams.maxResults
                additionalHeaders = analyticImageryTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = analyticImageryTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticImageryTupleParams].
         *
         ...
         */
        fun build(): AnalyticImageryTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AnalyticImageryTupleParams && columns == other.columns && msgTime == other.msgTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(columns, msgTime, firstResult, maxResults, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "AnalyticImageryTupleParams{columns=$columns, msgTime=$msgTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
