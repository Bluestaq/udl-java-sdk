...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ManifoldListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldListParams: ManifoldListParams) = apply {
    ...
    override fun toString() =
        "ManifoldListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
