...
class LogisticsSupportGetResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportGetResponse: LogisticsSupportGetResponse) =
            apply {
                ...
                logisticsDiscrepancyInfos = logisticsSupportGetResponse.logisticsDiscrepancyInfos.map { it.toMutableList() }
                logisticsRecordId = logisticsSupportGetResponse.logisticsRecordId
                logisticsRemarks = logisticsSupportGetResponse.logisticsRemarks.map { it.toMutableList() }
                logisticsSupportItems = logisticsSupportGetResponse.logisticsSupportItems.map { it.toMutableList() }
                logisticsTransportationPlans = logisticsSupportGetResponse.logisticsTransportationPlans.map { it.toMutableList() }
    ...
    fun validate(): LogisticsSupportGetResponse =
        apply {
            if (validated) {
              return@apply
            }
