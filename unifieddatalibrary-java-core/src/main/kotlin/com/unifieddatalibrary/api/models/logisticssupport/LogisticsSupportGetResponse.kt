 ...
 * personnel.
 */
class LogisticsSupportGetResponse
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        logisticsDiscrepancyInfos: JsonField<List<LogisticsDiscrepancyInfosFull>> =
            JsonMissing.of(),
        ...
        @ExcludeMissing
        logisticsSupportItems: JsonField<List<LogisticsSupportItemsFull>> = JsonMissing.of(),
        @JsonProperty("logisticsTransportationPlans")
        @ExcludeMissing
        logisticsTransportationPlans: JsonField<List<LogisticsTransportationPlansFull>> =
            JsonMissing.of(),
     ...
     *   if the server responded with an unexpected value).
     */
    fun logisticsDiscrepancyInfos(): Optional<List<LogisticsDiscrepancyInfosFull>> =
     ...
     *   if the server responded with an unexpected value).
     */
    fun logisticsSupportItems(): Optional<List<LogisticsSupportItemsFull>> =
     ...
     *   if the server responded with an unexpected value).
     */
    fun logisticsTransportationPlans(): Optional<List<LogisticsTransportationPlansFull>> =
    ...
    @JsonProperty("logisticsDiscrepancyInfos")
    @ExcludeMissing
    fun _logisticsDiscrepancyInfos(): JsonField<List<LogisticsDiscrepancyInfosFull>> =
        logisticsDiscrepancyInfos
    ...
    @JsonProperty("logisticsTransportationPlans")
    @ExcludeMissing
    fun _logisticsTransportationPlans(): JsonField<List<LogisticsTransportationPlansFull>> =
        logisticsTransportationPlans
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LogisticsSupportGetResponse].
         *
    ...
    /** A builder for [LogisticsSupportGetResponse]. */
    class Builder internal constructor() {
        ...
        private var logisticsDiscrepancyInfos:
            JsonField<MutableList<LogisticsDiscrepancyInfosFull>>? =
            null
        ...
        private var logisticsTransportationPlans:
            JsonField<MutableList<LogisticsTransportationPlansFull>>? =
            null
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportGetResponse: LogisticsSupportGetResponse) = apply {
            classificationMarking = logisticsSupportGetResponse.classificationMarking
            dataMode = logisticsSupportGetResponse.dataMode
            rptCreatedTime = logisticsSupportGetResponse.rptCreatedTime
            source = logisticsSupportGetResponse.source
            id = logisticsSupportGetResponse.id
            aircraftMds = logisticsSupportGetResponse.aircraftMds
            createdAt = logisticsSupportGetResponse.createdAt
            createdBy = logisticsSupportGetResponse.createdBy
            currIcao = logisticsSupportGetResponse.currIcao
            etic = logisticsSupportGetResponse.etic
            etmc = logisticsSupportGetResponse.etmc
            extSystemId = logisticsSupportGetResponse.extSystemId
            logisticAction = logisticsSupportGetResponse.logisticAction
            logisticsDiscrepancyInfos =
                logisticsSupportGetResponse.logisticsDiscrepancyInfos.map { it.toMutableList() }
            logisticsRecordId = logisticsSupportGetResponse.logisticsRecordId
            logisticsRemarks =
                logisticsSupportGetResponse.logisticsRemarks.map { it.toMutableList() }
            logisticsSupportItems =
                logisticsSupportGetResponse.logisticsSupportItems.map { it.toMutableList() }
            logisticsTransportationPlans =
                logisticsSupportGetResponse.logisticsTransportationPlans.map { it.toMutableList() }
            maintStatusCode = logisticsSupportGetResponse.maintStatusCode
            mcTime = logisticsSupportGetResponse.mcTime
            meTime = logisticsSupportGetResponse.meTime
            origin = logisticsSupportGetResponse.origin
            origNetwork = logisticsSupportGetResponse.origNetwork
            owner = logisticsSupportGetResponse.owner
            reopenFlag = logisticsSupportGetResponse.reopenFlag
            rptClosedTime = logisticsSupportGetResponse.rptClosedTime
            suppIcao = logisticsSupportGetResponse.suppIcao
            tailNumber = logisticsSupportGetResponse.tailNumber
            updatedAt = logisticsSupportGetResponse.updatedAt
            updatedBy = logisticsSupportGetResponse.updatedBy
            additionalProperties = logisticsSupportGetResponse.additionalProperties.toMutableMap()
        }
        ...
        fun logisticsDiscrepancyInfos(
            logisticsDiscrepancyInfos: List<LogisticsDiscrepancyInfosFull>
         ...
         * `List<LogisticsDiscrepancyInfosFull>` value instead. This method is primarily for setting
        ...
        /** Support items associated with this LogisticsSupport record. */
        fun logisticsSupportItems(logisticsSupportItems: List<LogisticsSupportItemsFull>) =
         ...
         * `List<LogisticsSupportItemsFull>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun logisticsSupportItems(
            logisticsSupportItems: JsonField<List<LogisticsSupportItemsFull>>
        ) = apply { this.logisticsSupportItems = logisticsSupportItems.map { it.toMutableList() } }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLogisticsSupportItem(logisticsSupportItem: LogisticsSupportItemsFull) = apply {
            logisticsSupportItems =
        ...
        fun logisticsTransportationPlans(
            logisticsTransportationPlans: List<LogisticsTransportationPlansFull>
         ...
         * `List<LogisticsTransportationPlansFull>` value instead. This method is primarily for
        ...
        fun addLogisticsTransportationPlan(
            logisticsTransportationPlan: LogisticsTransportationPlansFull
        ) = apply {
            logisticsTransportationPlans =
        ...
        /**
         * Returns an immutable instance of [LogisticsSupportGetResponse].
         *
         ...
         */
        fun build(): LogisticsSupportGetResponse =
    ...
    fun validate(): LogisticsSupportGetResponse = apply {
        if (validated) {
            return@apply
        }
