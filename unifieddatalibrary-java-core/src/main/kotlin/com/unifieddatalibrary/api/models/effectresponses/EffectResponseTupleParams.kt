...
class EffectResponseTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EffectResponseTupleParams].
         *
    ...
    /** A builder for [EffectResponseTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(effectResponseTupleParams: EffectResponseTupleParams) =
            apply {
                columns = effectResponseTupleParams.columns
                createdAt = effectResponseTupleParams.createdAt
                firstResult = effectResponseTupleParams.firstResult
                maxResults = effectResponseTupleParams.maxResults
                additionalHeaders = effectResponseTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = effectResponseTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EffectResponseTupleParams].
         *
         ...
         */
        fun build(): EffectResponseTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EffectResponseTupleParams && columns == other.columns && createdAt == other.createdAt && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "EffectResponseTupleParams{columns=$columns, createdAt=$createdAt, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
