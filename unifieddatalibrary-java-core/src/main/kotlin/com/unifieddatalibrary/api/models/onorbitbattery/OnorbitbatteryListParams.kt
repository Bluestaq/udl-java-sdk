 ...
 */
class OnorbitbatteryListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitbatteryListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitbatteryListParams: OnorbitbatteryListParams) = apply {
    ...
    override fun toString() =
        "OnorbitbatteryListParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
