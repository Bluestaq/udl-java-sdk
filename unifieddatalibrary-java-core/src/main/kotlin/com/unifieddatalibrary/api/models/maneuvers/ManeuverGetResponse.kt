...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ManeuverGetResponse].
         *
    ...
    /** A builder for [ManeuverGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(maneuverGetResponse: ManeuverGetResponse) = apply {
            classificationMarking = maneuverGetResponse.classificationMarking
            dataMode = maneuverGetResponse.dataMode
            eventStartTime = maneuverGetResponse.eventStartTime
            source = maneuverGetResponse.source
            id = maneuverGetResponse.id
            algorithm = maneuverGetResponse.algorithm
            characterization = maneuverGetResponse.characterization
            characterizationUnc = maneuverGetResponse.characterizationUnc
            cov = maneuverGetResponse.cov.map { it.toMutableList() }
            createdAt = maneuverGetResponse.createdAt
            createdBy = maneuverGetResponse.createdBy
            deltaMass = maneuverGetResponse.deltaMass
            deltaPos = maneuverGetResponse.deltaPos
            deltaPosU = maneuverGetResponse.deltaPosU
            deltaPosV = maneuverGetResponse.deltaPosV
            deltaPosW = maneuverGetResponse.deltaPosW
            deltaVel = maneuverGetResponse.deltaVel
            deltaVelU = maneuverGetResponse.deltaVelU
            deltaVelV = maneuverGetResponse.deltaVelV
            deltaVelW = maneuverGetResponse.deltaVelW
            description = maneuverGetResponse.description
            descriptor = maneuverGetResponse.descriptor
            eventEndTime = maneuverGetResponse.eventEndTime
            eventId = maneuverGetResponse.eventId
            idOnOrbit = maneuverGetResponse.idOnOrbit
            idSensor = maneuverGetResponse.idSensor
            maneuverUnc = maneuverGetResponse.maneuverUnc
            mnvrAccels = maneuverGetResponse.mnvrAccels.map { it.toMutableList() }
            mnvrAccelTimes = maneuverGetResponse.mnvrAccelTimes.map { it.toMutableList() }
            mnvrAccelUncs = maneuverGetResponse.mnvrAccelUncs.map { it.toMutableList() }
            numAccelPoints = maneuverGetResponse.numAccelPoints
            numObs = maneuverGetResponse.numObs
            odFitEndTime = maneuverGetResponse.odFitEndTime
            onOrbit = maneuverGetResponse.onOrbit
            origin = maneuverGetResponse.origin
            origNetwork = maneuverGetResponse.origNetwork
            origObjectId = maneuverGetResponse.origObjectId
            origSensorId = maneuverGetResponse.origSensorId
            postApogee = maneuverGetResponse.postApogee
            postArea = maneuverGetResponse.postArea
            postBallisticCoeff = maneuverGetResponse.postBallisticCoeff
            postDriftRate = maneuverGetResponse.postDriftRate
            postEccentricity = maneuverGetResponse.postEccentricity
            postEventElset = maneuverGetResponse.postEventElset
            postEventIdElset = maneuverGetResponse.postEventIdElset
            postEventIdStateVector = maneuverGetResponse.postEventIdStateVector
            postEventStateVector = maneuverGetResponse.postEventStateVector
            postGeoLongitude = maneuverGetResponse.postGeoLongitude
            postInclination = maneuverGetResponse.postInclination
            postMass = maneuverGetResponse.postMass
            postPerigee = maneuverGetResponse.postPerigee
            postPeriod = maneuverGetResponse.postPeriod
            postPosX = maneuverGetResponse.postPosX
            postPosY = maneuverGetResponse.postPosY
            postPosZ = maneuverGetResponse.postPosZ
            postRaan = maneuverGetResponse.postRaan
            postRadiationPressCoeff = maneuverGetResponse.postRadiationPressCoeff
            postSigmaU = maneuverGetResponse.postSigmaU
            postSigmaV = maneuverGetResponse.postSigmaV
            postSigmaW = maneuverGetResponse.postSigmaW
            postSma = maneuverGetResponse.postSma
            postVelX = maneuverGetResponse.postVelX
            postVelY = maneuverGetResponse.postVelY
            postVelZ = maneuverGetResponse.postVelZ
            preApogee = maneuverGetResponse.preApogee
            preBallisticCoeff = maneuverGetResponse.preBallisticCoeff
            preDriftRate = maneuverGetResponse.preDriftRate
            preEccentricity = maneuverGetResponse.preEccentricity
            preEventElset = maneuverGetResponse.preEventElset
            preEventIdElset = maneuverGetResponse.preEventIdElset
            preEventIdStateVector = maneuverGetResponse.preEventIdStateVector
            preEventStateVector = maneuverGetResponse.preEventStateVector
            preGeoLongitude = maneuverGetResponse.preGeoLongitude
            preInclination = maneuverGetResponse.preInclination
            prePerigee = maneuverGetResponse.prePerigee
            prePeriod = maneuverGetResponse.prePeriod
            prePosX = maneuverGetResponse.prePosX
            prePosY = maneuverGetResponse.prePosY
            prePosZ = maneuverGetResponse.prePosZ
            preRaan = maneuverGetResponse.preRaan
            preRadiationPressCoeff = maneuverGetResponse.preRadiationPressCoeff
            preSigmaU = maneuverGetResponse.preSigmaU
            preSigmaV = maneuverGetResponse.preSigmaV
            preSigmaW = maneuverGetResponse.preSigmaW
            preSma = maneuverGetResponse.preSma
            preVelX = maneuverGetResponse.preVelX
            preVelY = maneuverGetResponse.preVelY
            preVelZ = maneuverGetResponse.preVelZ
            reportTime = maneuverGetResponse.reportTime
            satNo = maneuverGetResponse.satNo
            sourcedData = maneuverGetResponse.sourcedData.map { it.toMutableList() }
            sourcedDataTypes = maneuverGetResponse.sourcedDataTypes.map { it.toMutableList() }
            stateModel = maneuverGetResponse.stateModel
            stateModelVersion = maneuverGetResponse.stateModelVersion
            status = maneuverGetResponse.status
            tags = maneuverGetResponse.tags.map { it.toMutableList() }
            totalBurnTime = maneuverGetResponse.totalBurnTime
            transactionId = maneuverGetResponse.transactionId
            uct = maneuverGetResponse.uct
            additionalProperties = maneuverGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ManeuverGetResponse].
         *
    ...
    fun validate(): ManeuverGetResponse = apply {
        if (validated) {
            return@apply
        }
