...
class EvacQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EvacQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EvacQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evacQueryHelpResponse: EvacQueryHelpResponse) =
            apply {
                aodrSupported = evacQueryHelpResponse.aodrSupported
                classificationMarking = evacQueryHelpResponse.classificationMarking
                description = evacQueryHelpResponse.description
                historySupported = evacQueryHelpResponse.historySupported
                name = evacQueryHelpResponse.name
                parameters = evacQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = evacQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = evacQueryHelpResponse.restSupported
                sortSupported = evacQueryHelpResponse.sortSupported
                typeName = evacQueryHelpResponse.typeName
                uri = evacQueryHelpResponse.uri
                additionalProperties = evacQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EvacQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EvacQueryHelpResponse =
    ...
    fun validate(): EvacQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
