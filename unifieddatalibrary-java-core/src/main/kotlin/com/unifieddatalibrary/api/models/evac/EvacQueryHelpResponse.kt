...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evacQueryHelpResponse: EvacQueryHelpResponse) = apply {
    ...
    fun validate(): EvacQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
