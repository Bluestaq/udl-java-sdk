...
class CalibrationQueryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalibrationQueryParams].
         *
    ...
    /** A builder for [CalibrationQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calibrationQueryParams: CalibrationQueryParams) =
            apply {
                startTime = calibrationQueryParams.startTime
                firstResult = calibrationQueryParams.firstResult
                maxResults = calibrationQueryParams.maxResults
                additionalHeaders = calibrationQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams = calibrationQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CalibrationQueryParams].
         *
         ...
         */
        fun build(): CalibrationQueryParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CalibrationQueryParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CalibrationQueryParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
