...
class EquipmentFull private constructor(
    ...
    private val equipmentRemarks: JsonField<List<EquipmentRemarkFull>>,
    ...
    private constructor(
        ...
        @JsonProperty("altEqpId") @ExcludeMissing altEqpId: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("eqpIdNum") @ExcludeMissing eqpIdNum: JsonField<String> = JsonMissing.of(),
        @JsonProperty("equipmentRemarks") @ExcludeMissing equipmentRemarks: JsonField<List<EquipmentRemarkFull>> = JsonMissing.of(),
        ...
        @JsonProperty("function") @ExcludeMissing function: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("idParentEquipment") @ExcludeMissing idParentEquipment: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("operAreaPrimary") @ExcludeMissing operAreaPrimary: JsonField<String> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun equipmentRemarks(): Optional<List<EquipmentRemarkFull>> = equipmentRemarks.getOptional("equipmentRemarks")
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun idParentEquipment(): Optional<String> = idParentEquipment.getOptional("idParentEquipment")
    ...
    @ExcludeMissing
    fun _altEqpId(): JsonField<String> = altEqpId
    ...
    @ExcludeMissing
    fun _eqpCode(): JsonField<String> = eqpCode
    ...
    @ExcludeMissing
    fun _eqpIdNum(): JsonField<String> = eqpIdNum

    /**
     * Returns the raw JSON value of [equipmentRemarks].
     *
     * Unlike [equipmentRemarks], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("equipmentRemarks")
    @ExcludeMissing
    fun _equipmentRemarks(): JsonField<List<EquipmentRemarkFull>> = equipmentRemarks
    ...
    @ExcludeMissing
    fun _function(): JsonField<String> = function
     ...
     *
     * Unlike [idParentEquipment], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("nomen")
    @ExcludeMissing
    fun _nomen(): JsonField<String> = nomen

    /**
     * Returns the raw JSON value of [operAreaPrimary].
     *
     * Unlike [operAreaPrimary], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("qtyOH")
    @ExcludeMissing
    fun _qtyOh(): JsonField<Int> = qtyOh
    ...
    @JsonProperty("seqNum")
    @ExcludeMissing
    fun _seqNum(): JsonField<Int> = seqNum
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EquipmentFull].
         *
    ...
    class Builder internal constructor() {
        ...
        private var equipmentRemarks: JsonField<MutableList<EquipmentRemarkFull>>? = null
        ...
        @JvmSynthetic
        internal fun from(equipmentFull: EquipmentFull) =
            apply {
                classificationMarking = equipmentFull.classificationMarking
                countryCode = equipmentFull.countryCode
                dataMode = equipmentFull.dataMode
                lat = equipmentFull.lat
                lon = equipmentFull.lon
                source = equipmentFull.source
                id = equipmentFull.id
                airDefArea = equipmentFull.airDefArea
                allegiance = equipmentFull.allegiance
                altAllegiance = equipmentFull.altAllegiance
                altCountryCode = equipmentFull.altCountryCode
                altEqpId = equipmentFull.altEqpId
                classRating = equipmentFull.classRating
                condition = equipmentFull.condition
                conditionAvail = equipmentFull.conditionAvail
                coord = equipmentFull.coord
                coordDatum = equipmentFull.coordDatum
                coordDerivAcc = equipmentFull.coordDerivAcc
                createdAt = equipmentFull.createdAt
                createdBy = equipmentFull.createdBy
                elevMsl = equipmentFull.elevMsl
                elevMslConfLvl = equipmentFull.elevMslConfLvl
                elevMslDerivAcc = equipmentFull.elevMslDerivAcc
                eqpCode = equipmentFull.eqpCode
                eqpIdNum = equipmentFull.eqpIdNum
                equipmentRemarks = equipmentFull.equipmentRemarks.map { it.toMutableList() }
                eval = equipmentFull.eval
                fpa = equipmentFull.fpa
                function = equipmentFull.function
                functPrimary = equipmentFull.functPrimary
                geoidalMslSep = equipmentFull.geoidalMslSep
                ident = equipmentFull.ident
                idOperatingUnit = equipmentFull.idOperatingUnit
                idParentEquipment = equipmentFull.idParentEquipment
                idSite = equipmentFull.idSite
                locReason = equipmentFull.locReason
                milGrid = equipmentFull.milGrid
                milGridSys = equipmentFull.milGridSys
                nomen = equipmentFull.nomen
                operAreaPrimary = equipmentFull.operAreaPrimary
                operStatus = equipmentFull.operStatus
                origin = equipmentFull.origin
                polSubdiv = equipmentFull.polSubdiv
                qtyOh = equipmentFull.qtyOh
                recStatus = equipmentFull.recStatus
                referenceDoc = equipmentFull.referenceDoc
                resProd = equipmentFull.resProd
                reviewDate = equipmentFull.reviewDate
                seqNum = equipmentFull.seqNum
                srcIds = equipmentFull.srcIds.map { it.toMutableList() }
                srcTyps = equipmentFull.srcTyps.map { it.toMutableList() }
                symCode = equipmentFull.symCode
                updatedAt = equipmentFull.updatedAt
                updatedBy = equipmentFull.updatedBy
                utm = equipmentFull.utm
                wac = equipmentFull.wac
                additionalProperties = equipmentFull.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.altEqpId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun altEqpId(altEqpId: JsonField<String>) =
            apply {
                this.altEqpId = altEqpId
            }
         ...
         *
         * You should usually call [Builder.eqpCode] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eqpCode(eqpCode: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.eqpIdNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eqpIdNum(eqpIdNum: JsonField<String>) =
            apply {
                this.eqpIdNum = eqpIdNum
            }

        /** Remarks contain amplifying information for a specific service. The information may contain context and interpretations for consumer use. */
        fun equipmentRemarks(equipmentRemarks: List<EquipmentRemarkFull>) = equipmentRemarks(JsonField.of(equipmentRemarks))

        /**
         * Sets [Builder.equipmentRemarks] to an arbitrary JSON value.
         *
         * You should usually call [Builder.equipmentRemarks] with a well-typed `List<EquipmentRemarkFull>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun equipmentRemarks(equipmentRemarks: JsonField<List<EquipmentRemarkFull>>) =
            apply {
                this.equipmentRemarks = equipmentRemarks.map { it.toMutableList() }
            }

        /**
         * Adds a single [EquipmentRemarkFull] to [equipmentRemarks].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addEquipmentRemark(equipmentRemark: EquipmentRemarkFull) =
            apply {
                equipmentRemarks = (equipmentRemarks ?: JsonField.of(mutableListOf())).also {
                    checkKnown("equipmentRemarks", it).add(equipmentRemark)
                }
            }
         ...
         *
         * You should usually call [Builder.function] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun function(function: JsonField<String>) =
            apply {
        ...
        /** Unique identifier of the Parent equipment record associated with this equipment record. */
        fun idParentEquipment(idParentEquipment: String) = idParentEquipment(JsonField.of(idParentEquipment))

        /**
         * Sets [Builder.idParentEquipment] to an arbitrary JSON value.
         *
         * You should usually call [Builder.idParentEquipment] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idParentEquipment(idParentEquipment: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.nomen] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nomen(nomen: JsonField<String>) =
            apply {
                this.nomen = nomen
            }

        /** Internationally recognized water area in which the vessel is most likely to be deployed or in which it normally operates most frequently. */
        fun operAreaPrimary(operAreaPrimary: String) = operAreaPrimary(JsonField.of(operAreaPrimary))

        /**
         * Sets [Builder.operAreaPrimary] to an arbitrary JSON value.
         *
         * You should usually call [Builder.operAreaPrimary] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun operAreaPrimary(operAreaPrimary: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.qtyOh] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun qtyOh(qtyOh: JsonField<Int>) =
            apply {
                this.qtyOh = qtyOh
            }
         ...
         *
         * You should usually call [Builder.seqNum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun seqNum(seqNum: JsonField<Int>) =
            apply {
                this.seqNum = seqNum
            }
        ...
        /**
         * Returns an immutable instance of [EquipmentFull].
         *
        ...
        fun build(): EquipmentFull =
            EquipmentFull(
              ...
              eqpCode,
              eqpIdNum,
              (equipmentRemarks ?: JsonMissing.of()).map { it.toImmutable() },
              eval,
              fpa,
              function,
              functPrimary,
    ...
    fun validate(): EquipmentFull =
        apply {
            ...
            eqpCode()
            eqpIdNum()
            equipmentRemarks().ifPresent { it.forEach { it.validate() } }
            eval()
            fpa()
            function()
            functPrimary()
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (if (countryCode.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (lat.asKnown().isPresent) 1 else 0) + (if (lon.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (airDefArea.asKnown().isPresent) 1 else 0) + (if (allegiance.asKnown().isPresent) 1 else 0) + (if (altAllegiance.asKnown().isPresent) 1 else 0) + (if (altCountryCode.asKnown().isPresent) 1 else 0) + (if (altEqpId.asKnown().isPresent) 1 else 0) + (if (classRating.asKnown().isPresent) 1 else 0) + (if (condition.asKnown().isPresent) 1 else 0) + (if (conditionAvail.asKnown().isPresent) 1 else 0) + (if (coord.asKnown().isPresent) 1 else 0) + (if (coordDatum.asKnown().isPresent) 1 else 0) + (if (coordDerivAcc.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (elevMsl.asKnown().isPresent) 1 else 0) + (if (elevMslConfLvl.asKnown().isPresent) 1 else 0) + (if (elevMslDerivAcc.asKnown().isPresent) 1 else 0) + (if (eqpCode.asKnown().isPresent) 1 else 0) + (if (eqpIdNum.asKnown().isPresent) 1 else 0) + (equipmentRemarks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (eval.asKnown().isPresent) 1 else 0) + (if (fpa.asKnown().isPresent) 1 else 0) + (if (function.asKnown().isPresent) 1 else 0) + (if (functPrimary.asKnown().isPresent) 1 else 0) + (if (geoidalMslSep.asKnown().isPresent) 1 else 0) + (if (ident.asKnown().isPresent) 1 else 0) + (if (idOperatingUnit.asKnown().isPresent) 1 else 0) + (if (idParentEquipment.asKnown().isPresent) 1 else 0) + (if (idSite.asKnown().isPresent) 1 else 0) + (if (locReason.asKnown().isPresent) 1 else 0) + (if (milGrid.asKnown().isPresent) 1 else 0) + (if (milGridSys.asKnown().isPresent) 1 else 0) + (if (nomen.asKnown().isPresent) 1 else 0) + (if (operAreaPrimary.asKnown().isPresent) 1 else 0) + (if (operStatus.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (polSubdiv.asKnown().isPresent) 1 else 0) + (if (qtyOh.asKnown().isPresent) 1 else 0) + (if (recStatus.asKnown().isPresent) 1 else 0) + (if (referenceDoc.asKnown().isPresent) 1 else 0) + (if (resProd.asKnown().isPresent) 1 else 0) + (if (reviewDate.asKnown().isPresent) 1 else 0) + (if (seqNum.asKnown().isPresent) 1 else 0) + (srcIds.asKnown().getOrNull()?.size ?: 0) + (srcTyps.asKnown().getOrNull()?.size ?: 0) + (if (symCode.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0) + (if (utm.asKnown().isPresent) 1 else 0) + (if (wac.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "EquipmentFull{classificationMarking=$classificationMarking, countryCode=$countryCode, dataMode=$dataMode, lat=$lat, lon=$lon, source=$source, id=$id, airDefArea=$airDefArea, allegiance=$allegiance, altAllegiance=$altAllegiance, altCountryCode=$altCountryCode, altEqpId=$altEqpId, classRating=$classRating, condition=$condition, conditionAvail=$conditionAvail, coord=$coord, coordDatum=$coordDatum, coordDerivAcc=$coordDerivAcc, createdAt=$createdAt, createdBy=$createdBy, elevMsl=$elevMsl, elevMslConfLvl=$elevMslConfLvl, elevMslDerivAcc=$elevMslDerivAcc, eqpCode=$eqpCode, eqpIdNum=$eqpIdNum, equipmentRemarks=$equipmentRemarks, eval=$eval, fpa=$fpa, function=$function, functPrimary=$functPrimary, geoidalMslSep=$geoidalMslSep, ident=$ident, idOperatingUnit=$idOperatingUnit, idParentEquipment=$idParentEquipment, idSite=$idSite, locReason=$locReason, milGrid=$milGrid, milGridSys=$milGridSys, nomen=$nomen, operAreaPrimary=$operAreaPrimary, operStatus=$operStatus, origin=$origin, polSubdiv=$polSubdiv, qtyOh=$qtyOh, recStatus=$recStatus, referenceDoc=$referenceDoc, resProd=$resProd, reviewDate=$reviewDate, seqNum=$seqNum, srcIds=$srcIds, srcTyps=$srcTyps, symCode=$symCode, updatedAt=$updatedAt, updatedBy=$updatedBy, utm=$utm, wac=$wac, additionalProperties=$additionalProperties}"
}
