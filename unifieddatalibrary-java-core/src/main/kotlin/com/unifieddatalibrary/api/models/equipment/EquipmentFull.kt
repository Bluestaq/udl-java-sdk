...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        equipmentRemarks: JsonField<List<EquipmentRemarkFull>> = JsonMissing.of(),
     ...
     * equipment geographic coordinates reside. This field will be set to "OTHR" if the source value
    ...
    /**
     * The DoD Standard Country Code designator for the country or political entity to which the
     * equipment owes its allegiance. This field will be set to "OTHR" if the source value does not
    ...
    /**
     * Indicates the importance of the equipment. Referenced, but not constrained to, the following
     * class ratings type classifications.
     *
     ...
     * a fixed figure, system of lines, etc. specified in degrees, minute, and seconds.
     *
     ...
     * vertical accuracy. Confidence level has a range of values from 0 to 100, with 100 being
    ...
    /**
     * Designated equipment code assigned to the item of equipment or an abbreviation record type
     * unique identifier. Users should consult the data provider for information on the equipment
     * code structure.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     *   if the server responded with an unexpected value).
     */
    fun equipmentRemarks(): Optional<List<EquipmentRemarkFull>> =
        equipmentRemarks.getOptional("equipmentRemarks")
    ...
    /**
     * Indicates the function or mission of this equipment, which may or may not be engaged in at
     * any particular time. Typically refers to a unit, organization, or installation/facility
    ...
    /**
     * Generic type this specific piece of equipment belongs to, and the identifying nomenclature
     * which describes the equipment.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Internationally recognized water area in which the vessel is most likely to be deployed or in
     * which it normally operates most frequently.
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * Relative to the parent entity, the total number of military personnel or equipment assessed
     * to be on-hand (OH).
     *
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     ...
     * elements in the record as defined by SOPs. Referenced, but not constrained to, the following
     * record status type classifications.
     *
     * A - Active
     *
     * I - Inactive
    ...
    /**
     * Array of UUID(s) of the UDL data record(s) that are related to this equipment record. See the
     ...
     *
     * Unlike [equipmentRemarks], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("equipmentRemarks")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(equipmentFull: EquipmentFull) = apply {
         ...
         *
         * You should usually call [Builder.altEqpId] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.eqpCode] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.eqpIdNum] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         */
        fun equipmentRemarks(equipmentRemarks: List<EquipmentRemarkFull>) =
            equipmentRemarks(JsonField.of(equipmentRemarks))

        /**
         * Sets [Builder.equipmentRemarks] to an arbitrary JSON value.
         *
         * You should usually call [Builder.equipmentRemarks] with a well-typed
         * `List<EquipmentRemarkFull>` value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun equipmentRemarks(equipmentRemarks: JsonField<List<EquipmentRemarkFull>>) = apply {
         ...
         */
        fun addEquipmentRemark(equipmentRemark: EquipmentRemarkFull) = apply {
            equipmentRemarks =
                (equipmentRemarks ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.function] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.nomen] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    fun validate(): EquipmentFull = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (classificationMarking.asKnown().isPresent) 1 else 0) +
            ...
            (equipmentRemarks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
