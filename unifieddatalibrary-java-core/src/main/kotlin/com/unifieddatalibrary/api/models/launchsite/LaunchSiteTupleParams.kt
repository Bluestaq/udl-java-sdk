...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteTupleParams].
         *
    ...
    /** A builder for [LaunchSiteTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteTupleParams: LaunchSiteTupleParams) = apply {
            columns = launchSiteTupleParams.columns
            firstResult = launchSiteTupleParams.firstResult
            maxResults = launchSiteTupleParams.maxResults
            additionalHeaders = launchSiteTupleParams.additionalHeaders.toBuilder()
            additionalQueryParams = launchSiteTupleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LaunchSiteTupleParams].
         *
         ...
         */
        fun build(): LaunchSiteTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LaunchSiteTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "LaunchSiteTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
