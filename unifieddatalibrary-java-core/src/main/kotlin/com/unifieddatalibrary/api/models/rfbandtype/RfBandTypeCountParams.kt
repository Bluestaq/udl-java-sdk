...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RfBandTypeCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfBandTypeCountParams: RfBandTypeCountParams) = apply {
    ...
    override fun toString() =
        "RfBandTypeCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
