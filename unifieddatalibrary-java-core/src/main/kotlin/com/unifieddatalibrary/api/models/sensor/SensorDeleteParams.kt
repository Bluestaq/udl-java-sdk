...
class SensorDeleteParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SensorDeleteParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorDeleteParams: SensorDeleteParams) =
            apply {
                id = sensorDeleteParams.id
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorDeleteParams && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() = "SensorDeleteParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
