...
/**
 * Service operation intended for initial integration only, to take a list of RF observations as a
 ...
 */
class RfObservationCreateBulkParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rfObservationCreateBulkParams: RfObservationCreateBulkParams) = apply {
    ...
    override fun toString() =
        "RfObservationCreateBulkParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
