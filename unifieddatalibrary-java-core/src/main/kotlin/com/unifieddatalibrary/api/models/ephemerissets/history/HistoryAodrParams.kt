...
class HistoryAodrParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyAodrParams: HistoryAodrParams) =
            apply {
                ...
                pointEndTime = historyAodrParams.pointEndTime
                pointStartTime = historyAodrParams.pointStartTime
    ...
    override fun toString() = "HistoryAodrParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, notification=$notification, outputDelimiter=$outputDelimiter, outputFormat=$outputFormat, pointEndTime=$pointEndTime, pointStartTime=$pointStartTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
