...
class EphemerisSetQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EphemerisSetQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [EphemerisSetQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetQueryhelpResponse: EphemerisSetQueryhelpResponse) =
            apply {
                aodrSupported = ephemerisSetQueryhelpResponse.aodrSupported
                classificationMarking = ephemerisSetQueryhelpResponse.classificationMarking
                description = ephemerisSetQueryhelpResponse.description
                historySupported = ephemerisSetQueryhelpResponse.historySupported
                name = ephemerisSetQueryhelpResponse.name
                parameters = ephemerisSetQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = ephemerisSetQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = ephemerisSetQueryhelpResponse.restSupported
                sortSupported = ephemerisSetQueryhelpResponse.sortSupported
                typeName = ephemerisSetQueryhelpResponse.typeName
                uri = ephemerisSetQueryhelpResponse.uri
                additionalProperties = ephemerisSetQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EphemerisSetQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EphemerisSetQueryhelpResponse =
    ...
    fun validate(): EphemerisSetQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is EphemerisSetQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
