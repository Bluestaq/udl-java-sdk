...
class EphemerisSetQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ephemerisSetQueryhelpResponse: EphemerisSetQueryhelpResponse) = apply {
    ...
    fun validate(): EphemerisSetQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
