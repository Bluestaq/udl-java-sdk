...
class SiteRemarkListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteRemarkListResponse: SiteRemarkListResponse) =
            apply {
    ...
    fun validate(): SiteRemarkListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "SiteRemarkListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, idSite=$idSite, source=$source, text=$text, id=$id, code=$code, createdAt=$createdAt, createdBy=$createdBy, name=$name, origin=$origin, origNetwork=$origNetwork, origRmkId=$origRmkId, type=$type, additionalProperties=$additionalProperties}"
}
