...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EcpedrListResponse].
         *
    ...
    /** A builder for [EcpedrListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ecpedrListResponse: EcpedrListResponse) = apply {
            classificationMarking = ecpedrListResponse.classificationMarking
            dataMode = ecpedrListResponse.dataMode
            ecpedrMeasurements = ecpedrListResponse.ecpedrMeasurements.map { it.toMutableList() }
            obTime = ecpedrListResponse.obTime
            source = ecpedrListResponse.source
            id = ecpedrListResponse.id
            createdAt = ecpedrListResponse.createdAt
            createdBy = ecpedrListResponse.createdBy
            genSystem = ecpedrListResponse.genSystem
            genTime = ecpedrListResponse.genTime
            idOnOrbit = ecpedrListResponse.idOnOrbit
            idSensor = ecpedrListResponse.idSensor
            origin = ecpedrListResponse.origin
            origNetwork = ecpedrListResponse.origNetwork
            origObjectId = ecpedrListResponse.origObjectId
            origSensorId = ecpedrListResponse.origSensorId
            satNo = ecpedrListResponse.satNo
            senPos = ecpedrListResponse.senPos.map { it.toMutableList() }
            senReferenceFrame = ecpedrListResponse.senReferenceFrame
            sourceDl = ecpedrListResponse.sourceDl
            tags = ecpedrListResponse.tags.map { it.toMutableList() }
            transactionId = ecpedrListResponse.transactionId
            additionalProperties = ecpedrListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EcpedrListResponse].
         *
    ...
    fun validate(): EcpedrListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EcpedrListResponse &&
