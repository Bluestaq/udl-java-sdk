...
class LaunchSiteDetailCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LaunchSiteDetailCreateParams].
         *
    ...
    /** A builder for [LaunchSiteDetailCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteDetailCreateParams: LaunchSiteDetailCreateParams) =
            apply {
                body = launchSiteDetailCreateParams.body.toBuilder()
                additionalHeaders = launchSiteDetailCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = launchSiteDetailCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** ID of the location data for the launch site, or null if mobile (e.g. sea launch platform in international waters). */
        fun idLocation(idLocation: String) =
            apply {
                body.idLocation(idLocation)
            }
        ...
        /** Launch site group name. Multiple launch sites may be colocated within a launch ''group''. */
        fun launchGroup(launchGroup: String) =
            apply {
                body.launchGroup(launchGroup)
            }
        ...
        /** Model representation of a location, which is a specific fixed point on the earth and is used to denote the locations of fixed sensors, operating units, etc. */
        fun location(location: LocationIngest) =
            apply {
        ...
        /**
         * Returns an immutable instance of [LaunchSiteDetailCreateParams].
         *
         ...
         */
        fun build(): LaunchSiteDetailCreateParams =
    ...
    class Body private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idLaunchSite.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (availableInclinations.asKnown().getOrNull()?.size ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (idLocation.asKnown().isPresent) 1 else 0) + (if (launchGroup.asKnown().isPresent) 1 else 0) + (location.asKnown().getOrNull()?.validity() ?: 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0)
        ...
        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(classificationMarking, dataMode, idLaunchSite, source, id, availableInclinations, createdAt, createdBy, description, idLocation, launchGroup, location, origin, origNetwork, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{classificationMarking=$classificationMarking, dataMode=$dataMode, idLaunchSite=$idLaunchSite, source=$source, id=$id, availableInclinations=$availableInclinations, createdAt=$createdAt, createdBy=$createdBy, description=$description, idLocation=$idLocation, launchGroup=$launchGroup, location=$location, origin=$origin, origNetwork=$origNetwork, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is LaunchSiteDetailCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "LaunchSiteDetailCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
