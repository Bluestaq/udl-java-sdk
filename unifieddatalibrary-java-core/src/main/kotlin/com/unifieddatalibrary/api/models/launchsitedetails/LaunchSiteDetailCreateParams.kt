...
/**
 * Service operation to take a single LaunchSiteDetails as a POST body and ingest into the database.
 * A LaunchSiteDetails represents details compiled/collected on a launch site by a particular
 * source. A launch site may have several details records. A specific role is required to perform
 * this service operation. Please contact the UDL team for assistance.
 */
class LaunchSiteDetailCreateParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(launchSiteDetailCreateParams: LaunchSiteDetailCreateParams) = apply {
    ...
    override fun toString() =
        "LaunchSiteDetailCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
