...
class SeradataOpticalPayloadListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<SeradataOpticalPayloadListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SeradataOpticalPayloadListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(seradataOpticalPayloadListPageAsync: SeradataOpticalPayloadListPageAsync) =
            apply {
        ...
        fun service(service: SeradataOpticalPayloadServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SeradataOpticalPayloadListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, streamHandlerExecutor, params, items) /* spotless:on */

    override fun toString() = "SeradataOpticalPayloadListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
