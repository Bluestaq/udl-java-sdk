...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(historyListResponse: HistoryListResponse) = apply {
            ...
            msgfmt = historyListResponse.msgfmt
            msgts = historyListResponse.msgts
            msgtyp = historyListResponse.msgtyp
            source = historyListResponse.source
            ts = historyListResponse.ts
            id = historyListResponse.id
            acp = historyListResponse.acp
            addr = historyListResponse.addr
            af = historyListResponse.af
            aims = historyListResponse.aims
            alt3d = historyListResponse.alt3d
            artsqual = historyListResponse.artsqual
            az = historyListResponse.az
            azdelt = historyListResponse.azdelt
            bcnhits = historyListResponse.bcnhits
            cartpos = historyListResponse.cartpos.map { it.toMutableList() }
            cdm = historyListResponse.cdm
            code7500 = historyListResponse.code7500
            code7600 = historyListResponse.code7600
            code7700 = historyListResponse.code7700
            createdAt = historyListResponse.createdAt
            createdBy = historyListResponse.createdBy
            faa = historyListResponse.faa
            grndspd = historyListResponse.grndspd
            hdng = historyListResponse.hdng
            idSensor = historyListResponse.idSensor
            m1 = historyListResponse.m1
            m1g = historyListResponse.m1g
            m1v = historyListResponse.m1v
            m2 = historyListResponse.m2
            m2g = historyListResponse.m2g
            m2v = historyListResponse.m2v
            m2xv = historyListResponse.m2xv
            m3a = historyListResponse.m3a
            m3ag = historyListResponse.m3ag
            m3av = historyListResponse.m3av
            m3axv = historyListResponse.m3axv
            m4 = historyListResponse.m4
            m4d1d2 = historyListResponse.m4d1d2
            m4v = historyListResponse.m4v
            mah = historyListResponse.mah
            mc = historyListResponse.mc
            mcg = historyListResponse.mcg
            mcv = historyListResponse.mcv
            milemrgcy = historyListResponse.milemrgcy
            mrgrpt = historyListResponse.mrgrpt
            mscommb = historyListResponse.mscommb
            mti = historyListResponse.mti
            ...
            psrrl = historyListResponse.psrrl
            rad = historyListResponse.rad
            rng = historyListResponse.rng
            rngdelt = historyListResponse.rngdelt
            sac = historyListResponse.sac
            senalt = historyListResponse.senalt
            senlat = historyListResponse.senlat
            senlon = historyListResponse.senlon
            sic = historyListResponse.sic
            spi = historyListResponse.spi
            ssrl = historyListResponse.ssrl
            tags = historyListResponse.tags.map { it.toMutableList() }
            tgtconf = historyListResponse.tgtconf
            tgtcorr = historyListResponse.tgtcorr
            tgtid = historyListResponse.tgtid
            tis = historyListResponse.tis
            trkelig = historyListResponse.trkelig
            trknum = historyListResponse.trknum
            tti = historyListResponse.tti
            wectc = historyListResponse.wectc.map { it.toMutableList() }
