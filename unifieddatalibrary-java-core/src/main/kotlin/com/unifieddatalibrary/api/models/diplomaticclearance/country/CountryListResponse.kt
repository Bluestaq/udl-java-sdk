...
class CountryListResponse private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(countryListResponse: CountryListResponse) =
            apply {
                classificationMarking = countryListResponse.classificationMarking
                countryCode = countryListResponse.countryCode
                dataMode = countryListResponse.dataMode
                lastChangedDate = countryListResponse.lastChangedDate
                source = countryListResponse.source
                id = countryListResponse.id
                acceptsDms = countryListResponse.acceptsDms
                acceptsEmail = countryListResponse.acceptsEmail
                acceptsFax = countryListResponse.acceptsFax
                acceptsSiprNet = countryListResponse.acceptsSiprNet
                agency = countryListResponse.agency
                altCountryCode = countryListResponse.altCountryCode
                closeTime = countryListResponse.closeTime
                countryId = countryListResponse.countryId
                countryName = countryListResponse.countryName
                countryRemark = countryListResponse.countryRemark
                createdAt = countryListResponse.createdAt
                createdBy = countryListResponse.createdBy
                diplomaticClearanceCountryContacts = countryListResponse.diplomaticClearanceCountryContacts.map { it.toMutableList() }
                diplomaticClearanceCountryEntryExitPoints = countryListResponse.diplomaticClearanceCountryEntryExitPoints.map { it.toMutableList() }
                diplomaticClearanceCountryProfiles = countryListResponse.diplomaticClearanceCountryProfiles.map { it.toMutableList() }
                existingProfile = countryListResponse.existingProfile
                gmtOffset = countryListResponse.gmtOffset
                officeName = countryListResponse.officeName
                officePoc = countryListResponse.officePoc
                officeRemark = countryListResponse.officeRemark
                openFri = countryListResponse.openFri
                openMon = countryListResponse.openMon
                openSat = countryListResponse.openSat
                openSun = countryListResponse.openSun
                openThu = countryListResponse.openThu
                openTime = countryListResponse.openTime
                openTue = countryListResponse.openTue
                openWed = countryListResponse.openWed
                origin = countryListResponse.origin
                origNetwork = countryListResponse.origNetwork
                sourceDl = countryListResponse.sourceDl
                updatedAt = countryListResponse.updatedAt
                updatedBy = countryListResponse.updatedBy
