...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(countryListResponse: CountryListResponse) = apply {
            ...
            diplomaticClearanceCountryContacts =
                countryListResponse.diplomaticClearanceCountryContacts.map { it.toMutableList() }
            diplomaticClearanceCountryEntryExitPoints =
                countryListResponse.diplomaticClearanceCountryEntryExitPoints.map {
                    it.toMutableList()
                }
            diplomaticClearanceCountryProfiles =
                countryListResponse.diplomaticClearanceCountryProfiles.map { it.toMutableList() }
