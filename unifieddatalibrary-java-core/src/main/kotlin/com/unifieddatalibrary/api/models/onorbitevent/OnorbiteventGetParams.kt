...
class OnorbiteventGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OnorbiteventGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventGetParams: OnorbiteventGetParams) =
            apply {
    ...
    override fun toString() = "OnorbiteventGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
