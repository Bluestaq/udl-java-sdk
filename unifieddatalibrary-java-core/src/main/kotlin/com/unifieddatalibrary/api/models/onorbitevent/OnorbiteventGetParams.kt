 ...
 * parameter. An OnorbitEvent is an event associated with a particular on-orbit spacecraft including
 * insurance related losses, anomalies and incidents.
 */
class OnorbiteventGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbiteventGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OnorbiteventGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OnorbiteventGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbiteventGetParams: OnorbiteventGetParams) = apply {
            id = onorbiteventGetParams.id
            firstResult = onorbiteventGetParams.firstResult
            maxResults = onorbiteventGetParams.maxResults
            additionalHeaders = onorbiteventGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = onorbiteventGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbiteventGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbiteventGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OnorbiteventGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "OnorbiteventGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
