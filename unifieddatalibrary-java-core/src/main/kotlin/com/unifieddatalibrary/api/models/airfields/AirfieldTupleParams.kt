...
class AirfieldTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirfieldTupleParams].
         *
    ...
    /** A builder for [AirfieldTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldTupleParams: AirfieldTupleParams) =
            apply {
                columns = airfieldTupleParams.columns
                firstResult = airfieldTupleParams.firstResult
                maxResults = airfieldTupleParams.maxResults
                additionalHeaders = airfieldTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = airfieldTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AirfieldTupleParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is AirfieldTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "AirfieldTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
