...
/**
 * Historical drift rates for GEO Onorbit objects resulting from updates to OnorbitDetails driftRate
 * values.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(driftHistoryFull: DriftHistoryFull) = apply {
    ...
    fun validate(): DriftHistoryFull = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DriftHistoryFull &&
    ...
    override fun toString() =
        "DriftHistoryFull{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, id=$id, createdBy=$createdBy, driftRate=$driftRate, effectiveUntil=$effectiveUntil, idOnOrbit=$idOnOrbit, origin=$origin, additionalProperties=$additionalProperties}"
}
