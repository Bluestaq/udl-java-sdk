...
class PoiCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poiCreateParams: PoiCreateParams) =
            apply {
        ...
        /** The Basic Encyclopedia Number associated with the POI, if applicable. */
        fun beNumber(beNumber: String) =
            apply {
                body.beNumber(beNumber)
            }
        ...
        /** Stale timestamp (optional), in ISO8601 UTC format. */
        fun stale(stale: OffsetDateTime) =
            apply {
                body.stale(stale)
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PoiCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "PoiCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
