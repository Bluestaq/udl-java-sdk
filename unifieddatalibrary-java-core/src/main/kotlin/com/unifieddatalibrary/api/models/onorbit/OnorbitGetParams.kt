...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OnorbitGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitGetParams: OnorbitGetParams) = apply {
    ...
    override fun toString() =
        "OnorbitGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
