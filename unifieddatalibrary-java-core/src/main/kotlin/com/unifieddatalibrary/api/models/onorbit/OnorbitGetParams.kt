...
class OnorbitGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OnorbitGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OnorbitGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [OnorbitGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(onorbitGetParams: OnorbitGetParams) =
            apply {
                id = onorbitGetParams.id
                firstResult = onorbitGetParams.firstResult
                maxResults = onorbitGetParams.maxResults
                additionalHeaders = onorbitGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = onorbitGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OnorbitGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitGetParams =
            OnorbitGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OnorbitGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OnorbitGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
