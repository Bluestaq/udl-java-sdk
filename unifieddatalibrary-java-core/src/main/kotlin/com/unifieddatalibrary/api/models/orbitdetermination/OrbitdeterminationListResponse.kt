 ...
 */
class OrbitdeterminationListResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationListResponse: OrbitdeterminationListResponse) = apply {
            ...
            acceptedObTyps =
                orbitdeterminationListResponse.acceptedObTyps.map { it.toMutableList() }
            ...
            rejectedObTyps =
                orbitdeterminationListResponse.rejectedObTyps.map { it.toMutableList() }
            ...
            additionalProperties =
                orbitdeterminationListResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): OrbitdeterminationListResponse = apply {
        if (validated) {
            return@apply
        }
