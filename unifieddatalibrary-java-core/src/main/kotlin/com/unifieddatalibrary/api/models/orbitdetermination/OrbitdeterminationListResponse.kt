...
class OrbitdeterminationListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrbitdeterminationListResponse].
         *
    ...
    /** A builder for [OrbitdeterminationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orbitdeterminationListResponse: OrbitdeterminationListResponse) =
            apply {
                classificationMarking = orbitdeterminationListResponse.classificationMarking
                dataMode = orbitdeterminationListResponse.dataMode
                endTime = orbitdeterminationListResponse.endTime
                initialOd = orbitdeterminationListResponse.initialOd
                method = orbitdeterminationListResponse.method
                source = orbitdeterminationListResponse.source
                startTime = orbitdeterminationListResponse.startTime
                id = orbitdeterminationListResponse.id
                acceptedObIds = orbitdeterminationListResponse.acceptedObIds.map { it.toMutableList() }
                acceptedObTyps = orbitdeterminationListResponse.acceptedObTyps.map { it.toMutableList() }
                agomEst = orbitdeterminationListResponse.agomEst
                agomModel = orbitdeterminationListResponse.agomModel
                aprioriElset = orbitdeterminationListResponse.aprioriElset
                aprioriIdElset = orbitdeterminationListResponse.aprioriIdElset
                aprioriIdStateVector = orbitdeterminationListResponse.aprioriIdStateVector
                aprioriStateVector = orbitdeterminationListResponse.aprioriStateVector
                ballisticCoeffEst = orbitdeterminationListResponse.ballisticCoeffEst
                ballisticCoeffModel = orbitdeterminationListResponse.ballisticCoeffModel
                bestPassWrms = orbitdeterminationListResponse.bestPassWrms
                createdAt = orbitdeterminationListResponse.createdAt
                createdBy = orbitdeterminationListResponse.createdBy
                edr = orbitdeterminationListResponse.edr
                effectiveFrom = orbitdeterminationListResponse.effectiveFrom
                effectiveUntil = orbitdeterminationListResponse.effectiveUntil
                errorGrowthRate = orbitdeterminationListResponse.errorGrowthRate
                firstPassWrms = orbitdeterminationListResponse.firstPassWrms
                fitSpan = orbitdeterminationListResponse.fitSpan
                idOnOrbit = orbitdeterminationListResponse.idOnOrbit
                lastObEnd = orbitdeterminationListResponse.lastObEnd
                lastObStart = orbitdeterminationListResponse.lastObStart
                methodSource = orbitdeterminationListResponse.methodSource
                numIterations = orbitdeterminationListResponse.numIterations
                origin = orbitdeterminationListResponse.origin
                origNetwork = orbitdeterminationListResponse.origNetwork
                origObjectId = orbitdeterminationListResponse.origObjectId
                previousWrms = orbitdeterminationListResponse.previousWrms
                rejectedObIds = orbitdeterminationListResponse.rejectedObIds.map { it.toMutableList() }
                rejectedObTyps = orbitdeterminationListResponse.rejectedObTyps.map { it.toMutableList() }
                rmsConvergenceCriteria = orbitdeterminationListResponse.rmsConvergenceCriteria
                satNo = orbitdeterminationListResponse.satNo
                sensorIds = orbitdeterminationListResponse.sensorIds.map { it.toMutableList() }
                sourceDl = orbitdeterminationListResponse.sourceDl
                timeSpan = orbitdeterminationListResponse.timeSpan
                wrms = orbitdeterminationListResponse.wrms
                additionalProperties = orbitdeterminationListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OrbitdeterminationListResponse].
         *
         ...
         */
        fun build(): OrbitdeterminationListResponse =
    ...
    fun validate(): OrbitdeterminationListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class AprioriElset private constructor(
        ...
        override fun toString() = "AprioriElset{classificationMarking=$classificationMarking, dataMode=$dataMode, epoch=$epoch, source=$source, agom=$agom, algorithm=$algorithm, apogee=$apogee, argOfPerigee=$argOfPerigee, ballisticCoeff=$ballisticCoeff, bStar=$bStar, createdAt=$createdAt, createdBy=$createdBy, descriptor=$descriptor, eccentricity=$eccentricity, ephemType=$ephemType, idElset=$idElset, idOnOrbit=$idOnOrbit, idOrbitDetermination=$idOrbitDetermination, inclination=$inclination, line1=$line1, line2=$line2, meanAnomaly=$meanAnomaly, meanMotion=$meanMotion, meanMotionDDot=$meanMotionDDot, meanMotionDot=$meanMotionDot, origin=$origin, origNetwork=$origNetwork, origObjectId=$origObjectId, perigee=$perigee, period=$period, raan=$raan, revNo=$revNo, satNo=$satNo, semiMajorAxis=$semiMajorAxis, sourceDl=$sourceDl, transactionId=$transactionId, uct=$uct, additionalProperties=$additionalProperties}"
    }
    ...
    class AprioriStateVector private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (epoch.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (actualOdSpan.asKnown().isPresent) 1 else 0) + (if (algorithm.asKnown().isPresent) 1 else 0) + (if (alt1ReferenceFrame.asKnown().isPresent) 1 else 0) + (if (alt2ReferenceFrame.asKnown().isPresent) 1 else 0) + (if (area.asKnown().isPresent) 1 else 0) + (if (bDot.asKnown().isPresent) 1 else 0) + (if (cmOffset.asKnown().isPresent) 1 else 0) + (cov.asKnown().getOrNull()?.size ?: 0) + (if (covMethod.asKnown().isPresent) 1 else 0) + (covReferenceFrame.asKnown().getOrNull()?.validity() ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (descriptor.asKnown().isPresent) 1 else 0) + (if (dragArea.asKnown().isPresent) 1 else 0) + (if (dragCoeff.asKnown().isPresent) 1 else 0) + (if (dragModel.asKnown().isPresent) 1 else 0) + (if (edr.asKnown().isPresent) 1 else 0) + (eqCov.asKnown().getOrNull()?.size ?: 0) + (if (errorControl.asKnown().isPresent) 1 else 0) + (if (fixedStep.asKnown().isPresent) 1 else 0) + (if (geopotentialModel.asKnown().isPresent) 1 else 0) + (if (iau1980Terms.asKnown().isPresent) 1 else 0) + (if (idOnOrbit.asKnown().isPresent) 1 else 0) + (if (idOrbitDetermination.asKnown().isPresent) 1 else 0) + (if (idStateVector.asKnown().isPresent) 1 else 0) + (if (integratorMode.asKnown().isPresent) 1 else 0) + (if (inTrackThrust.asKnown().isPresent) 1 else 0) + (if (lastObEnd.asKnown().isPresent) 1 else 0) + (if (lastObStart.asKnown().isPresent) 1 else 0) + (if (leapSecondTime.asKnown().isPresent) 1 else 0) + (if (lunarSolar.asKnown().isPresent) 1 else 0) + (if (mass.asKnown().isPresent) 1 else 0) + (if (obsAvailable.asKnown().isPresent) 1 else 0) + (if (obsUsed.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (origObjectId.asKnown().isPresent) 1 else 0) + (if (partials.asKnown().isPresent) 1 else 0) + (if (pedigree.asKnown().isPresent) 1 else 0) + (if (polarMotionX.asKnown().isPresent) 1 else 0) + (if (polarMotionY.asKnown().isPresent) 1 else 0) + (if (posUnc.asKnown().isPresent) 1 else 0) + (if (recOdSpan.asKnown().isPresent) 1 else 0) + (referenceFrame.asKnown().getOrNull()?.validity() ?: 0) + (if (residualsAcc.asKnown().isPresent) 1 else 0) + (if (revNo.asKnown().isPresent) 1 else 0) + (if (rms.asKnown().isPresent) 1 else 0) + (if (satNo.asKnown().isPresent) 1 else 0) + (sigmaPosUvw.asKnown().getOrNull()?.size ?: 0) + (sigmaVelUvw.asKnown().getOrNull()?.size ?: 0) + (if (solarFluxApAvg.asKnown().isPresent) 1 else 0) + (if (solarFluxF10.asKnown().isPresent) 1 else 0) + (if (solarFluxF10Avg.asKnown().isPresent) 1 else 0) + (if (solarRadPress.asKnown().isPresent) 1 else 0) + (if (solarRadPressCoeff.asKnown().isPresent) 1 else 0) + (if (solidEarthTides.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (srpArea.asKnown().isPresent) 1 else 0) + (if (stepMode.asKnown().isPresent) 1 else 0) + (if (stepSize.asKnown().isPresent) 1 else 0) + (if (stepSizeSelection.asKnown().isPresent) 1 else 0) + (if (taiUtc.asKnown().isPresent) 1 else 0) + (if (thrustAccel.asKnown().isPresent) 1 else 0) + (if (tracksAvail.asKnown().isPresent) 1 else 0) + (if (tracksUsed.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0) + (if (uct.asKnown().isPresent) 1 else 0) + (if (ut1Rate.asKnown().isPresent) 1 else 0) + (if (ut1Utc.asKnown().isPresent) 1 else 0) + (if (velUnc.asKnown().isPresent) 1 else 0) + (if (xaccel.asKnown().isPresent) 1 else 0) + (if (xpos.asKnown().isPresent) 1 else 0) + (if (xposAlt1.asKnown().isPresent) 1 else 0) + (if (xposAlt2.asKnown().isPresent) 1 else 0) + (if (xvel.asKnown().isPresent) 1 else 0) + (if (xvelAlt1.asKnown().isPresent) 1 else 0) + (if (xvelAlt2.asKnown().isPresent) 1 else 0) + (if (yaccel.asKnown().isPresent) 1 else 0) + (if (ypos.asKnown().isPresent) 1 else 0) + (if (yposAlt1.asKnown().isPresent) 1 else 0) + (if (yposAlt2.asKnown().isPresent) 1 else 0) + (if (yvel.asKnown().isPresent) 1 else 0) + (if (yvelAlt1.asKnown().isPresent) 1 else 0) + (if (yvelAlt2.asKnown().isPresent) 1 else 0) + (if (zaccel.asKnown().isPresent) 1 else 0) + (if (zpos.asKnown().isPresent) 1 else 0) + (if (zposAlt1.asKnown().isPresent) 1 else 0) + (if (zposAlt2.asKnown().isPresent) 1 else 0) + (if (zvel.asKnown().isPresent) 1 else 0) + (if (zvelAlt1.asKnown().isPresent) 1 else 0) + (if (zvelAlt2.asKnown().isPresent) 1 else 0)
