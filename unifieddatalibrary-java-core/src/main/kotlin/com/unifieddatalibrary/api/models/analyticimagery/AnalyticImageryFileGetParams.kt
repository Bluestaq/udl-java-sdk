...
/**
 * Service operation to get a single AnalyticImagery binary image by its unique ID passed as a path
 * parameter. The image is returned as an attachment Content-Disposition.
 */
class AnalyticImageryFileGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AnalyticImageryFileGetParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AnalyticImageryFileGetParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AnalyticImageryFileGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryFileGetParams: AnalyticImageryFileGetParams) = apply {
            id = analyticImageryFileGetParams.id
            firstResult = analyticImageryFileGetParams.firstResult
            maxResults = analyticImageryFileGetParams.maxResults
            additionalHeaders = analyticImageryFileGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = analyticImageryFileGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AnalyticImageryFileGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AnalyticImageryFileGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AnalyticImageryFileGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "AnalyticImageryFileGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
