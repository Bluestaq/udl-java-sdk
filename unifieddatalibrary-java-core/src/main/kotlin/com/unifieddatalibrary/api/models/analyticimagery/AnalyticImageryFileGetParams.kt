...
class AnalyticImageryFileGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): AnalyticImageryFileGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticImageryFileGetParams: AnalyticImageryFileGetParams) =
            apply {
    ...
    override fun toString() = "AnalyticImageryFileGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
