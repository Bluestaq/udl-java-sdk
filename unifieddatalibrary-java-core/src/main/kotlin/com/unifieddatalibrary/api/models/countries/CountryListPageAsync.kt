...
class CountryListPageAsync private constructor(
    private val service: CountryServiceAsync,
    private val streamHandlerExecutor: Executor,
    private val params: CountryListParams,
    private val items: List<CountryAbridged>,

) : PageAsync<CountryAbridged> {
    ...
    override fun nextPage(): CompletableFuture<CountryListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<CountryAbridged> =
        AutoPagerAsync.from(
    ...
    override fun items(): List<CountryAbridged> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: List<CountryAbridged>? = null

        @JvmSynthetic
        internal fun from(countryListPageAsync: CountryListPageAsync) =
            apply {
        ...
        fun service(service: CountryServiceAsync) =
            apply {
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<CountryAbridged>) =
            apply {
                this.items = items
            }
    ...
    override fun toString() = "CountryListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, items=$items}"
}
