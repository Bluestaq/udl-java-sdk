...
class GeoStatusGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): GeoStatusGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GeoStatusGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [GeoStatusGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusGetParams: GeoStatusGetParams) =
            apply {
                id = geoStatusGetParams.id
                firstResult = geoStatusGetParams.firstResult
                maxResults = geoStatusGetParams.maxResults
                additionalHeaders = geoStatusGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = geoStatusGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [GeoStatusGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GeoStatusGetParams =
            GeoStatusGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is GeoStatusGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "GeoStatusGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
