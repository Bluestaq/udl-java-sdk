...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): GeoStatusGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(geoStatusGetParams: GeoStatusGetParams) = apply {
    ...
    override fun toString() =
        "GeoStatusGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
