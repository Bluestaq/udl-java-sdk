...
class TrackDetailTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TrackDetailTupleParams].
         *
    ...
    /** A builder for [TrackDetailTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trackDetailTupleParams: TrackDetailTupleParams) =
            apply {
                columns = trackDetailTupleParams.columns
                ts = trackDetailTupleParams.ts
                firstResult = trackDetailTupleParams.firstResult
                maxResults = trackDetailTupleParams.maxResults
                additionalHeaders = trackDetailTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = trackDetailTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TrackDetailTupleParams].
         *
         ...
         */
        fun build(): TrackDetailTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is TrackDetailTupleParams && columns == other.columns && ts == other.ts && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "TrackDetailTupleParams{columns=$columns, ts=$ts, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
