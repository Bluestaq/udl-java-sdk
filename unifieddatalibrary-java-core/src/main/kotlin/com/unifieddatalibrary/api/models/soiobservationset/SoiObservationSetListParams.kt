...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SoiObservationSetListParams].
         *
    ...
    /** A builder for [SoiObservationSetListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(soiObservationSetListParams: SoiObservationSetListParams) = apply {
            startTime = soiObservationSetListParams.startTime
            firstResult = soiObservationSetListParams.firstResult
            maxResults = soiObservationSetListParams.maxResults
            additionalHeaders = soiObservationSetListParams.additionalHeaders.toBuilder()
            additionalQueryParams = soiObservationSetListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SoiObservationSetListParams].
         *
         ...
         */
        fun build(): SoiObservationSetListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SoiObservationSetListParams && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SoiObservationSetListParams{startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
