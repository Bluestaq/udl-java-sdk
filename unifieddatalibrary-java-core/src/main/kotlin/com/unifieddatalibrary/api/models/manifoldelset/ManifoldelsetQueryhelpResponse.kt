...
class ManifoldelsetQueryhelpResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetQueryhelpResponse: ManifoldelsetQueryhelpResponse) = apply {
            ...
            additionalProperties =
                manifoldelsetQueryhelpResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): ManifoldelsetQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
