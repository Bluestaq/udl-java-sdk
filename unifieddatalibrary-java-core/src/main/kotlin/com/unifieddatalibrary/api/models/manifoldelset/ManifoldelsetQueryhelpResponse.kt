...
class ManifoldelsetQueryhelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ManifoldelsetQueryhelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [ManifoldelsetQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(manifoldelsetQueryhelpResponse: ManifoldelsetQueryhelpResponse) =
            apply {
                aodrSupported = manifoldelsetQueryhelpResponse.aodrSupported
                classificationMarking = manifoldelsetQueryhelpResponse.classificationMarking
                description = manifoldelsetQueryhelpResponse.description
                historySupported = manifoldelsetQueryhelpResponse.historySupported
                name = manifoldelsetQueryhelpResponse.name
                parameters = manifoldelsetQueryhelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = manifoldelsetQueryhelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = manifoldelsetQueryhelpResponse.restSupported
                sortSupported = manifoldelsetQueryhelpResponse.sortSupported
                typeName = manifoldelsetQueryhelpResponse.typeName
                uri = manifoldelsetQueryhelpResponse.uri
                additionalProperties = manifoldelsetQueryhelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ManifoldelsetQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ManifoldelsetQueryhelpResponse =
    ...
    fun validate(): ManifoldelsetQueryhelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is ManifoldelsetQueryhelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
