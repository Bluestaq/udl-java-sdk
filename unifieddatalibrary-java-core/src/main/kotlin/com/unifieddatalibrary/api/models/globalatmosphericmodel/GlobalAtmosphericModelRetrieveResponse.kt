 ...
 * Density (3D) data, etc.
 */
class GlobalAtmosphericModelRetrieveResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            globalAtmosphericModelRetrieveResponse: GlobalAtmosphericModelRetrieveResponse
        ) = apply {
            ...
            dataSourceIdentifier = globalAtmosphericModelRetrieveResponse.dataSourceIdentifier
            ...
            additionalProperties =
                globalAtmosphericModelRetrieveResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): GlobalAtmosphericModelRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
