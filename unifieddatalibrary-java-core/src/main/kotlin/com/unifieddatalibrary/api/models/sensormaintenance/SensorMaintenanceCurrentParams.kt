...
class SensorMaintenanceCurrentParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): SensorMaintenanceCurrentParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SensorMaintenanceCurrentParams]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceCurrentParams: SensorMaintenanceCurrentParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is SensorMaintenanceCurrentParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "SensorMaintenanceCurrentParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
