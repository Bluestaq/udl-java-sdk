...
class StageGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): StageGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageGetParams: StageGetParams) =
            apply {
    ...
    override fun toString() = "StageGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
