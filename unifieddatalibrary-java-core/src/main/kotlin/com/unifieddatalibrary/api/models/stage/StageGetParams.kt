...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StageGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StageGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [StageGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stageGetParams: StageGetParams) = apply {
            id = stageGetParams.id
            firstResult = stageGetParams.firstResult
            maxResults = stageGetParams.maxResults
            additionalHeaders = stageGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = stageGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [StageGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StageGetParams =
            StageGetParams(
                id,
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StageGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "StageGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
