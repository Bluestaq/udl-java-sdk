...
class SensorMaintenanceListPage
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sensorMaintenanceListPage: SensorMaintenanceListPage) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SensorMaintenanceListPage &&
    ...
    override fun toString() =
        "SensorMaintenanceListPage{service=$service, params=$params, items=$items}"
}
