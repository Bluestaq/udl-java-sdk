...
class AirEventListResponse private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("arEventType") @ExcludeMissing arEventType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("arrPurpose") @ExcludeMissing arrPurpose: JsonField<String> = JsonMissing.of(),
        @JsonProperty("arTrackId") @ExcludeMissing arTrackId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("arTrackName") @ExcludeMissing arTrackName: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("depPurpose") @ExcludeMissing depPurpose: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("externalAirEventId") @ExcludeMissing externalAirEventId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("externalARTrackId") @ExcludeMissing externalArTrackId: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("receivers") @ExcludeMissing receivers: JsonField<List<Receiver>> = JsonMissing.of(),
        ...
        @JsonProperty("shortTrack") @ExcludeMissing shortTrack: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("sourceDL") @ExcludeMissing sourceDl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("statusCode") @ExcludeMissing statusCode: JsonField<String> = JsonMissing.of(),
        @JsonProperty("tankers") @ExcludeMissing tankers: JsonField<List<Tanker>> = JsonMissing.of(),
     ...
     * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun externalAirEventId(): Optional<String> = externalAirEventId.getOptional("externalAirEventId")
    ...
    @JsonProperty("arct")
    @ExcludeMissing
    fun _arct(): JsonField<OffsetDateTime> = arct
    ...
    @ExcludeMissing
    fun _arEventType(): JsonField<String> = arEventType
    ...
    @ExcludeMissing
    fun _arrPurpose(): JsonField<String> = arrPurpose
    ...
    @ExcludeMissing
    fun _arTrackId(): JsonField<String> = arTrackId
    ...
    @ExcludeMissing
    fun _arTrackName(): JsonField<String> = arTrackName
     ...
     */
    @JsonProperty("baseAlt")
    @ExcludeMissing
    fun _baseAlt(): JsonField<Double> = baseAlt
    ...
    @ExcludeMissing
    fun _cancelled(): JsonField<Boolean> = cancelled
    ...
    @ExcludeMissing
    fun _depPurpose(): JsonField<String> = depPurpose
     ...
     *
     * Unlike [externalAirEventId], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [externalArTrackId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _numTankers(): JsonField<Int> = numTankers
    ...
    @ExcludeMissing
    fun _revTrack(): JsonField<Boolean> = revTrack
    ...
    @JsonProperty("rzct")
    @ExcludeMissing
    fun _rzct(): JsonField<OffsetDateTime> = rzct
     ...
     */
    @JsonProperty("rzPoint")
    @ExcludeMissing
    fun _rzPoint(): JsonField<String> = rzPoint
    ...
    @JsonProperty("rzType")
    @ExcludeMissing
    fun _rzType(): JsonField<String> = rzType
    ...
    @ExcludeMissing
    fun _shortTrack(): JsonField<Boolean> = shortTrack
    ...
    @ExcludeMissing
    fun _tankers(): JsonField<List<Tanker>> = tankers
    ...
    @ExcludeMissing
    fun _trackTime(): JsonField<Double> = trackTime
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AirEventListResponse].
         *
    ...
    /** A builder for [AirEventListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airEventListResponse: AirEventListResponse) =
            apply {
                classificationMarking = airEventListResponse.classificationMarking
                dataMode = airEventListResponse.dataMode
                source = airEventListResponse.source
                type = airEventListResponse.type
                id = airEventListResponse.id
                actualArrTime = airEventListResponse.actualArrTime
                actualDepTime = airEventListResponse.actualDepTime
                arct = airEventListResponse.arct
                arEventType = airEventListResponse.arEventType
                arrPurpose = airEventListResponse.arrPurpose
                arTrackId = airEventListResponse.arTrackId
                arTrackName = airEventListResponse.arTrackName
                baseAlt = airEventListResponse.baseAlt
                cancelled = airEventListResponse.cancelled
                createdAt = airEventListResponse.createdAt
                createdBy = airEventListResponse.createdBy
                depPurpose = airEventListResponse.depPurpose
                estArrTime = airEventListResponse.estArrTime
                estDepTime = airEventListResponse.estDepTime
                externalAirEventId = airEventListResponse.externalAirEventId
                externalArTrackId = airEventListResponse.externalArTrackId
                idMission = airEventListResponse.idMission
                idSortie = airEventListResponse.idSortie
                legNum = airEventListResponse.legNum
                location = airEventListResponse.location
                numTankers = airEventListResponse.numTankers
                origin = airEventListResponse.origin
                origNetwork = airEventListResponse.origNetwork
                plannedArrTime = airEventListResponse.plannedArrTime
                plannedDepTime = airEventListResponse.plannedDepTime
                priority = airEventListResponse.priority
                receivers = airEventListResponse.receivers.map { it.toMutableList() }
                remarks = airEventListResponse.remarks.map { it.toMutableList() }
                revTrack = airEventListResponse.revTrack
                rzct = airEventListResponse.rzct
                rzPoint = airEventListResponse.rzPoint
                rzType = airEventListResponse.rzType
                shortTrack = airEventListResponse.shortTrack
                sourceDl = airEventListResponse.sourceDl
                statusCode = airEventListResponse.statusCode
                tankers = airEventListResponse.tankers.map { it.toMutableList() }
                trackTime = airEventListResponse.trackTime
                updatedAt = airEventListResponse.updatedAt
                updatedBy = airEventListResponse.updatedBy
                additionalProperties = airEventListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.arct] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arct(arct: JsonField<OffsetDateTime>) =
            apply {
                this.arct = arct
            }
         ...
         *
         * You should usually call [Builder.arEventType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arEventType(arEventType: JsonField<String>) =
            apply {
                this.arEventType = arEventType
            }
         ...
         *
         * You should usually call [Builder.arrPurpose] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arrPurpose(arrPurpose: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.arTrackId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arTrackId(arTrackId: JsonField<String>) =
            apply {
                this.arTrackId = arTrackId
            }
         ...
         *
         * You should usually call [Builder.arTrackName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun arTrackName(arTrackName: JsonField<String>) =
            apply {
                this.arTrackName = arTrackName
            }
         ...
         *
         * You should usually call [Builder.baseAlt] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun baseAlt(baseAlt: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.cancelled] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun cancelled(cancelled: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.depPurpose] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun depPurpose(depPurpose: JsonField<String>) =
            apply {
                this.depPurpose = depPurpose
            }
        ...
        /** Optional air event ID from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID. */
        fun externalAirEventId(externalAirEventId: String) = externalAirEventId(JsonField.of(externalAirEventId))

        /**
         * Sets [Builder.externalAirEventId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.externalAirEventId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun externalAirEventId(externalAirEventId: JsonField<String>) =
            apply {
                this.externalAirEventId = externalAirEventId
            }

        /** Optional air refueling track ID from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID. */
        fun externalArTrackId(externalArTrackId: String) = externalArTrackId(JsonField.of(externalArTrackId))

        /**
         * Sets [Builder.externalArTrackId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.externalArTrackId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun externalArTrackId(externalArTrackId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.location] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun location(location: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.numTankers] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun numTankers(numTankers: JsonField<Int>) =
            apply {
                this.numTankers = numTankers
            }
         ...
         *
         * You should usually call [Builder.receivers] with a well-typed `List<Receiver>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun receivers(receivers: JsonField<List<Receiver>>) =
            apply {
        ...
        fun addReceiver(receiver: Receiver) =
            apply {
                receivers = (receivers ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.revTrack] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun revTrack(revTrack: JsonField<Boolean>) =
            apply {
                this.revTrack = revTrack
            }
         ...
         *
         * You should usually call [Builder.rzct] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rzct(rzct: JsonField<OffsetDateTime>) =
            apply {
                this.rzct = rzct
            }
         ...
         *
         * You should usually call [Builder.rzPoint] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rzPoint(rzPoint: JsonField<String>) =
            apply {
                this.rzPoint = rzPoint
            }
         ...
         *
         * You should usually call [Builder.rzType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rzType(rzType: JsonField<String>) =
            apply {
                this.rzType = rzType
            }
         ...
         *
         * You should usually call [Builder.shortTrack] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun shortTrack(shortTrack: JsonField<Boolean>) =
            apply {
                this.shortTrack = shortTrack
            }
         ...
         *
         * You should usually call [Builder.tankers] with a well-typed `List<Tanker>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tankers(tankers: JsonField<List<Tanker>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTanker(tanker: Tanker) =
            apply {
                tankers = (tankers ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.trackTime] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trackTime(trackTime: JsonField<Double>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [AirEventListResponse].
         *
         ...
         */
        fun build(): AirEventListResponse =
    ...
    fun validate(): AirEventListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (actualArrTime.asKnown().isPresent) 1 else 0) + (if (actualDepTime.asKnown().isPresent) 1 else 0) + (if (arct.asKnown().isPresent) 1 else 0) + (if (arEventType.asKnown().isPresent) 1 else 0) + (if (arrPurpose.asKnown().isPresent) 1 else 0) + (if (arTrackId.asKnown().isPresent) 1 else 0) + (if (arTrackName.asKnown().isPresent) 1 else 0) + (if (baseAlt.asKnown().isPresent) 1 else 0) + (if (cancelled.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (depPurpose.asKnown().isPresent) 1 else 0) + (if (estArrTime.asKnown().isPresent) 1 else 0) + (if (estDepTime.asKnown().isPresent) 1 else 0) + (if (externalAirEventId.asKnown().isPresent) 1 else 0) + (if (externalArTrackId.asKnown().isPresent) 1 else 0) + (if (idMission.asKnown().isPresent) 1 else 0) + (if (idSortie.asKnown().isPresent) 1 else 0) + (if (legNum.asKnown().isPresent) 1 else 0) + (if (location.asKnown().isPresent) 1 else 0) + (if (numTankers.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (plannedArrTime.asKnown().isPresent) 1 else 0) + (if (plannedDepTime.asKnown().isPresent) 1 else 0) + (if (priority.asKnown().isPresent) 1 else 0) + (receivers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (remarks.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (revTrack.asKnown().isPresent) 1 else 0) + (if (rzct.asKnown().isPresent) 1 else 0) + (if (rzPoint.asKnown().isPresent) 1 else 0) + (if (rzType.asKnown().isPresent) 1 else 0) + (if (shortTrack.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (statusCode.asKnown().isPresent) 1 else 0) + (tankers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (trackTime.asKnown().isPresent) 1 else 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (if (updatedBy.asKnown().isPresent) 1 else 0)
    ...
    /** Collection of receiver aircraft associated with this Air Event. */
    class Receiver private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("altReceiverMissionId") @ExcludeMissing altReceiverMissionId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("amcReceiverMissionId") @ExcludeMissing amcReceiverMissionId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("externalReceiverId") @ExcludeMissing externalReceiverId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("fuelOn") @ExcludeMissing fuelOn: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("idReceiverAirfield") @ExcludeMissing idReceiverAirfield: JsonField<String> = JsonMissing.of(),
            @JsonProperty("idReceiverMission") @ExcludeMissing idReceiverMission: JsonField<String> = JsonMissing.of(),
            @JsonProperty("idReceiverSortie") @ExcludeMissing idReceiverSortie: JsonField<String> = JsonMissing.of(),
            @JsonProperty("numRecAircraft") @ExcludeMissing numRecAircraft: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("packageId") @ExcludeMissing packageId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverCallSign") @ExcludeMissing receiverCallSign: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverCellPosition") @ExcludeMissing receiverCellPosition: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("receiverCoord") @ExcludeMissing receiverCoord: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverDeliveryMethod") @ExcludeMissing receiverDeliveryMethod: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverDeployedICAO") @ExcludeMissing receiverDeployedIcao: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverExercise") @ExcludeMissing receiverExercise: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverFuelType") @ExcludeMissing receiverFuelType: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverLegNum") @ExcludeMissing receiverLegNum: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("receiverMDS") @ExcludeMissing receiverMds: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverOwner") @ExcludeMissing receiverOwner: JsonField<String> = JsonMissing.of(),
            @JsonProperty("receiverPOC") @ExcludeMissing receiverPoc: JsonField<String> = JsonMissing.of(),
            @JsonProperty("recOrg") @ExcludeMissing recOrg: JsonField<String> = JsonMissing.of(),
            @JsonProperty("sequenceNum") @ExcludeMissing sequenceNum: JsonField<String> = JsonMissing.of()
        ) : this(
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun altReceiverMissionId(): Optional<String> = altReceiverMissionId.getOptional("altReceiverMissionId")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun amcReceiverMissionId(): Optional<String> = amcReceiverMissionId.getOptional("amcReceiverMissionId")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun externalReceiverId(): Optional<String> = externalReceiverId.getOptional("externalReceiverId")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun idReceiverAirfield(): Optional<String> = idReceiverAirfield.getOptional("idReceiverAirfield")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun idReceiverMission(): Optional<String> = idReceiverMission.getOptional("idReceiverMission")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun receiverCellPosition(): Optional<Int> = receiverCellPosition.getOptional("receiverCellPosition")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun receiverDeliveryMethod(): Optional<String> = receiverDeliveryMethod.getOptional("receiverDeliveryMethod")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun receiverDeployedIcao(): Optional<String> = receiverDeployedIcao.getOptional("receiverDeployedICAO")
         ...
         *
         * Unlike [altReceiverMissionId], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [amcReceiverMissionId], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [externalReceiverId], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("fuelOn")
        @ExcludeMissing
        fun _fuelOn(): JsonField<Double> = fuelOn

        /**
         * Returns the raw JSON value of [idReceiverAirfield].
         *
         * Unlike [idReceiverAirfield], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [idReceiverMission], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [idReceiverSortie], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [numRecAircraft], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverCallSign], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverCellPosition], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverCoord], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverDeliveryMethod], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverDeployedIcao], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverExercise], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverFuelType], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverLegNum], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [receiverOwner], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @JsonProperty("recOrg")
        @ExcludeMissing
        fun _recOrg(): JsonField<String> = recOrg
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(receiver: Receiver) =
                apply {
            ...
            /** Alternate mission identifier of this receiver provided by source. */
            fun altReceiverMissionId(altReceiverMissionId: String) = altReceiverMissionId(JsonField.of(altReceiverMissionId))

            /**
             * Sets [Builder.altReceiverMissionId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.altReceiverMissionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun altReceiverMissionId(altReceiverMissionId: JsonField<String>) =
                apply {
                    this.altReceiverMissionId = altReceiverMissionId
                }

            /** The Air Mobility Command (AMC) mission identifier of this receiver. */
            fun amcReceiverMissionId(amcReceiverMissionId: String) = amcReceiverMissionId(JsonField.of(amcReceiverMissionId))

            /**
             * Sets [Builder.amcReceiverMissionId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.amcReceiverMissionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun amcReceiverMissionId(amcReceiverMissionId: JsonField<String>) =
                apply {
                    this.amcReceiverMissionId = amcReceiverMissionId
                }

            /** Optional receiver identifier from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID. */
            fun externalReceiverId(externalReceiverId: String) = externalReceiverId(JsonField.of(externalReceiverId))

            /**
             * Sets [Builder.externalReceiverId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.externalReceiverId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun externalReceiverId(externalReceiverId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.fuelOn] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fuelOn(fuelOn: JsonField<Double>) =
                apply {
                    this.fuelOn = fuelOn
                }

            /** The UDL ID of the airfield this receiver is associated with for this event. */
            fun idReceiverAirfield(idReceiverAirfield: String) = idReceiverAirfield(JsonField.of(idReceiverAirfield))

            /**
             * Sets [Builder.idReceiverAirfield] to an arbitrary JSON value.
             *
             * You should usually call [Builder.idReceiverAirfield] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun idReceiverAirfield(idReceiverAirfield: JsonField<String>) =
                apply {
                    this.idReceiverAirfield = idReceiverAirfield
                }

            /** The UDL ID of the mission this receiver is associated with for this event. */
            fun idReceiverMission(idReceiverMission: String) = idReceiverMission(JsonField.of(idReceiverMission))

            /**
             * Sets [Builder.idReceiverMission] to an arbitrary JSON value.
             *
             * You should usually call [Builder.idReceiverMission] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun idReceiverMission(idReceiverMission: JsonField<String>) =
                apply {
                    this.idReceiverMission = idReceiverMission
                }

            /** The UDL ID of the aircraft sortie this receiver is associated with for this event. */
            fun idReceiverSortie(idReceiverSortie: String) = idReceiverSortie(JsonField.of(idReceiverSortie))

            /**
             * Sets [Builder.idReceiverSortie] to an arbitrary JSON value.
             *
             * You should usually call [Builder.idReceiverSortie] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun idReceiverSortie(idReceiverSortie: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.numRecAircraft] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun numRecAircraft(numRecAircraft: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.packageId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun packageId(packageId: JsonField<String>) =
                apply {
                    this.packageId = packageId
                }

            /** The call sign assigned to this receiver. */
            fun receiverCallSign(receiverCallSign: String) = receiverCallSign(JsonField.of(receiverCallSign))

            /**
             * Sets [Builder.receiverCallSign] to an arbitrary JSON value.
             *
             * You should usually call [Builder.receiverCallSign] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverCallSign(receiverCallSign: JsonField<String>) =
                apply {
                    this.receiverCallSign = receiverCallSign
                }

            /** Position of this receiver within a group of receivers in an air refueling event. */
            fun receiverCellPosition(receiverCellPosition: Int) = receiverCellPosition(JsonField.of(receiverCellPosition))

            /**
             * Sets [Builder.receiverCellPosition] to an arbitrary JSON value.
             *
             * You should usually call [Builder.receiverCellPosition] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverCellPosition(receiverCellPosition: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.receiverCoord] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverCoord(receiverCoord: JsonField<String>) =
                apply {
                    this.receiverCoord = receiverCoord
                }

            /** Type of fuel delivery method used by the receiver during an air refueling event (BOOM, DROGUE, BOTH). */
            fun receiverDeliveryMethod(receiverDeliveryMethod: String) = receiverDeliveryMethod(JsonField.of(receiverDeliveryMethod))

            /**
             * Sets [Builder.receiverDeliveryMethod] to an arbitrary JSON value.
             *
             * You should usually call [Builder.receiverDeliveryMethod] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverDeliveryMethod(receiverDeliveryMethod: JsonField<String>) =
                apply {
                    this.receiverDeliveryMethod = receiverDeliveryMethod
                }

            /** Location the receiver is deployed to for an air refueling event. */
            fun receiverDeployedIcao(receiverDeployedIcao: String) = receiverDeployedIcao(JsonField.of(receiverDeployedIcao))

            /**
             * Sets [Builder.receiverDeployedIcao] to an arbitrary JSON value.
             *
             * You should usually call [Builder.receiverDeployedIcao] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverDeployedIcao(receiverDeployedIcao: JsonField<String>) =
                apply {
                    this.receiverDeployedIcao = receiverDeployedIcao
                }

            /** Name of the receiver exercise associated with an air refueling event. */
            fun receiverExercise(receiverExercise: String) = receiverExercise(JsonField.of(receiverExercise))

            /**
             * Sets [Builder.receiverExercise] to an arbitrary JSON value.
             *
             * You should usually call [Builder.receiverExercise] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverExercise(receiverExercise: JsonField<String>) =
                apply {
                    this.receiverExercise = receiverExercise
                }

            /** Type of fuel being transferred to the receiver in an air refueling event. */
            fun receiverFuelType(receiverFuelType: String) = receiverFuelType(JsonField.of(receiverFuelType))

            /**
             * Sets [Builder.receiverFuelType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.receiverFuelType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverFuelType(receiverFuelType: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.receiverLegNum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverLegNum(receiverLegNum: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.receiverMds] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverMds(receiverMds: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.receiverOwner] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverOwner(receiverOwner: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.receiverPoc] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun receiverPoc(receiverPoc: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.recOrg] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun recOrg(recOrg: JsonField<String>) =
                apply {
                    this.recOrg = recOrg
                }
             ...
             *
             * You should usually call [Builder.sequenceNum] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun sequenceNum(sequenceNum: JsonField<String>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (altReceiverMissionId.asKnown().isPresent) 1 else 0) + (if (amcReceiverMissionId.asKnown().isPresent) 1 else 0) + (if (externalReceiverId.asKnown().isPresent) 1 else 0) + (if (fuelOn.asKnown().isPresent) 1 else 0) + (if (idReceiverAirfield.asKnown().isPresent) 1 else 0) + (if (idReceiverMission.asKnown().isPresent) 1 else 0) + (if (idReceiverSortie.asKnown().isPresent) 1 else 0) + (if (numRecAircraft.asKnown().isPresent) 1 else 0) + (if (packageId.asKnown().isPresent) 1 else 0) + (if (receiverCallSign.asKnown().isPresent) 1 else 0) + (if (receiverCellPosition.asKnown().isPresent) 1 else 0) + (if (receiverCoord.asKnown().isPresent) 1 else 0) + (if (receiverDeliveryMethod.asKnown().isPresent) 1 else 0) + (if (receiverDeployedIcao.asKnown().isPresent) 1 else 0) + (if (receiverExercise.asKnown().isPresent) 1 else 0) + (if (receiverFuelType.asKnown().isPresent) 1 else 0) + (if (receiverLegNum.asKnown().isPresent) 1 else 0) + (if (receiverMds.asKnown().isPresent) 1 else 0) + (if (receiverOwner.asKnown().isPresent) 1 else 0) + (if (receiverPoc.asKnown().isPresent) 1 else 0) + (if (recOrg.asKnown().isPresent) 1 else 0) + (if (sequenceNum.asKnown().isPresent) 1 else 0)
    ...
    class Remark private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("externalRemarkId") @ExcludeMissing externalRemarkId: JsonField<String> = JsonMissing.of(),
         ...
         *
         * Unlike [externalRemarkId], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            /** Optional remark ID from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID. */
            fun externalRemarkId(externalRemarkId: String) = externalRemarkId(JsonField.of(externalRemarkId))

            /**
             * Sets [Builder.externalRemarkId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.externalRemarkId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun externalRemarkId(externalRemarkId: JsonField<String>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (date.asKnown().isPresent) 1 else 0) + (if (externalRemarkId.asKnown().isPresent) 1 else 0) + (if (text.asKnown().isPresent) 1 else 0) + (if (user.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "Remark{date=$date, externalRemarkId=$externalRemarkId, text=$text, user=$user, additionalProperties=$additionalProperties}"
    }

    /** Collection of tanker aircraft associated with this Air Event. */
    class Tanker private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("altTankerMissionId") @ExcludeMissing altTankerMissionId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("amcTankerMissionId") @ExcludeMissing amcTankerMissionId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("dualRole") @ExcludeMissing dualRole: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("externalTankerId") @ExcludeMissing externalTankerId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("fuelOff") @ExcludeMissing fuelOff: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("idTankerAirfield") @ExcludeMissing idTankerAirfield: JsonField<String> = JsonMissing.of(),
            @JsonProperty("idTankerMission") @ExcludeMissing idTankerMission: JsonField<String> = JsonMissing.of(),
            @JsonProperty("idTankerSortie") @ExcludeMissing idTankerSortie: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tankerCallSign") @ExcludeMissing tankerCallSign: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tankerCellPosition") @ExcludeMissing tankerCellPosition: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("tankerCoord") @ExcludeMissing tankerCoord: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tankerDeliveryMethod") @ExcludeMissing tankerDeliveryMethod: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tankerDeployedICAO") @ExcludeMissing tankerDeployedIcao: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tankerFuelType") @ExcludeMissing tankerFuelType: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tankerLegNum") @ExcludeMissing tankerLegNum: JsonField<Int> = JsonMissing.of(),
            @JsonProperty("tankerMDS") @ExcludeMissing tankerMds: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tankerOwner") @ExcludeMissing tankerOwner: JsonField<String> = JsonMissing.of(),
            @JsonProperty("tankerPOC") @ExcludeMissing tankerPoc: JsonField<String> = JsonMissing.of()
        ) : this(
          altTankerMissionId,
          amcTankerMissionId,
          dualRole,
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun altTankerMissionId(): Optional<String> = altTankerMissionId.getOptional("altTankerMissionId")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun amcTankerMissionId(): Optional<String> = amcTankerMissionId.getOptional("amcTankerMissionId")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun tankerCellPosition(): Optional<Int> = tankerCellPosition.getOptional("tankerCellPosition")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun tankerDeliveryMethod(): Optional<String> = tankerDeliveryMethod.getOptional("tankerDeliveryMethod")
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun tankerDeployedIcao(): Optional<String> = tankerDeployedIcao.getOptional("tankerDeployedICAO")
         ...
         *
         * Unlike [altTankerMissionId], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [amcTankerMissionId], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _dualRole(): JsonField<Boolean> = dualRole

        /**
         * Returns the raw JSON value of [externalTankerId].
         *
         * Unlike [externalTankerId], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _fuelOff(): JsonField<Double> = fuelOff

        /**
         * Returns the raw JSON value of [idTankerAirfield].
         *
         * Unlike [idTankerAirfield], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [idTankerMission], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [idTankerSortie], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [tankerCallSign], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [tankerCellPosition], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [tankerDeliveryMethod], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [tankerDeployedIcao], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [tankerFuelType], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [tankerLegNum], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _tankerMds(): JsonField<String> = tankerMds
        ...
        @ExcludeMissing
        fun _tankerPoc(): JsonField<String> = tankerPoc
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(tanker: Tanker) =
                apply {
            ...
            /** Alternate mission identifier of this tanker provided by source. */
            fun altTankerMissionId(altTankerMissionId: String) = altTankerMissionId(JsonField.of(altTankerMissionId))

            /**
             * Sets [Builder.altTankerMissionId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.altTankerMissionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun altTankerMissionId(altTankerMissionId: JsonField<String>) =
                apply {
                    this.altTankerMissionId = altTankerMissionId
                }

            /** The Air Mobility Command (AMC) mission identifier of this tanker. */
            fun amcTankerMissionId(amcTankerMissionId: String) = amcTankerMissionId(JsonField.of(amcTankerMissionId))

            /**
             * Sets [Builder.amcTankerMissionId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.amcTankerMissionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun amcTankerMissionId(amcTankerMissionId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.dualRole] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun dualRole(dualRole: JsonField<Boolean>) =
                apply {
                    this.dualRole = dualRole
                }

            /** Optional tanker identifier from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID. */
            fun externalTankerId(externalTankerId: String) = externalTankerId(JsonField.of(externalTankerId))

            /**
             * Sets [Builder.externalTankerId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.externalTankerId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun externalTankerId(externalTankerId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.fuelOff] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fuelOff(fuelOff: JsonField<Double>) =
                apply {
                    this.fuelOff = fuelOff
                }

            /** The UDL ID of the airfield this tanker is associated with for this event. */
            fun idTankerAirfield(idTankerAirfield: String) = idTankerAirfield(JsonField.of(idTankerAirfield))

            /**
             * Sets [Builder.idTankerAirfield] to an arbitrary JSON value.
             *
             * You should usually call [Builder.idTankerAirfield] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun idTankerAirfield(idTankerAirfield: JsonField<String>) =
                apply {
                    this.idTankerAirfield = idTankerAirfield
                }

            /** The UDL ID of the mission this tanker is associated with for this event. */
            fun idTankerMission(idTankerMission: String) = idTankerMission(JsonField.of(idTankerMission))

            /**
             * Sets [Builder.idTankerMission] to an arbitrary JSON value.
             *
             * You should usually call [Builder.idTankerMission] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun idTankerMission(idTankerMission: JsonField<String>) =
                apply {
                    this.idTankerMission = idTankerMission
                }

            /** The UDL ID of the aircraft sortie this tanker is associated with for this event. */
            fun idTankerSortie(idTankerSortie: String) = idTankerSortie(JsonField.of(idTankerSortie))

            /**
             * Sets [Builder.idTankerSortie] to an arbitrary JSON value.
             *
             * You should usually call [Builder.idTankerSortie] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun idTankerSortie(idTankerSortie: JsonField<String>) =
                apply {
                    this.idTankerSortie = idTankerSortie
                }

            /** The call sign assigned to this tanker. */
            fun tankerCallSign(tankerCallSign: String) = tankerCallSign(JsonField.of(tankerCallSign))

            /**
             * Sets [Builder.tankerCallSign] to an arbitrary JSON value.
             *
             * You should usually call [Builder.tankerCallSign] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerCallSign(tankerCallSign: JsonField<String>) =
                apply {
                    this.tankerCallSign = tankerCallSign
                }

            /** Position of this tanker within a group of tankers in an air refueling event. */
            fun tankerCellPosition(tankerCellPosition: Int) = tankerCellPosition(JsonField.of(tankerCellPosition))

            /**
             * Sets [Builder.tankerCellPosition] to an arbitrary JSON value.
             *
             * You should usually call [Builder.tankerCellPosition] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerCellPosition(tankerCellPosition: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.tankerCoord] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerCoord(tankerCoord: JsonField<String>) =
                apply {
                    this.tankerCoord = tankerCoord
                }

            /** Type of fuel delivery method used by the tanker during an air refueling event (BOOM, DROGUE, BOTH). */
            fun tankerDeliveryMethod(tankerDeliveryMethod: String) = tankerDeliveryMethod(JsonField.of(tankerDeliveryMethod))

            /**
             * Sets [Builder.tankerDeliveryMethod] to an arbitrary JSON value.
             *
             * You should usually call [Builder.tankerDeliveryMethod] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerDeliveryMethod(tankerDeliveryMethod: JsonField<String>) =
                apply {
                    this.tankerDeliveryMethod = tankerDeliveryMethod
                }

            /** Location the tanker has been deployed to in preparation for an air refueling event. */
            fun tankerDeployedIcao(tankerDeployedIcao: String) = tankerDeployedIcao(JsonField.of(tankerDeployedIcao))

            /**
             * Sets [Builder.tankerDeployedIcao] to an arbitrary JSON value.
             *
             * You should usually call [Builder.tankerDeployedIcao] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerDeployedIcao(tankerDeployedIcao: JsonField<String>) =
                apply {
                    this.tankerDeployedIcao = tankerDeployedIcao
                }

            /** Type of fuel being transferred from the tanker in an air refueling event. */
            fun tankerFuelType(tankerFuelType: String) = tankerFuelType(JsonField.of(tankerFuelType))

            /**
             * Sets [Builder.tankerFuelType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.tankerFuelType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerFuelType(tankerFuelType: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.tankerLegNum] with a well-typed [Int] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerLegNum(tankerLegNum: JsonField<Int>) =
                apply {
             ...
             *
             * You should usually call [Builder.tankerMds] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerMds(tankerMds: JsonField<String>) =
                apply {
                    this.tankerMds = tankerMds
                }
             ...
             *
             * You should usually call [Builder.tankerOwner] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerOwner(tankerOwner: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.tankerPoc] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tankerPoc(tankerPoc: JsonField<String>) =
                apply {
                    this.tankerPoc = tankerPoc
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (altTankerMissionId.asKnown().isPresent) 1 else 0) + (if (amcTankerMissionId.asKnown().isPresent) 1 else 0) + (if (dualRole.asKnown().isPresent) 1 else 0) + (if (externalTankerId.asKnown().isPresent) 1 else 0) + (if (fuelOff.asKnown().isPresent) 1 else 0) + (if (idTankerAirfield.asKnown().isPresent) 1 else 0) + (if (idTankerMission.asKnown().isPresent) 1 else 0) + (if (idTankerSortie.asKnown().isPresent) 1 else 0) + (if (tankerCallSign.asKnown().isPresent) 1 else 0) + (if (tankerCellPosition.asKnown().isPresent) 1 else 0) + (if (tankerCoord.asKnown().isPresent) 1 else 0) + (if (tankerDeliveryMethod.asKnown().isPresent) 1 else 0) + (if (tankerDeployedIcao.asKnown().isPresent) 1 else 0) + (if (tankerFuelType.asKnown().isPresent) 1 else 0) + (if (tankerLegNum.asKnown().isPresent) 1 else 0) + (if (tankerMds.asKnown().isPresent) 1 else 0) + (if (tankerOwner.asKnown().isPresent) 1 else 0) + (if (tankerPoc.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "AirEventListResponse{classificationMarking=$classificationMarking, dataMode=$dataMode, source=$source, type=$type, id=$id, actualArrTime=$actualArrTime, actualDepTime=$actualDepTime, arct=$arct, arEventType=$arEventType, arrPurpose=$arrPurpose, arTrackId=$arTrackId, arTrackName=$arTrackName, baseAlt=$baseAlt, cancelled=$cancelled, createdAt=$createdAt, createdBy=$createdBy, depPurpose=$depPurpose, estArrTime=$estArrTime, estDepTime=$estDepTime, externalAirEventId=$externalAirEventId, externalArTrackId=$externalArTrackId, idMission=$idMission, idSortie=$idSortie, legNum=$legNum, location=$location, numTankers=$numTankers, origin=$origin, origNetwork=$origNetwork, plannedArrTime=$plannedArrTime, plannedDepTime=$plannedDepTime, priority=$priority, receivers=$receivers, remarks=$remarks, revTrack=$revTrack, rzct=$rzct, rzPoint=$rzPoint, rzType=$rzType, shortTrack=$shortTrack, sourceDl=$sourceDl, statusCode=$statusCode, tankers=$tankers, trackTime=$trackTime, updatedAt=$updatedAt, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
}
