...
class TransponderTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransponderTupleParams].
         *
    ...
    /** A builder for [TransponderTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transponderTupleParams: TransponderTupleParams) =
            apply {
                columns = transponderTupleParams.columns
                firstResult = transponderTupleParams.firstResult
                maxResults = transponderTupleParams.maxResults
                additionalHeaders = transponderTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = transponderTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TransponderTupleParams].
         *
         ...
         */
        fun build(): TransponderTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is TransponderTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "TransponderTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
