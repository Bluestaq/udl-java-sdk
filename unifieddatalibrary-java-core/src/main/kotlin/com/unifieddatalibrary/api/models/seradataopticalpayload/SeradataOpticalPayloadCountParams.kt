 ...
 */
class SeradataOpticalPayloadCountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SeradataOpticalPayloadCountParams = builder().build()
        ...
        internal fun from(seradataOpticalPayloadCountParams: SeradataOpticalPayloadCountParams) =
            apply {
                ...
                additionalQueryParams =
                    seradataOpticalPayloadCountParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() =
        "SeradataOpticalPayloadCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
