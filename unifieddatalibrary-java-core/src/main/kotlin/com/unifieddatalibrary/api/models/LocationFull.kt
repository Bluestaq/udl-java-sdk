...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(locationFull: LocationFull) = apply {
    ...
    fun validate(): LocationFull = apply {
        if (validated) {
            return@apply
        }
