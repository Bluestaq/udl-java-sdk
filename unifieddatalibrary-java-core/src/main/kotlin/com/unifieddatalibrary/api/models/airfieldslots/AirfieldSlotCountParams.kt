...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AirfieldSlotCountParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(airfieldSlotCountParams: AirfieldSlotCountParams) = apply {
    ...
    override fun toString() =
        "AirfieldSlotCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
