...
class CollectRequestTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectRequestTupleParams].
         *
    ...
    /** A builder for [CollectRequestTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectRequestTupleParams: CollectRequestTupleParams) =
            apply {
                columns = collectRequestTupleParams.columns
                startTime = collectRequestTupleParams.startTime
                firstResult = collectRequestTupleParams.firstResult
                maxResults = collectRequestTupleParams.maxResults
                additionalHeaders = collectRequestTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = collectRequestTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CollectRequestTupleParams].
         *
         ...
         */
        fun build(): CollectRequestTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is CollectRequestTupleParams && columns == other.columns && startTime == other.startTime && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "CollectRequestTupleParams{columns=$columns, startTime=$startTime, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
