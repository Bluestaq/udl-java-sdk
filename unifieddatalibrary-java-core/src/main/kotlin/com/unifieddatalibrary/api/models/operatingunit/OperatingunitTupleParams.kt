...
class OperatingunitTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OperatingunitTupleParams].
         *
    ...
    /** A builder for [OperatingunitTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(operatingunitTupleParams: OperatingunitTupleParams) =
            apply {
                columns = operatingunitTupleParams.columns
                firstResult = operatingunitTupleParams.firstResult
                maxResults = operatingunitTupleParams.maxResults
                additionalHeaders = operatingunitTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = operatingunitTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OperatingunitTupleParams].
         *
         ...
         */
        fun build(): OperatingunitTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is OperatingunitTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "OperatingunitTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
