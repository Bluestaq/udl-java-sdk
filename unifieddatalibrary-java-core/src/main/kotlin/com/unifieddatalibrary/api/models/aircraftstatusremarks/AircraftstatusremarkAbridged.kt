...
class AircraftstatusremarkAbridged private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("idAircraftStatus") @ExcludeMissing idAircraftStatus: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("lastUpdatedAt") @ExcludeMissing lastUpdatedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
     ...
     *
     * Unlike [idAircraftStatus], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _altRmkId(): JsonField<String> = altRmkId
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftstatusremarkAbridged: AircraftstatusremarkAbridged) =
            apply {
        ...
        /** The ID of the Aircraft Status to which this remark applies. */
        fun idAircraftStatus(idAircraftStatus: String) = idAircraftStatus(JsonField.of(idAircraftStatus))

        /**
         * Sets [Builder.idAircraftStatus] to an arbitrary JSON value.
         *
         * You should usually call [Builder.idAircraftStatus] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun idAircraftStatus(idAircraftStatus: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.altRmkId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun altRmkId(altRmkId: JsonField<String>) =
            apply {
                this.altRmkId = altRmkId
            }
        ...
        /** Time the remark was last updated in the originating system in ISO 8601 UTC format with millisecond precision. */
        fun lastUpdatedAt(lastUpdatedAt: OffsetDateTime) = lastUpdatedAt(JsonField.of(lastUpdatedAt))

        /**
         * Sets [Builder.lastUpdatedAt] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lastUpdatedAt] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lastUpdatedAt(lastUpdatedAt: JsonField<OffsetDateTime>) =
            apply {
    ...
    fun validate(): AircraftstatusremarkAbridged =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (classificationMarking.asKnown().isPresent) 1 else 0) + (dataMode.asKnown().getOrNull()?.validity() ?: 0) + (if (idAircraftStatus.asKnown().isPresent) 1 else 0) + (if (source.asKnown().isPresent) 1 else 0) + (if (text.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (altRmkId.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (lastUpdatedAt.asKnown().isPresent) 1 else 0) + (if (lastUpdatedBy.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (origin.asKnown().isPresent) 1 else 0) + (if (origNetwork.asKnown().isPresent) 1 else 0) + (if (sourceDl.asKnown().isPresent) 1 else 0) + (if (timestamp.asKnown().isPresent) 1 else 0)
    ...
    override fun toString() = "AircraftstatusremarkAbridged{classificationMarking=$classificationMarking, dataMode=$dataMode, idAircraftStatus=$idAircraftStatus, source=$source, text=$text, id=$id, altRmkId=$altRmkId, createdAt=$createdAt, createdBy=$createdBy, lastUpdatedAt=$lastUpdatedAt, lastUpdatedBy=$lastUpdatedBy, name=$name, origin=$origin, origNetwork=$origNetwork, sourceDl=$sourceDl, timestamp=$timestamp, additionalProperties=$additionalProperties}"
}
