...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AircraftstatusremarkAbridged].
         *
    ...
    /** A builder for [AircraftstatusremarkAbridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aircraftstatusremarkAbridged: AircraftstatusremarkAbridged) = apply {
            classificationMarking = aircraftstatusremarkAbridged.classificationMarking
            dataMode = aircraftstatusremarkAbridged.dataMode
            idAircraftStatus = aircraftstatusremarkAbridged.idAircraftStatus
            source = aircraftstatusremarkAbridged.source
            text = aircraftstatusremarkAbridged.text
            id = aircraftstatusremarkAbridged.id
            altRmkId = aircraftstatusremarkAbridged.altRmkId
            createdAt = aircraftstatusremarkAbridged.createdAt
            createdBy = aircraftstatusremarkAbridged.createdBy
            lastUpdatedAt = aircraftstatusremarkAbridged.lastUpdatedAt
            lastUpdatedBy = aircraftstatusremarkAbridged.lastUpdatedBy
            name = aircraftstatusremarkAbridged.name
            origin = aircraftstatusremarkAbridged.origin
            origNetwork = aircraftstatusremarkAbridged.origNetwork
            sourceDl = aircraftstatusremarkAbridged.sourceDl
            timestamp = aircraftstatusremarkAbridged.timestamp
            additionalProperties = aircraftstatusremarkAbridged.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AircraftstatusremarkAbridged].
         *
         ...
         */
        fun build(): AircraftstatusremarkAbridged =
    ...
    fun validate(): AircraftstatusremarkAbridged = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AircraftstatusremarkAbridged &&
    ...
    override fun toString() =
        "AircraftstatusremarkAbridged{classificationMarking=$classificationMarking, dataMode=$dataMode, idAircraftStatus=$idAircraftStatus, source=$source, text=$text, id=$id, altRmkId=$altRmkId, createdAt=$createdAt, createdBy=$createdBy, lastUpdatedAt=$lastUpdatedAt, lastUpdatedBy=$lastUpdatedBy, name=$name, origin=$origin, origNetwork=$origNetwork, sourceDl=$sourceDl, timestamp=$timestamp, additionalProperties=$additionalProperties}"
}
