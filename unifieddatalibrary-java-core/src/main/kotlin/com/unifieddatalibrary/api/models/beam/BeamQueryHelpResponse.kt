...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamQueryHelpResponse: BeamQueryHelpResponse) = apply {
    ...
    fun validate(): BeamQueryHelpResponse = apply {
        if (validated) {
            return@apply
        }
