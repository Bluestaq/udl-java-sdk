...
class BeamQueryHelpResponse private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BeamQueryHelpResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [BeamQueryHelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beamQueryHelpResponse: BeamQueryHelpResponse) =
            apply {
                aodrSupported = beamQueryHelpResponse.aodrSupported
                classificationMarking = beamQueryHelpResponse.classificationMarking
                description = beamQueryHelpResponse.description
                historySupported = beamQueryHelpResponse.historySupported
                name = beamQueryHelpResponse.name
                parameters = beamQueryHelpResponse.parameters.map { it.toMutableList() }
                requiredRoles = beamQueryHelpResponse.requiredRoles.map { it.toMutableList() }
                restSupported = beamQueryHelpResponse.restSupported
                sortSupported = beamQueryHelpResponse.sortSupported
                typeName = beamQueryHelpResponse.typeName
                uri = beamQueryHelpResponse.uri
                additionalProperties = beamQueryHelpResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BeamQueryHelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BeamQueryHelpResponse =
    ...
    fun validate(): BeamQueryHelpResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BeamQueryHelpResponse && aodrSupported == other.aodrSupported && classificationMarking == other.classificationMarking && description == other.description && historySupported == other.historySupported && name == other.name && parameters == other.parameters && requiredRoles == other.requiredRoles && restSupported == other.restSupported && sortSupported == other.sortSupported && typeName == other.typeName && uri == other.uri && additionalProperties == other.additionalProperties /* spotless:on */
    }
