...
class LogisticsSupportListPage
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logisticsSupportListPage: LogisticsSupportListPage) = apply {
            service = logisticsSupportListPage.service
            params = logisticsSupportListPage.params
            items = logisticsSupportListPage.items
        }

        fun service(service: LogisticsSupportService) = apply { this.service = service }

        /** The parameters that were used to request this page. */
        fun params(params: LogisticsSupportListParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun items(items: List<LogisticsSupportListResponse>) = apply { this.items = items }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LogisticsSupportListPage &&
    ...
    override fun toString() =
        "LogisticsSupportListPage{service=$service, params=$params, items=$items}"
}
