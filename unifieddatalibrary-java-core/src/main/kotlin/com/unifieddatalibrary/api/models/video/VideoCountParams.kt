...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VideoCountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [VideoCountParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VideoCountParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(videoCountParams: VideoCountParams) = apply {
            firstResult = videoCountParams.firstResult
            maxResults = videoCountParams.maxResults
            additionalHeaders = videoCountParams.additionalHeaders.toBuilder()
            additionalQueryParams = videoCountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VideoCountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VideoCountParams =
            VideoCountParams(
                firstResult,
                maxResults,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VideoCountParams && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "VideoCountParams{firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
