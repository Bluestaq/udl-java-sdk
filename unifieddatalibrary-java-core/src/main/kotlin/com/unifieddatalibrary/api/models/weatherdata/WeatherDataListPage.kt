...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(weatherDataListPage: WeatherDataListPage) = apply {
            service = weatherDataListPage.service
            params = weatherDataListPage.params
            items = weatherDataListPage.items
        }

        fun service(service: WeatherDataService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WeatherDataListPage &&
