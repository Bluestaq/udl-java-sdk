...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScFileDownloadParams].
         *
    ...
    /** A builder for [ScFileDownloadParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scFileDownloadParams: ScFileDownloadParams) = apply {
            id = scFileDownloadParams.id
            firstResult = scFileDownloadParams.firstResult
            maxResults = scFileDownloadParams.maxResults
            additionalHeaders = scFileDownloadParams.additionalHeaders.toBuilder()
            additionalQueryParams = scFileDownloadParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ScFileDownloadParams].
         *
         ...
         */
        fun build(): ScFileDownloadParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ScFileDownloadParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ScFileDownloadParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
