...
class NavigationTupleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NavigationTupleParams].
         *
    ...
    /** A builder for [NavigationTupleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(navigationTupleParams: NavigationTupleParams) =
            apply {
                columns = navigationTupleParams.columns
                firstResult = navigationTupleParams.firstResult
                maxResults = navigationTupleParams.maxResults
                additionalHeaders = navigationTupleParams.additionalHeaders.toBuilder()
                additionalQueryParams = navigationTupleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [NavigationTupleParams].
         *
         ...
         */
        fun build(): NavigationTupleParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is NavigationTupleParams && columns == other.columns && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "NavigationTupleParams{columns=$columns, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
