...
class IonoObservationListResponse private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IonoObservationListResponse].
         *
    ...
    /** A builder for [IonoObservationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ionoObservationListResponse: IonoObservationListResponse) =
            apply {
                classificationMarking = ionoObservationListResponse.classificationMarking
                dataMode = ionoObservationListResponse.dataMode
                source = ionoObservationListResponse.source
                startTimeUtc = ionoObservationListResponse.startTimeUtc
                stationId = ionoObservationListResponse.stationId
                system = ionoObservationListResponse.system
                systemInfo = ionoObservationListResponse.systemInfo
                id = ionoObservationListResponse.id
                amplitude = ionoObservationListResponse.amplitude
                antennaElementPosition = ionoObservationListResponse.antennaElementPosition
                antennaElementPositionCoordinateSystem = ionoObservationListResponse.antennaElementPositionCoordinateSystem
                artistFlags = ionoObservationListResponse.artistFlags.map { it.toMutableList() }
                azimuth = ionoObservationListResponse.azimuth
                b0 = ionoObservationListResponse.b0
                b1 = ionoObservationListResponse.b1
                charAtts = ionoObservationListResponse.charAtts.map { it.toMutableList() }
                createdAt = ionoObservationListResponse.createdAt
                createdBy = ionoObservationListResponse.createdBy
                d = ionoObservationListResponse.d
                d1 = ionoObservationListResponse.d1
                datum = ionoObservationListResponse.datum
                deltafoF2 = ionoObservationListResponse.deltafoF2
                densityProfile = ionoObservationListResponse.densityProfile
                doppler = ionoObservationListResponse.doppler
                downE = ionoObservationListResponse.downE
                downEs = ionoObservationListResponse.downEs
                downF = ionoObservationListResponse.downF
                electronDensity = ionoObservationListResponse.electronDensity.map { it.toMutableList() }
                electronDensityUncertainty = ionoObservationListResponse.electronDensityUncertainty.map { it.toMutableList() }
                elevation = ionoObservationListResponse.elevation
                fbEs = ionoObservationListResponse.fbEs
                fe = ionoObservationListResponse.fe
                ff = ionoObservationListResponse.ff
                fhprimeF = ionoObservationListResponse.fhprimeF
                fhprimeF2 = ionoObservationListResponse.fhprimeF2
                fmin = ionoObservationListResponse.fmin
                fminE = ionoObservationListResponse.fminE
                fminEs = ionoObservationListResponse.fminEs
                fminF = ionoObservationListResponse.fminF
                fmuf = ionoObservationListResponse.fmuf
                foE = ionoObservationListResponse.foE
                foEa = ionoObservationListResponse.foEa
                foEp = ionoObservationListResponse.foEp
                foEs = ionoObservationListResponse.foEs
                foF1 = ionoObservationListResponse.foF1
                foF1p = ionoObservationListResponse.foF1p
                foF2 = ionoObservationListResponse.foF2
                foF2p = ionoObservationListResponse.foF2p
                foP = ionoObservationListResponse.foP
                frequency = ionoObservationListResponse.frequency
                fxE = ionoObservationListResponse.fxE
                fxF1 = ionoObservationListResponse.fxF1
                fxF2 = ionoObservationListResponse.fxF2
                fxI = ionoObservationListResponse.fxI
                height = ionoObservationListResponse.height.map { it.toMutableList() }
                hmE = ionoObservationListResponse.hmE
                hmF1 = ionoObservationListResponse.hmF1
                hmF2 = ionoObservationListResponse.hmF2
                hprimeE = ionoObservationListResponse.hprimeE
                hprimeEa = ionoObservationListResponse.hprimeEa
                hprimeEs = ionoObservationListResponse.hprimeEs
                hprimeF = ionoObservationListResponse.hprimeF
                hprimeF1 = ionoObservationListResponse.hprimeF1
                hprimeF2 = ionoObservationListResponse.hprimeF2
                hprimefMuf = ionoObservationListResponse.hprimefMuf
                hprimeP = ionoObservationListResponse.hprimeP
                idSensor = ionoObservationListResponse.idSensor
                luf = ionoObservationListResponse.luf
                md = ionoObservationListResponse.md
                mufd = ionoObservationListResponse.mufd
                neProfileName = ionoObservationListResponse.neProfileName
                neProfileVersion = ionoObservationListResponse.neProfileVersion
                origin = ionoObservationListResponse.origin
                origNetwork = ionoObservationListResponse.origNetwork
                origSensorId = ionoObservationListResponse.origSensorId
                phase = ionoObservationListResponse.phase
                plasmaFrequency = ionoObservationListResponse.plasmaFrequency.map { it.toMutableList() }
                plasmaFrequencyUncertainty = ionoObservationListResponse.plasmaFrequencyUncertainty.map { it.toMutableList() }
                platformName = ionoObservationListResponse.platformName
                polarization = ionoObservationListResponse.polarization
                power = ionoObservationListResponse.power
                qe = ionoObservationListResponse.qe
                qf = ionoObservationListResponse.qf
                range = ionoObservationListResponse.range
                receiveCoordinates = ionoObservationListResponse.receiveCoordinates.map { it.toMutableList() }
                receiveSensorType = ionoObservationListResponse.receiveSensorType
                restrictedFrequency = ionoObservationListResponse.restrictedFrequency.map { it.toMutableList() }
                restrictedFrequencyNotes = ionoObservationListResponse.restrictedFrequencyNotes
                scaleHeightF2Peak = ionoObservationListResponse.scaleHeightF2Peak
                scalerInfo = ionoObservationListResponse.scalerInfo
                stokes = ionoObservationListResponse.stokes
                systemNotes = ionoObservationListResponse.systemNotes
                tec = ionoObservationListResponse.tec
                tidAzimuth = ionoObservationListResponse.tidAzimuth.map { it.toMutableList() }
                tidPeriods = ionoObservationListResponse.tidPeriods.map { it.toMutableList() }
                tidPhaseSpeeds = ionoObservationListResponse.tidPhaseSpeeds.map { it.toMutableList() }
                time = ionoObservationListResponse.time
                traceGeneric = ionoObservationListResponse.traceGeneric
                transmitCoordinates = ionoObservationListResponse.transmitCoordinates.map { it.toMutableList() }
                transmitSensorType = ionoObservationListResponse.transmitSensorType
                typeEs = ionoObservationListResponse.typeEs
                updatedAt = ionoObservationListResponse.updatedAt
                updatedBy = ionoObservationListResponse.updatedBy
                yE = ionoObservationListResponse.yE
                yF1 = ionoObservationListResponse.yF1
                yF2 = ionoObservationListResponse.yF2
                zhalfNm = ionoObservationListResponse.zhalfNm
                zmE = ionoObservationListResponse.zmE
                additionalProperties = ionoObservationListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [IonoObservationListResponse].
         *
         ...
         */
        fun build(): IonoObservationListResponse =
    ...
    fun validate(): IonoObservationListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Polarization private constructor(
        private val data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>>,
        private val dimensionName: JsonField<List<String>>,
        private val dimensions: JsonField<List<Int>>,
        private val notes: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") @ExcludeMissing data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>> = JsonMissing.of(),
            @JsonProperty("dimensionName") @ExcludeMissing dimensionName: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("dimensions") @ExcludeMissing dimensions: JsonField<List<Int>> = JsonMissing.of(),
            @JsonProperty("notes") @ExcludeMissing notes: JsonField<String> = JsonMissing.of()
        ) : this(
         ...
         * @throws UnifieddatalibraryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun data(): Optional<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>> = data.getOptional("data")
        ...
        @JsonProperty("data")
        @ExcludeMissing
        fun _data(): JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>> = data
        ...
        class Builder internal constructor() {
            ...
            private var data: JsonField<MutableList<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>>? = null
            private var dimensionName: JsonField<MutableList<String>>? = null
            private var dimensions: JsonField<MutableList<Int>>? = null
            private var notes: JsonField<String> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            /** Array of polarization data. */
            fun data(data: List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>) = data(JsonField.of(data))

            /**
             * Sets [Builder.data] to an arbitrary JSON value.
             *
             * You should usually call [Builder.data] with a well-typed `List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun data(data: JsonField<List<List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>>>) =
                apply {
                    this.data = data.map { it.toMutableList() }
                }

            /**
             * Adds a single [List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>] to [Builder.data].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addData(data: List<List<List<List<List<List<UnnamedSchemaWithArrayParent0>>>>>>) =
                apply {
                    this.data = (this.data ?: JsonField.of(mutableListOf())).also {
                        checkKnown("data", it).add(data)
                    }
        ...
        class UnnamedSchemaWithArrayParent0 @JsonCreator private constructor(
            ...
            fun known(): Known =
                when (this) {
                    X -> Known.X
                    O -> Known.O
                    else -> throw UnifieddatalibraryInvalidDataException("Unknown UnnamedSchemaWithArrayParent0: $value")
                }
