...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PortGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portGetParams: PortGetParams) = apply {
            id = portGetParams.id
    ...
    override fun toString() =
        "PortGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
