...
class PortGetParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): PortGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PortGetParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [PortGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portGetParams: PortGetParams) =
            apply {
                id = portGetParams.id
                firstResult = portGetParams.firstResult
                maxResults = portGetParams.maxResults
                additionalHeaders = portGetParams.additionalHeaders.toBuilder()
                additionalQueryParams = portGetParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PortGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortGetParams =
            PortGetParams(
              id,
              firstResult,
              maxResults,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is PortGetParams && id == other.id && firstResult == other.firstResult && maxResults == other.maxResults && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "PortGetParams{id=$id, firstResult=$firstResult, maxResults=$maxResults, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
