...
class OnorbitthrusterstatusQueryhelpResponse
private constructor(
    ...
    /** A builder for [OnorbitthrusterstatusQueryhelpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            onorbitthrusterstatusQueryhelpResponse: OnorbitthrusterstatusQueryhelpResponse
        ) = apply {
            aodrSupported = onorbitthrusterstatusQueryhelpResponse.aodrSupported
            classificationMarking = onorbitthrusterstatusQueryhelpResponse.classificationMarking
            description = onorbitthrusterstatusQueryhelpResponse.description
            historySupported = onorbitthrusterstatusQueryhelpResponse.historySupported
            name = onorbitthrusterstatusQueryhelpResponse.name
            parameters =
                onorbitthrusterstatusQueryhelpResponse.parameters.map { it.toMutableList() }
            requiredRoles =
                onorbitthrusterstatusQueryhelpResponse.requiredRoles.map { it.toMutableList() }
            restSupported = onorbitthrusterstatusQueryhelpResponse.restSupported
            sortSupported = onorbitthrusterstatusQueryhelpResponse.sortSupported
            typeName = onorbitthrusterstatusQueryhelpResponse.typeName
            uri = onorbitthrusterstatusQueryhelpResponse.uri
            additionalProperties =
                onorbitthrusterstatusQueryhelpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OnorbitthrusterstatusQueryhelpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OnorbitthrusterstatusQueryhelpResponse =
            OnorbitthrusterstatusQueryhelpResponse(
                aodrSupported,
                classificationMarking,
                description,
    ...
    fun validate(): OnorbitthrusterstatusQueryhelpResponse = apply {
        if (validated) {
            return@apply
        }
