...
package com.unifieddatalibrary.api.services.blocking.gnssrawif
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/gnssrawif/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/gnssrawif/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/gnssrawif/history`, but is otherwise the same as [HistoryService.query]. */
        @MustBeClosed
