...
class LaunchSiteServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : LaunchSiteService {

    private val withRawResponse: LaunchSiteService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): LaunchSiteService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LaunchSiteService = LaunchSiteServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: LaunchSiteListParams, requestOptions: RequestOptions): LaunchSiteListPage =
        // get /udl/launchsite
    ...
    override fun get(params: LaunchSiteGetParams, requestOptions: RequestOptions): LaunchSiteGetResponse =
        // get /udl/launchsite/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: LaunchSiteQueryhelpParams, requestOptions: RequestOptions): LaunchSiteQueryhelpResponse =
        // get /udl/launchsite/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: LaunchSiteTupleParams, requestOptions: RequestOptions): List<LaunchSiteTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LaunchSiteService.WithRawResponse = LaunchSiteServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: LaunchSiteCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: LaunchSiteUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: LaunchSiteListParams, requestOptions: RequestOptions): HttpResponseFor<LaunchSiteListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: LaunchSiteDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: LaunchSiteCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: LaunchSiteGetParams, requestOptions: RequestOptions): HttpResponseFor<LaunchSiteGetResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: LaunchSiteQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<LaunchSiteQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: LaunchSiteTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<LaunchSiteTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
