...
class OnboardnavigationServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : OnboardnavigationServiceAsync {

    private val withRawResponse: OnboardnavigationServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        OnboardnavigationServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnboardnavigationServiceAsyncImpl.WithRawResponseImpl(
