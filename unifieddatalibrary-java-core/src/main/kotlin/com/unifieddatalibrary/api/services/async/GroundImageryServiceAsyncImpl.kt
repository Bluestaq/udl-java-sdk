...
class GroundImageryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: GroundImageryServiceAsync.WithRawResponse by lazy {
    ...
    override fun get(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<GroundImageryGetResponse> =
    ...
    override fun queryhelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<GroundImageryQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<GroundImageryTupleResponse>> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            GroundImageryServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun get(
            params: GroundImageryGetParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<GroundImageryGetResponse>> {
        ...
        override fun queryhelp(
            params: GroundImageryQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<GroundImageryQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(
            params: GroundImageryTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<GroundImageryTupleResponse>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
