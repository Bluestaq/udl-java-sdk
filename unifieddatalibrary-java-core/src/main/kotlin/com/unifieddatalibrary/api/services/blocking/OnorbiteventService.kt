...
interface OnorbiteventService {
     ...
     */
    fun create(params: OnorbiteventCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: OnorbiteventUpdateParams) = update(params, RequestOptions.none())
     ...
     * this service operation. Please contact the UDL team for assistance.
     */
    fun delete(id: String) = delete(id, OnorbiteventDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: OnorbiteventDeleteParams) = delete(params, RequestOptions.none())
     ...
     */
    fun get(id: String): OnorbiteventGetResponse = get(id, OnorbiteventGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): OnorbiteventGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: OnorbiteventGetParams = OnorbiteventGetParams.none(),
    ): OnorbiteventGetResponse = get(id, params, RequestOptions.none())
    ...
    fun queryhelp(
        params: OnorbiteventQueryhelpParams = OnorbiteventQueryhelpParams.none()
    ): OnorbiteventQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: OnorbiteventListParams = OnorbiteventListParams.none()
        ): HttpResponseFor<OnorbiteventListPage> = list(params, RequestOptions.none())
         ...
         * same as [OnorbiteventService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, OnorbiteventDeleteParams.none())
         ...
         * as [OnorbiteventService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(OnorbiteventCountParams.none())
        ...
        fun get(
            id: String,
            params: OnorbiteventGetParams = OnorbiteventGetParams.none(),
        ): HttpResponseFor<OnorbiteventGetResponse> = get(id, params, RequestOptions.none())
         ...
         * same as [OnorbiteventService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<OnorbiteventQueryhelpResponse> =
        ...
        fun queryhelp(
            params: OnorbiteventQueryhelpParams = OnorbiteventQueryhelpParams.none()
        ): HttpResponseFor<OnorbiteventQueryhelpResponse> = queryhelp(params, RequestOptions.none())
         ...
         * as [OnorbiteventService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: OnorbiteventTupleParams
        ): HttpResponseFor<List<OnorbiteventTupleResponse>> = tuple(params, RequestOptions.none())
