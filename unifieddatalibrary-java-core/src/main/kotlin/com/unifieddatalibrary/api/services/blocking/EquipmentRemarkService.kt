...
interface EquipmentRemarkService {
     ...
     */
    fun create(params: EquipmentRemarkCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): EquipmentRemarkFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: EquipmentRemarkRetrieveParams = EquipmentRemarkRetrieveParams.none(),
    ): EquipmentRemarkFull = retrieve(id, params, RequestOptions.none())
    ...
    fun list(
        params: EquipmentRemarkListParams = EquipmentRemarkListParams.none()
    ): EquipmentRemarkListPage = list(params, RequestOptions.none())
     ...
     */
    fun queryHelp(): EquipmentRemarkQueryHelpResponse =
    ...
    fun queryHelp(
        params: EquipmentRemarkQueryHelpParams = EquipmentRemarkQueryHelpParams.none()
    ): EquipmentRemarkQueryHelpResponse = queryHelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): List<EquipmentRemarkFull>

    /**
     * A view of [EquipmentRemarkService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * same as [EquipmentRemarkService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            ...
            params: EquipmentRemarkRetrieveParams = EquipmentRemarkRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<EquipmentRemarkFull> =
        ...
        fun retrieve(
            id: String,
            params: EquipmentRemarkRetrieveParams = EquipmentRemarkRetrieveParams.none(),
        ): HttpResponseFor<EquipmentRemarkFull> = retrieve(id, params, RequestOptions.none())
         ...
         * [EquipmentRemarkService.list].
         */
        @MustBeClosed
        fun list(): HttpResponseFor<EquipmentRemarkListPage> =
        ...
        fun list(
            params: EquipmentRemarkListParams = EquipmentRemarkListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<EquipmentRemarkListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: EquipmentRemarkListParams = EquipmentRemarkListParams.none()
        ): HttpResponseFor<EquipmentRemarkListPage> = list(params, RequestOptions.none())
         ...
         * same as [EquipmentRemarkService.count].
         */
        @MustBeClosed
         ...
         * the same as [EquipmentRemarkService.createBulk].
         */
        @MustBeClosed
         ...
         * the same as [EquipmentRemarkService.queryHelp].
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<EquipmentRemarkQueryHelpResponse> =
            queryHelp(EquipmentRemarkQueryHelpParams.none())
        ...
        fun queryHelp(
            params: EquipmentRemarkQueryHelpParams = EquipmentRemarkQueryHelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<EquipmentRemarkQueryHelpResponse>
         ...
         * same as [EquipmentRemarkService.tuple].
         */
        @MustBeClosed
        ...
        fun tuple(
            params: EquipmentRemarkTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<EquipmentRemarkFull>>
    }
}
