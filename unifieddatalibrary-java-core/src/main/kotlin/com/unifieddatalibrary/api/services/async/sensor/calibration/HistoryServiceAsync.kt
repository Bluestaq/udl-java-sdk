...
package com.unifieddatalibrary.api.services.async.sensor.calibration
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/sensorcalibration/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
        ...
        /** Returns a raw HTTP response for `get /udl/sensorcalibration/history`, but is otherwise the same as [HistoryServiceAsync.query]. */
        ...
        /** Returns a raw HTTP response for `get /udl/sensorcalibration/history/aodr`, but is otherwise the same as [HistoryServiceAsync.writeAodr]. */
