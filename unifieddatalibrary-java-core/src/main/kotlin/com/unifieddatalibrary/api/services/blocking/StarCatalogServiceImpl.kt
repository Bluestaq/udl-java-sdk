...
class StarCatalogServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : StarCatalogService {

    private val withRawResponse: StarCatalogService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): StarCatalogService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): StarCatalogService = StarCatalogServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: StarCatalogListParams, requestOptions: RequestOptions): StarCatalogListPage =
        // get /udl/starcatalog
    ...
    override fun get(params: StarCatalogGetParams, requestOptions: RequestOptions): StarCatalogGetResponse =
        // get /udl/starcatalog/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: StarCatalogQueryhelpParams, requestOptions: RequestOptions): StarCatalogQueryhelpResponse =
        // get /udl/starcatalog/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: StarCatalogTupleParams, requestOptions: RequestOptions): List<StarCatalogTupleResponse> =
        // get /udl/starcatalog/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: StarCatalogUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): StarCatalogService.WithRawResponse = StarCatalogServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: StarCatalogCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: StarCatalogUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: StarCatalogListParams, requestOptions: RequestOptions): HttpResponseFor<StarCatalogListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: StarCatalogDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: StarCatalogCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: StarCatalogCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: StarCatalogGetParams, requestOptions: RequestOptions): HttpResponseFor<StarCatalogGetResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: StarCatalogQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<StarCatalogQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: StarCatalogTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<StarCatalogTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: StarCatalogUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
