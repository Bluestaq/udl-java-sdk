...
class SarObservationServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : SarObservationServiceAsync {

    private val withRawResponse: SarObservationServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        SarObservationServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SarObservationServiceAsyncImpl.WithRawResponseImpl(
