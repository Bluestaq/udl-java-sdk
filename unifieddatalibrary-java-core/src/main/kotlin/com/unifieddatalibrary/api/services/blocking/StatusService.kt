...
interface StatusService {
     ...
     * assistance.
     */
    fun create(params: StatusCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: StatusUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, StatusDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: StatusDeleteParams) = delete(params, RequestOptions.none())
     ...
     */
    fun get(id: String): StatusFull = get(id, StatusGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): StatusFull = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: StatusGetParams): StatusFull = get(params, RequestOptions.none())
    ...
    fun getByEntityId(
        idEntity: String,
        params: StatusGetByEntityIdParams = StatusGetByEntityIdParams.none(),
    ): List<StatusFull> = getByEntityId(idEntity, params, RequestOptions.none())
    ...
    fun getByEntityType(
        entityType: String,
        params: StatusGetByEntityTypeParams = StatusGetByEntityTypeParams.none(),
    ): List<StatusFull> = getByEntityType(entityType, params, RequestOptions.none())
    ...
    fun queryhelp(
        params: StatusQueryhelpParams = StatusQueryhelpParams.none()
    ): StatusQueryhelpResponse = queryhelp(params, RequestOptions.none())
     ...
     */
    fun tuple(params: StatusTupleParams): List<StatusFull> = tuple(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: StatusCreateParams): HttpResponse = create(params, RequestOptions.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: StatusUpdateParams): HttpResponse = update(params, RequestOptions.none())
         ...
         * [StatusService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<StatusListPage> = list(StatusListParams.none())
        ...
        fun list(
            params: StatusListParams = StatusListParams.none()
        ): HttpResponseFor<StatusListPage> = list(params, RequestOptions.none())
         ...
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, StatusDeleteParams.none())
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: StatusDeleteParams): HttpResponse = delete(params, RequestOptions.none())
         ...
         * [StatusService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(StatusCountParams.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<StatusFull> = get(id, StatusGetParams.none())
        ...
        fun get(
            ...
            params: StatusGetParams = StatusGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<StatusFull> = get(params.toBuilder().id(id).build(), requestOptions)
        ...
        fun get(
            id: String,
            params: StatusGetParams = StatusGetParams.none(),
        ): HttpResponseFor<StatusFull> = get(id, params, RequestOptions.none())
         ...
         * the same as [StatusService.getByEntityId].
         */
        @MustBeClosed
         ...
         * otherwise the same as [StatusService.getByEntityType].
         */
        @MustBeClosed
        ...
        fun getByEntityType(
            params: StatusGetByEntityTypeParams
        ): HttpResponseFor<List<StatusFull>> = getByEntityType(params, RequestOptions.none())
         ...
         * [StatusService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<StatusQueryhelpResponse> =
        ...
        fun queryhelp(
            params: StatusQueryhelpParams = StatusQueryhelpParams.none()
        ): HttpResponseFor<StatusQueryhelpResponse> = queryhelp(params, RequestOptions.none())
