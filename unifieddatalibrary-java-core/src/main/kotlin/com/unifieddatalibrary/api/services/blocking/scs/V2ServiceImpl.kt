...
class V2ServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : V2Service {

    private val withRawResponse: V2Service.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): V2Service.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): V2Service = V2ServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): V2Service.WithRawResponse = V2ServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: V2ListParams, requestOptions: RequestOptions): HttpResponseFor<V2ListPage> {
          val request = HttpRequest.builder()
        ...
        override fun fileUpload(params: V2FileUploadParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun folderCreate(params: V2FolderCreateParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
