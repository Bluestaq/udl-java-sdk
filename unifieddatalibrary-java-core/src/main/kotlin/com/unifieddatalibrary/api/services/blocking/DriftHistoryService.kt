...
interface DriftHistoryService {
     ...
     * parameter. DriftHistory represents historical drift rates for GEO Onorbit objects resulting
     * from updates to OnorbitDetails driftRate values.
     */
    fun retrieve(id: String): DriftHistoryFull = retrieve(id, DriftHistoryRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: DriftHistoryRetrieveParams = DriftHistoryRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): DriftHistoryFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: DriftHistoryRetrieveParams = DriftHistoryRetrieveParams.none(),
    ): DriftHistoryFull = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(id: String, requestOptions: RequestOptions): DriftHistoryFull =
        retrieve(id, DriftHistoryRetrieveParams.none(), requestOptions)
    ...
    /** @see list */
    fun list(
        params: DriftHistoryListParams = DriftHistoryListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun list(requestOptions: RequestOptions): DriftHistoryListPage =
        list(DriftHistoryListParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: DriftHistoryCountParams = DriftHistoryCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): String
    ...
    fun count(requestOptions: RequestOptions): String =
        count(DriftHistoryCountParams.none(), requestOptions)
    ...
    /** @see queryhelp */
    fun queryhelp(
        params: DriftHistoryQueryhelpParams = DriftHistoryQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: DriftHistoryQueryhelpParams = DriftHistoryQueryhelpParams.none()
    ): DriftHistoryQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): DriftHistoryQueryhelpResponse =
        queryhelp(DriftHistoryQueryhelpParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/drifthistory/{id}`, but is otherwise the same
         * as [DriftHistoryService.retrieve].
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<DriftHistoryFull> =
            retrieve(id, DriftHistoryRetrieveParams.none())
        ...
        fun retrieve(
            id: String,
            params: DriftHistoryRetrieveParams = DriftHistoryRetrieveParams.none(),
        ): HttpResponseFor<DriftHistoryFull> = retrieve(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/drifthistory`, but is otherwise the same as
         * [DriftHistoryService.list].
         */
        @MustBeClosed
        ...
        fun list(
            params: DriftHistoryListParams = DriftHistoryListParams.none()
        ): HttpResponseFor<DriftHistoryListPage> = list(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/drifthistory/count`, but is otherwise the same
         * as [DriftHistoryService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(DriftHistoryCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/drifthistory/queryhelp`, but is otherwise the
         * same as [DriftHistoryService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<DriftHistoryQueryhelpResponse> =
            queryhelp(DriftHistoryQueryhelpParams.none())
        ...
        fun queryhelp(
            params: DriftHistoryQueryhelpParams = DriftHistoryQueryhelpParams.none()
        ): HttpResponseFor<DriftHistoryQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/drifthistory/tuple`, but is otherwise the same
         * as [DriftHistoryService.tuple].
         */
        @MustBeClosed
