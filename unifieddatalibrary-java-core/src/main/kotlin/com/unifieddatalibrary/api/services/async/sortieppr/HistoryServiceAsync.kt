...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sortieppr/history`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sortieppr/history/aodr`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sortieppr/history/count`, but is otherwise the
