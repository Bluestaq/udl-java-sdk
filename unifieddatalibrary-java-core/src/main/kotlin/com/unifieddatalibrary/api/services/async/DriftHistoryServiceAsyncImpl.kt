...
class DriftHistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    DriftHistoryServiceAsync {

    private val withRawResponse: DriftHistoryServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): DriftHistoryServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DriftHistoryServiceAsync =
        DriftHistoryServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun retrieve(
        params: DriftHistoryRetrieveParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<DriftHistoryFull> =
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<DriftHistoryListPageAsync> =
    ...
    override fun queryhelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<DriftHistoryQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<DriftHistoryFull>> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            DriftHistoryServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun retrieve(
            params: DriftHistoryRetrieveParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<DriftHistoryFull>> {
        ...
        override fun list(
            params: DriftHistoryListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<DriftHistoryListPageAsync>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(
            params: DriftHistoryQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<DriftHistoryQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(
            params: DriftHistoryTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<DriftHistoryFull>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
