...
interface HistoryService {
    ...
    fun ador(params: HistoryAdorParams) =
        ador(
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/h3geo/history/aodr`, but is otherwise the same as [HistoryService.ador]. */
        @MustBeClosed
        fun ador(params: HistoryAdorParams): HttpResponse =
            ador(
              params, RequestOptions.none()
            )
        ...
        /** @see ador */
        @MustBeClosed
        fun ador(params: HistoryAdorParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `get /udl/h3geo/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/h3geo/history`, but is otherwise the same as [HistoryService.query]. */
        @MustBeClosed
