...
interface GnssObservationsetService {
     ...
     * information.
     */
    fun count(params: GnssObservationsetCountParams): String = count(params, RequestOptions.none())
     ...
     */
    fun queryhelp(): GnssObservationsetQueryhelpResponse =
    ...
    fun queryhelp(
        params: GnssObservationsetQueryhelpParams = GnssObservationsetQueryhelpParams.none()
    ): GnssObservationsetQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [GnssObservationsetService.list].
         */
        @MustBeClosed
        fun list(
            params: GnssObservationsetListParams
        ): HttpResponseFor<GnssObservationsetListPage> = list(params, RequestOptions.none())
         ...
         * otherwise the same as [GnssObservationsetService.createBulk].
         */
        @MustBeClosed
         ...
         * the same as [GnssObservationsetService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<GnssObservationsetQueryhelpResponse> =
            queryhelp(GnssObservationsetQueryhelpParams.none())
        ...
        fun queryhelp(
            params: GnssObservationsetQueryhelpParams = GnssObservationsetQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<GnssObservationsetQueryhelpResponse>
         ...
         * same as [GnssObservationsetService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: GnssObservationsetTupleParams
        ): HttpResponseFor<List<GnssObservationSetFull>> = tuple(params, RequestOptions.none())
        ...
        fun tuple(
            params: GnssObservationsetTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<GnssObservationSetFull>>

        /**
         * Returns a raw HTTP response for `post /filedrop/udl-gnssobset`, but is otherwise the same
         * as [GnssObservationsetService.unvalidatedPublish].
         */
        @MustBeClosed
