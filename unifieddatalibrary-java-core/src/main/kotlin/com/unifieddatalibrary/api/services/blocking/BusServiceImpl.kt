...
class BusServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BusService {

    private val withRawResponse: BusService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BusService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BusService = BusServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryHelp(params: BusQueryHelpParams, requestOptions: RequestOptions): BusQueryHelpResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BusService.WithRawResponse = BusServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun retrieve(params: BusRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<BusFull> {
        ...
        override fun list(params: BusListParams, requestOptions: RequestOptions): HttpResponseFor<BusListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "bus")
        ...
        override fun count(params: BusCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: BusQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<BusQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: BusTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<BusFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
