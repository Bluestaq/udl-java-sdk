...
import com.unifieddatalibrary.api.models.sitestatus.history.HistoryListPageAsync
...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun count(
        ...
        // get /udl/sitestatus/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "sitestatus", "history")
                    .build()
        ...
        override fun count(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "sitestatus", "history", "count")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
