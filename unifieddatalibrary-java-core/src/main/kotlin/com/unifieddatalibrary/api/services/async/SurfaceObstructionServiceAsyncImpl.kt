...
internal constructor(private val clientOptions: ClientOptions) : SurfaceObstructionServiceAsync {
    ...
    private val withRawResponse: SurfaceObstructionServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        SurfaceObstructionServiceAsyncImpl(
    ...
    override fun list(
        params: SurfaceObstructionListParams,
        requestOptions: RequestOptions,
    ...
    override fun count(
        params: SurfaceObstructionCountParams,
        requestOptions: RequestOptions,
    ...
    override fun queryhelp(
        params: SurfaceObstructionQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SurfaceObstructionServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
        ...
        private val listHandler: Handler<List<SurfaceObstructionListResponse>> =
            jsonHandler<List<SurfaceObstructionListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<SurfaceObstructionGetResponse> =
            jsonHandler<SurfaceObstructionGetResponse>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<SurfaceObstructionQueryhelpResponse> =
            jsonHandler<SurfaceObstructionQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<SurfaceObstructionTupleResponse>> =
            jsonHandler<List<SurfaceObstructionTupleResponse>>(clientOptions.jsonMapper)
