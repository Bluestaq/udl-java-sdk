...
interface SgiService {
     ...
     * assistance.
     */
    fun create(params: SgiCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: SgiUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, SgiDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: SgiDeleteParams) = delete(params, RequestOptions.none())
    ...
    /** @see count */
    fun count(requestOptions: RequestOptions): String = count(SgiCountParams.none(), requestOptions)
     ...
     */
    fun createBulk(params: SgiCreateBulkParams) = createBulk(params, RequestOptions.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SgiGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: SgiGetParams): SgiGetResponse = get(params, RequestOptions.none())
    ...
    fun getDataByEffectiveAsOfDate(): SgiGetDataByEffectiveAsOfDateResponse =
     ...
     */
    fun tuple(params: SgiTupleParams): List<SgiTupleResponse> = tuple(params, RequestOptions.none())

    /** @see tuple */
    fun tuple(
        params: SgiTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): List<SgiTupleResponse>
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: SgiCreateParams): HttpResponse = create(params, RequestOptions.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: SgiUpdateParams): HttpResponse = update(params, RequestOptions.none())
         ...
         * [SgiService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<SgiListPage> = list(SgiListParams.none())
         ...
         * [SgiService.delete].
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, SgiDeleteParams.none())
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: SgiDeleteParams): HttpResponse = delete(params, RequestOptions.none())
         ...
         * [SgiService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(SgiCountParams.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<SgiGetResponse> = get(id, SgiGetParams.none())
        ...
        fun get(
            ...
            params: SgiGetParams = SgiGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<SgiGetResponse> = get(params.toBuilder().id(id).build(), requestOptions)
        ...
        fun get(
            id: String,
            params: SgiGetParams = SgiGetParams.none(),
        ): HttpResponseFor<SgiGetResponse> = get(id, params, RequestOptions.none())
        ...
        fun get(
            params: SgiGetParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<SgiGetResponse>
         ...
         * otherwise the same as [SgiService.getDataByEffectiveAsOfDate].
         */
        @MustBeClosed
        fun getDataByEffectiveAsOfDate(): HttpResponseFor<SgiGetDataByEffectiveAsOfDateResponse> =
            getDataByEffectiveAsOfDate(SgiGetDataByEffectiveAsOfDateParams.none())
        ...
        fun getDataByEffectiveAsOfDate(
            ...
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<SgiGetDataByEffectiveAsOfDateResponse>
         ...
         * [SgiService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SgiQueryhelpResponse> =
        ...
        fun queryhelp(
            params: SgiQueryhelpParams = SgiQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<SgiQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: SgiQueryhelpParams = SgiQueryhelpParams.none()
        ): HttpResponseFor<SgiQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: SgiTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<SgiTupleResponse>>
