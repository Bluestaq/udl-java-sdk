...
class CommServiceImpl internal constructor(private val clientOptions: ClientOptions) : CommService {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CommService =
        CommServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            CommServiceImpl.WithRawResponseImpl(
