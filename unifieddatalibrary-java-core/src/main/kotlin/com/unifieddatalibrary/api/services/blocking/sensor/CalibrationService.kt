...
interface CalibrationService {
     ...
     */
    fun create(params: CalibrationCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CalibrationRetrieveResponse = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: CalibrationRetrieveParams = CalibrationRetrieveParams.none(),
    ): CalibrationRetrieveResponse = retrieve(id, params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: CalibrationCountParams): String = count(params, RequestOptions.none())
     ...
     * mechanism.
     */
    fun createBulk(params: CalibrationCreateBulkParams) = createBulk(params, RequestOptions.none())
    ...
    fun queryHelp(
        params: CalibrationQueryHelpParams = CalibrationQueryHelpParams.none()
    ): CalibrationQueryHelpResponse = queryHelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [CalibrationService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            params: CalibrationRetrieveParams
        ): HttpResponseFor<CalibrationRetrieveResponse> = retrieve(params, RequestOptions.none())
         ...
         * otherwise the same as [CalibrationService.createBulk].
         */
        @MustBeClosed
         ...
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<CalibrationQueryHelpResponse> =
        ...
        fun queryHelp(
            params: CalibrationQueryHelpParams = CalibrationQueryHelpParams.none()
        ): HttpResponseFor<CalibrationQueryHelpResponse> = queryHelp(params, RequestOptions.none())
         ...
         * same as [CalibrationService.tuple].
         */
        @MustBeClosed
         ...
         * the same as [CalibrationService.unvalidatedPublish].
         */
        @MustBeClosed
