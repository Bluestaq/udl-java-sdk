...
class FeatureAssessmentServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : FeatureAssessmentServiceAsync {

    private val withRawResponse: FeatureAssessmentServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        FeatureAssessmentServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            FeatureAssessmentServiceAsyncImpl.WithRawResponseImpl(
