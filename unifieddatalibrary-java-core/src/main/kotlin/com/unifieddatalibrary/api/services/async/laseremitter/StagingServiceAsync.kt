...
interface StagingServiceAsync {
    ...
    interface WithRawResponse {
         ...
         * same as [StagingServiceAsync.create].
         */
         ...
         * the same as [StagingServiceAsync.delete].
         */
         ...
         * otherwise the same as [StagingServiceAsync.createBulk].
         */
         ...
         * otherwise the same as [StagingServiceAsync.queryhelp].
         */
