...
interface GroundImageryServiceAsync {
    ...
    fun get(
        id: String,
        params: GroundImageryGetParams = GroundImageryGetParams.none(),
    ): CompletableFuture<GroundImageryGetResponse> = get(id, params, RequestOptions.none())
    ...
    fun getFile(id: String): CompletableFuture<HttpResponse> =
        getFile(id, GroundImageryGetFileParams.none())
     ...
     */
    fun queryhelp(): CompletableFuture<GroundImageryQueryhelpResponse> =
    ...
    fun queryhelp(
        params: GroundImageryQueryhelpParams = GroundImageryQueryhelpParams.none()
    ): CompletableFuture<GroundImageryQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    ): CompletableFuture<List<GroundImageryTupleResponse>> = tuple(params, RequestOptions.none())
    ...
    /**
     * A view of [GroundImageryServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [GroundImageryServiceAsync.get].
         */
         ...
         * the same as [GroundImageryServiceAsync.getFile].
         */
        fun getFile(id: String): CompletableFuture<HttpResponse> =
            getFile(id, GroundImageryGetFileParams.none())
         ...
         * same as [GroundImageryServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<GroundImageryQueryhelpResponse>> =
            queryhelp(GroundImageryQueryhelpParams.none())
         ...
         * as [GroundImageryServiceAsync.tuple].
         */
        fun tuple(
            params: GroundImageryTupleParams
         ...
         * same as [GroundImageryServiceAsync.uploadZip].
         */
