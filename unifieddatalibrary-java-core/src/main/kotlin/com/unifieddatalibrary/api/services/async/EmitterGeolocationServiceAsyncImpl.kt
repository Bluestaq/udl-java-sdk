...
internal constructor(private val clientOptions: ClientOptions) : EmitterGeolocationServiceAsync {
    ...
    private val withRawResponse: EmitterGeolocationServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        EmitterGeolocationServiceAsyncImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EmitterGeolocationServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
