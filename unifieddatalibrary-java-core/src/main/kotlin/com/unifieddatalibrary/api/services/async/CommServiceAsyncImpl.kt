...
class CommServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: CommServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): CommServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CommServiceAsync =
        CommServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            CommServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val retrieveHandler: Handler<CommFull> =
            jsonHandler<CommFull>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<List<CommAbridged>> =
            jsonHandler<List<CommAbridged>>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<CommQueryhelpResponse> =
            jsonHandler<CommQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<CommFull>> =
            jsonHandler<List<CommFull>>(clientOptions.jsonMapper)
