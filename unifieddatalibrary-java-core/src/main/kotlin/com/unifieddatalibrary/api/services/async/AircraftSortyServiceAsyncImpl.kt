...
class AircraftSortyServiceAsyncImpl internal constructor(
    ...
    override fun retrieve(params: AircraftSortyRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AircraftsortieFull> =
        // get /udl/aircraftsortie/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: AircraftSortyUpdateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // put /udl/aircraftsortie/{id}
        withRawResponse().update(params, requestOptions).thenAccept {}

    override fun queryhelp(params: AircraftSortyQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<AircraftSortyQueryhelpResponse> =
        // get /udl/aircraftsortie/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: AircraftSortyTupleParams, requestOptions: RequestOptions): CompletableFuture<List<AircraftsortieFull>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: AircraftSortyRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AircraftsortieFull>> {
        ...
        override fun update(params: AircraftSortyUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun queryhelp(params: AircraftSortyQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AircraftSortyQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: AircraftSortyTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<AircraftsortieFull>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
