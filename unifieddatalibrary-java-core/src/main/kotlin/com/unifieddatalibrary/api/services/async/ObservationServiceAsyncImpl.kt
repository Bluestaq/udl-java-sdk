...
class ObservationServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ObservationServiceAsync {

    private val withRawResponse: ObservationServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val ecpsdr: EcpsdrServiceAsync by lazy { EcpsdrServiceAsyncImpl(clientOptions) }

    private val monoradar: MonoradarServiceAsync by lazy { MonoradarServiceAsyncImpl(clientOptions) }

    private val swir: SwirServiceAsync by lazy { SwirServiceAsyncImpl(clientOptions) }

    private val radarobservation: RadarobservationServiceAsync by lazy { RadarobservationServiceAsyncImpl(clientOptions) }

    private val rfObservation: RfObservationServiceAsync by lazy { RfObservationServiceAsyncImpl(clientOptions) }

    private val passiveRadarObservation: PassiveRadarObservationServiceAsync by lazy { PassiveRadarObservationServiceAsyncImpl(clientOptions) }

    private val eoObservations: EoObservationServiceAsync by lazy { EoObservationServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): ObservationServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ObservationServiceAsync = ObservationServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun passiveRadarObservation(): PassiveRadarObservationServiceAsync = passiveRadarObservation
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val monoradar: MonoradarServiceAsync.WithRawResponse by lazy { MonoradarServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val swir: SwirServiceAsync.WithRawResponse by lazy { SwirServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val radarobservation: RadarobservationServiceAsync.WithRawResponse by lazy { RadarobservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val rfObservation: RfObservationServiceAsync.WithRawResponse by lazy { RfObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val passiveRadarObservation: PassiveRadarObservationServiceAsync.WithRawResponse by lazy { PassiveRadarObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val eoObservations: EoObservationServiceAsync.WithRawResponse by lazy { EoObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ObservationServiceAsync.WithRawResponse = ObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun radarobservation(): RadarobservationServiceAsync.WithRawResponse = radarobservation

        override fun rfObservation(): RfObservationServiceAsync.WithRawResponse = rfObservation

        override fun passiveRadarObservation(): PassiveRadarObservationServiceAsync.WithRawResponse = passiveRadarObservation
