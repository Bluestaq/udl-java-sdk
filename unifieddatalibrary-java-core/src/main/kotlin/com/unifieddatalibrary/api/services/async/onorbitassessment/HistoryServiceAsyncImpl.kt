...
package com.unifieddatalibrary.api.services.async.onorbitassessment
...
import com.unifieddatalibrary.api.models.onorbitassessment.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.onorbitassessment.history.HistoryCountParams
import com.unifieddatalibrary.api.models.onorbitassessment.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.onorbitassessment.history.HistoryListParams
import com.unifieddatalibrary.api.models.onorbitassessment.history.HistoryListResponse
...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(
        ...
        // get /udl/onorbitassessment/history
    ...
    override fun aodr(
        ...
        // get /udl/onorbitassessment/history/aodr
    ...
    override fun count(
        ...
        // get /udl/onorbitassessment/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "onorbitassessment", "history")
                    .build()
        ...
        override fun aodr(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "onorbitassessment", "history", "aodr")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
        ...
        override fun count(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "onorbitassessment", "history", "count")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
