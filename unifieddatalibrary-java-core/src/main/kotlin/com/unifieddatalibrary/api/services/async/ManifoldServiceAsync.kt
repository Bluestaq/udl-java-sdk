...
interface ManifoldServiceAsync {
    ...
    /** @see create */
    fun create(
        params: ManifoldCreateParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?>

    /**
     * Service operation to update a single Manifold. A manifold represents a set of
     * possible/theoretical orbits for an object of interest based on a delta V and delta T. A
    ...
    /** @see list */
    fun list(
        params: ManifoldListParams = ManifoldListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<ManifoldListPageAsync>

    /** @see list */
    fun list(
        params: ManifoldListParams = ManifoldListParams.none()
    ): CompletableFuture<ManifoldListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<ManifoldListPageAsync> =
        list(ManifoldListParams.none(), requestOptions)

    /**
     * Service operation to delete a Manifold object specified by the passed ID path parameter. A
     * manifold represents a set of possible/theoretical orbits for an object of interest based on a
     * delta V and delta T. A specific role is required to perform this service operation. Please
     * contact the UDL team for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, ManifoldDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: ManifoldDeleteParams = ManifoldDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun delete(id: String, requestOptions: RequestOptions): CompletableFuture<Void?> =
        delete(id, ManifoldDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: ManifoldCountParams = ManifoldCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun count(requestOptions: RequestOptions): CompletableFuture<String> =
        count(ManifoldCountParams.none(), requestOptions)

    /**
     * Service operation to take multiple Manifolds as a POST body and ingest into the database. A
     * specific role is required to perform this service operation. Please contact the UDL team for
     * assistance.
     */
    ...
    /** @see createBulk */
    fun createBulk(body: List<ManifoldCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun get(id: String): CompletableFuture<ManifoldGetResponse> = get(id, ManifoldGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: ManifoldGetParams = ManifoldGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<ManifoldGetResponse> =
    ...
    fun get(
        id: String,
        params: ManifoldGetParams = ManifoldGetParams.none(),
    ): CompletableFuture<ManifoldGetResponse> = get(id, params, RequestOptions.none())

    /** @see get */
    fun get(
        params: ManifoldGetParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<ManifoldGetResponse>
    ...
    fun get(id: String, requestOptions: RequestOptions): CompletableFuture<ManifoldGetResponse> =
        get(id, ManifoldGetParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<ManifoldQueryhelpResponse> =
        queryhelp(ManifoldQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: ManifoldQueryhelpParams = ManifoldQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<ManifoldQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: ManifoldQueryhelpParams = ManifoldQueryhelpParams.none()
    ): CompletableFuture<ManifoldQueryhelpResponse> = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): CompletableFuture<ManifoldQueryhelpResponse> =
        queryhelp(ManifoldQueryhelpParams.none(), requestOptions)
    ...
    /** @see tuple */
    fun tuple(
        params: ManifoldTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<ManifoldTupleResponse>>
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/manifold`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `put /udl/manifold/{id}`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/manifold`, but is otherwise the same as
         * [ManifoldServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<ManifoldListPageAsync>> =
            list(ManifoldListParams.none())

        /** @see list */
        fun list(
            params: ManifoldListParams = ManifoldListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<ManifoldListPageAsync>>
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/manifold/{id}`, but is otherwise the same as
         * [ManifoldServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, ManifoldDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/manifold/count`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `post /udl/manifold/createBulk`, but is otherwise the
         * same as [ManifoldServiceAsync.createBulk].
         */
        ...
        /** @see createBulk */
        fun createBulk(body: List<ManifoldCreateBulkParams.Body>): CompletableFuture<HttpResponse> =
            createBulk(body, RequestOptions.none())
        ...
        fun get(
            ...
            params: ManifoldGetParams = ManifoldGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<ManifoldGetResponse>> =
            get(params.toBuilder().id(id).build(), requestOptions)
        ...
        /**
         * Returns a raw HTTP response for `get /udl/manifold/queryhelp`, but is otherwise the same
         * as [ManifoldServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<ManifoldQueryhelpResponse>> =
            queryhelp(ManifoldQueryhelpParams.none())
        ...
        fun queryhelp(
            params: ManifoldQueryhelpParams = ManifoldQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<ManifoldQueryhelpResponse>>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/manifold/tuple`, but is otherwise the same as
         * [ManifoldServiceAsync.tuple].
         */
        fun tuple(
            params: ManifoldTupleParams
        ): CompletableFuture<HttpResponseFor<List<ManifoldTupleResponse>>> =
            tuple(params, RequestOptions.none())
