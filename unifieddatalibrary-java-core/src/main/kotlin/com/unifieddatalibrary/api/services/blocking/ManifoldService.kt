...
interface ManifoldService {
     ...
     */
    fun create(params: ManifoldCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: ManifoldUpdateParams) = update(params, RequestOptions.none())
     ...
     * contact the UDL team for assistance.
     */
    fun delete(id: String) = delete(id, ManifoldDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: ManifoldDeleteParams) = delete(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun createBulk(params: ManifoldCreateBulkParams) = createBulk(params, RequestOptions.none())
     ...
     */
    fun get(id: String): ManifoldGetResponse = get(id, ManifoldGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): ManifoldGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: ManifoldGetParams): ManifoldGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: ManifoldQueryhelpParams = ManifoldQueryhelpParams.none()
    ): ManifoldQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: ManifoldListParams = ManifoldListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<ManifoldListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: ManifoldListParams = ManifoldListParams.none()
        ): HttpResponseFor<ManifoldListPage> = list(params, RequestOptions.none())
         ...
         * [ManifoldService.delete].
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, ManifoldDeleteParams.none())
         ...
         * [ManifoldService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(ManifoldCountParams.none())
         ...
         * same as [ManifoldService.createBulk].
         */
        @MustBeClosed
        ...
        fun get(
            ...
            params: ManifoldGetParams = ManifoldGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<ManifoldGetResponse> =
        ...
        fun get(
            id: String,
            params: ManifoldGetParams = ManifoldGetParams.none(),
        ): HttpResponseFor<ManifoldGetResponse> = get(id, params, RequestOptions.none())
         ...
         * as [ManifoldService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<ManifoldQueryhelpResponse> =
        ...
        fun queryhelp(
            params: ManifoldQueryhelpParams = ManifoldQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<ManifoldQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: ManifoldQueryhelpParams = ManifoldQueryhelpParams.none()
        ): HttpResponseFor<ManifoldQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: ManifoldTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<ManifoldTupleResponse>>
    }
}
