...
class PassiveRadarObservationServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PassiveRadarObservationServiceAsync {

    private val withRawResponse: PassiveRadarObservationServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): PassiveRadarObservationServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PassiveRadarObservationServiceAsync = PassiveRadarObservationServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryServiceAsync = history

    override fun create(params: PassiveRadarObservationCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/passiveradarobservation
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun list(params: PassiveRadarObservationListParams, requestOptions: RequestOptions): CompletableFuture<PassiveRadarObservationListPageAsync> =
        // get /udl/passiveradarobservation
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: PassiveRadarObservationCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/passiveradarobservation/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: PassiveRadarObservationCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/passiveradarobservation/createBulk
        withRawResponse().createBulk(params, requestOptions).thenAccept {}

    override fun fileCreate(params: PassiveRadarObservationFileCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /filedrop/udl-passiveradar
        withRawResponse().fileCreate(params, requestOptions).thenAccept {}

    override fun get(params: PassiveRadarObservationGetParams, requestOptions: RequestOptions): CompletableFuture<PassiveRadarObservationGetResponse> =
        // get /udl/passiveradarobservation/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: PassiveRadarObservationQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<PassiveRadarObservationQueryhelpResponse> =
        // get /udl/passiveradarobservation/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: PassiveRadarObservationTupleParams, requestOptions: RequestOptions): CompletableFuture<List<PassiveRadarObservationTupleResponse>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PassiveRadarObservationServiceAsync.WithRawResponse = PassiveRadarObservationServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryServiceAsync.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: PassiveRadarObservationCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: PassiveRadarObservationListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PassiveRadarObservationListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: PassiveRadarObservationCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: PassiveRadarObservationCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun fileCreate(params: PassiveRadarObservationFileCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: PassiveRadarObservationGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PassiveRadarObservationGetResponse>> {
        ...
        override fun queryhelp(params: PassiveRadarObservationQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PassiveRadarObservationQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: PassiveRadarObservationTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<PassiveRadarObservationTupleResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
