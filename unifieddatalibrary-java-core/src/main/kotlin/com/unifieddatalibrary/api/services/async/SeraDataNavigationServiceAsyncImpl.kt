...
internal constructor(private val clientOptions: ClientOptions) : SeraDataNavigationServiceAsync {
    ...
    private val withRawResponse: SeraDataNavigationServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        SeraDataNavigationServiceAsyncImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SeraDataNavigationServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
