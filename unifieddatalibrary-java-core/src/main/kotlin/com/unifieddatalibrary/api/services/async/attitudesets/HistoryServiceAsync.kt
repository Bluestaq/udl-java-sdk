...
package com.unifieddatalibrary.api.services.async.attitudesets
...
import com.unifieddatalibrary.api.models.attitudesets.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/attitudeset/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/attitudeset/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/attitudeset/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
