...
interface V2Service {
    ...
    fun update(params: V2UpdateParams) =
        update(
    ...
    fun list(params: V2ListParams): V2ListPage =
        list(
          params, RequestOptions.none()
        )

    /** @see list */
    fun list(params: V2ListParams, requestOptions: RequestOptions = RequestOptions.none()): V2ListPage
    ...
    fun delete(params: V2DeleteParams) =
        delete(
          params, RequestOptions.none()
        )
    ...
    /** @see fileUpload */
    fun fileUpload(fileContent: String, params: V2FileUploadParams, requestOptions: RequestOptions = RequestOptions.none()) =
        fileUpload(
          params.toBuilder()
    ...
    /** @see fileUpload */
    fun fileUpload(params: V2FileUploadParams) =
        fileUpload(
          params, RequestOptions.none()
        )

    /** @see fileUpload */
    fun fileUpload(params: V2FileUploadParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    fun folderCreate(params: V2FolderCreateParams) =
        folderCreate(
          params, RequestOptions.none()
        )

    /** @see folderCreate */
    fun folderCreate(params: V2FolderCreateParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `patch /scs/v2/update`, but is otherwise the same as [V2Service.update]. */
        @MustBeClosed
        fun update(params: V2UpdateParams): HttpResponse =
            update(
              params, RequestOptions.none()
            )
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: V2UpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `get /scs/v2/list`, but is otherwise the same as [V2Service.list]. */
        @MustBeClosed
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: V2ListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<V2ListPage>

        /** Returns a raw HTTP response for `delete /scs/v2/delete`, but is otherwise the same as [V2Service.delete]. */
        @MustBeClosed
        fun delete(params: V2DeleteParams): HttpResponse =
            delete(
              params, RequestOptions.none()
            )
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: V2DeleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `post /scs/v2/copy`, but is otherwise the same as [V2Service.copy]. */
        @MustBeClosed
        fun copy(params: V2CopyParams): HttpResponse =
            copy(
              params, RequestOptions.none()
            )
        ...
        /** @see copy */
        @MustBeClosed
        fun copy(params: V2CopyParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `post /scs/v2/file`, but is otherwise the same as [V2Service.fileUpload]. */
        @MustBeClosed
        ...
        /** @see fileUpload */
        @MustBeClosed
        fun fileUpload(fileContent: String, params: V2FileUploadParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse =
            fileUpload(
              params.toBuilder()
                  .fileContent(fileContent)
                  .build(), requestOptions
        ...
        /** @see fileUpload */
        @MustBeClosed
        fun fileUpload(params: V2FileUploadParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `post /scs/v2/folder`, but is otherwise the same as [V2Service.folderCreate]. */
        @MustBeClosed
        ...
        /** @see folderCreate */
        @MustBeClosed
        fun folderCreate(params: V2FolderCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `put /scs/v2/move`, but is otherwise the same as [V2Service.move]. */
        @MustBeClosed
        fun move(params: V2MoveParams): HttpResponse =
            move(
              params, RequestOptions.none()
            )
        ...
        /** @see move */
        @MustBeClosed
        fun move(params: V2MoveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
