...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/gnssobservationset/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/gnssobservationset/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
