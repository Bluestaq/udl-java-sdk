...
class DiffOfArrivalServiceImpl internal constructor(
    ...
    override fun retrieve(params: DiffOfArrivalRetrieveParams, requestOptions: RequestOptions): DiffofarrivalFull =
        // get /udl/diffofarrival/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun queryhelp(params: DiffOfArrivalQueryhelpParams, requestOptions: RequestOptions): DiffOfArrivalQueryhelpResponse =
        // get /udl/diffofarrival/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: DiffOfArrivalTupleParams, requestOptions: RequestOptions): List<DiffofarrivalFull> =
        // get /udl/diffofarrival/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: DiffOfArrivalUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val retrieveHandler: Handler<DiffofarrivalFull> = jsonHandler<DiffofarrivalFull>(clientOptions.jsonMapper)

        override fun retrieve(params: DiffOfArrivalRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<DiffofarrivalFull> {
        ...
        private val queryhelpHandler: Handler<DiffOfArrivalQueryhelpResponse> = jsonHandler<DiffOfArrivalQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(params: DiffOfArrivalQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<DiffOfArrivalQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<DiffofarrivalFull>> = jsonHandler<List<DiffofarrivalFull>>(clientOptions.jsonMapper)

        override fun tuple(params: DiffOfArrivalTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<DiffofarrivalFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: DiffOfArrivalUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
