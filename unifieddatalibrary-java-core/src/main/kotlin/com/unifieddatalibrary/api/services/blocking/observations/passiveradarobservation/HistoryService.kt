...
package com.unifieddatalibrary.api.services.blocking.observations.passiveradarobservation
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/passiveradarobservation/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/passiveradarobservation/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/passiveradarobservation/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
