...
interface V2ServiceAsync {
    ...
    /** @see update */
    fun update(params: V2UpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see list */
    fun list(params: V2ListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<V2ListPageAsync>
    ...
    /** @see delete */
    fun delete(params: V2DeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    fun copy(params: V2CopyParams): CompletableFuture<Void?> =
        copy(
          params, RequestOptions.none()
        )

    /** @see copy */
    fun copy(params: V2CopyParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see fileUpload */
    fun fileUpload(fileContent: String, params: V2FileUploadParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?> =
        fileUpload(
          params.toBuilder()
    ...
    /** @see fileUpload */
    fun fileUpload(params: V2FileUploadParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see folderCreate */
    fun folderCreate(params: V2FolderCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    fun move(params: V2MoveParams): CompletableFuture<Void?> =
        move(
          params, RequestOptions.none()
        )

    /** @see move */
    fun move(params: V2MoveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `patch /scs/v2/update`, but is otherwise the same as [V2ServiceAsync.update]. */
        ...
        /** @see update */
        fun update(params: V2UpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `get /scs/v2/list`, but is otherwise the same as [V2ServiceAsync.list]. */
        ...
        /** @see list */
        fun list(params: V2ListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<V2ListPageAsync>>

        /** Returns a raw HTTP response for `delete /scs/v2/delete`, but is otherwise the same as [V2ServiceAsync.delete]. */
        ...
        /** @see delete */
        fun delete(params: V2DeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /scs/v2/copy`, but is otherwise the same as [V2ServiceAsync.copy]. */
        ...
        /** @see copy */
        fun copy(params: V2CopyParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /scs/v2/file`, but is otherwise the same as [V2ServiceAsync.fileUpload]. */
        fun fileUpload(fileContent: String, params: V2FileUploadParams): CompletableFuture<HttpResponse> =
            fileUpload(
              fileContent,
              params,
              RequestOptions.none(),
        ...
        /** @see fileUpload */
        fun fileUpload(fileContent: String, params: V2FileUploadParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse> =
            fileUpload(
              params.toBuilder()
                  .fileContent(fileContent)
                  .build(), requestOptions
        ...
        /** @see fileUpload */
        fun fileUpload(params: V2FileUploadParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /scs/v2/folder`, but is otherwise the same as [V2ServiceAsync.folderCreate]. */
        ...
        /** @see folderCreate */
        fun folderCreate(params: V2FolderCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `put /scs/v2/move`, but is otherwise the same as [V2ServiceAsync.move]. */
        ...
        /** @see move */
        fun move(params: V2MoveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
