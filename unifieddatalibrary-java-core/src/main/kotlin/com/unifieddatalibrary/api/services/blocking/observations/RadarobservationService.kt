...
interface RadarobservationService {
     ...
     */
    fun create(params: RadarobservationCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun count(params: RadarobservationCountParams): String = count(params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<RadarobservationCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) = createBulk(RadarobservationCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<RadarobservationCreateBulkParams.Body>) =
     ...
     * parameter.
     */
    fun get(id: String): RadarobservationGetResponse = get(id, RadarobservationGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): RadarobservationGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: RadarobservationGetParams = RadarobservationGetParams.none(),
    ): RadarobservationGetResponse = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): RadarobservationQueryhelpResponse =
    ...
    fun queryhelp(
        params: RadarobservationQueryhelpParams = RadarobservationQueryhelpParams.none()
    ): RadarobservationQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<RadarobservationUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            RadarobservationUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<RadarobservationUnvalidatedPublishParams.Body>) =
        unvalidatedPublish(body, RequestOptions.none())

    /**
     * A view of [RadarobservationService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [RadarobservationService.create].
         */
        @MustBeClosed
         ...
         * same as [RadarobservationService.count].
         */
        @MustBeClosed
         ...
         * the same as [RadarobservationService.createBulk].
         */
        @MustBeClosed
        ...
        fun createBulk(
            ...
            createBulk(
                RadarobservationCreateBulkParams.builder().body(body).build(),
                requestOptions,
            )

        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<RadarobservationCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/radarobservation/{id}`, but is otherwise the
         * same as [RadarobservationService.get].
         */
        @MustBeClosed
        ...
        fun get(
            id: String,
            params: RadarobservationGetParams = RadarobservationGetParams.none(),
        ): HttpResponseFor<RadarobservationGetResponse> = get(id, params, RequestOptions.none())
         ...
         * the same as [RadarobservationService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<RadarobservationQueryhelpResponse> =
            queryhelp(RadarobservationQueryhelpParams.none())
         ...
         * same as [RadarobservationService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: RadarobservationTupleParams
         ...
         * [RadarobservationService.unvalidatedPublish].
         */
        @MustBeClosed
