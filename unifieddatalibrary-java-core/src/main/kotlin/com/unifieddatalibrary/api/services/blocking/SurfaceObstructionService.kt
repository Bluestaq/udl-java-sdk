...
interface SurfaceObstructionService {
     ...
     */
    fun create(params: SurfaceObstructionCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: SurfaceObstructionUpdateParams) = update(params, RequestOptions.none())
    ...
    fun list(
        params: SurfaceObstructionListParams = SurfaceObstructionListParams.none()
    ): SurfaceObstructionListPage = list(params, RequestOptions.none())
     ...
     */
    fun delete(id: String) = delete(id, SurfaceObstructionDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: SurfaceObstructionDeleteParams) = delete(params, RequestOptions.none())
     ...
     * parameter.
     */
    fun get(id: String): SurfaceObstructionGetResponse = get(id, SurfaceObstructionGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SurfaceObstructionGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: SurfaceObstructionGetParams = SurfaceObstructionGetParams.none(),
    ): SurfaceObstructionGetResponse = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): SurfaceObstructionQueryhelpResponse =
    ...
    fun queryhelp(
        params: SurfaceObstructionQueryhelpParams = SurfaceObstructionQueryhelpParams.none()
    ): SurfaceObstructionQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): List<SurfaceObstructionTupleResponse>
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<SurfaceObstructionUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            SurfaceObstructionUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<SurfaceObstructionUnvalidatedPublishParams.Body>) =
        unvalidatedPublish(body, RequestOptions.none())

    /**
     * A view of [SurfaceObstructionService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [SurfaceObstructionService.create].
         */
        @MustBeClosed
         ...
         * same as [SurfaceObstructionService.update].
         */
        @MustBeClosed
         ...
         * as [SurfaceObstructionService.list].
         */
        @MustBeClosed
        fun list(): HttpResponseFor<SurfaceObstructionListPage> =
        ...
        fun list(
            params: SurfaceObstructionListParams = SurfaceObstructionListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<SurfaceObstructionListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: SurfaceObstructionListParams = SurfaceObstructionListParams.none()
        ): HttpResponseFor<SurfaceObstructionListPage> = list(params, RequestOptions.none())
         ...
         * the same as [SurfaceObstructionService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, SurfaceObstructionDeleteParams.none())
         ...
         * same as [SurfaceObstructionService.count].
         */
        @MustBeClosed
         ...
         * same as [SurfaceObstructionService.get].
         */
        @MustBeClosed
        ...
        fun get(
            ...
            params: SurfaceObstructionGetParams = SurfaceObstructionGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<SurfaceObstructionGetResponse> =
        ...
        fun get(
            id: String,
            params: SurfaceObstructionGetParams = SurfaceObstructionGetParams.none(),
        ): HttpResponseFor<SurfaceObstructionGetResponse> = get(id, params, RequestOptions.none())
        ...
        fun get(
            params: SurfaceObstructionGetParams
        ): HttpResponseFor<SurfaceObstructionGetResponse> = get(params, RequestOptions.none())
         ...
         * the same as [SurfaceObstructionService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SurfaceObstructionQueryhelpResponse> =
            queryhelp(SurfaceObstructionQueryhelpParams.none())
        ...
        fun queryhelp(
            params: SurfaceObstructionQueryhelpParams = SurfaceObstructionQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<SurfaceObstructionQueryhelpResponse>
         ...
         * same as [SurfaceObstructionService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: SurfaceObstructionTupleParams
        ): HttpResponseFor<List<SurfaceObstructionTupleResponse>> =
            tuple(params, RequestOptions.none())
         ...
         * the same as [SurfaceObstructionService.unvalidatedPublish].
         */
        @MustBeClosed
