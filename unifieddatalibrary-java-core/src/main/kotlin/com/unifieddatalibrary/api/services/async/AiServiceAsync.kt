...
interface AiServiceAsync {
    ...
    fun queryhelp(
        params: AiQueryhelpParams = AiQueryhelpParams.none()
    ): CompletableFuture<AiQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [AiServiceAsync.historyCount].
         */
         ...
         * [AiServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<AiQueryhelpResponse>> =
            queryhelp(AiQueryhelpParams.none())
