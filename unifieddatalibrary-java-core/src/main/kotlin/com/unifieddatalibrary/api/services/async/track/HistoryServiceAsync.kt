...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/track/history`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/track/history/aodr`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/track/history/count`, but is otherwise the same
