...
package com.unifieddatalibrary.api.services.async.track
...
import com.unifieddatalibrary.api.models.track.history.HistoryCountParams
import com.unifieddatalibrary.api.models.track.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.track.history.HistoryListParams
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/track/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/track/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/track/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
