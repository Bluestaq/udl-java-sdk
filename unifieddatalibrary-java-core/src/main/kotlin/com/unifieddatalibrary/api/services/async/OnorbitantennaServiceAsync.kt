...
interface OnorbitantennaServiceAsync {
     ...
     */
    fun list(): CompletableFuture<OnorbitantennaListPageAsync> =
        list(OnorbitantennaListParams.none())
    ...
    fun list(
        params: OnorbitantennaListParams = OnorbitantennaListParams.none()
    ): CompletableFuture<OnorbitantennaListPageAsync> = list(params, RequestOptions.none())
     ...
     * contact the UDL team for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, OnorbitantennaDeleteParams.none())
    ...
    fun get(
        id: String,
        params: OnorbitantennaGetParams = OnorbitantennaGetParams.none(),
    ): CompletableFuture<OnorbitAntennaFull> = get(id, params, RequestOptions.none())
    ...
    /**
     * A view of [OnorbitantennaServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [OnorbitantennaServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: OnorbitantennaUpdateParams,
         ...
         * [OnorbitantennaServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<OnorbitantennaListPageAsync>> =
            list(OnorbitantennaListParams.none())
         ...
         * same as [OnorbitantennaServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, OnorbitantennaDeleteParams.none())
         ...
         * as [OnorbitantennaServiceAsync.get].
         */
