...
class SeradataSpacecraftDetailServiceImpl
internal constructor(private val clientOptions: ClientOptions) : SeradataSpacecraftDetailService {

    private val withRawResponse: SeradataSpacecraftDetailService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): SeradataSpacecraftDetailService.WithRawResponse =
        withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): SeradataSpacecraftDetailService =
        SeradataSpacecraftDetailServiceImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SeradataSpacecraftDetailServiceImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
