...
interface FlightplanService {
     ...
     */
    fun create(params: FlightplanCreateParams) = create(params, RequestOptions.none())
     ...
     * parameter.
     */
    fun retrieve(id: String): FlightPlanFull = retrieve(id, FlightplanRetrieveParams.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): FlightPlanFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: FlightplanRetrieveParams = FlightplanRetrieveParams.none(),
    ): FlightPlanFull = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: FlightplanUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, FlightplanDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: FlightplanDeleteParams) = delete(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: FlightplanQueryhelpParams = FlightplanQueryhelpParams.none()
    ): FlightplanQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<FlightplanUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            FlightplanUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<FlightplanUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            id: String,
            params: FlightplanRetrieveParams = FlightplanRetrieveParams.none(),
        ): HttpResponseFor<FlightPlanFull> = retrieve(id, params, RequestOptions.none())
        ...
        fun list(
            params: FlightplanListParams = FlightplanListParams.none()
        ): HttpResponseFor<FlightplanListPage> = list(params, RequestOptions.none())
         ...
         * as [FlightplanService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, FlightplanDeleteParams.none())
         ...
         * [FlightplanService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(FlightplanCountParams.none())
         ...
         * same as [FlightplanService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<FlightplanQueryhelpResponse> =
        ...
        fun queryhelp(
            params: FlightplanQueryhelpParams = FlightplanQueryhelpParams.none()
        ): HttpResponseFor<FlightplanQueryhelpResponse> = queryhelp(params, RequestOptions.none())
         ...
         * same as [FlightplanService.unvalidatedPublish].
         */
        @MustBeClosed
        ...
        /** @see unvalidatedPublish */
        @MustBeClosed
        fun unvalidatedPublish(body: List<FlightplanUnvalidatedPublishParams.Body>): HttpResponse =
            unvalidatedPublish(body, RequestOptions.none())
    }
}
