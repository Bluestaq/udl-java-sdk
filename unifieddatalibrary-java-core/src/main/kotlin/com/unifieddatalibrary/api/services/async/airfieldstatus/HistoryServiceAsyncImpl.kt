...
package com.unifieddatalibrary.api.services.async.airfieldstatus
...
import com.unifieddatalibrary.api.models.airfieldstatus.history.HistoryCountParams
import com.unifieddatalibrary.api.models.airfieldstatus.history.HistoryListPage
import com.unifieddatalibrary.api.models.airfieldstatus.history.HistoryListPageAsync
...
class HistoryServiceAsyncImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val listHandler: Handler<List<AirfieldstatusFull>> = jsonHandler<List<AirfieldstatusFull>>(clientOptions.jsonMapper)
        ...
        override fun list(params: HistoryListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<HistoryListPageAsync>> {
          val request = HttpRequest.builder()
            ...
            .addPathSegments("udl", "airfieldstatus", "history")
            .build()
        ...
        override fun count(params: HistoryCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "airfieldstatus", "history", "count")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
