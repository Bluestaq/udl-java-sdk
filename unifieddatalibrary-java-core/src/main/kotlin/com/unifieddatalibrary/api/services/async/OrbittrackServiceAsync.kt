...
interface OrbittrackServiceAsync {
    ...
    ): CompletableFuture<OrbittrackListPageAsync>
    ...
    /**
     * Service operation intended for initial integration only, to take a list of orbit track
    ...
    /** @see createBulk */
    fun createBulk(body: List<OrbittrackCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryhelp(): CompletableFuture<OrbittrackQueryhelpResponse> =
        queryhelp(OrbittrackQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: OrbittrackQueryhelpParams = OrbittrackQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OrbittrackQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: OrbittrackQueryhelpParams = OrbittrackQueryhelpParams.none()
    ): CompletableFuture<OrbittrackQueryhelpResponse> = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): CompletableFuture<OrbittrackQueryhelpResponse> =
        queryhelp(OrbittrackQueryhelpParams.none(), requestOptions)
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<OrbittrackTupleResponse>>
    ...
    /**
     * A view of [OrbittrackServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/orbittrack`, but is otherwise the same as
         * [OrbittrackServiceAsync.list].
         */
        fun list(
            params: OrbittrackListParams
        ): CompletableFuture<HttpResponseFor<OrbittrackListPageAsync>> =
            list(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/orbittrack/count`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `post /udl/orbittrack/createBulk`, but is otherwise the
         * same as [OrbittrackServiceAsync.createBulk].
         */
         ...
         * same as [OrbittrackServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<OrbittrackQueryhelpResponse>> =
            queryhelp(OrbittrackQueryhelpParams.none())
        ...
        fun queryhelp(
            params: OrbittrackQueryhelpParams = OrbittrackQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OrbittrackQueryhelpResponse>>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/orbittrack/tuple`, but is otherwise the same as
         * [OrbittrackServiceAsync.tuple].
         */
        fun tuple(
            params: OrbittrackTupleParams
        ): CompletableFuture<HttpResponseFor<List<OrbittrackTupleResponse>>> =
            tuple(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-orbittrack`, but is otherwise the
         * same as [OrbittrackServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: OrbittrackUnvalidatedPublishParams
