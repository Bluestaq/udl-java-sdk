...
class LaunchDetectionServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    LaunchDetectionService {

    private val withRawResponse: LaunchDetectionService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): LaunchDetectionService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LaunchDetectionService =
        LaunchDetectionServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            LaunchDetectionServiceImpl.WithRawResponseImpl(
