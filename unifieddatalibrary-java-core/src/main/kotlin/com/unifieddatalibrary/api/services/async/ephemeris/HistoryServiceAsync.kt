...
import com.unifieddatalibrary.api.models.ephemeris.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/ephemeris/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/ephemeris/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/ephemeris/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
