...
class RfBandTypeServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    RfBandTypeService {

    private val withRawResponse: RfBandTypeService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): RfBandTypeService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RfBandTypeService =
        RfBandTypeServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            RfBandTypeServiceImpl.WithRawResponseImpl(
