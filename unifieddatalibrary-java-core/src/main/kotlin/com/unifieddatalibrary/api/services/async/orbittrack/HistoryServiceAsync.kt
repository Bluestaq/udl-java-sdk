...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/orbittrack/history`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/orbittrack/history/aodr`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/orbittrack/history/count`, but is otherwise the
