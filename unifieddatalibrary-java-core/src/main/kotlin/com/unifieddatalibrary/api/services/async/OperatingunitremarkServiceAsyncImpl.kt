...
internal constructor(private val clientOptions: ClientOptions) : OperatingunitremarkServiceAsync {
    ...
    private val withRawResponse: OperatingunitremarkServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): OperatingunitremarkServiceAsync.WithRawResponse =
        withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): OperatingunitremarkServiceAsync =
        OperatingunitremarkServiceAsyncImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OperatingunitremarkServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
