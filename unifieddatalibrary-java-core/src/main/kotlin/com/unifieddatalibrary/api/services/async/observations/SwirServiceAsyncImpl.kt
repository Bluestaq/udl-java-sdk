...
class SwirServiceAsyncImpl internal constructor(
    ...
    override fun unvalidatedPublish(params: SwirUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /filedrop/swir
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun unvalidatedPublish(params: SwirUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
