...
interface RfObservationService {
     ...
     */
    fun create(params: RfObservationCreateParams) = create(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: RfObservationCountParams): String = count(params, RequestOptions.none())
     ...
     */
    fun get(id: String): RfObservationGetResponse = get(id, RfObservationGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): RfObservationGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: RfObservationGetParams = RfObservationGetParams.none(),
    ): RfObservationGetResponse = get(id, params, RequestOptions.none())
    ...
    fun queryhelp(
        params: RfObservationQueryhelpParams = RfObservationQueryhelpParams.none()
    ): RfObservationQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): List<RfObservationTupleResponse>
    ...
    interface WithRawResponse {
         ...
         * the same as [RfObservationService.createBulk].
         */
        @MustBeClosed
        ...
        fun get(
            ...
            params: RfObservationGetParams = RfObservationGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<RfObservationGetResponse> =
        ...
        fun get(
            id: String,
            params: RfObservationGetParams = RfObservationGetParams.none(),
        ): HttpResponseFor<RfObservationGetResponse> = get(id, params, RequestOptions.none())
         ...
         * same as [RfObservationService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<RfObservationQueryhelpResponse> =
        ...
        fun queryhelp(
            params: RfObservationQueryhelpParams = RfObservationQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<RfObservationQueryhelpResponse>
         ...
         * as [RfObservationService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: RfObservationTupleParams
        ): HttpResponseFor<List<RfObservationTupleResponse>> = tuple(params, RequestOptions.none())
        ...
        fun tuple(
            params: RfObservationTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<RfObservationTupleResponse>>

        /**
         * Returns a raw HTTP response for `post /filedrop/udl-rf`, but is otherwise the same as
         * [RfObservationService.unvalidatedPublish].
         */
        @MustBeClosed
