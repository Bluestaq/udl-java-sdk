...
class OrbittrackServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : OrbittrackService {

    private val withRawResponse: OrbittrackService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): OrbittrackService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OrbittrackService = OrbittrackServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryService = history

    override fun list(params: OrbittrackListParams, requestOptions: RequestOptions): OrbittrackListPage =
        // get /udl/orbittrack
    ...
    override fun queryhelp(params: OrbittrackQueryhelpParams, requestOptions: RequestOptions): OrbittrackQueryhelpResponse =
        // get /udl/orbittrack/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: OrbittrackTupleParams, requestOptions: RequestOptions): List<OrbittrackTupleResponse> =
        // get /udl/orbittrack/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: OrbittrackUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OrbittrackService.WithRawResponse = OrbittrackServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: OrbittrackListParams, requestOptions: RequestOptions): HttpResponseFor<OrbittrackListPage> {
        ...
        override fun count(params: OrbittrackCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: OrbittrackCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: OrbittrackQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<OrbittrackQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: OrbittrackTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<OrbittrackTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: OrbittrackUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
