...
internal constructor(private val clientOptions: ClientOptions) : MissionAssignmentServiceAsync {
    ...
    private val withRawResponse: MissionAssignmentServiceAsync.WithRawResponse by lazy {
    ...
    override fun queryhelp(
        params: MissionAssignmentQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            MissionAssignmentServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<MissionAssignmentListResponse>> =
            jsonHandler<List<MissionAssignmentListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<MissionAssignmentGetResponse> =
            jsonHandler<MissionAssignmentGetResponse>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<MissionAssignmentQueryhelpResponse> =
            jsonHandler<MissionAssignmentQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<MissionAssignmentTupleResponse>> =
            jsonHandler<List<MissionAssignmentTupleResponse>>(clientOptions.jsonMapper)
