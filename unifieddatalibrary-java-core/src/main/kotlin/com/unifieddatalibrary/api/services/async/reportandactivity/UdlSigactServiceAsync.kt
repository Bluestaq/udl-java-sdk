...
interface UdlSigactServiceAsync {
    ...
    /**
     * Service operation to get a single SigAct text file by its unique ID passed as a path
     * parameter. The text file is returned as an attachment Content-Disposition.
     */
    fun fileGet(id: String): CompletableFuture<HttpResponse> =
        fileGet(id, UdlSigactFileGetParams.none())

    /** @see fileGet */
    fun fileGet(
        id: String,
        params: UdlSigactFileGetParams = UdlSigactFileGetParams.none(),
    ...
    fun fileGet(id: String, requestOptions: RequestOptions): CompletableFuture<HttpResponse> =
        fileGet(id, UdlSigactFileGetParams.none(), requestOptions)

    /**
     * Service operation to take a list of SigAct as a POST body and ingest into the database. A
     * SigAct provides data for Report and Activity information. Requires a specific role, please
     * contact the UDL team to gain access. This operation is intended to be used for automated
     * feeds into UDL.
     */
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sigact/getFile/{id}`, but is otherwise the same
         * as [UdlSigactServiceAsync.fileGet].
         */
        fun fileGet(id: String): CompletableFuture<HttpResponse> =
            fileGet(id, UdlSigactFileGetParams.none())
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-sigact`, but is otherwise the same as
         * [UdlSigactServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: UdlSigactUnvalidatedPublishParams
