...
interface UdlH3geoService {
    ...
    fun unvalidatedPublish(params: UdlH3geoUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /filedrop/udl-h3geo`, but is otherwise the same as [UdlH3geoService.unvalidatedPublish]. */
        @MustBeClosed
        ...
        /** @see unvalidatedPublish */
        @MustBeClosed
        fun unvalidatedPublish(params: UdlH3geoUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
