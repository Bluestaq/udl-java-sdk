...
interface OnorbitdetailServiceAsync {
    ...
    /**
     * Service operation to take a single OnorbitDetails as a POST body and ingest into the
     * database. An OnorbitDetails is a collection of additional characteristics on an on-orbit
     * object. A specific role is required to perform this service operation. Please contact the UDL
     * team for assistance.
     */
    ...
    /**
     * Service operation to update a single OnorbitDetails. An OnorbitDetails is a collection of
     * additional characteristics on an on-orbit object. A specific role is required to perform this
    ...
    /** @see list */
    fun list(
        params: OnorbitdetailListParams = OnorbitdetailListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun list(
        params: OnorbitdetailListParams = OnorbitdetailListParams.none()
    ): CompletableFuture<OnorbitdetailListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<OnorbitdetailListPageAsync> =
        list(OnorbitdetailListParams.none(), requestOptions)

    /**
     * Service operation to delete a OnorbitDetails object specified by the passed ID path
     * parameter. An OnorbitDetails is a collection of additional characteristics on an on-orbit
     * object. A specific role is required to perform this service operation. Please contact the UDL
     * team for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, OnorbitdetailDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: OnorbitdetailDeleteParams = OnorbitdetailDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun delete(id: String, requestOptions: RequestOptions): CompletableFuture<Void?> =
        delete(id, OnorbitdetailDeleteParams.none(), requestOptions)

    /**
     * Service operation to get a single OnorbitDetails record by its unique ID passed as a path
     * parameter. An OnorbitDetails is a collection of additional characteristics on an on-orbit
     * object.
     */
    fun get(id: String): CompletableFuture<OnorbitDetailsFull> =
        get(id, OnorbitdetailGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: OnorbitdetailGetParams = OnorbitdetailGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun get(
        id: String,
        params: OnorbitdetailGetParams = OnorbitdetailGetParams.none(),
    ): CompletableFuture<OnorbitDetailsFull> = get(id, params, RequestOptions.none())
    ...
    fun get(id: String, requestOptions: RequestOptions): CompletableFuture<OnorbitDetailsFull> =
        get(id, OnorbitdetailGetParams.none(), requestOptions)

    /**
     * A view of [OnorbitdetailServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/onorbitdetails`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `put /udl/onorbitdetails/{id}`, but is otherwise the same
         * as [OnorbitdetailServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: OnorbitdetailUpdateParams,
        ...
        /**
         * Returns a raw HTTP response for `get /udl/onorbitdetails`, but is otherwise the same as
         * [OnorbitdetailServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<OnorbitdetailListPageAsync>> =
            list(OnorbitdetailListParams.none())
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/onorbitdetails/{id}`, but is otherwise the
         * same as [OnorbitdetailServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, OnorbitdetailDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/onorbitdetails/{id}`, but is otherwise the same
         * as [OnorbitdetailServiceAsync.get].
         */
