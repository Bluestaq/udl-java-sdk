...
interface FileServiceAsync {
    ...
    /** @see retrieve */
    fun retrieve(params: FileRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<FileData>
    ...
    /** @see update */
    fun update(params: FileUpdateParams = FileUpdateParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see list */
    fun list(params: FileListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<FileListPageAsync>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /scs/file`, but is otherwise the same as [FileServiceAsync.retrieve]. */
        ...
        /** @see retrieve */
        fun retrieve(params: FileRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<FileData>>

        /** Returns a raw HTTP response for `patch /scs/file`, but is otherwise the same as [FileServiceAsync.update]. */
        fun update(): CompletableFuture<HttpResponse> = update(FileUpdateParams.none())

        /** @see update */
        fun update(params: FileUpdateParams = FileUpdateParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** @see update */
        fun update(params: FileUpdateParams = FileUpdateParams.none()): CompletableFuture<HttpResponse> =
            update(
              params, RequestOptions.none()
            )
        ...
        /** Returns a raw HTTP response for `get /scs/list`, but is otherwise the same as [FileServiceAsync.list]. */
        ...
        /** @see list */
        fun list(params: FileListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<FileListPageAsync>>
    }
}
