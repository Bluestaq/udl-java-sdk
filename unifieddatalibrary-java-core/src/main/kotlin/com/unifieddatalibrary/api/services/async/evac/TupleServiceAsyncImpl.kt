...
class TupleServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: TupleServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): TupleServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TupleServiceAsync =
        TupleServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun list(
        params: TupleListParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<TupleListPageAsync> =
        // get /udl/evac/tuple
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TupleServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun list(
            params: TupleListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<TupleListPageAsync>> {
            val request =
                HttpRequest.builder()
