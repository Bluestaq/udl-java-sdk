...
class ManeuverServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ManeuverService {

    private val withRawResponse: ManeuverService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): ManeuverService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ManeuverService = ManeuverServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: ManeuverListParams, requestOptions: RequestOptions): ManeuverListPage =
        // get /udl/maneuver
    ...
    override fun get(params: ManeuverGetParams, requestOptions: RequestOptions): ManeuverGetResponse =
        // get /udl/maneuver/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: ManeuverQueryhelpParams, requestOptions: RequestOptions): ManeuverQueryhelpResponse =
        // get /udl/maneuver/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: ManeuverTupleParams, requestOptions: RequestOptions): List<ManeuverTupleResponse> =
        // get /udl/maneuver/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: ManeuverUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ManeuverService.WithRawResponse = ManeuverServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: ManeuverCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: ManeuverListParams, requestOptions: RequestOptions): HttpResponseFor<ManeuverListPage> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: ManeuverCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: ManeuverCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: ManeuverGetParams, requestOptions: RequestOptions): HttpResponseFor<ManeuverGetResponse> {
        ...
        override fun queryhelp(params: ManeuverQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<ManeuverQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: ManeuverTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<ManeuverTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: ManeuverUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
