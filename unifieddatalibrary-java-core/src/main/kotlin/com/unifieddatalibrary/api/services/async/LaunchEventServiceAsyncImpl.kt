...
class LaunchEventServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : LaunchEventServiceAsync {

    private val withRawResponse: LaunchEventServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): LaunchEventServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LaunchEventServiceAsync = LaunchEventServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryServiceAsync = history

    override fun create(params: LaunchEventCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/launchevent
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun list(params: LaunchEventListParams, requestOptions: RequestOptions): CompletableFuture<LaunchEventListPageAsync> =
        // get /udl/launchevent
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: LaunchEventCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/launchevent/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: LaunchEventCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/launchevent/createBulk
        withRawResponse().createBulk(params, requestOptions).thenAccept {}

    override fun get(params: LaunchEventGetParams, requestOptions: RequestOptions): CompletableFuture<LaunchEventGetResponse> =
        // get /udl/launchevent/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: LaunchEventQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<LaunchEventQueryhelpResponse> =
        // get /udl/launchevent/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: LaunchEventTupleParams, requestOptions: RequestOptions): CompletableFuture<List<LaunchEventTupleResponse>> =
        // get /udl/launchevent/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun unvalidatedPublish(params: LaunchEventUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LaunchEventServiceAsync.WithRawResponse = LaunchEventServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryServiceAsync.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: LaunchEventCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: LaunchEventListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LaunchEventListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: LaunchEventCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: LaunchEventCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: LaunchEventGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LaunchEventGetResponse>> {
        ...
        override fun queryhelp(params: LaunchEventQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LaunchEventQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: LaunchEventTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<LaunchEventTupleResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: LaunchEventUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
