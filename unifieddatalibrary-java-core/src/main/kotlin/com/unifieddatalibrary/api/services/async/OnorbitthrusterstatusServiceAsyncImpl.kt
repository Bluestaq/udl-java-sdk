...
internal constructor(private val clientOptions: ClientOptions) : OnorbitthrusterstatusServiceAsync {
    ...
    private val withRawResponse: OnorbitthrusterstatusServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): OnorbitthrusterstatusServiceAsync.WithRawResponse =
        withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): OnorbitthrusterstatusServiceAsync =
        OnorbitthrusterstatusServiceAsyncImpl(
    ...
    override fun list(
        params: OnorbitthrusterstatusListParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<OnorbitthrusterstatusListPageAsync> =
    ...
    override fun count(
        params: OnorbitthrusterstatusCountParams,
        requestOptions: RequestOptions,
    ...
    override fun get(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<OnorbitthrusterstatusFull> =
    ...
    override fun queryhelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<OnorbitthrusterstatusQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<OnorbitthrusterstatusFull>> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnorbitthrusterstatusServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
        ...
        private val listHandler: Handler<List<OnorbitthrusterstatusListResponse>> =
            jsonHandler<List<OnorbitthrusterstatusListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: OnorbitthrusterstatusListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<OnorbitthrusterstatusListPageAsync>> {
            val request =
                HttpRequest.builder()
        ...
        private val getHandler: Handler<OnorbitthrusterstatusFull> =
            jsonHandler<OnorbitthrusterstatusFull>(clientOptions.jsonMapper)

        override fun get(
            params: OnorbitthrusterstatusGetParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<OnorbitthrusterstatusFull>> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("id", params.id().getOrNull())
            val request =
        ...
        private val queryhelpHandler: Handler<OnorbitthrusterstatusQueryhelpResponse> =
            jsonHandler<OnorbitthrusterstatusQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(
            params: OnorbitthrusterstatusQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<OnorbitthrusterstatusQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<OnorbitthrusterstatusFull>> =
            jsonHandler<List<OnorbitthrusterstatusFull>>(clientOptions.jsonMapper)

        override fun tuple(
            params: OnorbitthrusterstatusTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<OnorbitthrusterstatusFull>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
