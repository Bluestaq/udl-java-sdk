...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraftstatus/history`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraftstatus/history/count`, but is otherwise
