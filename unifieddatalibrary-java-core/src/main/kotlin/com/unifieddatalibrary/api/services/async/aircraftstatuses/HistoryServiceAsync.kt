...
package com.unifieddatalibrary.api.services.async.aircraftstatuses

import com.unifieddatalibrary.api.core.ClientOptions
import com.unifieddatalibrary.api.core.RequestOptions
import com.unifieddatalibrary.api.core.http.HttpResponseFor
import com.unifieddatalibrary.api.models.aircraftstatuses.history.HistoryCountParams
import com.unifieddatalibrary.api.models.aircraftstatuses.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/aircraftstatus/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/aircraftstatus/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
