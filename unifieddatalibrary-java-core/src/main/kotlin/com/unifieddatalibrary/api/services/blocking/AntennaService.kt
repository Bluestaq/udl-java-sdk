...
interface AntennaService {
     ...
     * assistance.
     */
    fun create(params: AntennaCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun retrieve(id: String): AntennaFull = retrieve(id, AntennaRetrieveParams.none())
    ...
    ): AntennaFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AntennaRetrieveParams = AntennaRetrieveParams.none(),
    ): AntennaFull = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: AntennaUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, AntennaDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: AntennaDeleteParams) = delete(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: AntennaQueryhelpParams = AntennaQueryhelpParams.none()
    ): AntennaQueryhelpResponse = queryhelp(params, RequestOptions.none())
     ...
     */
    fun tuple(params: AntennaTupleParams): List<AntennaFull> = tuple(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            id: String,
            params: AntennaRetrieveParams = AntennaRetrieveParams.none(),
        ): HttpResponseFor<AntennaFull> = retrieve(id, params, RequestOptions.none())
         ...
         * [AntennaService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<AntennaListPage> = list(AntennaListParams.none())
        ...
        fun list(
            params: AntennaListParams = AntennaListParams.none()
        ): HttpResponseFor<AntennaListPage> = list(params, RequestOptions.none())
         ...
         * [AntennaService.delete].
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, AntennaDeleteParams.none())
         ...
         * [AntennaService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(AntennaCountParams.none())
         ...
         * as [AntennaService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AntennaQueryhelpResponse> =
        ...
        fun queryhelp(
            params: AntennaQueryhelpParams = AntennaQueryhelpParams.none()
        ): HttpResponseFor<AntennaQueryhelpResponse> = queryhelp(params, RequestOptions.none())
