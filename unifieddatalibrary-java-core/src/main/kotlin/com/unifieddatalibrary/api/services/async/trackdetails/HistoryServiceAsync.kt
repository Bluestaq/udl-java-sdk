...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/trackdetails/history`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/trackdetails/history/aodr`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `get /udl/trackdetails/history/count`, but is otherwise
