...
package com.unifieddatalibrary.api.services.blocking.aircraftstatuses
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/aircraftstatus/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/aircraftstatus/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
