...
interface CotService {
    ...
    /**
     * This service enables posting CoT messages to the UDL TAK server. CoT data will be persisted
     * in the UDL POI schema as well as federated to connected TAK servers.
     */
    fun create(params: CotCreateParams) = create(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/cot`, but is otherwise the same as
         * [CotService.create].
         */
        @MustBeClosed
        fun create(params: CotCreateParams): HttpResponse = create(params, RequestOptions.none())
