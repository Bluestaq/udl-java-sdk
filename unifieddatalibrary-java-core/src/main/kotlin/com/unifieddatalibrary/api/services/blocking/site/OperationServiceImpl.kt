...
class OperationServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: OperationService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): OperationService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OperationService =
        OperationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryHelp(
        params: OperationQueryHelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OperationServiceImpl.WithRawResponseImpl(
        ...
        private val retrieveHandler: Handler<OperationRetrieveResponse> =
            jsonHandler<OperationRetrieveResponse>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<List<OperationListResponse>> =
            jsonHandler<List<OperationListResponse>>(clientOptions.jsonMapper)
        ...
        private val queryHelpHandler: Handler<OperationQueryHelpResponse> =
            jsonHandler<OperationQueryHelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<OperationTupleResponse>> =
            jsonHandler<List<OperationTupleResponse>>(clientOptions.jsonMapper)
