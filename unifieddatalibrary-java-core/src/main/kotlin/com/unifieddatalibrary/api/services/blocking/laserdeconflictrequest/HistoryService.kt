...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/laserdeconflictrequest/history`, but is
         * otherwise the same as [HistoryService.list].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/laserdeconflictrequest/history/aodr`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /udl/laserdeconflictrequest/history/count`, but is
