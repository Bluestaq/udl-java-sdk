...
class MissileTrackServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    MissileTrackServiceAsync {

    private val withRawResponse: MissileTrackServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): MissileTrackServiceAsync =
        MissileTrackServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(
        params: MissileTrackQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            MissileTrackServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )

        override fun history(): HistoryServiceAsync.WithRawResponse = history

        private val listHandler: Handler<List<MissileTrackListResponse>> =
            jsonHandler<List<MissileTrackListResponse>>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<MissileTrackQueryhelpResponse> =
            jsonHandler<MissileTrackQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<MissileTrackTupleResponse>> =
            jsonHandler<List<MissileTrackTupleResponse>>(clientOptions.jsonMapper)
