...
interface EoObservationService {
    ...
    /**
     * Service operation to take a single EO observation as a POST body and ingest into the
     ...
     */
    fun create(params: EoObservationCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun retrieve(id: String): EoObservationFull = retrieve(id, EoObservationRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: EoObservationRetrieveParams = EoObservationRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): EoObservationFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: EoObservationRetrieveParams = EoObservationRetrieveParams.none(),
    ): EoObservationFull = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(id: String, requestOptions: RequestOptions): EoObservationFull =
        retrieve(id, EoObservationRetrieveParams.none(), requestOptions)
     ...
     */
    fun count(params: EoObservationCountParams): String = count(params, RequestOptions.none())
    ...
    /**
     * Service operation intended for initial integration only, to take a list of EO observations as
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<EoObservationCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) = createBulk(EoObservationCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<EoObservationCreateBulkParams.Body>) =
    ...
    /** @see queryhelp */
    fun queryhelp(
        params: EoObservationQueryhelpParams = EoObservationQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: EoObservationQueryhelpParams = EoObservationQueryhelpParams.none()
    ): EoObservationQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): EoObservationQueryhelpResponse =
        queryhelp(EoObservationQueryhelpParams.none(), requestOptions)
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): List<EoObservationFull>

    /**
     * Service operation to take multiple EO observations as a POST body and ingest into the
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<EoObservationUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            EoObservationUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<EoObservationUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/eoobservation`, but is otherwise the same as
         * [EoObservationService.create].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/eoobservation/{id}`, but is otherwise the same
         * as [EoObservationService.retrieve].
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<EoObservationFull> =
            retrieve(id, EoObservationRetrieveParams.none())
        ...
        fun retrieve(
            ...
            params: EoObservationRetrieveParams = EoObservationRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<EoObservationFull> =
        ...
        fun retrieve(
            id: String,
            params: EoObservationRetrieveParams = EoObservationRetrieveParams.none(),
        ): HttpResponseFor<EoObservationFull> = retrieve(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/eoobservation`, but is otherwise the same as
         * [EoObservationService.list].
         */
        @MustBeClosed
        ...
        fun list(
            params: EoObservationListParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<EoObservationListPage>

        /**
         * Returns a raw HTTP response for `get /udl/eoobservation/count`, but is otherwise the same
         * as [EoObservationService.count].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /udl/eoobservation/createBulk`, but is otherwise
         * the same as [EoObservationService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<EoObservationCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/eoobservation/queryhelp`, but is otherwise the
         * same as [EoObservationService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<EoObservationQueryhelpResponse> =
            queryhelp(EoObservationQueryhelpParams.none())
        ...
        fun queryhelp(
            params: EoObservationQueryhelpParams = EoObservationQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<EoObservationQueryhelpResponse>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/eoobservation/tuple`, but is otherwise the same
         * as [EoObservationService.tuple].
         */
        @MustBeClosed
        ...
        fun tuple(
            params: EoObservationTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<EoObservationFull>>

        /**
         * Returns a raw HTTP response for `post /filedrop/udl-eo`, but is otherwise the same as
         * [EoObservationService.unvalidatedPublish].
         */
        @MustBeClosed
