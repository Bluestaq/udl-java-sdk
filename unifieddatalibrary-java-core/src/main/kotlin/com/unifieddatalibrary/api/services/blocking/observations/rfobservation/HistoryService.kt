...
package com.unifieddatalibrary.api.services.blocking.observations.rfobservation
...
import com.unifieddatalibrary.api.models.observations.rfobservation.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/rfobservation/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/rfobservation/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/rfobservation/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
