...
interface EphemerisServiceAsync {
    ...
    /** @see list */
    fun list(params: EphemerisListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EphemerisListPageAsync>
    ...
    /** @see count */
    fun count(params: EphemerisCountParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<String>
    ...
    /** @see fileUpload */
    fun fileUpload(params: EphemerisFileUploadParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>

    /** Service operation to provide detailed information on available dynamic query parameters for a particular data type. */
    fun queryhelp(): CompletableFuture<EphemerisQueryhelpResponse> = queryhelp(EphemerisQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(params: EphemerisQueryhelpParams = EphemerisQueryhelpParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EphemerisQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(params: EphemerisQueryhelpParams = EphemerisQueryhelpParams.none()): CompletableFuture<EphemerisQueryhelpResponse> =
        queryhelp(
          params, RequestOptions.none()
        )
    ...
    /** @see tuple */
    fun tuple(params: EphemerisTupleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<List<EphemerisFull>>
    ...
    fun unvalidatedPublish(params: EphemerisUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): EphemerisServiceAsync.WithRawResponse

        fun attitudeData(): AttitudeDataServiceAsync.WithRawResponse

        fun history(): HistoryServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `get /udl/ephemeris`, but is otherwise the same as [EphemerisServiceAsync.list]. */
        fun list(params: EphemerisListParams): CompletableFuture<HttpResponseFor<EphemerisListPageAsync>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(params: EphemerisListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EphemerisListPageAsync>>

        /** Returns a raw HTTP response for `get /udl/ephemeris/count`, but is otherwise the same as [EphemerisServiceAsync.count]. */
        ...
        /** @see count */
        fun count(params: EphemerisCountParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<String>>

        /** Returns a raw HTTP response for `post /filedrop/ephem`, but is otherwise the same as [EphemerisServiceAsync.fileUpload]. */
        ...
        /** @see fileUpload */
        fun fileUpload(params: EphemerisFileUploadParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `get /udl/ephemeris/queryhelp`, but is otherwise the same as [EphemerisServiceAsync.queryhelp]. */
        fun queryhelp(): CompletableFuture<HttpResponseFor<EphemerisQueryhelpResponse>> = queryhelp(EphemerisQueryhelpParams.none())

        /** @see queryhelp */
        fun queryhelp(params: EphemerisQueryhelpParams = EphemerisQueryhelpParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<EphemerisQueryhelpResponse>>

        /** @see queryhelp */
        fun queryhelp(params: EphemerisQueryhelpParams = EphemerisQueryhelpParams.none()): CompletableFuture<HttpResponseFor<EphemerisQueryhelpResponse>> =
            queryhelp(
              params, RequestOptions.none()
            )

        /** @see queryhelp */
        fun queryhelp(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EphemerisQueryhelpResponse>> =
            queryhelp(
              EphemerisQueryhelpParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `get /udl/ephemeris/tuple`, but is otherwise the same as [EphemerisServiceAsync.tuple]. */
        fun tuple(params: EphemerisTupleParams): CompletableFuture<HttpResponseFor<List<EphemerisFull>>> =
            tuple(
              params, RequestOptions.none()
            )

        /** @see tuple */
        fun tuple(params: EphemerisTupleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<List<EphemerisFull>>>

        /** Returns a raw HTTP response for `post /filedrop/udl-ephset`, but is otherwise the same as [EphemerisServiceAsync.unvalidatedPublish]. */
        fun unvalidatedPublish(params: EphemerisUnvalidatedPublishParams): CompletableFuture<HttpResponse> =
            unvalidatedPublish(
              params, RequestOptions.none()
            )

        /** @see unvalidatedPublish */
        fun unvalidatedPublish(params: EphemerisUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
