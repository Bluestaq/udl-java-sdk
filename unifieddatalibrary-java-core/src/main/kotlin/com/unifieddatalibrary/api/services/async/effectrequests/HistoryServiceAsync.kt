...
package com.unifieddatalibrary.api.services.async.effectrequests
...
import com.unifieddatalibrary.api.models.effectrequests.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/effectrequest/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/effectrequest/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/effectrequest/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
