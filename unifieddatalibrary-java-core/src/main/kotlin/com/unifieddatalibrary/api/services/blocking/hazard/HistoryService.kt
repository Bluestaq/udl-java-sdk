...
package com.unifieddatalibrary.api.services.blocking.hazard
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/hazard/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/hazard/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/hazard/history`, but is otherwise the same as [HistoryService.query]. */
        @MustBeClosed
