...
class SigactServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SigactService {

    private val withRawResponse: SigactService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): SigactService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SigactService = SigactServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(params: SigactQueryhelpParams, requestOptions: RequestOptions): SigactQueryhelpResponse =
        // get /udl/sigact/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: SigactTupleParams, requestOptions: RequestOptions): List<SigactTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SigactService.WithRawResponse = SigactServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: SigactListParams, requestOptions: RequestOptions): HttpResponseFor<SigactListPage> {
        ...
        override fun count(params: SigactCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: SigactCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: SigactQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<SigactQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: SigactTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<SigactTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun uploadZip(params: SigactUploadZipParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
