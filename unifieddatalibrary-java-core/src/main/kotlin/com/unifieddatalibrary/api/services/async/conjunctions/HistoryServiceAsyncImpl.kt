...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun aodr(
        ...
        // get /udl/conjunction/history/aodr
    ...
    override fun count(
        ...
        // get /udl/conjunction/history/count
        ...
        override fun aodr(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "conjunction", "history", "aodr")
                    .build()
        ...
        override fun count(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "conjunction", "history", "count")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
