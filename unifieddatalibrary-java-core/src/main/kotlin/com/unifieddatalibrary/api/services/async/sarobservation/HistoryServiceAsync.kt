...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/sarobservation/history`, but is otherwise the same as [HistoryServiceAsync.retrieve]. */
        ...
        /** Returns a raw HTTP response for `get /udl/sarobservation/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/sarobservation/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
