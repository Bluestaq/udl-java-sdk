...
interface FeatureAssessmentServiceAsync {
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<FeatureAssessmentRetrieveResponse> =
    ...
    /** @see createBulk */
    fun createBulk(body: List<FeatureAssessmentCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryHelp(): CompletableFuture<FeatureAssessmentQueryHelpResponse> =
    ...
    fun queryHelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<FeatureAssessmentQueryHelpResponse>
    ...
    ): CompletableFuture<List<FeatureAssessmentTupleResponse>> =
    ...
    /**
     * A view of [FeatureAssessmentServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [FeatureAssessmentServiceAsync.create].
         */
         ...
         * same as [FeatureAssessmentServiceAsync.retrieve].
         */
        fun retrieve(
            id: String
        ): CompletableFuture<HttpResponseFor<FeatureAssessmentRetrieveResponse>> =
            retrieve(id, FeatureAssessmentRetrieveParams.none())
         ...
         * otherwise the same as [FeatureAssessmentServiceAsync.createBulk].
         */
         ...
         * the same as [FeatureAssessmentServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<FeatureAssessmentQueryHelpResponse>> =
            queryHelp(FeatureAssessmentQueryHelpParams.none())
        ...
        fun queryHelp(
            params: FeatureAssessmentQueryHelpParams = FeatureAssessmentQueryHelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<FeatureAssessmentQueryHelpResponse>>
         ...
         * same as [FeatureAssessmentServiceAsync.tuple].
         */
        fun tuple(
            params: FeatureAssessmentTupleParams
        ): CompletableFuture<HttpResponseFor<List<FeatureAssessmentTupleResponse>>> =
            tuple(params, RequestOptions.none())
         ...
         * the same as [FeatureAssessmentServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: FeatureAssessmentUnvalidatedPublishParams
