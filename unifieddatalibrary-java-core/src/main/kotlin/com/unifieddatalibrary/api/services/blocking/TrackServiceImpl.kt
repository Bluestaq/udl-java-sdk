...
class TrackServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : TrackService {

    private val withRawResponse: TrackService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): TrackService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TrackService = TrackServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(params: TrackQueryhelpParams, requestOptions: RequestOptions): TrackQueryhelpResponse =
    ...
    override fun unvalidatedPublish(params: TrackUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TrackService.WithRawResponse = TrackServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: TrackListParams, requestOptions: RequestOptions): HttpResponseFor<TrackListPage> {
        ...
        override fun count(params: TrackCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: TrackCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: TrackQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<TrackQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: TrackTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<TrackFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: TrackUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
