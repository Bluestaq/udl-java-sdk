...
interface OperationService {
     ...
     */
    fun create(params: OperationCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): OperationRetrieveResponse = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: OperationRetrieveParams = OperationRetrieveParams.none(),
    ): OperationRetrieveResponse = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: OperationUpdateParams) = update(params, RequestOptions.none())
     ...
     */
    fun list(params: OperationListParams): OperationListPage = list(params, RequestOptions.none())
     ...
     * UDL team for assistance.
     */
    fun delete(id: String) = delete(id, OperationDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: OperationDeleteParams) = delete(params, RequestOptions.none())
     ...
     */
    fun count(params: OperationCountParams): String = count(params, RequestOptions.none())
     ...
     * mechanism.
     */
    fun createBulk(params: OperationCreateBulkParams) = createBulk(params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(body: List<OperationCreateBulkParams.Body>) =
    ...
    fun queryHelp(
        params: OperationQueryHelpParams = OperationQueryHelpParams.none()
    ): OperationQueryHelpResponse = queryHelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<OperationUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            ...
            params: OperationRetrieveParams = OperationRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<OperationRetrieveResponse> =
        ...
        fun retrieve(
            id: String,
            params: OperationRetrieveParams = OperationRetrieveParams.none(),
        ): HttpResponseFor<OperationRetrieveResponse> = retrieve(id, params, RequestOptions.none())
        ...
        fun list(
            params: OperationListParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<OperationListPage>

        /**
         * Returns a raw HTTP response for `delete /udl/siteoperations/{id}`, but is otherwise the
         * same as [OperationService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, OperationDeleteParams.none())
         ...
         * same as [OperationService.count].
         */
        @MustBeClosed
         ...
         * the same as [OperationService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<OperationCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/siteoperations/queryhelp`, but is otherwise the
         * same as [OperationService.queryHelp].
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<OperationQueryHelpResponse> =
        ...
        fun queryHelp(
            params: OperationQueryHelpParams = OperationQueryHelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<OperationQueryHelpResponse>

        /** @see queryHelp */
        @MustBeClosed
        fun queryHelp(
            params: OperationQueryHelpParams = OperationQueryHelpParams.none()
        ): HttpResponseFor<OperationQueryHelpResponse> = queryHelp(params, RequestOptions.none())
         ...
         * same as [OperationService.tuple].
         */
        @MustBeClosed
        ...
        fun tuple(
            params: OperationTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<OperationTupleResponse>>

        /**
         * Returns a raw HTTP response for `post /filedrop/udl-siteoperations`, but is otherwise the
         * same as [OperationService.unvalidatedPublish].
         */
        @MustBeClosed
        ...
        /** @see unvalidatedPublish */
        @MustBeClosed
        fun unvalidatedPublish(body: List<OperationUnvalidatedPublishParams.Body>): HttpResponse =
            unvalidatedPublish(body, RequestOptions.none())
    }
}
