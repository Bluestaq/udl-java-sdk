...
interface NotificationService {
     ...
     * for assistance.
     */
    fun create(params: NotificationCreateParams) = create(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: NotificationCountParams): String = count(params, RequestOptions.none())
     ...
     */
    fun createRaw(params: NotificationCreateRawParams) = createRaw(params, RequestOptions.none())
     ...
     */
    fun get(id: String): NotificationFull = get(id, NotificationGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): NotificationFull = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: NotificationGetParams = NotificationGetParams.none(),
    ): NotificationFull = get(id, params, RequestOptions.none())
    ...
    /** @see get */
    fun get(params: NotificationGetParams): NotificationFull = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: NotificationQueryhelpParams = NotificationQueryhelpParams.none()
    ): NotificationQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [NotificationService.createRaw].
         */
        @MustBeClosed
        ...
        fun get(
            ...
            params: NotificationGetParams = NotificationGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<NotificationFull> =
        ...
        fun get(
            id: String,
            params: NotificationGetParams = NotificationGetParams.none(),
        ): HttpResponseFor<NotificationFull> = get(id, params, RequestOptions.none())
         ...
         * same as [NotificationService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<NotificationQueryhelpResponse> =
        ...
        fun queryhelp(
            params: NotificationQueryhelpParams = NotificationQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<NotificationQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: NotificationQueryhelpParams = NotificationQueryhelpParams.none()
        ): HttpResponseFor<NotificationQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: NotificationTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<NotificationFull>>
    }
}
