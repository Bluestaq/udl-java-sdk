...
package com.unifieddatalibrary.api.services.async.spaceenvobservation
...
import com.unifieddatalibrary.api.models.spaceenvobservation.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/spaceenvobservation/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/spaceenvobservation/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/spaceenvobservation/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
