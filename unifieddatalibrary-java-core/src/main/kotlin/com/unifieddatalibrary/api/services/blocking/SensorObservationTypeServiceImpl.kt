...
class SensorObservationTypeServiceImpl
internal constructor(private val clientOptions: ClientOptions) : SensorObservationTypeService {

    private val withRawResponse: SensorObservationTypeService.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        SensorObservationTypeServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SensorObservationTypeServiceImpl.WithRawResponseImpl(
