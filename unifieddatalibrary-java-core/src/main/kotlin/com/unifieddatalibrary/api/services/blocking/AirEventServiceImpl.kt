...
class AirEventServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    AirEventService {

    private val withRawResponse: AirEventService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): AirEventService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AirEventService =
        AirEventServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(
        params: AirEventQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    override fun tuple(
        params: AirEventTupleParams,
        requestOptions: RequestOptions,
    ): List<AirEventTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AirEventServiceImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<AirEventListResponse>> =
            jsonHandler<List<AirEventListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: AirEventListParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<AirEventListPage> {
            val request =
                HttpRequest.builder()
        ...
        override fun createBulk(
            params: AirEventCreateBulkParams,
            requestOptions: RequestOptions,
        ): HttpResponse {
            val request =
                HttpRequest.builder()
        ...
        private val getHandler: Handler<AirEventGetResponse> =
            jsonHandler<AirEventGetResponse>(clientOptions.jsonMapper)

        override fun get(
            params: AirEventGetParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<AirEventGetResponse> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("id", params.id().getOrNull())
            val request =
        ...
        private val queryhelpHandler: Handler<AirEventQueryhelpResponse> =
            jsonHandler<AirEventQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(
            params: AirEventQueryhelpParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<AirEventQueryhelpResponse> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<AirEventTupleResponse>> =
            jsonHandler<List<AirEventTupleResponse>>(clientOptions.jsonMapper)

        override fun tuple(
            params: AirEventTupleParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<List<AirEventTupleResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
