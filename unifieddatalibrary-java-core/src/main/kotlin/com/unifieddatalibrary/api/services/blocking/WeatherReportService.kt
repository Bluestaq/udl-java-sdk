...
interface WeatherReportService {
     ...
     * for assistance.
     */
    fun create(params: WeatherReportCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun count(params: WeatherReportCountParams): String = count(params, RequestOptions.none())
     ...
     */
    fun get(id: String): WeatherReportFull = get(id, WeatherReportGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): WeatherReportFull = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: WeatherReportGetParams = WeatherReportGetParams.none(),
    ): WeatherReportFull = get(id, params, RequestOptions.none())
    ...
    /** @see get */
    fun get(params: WeatherReportGetParams): WeatherReportFull = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: WeatherReportQueryhelpParams = WeatherReportQueryhelpParams.none()
    ): WeatherReportQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<WeatherReportUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            WeatherReportUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<WeatherReportUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
        ...
        fun get(
            id: String,
            params: WeatherReportGetParams = WeatherReportGetParams.none(),
        ): HttpResponseFor<WeatherReportFull> = get(id, params, RequestOptions.none())
         ...
         * same as [WeatherReportService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<WeatherReportQueryhelpResponse> =
         ...
         * same as [WeatherReportService.unvalidatedPublish].
         */
        @MustBeClosed
