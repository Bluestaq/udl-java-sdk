...
class ConjunctionServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ConjunctionService {

    private val withRawResponse: ConjunctionService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): ConjunctionService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ConjunctionService = ConjunctionServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryService = history

    override fun retrieve(params: ConjunctionRetrieveParams, requestOptions: RequestOptions): ConjunctionFull =
        // get /udl/conjunction/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: ConjunctionListParams, requestOptions: RequestOptions): ConjunctionListPage =
        // get /udl/conjunction
    ...
    override fun getHistory(params: ConjunctionGetHistoryParams, requestOptions: RequestOptions): List<ConjunctionFull> =
        // get /udl/conjunction/history
        withRawResponse().getHistory(params, requestOptions).parse()

    override fun queryhelp(params: ConjunctionQueryhelpParams, requestOptions: RequestOptions): ConjunctionQueryhelpResponse =
        // get /udl/conjunction/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: ConjunctionTupleParams, requestOptions: RequestOptions): List<ConjunctionFull> =
        // get /udl/conjunction/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: ConjunctionUnvalidatedPublishParams, requestOptions: RequestOptions) {
      // post /filedrop/udl-conjunction
      withRawResponse().unvalidatedPublish(params, requestOptions)
    }

    override fun uploadConjunctionDataMessage(params: ConjunctionUploadConjunctionDataMessageParams, requestOptions: RequestOptions) {
      // post /filedrop/cdms
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ConjunctionService.WithRawResponse = ConjunctionServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val retrieveHandler: Handler<ConjunctionFull> = jsonHandler<ConjunctionFull>(clientOptions.jsonMapper)

        override fun retrieve(params: ConjunctionRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<ConjunctionFull> {
        ...
        override fun list(params: ConjunctionListParams, requestOptions: RequestOptions): HttpResponseFor<ConjunctionListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun count(params: ConjunctionCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createUdl(params: ConjunctionCreateUdlParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
        ...
        override fun createBulk(params: ConjunctionCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun getHistory(params: ConjunctionGetHistoryParams, requestOptions: RequestOptions): HttpResponseFor<List<ConjunctionFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: ConjunctionQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<ConjunctionQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: ConjunctionTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<ConjunctionFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: ConjunctionUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun uploadConjunctionDataMessage(params: ConjunctionUploadConjunctionDataMessageParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
