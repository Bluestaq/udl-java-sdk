...
class ScServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ScService {

    private val withRawResponse: ScService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val folders: FolderService by lazy { FolderServiceImpl(clientOptions) }

    private val classificationMarkings: ClassificationMarkingService by lazy { ClassificationMarkingServiceImpl(clientOptions) }
    ...
    private val rangeParameters: RangeParameterService by lazy { RangeParameterServiceImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ScService = ScServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun aggregateDocType(params: ScAggregateDocTypeParams, requestOptions: RequestOptions): List<String> =
        // get /scs/aggregateDocType
        withRawResponse().aggregateDocType(params, requestOptions).parse()

    override fun allowableFileExtensions(params: ScAllowableFileExtensionsParams, requestOptions: RequestOptions): List<String> =
        // get /scs/allowableFileExtensions
        withRawResponse().allowableFileExtensions(params, requestOptions).parse()

    override fun allowableFileMimes(params: ScAllowableFileMimesParams, requestOptions: RequestOptions): List<String> =
    ...
    override fun fileDownload(params: ScFileDownloadParams, requestOptions: RequestOptions): HttpResponse =
        // get /scs/download
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val folders: FolderService.WithRawResponse by lazy { FolderServiceImpl.WithRawResponseImpl(clientOptions) }

        private val classificationMarkings: ClassificationMarkingService.WithRawResponse by lazy { ClassificationMarkingServiceImpl.WithRawResponseImpl(clientOptions) }

        private val groups: GroupService.WithRawResponse by lazy { GroupServiceImpl.WithRawResponseImpl(clientOptions) }

        private val fileMetadata: FileMetadataService.WithRawResponse by lazy { FileMetadataServiceImpl.WithRawResponseImpl(clientOptions) }

        private val rangeParameters: RangeParameterService.WithRawResponse by lazy { RangeParameterServiceImpl.WithRawResponseImpl(clientOptions) }

        private val paths: PathService.WithRawResponse by lazy { PathServiceImpl.WithRawResponseImpl(clientOptions) }

        private val v2: V2Service.WithRawResponse by lazy { V2ServiceImpl.WithRawResponseImpl(clientOptions) }

        private val file: FileService.WithRawResponse by lazy { FileServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ScService.WithRawResponse = ScServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun folders(): FolderService.WithRawResponse = folders

        override fun classificationMarkings(): ClassificationMarkingService.WithRawResponse = classificationMarkings
        ...
        override fun aggregateDocType(params: ScAggregateDocTypeParams, requestOptions: RequestOptions): HttpResponseFor<List<String>> {
          val request = HttpRequest.builder()
        ...
        override fun allowableFileExtensions(params: ScAllowableFileExtensionsParams, requestOptions: RequestOptions): HttpResponseFor<List<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun allowableFileMimes(params: ScAllowableFileMimesParams, requestOptions: RequestOptions): HttpResponseFor<List<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun copy(params: ScCopyParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
        ...
        override fun fileUpload(params: ScFileUploadParams, requestOptions: RequestOptions): HttpResponseFor<String> {
        ...
        override fun move(params: ScMoveParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
        ...
        override fun search(params: ScSearchParams, requestOptions: RequestOptions): HttpResponseFor<List<FileData>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun updateTags(params: ScUpdateTagsParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
            .baseUrl(clientOptions.baseUrl())
