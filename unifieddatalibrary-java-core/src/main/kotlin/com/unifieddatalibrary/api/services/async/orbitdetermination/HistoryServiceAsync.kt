...
package com.unifieddatalibrary.api.services.async.orbitdetermination
...
import com.unifieddatalibrary.api.models.orbitdetermination.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/orbitdetermination/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/orbitdetermination/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/orbitdetermination/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
