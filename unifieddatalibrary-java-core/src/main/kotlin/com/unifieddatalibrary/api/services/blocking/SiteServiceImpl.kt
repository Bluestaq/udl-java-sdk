...
class SiteServiceImpl internal constructor(private val clientOptions: ClientOptions) : SiteService {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val operations: OperationService.WithRawResponse by lazy {
            OperationServiceImpl.WithRawResponseImpl(clientOptions)
        }

        override fun withOptions(
            modifier: Consumer<ClientOptions.Builder>
        ): SiteService.WithRawResponse =
            SiteServiceImpl.WithRawResponseImpl(
