...
class AntennaDetailServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    AntennaDetailService {

    private val withRawResponse: AntennaDetailService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): AntennaDetailService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AntennaDetailService =
        AntennaDetailServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AntennaDetailServiceImpl.WithRawResponseImpl(
