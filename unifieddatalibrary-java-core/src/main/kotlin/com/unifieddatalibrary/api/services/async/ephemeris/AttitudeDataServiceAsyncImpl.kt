...
class AttitudeDataServiceAsyncImpl internal constructor(
    ...
    override fun list(params: AttitudeDataListParams, requestOptions: RequestOptions): CompletableFuture<AttitudeDataListPageAsync> =
        // get /udl/attitudedata
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: AttitudeDataCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun list(params: AttitudeDataListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AttitudeDataListPageAsync>> {
        ...
        override fun count(params: AttitudeDataCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
