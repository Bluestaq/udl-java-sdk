...
class EngineDetailServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    EngineDetailServiceAsync {

    private val withRawResponse: EngineDetailServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): EngineDetailServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EngineDetailServiceAsync =
        EngineDetailServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EngineDetailServiceAsyncImpl.WithRawResponseImpl(
