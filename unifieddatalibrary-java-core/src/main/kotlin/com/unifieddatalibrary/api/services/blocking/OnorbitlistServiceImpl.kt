...
class OnorbitlistServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    OnorbitlistService {

    private val withRawResponse: OnorbitlistService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): OnorbitlistService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnorbitlistService =
        OnorbitlistServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnorbitlistServiceImpl.WithRawResponseImpl(
