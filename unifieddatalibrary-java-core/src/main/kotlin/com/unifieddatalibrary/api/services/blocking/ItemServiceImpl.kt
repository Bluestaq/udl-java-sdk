...
class ItemServiceImpl internal constructor(
    ...
    override fun queryhelp(params: ItemQueryhelpParams, requestOptions: RequestOptions): ItemQueryhelpResponse =
        // get /udl/item/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: ItemTupleParams, requestOptions: RequestOptions): List<ItemTupleResponse> =
        // get /udl/item/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: ItemUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: ItemCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun count(params: ItemCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: ItemGetParams, requestOptions: RequestOptions): HttpResponseFor<ItemGetResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: ItemQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<ItemQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: ItemTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<ItemTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: ItemUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
