...
class SgiServiceImpl internal constructor(private val clientOptions: ClientOptions) : SgiService {
    ...
    override fun getDataByEffectiveAsOfDate(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SgiServiceImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<SgiListResponse>> =
            jsonHandler<List<SgiListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: SgiListParams,
            requestOptions: RequestOptions,
        ...
        private val getHandler: Handler<SgiGetResponse> =
            jsonHandler<SgiGetResponse>(clientOptions.jsonMapper)
        ...
        private val getDataByEffectiveAsOfDateHandler:
            Handler<SgiGetDataByEffectiveAsOfDateResponse> =
            jsonHandler<SgiGetDataByEffectiveAsOfDateResponse>(clientOptions.jsonMapper)
        ...
        override fun getDataByEffectiveAsOfDate(
            ...
            return errorHandler.handle(response).parseable {
                response
                    .use { getDataByEffectiveAsOfDateHandler.handle(it) }
                    .also {
                        if (requestOptions.responseValidation!!) {
                            it.validate()
                        }
        ...
        private val queryhelpHandler: Handler<SgiQueryhelpResponse> =
            jsonHandler<SgiQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<SgiTupleResponse>> =
            jsonHandler<List<SgiTupleResponse>>(clientOptions.jsonMapper)
