...
package com.unifieddatalibrary.api.services.async.soiobservationset
...
import com.unifieddatalibrary.api.models.soiobservationset.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.soiobservationset.history.HistoryCountParams
import com.unifieddatalibrary.api.models.soiobservationset.history.HistoryListPage
import com.unifieddatalibrary.api.models.soiobservationset.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.soiobservationset.history.HistoryListParams
...
class HistoryServiceAsyncImpl internal constructor(
    ...
    override fun count(params: HistoryCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/soiobservationset/history/count
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val listHandler: Handler<List<SoiObservationSetFull>> = jsonHandler<List<SoiObservationSetFull>>(clientOptions.jsonMapper)
        ...
        override fun list(params: HistoryListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<HistoryListPageAsync>> {
          val request = HttpRequest.builder()
            ...
            .addPathSegments("udl", "soiobservationset", "history")
            .build()
        ...
        override fun aodr(params: HistoryAodrParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "soiobservationset", "history", "aodr")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun count(params: HistoryCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "soiobservationset", "history", "count")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
