...
package com.unifieddatalibrary.api.services.async.observations.obscorrelation
...
import com.unifieddatalibrary.api.models.observations.obscorrelation.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.observations.obscorrelation.history.HistoryListParams
import com.unifieddatalibrary.api.models.observations.obscorrelation.history.HistoryListResponse
...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(
        ...
        // get /udl/obscorrelation/history
    ...
    override fun aodr(
        ...
        // get /udl/obscorrelation/history/aodr
    ...
    override fun count(
        ...
        // get /udl/obscorrelation/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "obscorrelation", "history")
                    .build()
        ...
        override fun aodr(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "obscorrelation", "history", "aodr")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
        ...
        override fun count(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "obscorrelation", "history", "count")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
