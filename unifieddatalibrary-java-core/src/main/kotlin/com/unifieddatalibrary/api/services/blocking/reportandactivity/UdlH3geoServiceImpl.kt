...
class UdlH3geoServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    UdlH3geoService {

    private val withRawResponse: UdlH3geoService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): UdlH3geoService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): UdlH3geoService =
        UdlH3geoServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            UdlH3geoServiceImpl.WithRawResponseImpl(
