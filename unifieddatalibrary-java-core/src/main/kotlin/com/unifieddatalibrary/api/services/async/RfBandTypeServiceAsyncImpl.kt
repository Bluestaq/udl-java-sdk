...
class RfBandTypeServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    RfBandTypeServiceAsync {

    private val withRawResponse: RfBandTypeServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): RfBandTypeServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RfBandTypeServiceAsync =
        RfBandTypeServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(
        params: RfBandTypeQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            RfBandTypeServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<RfBandTypeListResponse>> =
            jsonHandler<List<RfBandTypeListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<RfBandTypeGetResponse> =
            jsonHandler<RfBandTypeGetResponse>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<RfBandTypeQueryhelpResponse> =
            jsonHandler<RfBandTypeQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<RfBandTypeTupleResponse>> =
            jsonHandler<List<RfBandTypeTupleResponse>>(clientOptions.jsonMapper)
