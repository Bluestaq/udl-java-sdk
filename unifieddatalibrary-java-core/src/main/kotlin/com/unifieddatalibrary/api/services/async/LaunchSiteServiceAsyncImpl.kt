...
class LaunchSiteServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    LaunchSiteServiceAsync {

    private val withRawResponse: LaunchSiteServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): LaunchSiteServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LaunchSiteServiceAsync =
        LaunchSiteServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            LaunchSiteServiceAsyncImpl.WithRawResponseImpl(
