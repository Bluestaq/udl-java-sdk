...
interface GlobalAtmosphericModelServiceAsync {
    ...
    ): CompletableFuture<GlobalAtmosphericModelRetrieveResponse> =
    ...
    fun getFile(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<HttpResponse> = getFile(params.toBuilder().id(id).build(), requestOptions)

    /** @see getFile */
    fun getFile(
        id: String,
        params: GlobalAtmosphericModelGetFileParams = GlobalAtmosphericModelGetFileParams.none(),
    ): CompletableFuture<HttpResponse> = getFile(id, params, RequestOptions.none())
     ...
     */
    fun queryHelp(): CompletableFuture<GlobalAtmosphericModelQueryHelpResponse> =
    ...
    fun queryHelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<GlobalAtmosphericModelQueryHelpResponse>
    ...
    ): CompletableFuture<List<GlobalAtmosphericModelTupleResponse>> =
    ...
    /**
     * A view of [GlobalAtmosphericModelServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * the same as [GlobalAtmosphericModelServiceAsync.retrieve].
         */
        fun retrieve(
            id: String
        ): CompletableFuture<HttpResponseFor<GlobalAtmosphericModelRetrieveResponse>> =
            retrieve(id, GlobalAtmosphericModelRetrieveParams.none())
         ...
         * otherwise the same as [GlobalAtmosphericModelServiceAsync.getFile].
         */
        fun getFile(id: String): CompletableFuture<HttpResponse> =
            getFile(id, GlobalAtmosphericModelGetFileParams.none())
        ...
        fun getFile(
            ...
            getFile(params.toBuilder().id(id).build(), requestOptions)
         ...
         * otherwise the same as [GlobalAtmosphericModelServiceAsync.queryHelp].
         */
        fun queryHelp():
            CompletableFuture<HttpResponseFor<GlobalAtmosphericModelQueryHelpResponse>> =
            queryHelp(GlobalAtmosphericModelQueryHelpParams.none())
         ...
         * the same as [GlobalAtmosphericModelServiceAsync.tuple].
         */
        fun tuple(
            params: GlobalAtmosphericModelTupleParams
        ): CompletableFuture<HttpResponseFor<List<GlobalAtmosphericModelTupleResponse>>> =
            tuple(params, RequestOptions.none())
         ...
         * otherwise the same as [GlobalAtmosphericModelServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: GlobalAtmosphericModelUnvalidatedPublishParams
