...
interface EventEvolutionService {
     ...
     */
    fun create(params: EventEvolutionCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun retrieve(id: String): EventEvolutionFull = retrieve(id, EventEvolutionRetrieveParams.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): EventEvolutionFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: EventEvolutionRetrieveParams = EventEvolutionRetrieveParams.none(),
    ): EventEvolutionFull = retrieve(id, params, RequestOptions.none())
    ...
    fun list(
        params: EventEvolutionListParams = EventEvolutionListParams.none()
    ): EventEvolutionListPage = list(params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<EventEvolutionCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) = createBulk(EventEvolutionCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<EventEvolutionCreateBulkParams.Body>) =
     ...
     */
    fun queryhelp(): EventEvolutionQueryhelpResponse =
    ...
    fun queryhelp(
        params: EventEvolutionQueryhelpParams = EventEvolutionQueryhelpParams.none()
    ): EventEvolutionQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<EventEvolutionUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            EventEvolutionUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<EventEvolutionUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
         ...
         * as [EventEvolutionService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            id: String,
            params: EventEvolutionRetrieveParams = EventEvolutionRetrieveParams.none(),
        ): HttpResponseFor<EventEvolutionFull> = retrieve(id, params, RequestOptions.none())
        ...
        fun list(
            params: EventEvolutionListParams = EventEvolutionListParams.none()
        ): HttpResponseFor<EventEvolutionListPage> = list(params, RequestOptions.none())
         ...
         * same as [EventEvolutionService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(EventEvolutionCountParams.none())
         ...
         * the same as [EventEvolutionService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<EventEvolutionCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/eventevolution/queryhelp`, but is otherwise the
         * same as [EventEvolutionService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<EventEvolutionQueryhelpResponse> =
            queryhelp(EventEvolutionQueryhelpParams.none())
         ...
         * same as [EventEvolutionService.tuple].
         */
        @MustBeClosed
         ...
         * same as [EventEvolutionService.unvalidatedPublish].
         */
        @MustBeClosed
