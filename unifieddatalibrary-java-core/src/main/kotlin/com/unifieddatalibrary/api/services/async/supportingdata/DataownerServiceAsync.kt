...
interface DataownerServiceAsync {
     ...
     */
    fun queryHelp(): CompletableFuture<DataownerQueryHelpResponse> =
    ...
    fun queryHelp(
        params: DataownerQueryHelpParams = DataownerQueryHelpParams.none()
    ): CompletableFuture<DataownerQueryHelpResponse> = queryHelp(params, RequestOptions.none())
    ...
    fun retrieveDataOwnerTypes(): CompletableFuture<List<String>> =
    ...
    ): CompletableFuture<List<String>> = retrieveDataOwnerTypes(params, RequestOptions.none())
    ...
    fun retrieveProviderMetadata(): CompletableFuture<List<DataownerAbridged>> =
    ...
    interface WithRawResponse {
         ...
         * as [DataownerServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<DataownerQueryHelpResponse>> =
            queryHelp(DataownerQueryHelpParams.none())
         ...
         * the same as [DataownerServiceAsync.retrieveDataOwnerTypes].
         */
        fun retrieveDataOwnerTypes(): CompletableFuture<HttpResponseFor<List<String>>> =
            retrieveDataOwnerTypes(DataownerRetrieveDataOwnerTypesParams.none())
        ...
        fun retrieveDataOwnerTypes(
            ...
            retrieveDataOwnerTypes(params, RequestOptions.none())
         ...
         * the same as [DataownerServiceAsync.retrieveProviderMetadata].
         */
        fun retrieveProviderMetadata():
            CompletableFuture<HttpResponseFor<List<DataownerAbridged>>> =
            retrieveProviderMetadata(DataownerRetrieveProviderMetadataParams.none())
