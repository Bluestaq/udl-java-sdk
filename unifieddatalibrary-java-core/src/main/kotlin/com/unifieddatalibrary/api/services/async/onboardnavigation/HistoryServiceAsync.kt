...
package com.unifieddatalibrary.api.services.async.onboardnavigation
...
import com.unifieddatalibrary.api.models.onboardnavigation.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/onboardnavigation/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/onboardnavigation/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/onboardnavigation/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
