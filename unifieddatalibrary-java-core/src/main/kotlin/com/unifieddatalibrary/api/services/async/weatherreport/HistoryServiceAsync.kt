...
package com.unifieddatalibrary.api.services.async.weatherreport
...
import com.unifieddatalibrary.api.models.weatherreport.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/weatherreport/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/weatherreport/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/weatherreport/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
