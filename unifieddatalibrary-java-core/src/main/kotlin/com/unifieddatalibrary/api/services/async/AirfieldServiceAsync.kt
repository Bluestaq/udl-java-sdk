...
interface AirfieldServiceAsync {
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<AirfieldFull> = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirfieldRetrieveParams = AirfieldRetrieveParams.none(),
    ): CompletableFuture<AirfieldFull> = retrieve(id, params, RequestOptions.none())
    ...
    fun list(
        params: AirfieldListParams = AirfieldListParams.none()
    ): CompletableFuture<AirfieldListPageAsync> = list(params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<AirfieldQueryhelpResponse> =
    ...
    fun queryhelp(
        params: AirfieldQueryhelpParams = AirfieldQueryhelpParams.none()
    ): CompletableFuture<AirfieldQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [AirfieldServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<AirfieldListPageAsync>> =
            list(AirfieldListParams.none())
         ...
         * as [AirfieldServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<AirfieldQueryhelpResponse>> =
            queryhelp(AirfieldQueryhelpParams.none())
