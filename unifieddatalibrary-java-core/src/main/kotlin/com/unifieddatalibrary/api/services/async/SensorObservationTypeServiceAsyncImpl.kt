...
class SensorObservationTypeServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SensorObservationTypeServiceAsync {

    private val withRawResponse: SensorObservationTypeServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): SensorObservationTypeServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SensorObservationTypeServiceAsync = SensorObservationTypeServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun list(params: SensorObservationTypeListParams, requestOptions: RequestOptions): CompletableFuture<SensorObservationTypeListPageAsync> =
        // get /udl/sensorobservationtype
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun get(params: SensorObservationTypeGetParams, requestOptions: RequestOptions): CompletableFuture<SensorObservationTypeGetResponse> =
        // get /udl/sensorobservationtype/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: SensorObservationTypeQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<SensorObservationTypeQueryhelpResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SensorObservationTypeServiceAsync.WithRawResponse = SensorObservationTypeServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: SensorObservationTypeListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SensorObservationTypeListPageAsync>> {
        ...
        override fun get(params: SensorObservationTypeGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SensorObservationTypeGetResponse>> {
        ...
        override fun queryhelp(params: SensorObservationTypeQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SensorObservationTypeQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
