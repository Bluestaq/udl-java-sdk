...
class SolarArrayDetailServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SolarArrayDetailService {

    private val withRawResponse: SolarArrayDetailService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): SolarArrayDetailService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SolarArrayDetailService = SolarArrayDetailServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: SolarArrayDetailListParams, requestOptions: RequestOptions): SolarArrayDetailListPage =
    ...
    override fun get(params: SolarArrayDetailGetParams, requestOptions: RequestOptions): SolarArrayDetailsFull =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SolarArrayDetailService.WithRawResponse = SolarArrayDetailServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: SolarArrayDetailCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: SolarArrayDetailUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: SolarArrayDetailListParams, requestOptions: RequestOptions): HttpResponseFor<SolarArrayDetailListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: SolarArrayDetailDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun get(params: SolarArrayDetailGetParams, requestOptions: RequestOptions): HttpResponseFor<SolarArrayDetailsFull> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
