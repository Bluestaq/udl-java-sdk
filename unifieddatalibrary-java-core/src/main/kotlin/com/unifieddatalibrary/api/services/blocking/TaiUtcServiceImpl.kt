...
class TaiUtcServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : TaiUtcService {

    private val withRawResponse: TaiUtcService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): TaiUtcService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TaiUtcService = TaiUtcServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(params: TaiUtcQueryhelpParams, requestOptions: RequestOptions): TaiUtcQueryhelpResponse =
        // get /udl/taiutc/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: TaiUtcTupleParams, requestOptions: RequestOptions): List<TaiutcFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TaiUtcService.WithRawResponse = TaiUtcServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: TaiUtcCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: TaiUtcUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: TaiUtcListParams, requestOptions: RequestOptions): HttpResponseFor<TaiUtcListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: TaiUtcDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: TaiUtcCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: TaiUtcGetParams, requestOptions: RequestOptions): HttpResponseFor<TaiutcFull> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: TaiUtcQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<TaiUtcQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: TaiUtcTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<TaiutcFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
