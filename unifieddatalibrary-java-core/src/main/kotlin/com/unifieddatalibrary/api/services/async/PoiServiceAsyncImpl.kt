...
class PoiServiceAsyncImpl internal constructor(
    ...
    override fun create(params: PoiCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/poi
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun list(params: PoiListParams, requestOptions: RequestOptions): CompletableFuture<PoiListPageAsync> =
        // get /udl/poi
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: PoiCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/poi/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: PoiCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/poi/createBulk
        withRawResponse().createBulk(params, requestOptions).thenAccept {}

    override fun get(params: PoiGetParams, requestOptions: RequestOptions): CompletableFuture<PoiGetResponse> =
        // get /udl/poi/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: PoiQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<PoiQueryhelpResponse> =
        // get /udl/poi/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: PoiTupleParams, requestOptions: RequestOptions): CompletableFuture<List<PoiTupleResponse>> =
        // get /udl/poi/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun unvalidatedPublish(params: PoiUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: PoiCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: PoiListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PoiListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: PoiCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: PoiCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: PoiGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PoiGetResponse>> {
        ...
        override fun queryhelp(params: PoiQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PoiQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: PoiTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<PoiTupleResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: PoiUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
