...
package com.unifieddatalibrary.api.services.blocking.ecpedr
...
import com.unifieddatalibrary.api.models.ecpedr.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/ecpedr/history`, but is otherwise the same as
         * [HistoryService.list].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/ecpedr/history/aodr`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/ecpedr/history/count`, but is otherwise the
