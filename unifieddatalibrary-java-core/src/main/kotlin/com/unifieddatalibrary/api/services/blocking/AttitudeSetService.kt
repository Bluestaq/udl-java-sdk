...
interface AttitudeSetService {
     ...
     * </h3>
     */
    fun create(params: AttitudeSetCreateParams) =
        create(
          params, RequestOptions.none()
        )

    /** @see create */
    fun create(params: AttitudeSetCreateParams, requestOptions: RequestOptions = RequestOptions.none())

    /** Service operation to get a single AttitudeSet record by its unique ID passed as a path parameter. */
    fun retrieve(id: String): AttitudesetFull =
        retrieve(
          id, AttitudeSetRetrieveParams.none()
        )

    /** @see retrieve */
    fun retrieve(id: String, params: AttitudeSetRetrieveParams = AttitudeSetRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AttitudesetFull =
        retrieve(
          params.toBuilder()
              .id(id)
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: AttitudeSetRetrieveParams = AttitudeSetRetrieveParams.none()): AttitudesetFull =
        retrieve(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see retrieve */
    fun retrieve(params: AttitudeSetRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): AttitudesetFull
    ...
    /** @see list */
    fun list(params: AttitudeSetListParams, requestOptions: RequestOptions = RequestOptions.none()): AttitudeSetListPage

    /** Service operation to return the count of records satisfying the specified query parameters. This operation is useful to determine how many records pass a particular query criteria without retrieving large amounts of data. See the queryhelp operation (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query parameter information. */
    fun count(params: AttitudeSetCountParams): String =
        count(
          params, RequestOptions.none()
        )

    /** @see count */
    fun count(params: AttitudeSetCountParams, requestOptions: RequestOptions = RequestOptions.none()): String

    /** Service operation to provide detailed information on available dynamic query parameters for a particular data type. */
    fun queryHelp(): AttitudeSetQueryHelpResponse = queryHelp(AttitudeSetQueryHelpParams.none())

    /** @see queryHelp */
    fun queryHelp(params: AttitudeSetQueryHelpParams = AttitudeSetQueryHelpParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AttitudeSetQueryHelpResponse

    /** @see queryHelp */
    fun queryHelp(params: AttitudeSetQueryHelpParams = AttitudeSetQueryHelpParams.none()): AttitudeSetQueryHelpResponse =
        queryHelp(
          params, RequestOptions.none()
        )
    ...
    /** @see tuple */
    fun tuple(params: AttitudeSetTupleParams, requestOptions: RequestOptions = RequestOptions.none()): List<AttitudesetFull>
    ...
    fun unvalidatedPublish(params: AttitudeSetUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): AttitudeSetService.WithRawResponse

        fun history(): HistoryService.WithRawResponse

        /** Returns a raw HTTP response for `post /udl/attitudeset`, but is otherwise the same as [AttitudeSetService.create]. */
        @MustBeClosed
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: AttitudeSetCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `get /udl/attitudeset/{id}`, but is otherwise the same as [AttitudeSetService.retrieve]. */
        @MustBeClosed
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: AttitudeSetRetrieveParams = AttitudeSetRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AttitudesetFull> =
            retrieve(
              params.toBuilder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: AttitudeSetRetrieveParams = AttitudeSetRetrieveParams.none()): HttpResponseFor<AttitudesetFull> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: AttitudeSetRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AttitudesetFull>
        ...
        /** Returns a raw HTTP response for `get /udl/attitudeset`, but is otherwise the same as [AttitudeSetService.list]. */
        @MustBeClosed
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: AttitudeSetListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AttitudeSetListPage>

        /** Returns a raw HTTP response for `get /udl/attitudeset/count`, but is otherwise the same as [AttitudeSetService.count]. */
        @MustBeClosed
        ...
        /** @see count */
        @MustBeClosed
        fun count(params: AttitudeSetCountParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<String>

        /** Returns a raw HTTP response for `get /udl/attitudeset/queryhelp`, but is otherwise the same as [AttitudeSetService.queryHelp]. */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<AttitudeSetQueryHelpResponse> = queryHelp(AttitudeSetQueryHelpParams.none())

        /** @see queryHelp */
        @MustBeClosed
        fun queryHelp(params: AttitudeSetQueryHelpParams = AttitudeSetQueryHelpParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AttitudeSetQueryHelpResponse>

        /** @see queryHelp */
        @MustBeClosed
        fun queryHelp(params: AttitudeSetQueryHelpParams = AttitudeSetQueryHelpParams.none()): HttpResponseFor<AttitudeSetQueryHelpResponse> =
            queryHelp(
              params, RequestOptions.none()
            )
        ...
        /** @see queryHelp */
        @MustBeClosed
        fun queryHelp(requestOptions: RequestOptions): HttpResponseFor<AttitudeSetQueryHelpResponse> =
            queryHelp(
              AttitudeSetQueryHelpParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `get /udl/attitudeset/tuple`, but is otherwise the same as [AttitudeSetService.tuple]. */
        @MustBeClosed
        ...
        /** @see tuple */
        @MustBeClosed
        fun tuple(params: AttitudeSetTupleParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<List<AttitudesetFull>>

        /** Returns a raw HTTP response for `post /filedrop/udl-attitudeset`, but is otherwise the same as [AttitudeSetService.unvalidatedPublish]. */
        @MustBeClosed
        ...
        /** @see unvalidatedPublish */
        @MustBeClosed
        fun unvalidatedPublish(params: AttitudeSetUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
