...
class EntityServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun getAllTypes(
        params: EntityGetAllTypesParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val retrieveHandler: Handler<EntityFull> =
            jsonHandler<EntityFull>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<List<EntityAbridged>> =
            jsonHandler<List<EntityAbridged>>(clientOptions.jsonMapper)
        ...
        private val getAllTypesHandler: Handler<List<String>> =
        ...
        override fun getAllTypes(
            ...
            return request
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response.use { getAllTypesHandler.handle(it) }
                    }
                }
        }

        private val queryHelpHandler: Handler<EntityQueryHelpResponse> =
            jsonHandler<EntityQueryHelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<EntityFull>> =
            jsonHandler<List<EntityFull>>(clientOptions.jsonMapper)
