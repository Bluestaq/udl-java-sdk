...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/taiutc/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/taiutc/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/taiutc/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
