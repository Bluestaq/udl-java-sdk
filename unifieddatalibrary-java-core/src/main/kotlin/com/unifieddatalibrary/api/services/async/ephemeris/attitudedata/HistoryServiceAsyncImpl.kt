...
class HistoryServiceAsyncImpl internal constructor(
    ...
    override fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions): CompletableFuture<List<AttitudedataFull>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val retrieveHandler: Handler<List<AttitudedataFull>> = jsonHandler<List<AttitudedataFull>>(clientOptions.jsonMapper)

        override fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<AttitudedataFull>>> {
