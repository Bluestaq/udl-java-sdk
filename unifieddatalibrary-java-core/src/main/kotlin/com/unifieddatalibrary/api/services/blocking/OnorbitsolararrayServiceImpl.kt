...
class OnorbitsolararrayServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : OnorbitsolararrayService {

    private val withRawResponse: OnorbitsolararrayService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): OnorbitsolararrayService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnorbitsolararrayService = OnorbitsolararrayServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: OnorbitsolararrayListParams, requestOptions: RequestOptions): OnorbitsolararrayListPage =
    ...
    override fun get(params: OnorbitsolararrayGetParams, requestOptions: RequestOptions): OnorbitSolarArrayFull =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnorbitsolararrayService.WithRawResponse = OnorbitsolararrayServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: OnorbitsolararrayCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: OnorbitsolararrayUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: OnorbitsolararrayListParams, requestOptions: RequestOptions): HttpResponseFor<OnorbitsolararrayListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: OnorbitsolararrayDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun get(params: OnorbitsolararrayGetParams, requestOptions: RequestOptions): HttpResponseFor<OnorbitSolarArrayFull> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
