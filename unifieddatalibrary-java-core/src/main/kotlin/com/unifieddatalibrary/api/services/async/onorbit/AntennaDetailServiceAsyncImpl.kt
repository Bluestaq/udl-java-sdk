...
class AntennaDetailServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    AntennaDetailServiceAsync {

    private val withRawResponse: AntennaDetailServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): AntennaDetailServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AntennaDetailServiceAsync =
        AntennaDetailServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        params: AntennaDetailListParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AntennaDetailServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val retrieveHandler: Handler<AntennaDetailsFull> =
            jsonHandler<AntennaDetailsFull>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<List<AntennaDetailsAbridged>> =
            jsonHandler<List<AntennaDetailsAbridged>>(clientOptions.jsonMapper)
