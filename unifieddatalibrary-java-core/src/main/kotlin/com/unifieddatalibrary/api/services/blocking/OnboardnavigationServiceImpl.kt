...
class OnboardnavigationServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : OnboardnavigationService {

    private val withRawResponse: OnboardnavigationService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): OnboardnavigationService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnboardnavigationService = OnboardnavigationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryService = history

    override fun list(params: OnboardnavigationListParams, requestOptions: RequestOptions): OnboardnavigationListPage =
        // get /udl/onboardnavigation
        withRawResponse().list(params, requestOptions).parse()

    override fun count(params: OnboardnavigationCountParams, requestOptions: RequestOptions): String =
        // get /udl/onboardnavigation/count
        withRawResponse().count(params, requestOptions).parse()

    override fun createBulk(params: OnboardnavigationCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/onboardnavigation/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun queryhelp(params: OnboardnavigationQueryhelpParams, requestOptions: RequestOptions): OnboardnavigationQueryhelpResponse =
        // get /udl/onboardnavigation/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: OnboardnavigationTupleParams, requestOptions: RequestOptions): List<OnboardnavigationFull> =
        // get /udl/onboardnavigation/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: OnboardnavigationUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnboardnavigationService.WithRawResponse = OnboardnavigationServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: OnboardnavigationListParams, requestOptions: RequestOptions): HttpResponseFor<OnboardnavigationListPage> {
        ...
        override fun count(params: OnboardnavigationCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: OnboardnavigationCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: OnboardnavigationQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<OnboardnavigationQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: OnboardnavigationTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<OnboardnavigationFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: OnboardnavigationUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
