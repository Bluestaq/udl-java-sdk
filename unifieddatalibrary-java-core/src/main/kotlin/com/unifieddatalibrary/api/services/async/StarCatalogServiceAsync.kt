...
interface StarCatalogServiceAsync {
    ...
    /**
     * Service operation to take a single StarCatalog record as a POST body and ingest into the
    ...
    /**
     * Service operation to update a single starcatalog record. A specific role is required to
    ...
    /** @see list */
    fun list(
        params: StarCatalogListParams = StarCatalogListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun list(
        params: StarCatalogListParams = StarCatalogListParams.none()
    ): CompletableFuture<StarCatalogListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<StarCatalogListPageAsync> =
        list(StarCatalogListParams.none(), requestOptions)

    /**
     * Service operation to delete a dataset specified by the passed ID path parameter. A specific
     * role is required to perform this service operation. Please contact the UDL team for
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, StarCatalogDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: StarCatalogDeleteParams = StarCatalogDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun delete(id: String, requestOptions: RequestOptions): CompletableFuture<Void?> =
        delete(id, StarCatalogDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: StarCatalogCountParams = StarCatalogCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun count(requestOptions: RequestOptions): CompletableFuture<String> =
        count(StarCatalogCountParams.none(), requestOptions)

    /**
     * Service operation intended for initial integration only, to take a list of StarCatalog
    ...
    fun get(id: String): CompletableFuture<StarCatalogGetResponse> =
        get(id, StarCatalogGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: StarCatalogGetParams = StarCatalogGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun get(
        id: String,
        params: StarCatalogGetParams = StarCatalogGetParams.none(),
    ): CompletableFuture<StarCatalogGetResponse> = get(id, params, RequestOptions.none())
    ...
    fun get(id: String, requestOptions: RequestOptions): CompletableFuture<StarCatalogGetResponse> =
        get(id, StarCatalogGetParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<StarCatalogQueryhelpResponse> =
        queryhelp(StarCatalogQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: StarCatalogQueryhelpParams = StarCatalogQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: StarCatalogQueryhelpParams = StarCatalogQueryhelpParams.none()
    ): CompletableFuture<StarCatalogQueryhelpResponse> = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): CompletableFuture<StarCatalogQueryhelpResponse> =
        queryhelp(StarCatalogQueryhelpParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/starcatalog`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `put /udl/starcatalog/{id}`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/starcatalog`, but is otherwise the same as
         * [StarCatalogServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<StarCatalogListPageAsync>> =
            list(StarCatalogListParams.none())
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/starcatalog/{id}`, but is otherwise the same
         * as [StarCatalogServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, StarCatalogDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/starcatalog/count`, but is otherwise the same
         * as [StarCatalogServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(StarCatalogCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `post /udl/starcatalog/createBulk`, but is otherwise the
         * same as [StarCatalogServiceAsync.createBulk].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/starcatalog/queryhelp`, but is otherwise the
         * same as [StarCatalogServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<StarCatalogQueryhelpResponse>> =
            queryhelp(StarCatalogQueryhelpParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/starcatalog/tuple`, but is otherwise the same
         * as [StarCatalogServiceAsync.tuple].
         */
        fun tuple(
            params: StarCatalogTupleParams
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-starcatalog`, but is otherwise the
         * same as [StarCatalogServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: StarCatalogUnvalidatedPublishParams
