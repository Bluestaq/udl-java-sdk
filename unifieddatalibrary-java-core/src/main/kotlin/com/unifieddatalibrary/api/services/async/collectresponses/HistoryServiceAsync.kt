...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/collectresponse/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/collectresponse/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
