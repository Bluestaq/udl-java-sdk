...
class SeraDataNavigationServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SeraDataNavigationService {

    private val withRawResponse: SeraDataNavigationService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): SeraDataNavigationService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SeraDataNavigationService = SeraDataNavigationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: SeraDataNavigationListParams, requestOptions: RequestOptions): SeraDataNavigationListPage =
    ...
    override fun count(params: SeraDataNavigationCountParams, requestOptions: RequestOptions): String =
        // get /udl/seradatanavigation/count
        withRawResponse().count(params, requestOptions).parse()

    override fun get(params: SeraDataNavigationGetParams, requestOptions: RequestOptions): SeraDataNavigationGetResponse =
        // get /udl/seradatanavigation/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: SeraDataNavigationQueryhelpParams, requestOptions: RequestOptions): SeraDataNavigationQueryhelpResponse =
        // get /udl/seradatanavigation/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: SeraDataNavigationTupleParams, requestOptions: RequestOptions): List<SeraDataNavigationTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SeraDataNavigationService.WithRawResponse = SeraDataNavigationServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: SeraDataNavigationCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: SeraDataNavigationUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: SeraDataNavigationListParams, requestOptions: RequestOptions): HttpResponseFor<SeraDataNavigationListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: SeraDataNavigationDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: SeraDataNavigationCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: SeraDataNavigationGetParams, requestOptions: RequestOptions): HttpResponseFor<SeraDataNavigationGetResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: SeraDataNavigationQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<SeraDataNavigationQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: SeraDataNavigationTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<SeraDataNavigationTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
