...
internal constructor(private val clientOptions: ClientOptions) : CollectRequestServiceAsync {
    ...
    private val withRawResponse: CollectRequestServiceAsync.WithRawResponse by lazy {
    ...
    override fun retrieve(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<CollectRequestFull> =
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<CollectRequestListPageAsync> =
    ...
    override fun queryHelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<CollectRequestQueryHelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<CollectRequestFull>> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            CollectRequestServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun retrieve(
            params: CollectRequestRetrieveParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CollectRequestFull>> {
        ...
        override fun list(
            params: CollectRequestListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CollectRequestListPageAsync>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(
            params: CollectRequestQueryHelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CollectRequestQueryHelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(
            params: CollectRequestTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<CollectRequestFull>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
