...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history`, but is otherwise the same as [HistoryService.query]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history/aodr`, but is otherwise the same as [HistoryService.writeAodr]. */
        @MustBeClosed
