...
interface HistoryServiceAsync {
    ...
    fun retrieve(params: HistoryRetrieveParams): CompletableFuture<List<AttitudedataFull>> =
        retrieve(
          params, RequestOptions.none()
        )

    /** @see retrieve */
    fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<List<AttitudedataFull>>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/attitudedata/history`, but is otherwise the same as [HistoryServiceAsync.retrieve]. */
        fun retrieve(params: HistoryRetrieveParams): CompletableFuture<HttpResponseFor<List<AttitudedataFull>>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<List<AttitudedataFull>>>

        /** Returns a raw HTTP response for `get /udl/attitudedata/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/attitudedata/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
