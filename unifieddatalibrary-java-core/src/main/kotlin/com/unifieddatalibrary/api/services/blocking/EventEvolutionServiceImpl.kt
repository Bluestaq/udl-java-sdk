...
class EventEvolutionServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : EventEvolutionService {

    private val withRawResponse: EventEvolutionService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): EventEvolutionService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EventEvolutionService = EventEvolutionServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: EventEvolutionRetrieveParams, requestOptions: RequestOptions): EventEvolutionFull =
        // get /udl/eventevolution/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: EventEvolutionListParams, requestOptions: RequestOptions): EventEvolutionListPage =
    ...
    override fun createBulk(params: EventEvolutionCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/eventevolution/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun queryhelp(params: EventEvolutionQueryhelpParams, requestOptions: RequestOptions): EventEvolutionQueryhelpResponse =
        // get /udl/eventevolution/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: EventEvolutionTupleParams, requestOptions: RequestOptions): List<EventEvolutionFull> =
        // get /udl/eventevolution/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: EventEvolutionUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EventEvolutionService.WithRawResponse = EventEvolutionServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: EventEvolutionCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: EventEvolutionRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<EventEvolutionFull> {
        ...
        override fun list(params: EventEvolutionListParams, requestOptions: RequestOptions): HttpResponseFor<EventEvolutionListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "eventevolution")
        ...
        override fun count(params: EventEvolutionCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: EventEvolutionCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: EventEvolutionQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<EventEvolutionQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: EventEvolutionTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<EventEvolutionFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: EventEvolutionUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
