...
package com.unifieddatalibrary.api.services.async.collectrequests

import com.unifieddatalibrary.api.core.ClientOptions
import com.unifieddatalibrary.api.core.RequestOptions
import com.unifieddatalibrary.api.core.http.HttpResponse
import com.unifieddatalibrary.api.core.http.HttpResponseFor
import com.unifieddatalibrary.api.models.collectrequests.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.collectrequests.history.HistoryCountParams
import com.unifieddatalibrary.api.models.collectrequests.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/collectrequest/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/collectrequest/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/collectrequest/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
