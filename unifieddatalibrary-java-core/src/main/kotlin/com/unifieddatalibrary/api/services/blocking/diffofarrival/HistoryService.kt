...
package com.unifieddatalibrary.api.services.blocking.diffofarrival
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/diffofarrival/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
