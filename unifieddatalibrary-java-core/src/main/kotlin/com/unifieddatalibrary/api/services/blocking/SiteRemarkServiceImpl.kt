...
class SiteRemarkServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SiteRemarkService {

    private val withRawResponse: SiteRemarkService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): SiteRemarkService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SiteRemarkService = SiteRemarkServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: SiteRemarkListParams, requestOptions: RequestOptions): SiteRemarkListPage =
        // get /udl/siteremark
    ...
    override fun get(params: SiteRemarkGetParams, requestOptions: RequestOptions): SiteRemarkGetResponse =
        // get /udl/siteremark/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: SiteRemarkQueryhelpParams, requestOptions: RequestOptions): SiteRemarkQueryhelpResponse =
        // get /udl/siteremark/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: SiteRemarkTupleParams, requestOptions: RequestOptions): List<SiteRemarkTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SiteRemarkService.WithRawResponse = SiteRemarkServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: SiteRemarkCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: SiteRemarkListParams, requestOptions: RequestOptions): HttpResponseFor<SiteRemarkListPage> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: SiteRemarkCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: SiteRemarkGetParams, requestOptions: RequestOptions): HttpResponseFor<SiteRemarkGetResponse> {
        ...
        override fun queryhelp(params: SiteRemarkQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<SiteRemarkQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: SiteRemarkTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<SiteRemarkTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
