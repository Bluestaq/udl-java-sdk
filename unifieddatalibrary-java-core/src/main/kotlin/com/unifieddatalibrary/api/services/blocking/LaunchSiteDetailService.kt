...
interface LaunchSiteDetailService {
     ...
     */
    fun create(params: LaunchSiteDetailCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: LaunchSiteDetailUpdateParams) = update(params, RequestOptions.none())
    ...
    fun list(
        params: LaunchSiteDetailListParams = LaunchSiteDetailListParams.none()
    ): LaunchSiteDetailListPage = list(params, RequestOptions.none())
     ...
     */
    fun delete(id: String) = delete(id, LaunchSiteDetailDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: LaunchSiteDetailDeleteParams) = delete(params, RequestOptions.none())
    ...
    ): List<LaunchSiteDetailFindBySourceResponse> = findBySource(params, RequestOptions.none())
     ...
     */
    fun get(id: String): LaunchSiteDetailGetResponse = get(id, LaunchSiteDetailGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): LaunchSiteDetailGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: LaunchSiteDetailGetParams = LaunchSiteDetailGetParams.none(),
    ): LaunchSiteDetailGetResponse = get(id, params, RequestOptions.none())
    ...
    /**
     * A view of [LaunchSiteDetailService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [LaunchSiteDetailService.create].
         */
        @MustBeClosed
         ...
         * same as [LaunchSiteDetailService.update].
         */
        @MustBeClosed
         ...
         * as [LaunchSiteDetailService.list].
         */
        @MustBeClosed
        fun list(): HttpResponseFor<LaunchSiteDetailListPage> =
        ...
        fun list(
            params: LaunchSiteDetailListParams = LaunchSiteDetailListParams.none()
        ): HttpResponseFor<LaunchSiteDetailListPage> = list(params, RequestOptions.none())
         ...
         * the same as [LaunchSiteDetailService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, LaunchSiteDetailDeleteParams.none())
         ...
         * otherwise the same as [LaunchSiteDetailService.findBySource].
         */
        @MustBeClosed
        fun findBySource(
            params: LaunchSiteDetailFindBySourceParams
         ...
         * same as [LaunchSiteDetailService.get].
         */
        @MustBeClosed
        ...
        fun get(
            id: String,
            params: LaunchSiteDetailGetParams = LaunchSiteDetailGetParams.none(),
        ): HttpResponseFor<LaunchSiteDetailGetResponse> = get(id, params, RequestOptions.none())
