...
interface H3GeoServiceAsync {
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<H3GeoListPageAsync>
     ...
     */
    fun get(id: String): CompletableFuture<H3GeoGetResponse> = get(id, H3GeoGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<H3GeoGetResponse> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: H3GeoGetParams = H3GeoGetParams.none(),
    ): CompletableFuture<H3GeoGetResponse> = get(id, params, RequestOptions.none())

    /** @see get */
    fun get(
        params: H3GeoGetParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<H3GeoGetResponse>
     ...
     */
    fun queryhelp(): CompletableFuture<H3GeoQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<H3GeoQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: H3GeoQueryhelpParams = H3GeoQueryhelpParams.none()
    ): CompletableFuture<H3GeoQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<H3GeoTupleResponse>>
    ...
    interface WithRawResponse {
        ...
        fun get(
            ...
            params: H3GeoGetParams = H3GeoGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<H3GeoGetResponse>> =
         ...
         * [H3GeoServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<H3GeoQueryhelpResponse>> =
            queryhelp(H3GeoQueryhelpParams.none())
        ...
        fun queryhelp(
            params: H3GeoQueryhelpParams = H3GeoQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<H3GeoQueryhelpResponse>>
         ...
         * [H3GeoServiceAsync.tuple].
         */
        fun tuple(
            params: H3GeoTupleParams
        ): CompletableFuture<HttpResponseFor<List<H3GeoTupleResponse>>> =
            tuple(params, RequestOptions.none())
