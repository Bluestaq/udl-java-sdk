...
class AttitudeDataServiceImpl internal constructor(
    ...
    override fun queryHelp(params: AttitudeDataQueryHelpParams, requestOptions: RequestOptions): AttitudeDataQueryHelpResponse =
        // get /udl/attitudedata/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: AttitudeDataTupleParams, requestOptions: RequestOptions): List<AttitudedataFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun queryHelp(params: AttitudeDataQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<AttitudeDataQueryHelpResponse> {
        ...
        override fun tuple(params: AttitudeDataTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<AttitudedataFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
