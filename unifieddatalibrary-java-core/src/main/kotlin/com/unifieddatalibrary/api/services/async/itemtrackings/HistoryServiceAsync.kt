...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/itemtracking/history`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/itemtracking/history/count`, but is otherwise
