...
class CalibrationServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CalibrationService {

    private val withRawResponse: CalibrationService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): CalibrationService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CalibrationService = CalibrationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: CalibrationRetrieveParams, requestOptions: RequestOptions): CalibrationRetrieveResponse =
    ...
    override fun query(params: CalibrationQueryParams, requestOptions: RequestOptions): List<CalibrationQueryResponse> =
        // get /udl/sensorcalibration
        withRawResponse().query(params, requestOptions).parse()

    override fun queryHelp(params: CalibrationQueryHelpParams, requestOptions: RequestOptions): CalibrationQueryHelpResponse =
        // get /udl/sensorcalibration/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: CalibrationTupleParams, requestOptions: RequestOptions): List<CalibrationTupleResponse> =
        // get /udl/sensorcalibration/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: CalibrationUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CalibrationService.WithRawResponse = CalibrationServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: CalibrationCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: CalibrationRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CalibrationRetrieveResponse> {
        ...
        override fun count(params: CalibrationCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: CalibrationCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun query(params: CalibrationQueryParams, requestOptions: RequestOptions): HttpResponseFor<List<CalibrationQueryResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "sensorcalibration")
        ...
        override fun queryHelp(params: CalibrationQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<CalibrationQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: CalibrationTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<CalibrationTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: CalibrationUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
