...
class DataTypeServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : DataTypeServiceAsync {

    private val withRawResponse: DataTypeServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): DataTypeServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DataTypeServiceAsync = DataTypeServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun list(params: DataTypeListParams, requestOptions: RequestOptions): CompletableFuture<DataTypeListPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DataTypeServiceAsync.WithRawResponse = DataTypeServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val listHandler: Handler<List<String>> = jsonHandler<List<String>>(clientOptions.jsonMapper)

        override fun list(params: DataTypeListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<DataTypeListPageAsync>> {
