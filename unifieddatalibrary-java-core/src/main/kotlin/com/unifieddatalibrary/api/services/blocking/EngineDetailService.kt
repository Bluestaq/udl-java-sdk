...
interface EngineDetailService {
     ...
     */
    fun create(params: EngineDetailCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun retrieve(id: String): EngineDetailsFull = retrieve(id, EngineDetailRetrieveParams.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): EngineDetailsFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: EngineDetailRetrieveParams = EngineDetailRetrieveParams.none(),
    ): EngineDetailsFull = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: EngineDetailUpdateParams) = update(params, RequestOptions.none())
     ...
     * contact the UDL team for assistance.
     */
    fun delete(id: String) = delete(id, EngineDetailDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: EngineDetailDeleteParams) = delete(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [EngineDetailService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            id: String,
            params: EngineDetailRetrieveParams = EngineDetailRetrieveParams.none(),
        ): HttpResponseFor<EngineDetailsFull> = retrieve(id, params, RequestOptions.none())
        ...
        fun list(
            params: EngineDetailListParams = EngineDetailListParams.none()
        ): HttpResponseFor<EngineDetailListPage> = list(params, RequestOptions.none())
         ...
         * same as [EngineDetailService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, EngineDetailDeleteParams.none())
