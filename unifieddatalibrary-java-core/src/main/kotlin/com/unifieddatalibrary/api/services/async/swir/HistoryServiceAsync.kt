...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/swir/history`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/swir/history/aodr`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/swir/history/count`, but is otherwise the same
