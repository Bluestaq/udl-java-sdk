...
interface LinkStatusServiceAsync {
    ...
    /** @see list */
    fun list(
        params: LinkStatusListParams = LinkStatusListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<LinkStatusListPageAsync>

    /** @see list */
    fun list(
        params: LinkStatusListParams = LinkStatusListParams.none()
    ): CompletableFuture<LinkStatusListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<LinkStatusListPageAsync> =
        list(LinkStatusListParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: LinkStatusCountParams = LinkStatusCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun count(requestOptions: RequestOptions): CompletableFuture<String> =
        count(LinkStatusCountParams.none(), requestOptions)

    /**
     * Service operation to get a single LinkStatus record by its unique ID passed as a path
     * parameter.
     */
    fun get(id: String): CompletableFuture<LinkStatusGetResponse> =
        get(id, LinkStatusGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: LinkStatusGetParams = LinkStatusGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<LinkStatusGetResponse> =
    ...
    fun get(
        id: String,
        params: LinkStatusGetParams = LinkStatusGetParams.none(),
    ): CompletableFuture<LinkStatusGetResponse> = get(id, params, RequestOptions.none())
    ...
    fun get(id: String, requestOptions: RequestOptions): CompletableFuture<LinkStatusGetResponse> =
        get(id, LinkStatusGetParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<LinkStatusQueryhelpResponse> =
        queryhelp(LinkStatusQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: LinkStatusQueryhelpParams = LinkStatusQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<LinkStatusQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: LinkStatusQueryhelpParams = LinkStatusQueryhelpParams.none()
    ): CompletableFuture<LinkStatusQueryhelpResponse> = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): CompletableFuture<LinkStatusQueryhelpResponse> =
        queryhelp(LinkStatusQueryhelpParams.none(), requestOptions)
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<LinkStatusTupleResponse>>
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/linkstatus`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/linkstatus`, but is otherwise the same as
         * [LinkStatusServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<LinkStatusListPageAsync>> =
            list(LinkStatusListParams.none())

        /** @see list */
        fun list(
            params: LinkStatusListParams = LinkStatusListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<LinkStatusListPageAsync>>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/linkstatus/count`, but is otherwise the same as
         * [LinkStatusServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(LinkStatusCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/linkstatus/{id}`, but is otherwise the same as
        ...
        fun get(
            ...
            params: LinkStatusGetParams = LinkStatusGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<LinkStatusGetResponse>> =
            get(params.toBuilder().id(id).build(), requestOptions)
        ...
        /**
         * Returns a raw HTTP response for `get /udl/linkstatus/queryhelp`, but is otherwise the
         * same as [LinkStatusServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<LinkStatusQueryhelpResponse>> =
            queryhelp(LinkStatusQueryhelpParams.none())
        ...
        fun queryhelp(
            params: LinkStatusQueryhelpParams = LinkStatusQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<LinkStatusQueryhelpResponse>>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/linkstatus/tuple`, but is otherwise the same as
         * [LinkStatusServiceAsync.tuple].
         */
        fun tuple(
            params: LinkStatusTupleParams
        ): CompletableFuture<HttpResponseFor<List<LinkStatusTupleResponse>>> =
            tuple(params, RequestOptions.none())
