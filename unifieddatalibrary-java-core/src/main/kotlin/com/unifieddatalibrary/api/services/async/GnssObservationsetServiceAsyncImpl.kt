...
class GnssObservationsetServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : GnssObservationsetServiceAsync {

    private val withRawResponse: GnssObservationsetServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): GnssObservationsetServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GnssObservationsetServiceAsync = GnssObservationsetServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryServiceAsync = history

    override fun list(params: GnssObservationsetListParams, requestOptions: RequestOptions): CompletableFuture<GnssObservationsetListPageAsync> =
        // get /udl/gnssobservationset
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: GnssObservationsetCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/gnssobservationset/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: GnssObservationsetCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/gnssobservationset/createBulk
        withRawResponse().createBulk(params, requestOptions).thenAccept {}

    override fun queryhelp(params: GnssObservationsetQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<GnssObservationsetQueryhelpResponse> =
        // get /udl/gnssobservationset/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: GnssObservationsetTupleParams, requestOptions: RequestOptions): CompletableFuture<List<GnssObservationSetFull>> =
        // get /udl/gnssobservationset/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun unvalidatedPublish(params: GnssObservationsetUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GnssObservationsetServiceAsync.WithRawResponse = GnssObservationsetServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: GnssObservationsetListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<GnssObservationsetListPageAsync>> {
        ...
        override fun count(params: GnssObservationsetCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: GnssObservationsetCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: GnssObservationsetQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<GnssObservationsetQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: GnssObservationsetTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<GnssObservationSetFull>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: GnssObservationsetUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
