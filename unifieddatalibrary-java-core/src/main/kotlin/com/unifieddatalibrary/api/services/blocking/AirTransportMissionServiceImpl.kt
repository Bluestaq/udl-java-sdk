...
class AirTransportMissionServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AirTransportMissionService {

    private val withRawResponse: AirTransportMissionService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): AirTransportMissionService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AirTransportMissionService = AirTransportMissionServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: AirTransportMissionRetrieveParams, requestOptions: RequestOptions): AirTransportMissionFull =
    ...
    override fun list(params: AirTransportMissionListParams, requestOptions: RequestOptions): AirTransportMissionListPage =
        // get /udl/airtransportmission
        withRawResponse().list(params, requestOptions).parse()

    override fun count(params: AirTransportMissionCountParams, requestOptions: RequestOptions): String =
        // get /udl/airtransportmission/count
        withRawResponse().count(params, requestOptions).parse()

    override fun queryhelp(params: AirTransportMissionQueryhelpParams, requestOptions: RequestOptions): AirTransportMissionQueryhelpResponse =
        // get /udl/airtransportmission/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: AirTransportMissionTupleParams, requestOptions: RequestOptions): List<AirTransportMissionFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AirTransportMissionService.WithRawResponse = AirTransportMissionServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: AirTransportMissionCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: AirTransportMissionRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AirTransportMissionFull> {
        ...
        override fun update(params: AirTransportMissionUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun list(params: AirTransportMissionListParams, requestOptions: RequestOptions): HttpResponseFor<AirTransportMissionListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "airtransportmission")
        ...
        override fun count(params: AirTransportMissionCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: AirTransportMissionQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<AirTransportMissionQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: AirTransportMissionTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<AirTransportMissionFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
