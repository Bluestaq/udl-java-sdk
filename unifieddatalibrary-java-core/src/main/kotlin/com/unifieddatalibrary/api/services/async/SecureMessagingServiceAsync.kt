...
interface SecureMessagingServiceAsync {
    ...
    fun describeTopic(
        topic: String,
        params: SecureMessagingDescribeTopicParams = SecureMessagingDescribeTopicParams.none(),
    ): CompletableFuture<TopicDetails> = describeTopic(topic, params, RequestOptions.none())
    ...
    fun getLatestOffset(
        topic: String,
        params: SecureMessagingGetLatestOffsetParams = SecureMessagingGetLatestOffsetParams.none(),
    ): CompletableFuture<Void?> = getLatestOffset(topic, params, RequestOptions.none())
    ...
    fun listTopics(
        params: SecureMessagingListTopicsParams = SecureMessagingListTopicsParams.none()
    ): CompletableFuture<List<TopicDetails>> = listTopics(params, RequestOptions.none())
    ...
    /**
     * A view of [SecureMessagingServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * same as [SecureMessagingServiceAsync.describeTopic].
         */
        ...
        fun describeTopic(
            ...
            describeTopic(topic, params, RequestOptions.none())
         ...
         * same as [SecureMessagingServiceAsync.getLatestOffset].
         */
        ...
        fun getLatestOffset(
            ...
            params: SecureMessagingGetLatestOffsetParams =
                SecureMessagingGetLatestOffsetParams.none(),
        ): CompletableFuture<HttpResponse> = getLatestOffset(topic, params, RequestOptions.none())
        ...
        fun getLatestOffset(
            params: SecureMessagingGetLatestOffsetParams
        ): CompletableFuture<HttpResponse> = getLatestOffset(params, RequestOptions.none())
         ...
         * the same as [SecureMessagingServiceAsync.getMessages].
         */
        fun getMessages(
            offset: Long,
            params: SecureMessagingGetMessagesParams,
         ...
         * [SecureMessagingServiceAsync.listTopics].
         */
        fun listTopics(): CompletableFuture<HttpResponseFor<List<TopicDetails>>> =
            listTopics(SecureMessagingListTopicsParams.none())
        ...
        fun listTopics(
            ...
            listTopics(params, RequestOptions.none())
