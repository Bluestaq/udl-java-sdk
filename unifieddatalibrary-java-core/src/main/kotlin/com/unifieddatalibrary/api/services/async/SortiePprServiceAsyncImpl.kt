...
class SortiePprServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    SortiePprServiceAsync {

    private val withRawResponse: SortiePprServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SortiePprServiceAsync =
        SortiePprServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SortiePprServiceAsyncImpl.WithRawResponseImpl(
