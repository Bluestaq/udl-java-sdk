...
class SgiServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: SgiServiceAsync.WithRawResponse by lazy {
    ...
    override fun getDataByEffectiveAsOfDate(
        ...
        withRawResponse().getDataByEffectiveAsOfDate(params, requestOptions).thenApply {
            it.parse()
        }
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SgiServiceAsyncImpl.WithRawResponseImpl(
