...
interface OnorbitbatteryService {
     ...
     */
    fun create(params: OnorbitbatteryCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: OnorbitbatteryUpdateParams) = update(params, RequestOptions.none())
    ...
    fun list(
        params: OnorbitbatteryListParams = OnorbitbatteryListParams.none()
    ): OnorbitbatteryListPage = list(params, RequestOptions.none())
     ...
     * UDL team for assistance.
     */
    fun delete(id: String) = delete(id, OnorbitbatteryDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: OnorbitbatteryDeleteParams) = delete(params, RequestOptions.none())
     ...
     * spacecraft.
     */
    fun get(id: String): OnorbitBatteryFull = get(id, OnorbitbatteryGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): OnorbitBatteryFull = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: OnorbitbatteryGetParams = OnorbitbatteryGetParams.none(),
    ): OnorbitBatteryFull = get(id, params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [OnorbitbatteryService.update].
         */
        @MustBeClosed
        ...
        fun list(
            params: OnorbitbatteryListParams = OnorbitbatteryListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<OnorbitbatteryListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: OnorbitbatteryListParams = OnorbitbatteryListParams.none()
        ): HttpResponseFor<OnorbitbatteryListPage> = list(params, RequestOptions.none())
         ...
         * same as [OnorbitbatteryService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, OnorbitbatteryDeleteParams.none())
        ...
        fun get(
            ...
            params: OnorbitbatteryGetParams = OnorbitbatteryGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<OnorbitBatteryFull> =
        ...
        fun get(
            id: String,
            params: OnorbitbatteryGetParams = OnorbitbatteryGetParams.none(),
        ): HttpResponseFor<OnorbitBatteryFull> = get(id, params, RequestOptions.none())
