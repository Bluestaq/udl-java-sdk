...
interface WeatherDataServiceAsync {
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<WeatherDataCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> =
        createBulk(WeatherDataCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<WeatherDataCreateBulkParams.Body>): CompletableFuture<Void?> =
        createBulk(body, RequestOptions.none())

    /**
     * Service operation to get a single WeatherData by its unique ID passed as a path parameter.
     */
    fun get(id: String): CompletableFuture<WeatherDataFull> = get(id, WeatherDataGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<WeatherDataFull> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: WeatherDataGetParams = WeatherDataGetParams.none(),
    ): CompletableFuture<WeatherDataFull> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<WeatherDataQueryhelpResponse> =
    ...
    fun queryhelp(
        params: WeatherDataQueryhelpParams = WeatherDataQueryhelpParams.none()
    ): CompletableFuture<WeatherDataQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<WeatherDataUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> =
        unvalidatedPublish(
            WeatherDataUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )
    ...
    /**
     * A view of [WeatherDataServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [WeatherDataServiceAsync.count].
         */
         ...
         * same as [WeatherDataServiceAsync.createBulk].
         */
        ...
        fun get(id: String): CompletableFuture<HttpResponseFor<WeatherDataFull>> =
            get(id, WeatherDataGetParams.none())
         ...
         * same as [WeatherDataServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<WeatherDataQueryhelpResponse>> =
            queryhelp(WeatherDataQueryhelpParams.none())
         ...
         * as [WeatherDataServiceAsync.tuple].
         */
        fun tuple(
            params: WeatherDataTupleParams
         ...
         * same as [WeatherDataServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: WeatherDataUnvalidatedPublishParams
