...
class LinkStatusServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : LinkStatusService {

    private val withRawResponse: LinkStatusService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LinkStatusService = LinkStatusServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: LinkStatusListParams, requestOptions: RequestOptions): LinkStatusListPage =
        // get /udl/linkstatus
    ...
    override fun get(params: LinkStatusGetParams, requestOptions: RequestOptions): LinkStatusGetResponse =
        // get /udl/linkstatus/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: LinkStatusQueryhelpParams, requestOptions: RequestOptions): LinkStatusQueryhelpResponse =
        // get /udl/linkstatus/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: LinkStatusTupleParams, requestOptions: RequestOptions): List<LinkStatusTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val datalink: DatalinkService.WithRawResponse by lazy { DatalinkServiceImpl.WithRawResponseImpl(clientOptions) }

        private val history: HistoryService.WithRawResponse by lazy { HistoryServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LinkStatusService.WithRawResponse = LinkStatusServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: LinkStatusCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: LinkStatusListParams, requestOptions: RequestOptions): HttpResponseFor<LinkStatusListPage> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: LinkStatusCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: LinkStatusGetParams, requestOptions: RequestOptions): HttpResponseFor<LinkStatusGetResponse> {
        ...
        override fun queryhelp(params: LinkStatusQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<LinkStatusQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: LinkStatusTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<LinkStatusTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
