...
class TaiUtcServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    TaiUtcServiceAsync {

    private val withRawResponse: TaiUtcServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TaiUtcServiceAsync =
        TaiUtcServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TaiUtcServiceAsyncImpl.WithRawResponseImpl(
