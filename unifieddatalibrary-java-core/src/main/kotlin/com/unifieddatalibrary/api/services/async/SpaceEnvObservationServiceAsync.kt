...
interface SpaceEnvObservationServiceAsync {
    ...
    ): CompletableFuture<SpaceEnvObservationListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(
        params: SpaceEnvObservationListParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SpaceEnvObservationListPageAsync>
    ...
    /** @see createBulk */
    fun createBulk(body: List<SpaceEnvObservationCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryhelp(): CompletableFuture<SpaceEnvObservationQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SpaceEnvObservationQueryhelpResponse>
    ...
    ): CompletableFuture<List<SpaceEnvObservationFull>> = tuple(params, RequestOptions.none())

    /** @see tuple */
    fun tuple(
        params: SpaceEnvObservationTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<SpaceEnvObservationFull>>
    ...
    /**
     * A view of [SpaceEnvObservationServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * as [SpaceEnvObservationServiceAsync.list].
         */
        fun list(
            params: SpaceEnvObservationListParams
        ): CompletableFuture<HttpResponseFor<SpaceEnvObservationListPageAsync>> =
         ...
         * the same as [SpaceEnvObservationServiceAsync.count].
         */
        fun count(
            params: SpaceEnvObservationCountParams
         ...
         * otherwise the same as [SpaceEnvObservationServiceAsync.createBulk].
         */
        fun createBulk(
            params: SpaceEnvObservationCreateBulkParams
         ...
         * otherwise the same as [SpaceEnvObservationServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SpaceEnvObservationQueryhelpResponse>> =
            queryhelp(SpaceEnvObservationQueryhelpParams.none())
        ...
        fun queryhelp(
            params: SpaceEnvObservationQueryhelpParams = SpaceEnvObservationQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SpaceEnvObservationQueryhelpResponse>>
         ...
         * the same as [SpaceEnvObservationServiceAsync.tuple].
         */
        fun tuple(
            params: SpaceEnvObservationTupleParams
        ): CompletableFuture<HttpResponseFor<List<SpaceEnvObservationFull>>> =
         ...
         * same as [SpaceEnvObservationServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: SpaceEnvObservationUnvalidatedPublishParams
