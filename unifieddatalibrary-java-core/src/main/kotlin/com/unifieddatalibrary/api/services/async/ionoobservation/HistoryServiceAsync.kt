...
package com.unifieddatalibrary.api.services.async.ionoobservation
...
import com.unifieddatalibrary.api.models.ionoobservation.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/ionoobservation/history`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/ionoobservation/history/aodr`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `get /udl/ionoobservation/history/count`, but is
