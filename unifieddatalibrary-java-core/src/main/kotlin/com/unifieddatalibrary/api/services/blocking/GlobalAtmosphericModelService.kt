...
interface GlobalAtmosphericModelService {
    ...
    /**
     * Service operation to get a single GlobalAtmosphericModel record by its unique ID passed as a
     * path parameter.
     */
    fun retrieve(id: String): GlobalAtmosphericModelRetrieveResponse =
        retrieve(id, GlobalAtmosphericModelRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: GlobalAtmosphericModelRetrieveParams = GlobalAtmosphericModelRetrieveParams.none(),
    ...
    fun retrieve(
        id: String,
        params: GlobalAtmosphericModelRetrieveParams = GlobalAtmosphericModelRetrieveParams.none(),
    ): GlobalAtmosphericModelRetrieveResponse = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(
        params: GlobalAtmosphericModelRetrieveParams
    ): GlobalAtmosphericModelRetrieveResponse = retrieve(params, RequestOptions.none())
     ...
     */
    fun list(params: GlobalAtmosphericModelListParams): GlobalAtmosphericModelListPage =
    ...
    /**
     * Service operation to get a single GlobalAtmosphericModel compressed data file by its unique
     * ID passed as a path parameter. The compressed data file is returned as an attachment
     * Content-Disposition.
     */
    @MustBeClosed
    fun getFile(id: String): HttpResponse = getFile(id, GlobalAtmosphericModelGetFileParams.none())

    /** @see getFile */
    @MustBeClosed
    fun getFile(
        id: String,
        params: GlobalAtmosphericModelGetFileParams = GlobalAtmosphericModelGetFileParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
     ...
     */
    fun queryHelp(): GlobalAtmosphericModelQueryHelpResponse =
        queryHelp(GlobalAtmosphericModelQueryHelpParams.none())

    /** @see queryHelp */
    fun queryHelp(
        params: GlobalAtmosphericModelQueryHelpParams =
            GlobalAtmosphericModelQueryHelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): GlobalAtmosphericModelQueryHelpResponse

    /** @see queryHelp */
    fun queryHelp(
        params: GlobalAtmosphericModelQueryHelpParams = GlobalAtmosphericModelQueryHelpParams.none()
    ): GlobalAtmosphericModelQueryHelpResponse = queryHelp(params, RequestOptions.none())

    /** @see queryHelp */
    fun queryHelp(requestOptions: RequestOptions): GlobalAtmosphericModelQueryHelpResponse =
        queryHelp(GlobalAtmosphericModelQueryHelpParams.none(), requestOptions)
    ...
    ): List<GlobalAtmosphericModelTupleResponse> = tuple(params, RequestOptions.none())
     ...
     * `.json` file extension whose content conforms to the `GlobalAtmosphericModel_Ingest` schema.\
     * 2\) A file with the `.geojson` file extension.
     *
     * The JSON and GEOJSON files will be associated with each other other via the `id` field. Query
     * the metadata via `GET /udl/globalatmosphericmodel` and use `GET
     * /udl/globalatmosphericmodel/getFile/{id}` to retrieve the compressed GEOJSON file as `.gz`
     * extension.
     *
    ...
    /**
     * A view of [GlobalAtmosphericModelService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/globalatmosphericmodel/{id}`, but is otherwise
         * the same as [GlobalAtmosphericModelService.retrieve].
         */
        @MustBeClosed
         ...
         * same as [GlobalAtmosphericModelService.list].
         */
        @MustBeClosed
        fun list(
            params: GlobalAtmosphericModelListParams
        ): HttpResponseFor<GlobalAtmosphericModelListPage> = list(params, RequestOptions.none())
         ...
         * the same as [GlobalAtmosphericModelService.count].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/globalatmosphericmodel/getFile/{id}`, but is
         * otherwise the same as [GlobalAtmosphericModelService.getFile].
         */
        @MustBeClosed
        fun getFile(id: String): HttpResponse =
            getFile(id, GlobalAtmosphericModelGetFileParams.none())
         ...
         * otherwise the same as [GlobalAtmosphericModelService.queryHelp].
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<GlobalAtmosphericModelQueryHelpResponse> =
            queryHelp(GlobalAtmosphericModelQueryHelpParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/globalatmosphericmodel/tuple`, but is otherwise
         * the same as [GlobalAtmosphericModelService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: GlobalAtmosphericModelTupleParams
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-globalatmosphericmodel`, but is
         * otherwise the same as [GlobalAtmosphericModelService.unvalidatedPublish].
         */
        @MustBeClosed
        fun unvalidatedPublish(
            params: GlobalAtmosphericModelUnvalidatedPublishParams
