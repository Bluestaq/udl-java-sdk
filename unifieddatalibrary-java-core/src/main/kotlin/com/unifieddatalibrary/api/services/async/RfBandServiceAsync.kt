...
interface RfBandServiceAsync {
    ...
    /** @see list */
    fun list(
        params: RfBandListParams = RfBandListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<RfBandListPageAsync>

    /** @see list */
    fun list(
        params: RfBandListParams = RfBandListParams.none()
    ): CompletableFuture<RfBandListPageAsync> = list(params, RequestOptions.none())
    ...
    fun delete(
        id: String,
        params: RfBandDeleteParams = RfBandDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun delete(id: String, requestOptions: RequestOptions): CompletableFuture<Void?> =
        delete(id, RfBandDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: RfBandCountParams = RfBandCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun get(
        id: String,
        params: RfBandGetParams = RfBandGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<RfBandFull> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: RfBandGetParams = RfBandGetParams.none(),
    ): CompletableFuture<RfBandFull> = get(id, params, RequestOptions.none())

    /** @see get */
    fun get(
        params: RfBandGetParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<RfBandFull>
    ...
    fun get(id: String, requestOptions: RequestOptions): CompletableFuture<RfBandFull> =
        get(id, RfBandGetParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<RfBandQueryhelpResponse> =
        queryhelp(RfBandQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: RfBandQueryhelpParams = RfBandQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<RfBandQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: RfBandQueryhelpParams = RfBandQueryhelpParams.none()
    ): CompletableFuture<RfBandQueryhelpResponse> = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): CompletableFuture<RfBandQueryhelpResponse> =
        queryhelp(RfBandQueryhelpParams.none(), requestOptions)
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<RfBandFull>>
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/rfband`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `put /udl/rfband/{id}`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/rfband`, but is otherwise the same as
         * [RfBandServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<RfBandListPageAsync>> =
            list(RfBandListParams.none())

        /** @see list */
        fun list(
            params: RfBandListParams = RfBandListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<RfBandListPageAsync>>
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/rfband/{id}`, but is otherwise the same as
         * [RfBandServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, RfBandDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/rfband/count`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/rfband/{id}`, but is otherwise the same as
         * [RfBandServiceAsync.get].
         */
        fun get(id: String): CompletableFuture<HttpResponseFor<RfBandFull>> =
            get(id, RfBandGetParams.none())
        ...
        fun get(
            ...
            params: RfBandGetParams = RfBandGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<RfBandFull>> =
        ...
        fun get(
            id: String,
            params: RfBandGetParams = RfBandGetParams.none(),
        ): CompletableFuture<HttpResponseFor<RfBandFull>> = get(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/rfband/queryhelp`, but is otherwise the same as
         * [RfBandServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<RfBandQueryhelpResponse>> =
            queryhelp(RfBandQueryhelpParams.none())
        ...
        fun queryhelp(
            params: RfBandQueryhelpParams = RfBandQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<RfBandQueryhelpResponse>>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/rfband/tuple`, but is otherwise the same as
        ...
        fun tuple(
            params: RfBandTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<List<RfBandFull>>>
    }
}
