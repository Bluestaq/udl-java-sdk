...
class DatalinkServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: DatalinkService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): DatalinkService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DatalinkService =
        DatalinkServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(
        params: DatalinkQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            DatalinkServiceImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<DatalinkListResponse>> =
            jsonHandler<List<DatalinkListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: DatalinkListParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<DatalinkListPage> {
            val request =
                HttpRequest.builder()
        ...
        private val queryhelpHandler: Handler<DatalinkQueryhelpResponse> =
            jsonHandler<DatalinkQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(
            params: DatalinkQueryhelpParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<DatalinkQueryhelpResponse> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<DatalinkTupleResponse>> =
            jsonHandler<List<DatalinkTupleResponse>>(clientOptions.jsonMapper)

        override fun tuple(
            params: DatalinkTupleParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<List<DatalinkTupleResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
