...
interface EmitterGeolocationService {
     ...
     */
    fun list(params: EmitterGeolocationListParams): EmitterGeolocationListPage =
    ...
    /** @see createBulk */
    fun createBulk(body: List<EmitterGeolocationCreateBulkParams.Body>) =
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<EmitterGeolocationUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
         ...
         * as [EmitterGeolocationService.list].
         */
        @MustBeClosed
        fun list(
            params: EmitterGeolocationListParams
        ): HttpResponseFor<EmitterGeolocationListPage> = list(params, RequestOptions.none())
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<EmitterGeolocationCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())
