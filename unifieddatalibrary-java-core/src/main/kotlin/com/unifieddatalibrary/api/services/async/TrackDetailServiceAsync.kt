...
interface TrackDetailServiceAsync {
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<TrackDetailCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> =
        createBulk(TrackDetailCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<TrackDetailCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryhelp(): CompletableFuture<TrackDetailQueryhelpResponse> =
    ...
    fun queryhelp(
        params: TrackDetailQueryhelpParams = TrackDetailQueryhelpParams.none()
    ): CompletableFuture<TrackDetailQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [TrackDetailServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [TrackDetailServiceAsync.count].
         */
         ...
         * same as [TrackDetailServiceAsync.createBulk].
         */
         ...
         * same as [TrackDetailServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<TrackDetailQueryhelpResponse>> =
            queryhelp(TrackDetailQueryhelpParams.none())
         ...
         * as [TrackDetailServiceAsync.tuple].
         */
        fun tuple(
            params: TrackDetailTupleParams
