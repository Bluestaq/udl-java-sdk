...
class OnorbitServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : OnorbitService {

    private val withRawResponse: OnorbitService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val antennaDetails: AntennaDetailService by lazy { AntennaDetailServiceImpl(clientOptions) }

    override fun withRawResponse(): OnorbitService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnorbitService = OnorbitServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun getSignature(params: OnorbitGetSignatureParams, requestOptions: RequestOptions): OnorbitGetSignatureResponse =
        // get /udl/onorbit/getSignature
        withRawResponse().getSignature(params, requestOptions).parse()

    override fun queryhelp(params: OnorbitQueryhelpParams, requestOptions: RequestOptions): OnorbitQueryhelpResponse =
        // get /udl/onorbit/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: OnorbitTupleParams, requestOptions: RequestOptions): List<OnorbitFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val antennaDetails: AntennaDetailService.WithRawResponse by lazy { AntennaDetailServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnorbitService.WithRawResponse = OnorbitServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun antennaDetails(): AntennaDetailService.WithRawResponse = antennaDetails

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: OnorbitCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: OnorbitUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: OnorbitListParams, requestOptions: RequestOptions): HttpResponseFor<OnorbitListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: OnorbitDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun count(params: OnorbitCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: OnorbitGetParams, requestOptions: RequestOptions): HttpResponseFor<OnorbitFull> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun getSignature(params: OnorbitGetSignatureParams, requestOptions: RequestOptions): HttpResponseFor<OnorbitGetSignatureResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: OnorbitQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<OnorbitQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: OnorbitTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<OnorbitFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
