...
class SensorMaintenanceServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SensorMaintenanceService {

    private val withRawResponse: SensorMaintenanceService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): SensorMaintenanceService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SensorMaintenanceService = SensorMaintenanceServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: SensorMaintenanceListParams, requestOptions: RequestOptions): SensorMaintenanceListPage =
    ...
    override fun count(params: SensorMaintenanceCountParams, requestOptions: RequestOptions): String =
        // get /udl/sensormaintenance/count
        withRawResponse().count(params, requestOptions).parse()

    override fun createBulk(params: SensorMaintenanceCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/sensormaintenance/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun current(params: SensorMaintenanceCurrentParams, requestOptions: RequestOptions): List<SensorMaintenanceCurrentResponse> =
        // get /udl/sensormaintenance/current
        withRawResponse().current(params, requestOptions).parse()

    override fun get(params: SensorMaintenanceGetParams, requestOptions: RequestOptions): SensorMaintenanceGetResponse =
        // get /udl/sensormaintenance/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: SensorMaintenanceQueryhelpParams, requestOptions: RequestOptions): SensorMaintenanceQueryhelpResponse =
        // get /udl/sensormaintenance/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: SensorMaintenanceTupleParams, requestOptions: RequestOptions): List<SensorMaintenanceTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SensorMaintenanceService.WithRawResponse = SensorMaintenanceServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: SensorMaintenanceCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: SensorMaintenanceUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: SensorMaintenanceListParams, requestOptions: RequestOptions): HttpResponseFor<SensorMaintenanceListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: SensorMaintenanceDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: SensorMaintenanceCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: SensorMaintenanceCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun current(params: SensorMaintenanceCurrentParams, requestOptions: RequestOptions): HttpResponseFor<List<SensorMaintenanceCurrentResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: SensorMaintenanceGetParams, requestOptions: RequestOptions): HttpResponseFor<SensorMaintenanceGetResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: SensorMaintenanceQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<SensorMaintenanceQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: SensorMaintenanceTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<SensorMaintenanceTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
