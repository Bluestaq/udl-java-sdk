...
class NotificationServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun queryhelp(
        params: NotificationQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun createRaw(
            ...
            return request
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response.use { createRawHandler.handle(it) }
                    }
                }
        }

        private val getHandler: Handler<NotificationFull> =
            jsonHandler<NotificationFull>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<NotificationQueryhelpResponse> =
            jsonHandler<NotificationQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<NotificationFull>> =
            jsonHandler<List<NotificationFull>>(clientOptions.jsonMapper)
