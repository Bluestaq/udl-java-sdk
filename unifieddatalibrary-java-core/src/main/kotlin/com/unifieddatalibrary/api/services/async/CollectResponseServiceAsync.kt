...
interface CollectResponseServiceAsync {
    ...
    fun retrieve(
        id: String,
        params: CollectResponseRetrieveParams = CollectResponseRetrieveParams.none(),
    ): CompletableFuture<CollectResponseFull> = retrieve(id, params, RequestOptions.none())
     ...
     */
    fun queryHelp(): CompletableFuture<CollectResponseQueryHelpResponse> =
    ...
    interface WithRawResponse {
         ...
         * same as [CollectResponseServiceAsync.retrieve].
         */
         ...
         * same as [CollectResponseServiceAsync.count].
         */
         ...
         * the same as [CollectResponseServiceAsync.createBulk].
         */
         ...
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<CollectResponseQueryHelpResponse>> =
            queryHelp(CollectResponseQueryHelpParams.none())
         ...
         * the same as [CollectResponseServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: CollectResponseUnvalidatedPublishParams
