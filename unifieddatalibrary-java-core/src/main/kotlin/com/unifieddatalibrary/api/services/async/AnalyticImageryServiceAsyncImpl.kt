...
class AnalyticImageryServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AnalyticImageryServiceAsync {

    private val withRawResponse: AnalyticImageryServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): AnalyticImageryServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AnalyticImageryServiceAsync = AnalyticImageryServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun retrieve(params: AnalyticImageryRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AnalyticImageryFull> =
        // get /udl/analyticimagery/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun list(params: AnalyticImageryListParams, requestOptions: RequestOptions): CompletableFuture<AnalyticImageryListPageAsync> =
        // get /udl/analyticimagery
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: AnalyticImageryCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/analyticimagery/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun fileGet(params: AnalyticImageryFileGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> =
        // get /udl/analyticimagery/getFile/{id}
        withRawResponse().fileGet(params, requestOptions)

    override fun history(params: AnalyticImageryHistoryParams, requestOptions: RequestOptions): CompletableFuture<List<AnalyticImageryAbridged>> =
        // get /udl/analyticimagery/history
        withRawResponse().history(params, requestOptions).thenApply { it.parse() }

    override fun historyAodr(params: AnalyticImageryHistoryAodrParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // get /udl/analyticimagery/history/aodr
        withRawResponse().historyAodr(params, requestOptions).thenAccept {}

    override fun historyCount(params: AnalyticImageryHistoryCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/analyticimagery/history/count
        withRawResponse().historyCount(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: AnalyticImageryQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<AnalyticImageryQueryhelpResponse> =
        // get /udl/analyticimagery/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: AnalyticImageryTupleParams, requestOptions: RequestOptions): CompletableFuture<List<AnalyticImageryAbridged>> =
        // get /udl/analyticimagery/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun unvalidatedPublish(params: AnalyticImageryUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AnalyticImageryServiceAsync.WithRawResponse = AnalyticImageryServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val retrieveHandler: Handler<AnalyticImageryFull> = jsonHandler<AnalyticImageryFull>(clientOptions.jsonMapper)

        override fun retrieve(params: AnalyticImageryRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AnalyticImageryFull>> {
        ...
        override fun list(params: AnalyticImageryListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AnalyticImageryListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun count(params: AnalyticImageryCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun history(params: AnalyticImageryHistoryParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<AnalyticImageryAbridged>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun historyAodr(params: AnalyticImageryHistoryAodrParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun historyCount(params: AnalyticImageryHistoryCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: AnalyticImageryQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AnalyticImageryQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: AnalyticImageryTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<AnalyticImageryAbridged>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: AnalyticImageryUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
