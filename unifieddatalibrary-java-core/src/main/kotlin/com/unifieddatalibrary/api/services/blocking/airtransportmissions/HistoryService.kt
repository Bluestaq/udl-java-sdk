...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airtransportmission/history`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airtransportmission/history/aodr`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airtransportmission/history/count`, but is
