...
class CrewServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: CrewServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): CrewServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CrewServiceAsync =
        CrewServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<CrewListPageAsync> =
        // get /udl/crew
    ...
    override fun queryhelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<CrewQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<CrewFull>> =
        // get /udl/crew/tuple
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            CrewServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun retrieve(
            params: CrewRetrieveParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CrewFull>> {
        ...
        override fun list(
            params: CrewListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CrewListPageAsync>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(
            params: CrewQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CrewQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(
            params: CrewTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<CrewFull>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
