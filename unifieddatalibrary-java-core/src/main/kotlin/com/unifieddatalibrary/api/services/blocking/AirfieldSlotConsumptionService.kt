...
interface AirfieldSlotConsumptionService {
     ...
     */
    fun create(params: AirfieldSlotConsumptionCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirfieldslotconsumptionFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirfieldSlotConsumptionRetrieveParams = AirfieldSlotConsumptionRetrieveParams.none(),
    ): AirfieldslotconsumptionFull = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: AirfieldSlotConsumptionUpdateParams) = update(params, RequestOptions.none())
     ...
     */
    fun delete(id: String) = delete(id, AirfieldSlotConsumptionDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: AirfieldSlotConsumptionDeleteParams) = delete(params, RequestOptions.none())
     ...
     */
    fun queryhelp(): AirfieldSlotConsumptionQueryhelpResponse =
    ...
    fun queryhelp(
        params: AirfieldSlotConsumptionQueryhelpParams =
            AirfieldSlotConsumptionQueryhelpParams.none()
    ): AirfieldSlotConsumptionQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [AirfieldSlotConsumptionService] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * same as [AirfieldSlotConsumptionService.create].
         */
        @MustBeClosed
         ...
         * the same as [AirfieldSlotConsumptionService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            params: AirfieldSlotConsumptionRetrieveParams
        ): HttpResponseFor<AirfieldslotconsumptionFull> = retrieve(params, RequestOptions.none())
         ...
         * the same as [AirfieldSlotConsumptionService.update].
         */
        @MustBeClosed
         ...
         * same as [AirfieldSlotConsumptionService.list].
         */
        @MustBeClosed
        fun list(
            params: AirfieldSlotConsumptionListParams
        ): HttpResponseFor<AirfieldSlotConsumptionListPage> = list(params, RequestOptions.none())
         ...
         * otherwise the same as [AirfieldSlotConsumptionService.delete].
         */
        @MustBeClosed
         ...
         * otherwise the same as [AirfieldSlotConsumptionService.count].
         */
        @MustBeClosed
         ...
         * otherwise the same as [AirfieldSlotConsumptionService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AirfieldSlotConsumptionQueryhelpResponse> =
            queryhelp(AirfieldSlotConsumptionQueryhelpParams.none())
         ...
         * otherwise the same as [AirfieldSlotConsumptionService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: AirfieldSlotConsumptionTupleParams
        ): HttpResponseFor<List<AirfieldslotconsumptionFull>> = tuple(params, RequestOptions.none())
