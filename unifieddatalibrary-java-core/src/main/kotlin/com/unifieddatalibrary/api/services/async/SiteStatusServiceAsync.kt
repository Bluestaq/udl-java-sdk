...
interface SiteStatusServiceAsync {
    ...
    fun list(
        params: SiteStatusListParams = SiteStatusListParams.none()
    ): CompletableFuture<SiteStatusListPageAsync> = list(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, SiteStatusDeleteParams.none())
    ...
    fun get(
        id: String,
        params: SiteStatusGetParams = SiteStatusGetParams.none(),
    ): CompletableFuture<SiteStatusGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<SiteStatusQueryhelpResponse> =
    ...
    fun queryhelp(
        params: SiteStatusQueryhelpParams = SiteStatusQueryhelpParams.none()
    ): CompletableFuture<SiteStatusQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [SiteStatusServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * [SiteStatusServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<SiteStatusListPageAsync>> =
            list(SiteStatusListParams.none())
         ...
         * as [SiteStatusServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, SiteStatusDeleteParams.none())
        ...
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(SiteStatusCountParams.none())
         ...
         * same as [SiteStatusServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SiteStatusQueryhelpResponse>> =
            queryhelp(SiteStatusQueryhelpParams.none())
