...
class BatteryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    BatteryServiceAsync {

    private val withRawResponse: BatteryServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): BatteryServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BatteryServiceAsync =
        BatteryServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            BatteryServiceAsyncImpl.WithRawResponseImpl(
