...
interface SeradataRadarPayloadService {
     ...
     */
    fun create(params: SeradataRadarPayloadCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: SeradataRadarPayloadUpdateParams) = update(params, RequestOptions.none())
    ...
    fun list(
        params: SeradataRadarPayloadListParams = SeradataRadarPayloadListParams.none()
    ): SeradataRadarPayloadListPage = list(params, RequestOptions.none())
     ...
     * UDL team for assistance.
     */
    fun delete(id: String) = delete(id, SeradataRadarPayloadDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: SeradataRadarPayloadDeleteParams) = delete(params, RequestOptions.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SeradataRadarPayloadGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: SeradataRadarPayloadGetParams = SeradataRadarPayloadGetParams.none(),
    ): SeradataRadarPayloadGetResponse = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): SeradataRadarPayloadQueryhelpResponse =
    ...
    fun queryhelp(
        params: SeradataRadarPayloadQueryhelpParams = SeradataRadarPayloadQueryhelpParams.none()
    ): SeradataRadarPayloadQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [SeradataRadarPayloadService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * same as [SeradataRadarPayloadService.create].
         */
        @MustBeClosed
         ...
         * the same as [SeradataRadarPayloadService.update].
         */
        @MustBeClosed
         ...
         * same as [SeradataRadarPayloadService.list].
         */
        @MustBeClosed
        fun list(): HttpResponseFor<SeradataRadarPayloadListPage> =
        ...
        fun list(
            params: SeradataRadarPayloadListParams = SeradataRadarPayloadListParams.none()
        ): HttpResponseFor<SeradataRadarPayloadListPage> = list(params, RequestOptions.none())
         ...
         * the same as [SeradataRadarPayloadService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, SeradataRadarPayloadDeleteParams.none())
         ...
         * the same as [SeradataRadarPayloadService.count].
         */
        @MustBeClosed
         ...
         * the same as [SeradataRadarPayloadService.get].
         */
        @MustBeClosed
        ...
        fun get(
            id: String,
            params: SeradataRadarPayloadGetParams = SeradataRadarPayloadGetParams.none(),
        ): HttpResponseFor<SeradataRadarPayloadGetResponse> = get(id, params, RequestOptions.none())
        ...
        fun get(
            params: SeradataRadarPayloadGetParams
        ): HttpResponseFor<SeradataRadarPayloadGetResponse> = get(params, RequestOptions.none())
         ...
         * otherwise the same as [SeradataRadarPayloadService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SeradataRadarPayloadQueryhelpResponse> =
            queryhelp(SeradataRadarPayloadQueryhelpParams.none())
         ...
         * the same as [SeradataRadarPayloadService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: SeradataRadarPayloadTupleParams
