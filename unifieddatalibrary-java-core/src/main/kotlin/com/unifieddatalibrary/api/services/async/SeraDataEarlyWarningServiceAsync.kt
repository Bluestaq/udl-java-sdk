...
interface SeraDataEarlyWarningServiceAsync {
    ...
    /**
     * Service operation to take a single SeradataEarlyWarning as a POST body and ingest into the
    ...
    /**
     * Service operation to update an SeradataEarlyWarning. A specific role is required to perform
     ...
     */
    fun list(): CompletableFuture<SeraDataEarlyWarningListPageAsync> =
        list(SeraDataEarlyWarningListParams.none())

    /** @see list */
    fun list(
        params: SeraDataEarlyWarningListParams = SeraDataEarlyWarningListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun list(
        params: SeraDataEarlyWarningListParams = SeraDataEarlyWarningListParams.none()
    ): CompletableFuture<SeraDataEarlyWarningListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<SeraDataEarlyWarningListPageAsync> =
        list(SeraDataEarlyWarningListParams.none(), requestOptions)

    /**
     * Service operation to delete an SeradataEarlyWarning specified by the passed ID path
     * parameter. A specific role is required to perform this service operation. Please contact the
     * UDL team for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> =
        delete(id, SeraDataEarlyWarningDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: SeraDataEarlyWarningDeleteParams = SeraDataEarlyWarningDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun delete(id: String, requestOptions: RequestOptions): CompletableFuture<Void?> =
        delete(id, SeraDataEarlyWarningDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: SeraDataEarlyWarningCountParams = SeraDataEarlyWarningCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun count(requestOptions: RequestOptions): CompletableFuture<String> =
        count(SeraDataEarlyWarningCountParams.none(), requestOptions)

    /**
     * Service operation to get a single SeradataEarlyWarning by its unique ID passed as a path
     * parameter.
     */
    fun get(id: String): CompletableFuture<SeraDataEarlyWarningGetResponse> =
        get(id, SeraDataEarlyWarningGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: SeraDataEarlyWarningGetParams = SeraDataEarlyWarningGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun get(
        id: String,
        params: SeraDataEarlyWarningGetParams = SeraDataEarlyWarningGetParams.none(),
    ): CompletableFuture<SeraDataEarlyWarningGetResponse> = get(id, params, RequestOptions.none())
    ...
    fun get(
        params: SeraDataEarlyWarningGetParams
    ): CompletableFuture<SeraDataEarlyWarningGetResponse> = get(params, RequestOptions.none())
    ...
    fun get(
        ...
        get(id, SeraDataEarlyWarningGetParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<SeraDataEarlyWarningQueryhelpResponse> =
        queryhelp(SeraDataEarlyWarningQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: SeraDataEarlyWarningQueryhelpParams = SeraDataEarlyWarningQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        ...
        queryhelp(SeraDataEarlyWarningQueryhelpParams.none(), requestOptions)
    ...
    /**
     * A view of [SeraDataEarlyWarningServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/seradataearlywarning`, but is otherwise the
         * same as [SeraDataEarlyWarningServiceAsync.create].
         */
        ...
        /**
         * Returns a raw HTTP response for `put /udl/seradataearlywarning/{id}`, but is otherwise
         * the same as [SeraDataEarlyWarningServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: SeraDataEarlyWarningUpdateParams,
        ...
        /**
         * Returns a raw HTTP response for `get /udl/seradataearlywarning`, but is otherwise the
         * same as [SeraDataEarlyWarningServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<SeraDataEarlyWarningListPageAsync>> =
            list(SeraDataEarlyWarningListParams.none())
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/seradataearlywarning/{id}`, but is otherwise
         * the same as [SeraDataEarlyWarningServiceAsync.delete].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/seradataearlywarning/count`, but is otherwise
         * the same as [SeraDataEarlyWarningServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(SeraDataEarlyWarningCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/seradataearlywarning/{id}`, but is otherwise
         * the same as [SeraDataEarlyWarningServiceAsync.get].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/seradataearlywarning/queryhelp`, but is
         * otherwise the same as [SeraDataEarlyWarningServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SeraDataEarlyWarningQueryhelpResponse>> =
            queryhelp(SeraDataEarlyWarningQueryhelpParams.none())

        /** @see queryhelp */
        fun queryhelp(
            params: SeraDataEarlyWarningQueryhelpParams =
                SeraDataEarlyWarningQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ...
        /**
         * Returns a raw HTTP response for `get /udl/seradataearlywarning/tuple`, but is otherwise
         * the same as [SeraDataEarlyWarningServiceAsync.tuple].
         */
        fun tuple(
            params: SeraDataEarlyWarningTupleParams
