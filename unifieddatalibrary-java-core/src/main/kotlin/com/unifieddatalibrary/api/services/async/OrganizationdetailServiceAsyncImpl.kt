...
class OrganizationdetailServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : OrganizationdetailServiceAsync {

    private val withRawResponse: OrganizationdetailServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): OrganizationdetailServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OrganizationdetailServiceAsync = OrganizationdetailServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: OrganizationdetailCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/organizationdetails
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun update(params: OrganizationdetailUpdateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // put /udl/organizationdetails/{id}
        withRawResponse().update(params, requestOptions).thenAccept {}

    override fun list(params: OrganizationdetailListParams, requestOptions: RequestOptions): CompletableFuture<OrganizationdetailListPageAsync> =
        // get /udl/organizationdetails
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: OrganizationdetailDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /udl/organizationdetails/{id}
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun findBySource(params: OrganizationdetailFindBySourceParams, requestOptions: RequestOptions): CompletableFuture<List<OrganizationdetailFindBySourceResponse>> =
        // get /udl/organizationdetails/findBySource
        withRawResponse().findBySource(params, requestOptions).thenApply { it.parse() }

    override fun get(params: OrganizationdetailGetParams, requestOptions: RequestOptions): CompletableFuture<OrganizationDetailsFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OrganizationdetailServiceAsync.WithRawResponse = OrganizationdetailServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: OrganizationdetailCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun update(params: OrganizationdetailUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: OrganizationdetailListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<OrganizationdetailListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: OrganizationdetailDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun findBySource(params: OrganizationdetailFindBySourceParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<OrganizationdetailFindBySourceResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: OrganizationdetailGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<OrganizationDetailsFull>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
