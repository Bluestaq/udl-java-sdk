...
interface OnorbitthrusterstatusServiceAsync {
     ...
     */
    fun list(): CompletableFuture<OnorbitthrusterstatusListPageAsync> =
    ...
    fun list(
        params: OnorbitthrusterstatusListParams = OnorbitthrusterstatusListParams.none()
    ): CompletableFuture<OnorbitthrusterstatusListPageAsync> = list(params, RequestOptions.none())
    ...
    fun delete(id: String): CompletableFuture<Void?> =
        delete(id, OnorbitthrusterstatusDeleteParams.none())
    ...
    fun get(
        id: String,
        params: OnorbitthrusterstatusGetParams = OnorbitthrusterstatusGetParams.none(),
    ): CompletableFuture<OnorbitthrusterstatusFull> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<OnorbitthrusterstatusQueryhelpResponse> =
    ...
    ): CompletableFuture<List<OnorbitthrusterstatusFull>> = tuple(params, RequestOptions.none())
    ...
    /**
     * A view of [OnorbitthrusterstatusServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * same as [OnorbitthrusterstatusServiceAsync.create].
         */
         ...
         * same as [OnorbitthrusterstatusServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<OnorbitthrusterstatusListPageAsync>> =
            list(OnorbitthrusterstatusListParams.none())
         ...
         * otherwise the same as [OnorbitthrusterstatusServiceAsync.delete].
         */
         ...
         * the same as [OnorbitthrusterstatusServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(OnorbitthrusterstatusCountParams.none())
         ...
         * otherwise the same as [OnorbitthrusterstatusServiceAsync.createBulk].
         */
        fun createBulk(
            params: OnorbitthrusterstatusCreateBulkParams
         ...
         * the same as [OnorbitthrusterstatusServiceAsync.get].
         */
         ...
         * otherwise the same as [OnorbitthrusterstatusServiceAsync.queryhelp].
         */
        fun queryhelp():
         ...
         * the same as [OnorbitthrusterstatusServiceAsync.tuple].
         */
        fun tuple(
            params: OnorbitthrusterstatusTupleParams
