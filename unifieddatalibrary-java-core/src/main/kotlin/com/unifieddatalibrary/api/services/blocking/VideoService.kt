...
interface VideoService {
     ...
     */
    fun create(params: VideoCreateParams) = create(params, RequestOptions.none())
     ...
     * parameter.
     */
    fun get(id: String): VideoStreamsFull = get(id, VideoGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): VideoStreamsFull = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: VideoGetParams): VideoStreamsFull = get(params, RequestOptions.none())
    ...
    ): VideoGetPlayerStreamingInfoResponse = getPlayerStreamingInfo(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: VideoQueryhelpParams = VideoQueryhelpParams.none()
    ): VideoQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: VideoCreateParams): HttpResponse = create(params, RequestOptions.none())
         ...
         * [VideoService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(VideoCountParams.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<VideoStreamsFull> = get(id, VideoGetParams.none())
        ...
        fun get(
            ...
            params: VideoGetParams = VideoGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<VideoStreamsFull> =
        ...
        fun get(
            id: String,
            params: VideoGetParams = VideoGetParams.none(),
        ): HttpResponseFor<VideoStreamsFull> = get(id, params, RequestOptions.none())
         ...
         * the same as [VideoService.getPlayerStreamingInfo].
         */
        @MustBeClosed
        fun getPlayerStreamingInfo(
            params: VideoGetPlayerStreamingInfoParams
        ): HttpResponseFor<VideoGetPlayerStreamingInfoResponse> =
         ...
         * otherwise the same as [VideoService.getPublisherStreamingInfo].
         */
        @MustBeClosed
        fun getPublisherStreamingInfo(
            params: VideoGetPublisherStreamingInfoParams
        ): HttpResponseFor<VideoGetPublisherStreamingInfoResponse> =
            getPublisherStreamingInfo(params, RequestOptions.none())
         ...
         * as [VideoService.getStreamFile].
         */
        @MustBeClosed
        fun getStreamFile(
            params: VideoGetStreamFileParams
        ): HttpResponseFor<VideoGetStreamFileResponse> =
            getStreamFile(params, RequestOptions.none())
         ...
         * [VideoService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<VideoQueryhelpResponse> =
        ...
        fun queryhelp(
            params: VideoQueryhelpParams = VideoQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<VideoQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: VideoQueryhelpParams = VideoQueryhelpParams.none()
        ): HttpResponseFor<VideoQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: VideoTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<VideoStreamsFull>>
    }
}
