...
class OnorbitdetailServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    OnorbitdetailService {

    private val withRawResponse: OnorbitdetailService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): OnorbitdetailService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnorbitdetailService =
        OnorbitdetailServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnorbitdetailServiceImpl.WithRawResponseImpl(
