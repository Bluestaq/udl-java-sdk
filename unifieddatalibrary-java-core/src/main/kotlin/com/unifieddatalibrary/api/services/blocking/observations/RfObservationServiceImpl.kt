...
class RfObservationServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    RfObservationService {

    private val withRawResponse: RfObservationService.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RfObservationService =
        RfObservationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            RfObservationServiceImpl.WithRawResponseImpl(
