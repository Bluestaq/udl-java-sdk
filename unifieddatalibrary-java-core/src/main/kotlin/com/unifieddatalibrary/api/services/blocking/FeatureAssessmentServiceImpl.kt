...
class FeatureAssessmentServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : FeatureAssessmentService {

    private val withRawResponse: FeatureAssessmentService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): FeatureAssessmentService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): FeatureAssessmentService = FeatureAssessmentServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: FeatureAssessmentRetrieveParams, requestOptions: RequestOptions): FeatureAssessmentRetrieveResponse =
        // get /udl/featureassessment/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun count(params: FeatureAssessmentCountParams, requestOptions: RequestOptions): String =
        // get /udl/featureassessment/count
        withRawResponse().count(params, requestOptions).parse()

    override fun createBulk(params: FeatureAssessmentCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/featureassessment/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun query(params: FeatureAssessmentQueryParams, requestOptions: RequestOptions): List<FeatureAssessmentQueryResponse> =
        // get /udl/featureassessment
        withRawResponse().query(params, requestOptions).parse()

    override fun queryHelp(params: FeatureAssessmentQueryHelpParams, requestOptions: RequestOptions): FeatureAssessmentQueryHelpResponse =
        // get /udl/featureassessment/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: FeatureAssessmentTupleParams, requestOptions: RequestOptions): List<FeatureAssessmentTupleResponse> =
        // get /udl/featureassessment/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: FeatureAssessmentUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): FeatureAssessmentService.WithRawResponse = FeatureAssessmentServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: FeatureAssessmentCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: FeatureAssessmentRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<FeatureAssessmentRetrieveResponse> {
        ...
        override fun count(params: FeatureAssessmentCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: FeatureAssessmentCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun query(params: FeatureAssessmentQueryParams, requestOptions: RequestOptions): HttpResponseFor<List<FeatureAssessmentQueryResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "featureassessment")
        ...
        override fun queryHelp(params: FeatureAssessmentQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<FeatureAssessmentQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: FeatureAssessmentTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<FeatureAssessmentTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: FeatureAssessmentUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
