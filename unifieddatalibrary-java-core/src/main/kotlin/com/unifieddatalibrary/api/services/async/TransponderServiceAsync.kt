...
interface TransponderServiceAsync {
    ...
    fun list(
        params: TransponderListParams = TransponderListParams.none()
    ): CompletableFuture<TransponderListPageAsync> = list(params, RequestOptions.none())
     ...
     * channels.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, TransponderDeleteParams.none())
    ...
    fun get(
        id: String,
        params: TransponderGetParams = TransponderGetParams.none(),
    ): CompletableFuture<TransponderGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<TransponderQueryhelpResponse> =
    ...
    fun queryhelp(
        params: TransponderQueryhelpParams = TransponderQueryhelpParams.none()
    ): CompletableFuture<TransponderQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [TransponderServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * [TransponderServiceAsync.create].
         */
         ...
         * [TransponderServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: TransponderUpdateParams,
         ...
         * [TransponderServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<TransponderListPageAsync>> =
            list(TransponderListParams.none())
         ...
         * as [TransponderServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, TransponderDeleteParams.none())
         ...
         * as [TransponderServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(TransponderCountParams.none())
         ...
         * same as [TransponderServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<TransponderQueryhelpResponse>> =
            queryhelp(TransponderQueryhelpParams.none())
         ...
         * as [TransponderServiceAsync.tuple].
         */
        fun tuple(
            params: TransponderTupleParams
