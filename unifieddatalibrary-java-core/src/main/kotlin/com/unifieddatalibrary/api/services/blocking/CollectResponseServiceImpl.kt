...
class CollectResponseServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CollectResponseService {

    private val withRawResponse: CollectResponseService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CollectResponseService = CollectResponseServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: CollectResponseRetrieveParams, requestOptions: RequestOptions): CollectResponseFull =
        // get /udl/collectresponse/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: CollectResponseListParams, requestOptions: RequestOptions): CollectResponseListPage =
    ...
    override fun createBulk(params: CollectResponseCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/collectresponse/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun queryHelp(params: CollectResponseQueryHelpParams, requestOptions: RequestOptions): CollectResponseQueryHelpResponse =
        // get /udl/collectresponse/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun unvalidatedPublish(params: CollectResponseUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val tuple: TupleService.WithRawResponse by lazy { TupleServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CollectResponseService.WithRawResponse = CollectResponseServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: CollectResponseCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: CollectResponseRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CollectResponseFull> {
        ...
        override fun list(params: CollectResponseListParams, requestOptions: RequestOptions): HttpResponseFor<CollectResponseListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "collectresponse")
        ...
        override fun count(params: CollectResponseCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: CollectResponseCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: CollectResponseQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<CollectResponseQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: CollectResponseUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
