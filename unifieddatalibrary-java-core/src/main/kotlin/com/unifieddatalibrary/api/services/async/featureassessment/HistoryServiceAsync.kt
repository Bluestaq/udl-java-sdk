...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/featureassessment/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
        ...
        /** Returns a raw HTTP response for `get /udl/featureassessment/history`, but is otherwise the same as [HistoryServiceAsync.query]. */
        ...
        /** Returns a raw HTTP response for `get /udl/featureassessment/history/aodr`, but is otherwise the same as [HistoryServiceAsync.writeAodr]. */
