...
package com.unifieddatalibrary.api.services.async.observations.eoobservations
...
import com.unifieddatalibrary.api.models.observations.eoobservations.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.observations.eoobservations.history.HistoryCountParams
import com.unifieddatalibrary.api.models.observations.eoobservations.history.HistoryListPage
import com.unifieddatalibrary.api.models.observations.eoobservations.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.observations.eoobservations.history.HistoryListParams
...
class HistoryServiceAsyncImpl internal constructor(
    ...
    override fun count(params: HistoryCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/eoobservation/history/count
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val listHandler: Handler<List<EoObservationFull>> = jsonHandler<List<EoObservationFull>>(clientOptions.jsonMapper)
        ...
        override fun list(params: HistoryListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<HistoryListPageAsync>> {
          val request = HttpRequest.builder()
            ...
            .addPathSegments("udl", "eoobservation", "history")
            .build()
        ...
        override fun aodr(params: HistoryAodrParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "eoobservation", "history", "aodr")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun count(params: HistoryCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "eoobservation", "history", "count")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
