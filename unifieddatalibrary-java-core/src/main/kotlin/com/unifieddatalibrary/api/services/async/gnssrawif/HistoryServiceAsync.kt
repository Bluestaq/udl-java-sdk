...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/gnssrawif/history/aodr`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/gnssrawif/history/count`, but is otherwise the
         * same as [HistoryServiceAsync.count].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/gnssrawif/history`, but is otherwise the same
         * as [HistoryServiceAsync.query].
         */
        fun query(
            params: HistoryQueryParams
