...
package com.unifieddatalibrary.api.services.async.gnssrawif

import com.unifieddatalibrary.api.core.ClientOptions
import com.unifieddatalibrary.api.core.RequestOptions
import com.unifieddatalibrary.api.core.http.HttpResponse
import com.unifieddatalibrary.api.core.http.HttpResponseFor
import com.unifieddatalibrary.api.models.gnssrawif.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.gnssrawif.history.HistoryCountParams
import com.unifieddatalibrary.api.models.gnssrawif.history.HistoryQueryParams
import com.unifieddatalibrary.api.models.gnssrawif.history.HistoryQueryResponse
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/gnssrawif/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/gnssrawif/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
        ...
        /** Returns a raw HTTP response for `get /udl/gnssrawif/history`, but is otherwise the same as [HistoryServiceAsync.query]. */
