...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/mti/history`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/mti/history/aodr`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/mti/history/count`, but is otherwise the same
