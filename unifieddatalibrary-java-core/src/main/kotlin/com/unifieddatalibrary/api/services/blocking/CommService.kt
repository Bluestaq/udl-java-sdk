...
interface CommService {
     ...
     */
    fun create(params: CommCreateParams) = create(params, RequestOptions.none())
     ...
     * and channels, etc.
     */
    fun retrieve(id: String): CommFull = retrieve(id, CommRetrieveParams.none())
    ...
    ): CommFull = retrieve(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see retrieve */
    fun retrieve(params: CommRetrieveParams): CommFull = retrieve(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: CommUpdateParams) = update(params, RequestOptions.none())
     ...
     * the UDL team for assistance.
     */
    fun delete(id: String) = delete(id, CommDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: CommDeleteParams) = delete(params, RequestOptions.none())
     ...
     */
    fun tuple(params: CommTupleParams): List<CommFull> = tuple(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: CommCreateParams): HttpResponse = create(params, RequestOptions.none())
        ...
        fun retrieve(
            ...
            params: CommRetrieveParams = CommRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<CommFull> = retrieve(params.toBuilder().id(id).build(), requestOptions)
        ...
        fun retrieve(
            id: String,
            params: CommRetrieveParams = CommRetrieveParams.none(),
        ): HttpResponseFor<CommFull> = retrieve(id, params, RequestOptions.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: CommUpdateParams): HttpResponse = update(params, RequestOptions.none())
         ...
         * [CommService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<CommListPage> = list(CommListParams.none())
         ...
         * [CommService.delete].
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, CommDeleteParams.none())
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: CommDeleteParams): HttpResponse = delete(params, RequestOptions.none())
         ...
         * [CommService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(CommCountParams.none())
         ...
         * [CommService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<CommQueryhelpResponse> =
        ...
        fun queryhelp(
            params: CommQueryhelpParams = CommQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<CommQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: CommQueryhelpParams = CommQueryhelpParams.none()
        ): HttpResponseFor<CommQueryhelpResponse> = queryhelp(params, RequestOptions.none())
