...
interface OnorbitthrusterServiceAsync {
     ...
     */
    fun list(): CompletableFuture<OnorbitthrusterListPageAsync> =
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OnorbitthrusterListPageAsync>

    /** @see list */
    fun list(
        params: OnorbitthrusterListParams = OnorbitthrusterListParams.none()
    ): CompletableFuture<OnorbitthrusterListPageAsync> = list(params, RequestOptions.none())
    ...
    fun delete(id: String): CompletableFuture<Void?> =
        delete(id, OnorbitthrusterDeleteParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OnorbitThrusterFull> =
    ...
    fun get(
        id: String,
        params: OnorbitthrusterGetParams = OnorbitthrusterGetParams.none(),
    ): CompletableFuture<OnorbitThrusterFull> = get(id, params, RequestOptions.none())
    ...
    /**
     * A view of [OnorbitthrusterServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * same as [OnorbitthrusterServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: OnorbitthrusterUpdateParams,
         ...
         * [OnorbitthrusterServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<OnorbitthrusterListPageAsync>> =
            list(OnorbitthrusterListParams.none())
        ...
        fun list(
            params: OnorbitthrusterListParams = OnorbitthrusterListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OnorbitthrusterListPageAsync>>
         ...
         * same as [OnorbitthrusterServiceAsync.delete].
         */
         ...
         * same as [OnorbitthrusterServiceAsync.get].
         */
        ...
        fun get(
            ...
            params: OnorbitthrusterGetParams = OnorbitthrusterGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OnorbitThrusterFull>> =
            get(params.toBuilder().id(id).build(), requestOptions)
