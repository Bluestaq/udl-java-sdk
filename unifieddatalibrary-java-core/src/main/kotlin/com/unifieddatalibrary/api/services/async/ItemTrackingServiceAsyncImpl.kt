...
class ItemTrackingServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ItemTrackingServiceAsync {

    private val withRawResponse: ItemTrackingServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): ItemTrackingServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ItemTrackingServiceAsync = ItemTrackingServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryServiceAsync = history

    override fun create(params: ItemTrackingCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/itemtracking
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun list(params: ItemTrackingListParams, requestOptions: RequestOptions): CompletableFuture<ItemTrackingListPageAsync> =
        // get /udl/itemtracking
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: ItemTrackingDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /udl/itemtracking/{id}
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun count(params: ItemTrackingCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/itemtracking/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun get(params: ItemTrackingGetParams, requestOptions: RequestOptions): CompletableFuture<ItemTrackingGetResponse> =
        // get /udl/itemtracking/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: ItemTrackingQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<ItemTrackingQueryhelpResponse> =
        // get /udl/itemtracking/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: ItemTrackingTupleParams, requestOptions: RequestOptions): CompletableFuture<List<ItemTrackingTupleResponse>> =
        // get /udl/itemtracking/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun unvalidatedPublish(params: ItemTrackingUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ItemTrackingServiceAsync.WithRawResponse = ItemTrackingServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryServiceAsync.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: ItemTrackingCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: ItemTrackingListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ItemTrackingListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: ItemTrackingDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun count(params: ItemTrackingCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: ItemTrackingGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ItemTrackingGetResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: ItemTrackingQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ItemTrackingQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: ItemTrackingTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<ItemTrackingTupleResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: ItemTrackingUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
