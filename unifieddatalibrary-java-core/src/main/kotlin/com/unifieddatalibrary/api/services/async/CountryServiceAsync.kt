...
interface CountryServiceAsync {
    ...
    fun retrieve(
        code: String,
        params: CountryRetrieveParams = CountryRetrieveParams.none(),
    ): CompletableFuture<CountryFull> = retrieve(code, params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(code: String): CompletableFuture<Void?> = delete(code, CountryDeleteParams.none())
    ...
    fun delete(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> = delete(params.toBuilder().code(code).build(), requestOptions)

    /** @see delete */
    fun delete(
        code: String,
        params: CountryDeleteParams = CountryDeleteParams.none(),
    ): CompletableFuture<Void?> = delete(code, params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<CountryFull>>
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            ...
            params: CountryRetrieveParams = CountryRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<CountryFull>> =
            retrieve(params.toBuilder().code(code).build(), requestOptions)
        ...
        fun retrieve(
            ...
            retrieve(code, params, RequestOptions.none())
        ...
        fun retrieve(
            params: CountryRetrieveParams
        ): CompletableFuture<HttpResponseFor<CountryFull>> = retrieve(params, RequestOptions.none())
         ...
         * as [CountryServiceAsync.delete].
         */
        fun delete(code: String): CompletableFuture<HttpResponse> =
            delete(code, CountryDeleteParams.none())
        ...
        fun delete(
            code: String,
            params: CountryDeleteParams = CountryDeleteParams.none(),
        ): CompletableFuture<HttpResponse> = delete(code, params, RequestOptions.none())
         ...
         * as [CountryServiceAsync.queryhelp].
         */
        ...
        fun tuple(
            params: CountryTupleParams
        ): CompletableFuture<HttpResponseFor<List<CountryFull>>> =
            tuple(params, RequestOptions.none())
