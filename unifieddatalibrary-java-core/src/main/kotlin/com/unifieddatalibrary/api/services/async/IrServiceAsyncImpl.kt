...
class IrServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    IrServiceAsync {

    private val withRawResponse: IrServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): IrServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): IrServiceAsync =
        IrServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        params: IrListParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<IrListPageAsync> =
        // get /udl/ir
    ...
    override fun get(
        params: IrGetParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<IrGetResponse> =
        // get /udl/ir/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(
        params: IrQueryhelpParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<IrQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<IrTupleResponse>> =
        // get /udl/ir/tuple
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            IrServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<IrListResponse>> =
            jsonHandler<List<IrListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: IrListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<IrListPageAsync>> {
            val request =
                HttpRequest.builder()
        ...
        private val getHandler: Handler<IrGetResponse> =
            jsonHandler<IrGetResponse>(clientOptions.jsonMapper)

        override fun get(
            params: IrGetParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<IrGetResponse>> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("id", params.id().getOrNull())
            val request =
        ...
        private val queryhelpHandler: Handler<IrQueryhelpResponse> =
            jsonHandler<IrQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(
            params: IrQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<IrQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<IrTupleResponse>> =
            jsonHandler<List<IrTupleResponse>>(clientOptions.jsonMapper)

        override fun tuple(
            params: IrTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<IrTupleResponse>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
