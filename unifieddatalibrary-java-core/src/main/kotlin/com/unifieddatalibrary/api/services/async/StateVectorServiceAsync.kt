...
interface StateVectorServiceAsync {
     ...
     */
    fun get(id: String): CompletableFuture<StateVectorFull> = get(id, StateVectorGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<StateVectorFull> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: StateVectorGetParams = StateVectorGetParams.none(),
    ): CompletableFuture<StateVectorFull> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<StateVectorQueryhelpResponse> =
    ...
    fun queryhelp(
        params: StateVectorQueryhelpParams = StateVectorQueryhelpParams.none()
    ): CompletableFuture<StateVectorQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [StateVectorServiceAsync.count].
         */
         ...
         * same as [StateVectorServiceAsync.createBulk].
         */
        ...
        fun get(id: String): CompletableFuture<HttpResponseFor<StateVectorFull>> =
            get(id, StateVectorGetParams.none())
         ...
         * same as [StateVectorServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<StateVectorQueryhelpResponse>> =
            queryhelp(StateVectorQueryhelpParams.none())
         ...
         * as [StateVectorServiceAsync.tuple].
         */
        fun tuple(
            params: StateVectorTupleParams
