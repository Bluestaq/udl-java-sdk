...
class GeoStatusServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    GeoStatusServiceAsync {

    private val withRawResponse: GeoStatusServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GeoStatusServiceAsync =
        GeoStatusServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(
        params: GeoStatusQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            GeoStatusServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<GeoStatusListResponse>> =
            jsonHandler<List<GeoStatusListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<GeoStatusFull> =
            jsonHandler<GeoStatusFull>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<GeoStatusQueryhelpResponse> =
            jsonHandler<GeoStatusQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<GeoStatusFull>> =
            jsonHandler<List<GeoStatusFull>>(clientOptions.jsonMapper)
