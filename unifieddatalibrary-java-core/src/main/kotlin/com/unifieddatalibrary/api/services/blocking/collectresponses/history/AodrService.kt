...
interface AodrService {
    ...
    fun list(params: AodrListParams) =
        list(
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/collectresponse/history/aodr`, but is otherwise the same as [AodrService.list]. */
        @MustBeClosed
        fun list(params: AodrListParams): HttpResponse =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: AodrListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
