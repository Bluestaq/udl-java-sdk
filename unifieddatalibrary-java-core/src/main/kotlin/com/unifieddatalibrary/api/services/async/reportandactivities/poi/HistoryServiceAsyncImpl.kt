...
package com.unifieddatalibrary.api.services.async.reportandactivities.poi
...
import com.unifieddatalibrary.api.models.reportandactivities.poi.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.reportandactivities.poi.history.HistoryCountParams
import com.unifieddatalibrary.api.models.reportandactivities.poi.history.HistoryListPage
import com.unifieddatalibrary.api.models.reportandactivities.poi.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.reportandactivities.poi.history.HistoryListParams
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun list(params: HistoryListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<HistoryListPageAsync>> {
          val request = HttpRequest.builder()
            ...
            .addPathSegments("udl", "poi", "history")
            .build()
        ...
        override fun aodr(params: HistoryAodrParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "poi", "history", "aodr")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun count(params: HistoryCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "poi", "history", "count")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
