...
internal constructor(private val clientOptions: ClientOptions) : OrbitdeterminationServiceAsync {
    ...
    private val withRawResponse: OrbitdeterminationServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        OrbitdeterminationServiceAsyncImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OrbitdeterminationServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
