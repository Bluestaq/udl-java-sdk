...
interface OrganizationService {
     ...
     * for assistance.
     */
    fun create(params: OrganizationCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: OrganizationUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, OrganizationDeleteParams.none())
     ...
     */
    fun get(id: String): OrganizationFull = get(id, OrganizationGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): OrganizationFull = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: OrganizationGetParams = OrganizationGetParams.none(),
    ): OrganizationFull = get(id, params, RequestOptions.none())
    ...
    /** @see get */
    fun get(params: OrganizationGetParams): OrganizationFull = get(params, RequestOptions.none())
    ...
    fun getOrganizationCategories(): List<String> =
    ...
    fun getOrganizationCategories(
        params: OrganizationGetOrganizationCategoriesParams =
            OrganizationGetOrganizationCategoriesParams.none()
    ): List<String> = getOrganizationCategories(params, RequestOptions.none())
    ...
    fun getOrganizationTypes(): List<String> =
    ...
    fun getOrganizationTypes(
        params: OrganizationGetOrganizationTypesParams =
            OrganizationGetOrganizationTypesParams.none()
    ): List<String> = getOrganizationTypes(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: OrganizationQueryhelpParams = OrganizationQueryhelpParams.none()
    ): OrganizationQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [OrganizationService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, OrganizationDeleteParams.none())
         ...
         * as [OrganizationService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(OrganizationCountParams.none())
        ...
        fun get(
            ...
            params: OrganizationGetParams = OrganizationGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<OrganizationFull> =
        ...
        fun get(
            id: String,
            params: OrganizationGetParams = OrganizationGetParams.none(),
        ): HttpResponseFor<OrganizationFull> = get(id, params, RequestOptions.none())
         ...
         * otherwise the same as [OrganizationService.getOrganizationCategories].
         */
        @MustBeClosed
        fun getOrganizationCategories(): HttpResponseFor<List<String>> =
            getOrganizationCategories(OrganizationGetOrganizationCategoriesParams.none())
        ...
        fun getOrganizationCategories(
            params: OrganizationGetOrganizationCategoriesParams =
                OrganizationGetOrganizationCategoriesParams.none()
        ): HttpResponseFor<List<String>> = getOrganizationCategories(params, RequestOptions.none())
         ...
         * otherwise the same as [OrganizationService.getOrganizationTypes].
         */
        @MustBeClosed
        fun getOrganizationTypes(): HttpResponseFor<List<String>> =
            getOrganizationTypes(OrganizationGetOrganizationTypesParams.none())
        ...
        fun getOrganizationTypes(
            params: OrganizationGetOrganizationTypesParams =
                OrganizationGetOrganizationTypesParams.none()
        ): HttpResponseFor<List<String>> = getOrganizationTypes(params, RequestOptions.none())
         ...
         * same as [OrganizationService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<OrganizationQueryhelpResponse> =
        ...
        fun queryhelp(
            params: OrganizationQueryhelpParams = OrganizationQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<OrganizationQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: OrganizationQueryhelpParams = OrganizationQueryhelpParams.none()
        ): HttpResponseFor<OrganizationQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: OrganizationTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<OrganizationFull>>
    }
}
