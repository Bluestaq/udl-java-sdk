...
class H3GeoServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    H3GeoServiceAsync {

    private val withRawResponse: H3GeoServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): H3GeoServiceAsync =
        H3GeoServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            H3GeoServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<H3GeoListResponse>> =
            jsonHandler<List<H3GeoListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<H3GeoGetResponse> =
            jsonHandler<H3GeoGetResponse>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<H3GeoQueryhelpResponse> =
            jsonHandler<H3GeoQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<H3GeoTupleResponse>> =
            jsonHandler<List<H3GeoTupleResponse>>(clientOptions.jsonMapper)
