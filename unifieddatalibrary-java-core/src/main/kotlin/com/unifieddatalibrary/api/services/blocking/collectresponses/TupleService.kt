...
interface TupleService {
     ...
     */
    fun list(params: TupleListParams): TupleListPage = list(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/collectresponse/tuple`, but is otherwise the
         * same as [TupleService.list].
         */
        @MustBeClosed
