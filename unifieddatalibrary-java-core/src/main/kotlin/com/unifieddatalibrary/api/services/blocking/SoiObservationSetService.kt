...
interface SoiObservationSetService {
     ...
     */
    fun create(params: SoiObservationSetCreateParams) = create(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: SoiObservationSetCountParams): String = count(params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<SoiObservationSetCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) = createBulk(SoiObservationSetCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<SoiObservationSetCreateBulkParams.Body>) =
     ...
     * parameter.
     */
    fun get(id: String): SoiObservationSetFull = get(id, SoiObservationSetGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SoiObservationSetFull = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: SoiObservationSetGetParams = SoiObservationSetGetParams.none(),
    ): SoiObservationSetFull = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): SoiObservationSetQueryhelpResponse =
    ...
    fun queryhelp(
        params: SoiObservationSetQueryhelpParams = SoiObservationSetQueryhelpParams.none()
    ): SoiObservationSetQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<SoiObservationSetUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            SoiObservationSetUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<SoiObservationSetUnvalidatedPublishParams.Body>) =
        unvalidatedPublish(body, RequestOptions.none())

    /**
     * A view of [SoiObservationSetService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [SoiObservationSetService.create].
         */
        @MustBeClosed
         ...
         * as [SoiObservationSetService.list].
         */
        @MustBeClosed
         ...
         * same as [SoiObservationSetService.count].
         */
        @MustBeClosed
         ...
         * otherwise the same as [SoiObservationSetService.createBulk].
         */
        @MustBeClosed
        ...
        fun createBulk(
            ...
            createBulk(
                SoiObservationSetCreateBulkParams.builder().body(body).build(),
                requestOptions,
            )

        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<SoiObservationSetCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/soiobservationset/{id}`, but is otherwise the
         * same as [SoiObservationSetService.get].
         */
        @MustBeClosed
        ...
        fun get(
            id: String,
            params: SoiObservationSetGetParams = SoiObservationSetGetParams.none(),
        ): HttpResponseFor<SoiObservationSetFull> = get(id, params, RequestOptions.none())
         ...
         * the same as [SoiObservationSetService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SoiObservationSetQueryhelpResponse> =
            queryhelp(SoiObservationSetQueryhelpParams.none())
         ...
         * same as [SoiObservationSetService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: SoiObservationSetTupleParams
        ): HttpResponseFor<List<SoiObservationSetFull>> = tuple(params, RequestOptions.none())
         ...
         * the same as [SoiObservationSetService.unvalidatedPublish].
         */
        @MustBeClosed
