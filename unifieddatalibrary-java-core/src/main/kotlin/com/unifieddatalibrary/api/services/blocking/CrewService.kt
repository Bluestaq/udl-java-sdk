...
interface CrewService {
    ...
    /**
     * Service operation to take a single Crew object as a POST body and ingest into the database. A
     * specific role is required to perform this service operation. Please contact the UDL team for
     * assistance.
     */
    fun create(params: CrewCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun retrieve(id: String): CrewFull = retrieve(id, CrewRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: CrewRetrieveParams = CrewRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CrewFull = retrieve(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see retrieve */
    fun retrieve(params: CrewRetrieveParams): CrewFull = retrieve(params, RequestOptions.none())

    /** @see retrieve */
    fun retrieve(id: String, requestOptions: RequestOptions): CrewFull =
        retrieve(id, CrewRetrieveParams.none(), requestOptions)

    /**
     * Service operation to update a single Crew record. A specific role is required to perform this
    ...
    /** @see update */
    fun update(params: CrewUpdateParams) = update(params, RequestOptions.none())
    ...
    /** @see list */
    fun list(
        params: CrewListParams = CrewListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CrewListPage
    ...
    fun list(requestOptions: RequestOptions): CrewListPage =
        list(CrewListParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: CrewCountParams = CrewCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): String
    ...
    fun count(requestOptions: RequestOptions): String =
        count(CrewCountParams.none(), requestOptions)
    ...
    /** @see queryhelp */
    fun queryhelp(
        params: CrewQueryhelpParams = CrewQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(requestOptions: RequestOptions): CrewQueryhelpResponse =
        queryhelp(CrewQueryhelpParams.none(), requestOptions)
     ...
     */
    fun tuple(params: CrewTupleParams): List<CrewFull> = tuple(params, RequestOptions.none())
    ...
    /**
     * Service operation to take multiple Crew objects as a POST body and ingest into the database.
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/crew`, but is otherwise the same as
         * [CrewService.create].
         */
        @MustBeClosed
        fun create(params: CrewCreateParams): HttpResponse = create(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/crew/{id}`, but is otherwise the same as
         * [CrewService.retrieve].
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<CrewFull> =
            retrieve(id, CrewRetrieveParams.none())
        ...
        fun retrieve(
            ...
            params: CrewRetrieveParams = CrewRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<CrewFull> = retrieve(params.toBuilder().id(id).build(), requestOptions)
        ...
        fun retrieve(
            id: String,
            params: CrewRetrieveParams = CrewRetrieveParams.none(),
        ): HttpResponseFor<CrewFull> = retrieve(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `put /udl/crew/{id}`, but is otherwise the same as
         * [CrewService.update].
         */
        @MustBeClosed
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: CrewUpdateParams): HttpResponse = update(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/crew`, but is otherwise the same as
         * [CrewService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<CrewListPage> = list(CrewListParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/crew/count`, but is otherwise the same as
         * [CrewService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(CrewCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/crew/queryhelp`, but is otherwise the same as
         * [CrewService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<CrewQueryhelpResponse> =
            queryhelp(CrewQueryhelpParams.none())
        ...
        fun queryhelp(
            params: CrewQueryhelpParams = CrewQueryhelpParams.none()
        ): HttpResponseFor<CrewQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/crew/tuple`, but is otherwise the same as
         * [CrewService.tuple].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-crew`, but is otherwise the same as
         * [CrewService.unvalidatedPublish].
         */
        @MustBeClosed
