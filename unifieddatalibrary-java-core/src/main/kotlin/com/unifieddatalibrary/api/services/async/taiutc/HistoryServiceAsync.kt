...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/taiutc/history`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/taiutc/history/aodr`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/taiutc/history/count`, but is otherwise the
