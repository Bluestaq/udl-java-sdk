...
class AirTaskingOrderServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : AirTaskingOrderServiceAsync {

    private val withRawResponse: AirTaskingOrderServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        AirTaskingOrderServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AirTaskingOrderServiceAsyncImpl.WithRawResponseImpl(
