...
package com.unifieddatalibrary.api.services.async.sensorplan
...
interface HistoryServiceAsync {
    ...
    fun retrieve(params: HistoryRetrieveParams): CompletableFuture<List<HistoryRetrieveResponse>> =
        retrieve(
          params, RequestOptions.none()
        )

    /** @see retrieve */
    fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<List<HistoryRetrieveResponse>>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/sensorplan/history`, but is otherwise the same as [HistoryServiceAsync.retrieve]. */
        fun retrieve(params: HistoryRetrieveParams): CompletableFuture<HttpResponseFor<List<HistoryRetrieveResponse>>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<List<HistoryRetrieveResponse>>>

        /** Returns a raw HTTP response for `get /udl/sensorplan/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/sensorplan/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
