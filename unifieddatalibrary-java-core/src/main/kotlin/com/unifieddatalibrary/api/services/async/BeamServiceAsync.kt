...
interface BeamServiceAsync {
     ...
     */
    fun retrieve(id: String): CompletableFuture<BeamFull> = retrieve(id, BeamRetrieveParams.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<BeamFull> = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: BeamRetrieveParams = BeamRetrieveParams.none(),
    ): CompletableFuture<BeamFull> = retrieve(id, params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, BeamDeleteParams.none())
     ...
     */
    fun queryHelp(): CompletableFuture<BeamQueryHelpResponse> =
    ...
    fun queryHelp(
        params: BeamQueryHelpParams = BeamQueryHelpParams.none()
    ): CompletableFuture<BeamQueryHelpResponse> = queryHelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [BeamServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<BeamListPageAsync>> =
            list(BeamListParams.none())
         ...
         * [BeamServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, BeamDeleteParams.none())
         ...
         * [BeamServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<BeamQueryHelpResponse>> =
            queryHelp(BeamQueryHelpParams.none())
