...
interface RfEmitterDetailService {
     ...
     */
    fun create(params: RfEmitterDetailCreateParams) = create(params, RequestOptions.none())
    ...
    /**
     * Service operation to update an RFEmitterDetails. A specific role is required to perform this
    ...
    /** @see update */
    fun update(params: RfEmitterDetailUpdateParams) = update(params, RequestOptions.none())
    ...
    fun list(
        params: RfEmitterDetailListParams = RfEmitterDetailListParams.none()
    ): RfEmitterDetailListPage = list(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, RfEmitterDetailDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: RfEmitterDetailDeleteParams) = delete(params, RequestOptions.none())
    ...
    /**
     * Service operation to get a single RFEmitterDetails by its unique ID passed as a path
     * parameter.
     */
    fun get(id: String): RfEmitterDetailGetResponse = get(id, RfEmitterDetailGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): RfEmitterDetailGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: RfEmitterDetailGetParams = RfEmitterDetailGetParams.none(),
    ): RfEmitterDetailGetResponse = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): RfEmitterDetailQueryhelpResponse =
    ...
    fun queryhelp(
        params: RfEmitterDetailQueryhelpParams = RfEmitterDetailQueryhelpParams.none()
    ): RfEmitterDetailQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [RfEmitterDetailService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [RfEmitterDetailService.create].
         */
        @MustBeClosed
         ...
         * same as [RfEmitterDetailService.update].
         */
        @MustBeClosed
         ...
         * [RfEmitterDetailService.list].
         */
        @MustBeClosed
        fun list(): HttpResponseFor<RfEmitterDetailListPage> =
        ...
        fun list(
            params: RfEmitterDetailListParams = RfEmitterDetailListParams.none()
        ): HttpResponseFor<RfEmitterDetailListPage> = list(params, RequestOptions.none())
         ...
         * same as [RfEmitterDetailService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, RfEmitterDetailDeleteParams.none())
         ...
         * same as [RfEmitterDetailService.count].
         */
        @MustBeClosed
         ...
         * same as [RfEmitterDetailService.get].
         */
        @MustBeClosed
        ...
        fun get(
            id: String,
            params: RfEmitterDetailGetParams = RfEmitterDetailGetParams.none(),
        ): HttpResponseFor<RfEmitterDetailGetResponse> = get(id, params, RequestOptions.none())
         ...
         * the same as [RfEmitterDetailService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<RfEmitterDetailQueryhelpResponse> =
            queryhelp(RfEmitterDetailQueryhelpParams.none())
         ...
         * same as [RfEmitterDetailService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: RfEmitterDetailTupleParams
