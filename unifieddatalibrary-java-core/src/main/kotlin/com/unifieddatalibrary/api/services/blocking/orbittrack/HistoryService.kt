...
package com.unifieddatalibrary.api.services.blocking.orbittrack
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/orbittrack/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/orbittrack/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/orbittrack/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
