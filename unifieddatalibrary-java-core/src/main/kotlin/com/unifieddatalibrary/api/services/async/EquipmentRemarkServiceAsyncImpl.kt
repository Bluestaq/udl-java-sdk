...
internal constructor(private val clientOptions: ClientOptions) : EquipmentRemarkServiceAsync {
    ...
    private val withRawResponse: EquipmentRemarkServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        EquipmentRemarkServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        params: EquipmentRemarkListParams,
        requestOptions: RequestOptions,
    ...
    override fun count(
        params: EquipmentRemarkCountParams,
        requestOptions: RequestOptions,
    ...
    override fun queryHelp(
        params: EquipmentRemarkQueryHelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EquipmentRemarkServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val retrieveHandler: Handler<EquipmentRemarkFull> =
            jsonHandler<EquipmentRemarkFull>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<List<EquipmentRemarkAbridged>> =
            jsonHandler<List<EquipmentRemarkAbridged>>(clientOptions.jsonMapper)
        ...
        private val queryHelpHandler: Handler<EquipmentRemarkQueryHelpResponse> =
            jsonHandler<EquipmentRemarkQueryHelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<EquipmentRemarkFull>> =
            jsonHandler<List<EquipmentRemarkFull>>(clientOptions.jsonMapper)
