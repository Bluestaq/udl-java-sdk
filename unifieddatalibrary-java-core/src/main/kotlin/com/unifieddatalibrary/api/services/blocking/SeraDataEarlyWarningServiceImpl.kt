...
internal constructor(private val clientOptions: ClientOptions) : SeraDataEarlyWarningService {
    ...
    private val withRawResponse: SeraDataEarlyWarningService.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        SeraDataEarlyWarningServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SeraDataEarlyWarningServiceImpl.WithRawResponseImpl(
