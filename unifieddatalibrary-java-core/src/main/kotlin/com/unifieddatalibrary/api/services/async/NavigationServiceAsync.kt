...
interface NavigationServiceAsync {
    ...
    fun list(
        params: NavigationListParams = NavigationListParams.none()
    ): CompletableFuture<NavigationListPageAsync> = list(params, RequestOptions.none())
     ...
     * service operation. Please contact the UDL team for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, NavigationDeleteParams.none())
    ...
    fun get(
        id: String,
        params: NavigationGetParams = NavigationGetParams.none(),
    ): CompletableFuture<NavigationGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<NavigationQueryhelpResponse> =
    ...
    fun queryhelp(
        params: NavigationQueryhelpParams = NavigationQueryhelpParams.none()
    ): CompletableFuture<NavigationQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [NavigationServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<NavigationListPageAsync>> =
            list(NavigationListParams.none())
         ...
         * as [NavigationServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, NavigationDeleteParams.none())
         ...
         * [NavigationServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(NavigationCountParams.none())
         ...
         * same as [NavigationServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<NavigationQueryhelpResponse>> =
            queryhelp(NavigationQueryhelpParams.none())
