...
interface BatteryServiceAsync {
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<BatteryFull> = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: BatteryRetrieveParams = BatteryRetrieveParams.none(),
    ): CompletableFuture<BatteryFull> = retrieve(id, params, RequestOptions.none())

    /** @see retrieve */
    fun retrieve(
        params: BatteryRetrieveParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<BatteryFull>
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<BatteryListPageAsync>

    /** @see list */
    fun list(
        params: BatteryListParams = BatteryListParams.none()
    ): CompletableFuture<BatteryListPageAsync> = list(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, BatteryDeleteParams.none())
     ...
     */
    fun queryhelp(): CompletableFuture<BatteryQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<BatteryQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: BatteryQueryhelpParams = BatteryQueryhelpParams.none()
    ): CompletableFuture<BatteryQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<BatteryFull>>
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            ...
            params: BatteryRetrieveParams = BatteryRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<BatteryFull>> =
        ...
        fun retrieve(
            params: BatteryRetrieveParams
        ): CompletableFuture<HttpResponseFor<BatteryFull>> = retrieve(params, RequestOptions.none())
         ...
         * [BatteryServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<BatteryListPageAsync>> =
            list(BatteryListParams.none())

        /** @see list */
        fun list(
            params: BatteryListParams = BatteryListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<BatteryListPageAsync>>
         ...
         * [BatteryServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, BatteryDeleteParams.none())
         ...
         * as [BatteryServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<BatteryQueryhelpResponse>> =
            queryhelp(BatteryQueryhelpParams.none())
        ...
        fun queryhelp(
            params: BatteryQueryhelpParams = BatteryQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<BatteryQueryhelpResponse>>
        ...
        fun tuple(
            params: BatteryTupleParams
        ): CompletableFuture<HttpResponseFor<List<BatteryFull>>> =
            tuple(params, RequestOptions.none())
