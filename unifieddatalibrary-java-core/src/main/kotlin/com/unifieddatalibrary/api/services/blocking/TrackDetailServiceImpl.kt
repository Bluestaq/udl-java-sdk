...
class TrackDetailServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : TrackDetailService {

    private val withRawResponse: TrackDetailService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): TrackDetailService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TrackDetailService = TrackDetailServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryService = history

    override fun list(params: TrackDetailListParams, requestOptions: RequestOptions): TrackDetailListPage =
    ...
    override fun queryhelp(params: TrackDetailQueryhelpParams, requestOptions: RequestOptions): TrackDetailQueryhelpResponse =
        // get /udl/trackdetails/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: TrackDetailTupleParams, requestOptions: RequestOptions): List<TrackDetailsFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TrackDetailService.WithRawResponse = TrackDetailServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: TrackDetailListParams, requestOptions: RequestOptions): HttpResponseFor<TrackDetailListPage> {
        ...
        override fun count(params: TrackDetailCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: TrackDetailCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: TrackDetailQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<TrackDetailQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: TrackDetailTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<TrackDetailsFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
