...
interface EoObservationServiceAsync {
    ...
    fun retrieve(
        id: String,
        params: EoObservationRetrieveParams = EoObservationRetrieveParams.none(),
    ): CompletableFuture<EoObservationFull> = retrieve(id, params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(body: List<EoObservationCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryhelp(): CompletableFuture<EoObservationQueryhelpResponse> =
    ...
    fun queryhelp(
        params: EoObservationQueryhelpParams = EoObservationQueryhelpParams.none()
    ): CompletableFuture<EoObservationQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [EoObservationServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [EoObservationServiceAsync.retrieve].
         */
         ...
         * as [EoObservationServiceAsync.count].
         */
         ...
         * the same as [EoObservationServiceAsync.createBulk].
         */
         ...
         * same as [EoObservationServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<EoObservationQueryhelpResponse>> =
            queryhelp(EoObservationQueryhelpParams.none())
         ...
         * as [EoObservationServiceAsync.tuple].
         */
        fun tuple(
            params: EoObservationTupleParams
