...
class ManifoldelsetServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ManifoldelsetService {

    private val withRawResponse: ManifoldelsetService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ManifoldelsetService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ManifoldelsetService = ManifoldelsetServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: ManifoldelsetListParams, requestOptions: RequestOptions): ManifoldelsetListPage =
    ...
    override fun get(params: ManifoldelsetGetParams, requestOptions: RequestOptions): ManifoldelsetGetResponse =
        // get /udl/manifoldelset/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: ManifoldelsetQueryhelpParams, requestOptions: RequestOptions): ManifoldelsetQueryhelpResponse =
        // get /udl/manifoldelset/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: ManifoldelsetTupleParams, requestOptions: RequestOptions): List<ManifoldelsetTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ManifoldelsetService.WithRawResponse = ManifoldelsetServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: ManifoldelsetCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: ManifoldelsetUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: ManifoldelsetListParams, requestOptions: RequestOptions): HttpResponseFor<ManifoldelsetListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: ManifoldelsetDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: ManifoldelsetCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: ManifoldelsetCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: ManifoldelsetGetParams, requestOptions: RequestOptions): HttpResponseFor<ManifoldelsetGetResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: ManifoldelsetQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<ManifoldelsetQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: ManifoldelsetTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<ManifoldelsetTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
