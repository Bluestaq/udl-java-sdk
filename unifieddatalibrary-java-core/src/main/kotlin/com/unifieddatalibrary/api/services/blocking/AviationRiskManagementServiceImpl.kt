...
class AviationRiskManagementServiceImpl
internal constructor(private val clientOptions: ClientOptions) : AviationRiskManagementService {

    private val withRawResponse: AviationRiskManagementService.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        AviationRiskManagementServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AviationRiskManagementServiceImpl.WithRawResponseImpl(
