...
interface CurrentService {
     ...
     * variety of query parameters not specified in this API documentation. A current StateVector is
     * the currently active, latest StateVector for an on-orbit object. Current state vectors are
     * tracked by source and a source should be provided as a query parameter to this service
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/statevector/current`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/statevector/current/tuple`, but is otherwise
         * the same as [CurrentService.tuple].
         */
        @MustBeClosed
