...
class ObjectOfInterestServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : ObjectOfInterestServiceAsync {

    private val withRawResponse: ObjectOfInterestServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        ObjectOfInterestServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<ObjectOfInterestListPageAsync> =
    ...
    override fun get(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<ObjectOfInterestGetResponse> =
    ...
    override fun queryhelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<ObjectOfInterestQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<ObjectOfInterestTupleResponse>> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            ObjectOfInterestServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun list(
            params: ObjectOfInterestListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<ObjectOfInterestListPageAsync>> {
            val request =
                HttpRequest.builder()
        ...
        override fun get(
            params: ObjectOfInterestGetParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<ObjectOfInterestGetResponse>> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("id", params.id().getOrNull())
            val request =
        ...
        override fun queryhelp(
            params: ObjectOfInterestQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<ObjectOfInterestQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(
            params: ObjectOfInterestTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<ObjectOfInterestTupleResponse>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
