...
class CrewServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CrewService {

    private val withRawResponse: CrewService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CrewService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CrewService = CrewServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(params: CrewQueryhelpParams, requestOptions: RequestOptions): CrewQueryhelpResponse =
    ...
    override fun unvalidatedPublish(params: CrewUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CrewService.WithRawResponse = CrewServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: CrewCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: CrewRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CrewFull> {
        ...
        override fun update(params: CrewUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun list(params: CrewListParams, requestOptions: RequestOptions): HttpResponseFor<CrewListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "crew")
        ...
        override fun count(params: CrewCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: CrewQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<CrewQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: CrewTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<CrewFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: CrewUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
