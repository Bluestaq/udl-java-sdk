...
interface CollectRequestServiceAsync {
    ...
    fun retrieve(
        id: String,
        params: CollectRequestRetrieveParams = CollectRequestRetrieveParams.none(),
    ): CompletableFuture<CollectRequestFull> = retrieve(id, params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<CollectRequestCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> =
        createBulk(CollectRequestCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<CollectRequestCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryHelp(): CompletableFuture<CollectRequestQueryHelpResponse> =
    ...
    fun queryHelp(
        params: CollectRequestQueryHelpParams = CollectRequestQueryHelpParams.none()
    ): CompletableFuture<CollectRequestQueryHelpResponse> = queryHelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<CollectRequestUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> =
        unvalidatedPublish(
            CollectRequestUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )
    ...
    /**
     * A view of [CollectRequestServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [CollectRequestServiceAsync.retrieve].
         */
         ...
         * same as [CollectRequestServiceAsync.count].
         */
         ...
         * the same as [CollectRequestServiceAsync.createBulk].
         */
         ...
         * same as [CollectRequestServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<CollectRequestQueryHelpResponse>> =
            queryHelp(CollectRequestQueryHelpParams.none())
         ...
         * same as [CollectRequestServiceAsync.tuple].
         */
        fun tuple(
            params: CollectRequestTupleParams
         ...
         * same as [CollectRequestServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: CollectRequestUnvalidatedPublishParams
