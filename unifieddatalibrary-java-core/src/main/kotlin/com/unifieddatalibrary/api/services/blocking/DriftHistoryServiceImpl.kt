...
class DriftHistoryServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : DriftHistoryService {

    private val withRawResponse: DriftHistoryService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): DriftHistoryService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DriftHistoryService = DriftHistoryServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun retrieve(params: DriftHistoryRetrieveParams, requestOptions: RequestOptions): DriftHistoryFull =
        // get /udl/drifthistory/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: DriftHistoryListParams, requestOptions: RequestOptions): DriftHistoryListPage =
    ...
    override fun queryhelp(params: DriftHistoryQueryhelpParams, requestOptions: RequestOptions): DriftHistoryQueryhelpResponse =
        // get /udl/drifthistory/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: DriftHistoryTupleParams, requestOptions: RequestOptions): List<DriftHistoryFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DriftHistoryService.WithRawResponse = DriftHistoryServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val retrieveHandler: Handler<DriftHistoryFull> = jsonHandler<DriftHistoryFull>(clientOptions.jsonMapper)

        override fun retrieve(params: DriftHistoryRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<DriftHistoryFull> {
        ...
        override fun list(params: DriftHistoryListParams, requestOptions: RequestOptions): HttpResponseFor<DriftHistoryListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun count(params: DriftHistoryCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: DriftHistoryQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<DriftHistoryQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: DriftHistoryTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<DriftHistoryFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
