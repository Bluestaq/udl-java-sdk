...
interface AirfieldService {
    ...
    /**
     * Service operation to take a single Airfield as a POST body and ingest into the database. This
     ...
     */
    fun create(params: AirfieldCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(id: String): AirfieldFull = retrieve(id, AirfieldRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirfieldRetrieveParams = AirfieldRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirfieldFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirfieldRetrieveParams = AirfieldRetrieveParams.none(),
    ): AirfieldFull = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(id: String, requestOptions: RequestOptions): AirfieldFull =
        retrieve(id, AirfieldRetrieveParams.none(), requestOptions)

    /**
     * Service operation to update a single Airfield. A specific role is required to perform this
    ...
    /** @see update */
    fun update(params: AirfieldUpdateParams) = update(params, RequestOptions.none())
    ...
    /** @see list */
    fun list(
        params: AirfieldListParams = AirfieldListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirfieldListPage
    ...
    fun list(requestOptions: RequestOptions): AirfieldListPage =
        list(AirfieldListParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: AirfieldCountParams = AirfieldCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): String
    ...
    fun count(requestOptions: RequestOptions): String =
        count(AirfieldCountParams.none(), requestOptions)
    ...
    /** @see queryhelp */
    fun queryhelp(
        params: AirfieldQueryhelpParams = AirfieldQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: AirfieldQueryhelpParams = AirfieldQueryhelpParams.none()
    ): AirfieldQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): AirfieldQueryhelpResponse =
        queryhelp(AirfieldQueryhelpParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/airfield`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfield/{id}`, but is otherwise the same as
         * [AirfieldService.retrieve].
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<AirfieldFull> =
            retrieve(id, AirfieldRetrieveParams.none())
        ...
        fun retrieve(
            id: String,
            params: AirfieldRetrieveParams = AirfieldRetrieveParams.none(),
        ): HttpResponseFor<AirfieldFull> = retrieve(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `put /udl/airfield/{id}`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfield`, but is otherwise the same as
         * [AirfieldService.list].
         */
        @MustBeClosed
        ...
        fun list(
            params: AirfieldListParams = AirfieldListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<AirfieldListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: AirfieldListParams = AirfieldListParams.none()
        ): HttpResponseFor<AirfieldListPage> = list(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfield/count`, but is otherwise the same as
         * [AirfieldService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(AirfieldCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfield/queryhelp`, but is otherwise the same
         * as [AirfieldService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AirfieldQueryhelpResponse> =
            queryhelp(AirfieldQueryhelpParams.none())
        ...
        fun queryhelp(
            params: AirfieldQueryhelpParams = AirfieldQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<AirfieldQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: AirfieldQueryhelpParams = AirfieldQueryhelpParams.none()
        ): HttpResponseFor<AirfieldQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfield/tuple`, but is otherwise the same as
        ...
        fun tuple(
            params: AirfieldTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<AirfieldFull>>
    }
}
