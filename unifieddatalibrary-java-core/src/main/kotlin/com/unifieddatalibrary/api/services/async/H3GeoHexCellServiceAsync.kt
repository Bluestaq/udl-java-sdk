...
interface H3GeoHexCellServiceAsync {
    ...
    ): CompletableFuture<H3GeoHexCellListPageAsync>
     ...
     */
    fun queryhelp(): CompletableFuture<H3GeoHexCellQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<H3GeoHexCellQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: H3GeoHexCellQueryhelpParams = H3GeoHexCellQueryhelpParams.none()
    ): CompletableFuture<H3GeoHexCellQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<H3GeoHexCellTupleResponse>>

    /**
     * A view of [H3GeoHexCellServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        fun list(
            params: H3GeoHexCellListParams
        ): CompletableFuture<HttpResponseFor<H3GeoHexCellListPageAsync>> =
            list(params, RequestOptions.none())
         ...
         * as [H3GeoHexCellServiceAsync.count].
         */
         ...
         * same as [H3GeoHexCellServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<H3GeoHexCellQueryhelpResponse>> =
            queryhelp(H3GeoHexCellQueryhelpParams.none())
        ...
        fun queryhelp(
            params: H3GeoHexCellQueryhelpParams = H3GeoHexCellQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<H3GeoHexCellQueryhelpResponse>>
         ...
         * as [H3GeoHexCellServiceAsync.tuple].
         */
        fun tuple(
            params: H3GeoHexCellTupleParams
        ): CompletableFuture<HttpResponseFor<List<H3GeoHexCellTupleResponse>>> =
            tuple(params, RequestOptions.none())
