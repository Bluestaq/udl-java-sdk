...
interface LinkStatusService {
     ...
     * assistance.
     */
    fun create(params: LinkStatusCreateParams) = create(params, RequestOptions.none())
     ...
     * parameter.
     */
    fun get(id: String): LinkStatusGetResponse = get(id, LinkStatusGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): LinkStatusGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: LinkStatusGetParams = LinkStatusGetParams.none(),
    ): LinkStatusGetResponse = get(id, params, RequestOptions.none())
    ...
    /** @see get */
    fun get(params: LinkStatusGetParams): LinkStatusGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: LinkStatusQueryhelpParams = LinkStatusQueryhelpParams.none()
    ): LinkStatusQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: LinkStatusListParams = LinkStatusListParams.none()
        ): HttpResponseFor<LinkStatusListPage> = list(params, RequestOptions.none())
         ...
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(LinkStatusCountParams.none())
        ...
        fun get(
            id: String,
            params: LinkStatusGetParams = LinkStatusGetParams.none(),
        ): HttpResponseFor<LinkStatusGetResponse> = get(id, params, RequestOptions.none())
         ...
         * same as [LinkStatusService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<LinkStatusQueryhelpResponse> =
        ...
        fun queryhelp(
            params: LinkStatusQueryhelpParams = LinkStatusQueryhelpParams.none()
        ): HttpResponseFor<LinkStatusQueryhelpResponse> = queryhelp(params, RequestOptions.none())
