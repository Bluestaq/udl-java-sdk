...
class ScServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ScServiceAsync {

    private val withRawResponse: ScServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val folders: FolderServiceAsync by lazy { FolderServiceAsyncImpl(clientOptions) }

    private val classificationMarkings: ClassificationMarkingServiceAsync by lazy { ClassificationMarkingServiceAsyncImpl(clientOptions) }

    private val groups: GroupServiceAsync by lazy { GroupServiceAsyncImpl(clientOptions) }

    private val fileMetadata: FileMetadataServiceAsync by lazy { FileMetadataServiceAsyncImpl(clientOptions) }

    private val rangeParameters: RangeParameterServiceAsync by lazy { RangeParameterServiceAsyncImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ScServiceAsync = ScServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun folders(): FolderServiceAsync = folders

    override fun classificationMarkings(): ClassificationMarkingServiceAsync = classificationMarkings
    ...
    override fun delete(params: ScDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /scs/delete
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun aggregateDocType(params: ScAggregateDocTypeParams, requestOptions: RequestOptions): CompletableFuture<List<String>> =
        // get /scs/aggregateDocType
        withRawResponse().aggregateDocType(params, requestOptions).thenApply { it.parse() }

    override fun allowableFileExtensions(params: ScAllowableFileExtensionsParams, requestOptions: RequestOptions): CompletableFuture<List<String>> =
        // get /scs/allowableFileExtensions
        withRawResponse().allowableFileExtensions(params, requestOptions).thenApply { it.parse() }

    override fun allowableFileMimes(params: ScAllowableFileMimesParams, requestOptions: RequestOptions): CompletableFuture<List<String>> =
        // get /scs/allowableFileMimes
        withRawResponse().allowableFileMimes(params, requestOptions).thenApply { it.parse() }

    override fun copy(params: ScCopyParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // post /scs/copy
        withRawResponse().copy(params, requestOptions).thenApply { it.parse() }

    override fun download(params: ScDownloadParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> =
        // post /scs/download
        withRawResponse().download(params, requestOptions)

    override fun fileDownload(params: ScFileDownloadParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> =
        // get /scs/download
        withRawResponse().fileDownload(params, requestOptions)

    override fun fileUpload(params: ScFileUploadParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // post /scs/file
        withRawResponse().fileUpload(params, requestOptions).thenApply { it.parse() }

    override fun move(params: ScMoveParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // put /scs/move
        withRawResponse().move(params, requestOptions).thenApply { it.parse() }

    override fun rename(params: ScRenameParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // put /scs/rename
        withRawResponse().rename(params, requestOptions).thenAccept {}

    override fun search(params: ScSearchParams, requestOptions: RequestOptions): CompletableFuture<List<FileData>> =
        // post /scs/search
        withRawResponse().search(params, requestOptions).thenApply { it.parse() }

    override fun updateTags(params: ScUpdateTagsParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val folders: FolderServiceAsync.WithRawResponse by lazy { FolderServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val classificationMarkings: ClassificationMarkingServiceAsync.WithRawResponse by lazy { ClassificationMarkingServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val groups: GroupServiceAsync.WithRawResponse by lazy { GroupServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val fileMetadata: FileMetadataServiceAsync.WithRawResponse by lazy { FileMetadataServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val rangeParameters: RangeParameterServiceAsync.WithRawResponse by lazy { RangeParameterServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val paths: PathServiceAsync.WithRawResponse by lazy { PathServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val v2: V2ServiceAsync.WithRawResponse by lazy { V2ServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val file: FileServiceAsync.WithRawResponse by lazy { FileServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ScServiceAsync.WithRawResponse = ScServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun folders(): FolderServiceAsync.WithRawResponse = folders

        override fun classificationMarkings(): ClassificationMarkingServiceAsync.WithRawResponse = classificationMarkings
        ...
        override fun delete(params: ScDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        private val aggregateDocTypeHandler: Handler<List<String>> = jsonHandler<List<String>>(clientOptions.jsonMapper)

        override fun aggregateDocType(params: ScAggregateDocTypeParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<String>>> {
          val request = HttpRequest.builder()
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  aggregateDocTypeHandler.handle(it)
              }
          } }
        }

        private val allowableFileExtensionsHandler: Handler<List<String>> = jsonHandler<List<String>>(clientOptions.jsonMapper)

        override fun allowableFileExtensions(params: ScAllowableFileExtensionsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<String>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  allowableFileExtensionsHandler.handle(it)
              }
          } }
        }

        private val allowableFileMimesHandler: Handler<List<String>> = jsonHandler<List<String>>(clientOptions.jsonMapper)

        override fun allowableFileMimes(params: ScAllowableFileMimesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<String>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  allowableFileMimesHandler.handle(it)
              }
          } }
        }
        ...
        override fun copy(params: ScCopyParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
        ...
        override fun fileUpload(params: ScFileUploadParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
        ...
        override fun move(params: ScMoveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
        ...
        override fun rename(params: ScRenameParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  renameHandler.handle(it)
              }
          } }
        }

        private val searchHandler: Handler<List<FileData>> = jsonHandler<List<FileData>>(clientOptions.jsonMapper)

        override fun search(params: ScSearchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<FileData>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun updateTags(params: ScUpdateTagsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
            .baseUrl(clientOptions.baseUrl())
