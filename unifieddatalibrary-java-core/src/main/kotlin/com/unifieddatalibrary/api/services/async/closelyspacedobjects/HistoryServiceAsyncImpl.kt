...
package com.unifieddatalibrary.api.services.async.closelyspacedobjects
...
import com.unifieddatalibrary.api.models.closelyspacedobjects.history.HistoryListPageAsync
...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(
        ...
        // get /udl/closelyspacedobjects/history
    ...
    override fun aodr(
        ...
        // get /udl/closelyspacedobjects/history/aodr
    ...
    override fun count(
        ...
        // get /udl/closelyspacedobjects/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "closelyspacedobjects", "history")
                    .build()
        ...
        override fun aodr(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "closelyspacedobjects", "history", "aodr")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
