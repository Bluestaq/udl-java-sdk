...
package com.unifieddatalibrary.api.services.blocking.reportandactivity.poi
...
import com.unifieddatalibrary.api.models.reportandactivity.poi.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/poi/history`, but is otherwise the same as
         * [HistoryService.list].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/poi/history/aodr`, but is otherwise the same as
         * [HistoryService.aodr].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/poi/history/count`, but is otherwise the same
