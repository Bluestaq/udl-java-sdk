...
interface IrServiceAsync {
     ...
     * Please contact the UDL team for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, IrDeleteParams.none())
     ...
     */
    fun get(id: String): CompletableFuture<IrGetResponse> = get(id, IrGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<IrGetResponse> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: IrGetParams = IrGetParams.none(),
    ): CompletableFuture<IrGetResponse> = get(id, params, RequestOptions.none())
    ...
    fun queryhelp(
        params: IrQueryhelpParams = IrQueryhelpParams.none()
    ): CompletableFuture<IrQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: IrListParams = IrListParams.none()
        ): CompletableFuture<HttpResponseFor<IrListPageAsync>> = list(params, RequestOptions.none())
         ...
         * [IrServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> = delete(id, IrDeleteParams.none())
         ...
         * [IrServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<IrQueryhelpResponse>> =
            queryhelp(IrQueryhelpParams.none())
