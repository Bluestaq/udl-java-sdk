...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/linkstatus/history`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/linkstatus/history/aodr`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/linkstatus/history/count`, but is otherwise the
