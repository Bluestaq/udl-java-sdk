...
import com.unifieddatalibrary.api.models.linkstatus.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.linkstatus.history.HistoryListParams
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/linkstatus/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/linkstatus/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/linkstatus/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
