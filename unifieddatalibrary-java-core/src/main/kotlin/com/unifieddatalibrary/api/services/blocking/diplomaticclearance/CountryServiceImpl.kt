...
class CountryServiceImpl internal constructor(
    ...
    override fun retrieve(params: CountryRetrieveParams, requestOptions: RequestOptions): CountryRetrieveResponse =
    ...
    override fun tuple(params: CountryTupleParams, requestOptions: RequestOptions): List<CountryTupleResponse> =
        // get /udl/diplomaticclearancecountry/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: CountryUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val retrieveHandler: Handler<CountryRetrieveResponse> = jsonHandler<CountryRetrieveResponse>(clientOptions.jsonMapper)

        override fun retrieve(params: CountryRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CountryRetrieveResponse> {
        ...
        private val listHandler: Handler<List<CountryListResponse>> = jsonHandler<List<CountryListResponse>>(clientOptions.jsonMapper)
        ...
        override fun createBulk(params: CountryCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<CountryTupleResponse>> = jsonHandler<List<CountryTupleResponse>>(clientOptions.jsonMapper)

        override fun tuple(params: CountryTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<CountryTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: CountryUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
