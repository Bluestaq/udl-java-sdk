...
interface AirfieldSlotServiceAsync {
    ...
    fun retrieve(
        id: String,
        params: AirfieldSlotRetrieveParams = AirfieldSlotRetrieveParams.none(),
    ): CompletableFuture<AirfieldslotFull> = retrieve(id, params, RequestOptions.none())
    ...
    fun list(
        params: AirfieldSlotListParams = AirfieldSlotListParams.none()
    ): CompletableFuture<AirfieldSlotListPageAsync> = list(params, RequestOptions.none())
     ...
     * for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, AirfieldSlotDeleteParams.none())
     ...
     */
    fun queryhelp(): CompletableFuture<AirfieldSlotQueryhelpResponse> =
    ...
    fun queryhelp(
        params: AirfieldSlotQueryhelpParams = AirfieldSlotQueryhelpParams.none()
    ): CompletableFuture<AirfieldSlotQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [AirfieldSlotServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [AirfieldSlotServiceAsync.retrieve].
         */
         ...
         * as [AirfieldSlotServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: AirfieldSlotUpdateParams,
         ...
         * [AirfieldSlotServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<AirfieldSlotListPageAsync>> =
            list(AirfieldSlotListParams.none())
         ...
         * same as [AirfieldSlotServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, AirfieldSlotDeleteParams.none())
         ...
         * as [AirfieldSlotServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(AirfieldSlotCountParams.none())
         ...
         * same as [AirfieldSlotServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<AirfieldSlotQueryhelpResponse>> =
            queryhelp(AirfieldSlotQueryhelpParams.none())
         ...
         * as [AirfieldSlotServiceAsync.tuple].
         */
        fun tuple(
            params: AirfieldSlotTupleParams
