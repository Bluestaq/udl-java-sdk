...
import com.unifieddatalibrary.api.models.gnssrawif.history.HistoryListResponse
...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun aodr(
        ...
        // get /udl/gnssrawif/history/aodr
    ...
    override fun count(
        ...
        // get /udl/gnssrawif/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "gnssrawif", "history")
                    .build()
        ...
        override fun aodr(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "gnssrawif", "history", "aodr")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
