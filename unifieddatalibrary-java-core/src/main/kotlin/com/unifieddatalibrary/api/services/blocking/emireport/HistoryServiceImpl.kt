...
package com.unifieddatalibrary.api.services.blocking.emireport
...
import com.unifieddatalibrary.api.models.emireport.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.emireport.history.HistoryCountParams
import com.unifieddatalibrary.api.models.emireport.history.HistoryListPage
import com.unifieddatalibrary.api.models.emireport.history.HistoryListParams
import com.unifieddatalibrary.api.models.emireport.history.HistoryListResponse
...
class HistoryServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun count(params: HistoryCountParams, requestOptions: RequestOptions): String =
        // get /udl/emireport/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "emireport", "history")
                    .build()
        ...
        override fun aodr(params: HistoryAodrParams, requestOptions: RequestOptions): HttpResponse {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "emireport", "history", "aodr")
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            val response = clientOptions.httpClient.execute(request, requestOptions)
        ...
        override fun count(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "emireport", "history", "count")
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            val response = clientOptions.httpClient.execute(request, requestOptions)
