...
package com.unifieddatalibrary.api.services.async.logisticssupport
...
import com.unifieddatalibrary.api.models.logisticssupport.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/logisticssupport/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/logisticssupport/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/logisticssupport/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
