...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/elset/history`, but is otherwise the same as
         * [HistoryService.list].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/elset/history/aodr`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/elset/history/count`, but is otherwise the same
