...
interface MissileTrackServiceAsync {
    ...
    ): CompletableFuture<MissileTrackListPageAsync>
    ...
    /** @see createBulk */
    fun createBulk(body: List<MissileTrackCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryhelp(): CompletableFuture<MissileTrackQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<MissileTrackQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: MissileTrackQueryhelpParams = MissileTrackQueryhelpParams.none()
    ): CompletableFuture<MissileTrackQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<MissileTrackTupleResponse>>
    ...
    /**
     * A view of [MissileTrackServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        fun list(
            params: MissileTrackListParams
        ): CompletableFuture<HttpResponseFor<MissileTrackListPageAsync>> =
            list(params, RequestOptions.none())
         ...
         * as [MissileTrackServiceAsync.count].
         */
         ...
         * same as [MissileTrackServiceAsync.createBulk].
         */
         ...
         * same as [MissileTrackServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<MissileTrackQueryhelpResponse>> =
            queryhelp(MissileTrackQueryhelpParams.none())
        ...
        fun queryhelp(
            params: MissileTrackQueryhelpParams = MissileTrackQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<MissileTrackQueryhelpResponse>>
         ...
         * as [MissileTrackServiceAsync.tuple].
         */
        fun tuple(
            params: MissileTrackTupleParams
        ): CompletableFuture<HttpResponseFor<List<MissileTrackTupleResponse>>> =
            tuple(params, RequestOptions.none())
         ...
         * same as [MissileTrackServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: MissileTrackUnvalidatedPublishParams
