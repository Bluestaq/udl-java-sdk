...
interface EvacServiceAsync {
    ...
    fun retrieve(id: String): CompletableFuture<EvacFull> = retrieve(id, EvacRetrieveParams.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<EvacFull> = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: EvacRetrieveParams = EvacRetrieveParams.none(),
    ): CompletableFuture<EvacFull> = retrieve(id, params, RequestOptions.none())

    /** @see retrieve */
    fun retrieve(
        params: EvacRetrieveParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<EvacFull>
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<EvacListPageAsync>
    ...
    /** @see createBulk */
    fun createBulk(body: List<EvacCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryHelp(): CompletableFuture<EvacQueryHelpResponse> =
    ...
    fun queryHelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<EvacQueryHelpResponse>

    /** @see queryHelp */
    fun queryHelp(
        params: EvacQueryHelpParams = EvacQueryHelpParams.none()
    ): CompletableFuture<EvacQueryHelpResponse> = queryHelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            ...
            params: EvacRetrieveParams = EvacRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<EvacFull>> =
        ...
        fun list(
            params: EvacListParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<EvacListPageAsync>>
        ...
        /** @see createBulk */
        fun createBulk(body: List<EvacCreateBulkParams.Body>): CompletableFuture<HttpResponse> =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/evac/queryhelp`, but is otherwise the same as
         * [EvacServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<EvacQueryHelpResponse>> =
            queryHelp(EvacQueryHelpParams.none())
        ...
        fun queryHelp(
            params: EvacQueryHelpParams = EvacQueryHelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<EvacQueryHelpResponse>>
