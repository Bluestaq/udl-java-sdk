...
interface FeatureAssessmentService {
    ...
    /**
     * Service operation to take a single FeatureAssessment record as a POST body and ingest into
     * the database. A specific role is required to perform this service operation. Please contact
     * the UDL team for assistance.
     */
    fun create(params: FeatureAssessmentCreateParams) = create(params, RequestOptions.none())
    ...
    /**
     * Service operation to get a single FeatureAssessment record by its unique ID passed as a path
     * parameter.
     */
    fun retrieve(id: String): FeatureAssessmentRetrieveResponse =
        retrieve(id, FeatureAssessmentRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: FeatureAssessmentRetrieveParams = FeatureAssessmentRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun retrieve(
        id: String,
        params: FeatureAssessmentRetrieveParams = FeatureAssessmentRetrieveParams.none(),
    ): FeatureAssessmentRetrieveResponse = retrieve(id, params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: FeatureAssessmentCountParams): String = count(params, RequestOptions.none())
    ...
    /**
     * Service operation intended for initial integration only, to take a list of FeatureAssessment
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<FeatureAssessmentCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) = createBulk(FeatureAssessmentCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<FeatureAssessmentCreateBulkParams.Body>) =
     ...
     */
    fun queryHelp(): FeatureAssessmentQueryHelpResponse =
        queryHelp(FeatureAssessmentQueryHelpParams.none())

    /** @see queryHelp */
    fun queryHelp(
        params: FeatureAssessmentQueryHelpParams = FeatureAssessmentQueryHelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryHelp(
        params: FeatureAssessmentQueryHelpParams = FeatureAssessmentQueryHelpParams.none()
    ): FeatureAssessmentQueryHelpResponse = queryHelp(params, RequestOptions.none())

    /** @see queryHelp */
    fun queryHelp(requestOptions: RequestOptions): FeatureAssessmentQueryHelpResponse =
        queryHelp(FeatureAssessmentQueryHelpParams.none(), requestOptions)
    ...
    /**
     * Service operation to take multiple FeatureAssessment records as a POST body and ingest into
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<FeatureAssessmentUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            FeatureAssessmentUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<FeatureAssessmentUnvalidatedPublishParams.Body>) =
        unvalidatedPublish(body, RequestOptions.none())

    /**
     * A view of [FeatureAssessmentService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/featureassessment`, but is otherwise the same
         * as [FeatureAssessmentService.create].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/featureassessment/{id}`, but is otherwise the
         * same as [FeatureAssessmentService.retrieve].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /udl/featureassessment/createBulk`, but is
         * otherwise the same as [FeatureAssessmentService.createBulk].
         */
        @MustBeClosed
        ...
        fun createBulk(
            ...
            createBulk(
                FeatureAssessmentCreateBulkParams.builder().body(body).build(),
                requestOptions,
            )

        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<FeatureAssessmentCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/featureassessment/queryhelp`, but is otherwise
         * the same as [FeatureAssessmentService.queryHelp].
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<FeatureAssessmentQueryHelpResponse> =
            queryHelp(FeatureAssessmentQueryHelpParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/featureassessment/tuple`, but is otherwise the
         * same as [FeatureAssessmentService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: FeatureAssessmentTupleParams
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-featureassessment`, but is otherwise
         * the same as [FeatureAssessmentService.unvalidatedPublish].
         */
        @MustBeClosed
