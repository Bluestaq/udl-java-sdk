...
interface DiffOfArrivalService {
     ...
     * parameter.
     */
    fun retrieve(id: String): DiffofarrivalFull = retrieve(id, DiffOfArrivalRetrieveParams.none())
    ...
    ): DiffofarrivalFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: DiffOfArrivalRetrieveParams = DiffOfArrivalRetrieveParams.none(),
    ): DiffofarrivalFull = retrieve(id, params, RequestOptions.none())
    ...
    fun queryhelp(
        params: DiffOfArrivalQueryhelpParams = DiffOfArrivalQueryhelpParams.none()
    ): DiffOfArrivalQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [DiffOfArrivalService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            id: String,
            params: DiffOfArrivalRetrieveParams = DiffOfArrivalRetrieveParams.none(),
        ): HttpResponseFor<DiffofarrivalFull> = retrieve(id, params, RequestOptions.none())
         ...
         * same as [DiffOfArrivalService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<DiffOfArrivalQueryhelpResponse> =
         ...
         * same as [DiffOfArrivalService.unvalidatedPublish].
         */
        @MustBeClosed
