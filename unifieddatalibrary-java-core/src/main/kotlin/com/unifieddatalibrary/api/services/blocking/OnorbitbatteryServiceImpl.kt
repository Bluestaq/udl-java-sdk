...
class OnorbitbatteryServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    OnorbitbatteryService {

    private val withRawResponse: OnorbitbatteryService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): OnorbitbatteryService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnorbitbatteryService =
        OnorbitbatteryServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnorbitbatteryServiceImpl.WithRawResponseImpl(
