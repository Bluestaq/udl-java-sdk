...
class TdoaFdoaServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : TdoaFdoaService {

    private val withRawResponse: TdoaFdoaService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val diffofarrival: DiffofarrivalService by lazy { DiffofarrivalServiceImpl(clientOptions) }

    override fun withRawResponse(): TdoaFdoaService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TdoaFdoaService = TdoaFdoaServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TdoaFdoaService.WithRawResponse = TdoaFdoaServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
