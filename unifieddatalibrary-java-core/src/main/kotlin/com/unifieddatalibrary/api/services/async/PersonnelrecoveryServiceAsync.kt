...
interface PersonnelrecoveryServiceAsync {
    ...
    ): CompletableFuture<PersonnelrecoveryListPageAsync> = list(params, RequestOptions.none())
    ...
    fun get(
        id: String,
        params: PersonnelrecoveryGetParams = PersonnelrecoveryGetParams.none(),
    ): CompletableFuture<PersonnelRecoveryFullL> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<PersonnelrecoveryQueryhelpResponse> =
    ...
    ): CompletableFuture<List<PersonnelRecoveryFullL>> = tuple(params, RequestOptions.none())
    ...
    /**
     * A view of [PersonnelrecoveryServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [PersonnelrecoveryServiceAsync.create].
         */
         ...
         * as [PersonnelrecoveryServiceAsync.list].
         */
        fun list(
            params: PersonnelrecoveryListParams
         ...
         * same as [PersonnelrecoveryServiceAsync.count].
         */
        fun count(
            params: PersonnelrecoveryCountParams
         ...
         * otherwise the same as [PersonnelrecoveryServiceAsync.createBulk].
         */
         ...
         * same as [PersonnelrecoveryServiceAsync.get].
         */
         ...
         * the same as [PersonnelrecoveryServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<PersonnelrecoveryQueryhelpResponse>> =
            queryhelp(PersonnelrecoveryQueryhelpParams.none())
         ...
         * same as [PersonnelrecoveryServiceAsync.tuple].
         */
        fun tuple(
            params: PersonnelrecoveryTupleParams
