...
interface AirspaceControlOrderService {
     ...
     */
    fun create(params: AirspaceControlOrderCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirspacecontrolorderFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirspaceControlOrderRetrieveParams = AirspaceControlOrderRetrieveParams.none(),
    ): AirspacecontrolorderFull = retrieve(id, params, RequestOptions.none())
    ...
    fun list(
        params: AirspaceControlOrderListParams = AirspaceControlOrderListParams.none()
    ): AirspaceControlOrderListPage = list(params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(body: List<AirspaceControlOrderCreateBulkParams.Body>) =
     ...
     */
    fun queryHelp(): AirspaceControlOrderQueryHelpResponse =
    ...
    fun queryHelp(
        params: AirspaceControlOrderQueryHelpParams = AirspaceControlOrderQueryHelpParams.none()
    ): AirspaceControlOrderQueryHelpResponse = queryHelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [AirspaceControlOrderService.create].
         */
        @MustBeClosed
         ...
         * the same as [AirspaceControlOrderService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            id: String,
            params: AirspaceControlOrderRetrieveParams = AirspaceControlOrderRetrieveParams.none(),
        ): HttpResponseFor<AirspacecontrolorderFull> = retrieve(id, params, RequestOptions.none())
        ...
        fun retrieve(
            params: AirspaceControlOrderRetrieveParams
        ): HttpResponseFor<AirspacecontrolorderFull> = retrieve(params, RequestOptions.none())
         ...
         * same as [AirspaceControlOrderService.list].
         */
        @MustBeClosed
        fun list(): HttpResponseFor<AirspaceControlOrderListPage> =
        ...
        fun list(
            params: AirspaceControlOrderListParams = AirspaceControlOrderListParams.none()
        ): HttpResponseFor<AirspaceControlOrderListPage> = list(params, RequestOptions.none())
         ...
         * the same as [AirspaceControlOrderService.count].
         */
        @MustBeClosed
         ...
         * otherwise the same as [AirspaceControlOrderService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<AirspaceControlOrderCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/airspacecontrolorder/queryhelp`, but is
         * otherwise the same as [AirspaceControlOrderService.queryHelp].
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<AirspaceControlOrderQueryHelpResponse> =
            queryHelp(AirspaceControlOrderQueryHelpParams.none())
         ...
         * the same as [AirspaceControlOrderService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: AirspaceControlOrderTupleParams
        ): HttpResponseFor<List<AirspacecontrolorderFull>> = tuple(params, RequestOptions.none())
