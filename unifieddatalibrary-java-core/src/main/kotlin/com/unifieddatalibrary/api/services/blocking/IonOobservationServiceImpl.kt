...
class IonoObservationServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun queryhelp(
        params: IonoObservationQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val listHandler: Handler<List<IonoObservationListResponse>> =
            jsonHandler<List<IonoObservationListResponse>>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<IonoObservationQueryhelpResponse> =
            jsonHandler<IonoObservationQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<IonoObservationTupleResponse>> =
            jsonHandler<List<IonoObservationTupleResponse>>(clientOptions.jsonMapper)
