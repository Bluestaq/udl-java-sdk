...
interface ConjunctionServiceAsync {
    ...
    ): CompletableFuture<ConjunctionFull> =
    ...
    fun retrieve(
        id: String,
        params: ConjunctionRetrieveParams = ConjunctionRetrieveParams.none(),
    ): CompletableFuture<ConjunctionFull> = retrieve(id, params, RequestOptions.none())
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<ConjunctionListPageAsync>
    ...
    fun getHistory(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<ConjunctionFull>>

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<ConjunctionQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<ConjunctionQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: ConjunctionQueryhelpParams = ConjunctionQueryhelpParams.none()
    ): CompletableFuture<ConjunctionQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    fun uploadConjunctionDataMessage(
        params: ConjunctionUploadConjunctionDataMessageParams
    ): CompletableFuture<Void?> = uploadConjunctionDataMessage(params, RequestOptions.none())
    ...
    /**
     * A view of [ConjunctionServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        fun retrieve(
            ...
            params: ConjunctionRetrieveParams = ConjunctionRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<ConjunctionFull>> =
            retrieve(params.toBuilder().id(id).build(), requestOptions)
        ...
        fun list(
            params: ConjunctionListParams
        ): CompletableFuture<HttpResponseFor<ConjunctionListPageAsync>> =
            list(params, RequestOptions.none())
         ...
         * as [ConjunctionServiceAsync.count].
         */
         ...
         * same as [ConjunctionServiceAsync.createBulk].
         */
        ...
        fun getHistory(
            params: ConjunctionGetHistoryParams
        ): CompletableFuture<HttpResponseFor<List<ConjunctionFull>>> =
            getHistory(params, RequestOptions.none())
         ...
         * same as [ConjunctionServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<ConjunctionQueryhelpResponse>> =
            queryhelp(ConjunctionQueryhelpParams.none())
        ...
        fun queryhelp(
            params: ConjunctionQueryhelpParams = ConjunctionQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<ConjunctionQueryhelpResponse>>
         ...
         * as [ConjunctionServiceAsync.tuple].
         */
        fun tuple(
            params: ConjunctionTupleParams
        ): CompletableFuture<HttpResponseFor<List<ConjunctionFull>>> =
         ...
         * same as [ConjunctionServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: ConjunctionUnvalidatedPublishParams
