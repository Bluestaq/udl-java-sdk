...
internal constructor(private val clientOptions: ClientOptions) : AircraftStatusRemarkService {
    ...
    private val withRawResponse: AircraftStatusRemarkService.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        AircraftStatusRemarkServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AircraftStatusRemarkServiceImpl.WithRawResponseImpl(
