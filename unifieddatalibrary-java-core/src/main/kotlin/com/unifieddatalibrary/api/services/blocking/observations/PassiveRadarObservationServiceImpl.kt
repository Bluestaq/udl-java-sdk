...
class PassiveRadarObservationServiceImpl
internal constructor(private val clientOptions: ClientOptions) : PassiveRadarObservationService {

    private val withRawResponse: PassiveRadarObservationService.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        PassiveRadarObservationServiceImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            PassiveRadarObservationServiceImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
