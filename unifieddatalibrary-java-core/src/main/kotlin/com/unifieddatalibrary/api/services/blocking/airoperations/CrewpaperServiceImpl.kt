...
class CrewpaperServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CrewpaperService {

    private val withRawResponse: CrewpaperService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CrewpaperService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CrewpaperService = CrewpaperServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CrewpaperService.WithRawResponse = CrewpaperServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val unpublishHandler: Handler<Void?> = emptyHandler()

        override fun unpublish(params: CrewpaperUnpublishParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun uploadPdf(params: CrewpaperUploadPdfParams, requestOptions: RequestOptions): HttpResponse {
