...
interface SigactService {
    ...
    fun list(params: SigactListParams): SigactListPage =
        list(
          params, RequestOptions.none()
        )

    /** @see list */
    fun list(params: SigactListParams, requestOptions: RequestOptions = RequestOptions.none()): SigactListPage

    /** Service operation to return the count of records satisfying the specified query parameters. This operation is useful to determine how many records pass a particular query criteria without retrieving large amounts of data. See the queryhelp operation (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query parameter information. */
    fun count(params: SigactCountParams): String =
        count(
          params, RequestOptions.none()
        )

    /** @see count */
    fun count(params: SigactCountParams, requestOptions: RequestOptions = RequestOptions.none()): String
    ...
    fun createBulk(params: SigactCreateBulkParams) =
        createBulk(
          params, RequestOptions.none()
        )

    /** @see createBulk */
    fun createBulk(params: SigactCreateBulkParams, requestOptions: RequestOptions = RequestOptions.none())

    /** Service operation to provide detailed information on available dynamic query parameters for a particular data type. */
    fun queryhelp(): SigactQueryhelpResponse = queryhelp(SigactQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(params: SigactQueryhelpParams = SigactQueryhelpParams.none(), requestOptions: RequestOptions = RequestOptions.none()): SigactQueryhelpResponse

    /** @see queryhelp */
    fun queryhelp(params: SigactQueryhelpParams = SigactQueryhelpParams.none()): SigactQueryhelpResponse =
        queryhelp(
          params, RequestOptions.none()
        )
    ...
    /** @see tuple */
    fun tuple(params: SigactTupleParams, requestOptions: RequestOptions = RequestOptions.none()): List<SigactTupleResponse>
     ...
     */
    fun uploadZip(params: SigactUploadZipParams) =
        uploadZip(
          params, RequestOptions.none()
        )

    /** @see uploadZip */
    fun uploadZip(params: SigactUploadZipParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/sigact`, but is otherwise the same as [SigactService.list]. */
        @MustBeClosed
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: SigactListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SigactListPage>

        /** Returns a raw HTTP response for `get /udl/sigact/count`, but is otherwise the same as [SigactService.count]. */
        @MustBeClosed
        ...
        /** @see count */
        @MustBeClosed
        fun count(params: SigactCountParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<String>

        /** Returns a raw HTTP response for `post /udl/sigact/createBulk`, but is otherwise the same as [SigactService.createBulk]. */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(params: SigactCreateBulkParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `get /udl/sigact/queryhelp`, but is otherwise the same as [SigactService.queryhelp]. */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SigactQueryhelpResponse> = queryhelp(SigactQueryhelpParams.none())

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(params: SigactQueryhelpParams = SigactQueryhelpParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SigactQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(params: SigactQueryhelpParams = SigactQueryhelpParams.none()): HttpResponseFor<SigactQueryhelpResponse> =
            queryhelp(
              params, RequestOptions.none()
            )
        ...
        /** Returns a raw HTTP response for `get /udl/sigact/tuple`, but is otherwise the same as [SigactService.tuple]. */
        @MustBeClosed
        ...
        /** @see tuple */
        @MustBeClosed
        fun tuple(params: SigactTupleParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<List<SigactTupleResponse>>

        /** Returns a raw HTTP response for `post /filedrop/udl-sigact-text`, but is otherwise the same as [SigactService.uploadZip]. */
        @MustBeClosed
        ...
        /** @see uploadZip */
        @MustBeClosed
        fun uploadZip(params: SigactUploadZipParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
