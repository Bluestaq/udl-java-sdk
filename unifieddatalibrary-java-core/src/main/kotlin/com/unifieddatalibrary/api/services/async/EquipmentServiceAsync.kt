...
interface EquipmentServiceAsync {
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<EquipmentFull> =
    ...
    fun retrieve(
        id: String,
        params: EquipmentRetrieveParams = EquipmentRetrieveParams.none(),
    ): CompletableFuture<EquipmentFull> = retrieve(id, params, RequestOptions.none())
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<EquipmentListPageAsync>

    /** @see list */
    fun list(
        params: EquipmentListParams = EquipmentListParams.none()
    ): CompletableFuture<EquipmentListPageAsync> = list(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, EquipmentDeleteParams.none())
    ...
    /** @see createBulk */
    fun createBulk(body: List<EquipmentCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryHelp(): CompletableFuture<EquipmentQueryHelpResponse> =
    ...
    fun queryHelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<EquipmentQueryHelpResponse>

    /** @see queryHelp */
    fun queryHelp(
        params: EquipmentQueryHelpParams = EquipmentQueryHelpParams.none()
    ): CompletableFuture<EquipmentQueryHelpResponse> = queryHelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<EquipmentFull>>
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            ...
            params: EquipmentRetrieveParams = EquipmentRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<EquipmentFull>> =
            retrieve(params.toBuilder().id(id).build(), requestOptions)
         ...
         * [EquipmentServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<EquipmentListPageAsync>> =
            list(EquipmentListParams.none())

        /** @see list */
        fun list(
            params: EquipmentListParams = EquipmentListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<EquipmentListPageAsync>>
         ...
         * as [EquipmentServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, EquipmentDeleteParams.none())
         ...
         * same as [EquipmentServiceAsync.createBulk].
         */
         ...
         * as [EquipmentServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<EquipmentQueryHelpResponse>> =
            queryHelp(EquipmentQueryHelpParams.none())
        ...
        fun queryHelp(
            params: EquipmentQueryHelpParams = EquipmentQueryHelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<EquipmentQueryHelpResponse>>
        ...
        fun tuple(
            params: EquipmentTupleParams
        ): CompletableFuture<HttpResponseFor<List<EquipmentFull>>> =
            tuple(params, RequestOptions.none())
