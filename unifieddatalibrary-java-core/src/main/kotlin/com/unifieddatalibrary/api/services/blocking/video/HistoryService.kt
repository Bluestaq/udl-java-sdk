...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/video/history`, but is otherwise the same as
         * [HistoryService.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/video/history/count`, but is otherwise the same
