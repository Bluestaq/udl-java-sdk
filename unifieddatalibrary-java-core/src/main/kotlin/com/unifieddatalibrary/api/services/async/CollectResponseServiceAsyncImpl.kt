...
class CollectResponseServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : CollectResponseServiceAsync {

    private val withRawResponse: CollectResponseServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        CollectResponseServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<CollectResponseFull> =
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<CollectResponseListPageAsync> =
    ...
    override fun queryHelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<CollectResponseQueryHelpResponse> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val tuple: TupleServiceAsync.WithRawResponse by lazy {
            TupleServiceAsyncImpl.WithRawResponseImpl(clientOptions)
        }

        override fun withOptions(
            modifier: Consumer<ClientOptions.Builder>
        ): CollectResponseServiceAsync.WithRawResponse =
            CollectResponseServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun retrieve(
            params: CollectResponseRetrieveParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CollectResponseFull>> {
        ...
        override fun list(
            params: CollectResponseListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CollectResponseListPageAsync>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(
            params: CollectResponseQueryHelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CollectResponseQueryHelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
