...
interface CountryServiceAsync {
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: CountryRetrieveParams = CountryRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CountryRetrieveResponse> =
        retrieve(
          params.toBuilder()
              .id(id)
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: CountryRetrieveParams = CountryRetrieveParams.none()): CompletableFuture<CountryRetrieveResponse> =
        retrieve(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see retrieve */
    fun retrieve(params: CountryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CountryRetrieveResponse>
    ...
    /** @see retrieve */
    fun retrieve(id: String, requestOptions: RequestOptions): CompletableFuture<CountryRetrieveResponse> =
        retrieve(
          id,
    ...
    /** @see update */
    fun update(pathId: String, params: CountryUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?> =
        update(
          params.toBuilder()
              .pathId(pathId)
              .build(), requestOptions
    ...
    /** @see delete */
    fun delete(id: String, params: CountryDeleteParams = CountryDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?> =
        delete(
          params.toBuilder()
              .id(id)
              .build(), requestOptions
    ...
    /** @see delete */
    fun delete(id: String, params: CountryDeleteParams = CountryDeleteParams.none()): CompletableFuture<Void?> =
        delete(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see createBulk */
    fun createBulk(params: CountryCreateBulkParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see tuple */
    fun tuple(params: CountryTupleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<List<CountryTupleResponse>>
    ...
    fun unvalidatedPublish(params: CountryUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /udl/diplomaticclearancecountry`, but is otherwise the same as [CountryServiceAsync.create]. */
        ...
        /** Returns a raw HTTP response for `get /udl/diplomaticclearancecountry/{id}`, but is otherwise the same as [CountryServiceAsync.retrieve]. */
        ...
        /** @see retrieve */
        fun retrieve(id: String, params: CountryRetrieveParams = CountryRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CountryRetrieveResponse>> =
            retrieve(
              params.toBuilder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** @see retrieve */
        fun retrieve(id: String, params: CountryRetrieveParams = CountryRetrieveParams.none()): CompletableFuture<HttpResponseFor<CountryRetrieveResponse>> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see retrieve */
        fun retrieve(params: CountryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CountryRetrieveResponse>>

        /** @see retrieve */
        fun retrieve(params: CountryRetrieveParams): CompletableFuture<HttpResponseFor<CountryRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(id: String, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CountryRetrieveResponse>> =
            retrieve(
              id,
              CountryRetrieveParams.none(),
              requestOptions,
        ...
        /** Returns a raw HTTP response for `put /udl/diplomaticclearancecountry/{id}`, but is otherwise the same as [CountryServiceAsync.update]. */
        ...
        /** @see update */
        fun update(pathId: String, params: CountryUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse> =
            update(
              params.toBuilder()
                  .pathId(pathId)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `get /udl/diplomaticclearancecountry`, but is otherwise the same as [CountryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `delete /udl/diplomaticclearancecountry/{id}`, but is otherwise the same as [CountryServiceAsync.delete]. */
        ...
        /** @see delete */
        fun delete(id: String, params: CountryDeleteParams = CountryDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse> =
            delete(
              params.toBuilder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** @see delete */
        fun delete(id: String, params: CountryDeleteParams = CountryDeleteParams.none()): CompletableFuture<HttpResponse> =
            delete(
              id,
              params,
              RequestOptions.none(),
        ...
        /** Returns a raw HTTP response for `get /udl/diplomaticclearancecountry/count`, but is otherwise the same as [CountryServiceAsync.count]. */
        ...
        /** Returns a raw HTTP response for `post /udl/diplomaticclearancecountry/createBulk`, but is otherwise the same as [CountryServiceAsync.createBulk]. */
        ...
        /** @see createBulk */
        fun createBulk(params: CountryCreateBulkParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `get /udl/diplomaticclearancecountry/queryhelp`, but is otherwise the same as [CountryServiceAsync.queryHelp]. */
        ...
        /** Returns a raw HTTP response for `get /udl/diplomaticclearancecountry/tuple`, but is otherwise the same as [CountryServiceAsync.tuple]. */
        fun tuple(params: CountryTupleParams): CompletableFuture<HttpResponseFor<List<CountryTupleResponse>>> =
            tuple(
              params, RequestOptions.none()
            )

        /** @see tuple */
        fun tuple(params: CountryTupleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<List<CountryTupleResponse>>>

        /** Returns a raw HTTP response for `post /filedrop/udl-diplomaticclearancecountry`, but is otherwise the same as [CountryServiceAsync.unvalidatedPublish]. */
        fun unvalidatedPublish(params: CountryUnvalidatedPublishParams): CompletableFuture<HttpResponse> =
            unvalidatedPublish(
              params, RequestOptions.none()
            )

        /** @see unvalidatedPublish */
        fun unvalidatedPublish(params: CountryUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
