...
class OrbitdeterminationServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : OrbitdeterminationService {

    private val withRawResponse: OrbitdeterminationService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): OrbitdeterminationService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OrbitdeterminationService = OrbitdeterminationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: OrbitdeterminationListParams, requestOptions: RequestOptions): OrbitdeterminationListPage =
        // get /udl/orbitdetermination
        withRawResponse().list(params, requestOptions).parse()

    override fun count(params: OrbitdeterminationCountParams, requestOptions: RequestOptions): String =
        // get /udl/orbitdetermination/count
        withRawResponse().count(params, requestOptions).parse()

    override fun createBulk(params: OrbitdeterminationCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/orbitdetermination/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun get(params: OrbitdeterminationGetParams, requestOptions: RequestOptions): OrbitdeterminationGetResponse =
        // get /udl/orbitdetermination/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: OrbitdeterminationQueryhelpParams, requestOptions: RequestOptions): OrbitdeterminationQueryhelpResponse =
        // get /udl/orbitdetermination/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: OrbitdeterminationTupleParams, requestOptions: RequestOptions): List<OrbitdeterminationTupleResponse> =
        // get /udl/orbitdetermination/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: OrbitdeterminationUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OrbitdeterminationService.WithRawResponse = OrbitdeterminationServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: OrbitdeterminationCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: OrbitdeterminationListParams, requestOptions: RequestOptions): HttpResponseFor<OrbitdeterminationListPage> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: OrbitdeterminationCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: OrbitdeterminationCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: OrbitdeterminationGetParams, requestOptions: RequestOptions): HttpResponseFor<OrbitdeterminationGetResponse> {
        ...
        override fun queryhelp(params: OrbitdeterminationQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<OrbitdeterminationQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: OrbitdeterminationTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<OrbitdeterminationTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: OrbitdeterminationUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
