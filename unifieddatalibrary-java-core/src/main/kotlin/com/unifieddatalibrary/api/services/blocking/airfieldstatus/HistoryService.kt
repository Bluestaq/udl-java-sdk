...
package com.unifieddatalibrary.api.services.blocking.airfieldstatus
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/airfieldstatus/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/airfieldstatus/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
