...
package com.unifieddatalibrary.api.services.blocking.effectresponses
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/effectresponse/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/effectresponse/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/effectresponse/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
