...
interface OrganizationdetailServiceAsync {
    ...
    ): CompletableFuture<OrganizationdetailListPageAsync> = list(params, RequestOptions.none())
    ...
    fun delete(id: String): CompletableFuture<Void?> =
        delete(id, OrganizationdetailDeleteParams.none())
    ...
    fun get(
        id: String,
        params: OrganizationdetailGetParams = OrganizationdetailGetParams.none(),
    ): CompletableFuture<OrganizationDetailsFull> = get(id, params, RequestOptions.none())
    ...
    /**
     * A view of [OrganizationdetailServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * same as [OrganizationdetailServiceAsync.create].
         */
         ...
         * same as [OrganizationdetailServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: OrganizationdetailUpdateParams,
         ...
         * as [OrganizationdetailServiceAsync.list].
         */
        fun list(
            params: OrganizationdetailListParams
         ...
         * the same as [OrganizationdetailServiceAsync.delete].
         */
         ...
         * otherwise the same as [OrganizationdetailServiceAsync.findBySource].
         */
        fun findBySource(
            params: OrganizationdetailFindBySourceParams
         ...
         * same as [OrganizationdetailServiceAsync.get].
         */
