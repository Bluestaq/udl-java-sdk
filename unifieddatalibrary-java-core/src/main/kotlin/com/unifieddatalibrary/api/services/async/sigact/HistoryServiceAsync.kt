...
package com.unifieddatalibrary.api.services.async.sigact

import com.unifieddatalibrary.api.core.ClientOptions
import com.unifieddatalibrary.api.core.RequestOptions
import com.unifieddatalibrary.api.core.http.HttpResponseFor
import com.unifieddatalibrary.api.models.sigact.history.HistoryCountParams
import com.unifieddatalibrary.api.models.sigact.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/sigact/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/sigact/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
