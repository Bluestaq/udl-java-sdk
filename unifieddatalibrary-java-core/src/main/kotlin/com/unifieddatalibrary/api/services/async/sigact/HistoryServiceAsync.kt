...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sigact/history`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sigact/history/count`, but is otherwise the
