...
interface AodrServiceAsync {
    ...
    fun list(params: AodrListParams): CompletableFuture<Void?> =
        list(
          params, RequestOptions.none()
        )

    /** @see list */
    fun list(params: AodrListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/collectresponse/history/aodr`, but is otherwise the same as [AodrServiceAsync.list]. */
        ...
        /** @see list */
        fun list(params: AodrListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
