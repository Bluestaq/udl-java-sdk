...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/hazard/history/aodr`, but is otherwise the same
         * as [HistoryServiceAsync.aodr].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/hazard/history/count`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/hazard/history`, but is otherwise the same as
