...
package com.unifieddatalibrary.api.services.async.hazard

import com.unifieddatalibrary.api.core.ClientOptions
import com.unifieddatalibrary.api.core.RequestOptions
import com.unifieddatalibrary.api.core.http.HttpResponse
import com.unifieddatalibrary.api.core.http.HttpResponseFor
import com.unifieddatalibrary.api.models.hazard.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.hazard.history.HistoryCountParams
import com.unifieddatalibrary.api.models.hazard.history.HistoryQueryParams
import com.unifieddatalibrary.api.models.hazard.history.HistoryQueryResponse
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/hazard/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/hazard/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
        ...
        /** Returns a raw HTTP response for `get /udl/hazard/history`, but is otherwise the same as [HistoryServiceAsync.query]. */
