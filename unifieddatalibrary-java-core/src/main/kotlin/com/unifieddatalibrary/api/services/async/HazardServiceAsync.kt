...
interface HazardServiceAsync {
    ...
    /**
     * Service operation to take a single hazard as a POST body and ingest into the database. This
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<HazardListPageAsync>
    ...
    /**
     * Service operation intended for initial integration only, to take a list of hazards as a POST
    ...
    /** @see createBulk */
    fun createBulk(body: List<HazardCreateBulkParams.Body>): CompletableFuture<Void?> =
        createBulk(body, RequestOptions.none())

    /** Service operation to get a single Hazard by its unique ID passed as a path parameter. */
    fun get(id: String): CompletableFuture<HazardGetResponse> = get(id, HazardGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: HazardGetParams = HazardGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<HazardGetResponse> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: HazardGetParams = HazardGetParams.none(),
    ): CompletableFuture<HazardGetResponse> = get(id, params, RequestOptions.none())

    /** @see get */
    fun get(
        params: HazardGetParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<HazardGetResponse>
    ...
    fun get(id: String, requestOptions: RequestOptions): CompletableFuture<HazardGetResponse> =
        get(id, HazardGetParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<HazardQueryhelpResponse> =
        queryhelp(HazardQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: HazardQueryhelpParams = HazardQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<HazardQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: HazardQueryhelpParams = HazardQueryhelpParams.none()
    ): CompletableFuture<HazardQueryhelpResponse> = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): CompletableFuture<HazardQueryhelpResponse> =
        queryhelp(HazardQueryhelpParams.none(), requestOptions)
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<HazardTupleResponse>>
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/hazard`, but is otherwise the same as
         * [HazardServiceAsync.create].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/hazard`, but is otherwise the same as
         * [HazardServiceAsync.list].
         */
        fun list(
            params: HazardListParams
        ): CompletableFuture<HttpResponseFor<HazardListPageAsync>> =
            list(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/hazard/count`, but is otherwise the same as
         * [HazardServiceAsync.count].
         */
        ...
        /**
         * Returns a raw HTTP response for `post /udl/hazard/createBulk`, but is otherwise the same
         * as [HazardServiceAsync.createBulk].
         */
        ...
        fun get(
            ...
            params: HazardGetParams = HazardGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<HazardGetResponse>> =
        ...
        /**
         * Returns a raw HTTP response for `get /udl/hazard/queryhelp`, but is otherwise the same as
         * [HazardServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<HazardQueryhelpResponse>> =
            queryhelp(HazardQueryhelpParams.none())
        ...
        fun queryhelp(
            params: HazardQueryhelpParams = HazardQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<HazardQueryhelpResponse>>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/hazard/tuple`, but is otherwise the same as
         * [HazardServiceAsync.tuple].
         */
        fun tuple(
            params: HazardTupleParams
        ): CompletableFuture<HttpResponseFor<List<HazardTupleResponse>>> =
            tuple(params, RequestOptions.none())
