...
interface HazardService {
     ...
     */
    fun create(params: HazardCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun list(params: HazardListParams): HazardListPage = list(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: HazardCountParams): String = count(params, RequestOptions.none())
     ...
     */
    fun createBulk(params: HazardCreateBulkParams) = createBulk(params, RequestOptions.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): HazardGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: HazardGetParams): HazardGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: HazardQueryhelpParams = HazardQueryhelpParams.none()
    ): HazardQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: HazardCreateParams): HttpResponse = create(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<HazardGetResponse> = get(id, HazardGetParams.none())
        ...
        fun get(
            id: String,
            params: HazardGetParams = HazardGetParams.none(),
        ): HttpResponseFor<HazardGetResponse> = get(id, params, RequestOptions.none())
         ...
         * [HazardService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<HazardQueryhelpResponse> =
        ...
        fun queryhelp(
            params: HazardQueryhelpParams = HazardQueryhelpParams.none()
        ): HttpResponseFor<HazardQueryhelpResponse> = queryhelp(params, RequestOptions.none())
