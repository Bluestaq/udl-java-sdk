...
class BeamContourServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    BeamContourServiceAsync {

    private val withRawResponse: BeamContourServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): BeamContourServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BeamContourServiceAsync =
        BeamContourServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            BeamContourServiceAsyncImpl.WithRawResponseImpl(
