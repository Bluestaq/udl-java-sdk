...
class RfBandServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : RfBandService {

    private val withRawResponse: RfBandService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): RfBandService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RfBandService = RfBandServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(params: RfBandQueryhelpParams, requestOptions: RequestOptions): RfBandQueryhelpResponse =
        // get /udl/rfband/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: RfBandTupleParams, requestOptions: RequestOptions): List<RfBandFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RfBandService.WithRawResponse = RfBandServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: RfBandCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: RfBandUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: RfBandListParams, requestOptions: RequestOptions): HttpResponseFor<RfBandListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: RfBandDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: RfBandCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: RfBandGetParams, requestOptions: RequestOptions): HttpResponseFor<RfBandFull> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: RfBandQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<RfBandQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: RfBandTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<RfBandFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
