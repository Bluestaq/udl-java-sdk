...
interface AntennaDetailService {
     ...
     * assistance.
     */
    fun create(params: AntennaDetailCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun retrieve(id: String): AntennaDetailsFull = retrieve(id, AntennaDetailRetrieveParams.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AntennaDetailsFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AntennaDetailRetrieveParams = AntennaDetailRetrieveParams.none(),
    ): AntennaDetailsFull = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: AntennaDetailUpdateParams) = update(params, RequestOptions.none())
    ...
    fun list(
        params: AntennaDetailListParams = AntennaDetailListParams.none()
    ): AntennaDetailListPage = list(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, AntennaDetailDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: AntennaDetailDeleteParams) = delete(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [AntennaDetailService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            ...
            params: AntennaDetailRetrieveParams = AntennaDetailRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<AntennaDetailsFull> =
        ...
        fun retrieve(
            id: String,
            params: AntennaDetailRetrieveParams = AntennaDetailRetrieveParams.none(),
        ): HttpResponseFor<AntennaDetailsFull> = retrieve(id, params, RequestOptions.none())
         ...
         * as [AntennaDetailService.update].
         */
        @MustBeClosed
        ...
        fun list(
            params: AntennaDetailListParams = AntennaDetailListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<AntennaDetailListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: AntennaDetailListParams = AntennaDetailListParams.none()
        ): HttpResponseFor<AntennaDetailListPage> = list(params, RequestOptions.none())
         ...
         * same as [AntennaDetailService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, AntennaDetailDeleteParams.none())
