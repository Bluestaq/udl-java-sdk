...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/isrcollection/history`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/isrcollection/history/aodr`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `get /udl/isrcollection/history/count`, but is otherwise
