...
internal constructor(private val clientOptions: ClientOptions) : SpaceEnvObservationServiceAsync {
    ...
    private val withRawResponse: SpaceEnvObservationServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): SpaceEnvObservationServiceAsync.WithRawResponse =
        withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): SpaceEnvObservationServiceAsync =
        SpaceEnvObservationServiceAsyncImpl(
    ...
    override fun queryhelp(
        params: SpaceEnvObservationQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SpaceEnvObservationServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
        ...
        private val listHandler: Handler<List<SpaceEnvObservationListResponse>> =
            jsonHandler<List<SpaceEnvObservationListResponse>>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<SpaceEnvObservationQueryhelpResponse> =
            jsonHandler<SpaceEnvObservationQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<SpaceEnvObservationFull>> =
            jsonHandler<List<SpaceEnvObservationFull>>(clientOptions.jsonMapper)
