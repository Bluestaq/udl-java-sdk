...
interface FolderServiceAsync {
    ...
    /** @see create */
    fun create(params: FolderCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<String>
    ...
    /** @see retrieve */
    fun retrieve(params: FolderRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<FileData>
    ...
    /** @see update */
    fun update(params: FolderUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): FolderServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /scs/folder`, but is otherwise the same as [FolderServiceAsync.create]. */
        ...
        /** @see create */
        fun create(params: FolderCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<String>>

        /** Returns a raw HTTP response for `get /scs/folder`, but is otherwise the same as [FolderServiceAsync.retrieve]. */
        ...
        /** @see retrieve */
        fun retrieve(params: FolderRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<FileData>>

        /** Returns a raw HTTP response for `patch /scs/folder`, but is otherwise the same as [FolderServiceAsync.update]. */
        ...
        /** @see update */
        fun update(params: FolderUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
