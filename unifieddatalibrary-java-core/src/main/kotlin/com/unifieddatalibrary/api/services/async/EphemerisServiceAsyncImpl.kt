...
class EphemerisServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    EphemerisServiceAsync {

    private val withRawResponse: EphemerisServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val attitudeData: AttitudeDataServiceAsync by lazy {
        AttitudeDataServiceAsyncImpl(clientOptions)
    }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EphemerisServiceAsync =
        EphemerisServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EphemerisServiceAsyncImpl.WithRawResponseImpl(
