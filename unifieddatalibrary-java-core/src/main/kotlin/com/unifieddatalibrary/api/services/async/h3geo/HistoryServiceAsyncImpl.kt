...
class HistoryServiceAsyncImpl internal constructor(
    ...
    override fun ador(params: HistoryAdorParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun ador(params: HistoryAdorParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
