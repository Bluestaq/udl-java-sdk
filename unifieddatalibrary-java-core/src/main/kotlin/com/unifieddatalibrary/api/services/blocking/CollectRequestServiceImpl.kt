...
class CollectRequestServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CollectRequestService {

    private val withRawResponse: CollectRequestService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): CollectRequestService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CollectRequestService = CollectRequestServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: CollectRequestRetrieveParams, requestOptions: RequestOptions): CollectRequestFull =
        // get /udl/collectrequest/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: CollectRequestListParams, requestOptions: RequestOptions): CollectRequestListPage =
    ...
    override fun createBulk(params: CollectRequestCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/collectrequest/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun queryHelp(params: CollectRequestQueryHelpParams, requestOptions: RequestOptions): CollectRequestQueryHelpResponse =
        // get /udl/collectrequest/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: CollectRequestTupleParams, requestOptions: RequestOptions): List<CollectRequestFull> =
        // get /udl/collectrequest/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: CollectRequestUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CollectRequestService.WithRawResponse = CollectRequestServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: CollectRequestCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: CollectRequestRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CollectRequestFull> {
        ...
        override fun list(params: CollectRequestListParams, requestOptions: RequestOptions): HttpResponseFor<CollectRequestListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "collectrequest")
        ...
        override fun count(params: CollectRequestCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: CollectRequestCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: CollectRequestQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<CollectRequestQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: CollectRequestTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<CollectRequestFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: CollectRequestUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
