...
interface SkyImageryService {
     ...
     */
    fun list(params: SkyImageryListParams): SkyImageryListPage = list(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: SkyImageryCountParams): String = count(params, RequestOptions.none())
     ...
     */
    @MustBeClosed
    fun fileGet(id: String): HttpResponse = fileGet(id, SkyImageryFileGetParams.none())
     ...
     * image data.
     */
    fun get(id: String): SkyImageryGetResponse = get(id, SkyImageryGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SkyImageryGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: SkyImageryGetParams = SkyImageryGetParams.none(),
    ): SkyImageryGetResponse = get(id, params, RequestOptions.none())
    ...
    /** @see get */
    fun get(params: SkyImageryGetParams): SkyImageryGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: SkyImageryQueryhelpParams = SkyImageryQueryhelpParams.none()
    ): SkyImageryQueryhelpResponse = queryhelp(params, RequestOptions.none())
     ...
     */
    fun uploadZip(params: SkyImageryUploadZipParams) = uploadZip(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [SkyImageryService.fileGet].
         */
        @MustBeClosed
        fun fileGet(id: String): HttpResponse = fileGet(id, SkyImageryFileGetParams.none())
        ...
        fun get(
            id: String,
            params: SkyImageryGetParams = SkyImageryGetParams.none(),
        ): HttpResponseFor<SkyImageryGetResponse> = get(id, params, RequestOptions.none())
         ...
         * same as [SkyImageryService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SkyImageryQueryhelpResponse> =
        ...
        fun queryhelp(
            params: SkyImageryQueryhelpParams = SkyImageryQueryhelpParams.none()
        ): HttpResponseFor<SkyImageryQueryhelpResponse> = queryhelp(params, RequestOptions.none())
         ...
         * same as [SkyImageryService.uploadZip].
         */
        @MustBeClosed
