...
interface NavigationalObstructionServiceAsync {
     ...
     */
    fun list(): CompletableFuture<NavigationalObstructionListPageAsync> =
    ...
    fun list(
        params: NavigationalObstructionListParams = NavigationalObstructionListParams.none()
    ): CompletableFuture<NavigationalObstructionListPageAsync> = list(params, RequestOptions.none())
    ...
    fun get(
        params: NavigationalObstructionGetParams
    ): CompletableFuture<NavigationalObstructionGetResponse> = get(params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<NavigationalObstructionQueryhelpResponse> =
    ...
    /**
     * A view of [NavigationalObstructionServiceAsync] that provides access to raw HTTP responses
     * for each method.
     */
    interface WithRawResponse {
         ...
         * same as [NavigationalObstructionServiceAsync.create].
         */
         ...
         * the same as [NavigationalObstructionServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: NavigationalObstructionUpdateParams,
         ...
         * same as [NavigationalObstructionServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<NavigationalObstructionListPageAsync>> =
            list(NavigationalObstructionListParams.none())
         ...
         * otherwise the same as [NavigationalObstructionServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(NavigationalObstructionCountParams.none())
         ...
         * otherwise the same as [NavigationalObstructionServiceAsync.createBulk].
         */
        fun createBulk(
            params: NavigationalObstructionCreateBulkParams
         ...
         * the same as [NavigationalObstructionServiceAsync.get].
         */
        fun get(
            id: String
         ...
         * otherwise the same as [NavigationalObstructionServiceAsync.queryhelp].
         */
        fun queryhelp():
         ...
         * otherwise the same as [NavigationalObstructionServiceAsync.tuple].
         */
        fun tuple(
            params: NavigationalObstructionTupleParams
