...
class FileServiceImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: FileRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<FileData> {
        ...
        override fun update(params: FileUpdateParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
