...
interface SwirService {
    ...
    fun unvalidatedPublish(params: SwirUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /filedrop/swir`, but is otherwise the same as [SwirService.unvalidatedPublish]. */
        @MustBeClosed
        ...
        /** @see unvalidatedPublish */
        @MustBeClosed
        fun unvalidatedPublish(params: SwirUnvalidatedPublishParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
