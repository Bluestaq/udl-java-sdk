...
class MonoradarServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : MonoradarServiceAsync {

    private val withRawResponse: MonoradarServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): MonoradarServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): MonoradarServiceAsync = MonoradarServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryServiceAsync = history

    override fun list(params: MonoradarListParams, requestOptions: RequestOptions): CompletableFuture<MonoradarListPageAsync> =
        // get /udl/monoradar
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: MonoradarCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/monoradar/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: MonoradarCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/monoradar/createBulk
        withRawResponse().createBulk(params, requestOptions).thenAccept {}

    override fun queryhelp(params: MonoradarQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<MonoradarQueryhelpResponse> =
        // get /udl/monoradar/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: MonoradarTupleParams, requestOptions: RequestOptions): CompletableFuture<List<MonoradarTupleResponse>> =
        // get /udl/monoradar/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun unvalidatedPublish(params: MonoradarUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): MonoradarServiceAsync.WithRawResponse = MonoradarServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: MonoradarListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<MonoradarListPageAsync>> {
        ...
        override fun count(params: MonoradarCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: MonoradarCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: MonoradarQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<MonoradarQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: MonoradarTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<MonoradarTupleResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: MonoradarUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
