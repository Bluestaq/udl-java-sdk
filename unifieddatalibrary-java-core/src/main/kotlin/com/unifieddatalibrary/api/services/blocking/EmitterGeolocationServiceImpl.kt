...
class EmitterGeolocationServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: EmitterGeolocationService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): EmitterGeolocationService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EmitterGeolocationService =
        EmitterGeolocationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EmitterGeolocationServiceImpl.WithRawResponseImpl(
        ...
        private val retrieveHandler: Handler<EmitterGeolocationRetrieveResponse> =
            jsonHandler<EmitterGeolocationRetrieveResponse>(clientOptions.jsonMapper)
        ...
        private val queryHelpHandler: Handler<EmitterGeolocationQueryHelpResponse> =
            jsonHandler<EmitterGeolocationQueryHelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<EmitterGeolocationTupleResponse>> =
            jsonHandler<List<EmitterGeolocationTupleResponse>>(clientOptions.jsonMapper)
