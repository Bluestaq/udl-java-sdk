...
class ChannelServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val retrieveHandler: Handler<ChannelFull> =
            jsonHandler<ChannelFull>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<List<ChannelAbridged>> =
            jsonHandler<List<ChannelAbridged>>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<ChannelQueryhelpResponse> =
            jsonHandler<ChannelQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<ChannelFull>> =
            jsonHandler<List<ChannelFull>>(clientOptions.jsonMapper)
