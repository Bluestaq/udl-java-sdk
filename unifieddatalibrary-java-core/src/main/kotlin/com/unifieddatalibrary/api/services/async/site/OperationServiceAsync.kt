...
interface OperationServiceAsync {
    ...
    /**
     * Service operation to take a single siteoperations object as a POST body and ingest into the
    ...
    /**
     * Service operation to get a single siteoperations record by its unique ID passed as a path
     * parameter.
     */
    fun retrieve(id: String): CompletableFuture<OperationRetrieveResponse> =
        retrieve(id, OperationRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: OperationRetrieveParams = OperationRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OperationRetrieveResponse> =
    ...
    fun retrieve(
        id: String,
        params: OperationRetrieveParams = OperationRetrieveParams.none(),
    ): CompletableFuture<OperationRetrieveResponse> = retrieve(id, params, RequestOptions.none())

    /** @see retrieve */
    fun retrieve(
        params: OperationRetrieveParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OperationRetrieveResponse>
    ...
    fun retrieve(
        ...
        retrieve(id, OperationRetrieveParams.none(), requestOptions)

    /**
     * Service operation to update a single siteoperations record. A specific role is required to
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OperationListPageAsync>

    /**
     * Service operation to delete a siteoperations record specified by the passed ID path
     * parameter. A specific role is required to perform this service operation. Please contact the
     * UDL team for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, OperationDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: OperationDeleteParams = OperationDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun delete(id: String, requestOptions: RequestOptions): CompletableFuture<Void?> =
        delete(id, OperationDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: OperationCountParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<String>

    /**
     * Service operation intended for initial integration only, to take a list of siteoperations
    ...
    /** @see createBulk */
    fun createBulk(
        params: OperationCreateBulkParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?>

    /** @see createBulk */
    fun createBulk(
        body: List<OperationCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> =
        createBulk(OperationCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<OperationCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryHelp(): CompletableFuture<OperationQueryHelpResponse> =
        queryHelp(OperationQueryHelpParams.none())

    /** @see queryHelp */
    fun queryHelp(
        params: OperationQueryHelpParams = OperationQueryHelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OperationQueryHelpResponse>

    /** @see queryHelp */
    fun queryHelp(
        params: OperationQueryHelpParams = OperationQueryHelpParams.none()
    ): CompletableFuture<OperationQueryHelpResponse> = queryHelp(params, RequestOptions.none())

    /** @see queryHelp */
    fun queryHelp(requestOptions: RequestOptions): CompletableFuture<OperationQueryHelpResponse> =
        queryHelp(OperationQueryHelpParams.none(), requestOptions)
    ...
    /** @see tuple */
    fun tuple(
        params: OperationTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<OperationTupleResponse>>
    ...
    fun unvalidatedPublish(
        params: OperationUnvalidatedPublishParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?>

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<OperationUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> =
        unvalidatedPublish(
            OperationUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/siteoperations`, but is otherwise the same as
         * [OperationServiceAsync.create].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/siteoperations/{id}`, but is otherwise the same
         * as [OperationServiceAsync.retrieve].
         */
        ...
        fun retrieve(
            ...
            params: OperationRetrieveParams = OperationRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OperationRetrieveResponse>> =
            retrieve(params.toBuilder().id(id).build(), requestOptions)
        ...
        /**
         * Returns a raw HTTP response for `put /udl/siteoperations/{id}`, but is otherwise the same
         * as [OperationServiceAsync.update].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/siteoperations`, but is otherwise the same as
         * [OperationServiceAsync.list].
         */
        fun list(
            params: OperationListParams
        ): CompletableFuture<HttpResponseFor<OperationListPageAsync>> =
            list(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/siteoperations/{id}`, but is otherwise the
         * same as [OperationServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, OperationDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/siteoperations/count`, but is otherwise the
         * same as [OperationServiceAsync.count].
         */
        ...
        /**
         * Returns a raw HTTP response for `post /udl/siteoperations/createBulk`, but is otherwise
         * the same as [OperationServiceAsync.createBulk].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/siteoperations/queryhelp`, but is otherwise the
         * same as [OperationServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<OperationQueryHelpResponse>> =
            queryHelp(OperationQueryHelpParams.none())
        ...
        fun queryHelp(
            params: OperationQueryHelpParams = OperationQueryHelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OperationQueryHelpResponse>>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/siteoperations/tuple`, but is otherwise the
         * same as [OperationServiceAsync.tuple].
         */
        fun tuple(
            params: OperationTupleParams
        ): CompletableFuture<HttpResponseFor<List<OperationTupleResponse>>> =
            tuple(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-siteoperations`, but is otherwise the
         * same as [OperationServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: OperationUnvalidatedPublishParams
