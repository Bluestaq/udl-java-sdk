...
interface DiffofarrivalService {
    ...
    fun create(params: DiffofarrivalCreateParams) =
        create(
          params, RequestOptions.none()
        )

    /** @see create */
    fun create(params: DiffofarrivalCreateParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    /** @see list */
    fun list(params: DiffofarrivalListParams, requestOptions: RequestOptions = RequestOptions.none()): DiffofarrivalListPage

    /** Service operation to return the count of records satisfying the specified query parameters. This operation is useful to determine how many records pass a particular query criteria without retrieving large amounts of data. See the queryhelp operation (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query parameter information. */
    fun count(params: DiffofarrivalCountParams): String =
        count(
          params, RequestOptions.none()
        )

    /** @see count */
    fun count(params: DiffofarrivalCountParams, requestOptions: RequestOptions = RequestOptions.none()): String
    ...
    /** @see createBulk */
    fun createBulk(params: DiffofarrivalCreateBulkParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /udl/diffofarrival`, but is otherwise the same as [DiffofarrivalService.create]. */
        @MustBeClosed
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: DiffofarrivalCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `get /udl/diffofarrival`, but is otherwise the same as [DiffofarrivalService.list]. */
        @MustBeClosed
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: DiffofarrivalListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<DiffofarrivalListPage>

        /** Returns a raw HTTP response for `get /udl/diffofarrival/count`, but is otherwise the same as [DiffofarrivalService.count]. */
        @MustBeClosed
        ...
        /** @see count */
        @MustBeClosed
        fun count(params: DiffofarrivalCountParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<String>

        /** Returns a raw HTTP response for `post /udl/diffofarrival/createBulk`, but is otherwise the same as [DiffofarrivalService.createBulk]. */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(params: DiffofarrivalCreateBulkParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
