...
interface AirTransportMissionService {
     ...
     */
    fun create(params: AirTransportMissionCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirTransportMissionFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirTransportMissionRetrieveParams = AirTransportMissionRetrieveParams.none(),
    ): AirTransportMissionFull = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: AirTransportMissionUpdateParams) = update(params, RequestOptions.none())
     ...
     */
    fun queryhelp(): AirTransportMissionQueryhelpResponse =
    ...
    fun queryhelp(
        params: AirTransportMissionQueryhelpParams = AirTransportMissionQueryhelpParams.none()
    ): AirTransportMissionQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [AirTransportMissionService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * same as [AirTransportMissionService.create].
         */
        @MustBeClosed
         ...
         * same as [AirTransportMissionService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            id: String,
            params: AirTransportMissionRetrieveParams = AirTransportMissionRetrieveParams.none(),
        ): HttpResponseFor<AirTransportMissionFull> = retrieve(id, params, RequestOptions.none())
        ...
        fun retrieve(
            params: AirTransportMissionRetrieveParams
        ): HttpResponseFor<AirTransportMissionFull> = retrieve(params, RequestOptions.none())
         ...
         * same as [AirTransportMissionService.update].
         */
        @MustBeClosed
         ...
         * as [AirTransportMissionService.list].
         */
        @MustBeClosed
        fun list(
            params: AirTransportMissionListParams
        ): HttpResponseFor<AirTransportMissionListPage> = list(params, RequestOptions.none())
         ...
         * the same as [AirTransportMissionService.count].
         */
        @MustBeClosed
         ...
         * otherwise the same as [AirTransportMissionService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AirTransportMissionQueryhelpResponse> =
            queryhelp(AirTransportMissionQueryhelpParams.none())
         ...
         * the same as [AirTransportMissionService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: AirTransportMissionTupleParams
        ): HttpResponseFor<List<AirTransportMissionFull>> = tuple(params, RequestOptions.none())
