...
class SolarArrayDetailServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : SolarArrayDetailServiceAsync {

    private val withRawResponse: SolarArrayDetailServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        SolarArrayDetailServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<SolarArrayDetailListPageAsync> =
    ...
    override fun get(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<SolarArrayDetailsFull> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SolarArrayDetailServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun list(
            params: SolarArrayDetailListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<SolarArrayDetailListPageAsync>> {
            val request =
                HttpRequest.builder()
        ...
        override fun get(
            params: SolarArrayDetailGetParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<SolarArrayDetailsFull>> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("id", params.id().getOrNull())
            val request =
