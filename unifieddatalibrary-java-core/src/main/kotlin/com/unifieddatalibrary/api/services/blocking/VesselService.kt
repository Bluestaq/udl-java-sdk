...
interface VesselService {
     ...
     * for assistance.
     */
    fun create(params: VesselCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: VesselUpdateParams) = update(params, RequestOptions.none())
     ...
     * mechanism.
     */
    fun createBulk(params: VesselCreateBulkParams) = createBulk(params, RequestOptions.none())
     ...
     */
    fun get(id: String): VesselGetResponse = get(id, VesselGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): VesselGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: VesselGetParams): VesselGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: VesselQueryhelpParams = VesselQueryhelpParams.none()
    ): VesselQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: VesselCreateParams): HttpResponse = create(params, RequestOptions.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: VesselUpdateParams): HttpResponse = update(params, RequestOptions.none())
         ...
         * [VesselService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<VesselListPage> = list(VesselListParams.none())
        ...
        fun list(
            params: VesselListParams = VesselListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<VesselListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: VesselListParams = VesselListParams.none()
        ): HttpResponseFor<VesselListPage> = list(params, RequestOptions.none())
         ...
         * [VesselService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(VesselCountParams.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<VesselGetResponse> = get(id, VesselGetParams.none())
        ...
        fun get(
            ...
            params: VesselGetParams = VesselGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<VesselGetResponse> =
        ...
        fun get(
            id: String,
            params: VesselGetParams = VesselGetParams.none(),
        ): HttpResponseFor<VesselGetResponse> = get(id, params, RequestOptions.none())
         ...
         * [VesselService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<VesselQueryhelpResponse> =
        ...
        fun queryhelp(
            params: VesselQueryhelpParams = VesselQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<VesselQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: VesselQueryhelpParams = VesselQueryhelpParams.none()
        ): HttpResponseFor<VesselQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: VesselTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<VesselTupleResponse>>
    }
}
