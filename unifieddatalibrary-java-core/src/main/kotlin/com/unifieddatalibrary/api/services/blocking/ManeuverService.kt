...
interface ManeuverService {
     ...
     */
    fun create(params: ManeuverCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun list(params: ManeuverListParams): ManeuverListPage = list(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: ManeuverCountParams): String = count(params, RequestOptions.none())
     ...
     * mechanism.
     */
    fun createBulk(params: ManeuverCreateBulkParams) = createBulk(params, RequestOptions.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): ManeuverGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: ManeuverGetParams): ManeuverGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: ManeuverQueryhelpParams = ManeuverQueryhelpParams.none()
    ): ManeuverQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [ManeuverService.createBulk].
         */
        @MustBeClosed
        ...
        fun get(
            id: String,
            params: ManeuverGetParams = ManeuverGetParams.none(),
        ): HttpResponseFor<ManeuverGetResponse> = get(id, params, RequestOptions.none())
         ...
         * as [ManeuverService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<ManeuverQueryhelpResponse> =
        ...
        fun queryhelp(
            params: ManeuverQueryhelpParams = ManeuverQueryhelpParams.none()
        ): HttpResponseFor<ManeuverQueryhelpResponse> = queryhelp(params, RequestOptions.none())
         ...
         * as [ManeuverService.unvalidatedPublish].
         */
        @MustBeClosed
