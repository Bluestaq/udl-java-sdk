...
import com.unifieddatalibrary.api.models.isrcollections.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/isrcollection/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/isrcollection/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/isrcollection/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
