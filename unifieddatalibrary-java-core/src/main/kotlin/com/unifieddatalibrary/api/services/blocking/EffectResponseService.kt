...
interface EffectResponseService {
     ...
     */
    fun create(params: EffectResponseCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): EffectResponseRetrieveResponse = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: EffectResponseRetrieveParams = EffectResponseRetrieveParams.none(),
    ): EffectResponseRetrieveResponse = retrieve(id, params, RequestOptions.none())
     ...
     */
    fun count(params: EffectResponseCountParams): String = count(params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(body: List<EffectResponseCreateBulkParams.Body>) =
     ...
     */
    fun queryHelp(): EffectResponseQueryHelpResponse =
    ...
    fun queryHelp(
        params: EffectResponseQueryHelpParams = EffectResponseQueryHelpParams.none()
    ): EffectResponseQueryHelpResponse = queryHelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<EffectResponseUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
         ...
         * as [EffectResponseService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            params: EffectResponseRetrieveParams
        ): HttpResponseFor<EffectResponseRetrieveResponse> = retrieve(params, RequestOptions.none())
         ...
         * same as [EffectResponseService.count].
         */
        @MustBeClosed
         ...
         * the same as [EffectResponseService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<EffectResponseCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/effectresponse/queryhelp`, but is otherwise the
         * same as [EffectResponseService.queryHelp].
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<EffectResponseQueryHelpResponse> =
            queryHelp(EffectResponseQueryHelpParams.none())
         ...
         * same as [EffectResponseService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: EffectResponseTupleParams
        ): HttpResponseFor<List<EffectResponseTupleResponse>> = tuple(params, RequestOptions.none())
         ...
         * same as [EffectResponseService.unvalidatedPublish].
         */
        @MustBeClosed
