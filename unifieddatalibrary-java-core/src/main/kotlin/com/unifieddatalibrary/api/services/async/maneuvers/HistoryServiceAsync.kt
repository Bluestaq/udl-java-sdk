...
package com.unifieddatalibrary.api.services.async.maneuvers

import com.unifieddatalibrary.api.core.ClientOptions
import com.unifieddatalibrary.api.core.RequestOptions
import com.unifieddatalibrary.api.core.http.HttpResponse
import com.unifieddatalibrary.api.core.http.HttpResponseFor
import com.unifieddatalibrary.api.models.maneuvers.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.maneuvers.history.HistoryCountParams
import com.unifieddatalibrary.api.models.maneuvers.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/maneuver/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/maneuver/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/maneuver/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
