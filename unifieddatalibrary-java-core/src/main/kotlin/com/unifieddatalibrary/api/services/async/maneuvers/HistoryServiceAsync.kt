...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/maneuver/history`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/maneuver/history/aodr`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/maneuver/history/count`, but is otherwise the
