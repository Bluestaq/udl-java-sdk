...
package com.unifieddatalibrary.api.services.blocking.maneuvers
...
import com.unifieddatalibrary.api.models.maneuvers.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/maneuver/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/maneuver/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/maneuver/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
