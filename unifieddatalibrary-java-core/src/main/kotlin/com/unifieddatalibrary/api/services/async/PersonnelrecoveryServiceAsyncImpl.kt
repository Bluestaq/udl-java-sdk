...
class PersonnelrecoveryServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PersonnelrecoveryServiceAsync {

    private val withRawResponse: PersonnelrecoveryServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): PersonnelrecoveryServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PersonnelrecoveryServiceAsync = PersonnelrecoveryServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryServiceAsync = history

    override fun create(params: PersonnelrecoveryCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/personnelrecovery
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun list(params: PersonnelrecoveryListParams, requestOptions: RequestOptions): CompletableFuture<PersonnelrecoveryListPageAsync> =
        // get /udl/personnelrecovery
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: PersonnelrecoveryCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/personnelrecovery/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: PersonnelrecoveryCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/personnelrecovery/createBulk
        withRawResponse().createBulk(params, requestOptions).thenAccept {}

    override fun fileCreate(params: PersonnelrecoveryFileCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /filedrop/udl-personnelrecovery
        withRawResponse().fileCreate(params, requestOptions).thenAccept {}

    override fun get(params: PersonnelrecoveryGetParams, requestOptions: RequestOptions): CompletableFuture<PersonnelRecoveryFullL> =
        // get /udl/personnelrecovery/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: PersonnelrecoveryQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<PersonnelrecoveryQueryhelpResponse> =
        // get /udl/personnelrecovery/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: PersonnelrecoveryTupleParams, requestOptions: RequestOptions): CompletableFuture<List<PersonnelRecoveryFullL>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PersonnelrecoveryServiceAsync.WithRawResponse = PersonnelrecoveryServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryServiceAsync.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: PersonnelrecoveryCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: PersonnelrecoveryListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PersonnelrecoveryListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: PersonnelrecoveryCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: PersonnelrecoveryCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun fileCreate(params: PersonnelrecoveryFileCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: PersonnelrecoveryGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PersonnelRecoveryFullL>> {
        ...
        override fun queryhelp(params: PersonnelrecoveryQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PersonnelrecoveryQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: PersonnelrecoveryTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<PersonnelRecoveryFullL>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
