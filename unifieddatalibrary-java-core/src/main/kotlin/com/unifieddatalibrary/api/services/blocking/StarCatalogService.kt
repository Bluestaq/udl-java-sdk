...
interface StarCatalogService {
     ...
     */
    fun create(params: StarCatalogCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: StarCatalogUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, StarCatalogDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: StarCatalogDeleteParams) = delete(params, RequestOptions.none())
     ...
     * mechanism.
     */
    fun createBulk(params: StarCatalogCreateBulkParams) = createBulk(params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(body: List<StarCatalogCreateBulkParams.Body>) =
     ...
     * parameter.
     */
    fun get(id: String): StarCatalogGetResponse = get(id, StarCatalogGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): StarCatalogGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: StarCatalogGetParams = StarCatalogGetParams.none(),
    ): StarCatalogGetResponse = get(id, params, RequestOptions.none())
    ...
    fun queryhelp(
        params: StarCatalogQueryhelpParams = StarCatalogQueryhelpParams.none()
    ): StarCatalogQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<StarCatalogUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: StarCatalogListParams = StarCatalogListParams.none()
        ): HttpResponseFor<StarCatalogListPage> = list(params, RequestOptions.none())
         ...
         * as [StarCatalogService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, StarCatalogDeleteParams.none())
         ...
         * as [StarCatalogService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(StarCatalogCountParams.none())
         ...
         * same as [StarCatalogService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<StarCatalogCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())
        ...
        fun get(
            id: String,
            params: StarCatalogGetParams = StarCatalogGetParams.none(),
        ): HttpResponseFor<StarCatalogGetResponse> = get(id, params, RequestOptions.none())
         ...
         * same as [StarCatalogService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<StarCatalogQueryhelpResponse> =
        ...
        fun queryhelp(
            params: StarCatalogQueryhelpParams = StarCatalogQueryhelpParams.none()
        ): HttpResponseFor<StarCatalogQueryhelpResponse> = queryhelp(params, RequestOptions.none())
         ...
         * same as [StarCatalogService.unvalidatedPublish].
         */
        @MustBeClosed
        ...
        /** @see unvalidatedPublish */
        @MustBeClosed
        fun unvalidatedPublish(body: List<StarCatalogUnvalidatedPublishParams.Body>): HttpResponse =
            unvalidatedPublish(body, RequestOptions.none())
    }
}
