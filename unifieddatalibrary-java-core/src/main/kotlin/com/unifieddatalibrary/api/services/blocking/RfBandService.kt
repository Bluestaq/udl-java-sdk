...
interface RfBandService {
    ...
    /** @see update */
    fun update(params: RfBandUpdateParams) = update(params, RequestOptions.none())
    ...
    /** @see delete */
    fun delete(params: RfBandDeleteParams) = delete(params, RequestOptions.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): RfBandFull = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: RfBandGetParams): RfBandFull = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: RfBandQueryhelpParams = RfBandQueryhelpParams.none()
    ): RfBandQueryhelpResponse = queryhelp(params, RequestOptions.none())
     ...
     */
    fun tuple(params: RfBandTupleParams): List<RfBandFull> = tuple(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: RfBandCreateParams): HttpResponse = create(params, RequestOptions.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: RfBandUpdateParams): HttpResponse = update(params, RequestOptions.none())
         ...
         * [RfBandService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<RfBandListPage> = list(RfBandListParams.none())
        ...
        fun list(
            params: RfBandListParams = RfBandListParams.none()
        ): HttpResponseFor<RfBandListPage> = list(params, RequestOptions.none())
         ...
         * [RfBandService.delete].
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, RfBandDeleteParams.none())
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: RfBandDeleteParams): HttpResponse = delete(params, RequestOptions.none())
         ...
         * [RfBandService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(RfBandCountParams.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<RfBandFull> = get(id, RfBandGetParams.none())
        ...
        fun get(
            ...
            params: RfBandGetParams = RfBandGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<RfBandFull> = get(params.toBuilder().id(id).build(), requestOptions)
        ...
        fun get(
            id: String,
            params: RfBandGetParams = RfBandGetParams.none(),
        ): HttpResponseFor<RfBandFull> = get(id, params, RequestOptions.none())
         ...
         * [RfBandService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<RfBandQueryhelpResponse> =
        ...
        fun queryhelp(
            params: RfBandQueryhelpParams = RfBandQueryhelpParams.none()
        ): HttpResponseFor<RfBandQueryhelpResponse> = queryhelp(params, RequestOptions.none())
