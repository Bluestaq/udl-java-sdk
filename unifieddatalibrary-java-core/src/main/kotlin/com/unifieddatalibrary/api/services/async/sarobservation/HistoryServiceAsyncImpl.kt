...
class HistoryServiceAsyncImpl internal constructor(
    ...
    override fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions): CompletableFuture<List<HistoryRetrieveResponse>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<HistoryRetrieveResponse>>> {
