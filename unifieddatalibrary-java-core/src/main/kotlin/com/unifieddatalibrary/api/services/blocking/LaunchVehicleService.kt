...
interface LaunchVehicleService {
     ...
     * for assistance.
     */
    fun create(params: LaunchVehicleCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: LaunchVehicleUpdateParams) = update(params, RequestOptions.none())
    ...
    fun list(
        params: LaunchVehicleListParams = LaunchVehicleListParams.none()
    ): LaunchVehicleListPage = list(params, RequestOptions.none())
     ...
     * for assistance.
     */
    fun delete(id: String) = delete(id, LaunchVehicleDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: LaunchVehicleDeleteParams) = delete(params, RequestOptions.none())
     ...
     * parameter.
     */
    fun get(id: String): LaunchVehicleGetResponse = get(id, LaunchVehicleGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): LaunchVehicleGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: LaunchVehicleGetParams = LaunchVehicleGetParams.none(),
    ): LaunchVehicleGetResponse = get(id, params, RequestOptions.none())
    ...
    fun queryhelp(
        params: LaunchVehicleQueryhelpParams = LaunchVehicleQueryhelpParams.none()
    ): LaunchVehicleQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): List<LaunchVehicleTupleResponse>
    ...
    interface WithRawResponse {
         ...
         * as [LaunchVehicleService.update].
         */
        @MustBeClosed
        ...
        fun list(
            params: LaunchVehicleListParams = LaunchVehicleListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<LaunchVehicleListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: LaunchVehicleListParams = LaunchVehicleListParams.none()
        ): HttpResponseFor<LaunchVehicleListPage> = list(params, RequestOptions.none())
         ...
         * same as [LaunchVehicleService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, LaunchVehicleDeleteParams.none())
         ...
         * as [LaunchVehicleService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(LaunchVehicleCountParams.none())
        ...
        fun get(
            ...
            params: LaunchVehicleGetParams = LaunchVehicleGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<LaunchVehicleGetResponse> =
        ...
        fun get(
            id: String,
            params: LaunchVehicleGetParams = LaunchVehicleGetParams.none(),
        ): HttpResponseFor<LaunchVehicleGetResponse> = get(id, params, RequestOptions.none())
         ...
         * same as [LaunchVehicleService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<LaunchVehicleQueryhelpResponse> =
        ...
        fun queryhelp(
            params: LaunchVehicleQueryhelpParams = LaunchVehicleQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<LaunchVehicleQueryhelpResponse>
         ...
         * as [LaunchVehicleService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: LaunchVehicleTupleParams
        ): HttpResponseFor<List<LaunchVehicleTupleResponse>> = tuple(params, RequestOptions.none())
        ...
        fun tuple(
            params: LaunchVehicleTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<LaunchVehicleTupleResponse>>
    }
}
