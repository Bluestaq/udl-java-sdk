...
internal constructor(private val clientOptions: ClientOptions) : OnorbitsolararrayServiceAsync {
    ...
    private val withRawResponse: OnorbitsolararrayServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        OnorbitsolararrayServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnorbitsolararrayServiceAsyncImpl.WithRawResponseImpl(
