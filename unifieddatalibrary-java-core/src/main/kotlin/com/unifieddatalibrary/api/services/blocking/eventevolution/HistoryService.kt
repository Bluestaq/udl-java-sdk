...
package com.unifieddatalibrary.api.services.blocking.eventevolution
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/eventevolution/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/eventevolution/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/eventevolution/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
