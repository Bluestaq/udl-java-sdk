...
class H3GeoHexCellServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : H3GeoHexCellService {

    private val withRawResponse: H3GeoHexCellService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): H3GeoHexCellService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): H3GeoHexCellService = H3GeoHexCellServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun list(params: H3GeoHexCellListParams, requestOptions: RequestOptions): H3GeoHexCellListPage =
    ...
    override fun queryhelp(params: H3GeoHexCellQueryhelpParams, requestOptions: RequestOptions): H3GeoHexCellQueryhelpResponse =
        // get /udl/h3geohexcell/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: H3GeoHexCellTupleParams, requestOptions: RequestOptions): List<H3GeoHexCellTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): H3GeoHexCellService.WithRawResponse = H3GeoHexCellServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: H3GeoHexCellListParams, requestOptions: RequestOptions): HttpResponseFor<H3GeoHexCellListPage> {
        ...
        override fun count(params: H3GeoHexCellCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: H3GeoHexCellQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<H3GeoHexCellQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: H3GeoHexCellTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<H3GeoHexCellTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
