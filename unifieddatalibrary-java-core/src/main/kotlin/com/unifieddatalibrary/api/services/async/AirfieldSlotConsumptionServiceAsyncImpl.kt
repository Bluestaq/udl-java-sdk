...
class AirfieldSlotConsumptionServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) :
    AirfieldSlotConsumptionServiceAsync {

    private val withRawResponse: AirfieldSlotConsumptionServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): AirfieldSlotConsumptionServiceAsync.WithRawResponse =
        withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): AirfieldSlotConsumptionServiceAsync =
        AirfieldSlotConsumptionServiceAsyncImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AirfieldSlotConsumptionServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
