...
class AttitudeSetServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AttitudeSetService {

    private val withRawResponse: AttitudeSetService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): AttitudeSetService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AttitudeSetService = AttitudeSetServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: AttitudeSetRetrieveParams, requestOptions: RequestOptions): AttitudesetFull =
        // get /udl/attitudeset/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: AttitudeSetListParams, requestOptions: RequestOptions): AttitudeSetListPage =
        // get /udl/attitudeset
    ...
    override fun queryHelp(params: AttitudeSetQueryHelpParams, requestOptions: RequestOptions): AttitudeSetQueryHelpResponse =
        // get /udl/attitudeset/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: AttitudeSetTupleParams, requestOptions: RequestOptions): List<AttitudesetFull> =
        // get /udl/attitudeset/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: AttitudeSetUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AttitudeSetService.WithRawResponse = AttitudeSetServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: AttitudeSetCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: AttitudeSetRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AttitudesetFull> {
        ...
        override fun list(params: AttitudeSetListParams, requestOptions: RequestOptions): HttpResponseFor<AttitudeSetListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "attitudeset")
        ...
        override fun count(params: AttitudeSetCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: AttitudeSetQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<AttitudeSetQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: AttitudeSetTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<AttitudesetFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: AttitudeSetUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
