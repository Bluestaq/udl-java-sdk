...
class AircraftStatusRemarkServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : AircraftStatusRemarkServiceAsync {

    private val withRawResponse: AircraftStatusRemarkServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): AircraftStatusRemarkServiceAsync.WithRawResponse =
        withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): AircraftStatusRemarkServiceAsync =
        AircraftStatusRemarkServiceAsyncImpl(
    ...
    override fun list(
        params: AircraftStatusRemarkListParams,
        requestOptions: RequestOptions,
    ...
    override fun count(
        params: AircraftStatusRemarkCountParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AircraftStatusRemarkServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
        ...
        private val retrieveHandler: Handler<AircraftstatusremarkFull> =
            jsonHandler<AircraftstatusremarkFull>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<List<AircraftstatusremarkAbridged>> =
            jsonHandler<List<AircraftstatusremarkAbridged>>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<AircraftStatusRemarkQueryhelpResponse> =
            jsonHandler<AircraftStatusRemarkQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<AircraftstatusremarkFull>> =
            jsonHandler<List<AircraftstatusremarkFull>>(clientOptions.jsonMapper)
