...
class EvacServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : EvacService {

    private val withRawResponse: EvacService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EvacService = EvacServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryHelp(params: EvacQueryHelpParams, requestOptions: RequestOptions): EvacQueryHelpResponse =
        // get /udl/evac/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun unvalidatedPublish(params: EvacUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EvacService.WithRawResponse = EvacServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: EvacCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: EvacRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<EvacFull> {
        ...
        override fun list(params: EvacListParams, requestOptions: RequestOptions): HttpResponseFor<EvacListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "evac")
        ...
        override fun count(params: EvacCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: EvacCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: EvacQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<EvacQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: EvacUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
