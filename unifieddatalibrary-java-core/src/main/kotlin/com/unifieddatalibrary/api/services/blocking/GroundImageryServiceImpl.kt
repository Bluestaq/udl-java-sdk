...
class GroundImageryServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : GroundImageryService {

    private val withRawResponse: GroundImageryService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): GroundImageryService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GroundImageryService = GroundImageryServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: GroundImageryListParams, requestOptions: RequestOptions): GroundImageryListPage =
    ...
    override fun get(params: GroundImageryGetParams, requestOptions: RequestOptions): GroundImageryGetResponse =
        // get /udl/groundimagery/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun getFile(params: GroundImageryGetFileParams, requestOptions: RequestOptions): HttpResponse =
        // get /udl/groundimagery/getFile/{id}
        withRawResponse().getFile(params, requestOptions)

    override fun historyAodr(params: GroundImageryHistoryAodrParams, requestOptions: RequestOptions) {
      // get /udl/groundimagery/history/aodr
      withRawResponse().historyAodr(params, requestOptions)
    }

    override fun queryhelp(params: GroundImageryQueryhelpParams, requestOptions: RequestOptions): GroundImageryQueryhelpResponse =
        // get /udl/groundimagery/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: GroundImageryTupleParams, requestOptions: RequestOptions): List<GroundImageryTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GroundImageryService.WithRawResponse = GroundImageryServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: GroundImageryCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: GroundImageryListParams, requestOptions: RequestOptions): HttpResponseFor<GroundImageryListPage> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: GroundImageryCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: GroundImageryGetParams, requestOptions: RequestOptions): HttpResponseFor<GroundImageryGetResponse> {
        ...
        override fun historyAodr(params: GroundImageryHistoryAodrParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: GroundImageryQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<GroundImageryQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: GroundImageryTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<GroundImageryTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun uploadZip(params: GroundImageryUploadZipParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
