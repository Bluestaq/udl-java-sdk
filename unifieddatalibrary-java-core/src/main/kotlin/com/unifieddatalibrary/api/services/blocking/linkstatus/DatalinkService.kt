...
interface DatalinkService {
     ...
     */
    fun create(params: DatalinkCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun list(params: DatalinkListParams): DatalinkListPage = list(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: DatalinkCountParams): String = count(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: DatalinkQueryhelpParams = DatalinkQueryhelpParams.none()
    ): DatalinkQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [DatalinkService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<DatalinkQueryhelpResponse> =
        ...
        fun queryhelp(
            params: DatalinkQueryhelpParams = DatalinkQueryhelpParams.none()
        ): HttpResponseFor<DatalinkQueryhelpResponse> = queryhelp(params, RequestOptions.none())
         ...
         * as [DatalinkService.unvalidatedPublish].
         */
        @MustBeClosed
