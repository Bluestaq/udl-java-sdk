...
interface SwirServiceAsync {
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SwirListPageAsync>
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<SwirCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?> =
        createBulk(SwirCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<SwirCreateBulkParams.Body>): CompletableFuture<Void?> =
        createBulk(body, RequestOptions.none())

    /**
     * Service operation to get a single SWIR record by its unique ID passed as a path parameter.
     */
    fun get(id: String): CompletableFuture<SwirFull> = get(id, SwirGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SwirFull> = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SwirFull>

    /** @see get */
    fun get(params: SwirGetParams): CompletableFuture<SwirFull> = get(params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<SwirQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SwirQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: SwirQueryhelpParams = SwirQueryhelpParams.none()
    ): CompletableFuture<SwirQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<SwirFull>>
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: SwirListParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SwirListPageAsync>>
        ...
        /** @see createBulk */
        fun createBulk(body: List<SwirCreateBulkParams.Body>): CompletableFuture<HttpResponse> =
            createBulk(body, RequestOptions.none())
        ...
        fun get(
            ...
            params: SwirGetParams = SwirGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SwirFull>> =
        ...
        fun get(
            id: String,
            params: SwirGetParams = SwirGetParams.none(),
        ): CompletableFuture<HttpResponseFor<SwirFull>> = get(id, params, RequestOptions.none())
         ...
         * [SwirServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SwirQueryhelpResponse>> =
            queryhelp(SwirQueryhelpParams.none())
        ...
        fun queryhelp(
            params: SwirQueryhelpParams = SwirQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SwirQueryhelpResponse>>
        ...
        fun tuple(
            params: SwirTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<List<SwirFull>>>
    }
}
