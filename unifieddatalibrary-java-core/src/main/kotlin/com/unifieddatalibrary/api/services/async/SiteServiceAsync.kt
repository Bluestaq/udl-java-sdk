...
interface SiteServiceAsync {
     ...
     */
    fun get(id: String): CompletableFuture<SiteGetResponse> = get(id, SiteGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SiteGetResponse> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: SiteGetParams = SiteGetParams.none(),
    ): CompletableFuture<SiteGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<SiteQueryhelpResponse> =
    ...
    fun queryhelp(
        params: SiteQueryhelpParams = SiteQueryhelpParams.none()
    ): CompletableFuture<SiteQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [SiteServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<SiteListPageAsync>> =
            list(SiteListParams.none())
         ...
         * [SiteServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SiteQueryhelpResponse>> =
            queryhelp(SiteQueryhelpParams.none())
