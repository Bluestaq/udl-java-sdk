...
internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: GlobalAtmosphericModelServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): GlobalAtmosphericModelServiceAsync.WithRawResponse =
        withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): GlobalAtmosphericModelServiceAsync =
        GlobalAtmosphericModelServiceAsyncImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            GlobalAtmosphericModelServiceAsyncImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response
                            ...
                            .let {
                                GlobalAtmosphericModelListPageAsync.builder()
                                    .service(GlobalAtmosphericModelServiceAsyncImpl(clientOptions))
