...
class TrackDetailServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: TrackDetailServiceAsync.WithRawResponse by lazy {
    ...
    ): CompletableFuture<TrackDetailListPageAsync> =
    ...
    override fun queryhelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<TrackDetailQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<TrackDetailsFull>> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TrackDetailServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun list(
            params: TrackDetailListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<TrackDetailListPageAsync>> {
            val request =
                HttpRequest.builder()
        ...
        override fun queryhelp(
            params: TrackDetailQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<TrackDetailQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(
            params: TrackDetailTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<TrackDetailsFull>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
