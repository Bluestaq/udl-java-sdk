...
class ElsetServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ElsetService {

    private val withRawResponse: ElsetService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ElsetService = ElsetServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun createBulkFromTle(params: ElsetCreateBulkFromTleParams, requestOptions: RequestOptions) {
      // post /udl/elset/createBulkFromTLE
      withRawResponse().createBulkFromTle(params, requestOptions)
    }

    override fun queryCurrentElsetHelp(params: ElsetQueryCurrentElsetHelpParams, requestOptions: RequestOptions): ElsetQueryCurrentElsetHelpResponse =
        // get /udl/currentelset/queryhelp
        withRawResponse().queryCurrentElsetHelp(params, requestOptions).parse()

    override fun queryhelp(params: ElsetQueryhelpParams, requestOptions: RequestOptions): ElsetQueryhelpResponse =
    ...
    override fun unvalidatedPublish(params: ElsetUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ElsetService.WithRawResponse = ElsetServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: ElsetCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: ElsetRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Elset> {
        ...
        override fun list(params: ElsetListParams, requestOptions: RequestOptions): HttpResponseFor<ElsetListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "elset")
        ...
        override fun count(params: ElsetCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: ElsetCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulkFromTle(params: ElsetCreateBulkFromTleParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryCurrentElsetHelp(params: ElsetQueryCurrentElsetHelpParams, requestOptions: RequestOptions): HttpResponseFor<ElsetQueryCurrentElsetHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: ElsetQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<ElsetQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: ElsetTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<Elset>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: ElsetUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
