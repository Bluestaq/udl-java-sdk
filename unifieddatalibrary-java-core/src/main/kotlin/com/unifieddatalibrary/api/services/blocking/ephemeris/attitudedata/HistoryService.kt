...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/attitudedata/history`, but is otherwise the
         * same as [HistoryService.retrieve].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/attitudedata/history/aodr`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `get /udl/attitudedata/history/count`, but is otherwise
