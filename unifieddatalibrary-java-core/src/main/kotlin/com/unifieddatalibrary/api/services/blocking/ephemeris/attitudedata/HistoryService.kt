...
interface HistoryService {
    ...
    fun retrieve(params: HistoryRetrieveParams): List<AttitudedataFull> =
        retrieve(
          params, RequestOptions.none()
        )

    /** @see retrieve */
    fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): List<AttitudedataFull>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/attitudedata/history`, but is otherwise the same as [HistoryService.retrieve]. */
        @MustBeClosed
        fun retrieve(params: HistoryRetrieveParams): HttpResponseFor<List<AttitudedataFull>> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<List<AttitudedataFull>>

        /** Returns a raw HTTP response for `get /udl/attitudedata/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/attitudedata/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
