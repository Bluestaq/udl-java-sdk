...
interface BeamContourServiceAsync {
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<BeamcontourFull> =
    ...
    fun retrieve(
        id: String,
        params: BeamContourRetrieveParams = BeamContourRetrieveParams.none(),
    ): CompletableFuture<BeamcontourFull> = retrieve(id, params, RequestOptions.none())
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<BeamContourListPageAsync>
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, BeamContourDeleteParams.none())
     ...
     */
    fun queryHelp(): CompletableFuture<BeamContourQueryHelpResponse> =
    ...
    fun queryHelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<BeamContourQueryHelpResponse>

    /** @see queryHelp */
    fun queryHelp(
        params: BeamContourQueryHelpParams = BeamContourQueryHelpParams.none()
    ): CompletableFuture<BeamContourQueryHelpResponse> = queryHelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<BeamcontourFull>>

    /**
     * A view of [BeamContourServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        fun retrieve(
            ...
            params: BeamContourRetrieveParams = BeamContourRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<BeamcontourFull>> =
            retrieve(params.toBuilder().id(id).build(), requestOptions)
         ...
         * [BeamContourServiceAsync.list].
         */
        fun list(
            params: BeamContourListParams
        ): CompletableFuture<HttpResponseFor<BeamContourListPageAsync>> =
            list(params, RequestOptions.none())
         ...
         * as [BeamContourServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, BeamContourDeleteParams.none())
         ...
         * as [BeamContourServiceAsync.count].
         */
         ...
         * same as [BeamContourServiceAsync.createBulk].
         */
         ...
         * same as [BeamContourServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<BeamContourQueryHelpResponse>> =
            queryHelp(BeamContourQueryHelpParams.none())
        ...
        fun queryHelp(
            params: BeamContourQueryHelpParams = BeamContourQueryHelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<BeamContourQueryHelpResponse>>
         ...
         * as [BeamContourServiceAsync.tuple].
         */
        fun tuple(
            params: BeamContourTupleParams
        ): CompletableFuture<HttpResponseFor<List<BeamcontourFull>>> =
            tuple(params, RequestOptions.none())
