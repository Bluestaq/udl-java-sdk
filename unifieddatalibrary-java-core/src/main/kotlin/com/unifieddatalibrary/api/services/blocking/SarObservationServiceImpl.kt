...
class SarObservationServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SarObservationService {

    private val withRawResponse: SarObservationService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): SarObservationService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SarObservationService = SarObservationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: SarObservationListParams, requestOptions: RequestOptions): SarObservationListPage =
    ...
    override fun createBulk(params: SarObservationCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/sarobservation/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun get(params: SarObservationGetParams, requestOptions: RequestOptions): SarObservationGetResponse =
        // get /udl/sarobservation/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: SarObservationQueryhelpParams, requestOptions: RequestOptions): SarObservationQueryhelpResponse =
        // get /udl/sarobservation/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: SarObservationTupleParams, requestOptions: RequestOptions): List<SarObservationTupleResponse> =
        // get /udl/sarobservation/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: SarObservationUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SarObservationService.WithRawResponse = SarObservationServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: SarObservationCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: SarObservationListParams, requestOptions: RequestOptions): HttpResponseFor<SarObservationListPage> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: SarObservationCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: SarObservationCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: SarObservationGetParams, requestOptions: RequestOptions): HttpResponseFor<SarObservationGetResponse> {
        ...
        override fun queryhelp(params: SarObservationQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<SarObservationQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: SarObservationTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<SarObservationTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: SarObservationUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
