...
class AirTaskingOrderServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AirTaskingOrderService {

    private val withRawResponse: AirTaskingOrderService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): AirTaskingOrderService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AirTaskingOrderService = AirTaskingOrderServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: AirTaskingOrderRetrieveParams, requestOptions: RequestOptions): AirTaskingOrderFull =
        // get /udl/airtaskingorder/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: AirTaskingOrderListParams, requestOptions: RequestOptions): AirTaskingOrderListPage =
    ...
    override fun queryHelp(params: AirTaskingOrderQueryHelpParams, requestOptions: RequestOptions): AirTaskingOrderQueryHelpResponse =
        // get /udl/airtaskingorder/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: AirTaskingOrderTupleParams, requestOptions: RequestOptions): List<AirTaskingOrderFull> =
        // get /udl/airtaskingorder/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: AirTaskingOrderUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AirTaskingOrderService.WithRawResponse = AirTaskingOrderServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: AirTaskingOrderCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: AirTaskingOrderRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AirTaskingOrderFull> {
        ...
        override fun list(params: AirTaskingOrderListParams, requestOptions: RequestOptions): HttpResponseFor<AirTaskingOrderListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "airtaskingorder")
        ...
        override fun count(params: AirTaskingOrderCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: AirTaskingOrderQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<AirTaskingOrderQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: AirTaskingOrderTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<AirTaskingOrderFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: AirTaskingOrderUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
