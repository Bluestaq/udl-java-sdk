...
class WeatherDataServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : WeatherDataServiceAsync {

    private val withRawResponse: WeatherDataServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): WeatherDataServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WeatherDataServiceAsync = WeatherDataServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryServiceAsync = history

    override fun create(params: WeatherDataCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/weatherdata
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun list(params: WeatherDataListParams, requestOptions: RequestOptions): CompletableFuture<WeatherDataListPageAsync> =
        // get /udl/weatherdata
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: WeatherDataCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/weatherdata/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: WeatherDataCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/weatherdata/createBulk
        withRawResponse().createBulk(params, requestOptions).thenAccept {}

    override fun get(params: WeatherDataGetParams, requestOptions: RequestOptions): CompletableFuture<WeatherDataFull> =
        // get /udl/weatherdata/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: WeatherDataQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<WeatherDataQueryhelpResponse> =
        // get /udl/weatherdata/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: WeatherDataTupleParams, requestOptions: RequestOptions): CompletableFuture<List<WeatherDataFull>> =
        // get /udl/weatherdata/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun unvalidatedPublish(params: WeatherDataUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WeatherDataServiceAsync.WithRawResponse = WeatherDataServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryServiceAsync.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: WeatherDataCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: WeatherDataListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WeatherDataListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: WeatherDataCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: WeatherDataCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: WeatherDataGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WeatherDataFull>> {
        ...
        override fun queryhelp(params: WeatherDataQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WeatherDataQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: WeatherDataTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<WeatherDataFull>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: WeatherDataUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
