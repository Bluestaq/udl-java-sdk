...
class AirspaceControlOrderServiceImpl internal constructor(
    ...
    override fun retrieve(params: AirspaceControlOrderRetrieveParams, requestOptions: RequestOptions): AirspacecontrolorderFull =
        // get /udl/airspacecontrolorder/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: AirspaceControlOrderListParams, requestOptions: RequestOptions): AirspaceControlOrderListPage =
        // get /udl/airspacecontrolorder
        withRawResponse().list(params, requestOptions).parse()

    override fun count(params: AirspaceControlOrderCountParams, requestOptions: RequestOptions): String =
        // get /udl/airspacecontrolorder/count
        withRawResponse().count(params, requestOptions).parse()

    override fun createBulk(params: AirspaceControlOrderCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/airspacecontrolorder/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun queryHelp(params: AirspaceControlOrderQueryHelpParams, requestOptions: RequestOptions): AirspaceControlOrderQueryHelpResponse =
        // get /udl/airspacecontrolorder/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: AirspaceControlOrderTupleParams, requestOptions: RequestOptions): List<AirspacecontrolorderFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: AirspaceControlOrderCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: AirspaceControlOrderRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AirspacecontrolorderFull> {
        ...
        override fun list(params: AirspaceControlOrderListParams, requestOptions: RequestOptions): HttpResponseFor<AirspaceControlOrderListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "airspacecontrolorder")
        ...
        override fun count(params: AirspaceControlOrderCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: AirspaceControlOrderCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: AirspaceControlOrderQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<AirspaceControlOrderQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: AirspaceControlOrderTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<AirspacecontrolorderFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
