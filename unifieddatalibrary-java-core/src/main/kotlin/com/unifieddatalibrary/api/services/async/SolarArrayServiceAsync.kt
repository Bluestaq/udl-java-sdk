...
interface SolarArrayServiceAsync {
    ...
    /** @see list */
    fun list(
        params: SolarArrayListParams = SolarArrayListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SolarArrayListPageAsync>

    /** @see list */
    fun list(
        params: SolarArrayListParams = SolarArrayListParams.none()
    ): CompletableFuture<SolarArrayListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<SolarArrayListPageAsync> =
        list(SolarArrayListParams.none(), requestOptions)

    /**
     * Service operation to delete a SolarArray object specified by the passed ID path parameter. A
     * specific role is required to perform this service operation. Please contact the UDL team for
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, SolarArrayDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: SolarArrayDeleteParams = SolarArrayDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun delete(id: String, requestOptions: RequestOptions): CompletableFuture<Void?> =
        delete(id, SolarArrayDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: SolarArrayCountParams = SolarArrayCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun count(requestOptions: RequestOptions): CompletableFuture<String> =
        count(SolarArrayCountParams.none(), requestOptions)

    /**
     * Service operation to get a single SolarArray record by its unique ID passed as a path
     * parameter.
     */
    fun get(id: String): CompletableFuture<SolarArrayFull> = get(id, SolarArrayGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: SolarArrayGetParams = SolarArrayGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SolarArrayFull> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: SolarArrayGetParams = SolarArrayGetParams.none(),
    ): CompletableFuture<SolarArrayFull> = get(id, params, RequestOptions.none())

    /** @see get */
    fun get(
        params: SolarArrayGetParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SolarArrayFull>
    ...
    fun get(id: String, requestOptions: RequestOptions): CompletableFuture<SolarArrayFull> =
        get(id, SolarArrayGetParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<SolarArrayQueryhelpResponse> =
        queryhelp(SolarArrayQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: SolarArrayQueryhelpParams = SolarArrayQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SolarArrayQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: SolarArrayQueryhelpParams = SolarArrayQueryhelpParams.none()
    ): CompletableFuture<SolarArrayQueryhelpResponse> = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): CompletableFuture<SolarArrayQueryhelpResponse> =
        queryhelp(SolarArrayQueryhelpParams.none(), requestOptions)
    ...
    /** @see tuple */
    fun tuple(
        params: SolarArrayTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<SolarArrayFull>>

    /**
     * A view of [SolarArrayServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        ): SolarArrayServiceAsync.WithRawResponse

        /**
         * Returns a raw HTTP response for `post /udl/solararray`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/solararray`, but is otherwise the same as
         * [SolarArrayServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<SolarArrayListPageAsync>> =
            list(SolarArrayListParams.none())

        /** @see list */
        fun list(
            params: SolarArrayListParams = SolarArrayListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SolarArrayListPageAsync>>
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/solararray/{id}`, but is otherwise the same
         * as [SolarArrayServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, SolarArrayDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/solararray/count`, but is otherwise the same as
         * [SolarArrayServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(SolarArrayCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/solararray/{id}`, but is otherwise the same as
         * [SolarArrayServiceAsync.get].
         */
        fun get(id: String): CompletableFuture<HttpResponseFor<SolarArrayFull>> =
            get(id, SolarArrayGetParams.none())
        ...
        fun get(
            ...
            params: SolarArrayGetParams = SolarArrayGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SolarArrayFull>> =
        ...
        /**
         * Returns a raw HTTP response for `get /udl/solararray/queryhelp`, but is otherwise the
         * same as [SolarArrayServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SolarArrayQueryhelpResponse>> =
            queryhelp(SolarArrayQueryhelpParams.none())
        ...
        fun queryhelp(
            params: SolarArrayQueryhelpParams = SolarArrayQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SolarArrayQueryhelpResponse>>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/solararray/tuple`, but is otherwise the same as
         * [SolarArrayServiceAsync.tuple].
         */
        fun tuple(
            params: SolarArrayTupleParams
        ): CompletableFuture<HttpResponseFor<List<SolarArrayFull>>> =
            tuple(params, RequestOptions.none())
