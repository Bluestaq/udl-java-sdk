...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/monoradar/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/monoradar/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
        ...
        /** Returns a raw HTTP response for `get /udl/monoradar/history`, but is otherwise the same as [HistoryServiceAsync.query]. */
