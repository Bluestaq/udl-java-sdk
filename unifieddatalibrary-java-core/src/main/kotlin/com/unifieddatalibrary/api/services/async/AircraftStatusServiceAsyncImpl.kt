...
class AircraftStatusServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : AircraftStatusServiceAsync {

    private val withRawResponse: AircraftStatusServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        AircraftStatusServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<AircraftstatusFull> =
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<AircraftStatusListPageAsync> =
    ...
    override fun queryhelp(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<AircraftStatusQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<AircraftstatusFull>> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AircraftStatusServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun retrieve(
            params: AircraftStatusRetrieveParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<AircraftstatusFull>> {
        ...
        override fun list(
            params: AircraftStatusListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<AircraftStatusListPageAsync>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(
            params: AircraftStatusQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<AircraftStatusQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(
            params: AircraftStatusTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<AircraftstatusFull>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
