...
package com.unifieddatalibrary.api.services.blocking.missionassignment
...
class HistoryServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun aodr(params: HistoryAodrParams, requestOptions: RequestOptions) {
        // get /udl/missionassignment/history/aodr
    ...
    override fun count(params: HistoryCountParams, requestOptions: RequestOptions): String =
        // get /udl/missionassignment/history/count
    ...
    override fun query(
        ...
        // get /udl/missionassignment/history
        ...
        override fun aodr(params: HistoryAodrParams, requestOptions: RequestOptions): HttpResponse {
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "missionassignment", "history", "aodr")
                    .build()
        ...
        override fun query(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "missionassignment", "history")
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            val response = clientOptions.httpClient.execute(request, requestOptions)
