...
class SolarArrayServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: SolarArrayService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): SolarArrayService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SolarArrayService =
        SolarArrayServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(
        params: SolarArrayQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SolarArrayServiceImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<SolarArrayListResponse>> =
            jsonHandler<List<SolarArrayListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: SolarArrayListParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<SolarArrayListPage> {
            val request =
                HttpRequest.builder()
        ...
        private val getHandler: Handler<SolarArrayFull> =
            jsonHandler<SolarArrayFull>(clientOptions.jsonMapper)

        override fun get(
            params: SolarArrayGetParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<SolarArrayFull> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("id", params.id().getOrNull())
            val request =
        ...
        private val queryhelpHandler: Handler<SolarArrayQueryhelpResponse> =
            jsonHandler<SolarArrayQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(
            params: SolarArrayQueryhelpParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<SolarArrayQueryhelpResponse> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<SolarArrayFull>> =
            jsonHandler<List<SolarArrayFull>>(clientOptions.jsonMapper)

        override fun tuple(
            params: SolarArrayTupleParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<List<SolarArrayFull>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
