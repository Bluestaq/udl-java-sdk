...
interface MtiServiceAsync {
    ...
    ): CompletableFuture<MtiListPageAsync>
    ...
    /** @see createBulk */
    fun createBulk(body: List<MtiCreateBulkParams.Body>): CompletableFuture<Void?> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<MtiQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: MtiQueryhelpParams = MtiQueryhelpParams.none()
    ): CompletableFuture<MtiQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<MtiFull>>
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<MtiUnvalidatedPublishParams.Body>): CompletableFuture<Void?> =
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: MtiListParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<MtiListPageAsync>>
        ...
        /** @see createBulk */
        fun createBulk(body: List<MtiCreateBulkParams.Body>): CompletableFuture<HttpResponse> =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/mti/queryhelp`, but is otherwise the same as
         * [MtiServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<MtiQueryhelpResponse>> =
        ...
        fun queryhelp(
            params: MtiQueryhelpParams = MtiQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<MtiQueryhelpResponse>>
        ...
        fun tuple(
            params: MtiTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<List<MtiFull>>>
