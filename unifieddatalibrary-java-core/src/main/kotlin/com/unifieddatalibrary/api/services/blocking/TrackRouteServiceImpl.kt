...
class TrackRouteServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    TrackRouteService {

    private val withRawResponse: TrackRouteService.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TrackRouteService =
        TrackRouteServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TrackRouteServiceImpl.WithRawResponseImpl(
