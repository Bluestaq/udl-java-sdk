...
interface RouteStatServiceAsync {
    ...
    fun retrieve(
        id: String,
        params: RouteStatRetrieveParams = RouteStatRetrieveParams.none(),
    ): CompletableFuture<RouteStatRetrieveResponse> = retrieve(id, params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, RouteStatDeleteParams.none())
    ...
    /** @see createBulk */
    fun createBulk(body: List<RouteStatCreateBulkParams.Body>): CompletableFuture<Void?> =
     ...
     */
    fun queryHelp(): CompletableFuture<RouteStatQueryHelpResponse> =
    ...
    fun queryHelp(
        params: RouteStatQueryHelpParams = RouteStatQueryHelpParams.none()
    ): CompletableFuture<RouteStatQueryHelpResponse> = queryHelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, RouteStatDeleteParams.none())
         ...
         * same as [RouteStatServiceAsync.createBulk].
         */
         ...
         * same as [RouteStatServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<RouteStatQueryHelpResponse>> =
            queryHelp(RouteStatQueryHelpParams.none())
         ...
         * same as [RouteStatServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: RouteStatUnvalidatedPublishParams
