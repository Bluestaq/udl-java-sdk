...
class MonoradarServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    MonoradarService {

    private val withRawResponse: MonoradarService.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): MonoradarService =
        MonoradarServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            MonoradarServiceImpl.WithRawResponseImpl(
