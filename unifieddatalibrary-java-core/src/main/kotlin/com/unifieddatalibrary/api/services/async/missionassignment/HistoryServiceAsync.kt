...
package com.unifieddatalibrary.api.services.async.missionassignment

import com.unifieddatalibrary.api.core.ClientOptions
import com.unifieddatalibrary.api.core.RequestOptions
import com.unifieddatalibrary.api.core.http.HttpResponse
import com.unifieddatalibrary.api.core.http.HttpResponseFor
import com.unifieddatalibrary.api.models.missionassignment.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.missionassignment.history.HistoryCountParams
import com.unifieddatalibrary.api.models.missionassignment.history.HistoryQueryParams
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/missionassignment/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/missionassignment/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
        ...
        /** Returns a raw HTTP response for `get /udl/missionassignment/history`, but is otherwise the same as [HistoryServiceAsync.query]. */
