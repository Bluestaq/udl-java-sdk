...
interface SeradataSigintPayloadServiceAsync {
     ...
     */
    fun list(): CompletableFuture<SeradataSigintPayloadListPageAsync> =
    ...
    fun list(
        params: SeradataSigintPayloadListParams = SeradataSigintPayloadListParams.none()
    ): CompletableFuture<SeradataSigintPayloadListPageAsync> = list(params, RequestOptions.none())
    ...
    fun delete(id: String): CompletableFuture<Void?> =
        delete(id, SeradataSigintPayloadDeleteParams.none())
    ...
    fun get(
        id: String,
        params: SeradataSigintPayloadGetParams = SeradataSigintPayloadGetParams.none(),
    ): CompletableFuture<SeradataSigintPayloadGetResponse> = get(id, params, RequestOptions.none())
    ...
    fun get(
        params: SeradataSigintPayloadGetParams
    ): CompletableFuture<SeradataSigintPayloadGetResponse> = get(params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<SeradataSigintPayloadQueryhelpResponse> =
    ...
    /**
     * A view of [SeradataSigintPayloadServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * same as [SeradataSigintPayloadServiceAsync.create].
         */
         ...
         * the same as [SeradataSigintPayloadServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: SeradataSigintPayloadUpdateParams,
         ...
         * same as [SeradataSigintPayloadServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<SeradataSigintPayloadListPageAsync>> =
            list(SeradataSigintPayloadListParams.none())
         ...
         * otherwise the same as [SeradataSigintPayloadServiceAsync.delete].
         */
         ...
         * the same as [SeradataSigintPayloadServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(SeradataSigintPayloadCountParams.none())
         ...
         * the same as [SeradataSigintPayloadServiceAsync.get].
         */
         ...
         * otherwise the same as [SeradataSigintPayloadServiceAsync.queryhelp].
         */
        fun queryhelp():
         ...
         * the same as [SeradataSigintPayloadServiceAsync.tuple].
         */
        fun tuple(
            params: SeradataSigintPayloadTupleParams
