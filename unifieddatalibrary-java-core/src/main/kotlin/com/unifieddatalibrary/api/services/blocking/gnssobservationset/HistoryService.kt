...
package com.unifieddatalibrary.api.services.blocking.gnssobservationset
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/gnssobservationset/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/gnssobservationset/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
