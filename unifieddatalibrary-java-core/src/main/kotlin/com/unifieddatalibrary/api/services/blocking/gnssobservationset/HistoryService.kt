...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/gnssobservationset/history`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `get /udl/gnssobservationset/history/aodr`, but is
