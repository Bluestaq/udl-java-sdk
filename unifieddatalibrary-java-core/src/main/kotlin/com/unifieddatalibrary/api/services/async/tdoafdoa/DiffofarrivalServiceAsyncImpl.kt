...
class DiffofarrivalServiceAsyncImpl internal constructor(
    ...
    override fun create(params: DiffofarrivalCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/diffofarrival
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun list(params: DiffofarrivalListParams, requestOptions: RequestOptions): CompletableFuture<DiffofarrivalListPageAsync> =
        // get /udl/diffofarrival
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: DiffofarrivalCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/diffofarrival/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: DiffofarrivalCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: DiffofarrivalCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: DiffofarrivalListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<DiffofarrivalListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: DiffofarrivalCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: DiffofarrivalCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
