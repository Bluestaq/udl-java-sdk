...
package com.unifieddatalibrary.api.services.blocking.track
...
import com.unifieddatalibrary.api.models.track.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/track/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/track/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/track/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
