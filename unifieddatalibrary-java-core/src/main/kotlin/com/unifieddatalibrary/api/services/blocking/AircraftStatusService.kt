...
interface AircraftStatusService {
    ...
    /**
     * Service operation to take a single AircraftStatus as a POST body and ingest into the
     * database. A specific role is required to perform this service operation. Please contact the
     * UDL team for assistance.
     */
    fun create(params: AircraftStatusCreateParams) = create(params, RequestOptions.none())
    ...
    /**
     * Service operation to get a single AircraftStatus record by its unique ID passed as a path
     * parameter.
     */
    fun retrieve(id: String): AircraftstatusFull = retrieve(id, AircraftStatusRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AircraftStatusRetrieveParams = AircraftStatusRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AircraftstatusFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AircraftStatusRetrieveParams = AircraftStatusRetrieveParams.none(),
    ): AircraftstatusFull = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(id: String, requestOptions: RequestOptions): AircraftstatusFull =
        retrieve(id, AircraftStatusRetrieveParams.none(), requestOptions)

    /**
     * Service operation to update a single AircraftStatus. A specific role is required to perform
    ...
    /** @see update */
    fun update(params: AircraftStatusUpdateParams) = update(params, RequestOptions.none())
    ...
    /** @see list */
    fun list(
        params: AircraftStatusListParams = AircraftStatusListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun list(
        params: AircraftStatusListParams = AircraftStatusListParams.none()
    ): AircraftStatusListPage = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): AircraftStatusListPage =
        list(AircraftStatusListParams.none(), requestOptions)
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, AircraftStatusDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: AircraftStatusDeleteParams = AircraftStatusDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    /** @see delete */
    fun delete(params: AircraftStatusDeleteParams) = delete(params, RequestOptions.none())

    /** @see delete */
    fun delete(id: String, requestOptions: RequestOptions) =
        delete(id, AircraftStatusDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: AircraftStatusCountParams = AircraftStatusCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): String
    ...
    fun count(requestOptions: RequestOptions): String =
        count(AircraftStatusCountParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): AircraftStatusQueryhelpResponse =
        queryhelp(AircraftStatusQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: AircraftStatusQueryhelpParams = AircraftStatusQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: AircraftStatusQueryhelpParams = AircraftStatusQueryhelpParams.none()
    ): AircraftStatusQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): AircraftStatusQueryhelpResponse =
        queryhelp(AircraftStatusQueryhelpParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/aircraftstatus`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraftstatus/{id}`, but is otherwise the same
         * as [AircraftStatusService.retrieve].
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<AircraftstatusFull> =
            retrieve(id, AircraftStatusRetrieveParams.none())
        ...
        fun retrieve(
            id: String,
            params: AircraftStatusRetrieveParams = AircraftStatusRetrieveParams.none(),
        ): HttpResponseFor<AircraftstatusFull> = retrieve(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `put /udl/aircraftstatus/{id}`, but is otherwise the same
         * as [AircraftStatusService.update].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraftstatus`, but is otherwise the same as
         * [AircraftStatusService.list].
         */
        @MustBeClosed
        ...
        fun list(
            params: AircraftStatusListParams = AircraftStatusListParams.none()
        ): HttpResponseFor<AircraftStatusListPage> = list(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/aircraftstatus/{id}`, but is otherwise the
         * same as [AircraftStatusService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, AircraftStatusDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraftstatus/count`, but is otherwise the
         * same as [AircraftStatusService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(AircraftStatusCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraftstatus/queryhelp`, but is otherwise the
         * same as [AircraftStatusService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AircraftStatusQueryhelpResponse> =
            queryhelp(AircraftStatusQueryhelpParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraftstatus/tuple`, but is otherwise the
         * same as [AircraftStatusService.tuple].
         */
        @MustBeClosed
