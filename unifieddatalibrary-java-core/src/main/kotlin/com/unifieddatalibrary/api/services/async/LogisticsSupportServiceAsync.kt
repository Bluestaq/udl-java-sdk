...
interface LogisticsSupportServiceAsync {
     ...
     */
    fun list(): CompletableFuture<LogisticsSupportListPageAsync> =
    ...
    fun list(
        params: LogisticsSupportListParams = LogisticsSupportListParams.none()
    ): CompletableFuture<LogisticsSupportListPageAsync> = list(params, RequestOptions.none())
    ...
    fun get(
        id: String,
        params: LogisticsSupportGetParams = LogisticsSupportGetParams.none(),
    ): CompletableFuture<LogisticsSupportGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<LogisticsSupportQueryhelpResponse> =
    ...
    ): CompletableFuture<List<LogisticsSupportTupleResponse>> = tuple(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [LogisticsSupportServiceAsync.create].
         */
         ...
         * same as [LogisticsSupportServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: LogisticsSupportUpdateParams,
         ...
         * [LogisticsSupportServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<LogisticsSupportListPageAsync>> =
            list(LogisticsSupportListParams.none())
         ...
         * same as [LogisticsSupportServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(LogisticsSupportCountParams.none())
         ...
         * the same as [LogisticsSupportServiceAsync.createBulk].
         */
         ...
         * the same as [LogisticsSupportServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<LogisticsSupportQueryhelpResponse>> =
            queryhelp(LogisticsSupportQueryhelpParams.none())
         ...
         * same as [LogisticsSupportServiceAsync.tuple].
         */
        fun tuple(
            params: LogisticsSupportTupleParams
         ...
         * the same as [LogisticsSupportServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: LogisticsSupportUnvalidatedPublishParams
