...
interface SarObservationServiceAsync {
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SarObservationListPageAsync>
    ...
    /** @see createBulk */
    fun createBulk(body: List<SarObservationCreateBulkParams.Body>): CompletableFuture<Void?> =
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SarObservationGetResponse> =
    ...
    fun get(
        id: String,
        params: SarObservationGetParams = SarObservationGetParams.none(),
    ): CompletableFuture<SarObservationGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<SarObservationQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SarObservationQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: SarObservationQueryhelpParams = SarObservationQueryhelpParams.none()
    ): CompletableFuture<SarObservationQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    ): CompletableFuture<List<SarObservationTupleResponse>> = tuple(params, RequestOptions.none())

    /** @see tuple */
    fun tuple(
        params: SarObservationTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<SarObservationTupleResponse>>
    ...
    /**
     * A view of [SarObservationServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * [SarObservationServiceAsync.create].
         */
         ...
         * [SarObservationServiceAsync.list].
         */
        fun list(
            params: SarObservationListParams
        ): CompletableFuture<HttpResponseFor<SarObservationListPageAsync>> =
            list(params, RequestOptions.none())
         ...
         * same as [SarObservationServiceAsync.count].
         */
         ...
         * the same as [SarObservationServiceAsync.createBulk].
         */
         ...
         * as [SarObservationServiceAsync.get].
         */
        ...
        fun get(
            ...
            params: SarObservationGetParams = SarObservationGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SarObservationGetResponse>> =
            get(params.toBuilder().id(id).build(), requestOptions)
         ...
         * same as [SarObservationServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SarObservationQueryhelpResponse>> =
            queryhelp(SarObservationQueryhelpParams.none())
        ...
        fun queryhelp(
            params: SarObservationQueryhelpParams = SarObservationQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SarObservationQueryhelpResponse>>
         ...
         * same as [SarObservationServiceAsync.tuple].
         */
        fun tuple(
            params: SarObservationTupleParams
        ): CompletableFuture<HttpResponseFor<List<SarObservationTupleResponse>>> =
         ...
         * [SarObservationServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: SarObservationUnvalidatedPublishParams
