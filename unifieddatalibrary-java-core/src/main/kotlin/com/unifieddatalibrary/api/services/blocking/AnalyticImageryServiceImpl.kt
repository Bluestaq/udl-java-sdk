...
import com.unifieddatalibrary.api.services.blocking.analyticimagery.HistoryServiceImpl
...
class AnalyticImageryServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun count(params: AnalyticImageryCountParams, requestOptions: RequestOptions): String =
