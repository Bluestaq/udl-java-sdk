...
interface AircraftServiceAsync {
    ...
    /**
     * Service operation to take a single Aircraft as a POST body and ingest into the database. A
    ...
    /**
     * Service operation to get a single Aircraft record by its unique ID passed as a path
     * parameter.
     */
    fun retrieve(id: String): CompletableFuture<AircraftFull> =
        retrieve(id, AircraftRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AircraftRetrieveParams = AircraftRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<AircraftFull> = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AircraftRetrieveParams = AircraftRetrieveParams.none(),
    ): CompletableFuture<AircraftFull> = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(id: String, requestOptions: RequestOptions): CompletableFuture<AircraftFull> =
        retrieve(id, AircraftRetrieveParams.none(), requestOptions)
    ...
    /** @see list */
    fun list(
        params: AircraftListParams = AircraftListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun list(
        params: AircraftListParams = AircraftListParams.none()
    ): CompletableFuture<AircraftListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<AircraftListPageAsync> =
        list(AircraftListParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: AircraftCountParams = AircraftCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun count(requestOptions: RequestOptions): CompletableFuture<String> =
        count(AircraftCountParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): CompletableFuture<AircraftQueryhelpResponse> =
        queryhelp(AircraftQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: AircraftQueryhelpParams = AircraftQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: AircraftQueryhelpParams = AircraftQueryhelpParams.none()
    ): CompletableFuture<AircraftQueryhelpResponse> = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): CompletableFuture<AircraftQueryhelpResponse> =
        queryhelp(AircraftQueryhelpParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/aircraft`, but is otherwise the same as
         * [AircraftServiceAsync.create].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraft/{id}`, but is otherwise the same as
         * [AircraftServiceAsync.retrieve].
         */
        ...
        /**
         * Returns a raw HTTP response for `put /udl/aircraft/{id}`, but is otherwise the same as
         * [AircraftServiceAsync.update].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraft`, but is otherwise the same as
         * [AircraftServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<AircraftListPageAsync>> =
            list(AircraftListParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraft/count`, but is otherwise the same as
         * [AircraftServiceAsync.count].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/aircraft/queryhelp`, but is otherwise the same
         * as [AircraftServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<AircraftQueryhelpResponse>> =
            queryhelp(AircraftQueryhelpParams.none())
