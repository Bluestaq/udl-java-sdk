...
class EquipmentServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : EquipmentService {

    private val withRawResponse: EquipmentService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): EquipmentService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EquipmentService = EquipmentServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: EquipmentRetrieveParams, requestOptions: RequestOptions): EquipmentFull =
    ...
    override fun list(params: EquipmentListParams, requestOptions: RequestOptions): EquipmentListPage =
        // get /udl/equipment
    ...
    override fun queryHelp(params: EquipmentQueryHelpParams, requestOptions: RequestOptions): EquipmentQueryHelpResponse =
        // get /udl/equipment/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: EquipmentTupleParams, requestOptions: RequestOptions): List<EquipmentFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EquipmentService.WithRawResponse = EquipmentServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: EquipmentCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: EquipmentRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<EquipmentFull> {
        ...
        override fun update(params: EquipmentUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun list(params: EquipmentListParams, requestOptions: RequestOptions): HttpResponseFor<EquipmentListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "equipment")
        ...
        override fun delete(params: EquipmentDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun count(params: EquipmentCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: EquipmentCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: EquipmentQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<EquipmentQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: EquipmentTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<EquipmentFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
