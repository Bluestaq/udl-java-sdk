...
interface RfBandTypeService {
     ...
     * assistance.
     */
    fun create(params: RfBandTypeCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: RfBandTypeUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, RfBandTypeDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: RfBandTypeDeleteParams) = delete(params, RequestOptions.none())
    ...
    fun get(id: String): RfBandTypeGetResponse = get(id, RfBandTypeGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): RfBandTypeGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: RfBandTypeGetParams = RfBandTypeGetParams.none(),
    ): RfBandTypeGetResponse = get(id, params, RequestOptions.none())
    ...
    /** @see get */
    fun get(params: RfBandTypeGetParams): RfBandTypeGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: RfBandTypeQueryhelpParams = RfBandTypeQueryhelpParams.none()
    ): RfBandTypeQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: RfBandTypeListParams = RfBandTypeListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<RfBandTypeListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: RfBandTypeListParams = RfBandTypeListParams.none()
        ): HttpResponseFor<RfBandTypeListPage> = list(params, RequestOptions.none())
         ...
         * as [RfBandTypeService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, RfBandTypeDeleteParams.none())
         ...
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(RfBandTypeCountParams.none())
        ...
        fun get(
            ...
            params: RfBandTypeGetParams = RfBandTypeGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<RfBandTypeGetResponse> =
        ...
        fun get(
            id: String,
            params: RfBandTypeGetParams = RfBandTypeGetParams.none(),
        ): HttpResponseFor<RfBandTypeGetResponse> = get(id, params, RequestOptions.none())
         ...
         * same as [RfBandTypeService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<RfBandTypeQueryhelpResponse> =
        ...
        fun queryhelp(
            params: RfBandTypeQueryhelpParams = RfBandTypeQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<RfBandTypeQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: RfBandTypeQueryhelpParams = RfBandTypeQueryhelpParams.none()
        ): HttpResponseFor<RfBandTypeQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: RfBandTypeTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<RfBandTypeTupleResponse>>
    }
}
