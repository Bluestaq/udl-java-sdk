...
class NavigationalObstructionServiceImpl
internal constructor(private val clientOptions: ClientOptions) : NavigationalObstructionService {

    private val withRawResponse: NavigationalObstructionService.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        NavigationalObstructionServiceImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            NavigationalObstructionServiceImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )
