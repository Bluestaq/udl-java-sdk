...
interface SensorServiceAsync {
    ...
    fun list(
        params: SensorListParams = SensorListParams.none()
    ): CompletableFuture<SensorListPageAsync> = list(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, SensorDeleteParams.none())
    ...
    fun get(id: String): CompletableFuture<SensorGetResponse> = get(id, SensorGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SensorGetResponse> = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: SensorGetParams = SensorGetParams.none(),
    ): CompletableFuture<SensorGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<SensorQueryhelpResponse> =
    ...
    fun queryhelp(
        params: SensorQueryhelpParams = SensorQueryhelpParams.none()
    ): CompletableFuture<SensorQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [SensorServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<SensorListPageAsync>> =
            list(SensorListParams.none())
        ...
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, SensorDeleteParams.none())
         ...
         * [SensorServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SensorQueryhelpResponse>> =
            queryhelp(SensorQueryhelpParams.none())
