...
interface SeraDataNavigationServiceAsync {
     ...
     */
    fun list(): CompletableFuture<SeraDataNavigationListPageAsync> =
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SeraDataNavigationListPageAsync>

    /** @see list */
    fun list(
        params: SeraDataNavigationListParams = SeraDataNavigationListParams.none()
    ): CompletableFuture<SeraDataNavigationListPageAsync> = list(params, RequestOptions.none())
    ...
    fun delete(id: String): CompletableFuture<Void?> =
        delete(id, SeraDataNavigationDeleteParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SeraDataNavigationGetResponse> =
    ...
    fun get(
        id: String,
        params: SeraDataNavigationGetParams = SeraDataNavigationGetParams.none(),
    ): CompletableFuture<SeraDataNavigationGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<SeraDataNavigationQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<SeraDataNavigationQueryhelpResponse>
    ...
    ): CompletableFuture<List<SeraDataNavigationTupleResponse>> =
    ...
    /**
     * A view of [SeraDataNavigationServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * as [SeraDataNavigationServiceAsync.create].
         */
         ...
         * same as [SeraDataNavigationServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: SeraDataNavigationUpdateParams,
         ...
         * as [SeraDataNavigationServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<SeraDataNavigationListPageAsync>> =
            list(SeraDataNavigationListParams.none())
        ...
        fun list(
            params: SeraDataNavigationListParams = SeraDataNavigationListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SeraDataNavigationListPageAsync>>
         ...
         * the same as [SeraDataNavigationServiceAsync.delete].
         */
         ...
         * same as [SeraDataNavigationServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(SeraDataNavigationCountParams.none())
         ...
         * same as [SeraDataNavigationServiceAsync.get].
         */
        ...
        fun get(
            ...
            params: SeraDataNavigationGetParams = SeraDataNavigationGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SeraDataNavigationGetResponse>> =
            get(params.toBuilder().id(id).build(), requestOptions)
         ...
         * the same as [SeraDataNavigationServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<SeraDataNavigationQueryhelpResponse>> =
            queryhelp(SeraDataNavigationQueryhelpParams.none())
        ...
        fun queryhelp(
            params: SeraDataNavigationQueryhelpParams = SeraDataNavigationQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<SeraDataNavigationQueryhelpResponse>>
         ...
         * same as [SeraDataNavigationServiceAsync.tuple].
         */
        fun tuple(
            params: SeraDataNavigationTupleParams
        ): CompletableFuture<HttpResponseFor<List<SeraDataNavigationTupleResponse>>> =
            tuple(params, RequestOptions.none())
