...
interface AirfieldStatusServiceAsync {
    ...
    fun retrieve(
        id: String,
        params: AirfieldStatusRetrieveParams = AirfieldStatusRetrieveParams.none(),
    ): CompletableFuture<AirfieldstatusFull> = retrieve(id, params, RequestOptions.none())
     ...
     */
    fun list(): CompletableFuture<AirfieldStatusListPageAsync> =
        list(AirfieldStatusListParams.none())
    ...
    fun list(
        params: AirfieldStatusListParams = AirfieldStatusListParams.none()
    ): CompletableFuture<AirfieldStatusListPageAsync> = list(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, AirfieldStatusDeleteParams.none())
     ...
     */
    fun queryhelp(): CompletableFuture<AirfieldStatusQueryhelpResponse> =
    ...
    fun queryhelp(
        params: AirfieldStatusQueryhelpParams = AirfieldStatusQueryhelpParams.none()
    ): CompletableFuture<AirfieldStatusQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [AirfieldStatusServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [AirfieldStatusServiceAsync.retrieve].
         */
         ...
         * as [AirfieldStatusServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: AirfieldStatusUpdateParams,
         ...
         * [AirfieldStatusServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<AirfieldStatusListPageAsync>> =
            list(AirfieldStatusListParams.none())
         ...
         * same as [AirfieldStatusServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, AirfieldStatusDeleteParams.none())
         ...
         * same as [AirfieldStatusServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(AirfieldStatusCountParams.none())
         ...
         * same as [AirfieldStatusServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<AirfieldStatusQueryhelpResponse>> =
            queryhelp(AirfieldStatusQueryhelpParams.none())
         ...
         * same as [AirfieldStatusServiceAsync.tuple].
         */
        fun tuple(
            params: AirfieldStatusTupleParams
