...
interface AirloadPlanService {
    ...
    /**
     * Service operation to take a single airloadplan record as a POST body and ingest into the
     * database. A specific role is required to perform this service operation. Please contact the
     * UDL team for assistance.
     */
    fun create(params: AirloadPlanCreateParams) = create(params, RequestOptions.none())
    ...
    /**
     * Service operation to get a single airloadplan record by its unique ID passed as a path
     * parameter.
     */
    fun retrieve(id: String): AirloadplanFull = retrieve(id, AirloadPlanRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirloadPlanRetrieveParams = AirloadPlanRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirloadplanFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirloadPlanRetrieveParams = AirloadPlanRetrieveParams.none(),
    ): AirloadplanFull = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(id: String, requestOptions: RequestOptions): AirloadplanFull =
        retrieve(id, AirloadPlanRetrieveParams.none(), requestOptions)
     ...
     * information.
     */
    fun count(params: AirloadPlanCountParams): String = count(params, RequestOptions.none())
    ...
    /** @see queryhelp */
    fun queryhelp(
        params: AirloadPlanQueryhelpParams = AirloadPlanQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: AirloadPlanQueryhelpParams = AirloadPlanQueryhelpParams.none()
    ): AirloadPlanQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): AirloadPlanQueryhelpResponse =
        queryhelp(AirloadPlanQueryhelpParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/airloadplan`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airloadplan/{id}`, but is otherwise the same as
         * [AirloadPlanService.retrieve].
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<AirloadplanFull> =
            retrieve(id, AirloadPlanRetrieveParams.none())
        ...
        fun retrieve(
            id: String,
            params: AirloadPlanRetrieveParams = AirloadPlanRetrieveParams.none(),
        ): HttpResponseFor<AirloadplanFull> = retrieve(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airloadplan`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airloadplan/count`, but is otherwise the same
         * as [AirloadPlanService.count].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airloadplan/queryhelp`, but is otherwise the
         * same as [AirloadPlanService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AirloadPlanQueryhelpResponse> =
            queryhelp(AirloadPlanQueryhelpParams.none())
        ...
        fun queryhelp(
            params: AirloadPlanQueryhelpParams = AirloadPlanQueryhelpParams.none()
        ): HttpResponseFor<AirloadPlanQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airloadplan/tuple`, but is otherwise the same
         * as [AirloadPlanService.tuple].
         */
        @MustBeClosed
