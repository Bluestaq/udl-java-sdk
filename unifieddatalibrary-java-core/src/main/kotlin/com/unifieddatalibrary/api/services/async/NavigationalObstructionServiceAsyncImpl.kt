...
class NavigationalObstructionServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : NavigationalObstructionServiceAsync {

    private val withRawResponse: NavigationalObstructionServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): NavigationalObstructionServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): NavigationalObstructionServiceAsync = NavigationalObstructionServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: NavigationalObstructionCreateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/navigationalobstruction
        withRawResponse().create(params, requestOptions).thenAccept {}

    override fun update(params: NavigationalObstructionUpdateParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // put /udl/navigationalobstruction/{id}
        withRawResponse().update(params, requestOptions).thenAccept {}

    override fun list(params: NavigationalObstructionListParams, requestOptions: RequestOptions): CompletableFuture<NavigationalObstructionListPageAsync> =
        // get /udl/navigationalobstruction
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: NavigationalObstructionCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/navigationalobstruction/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun createBulk(params: NavigationalObstructionCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /udl/navigationalobstruction/createBulk
        withRawResponse().createBulk(params, requestOptions).thenAccept {}

    override fun get(params: NavigationalObstructionGetParams, requestOptions: RequestOptions): CompletableFuture<NavigationalObstructionGetResponse> =
        // get /udl/navigationalobstruction/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: NavigationalObstructionQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<NavigationalObstructionQueryhelpResponse> =
        // get /udl/navigationalobstruction/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: NavigationalObstructionTupleParams, requestOptions: RequestOptions): CompletableFuture<List<NavigationalObstructionTupleResponse>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): NavigationalObstructionServiceAsync.WithRawResponse = NavigationalObstructionServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: NavigationalObstructionCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun update(params: NavigationalObstructionUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun list(params: NavigationalObstructionListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<NavigationalObstructionListPageAsync>> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: NavigationalObstructionCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: NavigationalObstructionCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: NavigationalObstructionGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<NavigationalObstructionGetResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun queryhelp(params: NavigationalObstructionQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<NavigationalObstructionQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: NavigationalObstructionTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<NavigationalObstructionTupleResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
