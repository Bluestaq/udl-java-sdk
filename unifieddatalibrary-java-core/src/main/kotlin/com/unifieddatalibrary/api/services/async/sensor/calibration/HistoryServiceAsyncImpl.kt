...
import com.unifieddatalibrary.api.models.sensor.calibration.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.sensor.calibration.history.HistoryListParams
import com.unifieddatalibrary.api.models.sensor.calibration.history.HistoryListResponse
...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(
        ...
        // get /udl/sensorcalibration/history
    ...
    override fun aodr(
        ...
        // get /udl/sensorcalibration/history/aodr
    ...
    override fun count(
        ...
        // get /udl/sensorcalibration/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "sensorcalibration", "history")
                    .build()
        ...
        override fun aodr(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "sensorcalibration", "history", "aodr")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
        ...
        override fun count(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "sensorcalibration", "history", "count")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
