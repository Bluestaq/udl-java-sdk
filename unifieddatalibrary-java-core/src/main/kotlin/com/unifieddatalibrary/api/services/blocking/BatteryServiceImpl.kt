...
class BatteryServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BatteryService {

    private val withRawResponse: BatteryService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BatteryService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BatteryService = BatteryServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: BatteryRetrieveParams, requestOptions: RequestOptions): BatteryFull =
        // get /udl/battery/{id}
    ...
    override fun queryhelp(params: BatteryQueryhelpParams, requestOptions: RequestOptions): BatteryQueryhelpResponse =
        // get /udl/battery/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: BatteryTupleParams, requestOptions: RequestOptions): List<BatteryFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BatteryService.WithRawResponse = BatteryServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: BatteryCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: BatteryRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<BatteryFull> {
        ...
        override fun update(params: BatteryUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun list(params: BatteryListParams, requestOptions: RequestOptions): HttpResponseFor<BatteryListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "battery")
        ...
        override fun delete(params: BatteryDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun count(params: BatteryCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: BatteryQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<BatteryQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: BatteryTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<BatteryFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
