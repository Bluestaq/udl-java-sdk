...
package com.unifieddatalibrary.api.services.async.emireport
...
import com.unifieddatalibrary.api.models.emireport.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/emireport/history`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `get /udl/emireport/history/aodr`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/emireport/history/count`, but is otherwise the
