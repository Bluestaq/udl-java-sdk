...
class OnorbitbatteryServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : OnorbitbatteryServiceAsync {

    private val withRawResponse: OnorbitbatteryServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        OnorbitbatteryServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        params: OnorbitbatteryListParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnorbitbatteryServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<OnorbitbatteryListResponse>> =
            jsonHandler<List<OnorbitbatteryListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<OnorbitBatteryFull> =
            jsonHandler<OnorbitBatteryFull>(clientOptions.jsonMapper)
