...
interface HistoryService {
    ...
    /** @see retrieve */
    fun retrieve(params: HistoryRetrieveParams = HistoryRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): List<HistoryRetrieveResponse>

    /** @see retrieve */
    fun retrieve(params: HistoryRetrieveParams = HistoryRetrieveParams.none()): List<HistoryRetrieveResponse> =
        retrieve(
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/sensormaintenance/history`, but is otherwise the same as [HistoryService.retrieve]. */
        @MustBeClosed
        fun retrieve(): HttpResponseFor<List<HistoryRetrieveResponse>> = retrieve(HistoryRetrieveParams.none())

        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: HistoryRetrieveParams = HistoryRetrieveParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<List<HistoryRetrieveResponse>>

        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: HistoryRetrieveParams = HistoryRetrieveParams.none()): HttpResponseFor<List<HistoryRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(requestOptions: RequestOptions): HttpResponseFor<List<HistoryRetrieveResponse>> =
            retrieve(
              HistoryRetrieveParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `get /udl/sensormaintenance/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/sensormaintenance/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
