...
package com.unifieddatalibrary.api.services.blocking.sarobservation
...
interface HistoryService {
    ...
    /** @see retrieve */
    fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): List<HistoryRetrieveResponse>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/sarobservation/history`, but is otherwise the same as [HistoryService.retrieve]. */
        @MustBeClosed
        fun retrieve(params: HistoryRetrieveParams): HttpResponseFor<List<HistoryRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: HistoryRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<List<HistoryRetrieveResponse>>

        /** Returns a raw HTTP response for `get /udl/sarobservation/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/sarobservation/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
