...
interface PoiService {
     ...
     * assistance.
     */
    fun create(params: PoiCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun list(params: PoiListParams): PoiListPage = list(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: PoiCountParams): String = count(params, RequestOptions.none())
     ...
     */
    fun createBulk(params: PoiCreateBulkParams) = createBulk(params, RequestOptions.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): PoiGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: PoiGetParams): PoiGetResponse = get(params, RequestOptions.none())
     ...
     */
    fun tuple(params: PoiTupleParams): List<PoiTupleResponse> = tuple(params, RequestOptions.none())

    /** @see tuple */
    fun tuple(
        params: PoiTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): List<PoiTupleResponse>
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: PoiCreateParams): HttpResponse = create(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<PoiGetResponse> = get(id, PoiGetParams.none())
        ...
        fun get(
            ...
            params: PoiGetParams = PoiGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<PoiGetResponse> = get(params.toBuilder().id(id).build(), requestOptions)
        ...
        fun get(
            id: String,
            params: PoiGetParams = PoiGetParams.none(),
        ): HttpResponseFor<PoiGetResponse> = get(id, params, RequestOptions.none())
        ...
        fun get(
            params: PoiGetParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<PoiGetResponse>
         ...
         * [PoiService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<PoiQueryhelpResponse> =
        ...
        fun queryhelp(
            params: PoiQueryhelpParams = PoiQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<PoiQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: PoiQueryhelpParams = PoiQueryhelpParams.none()
        ): HttpResponseFor<PoiQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: PoiTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<PoiTupleResponse>>
