...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/missionassignment/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/missionassignment/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/missionassignment/history`, but is otherwise the same as [HistoryService.query]. */
        @MustBeClosed
