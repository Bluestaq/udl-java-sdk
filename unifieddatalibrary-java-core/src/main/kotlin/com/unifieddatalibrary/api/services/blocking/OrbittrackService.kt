...
interface OrbittrackService {
     ...
     */
    fun list(params: OrbittrackListParams): OrbittrackListPage = list(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: OrbittrackCountParams): String = count(params, RequestOptions.none())
     ...
     * mechanism.
     */
    fun createBulk(params: OrbittrackCreateBulkParams) = createBulk(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: OrbittrackQueryhelpParams = OrbittrackQueryhelpParams.none()
    ): OrbittrackQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [OrbittrackService.createBulk].
         */
        @MustBeClosed
         ...
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<OrbittrackQueryhelpResponse> =
        ...
        fun queryhelp(
            params: OrbittrackQueryhelpParams = OrbittrackQueryhelpParams.none()
        ): HttpResponseFor<OrbittrackQueryhelpResponse> = queryhelp(params, RequestOptions.none())
         ...
         * same as [OrbittrackService.unvalidatedPublish].
         */
        @MustBeClosed
