...
class OnorbitlistServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    OnorbitlistServiceAsync {

    private val withRawResponse: OnorbitlistServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): OnorbitlistServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): OnorbitlistServiceAsync =
        OnorbitlistServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(
        params: OnorbitlistQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnorbitlistServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<OnorbitlistListResponse>> =
            jsonHandler<List<OnorbitlistListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<OnorbitlistGetResponse> =
            jsonHandler<OnorbitlistGetResponse>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<OnorbitlistQueryhelpResponse> =
            jsonHandler<OnorbitlistQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<OnorbitlistTupleResponse>> =
            jsonHandler<List<OnorbitlistTupleResponse>>(clientOptions.jsonMapper)
