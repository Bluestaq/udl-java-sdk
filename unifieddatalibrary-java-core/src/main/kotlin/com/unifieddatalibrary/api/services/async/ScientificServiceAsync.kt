...
interface ScientificServiceAsync {
    ...
    fun list(
        params: ScientificListParams = ScientificListParams.none()
    ): CompletableFuture<ScientificListPageAsync> = list(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, ScientificDeleteParams.none())
    ...
    fun get(
        id: String,
        params: ScientificGetParams = ScientificGetParams.none(),
    ): CompletableFuture<ScientificGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<ScientificQueryhelpResponse> =
    ...
    fun queryhelp(
        params: ScientificQueryhelpParams = ScientificQueryhelpParams.none()
    ): CompletableFuture<ScientificQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    /**
     * A view of [ScientificServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * [ScientificServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<ScientificListPageAsync>> =
            list(ScientificListParams.none())
         ...
         * as [ScientificServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, ScientificDeleteParams.none())
        ...
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(ScientificCountParams.none())
         ...
         * same as [ScientificServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<ScientificQueryhelpResponse>> =
            queryhelp(ScientificQueryhelpParams.none())
