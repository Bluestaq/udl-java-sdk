...
interface AttitudeDataService {
    ...
    fun queryHelp(
        params: AttitudeDataQueryHelpParams = AttitudeDataQueryHelpParams.none()
    ): AttitudeDataQueryHelpResponse = queryHelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [AttitudeDataService.queryHelp].
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<AttitudeDataQueryHelpResponse> =
        ...
        fun queryHelp(
            params: AttitudeDataQueryHelpParams = AttitudeDataQueryHelpParams.none()
        ): HttpResponseFor<AttitudeDataQueryHelpResponse> = queryHelp(params, RequestOptions.none())
