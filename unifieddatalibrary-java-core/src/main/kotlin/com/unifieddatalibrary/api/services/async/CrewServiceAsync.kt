...
interface CrewServiceAsync {
     ...
     */
    fun retrieve(id: String): CompletableFuture<CrewFull> = retrieve(id, CrewRetrieveParams.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<CrewFull> = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: CrewRetrieveParams = CrewRetrieveParams.none(),
    ): CompletableFuture<CrewFull> = retrieve(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<CrewQueryhelpResponse> =
    ...
    fun queryhelp(
        params: CrewQueryhelpParams = CrewQueryhelpParams.none()
    ): CompletableFuture<CrewQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [CrewServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<CrewListPageAsync>> =
            list(CrewListParams.none())
         ...
         * [CrewServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<CrewQueryhelpResponse>> =
            queryhelp(CrewQueryhelpParams.none())
