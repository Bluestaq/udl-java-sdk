...
interface AttitudeSetServiceAsync {
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<AttitudeSetListPageAsync>
     ...
     */
    fun queryHelp(): CompletableFuture<AttitudeSetQueryHelpResponse> =
    ...
    fun queryHelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<AttitudeSetQueryHelpResponse>

    /** @see queryHelp */
    fun queryHelp(
        params: AttitudeSetQueryHelpParams = AttitudeSetQueryHelpParams.none()
    ): CompletableFuture<AttitudeSetQueryHelpResponse> = queryHelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<AttitudesetFull>>
    ...
    interface WithRawResponse {
         ...
         * [AttitudeSetServiceAsync.create].
         */
         ...
         * [AttitudeSetServiceAsync.list].
         */
        fun list(
            params: AttitudeSetListParams
        ): CompletableFuture<HttpResponseFor<AttitudeSetListPageAsync>> =
            list(params, RequestOptions.none())
         ...
         * as [AttitudeSetServiceAsync.count].
         */
         ...
         * same as [AttitudeSetServiceAsync.queryHelp].
         */
        fun queryHelp(): CompletableFuture<HttpResponseFor<AttitudeSetQueryHelpResponse>> =
            queryHelp(AttitudeSetQueryHelpParams.none())
        ...
        fun queryHelp(
            params: AttitudeSetQueryHelpParams = AttitudeSetQueryHelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<AttitudeSetQueryHelpResponse>>
         ...
         * as [AttitudeSetServiceAsync.tuple].
         */
        fun tuple(
            params: AttitudeSetTupleParams
        ): CompletableFuture<HttpResponseFor<List<AttitudesetFull>>> =
            tuple(params, RequestOptions.none())
         ...
         * same as [AttitudeSetServiceAsync.unvalidatedPublish].
         */
        fun unvalidatedPublish(
            params: AttitudeSetUnvalidatedPublishParams
