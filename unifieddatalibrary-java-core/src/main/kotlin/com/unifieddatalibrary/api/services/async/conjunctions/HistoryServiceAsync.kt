...
package com.unifieddatalibrary.api.services.async.conjunctions
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/conjunction/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/conjunction/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
