...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/conjunction/history/aodr`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /udl/conjunction/history/count`, but is otherwise
