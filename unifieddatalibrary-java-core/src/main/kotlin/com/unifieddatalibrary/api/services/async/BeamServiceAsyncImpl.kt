...
class BeamServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: BeamServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): BeamServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BeamServiceAsync =
        BeamServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        params: BeamListParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<BeamListPageAsync> =
        // get /udl/beam
    ...
    override fun queryHelp(
        params: BeamQueryHelpParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<BeamQueryHelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<BeamFull>> =
        // get /udl/beam/tuple
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            BeamServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val retrieveHandler: Handler<BeamFull> =
            jsonHandler<BeamFull>(clientOptions.jsonMapper)

        override fun retrieve(
            params: BeamRetrieveParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<BeamFull>> {
        ...
        private val listHandler: Handler<List<BeamAbridged>> =
            jsonHandler<List<BeamAbridged>>(clientOptions.jsonMapper)

        override fun list(
            params: BeamListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<BeamListPageAsync>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val queryHelpHandler: Handler<BeamQueryHelpResponse> =
            jsonHandler<BeamQueryHelpResponse>(clientOptions.jsonMapper)

        override fun queryHelp(
            params: BeamQueryHelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<BeamQueryHelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<BeamFull>> =
            jsonHandler<List<BeamFull>>(clientOptions.jsonMapper)

        override fun tuple(
            params: BeamTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<BeamFull>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
