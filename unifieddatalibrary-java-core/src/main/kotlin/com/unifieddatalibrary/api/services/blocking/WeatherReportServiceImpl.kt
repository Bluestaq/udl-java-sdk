...
class WeatherReportServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : WeatherReportService {

    private val withRawResponse: WeatherReportService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): WeatherReportService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WeatherReportService = WeatherReportServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: WeatherReportListParams, requestOptions: RequestOptions): WeatherReportListPage =
    ...
    override fun get(params: WeatherReportGetParams, requestOptions: RequestOptions): WeatherReportFull =
        // get /udl/weatherreport/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: WeatherReportQueryhelpParams, requestOptions: RequestOptions): WeatherReportQueryhelpResponse =
        // get /udl/weatherreport/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: WeatherReportTupleParams, requestOptions: RequestOptions): List<WeatherReportFull> =
        // get /udl/weatherreport/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: WeatherReportUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WeatherReportService.WithRawResponse = WeatherReportServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: WeatherReportCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: WeatherReportListParams, requestOptions: RequestOptions): HttpResponseFor<WeatherReportListPage> {
          val request = HttpRequest.builder()
        ...
        override fun count(params: WeatherReportCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: WeatherReportGetParams, requestOptions: RequestOptions): HttpResponseFor<WeatherReportFull> {
        ...
        override fun queryhelp(params: WeatherReportQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<WeatherReportQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: WeatherReportTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<WeatherReportFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: WeatherReportUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
