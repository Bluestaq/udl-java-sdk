...
package com.unifieddatalibrary.api.services.async.deconflictset
...
import com.unifieddatalibrary.api.models.deconflictset.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.deconflictset.history.HistoryCountParams
import com.unifieddatalibrary.api.models.deconflictset.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.deconflictset.history.HistoryListParams
...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun aodr(
        ...
        // get /udl/deconflictset/history/aodr
    ...
    override fun count(
        ...
        // get /udl/deconflictset/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "deconflictset", "history")
                    .build()
        ...
        override fun aodr(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "deconflictset", "history", "aodr")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
        ...
        override fun count(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "deconflictset", "history", "count")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
