...
class CountryServiceAsyncImpl internal constructor(
    ...
    override fun createBulk(params: CountryCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    override fun tuple(params: CountryTupleParams, requestOptions: RequestOptions): CompletableFuture<List<CountryTupleResponse>> =
        // get /udl/diplomaticclearancecountry/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun unvalidatedPublish(params: CountryUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun createBulk(params: CountryCreateBulkParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: CountryTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<CountryTupleResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: CountryUnvalidatedPublishParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
