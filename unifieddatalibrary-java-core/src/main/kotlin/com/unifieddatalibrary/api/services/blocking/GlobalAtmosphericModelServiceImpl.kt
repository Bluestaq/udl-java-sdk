...
class GlobalAtmosphericModelServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : GlobalAtmosphericModelService {

    private val withRawResponse: GlobalAtmosphericModelService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): GlobalAtmosphericModelService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GlobalAtmosphericModelService = GlobalAtmosphericModelServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryService = history

    override fun retrieve(params: GlobalAtmosphericModelRetrieveParams, requestOptions: RequestOptions): GlobalAtmosphericModelRetrieveResponse =
        // get /udl/globalatmosphericmodel/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun count(params: GlobalAtmosphericModelCountParams, requestOptions: RequestOptions): String =
        // get /udl/globalatmosphericmodel/count
        withRawResponse().count(params, requestOptions).parse()

    override fun getFile(params: GlobalAtmosphericModelGetFileParams, requestOptions: RequestOptions): HttpResponse =
        // get /udl/globalatmosphericmodel/getFile/{id}
        withRawResponse().getFile(params, requestOptions)

    override fun query(params: GlobalAtmosphericModelQueryParams, requestOptions: RequestOptions): List<GlobalAtmosphericModelQueryResponse> =
        // get /udl/globalatmosphericmodel
        withRawResponse().query(params, requestOptions).parse()

    override fun queryHelp(params: GlobalAtmosphericModelQueryHelpParams, requestOptions: RequestOptions): GlobalAtmosphericModelQueryHelpResponse =
        // get /udl/globalatmosphericmodel/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: GlobalAtmosphericModelTupleParams, requestOptions: RequestOptions): List<GlobalAtmosphericModelTupleResponse> =
        // get /udl/globalatmosphericmodel/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: GlobalAtmosphericModelUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GlobalAtmosphericModelService.WithRawResponse = GlobalAtmosphericModelServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun retrieve(params: GlobalAtmosphericModelRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<GlobalAtmosphericModelRetrieveResponse> {
        ...
        override fun count(params: GlobalAtmosphericModelCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun query(params: GlobalAtmosphericModelQueryParams, requestOptions: RequestOptions): HttpResponseFor<List<GlobalAtmosphericModelQueryResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: GlobalAtmosphericModelQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<GlobalAtmosphericModelQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: GlobalAtmosphericModelTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<GlobalAtmosphericModelTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: GlobalAtmosphericModelUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
