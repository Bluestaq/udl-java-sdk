...
interface EphemerisService {
     ...
     */
    fun list(params: EphemerisListParams): EphemerisListPage = list(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: EphemerisCountParams): String = count(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: EphemerisQueryhelpParams = EphemerisQueryhelpParams.none()
    ): EphemerisQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [EphemerisService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<EphemerisQueryhelpResponse> =
        ...
        fun queryhelp(
            params: EphemerisQueryhelpParams = EphemerisQueryhelpParams.none()
        ): HttpResponseFor<EphemerisQueryhelpResponse> = queryhelp(params, RequestOptions.none())
