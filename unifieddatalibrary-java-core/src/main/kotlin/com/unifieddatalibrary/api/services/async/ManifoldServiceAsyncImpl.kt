...
class ManifoldServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ManifoldServiceAsync {

    private val withRawResponse: ManifoldServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): ManifoldServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ManifoldServiceAsync =
        ManifoldServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            ManifoldServiceAsyncImpl.WithRawResponseImpl(
