...
class ObjectOfInterestServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ObjectOfInterestService {

    private val withRawResponse: ObjectOfInterestService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ObjectOfInterestService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ObjectOfInterestService = ObjectOfInterestServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: ObjectOfInterestListParams, requestOptions: RequestOptions): ObjectOfInterestListPage =
    ...
    override fun count(params: ObjectOfInterestCountParams, requestOptions: RequestOptions): String =
        // get /udl/objectofinterest/count
        withRawResponse().count(params, requestOptions).parse()

    override fun get(params: ObjectOfInterestGetParams, requestOptions: RequestOptions): ObjectOfInterestGetResponse =
        // get /udl/objectofinterest/{id}
        withRawResponse().get(params, requestOptions).parse()

    override fun queryhelp(params: ObjectOfInterestQueryhelpParams, requestOptions: RequestOptions): ObjectOfInterestQueryhelpResponse =
        // get /udl/objectofinterest/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: ObjectOfInterestTupleParams, requestOptions: RequestOptions): List<ObjectOfInterestTupleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ObjectOfInterestService.WithRawResponse = ObjectOfInterestServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: ObjectOfInterestCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: ObjectOfInterestUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: ObjectOfInterestListParams, requestOptions: RequestOptions): HttpResponseFor<ObjectOfInterestListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: ObjectOfInterestDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: ObjectOfInterestCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: ObjectOfInterestGetParams, requestOptions: RequestOptions): HttpResponseFor<ObjectOfInterestGetResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: ObjectOfInterestQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<ObjectOfInterestQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: ObjectOfInterestTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<ObjectOfInterestTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
