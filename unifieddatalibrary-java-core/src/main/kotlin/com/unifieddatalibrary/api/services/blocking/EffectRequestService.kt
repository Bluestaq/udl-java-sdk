...
interface EffectRequestService {
     ...
     */
    fun create(params: EffectRequestCreateParams) = create(params, RequestOptions.none())
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): EffectRequestRetrieveResponse = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: EffectRequestRetrieveParams = EffectRequestRetrieveParams.none(),
    ): EffectRequestRetrieveResponse = retrieve(id, params, RequestOptions.none())
     ...
     */
    fun count(params: EffectRequestCountParams): String = count(params, RequestOptions.none())
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<EffectRequestCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) = createBulk(EffectRequestCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<EffectRequestCreateBulkParams.Body>) =
    ...
    fun queryHelp(
        params: EffectRequestQueryHelpParams = EffectRequestQueryHelpParams.none()
    ): EffectRequestQueryHelpResponse = queryHelp(params, RequestOptions.none())
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<EffectRequestUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            EffectRequestUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<EffectRequestUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
         ...
         * as [EffectRequestService.retrieve].
         */
        @MustBeClosed
        ...
        fun retrieve(
            params: EffectRequestRetrieveParams
        ): HttpResponseFor<EffectRequestRetrieveResponse> = retrieve(params, RequestOptions.none())
         ...
         * the same as [EffectRequestService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<EffectRequestCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/effectrequest/queryhelp`, but is otherwise the
         * same as [EffectRequestService.queryHelp].
         */
        @MustBeClosed
        fun queryHelp(): HttpResponseFor<EffectRequestQueryHelpResponse> =
         ...
         * as [EffectRequestService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: EffectRequestTupleParams
        ): HttpResponseFor<List<EffectRequestTupleResponse>> = tuple(params, RequestOptions.none())
         ...
         * same as [EffectRequestService.unvalidatedPublish].
         */
        @MustBeClosed
