...
interface AircraftService {
     ...
     * assistance.
     */
    fun create(params: AircraftCreateParams) = create(params, RequestOptions.none())
     ...
     * parameter.
     */
    fun retrieve(id: String): AircraftFull = retrieve(id, AircraftRetrieveParams.none())
    ...
    ): AircraftFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AircraftRetrieveParams = AircraftRetrieveParams.none(),
    ): AircraftFull = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: AircraftUpdateParams) = update(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: AircraftQueryhelpParams = AircraftQueryhelpParams.none()
    ): AircraftQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            id: String,
            params: AircraftRetrieveParams = AircraftRetrieveParams.none(),
        ): HttpResponseFor<AircraftFull> = retrieve(id, params, RequestOptions.none())
        ...
        fun list(
            params: AircraftListParams = AircraftListParams.none()
        ): HttpResponseFor<AircraftListPage> = list(params, RequestOptions.none())
         ...
         * [AircraftService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(AircraftCountParams.none())
         ...
         * as [AircraftService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AircraftQueryhelpResponse> =
        ...
        fun queryhelp(
            params: AircraftQueryhelpParams = AircraftQueryhelpParams.none()
        ): HttpResponseFor<AircraftQueryhelpResponse> = queryhelp(params, RequestOptions.none())
