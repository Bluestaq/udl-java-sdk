...
interface SurfaceService {
     ...
     * assistance.
     */
    fun create(params: SurfaceCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: SurfaceUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, SurfaceDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: SurfaceDeleteParams) = delete(params, RequestOptions.none())
     ...
     */
    fun get(id: String): SurfaceGetResponse = get(id, SurfaceGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SurfaceGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: SurfaceGetParams): SurfaceGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: SurfaceQueryhelpParams = SurfaceQueryhelpParams.none()
    ): SurfaceQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [SurfaceService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<SurfaceListPage> = list(SurfaceListParams.none())
        ...
        fun list(
            params: SurfaceListParams = SurfaceListParams.none()
        ): HttpResponseFor<SurfaceListPage> = list(params, RequestOptions.none())
         ...
         * [SurfaceService.delete].
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, SurfaceDeleteParams.none())
         ...
         * [SurfaceService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(SurfaceCountParams.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<SurfaceGetResponse> = get(id, SurfaceGetParams.none())
        ...
        fun get(
            id: String,
            params: SurfaceGetParams = SurfaceGetParams.none(),
        ): HttpResponseFor<SurfaceGetResponse> = get(id, params, RequestOptions.none())
         ...
         * as [SurfaceService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SurfaceQueryhelpResponse> =
        ...
        fun queryhelp(
            params: SurfaceQueryhelpParams = SurfaceQueryhelpParams.none()
        ): HttpResponseFor<SurfaceQueryhelpResponse> = queryhelp(params, RequestOptions.none())
