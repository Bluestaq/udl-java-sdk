...
class WeatherDataServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    WeatherDataService {

    private val withRawResponse: WeatherDataService.WithRawResponse by lazy {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): WeatherDataService =
        WeatherDataServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            WeatherDataServiceImpl.WithRawResponseImpl(
