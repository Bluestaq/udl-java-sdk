...
package com.unifieddatalibrary.api.services.blocking.geostatus
...
import com.unifieddatalibrary.api.models.geostatus.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.geostatus.history.HistoryCountParams
import com.unifieddatalibrary.api.models.geostatus.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/geostatus/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/geostatus/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/geostatus/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
