...
package com.unifieddatalibrary.api.services.blocking.ephemerissets
...
import com.unifieddatalibrary.api.models.ephemerissets.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/ephemerisset/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/ephemerisset/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/ephemerisset/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
