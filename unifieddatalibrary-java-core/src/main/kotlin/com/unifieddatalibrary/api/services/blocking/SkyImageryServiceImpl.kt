...
class SkyImageryServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: SkyImageryService.WithRawResponse by lazy {
    ...
    override fun queryhelp(
        params: SkyImageryQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SkyImageryServiceImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<SkyImageryListResponse>> =
            jsonHandler<List<SkyImageryListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: SkyImageryListParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<SkyImageryListPage> {
            val request =
                HttpRequest.builder()
        ...
        private val getHandler: Handler<SkyImageryGetResponse> =
            jsonHandler<SkyImageryGetResponse>(clientOptions.jsonMapper)

        override fun get(
            params: SkyImageryGetParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<SkyImageryGetResponse> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("id", params.id().getOrNull())
            val request =
        ...
        private val queryhelpHandler: Handler<SkyImageryQueryhelpResponse> =
            jsonHandler<SkyImageryQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(
            params: SkyImageryQueryhelpParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<SkyImageryQueryhelpResponse> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<SkyImageryTupleResponse>> =
            jsonHandler<List<SkyImageryTupleResponse>>(clientOptions.jsonMapper)

        override fun tuple(
            params: SkyImageryTupleParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<List<SkyImageryTupleResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
