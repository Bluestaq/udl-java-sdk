...
class SensorServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val calibration: CalibrationServiceAsync by lazy {
        CalibrationServiceAsyncImpl(clientOptions)
    }
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<SensorListPageAsync> =
        // get /udl/sensor
    ...
    override fun get(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<SensorGetResponse> =
        // get /udl/sensor/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(
        params: SensorQueryhelpParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<SensorQueryhelpResponse> =
    ...
    override fun tuple(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<List<SensorTupleResponse>> =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val calibration: CalibrationServiceAsync.WithRawResponse by lazy {
            CalibrationServiceAsyncImpl.WithRawResponseImpl(clientOptions)
        }
        ...
        private val listHandler: Handler<List<SensorListResponse>> =
            jsonHandler<List<SensorListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: SensorListParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<SensorListPageAsync>> {
            val request =
                HttpRequest.builder()
        ...
        private val getHandler: Handler<SensorGetResponse> =
            jsonHandler<SensorGetResponse>(clientOptions.jsonMapper)

        override fun get(
            params: SensorGetParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<SensorGetResponse>> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("id", params.id().getOrNull())
            val request =
        ...
        private val queryhelpHandler: Handler<SensorQueryhelpResponse> =
            jsonHandler<SensorQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(
            params: SensorQueryhelpParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<SensorQueryhelpResponse>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<SensorTupleResponse>> =
            jsonHandler<List<SensorTupleResponse>>(clientOptions.jsonMapper)

        override fun tuple(
            params: SensorTupleParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<List<SensorTupleResponse>>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
