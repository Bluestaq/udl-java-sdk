...
interface AircraftStatusRemarkServiceAsync {
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<AircraftstatusremarkFull> =
    ...
    fun retrieve(
        id: String,
        params: AircraftStatusRemarkRetrieveParams = AircraftStatusRemarkRetrieveParams.none(),
    ): CompletableFuture<AircraftstatusremarkFull> = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(
        params: AircraftStatusRemarkRetrieveParams
    ): CompletableFuture<AircraftstatusremarkFull> = retrieve(params, RequestOptions.none())
     ...
     */
    fun list(): CompletableFuture<AircraftStatusRemarkListPageAsync> =
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<AircraftStatusRemarkListPageAsync>

    /** @see list */
    fun list(
        params: AircraftStatusRemarkListParams = AircraftStatusRemarkListParams.none()
    ): CompletableFuture<AircraftStatusRemarkListPageAsync> = list(params, RequestOptions.none())
    ...
    fun delete(id: String): CompletableFuture<Void?> =
        delete(id, AircraftStatusRemarkDeleteParams.none())
     ...
     */
    fun queryhelp(): CompletableFuture<AircraftStatusRemarkQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<AircraftStatusRemarkQueryhelpResponse>
    ...
    ): CompletableFuture<List<AircraftstatusremarkFull>> = tuple(params, RequestOptions.none())

    /** @see tuple */
    fun tuple(
        params: AircraftStatusRemarkTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<AircraftstatusremarkFull>>

    /**
     * A view of [AircraftStatusRemarkServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * same as [AircraftStatusRemarkServiceAsync.create].
         */
         ...
         * the same as [AircraftStatusRemarkServiceAsync.retrieve].
         */
        ...
        fun retrieve(
            ...
            params: AircraftStatusRemarkRetrieveParams = AircraftStatusRemarkRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<AircraftstatusremarkFull>> =
            retrieve(params.toBuilder().id(id).build(), requestOptions)
         ...
         * the same as [AircraftStatusRemarkServiceAsync.update].
         */
        fun update(
            pathId: String,
            params: AircraftStatusRemarkUpdateParams,
         ...
         * same as [AircraftStatusRemarkServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<AircraftStatusRemarkListPageAsync>> =
            list(AircraftStatusRemarkListParams.none())
        ...
        fun list(
            params: AircraftStatusRemarkListParams = AircraftStatusRemarkListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<AircraftStatusRemarkListPageAsync>>
         ...
         * the same as [AircraftStatusRemarkServiceAsync.delete].
         */
         ...
         * the same as [AircraftStatusRemarkServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(AircraftStatusRemarkCountParams.none())
         ...
         * otherwise the same as [AircraftStatusRemarkServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<AircraftStatusRemarkQueryhelpResponse>> =
            queryhelp(AircraftStatusRemarkQueryhelpParams.none())
        ...
        fun queryhelp(
            ...
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<AircraftStatusRemarkQueryhelpResponse>>
         ...
         * the same as [AircraftStatusRemarkServiceAsync.tuple].
         */
        fun tuple(
            params: AircraftStatusRemarkTupleParams
        ): CompletableFuture<HttpResponseFor<List<AircraftstatusremarkFull>>> =
