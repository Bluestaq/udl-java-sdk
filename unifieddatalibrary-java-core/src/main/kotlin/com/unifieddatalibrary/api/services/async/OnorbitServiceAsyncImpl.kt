...
class OnorbitServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: OnorbitServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val antennaDetails: AntennaDetailServiceAsync by lazy {
        AntennaDetailServiceAsyncImpl(clientOptions)
    }
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val antennaDetails: AntennaDetailServiceAsync.WithRawResponse by lazy {
            AntennaDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions)
        }

        override fun withOptions(
            modifier: Consumer<ClientOptions.Builder>
        ): OnorbitServiceAsync.WithRawResponse =
            OnorbitServiceAsyncImpl.WithRawResponseImpl(
