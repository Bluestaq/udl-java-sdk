...
package com.unifieddatalibrary.api.services.async.observations.radarobservation
...
import com.unifieddatalibrary.api.models.observations.radarobservation.history.HistoryListPageAsync
...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/radarobservation/history`, but is otherwise the same as [HistoryServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `get /udl/radarobservation/history/aodr`, but is otherwise the same as [HistoryServiceAsync.aodr]. */
        ...
        /** Returns a raw HTTP response for `get /udl/radarobservation/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
