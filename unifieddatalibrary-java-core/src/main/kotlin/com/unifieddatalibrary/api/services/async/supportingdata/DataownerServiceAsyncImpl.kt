...
class DataownerServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : DataownerServiceAsync {

    private val withRawResponse: DataownerServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): DataownerServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DataownerServiceAsync = DataownerServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun retrieve(params: DataownerRetrieveParams, requestOptions: RequestOptions): CompletableFuture<List<DataownerAbridged>> =
        // get /udl/dataowner
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun count(params: DataownerCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/dataowner/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun queryHelp(params: DataownerQueryHelpParams, requestOptions: RequestOptions): CompletableFuture<DataownerQueryHelpResponse> =
        // get /udl/dataowner/queryhelp
        withRawResponse().queryHelp(params, requestOptions).thenApply { it.parse() }

    override fun retrieveDataOwnerTypes(params: DataownerRetrieveDataOwnerTypesParams, requestOptions: RequestOptions): CompletableFuture<List<String>> =
        // get /udl/dataowner/getDataOwnerTypes
        withRawResponse().retrieveDataOwnerTypes(params, requestOptions).thenApply { it.parse() }

    override fun retrieveProviderMetadata(params: DataownerRetrieveProviderMetadataParams, requestOptions: RequestOptions): CompletableFuture<List<DataownerAbridged>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DataownerServiceAsync.WithRawResponse = DataownerServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val retrieveHandler: Handler<List<DataownerAbridged>> = jsonHandler<List<DataownerAbridged>>(clientOptions.jsonMapper)

        override fun retrieve(params: DataownerRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<DataownerAbridged>>> {
        ...
        override fun count(params: DataownerCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: DataownerQueryHelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<DataownerQueryHelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun retrieveDataOwnerTypes(params: DataownerRetrieveDataOwnerTypesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<String>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun retrieveProviderMetadata(params: DataownerRetrieveProviderMetadataParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<DataownerAbridged>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
