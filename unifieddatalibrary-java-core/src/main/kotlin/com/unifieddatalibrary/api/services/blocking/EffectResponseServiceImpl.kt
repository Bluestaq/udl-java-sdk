...
class EffectResponseServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : EffectResponseService {

    private val withRawResponse: EffectResponseService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): EffectResponseService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EffectResponseService = EffectResponseServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: EffectResponseRetrieveParams, requestOptions: RequestOptions): EffectResponseRetrieveResponse =
        // get /udl/effectresponse/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: EffectResponseListParams, requestOptions: RequestOptions): EffectResponseListPage =
    ...
    override fun createBulk(params: EffectResponseCreateBulkParams, requestOptions: RequestOptions) {
      // post /udl/effectresponse/createBulk
      withRawResponse().createBulk(params, requestOptions)
    }

    override fun queryHelp(params: EffectResponseQueryHelpParams, requestOptions: RequestOptions): EffectResponseQueryHelpResponse =
        // get /udl/effectresponse/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: EffectResponseTupleParams, requestOptions: RequestOptions): List<EffectResponseTupleResponse> =
        // get /udl/effectresponse/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: EffectResponseUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EffectResponseService.WithRawResponse = EffectResponseServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: EffectResponseCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: EffectResponseRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<EffectResponseRetrieveResponse> {
        ...
        override fun list(params: EffectResponseListParams, requestOptions: RequestOptions): HttpResponseFor<EffectResponseListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "effectresponse")
        ...
        override fun count(params: EffectResponseCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: EffectResponseCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: EffectResponseQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<EffectResponseQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: EffectResponseTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<EffectResponseTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: EffectResponseUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
