...
interface OperatingunitService {
     ...
     * team for assistance.
     */
    fun create(params: OperatingunitCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: OperatingunitUpdateParams) = update(params, RequestOptions.none())
    ...
    fun list(
        params: OperatingunitListParams = OperatingunitListParams.none()
    ): OperatingunitListPage = list(params, RequestOptions.none())
     ...
     */
    fun delete(id: String) = delete(id, OperatingunitDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: OperatingunitDeleteParams) = delete(params, RequestOptions.none())
     ...
     */
    fun get(id: String): OperatingunitFull = get(id, OperatingunitGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): OperatingunitFull = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: OperatingunitGetParams = OperatingunitGetParams.none(),
    ): OperatingunitFull = get(id, params, RequestOptions.none())
    ...
    /** @see get */
    fun get(params: OperatingunitGetParams): OperatingunitFull = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: OperatingunitQueryhelpParams = OperatingunitQueryhelpParams.none()
    ): OperatingunitQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [OperatingunitService.update].
         */
        @MustBeClosed
        ...
        fun list(
            params: OperatingunitListParams = OperatingunitListParams.none()
        ): HttpResponseFor<OperatingunitListPage> = list(params, RequestOptions.none())
         ...
         * same as [OperatingunitService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, OperatingunitDeleteParams.none())
         ...
         * as [OperatingunitService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(OperatingunitCountParams.none())
        ...
        fun get(
            id: String,
            params: OperatingunitGetParams = OperatingunitGetParams.none(),
        ): HttpResponseFor<OperatingunitFull> = get(id, params, RequestOptions.none())
         ...
         * same as [OperatingunitService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<OperatingunitQueryhelpResponse> =
