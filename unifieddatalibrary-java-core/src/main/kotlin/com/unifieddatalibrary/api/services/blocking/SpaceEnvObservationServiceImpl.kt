...
class SpaceEnvObservationServiceImpl
internal constructor(private val clientOptions: ClientOptions) : SpaceEnvObservationService {

    private val withRawResponse: SpaceEnvObservationService.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        SpaceEnvObservationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SpaceEnvObservationServiceImpl.WithRawResponseImpl(
