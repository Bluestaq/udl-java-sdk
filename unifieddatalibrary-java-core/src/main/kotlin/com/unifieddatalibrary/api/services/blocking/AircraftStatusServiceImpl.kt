...
class AircraftStatusServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AircraftStatusService {

    private val withRawResponse: AircraftStatusService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): AircraftStatusService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AircraftStatusService = AircraftStatusServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: AircraftStatusRetrieveParams, requestOptions: RequestOptions): AircraftstatusFull =
    ...
    override fun list(params: AircraftStatusListParams, requestOptions: RequestOptions): AircraftStatusListPage =
    ...
    override fun queryhelp(params: AircraftStatusQueryhelpParams, requestOptions: RequestOptions): AircraftStatusQueryhelpResponse =
        // get /udl/aircraftstatus/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: AircraftStatusTupleParams, requestOptions: RequestOptions): List<AircraftstatusFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AircraftStatusService.WithRawResponse = AircraftStatusServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: AircraftStatusCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: AircraftStatusRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<AircraftstatusFull> {
        ...
        override fun update(params: AircraftStatusUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun list(params: AircraftStatusListParams, requestOptions: RequestOptions): HttpResponseFor<AircraftStatusListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "aircraftstatus")
        ...
        override fun delete(params: AircraftStatusDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun count(params: AircraftStatusCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryhelp(params: AircraftStatusQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<AircraftStatusQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: AircraftStatusTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<AircraftstatusFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
