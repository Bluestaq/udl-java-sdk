...
interface AirloadPlanServiceAsync {
    ...
    fun retrieve(
        id: String,
        params: AirloadPlanRetrieveParams = AirloadPlanRetrieveParams.none(),
    ): CompletableFuture<AirloadplanFull> = retrieve(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<AirloadPlanQueryhelpResponse> =
    ...
    fun queryhelp(
        params: AirloadPlanQueryhelpParams = AirloadPlanQueryhelpParams.none()
    ): CompletableFuture<AirloadPlanQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [AirloadPlanServiceAsync.count].
         */
         ...
         * same as [AirloadPlanServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<AirloadPlanQueryhelpResponse>> =
            queryhelp(AirloadPlanQueryhelpParams.none())
         ...
         * as [AirloadPlanServiceAsync.tuple].
         */
        fun tuple(
            params: AirloadPlanTupleParams
