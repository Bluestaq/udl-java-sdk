...
internal constructor(private val clientOptions: ClientOptions) : OperatingunitremarkService {
    ...
    private val withRawResponse: OperatingunitremarkService.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        OperatingunitremarkServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        params: OperatingunitremarkListParams,
    ...
    override fun count(
        params: OperatingunitremarkCountParams,
        requestOptions: RequestOptions,
    ): String =
    ...
    override fun queryhelp(
        params: OperatingunitremarkQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OperatingunitremarkServiceImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<OperatingunitremarkListResponse>> =
            jsonHandler<List<OperatingunitremarkListResponse>>(clientOptions.jsonMapper)

        override fun list(
            params: OperatingunitremarkListParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<OperatingunitremarkListPage> {
            val request =
                HttpRequest.builder()
        ...
        private val getHandler: Handler<OperatingUnitRemarkFull> =
            jsonHandler<OperatingUnitRemarkFull>(clientOptions.jsonMapper)

        override fun get(
            params: OperatingunitremarkGetParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<OperatingUnitRemarkFull> {
        ...
        private val queryhelpHandler: Handler<OperatingunitremarkQueryhelpResponse> =
            jsonHandler<OperatingunitremarkQueryhelpResponse>(clientOptions.jsonMapper)

        override fun queryhelp(
            params: OperatingunitremarkQueryhelpParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<OperatingunitremarkQueryhelpResponse> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        private val tupleHandler: Handler<List<OperatingUnitRemarkFull>> =
            jsonHandler<List<OperatingUnitRemarkFull>>(clientOptions.jsonMapper)

        override fun tuple(
            params: OperatingunitremarkTupleParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<List<OperatingUnitRemarkFull>> {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
