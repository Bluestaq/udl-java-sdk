...
interface SarObservationService {
    ...
    /**
     * Service operation to take a single SAR observation as a POST body and ingest into the
     ...
     */
    fun create(params: SarObservationCreateParams) = create(params, RequestOptions.none())
     ...
     * information.
     */
    fun count(params: SarObservationCountParams): String = count(params, RequestOptions.none())
    ...
    /**
     * Service operation intended for initial integration only, to take a list of SAR observations
    ...
    /** @see createBulk */
    fun createBulk(
        body: List<SarObservationCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) = createBulk(SarObservationCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<SarObservationCreateBulkParams.Body>) =
        createBulk(body, RequestOptions.none())

    /**
     * Service operation to get a single SAR observations by its unique ID passed as a path
     * parameter.
     */
    fun get(id: String): SarObservationGetResponse = get(id, SarObservationGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: SarObservationGetParams = SarObservationGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SarObservationGetResponse = get(params.toBuilder().id(id).build(), requestOptions)

    /** @see get */
    fun get(
        id: String,
        params: SarObservationGetParams = SarObservationGetParams.none(),
    ): SarObservationGetResponse = get(id, params, RequestOptions.none())
    ...
    fun get(id: String, requestOptions: RequestOptions): SarObservationGetResponse =
        get(id, SarObservationGetParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): SarObservationQueryhelpResponse =
        queryhelp(SarObservationQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: SarObservationQueryhelpParams = SarObservationQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: SarObservationQueryhelpParams = SarObservationQueryhelpParams.none()
    ): SarObservationQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): SarObservationQueryhelpResponse =
        queryhelp(SarObservationQueryhelpParams.none(), requestOptions)
    ...
    /**
     * Service operation to take SAR observations as a POST body and ingest into the database. This
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<SarObservationUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            SarObservationUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<SarObservationUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/sarobservation`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sarobservation`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sarobservation/count`, but is otherwise the
         * same as [SarObservationService.count].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /udl/sarobservation/createBulk`, but is otherwise
         * the same as [SarObservationService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<SarObservationCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/sarobservation/{id}`, but is otherwise the same
         * as [SarObservationService.get].
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<SarObservationGetResponse> =
            get(id, SarObservationGetParams.none())
        ...
        fun get(
            id: String,
            params: SarObservationGetParams = SarObservationGetParams.none(),
        ): HttpResponseFor<SarObservationGetResponse> = get(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sarobservation/queryhelp`, but is otherwise the
         * same as [SarObservationService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SarObservationQueryhelpResponse> =
            queryhelp(SarObservationQueryhelpParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/sarobservation/tuple`, but is otherwise the
         * same as [SarObservationService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: SarObservationTupleParams
        ): HttpResponseFor<List<SarObservationTupleResponse>> = tuple(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-sar`, but is otherwise the same as
