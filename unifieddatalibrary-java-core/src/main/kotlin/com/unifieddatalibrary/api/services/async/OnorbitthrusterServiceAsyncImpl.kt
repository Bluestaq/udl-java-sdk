...
class OnorbitthrusterServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : OnorbitthrusterServiceAsync {

    private val withRawResponse: OnorbitthrusterServiceAsync.WithRawResponse by lazy {
    ...
    override fun withOptions(
        ...
        OnorbitthrusterServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            OnorbitthrusterServiceAsyncImpl.WithRawResponseImpl(
