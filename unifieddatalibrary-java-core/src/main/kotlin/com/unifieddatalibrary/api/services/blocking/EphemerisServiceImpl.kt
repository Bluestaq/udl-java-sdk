...
class EphemerisServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : EphemerisService {

    private val withRawResponse: EphemerisService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EphemerisService = EphemerisServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun attitudeData(): AttitudeDataService = attitudeData

    override fun history(): HistoryService = history

    override fun list(params: EphemerisListParams, requestOptions: RequestOptions): EphemerisListPage =
        // get /udl/ephemeris
    ...
    override fun queryhelp(params: EphemerisQueryhelpParams, requestOptions: RequestOptions): EphemerisQueryhelpResponse =
        // get /udl/ephemeris/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: EphemerisTupleParams, requestOptions: RequestOptions): List<EphemerisFull> =
        // get /udl/ephemeris/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: EphemerisUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EphemerisService.WithRawResponse = EphemerisServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: EphemerisListParams, requestOptions: RequestOptions): HttpResponseFor<EphemerisListPage> {
        ...
        override fun count(params: EphemerisCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun fileUpload(params: EphemerisFileUploadParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: EphemerisQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<EphemerisQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: EphemerisTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<EphemerisFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: EphemerisUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
