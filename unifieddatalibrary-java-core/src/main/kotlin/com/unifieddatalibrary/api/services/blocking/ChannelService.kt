...
interface ChannelService {
     ...
     * assistance.
     */
    fun create(params: ChannelCreateParams) = create(params, RequestOptions.none())
     ...
     */
    fun retrieve(id: String): ChannelFull = retrieve(id, ChannelRetrieveParams.none())
    ...
    ): ChannelFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: ChannelRetrieveParams = ChannelRetrieveParams.none(),
    ): ChannelFull = retrieve(id, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: ChannelUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, ChannelDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: ChannelDeleteParams) = delete(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: ChannelQueryhelpParams = ChannelQueryhelpParams.none()
    ): ChannelQueryhelpResponse = queryhelp(params, RequestOptions.none())
     ...
     */
    fun tuple(params: ChannelTupleParams): List<ChannelFull> = tuple(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun retrieve(
            id: String,
            params: ChannelRetrieveParams = ChannelRetrieveParams.none(),
        ): HttpResponseFor<ChannelFull> = retrieve(id, params, RequestOptions.none())
         ...
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, ChannelDeleteParams.none())
         ...
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(ChannelCountParams.none())
         ...
         * as [ChannelService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<ChannelQueryhelpResponse> =
        ...
        fun queryhelp(
            params: ChannelQueryhelpParams = ChannelQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<ChannelQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: ChannelQueryhelpParams = ChannelQueryhelpParams.none()
        ): HttpResponseFor<ChannelQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: ChannelTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<ChannelFull>>
    }
}
