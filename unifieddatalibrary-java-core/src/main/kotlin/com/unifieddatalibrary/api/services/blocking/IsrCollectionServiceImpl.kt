...
class IsrCollectionServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : IsrCollectionService {

    private val withRawResponse: IsrCollectionService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): IsrCollectionService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): IsrCollectionService = IsrCollectionServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryService = history

    override fun list(params: IsrCollectionListParams, requestOptions: RequestOptions): IsrCollectionListPage =
    ...
    override fun queryhelp(params: IsrCollectionQueryhelpParams, requestOptions: RequestOptions): IsrCollectionQueryhelpResponse =
        // get /udl/isrcollection/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: IsrCollectionTupleParams, requestOptions: RequestOptions): List<IsrCollectionTupleResponse> =
        // get /udl/isrcollection/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: IsrCollectionUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): IsrCollectionService.WithRawResponse = IsrCollectionServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: IsrCollectionListParams, requestOptions: RequestOptions): HttpResponseFor<IsrCollectionListPage> {
        ...
        override fun count(params: IsrCollectionCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: IsrCollectionCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
        ...
        override fun queryhelp(params: IsrCollectionQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<IsrCollectionQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: IsrCollectionTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<IsrCollectionTupleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: IsrCollectionUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
