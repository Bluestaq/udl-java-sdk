...
interface StageService {
     ...
     */
    fun create(params: StageCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: StageUpdateParams) = update(params, RequestOptions.none())
     ...
     * particular source. A vehicle may have multiple stage records.
     */
    fun delete(id: String) = delete(id, StageDeleteParams.none())
     ...
     */
    fun get(id: String): StageGetResponse = get(id, StageGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): StageGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: StageGetParams): StageGetResponse = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: StageQueryhelpParams = StageQueryhelpParams.none()
    ): StageQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: StageCreateParams): HttpResponse = create(params, RequestOptions.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: StageUpdateParams): HttpResponse = update(params, RequestOptions.none())
         ...
         * [StageService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<StageListPage> = list(StageListParams.none())
         ...
         * [StageService.delete].
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, StageDeleteParams.none())
         ...
         * [StageService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(StageCountParams.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<StageGetResponse> = get(id, StageGetParams.none())
        ...
        fun get(
            ...
            params: StageGetParams = StageGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<StageGetResponse> =
        ...
        fun get(
            id: String,
            params: StageGetParams = StageGetParams.none(),
        ): HttpResponseFor<StageGetResponse> = get(id, params, RequestOptions.none())
         ...
         * [StageService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<StageQueryhelpResponse> =
        ...
        fun queryhelp(
            params: StageQueryhelpParams = StageQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<StageQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: StageQueryhelpParams = StageQueryhelpParams.none()
        ): HttpResponseFor<StageQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        fun tuple(
            params: StageTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<StageTupleResponse>>
    }
}
