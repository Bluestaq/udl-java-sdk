...
interface CountryService {
    ...
    /**
     * Service operation to get a single Country record by its unique code passed as a path
     * parameter.
     */
    fun retrieve(code: String): CountryFull = retrieve(code, CountryRetrieveParams.none())
    ...
    ): CountryFull = retrieve(params.toBuilder().code(code).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        code: String,
        params: CountryRetrieveParams = CountryRetrieveParams.none(),
    ): CountryFull = retrieve(code, params, RequestOptions.none())
    ...
    fun retrieve(code: String, requestOptions: RequestOptions): CountryFull =
        retrieve(code, CountryRetrieveParams.none(), requestOptions)

    /**
     * Service operation to update a single Country. A specific role is required to perform this
     * service operation. Please contact the UDL team for assistance.
     */
    fun update(pathCode: String, params: CountryUpdateParams) =
        update(pathCode, params, RequestOptions.none())
    ...
    /**
     * Service operation to delete a Country object specified by the passed code path parameter. A
     * specific role is required to perform this service operation. Please contact the UDL team for
     * assistance.
     */
    fun delete(code: String) = delete(code, CountryDeleteParams.none())
    ...
    fun delete(code: String, params: CountryDeleteParams = CountryDeleteParams.none()) =
        delete(code, params, RequestOptions.none())
    ...
    fun delete(code: String, requestOptions: RequestOptions) =
        delete(code, CountryDeleteParams.none(), requestOptions)
     ...
     */
    fun tuple(params: CountryTupleParams): List<CountryFull> = tuple(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/country`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/country/{code}`, but is otherwise the same as
         * [CountryService.retrieve].
         */
        @MustBeClosed
        fun retrieve(code: String): HttpResponseFor<CountryFull> =
            retrieve(code, CountryRetrieveParams.none())
        ...
        fun retrieve(
            code: String,
            params: CountryRetrieveParams = CountryRetrieveParams.none(),
        ): HttpResponseFor<CountryFull> = retrieve(code, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `put /udl/country/{code}`, but is otherwise the same as
        ...
        fun update(
            ...
            params: CountryUpdateParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponse = update(params.toBuilder().pathCode(pathCode).build(), requestOptions)
        ...
        /**
         * Returns a raw HTTP response for `get /udl/country`, but is otherwise the same as
         * [CountryService.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/country/{code}`, but is otherwise the same
         * as [CountryService.delete].
         */
        @MustBeClosed
        fun delete(code: String): HttpResponse = delete(code, CountryDeleteParams.none())
        ...
        fun delete(
            code: String,
            params: CountryDeleteParams = CountryDeleteParams.none(),
        ): HttpResponse = delete(code, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/country/count`, but is otherwise the same as
         * [CountryService.count].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /udl/country/queryhelp`, but is otherwise the same
         * as [CountryService.queryhelp].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/country/tuple`, but is otherwise the same as
        ...
        fun tuple(
            params: CountryTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<CountryFull>>
    }
}
