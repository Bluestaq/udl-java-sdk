...
package com.unifieddatalibrary.api.services.async.laserdeconflictrequest
...
import com.unifieddatalibrary.api.models.laserdeconflictrequest.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.laserdeconflictrequest.history.HistoryCountParams
import com.unifieddatalibrary.api.models.laserdeconflictrequest.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.laserdeconflictrequest.history.HistoryListParams
...
class HistoryServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(
        ...
        // get /udl/laserdeconflictrequest/history
    ...
    override fun aodr(
        ...
        // get /udl/laserdeconflictrequest/history/aodr
    ...
    override fun count(
        ...
        // get /udl/laserdeconflictrequest/history/count
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("udl", "laserdeconflictrequest", "history")
                    .build()
        ...
        override fun aodr(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "laserdeconflictrequest", "history", "aodr")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
        ...
        override fun count(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("udl", "laserdeconflictrequest", "history", "count")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
