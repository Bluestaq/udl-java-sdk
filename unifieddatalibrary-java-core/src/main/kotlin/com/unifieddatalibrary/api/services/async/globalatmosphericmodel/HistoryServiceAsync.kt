...
package com.unifieddatalibrary.api.services.async.globalatmosphericmodel
...
interface HistoryServiceAsync {
    ...
    /** @see writeAodr */
    fun writeAodr(params: HistoryWriteAodrParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history/count`, but is otherwise the same as [HistoryServiceAsync.count]. */
        ...
        /** Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history`, but is otherwise the same as [HistoryServiceAsync.query]. */
        ...
        /** Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history/aodr`, but is otherwise the same as [HistoryServiceAsync.writeAodr]. */
        ...
        /** @see writeAodr */
        fun writeAodr(params: HistoryWriteAodrParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
