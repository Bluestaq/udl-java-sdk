...
interface HistoryServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history/count`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history`, but is
         * otherwise the same as [HistoryServiceAsync.query].
         */
        fun query(
            params: HistoryQueryParams
        ...
        /**
         * Returns a raw HTTP response for `get /udl/globalatmosphericmodel/history/aodr`, but is
