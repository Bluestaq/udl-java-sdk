...
class SortiePprServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SortiePprService {

    private val withRawResponse: SortiePprService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryService by lazy { HistoryServiceImpl(clientOptions) }

    override fun withRawResponse(): SortiePprService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SortiePprService = SortiePprServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: SortiePprListParams, requestOptions: RequestOptions): SortiePprListPage =
        // get /udl/sortieppr
    ...
    override fun queryhelp(params: SortiePprQueryhelpParams, requestOptions: RequestOptions): SortiePprQueryhelpResponse =
        // get /udl/sortieppr/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: SortiePprTupleParams, requestOptions: RequestOptions): List<SortiePprFull> =
        // get /udl/sortieppr/tuple
        withRawResponse().tuple(params, requestOptions).parse()

    override fun unvalidatedPublish(params: SortiePprUnvalidatedPublishParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SortiePprService.WithRawResponse = SortiePprServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun history(): HistoryService.WithRawResponse = history

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: SortiePprCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: SortiePprUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: SortiePprListParams, requestOptions: RequestOptions): HttpResponseFor<SortiePprListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: SortiePprDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: SortiePprCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: SortiePprCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: SortiePprGetParams, requestOptions: RequestOptions): HttpResponseFor<SortiePprFull> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: SortiePprQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<SortiePprQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: SortiePprTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<SortiePprFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun unvalidatedPublish(params: SortiePprUnvalidatedPublishParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
