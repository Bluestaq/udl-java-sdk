...
class VesselServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: VesselService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): VesselService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): VesselService =
        VesselServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            VesselServiceImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<VesselListResponse>> =
            jsonHandler<List<VesselListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<VesselGetResponse> =
            jsonHandler<VesselGetResponse>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<VesselQueryhelpResponse> =
            jsonHandler<VesselQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<VesselTupleResponse>> =
            jsonHandler<List<VesselTupleResponse>>(clientOptions.jsonMapper)
