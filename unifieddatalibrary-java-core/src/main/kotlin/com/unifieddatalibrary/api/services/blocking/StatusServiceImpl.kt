...
class StatusServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : StatusService {

    private val withRawResponse: StatusService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): StatusService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): StatusService = StatusServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun getByEntityId(params: StatusGetByEntityIdParams, requestOptions: RequestOptions): List<StatusFull> =
        // get /udl/status/byIdEntity/{idEntity}
        withRawResponse().getByEntityId(params, requestOptions).parse()

    override fun getByEntityType(params: StatusGetByEntityTypeParams, requestOptions: RequestOptions): List<StatusFull> =
        // get /udl/status/byEntityType/{entityType}
        withRawResponse().getByEntityType(params, requestOptions).parse()

    override fun queryhelp(params: StatusQueryhelpParams, requestOptions: RequestOptions): StatusQueryhelpResponse =
        // get /udl/status/queryhelp
        withRawResponse().queryhelp(params, requestOptions).parse()

    override fun tuple(params: StatusTupleParams, requestOptions: RequestOptions): List<StatusFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): StatusService.WithRawResponse = StatusServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: StatusCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: StatusUpdateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: StatusListParams, requestOptions: RequestOptions): HttpResponseFor<StatusListPage> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: StatusDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun count(params: StatusCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: StatusGetParams, requestOptions: RequestOptions): HttpResponseFor<StatusFull> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun getByEntityId(params: StatusGetByEntityIdParams, requestOptions: RequestOptions): HttpResponseFor<List<StatusFull>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun getByEntityType(params: StatusGetByEntityTypeParams, requestOptions: RequestOptions): HttpResponseFor<List<StatusFull>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun queryhelp(params: StatusQueryhelpParams, requestOptions: RequestOptions): HttpResponseFor<StatusQueryhelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: StatusTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<StatusFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
