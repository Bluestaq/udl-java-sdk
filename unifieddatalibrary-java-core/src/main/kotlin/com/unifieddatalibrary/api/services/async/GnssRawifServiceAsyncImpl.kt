...
class GnssRawIfServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : GnssRawIfServiceAsync {

    private val withRawResponse: GnssRawIfServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val history: HistoryServiceAsync by lazy { HistoryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): GnssRawIfServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GnssRawIfServiceAsync = GnssRawIfServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun history(): HistoryServiceAsync = history

    override fun list(params: GnssRawIfListParams, requestOptions: RequestOptions): CompletableFuture<GnssRawIfListPageAsync> =
        // get /udl/gnssrawif
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun count(params: GnssRawIfCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/gnssrawif/count
        withRawResponse().count(params, requestOptions).thenApply { it.parse() }

    override fun fileGet(params: GnssRawIfFileGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> =
        // get /udl/gnssrawif/getFile/{id}
        withRawResponse().fileGet(params, requestOptions)

    override fun get(params: GnssRawIfGetParams, requestOptions: RequestOptions): CompletableFuture<GnssRawIfGetResponse> =
        // get /udl/gnssrawif/{id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun queryhelp(params: GnssRawIfQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<GnssRawIfQueryhelpResponse> =
        // get /udl/gnssrawif/queryhelp
        withRawResponse().queryhelp(params, requestOptions).thenApply { it.parse() }

    override fun tuple(params: GnssRawIfTupleParams, requestOptions: RequestOptions): CompletableFuture<List<GnssRawIfTupleResponse>> =
        // get /udl/gnssrawif/tuple
        withRawResponse().tuple(params, requestOptions).thenApply { it.parse() }

    override fun uploadZip(params: GnssRawIfUploadZipParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GnssRawIfServiceAsync.WithRawResponse = GnssRawIfServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: GnssRawIfListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<GnssRawIfListPageAsync>> {
        ...
        override fun count(params: GnssRawIfCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun get(params: GnssRawIfGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<GnssRawIfGetResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun queryhelp(params: GnssRawIfQueryhelpParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<GnssRawIfQueryhelpResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: GnssRawIfTupleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<GnssRawIfTupleResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun uploadZip(params: GnssRawIfUploadZipParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
