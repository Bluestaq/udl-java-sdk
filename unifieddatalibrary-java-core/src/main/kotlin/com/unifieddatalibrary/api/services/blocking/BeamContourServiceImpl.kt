...
class BeamContourServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BeamContourService {

    private val withRawResponse: BeamContourService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BeamContourService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BeamContourService = BeamContourServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: BeamContourRetrieveParams, requestOptions: RequestOptions): BeamcontourFull =
    ...
    override fun list(params: BeamContourListParams, requestOptions: RequestOptions): BeamContourListPage =
        // get /udl/beamcontour
    ...
    override fun queryHelp(params: BeamContourQueryHelpParams, requestOptions: RequestOptions): BeamContourQueryHelpResponse =
        // get /udl/beamcontour/queryhelp
        withRawResponse().queryHelp(params, requestOptions).parse()

    override fun tuple(params: BeamContourTupleParams, requestOptions: RequestOptions): List<BeamcontourFull> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BeamContourService.WithRawResponse = BeamContourServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: BeamContourCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: BeamContourRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<BeamcontourFull> {
        ...
        override fun update(params: BeamContourUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override fun list(params: BeamContourListParams, requestOptions: RequestOptions): HttpResponseFor<BeamContourListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "beamcontour")
        ...
        override fun delete(params: BeamContourDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun count(params: BeamContourCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createBulk(params: BeamContourCreateBulkParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun queryHelp(params: BeamContourQueryHelpParams, requestOptions: RequestOptions): HttpResponseFor<BeamContourQueryHelpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun tuple(params: BeamContourTupleParams, requestOptions: RequestOptions): HttpResponseFor<List<BeamcontourFull>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
