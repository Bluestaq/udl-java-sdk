...
package com.unifieddatalibrary.api.services.blocking.collectrequests
...
import com.unifieddatalibrary.api.models.collectrequests.history.HistoryListPage
...
interface HistoryService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /udl/collectrequest/history`, but is otherwise the same as [HistoryService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/collectrequest/history/aodr`, but is otherwise the same as [HistoryService.aodr]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /udl/collectrequest/history/count`, but is otherwise the same as [HistoryService.count]. */
        @MustBeClosed
