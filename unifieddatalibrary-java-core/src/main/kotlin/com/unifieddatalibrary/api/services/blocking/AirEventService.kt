...
interface AirEventService {
    ...
    /**
     * Service operation to take a single airevent object as a POST body and ingest into the
     * database. A specific role is required to perform this service operation. Please contact the
     * UDL team for assistance.
     */
    fun create(params: AirEventCreateParams) = create(params, RequestOptions.none())

    /** @see create */
    fun create(params: AirEventCreateParams, requestOptions: RequestOptions = RequestOptions.none())

    /**
     * Service operation to update a single airevent record. A specific role is required to perform
    ...
    /** @see update */
    fun update(params: AirEventUpdateParams) = update(params, RequestOptions.none())
    ...
    /** @see list */
    fun list(
        params: AirEventListParams = AirEventListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirEventListPage
    ...
    fun list(requestOptions: RequestOptions): AirEventListPage =
        list(AirEventListParams.none(), requestOptions)
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, AirEventDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: AirEventDeleteParams = AirEventDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    /** @see delete */
    fun delete(params: AirEventDeleteParams) = delete(params, RequestOptions.none())

    /** @see delete */
    fun delete(id: String, requestOptions: RequestOptions) =
        delete(id, AirEventDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: AirEventCountParams = AirEventCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): String
    ...
    fun count(requestOptions: RequestOptions): String =
        count(AirEventCountParams.none(), requestOptions)
     ...
     * ingest into the database. This operation is not intended to be used for automated feeds into
     * UDL. Data providers should contact the UDL team for specific role assignments and for
     * instructions on setting up a permanent feed through an alternate mechanism.
     */
    fun createBulk(params: AirEventCreateBulkParams) = createBulk(params, RequestOptions.none())
     ...
     * parameter.
     */
    fun get(id: String): AirEventGetResponse = get(id, AirEventGetParams.none())

    /** @see get */
    fun get(
        id: String,
        params: AirEventGetParams = AirEventGetParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirEventGetResponse = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: AirEventGetParams): AirEventGetResponse = get(params, RequestOptions.none())

    /** @see get */
    fun get(id: String, requestOptions: RequestOptions): AirEventGetResponse =
        get(id, AirEventGetParams.none(), requestOptions)
    ...
    /** @see queryhelp */
    fun queryhelp(
        params: AirEventQueryhelpParams = AirEventQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: AirEventQueryhelpParams = AirEventQueryhelpParams.none()
    ): AirEventQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): AirEventQueryhelpResponse =
        queryhelp(AirEventQueryhelpParams.none(), requestOptions)
    ...
    /**
     * Service operation to take multiple airevent records as a POST body and ingest into the
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/airevent`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `put /udl/airevent/{id}`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airevent`, but is otherwise the same as
         * [AirEventService.list].
         */
        @MustBeClosed
        ...
        fun list(
            params: AirEventListParams = AirEventListParams.none()
        ): HttpResponseFor<AirEventListPage> = list(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/airevent/{id}`, but is otherwise the same as
         * [AirEventService.delete].
         */
        @MustBeClosed fun delete(id: String): HttpResponse = delete(id, AirEventDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airevent/count`, but is otherwise the same as
         * [AirEventService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(AirEventCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `post /udl/airevent/createBulk`, but is otherwise the
         * same as [AirEventService.createBulk].
         */
        @MustBeClosed
        ...
        fun get(
            id: String,
            params: AirEventGetParams = AirEventGetParams.none(),
        ): HttpResponseFor<AirEventGetResponse> = get(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airevent/queryhelp`, but is otherwise the same
         * as [AirEventService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AirEventQueryhelpResponse> =
            queryhelp(AirEventQueryhelpParams.none())
        ...
        fun queryhelp(
            params: AirEventQueryhelpParams = AirEventQueryhelpParams.none()
        ): HttpResponseFor<AirEventQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airevent/tuple`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `post /filedrop/udl-airevent`, but is otherwise the same
         * as [AirEventService.unvalidatedPublish].
         */
        @MustBeClosed
