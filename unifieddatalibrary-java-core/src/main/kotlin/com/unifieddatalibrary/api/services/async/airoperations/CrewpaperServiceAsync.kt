...
interface CrewpaperServiceAsync {
    ...
    /** @see unpublish */
    fun unpublish(params: CrewpaperUnpublishParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see uploadPdf */
    fun uploadPdf(fileContent: String, params: CrewpaperUploadPdfParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?> =
        uploadPdf(
          params.toBuilder()
    ...
    /** @see uploadPdf */
    fun uploadPdf(params: CrewpaperUploadPdfParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): CrewpaperServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /udl/crewpapers/unpublish`, but is otherwise the same as [CrewpaperServiceAsync.unpublish]. */
        ...
        /** @see unpublish */
        fun unpublish(params: CrewpaperUnpublishParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /filedrop/crewpapers`, but is otherwise the same as [CrewpaperServiceAsync.uploadPdf]. */
        fun uploadPdf(fileContent: String, params: CrewpaperUploadPdfParams): CompletableFuture<HttpResponse> =
            uploadPdf(
              fileContent,
              params,
              RequestOptions.none(),
        ...
        /** @see uploadPdf */
        fun uploadPdf(fileContent: String, params: CrewpaperUploadPdfParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse> =
            uploadPdf(
              params.toBuilder()
                  .fileContent(fileContent)
                  .build(), requestOptions
        ...
        /** @see uploadPdf */
        fun uploadPdf(params: CrewpaperUploadPdfParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
