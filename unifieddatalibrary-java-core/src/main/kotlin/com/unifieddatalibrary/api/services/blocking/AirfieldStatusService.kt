...
interface AirfieldStatusService {
    ...
    /**
     * Service operation to take a single airfield status record as a POST body and ingest into the
     ...
     */
    fun create(params: AirfieldStatusCreateParams) = create(params, RequestOptions.none())
    ...
    /**
     * Service operation to get a single airfield status record by its unique ID passed as a path
     * parameter.
     */
    fun retrieve(id: String): AirfieldstatusFull = retrieve(id, AirfieldStatusRetrieveParams.none())

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirfieldStatusRetrieveParams = AirfieldStatusRetrieveParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): AirfieldstatusFull = retrieve(params.toBuilder().id(id).build(), requestOptions)

    /** @see retrieve */
    fun retrieve(
        id: String,
        params: AirfieldStatusRetrieveParams = AirfieldStatusRetrieveParams.none(),
    ): AirfieldstatusFull = retrieve(id, params, RequestOptions.none())
    ...
    fun retrieve(id: String, requestOptions: RequestOptions): AirfieldstatusFull =
        retrieve(id, AirfieldStatusRetrieveParams.none(), requestOptions)
    ...
    /** @see update */
    fun update(params: AirfieldStatusUpdateParams) = update(params, RequestOptions.none())
    ...
    /** @see list */
    fun list(
        params: AirfieldStatusListParams = AirfieldStatusListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun list(
        params: AirfieldStatusListParams = AirfieldStatusListParams.none()
    ): AirfieldStatusListPage = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): AirfieldStatusListPage =
        list(AirfieldStatusListParams.none(), requestOptions)
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, AirfieldStatusDeleteParams.none())

    /** @see delete */
    fun delete(
        id: String,
        params: AirfieldStatusDeleteParams = AirfieldStatusDeleteParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    /** @see delete */
    fun delete(params: AirfieldStatusDeleteParams) = delete(params, RequestOptions.none())

    /** @see delete */
    fun delete(id: String, requestOptions: RequestOptions) =
        delete(id, AirfieldStatusDeleteParams.none(), requestOptions)
    ...
    /** @see count */
    fun count(
        params: AirfieldStatusCountParams = AirfieldStatusCountParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): String
    ...
    fun count(requestOptions: RequestOptions): String =
        count(AirfieldStatusCountParams.none(), requestOptions)

    /**
     * Service operation to provide detailed information on available dynamic query parameters for a
     * particular data type.
     */
    fun queryhelp(): AirfieldStatusQueryhelpResponse =
        queryhelp(AirfieldStatusQueryhelpParams.none())

    /** @see queryhelp */
    fun queryhelp(
        params: AirfieldStatusQueryhelpParams = AirfieldStatusQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: AirfieldStatusQueryhelpParams = AirfieldStatusQueryhelpParams.none()
    ): AirfieldStatusQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): AirfieldStatusQueryhelpResponse =
        queryhelp(AirfieldStatusQueryhelpParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /udl/airfieldstatus`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfieldstatus/{id}`, but is otherwise the same
         * as [AirfieldStatusService.retrieve].
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<AirfieldstatusFull> =
            retrieve(id, AirfieldStatusRetrieveParams.none())
        ...
        fun retrieve(
            ...
            params: AirfieldStatusRetrieveParams = AirfieldStatusRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<AirfieldstatusFull> =
        ...
        fun retrieve(
            id: String,
            params: AirfieldStatusRetrieveParams = AirfieldStatusRetrieveParams.none(),
        ): HttpResponseFor<AirfieldstatusFull> = retrieve(id, params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `put /udl/airfieldstatus/{id}`, but is otherwise the same
         * as [AirfieldStatusService.update].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfieldstatus`, but is otherwise the same as
         * [AirfieldStatusService.list].
         */
        @MustBeClosed
        ...
        fun list(
            params: AirfieldStatusListParams = AirfieldStatusListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<AirfieldStatusListPage>

        /** @see list */
        @MustBeClosed
        fun list(
            params: AirfieldStatusListParams = AirfieldStatusListParams.none()
        ): HttpResponseFor<AirfieldStatusListPage> = list(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `delete /udl/airfieldstatus/{id}`, but is otherwise the
         * same as [AirfieldStatusService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, AirfieldStatusDeleteParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfieldstatus/count`, but is otherwise the
         * same as [AirfieldStatusService.count].
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(AirfieldStatusCountParams.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfieldstatus/queryhelp`, but is otherwise the
         * same as [AirfieldStatusService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<AirfieldStatusQueryhelpResponse> =
            queryhelp(AirfieldStatusQueryhelpParams.none())
        ...
        fun queryhelp(
            params: AirfieldStatusQueryhelpParams = AirfieldStatusQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<AirfieldStatusQueryhelpResponse>
        ...
        /**
         * Returns a raw HTTP response for `get /udl/airfieldstatus/tuple`, but is otherwise the
         * same as [AirfieldStatusService.tuple].
         */
        @MustBeClosed
        ...
        fun tuple(
            params: AirfieldStatusTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<AirfieldstatusFull>>
    }
}
