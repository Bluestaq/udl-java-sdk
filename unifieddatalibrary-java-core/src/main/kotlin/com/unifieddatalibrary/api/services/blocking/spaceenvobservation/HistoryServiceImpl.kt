...
package com.unifieddatalibrary.api.services.blocking.spaceenvobservation
...
import com.unifieddatalibrary.api.models.spaceenvobservation.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.spaceenvobservation.history.HistoryCountParams
import com.unifieddatalibrary.api.models.spaceenvobservation.history.HistoryListPage
import com.unifieddatalibrary.api.models.spaceenvobservation.history.HistoryListParams
...
class HistoryServiceImpl internal constructor(
    ...
    override fun count(params: HistoryCountParams, requestOptions: RequestOptions): String =
        // get /udl/spaceenvobservation/history/count
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val listHandler: Handler<List<SpaceEnvObservationFull>> = jsonHandler<List<SpaceEnvObservationFull>>(clientOptions.jsonMapper)

        override fun list(params: HistoryListParams, requestOptions: RequestOptions): HttpResponseFor<HistoryListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "spaceenvobservation", "history")
            .build()
        ...
        override fun aodr(params: HistoryAodrParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "spaceenvobservation", "history", "aodr")
            .build()
            .prepare(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun count(params: HistoryCountParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "spaceenvobservation", "history", "count")
            .build()
            .prepare(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
