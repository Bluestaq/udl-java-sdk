...
package com.unifieddatalibrary.api.services.async.observations.passiveradarobservation
...
import com.unifieddatalibrary.api.models.observations.passiveradarobservation.history.HistoryAodrParams
import com.unifieddatalibrary.api.models.observations.passiveradarobservation.history.HistoryCountParams
import com.unifieddatalibrary.api.models.observations.passiveradarobservation.history.HistoryListPage
import com.unifieddatalibrary.api.models.observations.passiveradarobservation.history.HistoryListPageAsync
import com.unifieddatalibrary.api.models.observations.passiveradarobservation.history.HistoryListParams
...
class HistoryServiceAsyncImpl internal constructor(
    ...
    override fun count(params: HistoryCountParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // get /udl/passiveradarobservation/history/count
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun list(params: HistoryListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<HistoryListPageAsync>> {
          val request = HttpRequest.builder()
            ...
            .addPathSegments("udl", "passiveradarobservation", "history")
            .build()
        ...
        override fun aodr(params: HistoryAodrParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "passiveradarobservation", "history", "aodr")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun count(params: HistoryCountParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("udl", "passiveradarobservation", "history", "count")
            .build()
            .prepareAsync(clientOptions, params)
          val requestOptions = requestOptions
              .applyDefaults(RequestOptions.from(clientOptions))
