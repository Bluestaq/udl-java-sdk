...
package com.unifieddatalibrary.api.services.blocking.trackdetails
...
import com.unifieddatalibrary.api.models.trackdetails.history.HistoryListPage
...
class HistoryServiceImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val listHandler: Handler<List<TrackDetailsFull>> = jsonHandler<List<TrackDetailsFull>>(clientOptions.jsonMapper)
