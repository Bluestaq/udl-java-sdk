...
class DatalinkServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    DatalinkServiceAsync {

    private val withRawResponse: DatalinkServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): DatalinkServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DatalinkServiceAsync =
        DatalinkServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            DatalinkServiceAsyncImpl.WithRawResponseImpl(
