...
interface MissileTrackService {
     ...
     */
    fun count(params: MissileTrackCountParams): String = count(params, RequestOptions.none())

    /** @see count */
    fun count(
        params: MissileTrackCountParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): String

    /**
     * Service operation intended for initial integration only, to take a list of MissileTrack
     ...
     * mechanism.
     */
    fun createBulk(params: MissileTrackCreateBulkParams) = createBulk(params, RequestOptions.none())

    /** @see createBulk */
    fun createBulk(
        params: MissileTrackCreateBulkParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    )

    /** @see createBulk */
    fun createBulk(
        body: List<MissileTrackCreateBulkParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) = createBulk(MissileTrackCreateBulkParams.builder().body(body).build(), requestOptions)

    /** @see createBulk */
    fun createBulk(body: List<MissileTrackCreateBulkParams.Body>) =
    ...
    /** @see queryhelp */
    fun queryhelp(
        params: MissileTrackQueryhelpParams = MissileTrackQueryhelpParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun queryhelp(
        params: MissileTrackQueryhelpParams = MissileTrackQueryhelpParams.none()
    ): MissileTrackQueryhelpResponse = queryhelp(params, RequestOptions.none())

    /** @see queryhelp */
    fun queryhelp(requestOptions: RequestOptions): MissileTrackQueryhelpResponse =
        queryhelp(MissileTrackQueryhelpParams.none(), requestOptions)
    ...
    /** @see tuple */
    fun tuple(
        params: MissileTrackTupleParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): List<MissileTrackTupleResponse>
    ...
    /** @see unvalidatedPublish */
    fun unvalidatedPublish(
        body: List<MissileTrackUnvalidatedPublishParams.Body>,
        requestOptions: RequestOptions = RequestOptions.none(),
    ) =
        unvalidatedPublish(
            MissileTrackUnvalidatedPublishParams.builder().body(body).build(),
            requestOptions,
        )

    /** @see unvalidatedPublish */
    fun unvalidatedPublish(body: List<MissileTrackUnvalidatedPublishParams.Body>) =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /udl/missiletrack`, but is otherwise the same as
         * [MissileTrackService.list].
         */
        @MustBeClosed
        ...
        fun list(
            params: MissileTrackListParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<MissileTrackListPage>

        /**
         * Returns a raw HTTP response for `get /udl/missiletrack/count`, but is otherwise the same
         * as [MissileTrackService.count].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /udl/missiletrack/createBulk`, but is otherwise the
         * same as [MissileTrackService.createBulk].
         */
        @MustBeClosed
        ...
        /** @see createBulk */
        @MustBeClosed
        fun createBulk(body: List<MissileTrackCreateBulkParams.Body>): HttpResponse =
            createBulk(body, RequestOptions.none())

        /**
         * Returns a raw HTTP response for `get /udl/missiletrack/queryhelp`, but is otherwise the
         * same as [MissileTrackService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<MissileTrackQueryhelpResponse> =
            queryhelp(MissileTrackQueryhelpParams.none())
        ...
        fun queryhelp(
            params: MissileTrackQueryhelpParams = MissileTrackQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<MissileTrackQueryhelpResponse>

        /** @see queryhelp */
        @MustBeClosed
        fun queryhelp(
            params: MissileTrackQueryhelpParams = MissileTrackQueryhelpParams.none()
        ): HttpResponseFor<MissileTrackQueryhelpResponse> = queryhelp(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `get /udl/missiletrack/tuple`, but is otherwise the same
         * as [MissileTrackService.tuple].
         */
        @MustBeClosed
        fun tuple(
            params: MissileTrackTupleParams
        ): HttpResponseFor<List<MissileTrackTupleResponse>> = tuple(params, RequestOptions.none())
        ...
        fun tuple(
            params: MissileTrackTupleParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<List<MissileTrackTupleResponse>>

        /**
         * Returns a raw HTTP response for `post /filedrop/udl-missiletrack`, but is otherwise the
         * same as [MissileTrackService.unvalidatedPublish].
         */
        @MustBeClosed
