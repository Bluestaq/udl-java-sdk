...
class BatterydetailServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    BatterydetailServiceAsync {

    private val withRawResponse: BatterydetailServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): BatterydetailServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BatterydetailServiceAsync =
        BatterydetailServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        params: BatterydetailListParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            BatterydetailServiceAsyncImpl.WithRawResponseImpl(
        ...
        private val retrieveHandler: Handler<BatterydetailsFull> =
            jsonHandler<BatterydetailsFull>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<List<BatterydetailsAbridged>> =
            jsonHandler<List<BatterydetailsAbridged>>(clientOptions.jsonMapper)
