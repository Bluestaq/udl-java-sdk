...
class ManifoldServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: ManifoldService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): ManifoldService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ManifoldService =
        ManifoldServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun queryhelp(
        params: ManifoldQueryhelpParams,
        requestOptions: RequestOptions,
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            ManifoldServiceImpl.WithRawResponseImpl(
        ...
        private val listHandler: Handler<List<ManifoldListResponse>> =
            jsonHandler<List<ManifoldListResponse>>(clientOptions.jsonMapper)
        ...
        private val getHandler: Handler<ManifoldGetResponse> =
            jsonHandler<ManifoldGetResponse>(clientOptions.jsonMapper)
        ...
        private val queryhelpHandler: Handler<ManifoldQueryhelpResponse> =
            jsonHandler<ManifoldQueryhelpResponse>(clientOptions.jsonMapper)
        ...
        private val tupleHandler: Handler<List<ManifoldTupleResponse>> =
            jsonHandler<List<ManifoldTupleResponse>>(clientOptions.jsonMapper)
