...
interface SolarArrayService {
     ...
     * assistance.
     */
    fun create(params: SolarArrayCreateParams) = create(params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: SolarArrayUpdateParams) = update(params, RequestOptions.none())
     ...
     * assistance.
     */
    fun delete(id: String) = delete(id, SolarArrayDeleteParams.none())
    ...
    /** @see delete */
    fun delete(params: SolarArrayDeleteParams) = delete(params, RequestOptions.none())
     ...
     * parameter.
     */
    fun get(id: String): SolarArrayFull = get(id, SolarArrayGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SolarArrayFull = get(params.toBuilder().id(id).build(), requestOptions)
    ...
    /** @see get */
    fun get(params: SolarArrayGetParams): SolarArrayFull = get(params, RequestOptions.none())
    ...
    fun queryhelp(
        params: SolarArrayQueryhelpParams = SolarArrayQueryhelpParams.none()
    ): SolarArrayQueryhelpResponse = queryhelp(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun list(
            params: SolarArrayListParams = SolarArrayListParams.none()
        ): HttpResponseFor<SolarArrayListPage> = list(params, RequestOptions.none())
         ...
         * as [SolarArrayService.delete].
         */
        @MustBeClosed
        fun delete(id: String): HttpResponse = delete(id, SolarArrayDeleteParams.none())
         ...
         */
        @MustBeClosed fun count(): HttpResponseFor<String> = count(SolarArrayCountParams.none())
         ...
         */
        @MustBeClosed
        fun get(id: String): HttpResponseFor<SolarArrayFull> = get(id, SolarArrayGetParams.none())
        ...
        fun get(
            ...
            params: SolarArrayGetParams = SolarArrayGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<SolarArrayFull> = get(params.toBuilder().id(id).build(), requestOptions)
        ...
        fun get(
            id: String,
            params: SolarArrayGetParams = SolarArrayGetParams.none(),
        ): HttpResponseFor<SolarArrayFull> = get(id, params, RequestOptions.none())
         ...
         * same as [SolarArrayService.queryhelp].
         */
        @MustBeClosed
        fun queryhelp(): HttpResponseFor<SolarArrayQueryhelpResponse> =
        ...
        fun queryhelp(
            params: SolarArrayQueryhelpParams = SolarArrayQueryhelpParams.none()
        ): HttpResponseFor<SolarArrayQueryhelpResponse> = queryhelp(params, RequestOptions.none())
