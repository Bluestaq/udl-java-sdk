...
interface OnorbitlistServiceAsync {
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OnorbitlistListPageAsync>

    /** @see list */
    fun list(
        params: OnorbitlistListParams = OnorbitlistListParams.none()
    ): CompletableFuture<OnorbitlistListPageAsync> = list(params, RequestOptions.none())
     ...
     * perform this service operation. Please contact the UDL team for assistance.
     */
    fun delete(id: String): CompletableFuture<Void?> = delete(id, OnorbitlistDeleteParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OnorbitlistGetResponse> =
    ...
    fun get(
        id: String,
        params: OnorbitlistGetParams = OnorbitlistGetParams.none(),
    ): CompletableFuture<OnorbitlistGetResponse> = get(id, params, RequestOptions.none())
     ...
     */
    fun queryhelp(): CompletableFuture<OnorbitlistQueryhelpResponse> =
    ...
    fun queryhelp(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OnorbitlistQueryhelpResponse>

    /** @see queryhelp */
    fun queryhelp(
        params: OnorbitlistQueryhelpParams = OnorbitlistQueryhelpParams.none()
    ): CompletableFuture<OnorbitlistQueryhelpResponse> = queryhelp(params, RequestOptions.none())
    ...
    fun tuple(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<List<OnorbitlistTupleResponse>>

    /**
     * A view of [OnorbitlistServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * [OnorbitlistServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<OnorbitlistListPageAsync>> =
            list(OnorbitlistListParams.none())

        /** @see list */
        fun list(
            params: OnorbitlistListParams = OnorbitlistListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OnorbitlistListPageAsync>>
         ...
         * as [OnorbitlistServiceAsync.delete].
         */
        fun delete(id: String): CompletableFuture<HttpResponse> =
            delete(id, OnorbitlistDeleteParams.none())
         ...
         * as [OnorbitlistServiceAsync.count].
         */
        fun count(): CompletableFuture<HttpResponseFor<String>> =
            count(OnorbitlistCountParams.none())
        ...
        fun get(
            ...
            params: OnorbitlistGetParams = OnorbitlistGetParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OnorbitlistGetResponse>> =
            get(params.toBuilder().id(id).build(), requestOptions)
         ...
         * same as [OnorbitlistServiceAsync.queryhelp].
         */
        fun queryhelp(): CompletableFuture<HttpResponseFor<OnorbitlistQueryhelpResponse>> =
            queryhelp(OnorbitlistQueryhelpParams.none())
        ...
        fun queryhelp(
            params: OnorbitlistQueryhelpParams = OnorbitlistQueryhelpParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OnorbitlistQueryhelpResponse>>
         ...
         * as [OnorbitlistServiceAsync.tuple].
         */
        fun tuple(
            params: OnorbitlistTupleParams
        ): CompletableFuture<HttpResponseFor<List<OnorbitlistTupleResponse>>> =
            tuple(params, RequestOptions.none())
