...
private constructor(
     ...
     *
     * Use the one published in `unifieddatalibrary-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.unifieddatalibrary.api.core.jsonMapper]. The default is usually sufficient
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://unifieddatalibrary.com"
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "unifieddatalibrary-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )
