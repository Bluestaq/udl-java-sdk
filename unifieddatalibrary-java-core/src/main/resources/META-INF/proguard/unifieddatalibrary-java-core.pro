...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.unifieddatalibrary.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.unifieddatalibrary.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.unifieddatalibrary.api.** {
    <init>(...);
