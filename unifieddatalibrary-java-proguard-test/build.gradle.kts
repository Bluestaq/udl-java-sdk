...
dependencies {
    testImplementation(project(":unifieddatalibrary-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../unifieddatalibrary-java-core/src/main/resources/META-INF/proguard/unifieddatalibrary-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.unifieddatalibrary.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../unifieddatalibrary-java-core/src/main/resources/META-INF/proguard/unifieddatalibrary-java-core.pro",
