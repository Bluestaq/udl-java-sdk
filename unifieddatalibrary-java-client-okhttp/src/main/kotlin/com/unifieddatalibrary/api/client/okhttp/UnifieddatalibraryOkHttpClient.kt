...
package com.unifieddatalibrary.api.client.okhttp
...
/**
 * A class that allows building an instance of [UnifieddatalibraryClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class UnifieddatalibraryOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [UnifieddatalibraryClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): UnifieddatalibraryClient = builder().fromEnv().build()
    }

    /** A builder for [UnifieddatalibraryOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.unifieddatalibrary.api.core.jsonMapper]. The default is usually
         ...
         *
         * Defaults to the production environment: `https://unifieddatalibrary.com`.
         */
        ...
        /**
         * Returns an immutable instance of [UnifieddatalibraryClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UnifieddatalibraryClient =
            UnifieddatalibraryClientImpl(
                clientOptions
                    .httpClient(
