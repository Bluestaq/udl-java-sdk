...
/**
 * A class that allows building an instance of [UnifieddatalibraryClientAsync] with [OkHttpClient]
 * as the underlying [HttpClient].
 */
class UnifieddatalibraryOkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): UnifieddatalibraryClientAsync = builder().fromEnv().build()
    }

    /** A builder for [UnifieddatalibraryOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [UnifieddatalibraryClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UnifieddatalibraryClientAsync =
            UnifieddatalibraryClientAsyncImpl(
                clientOptions
                    .httpClient(
